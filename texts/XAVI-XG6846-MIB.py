...
# Produced by pysmi-1.1.12 at Wed Jul  3 13:31:26 2024
...
mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Integer32, Counter32, ModuleIdentity, ObjectIdentity, Gauge32, snmpModules, iso, Counter64, MibIdentifier, Bits, NotificationType, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Integer32", "Counter32", "ModuleIdentity", "ObjectIdentity", "Gauge32", "snmpModules", "iso", "Counter64", "MibIdentifier", "Bits", "NotificationType", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port2=port2, portIndex=portIndex, jumblan3=jumblan3, voltage=voltage, staticIpGateway=staticIpGateway, portName=portName, tftp=tftp, statisticTable=statisticTable, staticIpDomainName=staticIpDomainName, operStatus=operStatus, bias=bias, internetPort=internetPort, port3=port3, speed=speed, modeEntry=modeEntry, catv=catv, lanportTable=lanportTable, vlan=vlan, portPower=portPower, port1=port1, rebootEnable=rebootEnable, vlanid=vlanid, jumb=jumb, dscpEnable=dscpEnable, fcsErrorReceived=fcsErrorReceived, ddminfo=ddminfo, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, lanportspeed=lanportspeed, qosTable=qosTable, pauseReceived=pauseReceived, lan1=lan1, qmapping=qmapping, lan3=lan3, serialnum=serialnum, groupid=groupid, qos=qos, fcsErrorTransmitted=fcsErrorTransmitted, jumblan1=jumblan1, vlangroupTable=vlangroupTable, lanportIndex=lanportIndex, wan=wan, portmode=portmode, temperature=temperature, fileType=fileType, jumblan4=jumblan4, qmode=qmode, secondaryDns=secondaryDns, primaryDns=primaryDns, staticDns=staticDns, adminStatus=adminStatus, lan2=lan2, priority=priority, pauseTransmitted=pauseTransmitted, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, jumbwan=jumbwan, port4=port4, multicastsTransmitted=multicastsTransmitted, portStatistic=portStatistic, wanType=wanType, lan4=lan4, staticIpSubMask=staticIpSubMask, broadcastsReceived=broadcastsReceived, vendorOui=vendorOui, hostname=hostname, qosEntry=qosEntry, vendorName=vendorName, action=action, staticIpPrimaryDns=staticIpPrimaryDns, reboot=reboot, portStatEntry=portStatEntry, groupEntry=groupEntry, xg6846=xg6846, catvEnable=catvEnable, lanportpause=lanportpause, statIndex=statIndex, multicastsReceived=multicastsReceived, txPower=txPower, deviceinfo=deviceinfo, lanportName=lanportName, unicastsReceived=unicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, portEntry=portEntry, domainame=domainame, tftpSevIp=tftpSevIp, portTable=portTable, groupIndex=groupIndex, staticIpAddr=staticIpAddr, staticIpHostName=staticIpHostName, fileName=fileName, jumblan2=jumblan2, rxPower=rxPower, vendorPn=vendorPn)
