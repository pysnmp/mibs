...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Unsigned32, Gauge32, ObjectIdentity, TimeTicks, MibIdentifier, ModuleIdentity, snmpModules, Bits, mib_2, Counter64, IpAddress, NotificationType, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Unsigned32", "Gauge32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "ModuleIdentity", "snmpModules", "Bits", "mib-2", "Counter64", "IpAddress", "NotificationType", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlangroupTable=vlangroupTable, pauseReceived=pauseReceived, speed=speed, vlan=vlan, jumblan4=jumblan4, lanportpause=lanportpause, portStatEntry=portStatEntry, fileName=fileName, qos=qos, unicastsTransmitted=unicastsTransmitted, port2=port2, jumblan1=jumblan1, qosTable=qosTable, hostname=hostname, broadcastsTransmitted=broadcastsTransmitted, port1=port1, lan1=lan1, catvEnable=catvEnable, tftp=tftp, multicastsReceived=multicastsReceived, qmode=qmode, staticIpDomainName=staticIpDomainName, jumb=jumb, lanportName=lanportName, rxPower=rxPower, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, portName=portName, txPower=txPower, ddminfo=ddminfo, rebootEnable=rebootEnable, lan3=lan3, portmode=portmode, portStatistic=portStatistic, internetPort=internetPort, operStatus=operStatus, modeEntry=modeEntry, wan=wan, statIndex=statIndex, lanportIndex=lanportIndex, catv=catv, adminStatus=adminStatus, qmapping=qmapping, priority=priority, portPower=portPower, xg6846=xg6846, vendorPn=vendorPn, staticIpHostName=staticIpHostName, lan4=lan4, reboot=reboot, portEntry=portEntry, fileType=fileType, lanportTable=lanportTable, qosEntry=qosEntry, groupid=groupid, jumblan3=jumblan3, action=action, staticIpAddr=staticIpAddr, wanType=wanType, primaryDns=primaryDns, lanportspeed=lanportspeed, qosIndex=qosIndex, unicastsReceived=unicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, bias=bias, lan2=lan2, serialnum=serialnum, port3=port3, vlanid=vlanid, temperature=temperature, deviceinfo=deviceinfo, groupIndex=groupIndex, groupEntry=groupEntry, domainame=domainame, statisticTable=statisticTable, vendorOui=vendorOui, pauseTransmitted=pauseTransmitted, vendorName=vendorName, voltage=voltage, portIndex=portIndex, tftpSevIp=tftpSevIp, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsReceived=broadcastsReceived, secondaryDns=secondaryDns, vendorRev=vendorRev, staticIpGateway=staticIpGateway, fcsErrorReceived=fcsErrorReceived, portTable=portTable, multicastsTransmitted=multicastsTransmitted, port4=port4, dscpEnable=dscpEnable, staticDns=staticDns)
