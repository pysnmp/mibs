...
# Produced by pysmi-1.1.0 at Fri Nov 19 15:18:30 2021
...
mib_2, TimeTicks, IpAddress, MibIdentifier, ObjectIdentity, ModuleIdentity, Integer32, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Gauge32, Bits, iso, Counter64, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "TimeTicks", "IpAddress", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Integer32", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Gauge32", "Bits", "iso", "Counter64", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qos=qos, lanportspeed=lanportspeed, lan4=lan4, qosTable=qosTable, fcsErrorReceived=fcsErrorReceived, jumblan2=jumblan2, broadcastsReceived=broadcastsReceived, tftp=tftp, port2=port2, lan3=lan3, portStatistic=portStatistic, lan1=lan1, jumblan1=jumblan1, jumblan3=jumblan3, fileType=fileType, reboot=reboot, staticIpDomainName=staticIpDomainName, vendorOui=vendorOui, catv=catv, lanportpause=lanportpause, rxPower=rxPower, xg6846=xg6846, primaryDns=primaryDns, portStatEntry=portStatEntry, priority=priority, qosIndex=qosIndex, port3=port3, jumblan4=jumblan4, vlangroupTable=vlangroupTable, catvEnable=catvEnable, groupEntry=groupEntry, staticIpSecondaryDns=staticIpSecondaryDns, portTable=portTable, action=action, lanportIndex=lanportIndex, adminStatus=adminStatus, qmode=qmode, statisticTable=statisticTable, vendorPn=vendorPn, vlan=vlan, vlanid=vlanid, serialnum=serialnum, staticIpPrimaryDns=staticIpPrimaryDns, portIndex=portIndex, tftpSevIp=tftpSevIp, jumbwan=jumbwan, groupid=groupid, staticIpSubMask=staticIpSubMask, unicastsReceived=unicastsReceived, port4=port4, statIndex=statIndex, pauseReceived=pauseReceived, fcsErrorTransmitted=fcsErrorTransmitted, hostname=hostname, domainame=domainame, portEntry=portEntry, port1=port1, broadcastsTransmitted=broadcastsTransmitted, multicastsReceived=multicastsReceived, staticDns=staticDns, ddminfo=ddminfo, wan=wan, rebootEnable=rebootEnable, temperature=temperature, lanportTable=lanportTable, internetPort=internetPort, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, pauseTransmitted=pauseTransmitted, voltage=voltage, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, lan2=lan2, dscpEnable=dscpEnable, vendorName=vendorName, secondaryDns=secondaryDns, speed=speed, modeEntry=modeEntry, qmapping=qmapping, portPower=portPower, fileName=fileName, qosEntry=qosEntry, wanType=wanType, portmode=portmode, bias=bias, staticIpHostName=staticIpHostName, vendorRev=vendorRev, unicastsTransmitted=unicastsTransmitted, lanportName=lanportName, deviceinfo=deviceinfo, txPower=txPower, portName=portName, jumb=jumb, operStatus=operStatus)
