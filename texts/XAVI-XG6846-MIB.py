...
# Produced by pysmi-1.1.8 at Tue Sep 12 08:08:14 2023
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, ModuleIdentity, Gauge32, mib_2, Bits, Integer32, Counter64, enterprises, TimeTicks, NotificationType, iso, ObjectIdentity, Unsigned32, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "ModuleIdentity", "Gauge32", "mib-2", "Bits", "Integer32", "Counter64", "enterprises", "TimeTicks", "NotificationType", "iso", "ObjectIdentity", "Unsigned32", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileName=fileName, portIndex=portIndex, portEntry=portEntry, qmode=qmode, jumblan2=jumblan2, adminStatus=adminStatus, action=action, operStatus=operStatus, portTable=portTable, portStatistic=portStatistic, portPower=portPower, jumb=jumb, rxPower=rxPower, lanportspeed=lanportspeed, groupEntry=groupEntry, vendorName=vendorName, ddminfo=ddminfo, unicastsReceived=unicastsReceived, staticIpSubMask=staticIpSubMask, bias=bias, portmode=portmode, portName=portName, xg6846=xg6846, temperature=temperature, vendorPn=vendorPn, vendorOui=vendorOui, staticIpGateway=staticIpGateway, qos=qos, rebootEnable=rebootEnable, staticIpHostName=staticIpHostName, secondaryDns=secondaryDns, groupIndex=groupIndex, tftpSevIp=tftpSevIp, lan4=lan4, staticIpAddr=staticIpAddr, catv=catv, statIndex=statIndex, qosTable=qosTable, lanportIndex=lanportIndex, wanType=wanType, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, pauseReceived=pauseReceived, staticIpSecondaryDns=staticIpSecondaryDns, voltage=voltage, lan2=lan2, dscpEnable=dscpEnable, jumbwan=jumbwan, jumblan4=jumblan4, lanportTable=lanportTable, vlanid=vlanid, port2=port2, qosIndex=qosIndex, qmapping=qmapping, reboot=reboot, fcsErrorReceived=fcsErrorReceived, deviceinfo=deviceinfo, groupid=groupid, broadcastsReceived=broadcastsReceived, tftp=tftp, txPower=txPower, speed=speed, primaryDns=primaryDns, port1=port1, jumblan3=jumblan3, multicastsTransmitted=multicastsTransmitted, fileType=fileType, domainame=domainame, serialnum=serialnum, hostname=hostname, lan3=lan3, modeEntry=modeEntry, portStatEntry=portStatEntry, unicastsTransmitted=unicastsTransmitted, port4=port4, lanportpause=lanportpause, statisticTable=statisticTable, lanportName=lanportName, port3=port3, lan1=lan1, vendorRev=vendorRev, catvEnable=catvEnable, priority=priority, multicastsReceived=multicastsReceived, wan=wan, jumblan1=jumblan1, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, vlangroupTable=vlangroupTable, qosEntry=qosEntry, staticDns=staticDns, staticIpDomainName=staticIpDomainName, vlan=vlan)
