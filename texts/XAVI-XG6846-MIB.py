...
# Produced by pysmi-1.1.8 at Thu Feb  9 13:27:03 2023
...
Bits, mib_2, ObjectIdentity, snmpModules, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, iso, IpAddress, MibIdentifier, Counter32, Integer32, ModuleIdentity, Unsigned32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "ObjectIdentity", "snmpModules", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "iso", "IpAddress", "MibIdentifier", "Counter32", "Integer32", "ModuleIdentity", "Unsigned32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, staticIpHostName=staticIpHostName, portmode=portmode, port3=port3, vendorName=vendorName, multicastsReceived=multicastsReceived, priority=priority, qosTable=qosTable, catvEnable=catvEnable, lanportspeed=lanportspeed, voltage=voltage, bias=bias, modeEntry=modeEntry, staticIpSubMask=staticIpSubMask, jumblan3=jumblan3, lanportIndex=lanportIndex, unicastsReceived=unicastsReceived, secondaryDns=secondaryDns, jumbwan=jumbwan, fcsErrorReceived=fcsErrorReceived, catv=catv, lan4=lan4, fileName=fileName, action=action, jumblan4=jumblan4, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, deviceinfo=deviceinfo, qosEntry=qosEntry, portStatEntry=portStatEntry, vlanid=vlanid, portName=portName, unicastsTransmitted=unicastsTransmitted, lan3=lan3, speed=speed, lanportTable=lanportTable, staticDns=staticDns, primaryDns=primaryDns, lan2=lan2, port2=port2, hostname=hostname, staticIpAddr=staticIpAddr, jumb=jumb, statisticTable=statisticTable, vlan=vlan, rebootEnable=rebootEnable, staticIpSecondaryDns=staticIpSecondaryDns, groupEntry=groupEntry, portTable=portTable, vendorRev=vendorRev, jumblan1=jumblan1, broadcastsReceived=broadcastsReceived, qmapping=qmapping, reboot=reboot, rxPower=rxPower, vlangroupTable=vlangroupTable, operStatus=operStatus, tftp=tftp, jumblan2=jumblan2, portEntry=portEntry, pauseTransmitted=pauseTransmitted, pauseReceived=pauseReceived, ddminfo=ddminfo, txPower=txPower, staticIpPrimaryDns=staticIpPrimaryDns, fileType=fileType, vendorPn=vendorPn, domainame=domainame, adminStatus=adminStatus, staticIpDomainName=staticIpDomainName, lan1=lan1, qosIndex=qosIndex, groupIndex=groupIndex, temperature=temperature, wan=wan, lanportName=lanportName, portIndex=portIndex, wanType=wanType, qos=qos, fcsErrorTransmitted=fcsErrorTransmitted, lanportpause=lanportpause, dscpEnable=dscpEnable, staticIpGateway=staticIpGateway, tftpSevIp=tftpSevIp, qmode=qmode, portStatistic=portStatistic, port4=port4, serialnum=serialnum, internetPort=internetPort, statIndex=statIndex, portPower=portPower, groupid=groupid, port1=port1)
