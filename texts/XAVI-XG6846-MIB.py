...
# Produced by pysmi-1.1.12 at Tue Sep 17 12:04:51 2024
...
Unsigned32, snmpModules, Bits, mib_2, MibIdentifier, ModuleIdentity, enterprises, IpAddress, Gauge32, iso, ObjectIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "snmpModules", "Bits", "mib-2", "MibIdentifier", "ModuleIdentity", "enterprises", "IpAddress", "Gauge32", "iso", "ObjectIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumbwan=jumbwan, vendorName=vendorName, wanType=wanType, action=action, portPower=portPower, port1=port1, portIndex=portIndex, domainame=domainame, staticIpSecondaryDns=staticIpSecondaryDns, groupid=groupid, lan3=lan3, portTable=portTable, multicastsReceived=multicastsReceived, pauseTransmitted=pauseTransmitted, jumblan3=jumblan3, tftp=tftp, secondaryDns=secondaryDns, unicastsTransmitted=unicastsTransmitted, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, qos=qos, tftpSevIp=tftpSevIp, jumblan1=jumblan1, lanportTable=lanportTable, lanportName=lanportName, staticDns=staticDns, portStatEntry=portStatEntry, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, xg6846=xg6846, lan4=lan4, dscpEnable=dscpEnable, jumb=jumb, portEntry=portEntry, adminStatus=adminStatus, staticIpAddr=staticIpAddr, bias=bias, fileName=fileName, qosIndex=qosIndex, groupIndex=groupIndex, broadcastsTransmitted=broadcastsTransmitted, operStatus=operStatus, catvEnable=catvEnable, staticIpGateway=staticIpGateway, groupEntry=groupEntry, temperature=temperature, qmapping=qmapping, fcsErrorReceived=fcsErrorReceived, qosEntry=qosEntry, voltage=voltage, unicastsReceived=unicastsReceived, pauseReceived=pauseReceived, port2=port2, jumblan4=jumblan4, portName=portName, staticIpDomainName=staticIpDomainName, txPower=txPower, port3=port3, vendorRev=vendorRev, lan1=lan1, vlan=vlan, lanportpause=lanportpause, statisticTable=statisticTable, catv=catv, qmode=qmode, serialnum=serialnum, staticIpHostName=staticIpHostName, ddminfo=ddminfo, lan2=lan2, primaryDns=primaryDns, fileType=fileType, priority=priority, port4=port4, lanportspeed=lanportspeed, deviceinfo=deviceinfo, wan=wan, vlangroupTable=vlangroupTable, jumblan2=jumblan2, qosTable=qosTable, modeEntry=modeEntry, vendorOui=vendorOui, reboot=reboot, lanportIndex=lanportIndex, portStatistic=portStatistic, vendorPn=vendorPn, speed=speed, internetPort=internetPort, multicastsTransmitted=multicastsTransmitted, rxPower=rxPower, staticIpSubMask=staticIpSubMask, hostname=hostname, statIndex=statIndex, vlanid=vlanid)
