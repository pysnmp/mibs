...
# Produced by pysmi-1.1.3 at Tue Nov 30 13:50:43 2021
...
Gauge32, Bits, Counter32, TimeTicks, enterprises, iso, Counter64, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, snmpModules, mib_2, Integer32, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "Counter32", "TimeTicks", "enterprises", "iso", "Counter64", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "snmpModules", "mib-2", "Integer32", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatistic=portStatistic, vlanid=vlanid, qmapping=qmapping, portTable=portTable, lan3=lan3, unicastsTransmitted=unicastsTransmitted, unicastsReceived=unicastsReceived, deviceinfo=deviceinfo, lan2=lan2, qosTable=qosTable, staticIpGateway=staticIpGateway, staticIpAddr=staticIpAddr, tftp=tftp, port3=port3, ddminfo=ddminfo, qosIndex=qosIndex, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorReceived=fcsErrorReceived, modeEntry=modeEntry, lanportIndex=lanportIndex, port4=port4, adminStatus=adminStatus, staticIpHostName=staticIpHostName, catv=catv, wanType=wanType, statisticTable=statisticTable, broadcastsTransmitted=broadcastsTransmitted, lan1=lan1, port2=port2, temperature=temperature, jumblan4=jumblan4, vendorPn=vendorPn, rebootEnable=rebootEnable, jumblan1=jumblan1, qmode=qmode, fileType=fileType, internetPort=internetPort, qos=qos, txPower=txPower, action=action, speed=speed, groupEntry=groupEntry, portmode=portmode, port1=port1, dscpEnable=dscpEnable, portName=portName, pauseTransmitted=pauseTransmitted, secondaryDns=secondaryDns, staticIpSubMask=staticIpSubMask, broadcastsReceived=broadcastsReceived, jumblan3=jumblan3, portStatEntry=portStatEntry, bias=bias, reboot=reboot, portPower=portPower, domainame=domainame, wan=wan, pauseReceived=pauseReceived, voltage=voltage, fileName=fileName, jumb=jumb, portEntry=portEntry, catvEnable=catvEnable, vendorName=vendorName, lanportspeed=lanportspeed, qosEntry=qosEntry, staticIpDomainName=staticIpDomainName, serialnum=serialnum, staticIpPrimaryDns=staticIpPrimaryDns, primaryDns=primaryDns, vendorOui=vendorOui, lanportpause=lanportpause, groupid=groupid, groupIndex=groupIndex, lan4=lan4, vlan=vlan, hostname=hostname, fcsErrorTransmitted=fcsErrorTransmitted, lanportName=lanportName, operStatus=operStatus, rxPower=rxPower, vlangroupTable=vlangroupTable, portIndex=portIndex, xg6846=xg6846, tftpSevIp=tftpSevIp, lanportTable=lanportTable, multicastsTransmitted=multicastsTransmitted, staticDns=staticDns, jumbwan=jumbwan, multicastsReceived=multicastsReceived, vendorRev=vendorRev, statIndex=statIndex, priority=priority, jumblan2=jumblan2)
