...
snmpModules, ModuleIdentity, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, mib_2, Bits, Counter64, ObjectIdentity, MibIdentifier, Gauge32, iso, Integer32, Unsigned32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "ModuleIdentity", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "mib-2", "Bits", "Counter64", "ObjectIdentity", "MibIdentifier", "Gauge32", "iso", "Integer32", "Unsigned32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portIndex=portIndex, adminStatus=adminStatus, fcsErrorTransmitted=fcsErrorTransmitted, jumblan4=jumblan4, jumb=jumb, tftp=tftp, bias=bias, jumblan3=jumblan3, multicastsTransmitted=multicastsTransmitted, secondaryDns=secondaryDns, pauseReceived=pauseReceived, groupEntry=groupEntry, staticIpHostName=staticIpHostName, lan4=lan4, lanportspeed=lanportspeed, vlanid=vlanid, wanType=wanType, lanportTable=lanportTable, port4=port4, tftpSevIp=tftpSevIp, qosIndex=qosIndex, vendorOui=vendorOui, broadcastsTransmitted=broadcastsTransmitted, vendorName=vendorName, portEntry=portEntry, rxPower=rxPower, catvEnable=catvEnable, modeEntry=modeEntry, lan1=lan1, portTable=portTable, vlangroupTable=vlangroupTable, vlan=vlan, deviceinfo=deviceinfo, portName=portName, primaryDns=primaryDns, catv=catv, fcsErrorReceived=fcsErrorReceived, lanportpause=lanportpause, speed=speed, qmode=qmode, internetPort=internetPort, groupid=groupid, fileName=fileName, portPower=portPower, lanportName=lanportName, qosTable=qosTable, operStatus=operStatus, groupIndex=groupIndex, lan3=lan3, jumbwan=jumbwan, staticIpDomainName=staticIpDomainName, qos=qos, lan2=lan2, xg6846=xg6846, staticIpGateway=staticIpGateway, multicastsReceived=multicastsReceived, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, domainame=domainame, action=action, port2=port2, staticIpAddr=staticIpAddr, voltage=voltage, reboot=reboot, staticIpSecondaryDns=staticIpSecondaryDns, vendorPn=vendorPn, priority=priority, port1=port1, staticIpSubMask=staticIpSubMask, rebootEnable=rebootEnable, serialnum=serialnum, txPower=txPower, ddminfo=ddminfo, wan=wan, statisticTable=statisticTable, staticDns=staticDns, temperature=temperature, pauseTransmitted=pauseTransmitted, hostname=hostname, qmapping=qmapping, staticIpPrimaryDns=staticIpPrimaryDns, jumblan1=jumblan1, portStatistic=portStatistic, lanportIndex=lanportIndex, dscpEnable=dscpEnable, jumblan2=jumblan2, statIndex=statIndex, broadcastsReceived=broadcastsReceived, vendorRev=vendorRev, fileType=fileType, port3=port3, qosEntry=qosEntry, portmode=portmode, unicastsTransmitted=unicastsTransmitted)
