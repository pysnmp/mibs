...
iso, mib_2, NotificationType, enterprises, ObjectIdentity, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Bits, Gauge32, Counter32, Integer32, Unsigned32, MibIdentifier, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "mib-2", "NotificationType", "enterprises", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Bits", "Gauge32", "Counter32", "Integer32", "Unsigned32", "MibIdentifier", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portEntry=portEntry, multicastsTransmitted=multicastsTransmitted, groupEntry=groupEntry, portStatistic=portStatistic, lanportIndex=lanportIndex, staticIpPrimaryDns=staticIpPrimaryDns, fileName=fileName, port3=port3, domainame=domainame, jumblan1=jumblan1, port1=port1, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, qosIndex=qosIndex, wanType=wanType, qmode=qmode, staticDns=staticDns, adminStatus=adminStatus, pauseReceived=pauseReceived, lanportTable=lanportTable, qos=qos, rebootEnable=rebootEnable, tftp=tftp, vlan=vlan, ddminfo=ddminfo, secondaryDns=secondaryDns, lanportName=lanportName, staticIpGateway=staticIpGateway, jumblan3=jumblan3, port2=port2, xg6846=xg6846, unicastsTransmitted=unicastsTransmitted, txPower=txPower, vlangroupTable=vlangroupTable, vendorName=vendorName, rxPower=rxPower, wan=wan, serialnum=serialnum, fcsErrorReceived=fcsErrorReceived, vlanid=vlanid, fileType=fileType, lan4=lan4, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, portName=portName, statisticTable=statisticTable, lanportspeed=lanportspeed, lanportpause=lanportpause, dscpEnable=dscpEnable, qosEntry=qosEntry, fcsErrorTransmitted=fcsErrorTransmitted, vendorOui=vendorOui, tftpSevIp=tftpSevIp, hostname=hostname, qosTable=qosTable, jumb=jumb, jumblan2=jumblan2, groupIndex=groupIndex, voltage=voltage, port4=port4, operStatus=operStatus, modeEntry=modeEntry, catv=catv, reboot=reboot, speed=speed, portIndex=portIndex, portPower=portPower, vendorPn=vendorPn, catvEnable=catvEnable, qmapping=qmapping, portStatEntry=portStatEntry, lan3=lan3, unicastsReceived=unicastsReceived, internetPort=internetPort, priority=priority, statIndex=statIndex, staticIpDomainName=staticIpDomainName, groupid=groupid, temperature=temperature, multicastsReceived=multicastsReceived, action=action, portTable=portTable, bias=bias, staticIpAddr=staticIpAddr, portmode=portmode, jumbwan=jumbwan, deviceinfo=deviceinfo, broadcastsReceived=broadcastsReceived, vendorRev=vendorRev, primaryDns=primaryDns, jumblan4=jumblan4, staticIpHostName=staticIpHostName, pauseTransmitted=pauseTransmitted, staticIpSubMask=staticIpSubMask)
