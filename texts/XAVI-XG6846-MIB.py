...
# Produced by pysmi-1.1.8 at Wed Sep 13 15:00:51 2023
...
TimeTicks, Gauge32, Counter64, Bits, Counter32, ModuleIdentity, NotificationType, MibIdentifier, ObjectIdentity, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, IpAddress, iso, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "Counter64", "Bits", "Counter32", "ModuleIdentity", "NotificationType", "MibIdentifier", "ObjectIdentity", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "IpAddress", "iso", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wanType=wanType, qosEntry=qosEntry, qosTable=qosTable, deviceinfo=deviceinfo, vlan=vlan, tftp=tftp, port4=port4, adminStatus=adminStatus, portPower=portPower, tftpSevIp=tftpSevIp, jumblan2=jumblan2, staticDns=staticDns, dscpEnable=dscpEnable, jumblan1=jumblan1, groupIndex=groupIndex, lanportTable=lanportTable, portStatistic=portStatistic, temperature=temperature, statIndex=statIndex, vlanid=vlanid, vendorRev=vendorRev, wan=wan, pauseReceived=pauseReceived, serialnum=serialnum, qosIndex=qosIndex, vendorPn=vendorPn, lan2=lan2, modeEntry=modeEntry, staticIpPrimaryDns=staticIpPrimaryDns, statisticTable=statisticTable, portIndex=portIndex, lanportspeed=lanportspeed, rebootEnable=rebootEnable, txPower=txPower, catv=catv, primaryDns=primaryDns, staticIpSecondaryDns=staticIpSecondaryDns, lanportName=lanportName, port3=port3, bias=bias, lan1=lan1, staticIpAddr=staticIpAddr, secondaryDns=secondaryDns, lan3=lan3, hostname=hostname, fileName=fileName, fileType=fileType, unicastsReceived=unicastsReceived, vendorName=vendorName, portmode=portmode, port1=port1, jumblan4=jumblan4, catvEnable=catvEnable, portEntry=portEntry, action=action, broadcastsTransmitted=broadcastsTransmitted, lanportIndex=lanportIndex, multicastsReceived=multicastsReceived, vlangroupTable=vlangroupTable, port2=port2, lan4=lan4, staticIpHostName=staticIpHostName, groupid=groupid, priority=priority, portStatEntry=portStatEntry, operStatus=operStatus, fcsErrorTransmitted=fcsErrorTransmitted, portTable=portTable, internetPort=internetPort, reboot=reboot, broadcastsReceived=broadcastsReceived, lanportpause=lanportpause, portName=portName, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, staticIpDomainName=staticIpDomainName, jumb=jumb, jumblan3=jumblan3, xg6846=xg6846, qos=qos, fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, domainame=domainame, qmapping=qmapping, vendorOui=vendorOui, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, voltage=voltage, unicastsTransmitted=unicastsTransmitted, ddminfo=ddminfo, qmode=qmode, rxPower=rxPower, multicastsTransmitted=multicastsTransmitted, speed=speed)
