...
enterprises, IpAddress, ModuleIdentity, TimeTicks, Counter32, Gauge32, NotificationType, ObjectIdentity, snmpModules, MibIdentifier, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Unsigned32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "ModuleIdentity", "TimeTicks", "Counter32", "Gauge32", "NotificationType", "ObjectIdentity", "snmpModules", "MibIdentifier", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Unsigned32", "Integer32", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port1=port1, groupIndex=groupIndex, lanportTable=lanportTable, staticIpPrimaryDns=staticIpPrimaryDns, qmode=qmode, staticIpGateway=staticIpGateway, xg6846=xg6846, port3=port3, lan2=lan2, domainame=domainame, rxPower=rxPower, portStatistic=portStatistic, portPower=portPower, wanType=wanType, lan1=lan1, tftp=tftp, operStatus=operStatus, vlanid=vlanid, reboot=reboot, qosEntry=qosEntry, vendorPn=vendorPn, wan=wan, staticDns=staticDns, action=action, temperature=temperature, lanportName=lanportName, staticIpHostName=staticIpHostName, catvEnable=catvEnable, staticIpSecondaryDns=staticIpSecondaryDns, statIndex=statIndex, speed=speed, lan3=lan3, hostname=hostname, qosIndex=qosIndex, vendorName=vendorName, staticIpSubMask=staticIpSubMask, lanportIndex=lanportIndex, priority=priority, fcsErrorTransmitted=fcsErrorTransmitted, multicastsTransmitted=multicastsTransmitted, internetPort=internetPort, unicastsTransmitted=unicastsTransmitted, voltage=voltage, fcsErrorReceived=fcsErrorReceived, port2=port2, statisticTable=statisticTable, qosTable=qosTable, portEntry=portEntry, ddminfo=ddminfo, portName=portName, lan4=lan4, bias=bias, jumblan2=jumblan2, tftpSevIp=tftpSevIp, groupEntry=groupEntry, jumblan3=jumblan3, portmode=portmode, deviceinfo=deviceinfo, vendorRev=vendorRev, vendorOui=vendorOui, pauseReceived=pauseReceived, fileName=fileName, jumblan4=jumblan4, adminStatus=adminStatus, dscpEnable=dscpEnable, txPower=txPower, staticIpAddr=staticIpAddr, vlangroupTable=vlangroupTable, vlan=vlan, port4=port4, portStatEntry=portStatEntry, primaryDns=primaryDns, qmapping=qmapping, jumb=jumb, jumblan1=jumblan1, portTable=portTable, multicastsReceived=multicastsReceived, jumbwan=jumbwan, rebootEnable=rebootEnable, portIndex=portIndex, broadcastsTransmitted=broadcastsTransmitted, pauseTransmitted=pauseTransmitted, modeEntry=modeEntry, fileType=fileType, unicastsReceived=unicastsReceived, groupid=groupid, lanportspeed=lanportspeed, catv=catv, serialnum=serialnum, lanportpause=lanportpause, secondaryDns=secondaryDns, staticIpDomainName=staticIpDomainName, qos=qos, broadcastsReceived=broadcastsReceived)
