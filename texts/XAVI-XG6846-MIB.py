...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:40:24 2024
...
Counter32, mib_2, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, Integer32, Counter64, NotificationType, iso, TimeTicks, ObjectIdentity, IpAddress, Gauge32, snmpModules, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "mib-2", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "Integer32", "Counter64", "NotificationType", "iso", "TimeTicks", "ObjectIdentity", "IpAddress", "Gauge32", "snmpModules", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", operStatus=operStatus, priority=priority, lan1=lan1, ddminfo=ddminfo, secondaryDns=secondaryDns, serialnum=serialnum, lanportIndex=lanportIndex, groupIndex=groupIndex, port2=port2, tftpSevIp=tftpSevIp, portEntry=portEntry, portIndex=portIndex, broadcastsTransmitted=broadcastsTransmitted, vendorRev=vendorRev, xg6846=xg6846, staticIpHostName=staticIpHostName, staticDns=staticDns, temperature=temperature, qosEntry=qosEntry, lan4=lan4, portName=portName, qmode=qmode, reboot=reboot, statisticTable=statisticTable, adminStatus=adminStatus, internetPort=internetPort, vendorPn=vendorPn, qos=qos, groupEntry=groupEntry, staticIpSubMask=staticIpSubMask, groupid=groupid, lanportpause=lanportpause, multicastsReceived=multicastsReceived, jumblan4=jumblan4, wanType=wanType, domainame=domainame, jumb=jumb, fileName=fileName, lan3=lan3, txPower=txPower, vlan=vlan, deviceinfo=deviceinfo, catvEnable=catvEnable, lan2=lan2, rxPower=rxPower, primaryDns=primaryDns, staticIpDomainName=staticIpDomainName, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, jumbwan=jumbwan, port4=port4, wan=wan, unicastsReceived=unicastsReceived, vendorOui=vendorOui, staticIpAddr=staticIpAddr, qosIndex=qosIndex, jumblan2=jumblan2, pauseReceived=pauseReceived, portPower=portPower, lanportTable=lanportTable, staticIpPrimaryDns=staticIpPrimaryDns, voltage=voltage, portStatEntry=portStatEntry, jumblan1=jumblan1, portStatistic=portStatistic, vlangroupTable=vlangroupTable, action=action, qmapping=qmapping, pauseTransmitted=pauseTransmitted, lanportName=lanportName, staticIpGateway=staticIpGateway, fcsErrorTransmitted=fcsErrorTransmitted, hostname=hostname, portTable=portTable, vendorName=vendorName, lanportspeed=lanportspeed, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, qosTable=qosTable, modeEntry=modeEntry, speed=speed, port1=port1, broadcastsReceived=broadcastsReceived, statIndex=statIndex, port3=port3, portmode=portmode, jumblan3=jumblan3, fileType=fileType, catv=catv, staticIpSecondaryDns=staticIpSecondaryDns, rebootEnable=rebootEnable, bias=bias, tftp=tftp, vlanid=vlanid)
