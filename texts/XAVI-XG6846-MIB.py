...
Counter32, Counter64, iso, IpAddress, snmpModules, Integer32, ObjectIdentity, MibIdentifier, TimeTicks, NotificationType, ModuleIdentity, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "iso", "IpAddress", "snmpModules", "Integer32", "ObjectIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "ModuleIdentity", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan2=jumblan2, qmode=qmode, multicastsTransmitted=multicastsTransmitted, tftp=tftp, wanType=wanType, lanportTable=lanportTable, groupIndex=groupIndex, vlanid=vlanid, portEntry=portEntry, primaryDns=primaryDns, tftpSevIp=tftpSevIp, vendorOui=vendorOui, speed=speed, jumblan3=jumblan3, qosIndex=qosIndex, serialnum=serialnum, lanportIndex=lanportIndex, qmapping=qmapping, statisticTable=statisticTable, vendorName=vendorName, wan=wan, catvEnable=catvEnable, secondaryDns=secondaryDns, jumblan1=jumblan1, unicastsReceived=unicastsReceived, modeEntry=modeEntry, jumbwan=jumbwan, lanportspeed=lanportspeed, groupEntry=groupEntry, multicastsReceived=multicastsReceived, portStatistic=portStatistic, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, port4=port4, lan3=lan3, pauseTransmitted=pauseTransmitted, deviceinfo=deviceinfo, unicastsTransmitted=unicastsTransmitted, qos=qos, groupid=groupid, priority=priority, pauseReceived=pauseReceived, broadcastsReceived=broadcastsReceived, qosEntry=qosEntry, lanportpause=lanportpause, portName=portName, domainame=domainame, catv=catv, fcsErrorReceived=fcsErrorReceived, temperature=temperature, vlan=vlan, reboot=reboot, voltage=voltage, bias=bias, fileName=fileName, jumb=jumb, txPower=txPower, portmode=portmode, adminStatus=adminStatus, fileType=fileType, internetPort=internetPort, xg6846=xg6846, operStatus=operStatus, staticIpDomainName=staticIpDomainName, vlangroupTable=vlangroupTable, staticDns=staticDns, staticIpSecondaryDns=staticIpSecondaryDns, vendorPn=vendorPn, qosTable=qosTable, broadcastsTransmitted=broadcastsTransmitted, vendorRev=vendorRev, hostname=hostname, portTable=portTable, portIndex=portIndex, staticIpHostName=staticIpHostName, fcsErrorTransmitted=fcsErrorTransmitted, rxPower=rxPower, lanportName=lanportName, portStatEntry=portStatEntry, lan4=lan4, port2=port2, action=action, lan1=lan1, lan2=lan2, port1=port1, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, ddminfo=ddminfo, jumblan4=jumblan4, port3=port3, portPower=portPower, staticIpGateway=staticIpGateway, dscpEnable=dscpEnable, statIndex=statIndex)
