...
Bits, ObjectIdentity, MibIdentifier, iso, mib_2, snmpModules, IpAddress, Integer32, Unsigned32, Counter32, Counter64, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "MibIdentifier", "iso", "mib-2", "snmpModules", "IpAddress", "Integer32", "Unsigned32", "Counter32", "Counter64", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", bias=bias, lan1=lan1, operStatus=operStatus, dscpEnable=dscpEnable, vlan=vlan, jumblan4=jumblan4, groupid=groupid, catv=catv, pauseReceived=pauseReceived, staticIpAddr=staticIpAddr, staticIpHostName=staticIpHostName, jumblan2=jumblan2, multicastsReceived=multicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, lan4=lan4, vlanid=vlanid, fileType=fileType, modeEntry=modeEntry, groupIndex=groupIndex, qosEntry=qosEntry, qmapping=qmapping, wanType=wanType, tftp=tftp, lan3=lan3, rebootEnable=rebootEnable, fcsErrorReceived=fcsErrorReceived, qos=qos, vendorPn=vendorPn, pauseTransmitted=pauseTransmitted, qosIndex=qosIndex, staticIpGateway=staticIpGateway, broadcastsReceived=broadcastsReceived, staticIpDomainName=staticIpDomainName, statisticTable=statisticTable, portStatEntry=portStatEntry, portTable=portTable, portStatistic=portStatistic, domainame=domainame, unicastsTransmitted=unicastsTransmitted, lanportName=lanportName, staticIpSecondaryDns=staticIpSecondaryDns, primaryDns=primaryDns, ddminfo=ddminfo, lanportspeed=lanportspeed, txPower=txPower, port3=port3, portName=portName, portPower=portPower, multicastsTransmitted=multicastsTransmitted, fileName=fileName, tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask, staticDns=staticDns, action=action, qmode=qmode, jumbwan=jumbwan, qosTable=qosTable, jumblan3=jumblan3, vendorName=vendorName, deviceinfo=deviceinfo, lanportpause=lanportpause, portIndex=portIndex, port1=port1, temperature=temperature, catvEnable=catvEnable, reboot=reboot, portEntry=portEntry, priority=priority, serialnum=serialnum, port2=port2, speed=speed, lanportTable=lanportTable, vlangroupTable=vlangroupTable, groupEntry=groupEntry, voltage=voltage, portmode=portmode, lan2=lan2, vendorOui=vendorOui, internetPort=internetPort, vendorRev=vendorRev, hostname=hostname, port4=port4, rxPower=rxPower, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived, jumb=jumb, lanportIndex=lanportIndex, statIndex=statIndex, jumblan1=jumblan1, wan=wan, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus)
