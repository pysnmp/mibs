...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:36:17 2021
...
ModuleIdentity, NotificationType, Counter32, enterprises, Gauge32, iso, Unsigned32, snmpModules, Counter64, MibIdentifier, Bits, mib_2, IpAddress, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "Counter32", "enterprises", "Gauge32", "iso", "Unsigned32", "snmpModules", "Counter64", "MibIdentifier", "Bits", "mib-2", "IpAddress", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rebootEnable=rebootEnable, portIndex=portIndex, portName=portName, lanportTable=lanportTable, qmode=qmode, internetPort=internetPort, pauseReceived=pauseReceived, qosIndex=qosIndex, wan=wan, modeEntry=modeEntry, vendorOui=vendorOui, rxPower=rxPower, staticIpSecondaryDns=staticIpSecondaryDns, qos=qos, groupIndex=groupIndex, qmapping=qmapping, vlan=vlan, temperature=temperature, serialnum=serialnum, vendorRev=vendorRev, statisticTable=statisticTable, fileType=fileType, portStatEntry=portStatEntry, domainame=domainame, vendorPn=vendorPn, statIndex=statIndex, hostname=hostname, lan3=lan3, multicastsTransmitted=multicastsTransmitted, deviceinfo=deviceinfo, staticIpHostName=staticIpHostName, broadcastsReceived=broadcastsReceived, jumblan2=jumblan2, priority=priority, pauseTransmitted=pauseTransmitted, unicastsReceived=unicastsReceived, tftpSevIp=tftpSevIp, portTable=portTable, jumbwan=jumbwan, voltage=voltage, multicastsReceived=multicastsReceived, lan1=lan1, broadcastsTransmitted=broadcastsTransmitted, port2=port2, qosEntry=qosEntry, port3=port3, jumblan3=jumblan3, port1=port1, fileName=fileName, vendorName=vendorName, lanportspeed=lanportspeed, catv=catv, txPower=txPower, groupEntry=groupEntry, unicastsTransmitted=unicastsTransmitted, reboot=reboot, portEntry=portEntry, secondaryDns=secondaryDns, lanportIndex=lanportIndex, action=action, portPower=portPower, jumblan4=jumblan4, staticIpGateway=staticIpGateway, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, staticDns=staticDns, operStatus=operStatus, primaryDns=primaryDns, fcsErrorTransmitted=fcsErrorTransmitted, ddminfo=ddminfo, fcsErrorReceived=fcsErrorReceived, lan4=lan4, xg6846=xg6846, staticIpDomainName=staticIpDomainName, lanportName=lanportName, portStatistic=portStatistic, dscpEnable=dscpEnable, staticIpPrimaryDns=staticIpPrimaryDns, jumb=jumb, staticIpAddr=staticIpAddr, vlanid=vlanid, wanType=wanType, speed=speed, jumblan1=jumblan1, lan2=lan2, portmode=portmode, groupid=groupid, catvEnable=catvEnable, tftp=tftp, qosTable=qosTable, bias=bias, adminStatus=adminStatus, port4=port4, lanportpause=lanportpause)
