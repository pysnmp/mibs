...
mib_2, snmpModules, Unsigned32, NotificationType, Counter32, Gauge32, MibIdentifier, ModuleIdentity, enterprises, Integer32, iso, Bits, TimeTicks, IpAddress, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "snmpModules", "Unsigned32", "NotificationType", "Counter32", "Gauge32", "MibIdentifier", "ModuleIdentity", "enterprises", "Integer32", "iso", "Bits", "TimeTicks", "IpAddress", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportTable=lanportTable, qmapping=qmapping, lan3=lan3, xg6846=xg6846, port4=port4, lanportName=lanportName, speed=speed, staticIpSubMask=staticIpSubMask, rxPower=rxPower, modeEntry=modeEntry, unicastsReceived=unicastsReceived, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, portEntry=portEntry, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsReceived=broadcastsReceived, fileType=fileType, groupIndex=groupIndex, domainame=domainame, txPower=txPower, port1=port1, fileName=fileName, portmode=portmode, qosTable=qosTable, priority=priority, portStatistic=portStatistic, groupEntry=groupEntry, lan2=lan2, vlan=vlan, portPower=portPower, temperature=temperature, staticIpDomainName=staticIpDomainName, vendorName=vendorName, deviceinfo=deviceinfo, jumblan3=jumblan3, secondaryDns=secondaryDns, portTable=portTable, internetPort=internetPort, serialnum=serialnum, portName=portName, vlanid=vlanid, multicastsReceived=multicastsReceived, rebootEnable=rebootEnable, qosIndex=qosIndex, statisticTable=statisticTable, tftp=tftp, lanportpause=lanportpause, wan=wan, portIndex=portIndex, fcsErrorTransmitted=fcsErrorTransmitted, catvEnable=catvEnable, vendorRev=vendorRev, port2=port2, primaryDns=primaryDns, unicastsTransmitted=unicastsTransmitted, fcsErrorReceived=fcsErrorReceived, lan1=lan1, tftpSevIp=tftpSevIp, catv=catv, reboot=reboot, port3=port3, jumblan1=jumblan1, action=action, hostname=hostname, vlangroupTable=vlangroupTable, qosEntry=qosEntry, jumbwan=jumbwan, qos=qos, bias=bias, staticIpAddr=staticIpAddr, qmode=qmode, staticDns=staticDns, lanportspeed=lanportspeed, jumblan4=jumblan4, jumblan2=jumblan2, lan4=lan4, vendorOui=vendorOui, staticIpPrimaryDns=staticIpPrimaryDns, lanportIndex=lanportIndex, operStatus=operStatus, groupid=groupid, pauseTransmitted=pauseTransmitted, wanType=wanType, portStatEntry=portStatEntry, ddminfo=ddminfo, multicastsTransmitted=multicastsTransmitted, pauseReceived=pauseReceived, dscpEnable=dscpEnable, staticIpGateway=staticIpGateway, statIndex=statIndex, voltage=voltage, staticIpHostName=staticIpHostName, vendorPn=vendorPn, adminStatus=adminStatus)
