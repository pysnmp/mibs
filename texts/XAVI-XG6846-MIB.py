...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:07:09 2021
...
IpAddress, TimeTicks, MibIdentifier, enterprises, Bits, Integer32, mib_2, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, iso, Gauge32, Unsigned32, snmpModules, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "MibIdentifier", "enterprises", "Bits", "Integer32", "mib-2", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "iso", "Gauge32", "Unsigned32", "snmpModules", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportTable=lanportTable, lan4=lan4, wan=wan, vendorName=vendorName, lan2=lan2, staticIpDomainName=staticIpDomainName, groupid=groupid, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, secondaryDns=secondaryDns, deviceinfo=deviceinfo, vlanid=vlanid, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, multicastsTransmitted=multicastsTransmitted, statisticTable=statisticTable, qosIndex=qosIndex, lanportspeed=lanportspeed, qosTable=qosTable, pauseReceived=pauseReceived, ddminfo=ddminfo, portStatistic=portStatistic, primaryDns=primaryDns, portEntry=portEntry, staticIpSubMask=staticIpSubMask, vendorRev=vendorRev, lan3=lan3, groupIndex=groupIndex, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, adminStatus=adminStatus, serialnum=serialnum, vendorPn=vendorPn, fcsErrorTransmitted=fcsErrorTransmitted, jumblan1=jumblan1, voltage=voltage, wanType=wanType, unicastsTransmitted=unicastsTransmitted, port3=port3, broadcastsTransmitted=broadcastsTransmitted, jumblan4=jumblan4, bias=bias, qmode=qmode, rxPower=rxPower, vendorOui=vendorOui, rebootEnable=rebootEnable, lanportpause=lanportpause, jumb=jumb, staticDns=staticDns, port4=port4, staticIpAddr=staticIpAddr, catvEnable=catvEnable, jumblan2=jumblan2, portStatEntry=portStatEntry, lanportName=lanportName, statIndex=statIndex, internetPort=internetPort, qos=qos, lanportIndex=lanportIndex, portPower=portPower, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, jumbwan=jumbwan, portName=portName, txPower=txPower, modeEntry=modeEntry, domainame=domainame, vlangroupTable=vlangroupTable, portIndex=portIndex, vlan=vlan, dscpEnable=dscpEnable, priority=priority, fileName=fileName, lan1=lan1, portTable=portTable, groupEntry=groupEntry, port2=port2, operStatus=operStatus, qosEntry=qosEntry, fileType=fileType, catv=catv, xg6846=xg6846, temperature=temperature, reboot=reboot, speed=speed, action=action, tftp=tftp, hostname=hostname, qmapping=qmapping, portmode=portmode, staticIpHostName=staticIpHostName)
