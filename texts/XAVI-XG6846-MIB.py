...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:31:56 2022
...
IpAddress, Bits, Gauge32, ModuleIdentity, enterprises, NotificationType, ObjectIdentity, snmpModules, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Counter64, MibIdentifier, Counter32, Unsigned32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Gauge32", "ModuleIdentity", "enterprises", "NotificationType", "ObjectIdentity", "snmpModules", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Counter64", "MibIdentifier", "Counter32", "Unsigned32", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumbwan=jumbwan, portIndex=portIndex, portEntry=portEntry, tftp=tftp, jumblan1=jumblan1, vlanid=vlanid, unicastsReceived=unicastsReceived, secondaryDns=secondaryDns, qosTable=qosTable, jumb=jumb, qos=qos, portmode=portmode, domainame=domainame, serialnum=serialnum, tftpSevIp=tftpSevIp, statisticTable=statisticTable, portTable=portTable, fcsErrorReceived=fcsErrorReceived, lan1=lan1, port1=port1, fileType=fileType, statIndex=statIndex, rxPower=rxPower, vlan=vlan, fileName=fileName, lanportpause=lanportpause, port4=port4, ddminfo=ddminfo, action=action, wan=wan, pauseReceived=pauseReceived, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, portName=portName, staticIpAddr=staticIpAddr, unicastsTransmitted=unicastsTransmitted, xg6846=xg6846, bias=bias, portStatEntry=portStatEntry, lan2=lan2, staticIpSubMask=staticIpSubMask, operStatus=operStatus, rebootEnable=rebootEnable, catvEnable=catvEnable, catv=catv, jumblan3=jumblan3, qosIndex=qosIndex, vendorPn=vendorPn, port2=port2, staticIpSecondaryDns=staticIpSecondaryDns, lanportIndex=lanportIndex, wanType=wanType, adminStatus=adminStatus, portStatistic=portStatistic, staticIpGateway=staticIpGateway, groupIndex=groupIndex, jumblan2=jumblan2, modeEntry=modeEntry, staticIpHostName=staticIpHostName, staticIpPrimaryDns=staticIpPrimaryDns, qmode=qmode, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, lanportName=lanportName, vendorRev=vendorRev, vendorOui=vendorOui, temperature=temperature, lan3=lan3, priority=priority, speed=speed, jumblan4=jumblan4, vendorName=vendorName, fcsErrorTransmitted=fcsErrorTransmitted, qosEntry=qosEntry, reboot=reboot, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, internetPort=internetPort, dscpEnable=dscpEnable, deviceinfo=deviceinfo, lan4=lan4, vlangroupTable=vlangroupTable, groupid=groupid, qmapping=qmapping, port3=port3, voltage=voltage, pauseTransmitted=pauseTransmitted, portPower=portPower, staticDns=staticDns, groupEntry=groupEntry, hostname=hostname, lanportspeed=lanportspeed, multicastsReceived=multicastsReceived, txPower=txPower)
