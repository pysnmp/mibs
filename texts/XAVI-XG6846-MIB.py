...
# Produced by pysmi-1.1.8 at Fri Dec  2 15:56:46 2022
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, Counter32, TimeTicks, NotificationType, IpAddress, Gauge32, ModuleIdentity, Integer32, snmpModules, enterprises, iso, ObjectIdentity, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "Counter32", "TimeTicks", "NotificationType", "IpAddress", "Gauge32", "ModuleIdentity", "Integer32", "snmpModules", "enterprises", "iso", "ObjectIdentity", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port4=port4, groupid=groupid, staticIpDomainName=staticIpDomainName, portTable=portTable, groupIndex=groupIndex, lanportIndex=lanportIndex, port2=port2, vlangroupTable=vlangroupTable, operStatus=operStatus, staticDns=staticDns, staticIpGateway=staticIpGateway, vendorName=vendorName, statIndex=statIndex, lan3=lan3, staticIpPrimaryDns=staticIpPrimaryDns, staticIpAddr=staticIpAddr, jumblan4=jumblan4, qosTable=qosTable, wanType=wanType, domainame=domainame, adminStatus=adminStatus, lan1=lan1, lan4=lan4, secondaryDns=secondaryDns, qmapping=qmapping, vendorPn=vendorPn, portEntry=portEntry, action=action, jumb=jumb, priority=priority, fileName=fileName, txPower=txPower, broadcastsReceived=broadcastsReceived, port1=port1, primaryDns=primaryDns, lanportpause=lanportpause, vlanid=vlanid, fileType=fileType, portStatEntry=portStatEntry, lan2=lan2, portPower=portPower, portStatistic=portStatistic, reboot=reboot, multicastsReceived=multicastsReceived, lanportName=lanportName, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, hostname=hostname, qos=qos, qosEntry=qosEntry, rebootEnable=rebootEnable, qmode=qmode, jumblan3=jumblan3, jumbwan=jumbwan, voltage=voltage, portmode=portmode, xg6846=xg6846, staticIpSubMask=staticIpSubMask, speed=speed, broadcastsTransmitted=broadcastsTransmitted, vlan=vlan, serialnum=serialnum, unicastsTransmitted=unicastsTransmitted, ddminfo=ddminfo, rxPower=rxPower, vendorRev=vendorRev, statisticTable=statisticTable, deviceinfo=deviceinfo, pauseReceived=pauseReceived, multicastsTransmitted=multicastsTransmitted, modeEntry=modeEntry, lanportspeed=lanportspeed, pauseTransmitted=pauseTransmitted, tftp=tftp, jumblan2=jumblan2, wan=wan, temperature=temperature, groupEntry=groupEntry, vendorOui=vendorOui, bias=bias, portIndex=portIndex, catv=catv, jumblan1=jumblan1, catvEnable=catvEnable, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, qosIndex=qosIndex, lanportTable=lanportTable, port3=port3, portName=portName, staticIpHostName=staticIpHostName)
