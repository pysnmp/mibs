...
# Produced by pysmi-1.1.8 at Mon Jan  2 13:17:15 2023
...
ModuleIdentity, iso, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ObjectIdentity, Bits, Counter64, Gauge32, Unsigned32, NotificationType, MibIdentifier, snmpModules, enterprises, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ObjectIdentity", "Bits", "Counter64", "Gauge32", "Unsigned32", "NotificationType", "MibIdentifier", "snmpModules", "enterprises", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsReceived=multicastsReceived, staticIpSubMask=staticIpSubMask, portIndex=portIndex, statIndex=statIndex, staticIpSecondaryDns=staticIpSecondaryDns, jumblan3=jumblan3, vlanid=vlanid, fcsErrorReceived=fcsErrorReceived, port4=port4, vlan=vlan, multicastsTransmitted=multicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, portTable=portTable, vendorOui=vendorOui, tftpSevIp=tftpSevIp, portEntry=portEntry, staticDns=staticDns, vendorPn=vendorPn, catvEnable=catvEnable, action=action, port2=port2, groupid=groupid, groupIndex=groupIndex, staticIpAddr=staticIpAddr, jumblan1=jumblan1, hostname=hostname, staticIpGateway=staticIpGateway, unicastsReceived=unicastsReceived, jumblan2=jumblan2, jumbwan=jumbwan, portmode=portmode, lan4=lan4, lan1=lan1, reboot=reboot, qosIndex=qosIndex, lanportIndex=lanportIndex, qosTable=qosTable, voltage=voltage, bias=bias, fileType=fileType, staticIpDomainName=staticIpDomainName, serialnum=serialnum, speed=speed, pauseTransmitted=pauseTransmitted, qmode=qmode, unicastsTransmitted=unicastsTransmitted, portStatistic=portStatistic, port3=port3, fileName=fileName, catv=catv, rebootEnable=rebootEnable, lanportpause=lanportpause, lanportTable=lanportTable, primaryDns=primaryDns, broadcastsReceived=broadcastsReceived, operStatus=operStatus, jumb=jumb, qmapping=qmapping, pauseReceived=pauseReceived, qos=qos, txPower=txPower, tftp=tftp, xg6846=xg6846, temperature=temperature, lan3=lan3, broadcastsTransmitted=broadcastsTransmitted, jumblan4=jumblan4, ddminfo=ddminfo, lanportspeed=lanportspeed, portPower=portPower, lanportName=lanportName, rxPower=rxPower, modeEntry=modeEntry, vendorName=vendorName, internetPort=internetPort, qosEntry=qosEntry, domainame=domainame, port1=port1, secondaryDns=secondaryDns, staticIpHostName=staticIpHostName, priority=priority, statisticTable=statisticTable, adminStatus=adminStatus, portName=portName, vendorRev=vendorRev, portStatEntry=portStatEntry, deviceinfo=deviceinfo, wanType=wanType, vlangroupTable=vlangroupTable, lan2=lan2, wan=wan, fcsErrorTransmitted=fcsErrorTransmitted, groupEntry=groupEntry, dscpEnable=dscpEnable)
