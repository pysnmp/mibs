...
Counter32, IpAddress, MibIdentifier, Gauge32, ObjectIdentity, Unsigned32, enterprises, Integer32, Bits, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter64, TimeTicks, NotificationType, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "MibIdentifier", "Gauge32", "ObjectIdentity", "Unsigned32", "enterprises", "Integer32", "Bits", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter64", "TimeTicks", "NotificationType", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportIndex=lanportIndex, hostname=hostname, statIndex=statIndex, staticIpSubMask=staticIpSubMask, qmode=qmode, port4=port4, jumblan3=jumblan3, lanportspeed=lanportspeed, ddminfo=ddminfo, lan3=lan3, port2=port2, vendorName=vendorName, lan1=lan1, dscpEnable=dscpEnable, lanportName=lanportName, qosEntry=qosEntry, portPower=portPower, unicastsReceived=unicastsReceived, action=action, port1=port1, portStatEntry=portStatEntry, catv=catv, vlan=vlan, multicastsTransmitted=multicastsTransmitted, pauseTransmitted=pauseTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, lan2=lan2, portEntry=portEntry, groupIndex=groupIndex, portTable=portTable, reboot=reboot, voltage=voltage, rebootEnable=rebootEnable, domainame=domainame, secondaryDns=secondaryDns, fileType=fileType, speed=speed, unicastsTransmitted=unicastsTransmitted, multicastsReceived=multicastsReceived, statisticTable=statisticTable, lan4=lan4, vendorPn=vendorPn, groupid=groupid, staticIpHostName=staticIpHostName, jumb=jumb, wan=wan, pauseReceived=pauseReceived, jumblan1=jumblan1, groupEntry=groupEntry, modeEntry=modeEntry, broadcastsReceived=broadcastsReceived, xg6846=xg6846, rxPower=rxPower, vlangroupTable=vlangroupTable, jumbwan=jumbwan, tftp=tftp, lanportpause=lanportpause, deviceinfo=deviceinfo, primaryDns=primaryDns, portStatistic=portStatistic, tftpSevIp=tftpSevIp, staticIpAddr=staticIpAddr, vendorOui=vendorOui, vlanid=vlanid, fcsErrorReceived=fcsErrorReceived, qosTable=qosTable, staticDns=staticDns, port3=port3, fileName=fileName, wanType=wanType, qosIndex=qosIndex, priority=priority, jumblan2=jumblan2, qos=qos, portmode=portmode, txPower=txPower, staticIpSecondaryDns=staticIpSecondaryDns, bias=bias, internetPort=internetPort, portIndex=portIndex, operStatus=operStatus, temperature=temperature, vendorRev=vendorRev, serialnum=serialnum, staticIpPrimaryDns=staticIpPrimaryDns, catvEnable=catvEnable, lanportTable=lanportTable, staticIpDomainName=staticIpDomainName, broadcastsTransmitted=broadcastsTransmitted, staticIpGateway=staticIpGateway, portName=portName, jumblan4=jumblan4, qmapping=qmapping, adminStatus=adminStatus)
