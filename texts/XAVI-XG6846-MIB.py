...
mib_2, Counter64, ObjectIdentity, Gauge32, ModuleIdentity, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, snmpModules, enterprises, Integer32, iso, Bits, MibIdentifier, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter64", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "snmpModules", "enterprises", "Integer32", "iso", "Bits", "MibIdentifier", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portIndex=portIndex, lan2=lan2, staticIpSubMask=staticIpSubMask, portPower=portPower, staticIpDomainName=staticIpDomainName, port2=port2, internetPort=internetPort, vendorOui=vendorOui, jumblan4=jumblan4, catvEnable=catvEnable, jumblan3=jumblan3, jumbwan=jumbwan, hostname=hostname, primaryDns=primaryDns, qosIndex=qosIndex, deviceinfo=deviceinfo, jumb=jumb, portTable=portTable, bias=bias, lan1=lan1, vlanid=vlanid, portStatEntry=portStatEntry, xg6846=xg6846, statIndex=statIndex, speed=speed, reboot=reboot, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, multicastsReceived=multicastsReceived, lanportTable=lanportTable, groupEntry=groupEntry, temperature=temperature, domainame=domainame, qosTable=qosTable, vendorPn=vendorPn, staticIpGateway=staticIpGateway, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsTransmitted=broadcastsTransmitted, lan4=lan4, unicastsTransmitted=unicastsTransmitted, rxPower=rxPower, adminStatus=adminStatus, priority=priority, groupIndex=groupIndex, lanportIndex=lanportIndex, vlangroupTable=vlangroupTable, qmapping=qmapping, serialnum=serialnum, portEntry=portEntry, lanportspeed=lanportspeed, dscpEnable=dscpEnable, catv=catv, modeEntry=modeEntry, txPower=txPower, lan3=lan3, jumblan2=jumblan2, fcsErrorTransmitted=fcsErrorTransmitted, staticIpHostName=staticIpHostName, portName=portName, statisticTable=statisticTable, multicastsTransmitted=multicastsTransmitted, port3=port3, vendorRev=vendorRev, portmode=portmode, ddminfo=ddminfo, secondaryDns=secondaryDns, broadcastsReceived=broadcastsReceived, tftp=tftp, voltage=voltage, vlan=vlan, lanportName=lanportName, port1=port1, fileName=fileName, unicastsReceived=unicastsReceived, wanType=wanType, lanportpause=lanportpause, groupid=groupid, rebootEnable=rebootEnable, staticIpPrimaryDns=staticIpPrimaryDns, tftpSevIp=tftpSevIp, vendorName=vendorName, pauseReceived=pauseReceived, port4=port4, qosEntry=qosEntry, operStatus=operStatus, fileType=fileType, staticDns=staticDns, pauseTransmitted=pauseTransmitted, jumblan1=jumblan1, wan=wan, qos=qos, qmode=qmode, action=action, portStatistic=portStatistic)
