...
ObjectIdentity, Unsigned32, ModuleIdentity, Counter64, TimeTicks, mib_2, enterprises, IpAddress, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, NotificationType, Gauge32, Counter32, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter64", "TimeTicks", "mib-2", "enterprises", "IpAddress", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "NotificationType", "Gauge32", "Counter32", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupEntry=groupEntry, staticIpSubMask=staticIpSubMask, statisticTable=statisticTable, vlanid=vlanid, catvEnable=catvEnable, xg6846=xg6846, staticIpPrimaryDns=staticIpPrimaryDns, groupid=groupid, vendorPn=vendorPn, lanportName=lanportName, priority=priority, lanportTable=lanportTable, lanportIndex=lanportIndex, voltage=voltage, vendorRev=vendorRev, wan=wan, adminStatus=adminStatus, lan4=lan4, temperature=temperature, vendorOui=vendorOui, jumb=jumb, lan3=lan3, qmode=qmode, rebootEnable=rebootEnable, staticIpHostName=staticIpHostName, staticIpAddr=staticIpAddr, qosTable=qosTable, staticIpSecondaryDns=staticIpSecondaryDns, speed=speed, portStatistic=portStatistic, fcsErrorTransmitted=fcsErrorTransmitted, tftpSevIp=tftpSevIp, broadcastsReceived=broadcastsReceived, hostname=hostname, portmode=portmode, lan2=lan2, fcsErrorReceived=fcsErrorReceived, qmapping=qmapping, unicastsReceived=unicastsReceived, tftp=tftp, rxPower=rxPower, jumblan2=jumblan2, reboot=reboot, jumblan4=jumblan4, deviceinfo=deviceinfo, internetPort=internetPort, secondaryDns=secondaryDns, dscpEnable=dscpEnable, broadcastsTransmitted=broadcastsTransmitted, multicastsReceived=multicastsReceived, multicastsTransmitted=multicastsTransmitted, fileName=fileName, fileType=fileType, unicastsTransmitted=unicastsTransmitted, pauseTransmitted=pauseTransmitted, qosEntry=qosEntry, operStatus=operStatus, jumbwan=jumbwan, groupIndex=groupIndex, lan1=lan1, statIndex=statIndex, vendorName=vendorName, txPower=txPower, bias=bias, staticIpGateway=staticIpGateway, vlan=vlan, pauseReceived=pauseReceived, staticIpDomainName=staticIpDomainName, wanType=wanType, qosIndex=qosIndex, portTable=portTable, domainame=domainame, vlangroupTable=vlangroupTable, portIndex=portIndex, ddminfo=ddminfo, staticDns=staticDns, catv=catv, port3=port3, jumblan1=jumblan1, portName=portName, portPower=portPower, modeEntry=modeEntry, serialnum=serialnum, jumblan3=jumblan3, lanportspeed=lanportspeed, action=action, portEntry=portEntry, qos=qos, primaryDns=primaryDns, port4=port4, port2=port2, lanportpause=lanportpause, portStatEntry=portStatEntry, port1=port1)
