...
# Produced by pysmi-1.1.8 at Thu Sep  7 10:18:31 2023
...
TimeTicks, snmpModules, IpAddress, Counter64, Counter32, Gauge32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, ObjectIdentity, Unsigned32, MibIdentifier, enterprises, ModuleIdentity, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "snmpModules", "IpAddress", "Counter64", "Counter32", "Gauge32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "ObjectIdentity", "Unsigned32", "MibIdentifier", "enterprises", "ModuleIdentity", "iso", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorRev=vendorRev, catv=catv, statisticTable=statisticTable, vendorPn=vendorPn, pauseReceived=pauseReceived, action=action, jumblan1=jumblan1, priority=priority, rebootEnable=rebootEnable, secondaryDns=secondaryDns, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, catvEnable=catvEnable, xg6846=xg6846, staticIpDomainName=staticIpDomainName, ddminfo=ddminfo, port1=port1, hostname=hostname, tftp=tftp, staticIpAddr=staticIpAddr, fileName=fileName, jumblan2=jumblan2, qosTable=qosTable, speed=speed, vlan=vlan, wanType=wanType, domainame=domainame, qos=qos, lan1=lan1, rxPower=rxPower, reboot=reboot, internetPort=internetPort, jumb=jumb, deviceinfo=deviceinfo, groupIndex=groupIndex, qmode=qmode, port4=port4, lan4=lan4, portEntry=portEntry, fcsErrorTransmitted=fcsErrorTransmitted, lan2=lan2, multicastsReceived=multicastsReceived, vendorOui=vendorOui, fileType=fileType, lanportspeed=lanportspeed, broadcastsReceived=broadcastsReceived, jumbwan=jumbwan, staticIpGateway=staticIpGateway, port2=port2, portPower=portPower, jumblan4=jumblan4, lanportName=lanportName, qosIndex=qosIndex, portStatistic=portStatistic, qosEntry=qosEntry, statIndex=statIndex, pauseTransmitted=pauseTransmitted, txPower=txPower, dscpEnable=dscpEnable, groupid=groupid, vlanid=vlanid, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, lanportpause=lanportpause, operStatus=operStatus, wan=wan, lan3=lan3, jumblan3=jumblan3, serialnum=serialnum, portTable=portTable, adminStatus=adminStatus, tftpSevIp=tftpSevIp, qmapping=qmapping, portStatEntry=portStatEntry, bias=bias, modeEntry=modeEntry, portmode=portmode, portName=portName, lanportIndex=lanportIndex, voltage=voltage, vendorName=vendorName, broadcastsTransmitted=broadcastsTransmitted, multicastsTransmitted=multicastsTransmitted, groupEntry=groupEntry, staticIpHostName=staticIpHostName, temperature=temperature, staticDns=staticDns, primaryDns=primaryDns, lanportTable=lanportTable, unicastsReceived=unicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, port3=port3, staticIpSecondaryDns=staticIpSecondaryDns, unicastsTransmitted=unicastsTransmitted)
