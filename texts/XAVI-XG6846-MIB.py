...
ModuleIdentity, Unsigned32, enterprises, Integer32, Bits, MibIdentifier, mib_2, ObjectIdentity, Counter64, IpAddress, Counter32, NotificationType, iso, Gauge32, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "enterprises", "Integer32", "Bits", "MibIdentifier", "mib-2", "ObjectIdentity", "Counter64", "IpAddress", "Counter32", "NotificationType", "iso", "Gauge32", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosTable=qosTable, staticIpDomainName=staticIpDomainName, deviceinfo=deviceinfo, secondaryDns=secondaryDns, jumbwan=jumbwan, groupid=groupid, statisticTable=statisticTable, port1=port1, xg6846=xg6846, staticIpPrimaryDns=staticIpPrimaryDns, dscpEnable=dscpEnable, pauseTransmitted=pauseTransmitted, speed=speed, port4=port4, vlanid=vlanid, qmode=qmode, vendorRev=vendorRev, wanType=wanType, operStatus=operStatus, statIndex=statIndex, internetPort=internetPort, vendorName=vendorName, portmode=portmode, action=action, catvEnable=catvEnable, hostname=hostname, jumblan1=jumblan1, vlangroupTable=vlangroupTable, fcsErrorReceived=fcsErrorReceived, lan4=lan4, lan3=lan3, lan1=lan1, groupIndex=groupIndex, rebootEnable=rebootEnable, groupEntry=groupEntry, staticIpSubMask=staticIpSubMask, lanportIndex=lanportIndex, bias=bias, ddminfo=ddminfo, voltage=voltage, staticIpSecondaryDns=staticIpSecondaryDns, lanportName=lanportName, wan=wan, serialnum=serialnum, unicastsReceived=unicastsReceived, tftpSevIp=tftpSevIp, vendorPn=vendorPn, modeEntry=modeEntry, staticIpAddr=staticIpAddr, multicastsTransmitted=multicastsTransmitted, multicastsReceived=multicastsReceived, priority=priority, jumblan2=jumblan2, port2=port2, portPower=portPower, vlan=vlan, txPower=txPower, qosEntry=qosEntry, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, portIndex=portIndex, staticDns=staticDns, pauseReceived=pauseReceived, jumblan4=jumblan4, qosIndex=qosIndex, lanportspeed=lanportspeed, portStatistic=portStatistic, portStatEntry=portStatEntry, fcsErrorTransmitted=fcsErrorTransmitted, domainame=domainame, catv=catv, adminStatus=adminStatus, jumblan3=jumblan3, broadcastsReceived=broadcastsReceived, fileType=fileType, staticIpGateway=staticIpGateway, tftp=tftp, portEntry=portEntry, port3=port3, portTable=portTable, portName=portName, lanportTable=lanportTable, fileName=fileName, lanportpause=lanportpause, lan2=lan2, temperature=temperature, primaryDns=primaryDns, jumb=jumb, qmapping=qmapping, rxPower=rxPower, qos=qos, staticIpHostName=staticIpHostName, reboot=reboot, broadcastsTransmitted=broadcastsTransmitted)
