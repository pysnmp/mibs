...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Gauge32, enterprises, MibIdentifier, IpAddress, Counter64, Counter32, Unsigned32, Bits, ModuleIdentity, mib_2, iso, NotificationType, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Gauge32", "enterprises", "MibIdentifier", "IpAddress", "Counter64", "Counter32", "Unsigned32", "Bits", "ModuleIdentity", "mib-2", "iso", "NotificationType", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsTransmitted=multicastsTransmitted, lan1=lan1, temperature=temperature, groupIndex=groupIndex, statIndex=statIndex, vlanid=vlanid, secondaryDns=secondaryDns, jumblan3=jumblan3, operStatus=operStatus, staticIpDomainName=staticIpDomainName, serialnum=serialnum, lanportspeed=lanportspeed, broadcastsReceived=broadcastsReceived, internetPort=internetPort, fileType=fileType, jumblan4=jumblan4, vendorName=vendorName, lanportName=lanportName, wanType=wanType, pauseTransmitted=pauseTransmitted, priority=priority, xg6846=xg6846, groupid=groupid, qmapping=qmapping, jumb=jumb, primaryDns=primaryDns, wan=wan, tftpSevIp=tftpSevIp, speed=speed, jumblan2=jumblan2, portStatistic=portStatistic, voltage=voltage, lanportTable=lanportTable, portStatEntry=portStatEntry, qos=qos, pauseReceived=pauseReceived, qmode=qmode, portName=portName, reboot=reboot, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, lan3=lan3, portEntry=portEntry, hostname=hostname, port2=port2, broadcastsTransmitted=broadcastsTransmitted, lan4=lan4, catv=catv, lanportIndex=lanportIndex, dscpEnable=dscpEnable, rebootEnable=rebootEnable, staticIpAddr=staticIpAddr, rxPower=rxPower, deviceinfo=deviceinfo, unicastsTransmitted=unicastsTransmitted, qosEntry=qosEntry, catvEnable=catvEnable, bias=bias, staticIpSecondaryDns=staticIpSecondaryDns, portPower=portPower, statisticTable=statisticTable, multicastsReceived=multicastsReceived, staticIpGateway=staticIpGateway, staticIpHostName=staticIpHostName, qosTable=qosTable, ddminfo=ddminfo, vlan=vlan, txPower=txPower, domainame=domainame, tftp=tftp, qosIndex=qosIndex, lanportpause=lanportpause, unicastsReceived=unicastsReceived, portIndex=portIndex, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, port4=port4, vendorRev=vendorRev, jumbwan=jumbwan, portTable=portTable, fileName=fileName, modeEntry=modeEntry, port3=port3, adminStatus=adminStatus, vendorPn=vendorPn, groupEntry=groupEntry, lan2=lan2, fcsErrorReceived=fcsErrorReceived, vendorOui=vendorOui, vlangroupTable=vlangroupTable, staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, action=action)
