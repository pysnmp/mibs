...
# Produced by pysmi-1.1.12 at Fri Jul 19 11:37:49 2024
...
Counter32, MibIdentifier, NotificationType, ObjectIdentity, TimeTicks, Gauge32, ModuleIdentity, Integer32, iso, Bits, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, mib_2, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "NotificationType", "ObjectIdentity", "TimeTicks", "Gauge32", "ModuleIdentity", "Integer32", "iso", "Bits", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "mib-2", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port3=port3, jumblan4=jumblan4, staticIpHostName=staticIpHostName, port1=port1, lan4=lan4, vendorRev=vendorRev, fileName=fileName, hostname=hostname, staticDns=staticDns, tftp=tftp, domainame=domainame, vendorPn=vendorPn, portEntry=portEntry, reboot=reboot, vlanid=vlanid, rebootEnable=rebootEnable, lanportTable=lanportTable, jumblan2=jumblan2, vlangroupTable=vlangroupTable, unicastsTransmitted=unicastsTransmitted, qmapping=qmapping, txPower=txPower, action=action, pauseTransmitted=pauseTransmitted, voltage=voltage, dscpEnable=dscpEnable, lanportIndex=lanportIndex, catvEnable=catvEnable, groupIndex=groupIndex, jumblan1=jumblan1, qosEntry=qosEntry, wanType=wanType, staticIpDomainName=staticIpDomainName, jumbwan=jumbwan, staticIpAddr=staticIpAddr, lan2=lan2, portStatEntry=portStatEntry, groupid=groupid, qos=qos, portStatistic=portStatistic, catv=catv, speed=speed, staticIpSubMask=staticIpSubMask, adminStatus=adminStatus, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsTransmitted=broadcastsTransmitted, pauseReceived=pauseReceived, operStatus=operStatus, vlan=vlan, qmode=qmode, primaryDns=primaryDns, fileType=fileType, lanportName=lanportName, multicastsReceived=multicastsReceived, portTable=portTable, bias=bias, ddminfo=ddminfo, statIndex=statIndex, tftpSevIp=tftpSevIp, lanportpause=lanportpause, qosTable=qosTable, qosIndex=qosIndex, rxPower=rxPower, port2=port2, serialnum=serialnum, jumb=jumb, temperature=temperature, portName=portName, groupEntry=groupEntry, deviceinfo=deviceinfo, broadcastsReceived=broadcastsReceived, lan1=lan1, lan3=lan3, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, portPower=portPower, port4=port4, jumblan3=jumblan3, portmode=portmode, vendorName=vendorName, priority=priority, statisticTable=statisticTable, staticIpGateway=staticIpGateway, secondaryDns=secondaryDns, multicastsTransmitted=multicastsTransmitted, lanportspeed=lanportspeed, vendorOui=vendorOui, unicastsReceived=unicastsReceived, modeEntry=modeEntry, fcsErrorTransmitted=fcsErrorTransmitted, wan=wan, internetPort=internetPort)
