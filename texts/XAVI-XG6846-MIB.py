...
iso, snmpModules, TimeTicks, ModuleIdentity, mib_2, Integer32, Bits, Gauge32, IpAddress, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, MibIdentifier, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "snmpModules", "TimeTicks", "ModuleIdentity", "mib-2", "Integer32", "Bits", "Gauge32", "IpAddress", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "MibIdentifier", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", bias=bias, secondaryDns=secondaryDns, staticIpHostName=staticIpHostName, qmapping=qmapping, speed=speed, portStatEntry=portStatEntry, rxPower=rxPower, priority=priority, staticIpDomainName=staticIpDomainName, qosTable=qosTable, rebootEnable=rebootEnable, unicastsTransmitted=unicastsTransmitted, vlanid=vlanid, fcsErrorReceived=fcsErrorReceived, wanType=wanType, deviceinfo=deviceinfo, lanportTable=lanportTable, portmode=portmode, dscpEnable=dscpEnable, fileType=fileType, qosEntry=qosEntry, vlangroupTable=vlangroupTable, vendorName=vendorName, jumblan1=jumblan1, staticIpPrimaryDns=staticIpPrimaryDns, portPower=portPower, port4=port4, port3=port3, staticDns=staticDns, lanportName=lanportName, txPower=txPower, portIndex=portIndex, statIndex=statIndex, portStatistic=portStatistic, staticIpSecondaryDns=staticIpSecondaryDns, lan1=lan1, groupEntry=groupEntry, jumb=jumb, lan3=lan3, domainame=domainame, fileName=fileName, statisticTable=statisticTable, lanportpause=lanportpause, reboot=reboot, lanportIndex=lanportIndex, primaryDns=primaryDns, qosIndex=qosIndex, qmode=qmode, internetPort=internetPort, adminStatus=adminStatus, vlan=vlan, port2=port2, hostname=hostname, portName=portName, jumblan4=jumblan4, qos=qos, jumblan3=jumblan3, serialnum=serialnum, portTable=portTable, unicastsReceived=unicastsReceived, portEntry=portEntry, jumbwan=jumbwan, ddminfo=ddminfo, operStatus=operStatus, modeEntry=modeEntry, lanportspeed=lanportspeed, action=action, tftp=tftp, catv=catv, lan2=lan2, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, pauseReceived=pauseReceived, catvEnable=catvEnable, groupid=groupid, broadcastsReceived=broadcastsReceived, jumblan2=jumblan2, wan=wan, multicastsReceived=multicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, voltage=voltage, xg6846=xg6846, multicastsTransmitted=multicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, vendorRev=vendorRev, port1=port1, staticIpAddr=staticIpAddr, vendorOui=vendorOui, temperature=temperature, groupIndex=groupIndex, lan4=lan4, vendorPn=vendorPn, tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask)
