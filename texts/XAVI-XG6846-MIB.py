...
ModuleIdentity, enterprises, snmpModules, ObjectIdentity, Unsigned32, Counter32, mib_2, IpAddress, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, TimeTicks, Bits, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "snmpModules", "ObjectIdentity", "Unsigned32", "Counter32", "mib-2", "IpAddress", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "TimeTicks", "Bits", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsTransmitted=multicastsTransmitted, vendorName=vendorName, adminStatus=adminStatus, jumblan2=jumblan2, port4=port4, speed=speed, staticIpAddr=staticIpAddr, lanportIndex=lanportIndex, domainame=domainame, portStatEntry=portStatEntry, vendorPn=vendorPn, staticIpHostName=staticIpHostName, wanType=wanType, txPower=txPower, qosIndex=qosIndex, statIndex=statIndex, qosTable=qosTable, rebootEnable=rebootEnable, lan4=lan4, deviceinfo=deviceinfo, multicastsReceived=multicastsReceived, jumblan3=jumblan3, secondaryDns=secondaryDns, action=action, jumblan4=jumblan4, qmode=qmode, modeEntry=modeEntry, port2=port2, staticIpSecondaryDns=staticIpSecondaryDns, pauseReceived=pauseReceived, lanportpause=lanportpause, temperature=temperature, port1=port1, priority=priority, staticIpDomainName=staticIpDomainName, staticIpGateway=staticIpGateway, jumblan1=jumblan1, unicastsReceived=unicastsReceived, ddminfo=ddminfo, catv=catv, jumbwan=jumbwan, dscpEnable=dscpEnable, primaryDns=primaryDns, portName=portName, wan=wan, groupid=groupid, qos=qos, lan3=lan3, portEntry=portEntry, tftp=tftp, fcsErrorReceived=fcsErrorReceived, portIndex=portIndex, vlanid=vlanid, lanportName=lanportName, tftpSevIp=tftpSevIp, vlan=vlan, vlangroupTable=vlangroupTable, xg6846=xg6846, vendorOui=vendorOui, groupIndex=groupIndex, lan1=lan1, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, pauseTransmitted=pauseTransmitted, catvEnable=catvEnable, lanportTable=lanportTable, serialnum=serialnum, lan2=lan2, fileType=fileType, voltage=voltage, jumb=jumb, operStatus=operStatus, portTable=portTable, hostname=hostname, qosEntry=qosEntry, portmode=portmode, portStatistic=portStatistic, groupEntry=groupEntry, rxPower=rxPower, unicastsTransmitted=unicastsTransmitted, port3=port3, broadcastsTransmitted=broadcastsTransmitted, statisticTable=statisticTable, broadcastsReceived=broadcastsReceived, bias=bias, staticDns=staticDns, portPower=portPower, lanportspeed=lanportspeed, fileName=fileName, qmapping=qmapping, fcsErrorTransmitted=fcsErrorTransmitted, vendorRev=vendorRev, staticIpSubMask=staticIpSubMask, reboot=reboot)
