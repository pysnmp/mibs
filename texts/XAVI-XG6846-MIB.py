...
# Produced by pysmi-1.1.8 at Sat Jan 15 05:29:12 2022
...
MibIdentifier, iso, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, Counter32, TimeTicks, enterprises, mib_2, snmpModules, Integer32, IpAddress, NotificationType, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "Counter32", "TimeTicks", "enterprises", "mib-2", "snmpModules", "Integer32", "IpAddress", "NotificationType", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftp=tftp, jumb=jumb, port4=port4, staticIpPrimaryDns=staticIpPrimaryDns, portIndex=portIndex, qmapping=qmapping, pauseTransmitted=pauseTransmitted, vlan=vlan, lan4=lan4, txPower=txPower, primaryDns=primaryDns, port3=port3, portName=portName, jumbwan=jumbwan, vendorName=vendorName, fileName=fileName, operStatus=operStatus, port1=port1, modeEntry=modeEntry, catvEnable=catvEnable, unicastsReceived=unicastsReceived, secondaryDns=secondaryDns, lan3=lan3, domainame=domainame, lanportIndex=lanportIndex, portmode=portmode, qosIndex=qosIndex, unicastsTransmitted=unicastsTransmitted, reboot=reboot, lanportspeed=lanportspeed, portStatEntry=portStatEntry, ddminfo=ddminfo, lanportName=lanportName, jumblan1=jumblan1, deviceinfo=deviceinfo, jumblan4=jumblan4, multicastsTransmitted=multicastsTransmitted, broadcastsReceived=broadcastsReceived, vlangroupTable=vlangroupTable, broadcastsTransmitted=broadcastsTransmitted, portPower=portPower, lanportTable=lanportTable, rxPower=rxPower, serialnum=serialnum, priority=priority, staticIpHostName=staticIpHostName, portStatistic=portStatistic, voltage=voltage, speed=speed, qmode=qmode, qosTable=qosTable, portEntry=portEntry, hostname=hostname, rebootEnable=rebootEnable, staticIpGateway=staticIpGateway, lan2=lan2, tftpSevIp=tftpSevIp, action=action, vendorRev=vendorRev, portTable=portTable, port2=port2, vendorPn=vendorPn, xg6846=xg6846, dscpEnable=dscpEnable, lanportpause=lanportpause, groupEntry=groupEntry, groupid=groupid, staticDns=staticDns, adminStatus=adminStatus, statIndex=statIndex, internetPort=internetPort, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, fileType=fileType, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSubMask=staticIpSubMask, qosEntry=qosEntry, lan1=lan1, staticIpDomainName=staticIpDomainName, wanType=wanType, wan=wan, staticIpAddr=staticIpAddr, bias=bias, groupIndex=groupIndex, vlanid=vlanid, catv=catv, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, qos=qos, multicastsReceived=multicastsReceived, pauseReceived=pauseReceived, vendorOui=vendorOui, jumblan2=jumblan2, statisticTable=statisticTable)
