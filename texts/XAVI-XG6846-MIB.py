...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:38:13 2021
...
Counter32, iso, Counter64, Unsigned32, MibIdentifier, ModuleIdentity, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, Bits, ObjectIdentity, NotificationType, enterprises, snmpModules, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "Counter64", "Unsigned32", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "Bits", "ObjectIdentity", "NotificationType", "enterprises", "snmpModules", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlanid=vlanid, xg6846=xg6846, qosTable=qosTable, staticIpAddr=staticIpAddr, portEntry=portEntry, unicastsTransmitted=unicastsTransmitted, serialnum=serialnum, fileName=fileName, staticIpGateway=staticIpGateway, qmode=qmode, domainame=domainame, catv=catv, lanportTable=lanportTable, catvEnable=catvEnable, staticIpDomainName=staticIpDomainName, modeEntry=modeEntry, pauseReceived=pauseReceived, qosEntry=qosEntry, vendorPn=vendorPn, voltage=voltage, portIndex=portIndex, statIndex=statIndex, lanportspeed=lanportspeed, wan=wan, vlan=vlan, rebootEnable=rebootEnable, jumblan2=jumblan2, lanportIndex=lanportIndex, staticIpPrimaryDns=staticIpPrimaryDns, lan3=lan3, txPower=txPower, broadcastsTransmitted=broadcastsTransmitted, portName=portName, hostname=hostname, portTable=portTable, port4=port4, vendorName=vendorName, jumblan3=jumblan3, tftpSevIp=tftpSevIp, operStatus=operStatus, jumb=jumb, temperature=temperature, jumblan4=jumblan4, action=action, qos=qos, priority=priority, staticIpSecondaryDns=staticIpSecondaryDns, port3=port3, statisticTable=statisticTable, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, qmapping=qmapping, jumblan1=jumblan1, pauseTransmitted=pauseTransmitted, jumbwan=jumbwan, deviceinfo=deviceinfo, portPower=portPower, groupEntry=groupEntry, lan1=lan1, unicastsReceived=unicastsReceived, groupIndex=groupIndex, lanportName=lanportName, staticDns=staticDns, broadcastsReceived=broadcastsReceived, multicastsTransmitted=multicastsTransmitted, reboot=reboot, multicastsReceived=multicastsReceived, lan4=lan4, speed=speed, adminStatus=adminStatus, staticIpSubMask=staticIpSubMask, port2=port2, qosIndex=qosIndex, ddminfo=ddminfo, secondaryDns=secondaryDns, vendorRev=vendorRev, primaryDns=primaryDns, staticIpHostName=staticIpHostName, port1=port1, groupid=groupid, rxPower=rxPower, fcsErrorReceived=fcsErrorReceived, vendorOui=vendorOui, lanportpause=lanportpause, vlangroupTable=vlangroupTable, lan2=lan2, portStatistic=portStatistic, portStatEntry=portStatEntry, portmode=portmode, bias=bias, tftp=tftp, dscpEnable=dscpEnable, fileType=fileType, wanType=wanType)
