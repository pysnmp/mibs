...
ModuleIdentity, Gauge32, Bits, snmpModules, Counter64, ObjectIdentity, enterprises, Counter32, TimeTicks, Integer32, Unsigned32, MibIdentifier, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Bits", "snmpModules", "Counter64", "ObjectIdentity", "enterprises", "Counter32", "TimeTicks", "Integer32", "Unsigned32", "MibIdentifier", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port2=port2, broadcastsReceived=broadcastsReceived, vendorRev=vendorRev, groupEntry=groupEntry, lan3=lan3, vlanid=vlanid, lanportName=lanportName, dscpEnable=dscpEnable, jumb=jumb, staticDns=staticDns, port3=port3, reboot=reboot, fcsErrorTransmitted=fcsErrorTransmitted, xg6846=xg6846, groupid=groupid, qmapping=qmapping, jumblan2=jumblan2, vendorOui=vendorOui, pauseTransmitted=pauseTransmitted, lan4=lan4, unicastsTransmitted=unicastsTransmitted, adminStatus=adminStatus, staticIpGateway=staticIpGateway, fcsErrorReceived=fcsErrorReceived, catvEnable=catvEnable, qos=qos, fileName=fileName, secondaryDns=secondaryDns, primaryDns=primaryDns, staticIpAddr=staticIpAddr, jumblan3=jumblan3, vlangroupTable=vlangroupTable, qosTable=qosTable, modeEntry=modeEntry, speed=speed, wan=wan, txPower=txPower, voltage=voltage, wanType=wanType, vlan=vlan, qosIndex=qosIndex, temperature=temperature, fileType=fileType, staticIpHostName=staticIpHostName, tftpSevIp=tftpSevIp, serialnum=serialnum, lan2=lan2, portStatEntry=portStatEntry, jumblan4=jumblan4, lanportspeed=lanportspeed, vendorName=vendorName, internetPort=internetPort, domainame=domainame, rxPower=rxPower, multicastsReceived=multicastsReceived, statisticTable=statisticTable, portPower=portPower, staticIpDomainName=staticIpDomainName, catv=catv, portTable=portTable, multicastsTransmitted=multicastsTransmitted, port4=port4, jumbwan=jumbwan, priority=priority, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, vendorPn=vendorPn, statIndex=statIndex, portName=portName, lanportIndex=lanportIndex, unicastsReceived=unicastsReceived, operStatus=operStatus, pauseReceived=pauseReceived, portEntry=portEntry, rebootEnable=rebootEnable, portIndex=portIndex, lanportpause=lanportpause, portmode=portmode, portStatistic=portStatistic, broadcastsTransmitted=broadcastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, lan1=lan1, lanportTable=lanportTable, qmode=qmode, groupIndex=groupIndex, ddminfo=ddminfo, hostname=hostname, jumblan1=jumblan1, deviceinfo=deviceinfo, staticIpSubMask=staticIpSubMask, port1=port1, qosEntry=qosEntry, tftp=tftp, action=action)
