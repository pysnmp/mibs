...
# Produced by pysmi-1.1.8 at Sat Jan 15 18:07:17 2022
...
Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, ObjectIdentity, TimeTicks, iso, ModuleIdentity, Counter64, snmpModules, mib_2, IpAddress, Bits, NotificationType, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "ObjectIdentity", "TimeTicks", "iso", "ModuleIdentity", "Counter64", "snmpModules", "mib-2", "IpAddress", "Bits", "NotificationType", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", domainame=domainame, adminStatus=adminStatus, vlan=vlan, qos=qos, lanportIndex=lanportIndex, unicastsTransmitted=unicastsTransmitted, fileType=fileType, port2=port2, qmapping=qmapping, rebootEnable=rebootEnable, vendorPn=vendorPn, reboot=reboot, port4=port4, groupid=groupid, ddminfo=ddminfo, multicastsTransmitted=multicastsTransmitted, port3=port3, vlangroupTable=vlangroupTable, dscpEnable=dscpEnable, deviceinfo=deviceinfo, qosTable=qosTable, portPower=portPower, vendorName=vendorName, port1=port1, staticIpAddr=staticIpAddr, serialnum=serialnum, staticIpGateway=staticIpGateway, tftpSevIp=tftpSevIp, catv=catv, voltage=voltage, primaryDns=primaryDns, portName=portName, vendorOui=vendorOui, modeEntry=modeEntry, jumblan2=jumblan2, statisticTable=statisticTable, wan=wan, operStatus=operStatus, catvEnable=catvEnable, pauseReceived=pauseReceived, temperature=temperature, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, txPower=txPower, pauseTransmitted=pauseTransmitted, qosEntry=qosEntry, lan3=lan3, staticIpDomainName=staticIpDomainName, speed=speed, lanportspeed=lanportspeed, fcsErrorReceived=fcsErrorReceived, jumblan1=jumblan1, portStatEntry=portStatEntry, lanportTable=lanportTable, qosIndex=qosIndex, unicastsReceived=unicastsReceived, lan1=lan1, xg6846=xg6846, lan4=lan4, staticIpHostName=staticIpHostName, jumbwan=jumbwan, vlanid=vlanid, rxPower=rxPower, staticIpSubMask=staticIpSubMask, portmode=portmode, statIndex=statIndex, vendorRev=vendorRev, secondaryDns=secondaryDns, hostname=hostname, qmode=qmode, internetPort=internetPort, action=action, broadcastsReceived=broadcastsReceived, jumblan3=jumblan3, fileName=fileName, jumblan4=jumblan4, tftp=tftp, portEntry=portEntry, multicastsReceived=multicastsReceived, portTable=portTable, fcsErrorTransmitted=fcsErrorTransmitted, lanportpause=lanportpause, bias=bias, groupEntry=groupEntry, portStatistic=portStatistic, jumb=jumb, wanType=wanType, lan2=lan2, groupIndex=groupIndex, broadcastsTransmitted=broadcastsTransmitted, staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, priority=priority, lanportName=lanportName)
