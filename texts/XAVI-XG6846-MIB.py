...
NotificationType, iso, Counter64, MibIdentifier, enterprises, Integer32, Gauge32, TimeTicks, snmpModules, Bits, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter32, Unsigned32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Counter64", "MibIdentifier", "enterprises", "Integer32", "Gauge32", "TimeTicks", "snmpModules", "Bits", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter32", "Unsigned32", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportName=lanportName, qmode=qmode, vlan=vlan, staticIpGateway=staticIpGateway, groupIndex=groupIndex, staticDns=staticDns, unicastsTransmitted=unicastsTransmitted, operStatus=operStatus, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, portTable=portTable, qosTable=qosTable, jumb=jumb, qmapping=qmapping, action=action, primaryDns=primaryDns, catvEnable=catvEnable, serialnum=serialnum, staticIpDomainName=staticIpDomainName, pauseReceived=pauseReceived, vlangroupTable=vlangroupTable, jumblan1=jumblan1, dscpEnable=dscpEnable, vendorPn=vendorPn, lanportspeed=lanportspeed, jumbwan=jumbwan, bias=bias, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, lan2=lan2, ddminfo=ddminfo, temperature=temperature, fileName=fileName, portStatEntry=portStatEntry, lanportTable=lanportTable, portIndex=portIndex, jumblan2=jumblan2, portEntry=portEntry, xg6846=xg6846, lanportpause=lanportpause, staticIpHostName=staticIpHostName, portmode=portmode, modeEntry=modeEntry, hostname=hostname, vendorOui=vendorOui, rebootEnable=rebootEnable, groupid=groupid, port4=port4, jumblan4=jumblan4, lanportIndex=lanportIndex, secondaryDns=secondaryDns, groupEntry=groupEntry, multicastsReceived=multicastsReceived, deviceinfo=deviceinfo, vlanid=vlanid, port3=port3, portPower=portPower, wan=wan, portStatistic=portStatistic, broadcastsReceived=broadcastsReceived, staticIpAddr=staticIpAddr, reboot=reboot, adminStatus=adminStatus, priority=priority, internetPort=internetPort, speed=speed, qos=qos, qosEntry=qosEntry, port1=port1, jumblan3=jumblan3, broadcastsTransmitted=broadcastsTransmitted, rxPower=rxPower, tftpSevIp=tftpSevIp, wanType=wanType, txPower=txPower, tftp=tftp, statIndex=statIndex, qosIndex=qosIndex, statisticTable=statisticTable, multicastsTransmitted=multicastsTransmitted, lan4=lan4, voltage=voltage, fileType=fileType, vendorRev=vendorRev, catv=catv, vendorName=vendorName, port2=port2, unicastsReceived=unicastsReceived, portName=portName, domainame=domainame, lan1=lan1, fcsErrorReceived=fcsErrorReceived, lan3=lan3)
