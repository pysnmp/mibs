...
# Produced by pysmi-1.1.8 at Wed Sep  6 13:33:54 2023
...
Counter32, Bits, Gauge32, Integer32, mib_2, enterprises, Counter64, Unsigned32, ObjectIdentity, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, NotificationType, snmpModules, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "Gauge32", "Integer32", "mib-2", "enterprises", "Counter64", "Unsigned32", "ObjectIdentity", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "NotificationType", "snmpModules", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", temperature=temperature, jumblan3=jumblan3, pauseTransmitted=pauseTransmitted, portPower=portPower, qosEntry=qosEntry, port4=port4, qmode=qmode, hostname=hostname, secondaryDns=secondaryDns, portmode=portmode, lan3=lan3, fcsErrorReceived=fcsErrorReceived, statIndex=statIndex, modeEntry=modeEntry, vendorPn=vendorPn, rebootEnable=rebootEnable, portStatistic=portStatistic, vendorRev=vendorRev, staticIpGateway=staticIpGateway, operStatus=operStatus, lan4=lan4, groupIndex=groupIndex, staticIpSubMask=staticIpSubMask, jumblan2=jumblan2, port3=port3, adminStatus=adminStatus, vendorOui=vendorOui, jumb=jumb, internetPort=internetPort, vendorName=vendorName, jumblan1=jumblan1, qos=qos, multicastsTransmitted=multicastsTransmitted, lanportName=lanportName, action=action, jumblan4=jumblan4, lanportIndex=lanportIndex, lanportTable=lanportTable, fileType=fileType, bias=bias, ddminfo=ddminfo, priority=priority, groupEntry=groupEntry, unicastsTransmitted=unicastsTransmitted, lan1=lan1, domainame=domainame, speed=speed, rxPower=rxPower, tftp=tftp, portEntry=portEntry, voltage=voltage, wanType=wanType, txPower=txPower, staticIpAddr=staticIpAddr, qosTable=qosTable, qosIndex=qosIndex, staticIpDomainName=staticIpDomainName, tftpSevIp=tftpSevIp, portTable=portTable, primaryDns=primaryDns, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, lanportpause=lanportpause, staticDns=staticDns, reboot=reboot, jumbwan=jumbwan, fcsErrorTransmitted=fcsErrorTransmitted, multicastsReceived=multicastsReceived, unicastsReceived=unicastsReceived, vlangroupTable=vlangroupTable, qmapping=qmapping, groupid=groupid, staticIpHostName=staticIpHostName, wan=wan, deviceinfo=deviceinfo, vlanid=vlanid, serialnum=serialnum, dscpEnable=dscpEnable, fileName=fileName, port2=port2, portStatEntry=portStatEntry, statisticTable=statisticTable, catvEnable=catvEnable, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, vlan=vlan, lanportspeed=lanportspeed, xg6846=xg6846, portName=portName, broadcastsTransmitted=broadcastsTransmitted, catv=catv, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, lan2=lan2)
