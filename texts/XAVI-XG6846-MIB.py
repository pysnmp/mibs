...
# Produced by pysmi-1.1.8 at Mon Jan 17 14:59:05 2022
...
ObjectIdentity, NotificationType, Bits, MibIdentifier, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, mib_2, TimeTicks, IpAddress, enterprises, Counter64, Counter32, Integer32, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Bits", "MibIdentifier", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "mib-2", "TimeTicks", "IpAddress", "enterprises", "Counter64", "Counter32", "Integer32", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan1=jumblan1, vlanid=vlanid, lanportspeed=lanportspeed, staticIpSubMask=staticIpSubMask, qmapping=qmapping, modeEntry=modeEntry, fcsErrorTransmitted=fcsErrorTransmitted, qos=qos, statisticTable=statisticTable, portPower=portPower, groupEntry=groupEntry, reboot=reboot, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, operStatus=operStatus, qosTable=qosTable, vlan=vlan, jumblan2=jumblan2, lan2=lan2, hostname=hostname, wan=wan, staticIpPrimaryDns=staticIpPrimaryDns, portmode=portmode, vendorName=vendorName, portIndex=portIndex, domainame=domainame, staticIpGateway=staticIpGateway, staticIpHostName=staticIpHostName, port2=port2, jumblan3=jumblan3, groupIndex=groupIndex, qmode=qmode, lan1=lan1, multicastsReceived=multicastsReceived, portStatEntry=portStatEntry, staticDns=staticDns, portEntry=portEntry, rxPower=rxPower, lan3=lan3, pauseTransmitted=pauseTransmitted, vendorPn=vendorPn, action=action, broadcastsReceived=broadcastsReceived, wanType=wanType, port1=port1, voltage=voltage, staticIpDomainName=staticIpDomainName, jumb=jumb, dscpEnable=dscpEnable, catvEnable=catvEnable, qosIndex=qosIndex, multicastsTransmitted=multicastsTransmitted, port3=port3, tftpSevIp=tftpSevIp, bias=bias, deviceinfo=deviceinfo, staticIpSecondaryDns=staticIpSecondaryDns, jumblan4=jumblan4, portTable=portTable, fileName=fileName, lanportpause=lanportpause, unicastsReceived=unicastsReceived, lanportIndex=lanportIndex, portStatistic=portStatistic, lan4=lan4, catv=catv, fileType=fileType, vlangroupTable=vlangroupTable, adminStatus=adminStatus, vendorOui=vendorOui, portName=portName, pauseReceived=pauseReceived, jumbwan=jumbwan, xg6846=xg6846, ddminfo=ddminfo, port4=port4, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, temperature=temperature, serialnum=serialnum, vendorRev=vendorRev, secondaryDns=secondaryDns, lanportTable=lanportTable, statIndex=statIndex, primaryDns=primaryDns, speed=speed, tftp=tftp, fcsErrorReceived=fcsErrorReceived, txPower=txPower, lanportName=lanportName, qosEntry=qosEntry, priority=priority, unicastsTransmitted=unicastsTransmitted)
