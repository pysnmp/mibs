...
# Produced by pysmi-1.1.3 at Wed Dec  8 19:47:03 2021
...
Bits, ModuleIdentity, mib_2, Counter32, TimeTicks, ObjectIdentity, Integer32, Gauge32, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Counter64, NotificationType, IpAddress, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "mib-2", "Counter32", "TimeTicks", "ObjectIdentity", "Integer32", "Gauge32", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Counter64", "NotificationType", "IpAddress", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsTransmitted=unicastsTransmitted, port3=port3, fileName=fileName, lanportIndex=lanportIndex, rxPower=rxPower, lanportTable=lanportTable, lan2=lan2, qos=qos, portStatEntry=portStatEntry, lanportspeed=lanportspeed, action=action, lan3=lan3, groupIndex=groupIndex, port4=port4, qmapping=qmapping, jumblan2=jumblan2, operStatus=operStatus, catvEnable=catvEnable, multicastsReceived=multicastsReceived, qosEntry=qosEntry, secondaryDns=secondaryDns, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, vendorRev=vendorRev, staticIpSecondaryDns=staticIpSecondaryDns, staticIpHostName=staticIpHostName, portIndex=portIndex, portmode=portmode, reboot=reboot, deviceinfo=deviceinfo, hostname=hostname, qmode=qmode, lan1=lan1, fcsErrorTransmitted=fcsErrorTransmitted, jumblan4=jumblan4, jumbwan=jumbwan, jumblan3=jumblan3, modeEntry=modeEntry, vendorPn=vendorPn, wan=wan, catv=catv, txPower=txPower, groupEntry=groupEntry, primaryDns=primaryDns, staticIpPrimaryDns=staticIpPrimaryDns, serialnum=serialnum, temperature=temperature, staticIpGateway=staticIpGateway, portName=portName, adminStatus=adminStatus, bias=bias, tftpSevIp=tftpSevIp, groupid=groupid, staticIpSubMask=staticIpSubMask, pauseReceived=pauseReceived, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, jumb=jumb, portEntry=portEntry, domainame=domainame, voltage=voltage, qosTable=qosTable, priority=priority, lanportName=lanportName, portTable=portTable, broadcastsReceived=broadcastsReceived, statisticTable=statisticTable, port2=port2, lan4=lan4, statIndex=statIndex, portPower=portPower, vlan=vlan, jumblan1=jumblan1, vlangroupTable=vlangroupTable, portStatistic=portStatistic, port1=port1, rebootEnable=rebootEnable, vendorName=vendorName, qosIndex=qosIndex, pauseTransmitted=pauseTransmitted, xg6846=xg6846, tftp=tftp, vendorOui=vendorOui, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, speed=speed, staticDns=staticDns, vlanid=vlanid, lanportpause=lanportpause, ddminfo=ddminfo, fileType=fileType, wanType=wanType, staticIpAddr=staticIpAddr, fcsErrorReceived=fcsErrorReceived)
