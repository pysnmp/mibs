...
MibIdentifier, TimeTicks, Bits, ModuleIdentity, Counter32, mib_2, snmpModules, iso, IpAddress, Unsigned32, Integer32, NotificationType, enterprises, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Bits", "ModuleIdentity", "Counter32", "mib-2", "snmpModules", "iso", "IpAddress", "Unsigned32", "Integer32", "NotificationType", "enterprises", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmode=qmode, domainame=domainame, reboot=reboot, adminStatus=adminStatus, fileName=fileName, statIndex=statIndex, txPower=txPower, fcsErrorTransmitted=fcsErrorTransmitted, wanType=wanType, vlangroupTable=vlangroupTable, vlanid=vlanid, lanportspeed=lanportspeed, port4=port4, groupid=groupid, catvEnable=catvEnable, groupEntry=groupEntry, lan1=lan1, broadcastsReceived=broadcastsReceived, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, lan4=lan4, wan=wan, lanportTable=lanportTable, portStatistic=portStatistic, staticDns=staticDns, pauseTransmitted=pauseTransmitted, pauseReceived=pauseReceived, statisticTable=statisticTable, qosTable=qosTable, lan3=lan3, qos=qos, staticIpGateway=staticIpGateway, portStatEntry=portStatEntry, lanportIndex=lanportIndex, bias=bias, port1=port1, catv=catv, action=action, broadcastsTransmitted=broadcastsTransmitted, lanportName=lanportName, port2=port2, vlan=vlan, portPower=portPower, lan2=lan2, rebootEnable=rebootEnable, voltage=voltage, qmapping=qmapping, internetPort=internetPort, multicastsTransmitted=multicastsTransmitted, speed=speed, fcsErrorReceived=fcsErrorReceived, staticIpHostName=staticIpHostName, unicastsReceived=unicastsReceived, jumblan2=jumblan2, dscpEnable=dscpEnable, temperature=temperature, portEntry=portEntry, jumbwan=jumbwan, priority=priority, portTable=portTable, portmode=portmode, fileType=fileType, groupIndex=groupIndex, qosIndex=qosIndex, primaryDns=primaryDns, secondaryDns=secondaryDns, jumb=jumb, qosEntry=qosEntry, unicastsTransmitted=unicastsTransmitted, port3=port3, tftp=tftp, vendorName=vendorName, ddminfo=ddminfo, multicastsReceived=multicastsReceived, xg6846=xg6846, portName=portName, vendorPn=vendorPn, hostname=hostname, portIndex=portIndex, vendorRev=vendorRev, tftpSevIp=tftpSevIp, modeEntry=modeEntry, jumblan4=jumblan4, rxPower=rxPower, staticIpAddr=staticIpAddr, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, deviceinfo=deviceinfo, jumblan1=jumblan1, operStatus=operStatus, jumblan3=jumblan3, vendorOui=vendorOui, lanportpause=lanportpause, serialnum=serialnum)
