...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:27:51 2021
...
NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, Counter32, ObjectIdentity, snmpModules, Integer32, mib_2, Counter64, MibIdentifier, Gauge32, TimeTicks, iso, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "Counter32", "ObjectIdentity", "snmpModules", "Integer32", "mib-2", "Counter64", "MibIdentifier", "Gauge32", "TimeTicks", "iso", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port2=port2, hostname=hostname, qmapping=qmapping, vlan=vlan, lan3=lan3, vendorOui=vendorOui, multicastsTransmitted=multicastsTransmitted, voltage=voltage, lanportpause=lanportpause, pauseTransmitted=pauseTransmitted, fileName=fileName, portEntry=portEntry, qmode=qmode, vendorPn=vendorPn, operStatus=operStatus, serialnum=serialnum, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, staticIpAddr=staticIpAddr, statIndex=statIndex, secondaryDns=secondaryDns, catv=catv, domainame=domainame, wan=wan, reboot=reboot, staticIpDomainName=staticIpDomainName, portStatEntry=portStatEntry, broadcastsTransmitted=broadcastsTransmitted, broadcastsReceived=broadcastsReceived, staticIpGateway=staticIpGateway, fcsErrorReceived=fcsErrorReceived, speed=speed, lanportName=lanportName, txPower=txPower, lan4=lan4, staticDns=staticDns, tftpSevIp=tftpSevIp, adminStatus=adminStatus, modeEntry=modeEntry, catvEnable=catvEnable, action=action, portPower=portPower, vendorName=vendorName, vendorRev=vendorRev, tftp=tftp, pauseReceived=pauseReceived, priority=priority, vlanid=vlanid, multicastsReceived=multicastsReceived, rxPower=rxPower, staticIpSecondaryDns=staticIpSecondaryDns, lanportTable=lanportTable, groupIndex=groupIndex, lanportspeed=lanportspeed, jumblan4=jumblan4, staticIpSubMask=staticIpSubMask, lan1=lan1, portTable=portTable, port4=port4, port1=port1, qosTable=qosTable, lan2=lan2, jumb=jumb, ddminfo=ddminfo, groupid=groupid, lanportIndex=lanportIndex, portmode=portmode, temperature=temperature, jumblan2=jumblan2, jumblan3=jumblan3, xg6846=xg6846, primaryDns=primaryDns, unicastsTransmitted=unicastsTransmitted, vlangroupTable=vlangroupTable, qos=qos, statisticTable=statisticTable, fcsErrorTransmitted=fcsErrorTransmitted, qosIndex=qosIndex, staticIpHostName=staticIpHostName, port3=port3, rebootEnable=rebootEnable, jumblan1=jumblan1, internetPort=internetPort, fileType=fileType, wanType=wanType, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, groupEntry=groupEntry, jumbwan=jumbwan, portStatistic=portStatistic, portName=portName, portIndex=portIndex, deviceinfo=deviceinfo, qosEntry=qosEntry)
