...
# Produced by pysmi-1.1.8 at Fri Jul  8 07:40:25 2022
...
Unsigned32, Gauge32, ObjectIdentity, Counter64, mib_2, TimeTicks, MibIdentifier, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, enterprises, IpAddress, NotificationType, snmpModules, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter64", "mib-2", "TimeTicks", "MibIdentifier", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "enterprises", "IpAddress", "NotificationType", "snmpModules", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wanType=wanType, qosTable=qosTable, txPower=txPower, secondaryDns=secondaryDns, portName=portName, portPower=portPower, serialnum=serialnum, catvEnable=catvEnable, staticIpHostName=staticIpHostName, portmode=portmode, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, vlanid=vlanid, wan=wan, deviceinfo=deviceinfo, port3=port3, operStatus=operStatus, jumbwan=jumbwan, rebootEnable=rebootEnable, staticIpDomainName=staticIpDomainName, statisticTable=statisticTable, staticIpAddr=staticIpAddr, catv=catv, jumblan3=jumblan3, jumblan1=jumblan1, temperature=temperature, groupEntry=groupEntry, fcsErrorReceived=fcsErrorReceived, vendorOui=vendorOui, staticIpGateway=staticIpGateway, multicastsReceived=multicastsReceived, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, portIndex=portIndex, staticDns=staticDns, tftpSevIp=tftpSevIp, lan4=lan4, portStatEntry=portStatEntry, action=action, primaryDns=primaryDns, qosIndex=qosIndex, qos=qos, jumblan4=jumblan4, jumb=jumb, adminStatus=adminStatus, vlan=vlan, lan2=lan2, lan1=lan1, bias=bias, statIndex=statIndex, lanportspeed=lanportspeed, qosEntry=qosEntry, speed=speed, port2=port2, dscpEnable=dscpEnable, qmapping=qmapping, pauseReceived=pauseReceived, voltage=voltage, multicastsTransmitted=multicastsTransmitted, vendorName=vendorName, priority=priority, portTable=portTable, vlangroupTable=vlangroupTable, lanportpause=lanportpause, lanportName=lanportName, groupIndex=groupIndex, xg6846=xg6846, tftp=tftp, fcsErrorTransmitted=fcsErrorTransmitted, fileType=fileType, lanportIndex=lanportIndex, lan3=lan3, portEntry=portEntry, vendorRev=vendorRev, groupid=groupid, unicastsTransmitted=unicastsTransmitted, rxPower=rxPower, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, internetPort=internetPort, hostname=hostname, lanportTable=lanportTable, qmode=qmode, fileName=fileName, port4=port4, domainame=domainame, broadcastsTransmitted=broadcastsTransmitted, jumblan2=jumblan2, ddminfo=ddminfo, vendorPn=vendorPn, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, port1=port1, reboot=reboot)
