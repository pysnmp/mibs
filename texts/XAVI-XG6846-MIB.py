...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:28:52 2022
...
enterprises, iso, Integer32, ObjectIdentity, ModuleIdentity, TimeTicks, Counter32, IpAddress, snmpModules, NotificationType, Unsigned32, mib_2, Counter64, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "Integer32", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Counter32", "IpAddress", "snmpModules", "NotificationType", "Unsigned32", "mib-2", "Counter64", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", ddminfo=ddminfo, lan1=lan1, vlangroupTable=vlangroupTable, staticIpSecondaryDns=staticIpSecondaryDns, jumblan1=jumblan1, lanportIndex=lanportIndex, deviceinfo=deviceinfo, staticIpGateway=staticIpGateway, portStatEntry=portStatEntry, vendorRev=vendorRev, groupIndex=groupIndex, multicastsReceived=multicastsReceived, unicastsReceived=unicastsReceived, broadcastsReceived=broadcastsReceived, portTable=portTable, wanType=wanType, portPower=portPower, primaryDns=primaryDns, portStatistic=portStatistic, temperature=temperature, staticIpDomainName=staticIpDomainName, xg6846=xg6846, jumbwan=jumbwan, rxPower=rxPower, secondaryDns=secondaryDns, fileName=fileName, groupEntry=groupEntry, hostname=hostname, jumblan4=jumblan4, portmode=portmode, qos=qos, catv=catv, lanportpause=lanportpause, tftpSevIp=tftpSevIp, adminStatus=adminStatus, catvEnable=catvEnable, qosEntry=qosEntry, tftp=tftp, lanportspeed=lanportspeed, lanportName=lanportName, unicastsTransmitted=unicastsTransmitted, staticIpHostName=staticIpHostName, txPower=txPower, lanportTable=lanportTable, speed=speed, qosIndex=qosIndex, rebootEnable=rebootEnable, port2=port2, pauseTransmitted=pauseTransmitted, voltage=voltage, reboot=reboot, serialnum=serialnum, port4=port4, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSubMask=staticIpSubMask, jumblan2=jumblan2, staticDns=staticDns, pauseReceived=pauseReceived, vlan=vlan, port3=port3, groupid=groupid, qosTable=qosTable, action=action, fileType=fileType, qmode=qmode, jumblan3=jumblan3, domainame=domainame, bias=bias, priority=priority, portIndex=portIndex, staticIpAddr=staticIpAddr, vendorPn=vendorPn, portName=portName, broadcastsTransmitted=broadcastsTransmitted, statisticTable=statisticTable, vendorName=vendorName, fcsErrorReceived=fcsErrorReceived, lan3=lan3, dscpEnable=dscpEnable, vendorOui=vendorOui, statIndex=statIndex, wan=wan, internetPort=internetPort, lan2=lan2, operStatus=operStatus, portEntry=portEntry, qmapping=qmapping, vlanid=vlanid, port1=port1, multicastsTransmitted=multicastsTransmitted, jumb=jumb, staticIpPrimaryDns=staticIpPrimaryDns, lan4=lan4, modeEntry=modeEntry)
