...
# Produced by pysmi-1.1.3 at Sat Nov 20 16:53:05 2021
...
Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Unsigned32, Counter64, MibIdentifier, Integer32, ModuleIdentity, mib_2, snmpModules, Counter32, enterprises, Bits, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Unsigned32", "Counter64", "MibIdentifier", "Integer32", "ModuleIdentity", "mib-2", "snmpModules", "Counter32", "enterprises", "Bits", "IpAddress", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatistic=portStatistic, vlanid=vlanid, staticIpSubMask=staticIpSubMask, ddminfo=ddminfo, portEntry=portEntry, statIndex=statIndex, catv=catv, broadcastsReceived=broadcastsReceived, internetPort=internetPort, portPower=portPower, wan=wan, jumblan4=jumblan4, qosTable=qosTable, groupEntry=groupEntry, wanType=wanType, qmode=qmode, xg6846=xg6846, fcsErrorReceived=fcsErrorReceived, operStatus=operStatus, staticIpAddr=staticIpAddr, jumblan1=jumblan1, rebootEnable=rebootEnable, reboot=reboot, staticIpHostName=staticIpHostName, portmode=portmode, port1=port1, priority=priority, tftp=tftp, qmapping=qmapping, lanportspeed=lanportspeed, dscpEnable=dscpEnable, portTable=portTable, broadcastsTransmitted=broadcastsTransmitted, portStatEntry=portStatEntry, unicastsTransmitted=unicastsTransmitted, lanportTable=lanportTable, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, qos=qos, lanportName=lanportName, port2=port2, staticDns=staticDns, vendorOui=vendorOui, temperature=temperature, portIndex=portIndex, lan4=lan4, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, fileType=fileType, deviceinfo=deviceinfo, rxPower=rxPower, tftpSevIp=tftpSevIp, groupid=groupid, secondaryDns=secondaryDns, action=action, modeEntry=modeEntry, voltage=voltage, lan1=lan1, groupIndex=groupIndex, speed=speed, catvEnable=catvEnable, pauseReceived=pauseReceived, qosEntry=qosEntry, vendorName=vendorName, vendorRev=vendorRev, fcsErrorTransmitted=fcsErrorTransmitted, statisticTable=statisticTable, staticIpGateway=staticIpGateway, portName=portName, vlan=vlan, qosIndex=qosIndex, primaryDns=primaryDns, lan3=lan3, lanportIndex=lanportIndex, pauseTransmitted=pauseTransmitted, lanportpause=lanportpause, vendorPn=vendorPn, serialnum=serialnum, lan2=lan2, unicastsReceived=unicastsReceived, vlangroupTable=vlangroupTable, domainame=domainame, port3=port3, jumb=jumb, jumblan3=jumblan3, multicastsReceived=multicastsReceived, txPower=txPower, jumbwan=jumbwan, hostname=hostname, staticIpSecondaryDns=staticIpSecondaryDns, adminStatus=adminStatus, port4=port4, fileName=fileName, jumblan2=jumblan2)
