...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:55:43 2022
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Integer32, IpAddress, Gauge32, TimeTicks, enterprises, ObjectIdentity, Unsigned32, MibIdentifier, mib_2, Counter32, Bits, snmpModules, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Integer32", "IpAddress", "Gauge32", "TimeTicks", "enterprises", "ObjectIdentity", "Unsigned32", "MibIdentifier", "mib-2", "Counter32", "Bits", "snmpModules", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portTable=portTable, vendorName=vendorName, rxPower=rxPower, qmapping=qmapping, qos=qos, qosIndex=qosIndex, primaryDns=primaryDns, jumb=jumb, operStatus=operStatus, staticIpSubMask=staticIpSubMask, action=action, portIndex=portIndex, lanportTable=lanportTable, vlanid=vlanid, statIndex=statIndex, staticIpAddr=staticIpAddr, temperature=temperature, fileType=fileType, multicastsTransmitted=multicastsTransmitted, secondaryDns=secondaryDns, voltage=voltage, wan=wan, staticDns=staticDns, fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, domainame=domainame, lan1=lan1, wanType=wanType, speed=speed, serialnum=serialnum, fileName=fileName, staticIpDomainName=staticIpDomainName, tftpSevIp=tftpSevIp, modeEntry=modeEntry, qmode=qmode, pauseReceived=pauseReceived, portmode=portmode, lan3=lan3, lanportpause=lanportpause, vlangroupTable=vlangroupTable, hostname=hostname, reboot=reboot, lanportspeed=lanportspeed, portStatEntry=portStatEntry, qosTable=qosTable, jumblan1=jumblan1, staticIpPrimaryDns=staticIpPrimaryDns, port2=port2, xg6846=xg6846, txPower=txPower, staticIpHostName=staticIpHostName, rebootEnable=rebootEnable, vendorRev=vendorRev, qosEntry=qosEntry, catvEnable=catvEnable, tftp=tftp, unicastsReceived=unicastsReceived, lan4=lan4, groupEntry=groupEntry, adminStatus=adminStatus, portEntry=portEntry, priority=priority, lanportName=lanportName, groupIndex=groupIndex, port3=port3, pauseTransmitted=pauseTransmitted, catv=catv, lan2=lan2, internetPort=internetPort, port4=port4, deviceinfo=deviceinfo, portPower=portPower, dscpEnable=dscpEnable, staticIpGateway=staticIpGateway, broadcastsTransmitted=broadcastsTransmitted, bias=bias, broadcastsReceived=broadcastsReceived, vendorPn=vendorPn, portStatistic=portStatistic, port1=port1, jumblan4=jumblan4, multicastsReceived=multicastsReceived, jumblan2=jumblan2, jumbwan=jumbwan, staticIpSecondaryDns=staticIpSecondaryDns, portName=portName, fcsErrorReceived=fcsErrorReceived, vlan=vlan, statisticTable=statisticTable, groupid=groupid, ddminfo=ddminfo, unicastsTransmitted=unicastsTransmitted, lanportIndex=lanportIndex, vendorOui=vendorOui)
