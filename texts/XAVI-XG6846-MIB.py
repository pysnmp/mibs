...
# Produced by pysmi-1.1.11 at Wed Apr  3 14:53:15 2024
...
snmpModules, mib_2, Counter64, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, TimeTicks, Unsigned32, Integer32, Counter32, iso, Gauge32, ObjectIdentity, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "mib-2", "Counter64", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "TimeTicks", "Unsigned32", "Integer32", "Counter32", "iso", "Gauge32", "ObjectIdentity", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", txPower=txPower, fileType=fileType, wan=wan, qosIndex=qosIndex, dscpEnable=dscpEnable, statisticTable=statisticTable, jumblan2=jumblan2, lanportIndex=lanportIndex, tftp=tftp, catv=catv, jumblan3=jumblan3, lan3=lan3, domainame=domainame, staticIpHostName=staticIpHostName, jumbwan=jumbwan, lan2=lan2, fileName=fileName, port2=port2, temperature=temperature, portTable=portTable, jumb=jumb, lanportpause=lanportpause, staticIpAddr=staticIpAddr, adminStatus=adminStatus, staticDns=staticDns, qos=qos, multicastsReceived=multicastsReceived, rebootEnable=rebootEnable, groupIndex=groupIndex, unicastsReceived=unicastsReceived, vlan=vlan, fcsErrorReceived=fcsErrorReceived, staticIpPrimaryDns=staticIpPrimaryDns, vendorName=vendorName, qmapping=qmapping, primaryDns=primaryDns, reboot=reboot, portName=portName, qosEntry=qosEntry, staticIpGateway=staticIpGateway, deviceinfo=deviceinfo, rxPower=rxPower, wanType=wanType, catvEnable=catvEnable, statIndex=statIndex, vendorRev=vendorRev, jumblan1=jumblan1, hostname=hostname, broadcastsReceived=broadcastsReceived, lanportName=lanportName, lanportspeed=lanportspeed, broadcastsTransmitted=broadcastsTransmitted, operStatus=operStatus, internetPort=internetPort, jumblan4=jumblan4, lan1=lan1, unicastsTransmitted=unicastsTransmitted, vlanid=vlanid, groupid=groupid, xg6846=xg6846, portPower=portPower, modeEntry=modeEntry, portIndex=portIndex, port3=port3, vendorOui=vendorOui, staticIpSubMask=staticIpSubMask, ddminfo=ddminfo, pauseReceived=pauseReceived, vlangroupTable=vlangroupTable, lan4=lan4, port4=port4, fcsErrorTransmitted=fcsErrorTransmitted, vendorPn=vendorPn, portStatistic=portStatistic, groupEntry=groupEntry, bias=bias, staticIpDomainName=staticIpDomainName, staticIpSecondaryDns=staticIpSecondaryDns, lanportTable=lanportTable, tftpSevIp=tftpSevIp, port1=port1, speed=speed, secondaryDns=secondaryDns, serialnum=serialnum, portEntry=portEntry, portStatEntry=portStatEntry, qmode=qmode, priority=priority, qosTable=qosTable, multicastsTransmitted=multicastsTransmitted, action=action, pauseTransmitted=pauseTransmitted, portmode=portmode, voltage=voltage)
