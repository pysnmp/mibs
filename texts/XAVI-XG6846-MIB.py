...
# Produced by pysmi-1.1.8 at Fri Jan 27 15:49:36 2023
...
TimeTicks, ModuleIdentity, snmpModules, IpAddress, iso, mib_2, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, Unsigned32, Gauge32, ObjectIdentity, Bits, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "snmpModules", "IpAddress", "iso", "mib-2", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "Unsigned32", "Gauge32", "ObjectIdentity", "Bits", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", deviceinfo=deviceinfo, port3=port3, port1=port1, lan1=lan1, portEntry=portEntry, modeEntry=modeEntry, secondaryDns=secondaryDns, tftpSevIp=tftpSevIp, action=action, lan4=lan4, vendorRev=vendorRev, staticIpDomainName=staticIpDomainName, qosIndex=qosIndex, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, groupIndex=groupIndex, internetPort=internetPort, rxPower=rxPower, qosEntry=qosEntry, jumblan4=jumblan4, unicastsTransmitted=unicastsTransmitted, staticDns=staticDns, portTable=portTable, jumbwan=jumbwan, hostname=hostname, portIndex=portIndex, statIndex=statIndex, lanportTable=lanportTable, voltage=voltage, lanportpause=lanportpause, vlan=vlan, wanType=wanType, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, dscpEnable=dscpEnable, ddminfo=ddminfo, reboot=reboot, fcsErrorTransmitted=fcsErrorTransmitted, lanportIndex=lanportIndex, serialnum=serialnum, speed=speed, fileName=fileName, tftp=tftp, portPower=portPower, statisticTable=statisticTable, groupid=groupid, priority=priority, staticIpSecondaryDns=staticIpSecondaryDns, lan3=lan3, domainame=domainame, portStatistic=portStatistic, vendorName=vendorName, staticIpHostName=staticIpHostName, broadcastsTransmitted=broadcastsTransmitted, fileType=fileType, catv=catv, txPower=txPower, rebootEnable=rebootEnable, qos=qos, qmapping=qmapping, port4=port4, jumblan3=jumblan3, wan=wan, vendorPn=vendorPn, pauseReceived=pauseReceived, vlanid=vlanid, adminStatus=adminStatus, portStatEntry=portStatEntry, portName=portName, staticIpGateway=staticIpGateway, pauseTransmitted=pauseTransmitted, jumblan1=jumblan1, unicastsReceived=unicastsReceived, groupEntry=groupEntry, temperature=temperature, qosTable=qosTable, qmode=qmode, multicastsTransmitted=multicastsTransmitted, operStatus=operStatus, lanportspeed=lanportspeed, lan2=lan2, multicastsReceived=multicastsReceived, jumb=jumb, xg6846=xg6846, bias=bias, primaryDns=primaryDns, vlangroupTable=vlangroupTable, vendorOui=vendorOui, port2=port2, portmode=portmode, staticIpSubMask=staticIpSubMask, fcsErrorReceived=fcsErrorReceived, lanportName=lanportName, staticIpAddr=staticIpAddr)
