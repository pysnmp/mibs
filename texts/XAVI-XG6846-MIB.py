...
# Produced by pysmi-1.1.12 at Thu Apr  4 13:16:23 2024
...
TimeTicks, ObjectIdentity, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Bits, Counter64, iso, MibIdentifier, Gauge32, snmpModules, ModuleIdentity, NotificationType, IpAddress, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Bits", "Counter64", "iso", "MibIdentifier", "Gauge32", "snmpModules", "ModuleIdentity", "NotificationType", "IpAddress", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, adminStatus=adminStatus, lan1=lan1, fileType=fileType, fcsErrorTransmitted=fcsErrorTransmitted, operStatus=operStatus, groupid=groupid, xg6846=xg6846, staticIpHostName=staticIpHostName, deviceinfo=deviceinfo, unicastsReceived=unicastsReceived, lanportIndex=lanportIndex, portStatistic=portStatistic, port3=port3, portmode=portmode, qosIndex=qosIndex, portIndex=portIndex, serialnum=serialnum, catv=catv, pauseReceived=pauseReceived, jumblan4=jumblan4, staticIpPrimaryDns=staticIpPrimaryDns, jumblan3=jumblan3, statisticTable=statisticTable, broadcastsTransmitted=broadcastsTransmitted, port1=port1, lanportTable=lanportTable, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, wan=wan, lanportpause=lanportpause, portStatEntry=portStatEntry, staticIpAddr=staticIpAddr, internetPort=internetPort, staticDns=staticDns, portPower=portPower, rxPower=rxPower, groupEntry=groupEntry, jumblan2=jumblan2, tftp=tftp, vlan=vlan, lan4=lan4, vlanid=vlanid, voltage=voltage, catvEnable=catvEnable, portEntry=portEntry, lan2=lan2, jumbwan=jumbwan, action=action, speed=speed, staticIpSecondaryDns=staticIpSecondaryDns, rebootEnable=rebootEnable, vlangroupTable=vlangroupTable, vendorName=vendorName, pauseTransmitted=pauseTransmitted, primaryDns=primaryDns, hostname=hostname, multicastsReceived=multicastsReceived, vendorRev=vendorRev, priority=priority, vendorPn=vendorPn, qosEntry=qosEntry, temperature=temperature, qosTable=qosTable, qmapping=qmapping, secondaryDns=secondaryDns, domainame=domainame, tftpSevIp=tftpSevIp, staticIpDomainName=staticIpDomainName, portName=portName, bias=bias, wanType=wanType, fcsErrorReceived=fcsErrorReceived, port2=port2, reboot=reboot, portTable=portTable, fileName=fileName, jumblan1=jumblan1, qmode=qmode, statIndex=statIndex, multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, lanportName=lanportName, lanportspeed=lanportspeed, broadcastsReceived=broadcastsReceived, lan3=lan3, qos=qos, modeEntry=modeEntry, staticIpSubMask=staticIpSubMask, jumb=jumb, port4=port4, ddminfo=ddminfo, txPower=txPower, dscpEnable=dscpEnable)
