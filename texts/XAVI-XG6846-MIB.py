...
snmpModules, ObjectIdentity, Counter32, MibIdentifier, enterprises, NotificationType, mib_2, Counter64, Gauge32, Integer32, IpAddress, Unsigned32, Bits, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "ObjectIdentity", "Counter32", "MibIdentifier", "enterprises", "NotificationType", "mib-2", "Counter64", "Gauge32", "Integer32", "IpAddress", "Unsigned32", "Bits", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpPrimaryDns=staticIpPrimaryDns, speed=speed, tftpSevIp=tftpSevIp, jumblan3=jumblan3, secondaryDns=secondaryDns, staticIpSecondaryDns=staticIpSecondaryDns, vlan=vlan, portIndex=portIndex, action=action, vlanid=vlanid, lan3=lan3, lanportTable=lanportTable, portTable=portTable, portStatistic=portStatistic, multicastsTransmitted=multicastsTransmitted, port2=port2, deviceinfo=deviceinfo, staticIpHostName=staticIpHostName, qosTable=qosTable, txPower=txPower, priority=priority, groupIndex=groupIndex, lanportpause=lanportpause, catvEnable=catvEnable, dscpEnable=dscpEnable, pauseTransmitted=pauseTransmitted, vendorRev=vendorRev, staticIpAddr=staticIpAddr, adminStatus=adminStatus, tftp=tftp, lanportspeed=lanportspeed, vendorPn=vendorPn, qmode=qmode, fileType=fileType, unicastsTransmitted=unicastsTransmitted, reboot=reboot, lan4=lan4, primaryDns=primaryDns, groupid=groupid, statIndex=statIndex, staticIpGateway=staticIpGateway, serialnum=serialnum, jumblan4=jumblan4, rebootEnable=rebootEnable, qos=qos, lanportIndex=lanportIndex, lan1=lan1, catv=catv, staticIpSubMask=staticIpSubMask, wanType=wanType, staticIpDomainName=staticIpDomainName, vlangroupTable=vlangroupTable, multicastsReceived=multicastsReceived, qosEntry=qosEntry, rxPower=rxPower, bias=bias, port1=port1, groupEntry=groupEntry, domainame=domainame, lan2=lan2, voltage=voltage, portEntry=portEntry, qosIndex=qosIndex, jumbwan=jumbwan, portPower=portPower, fcsErrorTransmitted=fcsErrorTransmitted, portmode=portmode, lanportName=lanportName, statisticTable=statisticTable, internetPort=internetPort, portName=portName, xg6846=xg6846, operStatus=operStatus, hostname=hostname, modeEntry=modeEntry, fileName=fileName, temperature=temperature, pauseReceived=pauseReceived, fcsErrorReceived=fcsErrorReceived, jumblan2=jumblan2, jumblan1=jumblan1, unicastsReceived=unicastsReceived, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, staticDns=staticDns, wan=wan, broadcastsReceived=broadcastsReceived, qmapping=qmapping, jumb=jumb, port3=port3, portStatEntry=portStatEntry, vendorName=vendorName, ddminfo=ddminfo, port4=port4)
