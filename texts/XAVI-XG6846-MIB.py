...
# Produced by pysmi-1.1.12 at Tue May 28 12:14:28 2024
...
Gauge32, ObjectIdentity, Bits, iso, ModuleIdentity, MibIdentifier, Counter64, enterprises, Unsigned32, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32, snmpModules, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Bits", "iso", "ModuleIdentity", "MibIdentifier", "Counter64", "enterprises", "Unsigned32", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32", "snmpModules", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupid=groupid, catvEnable=catvEnable, staticIpDomainName=staticIpDomainName, xg6846=xg6846, pauseReceived=pauseReceived, action=action, tftp=tftp, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, jumblan1=jumblan1, wan=wan, portStatistic=portStatistic, jumblan2=jumblan2, lanportTable=lanportTable, lanportIndex=lanportIndex, unicastsReceived=unicastsReceived, rebootEnable=rebootEnable, lan2=lan2, priority=priority, adminStatus=adminStatus, primaryDns=primaryDns, lan1=lan1, secondaryDns=secondaryDns, portStatEntry=portStatEntry, lan4=lan4, port1=port1, pauseTransmitted=pauseTransmitted, speed=speed, temperature=temperature, qosIndex=qosIndex, lanportspeed=lanportspeed, serialnum=serialnum, portPower=portPower, groupIndex=groupIndex, rxPower=rxPower, portName=portName, ddminfo=ddminfo, wanType=wanType, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, deviceinfo=deviceinfo, portTable=portTable, port3=port3, vendorPn=vendorPn, broadcastsTransmitted=broadcastsTransmitted, operStatus=operStatus, vlangroupTable=vlangroupTable, unicastsTransmitted=unicastsTransmitted, fcsErrorReceived=fcsErrorReceived, lanportpause=lanportpause, vlanid=vlanid, portIndex=portIndex, vendorOui=vendorOui, vendorRev=vendorRev, internetPort=internetPort, port2=port2, qos=qos, voltage=voltage, bias=bias, jumbwan=jumbwan, modeEntry=modeEntry, staticIpHostName=staticIpHostName, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, txPower=txPower, domainame=domainame, jumb=jumb, portEntry=portEntry, fcsErrorTransmitted=fcsErrorTransmitted, vendorName=vendorName, staticIpSubMask=staticIpSubMask, portmode=portmode, staticDns=staticDns, lan3=lan3, hostname=hostname, fileName=fileName, staticIpPrimaryDns=staticIpPrimaryDns, qosTable=qosTable, qosEntry=qosEntry, jumblan4=jumblan4, qmapping=qmapping, dscpEnable=dscpEnable, multicastsTransmitted=multicastsTransmitted, qmode=qmode, port4=port4, vlan=vlan, statisticTable=statisticTable, groupEntry=groupEntry, statIndex=statIndex, reboot=reboot, catv=catv, jumblan3=jumblan3, lanportName=lanportName, fileType=fileType)
