...
TimeTicks, ModuleIdentity, Bits, mib_2, NotificationType, Integer32, Counter64, Gauge32, Unsigned32, ObjectIdentity, IpAddress, MibIdentifier, enterprises, Counter32, iso, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Bits", "mib-2", "NotificationType", "Integer32", "Counter64", "Gauge32", "Unsigned32", "ObjectIdentity", "IpAddress", "MibIdentifier", "enterprises", "Counter32", "iso", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseReceived=pauseReceived, domainame=domainame, reboot=reboot, lan1=lan1, operStatus=operStatus, txPower=txPower, lan2=lan2, voltage=voltage, secondaryDns=secondaryDns, portIndex=portIndex, tftpSevIp=tftpSevIp, groupIndex=groupIndex, portTable=portTable, priority=priority, port1=port1, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, lan4=lan4, qmapping=qmapping, portName=portName, jumblan4=jumblan4, port2=port2, fcsErrorReceived=fcsErrorReceived, staticIpHostName=staticIpHostName, statisticTable=statisticTable, lanportIndex=lanportIndex, jumbwan=jumbwan, staticIpPrimaryDns=staticIpPrimaryDns, portEntry=portEntry, dscpEnable=dscpEnable, rxPower=rxPower, xg6846=xg6846, qosEntry=qosEntry, vendorOui=vendorOui, fcsErrorTransmitted=fcsErrorTransmitted, statIndex=statIndex, fileType=fileType, vlan=vlan, unicastsTransmitted=unicastsTransmitted, action=action, staticIpDomainName=staticIpDomainName, portmode=portmode, jumblan2=jumblan2, port4=port4, fileName=fileName, bias=bias, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, rebootEnable=rebootEnable, staticIpSubMask=staticIpSubMask, broadcastsTransmitted=broadcastsTransmitted, qos=qos, multicastsReceived=multicastsReceived, modeEntry=modeEntry, vendorName=vendorName, wan=wan, staticDns=staticDns, multicastsTransmitted=multicastsTransmitted, jumblan3=jumblan3, pauseTransmitted=pauseTransmitted, vendorPn=vendorPn, staticIpGateway=staticIpGateway, speed=speed, qosTable=qosTable, portPower=portPower, wanType=wanType, internetPort=internetPort, catvEnable=catvEnable, adminStatus=adminStatus, lan3=lan3, primaryDns=primaryDns, broadcastsReceived=broadcastsReceived, lanportspeed=lanportspeed, portStatistic=portStatistic, staticIpAddr=staticIpAddr, qosIndex=qosIndex, catv=catv, tftp=tftp, serialnum=serialnum, ddminfo=ddminfo, lanportTable=lanportTable, vlanid=vlanid, lanportpause=lanportpause, hostname=hostname, qmode=qmode, port3=port3, vlangroupTable=vlangroupTable, lanportName=lanportName, jumblan1=jumblan1, jumb=jumb, groupid=groupid, vendorRev=vendorRev, groupEntry=groupEntry, deviceinfo=deviceinfo)
