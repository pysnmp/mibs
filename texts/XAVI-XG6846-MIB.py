...
Unsigned32, Bits, IpAddress, enterprises, Counter32, TimeTicks, ModuleIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, NotificationType, Integer32, snmpModules, iso, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "IpAddress", "enterprises", "Counter32", "TimeTicks", "ModuleIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "NotificationType", "Integer32", "snmpModules", "iso", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, serialnum=serialnum, port1=port1, lan4=lan4, ddminfo=ddminfo, staticIpHostName=staticIpHostName, jumblan1=jumblan1, fileName=fileName, lan3=lan3, catvEnable=catvEnable, fileType=fileType, fcsErrorTransmitted=fcsErrorTransmitted, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, vlan=vlan, xg6846=xg6846, wanType=wanType, statisticTable=statisticTable, lanportspeed=lanportspeed, jumblan2=jumblan2, groupid=groupid, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, txPower=txPower, pauseTransmitted=pauseTransmitted, jumbwan=jumbwan, pauseReceived=pauseReceived, bias=bias, qosTable=qosTable, hostname=hostname, portStatEntry=portStatEntry, portName=portName, groupEntry=groupEntry, deviceinfo=deviceinfo, staticIpPrimaryDns=staticIpPrimaryDns, wan=wan, lan2=lan2, catv=catv, groupIndex=groupIndex, staticIpDomainName=staticIpDomainName, multicastsTransmitted=multicastsTransmitted, port4=port4, priority=priority, vendorName=vendorName, port3=port3, modeEntry=modeEntry, tftpSevIp=tftpSevIp, staticIpGateway=staticIpGateway, lanportIndex=lanportIndex, primaryDns=primaryDns, qmapping=qmapping, unicastsTransmitted=unicastsTransmitted, port2=port2, qmode=qmode, rebootEnable=rebootEnable, portStatistic=portStatistic, rxPower=rxPower, vendorOui=vendorOui, vlangroupTable=vlangroupTable, tftp=tftp, lan1=lan1, qos=qos, portPower=portPower, lanportName=lanportName, broadcastsReceived=broadcastsReceived, action=action, portTable=portTable, vendorRev=vendorRev, staticIpAddr=staticIpAddr, lanportTable=lanportTable, vendorPn=vendorPn, portIndex=portIndex, lanportpause=lanportpause, temperature=temperature, dscpEnable=dscpEnable, operStatus=operStatus, unicastsReceived=unicastsReceived, portEntry=portEntry, portmode=portmode, staticDns=staticDns, statIndex=statIndex, speed=speed, adminStatus=adminStatus, jumblan3=jumblan3, domainame=domainame, qosEntry=qosEntry, multicastsReceived=multicastsReceived, qosIndex=qosIndex, vlanid=vlanid, internetPort=internetPort, voltage=voltage, jumblan4=jumblan4)
