...
# Produced by pysmi-1.1.12 at Mon Jun  3 13:14:40 2024
...
MibIdentifier, TimeTicks, Bits, Counter32, Integer32, iso, Gauge32, Unsigned32, enterprises, mib_2, snmpModules, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Bits", "Counter32", "Integer32", "iso", "Gauge32", "Unsigned32", "enterprises", "mib-2", "snmpModules", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmode=qmode, vlangroupTable=vlangroupTable, wan=wan, lan1=lan1, qmapping=qmapping, multicastsReceived=multicastsReceived, lanportpause=lanportpause, lan3=lan3, staticIpAddr=staticIpAddr, modeEntry=modeEntry, lan4=lan4, fileName=fileName, staticIpHostName=staticIpHostName, jumb=jumb, unicastsTransmitted=unicastsTransmitted, catvEnable=catvEnable, groupid=groupid, statIndex=statIndex, qos=qos, portmode=portmode, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, lanportspeed=lanportspeed, lanportName=lanportName, portPower=portPower, portStatEntry=portStatEntry, action=action, fcsErrorReceived=fcsErrorReceived, lanportTable=lanportTable, rebootEnable=rebootEnable, staticIpSubMask=staticIpSubMask, voltage=voltage, operStatus=operStatus, staticDns=staticDns, pauseReceived=pauseReceived, statisticTable=statisticTable, qosEntry=qosEntry, vendorName=vendorName, port4=port4, vendorOui=vendorOui, reboot=reboot, portIndex=portIndex, lan2=lan2, staticIpSecondaryDns=staticIpSecondaryDns, qosTable=qosTable, priority=priority, jumbwan=jumbwan, secondaryDns=secondaryDns, staticIpDomainName=staticIpDomainName, internetPort=internetPort, jumblan4=jumblan4, rxPower=rxPower, portStatistic=portStatistic, xg6846=xg6846, fcsErrorTransmitted=fcsErrorTransmitted, unicastsReceived=unicastsReceived, groupEntry=groupEntry, adminStatus=adminStatus, hostname=hostname, temperature=temperature, vendorRev=vendorRev, fileType=fileType, ddminfo=ddminfo, jumblan1=jumblan1, tftp=tftp, tftpSevIp=tftpSevIp, port3=port3, portName=portName, jumblan3=jumblan3, staticIpPrimaryDns=staticIpPrimaryDns, bias=bias, groupIndex=groupIndex, speed=speed, domainame=domainame, port1=port1, multicastsTransmitted=multicastsTransmitted, primaryDns=primaryDns, wanType=wanType, vlan=vlan, vlanid=vlanid, jumblan2=jumblan2, staticIpGateway=staticIpGateway, dscpEnable=dscpEnable, port2=port2, txPower=txPower, pauseTransmitted=pauseTransmitted, catv=catv, deviceinfo=deviceinfo, lanportIndex=lanportIndex, portEntry=portEntry, serialnum=serialnum, qosIndex=qosIndex, vendorPn=vendorPn, portTable=portTable)
