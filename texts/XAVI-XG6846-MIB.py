...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:04:00 2023
...
Gauge32, ModuleIdentity, snmpModules, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, MibIdentifier, NotificationType, enterprises, TimeTicks, Counter64, ObjectIdentity, mib_2, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "snmpModules", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "MibIdentifier", "NotificationType", "enterprises", "TimeTicks", "Counter64", "ObjectIdentity", "mib-2", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSubMask=staticIpSubMask, jumblan4=jumblan4, hostname=hostname, catv=catv, lan3=lan3, staticIpHostName=staticIpHostName, rxPower=rxPower, vendorOui=vendorOui, groupEntry=groupEntry, ddminfo=ddminfo, modeEntry=modeEntry, rebootEnable=rebootEnable, staticIpPrimaryDns=staticIpPrimaryDns, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, vendorRev=vendorRev, jumb=jumb, xg6846=xg6846, lan4=lan4, staticIpDomainName=staticIpDomainName, jumblan3=jumblan3, vendorName=vendorName, staticDns=staticDns, lanportTable=lanportTable, tftp=tftp, portStatEntry=portStatEntry, fileType=fileType, temperature=temperature, operStatus=operStatus, lan2=lan2, port2=port2, fcsErrorReceived=fcsErrorReceived, portTable=portTable, multicastsReceived=multicastsReceived, lanportpause=lanportpause, bias=bias, groupid=groupid, qosIndex=qosIndex, wan=wan, domainame=domainame, qmode=qmode, unicastsReceived=unicastsReceived, txPower=txPower, vlangroupTable=vlangroupTable, internetPort=internetPort, portStatistic=portStatistic, reboot=reboot, vlanid=vlanid, jumblan1=jumblan1, port1=port1, staticIpGateway=staticIpGateway, multicastsTransmitted=multicastsTransmitted, action=action, vlan=vlan, lanportIndex=lanportIndex, lanportName=lanportName, lan1=lan1, unicastsTransmitted=unicastsTransmitted, portmode=portmode, secondaryDns=secondaryDns, staticIpSecondaryDns=staticIpSecondaryDns, serialnum=serialnum, portPower=portPower, voltage=voltage, statIndex=statIndex, fcsErrorTransmitted=fcsErrorTransmitted, dscpEnable=dscpEnable, qosTable=qosTable, groupIndex=groupIndex, vendorPn=vendorPn, jumblan2=jumblan2, speed=speed, staticIpAddr=staticIpAddr, pauseReceived=pauseReceived, port4=port4, jumbwan=jumbwan, fileName=fileName, adminStatus=adminStatus, wanType=wanType, deviceinfo=deviceinfo, portEntry=portEntry, lanportspeed=lanportspeed, catvEnable=catvEnable, portName=portName, qmapping=qmapping, priority=priority, qosEntry=qosEntry, portIndex=portIndex, statisticTable=statisticTable, tftpSevIp=tftpSevIp, port3=port3, qos=qos, primaryDns=primaryDns)
