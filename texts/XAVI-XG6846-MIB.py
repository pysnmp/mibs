...
# Produced by pysmi-1.1.3 at Tue Dec  7 16:29:20 2021
...
Unsigned32, TimeTicks, ModuleIdentity, iso, snmpModules, MibIdentifier, Bits, IpAddress, Counter64, enterprises, ObjectIdentity, NotificationType, Integer32, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "ModuleIdentity", "iso", "snmpModules", "MibIdentifier", "Bits", "IpAddress", "Counter64", "enterprises", "ObjectIdentity", "NotificationType", "Integer32", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qos=qos, lan4=lan4, groupEntry=groupEntry, groupIndex=groupIndex, jumblan2=jumblan2, speed=speed, port3=port3, jumbwan=jumbwan, ddminfo=ddminfo, qmode=qmode, dscpEnable=dscpEnable, action=action, lanportName=lanportName, fileName=fileName, portStatistic=portStatistic, portEntry=portEntry, staticIpHostName=staticIpHostName, qmapping=qmapping, primaryDns=primaryDns, catvEnable=catvEnable, broadcastsTransmitted=broadcastsTransmitted, lanportspeed=lanportspeed, vlan=vlan, lanportIndex=lanportIndex, fileType=fileType, bias=bias, rebootEnable=rebootEnable, fcsErrorTransmitted=fcsErrorTransmitted, qosIndex=qosIndex, unicastsTransmitted=unicastsTransmitted, vlangroupTable=vlangroupTable, jumblan3=jumblan3, qosTable=qosTable, portmode=portmode, adminStatus=adminStatus, multicastsReceived=multicastsReceived, port4=port4, qosEntry=qosEntry, priority=priority, unicastsReceived=unicastsReceived, operStatus=operStatus, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, reboot=reboot, xg6846=xg6846, modeEntry=modeEntry, jumb=jumb, voltage=voltage, deviceinfo=deviceinfo, lan2=lan2, broadcastsReceived=broadcastsReceived, lanportTable=lanportTable, jumblan1=jumblan1, lanportpause=lanportpause, vendorPn=vendorPn, staticIpGateway=staticIpGateway, domainame=domainame, txPower=txPower, temperature=temperature, port2=port2, staticIpSubMask=staticIpSubMask, wanType=wanType, lan3=lan3, catv=catv, tftpSevIp=tftpSevIp, vendorName=vendorName, portIndex=portIndex, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, staticIpSecondaryDns=staticIpSecondaryDns, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, portStatEntry=portStatEntry, staticDns=staticDns, vendorRev=vendorRev, vlanid=vlanid, pauseTransmitted=pauseTransmitted, vendorOui=vendorOui, portTable=portTable, jumblan4=jumblan4, statisticTable=statisticTable, statIndex=statIndex, wan=wan, pauseReceived=pauseReceived, groupid=groupid, serialnum=serialnum, tftp=tftp, rxPower=rxPower, secondaryDns=secondaryDns, portPower=portPower, port1=port1, portName=portName, lan1=lan1, hostname=hostname)
