...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:10:29 2022
...
Integer32, MibIdentifier, Unsigned32, Gauge32, Bits, snmpModules, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, ObjectIdentity, Counter32, TimeTicks, ModuleIdentity, mib_2, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "Unsigned32", "Gauge32", "Bits", "snmpModules", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "ObjectIdentity", "Counter32", "TimeTicks", "ModuleIdentity", "mib-2", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, port3=port3, wan=wan, vendorName=vendorName, primaryDns=primaryDns, serialnum=serialnum, catv=catv, broadcastsTransmitted=broadcastsTransmitted, qosTable=qosTable, internetPort=internetPort, multicastsTransmitted=multicastsTransmitted, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, jumb=jumb, fcsErrorTransmitted=fcsErrorTransmitted, jumbwan=jumbwan, staticIpSecondaryDns=staticIpSecondaryDns, portIndex=portIndex, staticIpDomainName=staticIpDomainName, vlanid=vlanid, port1=port1, domainame=domainame, bias=bias, qmapping=qmapping, wanType=wanType, txPower=txPower, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, pauseReceived=pauseReceived, vendorRev=vendorRev, fileName=fileName, deviceinfo=deviceinfo, multicastsReceived=multicastsReceived, qosIndex=qosIndex, jumblan3=jumblan3, lanportTable=lanportTable, lan2=lan2, pauseTransmitted=pauseTransmitted, portmode=portmode, action=action, lan4=lan4, lanportIndex=lanportIndex, staticIpAddr=staticIpAddr, staticDns=staticDns, staticIpGateway=staticIpGateway, portTable=portTable, xg6846=xg6846, secondaryDns=secondaryDns, temperature=temperature, ddminfo=ddminfo, groupIndex=groupIndex, lan3=lan3, jumblan4=jumblan4, statisticTable=statisticTable, staticIpHostName=staticIpHostName, adminStatus=adminStatus, modeEntry=modeEntry, voltage=voltage, unicastsReceived=unicastsReceived, jumblan2=jumblan2, qosEntry=qosEntry, operStatus=operStatus, statIndex=statIndex, broadcastsReceived=broadcastsReceived, rxPower=rxPower, portPower=portPower, vendorPn=vendorPn, vendorOui=vendorOui, qos=qos, rebootEnable=rebootEnable, qmode=qmode, port4=port4, lanportpause=lanportpause, catvEnable=catvEnable, groupEntry=groupEntry, jumblan1=jumblan1, portStatistic=portStatistic, priority=priority, lanportspeed=lanportspeed, staticIpSubMask=staticIpSubMask, lanportName=lanportName, lan1=lan1, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, hostname=hostname, port2=port2, portName=portName, vlan=vlan, speed=speed, tftp=tftp, portEntry=portEntry, groupid=groupid, fileType=fileType, portStatEntry=portStatEntry)
