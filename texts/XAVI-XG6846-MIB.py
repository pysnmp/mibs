...
ObjectIdentity, iso, Unsigned32, Counter32, ModuleIdentity, MibIdentifier, mib_2, TimeTicks, IpAddress, Integer32, snmpModules, Gauge32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Unsigned32", "Counter32", "ModuleIdentity", "MibIdentifier", "mib-2", "TimeTicks", "IpAddress", "Integer32", "snmpModules", "Gauge32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", ddminfo=ddminfo, portIndex=portIndex, qos=qos, lanportTable=lanportTable, jumblan3=jumblan3, port1=port1, portName=portName, vlangroupTable=vlangroupTable, groupIndex=groupIndex, catvEnable=catvEnable, domainame=domainame, portStatEntry=portStatEntry, secondaryDns=secondaryDns, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, lan1=lan1, unicastsReceived=unicastsReceived, vendorPn=vendorPn, qosIndex=qosIndex, portEntry=portEntry, qmode=qmode, rebootEnable=rebootEnable, vendorOui=vendorOui, wanType=wanType, lan4=lan4, speed=speed, vlanid=vlanid, lanportspeed=lanportspeed, portStatistic=portStatistic, multicastsTransmitted=multicastsTransmitted, action=action, multicastsReceived=multicastsReceived, portmode=portmode, deviceinfo=deviceinfo, groupid=groupid, groupEntry=groupEntry, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, jumbwan=jumbwan, serialnum=serialnum, voltage=voltage, bias=bias, dscpEnable=dscpEnable, broadcastsReceived=broadcastsReceived, port3=port3, lan3=lan3, temperature=temperature, rxPower=rxPower, staticIpAddr=staticIpAddr, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, jumblan2=jumblan2, jumblan4=jumblan4, modeEntry=modeEntry, wan=wan, fcsErrorReceived=fcsErrorReceived, reboot=reboot, portPower=portPower, jumb=jumb, lan2=lan2, fileName=fileName, pauseReceived=pauseReceived, staticIpDomainName=staticIpDomainName, vendorName=vendorName, fcsErrorTransmitted=fcsErrorTransmitted, qosTable=qosTable, operStatus=operStatus, catv=catv, lanportpause=lanportpause, vlan=vlan, vendorRev=vendorRev, qmapping=qmapping, hostname=hostname, tftp=tftp, xg6846=xg6846, lanportName=lanportName, tftpSevIp=tftpSevIp, primaryDns=primaryDns, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, staticIpSecondaryDns=staticIpSecondaryDns, priority=priority, unicastsTransmitted=unicastsTransmitted, txPower=txPower, port2=port2, lanportIndex=lanportIndex, adminStatus=adminStatus, staticIpHostName=staticIpHostName, fileType=fileType, qosEntry=qosEntry, statisticTable=statisticTable, port4=port4, portTable=portTable, staticDns=staticDns)
