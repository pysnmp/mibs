...
snmpModules, enterprises, ModuleIdentity, Gauge32, MibIdentifier, ObjectIdentity, Unsigned32, Bits, Integer32, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, TimeTicks, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "enterprises", "ModuleIdentity", "Gauge32", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Bits", "Integer32", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "TimeTicks", "Counter32", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, domainame=domainame, qmapping=qmapping, portStatEntry=portStatEntry, rxPower=rxPower, dscpEnable=dscpEnable, portIndex=portIndex, fileType=fileType, lan4=lan4, portTable=portTable, staticIpGateway=staticIpGateway, pauseTransmitted=pauseTransmitted, qmode=qmode, vlan=vlan, vlanid=vlanid, lan1=lan1, vendorPn=vendorPn, lan2=lan2, qosIndex=qosIndex, txPower=txPower, jumblan2=jumblan2, temperature=temperature, portName=portName, staticIpPrimaryDns=staticIpPrimaryDns, staticIpHostName=staticIpHostName, portmode=portmode, port1=port1, fcsErrorTransmitted=fcsErrorTransmitted, speed=speed, lanportpause=lanportpause, vendorName=vendorName, wanType=wanType, statIndex=statIndex, operStatus=operStatus, jumbwan=jumbwan, lanportspeed=lanportspeed, pauseReceived=pauseReceived, vendorOui=vendorOui, serialnum=serialnum, wan=wan, adminStatus=adminStatus, groupid=groupid, lanportName=lanportName, jumb=jumb, internetPort=internetPort, xg6846=xg6846, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, unicastsReceived=unicastsReceived, modeEntry=modeEntry, qosTable=qosTable, statisticTable=statisticTable, jumblan4=jumblan4, portStatistic=portStatistic, qos=qos, priority=priority, lanportTable=lanportTable, jumblan3=jumblan3, portEntry=portEntry, secondaryDns=secondaryDns, tftp=tftp, voltage=voltage, staticDns=staticDns, catv=catv, vendorRev=vendorRev, deviceinfo=deviceinfo, ddminfo=ddminfo, qosEntry=qosEntry, tftpSevIp=tftpSevIp, fileName=fileName, rebootEnable=rebootEnable, staticIpAddr=staticIpAddr, reboot=reboot, jumblan1=jumblan1, multicastsReceived=multicastsReceived, lan3=lan3, port2=port2, action=action, port4=port4, hostname=hostname, port3=port3, lanportIndex=lanportIndex, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, portPower=portPower, vlangroupTable=vlangroupTable, staticIpDomainName=staticIpDomainName, groupEntry=groupEntry, bias=bias, groupIndex=groupIndex, staticIpSubMask=staticIpSubMask)
