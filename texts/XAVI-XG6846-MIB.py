...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:20:05 2022
...
Gauge32, ModuleIdentity, Unsigned32, iso, IpAddress, snmpModules, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Counter64, MibIdentifier, mib_2, NotificationType, Counter32, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Unsigned32", "iso", "IpAddress", "snmpModules", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Counter64", "MibIdentifier", "mib-2", "NotificationType", "Counter32", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftp=tftp, unicastsTransmitted=unicastsTransmitted, jumblan2=jumblan2, lan4=lan4, vendorOui=vendorOui, primaryDns=primaryDns, jumbwan=jumbwan, port1=port1, lanportTable=lanportTable, staticIpDomainName=staticIpDomainName, pauseTransmitted=pauseTransmitted, staticIpAddr=staticIpAddr, vlan=vlan, vendorRev=vendorRev, temperature=temperature, fcsErrorTransmitted=fcsErrorTransmitted, qosEntry=qosEntry, qosIndex=qosIndex, deviceinfo=deviceinfo, statisticTable=statisticTable, adminStatus=adminStatus, broadcastsTransmitted=broadcastsTransmitted, vlangroupTable=vlangroupTable, vlanid=vlanid, qmode=qmode, staticIpGateway=staticIpGateway, catv=catv, lanportspeed=lanportspeed, operStatus=operStatus, pauseReceived=pauseReceived, multicastsTransmitted=multicastsTransmitted, domainame=domainame, groupid=groupid, ddminfo=ddminfo, multicastsReceived=multicastsReceived, broadcastsReceived=broadcastsReceived, modeEntry=modeEntry, reboot=reboot, port3=port3, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, lanportpause=lanportpause, jumblan3=jumblan3, fileType=fileType, wan=wan, portTable=portTable, unicastsReceived=unicastsReceived, jumb=jumb, lan2=lan2, tftpSevIp=tftpSevIp, portStatistic=portStatistic, lan1=lan1, catvEnable=catvEnable, qosTable=qosTable, lanportIndex=lanportIndex, portStatEntry=portStatEntry, priority=priority, xg6846=xg6846, bias=bias, jumblan1=jumblan1, port4=port4, portmode=portmode, txPower=txPower, fileName=fileName, staticIpHostName=staticIpHostName, staticIpSubMask=staticIpSubMask, hostname=hostname, port2=port2, rebootEnable=rebootEnable, vendorPn=vendorPn, qos=qos, lan3=lan3, dscpEnable=dscpEnable, action=action, staticDns=staticDns, portEntry=portEntry, staticIpSecondaryDns=staticIpSecondaryDns, qmapping=qmapping, wanType=wanType, groupEntry=groupEntry, staticIpPrimaryDns=staticIpPrimaryDns, voltage=voltage, portName=portName, internetPort=internetPort, statIndex=statIndex, secondaryDns=secondaryDns, portPower=portPower, vendorName=vendorName, jumblan4=jumblan4, groupIndex=groupIndex, rxPower=rxPower, speed=speed, serialnum=serialnum, lanportName=lanportName)
