...
NotificationType, ObjectIdentity, Counter64, snmpModules, Bits, TimeTicks, mib_2, Unsigned32, MibIdentifier, Gauge32, IpAddress, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Counter64", "snmpModules", "Bits", "TimeTicks", "mib-2", "Unsigned32", "MibIdentifier", "Gauge32", "IpAddress", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", bias=bias, vlangroupTable=vlangroupTable, modeEntry=modeEntry, vendorRev=vendorRev, qmode=qmode, vendorPn=vendorPn, primaryDns=primaryDns, port4=port4, jumblan3=jumblan3, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, tftpSevIp=tftpSevIp, priority=priority, internetPort=internetPort, operStatus=operStatus, vlanid=vlanid, reboot=reboot, secondaryDns=secondaryDns, deviceinfo=deviceinfo, lan4=lan4, qosIndex=qosIndex, staticIpHostName=staticIpHostName, adminStatus=adminStatus, xg6846=xg6846, lanportIndex=lanportIndex, staticIpAddr=staticIpAddr, staticIpPrimaryDns=staticIpPrimaryDns, portName=portName, groupid=groupid, rebootEnable=rebootEnable, fcsErrorReceived=fcsErrorReceived, dscpEnable=dscpEnable, wan=wan, voltage=voltage, groupIndex=groupIndex, temperature=temperature, port2=port2, staticIpDomainName=staticIpDomainName, port3=port3, statIndex=statIndex, txPower=txPower, jumblan1=jumblan1, portPower=portPower, port1=port1, portEntry=portEntry, fileName=fileName, qmapping=qmapping, multicastsReceived=multicastsReceived, lan2=lan2, wanType=wanType, lanportName=lanportName, jumb=jumb, lanportTable=lanportTable, vlan=vlan, lan1=lan1, portStatEntry=portStatEntry, ddminfo=ddminfo, rxPower=rxPower, action=action, catvEnable=catvEnable, portTable=portTable, jumblan4=jumblan4, staticIpSecondaryDns=staticIpSecondaryDns, portIndex=portIndex, tftp=tftp, lanportpause=lanportpause, pauseReceived=pauseReceived, qosEntry=qosEntry, fcsErrorTransmitted=fcsErrorTransmitted, unicastsTransmitted=unicastsTransmitted, broadcastsReceived=broadcastsReceived, portmode=portmode, multicastsTransmitted=multicastsTransmitted, vendorName=vendorName, hostname=hostname, portStatistic=portStatistic, lan3=lan3, lanportspeed=lanportspeed, qos=qos, staticDns=staticDns, groupEntry=groupEntry, fileType=fileType, staticIpSubMask=staticIpSubMask, speed=speed, staticIpGateway=staticIpGateway, jumbwan=jumbwan, unicastsReceived=unicastsReceived, qosTable=qosTable, pauseTransmitted=pauseTransmitted, serialnum=serialnum, jumblan2=jumblan2, catv=catv, domainame=domainame, statisticTable=statisticTable)
