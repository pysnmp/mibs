...
# Produced by pysmi-1.1.3 at Tue Dec  7 13:47:31 2021
...
enterprises, ModuleIdentity, Bits, Integer32, iso, Unsigned32, mib_2, MibIdentifier, Counter64, ObjectIdentity, Gauge32, snmpModules, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "Bits", "Integer32", "iso", "Unsigned32", "mib-2", "MibIdentifier", "Counter64", "ObjectIdentity", "Gauge32", "snmpModules", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, groupid=groupid, qosTable=qosTable, qmapping=qmapping, staticIpDomainName=staticIpDomainName, tftpSevIp=tftpSevIp, staticIpPrimaryDns=staticIpPrimaryDns, lanportpause=lanportpause, speed=speed, deviceinfo=deviceinfo, fileName=fileName, unicastsTransmitted=unicastsTransmitted, modeEntry=modeEntry, vendorRev=vendorRev, portmode=portmode, wanType=wanType, jumblan2=jumblan2, broadcastsReceived=broadcastsReceived, staticIpSubMask=staticIpSubMask, primaryDns=primaryDns, lanportIndex=lanportIndex, priority=priority, qos=qos, tftp=tftp, voltage=voltage, unicastsReceived=unicastsReceived, xg6846=xg6846, internetPort=internetPort, lanportspeed=lanportspeed, hostname=hostname, serialnum=serialnum, port4=port4, pauseTransmitted=pauseTransmitted, lan2=lan2, jumb=jumb, qosIndex=qosIndex, adminStatus=adminStatus, pauseReceived=pauseReceived, operStatus=operStatus, staticIpGateway=staticIpGateway, groupEntry=groupEntry, statIndex=statIndex, catvEnable=catvEnable, domainame=domainame, vlanid=vlanid, reboot=reboot, action=action, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, vendorOui=vendorOui, jumblan3=jumblan3, vendorName=vendorName, vlan=vlan, portStatistic=portStatistic, lanportName=lanportName, vlangroupTable=vlangroupTable, staticDns=staticDns, temperature=temperature, port3=port3, fcsErrorTransmitted=fcsErrorTransmitted, jumblan1=jumblan1, broadcastsTransmitted=broadcastsTransmitted, txPower=txPower, staticIpAddr=staticIpAddr, portTable=portTable, portEntry=portEntry, vendorPn=vendorPn, qosEntry=qosEntry, lanportTable=lanportTable, fileType=fileType, dscpEnable=dscpEnable, groupIndex=groupIndex, rebootEnable=rebootEnable, port2=port2, multicastsReceived=multicastsReceived, portStatEntry=portStatEntry, lan1=lan1, lan3=lan3, statisticTable=statisticTable, ddminfo=ddminfo, bias=bias, rxPower=rxPower, multicastsTransmitted=multicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, portPower=portPower, secondaryDns=secondaryDns, portIndex=portIndex, portName=portName, qmode=qmode, jumbwan=jumbwan, port1=port1, staticIpHostName=staticIpHostName, wan=wan, lan4=lan4)
