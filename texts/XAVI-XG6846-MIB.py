...
# Produced by pysmi-1.1.3 at Mon Nov 22 11:49:05 2021
...
NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, ObjectIdentity, iso, Unsigned32, MibIdentifier, snmpModules, mib_2, Counter32, TimeTicks, Counter64, enterprises, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "ObjectIdentity", "iso", "Unsigned32", "MibIdentifier", "snmpModules", "mib-2", "Counter32", "TimeTicks", "Counter64", "enterprises", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlan=vlan, jumblan1=jumblan1, reboot=reboot, rebootEnable=rebootEnable, staticIpDomainName=staticIpDomainName, operStatus=operStatus, staticIpAddr=staticIpAddr, deviceinfo=deviceinfo, staticDns=staticDns, xg6846=xg6846, lanportTable=lanportTable, adminStatus=adminStatus, pauseReceived=pauseReceived, action=action, port1=port1, qosTable=qosTable, groupid=groupid, vendorPn=vendorPn, bias=bias, staticIpHostName=staticIpHostName, staticIpSubMask=staticIpSubMask, modeEntry=modeEntry, lan4=lan4, vendorRev=vendorRev, wanType=wanType, lanportpause=lanportpause, catv=catv, qos=qos, rxPower=rxPower, jumblan3=jumblan3, portStatistic=portStatistic, lanportName=lanportName, lan1=lan1, vendorName=vendorName, fileName=fileName, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, lanportspeed=lanportspeed, tftpSevIp=tftpSevIp, qosIndex=qosIndex, speed=speed, voltage=voltage, groupEntry=groupEntry, jumb=jumb, vendorOui=vendorOui, priority=priority, statisticTable=statisticTable, qosEntry=qosEntry, jumblan2=jumblan2, wan=wan, tftp=tftp, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, groupIndex=groupIndex, portPower=portPower, port2=port2, unicastsReceived=unicastsReceived, ddminfo=ddminfo, qmode=qmode, catvEnable=catvEnable, pauseTransmitted=pauseTransmitted, multicastsReceived=multicastsReceived, qmapping=qmapping, portIndex=portIndex, statIndex=statIndex, broadcastsTransmitted=broadcastsTransmitted, portmode=portmode, vlanid=vlanid, jumblan4=jumblan4, primaryDns=primaryDns, dscpEnable=dscpEnable, serialnum=serialnum, vlangroupTable=vlangroupTable, broadcastsReceived=broadcastsReceived, port4=port4, multicastsTransmitted=multicastsTransmitted, temperature=temperature, unicastsTransmitted=unicastsTransmitted, secondaryDns=secondaryDns, domainame=domainame, portName=portName, portEntry=portEntry, lan2=lan2, lanportIndex=lanportIndex, fileType=fileType, portTable=portTable, port3=port3, portStatEntry=portStatEntry, staticIpGateway=staticIpGateway, jumbwan=jumbwan, hostname=hostname, fcsErrorReceived=fcsErrorReceived, txPower=txPower)
