...
IpAddress, snmpModules, Bits, ModuleIdentity, Integer32, ObjectIdentity, Gauge32, MibIdentifier, enterprises, TimeTicks, Counter64, iso, Unsigned32, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "snmpModules", "Bits", "ModuleIdentity", "Integer32", "ObjectIdentity", "Gauge32", "MibIdentifier", "enterprises", "TimeTicks", "Counter64", "iso", "Unsigned32", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", ddminfo=ddminfo, deviceinfo=deviceinfo, statIndex=statIndex, adminStatus=adminStatus, vlangroupTable=vlangroupTable, portmode=portmode, catv=catv, broadcastsReceived=broadcastsReceived, serialnum=serialnum, primaryDns=primaryDns, qosEntry=qosEntry, portTable=portTable, staticIpSecondaryDns=staticIpSecondaryDns, lanportpause=lanportpause, rxPower=rxPower, staticIpDomainName=staticIpDomainName, temperature=temperature, priority=priority, lan3=lan3, fcsErrorTransmitted=fcsErrorTransmitted, vendorOui=vendorOui, pauseReceived=pauseReceived, groupid=groupid, qos=qos, lanportName=lanportName, lan2=lan2, staticIpSubMask=staticIpSubMask, multicastsTransmitted=multicastsTransmitted, portPower=portPower, portEntry=portEntry, voltage=voltage, hostname=hostname, reboot=reboot, tftp=tftp, vendorRev=vendorRev, lan4=lan4, xg6846=xg6846, internetPort=internetPort, statisticTable=statisticTable, multicastsReceived=multicastsReceived, lan1=lan1, fileType=fileType, dscpEnable=dscpEnable, portStatistic=portStatistic, action=action, vendorPn=vendorPn, port1=port1, vlan=vlan, bias=bias, jumblan4=jumblan4, port4=port4, unicastsTransmitted=unicastsTransmitted, unicastsReceived=unicastsReceived, secondaryDns=secondaryDns, qmode=qmode, lanportTable=lanportTable, txPower=txPower, pauseTransmitted=pauseTransmitted, jumblan2=jumblan2, qosIndex=qosIndex, rebootEnable=rebootEnable, lanportspeed=lanportspeed, lanportIndex=lanportIndex, staticDns=staticDns, vlanid=vlanid, portName=portName, wan=wan, speed=speed, jumblan3=jumblan3, groupIndex=groupIndex, portStatEntry=portStatEntry, catvEnable=catvEnable, jumb=jumb, fcsErrorReceived=fcsErrorReceived, staticIpHostName=staticIpHostName, qosTable=qosTable, port2=port2, domainame=domainame, jumblan1=jumblan1, modeEntry=modeEntry, tftpSevIp=tftpSevIp, jumbwan=jumbwan, portIndex=portIndex, staticIpPrimaryDns=staticIpPrimaryDns, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, wanType=wanType, fileName=fileName, port3=port3, groupEntry=groupEntry, operStatus=operStatus, broadcastsTransmitted=broadcastsTransmitted, vendorName=vendorName, qmapping=qmapping)
