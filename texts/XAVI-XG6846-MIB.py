...
ModuleIdentity, mib_2, snmpModules, NotificationType, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier, Unsigned32, TimeTicks, Counter64, Gauge32, Bits, Counter32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "snmpModules", "NotificationType", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier", "Unsigned32", "TimeTicks", "Counter64", "Gauge32", "Bits", "Counter32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsTransmitted=multicastsTransmitted, temperature=temperature, serialnum=serialnum, staticIpPrimaryDns=staticIpPrimaryDns, lan3=lan3, lan1=lan1, portTable=portTable, vlan=vlan, modeEntry=modeEntry, secondaryDns=secondaryDns, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, catv=catv, hostname=hostname, tftp=tftp, portStatEntry=portStatEntry, deviceinfo=deviceinfo, vendorName=vendorName, fileName=fileName, port2=port2, port3=port3, vendorOui=vendorOui, internetPort=internetPort, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, portmode=portmode, multicastsReceived=multicastsReceived, qos=qos, groupIndex=groupIndex, rxPower=rxPower, vendorRev=vendorRev, groupEntry=groupEntry, rebootEnable=rebootEnable, lanportTable=lanportTable, speed=speed, pauseTransmitted=pauseTransmitted, port1=port1, vlanid=vlanid, staticDns=staticDns, bias=bias, lanportpause=lanportpause, jumb=jumb, staticIpAddr=staticIpAddr, pauseReceived=pauseReceived, priority=priority, portIndex=portIndex, portStatistic=portStatistic, vlangroupTable=vlangroupTable, unicastsTransmitted=unicastsTransmitted, jumblan4=jumblan4, action=action, qosTable=qosTable, qmapping=qmapping, vendorPn=vendorPn, qosEntry=qosEntry, qosIndex=qosIndex, catvEnable=catvEnable, jumblan1=jumblan1, unicastsReceived=unicastsReceived, wanType=wanType, jumbwan=jumbwan, lan4=lan4, statisticTable=statisticTable, operStatus=operStatus, adminStatus=adminStatus, broadcastsTransmitted=broadcastsTransmitted, jumblan2=jumblan2, lan2=lan2, txPower=txPower, port4=port4, voltage=voltage, tftpSevIp=tftpSevIp, qmode=qmode, primaryDns=primaryDns, lanportName=lanportName, jumblan3=jumblan3, portName=portName, portPower=portPower, domainame=domainame, staticIpHostName=staticIpHostName, broadcastsReceived=broadcastsReceived, lanportspeed=lanportspeed, reboot=reboot, wan=wan, groupid=groupid, fileType=fileType, staticIpGateway=staticIpGateway, staticIpDomainName=staticIpDomainName, dscpEnable=dscpEnable, portEntry=portEntry, staticIpSubMask=staticIpSubMask, ddminfo=ddminfo, lanportIndex=lanportIndex, statIndex=statIndex)
