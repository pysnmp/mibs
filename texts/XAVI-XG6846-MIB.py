...
# Produced by pysmi-1.1.12 at Wed Jun 26 13:36:28 2024
...
NotificationType, Integer32, ModuleIdentity, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Counter32, IpAddress, enterprises, TimeTicks, MibIdentifier, snmpModules, Gauge32, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ModuleIdentity", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Counter32", "IpAddress", "enterprises", "TimeTicks", "MibIdentifier", "snmpModules", "Gauge32", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportTable=lanportTable, lan3=lan3, statisticTable=statisticTable, primaryDns=primaryDns, portIndex=portIndex, staticIpHostName=staticIpHostName, port3=port3, portName=portName, domainame=domainame, port2=port2, statIndex=statIndex, vendorRev=vendorRev, jumblan4=jumblan4, reboot=reboot, operStatus=operStatus, catvEnable=catvEnable, temperature=temperature, fileType=fileType, modeEntry=modeEntry, voltage=voltage, jumb=jumb, staticIpSubMask=staticIpSubMask, lanportName=lanportName, broadcastsTransmitted=broadcastsTransmitted, vendorName=vendorName, jumbwan=jumbwan, port1=port1, qosEntry=qosEntry, qosTable=qosTable, unicastsReceived=unicastsReceived, lan1=lan1, vendorPn=vendorPn, tftpSevIp=tftpSevIp, lan2=lan2, groupid=groupid, serialnum=serialnum, bias=bias, staticIpDomainName=staticIpDomainName, groupEntry=groupEntry, qmode=qmode, fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, multicastsTransmitted=multicastsTransmitted, hostname=hostname, fcsErrorReceived=fcsErrorReceived, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, ddminfo=ddminfo, vendorOui=vendorOui, lan4=lan4, speed=speed, vlanid=vlanid, dscpEnable=dscpEnable, lanportpause=lanportpause, fileName=fileName, staticIpSecondaryDns=staticIpSecondaryDns, action=action, adminStatus=adminStatus, qosIndex=qosIndex, secondaryDns=secondaryDns, unicastsTransmitted=unicastsTransmitted, txPower=txPower, portStatistic=portStatistic, lanportspeed=lanportspeed, rebootEnable=rebootEnable, port4=port4, wanType=wanType, jumblan1=jumblan1, portEntry=portEntry, qos=qos, rxPower=rxPower, priority=priority, groupIndex=groupIndex, internetPort=internetPort, tftp=tftp, staticIpAddr=staticIpAddr, multicastsReceived=multicastsReceived, portPower=portPower, catv=catv, qmapping=qmapping, staticIpGateway=staticIpGateway, staticDns=staticDns, deviceinfo=deviceinfo, xg6846=xg6846, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, vlan=vlan, portTable=portTable, wan=wan, lanportIndex=lanportIndex, pauseReceived=pauseReceived, portStatEntry=portStatEntry, portmode=portmode, jumblan2=jumblan2)
