...
# Produced by pysmi-1.1.8 at Tue Jan 18 13:45:51 2022
...
enterprises, Counter32, Counter64, iso, mib_2, TimeTicks, IpAddress, snmpModules, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, NotificationType, MibIdentifier, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Counter64", "iso", "mib-2", "TimeTicks", "IpAddress", "snmpModules", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "NotificationType", "MibIdentifier", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportIndex=lanportIndex, vlanid=vlanid, pauseTransmitted=pauseTransmitted, lanportName=lanportName, fcsErrorReceived=fcsErrorReceived, adminStatus=adminStatus, vlan=vlan, fileType=fileType, rxPower=rxPower, qos=qos, jumblan1=jumblan1, pauseReceived=pauseReceived, staticIpSubMask=staticIpSubMask, port1=port1, catv=catv, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, speed=speed, temperature=temperature, port4=port4, rebootEnable=rebootEnable, secondaryDns=secondaryDns, txPower=txPower, operStatus=operStatus, voltage=voltage, qosTable=qosTable, groupEntry=groupEntry, internetPort=internetPort, broadcastsReceived=broadcastsReceived, priority=priority, lanportspeed=lanportspeed, portmode=portmode, xg6846=xg6846, portName=portName, catvEnable=catvEnable, lanportpause=lanportpause, staticIpPrimaryDns=staticIpPrimaryDns, vendorPn=vendorPn, portStatEntry=portStatEntry, portIndex=portIndex, dscpEnable=dscpEnable, tftp=tftp, groupid=groupid, hostname=hostname, portTable=portTable, staticIpGateway=staticIpGateway, staticDns=staticDns, reboot=reboot, groupIndex=groupIndex, vendorName=vendorName, qmapping=qmapping, ddminfo=ddminfo, wanType=wanType, qosIndex=qosIndex, lanportTable=lanportTable, port2=port2, vlangroupTable=vlangroupTable, tftpSevIp=tftpSevIp, multicastsReceived=multicastsReceived, portPower=portPower, jumb=jumb, jumblan2=jumblan2, primaryDns=primaryDns, portEntry=portEntry, portStatistic=portStatistic, jumblan4=jumblan4, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, qosEntry=qosEntry, deviceinfo=deviceinfo, broadcastsTransmitted=broadcastsTransmitted, jumblan3=jumblan3, domainame=domainame, action=action, statIndex=statIndex, statisticTable=statisticTable, lan1=lan1, staticIpAddr=staticIpAddr, port3=port3, vendorOui=vendorOui, fcsErrorTransmitted=fcsErrorTransmitted, lan4=lan4, modeEntry=modeEntry, wan=wan, vendorRev=vendorRev, qmode=qmode, staticIpSecondaryDns=staticIpSecondaryDns, lan2=lan2, staticIpDomainName=staticIpDomainName, bias=bias, fileName=fileName, jumbwan=jumbwan, serialnum=serialnum, lan3=lan3)
