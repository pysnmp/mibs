...
Unsigned32, Integer32, enterprises, Counter32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ObjectIdentity, snmpModules, IpAddress, TimeTicks, Bits, MibIdentifier, Counter64, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "enterprises", "Counter32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ObjectIdentity", "snmpModules", "IpAddress", "TimeTicks", "Bits", "MibIdentifier", "Counter64", "ModuleIdentity", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseReceived=pauseReceived, primaryDns=primaryDns, adminStatus=adminStatus, qosEntry=qosEntry, multicastsReceived=multicastsReceived, qosTable=qosTable, lanportspeed=lanportspeed, jumblan4=jumblan4, deviceinfo=deviceinfo, qmode=qmode, jumbwan=jumbwan, lanportTable=lanportTable, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, vlanid=vlanid, statIndex=statIndex, pauseTransmitted=pauseTransmitted, fileName=fileName, portPower=portPower, staticIpAddr=staticIpAddr, catvEnable=catvEnable, staticIpHostName=staticIpHostName, staticIpGateway=staticIpGateway, vlan=vlan, multicastsTransmitted=multicastsTransmitted, tftp=tftp, temperature=temperature, lanportIndex=lanportIndex, fcsErrorTransmitted=fcsErrorTransmitted, modeEntry=modeEntry, vlangroupTable=vlangroupTable, fcsErrorReceived=fcsErrorReceived, jumblan1=jumblan1, jumblan3=jumblan3, lan3=lan3, broadcastsReceived=broadcastsReceived, portStatEntry=portStatEntry, speed=speed, vendorRev=vendorRev, txPower=txPower, lanportpause=lanportpause, portStatistic=portStatistic, vendorOui=vendorOui, tftpSevIp=tftpSevIp, jumblan2=jumblan2, port4=port4, lanportName=lanportName, qmapping=qmapping, wanType=wanType, portIndex=portIndex, staticIpSubMask=staticIpSubMask, bias=bias, domainame=domainame, wan=wan, groupid=groupid, portmode=portmode, portName=portName, internetPort=internetPort, port1=port1, staticDns=staticDns, lan2=lan2, ddminfo=ddminfo, statisticTable=statisticTable, jumb=jumb, port2=port2, hostname=hostname, xg6846=xg6846, fileType=fileType, priority=priority, rxPower=rxPower, operStatus=operStatus, serialnum=serialnum, portEntry=portEntry, rebootEnable=rebootEnable, broadcastsTransmitted=broadcastsTransmitted, staticIpDomainName=staticIpDomainName, qosIndex=qosIndex, portTable=portTable, dscpEnable=dscpEnable, voltage=voltage, lan1=lan1, vendorPn=vendorPn, catv=catv, staticIpSecondaryDns=staticIpSecondaryDns, action=action, vendorName=vendorName, secondaryDns=secondaryDns, port3=port3, groupIndex=groupIndex, qos=qos, unicastsTransmitted=unicastsTransmitted, lan4=lan4, reboot=reboot, groupEntry=groupEntry)
