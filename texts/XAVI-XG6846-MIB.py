...
# Produced by pysmi-1.1.8 at Sat Jan 15 16:44:23 2022
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, snmpModules, MibIdentifier, enterprises, NotificationType, ObjectIdentity, ModuleIdentity, mib_2, TimeTicks, IpAddress, iso, Bits, Integer32, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "snmpModules", "MibIdentifier", "enterprises", "NotificationType", "ObjectIdentity", "ModuleIdentity", "mib-2", "TimeTicks", "IpAddress", "iso", "Bits", "Integer32", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port2=port2, portIndex=portIndex, vendorRev=vendorRev, staticIpGateway=staticIpGateway, groupid=groupid, portPower=portPower, voltage=voltage, pauseReceived=pauseReceived, fcsErrorReceived=fcsErrorReceived, port3=port3, vlangroupTable=vlangroupTable, jumblan3=jumblan3, vendorOui=vendorOui, qmapping=qmapping, fileType=fileType, lanportIndex=lanportIndex, priority=priority, xg6846=xg6846, modeEntry=modeEntry, lanportName=lanportName, vendorPn=vendorPn, unicastsTransmitted=unicastsTransmitted, rxPower=rxPower, staticIpAddr=staticIpAddr, internetPort=internetPort, port4=port4, vlan=vlan, wan=wan, lan3=lan3, unicastsReceived=unicastsReceived, vlanid=vlanid, broadcastsReceived=broadcastsReceived, dscpEnable=dscpEnable, statisticTable=statisticTable, txPower=txPower, catv=catv, multicastsReceived=multicastsReceived, secondaryDns=secondaryDns, port1=port1, tftp=tftp, action=action, wanType=wanType, portTable=portTable, portStatEntry=portStatEntry, pauseTransmitted=pauseTransmitted, lanportTable=lanportTable, groupIndex=groupIndex, portEntry=portEntry, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, adminStatus=adminStatus, lanportspeed=lanportspeed, lan2=lan2, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, portmode=portmode, domainame=domainame, qosEntry=qosEntry, jumblan4=jumblan4, qos=qos, staticDns=staticDns, vendorName=vendorName, jumblan1=jumblan1, reboot=reboot, portName=portName, staticIpDomainName=staticIpDomainName, statIndex=statIndex, jumb=jumb, fileName=fileName, jumbwan=jumbwan, primaryDns=primaryDns, lan1=lan1, qosTable=qosTable, temperature=temperature, lan4=lan4, lanportpause=lanportpause, staticIpSecondaryDns=staticIpSecondaryDns, groupEntry=groupEntry, ddminfo=ddminfo, qosIndex=qosIndex, staticIpHostName=staticIpHostName, hostname=hostname, operStatus=operStatus, deviceinfo=deviceinfo, qmode=qmode, multicastsTransmitted=multicastsTransmitted, tftpSevIp=tftpSevIp, jumblan2=jumblan2, catvEnable=catvEnable, portStatistic=portStatistic, bias=bias, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum)
