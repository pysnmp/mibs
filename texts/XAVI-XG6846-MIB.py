...
# Produced by pysmi-1.1.3 at Mon Nov 22 19:26:05 2021
...
MibIdentifier, mib_2, Gauge32, Bits, Counter32, ModuleIdentity, enterprises, Integer32, IpAddress, snmpModules, Unsigned32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "mib-2", "Gauge32", "Bits", "Counter32", "ModuleIdentity", "enterprises", "Integer32", "IpAddress", "snmpModules", "Unsigned32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlangroupTable=vlangroupTable, port4=port4, groupIndex=groupIndex, priority=priority, ddminfo=ddminfo, reboot=reboot, domainame=domainame, fcsErrorTransmitted=fcsErrorTransmitted, fileType=fileType, portPower=portPower, lan1=lan1, qosIndex=qosIndex, jumb=jumb, vendorName=vendorName, staticIpGateway=staticIpGateway, port1=port1, vendorOui=vendorOui, rxPower=rxPower, unicastsReceived=unicastsReceived, fcsErrorReceived=fcsErrorReceived, vlan=vlan, portEntry=portEntry, multicastsTransmitted=multicastsTransmitted, lanportTable=lanportTable, txPower=txPower, lan2=lan2, voltage=voltage, vlanid=vlanid, pauseTransmitted=pauseTransmitted, vendorRev=vendorRev, qmode=qmode, operStatus=operStatus, jumblan1=jumblan1, bias=bias, fileName=fileName, portmode=portmode, tftp=tftp, wan=wan, port2=port2, catvEnable=catvEnable, broadcastsTransmitted=broadcastsTransmitted, temperature=temperature, jumbwan=jumbwan, staticIpAddr=staticIpAddr, dscpEnable=dscpEnable, lan4=lan4, multicastsReceived=multicastsReceived, tftpSevIp=tftpSevIp, deviceinfo=deviceinfo, staticIpHostName=staticIpHostName, qosTable=qosTable, broadcastsReceived=broadcastsReceived, speed=speed, qmapping=qmapping, qos=qos, adminStatus=adminStatus, groupid=groupid, lanportspeed=lanportspeed, lanportName=lanportName, jumblan3=jumblan3, xg6846=xg6846, lanportpause=lanportpause, staticIpDomainName=staticIpDomainName, staticIpSubMask=staticIpSubMask, action=action, groupEntry=groupEntry, qosEntry=qosEntry, staticDns=staticDns, portIndex=portIndex, secondaryDns=secondaryDns, serialnum=serialnum, statisticTable=statisticTable, internetPort=internetPort, wanType=wanType, jumblan2=jumblan2, vendorPn=vendorPn, staticIpPrimaryDns=staticIpPrimaryDns, portStatistic=portStatistic, portStatEntry=portStatEntry, lanportIndex=lanportIndex, statIndex=statIndex, portName=portName, jumblan4=jumblan4, unicastsTransmitted=unicastsTransmitted, pauseReceived=pauseReceived, portTable=portTable, rebootEnable=rebootEnable, primaryDns=primaryDns, lan3=lan3, port3=port3, staticIpSecondaryDns=staticIpSecondaryDns, hostname=hostname, modeEntry=modeEntry, catv=catv)
