...
# Produced by pysmi-1.1.8 at Thu Feb  9 12:03:52 2023
...
ObjectIdentity, mib_2, iso, Unsigned32, ModuleIdentity, Counter64, MibIdentifier, snmpModules, enterprises, Bits, TimeTicks, NotificationType, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "mib-2", "iso", "Unsigned32", "ModuleIdentity", "Counter64", "MibIdentifier", "snmpModules", "enterprises", "Bits", "TimeTicks", "NotificationType", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", hostname=hostname, unicastsReceived=unicastsReceived, portStatistic=portStatistic, reboot=reboot, vendorPn=vendorPn, qosTable=qosTable, serialnum=serialnum, domainame=domainame, fileName=fileName, priority=priority, wan=wan, broadcastsTransmitted=broadcastsTransmitted, staticIpHostName=staticIpHostName, qmode=qmode, staticDns=staticDns, txPower=txPower, portStatEntry=portStatEntry, staticIpGateway=staticIpGateway, port1=port1, portmode=portmode, primaryDns=primaryDns, operStatus=operStatus, portIndex=portIndex, multicastsReceived=multicastsReceived, vendorRev=vendorRev, port4=port4, speed=speed, secondaryDns=secondaryDns, qos=qos, action=action, temperature=temperature, dscpEnable=dscpEnable, lan3=lan3, lan1=lan1, fcsErrorReceived=fcsErrorReceived, portTable=portTable, catv=catv, tftp=tftp, qosIndex=qosIndex, vlanid=vlanid, voltage=voltage, jumblan2=jumblan2, port3=port3, multicastsTransmitted=multicastsTransmitted, statisticTable=statisticTable, portEntry=portEntry, bias=bias, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, groupEntry=groupEntry, ddminfo=ddminfo, vlan=vlan, jumb=jumb, jumbwan=jumbwan, qosEntry=qosEntry, lan2=lan2, tftpSevIp=tftpSevIp, jumblan1=jumblan1, xg6846=xg6846, lanportIndex=lanportIndex, vendorOui=vendorOui, deviceinfo=deviceinfo, unicastsTransmitted=unicastsTransmitted, lanportpause=lanportpause, vendorName=vendorName, portPower=portPower, pauseTransmitted=pauseTransmitted, rebootEnable=rebootEnable, jumblan4=jumblan4, qmapping=qmapping, catvEnable=catvEnable, staticIpSubMask=staticIpSubMask, port2=port2, staticIpAddr=staticIpAddr, staticIpDomainName=staticIpDomainName, statIndex=statIndex, wanType=wanType, rxPower=rxPower, fileType=fileType, groupid=groupid, lanportName=lanportName, lan4=lan4, jumblan3=jumblan3, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, pauseReceived=pauseReceived, portName=portName, broadcastsReceived=broadcastsReceived, adminStatus=adminStatus, lanportspeed=lanportspeed, groupIndex=groupIndex, lanportTable=lanportTable, vlangroupTable=vlangroupTable)
