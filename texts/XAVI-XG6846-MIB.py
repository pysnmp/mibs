...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:01:39 2021
...
ModuleIdentity, ObjectIdentity, enterprises, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Unsigned32, Counter32, snmpModules, NotificationType, TimeTicks, mib_2, iso, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "enterprises", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Unsigned32", "Counter32", "snmpModules", "NotificationType", "TimeTicks", "mib-2", "iso", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsTransmitted=unicastsTransmitted, portName=portName, tftp=tftp, serialnum=serialnum, rebootEnable=rebootEnable, lanportTable=lanportTable, vendorOui=vendorOui, portPower=portPower, staticIpPrimaryDns=staticIpPrimaryDns, portStatEntry=portStatEntry, priority=priority, lan3=lan3, vendorName=vendorName, internetPort=internetPort, voltage=voltage, statisticTable=statisticTable, port2=port2, statIndex=statIndex, bias=bias, qos=qos, ddminfo=ddminfo, staticIpAddr=staticIpAddr, groupEntry=groupEntry, primaryDns=primaryDns, staticIpDomainName=staticIpDomainName, portIndex=portIndex, staticIpGateway=staticIpGateway, vlangroupTable=vlangroupTable, vendorRev=vendorRev, secondaryDns=secondaryDns, lanportIndex=lanportIndex, tftpSevIp=tftpSevIp, port4=port4, dscpEnable=dscpEnable, wan=wan, vendorPn=vendorPn, operStatus=operStatus, staticIpSubMask=staticIpSubMask, portmode=portmode, qmode=qmode, portEntry=portEntry, jumblan2=jumblan2, groupIndex=groupIndex, multicastsReceived=multicastsReceived, jumb=jumb, groupid=groupid, port1=port1, catv=catv, jumblan1=jumblan1, lan2=lan2, vlanid=vlanid, action=action, temperature=temperature, pauseReceived=pauseReceived, lan4=lan4, adminStatus=adminStatus, rxPower=rxPower, hostname=hostname, deviceinfo=deviceinfo, modeEntry=modeEntry, vlan=vlan, broadcastsTransmitted=broadcastsTransmitted, qosTable=qosTable, jumbwan=jumbwan, fileName=fileName, speed=speed, port3=port3, catvEnable=catvEnable, lanportspeed=lanportspeed, qosEntry=qosEntry, txPower=txPower, fcsErrorTransmitted=fcsErrorTransmitted, xg6846=xg6846, fileType=fileType, multicastsTransmitted=multicastsTransmitted, lanportpause=lanportpause, staticIpHostName=staticIpHostName, unicastsReceived=unicastsReceived, pauseTransmitted=pauseTransmitted, portStatistic=portStatistic, lan1=lan1, wanType=wanType, jumblan3=jumblan3, reboot=reboot, jumblan4=jumblan4, staticDns=staticDns, staticIpSecondaryDns=staticIpSecondaryDns, domainame=domainame, broadcastsReceived=broadcastsReceived, qosIndex=qosIndex, portTable=portTable, qmapping=qmapping, fcsErrorReceived=fcsErrorReceived, lanportName=lanportName)
