...
# Produced by pysmi-1.1.3 at Wed Dec  1 15:44:22 2021
...
Integer32, Counter32, enterprises, iso, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, mib_2, Gauge32, Unsigned32, Bits, TimeTicks, IpAddress, ModuleIdentity, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "enterprises", "iso", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "mib-2", "Gauge32", "Unsigned32", "Bits", "TimeTicks", "IpAddress", "ModuleIdentity", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpDomainName=staticIpDomainName, portIndex=portIndex, vlan=vlan, internetPort=internetPort, rxPower=rxPower, multicastsReceived=multicastsReceived, wanType=wanType, portPower=portPower, lan4=lan4, fileName=fileName, xg6846=xg6846, qosTable=qosTable, modeEntry=modeEntry, operStatus=operStatus, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived, port2=port2, port4=port4, temperature=temperature, fcsErrorReceived=fcsErrorReceived, statisticTable=statisticTable, speed=speed, multicastsTransmitted=multicastsTransmitted, pauseReceived=pauseReceived, txPower=txPower, action=action, lan2=lan2, dscpEnable=dscpEnable, jumblan2=jumblan2, lanportpause=lanportpause, lanportName=lanportName, jumblan4=jumblan4, groupEntry=groupEntry, portmode=portmode, hostname=hostname, vendorRev=vendorRev, staticIpHostName=staticIpHostName, qos=qos, groupIndex=groupIndex, reboot=reboot, ddminfo=ddminfo, staticIpSubMask=staticIpSubMask, tftpSevIp=tftpSevIp, unicastsTransmitted=unicastsTransmitted, jumbwan=jumbwan, lanportIndex=lanportIndex, staticIpAddr=staticIpAddr, voltage=voltage, portName=portName, statIndex=statIndex, groupid=groupid, fcsErrorTransmitted=fcsErrorTransmitted, portStatistic=portStatistic, lanportspeed=lanportspeed, staticIpGateway=staticIpGateway, fileType=fileType, jumblan1=jumblan1, priority=priority, primaryDns=primaryDns, lanportTable=lanportTable, adminStatus=adminStatus, portStatEntry=portStatEntry, deviceinfo=deviceinfo, staticDns=staticDns, catvEnable=catvEnable, vendorOui=vendorOui, jumblan3=jumblan3, bias=bias, portEntry=portEntry, vendorName=vendorName, catv=catv, vlangroupTable=vlangroupTable, qosIndex=qosIndex, port1=port1, portTable=portTable, qmapping=qmapping, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum, jumb=jumb, tftp=tftp, pauseTransmitted=pauseTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, lan3=lan3, wan=wan, broadcastsReceived=broadcastsReceived, port3=port3, domainame=domainame, staticIpPrimaryDns=staticIpPrimaryDns, lan1=lan1, vlanid=vlanid, rebootEnable=rebootEnable, vendorPn=vendorPn, qmode=qmode, qosEntry=qosEntry)
