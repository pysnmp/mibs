...
# Produced by pysmi-1.1.3 at Tue Nov 30 03:03:35 2021
...
Integer32, Counter32, ModuleIdentity, snmpModules, enterprises, iso, Counter64, mib_2, TimeTicks, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, MibIdentifier, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "ModuleIdentity", "snmpModules", "enterprises", "iso", "Counter64", "mib-2", "TimeTicks", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, pauseReceived=pauseReceived, lan3=lan3, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, adminStatus=adminStatus, fileType=fileType, catvEnable=catvEnable, portEntry=portEntry, staticIpPrimaryDns=staticIpPrimaryDns, rebootEnable=rebootEnable, fileName=fileName, lan2=lan2, priority=priority, secondaryDns=secondaryDns, domainame=domainame, bias=bias, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, temperature=temperature, primaryDns=primaryDns, pauseTransmitted=pauseTransmitted, unicastsTransmitted=unicastsTransmitted, staticDns=staticDns, speed=speed, jumbwan=jumbwan, qmapping=qmapping, catv=catv, hostname=hostname, qosEntry=qosEntry, portmode=portmode, portStatEntry=portStatEntry, staticIpDomainName=staticIpDomainName, lanportIndex=lanportIndex, port2=port2, port4=port4, vendorName=vendorName, groupEntry=groupEntry, vendorPn=vendorPn, staticIpGateway=staticIpGateway, portTable=portTable, multicastsReceived=multicastsReceived, lanportTable=lanportTable, staticIpSecondaryDns=staticIpSecondaryDns, lanportspeed=lanportspeed, internetPort=internetPort, portIndex=portIndex, vlanid=vlanid, port3=port3, portPower=portPower, dscpEnable=dscpEnable, lan1=lan1, action=action, operStatus=operStatus, statisticTable=statisticTable, jumblan2=jumblan2, serialnum=serialnum, qmode=qmode, vendorRev=vendorRev, qosTable=qosTable, jumblan1=jumblan1, lan4=lan4, broadcastsReceived=broadcastsReceived, voltage=voltage, tftp=tftp, lanportName=lanportName, qos=qos, groupid=groupid, unicastsReceived=unicastsReceived, vlangroupTable=vlangroupTable, vlan=vlan, wanType=wanType, wan=wan, vendorOui=vendorOui, statIndex=statIndex, portStatistic=portStatistic, portName=portName, xg6846=xg6846, tftpSevIp=tftpSevIp, reboot=reboot, lanportpause=lanportpause, jumb=jumb, port1=port1, fcsErrorReceived=fcsErrorReceived, deviceinfo=deviceinfo, rxPower=rxPower, staticIpSubMask=staticIpSubMask, jumblan4=jumblan4, jumblan3=jumblan3, ddminfo=ddminfo, staticIpAddr=staticIpAddr, txPower=txPower, staticIpHostName=staticIpHostName, fcsErrorTransmitted=fcsErrorTransmitted)
