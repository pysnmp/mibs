...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, snmpModules, Integer32, Unsigned32, Gauge32, IpAddress, enterprises, Counter32, Bits, iso, Counter64, ObjectIdentity, MibIdentifier, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "snmpModules", "Integer32", "Unsigned32", "Gauge32", "IpAddress", "enterprises", "Counter32", "Bits", "iso", "Counter64", "ObjectIdentity", "MibIdentifier", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmode=qmode, unicastsReceived=unicastsReceived, lanportTable=lanportTable, txPower=txPower, staticIpHostName=staticIpHostName, jumbwan=jumbwan, portTable=portTable, catv=catv, speed=speed, staticIpSecondaryDns=staticIpSecondaryDns, vendorOui=vendorOui, vlan=vlan, tftp=tftp, deviceinfo=deviceinfo, vendorPn=vendorPn, priority=priority, staticIpDomainName=staticIpDomainName, multicastsReceived=multicastsReceived, fileName=fileName, lanportName=lanportName, jumb=jumb, staticIpGateway=staticIpGateway, fcsErrorReceived=fcsErrorReceived, vlangroupTable=vlangroupTable, portIndex=portIndex, staticIpAddr=staticIpAddr, lan2=lan2, action=action, pauseTransmitted=pauseTransmitted, vendorRev=vendorRev, reboot=reboot, multicastsTransmitted=multicastsTransmitted, groupid=groupid, port1=port1, unicastsTransmitted=unicastsTransmitted, internetPort=internetPort, qosTable=qosTable, statisticTable=statisticTable, lan1=lan1, tftpSevIp=tftpSevIp, secondaryDns=secondaryDns, portStatistic=portStatistic, jumblan3=jumblan3, ddminfo=ddminfo, groupEntry=groupEntry, port2=port2, jumblan2=jumblan2, hostname=hostname, bias=bias, serialnum=serialnum, vlanid=vlanid, lan3=lan3, rxPower=rxPower, groupIndex=groupIndex, portName=portName, lanportpause=lanportpause, modeEntry=modeEntry, voltage=voltage, portStatEntry=portStatEntry, port4=port4, qos=qos, domainame=domainame, portEntry=portEntry, rebootEnable=rebootEnable, vendorName=vendorName, qmapping=qmapping, lan4=lan4, jumblan1=jumblan1, dscpEnable=dscpEnable, staticIpSubMask=staticIpSubMask, fileType=fileType, operStatus=operStatus, catvEnable=catvEnable, qosIndex=qosIndex, wanType=wanType, port3=port3, temperature=temperature, staticDns=staticDns, qosEntry=qosEntry, jumblan4=jumblan4, lanportspeed=lanportspeed, wan=wan, portPower=portPower, statIndex=statIndex, xg6846=xg6846, staticIpPrimaryDns=staticIpPrimaryDns, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, pauseReceived=pauseReceived, lanportIndex=lanportIndex, fcsErrorTransmitted=fcsErrorTransmitted, portmode=portmode, broadcastsTransmitted=broadcastsTransmitted)
