...
MibIdentifier, ModuleIdentity, mib_2, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, Bits, NotificationType, Counter64, Unsigned32, snmpModules, TimeTicks, ObjectIdentity, Counter32, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "mib-2", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "Bits", "NotificationType", "Counter64", "Unsigned32", "snmpModules", "TimeTicks", "ObjectIdentity", "Counter32", "IpAddress", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", operStatus=operStatus, portEntry=portEntry, portIndex=portIndex, vendorRev=vendorRev, staticIpDomainName=staticIpDomainName, domainame=domainame, tftp=tftp, ddminfo=ddminfo, pauseTransmitted=pauseTransmitted, lan3=lan3, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, internetPort=internetPort, staticIpGateway=staticIpGateway, reboot=reboot, rebootEnable=rebootEnable, lanportTable=lanportTable, fileType=fileType, lan4=lan4, pauseReceived=pauseReceived, unicastsTransmitted=unicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, vendorPn=vendorPn, vlangroupTable=vlangroupTable, statisticTable=statisticTable, portName=portName, staticDns=staticDns, primaryDns=primaryDns, speed=speed, qos=qos, lanportIndex=lanportIndex, fcsErrorTransmitted=fcsErrorTransmitted, portPower=portPower, wanType=wanType, port1=port1, wan=wan, jumb=jumb, voltage=voltage, port2=port2, unicastsReceived=unicastsReceived, temperature=temperature, dscpEnable=dscpEnable, port4=port4, staticIpHostName=staticIpHostName, lanportpause=lanportpause, groupEntry=groupEntry, staticIpAddr=staticIpAddr, vlan=vlan, bias=bias, groupid=groupid, qosEntry=qosEntry, qosIndex=qosIndex, portStatEntry=portStatEntry, multicastsTransmitted=multicastsTransmitted, port3=port3, jumbwan=jumbwan, qosTable=qosTable, groupIndex=groupIndex, portmode=portmode, adminStatus=adminStatus, fileName=fileName, lan2=lan2, secondaryDns=secondaryDns, jumblan4=jumblan4, qmode=qmode, fcsErrorReceived=fcsErrorReceived, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, multicastsReceived=multicastsReceived, lan1=lan1, lanportName=lanportName, vendorOui=vendorOui, statIndex=statIndex, rxPower=rxPower, serialnum=serialnum, jumblan3=jumblan3, tftpSevIp=tftpSevIp, portTable=portTable, xg6846=xg6846, hostname=hostname, catvEnable=catvEnable, lanportspeed=lanportspeed, priority=priority, catv=catv, txPower=txPower, jumblan1=jumblan1, broadcastsReceived=broadcastsReceived, portStatistic=portStatistic, qmapping=qmapping, deviceinfo=deviceinfo, vendorName=vendorName, vlanid=vlanid, action=action, jumblan2=jumblan2)
