...
NotificationType, ModuleIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Unsigned32, Integer32, Bits, IpAddress, snmpModules, TimeTicks, iso, MibIdentifier, Counter32, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Unsigned32", "Integer32", "Bits", "IpAddress", "snmpModules", "TimeTicks", "iso", "MibIdentifier", "Counter32", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portEntry=portEntry, jumblan2=jumblan2, portTable=portTable, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, multicastsTransmitted=multicastsTransmitted, statisticTable=statisticTable, portStatistic=portStatistic, jumblan4=jumblan4, catv=catv, jumb=jumb, lan4=lan4, adminStatus=adminStatus, portmode=portmode, secondaryDns=secondaryDns, speed=speed, qmapping=qmapping, operStatus=operStatus, jumblan1=jumblan1, portName=portName, catvEnable=catvEnable, primaryDns=primaryDns, qosTable=qosTable, xg6846=xg6846, priority=priority, internetPort=internetPort, port3=port3, action=action, vendorRev=vendorRev, hostname=hostname, dscpEnable=dscpEnable, statIndex=statIndex, rxPower=rxPower, broadcastsTransmitted=broadcastsTransmitted, port4=port4, vlangroupTable=vlangroupTable, lan3=lan3, vlanid=vlanid, lanportIndex=lanportIndex, qosIndex=qosIndex, ddminfo=ddminfo, voltage=voltage, tftp=tftp, staticDns=staticDns, jumblan3=jumblan3, lanportName=lanportName, lanportspeed=lanportspeed, qmode=qmode, domainame=domainame, port2=port2, temperature=temperature, vlan=vlan, port1=port1, staticIpAddr=staticIpAddr, staticIpHostName=staticIpHostName, vendorOui=vendorOui, serialnum=serialnum, qosEntry=qosEntry, txPower=txPower, staticIpSecondaryDns=staticIpSecondaryDns, wanType=wanType, vendorPn=vendorPn, deviceinfo=deviceinfo, pauseTransmitted=pauseTransmitted, modeEntry=modeEntry, unicastsTransmitted=unicastsTransmitted, multicastsReceived=multicastsReceived, portStatEntry=portStatEntry, fcsErrorTransmitted=fcsErrorTransmitted, jumbwan=jumbwan, lanportTable=lanportTable, fileType=fileType, groupIndex=groupIndex, fileName=fileName, staticIpDomainName=staticIpDomainName, lan2=lan2, portIndex=portIndex, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, groupid=groupid, staticIpGateway=staticIpGateway, vendorName=vendorName, rebootEnable=rebootEnable, broadcastsReceived=broadcastsReceived, portPower=portPower, lan1=lan1, staticIpSubMask=staticIpSubMask, groupEntry=groupEntry, qos=qos, unicastsReceived=unicastsReceived, wan=wan, reboot=reboot, pauseReceived=pauseReceived, lanportpause=lanportpause)
