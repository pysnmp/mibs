...
# Produced by pysmi-1.1.8 at Mon Jan 17 22:09:58 2022
...
ModuleIdentity, enterprises, Unsigned32, TimeTicks, snmpModules, Bits, ObjectIdentity, Integer32, mib_2, iso, Counter64, MibIdentifier, Gauge32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Unsigned32", "TimeTicks", "snmpModules", "Bits", "ObjectIdentity", "Integer32", "mib-2", "iso", "Counter64", "MibIdentifier", "Gauge32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSubMask=staticIpSubMask, secondaryDns=secondaryDns, tftp=tftp, pauseReceived=pauseReceived, modeEntry=modeEntry, rebootEnable=rebootEnable, internetPort=internetPort, wanType=wanType, broadcastsReceived=broadcastsReceived, txPower=txPower, portStatistic=portStatistic, portmode=portmode, tftpSevIp=tftpSevIp, lanportIndex=lanportIndex, portPower=portPower, catv=catv, fileType=fileType, vlan=vlan, qos=qos, groupEntry=groupEntry, rxPower=rxPower, dscpEnable=dscpEnable, portIndex=portIndex, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, multicastsTransmitted=multicastsTransmitted, portName=portName, portStatEntry=portStatEntry, jumbwan=jumbwan, fcsErrorReceived=fcsErrorReceived, qosIndex=qosIndex, primaryDns=primaryDns, fileName=fileName, lanportspeed=lanportspeed, qmapping=qmapping, domainame=domainame, ddminfo=ddminfo, statIndex=statIndex, staticIpAddr=staticIpAddr, vlangroupTable=vlangroupTable, jumblan3=jumblan3, port2=port2, vendorPn=vendorPn, jumblan1=jumblan1, staticIpSecondaryDns=staticIpSecondaryDns, speed=speed, pauseTransmitted=pauseTransmitted, multicastsReceived=multicastsReceived, groupid=groupid, lan2=lan2, port4=port4, vendorName=vendorName, bias=bias, qosEntry=qosEntry, operStatus=operStatus, temperature=temperature, jumblan4=jumblan4, wan=wan, hostname=hostname, staticIpGateway=staticIpGateway, jumblan2=jumblan2, lanportpause=lanportpause, voltage=voltage, serialnum=serialnum, staticIpDomainName=staticIpDomainName, vendorOui=vendorOui, reboot=reboot, lan4=lan4, xg6846=xg6846, broadcastsTransmitted=broadcastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, vlanid=vlanid, jumb=jumb, qmode=qmode, qosTable=qosTable, vendorRev=vendorRev, priority=priority, staticIpHostName=staticIpHostName, port3=port3, lanportTable=lanportTable, staticDns=staticDns, port1=port1, action=action, lanportName=lanportName, portEntry=portEntry, catvEnable=catvEnable, portTable=portTable, lan3=lan3, lan1=lan1, groupIndex=groupIndex, adminStatus=adminStatus, statisticTable=statisticTable)
