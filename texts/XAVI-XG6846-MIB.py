...
# Produced by pysmi-1.1.0 at Mon Nov 15 19:55:42 2021
...
enterprises, ModuleIdentity, Counter32, MibIdentifier, snmpModules, Bits, NotificationType, Counter64, Unsigned32, TimeTicks, Integer32, ObjectIdentity, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "Counter32", "MibIdentifier", "snmpModules", "Bits", "NotificationType", "Counter64", "Unsigned32", "TimeTicks", "Integer32", "ObjectIdentity", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseReceived=pauseReceived, catv=catv, jumblan2=jumblan2, qosTable=qosTable, portIndex=portIndex, staticIpPrimaryDns=staticIpPrimaryDns, fileName=fileName, portStatistic=portStatistic, reboot=reboot, jumblan4=jumblan4, secondaryDns=secondaryDns, port2=port2, qmapping=qmapping, qosEntry=qosEntry, portmode=portmode, catvEnable=catvEnable, rxPower=rxPower, groupid=groupid, speed=speed, groupIndex=groupIndex, lanportpause=lanportpause, port1=port1, staticDns=staticDns, lan4=lan4, staticIpGateway=staticIpGateway, port4=port4, portTable=portTable, adminStatus=adminStatus, lanportIndex=lanportIndex, qmode=qmode, vendorRev=vendorRev, vendorOui=vendorOui, bias=bias, lanportName=lanportName, fcsErrorTransmitted=fcsErrorTransmitted, internetPort=internetPort, jumblan1=jumblan1, domainame=domainame, statisticTable=statisticTable, broadcastsTransmitted=broadcastsTransmitted, pauseTransmitted=pauseTransmitted, staticIpHostName=staticIpHostName, primaryDns=primaryDns, deviceinfo=deviceinfo, tftpSevIp=tftpSevIp, serialnum=serialnum, lan2=lan2, statIndex=statIndex, temperature=temperature, portStatEntry=portStatEntry, broadcastsReceived=broadcastsReceived, hostname=hostname, qos=qos, fcsErrorReceived=fcsErrorReceived, ddminfo=ddminfo, port3=port3, staticIpSubMask=staticIpSubMask, multicastsTransmitted=multicastsTransmitted, vendorName=vendorName, portPower=portPower, portEntry=portEntry, wan=wan, staticIpAddr=staticIpAddr, action=action, unicastsReceived=unicastsReceived, voltage=voltage, txPower=txPower, tftp=tftp, unicastsTransmitted=unicastsTransmitted, jumbwan=jumbwan, vendorPn=vendorPn, operStatus=operStatus, modeEntry=modeEntry, xg6846=xg6846, lanportspeed=lanportspeed, vlanid=vlanid, staticIpSecondaryDns=staticIpSecondaryDns, qosIndex=qosIndex, lan1=lan1, groupEntry=groupEntry, multicastsReceived=multicastsReceived, lan3=lan3, wanType=wanType, dscpEnable=dscpEnable, staticIpDomainName=staticIpDomainName, priority=priority, jumb=jumb, vlangroupTable=vlangroupTable, rebootEnable=rebootEnable, jumblan3=jumblan3, portName=portName, vlan=vlan, fileType=fileType, lanportTable=lanportTable)
