...
Integer32, iso, TimeTicks, ModuleIdentity, ObjectIdentity, MibIdentifier, Counter64, enterprises, Bits, NotificationType, mib_2, Gauge32, IpAddress, snmpModules, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Counter64", "enterprises", "Bits", "NotificationType", "mib-2", "Gauge32", "IpAddress", "snmpModules", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qos=qos, qmode=qmode, fileType=fileType, rxPower=rxPower, hostname=hostname, staticIpDomainName=staticIpDomainName, secondaryDns=secondaryDns, adminStatus=adminStatus, catv=catv, operStatus=operStatus, jumblan4=jumblan4, bias=bias, staticIpGateway=staticIpGateway, portIndex=portIndex, port2=port2, tftp=tftp, voltage=voltage, vendorPn=vendorPn, lan3=lan3, reboot=reboot, vendorOui=vendorOui, staticIpSecondaryDns=staticIpSecondaryDns, catvEnable=catvEnable, groupIndex=groupIndex, unicastsTransmitted=unicastsTransmitted, portName=portName, dscpEnable=dscpEnable, ddminfo=ddminfo, qosEntry=qosEntry, qosIndex=qosIndex, lan1=lan1, lanportName=lanportName, port3=port3, portPower=portPower, temperature=temperature, domainame=domainame, broadcastsReceived=broadcastsReceived, xg6846=xg6846, tftpSevIp=tftpSevIp, statisticTable=statisticTable, wan=wan, staticDns=staticDns, deviceinfo=deviceinfo, unicastsReceived=unicastsReceived, multicastsReceived=multicastsReceived, wanType=wanType, groupid=groupid, vlangroupTable=vlangroupTable, lan2=lan2, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, staticIpSubMask=staticIpSubMask, portEntry=portEntry, qosTable=qosTable, fcsErrorTransmitted=fcsErrorTransmitted, portStatistic=portStatistic, fileName=fileName, jumblan3=jumblan3, portStatEntry=portStatEntry, jumblan1=jumblan1, port4=port4, lan4=lan4, staticIpAddr=staticIpAddr, lanportTable=lanportTable, statIndex=statIndex, jumb=jumb, portTable=portTable, rebootEnable=rebootEnable, internetPort=internetPort, lanportspeed=lanportspeed, portmode=portmode, staticIpHostName=staticIpHostName, pauseTransmitted=pauseTransmitted, lanportIndex=lanportIndex, fcsErrorReceived=fcsErrorReceived, vendorName=vendorName, lanportpause=lanportpause, jumbwan=jumbwan, multicastsTransmitted=multicastsTransmitted, speed=speed, jumblan2=jumblan2, txPower=txPower, modeEntry=modeEntry, qmapping=qmapping, port1=port1, serialnum=serialnum, primaryDns=primaryDns, action=action, vendorRev=vendorRev, groupEntry=groupEntry, staticIpPrimaryDns=staticIpPrimaryDns, vlan=vlan, priority=priority, pauseReceived=pauseReceived)
