...
Counter32, Integer32, enterprises, Bits, snmpModules, Gauge32, ObjectIdentity, MibIdentifier, Unsigned32, mib_2, NotificationType, TimeTicks, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "enterprises", "Bits", "snmpModules", "Gauge32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "mib-2", "NotificationType", "TimeTicks", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", dscpEnable=dscpEnable, jumblan1=jumblan1, fcsErrorTransmitted=fcsErrorTransmitted, portmode=portmode, deviceinfo=deviceinfo, portStatistic=portStatistic, staticIpSubMask=staticIpSubMask, lanportspeed=lanportspeed, lan2=lan2, priority=priority, lanportIndex=lanportIndex, voltage=voltage, groupIndex=groupIndex, vendorPn=vendorPn, lanportpause=lanportpause, lanportName=lanportName, lan4=lan4, jumblan4=jumblan4, jumblan3=jumblan3, qmode=qmode, bias=bias, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, lan3=lan3, port4=port4, modeEntry=modeEntry, fileName=fileName, vendorRev=vendorRev, hostname=hostname, portPower=portPower, groupid=groupid, jumbwan=jumbwan, lanportTable=lanportTable, xg6846=xg6846, wan=wan, portName=portName, fileType=fileType, qmapping=qmapping, tftp=tftp, ddminfo=ddminfo, reboot=reboot, rebootEnable=rebootEnable, fcsErrorReceived=fcsErrorReceived, vendorName=vendorName, qos=qos, action=action, multicastsTransmitted=multicastsTransmitted, qosEntry=qosEntry, staticIpAddr=staticIpAddr, operStatus=operStatus, qosIndex=qosIndex, jumblan2=jumblan2, vlan=vlan, pauseReceived=pauseReceived, staticIpGateway=staticIpGateway, secondaryDns=secondaryDns, staticIpDomainName=staticIpDomainName, statIndex=statIndex, catvEnable=catvEnable, vlangroupTable=vlangroupTable, staticDns=staticDns, portEntry=portEntry, pauseTransmitted=pauseTransmitted, multicastsReceived=multicastsReceived, primaryDns=primaryDns, port1=port1, catv=catv, qosTable=qosTable, adminStatus=adminStatus, vlanid=vlanid, rxPower=rxPower, vendorOui=vendorOui, domainame=domainame, speed=speed, staticIpSecondaryDns=staticIpSecondaryDns, unicastsTransmitted=unicastsTransmitted, tftpSevIp=tftpSevIp, temperature=temperature, port3=port3, statisticTable=statisticTable, serialnum=serialnum, staticIpPrimaryDns=staticIpPrimaryDns, wanType=wanType, groupEntry=groupEntry, broadcastsReceived=broadcastsReceived, portTable=portTable, txPower=txPower, port2=port2, lan1=lan1, staticIpHostName=staticIpHostName, internetPort=internetPort, portStatEntry=portStatEntry, jumb=jumb, unicastsReceived=unicastsReceived)
