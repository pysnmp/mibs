...
# Produced by pysmi-1.1.8 at Tue Aug  9 15:46:31 2022
...
TimeTicks, Counter64, NotificationType, ModuleIdentity, Integer32, iso, mib_2, MibIdentifier, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, enterprises, ObjectIdentity, snmpModules, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "NotificationType", "ModuleIdentity", "Integer32", "iso", "mib-2", "MibIdentifier", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "enterprises", "ObjectIdentity", "snmpModules", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseTransmitted=pauseTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, vlangroupTable=vlangroupTable, lan4=lan4, rebootEnable=rebootEnable, unicastsTransmitted=unicastsTransmitted, catvEnable=catvEnable, groupEntry=groupEntry, portStatEntry=portStatEntry, groupid=groupid, xg6846=xg6846, vlan=vlan, voltage=voltage, secondaryDns=secondaryDns, lan1=lan1, groupIndex=groupIndex, ddminfo=ddminfo, priority=priority, operStatus=operStatus, staticIpHostName=staticIpHostName, serialnum=serialnum, qmode=qmode, qmapping=qmapping, vendorName=vendorName, portmode=portmode, fileType=fileType, staticDns=staticDns, fileName=fileName, multicastsTransmitted=multicastsTransmitted, bias=bias, wanType=wanType, tftp=tftp, vendorOui=vendorOui, jumblan3=jumblan3, staticIpAddr=staticIpAddr, portName=portName, qosIndex=qosIndex, staticIpGateway=staticIpGateway, fcsErrorReceived=fcsErrorReceived, hostname=hostname, tftpSevIp=tftpSevIp, modeEntry=modeEntry, jumblan4=jumblan4, vlanid=vlanid, broadcastsReceived=broadcastsReceived, lanportIndex=lanportIndex, broadcastsTransmitted=broadcastsTransmitted, statisticTable=statisticTable, portIndex=portIndex, qosTable=qosTable, portStatistic=portStatistic, jumblan2=jumblan2, pauseReceived=pauseReceived, port3=port3, lanportName=lanportName, port4=port4, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, jumblan1=jumblan1, portPower=portPower, txPower=txPower, jumbwan=jumbwan, statIndex=statIndex, staticIpSubMask=staticIpSubMask, qos=qos, unicastsReceived=unicastsReceived, dscpEnable=dscpEnable, staticIpDomainName=staticIpDomainName, adminStatus=adminStatus, multicastsReceived=multicastsReceived, lan2=lan2, domainame=domainame, vendorRev=vendorRev, catv=catv, primaryDns=primaryDns, qosEntry=qosEntry, lanportspeed=lanportspeed, internetPort=internetPort, rxPower=rxPower, deviceinfo=deviceinfo, fcsErrorTransmitted=fcsErrorTransmitted, action=action, reboot=reboot, jumb=jumb, lanportpause=lanportpause, wan=wan, portTable=portTable, speed=speed, port1=port1, lan3=lan3, vendorPn=vendorPn, lanportTable=lanportTable, port2=port2, portEntry=portEntry)
