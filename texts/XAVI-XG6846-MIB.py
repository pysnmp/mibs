...
IpAddress, Counter32, Counter64, snmpModules, Gauge32, ObjectIdentity, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, enterprises, mib_2, Integer32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Counter64", "snmpModules", "Gauge32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "enterprises", "mib-2", "Integer32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", deviceinfo=deviceinfo, reboot=reboot, port4=port4, voltage=voltage, portmode=portmode, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, lanportIndex=lanportIndex, lan2=lan2, qos=qos, port1=port1, tftp=tftp, serialnum=serialnum, portPower=portPower, xg6846=xg6846, dscpEnable=dscpEnable, qosEntry=qosEntry, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, ddminfo=ddminfo, staticIpHostName=staticIpHostName, unicastsReceived=unicastsReceived, pauseReceived=pauseReceived, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, catvEnable=catvEnable, speed=speed, lanportpause=lanportpause, hostname=hostname, jumbwan=jumbwan, jumblan1=jumblan1, portTable=portTable, lanportspeed=lanportspeed, broadcastsReceived=broadcastsReceived, bias=bias, lan1=lan1, broadcastsTransmitted=broadcastsTransmitted, portName=portName, tftpSevIp=tftpSevIp, qosTable=qosTable, statIndex=statIndex, lanportName=lanportName, lan3=lan3, priority=priority, rebootEnable=rebootEnable, staticDns=staticDns, rxPower=rxPower, staticIpSubMask=staticIpSubMask, modeEntry=modeEntry, vlanid=vlanid, lan4=lan4, fileName=fileName, jumblan2=jumblan2, primaryDns=primaryDns, lanportTable=lanportTable, wanType=wanType, groupEntry=groupEntry, statisticTable=statisticTable, staticIpSecondaryDns=staticIpSecondaryDns, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, portStatistic=portStatistic, txPower=txPower, catv=catv, vendorPn=vendorPn, port2=port2, qmode=qmode, multicastsTransmitted=multicastsTransmitted, secondaryDns=secondaryDns, jumblan3=jumblan3, staticIpDomainName=staticIpDomainName, temperature=temperature, vlan=vlan, portEntry=portEntry, adminStatus=adminStatus, vendorName=vendorName, multicastsReceived=multicastsReceived, vendorOui=vendorOui, operStatus=operStatus, groupIndex=groupIndex, fileType=fileType, internetPort=internetPort, action=action, port3=port3, qosIndex=qosIndex, portStatEntry=portStatEntry, jumb=jumb, fcsErrorTransmitted=fcsErrorTransmitted, qmapping=qmapping, wan=wan, portIndex=portIndex, groupid=groupid, domainame=domainame, pauseTransmitted=pauseTransmitted)
