...
snmpModules, ObjectIdentity, mib_2, Unsigned32, MibIdentifier, iso, NotificationType, Counter64, IpAddress, ModuleIdentity, enterprises, Gauge32, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "ObjectIdentity", "mib-2", "Unsigned32", "MibIdentifier", "iso", "NotificationType", "Counter64", "IpAddress", "ModuleIdentity", "enterprises", "Gauge32", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumbwan=jumbwan, deviceinfo=deviceinfo, lan2=lan2, qmode=qmode, jumblan3=jumblan3, staticIpAddr=staticIpAddr, jumb=jumb, internetPort=internetPort, rebootEnable=rebootEnable, port3=port3, hostname=hostname, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, vendorName=vendorName, portmode=portmode, adminStatus=adminStatus, jumblan4=jumblan4, staticIpGateway=staticIpGateway, multicastsTransmitted=multicastsTransmitted, portName=portName, catvEnable=catvEnable, speed=speed, lanportpause=lanportpause, multicastsReceived=multicastsReceived, portStatEntry=portStatEntry, qos=qos, staticDns=staticDns, portTable=portTable, lan3=lan3, qosIndex=qosIndex, broadcastsReceived=broadcastsReceived, lanportIndex=lanportIndex, vendorPn=vendorPn, domainame=domainame, staticIpHostName=staticIpHostName, staticIpSecondaryDns=staticIpSecondaryDns, portIndex=portIndex, dscpEnable=dscpEnable, tftp=tftp, port4=port4, temperature=temperature, portEntry=portEntry, pauseTransmitted=pauseTransmitted, unicastsReceived=unicastsReceived, fileType=fileType, xg6846=xg6846, vendorRev=vendorRev, qmapping=qmapping, jumblan2=jumblan2, modeEntry=modeEntry, groupid=groupid, lanportTable=lanportTable, ddminfo=ddminfo, lan1=lan1, statIndex=statIndex, primaryDns=primaryDns, wanType=wanType, voltage=voltage, vendorOui=vendorOui, vlan=vlan, catv=catv, reboot=reboot, rxPower=rxPower, txPower=txPower, groupIndex=groupIndex, bias=bias, statisticTable=statisticTable, vlangroupTable=vlangroupTable, wan=wan, staticIpDomainName=staticIpDomainName, port2=port2, broadcastsTransmitted=broadcastsTransmitted, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, staticIpPrimaryDns=staticIpPrimaryDns, qosEntry=qosEntry, serialnum=serialnum, portPower=portPower, lanportspeed=lanportspeed, qosTable=qosTable, action=action, priority=priority, fcsErrorTransmitted=fcsErrorTransmitted, operStatus=operStatus, pauseReceived=pauseReceived, port1=port1, tftpSevIp=tftpSevIp, lan4=lan4, jumblan1=jumblan1, fileName=fileName, vlanid=vlanid, lanportName=lanportName, groupEntry=groupEntry, unicastsTransmitted=unicastsTransmitted)
