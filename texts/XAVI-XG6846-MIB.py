...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:16:09 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Gauge32, Integer32, TimeTicks, MibIdentifier, ObjectIdentity, Counter32, NotificationType, Unsigned32, enterprises, iso, Bits, mib_2, snmpModules, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Gauge32", "Integer32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Counter32", "NotificationType", "Unsigned32", "enterprises", "iso", "Bits", "mib-2", "snmpModules", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorRev=vendorRev, staticIpDomainName=staticIpDomainName, qmapping=qmapping, bias=bias, catvEnable=catvEnable, portStatEntry=portStatEntry, jumblan4=jumblan4, operStatus=operStatus, jumb=jumb, deviceinfo=deviceinfo, catv=catv, domainame=domainame, staticIpAddr=staticIpAddr, lanportpause=lanportpause, speed=speed, multicastsTransmitted=multicastsTransmitted, action=action, tftpSevIp=tftpSevIp, jumblan2=jumblan2, lanportName=lanportName, fcsErrorTransmitted=fcsErrorTransmitted, ddminfo=ddminfo, temperature=temperature, rxPower=rxPower, primaryDns=primaryDns, vendorOui=vendorOui, secondaryDns=secondaryDns, fileType=fileType, portTable=portTable, lan2=lan2, portStatistic=portStatistic, qosTable=qosTable, broadcastsTransmitted=broadcastsTransmitted, rebootEnable=rebootEnable, dscpEnable=dscpEnable, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, vlan=vlan, qmode=qmode, wan=wan, broadcastsReceived=broadcastsReceived, lanportIndex=lanportIndex, lanportspeed=lanportspeed, xg6846=xg6846, fcsErrorReceived=fcsErrorReceived, lan1=lan1, vlangroupTable=vlangroupTable, portIndex=portIndex, qos=qos, pauseReceived=pauseReceived, modeEntry=modeEntry, staticIpPrimaryDns=staticIpPrimaryDns, jumbwan=jumbwan, lanportTable=lanportTable, portmode=portmode, vendorPn=vendorPn, groupid=groupid, hostname=hostname, jumblan3=jumblan3, unicastsReceived=unicastsReceived, statisticTable=statisticTable, txPower=txPower, staticIpSecondaryDns=staticIpSecondaryDns, tftp=tftp, lan3=lan3, portEntry=portEntry, staticIpHostName=staticIpHostName, serialnum=serialnum, port4=port4, staticDns=staticDns, qosIndex=qosIndex, groupEntry=groupEntry, fileName=fileName, port2=port2, internetPort=internetPort, port1=port1, lan4=lan4, vendorName=vendorName, port3=port3, wanType=wanType, voltage=voltage, pauseTransmitted=pauseTransmitted, vlanid=vlanid, multicastsReceived=multicastsReceived, groupIndex=groupIndex, portPower=portPower, portName=portName, reboot=reboot, priority=priority, staticIpSubMask=staticIpSubMask, qosEntry=qosEntry, adminStatus=adminStatus, statIndex=statIndex, jumblan1=jumblan1)
