...
# Produced by pysmi-1.1.8 at Wed Oct 11 09:30:08 2023
...
enterprises, Integer32, Gauge32, NotificationType, Counter32, TimeTicks, Bits, Unsigned32, MibIdentifier, snmpModules, IpAddress, mib_2, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "Gauge32", "NotificationType", "Counter32", "TimeTicks", "Bits", "Unsigned32", "MibIdentifier", "snmpModules", "IpAddress", "mib-2", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", dscpEnable=dscpEnable, lanportspeed=lanportspeed, bias=bias, vendorRev=vendorRev, pauseTransmitted=pauseTransmitted, voltage=voltage, adminStatus=adminStatus, qosTable=qosTable, lanportName=lanportName, domainame=domainame, catvEnable=catvEnable, staticDns=staticDns, staticIpAddr=staticIpAddr, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, staticIpDomainName=staticIpDomainName, vlanid=vlanid, rxPower=rxPower, lan3=lan3, port1=port1, jumblan3=jumblan3, qos=qos, groupEntry=groupEntry, portEntry=portEntry, vendorOui=vendorOui, priority=priority, portIndex=portIndex, unicastsTransmitted=unicastsTransmitted, action=action, reboot=reboot, internetPort=internetPort, broadcastsReceived=broadcastsReceived, txPower=txPower, qosIndex=qosIndex, jumblan2=jumblan2, qmode=qmode, pauseReceived=pauseReceived, primaryDns=primaryDns, serialnum=serialnum, jumblan4=jumblan4, rebootEnable=rebootEnable, lanportpause=lanportpause, tftpSevIp=tftpSevIp, statisticTable=statisticTable, ddminfo=ddminfo, lanportIndex=lanportIndex, operStatus=operStatus, speed=speed, portmode=portmode, multicastsReceived=multicastsReceived, groupIndex=groupIndex, portPower=portPower, hostname=hostname, tftp=tftp, staticIpSecondaryDns=staticIpSecondaryDns, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, lanportTable=lanportTable, wan=wan, port3=port3, jumb=jumb, staticIpGateway=staticIpGateway, fcsErrorTransmitted=fcsErrorTransmitted, vlan=vlan, vendorPn=vendorPn, catv=catv, portName=portName, fileType=fileType, temperature=temperature, statIndex=statIndex, portStatistic=portStatistic, port2=port2, jumbwan=jumbwan, qosEntry=qosEntry, fcsErrorReceived=fcsErrorReceived, port4=port4, xg6846=xg6846, staticIpSubMask=staticIpSubMask, fileName=fileName, lan4=lan4, jumblan1=jumblan1, lan2=lan2, deviceinfo=deviceinfo, portStatEntry=portStatEntry, vendorName=vendorName, secondaryDns=secondaryDns, groupid=groupid, lan1=lan1, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, wanType=wanType, portTable=portTable, staticIpPrimaryDns=staticIpPrimaryDns, modeEntry=modeEntry)
