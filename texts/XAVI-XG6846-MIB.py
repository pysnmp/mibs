...
# Produced by pysmi-1.1.10 at Fri Nov 10 08:46:00 2023
...
TimeTicks, iso, Integer32, Unsigned32, MibIdentifier, Gauge32, enterprises, ObjectIdentity, snmpModules, IpAddress, ModuleIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Integer32", "Unsigned32", "MibIdentifier", "Gauge32", "enterprises", "ObjectIdentity", "snmpModules", "IpAddress", "ModuleIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "Bits", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan1=jumblan1, lan4=lan4, vendorName=vendorName, jumbwan=jumbwan, vendorOui=vendorOui, rebootEnable=rebootEnable, ddminfo=ddminfo, multicastsReceived=multicastsReceived, portTable=portTable, jumblan3=jumblan3, portName=portName, staticIpSecondaryDns=staticIpSecondaryDns, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, hostname=hostname, lanportName=lanportName, port2=port2, statisticTable=statisticTable, pauseTransmitted=pauseTransmitted, txPower=txPower, portStatistic=portStatistic, vlanid=vlanid, serialnum=serialnum, qosTable=qosTable, portIndex=portIndex, adminStatus=adminStatus, action=action, rxPower=rxPower, fileType=fileType, catvEnable=catvEnable, vlangroupTable=vlangroupTable, port3=port3, speed=speed, staticIpDomainName=staticIpDomainName, fcsErrorTransmitted=fcsErrorTransmitted, wan=wan, groupid=groupid, catv=catv, lanportTable=lanportTable, qosEntry=qosEntry, portmode=portmode, qmapping=qmapping, staticIpAddr=staticIpAddr, staticIpGateway=staticIpGateway, lan1=lan1, lan3=lan3, staticIpHostName=staticIpHostName, tftpSevIp=tftpSevIp, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, dscpEnable=dscpEnable, fileName=fileName, temperature=temperature, staticDns=staticDns, groupIndex=groupIndex, portStatEntry=portStatEntry, bias=bias, secondaryDns=secondaryDns, wanType=wanType, deviceinfo=deviceinfo, voltage=voltage, primaryDns=primaryDns, vendorPn=vendorPn, jumblan4=jumblan4, internetPort=internetPort, priority=priority, lan2=lan2, vlan=vlan, xg6846=xg6846, jumblan2=jumblan2, portEntry=portEntry, qosIndex=qosIndex, lanportspeed=lanportspeed, groupEntry=groupEntry, reboot=reboot, unicastsReceived=unicastsReceived, vendorRev=vendorRev, port1=port1, qos=qos, broadcastsReceived=broadcastsReceived, fcsErrorReceived=fcsErrorReceived, lanportIndex=lanportIndex, broadcastsTransmitted=broadcastsTransmitted, lanportpause=lanportpause, jumb=jumb, port4=port4, pauseReceived=pauseReceived, staticIpSubMask=staticIpSubMask, portPower=portPower, tftp=tftp, qmode=qmode, operStatus=operStatus, modeEntry=modeEntry, domainame=domainame)
