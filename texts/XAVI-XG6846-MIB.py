...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:04:19 2021
...
mib_2, enterprises, ObjectIdentity, MibIdentifier, Bits, Gauge32, NotificationType, TimeTicks, Counter64, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, snmpModules, iso, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "enterprises", "ObjectIdentity", "MibIdentifier", "Bits", "Gauge32", "NotificationType", "TimeTicks", "Counter64", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "snmpModules", "iso", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statisticTable=statisticTable, action=action, multicastsReceived=multicastsReceived, port1=port1, groupEntry=groupEntry, jumbwan=jumbwan, portStatistic=portStatistic, adminStatus=adminStatus, jumblan3=jumblan3, lanportpause=lanportpause, rebootEnable=rebootEnable, txPower=txPower, qosEntry=qosEntry, pauseReceived=pauseReceived, serialnum=serialnum, deviceinfo=deviceinfo, vendorOui=vendorOui, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, pauseTransmitted=pauseTransmitted, fileType=fileType, fcsErrorReceived=fcsErrorReceived, vendorName=vendorName, lanportspeed=lanportspeed, qos=qos, portPower=portPower, voltage=voltage, wan=wan, unicastsTransmitted=unicastsTransmitted, catvEnable=catvEnable, qmode=qmode, portEntry=portEntry, groupIndex=groupIndex, qosTable=qosTable, staticIpAddr=staticIpAddr, port2=port2, catv=catv, internetPort=internetPort, vlanid=vlanid, speed=speed, ddminfo=ddminfo, staticIpPrimaryDns=staticIpPrimaryDns, domainame=domainame, vlangroupTable=vlangroupTable, groupid=groupid, xg6846=xg6846, staticIpHostName=staticIpHostName, portName=portName, modeEntry=modeEntry, bias=bias, vendorRev=vendorRev, tftpSevIp=tftpSevIp, portTable=portTable, hostname=hostname, port3=port3, portIndex=portIndex, operStatus=operStatus, portStatEntry=portStatEntry, jumb=jumb, staticIpGateway=staticIpGateway, portmode=portmode, dscpEnable=dscpEnable, wanType=wanType, temperature=temperature, staticIpSubMask=staticIpSubMask, lan4=lan4, vendorPn=vendorPn, rxPower=rxPower, qosIndex=qosIndex, broadcastsTransmitted=broadcastsTransmitted, broadcastsReceived=broadcastsReceived, jumblan2=jumblan2, lan3=lan3, lanportIndex=lanportIndex, lanportName=lanportName, jumblan1=jumblan1, vlan=vlan, qmapping=qmapping, priority=priority, lan2=lan2, statIndex=statIndex, fcsErrorTransmitted=fcsErrorTransmitted, jumblan4=jumblan4, multicastsTransmitted=multicastsTransmitted, tftp=tftp, staticDns=staticDns, port4=port4, fileName=fileName, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, reboot=reboot, primaryDns=primaryDns, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived)
