...
iso, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Integer32, IpAddress, Counter64, Gauge32, MibIdentifier, enterprises, ObjectIdentity, snmpModules, TimeTicks, Unsigned32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Integer32", "IpAddress", "Counter64", "Gauge32", "MibIdentifier", "enterprises", "ObjectIdentity", "snmpModules", "TimeTicks", "Unsigned32", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, secondaryDns=secondaryDns, action=action, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, lan1=lan1, lanportpause=lanportpause, staticIpSecondaryDns=staticIpSecondaryDns, serialnum=serialnum, domainame=domainame, staticIpPrimaryDns=staticIpPrimaryDns, lan4=lan4, priority=priority, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, multicastsTransmitted=multicastsTransmitted, portName=portName, fcsErrorTransmitted=fcsErrorTransmitted, staticIpGateway=staticIpGateway, jumbwan=jumbwan, portTable=portTable, primaryDns=primaryDns, speed=speed, vendorPn=vendorPn, port2=port2, statisticTable=statisticTable, vendorName=vendorName, groupIndex=groupIndex, temperature=temperature, portPower=portPower, unicastsReceived=unicastsReceived, port1=port1, qmapping=qmapping, vlanid=vlanid, jumb=jumb, internetPort=internetPort, vendorOui=vendorOui, staticIpDomainName=staticIpDomainName, jumblan2=jumblan2, vlangroupTable=vlangroupTable, port4=port4, jumblan1=jumblan1, rxPower=rxPower, qmode=qmode, vlan=vlan, lan3=lan3, groupEntry=groupEntry, xg6846=xg6846, tftp=tftp, qosEntry=qosEntry, portEntry=portEntry, jumblan3=jumblan3, portmode=portmode, catv=catv, multicastsReceived=multicastsReceived, wan=wan, broadcastsReceived=broadcastsReceived, lanportName=lanportName, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, deviceinfo=deviceinfo, hostname=hostname, dscpEnable=dscpEnable, lanportTable=lanportTable, portStatEntry=portStatEntry, reboot=reboot, port3=port3, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, portStatistic=portStatistic, fcsErrorReceived=fcsErrorReceived, wanType=wanType, lanportIndex=lanportIndex, lanportspeed=lanportspeed, adminStatus=adminStatus, catvEnable=catvEnable, qosTable=qosTable, qos=qos, jumblan4=jumblan4, pauseReceived=pauseReceived, groupid=groupid, staticIpHostName=staticIpHostName, txPower=txPower, lan2=lan2, portIndex=portIndex, tftpSevIp=tftpSevIp, ddminfo=ddminfo, staticDns=staticDns, voltage=voltage, pauseTransmitted=pauseTransmitted, operStatus=operStatus, fileName=fileName, bias=bias, fileType=fileType)
