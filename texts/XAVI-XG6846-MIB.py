...
IpAddress, Counter32, Bits, Unsigned32, ObjectIdentity, Integer32, mib_2, iso, Gauge32, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, ModuleIdentity, snmpModules, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter32", "Bits", "Unsigned32", "ObjectIdentity", "Integer32", "mib-2", "iso", "Gauge32", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "ModuleIdentity", "snmpModules", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", ddminfo=ddminfo, qos=qos, dscpEnable=dscpEnable, multicastsReceived=multicastsReceived, serialnum=serialnum, lanportpause=lanportpause, vlan=vlan, staticIpGateway=staticIpGateway, port2=port2, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, deviceinfo=deviceinfo, groupEntry=groupEntry, jumblan2=jumblan2, reboot=reboot, rebootEnable=rebootEnable, wanType=wanType, bias=bias, txPower=txPower, qosTable=qosTable, jumblan4=jumblan4, lanportIndex=lanportIndex, jumblan3=jumblan3, vlangroupTable=vlangroupTable, hostname=hostname, operStatus=operStatus, primaryDns=primaryDns, jumb=jumb, lanportTable=lanportTable, statIndex=statIndex, portIndex=portIndex, domainame=domainame, qmapping=qmapping, tftp=tftp, port3=port3, lan2=lan2, lan1=lan1, catvEnable=catvEnable, portEntry=portEntry, speed=speed, tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask, qosEntry=qosEntry, portName=portName, vendorName=vendorName, portStatistic=portStatistic, priority=priority, staticIpPrimaryDns=staticIpPrimaryDns, portTable=portTable, broadcastsTransmitted=broadcastsTransmitted, groupIndex=groupIndex, fileName=fileName, vendorRev=vendorRev, adminStatus=adminStatus, modeEntry=modeEntry, staticIpAddr=staticIpAddr, statisticTable=statisticTable, internetPort=internetPort, secondaryDns=secondaryDns, qmode=qmode, lanportName=lanportName, jumbwan=jumbwan, portPower=portPower, pauseReceived=pauseReceived, staticIpHostName=staticIpHostName, port4=port4, groupid=groupid, staticDns=staticDns, qosIndex=qosIndex, portmode=portmode, wan=wan, port1=port1, portStatEntry=portStatEntry, rxPower=rxPower, jumblan1=jumblan1, fcsErrorTransmitted=fcsErrorTransmitted, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, action=action, voltage=voltage, unicastsTransmitted=unicastsTransmitted, vendorPn=vendorPn, vlanid=vlanid, broadcastsReceived=broadcastsReceived, temperature=temperature, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, unicastsReceived=unicastsReceived, lanportspeed=lanportspeed, lan4=lan4, catv=catv, vendorOui=vendorOui, pauseTransmitted=pauseTransmitted, fileType=fileType)
