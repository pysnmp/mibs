...
Integer32, ObjectIdentity, enterprises, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, TimeTicks, mib_2, Counter64, Gauge32, MibIdentifier, Unsigned32, snmpModules, Counter32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "enterprises", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "TimeTicks", "mib-2", "Counter64", "Gauge32", "MibIdentifier", "Unsigned32", "snmpModules", "Counter32", "iso", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan2=lan2, qosIndex=qosIndex, txPower=txPower, staticDns=staticDns, groupIndex=groupIndex, jumblan1=jumblan1, multicastsReceived=multicastsReceived, primaryDns=primaryDns, speed=speed, pauseReceived=pauseReceived, staticIpHostName=staticIpHostName, port4=port4, portmode=portmode, multicastsTransmitted=multicastsTransmitted, temperature=temperature, dscpEnable=dscpEnable, qosEntry=qosEntry, staticIpSubMask=staticIpSubMask, ddminfo=ddminfo, priority=priority, broadcastsReceived=broadcastsReceived, jumblan2=jumblan2, tftpSevIp=tftpSevIp, tftp=tftp, jumblan3=jumblan3, statisticTable=statisticTable, vlanid=vlanid, vendorPn=vendorPn, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, portStatistic=portStatistic, staticIpDomainName=staticIpDomainName, portName=portName, secondaryDns=secondaryDns, qosTable=qosTable, modeEntry=modeEntry, fileType=fileType, staticIpAddr=staticIpAddr, wan=wan, xg6846=xg6846, pauseTransmitted=pauseTransmitted, bias=bias, lanportspeed=lanportspeed, port3=port3, deviceinfo=deviceinfo, fileName=fileName, staticIpGateway=staticIpGateway, qmode=qmode, reboot=reboot, portEntry=portEntry, groupid=groupid, lan3=lan3, rxPower=rxPower, portStatEntry=portStatEntry, unicastsTransmitted=unicastsTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, internetPort=internetPort, jumbwan=jumbwan, hostname=hostname, vlan=vlan, qmapping=qmapping, jumb=jumb, portPower=portPower, statIndex=statIndex, domainame=domainame, port2=port2, staticIpSecondaryDns=staticIpSecondaryDns, operStatus=operStatus, lanportTable=lanportTable, vendorName=vendorName, voltage=voltage, catv=catv, unicastsReceived=unicastsReceived, lan1=lan1, qos=qos, staticIpPrimaryDns=staticIpPrimaryDns, portTable=portTable, serialnum=serialnum, lanportName=lanportName, vlangroupTable=vlangroupTable, port1=port1, action=action, jumblan4=jumblan4, wanType=wanType, catvEnable=catvEnable, lanportpause=lanportpause, adminStatus=adminStatus, vendorRev=vendorRev, groupEntry=groupEntry, lan4=lan4, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, lanportIndex=lanportIndex)
