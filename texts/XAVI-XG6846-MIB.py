...
# Produced by pysmi-1.1.12 at Mon Jun  3 03:05:55 2024
...
IpAddress, iso, ObjectIdentity, ModuleIdentity, TimeTicks, mib_2, NotificationType, enterprises, Gauge32, Counter64, MibIdentifier, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, snmpModules, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "mib-2", "NotificationType", "enterprises", "Gauge32", "Counter64", "MibIdentifier", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "snmpModules", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmapping=qmapping, lan3=lan3, portPower=portPower, lan1=lan1, portStatEntry=portStatEntry, groupEntry=groupEntry, broadcastsReceived=broadcastsReceived, port2=port2, staticIpSubMask=staticIpSubMask, unicastsReceived=unicastsReceived, portEntry=portEntry, vendorName=vendorName, speed=speed, lanportTable=lanportTable, qosIndex=qosIndex, lanportspeed=lanportspeed, temperature=temperature, staticDns=staticDns, qosTable=qosTable, modeEntry=modeEntry, portStatistic=portStatistic, jumblan4=jumblan4, operStatus=operStatus, statisticTable=statisticTable, reboot=reboot, fileName=fileName, lan4=lan4, domainame=domainame, lanportName=lanportName, action=action, statIndex=statIndex, vlan=vlan, fileType=fileType, multicastsReceived=multicastsReceived, txPower=txPower, lan2=lan2, portName=portName, vlanid=vlanid, primaryDns=primaryDns, fcsErrorReceived=fcsErrorReceived, jumb=jumb, dscpEnable=dscpEnable, internetPort=internetPort, groupid=groupid, portIndex=portIndex, vendorPn=vendorPn, staticIpAddr=staticIpAddr, vendorOui=vendorOui, deviceinfo=deviceinfo, catvEnable=catvEnable, staticIpGateway=staticIpGateway, qmode=qmode, qosEntry=qosEntry, tftp=tftp, voltage=voltage, port4=port4, staticIpHostName=staticIpHostName, tftpSevIp=tftpSevIp, hostname=hostname, groupIndex=groupIndex, lanportpause=lanportpause, rebootEnable=rebootEnable, xg6846=xg6846, pauseReceived=pauseReceived, multicastsTransmitted=multicastsTransmitted, jumblan1=jumblan1, ddminfo=ddminfo, portmode=portmode, broadcastsTransmitted=broadcastsTransmitted, bias=bias, jumblan2=jumblan2, pauseTransmitted=pauseTransmitted, port1=port1, vlangroupTable=vlangroupTable, wanType=wanType, unicastsTransmitted=unicastsTransmitted, lanportIndex=lanportIndex, priority=priority, jumblan3=jumblan3, rxPower=rxPower, portTable=portTable, qos=qos, staticIpSecondaryDns=staticIpSecondaryDns, secondaryDns=secondaryDns, jumbwan=jumbwan, staticIpDomainName=staticIpDomainName, wan=wan, serialnum=serialnum, port3=port3, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus, vendorRev=vendorRev, staticIpPrimaryDns=staticIpPrimaryDns, catv=catv)
