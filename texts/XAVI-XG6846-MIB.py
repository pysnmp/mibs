...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:08:12 2023
...
Counter64, Gauge32, Integer32, MibIdentifier, Counter32, snmpModules, iso, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, TimeTicks, enterprises, NotificationType, mib_2, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "Integer32", "MibIdentifier", "Counter32", "snmpModules", "iso", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "TimeTicks", "enterprises", "NotificationType", "mib-2", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftp=tftp, lanportIndex=lanportIndex, portStatistic=portStatistic, qmapping=qmapping, deviceinfo=deviceinfo, temperature=temperature, speed=speed, vendorName=vendorName, jumblan4=jumblan4, vlanid=vlanid, port1=port1, priority=priority, pauseReceived=pauseReceived, lan3=lan3, jumbwan=jumbwan, fileName=fileName, staticDns=staticDns, staticIpHostName=staticIpHostName, multicastsTransmitted=multicastsTransmitted, lanportpause=lanportpause, secondaryDns=secondaryDns, jumblan1=jumblan1, jumblan3=jumblan3, ddminfo=ddminfo, vendorOui=vendorOui, qosTable=qosTable, tftpSevIp=tftpSevIp, statIndex=statIndex, rxPower=rxPower, lan4=lan4, vlangroupTable=vlangroupTable, portIndex=portIndex, xg6846=xg6846, portEntry=portEntry, modeEntry=modeEntry, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, portName=portName, port2=port2, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, qos=qos, qosEntry=qosEntry, port4=port4, portmode=portmode, port3=port3, statisticTable=statisticTable, staticIpAddr=staticIpAddr, vendorRev=vendorRev, voltage=voltage, wan=wan, catvEnable=catvEnable, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, bias=bias, wanType=wanType, txPower=txPower, serialnum=serialnum, internetPort=internetPort, lan2=lan2, groupid=groupid, portStatEntry=portStatEntry, lanportName=lanportName, qmode=qmode, fcsErrorReceived=fcsErrorReceived, domainame=domainame, staticIpPrimaryDns=staticIpPrimaryDns, rebootEnable=rebootEnable, qosIndex=qosIndex, jumblan2=jumblan2, portTable=portTable, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, vlan=vlan, pauseTransmitted=pauseTransmitted, hostname=hostname, vendorPn=vendorPn, fcsErrorTransmitted=fcsErrorTransmitted, dscpEnable=dscpEnable, action=action, fileType=fileType, jumb=jumb, portPower=portPower, reboot=reboot, multicastsReceived=multicastsReceived, adminStatus=adminStatus, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, operStatus=operStatus, broadcastsTransmitted=broadcastsTransmitted, groupEntry=groupEntry, staticIpDomainName=staticIpDomainName, groupIndex=groupIndex, catv=catv)
