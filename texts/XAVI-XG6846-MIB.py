...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portEntry=portEntry, fileType=fileType, fileName=fileName, rxPower=rxPower, qosTable=qosTable, vendorPn=vendorPn, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, temperature=temperature, internetPort=internetPort, vlan=vlan, catvEnable=catvEnable, statIndex=statIndex, vlangroupTable=vlangroupTable, ddminfo=ddminfo, vlanid=vlanid, portStatistic=portStatistic, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, groupid=groupid, xg6846=xg6846, jumbwan=jumbwan, qosIndex=qosIndex, wanType=wanType, multicastsReceived=multicastsReceived, primaryDns=primaryDns, tftpSevIp=tftpSevIp, qmapping=qmapping, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, portStatEntry=portStatEntry, lanportIndex=lanportIndex, operStatus=operStatus, action=action, portTable=portTable, multicastsTransmitted=multicastsTransmitted, voltage=voltage, staticIpSubMask=staticIpSubMask, port3=port3, qmode=qmode, vendorOui=vendorOui, jumb=jumb, priority=priority, lan1=lan1, lan2=lan2, statisticTable=statisticTable, jumblan3=jumblan3, jumblan4=jumblan4, lanportName=lanportName, fcsErrorTransmitted=fcsErrorTransmitted, tftp=tftp, portmode=portmode, port2=port2, portIndex=portIndex, lanportpause=lanportpause, lanportTable=lanportTable, port4=port4, staticIpHostName=staticIpHostName, unicastsTransmitted=unicastsTransmitted, wan=wan, catv=catv, portName=portName, qos=qos, adminStatus=adminStatus, vendorRev=vendorRev, jumblan1=jumblan1, groupEntry=groupEntry, fcsErrorReceived=fcsErrorReceived, portPower=portPower, groupIndex=groupIndex, serialnum=serialnum, port1=port1, txPower=txPower, pauseReceived=pauseReceived, domainame=domainame, staticIpDomainName=staticIpDomainName, speed=speed, staticDns=staticDns, staticIpGateway=staticIpGateway, lan3=lan3, jumblan2=jumblan2, staticIpPrimaryDns=staticIpPrimaryDns, bias=bias, reboot=reboot, deviceinfo=deviceinfo, vendorName=vendorName, broadcastsTransmitted=broadcastsTransmitted, rebootEnable=rebootEnable, lan4=lan4, lanportspeed=lanportspeed, staticIpAddr=staticIpAddr, secondaryDns=secondaryDns, hostname=hostname, qosEntry=qosEntry)
