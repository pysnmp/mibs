...
Counter32, IpAddress, enterprises, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, iso, Bits, Unsigned32, snmpModules, mib_2, MibIdentifier, NotificationType, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "enterprises", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "iso", "Bits", "Unsigned32", "snmpModules", "mib-2", "MibIdentifier", "NotificationType", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticDns=staticDns, portmode=portmode, broadcastsReceived=broadcastsReceived, domainame=domainame, catvEnable=catvEnable, lanportspeed=lanportspeed, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, qmode=qmode, port4=port4, groupid=groupid, pauseReceived=pauseReceived, ddminfo=ddminfo, portPower=portPower, tftpSevIp=tftpSevIp, qmapping=qmapping, speed=speed, portEntry=portEntry, rebootEnable=rebootEnable, portStatEntry=portStatEntry, jumb=jumb, lanportpause=lanportpause, vendorName=vendorName, vlanid=vlanid, operStatus=operStatus, staticIpAddr=staticIpAddr, deviceinfo=deviceinfo, vendorOui=vendorOui, portIndex=portIndex, multicastsReceived=multicastsReceived, groupEntry=groupEntry, txPower=txPower, jumblan1=jumblan1, action=action, voltage=voltage, tftp=tftp, staticIpHostName=staticIpHostName, statisticTable=statisticTable, portName=portName, lan4=lan4, qos=qos, jumbwan=jumbwan, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, port3=port3, temperature=temperature, lanportIndex=lanportIndex, vlan=vlan, lan1=lan1, portStatistic=portStatistic, port1=port1, lanportTable=lanportTable, fcsErrorTransmitted=fcsErrorTransmitted, qosIndex=qosIndex, jumblan2=jumblan2, broadcastsTransmitted=broadcastsTransmitted, qosTable=qosTable, groupIndex=groupIndex, port2=port2, vlangroupTable=vlangroupTable, catv=catv, internetPort=internetPort, hostname=hostname, unicastsReceived=unicastsReceived, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, staticIpGateway=staticIpGateway, serialnum=serialnum, pauseTransmitted=pauseTransmitted, bias=bias, wan=wan, secondaryDns=secondaryDns, fileName=fileName, wanType=wanType, primaryDns=primaryDns, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, vendorPn=vendorPn, rxPower=rxPower, modeEntry=modeEntry, qosEntry=qosEntry, jumblan3=jumblan3, reboot=reboot, portTable=portTable, lan2=lan2, jumblan4=jumblan4, adminStatus=adminStatus, statIndex=statIndex, priority=priority, fileType=fileType, lanportName=lanportName, vendorRev=vendorRev)
