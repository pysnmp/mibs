...
Gauge32, Counter32, Integer32, snmpModules, NotificationType, ObjectIdentity, Unsigned32, iso, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, mib_2, Bits, Counter64, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Integer32", "snmpModules", "NotificationType", "ObjectIdentity", "Unsigned32", "iso", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "mib-2", "Bits", "Counter64", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", speed=speed, wan=wan, fcsErrorReceived=fcsErrorReceived, portStatEntry=portStatEntry, jumbwan=jumbwan, pauseTransmitted=pauseTransmitted, fileType=fileType, lanportTable=lanportTable, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, domainame=domainame, qosIndex=qosIndex, hostname=hostname, lanportIndex=lanportIndex, portEntry=portEntry, wanType=wanType, portPower=portPower, unicastsTransmitted=unicastsTransmitted, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, qmapping=qmapping, internetPort=internetPort, lanportName=lanportName, jumblan1=jumblan1, jumblan4=jumblan4, groupid=groupid, statIndex=statIndex, staticIpHostName=staticIpHostName, multicastsReceived=multicastsReceived, staticIpDomainName=staticIpDomainName, port4=port4, xg6846=xg6846, txPower=txPower, ddminfo=ddminfo, lan4=lan4, vendorPn=vendorPn, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, modeEntry=modeEntry, dscpEnable=dscpEnable, port3=port3, primaryDns=primaryDns, staticIpPrimaryDns=staticIpPrimaryDns, lanportpause=lanportpause, temperature=temperature, qos=qos, groupIndex=groupIndex, voltage=voltage, rxPower=rxPower, reboot=reboot, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, lanportspeed=lanportspeed, staticIpAddr=staticIpAddr, jumblan2=jumblan2, lan2=lan2, lan3=lan3, portTable=portTable, portIndex=portIndex, priority=priority, statisticTable=statisticTable, port1=port1, catv=catv, jumb=jumb, jumblan3=jumblan3, groupEntry=groupEntry, staticIpGateway=staticIpGateway, catvEnable=catvEnable, secondaryDns=secondaryDns, qosTable=qosTable, action=action, deviceinfo=deviceinfo, adminStatus=adminStatus, rebootEnable=rebootEnable, vendorRev=vendorRev, qosEntry=qosEntry, multicastsTransmitted=multicastsTransmitted, portName=portName, unicastsReceived=unicastsReceived, qmode=qmode, vlangroupTable=vlangroupTable, lan1=lan1, serialnum=serialnum, vendorName=vendorName, fileName=fileName, port2=port2, operStatus=operStatus, tftp=tftp, vlanid=vlanid, vlan=vlan, fcsErrorTransmitted=fcsErrorTransmitted, bias=bias, staticDns=staticDns, portmode=portmode)
