...
# Produced by pysmi-1.1.8 at Sat Jan 15 04:47:08 2022
...
IpAddress, NotificationType, Integer32, MibIdentifier, ModuleIdentity, enterprises, Gauge32, Counter32, Bits, mib_2, TimeTicks, Counter64, Unsigned32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "Integer32", "MibIdentifier", "ModuleIdentity", "enterprises", "Gauge32", "Counter32", "Bits", "mib-2", "TimeTicks", "Counter64", "Unsigned32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumbwan=jumbwan, tftpSevIp=tftpSevIp, deviceinfo=deviceinfo, portmode=portmode, jumblan3=jumblan3, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, vendorRev=vendorRev, jumblan2=jumblan2, qosTable=qosTable, dscpEnable=dscpEnable, staticIpAddr=staticIpAddr, rxPower=rxPower, priority=priority, wan=wan, groupEntry=groupEntry, fcsErrorTransmitted=fcsErrorTransmitted, primaryDns=primaryDns, internetPort=internetPort, portEntry=portEntry, port3=port3, pauseReceived=pauseReceived, lanportIndex=lanportIndex, portIndex=portIndex, secondaryDns=secondaryDns, qmode=qmode, pauseTransmitted=pauseTransmitted, port4=port4, catvEnable=catvEnable, groupIndex=groupIndex, statIndex=statIndex, unicastsReceived=unicastsReceived, jumblan4=jumblan4, qosEntry=qosEntry, jumblan1=jumblan1, staticDns=staticDns, portStatEntry=portStatEntry, temperature=temperature, staticIpSubMask=staticIpSubMask, voltage=voltage, staticIpHostName=staticIpHostName, hostname=hostname, staticIpDomainName=staticIpDomainName, txPower=txPower, operStatus=operStatus, qmapping=qmapping, staticIpGateway=staticIpGateway, lanportpause=lanportpause, portStatistic=portStatistic, qos=qos, vendorOui=vendorOui, qosIndex=qosIndex, vlanid=vlanid, wanType=wanType, broadcastsTransmitted=broadcastsTransmitted, jumb=jumb, speed=speed, reboot=reboot, modeEntry=modeEntry, unicastsTransmitted=unicastsTransmitted, port1=port1, lan4=lan4, lanportspeed=lanportspeed, fileType=fileType, port2=port2, staticIpSecondaryDns=staticIpSecondaryDns, adminStatus=adminStatus, lan1=lan1, multicastsTransmitted=multicastsTransmitted, portPower=portPower, catv=catv, broadcastsReceived=broadcastsReceived, groupid=groupid, portName=portName, xg6846=xg6846, statisticTable=statisticTable, lanportTable=lanportTable, tftp=tftp, vendorName=vendorName, serialnum=serialnum, vendorPn=vendorPn, fileName=fileName, bias=bias, lan2=lan2, fcsErrorReceived=fcsErrorReceived, portTable=portTable, action=action, vlangroupTable=vlangroupTable, multicastsReceived=multicastsReceived, lan3=lan3, ddminfo=ddminfo, domainame=domainame, rebootEnable=rebootEnable, vlan=vlan)
