...
ModuleIdentity, TimeTicks, snmpModules, IpAddress, Gauge32, mib_2, Integer32, Bits, ObjectIdentity, MibIdentifier, Unsigned32, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "snmpModules", "IpAddress", "Gauge32", "mib-2", "Integer32", "Bits", "ObjectIdentity", "MibIdentifier", "Unsigned32", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileName=fileName, action=action, bias=bias, primaryDns=primaryDns, jumblan2=jumblan2, staticIpAddr=staticIpAddr, catvEnable=catvEnable, jumblan4=jumblan4, groupid=groupid, rebootEnable=rebootEnable, vendorOui=vendorOui, staticIpPrimaryDns=staticIpPrimaryDns, staticDns=staticDns, unicastsTransmitted=unicastsTransmitted, lanportTable=lanportTable, voltage=voltage, domainame=domainame, port3=port3, portName=portName, temperature=temperature, secondaryDns=secondaryDns, wan=wan, statisticTable=statisticTable, qosTable=qosTable, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, lanportIndex=lanportIndex, speed=speed, qosEntry=qosEntry, priority=priority, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, lanportpause=lanportpause, portEntry=portEntry, staticIpGateway=staticIpGateway, port2=port2, groupEntry=groupEntry, qmode=qmode, catv=catv, lan2=lan2, vendorName=vendorName, serialnum=serialnum, qos=qos, lan4=lan4, portTable=portTable, statIndex=statIndex, hostname=hostname, fileType=fileType, port1=port1, ddminfo=ddminfo, lanportName=lanportName, jumblan1=jumblan1, qmapping=qmapping, txPower=txPower, vlan=vlan, wanType=wanType, adminStatus=adminStatus, portStatistic=portStatistic, vendorRev=vendorRev, pauseReceived=pauseReceived, vlangroupTable=vlangroupTable, rxPower=rxPower, internetPort=internetPort, tftpSevIp=tftpSevIp, jumb=jumb, jumbwan=jumbwan, dscpEnable=dscpEnable, operStatus=operStatus, multicastsReceived=multicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, multicastsTransmitted=multicastsTransmitted, jumblan3=jumblan3, staticIpHostName=staticIpHostName, portPower=portPower, reboot=reboot, portmode=portmode, deviceinfo=deviceinfo, unicastsReceived=unicastsReceived, port4=port4, vlanid=vlanid, groupIndex=groupIndex, staticIpDomainName=staticIpDomainName, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, xg6846=xg6846, lan1=lan1, lanportspeed=lanportspeed, tftp=tftp, vendorPn=vendorPn, fcsErrorReceived=fcsErrorReceived, portStatEntry=portStatEntry, portIndex=portIndex, lan3=lan3)
