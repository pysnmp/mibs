...
mib_2, MibIdentifier, iso, snmpModules, Gauge32, NotificationType, Counter64, ModuleIdentity, ObjectIdentity, Unsigned32, TimeTicks, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibIdentifier", "iso", "snmpModules", "Gauge32", "NotificationType", "Counter64", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "TimeTicks", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan1=jumblan1, groupIndex=groupIndex, portPower=portPower, vendorOui=vendorOui, speed=speed, jumblan2=jumblan2, staticIpSubMask=staticIpSubMask, lan1=lan1, fileName=fileName, bias=bias, catv=catv, action=action, lanportpause=lanportpause, staticDns=staticDns, lan4=lan4, fileType=fileType, portEntry=portEntry, deviceinfo=deviceinfo, portIndex=portIndex, jumblan3=jumblan3, portmode=portmode, port2=port2, hostname=hostname, unicastsReceived=unicastsReceived, fcsErrorReceived=fcsErrorReceived, portStatistic=portStatistic, qos=qos, lan3=lan3, staticIpAddr=staticIpAddr, portStatEntry=portStatEntry, fcsErrorTransmitted=fcsErrorTransmitted, qmode=qmode, ddminfo=ddminfo, pauseTransmitted=pauseTransmitted, reboot=reboot, vendorRev=vendorRev, xg6846=xg6846, temperature=temperature, staticIpPrimaryDns=staticIpPrimaryDns, statIndex=statIndex, portTable=portTable, staticIpDomainName=staticIpDomainName, broadcastsReceived=broadcastsReceived, domainame=domainame, qosTable=qosTable, unicastsTransmitted=unicastsTransmitted, jumbwan=jumbwan, statisticTable=statisticTable, primaryDns=primaryDns, groupEntry=groupEntry, portName=portName, secondaryDns=secondaryDns, tftp=tftp, modeEntry=modeEntry, serialnum=serialnum, staticIpSecondaryDns=staticIpSecondaryDns, qosEntry=qosEntry, catvEnable=catvEnable, lanportName=lanportName, vlangroupTable=vlangroupTable, operStatus=operStatus, port4=port4, vendorPn=vendorPn, priority=priority, lan2=lan2, internetPort=internetPort, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, wan=wan, qmapping=qmapping, port1=port1, staticIpGateway=staticIpGateway, lanportspeed=lanportspeed, vendorName=vendorName, multicastsTransmitted=multicastsTransmitted, wanType=wanType, dscpEnable=dscpEnable, port3=port3, multicastsReceived=multicastsReceived, vlanid=vlanid, adminStatus=adminStatus, jumb=jumb, tftpSevIp=tftpSevIp, staticIpHostName=staticIpHostName, txPower=txPower, voltage=voltage, vlan=vlan, pauseReceived=pauseReceived, rxPower=rxPower, jumblan4=jumblan4, lanportIndex=lanportIndex, lanportTable=lanportTable, rebootEnable=rebootEnable, qosIndex=qosIndex)
