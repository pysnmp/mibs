...
# Produced by pysmi-1.1.8 at Fri Jan 13 13:59:54 2023
...
IpAddress, snmpModules, ObjectIdentity, Bits, Gauge32, iso, Integer32, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, mib_2, enterprises, NotificationType, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "snmpModules", "ObjectIdentity", "Bits", "Gauge32", "iso", "Integer32", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "mib-2", "enterprises", "NotificationType", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorOui=vendorOui, voltage=voltage, port2=port2, portmode=portmode, lanportIndex=lanportIndex, domainame=domainame, portStatistic=portStatistic, internetPort=internetPort, staticIpGateway=staticIpGateway, portName=portName, adminStatus=adminStatus, staticIpHostName=staticIpHostName, vlan=vlan, qmapping=qmapping, deviceinfo=deviceinfo, secondaryDns=secondaryDns, staticIpAddr=staticIpAddr, unicastsReceived=unicastsReceived, qosEntry=qosEntry, vlangroupTable=vlangroupTable, fcsErrorReceived=fcsErrorReceived, vendorPn=vendorPn, vendorRev=vendorRev, wan=wan, lan3=lan3, fileType=fileType, vendorName=vendorName, multicastsTransmitted=multicastsTransmitted, serialnum=serialnum, broadcastsReceived=broadcastsReceived, lan4=lan4, dscpEnable=dscpEnable, xg6846=xg6846, lanportspeed=lanportspeed, txPower=txPower, priority=priority, lanportpause=lanportpause, pauseReceived=pauseReceived, tftp=tftp, staticIpDomainName=staticIpDomainName, qos=qos, staticIpSubMask=staticIpSubMask, groupEntry=groupEntry, qosIndex=qosIndex, lan2=lan2, jumb=jumb, pauseTransmitted=pauseTransmitted, rxPower=rxPower, jumbwan=jumbwan, lanportName=lanportName, catvEnable=catvEnable, qosTable=qosTable, jumblan3=jumblan3, port4=port4, qmode=qmode, fileName=fileName, bias=bias, portIndex=portIndex, lanportTable=lanportTable, ddminfo=ddminfo, portEntry=portEntry, primaryDns=primaryDns, reboot=reboot, vlanid=vlanid, jumblan1=jumblan1, portStatEntry=portStatEntry, staticIpSecondaryDns=staticIpSecondaryDns, lan1=lan1, hostname=hostname, port3=port3, catv=catv, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, groupid=groupid, tftpSevIp=tftpSevIp, temperature=temperature, port1=port1, groupIndex=groupIndex, rebootEnable=rebootEnable, operStatus=operStatus, modeEntry=modeEntry, fcsErrorTransmitted=fcsErrorTransmitted, speed=speed, staticDns=staticDns, multicastsReceived=multicastsReceived, portTable=portTable, statisticTable=statisticTable, jumblan4=jumblan4, unicastsTransmitted=unicastsTransmitted, wanType=wanType, portPower=portPower, action=action, jumblan2=jumblan2)
