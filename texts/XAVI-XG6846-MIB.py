...
# Produced by pysmi-1.1.8 at Fri Jan  7 01:13:26 2022
...
Counter32, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, snmpModules, Bits, Unsigned32, TimeTicks, IpAddress, NotificationType, iso, ObjectIdentity, MibIdentifier, enterprises, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "snmpModules", "Bits", "Unsigned32", "TimeTicks", "IpAddress", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier", "enterprises", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosIndex=qosIndex, fileName=fileName, jumbwan=jumbwan, modeEntry=modeEntry, qosEntry=qosEntry, portName=portName, qmapping=qmapping, jumblan3=jumblan3, txPower=txPower, tftp=tftp, secondaryDns=secondaryDns, staticIpHostName=staticIpHostName, temperature=temperature, tftpSevIp=tftpSevIp, lanportTable=lanportTable, groupid=groupid, lan1=lan1, fcsErrorReceived=fcsErrorReceived, speed=speed, voltage=voltage, catvEnable=catvEnable, pauseReceived=pauseReceived, vlan=vlan, wanType=wanType, staticDns=staticDns, reboot=reboot, bias=bias, port1=port1, port3=port3, jumblan4=jumblan4, staticIpAddr=staticIpAddr, port2=port2, portEntry=portEntry, vendorRev=vendorRev, portmode=portmode, internetPort=internetPort, jumblan2=jumblan2, lan2=lan2, port4=port4, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, qosTable=qosTable, portTable=portTable, lanportpause=lanportpause, lan4=lan4, primaryDns=primaryDns, ddminfo=ddminfo, broadcastsReceived=broadcastsReceived, adminStatus=adminStatus, portStatEntry=portStatEntry, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, vendorName=vendorName, multicastsReceived=multicastsReceived, lan3=lan3, groupIndex=groupIndex, portIndex=portIndex, priority=priority, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, groupEntry=groupEntry, lanportName=lanportName, vlanid=vlanid, catv=catv, statIndex=statIndex, jumblan1=jumblan1, operStatus=operStatus, vlangroupTable=vlangroupTable, vendorOui=vendorOui, portPower=portPower, staticIpSubMask=staticIpSubMask, domainame=domainame, deviceinfo=deviceinfo, vendorPn=vendorPn, qmode=qmode, action=action, staticIpSecondaryDns=staticIpSecondaryDns, wan=wan, rxPower=rxPower, lanportIndex=lanportIndex, multicastsTransmitted=multicastsTransmitted, hostname=hostname, statisticTable=statisticTable, serialnum=serialnum, qos=qos, unicastsReceived=unicastsReceived, staticIpDomainName=staticIpDomainName, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, lanportspeed=lanportspeed, staticIpPrimaryDns=staticIpPrimaryDns, portStatistic=portStatistic, fileType=fileType, xg6846=xg6846)
