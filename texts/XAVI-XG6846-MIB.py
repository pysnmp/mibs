...
snmpModules, Unsigned32, Counter64, ObjectIdentity, iso, IpAddress, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, enterprises, ModuleIdentity, NotificationType, Counter32, mib_2, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Unsigned32", "Counter64", "ObjectIdentity", "iso", "IpAddress", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "enterprises", "ModuleIdentity", "NotificationType", "Counter32", "mib-2", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumbwan=jumbwan, port3=port3, port4=port4, qosIndex=qosIndex, groupid=groupid, catv=catv, portStatEntry=portStatEntry, tftp=tftp, staticIpAddr=staticIpAddr, operStatus=operStatus, lanportName=lanportName, temperature=temperature, jumblan2=jumblan2, rxPower=rxPower, multicastsReceived=multicastsReceived, deviceinfo=deviceinfo, qosTable=qosTable, fileName=fileName, priority=priority, lan2=lan2, lan3=lan3, staticIpDomainName=staticIpDomainName, bias=bias, rebootEnable=rebootEnable, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorTransmitted=fcsErrorTransmitted, voltage=voltage, statIndex=statIndex, staticIpGateway=staticIpGateway, wanType=wanType, qmode=qmode, internetPort=internetPort, lanportIndex=lanportIndex, primaryDns=primaryDns, vendorRev=vendorRev, portIndex=portIndex, portName=portName, portPower=portPower, xg6846=xg6846, lan4=lan4, fcsErrorReceived=fcsErrorReceived, qosEntry=qosEntry, vendorName=vendorName, vendorOui=vendorOui, port1=port1, modeEntry=modeEntry, qos=qos, lanportspeed=lanportspeed, serialnum=serialnum, domainame=domainame, vendorPn=vendorPn, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived, multicastsTransmitted=multicastsTransmitted, wan=wan, pauseReceived=pauseReceived, staticDns=staticDns, groupIndex=groupIndex, action=action, portStatistic=portStatistic, portmode=portmode, reboot=reboot, tftpSevIp=tftpSevIp, port2=port2, staticIpSecondaryDns=staticIpSecondaryDns, jumblan3=jumblan3, dscpEnable=dscpEnable, broadcastsTransmitted=broadcastsTransmitted, catvEnable=catvEnable, speed=speed, staticIpHostName=staticIpHostName, unicastsTransmitted=unicastsTransmitted, jumblan1=jumblan1, adminStatus=adminStatus, ddminfo=ddminfo, portTable=portTable, statisticTable=statisticTable, txPower=txPower, portEntry=portEntry, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, groupEntry=groupEntry, fileType=fileType, hostname=hostname, qmapping=qmapping, lan1=lan1, vlan=vlan, lanportTable=lanportTable, broadcastsReceived=broadcastsReceived, lanportpause=lanportpause, jumb=jumb, vlanid=vlanid, pauseTransmitted=pauseTransmitted, jumblan4=jumblan4)
