...
MibIdentifier, TimeTicks, Counter32, enterprises, mib_2, Counter64, Bits, IpAddress, snmpModules, Integer32, Gauge32, ModuleIdentity, ObjectIdentity, Unsigned32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Counter32", "enterprises", "mib-2", "Counter64", "Bits", "IpAddress", "snmpModules", "Integer32", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qos=qos, fileName=fileName, lan1=lan1, port1=port1, xg6846=xg6846, port4=port4, rebootEnable=rebootEnable, staticIpGateway=staticIpGateway, reboot=reboot, ddminfo=ddminfo, catvEnable=catvEnable, lanportspeed=lanportspeed, vendorRev=vendorRev, jumblan4=jumblan4, txPower=txPower, jumbwan=jumbwan, portStatEntry=portStatEntry, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, serialnum=serialnum, voltage=voltage, domainame=domainame, statisticTable=statisticTable, primaryDns=primaryDns, vlan=vlan, vendorName=vendorName, jumblan2=jumblan2, jumb=jumb, broadcastsReceived=broadcastsReceived, qosTable=qosTable, lan2=lan2, staticIpDomainName=staticIpDomainName, fileType=fileType, staticIpPrimaryDns=staticIpPrimaryDns, wan=wan, multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, lanportTable=lanportTable, rxPower=rxPower, staticDns=staticDns, port2=port2, dscpEnable=dscpEnable, staticIpHostName=staticIpHostName, operStatus=operStatus, portName=portName, portTable=portTable, qosIndex=qosIndex, groupIndex=groupIndex, pauseReceived=pauseReceived, qosEntry=qosEntry, priority=priority, lanportpause=lanportpause, unicastsReceived=unicastsReceived, multicastsReceived=multicastsReceived, adminStatus=adminStatus, portIndex=portIndex, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, jumblan1=jumblan1, tftp=tftp, staticIpAddr=staticIpAddr, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, modeEntry=modeEntry, staticIpSubMask=staticIpSubMask, lan4=lan4, lanportName=lanportName, temperature=temperature, vendorPn=vendorPn, qmapping=qmapping, portStatistic=portStatistic, tftpSevIp=tftpSevIp, portPower=portPower, portEntry=portEntry, action=action, internetPort=internetPort, vlangroupTable=vlangroupTable, speed=speed, bias=bias, groupEntry=groupEntry, groupid=groupid, wanType=wanType, catv=catv, jumblan3=jumblan3, statIndex=statIndex, pauseTransmitted=pauseTransmitted, port3=port3, deviceinfo=deviceinfo, hostname=hostname, secondaryDns=secondaryDns, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, qmode=qmode, lanportIndex=lanportIndex)
