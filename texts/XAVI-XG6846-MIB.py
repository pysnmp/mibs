...
# Produced by pysmi-1.1.8 at Wed Sep 13 08:04:10 2023
...
NotificationType, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, mib_2, IpAddress, Unsigned32, snmpModules, enterprises, Bits, MibIdentifier, TimeTicks, Gauge32, Counter64, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "mib-2", "IpAddress", "Unsigned32", "snmpModules", "enterprises", "Bits", "MibIdentifier", "TimeTicks", "Gauge32", "Counter64", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpHostName=staticIpHostName, speed=speed, vendorName=vendorName, lan2=lan2, jumblan1=jumblan1, lan4=lan4, port4=port4, groupid=groupid, multicastsTransmitted=multicastsTransmitted, unicastsTransmitted=unicastsTransmitted, portStatEntry=portStatEntry, reboot=reboot, vendorOui=vendorOui, lan1=lan1, bias=bias, action=action, port3=port3, tftpSevIp=tftpSevIp, jumblan3=jumblan3, portName=portName, fileType=fileType, jumbwan=jumbwan, qos=qos, qmapping=qmapping, portStatistic=portStatistic, staticIpAddr=staticIpAddr, statIndex=statIndex, tftp=tftp, port2=port2, unicastsReceived=unicastsReceived, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, fileName=fileName, wan=wan, lanportName=lanportName, lanportspeed=lanportspeed, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, qosTable=qosTable, lanportIndex=lanportIndex, portmode=portmode, xg6846=xg6846, broadcastsTransmitted=broadcastsTransmitted, statisticTable=statisticTable, staticIpSecondaryDns=staticIpSecondaryDns, rebootEnable=rebootEnable, fcsErrorTransmitted=fcsErrorTransmitted, catvEnable=catvEnable, adminStatus=adminStatus, portEntry=portEntry, jumb=jumb, temperature=temperature, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, hostname=hostname, staticDns=staticDns, vlanid=vlanid, priority=priority, primaryDns=primaryDns, voltage=voltage, multicastsReceived=multicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower, vendorRev=vendorRev, ddminfo=ddminfo, groupEntry=groupEntry, txPower=txPower, modeEntry=modeEntry, vendorPn=vendorPn, domainame=domainame, pauseTransmitted=pauseTransmitted, internetPort=internetPort, staticIpDomainName=staticIpDomainName, dscpEnable=dscpEnable, wanType=wanType, lan3=lan3, vlan=vlan, lanportpause=lanportpause, lanportTable=lanportTable, deviceinfo=deviceinfo, jumblan2=jumblan2, catv=catv, serialnum=serialnum, portIndex=portIndex, pauseReceived=pauseReceived, operStatus=operStatus, qosEntry=qosEntry, qmode=qmode, port1=port1, groupIndex=groupIndex, portTable=portTable, qosIndex=qosIndex, staticIpGateway=staticIpGateway, portPower=portPower)
