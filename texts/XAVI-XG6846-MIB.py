...
# Produced by pysmi-1.1.8 at Thu Jan  5 13:24:26 2023
...
iso, Integer32, Unsigned32, mib_2, IpAddress, Bits, Counter32, NotificationType, TimeTicks, Counter64, ObjectIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, ModuleIdentity, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Unsigned32", "mib-2", "IpAddress", "Bits", "Counter32", "NotificationType", "TimeTicks", "Counter64", "ObjectIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "ModuleIdentity", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpPrimaryDns=staticIpPrimaryDns, lan3=lan3, vlangroupTable=vlangroupTable, qmode=qmode, modeEntry=modeEntry, fcsErrorTransmitted=fcsErrorTransmitted, operStatus=operStatus, portEntry=portEntry, internetPort=internetPort, lan1=lan1, deviceinfo=deviceinfo, statIndex=statIndex, multicastsTransmitted=multicastsTransmitted, jumblan4=jumblan4, jumblan1=jumblan1, priority=priority, port4=port4, voltage=voltage, catv=catv, portStatistic=portStatistic, portPower=portPower, portStatEntry=portStatEntry, jumblan3=jumblan3, temperature=temperature, bias=bias, wan=wan, catvEnable=catvEnable, fileType=fileType, domainame=domainame, jumbwan=jumbwan, jumblan2=jumblan2, portName=portName, fcsErrorReceived=fcsErrorReceived, staticDns=staticDns, dscpEnable=dscpEnable, multicastsReceived=multicastsReceived, serialnum=serialnum, vendorOui=vendorOui, staticIpAddr=staticIpAddr, lanportName=lanportName, staticIpDomainName=staticIpDomainName, vendorRev=vendorRev, tftpSevIp=tftpSevIp, jumb=jumb, pauseTransmitted=pauseTransmitted, lanportIndex=lanportIndex, qosTable=qosTable, broadcastsReceived=broadcastsReceived, ddminfo=ddminfo, adminStatus=adminStatus, wanType=wanType, qos=qos, secondaryDns=secondaryDns, pauseReceived=pauseReceived, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, vlanid=vlanid, qosEntry=qosEntry, txPower=txPower, groupEntry=groupEntry, groupid=groupid, portTable=portTable, staticIpHostName=staticIpHostName, lanportpause=lanportpause, portmode=portmode, action=action, primaryDns=primaryDns, statisticTable=statisticTable, vendorPn=vendorPn, hostname=hostname, tftp=tftp, lan2=lan2, lan4=lan4, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, unicastsReceived=unicastsReceived, portIndex=portIndex, lanportTable=lanportTable, speed=speed, vendorName=vendorName, port2=port2, fileName=fileName, reboot=reboot, port1=port1, xg6846=xg6846, vlan=vlan, port3=port3, rebootEnable=rebootEnable, staticIpSecondaryDns=staticIpSecondaryDns, rxPower=rxPower, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, lanportspeed=lanportspeed, groupIndex=groupIndex)
