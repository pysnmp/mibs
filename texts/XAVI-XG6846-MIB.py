...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:55:02 2021
...
NotificationType, ModuleIdentity, Unsigned32, Gauge32, Counter64, enterprises, TimeTicks, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Counter32, IpAddress, MibIdentifier, Bits, mib_2, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Unsigned32", "Gauge32", "Counter64", "enterprises", "TimeTicks", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Counter32", "IpAddress", "MibIdentifier", "Bits", "mib-2", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", priority=priority, hostname=hostname, reboot=reboot, ddminfo=ddminfo, portTable=portTable, staticIpSecondaryDns=staticIpSecondaryDns, catvEnable=catvEnable, vlanid=vlanid, portStatEntry=portStatEntry, vendorRev=vendorRev, lan2=lan2, modeEntry=modeEntry, jumblan4=jumblan4, fileName=fileName, statIndex=statIndex, rxPower=rxPower, jumblan3=jumblan3, pauseTransmitted=pauseTransmitted, deviceinfo=deviceinfo, broadcastsTransmitted=broadcastsTransmitted, vendorPn=vendorPn, groupEntry=groupEntry, staticIpDomainName=staticIpDomainName, jumblan2=jumblan2, lanportTable=lanportTable, groupid=groupid, jumb=jumb, fcsErrorTransmitted=fcsErrorTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, vlangroupTable=vlangroupTable, jumblan1=jumblan1, domainame=domainame, staticIpAddr=staticIpAddr, portStatistic=portStatistic, multicastsReceived=multicastsReceived, vlan=vlan, lan3=lan3, lan4=lan4, jumbwan=jumbwan, serialnum=serialnum, tftp=tftp, lanportIndex=lanportIndex, action=action, lanportpause=lanportpause, fileType=fileType, pauseReceived=pauseReceived, portIndex=portIndex, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, speed=speed, staticDns=staticDns, bias=bias, tftpSevIp=tftpSevIp, staticIpGateway=staticIpGateway, fcsErrorReceived=fcsErrorReceived, txPower=txPower, voltage=voltage, lan1=lan1, secondaryDns=secondaryDns, portName=portName, temperature=temperature, port1=port1, portEntry=portEntry, staticIpHostName=staticIpHostName, adminStatus=adminStatus, rebootEnable=rebootEnable, wan=wan, dscpEnable=dscpEnable, portPower=portPower, wanType=wanType, vendorOui=vendorOui, qmapping=qmapping, groupIndex=groupIndex, lanportspeed=lanportspeed, qosEntry=qosEntry, xg6846=xg6846, vendorName=vendorName, portmode=portmode, lanportName=lanportName, qosTable=qosTable, broadcastsReceived=broadcastsReceived, operStatus=operStatus, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, unicastsReceived=unicastsReceived, port3=port3, internetPort=internetPort, port4=port4, qmode=qmode, primaryDns=primaryDns, catv=catv, statisticTable=statisticTable, port2=port2, qos=qos)
