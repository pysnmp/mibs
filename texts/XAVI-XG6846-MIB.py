...
ObjectIdentity, IpAddress, MibIdentifier, Unsigned32, enterprises, ModuleIdentity, Bits, NotificationType, iso, Integer32, Gauge32, TimeTicks, snmpModules, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "MibIdentifier", "Unsigned32", "enterprises", "ModuleIdentity", "Bits", "NotificationType", "iso", "Integer32", "Gauge32", "TimeTicks", "snmpModules", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, priority=priority, staticDns=staticDns, speed=speed, port1=port1, portIndex=portIndex, lanportspeed=lanportspeed, operStatus=operStatus, modeEntry=modeEntry, jumblan1=jumblan1, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, portStatEntry=portStatEntry, vlanid=vlanid, hostname=hostname, portPower=portPower, groupEntry=groupEntry, bias=bias, xg6846=xg6846, fileType=fileType, txPower=txPower, vlangroupTable=vlangroupTable, secondaryDns=secondaryDns, staticIpDomainName=staticIpDomainName, statIndex=statIndex, lan1=lan1, catv=catv, vendorOui=vendorOui, portEntry=portEntry, fcsErrorReceived=fcsErrorReceived, portTable=portTable, pauseReceived=pauseReceived, vlan=vlan, jumblan4=jumblan4, staticIpAddr=staticIpAddr, unicastsTransmitted=unicastsTransmitted, vendorName=vendorName, staticIpSubMask=staticIpSubMask, unicastsReceived=unicastsReceived, multicastsReceived=multicastsReceived, internetPort=internetPort, lanportIndex=lanportIndex, dscpEnable=dscpEnable, action=action, lan3=lan3, port3=port3, multicastsTransmitted=multicastsTransmitted, port2=port2, ddminfo=ddminfo, jumblan3=jumblan3, vendorRev=vendorRev, jumblan2=jumblan2, staticIpGateway=staticIpGateway, pauseTransmitted=pauseTransmitted, portName=portName, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, qos=qos, tftp=tftp, jumbwan=jumbwan, lan4=lan4, statisticTable=statisticTable, portStatistic=portStatistic, lanportName=lanportName, voltage=voltage, fileName=fileName, qosTable=qosTable, catvEnable=catvEnable, serialnum=serialnum, qmapping=qmapping, portmode=portmode, deviceinfo=deviceinfo, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower, qosEntry=qosEntry, staticIpSecondaryDns=staticIpSecondaryDns, adminStatus=adminStatus, lanportpause=lanportpause, wan=wan, vendorPn=vendorPn, staticIpHostName=staticIpHostName, domainame=domainame, tftpSevIp=tftpSevIp, lanportTable=lanportTable, rebootEnable=rebootEnable, lan2=lan2, qosIndex=qosIndex, temperature=temperature, groupid=groupid, wanType=wanType, qmode=qmode, port4=port4)
