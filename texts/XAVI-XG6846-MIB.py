...
snmpModules, Unsigned32, Counter32, Counter64, mib_2, Gauge32, enterprises, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Integer32, NotificationType, IpAddress, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Unsigned32", "Counter32", "Counter64", "mib-2", "Gauge32", "enterprises", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Integer32", "NotificationType", "IpAddress", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port2=port2, qosIndex=qosIndex, jumblan4=jumblan4, adminStatus=adminStatus, vendorName=vendorName, vendorRev=vendorRev, groupEntry=groupEntry, voltage=voltage, internetPort=internetPort, lan1=lan1, wan=wan, txPower=txPower, qmode=qmode, statisticTable=statisticTable, operStatus=operStatus, modeEntry=modeEntry, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, port3=port3, jumbwan=jumbwan, secondaryDns=secondaryDns, vlanid=vlanid, multicastsReceived=multicastsReceived, portIndex=portIndex, lanportTable=lanportTable, catv=catv, ddminfo=ddminfo, jumblan3=jumblan3, lanportpause=lanportpause, fileName=fileName, qosEntry=qosEntry, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, lanportName=lanportName, portPower=portPower, staticIpDomainName=staticIpDomainName, groupid=groupid, wanType=wanType, unicastsTransmitted=unicastsTransmitted, lanportspeed=lanportspeed, staticIpAddr=staticIpAddr, pauseTransmitted=pauseTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, groupIndex=groupIndex, action=action, portName=portName, staticDns=staticDns, vendorPn=vendorPn, priority=priority, staticIpGateway=staticIpGateway, lan4=lan4, lan3=lan3, pauseReceived=pauseReceived, speed=speed, temperature=temperature, catvEnable=catvEnable, qos=qos, serialnum=serialnum, broadcastsReceived=broadcastsReceived, statIndex=statIndex, vlan=vlan, fileType=fileType, fcsErrorTransmitted=fcsErrorTransmitted, xg6846=xg6846, fcsErrorReceived=fcsErrorReceived, bias=bias, rebootEnable=rebootEnable, lan2=lan2, tftpSevIp=tftpSevIp, vendorOui=vendorOui, port1=port1, portEntry=portEntry, tftp=tftp, reboot=reboot, jumblan2=jumblan2, jumb=jumb, portStatistic=portStatistic, domainame=domainame, primaryDns=primaryDns, port4=port4, jumblan1=jumblan1, dscpEnable=dscpEnable, rxPower=rxPower, lanportIndex=lanportIndex, staticIpHostName=staticIpHostName, staticIpSubMask=staticIpSubMask, deviceinfo=deviceinfo, staticIpSecondaryDns=staticIpSecondaryDns, qosTable=qosTable, broadcastsTransmitted=broadcastsTransmitted, portTable=portTable, hostname=hostname, portmode=portmode, qmapping=qmapping)
