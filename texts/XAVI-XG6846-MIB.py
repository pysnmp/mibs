...
# Produced by pysmi-1.1.12 at Wed May 29 06:47:17 2024
...
ModuleIdentity, Unsigned32, Bits, NotificationType, Gauge32, IpAddress, Counter32, iso, Counter64, mib_2, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, enterprises, snmpModules, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Bits", "NotificationType", "Gauge32", "IpAddress", "Counter32", "iso", "Counter64", "mib-2", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "enterprises", "snmpModules", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, ddminfo=ddminfo, staticIpSecondaryDns=staticIpSecondaryDns, lan1=lan1, unicastsReceived=unicastsReceived, reboot=reboot, staticDns=staticDns, portIndex=portIndex, staticIpSubMask=staticIpSubMask, secondaryDns=secondaryDns, unicastsTransmitted=unicastsTransmitted, temperature=temperature, lanportspeed=lanportspeed, hostname=hostname, priority=priority, rebootEnable=rebootEnable, speed=speed, lanportpause=lanportpause, vendorRev=vendorRev, lan4=lan4, groupEntry=groupEntry, jumblan3=jumblan3, multicastsTransmitted=multicastsTransmitted, lanportIndex=lanportIndex, qosEntry=qosEntry, portStatEntry=portStatEntry, port3=port3, pauseReceived=pauseReceived, internetPort=internetPort, lanportTable=lanportTable, vendorName=vendorName, portmode=portmode, modeEntry=modeEntry, port2=port2, vlan=vlan, jumblan1=jumblan1, bias=bias, voltage=voltage, statIndex=statIndex, staticIpDomainName=staticIpDomainName, tftp=tftp, deviceinfo=deviceinfo, wanType=wanType, portEntry=portEntry, jumblan2=jumblan2, dscpEnable=dscpEnable, multicastsReceived=multicastsReceived, fileName=fileName, staticIpAddr=staticIpAddr, portPower=portPower, portStatistic=portStatistic, staticIpHostName=staticIpHostName, qmapping=qmapping, operStatus=operStatus, lanportName=lanportName, qosTable=qosTable, tftpSevIp=tftpSevIp, statisticTable=statisticTable, action=action, lan2=lan2, primaryDns=primaryDns, vlangroupTable=vlangroupTable, jumblan4=jumblan4, pauseTransmitted=pauseTransmitted, lan3=lan3, catv=catv, rxPower=rxPower, qmode=qmode, staticIpPrimaryDns=staticIpPrimaryDns, vendorPn=vendorPn, serialnum=serialnum, adminStatus=adminStatus, txPower=txPower, port1=port1, port4=port4, jumbwan=jumbwan, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, broadcastsReceived=broadcastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, portTable=portTable, fileType=fileType, qosIndex=qosIndex, vlanid=vlanid, wan=wan, vendorOui=vendorOui, domainame=domainame, staticIpGateway=staticIpGateway, fcsErrorReceived=fcsErrorReceived, jumb=jumb, groupIndex=groupIndex, xg6846=xg6846, portName=portName, qos=qos)
