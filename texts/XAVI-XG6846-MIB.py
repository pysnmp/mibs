...
# Produced by pysmi-1.1.8 at Wed Sep 13 07:28:23 2023
...
enterprises, NotificationType, iso, Integer32, Bits, Gauge32, Counter64, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, ObjectIdentity, Unsigned32, mib_2, ModuleIdentity, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "iso", "Integer32", "Bits", "Gauge32", "Counter64", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "ObjectIdentity", "Unsigned32", "mib-2", "ModuleIdentity", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsReceived=multicastsReceived, jumblan4=jumblan4, staticIpHostName=staticIpHostName, fcsErrorReceived=fcsErrorReceived, portStatEntry=portStatEntry, groupIndex=groupIndex, portEntry=portEntry, lanportName=lanportName, voltage=voltage, modeEntry=modeEntry, bias=bias, statisticTable=statisticTable, portTable=portTable, staticIpDomainName=staticIpDomainName, speed=speed, jumbwan=jumbwan, lanportspeed=lanportspeed, portName=portName, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, portPower=portPower, vlangroupTable=vlangroupTable, fcsErrorTransmitted=fcsErrorTransmitted, operStatus=operStatus, groupid=groupid, qmapping=qmapping, lan4=lan4, qmode=qmode, jumblan3=jumblan3, lanportIndex=lanportIndex, unicastsReceived=unicastsReceived, portStatistic=portStatistic, deviceinfo=deviceinfo, lan2=lan2, multicastsTransmitted=multicastsTransmitted, portmode=portmode, vendorOui=vendorOui, reboot=reboot, staticIpAddr=staticIpAddr, staticDns=staticDns, action=action, tftpSevIp=tftpSevIp, wanType=wanType, fileName=fileName, fileType=fileType, staticIpSubMask=staticIpSubMask, priority=priority, tftp=tftp, pauseReceived=pauseReceived, domainame=domainame, secondaryDns=secondaryDns, qosIndex=qosIndex, qos=qos, catv=catv, qosTable=qosTable, broadcastsTransmitted=broadcastsTransmitted, lanportTable=lanportTable, primaryDns=primaryDns, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, statIndex=statIndex, groupEntry=groupEntry, vlan=vlan, dscpEnable=dscpEnable, vlanid=vlanid, staticIpGateway=staticIpGateway, lan3=lan3, adminStatus=adminStatus, hostname=hostname, staticIpSecondaryDns=staticIpSecondaryDns, vendorRev=vendorRev, unicastsTransmitted=unicastsTransmitted, wan=wan, catvEnable=catvEnable, jumblan1=jumblan1, vendorName=vendorName, jumblan2=jumblan2, rxPower=rxPower, txPower=txPower, xg6846=xg6846, lan1=lan1, vendorPn=vendorPn, port4=port4, qosEntry=qosEntry, rebootEnable=rebootEnable, port2=port2, jumb=jumb, temperature=temperature, ddminfo=ddminfo, internetPort=internetPort, lanportpause=lanportpause, port3=port3, serialnum=serialnum, portIndex=portIndex)
