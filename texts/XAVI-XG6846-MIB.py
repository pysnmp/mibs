...
# Produced by pysmi-1.1.12 at Tue Dec  3 09:44:38 2024
...
MibIdentifier, TimeTicks, Counter64, Gauge32, Bits, ModuleIdentity, snmpModules, IpAddress, iso, Unsigned32, mib_2, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Counter64", "Gauge32", "Bits", "ModuleIdentity", "snmpModules", "IpAddress", "iso", "Unsigned32", "mib-2", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportspeed=lanportspeed, statIndex=statIndex, staticIpSecondaryDns=staticIpSecondaryDns, jumbwan=jumbwan, staticDns=staticDns, port2=port2, xg6846=xg6846, lan3=lan3, txPower=txPower, portEntry=portEntry, catvEnable=catvEnable, multicastsTransmitted=multicastsTransmitted, lan4=lan4, port3=port3, portStatistic=portStatistic, staticIpSubMask=staticIpSubMask, qmapping=qmapping, jumblan1=jumblan1, adminStatus=adminStatus, jumblan2=jumblan2, temperature=temperature, portmode=portmode, vendorName=vendorName, vlangroupTable=vlangroupTable, vlanid=vlanid, multicastsReceived=multicastsReceived, ddminfo=ddminfo, operStatus=operStatus, speed=speed, primaryDns=primaryDns, qmode=qmode, vlan=vlan, portPower=portPower, tftp=tftp, lan1=lan1, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, unicastsTransmitted=unicastsTransmitted, rebootEnable=rebootEnable, portIndex=portIndex, unicastsReceived=unicastsReceived, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, lanportIndex=lanportIndex, deviceinfo=deviceinfo, lanportName=lanportName, fileType=fileType, internetPort=internetPort, lanportpause=lanportpause, portName=portName, staticIpAddr=staticIpAddr, qosTable=qosTable, portStatEntry=portStatEntry, wan=wan, qosEntry=qosEntry, vendorPn=vendorPn, modeEntry=modeEntry, groupid=groupid, portTable=portTable, staticIpGateway=staticIpGateway, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, bias=bias, action=action, tftpSevIp=tftpSevIp, pauseReceived=pauseReceived, lanportTable=lanportTable, staticIpPrimaryDns=staticIpPrimaryDns, secondaryDns=secondaryDns, groupIndex=groupIndex, staticIpDomainName=staticIpDomainName, fcsErrorTransmitted=fcsErrorTransmitted, dscpEnable=dscpEnable, groupEntry=groupEntry, voltage=voltage, priority=priority, jumblan3=jumblan3, domainame=domainame, rxPower=rxPower, reboot=reboot, vendorRev=vendorRev, statisticTable=statisticTable, serialnum=serialnum, qosIndex=qosIndex, wanType=wanType, lan2=lan2, qos=qos, hostname=hostname, catv=catv, jumb=jumb, port1=port1, port4=port4, vendorOui=vendorOui, staticIpHostName=staticIpHostName)
