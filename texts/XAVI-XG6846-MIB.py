...
ObjectIdentity, snmpModules, enterprises, mib_2, Counter64, Unsigned32, MibIdentifier, NotificationType, IpAddress, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, Integer32, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "snmpModules", "enterprises", "mib-2", "Counter64", "Unsigned32", "MibIdentifier", "NotificationType", "IpAddress", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "Integer32", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, lan4=lan4, lanportpause=lanportpause, portmode=portmode, jumbwan=jumbwan, jumb=jumb, portEntry=portEntry, qosTable=qosTable, qosIndex=qosIndex, tftp=tftp, staticIpDomainName=staticIpDomainName, vlanid=vlanid, deviceinfo=deviceinfo, qosEntry=qosEntry, qos=qos, bias=bias, lanportspeed=lanportspeed, multicastsReceived=multicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, vendorName=vendorName, hostname=hostname, secondaryDns=secondaryDns, staticIpSecondaryDns=staticIpSecondaryDns, lan2=lan2, speed=speed, wan=wan, staticDns=staticDns, groupEntry=groupEntry, vendorRev=vendorRev, fileType=fileType, jumblan2=jumblan2, portName=portName, jumblan1=jumblan1, priority=priority, domainame=domainame, serialnum=serialnum, lanportName=lanportName, rxPower=rxPower, statIndex=statIndex, xg6846=xg6846, catvEnable=catvEnable, tftpSevIp=tftpSevIp, lan3=lan3, vlan=vlan, lanportTable=lanportTable, fileName=fileName, portIndex=portIndex, vendorPn=vendorPn, portPower=portPower, staticIpGateway=staticIpGateway, temperature=temperature, groupid=groupid, voltage=voltage, lan1=lan1, pauseReceived=pauseReceived, groupIndex=groupIndex, unicastsReceived=unicastsReceived, jumblan3=jumblan3, primaryDns=primaryDns, fcsErrorReceived=fcsErrorReceived, multicastsTransmitted=multicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, modeEntry=modeEntry, txPower=txPower, operStatus=operStatus, unicastsTransmitted=unicastsTransmitted, port3=port3, port1=port1, staticIpHostName=staticIpHostName, jumblan4=jumblan4, qmapping=qmapping, wanType=wanType, portTable=portTable, port4=port4, vendorOui=vendorOui, dscpEnable=dscpEnable, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, action=action, reboot=reboot, portStatEntry=portStatEntry, rebootEnable=rebootEnable, ddminfo=ddminfo, staticIpAddr=staticIpAddr, broadcastsTransmitted=broadcastsTransmitted, qmode=qmode, adminStatus=adminStatus, port2=port2, lanportIndex=lanportIndex, internetPort=internetPort, vlangroupTable=vlangroupTable, statisticTable=statisticTable)
