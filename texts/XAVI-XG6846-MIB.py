...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:00:20 2023
...
TimeTicks, enterprises, iso, ObjectIdentity, Integer32, MibIdentifier, mib_2, NotificationType, Gauge32, snmpModules, IpAddress, Unsigned32, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "iso", "ObjectIdentity", "Integer32", "MibIdentifier", "mib-2", "NotificationType", "Gauge32", "snmpModules", "IpAddress", "Unsigned32", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statIndex=statIndex, portName=portName, jumbwan=jumbwan, lan4=lan4, groupid=groupid, qmode=qmode, hostname=hostname, catvEnable=catvEnable, catv=catv, qosIndex=qosIndex, vendorName=vendorName, portTable=portTable, statisticTable=statisticTable, rebootEnable=rebootEnable, multicastsReceived=multicastsReceived, portIndex=portIndex, temperature=temperature, port2=port2, qosEntry=qosEntry, lan1=lan1, jumblan2=jumblan2, staticIpAddr=staticIpAddr, dscpEnable=dscpEnable, rxPower=rxPower, fileType=fileType, portEntry=portEntry, adminStatus=adminStatus, lanportpause=lanportpause, action=action, txPower=txPower, groupEntry=groupEntry, modeEntry=modeEntry, portPower=portPower, port1=port1, vendorOui=vendorOui, tftpSevIp=tftpSevIp, pauseReceived=pauseReceived, fileName=fileName, broadcastsReceived=broadcastsReceived, internetPort=internetPort, qosTable=qosTable, secondaryDns=secondaryDns, vlan=vlan, voltage=voltage, xg6846=xg6846, port3=port3, reboot=reboot, qmapping=qmapping, pauseTransmitted=pauseTransmitted, wan=wan, ddminfo=ddminfo, multicastsTransmitted=multicastsTransmitted, tftp=tftp, vlanid=vlanid, deviceinfo=deviceinfo, speed=speed, lanportTable=lanportTable, vendorRev=vendorRev, lan3=lan3, staticIpDomainName=staticIpDomainName, staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, jumblan3=jumblan3, operStatus=operStatus, jumb=jumb, primaryDns=primaryDns, portmode=portmode, groupIndex=groupIndex, vendorPn=vendorPn, lanportName=lanportName, jumblan1=jumblan1, unicastsReceived=unicastsReceived, portStatEntry=portStatEntry, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, port4=port4, staticIpGateway=staticIpGateway, jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, portStatistic=portStatistic, lan2=lan2, wanType=wanType, staticIpHostName=staticIpHostName, lanportIndex=lanportIndex, priority=priority, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, fcsErrorReceived=fcsErrorReceived, qos=qos, domainame=domainame, staticIpSecondaryDns=staticIpSecondaryDns, serialnum=serialnum, broadcastsTransmitted=broadcastsTransmitted, bias=bias)
