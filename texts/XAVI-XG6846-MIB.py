...
# Produced by pysmi-1.1.8 at Thu Jan  5 14:48:54 2023
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qos=qos, lanportTable=lanportTable, fcsErrorTransmitted=fcsErrorTransmitted, staticIpDomainName=staticIpDomainName, jumblan4=jumblan4, portTable=portTable, tftpSevIp=tftpSevIp, catv=catv, broadcastsTransmitted=broadcastsTransmitted, port3=port3, staticIpHostName=staticIpHostName, vlan=vlan, bias=bias, groupIndex=groupIndex, reboot=reboot, staticIpPrimaryDns=staticIpPrimaryDns, port4=port4, portEntry=portEntry, lan2=lan2, portStatistic=portStatistic, jumblan2=jumblan2, serialnum=serialnum, jumblan1=jumblan1, temperature=temperature, operStatus=operStatus, pauseTransmitted=pauseTransmitted, rxPower=rxPower, statisticTable=statisticTable, multicastsTransmitted=multicastsTransmitted, hostname=hostname, rebootEnable=rebootEnable, staticIpSubMask=staticIpSubMask, groupid=groupid, port2=port2, fileType=fileType, qosIndex=qosIndex, vlanid=vlanid, multicastsReceived=multicastsReceived, tftp=tftp, speed=speed, unicastsTransmitted=unicastsTransmitted, lanportName=lanportName, secondaryDns=secondaryDns, fcsErrorReceived=fcsErrorReceived, voltage=voltage, staticIpAddr=staticIpAddr, portName=portName, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, portmode=portmode, priority=priority, qmode=qmode, qosTable=qosTable, vendorOui=vendorOui, fileName=fileName, jumbwan=jumbwan, vlangroupTable=vlangroupTable, vendorRev=vendorRev, lanportspeed=lanportspeed, qosEntry=qosEntry, pauseReceived=pauseReceived, statIndex=statIndex, lan3=lan3, port1=port1, portIndex=portIndex, qmapping=qmapping, ddminfo=ddminfo, staticIpGateway=staticIpGateway, dscpEnable=dscpEnable, jumb=jumb, internetPort=internetPort, domainame=domainame, staticDns=staticDns, wan=wan, vendorName=vendorName, lanportIndex=lanportIndex, lan1=lan1, adminStatus=adminStatus, catvEnable=catvEnable, xg6846=xg6846, jumblan3=jumblan3, lan4=lan4, wanType=wanType, broadcastsReceived=broadcastsReceived, txPower=txPower, primaryDns=primaryDns, portStatEntry=portStatEntry, portPower=portPower, deviceinfo=deviceinfo, action=action, lanportpause=lanportpause, unicastsReceived=unicastsReceived, groupEntry=groupEntry, vendorPn=vendorPn)
