...
Counter64, ObjectIdentity, snmpModules, enterprises, IpAddress, Integer32, Bits, Unsigned32, Gauge32, iso, Counter32, MibIdentifier, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "snmpModules", "enterprises", "IpAddress", "Integer32", "Bits", "Unsigned32", "Gauge32", "iso", "Counter32", "MibIdentifier", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSubMask=staticIpSubMask, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, ddminfo=ddminfo, portPower=portPower, tftp=tftp, domainame=domainame, pauseReceived=pauseReceived, staticIpGateway=staticIpGateway, serialnum=serialnum, statisticTable=statisticTable, dscpEnable=dscpEnable, lan3=lan3, lanportspeed=lanportspeed, secondaryDns=secondaryDns, catvEnable=catvEnable, port3=port3, primaryDns=primaryDns, pauseTransmitted=pauseTransmitted, vendorRev=vendorRev, unicastsReceived=unicastsReceived, qos=qos, vlangroupTable=vlangroupTable, txPower=txPower, deviceinfo=deviceinfo, staticIpHostName=staticIpHostName, operStatus=operStatus, vendorPn=vendorPn, action=action, fileName=fileName, priority=priority, voltage=voltage, qosTable=qosTable, staticIpSecondaryDns=staticIpSecondaryDns, jumb=jumb, internetPort=internetPort, groupIndex=groupIndex, rebootEnable=rebootEnable, wanType=wanType, temperature=temperature, staticIpDomainName=staticIpDomainName, fcsErrorReceived=fcsErrorReceived, vendorName=vendorName, reboot=reboot, qosEntry=qosEntry, lanportTable=lanportTable, staticIpAddr=staticIpAddr, lan4=lan4, xg6846=xg6846, qmode=qmode, statIndex=statIndex, fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, jumbwan=jumbwan, lanportName=lanportName, jumblan4=jumblan4, portEntry=portEntry, portmode=portmode, lanportIndex=lanportIndex, bias=bias, groupEntry=groupEntry, portIndex=portIndex, qosIndex=qosIndex, rxPower=rxPower, portStatistic=portStatistic, adminStatus=adminStatus, jumblan1=jumblan1, vlan=vlan, multicastsReceived=multicastsReceived, hostname=hostname, lan2=lan2, portName=portName, unicastsTransmitted=unicastsTransmitted, speed=speed, jumblan2=jumblan2, portTable=portTable, qmapping=qmapping, modeEntry=modeEntry, port4=port4, portStatEntry=portStatEntry, vlanid=vlanid, lan1=lan1, port1=port1, wan=wan, port2=port2, lanportpause=lanportpause, groupid=groupid, tftpSevIp=tftpSevIp, multicastsTransmitted=multicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsReceived=broadcastsReceived, fileType=fileType, staticDns=staticDns, catv=catv)
