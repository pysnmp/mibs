...
Counter64, iso, ObjectIdentity, ModuleIdentity, NotificationType, Integer32, Unsigned32, Counter32, snmpModules, enterprises, mib_2, Bits, Gauge32, MibIdentifier, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Integer32", "Unsigned32", "Counter32", "snmpModules", "enterprises", "mib-2", "Bits", "Gauge32", "MibIdentifier", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpAddr=staticIpAddr, priority=priority, multicastsReceived=multicastsReceived, pauseReceived=pauseReceived, domainame=domainame, tftpSevIp=tftpSevIp, groupEntry=groupEntry, staticIpHostName=staticIpHostName, jumblan3=jumblan3, qosTable=qosTable, xg6846=xg6846, statisticTable=statisticTable, broadcastsReceived=broadcastsReceived, qosEntry=qosEntry, port1=port1, qmapping=qmapping, vlanid=vlanid, lanportTable=lanportTable, portIndex=portIndex, bias=bias, vendorRev=vendorRev, txPower=txPower, port2=port2, qos=qos, lanportspeed=lanportspeed, action=action, vlan=vlan, statIndex=statIndex, groupid=groupid, groupIndex=groupIndex, tftp=tftp, port4=port4, jumblan2=jumblan2, portEntry=portEntry, staticIpPrimaryDns=staticIpPrimaryDns, staticDns=staticDns, vendorName=vendorName, pauseTransmitted=pauseTransmitted, qosIndex=qosIndex, rxPower=rxPower, speed=speed, catvEnable=catvEnable, jumblan4=jumblan4, vendorPn=vendorPn, qmode=qmode, deviceinfo=deviceinfo, hostname=hostname, fileType=fileType, jumblan1=jumblan1, fileName=fileName, fcsErrorReceived=fcsErrorReceived, portStatEntry=portStatEntry, lan3=lan3, rebootEnable=rebootEnable, operStatus=operStatus, port3=port3, lan2=lan2, catv=catv, portName=portName, dscpEnable=dscpEnable, multicastsTransmitted=multicastsTransmitted, serialnum=serialnum, fcsErrorTransmitted=fcsErrorTransmitted, staticIpDomainName=staticIpDomainName, unicastsReceived=unicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, lanportpause=lanportpause, secondaryDns=secondaryDns, temperature=temperature, adminStatus=adminStatus, primaryDns=primaryDns, unicastsTransmitted=unicastsTransmitted, wanType=wanType, wan=wan, portTable=portTable, vlangroupTable=vlangroupTable, lan4=lan4, portStatistic=portStatistic, reboot=reboot, vendorOui=vendorOui, staticIpSubMask=staticIpSubMask, staticIpGateway=staticIpGateway, modeEntry=modeEntry, voltage=voltage, lan1=lan1, ddminfo=ddminfo, jumbwan=jumbwan, portmode=portmode, portPower=portPower, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, lanportIndex=lanportIndex, lanportName=lanportName, jumb=jumb)
