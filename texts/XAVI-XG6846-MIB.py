...
MibIdentifier, Counter64, snmpModules, mib_2, IpAddress, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Gauge32, NotificationType, Counter32, Unsigned32, TimeTicks, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "snmpModules", "mib-2", "IpAddress", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Gauge32", "NotificationType", "Counter32", "Unsigned32", "TimeTicks", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", temperature=temperature, deviceinfo=deviceinfo, domainame=domainame, vlangroupTable=vlangroupTable, jumblan3=jumblan3, portName=portName, lanportspeed=lanportspeed, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSubMask=staticIpSubMask, vlan=vlan, dscpEnable=dscpEnable, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, reboot=reboot, port1=port1, speed=speed, staticDns=staticDns, catvEnable=catvEnable, staticIpHostName=staticIpHostName, port3=port3, jumblan2=jumblan2, portStatEntry=portStatEntry, groupid=groupid, multicastsTransmitted=multicastsTransmitted, qmapping=qmapping, groupIndex=groupIndex, vendorRev=vendorRev, txPower=txPower, priority=priority, multicastsReceived=multicastsReceived, lanportName=lanportName, ddminfo=ddminfo, modeEntry=modeEntry, jumb=jumb, wan=wan, qosIndex=qosIndex, staticIpGateway=staticIpGateway, statisticTable=statisticTable, portPower=portPower, port4=port4, lan3=lan3, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, qosTable=qosTable, groupEntry=groupEntry, catv=catv, fileName=fileName, lanportTable=lanportTable, tftp=tftp, qos=qos, voltage=voltage, port2=port2, internetPort=internetPort, staticIpSecondaryDns=staticIpSecondaryDns, lanportIndex=lanportIndex, broadcastsReceived=broadcastsReceived, lan4=lan4, rxPower=rxPower, qosEntry=qosEntry, primaryDns=primaryDns, portEntry=portEntry, lan1=lan1, vendorPn=vendorPn, vendorName=vendorName, secondaryDns=secondaryDns, operStatus=operStatus, wanType=wanType, action=action, lanportpause=lanportpause, pauseReceived=pauseReceived, hostname=hostname, serialnum=serialnum, pauseTransmitted=pauseTransmitted, qmode=qmode, xg6846=xg6846, portIndex=portIndex, staticIpAddr=staticIpAddr, jumbwan=jumbwan, staticIpDomainName=staticIpDomainName, unicastsTransmitted=unicastsTransmitted, statIndex=statIndex, vendorOui=vendorOui, fileType=fileType, portTable=portTable, unicastsReceived=unicastsReceived, rebootEnable=rebootEnable, portStatistic=portStatistic, portmode=portmode, adminStatus=adminStatus, lan2=lan2, tftpSevIp=tftpSevIp, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, jumblan1=jumblan1)
