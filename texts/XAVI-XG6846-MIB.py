...
ModuleIdentity, Counter32, TimeTicks, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, NotificationType, iso, MibIdentifier, ObjectIdentity, Gauge32, snmpModules, mib_2, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "TimeTicks", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "NotificationType", "iso", "MibIdentifier", "ObjectIdentity", "Gauge32", "snmpModules", "mib-2", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupEntry=groupEntry, priority=priority, portName=portName, jumblan3=jumblan3, lan3=lan3, dscpEnable=dscpEnable, voltage=voltage, lanportTable=lanportTable, staticIpAddr=staticIpAddr, catvEnable=catvEnable, rebootEnable=rebootEnable, qosTable=qosTable, jumb=jumb, vendorRev=vendorRev, groupid=groupid, fileName=fileName, vendorName=vendorName, ddminfo=ddminfo, multicastsReceived=multicastsReceived, staticIpGateway=staticIpGateway, qmapping=qmapping, lan2=lan2, secondaryDns=secondaryDns, adminStatus=adminStatus, jumblan2=jumblan2, hostname=hostname, port2=port2, wanType=wanType, jumbwan=jumbwan, staticDns=staticDns, operStatus=operStatus, lanportIndex=lanportIndex, portPower=portPower, broadcastsTransmitted=broadcastsTransmitted, vlan=vlan, wan=wan, temperature=temperature, multicastsTransmitted=multicastsTransmitted, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, portTable=portTable, qmode=qmode, xg6846=xg6846, qosIndex=qosIndex, tftpSevIp=tftpSevIp, qosEntry=qosEntry, vendorOui=vendorOui, rxPower=rxPower, tftp=tftp, lanportpause=lanportpause, fcsErrorReceived=fcsErrorReceived, port1=port1, portIndex=portIndex, portStatistic=portStatistic, jumblan1=jumblan1, primaryDns=primaryDns, statisticTable=statisticTable, groupIndex=groupIndex, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, serialnum=serialnum, staticIpHostName=staticIpHostName, bias=bias, broadcastsReceived=broadcastsReceived, port3=port3, fileType=fileType, vlangroupTable=vlangroupTable, speed=speed, reboot=reboot, domainame=domainame, pauseTransmitted=pauseTransmitted, action=action, txPower=txPower, staticIpSecondaryDns=staticIpSecondaryDns, lan4=lan4, lan1=lan1, lanportspeed=lanportspeed, catv=catv, vlanid=vlanid, portStatEntry=portStatEntry, jumblan4=jumblan4, unicastsReceived=unicastsReceived, staticIpDomainName=staticIpDomainName, modeEntry=modeEntry, portmode=portmode, vendorPn=vendorPn, deviceinfo=deviceinfo, statIndex=statIndex, pauseReceived=pauseReceived, qos=qos, staticIpSubMask=staticIpSubMask, portEntry=portEntry, port4=port4, unicastsTransmitted=unicastsTransmitted)
