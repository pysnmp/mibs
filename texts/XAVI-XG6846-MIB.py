...
# Produced by pysmi-1.1.8 at Thu Sep  8 09:55:53 2022
...
Unsigned32, ObjectIdentity, Gauge32, ModuleIdentity, Counter32, enterprises, Integer32, iso, TimeTicks, mib_2, snmpModules, Counter64, IpAddress, Bits, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Counter32", "enterprises", "Integer32", "iso", "TimeTicks", "mib-2", "snmpModules", "Counter64", "IpAddress", "Bits", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rebootEnable=rebootEnable, action=action, lan2=lan2, lanportpause=lanportpause, qosTable=qosTable, priority=priority, staticIpHostName=staticIpHostName, tftp=tftp, qmapping=qmapping, domainame=domainame, primaryDns=primaryDns, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, staticIpAddr=staticIpAddr, multicastsReceived=multicastsReceived, ddminfo=ddminfo, vendorOui=vendorOui, portStatistic=portStatistic, bias=bias, jumb=jumb, serialnum=serialnum, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, fileName=fileName, qos=qos, pauseReceived=pauseReceived, portPower=portPower, internetPort=internetPort, fcsErrorReceived=fcsErrorReceived, lanportIndex=lanportIndex, portmode=portmode, vlangroupTable=vlangroupTable, port4=port4, xg6846=xg6846, reboot=reboot, broadcastsReceived=broadcastsReceived, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, qosIndex=qosIndex, portEntry=portEntry, hostname=hostname, port1=port1, catv=catv, adminStatus=adminStatus, wanType=wanType, unicastsReceived=unicastsReceived, lanportTable=lanportTable, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, lan1=lan1, wan=wan, vendorPn=vendorPn, staticDns=staticDns, port3=port3, portStatEntry=portStatEntry, secondaryDns=secondaryDns, dscpEnable=dscpEnable, portTable=portTable, rxPower=rxPower, qmode=qmode, statisticTable=statisticTable, lan4=lan4, catvEnable=catvEnable, pauseTransmitted=pauseTransmitted, qosEntry=qosEntry, portName=portName, lan3=lan3, temperature=temperature, operStatus=operStatus, voltage=voltage, vlanid=vlanid, jumbwan=jumbwan, vendorRev=vendorRev, txPower=txPower, vendorName=vendorName, staticIpPrimaryDns=staticIpPrimaryDns, portIndex=portIndex, lanportName=lanportName, broadcastsTransmitted=broadcastsTransmitted, jumblan2=jumblan2, staticIpDomainName=staticIpDomainName, lanportspeed=lanportspeed, speed=speed, jumblan3=jumblan3, groupEntry=groupEntry, tftpSevIp=tftpSevIp, vlan=vlan, groupid=groupid, staticIpGateway=staticIpGateway, fileType=fileType, deviceinfo=deviceinfo, statIndex=statIndex, port2=port2, jumblan4=jumblan4)
