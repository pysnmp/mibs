...
TimeTicks, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Counter64, snmpModules, Unsigned32, ObjectIdentity, MibIdentifier, Gauge32, mib_2, NotificationType, Integer32, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Counter64", "snmpModules", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Gauge32", "mib-2", "NotificationType", "Integer32", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsTransmitted=multicastsTransmitted, groupIndex=groupIndex, groupEntry=groupEntry, speed=speed, jumblan4=jumblan4, statisticTable=statisticTable, catv=catv, portPower=portPower, jumblan1=jumblan1, lanportspeed=lanportspeed, jumbwan=jumbwan, multicastsReceived=multicastsReceived, lanportTable=lanportTable, internetPort=internetPort, portIndex=portIndex, vendorRev=vendorRev, qosEntry=qosEntry, lan2=lan2, vendorName=vendorName, hostname=hostname, vlangroupTable=vlangroupTable, qos=qos, groupid=groupid, portTable=portTable, pauseReceived=pauseReceived, lan4=lan4, tftp=tftp, staticIpSubMask=staticIpSubMask, staticIpHostName=staticIpHostName, qosTable=qosTable, port2=port2, wanType=wanType, modeEntry=modeEntry, vendorPn=vendorPn, reboot=reboot, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, lan3=lan3, catvEnable=catvEnable, qmapping=qmapping, staticIpSecondaryDns=staticIpSecondaryDns, xg6846=xg6846, jumblan3=jumblan3, portmode=portmode, bias=bias, qmode=qmode, domainame=domainame, fcsErrorTransmitted=fcsErrorTransmitted, port1=port1, port3=port3, staticIpPrimaryDns=staticIpPrimaryDns, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, rebootEnable=rebootEnable, vlan=vlan, adminStatus=adminStatus, serialnum=serialnum, jumb=jumb, portEntry=portEntry, port4=port4, portStatistic=portStatistic, portStatEntry=portStatEntry, ddminfo=ddminfo, voltage=voltage, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived, txPower=txPower, primaryDns=primaryDns, fileType=fileType, staticIpAddr=staticIpAddr, action=action, operStatus=operStatus, rxPower=rxPower, qosIndex=qosIndex, lanportName=lanportName, vlanid=vlanid, staticDns=staticDns, temperature=temperature, dscpEnable=dscpEnable, wan=wan, staticIpGateway=staticIpGateway, statIndex=statIndex, vendorOui=vendorOui, lanportIndex=lanportIndex, jumblan2=jumblan2, lan1=lan1, fcsErrorReceived=fcsErrorReceived, tftpSevIp=tftpSevIp, broadcastsTransmitted=broadcastsTransmitted, priority=priority, staticIpDomainName=staticIpDomainName, lanportpause=lanportpause, portName=portName, fileName=fileName)
