...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:21:45 2022
...
Unsigned32, iso, Gauge32, Counter32, Integer32, Counter64, MibIdentifier, ModuleIdentity, TimeTicks, Bits, mib_2, IpAddress, snmpModules, enterprises, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Gauge32", "Counter32", "Integer32", "Counter64", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Bits", "mib-2", "IpAddress", "snmpModules", "enterprises", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", adminStatus=adminStatus, vlangroupTable=vlangroupTable, xg6846=xg6846, qmapping=qmapping, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, qos=qos, jumbwan=jumbwan, speed=speed, ddminfo=ddminfo, port3=port3, deviceinfo=deviceinfo, voltage=voltage, vendorPn=vendorPn, staticIpHostName=staticIpHostName, staticIpGateway=staticIpGateway, portEntry=portEntry, wanType=wanType, statIndex=statIndex, operStatus=operStatus, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, hostname=hostname, primaryDns=primaryDns, staticIpDomainName=staticIpDomainName, portTable=portTable, pauseReceived=pauseReceived, jumblan3=jumblan3, groupid=groupid, catv=catv, portPower=portPower, unicastsReceived=unicastsReceived, broadcastsReceived=broadcastsReceived, portName=portName, statisticTable=statisticTable, staticDns=staticDns, lan4=lan4, jumblan1=jumblan1, staticIpSecondaryDns=staticIpSecondaryDns, temperature=temperature, qosTable=qosTable, serialnum=serialnum, vlan=vlan, qosEntry=qosEntry, pauseTransmitted=pauseTransmitted, qosIndex=qosIndex, staticIpPrimaryDns=staticIpPrimaryDns, multicastsTransmitted=multicastsTransmitted, priority=priority, fcsErrorReceived=fcsErrorReceived, lanportName=lanportName, groupIndex=groupIndex, groupEntry=groupEntry, portmode=portmode, reboot=reboot, port1=port1, staticIpSubMask=staticIpSubMask, wan=wan, rxPower=rxPower, txPower=txPower, fileType=fileType, lan3=lan3, port2=port2, modeEntry=modeEntry, rebootEnable=rebootEnable, jumb=jumb, portStatistic=portStatistic, tftp=tftp, fcsErrorTransmitted=fcsErrorTransmitted, jumblan4=jumblan4, vendorName=vendorName, dscpEnable=dscpEnable, internetPort=internetPort, secondaryDns=secondaryDns, vlanid=vlanid, portStatEntry=portStatEntry, staticIpAddr=staticIpAddr, lanportTable=lanportTable, domainame=domainame, qmode=qmode, multicastsReceived=multicastsReceived, tftpSevIp=tftpSevIp, lan1=lan1, action=action, lanportpause=lanportpause, portIndex=portIndex, vendorRev=vendorRev, port4=port4, lanportspeed=lanportspeed, bias=bias, jumblan2=jumblan2, lanportIndex=lanportIndex, catvEnable=catvEnable)
