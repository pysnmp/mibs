...
# Produced by pysmi-1.1.3 at Sun Nov 28 21:18:41 2021
...
ModuleIdentity, NotificationType, enterprises, iso, Counter64, TimeTicks, Counter32, Gauge32, Unsigned32, Bits, snmpModules, mib_2, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "enterprises", "iso", "Counter64", "TimeTicks", "Counter32", "Gauge32", "Unsigned32", "Bits", "snmpModules", "mib-2", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, internetPort=internetPort, groupIndex=groupIndex, action=action, lanportIndex=lanportIndex, fcsErrorTransmitted=fcsErrorTransmitted, lan4=lan4, tftp=tftp, pauseReceived=pauseReceived, speed=speed, qmapping=qmapping, voltage=voltage, lan3=lan3, portPower=portPower, unicastsReceived=unicastsReceived, domainame=domainame, fcsErrorReceived=fcsErrorReceived, bias=bias, statIndex=statIndex, jumblan1=jumblan1, qmode=qmode, priority=priority, temperature=temperature, port3=port3, adminStatus=adminStatus, txPower=txPower, port1=port1, qosIndex=qosIndex, port2=port2, modeEntry=modeEntry, fileName=fileName, reboot=reboot, deviceinfo=deviceinfo, rxPower=rxPower, wanType=wanType, hostname=hostname, staticIpSubMask=staticIpSubMask, vendorRev=vendorRev, vendorOui=vendorOui, secondaryDns=secondaryDns, fileType=fileType, lanportName=lanportName, staticIpHostName=staticIpHostName, portName=portName, qosTable=qosTable, staticIpPrimaryDns=staticIpPrimaryDns, jumblan4=jumblan4, portStatistic=portStatistic, lan2=lan2, lanportpause=lanportpause, jumblan2=jumblan2, multicastsReceived=multicastsReceived, staticIpDomainName=staticIpDomainName, vlan=vlan, groupEntry=groupEntry, xg6846=xg6846, lanportTable=lanportTable, staticIpGateway=staticIpGateway, vendorPn=vendorPn, vlanid=vlanid, portStatEntry=portStatEntry, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, broadcastsReceived=broadcastsReceived, vlangroupTable=vlangroupTable, staticDns=staticDns, staticIpAddr=staticIpAddr, unicastsTransmitted=unicastsTransmitted, port4=port4, portmode=portmode, dscpEnable=dscpEnable, statisticTable=statisticTable, catvEnable=catvEnable, ddminfo=ddminfo, jumb=jumb, tftpSevIp=tftpSevIp, jumbwan=jumbwan, portEntry=portEntry, qos=qos, groupid=groupid, vendorName=vendorName, wan=wan, jumblan3=jumblan3, qosEntry=qosEntry, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, pauseTransmitted=pauseTransmitted, rebootEnable=rebootEnable, operStatus=operStatus, staticIpSecondaryDns=staticIpSecondaryDns, lan1=lan1, serialnum=serialnum, portTable=portTable, lanportspeed=lanportspeed)
