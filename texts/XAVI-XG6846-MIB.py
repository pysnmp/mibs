...
# Produced by pysmi-1.1.3 at Tue Dec  7 13:59:20 2021
...
snmpModules, ObjectIdentity, Unsigned32, Bits, enterprises, Counter64, NotificationType, mib_2, Counter32, IpAddress, Gauge32, MibIdentifier, Integer32, iso, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "ObjectIdentity", "Unsigned32", "Bits", "enterprises", "Counter64", "NotificationType", "mib-2", "Counter32", "IpAddress", "Gauge32", "MibIdentifier", "Integer32", "iso", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlan=vlan, deviceinfo=deviceinfo, bias=bias, reboot=reboot, lanportName=lanportName, operStatus=operStatus, groupIndex=groupIndex, groupEntry=groupEntry, portStatEntry=portStatEntry, lanportpause=lanportpause, vendorRev=vendorRev, fileName=fileName, catv=catv, vlanid=vlanid, qosIndex=qosIndex, tftp=tftp, tftpSevIp=tftpSevIp, qmode=qmode, wan=wan, lan1=lan1, vendorName=vendorName, portName=portName, pauseTransmitted=pauseTransmitted, priority=priority, staticIpSubMask=staticIpSubMask, txPower=txPower, port3=port3, portTable=portTable, modeEntry=modeEntry, vlangroupTable=vlangroupTable, groupid=groupid, fileType=fileType, fcsErrorTransmitted=fcsErrorTransmitted, catvEnable=catvEnable, lanportspeed=lanportspeed, port2=port2, staticIpHostName=staticIpHostName, rebootEnable=rebootEnable, jumb=jumb, multicastsReceived=multicastsReceived, lan3=lan3, lanportIndex=lanportIndex, rxPower=rxPower, serialnum=serialnum, jumblan2=jumblan2, qosEntry=qosEntry, voltage=voltage, staticIpSecondaryDns=staticIpSecondaryDns, jumblan4=jumblan4, qos=qos, statisticTable=statisticTable, port1=port1, lanportTable=lanportTable, adminStatus=adminStatus, pauseReceived=pauseReceived, jumblan1=jumblan1, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, domainame=domainame, portmode=portmode, speed=speed, ddminfo=ddminfo, unicastsTransmitted=unicastsTransmitted, statIndex=statIndex, wanType=wanType, secondaryDns=secondaryDns, vendorPn=vendorPn, action=action, portStatistic=portStatistic, lan4=lan4, internetPort=internetPort, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, jumblan3=jumblan3, lan2=lan2, dscpEnable=dscpEnable, fcsErrorReceived=fcsErrorReceived, staticIpPrimaryDns=staticIpPrimaryDns, staticDns=staticDns, hostname=hostname, port4=port4, qosTable=qosTable, jumbwan=jumbwan, portIndex=portIndex, vendorOui=vendorOui, staticIpGateway=staticIpGateway, staticIpAddr=staticIpAddr, portEntry=portEntry, temperature=temperature, unicastsReceived=unicastsReceived, portPower=portPower, qmapping=qmapping, staticIpDomainName=staticIpDomainName, broadcastsReceived=broadcastsReceived)
