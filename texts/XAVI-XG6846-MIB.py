...
Integer32, IpAddress, Gauge32, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, mib_2, iso, Bits, NotificationType, Counter64, ObjectIdentity, MibIdentifier, ModuleIdentity, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Gauge32", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "mib-2", "iso", "Bits", "NotificationType", "Counter64", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan3=lan3, qosIndex=qosIndex, statisticTable=statisticTable, unicastsReceived=unicastsReceived, jumblan4=jumblan4, port2=port2, vlan=vlan, voltage=voltage, bias=bias, qosEntry=qosEntry, lan2=lan2, action=action, internetPort=internetPort, fileType=fileType, pauseTransmitted=pauseTransmitted, speed=speed, operStatus=operStatus, fcsErrorReceived=fcsErrorReceived, portEntry=portEntry, temperature=temperature, groupid=groupid, multicastsTransmitted=multicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, wanType=wanType, tftp=tftp, vendorOui=vendorOui, portStatistic=portStatistic, modeEntry=modeEntry, catvEnable=catvEnable, portStatEntry=portStatEntry, broadcastsTransmitted=broadcastsTransmitted, vendorRev=vendorRev, qos=qos, qmode=qmode, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, wan=wan, hostname=hostname, portmode=portmode, vendorName=vendorName, secondaryDns=secondaryDns, dscpEnable=dscpEnable, jumblan1=jumblan1, rxPower=rxPower, lan4=lan4, adminStatus=adminStatus, primaryDns=primaryDns, staticIpGateway=staticIpGateway, lanportTable=lanportTable, lan1=lan1, lanportspeed=lanportspeed, groupEntry=groupEntry, staticIpPrimaryDns=staticIpPrimaryDns, groupIndex=groupIndex, lanportName=lanportName, broadcastsReceived=broadcastsReceived, vlangroupTable=vlangroupTable, reboot=reboot, deviceinfo=deviceinfo, xg6846=xg6846, tftpSevIp=tftpSevIp, qmapping=qmapping, portName=portName, fileName=fileName, jumbwan=jumbwan, vendorPn=vendorPn, portTable=portTable, fcsErrorTransmitted=fcsErrorTransmitted, lanportIndex=lanportIndex, port4=port4, staticDns=staticDns, ddminfo=ddminfo, jumblan2=jumblan2, jumb=jumb, serialnum=serialnum, domainame=domainame, statIndex=statIndex, catv=catv, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, pauseReceived=pauseReceived, unicastsTransmitted=unicastsTransmitted, txPower=txPower, portIndex=portIndex, priority=priority, port1=port1, lanportpause=lanportpause, vlanid=vlanid, portPower=portPower, staticIpSubMask=staticIpSubMask, port3=port3, qosTable=qosTable, jumblan3=jumblan3, multicastsReceived=multicastsReceived)
