...
NotificationType, enterprises, Gauge32, MibIdentifier, snmpModules, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, IpAddress, mib_2, Integer32, iso, Unsigned32, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "Gauge32", "MibIdentifier", "snmpModules", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "IpAddress", "mib-2", "Integer32", "iso", "Unsigned32", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorName=vendorName, ddminfo=ddminfo, statIndex=statIndex, portName=portName, portPower=portPower, lan1=lan1, rxPower=rxPower, broadcastsTransmitted=broadcastsTransmitted, jumblan4=jumblan4, portStatistic=portStatistic, staticIpDomainName=staticIpDomainName, qmode=qmode, reboot=reboot, staticIpSubMask=staticIpSubMask, broadcastsReceived=broadcastsReceived, modeEntry=modeEntry, groupIndex=groupIndex, catvEnable=catvEnable, qos=qos, unicastsReceived=unicastsReceived, vlanid=vlanid, portEntry=portEntry, rebootEnable=rebootEnable, primaryDns=primaryDns, port4=port4, hostname=hostname, priority=priority, multicastsReceived=multicastsReceived, wan=wan, staticIpPrimaryDns=staticIpPrimaryDns, voltage=voltage, qosEntry=qosEntry, vendorRev=vendorRev, lanportspeed=lanportspeed, qmapping=qmapping, lanportIndex=lanportIndex, vendorOui=vendorOui, port2=port2, jumblan3=jumblan3, staticDns=staticDns, portmode=portmode, staticIpGateway=staticIpGateway, portStatEntry=portStatEntry, jumblan2=jumblan2, lan4=lan4, speed=speed, txPower=txPower, fileType=fileType, domainame=domainame, vlan=vlan, internetPort=internetPort, dscpEnable=dscpEnable, serialnum=serialnum, groupid=groupid, lan2=lan2, temperature=temperature, pauseReceived=pauseReceived, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, vlangroupTable=vlangroupTable, tftpSevIp=tftpSevIp, staticIpAddr=staticIpAddr, deviceinfo=deviceinfo, adminStatus=adminStatus, portTable=portTable, lanportpause=lanportpause, jumbwan=jumbwan, lan3=lan3, portIndex=portIndex, pauseTransmitted=pauseTransmitted, jumblan1=jumblan1, jumb=jumb, vendorPn=vendorPn, port1=port1, catv=catv, action=action, port3=port3, operStatus=operStatus, groupEntry=groupEntry, fcsErrorTransmitted=fcsErrorTransmitted, wanType=wanType, statisticTable=statisticTable, lanportName=lanportName, staticIpHostName=staticIpHostName, staticIpSecondaryDns=staticIpSecondaryDns, qosTable=qosTable, tftp=tftp, bias=bias, qosIndex=qosIndex, lanportTable=lanportTable, secondaryDns=secondaryDns, fcsErrorReceived=fcsErrorReceived, fileName=fileName, xg6846=xg6846)
