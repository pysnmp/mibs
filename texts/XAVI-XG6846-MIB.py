...
# Produced by pysmi-1.1.8 at Sat Jan 15 17:27:20 2022
...
snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Counter64, enterprises, Counter32, MibIdentifier, ModuleIdentity, iso, NotificationType, TimeTicks, mib_2, ObjectIdentity, Unsigned32, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Counter64", "enterprises", "Counter32", "MibIdentifier", "ModuleIdentity", "iso", "NotificationType", "TimeTicks", "mib-2", "ObjectIdentity", "Unsigned32", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", priority=priority, broadcastsReceived=broadcastsReceived, vlangroupTable=vlangroupTable, pauseTransmitted=pauseTransmitted, vendorRev=vendorRev, vlan=vlan, temperature=temperature, primaryDns=primaryDns, portStatEntry=portStatEntry, lanportIndex=lanportIndex, port4=port4, statIndex=statIndex, jumb=jumb, staticIpDomainName=staticIpDomainName, jumblan4=jumblan4, fileName=fileName, groupEntry=groupEntry, qosIndex=qosIndex, pauseReceived=pauseReceived, reboot=reboot, groupIndex=groupIndex, catv=catv, lan2=lan2, jumblan2=jumblan2, voltage=voltage, vlanid=vlanid, operStatus=operStatus, deviceinfo=deviceinfo, rxPower=rxPower, unicastsReceived=unicastsReceived, qmode=qmode, serialnum=serialnum, statisticTable=statisticTable, lan3=lan3, xg6846=xg6846, fileType=fileType, portTable=portTable, secondaryDns=secondaryDns, portEntry=portEntry, jumblan1=jumblan1, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, jumblan3=jumblan3, domainame=domainame, vendorOui=vendorOui, port2=port2, portName=portName, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, portmode=portmode, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, modeEntry=modeEntry, txPower=txPower, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, groupid=groupid, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, staticIpHostName=staticIpHostName, portStatistic=portStatistic, lan1=lan1, broadcastsTransmitted=broadcastsTransmitted, lanportTable=lanportTable, tftp=tftp, port1=port1, catvEnable=catvEnable, port3=port3, multicastsTransmitted=multicastsTransmitted, qos=qos, lanportspeed=lanportspeed, vendorName=vendorName, portIndex=portIndex, multicastsReceived=multicastsReceived, vendorPn=vendorPn, qosTable=qosTable, dscpEnable=dscpEnable, action=action, wan=wan, qmapping=qmapping, bias=bias, lan4=lan4, lanportName=lanportName, wanType=wanType, lanportpause=lanportpause, staticDns=staticDns, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, adminStatus=adminStatus, tftpSevIp=tftpSevIp, portPower=portPower, rebootEnable=rebootEnable, qosEntry=qosEntry, hostname=hostname)
