...
# Produced by pysmi-1.1.8 at Fri Jan 13 14:34:04 2023
...
iso, TimeTicks, ObjectIdentity, IpAddress, Unsigned32, ModuleIdentity, Counter32, NotificationType, Integer32, snmpModules, Bits, mib_2, Counter64, enterprises, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "ObjectIdentity", "IpAddress", "Unsigned32", "ModuleIdentity", "Counter32", "NotificationType", "Integer32", "snmpModules", "Bits", "mib-2", "Counter64", "enterprises", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", domainame=domainame, serialnum=serialnum, tftp=tftp, deviceinfo=deviceinfo, catvEnable=catvEnable, staticIpSubMask=staticIpSubMask, lan3=lan3, groupIndex=groupIndex, fcsErrorReceived=fcsErrorReceived, portPower=portPower, lanportIndex=lanportIndex, qosEntry=qosEntry, groupEntry=groupEntry, portIndex=portIndex, lan1=lan1, multicastsReceived=multicastsReceived, fileName=fileName, jumbwan=jumbwan, staticDns=staticDns, jumblan4=jumblan4, portStatEntry=portStatEntry, tftpSevIp=tftpSevIp, pauseReceived=pauseReceived, qosTable=qosTable, staticIpPrimaryDns=staticIpPrimaryDns, temperature=temperature, vendorName=vendorName, qmapping=qmapping, reboot=reboot, vendorOui=vendorOui, lanportTable=lanportTable, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, portName=portName, port2=port2, portmode=portmode, staticIpSecondaryDns=staticIpSecondaryDns, port3=port3, qos=qos, xg6846=xg6846, voltage=voltage, operStatus=operStatus, ddminfo=ddminfo, secondaryDns=secondaryDns, statIndex=statIndex, fileType=fileType, dscpEnable=dscpEnable, broadcastsReceived=broadcastsReceived, rebootEnable=rebootEnable, staticIpHostName=staticIpHostName, vendorRev=vendorRev, qmode=qmode, statisticTable=statisticTable, fcsErrorTransmitted=fcsErrorTransmitted, vlan=vlan, port4=port4, hostname=hostname, jumblan3=jumblan3, modeEntry=modeEntry, portStatistic=portStatistic, internetPort=internetPort, qosIndex=qosIndex, unicastsReceived=unicastsReceived, staticIpDomainName=staticIpDomainName, jumblan2=jumblan2, action=action, rxPower=rxPower, lanportName=lanportName, staticIpGateway=staticIpGateway, lan4=lan4, portTable=portTable, wan=wan, port1=port1, lan2=lan2, lanportpause=lanportpause, groupid=groupid, vlanid=vlanid, speed=speed, jumblan1=jumblan1, broadcastsTransmitted=broadcastsTransmitted, priority=priority, staticIpAddr=staticIpAddr, portEntry=portEntry, txPower=txPower, lanportspeed=lanportspeed, jumb=jumb, primaryDns=primaryDns, catv=catv, unicastsTransmitted=unicastsTransmitted, vendorPn=vendorPn, wanType=wanType, adminStatus=adminStatus, bias=bias, pauseTransmitted=pauseTransmitted)
