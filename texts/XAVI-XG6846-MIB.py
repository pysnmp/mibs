...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Unsigned32, mib_2, snmpModules, ModuleIdentity, Counter32, enterprises, iso, Counter64, IpAddress, Gauge32, TimeTicks, NotificationType, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Unsigned32", "mib-2", "snmpModules", "ModuleIdentity", "Counter32", "enterprises", "iso", "Counter64", "IpAddress", "Gauge32", "TimeTicks", "NotificationType", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", ddminfo=ddminfo, portTable=portTable, jumblan1=jumblan1, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, jumblan3=jumblan3, catvEnable=catvEnable, serialnum=serialnum, jumbwan=jumbwan, jumb=jumb, deviceinfo=deviceinfo, multicastsTransmitted=multicastsTransmitted, vlanid=vlanid, fcsErrorReceived=fcsErrorReceived, vendorOui=vendorOui, voltage=voltage, primaryDns=primaryDns, secondaryDns=secondaryDns, action=action, pauseReceived=pauseReceived, bias=bias, vlan=vlan, staticIpSecondaryDns=staticIpSecondaryDns, internetPort=internetPort, portEntry=portEntry, txPower=txPower, xg6846=xg6846, multicastsReceived=multicastsReceived, portStatEntry=portStatEntry, operStatus=operStatus, qmode=qmode, hostname=hostname, statIndex=statIndex, portIndex=portIndex, catv=catv, portStatistic=portStatistic, groupIndex=groupIndex, lan4=lan4, modeEntry=modeEntry, tftp=tftp, lanportspeed=lanportspeed, jumblan2=jumblan2, broadcastsReceived=broadcastsReceived, tftpSevIp=tftpSevIp, qosTable=qosTable, vendorRev=vendorRev, adminStatus=adminStatus, statisticTable=statisticTable, lan3=lan3, lan2=lan2, speed=speed, lanportpause=lanportpause, groupEntry=groupEntry, rebootEnable=rebootEnable, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, port2=port2, portmode=portmode, fileType=fileType, reboot=reboot, port3=port3, lan1=lan1, fileName=fileName, unicastsReceived=unicastsReceived, jumblan4=jumblan4, dscpEnable=dscpEnable, wan=wan, qosEntry=qosEntry, staticDns=staticDns, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, lanportTable=lanportTable, priority=priority, qosIndex=qosIndex, staticIpHostName=staticIpHostName, port4=port4, portName=portName, rxPower=rxPower, qos=qos, unicastsTransmitted=unicastsTransmitted, portPower=portPower, vendorPn=vendorPn, staticIpAddr=staticIpAddr, staticIpDomainName=staticIpDomainName, broadcastsTransmitted=broadcastsTransmitted, port1=port1, lanportIndex=lanportIndex, domainame=domainame, qmapping=qmapping, lanportName=lanportName, vendorName=vendorName, staticIpGateway=staticIpGateway, temperature=temperature, wanType=wanType)
