...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:35:03 2024
...
enterprises, Counter32, MibIdentifier, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Counter64, Integer32, Gauge32, ObjectIdentity, ModuleIdentity, mib_2, Bits, snmpModules, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "MibIdentifier", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Counter64", "Integer32", "Gauge32", "ObjectIdentity", "ModuleIdentity", "mib-2", "Bits", "snmpModules", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portmode=portmode, qosTable=qosTable, jumblan1=jumblan1, fcsErrorReceived=fcsErrorReceived, vlangroupTable=vlangroupTable, jumblan4=jumblan4, portTable=portTable, temperature=temperature, broadcastsTransmitted=broadcastsTransmitted, qmode=qmode, bias=bias, adminStatus=adminStatus, vendorName=vendorName, lan4=lan4, jumb=jumb, rebootEnable=rebootEnable, portPower=portPower, pauseTransmitted=pauseTransmitted, qosIndex=qosIndex, priority=priority, staticDns=staticDns, wan=wan, jumblan3=jumblan3, speed=speed, unicastsTransmitted=unicastsTransmitted, tftpSevIp=tftpSevIp, voltage=voltage, lanportspeed=lanportspeed, modeEntry=modeEntry, staticIpGateway=staticIpGateway, qmapping=qmapping, reboot=reboot, vendorRev=vendorRev, vlan=vlan, qosEntry=qosEntry, wanType=wanType, statisticTable=statisticTable, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, lanportIndex=lanportIndex, vlanid=vlanid, staticIpAddr=staticIpAddr, catvEnable=catvEnable, serialnum=serialnum, rxPower=rxPower, unicastsReceived=unicastsReceived, qos=qos, jumbwan=jumbwan, catv=catv, staticIpSecondaryDns=staticIpSecondaryDns, deviceinfo=deviceinfo, multicastsReceived=multicastsReceived, action=action, portStatistic=portStatistic, vendorOui=vendorOui, ddminfo=ddminfo, portEntry=portEntry, tftp=tftp, lan3=lan3, lan2=lan2, vendorPn=vendorPn, groupEntry=groupEntry, internetPort=internetPort, domainame=domainame, fileName=fileName, secondaryDns=secondaryDns, portIndex=portIndex, staticIpDomainName=staticIpDomainName, lanportName=lanportName, dscpEnable=dscpEnable, operStatus=operStatus, staticIpPrimaryDns=staticIpPrimaryDns, fileType=fileType, port2=port2, staticIpSubMask=staticIpSubMask, txPower=txPower, groupid=groupid, portStatEntry=portStatEntry, port4=port4, groupIndex=groupIndex, statIndex=statIndex, multicastsTransmitted=multicastsTransmitted, port1=port1, jumblan2=jumblan2, fcsErrorTransmitted=fcsErrorTransmitted, xg6846=xg6846, lanportpause=lanportpause, pauseReceived=pauseReceived, portName=portName, lan1=lan1, staticIpHostName=staticIpHostName, hostname=hostname, lanportTable=lanportTable, port3=port3)
