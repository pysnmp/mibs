...
Gauge32, enterprises, Unsigned32, Counter32, NotificationType, Integer32, snmpModules, mib_2, Bits, ObjectIdentity, MibIdentifier, TimeTicks, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "Unsigned32", "Counter32", "NotificationType", "Integer32", "snmpModules", "mib-2", "Bits", "ObjectIdentity", "MibIdentifier", "TimeTicks", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", primaryDns=primaryDns, port4=port4, fcsErrorReceived=fcsErrorReceived, vlangroupTable=vlangroupTable, priority=priority, jumblan2=jumblan2, qosIndex=qosIndex, lan4=lan4, adminStatus=adminStatus, domainame=domainame, staticIpPrimaryDns=staticIpPrimaryDns, bias=bias, staticIpHostName=staticIpHostName, broadcastsTransmitted=broadcastsTransmitted, lanportpause=lanportpause, modeEntry=modeEntry, pauseReceived=pauseReceived, deviceinfo=deviceinfo, lanportIndex=lanportIndex, txPower=txPower, catv=catv, portmode=portmode, staticIpAddr=staticIpAddr, vendorOui=vendorOui, qos=qos, vendorRev=vendorRev, port2=port2, wanType=wanType, jumbwan=jumbwan, rxPower=rxPower, secondaryDns=secondaryDns, jumblan4=jumblan4, tftpSevIp=tftpSevIp, portName=portName, serialnum=serialnum, fileType=fileType, action=action, staticIpSubMask=staticIpSubMask, qmapping=qmapping, jumblan3=jumblan3, port1=port1, xg6846=xg6846, staticDns=staticDns, staticIpDomainName=staticIpDomainName, staticIpSecondaryDns=staticIpSecondaryDns, portPower=portPower, portTable=portTable, lanportTable=lanportTable, vendorPn=vendorPn, qmode=qmode, lanportspeed=lanportspeed, vlanid=vlanid, operStatus=operStatus, port3=port3, unicastsReceived=unicastsReceived, fileName=fileName, qosTable=qosTable, portIndex=portIndex, multicastsReceived=multicastsReceived, statisticTable=statisticTable, lan3=lan3, multicastsTransmitted=multicastsTransmitted, jumb=jumb, lanportName=lanportName, lan2=lan2, wan=wan, temperature=temperature, pauseTransmitted=pauseTransmitted, hostname=hostname, vlan=vlan, rebootEnable=rebootEnable, catvEnable=catvEnable, lan1=lan1, statIndex=statIndex, ddminfo=ddminfo, groupIndex=groupIndex, groupEntry=groupEntry, tftp=tftp, broadcastsReceived=broadcastsReceived, internetPort=internetPort, staticIpGateway=staticIpGateway, qosEntry=qosEntry, voltage=voltage, groupid=groupid, unicastsTransmitted=unicastsTransmitted, portStatistic=portStatistic, dscpEnable=dscpEnable, reboot=reboot, jumblan1=jumblan1, speed=speed, fcsErrorTransmitted=fcsErrorTransmitted, portEntry=portEntry, portStatEntry=portStatEntry, vendorName=vendorName)
