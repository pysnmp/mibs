...
# Produced by pysmi-1.1.8 at Thu Sep  7 09:19:55 2023
...
NotificationType, enterprises, Counter64, Unsigned32, TimeTicks, IpAddress, MibIdentifier, Integer32, Counter32, Gauge32, iso, ModuleIdentity, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "Counter64", "Unsigned32", "TimeTicks", "IpAddress", "MibIdentifier", "Integer32", "Counter32", "Gauge32", "iso", "ModuleIdentity", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan2=lan2, deviceinfo=deviceinfo, dscpEnable=dscpEnable, unicastsTransmitted=unicastsTransmitted, portIndex=portIndex, ddminfo=ddminfo, jumblan3=jumblan3, vendorName=vendorName, pauseTransmitted=pauseTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, reboot=reboot, jumbwan=jumbwan, jumblan2=jumblan2, lan1=lan1, staticIpDomainName=staticIpDomainName, multicastsReceived=multicastsReceived, lanportspeed=lanportspeed, port4=port4, staticIpSubMask=staticIpSubMask, multicastsTransmitted=multicastsTransmitted, qosIndex=qosIndex, tftpSevIp=tftpSevIp, priority=priority, portStatistic=portStatistic, portPower=portPower, portEntry=portEntry, portName=portName, groupIndex=groupIndex, rebootEnable=rebootEnable, groupEntry=groupEntry, txPower=txPower, adminStatus=adminStatus, staticIpAddr=staticIpAddr, rxPower=rxPower, lanportIndex=lanportIndex, staticIpHostName=staticIpHostName, vendorOui=vendorOui, serialnum=serialnum, xg6846=xg6846, wan=wan, operStatus=operStatus, qosEntry=qosEntry, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, domainame=domainame, portStatEntry=portStatEntry, vlan=vlan, port2=port2, port1=port1, vlanid=vlanid, lan3=lan3, internetPort=internetPort, lanportTable=lanportTable, primaryDns=primaryDns, vlangroupTable=vlangroupTable, voltage=voltage, bias=bias, wanType=wanType, qosTable=qosTable, catv=catv, jumblan4=jumblan4, action=action, staticIpGateway=staticIpGateway, port3=port3, staticIpPrimaryDns=staticIpPrimaryDns, portTable=portTable, jumb=jumb, speed=speed, vendorPn=vendorPn, vendorRev=vendorRev, lanportpause=lanportpause, pauseReceived=pauseReceived, qmapping=qmapping, secondaryDns=secondaryDns, staticDns=staticDns, temperature=temperature, modeEntry=modeEntry, qmode=qmode, staticIpSecondaryDns=staticIpSecondaryDns, fileType=fileType, lanportName=lanportName, broadcastsReceived=broadcastsReceived, portmode=portmode, qos=qos, catvEnable=catvEnable, fcsErrorReceived=fcsErrorReceived, hostname=hostname, unicastsReceived=unicastsReceived, fileName=fileName, statisticTable=statisticTable, lan4=lan4, jumblan1=jumblan1, tftp=tftp, statIndex=statIndex)
