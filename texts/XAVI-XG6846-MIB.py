...
iso, MibIdentifier, mib_2, Bits, IpAddress, TimeTicks, NotificationType, Counter32, ObjectIdentity, snmpModules, Counter64, Gauge32, ModuleIdentity, enterprises, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "mib-2", "Bits", "IpAddress", "TimeTicks", "NotificationType", "Counter32", "ObjectIdentity", "snmpModules", "Counter64", "Gauge32", "ModuleIdentity", "enterprises", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", internetPort=internetPort, vlanid=vlanid, rebootEnable=rebootEnable, staticDns=staticDns, portTable=portTable, jumblan3=jumblan3, vendorName=vendorName, lanportspeed=lanportspeed, fcsErrorReceived=fcsErrorReceived, tftpSevIp=tftpSevIp, jumblan2=jumblan2, bias=bias, fcsErrorTransmitted=fcsErrorTransmitted, groupid=groupid, staticIpGateway=staticIpGateway, speed=speed, fileName=fileName, portIndex=portIndex, temperature=temperature, priority=priority, unicastsTransmitted=unicastsTransmitted, pauseReceived=pauseReceived, voltage=voltage, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, vlan=vlan, deviceinfo=deviceinfo, port3=port3, catvEnable=catvEnable, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum, jumb=jumb, port1=port1, wanType=wanType, vendorPn=vendorPn, lan4=lan4, staticIpAddr=staticIpAddr, txPower=txPower, portStatistic=portStatistic, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, xg6846=xg6846, staticIpPrimaryDns=staticIpPrimaryDns, multicastsReceived=multicastsReceived, qosIndex=qosIndex, jumbwan=jumbwan, portStatEntry=portStatEntry, portName=portName, lanportIndex=lanportIndex, statIndex=statIndex, primaryDns=primaryDns, qmode=qmode, vlangroupTable=vlangroupTable, jumblan4=jumblan4, secondaryDns=secondaryDns, staticIpSecondaryDns=staticIpSecondaryDns, staticIpHostName=staticIpHostName, vendorOui=vendorOui, portmode=portmode, port2=port2, groupEntry=groupEntry, qosTable=qosTable, portEntry=portEntry, rxPower=rxPower, adminStatus=adminStatus, staticIpDomainName=staticIpDomainName, lan1=lan1, fileType=fileType, vendorRev=vendorRev, qosEntry=qosEntry, groupIndex=groupIndex, catv=catv, reboot=reboot, qmapping=qmapping, lanportpause=lanportpause, multicastsTransmitted=multicastsTransmitted, operStatus=operStatus, statisticTable=statisticTable, unicastsReceived=unicastsReceived, wan=wan, modeEntry=modeEntry, dscpEnable=dscpEnable, hostname=hostname, lan3=lan3, ddminfo=ddminfo, portPower=portPower, action=action, jumblan1=jumblan1, tftp=tftp, domainame=domainame, lanportName=lanportName, lan2=lan2, port4=port4, qos=qos)
