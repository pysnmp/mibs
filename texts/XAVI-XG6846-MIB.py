...
Bits, mib_2, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Gauge32, MibIdentifier, Unsigned32, ModuleIdentity, Integer32, NotificationType, snmpModules, enterprises, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "mib-2", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Gauge32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "Integer32", "NotificationType", "snmpModules", "enterprises", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileName=fileName, qos=qos, groupIndex=groupIndex, fileType=fileType, dscpEnable=dscpEnable, port1=port1, portName=portName, fcsErrorTransmitted=fcsErrorTransmitted, staticDns=staticDns, staticIpGateway=staticIpGateway, reboot=reboot, voltage=voltage, portPower=portPower, vendorPn=vendorPn, port4=port4, lan3=lan3, speed=speed, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, catv=catv, vendorName=vendorName, hostname=hostname, modeEntry=modeEntry, lan4=lan4, action=action, qosEntry=qosEntry, operStatus=operStatus, lanportIndex=lanportIndex, portStatEntry=portStatEntry, vlan=vlan, tftp=tftp, domainame=domainame, serialnum=serialnum, txPower=txPower, jumblan4=jumblan4, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, groupEntry=groupEntry, jumblan1=jumblan1, rxPower=rxPower, multicastsTransmitted=multicastsTransmitted, xg6846=xg6846, temperature=temperature, lanportName=lanportName, unicastsTransmitted=unicastsTransmitted, jumb=jumb, wanType=wanType, wan=wan, vendorOui=vendorOui, port2=port2, groupid=groupid, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, deviceinfo=deviceinfo, bias=bias, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, statisticTable=statisticTable, vlangroupTable=vlangroupTable, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, lan2=lan2, rebootEnable=rebootEnable, priority=priority, portStatistic=portStatistic, portEntry=portEntry, broadcastsReceived=broadcastsReceived, jumblan2=jumblan2, vendorRev=vendorRev, lanportspeed=lanportspeed, secondaryDns=secondaryDns, qosTable=qosTable, statIndex=statIndex, staticIpAddr=staticIpAddr, qosIndex=qosIndex, pauseReceived=pauseReceived, vlanid=vlanid, multicastsReceived=multicastsReceived, staticIpDomainName=staticIpDomainName, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, ddminfo=ddminfo, primaryDns=primaryDns, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, catvEnable=catvEnable, qmapping=qmapping, portmode=portmode, portTable=portTable, qmode=qmode, port3=port3, lan1=lan1, lanportpause=lanportpause, jumbwan=jumbwan)
