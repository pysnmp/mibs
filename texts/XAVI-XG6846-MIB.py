...
# Produced by pysmi-1.1.11 at Wed Apr  3 15:17:11 2024
...
Gauge32, Unsigned32, TimeTicks, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, Bits, IpAddress, Counter64, mib_2, NotificationType, enterprises, Counter32, MibIdentifier, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "Bits", "IpAddress", "Counter64", "mib-2", "NotificationType", "enterprises", "Counter32", "MibIdentifier", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan1=jumblan1, qos=qos, jumb=jumb, portTable=portTable, wanType=wanType, rebootEnable=rebootEnable, pauseTransmitted=pauseTransmitted, lan1=lan1, reboot=reboot, lanportName=lanportName, vlanid=vlanid, vlan=vlan, lan4=lan4, staticIpPrimaryDns=staticIpPrimaryDns, bias=bias, portStatEntry=portStatEntry, xg6846=xg6846, voltage=voltage, staticIpGateway=staticIpGateway, lanportTable=lanportTable, qmode=qmode, port4=port4, tftpSevIp=tftpSevIp, jumblan4=jumblan4, portPower=portPower, portIndex=portIndex, qmapping=qmapping, portName=portName, staticIpSubMask=staticIpSubMask, temperature=temperature, groupid=groupid, qosTable=qosTable, broadcastsReceived=broadcastsReceived, vendorRev=vendorRev, pauseReceived=pauseReceived, hostname=hostname, ddminfo=ddminfo, unicastsTransmitted=unicastsTransmitted, fileName=fileName, staticIpHostName=staticIpHostName, portmode=portmode, multicastsReceived=multicastsReceived, operStatus=operStatus, unicastsReceived=unicastsReceived, rxPower=rxPower, staticDns=staticDns, groupEntry=groupEntry, lanportspeed=lanportspeed, portStatistic=portStatistic, speed=speed, port1=port1, staticIpDomainName=staticIpDomainName, catv=catv, modeEntry=modeEntry, jumblan2=jumblan2, dscpEnable=dscpEnable, jumbwan=jumbwan, internetPort=internetPort, txPower=txPower, deviceinfo=deviceinfo, statisticTable=statisticTable, port3=port3, serialnum=serialnum, fcsErrorReceived=fcsErrorReceived, qosEntry=qosEntry, lan2=lan2, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, wan=wan, jumblan3=jumblan3, multicastsTransmitted=multicastsTransmitted, tftp=tftp, qosIndex=qosIndex, vendorOui=vendorOui, action=action, lanportpause=lanportpause, catvEnable=catvEnable, broadcastsTransmitted=broadcastsTransmitted, domainame=domainame, vendorName=vendorName, portEntry=portEntry, vlangroupTable=vlangroupTable, lanportIndex=lanportIndex, groupIndex=groupIndex, secondaryDns=secondaryDns, vendorPn=vendorPn, priority=priority, port2=port2, adminStatus=adminStatus, staticIpAddr=staticIpAddr, statIndex=statIndex, lan3=lan3, primaryDns=primaryDns, fileType=fileType)
