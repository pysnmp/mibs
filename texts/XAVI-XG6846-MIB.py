...
MibIdentifier, iso, Bits, TimeTicks, Counter64, NotificationType, IpAddress, Counter32, Gauge32, Unsigned32, enterprises, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, snmpModules, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Bits", "TimeTicks", "Counter64", "NotificationType", "IpAddress", "Counter32", "Gauge32", "Unsigned32", "enterprises", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "snmpModules", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", serialnum=serialnum, jumblan2=jumblan2, temperature=temperature, qos=qos, groupEntry=groupEntry, rebootEnable=rebootEnable, internetPort=internetPort, port1=port1, rxPower=rxPower, txPower=txPower, statIndex=statIndex, lanportTable=lanportTable, operStatus=operStatus, qosIndex=qosIndex, vlanid=vlanid, portIndex=portIndex, tftpSevIp=tftpSevIp, secondaryDns=secondaryDns, jumblan1=jumblan1, lanportName=lanportName, port4=port4, qmapping=qmapping, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, ddminfo=ddminfo, multicastsTransmitted=multicastsTransmitted, jumb=jumb, fcsErrorTransmitted=fcsErrorTransmitted, lan3=lan3, vlangroupTable=vlangroupTable, vendorPn=vendorPn, vlan=vlan, priority=priority, fileName=fileName, fileType=fileType, dscpEnable=dscpEnable, fcsErrorReceived=fcsErrorReceived, reboot=reboot, portStatEntry=portStatEntry, portName=portName, jumbwan=jumbwan, qosTable=qosTable, voltage=voltage, adminStatus=adminStatus, staticIpDomainName=staticIpDomainName, groupid=groupid, unicastsReceived=unicastsReceived, pauseTransmitted=pauseTransmitted, groupIndex=groupIndex, speed=speed, portEntry=portEntry, bias=bias, lan2=lan2, wan=wan, staticIpHostName=staticIpHostName, jumblan3=jumblan3, staticIpSubMask=staticIpSubMask, catv=catv, action=action, staticIpGateway=staticIpGateway, lan4=lan4, multicastsReceived=multicastsReceived, catvEnable=catvEnable, primaryDns=primaryDns, tftp=tftp, domainame=domainame, portmode=portmode, lanportIndex=lanportIndex, lanportspeed=lanportspeed, lan1=lan1, pauseReceived=pauseReceived, port2=port2, statisticTable=statisticTable, lanportpause=lanportpause, vendorName=vendorName, portPower=portPower, qosEntry=qosEntry, jumblan4=jumblan4, xg6846=xg6846, deviceinfo=deviceinfo, staticIpAddr=staticIpAddr, qmode=qmode, portTable=portTable, staticIpSecondaryDns=staticIpSecondaryDns, portStatistic=portStatistic, staticDns=staticDns, wanType=wanType, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, port3=port3, modeEntry=modeEntry, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, hostname=hostname)
