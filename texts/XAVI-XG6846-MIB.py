...
enterprises, iso, Gauge32, Bits, Integer32, NotificationType, Unsigned32, TimeTicks, ObjectIdentity, IpAddress, ModuleIdentity, snmpModules, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "Gauge32", "Bits", "Integer32", "NotificationType", "Unsigned32", "TimeTicks", "ObjectIdentity", "IpAddress", "ModuleIdentity", "snmpModules", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", hostname=hostname, catvEnable=catvEnable, qmode=qmode, statIndex=statIndex, staticIpSubMask=staticIpSubMask, pauseTransmitted=pauseTransmitted, wanType=wanType, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower, portStatistic=portStatistic, temperature=temperature, staticDns=staticDns, lan4=lan4, dscpEnable=dscpEnable, portmode=portmode, deviceinfo=deviceinfo, portPower=portPower, vendorOui=vendorOui, lanportName=lanportName, lan1=lan1, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, staticIpGateway=staticIpGateway, port2=port2, groupid=groupid, port3=port3, qosEntry=qosEntry, primaryDns=primaryDns, lanportpause=lanportpause, jumb=jumb, xg6846=xg6846, bias=bias, groupIndex=groupIndex, lanportIndex=lanportIndex, vlan=vlan, vlanid=vlanid, fileName=fileName, serialnum=serialnum, tftpSevIp=tftpSevIp, action=action, operStatus=operStatus, portEntry=portEntry, priority=priority, lanportspeed=lanportspeed, portIndex=portIndex, staticIpDomainName=staticIpDomainName, vendorRev=vendorRev, domainame=domainame, modeEntry=modeEntry, qmapping=qmapping, vendorPn=vendorPn, voltage=voltage, speed=speed, jumbwan=jumbwan, staticIpSecondaryDns=staticIpSecondaryDns, rebootEnable=rebootEnable, jumblan3=jumblan3, catv=catv, staticIpHostName=staticIpHostName, portName=portName, secondaryDns=secondaryDns, qos=qos, multicastsReceived=multicastsReceived, broadcastsTransmitted=broadcastsTransmitted, reboot=reboot, statisticTable=statisticTable, pauseReceived=pauseReceived, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, vlangroupTable=vlangroupTable, adminStatus=adminStatus, qosTable=qosTable, qosIndex=qosIndex, wan=wan, jumblan1=jumblan1, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, port1=port1, staticIpAddr=staticIpAddr, vendorName=vendorName, txPower=txPower, broadcastsReceived=broadcastsReceived, fileType=fileType, jumblan2=jumblan2, ddminfo=ddminfo, lan2=lan2, lan3=lan3, portTable=portTable, port4=port4, lanportTable=lanportTable, tftp=tftp, unicastsTransmitted=unicastsTransmitted, groupEntry=groupEntry, multicastsTransmitted=multicastsTransmitted)
