...
NotificationType, snmpModules, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, Bits, iso, Counter32, TimeTicks, MibIdentifier, Counter64, ObjectIdentity, Gauge32, mib_2, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "snmpModules", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "Bits", "iso", "Counter32", "TimeTicks", "MibIdentifier", "Counter64", "ObjectIdentity", "Gauge32", "mib-2", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, lanportpause=lanportpause, primaryDns=primaryDns, portPower=portPower, priority=priority, staticIpGateway=staticIpGateway, speed=speed, qosTable=qosTable, portTable=portTable, lanportTable=lanportTable, portStatEntry=portStatEntry, secondaryDns=secondaryDns, vlan=vlan, serialnum=serialnum, lan1=lan1, operStatus=operStatus, domainame=domainame, fileType=fileType, portStatistic=portStatistic, txPower=txPower, qos=qos, lanportName=lanportName, port2=port2, multicastsTransmitted=multicastsTransmitted, statisticTable=statisticTable, fcsErrorReceived=fcsErrorReceived, staticIpHostName=staticIpHostName, port3=port3, portmode=portmode, jumblan3=jumblan3, vendorName=vendorName, staticIpSubMask=staticIpSubMask, portName=portName, modeEntry=modeEntry, xg6846=xg6846, action=action, multicastsReceived=multicastsReceived, qmode=qmode, fcsErrorTransmitted=fcsErrorTransmitted, temperature=temperature, wan=wan, fileName=fileName, jumb=jumb, staticIpDomainName=staticIpDomainName, catv=catv, portEntry=portEntry, lan2=lan2, hostname=hostname, groupIndex=groupIndex, qmapping=qmapping, deviceinfo=deviceinfo, lanportIndex=lanportIndex, voltage=voltage, groupid=groupid, port4=port4, lanportspeed=lanportspeed, rebootEnable=rebootEnable, tftp=tftp, vlangroupTable=vlangroupTable, reboot=reboot, staticDns=staticDns, unicastsTransmitted=unicastsTransmitted, vlanid=vlanid, lan4=lan4, statIndex=statIndex, pauseReceived=pauseReceived, rxPower=rxPower, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsTransmitted=broadcastsTransmitted, vendorRev=vendorRev, lan3=lan3, adminStatus=adminStatus, tftpSevIp=tftpSevIp, vendorPn=vendorPn, internetPort=internetPort, jumblan4=jumblan4, staticIpSecondaryDns=staticIpSecondaryDns, bias=bias, qosIndex=qosIndex, jumblan2=jumblan2, jumblan1=jumblan1, broadcastsReceived=broadcastsReceived, wanType=wanType, unicastsReceived=unicastsReceived, port1=port1, portIndex=portIndex, dscpEnable=dscpEnable, ddminfo=ddminfo, qosEntry=qosEntry, pauseTransmitted=pauseTransmitted, groupEntry=groupEntry, vendorOui=vendorOui, staticIpAddr=staticIpAddr, jumbwan=jumbwan)
