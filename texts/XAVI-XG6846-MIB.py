...
enterprises, mib_2, TimeTicks, Counter32, IpAddress, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, NotificationType, Gauge32, iso, Counter64, ModuleIdentity, MibIdentifier, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "mib-2", "TimeTicks", "Counter32", "IpAddress", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "NotificationType", "Gauge32", "iso", "Counter64", "ModuleIdentity", "MibIdentifier", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portmode=portmode, modeEntry=modeEntry, reboot=reboot, adminStatus=adminStatus, port4=port4, jumblan3=jumblan3, priority=priority, vendorRev=vendorRev, groupid=groupid, operStatus=operStatus, domainame=domainame, vlanid=vlanid, lanportpause=lanportpause, port3=port3, jumbwan=jumbwan, statIndex=statIndex, staticIpHostName=staticIpHostName, fcsErrorReceived=fcsErrorReceived, deviceinfo=deviceinfo, vlan=vlan, wanType=wanType, vendorOui=vendorOui, statisticTable=statisticTable, staticIpAddr=staticIpAddr, serialnum=serialnum, lanportName=lanportName, port2=port2, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, rxPower=rxPower, pauseReceived=pauseReceived, temperature=temperature, action=action, catvEnable=catvEnable, qosEntry=qosEntry, secondaryDns=secondaryDns, staticIpGateway=staticIpGateway, pauseTransmitted=pauseTransmitted, staticDns=staticDns, dscpEnable=dscpEnable, groupEntry=groupEntry, jumb=jumb, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, qmode=qmode, qosTable=qosTable, groupIndex=groupIndex, rebootEnable=rebootEnable, multicastsTransmitted=multicastsTransmitted, internetPort=internetPort, qmapping=qmapping, multicastsReceived=multicastsReceived, ddminfo=ddminfo, vendorPn=vendorPn, primaryDns=primaryDns, port1=port1, staticIpDomainName=staticIpDomainName, tftp=tftp, unicastsReceived=unicastsReceived, lanportspeed=lanportspeed, portTable=portTable, fcsErrorTransmitted=fcsErrorTransmitted, unicastsTransmitted=unicastsTransmitted, tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, portPower=portPower, portEntry=portEntry, fileName=fileName, wan=wan, vendorName=vendorName, portIndex=portIndex, broadcastsTransmitted=broadcastsTransmitted, txPower=txPower, lan1=lan1, hostname=hostname, portStatistic=portStatistic, voltage=voltage, xg6846=xg6846, speed=speed, lan3=lan3, lanportIndex=lanportIndex, jumblan2=jumblan2, fileType=fileType, qos=qos, catv=catv, qosIndex=qosIndex, lan2=lan2, vlangroupTable=vlangroupTable, staticIpSecondaryDns=staticIpSecondaryDns, portStatEntry=portStatEntry, lan4=lan4, portName=portName, jumblan1=jumblan1)
