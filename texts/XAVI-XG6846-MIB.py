...
enterprises, ModuleIdentity, Integer32, iso, ObjectIdentity, Counter32, Unsigned32, TimeTicks, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Bits, Counter64, NotificationType, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "Integer32", "iso", "ObjectIdentity", "Counter32", "Unsigned32", "TimeTicks", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Bits", "Counter64", "NotificationType", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portEntry=portEntry, pauseTransmitted=pauseTransmitted, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, vendorRev=vendorRev, fileName=fileName, staticIpGateway=staticIpGateway, serialnum=serialnum, lanportTable=lanportTable, vlangroupTable=vlangroupTable, port4=port4, statisticTable=statisticTable, groupIndex=groupIndex, broadcastsTransmitted=broadcastsTransmitted, modeEntry=modeEntry, wan=wan, qmapping=qmapping, lanportIndex=lanportIndex, vlan=vlan, xg6846=xg6846, vendorName=vendorName, primaryDns=primaryDns, action=action, catv=catv, portStatEntry=portStatEntry, ddminfo=ddminfo, lanportpause=lanportpause, jumbwan=jumbwan, tftpSevIp=tftpSevIp, staticIpPrimaryDns=staticIpPrimaryDns, qosTable=qosTable, portTable=portTable, unicastsTransmitted=unicastsTransmitted, reboot=reboot, lan3=lan3, portIndex=portIndex, jumb=jumb, fcsErrorReceived=fcsErrorReceived, lanportspeed=lanportspeed, staticIpAddr=staticIpAddr, voltage=voltage, rebootEnable=rebootEnable, jumblan3=jumblan3, adminStatus=adminStatus, secondaryDns=secondaryDns, jumblan2=jumblan2, qosIndex=qosIndex, vendorOui=vendorOui, multicastsReceived=multicastsReceived, domainame=domainame, vendorPn=vendorPn, jumblan1=jumblan1, rxPower=rxPower, broadcastsReceived=broadcastsReceived, vlanid=vlanid, lan1=lan1, wanType=wanType, txPower=txPower, hostname=hostname, jumblan4=jumblan4, dscpEnable=dscpEnable, staticIpSecondaryDns=staticIpSecondaryDns, deviceinfo=deviceinfo, qmode=qmode, pauseReceived=pauseReceived, qosEntry=qosEntry, port2=port2, groupid=groupid, lanportName=lanportName, statIndex=statIndex, priority=priority, staticDns=staticDns, fileType=fileType, qos=qos, internetPort=internetPort, speed=speed, port1=port1, port3=port3, lan4=lan4, groupEntry=groupEntry, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, operStatus=operStatus, catvEnable=catvEnable, temperature=temperature, tftp=tftp, staticIpHostName=staticIpHostName, lan2=lan2, bias=bias, portName=portName, unicastsReceived=unicastsReceived, portPower=portPower, fcsErrorTransmitted=fcsErrorTransmitted, portmode=portmode)
