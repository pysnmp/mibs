...
iso, Unsigned32, IpAddress, NotificationType, enterprises, ObjectIdentity, mib_2, MibIdentifier, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Bits, Counter64, Gauge32, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Unsigned32", "IpAddress", "NotificationType", "enterprises", "ObjectIdentity", "mib-2", "MibIdentifier", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Bits", "Counter64", "Gauge32", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsReceived=unicastsReceived, pauseReceived=pauseReceived, tftpSevIp=tftpSevIp, jumblan2=jumblan2, jumbwan=jumbwan, wan=wan, lanportIndex=lanportIndex, lanportTable=lanportTable, statIndex=statIndex, staticDns=staticDns, staticIpSubMask=staticIpSubMask, bias=bias, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, jumb=jumb, portTable=portTable, temperature=temperature, voltage=voltage, lanportspeed=lanportspeed, port1=port1, catvEnable=catvEnable, port3=port3, groupIndex=groupIndex, operStatus=operStatus, statisticTable=statisticTable, qosIndex=qosIndex, internetPort=internetPort, wanType=wanType, priority=priority, staticIpGateway=staticIpGateway, multicastsReceived=multicastsReceived, portEntry=portEntry, qmode=qmode, ddminfo=ddminfo, txPower=txPower, vendorRev=vendorRev, serialnum=serialnum, portStatEntry=portStatEntry, portPower=portPower, staticIpHostName=staticIpHostName, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, multicastsTransmitted=multicastsTransmitted, lanportName=lanportName, lan1=lan1, action=action, lanportpause=lanportpause, fcsErrorTransmitted=fcsErrorTransmitted, jumblan1=jumblan1, port4=port4, vlan=vlan, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, broadcastsReceived=broadcastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, domainame=domainame, qosEntry=qosEntry, vlanid=vlanid, lan4=lan4, staticIpAddr=staticIpAddr, staticIpDomainName=staticIpDomainName, vlangroupTable=vlangroupTable, modeEntry=modeEntry, portStatistic=portStatistic, fileName=fileName, pauseTransmitted=pauseTransmitted, lan3=lan3, qosTable=qosTable, rxPower=rxPower, reboot=reboot, secondaryDns=secondaryDns, fileType=fileType, deviceinfo=deviceinfo, catv=catv, jumblan4=jumblan4, rebootEnable=rebootEnable, adminStatus=adminStatus, vendorPn=vendorPn, groupEntry=groupEntry, qos=qos, jumblan3=jumblan3, lan2=lan2, speed=speed, qmapping=qmapping, primaryDns=primaryDns, portName=portName, hostname=hostname, port2=port2, portmode=portmode, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, vendorOui=vendorOui, tftp=tftp, vendorName=vendorName)
