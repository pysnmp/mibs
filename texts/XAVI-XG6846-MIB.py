...
ObjectIdentity, Bits, enterprises, iso, NotificationType, Counter64, Integer32, Gauge32, MibIdentifier, mib_2, IpAddress, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "enterprises", "iso", "NotificationType", "Counter64", "Integer32", "Gauge32", "MibIdentifier", "mib-2", "IpAddress", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorRev=vendorRev, portEntry=portEntry, wanType=wanType, qosEntry=qosEntry, secondaryDns=secondaryDns, temperature=temperature, modeEntry=modeEntry, fileName=fileName, staticIpPrimaryDns=staticIpPrimaryDns, port3=port3, fcsErrorTransmitted=fcsErrorTransmitted, qmode=qmode, jumb=jumb, fileType=fileType, xg6846=xg6846, catv=catv, rxPower=rxPower, portStatistic=portStatistic, tftpSevIp=tftpSevIp, bias=bias, jumblan1=jumblan1, vlangroupTable=vlangroupTable, staticIpDomainName=staticIpDomainName, unicastsReceived=unicastsReceived, ddminfo=ddminfo, lan2=lan2, dscpEnable=dscpEnable, lanportpause=lanportpause, lan1=lan1, vendorOui=vendorOui, groupIndex=groupIndex, broadcastsReceived=broadcastsReceived, jumbwan=jumbwan, primaryDns=primaryDns, vlanid=vlanid, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, txPower=txPower, port4=port4, qosIndex=qosIndex, action=action, lanportName=lanportName, port1=port1, wan=wan, staticIpSecondaryDns=staticIpSecondaryDns, portIndex=portIndex, vlan=vlan, pauseTransmitted=pauseTransmitted, portStatEntry=portStatEntry, hostname=hostname, staticIpHostName=staticIpHostName, lan4=lan4, groupid=groupid, multicastsReceived=multicastsReceived, unicastsTransmitted=unicastsTransmitted, voltage=voltage, qmapping=qmapping, adminStatus=adminStatus, reboot=reboot, lanportspeed=lanportspeed, jumblan2=jumblan2, jumblan3=jumblan3, vendorName=vendorName, serialnum=serialnum, operStatus=operStatus, vendorPn=vendorPn, staticIpAddr=staticIpAddr, broadcastsTransmitted=broadcastsTransmitted, pauseReceived=pauseReceived, multicastsTransmitted=multicastsTransmitted, qos=qos, portPower=portPower, tftp=tftp, portmode=portmode, groupEntry=groupEntry, lanportTable=lanportTable, catvEnable=catvEnable, lan3=lan3, rebootEnable=rebootEnable, statisticTable=statisticTable, statIndex=statIndex, qosTable=qosTable, internetPort=internetPort, lanportIndex=lanportIndex, staticDns=staticDns, speed=speed, portName=portName, jumblan4=jumblan4, port2=port2, portTable=portTable, domainame=domainame, priority=priority, staticIpGateway=staticIpGateway, staticIpSubMask=staticIpSubMask)
