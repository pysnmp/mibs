...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:19:06 2021
...
enterprises, TimeTicks, ModuleIdentity, Counter64, iso, IpAddress, Bits, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, snmpModules, ObjectIdentity, Gauge32, NotificationType, mib_2, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "ModuleIdentity", "Counter64", "iso", "IpAddress", "Bits", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "snmpModules", "ObjectIdentity", "Gauge32", "NotificationType", "mib-2", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileType=fileType, fcsErrorReceived=fcsErrorReceived, multicastsReceived=multicastsReceived, vendorPn=vendorPn, staticIpDomainName=staticIpDomainName, speed=speed, lanportIndex=lanportIndex, portmode=portmode, vlan=vlan, staticIpSubMask=staticIpSubMask, qmode=qmode, temperature=temperature, vlangroupTable=vlangroupTable, txPower=txPower, staticDns=staticDns, staticIpAddr=staticIpAddr, groupEntry=groupEntry, pauseReceived=pauseReceived, dscpEnable=dscpEnable, qosIndex=qosIndex, unicastsReceived=unicastsReceived, jumblan3=jumblan3, statIndex=statIndex, catvEnable=catvEnable, modeEntry=modeEntry, jumb=jumb, hostname=hostname, unicastsTransmitted=unicastsTransmitted, qosTable=qosTable, lan4=lan4, port1=port1, internetPort=internetPort, adminStatus=adminStatus, domainame=domainame, deviceinfo=deviceinfo, staticIpHostName=staticIpHostName, broadcastsReceived=broadcastsReceived, vendorName=vendorName, qmapping=qmapping, fileName=fileName, port2=port2, jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, action=action, vendorRev=vendorRev, port4=port4, lanportTable=lanportTable, serialnum=serialnum, jumblan2=jumblan2, lanportpause=lanportpause, primaryDns=primaryDns, xg6846=xg6846, lanportName=lanportName, lanportspeed=lanportspeed, lan2=lan2, tftp=tftp, statisticTable=statisticTable, tftpSevIp=tftpSevIp, wanType=wanType, vendorOui=vendorOui, broadcastsTransmitted=broadcastsTransmitted, portName=portName, lan3=lan3, bias=bias, rebootEnable=rebootEnable, portTable=portTable, rxPower=rxPower, portEntry=portEntry, jumblan1=jumblan1, qos=qos, ddminfo=ddminfo, port3=port3, portIndex=portIndex, catv=catv, reboot=reboot, vlanid=vlanid, portStatistic=portStatistic, groupIndex=groupIndex, staticIpGateway=staticIpGateway, portPower=portPower, voltage=voltage, operStatus=operStatus, staticIpSecondaryDns=staticIpSecondaryDns, jumbwan=jumbwan, pauseTransmitted=pauseTransmitted, wan=wan, lan1=lan1, portStatEntry=portStatEntry, qosEntry=qosEntry, priority=priority, staticIpPrimaryDns=staticIpPrimaryDns, groupid=groupid, secondaryDns=secondaryDns, multicastsTransmitted=multicastsTransmitted)
