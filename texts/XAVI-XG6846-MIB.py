...
# Produced by pysmi-1.1.3 at Wed Dec  1 14:54:49 2021
...
enterprises, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter64, Unsigned32, snmpModules, ObjectIdentity, Counter32, ModuleIdentity, mib_2, IpAddress, MibIdentifier, Bits, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter64", "Unsigned32", "snmpModules", "ObjectIdentity", "Counter32", "ModuleIdentity", "mib-2", "IpAddress", "MibIdentifier", "Bits", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatistic=portStatistic, catv=catv, wanType=wanType, jumblan4=jumblan4, qosTable=qosTable, operStatus=operStatus, lan3=lan3, voltage=voltage, txPower=txPower, qmapping=qmapping, secondaryDns=secondaryDns, catvEnable=catvEnable, pauseReceived=pauseReceived, lan4=lan4, qosEntry=qosEntry, statisticTable=statisticTable, staticIpHostName=staticIpHostName, tftpSevIp=tftpSevIp, jumblan3=jumblan3, hostname=hostname, qos=qos, portTable=portTable, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, portmode=portmode, fileType=fileType, groupid=groupid, xg6846=xg6846, modeEntry=modeEntry, multicastsTransmitted=multicastsTransmitted, temperature=temperature, rxPower=rxPower, fcsErrorTransmitted=fcsErrorTransmitted, port3=port3, wan=wan, portEntry=portEntry, lanportspeed=lanportspeed, bias=bias, staticIpAddr=staticIpAddr, serialnum=serialnum, statIndex=statIndex, port4=port4, vendorPn=vendorPn, speed=speed, broadcastsReceived=broadcastsReceived, staticDns=staticDns, fileName=fileName, portIndex=portIndex, port2=port2, priority=priority, lan1=lan1, portPower=portPower, unicastsReceived=unicastsReceived, vendorRev=vendorRev, staticIpDomainName=staticIpDomainName, vlangroupTable=vlangroupTable, unicastsTransmitted=unicastsTransmitted, action=action, jumblan2=jumblan2, vendorName=vendorName, lanportpause=lanportpause, staticIpPrimaryDns=staticIpPrimaryDns, vlanid=vlanid, qmode=qmode, staticIpGateway=staticIpGateway, pauseTransmitted=pauseTransmitted, primaryDns=primaryDns, vlan=vlan, vendorOui=vendorOui, ddminfo=ddminfo, reboot=reboot, groupIndex=groupIndex, staticIpSecondaryDns=staticIpSecondaryDns, qosIndex=qosIndex, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, internetPort=internetPort, lanportName=lanportName, lanportTable=lanportTable, portStatEntry=portStatEntry, deviceinfo=deviceinfo, portName=portName, dscpEnable=dscpEnable, tftp=tftp, lanportIndex=lanportIndex, groupEntry=groupEntry, jumbwan=jumbwan, multicastsReceived=multicastsReceived, port1=port1, adminStatus=adminStatus, fcsErrorReceived=fcsErrorReceived, jumb=jumb, domainame=domainame, rebootEnable=rebootEnable)
