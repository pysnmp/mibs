...
snmpModules, IpAddress, Integer32, iso, Bits, MibIdentifier, NotificationType, Counter64, Unsigned32, Gauge32, ObjectIdentity, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "IpAddress", "Integer32", "iso", "Bits", "MibIdentifier", "NotificationType", "Counter64", "Unsigned32", "Gauge32", "ObjectIdentity", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, pauseReceived=pauseReceived, wanType=wanType, jumblan4=jumblan4, serialnum=serialnum, statIndex=statIndex, jumb=jumb, fcsErrorReceived=fcsErrorReceived, reboot=reboot, port2=port2, portTable=portTable, jumbwan=jumbwan, unicastsTransmitted=unicastsTransmitted, tftp=tftp, qmapping=qmapping, catvEnable=catvEnable, bias=bias, vlangroupTable=vlangroupTable, port4=port4, staticDns=staticDns, hostname=hostname, staticIpAddr=staticIpAddr, catv=catv, groupid=groupid, portStatEntry=portStatEntry, fileName=fileName, rebootEnable=rebootEnable, qos=qos, lanportIndex=lanportIndex, port1=port1, speed=speed, vlanid=vlanid, portmode=portmode, qosEntry=qosEntry, fcsErrorTransmitted=fcsErrorTransmitted, groupEntry=groupEntry, voltage=voltage, jumblan3=jumblan3, vendorName=vendorName, portStatistic=portStatistic, adminStatus=adminStatus, groupIndex=groupIndex, portEntry=portEntry, lanportName=lanportName, jumblan1=jumblan1, portPower=portPower, rxPower=rxPower, staticIpDomainName=staticIpDomainName, staticIpHostName=staticIpHostName, operStatus=operStatus, statisticTable=statisticTable, qmode=qmode, port3=port3, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, dscpEnable=dscpEnable, multicastsReceived=multicastsReceived, lanportTable=lanportTable, priority=priority, lan3=lan3, wan=wan, lanportspeed=lanportspeed, internetPort=internetPort, fileType=fileType, unicastsReceived=unicastsReceived, primaryDns=primaryDns, staticIpSecondaryDns=staticIpSecondaryDns, txPower=txPower, vendorRev=vendorRev, qosIndex=qosIndex, domainame=domainame, secondaryDns=secondaryDns, multicastsTransmitted=multicastsTransmitted, temperature=temperature, staticIpSubMask=staticIpSubMask, tftpSevIp=tftpSevIp, vlan=vlan, pauseTransmitted=pauseTransmitted, xg6846=xg6846, vendorOui=vendorOui, action=action, staticIpGateway=staticIpGateway, lanportpause=lanportpause, portName=portName, lan4=lan4, portIndex=portIndex, ddminfo=ddminfo, lan2=lan2, broadcastsReceived=broadcastsReceived, qosTable=qosTable, broadcastsTransmitted=broadcastsTransmitted, deviceinfo=deviceinfo, lan1=lan1, vendorPn=vendorPn)
