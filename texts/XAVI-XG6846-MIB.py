...
# Produced by pysmi-1.1.8 at Wed Oct 11 08:35:31 2023
...
enterprises, mib_2, Integer32, ObjectIdentity, TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Bits, Unsigned32, ModuleIdentity, Gauge32, IpAddress, Counter64, MibIdentifier, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "mib-2", "Integer32", "ObjectIdentity", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Bits", "Unsigned32", "ModuleIdentity", "Gauge32", "IpAddress", "Counter64", "MibIdentifier", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, fileName=fileName, lanportName=lanportName, lan4=lan4, speed=speed, operStatus=operStatus, vlan=vlan, vendorPn=vendorPn, qosTable=qosTable, jumblan3=jumblan3, portTable=portTable, qmapping=qmapping, vlanid=vlanid, lan3=lan3, qmode=qmode, lan2=lan2, tftpSevIp=tftpSevIp, statisticTable=statisticTable, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, pauseReceived=pauseReceived, adminStatus=adminStatus, pauseTransmitted=pauseTransmitted, fcsErrorReceived=fcsErrorReceived, broadcastsReceived=broadcastsReceived, statIndex=statIndex, vendorOui=vendorOui, catvEnable=catvEnable, multicastsTransmitted=multicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, modeEntry=modeEntry, staticDns=staticDns, qosIndex=qosIndex, serialnum=serialnum, deviceinfo=deviceinfo, ddminfo=ddminfo, action=action, catv=catv, bias=bias, port2=port2, staticIpDomainName=staticIpDomainName, staticIpGateway=staticIpGateway, vendorRev=vendorRev, priority=priority, tftp=tftp, groupIndex=groupIndex, txPower=txPower, qosEntry=qosEntry, internetPort=internetPort, xg6846=xg6846, vendorName=vendorName, lan1=lan1, lanportspeed=lanportspeed, jumblan1=jumblan1, groupid=groupid, multicastsReceived=multicastsReceived, hostname=hostname, jumbwan=jumbwan, qos=qos, wanType=wanType, temperature=temperature, staticIpSubMask=staticIpSubMask, dscpEnable=dscpEnable, vlangroupTable=vlangroupTable, staticIpHostName=staticIpHostName, portEntry=portEntry, reboot=reboot, port1=port1, secondaryDns=secondaryDns, portPower=portPower, wan=wan, rxPower=rxPower, portIndex=portIndex, fileType=fileType, lanportTable=lanportTable, jumb=jumb, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, portmode=portmode, jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, voltage=voltage, unicastsReceived=unicastsReceived, portStatistic=portStatistic, port4=port4, port3=port3, broadcastsTransmitted=broadcastsTransmitted, lanportIndex=lanportIndex, domainame=domainame, portName=portName, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, groupEntry=groupEntry, primaryDns=primaryDns)
