...
mib_2, snmpModules, NotificationType, enterprises, Counter32, ModuleIdentity, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Gauge32, iso, Bits, Counter64, MibIdentifier, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "snmpModules", "NotificationType", "enterprises", "Counter32", "ModuleIdentity", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Gauge32", "iso", "Bits", "Counter64", "MibIdentifier", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qos=qos, lan1=lan1, pauseTransmitted=pauseTransmitted, portIndex=portIndex, lan4=lan4, tftpSevIp=tftpSevIp, jumb=jumb, qmode=qmode, statIndex=statIndex, broadcastsReceived=broadcastsReceived, lanportTable=lanportTable, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, staticDns=staticDns, lan3=lan3, vlan=vlan, catv=catv, fileType=fileType, priority=priority, tftp=tftp, txPower=txPower, fcsErrorReceived=fcsErrorReceived, portStatistic=portStatistic, qmapping=qmapping, portPower=portPower, lanportIndex=lanportIndex, qosIndex=qosIndex, action=action, port3=port3, lanportName=lanportName, vendorPn=vendorPn, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, jumblan4=jumblan4, lanportspeed=lanportspeed, secondaryDns=secondaryDns, modeEntry=modeEntry, dscpEnable=dscpEnable, port2=port2, portmode=portmode, operStatus=operStatus, groupEntry=groupEntry, wanType=wanType, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, rebootEnable=rebootEnable, fcsErrorTransmitted=fcsErrorTransmitted, wan=wan, vlangroupTable=vlangroupTable, vendorRev=vendorRev, qosTable=qosTable, portName=portName, portEntry=portEntry, jumblan1=jumblan1, groupIndex=groupIndex, fileName=fileName, domainame=domainame, staticIpSubMask=staticIpSubMask, unicastsReceived=unicastsReceived, reboot=reboot, vendorName=vendorName, staticIpGateway=staticIpGateway, jumblan2=jumblan2, lanportpause=lanportpause, catvEnable=catvEnable, temperature=temperature, multicastsReceived=multicastsReceived, voltage=voltage, qosEntry=qosEntry, groupid=groupid, hostname=hostname, portStatEntry=portStatEntry, jumblan3=jumblan3, internetPort=internetPort, serialnum=serialnum, staticIpHostName=staticIpHostName, ddminfo=ddminfo, rxPower=rxPower, staticIpSecondaryDns=staticIpSecondaryDns, vlanid=vlanid, adminStatus=adminStatus, jumbwan=jumbwan, statisticTable=statisticTable, port4=port4, staticIpPrimaryDns=staticIpPrimaryDns, pauseReceived=pauseReceived, deviceinfo=deviceinfo, bias=bias, speed=speed, portTable=portTable, port1=port1)
