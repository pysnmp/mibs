...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, mib_2, Integer32, iso, Bits, Counter64, ObjectIdentity, ModuleIdentity, MibIdentifier, snmpModules, Gauge32, TimeTicks, Unsigned32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "mib-2", "Integer32", "iso", "Bits", "Counter64", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "snmpModules", "Gauge32", "TimeTicks", "Unsigned32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wanType=wanType, modeEntry=modeEntry, groupid=groupid, adminStatus=adminStatus, vlan=vlan, vendorRev=vendorRev, qosTable=qosTable, jumblan3=jumblan3, dscpEnable=dscpEnable, qos=qos, multicastsTransmitted=multicastsTransmitted, lan4=lan4, fcsErrorTransmitted=fcsErrorTransmitted, jumb=jumb, multicastsReceived=multicastsReceived, groupEntry=groupEntry, staticIpSecondaryDns=staticIpSecondaryDns, portName=portName, statisticTable=statisticTable, ddminfo=ddminfo, tftp=tftp, bias=bias, xg6846=xg6846, staticIpHostName=staticIpHostName, staticDns=staticDns, unicastsTransmitted=unicastsTransmitted, lanportIndex=lanportIndex, portEntry=portEntry, voltage=voltage, port4=port4, hostname=hostname, portIndex=portIndex, qosIndex=qosIndex, vendorOui=vendorOui, fcsErrorReceived=fcsErrorReceived, broadcastsReceived=broadcastsReceived, portmode=portmode, broadcastsTransmitted=broadcastsTransmitted, catv=catv, groupIndex=groupIndex, vlanid=vlanid, txPower=txPower, jumblan2=jumblan2, temperature=temperature, domainame=domainame, secondaryDns=secondaryDns, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, jumbwan=jumbwan, lanportspeed=lanportspeed, catvEnable=catvEnable, fileType=fileType, tftpSevIp=tftpSevIp, primaryDns=primaryDns, lan1=lan1, pauseReceived=pauseReceived, lanportTable=lanportTable, jumblan4=jumblan4, vendorName=vendorName, lan3=lan3, staticIpSubMask=staticIpSubMask, lan2=lan2, reboot=reboot, wan=wan, staticIpAddr=staticIpAddr, portStatistic=portStatistic, port1=port1, qmapping=qmapping, port3=port3, portTable=portTable, pauseTransmitted=pauseTransmitted, rebootEnable=rebootEnable, statIndex=statIndex, portPower=portPower, serialnum=serialnum, portStatEntry=portStatEntry, qosEntry=qosEntry, staticIpDomainName=staticIpDomainName, action=action, operStatus=operStatus, port2=port2, qmode=qmode, deviceinfo=deviceinfo, vendorPn=vendorPn, rxPower=rxPower, lanportpause=lanportpause, staticIpGateway=staticIpGateway, priority=priority, fileName=fileName, jumblan1=jumblan1, vlangroupTable=vlangroupTable, unicastsReceived=unicastsReceived, speed=speed, internetPort=internetPort)
