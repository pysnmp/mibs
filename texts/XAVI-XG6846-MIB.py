...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:24:30 2021
...
IpAddress, ObjectIdentity, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, MibIdentifier, snmpModules, Unsigned32, Counter64, iso, Integer32, Gauge32, TimeTicks, NotificationType, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "MibIdentifier", "snmpModules", "Unsigned32", "Counter64", "iso", "Integer32", "Gauge32", "TimeTicks", "NotificationType", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseTransmitted=pauseTransmitted, secondaryDns=secondaryDns, broadcastsReceived=broadcastsReceived, multicastsReceived=multicastsReceived, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, serialnum=serialnum, xg6846=xg6846, lan3=lan3, priority=priority, lanportIndex=lanportIndex, portPower=portPower, jumbwan=jumbwan, tftpSevIp=tftpSevIp, vendorOui=vendorOui, staticIpSecondaryDns=staticIpSecondaryDns, portmode=portmode, vlangroupTable=vlangroupTable, jumb=jumb, jumblan1=jumblan1, port3=port3, staticDns=staticDns, wan=wan, multicastsTransmitted=multicastsTransmitted, lan2=lan2, reboot=reboot, qosEntry=qosEntry, fileType=fileType, lan1=lan1, rebootEnable=rebootEnable, portStatEntry=portStatEntry, fileName=fileName, vendorRev=vendorRev, lan4=lan4, unicastsTransmitted=unicastsTransmitted, groupIndex=groupIndex, jumblan3=jumblan3, lanportName=lanportName, fcsErrorTransmitted=fcsErrorTransmitted, operStatus=operStatus, adminStatus=adminStatus, deviceinfo=deviceinfo, bias=bias, catv=catv, vlanid=vlanid, statisticTable=statisticTable, port2=port2, portEntry=portEntry, jumblan2=jumblan2, port1=port1, port4=port4, qosTable=qosTable, wanType=wanType, staticIpPrimaryDns=staticIpPrimaryDns, qos=qos, txPower=txPower, statIndex=statIndex, portTable=portTable, vlan=vlan, portIndex=portIndex, tftp=tftp, hostname=hostname, qmapping=qmapping, jumblan4=jumblan4, staticIpGateway=staticIpGateway, portName=portName, lanportspeed=lanportspeed, qosIndex=qosIndex, dscpEnable=dscpEnable, modeEntry=modeEntry, groupEntry=groupEntry, fcsErrorReceived=fcsErrorReceived, catvEnable=catvEnable, pauseReceived=pauseReceived, vendorName=vendorName, action=action, temperature=temperature, voltage=voltage, speed=speed, staticIpSubMask=staticIpSubMask, ddminfo=ddminfo, portStatistic=portStatistic, rxPower=rxPower, broadcastsTransmitted=broadcastsTransmitted, primaryDns=primaryDns, lanportpause=lanportpause, lanportTable=lanportTable, groupid=groupid, vendorPn=vendorPn, internetPort=internetPort, domainame=domainame, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, qmode=qmode)
