...
Integer32, snmpModules, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Unsigned32, enterprises, mib_2, ObjectIdentity, MibIdentifier, iso, Bits, Counter32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "snmpModules", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Unsigned32", "enterprises", "mib-2", "ObjectIdentity", "MibIdentifier", "iso", "Bits", "Counter32", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan1=lan1, domainame=domainame, staticIpSubMask=staticIpSubMask, vlan=vlan, action=action, wan=wan, staticIpGateway=staticIpGateway, fcsErrorTransmitted=fcsErrorTransmitted, priority=priority, adminStatus=adminStatus, portIndex=portIndex, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, port3=port3, serialnum=serialnum, lan3=lan3, qos=qos, tftp=tftp, groupEntry=groupEntry, rebootEnable=rebootEnable, lan2=lan2, statisticTable=statisticTable, portName=portName, portPower=portPower, groupIndex=groupIndex, pauseTransmitted=pauseTransmitted, ddminfo=ddminfo, qosIndex=qosIndex, vlangroupTable=vlangroupTable, vendorRev=vendorRev, lanportspeed=lanportspeed, staticDns=staticDns, port4=port4, jumblan2=jumblan2, reboot=reboot, multicastsTransmitted=multicastsTransmitted, txPower=txPower, jumblan3=jumblan3, pauseReceived=pauseReceived, catvEnable=catvEnable, vendorPn=vendorPn, broadcastsTransmitted=broadcastsTransmitted, port2=port2, jumbwan=jumbwan, dscpEnable=dscpEnable, vendorName=vendorName, groupid=groupid, speed=speed, lan4=lan4, portStatistic=portStatistic, unicastsTransmitted=unicastsTransmitted, xg6846=xg6846, vendorOui=vendorOui, catv=catv, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsReceived=broadcastsReceived, statIndex=statIndex, qosTable=qosTable, unicastsReceived=unicastsReceived, jumb=jumb, tftpSevIp=tftpSevIp, qosEntry=qosEntry, voltage=voltage, wanType=wanType, primaryDns=primaryDns, portEntry=portEntry, staticIpDomainName=staticIpDomainName, lanportIndex=lanportIndex, lanportpause=lanportpause, deviceinfo=deviceinfo, vlanid=vlanid, portmode=portmode, fcsErrorReceived=fcsErrorReceived, port1=port1, qmapping=qmapping, internetPort=internetPort, secondaryDns=secondaryDns, operStatus=operStatus, portTable=portTable, staticIpHostName=staticIpHostName, lanportName=lanportName, multicastsReceived=multicastsReceived, qmode=qmode, rxPower=rxPower, temperature=temperature, jumblan4=jumblan4, staticIpAddr=staticIpAddr, fileType=fileType, fileName=fileName, hostname=hostname, modeEntry=modeEntry, portStatEntry=portStatEntry, lanportTable=lanportTable, jumblan1=jumblan1)
