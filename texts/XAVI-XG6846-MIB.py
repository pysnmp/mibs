...
ModuleIdentity, snmpModules, Counter32, Bits, Unsigned32, Gauge32, TimeTicks, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, mib_2, MibIdentifier, IpAddress, Integer32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "snmpModules", "Counter32", "Bits", "Unsigned32", "Gauge32", "TimeTicks", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "mib-2", "MibIdentifier", "IpAddress", "Integer32", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan4=lan4, jumbwan=jumbwan, lanportIndex=lanportIndex, vlanid=vlanid, qosEntry=qosEntry, qmapping=qmapping, ddminfo=ddminfo, vlangroupTable=vlangroupTable, pauseTransmitted=pauseTransmitted, reboot=reboot, unicastsReceived=unicastsReceived, secondaryDns=secondaryDns, txPower=txPower, portPower=portPower, lan2=lan2, qosIndex=qosIndex, lan1=lan1, staticDns=staticDns, voltage=voltage, staticIpSecondaryDns=staticIpSecondaryDns, lanportName=lanportName, jumb=jumb, catv=catv, staticIpGateway=staticIpGateway, qosTable=qosTable, rxPower=rxPower, fileName=fileName, tftp=tftp, operStatus=operStatus, lanportspeed=lanportspeed, groupid=groupid, staticIpHostName=staticIpHostName, action=action, portTable=portTable, port4=port4, fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, priority=priority, multicastsTransmitted=multicastsTransmitted, temperature=temperature, portmode=portmode, broadcastsReceived=broadcastsReceived, lanportTable=lanportTable, portStatistic=portStatistic, groupIndex=groupIndex, serialnum=serialnum, staticIpAddr=staticIpAddr, staticIpSubMask=staticIpSubMask, staticIpDomainName=staticIpDomainName, port2=port2, xg6846=xg6846, domainame=domainame, catvEnable=catvEnable, fileType=fileType, broadcastsTransmitted=broadcastsTransmitted, portEntry=portEntry, portName=portName, vendorPn=vendorPn, jumblan1=jumblan1, qmode=qmode, port3=port3, vendorName=vendorName, wan=wan, deviceinfo=deviceinfo, lanportpause=lanportpause, jumblan4=jumblan4, rebootEnable=rebootEnable, qos=qos, vendorRev=vendorRev, bias=bias, portIndex=portIndex, staticIpPrimaryDns=staticIpPrimaryDns, speed=speed, fcsErrorTransmitted=fcsErrorTransmitted, lan3=lan3, statisticTable=statisticTable, jumblan2=jumblan2, primaryDns=primaryDns, portStatEntry=portStatEntry, multicastsReceived=multicastsReceived, tftpSevIp=tftpSevIp, vlan=vlan, vendorOui=vendorOui, jumblan3=jumblan3, hostname=hostname, port1=port1, statIndex=statIndex, pauseReceived=pauseReceived, modeEntry=modeEntry, dscpEnable=dscpEnable, adminStatus=adminStatus, wanType=wanType, internetPort=internetPort, unicastsTransmitted=unicastsTransmitted)
