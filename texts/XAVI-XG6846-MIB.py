...
# Produced by pysmi-1.1.8 at Thu Oct 12 09:09:35 2023
...
TimeTicks, IpAddress, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Counter32, mib_2, ModuleIdentity, Unsigned32, MibIdentifier, iso, Gauge32, Integer32, ObjectIdentity, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Counter32", "mib-2", "ModuleIdentity", "Unsigned32", "MibIdentifier", "iso", "Gauge32", "Integer32", "ObjectIdentity", "enterprises", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, qosTable=qosTable, multicastsReceived=multicastsReceived, portTable=portTable, voltage=voltage, tftp=tftp, port1=port1, catv=catv, port4=port4, lanportName=lanportName, deviceinfo=deviceinfo, pauseReceived=pauseReceived, priority=priority, unicastsTransmitted=unicastsTransmitted, reboot=reboot, staticIpSubMask=staticIpSubMask, lanportIndex=lanportIndex, multicastsTransmitted=multicastsTransmitted, wan=wan, unicastsReceived=unicastsReceived, jumblan4=jumblan4, vlanid=vlanid, qmode=qmode, broadcastsReceived=broadcastsReceived, vendorName=vendorName, bias=bias, fcsErrorReceived=fcsErrorReceived, action=action, statisticTable=statisticTable, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, qmapping=qmapping, jumb=jumb, domainame=domainame, port3=port3, wanType=wanType, tftpSevIp=tftpSevIp, lanportTable=lanportTable, staticIpAddr=staticIpAddr, xg6846=xg6846, hostname=hostname, portStatEntry=portStatEntry, groupid=groupid, lan3=lan3, vendorPn=vendorPn, jumbwan=jumbwan, serialnum=serialnum, staticIpGateway=staticIpGateway, txPower=txPower, lanportspeed=lanportspeed, lan4=lan4, temperature=temperature, portStatistic=portStatistic, staticIpHostName=staticIpHostName, secondaryDns=secondaryDns, modeEntry=modeEntry, portEntry=portEntry, statIndex=statIndex, portName=portName, rxPower=rxPower, catvEnable=catvEnable, staticIpPrimaryDns=staticIpPrimaryDns, staticDns=staticDns, vendorOui=vendorOui, ddminfo=ddminfo, portPower=portPower, staticIpDomainName=staticIpDomainName, groupEntry=groupEntry, vlangroupTable=vlangroupTable, qosEntry=qosEntry, vlan=vlan, operStatus=operStatus, pauseTransmitted=pauseTransmitted, portmode=portmode, rebootEnable=rebootEnable, qos=qos, jumblan3=jumblan3, speed=speed, port2=port2, fileName=fileName, jumblan1=jumblan1, primaryDns=primaryDns, internetPort=internetPort, lanportpause=lanportpause, adminStatus=adminStatus, qosIndex=qosIndex, broadcastsTransmitted=broadcastsTransmitted, lan2=lan2, fcsErrorTransmitted=fcsErrorTransmitted, vendorRev=vendorRev, dscpEnable=dscpEnable, lan1=lan1, jumblan2=jumblan2, fileType=fileType)
