...
ObjectIdentity, TimeTicks, enterprises, Integer32, Counter32, NotificationType, MibIdentifier, iso, Bits, mib_2, Gauge32, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "enterprises", "Integer32", "Counter32", "NotificationType", "MibIdentifier", "iso", "Bits", "mib-2", "Gauge32", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", voltage=voltage, fcsErrorReceived=fcsErrorReceived, staticIpDomainName=staticIpDomainName, multicastsTransmitted=multicastsTransmitted, qmode=qmode, vendorOui=vendorOui, reboot=reboot, lan1=lan1, staticIpAddr=staticIpAddr, broadcastsTransmitted=broadcastsTransmitted, groupid=groupid, vendorName=vendorName, multicastsReceived=multicastsReceived, catvEnable=catvEnable, unicastsReceived=unicastsReceived, qosTable=qosTable, bias=bias, action=action, operStatus=operStatus, jumblan4=jumblan4, qos=qos, txPower=txPower, dscpEnable=dscpEnable, staticIpPrimaryDns=staticIpPrimaryDns, fileType=fileType, lanportspeed=lanportspeed, vlanid=vlanid, portTable=portTable, internetPort=internetPort, xg6846=xg6846, serialnum=serialnum, port2=port2, vlangroupTable=vlangroupTable, staticIpSubMask=staticIpSubMask, deviceinfo=deviceinfo, pauseReceived=pauseReceived, portStatistic=portStatistic, lan4=lan4, staticDns=staticDns, lanportTable=lanportTable, tftp=tftp, fcsErrorTransmitted=fcsErrorTransmitted, vendorPn=vendorPn, statIndex=statIndex, primaryDns=primaryDns, qosEntry=qosEntry, portStatEntry=portStatEntry, vlan=vlan, catv=catv, portIndex=portIndex, portPower=portPower, qosIndex=qosIndex, qmapping=qmapping, lanportName=lanportName, wanType=wanType, rebootEnable=rebootEnable, portEntry=portEntry, domainame=domainame, staticIpGateway=staticIpGateway, groupIndex=groupIndex, port3=port3, staticIpHostName=staticIpHostName, tftpSevIp=tftpSevIp, port1=port1, temperature=temperature, jumblan3=jumblan3, ddminfo=ddminfo, vendorRev=vendorRev, modeEntry=modeEntry, hostname=hostname, broadcastsReceived=broadcastsReceived, lan3=lan3, secondaryDns=secondaryDns, lan2=lan2, priority=priority, portName=portName, staticIpSecondaryDns=staticIpSecondaryDns, port4=port4, groupEntry=groupEntry, fileName=fileName, speed=speed, jumblan1=jumblan1, portmode=portmode, pauseTransmitted=pauseTransmitted, lanportIndex=lanportIndex, wan=wan, rxPower=rxPower, jumblan2=jumblan2, jumb=jumb, jumbwan=jumbwan, adminStatus=adminStatus, statisticTable=statisticTable, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted)
