...
# Produced by pysmi-1.1.8 at Fri Sep  8 11:10:05 2023
...
ObjectIdentity, Counter64, ModuleIdentity, Counter32, enterprises, IpAddress, Gauge32, snmpModules, Bits, TimeTicks, mib_2, Unsigned32, Integer32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "ModuleIdentity", "Counter32", "enterprises", "IpAddress", "Gauge32", "snmpModules", "Bits", "TimeTicks", "mib-2", "Unsigned32", "Integer32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan4=lan4, deviceinfo=deviceinfo, serialnum=serialnum, lan1=lan1, vlangroupTable=vlangroupTable, qosIndex=qosIndex, primaryDns=primaryDns, broadcastsReceived=broadcastsReceived, groupIndex=groupIndex, staticIpHostName=staticIpHostName, qmapping=qmapping, statIndex=statIndex, xg6846=xg6846, fcsErrorTransmitted=fcsErrorTransmitted, lanportName=lanportName, catv=catv, staticIpSecondaryDns=staticIpSecondaryDns, lanportTable=lanportTable, jumb=jumb, lan3=lan3, port3=port3, catvEnable=catvEnable, modeEntry=modeEntry, unicastsTransmitted=unicastsTransmitted, jumblan2=jumblan2, port4=port4, multicastsTransmitted=multicastsTransmitted, staticIpDomainName=staticIpDomainName, jumbwan=jumbwan, tftp=tftp, lan2=lan2, ddminfo=ddminfo, portStatistic=portStatistic, portIndex=portIndex, fileType=fileType, staticIpAddr=staticIpAddr, tftpSevIp=tftpSevIp, unicastsReceived=unicastsReceived, jumblan1=jumblan1, priority=priority, port1=port1, vlan=vlan, lanportpause=lanportpause, pauseReceived=pauseReceived, staticDns=staticDns, dscpEnable=dscpEnable, portName=portName, vendorPn=vendorPn, reboot=reboot, lanportspeed=lanportspeed, statisticTable=statisticTable, jumblan3=jumblan3, staticIpSubMask=staticIpSubMask, secondaryDns=secondaryDns, wan=wan, portEntry=portEntry, internetPort=internetPort, portPower=portPower, groupEntry=groupEntry, txPower=txPower, pauseTransmitted=pauseTransmitted, domainame=domainame, vlanid=vlanid, staticIpGateway=staticIpGateway, qosTable=qosTable, operStatus=operStatus, portmode=portmode, qmode=qmode, temperature=temperature, adminStatus=adminStatus, portStatEntry=portStatEntry, portTable=portTable, fcsErrorReceived=fcsErrorReceived, qos=qos, qosEntry=qosEntry, lanportIndex=lanportIndex, hostname=hostname, jumblan4=jumblan4, vendorRev=vendorRev, port2=port2, fileName=fileName, wanType=wanType, multicastsReceived=multicastsReceived, voltage=voltage, vendorName=vendorName, rebootEnable=rebootEnable, broadcastsTransmitted=broadcastsTransmitted, action=action, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, bias=bias, speed=speed, vendorOui=vendorOui, rxPower=rxPower)
