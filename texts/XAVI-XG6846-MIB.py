...
# Produced by pysmi-1.1.8 at Mon Jan 17 15:00:51 2022
...
iso, IpAddress, Bits, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, mib_2, ModuleIdentity, MibIdentifier, Counter64, Counter32, snmpModules, NotificationType, enterprises, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Bits", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "mib-2", "ModuleIdentity", "MibIdentifier", "Counter64", "Counter32", "snmpModules", "NotificationType", "enterprises", "TimeTicks", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", temperature=temperature, reboot=reboot, internetPort=internetPort, jumblan3=jumblan3, jumblan2=jumblan2, wan=wan, speed=speed, vendorName=vendorName, pauseReceived=pauseReceived, vendorOui=vendorOui, qosIndex=qosIndex, vlan=vlan, fileName=fileName, txPower=txPower, multicastsReceived=multicastsReceived, qmode=qmode, vendorRev=vendorRev, jumb=jumb, jumbwan=jumbwan, portPower=portPower, qosEntry=qosEntry, multicastsTransmitted=multicastsTransmitted, lan3=lan3, serialnum=serialnum, catvEnable=catvEnable, dscpEnable=dscpEnable, secondaryDns=secondaryDns, staticIpGateway=staticIpGateway, vlangroupTable=vlangroupTable, portTable=portTable, wanType=wanType, statisticTable=statisticTable, portIndex=portIndex, voltage=voltage, catv=catv, portName=portName, staticIpAddr=staticIpAddr, jumblan1=jumblan1, lanportspeed=lanportspeed, ddminfo=ddminfo, tftp=tftp, broadcastsTransmitted=broadcastsTransmitted, fcsErrorReceived=fcsErrorReceived, statIndex=statIndex, vendorPn=vendorPn, broadcastsReceived=broadcastsReceived, unicastsReceived=unicastsReceived, portStatEntry=portStatEntry, qmapping=qmapping, lan4=lan4, operStatus=operStatus, qos=qos, jumblan4=jumblan4, lanportTable=lanportTable, domainame=domainame, priority=priority, action=action, vlanid=vlanid, groupIndex=groupIndex, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, primaryDns=primaryDns, hostname=hostname, unicastsTransmitted=unicastsTransmitted, adminStatus=adminStatus, lan2=lan2, lanportName=lanportName, bias=bias, lan1=lan1, groupEntry=groupEntry, port1=port1, port4=port4, portmode=portmode, modeEntry=modeEntry, portStatistic=portStatistic, rxPower=rxPower, fileType=fileType, lanportpause=lanportpause, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, qosTable=qosTable, xg6846=xg6846, port2=port2, rebootEnable=rebootEnable, staticDns=staticDns, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, port3=port3, portEntry=portEntry, fcsErrorTransmitted=fcsErrorTransmitted, deviceinfo=deviceinfo, tftpSevIp=tftpSevIp, pauseTransmitted=pauseTransmitted, lanportIndex=lanportIndex)
