...
TimeTicks, IpAddress, Bits, snmpModules, MibIdentifier, enterprises, Counter32, Integer32, iso, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ObjectIdentity, NotificationType, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Bits", "snmpModules", "MibIdentifier", "enterprises", "Counter32", "Integer32", "iso", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ObjectIdentity", "NotificationType", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", speed=speed, jumblan4=jumblan4, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, rxPower=rxPower, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, portStatistic=portStatistic, ddminfo=ddminfo, portmode=portmode, broadcastsTransmitted=broadcastsTransmitted, voltage=voltage, lanportIndex=lanportIndex, qosEntry=qosEntry, adminStatus=adminStatus, qosTable=qosTable, fileName=fileName, jumb=jumb, jumblan2=jumblan2, jumbwan=jumbwan, priority=priority, reboot=reboot, dscpEnable=dscpEnable, portTable=portTable, vendorPn=vendorPn, portStatEntry=portStatEntry, staticIpPrimaryDns=staticIpPrimaryDns, pauseTransmitted=pauseTransmitted, temperature=temperature, operStatus=operStatus, pauseReceived=pauseReceived, statisticTable=statisticTable, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, staticIpHostName=staticIpHostName, qos=qos, lanportspeed=lanportspeed, qmode=qmode, port3=port3, vlangroupTable=vlangroupTable, portPower=portPower, staticIpAddr=staticIpAddr, groupIndex=groupIndex, modeEntry=modeEntry, qmapping=qmapping, jumblan1=jumblan1, port2=port2, xg6846=xg6846, staticIpSecondaryDns=staticIpSecondaryDns, rebootEnable=rebootEnable, fileType=fileType, wanType=wanType, lanportName=lanportName, action=action, staticDns=staticDns, port4=port4, staticIpDomainName=staticIpDomainName, port1=port1, domainame=domainame, staticIpSubMask=staticIpSubMask, txPower=txPower, lanportTable=lanportTable, lan1=lan1, vlan=vlan, multicastsReceived=multicastsReceived, lanportpause=lanportpause, tftpSevIp=tftpSevIp, vendorName=vendorName, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived, vendorRev=vendorRev, jumblan3=jumblan3, qosIndex=qosIndex, multicastsTransmitted=multicastsTransmitted, catv=catv, lan4=lan4, groupEntry=groupEntry, lan2=lan2, wan=wan, vlanid=vlanid, portIndex=portIndex, fcsErrorTransmitted=fcsErrorTransmitted, primaryDns=primaryDns, vendorOui=vendorOui, serialnum=serialnum, internetPort=internetPort, portEntry=portEntry, statIndex=statIndex, lan3=lan3, hostname=hostname, portName=portName, groupid=groupid, bias=bias, tftp=tftp)
