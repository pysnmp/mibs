...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:28:13 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, iso, NotificationType, mib_2, IpAddress, Bits, Unsigned32, MibIdentifier, ObjectIdentity, Integer32, Counter64, snmpModules, TimeTicks, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "iso", "NotificationType", "mib-2", "IpAddress", "Bits", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Integer32", "Counter64", "snmpModules", "TimeTicks", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan1=lan1, broadcastsReceived=broadcastsReceived, voltage=voltage, txPower=txPower, hostname=hostname, operStatus=operStatus, portStatistic=portStatistic, portEntry=portEntry, pauseTransmitted=pauseTransmitted, wanType=wanType, dscpEnable=dscpEnable, primaryDns=primaryDns, serialnum=serialnum, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, portmode=portmode, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, staticIpSubMask=staticIpSubMask, staticDns=staticDns, staticIpHostName=staticIpHostName, port1=port1, jumblan2=jumblan2, deviceinfo=deviceinfo, multicastsTransmitted=multicastsTransmitted, xg6846=xg6846, action=action, groupid=groupid, portIndex=portIndex, modeEntry=modeEntry, portStatEntry=portStatEntry, qosTable=qosTable, pauseReceived=pauseReceived, rebootEnable=rebootEnable, bias=bias, lanportIndex=lanportIndex, statIndex=statIndex, vlangroupTable=vlangroupTable, speed=speed, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, jumblan4=jumblan4, rxPower=rxPower, portTable=portTable, groupEntry=groupEntry, jumblan1=jumblan1, tftp=tftp, vendorOui=vendorOui, port3=port3, unicastsReceived=unicastsReceived, ddminfo=ddminfo, groupIndex=groupIndex, qosEntry=qosEntry, multicastsReceived=multicastsReceived, lanportspeed=lanportspeed, staticIpSecondaryDns=staticIpSecondaryDns, vendorName=vendorName, fcsErrorTransmitted=fcsErrorTransmitted, staticIpAddr=staticIpAddr, vlanid=vlanid, vendorPn=vendorPn, portPower=portPower, qmapping=qmapping, jumbwan=jumbwan, lan3=lan3, wan=wan, priority=priority, lanportName=lanportName, domainame=domainame, qos=qos, lan4=lan4, fileType=fileType, port2=port2, jumblan3=jumblan3, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, jumb=jumb, portName=portName, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, catv=catv, vlan=vlan, qmode=qmode, internetPort=internetPort, staticIpGateway=staticIpGateway, fileName=fileName, statisticTable=statisticTable, port4=port4, vendorRev=vendorRev, temperature=temperature, reboot=reboot, catvEnable=catvEnable, qosIndex=qosIndex, adminStatus=adminStatus)
