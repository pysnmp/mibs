...
NotificationType, Counter32, IpAddress, Unsigned32, Integer32, MibIdentifier, snmpModules, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, mib_2, TimeTicks, Gauge32, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "IpAddress", "Unsigned32", "Integer32", "MibIdentifier", "snmpModules", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "mib-2", "TimeTicks", "Gauge32", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan3=jumblan3, reboot=reboot, portEntry=portEntry, fileType=fileType, portName=portName, groupIndex=groupIndex, port3=port3, broadcastsTransmitted=broadcastsTransmitted, lanportspeed=lanportspeed, staticIpAddr=staticIpAddr, fcsErrorReceived=fcsErrorReceived, domainame=domainame, portmode=portmode, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsReceived=broadcastsReceived, multicastsTransmitted=multicastsTransmitted, vendorRev=vendorRev, action=action, internetPort=internetPort, staticIpGateway=staticIpGateway, vendorOui=vendorOui, portTable=portTable, bias=bias, xg6846=xg6846, temperature=temperature, statisticTable=statisticTable, secondaryDns=secondaryDns, fileName=fileName, jumbwan=jumbwan, qosEntry=qosEntry, catv=catv, dscpEnable=dscpEnable, wan=wan, staticIpDomainName=staticIpDomainName, tftpSevIp=tftpSevIp, portIndex=portIndex, pauseReceived=pauseReceived, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, priority=priority, qosTable=qosTable, portStatEntry=portStatEntry, txPower=txPower, hostname=hostname, lanportTable=lanportTable, qmode=qmode, multicastsReceived=multicastsReceived, lan2=lan2, port2=port2, qos=qos, staticIpHostName=staticIpHostName, wanType=wanType, jumblan2=jumblan2, port4=port4, lanportIndex=lanportIndex, statIndex=statIndex, deviceinfo=deviceinfo, staticIpSecondaryDns=staticIpSecondaryDns, lan1=lan1, qosIndex=qosIndex, lan4=lan4, portStatistic=portStatistic, catvEnable=catvEnable, rebootEnable=rebootEnable, serialnum=serialnum, pauseTransmitted=pauseTransmitted, portPower=portPower, operStatus=operStatus, vlanid=vlanid, port1=port1, primaryDns=primaryDns, jumblan1=jumblan1, staticDns=staticDns, jumb=jumb, unicastsTransmitted=unicastsTransmitted, speed=speed, vendorPn=vendorPn, modeEntry=modeEntry, ddminfo=ddminfo, adminStatus=adminStatus, vlan=vlan, jumblan4=jumblan4, rxPower=rxPower, qmapping=qmapping, voltage=voltage, lanportName=lanportName, vendorName=vendorName, staticIpSubMask=staticIpSubMask, groupid=groupid, groupEntry=groupEntry, lanportpause=lanportpause, lan3=lan3, tftp=tftp)
