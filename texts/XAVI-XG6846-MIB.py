...
snmpModules, Counter32, Integer32, Bits, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, NotificationType, Unsigned32, MibIdentifier, ObjectIdentity, ModuleIdentity, TimeTicks, mib_2, iso = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Counter32", "Integer32", "Bits", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "NotificationType", "Unsigned32", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "mib-2", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", bias=bias, lanportTable=lanportTable, reboot=reboot, wanType=wanType, operStatus=operStatus, multicastsReceived=multicastsReceived, jumblan3=jumblan3, jumbwan=jumbwan, statisticTable=statisticTable, qosIndex=qosIndex, tftp=tftp, port1=port1, vendorRev=vendorRev, qmode=qmode, broadcastsReceived=broadcastsReceived, multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, jumblan2=jumblan2, jumb=jumb, portIndex=portIndex, pauseTransmitted=pauseTransmitted, statIndex=statIndex, hostname=hostname, groupEntry=groupEntry, rxPower=rxPower, txPower=txPower, broadcastsTransmitted=broadcastsTransmitted, voltage=voltage, unicastsReceived=unicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, catv=catv, lan2=lan2, unicastsTransmitted=unicastsTransmitted, primaryDns=primaryDns, fcsErrorReceived=fcsErrorReceived, lan1=lan1, portEntry=portEntry, pauseReceived=pauseReceived, groupIndex=groupIndex, lan3=lan3, lanportIndex=lanportIndex, deviceinfo=deviceinfo, fcsErrorTransmitted=fcsErrorTransmitted, serialnum=serialnum, vlan=vlan, ddminfo=ddminfo, fileType=fileType, jumblan1=jumblan1, staticIpPrimaryDns=staticIpPrimaryDns, adminStatus=adminStatus, lanportpause=lanportpause, wan=wan, dscpEnable=dscpEnable, qosEntry=qosEntry, vlanid=vlanid, vlangroupTable=vlangroupTable, staticIpAddr=staticIpAddr, tftpSevIp=tftpSevIp, rebootEnable=rebootEnable, portStatistic=portStatistic, qosTable=qosTable, qos=qos, port4=port4, portmode=portmode, modeEntry=modeEntry, lan4=lan4, staticIpDomainName=staticIpDomainName, portTable=portTable, staticIpHostName=staticIpHostName, lanportName=lanportName, jumblan4=jumblan4, temperature=temperature, vendorPn=vendorPn, xg6846=xg6846, port2=port2, priority=priority, secondaryDns=secondaryDns, catvEnable=catvEnable, speed=speed, portPower=portPower, groupid=groupid, portStatEntry=portStatEntry, port3=port3, staticDns=staticDns, qmapping=qmapping, vendorName=vendorName, portName=portName, internetPort=internetPort, fileName=fileName, staticIpGateway=staticIpGateway, lanportspeed=lanportspeed, domainame=domainame, action=action, staticIpSubMask=staticIpSubMask)
