...
Unsigned32, Gauge32, snmpModules, Counter64, ObjectIdentity, NotificationType, mib_2, TimeTicks, MibIdentifier, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, iso, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "snmpModules", "Counter64", "ObjectIdentity", "NotificationType", "mib-2", "TimeTicks", "MibIdentifier", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "iso", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, speed=speed, rebootEnable=rebootEnable, vendorName=vendorName, pauseTransmitted=pauseTransmitted, lanportName=lanportName, vlangroupTable=vlangroupTable, deviceinfo=deviceinfo, voltage=voltage, internetPort=internetPort, modeEntry=modeEntry, serialnum=serialnum, vendorRev=vendorRev, staticIpSubMask=staticIpSubMask, action=action, lan3=lan3, txPower=txPower, portName=portName, qosIndex=qosIndex, operStatus=operStatus, portEntry=portEntry, portPower=portPower, portTable=portTable, temperature=temperature, catvEnable=catvEnable, qosTable=qosTable, tftp=tftp, statisticTable=statisticTable, hostname=hostname, port3=port3, qosEntry=qosEntry, portStatistic=portStatistic, groupEntry=groupEntry, qmapping=qmapping, portStatEntry=portStatEntry, adminStatus=adminStatus, port2=port2, lanportIndex=lanportIndex, port4=port4, broadcastsTransmitted=broadcastsTransmitted, lanportTable=lanportTable, priority=priority, lan1=lan1, lan4=lan4, jumbwan=jumbwan, pauseReceived=pauseReceived, vendorOui=vendorOui, rxPower=rxPower, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, unicastsTransmitted=unicastsTransmitted, reboot=reboot, fileType=fileType, xg6846=xg6846, unicastsReceived=unicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, multicastsReceived=multicastsReceived, jumblan1=jumblan1, lan2=lan2, vlanid=vlanid, groupIndex=groupIndex, vendorPn=vendorPn, staticDns=staticDns, port1=port1, jumblan3=jumblan3, groupid=groupid, primaryDns=primaryDns, staticIpHostName=staticIpHostName, jumb=jumb, staticIpSecondaryDns=staticIpSecondaryDns, multicastsTransmitted=multicastsTransmitted, ddminfo=ddminfo, jumblan4=jumblan4, lanportpause=lanportpause, vlan=vlan, portIndex=portIndex, staticIpGateway=staticIpGateway, wan=wan, dscpEnable=dscpEnable, wanType=wanType, statIndex=statIndex, secondaryDns=secondaryDns, jumblan2=jumblan2, qos=qos, lanportspeed=lanportspeed, qmode=qmode, staticIpDomainName=staticIpDomainName, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsReceived=broadcastsReceived, domainame=domainame, fileName=fileName, bias=bias, portmode=portmode, tftpSevIp=tftpSevIp)
