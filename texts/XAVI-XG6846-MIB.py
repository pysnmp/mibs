...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Counter32, TimeTicks, Bits, Gauge32, enterprises, MibIdentifier, Integer32, snmpModules, mib_2, Unsigned32, IpAddress, NotificationType, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Counter32", "TimeTicks", "Bits", "Gauge32", "enterprises", "MibIdentifier", "Integer32", "snmpModules", "mib-2", "Unsigned32", "IpAddress", "NotificationType", "Counter64", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", dscpEnable=dscpEnable, voltage=voltage, staticIpHostName=staticIpHostName, pauseTransmitted=pauseTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, deviceinfo=deviceinfo, qmode=qmode, lan2=lan2, qosEntry=qosEntry, statisticTable=statisticTable, serialnum=serialnum, lanportspeed=lanportspeed, ddminfo=ddminfo, lan4=lan4, staticIpSubMask=staticIpSubMask, vlan=vlan, secondaryDns=secondaryDns, xg6846=xg6846, modeEntry=modeEntry, qosIndex=qosIndex, jumblan4=jumblan4, pauseReceived=pauseReceived, broadcastsTransmitted=broadcastsTransmitted, bias=bias, portIndex=portIndex, wanType=wanType, portName=portName, jumblan2=jumblan2, statIndex=statIndex, vendorRev=vendorRev, qmapping=qmapping, jumblan3=jumblan3, portmode=portmode, domainame=domainame, portTable=portTable, action=action, groupid=groupid, unicastsReceived=unicastsReceived, rxPower=rxPower, lanportTable=lanportTable, fileType=fileType, jumb=jumb, port1=port1, groupEntry=groupEntry, multicastsTransmitted=multicastsTransmitted, lanportName=lanportName, qosTable=qosTable, vendorOui=vendorOui, fileName=fileName, staticIpDomainName=staticIpDomainName, portPower=portPower, broadcastsReceived=broadcastsReceived, lanportIndex=lanportIndex, portStatEntry=portStatEntry, lan3=lan3, txPower=txPower, catvEnable=catvEnable, adminStatus=adminStatus, fcsErrorTransmitted=fcsErrorTransmitted, jumbwan=jumbwan, portEntry=portEntry, reboot=reboot, vlangroupTable=vlangroupTable, lan1=lan1, vendorPn=vendorPn, catv=catv, port2=port2, hostname=hostname, temperature=temperature, staticIpGateway=staticIpGateway, vendorName=vendorName, tftpSevIp=tftpSevIp, unicastsTransmitted=unicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, internetPort=internetPort, qos=qos, fcsErrorReceived=fcsErrorReceived, port3=port3, speed=speed, staticIpAddr=staticIpAddr, primaryDns=primaryDns, jumblan1=jumblan1, port4=port4, priority=priority, groupIndex=groupIndex, staticDns=staticDns, rebootEnable=rebootEnable, wan=wan, tftp=tftp, multicastsReceived=multicastsReceived, operStatus=operStatus, lanportpause=lanportpause, vlanid=vlanid, portStatistic=portStatistic)
