...
enterprises, Counter64, MibIdentifier, iso, ModuleIdentity, snmpModules, Integer32, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, IpAddress, Counter32, Unsigned32, Bits, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "MibIdentifier", "iso", "ModuleIdentity", "snmpModules", "Integer32", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "IpAddress", "Counter32", "Unsigned32", "Bits", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, portName=portName, pauseReceived=pauseReceived, speed=speed, vlanid=vlanid, groupid=groupid, portStatistic=portStatistic, vlan=vlan, primaryDns=primaryDns, tftpSevIp=tftpSevIp, portPower=portPower, vlangroupTable=vlangroupTable, xg6846=xg6846, lanportName=lanportName, lan3=lan3, staticIpHostName=staticIpHostName, statIndex=statIndex, action=action, jumblan1=jumblan1, staticIpPrimaryDns=staticIpPrimaryDns, lan1=lan1, voltage=voltage, portStatEntry=portStatEntry, broadcastsTransmitted=broadcastsTransmitted, domainame=domainame, staticIpAddr=staticIpAddr, lan4=lan4, staticIpSecondaryDns=staticIpSecondaryDns, portEntry=portEntry, jumblan2=jumblan2, vendorOui=vendorOui, port1=port1, vendorPn=vendorPn, reboot=reboot, groupEntry=groupEntry, rebootEnable=rebootEnable, serialnum=serialnum, staticIpSubMask=staticIpSubMask, staticDns=staticDns, portTable=portTable, pauseTransmitted=pauseTransmitted, qos=qos, fcsErrorReceived=fcsErrorReceived, jumbwan=jumbwan, jumb=jumb, operStatus=operStatus, port2=port2, portmode=portmode, multicastsTransmitted=multicastsTransmitted, priority=priority, staticIpDomainName=staticIpDomainName, temperature=temperature, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, multicastsReceived=multicastsReceived, qosEntry=qosEntry, staticIpGateway=staticIpGateway, secondaryDns=secondaryDns, statisticTable=statisticTable, ddminfo=ddminfo, fcsErrorTransmitted=fcsErrorTransmitted, bias=bias, port4=port4, vendorRev=vendorRev, qmapping=qmapping, qosIndex=qosIndex, qosTable=qosTable, qmode=qmode, wan=wan, deviceinfo=deviceinfo, unicastsReceived=unicastsReceived, port3=port3, txPower=txPower, wanType=wanType, hostname=hostname, broadcastsReceived=broadcastsReceived, lan2=lan2, internetPort=internetPort, lanportIndex=lanportIndex, rxPower=rxPower, modeEntry=modeEntry, jumblan4=jumblan4, fileType=fileType, fileName=fileName, tftp=tftp, vendorName=vendorName, lanportpause=lanportpause, portIndex=portIndex, dscpEnable=dscpEnable, catvEnable=catvEnable, catv=catv, adminStatus=adminStatus, jumblan3=jumblan3, lanportTable=lanportTable)
