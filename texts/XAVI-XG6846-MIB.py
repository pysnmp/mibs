...
# Produced by pysmi-1.1.8 at Mon Jan  9 11:05:58 2023
...
NotificationType, enterprises, Counter64, IpAddress, MibIdentifier, Integer32, TimeTicks, Bits, ModuleIdentity, Counter32, snmpModules, iso, Gauge32, ObjectIdentity, Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "Counter64", "IpAddress", "MibIdentifier", "Integer32", "TimeTicks", "Bits", "ModuleIdentity", "Counter32", "snmpModules", "iso", "Gauge32", "ObjectIdentity", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", bias=bias, port1=port1, port4=port4, unicastsReceived=unicastsReceived, lanportIndex=lanportIndex, action=action, jumbwan=jumbwan, groupEntry=groupEntry, primaryDns=primaryDns, vendorRev=vendorRev, staticIpGateway=staticIpGateway, adminStatus=adminStatus, deviceinfo=deviceinfo, portIndex=portIndex, internetPort=internetPort, portEntry=portEntry, qmode=qmode, tftpSevIp=tftpSevIp, groupIndex=groupIndex, lanportName=lanportName, operStatus=operStatus, jumblan4=jumblan4, portStatEntry=portStatEntry, portTable=portTable, unicastsTransmitted=unicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, voltage=voltage, portPower=portPower, rxPower=rxPower, portmode=portmode, vlangroupTable=vlangroupTable, speed=speed, txPower=txPower, fcsErrorReceived=fcsErrorReceived, lan3=lan3, lanportTable=lanportTable, staticIpPrimaryDns=staticIpPrimaryDns, modeEntry=modeEntry, jumblan2=jumblan2, jumb=jumb, catv=catv, vlanid=vlanid, wanType=wanType, groupid=groupid, lan1=lan1, statisticTable=statisticTable, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, pauseTransmitted=pauseTransmitted, catvEnable=catvEnable, vendorPn=vendorPn, domainame=domainame, fileType=fileType, qmapping=qmapping, multicastsReceived=multicastsReceived, reboot=reboot, vlan=vlan, qosTable=qosTable, vendorOui=vendorOui, staticIpSubMask=staticIpSubMask, lan4=lan4, serialnum=serialnum, secondaryDns=secondaryDns, port2=port2, port3=port3, lanportspeed=lanportspeed, tftp=tftp, hostname=hostname, dscpEnable=dscpEnable, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, multicastsTransmitted=multicastsTransmitted, temperature=temperature, fileName=fileName, fcsErrorTransmitted=fcsErrorTransmitted, wan=wan, portName=portName, priority=priority, rebootEnable=rebootEnable, portStatistic=portStatistic, lanportpause=lanportpause, lan2=lan2, ddminfo=ddminfo, statIndex=statIndex, qos=qos, staticIpSecondaryDns=staticIpSecondaryDns, vendorName=vendorName, qosEntry=qosEntry, staticIpAddr=staticIpAddr, jumblan1=jumblan1, staticDns=staticDns, jumblan3=jumblan3, qosIndex=qosIndex)
