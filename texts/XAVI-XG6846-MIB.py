...
# Produced by pysmi-1.1.8 at Thu Oct 26 10:17:13 2023
...
mib_2, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, snmpModules, TimeTicks, Unsigned32, Gauge32, Integer32, Bits, Counter64, NotificationType, ObjectIdentity, enterprises, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "snmpModules", "TimeTicks", "Unsigned32", "Gauge32", "Integer32", "Bits", "Counter64", "NotificationType", "ObjectIdentity", "enterprises", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", speed=speed, jumblan4=jumblan4, portStatistic=portStatistic, adminStatus=adminStatus, tftp=tftp, vlan=vlan, hostname=hostname, lanportIndex=lanportIndex, fileName=fileName, reboot=reboot, internetPort=internetPort, secondaryDns=secondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, qmode=qmode, vendorName=vendorName, catv=catv, broadcastsReceived=broadcastsReceived, operStatus=operStatus, rxPower=rxPower, portPower=portPower, qos=qos, domainame=domainame, primaryDns=primaryDns, wan=wan, pauseReceived=pauseReceived, lanportspeed=lanportspeed, port3=port3, wanType=wanType, staticIpSubMask=staticIpSubMask, portIndex=portIndex, txPower=txPower, lanportName=lanportName, lan3=lan3, voltage=voltage, fileType=fileType, groupEntry=groupEntry, groupIndex=groupIndex, unicastsReceived=unicastsReceived, vendorPn=vendorPn, vendorOui=vendorOui, lanportpause=lanportpause, fcsErrorReceived=fcsErrorReceived, qosTable=qosTable, staticDns=staticDns, serialnum=serialnum, portName=portName, dscpEnable=dscpEnable, multicastsReceived=multicastsReceived, portmode=portmode, catvEnable=catvEnable, vlanid=vlanid, staticIpDomainName=staticIpDomainName, groupid=groupid, statisticTable=statisticTable, tftpSevIp=tftpSevIp, temperature=temperature, xg6846=xg6846, qmapping=qmapping, ddminfo=ddminfo, rebootEnable=rebootEnable, jumblan1=jumblan1, statIndex=statIndex, broadcastsTransmitted=broadcastsTransmitted, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, portStatEntry=portStatEntry, staticIpAddr=staticIpAddr, lan2=lan2, modeEntry=modeEntry, bias=bias, staticIpHostName=staticIpHostName, port4=port4, lan4=lan4, jumbwan=jumbwan, priority=priority, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, qosIndex=qosIndex, pauseTransmitted=pauseTransmitted, portEntry=portEntry, jumblan2=jumblan2, qosEntry=qosEntry, vlangroupTable=vlangroupTable, vendorRev=vendorRev, port2=port2, lanportTable=lanportTable, lan1=lan1, multicastsTransmitted=multicastsTransmitted, staticIpGateway=staticIpGateway, action=action, portTable=portTable, jumblan3=jumblan3, jumb=jumb, staticIpSecondaryDns=staticIpSecondaryDns)
