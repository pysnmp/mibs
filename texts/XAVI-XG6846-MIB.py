...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:10:05 2022
...
NotificationType, MibIdentifier, Gauge32, mib_2, Counter32, ObjectIdentity, ModuleIdentity, enterprises, Counter64, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, IpAddress, TimeTicks, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Gauge32", "mib-2", "Counter32", "ObjectIdentity", "ModuleIdentity", "enterprises", "Counter64", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "IpAddress", "TimeTicks", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumbwan=jumbwan, serialnum=serialnum, deviceinfo=deviceinfo, qmode=qmode, vlanid=vlanid, vendorRev=vendorRev, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, fcsErrorReceived=fcsErrorReceived, txPower=txPower, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, tftp=tftp, primaryDns=primaryDns, vendorName=vendorName, pauseReceived=pauseReceived, fileName=fileName, lan3=lan3, staticIpSubMask=staticIpSubMask, vendorPn=vendorPn, groupIndex=groupIndex, staticIpGateway=staticIpGateway, xg6846=xg6846, port1=port1, jumb=jumb, groupEntry=groupEntry, broadcastsReceived=broadcastsReceived, speed=speed, domainame=domainame, voltage=voltage, multicastsTransmitted=multicastsTransmitted, catv=catv, qmapping=qmapping, bias=bias, rebootEnable=rebootEnable, internetPort=internetPort, wanType=wanType, statisticTable=statisticTable, lanportName=lanportName, ddminfo=ddminfo, reboot=reboot, hostname=hostname, portmode=portmode, statIndex=statIndex, jumblan1=jumblan1, rxPower=rxPower, portName=portName, jumblan4=jumblan4, portStatistic=portStatistic, groupid=groupid, qosEntry=qosEntry, priority=priority, catvEnable=catvEnable, portEntry=portEntry, pauseTransmitted=pauseTransmitted, portPower=portPower, fileType=fileType, adminStatus=adminStatus, wan=wan, action=action, multicastsReceived=multicastsReceived, staticIpDomainName=staticIpDomainName, operStatus=operStatus, lanportpause=lanportpause, qosIndex=qosIndex, qosTable=qosTable, jumblan3=jumblan3, qos=qos, jumblan2=jumblan2, lanportTable=lanportTable, lan2=lan2, staticDns=staticDns, port3=port3, dscpEnable=dscpEnable, lanportIndex=lanportIndex, staticIpAddr=staticIpAddr, portStatEntry=portStatEntry, vendorOui=vendorOui, broadcastsTransmitted=broadcastsTransmitted, port4=port4, fcsErrorTransmitted=fcsErrorTransmitted, staticIpHostName=staticIpHostName, modeEntry=modeEntry, portTable=portTable, lan1=lan1, vlangroupTable=vlangroupTable, unicastsReceived=unicastsReceived, port2=port2, tftpSevIp=tftpSevIp, vlan=vlan, lan4=lan4, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, portIndex=portIndex)
