...
ModuleIdentity, Counter64, enterprises, mib_2, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, ObjectIdentity, Unsigned32, MibIdentifier, snmpModules, Integer32, NotificationType, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "enterprises", "mib-2", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "snmpModules", "Integer32", "NotificationType", "Counter32", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", bias=bias, vlan=vlan, lanportIndex=lanportIndex, statIndex=statIndex, tftp=tftp, qosEntry=qosEntry, catvEnable=catvEnable, modeEntry=modeEntry, portStatEntry=portStatEntry, groupIndex=groupIndex, jumblan2=jumblan2, pauseTransmitted=pauseTransmitted, lanportpause=lanportpause, multicastsTransmitted=multicastsTransmitted, vlanid=vlanid, groupid=groupid, portTable=portTable, qos=qos, qmapping=qmapping, pauseReceived=pauseReceived, action=action, vendorPn=vendorPn, rebootEnable=rebootEnable, jumblan1=jumblan1, jumblan4=jumblan4, portEntry=portEntry, portPower=portPower, staticIpHostName=staticIpHostName, groupEntry=groupEntry, wanType=wanType, xg6846=xg6846, staticIpAddr=staticIpAddr, vendorOui=vendorOui, rxPower=rxPower, statisticTable=statisticTable, serialnum=serialnum, speed=speed, broadcastsReceived=broadcastsReceived, staticIpDomainName=staticIpDomainName, reboot=reboot, dscpEnable=dscpEnable, portmode=portmode, multicastsReceived=multicastsReceived, lanportName=lanportName, jumb=jumb, hostname=hostname, vendorName=vendorName, port4=port4, ddminfo=ddminfo, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, qosIndex=qosIndex, internetPort=internetPort, domainame=domainame, txPower=txPower, portName=portName, lan4=lan4, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, port2=port2, fileName=fileName, catv=catv, lan3=lan3, fileType=fileType, tftpSevIp=tftpSevIp, staticDns=staticDns, lan2=lan2, portIndex=portIndex, vendorRev=vendorRev, voltage=voltage, lanportspeed=lanportspeed, port1=port1, port3=port3, fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, qosTable=qosTable, deviceinfo=deviceinfo, broadcastsTransmitted=broadcastsTransmitted, wan=wan, unicastsReceived=unicastsReceived, primaryDns=primaryDns, qmode=qmode, temperature=temperature, secondaryDns=secondaryDns, portStatistic=portStatistic, fcsErrorReceived=fcsErrorReceived, operStatus=operStatus, priority=priority, vlangroupTable=vlangroupTable, jumbwan=jumbwan, lan1=lan1, adminStatus=adminStatus, lanportTable=lanportTable)
