...
Counter64, Gauge32, TimeTicks, snmpModules, Integer32, enterprises, Bits, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Unsigned32, mib_2, IpAddress, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "TimeTicks", "snmpModules", "Integer32", "enterprises", "Bits", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Unsigned32", "mib-2", "IpAddress", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", secondaryDns=secondaryDns, reboot=reboot, port3=port3, pauseTransmitted=pauseTransmitted, qos=qos, lan4=lan4, adminStatus=adminStatus, staticDns=staticDns, vendorRev=vendorRev, hostname=hostname, groupIndex=groupIndex, jumblan2=jumblan2, action=action, bias=bias, portIndex=portIndex, vlan=vlan, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, jumblan1=jumblan1, internetPort=internetPort, lanportTable=lanportTable, staticIpSecondaryDns=staticIpSecondaryDns, temperature=temperature, vendorName=vendorName, rebootEnable=rebootEnable, modeEntry=modeEntry, portTable=portTable, pauseReceived=pauseReceived, lan1=lan1, lanportIndex=lanportIndex, unicastsTransmitted=unicastsTransmitted, lanportpause=lanportpause, voltage=voltage, tftp=tftp, qosEntry=qosEntry, fcsErrorReceived=fcsErrorReceived, vlanid=vlanid, portName=portName, vlangroupTable=vlangroupTable, deviceinfo=deviceinfo, operStatus=operStatus, staticIpHostName=staticIpHostName, fileName=fileName, port1=port1, fileType=fileType, statisticTable=statisticTable, portPower=portPower, staticIpSubMask=staticIpSubMask, lanportspeed=lanportspeed, portmode=portmode, portStatEntry=portStatEntry, portEntry=portEntry, jumblan3=jumblan3, staticIpAddr=staticIpAddr, jumbwan=jumbwan, vendorPn=vendorPn, lan3=lan3, port2=port2, txPower=txPower, tftpSevIp=tftpSevIp, qosIndex=qosIndex, jumb=jumb, catv=catv, groupid=groupid, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, qosTable=qosTable, broadcastsReceived=broadcastsReceived, multicastsReceived=multicastsReceived, dscpEnable=dscpEnable, jumblan4=jumblan4, primaryDns=primaryDns, statIndex=statIndex, serialnum=serialnum, rxPower=rxPower, portStatistic=portStatistic, lan2=lan2, groupEntry=groupEntry, multicastsTransmitted=multicastsTransmitted, xg6846=xg6846, fcsErrorTransmitted=fcsErrorTransmitted, port4=port4, wan=wan, wanType=wanType, qmapping=qmapping, qmode=qmode, domainame=domainame, ddminfo=ddminfo, lanportName=lanportName, staticIpGateway=staticIpGateway, staticIpDomainName=staticIpDomainName, catvEnable=catvEnable, unicastsReceived=unicastsReceived, priority=priority)
