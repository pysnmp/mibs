...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:24:05 2022
...
Integer32, IpAddress, ObjectIdentity, NotificationType, Bits, Counter64, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, ModuleIdentity, TimeTicks, mib_2, Gauge32, MibIdentifier, Unsigned32, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "ObjectIdentity", "NotificationType", "Bits", "Counter64", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "ModuleIdentity", "TimeTicks", "mib-2", "Gauge32", "MibIdentifier", "Unsigned32", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", broadcastsTransmitted=broadcastsTransmitted, port1=port1, lanportTable=lanportTable, bias=bias, vendorName=vendorName, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, portStatistic=portStatistic, qmode=qmode, qos=qos, action=action, fcsErrorTransmitted=fcsErrorTransmitted, vlangroupTable=vlangroupTable, jumblan1=jumblan1, serialnum=serialnum, dscpEnable=dscpEnable, vlanid=vlanid, domainame=domainame, operStatus=operStatus, tftp=tftp, qosTable=qosTable, wanType=wanType, staticIpAddr=staticIpAddr, port2=port2, ddminfo=ddminfo, qosEntry=qosEntry, lanportpause=lanportpause, rxPower=rxPower, pauseTransmitted=pauseTransmitted, portName=portName, staticIpSecondaryDns=staticIpSecondaryDns, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, lanportspeed=lanportspeed, reboot=reboot, staticIpSubMask=staticIpSubMask, lan4=lan4, deviceinfo=deviceinfo, lan1=lan1, priority=priority, jumbwan=jumbwan, modeEntry=modeEntry, groupid=groupid, secondaryDns=secondaryDns, portIndex=portIndex, lan2=lan2, voltage=voltage, jumblan4=jumblan4, qosIndex=qosIndex, primaryDns=primaryDns, fileName=fileName, staticIpDomainName=staticIpDomainName, hostname=hostname, vendorOui=vendorOui, internetPort=internetPort, jumblan3=jumblan3, vlan=vlan, lanportName=lanportName, speed=speed, multicastsReceived=multicastsReceived, qmapping=qmapping, statisticTable=statisticTable, vendorPn=vendorPn, jumb=jumb, portTable=portTable, tftpSevIp=tftpSevIp, catv=catv, staticDns=staticDns, portEntry=portEntry, portPower=portPower, unicastsTransmitted=unicastsTransmitted, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, vendorRev=vendorRev, lan3=lan3, rebootEnable=rebootEnable, groupEntry=groupEntry, portStatEntry=portStatEntry, statIndex=statIndex, port4=port4, temperature=temperature, txPower=txPower, catvEnable=catvEnable, staticIpPrimaryDns=staticIpPrimaryDns, portmode=portmode, staticIpHostName=staticIpHostName, port3=port3, lanportIndex=lanportIndex, adminStatus=adminStatus, fileType=fileType, jumblan2=jumblan2, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, wan=wan)
