...
enterprises, Bits, ModuleIdentity, mib_2, NotificationType, Unsigned32, MibIdentifier, Integer32, IpAddress, Counter64, Gauge32, snmpModules, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "ModuleIdentity", "mib-2", "NotificationType", "Unsigned32", "MibIdentifier", "Integer32", "IpAddress", "Counter64", "Gauge32", "snmpModules", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorRev=vendorRev, lanportIndex=lanportIndex, jumblan2=jumblan2, port2=port2, unicastsTransmitted=unicastsTransmitted, portName=portName, operStatus=operStatus, domainame=domainame, primaryDns=primaryDns, qosIndex=qosIndex, lanportpause=lanportpause, groupEntry=groupEntry, multicastsTransmitted=multicastsTransmitted, internetPort=internetPort, jumblan1=jumblan1, voltage=voltage, temperature=temperature, groupid=groupid, modeEntry=modeEntry, groupIndex=groupIndex, pauseTransmitted=pauseTransmitted, jumblan3=jumblan3, qosTable=qosTable, txPower=txPower, jumbwan=jumbwan, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, catvEnable=catvEnable, rebootEnable=rebootEnable, port1=port1, priority=priority, pauseReceived=pauseReceived, vendorOui=vendorOui, serialnum=serialnum, vendorPn=vendorPn, staticDns=staticDns, fileType=fileType, port4=port4, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, jumb=jumb, staticIpDomainName=staticIpDomainName, unicastsReceived=unicastsReceived, action=action, dscpEnable=dscpEnable, portTable=portTable, secondaryDns=secondaryDns, portStatEntry=portStatEntry, vlan=vlan, hostname=hostname, staticIpPrimaryDns=staticIpPrimaryDns, catv=catv, speed=speed, lan1=lan1, vlanid=vlanid, qos=qos, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, broadcastsReceived=broadcastsReceived, qosEntry=qosEntry, portEntry=portEntry, tftp=tftp, staticIpHostName=staticIpHostName, wan=wan, staticIpGateway=staticIpGateway, wanType=wanType, lanportName=lanportName, lan2=lan2, fileName=fileName, bias=bias, portmode=portmode, rxPower=rxPower, qmode=qmode, fcsErrorReceived=fcsErrorReceived, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus, xg6846=xg6846, statisticTable=statisticTable, ddminfo=ddminfo, reboot=reboot, jumblan4=jumblan4, lan4=lan4, vendorName=vendorName, staticIpAddr=staticIpAddr, portStatistic=portStatistic, port3=port3, lanportspeed=lanportspeed, statIndex=statIndex, multicastsReceived=multicastsReceived, portPower=portPower, deviceinfo=deviceinfo, vlangroupTable=vlangroupTable, portIndex=portIndex)
