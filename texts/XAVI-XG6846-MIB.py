...
Counter64, Unsigned32, iso, Counter32, snmpModules, Bits, MibIdentifier, ObjectIdentity, enterprises, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, mib_2, IpAddress, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "iso", "Counter32", "snmpModules", "Bits", "MibIdentifier", "ObjectIdentity", "enterprises", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "mib-2", "IpAddress", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupid=groupid, portEntry=portEntry, fcsErrorTransmitted=fcsErrorTransmitted, staticDns=staticDns, port2=port2, serialnum=serialnum, fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, jumblan3=jumblan3, primaryDns=primaryDns, port3=port3, unicastsTransmitted=unicastsTransmitted, lan4=lan4, wan=wan, vlangroupTable=vlangroupTable, speed=speed, pauseTransmitted=pauseTransmitted, jumblan2=jumblan2, broadcastsReceived=broadcastsReceived, qosTable=qosTable, qos=qos, deviceinfo=deviceinfo, multicastsTransmitted=multicastsTransmitted, temperature=temperature, domainame=domainame, qosIndex=qosIndex, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, fileName=fileName, vendorName=vendorName, wanType=wanType, portStatEntry=portStatEntry, lan1=lan1, statIndex=statIndex, rebootEnable=rebootEnable, rxPower=rxPower, operStatus=operStatus, catvEnable=catvEnable, portStatistic=portStatistic, tftpSevIp=tftpSevIp, voltage=voltage, staticIpHostName=staticIpHostName, adminStatus=adminStatus, port4=port4, secondaryDns=secondaryDns, qmode=qmode, staticIpSubMask=staticIpSubMask, lanportspeed=lanportspeed, portIndex=portIndex, tftp=tftp, bias=bias, modeEntry=modeEntry, staticIpGateway=staticIpGateway, lanportName=lanportName, portPower=portPower, portTable=portTable, staticIpPrimaryDns=staticIpPrimaryDns, fileType=fileType, xg6846=xg6846, ddminfo=ddminfo, lan3=lan3, priority=priority, staticIpSecondaryDns=staticIpSecondaryDns, port1=port1, unicastsReceived=unicastsReceived, qmapping=qmapping, portName=portName, dscpEnable=dscpEnable, reboot=reboot, groupIndex=groupIndex, vendorRev=vendorRev, lanportpause=lanportpause, portmode=portmode, lanportIndex=lanportIndex, hostname=hostname, txPower=txPower, jumblan1=jumblan1, multicastsReceived=multicastsReceived, lanportTable=lanportTable, jumb=jumb, jumblan4=jumblan4, vlan=vlan, internetPort=internetPort, vlanid=vlanid, jumbwan=jumbwan, vendorOui=vendorOui, vendorPn=vendorPn, qosEntry=qosEntry, statisticTable=statisticTable, action=action, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, pauseReceived=pauseReceived, catv=catv)
