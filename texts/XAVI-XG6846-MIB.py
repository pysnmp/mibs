...
# Produced by pysmi-1.1.3 at Sun Nov 28 13:54:53 2021
...
mib_2, enterprises, IpAddress, TimeTicks, NotificationType, iso, Unsigned32, MibIdentifier, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Gauge32, Counter64, Bits, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "enterprises", "IpAddress", "TimeTicks", "NotificationType", "iso", "Unsigned32", "MibIdentifier", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Gauge32", "Counter64", "Bits", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, lanportTable=lanportTable, portName=portName, jumbwan=jumbwan, multicastsTransmitted=multicastsTransmitted, staticIpAddr=staticIpAddr, unicastsReceived=unicastsReceived, portIndex=portIndex, portStatistic=portStatistic, lan2=lan2, staticIpHostName=staticIpHostName, pauseReceived=pauseReceived, staticIpGateway=staticIpGateway, vlangroupTable=vlangroupTable, jumblan4=jumblan4, rxPower=rxPower, fileName=fileName, modeEntry=modeEntry, pauseTransmitted=pauseTransmitted, port1=port1, tftp=tftp, qmapping=qmapping, bias=bias, lanportspeed=lanportspeed, portStatEntry=portStatEntry, portmode=portmode, tftpSevIp=tftpSevIp, broadcastsTransmitted=broadcastsTransmitted, dscpEnable=dscpEnable, lan4=lan4, wanType=wanType, qos=qos, voltage=voltage, lanportpause=lanportpause, vendorRev=vendorRev, action=action, port4=port4, portPower=portPower, qosTable=qosTable, adminStatus=adminStatus, lanportIndex=lanportIndex, staticIpPrimaryDns=staticIpPrimaryDns, internetPort=internetPort, staticIpSubMask=staticIpSubMask, statIndex=statIndex, secondaryDns=secondaryDns, primaryDns=primaryDns, ddminfo=ddminfo, lan1=lan1, multicastsReceived=multicastsReceived, lanportName=lanportName, staticDns=staticDns, serialnum=serialnum, groupEntry=groupEntry, groupIndex=groupIndex, txPower=txPower, staticIpDomainName=staticIpDomainName, vlanid=vlanid, groupid=groupid, wan=wan, jumblan2=jumblan2, temperature=temperature, xg6846=xg6846, domainame=domainame, hostname=hostname, rebootEnable=rebootEnable, port3=port3, qosEntry=qosEntry, vendorOui=vendorOui, jumblan3=jumblan3, deviceinfo=deviceinfo, priority=priority, qmode=qmode, fileType=fileType, portTable=portTable, jumb=jumb, lan3=lan3, jumblan1=jumblan1, vendorPn=vendorPn, speed=speed, unicastsTransmitted=unicastsTransmitted, qosIndex=qosIndex, port2=port2, fcsErrorReceived=fcsErrorReceived, fcsErrorTransmitted=fcsErrorTransmitted, catv=catv, statisticTable=statisticTable, vlan=vlan, portEntry=portEntry, operStatus=operStatus, vendorName=vendorName)
