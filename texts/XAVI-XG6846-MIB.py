...
Integer32, Counter32, Unsigned32, TimeTicks, NotificationType, snmpModules, Bits, ObjectIdentity, Counter64, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, MibIdentifier, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Unsigned32", "TimeTicks", "NotificationType", "snmpModules", "Bits", "ObjectIdentity", "Counter64", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "MibIdentifier", "ModuleIdentity", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorName=vendorName, action=action, priority=priority, staticIpSubMask=staticIpSubMask, unicastsReceived=unicastsReceived, pauseTransmitted=pauseTransmitted, statisticTable=statisticTable, portEntry=portEntry, operStatus=operStatus, fcsErrorReceived=fcsErrorReceived, internetPort=internetPort, jumb=jumb, groupIndex=groupIndex, groupid=groupid, lanportTable=lanportTable, staticIpHostName=staticIpHostName, port1=port1, qosTable=qosTable, portPower=portPower, bias=bias, port3=port3, modeEntry=modeEntry, lan3=lan3, jumblan3=jumblan3, ddminfo=ddminfo, tftpSevIp=tftpSevIp, lanportspeed=lanportspeed, dscpEnable=dscpEnable, portName=portName, fileName=fileName, staticIpSecondaryDns=staticIpSecondaryDns, lanportName=lanportName, pauseReceived=pauseReceived, wanType=wanType, lan1=lan1, port4=port4, deviceinfo=deviceinfo, groupEntry=groupEntry, vendorRev=vendorRev, port2=port2, xg6846=xg6846, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, lanportIndex=lanportIndex, primaryDns=primaryDns, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, multicastsTransmitted=multicastsTransmitted, staticIpGateway=staticIpGateway, catvEnable=catvEnable, fcsErrorTransmitted=fcsErrorTransmitted, temperature=temperature, jumblan2=jumblan2, staticIpAddr=staticIpAddr, serialnum=serialnum, vlan=vlan, lanportpause=lanportpause, multicastsReceived=multicastsReceived, voltage=voltage, lan4=lan4, vendorPn=vendorPn, portIndex=portIndex, rebootEnable=rebootEnable, fileType=fileType, txPower=txPower, qosEntry=qosEntry, portmode=portmode, hostname=hostname, catv=catv, qmode=qmode, statIndex=statIndex, portTable=portTable, vlanid=vlanid, domainame=domainame, vlangroupTable=vlangroupTable, jumblan1=jumblan1, speed=speed, reboot=reboot, staticIpDomainName=staticIpDomainName, rxPower=rxPower, wan=wan, lan2=lan2, qmapping=qmapping, secondaryDns=secondaryDns, tftp=tftp, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, portStatistic=portStatistic, portStatEntry=portStatEntry, staticDns=staticDns, jumblan4=jumblan4, staticIpPrimaryDns=staticIpPrimaryDns, qos=qos, jumbwan=jumbwan)
