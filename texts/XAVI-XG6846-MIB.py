...
mib_2, Gauge32, snmpModules, Counter64, Unsigned32, ObjectIdentity, Integer32, MibIdentifier, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Bits, IpAddress, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Gauge32", "snmpModules", "Counter64", "Unsigned32", "ObjectIdentity", "Integer32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Bits", "IpAddress", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, groupEntry=groupEntry, rxPower=rxPower, portEntry=portEntry, staticIpSecondaryDns=staticIpSecondaryDns, lanportIndex=lanportIndex, port4=port4, vlangroupTable=vlangroupTable, jumblan4=jumblan4, speed=speed, ddminfo=ddminfo, groupIndex=groupIndex, lan3=lan3, staticIpSubMask=staticIpSubMask, fileName=fileName, xg6846=xg6846, qosEntry=qosEntry, qmode=qmode, unicastsTransmitted=unicastsTransmitted, fcsErrorReceived=fcsErrorReceived, statIndex=statIndex, lan1=lan1, lan4=lan4, portIndex=portIndex, lanportspeed=lanportspeed, wanType=wanType, operStatus=operStatus, reboot=reboot, temperature=temperature, statisticTable=statisticTable, staticIpGateway=staticIpGateway, catv=catv, tftpSevIp=tftpSevIp, action=action, port3=port3, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, qos=qos, vendorOui=vendorOui, secondaryDns=secondaryDns, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, multicastsTransmitted=multicastsTransmitted, vlan=vlan, jumb=jumb, dscpEnable=dscpEnable, internetPort=internetPort, rebootEnable=rebootEnable, port1=port1, staticIpHostName=staticIpHostName, portTable=portTable, lan2=lan2, tftp=tftp, vlanid=vlanid, staticIpAddr=staticIpAddr, qosIndex=qosIndex, vendorRev=vendorRev, portStatistic=portStatistic, deviceinfo=deviceinfo, staticDns=staticDns, portPower=portPower, wan=wan, port2=port2, portName=portName, pauseTransmitted=pauseTransmitted, lanportName=lanportName, jumbwan=jumbwan, lanportpause=lanportpause, jumblan3=jumblan3, lanportTable=lanportTable, adminStatus=adminStatus, staticIpPrimaryDns=staticIpPrimaryDns, priority=priority, catvEnable=catvEnable, bias=bias, jumblan1=jumblan1, staticIpDomainName=staticIpDomainName, txPower=txPower, modeEntry=modeEntry, voltage=voltage, domainame=domainame, jumblan2=jumblan2, unicastsReceived=unicastsReceived, multicastsReceived=multicastsReceived, fileType=fileType, qosTable=qosTable, vendorPn=vendorPn, vendorName=vendorName, portmode=portmode, hostname=hostname, primaryDns=primaryDns, serialnum=serialnum, fcsErrorTransmitted=fcsErrorTransmitted, qmapping=qmapping)
