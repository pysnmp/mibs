...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:26:41 2021
...
MibIdentifier, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Bits, Gauge32, snmpModules, mib_2, ObjectIdentity, iso, Counter32, Counter64, enterprises, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Bits", "Gauge32", "snmpModules", "mib-2", "ObjectIdentity", "iso", "Counter32", "Counter64", "enterprises", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportName=lanportName, hostname=hostname, rxPower=rxPower, pauseReceived=pauseReceived, secondaryDns=secondaryDns, staticDns=staticDns, ddminfo=ddminfo, statIndex=statIndex, dscpEnable=dscpEnable, adminStatus=adminStatus, staticIpSubMask=staticIpSubMask, port3=port3, operStatus=operStatus, lanportTable=lanportTable, txPower=txPower, portEntry=portEntry, jumblan4=jumblan4, groupid=groupid, rebootEnable=rebootEnable, speed=speed, portIndex=portIndex, fileType=fileType, vendorPn=vendorPn, broadcastsReceived=broadcastsReceived, fileName=fileName, staticIpSecondaryDns=staticIpSecondaryDns, unicastsTransmitted=unicastsTransmitted, reboot=reboot, qmode=qmode, xg6846=xg6846, portPower=portPower, port1=port1, staticIpGateway=staticIpGateway, priority=priority, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, jumblan2=jumblan2, portStatistic=portStatistic, fcsErrorTransmitted=fcsErrorTransmitted, groupIndex=groupIndex, tftp=tftp, vlan=vlan, staticIpHostName=staticIpHostName, qosTable=qosTable, portTable=portTable, port2=port2, lan1=lan1, jumblan1=jumblan1, qosEntry=qosEntry, jumblan3=jumblan3, modeEntry=modeEntry, statisticTable=statisticTable, pauseTransmitted=pauseTransmitted, wan=wan, domainame=domainame, unicastsReceived=unicastsReceived, vendorOui=vendorOui, lan4=lan4, voltage=voltage, vendorRev=vendorRev, qosIndex=qosIndex, action=action, jumbwan=jumbwan, port4=port4, vendorName=vendorName, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, qos=qos, staticIpAddr=staticIpAddr, multicastsTransmitted=multicastsTransmitted, bias=bias, primaryDns=primaryDns, vlanid=vlanid, wanType=wanType, lan2=lan2, deviceinfo=deviceinfo, internetPort=internetPort, lanportpause=lanportpause, temperature=temperature, serialnum=serialnum, jumb=jumb, catv=catv, catvEnable=catvEnable, groupEntry=groupEntry, lanportIndex=lanportIndex, portName=portName, vlangroupTable=vlangroupTable, portmode=portmode, portStatEntry=portStatEntry, staticIpDomainName=staticIpDomainName, lanportspeed=lanportspeed, lan3=lan3, staticIpPrimaryDns=staticIpPrimaryDns, tftpSevIp=tftpSevIp)
