...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:38:56 2023
...
Integer32, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, mib_2, iso, Gauge32, Unsigned32, enterprises, TimeTicks, snmpModules, IpAddress, ObjectIdentity, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "mib-2", "iso", "Gauge32", "Unsigned32", "enterprises", "TimeTicks", "snmpModules", "IpAddress", "ObjectIdentity", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmapping=qmapping, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, statisticTable=statisticTable, staticIpPrimaryDns=staticIpPrimaryDns, vlangroupTable=vlangroupTable, groupid=groupid, jumblan2=jumblan2, jumblan3=jumblan3, pauseReceived=pauseReceived, vendorName=vendorName, staticIpSubMask=staticIpSubMask, port4=port4, vlanid=vlanid, port1=port1, jumblan4=jumblan4, fileType=fileType, action=action, wan=wan, groupEntry=groupEntry, deviceinfo=deviceinfo, portPower=portPower, portStatEntry=portStatEntry, qos=qos, lanportTable=lanportTable, rebootEnable=rebootEnable, lan3=lan3, staticIpDomainName=staticIpDomainName, modeEntry=modeEntry, dscpEnable=dscpEnable, portTable=portTable, adminStatus=adminStatus, pauseTransmitted=pauseTransmitted, secondaryDns=secondaryDns, operStatus=operStatus, jumbwan=jumbwan, vlan=vlan, bias=bias, multicastsTransmitted=multicastsTransmitted, port2=port2, unicastsReceived=unicastsReceived, lan1=lan1, staticIpGateway=staticIpGateway, staticIpSecondaryDns=staticIpSecondaryDns, priority=priority, temperature=temperature, speed=speed, catv=catv, portStatistic=portStatistic, lanportIndex=lanportIndex, fcsErrorReceived=fcsErrorReceived, multicastsReceived=multicastsReceived, broadcastsReceived=broadcastsReceived, voltage=voltage, xg6846=xg6846, vendorRev=vendorRev, portmode=portmode, lanportName=lanportName, qosIndex=qosIndex, staticIpAddr=staticIpAddr, catvEnable=catvEnable, fileName=fileName, groupIndex=groupIndex, port3=port3, primaryDns=primaryDns, vendorPn=vendorPn, lan2=lan2, txPower=txPower, qmode=qmode, jumb=jumb, vendorOui=vendorOui, wanType=wanType, domainame=domainame, qosEntry=qosEntry, lan4=lan4, unicastsTransmitted=unicastsTransmitted, ddminfo=ddminfo, lanportpause=lanportpause, staticIpHostName=staticIpHostName, internetPort=internetPort, tftp=tftp, serialnum=serialnum, lanportspeed=lanportspeed, rxPower=rxPower, tftpSevIp=tftpSevIp, portEntry=portEntry, jumblan1=jumblan1, reboot=reboot, fcsErrorTransmitted=fcsErrorTransmitted, qosTable=qosTable, portName=portName, statIndex=statIndex, portIndex=portIndex, staticDns=staticDns)
