...
# Produced by pysmi-1.1.3 at Sun Nov 21 00:40:06 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Bits, enterprises, TimeTicks, NotificationType, Counter32, mib_2, Integer32, ModuleIdentity, IpAddress, Unsigned32, snmpModules, iso, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Bits", "enterprises", "TimeTicks", "NotificationType", "Counter32", "mib-2", "Integer32", "ModuleIdentity", "IpAddress", "Unsigned32", "snmpModules", "iso", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, portIndex=portIndex, txPower=txPower, staticIpHostName=staticIpHostName, xg6846=xg6846, voltage=voltage, domainame=domainame, port1=port1, deviceinfo=deviceinfo, qmode=qmode, internetPort=internetPort, lanportspeed=lanportspeed, multicastsReceived=multicastsReceived, portName=portName, fcsErrorTransmitted=fcsErrorTransmitted, unicastsReceived=unicastsReceived, tftpSevIp=tftpSevIp, rxPower=rxPower, operStatus=operStatus, catvEnable=catvEnable, staticIpGateway=staticIpGateway, speed=speed, dscpEnable=dscpEnable, multicastsTransmitted=multicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, staticDns=staticDns, fileType=fileType, vendorPn=vendorPn, staticIpSubMask=staticIpSubMask, portPower=portPower, portStatistic=portStatistic, portEntry=portEntry, staticIpPrimaryDns=staticIpPrimaryDns, wan=wan, portStatEntry=portStatEntry, lanportIndex=lanportIndex, pauseReceived=pauseReceived, ddminfo=ddminfo, pauseTransmitted=pauseTransmitted, lan4=lan4, serialnum=serialnum, jumblan2=jumblan2, reboot=reboot, staticIpAddr=staticIpAddr, lanportpause=lanportpause, vendorOui=vendorOui, rebootEnable=rebootEnable, jumblan4=jumblan4, jumblan3=jumblan3, lanportName=lanportName, modeEntry=modeEntry, qosIndex=qosIndex, lan2=lan2, qos=qos, portmode=portmode, jumbwan=jumbwan, hostname=hostname, jumb=jumb, qosTable=qosTable, lan3=lan3, vlangroupTable=vlangroupTable, wanType=wanType, vlan=vlan, primaryDns=primaryDns, tftp=tftp, port3=port3, fcsErrorReceived=fcsErrorReceived, lan1=lan1, priority=priority, vendorName=vendorName, groupIndex=groupIndex, groupid=groupid, action=action, lanportTable=lanportTable, portTable=portTable, secondaryDns=secondaryDns, staticIpSecondaryDns=staticIpSecondaryDns, fileName=fileName, bias=bias, vendorRev=vendorRev, qosEntry=qosEntry, vlanid=vlanid, groupEntry=groupEntry, unicastsTransmitted=unicastsTransmitted, broadcastsReceived=broadcastsReceived, temperature=temperature, adminStatus=adminStatus, staticIpDomainName=staticIpDomainName, port2=port2, jumblan1=jumblan1, statIndex=statIndex, port4=port4, qmapping=qmapping, statisticTable=statisticTable)
