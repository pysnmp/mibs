...
IpAddress, TimeTicks, Gauge32, MibIdentifier, ObjectIdentity, Counter32, enterprises, iso, Integer32, Unsigned32, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, ModuleIdentity, mib_2, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Gauge32", "MibIdentifier", "ObjectIdentity", "Counter32", "enterprises", "iso", "Integer32", "Unsigned32", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "ModuleIdentity", "mib-2", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", operStatus=operStatus, broadcastsTransmitted=broadcastsTransmitted, adminStatus=adminStatus, jumblan2=jumblan2, catvEnable=catvEnable, qos=qos, port1=port1, pauseReceived=pauseReceived, rebootEnable=rebootEnable, vlanid=vlanid, wan=wan, vendorOui=vendorOui, unicastsTransmitted=unicastsTransmitted, lan3=lan3, portTable=portTable, fileType=fileType, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, qmapping=qmapping, lanportName=lanportName, fcsErrorReceived=fcsErrorReceived, port3=port3, portStatEntry=portStatEntry, statisticTable=statisticTable, staticIpSubMask=staticIpSubMask, groupid=groupid, rxPower=rxPower, port2=port2, temperature=temperature, priority=priority, groupIndex=groupIndex, broadcastsReceived=broadcastsReceived, jumblan1=jumblan1, lan2=lan2, voltage=voltage, action=action, vendorRev=vendorRev, reboot=reboot, portmode=portmode, staticIpAddr=staticIpAddr, vendorPn=vendorPn, qosEntry=qosEntry, txPower=txPower, internetPort=internetPort, jumblan3=jumblan3, vendorName=vendorName, qosIndex=qosIndex, tftp=tftp, multicastsReceived=multicastsReceived, lan1=lan1, modeEntry=modeEntry, fileName=fileName, hostname=hostname, groupEntry=groupEntry, portName=portName, lanportTable=lanportTable, jumbwan=jumbwan, serialnum=serialnum, statIndex=statIndex, speed=speed, xg6846=xg6846, staticIpPrimaryDns=staticIpPrimaryDns, secondaryDns=secondaryDns, lanportpause=lanportpause, qmode=qmode, tftpSevIp=tftpSevIp, deviceinfo=deviceinfo, jumblan4=jumblan4, qosTable=qosTable, lan4=lan4, portIndex=portIndex, port4=port4, catv=catv, portEntry=portEntry, domainame=domainame, lanportspeed=lanportspeed, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, staticIpHostName=staticIpHostName, wanType=wanType, unicastsReceived=unicastsReceived, portPower=portPower, primaryDns=primaryDns, staticIpGateway=staticIpGateway, bias=bias, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, vlangroupTable=vlangroupTable, jumb=jumb, staticIpDomainName=staticIpDomainName, staticDns=staticDns, vlan=vlan, lanportIndex=lanportIndex, portStatistic=portStatistic)
