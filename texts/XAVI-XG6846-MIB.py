...
Gauge32, iso, enterprises, Counter64, ObjectIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, NotificationType, TimeTicks, Integer32, MibIdentifier, Counter32, Bits, snmpModules, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "enterprises", "Counter64", "ObjectIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "NotificationType", "TimeTicks", "Integer32", "MibIdentifier", "Counter32", "Bits", "snmpModules", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsReceived=multicastsReceived, qmapping=qmapping, statisticTable=statisticTable, catv=catv, ddminfo=ddminfo, portStatEntry=portStatEntry, groupid=groupid, reboot=reboot, portIndex=portIndex, portName=portName, groupIndex=groupIndex, port4=port4, portTable=portTable, vendorOui=vendorOui, catvEnable=catvEnable, port1=port1, wanType=wanType, tftp=tftp, deviceinfo=deviceinfo, broadcastsReceived=broadcastsReceived, vlangroupTable=vlangroupTable, port2=port2, groupEntry=groupEntry, operStatus=operStatus, unicastsReceived=unicastsReceived, primaryDns=primaryDns, portStatistic=portStatistic, action=action, jumblan3=jumblan3, lan2=lan2, qosIndex=qosIndex, staticIpSubMask=staticIpSubMask, vlanid=vlanid, vendorPn=vendorPn, portPower=portPower, qos=qos, jumblan1=jumblan1, speed=speed, jumblan4=jumblan4, staticIpDomainName=staticIpDomainName, voltage=voltage, qmode=qmode, lanportIndex=lanportIndex, jumblan2=jumblan2, staticIpSecondaryDns=staticIpSecondaryDns, lan1=lan1, rebootEnable=rebootEnable, serialnum=serialnum, statIndex=statIndex, domainame=domainame, hostname=hostname, portmode=portmode, jumb=jumb, pauseReceived=pauseReceived, lan3=lan3, staticIpHostName=staticIpHostName, lanportTable=lanportTable, txPower=txPower, staticIpPrimaryDns=staticIpPrimaryDns, bias=bias, staticDns=staticDns, modeEntry=modeEntry, multicastsTransmitted=multicastsTransmitted, fcsErrorReceived=fcsErrorReceived, rxPower=rxPower, staticIpAddr=staticIpAddr, fileName=fileName, tftpSevIp=tftpSevIp, vendorRev=vendorRev, unicastsTransmitted=unicastsTransmitted, jumbwan=jumbwan, fcsErrorTransmitted=fcsErrorTransmitted, xg6846=xg6846, qosEntry=qosEntry, priority=priority, fileType=fileType, vlan=vlan, qosTable=qosTable, lan4=lan4, portEntry=portEntry, vendorName=vendorName, internetPort=internetPort, broadcastsTransmitted=broadcastsTransmitted, adminStatus=adminStatus, lanportName=lanportName, lanportpause=lanportpause, pauseTransmitted=pauseTransmitted, lanportspeed=lanportspeed, secondaryDns=secondaryDns, port3=port3, wan=wan, temperature=temperature, staticIpGateway=staticIpGateway, dscpEnable=dscpEnable)
