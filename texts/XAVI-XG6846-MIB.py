...
TimeTicks, Gauge32, IpAddress, MibIdentifier, NotificationType, Unsigned32, Integer32, enterprises, Bits, ModuleIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, snmpModules, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Gauge32", "IpAddress", "MibIdentifier", "NotificationType", "Unsigned32", "Integer32", "enterprises", "Bits", "ModuleIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "snmpModules", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", serialnum=serialnum, fcsErrorReceived=fcsErrorReceived, qos=qos, bias=bias, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, jumblan3=jumblan3, wanType=wanType, pauseReceived=pauseReceived, speed=speed, portStatEntry=portStatEntry, temperature=temperature, port4=port4, domainame=domainame, unicastsReceived=unicastsReceived, lanportpause=lanportpause, qmapping=qmapping, portIndex=portIndex, fcsErrorTransmitted=fcsErrorTransmitted, catvEnable=catvEnable, hostname=hostname, tftpSevIp=tftpSevIp, jumblan4=jumblan4, portEntry=portEntry, deviceinfo=deviceinfo, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, lanportIndex=lanportIndex, staticIpDomainName=staticIpDomainName, tftp=tftp, catv=catv, vendorPn=vendorPn, secondaryDns=secondaryDns, lan4=lan4, qosTable=qosTable, priority=priority, broadcastsReceived=broadcastsReceived, portmode=portmode, jumbwan=jumbwan, vendorName=vendorName, rxPower=rxPower, ddminfo=ddminfo, pauseTransmitted=pauseTransmitted, lan1=lan1, portStatistic=portStatistic, txPower=txPower, groupIndex=groupIndex, vlanid=vlanid, fileName=fileName, wan=wan, jumblan2=jumblan2, staticIpPrimaryDns=staticIpPrimaryDns, statIndex=statIndex, portTable=portTable, groupid=groupid, adminStatus=adminStatus, qosIndex=qosIndex, fileType=fileType, voltage=voltage, internetPort=internetPort, staticIpAddr=staticIpAddr, dscpEnable=dscpEnable, port3=port3, jumb=jumb, lanportTable=lanportTable, qosEntry=qosEntry, vlan=vlan, lanportspeed=lanportspeed, port1=port1, operStatus=operStatus, xg6846=xg6846, staticDns=staticDns, statisticTable=statisticTable, vendorRev=vendorRev, qmode=qmode, primaryDns=primaryDns, broadcastsTransmitted=broadcastsTransmitted, groupEntry=groupEntry, vendorOui=vendorOui, staticIpHostName=staticIpHostName, multicastsReceived=multicastsReceived, portPower=portPower, unicastsTransmitted=unicastsTransmitted, portName=portName, lan2=lan2, modeEntry=modeEntry, rebootEnable=rebootEnable, port2=port2, vlangroupTable=vlangroupTable, staticIpGateway=staticIpGateway, multicastsTransmitted=multicastsTransmitted, lanportName=lanportName, reboot=reboot, action=action)
