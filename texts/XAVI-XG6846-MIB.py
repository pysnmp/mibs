...
# Produced by pysmi-1.1.8 at Mon Jan  9 13:41:10 2023
...
ObjectIdentity, Gauge32, NotificationType, Counter32, TimeTicks, mib_2, enterprises, Unsigned32, Bits, Counter64, MibIdentifier, ModuleIdentity, IpAddress, snmpModules, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "NotificationType", "Counter32", "TimeTicks", "mib-2", "enterprises", "Unsigned32", "Bits", "Counter64", "MibIdentifier", "ModuleIdentity", "IpAddress", "snmpModules", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", temperature=temperature, qosEntry=qosEntry, reboot=reboot, operStatus=operStatus, pauseReceived=pauseReceived, primaryDns=primaryDns, portEntry=portEntry, catv=catv, portPower=portPower, lanportpause=lanportpause, portStatEntry=portStatEntry, groupIndex=groupIndex, portmode=portmode, jumblan4=jumblan4, port4=port4, qosTable=qosTable, rebootEnable=rebootEnable, lanportName=lanportName, staticIpAddr=staticIpAddr, catvEnable=catvEnable, groupEntry=groupEntry, jumblan3=jumblan3, staticIpSubMask=staticIpSubMask, voltage=voltage, deviceinfo=deviceinfo, portName=portName, port2=port2, staticIpHostName=staticIpHostName, internetPort=internetPort, lanportspeed=lanportspeed, statIndex=statIndex, jumblan2=jumblan2, fcsErrorReceived=fcsErrorReceived, domainame=domainame, portTable=portTable, statisticTable=statisticTable, staticIpSecondaryDns=staticIpSecondaryDns, vlanid=vlanid, jumb=jumb, vendorPn=vendorPn, vendorName=vendorName, adminStatus=adminStatus, tftp=tftp, broadcastsTransmitted=broadcastsTransmitted, groupid=groupid, unicastsTransmitted=unicastsTransmitted, qmapping=qmapping, lan2=lan2, lan4=lan4, broadcastsReceived=broadcastsReceived, fileType=fileType, lan3=lan3, modeEntry=modeEntry, vlan=vlan, staticIpGateway=staticIpGateway, staticIpDomainName=staticIpDomainName, secondaryDns=secondaryDns, vendorRev=vendorRev, port1=port1, txPower=txPower, serialnum=serialnum, xg6846=xg6846, portIndex=portIndex, hostname=hostname, dscpEnable=dscpEnable, lan1=lan1, tftpSevIp=tftpSevIp, speed=speed, lanportIndex=lanportIndex, rxPower=rxPower, wanType=wanType, multicastsTransmitted=multicastsTransmitted, unicastsReceived=unicastsReceived, port3=port3, action=action, jumbwan=jumbwan, jumblan1=jumblan1, vendorOui=vendorOui, lanportTable=lanportTable, staticDns=staticDns, bias=bias, qos=qos, pauseTransmitted=pauseTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, multicastsReceived=multicastsReceived, qmode=qmode, qosIndex=qosIndex, ddminfo=ddminfo, vlangroupTable=vlangroupTable, fcsErrorTransmitted=fcsErrorTransmitted, fileName=fileName, portStatistic=portStatistic, wan=wan, priority=priority)
