...
# Produced by pysmi-1.1.8 at Fri Jan 27 14:17:38 2023
...
MibIdentifier, IpAddress, NotificationType, snmpModules, ObjectIdentity, ModuleIdentity, enterprises, Gauge32, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Unsigned32, Integer32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "NotificationType", "snmpModules", "ObjectIdentity", "ModuleIdentity", "enterprises", "Gauge32", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Unsigned32", "Integer32", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorPn=vendorPn, jumblan3=jumblan3, qosEntry=qosEntry, wan=wan, port4=port4, broadcastsReceived=broadcastsReceived, port3=port3, portStatistic=portStatistic, jumb=jumb, qos=qos, portmode=portmode, primaryDns=primaryDns, portIndex=portIndex, staticIpGateway=staticIpGateway, lan1=lan1, portStatEntry=portStatEntry, staticDns=staticDns, speed=speed, staticIpDomainName=staticIpDomainName, lan4=lan4, hostname=hostname, staticIpAddr=staticIpAddr, pauseReceived=pauseReceived, broadcastsTransmitted=broadcastsTransmitted, portName=portName, jumblan1=jumblan1, vlan=vlan, portTable=portTable, catvEnable=catvEnable, lanportName=lanportName, voltage=voltage, action=action, deviceinfo=deviceinfo, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, pauseTransmitted=pauseTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, tftp=tftp, port1=port1, lan2=lan2, groupEntry=groupEntry, txPower=txPower, ddminfo=ddminfo, qmode=qmode, multicastsTransmitted=multicastsTransmitted, jumblan2=jumblan2, qosIndex=qosIndex, vlanid=vlanid, staticIpHostName=staticIpHostName, domainame=domainame, priority=priority, lanportTable=lanportTable, catv=catv, operStatus=operStatus, groupid=groupid, unicastsReceived=unicastsReceived, reboot=reboot, rxPower=rxPower, multicastsReceived=multicastsReceived, dscpEnable=dscpEnable, portPower=portPower, staticIpSecondaryDns=staticIpSecondaryDns, wanType=wanType, jumblan4=jumblan4, statisticTable=statisticTable, groupIndex=groupIndex, portEntry=portEntry, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, vendorName=vendorName, qmapping=qmapping, statIndex=statIndex, vendorOui=vendorOui, staticIpSubMask=staticIpSubMask, fileName=fileName, lan3=lan3, lanportspeed=lanportspeed, port2=port2, bias=bias, vendorRev=vendorRev, qosTable=qosTable, internetPort=internetPort, fileType=fileType, xg6846=xg6846, modeEntry=modeEntry, lanportIndex=lanportIndex, temperature=temperature, serialnum=serialnum, jumbwan=jumbwan, rebootEnable=rebootEnable, adminStatus=adminStatus, secondaryDns=secondaryDns, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived)
