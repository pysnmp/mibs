...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:31:14 2022
...
Counter32, Integer32, IpAddress, Bits, Counter64, MibIdentifier, ModuleIdentity, mib_2, Unsigned32, NotificationType, snmpModules, Gauge32, ObjectIdentity, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "IpAddress", "Bits", "Counter64", "MibIdentifier", "ModuleIdentity", "mib-2", "Unsigned32", "NotificationType", "snmpModules", "Gauge32", "ObjectIdentity", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wanType=wanType, catv=catv, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, temperature=temperature, portPower=portPower, staticIpSecondaryDns=staticIpSecondaryDns, statisticTable=statisticTable, portTable=portTable, internetPort=internetPort, lan1=lan1, jumb=jumb, staticIpPrimaryDns=staticIpPrimaryDns, vlanid=vlanid, serialnum=serialnum, portStatEntry=portStatEntry, jumbwan=jumbwan, qosTable=qosTable, unicastsTransmitted=unicastsTransmitted, priority=priority, jumblan2=jumblan2, deviceinfo=deviceinfo, lanportName=lanportName, port4=port4, portName=portName, jumblan3=jumblan3, lanportTable=lanportTable, hostname=hostname, lan3=lan3, portIndex=portIndex, pauseTransmitted=pauseTransmitted, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, portStatistic=portStatistic, broadcastsReceived=broadcastsReceived, operStatus=operStatus, domainame=domainame, vendorName=vendorName, reboot=reboot, staticIpDomainName=staticIpDomainName, unicastsReceived=unicastsReceived, staticIpAddr=staticIpAddr, portEntry=portEntry, tftp=tftp, action=action, port1=port1, vendorRev=vendorRev, txPower=txPower, port3=port3, qosIndex=qosIndex, fcsErrorTransmitted=fcsErrorTransmitted, speed=speed, lan2=lan2, pauseReceived=pauseReceived, lanportspeed=lanportspeed, modeEntry=modeEntry, portmode=portmode, primaryDns=primaryDns, lanportpause=lanportpause, multicastsReceived=multicastsReceived, wan=wan, vendorPn=vendorPn, port2=port2, fcsErrorReceived=fcsErrorReceived, qos=qos, statIndex=statIndex, qosEntry=qosEntry, rxPower=rxPower, bias=bias, lanportIndex=lanportIndex, rebootEnable=rebootEnable, staticIpHostName=staticIpHostName, adminStatus=adminStatus, staticIpGateway=staticIpGateway, catvEnable=catvEnable, staticDns=staticDns, groupIndex=groupIndex, voltage=voltage, fileType=fileType, fileName=fileName, jumblan4=jumblan4, ddminfo=ddminfo, secondaryDns=secondaryDns, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, groupEntry=groupEntry, dscpEnable=dscpEnable, xg6846=xg6846, groupid=groupid, lan4=lan4, tftpSevIp=tftpSevIp, qmapping=qmapping, vlan=vlan)
