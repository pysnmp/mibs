...
NotificationType, mib_2, TimeTicks, Bits, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, iso, Unsigned32, ObjectIdentity, snmpModules, IpAddress, ModuleIdentity, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "mib-2", "TimeTicks", "Bits", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "iso", "Unsigned32", "ObjectIdentity", "snmpModules", "IpAddress", "ModuleIdentity", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, qmapping=qmapping, jumblan3=jumblan3, portEntry=portEntry, portIndex=portIndex, groupIndex=groupIndex, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, multicastsTransmitted=multicastsTransmitted, staticIpHostName=staticIpHostName, unicastsReceived=unicastsReceived, port2=port2, staticIpGateway=staticIpGateway, qosIndex=qosIndex, speed=speed, action=action, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, qosTable=qosTable, vlangroupTable=vlangroupTable, lanportTable=lanportTable, pauseTransmitted=pauseTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, pauseReceived=pauseReceived, primaryDns=primaryDns, lan4=lan4, wanType=wanType, vlan=vlan, qosEntry=qosEntry, port1=port1, staticDns=staticDns, deviceinfo=deviceinfo, fileName=fileName, portmode=portmode, priority=priority, lan3=lan3, multicastsReceived=multicastsReceived, adminStatus=adminStatus, jumb=jumb, broadcastsReceived=broadcastsReceived, wan=wan, vendorRev=vendorRev, bias=bias, lanportIndex=lanportIndex, lanportpause=lanportpause, port4=port4, qmode=qmode, groupEntry=groupEntry, portName=portName, statisticTable=statisticTable, fcsErrorReceived=fcsErrorReceived, dscpEnable=dscpEnable, portTable=portTable, serialnum=serialnum, staticIpSecondaryDns=staticIpSecondaryDns, catv=catv, portPower=portPower, qos=qos, unicastsTransmitted=unicastsTransmitted, jumblan1=jumblan1, tftp=tftp, ddminfo=ddminfo, domainame=domainame, jumbwan=jumbwan, internetPort=internetPort, lanportspeed=lanportspeed, operStatus=operStatus, catvEnable=catvEnable, vendorPn=vendorPn, txPower=txPower, fileType=fileType, modeEntry=modeEntry, staticIpDomainName=staticIpDomainName, temperature=temperature, portStatistic=portStatistic, jumblan4=jumblan4, jumblan2=jumblan2, reboot=reboot, voltage=voltage, xg6846=xg6846, vendorOui=vendorOui, vlanid=vlanid, hostname=hostname, port3=port3, vendorName=vendorName, lanportName=lanportName, lan1=lan1, portStatEntry=portStatEntry, staticIpAddr=staticIpAddr, rxPower=rxPower, staticIpSubMask=staticIpSubMask, rebootEnable=rebootEnable, statIndex=statIndex, lan2=lan2)
