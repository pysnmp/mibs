...
NotificationType, enterprises, IpAddress, MibIdentifier, iso, Bits, Gauge32, Unsigned32, Counter64, mib_2, ModuleIdentity, ObjectIdentity, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "IpAddress", "MibIdentifier", "iso", "Bits", "Gauge32", "Unsigned32", "Counter64", "mib-2", "ModuleIdentity", "ObjectIdentity", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmapping=qmapping, lanportIndex=lanportIndex, portmode=portmode, fileName=fileName, xg6846=xg6846, vlanid=vlanid, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, pauseReceived=pauseReceived, vlangroupTable=vlangroupTable, groupIndex=groupIndex, staticIpAddr=staticIpAddr, staticIpSecondaryDns=staticIpSecondaryDns, secondaryDns=secondaryDns, qosTable=qosTable, lan2=lan2, statIndex=statIndex, qmode=qmode, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, speed=speed, groupid=groupid, vendorName=vendorName, portPower=portPower, statisticTable=statisticTable, ddminfo=ddminfo, catv=catv, lan3=lan3, rxPower=rxPower, tftp=tftp, portEntry=portEntry, portTable=portTable, jumblan4=jumblan4, action=action, unicastsTransmitted=unicastsTransmitted, lanportspeed=lanportspeed, multicastsTransmitted=multicastsTransmitted, jumbwan=jumbwan, modeEntry=modeEntry, qosEntry=qosEntry, catvEnable=catvEnable, port1=port1, staticIpDomainName=staticIpDomainName, unicastsReceived=unicastsReceived, txPower=txPower, lan1=lan1, temperature=temperature, staticIpHostName=staticIpHostName, vendorPn=vendorPn, deviceinfo=deviceinfo, jumblan1=jumblan1, priority=priority, internetPort=internetPort, broadcastsReceived=broadcastsReceived, portStatEntry=portStatEntry, jumb=jumb, portName=portName, adminStatus=adminStatus, staticIpGateway=staticIpGateway, wanType=wanType, vendorOui=vendorOui, vendorRev=vendorRev, primaryDns=primaryDns, lan4=lan4, wan=wan, bias=bias, qos=qos, portIndex=portIndex, jumblan3=jumblan3, fcsErrorReceived=fcsErrorReceived, vlan=vlan, lanportpause=lanportpause, hostname=hostname, reboot=reboot, qosIndex=qosIndex, port4=port4, lanportTable=lanportTable, serialnum=serialnum, domainame=domainame, jumblan2=jumblan2, operStatus=operStatus, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, voltage=voltage, dscpEnable=dscpEnable, multicastsReceived=multicastsReceived, rebootEnable=rebootEnable, tftpSevIp=tftpSevIp, port2=port2, port3=port3, fileType=fileType, groupEntry=groupEntry)
