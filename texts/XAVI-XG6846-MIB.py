...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:54:46 2022
...
TimeTicks, Unsigned32, snmpModules, mib_2, iso, ObjectIdentity, NotificationType, Integer32, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, MibIdentifier, Counter32, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "snmpModules", "mib-2", "iso", "ObjectIdentity", "NotificationType", "Integer32", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "MibIdentifier", "Counter32", "Bits", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportIndex=lanportIndex, modeEntry=modeEntry, jumblan4=jumblan4, speed=speed, adminStatus=adminStatus, dscpEnable=dscpEnable, groupEntry=groupEntry, staticIpPrimaryDns=staticIpPrimaryDns, lan2=lan2, pauseTransmitted=pauseTransmitted, jumblan1=jumblan1, qosEntry=qosEntry, serialnum=serialnum, reboot=reboot, qmapping=qmapping, txPower=txPower, operStatus=operStatus, deviceinfo=deviceinfo, tftpSevIp=tftpSevIp, portName=portName, vlan=vlan, portTable=portTable, lan1=lan1, bias=bias, fileType=fileType, wanType=wanType, qosTable=qosTable, portPower=portPower, hostname=hostname, secondaryDns=secondaryDns, lanportpause=lanportpause, staticIpHostName=staticIpHostName, internetPort=internetPort, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, fcsErrorTransmitted=fcsErrorTransmitted, port4=port4, qosIndex=qosIndex, port3=port3, unicastsReceived=unicastsReceived, voltage=voltage, staticIpSubMask=staticIpSubMask, lanportName=lanportName, fileName=fileName, qos=qos, vendorOui=vendorOui, multicastsReceived=multicastsReceived, portEntry=portEntry, vendorPn=vendorPn, rxPower=rxPower, pauseReceived=pauseReceived, groupid=groupid, vendorRev=vendorRev, domainame=domainame, catv=catv, vlangroupTable=vlangroupTable, jumblan3=jumblan3, ddminfo=ddminfo, lanportspeed=lanportspeed, lan4=lan4, jumb=jumb, vendorName=vendorName, tftp=tftp, broadcastsTransmitted=broadcastsTransmitted, multicastsTransmitted=multicastsTransmitted, priority=priority, statisticTable=statisticTable, staticIpSecondaryDns=staticIpSecondaryDns, catvEnable=catvEnable, staticIpAddr=staticIpAddr, portmode=portmode, action=action, primaryDns=primaryDns, wan=wan, lan3=lan3, portStatistic=portStatistic, statIndex=statIndex, groupIndex=groupIndex, vlanid=vlanid, unicastsTransmitted=unicastsTransmitted, port2=port2, lanportTable=lanportTable, temperature=temperature, rebootEnable=rebootEnable, portStatEntry=portStatEntry, broadcastsReceived=broadcastsReceived, staticDns=staticDns, portIndex=portIndex, jumbwan=jumbwan, port1=port1, jumblan2=jumblan2, staticIpGateway=staticIpGateway, qmode=qmode, staticIpDomainName=staticIpDomainName)
