...
snmpModules, MibIdentifier, Integer32, iso, ObjectIdentity, Unsigned32, ModuleIdentity, mib_2, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, enterprises, Counter64, Gauge32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "MibIdentifier", "Integer32", "iso", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "mib-2", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "enterprises", "Counter64", "Gauge32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumbwan=jumbwan, staticIpPrimaryDns=staticIpPrimaryDns, hostname=hostname, txPower=txPower, adminStatus=adminStatus, action=action, broadcastsReceived=broadcastsReceived, lan1=lan1, port2=port2, port1=port1, dscpEnable=dscpEnable, qosEntry=qosEntry, vendorRev=vendorRev, deviceinfo=deviceinfo, qos=qos, vlangroupTable=vlangroupTable, groupid=groupid, lanportspeed=lanportspeed, portTable=portTable, speed=speed, wan=wan, lanportName=lanportName, lanportpause=lanportpause, lanportTable=lanportTable, portStatEntry=portStatEntry, jumblan1=jumblan1, qosIndex=qosIndex, qmode=qmode, reboot=reboot, vlan=vlan, portStatistic=portStatistic, lan2=lan2, temperature=temperature, ddminfo=ddminfo, bias=bias, xg6846=xg6846, staticDns=staticDns, portPower=portPower, staticIpGateway=staticIpGateway, lan4=lan4, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, lanportIndex=lanportIndex, operStatus=operStatus, portIndex=portIndex, tftp=tftp, qmapping=qmapping, voltage=voltage, fileName=fileName, jumblan2=jumblan2, modeEntry=modeEntry, vendorName=vendorName, jumblan4=jumblan4, qosTable=qosTable, portName=portName, internetPort=internetPort, serialnum=serialnum, fcsErrorTransmitted=fcsErrorTransmitted, vendorPn=vendorPn, catv=catv, vlanid=vlanid, unicastsTransmitted=unicastsTransmitted, rxPower=rxPower, fileType=fileType, portEntry=portEntry, catvEnable=catvEnable, wanType=wanType, staticIpDomainName=staticIpDomainName, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, pauseReceived=pauseReceived, staticIpHostName=staticIpHostName, jumblan3=jumblan3, primaryDns=primaryDns, groupIndex=groupIndex, groupEntry=groupEntry, rebootEnable=rebootEnable, jumb=jumb, lan3=lan3, port3=port3, unicastsReceived=unicastsReceived, domainame=domainame, pauseTransmitted=pauseTransmitted, statisticTable=statisticTable, vendorOui=vendorOui, secondaryDns=secondaryDns, portmode=portmode, multicastsTransmitted=multicastsTransmitted, staticIpSubMask=staticIpSubMask, staticIpAddr=staticIpAddr, port4=port4, fcsErrorReceived=fcsErrorReceived, tftpSevIp=tftpSevIp, priority=priority)
