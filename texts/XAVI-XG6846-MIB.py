...
# Produced by pysmi-1.1.0 at Tue Nov 16 11:52:06 2021
...
snmpModules, iso, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Gauge32, mib_2, MibIdentifier, TimeTicks, ObjectIdentity, Integer32, Bits, IpAddress, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "iso", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Gauge32", "mib-2", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Integer32", "Bits", "IpAddress", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorPn=vendorPn, bias=bias, internetPort=internetPort, ddminfo=ddminfo, portStatEntry=portStatEntry, staticIpPrimaryDns=staticIpPrimaryDns, vendorOui=vendorOui, port1=port1, fileName=fileName, portStatistic=portStatistic, lanportName=lanportName, jumblan2=jumblan2, portIndex=portIndex, pauseTransmitted=pauseTransmitted, statisticTable=statisticTable, portmode=portmode, jumblan1=jumblan1, lanportTable=lanportTable, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, secondaryDns=secondaryDns, statIndex=statIndex, jumblan4=jumblan4, lan4=lan4, tftp=tftp, domainame=domainame, vlan=vlan, voltage=voltage, tftpSevIp=tftpSevIp, groupIndex=groupIndex, qmode=qmode, multicastsReceived=multicastsReceived, groupid=groupid, qos=qos, port4=port4, catvEnable=catvEnable, deviceinfo=deviceinfo, modeEntry=modeEntry, portTable=portTable, port3=port3, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, jumbwan=jumbwan, fcsErrorTransmitted=fcsErrorTransmitted, lanportspeed=lanportspeed, staticIpAddr=staticIpAddr, port2=port2, portPower=portPower, portEntry=portEntry, fileType=fileType, adminStatus=adminStatus, multicastsTransmitted=multicastsTransmitted, pauseReceived=pauseReceived, rxPower=rxPower, catv=catv, qmapping=qmapping, wan=wan, serialnum=serialnum, xg6846=xg6846, staticIpGateway=staticIpGateway, vlanid=vlanid, rebootEnable=rebootEnable, temperature=temperature, vendorRev=vendorRev, vlangroupTable=vlangroupTable, groupEntry=groupEntry, qosIndex=qosIndex, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, txPower=txPower, reboot=reboot, qosEntry=qosEntry, unicastsReceived=unicastsReceived, fcsErrorReceived=fcsErrorReceived, staticIpSecondaryDns=staticIpSecondaryDns, hostname=hostname, vendorName=vendorName, lanportIndex=lanportIndex, primaryDns=primaryDns, lan1=lan1, lan2=lan2, broadcastsReceived=broadcastsReceived, qosTable=qosTable, lan3=lan3, speed=speed, staticIpSubMask=staticIpSubMask, action=action, priority=priority, staticDns=staticDns, dscpEnable=dscpEnable, jumblan3=jumblan3, operStatus=operStatus, portName=portName, wanType=wanType)
