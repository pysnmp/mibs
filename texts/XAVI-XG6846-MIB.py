...
Integer32, ObjectIdentity, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, snmpModules, TimeTicks, Gauge32, Counter32, ModuleIdentity, IpAddress, NotificationType, iso, MibIdentifier, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "snmpModules", "TimeTicks", "Gauge32", "Counter32", "ModuleIdentity", "IpAddress", "NotificationType", "iso", "MibIdentifier", "mib-2", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportspeed=lanportspeed, qosIndex=qosIndex, vlan=vlan, port3=port3, serialnum=serialnum, jumblan1=jumblan1, portIndex=portIndex, pauseTransmitted=pauseTransmitted, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, portmode=portmode, jumblan2=jumblan2, secondaryDns=secondaryDns, vlanid=vlanid, qosTable=qosTable, speed=speed, priority=priority, operStatus=operStatus, staticIpGateway=staticIpGateway, rebootEnable=rebootEnable, vendorName=vendorName, port1=port1, groupid=groupid, jumbwan=jumbwan, lan2=lan2, staticIpSubMask=staticIpSubMask, groupEntry=groupEntry, reboot=reboot, wan=wan, lanportIndex=lanportIndex, portTable=portTable, fcsErrorTransmitted=fcsErrorTransmitted, port4=port4, pauseReceived=pauseReceived, lan4=lan4, adminStatus=adminStatus, vendorRev=vendorRev, lanportTable=lanportTable, portEntry=portEntry, portPower=portPower, primaryDns=primaryDns, staticIpSecondaryDns=staticIpSecondaryDns, catv=catv, deviceinfo=deviceinfo, portStatistic=portStatistic, qmapping=qmapping, broadcastsTransmitted=broadcastsTransmitted, multicastsReceived=multicastsReceived, vendorOui=vendorOui, broadcastsReceived=broadcastsReceived, vlangroupTable=vlangroupTable, qos=qos, port2=port2, qosEntry=qosEntry, ddminfo=ddminfo, domainame=domainame, dscpEnable=dscpEnable, txPower=txPower, staticIpHostName=staticIpHostName, portName=portName, groupIndex=groupIndex, staticDns=staticDns, lanportpause=lanportpause, statIndex=statIndex, jumb=jumb, temperature=temperature, bias=bias, hostname=hostname, vendorPn=vendorPn, voltage=voltage, lan3=lan3, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, tftp=tftp, qmode=qmode, portStatEntry=portStatEntry, tftpSevIp=tftpSevIp, staticIpDomainName=staticIpDomainName, multicastsTransmitted=multicastsTransmitted, jumblan4=jumblan4, staticIpAddr=staticIpAddr, internetPort=internetPort, jumblan3=jumblan3, rxPower=rxPower, lan1=lan1, modeEntry=modeEntry, lanportName=lanportName, wanType=wanType, fileName=fileName, action=action, unicastsTransmitted=unicastsTransmitted, catvEnable=catvEnable, statisticTable=statisticTable, fileType=fileType)
