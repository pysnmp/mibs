...
# Produced by pysmi-1.1.8 at Thu Oct 26 09:06:06 2023
...
Bits, Gauge32, mib_2, ModuleIdentity, snmpModules, Counter32, enterprises, ObjectIdentity, Counter64, Unsigned32, TimeTicks, iso, Integer32, NotificationType, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "mib-2", "ModuleIdentity", "snmpModules", "Counter32", "enterprises", "ObjectIdentity", "Counter64", "Unsigned32", "TimeTicks", "iso", "Integer32", "NotificationType", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portmode=portmode, adminStatus=adminStatus, groupid=groupid, portStatistic=portStatistic, multicastsTransmitted=multicastsTransmitted, wan=wan, lan2=lan2, lan1=lan1, wanType=wanType, staticIpHostName=staticIpHostName, statIndex=statIndex, rebootEnable=rebootEnable, lanportName=lanportName, lan3=lan3, serialnum=serialnum, domainame=domainame, statisticTable=statisticTable, fcsErrorReceived=fcsErrorReceived, txPower=txPower, dscpEnable=dscpEnable, jumb=jumb, broadcastsReceived=broadcastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, qosTable=qosTable, priority=priority, bias=bias, staticIpDomainName=staticIpDomainName, qosEntry=qosEntry, vendorOui=vendorOui, xg6846=xg6846, rxPower=rxPower, unicastsReceived=unicastsReceived, vendorRev=vendorRev, vendorPn=vendorPn, vlangroupTable=vlangroupTable, vlan=vlan, fileType=fileType, ddminfo=ddminfo, pauseTransmitted=pauseTransmitted, jumbwan=jumbwan, portStatEntry=portStatEntry, catvEnable=catvEnable, portEntry=portEntry, port1=port1, jumblan2=jumblan2, staticIpGateway=staticIpGateway, portPower=portPower, port3=port3, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, jumblan4=jumblan4, lanportIndex=lanportIndex, modeEntry=modeEntry, reboot=reboot, qosIndex=qosIndex, lanportTable=lanportTable, port2=port2, fileName=fileName, jumblan3=jumblan3, staticIpAddr=staticIpAddr, operStatus=operStatus, action=action, staticDns=staticDns, internetPort=internetPort, lan4=lan4, multicastsReceived=multicastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, secondaryDns=secondaryDns, tftpSevIp=tftpSevIp, jumblan1=jumblan1, qmapping=qmapping, voltage=voltage, groupEntry=groupEntry, temperature=temperature, primaryDns=primaryDns, qos=qos, staticIpSubMask=staticIpSubMask, fcsErrorTransmitted=fcsErrorTransmitted, pauseReceived=pauseReceived, speed=speed, port4=port4, portName=portName, portTable=portTable, vendorName=vendorName, portIndex=portIndex, deviceinfo=deviceinfo, lanportpause=lanportpause, qmode=qmode, lanportspeed=lanportspeed, groupIndex=groupIndex, vlanid=vlanid, catv=catv, unicastsTransmitted=unicastsTransmitted, tftp=tftp)
