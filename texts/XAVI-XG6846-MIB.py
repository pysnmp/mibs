...
ObjectIdentity, Gauge32, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, mib_2, NotificationType, iso, TimeTicks, Integer32, MibIdentifier, Bits, enterprises, Counter64, snmpModules, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "mib-2", "NotificationType", "iso", "TimeTicks", "Integer32", "MibIdentifier", "Bits", "enterprises", "Counter64", "snmpModules", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseReceived=pauseReceived, portTable=portTable, jumblan2=jumblan2, bias=bias, jumblan4=jumblan4, rebootEnable=rebootEnable, operStatus=operStatus, dscpEnable=dscpEnable, qmapping=qmapping, broadcastsTransmitted=broadcastsTransmitted, jumblan1=jumblan1, qosIndex=qosIndex, groupIndex=groupIndex, fileType=fileType, staticIpPrimaryDns=staticIpPrimaryDns, speed=speed, txPower=txPower, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, port3=port3, port4=port4, priority=priority, portEntry=portEntry, lanportspeed=lanportspeed, jumb=jumb, port2=port2, unicastsReceived=unicastsReceived, vendorPn=vendorPn, qmode=qmode, serialnum=serialnum, jumbwan=jumbwan, staticIpAddr=staticIpAddr, internetPort=internetPort, reboot=reboot, qosEntry=qosEntry, lanportpause=lanportpause, action=action, xg6846=xg6846, catvEnable=catvEnable, primaryDns=primaryDns, wanType=wanType, qosTable=qosTable, multicastsTransmitted=multicastsTransmitted, vlanid=vlanid, statisticTable=statisticTable, tftp=tftp, wan=wan, staticIpDomainName=staticIpDomainName, staticIpSubMask=staticIpSubMask, lan2=lan2, lan4=lan4, portStatEntry=portStatEntry, broadcastsReceived=broadcastsReceived, deviceinfo=deviceinfo, vlan=vlan, lanportTable=lanportTable, staticIpHostName=staticIpHostName, hostname=hostname, temperature=temperature, lan1=lan1, vendorRev=vendorRev, groupEntry=groupEntry, portPower=portPower, lanportName=lanportName, modeEntry=modeEntry, groupid=groupid, lanportIndex=lanportIndex, jumblan3=jumblan3, tftpSevIp=tftpSevIp, unicastsTransmitted=unicastsTransmitted, lan3=lan3, portIndex=portIndex, fcsErrorTransmitted=fcsErrorTransmitted, domainame=domainame, portName=portName, port1=port1, catv=catv, portStatistic=portStatistic, portmode=portmode, vendorOui=vendorOui, secondaryDns=secondaryDns, rxPower=rxPower, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, qos=qos, staticDns=staticDns, pauseTransmitted=pauseTransmitted, statIndex=statIndex, staticIpGateway=staticIpGateway, fileName=fileName, adminStatus=adminStatus, vlangroupTable=vlangroupTable, vendorName=vendorName, voltage=voltage)
