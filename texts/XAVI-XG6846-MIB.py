...
NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, ModuleIdentity, TimeTicks, MibIdentifier, enterprises, mib_2, iso, snmpModules, Gauge32, Integer32, Unsigned32, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "ModuleIdentity", "TimeTicks", "MibIdentifier", "enterprises", "mib-2", "iso", "snmpModules", "Gauge32", "Integer32", "Unsigned32", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", priority=priority, port1=port1, xg6846=xg6846, unicastsReceived=unicastsReceived, fcsErrorReceived=fcsErrorReceived, lan4=lan4, fcsErrorTransmitted=fcsErrorTransmitted, portName=portName, domainame=domainame, portEntry=portEntry, modeEntry=modeEntry, qmapping=qmapping, speed=speed, lanportIndex=lanportIndex, jumblan1=jumblan1, statIndex=statIndex, multicastsReceived=multicastsReceived, portTable=portTable, tftp=tftp, wan=wan, lanportName=lanportName, jumblan4=jumblan4, portStatistic=portStatistic, wanType=wanType, reboot=reboot, staticIpAddr=staticIpAddr, portStatEntry=portStatEntry, jumblan3=jumblan3, qosEntry=qosEntry, port4=port4, staticIpSecondaryDns=staticIpSecondaryDns, vlan=vlan, portPower=portPower, portmode=portmode, secondaryDns=secondaryDns, voltage=voltage, vlanid=vlanid, internetPort=internetPort, qmode=qmode, qosTable=qosTable, jumbwan=jumbwan, ddminfo=ddminfo, staticIpHostName=staticIpHostName, multicastsTransmitted=multicastsTransmitted, adminStatus=adminStatus, deviceinfo=deviceinfo, qos=qos, portIndex=portIndex, qosIndex=qosIndex, operStatus=operStatus, port3=port3, fileType=fileType, vlangroupTable=vlangroupTable, groupEntry=groupEntry, rebootEnable=rebootEnable, action=action, vendorPn=vendorPn, txPower=txPower, jumb=jumb, groupIndex=groupIndex, rxPower=rxPower, broadcastsReceived=broadcastsReceived, lanportspeed=lanportspeed, temperature=temperature, lanportpause=lanportpause, groupid=groupid, vendorOui=vendorOui, staticDns=staticDns, bias=bias, statisticTable=statisticTable, vendorRev=vendorRev, jumblan2=jumblan2, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, tftpSevIp=tftpSevIp, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, pauseTransmitted=pauseTransmitted, lan2=lan2, lan3=lan3, pauseReceived=pauseReceived, catv=catv, fileName=fileName, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, port2=port2, primaryDns=primaryDns, catvEnable=catvEnable, vendorName=vendorName, dscpEnable=dscpEnable, lan1=lan1, serialnum=serialnum, staticIpDomainName=staticIpDomainName)
