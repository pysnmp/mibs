...
snmpModules, mib_2, Unsigned32, ObjectIdentity, Gauge32, Counter32, enterprises, iso, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, MibIdentifier, NotificationType, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "mib-2", "Unsigned32", "ObjectIdentity", "Gauge32", "Counter32", "enterprises", "iso", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "MibIdentifier", "NotificationType", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, operStatus=operStatus, lan2=lan2, port4=port4, lanportIndex=lanportIndex, lanportName=lanportName, txPower=txPower, port3=port3, lan1=lan1, staticIpAddr=staticIpAddr, qosIndex=qosIndex, lan4=lan4, staticIpSecondaryDns=staticIpSecondaryDns, lanportspeed=lanportspeed, multicastsTransmitted=multicastsTransmitted, portStatEntry=portStatEntry, speed=speed, jumblan4=jumblan4, statIndex=statIndex, deviceinfo=deviceinfo, staticIpDomainName=staticIpDomainName, unicastsReceived=unicastsReceived, port2=port2, temperature=temperature, priority=priority, voltage=voltage, broadcastsReceived=broadcastsReceived, groupid=groupid, rebootEnable=rebootEnable, jumblan1=jumblan1, portEntry=portEntry, internetPort=internetPort, fcsErrorReceived=fcsErrorReceived, action=action, port1=port1, portStatistic=portStatistic, ddminfo=ddminfo, wanType=wanType, rxPower=rxPower, unicastsTransmitted=unicastsTransmitted, lanportpause=lanportpause, tftpSevIp=tftpSevIp, jumb=jumb, portIndex=portIndex, vendorRev=vendorRev, portName=portName, bias=bias, jumblan2=jumblan2, vlanid=vlanid, primaryDns=primaryDns, catv=catv, secondaryDns=secondaryDns, portmode=portmode, fileType=fileType, pauseReceived=pauseReceived, serialnum=serialnum, qmapping=qmapping, broadcastsTransmitted=broadcastsTransmitted, staticDns=staticDns, fileName=fileName, staticIpGateway=staticIpGateway, wan=wan, statisticTable=statisticTable, hostname=hostname, staticIpHostName=staticIpHostName, vendorName=vendorName, multicastsReceived=multicastsReceived, domainame=domainame, tftp=tftp, qos=qos, fcsErrorTransmitted=fcsErrorTransmitted, vlan=vlan, staticIpSubMask=staticIpSubMask, pauseTransmitted=pauseTransmitted, qosTable=qosTable, qosEntry=qosEntry, portTable=portTable, jumbwan=jumbwan, staticIpPrimaryDns=staticIpPrimaryDns, xg6846=xg6846, lanportTable=lanportTable, vendorOui=vendorOui, portPower=portPower, vlangroupTable=vlangroupTable, qmode=qmode, catvEnable=catvEnable, groupIndex=groupIndex, groupEntry=groupEntry, lan3=lan3, vendorPn=vendorPn, adminStatus=adminStatus, jumblan3=jumblan3, dscpEnable=dscpEnable, reboot=reboot)
