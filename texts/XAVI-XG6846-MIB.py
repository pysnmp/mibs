...
Counter64, NotificationType, ObjectIdentity, snmpModules, Counter32, ModuleIdentity, enterprises, Integer32, iso, Gauge32, Unsigned32, Bits, MibIdentifier, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "ObjectIdentity", "snmpModules", "Counter32", "ModuleIdentity", "enterprises", "Integer32", "iso", "Gauge32", "Unsigned32", "Bits", "MibIdentifier", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportpause=lanportpause, jumblan2=jumblan2, deviceinfo=deviceinfo, modeEntry=modeEntry, jumblan4=jumblan4, broadcastsTransmitted=broadcastsTransmitted, staticIpAddr=staticIpAddr, action=action, tftp=tftp, jumblan3=jumblan3, pauseTransmitted=pauseTransmitted, domainame=domainame, hostname=hostname, pauseReceived=pauseReceived, portmode=portmode, speed=speed, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, groupid=groupid, jumb=jumb, wan=wan, staticDns=staticDns, jumbwan=jumbwan, xg6846=xg6846, fileType=fileType, qmapping=qmapping, statisticTable=statisticTable, secondaryDns=secondaryDns, catv=catv, bias=bias, wanType=wanType, primaryDns=primaryDns, portIndex=portIndex, dscpEnable=dscpEnable, vlangroupTable=vlangroupTable, port2=port2, qosTable=qosTable, groupEntry=groupEntry, operStatus=operStatus, staticIpGateway=staticIpGateway, fileName=fileName, temperature=temperature, unicastsReceived=unicastsReceived, portName=portName, vendorRev=vendorRev, rxPower=rxPower, jumblan1=jumblan1, portPower=portPower, statIndex=statIndex, multicastsTransmitted=multicastsTransmitted, vendorName=vendorName, multicastsReceived=multicastsReceived, tftpSevIp=tftpSevIp, port1=port1, portStatEntry=portStatEntry, portEntry=portEntry, lan3=lan3, ddminfo=ddminfo, unicastsTransmitted=unicastsTransmitted, staticIpDomainName=staticIpDomainName, port3=port3, qosEntry=qosEntry, adminStatus=adminStatus, staticIpPrimaryDns=staticIpPrimaryDns, qmode=qmode, vendorPn=vendorPn, priority=priority, catvEnable=catvEnable, port4=port4, fcsErrorReceived=fcsErrorReceived, qosIndex=qosIndex, txPower=txPower, reboot=reboot, vlan=vlan, lan2=lan2, lanportIndex=lanportIndex, fcsErrorTransmitted=fcsErrorTransmitted, groupIndex=groupIndex, lanportName=lanportName, qos=qos, lan4=lan4, rebootEnable=rebootEnable, staticIpHostName=staticIpHostName, internetPort=internetPort, lanportspeed=lanportspeed, portStatistic=portStatistic, voltage=voltage, portTable=portTable, vendorOui=vendorOui, serialnum=serialnum, lan1=lan1, vlanid=vlanid, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsReceived=broadcastsReceived)
