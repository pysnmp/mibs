...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:51:27 2021
...
snmpModules, Integer32, Gauge32, NotificationType, iso, Counter32, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, MibIdentifier, enterprises, mib_2, ModuleIdentity, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Integer32", "Gauge32", "NotificationType", "iso", "Counter32", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "MibIdentifier", "enterprises", "mib-2", "ModuleIdentity", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", bias=bias, groupEntry=groupEntry, lan3=lan3, staticIpSubMask=staticIpSubMask, pauseReceived=pauseReceived, secondaryDns=secondaryDns, lanportTable=lanportTable, staticIpDomainName=staticIpDomainName, multicastsReceived=multicastsReceived, domainame=domainame, portEntry=portEntry, reboot=reboot, qmode=qmode, modeEntry=modeEntry, xg6846=xg6846, serialnum=serialnum, staticIpAddr=staticIpAddr, jumb=jumb, port1=port1, portIndex=portIndex, vendorRev=vendorRev, rebootEnable=rebootEnable, portName=portName, hostname=hostname, multicastsTransmitted=multicastsTransmitted, qosEntry=qosEntry, internetPort=internetPort, groupIndex=groupIndex, jumblan3=jumblan3, lanportIndex=lanportIndex, unicastsTransmitted=unicastsTransmitted, port3=port3, staticIpGateway=staticIpGateway, wanType=wanType, portTable=portTable, lanportspeed=lanportspeed, adminStatus=adminStatus, jumblan4=jumblan4, lan4=lan4, port2=port2, catvEnable=catvEnable, priority=priority, lan2=lan2, fileName=fileName, qmapping=qmapping, portStatEntry=portStatEntry, jumblan2=jumblan2, catv=catv, statisticTable=statisticTable, rxPower=rxPower, tftpSevIp=tftpSevIp, vendorOui=vendorOui, broadcastsTransmitted=broadcastsTransmitted, groupid=groupid, operStatus=operStatus, qosIndex=qosIndex, vlanid=vlanid, staticIpSecondaryDns=staticIpSecondaryDns, dscpEnable=dscpEnable, ddminfo=ddminfo, lanportpause=lanportpause, fileType=fileType, portStatistic=portStatistic, action=action, jumblan1=jumblan1, vendorPn=vendorPn, staticIpHostName=staticIpHostName, lan1=lan1, lanportName=lanportName, tftp=tftp, statIndex=statIndex, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, qosTable=qosTable, staticDns=staticDns, temperature=temperature, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, speed=speed, deviceinfo=deviceinfo, unicastsReceived=unicastsReceived, vendorName=vendorName, wan=wan, primaryDns=primaryDns, qos=qos, txPower=txPower, port4=port4, vlan=vlan, fcsErrorReceived=fcsErrorReceived, portmode=portmode, jumbwan=jumbwan, portPower=portPower, vlangroupTable=vlangroupTable, voltage=voltage)
