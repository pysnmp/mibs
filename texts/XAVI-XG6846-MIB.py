...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:27:46 2023
...
enterprises, Counter32, Integer32, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, MibIdentifier, ObjectIdentity, iso, ModuleIdentity, Unsigned32, Counter64, snmpModules, NotificationType, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "Integer32", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "MibIdentifier", "ObjectIdentity", "iso", "ModuleIdentity", "Unsigned32", "Counter64", "snmpModules", "NotificationType", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", action=action, lan4=lan4, secondaryDns=secondaryDns, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, lanportspeed=lanportspeed, multicastsTransmitted=multicastsTransmitted, staticIpHostName=staticIpHostName, portPower=portPower, jumblan3=jumblan3, staticIpGateway=staticIpGateway, qos=qos, jumblan2=jumblan2, catv=catv, adminStatus=adminStatus, qosEntry=qosEntry, broadcastsReceived=broadcastsReceived, statisticTable=statisticTable, staticDns=staticDns, qmapping=qmapping, tftpSevIp=tftpSevIp, port2=port2, port4=port4, rxPower=rxPower, portTable=portTable, qosTable=qosTable, groupIndex=groupIndex, fcsErrorReceived=fcsErrorReceived, jumblan1=jumblan1, serialnum=serialnum, vlan=vlan, vendorName=vendorName, portStatistic=portStatistic, fcsErrorTransmitted=fcsErrorTransmitted, vendorOui=vendorOui, catvEnable=catvEnable, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, jumbwan=jumbwan, jumb=jumb, bias=bias, fileName=fileName, jumblan4=jumblan4, rebootEnable=rebootEnable, dscpEnable=dscpEnable, lanportpause=lanportpause, tftp=tftp, lan1=lan1, voltage=voltage, reboot=reboot, staticIpAddr=staticIpAddr, unicastsReceived=unicastsReceived, temperature=temperature, groupid=groupid, qosIndex=qosIndex, vendorRev=vendorRev, statIndex=statIndex, pauseReceived=pauseReceived, speed=speed, wan=wan, txPower=txPower, portIndex=portIndex, portStatEntry=portStatEntry, vendorPn=vendorPn, lanportIndex=lanportIndex, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, operStatus=operStatus, primaryDns=primaryDns, internetPort=internetPort, lan3=lan3, modeEntry=modeEntry, wanType=wanType, vlangroupTable=vlangroupTable, vlanid=vlanid, port1=port1, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, portEntry=portEntry, groupEntry=groupEntry, xg6846=xg6846, pauseTransmitted=pauseTransmitted, ddminfo=ddminfo, lanportTable=lanportTable, priority=priority, qmode=qmode, lan2=lan2, lanportName=lanportName, staticIpDomainName=staticIpDomainName, portmode=portmode, portName=portName, fileType=fileType, domainame=domainame, port3=port3)
