...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:31:51 2021
...
IpAddress, Counter64, ModuleIdentity, MibIdentifier, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, ObjectIdentity, Counter32, enterprises, iso, snmpModules, mib_2, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "ObjectIdentity", "Counter32", "enterprises", "iso", "snmpModules", "mib-2", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", xg6846=xg6846, lanportIndex=lanportIndex, jumblan4=jumblan4, statisticTable=statisticTable, staticIpAddr=staticIpAddr, vlanid=vlanid, portmode=portmode, qmapping=qmapping, vlangroupTable=vlangroupTable, broadcastsTransmitted=broadcastsTransmitted, wan=wan, portEntry=portEntry, portIndex=portIndex, groupIndex=groupIndex, staticIpPrimaryDns=staticIpPrimaryDns, lanportName=lanportName, lan3=lan3, qosIndex=qosIndex, lanportpause=lanportpause, hostname=hostname, portTable=portTable, reboot=reboot, lan2=lan2, lanportTable=lanportTable, tftp=tftp, jumb=jumb, vendorName=vendorName, pauseReceived=pauseReceived, jumblan1=jumblan1, pauseTransmitted=pauseTransmitted, speed=speed, tftpSevIp=tftpSevIp, temperature=temperature, groupid=groupid, lan1=lan1, lan4=lan4, internetPort=internetPort, vlan=vlan, wanType=wanType, domainame=domainame, port2=port2, secondaryDns=secondaryDns, qosEntry=qosEntry, fileType=fileType, adminStatus=adminStatus, qmode=qmode, multicastsReceived=multicastsReceived, txPower=txPower, staticIpDomainName=staticIpDomainName, portPower=portPower, catvEnable=catvEnable, staticIpSubMask=staticIpSubMask, port4=port4, vendorPn=vendorPn, modeEntry=modeEntry, priority=priority, rxPower=rxPower, multicastsTransmitted=multicastsTransmitted, staticDns=staticDns, bias=bias, jumblan2=jumblan2, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, groupEntry=groupEntry, deviceinfo=deviceinfo, statIndex=statIndex, vendorOui=vendorOui, qos=qos, primaryDns=primaryDns, ddminfo=ddminfo, portName=portName, serialnum=serialnum, operStatus=operStatus, staticIpHostName=staticIpHostName, action=action, catv=catv, rebootEnable=rebootEnable, port1=port1, jumbwan=jumbwan, port3=port3, staticIpSecondaryDns=staticIpSecondaryDns, portStatistic=portStatistic, qosTable=qosTable, portStatEntry=portStatEntry, vendorRev=vendorRev, fcsErrorTransmitted=fcsErrorTransmitted, unicastsReceived=unicastsReceived, broadcastsReceived=broadcastsReceived, fileName=fileName, lanportspeed=lanportspeed, voltage=voltage, dscpEnable=dscpEnable, jumblan3=jumblan3)
