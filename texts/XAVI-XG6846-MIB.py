...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:20:52 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, snmpModules, Counter32, Bits, iso, Gauge32, enterprises, ObjectIdentity, ModuleIdentity, NotificationType, mib_2, TimeTicks, Counter64, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "snmpModules", "Counter32", "Bits", "iso", "Gauge32", "enterprises", "ObjectIdentity", "ModuleIdentity", "NotificationType", "mib-2", "TimeTicks", "Counter64", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpGateway=staticIpGateway, internetPort=internetPort, hostname=hostname, staticIpHostName=staticIpHostName, wan=wan, lanportIndex=lanportIndex, qosTable=qosTable, temperature=temperature, txPower=txPower, vendorName=vendorName, operStatus=operStatus, groupEntry=groupEntry, modeEntry=modeEntry, groupid=groupid, catv=catv, action=action, serialnum=serialnum, qmapping=qmapping, port4=port4, lan3=lan3, jumblan4=jumblan4, unicastsReceived=unicastsReceived, portmode=portmode, lanportspeed=lanportspeed, catvEnable=catvEnable, port1=port1, fileType=fileType, qmode=qmode, rebootEnable=rebootEnable, adminStatus=adminStatus, port3=port3, lanportName=lanportName, vlanid=vlanid, qosIndex=qosIndex, staticDns=staticDns, portName=portName, multicastsReceived=multicastsReceived, statisticTable=statisticTable, staticIpPrimaryDns=staticIpPrimaryDns, lan2=lan2, rxPower=rxPower, portStatistic=portStatistic, pauseReceived=pauseReceived, portStatEntry=portStatEntry, lan1=lan1, vlangroupTable=vlangroupTable, fcsErrorReceived=fcsErrorReceived, bias=bias, broadcastsTransmitted=broadcastsTransmitted, secondaryDns=secondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, tftpSevIp=tftpSevIp, staticIpDomainName=staticIpDomainName, lan4=lan4, deviceinfo=deviceinfo, primaryDns=primaryDns, portIndex=portIndex, jumblan2=jumblan2, jumb=jumb, qosEntry=qosEntry, lanportpause=lanportpause, portTable=portTable, dscpEnable=dscpEnable, jumbwan=jumbwan, staticIpSubMask=staticIpSubMask, tftp=tftp, portEntry=portEntry, qos=qos, vendorRev=vendorRev, speed=speed, vendorPn=vendorPn, ddminfo=ddminfo, wanType=wanType, vlan=vlan, groupIndex=groupIndex, jumblan1=jumblan1, domainame=domainame, voltage=voltage, fileName=fileName, reboot=reboot, staticIpAddr=staticIpAddr, lanportTable=lanportTable, xg6846=xg6846, pauseTransmitted=pauseTransmitted, statIndex=statIndex, broadcastsReceived=broadcastsReceived, vendorOui=vendorOui, staticIpSecondaryDns=staticIpSecondaryDns, priority=priority, unicastsTransmitted=unicastsTransmitted, jumblan3=jumblan3, portPower=portPower, port2=port2, multicastsTransmitted=multicastsTransmitted)
