...
ModuleIdentity, TimeTicks, enterprises, snmpModules, iso, ObjectIdentity, NotificationType, Counter32, Integer32, Unsigned32, MibIdentifier, Gauge32, Bits, IpAddress, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "enterprises", "snmpModules", "iso", "ObjectIdentity", "NotificationType", "Counter32", "Integer32", "Unsigned32", "MibIdentifier", "Gauge32", "Bits", "IpAddress", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", ddminfo=ddminfo, lanportspeed=lanportspeed, jumblan2=jumblan2, voltage=voltage, vendorPn=vendorPn, fileType=fileType, rxPower=rxPower, rebootEnable=rebootEnable, staticIpGateway=staticIpGateway, txPower=txPower, wanType=wanType, action=action, groupEntry=groupEntry, portmode=portmode, lan4=lan4, secondaryDns=secondaryDns, port3=port3, port1=port1, staticIpPrimaryDns=staticIpPrimaryDns, vlangroupTable=vlangroupTable, port2=port2, statIndex=statIndex, qmapping=qmapping, fileName=fileName, serialnum=serialnum, portTable=portTable, lanportTable=lanportTable, wan=wan, portPower=portPower, lanportIndex=lanportIndex, lan1=lan1, groupid=groupid, reboot=reboot, vendorName=vendorName, staticIpAddr=staticIpAddr, lanportpause=lanportpause, staticIpDomainName=staticIpDomainName, statisticTable=statisticTable, temperature=temperature, broadcastsReceived=broadcastsReceived, portName=portName, catvEnable=catvEnable, fcsErrorReceived=fcsErrorReceived, deviceinfo=deviceinfo, staticDns=staticDns, adminStatus=adminStatus, speed=speed, portEntry=portEntry, primaryDns=primaryDns, jumblan3=jumblan3, qosTable=qosTable, hostname=hostname, jumb=jumb, jumblan4=jumblan4, dscpEnable=dscpEnable, catv=catv, staticIpSubMask=staticIpSubMask, vendorOui=vendorOui, lanportName=lanportName, priority=priority, bias=bias, multicastsTransmitted=multicastsTransmitted, groupIndex=groupIndex, modeEntry=modeEntry, lan3=lan3, portStatistic=portStatistic, qosIndex=qosIndex, qmode=qmode, lan2=lan2, multicastsReceived=multicastsReceived, vlan=vlan, tftp=tftp, staticIpHostName=staticIpHostName, jumbwan=jumbwan, staticIpSecondaryDns=staticIpSecondaryDns, vendorRev=vendorRev, tftpSevIp=tftpSevIp, portStatEntry=portStatEntry, pauseTransmitted=pauseTransmitted, operStatus=operStatus, internetPort=internetPort, xg6846=xg6846, portIndex=portIndex, jumblan1=jumblan1, qosEntry=qosEntry, pauseReceived=pauseReceived, vlanid=vlanid, domainame=domainame, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsTransmitted=broadcastsTransmitted, qos=qos, port4=port4, unicastsReceived=unicastsReceived, unicastsTransmitted=unicastsTransmitted)
