...
# Produced by pysmi-1.1.12 at Wed Nov  6 08:32:39 2024
...
NotificationType, ModuleIdentity, enterprises, mib_2, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Unsigned32, iso, Bits, Gauge32, TimeTicks, IpAddress, MibIdentifier, snmpModules, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "enterprises", "mib-2", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Unsigned32", "iso", "Bits", "Gauge32", "TimeTicks", "IpAddress", "MibIdentifier", "snmpModules", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", temperature=temperature, multicastsTransmitted=multicastsTransmitted, statisticTable=statisticTable, staticIpGateway=staticIpGateway, groupIndex=groupIndex, wan=wan, groupEntry=groupEntry, staticIpSecondaryDns=staticIpSecondaryDns, vlan=vlan, qmapping=qmapping, modeEntry=modeEntry, unicastsTransmitted=unicastsTransmitted, vendorName=vendorName, catv=catv, portmode=portmode, portIndex=portIndex, statIndex=statIndex, fileType=fileType, jumb=jumb, jumblan1=jumblan1, tftp=tftp, jumblan3=jumblan3, qosEntry=qosEntry, lanportspeed=lanportspeed, fcsErrorTransmitted=fcsErrorTransmitted, lan2=lan2, internetPort=internetPort, groupid=groupid, port3=port3, rxPower=rxPower, jumblan4=jumblan4, staticIpAddr=staticIpAddr, domainame=domainame, lanportTable=lanportTable, vendorPn=vendorPn, reboot=reboot, staticIpPrimaryDns=staticIpPrimaryDns, qosTable=qosTable, adminStatus=adminStatus, dscpEnable=dscpEnable, operStatus=operStatus, speed=speed, vendorOui=vendorOui, jumblan2=jumblan2, ddminfo=ddminfo, port2=port2, lanportIndex=lanportIndex, fileName=fileName, priority=priority, bias=bias, portStatistic=portStatistic, port4=port4, portName=portName, primaryDns=primaryDns, lan3=lan3, voltage=voltage, staticIpSubMask=staticIpSubMask, deviceinfo=deviceinfo, xg6846=xg6846, staticDns=staticDns, action=action, lanportpause=lanportpause, vlanid=vlanid, multicastsReceived=multicastsReceived, broadcastsTransmitted=broadcastsTransmitted, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, hostname=hostname, portTable=portTable, txPower=txPower, staticIpHostName=staticIpHostName, serialnum=serialnum, unicastsReceived=unicastsReceived, vlangroupTable=vlangroupTable, fcsErrorReceived=fcsErrorReceived, lanportName=lanportName, qos=qos, portEntry=portEntry, portPower=portPower, qosIndex=qosIndex, pauseReceived=pauseReceived, qmode=qmode, jumbwan=jumbwan, lan1=lan1, tftpSevIp=tftpSevIp, lan4=lan4, vendorRev=vendorRev, wanType=wanType, portStatEntry=portStatEntry, catvEnable=catvEnable, rebootEnable=rebootEnable, port1=port1, staticIpDomainName=staticIpDomainName, secondaryDns=secondaryDns)
