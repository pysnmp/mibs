...
# Produced by pysmi-1.1.8 at Mon Jan  9 10:32:56 2023
...
snmpModules, Counter32, Integer32, Counter64, ModuleIdentity, TimeTicks, ObjectIdentity, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, Unsigned32, mib_2, Bits, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Counter32", "Integer32", "Counter64", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "Unsigned32", "mib-2", "Bits", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, port4=port4, pauseReceived=pauseReceived, staticDns=staticDns, ddminfo=ddminfo, qosTable=qosTable, rxPower=rxPower, port3=port3, dscpEnable=dscpEnable, internetPort=internetPort, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, port1=port1, deviceinfo=deviceinfo, qmapping=qmapping, portEntry=portEntry, statIndex=statIndex, multicastsTransmitted=multicastsTransmitted, operStatus=operStatus, vendorOui=vendorOui, lan2=lan2, lan3=lan3, jumblan1=jumblan1, tftpSevIp=tftpSevIp, groupid=groupid, lanportspeed=lanportspeed, speed=speed, priority=priority, lanportName=lanportName, catv=catv, domainame=domainame, portTable=portTable, hostname=hostname, portStatistic=portStatistic, wan=wan, staticIpSubMask=staticIpSubMask, txPower=txPower, portStatEntry=portStatEntry, secondaryDns=secondaryDns, jumbwan=jumbwan, modeEntry=modeEntry, fileName=fileName, temperature=temperature, fcsErrorTransmitted=fcsErrorTransmitted, fileType=fileType, reboot=reboot, staticIpHostName=staticIpHostName, lanportpause=lanportpause, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, vlangroupTable=vlangroupTable, staticIpSecondaryDns=staticIpSecondaryDns, tftp=tftp, qos=qos, qmode=qmode, vlanid=vlanid, wanType=wanType, vendorName=vendorName, rebootEnable=rebootEnable, lan4=lan4, catvEnable=catvEnable, qosEntry=qosEntry, portName=portName, groupEntry=groupEntry, multicastsReceived=multicastsReceived, groupIndex=groupIndex, voltage=voltage, serialnum=serialnum, lanportTable=lanportTable, adminStatus=adminStatus, portPower=portPower, port2=port2, qosIndex=qosIndex, staticIpAddr=staticIpAddr, lan1=lan1, unicastsReceived=unicastsReceived, vlan=vlan, staticIpGateway=staticIpGateway, vendorPn=vendorPn, primaryDns=primaryDns, staticIpPrimaryDns=staticIpPrimaryDns, portmode=portmode, statisticTable=statisticTable, lanportIndex=lanportIndex, staticIpDomainName=staticIpDomainName, portIndex=portIndex, jumblan2=jumblan2, action=action, jumb=jumb, jumblan4=jumblan4, jumblan3=jumblan3, bias=bias, vendorRev=vendorRev)
