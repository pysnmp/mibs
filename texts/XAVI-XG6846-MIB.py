...
# Produced by pysmi-1.1.3 at Sat Nov 20 17:19:19 2021
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, Counter32, Bits, MibIdentifier, IpAddress, ModuleIdentity, Integer32, ObjectIdentity, mib_2, Unsigned32, snmpModules, NotificationType, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "Counter32", "Bits", "MibIdentifier", "IpAddress", "ModuleIdentity", "Integer32", "ObjectIdentity", "mib-2", "Unsigned32", "snmpModules", "NotificationType", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan2=jumblan2, vendorName=vendorName, qmode=qmode, portIndex=portIndex, bias=bias, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus, lanportTable=lanportTable, port3=port3, pauseReceived=pauseReceived, port2=port2, broadcastsReceived=broadcastsReceived, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, jumblan4=jumblan4, lan1=lan1, portmode=portmode, groupEntry=groupEntry, portStatEntry=portStatEntry, broadcastsTransmitted=broadcastsTransmitted, multicastsTransmitted=multicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, wanType=wanType, reboot=reboot, temperature=temperature, portTable=portTable, modeEntry=modeEntry, vendorPn=vendorPn, xg6846=xg6846, portStatistic=portStatistic, qosTable=qosTable, secondaryDns=secondaryDns, operStatus=operStatus, staticIpAddr=staticIpAddr, vlan=vlan, lan2=lan2, vendorRev=vendorRev, catvEnable=catvEnable, portEntry=portEntry, wan=wan, portPower=portPower, jumbwan=jumbwan, portName=portName, statisticTable=statisticTable, qmapping=qmapping, ddminfo=ddminfo, jumb=jumb, jumblan1=jumblan1, speed=speed, serialnum=serialnum, vlanid=vlanid, staticIpSecondaryDns=staticIpSecondaryDns, qos=qos, priority=priority, primaryDns=primaryDns, tftp=tftp, staticIpDomainName=staticIpDomainName, vendorOui=vendorOui, pauseTransmitted=pauseTransmitted, dscpEnable=dscpEnable, catv=catv, lanportName=lanportName, txPower=txPower, vlangroupTable=vlangroupTable, fileName=fileName, staticIpHostName=staticIpHostName, deviceinfo=deviceinfo, groupid=groupid, unicastsTransmitted=unicastsTransmitted, lanportspeed=lanportspeed, port1=port1, action=action, voltage=voltage, fileType=fileType, lan4=lan4, tftpSevIp=tftpSevIp, port4=port4, statIndex=statIndex, qosEntry=qosEntry, lan3=lan3, lanportIndex=lanportIndex, unicastsReceived=unicastsReceived, groupIndex=groupIndex, staticDns=staticDns, lanportpause=lanportpause, internetPort=internetPort, domainame=domainame, rebootEnable=rebootEnable, staticIpGateway=staticIpGateway, qosIndex=qosIndex, multicastsReceived=multicastsReceived, staticIpSubMask=staticIpSubMask, hostname=hostname, rxPower=rxPower)
