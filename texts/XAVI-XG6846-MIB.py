...
# Produced by pysmi-1.1.8 at Fri Dec  2 17:10:12 2022
...
ObjectIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, ModuleIdentity, TimeTicks, iso, Bits, mib_2, Counter32, Gauge32, Unsigned32, MibIdentifier, IpAddress, Integer32, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "ModuleIdentity", "TimeTicks", "iso", "Bits", "mib-2", "Counter32", "Gauge32", "Unsigned32", "MibIdentifier", "IpAddress", "Integer32", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosIndex=qosIndex, lanportspeed=lanportspeed, hostname=hostname, staticIpDomainName=staticIpDomainName, lanportName=lanportName, unicastsTransmitted=unicastsTransmitted, fileType=fileType, action=action, vlanid=vlanid, voltage=voltage, pauseReceived=pauseReceived, lan2=lan2, fcsErrorReceived=fcsErrorReceived, qmode=qmode, staticIpHostName=staticIpHostName, port1=port1, qmapping=qmapping, portEntry=portEntry, vendorRev=vendorRev, qos=qos, deviceinfo=deviceinfo, catv=catv, qosTable=qosTable, reboot=reboot, staticIpSecondaryDns=staticIpSecondaryDns, primaryDns=primaryDns, catvEnable=catvEnable, ddminfo=ddminfo, groupEntry=groupEntry, groupid=groupid, lanportIndex=lanportIndex, statisticTable=statisticTable, portStatEntry=portStatEntry, dscpEnable=dscpEnable, fileName=fileName, unicastsReceived=unicastsReceived, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, domainame=domainame, bias=bias, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, tftpSevIp=tftpSevIp, staticIpPrimaryDns=staticIpPrimaryDns, jumblan4=jumblan4, wan=wan, vlangroupTable=vlangroupTable, serialnum=serialnum, temperature=temperature, portmode=portmode, lan3=lan3, jumb=jumb, vlan=vlan, broadcastsTransmitted=broadcastsTransmitted, rxPower=rxPower, statIndex=statIndex, wanType=wanType, speed=speed, jumblan3=jumblan3, port2=port2, portStatistic=portStatistic, jumblan2=jumblan2, txPower=txPower, portIndex=portIndex, jumbwan=jumbwan, multicastsReceived=multicastsReceived, portTable=portTable, pauseTransmitted=pauseTransmitted, operStatus=operStatus, adminStatus=adminStatus, xg6846=xg6846, port3=port3, rebootEnable=rebootEnable, vendorName=vendorName, priority=priority, staticIpAddr=staticIpAddr, port4=port4, jumblan1=jumblan1, modeEntry=modeEntry, staticIpGateway=staticIpGateway, secondaryDns=secondaryDns, lanportTable=lanportTable, staticIpSubMask=staticIpSubMask, lan1=lan1, staticDns=staticDns, tftp=tftp, portPower=portPower, lan4=lan4, vendorOui=vendorOui, broadcastsReceived=broadcastsReceived, lanportpause=lanportpause, qosEntry=qosEntry, portName=portName, vendorPn=vendorPn)
