...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:29:32 2021
...
ModuleIdentity, ObjectIdentity, Counter64, Counter32, Bits, NotificationType, mib_2, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, Gauge32, TimeTicks, snmpModules, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Counter64", "Counter32", "Bits", "NotificationType", "mib-2", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "Gauge32", "TimeTicks", "snmpModules", "iso", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmode=qmode, secondaryDns=secondaryDns, reboot=reboot, vendorName=vendorName, port1=port1, txPower=txPower, groupEntry=groupEntry, rxPower=rxPower, portIndex=portIndex, portPower=portPower, wan=wan, serialnum=serialnum, pauseTransmitted=pauseTransmitted, deviceinfo=deviceinfo, jumblan2=jumblan2, pauseReceived=pauseReceived, lan3=lan3, staticIpSubMask=staticIpSubMask, port2=port2, portStatistic=portStatistic, catv=catv, primaryDns=primaryDns, fcsErrorTransmitted=fcsErrorTransmitted, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, tftp=tftp, unicastsReceived=unicastsReceived, wanType=wanType, port4=port4, qmapping=qmapping, speed=speed, portStatEntry=portStatEntry, vendorRev=vendorRev, fileName=fileName, voltage=voltage, jumblan1=jumblan1, modeEntry=modeEntry, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorReceived=fcsErrorReceived, temperature=temperature, lan1=lan1, portEntry=portEntry, priority=priority, vendorOui=vendorOui, statisticTable=statisticTable, staticIpAddr=staticIpAddr, tftpSevIp=tftpSevIp, qosEntry=qosEntry, vendorPn=vendorPn, hostname=hostname, ddminfo=ddminfo, adminStatus=adminStatus, dscpEnable=dscpEnable, domainame=domainame, qosIndex=qosIndex, staticIpGateway=staticIpGateway, lan4=lan4, staticIpHostName=staticIpHostName, rebootEnable=rebootEnable, lanportspeed=lanportspeed, port3=port3, jumb=jumb, broadcastsReceived=broadcastsReceived, jumblan3=jumblan3, fileType=fileType, lanportTable=lanportTable, multicastsReceived=multicastsReceived, lanportIndex=lanportIndex, vlanid=vlanid, lan2=lan2, unicastsTransmitted=unicastsTransmitted, groupid=groupid, portName=portName, staticIpDomainName=staticIpDomainName, broadcastsTransmitted=broadcastsTransmitted, qosTable=qosTable, action=action, jumblan4=jumblan4, qos=qos, portmode=portmode, catvEnable=catvEnable, staticDns=staticDns, lanportpause=lanportpause, statIndex=statIndex, xg6846=xg6846, vlan=vlan, operStatus=operStatus, portTable=portTable, jumbwan=jumbwan, lanportName=lanportName, multicastsTransmitted=multicastsTransmitted, groupIndex=groupIndex, vlangroupTable=vlangroupTable, internetPort=internetPort)
