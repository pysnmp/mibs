...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:56:31 2021
...
Counter32, Unsigned32, Gauge32, ModuleIdentity, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, snmpModules, enterprises, Integer32, Bits, NotificationType, iso, Counter64, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "Gauge32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "snmpModules", "enterprises", "Integer32", "Bits", "NotificationType", "iso", "Counter64", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileType=fileType, pauseTransmitted=pauseTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, portTable=portTable, broadcastsReceived=broadcastsReceived, vlanid=vlanid, staticIpSecondaryDns=staticIpSecondaryDns, qmode=qmode, catv=catv, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, multicastsTransmitted=multicastsTransmitted, hostname=hostname, portName=portName, reboot=reboot, txPower=txPower, catvEnable=catvEnable, unicastsReceived=unicastsReceived, speed=speed, serialnum=serialnum, secondaryDns=secondaryDns, groupid=groupid, fileName=fileName, portPower=portPower, port2=port2, portEntry=portEntry, operStatus=operStatus, rebootEnable=rebootEnable, qosEntry=qosEntry, jumblan2=jumblan2, adminStatus=adminStatus, lanportTable=lanportTable, jumblan4=jumblan4, staticIpGateway=staticIpGateway, wan=wan, vlangroupTable=vlangroupTable, groupIndex=groupIndex, vendorRev=vendorRev, staticIpPrimaryDns=staticIpPrimaryDns, staticIpDomainName=staticIpDomainName, qosTable=qosTable, lanportIndex=lanportIndex, lanportName=lanportName, voltage=voltage, statisticTable=statisticTable, xg6846=xg6846, primaryDns=primaryDns, priority=priority, lan3=lan3, modeEntry=modeEntry, port4=port4, temperature=temperature, portStatistic=portStatistic, port1=port1, unicastsTransmitted=unicastsTransmitted, vlan=vlan, jumblan3=jumblan3, rxPower=rxPower, ddminfo=ddminfo, deviceinfo=deviceinfo, vendorName=vendorName, staticDns=staticDns, lanportspeed=lanportspeed, portmode=portmode, port3=port3, staticIpHostName=staticIpHostName, statIndex=statIndex, staticIpSubMask=staticIpSubMask, vendorPn=vendorPn, qos=qos, lan2=lan2, fcsErrorReceived=fcsErrorReceived, lan1=lan1, tftp=tftp, domainame=domainame, qosIndex=qosIndex, jumblan1=jumblan1, lan4=lan4, qmapping=qmapping, broadcastsTransmitted=broadcastsTransmitted, wanType=wanType, bias=bias, jumb=jumb, groupEntry=groupEntry, internetPort=internetPort, jumbwan=jumbwan, portStatEntry=portStatEntry, lanportpause=lanportpause, action=action, vendorOui=vendorOui, dscpEnable=dscpEnable, pauseReceived=pauseReceived, tftpSevIp=tftpSevIp, portIndex=portIndex)
