...
Unsigned32, NotificationType, iso, Gauge32, IpAddress, enterprises, Integer32, TimeTicks, Counter64, ModuleIdentity, Counter32, mib_2, snmpModules, ObjectIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "iso", "Gauge32", "IpAddress", "enterprises", "Integer32", "TimeTicks", "Counter64", "ModuleIdentity", "Counter32", "mib-2", "snmpModules", "ObjectIdentity", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wanType=wanType, jumblan4=jumblan4, unicastsReceived=unicastsReceived, lan3=lan3, broadcastsReceived=broadcastsReceived, temperature=temperature, rebootEnable=rebootEnable, hostname=hostname, secondaryDns=secondaryDns, vendorRev=vendorRev, unicastsTransmitted=unicastsTransmitted, lanportIndex=lanportIndex, staticIpGateway=staticIpGateway, bias=bias, pauseTransmitted=pauseTransmitted, qmapping=qmapping, vendorName=vendorName, reboot=reboot, jumblan1=jumblan1, port1=port1, staticIpSubMask=staticIpSubMask, staticIpSecondaryDns=staticIpSecondaryDns, fileType=fileType, statisticTable=statisticTable, lanportTable=lanportTable, vlangroupTable=vlangroupTable, multicastsReceived=multicastsReceived, internetPort=internetPort, vlanid=vlanid, port3=port3, ddminfo=ddminfo, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, jumbwan=jumbwan, catv=catv, groupid=groupid, jumblan2=jumblan2, portmode=portmode, staticIpHostName=staticIpHostName, voltage=voltage, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsTransmitted=broadcastsTransmitted, wan=wan, lan4=lan4, port2=port2, qosEntry=qosEntry, port4=port4, txPower=txPower, action=action, fcsErrorTransmitted=fcsErrorTransmitted, groupIndex=groupIndex, statIndex=statIndex, portPower=portPower, portName=portName, fileName=fileName, pauseReceived=pauseReceived, portIndex=portIndex, vlan=vlan, serialnum=serialnum, xg6846=xg6846, rxPower=rxPower, tftp=tftp, dscpEnable=dscpEnable, lanportpause=lanportpause, multicastsTransmitted=multicastsTransmitted, staticIpAddr=staticIpAddr, portEntry=portEntry, portTable=portTable, lan2=lan2, lanportspeed=lanportspeed, qos=qos, operStatus=operStatus, priority=priority, deviceinfo=deviceinfo, vendorOui=vendorOui, primaryDns=primaryDns, domainame=domainame, qmode=qmode, groupEntry=groupEntry, lan1=lan1, modeEntry=modeEntry, portStatistic=portStatistic, portStatEntry=portStatEntry, adminStatus=adminStatus, vendorPn=vendorPn, catvEnable=catvEnable, staticIpDomainName=staticIpDomainName, qosTable=qosTable, tftpSevIp=tftpSevIp, jumb=jumb, lanportName=lanportName, qosIndex=qosIndex, staticDns=staticDns, speed=speed)
