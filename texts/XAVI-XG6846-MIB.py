...
# Produced by pysmi-1.1.3 at Sun Nov 28 15:03:48 2021
...
snmpModules, Unsigned32, Integer32, NotificationType, MibIdentifier, enterprises, ModuleIdentity, Bits, IpAddress, mib_2, TimeTicks, iso, ObjectIdentity, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Unsigned32", "Integer32", "NotificationType", "MibIdentifier", "enterprises", "ModuleIdentity", "Bits", "IpAddress", "mib-2", "TimeTicks", "iso", "ObjectIdentity", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portmode=portmode, temperature=temperature, port1=port1, groupEntry=groupEntry, qos=qos, txPower=txPower, priority=priority, vendorName=vendorName, lanportspeed=lanportspeed, lanportIndex=lanportIndex, qosEntry=qosEntry, statisticTable=statisticTable, lan1=lan1, rxPower=rxPower, wanType=wanType, pauseReceived=pauseReceived, reboot=reboot, domainame=domainame, adminStatus=adminStatus, portPower=portPower, fcsErrorTransmitted=fcsErrorTransmitted, staticIpHostName=staticIpHostName, qosTable=qosTable, jumb=jumb, unicastsReceived=unicastsReceived, port2=port2, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsReceived=broadcastsReceived, groupIndex=groupIndex, deviceinfo=deviceinfo, staticIpAddr=staticIpAddr, jumblan3=jumblan3, operStatus=operStatus, multicastsTransmitted=multicastsTransmitted, portEntry=portEntry, dscpEnable=dscpEnable, pauseTransmitted=pauseTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, jumbwan=jumbwan, hostname=hostname, jumblan4=jumblan4, statIndex=statIndex, lan2=lan2, serialnum=serialnum, vlangroupTable=vlangroupTable, vendorRev=vendorRev, portName=portName, multicastsReceived=multicastsReceived, qmapping=qmapping, xg6846=xg6846, lanportTable=lanportTable, portStatEntry=portStatEntry, primaryDns=primaryDns, lan4=lan4, portTable=portTable, secondaryDns=secondaryDns, fcsErrorReceived=fcsErrorReceived, fileType=fileType, internetPort=internetPort, lan3=lan3, jumblan2=jumblan2, staticIpGateway=staticIpGateway, catv=catv, port3=port3, bias=bias, unicastsTransmitted=unicastsTransmitted, voltage=voltage, wan=wan, vendorOui=vendorOui, qmode=qmode, speed=speed, jumblan1=jumblan1, fileName=fileName, lanportpause=lanportpause, rebootEnable=rebootEnable, ddminfo=ddminfo, broadcastsTransmitted=broadcastsTransmitted, vlanid=vlanid, portStatistic=portStatistic, tftpSevIp=tftpSevIp, action=action, staticDns=staticDns, tftp=tftp, staticIpDomainName=staticIpDomainName, port4=port4, staticIpSubMask=staticIpSubMask, vendorPn=vendorPn, catvEnable=catvEnable, groupid=groupid, modeEntry=modeEntry, portIndex=portIndex, qosIndex=qosIndex, vlan=vlan)
