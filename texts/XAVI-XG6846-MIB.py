...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:43:24 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, MibIdentifier, Counter64, NotificationType, mib_2, Integer32, ModuleIdentity, iso, TimeTicks, Gauge32, Unsigned32, Counter32, enterprises, Bits, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "MibIdentifier", "Counter64", "NotificationType", "mib-2", "Integer32", "ModuleIdentity", "iso", "TimeTicks", "Gauge32", "Unsigned32", "Counter32", "enterprises", "Bits", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port1=port1, jumblan1=jumblan1, modeEntry=modeEntry, statisticTable=statisticTable, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, lanportspeed=lanportspeed, primaryDns=primaryDns, xg6846=xg6846, operStatus=operStatus, qosIndex=qosIndex, port4=port4, rebootEnable=rebootEnable, pauseTransmitted=pauseTransmitted, lanportName=lanportName, unicastsTransmitted=unicastsTransmitted, reboot=reboot, wanType=wanType, tftp=tftp, priority=priority, adminStatus=adminStatus, staticDns=staticDns, multicastsTransmitted=multicastsTransmitted, lanportIndex=lanportIndex, broadcastsReceived=broadcastsReceived, jumblan2=jumblan2, vendorRev=vendorRev, jumblan3=jumblan3, vendorOui=vendorOui, hostname=hostname, fcsErrorReceived=fcsErrorReceived, staticIpGateway=staticIpGateway, qos=qos, jumbwan=jumbwan, rxPower=rxPower, staticIpAddr=staticIpAddr, lanportpause=lanportpause, pauseReceived=pauseReceived, port2=port2, fileType=fileType, staticIpPrimaryDns=staticIpPrimaryDns, groupIndex=groupIndex, portName=portName, qmode=qmode, portStatistic=portStatistic, tftpSevIp=tftpSevIp, statIndex=statIndex, lan2=lan2, deviceinfo=deviceinfo, secondaryDns=secondaryDns, speed=speed, staticIpSecondaryDns=staticIpSecondaryDns, catvEnable=catvEnable, serialnum=serialnum, lan1=lan1, groupEntry=groupEntry, portmode=portmode, catv=catv, action=action, jumb=jumb, domainame=domainame, txPower=txPower, lan3=lan3, qosEntry=qosEntry, fileName=fileName, lanportTable=lanportTable, dscpEnable=dscpEnable, vendorName=vendorName, voltage=voltage, port3=port3, vlanid=vlanid, multicastsReceived=multicastsReceived, portPower=portPower, unicastsReceived=unicastsReceived, bias=bias, portTable=portTable, jumblan4=jumblan4, lan4=lan4, staticIpHostName=staticIpHostName, ddminfo=ddminfo, portStatEntry=portStatEntry, temperature=temperature, groupid=groupid, vlan=vlan, portIndex=portIndex, wan=wan, vlangroupTable=vlangroupTable, qosTable=qosTable, fcsErrorTransmitted=fcsErrorTransmitted, portEntry=portEntry, internetPort=internetPort, staticIpDomainName=staticIpDomainName, staticIpSubMask=staticIpSubMask, vendorPn=vendorPn)
