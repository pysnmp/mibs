...
mib_2, snmpModules, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Unsigned32, MibIdentifier, TimeTicks, Counter32, enterprises, iso, Counter64, ObjectIdentity, Bits, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "snmpModules", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Unsigned32", "MibIdentifier", "TimeTicks", "Counter32", "enterprises", "iso", "Counter64", "ObjectIdentity", "Bits", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpAddr=staticIpAddr, unicastsTransmitted=unicastsTransmitted, qos=qos, modeEntry=modeEntry, lan1=lan1, multicastsTransmitted=multicastsTransmitted, staticIpHostName=staticIpHostName, vendorPn=vendorPn, domainame=domainame, serialnum=serialnum, rebootEnable=rebootEnable, bias=bias, lanportTable=lanportTable, tftp=tftp, staticDns=staticDns, catv=catv, portmode=portmode, fcsErrorReceived=fcsErrorReceived, qosIndex=qosIndex, portTable=portTable, portPower=portPower, jumblan4=jumblan4, vendorRev=vendorRev, lan4=lan4, lanportspeed=lanportspeed, jumblan1=jumblan1, reboot=reboot, staticIpSecondaryDns=staticIpSecondaryDns, portStatEntry=portStatEntry, staticIpGateway=staticIpGateway, lan3=lan3, txPower=txPower, lanportName=lanportName, jumb=jumb, vendorName=vendorName, vendorOui=vendorOui, primaryDns=primaryDns, action=action, port1=port1, vlangroupTable=vlangroupTable, wanType=wanType, statIndex=statIndex, staticIpDomainName=staticIpDomainName, speed=speed, hostname=hostname, broadcastsReceived=broadcastsReceived, portEntry=portEntry, jumblan2=jumblan2, secondaryDns=secondaryDns, statisticTable=statisticTable, operStatus=operStatus, unicastsReceived=unicastsReceived, fileName=fileName, groupEntry=groupEntry, portStatistic=portStatistic, port4=port4, fileType=fileType, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus, port3=port3, staticIpSubMask=staticIpSubMask, groupIndex=groupIndex, jumbwan=jumbwan, wan=wan, catvEnable=catvEnable, portName=portName, temperature=temperature, staticIpPrimaryDns=staticIpPrimaryDns, port2=port2, dscpEnable=dscpEnable, lanportpause=lanportpause, lan2=lan2, qmode=qmode, priority=priority, vlanid=vlanid, internetPort=internetPort, jumblan3=jumblan3, ddminfo=ddminfo, vlan=vlan, pauseReceived=pauseReceived, groupid=groupid, tftpSevIp=tftpSevIp, multicastsReceived=multicastsReceived, rxPower=rxPower, deviceinfo=deviceinfo, lanportIndex=lanportIndex, broadcastsTransmitted=broadcastsTransmitted, voltage=voltage, pauseTransmitted=pauseTransmitted, xg6846=xg6846, qosEntry=qosEntry, qmapping=qmapping, portIndex=portIndex, qosTable=qosTable)
