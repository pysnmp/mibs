...
# Produced by pysmi-1.1.8 at Mon Feb  7 16:17:12 2022
...
NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, mib_2, snmpModules, ObjectIdentity, Bits, Gauge32, Unsigned32, ModuleIdentity, Integer32, MibIdentifier, iso, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "mib-2", "snmpModules", "ObjectIdentity", "Bits", "Gauge32", "Unsigned32", "ModuleIdentity", "Integer32", "MibIdentifier", "iso", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileType=fileType, lan3=lan3, statisticTable=statisticTable, vlangroupTable=vlangroupTable, vlanid=vlanid, staticIpDomainName=staticIpDomainName, port2=port2, wan=wan, groupEntry=groupEntry, jumb=jumb, vlan=vlan, port1=port1, fcsErrorReceived=fcsErrorReceived, modeEntry=modeEntry, rebootEnable=rebootEnable, lanportIndex=lanportIndex, portStatEntry=portStatEntry, fcsErrorTransmitted=fcsErrorTransmitted, hostname=hostname, deviceinfo=deviceinfo, ddminfo=ddminfo, qmapping=qmapping, adminStatus=adminStatus, fileName=fileName, lanportName=lanportName, internetPort=internetPort, jumblan1=jumblan1, qos=qos, staticIpPrimaryDns=staticIpPrimaryDns, portPower=portPower, staticIpSecondaryDns=staticIpSecondaryDns, priority=priority, jumblan4=jumblan4, operStatus=operStatus, lanportTable=lanportTable, vendorRev=vendorRev, groupid=groupid, multicastsReceived=multicastsReceived, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, portStatistic=portStatistic, bias=bias, voltage=voltage, staticIpHostName=staticIpHostName, reboot=reboot, staticDns=staticDns, lan1=lan1, temperature=temperature, lanportspeed=lanportspeed, jumblan2=jumblan2, unicastsReceived=unicastsReceived, domainame=domainame, pauseTransmitted=pauseTransmitted, portEntry=portEntry, unicastsTransmitted=unicastsTransmitted, lanportpause=lanportpause, qosIndex=qosIndex, vendorPn=vendorPn, staticIpGateway=staticIpGateway, lan2=lan2, portName=portName, multicastsTransmitted=multicastsTransmitted, tftpSevIp=tftpSevIp, statIndex=statIndex, portIndex=portIndex, secondaryDns=secondaryDns, qosEntry=qosEntry, wanType=wanType, vendorName=vendorName, jumblan3=jumblan3, portTable=portTable, action=action, port4=port4, portmode=portmode, primaryDns=primaryDns, jumbwan=jumbwan, broadcastsReceived=broadcastsReceived, speed=speed, serialnum=serialnum, qosTable=qosTable, rxPower=rxPower, lan4=lan4, catv=catv, groupIndex=groupIndex, vendorOui=vendorOui, staticIpSubMask=staticIpSubMask, staticIpAddr=staticIpAddr, pauseReceived=pauseReceived, tftp=tftp, txPower=txPower, port3=port3, qmode=qmode, catvEnable=catvEnable, dscpEnable=dscpEnable)
