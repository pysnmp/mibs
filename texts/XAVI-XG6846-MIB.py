...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:36:54 2021
...
Counter64, mib_2, Bits, ObjectIdentity, Gauge32, enterprises, ModuleIdentity, IpAddress, MibIdentifier, snmpModules, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, Counter32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "Bits", "ObjectIdentity", "Gauge32", "enterprises", "ModuleIdentity", "IpAddress", "MibIdentifier", "snmpModules", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "Counter32", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", temperature=temperature, vendorName=vendorName, rebootEnable=rebootEnable, catvEnable=catvEnable, dscpEnable=dscpEnable, statisticTable=statisticTable, portEntry=portEntry, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, portmode=portmode, jumblan2=jumblan2, rxPower=rxPower, vlangroupTable=vlangroupTable, internetPort=internetPort, port2=port2, vlan=vlan, staticIpSubMask=staticIpSubMask, tftpSevIp=tftpSevIp, groupEntry=groupEntry, qmapping=qmapping, qosIndex=qosIndex, broadcastsTransmitted=broadcastsTransmitted, broadcastsReceived=broadcastsReceived, portStatEntry=portStatEntry, jumblan4=jumblan4, reboot=reboot, multicastsTransmitted=multicastsTransmitted, lanportTable=lanportTable, adminStatus=adminStatus, xg6846=xg6846, lan1=lan1, voltage=voltage, vendorRev=vendorRev, groupIndex=groupIndex, lan2=lan2, primaryDns=primaryDns, lan4=lan4, port3=port3, domainame=domainame, hostname=hostname, groupid=groupid, portTable=portTable, wan=wan, action=action, qosEntry=qosEntry, operStatus=operStatus, bias=bias, lanportIndex=lanportIndex, txPower=txPower, jumb=jumb, fileName=fileName, wanType=wanType, lanportName=lanportName, fcsErrorReceived=fcsErrorReceived, port1=port1, port4=port4, vendorOui=vendorOui, ddminfo=ddminfo, jumblan1=jumblan1, statIndex=statIndex, portPower=portPower, deviceinfo=deviceinfo, unicastsTransmitted=unicastsTransmitted, jumblan3=jumblan3, staticIpDomainName=staticIpDomainName, pauseReceived=pauseReceived, qos=qos, staticIpAddr=staticIpAddr, unicastsReceived=unicastsReceived, qmode=qmode, staticDns=staticDns, qosTable=qosTable, lanportpause=lanportpause, fileType=fileType, portIndex=portIndex, staticIpHostName=staticIpHostName, priority=priority, jumbwan=jumbwan, lanportspeed=lanportspeed, portStatistic=portStatistic, vlanid=vlanid, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, portName=portName, tftp=tftp, modeEntry=modeEntry, lan3=lan3, staticIpGateway=staticIpGateway, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, serialnum=serialnum, secondaryDns=secondaryDns, catv=catv, vendorPn=vendorPn)
