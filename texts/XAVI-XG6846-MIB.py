...
Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, mib_2, MibIdentifier, iso, NotificationType, Counter64, snmpModules, Unsigned32, ObjectIdentity, ModuleIdentity, IpAddress, Counter32, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "mib-2", "MibIdentifier", "iso", "NotificationType", "Counter64", "snmpModules", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Counter32", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", dscpEnable=dscpEnable, port3=port3, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, unicastsReceived=unicastsReceived, txPower=txPower, staticIpPrimaryDns=staticIpPrimaryDns, wanType=wanType, broadcastsReceived=broadcastsReceived, portStatistic=portStatistic, vendorName=vendorName, vendorOui=vendorOui, staticDns=staticDns, adminStatus=adminStatus, statIndex=statIndex, port2=port2, statisticTable=statisticTable, groupEntry=groupEntry, vendorPn=vendorPn, reboot=reboot, multicastsReceived=multicastsReceived, portPower=portPower, fcsErrorTransmitted=fcsErrorTransmitted, fileType=fileType, staticIpDomainName=staticIpDomainName, groupIndex=groupIndex, qmapping=qmapping, staticIpHostName=staticIpHostName, staticIpAddr=staticIpAddr, lanportIndex=lanportIndex, staticIpSubMask=staticIpSubMask, portTable=portTable, internetPort=internetPort, priority=priority, qosIndex=qosIndex, lan4=lan4, portEntry=portEntry, jumblan4=jumblan4, temperature=temperature, lanportName=lanportName, pauseReceived=pauseReceived, voltage=voltage, rebootEnable=rebootEnable, groupid=groupid, portmode=portmode, bias=bias, vlangroupTable=vlangroupTable, serialnum=serialnum, action=action, jumblan2=jumblan2, qos=qos, catvEnable=catvEnable, domainame=domainame, fileName=fileName, port4=port4, port1=port1, rxPower=rxPower, portIndex=portIndex, vlanid=vlanid, lan3=lan3, jumbwan=jumbwan, catv=catv, qosEntry=qosEntry, lanportspeed=lanportspeed, vlan=vlan, primaryDns=primaryDns, multicastsTransmitted=multicastsTransmitted, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, speed=speed, qosTable=qosTable, lanportTable=lanportTable, tftp=tftp, secondaryDns=secondaryDns, vendorRev=vendorRev, lanportpause=lanportpause, lan1=lan1, modeEntry=modeEntry, tftpSevIp=tftpSevIp, jumblan1=jumblan1, ddminfo=ddminfo, staticIpSecondaryDns=staticIpSecondaryDns, qmode=qmode, jumblan3=jumblan3, wan=wan, portStatEntry=portStatEntry, hostname=hostname, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, deviceinfo=deviceinfo, operStatus=operStatus, portName=portName, lan2=lan2, xg6846=xg6846)
