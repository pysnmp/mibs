...
# Produced by pysmi-1.1.10 at Fri Oct 27 07:55:46 2023
...
Integer32, iso, MibIdentifier, enterprises, TimeTicks, mib_2, Gauge32, Bits, ModuleIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, ObjectIdentity, snmpModules, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "MibIdentifier", "enterprises", "TimeTicks", "mib-2", "Gauge32", "Bits", "ModuleIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "ObjectIdentity", "snmpModules", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statisticTable=statisticTable, pauseTransmitted=pauseTransmitted, lan1=lan1, serialnum=serialnum, portStatEntry=portStatEntry, vlangroupTable=vlangroupTable, vlanid=vlanid, staticIpGateway=staticIpGateway, jumblan2=jumblan2, action=action, multicastsReceived=multicastsReceived, qosIndex=qosIndex, secondaryDns=secondaryDns, tftp=tftp, portPower=portPower, qosTable=qosTable, jumb=jumb, lanportspeed=lanportspeed, staticIpDomainName=staticIpDomainName, groupIndex=groupIndex, fcsErrorReceived=fcsErrorReceived, port3=port3, portName=portName, jumbwan=jumbwan, internetPort=internetPort, qmapping=qmapping, port1=port1, broadcastsTransmitted=broadcastsTransmitted, staticIpAddr=staticIpAddr, staticIpPrimaryDns=staticIpPrimaryDns, jumblan3=jumblan3, rxPower=rxPower, staticDns=staticDns, pauseReceived=pauseReceived, portTable=portTable, vlan=vlan, dscpEnable=dscpEnable, speed=speed, portStatistic=portStatistic, xg6846=xg6846, groupEntry=groupEntry, lan4=lan4, qosEntry=qosEntry, vendorOui=vendorOui, lan2=lan2, lanportName=lanportName, vendorRev=vendorRev, txPower=txPower, jumblan1=jumblan1, priority=priority, staticIpHostName=staticIpHostName, staticIpSubMask=staticIpSubMask, fileName=fileName, multicastsTransmitted=multicastsTransmitted, unicastsReceived=unicastsReceived, deviceinfo=deviceinfo, domainame=domainame, temperature=temperature, portmode=portmode, tftpSevIp=tftpSevIp, lanportIndex=lanportIndex, reboot=reboot, ddminfo=ddminfo, rebootEnable=rebootEnable, qos=qos, port2=port2, lan3=lan3, broadcastsReceived=broadcastsReceived, portEntry=portEntry, wanType=wanType, catv=catv, vendorPn=vendorPn, adminStatus=adminStatus, groupid=groupid, qmode=qmode, jumblan4=jumblan4, lanportTable=lanportTable, port4=port4, catvEnable=catvEnable, modeEntry=modeEntry, statIndex=statIndex, unicastsTransmitted=unicastsTransmitted, vendorName=vendorName, primaryDns=primaryDns, bias=bias, fcsErrorTransmitted=fcsErrorTransmitted, hostname=hostname, portIndex=portIndex, wan=wan, operStatus=operStatus, fileType=fileType, voltage=voltage, lanportpause=lanportpause, staticIpSecondaryDns=staticIpSecondaryDns)
