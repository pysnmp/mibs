...
enterprises, NotificationType, Counter32, Integer32, snmpModules, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Bits, ObjectIdentity, Counter64, Unsigned32, MibIdentifier, TimeTicks, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Counter32", "Integer32", "snmpModules", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Bits", "ObjectIdentity", "Counter64", "Unsigned32", "MibIdentifier", "TimeTicks", "iso", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", dscpEnable=dscpEnable, multicastsReceived=multicastsReceived, domainame=domainame, vendorRev=vendorRev, pauseReceived=pauseReceived, unicastsReceived=unicastsReceived, wanType=wanType, unicastsTransmitted=unicastsTransmitted, primaryDns=primaryDns, staticIpAddr=staticIpAddr, temperature=temperature, groupEntry=groupEntry, qos=qos, fcsErrorTransmitted=fcsErrorTransmitted, qmode=qmode, voltage=voltage, staticIpSecondaryDns=staticIpSecondaryDns, tftp=tftp, txPower=txPower, staticIpGateway=staticIpGateway, xg6846=xg6846, staticIpSubMask=staticIpSubMask, bias=bias, jumblan4=jumblan4, priority=priority, multicastsTransmitted=multicastsTransmitted, pauseTransmitted=pauseTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsTransmitted=broadcastsTransmitted, tftpSevIp=tftpSevIp, jumbwan=jumbwan, port3=port3, qosIndex=qosIndex, port2=port2, portPower=portPower, statisticTable=statisticTable, port1=port1, action=action, vlangroupTable=vlangroupTable, lan2=lan2, broadcastsReceived=broadcastsReceived, groupid=groupid, portmode=portmode, catv=catv, portEntry=portEntry, port4=port4, hostname=hostname, jumblan2=jumblan2, reboot=reboot, adminStatus=adminStatus, secondaryDns=secondaryDns, rebootEnable=rebootEnable, lan4=lan4, lan1=lan1, qosTable=qosTable, groupIndex=groupIndex, lanportIndex=lanportIndex, rxPower=rxPower, fileName=fileName, lanportspeed=lanportspeed, vendorPn=vendorPn, internetPort=internetPort, jumb=jumb, fcsErrorReceived=fcsErrorReceived, qosEntry=qosEntry, vlan=vlan, operStatus=operStatus, fileType=fileType, vlanid=vlanid, jumblan1=jumblan1, serialnum=serialnum, modeEntry=modeEntry, staticIpHostName=staticIpHostName, portStatistic=portStatistic, portTable=portTable, catvEnable=catvEnable, wan=wan, jumblan3=jumblan3, vendorName=vendorName, vendorOui=vendorOui, portStatEntry=portStatEntry, lan3=lan3, portIndex=portIndex, staticIpDomainName=staticIpDomainName, ddminfo=ddminfo, lanportTable=lanportTable, deviceinfo=deviceinfo, lanportpause=lanportpause, qmapping=qmapping, lanportName=lanportName, staticDns=staticDns, portName=portName, speed=speed, statIndex=statIndex)
