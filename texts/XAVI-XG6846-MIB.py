...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:12:41 2023
...
enterprises, NotificationType, IpAddress, Integer32, mib_2, ModuleIdentity, TimeTicks, Gauge32, Unsigned32, iso, Counter32, Counter64, MibIdentifier, ObjectIdentity, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "IpAddress", "Integer32", "mib-2", "ModuleIdentity", "TimeTicks", "Gauge32", "Unsigned32", "iso", "Counter32", "Counter64", "MibIdentifier", "ObjectIdentity", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", secondaryDns=secondaryDns, lan2=lan2, jumblan4=jumblan4, port3=port3, broadcastsTransmitted=broadcastsTransmitted, vlanid=vlanid, serialnum=serialnum, multicastsReceived=multicastsReceived, lan4=lan4, staticIpAddr=staticIpAddr, jumbwan=jumbwan, portEntry=portEntry, jumblan1=jumblan1, rxPower=rxPower, portStatistic=portStatistic, staticIpHostName=staticIpHostName, groupEntry=groupEntry, temperature=temperature, qosEntry=qosEntry, statisticTable=statisticTable, wan=wan, vendorPn=vendorPn, jumb=jumb, dscpEnable=dscpEnable, tftp=tftp, modeEntry=modeEntry, portPower=portPower, unicastsTransmitted=unicastsTransmitted, bias=bias, staticIpPrimaryDns=staticIpPrimaryDns, port4=port4, qos=qos, vlan=vlan, staticIpSubMask=staticIpSubMask, ddminfo=ddminfo, lan1=lan1, fcsErrorReceived=fcsErrorReceived, fileType=fileType, portIndex=portIndex, fcsErrorTransmitted=fcsErrorTransmitted, portTable=portTable, port2=port2, staticDns=staticDns, vlangroupTable=vlangroupTable, deviceinfo=deviceinfo, adminStatus=adminStatus, vendorOui=vendorOui, port1=port1, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, qmapping=qmapping, lan3=lan3, portName=portName, xg6846=xg6846, internetPort=internetPort, fileName=fileName, hostname=hostname, tftpSevIp=tftpSevIp, lanportspeed=lanportspeed, vendorName=vendorName, rebootEnable=rebootEnable, speed=speed, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, qmode=qmode, portStatEntry=portStatEntry, statIndex=statIndex, primaryDns=primaryDns, operStatus=operStatus, lanportIndex=lanportIndex, unicastsReceived=unicastsReceived, portmode=portmode, action=action, multicastsTransmitted=multicastsTransmitted, pauseReceived=pauseReceived, groupid=groupid, staticIpSecondaryDns=staticIpSecondaryDns, domainame=domainame, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, qosIndex=qosIndex, groupIndex=groupIndex, lanportpause=lanportpause, txPower=txPower, lanportName=lanportName, qosTable=qosTable, jumblan3=jumblan3, catv=catv, vendorRev=vendorRev, wanType=wanType, voltage=voltage, jumblan2=jumblan2, priority=priority, reboot=reboot)
