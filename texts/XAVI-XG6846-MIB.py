...
# Produced by pysmi-1.1.8 at Thu Jan 27 21:40:13 2022
...
Counter32, Gauge32, ModuleIdentity, Counter64, Integer32, NotificationType, mib_2, iso, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, ObjectIdentity, Unsigned32, enterprises, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ModuleIdentity", "Counter64", "Integer32", "NotificationType", "mib-2", "iso", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "ObjectIdentity", "Unsigned32", "enterprises", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, pauseReceived=pauseReceived, wanType=wanType, voltage=voltage, multicastsTransmitted=multicastsTransmitted, staticIpSubMask=staticIpSubMask, portPower=portPower, vlanid=vlanid, modeEntry=modeEntry, portIndex=portIndex, adminStatus=adminStatus, reboot=reboot, staticIpHostName=staticIpHostName, jumblan2=jumblan2, dscpEnable=dscpEnable, lan2=lan2, staticIpDomainName=staticIpDomainName, staticIpPrimaryDns=staticIpPrimaryDns, speed=speed, statIndex=statIndex, qosIndex=qosIndex, ddminfo=ddminfo, unicastsTransmitted=unicastsTransmitted, temperature=temperature, xg6846=xg6846, staticIpAddr=staticIpAddr, internetPort=internetPort, lanportTable=lanportTable, lan1=lan1, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, qosTable=qosTable, portEntry=portEntry, lanportName=lanportName, action=action, jumblan1=jumblan1, staticDns=staticDns, groupIndex=groupIndex, vlan=vlan, multicastsReceived=multicastsReceived, vendorName=vendorName, portStatEntry=portStatEntry, portName=portName, lan4=lan4, rxPower=rxPower, domainame=domainame, fileType=fileType, txPower=txPower, lanportspeed=lanportspeed, qmode=qmode, portTable=portTable, port1=port1, wan=wan, port4=port4, vendorRev=vendorRev, deviceinfo=deviceinfo, port2=port2, jumblan3=jumblan3, priority=priority, port3=port3, vlangroupTable=vlangroupTable, lanportIndex=lanportIndex, qosEntry=qosEntry, vendorOui=vendorOui, pauseTransmitted=pauseTransmitted, unicastsReceived=unicastsReceived, portmode=portmode, fcsErrorReceived=fcsErrorReceived, operStatus=operStatus, lanportpause=lanportpause, vendorPn=vendorPn, bias=bias, primaryDns=primaryDns, hostname=hostname, groupEntry=groupEntry, tftpSevIp=tftpSevIp, fileName=fileName, catvEnable=catvEnable, portStatistic=portStatistic, jumbwan=jumbwan, serialnum=serialnum, broadcastsReceived=broadcastsReceived, staticIpGateway=staticIpGateway, fcsErrorTransmitted=fcsErrorTransmitted, jumb=jumb, rebootEnable=rebootEnable, tftp=tftp, jumblan4=jumblan4, qos=qos, secondaryDns=secondaryDns, statisticTable=statisticTable)
