...
Counter32, TimeTicks, NotificationType, Unsigned32, IpAddress, ObjectIdentity, snmpModules, mib_2, enterprises, Bits, Gauge32, MibIdentifier, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "NotificationType", "Unsigned32", "IpAddress", "ObjectIdentity", "snmpModules", "mib-2", "enterprises", "Bits", "Gauge32", "MibIdentifier", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmapping=qmapping, txPower=txPower, staticIpDomainName=staticIpDomainName, port4=port4, lan1=lan1, jumbwan=jumbwan, temperature=temperature, unicastsReceived=unicastsReceived, primaryDns=primaryDns, catv=catv, staticIpSubMask=staticIpSubMask, pauseTransmitted=pauseTransmitted, qos=qos, staticIpSecondaryDns=staticIpSecondaryDns, internetPort=internetPort, vlanid=vlanid, hostname=hostname, staticIpGateway=staticIpGateway, staticIpHostName=staticIpHostName, staticIpAddr=staticIpAddr, broadcastsTransmitted=broadcastsTransmitted, operStatus=operStatus, modeEntry=modeEntry, fcsErrorTransmitted=fcsErrorTransmitted, vendorRev=vendorRev, lanportpause=lanportpause, lan3=lan3, fileName=fileName, qosEntry=qosEntry, vendorPn=vendorPn, jumblan1=jumblan1, rebootEnable=rebootEnable, port1=port1, priority=priority, portPower=portPower, portName=portName, qmode=qmode, portEntry=portEntry, serialnum=serialnum, jumb=jumb, jumblan3=jumblan3, vlangroupTable=vlangroupTable, action=action, qosTable=qosTable, bias=bias, lan2=lan2, pauseReceived=pauseReceived, staticDns=staticDns, lan4=lan4, vendorName=vendorName, secondaryDns=secondaryDns, reboot=reboot, port2=port2, domainame=domainame, tftp=tftp, groupIndex=groupIndex, catvEnable=catvEnable, rxPower=rxPower, jumblan4=jumblan4, portStatistic=portStatistic, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, wan=wan, vlan=vlan, portmode=portmode, tftpSevIp=tftpSevIp, fileType=fileType, broadcastsReceived=broadcastsReceived, portStatEntry=portStatEntry, lanportName=lanportName, wanType=wanType, statisticTable=statisticTable, port3=port3, portIndex=portIndex, speed=speed, lanportspeed=lanportspeed, jumblan2=jumblan2, ddminfo=ddminfo, voltage=voltage, qosIndex=qosIndex, groupid=groupid, xg6846=xg6846, lanportIndex=lanportIndex, lanportTable=lanportTable, adminStatus=adminStatus, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, groupEntry=groupEntry, unicastsTransmitted=unicastsTransmitted, multicastsReceived=multicastsReceived, deviceinfo=deviceinfo, portTable=portTable, vendorOui=vendorOui, fcsErrorReceived=fcsErrorReceived)
