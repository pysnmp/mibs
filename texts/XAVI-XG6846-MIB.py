...
enterprises, MibIdentifier, mib_2, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, ModuleIdentity, Gauge32, Counter64, ObjectIdentity, snmpModules, Integer32, Bits, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "mib-2", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "ModuleIdentity", "Gauge32", "Counter64", "ObjectIdentity", "snmpModules", "Integer32", "Bits", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosTable=qosTable, staticIpSecondaryDns=staticIpSecondaryDns, lanportpause=lanportpause, lan1=lan1, portStatEntry=portStatEntry, operStatus=operStatus, domainame=domainame, catvEnable=catvEnable, tftpSevIp=tftpSevIp, port3=port3, staticDns=staticDns, jumblan2=jumblan2, portStatistic=portStatistic, serialnum=serialnum, broadcastsReceived=broadcastsReceived, lanportIndex=lanportIndex, dscpEnable=dscpEnable, internetPort=internetPort, qosEntry=qosEntry, port1=port1, port2=port2, primaryDns=primaryDns, vlan=vlan, jumblan4=jumblan4, lan3=lan3, staticIpAddr=staticIpAddr, tftp=tftp, statIndex=statIndex, vlangroupTable=vlangroupTable, ddminfo=ddminfo, portIndex=portIndex, temperature=temperature, groupIndex=groupIndex, pauseReceived=pauseReceived, portEntry=portEntry, multicastsTransmitted=multicastsTransmitted, rebootEnable=rebootEnable, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, portmode=portmode, txPower=txPower, lanportTable=lanportTable, port4=port4, qos=qos, lanportName=lanportName, reboot=reboot, staticIpHostName=staticIpHostName, staticIpDomainName=staticIpDomainName, hostname=hostname, voltage=voltage, vendorName=vendorName, lanportspeed=lanportspeed, action=action, groupid=groupid, speed=speed, adminStatus=adminStatus, portPower=portPower, unicastsReceived=unicastsReceived, wanType=wanType, jumblan1=jumblan1, modeEntry=modeEntry, jumbwan=jumbwan, groupEntry=groupEntry, fcsErrorTransmitted=fcsErrorTransmitted, bias=bias, xg6846=xg6846, statisticTable=statisticTable, secondaryDns=secondaryDns, qosIndex=qosIndex, lan4=lan4, fileType=fileType, staticIpSubMask=staticIpSubMask, fileName=fileName, jumb=jumb, vendorOui=vendorOui, lan2=lan2, multicastsReceived=multicastsReceived, wan=wan, priority=priority, rxPower=rxPower, fcsErrorReceived=fcsErrorReceived, qmode=qmode, portName=portName, vlanid=vlanid, vendorRev=vendorRev, pauseTransmitted=pauseTransmitted, qmapping=qmapping, portTable=portTable, jumblan3=jumblan3, vendorPn=vendorPn, catv=catv, deviceinfo=deviceinfo, broadcastsTransmitted=broadcastsTransmitted)
