...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, MibIdentifier, Unsigned32, IpAddress, ObjectIdentity, ModuleIdentity, Counter32, mib_2, snmpModules, Bits, Counter64, Integer32, enterprises, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "MibIdentifier", "Unsigned32", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Counter32", "mib-2", "snmpModules", "Bits", "Counter64", "Integer32", "enterprises", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wanType=wanType, portPower=portPower, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, lan1=lan1, tftpSevIp=tftpSevIp, catv=catv, pauseReceived=pauseReceived, speed=speed, portStatistic=portStatistic, fcsErrorReceived=fcsErrorReceived, multicastsReceived=multicastsReceived, pauseTransmitted=pauseTransmitted, portEntry=portEntry, qos=qos, rebootEnable=rebootEnable, groupIndex=groupIndex, jumblan4=jumblan4, lan4=lan4, broadcastsReceived=broadcastsReceived, vlangroupTable=vlangroupTable, qosEntry=qosEntry, staticIpGateway=staticIpGateway, staticIpHostName=staticIpHostName, portName=portName, fileType=fileType, adminStatus=adminStatus, jumblan2=jumblan2, qosTable=qosTable, reboot=reboot, serialnum=serialnum, voltage=voltage, internetPort=internetPort, vlan=vlan, domainame=domainame, secondaryDns=secondaryDns, vendorName=vendorName, staticIpAddr=staticIpAddr, vendorOui=vendorOui, jumbwan=jumbwan, qmode=qmode, groupEntry=groupEntry, port4=port4, modeEntry=modeEntry, xg6846=xg6846, dscpEnable=dscpEnable, lanportTable=lanportTable, port1=port1, portIndex=portIndex, bias=bias, wan=wan, hostname=hostname, txPower=txPower, vendorPn=vendorPn, deviceinfo=deviceinfo, action=action, temperature=temperature, unicastsReceived=unicastsReceived, priority=priority, fcsErrorTransmitted=fcsErrorTransmitted, lanportspeed=lanportspeed, lan2=lan2, unicastsTransmitted=unicastsTransmitted, lanportName=lanportName, lan3=lan3, portStatEntry=portStatEntry, qosIndex=qosIndex, qmapping=qmapping, portmode=portmode, lanportIndex=lanportIndex, rxPower=rxPower, port3=port3, tftp=tftp, jumblan1=jumblan1, statIndex=statIndex, groupid=groupid, jumblan3=jumblan3, ddminfo=ddminfo, catvEnable=catvEnable, multicastsTransmitted=multicastsTransmitted, port2=port2, vendorRev=vendorRev, vlanid=vlanid, primaryDns=primaryDns, statisticTable=statisticTable, staticDns=staticDns, staticIpSubMask=staticIpSubMask, portTable=portTable, operStatus=operStatus, lanportpause=lanportpause, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, fileName=fileName)
