...
Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Bits, enterprises, Counter64, TimeTicks, mib_2, ObjectIdentity, Gauge32, NotificationType, Counter32, iso, snmpModules, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Bits", "enterprises", "Counter64", "TimeTicks", "mib-2", "ObjectIdentity", "Gauge32", "NotificationType", "Counter32", "iso", "snmpModules", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", deviceinfo=deviceinfo, qosEntry=qosEntry, staticIpGateway=staticIpGateway, vendorOui=vendorOui, lan4=lan4, speed=speed, staticIpHostName=staticIpHostName, portPower=portPower, wan=wan, port2=port2, port1=port1, jumbwan=jumbwan, portStatEntry=portStatEntry, tftp=tftp, jumblan2=jumblan2, portTable=portTable, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, fileName=fileName, staticDns=staticDns, staticIpSubMask=staticIpSubMask, temperature=temperature, qmode=qmode, vendorName=vendorName, lan3=lan3, statIndex=statIndex, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, domainame=domainame, jumblan1=jumblan1, tftpSevIp=tftpSevIp, lanportspeed=lanportspeed, pauseReceived=pauseReceived, priority=priority, lanportTable=lanportTable, groupEntry=groupEntry, lan1=lan1, dscpEnable=dscpEnable, vendorRev=vendorRev, vlanid=vlanid, jumblan4=jumblan4, vlan=vlan, qosTable=qosTable, statisticTable=statisticTable, groupid=groupid, txPower=txPower, xg6846=xg6846, internetPort=internetPort, ddminfo=ddminfo, multicastsReceived=multicastsReceived, lanportName=lanportName, multicastsTransmitted=multicastsTransmitted, qmapping=qmapping, staticIpAddr=staticIpAddr, serialnum=serialnum, vlangroupTable=vlangroupTable, portEntry=portEntry, rebootEnable=rebootEnable, bias=bias, action=action, broadcastsReceived=broadcastsReceived, modeEntry=modeEntry, broadcastsTransmitted=broadcastsTransmitted, catvEnable=catvEnable, staticIpSecondaryDns=staticIpSecondaryDns, hostname=hostname, catv=catv, portName=portName, wanType=wanType, adminStatus=adminStatus, secondaryDns=secondaryDns, portmode=portmode, portIndex=portIndex, lanportIndex=lanportIndex, lanportpause=lanportpause, reboot=reboot, fileType=fileType, port3=port3, primaryDns=primaryDns, qosIndex=qosIndex, portStatistic=portStatistic, qos=qos, port4=port4, voltage=voltage, jumb=jumb, lan2=lan2, fcsErrorReceived=fcsErrorReceived, vendorPn=vendorPn, rxPower=rxPower, staticIpDomainName=staticIpDomainName, unicastsTransmitted=unicastsTransmitted, operStatus=operStatus, jumblan3=jumblan3, pauseTransmitted=pauseTransmitted)
