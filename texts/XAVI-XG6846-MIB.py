...
ObjectIdentity, Unsigned32, Bits, enterprises, ModuleIdentity, TimeTicks, iso, Counter64, IpAddress, Integer32, Gauge32, Counter32, MibIdentifier, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "Bits", "enterprises", "ModuleIdentity", "TimeTicks", "iso", "Counter64", "IpAddress", "Integer32", "Gauge32", "Counter32", "MibIdentifier", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", broadcastsTransmitted=broadcastsTransmitted, port2=port2, groupid=groupid, pauseTransmitted=pauseTransmitted, vendorRev=vendorRev, qosIndex=qosIndex, jumblan1=jumblan1, temperature=temperature, txPower=txPower, rebootEnable=rebootEnable, primaryDns=primaryDns, ddminfo=ddminfo, lan1=lan1, unicastsReceived=unicastsReceived, portPower=portPower, secondaryDns=secondaryDns, jumbwan=jumbwan, catv=catv, portIndex=portIndex, vlan=vlan, vendorPn=vendorPn, portStatEntry=portStatEntry, statisticTable=statisticTable, jumblan4=jumblan4, jumb=jumb, vlangroupTable=vlangroupTable, portTable=portTable, voltage=voltage, serialnum=serialnum, qmapping=qmapping, port4=port4, lan4=lan4, priority=priority, speed=speed, fileName=fileName, portStatistic=portStatistic, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, qosEntry=qosEntry, jumblan2=jumblan2, pauseReceived=pauseReceived, lanportspeed=lanportspeed, staticIpSubMask=staticIpSubMask, lan3=lan3, staticIpAddr=staticIpAddr, hostname=hostname, tftpSevIp=tftpSevIp, dscpEnable=dscpEnable, modeEntry=modeEntry, wan=wan, deviceinfo=deviceinfo, groupIndex=groupIndex, tftp=tftp, fcsErrorTransmitted=fcsErrorTransmitted, jumblan3=jumblan3, lanportpause=lanportpause, portName=portName, action=action, lanportTable=lanportTable, staticIpDomainName=staticIpDomainName, wanType=wanType, unicastsTransmitted=unicastsTransmitted, portEntry=portEntry, lanportName=lanportName, qosTable=qosTable, qos=qos, vendorName=vendorName, domainame=domainame, port3=port3, lanportIndex=lanportIndex, qmode=qmode, reboot=reboot, fileType=fileType, port1=port1, xg6846=xg6846, statIndex=statIndex, vendorOui=vendorOui, operStatus=operStatus, lan2=lan2, broadcastsReceived=broadcastsReceived, fcsErrorReceived=fcsErrorReceived, portmode=portmode, staticIpGateway=staticIpGateway, vlanid=vlanid, catvEnable=catvEnable, bias=bias, multicastsTransmitted=multicastsTransmitted, adminStatus=adminStatus, groupEntry=groupEntry, internetPort=internetPort, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower, staticIpHostName=staticIpHostName, staticDns=staticDns)
