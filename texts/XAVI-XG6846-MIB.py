...
snmpModules, mib_2, ObjectIdentity, Gauge32, Bits, MibIdentifier, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, Integer32, IpAddress, Counter64, Unsigned32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "mib-2", "ObjectIdentity", "Gauge32", "Bits", "MibIdentifier", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "Integer32", "IpAddress", "Counter64", "Unsigned32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticDns=staticDns, statIndex=statIndex, ddminfo=ddminfo, vendorRev=vendorRev, portEntry=portEntry, lan2=lan2, fileName=fileName, lan4=lan4, jumblan1=jumblan1, modeEntry=modeEntry, rebootEnable=rebootEnable, vlan=vlan, broadcastsReceived=broadcastsReceived, fileType=fileType, portPower=portPower, operStatus=operStatus, portStatistic=portStatistic, vlanid=vlanid, pauseTransmitted=pauseTransmitted, staticIpAddr=staticIpAddr, tftpSevIp=tftpSevIp, vendorName=vendorName, unicastsTransmitted=unicastsTransmitted, qosEntry=qosEntry, wanType=wanType, speed=speed, catv=catv, lanportspeed=lanportspeed, reboot=reboot, port3=port3, internetPort=internetPort, qos=qos, lanportIndex=lanportIndex, lanportpause=lanportpause, qosTable=qosTable, staticIpHostName=staticIpHostName, port4=port4, staticIpSubMask=staticIpSubMask, port1=port1, vendorOui=vendorOui, priority=priority, txPower=txPower, fcsErrorTransmitted=fcsErrorTransmitted, serialnum=serialnum, portIndex=portIndex, vendorPn=vendorPn, qmode=qmode, secondaryDns=secondaryDns, groupIndex=groupIndex, portStatEntry=portStatEntry, portmode=portmode, catvEnable=catvEnable, domainame=domainame, rxPower=rxPower, groupEntry=groupEntry, broadcastsTransmitted=broadcastsTransmitted, primaryDns=primaryDns, wan=wan, action=action, fcsErrorReceived=fcsErrorReceived, multicastsTransmitted=multicastsTransmitted, voltage=voltage, qmapping=qmapping, pauseReceived=pauseReceived, jumbwan=jumbwan, lanportTable=lanportTable, multicastsReceived=multicastsReceived, groupid=groupid, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, lan1=lan1, temperature=temperature, deviceinfo=deviceinfo, jumblan3=jumblan3, jumblan4=jumblan4, staticIpSecondaryDns=staticIpSecondaryDns, tftp=tftp, statisticTable=statisticTable, portName=portName, staticIpDomainName=staticIpDomainName, adminStatus=adminStatus, bias=bias, lan3=lan3, portTable=portTable, xg6846=xg6846, jumb=jumb, dscpEnable=dscpEnable, jumblan2=jumblan2, vlangroupTable=vlangroupTable, qosIndex=qosIndex, staticIpGateway=staticIpGateway, unicastsReceived=unicastsReceived, port2=port2, hostname=hostname)
