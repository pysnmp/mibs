...
# Produced by pysmi-1.1.3 at Sat Nov 20 21:29:23 2021
...
Integer32, Bits, NotificationType, enterprises, ModuleIdentity, iso, ObjectIdentity, MibIdentifier, Counter32, mib_2, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, IpAddress, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "NotificationType", "enterprises", "ModuleIdentity", "iso", "ObjectIdentity", "MibIdentifier", "Counter32", "mib-2", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "IpAddress", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, lan4=lan4, vlangroupTable=vlangroupTable, portName=portName, speed=speed, qosIndex=qosIndex, jumblan1=jumblan1, groupIndex=groupIndex, qos=qos, lanportspeed=lanportspeed, tftp=tftp, xg6846=xg6846, qosTable=qosTable, portStatistic=portStatistic, fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, vendorOui=vendorOui, portEntry=portEntry, jumblan4=jumblan4, rebootEnable=rebootEnable, portmode=portmode, lanportpause=lanportpause, lan1=lan1, pauseReceived=pauseReceived, tftpSevIp=tftpSevIp, vendorName=vendorName, portIndex=portIndex, wan=wan, multicastsTransmitted=multicastsTransmitted, unicastsTransmitted=unicastsTransmitted, jumb=jumb, port4=port4, staticIpSecondaryDns=staticIpSecondaryDns, qmapping=qmapping, staticIpSubMask=staticIpSubMask, lan2=lan2, action=action, jumbwan=jumbwan, statIndex=statIndex, serialnum=serialnum, wanType=wanType, reboot=reboot, txPower=txPower, jumblan3=jumblan3, vlan=vlan, ddminfo=ddminfo, portPower=portPower, deviceinfo=deviceinfo, bias=bias, dscpEnable=dscpEnable, fileName=fileName, port1=port1, port2=port2, qmode=qmode, multicastsReceived=multicastsReceived, primaryDns=primaryDns, lanportName=lanportName, lanportTable=lanportTable, fcsErrorTransmitted=fcsErrorTransmitted, portStatEntry=portStatEntry, staticIpAddr=staticIpAddr, catv=catv, priority=priority, vlanid=vlanid, fileType=fileType, lanportIndex=lanportIndex, portTable=portTable, hostname=hostname, adminStatus=adminStatus, staticIpGateway=staticIpGateway, operStatus=operStatus, rxPower=rxPower, groupid=groupid, catvEnable=catvEnable, vendorPn=vendorPn, secondaryDns=secondaryDns, broadcastsReceived=broadcastsReceived, statisticTable=statisticTable, qosEntry=qosEntry, staticIpHostName=staticIpHostName, port3=port3, vendorRev=vendorRev, unicastsReceived=unicastsReceived, jumblan2=jumblan2, internetPort=internetPort, broadcastsTransmitted=broadcastsTransmitted, pauseTransmitted=pauseTransmitted, domainame=domainame, staticIpDomainName=staticIpDomainName, voltage=voltage, temperature=temperature, staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, lan3=lan3)
