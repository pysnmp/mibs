...
# Produced by pysmi-1.1.8 at Fri Sep  8 07:41:45 2023
...
mib_2, IpAddress, snmpModules, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, enterprises, iso, Gauge32, Unsigned32, Counter64, TimeTicks, Counter32, ModuleIdentity, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "IpAddress", "snmpModules", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "enterprises", "iso", "Gauge32", "Unsigned32", "Counter64", "TimeTicks", "Counter32", "ModuleIdentity", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rebootEnable=rebootEnable, wan=wan, staticIpAddr=staticIpAddr, jumblan3=jumblan3, action=action, vlan=vlan, staticIpSubMask=staticIpSubMask, portEntry=portEntry, domainame=domainame, jumbwan=jumbwan, groupid=groupid, port2=port2, wanType=wanType, broadcastsTransmitted=broadcastsTransmitted, lanportpause=lanportpause, fcsErrorTransmitted=fcsErrorTransmitted, rxPower=rxPower, statIndex=statIndex, fileName=fileName, vendorRev=vendorRev, qosEntry=qosEntry, pauseReceived=pauseReceived, lanportName=lanportName, temperature=temperature, secondaryDns=secondaryDns, primaryDns=primaryDns, internetPort=internetPort, staticIpHostName=staticIpHostName, groupIndex=groupIndex, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, speed=speed, deviceinfo=deviceinfo, lanportIndex=lanportIndex, catv=catv, groupEntry=groupEntry, modeEntry=modeEntry, adminStatus=adminStatus, lanportTable=lanportTable, fileType=fileType, reboot=reboot, unicastsTransmitted=unicastsTransmitted, serialnum=serialnum, portName=portName, priority=priority, portStatistic=portStatistic, bias=bias, jumblan1=jumblan1, staticIpSecondaryDns=staticIpSecondaryDns, txPower=txPower, vendorOui=vendorOui, portTable=portTable, port4=port4, jumb=jumb, operStatus=operStatus, xg6846=xg6846, lan2=lan2, tftpSevIp=tftpSevIp, unicastsReceived=unicastsReceived, jumblan2=jumblan2, multicastsReceived=multicastsReceived, lanportspeed=lanportspeed, staticIpPrimaryDns=staticIpPrimaryDns, portPower=portPower, catvEnable=catvEnable, vlanid=vlanid, dscpEnable=dscpEnable, staticIpDomainName=staticIpDomainName, port1=port1, qosTable=qosTable, vlangroupTable=vlangroupTable, staticDns=staticDns, broadcastsReceived=broadcastsReceived, staticIpGateway=staticIpGateway, hostname=hostname, lan3=lan3, port3=port3, tftp=tftp, qmapping=qmapping, pauseTransmitted=pauseTransmitted, voltage=voltage, vendorPn=vendorPn, qmode=qmode, vendorName=vendorName, portStatEntry=portStatEntry, portmode=portmode, lan4=lan4, multicastsTransmitted=multicastsTransmitted, ddminfo=ddminfo, qos=qos, qosIndex=qosIndex, lan1=lan1, statisticTable=statisticTable, jumblan4=jumblan4)
