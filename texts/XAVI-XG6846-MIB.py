...
# Produced by pysmi-1.1.12 at Tue Jun  4 13:53:50 2024
...
ModuleIdentity, enterprises, Integer32, iso, IpAddress, Counter64, Bits, Gauge32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, ObjectIdentity, TimeTicks, MibIdentifier, Unsigned32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Integer32", "iso", "IpAddress", "Counter64", "Bits", "Gauge32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Unsigned32", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportspeed=lanportspeed, qosIndex=qosIndex, fcsErrorTransmitted=fcsErrorTransmitted, lan3=lan3, rebootEnable=rebootEnable, qosEntry=qosEntry, lan2=lan2, port4=port4, catv=catv, staticIpHostName=staticIpHostName, jumblan1=jumblan1, portTable=portTable, operStatus=operStatus, portStatEntry=portStatEntry, staticIpSecondaryDns=staticIpSecondaryDns, internetPort=internetPort, staticIpDomainName=staticIpDomainName, portStatistic=portStatistic, secondaryDns=secondaryDns, groupid=groupid, qosTable=qosTable, adminStatus=adminStatus, speed=speed, portEntry=portEntry, lanportIndex=lanportIndex, jumb=jumb, lanportName=lanportName, hostname=hostname, vlangroupTable=vlangroupTable, vlan=vlan, unicastsTransmitted=unicastsTransmitted, action=action, deviceinfo=deviceinfo, priority=priority, serialnum=serialnum, vendorRev=vendorRev, fileType=fileType, jumblan3=jumblan3, vendorPn=vendorPn, wanType=wanType, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, staticIpGateway=staticIpGateway, staticIpPrimaryDns=staticIpPrimaryDns, portName=portName, bias=bias, jumblan2=jumblan2, groupIndex=groupIndex, ddminfo=ddminfo, port1=port1, voltage=voltage, fcsErrorReceived=fcsErrorReceived, qmapping=qmapping, groupEntry=groupEntry, port2=port2, vendorName=vendorName, portIndex=portIndex, lan4=lan4, statisticTable=statisticTable, primaryDns=primaryDns, pauseReceived=pauseReceived, dscpEnable=dscpEnable, lanportpause=lanportpause, vendorOui=vendorOui, qos=qos, staticIpSubMask=staticIpSubMask, multicastsTransmitted=multicastsTransmitted, fileName=fileName, tftp=tftp, staticDns=staticDns, xg6846=xg6846, lan1=lan1, portmode=portmode, catvEnable=catvEnable, jumblan4=jumblan4, domainame=domainame, vlanid=vlanid, staticIpAddr=staticIpAddr, portPower=portPower, unicastsReceived=unicastsReceived, lanportTable=lanportTable, pauseTransmitted=pauseTransmitted, multicastsReceived=multicastsReceived, port3=port3, temperature=temperature, modeEntry=modeEntry, txPower=txPower, jumbwan=jumbwan, wan=wan, tftpSevIp=tftpSevIp, reboot=reboot, broadcastsReceived=broadcastsReceived, statIndex=statIndex, rxPower=rxPower)
