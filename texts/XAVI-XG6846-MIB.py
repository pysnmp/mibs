...
# Produced by pysmi-1.1.8 at Thu Jan  5 10:23:46 2023
...
IpAddress, Bits, mib_2, enterprises, MibIdentifier, TimeTicks, Counter32, Gauge32, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, NotificationType, Unsigned32, snmpModules, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "mib-2", "enterprises", "MibIdentifier", "TimeTicks", "Counter32", "Gauge32", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "NotificationType", "Unsigned32", "snmpModules", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", temperature=temperature, internetPort=internetPort, hostname=hostname, staticIpSecondaryDns=staticIpSecondaryDns, dscpEnable=dscpEnable, vendorName=vendorName, fileName=fileName, groupIndex=groupIndex, qmode=qmode, tftpSevIp=tftpSevIp, staticIpSubMask=staticIpSubMask, action=action, lanportTable=lanportTable, jumblan3=jumblan3, portmode=portmode, domainame=domainame, vendorRev=vendorRev, catv=catv, vendorOui=vendorOui, statisticTable=statisticTable, rebootEnable=rebootEnable, fcsErrorReceived=fcsErrorReceived, staticIpHostName=staticIpHostName, bias=bias, tftp=tftp, statIndex=statIndex, qos=qos, ddminfo=ddminfo, jumbwan=jumbwan, port3=port3, modeEntry=modeEntry, multicastsReceived=multicastsReceived, voltage=voltage, vendorPn=vendorPn, fileType=fileType, catvEnable=catvEnable, lan1=lan1, jumblan4=jumblan4, lanportName=lanportName, rxPower=rxPower, speed=speed, lanportpause=lanportpause, adminStatus=adminStatus, pauseReceived=pauseReceived, unicastsReceived=unicastsReceived, lanportIndex=lanportIndex, deviceinfo=deviceinfo, primaryDns=primaryDns, port2=port2, portStatistic=portStatistic, port4=port4, groupEntry=groupEntry, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, lan2=lan2, staticIpGateway=staticIpGateway, qosIndex=qosIndex, xg6846=xg6846, operStatus=operStatus, jumb=jumb, vlangroupTable=vlangroupTable, staticIpAddr=staticIpAddr, port1=port1, wanType=wanType, groupid=groupid, portEntry=portEntry, qosEntry=qosEntry, jumblan2=jumblan2, lan3=lan3, qmapping=qmapping, staticIpDomainName=staticIpDomainName, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, broadcastsReceived=broadcastsReceived, portPower=portPower, pauseTransmitted=pauseTransmitted, priority=priority, portIndex=portIndex, portName=portName, jumblan1=jumblan1, staticIpPrimaryDns=staticIpPrimaryDns, vlan=vlan, txPower=txPower, staticDns=staticDns, fcsErrorTransmitted=fcsErrorTransmitted, lan4=lan4, qosTable=qosTable, reboot=reboot, secondaryDns=secondaryDns, wan=wan, serialnum=serialnum, lanportspeed=lanportspeed, portStatEntry=portStatEntry, portTable=portTable)
