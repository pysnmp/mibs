...
# Produced by pysmi-1.1.8 at Wed Oct 11 11:31:52 2023
...
ObjectIdentity, NotificationType, Gauge32, enterprises, Counter64, IpAddress, MibIdentifier, ModuleIdentity, Integer32, mib_2, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Unsigned32, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Gauge32", "enterprises", "Counter64", "IpAddress", "MibIdentifier", "ModuleIdentity", "Integer32", "mib-2", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Unsigned32", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, portName=portName, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, fileType=fileType, vlangroupTable=vlangroupTable, lanportTable=lanportTable, secondaryDns=secondaryDns, staticDns=staticDns, lanportIndex=lanportIndex, wan=wan, qmapping=qmapping, portStatEntry=portStatEntry, unicastsTransmitted=unicastsTransmitted, vendorPn=vendorPn, port2=port2, vendorRev=vendorRev, lan1=lan1, lanportspeed=lanportspeed, tftpSevIp=tftpSevIp, portEntry=portEntry, jumblan3=jumblan3, groupid=groupid, tftp=tftp, fcsErrorReceived=fcsErrorReceived, jumb=jumb, unicastsReceived=unicastsReceived, vendorName=vendorName, catvEnable=catvEnable, rebootEnable=rebootEnable, deviceinfo=deviceinfo, speed=speed, statisticTable=statisticTable, jumblan4=jumblan4, txPower=txPower, port3=port3, portTable=portTable, rxPower=rxPower, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, lanportpause=lanportpause, fcsErrorTransmitted=fcsErrorTransmitted, portPower=portPower, multicastsTransmitted=multicastsTransmitted, qosIndex=qosIndex, qos=qos, port4=port4, lan4=lan4, bias=bias, multicastsReceived=multicastsReceived, lanportName=lanportName, serialnum=serialnum, portStatistic=portStatistic, wanType=wanType, portmode=portmode, qosTable=qosTable, catv=catv, xg6846=xg6846, lan3=lan3, vlanid=vlanid, voltage=voltage, jumblan2=jumblan2, groupIndex=groupIndex, staticIpHostName=staticIpHostName, staticIpAddr=staticIpAddr, port1=port1, vendorOui=vendorOui, ddminfo=ddminfo, dscpEnable=dscpEnable, statIndex=statIndex, qosEntry=qosEntry, domainame=domainame, action=action, pauseTransmitted=pauseTransmitted, operStatus=operStatus, jumblan1=jumblan1, staticIpGateway=staticIpGateway, modeEntry=modeEntry, qmode=qmode, pauseReceived=pauseReceived, adminStatus=adminStatus, staticIpPrimaryDns=staticIpPrimaryDns, staticIpDomainName=staticIpDomainName, priority=priority, lan2=lan2, groupEntry=groupEntry, temperature=temperature, vlan=vlan, fileName=fileName, jumbwan=jumbwan, internetPort=internetPort, hostname=hostname, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask)
