...
# Produced by pysmi-1.1.10 at Thu Oct 26 12:32:43 2023
...
Unsigned32, enterprises, TimeTicks, Gauge32, ModuleIdentity, IpAddress, Integer32, ObjectIdentity, MibIdentifier, NotificationType, snmpModules, Counter64, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "enterprises", "TimeTicks", "Gauge32", "ModuleIdentity", "IpAddress", "Integer32", "ObjectIdentity", "MibIdentifier", "NotificationType", "snmpModules", "Counter64", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, staticIpPrimaryDns=staticIpPrimaryDns, groupEntry=groupEntry, jumblan1=jumblan1, unicastsReceived=unicastsReceived, fileType=fileType, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, qosIndex=qosIndex, vlanid=vlanid, unicastsTransmitted=unicastsTransmitted, lan2=lan2, port1=port1, internetPort=internetPort, speed=speed, lanportName=lanportName, port4=port4, portStatEntry=portStatEntry, qmapping=qmapping, primaryDns=primaryDns, port3=port3, portEntry=portEntry, jumblan3=jumblan3, txPower=txPower, multicastsReceived=multicastsReceived, staticIpHostName=staticIpHostName, vlan=vlan, staticIpSecondaryDns=staticIpSecondaryDns, portmode=portmode, voltage=voltage, catvEnable=catvEnable, statisticTable=statisticTable, vendorName=vendorName, domainame=domainame, lanportpause=lanportpause, rxPower=rxPower, qos=qos, bias=bias, ddminfo=ddminfo, lanportIndex=lanportIndex, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, portName=portName, rebootEnable=rebootEnable, staticIpAddr=staticIpAddr, jumb=jumb, staticDns=staticDns, vendorRev=vendorRev, vlangroupTable=vlangroupTable, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, fileName=fileName, catv=catv, qmode=qmode, xg6846=xg6846, wan=wan, vendorOui=vendorOui, pauseTransmitted=pauseTransmitted, port2=port2, action=action, jumblan2=jumblan2, vendorPn=vendorPn, secondaryDns=secondaryDns, portStatistic=portStatistic, jumblan4=jumblan4, broadcastsTransmitted=broadcastsTransmitted, tftpSevIp=tftpSevIp, lanportTable=lanportTable, serialnum=serialnum, statIndex=statIndex, wanType=wanType, temperature=temperature, tftp=tftp, staticIpGateway=staticIpGateway, portPower=portPower, jumbwan=jumbwan, lan3=lan3, dscpEnable=dscpEnable, priority=priority, lan4=lan4, staticIpSubMask=staticIpSubMask, staticIpDomainName=staticIpDomainName, lan1=lan1, portTable=portTable, groupid=groupid, modeEntry=modeEntry, deviceinfo=deviceinfo, pauseReceived=pauseReceived, qosEntry=qosEntry, operStatus=operStatus, hostname=hostname, qosTable=qosTable, lanportspeed=lanportspeed)
