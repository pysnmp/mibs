...
# Produced by pysmi-1.1.8 at Tue Jul 26 15:30:23 2022
...
TimeTicks, IpAddress, enterprises, Integer32, Counter64, NotificationType, Gauge32, MibIdentifier, snmpModules, ModuleIdentity, Counter32, iso, Bits, ObjectIdentity, mib_2, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "enterprises", "Integer32", "Counter64", "NotificationType", "Gauge32", "MibIdentifier", "snmpModules", "ModuleIdentity", "Counter32", "iso", "Bits", "ObjectIdentity", "mib-2", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan3=lan3, staticIpAddr=staticIpAddr, hostname=hostname, rebootEnable=rebootEnable, multicastsReceived=multicastsReceived, jumb=jumb, voltage=voltage, lan2=lan2, serialnum=serialnum, lanportTable=lanportTable, vendorName=vendorName, port4=port4, vendorPn=vendorPn, primaryDns=primaryDns, xg6846=xg6846, txPower=txPower, fcsErrorReceived=fcsErrorReceived, vendorOui=vendorOui, qosEntry=qosEntry, catvEnable=catvEnable, fileType=fileType, port3=port3, portStatEntry=portStatEntry, staticIpGateway=staticIpGateway, staticIpSecondaryDns=staticIpSecondaryDns, qosTable=qosTable, speed=speed, temperature=temperature, fcsErrorTransmitted=fcsErrorTransmitted, jumblan4=jumblan4, statisticTable=statisticTable, staticIpDomainName=staticIpDomainName, wan=wan, portTable=portTable, domainame=domainame, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, lanportName=lanportName, pauseTransmitted=pauseTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, reboot=reboot, multicastsTransmitted=multicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, staticIpHostName=staticIpHostName, modeEntry=modeEntry, fileName=fileName, lanportIndex=lanportIndex, staticDns=staticDns, dscpEnable=dscpEnable, internetPort=internetPort, unicastsReceived=unicastsReceived, priority=priority, ddminfo=ddminfo, action=action, portIndex=portIndex, statIndex=statIndex, deviceinfo=deviceinfo, qosIndex=qosIndex, catv=catv, secondaryDns=secondaryDns, lan1=lan1, operStatus=operStatus, portmode=portmode, lanportpause=lanportpause, bias=bias, vlan=vlan, tftpSevIp=tftpSevIp, portEntry=portEntry, jumbwan=jumbwan, broadcastsReceived=broadcastsReceived, groupid=groupid, portPower=portPower, groupIndex=groupIndex, adminStatus=adminStatus, vlanid=vlanid, port1=port1, qos=qos, portStatistic=portStatistic, pauseReceived=pauseReceived, qmapping=qmapping, jumblan3=jumblan3, lanportspeed=lanportspeed, lan4=lan4, vlangroupTable=vlangroupTable, groupEntry=groupEntry, portName=portName, qmode=qmode, rxPower=rxPower, tftp=tftp, port2=port2, jumblan1=jumblan1, wanType=wanType, staticIpSubMask=staticIpSubMask)
