...
# Produced by pysmi-1.1.10 at Fri Oct 27 12:15:27 2023
...
mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Gauge32, NotificationType, iso, enterprises, Bits, Counter64, Unsigned32, MibIdentifier, ObjectIdentity, ModuleIdentity, Counter32, Integer32, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Gauge32", "NotificationType", "iso", "enterprises", "Bits", "Counter64", "Unsigned32", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Counter32", "Integer32", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portIndex=portIndex, qosIndex=qosIndex, operStatus=operStatus, jumblan4=jumblan4, jumbwan=jumbwan, vlangroupTable=vlangroupTable, vendorPn=vendorPn, modeEntry=modeEntry, lanportIndex=lanportIndex, internetPort=internetPort, vendorRev=vendorRev, bias=bias, tftp=tftp, tftpSevIp=tftpSevIp, lan2=lan2, portName=portName, broadcastsReceived=broadcastsReceived, jumblan3=jumblan3, staticIpDomainName=staticIpDomainName, jumblan2=jumblan2, portTable=portTable, qmode=qmode, unicastsReceived=unicastsReceived, port2=port2, catv=catv, multicastsTransmitted=multicastsTransmitted, statIndex=statIndex, reboot=reboot, lanportTable=lanportTable, fcsErrorTransmitted=fcsErrorTransmitted, rebootEnable=rebootEnable, temperature=temperature, domainame=domainame, statisticTable=statisticTable, catvEnable=catvEnable, fileType=fileType, lanportpause=lanportpause, speed=speed, lan4=lan4, deviceinfo=deviceinfo, primaryDns=primaryDns, pauseReceived=pauseReceived, xg6846=xg6846, fcsErrorReceived=fcsErrorReceived, wanType=wanType, jumblan1=jumblan1, portPower=portPower, staticDns=staticDns, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, staticIpSubMask=staticIpSubMask, qosEntry=qosEntry, portStatistic=portStatistic, port1=port1, wan=wan, qmapping=qmapping, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, vlan=vlan, port4=port4, voltage=voltage, lan1=lan1, qos=qos, adminStatus=adminStatus, vendorName=vendorName, txPower=txPower, staticIpHostName=staticIpHostName, portEntry=portEntry, dscpEnable=dscpEnable, rxPower=rxPower, action=action, qosTable=qosTable, secondaryDns=secondaryDns, vendorOui=vendorOui, ddminfo=ddminfo, portmode=portmode, priority=priority, port3=port3, hostname=hostname, staticIpPrimaryDns=staticIpPrimaryDns, jumb=jumb, serialnum=serialnum, staticIpAddr=staticIpAddr, groupEntry=groupEntry, lanportName=lanportName, fileName=fileName, lanportspeed=lanportspeed, lan3=lan3, vlanid=vlanid, unicastsTransmitted=unicastsTransmitted, groupIndex=groupIndex, portStatEntry=portStatEntry)
