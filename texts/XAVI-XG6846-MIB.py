...
Counter64, snmpModules, Counter32, Integer32, TimeTicks, IpAddress, MibIdentifier, ObjectIdentity, enterprises, iso, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, ModuleIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "snmpModules", "Counter32", "Integer32", "TimeTicks", "IpAddress", "MibIdentifier", "ObjectIdentity", "enterprises", "iso", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "ModuleIdentity", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port1=port1, rebootEnable=rebootEnable, staticIpSubMask=staticIpSubMask, portmode=portmode, portTable=portTable, statisticTable=statisticTable, staticIpAddr=staticIpAddr, qosEntry=qosEntry, lan1=lan1, reboot=reboot, fileType=fileType, pauseReceived=pauseReceived, portPower=portPower, catv=catv, multicastsReceived=multicastsReceived, unicastsTransmitted=unicastsTransmitted, tftp=tftp, port3=port3, jumblan3=jumblan3, vendorName=vendorName, internetPort=internetPort, secondaryDns=secondaryDns, vendorPn=vendorPn, lan2=lan2, wanType=wanType, port4=port4, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, primaryDns=primaryDns, fileName=fileName, lanportIndex=lanportIndex, voltage=voltage, qos=qos, jumb=jumb, portStatEntry=portStatEntry, portName=portName, adminStatus=adminStatus, pauseTransmitted=pauseTransmitted, fcsErrorReceived=fcsErrorReceived, tftpSevIp=tftpSevIp, xg6846=xg6846, multicastsTransmitted=multicastsTransmitted, wan=wan, unicastsReceived=unicastsReceived, lanportName=lanportName, jumblan2=jumblan2, modeEntry=modeEntry, serialnum=serialnum, deviceinfo=deviceinfo, rxPower=rxPower, lan3=lan3, groupIndex=groupIndex, staticIpHostName=staticIpHostName, staticIpPrimaryDns=staticIpPrimaryDns, jumbwan=jumbwan, qosTable=qosTable, vendorOui=vendorOui, portIndex=portIndex, statIndex=statIndex, broadcastsReceived=broadcastsReceived, lanportspeed=lanportspeed, groupid=groupid, dscpEnable=dscpEnable, temperature=temperature, groupEntry=groupEntry, jumblan1=jumblan1, vlangroupTable=vlangroupTable, staticDns=staticDns, txPower=txPower, catvEnable=catvEnable, qmapping=qmapping, domainame=domainame, port2=port2, hostname=hostname, bias=bias, portEntry=portEntry, jumblan4=jumblan4, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, qmode=qmode, speed=speed, portStatistic=portStatistic, staticIpGateway=staticIpGateway, lanportTable=lanportTable, priority=priority, operStatus=operStatus, vlanid=vlanid, lanportpause=lanportpause, action=action, vendorRev=vendorRev, lan4=lan4, fcsErrorTransmitted=fcsErrorTransmitted, vlan=vlan, ddminfo=ddminfo)
