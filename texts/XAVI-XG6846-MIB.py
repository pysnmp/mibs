...
Bits, Unsigned32, TimeTicks, Counter32, iso, ModuleIdentity, mib_2, enterprises, MibIdentifier, Counter64, ObjectIdentity, NotificationType, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "TimeTicks", "Counter32", "iso", "ModuleIdentity", "mib-2", "enterprises", "MibIdentifier", "Counter64", "ObjectIdentity", "NotificationType", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", internetPort=internetPort, staticIpGateway=staticIpGateway, wan=wan, modeEntry=modeEntry, multicastsTransmitted=multicastsTransmitted, lan3=lan3, vendorRev=vendorRev, hostname=hostname, vlan=vlan, statIndex=statIndex, temperature=temperature, jumb=jumb, ddminfo=ddminfo, catvEnable=catvEnable, portName=portName, staticIpAddr=staticIpAddr, speed=speed, port4=port4, lanportName=lanportName, qmapping=qmapping, portStatEntry=portStatEntry, staticIpHostName=staticIpHostName, qosEntry=qosEntry, groupIndex=groupIndex, deviceinfo=deviceinfo, staticDns=staticDns, secondaryDns=secondaryDns, fileName=fileName, qosTable=qosTable, port2=port2, adminStatus=adminStatus, jumblan2=jumblan2, wanType=wanType, action=action, xg6846=xg6846, vendorOui=vendorOui, lanportTable=lanportTable, port1=port1, lan4=lan4, qmode=qmode, portStatistic=portStatistic, unicastsReceived=unicastsReceived, vlangroupTable=vlangroupTable, port3=port3, primaryDns=primaryDns, broadcastsTransmitted=broadcastsTransmitted, txPower=txPower, vendorPn=vendorPn, statisticTable=statisticTable, multicastsReceived=multicastsReceived, serialnum=serialnum, bias=bias, operStatus=operStatus, priority=priority, staticIpSubMask=staticIpSubMask, dscpEnable=dscpEnable, groupEntry=groupEntry, voltage=voltage, catv=catv, jumblan1=jumblan1, domainame=domainame, lanportIndex=lanportIndex, vendorName=vendorName, qosIndex=qosIndex, groupid=groupid, lanportspeed=lanportspeed, fcsErrorTransmitted=fcsErrorTransmitted, pauseTransmitted=pauseTransmitted, tftpSevIp=tftpSevIp, portPower=portPower, portTable=portTable, lan1=lan1, jumblan3=jumblan3, fileType=fileType, jumbwan=jumbwan, rebootEnable=rebootEnable, unicastsTransmitted=unicastsTransmitted, lanportpause=lanportpause, staticIpSecondaryDns=staticIpSecondaryDns, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, vlanid=vlanid, portmode=portmode, portEntry=portEntry, lan2=lan2, qos=qos, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, staticIpDomainName=staticIpDomainName, staticIpPrimaryDns=staticIpPrimaryDns, tftp=tftp, reboot=reboot, rxPower=rxPower, pauseReceived=pauseReceived)
