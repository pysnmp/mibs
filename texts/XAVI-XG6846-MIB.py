...
enterprises, Integer32, NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, iso, IpAddress, snmpModules, Gauge32, TimeTicks, mib_2, MibIdentifier, ModuleIdentity, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "iso", "IpAddress", "snmpModules", "Gauge32", "TimeTicks", "mib-2", "MibIdentifier", "ModuleIdentity", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorReceived=fcsErrorReceived, staticIpHostName=staticIpHostName, txPower=txPower, ddminfo=ddminfo, jumb=jumb, jumblan1=jumblan1, lan2=lan2, rxPower=rxPower, lan1=lan1, fileName=fileName, unicastsReceived=unicastsReceived, pauseReceived=pauseReceived, tftp=tftp, vendorPn=vendorPn, xg6846=xg6846, temperature=temperature, catv=catv, lanportspeed=lanportspeed, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, qmode=qmode, jumblan2=jumblan2, domainame=domainame, portStatistic=portStatistic, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSecondaryDns=staticIpSecondaryDns, wanType=wanType, priority=priority, portmode=portmode, fileType=fileType, portEntry=portEntry, broadcastsTransmitted=broadcastsTransmitted, lanportTable=lanportTable, port1=port1, qos=qos, dscpEnable=dscpEnable, portStatEntry=portStatEntry, vendorRev=vendorRev, modeEntry=modeEntry, lanportpause=lanportpause, lanportName=lanportName, qosEntry=qosEntry, staticIpDomainName=staticIpDomainName, rebootEnable=rebootEnable, voltage=voltage, lanportIndex=lanportIndex, jumbwan=jumbwan, port4=port4, portPower=portPower, operStatus=operStatus, multicastsReceived=multicastsReceived, groupEntry=groupEntry, groupid=groupid, primaryDns=primaryDns, serialnum=serialnum, broadcastsReceived=broadcastsReceived, vendorOui=vendorOui, staticIpSubMask=staticIpSubMask, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, groupIndex=groupIndex, reboot=reboot, statisticTable=statisticTable, catvEnable=catvEnable, pauseTransmitted=pauseTransmitted, bias=bias, speed=speed, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus, port2=port2, vlanid=vlanid, portName=portName, vendorName=vendorName, internetPort=internetPort, jumblan4=jumblan4, tftpSevIp=tftpSevIp, deviceinfo=deviceinfo, portTable=portTable, staticIpAddr=staticIpAddr, portIndex=portIndex, hostname=hostname, jumblan3=jumblan3, lan4=lan4, secondaryDns=secondaryDns, wan=wan, lan3=lan3, action=action, port3=port3, vlan=vlan, qosIndex=qosIndex, staticDns=staticDns, statIndex=statIndex, qosTable=qosTable, qmapping=qmapping)
