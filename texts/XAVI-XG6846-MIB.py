...
Integer32, NotificationType, Unsigned32, Counter64, IpAddress, MibIdentifier, iso, Bits, Gauge32, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Counter32, enterprises, TimeTicks, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Unsigned32", "Counter64", "IpAddress", "MibIdentifier", "iso", "Bits", "Gauge32", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Counter32", "enterprises", "TimeTicks", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan2=lan2, port3=port3, groupEntry=groupEntry, broadcastsTransmitted=broadcastsTransmitted, domainame=domainame, catv=catv, multicastsTransmitted=multicastsTransmitted, portPower=portPower, qmode=qmode, txPower=txPower, lanportIndex=lanportIndex, vendorName=vendorName, temperature=temperature, tftpSevIp=tftpSevIp, fcsErrorTransmitted=fcsErrorTransmitted, voltage=voltage, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, speed=speed, groupid=groupid, statisticTable=statisticTable, jumblan1=jumblan1, multicastsReceived=multicastsReceived, lanportpause=lanportpause, fcsErrorReceived=fcsErrorReceived, lan1=lan1, deviceinfo=deviceinfo, priority=priority, staticIpPrimaryDns=staticIpPrimaryDns, qosTable=qosTable, jumblan4=jumblan4, rebootEnable=rebootEnable, portIndex=portIndex, pauseReceived=pauseReceived, serialnum=serialnum, portmode=portmode, operStatus=operStatus, qmapping=qmapping, secondaryDns=secondaryDns, bias=bias, lan3=lan3, qos=qos, staticIpHostName=staticIpHostName, primaryDns=primaryDns, port1=port1, jumblan2=jumblan2, lanportTable=lanportTable, fileType=fileType, groupIndex=groupIndex, staticIpAddr=staticIpAddr, lanportspeed=lanportspeed, dscpEnable=dscpEnable, portEntry=portEntry, wanType=wanType, vlanid=vlanid, internetPort=internetPort, ddminfo=ddminfo, vlangroupTable=vlangroupTable, vendorOui=vendorOui, pauseTransmitted=pauseTransmitted, port2=port2, catvEnable=catvEnable, vlan=vlan, lanportName=lanportName, vendorRev=vendorRev, action=action, fileName=fileName, xg6846=xg6846, qosIndex=qosIndex, reboot=reboot, jumb=jumb, portStatEntry=portStatEntry, vendorPn=vendorPn, portName=portName, hostname=hostname, portStatistic=portStatistic, tftp=tftp, jumbwan=jumbwan, port4=port4, statIndex=statIndex, staticIpSecondaryDns=staticIpSecondaryDns, portTable=portTable, unicastsTransmitted=unicastsTransmitted, staticIpDomainName=staticIpDomainName, lan4=lan4, staticIpSubMask=staticIpSubMask, staticIpGateway=staticIpGateway, rxPower=rxPower, qosEntry=qosEntry, unicastsReceived=unicastsReceived, modeEntry=modeEntry, jumblan3=jumblan3, wan=wan, staticDns=staticDns)
