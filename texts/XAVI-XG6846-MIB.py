...
Bits, NotificationType, Integer32, mib_2, TimeTicks, ModuleIdentity, Gauge32, iso, MibIdentifier, IpAddress, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, enterprises, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Integer32", "mib-2", "TimeTicks", "ModuleIdentity", "Gauge32", "iso", "MibIdentifier", "IpAddress", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "enterprises", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", priority=priority, bias=bias, action=action, dscpEnable=dscpEnable, broadcastsTransmitted=broadcastsTransmitted, fcsErrorReceived=fcsErrorReceived, groupid=groupid, serialnum=serialnum, staticIpGateway=staticIpGateway, jumb=jumb, secondaryDns=secondaryDns, portStatistic=portStatistic, lanportIndex=lanportIndex, staticIpHostName=staticIpHostName, unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, port4=port4, tftp=tftp, qos=qos, qosEntry=qosEntry, qmode=qmode, pauseTransmitted=pauseTransmitted, wan=wan, jumblan2=jumblan2, qmapping=qmapping, hostname=hostname, vendorPn=vendorPn, port2=port2, rxPower=rxPower, pauseReceived=pauseReceived, lanportTable=lanportTable, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, jumbwan=jumbwan, reboot=reboot, vlanid=vlanid, ddminfo=ddminfo, voltage=voltage, lanportspeed=lanportspeed, rebootEnable=rebootEnable, port1=port1, portTable=portTable, vendorOui=vendorOui, jumblan4=jumblan4, portName=portName, staticIpSecondaryDns=staticIpSecondaryDns, unicastsTransmitted=unicastsTransmitted, adminStatus=adminStatus, statisticTable=statisticTable, catvEnable=catvEnable, vlan=vlan, vendorRev=vendorRev, internetPort=internetPort, lanportName=lanportName, deviceinfo=deviceinfo, multicastsTransmitted=multicastsTransmitted, fileType=fileType, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, staticIpDomainName=staticIpDomainName, lan2=lan2, temperature=temperature, qosTable=qosTable, qosIndex=qosIndex, operStatus=operStatus, vlangroupTable=vlangroupTable, portStatEntry=portStatEntry, lan3=lan3, primaryDns=primaryDns, portPower=portPower, wanType=wanType, portEntry=portEntry, broadcastsReceived=broadcastsReceived, lan4=lan4, port3=port3, lan1=lan1, jumblan3=jumblan3, portIndex=portIndex, groupIndex=groupIndex, jumblan1=jumblan1, catv=catv, portmode=portmode, staticIpSubMask=staticIpSubMask, groupEntry=groupEntry, staticDns=staticDns, lanportpause=lanportpause, xg6846=xg6846, tftpSevIp=tftpSevIp, txPower=txPower, fileName=fileName, modeEntry=modeEntry, vendorName=vendorName, statIndex=statIndex, domainame=domainame)
