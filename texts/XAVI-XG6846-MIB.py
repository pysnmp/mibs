...
snmpModules, Gauge32, Counter64, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, mib_2, IpAddress, TimeTicks, Counter32, ModuleIdentity, iso, enterprises, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Gauge32", "Counter64", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "mib-2", "IpAddress", "TimeTicks", "Counter32", "ModuleIdentity", "iso", "enterprises", "Bits", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, fcsErrorTransmitted=fcsErrorTransmitted, portName=portName, staticIpHostName=staticIpHostName, statisticTable=statisticTable, serialnum=serialnum, speed=speed, rebootEnable=rebootEnable, vendorName=vendorName, internetPort=internetPort, portmode=portmode, dscpEnable=dscpEnable, lanportName=lanportName, qos=qos, domainame=domainame, port2=port2, portPower=portPower, staticIpAddr=staticIpAddr, txPower=txPower, statIndex=statIndex, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, priority=priority, temperature=temperature, groupEntry=groupEntry, qosEntry=qosEntry, pauseReceived=pauseReceived, port4=port4, reboot=reboot, jumblan1=jumblan1, staticDns=staticDns, vlan=vlan, secondaryDns=secondaryDns, vendorOui=vendorOui, jumblan2=jumblan2, staticIpDomainName=staticIpDomainName, vendorPn=vendorPn, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, qmode=qmode, staticIpGateway=staticIpGateway, portTable=portTable, lan3=lan3, broadcastsTransmitted=broadcastsTransmitted, jumblan4=jumblan4, lanportspeed=lanportspeed, qosIndex=qosIndex, wan=wan, unicastsTransmitted=unicastsTransmitted, lan1=lan1, multicastsTransmitted=multicastsTransmitted, vlangroupTable=vlangroupTable, xg6846=xg6846, lanportIndex=lanportIndex, lan2=lan2, voltage=voltage, modeEntry=modeEntry, primaryDns=primaryDns, multicastsReceived=multicastsReceived, groupid=groupid, hostname=hostname, vlanid=vlanid, lanportTable=lanportTable, deviceinfo=deviceinfo, catv=catv, staticIpSecondaryDns=staticIpSecondaryDns, portStatistic=portStatistic, unicastsReceived=unicastsReceived, fileName=fileName, port3=port3, bias=bias, qmapping=qmapping, fcsErrorReceived=fcsErrorReceived, lanportpause=lanportpause, ddminfo=ddminfo, vendorRev=vendorRev, jumb=jumb, operStatus=operStatus, port1=port1, jumbwan=jumbwan, fileType=fileType, portIndex=portIndex, lan4=lan4, portStatEntry=portStatEntry, jumblan3=jumblan3, wanType=wanType, broadcastsReceived=broadcastsReceived, groupIndex=groupIndex, portEntry=portEntry, qosTable=qosTable, tftp=tftp, tftpSevIp=tftpSevIp, rxPower=rxPower, action=action)
