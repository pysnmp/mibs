...
enterprises, iso, Unsigned32, mib_2, IpAddress, Bits, ModuleIdentity, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, snmpModules, Integer32, NotificationType, Counter64, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "iso", "Unsigned32", "mib-2", "IpAddress", "Bits", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "snmpModules", "Integer32", "NotificationType", "Counter64", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorTransmitted=fcsErrorTransmitted, reboot=reboot, serialnum=serialnum, qmapping=qmapping, operStatus=operStatus, pauseReceived=pauseReceived, lanportName=lanportName, voltage=voltage, hostname=hostname, ddminfo=ddminfo, vendorPn=vendorPn, staticIpAddr=staticIpAddr, portStatistic=portStatistic, vlan=vlan, qosEntry=qosEntry, jumb=jumb, catv=catv, groupEntry=groupEntry, rebootEnable=rebootEnable, primaryDns=primaryDns, adminStatus=adminStatus, statIndex=statIndex, fcsErrorReceived=fcsErrorReceived, dscpEnable=dscpEnable, wan=wan, vendorRev=vendorRev, lan1=lan1, internetPort=internetPort, lanportIndex=lanportIndex, lan3=lan3, portEntry=portEntry, qmode=qmode, portTable=portTable, portName=portName, wanType=wanType, action=action, port3=port3, staticIpPrimaryDns=staticIpPrimaryDns, portPower=portPower, domainame=domainame, port4=port4, qosIndex=qosIndex, rxPower=rxPower, priority=priority, port2=port2, pauseTransmitted=pauseTransmitted, unicastsTransmitted=unicastsTransmitted, staticIpSubMask=staticIpSubMask, unicastsReceived=unicastsReceived, tftpSevIp=tftpSevIp, tftp=tftp, lanportspeed=lanportspeed, broadcastsReceived=broadcastsReceived, qosTable=qosTable, portIndex=portIndex, vendorOui=vendorOui, portStatEntry=portStatEntry, statisticTable=statisticTable, catvEnable=catvEnable, modeEntry=modeEntry, staticIpDomainName=staticIpDomainName, staticIpHostName=staticIpHostName, fileName=fileName, lanportpause=lanportpause, staticIpGateway=staticIpGateway, lan2=lan2, portmode=portmode, deviceinfo=deviceinfo, secondaryDns=secondaryDns, groupIndex=groupIndex, speed=speed, xg6846=xg6846, jumblan2=jumblan2, temperature=temperature, vendorName=vendorName, multicastsReceived=multicastsReceived, fileType=fileType, jumblan3=jumblan3, jumblan4=jumblan4, multicastsTransmitted=multicastsTransmitted, qos=qos, txPower=txPower, lan4=lan4, jumbwan=jumbwan, staticIpSecondaryDns=staticIpSecondaryDns, bias=bias, lanportTable=lanportTable, jumblan1=jumblan1, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, port1=port1, vlangroupTable=vlangroupTable, staticDns=staticDns, groupid=groupid)
