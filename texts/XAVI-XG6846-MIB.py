...
Integer32, ModuleIdentity, mib_2, ObjectIdentity, Counter64, enterprises, Bits, MibIdentifier, Unsigned32, iso, NotificationType, Gauge32, snmpModules, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "mib-2", "ObjectIdentity", "Counter64", "enterprises", "Bits", "MibIdentifier", "Unsigned32", "iso", "NotificationType", "Gauge32", "snmpModules", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSecondaryDns=staticIpSecondaryDns, qmapping=qmapping, tftpSevIp=tftpSevIp, port2=port2, vendorOui=vendorOui, lan1=lan1, qos=qos, lan4=lan4, statisticTable=statisticTable, groupid=groupid, lanportName=lanportName, catvEnable=catvEnable, vlangroupTable=vlangroupTable, port1=port1, qosIndex=qosIndex, deviceinfo=deviceinfo, portmode=portmode, vendorRev=vendorRev, vendorPn=vendorPn, fileType=fileType, port3=port3, portName=portName, rebootEnable=rebootEnable, lanportspeed=lanportspeed, fcsErrorTransmitted=fcsErrorTransmitted, portIndex=portIndex, wanType=wanType, catv=catv, temperature=temperature, portStatEntry=portStatEntry, fcsErrorReceived=fcsErrorReceived, operStatus=operStatus, unicastsReceived=unicastsReceived, hostname=hostname, pauseReceived=pauseReceived, jumblan3=jumblan3, rxPower=rxPower, groupIndex=groupIndex, primaryDns=primaryDns, voltage=voltage, broadcastsTransmitted=broadcastsTransmitted, lanportIndex=lanportIndex, pauseTransmitted=pauseTransmitted, multicastsTransmitted=multicastsTransmitted, groupEntry=groupEntry, fileName=fileName, qosEntry=qosEntry, jumb=jumb, lan3=lan3, bias=bias, staticIpDomainName=staticIpDomainName, dscpEnable=dscpEnable, txPower=txPower, lan2=lan2, broadcastsReceived=broadcastsReceived, qmode=qmode, staticIpHostName=staticIpHostName, portPower=portPower, action=action, lanportpause=lanportpause, staticIpPrimaryDns=staticIpPrimaryDns, port4=port4, xg6846=xg6846, adminStatus=adminStatus, staticDns=staticDns, modeEntry=modeEntry, vendorName=vendorName, jumbwan=jumbwan, jumblan2=jumblan2, portTable=portTable, staticIpSubMask=staticIpSubMask, serialnum=serialnum, wan=wan, portEntry=portEntry, internetPort=internetPort, staticIpAddr=staticIpAddr, lanportTable=lanportTable, statIndex=statIndex, jumblan1=jumblan1, vlanid=vlanid, ddminfo=ddminfo, speed=speed, vlan=vlan, jumblan4=jumblan4, qosTable=qosTable, staticIpGateway=staticIpGateway, multicastsReceived=multicastsReceived, portStatistic=portStatistic, domainame=domainame, unicastsTransmitted=unicastsTransmitted, reboot=reboot, tftp=tftp, secondaryDns=secondaryDns, priority=priority)
