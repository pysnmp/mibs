...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosTable=qosTable, staticIpSecondaryDns=staticIpSecondaryDns, jumblan2=jumblan2, txPower=txPower, lan3=lan3, port1=port1, jumblan1=jumblan1, groupIndex=groupIndex, port3=port3, xg6846=xg6846, action=action, jumbwan=jumbwan, staticIpGateway=staticIpGateway, pauseReceived=pauseReceived, portName=portName, hostname=hostname, operStatus=operStatus, lanportspeed=lanportspeed, tftpSevIp=tftpSevIp, qmapping=qmapping, portStatistic=portStatistic, jumb=jumb, portPower=portPower, fcsErrorTransmitted=fcsErrorTransmitted, port2=port2, vlan=vlan, bias=bias, fileName=fileName, staticIpSubMask=staticIpSubMask, broadcastsTransmitted=broadcastsTransmitted, catv=catv, priority=priority, wanType=wanType, pauseTransmitted=pauseTransmitted, unicastsReceived=unicastsReceived, statIndex=statIndex, speed=speed, lan4=lan4, vlangroupTable=vlangroupTable, internetPort=internetPort, dscpEnable=dscpEnable, temperature=temperature, vendorRev=vendorRev, portTable=portTable, lanportIndex=lanportIndex, portmode=portmode, rxPower=rxPower, domainame=domainame, reboot=reboot, multicastsReceived=multicastsReceived, serialnum=serialnum, groupid=groupid, rebootEnable=rebootEnable, vendorPn=vendorPn, primaryDns=primaryDns, fileType=fileType, vendorOui=vendorOui, lan1=lan1, staticIpHostName=staticIpHostName, modeEntry=modeEntry, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, qosEntry=qosEntry, voltage=voltage, unicastsTransmitted=unicastsTransmitted, adminStatus=adminStatus, secondaryDns=secondaryDns, statisticTable=statisticTable, qos=qos, staticIpAddr=staticIpAddr, lanportName=lanportName, staticDns=staticDns, broadcastsReceived=broadcastsReceived, qmode=qmode, vlanid=vlanid, portEntry=portEntry, lanportpause=lanportpause, catvEnable=catvEnable, staticIpPrimaryDns=staticIpPrimaryDns, ddminfo=ddminfo, lan2=lan2, multicastsTransmitted=multicastsTransmitted, wan=wan, port4=port4, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, qosIndex=qosIndex, groupEntry=groupEntry, portStatEntry=portStatEntry, deviceinfo=deviceinfo, portIndex=portIndex, tftp=tftp, jumblan3=jumblan3, vendorName=vendorName)
