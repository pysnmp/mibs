...
# Produced by pysmi-1.1.8 at Thu Sep 15 09:43:29 2022
...
IpAddress, enterprises, Counter64, ObjectIdentity, MibIdentifier, snmpModules, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, NotificationType, Integer32, mib_2, Gauge32, TimeTicks, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "Counter64", "ObjectIdentity", "MibIdentifier", "snmpModules", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "NotificationType", "Integer32", "mib-2", "Gauge32", "TimeTicks", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, fileType=fileType, serialnum=serialnum, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, wan=wan, tftpSevIp=tftpSevIp, adminStatus=adminStatus, hostname=hostname, vendorName=vendorName, dscpEnable=dscpEnable, portEntry=portEntry, qmode=qmode, qosTable=qosTable, jumblan1=jumblan1, bias=bias, internetPort=internetPort, groupid=groupid, unicastsTransmitted=unicastsTransmitted, portStatistic=portStatistic, broadcastsTransmitted=broadcastsTransmitted, vendorOui=vendorOui, jumb=jumb, deviceinfo=deviceinfo, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, rxPower=rxPower, portmode=portmode, operStatus=operStatus, jumblan2=jumblan2, portName=portName, staticIpAddr=staticIpAddr, primaryDns=primaryDns, ddminfo=ddminfo, vlangroupTable=vlangroupTable, lanportpause=lanportpause, port4=port4, groupEntry=groupEntry, port2=port2, port1=port1, port3=port3, unicastsReceived=unicastsReceived, qmapping=qmapping, portStatEntry=portStatEntry, rebootEnable=rebootEnable, xg6846=xg6846, tftp=tftp, staticIpDomainName=staticIpDomainName, multicastsReceived=multicastsReceived, temperature=temperature, catv=catv, catvEnable=catvEnable, portTable=portTable, vlan=vlan, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, vendorPn=vendorPn, vlanid=vlanid, modeEntry=modeEntry, statisticTable=statisticTable, lanportIndex=lanportIndex, staticIpSecondaryDns=staticIpSecondaryDns, broadcastsReceived=broadcastsReceived, staticIpHostName=staticIpHostName, wanType=wanType, qos=qos, txPower=txPower, lan4=lan4, secondaryDns=secondaryDns, reboot=reboot, action=action, priority=priority, vendorRev=vendorRev, lan1=lan1, jumblan3=jumblan3, jumbwan=jumbwan, qosIndex=qosIndex, staticIpGateway=staticIpGateway, lanportTable=lanportTable, speed=speed, pauseReceived=pauseReceived, domainame=domainame, staticIpSubMask=staticIpSubMask, qosEntry=qosEntry, portPower=portPower, lanportName=lanportName, staticDns=staticDns, pauseTransmitted=pauseTransmitted, lan3=lan3, fileName=fileName, lanportspeed=lanportspeed, lan2=lan2, voltage=voltage)
