...
# Produced by pysmi-1.1.8 at Thu Apr 27 12:15:43 2023
...
Gauge32, ObjectIdentity, Unsigned32, mib_2, ModuleIdentity, enterprises, Integer32, MibIdentifier, NotificationType, snmpModules, Bits, TimeTicks, Counter64, IpAddress, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Unsigned32", "mib-2", "ModuleIdentity", "enterprises", "Integer32", "MibIdentifier", "NotificationType", "snmpModules", "Bits", "TimeTicks", "Counter64", "IpAddress", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", operStatus=operStatus, qos=qos, txPower=txPower, port3=port3, hostname=hostname, qosIndex=qosIndex, unicastsReceived=unicastsReceived, staticIpAddr=staticIpAddr, statIndex=statIndex, reboot=reboot, priority=priority, temperature=temperature, voltage=voltage, multicastsReceived=multicastsReceived, qosEntry=qosEntry, jumblan2=jumblan2, lanportspeed=lanportspeed, portIndex=portIndex, primaryDns=primaryDns, pauseTransmitted=pauseTransmitted, lanportName=lanportName, lanportpause=lanportpause, tftpSevIp=tftpSevIp, staticIpGateway=staticIpGateway, staticIpHostName=staticIpHostName, jumblan3=jumblan3, jumbwan=jumbwan, vlangroupTable=vlangroupTable, action=action, port2=port2, jumblan1=jumblan1, vendorPn=vendorPn, statisticTable=statisticTable, catv=catv, lan1=lan1, fcsErrorTransmitted=fcsErrorTransmitted, staticIpSubMask=staticIpSubMask, portTable=portTable, wan=wan, catvEnable=catvEnable, fcsErrorReceived=fcsErrorReceived, wanType=wanType, groupEntry=groupEntry, staticIpDomainName=staticIpDomainName, modeEntry=modeEntry, bias=bias, fileType=fileType, portmode=portmode, qosTable=qosTable, vendorName=vendorName, qmapping=qmapping, portStatEntry=portStatEntry, broadcastsReceived=broadcastsReceived, qmode=qmode, staticIpPrimaryDns=staticIpPrimaryDns, tftp=tftp, lanportIndex=lanportIndex, rxPower=rxPower, dscpEnable=dscpEnable, secondaryDns=secondaryDns, lanportTable=lanportTable, pauseReceived=pauseReceived, staticDns=staticDns, speed=speed, staticIpSecondaryDns=staticIpSecondaryDns, ddminfo=ddminfo, lan4=lan4, portPower=portPower, lan3=lan3, serialnum=serialnum, portEntry=portEntry, adminStatus=adminStatus, jumb=jumb, domainame=domainame, xg6846=xg6846, vlan=vlan, multicastsTransmitted=multicastsTransmitted, vlanid=vlanid, groupIndex=groupIndex, internetPort=internetPort, rebootEnable=rebootEnable, portStatistic=portStatistic, fileName=fileName, groupid=groupid, lan2=lan2, vendorOui=vendorOui, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, portName=portName, broadcastsTransmitted=broadcastsTransmitted, vendorRev=vendorRev, port4=port4, jumblan4=jumblan4, port1=port1)
