...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:27:52 2022
...
iso, MibIdentifier, IpAddress, ObjectIdentity, Integer32, NotificationType, TimeTicks, snmpModules, Counter64, Gauge32, mib_2, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "IpAddress", "ObjectIdentity", "Integer32", "NotificationType", "TimeTicks", "snmpModules", "Counter64", "Gauge32", "mib-2", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorTransmitted=fcsErrorTransmitted, catvEnable=catvEnable, lan1=lan1, rxPower=rxPower, multicastsReceived=multicastsReceived, lan4=lan4, staticIpPrimaryDns=staticIpPrimaryDns, portPower=portPower, qosIndex=qosIndex, portmode=portmode, vendorName=vendorName, vendorOui=vendorOui, groupEntry=groupEntry, lan2=lan2, xg6846=xg6846, multicastsTransmitted=multicastsTransmitted, voltage=voltage, fileName=fileName, unicastsReceived=unicastsReceived, catv=catv, secondaryDns=secondaryDns, staticIpDomainName=staticIpDomainName, groupIndex=groupIndex, qosTable=qosTable, portTable=portTable, lanportIndex=lanportIndex, lanportName=lanportName, tftpSevIp=tftpSevIp, operStatus=operStatus, ddminfo=ddminfo, hostname=hostname, bias=bias, portStatEntry=portStatEntry, portEntry=portEntry, fcsErrorReceived=fcsErrorReceived, vlanid=vlanid, speed=speed, qos=qos, lanportTable=lanportTable, jumblan2=jumblan2, portName=portName, txPower=txPower, port3=port3, serialnum=serialnum, lanportpause=lanportpause, groupid=groupid, staticIpAddr=staticIpAddr, adminStatus=adminStatus, rebootEnable=rebootEnable, modeEntry=modeEntry, portIndex=portIndex, staticDns=staticDns, port2=port2, tftp=tftp, reboot=reboot, staticIpSecondaryDns=staticIpSecondaryDns, pauseTransmitted=pauseTransmitted, port4=port4, jumblan3=jumblan3, deviceinfo=deviceinfo, dscpEnable=dscpEnable, qmode=qmode, domainame=domainame, wan=wan, qosEntry=qosEntry, lan3=lan3, primaryDns=primaryDns, lanportspeed=lanportspeed, broadcastsReceived=broadcastsReceived, jumbwan=jumbwan, fileType=fileType, vendorPn=vendorPn, broadcastsTransmitted=broadcastsTransmitted, action=action, statIndex=statIndex, pauseReceived=pauseReceived, priority=priority, internetPort=internetPort, temperature=temperature, staticIpSubMask=staticIpSubMask, vendorRev=vendorRev, statisticTable=statisticTable, staticIpHostName=staticIpHostName, staticIpGateway=staticIpGateway, port1=port1, jumblan4=jumblan4, vlangroupTable=vlangroupTable, jumb=jumb, wanType=wanType, vlan=vlan, qmapping=qmapping, portStatistic=portStatistic, unicastsTransmitted=unicastsTransmitted, jumblan1=jumblan1)
