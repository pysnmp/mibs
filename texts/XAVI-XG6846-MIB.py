...
Counter32, Integer32, Bits, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, snmpModules, mib_2, Counter64, iso, ModuleIdentity, Gauge32, IpAddress, NotificationType, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Bits", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "snmpModules", "mib-2", "Counter64", "iso", "ModuleIdentity", "Gauge32", "IpAddress", "NotificationType", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileName=fileName, unicastsTransmitted=unicastsTransmitted, port4=port4, unicastsReceived=unicastsReceived, internetPort=internetPort, pauseTransmitted=pauseTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, staticIpAddr=staticIpAddr, ddminfo=ddminfo, qosTable=qosTable, qmode=qmode, staticIpDomainName=staticIpDomainName, lan1=lan1, catv=catv, qosEntry=qosEntry, groupid=groupid, staticIpSubMask=staticIpSubMask, portPower=portPower, qos=qos, qmapping=qmapping, fileType=fileType, staticDns=staticDns, hostname=hostname, portIndex=portIndex, port2=port2, fcsErrorReceived=fcsErrorReceived, deviceinfo=deviceinfo, adminStatus=adminStatus, statIndex=statIndex, vlanid=vlanid, pauseReceived=pauseReceived, vendorOui=vendorOui, domainame=domainame, rxPower=rxPower, vendorRev=vendorRev, action=action, portmode=portmode, secondaryDns=secondaryDns, jumblan4=jumblan4, fcsErrorTransmitted=fcsErrorTransmitted, wan=wan, vendorName=vendorName, txPower=txPower, modeEntry=modeEntry, bias=bias, jumbwan=jumbwan, priority=priority, lanportpause=lanportpause, vendorPn=vendorPn, tftpSevIp=tftpSevIp, portStatEntry=portStatEntry, vlan=vlan, portStatistic=portStatistic, staticIpPrimaryDns=staticIpPrimaryDns, statisticTable=statisticTable, staticIpGateway=staticIpGateway, lanportName=lanportName, portName=portName, broadcastsTransmitted=broadcastsTransmitted, catvEnable=catvEnable, broadcastsReceived=broadcastsReceived, portTable=portTable, portEntry=portEntry, jumblan2=jumblan2, serialnum=serialnum, multicastsTransmitted=multicastsTransmitted, voltage=voltage, jumb=jumb, lanportspeed=lanportspeed, groupEntry=groupEntry, jumblan3=jumblan3, lanportIndex=lanportIndex, vlangroupTable=vlangroupTable, staticIpHostName=staticIpHostName, wanType=wanType, multicastsReceived=multicastsReceived, lanportTable=lanportTable, groupIndex=groupIndex, dscpEnable=dscpEnable, jumblan1=jumblan1, primaryDns=primaryDns, qosIndex=qosIndex, lan3=lan3, reboot=reboot, port1=port1, port3=port3, lan2=lan2, tftp=tftp, xg6846=xg6846, lan4=lan4, speed=speed, temperature=temperature, rebootEnable=rebootEnable, operStatus=operStatus)
