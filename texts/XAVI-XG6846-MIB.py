...
Unsigned32, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, MibIdentifier, Integer32, snmpModules, Counter64, NotificationType, mib_2, ObjectIdentity, Bits, iso, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Integer32", "snmpModules", "Counter64", "NotificationType", "mib-2", "ObjectIdentity", "Bits", "iso", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", bias=bias, domainame=domainame, vendorRev=vendorRev, qmode=qmode, secondaryDns=secondaryDns, hostname=hostname, portmode=portmode, statisticTable=statisticTable, qmapping=qmapping, reboot=reboot, lan4=lan4, dscpEnable=dscpEnable, groupid=groupid, staticDns=staticDns, broadcastsTransmitted=broadcastsTransmitted, qosEntry=qosEntry, staticIpHostName=staticIpHostName, internetPort=internetPort, operStatus=operStatus, unicastsReceived=unicastsReceived, modeEntry=modeEntry, jumb=jumb, statIndex=statIndex, vlanid=vlanid, lan3=lan3, groupEntry=groupEntry, fileName=fileName, serialnum=serialnum, deviceinfo=deviceinfo, vendorName=vendorName, port2=port2, portStatistic=portStatistic, tftp=tftp, lan2=lan2, lanportspeed=lanportspeed, broadcastsReceived=broadcastsReceived, port1=port1, wan=wan, port3=port3, xg6846=xg6846, wanType=wanType, fcsErrorTransmitted=fcsErrorTransmitted, jumblan2=jumblan2, portName=portName, primaryDns=primaryDns, staticIpGateway=staticIpGateway, staticIpPrimaryDns=staticIpPrimaryDns, rebootEnable=rebootEnable, vlangroupTable=vlangroupTable, temperature=temperature, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, voltage=voltage, jumbwan=jumbwan, tftpSevIp=tftpSevIp, portStatEntry=portStatEntry, pauseReceived=pauseReceived, jumblan3=jumblan3, qosIndex=qosIndex, staticIpDomainName=staticIpDomainName, txPower=txPower, adminStatus=adminStatus, staticIpAddr=staticIpAddr, lan1=lan1, multicastsTransmitted=multicastsTransmitted, vendorPn=vendorPn, fileType=fileType, unicastsTransmitted=unicastsTransmitted, lanportpause=lanportpause, pauseTransmitted=pauseTransmitted, portTable=portTable, port4=port4, lanportIndex=lanportIndex, qos=qos, lanportName=lanportName, portPower=portPower, speed=speed, jumblan4=jumblan4, ddminfo=ddminfo, lanportTable=lanportTable, qosTable=qosTable, catvEnable=catvEnable, rxPower=rxPower, portEntry=portEntry, priority=priority, portIndex=portIndex, vendorOui=vendorOui, action=action, groupIndex=groupIndex, vlan=vlan, fcsErrorReceived=fcsErrorReceived, multicastsReceived=multicastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, catv=catv)
