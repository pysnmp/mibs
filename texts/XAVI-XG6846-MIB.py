...
IpAddress, iso, mib_2, ModuleIdentity, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, ObjectIdentity, Counter64, MibIdentifier, Counter32, Unsigned32, NotificationType, enterprises, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "mib-2", "ModuleIdentity", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "ObjectIdentity", "Counter64", "MibIdentifier", "Counter32", "Unsigned32", "NotificationType", "enterprises", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsTransmitted=unicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, portTable=portTable, operStatus=operStatus, vendorPn=vendorPn, internetPort=internetPort, jumb=jumb, adminStatus=adminStatus, staticIpHostName=staticIpHostName, lanportName=lanportName, staticIpSubMask=staticIpSubMask, catvEnable=catvEnable, catv=catv, secondaryDns=secondaryDns, fcsErrorReceived=fcsErrorReceived, qosTable=qosTable, tftpSevIp=tftpSevIp, portPower=portPower, statisticTable=statisticTable, lan4=lan4, lanportIndex=lanportIndex, action=action, port4=port4, bias=bias, ddminfo=ddminfo, xg6846=xg6846, port1=port1, speed=speed, deviceinfo=deviceinfo, lan3=lan3, lanportTable=lanportTable, jumblan1=jumblan1, temperature=temperature, jumblan2=jumblan2, dscpEnable=dscpEnable, voltage=voltage, staticDns=staticDns, jumbwan=jumbwan, pauseTransmitted=pauseTransmitted, statIndex=statIndex, port3=port3, portName=portName, wan=wan, groupIndex=groupIndex, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, modeEntry=modeEntry, portEntry=portEntry, port2=port2, rebootEnable=rebootEnable, lan2=lan2, staticIpDomainName=staticIpDomainName, reboot=reboot, fileName=fileName, jumblan3=jumblan3, multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, fileType=fileType, qosEntry=qosEntry, domainame=domainame, portIndex=portIndex, lanportpause=lanportpause, broadcastsReceived=broadcastsReceived, qmode=qmode, unicastsReceived=unicastsReceived, staticIpAddr=staticIpAddr, lanportspeed=lanportspeed, vendorRev=vendorRev, portmode=portmode, primaryDns=primaryDns, jumblan4=jumblan4, priority=priority, wanType=wanType, lan1=lan1, qos=qos, vlan=vlan, portStatistic=portStatistic, qmapping=qmapping, vlanid=vlanid, qosIndex=qosIndex, vlangroupTable=vlangroupTable, vendorName=vendorName, staticIpGateway=staticIpGateway, rxPower=rxPower, txPower=txPower, portStatEntry=portStatEntry, multicastsReceived=multicastsReceived, pauseReceived=pauseReceived, staticIpSecondaryDns=staticIpSecondaryDns, tftp=tftp, groupid=groupid, groupEntry=groupEntry, serialnum=serialnum)
