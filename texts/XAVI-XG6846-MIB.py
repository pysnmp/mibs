...
# Produced by pysmi-1.1.8 at Sun Jan 16 01:04:15 2022
...
mib_2, MibIdentifier, iso, Bits, enterprises, NotificationType, snmpModules, Counter64, Integer32, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, ModuleIdentity, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibIdentifier", "iso", "Bits", "enterprises", "NotificationType", "snmpModules", "Counter64", "Integer32", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, portPower=portPower, secondaryDns=secondaryDns, fcsErrorReceived=fcsErrorReceived, vendorPn=vendorPn, groupIndex=groupIndex, adminStatus=adminStatus, staticIpDomainName=staticIpDomainName, port2=port2, port3=port3, groupid=groupid, staticIpSubMask=staticIpSubMask, groupEntry=groupEntry, portName=portName, vendorOui=vendorOui, jumb=jumb, lan3=lan3, txPower=txPower, catvEnable=catvEnable, wanType=wanType, unicastsReceived=unicastsReceived, statIndex=statIndex, rebootEnable=rebootEnable, jumblan3=jumblan3, reboot=reboot, ddminfo=ddminfo, primaryDns=primaryDns, lan4=lan4, lan2=lan2, rxPower=rxPower, portStatistic=portStatistic, vendorName=vendorName, lanportIndex=lanportIndex, tftp=tftp, xg6846=xg6846, staticIpHostName=staticIpHostName, serialnum=serialnum, vlanid=vlanid, internetPort=internetPort, dscpEnable=dscpEnable, portIndex=portIndex, lanportTable=lanportTable, broadcastsTransmitted=broadcastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, wan=wan, portmode=portmode, portTable=portTable, modeEntry=modeEntry, lanportName=lanportName, lanportpause=lanportpause, voltage=voltage, bias=bias, vlan=vlan, pauseReceived=pauseReceived, priority=priority, staticDns=staticDns, domainame=domainame, deviceinfo=deviceinfo, portEntry=portEntry, multicastsReceived=multicastsReceived, fileType=fileType, jumbwan=jumbwan, lan1=lan1, portStatEntry=portStatEntry, statisticTable=statisticTable, unicastsTransmitted=unicastsTransmitted, jumblan4=jumblan4, vendorRev=vendorRev, operStatus=operStatus, jumblan2=jumblan2, action=action, multicastsTransmitted=multicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, qosTable=qosTable, lanportspeed=lanportspeed, qos=qos, qosEntry=qosEntry, qosIndex=qosIndex, vlangroupTable=vlangroupTable, hostname=hostname, catv=catv, fcsErrorTransmitted=fcsErrorTransmitted, jumblan1=jumblan1, temperature=temperature, speed=speed, port4=port4, fileName=fileName, broadcastsReceived=broadcastsReceived, qmode=qmode, port1=port1, staticIpAddr=staticIpAddr, qmapping=qmapping)
