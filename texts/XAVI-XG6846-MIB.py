...
# Produced by pysmi-1.1.3 at Thu Dec  9 14:28:59 2021
...
ObjectIdentity, NotificationType, mib_2, Integer32, TimeTicks, Counter32, Counter64, Gauge32, ModuleIdentity, Bits, enterprises, snmpModules, iso, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "mib-2", "Integer32", "TimeTicks", "Counter32", "Counter64", "Gauge32", "ModuleIdentity", "Bits", "enterprises", "snmpModules", "iso", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportIndex=lanportIndex, fileType=fileType, groupIndex=groupIndex, internetPort=internetPort, rebootEnable=rebootEnable, statIndex=statIndex, portStatistic=portStatistic, modeEntry=modeEntry, txPower=txPower, vendorName=vendorName, groupid=groupid, hostname=hostname, broadcastsTransmitted=broadcastsTransmitted, bias=bias, lan1=lan1, serialnum=serialnum, jumb=jumb, vlan=vlan, deviceinfo=deviceinfo, action=action, vendorRev=vendorRev, portmode=portmode, groupEntry=groupEntry, portIndex=portIndex, tftpSevIp=tftpSevIp, portPower=portPower, staticIpSubMask=staticIpSubMask, wanType=wanType, staticIpDomainName=staticIpDomainName, speed=speed, adminStatus=adminStatus, multicastsTransmitted=multicastsTransmitted, port3=port3, unicastsReceived=unicastsReceived, pauseReceived=pauseReceived, staticIpSecondaryDns=staticIpSecondaryDns, statisticTable=statisticTable, fcsErrorReceived=fcsErrorReceived, priority=priority, staticDns=staticDns, wan=wan, lan3=lan3, dscpEnable=dscpEnable, pauseTransmitted=pauseTransmitted, vendorOui=vendorOui, qosIndex=qosIndex, portName=portName, domainame=domainame, qmode=qmode, qosTable=qosTable, fcsErrorTransmitted=fcsErrorTransmitted, vlangroupTable=vlangroupTable, rxPower=rxPower, ddminfo=ddminfo, lan4=lan4, jumblan2=jumblan2, catv=catv, catvEnable=catvEnable, lan2=lan2, lanportTable=lanportTable, jumblan1=jumblan1, voltage=voltage, secondaryDns=secondaryDns, portStatEntry=portStatEntry, operStatus=operStatus, portEntry=portEntry, tftp=tftp, lanportpause=lanportpause, fileName=fileName, qmapping=qmapping, port2=port2, port4=port4, lanportspeed=lanportspeed, staticIpGateway=staticIpGateway, qosEntry=qosEntry, staticIpPrimaryDns=staticIpPrimaryDns, vendorPn=vendorPn, reboot=reboot, jumblan4=jumblan4, temperature=temperature, qos=qos, primaryDns=primaryDns, unicastsTransmitted=unicastsTransmitted, lanportName=lanportName, broadcastsReceived=broadcastsReceived, xg6846=xg6846, portTable=portTable, vlanid=vlanid, staticIpHostName=staticIpHostName, port1=port1, jumblan3=jumblan3, jumbwan=jumbwan, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr)
