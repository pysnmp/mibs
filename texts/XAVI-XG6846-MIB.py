...
# Produced by pysmi-1.1.8 at Tue Feb  1 21:06:56 2022
...
TimeTicks, MibIdentifier, Integer32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, snmpModules, iso, Bits, Counter32, IpAddress, mib_2, Counter64, NotificationType, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Integer32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "snmpModules", "iso", "Bits", "Counter32", "IpAddress", "mib-2", "Counter64", "NotificationType", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportName=lanportName, fileName=fileName, txPower=txPower, modeEntry=modeEntry, vendorOui=vendorOui, staticDns=staticDns, vendorPn=vendorPn, lan1=lan1, jumb=jumb, qmode=qmode, jumblan4=jumblan4, operStatus=operStatus, statisticTable=statisticTable, internetPort=internetPort, lanportIndex=lanportIndex, vlan=vlan, portEntry=portEntry, tftpSevIp=tftpSevIp, qosIndex=qosIndex, portStatEntry=portStatEntry, hostname=hostname, catv=catv, deviceinfo=deviceinfo, bias=bias, vendorRev=vendorRev, fcsErrorTransmitted=fcsErrorTransmitted, staticIpAddr=staticIpAddr, lanportTable=lanportTable, lan3=lan3, staticIpPrimaryDns=staticIpPrimaryDns, qosEntry=qosEntry, domainame=domainame, rebootEnable=rebootEnable, speed=speed, lanportspeed=lanportspeed, vlangroupTable=vlangroupTable, portStatistic=portStatistic, temperature=temperature, unicastsTransmitted=unicastsTransmitted, wan=wan, staticIpHostName=staticIpHostName, staticIpSecondaryDns=staticIpSecondaryDns, tftp=tftp, portTable=portTable, voltage=voltage, groupIndex=groupIndex, multicastsTransmitted=multicastsTransmitted, multicastsReceived=multicastsReceived, vlanid=vlanid, primaryDns=primaryDns, xg6846=xg6846, catvEnable=catvEnable, portPower=portPower, jumbwan=jumbwan, statIndex=statIndex, jumblan1=jumblan1, wanType=wanType, jumblan3=jumblan3, staticIpSubMask=staticIpSubMask, port2=port2, dscpEnable=dscpEnable, pauseTransmitted=pauseTransmitted, ddminfo=ddminfo, unicastsReceived=unicastsReceived, qos=qos, serialnum=serialnum, reboot=reboot, port1=port1, lan4=lan4, portmode=portmode, fcsErrorReceived=fcsErrorReceived, broadcastsReceived=broadcastsReceived, groupid=groupid, staticIpGateway=staticIpGateway, groupEntry=groupEntry, portName=portName, fileType=fileType, portIndex=portIndex, jumblan2=jumblan2, action=action, pauseReceived=pauseReceived, port3=port3, qosTable=qosTable, lanportpause=lanportpause, secondaryDns=secondaryDns, staticIpDomainName=staticIpDomainName, qmapping=qmapping, vendorName=vendorName, adminStatus=adminStatus, priority=priority, port4=port4, lan2=lan2, broadcastsTransmitted=broadcastsTransmitted, rxPower=rxPower)
