...
NotificationType, iso, snmpModules, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter32, ModuleIdentity, MibIdentifier, Counter64, ObjectIdentity, enterprises, TimeTicks, Gauge32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "snmpModules", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter32", "ModuleIdentity", "MibIdentifier", "Counter64", "ObjectIdentity", "enterprises", "TimeTicks", "Gauge32", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorReceived=fcsErrorReceived, staticIpSecondaryDns=staticIpSecondaryDns, operStatus=operStatus, vendorRev=vendorRev, internetPort=internetPort, groupIndex=groupIndex, unicastsReceived=unicastsReceived, jumblan3=jumblan3, hostname=hostname, fcsErrorTransmitted=fcsErrorTransmitted, portStatEntry=portStatEntry, fileType=fileType, vlanid=vlanid, catvEnable=catvEnable, primaryDns=primaryDns, lan3=lan3, multicastsTransmitted=multicastsTransmitted, staticIpSubMask=staticIpSubMask, qos=qos, lan2=lan2, portTable=portTable, bias=bias, portIndex=portIndex, lan1=lan1, port1=port1, jumblan4=jumblan4, groupid=groupid, vendorOui=vendorOui, tftpSevIp=tftpSevIp, qosIndex=qosIndex, port4=port4, jumbwan=jumbwan, staticIpAddr=staticIpAddr, portEntry=portEntry, pauseReceived=pauseReceived, qosEntry=qosEntry, rebootEnable=rebootEnable, secondaryDns=secondaryDns, staticDns=staticDns, portPower=portPower, vlan=vlan, voltage=voltage, jumblan2=jumblan2, serialnum=serialnum, statIndex=statIndex, qmapping=qmapping, txPower=txPower, jumblan1=jumblan1, lan4=lan4, dscpEnable=dscpEnable, wanType=wanType, port3=port3, lanportspeed=lanportspeed, deviceinfo=deviceinfo, fileName=fileName, ddminfo=ddminfo, qosTable=qosTable, catv=catv, unicastsTransmitted=unicastsTransmitted, wan=wan, action=action, staticIpDomainName=staticIpDomainName, staticIpPrimaryDns=staticIpPrimaryDns, vlangroupTable=vlangroupTable, lanportpause=lanportpause, lanportTable=lanportTable, broadcastsReceived=broadcastsReceived, vendorName=vendorName, port2=port2, portName=portName, temperature=temperature, portmode=portmode, tftp=tftp, lanportIndex=lanportIndex, priority=priority, staticIpHostName=staticIpHostName, portStatistic=portStatistic, staticIpGateway=staticIpGateway, pauseTransmitted=pauseTransmitted, vendorPn=vendorPn, domainame=domainame, jumb=jumb, groupEntry=groupEntry, speed=speed, modeEntry=modeEntry, reboot=reboot, broadcastsTransmitted=broadcastsTransmitted, multicastsReceived=multicastsReceived, statisticTable=statisticTable, qmode=qmode, rxPower=rxPower, adminStatus=adminStatus, lanportName=lanportName, xg6846=xg6846)
