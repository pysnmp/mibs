...
MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, ModuleIdentity, iso, snmpModules, ObjectIdentity, enterprises, NotificationType, Counter64, IpAddress, Gauge32, TimeTicks, Integer32, MibIdentifier, Unsigned32, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "ModuleIdentity", "iso", "snmpModules", "ObjectIdentity", "enterprises", "NotificationType", "Counter64", "IpAddress", "Gauge32", "TimeTicks", "Integer32", "MibIdentifier", "Unsigned32", "Bits", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fcsErrorReceived=fcsErrorReceived, portmode=portmode, port3=port3, portName=portName, qosIndex=qosIndex, lanportspeed=lanportspeed, fileType=fileType, ddminfo=ddminfo, jumblan2=jumblan2, serialnum=serialnum, broadcastsReceived=broadcastsReceived, domainame=domainame, vlanid=vlanid, priority=priority, adminStatus=adminStatus, qosTable=qosTable, dscpEnable=dscpEnable, portStatEntry=portStatEntry, vlan=vlan, qosEntry=qosEntry, lanportName=lanportName, jumb=jumb, primaryDns=primaryDns, secondaryDns=secondaryDns, lan4=lan4, jumblan1=jumblan1, rebootEnable=rebootEnable, lanportTable=lanportTable, portPower=portPower, groupid=groupid, portTable=portTable, tftp=tftp, groupIndex=groupIndex, jumblan3=jumblan3, hostname=hostname, catvEnable=catvEnable, deviceinfo=deviceinfo, portStatistic=portStatistic, staticIpDomainName=staticIpDomainName, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, vlangroupTable=vlangroupTable, staticIpPrimaryDns=staticIpPrimaryDns, xg6846=xg6846, internetPort=internetPort, tftpSevIp=tftpSevIp, voltage=voltage, port2=port2, temperature=temperature, vendorRev=vendorRev, portEntry=portEntry, vendorPn=vendorPn, staticIpGateway=staticIpGateway, rxPower=rxPower, pauseTransmitted=pauseTransmitted, jumblan4=jumblan4, modeEntry=modeEntry, lan1=lan1, staticIpHostName=staticIpHostName, lanportpause=lanportpause, staticIpSubMask=staticIpSubMask, groupEntry=groupEntry, unicastsReceived=unicastsReceived, lan2=lan2, portIndex=portIndex, operStatus=operStatus, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, catv=catv, wan=wan, vendorName=vendorName, action=action, lan3=lan3, statisticTable=statisticTable, port1=port1, fcsErrorTransmitted=fcsErrorTransmitted, multicastsTransmitted=multicastsTransmitted, port4=port4, staticDns=staticDns, staticIpSecondaryDns=staticIpSecondaryDns, lanportIndex=lanportIndex, qos=qos, txPower=txPower, fileName=fileName, reboot=reboot, speed=speed, qmapping=qmapping, statIndex=statIndex, jumbwan=jumbwan, pauseReceived=pauseReceived, bias=bias, wanType=wanType)
