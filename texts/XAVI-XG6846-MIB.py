...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:56:30 2021
...
Unsigned32, TimeTicks, Counter32, IpAddress, mib_2, Bits, Gauge32, enterprises, snmpModules, MibIdentifier, Counter64, iso, ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "Counter32", "IpAddress", "mib-2", "Bits", "Gauge32", "enterprises", "snmpModules", "MibIdentifier", "Counter64", "iso", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlangroupTable=vlangroupTable, staticDns=staticDns, rxPower=rxPower, portStatEntry=portStatEntry, broadcastsReceived=broadcastsReceived, jumblan4=jumblan4, multicastsTransmitted=multicastsTransmitted, vendorRev=vendorRev, primaryDns=primaryDns, serialnum=serialnum, secondaryDns=secondaryDns, tftpSevIp=tftpSevIp, pauseTransmitted=pauseTransmitted, portmode=portmode, operStatus=operStatus, xg6846=xg6846, ddminfo=ddminfo, dscpEnable=dscpEnable, vendorPn=vendorPn, wanType=wanType, jumb=jumb, lanportpause=lanportpause, staticIpDomainName=staticIpDomainName, catv=catv, staticIpGateway=staticIpGateway, fcsErrorTransmitted=fcsErrorTransmitted, priority=priority, internetPort=internetPort, jumbwan=jumbwan, speed=speed, deviceinfo=deviceinfo, lan4=lan4, statIndex=statIndex, port1=port1, groupEntry=groupEntry, txPower=txPower, hostname=hostname, jumblan3=jumblan3, portEntry=portEntry, adminStatus=adminStatus, unicastsReceived=unicastsReceived, lan2=lan2, lanportTable=lanportTable, portIndex=portIndex, qosTable=qosTable, action=action, catvEnable=catvEnable, staticIpPrimaryDns=staticIpPrimaryDns, vlanid=vlanid, reboot=reboot, lanportIndex=lanportIndex, port3=port3, tftp=tftp, statisticTable=statisticTable, groupid=groupid, qosEntry=qosEntry, lan3=lan3, staticIpHostName=staticIpHostName, qos=qos, groupIndex=groupIndex, lan1=lan1, lanportName=lanportName, voltage=voltage, bias=bias, staticIpSecondaryDns=staticIpSecondaryDns, vendorName=vendorName, unicastsTransmitted=unicastsTransmitted, lanportspeed=lanportspeed, vlan=vlan, portStatistic=portStatistic, qmapping=qmapping, port4=port4, staticIpAddr=staticIpAddr, broadcastsTransmitted=broadcastsTransmitted, fileType=fileType, qmode=qmode, fileName=fileName, vendorOui=vendorOui, rebootEnable=rebootEnable, jumblan1=jumblan1, portPower=portPower, portName=portName, pauseReceived=pauseReceived, port2=port2, qosIndex=qosIndex, temperature=temperature, wan=wan, fcsErrorReceived=fcsErrorReceived, staticIpSubMask=staticIpSubMask, jumblan2=jumblan2, portTable=portTable, domainame=domainame, modeEntry=modeEntry, multicastsReceived=multicastsReceived)
