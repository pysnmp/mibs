...
# Produced by pysmi-1.1.8 at Thu Jan  6 20:20:32 2022
...
Gauge32, ModuleIdentity, IpAddress, iso, Counter64, MibIdentifier, NotificationType, snmpModules, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Bits, ObjectIdentity, Integer32, mib_2, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "IpAddress", "iso", "Counter64", "MibIdentifier", "NotificationType", "snmpModules", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Bits", "ObjectIdentity", "Integer32", "mib-2", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statisticTable=statisticTable, staticDns=staticDns, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, broadcastsReceived=broadcastsReceived, groupIndex=groupIndex, lan1=lan1, jumblan3=jumblan3, portTable=portTable, serialnum=serialnum, vendorName=vendorName, vlangroupTable=vlangroupTable, hostname=hostname, jumb=jumb, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, wanType=wanType, port3=port3, fileName=fileName, staticIpDomainName=staticIpDomainName, vlan=vlan, port2=port2, qmapping=qmapping, ddminfo=ddminfo, fileType=fileType, lanportName=lanportName, jumbwan=jumbwan, temperature=temperature, lanportpause=lanportpause, fcsErrorTransmitted=fcsErrorTransmitted, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSecondaryDns=staticIpSecondaryDns, pauseTransmitted=pauseTransmitted, jumblan2=jumblan2, lanportspeed=lanportspeed, portPower=portPower, internetPort=internetPort, vendorOui=vendorOui, port4=port4, qosEntry=qosEntry, catvEnable=catvEnable, staticIpHostName=staticIpHostName, adminStatus=adminStatus, groupid=groupid, modeEntry=modeEntry, tftp=tftp, jumblan1=jumblan1, qosIndex=qosIndex, portEntry=portEntry, voltage=voltage, multicastsTransmitted=multicastsTransmitted, staticIpSubMask=staticIpSubMask, qmode=qmode, reboot=reboot, operStatus=operStatus, tftpSevIp=tftpSevIp, deviceinfo=deviceinfo, priority=priority, txPower=txPower, groupEntry=groupEntry, multicastsReceived=multicastsReceived, port1=port1, portName=portName, domainame=domainame, rxPower=rxPower, lan3=lan3, portStatistic=portStatistic, action=action, staticIpAddr=staticIpAddr, primaryDns=primaryDns, qosTable=qosTable, portmode=portmode, catv=catv, rebootEnable=rebootEnable, bias=bias, dscpEnable=dscpEnable, lanportIndex=lanportIndex, wan=wan, lan2=lan2, portIndex=portIndex, statIndex=statIndex, speed=speed, qos=qos, pauseReceived=pauseReceived, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, lan4=lan4, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, vendorPn=vendorPn, xg6846=xg6846, lanportTable=lanportTable, staticIpGateway=staticIpGateway)
