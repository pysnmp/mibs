...
snmpModules, Bits, Gauge32, ObjectIdentity, Integer32, ModuleIdentity, iso, Counter64, MibIdentifier, enterprises, TimeTicks, NotificationType, Unsigned32, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Bits", "Gauge32", "ObjectIdentity", "Integer32", "ModuleIdentity", "iso", "Counter64", "MibIdentifier", "enterprises", "TimeTicks", "NotificationType", "Unsigned32", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpDomainName=staticIpDomainName, jumblan4=jumblan4, staticIpGateway=staticIpGateway, portPower=portPower, deviceinfo=deviceinfo, portName=portName, domainame=domainame, secondaryDns=secondaryDns, vendorName=vendorName, lanportspeed=lanportspeed, unicastsTransmitted=unicastsTransmitted, action=action, voltage=voltage, internetPort=internetPort, lanportIndex=lanportIndex, jumb=jumb, vlan=vlan, staticIpSecondaryDns=staticIpSecondaryDns, portIndex=portIndex, staticIpAddr=staticIpAddr, portmode=portmode, fileType=fileType, statisticTable=statisticTable, vendorPn=vendorPn, jumblan3=jumblan3, speed=speed, statIndex=statIndex, fileName=fileName, jumblan1=jumblan1, lan3=lan3, tftpSevIp=tftpSevIp, qmode=qmode, dscpEnable=dscpEnable, qosTable=qosTable, tftp=tftp, staticIpSubMask=staticIpSubMask, ddminfo=ddminfo, rebootEnable=rebootEnable, lanportName=lanportName, wan=wan, jumbwan=jumbwan, lan2=lan2, wanType=wanType, portEntry=portEntry, port3=port3, portStatistic=portStatistic, broadcastsTransmitted=broadcastsTransmitted, bias=bias, portTable=portTable, txPower=txPower, fcsErrorTransmitted=fcsErrorTransmitted, catv=catv, portStatEntry=portStatEntry, unicastsReceived=unicastsReceived, serialnum=serialnum, port2=port2, lanportpause=lanportpause, groupid=groupid, catvEnable=catvEnable, qosIndex=qosIndex, pauseReceived=pauseReceived, fcsErrorReceived=fcsErrorReceived, vendorOui=vendorOui, lan1=lan1, broadcastsReceived=broadcastsReceived, multicastsTransmitted=multicastsTransmitted, vlangroupTable=vlangroupTable, vlanid=vlanid, lan4=lan4, rxPower=rxPower, qosEntry=qosEntry, port1=port1, staticDns=staticDns, port4=port4, jumblan2=jumblan2, lanportTable=lanportTable, qos=qos, xg6846=xg6846, temperature=temperature, reboot=reboot, groupIndex=groupIndex, groupEntry=groupEntry, staticIpPrimaryDns=staticIpPrimaryDns, pauseTransmitted=pauseTransmitted, multicastsReceived=multicastsReceived, vendorRev=vendorRev, staticIpHostName=staticIpHostName, modeEntry=modeEntry, hostname=hostname, adminStatus=adminStatus, primaryDns=primaryDns, priority=priority, qmapping=qmapping, operStatus=operStatus)
