...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:36:54 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ModuleIdentity, MibIdentifier, Counter64, mib_2, IpAddress, ObjectIdentity, NotificationType, TimeTicks, Bits, Counter32, iso, Gauge32, snmpModules, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Counter64", "mib-2", "IpAddress", "ObjectIdentity", "NotificationType", "TimeTicks", "Bits", "Counter32", "iso", "Gauge32", "snmpModules", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpSubMask=staticIpSubMask, lan1=lan1, vendorRev=vendorRev, qosTable=qosTable, jumblan2=jumblan2, port1=port1, port3=port3, qos=qos, multicastsReceived=multicastsReceived, jumblan3=jumblan3, portEntry=portEntry, qmode=qmode, lanportpause=lanportpause, qosIndex=qosIndex, groupid=groupid, bias=bias, broadcastsTransmitted=broadcastsTransmitted, vlanid=vlanid, multicastsTransmitted=multicastsTransmitted, portPower=portPower, modeEntry=modeEntry, serialnum=serialnum, fcsErrorTransmitted=fcsErrorTransmitted, staticDns=staticDns, lan4=lan4, wan=wan, action=action, fileType=fileType, portName=portName, speed=speed, portTable=portTable, jumbwan=jumbwan, lanportIndex=lanportIndex, rxPower=rxPower, primaryDns=primaryDns, operStatus=operStatus, qosEntry=qosEntry, groupIndex=groupIndex, port2=port2, portStatEntry=portStatEntry, reboot=reboot, dscpEnable=dscpEnable, txPower=txPower, tftp=tftp, tftpSevIp=tftpSevIp, groupEntry=groupEntry, jumblan1=jumblan1, staticIpGateway=staticIpGateway, statisticTable=statisticTable, pauseTransmitted=pauseTransmitted, portIndex=portIndex, priority=priority, wanType=wanType, vendorName=vendorName, portStatistic=portStatistic, jumb=jumb, rebootEnable=rebootEnable, vlan=vlan, staticIpSecondaryDns=staticIpSecondaryDns, staticIpDomainName=staticIpDomainName, vendorPn=vendorPn, voltage=voltage, xg6846=xg6846, pauseReceived=pauseReceived, lan2=lan2, lanportspeed=lanportspeed, port4=port4, statIndex=statIndex, jumblan4=jumblan4, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, fileName=fileName, staticIpHostName=staticIpHostName, vlangroupTable=vlangroupTable, temperature=temperature, deviceinfo=deviceinfo, adminStatus=adminStatus, hostname=hostname, staticIpAddr=staticIpAddr, unicastsTransmitted=unicastsTransmitted, catv=catv, unicastsReceived=unicastsReceived, internetPort=internetPort, lanportTable=lanportTable, vendorOui=vendorOui, domainame=domainame, ddminfo=ddminfo, qmapping=qmapping, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, catvEnable=catvEnable, lan3=lan3, portmode=portmode, broadcastsReceived=broadcastsReceived)
