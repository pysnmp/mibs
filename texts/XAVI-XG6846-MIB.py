...
# Produced by pysmi-1.1.8 at Mon Jan 17 17:57:14 2022
...
IpAddress, Bits, NotificationType, iso, Integer32, ModuleIdentity, enterprises, Gauge32, MibIdentifier, snmpModules, Counter64, ObjectIdentity, Unsigned32, Counter32, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "NotificationType", "iso", "Integer32", "ModuleIdentity", "enterprises", "Gauge32", "MibIdentifier", "snmpModules", "Counter64", "ObjectIdentity", "Unsigned32", "Counter32", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statisticTable=statisticTable, qos=qos, vendorName=vendorName, adminStatus=adminStatus, lan1=lan1, txPower=txPower, portStatistic=portStatistic, vendorPn=vendorPn, lan3=lan3, action=action, lan4=lan4, dscpEnable=dscpEnable, multicastsTransmitted=multicastsTransmitted, groupid=groupid, deviceinfo=deviceinfo, secondaryDns=secondaryDns, staticIpDomainName=staticIpDomainName, voltage=voltage, groupIndex=groupIndex, wanType=wanType, lanportIndex=lanportIndex, lanportspeed=lanportspeed, unicastsReceived=unicastsReceived, lan2=lan2, operStatus=operStatus, jumblan3=jumblan3, lanportTable=lanportTable, statIndex=statIndex, reboot=reboot, jumblan4=jumblan4, wan=wan, staticIpAddr=staticIpAddr, qmode=qmode, multicastsReceived=multicastsReceived, portmode=portmode, rxPower=rxPower, portEntry=portEntry, fcsErrorTransmitted=fcsErrorTransmitted, qmapping=qmapping, internetPort=internetPort, xg6846=xg6846, ddminfo=ddminfo, lanportName=lanportName, fileName=fileName, port4=port4, port1=port1, tftpSevIp=tftpSevIp, broadcastsTransmitted=broadcastsTransmitted, portPower=portPower, jumblan2=jumblan2, staticDns=staticDns, hostname=hostname, speed=speed, temperature=temperature, port2=port2, portTable=portTable, portIndex=portIndex, lanportpause=lanportpause, catvEnable=catvEnable, jumblan1=jumblan1, portStatEntry=portStatEntry, priority=priority, vlanid=vlanid, catv=catv, domainame=domainame, primaryDns=primaryDns, staticIpPrimaryDns=staticIpPrimaryDns, tftp=tftp, modeEntry=modeEntry, fcsErrorReceived=fcsErrorReceived, pauseTransmitted=pauseTransmitted, pauseReceived=pauseReceived, vlangroupTable=vlangroupTable, qosIndex=qosIndex, qosEntry=qosEntry, fileType=fileType, staticIpSubMask=staticIpSubMask, serialnum=serialnum, qosTable=qosTable, jumb=jumb, broadcastsReceived=broadcastsReceived, bias=bias, rebootEnable=rebootEnable, port3=port3, portName=portName, jumbwan=jumbwan, staticIpHostName=staticIpHostName, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, staticIpSecondaryDns=staticIpSecondaryDns, vlan=vlan, groupEntry=groupEntry, vendorRev=vendorRev, vendorOui=vendorOui)
