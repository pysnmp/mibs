...
# Produced by pysmi-1.1.8 at Thu Sep  7 12:03:26 2023
...
Gauge32, Integer32, ObjectIdentity, snmpModules, MibIdentifier, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, iso, Unsigned32, mib_2, Bits, ModuleIdentity, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "ObjectIdentity", "snmpModules", "MibIdentifier", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "iso", "Unsigned32", "mib-2", "Bits", "ModuleIdentity", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatEntry=portStatEntry, statIndex=statIndex, lanportTable=lanportTable, portmode=portmode, vendorRev=vendorRev, jumblan3=jumblan3, vlan=vlan, groupEntry=groupEntry, voltage=voltage, qosIndex=qosIndex, ddminfo=ddminfo, lan2=lan2, staticIpAddr=staticIpAddr, portEntry=portEntry, adminStatus=adminStatus, primaryDns=primaryDns, deviceinfo=deviceinfo, reboot=reboot, staticIpPrimaryDns=staticIpPrimaryDns, jumb=jumb, rebootEnable=rebootEnable, fileType=fileType, action=action, pauseReceived=pauseReceived, priority=priority, qmapping=qmapping, domainame=domainame, jumblan1=jumblan1, lan3=lan3, lanportIndex=lanportIndex, bias=bias, catvEnable=catvEnable, statisticTable=statisticTable, xg6846=xg6846, staticIpSubMask=staticIpSubMask, rxPower=rxPower, serialnum=serialnum, portName=portName, portStatistic=portStatistic, dscpEnable=dscpEnable, modeEntry=modeEntry, catv=catv, internetPort=internetPort, temperature=temperature, vlanid=vlanid, lanportName=lanportName, port1=port1, lan4=lan4, fcsErrorTransmitted=fcsErrorTransmitted, unicastsReceived=unicastsReceived, groupIndex=groupIndex, portTable=portTable, broadcastsTransmitted=broadcastsTransmitted, vendorPn=vendorPn, staticIpHostName=staticIpHostName, jumblan2=jumblan2, fileName=fileName, vlangroupTable=vlangroupTable, qosTable=qosTable, wanType=wanType, txPower=txPower, lanportpause=lanportpause, staticIpSecondaryDns=staticIpSecondaryDns, port2=port2, multicastsTransmitted=multicastsTransmitted, qmode=qmode, staticDns=staticDns, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, staticIpDomainName=staticIpDomainName, operStatus=operStatus, qosEntry=qosEntry, groupid=groupid, portIndex=portIndex, hostname=hostname, tftp=tftp, lanportspeed=lanportspeed, staticIpGateway=staticIpGateway, port3=port3, jumblan4=jumblan4, speed=speed, pauseTransmitted=pauseTransmitted, unicastsTransmitted=unicastsTransmitted, qos=qos, port4=port4, broadcastsReceived=broadcastsReceived, vendorOui=vendorOui, lan1=lan1, vendorName=vendorName, jumbwan=jumbwan, wan=wan, tftpSevIp=tftpSevIp, portPower=portPower, multicastsReceived=multicastsReceived)
