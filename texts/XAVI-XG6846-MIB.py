...
# Produced by pysmi-1.1.8 at Tue Jul 26 16:45:25 2022
...
MibIdentifier, iso, Gauge32, ObjectIdentity, TimeTicks, Bits, Integer32, Counter64, IpAddress, mib_2, Unsigned32, snmpModules, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Gauge32", "ObjectIdentity", "TimeTicks", "Bits", "Integer32", "Counter64", "IpAddress", "mib-2", "Unsigned32", "snmpModules", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", domainame=domainame, speed=speed, action=action, qosIndex=qosIndex, txPower=txPower, hostname=hostname, wan=wan, ddminfo=ddminfo, tftp=tftp, rebootEnable=rebootEnable, staticIpGateway=staticIpGateway, multicastsTransmitted=multicastsTransmitted, catvEnable=catvEnable, portStatistic=portStatistic, modeEntry=modeEntry, port2=port2, groupEntry=groupEntry, qosEntry=qosEntry, broadcastsReceived=broadcastsReceived, portTable=portTable, staticIpPrimaryDns=staticIpPrimaryDns, pauseReceived=pauseReceived, voltage=voltage, fcsErrorTransmitted=fcsErrorTransmitted, vlan=vlan, adminStatus=adminStatus, port4=port4, temperature=temperature, vendorRev=vendorRev, jumbwan=jumbwan, pauseTransmitted=pauseTransmitted, wanType=wanType, portEntry=portEntry, lanportTable=lanportTable, staticIpSubMask=staticIpSubMask, qmode=qmode, lan1=lan1, priority=priority, fileType=fileType, staticIpHostName=staticIpHostName, jumblan1=jumblan1, operStatus=operStatus, staticIpAddr=staticIpAddr, lanportIndex=lanportIndex, multicastsReceived=multicastsReceived, tftpSevIp=tftpSevIp, portmode=portmode, jumblan3=jumblan3, portStatEntry=portStatEntry, lan3=lan3, vendorPn=vendorPn, internetPort=internetPort, serialnum=serialnum, staticIpSecondaryDns=staticIpSecondaryDns, portName=portName, fcsErrorReceived=fcsErrorReceived, primaryDns=primaryDns, vlanid=vlanid, staticDns=staticDns, qos=qos, catv=catv, reboot=reboot, portIndex=portIndex, lan2=lan2, bias=bias, deviceinfo=deviceinfo, jumblan2=jumblan2, port1=port1, rxPower=rxPower, lan4=lan4, fileName=fileName, xg6846=xg6846, qmapping=qmapping, unicastsTransmitted=unicastsTransmitted, vlangroupTable=vlangroupTable, qosTable=qosTable, unicastsReceived=unicastsReceived, lanportName=lanportName, groupIndex=groupIndex, broadcastsTransmitted=broadcastsTransmitted, secondaryDns=secondaryDns, groupid=groupid, vendorOui=vendorOui, vendorName=vendorName, port3=port3, lanportspeed=lanportspeed, lanportpause=lanportpause, jumblan4=jumblan4, portPower=portPower, statisticTable=statisticTable, statIndex=statIndex, jumb=jumb, staticIpDomainName=staticIpDomainName, dscpEnable=dscpEnable)
