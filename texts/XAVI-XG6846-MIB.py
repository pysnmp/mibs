...
Gauge32, TimeTicks, Counter32, snmpModules, MibIdentifier, Unsigned32, IpAddress, mib_2, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity, Integer32, ModuleIdentity, iso, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "TimeTicks", "Counter32", "snmpModules", "MibIdentifier", "Unsigned32", "IpAddress", "mib-2", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity", "Integer32", "ModuleIdentity", "iso", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileType=fileType, jumbwan=jumbwan, fcsErrorTransmitted=fcsErrorTransmitted, internetPort=internetPort, portmode=portmode, portEntry=portEntry, portStatistic=portStatistic, pauseReceived=pauseReceived, vendorOui=vendorOui, port3=port3, portTable=portTable, lan3=lan3, bias=bias, lanportIndex=lanportIndex, priority=priority, unicastsTransmitted=unicastsTransmitted, port1=port1, lanportTable=lanportTable, staticIpGateway=staticIpGateway, lan4=lan4, xg6846=xg6846, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, vlan=vlan, secondaryDns=secondaryDns, jumblan2=jumblan2, portStatEntry=portStatEntry, pauseTransmitted=pauseTransmitted, deviceinfo=deviceinfo, qmapping=qmapping, adminStatus=adminStatus, qmode=qmode, groupid=groupid, staticIpPrimaryDns=staticIpPrimaryDns, multicastsTransmitted=multicastsTransmitted, dscpEnable=dscpEnable, staticIpHostName=staticIpHostName, broadcastsReceived=broadcastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, jumblan3=jumblan3, portIndex=portIndex, voltage=voltage, jumblan4=jumblan4, jumblan1=jumblan1, tftpSevIp=tftpSevIp, ddminfo=ddminfo, vlanid=vlanid, multicastsReceived=multicastsReceived, groupEntry=groupEntry, primaryDns=primaryDns, fcsErrorReceived=fcsErrorReceived, port4=port4, temperature=temperature, tftp=tftp, lan1=lan1, speed=speed, qosIndex=qosIndex, vendorName=vendorName, wanType=wanType, qosTable=qosTable, vendorPn=vendorPn, rebootEnable=rebootEnable, port2=port2, lanportpause=lanportpause, serialnum=serialnum, catv=catv, portName=portName, jumb=jumb, action=action, rxPower=rxPower, staticIpAddr=staticIpAddr, fileName=fileName, catvEnable=catvEnable, portPower=portPower, operStatus=operStatus, vendorRev=vendorRev, unicastsReceived=unicastsReceived, wan=wan, qosEntry=qosEntry, domainame=domainame, staticDns=staticDns, lanportspeed=lanportspeed, vlangroupTable=vlangroupTable, groupIndex=groupIndex, reboot=reboot, qos=qos, modeEntry=modeEntry, lan2=lan2, statIndex=statIndex, staticIpDomainName=staticIpDomainName, lanportName=lanportName, txPower=txPower, staticIpSubMask=staticIpSubMask, statisticTable=statisticTable)
