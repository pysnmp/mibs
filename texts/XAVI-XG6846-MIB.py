...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:51:37 2022
...
Unsigned32, ModuleIdentity, snmpModules, Gauge32, Counter64, mib_2, Integer32, Bits, TimeTicks, enterprises, iso, ObjectIdentity, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "snmpModules", "Gauge32", "Counter64", "mib-2", "Integer32", "Bits", "TimeTicks", "enterprises", "iso", "ObjectIdentity", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorName=vendorName, qos=qos, staticIpPrimaryDns=staticIpPrimaryDns, lanportspeed=lanportspeed, txPower=txPower, portTable=portTable, qmapping=qmapping, multicastsTransmitted=multicastsTransmitted, portName=portName, portIndex=portIndex, tftpSevIp=tftpSevIp, port3=port3, statIndex=statIndex, pauseTransmitted=pauseTransmitted, rxPower=rxPower, lan3=lan3, dscpEnable=dscpEnable, vendorPn=vendorPn, staticIpGateway=staticIpGateway, lan1=lan1, action=action, port1=port1, statisticTable=statisticTable, operStatus=operStatus, xg6846=xg6846, staticIpAddr=staticIpAddr, internetPort=internetPort, tftp=tftp, vlangroupTable=vlangroupTable, jumblan3=jumblan3, broadcastsTransmitted=broadcastsTransmitted, broadcastsReceived=broadcastsReceived, unicastsTransmitted=unicastsTransmitted, qosIndex=qosIndex, groupEntry=groupEntry, port4=port4, deviceinfo=deviceinfo, qmode=qmode, staticIpDomainName=staticIpDomainName, lan2=lan2, vlan=vlan, lanportTable=lanportTable, staticIpSecondaryDns=staticIpSecondaryDns, port2=port2, ddminfo=ddminfo, catvEnable=catvEnable, vendorOui=vendorOui, staticIpHostName=staticIpHostName, fcsErrorReceived=fcsErrorReceived, multicastsReceived=multicastsReceived, portStatistic=portStatistic, jumb=jumb, staticIpSubMask=staticIpSubMask, qosEntry=qosEntry, secondaryDns=secondaryDns, speed=speed, wan=wan, serialnum=serialnum, modeEntry=modeEntry, groupid=groupid, pauseReceived=pauseReceived, catv=catv, voltage=voltage, fileType=fileType, groupIndex=groupIndex, temperature=temperature, vlanid=vlanid, lan4=lan4, lanportName=lanportName, lanportIndex=lanportIndex, adminStatus=adminStatus, jumblan4=jumblan4, fileName=fileName, portEntry=portEntry, qosTable=qosTable, wanType=wanType, rebootEnable=rebootEnable, hostname=hostname, portPower=portPower, jumblan1=jumblan1, vendorRev=vendorRev, staticDns=staticDns, portStatEntry=portStatEntry, bias=bias, reboot=reboot, jumbwan=jumbwan, primaryDns=primaryDns, priority=priority, jumblan2=jumblan2, fcsErrorTransmitted=fcsErrorTransmitted, lanportpause=lanportpause, domainame=domainame, unicastsReceived=unicastsReceived, portmode=portmode)
