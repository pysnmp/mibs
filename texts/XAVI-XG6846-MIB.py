...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, mib_2, iso, Bits, ObjectIdentity, snmpModules, Counter32, Integer32, Counter64, IpAddress, ModuleIdentity, Gauge32, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "mib-2", "iso", "Bits", "ObjectIdentity", "snmpModules", "Counter32", "Integer32", "Counter64", "IpAddress", "ModuleIdentity", "Gauge32", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port1=port1, adminStatus=adminStatus, staticIpHostName=staticIpHostName, primaryDns=primaryDns, staticIpAddr=staticIpAddr, staticIpSecondaryDns=staticIpSecondaryDns, rxPower=rxPower, qmapping=qmapping, port3=port3, portStatistic=portStatistic, vendorPn=vendorPn, portTable=portTable, jumblan1=jumblan1, multicastsTransmitted=multicastsTransmitted, wan=wan, staticIpDomainName=staticIpDomainName, staticDns=staticDns, lanportIndex=lanportIndex, rebootEnable=rebootEnable, pauseReceived=pauseReceived, portPower=portPower, lanportName=lanportName, staticIpSubMask=staticIpSubMask, vendorName=vendorName, groupid=groupid, catv=catv, vlan=vlan, vlanid=vlanid, portStatEntry=portStatEntry, unicastsTransmitted=unicastsTransmitted, operStatus=operStatus, portName=portName, portEntry=portEntry, staticIpPrimaryDns=staticIpPrimaryDns, bias=bias, lan4=lan4, xg6846=xg6846, dscpEnable=dscpEnable, lanportpause=lanportpause, broadcastsReceived=broadcastsReceived, lanportTable=lanportTable, voltage=voltage, deviceinfo=deviceinfo, temperature=temperature, secondaryDns=secondaryDns, speed=speed, statIndex=statIndex, tftp=tftp, statisticTable=statisticTable, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, qos=qos, pauseTransmitted=pauseTransmitted, qmode=qmode, port2=port2, serialnum=serialnum, jumblan2=jumblan2, jumblan3=jumblan3, lan3=lan3, ddminfo=ddminfo, jumblan4=jumblan4, jumb=jumb, fcsErrorTransmitted=fcsErrorTransmitted, qosEntry=qosEntry, reboot=reboot, groupEntry=groupEntry, qosTable=qosTable, groupIndex=groupIndex, qosIndex=qosIndex, port4=port4, vendorOui=vendorOui, modeEntry=modeEntry, lan2=lan2, priority=priority, hostname=hostname, catvEnable=catvEnable, vendorRev=vendorRev, fileName=fileName, fcsErrorReceived=fcsErrorReceived, internetPort=internetPort, txPower=txPower, lanportspeed=lanportspeed, multicastsReceived=multicastsReceived, lan1=lan1, vlangroupTable=vlangroupTable, broadcastsTransmitted=broadcastsTransmitted, portIndex=portIndex, portmode=portmode, action=action, wanType=wanType, fileType=fileType, tftpSevIp=tftpSevIp, jumbwan=jumbwan, domainame=domainame)
