...
Gauge32, snmpModules, mib_2, IpAddress, Integer32, enterprises, ModuleIdentity, ObjectIdentity, TimeTicks, MibIdentifier, NotificationType, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "snmpModules", "mib-2", "IpAddress", "Integer32", "enterprises", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", speed=speed, jumblan4=jumblan4, operStatus=operStatus, qos=qos, internetPort=internetPort, catvEnable=catvEnable, dscpEnable=dscpEnable, qmode=qmode, jumblan3=jumblan3, txPower=txPower, portEntry=portEntry, reboot=reboot, deviceinfo=deviceinfo, vlan=vlan, ddminfo=ddminfo, pauseReceived=pauseReceived, jumbwan=jumbwan, portmode=portmode, wan=wan, qosEntry=qosEntry, rebootEnable=rebootEnable, jumb=jumb, staticIpGateway=staticIpGateway, vlanid=vlanid, tftpSevIp=tftpSevIp, voltage=voltage, port2=port2, statIndex=statIndex, staticIpHostName=staticIpHostName, port4=port4, portStatistic=portStatistic, multicastsTransmitted=multicastsTransmitted, catv=catv, jumblan1=jumblan1, portPower=portPower, vendorPn=vendorPn, priority=priority, action=action, port3=port3, groupid=groupid, jumblan2=jumblan2, broadcastsTransmitted=broadcastsTransmitted, portTable=portTable, lanportspeed=lanportspeed, primaryDns=primaryDns, fileName=fileName, staticIpAddr=staticIpAddr, domainame=domainame, pauseTransmitted=pauseTransmitted, vendorRev=vendorRev, lanportIndex=lanportIndex, broadcastsReceived=broadcastsReceived, hostname=hostname, lanportpause=lanportpause, wanType=wanType, groupIndex=groupIndex, lan2=lan2, qosTable=qosTable, lan3=lan3, fileType=fileType, lanportName=lanportName, port1=port1, multicastsReceived=multicastsReceived, staticIpSubMask=staticIpSubMask, vlangroupTable=vlangroupTable, qosIndex=qosIndex, groupEntry=groupEntry, portName=portName, qmapping=qmapping, portStatEntry=portStatEntry, bias=bias, staticDns=staticDns, unicastsReceived=unicastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, staticIpDomainName=staticIpDomainName, portIndex=portIndex, statisticTable=statisticTable, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSecondaryDns=staticIpSecondaryDns, lanportTable=lanportTable, unicastsTransmitted=unicastsTransmitted, lan1=lan1, adminStatus=adminStatus, vendorName=vendorName, secondaryDns=secondaryDns, modeEntry=modeEntry, lan4=lan4, rxPower=rxPower, serialnum=serialnum, fcsErrorReceived=fcsErrorReceived, xg6846=xg6846, temperature=temperature, tftp=tftp, vendorOui=vendorOui)
