...
# Produced by pysmi-1.1.3 at Sun Nov 21 01:07:55 2021
...
IpAddress, Bits, Gauge32, snmpModules, ModuleIdentity, iso, ObjectIdentity, NotificationType, mib_2, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Integer32, MibIdentifier, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "Gauge32", "snmpModules", "ModuleIdentity", "iso", "ObjectIdentity", "NotificationType", "mib-2", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Integer32", "MibIdentifier", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", ddminfo=ddminfo, vendorName=vendorName, staticIpHostName=staticIpHostName, primaryDns=primaryDns, catvEnable=catvEnable, unicastsReceived=unicastsReceived, temperature=temperature, unicastsTransmitted=unicastsTransmitted, lan1=lan1, wanType=wanType, portmode=portmode, hostname=hostname, port1=port1, staticIpAddr=staticIpAddr, lanportspeed=lanportspeed, port4=port4, lanportTable=lanportTable, serialnum=serialnum, qos=qos, portIndex=portIndex, vlan=vlan, statisticTable=statisticTable, secondaryDns=secondaryDns, statIndex=statIndex, portName=portName, qosTable=qosTable, fcsErrorTransmitted=fcsErrorTransmitted, lanportpause=lanportpause, qmapping=qmapping, fileType=fileType, deviceinfo=deviceinfo, lan3=lan3, action=action, dscpEnable=dscpEnable, pauseTransmitted=pauseTransmitted, staticIpDomainName=staticIpDomainName, vlanid=vlanid, rebootEnable=rebootEnable, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, jumb=jumb, vendorPn=vendorPn, operStatus=operStatus, bias=bias, groupEntry=groupEntry, vendorOui=vendorOui, fileName=fileName, portPower=portPower, lanportIndex=lanportIndex, qosIndex=qosIndex, broadcastsTransmitted=broadcastsTransmitted, pauseReceived=pauseReceived, port3=port3, portTable=portTable, groupIndex=groupIndex, tftp=tftp, jumblan1=jumblan1, multicastsReceived=multicastsReceived, lanportName=lanportName, reboot=reboot, voltage=voltage, wan=wan, staticIpGateway=staticIpGateway, portStatEntry=portStatEntry, domainame=domainame, vendorRev=vendorRev, qmode=qmode, groupid=groupid, jumblan2=jumblan2, portStatistic=portStatistic, rxPower=rxPower, speed=speed, multicastsTransmitted=multicastsTransmitted, priority=priority, staticDns=staticDns, jumbwan=jumbwan, modeEntry=modeEntry, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, portEntry=portEntry, xg6846=xg6846, txPower=txPower, catv=catv, tftpSevIp=tftpSevIp, internetPort=internetPort, vlangroupTable=vlangroupTable, qosEntry=qosEntry, staticIpSecondaryDns=staticIpSecondaryDns, lan4=lan4, port2=port2, adminStatus=adminStatus, lan2=lan2)
