...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:32:03 2022
...
mib_2, enterprises, Integer32, ModuleIdentity, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, snmpModules, IpAddress, Bits, Gauge32, Unsigned32, NotificationType, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "enterprises", "Integer32", "ModuleIdentity", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "snmpModules", "IpAddress", "Bits", "Gauge32", "Unsigned32", "NotificationType", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportpause=lanportpause, lanportName=lanportName, fileType=fileType, ddminfo=ddminfo, vendorRev=vendorRev, tftp=tftp, pauseTransmitted=pauseTransmitted, vendorName=vendorName, vlanid=vlanid, groupEntry=groupEntry, staticDns=staticDns, portmode=portmode, broadcastsReceived=broadcastsReceived, rxPower=rxPower, staticIpGateway=staticIpGateway, wanType=wanType, vlangroupTable=vlangroupTable, catv=catv, adminStatus=adminStatus, operStatus=operStatus, jumbwan=jumbwan, vlan=vlan, lan3=lan3, lan2=lan2, modeEntry=modeEntry, portName=portName, port2=port2, qosEntry=qosEntry, port4=port4, jumblan4=jumblan4, internetPort=internetPort, jumblan3=jumblan3, jumb=jumb, wan=wan, staticIpDomainName=staticIpDomainName, jumblan1=jumblan1, port3=port3, serialnum=serialnum, statisticTable=statisticTable, vendorOui=vendorOui, statIndex=statIndex, staticIpAddr=staticIpAddr, portTable=portTable, qosTable=qosTable, txPower=txPower, staticIpHostName=staticIpHostName, secondaryDns=secondaryDns, qos=qos, rebootEnable=rebootEnable, catvEnable=catvEnable, portStatEntry=portStatEntry, lanportTable=lanportTable, fileName=fileName, speed=speed, voltage=voltage, portIndex=portIndex, unicastsReceived=unicastsReceived, priority=priority, staticIpSecondaryDns=staticIpSecondaryDns, reboot=reboot, fcsErrorTransmitted=fcsErrorTransmitted, tftpSevIp=tftpSevIp, lanportspeed=lanportspeed, portPower=portPower, hostname=hostname, port1=port1, lanportIndex=lanportIndex, qmapping=qmapping, pauseReceived=pauseReceived, deviceinfo=deviceinfo, fcsErrorReceived=fcsErrorReceived, portEntry=portEntry, jumblan2=jumblan2, multicastsTransmitted=multicastsTransmitted, staticIpSubMask=staticIpSubMask, lan4=lan4, domainame=domainame, qosIndex=qosIndex, unicastsTransmitted=unicastsTransmitted, groupIndex=groupIndex, multicastsReceived=multicastsReceived, groupid=groupid, primaryDns=primaryDns, lan1=lan1, qmode=qmode, temperature=temperature, staticIpPrimaryDns=staticIpPrimaryDns, portStatistic=portStatistic, dscpEnable=dscpEnable, broadcastsTransmitted=broadcastsTransmitted, vendorPn=vendorPn, xg6846=xg6846, action=action, bias=bias)
