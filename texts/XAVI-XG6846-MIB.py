...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:15:26 2022
...
Bits, ModuleIdentity, Counter64, snmpModules, Integer32, enterprises, iso, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Counter32, TimeTicks, MibIdentifier, mib_2, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Counter64", "snmpModules", "Integer32", "enterprises", "iso", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Counter32", "TimeTicks", "MibIdentifier", "mib-2", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsTransmitted=multicastsTransmitted, tftp=tftp, operStatus=operStatus, modeEntry=modeEntry, catv=catv, broadcastsReceived=broadcastsReceived, domainame=domainame, lanportspeed=lanportspeed, portmode=portmode, lan3=lan3, rxPower=rxPower, fileName=fileName, adminStatus=adminStatus, unicastsTransmitted=unicastsTransmitted, rebootEnable=rebootEnable, jumblan1=jumblan1, lanportName=lanportName, lan1=lan1, staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, primaryDns=primaryDns, serialnum=serialnum, multicastsReceived=multicastsReceived, portEntry=portEntry, staticIpSecondaryDns=staticIpSecondaryDns, qmapping=qmapping, xg6846=xg6846, ddminfo=ddminfo, portStatistic=portStatistic, vlangroupTable=vlangroupTable, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, tftpSevIp=tftpSevIp, jumblan4=jumblan4, statisticTable=statisticTable, reboot=reboot, port1=port1, dscpEnable=dscpEnable, jumblan3=jumblan3, staticIpDomainName=staticIpDomainName, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, groupEntry=groupEntry, qosIndex=qosIndex, wan=wan, staticIpSubMask=staticIpSubMask, lanportIndex=lanportIndex, lanportpause=lanportpause, staticIpGateway=staticIpGateway, vendorOui=vendorOui, vendorRev=vendorRev, staticIpHostName=staticIpHostName, priority=priority, unicastsReceived=unicastsReceived, port4=port4, pauseTransmitted=pauseTransmitted, groupid=groupid, portName=portName, qosTable=qosTable, speed=speed, jumb=jumb, port2=port2, lan4=lan4, catvEnable=catvEnable, vendorPn=vendorPn, jumbwan=jumbwan, jumblan2=jumblan2, lanportTable=lanportTable, fileType=fileType, staticIpAddr=staticIpAddr, temperature=temperature, qmode=qmode, portTable=portTable, lan2=lan2, deviceinfo=deviceinfo, statIndex=statIndex, bias=bias, qosEntry=qosEntry, fcsErrorTransmitted=fcsErrorTransmitted, txPower=txPower, wanType=wanType, pauseReceived=pauseReceived, qos=qos, portStatEntry=portStatEntry, action=action, portPower=portPower, hostname=hostname, groupIndex=groupIndex, vendorName=vendorName, vlan=vlan, voltage=voltage, internetPort=internetPort, secondaryDns=secondaryDns, port3=port3)
