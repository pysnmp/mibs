...
# Produced by pysmi-1.1.10 at Fri Feb 16 02:38:26 2024
...
Integer32, enterprises, iso, Unsigned32, TimeTicks, ObjectIdentity, Bits, Counter32, mib_2, Counter64, snmpModules, ModuleIdentity, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "iso", "Unsigned32", "TimeTicks", "ObjectIdentity", "Bits", "Counter32", "mib-2", "Counter64", "snmpModules", "ModuleIdentity", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan1=jumblan1, bias=bias, vendorPn=vendorPn, catv=catv, jumbwan=jumbwan, qos=qos, internetPort=internetPort, action=action, multicastsReceived=multicastsReceived, qmode=qmode, jumb=jumb, staticIpDomainName=staticIpDomainName, txPower=txPower, multicastsTransmitted=multicastsTransmitted, wanType=wanType, fcsErrorReceived=fcsErrorReceived, fileName=fileName, jumblan4=jumblan4, qosIndex=qosIndex, vlangroupTable=vlangroupTable, statIndex=statIndex, broadcastsReceived=broadcastsReceived, portStatistic=portStatistic, fcsErrorTransmitted=fcsErrorTransmitted, staticIpHostName=staticIpHostName, lan4=lan4, unicastsReceived=unicastsReceived, operStatus=operStatus, portName=portName, vendorOui=vendorOui, portEntry=portEntry, hostname=hostname, adminStatus=adminStatus, groupIndex=groupIndex, groupid=groupid, lanportTable=lanportTable, primaryDns=primaryDns, lan3=lan3, qosEntry=qosEntry, tftpSevIp=tftpSevIp, jumblan3=jumblan3, fileType=fileType, lanportpause=lanportpause, portmode=portmode, groupEntry=groupEntry, modeEntry=modeEntry, xg6846=xg6846, broadcastsTransmitted=broadcastsTransmitted, speed=speed, vlan=vlan, portPower=portPower, rxPower=rxPower, ddminfo=ddminfo, priority=priority, wan=wan, lanportName=lanportName, tftp=tftp, temperature=temperature, portStatEntry=portStatEntry, staticIpPrimaryDns=staticIpPrimaryDns, portTable=portTable, dscpEnable=dscpEnable, staticIpSubMask=staticIpSubMask, voltage=voltage, domainame=domainame, staticIpGateway=staticIpGateway, lanportIndex=lanportIndex, lanportspeed=lanportspeed, port1=port1, port4=port4, unicastsTransmitted=unicastsTransmitted, staticIpAddr=staticIpAddr, port3=port3, vendorRev=vendorRev, serialnum=serialnum, vendorName=vendorName, lan1=lan1, statisticTable=statisticTable, rebootEnable=rebootEnable, deviceinfo=deviceinfo, secondaryDns=secondaryDns, qmapping=qmapping, lan2=lan2, staticIpSecondaryDns=staticIpSecondaryDns, qosTable=qosTable, staticDns=staticDns, portIndex=portIndex, port2=port2, vlanid=vlanid, catvEnable=catvEnable, pauseReceived=pauseReceived, jumblan2=jumblan2, pauseTransmitted=pauseTransmitted, reboot=reboot)
