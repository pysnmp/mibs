...
# Produced by pysmi-1.1.8 at Mon Sep 19 08:08:20 2022
...
NotificationType, ModuleIdentity, IpAddress, iso, mib_2, Bits, TimeTicks, Gauge32, snmpModules, enterprises, Counter64, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "IpAddress", "iso", "mib-2", "Bits", "TimeTicks", "Gauge32", "snmpModules", "enterprises", "Counter64", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portStatistic=portStatistic, portPower=portPower, deviceinfo=deviceinfo, portStatEntry=portStatEntry, internetPort=internetPort, hostname=hostname, jumblan4=jumblan4, action=action, wan=wan, secondaryDns=secondaryDns, qos=qos, broadcastsReceived=broadcastsReceived, vlan=vlan, qosIndex=qosIndex, rebootEnable=rebootEnable, portName=portName, adminStatus=adminStatus, qosEntry=qosEntry, groupid=groupid, jumb=jumb, unicastsTransmitted=unicastsTransmitted, staticIpSubMask=staticIpSubMask, staticIpHostName=staticIpHostName, qmapping=qmapping, lanportIndex=lanportIndex, portTable=portTable, staticIpAddr=staticIpAddr, jumbwan=jumbwan, jumblan1=jumblan1, port2=port2, multicastsTransmitted=multicastsTransmitted, lanportspeed=lanportspeed, tftpSevIp=tftpSevIp, lan4=lan4, groupEntry=groupEntry, txPower=txPower, staticIpGateway=staticIpGateway, pauseTransmitted=pauseTransmitted, dscpEnable=dscpEnable, catvEnable=catvEnable, rxPower=rxPower, catv=catv, staticIpSecondaryDns=staticIpSecondaryDns, fileType=fileType, vendorRev=vendorRev, qmode=qmode, lan2=lan2, fcsErrorReceived=fcsErrorReceived, jumblan3=jumblan3, fileName=fileName, lanportpause=lanportpause, staticIpDomainName=staticIpDomainName, statIndex=statIndex, temperature=temperature, lanportTable=lanportTable, vlangroupTable=vlangroupTable, port1=port1, statisticTable=statisticTable, port4=port4, lanportName=lanportName, multicastsReceived=multicastsReceived, vendorOui=vendorOui, wanType=wanType, staticDns=staticDns, groupIndex=groupIndex, lan1=lan1, priority=priority, domainame=domainame, vlanid=vlanid, xg6846=xg6846, speed=speed, staticIpPrimaryDns=staticIpPrimaryDns, operStatus=operStatus, port3=port3, qosTable=qosTable, vendorPn=vendorPn, ddminfo=ddminfo, reboot=reboot, serialnum=serialnum, fcsErrorTransmitted=fcsErrorTransmitted, portIndex=portIndex, jumblan2=jumblan2, broadcastsTransmitted=broadcastsTransmitted, bias=bias, unicastsReceived=unicastsReceived, pauseReceived=pauseReceived, voltage=voltage, modeEntry=modeEntry, portmode=portmode, tftp=tftp, primaryDns=primaryDns, portEntry=portEntry, lan3=lan3, vendorName=vendorName)
