...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:28:31 2023
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, mib_2, Gauge32, ModuleIdentity, Counter64, ObjectIdentity, Integer32, Unsigned32, enterprises, Counter32, Bits, TimeTicks, MibIdentifier, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "mib-2", "Gauge32", "ModuleIdentity", "Counter64", "ObjectIdentity", "Integer32", "Unsigned32", "enterprises", "Counter32", "Bits", "TimeTicks", "MibIdentifier", "IpAddress", "iso")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", adminStatus=adminStatus, portEntry=portEntry, lanportpause=lanportpause, qmapping=qmapping, qosTable=qosTable, catv=catv, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, staticIpSubMask=staticIpSubMask, staticDns=staticDns, fcsErrorReceived=fcsErrorReceived, speed=speed, broadcastsReceived=broadcastsReceived, rxPower=rxPower, staticIpHostName=staticIpHostName, jumblan3=jumblan3, wanType=wanType, multicastsTransmitted=multicastsTransmitted, groupEntry=groupEntry, portIndex=portIndex, vendorRev=vendorRev, lanportTable=lanportTable, groupIndex=groupIndex, jumblan4=jumblan4, secondaryDns=secondaryDns, vendorOui=vendorOui, port4=port4, staticIpDomainName=staticIpDomainName, lan2=lan2, vlan=vlan, fileType=fileType, lanportName=lanportName, vlangroupTable=vlangroupTable, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, jumblan1=jumblan1, staticIpSecondaryDns=staticIpSecondaryDns, vendorPn=vendorPn, primaryDns=primaryDns, portStatEntry=portStatEntry, txPower=txPower, portStatistic=portStatistic, voltage=voltage, portName=portName, priority=priority, operStatus=operStatus, tftp=tftp, wan=wan, lan3=lan3, qos=qos, deviceinfo=deviceinfo, lanportIndex=lanportIndex, ddminfo=ddminfo, reboot=reboot, tftpSevIp=tftpSevIp, portTable=portTable, statIndex=statIndex, temperature=temperature, hostname=hostname, statisticTable=statisticTable, action=action, internetPort=internetPort, modeEntry=modeEntry, xg6846=xg6846, unicastsReceived=unicastsReceived, domainame=domainame, qosEntry=qosEntry, serialnum=serialnum, multicastsReceived=multicastsReceived, rebootEnable=rebootEnable, fileName=fileName, staticIpAddr=staticIpAddr, lan1=lan1, jumbwan=jumbwan, portmode=portmode, dscpEnable=dscpEnable, groupid=groupid, qmode=qmode, vendorName=vendorName, portPower=portPower, port3=port3, fcsErrorTransmitted=fcsErrorTransmitted, lanportspeed=lanportspeed, catvEnable=catvEnable, jumblan2=jumblan2, port1=port1, staticIpPrimaryDns=staticIpPrimaryDns, pauseReceived=pauseReceived, bias=bias, jumb=jumb, lan4=lan4, port2=port2, unicastsTransmitted=unicastsTransmitted)
