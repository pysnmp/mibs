...
# Produced by pysmi-1.1.8 at Fri Sep  8 08:03:34 2023
...
enterprises, TimeTicks, IpAddress, Counter32, iso, MibIdentifier, Unsigned32, ObjectIdentity, ModuleIdentity, Counter64, NotificationType, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, mib_2, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "IpAddress", "Counter32", "iso", "MibIdentifier", "Unsigned32", "ObjectIdentity", "ModuleIdentity", "Counter64", "NotificationType", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "mib-2", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statIndex=statIndex, pauseReceived=pauseReceived, operStatus=operStatus, qos=qos, groupEntry=groupEntry, fcsErrorReceived=fcsErrorReceived, vendorName=vendorName, jumblan1=jumblan1, lanportTable=lanportTable, staticIpSubMask=staticIpSubMask, statisticTable=statisticTable, portTable=portTable, serialnum=serialnum, qmapping=qmapping, portStatistic=portStatistic, ddminfo=ddminfo, staticIpDomainName=staticIpDomainName, lanportpause=lanportpause, qosEntry=qosEntry, rxPower=rxPower, wan=wan, vendorRev=vendorRev, jumblan4=jumblan4, lanportName=lanportName, qmode=qmode, portPower=portPower, groupid=groupid, fileType=fileType, catvEnable=catvEnable, lan1=lan1, vlangroupTable=vlangroupTable, staticIpSecondaryDns=staticIpSecondaryDns, action=action, broadcastsReceived=broadcastsReceived, port2=port2, adminStatus=adminStatus, lan3=lan3, pauseTransmitted=pauseTransmitted, vlanid=vlanid, domainame=domainame, jumb=jumb, dscpEnable=dscpEnable, vlan=vlan, temperature=temperature, staticIpAddr=staticIpAddr, portName=portName, unicastsReceived=unicastsReceived, port3=port3, qosTable=qosTable, bias=bias, vendorPn=vendorPn, portEntry=portEntry, rebootEnable=rebootEnable, staticIpPrimaryDns=staticIpPrimaryDns, groupIndex=groupIndex, jumbwan=jumbwan, lanportIndex=lanportIndex, staticIpHostName=staticIpHostName, priority=priority, qosIndex=qosIndex, jumblan3=jumblan3, jumblan2=jumblan2, txPower=txPower, vendorOui=vendorOui, wanType=wanType, port4=port4, catv=catv, hostname=hostname, fcsErrorTransmitted=fcsErrorTransmitted, portIndex=portIndex, portmode=portmode, portStatEntry=portStatEntry, fileName=fileName, lan2=lan2, tftp=tftp, internetPort=internetPort, lan4=lan4, staticDns=staticDns, tftpSevIp=tftpSevIp, multicastsTransmitted=multicastsTransmitted, unicastsTransmitted=unicastsTransmitted, primaryDns=primaryDns, lanportspeed=lanportspeed, secondaryDns=secondaryDns, reboot=reboot, modeEntry=modeEntry, deviceinfo=deviceinfo, staticIpGateway=staticIpGateway, multicastsReceived=multicastsReceived, voltage=voltage, xg6846=xg6846, port1=port1, speed=speed, broadcastsTransmitted=broadcastsTransmitted)
