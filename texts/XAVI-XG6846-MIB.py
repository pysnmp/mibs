...
# Produced by pysmi-1.1.8 at Fri Jul  8 08:04:46 2022
...
Integer32, iso, ModuleIdentity, Counter64, Gauge32, TimeTicks, Unsigned32, IpAddress, mib_2, NotificationType, enterprises, Counter32, ObjectIdentity, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "ModuleIdentity", "Counter64", "Gauge32", "TimeTicks", "Unsigned32", "IpAddress", "mib-2", "NotificationType", "enterprises", "Counter32", "ObjectIdentity", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portPower=portPower, jumb=jumb, staticIpSecondaryDns=staticIpSecondaryDns, modeEntry=modeEntry, qosEntry=qosEntry, serialnum=serialnum, vlan=vlan, portmode=portmode, catvEnable=catvEnable, qmode=qmode, tftp=tftp, fileType=fileType, groupid=groupid, jumblan3=jumblan3, portStatEntry=portStatEntry, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, portName=portName, staticIpAddr=staticIpAddr, vlanid=vlanid, lanportName=lanportName, portIndex=portIndex, staticIpHostName=staticIpHostName, speed=speed, staticIpDomainName=staticIpDomainName, portEntry=portEntry, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, lanportspeed=lanportspeed, lan1=lan1, qmapping=qmapping, txPower=txPower, vendorRev=vendorRev, ddminfo=ddminfo, broadcastsReceived=broadcastsReceived, fileName=fileName, qosIndex=qosIndex, lanportIndex=lanportIndex, lanportpause=lanportpause, vendorOui=vendorOui, hostname=hostname, vlangroupTable=vlangroupTable, fcsErrorTransmitted=fcsErrorTransmitted, voltage=voltage, port4=port4, vendorName=vendorName, wanType=wanType, tftpSevIp=tftpSevIp, action=action, deviceinfo=deviceinfo, operStatus=operStatus, port3=port3, domainame=domainame, groupEntry=groupEntry, secondaryDns=secondaryDns, adminStatus=adminStatus, staticIpSubMask=staticIpSubMask, multicastsReceived=multicastsReceived, groupIndex=groupIndex, staticIpGateway=staticIpGateway, jumblan1=jumblan1, unicastsReceived=unicastsReceived, vendorPn=vendorPn, statisticTable=statisticTable, qos=qos, jumblan4=jumblan4, port1=port1, port2=port2, temperature=temperature, portTable=portTable, primaryDns=primaryDns, qosTable=qosTable, lanportTable=lanportTable, dscpEnable=dscpEnable, wan=wan, multicastsTransmitted=multicastsTransmitted, catv=catv, internetPort=internetPort, bias=bias, lan3=lan3, reboot=reboot, rxPower=rxPower, staticIpPrimaryDns=staticIpPrimaryDns, staticDns=staticDns, pauseReceived=pauseReceived, xg6846=xg6846, lan2=lan2, jumblan2=jumblan2, priority=priority, rebootEnable=rebootEnable, lan4=lan4, pauseTransmitted=pauseTransmitted, jumbwan=jumbwan, portStatistic=portStatistic)
