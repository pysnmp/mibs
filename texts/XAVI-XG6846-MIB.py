...
TimeTicks, iso, enterprises, Counter64, Counter32, MibIdentifier, mib_2, IpAddress, snmpModules, Gauge32, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "enterprises", "Counter64", "Counter32", "MibIdentifier", "mib-2", "IpAddress", "snmpModules", "Gauge32", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorName=vendorName, jumblan4=jumblan4, deviceinfo=deviceinfo, primaryDns=primaryDns, jumblan2=jumblan2, action=action, rxPower=rxPower, ddminfo=ddminfo, fcsErrorTransmitted=fcsErrorTransmitted, internetPort=internetPort, reboot=reboot, broadcastsTransmitted=broadcastsTransmitted, groupEntry=groupEntry, portTable=portTable, qos=qos, jumblan1=jumblan1, vlan=vlan, vlanid=vlanid, speed=speed, qosTable=qosTable, fileType=fileType, modeEntry=modeEntry, catv=catv, portStatistic=portStatistic, portPower=portPower, lan1=lan1, fileName=fileName, jumblan3=jumblan3, multicastsTransmitted=multicastsTransmitted, lan2=lan2, lan4=lan4, statIndex=statIndex, port4=port4, serialnum=serialnum, portName=portName, groupIndex=groupIndex, staticIpGateway=staticIpGateway, port1=port1, tftpSevIp=tftpSevIp, groupid=groupid, jumbwan=jumbwan, lan3=lan3, dscpEnable=dscpEnable, qosIndex=qosIndex, vlangroupTable=vlangroupTable, catvEnable=catvEnable, temperature=temperature, portStatEntry=portStatEntry, adminStatus=adminStatus, qmode=qmode, pauseTransmitted=pauseTransmitted, lanportpause=lanportpause, rebootEnable=rebootEnable, staticIpSecondaryDns=staticIpSecondaryDns, wan=wan, domainame=domainame, operStatus=operStatus, qosEntry=qosEntry, portmode=portmode, lanportTable=lanportTable, lanportName=lanportName, staticIpDomainName=staticIpDomainName, vendorOui=vendorOui, pauseReceived=pauseReceived, voltage=voltage, staticIpHostName=staticIpHostName, priority=priority, vendorRev=vendorRev, multicastsReceived=multicastsReceived, staticDns=staticDns, xg6846=xg6846, port3=port3, lanportspeed=lanportspeed, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, qmapping=qmapping, unicastsTransmitted=unicastsTransmitted, staticIpSubMask=staticIpSubMask, staticIpPrimaryDns=staticIpPrimaryDns, port2=port2, portIndex=portIndex, tftp=tftp, statisticTable=statisticTable, jumb=jumb, lanportIndex=lanportIndex, wanType=wanType, broadcastsReceived=broadcastsReceived, vendorPn=vendorPn, unicastsReceived=unicastsReceived, staticIpAddr=staticIpAddr, bias=bias, hostname=hostname, portEntry=portEntry, txPower=txPower)
