...
# Produced by pysmi-1.1.0 at Fri Nov 19 14:53:21 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, mib_2, TimeTicks, Bits, Integer32, snmpModules, IpAddress, NotificationType, Counter64, MibIdentifier, enterprises, iso, Gauge32, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "mib-2", "TimeTicks", "Bits", "Integer32", "snmpModules", "IpAddress", "NotificationType", "Counter64", "MibIdentifier", "enterprises", "iso", "Gauge32", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rxPower=rxPower, vendorRev=vendorRev, vlanid=vlanid, lanportTable=lanportTable, wan=wan, wanType=wanType, staticIpDomainName=staticIpDomainName, port3=port3, speed=speed, groupIndex=groupIndex, port2=port2, portmode=portmode, multicastsTransmitted=multicastsTransmitted, tftpSevIp=tftpSevIp, staticIpHostName=staticIpHostName, staticIpPrimaryDns=staticIpPrimaryDns, fileType=fileType, reboot=reboot, jumblan1=jumblan1, tftp=tftp, qosIndex=qosIndex, qmapping=qmapping, broadcastsReceived=broadcastsReceived, secondaryDns=secondaryDns, temperature=temperature, statisticTable=statisticTable, qosTable=qosTable, fcsErrorReceived=fcsErrorReceived, internetPort=internetPort, lan1=lan1, primaryDns=primaryDns, bias=bias, staticIpSubMask=staticIpSubMask, txPower=txPower, portStatistic=portStatistic, priority=priority, fcsErrorTransmitted=fcsErrorTransmitted, vendorPn=vendorPn, groupid=groupid, lan2=lan2, portTable=portTable, statIndex=statIndex, pauseReceived=pauseReceived, adminStatus=adminStatus, vendorName=vendorName, lanportIndex=lanportIndex, operStatus=operStatus, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, xg6846=xg6846, staticIpSecondaryDns=staticIpSecondaryDns, staticIpAddr=staticIpAddr, catv=catv, deviceinfo=deviceinfo, action=action, modeEntry=modeEntry, fileName=fileName, unicastsTransmitted=unicastsTransmitted, lan3=lan3, pauseTransmitted=pauseTransmitted, vlan=vlan, vendorOui=vendorOui, jumblan4=jumblan4, ddminfo=ddminfo, lan4=lan4, hostname=hostname, jumb=jumb, lanportspeed=lanportspeed, portName=portName, vlangroupTable=vlangroupTable, serialnum=serialnum, catvEnable=catvEnable, rebootEnable=rebootEnable, portEntry=portEntry, dscpEnable=dscpEnable, jumblan3=jumblan3, port1=port1, jumblan2=jumblan2, portPower=portPower, portIndex=portIndex, portStatEntry=portStatEntry, lanportName=lanportName, lanportpause=lanportpause, staticDns=staticDns, voltage=voltage, qos=qos, port4=port4, staticIpGateway=staticIpGateway, jumbwan=jumbwan, groupEntry=groupEntry, qosEntry=qosEntry, domainame=domainame, multicastsReceived=multicastsReceived, unicastsReceived=unicastsReceived)
