...
IpAddress, NotificationType, iso, Counter32, Unsigned32, enterprises, Gauge32, snmpModules, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, mib_2, Counter64, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "NotificationType", "iso", "Counter32", "Unsigned32", "enterprises", "Gauge32", "snmpModules", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "mib-2", "Counter64", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", action=action, staticIpSecondaryDns=staticIpSecondaryDns, hostname=hostname, staticDns=staticDns, tftpSevIp=tftpSevIp, vendorOui=vendorOui, portName=portName, wanType=wanType, secondaryDns=secondaryDns, staticIpAddr=staticIpAddr, broadcastsTransmitted=broadcastsTransmitted, unicastsReceived=unicastsReceived, statisticTable=statisticTable, xg6846=xg6846, groupEntry=groupEntry, fcsErrorReceived=fcsErrorReceived, pauseTransmitted=pauseTransmitted, jumblan3=jumblan3, staticIpGateway=staticIpGateway, portStatEntry=portStatEntry, vlanid=vlanid, vlangroupTable=vlangroupTable, fileType=fileType, pauseReceived=pauseReceived, port1=port1, multicastsReceived=multicastsReceived, temperature=temperature, jumblan2=jumblan2, voltage=voltage, primaryDns=primaryDns, lan1=lan1, lanportTable=lanportTable, txPower=txPower, port4=port4, vendorName=vendorName, tftp=tftp, operStatus=operStatus, reboot=reboot, ddminfo=ddminfo, vendorRev=vendorRev, catvEnable=catvEnable, multicastsTransmitted=multicastsTransmitted, lanportIndex=lanportIndex, rxPower=rxPower, statIndex=statIndex, jumbwan=jumbwan, adminStatus=adminStatus, qosIndex=qosIndex, bias=bias, qosEntry=qosEntry, serialnum=serialnum, rebootEnable=rebootEnable, portmode=portmode, groupIndex=groupIndex, lanportpause=lanportpause, staticIpDomainName=staticIpDomainName, portEntry=portEntry, qmode=qmode, lan3=lan3, broadcastsReceived=broadcastsReceived, port2=port2, dscpEnable=dscpEnable, deviceinfo=deviceinfo, qosTable=qosTable, fcsErrorTransmitted=fcsErrorTransmitted, fileName=fileName, lan2=lan2, domainame=domainame, modeEntry=modeEntry, priority=priority, groupid=groupid, staticIpSubMask=staticIpSubMask, vendorPn=vendorPn, port3=port3, qos=qos, internetPort=internetPort, qmapping=qmapping, staticIpPrimaryDns=staticIpPrimaryDns, lanportspeed=lanportspeed, catv=catv, wan=wan, portTable=portTable, speed=speed, staticIpHostName=staticIpHostName, portPower=portPower, lan4=lan4, jumblan1=jumblan1, jumblan4=jumblan4, portIndex=portIndex, lanportName=lanportName, jumb=jumb, portStatistic=portStatistic, vlan=vlan, unicastsTransmitted=unicastsTransmitted)
