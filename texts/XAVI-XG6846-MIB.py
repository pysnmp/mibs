...
TimeTicks, Counter64, Unsigned32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Integer32, iso, Counter32, ModuleIdentity, NotificationType, IpAddress, MibIdentifier, Bits, snmpModules, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Unsigned32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Integer32", "iso", "Counter32", "ModuleIdentity", "NotificationType", "IpAddress", "MibIdentifier", "Bits", "snmpModules", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", internetPort=internetPort, catvEnable=catvEnable, modeEntry=modeEntry, dscpEnable=dscpEnable, qmode=qmode, statIndex=statIndex, tftp=tftp, jumblan1=jumblan1, rxPower=rxPower, rebootEnable=rebootEnable, multicastsTransmitted=multicastsTransmitted, portmode=portmode, portTable=portTable, qosIndex=qosIndex, vendorPn=vendorPn, secondaryDns=secondaryDns, staticIpSubMask=staticIpSubMask, hostname=hostname, reboot=reboot, portIndex=portIndex, staticIpAddr=staticIpAddr, fileName=fileName, vendorRev=vendorRev, portStatEntry=portStatEntry, fileType=fileType, tftpSevIp=tftpSevIp, jumblan2=jumblan2, staticIpDomainName=staticIpDomainName, port1=port1, multicastsReceived=multicastsReceived, port2=port2, priority=priority, ddminfo=ddminfo, voltage=voltage, jumblan4=jumblan4, qosTable=qosTable, lanportIndex=lanportIndex, lan3=lan3, action=action, lanportpause=lanportpause, unicastsReceived=unicastsReceived, jumb=jumb, wanType=wanType, staticIpGateway=staticIpGateway, lan1=lan1, qosEntry=qosEntry, staticIpPrimaryDns=staticIpPrimaryDns, xg6846=xg6846, temperature=temperature, pauseReceived=pauseReceived, port3=port3, portEntry=portEntry, primaryDns=primaryDns, deviceinfo=deviceinfo, groupIndex=groupIndex, portPower=portPower, groupEntry=groupEntry, staticIpHostName=staticIpHostName, lan2=lan2, wan=wan, vlan=vlan, portName=portName, lanportName=lanportName, qos=qos, catv=catv, port4=port4, domainame=domainame, staticDns=staticDns, txPower=txPower, broadcastsReceived=broadcastsReceived, groupid=groupid, statisticTable=statisticTable, portStatistic=portStatistic, adminStatus=adminStatus, staticIpSecondaryDns=staticIpSecondaryDns, unicastsTransmitted=unicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, jumblan3=jumblan3, vendorOui=vendorOui, lanportspeed=lanportspeed, vendorName=vendorName, vlangroupTable=vlangroupTable, fcsErrorTransmitted=fcsErrorTransmitted, lan4=lan4, fcsErrorReceived=fcsErrorReceived, speed=speed, qmapping=qmapping, serialnum=serialnum, operStatus=operStatus, jumbwan=jumbwan, vlanid=vlanid, pauseTransmitted=pauseTransmitted, bias=bias, lanportTable=lanportTable)
