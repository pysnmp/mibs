...
enterprises, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, mib_2, Gauge32, Integer32, snmpModules, iso, NotificationType, ObjectIdentity, Counter64, MibIdentifier, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "mib-2", "Gauge32", "Integer32", "snmpModules", "iso", "NotificationType", "ObjectIdentity", "Counter64", "MibIdentifier", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port1=port1, rxPower=rxPower, qos=qos, catvEnable=catvEnable, domainame=domainame, vlan=vlan, staticIpSubMask=staticIpSubMask, temperature=temperature, jumb=jumb, lan1=lan1, jumblan2=jumblan2, qosTable=qosTable, pauseReceived=pauseReceived, portStatistic=portStatistic, portIndex=portIndex, staticIpDomainName=staticIpDomainName, voltage=voltage, staticIpGateway=staticIpGateway, bias=bias, statisticTable=statisticTable, primaryDns=primaryDns, lan3=lan3, vlangroupTable=vlangroupTable, wan=wan, groupIndex=groupIndex, lanportTable=lanportTable, qmode=qmode, fileName=fileName, qosEntry=qosEntry, lanportIndex=lanportIndex, staticIpHostName=staticIpHostName, portName=portName, multicastsReceived=multicastsReceived, fileType=fileType, pauseTransmitted=pauseTransmitted, jumblan3=jumblan3, wanType=wanType, portmode=portmode, deviceinfo=deviceinfo, vendorRev=vendorRev, groupEntry=groupEntry, adminStatus=adminStatus, txPower=txPower, vendorPn=vendorPn, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, jumblan1=jumblan1, serialnum=serialnum, staticIpAddr=staticIpAddr, hostname=hostname, port3=port3, xg6846=xg6846, fcsErrorTransmitted=fcsErrorTransmitted, groupid=groupid, modeEntry=modeEntry, lanportpause=lanportpause, port4=port4, staticDns=staticDns, action=action, rebootEnable=rebootEnable, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived, catv=catv, lanportName=lanportName, portTable=portTable, portPower=portPower, vendorOui=vendorOui, qosIndex=qosIndex, jumbwan=jumbwan, priority=priority, portStatEntry=portStatEntry, internetPort=internetPort, port2=port2, jumblan4=jumblan4, unicastsTransmitted=unicastsTransmitted, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, operStatus=operStatus, speed=speed, portEntry=portEntry, multicastsTransmitted=multicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, fcsErrorReceived=fcsErrorReceived, qmapping=qmapping, ddminfo=ddminfo, lanportspeed=lanportspeed, tftp=tftp, lan2=lan2, broadcastsReceived=broadcastsReceived, reboot=reboot, tftpSevIp=tftpSevIp, vendorName=vendorName, lan4=lan4, dscpEnable=dscpEnable)
