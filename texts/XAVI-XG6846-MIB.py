...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:04:53 2021
...
Counter64, iso, Unsigned32, NotificationType, mib_2, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, TimeTicks, Counter32, enterprises, ObjectIdentity, snmpModules, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Unsigned32", "NotificationType", "mib-2", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "TimeTicks", "Counter32", "enterprises", "ObjectIdentity", "snmpModules", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", domainame=domainame, fcsErrorReceived=fcsErrorReceived, speed=speed, catvEnable=catvEnable, portName=portName, multicastsTransmitted=multicastsTransmitted, portEntry=portEntry, statIndex=statIndex, staticIpSubMask=staticIpSubMask, adminStatus=adminStatus, primaryDns=primaryDns, multicastsReceived=multicastsReceived, lanportTable=lanportTable, voltage=voltage, lan1=lan1, port3=port3, lanportspeed=lanportspeed, operStatus=operStatus, jumblan3=jumblan3, vlanid=vlanid, staticIpDomainName=staticIpDomainName, groupIndex=groupIndex, lan2=lan2, internetPort=internetPort, qosIndex=qosIndex, fcsErrorTransmitted=fcsErrorTransmitted, qosTable=qosTable, tftpSevIp=tftpSevIp, broadcastsReceived=broadcastsReceived, staticIpSecondaryDns=staticIpSecondaryDns, portTable=portTable, qos=qos, groupid=groupid, jumblan2=jumblan2, lanportName=lanportName, unicastsReceived=unicastsReceived, staticIpHostName=staticIpHostName, jumbwan=jumbwan, statisticTable=statisticTable, rxPower=rxPower, vlangroupTable=vlangroupTable, txPower=txPower, jumblan4=jumblan4, tftp=tftp, serialnum=serialnum, lan4=lan4, reboot=reboot, port2=port2, qmapping=qmapping, jumb=jumb, rebootEnable=rebootEnable, jumblan1=jumblan1, modeEntry=modeEntry, wanType=wanType, portPower=portPower, wan=wan, vlan=vlan, qosEntry=qosEntry, secondaryDns=secondaryDns, pauseReceived=pauseReceived, pauseTransmitted=pauseTransmitted, vendorRev=vendorRev, unicastsTransmitted=unicastsTransmitted, lanportpause=lanportpause, vendorName=vendorName, lan3=lan3, xg6846=xg6846, catv=catv, deviceinfo=deviceinfo, action=action, ddminfo=ddminfo, qmode=qmode, groupEntry=groupEntry, broadcastsTransmitted=broadcastsTransmitted, lanportIndex=lanportIndex, staticIpGateway=staticIpGateway, dscpEnable=dscpEnable, portStatEntry=portStatEntry, fileName=fileName, fileType=fileType, temperature=temperature, priority=priority, vendorOui=vendorOui, staticIpAddr=staticIpAddr, portStatistic=portStatistic, staticDns=staticDns, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, portIndex=portIndex, portmode=portmode, vendorPn=vendorPn, hostname=hostname, bias=bias, port4=port4)
