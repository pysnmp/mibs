...
# Produced by pysmi-1.1.12 at Tue May 28 13:43:19 2024
...
Counter64, ModuleIdentity, TimeTicks, Bits, ObjectIdentity, enterprises, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Counter32, Unsigned32, MibIdentifier, mib_2, Gauge32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "TimeTicks", "Bits", "ObjectIdentity", "enterprises", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Counter32", "Unsigned32", "MibIdentifier", "mib-2", "Gauge32", "iso", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsReceived=multicastsReceived, groupid=groupid, temperature=temperature, lanportpause=lanportpause, wanType=wanType, bias=bias, primaryDns=primaryDns, xg6846=xg6846, broadcastsReceived=broadcastsReceived, vendorOui=vendorOui, portStatEntry=portStatEntry, lan3=lan3, pauseTransmitted=pauseTransmitted, jumblan3=jumblan3, staticIpPrimaryDns=staticIpPrimaryDns, vlangroupTable=vlangroupTable, speed=speed, portEntry=portEntry, pauseReceived=pauseReceived, lan2=lan2, staticIpSubMask=staticIpSubMask, serialnum=serialnum, vendorRev=vendorRev, jumblan2=jumblan2, statisticTable=statisticTable, secondaryDns=secondaryDns, internetPort=internetPort, tftpSevIp=tftpSevIp, catvEnable=catvEnable, vendorPn=vendorPn, fcsErrorReceived=fcsErrorReceived, statIndex=statIndex, catv=catv, vlan=vlan, port4=port4, voltage=voltage, hostname=hostname, multicastsTransmitted=multicastsTransmitted, txPower=txPower, jumbwan=jumbwan, port3=port3, portmode=portmode, lanportIndex=lanportIndex, action=action, fileName=fileName, portName=portName, rebootEnable=rebootEnable, lanportTable=lanportTable, portPower=portPower, vlanid=vlanid, jumblan1=jumblan1, wan=wan, fcsErrorTransmitted=fcsErrorTransmitted, lan4=lan4, port1=port1, staticIpSecondaryDns=staticIpSecondaryDns, portIndex=portIndex, port2=port2, staticIpHostName=staticIpHostName, jumb=jumb, operStatus=operStatus, staticIpAddr=staticIpAddr, adminStatus=adminStatus, groupIndex=groupIndex, staticDns=staticDns, lan1=lan1, qosTable=qosTable, qos=qos, portStatistic=portStatistic, qmode=qmode, portTable=portTable, groupEntry=groupEntry, qosIndex=qosIndex, qosEntry=qosEntry, qmapping=qmapping, domainame=domainame, fileType=fileType, staticIpDomainName=staticIpDomainName, deviceinfo=deviceinfo, jumblan4=jumblan4, ddminfo=ddminfo, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, rxPower=rxPower, lanportspeed=lanportspeed, reboot=reboot, priority=priority, tftp=tftp, unicastsTransmitted=unicastsTransmitted, lanportName=lanportName, vendorName=vendorName, broadcastsTransmitted=broadcastsTransmitted, modeEntry=modeEntry, staticIpGateway=staticIpGateway)
