...
# Produced by pysmi-1.1.8 at Sat Jan 15 15:17:10 2022
...
enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, ModuleIdentity, MibIdentifier, NotificationType, Unsigned32, ObjectIdentity, Bits, snmpModules, IpAddress, Integer32, iso, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "ModuleIdentity", "MibIdentifier", "NotificationType", "Unsigned32", "ObjectIdentity", "Bits", "snmpModules", "IpAddress", "Integer32", "iso", "mib-2", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan2=lan2, staticIpGateway=staticIpGateway, vlanid=vlanid, staticDns=staticDns, vendorRev=vendorRev, broadcastsReceived=broadcastsReceived, portPower=portPower, portIndex=portIndex, multicastsTransmitted=multicastsTransmitted, action=action, unicastsReceived=unicastsReceived, tftp=tftp, speed=speed, lan1=lan1, vendorName=vendorName, staticIpHostName=staticIpHostName, staticIpSecondaryDns=staticIpSecondaryDns, qosTable=qosTable, unicastsTransmitted=unicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, lanportTable=lanportTable, portStatEntry=portStatEntry, hostname=hostname, vendorPn=vendorPn, xg6846=xg6846, portTable=portTable, vlan=vlan, vlangroupTable=vlangroupTable, primaryDns=primaryDns, statisticTable=statisticTable, groupid=groupid, groupEntry=groupEntry, port3=port3, pauseTransmitted=pauseTransmitted, portEntry=portEntry, catv=catv, port2=port2, lanportpause=lanportpause, reboot=reboot, jumblan2=jumblan2, portName=portName, lan3=lan3, lanportspeed=lanportspeed, catvEnable=catvEnable, vendorOui=vendorOui, rxPower=rxPower, qosEntry=qosEntry, port4=port4, lanportIndex=lanportIndex, ddminfo=ddminfo, wan=wan, broadcastsTransmitted=broadcastsTransmitted, qmapping=qmapping, priority=priority, fcsErrorTransmitted=fcsErrorTransmitted, jumbwan=jumbwan, deviceinfo=deviceinfo, lan4=lan4, bias=bias, wanType=wanType, modeEntry=modeEntry, statIndex=statIndex, lanportName=lanportName, qos=qos, multicastsReceived=multicastsReceived, fileType=fileType, jumblan1=jumblan1, staticIpSubMask=staticIpSubMask, portmode=portmode, fcsErrorReceived=fcsErrorReceived, fileName=fileName, serialnum=serialnum, rebootEnable=rebootEnable, portStatistic=portStatistic, jumblan3=jumblan3, txPower=txPower, qmode=qmode, tftpSevIp=tftpSevIp, temperature=temperature, jumb=jumb, pauseReceived=pauseReceived, operStatus=operStatus, jumblan4=jumblan4, voltage=voltage, staticIpDomainName=staticIpDomainName, internetPort=internetPort, secondaryDns=secondaryDns, dscpEnable=dscpEnable, qosIndex=qosIndex, staticIpAddr=staticIpAddr, adminStatus=adminStatus, groupIndex=groupIndex, domainame=domainame)
