...
snmpModules, Counter32, MibIdentifier, enterprises, Integer32, mib_2, IpAddress, Gauge32, Counter64, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Bits, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Counter32", "MibIdentifier", "enterprises", "Integer32", "mib-2", "IpAddress", "Gauge32", "Counter64", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Bits", "ModuleIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumblan3=jumblan3, domainame=domainame, portEntry=portEntry, jumb=jumb, pauseReceived=pauseReceived, bias=bias, multicastsTransmitted=multicastsTransmitted, lanportName=lanportName, catv=catv, adminStatus=adminStatus, fileType=fileType, lanportTable=lanportTable, rxPower=rxPower, vlanid=vlanid, port1=port1, primaryDns=primaryDns, groupEntry=groupEntry, portStatEntry=portStatEntry, lanportpause=lanportpause, serialnum=serialnum, portPower=portPower, portTable=portTable, port3=port3, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, staticDns=staticDns, reboot=reboot, lan1=lan1, portName=portName, fileName=fileName, xg6846=xg6846, priority=priority, tftpSevIp=tftpSevIp, txPower=txPower, port2=port2, wan=wan, lan3=lan3, staticIpGateway=staticIpGateway, port4=port4, secondaryDns=secondaryDns, action=action, unicastsReceived=unicastsReceived, jumblan2=jumblan2, vendorRev=vendorRev, rebootEnable=rebootEnable, vlan=vlan, deviceinfo=deviceinfo, tftp=tftp, unicastsTransmitted=unicastsTransmitted, operStatus=operStatus, statisticTable=statisticTable, qos=qos, lan4=lan4, staticIpSubMask=staticIpSubMask, modeEntry=modeEntry, catvEnable=catvEnable, qmode=qmode, fcsErrorReceived=fcsErrorReceived, vendorPn=vendorPn, internetPort=internetPort, jumbwan=jumbwan, qosTable=qosTable, lanportIndex=lanportIndex, jumblan1=jumblan1, portmode=portmode, ddminfo=ddminfo, qmapping=qmapping, groupid=groupid, qosEntry=qosEntry, staticIpAddr=staticIpAddr, pauseTransmitted=pauseTransmitted, portIndex=portIndex, wanType=wanType, dscpEnable=dscpEnable, lanportspeed=lanportspeed, lan2=lan2, temperature=temperature, voltage=voltage, portStatistic=portStatistic, fcsErrorTransmitted=fcsErrorTransmitted, broadcastsReceived=broadcastsReceived, broadcastsTransmitted=broadcastsTransmitted, vendorName=vendorName, qosIndex=qosIndex, vendorOui=vendorOui, staticIpDomainName=staticIpDomainName, jumblan4=jumblan4, vlangroupTable=vlangroupTable, groupIndex=groupIndex, multicastsReceived=multicastsReceived, hostname=hostname, staticIpHostName=staticIpHostName, staticIpSecondaryDns=staticIpSecondaryDns, speed=speed)
