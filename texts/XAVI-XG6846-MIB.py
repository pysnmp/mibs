...
MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, MibIdentifier, enterprises, iso, Bits, Integer32, Gauge32, ModuleIdentity, TimeTicks, Unsigned32, Counter32, IpAddress, NotificationType, ObjectIdentity, Counter64, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "MibIdentifier", "enterprises", "iso", "Bits", "Integer32", "Gauge32", "ModuleIdentity", "TimeTicks", "Unsigned32", "Counter32", "IpAddress", "NotificationType", "ObjectIdentity", "Counter64", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wanType=wanType, lan1=lan1, jumblan2=jumblan2, qos=qos, vlangroupTable=vlangroupTable, priority=priority, serialnum=serialnum, operStatus=operStatus, port1=port1, temperature=temperature, tftp=tftp, vendorPn=vendorPn, bias=bias, portTable=portTable, portName=portName, dscpEnable=dscpEnable, portStatistic=portStatistic, portEntry=portEntry, groupid=groupid, deviceinfo=deviceinfo, lan3=lan3, port4=port4, lanportIndex=lanportIndex, primaryDns=primaryDns, statIndex=statIndex, reboot=reboot, action=action, fileName=fileName, vendorRev=vendorRev, statisticTable=statisticTable, staticIpHostName=staticIpHostName, speed=speed, qmapping=qmapping, vlan=vlan, multicastsTransmitted=multicastsTransmitted, lan2=lan2, jumb=jumb, broadcastsTransmitted=broadcastsTransmitted, jumblan4=jumblan4, lanportTable=lanportTable, qosTable=qosTable, staticIpGateway=staticIpGateway, staticIpDomainName=staticIpDomainName, qosEntry=qosEntry, lanportspeed=lanportspeed, tftpSevIp=tftpSevIp, portIndex=portIndex, lan4=lan4, ddminfo=ddminfo, port2=port2, vlanid=vlanid, domainame=domainame, internetPort=internetPort, rxPower=rxPower, wan=wan, vendorOui=vendorOui, groupEntry=groupEntry, broadcastsReceived=broadcastsReceived, port3=port3, jumbwan=jumbwan, vendorName=vendorName, multicastsReceived=multicastsReceived, pauseReceived=pauseReceived, staticIpSecondaryDns=staticIpSecondaryDns, staticIpAddr=staticIpAddr, fileType=fileType, jumblan3=jumblan3, adminStatus=adminStatus, staticIpPrimaryDns=staticIpPrimaryDns, staticDns=staticDns, modeEntry=modeEntry, secondaryDns=secondaryDns, qosIndex=qosIndex, lanportName=lanportName, pauseTransmitted=pauseTransmitted, groupIndex=groupIndex, catvEnable=catvEnable, qmode=qmode, portStatEntry=portStatEntry, fcsErrorReceived=fcsErrorReceived, portPower=portPower, hostname=hostname, fcsErrorTransmitted=fcsErrorTransmitted, xg6846=xg6846, txPower=txPower, unicastsTransmitted=unicastsTransmitted, catv=catv, rebootEnable=rebootEnable, lanportpause=lanportpause, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, unicastsReceived=unicastsReceived, portmode=portmode, voltage=voltage)
