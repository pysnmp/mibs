...
# Produced by pysmi-1.1.8 at Thu Sep 29 13:13:07 2022
...
Counter64, snmpModules, TimeTicks, IpAddress, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, Counter32, Integer32, iso, enterprises, Gauge32, Unsigned32, mib_2, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "snmpModules", "TimeTicks", "IpAddress", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "Counter32", "Integer32", "iso", "enterprises", "Gauge32", "Unsigned32", "mib-2", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", priority=priority, staticIpDomainName=staticIpDomainName, qosIndex=qosIndex, pauseReceived=pauseReceived, temperature=temperature, broadcastsReceived=broadcastsReceived, bias=bias, portStatEntry=portStatEntry, staticIpHostName=staticIpHostName, portName=portName, dscpEnable=dscpEnable, vlangroupTable=vlangroupTable, port2=port2, portmode=portmode, staticIpAddr=staticIpAddr, fileType=fileType, secondaryDns=secondaryDns, vlan=vlan, staticIpSecondaryDns=staticIpSecondaryDns, vendorRev=vendorRev, qosEntry=qosEntry, broadcastsTransmitted=broadcastsTransmitted, lan1=lan1, unicastsTransmitted=unicastsTransmitted, operStatus=operStatus, internetPort=internetPort, lan3=lan3, txPower=txPower, staticDns=staticDns, jumblan3=jumblan3, statisticTable=statisticTable, jumblan2=jumblan2, primaryDns=primaryDns, adminStatus=adminStatus, staticIpGateway=staticIpGateway, vlanid=vlanid, reboot=reboot, unicastsReceived=unicastsReceived, action=action, statIndex=statIndex, port3=port3, port1=port1, fcsErrorTransmitted=fcsErrorTransmitted, voltage=voltage, speed=speed, portEntry=portEntry, lanportTable=lanportTable, vendorOui=vendorOui, deviceinfo=deviceinfo, lanportspeed=lanportspeed, qosTable=qosTable, multicastsTransmitted=multicastsTransmitted, fcsErrorReceived=fcsErrorReceived, lan4=lan4, domainame=domainame, qos=qos, portIndex=portIndex, ddminfo=ddminfo, lanportpause=lanportpause, rebootEnable=rebootEnable, fileName=fileName, tftp=tftp, multicastsReceived=multicastsReceived, wanType=wanType, catvEnable=catvEnable, groupEntry=groupEntry, tftpSevIp=tftpSevIp, groupIndex=groupIndex, vendorName=vendorName, groupid=groupid, qmapping=qmapping, vendorPn=vendorPn, portStatistic=portStatistic, wan=wan, serialnum=serialnum, catv=catv, qmode=qmode, modeEntry=modeEntry, jumblan1=jumblan1, lanportIndex=lanportIndex, hostname=hostname, jumblan4=jumblan4, lanportName=lanportName, staticIpPrimaryDns=staticIpPrimaryDns, port4=port4, rxPower=rxPower, pauseTransmitted=pauseTransmitted, jumb=jumb, portPower=portPower, jumbwan=jumbwan, lan2=lan2, staticIpSubMask=staticIpSubMask, xg6846=xg6846, portTable=portTable)
