...
Counter32, ObjectIdentity, ModuleIdentity, mib_2, Integer32, Counter64, TimeTicks, MibIdentifier, snmpModules, Gauge32, IpAddress, Unsigned32, enterprises, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "ModuleIdentity", "mib-2", "Integer32", "Counter64", "TimeTicks", "MibIdentifier", "snmpModules", "Gauge32", "IpAddress", "Unsigned32", "enterprises", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qmode=qmode, speed=speed, fileType=fileType, rxPower=rxPower, fileName=fileName, lan1=lan1, multicastsReceived=multicastsReceived, serialnum=serialnum, vlanid=vlanid, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, lanportspeed=lanportspeed, vendorOui=vendorOui, action=action, catv=catv, portPower=portPower, staticIpAddr=staticIpAddr, internetPort=internetPort, unicastsTransmitted=unicastsTransmitted, broadcastsTransmitted=broadcastsTransmitted, vendorPn=vendorPn, portEntry=portEntry, xg6846=xg6846, jumblan3=jumblan3, vlangroupTable=vlangroupTable, operStatus=operStatus, groupIndex=groupIndex, jumbwan=jumbwan, primaryDns=primaryDns, qos=qos, staticIpHostName=staticIpHostName, bias=bias, tftp=tftp, wanType=wanType, unicastsReceived=unicastsReceived, temperature=temperature, lan4=lan4, catvEnable=catvEnable, lanportName=lanportName, qosTable=qosTable, fcsErrorReceived=fcsErrorReceived, statisticTable=statisticTable, voltage=voltage, portName=portName, vendorRev=vendorRev, jumblan4=jumblan4, adminStatus=adminStatus, lanportIndex=lanportIndex, portTable=portTable, lan2=lan2, secondaryDns=secondaryDns, staticIpGateway=staticIpGateway, vendorName=vendorName, multicastsTransmitted=multicastsTransmitted, port3=port3, jumblan1=jumblan1, groupEntry=groupEntry, jumblan2=jumblan2, vlan=vlan, pauseTransmitted=pauseTransmitted, qosEntry=qosEntry, staticIpDomainName=staticIpDomainName, deviceinfo=deviceinfo, fcsErrorTransmitted=fcsErrorTransmitted, lanportpause=lanportpause, rebootEnable=rebootEnable, portStatEntry=portStatEntry, reboot=reboot, port4=port4, jumb=jumb, groupid=groupid, dscpEnable=dscpEnable, priority=priority, portStatistic=portStatistic, statIndex=statIndex, port2=port2, tftpSevIp=tftpSevIp, domainame=domainame, qmapping=qmapping, ddminfo=ddminfo, wan=wan, broadcastsReceived=broadcastsReceived, staticIpPrimaryDns=staticIpPrimaryDns, staticDns=staticDns, modeEntry=modeEntry, port1=port1, lanportTable=lanportTable, portIndex=portIndex, hostname=hostname, staticIpSecondaryDns=staticIpSecondaryDns, portmode=portmode, lan3=lan3, txPower=txPower, pauseReceived=pauseReceived)
