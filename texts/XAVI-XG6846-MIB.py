...
# Produced by pysmi-1.1.10 at Mon Oct 30 02:24:43 2023
...
snmpModules, mib_2, iso, Counter64, Unsigned32, TimeTicks, Bits, Counter32, Gauge32, ObjectIdentity, MibIdentifier, NotificationType, ModuleIdentity, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "mib-2", "iso", "Counter64", "Unsigned32", "TimeTicks", "Bits", "Counter32", "Gauge32", "ObjectIdentity", "MibIdentifier", "NotificationType", "ModuleIdentity", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catv=catv, qosTable=qosTable, port1=port1, portName=portName, hostname=hostname, xg6846=xg6846, lan1=lan1, portIndex=portIndex, staticIpPrimaryDns=staticIpPrimaryDns, vendorRev=vendorRev, qos=qos, portEntry=portEntry, rebootEnable=rebootEnable, staticIpSubMask=staticIpSubMask, lanportIndex=lanportIndex, temperature=temperature, lanportTable=lanportTable, vendorOui=vendorOui, adminStatus=adminStatus, staticIpSecondaryDns=staticIpSecondaryDns, jumb=jumb, dscpEnable=dscpEnable, unicastsReceived=unicastsReceived, port3=port3, unicastsTransmitted=unicastsTransmitted, secondaryDns=secondaryDns, fileType=fileType, groupEntry=groupEntry, jumblan2=jumblan2, fcsErrorReceived=fcsErrorReceived, port2=port2, jumblan4=jumblan4, primaryDns=primaryDns, serialnum=serialnum, reboot=reboot, portPower=portPower, broadcastsTransmitted=broadcastsTransmitted, jumblan3=jumblan3, action=action, vlan=vlan, vendorName=vendorName, bias=bias, qosIndex=qosIndex, ddminfo=ddminfo, lanportpause=lanportpause, broadcastsReceived=broadcastsReceived, pauseReceived=pauseReceived, qosEntry=qosEntry, speed=speed, vlangroupTable=vlangroupTable, qmode=qmode, lanportName=lanportName, groupid=groupid, staticIpGateway=staticIpGateway, tftpSevIp=tftpSevIp, vlanid=vlanid, catvEnable=catvEnable, portTable=portTable, priority=priority, staticIpHostName=staticIpHostName, portmode=portmode, statIndex=statIndex, deviceinfo=deviceinfo, lan2=lan2, lan4=lan4, rxPower=rxPower, portStatEntry=portStatEntry, wanType=wanType, staticIpAddr=staticIpAddr, multicastsTransmitted=multicastsTransmitted, txPower=txPower, tftp=tftp, jumbwan=jumbwan, domainame=domainame, lanportspeed=lanportspeed, vendorPn=vendorPn, pauseTransmitted=pauseTransmitted, staticIpDomainName=staticIpDomainName, portStatistic=portStatistic, voltage=voltage, multicastsReceived=multicastsReceived, fileName=fileName, operStatus=operStatus, wan=wan, groupIndex=groupIndex, qmapping=qmapping, statisticTable=statisticTable, modeEntry=modeEntry, internetPort=internetPort, fcsErrorTransmitted=fcsErrorTransmitted, lan3=lan3, staticDns=staticDns, jumblan1=jumblan1, port4=port4)
