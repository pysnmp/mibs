...
enterprises, Bits, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, MibIdentifier, mib_2, iso, snmpModules, ModuleIdentity, Counter64, Unsigned32, Counter32, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "MibIdentifier", "mib-2", "iso", "snmpModules", "ModuleIdentity", "Counter64", "Unsigned32", "Counter32", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlan=vlan, lanportName=lanportName, staticDns=staticDns, vendorRev=vendorRev, staticIpSecondaryDns=staticIpSecondaryDns, jumblan4=jumblan4, lanportpause=lanportpause, portmode=portmode, fileType=fileType, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, broadcastsReceived=broadcastsReceived, groupEntry=groupEntry, catv=catv, portStatistic=portStatistic, primaryDns=primaryDns, staticIpGateway=staticIpGateway, staticIpAddr=staticIpAddr, tftp=tftp, adminStatus=adminStatus, jumb=jumb, rxPower=rxPower, bias=bias, catvEnable=catvEnable, groupIndex=groupIndex, fileName=fileName, staticIpPrimaryDns=staticIpPrimaryDns, port3=port3, vlanid=vlanid, lan2=lan2, port4=port4, port1=port1, unicastsTransmitted=unicastsTransmitted, temperature=temperature, staticIpSubMask=staticIpSubMask, fcsErrorTransmitted=fcsErrorTransmitted, unicastsReceived=unicastsReceived, multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, jumblan2=jumblan2, lan4=lan4, rebootEnable=rebootEnable, qosIndex=qosIndex, vendorName=vendorName, pauseTransmitted=pauseTransmitted, qosTable=qosTable, qosEntry=qosEntry, wan=wan, reboot=reboot, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, port2=port2, domainame=domainame, ddminfo=ddminfo, action=action, staticIpHostName=staticIpHostName, priority=priority, groupid=groupid, speed=speed, vlangroupTable=vlangroupTable, qmapping=qmapping, modeEntry=modeEntry, dscpEnable=dscpEnable, txPower=txPower, voltage=voltage, operStatus=operStatus, portIndex=portIndex, portName=portName, qos=qos, deviceinfo=deviceinfo, lan1=lan1, internetPort=internetPort, hostname=hostname, tftpSevIp=tftpSevIp, portTable=portTable, portStatEntry=portStatEntry, jumblan3=jumblan3, jumbwan=jumbwan, lanportspeed=lanportspeed, secondaryDns=secondaryDns, pauseReceived=pauseReceived, portEntry=portEntry, lanportIndex=lanportIndex, multicastsReceived=multicastsReceived, jumblan1=jumblan1, wanType=wanType, statisticTable=statisticTable, vendorPn=vendorPn, portPower=portPower, xg6846=xg6846, fcsErrorReceived=fcsErrorReceived, statIndex=statIndex, serialnum=serialnum, lan3=lan3)
