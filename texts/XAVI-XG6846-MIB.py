...
# Produced by pysmi-1.1.10 at Thu Nov  9 13:49:33 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, IpAddress, ModuleIdentity, ObjectIdentity, snmpModules, NotificationType, Unsigned32, iso, enterprises, mib_2, Counter32, Integer32, Counter64, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "IpAddress", "ModuleIdentity", "ObjectIdentity", "snmpModules", "NotificationType", "Unsigned32", "iso", "enterprises", "mib-2", "Counter32", "Integer32", "Counter64", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpPrimaryDns=staticIpPrimaryDns, jumblan2=jumblan2, broadcastsTransmitted=broadcastsTransmitted, lan4=lan4, lanportName=lanportName, portName=portName, qmode=qmode, jumblan1=jumblan1, qos=qos, xg6846=xg6846, portPower=portPower, operStatus=operStatus, voltage=voltage, rebootEnable=rebootEnable, speed=speed, staticIpSubMask=staticIpSubMask, statisticTable=statisticTable, statIndex=statIndex, groupid=groupid, vendorRev=vendorRev, port1=port1, vendorName=vendorName, txPower=txPower, catv=catv, reboot=reboot, qosEntry=qosEntry, jumb=jumb, groupIndex=groupIndex, dscpEnable=dscpEnable, tftpSevIp=tftpSevIp, portStatEntry=portStatEntry, adminStatus=adminStatus, port2=port2, primaryDns=primaryDns, qosIndex=qosIndex, portStatistic=portStatistic, pauseTransmitted=pauseTransmitted, lan2=lan2, fcsErrorReceived=fcsErrorReceived, priority=priority, multicastsReceived=multicastsReceived, vlan=vlan, lanportspeed=lanportspeed, bias=bias, unicastsReceived=unicastsReceived, port3=port3, fcsErrorTransmitted=fcsErrorTransmitted, staticIpHostName=staticIpHostName, tftp=tftp, lan3=lan3, action=action, wanType=wanType, staticIpSecondaryDns=staticIpSecondaryDns, catvEnable=catvEnable, qmapping=qmapping, qosTable=qosTable, jumblan4=jumblan4, secondaryDns=secondaryDns, port4=port4, groupEntry=groupEntry, staticIpDomainName=staticIpDomainName, portIndex=portIndex, staticIpGateway=staticIpGateway, domainame=domainame, jumblan3=jumblan3, portmode=portmode, lanportIndex=lanportIndex, broadcastsReceived=broadcastsReceived, internetPort=internetPort, lan1=lan1, portEntry=portEntry, deviceinfo=deviceinfo, staticIpAddr=staticIpAddr, multicastsTransmitted=multicastsTransmitted, wan=wan, unicastsTransmitted=unicastsTransmitted, vendorOui=vendorOui, lanportTable=lanportTable, fileName=fileName, lanportpause=lanportpause, staticDns=staticDns, vlanid=vlanid, portTable=portTable, fileType=fileType, ddminfo=ddminfo, pauseReceived=pauseReceived, vlangroupTable=vlangroupTable, hostname=hostname, rxPower=rxPower, temperature=temperature, jumbwan=jumbwan, modeEntry=modeEntry, vendorPn=vendorPn, serialnum=serialnum)
