...
TimeTicks, Counter32, Integer32, iso, Counter64, mib_2, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, ObjectIdentity, Gauge32, Unsigned32, MibIdentifier, ModuleIdentity, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "Integer32", "iso", "Counter64", "mib-2", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "ObjectIdentity", "Gauge32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftp=tftp, port3=port3, qmode=qmode, groupIndex=groupIndex, staticIpSubMask=staticIpSubMask, multicastsReceived=multicastsReceived, vlanid=vlanid, broadcastsTransmitted=broadcastsTransmitted, statIndex=statIndex, portStatistic=portStatistic, operStatus=operStatus, vlangroupTable=vlangroupTable, rebootEnable=rebootEnable, lanportspeed=lanportspeed, jumb=jumb, qmapping=qmapping, portIndex=portIndex, lanportName=lanportName, portName=portName, primaryDns=primaryDns, lan1=lan1, dscpEnable=dscpEnable, jumblan2=jumblan2, secondaryDns=secondaryDns, hostname=hostname, broadcastsReceived=broadcastsReceived, staticDns=staticDns, serialnum=serialnum, lan2=lan2, lanportTable=lanportTable, portStatEntry=portStatEntry, portmode=portmode, pauseReceived=pauseReceived, jumblan1=jumblan1, tftpSevIp=tftpSevIp, reboot=reboot, lan4=lan4, staticIpSecondaryDns=staticIpSecondaryDns, pauseTransmitted=pauseTransmitted, portTable=portTable, vendorName=vendorName, port1=port1, wanType=wanType, fileType=fileType, qosTable=qosTable, lanportpause=lanportpause, statisticTable=statisticTable, domainame=domainame, lanportIndex=lanportIndex, adminStatus=adminStatus, txPower=txPower, ddminfo=ddminfo, staticIpPrimaryDns=staticIpPrimaryDns, vendorRev=vendorRev, jumblan4=jumblan4, wan=wan, rxPower=rxPower, priority=priority, staticIpGateway=staticIpGateway, deviceinfo=deviceinfo, qosEntry=qosEntry, port2=port2, qos=qos, modeEntry=modeEntry, portPower=portPower, bias=bias, multicastsTransmitted=multicastsTransmitted, staticIpHostName=staticIpHostName, speed=speed, portEntry=portEntry, catv=catv, groupEntry=groupEntry, lan3=lan3, voltage=voltage, qosIndex=qosIndex, fcsErrorReceived=fcsErrorReceived, internetPort=internetPort, groupid=groupid, jumblan3=jumblan3, staticIpDomainName=staticIpDomainName, fileName=fileName, port4=port4, xg6846=xg6846, fcsErrorTransmitted=fcsErrorTransmitted, jumbwan=jumbwan, action=action, vendorOui=vendorOui, unicastsTransmitted=unicastsTransmitted, unicastsReceived=unicastsReceived, staticIpAddr=staticIpAddr, catvEnable=catvEnable, vlan=vlan, vendorPn=vendorPn, temperature=temperature)
