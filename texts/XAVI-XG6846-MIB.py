...
# Produced by pysmi-1.1.8 at Sat Jan 15 23:28:14 2022
...
IpAddress, mib_2, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Counter32, Counter64, Gauge32, Integer32, iso, TimeTicks, NotificationType, enterprises, Unsigned32, MibIdentifier, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "mib-2", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Counter32", "Counter64", "Gauge32", "Integer32", "iso", "TimeTicks", "NotificationType", "enterprises", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorOui=vendorOui, lanportIndex=lanportIndex, priority=priority, port4=port4, secondaryDns=secondaryDns, qosTable=qosTable, internetPort=internetPort, wanType=wanType, catv=catv, lanportspeed=lanportspeed, vlan=vlan, pauseTransmitted=pauseTransmitted, staticIpGateway=staticIpGateway, lan4=lan4, portEntry=portEntry, xg6846=xg6846, tftp=tftp, jumblan3=jumblan3, statisticTable=statisticTable, jumblan4=jumblan4, temperature=temperature, staticIpHostName=staticIpHostName, qmode=qmode, lan1=lan1, multicastsTransmitted=multicastsTransmitted, txPower=txPower, lanportTable=lanportTable, lan2=lan2, rebootEnable=rebootEnable, staticIpPrimaryDns=staticIpPrimaryDns, portPower=portPower, port1=port1, serialnum=serialnum, groupid=groupid, staticIpAddr=staticIpAddr, jumb=jumb, qosEntry=qosEntry, jumbwan=jumbwan, statIndex=statIndex, vendorName=vendorName, speed=speed, portIndex=portIndex, broadcastsReceived=broadcastsReceived, fcsErrorReceived=fcsErrorReceived, action=action, unicastsTransmitted=unicastsTransmitted, dscpEnable=dscpEnable, vendorRev=vendorRev, fcsErrorTransmitted=fcsErrorTransmitted, operStatus=operStatus, broadcastsTransmitted=broadcastsTransmitted, wan=wan, jumblan1=jumblan1, port3=port3, portmode=portmode, lanportpause=lanportpause, multicastsReceived=multicastsReceived, lan3=lan3, bias=bias, vendorPn=vendorPn, portStatistic=portStatistic, lanportName=lanportName, fileName=fileName, qos=qos, ddminfo=ddminfo, fileType=fileType, qmapping=qmapping, primaryDns=primaryDns, staticIpSubMask=staticIpSubMask, voltage=voltage, tftpSevIp=tftpSevIp, staticDns=staticDns, vlanid=vlanid, pauseReceived=pauseReceived, groupEntry=groupEntry, qosIndex=qosIndex, staticIpSecondaryDns=staticIpSecondaryDns, catvEnable=catvEnable, deviceinfo=deviceinfo, domainame=domainame, unicastsReceived=unicastsReceived, reboot=reboot, staticIpDomainName=staticIpDomainName, rxPower=rxPower, portTable=portTable, adminStatus=adminStatus, modeEntry=modeEntry, portName=portName, jumblan2=jumblan2, vlangroupTable=vlangroupTable, groupIndex=groupIndex, port2=port2, portStatEntry=portStatEntry, hostname=hostname)
