...
ObjectIdentity, ModuleIdentity, Counter64, MibIdentifier, IpAddress, Unsigned32, NotificationType, Gauge32, Counter32, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, mib_2, iso, TimeTicks, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Counter64", "MibIdentifier", "IpAddress", "Unsigned32", "NotificationType", "Gauge32", "Counter32", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "mib-2", "iso", "TimeTicks", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsTransmitted=multicastsTransmitted, vendorRev=vendorRev, voltage=voltage, portmode=portmode, statIndex=statIndex, txPower=txPower, staticIpPrimaryDns=staticIpPrimaryDns, staticIpAddr=staticIpAddr, temperature=temperature, deviceinfo=deviceinfo, wan=wan, qosTable=qosTable, ddminfo=ddminfo, port2=port2, operStatus=operStatus, serialnum=serialnum, xg6846=xg6846, lanportTable=lanportTable, internetPort=internetPort, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, vendorOui=vendorOui, staticIpSecondaryDns=staticIpSecondaryDns, lan2=lan2, staticIpSubMask=staticIpSubMask, jumblan1=jumblan1, vendorPn=vendorPn, statisticTable=statisticTable, priority=priority, lanportspeed=lanportspeed, jumbwan=jumbwan, qmapping=qmapping, lan4=lan4, fileType=fileType, jumb=jumb, portEntry=portEntry, pauseTransmitted=pauseTransmitted, portPower=portPower, staticIpHostName=staticIpHostName, jumblan3=jumblan3, vlangroupTable=vlangroupTable, lan3=lan3, staticIpDomainName=staticIpDomainName, jumblan4=jumblan4, groupEntry=groupEntry, modeEntry=modeEntry, speed=speed, rxPower=rxPower, tftp=tftp, lanportIndex=lanportIndex, qosEntry=qosEntry, bias=bias, staticDns=staticDns, multicastsReceived=multicastsReceived, rebootEnable=rebootEnable, port3=port3, vlan=vlan, lan1=lan1, domainame=domainame, fcsErrorReceived=fcsErrorReceived, portName=portName, wanType=wanType, portIndex=portIndex, port4=port4, qos=qos, unicastsReceived=unicastsReceived, portStatistic=portStatistic, broadcastsTransmitted=broadcastsTransmitted, catvEnable=catvEnable, portTable=portTable, lanportpause=lanportpause, action=action, hostname=hostname, groupIndex=groupIndex, portStatEntry=portStatEntry, tftpSevIp=tftpSevIp, dscpEnable=dscpEnable, qosIndex=qosIndex, pauseReceived=pauseReceived, fileName=fileName, jumblan2=jumblan2, qmode=qmode, vendorName=vendorName, vlanid=vlanid, lanportName=lanportName, fcsErrorTransmitted=fcsErrorTransmitted, catv=catv, unicastsTransmitted=unicastsTransmitted, reboot=reboot, staticIpGateway=staticIpGateway, adminStatus=adminStatus, secondaryDns=secondaryDns, groupid=groupid, port1=port1)
