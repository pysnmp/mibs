...
# Produced by pysmi-1.1.3 at Mon Nov 22 20:00:34 2021
...
Counter64, Bits, enterprises, snmpModules, NotificationType, IpAddress, ObjectIdentity, Counter32, Gauge32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, mib_2, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "enterprises", "snmpModules", "NotificationType", "IpAddress", "ObjectIdentity", "Counter32", "Gauge32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "mib-2", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", catvEnable=catvEnable, action=action, txPower=txPower, fcsErrorTransmitted=fcsErrorTransmitted, domainame=domainame, unicastsTransmitted=unicastsTransmitted, port3=port3, priority=priority, staticIpDomainName=staticIpDomainName, multicastsTransmitted=multicastsTransmitted, fcsErrorReceived=fcsErrorReceived, reboot=reboot, lanportpause=lanportpause, hostname=hostname, jumblan1=jumblan1, temperature=temperature, lan1=lan1, portEntry=portEntry, jumblan2=jumblan2, wan=wan, vlanid=vlanid, portIndex=portIndex, vendorRev=vendorRev, voltage=voltage, portPower=portPower, secondaryDns=secondaryDns, vlangroupTable=vlangroupTable, jumbwan=jumbwan, wanType=wanType, vlan=vlan, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, staticIpHostName=staticIpHostName, staticIpSubMask=staticIpSubMask, modeEntry=modeEntry, operStatus=operStatus, tftpSevIp=tftpSevIp, rebootEnable=rebootEnable, serialnum=serialnum, lanportName=lanportName, adminStatus=adminStatus, lanportspeed=lanportspeed, qos=qos, lan4=lan4, multicastsReceived=multicastsReceived, staticDns=staticDns, ddminfo=ddminfo, lan2=lan2, statisticTable=statisticTable, groupEntry=groupEntry, lanportIndex=lanportIndex, unicastsReceived=unicastsReceived, speed=speed, primaryDns=primaryDns, rxPower=rxPower, broadcastsTransmitted=broadcastsTransmitted, groupid=groupid, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, deviceinfo=deviceinfo, port1=port1, port4=port4, groupIndex=groupIndex, catv=catv, jumb=jumb, dscpEnable=dscpEnable, vendorOui=vendorOui, xg6846=xg6846, portmode=portmode, qosIndex=qosIndex, staticIpGateway=staticIpGateway, qmode=qmode, lan3=lan3, portName=portName, qmapping=qmapping, portStatEntry=portStatEntry, qosEntry=qosEntry, qosTable=qosTable, jumblan3=jumblan3, vendorName=vendorName, pauseTransmitted=pauseTransmitted, lanportTable=lanportTable, internetPort=internetPort, port2=port2, fileType=fileType, staticIpAddr=staticIpAddr, fileName=fileName, portStatistic=portStatistic, portTable=portTable, bias=bias, vendorPn=vendorPn, staticIpSecondaryDns=staticIpSecondaryDns, tftp=tftp, pauseReceived=pauseReceived)
