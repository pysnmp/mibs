...
# Produced by pysmi-1.1.8 at Thu Sep 29 08:54:15 2022
...
mib_2, ModuleIdentity, NotificationType, snmpModules, Bits, ObjectIdentity, Integer32, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, Counter64, TimeTicks, Gauge32, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ModuleIdentity", "NotificationType", "snmpModules", "Bits", "ObjectIdentity", "Integer32", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "Counter64", "TimeTicks", "Gauge32", "enterprises", "Counter32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", dscpEnable=dscpEnable, jumblan3=jumblan3, fcsErrorTransmitted=fcsErrorTransmitted, lanportIndex=lanportIndex, fileType=fileType, txPower=txPower, portTable=portTable, modeEntry=modeEntry, vendorName=vendorName, jumblan4=jumblan4, portmode=portmode, groupIndex=groupIndex, staticIpAddr=staticIpAddr, wan=wan, voltage=voltage, port3=port3, lan3=lan3, multicastsTransmitted=multicastsTransmitted, vendorOui=vendorOui, domainame=domainame, portStatEntry=portStatEntry, pauseTransmitted=pauseTransmitted, port4=port4, lanportTable=lanportTable, portPower=portPower, staticIpGateway=staticIpGateway, operStatus=operStatus, qmapping=qmapping, portEntry=portEntry, lanportspeed=lanportspeed, primaryDns=primaryDns, qosIndex=qosIndex, jumb=jumb, speed=speed, serialnum=serialnum, rxPower=rxPower, lan1=lan1, qos=qos, staticIpHostName=staticIpHostName, reboot=reboot, vlan=vlan, port1=port1, lanportpause=lanportpause, bias=bias, lan2=lan2, staticDns=staticDns, secondaryDns=secondaryDns, lanportName=lanportName, portName=portName, staticIpSecondaryDns=staticIpSecondaryDns, portIndex=portIndex, tftp=tftp, xg6846=xg6846, staticIpSubMask=staticIpSubMask, fileName=fileName, lan4=lan4, unicastsReceived=unicastsReceived, jumblan2=jumblan2, qosTable=qosTable, qosEntry=qosEntry, qmode=qmode, priority=priority, jumblan1=jumblan1, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, groupEntry=groupEntry, statisticTable=statisticTable, staticIpPrimaryDns=staticIpPrimaryDns, internetPort=internetPort, vendorRev=vendorRev, rebootEnable=rebootEnable, statIndex=statIndex, catv=catv, fcsErrorReceived=fcsErrorReceived, wanType=wanType, ddminfo=ddminfo, temperature=temperature, portStatistic=portStatistic, vendorPn=vendorPn, staticIpDomainName=staticIpDomainName, pauseReceived=pauseReceived, catvEnable=catvEnable, multicastsReceived=multicastsReceived, groupid=groupid, port2=port2, action=action, broadcastsTransmitted=broadcastsTransmitted, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, hostname=hostname, jumbwan=jumbwan, tftpSevIp=tftpSevIp, vlanid=vlanid, vlangroupTable=vlangroupTable)
