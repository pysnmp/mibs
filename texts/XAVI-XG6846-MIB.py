...
# Produced by pysmi-1.1.8 at Mon Jan 17 19:26:40 2022
...
ModuleIdentity, ObjectIdentity, TimeTicks, NotificationType, MibIdentifier, mib_2, enterprises, Counter32, IpAddress, Unsigned32, Integer32, iso, Bits, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "NotificationType", "MibIdentifier", "mib-2", "enterprises", "Counter32", "IpAddress", "Unsigned32", "Integer32", "iso", "Bits", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan2=lan2, portmode=portmode, jumblan2=jumblan2, rebootEnable=rebootEnable, vendorRev=vendorRev, staticIpHostName=staticIpHostName, vendorPn=vendorPn, multicastsReceived=multicastsReceived, jumblan1=jumblan1, lanportpause=lanportpause, qmapping=qmapping, bias=bias, jumb=jumb, statIndex=statIndex, deviceinfo=deviceinfo, portTable=portTable, priority=priority, unicastsReceived=unicastsReceived, pauseReceived=pauseReceived, adminStatus=adminStatus, staticIpGateway=staticIpGateway, staticIpSubMask=staticIpSubMask, lan3=lan3, vlanid=vlanid, groupIndex=groupIndex, lan1=lan1, internetPort=internetPort, port4=port4, lanportspeed=lanportspeed, qos=qos, port3=port3, lan4=lan4, unicastsTransmitted=unicastsTransmitted, voltage=voltage, serialnum=serialnum, fileName=fileName, jumbwan=jumbwan, wan=wan, statisticTable=statisticTable, lanportIndex=lanportIndex, groupid=groupid, portIndex=portIndex, domainame=domainame, action=action, port2=port2, qmode=qmode, qosTable=qosTable, portEntry=portEntry, staticIpDomainName=staticIpDomainName, groupEntry=groupEntry, modeEntry=modeEntry, xg6846=xg6846, port1=port1, tftp=tftp, wanType=wanType, reboot=reboot, fileType=fileType, vendorName=vendorName, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, portStatistic=portStatistic, catv=catv, catvEnable=catvEnable, tftpSevIp=tftpSevIp, dscpEnable=dscpEnable, portName=portName, staticDns=staticDns, ddminfo=ddminfo, portStatEntry=portStatEntry, txPower=txPower, vlangroupTable=vlangroupTable, jumblan3=jumblan3, lanportName=lanportName, rxPower=rxPower, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, qosEntry=qosEntry, qosIndex=qosIndex, primaryDns=primaryDns, portPower=portPower, fcsErrorTransmitted=fcsErrorTransmitted, lanportTable=lanportTable, pauseTransmitted=pauseTransmitted, multicastsTransmitted=multicastsTransmitted, jumblan4=jumblan4, temperature=temperature, staticIpSecondaryDns=staticIpSecondaryDns, vlan=vlan, vendorOui=vendorOui, broadcastsReceived=broadcastsReceived, speed=speed, hostname=hostname, broadcastsTransmitted=broadcastsTransmitted, operStatus=operStatus)
