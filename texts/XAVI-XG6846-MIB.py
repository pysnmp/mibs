...
enterprises, mib_2, NotificationType, ModuleIdentity, snmpModules, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, Gauge32, IpAddress, Counter64, MibIdentifier, TimeTicks, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "mib-2", "NotificationType", "ModuleIdentity", "snmpModules", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "Gauge32", "IpAddress", "Counter64", "MibIdentifier", "TimeTicks", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", temperature=temperature, qos=qos, action=action, txPower=txPower, fcsErrorTransmitted=fcsErrorTransmitted, rxPower=rxPower, wan=wan, rebootEnable=rebootEnable, port4=port4, lanportName=lanportName, port2=port2, tftp=tftp, portStatistic=portStatistic, pauseReceived=pauseReceived, portTable=portTable, broadcastsTransmitted=broadcastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, unicastsTransmitted=unicastsTransmitted, internetPort=internetPort, groupIndex=groupIndex, catv=catv, wanType=wanType, vendorRev=vendorRev, port3=port3, operStatus=operStatus, groupid=groupid, vlanid=vlanid, staticIpAddr=staticIpAddr, domainame=domainame, serialnum=serialnum, staticIpHostName=staticIpHostName, modeEntry=modeEntry, unicastsReceived=unicastsReceived, deviceinfo=deviceinfo, staticDns=staticDns, lanportspeed=lanportspeed, lanportpause=lanportpause, portStatEntry=portStatEntry, lan4=lan4, portEntry=portEntry, statisticTable=statisticTable, lan2=lan2, jumblan3=jumblan3, vlan=vlan, speed=speed, catvEnable=catvEnable, portPower=portPower, portIndex=portIndex, fcsErrorReceived=fcsErrorReceived, qosIndex=qosIndex, lanportIndex=lanportIndex, vendorPn=vendorPn, jumb=jumb, adminStatus=adminStatus, reboot=reboot, jumbwan=jumbwan, staticIpSubMask=staticIpSubMask, portmode=portmode, groupEntry=groupEntry, fileType=fileType, tftpSevIp=tftpSevIp, vendorName=vendorName, priority=priority, jumblan4=jumblan4, staticIpPrimaryDns=staticIpPrimaryDns, broadcastsReceived=broadcastsReceived, lanportTable=lanportTable, pauseTransmitted=pauseTransmitted, vendorOui=vendorOui, staticIpGateway=staticIpGateway, fileName=fileName, bias=bias, xg6846=xg6846, port1=port1, qosTable=qosTable, vlangroupTable=vlangroupTable, lan1=lan1, dscpEnable=dscpEnable, jumblan2=jumblan2, jumblan1=jumblan1, qmode=qmode, voltage=voltage, hostname=hostname, statIndex=statIndex, qmapping=qmapping, lan3=lan3, secondaryDns=secondaryDns, primaryDns=primaryDns, portName=portName, staticIpDomainName=staticIpDomainName, qosEntry=qosEntry, multicastsTransmitted=multicastsTransmitted, multicastsReceived=multicastsReceived, ddminfo=ddminfo)
