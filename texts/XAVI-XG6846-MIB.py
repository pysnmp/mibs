...
Integer32, TimeTicks, NotificationType, MibIdentifier, ModuleIdentity, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Counter32, Gauge32, Bits, snmpModules, Unsigned32, IpAddress, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "NotificationType", "MibIdentifier", "ModuleIdentity", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Counter32", "Gauge32", "Bits", "snmpModules", "Unsigned32", "IpAddress", "iso", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qos=qos, operStatus=operStatus, wanType=wanType, jumblan1=jumblan1, portPower=portPower, qosEntry=qosEntry, broadcastsTransmitted=broadcastsTransmitted, serialnum=serialnum, portTable=portTable, lan4=lan4, fcsErrorReceived=fcsErrorReceived, portmode=portmode, lanportIndex=lanportIndex, qmapping=qmapping, unicastsReceived=unicastsReceived, temperature=temperature, port2=port2, pauseReceived=pauseReceived, lanportspeed=lanportspeed, jumblan2=jumblan2, lan3=lan3, staticIpSecondaryDns=staticIpSecondaryDns, portStatEntry=portStatEntry, qosIndex=qosIndex, secondaryDns=secondaryDns, fcsErrorTransmitted=fcsErrorTransmitted, hostname=hostname, adminStatus=adminStatus, tftpSevIp=tftpSevIp, vlangroupTable=vlangroupTable, internetPort=internetPort, vendorRev=vendorRev, catvEnable=catvEnable, staticDns=staticDns, jumblan3=jumblan3, port4=port4, multicastsTransmitted=multicastsTransmitted, catv=catv, staticIpSubMask=staticIpSubMask, portName=portName, action=action, tftp=tftp, jumblan4=jumblan4, vendorOui=vendorOui, port3=port3, jumb=jumb, portIndex=portIndex, port1=port1, vlanid=vlanid, dscpEnable=dscpEnable, ddminfo=ddminfo, deviceinfo=deviceinfo, rxPower=rxPower, groupid=groupid, lan1=lan1, voltage=voltage, vendorPn=vendorPn, fileName=fileName, lanportTable=lanportTable, staticIpHostName=staticIpHostName, lan2=lan2, jumbwan=jumbwan, primaryDns=primaryDns, priority=priority, multicastsReceived=multicastsReceived, statisticTable=statisticTable, reboot=reboot, unicastsTransmitted=unicastsTransmitted, pauseTransmitted=pauseTransmitted, speed=speed, qosTable=qosTable, portEntry=portEntry, portStatistic=portStatistic, lanportpause=lanportpause, modeEntry=modeEntry, staticIpAddr=staticIpAddr, fileType=fileType, wan=wan, lanportName=lanportName, staticIpDomainName=staticIpDomainName, rebootEnable=rebootEnable, vlan=vlan, txPower=txPower, xg6846=xg6846, staticIpGateway=staticIpGateway, qmode=qmode, domainame=domainame, bias=bias, groupEntry=groupEntry, statIndex=statIndex, staticIpPrimaryDns=staticIpPrimaryDns, vendorName=vendorName, groupIndex=groupIndex, broadcastsReceived=broadcastsReceived)
