...
# Produced by pysmi-1.1.10 at Thu Oct 26 13:09:43 2023
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Counter64, NotificationType, snmpModules, ObjectIdentity, iso, MibIdentifier, ModuleIdentity, TimeTicks, Bits, Unsigned32, mib_2, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Counter64", "NotificationType", "snmpModules", "ObjectIdentity", "iso", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Bits", "Unsigned32", "mib-2", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlangroupTable=vlangroupTable, portIndex=portIndex, jumblan1=jumblan1, dscpEnable=dscpEnable, statIndex=statIndex, tftp=tftp, staticIpSecondaryDns=staticIpSecondaryDns, jumbwan=jumbwan, port3=port3, wan=wan, jumblan4=jumblan4, unicastsReceived=unicastsReceived, vlan=vlan, wanType=wanType, groupIndex=groupIndex, hostname=hostname, lanportIndex=lanportIndex, port4=port4, temperature=temperature, broadcastsReceived=broadcastsReceived, rxPower=rxPower, internetPort=internetPort, portPower=portPower, fileName=fileName, speed=speed, operStatus=operStatus, lanportName=lanportName, reboot=reboot, staticIpPrimaryDns=staticIpPrimaryDns, vendorOui=vendorOui, fcsErrorTransmitted=fcsErrorTransmitted, statisticTable=statisticTable, staticIpGateway=staticIpGateway, deviceinfo=deviceinfo, catvEnable=catvEnable, lan4=lan4, lanportspeed=lanportspeed, serialnum=serialnum, groupid=groupid, jumblan2=jumblan2, unicastsTransmitted=unicastsTransmitted, fcsErrorReceived=fcsErrorReceived, vendorRev=vendorRev, portmode=portmode, broadcastsTransmitted=broadcastsTransmitted, secondaryDns=secondaryDns, multicastsTransmitted=multicastsTransmitted, portTable=portTable, lanportpause=lanportpause, multicastsReceived=multicastsReceived, vendorPn=vendorPn, tftpSevIp=tftpSevIp, action=action, voltage=voltage, vendorName=vendorName, qosIndex=qosIndex, qmapping=qmapping, priority=priority, lan3=lan3, portEntry=portEntry, primaryDns=primaryDns, fileType=fileType, portStatistic=portStatistic, port2=port2, catv=catv, staticIpSubMask=staticIpSubMask, staticDns=staticDns, staticIpAddr=staticIpAddr, qmode=qmode, modeEntry=modeEntry, qosEntry=qosEntry, lan2=lan2, ddminfo=ddminfo, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, xg6846=xg6846, bias=bias, pauseReceived=pauseReceived, portStatEntry=portStatEntry, lan1=lan1, groupEntry=groupEntry, qosTable=qosTable, rebootEnable=rebootEnable, pauseTransmitted=pauseTransmitted, port1=port1, portName=portName, domainame=domainame, jumblan3=jumblan3, jumb=jumb, staticIpHostName=staticIpHostName, vlanid=vlanid, adminStatus=adminStatus, qos=qos, txPower=txPower)
