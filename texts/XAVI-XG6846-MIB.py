...
# Produced by pysmi-1.1.8 at Mon Feb  7 16:15:05 2022
...
iso, snmpModules, IpAddress, Integer32, NotificationType, mib_2, Unsigned32, ModuleIdentity, Gauge32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, Bits, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "snmpModules", "IpAddress", "Integer32", "NotificationType", "mib-2", "Unsigned32", "ModuleIdentity", "Gauge32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "Bits", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", groupIndex=groupIndex, port2=port2, dscpEnable=dscpEnable, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted, lanportTable=lanportTable, jumb=jumb, qosIndex=qosIndex, staticDns=staticDns, voltage=voltage, portStatistic=portStatistic, portName=portName, fileType=fileType, vendorPn=vendorPn, jumblan2=jumblan2, vendorName=vendorName, groupid=groupid, port4=port4, staticIpAddr=staticIpAddr, vlan=vlan, speed=speed, lan2=lan2, qmode=qmode, pauseTransmitted=pauseTransmitted, portIndex=portIndex, fcsErrorTransmitted=fcsErrorTransmitted, staticIpGateway=staticIpGateway, statisticTable=statisticTable, qos=qos, unicastsTransmitted=unicastsTransmitted, ddminfo=ddminfo, reboot=reboot, staticIpSubMask=staticIpSubMask, portmode=portmode, catv=catv, portStatEntry=portStatEntry, port1=port1, vendorRev=vendorRev, jumbwan=jumbwan, portEntry=portEntry, portTable=portTable, groupEntry=groupEntry, action=action, tftp=tftp, modeEntry=modeEntry, rebootEnable=rebootEnable, deviceinfo=deviceinfo, lan4=lan4, broadcastsTransmitted=broadcastsTransmitted, operStatus=operStatus, tftpSevIp=tftpSevIp, qmapping=qmapping, wanType=wanType, lanportName=lanportName, lan3=lan3, rxPower=rxPower, jumblan4=jumblan4, vlanid=vlanid, priority=priority, xg6846=xg6846, fcsErrorReceived=fcsErrorReceived, pauseReceived=pauseReceived, lanportspeed=lanportspeed, staticIpSecondaryDns=staticIpSecondaryDns, lanportpause=lanportpause, unicastsReceived=unicastsReceived, fileName=fileName, qosEntry=qosEntry, secondaryDns=secondaryDns, wan=wan, bias=bias, lan1=lan1, jumblan3=jumblan3, staticIpDomainName=staticIpDomainName, temperature=temperature, primaryDns=primaryDns, multicastsReceived=multicastsReceived, hostname=hostname, broadcastsReceived=broadcastsReceived, catvEnable=catvEnable, internetPort=internetPort, portPower=portPower, vendorOui=vendorOui, statIndex=statIndex, txPower=txPower, staticIpPrimaryDns=staticIpPrimaryDns, serialnum=serialnum, staticIpHostName=staticIpHostName, qosTable=qosTable, lanportIndex=lanportIndex, jumblan1=jumblan1, domainame=domainame, adminStatus=adminStatus, port3=port3)
