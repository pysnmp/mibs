...
Counter32, Gauge32, enterprises, IpAddress, NotificationType, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ModuleIdentity, MibIdentifier, ObjectIdentity, Unsigned32, snmpModules, Integer32, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "enterprises", "IpAddress", "NotificationType", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "Unsigned32", "snmpModules", "Integer32", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsReceived=unicastsReceived, internetPort=internetPort, lanportpause=lanportpause, lan4=lan4, jumb=jumb, staticIpDomainName=staticIpDomainName, fileName=fileName, qosIndex=qosIndex, deviceinfo=deviceinfo, qosTable=qosTable, staticIpGateway=staticIpGateway, staticIpPrimaryDns=staticIpPrimaryDns, reboot=reboot, staticIpAddr=staticIpAddr, qmapping=qmapping, lanportspeed=lanportspeed, lanportTable=lanportTable, pauseReceived=pauseReceived, lanportIndex=lanportIndex, vlan=vlan, staticIpSubMask=staticIpSubMask, rebootEnable=rebootEnable, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, serialnum=serialnum, action=action, groupEntry=groupEntry, lan2=lan2, catvEnable=catvEnable, port3=port3, portIndex=portIndex, lan3=lan3, fcsErrorReceived=fcsErrorReceived, tftpSevIp=tftpSevIp, statIndex=statIndex, jumblan3=jumblan3, voltage=voltage, catv=catv, modeEntry=modeEntry, staticDns=staticDns, vendorOui=vendorOui, fileType=fileType, jumbwan=jumbwan, wanType=wanType, bias=bias, vlanid=vlanid, portName=portName, vlangroupTable=vlangroupTable, vendorName=vendorName, rxPower=rxPower, port4=port4, vendorPn=vendorPn, portStatEntry=portStatEntry, lanportName=lanportName, tftp=tftp, adminStatus=adminStatus, wan=wan, xg6846=xg6846, jumblan2=jumblan2, temperature=temperature, operStatus=operStatus, port2=port2, qosEntry=qosEntry, domainame=domainame, jumblan1=jumblan1, qmode=qmode, txPower=txPower, portStatistic=portStatistic, ddminfo=ddminfo, multicastsReceived=multicastsReceived, port1=port1, portTable=portTable, portEntry=portEntry, unicastsTransmitted=unicastsTransmitted, broadcastsReceived=broadcastsReceived, secondaryDns=secondaryDns, jumblan4=jumblan4, staticIpSecondaryDns=staticIpSecondaryDns, lan1=lan1, staticIpHostName=staticIpHostName, priority=priority, statisticTable=statisticTable, portPower=portPower, dscpEnable=dscpEnable, pauseTransmitted=pauseTransmitted, fcsErrorTransmitted=fcsErrorTransmitted, portmode=portmode, groupIndex=groupIndex, vendorRev=vendorRev, multicastsTransmitted=multicastsTransmitted, primaryDns=primaryDns, speed=speed, groupid=groupid, qos=qos)
