...
# Produced by pysmi-1.1.8 at Thu Apr 27 10:06:15 2023
...
Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, enterprises, Counter64, Gauge32, Counter32, snmpModules, iso, TimeTicks, Unsigned32, MibIdentifier, ModuleIdentity, ObjectIdentity, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "enterprises", "Counter64", "Gauge32", "Counter32", "snmpModules", "iso", "TimeTicks", "Unsigned32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lanportName=lanportName, hostname=hostname, fileType=fileType, port4=port4, wan=wan, ddminfo=ddminfo, primaryDns=primaryDns, qmode=qmode, operStatus=operStatus, groupIndex=groupIndex, secondaryDns=secondaryDns, speed=speed, vendorOui=vendorOui, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, staticIpDomainName=staticIpDomainName, tftpSevIp=tftpSevIp, vendorRev=vendorRev, groupEntry=groupEntry, vendorPn=vendorPn, jumb=jumb, catvEnable=catvEnable, vlan=vlan, jumbwan=jumbwan, fileName=fileName, port2=port2, lan3=lan3, modeEntry=modeEntry, statisticTable=statisticTable, port1=port1, adminStatus=adminStatus, statIndex=statIndex, staticIpHostName=staticIpHostName, deviceinfo=deviceinfo, vlangroupTable=vlangroupTable, reboot=reboot, lan2=lan2, staticIpSubMask=staticIpSubMask, portStatistic=portStatistic, lanportIndex=lanportIndex, staticIpSecondaryDns=staticIpSecondaryDns, vlanid=vlanid, broadcastsReceived=broadcastsReceived, portmode=portmode, wanType=wanType, lanportTable=lanportTable, groupid=groupid, portStatEntry=portStatEntry, qmapping=qmapping, qosTable=qosTable, qosIndex=qosIndex, pauseReceived=pauseReceived, unicastsReceived=unicastsReceived, temperature=temperature, bias=bias, port3=port3, dscpEnable=dscpEnable, portEntry=portEntry, rebootEnable=rebootEnable, lanportpause=lanportpause, priority=priority, portIndex=portIndex, voltage=voltage, fcsErrorReceived=fcsErrorReceived, pauseTransmitted=pauseTransmitted, portTable=portTable, lan1=lan1, jumblan1=jumblan1, catv=catv, jumblan2=jumblan2, jumblan3=jumblan3, internetPort=internetPort, multicastsTransmitted=multicastsTransmitted, lan4=lan4, domainame=domainame, lanportspeed=lanportspeed, qos=qos, portPower=portPower, rxPower=rxPower, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, staticIpPrimaryDns=staticIpPrimaryDns, qosEntry=qosEntry, vendorName=vendorName, xg6846=xg6846, portName=portName, jumblan4=jumblan4, txPower=txPower, tftp=tftp, fcsErrorTransmitted=fcsErrorTransmitted, action=action, staticDns=staticDns, serialnum=serialnum, broadcastsTransmitted=broadcastsTransmitted)
