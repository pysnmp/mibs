...
NotificationType, Gauge32, mib_2, Unsigned32, snmpModules, iso, Bits, ObjectIdentity, MibIdentifier, Counter64, IpAddress, TimeTicks, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "mib-2", "Unsigned32", "snmpModules", "iso", "Bits", "ObjectIdentity", "MibIdentifier", "Counter64", "IpAddress", "TimeTicks", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", lan1=lan1, xg6846=xg6846, staticIpAddr=staticIpAddr, internetPort=internetPort, action=action, bias=bias, portName=portName, statisticTable=statisticTable, temperature=temperature, priority=priority, staticIpHostName=staticIpHostName, vlan=vlan, adminStatus=adminStatus, ddminfo=ddminfo, lanportpause=lanportpause, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, secondaryDns=secondaryDns, staticDns=staticDns, staticIpSecondaryDns=staticIpSecondaryDns, catvEnable=catvEnable, dscpEnable=dscpEnable, vendorRev=vendorRev, qmode=qmode, portPower=portPower, fcsErrorReceived=fcsErrorReceived, groupIndex=groupIndex, qmapping=qmapping, tftpSevIp=tftpSevIp, jumblan1=jumblan1, wanType=wanType, deviceinfo=deviceinfo, groupid=groupid, port1=port1, vendorPn=vendorPn, staticIpSubMask=staticIpSubMask, fcsErrorTransmitted=fcsErrorTransmitted, statIndex=statIndex, serialnum=serialnum, port4=port4, lanportspeed=lanportspeed, lanportIndex=lanportIndex, staticIpDomainName=staticIpDomainName, multicastsReceived=multicastsReceived, portTable=portTable, rebootEnable=rebootEnable, vendorOui=vendorOui, tftp=tftp, qosIndex=qosIndex, multicastsTransmitted=multicastsTransmitted, modeEntry=modeEntry, jumbwan=jumbwan, pauseReceived=pauseReceived, staticIpGateway=staticIpGateway, jumblan2=jumblan2, vendorName=vendorName, jumb=jumb, staticIpPrimaryDns=staticIpPrimaryDns, voltage=voltage, qos=qos, portmode=portmode, lanportName=lanportName, wan=wan, portEntry=portEntry, vlangroupTable=vlangroupTable, jumblan4=jumblan4, fileName=fileName, groupEntry=groupEntry, portStatistic=portStatistic, primaryDns=primaryDns, domainame=domainame, broadcastsTransmitted=broadcastsTransmitted, port2=port2, hostname=hostname, unicastsReceived=unicastsReceived, operStatus=operStatus, unicastsTransmitted=unicastsTransmitted, portIndex=portIndex, jumblan3=jumblan3, lan4=lan4, reboot=reboot, speed=speed, qosEntry=qosEntry, portStatEntry=portStatEntry, txPower=txPower, lanportTable=lanportTable, lan2=lan2, fileType=fileType, catv=catv, vlanid=vlanid, qosTable=qosTable, port3=port3, lan3=lan3, rxPower=rxPower)
