...
Unsigned32, NotificationType, ObjectIdentity, ModuleIdentity, Bits, enterprises, mib_2, snmpModules, iso, TimeTicks, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Bits", "enterprises", "mib-2", "snmpModules", "iso", "TimeTicks", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosTable=qosTable, portName=portName, lanportName=lanportName, adminStatus=adminStatus, rxPower=rxPower, speed=speed, portStatistic=portStatistic, vendorName=vendorName, staticIpDomainName=staticIpDomainName, statIndex=statIndex, primaryDns=primaryDns, wanType=wanType, catv=catv, jumbwan=jumbwan, reboot=reboot, port3=port3, portEntry=portEntry, portIndex=portIndex, tftp=tftp, broadcastsReceived=broadcastsReceived, vendorOui=vendorOui, deviceinfo=deviceinfo, jumblan3=jumblan3, serialnum=serialnum, port2=port2, jumb=jumb, staticIpSecondaryDns=staticIpSecondaryDns, groupIndex=groupIndex, catvEnable=catvEnable, operStatus=operStatus, priority=priority, vendorRev=vendorRev, unicastsReceived=unicastsReceived, domainame=domainame, wan=wan, voltage=voltage, groupEntry=groupEntry, multicastsReceived=multicastsReceived, portTable=portTable, internetPort=internetPort, lan4=lan4, broadcastsTransmitted=broadcastsTransmitted, hostname=hostname, vlanid=vlanid, staticIpAddr=staticIpAddr, groupid=groupid, jumblan4=jumblan4, staticIpHostName=staticIpHostName, pauseTransmitted=pauseTransmitted, lan1=lan1, secondaryDns=secondaryDns, staticIpPrimaryDns=staticIpPrimaryDns, xg6846=xg6846, multicastsTransmitted=multicastsTransmitted, ddminfo=ddminfo, staticDns=staticDns, modeEntry=modeEntry, lanportTable=lanportTable, fileType=fileType, unicastsTransmitted=unicastsTransmitted, fileName=fileName, dscpEnable=dscpEnable, lan3=lan3, txPower=txPower, portmode=portmode, jumblan2=jumblan2, fcsErrorReceived=fcsErrorReceived, vendorPn=vendorPn, vlangroupTable=vlangroupTable, lanportIndex=lanportIndex, qmapping=qmapping, temperature=temperature, qosEntry=qosEntry, tftpSevIp=tftpSevIp, qosIndex=qosIndex, portStatEntry=portStatEntry, staticIpSubMask=staticIpSubMask, qos=qos, statisticTable=statisticTable, lanportspeed=lanportspeed, action=action, lanportpause=lanportpause, fcsErrorTransmitted=fcsErrorTransmitted, jumblan1=jumblan1, bias=bias, port1=port1, pauseReceived=pauseReceived, port4=port4, staticIpGateway=staticIpGateway, lan2=lan2, portPower=portPower, qmode=qmode, vlan=vlan, rebootEnable=rebootEnable)
