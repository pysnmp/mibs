...
NotificationType, TimeTicks, Integer32, Gauge32, mib_2, ObjectIdentity, Unsigned32, Counter32, iso, MibIdentifier, Counter64, Bits, snmpModules, enterprises, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Integer32", "Gauge32", "mib-2", "ObjectIdentity", "Unsigned32", "Counter32", "iso", "MibIdentifier", "Counter64", "Bits", "snmpModules", "enterprises", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portName=portName, bias=bias, lanportTable=lanportTable, pauseReceived=pauseReceived, operStatus=operStatus, fcsErrorReceived=fcsErrorReceived, port3=port3, staticIpAddr=staticIpAddr, portmode=portmode, catvEnable=catvEnable, staticIpDomainName=staticIpDomainName, ddminfo=ddminfo, vendorPn=vendorPn, portPower=portPower, vendorOui=vendorOui, lan4=lan4, unicastsTransmitted=unicastsTransmitted, groupEntry=groupEntry, fileName=fileName, rxPower=rxPower, jumblan3=jumblan3, tftpSevIp=tftpSevIp, domainame=domainame, portIndex=portIndex, serialnum=serialnum, wanType=wanType, portTable=portTable, portStatistic=portStatistic, lan2=lan2, jumblan2=jumblan2, qosIndex=qosIndex, catv=catv, groupid=groupid, qos=qos, vendorRev=vendorRev, qmapping=qmapping, portEntry=portEntry, broadcastsTransmitted=broadcastsTransmitted, secondaryDns=secondaryDns, voltage=voltage, lanportspeed=lanportspeed, staticIpPrimaryDns=staticIpPrimaryDns, fileType=fileType, tftp=tftp, lan3=lan3, staticIpSubMask=staticIpSubMask, deviceinfo=deviceinfo, staticIpGateway=staticIpGateway, port1=port1, pauseTransmitted=pauseTransmitted, txPower=txPower, vlanid=vlanid, reboot=reboot, lanportpause=lanportpause, jumb=jumb, lan1=lan1, jumblan1=jumblan1, xg6846=xg6846, lanportName=lanportName, vlangroupTable=vlangroupTable, staticDns=staticDns, speed=speed, vendorName=vendorName, vlan=vlan, rebootEnable=rebootEnable, portStatEntry=portStatEntry, modeEntry=modeEntry, multicastsTransmitted=multicastsTransmitted, staticIpHostName=staticIpHostName, fcsErrorTransmitted=fcsErrorTransmitted, qmode=qmode, unicastsReceived=unicastsReceived, hostname=hostname, multicastsReceived=multicastsReceived, statisticTable=statisticTable, lanportIndex=lanportIndex, jumblan4=jumblan4, groupIndex=groupIndex, dscpEnable=dscpEnable, broadcastsReceived=broadcastsReceived, priority=priority, statIndex=statIndex, qosEntry=qosEntry, jumbwan=jumbwan, port2=port2, port4=port4, internetPort=internetPort, adminStatus=adminStatus, wan=wan, action=action, qosTable=qosTable, staticIpSecondaryDns=staticIpSecondaryDns, primaryDns=primaryDns, temperature=temperature)
