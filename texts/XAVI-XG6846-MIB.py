...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:00:30 2023
...
Counter32, iso, mib_2, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Unsigned32, ObjectIdentity, Gauge32, MibIdentifier, Counter64, ModuleIdentity, NotificationType, snmpModules, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "iso", "mib-2", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Unsigned32", "ObjectIdentity", "Gauge32", "MibIdentifier", "Counter64", "ModuleIdentity", "NotificationType", "snmpModules", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", multicastsReceived=multicastsReceived, fileType=fileType, fcsErrorReceived=fcsErrorReceived, fcsErrorTransmitted=fcsErrorTransmitted, staticIpGateway=staticIpGateway, multicastsTransmitted=multicastsTransmitted, vendorPn=vendorPn, tftpSevIp=tftpSevIp, port3=port3, unicastsReceived=unicastsReceived, lan4=lan4, secondaryDns=secondaryDns, catvEnable=catvEnable, jumblan2=jumblan2, wanType=wanType, txPower=txPower, qosTable=qosTable, xg6846=xg6846, jumb=jumb, staticIpAddr=staticIpAddr, lan3=lan3, tftp=tftp, portmode=portmode, lan2=lan2, port4=port4, voltage=voltage, vendorName=vendorName, portStatEntry=portStatEntry, reboot=reboot, broadcastsReceived=broadcastsReceived, statIndex=statIndex, staticIpHostName=staticIpHostName, qmapping=qmapping, dscpEnable=dscpEnable, qos=qos, qmode=qmode, portPower=portPower, vlangroupTable=vlangroupTable, lan1=lan1, speed=speed, statisticTable=statisticTable, jumbwan=jumbwan, pauseReceived=pauseReceived, lanportspeed=lanportspeed, modeEntry=modeEntry, lanportpause=lanportpause, unicastsTransmitted=unicastsTransmitted, portStatistic=portStatistic, internetPort=internetPort, qosEntry=qosEntry, portTable=portTable, rebootEnable=rebootEnable, temperature=temperature, lanportIndex=lanportIndex, groupIndex=groupIndex, lanportTable=lanportTable, groupEntry=groupEntry, ddminfo=ddminfo, jumblan1=jumblan1, jumblan3=jumblan3, lanportName=lanportName, serialnum=serialnum, staticIpPrimaryDns=staticIpPrimaryDns, vlan=vlan, port1=port1, staticIpSecondaryDns=staticIpSecondaryDns, operStatus=operStatus, vendorOui=vendorOui, action=action, port2=port2, jumblan4=jumblan4, catv=catv, staticDns=staticDns, staticIpSubMask=staticIpSubMask, vlanid=vlanid, vendorRev=vendorRev, priority=priority, domainame=domainame, qosIndex=qosIndex, bias=bias, portName=portName, wan=wan, staticIpDomainName=staticIpDomainName, groupid=groupid, pauseTransmitted=pauseTransmitted, fileName=fileName, rxPower=rxPower, portEntry=portEntry, broadcastsTransmitted=broadcastsTransmitted, deviceinfo=deviceinfo, primaryDns=primaryDns, portIndex=portIndex, hostname=hostname, adminStatus=adminStatus)
