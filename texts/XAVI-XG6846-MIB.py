...
mib_2, ModuleIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, iso, ObjectIdentity, Bits, Counter64, IpAddress, Integer32, Gauge32, MibIdentifier, enterprises, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "ModuleIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "iso", "ObjectIdentity", "Bits", "Counter64", "IpAddress", "Integer32", "Gauge32", "MibIdentifier", "enterprises", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", temperature=temperature, tftp=tftp, groupIndex=groupIndex, staticIpDomainName=staticIpDomainName, dscpEnable=dscpEnable, voltage=voltage, rxPower=rxPower, fileType=fileType, operStatus=operStatus, portmode=portmode, jumbwan=jumbwan, unicastsTransmitted=unicastsTransmitted, fileName=fileName, action=action, wanType=wanType, portName=portName, jumblan4=jumblan4, broadcastsReceived=broadcastsReceived, vlanid=vlanid, serialnum=serialnum, lan4=lan4, lanportpause=lanportpause, port2=port2, portIndex=portIndex, port3=port3, reboot=reboot, speed=speed, priority=priority, staticIpSubMask=staticIpSubMask, statIndex=statIndex, qosTable=qosTable, qos=qos, catvEnable=catvEnable, jumblan3=jumblan3, lanportTable=lanportTable, pauseReceived=pauseReceived, hostname=hostname, qosIndex=qosIndex, vendorName=vendorName, lanportIndex=lanportIndex, vlan=vlan, staticDns=staticDns, groupEntry=groupEntry, staticIpSecondaryDns=staticIpSecondaryDns, statisticTable=statisticTable, staticIpHostName=staticIpHostName, tftpSevIp=tftpSevIp, internetPort=internetPort, ddminfo=ddminfo, qmapping=qmapping, jumblan1=jumblan1, primaryDns=primaryDns, rebootEnable=rebootEnable, groupid=groupid, adminStatus=adminStatus, fcsErrorTransmitted=fcsErrorTransmitted, multicastsTransmitted=multicastsTransmitted, lan3=lan3, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, wan=wan, lan2=lan2, vlangroupTable=vlangroupTable, portEntry=portEntry, modeEntry=modeEntry, vendorRev=vendorRev, qmode=qmode, pauseTransmitted=pauseTransmitted, portStatEntry=portStatEntry, vendorOui=vendorOui, fcsErrorReceived=fcsErrorReceived, domainame=domainame, staticIpGateway=staticIpGateway, secondaryDns=secondaryDns, lanportName=lanportName, broadcastsTransmitted=broadcastsTransmitted, vendorPn=vendorPn, qosEntry=qosEntry, port4=port4, staticIpPrimaryDns=staticIpPrimaryDns, portStatistic=portStatistic, bias=bias, portPower=portPower, unicastsReceived=unicastsReceived, catv=catv, jumb=jumb, deviceinfo=deviceinfo, port1=port1, jumblan2=jumblan2, lan1=lan1, portTable=portTable, lanportspeed=lanportspeed, xg6846=xg6846, txPower=txPower)
