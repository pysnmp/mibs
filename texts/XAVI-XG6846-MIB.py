...
iso, ObjectIdentity, Counter32, mib_2, Unsigned32, Counter64, Integer32, TimeTicks, MibIdentifier, Gauge32, enterprises, NotificationType, snmpModules, ModuleIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Counter32", "mib-2", "Unsigned32", "Counter64", "Integer32", "TimeTicks", "MibIdentifier", "Gauge32", "enterprises", "NotificationType", "snmpModules", "ModuleIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", port4=port4, qosEntry=qosEntry, pauseTransmitted=pauseTransmitted, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, portPower=portPower, portIndex=portIndex, staticIpSecondaryDns=staticIpSecondaryDns, groupIndex=groupIndex, qos=qos, temperature=temperature, port1=port1, fileType=fileType, lanportName=lanportName, fcsErrorReceived=fcsErrorReceived, domainame=domainame, jumblan2=jumblan2, qosTable=qosTable, priority=priority, secondaryDns=secondaryDns, lanportIndex=lanportIndex, tftpSevIp=tftpSevIp, unicastsReceived=unicastsReceived, staticIpDomainName=staticIpDomainName, lan4=lan4, statIndex=statIndex, unicastsTransmitted=unicastsTransmitted, rebootEnable=rebootEnable, staticIpGateway=staticIpGateway, portStatEntry=portStatEntry, portEntry=portEntry, adminStatus=adminStatus, deviceinfo=deviceinfo, groupEntry=groupEntry, portName=portName, statisticTable=statisticTable, tftp=tftp, fileName=fileName, qosIndex=qosIndex, lan2=lan2, primaryDns=primaryDns, port2=port2, vendorOui=vendorOui, voltage=voltage, xg6846=xg6846, vlangroupTable=vlangroupTable, action=action, portTable=portTable, lan3=lan3, multicastsReceived=multicastsReceived, lanportspeed=lanportspeed, staticIpSubMask=staticIpSubMask, staticIpHostName=staticIpHostName, wan=wan, lanportTable=lanportTable, pauseReceived=pauseReceived, staticIpPrimaryDns=staticIpPrimaryDns, vendorRev=vendorRev, catv=catv, lan1=lan1, vlan=vlan, internetPort=internetPort, vlanid=vlanid, bias=bias, serialnum=serialnum, port3=port3, vendorPn=vendorPn, txPower=txPower, qmapping=qmapping, qmode=qmode, jumblan1=jumblan1, jumb=jumb, dscpEnable=dscpEnable, modeEntry=modeEntry, jumbwan=jumbwan, portmode=portmode, broadcastsReceived=broadcastsReceived, jumblan3=jumblan3, rxPower=rxPower, jumblan4=jumblan4, hostname=hostname, lanportpause=lanportpause, vendorName=vendorName, staticIpAddr=staticIpAddr, catvEnable=catvEnable, portStatistic=portStatistic, ddminfo=ddminfo, fcsErrorTransmitted=fcsErrorTransmitted, reboot=reboot, multicastsTransmitted=multicastsTransmitted, speed=speed, wanType=wanType, staticDns=staticDns, operStatus=operStatus)
