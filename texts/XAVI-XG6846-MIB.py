...
mib_2, Counter32, MibIdentifier, iso, Integer32, snmpModules, ObjectIdentity, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, NotificationType, Gauge32, enterprises, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "Counter32", "MibIdentifier", "iso", "Integer32", "snmpModules", "ObjectIdentity", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "NotificationType", "Gauge32", "enterprises", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", rxPower=rxPower, port4=port4, broadcastsTransmitted=broadcastsTransmitted, tftpSevIp=tftpSevIp, qmapping=qmapping, dscpEnable=dscpEnable, wan=wan, deviceinfo=deviceinfo, vendorRev=vendorRev, port1=port1, catvEnable=catvEnable, jumblan3=jumblan3, vlanid=vlanid, multicastsTransmitted=multicastsTransmitted, staticIpAddr=staticIpAddr, portmode=portmode, catv=catv, tftp=tftp, temperature=temperature, vlangroupTable=vlangroupTable, broadcastsReceived=broadcastsReceived, qos=qos, action=action, staticIpGateway=staticIpGateway, txPower=txPower, fcsErrorReceived=fcsErrorReceived, portTable=portTable, qosEntry=qosEntry, adminStatus=adminStatus, groupid=groupid, staticIpHostName=staticIpHostName, qosTable=qosTable, jumb=jumb, jumbwan=jumbwan, portName=portName, staticIpSubMask=staticIpSubMask, pauseTransmitted=pauseTransmitted, reboot=reboot, lanportTable=lanportTable, ddminfo=ddminfo, wanType=wanType, staticIpSecondaryDns=staticIpSecondaryDns, vendorOui=vendorOui, portStatEntry=portStatEntry, priority=priority, lanportpause=lanportpause, unicastsReceived=unicastsReceived, qmode=qmode, domainame=domainame, lan4=lan4, secondaryDns=secondaryDns, lanportspeed=lanportspeed, modeEntry=modeEntry, multicastsReceived=multicastsReceived, vendorName=vendorName, internetPort=internetPort, lanportIndex=lanportIndex, portStatistic=portStatistic, fileType=fileType, jumblan1=jumblan1, hostname=hostname, operStatus=operStatus, port3=port3, xg6846=xg6846, groupIndex=groupIndex, primaryDns=primaryDns, serialnum=serialnum, staticDns=staticDns, pauseReceived=pauseReceived, jumblan4=jumblan4, lanportName=lanportName, statisticTable=statisticTable, fcsErrorTransmitted=fcsErrorTransmitted, portPower=portPower, lan3=lan3, port2=port2, rebootEnable=rebootEnable, vendorPn=vendorPn, jumblan2=jumblan2, voltage=voltage, vlan=vlan, lan1=lan1, bias=bias, fileName=fileName, portIndex=portIndex, portEntry=portEntry, lan2=lan2, speed=speed, statIndex=statIndex, groupEntry=groupEntry, staticIpPrimaryDns=staticIpPrimaryDns, qosIndex=qosIndex, staticIpDomainName=staticIpDomainName, unicastsTransmitted=unicastsTransmitted)
