...
MibIdentifier, Integer32, enterprises, ModuleIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, mib_2, iso, snmpModules, Gauge32, ObjectIdentity, Unsigned32, Counter32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "enterprises", "ModuleIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "mib-2", "iso", "snmpModules", "Gauge32", "ObjectIdentity", "Unsigned32", "Counter32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", xg6846=xg6846, portIndex=portIndex, pauseTransmitted=pauseTransmitted, lan3=lan3, vlangroupTable=vlangroupTable, groupIndex=groupIndex, staticDns=staticDns, primaryDns=primaryDns, vendorName=vendorName, wan=wan, catv=catv, staticIpAddr=staticIpAddr, qosEntry=qosEntry, rebootEnable=rebootEnable, fileType=fileType, hostname=hostname, action=action, qmapping=qmapping, lanportpause=lanportpause, port3=port3, unicastsReceived=unicastsReceived, broadcastsTransmitted=broadcastsTransmitted, qosTable=qosTable, adminStatus=adminStatus, reboot=reboot, vendorRev=vendorRev, portName=portName, statisticTable=statisticTable, port1=port1, portmode=portmode, groupid=groupid, portTable=portTable, temperature=temperature, domainame=domainame, broadcastsReceived=broadcastsReceived, priority=priority, tftpSevIp=tftpSevIp, fileName=fileName, jumblan4=jumblan4, jumblan3=jumblan3, secondaryDns=secondaryDns, operStatus=operStatus, staticIpDomainName=staticIpDomainName, statIndex=statIndex, portStatEntry=portStatEntry, lan2=lan2, staticIpPrimaryDns=staticIpPrimaryDns, jumb=jumb, lanportTable=lanportTable, portStatistic=portStatistic, serialnum=serialnum, voltage=voltage, qmode=qmode, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, vendorPn=vendorPn, jumblan2=jumblan2, internetPort=internetPort, bias=bias, vlan=vlan, fcsErrorReceived=fcsErrorReceived, tftp=tftp, port2=port2, port4=port4, txPower=txPower, pauseReceived=pauseReceived, multicastsTransmitted=multicastsTransmitted, rxPower=rxPower, catvEnable=catvEnable, groupEntry=groupEntry, staticIpSecondaryDns=staticIpSecondaryDns, vlanid=vlanid, portPower=portPower, vendorOui=vendorOui, staticIpGateway=staticIpGateway, qosIndex=qosIndex, qos=qos, jumbwan=jumbwan, lan1=lan1, dscpEnable=dscpEnable, staticIpSubMask=staticIpSubMask, modeEntry=modeEntry, lanportName=lanportName, lan4=lan4, ddminfo=ddminfo, speed=speed, fcsErrorTransmitted=fcsErrorTransmitted, portEntry=portEntry, wanType=wanType, jumblan1=jumblan1, staticIpHostName=staticIpHostName, lanportspeed=lanportspeed, lanportIndex=lanportIndex, multicastsReceived=multicastsReceived)
