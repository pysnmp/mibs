...
# Produced by pysmi-1.1.8 at Thu Sep  8 10:20:23 2022
...
iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, snmpModules, Unsigned32, NotificationType, mib_2, Integer32, IpAddress, Counter32, Bits, enterprises, TimeTicks, ModuleIdentity, ObjectIdentity, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "snmpModules", "Unsigned32", "NotificationType", "mib-2", "Integer32", "IpAddress", "Counter32", "Bits", "enterprises", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", fileName=fileName, staticDns=staticDns, dscpEnable=dscpEnable, portStatEntry=portStatEntry, deviceinfo=deviceinfo, portPower=portPower, qosEntry=qosEntry, groupid=groupid, ddminfo=ddminfo, jumblan3=jumblan3, portTable=portTable, multicastsReceived=multicastsReceived, lan1=lan1, hostname=hostname, fileType=fileType, fcsErrorTransmitted=fcsErrorTransmitted, qosTable=qosTable, port2=port2, jumbwan=jumbwan, fcsErrorReceived=fcsErrorReceived, bias=bias, wanType=wanType, port4=port4, staticIpPrimaryDns=staticIpPrimaryDns, speed=speed, qmapping=qmapping, lan3=lan3, vlan=vlan, vendorRev=vendorRev, priority=priority, vendorName=vendorName, rebootEnable=rebootEnable, txPower=txPower, operStatus=operStatus, internetPort=internetPort, qosIndex=qosIndex, statisticTable=statisticTable, vendorPn=vendorPn, lan4=lan4, portIndex=portIndex, qmode=qmode, jumblan4=jumblan4, catvEnable=catvEnable, qos=qos, action=action, tftp=tftp, unicastsReceived=unicastsReceived, portName=portName, jumblan2=jumblan2, pauseTransmitted=pauseTransmitted, jumblan1=jumblan1, jumb=jumb, staticIpDomainName=staticIpDomainName, domainame=domainame, xg6846=xg6846, lanportTable=lanportTable, reboot=reboot, staticIpSubMask=staticIpSubMask, secondaryDns=secondaryDns, statIndex=statIndex, lanportIndex=lanportIndex, broadcastsTransmitted=broadcastsTransmitted, wan=wan, pauseReceived=pauseReceived, lanportName=lanportName, staticIpSecondaryDns=staticIpSecondaryDns, rxPower=rxPower, unicastsTransmitted=unicastsTransmitted, staticIpGateway=staticIpGateway, portStatistic=portStatistic, catv=catv, groupEntry=groupEntry, staticIpHostName=staticIpHostName, multicastsTransmitted=multicastsTransmitted, portEntry=portEntry, broadcastsReceived=broadcastsReceived, port3=port3, primaryDns=primaryDns, staticIpAddr=staticIpAddr, groupIndex=groupIndex, lan2=lan2, vlangroupTable=vlangroupTable, portmode=portmode, lanportpause=lanportpause, temperature=temperature, voltage=voltage, tftpSevIp=tftpSevIp, modeEntry=modeEntry, vendorOui=vendorOui, port1=port1, serialnum=serialnum, lanportspeed=lanportspeed, vlanid=vlanid, adminStatus=adminStatus)
