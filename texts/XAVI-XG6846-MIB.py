...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:56:24 2021
...
Integer32, TimeTicks, enterprises, MibIdentifier, snmpModules, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, Bits, Gauge32, Unsigned32, ObjectIdentity, Counter64, iso, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "enterprises", "MibIdentifier", "snmpModules", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "Bits", "Gauge32", "Unsigned32", "ObjectIdentity", "Counter64", "iso", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", reboot=reboot, qmode=qmode, dscpEnable=dscpEnable, staticIpDomainName=staticIpDomainName, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, staticIpSubMask=staticIpSubMask, pauseTransmitted=pauseTransmitted, groupIndex=groupIndex, operStatus=operStatus, fileType=fileType, portStatistic=portStatistic, lan1=lan1, jumblan1=jumblan1, serialnum=serialnum, speed=speed, wan=wan, lanportpause=lanportpause, pauseReceived=pauseReceived, primaryDns=primaryDns, staticIpAddr=staticIpAddr, lanportIndex=lanportIndex, lan3=lan3, groupEntry=groupEntry, qos=qos, statisticTable=statisticTable, tftp=tftp, jumblan2=jumblan2, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, lan2=lan2, portStatEntry=portStatEntry, port4=port4, groupid=groupid, xg6846=xg6846, temperature=temperature, vlanid=vlanid, port2=port2, staticDns=staticDns, catvEnable=catvEnable, adminStatus=adminStatus, vendorOui=vendorOui, catv=catv, jumblan4=jumblan4, jumbwan=jumbwan, qosTable=qosTable, staticIpSecondaryDns=staticIpSecondaryDns, jumb=jumb, unicastsReceived=unicastsReceived, domainame=domainame, rebootEnable=rebootEnable, staticIpPrimaryDns=staticIpPrimaryDns, vendorName=vendorName, vlan=vlan, lanportspeed=lanportspeed, portEntry=portEntry, lanportTable=lanportTable, portName=portName, secondaryDns=secondaryDns, wanType=wanType, ddminfo=ddminfo, staticIpHostName=staticIpHostName, multicastsTransmitted=multicastsTransmitted, portTable=portTable, portPower=portPower, broadcastsTransmitted=broadcastsTransmitted, qosIndex=qosIndex, voltage=voltage, jumblan3=jumblan3, portmode=portmode, lan4=lan4, qosEntry=qosEntry, qmapping=qmapping, lanportName=lanportName, broadcastsReceived=broadcastsReceived, port1=port1, fileName=fileName, deviceinfo=deviceinfo, rxPower=rxPower, multicastsReceived=multicastsReceived, statIndex=statIndex, txPower=txPower, internetPort=internetPort, port3=port3, fcsErrorTransmitted=fcsErrorTransmitted, bias=bias, portIndex=portIndex, priority=priority, staticIpGateway=staticIpGateway, hostname=hostname, vlangroupTable=vlangroupTable, vendorPn=vendorPn, modeEntry=modeEntry, action=action)
