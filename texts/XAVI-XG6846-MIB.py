...
Counter64, IpAddress, ObjectIdentity, Integer32, Unsigned32, Bits, snmpModules, mib_2, Counter32, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, iso, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "ObjectIdentity", "Integer32", "Unsigned32", "Bits", "snmpModules", "mib-2", "Counter32", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "iso", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vlanid=vlanid, bias=bias, hostname=hostname, fcsErrorReceived=fcsErrorReceived, lanportTable=lanportTable, lan4=lan4, staticIpSubMask=staticIpSubMask, multicastsReceived=multicastsReceived, adminStatus=adminStatus, unicastsTransmitted=unicastsTransmitted, statIndex=statIndex, catv=catv, portStatistic=portStatistic, vendorName=vendorName, txPower=txPower, broadcastsTransmitted=broadcastsTransmitted, modeEntry=modeEntry, jumblan2=jumblan2, tftp=tftp, wanType=wanType, jumbwan=jumbwan, staticIpSecondaryDns=staticIpSecondaryDns, catvEnable=catvEnable, portTable=portTable, staticDns=staticDns, speed=speed, vendorOui=vendorOui, qosEntry=qosEntry, tftpSevIp=tftpSevIp, dscpEnable=dscpEnable, groupid=groupid, operStatus=operStatus, temperature=temperature, portPower=portPower, action=action, rxPower=rxPower, statisticTable=statisticTable, xg6846=xg6846, lanportIndex=lanportIndex, lan2=lan2, jumblan3=jumblan3, secondaryDns=secondaryDns, domainame=domainame, multicastsTransmitted=multicastsTransmitted, portEntry=portEntry, port1=port1, fileName=fileName, qosIndex=qosIndex, unicastsReceived=unicastsReceived, qosTable=qosTable, staticIpAddr=staticIpAddr, primaryDns=primaryDns, port2=port2, serialnum=serialnum, lan1=lan1, portmode=portmode, pauseReceived=pauseReceived, lanportspeed=lanportspeed, qmapping=qmapping, fileType=fileType, jumb=jumb, lan3=lan3, fcsErrorTransmitted=fcsErrorTransmitted, lanportpause=lanportpause, vendorRev=vendorRev, staticIpPrimaryDns=staticIpPrimaryDns, groupIndex=groupIndex, voltage=voltage, qmode=qmode, staticIpGateway=staticIpGateway, rebootEnable=rebootEnable, groupEntry=groupEntry, internetPort=internetPort, vlangroupTable=vlangroupTable, portName=portName, lanportName=lanportName, jumblan4=jumblan4, jumblan1=jumblan1, portIndex=portIndex, ddminfo=ddminfo, deviceinfo=deviceinfo, priority=priority, staticIpHostName=staticIpHostName, reboot=reboot, wan=wan, port4=port4, pauseTransmitted=pauseTransmitted, broadcastsReceived=broadcastsReceived, port3=port3, vlan=vlan, staticIpDomainName=staticIpDomainName, vendorPn=vendorPn, qos=qos, portStatEntry=portStatEntry)
