...
Counter64, Gauge32, ObjectIdentity, Unsigned32, IpAddress, Counter32, iso, Bits, snmpModules, mib_2, enterprises, ModuleIdentity, MibIdentifier, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "ObjectIdentity", "Unsigned32", "IpAddress", "Counter32", "iso", "Bits", "snmpModules", "mib-2", "enterprises", "ModuleIdentity", "MibIdentifier", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", qosIndex=qosIndex, vendorOui=vendorOui, tftpSevIp=tftpSevIp, portIndex=portIndex, statIndex=statIndex, jumblan2=jumblan2, lan4=lan4, staticDns=staticDns, staticIpSecondaryDns=staticIpSecondaryDns, hostname=hostname, vlanid=vlanid, groupid=groupid, catvEnable=catvEnable, fileName=fileName, lan1=lan1, portmode=portmode, staticIpDomainName=staticIpDomainName, portName=portName, unicastsTransmitted=unicastsTransmitted, staticIpAddr=staticIpAddr, dscpEnable=dscpEnable, wan=wan, statisticTable=statisticTable, vendorRev=vendorRev, tftp=tftp, portTable=portTable, jumbwan=jumbwan, bias=bias, serialnum=serialnum, primaryDns=primaryDns, staticIpGateway=staticIpGateway, jumb=jumb, vendorPn=vendorPn, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, qmapping=qmapping, jumblan3=jumblan3, voltage=voltage, modeEntry=modeEntry, lanportspeed=lanportspeed, unicastsReceived=unicastsReceived, qosEntry=qosEntry, lanportIndex=lanportIndex, qmode=qmode, broadcastsReceived=broadcastsReceived, port2=port2, vlan=vlan, groupIndex=groupIndex, lan2=lan2, portStatistic=portStatistic, fileType=fileType, lanportpause=lanportpause, portEntry=portEntry, catv=catv, speed=speed, lan3=lan3, vendorName=vendorName, port3=port3, groupEntry=groupEntry, pauseReceived=pauseReceived, portPower=portPower, fcsErrorReceived=fcsErrorReceived, ddminfo=ddminfo, lanportTable=lanportTable, fcsErrorTransmitted=fcsErrorTransmitted, multicastsReceived=multicastsReceived, vlangroupTable=vlangroupTable, broadcastsTransmitted=broadcastsTransmitted, staticIpHostName=staticIpHostName, secondaryDns=secondaryDns, wanType=wanType, priority=priority, staticIpSubMask=staticIpSubMask, rxPower=rxPower, xg6846=xg6846, qos=qos, qosTable=qosTable, action=action, rebootEnable=rebootEnable, reboot=reboot, portStatEntry=portStatEntry, port1=port1, deviceinfo=deviceinfo, staticIpPrimaryDns=staticIpPrimaryDns, multicastsTransmitted=multicastsTransmitted, operStatus=operStatus, temperature=temperature, internetPort=internetPort, domainame=domainame, jumblan1=jumblan1, jumblan4=jumblan4, port4=port4, lanportName=lanportName, txPower=txPower)
