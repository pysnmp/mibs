...
NotificationType, iso, Gauge32, ModuleIdentity, Counter32, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, ObjectIdentity, IpAddress, TimeTicks, Unsigned32, enterprises, Counter64, Integer32, snmpModules = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "Gauge32", "ModuleIdentity", "Counter32", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "ObjectIdentity", "IpAddress", "TimeTicks", "Unsigned32", "enterprises", "Counter64", "Integer32", "snmpModules")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", jumb=jumb, lan3=lan3, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, jumblan2=jumblan2, serialnum=serialnum, tftp=tftp, voltage=voltage, vlan=vlan, catvEnable=catvEnable, txPower=txPower, fcsErrorReceived=fcsErrorReceived, wanType=wanType, unicastsReceived=unicastsReceived, port1=port1, portEntry=portEntry, broadcastsTransmitted=broadcastsTransmitted, portStatistic=portStatistic, statisticTable=statisticTable, staticIpGateway=staticIpGateway, primaryDns=primaryDns, portIndex=portIndex, tftpSevIp=tftpSevIp, fileName=fileName, staticIpSecondaryDns=staticIpSecondaryDns, staticIpSubMask=staticIpSubMask, fileType=fileType, secondaryDns=secondaryDns, qmode=qmode, groupid=groupid, portStatEntry=portStatEntry, vendorName=vendorName, jumbwan=jumbwan, wan=wan, portPower=portPower, vlangroupTable=vlangroupTable, adminStatus=adminStatus, bias=bias, speed=speed, lanportspeed=lanportspeed, vlanid=vlanid, port4=port4, modeEntry=modeEntry, staticDns=staticDns, staticIpHostName=staticIpHostName, internetPort=internetPort, vendorOui=vendorOui, port3=port3, staticIpDomainName=staticIpDomainName, staticIpPrimaryDns=staticIpPrimaryDns, statIndex=statIndex, groupEntry=groupEntry, qosEntry=qosEntry, domainame=domainame, staticIpAddr=staticIpAddr, lan2=lan2, jumblan4=jumblan4, lan4=lan4, vendorRev=vendorRev, portTable=portTable, portmode=portmode, priority=priority, fcsErrorTransmitted=fcsErrorTransmitted, vendorPn=vendorPn, groupIndex=groupIndex, dscpEnable=dscpEnable, lanportTable=lanportTable, reboot=reboot, qosTable=qosTable, rxPower=rxPower, qmapping=qmapping, hostname=hostname, rebootEnable=rebootEnable, multicastsTransmitted=multicastsTransmitted, operStatus=operStatus, lan1=lan1, lanportIndex=lanportIndex, qos=qos, unicastsTransmitted=unicastsTransmitted, multicastsReceived=multicastsReceived, action=action, catv=catv, qosIndex=qosIndex, port2=port2, lanportName=lanportName, xg6846=xg6846, temperature=temperature, jumblan1=jumblan1, jumblan3=jumblan3, ddminfo=ddminfo, deviceinfo=deviceinfo, portName=portName, pauseReceived=pauseReceived, lanportpause=lanportpause)
