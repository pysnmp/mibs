...
snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, NotificationType, enterprises, iso, TimeTicks, IpAddress, Bits, mib_2, MibIdentifier, Counter32, Unsigned32, Counter64, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "NotificationType", "enterprises", "iso", "TimeTicks", "IpAddress", "Bits", "mib-2", "MibIdentifier", "Counter32", "Unsigned32", "Counter64", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", hostname=hostname, qosTable=qosTable, staticIpGateway=staticIpGateway, priority=priority, unicastsReceived=unicastsReceived, port1=port1, port3=port3, vendorRev=vendorRev, portmode=portmode, portIndex=portIndex, jumblan1=jumblan1, reboot=reboot, qosEntry=qosEntry, lanportspeed=lanportspeed, vendorPn=vendorPn, lanportName=lanportName, bias=bias, lan2=lan2, staticIpSecondaryDns=staticIpSecondaryDns, secondaryDns=secondaryDns, qmode=qmode, catv=catv, rxPower=rxPower, statisticTable=statisticTable, tftp=tftp, primaryDns=primaryDns, portStatistic=portStatistic, pauseTransmitted=pauseTransmitted, port2=port2, lan1=lan1, portEntry=portEntry, qmapping=qmapping, internetPort=internetPort, multicastsReceived=multicastsReceived, multicastsTransmitted=multicastsTransmitted, ddminfo=ddminfo, jumblan4=jumblan4, vlangroupTable=vlangroupTable, lan3=lan3, groupEntry=groupEntry, staticIpSubMask=staticIpSubMask, qosIndex=qosIndex, portName=portName, domainame=domainame, jumblan2=jumblan2, lanportpause=lanportpause, wanType=wanType, staticDns=staticDns, staticIpDomainName=staticIpDomainName, staticIpAddr=staticIpAddr, xg6846=xg6846, portStatEntry=portStatEntry, broadcastsReceived=broadcastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, action=action, speed=speed, rebootEnable=rebootEnable, jumb=jumb, statIndex=statIndex, serialnum=serialnum, vendorOui=vendorOui, groupid=groupid, fileType=fileType, modeEntry=modeEntry, portTable=portTable, tftpSevIp=tftpSevIp, vendorName=vendorName, operStatus=operStatus, lan4=lan4, groupIndex=groupIndex, vlan=vlan, txPower=txPower, fileName=fileName, temperature=temperature, jumblan3=jumblan3, fcsErrorReceived=fcsErrorReceived, adminStatus=adminStatus, broadcastsTransmitted=broadcastsTransmitted, staticIpHostName=staticIpHostName, lanportIndex=lanportIndex, deviceinfo=deviceinfo, lanportTable=lanportTable, wan=wan, unicastsTransmitted=unicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, qos=qos, dscpEnable=dscpEnable, vlanid=vlanid, catvEnable=catvEnable, pauseReceived=pauseReceived, portPower=portPower, voltage=voltage, jumbwan=jumbwan, port4=port4)
