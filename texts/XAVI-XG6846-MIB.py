...
# Produced by pysmi-1.1.8 at Mon Feb  6 15:02:49 2023
...
NotificationType, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Unsigned32, Counter64, enterprises, MibIdentifier, TimeTicks, iso, snmpModules, mib_2, Integer32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Unsigned32", "Counter64", "enterprises", "MibIdentifier", "TimeTicks", "iso", "snmpModules", "mib-2", "Integer32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", statisticTable=statisticTable, staticIpAddr=staticIpAddr, rxPower=rxPower, broadcastsReceived=broadcastsReceived, port2=port2, bias=bias, portName=portName, wan=wan, portStatistic=portStatistic, lan3=lan3, qmapping=qmapping, multicastsTransmitted=multicastsTransmitted, port1=port1, jumblan4=jumblan4, fcsErrorReceived=fcsErrorReceived, lan1=lan1, voltage=voltage, groupIndex=groupIndex, jumblan1=jumblan1, staticIpHostName=staticIpHostName, unicastsTransmitted=unicastsTransmitted, deviceinfo=deviceinfo, vlangroupTable=vlangroupTable, operStatus=operStatus, staticIpPrimaryDns=staticIpPrimaryDns, vendorPn=vendorPn, qmode=qmode, lanportpause=lanportpause, domainame=domainame, fileType=fileType, pauseTransmitted=pauseTransmitted, xg6846=xg6846, wanType=wanType, staticDns=staticDns, primaryDns=primaryDns, vendorOui=vendorOui, catvEnable=catvEnable, port4=port4, staticIpDomainName=staticIpDomainName, qos=qos, fcsErrorTransmitted=fcsErrorTransmitted, unicastsReceived=unicastsReceived, staticIpGateway=staticIpGateway, action=action, vlan=vlan, groupEntry=groupEntry, statIndex=statIndex, lan4=lan4, priority=priority, pauseReceived=pauseReceived, portEntry=portEntry, lanportspeed=lanportspeed, vendorRev=vendorRev, staticIpSubMask=staticIpSubMask, staticIpSecondaryDns=staticIpSecondaryDns, tftpSevIp=tftpSevIp, modeEntry=modeEntry, jumblan2=jumblan2, lan2=lan2, qosTable=qosTable, speed=speed, groupid=groupid, portmode=portmode, internetPort=internetPort, hostname=hostname, reboot=reboot, vendorName=vendorName, serialnum=serialnum, qosIndex=qosIndex, rebootEnable=rebootEnable, ddminfo=ddminfo, lanportTable=lanportTable, vlanid=vlanid, secondaryDns=secondaryDns, broadcastsTransmitted=broadcastsTransmitted, port3=port3, portIndex=portIndex, jumbwan=jumbwan, lanportIndex=lanportIndex, qosEntry=qosEntry, fileName=fileName, catv=catv, portPower=portPower, jumb=jumb, dscpEnable=dscpEnable, lanportName=lanportName, jumblan3=jumblan3, portTable=portTable, portStatEntry=portStatEntry, adminStatus=adminStatus, tftp=tftp, txPower=txPower, temperature=temperature, multicastsReceived=multicastsReceived)
