...
# Produced by pysmi-1.1.8 at Mon Feb  6 14:33:26 2023
...
Gauge32, ObjectIdentity, Counter64, Unsigned32, MibIdentifier, iso, enterprises, IpAddress, Counter32, snmpModules, ModuleIdentity, TimeTicks, mib_2, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Counter64", "Unsigned32", "MibIdentifier", "iso", "enterprises", "IpAddress", "Counter32", "snmpModules", "ModuleIdentity", "TimeTicks", "mib-2", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorRev=vendorRev, adminStatus=adminStatus, broadcastsTransmitted=broadcastsTransmitted, jumblan2=jumblan2, multicastsTransmitted=multicastsTransmitted, statisticTable=statisticTable, groupid=groupid, fileName=fileName, xg6846=xg6846, vlanid=vlanid, portName=portName, portStatistic=portStatistic, hostname=hostname, secondaryDns=secondaryDns, vendorOui=vendorOui, tftp=tftp, rebootEnable=rebootEnable, portmode=portmode, lan4=lan4, domainame=domainame, rxPower=rxPower, bias=bias, vendorName=vendorName, staticIpSecondaryDns=staticIpSecondaryDns, lanportspeed=lanportspeed, primaryDns=primaryDns, fcsErrorReceived=fcsErrorReceived, reboot=reboot, voltage=voltage, portTable=portTable, action=action, groupEntry=groupEntry, staticIpPrimaryDns=staticIpPrimaryDns, unicastsReceived=unicastsReceived, serialnum=serialnum, deviceinfo=deviceinfo, multicastsReceived=multicastsReceived, jumblan1=jumblan1, staticIpAddr=staticIpAddr, port4=port4, portPower=portPower, portEntry=portEntry, vlan=vlan, staticIpDomainName=staticIpDomainName, vlangroupTable=vlangroupTable, modeEntry=modeEntry, staticIpHostName=staticIpHostName, qos=qos, port3=port3, jumbwan=jumbwan, groupIndex=groupIndex, pauseReceived=pauseReceived, speed=speed, tftpSevIp=tftpSevIp, priority=priority, lan1=lan1, catv=catv, lan3=lan3, jumblan3=jumblan3, catvEnable=catvEnable, jumblan4=jumblan4, fileType=fileType, qosEntry=qosEntry, unicastsTransmitted=unicastsTransmitted, port2=port2, qmapping=qmapping, ddminfo=ddminfo, statIndex=statIndex, port1=port1, staticIpSubMask=staticIpSubMask, wanType=wanType, qosTable=qosTable, lanportpause=lanportpause, qosIndex=qosIndex, fcsErrorTransmitted=fcsErrorTransmitted, dscpEnable=dscpEnable, wan=wan, lan2=lan2, portIndex=portIndex, lanportName=lanportName, lanportTable=lanportTable, temperature=temperature, broadcastsReceived=broadcastsReceived, jumb=jumb, lanportIndex=lanportIndex, pauseTransmitted=pauseTransmitted, vendorPn=vendorPn, staticDns=staticDns, portStatEntry=portStatEntry, staticIpGateway=staticIpGateway, txPower=txPower, qmode=qmode, operStatus=operStatus, internetPort=internetPort)
