...
iso, Integer32, Bits, enterprises, ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, TimeTicks, MibIdentifier, Unsigned32, mib_2, snmpModules, Counter64, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "Bits", "enterprises", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "TimeTicks", "MibIdentifier", "Unsigned32", "mib-2", "snmpModules", "Counter64", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", portPower=portPower, vlan=vlan, serialnum=serialnum, rebootEnable=rebootEnable, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, staticIpAddr=staticIpAddr, qmapping=qmapping, staticIpSecondaryDns=staticIpSecondaryDns, wanType=wanType, modeEntry=modeEntry, internetPort=internetPort, jumb=jumb, lanportspeed=lanportspeed, multicastsReceived=multicastsReceived, domainame=domainame, temperature=temperature, pauseTransmitted=pauseTransmitted, staticIpDomainName=staticIpDomainName, jumbwan=jumbwan, statIndex=statIndex, tftp=tftp, reboot=reboot, vendorOui=vendorOui, pauseReceived=pauseReceived, fcsErrorTransmitted=fcsErrorTransmitted, ddminfo=ddminfo, lan3=lan3, wan=wan, lanportIndex=lanportIndex, qos=qos, dscpEnable=dscpEnable, xg6846=xg6846, lanportpause=lanportpause, portStatistic=portStatistic, vendorRev=vendorRev, portName=portName, unicastsTransmitted=unicastsTransmitted, voltage=voltage, catvEnable=catvEnable, staticIpSubMask=staticIpSubMask, deviceinfo=deviceinfo, fileName=fileName, staticDns=staticDns, port2=port2, catv=catv, vlanid=vlanid, unicastsReceived=unicastsReceived, lanportTable=lanportTable, adminStatus=adminStatus, multicastsTransmitted=multicastsTransmitted, portmode=portmode, action=action, lan1=lan1, lan4=lan4, staticIpGateway=staticIpGateway, port3=port3, vendorName=vendorName, lanportName=lanportName, speed=speed, operStatus=operStatus, jumblan2=jumblan2, priority=priority, portStatEntry=portStatEntry, jumblan3=jumblan3, port1=port1, groupIndex=groupIndex, staticIpHostName=staticIpHostName, broadcastsReceived=broadcastsReceived, primaryDns=primaryDns, portIndex=portIndex, jumblan1=jumblan1, lan2=lan2, qosIndex=qosIndex, portTable=portTable, jumblan4=jumblan4, rxPower=rxPower, vendorPn=vendorPn, fileType=fileType, secondaryDns=secondaryDns, port4=port4, staticIpPrimaryDns=staticIpPrimaryDns, portEntry=portEntry, bias=bias, statisticTable=statisticTable, vlangroupTable=vlangroupTable, broadcastsTransmitted=broadcastsTransmitted, groupid=groupid, txPower=txPower, groupEntry=groupEntry, hostname=hostname, qosEntry=qosEntry, qosTable=qosTable, qmode=qmode)
