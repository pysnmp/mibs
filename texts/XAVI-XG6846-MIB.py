...
# Produced by pysmi-1.1.8 at Fri Sep  8 08:05:25 2023
...
IpAddress, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, NotificationType, Gauge32, Counter32, TimeTicks, mib_2, iso, enterprises, Bits, MibIdentifier, Unsigned32, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "NotificationType", "Gauge32", "Counter32", "TimeTicks", "mib-2", "iso", "enterprises", "Bits", "MibIdentifier", "Unsigned32", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", modeEntry=modeEntry, operStatus=operStatus, qmode=qmode, qosEntry=qosEntry, portPower=portPower, staticIpDomainName=staticIpDomainName, groupEntry=groupEntry, portStatistic=portStatistic, portmode=portmode, statisticTable=statisticTable, xg6846=xg6846, fileType=fileType, serialnum=serialnum, vlan=vlan, lan2=lan2, portIndex=portIndex, staticIpHostName=staticIpHostName, rxPower=rxPower, groupIndex=groupIndex, lan3=lan3, lanportspeed=lanportspeed, jumblan2=jumblan2, catvEnable=catvEnable, groupid=groupid, fileName=fileName, fcsErrorTransmitted=fcsErrorTransmitted, speed=speed, portName=portName, reboot=reboot, lanportTable=lanportTable, portEntry=portEntry, domainame=domainame, secondaryDns=secondaryDns, statIndex=statIndex, vendorPn=vendorPn, jumblan4=jumblan4, multicastsTransmitted=multicastsTransmitted, pauseReceived=pauseReceived, jumb=jumb, wan=wan, lan4=lan4, lanportName=lanportName, fcsErrorReceived=fcsErrorReceived, port1=port1, deviceinfo=deviceinfo, pauseTransmitted=pauseTransmitted, vlangroupTable=vlangroupTable, staticDns=staticDns, lanportpause=lanportpause, vlanid=vlanid, multicastsReceived=multicastsReceived, bias=bias, rebootEnable=rebootEnable, staticIpPrimaryDns=staticIpPrimaryDns, vendorRev=vendorRev, jumblan1=jumblan1, jumblan3=jumblan3, qosTable=qosTable, qos=qos, catv=catv, vendorName=vendorName, staticIpAddr=staticIpAddr, portStatEntry=portStatEntry, temperature=temperature, hostname=hostname, wanType=wanType, vendorOui=vendorOui, port2=port2, dscpEnable=dscpEnable, broadcastsTransmitted=broadcastsTransmitted, staticIpGateway=staticIpGateway, lan1=lan1, voltage=voltage, portTable=portTable, primaryDns=primaryDns, qmapping=qmapping, internetPort=internetPort, port3=port3, unicastsReceived=unicastsReceived, qosIndex=qosIndex, tftpSevIp=tftpSevIp, priority=priority, lanportIndex=lanportIndex, staticIpSecondaryDns=staticIpSecondaryDns, port4=port4, action=action, staticIpSubMask=staticIpSubMask, unicastsTransmitted=unicastsTransmitted, tftp=tftp, ddminfo=ddminfo, txPower=txPower, adminStatus=adminStatus, broadcastsReceived=broadcastsReceived, jumbwan=jumbwan)
