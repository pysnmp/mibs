...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:37:15 2021
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Counter32, enterprises, IpAddress, Counter64, snmpModules, Gauge32, TimeTicks, iso, mib_2, MibIdentifier, Bits, NotificationType, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Counter32", "enterprises", "IpAddress", "Counter64", "snmpModules", "Gauge32", "TimeTicks", "iso", "mib-2", "MibIdentifier", "Bits", "NotificationType", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", unicastsReceived=unicastsReceived, portmode=portmode, jumblan2=jumblan2, modeEntry=modeEntry, xg6846=xg6846, portTable=portTable, hostname=hostname, qosIndex=qosIndex, rebootEnable=rebootEnable, tftp=tftp, port2=port2, broadcastsTransmitted=broadcastsTransmitted, fileName=fileName, voltage=voltage, groupid=groupid, secondaryDns=secondaryDns, qosEntry=qosEntry, lanportName=lanportName, staticIpHostName=staticIpHostName, broadcastsReceived=broadcastsReceived, fcsErrorTransmitted=fcsErrorTransmitted, serialnum=serialnum, portIndex=portIndex, speed=speed, groupEntry=groupEntry, vlanid=vlanid, portPower=portPower, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, internetPort=internetPort, portStatistic=portStatistic, fcsErrorReceived=fcsErrorReceived, qmapping=qmapping, qosTable=qosTable, priority=priority, vendorPn=vendorPn, port1=port1, statIndex=statIndex, ddminfo=ddminfo, portName=portName, staticIpDomainName=staticIpDomainName, deviceinfo=deviceinfo, lan1=lan1, vendorName=vendorName, lan4=lan4, wanType=wanType, lanportTable=lanportTable, fileType=fileType, jumblan4=jumblan4, vendorRev=vendorRev, lan3=lan3, statisticTable=statisticTable, staticIpGateway=staticIpGateway, rxPower=rxPower, vlangroupTable=vlangroupTable, primaryDns=primaryDns, jumblan3=jumblan3, vlan=vlan, adminStatus=adminStatus, catv=catv, jumbwan=jumbwan, action=action, groupIndex=groupIndex, pauseTransmitted=pauseTransmitted, operStatus=operStatus, port3=port3, multicastsReceived=multicastsReceived, portStatEntry=portStatEntry, vendorOui=vendorOui, jumblan1=jumblan1, portEntry=portEntry, staticIpSecondaryDns=staticIpSecondaryDns, wan=wan, lan2=lan2, lanportpause=lanportpause, lanportspeed=lanportspeed, bias=bias, temperature=temperature, tftpSevIp=tftpSevIp, dscpEnable=dscpEnable, staticIpAddr=staticIpAddr, port4=port4, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSubMask=staticIpSubMask, qos=qos, qmode=qmode, staticDns=staticDns, txPower=txPower, reboot=reboot, jumb=jumb, domainame=domainame, lanportIndex=lanportIndex, pauseReceived=pauseReceived, catvEnable=catvEnable)
