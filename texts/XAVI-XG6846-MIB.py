...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:08:15 2023
...
snmpModules, Bits, mib_2, Counter32, MibIdentifier, Counter64, ObjectIdentity, IpAddress, Integer32, Gauge32, enterprises, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "Bits", "mib-2", "Counter32", "MibIdentifier", "Counter64", "ObjectIdentity", "IpAddress", "Integer32", "Gauge32", "enterprises", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpDomainName=staticIpDomainName, port4=port4, voltage=voltage, domainame=domainame, qos=qos, broadcastsTransmitted=broadcastsTransmitted, portTable=portTable, portmode=portmode, portPower=portPower, jumb=jumb, tftpSevIp=tftpSevIp, txPower=txPower, staticIpSubMask=staticIpSubMask, rxPower=rxPower, deviceinfo=deviceinfo, operStatus=operStatus, jumblan2=jumblan2, priority=priority, vlanid=vlanid, lan3=lan3, vendorOui=vendorOui, fcsErrorReceived=fcsErrorReceived, secondaryDns=secondaryDns, modeEntry=modeEntry, lan4=lan4, lanportName=lanportName, vendorPn=vendorPn, catv=catv, portName=portName, reboot=reboot, pauseTransmitted=pauseTransmitted, fileType=fileType, jumblan1=jumblan1, lanportTable=lanportTable, rebootEnable=rebootEnable, portStatistic=portStatistic, fileName=fileName, unicastsReceived=unicastsReceived, xg6846=xg6846, staticIpHostName=staticIpHostName, dscpEnable=dscpEnable, multicastsReceived=multicastsReceived, staticIpAddr=staticIpAddr, groupIndex=groupIndex, staticIpSecondaryDns=staticIpSecondaryDns, lan2=lan2, vlan=vlan, portIndex=portIndex, qmapping=qmapping, jumblan3=jumblan3, lanportpause=lanportpause, temperature=temperature, staticDns=staticDns, qosEntry=qosEntry, port2=port2, jumblan4=jumblan4, pauseReceived=pauseReceived, catvEnable=catvEnable, vendorName=vendorName, qosTable=qosTable, qosIndex=qosIndex, groupid=groupid, vendorRev=vendorRev, ddminfo=ddminfo, serialnum=serialnum, statisticTable=statisticTable, portEntry=portEntry, lanportspeed=lanportspeed, groupEntry=groupEntry, staticIpPrimaryDns=staticIpPrimaryDns, port1=port1, portStatEntry=portStatEntry, wan=wan, primaryDns=primaryDns, lan1=lan1, speed=speed, hostname=hostname, wanType=wanType, internetPort=internetPort, staticIpGateway=staticIpGateway, unicastsTransmitted=unicastsTransmitted, jumbwan=jumbwan, lanportIndex=lanportIndex, adminStatus=adminStatus, tftp=tftp, bias=bias, broadcastsReceived=broadcastsReceived, port3=port3, qmode=qmode, action=action, fcsErrorTransmitted=fcsErrorTransmitted, statIndex=statIndex, vlangroupTable=vlangroupTable, multicastsTransmitted=multicastsTransmitted)
