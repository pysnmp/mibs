...
# Produced by pysmi-1.1.8 at Fri Jul  8 09:22:54 2022
...
NotificationType, Counter32, mib_2, IpAddress, Gauge32, enterprises, snmpModules, Bits, iso, Integer32, ObjectIdentity, Unsigned32, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "mib-2", "IpAddress", "Gauge32", "enterprises", "snmpModules", "Bits", "iso", "Integer32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", hostname=hostname, primaryDns=primaryDns, qmapping=qmapping, dscpEnable=dscpEnable, jumblan3=jumblan3, portStatEntry=portStatEntry, lanportIndex=lanportIndex, lan3=lan3, portStatistic=portStatistic, vendorPn=vendorPn, lanportpause=lanportpause, fcsErrorTransmitted=fcsErrorTransmitted, wan=wan, multicastsTransmitted=multicastsTransmitted, lan2=lan2, portTable=portTable, multicastsReceived=multicastsReceived, unicastsTransmitted=unicastsTransmitted, catv=catv, xg6846=xg6846, jumbwan=jumbwan, lanportspeed=lanportspeed, portmode=portmode, fileType=fileType, lanportName=lanportName, staticIpAddr=staticIpAddr, staticIpSubMask=staticIpSubMask, lanportTable=lanportTable, vendorName=vendorName, tftp=tftp, port3=port3, groupid=groupid, deviceinfo=deviceinfo, modeEntry=modeEntry, port1=port1, portPower=portPower, jumblan1=jumblan1, reboot=reboot, temperature=temperature, rebootEnable=rebootEnable, domainame=domainame, lan4=lan4, broadcastsTransmitted=broadcastsTransmitted, port2=port2, groupIndex=groupIndex, staticIpPrimaryDns=staticIpPrimaryDns, staticIpSecondaryDns=staticIpSecondaryDns, operStatus=operStatus, secondaryDns=secondaryDns, vlan=vlan, port4=port4, fileName=fileName, jumb=jumb, internetPort=internetPort, statIndex=statIndex, voltage=voltage, wanType=wanType, jumblan2=jumblan2, vendorOui=vendorOui, txPower=txPower, portIndex=portIndex, pauseTransmitted=pauseTransmitted, vendorRev=vendorRev, statisticTable=statisticTable, staticDns=staticDns, broadcastsReceived=broadcastsReceived, portEntry=portEntry, staticIpHostName=staticIpHostName, speed=speed, qmode=qmode, qosTable=qosTable, serialnum=serialnum, action=action, qosEntry=qosEntry, catvEnable=catvEnable, lan1=lan1, bias=bias, rxPower=rxPower, ddminfo=ddminfo, vlanid=vlanid, fcsErrorReceived=fcsErrorReceived, jumblan4=jumblan4, unicastsReceived=unicastsReceived, staticIpDomainName=staticIpDomainName, pauseReceived=pauseReceived, tftpSevIp=tftpSevIp, adminStatus=adminStatus, groupEntry=groupEntry, qosIndex=qosIndex, vlangroupTable=vlangroupTable, priority=priority, staticIpGateway=staticIpGateway, portName=portName, qos=qos)
