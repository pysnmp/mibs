...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:18:29 2023
...
NotificationType, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, mib_2, snmpModules, Unsigned32, iso, ObjectIdentity, ModuleIdentity, Gauge32, Bits, Counter32, MibIdentifier, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "mib-2", "snmpModules", "Unsigned32", "iso", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Bits", "Counter32", "MibIdentifier", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", staticIpGateway=staticIpGateway, multicastsTransmitted=multicastsTransmitted, staticIpAddr=staticIpAddr, qmode=qmode, broadcastsTransmitted=broadcastsTransmitted, portName=portName, vendorRev=vendorRev, portStatEntry=portStatEntry, deviceinfo=deviceinfo, rxPower=rxPower, staticIpSubMask=staticIpSubMask, domainame=domainame, serialnum=serialnum, portmode=portmode, txPower=txPower, action=action, lanportspeed=lanportspeed, portStatistic=portStatistic, reboot=reboot, vendorPn=vendorPn, lanportpause=lanportpause, lan3=lan3, jumb=jumb, groupid=groupid, pauseTransmitted=pauseTransmitted, staticIpDomainName=staticIpDomainName, lanportTable=lanportTable, lan4=lan4, vlan=vlan, port1=port1, portPower=portPower, catv=catv, hostname=hostname, wan=wan, port3=port3, portTable=portTable, jumblan3=jumblan3, catvEnable=catvEnable, ddminfo=ddminfo, portIndex=portIndex, qosEntry=qosEntry, multicastsReceived=multicastsReceived, staticIpHostName=staticIpHostName, tftp=tftp, qosTable=qosTable, dscpEnable=dscpEnable, broadcastsReceived=broadcastsReceived, lanportIndex=lanportIndex, staticDns=staticDns, statisticTable=statisticTable, port2=port2, groupEntry=groupEntry, unicastsReceived=unicastsReceived, modeEntry=modeEntry, fcsErrorTransmitted=fcsErrorTransmitted, adminStatus=adminStatus, fileName=fileName, pauseReceived=pauseReceived, speed=speed, rebootEnable=rebootEnable, port4=port4, lanportName=lanportName, jumbwan=jumbwan, vendorOui=vendorOui, unicastsTransmitted=unicastsTransmitted, portEntry=portEntry, secondaryDns=secondaryDns, fileType=fileType, operStatus=operStatus, jumblan4=jumblan4, lan1=lan1, staticIpSecondaryDns=staticIpSecondaryDns, groupIndex=groupIndex, jumblan2=jumblan2, vlangroupTable=vlangroupTable, statIndex=statIndex, bias=bias, temperature=temperature, qosIndex=qosIndex, internetPort=internetPort, qos=qos, primaryDns=primaryDns, lan2=lan2, vendorName=vendorName, priority=priority, voltage=voltage, tftpSevIp=tftpSevIp, fcsErrorReceived=fcsErrorReceived, qmapping=qmapping, staticIpPrimaryDns=staticIpPrimaryDns, wanType=wanType, vlanid=vlanid, jumblan1=jumblan1, xg6846=xg6846)
