...
Counter32, Integer32, MibIdentifier, Counter64, snmpModules, ModuleIdentity, NotificationType, enterprises, ObjectIdentity, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, IpAddress, Gauge32, mib_2 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "MibIdentifier", "Counter64", "snmpModules", "ModuleIdentity", "NotificationType", "enterprises", "ObjectIdentity", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "IpAddress", "Gauge32", "mib-2")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", wan=wan, qmode=qmode, staticDns=staticDns, secondaryDns=secondaryDns, unicastsReceived=unicastsReceived, port2=port2, portmode=portmode, pauseReceived=pauseReceived, internetPort=internetPort, fcsErrorReceived=fcsErrorReceived, action=action, broadcastsReceived=broadcastsReceived, dscpEnable=dscpEnable, wanType=wanType, speed=speed, vendorPn=vendorPn, staticIpDomainName=staticIpDomainName, port1=port1, fcsErrorTransmitted=fcsErrorTransmitted, tftpSevIp=tftpSevIp, portTable=portTable, portPower=portPower, xg6846=xg6846, lanportName=lanportName, portStatistic=portStatistic, groupid=groupid, broadcastsTransmitted=broadcastsTransmitted, tftp=tftp, fileType=fileType, jumblan4=jumblan4, lan2=lan2, qosIndex=qosIndex, portIndex=portIndex, lan4=lan4, port3=port3, txPower=txPower, vendorRev=vendorRev, qosTable=qosTable, jumblan2=jumblan2, groupIndex=groupIndex, deviceinfo=deviceinfo, operStatus=operStatus, rxPower=rxPower, primaryDns=primaryDns, rebootEnable=rebootEnable, jumb=jumb, lanportIndex=lanportIndex, staticIpGateway=staticIpGateway, reboot=reboot, vlanid=vlanid, bias=bias, fileName=fileName, vendorName=vendorName, lan1=lan1, unicastsTransmitted=unicastsTransmitted, multicastsTransmitted=multicastsTransmitted, staticIpPrimaryDns=staticIpPrimaryDns, lanportTable=lanportTable, statIndex=statIndex, staticIpSecondaryDns=staticIpSecondaryDns, jumblan1=jumblan1, temperature=temperature, adminStatus=adminStatus, staticIpAddr=staticIpAddr, vendorOui=vendorOui, jumbwan=jumbwan, qosEntry=qosEntry, lan3=lan3, groupEntry=groupEntry, portStatEntry=portStatEntry, modeEntry=modeEntry, port4=port4, lanportspeed=lanportspeed, ddminfo=ddminfo, multicastsReceived=multicastsReceived, jumblan3=jumblan3, statisticTable=statisticTable, vlangroupTable=vlangroupTable, vlan=vlan, qmapping=qmapping, catvEnable=catvEnable, lanportpause=lanportpause, priority=priority, portName=portName, hostname=hostname, qos=qos, serialnum=serialnum, staticIpSubMask=staticIpSubMask, domainame=domainame, catv=catv, pauseTransmitted=pauseTransmitted, staticIpHostName=staticIpHostName, voltage=voltage, portEntry=portEntry)
