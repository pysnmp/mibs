...
# Produced by pysmi-1.1.8 at Thu Sep  7 11:45:48 2023
...
TimeTicks, enterprises, mib_2, Counter32, ModuleIdentity, Counter64, Integer32, Gauge32, snmpModules, Unsigned32, iso, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "mib-2", "Counter32", "ModuleIdentity", "Counter64", "Integer32", "Gauge32", "snmpModules", "Unsigned32", "iso", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", vendorOui=vendorOui, lanportpause=lanportpause, qosEntry=qosEntry, broadcastsTransmitted=broadcastsTransmitted, primaryDns=primaryDns, lan2=lan2, staticIpSubMask=staticIpSubMask, vlanid=vlanid, vlangroupTable=vlangroupTable, portIndex=portIndex, jumblan3=jumblan3, vendorName=vendorName, adminStatus=adminStatus, fileName=fileName, qosIndex=qosIndex, fcsErrorTransmitted=fcsErrorTransmitted, voltage=voltage, wan=wan, unicastsReceived=unicastsReceived, rxPower=rxPower, domainame=domainame, portTable=portTable, port3=port3, portPower=portPower, groupid=groupid, catv=catv, catvEnable=catvEnable, pauseReceived=pauseReceived, fcsErrorReceived=fcsErrorReceived, unicastsTransmitted=unicastsTransmitted, vendorRev=vendorRev, ddminfo=ddminfo, jumblan1=jumblan1, vlan=vlan, deviceinfo=deviceinfo, groupIndex=groupIndex, jumb=jumb, staticIpAddr=staticIpAddr, txPower=txPower, wanType=wanType, tftpSevIp=tftpSevIp, speed=speed, qos=qos, fileType=fileType, jumblan2=jumblan2, modeEntry=modeEntry, lanportName=lanportName, dscpEnable=dscpEnable, port4=port4, staticIpGateway=staticIpGateway, secondaryDns=secondaryDns, port1=port1, tftp=tftp, pauseTransmitted=pauseTransmitted, portName=portName, jumblan4=jumblan4, lanportIndex=lanportIndex, multicastsReceived=multicastsReceived, portStatEntry=portStatEntry, xg6846=xg6846, portStatistic=portStatistic, lan1=lan1, staticIpHostName=staticIpHostName, internetPort=internetPort, jumbwan=jumbwan, lanportTable=lanportTable, temperature=temperature, action=action, vendorPn=vendorPn, statisticTable=statisticTable, operStatus=operStatus, reboot=reboot, qmapping=qmapping, lan3=lan3, priority=priority, qmode=qmode, groupEntry=groupEntry, lan4=lan4, hostname=hostname, bias=bias, staticIpDomainName=staticIpDomainName, portmode=portmode, broadcastsReceived=broadcastsReceived, qosTable=qosTable, multicastsTransmitted=multicastsTransmitted, staticIpSecondaryDns=staticIpSecondaryDns, rebootEnable=rebootEnable, portEntry=portEntry, port2=port2, lanportspeed=lanportspeed, staticDns=staticDns, serialnum=serialnum, staticIpPrimaryDns=staticIpPrimaryDns, statIndex=statIndex)
