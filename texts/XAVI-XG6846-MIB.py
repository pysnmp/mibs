...
ObjectIdentity, Counter64, mib_2, IpAddress, Unsigned32, TimeTicks, iso, snmpModules, ModuleIdentity, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, NotificationType, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "mib-2", "IpAddress", "Unsigned32", "TimeTicks", "iso", "snmpModules", "ModuleIdentity", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "NotificationType", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("XAVI-XG6846-MIB", tftpSevIp=tftpSevIp, port1=port1, priority=priority, staticIpAddr=staticIpAddr, lanportpause=lanportpause, qosIndex=qosIndex, lan4=lan4, broadcastsReceived=broadcastsReceived, pauseTransmitted=pauseTransmitted, adminStatus=adminStatus, deviceinfo=deviceinfo, catv=catv, modeEntry=modeEntry, portmode=portmode, groupEntry=groupEntry, portTable=portTable, staticIpPrimaryDns=staticIpPrimaryDns, fcsErrorTransmitted=fcsErrorTransmitted, port2=port2, broadcastsTransmitted=broadcastsTransmitted, unicastsTransmitted=unicastsTransmitted, lan1=lan1, vendorName=vendorName, jumb=jumb, primaryDns=primaryDns, staticIpHostName=staticIpHostName, lan2=lan2, vendorPn=vendorPn, speed=speed, lan3=lan3, unicastsReceived=unicastsReceived, lanportIndex=lanportIndex, temperature=temperature, secondaryDns=secondaryDns, vendorOui=vendorOui, action=action, staticDns=staticDns, statIndex=statIndex, domainame=domainame, xg6846=xg6846, multicastsReceived=multicastsReceived, fcsErrorReceived=fcsErrorReceived, lanportName=lanportName, vlanid=vlanid, portStatEntry=portStatEntry, groupid=groupid, portName=portName, serialnum=serialnum, rebootEnable=rebootEnable, statisticTable=statisticTable, qmode=qmode, lanportspeed=lanportspeed, multicastsTransmitted=multicastsTransmitted, ddminfo=ddminfo, groupIndex=groupIndex, catvEnable=catvEnable, jumblan1=jumblan1, fileName=fileName, tftp=tftp, portPower=portPower, fileType=fileType, portEntry=portEntry, bias=bias, jumblan3=jumblan3, hostname=hostname, staticIpGateway=staticIpGateway, txPower=txPower, wan=wan, portStatistic=portStatistic, wanType=wanType, dscpEnable=dscpEnable, staticIpDomainName=staticIpDomainName, jumblan4=jumblan4, pauseReceived=pauseReceived, lanportTable=lanportTable, qosEntry=qosEntry, rxPower=rxPower, qosTable=qosTable, port3=port3, staticIpSubMask=staticIpSubMask, jumbwan=jumbwan, vlan=vlan, vlangroupTable=vlangroupTable, portIndex=portIndex, jumblan2=jumblan2, staticIpSecondaryDns=staticIpSecondaryDns, reboot=reboot, qmapping=qmapping, qos=qos, vendorRev=vendorRev, operStatus=operStatus, port4=port4, internetPort=internetPort, voltage=voltage)
