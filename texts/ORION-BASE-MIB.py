...
ObjectIdentity, Integer32, Bits, Gauge32, Counter32, ModuleIdentity, iso, Counter64, Unsigned32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "Bits", "Gauge32", "Counter32", "ModuleIdentity", "iso", "Counter64", "Unsigned32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcLvdIndex=dcLvdIndex, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcCurrentLimit=dcCurrentLimit, dcPowerLimitationStatus=dcPowerLimitationStatus, dcRectifierGroupIndex=dcRectifierGroupIndex, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcCriticalAlarmName=dcCriticalAlarmName, dcTrapDestinationIndex=dcTrapDestinationIndex, controllerEvents=controllerEvents, dcChargeState=dcChargeState, dcBatteryTemperature=dcBatteryTemperature, controllerBasicCompl=controllerBasicCompl, dcEfficiencyCycling=dcEfficiencyCycling, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcBattery=dcBattery, dcBatteryStringName=dcBatteryStringName, systemNonUrgentAlarm=systemNonUrgentAlarm, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcStartTemp=dcStartTemp, dcSlope=dcSlope, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcBatteryTestStatus=dcBatteryTestStatus, dcRectifierGroupName=dcRectifierGroupName, dcPowerLimitationLimit=dcPowerLimitationLimit, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcBatteryTestDateTime=dcBatteryTestDateTime, dcBatteryTestResults=dcBatteryTestResults, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcEqualizeInterval=dcEqualizeInterval, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcPowerLimitationTable=dcPowerLimitationTable, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcSystemDateTime=dcSystemDateTime, dcTempCompType=dcTempCompType, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcSystemInfo=dcSystemInfo, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcUrgentAlarmName=dcUrgentAlarmName, controllerCompl=controllerCompl, dcBoD=dcBoD, orionBaseMibModule=orionBaseMibModule, dcMisc=dcMisc, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcHighTempHyst=dcHighTempHyst, dcBatteryParameter=dcBatteryParameter, dcBoostChargeParameter=dcBoostChargeParameter, dcLowStopVoltage=dcLowStopVoltage, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcControlEventTable=dcControlEventTable, dcSystemMonitor=dcSystemMonitor, dcEqualizeLeadTime=dcEqualizeLeadTime, PYSNMP_MODULE_ID=orionBaseMibModule, systemCriticalAlarm=systemCriticalAlarm, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcRectifierStatus=dcRectifierStatus, dcPowerLimitationEventName=dcPowerLimitationEventName, dcControlEventName=dcControlEventName, orionBaseMib=orionBaseMib, dcLowTempSlope=dcLowTempSlope, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, notificationsGroup=notificationsGroup, dcLowStartTemp=dcLowStartTemp, trapDestinationTableGroup=trapDestinationTableGroup, dcUsMin=dcUsMin, batteryStringTableGroup=batteryStringTableGroup, dcTempComp=dcTempComp, dcGenericAlarmIndex=dcGenericAlarmIndex, dcBoostChargeType=dcBoostChargeType, dcRectifierIndex=dcRectifierIndex, dcMeasurementValue=dcMeasurementValue, rectifierTableGroup=rectifierTableGroup, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcGenericAlarmEventName=dcGenericAlarmEventName, dcGenericAlarmEntry=dcGenericAlarmEntry, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcRectifierEntry=dcRectifierEntry, dcRectifierGroupTable=dcRectifierGroupTable, dcEventProcessingEventType=dcEventProcessingEventType, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcEventProcessingEventTable=dcEventProcessingEventTable, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcBoostChargeControl=dcBoostChargeControl, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcPowerLimitationEntry=dcPowerLimitationEntry, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcMaximumLoadStep=dcMaximumLoadStep, dcUrgentAlarmValue=dcUrgentAlarmValue, batteryGroup=batteryGroup, dcBatteryTestUsupport=dcBatteryTestUsupport, dcGenericAlarmTable=dcGenericAlarmTable, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcMeasurementName=dcMeasurementName, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcMinimumLoadStep=dcMinimumLoadStep, dcLvdEntry=dcLvdEntry, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, systemInfoGroup=systemInfoGroup, dcBatteryTestTempTo=dcBatteryTestTempTo, dcBatteryStringEntry=dcBatteryStringEntry, dcTrapDestinationEntry=dcTrapDestinationEntry, dcAlarmEventValue=dcAlarmEventValue, dcEnableUsTempComp=dcEnableUsTempComp, rectifierGroupTableGroup=rectifierGroupTableGroup, measurementTableGroup=measurementTableGroup, dcUsys20=dcUsys20, dcEqualizeEnabled=dcEqualizeEnabled, dcFileProcessingStatus=dcFileProcessingStatus, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcTempSupervision=dcTempSupervision, dcUaMax=dcUaMax, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcRunawayVoltage=dcRunawayVoltage, dcEventHistoryMessage=dcEventHistoryMessage, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcControlEventIdentifier=dcControlEventIdentifier, dcHighStartTemp=dcHighStartTemp, rectifierGroup=rectifierGroup, dcTrapDestinationIp=dcTrapDestinationIp, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcMeterPanelEventValue=dcMeterPanelEventValue, dcBoostChargeIstart=dcBoostChargeIstart, eventHistoryTableGroup=eventHistoryTableGroup, dcControlEventValue=dcControlEventValue, dcMeasurementUnit=dcMeasurementUnit, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcBatteryTestInterval=dcBatteryTestInterval, dcRectifier=dcRectifier, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcBatteryTestControl=dcBatteryTestControl, controllerEventObjects=controllerEventObjects, dcSystemPower=dcSystemPower, dcSystemVoltage=dcSystemVoltage, dcBoostCharge=dcBoostCharge, dcBatteryTestType=dcBatteryTestType, dcEventHistoryEntry=dcEventHistoryEntry, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, controlEventTableGroup=controlEventTableGroup, meterPanelEventTableGroup=meterPanelEventTableGroup, dcMeterPanelEventTable=dcMeterPanelEventTable, dcEqualizeDuration=dcEqualizeDuration, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcInputOutput=dcInputOutput, dcEqualizeTimeLag=dcEqualizeTimeLag, dcSoftwareVersion=dcSoftwareVersion, dcEventProcessingEventName=dcEventProcessingEventName, systemAlarmGroup=systemAlarmGroup, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcAlarmTable=dcAlarmTable, dcPowerLimitation=dcPowerLimitation, dcCriticalAlarmValue=dcCriticalAlarmValue, dcBoostChargeIstop=dcBoostChargeIstop, dcMeasurementIndex=dcMeasurementIndex, dcMeasurementTable=dcMeasurementTable, dcEqualize=dcEqualize, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcAlarmEventName=dcAlarmEventName, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcTrapDestinationTable=dcTrapDestinationTable, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcLvdName=dcLvdName, dcLossOfBackupTime=dcLossOfBackupTime, dcFloatCharge=dcFloatCharge, dcRectifierGroupEntry=dcRectifierGroupEntry, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcMeterPanelEventName=dcMeterPanelEventName, dcRectifierFunctions=dcRectifierFunctions, miscGroup=miscGroup, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcSiteName=dcSiteName, dcBatteryTestResult=dcBatteryTestResult, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcBatteryTest=dcBatteryTest, dcPowerLimitationType=dcPowerLimitationType, powerLimitationTableGroup=powerLimitationTableGroup, dcEventHistoryTable=dcEventHistoryTable, dcConfig=dcConfig, controllerEventsV2=controllerEventsV2, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcEventHistoryIndex=dcEventHistoryIndex, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcEqualizeStatus=dcEqualizeStatus, dcBatteryStringTable=dcBatteryStringTable, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcRectifierIdentifier=dcRectifierIdentifier, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcBoostChargeStatus=dcBoostChargeStatus, dcLoadCurrent=dcLoadCurrent, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcMainsFailureAlarm=dcMainsFailureAlarm, controllerGroups=controllerGroups, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcBatteryTestDuration=dcBatteryTestDuration, defaultLogEventTableGroup=defaultLogEventTableGroup, dcExpectedBackupTime=dcExpectedBackupTime, dcRunawayTemp=dcRunawayTemp, dcEqualizeVoltage=dcEqualizeVoltage, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcHighStopVoltage=dcHighStopVoltage, dcNumberRectifiers=dcNumberRectifiers, controllerObjects=controllerObjects, dcBatteryStringCapacity=dcBatteryStringCapacity, dcBatteryCurrent=dcBatteryCurrent, dcStopTemp=dcStopTemp, dcTrapDestinationPort=dcTrapDestinationPort, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcEvtCtrlCharge=dcEvtCtrlCharge, dcRectifierCurrent=dcRectifierCurrent, controllerConfs=controllerConfs, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcControlEventIndex=dcControlEventIndex, dcDefaultLogEventName=dcDefaultLogEventName, dcBatteryStringIndex=dcBatteryStringIndex, dcSystemAlarms=dcSystemAlarms, dcDefaultLogEventTable=dcDefaultLogEventTable, dcLvdTable=dcLvdTable, dcMeterPanel=dcMeterPanel, dcUaMin=dcUaMin, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcHighTempSlope=dcHighTempSlope, dcAlarmEntry=dcAlarmEntry, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcMeasurementEntry=dcMeasurementEntry, systemMonitorGroup=systemMonitorGroup, genericAlarmTableGroup=genericAlarmTableGroup, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcAlarmEventCategory=dcAlarmEventCategory, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcEqualizeParameter=dcEqualizeParameter, lvdTableGroup=lvdTableGroup, dcEqualizeControl=dcEqualizeControl, dcBatteryTestParameter=dcBatteryTestParameter, dcAlarmIndex=dcAlarmIndex, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcBoostChargeVoltage=dcBoostChargeVoltage, dcHysteresis=dcHysteresis)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcMaxVoltage=dcMaxVoltage, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcUsMax=dcUsMax, dcRectifierTable=dcRectifierTable, dcControlEventEntry=dcControlEventEntry, dcPowerLimitationIndex=dcPowerLimitationIndex, alarmTableGroup=alarmTableGroup, dcSystemName=dcSystemName, systemUrgentAlarm=systemUrgentAlarm, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcHighTemp=dcHighTemp, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcMeasurement=dcMeasurement)
