...
MibIdentifier, Integer32, IpAddress, ModuleIdentity, TimeTicks, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, NotificationType, enterprises, iso, Bits, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "IpAddress", "ModuleIdentity", "TimeTicks", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "NotificationType", "enterprises", "iso", "Bits", "Counter64")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcBatteryTest=dcBatteryTest, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcAlarmEventValue=dcAlarmEventValue, dcEventProcessingEventName=dcEventProcessingEventName, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcControlEventIdentifier=dcControlEventIdentifier, dcRectifierFunctions=dcRectifierFunctions, dcRectifierEntry=dcRectifierEntry, dcAlarmEventCategory=dcAlarmEventCategory, dcConfig=dcConfig, dcUaMax=dcUaMax, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcTrapDestinationIp=dcTrapDestinationIp, dcBoostChargeType=dcBoostChargeType, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, measurementTableGroup=measurementTableGroup, dcRectifierIdentifier=dcRectifierIdentifier, systemInfoGroup=systemInfoGroup, dcFileProcessingStatus=dcFileProcessingStatus, dcLoadCurrent=dcLoadCurrent, dcRectifierGroupTable=dcRectifierGroupTable, dcDefaultLogEventIndex=dcDefaultLogEventIndex, batteryStringTableGroup=batteryStringTableGroup, dcBatteryTestParameter=dcBatteryTestParameter, dcEventHistoryEntry=dcEventHistoryEntry, dcGenericAlarmEventName=dcGenericAlarmEventName, dcEqualizeTimeLag=dcEqualizeTimeLag, dcRunawayVoltage=dcRunawayVoltage, dcBatteryTestInterval=dcBatteryTestInterval, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, notificationsGroup=notificationsGroup, dcBatteryStringCapacity=dcBatteryStringCapacity, dcEqualizeParameter=dcEqualizeParameter, dcMeasurementName=dcMeasurementName, dcBatteryParameter=dcBatteryParameter, dcCurrentLimit=dcCurrentLimit, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcBatteryCurrent=dcBatteryCurrent, dcEventHistoryMessage=dcEventHistoryMessage, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcCriticalAlarmName=dcCriticalAlarmName, defaultLogEventTableGroup=defaultLogEventTableGroup, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcEqualizeLeadTime=dcEqualizeLeadTime, dcBatteryStringName=dcBatteryStringName, rectifierGroupTableGroup=rectifierGroupTableGroup, dcMeterPanel=dcMeterPanel, dcTrapDestinationPort=dcTrapDestinationPort, dcSystemName=dcSystemName, dcPowerLimitationIndex=dcPowerLimitationIndex, dcMeterPanelEventName=dcMeterPanelEventName, dcRectifierGroupEntry=dcRectifierGroupEntry, dcMeasurementEntry=dcMeasurementEntry, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcTempCompType=dcTempCompType, systemMonitorGroup=systemMonitorGroup, dcHighTemp=dcHighTemp, dcBatteryTestControl=dcBatteryTestControl, dcLowTempSlope=dcLowTempSlope, dcSlope=dcSlope, dcEventProcessingEventType=dcEventProcessingEventType, dcMisc=dcMisc, controllerBasicCompl=controllerBasicCompl, dcBoostChargeParameter=dcBoostChargeParameter, dcLvdName=dcLvdName, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcRectifierCurrent=dcRectifierCurrent, dcSystemInfo=dcSystemInfo, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcHighTempSlope=dcHighTempSlope, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcControlEventIndex=dcControlEventIndex, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcBatteryTemperature=dcBatteryTemperature, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcBoostChargeIstop=dcBoostChargeIstop, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcLowStartTemp=dcLowStartTemp, dcBattery=dcBattery, dcBoostChargeStatus=dcBoostChargeStatus, systemUrgentAlarm=systemUrgentAlarm, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcEventProcessingEventTable=dcEventProcessingEventTable, dcAlarmIndex=dcAlarmIndex, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcEnableUsTempComp=dcEnableUsTempComp, dcMeterPanelEventValue=dcMeterPanelEventValue, dcEqualizeControl=dcEqualizeControl, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcFloatCharge=dcFloatCharge, dcUsMax=dcUsMax, dcLvdTable=dcLvdTable, dcBoD=dcBoD, controllerEvents=controllerEvents, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, alarmTableGroup=alarmTableGroup, genericAlarmTableGroup=genericAlarmTableGroup, dcPowerLimitationTable=dcPowerLimitationTable, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcPowerLimitation=dcPowerLimitation, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcTrapDestinationIndex=dcTrapDestinationIndex, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcHighStartTemp=dcHighStartTemp, dcRectifierGroupName=dcRectifierGroupName, dcEqualize=dcEqualize, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcMainsFailureAlarm=dcMainsFailureAlarm, dcUsys20=dcUsys20, dcMeasurementIndex=dcMeasurementIndex, dcRectifierTable=dcRectifierTable, dcSystemPower=dcSystemPower, controllerConfs=controllerConfs, dcBatteryTestResults=dcBatteryTestResults, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcPowerLimitationType=dcPowerLimitationType, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcRunawayTemp=dcRunawayTemp, dcMaxVoltage=dcMaxVoltage, dcStartTemp=dcStartTemp, dcGenericAlarmEntry=dcGenericAlarmEntry, dcLvdEntry=dcLvdEntry, dcUrgentAlarmValue=dcUrgentAlarmValue, dcPowerLimitationLimit=dcPowerLimitationLimit, systemNonUrgentAlarm=systemNonUrgentAlarm, dcPowerLimitationEventName=dcPowerLimitationEventName, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcStopTemp=dcStopTemp, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcBatteryStringEntry=dcBatteryStringEntry, dcDefaultLogEventLogged=dcDefaultLogEventLogged, controlEventTableGroup=controlEventTableGroup, dcRectifierGroupIndex=dcRectifierGroupIndex, dcBoostCharge=dcBoostCharge, dcAlarmEventName=dcAlarmEventName, dcSystemAlarms=dcSystemAlarms, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcEfficiencyCycling=dcEfficiencyCycling, dcEqualizeDuration=dcEqualizeDuration, dcUaMin=dcUaMin, dcBatteryTestUsupport=dcBatteryTestUsupport, dcInputOutput=dcInputOutput, dcSystemDateTime=dcSystemDateTime, dcBatteryTestTempTo=dcBatteryTestTempTo, dcAlarmTable=dcAlarmTable, dcDefaultLogEventTable=dcDefaultLogEventTable, trapDestinationTableGroup=trapDestinationTableGroup, dcMeasurementUnit=dcMeasurementUnit, dcSystemVoltage=dcSystemVoltage, dcPowerLimitationStatus=dcPowerLimitationStatus, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, powerLimitationTableGroup=powerLimitationTableGroup, dcDefaultLogEventName=dcDefaultLogEventName, dcBatteryTestTempFrom=dcBatteryTestTempFrom, rectifierGroup=rectifierGroup, dcMeasurementValue=dcMeasurementValue, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcControlEventValue=dcControlEventValue, dcAlarmEntry=dcAlarmEntry, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcUrgentAlarmName=dcUrgentAlarmName, dcBatteryTestResult=dcBatteryTestResult, controllerGroups=controllerGroups, dcTrapDestinationEntry=dcTrapDestinationEntry, dcDefaultLogEventEntry=dcDefaultLogEventEntry, rectifierTableGroup=rectifierTableGroup, dcHighTempHyst=dcHighTempHyst, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcBoostChargeIstart=dcBoostChargeIstart, batteryGroup=batteryGroup, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcLossOfBackupTime=dcLossOfBackupTime, dcControlEventName=dcControlEventName, dcTempSupervision=dcTempSupervision, dcHighStopVoltage=dcHighStopVoltage, lvdTableGroup=lvdTableGroup, dcMeasurement=dcMeasurement, dcEventHistoryIndex=dcEventHistoryIndex, PYSNMP_MODULE_ID=orionBaseMibModule, dcSystemMonitor=dcSystemMonitor, dcControlEventTable=dcControlEventTable, dcChargeState=dcChargeState, miscGroup=miscGroup, dcPowerLimitationEntry=dcPowerLimitationEntry, dcMaximumLoadStep=dcMaximumLoadStep, dcBatteryTestDateTime=dcBatteryTestDateTime, dcRectifierStatus=dcRectifierStatus, dcControlEventEntry=dcControlEventEntry, dcTrapDestinationTable=dcTrapDestinationTable, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcHysteresis=dcHysteresis, dcLowStopVoltage=dcLowStopVoltage, dcUsMin=dcUsMin, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcGenericAlarmTable=dcGenericAlarmTable, controllerEventObjects=controllerEventObjects, systemAlarmGroup=systemAlarmGroup, dcMeasurementTable=dcMeasurementTable, dcBatteryTestStatus=dcBatteryTestStatus, dcBoostChargeVoltage=dcBoostChargeVoltage, dcLvdIndex=dcLvdIndex, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcEventHistoryTable=dcEventHistoryTable, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcMeterPanelEventTable=dcMeterPanelEventTable, dcLimitSwitchingTimes=dcLimitSwitchingTimes, meterPanelEventTableGroup=meterPanelEventTableGroup, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcExpectedBackupTime=dcExpectedBackupTime, dcEqualizeStatus=dcEqualizeStatus, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcBatteryStringTable=dcBatteryStringTable, controllerCompl=controllerCompl, dcBatteryTestType=dcBatteryTestType, dcBoostChargeControl=dcBoostChargeControl, orionBaseMibModule=orionBaseMibModule, dcBatteryTestDuration=dcBatteryTestDuration, dcEqualizeEnabled=dcEqualizeEnabled, dcEqualizeVoltage=dcEqualizeVoltage, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcGenericAlarmIndex=dcGenericAlarmIndex, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, eventHistoryTableGroup=eventHistoryTableGroup, controllerEventsV2=controllerEventsV2, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcNumberRectifiers=dcNumberRectifiers, dcRectifierIndex=dcRectifierIndex, dcEqualizeInterval=dcEqualizeInterval, systemCriticalAlarm=systemCriticalAlarm, dcBatteryStringIndex=dcBatteryStringIndex, dcRectifier=dcRectifier, dcSiteName=dcSiteName, orionBaseMib=orionBaseMib, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, controllerObjects=controllerObjects)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcMinimumLoadStep=dcMinimumLoadStep, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcEvtCtrlCharge=dcEvtCtrlCharge, dcTempComp=dcTempComp, dcCriticalAlarmValue=dcCriticalAlarmValue, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcSoftwareVersion=dcSoftwareVersion, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff)
