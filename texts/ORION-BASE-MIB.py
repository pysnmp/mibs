...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcMeasurementEntry=dcMeasurementEntry, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcRectifierGroupIndex=dcRectifierGroupIndex, dcSystemName=dcSystemName, dcControlEventName=dcControlEventName, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcMinimumLoadStep=dcMinimumLoadStep, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcControlEventTable=dcControlEventTable, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcUsMin=dcUsMin, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcBatteryCurrent=dcBatteryCurrent, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcRectifierIdentifier=dcRectifierIdentifier, dcMeasurementUnit=dcMeasurementUnit, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcHighStartTemp=dcHighStartTemp, dcControlEventIndex=dcControlEventIndex, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcPowerLimitationTable=dcPowerLimitationTable, measurementTableGroup=measurementTableGroup, dcUrgentAlarmValue=dcUrgentAlarmValue, genericAlarmTableGroup=genericAlarmTableGroup, dcHighTempHyst=dcHighTempHyst, dcPowerLimitationLimit=dcPowerLimitationLimit, dcBattery=dcBattery, dcSoftwareVersion=dcSoftwareVersion, alarmTableGroup=alarmTableGroup, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, lvdTableGroup=lvdTableGroup, dcLowStartTemp=dcLowStartTemp, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcBatteryTestControl=dcBatteryTestControl, dcStopTemp=dcStopTemp, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, defaultLogEventTableGroup=defaultLogEventTableGroup, dcChargeState=dcChargeState, dcRunawayVoltage=dcRunawayVoltage, PYSNMP_MODULE_ID=orionBaseMibModule, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, controllerObjects=controllerObjects, dcBatteryStringCapacity=dcBatteryStringCapacity, dcMeterPanelEventName=dcMeterPanelEventName, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcTrapDestinationPort=dcTrapDestinationPort, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, controllerBasicCompl=controllerBasicCompl, dcPowerLimitationType=dcPowerLimitationType, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcEventProcessingEventName=dcEventProcessingEventName, powerLimitationTableGroup=powerLimitationTableGroup, dcBoostChargeParameter=dcBoostChargeParameter, dcBoostChargeControl=dcBoostChargeControl, dcSystemMonitor=dcSystemMonitor, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcUrgentAlarmName=dcUrgentAlarmName, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcEqualizeDuration=dcEqualizeDuration, dcTrapDestinationIndex=dcTrapDestinationIndex, dcLvdTable=dcLvdTable, dcEqualize=dcEqualize, dcEventProcessingEventTable=dcEventProcessingEventTable, batteryGroup=batteryGroup, dcEqualizeStatus=dcEqualizeStatus, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, batteryStringTableGroup=batteryStringTableGroup, dcGenericAlarmEntry=dcGenericAlarmEntry, dcMeasurementName=dcMeasurementName, dcHighStopVoltage=dcHighStopVoltage, dcPowerLimitationIndex=dcPowerLimitationIndex, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcBoostChargeType=dcBoostChargeType, dcEqualizeParameter=dcEqualizeParameter, dcEqualizeLeadTime=dcEqualizeLeadTime, dcRectifierEntry=dcRectifierEntry, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcEventHistoryMessage=dcEventHistoryMessage, dcCriticalAlarmValue=dcCriticalAlarmValue, dcLoadCurrent=dcLoadCurrent, dcUaMin=dcUaMin, dcRectifierGroupTable=dcRectifierGroupTable, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, controllerEvents=controllerEvents, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcBatteryStringTable=dcBatteryStringTable, dcEqualizeEnabled=dcEqualizeEnabled, dcBatteryTestDateTime=dcBatteryTestDateTime, dcRectifierStatus=dcRectifierStatus, dcRectifier=dcRectifier, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcSlope=dcSlope, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcNonUrgentAlarmName=dcNonUrgentAlarmName, orionBaseMib=orionBaseMib, dcSystemDateTime=dcSystemDateTime, dcLowStopVoltage=dcLowStopVoltage, notificationsGroup=notificationsGroup, dcTempCompType=dcTempCompType, dcStartTemp=dcStartTemp, dcRectifierGroupEntry=dcRectifierGroupEntry, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcControlEventValue=dcControlEventValue, dcRectifierFunctions=dcRectifierFunctions, dcBatteryStringName=dcBatteryStringName, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcDefaultLogEventName=dcDefaultLogEventName, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcBatteryTestType=dcBatteryTestType, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcMeasurementTable=dcMeasurementTable, dcBoostChargeIstart=dcBoostChargeIstart, dcLowTempSlope=dcLowTempSlope, dcEqualizeVoltage=dcEqualizeVoltage, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcPowerLimitationStatus=dcPowerLimitationStatus, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, controllerCompl=controllerCompl, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcTrapDestinationEntry=dcTrapDestinationEntry, dcPowerLimitationEntry=dcPowerLimitationEntry, dcHysteresis=dcHysteresis, dcGenericAlarmEventValue=dcGenericAlarmEventValue, controllerGroups=controllerGroups, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcFileProcessingStatus=dcFileProcessingStatus, dcSystemInfo=dcSystemInfo, dcMainsFailureAlarm=dcMainsFailureAlarm, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcAlarmEventName=dcAlarmEventName, dcRectifierIndex=dcRectifierIndex, dcSiteName=dcSiteName, dcEnableUsTempComp=dcEnableUsTempComp, dcEventHistoryTable=dcEventHistoryTable, dcAlarmEventValue=dcAlarmEventValue, dcUsMax=dcUsMax, controllerConfs=controllerConfs, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcMeasurementIndex=dcMeasurementIndex, dcHighTemp=dcHighTemp, dcSystemAlarms=dcSystemAlarms, dcExpectedBackupTime=dcExpectedBackupTime, dcEqualizeControl=dcEqualizeControl, dcCriticalAlarmName=dcCriticalAlarmName, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcGenericAlarmTable=dcGenericAlarmTable, dcBatteryTestParameter=dcBatteryTestParameter, dcMisc=dcMisc, dcTrapDestinationIp=dcTrapDestinationIp, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcTempComp=dcTempComp, controllerEventObjects=controllerEventObjects, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcNumberRectifiers=dcNumberRectifiers, dcRectifierGroupName=dcRectifierGroupName, controllerEventsV2=controllerEventsV2, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, systemAlarmGroup=systemAlarmGroup, dcSystemVoltage=dcSystemVoltage, dcMeterPanelEventEntry=dcMeterPanelEventEntry, miscGroup=miscGroup, dcCurrentLimit=dcCurrentLimit, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcBatteryStringEntry=dcBatteryStringEntry, dcLossOfBackupTime=dcLossOfBackupTime, systemNonUrgentAlarm=systemNonUrgentAlarm, meterPanelEventTableGroup=meterPanelEventTableGroup, dcMeasurementValue=dcMeasurementValue, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcMaxVoltage=dcMaxVoltage, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcGenericAlarmIndex=dcGenericAlarmIndex, dcLvdIndex=dcLvdIndex, dcPowerLimitation=dcPowerLimitation, systemInfoGroup=systemInfoGroup, dcControlEventIdentifier=dcControlEventIdentifier, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcBatteryParameter=dcBatteryParameter, dcUaMax=dcUaMax, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcMeterPanel=dcMeterPanel, dcNumberUrgentAlarms=dcNumberUrgentAlarms, rectifierTableGroup=rectifierTableGroup, dcEvtCtrlChargeType=dcEvtCtrlChargeType, orionBaseMibModule=orionBaseMibModule, dcRectifierTable=dcRectifierTable, dcFloatCharge=dcFloatCharge, dcEventProcessingEventType=dcEventProcessingEventType, dcBatteryTemperature=dcBatteryTemperature, dcBoD=dcBoD, dcAlarmEventCategory=dcAlarmEventCategory, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, trapDestinationTableGroup=trapDestinationTableGroup, dcConfig=dcConfig, dcBoostCharge=dcBoostCharge, dcMeasurement=dcMeasurement, dcBatteryTestInterval=dcBatteryTestInterval, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcMeterPanelEventTable=dcMeterPanelEventTable, dcBatteryTestResults=dcBatteryTestResults, dcRectifierCurrent=dcRectifierCurrent, dcEventHistoryEntry=dcEventHistoryEntry, dcInputOutput=dcInputOutput, dcGenericAlarmEventName=dcGenericAlarmEventName, dcMeterPanelEventValue=dcMeterPanelEventValue, dcLvdEntry=dcLvdEntry, dcBatteryTestUsupport=dcBatteryTestUsupport, dcBoostChargeStatus=dcBoostChargeStatus, dcUsys20=dcUsys20, dcControlEventEntry=dcControlEventEntry, dcBatteryTestDuration=dcBatteryTestDuration, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcAlarmIndex=dcAlarmIndex, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcLvdName=dcLvdName, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcAlarmTable=dcAlarmTable, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcBatteryStringIndex=dcBatteryStringIndex, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, systemMonitorGroup=systemMonitorGroup, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcDefaultLogEventTable=dcDefaultLogEventTable, eventHistoryTableGroup=eventHistoryTableGroup, dcBatteryTestResult=dcBatteryTestResult, dcBatteryTestTempTo=dcBatteryTestTempTo, dcBoostChargeIstop=dcBoostChargeIstop, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcRunawayTemp=dcRunawayTemp, dcNumberRectifiersOkay=dcNumberRectifiersOkay, rectifierGroup=rectifierGroup, rectifierGroupTableGroup=rectifierGroupTableGroup, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcMaximumLoadStep=dcMaximumLoadStep, dcSystemPower=dcSystemPower, dcEqualizeInterval=dcEqualizeInterval, dcEvtCtrlCharge=dcEvtCtrlCharge)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcTempSupervision=dcTempSupervision, dcBatteryTest=dcBatteryTest, dcEventHistoryIndex=dcEventHistoryIndex, dcAlarmEntry=dcAlarmEntry, dcHighTempSlope=dcHighTempSlope, systemCriticalAlarm=systemCriticalAlarm, dcEqualizeTimeLag=dcEqualizeTimeLag, controlEventTableGroup=controlEventTableGroup, dcPowerLimitationEventName=dcPowerLimitationEventName, systemUrgentAlarm=systemUrgentAlarm, dcBatteryTestStatus=dcBatteryTestStatus, dcTrapDestinationTable=dcTrapDestinationTable, dcBoostChargeVoltage=dcBoostChargeVoltage, dcEfficiencyCycling=dcEfficiencyCycling)
