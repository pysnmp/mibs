...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcChargeState=dcChargeState, dcUaMax=dcUaMax, dcBatteryParameter=dcBatteryParameter, orionBaseMib=orionBaseMib, dcGenericAlarmEntry=dcGenericAlarmEntry, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcMaximumLoadStep=dcMaximumLoadStep, dcBattery=dcBattery, dcBoostChargeType=dcBoostChargeType, dcEventHistoryTable=dcEventHistoryTable, dcRectifierTable=dcRectifierTable, dcExpectedBackupTime=dcExpectedBackupTime, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcRunawayVoltage=dcRunawayVoltage, dcHighTempSlope=dcHighTempSlope, dcSystemInfo=dcSystemInfo, dcBatteryStringEntry=dcBatteryStringEntry, dcEventProcessingEventIndex=dcEventProcessingEventIndex, rectifierGroupTableGroup=rectifierGroupTableGroup, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcBatteryTestDuration=dcBatteryTestDuration, dcLvdTable=dcLvdTable, dcRectifierGroupName=dcRectifierGroupName, batteryStringTableGroup=batteryStringTableGroup, dcGenericAlarmIndex=dcGenericAlarmIndex, dcMeterPanelEventValue=dcMeterPanelEventValue, dcHysteresis=dcHysteresis, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcEventHistoryIndex=dcEventHistoryIndex, dcEqualizeStatus=dcEqualizeStatus, dcSystemVoltage=dcSystemVoltage, dcHighStopVoltage=dcHighStopVoltage, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, eventHistoryTableGroup=eventHistoryTableGroup, controllerEventsV2=controllerEventsV2, dcRectifierFunctions=dcRectifierFunctions, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcPowerLimitationTable=dcPowerLimitationTable, dcLowStartTemp=dcLowStartTemp, dcMeterPanelEventTable=dcMeterPanelEventTable, dcTempSupervision=dcTempSupervision, dcBatteryTestParameter=dcBatteryTestParameter, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcPowerLimitationType=dcPowerLimitationType, dcBoostChargeVoltage=dcBoostChargeVoltage, dcDefaultLogEventName=dcDefaultLogEventName, dcLossOfBackupTime=dcLossOfBackupTime, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcBatteryTestDateTime=dcBatteryTestDateTime, dcTrapDestinationTable=dcTrapDestinationTable, dcAlarmTable=dcAlarmTable, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcBatteryStringTable=dcBatteryStringTable, dcBatteryTestUsupport=dcBatteryTestUsupport, dcAlarmIndex=dcAlarmIndex, dcBoD=dcBoD, dcFileProcessingStatus=dcFileProcessingStatus, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, controllerConfs=controllerConfs, dcStartTemp=dcStartTemp, dcEqualizeVoltage=dcEqualizeVoltage, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, systemInfoGroup=systemInfoGroup, dcNumberRectifiers=dcNumberRectifiers, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcCriticalAlarmName=dcCriticalAlarmName, dcStopTemp=dcStopTemp, systemUrgentAlarm=systemUrgentAlarm, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, genericAlarmTableGroup=genericAlarmTableGroup, powerLimitationTableGroup=powerLimitationTableGroup, dcBatteryStringIndex=dcBatteryStringIndex, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcCurrentLimit=dcCurrentLimit, dcMeasurementTable=dcMeasurementTable, dcControlEventIndex=dcControlEventIndex, systemNonUrgentAlarm=systemNonUrgentAlarm, dcRectifierEntry=dcRectifierEntry, dcRectifierIndex=dcRectifierIndex, dcTempComp=dcTempComp, dcBatteryTestResults=dcBatteryTestResults, dcGenericAlarmTable=dcGenericAlarmTable, dcLvdName=dcLvdName, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcEqualizeDuration=dcEqualizeDuration, defaultLogEventTableGroup=defaultLogEventTableGroup, dcMeasurementName=dcMeasurementName, dcUrgentAlarmValue=dcUrgentAlarmValue, dcLowStopVoltage=dcLowStopVoltage, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcPowerLimitation=dcPowerLimitation, dcLowTempSlope=dcLowTempSlope, systemCriticalAlarm=systemCriticalAlarm, dcMeterPanelEventName=dcMeterPanelEventName, dcEfficiencyCycling=dcEfficiencyCycling, dcBoostChargeIstop=dcBoostChargeIstop, rectifierTableGroup=rectifierTableGroup, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcBoostChargeControl=dcBoostChargeControl, dcSiteName=dcSiteName, dcEqualizeTimeLag=dcEqualizeTimeLag, dcMeasurement=dcMeasurement, dcBatteryCurrent=dcBatteryCurrent, dcMaxVoltage=dcMaxVoltage, dcSystemMonitor=dcSystemMonitor, dcEqualizeControl=dcEqualizeControl, dcControlEventName=dcControlEventName, dcBatteryTestTempTo=dcBatteryTestTempTo, dcUrgentAlarmName=dcUrgentAlarmName, dcAlarmEventValue=dcAlarmEventValue, controllerBasicCompl=controllerBasicCompl, dcLvdIndex=dcLvdIndex, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcUsMin=dcUsMin, dcMinimumLoadStep=dcMinimumLoadStep, dcBoostChargeStatus=dcBoostChargeStatus, dcEventProcessingEventName=dcEventProcessingEventName, dcMeasurementUnit=dcMeasurementUnit, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcHighStartTemp=dcHighStartTemp, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, miscGroup=miscGroup, alarmTableGroup=alarmTableGroup, dcNonUrgentAlarmName=dcNonUrgentAlarmName, trapDestinationTableGroup=trapDestinationTableGroup, dcBatteryTestControl=dcBatteryTestControl, dcPowerLimitationStatus=dcPowerLimitationStatus, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcMeterPanel=dcMeterPanel, dcControlEventIdentifier=dcControlEventIdentifier, dcHighTempHyst=dcHighTempHyst, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcAlarmEventName=dcAlarmEventName, dcSoftwareVersion=dcSoftwareVersion, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcRectifierGroupEntry=dcRectifierGroupEntry, dcTrapDestinationIp=dcTrapDestinationIp, dcBatteryTestInterval=dcBatteryTestInterval, dcEventHistoryMessage=dcEventHistoryMessage, systemMonitorGroup=systemMonitorGroup, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcTrapDestinationEntry=dcTrapDestinationEntry, dcUaMin=dcUaMin, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcTrapDestinationIndex=dcTrapDestinationIndex, controlEventTableGroup=controlEventTableGroup, dcCriticalAlarmValue=dcCriticalAlarmValue, dcPowerLimitationLimit=dcPowerLimitationLimit, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, controllerGroups=controllerGroups, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcBatteryTestType=dcBatteryTestType, dcSystemAlarms=dcSystemAlarms, dcSystemName=dcSystemName, controllerEvents=controllerEvents, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcDefaultLogEventTable=dcDefaultLogEventTable, dcRectifierGroupTable=dcRectifierGroupTable, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcPowerLimitationEntry=dcPowerLimitationEntry, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcHighTemp=dcHighTemp, dcEqualize=dcEqualize, dcBatteryTemperature=dcBatteryTemperature, dcBoostChargeIstart=dcBoostChargeIstart, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcControlEventTable=dcControlEventTable, dcFloatCharge=dcFloatCharge, dcConfig=dcConfig, notificationsGroup=notificationsGroup, dcControlEventValue=dcControlEventValue, meterPanelEventTableGroup=meterPanelEventTableGroup, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcEvtCtrlCharge=dcEvtCtrlCharge, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcBatteryTestStatus=dcBatteryTestStatus, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcSlope=dcSlope, dcControlEventEntry=dcControlEventEntry, dcEventProcessingEventType=dcEventProcessingEventType, dcAlarmEventCategory=dcAlarmEventCategory, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, batteryGroup=batteryGroup, PYSNMP_MODULE_ID=orionBaseMibModule, dcEnableUsTempComp=dcEnableUsTempComp, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcBatteryTestResult=dcBatteryTestResult, measurementTableGroup=measurementTableGroup, dcPowerLimitationEventName=dcPowerLimitationEventName, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcRectifierGroupIndex=dcRectifierGroupIndex, dcTrapDestinationPort=dcTrapDestinationPort, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcBoostCharge=dcBoostCharge, orionBaseMibModule=orionBaseMibModule, dcRectifierIdentifier=dcRectifierIdentifier, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcGenericAlarmEventName=dcGenericAlarmEventName, systemAlarmGroup=systemAlarmGroup, dcRectifierStatus=dcRectifierStatus, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcRectifier=dcRectifier, dcBoostChargeParameter=dcBoostChargeParameter, dcEqualizeEnabled=dcEqualizeEnabled, dcSystemDateTime=dcSystemDateTime, dcEqualizeLeadTime=dcEqualizeLeadTime, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcBatteryStringCapacity=dcBatteryStringCapacity, dcMeasurementIndex=dcMeasurementIndex, controllerEventObjects=controllerEventObjects, dcTempCompType=dcTempCompType, dcMeasurementValue=dcMeasurementValue, dcMeterPanelEventEntry=dcMeterPanelEventEntry, controllerCompl=controllerCompl, rectifierGroup=rectifierGroup, dcMisc=dcMisc, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcBatteryTest=dcBatteryTest, dcLvdEntry=dcLvdEntry, dcEqualizeParameter=dcEqualizeParameter, dcAlarmEntry=dcAlarmEntry, dcEqualizeInterval=dcEqualizeInterval, dcPowerLimitationIndex=dcPowerLimitationIndex, dcUsys20=dcUsys20, dcMainsFailureAlarm=dcMainsFailureAlarm, dcSystemPower=dcSystemPower, dcBatteryStringName=dcBatteryStringName, dcMeasurementEntry=dcMeasurementEntry, dcLoadCurrent=dcLoadCurrent)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcRunawayTemp=dcRunawayTemp, controllerObjects=controllerObjects, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcEventHistoryEntry=dcEventHistoryEntry, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, lvdTableGroup=lvdTableGroup, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcRectifierCurrent=dcRectifierCurrent, dcInputOutput=dcInputOutput, dcEventProcessingEventTable=dcEventProcessingEventTable, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcUsMax=dcUsMax)
