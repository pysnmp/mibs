...
Counter32, enterprises, MibIdentifier, TimeTicks, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Integer32, Unsigned32, Bits, NotificationType, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Integer32", "Unsigned32", "Bits", "NotificationType", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcSoftwareVersion=dcSoftwareVersion, dcRectifierFunctions=dcRectifierFunctions, dcFileProcessingStatus=dcFileProcessingStatus, dcSystemPower=dcSystemPower, dcCurrentLimit=dcCurrentLimit, dcRectifierTable=dcRectifierTable, dcMeterPanelEventTable=dcMeterPanelEventTable, dcMinimumLoadStep=dcMinimumLoadStep, controllerEventsV2=controllerEventsV2, dcHighTempSlope=dcHighTempSlope, defaultLogEventTableGroup=defaultLogEventTableGroup, dcLimitSwitchingTimes=dcLimitSwitchingTimes, systemUrgentAlarm=systemUrgentAlarm, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcTrapDestinationTable=dcTrapDestinationTable, dcPowerLimitationIndex=dcPowerLimitationIndex, dcMeasurementTable=dcMeasurementTable, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcRectifier=dcRectifier, dcMisc=dcMisc, dcLoadCurrent=dcLoadCurrent, dcBatteryTestUsupport=dcBatteryTestUsupport, dcDefaultLogEventName=dcDefaultLogEventName, rectifierGroup=rectifierGroup, dcCriticalAlarmName=dcCriticalAlarmName, dcInputOutput=dcInputOutput, dcRectifierCurrent=dcRectifierCurrent, dcBatteryTestResult=dcBatteryTestResult, dcEqualize=dcEqualize, dcEventHistoryMessage=dcEventHistoryMessage, dcBoostChargeIstop=dcBoostChargeIstop, dcLowStartTemp=dcLowStartTemp, dcPowerLimitationStatus=dcPowerLimitationStatus, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, alarmTableGroup=alarmTableGroup, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, lvdTableGroup=lvdTableGroup, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcBoostChargeParameter=dcBoostChargeParameter, dcBatteryTestTempTo=dcBatteryTestTempTo, dcRectifierGroupTable=dcRectifierGroupTable, dcExpectedBackupTime=dcExpectedBackupTime, dcEventHistoryIndex=dcEventHistoryIndex, dcTempSupervision=dcTempSupervision, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcPowerLimitationType=dcPowerLimitationType, dcCriticalAlarmValue=dcCriticalAlarmValue, dcSystemDateTime=dcSystemDateTime, dcUrgentAlarmValue=dcUrgentAlarmValue, dcSiteName=dcSiteName, dcMainsFailureAlarm=dcMainsFailureAlarm, dcBatteryCurrent=dcBatteryCurrent, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcBatteryTemperature=dcBatteryTemperature, dcRectifierGroupEntry=dcRectifierGroupEntry, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcBoD=dcBoD, dcBatteryTest=dcBatteryTest, dcLossOfBackupTime=dcLossOfBackupTime, PYSNMP_MODULE_ID=orionBaseMibModule, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcLvdIndex=dcLvdIndex, batteryGroup=batteryGroup, dcSystemMonitor=dcSystemMonitor, controllerEventObjects=controllerEventObjects, dcEqualizeStatus=dcEqualizeStatus, dcUaMin=dcUaMin, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcMeterPanelEventValue=dcMeterPanelEventValue, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, controllerEvents=controllerEvents, notificationsGroup=notificationsGroup, systemAlarmGroup=systemAlarmGroup, dcBoostChargeVoltage=dcBoostChargeVoltage, dcEqualizeLeadTime=dcEqualizeLeadTime, dcEventProcessingEventType=dcEventProcessingEventType, dcLowStopVoltage=dcLowStopVoltage, dcTempComp=dcTempComp, dcHighTemp=dcHighTemp, dcGenericAlarmTable=dcGenericAlarmTable, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcEventProcessingEventName=dcEventProcessingEventName, controllerGroups=controllerGroups, dcRectifierIndex=dcRectifierIndex, dcControlEventIndex=dcControlEventIndex, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, controllerBasicCompl=controllerBasicCompl, dcControlEventTable=dcControlEventTable, dcBoostChargeStatus=dcBoostChargeStatus, dcMeterPanel=dcMeterPanel, dcBatteryTestInterval=dcBatteryTestInterval, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcTempCompType=dcTempCompType, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcHighStartTemp=dcHighStartTemp, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcGenericAlarmIndex=dcGenericAlarmIndex, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcControlEventIdentifier=dcControlEventIdentifier, controllerObjects=controllerObjects, dcControlEventEntry=dcControlEventEntry, dcLvdEntry=dcLvdEntry, dcPowerLimitationEventName=dcPowerLimitationEventName, dcUsMax=dcUsMax, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcGenericAlarmEventName=dcGenericAlarmEventName, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcHighTempHyst=dcHighTempHyst, dcBatteryStringEntry=dcBatteryStringEntry, miscGroup=miscGroup, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcMeterPanelEventEntry=dcMeterPanelEventEntry, controlEventTableGroup=controlEventTableGroup, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcTrapDestinationIp=dcTrapDestinationIp, dcUrgentAlarmName=dcUrgentAlarmName, dcAlarmEventName=dcAlarmEventName, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcSystemInfo=dcSystemInfo, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcAlarmTable=dcAlarmTable, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, meterPanelEventTableGroup=meterPanelEventTableGroup, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcEqualizeTimeLag=dcEqualizeTimeLag, dcLowTempSlope=dcLowTempSlope, dcBoostCharge=dcBoostCharge, dcBatteryTestDateTime=dcBatteryTestDateTime, dcAlarmEventCategory=dcAlarmEventCategory, dcLvdName=dcLvdName, dcSlope=dcSlope, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcHysteresis=dcHysteresis, dcMeasurementEntry=dcMeasurementEntry, dcEqualizeInterval=dcEqualizeInterval, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcRectifierGroupIndex=dcRectifierGroupIndex, dcBatteryStringIndex=dcBatteryStringIndex, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcMeasurementUnit=dcMeasurementUnit, dcControlEventName=dcControlEventName, dcBoostChargeType=dcBoostChargeType, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcMeterPanelEventName=dcMeterPanelEventName, dcMaxVoltage=dcMaxVoltage, dcControlEventValue=dcControlEventValue, measurementTableGroup=measurementTableGroup, orionBaseMibModule=orionBaseMibModule, dcAlarmEntry=dcAlarmEntry, dcAlarmEventValue=dcAlarmEventValue, dcBatteryStringCapacity=dcBatteryStringCapacity, systemMonitorGroup=systemMonitorGroup, dcBatteryStringTable=dcBatteryStringTable, dcPowerLimitation=dcPowerLimitation, dcEqualizeEnabled=dcEqualizeEnabled, dcSystemName=dcSystemName, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcGenericAlarmEntry=dcGenericAlarmEntry, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcTrapDestinationPort=dcTrapDestinationPort, rectifierTableGroup=rectifierTableGroup, dcStopTemp=dcStopTemp, dcEventProcessingEventTable=dcEventProcessingEventTable, dcRectifierGroupName=dcRectifierGroupName, dcMeasurement=dcMeasurement, dcSystemVoltage=dcSystemVoltage, rectifierGroupTableGroup=rectifierGroupTableGroup, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcBatteryTestResults=dcBatteryTestResults, dcUsys20=dcUsys20, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcEventHistoryTable=dcEventHistoryTable, dcBatteryStringName=dcBatteryStringName, dcSystemAlarms=dcSystemAlarms, dcLvdTable=dcLvdTable, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcEqualizeDuration=dcEqualizeDuration, dcStartTemp=dcStartTemp, eventHistoryTableGroup=eventHistoryTableGroup, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcRunawayVoltage=dcRunawayVoltage, orionBaseMib=orionBaseMib, dcEfficiencyCycling=dcEfficiencyCycling, dcEvtCtrlCharge=dcEvtCtrlCharge, dcBattery=dcBattery, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcMeasurementIndex=dcMeasurementIndex, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcRectifierEntry=dcRectifierEntry, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcChargeState=dcChargeState, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcNumberRectifiers=dcNumberRectifiers, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcEqualizeVoltage=dcEqualizeVoltage, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcConfig=dcConfig, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcUsMin=dcUsMin, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, powerLimitationTableGroup=powerLimitationTableGroup, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcEqualizeControl=dcEqualizeControl, batteryStringTableGroup=batteryStringTableGroup, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcTrapDestinationEntry=dcTrapDestinationEntry, dcBoostChargeIstart=dcBoostChargeIstart, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcPowerLimitationEntry=dcPowerLimitationEntry, systemNonUrgentAlarm=systemNonUrgentAlarm, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcDefaultLogEventTable=dcDefaultLogEventTable, dcMaximumLoadStep=dcMaximumLoadStep, dcPowerLimitationLimit=dcPowerLimitationLimit, controllerCompl=controllerCompl, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcPowerLimitationTable=dcPowerLimitationTable, dcRectifierStatus=dcRectifierStatus, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcMeasurementName=dcMeasurementName, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcBatteryTestControl=dcBatteryTestControl, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcTrapDestinationIndex=dcTrapDestinationIndex, dcBatteryTestStatus=dcBatteryTestStatus, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcRunawayTemp=dcRunawayTemp, dcUaMax=dcUaMax, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcAlarmIndex=dcAlarmIndex, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcBatteryTestType=dcBatteryTestType, dcHighStopVoltage=dcHighStopVoltage, dcBoostChargeControl=dcBoostChargeControl, dcMeasurementValue=dcMeasurementValue, dcRectifierIdentifier=dcRectifierIdentifier, dcBatteryTestDuration=dcBatteryTestDuration)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcBatteryTestParameter=dcBatteryTestParameter, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcFloatCharge=dcFloatCharge, dcBatteryParameter=dcBatteryParameter, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcEqualizeParameter=dcEqualizeParameter, dcEventHistoryEntry=dcEventHistoryEntry, systemInfoGroup=systemInfoGroup, trapDestinationTableGroup=trapDestinationTableGroup, dcEnableUsTempComp=dcEnableUsTempComp, systemCriticalAlarm=systemCriticalAlarm, controllerConfs=controllerConfs, genericAlarmTableGroup=genericAlarmTableGroup, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage)
