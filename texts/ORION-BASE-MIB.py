...
Bits, TimeTicks, Integer32, ModuleIdentity, enterprises, ObjectIdentity, Unsigned32, Gauge32, MibIdentifier, Counter32, iso, NotificationType, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Integer32", "ModuleIdentity", "enterprises", "ObjectIdentity", "Unsigned32", "Gauge32", "MibIdentifier", "Counter32", "iso", "NotificationType", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcHighTempSlope=dcHighTempSlope, dcLossOfBackupTime=dcLossOfBackupTime, dcBatteryTestParameter=dcBatteryTestParameter, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcBoostChargeIstart=dcBoostChargeIstart, dcRectifierStatus=dcRectifierStatus, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcUaMin=dcUaMin, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcBatteryTestInterval=dcBatteryTestInterval, dcControlEventName=dcControlEventName, controllerConfs=controllerConfs, dcMeterPanelEventTable=dcMeterPanelEventTable, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcBatteryStringIndex=dcBatteryStringIndex, dcEqualizeVoltage=dcEqualizeVoltage, batteryStringTableGroup=batteryStringTableGroup, dcMeasurementIndex=dcMeasurementIndex, dcHysteresis=dcHysteresis, batteryGroup=batteryGroup, dcEventHistoryEntry=dcEventHistoryEntry, dcHighStopVoltage=dcHighStopVoltage, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcPowerLimitationStatus=dcPowerLimitationStatus, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcAlarmTable=dcAlarmTable, dcTempSupervision=dcTempSupervision, dcRectifierGroupEntry=dcRectifierGroupEntry, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcAlarmEventValue=dcAlarmEventValue, dcMeasurementName=dcMeasurementName, dcChargeState=dcChargeState, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcEventHistoryMessage=dcEventHistoryMessage, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcHighStartTemp=dcHighStartTemp, systemNonUrgentAlarm=systemNonUrgentAlarm, dcLvdEntry=dcLvdEntry, systemInfoGroup=systemInfoGroup, dcBatteryTest=dcBatteryTest, controllerEventObjects=controllerEventObjects, dcBatteryTestControl=dcBatteryTestControl, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcPowerLimitationTable=dcPowerLimitationTable, dcMeasurementTable=dcMeasurementTable, dcBatteryTestResult=dcBatteryTestResult, dcBatteryStringEntry=dcBatteryStringEntry, dcControlEventIndex=dcControlEventIndex, dcSiteName=dcSiteName, dcControlEventValue=dcControlEventValue, dcEventProcessingEventTable=dcEventProcessingEventTable, systemMonitorGroup=systemMonitorGroup, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcMaximumLoadStep=dcMaximumLoadStep, dcBattery=dcBattery, dcNumberRectifiers=dcNumberRectifiers, dcHighTempHyst=dcHighTempHyst, dcControlEventEntry=dcControlEventEntry, dcMeasurementEntry=dcMeasurementEntry, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcRectifierIdentifier=dcRectifierIdentifier, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcTrapDestinationPort=dcTrapDestinationPort, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcRectifierGroupName=dcRectifierGroupName, dcEqualizeLeadTime=dcEqualizeLeadTime, dcCriticalAlarmValue=dcCriticalAlarmValue, dcSystemVoltageSupervision=dcSystemVoltageSupervision, orionBaseMib=orionBaseMib, dcEventProcessingEventType=dcEventProcessingEventType, dcLvdTable=dcLvdTable, powerLimitationTableGroup=powerLimitationTableGroup, dcBoostChargeControl=dcBoostChargeControl, dcDefaultLogEventTable=dcDefaultLogEventTable, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcRectifier=dcRectifier, dcBatteryParameter=dcBatteryParameter, dcFileProcessingStatus=dcFileProcessingStatus, dcRectifierEntry=dcRectifierEntry, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, alarmTableGroup=alarmTableGroup, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcBoostChargeStatus=dcBoostChargeStatus, dcBatteryTemperature=dcBatteryTemperature, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcBoD=dcBoD, dcControlEventIdentifier=dcControlEventIdentifier, dcEqualizeParameter=dcEqualizeParameter, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcExpectedBackupTime=dcExpectedBackupTime, dcEqualizeTimeLag=dcEqualizeTimeLag, dcAlarmEventName=dcAlarmEventName, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcSystemVoltage=dcSystemVoltage, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcTempCompType=dcTempCompType, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcGenericAlarmTable=dcGenericAlarmTable, dcStopTemp=dcStopTemp, dcHighTemp=dcHighTemp, defaultLogEventTableGroup=defaultLogEventTableGroup, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcPowerLimitationEventName=dcPowerLimitationEventName, dcRunawayTemp=dcRunawayTemp, dcSystemMonitor=dcSystemMonitor, dcRectifierIndex=dcRectifierIndex, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcSystemDateTime=dcSystemDateTime, dcBatteryTestResults=dcBatteryTestResults, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcLowStopVoltage=dcLowStopVoltage, dcTrapDestinationIp=dcTrapDestinationIp, dcTrapDestinationEntry=dcTrapDestinationEntry, dcEqualizeControl=dcEqualizeControl, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcBoostChargeVoltage=dcBoostChargeVoltage, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcPowerLimitationType=dcPowerLimitationType, dcBatteryTestDuration=dcBatteryTestDuration, dcUrgentAlarmValue=dcUrgentAlarmValue, dcGenericAlarmEventName=dcGenericAlarmEventName, systemUrgentAlarm=systemUrgentAlarm, dcBatteryTestUsupport=dcBatteryTestUsupport, dcPowerLimitationIndex=dcPowerLimitationIndex, dcSystemInfo=dcSystemInfo, controlEventTableGroup=controlEventTableGroup, controllerEventsV2=controllerEventsV2, dcCriticalAlarmName=dcCriticalAlarmName, meterPanelEventTableGroup=meterPanelEventTableGroup, dcRectifierCurrent=dcRectifierCurrent, dcUrgentAlarmName=dcUrgentAlarmName, miscGroup=miscGroup, dcUsys20=dcUsys20, dcMeterPanel=dcMeterPanel, dcEventHistoryTable=dcEventHistoryTable, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcFloatCharge=dcFloatCharge, dcBatteryTestDateTime=dcBatteryTestDateTime, dcBoostChargeIstop=dcBoostChargeIstop, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcBoostChargeParameter=dcBoostChargeParameter, controllerCompl=controllerCompl, lvdTableGroup=lvdTableGroup, dcBatteryStringTable=dcBatteryStringTable, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, measurementTableGroup=measurementTableGroup, dcEqualize=dcEqualize, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcSoftwareVersion=dcSoftwareVersion, dcMaxVoltage=dcMaxVoltage, genericAlarmTableGroup=genericAlarmTableGroup, dcInputOutput=dcInputOutput, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcEqualizeEnabled=dcEqualizeEnabled, dcStartTemp=dcStartTemp, dcSystemName=dcSystemName, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcRectifierGroupIndex=dcRectifierGroupIndex, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcAlarmEntry=dcAlarmEntry, dcMeterPanelEventValue=dcMeterPanelEventValue, controllerBasicCompl=controllerBasicCompl, dcTrapDestinationTable=dcTrapDestinationTable, dcGenericAlarmEntry=dcGenericAlarmEntry, dcDefaultLogEventName=dcDefaultLogEventName, dcLvdIndex=dcLvdIndex, dcEnableUsTempComp=dcEnableUsTempComp, dcPowerLimitationEntry=dcPowerLimitationEntry, dcTempComp=dcTempComp, dcConfig=dcConfig, dcBatteryTestStatus=dcBatteryTestStatus, dcUsMin=dcUsMin, dcAlarmIndex=dcAlarmIndex, dcBatteryCurrent=dcBatteryCurrent, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcRectifierTable=dcRectifierTable, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcLoadCurrent=dcLoadCurrent, controllerObjects=controllerObjects, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcLowTempSlope=dcLowTempSlope, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, orionBaseMibModule=orionBaseMibModule, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcBoostCharge=dcBoostCharge, dcRectifierGroupTable=dcRectifierGroupTable, dcMeasurement=dcMeasurement, dcEventProcessingEventName=dcEventProcessingEventName, dcBatteryStringName=dcBatteryStringName, dcRectifierFunctions=dcRectifierFunctions, dcControlEventTable=dcControlEventTable, dcBoostChargeType=dcBoostChargeType, dcSystemPower=dcSystemPower, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcMisc=dcMisc, systemCriticalAlarm=systemCriticalAlarm, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, rectifierTableGroup=rectifierTableGroup, trapDestinationTableGroup=trapDestinationTableGroup, dcSlope=dcSlope, dcEvtCtrlCharge=dcEvtCtrlCharge, dcCurrentLimit=dcCurrentLimit, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcMeasurementValue=dcMeasurementValue, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcGenericAlarmIndex=dcGenericAlarmIndex, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcBatteryStringCapacity=dcBatteryStringCapacity, dcEventHistoryIndex=dcEventHistoryIndex, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcAlarmEventCategory=dcAlarmEventCategory, dcNonUrgentAlarmName=dcNonUrgentAlarmName, controllerGroups=controllerGroups, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcEqualizeDuration=dcEqualizeDuration, dcPowerLimitation=dcPowerLimitation, dcTrapDestinationIndex=dcTrapDestinationIndex, dcUsMax=dcUsMax, dcMeterPanelEventIndex=dcMeterPanelEventIndex, systemAlarmGroup=systemAlarmGroup, dcEvtCtrlChargeType=dcEvtCtrlChargeType, notificationsGroup=notificationsGroup, dcLowStartTemp=dcLowStartTemp, controllerEvents=controllerEvents, dcEqualizeInterval=dcEqualizeInterval, dcSystemAlarms=dcSystemAlarms, PYSNMP_MODULE_ID=orionBaseMibModule, dcMinimumLoadStep=dcMinimumLoadStep, dcEqualizeStatus=dcEqualizeStatus, dcRunawayVoltage=dcRunawayVoltage, dcMeterPanelEventName=dcMeterPanelEventName, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcMainsFailureAlarm=dcMainsFailureAlarm)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcLvdName=dcLvdName, rectifierGroup=rectifierGroup, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcEfficiencyCycling=dcEfficiencyCycling, dcBatteryTestTempTo=dcBatteryTestTempTo, dcPowerLimitationLimit=dcPowerLimitationLimit, eventHistoryTableGroup=eventHistoryTableGroup, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcUaMax=dcUaMax, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcBatteryTestType=dcBatteryTestType, dcMeasurementUnit=dcMeasurementUnit, rectifierGroupTableGroup=rectifierGroupTableGroup)
