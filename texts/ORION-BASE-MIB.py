...
mibBuilder.exportSymbols("ORION-BASE-MIB", trapDestinationTableGroup=trapDestinationTableGroup, controllerGroups=controllerGroups, dcUrgentAlarmValue=dcUrgentAlarmValue, dcUaMax=dcUaMax, dcHighStartTemp=dcHighStartTemp, dcStartTemp=dcStartTemp, dcLvdName=dcLvdName, dcSiteName=dcSiteName, dcFloatCharge=dcFloatCharge, dcSystemDateTime=dcSystemDateTime, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcUrgentAlarmName=dcUrgentAlarmName, dcBatteryTemperature=dcBatteryTemperature, dcEventHistoryTable=dcEventHistoryTable, dcRectifierEntry=dcRectifierEntry, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcBatteryTestResults=dcBatteryTestResults, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcHysteresis=dcHysteresis, dcBatteryStringTable=dcBatteryStringTable, controllerEventsV2=controllerEventsV2, dcMeasurementUnit=dcMeasurementUnit, meterPanelEventTableGroup=meterPanelEventTableGroup, dcBoostChargeType=dcBoostChargeType, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcSystemAlarms=dcSystemAlarms, dcMeterPanelEventName=dcMeterPanelEventName, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcBoostChargeIstart=dcBoostChargeIstart, dcTrapDestinationIp=dcTrapDestinationIp, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcBatteryStringIndex=dcBatteryStringIndex, dcBoostChargeTimeLag=dcBoostChargeTimeLag, systemInfoGroup=systemInfoGroup, dcEqualizeDuration=dcEqualizeDuration, PYSNMP_MODULE_ID=orionBaseMibModule, dcEqualizeParameter=dcEqualizeParameter, dcMeasurement=dcMeasurement, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcAlarmEventCategory=dcAlarmEventCategory, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcRectifierTable=dcRectifierTable, dcPowerLimitationType=dcPowerLimitationType, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcUaMin=dcUaMin, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcSoftwareVersion=dcSoftwareVersion, dcBoD=dcBoD, dcRectifier=dcRectifier, dcUsys20=dcUsys20, dcSystemVoltage=dcSystemVoltage, dcBatteryTestUsupport=dcBatteryTestUsupport, dcUsMax=dcUsMax, dcMaxVoltage=dcMaxVoltage, dcGenericAlarmIndex=dcGenericAlarmIndex, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcEventProcessingEventTable=dcEventProcessingEventTable, rectifierGroupTableGroup=rectifierGroupTableGroup, powerLimitationTableGroup=powerLimitationTableGroup, dcControlEventName=dcControlEventName, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcTempSupervision=dcTempSupervision, dcBatteryTest=dcBatteryTest, dcBoostChargeVoltage=dcBoostChargeVoltage, dcMeterPanel=dcMeterPanel, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcMeasurementEntry=dcMeasurementEntry, dcBatteryTestInterval=dcBatteryTestInterval, dcMeterPanelEventValue=dcMeterPanelEventValue, dcEqualizeVoltage=dcEqualizeVoltage, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcAlarmEventValue=dcAlarmEventValue, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcControlEventEntry=dcControlEventEntry, dcDefaultLogEventName=dcDefaultLogEventName, dcLoadCurrent=dcLoadCurrent, dcBatteryTestParameter=dcBatteryTestParameter, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcAlarmEntry=dcAlarmEntry, dcTrapDestinationEntry=dcTrapDestinationEntry, systemCriticalAlarm=systemCriticalAlarm, genericAlarmTableGroup=genericAlarmTableGroup, dcEqualizeEnabled=dcEqualizeEnabled, dcSystemMonitor=dcSystemMonitor, dcPowerLimitationLimit=dcPowerLimitationLimit, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcRectifierCurrent=dcRectifierCurrent, dcTempCompType=dcTempCompType, dcMeasurementTable=dcMeasurementTable, dcBatteryStringCapacity=dcBatteryStringCapacity, dcTrapDestinationPort=dcTrapDestinationPort, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcMeterPanelEventTable=dcMeterPanelEventTable, dcRectifierIndex=dcRectifierIndex, dcPowerLimitationEntry=dcPowerLimitationEntry, dcRectifierFunctions=dcRectifierFunctions, dcGenericAlarmEventName=dcGenericAlarmEventName, lvdTableGroup=lvdTableGroup, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, systemNonUrgentAlarm=systemNonUrgentAlarm, controlEventTableGroup=controlEventTableGroup, dcMainsFailureAlarm=dcMainsFailureAlarm, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcEqualizeStatus=dcEqualizeStatus, dcEqualizeInterval=dcEqualizeInterval, dcBatteryStringEntry=dcBatteryStringEntry, dcBatteryTestStatus=dcBatteryTestStatus, dcControlEventValue=dcControlEventValue, dcMeasurementName=dcMeasurementName, dcConfig=dcConfig, controllerConfs=controllerConfs, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcPowerLimitationEventName=dcPowerLimitationEventName, dcAlarmTable=dcAlarmTable, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, defaultLogEventTableGroup=defaultLogEventTableGroup, batteryGroup=batteryGroup, dcControlEventIdentifier=dcControlEventIdentifier, batteryStringTableGroup=batteryStringTableGroup, dcEqualizeLeadTime=dcEqualizeLeadTime, dcStopTemp=dcStopTemp, dcBoostCharge=dcBoostCharge, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcControlEventTable=dcControlEventTable, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcLowStartTemp=dcLowStartTemp, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcPowerLimitationIndex=dcPowerLimitationIndex, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcFileProcessingStatus=dcFileProcessingStatus, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, orionBaseMibModule=orionBaseMibModule, dcEvtCtrlCharge=dcEvtCtrlCharge, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcHighTempHyst=dcHighTempHyst, dcLimitSwitchingTimes=dcLimitSwitchingTimes, controllerObjects=controllerObjects, dcGenericAlarmTable=dcGenericAlarmTable, dcEventProcessingEventEntry=dcEventProcessingEventEntry, systemAlarmGroup=systemAlarmGroup, dcEventHistoryMessage=dcEventHistoryMessage, dcEventHistoryIndex=dcEventHistoryIndex, dcHighTempSlope=dcHighTempSlope, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcDefaultLogEventTable=dcDefaultLogEventTable, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcCurrentLimit=dcCurrentLimit, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, systemUrgentAlarm=systemUrgentAlarm, dcEfficiencyCycling=dcEfficiencyCycling, dcRectifierGroupEntry=dcRectifierGroupEntry, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, controllerEvents=controllerEvents, dcTempComp=dcTempComp, dcAlarmEventName=dcAlarmEventName, controllerBasicCompl=controllerBasicCompl, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcEnableUsTempComp=dcEnableUsTempComp, dcRunawayVoltage=dcRunawayVoltage, dcTrapDestinationTable=dcTrapDestinationTable, dcBoostChargeControl=dcBoostChargeControl, dcEqualize=dcEqualize, dcSystemName=dcSystemName, dcLowTempSlope=dcLowTempSlope, eventHistoryTableGroup=eventHistoryTableGroup, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcBoostChargeParameter=dcBoostChargeParameter, orionBaseMib=orionBaseMib, dcMinimumLoadStep=dcMinimumLoadStep, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcLvdTable=dcLvdTable, dcCriticalAlarmName=dcCriticalAlarmName, dcUsMin=dcUsMin, dcLossOfBackupTime=dcLossOfBackupTime, dcCriticalAlarmValue=dcCriticalAlarmValue, dcBatteryCurrent=dcBatteryCurrent, dcHighTemp=dcHighTemp, dcEventProcessingEventType=dcEventProcessingEventType, dcPowerLimitation=dcPowerLimitation, dcPowerLimitationStatus=dcPowerLimitationStatus, dcBatteryTestControl=dcBatteryTestControl, dcLowStopVoltage=dcLowStopVoltage, dcBatteryStringName=dcBatteryStringName, measurementTableGroup=measurementTableGroup, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcRectifierGroupName=dcRectifierGroupName, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcBatteryTestDateTime=dcBatteryTestDateTime, dcRectifierIdentifier=dcRectifierIdentifier, systemMonitorGroup=systemMonitorGroup, dcHighStopVoltage=dcHighStopVoltage, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcBattery=dcBattery, dcControlEventIndex=dcControlEventIndex, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcSystemInfo=dcSystemInfo, dcEqualizeControl=dcEqualizeControl, dcSystemPower=dcSystemPower, dcInputOutput=dcInputOutput, dcTrapDestinationIndex=dcTrapDestinationIndex, rectifierTableGroup=rectifierTableGroup, dcMeasurementValue=dcMeasurementValue, controllerCompl=controllerCompl, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcGenericAlarmEntry=dcGenericAlarmEntry, dcLvdEntry=dcLvdEntry, dcEventProcessingEventName=dcEventProcessingEventName, dcRectifierStatus=dcRectifierStatus, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcEventHistoryEntry=dcEventHistoryEntry, dcChargeState=dcChargeState, dcEqualizeTimeLag=dcEqualizeTimeLag, dcMeasurementIndex=dcMeasurementIndex, dcNumberRectifiers=dcNumberRectifiers, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcBoostChargeIstop=dcBoostChargeIstop, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcLvdIndex=dcLvdIndex, dcRunawayTemp=dcRunawayTemp, dcMaximumLoadStep=dcMaximumLoadStep, dcRectifierGroupTable=dcRectifierGroupTable, miscGroup=miscGroup, dcAlarmIndex=dcAlarmIndex, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcPowerLimitationTable=dcPowerLimitationTable, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcBatteryTestDuration=dcBatteryTestDuration, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcBatteryTestTempTo=dcBatteryTestTempTo, dcBatteryTestType=dcBatteryTestType, dcMisc=dcMisc, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcExpectedBackupTime=dcExpectedBackupTime)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcSlope=dcSlope, controllerEventObjects=controllerEventObjects, dcNonUrgentAlarmName=dcNonUrgentAlarmName, alarmTableGroup=alarmTableGroup, dcBoostChargeStatus=dcBoostChargeStatus, notificationsGroup=notificationsGroup, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcRectifierGroupIndex=dcRectifierGroupIndex, rectifierGroup=rectifierGroup, dcBatteryTestResult=dcBatteryTestResult, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcBatteryParameter=dcBatteryParameter)
