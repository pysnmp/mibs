...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcSoftwareVersion=dcSoftwareVersion, dcBatteryStringCapacity=dcBatteryStringCapacity, dcGenericAlarmEventValue=dcGenericAlarmEventValue, systemAlarmGroup=systemAlarmGroup, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcEqualizeControl=dcEqualizeControl, systemNonUrgentAlarm=systemNonUrgentAlarm, dcRectifierIndex=dcRectifierIndex, dcBatteryTestResult=dcBatteryTestResult, dcEqualizeTimeLag=dcEqualizeTimeLag, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcRectifierCurrent=dcRectifierCurrent, dcMeterPanelEventName=dcMeterPanelEventName, dcBatteryTemperature=dcBatteryTemperature, trapDestinationTableGroup=trapDestinationTableGroup, dcRectifierGroupName=dcRectifierGroupName, dcEqualizeVoltage=dcEqualizeVoltage, dcUrgentAlarmValue=dcUrgentAlarmValue, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcCurrentLimit=dcCurrentLimit, dcBatteryTest=dcBatteryTest, dcMainsFailureAlarm=dcMainsFailureAlarm, dcChargeState=dcChargeState, dcPowerLimitationStatus=dcPowerLimitationStatus, dcBoostChargeVoltage=dcBoostChargeVoltage, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcBatteryTestParameter=dcBatteryTestParameter, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcHighTempHyst=dcHighTempHyst, dcSystemVoltageSupervision=dcSystemVoltageSupervision, orionBaseMib=orionBaseMib, dcBatteryTestResults=dcBatteryTestResults, dcEqualizeEnabled=dcEqualizeEnabled, dcSystemName=dcSystemName, dcExpectedBackupTime=dcExpectedBackupTime, dcEqualizeInterval=dcEqualizeInterval, dcUsMax=dcUsMax, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcRectifierGroupEntry=dcRectifierGroupEntry, dcEqualize=dcEqualize, dcAlarmEventName=dcAlarmEventName, dcMeasurementUnit=dcMeasurementUnit, dcStopTemp=dcStopTemp, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcHighTemp=dcHighTemp, dcRectifierFunctions=dcRectifierFunctions, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcAlarmIndex=dcAlarmIndex, rectifierTableGroup=rectifierTableGroup, dcBatteryTestDuration=dcBatteryTestDuration, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcMeasurementName=dcMeasurementName, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcMeterPanelEventValue=dcMeterPanelEventValue, defaultLogEventTableGroup=defaultLogEventTableGroup, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcLoadCurrent=dcLoadCurrent, lvdTableGroup=lvdTableGroup, dcSystemPower=dcSystemPower, dcDefaultLogEventName=dcDefaultLogEventName, dcRectifierStatus=dcRectifierStatus, dcUsMin=dcUsMin, dcBatteryTestControl=dcBatteryTestControl, dcLowStartTemp=dcLowStartTemp, dcLvdEntry=dcLvdEntry, dcAlarmEventCategory=dcAlarmEventCategory, dcLvdName=dcLvdName, dcMeasurementEntry=dcMeasurementEntry, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcUrgentAlarmName=dcUrgentAlarmName, dcBoostChargeIstop=dcBoostChargeIstop, batteryGroup=batteryGroup, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcEventProcessingEventName=dcEventProcessingEventName, dcCriticalAlarmValue=dcCriticalAlarmValue, controllerEvents=controllerEvents, dcRectifierIdentifier=dcRectifierIdentifier, dcEventProcessingEventTable=dcEventProcessingEventTable, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, controllerEventObjects=controllerEventObjects, systemInfoGroup=systemInfoGroup, eventHistoryTableGroup=eventHistoryTableGroup, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcUaMax=dcUaMax, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcMeasurementIndex=dcMeasurementIndex, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, PYSNMP_MODULE_ID=orionBaseMibModule, dcFloatCharge=dcFloatCharge, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcTempSupervision=dcTempSupervision, dcAlarmEntry=dcAlarmEntry, dcEqualizeDuration=dcEqualizeDuration, dcEventHistoryMessage=dcEventHistoryMessage, dcSiteName=dcSiteName, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcRunawayTemp=dcRunawayTemp, dcEventHistoryTable=dcEventHistoryTable, dcEqualizeParameter=dcEqualizeParameter, dcGenericAlarmEntry=dcGenericAlarmEntry, dcBoostChargeParameter=dcBoostChargeParameter, dcEvtCtrlCharge=dcEvtCtrlCharge, dcDefaultLogEventTable=dcDefaultLogEventTable, dcPowerLimitationIndex=dcPowerLimitationIndex, controllerEventsV2=controllerEventsV2, dcAlarmEventValue=dcAlarmEventValue, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcBatteryStringIndex=dcBatteryStringIndex, dcLvdTable=dcLvdTable, dcTrapDestinationIp=dcTrapDestinationIp, miscGroup=miscGroup, dcUsys20=dcUsys20, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, meterPanelEventTableGroup=meterPanelEventTableGroup, dcMeterPanelEventEntry=dcMeterPanelEventEntry, rectifierGroupTableGroup=rectifierGroupTableGroup, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, controllerCompl=controllerCompl, dcTrapDestinationIndex=dcTrapDestinationIndex, dcBoostCharge=dcBoostCharge, rectifierGroup=rectifierGroup, dcHysteresis=dcHysteresis, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcEqualizeStatus=dcEqualizeStatus, dcBoostChargeIstart=dcBoostChargeIstart, dcMeterPanelEventTable=dcMeterPanelEventTable, alarmTableGroup=alarmTableGroup, dcGenericAlarmTable=dcGenericAlarmTable, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcControlEventIdentifier=dcControlEventIdentifier, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcBatteryTestStatus=dcBatteryTestStatus, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcTrapDestinationTable=dcTrapDestinationTable, dcBatteryTestInterval=dcBatteryTestInterval, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcEfficiencyCycling=dcEfficiencyCycling, dcMeasurementValue=dcMeasurementValue, dcHighStartTemp=dcHighStartTemp, dcRectifierGroupTable=dcRectifierGroupTable, dcMisc=dcMisc, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcSlope=dcSlope, dcAlarmTable=dcAlarmTable, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcMeasurementTable=dcMeasurementTable, dcSystemVoltage=dcSystemVoltage, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcPowerLimitation=dcPowerLimitation, dcPowerLimitationEntry=dcPowerLimitationEntry, dcSystemMonitor=dcSystemMonitor, dcEventHistoryEntry=dcEventHistoryEntry, dcControlEventName=dcControlEventName, dcBatteryStringEntry=dcBatteryStringEntry, dcGenericAlarmIndex=dcGenericAlarmIndex, dcEqualizeLeadTime=dcEqualizeLeadTime, dcTrapDestinationPort=dcTrapDestinationPort, dcCriticalAlarmName=dcCriticalAlarmName, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcBoD=dcBoD, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcRectifierTable=dcRectifierTable, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcLvdIndex=dcLvdIndex, controllerGroups=controllerGroups, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcBatteryParameter=dcBatteryParameter, dcSystemDateTime=dcSystemDateTime, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, notificationsGroup=notificationsGroup, dcBatteryTestType=dcBatteryTestType, dcPowerLimitationEventName=dcPowerLimitationEventName, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, controllerConfs=controllerConfs, dcRectifierEntry=dcRectifierEntry, dcBatteryTestUsupport=dcBatteryTestUsupport, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcBoostChargeControl=dcBoostChargeControl, dcBatteryStringName=dcBatteryStringName, dcBatteryStringTable=dcBatteryStringTable, dcNumberRectifiers=dcNumberRectifiers, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcFileProcessingStatus=dcFileProcessingStatus, dcGenericAlarmEventName=dcGenericAlarmEventName, batteryStringTableGroup=batteryStringTableGroup, dcRectifier=dcRectifier, dcRectifierGroupIndex=dcRectifierGroupIndex, systemMonitorGroup=systemMonitorGroup, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcStartTemp=dcStartTemp, dcBoostChargeType=dcBoostChargeType, dcTempComp=dcTempComp, dcMeasurement=dcMeasurement, dcEventHistoryIndex=dcEventHistoryIndex, dcEventProcessingEventType=dcEventProcessingEventType, dcSystemAlarms=dcSystemAlarms, dcConfig=dcConfig, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcRunawayVoltage=dcRunawayVoltage, dcPowerLimitationLimit=dcPowerLimitationLimit, dcControlEventValue=dcControlEventValue, dcLowTempSlope=dcLowTempSlope, measurementTableGroup=measurementTableGroup, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcLowStopVoltage=dcLowStopVoltage, dcMinimumLoadStep=dcMinimumLoadStep, dcBattery=dcBattery, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcInputOutput=dcInputOutput, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcPowerLimitationTable=dcPowerLimitationTable, systemCriticalAlarm=systemCriticalAlarm, genericAlarmTableGroup=genericAlarmTableGroup, dcLossOfBackupTime=dcLossOfBackupTime, controlEventTableGroup=controlEventTableGroup, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcEnableUsTempComp=dcEnableUsTempComp, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcTrapDestinationEntry=dcTrapDestinationEntry, dcBatteryTestTempTo=dcBatteryTestTempTo, dcUaMin=dcUaMin, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcControlEventTable=dcControlEventTable, dcMaxVoltage=dcMaxVoltage, dcBatteryCurrent=dcBatteryCurrent, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcSystemInfo=dcSystemInfo, dcHighTempSlope=dcHighTempSlope, dcHighStopVoltage=dcHighStopVoltage, dcControlEventIndex=dcControlEventIndex, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, powerLimitationTableGroup=powerLimitationTableGroup, dcMeterPanel=dcMeterPanel, dcMaximumLoadStep=dcMaximumLoadStep)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcBatteryTestDateTime=dcBatteryTestDateTime, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcTempCompType=dcTempCompType, dcPowerLimitationType=dcPowerLimitationType, controllerBasicCompl=controllerBasicCompl, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, systemUrgentAlarm=systemUrgentAlarm, orionBaseMibModule=orionBaseMibModule, dcBoostChargeStatus=dcBoostChargeStatus, dcControlEventEntry=dcControlEventEntry, dcBatteryTestMinDuration=dcBatteryTestMinDuration, controllerObjects=controllerObjects)
