...
Unsigned32, ModuleIdentity, IpAddress, TimeTicks, Counter32, ObjectIdentity, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Counter64, Gauge32, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "IpAddress", "TimeTicks", "Counter32", "ObjectIdentity", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Counter64", "Gauge32", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcHysteresis=dcHysteresis, dcChargeState=dcChargeState, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcPowerLimitationIndex=dcPowerLimitationIndex, dcUsys20=dcUsys20, dcEqualizeLeadTime=dcEqualizeLeadTime, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcUrgentAlarmValue=dcUrgentAlarmValue, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcSystemName=dcSystemName, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcCriticalAlarmName=dcCriticalAlarmName, dcUrgentAlarmName=dcUrgentAlarmName, dcConfig=dcConfig, dcEventHistoryEntry=dcEventHistoryEntry, dcAlarmIndex=dcAlarmIndex, dcPowerLimitationLimit=dcPowerLimitationLimit, dcBatteryTestTempTo=dcBatteryTestTempTo, dcDefaultLogEventName=dcDefaultLogEventName, dcEventHistoryMessage=dcEventHistoryMessage, dcBatteryTestControl=dcBatteryTestControl, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcRectifierGroupName=dcRectifierGroupName, dcEqualizeControl=dcEqualizeControl, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcAlarmEventIdentifier=dcAlarmEventIdentifier, orionBaseMibModule=orionBaseMibModule, dcBatteryTestInterval=dcBatteryTestInterval, dcBoostChargeParameter=dcBoostChargeParameter, dcRectifierIdentifier=dcRectifierIdentifier, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcBatteryStringEntry=dcBatteryStringEntry, dcSiteName=dcSiteName, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcBoostChargeType=dcBoostChargeType, PYSNMP_MODULE_ID=orionBaseMibModule, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcMeasurementEntry=dcMeasurementEntry, dcBatteryTest=dcBatteryTest, systemCriticalAlarm=systemCriticalAlarm, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcLvdDisconnectDelay=dcLvdDisconnectDelay, alarmTableGroup=alarmTableGroup, dcGenericAlarmIndex=dcGenericAlarmIndex, dcGenericAlarmEventName=dcGenericAlarmEventName, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcExpectedBackupTime=dcExpectedBackupTime, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcEventHistoryTable=dcEventHistoryTable, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcStopTemp=dcStopTemp, dcHighStopVoltage=dcHighStopVoltage, dcRectifierStatus=dcRectifierStatus, rectifierGroup=rectifierGroup, dcHighTempHyst=dcHighTempHyst, dcPowerLimitationTable=dcPowerLimitationTable, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcRectifierGroupTable=dcRectifierGroupTable, controlEventTableGroup=controlEventTableGroup, defaultLogEventTableGroup=defaultLogEventTableGroup, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcEqualizeTimeLag=dcEqualizeTimeLag, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcEqualizeEnabled=dcEqualizeEnabled, powerLimitationTableGroup=powerLimitationTableGroup, dcBatteryTemperature=dcBatteryTemperature, dcTrapDestinationPort=dcTrapDestinationPort, eventHistoryTableGroup=eventHistoryTableGroup, dcEventHistoryIndex=dcEventHistoryIndex, dcAlarmEventValue=dcAlarmEventValue, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcBoostChargeVoltage=dcBoostChargeVoltage, dcMeterPanelEventEntry=dcMeterPanelEventEntry, trapDestinationTableGroup=trapDestinationTableGroup, dcHighStartTemp=dcHighStartTemp, dcHighTemp=dcHighTemp, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, systemAlarmGroup=systemAlarmGroup, genericAlarmTableGroup=genericAlarmTableGroup, dcLowStopVoltage=dcLowStopVoltage, dcBatteryStringIndex=dcBatteryStringIndex, batteryGroup=batteryGroup, dcSoftwareVersion=dcSoftwareVersion, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcPowerLimitation=dcPowerLimitation, controllerBasicCompl=controllerBasicCompl, dcMeasurement=dcMeasurement, dcMainsFailureAlarm=dcMainsFailureAlarm, dcTrapDestinationTable=dcTrapDestinationTable, dcMeasurementIndex=dcMeasurementIndex, dcRectifierGroupEntry=dcRectifierGroupEntry, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcTrapDestinationEntry=dcTrapDestinationEntry, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcMeasurementValue=dcMeasurementValue, systemInfoGroup=systemInfoGroup, controllerGroups=controllerGroups, dcBatteryTestDuration=dcBatteryTestDuration, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, controllerEventObjects=controllerEventObjects, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcRectifierFunctions=dcRectifierFunctions, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcRectifierTable=dcRectifierTable, dcDefaultLogEventTable=dcDefaultLogEventTable, controllerObjects=controllerObjects, dcUaMax=dcUaMax, dcControlEventIndex=dcControlEventIndex, dcFileProcessingStatus=dcFileProcessingStatus, dcMeasurementName=dcMeasurementName, notificationsGroup=notificationsGroup, dcGenericAlarmTable=dcGenericAlarmTable, dcGenericAlarmEntry=dcGenericAlarmEntry, dcSystemVoltage=dcSystemVoltage, rectifierTableGroup=rectifierTableGroup, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcEqualizeStatus=dcEqualizeStatus, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcMaxVoltage=dcMaxVoltage, batteryStringTableGroup=batteryStringTableGroup, dcRectifierCurrent=dcRectifierCurrent, dcPowerLimitationStatus=dcPowerLimitationStatus, dcControlEventName=dcControlEventName, dcMeterPanelEventIndex=dcMeterPanelEventIndex, measurementTableGroup=measurementTableGroup, dcHighTempSlope=dcHighTempSlope, dcTempComp=dcTempComp, dcRunawayVoltage=dcRunawayVoltage, dcMeterPanelEventValue=dcMeterPanelEventValue, dcBatteryTestParameter=dcBatteryTestParameter, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcPowerLimitationEventName=dcPowerLimitationEventName, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcTrapDestinationIndex=dcTrapDestinationIndex, controllerCompl=controllerCompl, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcLvdTable=dcLvdTable, dcBoostCharge=dcBoostCharge, dcUsMin=dcUsMin, dcRectifierEntry=dcRectifierEntry, dcControlEventIdentifier=dcControlEventIdentifier, dcEqualize=dcEqualize, dcSystemDateTime=dcSystemDateTime, dcMisc=dcMisc, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcTempSupervision=dcTempSupervision, dcEventProcessingEventName=dcEventProcessingEventName, dcBoostChargeIstart=dcBoostChargeIstart, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcEqualizeParameter=dcEqualizeParameter, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcLoadCurrent=dcLoadCurrent, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, meterPanelEventTableGroup=meterPanelEventTableGroup, dcLvdIndex=dcLvdIndex, dcLvdName=dcLvdName, dcUsMax=dcUsMax, dcControlEventTable=dcControlEventTable, dcEventProcessingEventType=dcEventProcessingEventType, dcTrapDestinationIp=dcTrapDestinationIp, controllerEvents=controllerEvents, dcBatteryParameter=dcBatteryParameter, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcCurrentLimit=dcCurrentLimit, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcLowStartTemp=dcLowStartTemp, dcRectifierGroupIndex=dcRectifierGroupIndex, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcBoD=dcBoD, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcAlarmTable=dcAlarmTable, dcBatteryStringCapacity=dcBatteryStringCapacity, dcBatteryTestDateTime=dcBatteryTestDateTime, dcMeterPanelEventName=dcMeterPanelEventName, dcRunawayTemp=dcRunawayTemp, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcBatteryTestStatus=dcBatteryTestStatus, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcBatteryStringName=dcBatteryStringName, dcBoostChargeIstop=dcBoostChargeIstop, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcBatteryCurrent=dcBatteryCurrent, dcMeterPanel=dcMeterPanel, dcEventProcessingEventTable=dcEventProcessingEventTable, miscGroup=miscGroup, systemNonUrgentAlarm=systemNonUrgentAlarm, lvdTableGroup=lvdTableGroup, dcNumberRectifiers=dcNumberRectifiers, dcBatteryTestResults=dcBatteryTestResults, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcBatteryTestType=dcBatteryTestType, dcPowerLimitationEntry=dcPowerLimitationEntry, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcSystemMonitor=dcSystemMonitor, dcAlarmEventCategory=dcAlarmEventCategory, dcUaMin=dcUaMin, rectifierGroupTableGroup=rectifierGroupTableGroup, dcEqualizeInterval=dcEqualizeInterval, dcEqualizeVoltage=dcEqualizeVoltage, dcControlEventValue=dcControlEventValue, systemMonitorGroup=systemMonitorGroup, dcMaximumLoadStep=dcMaximumLoadStep, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcRectifierIndex=dcRectifierIndex, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcBatteryStringTable=dcBatteryStringTable, dcStartTemp=dcStartTemp, dcSystemAlarms=dcSystemAlarms, dcMeterPanelEventTable=dcMeterPanelEventTable, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcLossOfBackupTime=dcLossOfBackupTime, dcAlarmEntry=dcAlarmEntry, dcPowerLimitationType=dcPowerLimitationType, dcMeasurementUnit=dcMeasurementUnit, systemUrgentAlarm=systemUrgentAlarm, dcEnableUsTempComp=dcEnableUsTempComp, dcBatteryTestResult=dcBatteryTestResult, dcLowTempSlope=dcLowTempSlope, dcSlope=dcSlope, dcEfficiencyCycling=dcEfficiencyCycling, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcSystemPower=dcSystemPower, dcFloatCharge=dcFloatCharge, dcAlarmEventName=dcAlarmEventName, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcRectifier=dcRectifier, dcMinimumLoadStep=dcMinimumLoadStep, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcInputOutput=dcInputOutput, dcEqualizeDuration=dcEqualizeDuration, dcBatteryTestUsupport=dcBatteryTestUsupport, dcBoostChargeStatus=dcBoostChargeStatus, dcTempCompType=dcTempCompType, controllerConfs=controllerConfs, orionBaseMib=orionBaseMib, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit)
mibBuilder.exportSymbols("ORION-BASE-MIB", controllerEventsV2=controllerEventsV2, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcEvtCtrlCharge=dcEvtCtrlCharge, dcCriticalAlarmValue=dcCriticalAlarmValue, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcLvdEntry=dcLvdEntry, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcSystemInfo=dcSystemInfo, dcMeasurementTable=dcMeasurementTable, dcBattery=dcBattery, dcControlEventEntry=dcControlEventEntry, dcBoostChargeControl=dcBoostChargeControl)
