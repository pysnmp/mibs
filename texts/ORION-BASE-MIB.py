...
Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, ModuleIdentity, MibIdentifier, Unsigned32, Integer32, Counter32, Bits, enterprises, IpAddress, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Integer32", "Counter32", "Bits", "enterprises", "IpAddress", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcEventHistoryEntry=dcEventHistoryEntry, dcMaximumLoadStep=dcMaximumLoadStep, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcRectifierGroupEntry=dcRectifierGroupEntry, dcBoostChargeParameter=dcBoostChargeParameter, dcMeterPanel=dcMeterPanel, dcBatteryTestTempTo=dcBatteryTestTempTo, dcBatteryTestResults=dcBatteryTestResults, dcBatteryCurrent=dcBatteryCurrent, dcBatteryTestStatus=dcBatteryTestStatus, dcHighStartTemp=dcHighStartTemp, dcLvdIndex=dcLvdIndex, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcTrapDestinationIndex=dcTrapDestinationIndex, dcMeasurementEntry=dcMeasurementEntry, dcUsMax=dcUsMax, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcSystemInfo=dcSystemInfo, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcMeasurement=dcMeasurement, dcEqualizeStatus=dcEqualizeStatus, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcInputOutput=dcInputOutput, dcBoostChargeType=dcBoostChargeType, dcPowerLimitationEntry=dcPowerLimitationEntry, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcBoD=dcBoD, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, miscGroup=miscGroup, orionBaseMibModule=orionBaseMibModule, dcBatteryTest=dcBatteryTest, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcSlope=dcSlope, dcDefaultLogEventTable=dcDefaultLogEventTable, systemMonitorGroup=systemMonitorGroup, dcBatteryTestParameter=dcBatteryTestParameter, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcAlarmEventIdentifier=dcAlarmEventIdentifier, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcLvdTable=dcLvdTable, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcEfficiencyCycling=dcEfficiencyCycling, PYSNMP_MODULE_ID=orionBaseMibModule, dcLowStartTemp=dcLowStartTemp, dcBatteryTestUsupport=dcBatteryTestUsupport, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcGenericAlarmEventName=dcGenericAlarmEventName, dcEqualizeDuration=dcEqualizeDuration, dcPowerLimitationLimit=dcPowerLimitationLimit, dcTrapDestinationEntry=dcTrapDestinationEntry, dcEventProcessingEventName=dcEventProcessingEventName, dcRectifierGroupName=dcRectifierGroupName, dcMeasurementUnit=dcMeasurementUnit, dcConfig=dcConfig, controllerBasicCompl=controllerBasicCompl, dcBoostCharge=dcBoostCharge, dcTotalBatteryCapacity=dcTotalBatteryCapacity, defaultLogEventTableGroup=defaultLogEventTableGroup, dcLvdEntry=dcLvdEntry, dcChargeState=dcChargeState, dcUaMax=dcUaMax, dcSystemVoltage=dcSystemVoltage, dcBatteryStringName=dcBatteryStringName, dcMaxVoltage=dcMaxVoltage, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcBatteryParameter=dcBatteryParameter, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcEventHistoryTable=dcEventHistoryTable, dcGenericAlarmTable=dcGenericAlarmTable, dcRunawayTemp=dcRunawayTemp, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcMeterPanelEventName=dcMeterPanelEventName, dcBoostChargeVoltage=dcBoostChargeVoltage, controllerCompl=controllerCompl, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcRectifierEntry=dcRectifierEntry, dcPowerLimitation=dcPowerLimitation, dcControlEventName=dcControlEventName, controllerEvents=controllerEvents, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcCurrentLimit=dcCurrentLimit, dcBoostChargeStatus=dcBoostChargeStatus, dcBatteryTestInterval=dcBatteryTestInterval, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcMeasurementIndex=dcMeasurementIndex, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcControlEventIdentifier=dcControlEventIdentifier, dcHighTemp=dcHighTemp, dcTempSupervision=dcTempSupervision, dcSiteName=dcSiteName, dcLoadCurrent=dcLoadCurrent, dcAlarmEventName=dcAlarmEventName, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcPowerLimitationType=dcPowerLimitationType, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcEqualizeLeadTime=dcEqualizeLeadTime, dcMisc=dcMisc, dcPowerLimitationIndex=dcPowerLimitationIndex, dcPowerLimitationStatus=dcPowerLimitationStatus, rectifierGroup=rectifierGroup, dcMeasurementTable=dcMeasurementTable, dcUrgentAlarmName=dcUrgentAlarmName, dcTempCompType=dcTempCompType, dcDefaultLogEventName=dcDefaultLogEventName, lvdTableGroup=lvdTableGroup, dcRectifierStatus=dcRectifierStatus, dcRunawayVoltage=dcRunawayVoltage, meterPanelEventTableGroup=meterPanelEventTableGroup, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcTrapDestinationIp=dcTrapDestinationIp, dcBattery=dcBattery, dcBatteryStringCapacity=dcBatteryStringCapacity, controlEventTableGroup=controlEventTableGroup, dcRectifierIndex=dcRectifierIndex, dcCriticalAlarmValue=dcCriticalAlarmValue, dcUaMin=dcUaMin, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcMeterPanelEventTable=dcMeterPanelEventTable, dcMainsFailureAlarm=dcMainsFailureAlarm, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcHighTempHyst=dcHighTempHyst, dcBoostChargeIstop=dcBoostChargeIstop, controllerObjects=controllerObjects, dcEqualizeControl=dcEqualizeControl, systemNonUrgentAlarm=systemNonUrgentAlarm, dcEqualizeParameter=dcEqualizeParameter, dcEqualize=dcEqualize, dcEventHistoryTimestamp=dcEventHistoryTimestamp, orionBaseMib=orionBaseMib, dcEventHistoryMessage=dcEventHistoryMessage, dcEnableUsTempComp=dcEnableUsTempComp, batteryStringTableGroup=batteryStringTableGroup, dcTempComp=dcTempComp, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcAlarmEventValue=dcAlarmEventValue, dcAlarmIndex=dcAlarmIndex, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcSystemVoltageSupervision=dcSystemVoltageSupervision, systemCriticalAlarm=systemCriticalAlarm, dcControlEventValue=dcControlEventValue, dcHysteresis=dcHysteresis, dcBatteryTestDuration=dcBatteryTestDuration, dcAlarmEntry=dcAlarmEntry, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, eventHistoryTableGroup=eventHistoryTableGroup, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcLowTempSlope=dcLowTempSlope, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcUsys20=dcUsys20, dcSoftwareVersion=dcSoftwareVersion, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcEqualizeTimeLag=dcEqualizeTimeLag, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcSystemAlarms=dcSystemAlarms, dcAlarmEventCategory=dcAlarmEventCategory, dcRectifier=dcRectifier, dcBatteryTemperature=dcBatteryTemperature, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcTrapDestinationTable=dcTrapDestinationTable, dcEventProcessingEventTable=dcEventProcessingEventTable, notificationsGroup=notificationsGroup, trapDestinationTableGroup=trapDestinationTableGroup, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcControlEventIndex=dcControlEventIndex, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcLvdName=dcLvdName, dcBatteryTestDateTime=dcBatteryTestDateTime, systemAlarmGroup=systemAlarmGroup, dcUrgentAlarmValue=dcUrgentAlarmValue, batteryGroup=batteryGroup, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcRectifierCurrent=dcRectifierCurrent, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcSystemPower=dcSystemPower, dcSystemMonitor=dcSystemMonitor, dcMeasurementName=dcMeasurementName, rectifierGroupTableGroup=rectifierGroupTableGroup, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcLowStopVoltage=dcLowStopVoltage, measurementTableGroup=measurementTableGroup, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcMeterPanelEventValue=dcMeterPanelEventValue, dcSystemName=dcSystemName, dcMinimumLoadStep=dcMinimumLoadStep, dcRectifierTable=dcRectifierTable, dcBatteryStringTable=dcBatteryStringTable, dcControlEventEntry=dcControlEventEntry, controllerEventObjects=controllerEventObjects, dcStartTemp=dcStartTemp, dcPowerLimitationEventName=dcPowerLimitationEventName, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcUsMin=dcUsMin, powerLimitationTableGroup=powerLimitationTableGroup, systemUrgentAlarm=systemUrgentAlarm, dcEqualizeVoltage=dcEqualizeVoltage, dcPowerLimitationTable=dcPowerLimitationTable, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcHighTempSlope=dcHighTempSlope, dcRectifierGroupTable=dcRectifierGroupTable, dcEqualizeEnabled=dcEqualizeEnabled, controllerConfs=controllerConfs, dcRectifierFunctions=dcRectifierFunctions, dcGenericAlarmIndex=dcGenericAlarmIndex, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcBatteryStringIndex=dcBatteryStringIndex, dcGenericAlarmEntry=dcGenericAlarmEntry, controllerGroups=controllerGroups, dcBatteryTestControl=dcBatteryTestControl, dcRectifierGroupIndex=dcRectifierGroupIndex, dcEventProcessingEventIndex=dcEventProcessingEventIndex, controllerEventsV2=controllerEventsV2, dcMeasurementValue=dcMeasurementValue, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcLossOfBackupTime=dcLossOfBackupTime, dcBatteryStringEntry=dcBatteryStringEntry, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcCriticalAlarmName=dcCriticalAlarmName, dcBatteryTestType=dcBatteryTestType, dcEqualizeInterval=dcEqualizeInterval, dcEvtCtrlCharge=dcEvtCtrlCharge, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcFloatCharge=dcFloatCharge, dcNumberRectifiers=dcNumberRectifiers, dcAlarmTable=dcAlarmTable, dcRectifierIdentifier=dcRectifierIdentifier, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, systemInfoGroup=systemInfoGroup, genericAlarmTableGroup=genericAlarmTableGroup, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcBatteryTestResult=dcBatteryTestResult, dcBoostChargeControl=dcBoostChargeControl, dcControlEventTable=dcControlEventTable, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcHighStopVoltage=dcHighStopVoltage, dcFileProcessingStatus=dcFileProcessingStatus, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcExpectedBackupTime=dcExpectedBackupTime, dcBoostChargeIstart=dcBoostChargeIstart, dcEventHistoryIndex=dcEventHistoryIndex, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcTrapDestinationPort=dcTrapDestinationPort, dcStopTemp=dcStopTemp, dcSystemDateTime=dcSystemDateTime, dcEventProcessingEventType=dcEventProcessingEventType, alarmTableGroup=alarmTableGroup, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, rectifierTableGroup=rectifierTableGroup)
