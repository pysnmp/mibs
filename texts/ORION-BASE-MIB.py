...
enterprises, IpAddress, NotificationType, ModuleIdentity, Bits, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, MibIdentifier, Integer32, iso, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "NotificationType", "ModuleIdentity", "Bits", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Integer32", "iso", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcSystemName=dcSystemName, controllerCompl=controllerCompl, dcEqualize=dcEqualize, dcCriticalAlarmName=dcCriticalAlarmName, dcLowTempSlope=dcLowTempSlope, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcBatteryTestDateTime=dcBatteryTestDateTime, dcStopTemp=dcStopTemp, dcUsys20=dcUsys20, dcBatteryStringEntry=dcBatteryStringEntry, dcRectifierEntry=dcRectifierEntry, dcSystemInfo=dcSystemInfo, dcBatteryTestDuration=dcBatteryTestDuration, dcBatteryCurrent=dcBatteryCurrent, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcMeterPanelEventTable=dcMeterPanelEventTable, batteryStringTableGroup=batteryStringTableGroup, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcMeasurementScaleFactor=dcMeasurementScaleFactor, powerLimitationTableGroup=powerLimitationTableGroup, dcGenericAlarmEventName=dcGenericAlarmEventName, dcFloatCharge=dcFloatCharge, dcHighStopVoltage=dcHighStopVoltage, dcGenericAlarmIndex=dcGenericAlarmIndex, dcLvdName=dcLvdName, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcTempSupervision=dcTempSupervision, dcMeasurement=dcMeasurement, rectifierGroup=rectifierGroup, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcLvdTable=dcLvdTable, dcMeterPanelEventName=dcMeterPanelEventName, systemAlarmGroup=systemAlarmGroup, dcBatteryTestStatus=dcBatteryTestStatus, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, miscGroup=miscGroup, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcRectifierIndex=dcRectifierIndex, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcLoadCurrent=dcLoadCurrent, dcHighStartTemp=dcHighStartTemp, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcPowerLimitationStatus=dcPowerLimitationStatus, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcEqualizeStatus=dcEqualizeStatus, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcMisc=dcMisc, dcTrapDestinationEntry=dcTrapDestinationEntry, dcMeasurementIndex=dcMeasurementIndex, dcUaMax=dcUaMax, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcHighTempHyst=dcHighTempHyst, dcEfficiencyCycling=dcEfficiencyCycling, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcPowerLimitationTable=dcPowerLimitationTable, dcRunawayTemp=dcRunawayTemp, dcPowerLimitationIndex=dcPowerLimitationIndex, rectifierTableGroup=rectifierTableGroup, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcBoostChargeControl=dcBoostChargeControl, dcDefaultLogEventTable=dcDefaultLogEventTable, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcDefaultLogEventName=dcDefaultLogEventName, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, controllerEvents=controllerEvents, dcEqualizeLeadTime=dcEqualizeLeadTime, dcUsMin=dcUsMin, dcControlEventEntry=dcControlEventEntry, dcHysteresis=dcHysteresis, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, controllerConfs=controllerConfs, dcGenericAlarmEntry=dcGenericAlarmEntry, dcUrgentAlarmName=dcUrgentAlarmName, dcMeasurementTable=dcMeasurementTable, dcAlarmIndex=dcAlarmIndex, dcEventHistoryEntry=dcEventHistoryEntry, dcRectifierIdentifier=dcRectifierIdentifier, controllerEventObjects=controllerEventObjects, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcNumberRectifiers=dcNumberRectifiers, PYSNMP_MODULE_ID=orionBaseMibModule, notificationsGroup=notificationsGroup, dcRectifierGroupEntry=dcRectifierGroupEntry, dcEventHistoryTable=dcEventHistoryTable, dcBoostChargeIstart=dcBoostChargeIstart, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcInputOutput=dcInputOutput, dcRectifierFunctions=dcRectifierFunctions, dcBatteryTestInterval=dcBatteryTestInterval, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcControlEventValue=dcControlEventValue, dcBoostChargeType=dcBoostChargeType, dcAlarmEventName=dcAlarmEventName, dcControlEventIdentifier=dcControlEventIdentifier, meterPanelEventTableGroup=meterPanelEventTableGroup, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcMaxVoltage=dcMaxVoltage, dcAlarmEventCategory=dcAlarmEventCategory, dcStartTemp=dcStartTemp, dcBoostChargeStatus=dcBoostChargeStatus, dcCurrentLimit=dcCurrentLimit, dcBatteryStringName=dcBatteryStringName, dcTempCompType=dcTempCompType, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcPowerLimitationLimit=dcPowerLimitationLimit, dcEqualizeInterval=dcEqualizeInterval, dcBatteryTestTempFrom=dcBatteryTestTempFrom, orionBaseMibModule=orionBaseMibModule, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcEqualizeEnabled=dcEqualizeEnabled, dcEqualizeVoltage=dcEqualizeVoltage, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcLowStartTemp=dcLowStartTemp, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcControlEventTable=dcControlEventTable, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcRectifierGroupIndex=dcRectifierGroupIndex, dcRectifier=dcRectifier, dcLvdIndex=dcLvdIndex, dcMeterPanelEventValue=dcMeterPanelEventValue, dcMinimumLoadStep=dcMinimumLoadStep, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcConfig=dcConfig, dcSystemDateTime=dcSystemDateTime, dcPowerLimitationEntry=dcPowerLimitationEntry, dcSystemVoltage=dcSystemVoltage, dcRectifierStatus=dcRectifierStatus, rectifierGroupTableGroup=rectifierGroupTableGroup, dcRectifierTable=dcRectifierTable, dcExpectedBackupTime=dcExpectedBackupTime, dcAlarmTable=dcAlarmTable, orionBaseMib=orionBaseMib, systemCriticalAlarm=systemCriticalAlarm, dcBatteryTestParameter=dcBatteryTestParameter, dcRunawayVoltage=dcRunawayVoltage, dcTrapDestinationTable=dcTrapDestinationTable, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcLvdEntry=dcLvdEntry, alarmTableGroup=alarmTableGroup, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcEventHistoryIndex=dcEventHistoryIndex, dcBatteryTestType=dcBatteryTestType, dcSystemMonitor=dcSystemMonitor, dcEqualizeControl=dcEqualizeControl, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, trapDestinationTableGroup=trapDestinationTableGroup, dcEvtCtrlCharge=dcEvtCtrlCharge, dcTotalBatteryCapacity=dcTotalBatteryCapacity, systemMonitorGroup=systemMonitorGroup, dcSoftwareVersion=dcSoftwareVersion, dcLossOfBackupTime=dcLossOfBackupTime, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, controlEventTableGroup=controlEventTableGroup, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcSiteName=dcSiteName, dcPowerLimitationType=dcPowerLimitationType, dcUaMin=dcUaMin, dcGenericAlarmTable=dcGenericAlarmTable, dcBatteryTestControl=dcBatteryTestControl, dcUsMax=dcUsMax, dcTrapDestinationIndex=dcTrapDestinationIndex, dcEnableUsTempComp=dcEnableUsTempComp, dcBatteryStringIndex=dcBatteryStringIndex, dcMeasurementEntry=dcMeasurementEntry, controllerGroups=controllerGroups, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcMeasurementName=dcMeasurementName, dcMeasurementValue=dcMeasurementValue, dcTempComp=dcTempComp, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, batteryGroup=batteryGroup, dcChargeState=dcChargeState, dcBatteryTestResult=dcBatteryTestResult, dcEqualizeParameter=dcEqualizeParameter, dcUrgentAlarmValue=dcUrgentAlarmValue, dcBatteryTemperature=dcBatteryTemperature, dcBoostCharge=dcBoostCharge, dcTrapDestinationPort=dcTrapDestinationPort, dcEventProcessingEventTable=dcEventProcessingEventTable, dcEventProcessingEventType=dcEventProcessingEventType, eventHistoryTableGroup=eventHistoryTableGroup, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, lvdTableGroup=lvdTableGroup, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcMeterPanel=dcMeterPanel, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcControlEventIndex=dcControlEventIndex, dcLimitSwitchingTimes=dcLimitSwitchingTimes, controllerEventsV2=controllerEventsV2, dcSystemAlarms=dcSystemAlarms, dcEqualizeTimeLag=dcEqualizeTimeLag, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcBoostChargeIstop=dcBoostChargeIstop, dcEqualizeDuration=dcEqualizeDuration, dcRectifierGroupTable=dcRectifierGroupTable, genericAlarmTableGroup=genericAlarmTableGroup, controllerObjects=controllerObjects, dcEventHistoryMessage=dcEventHistoryMessage, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcPowerLimitation=dcPowerLimitation, dcFileProcessingStatus=dcFileProcessingStatus, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcSlope=dcSlope, dcBoostChargeParameter=dcBoostChargeParameter, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcHighTempSlope=dcHighTempSlope, dcRectifierGroupName=dcRectifierGroupName, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcEventProcessingEventName=dcEventProcessingEventName, defaultLogEventTableGroup=defaultLogEventTableGroup, dcTrapDestinationIp=dcTrapDestinationIp, dcBatteryTestUsupport=dcBatteryTestUsupport, dcHighTemp=dcHighTemp, dcAlarmEntry=dcAlarmEntry, dcPowerLimitationEventName=dcPowerLimitationEventName, controllerBasicCompl=controllerBasicCompl, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcControlEventName=dcControlEventName, dcBoostChargeTimeLag=dcBoostChargeTimeLag, measurementTableGroup=measurementTableGroup, dcMeasurementUnit=dcMeasurementUnit, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcBoostChargeVoltage=dcBoostChargeVoltage, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcBatteryStringTable=dcBatteryStringTable, dcBatteryParameter=dcBatteryParameter, dcCriticalAlarmValue=dcCriticalAlarmValue, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcBatteryTestTempTo=dcBatteryTestTempTo, systemUrgentAlarm=systemUrgentAlarm, dcLowStopVoltage=dcLowStopVoltage)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcBatteryStringCapacity=dcBatteryStringCapacity, dcRectifierCurrent=dcRectifierCurrent, dcSystemPower=dcSystemPower, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcBatteryTestResults=dcBatteryTestResults, dcBoD=dcBoD, dcBatteryTest=dcBatteryTest, dcAlarmEventValue=dcAlarmEventValue, systemInfoGroup=systemInfoGroup, dcBattery=dcBattery, systemNonUrgentAlarm=systemNonUrgentAlarm, dcMainsFailureAlarm=dcMainsFailureAlarm, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcMaximumLoadStep=dcMaximumLoadStep)
