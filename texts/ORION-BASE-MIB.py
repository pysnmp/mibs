...
enterprises, TimeTicks, Gauge32, ObjectIdentity, NotificationType, Integer32, Unsigned32, Counter64, iso, ModuleIdentity, Bits, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Gauge32", "ObjectIdentity", "NotificationType", "Integer32", "Unsigned32", "Counter64", "iso", "ModuleIdentity", "Bits", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcMeasurement=dcMeasurement, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcHighTempHyst=dcHighTempHyst, dcEqualizeLeadTime=dcEqualizeLeadTime, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcEqualizeControl=dcEqualizeControl, dcUaMin=dcUaMin, dcUsMin=dcUsMin, notificationsGroup=notificationsGroup, dcEventProcessingEventName=dcEventProcessingEventName, dcAlarmEntry=dcAlarmEntry, dcDefaultLogEventIndex=dcDefaultLogEventIndex, systemMonitorGroup=systemMonitorGroup, dcLvdName=dcLvdName, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcEventHistoryEntry=dcEventHistoryEntry, dcSystemInfo=dcSystemInfo, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcBatteryTestInterval=dcBatteryTestInterval, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcBatteryTestType=dcBatteryTestType, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcStopTemp=dcStopTemp, dcBatteryStringTable=dcBatteryStringTable, lvdTableGroup=lvdTableGroup, dcBoostChargeIstart=dcBoostChargeIstart, dcGenericAlarmIndex=dcGenericAlarmIndex, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcAlarmEventName=dcAlarmEventName, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcEqualizeDuration=dcEqualizeDuration, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcRunawayTemp=dcRunawayTemp, dcEfficiencyCycling=dcEfficiencyCycling, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcEqualizeParameter=dcEqualizeParameter, controllerEventsV2=controllerEventsV2, dcEventProcessingEventTable=dcEventProcessingEventTable, alarmTableGroup=alarmTableGroup, dcBatteryStringIndex=dcBatteryStringIndex, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcHighStartTemp=dcHighStartTemp, dcBatteryTestControl=dcBatteryTestControl, dcBatteryTestDuration=dcBatteryTestDuration, dcMeterPanel=dcMeterPanel, dcLoadCurrent=dcLoadCurrent, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcTempSupervision=dcTempSupervision, controllerEvents=controllerEvents, dcTrapDestinationEntry=dcTrapDestinationEntry, dcTrapDestinationIndex=dcTrapDestinationIndex, dcTrapDestinationIp=dcTrapDestinationIp, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcRectifierGroupIndex=dcRectifierGroupIndex, dcMeasurementUnit=dcMeasurementUnit, dcConfig=dcConfig, dcEventHistoryIndex=dcEventHistoryIndex, dcMeterPanelEventName=dcMeterPanelEventName, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcUsys20=dcUsys20, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcEqualizeInterval=dcEqualizeInterval, dcSiteName=dcSiteName, dcBatteryStringName=dcBatteryStringName, dcHighStopVoltage=dcHighStopVoltage, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcTempCompType=dcTempCompType, dcPowerLimitationEntry=dcPowerLimitationEntry, dcBatteryTestStatus=dcBatteryTestStatus, powerLimitationTableGroup=powerLimitationTableGroup, dcMisc=dcMisc, dcBatteryTestUsupport=dcBatteryTestUsupport, dcMeterPanelEventEntry=dcMeterPanelEventEntry, controllerBasicCompl=controllerBasicCompl, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcRectifierEntry=dcRectifierEntry, dcBatteryParameter=dcBatteryParameter, dcBatteryTestTempTo=dcBatteryTestTempTo, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcLowStartTemp=dcLowStartTemp, dcRectifierGroupTable=dcRectifierGroupTable, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcPowerLimitationType=dcPowerLimitationType, dcControlEventIndex=dcControlEventIndex, dcMainsFailureAlarm=dcMainsFailureAlarm, dcPowerLimitationLimit=dcPowerLimitationLimit, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcControlEventEntry=dcControlEventEntry, systemNonUrgentAlarm=systemNonUrgentAlarm, dcRectifierTable=dcRectifierTable, dcDefaultLogEventName=dcDefaultLogEventName, dcMeasurementScaleFactor=dcMeasurementScaleFactor, systemAlarmGroup=systemAlarmGroup, dcSystemAlarms=dcSystemAlarms, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcBatteryTest=dcBatteryTest, defaultLogEventTableGroup=defaultLogEventTableGroup, dcTempComp=dcTempComp, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, orionBaseMib=orionBaseMib, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcBoostChargeStatus=dcBoostChargeStatus, dcBatteryTestResult=dcBatteryTestResult, controllerObjects=controllerObjects, dcRectifierCurrent=dcRectifierCurrent, dcFloatCharge=dcFloatCharge, dcHysteresis=dcHysteresis, dcRectifierGroupName=dcRectifierGroupName, dcPowerLimitationTable=dcPowerLimitationTable, controllerGroups=controllerGroups, dcDefaultLogEventTable=dcDefaultLogEventTable, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcBoostChargeControl=dcBoostChargeControl, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcTrapDestinationTable=dcTrapDestinationTable, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcSystemPower=dcSystemPower, dcBatteryTestParameter=dcBatteryTestParameter, dcBattery=dcBattery, dcUrgentAlarmValue=dcUrgentAlarmValue, dcMeasurementEntry=dcMeasurementEntry, dcInputOutput=dcInputOutput, dcNumberRectifiers=dcNumberRectifiers, dcFileProcessingStatus=dcFileProcessingStatus, systemUrgentAlarm=systemUrgentAlarm, dcBatteryCurrent=dcBatteryCurrent, dcNumberUrgentAlarms=dcNumberUrgentAlarms, rectifierTableGroup=rectifierTableGroup, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, controlEventTableGroup=controlEventTableGroup, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcBoostCharge=dcBoostCharge, dcControlEventTable=dcControlEventTable, dcPowerLimitationEventName=dcPowerLimitationEventName, dcRectifier=dcRectifier, batteryGroup=batteryGroup, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcGenericAlarmTable=dcGenericAlarmTable, dcExpectedBackupTime=dcExpectedBackupTime, dcEnableUsTempComp=dcEnableUsTempComp, dcCurrentLimit=dcCurrentLimit, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcMeasurementName=dcMeasurementName, dcEvtCtrlCharge=dcEvtCtrlCharge, dcSlope=dcSlope, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcChargeState=dcChargeState, dcHighTemp=dcHighTemp, dcBatteryTestDateTime=dcBatteryTestDateTime, dcEqualizeStatus=dcEqualizeStatus, dcStartTemp=dcStartTemp, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcMeterPanelEventTable=dcMeterPanelEventTable, dcRectifierFunctions=dcRectifierFunctions, batteryStringTableGroup=batteryStringTableGroup, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcAlarmIndex=dcAlarmIndex, dcPowerLimitation=dcPowerLimitation, meterPanelEventTableGroup=meterPanelEventTableGroup, dcUsMax=dcUsMax, dcLvdIndex=dcLvdIndex, rectifierGroupTableGroup=rectifierGroupTableGroup, dcLowStopVoltage=dcLowStopVoltage, dcSystemName=dcSystemName, dcMaximumLoadStep=dcMaximumLoadStep, PYSNMP_MODULE_ID=orionBaseMibModule, dcMaxVoltage=dcMaxVoltage, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcMeasurementIndex=dcMeasurementIndex, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcBoostChargeVoltage=dcBoostChargeVoltage, dcEventHistoryMessage=dcEventHistoryMessage, dcEventHistoryTable=dcEventHistoryTable, dcBatteryTemperature=dcBatteryTemperature, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcRectifierIdentifier=dcRectifierIdentifier, dcCriticalAlarmValue=dcCriticalAlarmValue, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcLowTempSlope=dcLowTempSlope, dcAlarmEventIdentifier=dcAlarmEventIdentifier, miscGroup=miscGroup, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcMinimumLoadStep=dcMinimumLoadStep, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcCriticalAlarmName=dcCriticalAlarmName, dcBatteryStringCapacity=dcBatteryStringCapacity, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcLvdTable=dcLvdTable, eventHistoryTableGroup=eventHistoryTableGroup, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcHighTempSlope=dcHighTempSlope, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcSoftwareVersion=dcSoftwareVersion, dcBoD=dcBoD, dcMeasurementValue=dcMeasurementValue, dcUaMax=dcUaMax, dcEqualize=dcEqualize, dcBoostChargeType=dcBoostChargeType, orionBaseMibModule=orionBaseMibModule, dcBatteryTestResults=dcBatteryTestResults, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcRunawayVoltage=dcRunawayVoltage, dcLossOfBackupTime=dcLossOfBackupTime, dcRectifierIndex=dcRectifierIndex, dcMeasurementTable=dcMeasurementTable, dcAlarmEventValue=dcAlarmEventValue, dcSystemMonitor=dcSystemMonitor, dcRectifierGroupEntry=dcRectifierGroupEntry, dcGenericAlarmEntry=dcGenericAlarmEntry, dcPowerLimitationStatus=dcPowerLimitationStatus, dcControlEventValue=dcControlEventValue, dcMeterPanelEventValue=dcMeterPanelEventValue, dcControlEventName=dcControlEventName, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcLvdEntry=dcLvdEntry, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, genericAlarmTableGroup=genericAlarmTableGroup, dcGenericAlarmEventName=dcGenericAlarmEventName, dcAlarmTable=dcAlarmTable, controllerEventObjects=controllerEventObjects, trapDestinationTableGroup=trapDestinationTableGroup, systemCriticalAlarm=systemCriticalAlarm, dcRectifierStatus=dcRectifierStatus, dcBoostChargeParameter=dcBoostChargeParameter, dcAlarmEventCategory=dcAlarmEventCategory, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcSystemVoltage=dcSystemVoltage, dcPowerLimitationIndex=dcPowerLimitationIndex, dcUrgentAlarmName=dcUrgentAlarmName, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcSystemDateTime=dcSystemDateTime, dcEqualizeEnabled=dcEqualizeEnabled, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcEqualizeTimeLag=dcEqualizeTimeLag, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier)
mibBuilder.exportSymbols("ORION-BASE-MIB", controllerCompl=controllerCompl, dcBatteryStringEntry=dcBatteryStringEntry, dcEventProcessingEventSelected=dcEventProcessingEventSelected, measurementTableGroup=measurementTableGroup, dcBoostChargeIstop=dcBoostChargeIstop, dcEventProcessingEventType=dcEventProcessingEventType, dcTrapDestinationPort=dcTrapDestinationPort, rectifierGroup=rectifierGroup, systemInfoGroup=systemInfoGroup, dcEqualizeVoltage=dcEqualizeVoltage, dcControlEventIdentifier=dcControlEventIdentifier, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, controllerConfs=controllerConfs, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod)
