...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcPowerLimitationLimit=dcPowerLimitationLimit, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcEqualizeControl=dcEqualizeControl, dcLvdTable=dcLvdTable, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, systemMonitorGroup=systemMonitorGroup, dcFloatCharge=dcFloatCharge, rectifierGroup=rectifierGroup, dcBatteryTestTempTo=dcBatteryTestTempTo, dcMainsFailureAlarm=dcMainsFailureAlarm, dcBoostChargeType=dcBoostChargeType, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcUsMin=dcUsMin, dcMeterPanelEventName=dcMeterPanelEventName, dcRectifierIndex=dcRectifierIndex, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcBatteryStringIndex=dcBatteryStringIndex, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcPowerLimitationEventName=dcPowerLimitationEventName, dcNonUrgentAlarmName=dcNonUrgentAlarmName, batteryStringTableGroup=batteryStringTableGroup, controllerObjects=controllerObjects, dcBatteryStringTable=dcBatteryStringTable, dcSystemInfo=dcSystemInfo, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcStartTemp=dcStartTemp, lvdTableGroup=lvdTableGroup, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcLvdName=dcLvdName, rectifierTableGroup=rectifierTableGroup, trapDestinationTableGroup=trapDestinationTableGroup, dcSystemPower=dcSystemPower, dcTrapDestinationTable=dcTrapDestinationTable, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcPowerLimitationStatus=dcPowerLimitationStatus, dcEqualizeLeadTime=dcEqualizeLeadTime, dcEventProcessingEventName=dcEventProcessingEventName, dcBatteryTemperature=dcBatteryTemperature, dcMeasurementIndex=dcMeasurementIndex, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcEventHistoryMessage=dcEventHistoryMessage, dcBatteryStringCapacity=dcBatteryStringCapacity, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcTrapDestinationEntry=dcTrapDestinationEntry, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcCurrentLimit=dcCurrentLimit, dcLowStartTemp=dcLowStartTemp, dcRectifierGroupEntry=dcRectifierGroupEntry, dcDefaultLogEventTable=dcDefaultLogEventTable, controllerCompl=controllerCompl, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcMisc=dcMisc, dcRectifierCurrent=dcRectifierCurrent, dcControlEventName=dcControlEventName, dcControlEventValue=dcControlEventValue, dcUrgentAlarmName=dcUrgentAlarmName, dcEqualizeVoltage=dcEqualizeVoltage, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcEvtCtrlCharge=dcEvtCtrlCharge, dcMeasurementUnit=dcMeasurementUnit, dcUaMin=dcUaMin, dcTempSupervision=dcTempSupervision, dcBatteryTestType=dcBatteryTestType, dcAlarmEventValue=dcAlarmEventValue, dcControlEventTable=dcControlEventTable, dcMeasurementEntry=dcMeasurementEntry, meterPanelEventTableGroup=meterPanelEventTableGroup, dcBatteryStringEntry=dcBatteryStringEntry, dcSoftwareVersion=dcSoftwareVersion, dcUsMax=dcUsMax, dcRectifierGroupName=dcRectifierGroupName, orionBaseMib=orionBaseMib, notificationsGroup=notificationsGroup, dcRectifierStatus=dcRectifierStatus, controlEventTableGroup=controlEventTableGroup, controllerConfs=controllerConfs, dcPowerLimitationType=dcPowerLimitationType, dcBatteryTest=dcBatteryTest, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcPowerLimitationTable=dcPowerLimitationTable, dcMeterPanelEventValue=dcMeterPanelEventValue, measurementTableGroup=measurementTableGroup, dcHighTemp=dcHighTemp, dcBoostChargeControl=dcBoostChargeControl, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, systemInfoGroup=systemInfoGroup, dcMeasurement=dcMeasurement, dcBatteryTestDuration=dcBatteryTestDuration, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcHysteresis=dcHysteresis, dcMeasurementTable=dcMeasurementTable, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcTempComp=dcTempComp, dcBatteryTestResults=dcBatteryTestResults, dcMaxVoltage=dcMaxVoltage, dcLowTempSlope=dcLowTempSlope, dcFileProcessingStatus=dcFileProcessingStatus, dcPowerLimitationEntry=dcPowerLimitationEntry, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcBatteryStringName=dcBatteryStringName, dcBoostChargeVoltage=dcBoostChargeVoltage, dcRectifierFunctions=dcRectifierFunctions, dcHighTempSlope=dcHighTempSlope, dcMeterPanel=dcMeterPanel, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcHighTempHyst=dcHighTempHyst, dcEventHistoryTable=dcEventHistoryTable, dcDefaultLogEventName=dcDefaultLogEventName, systemNonUrgentAlarm=systemNonUrgentAlarm, systemUrgentAlarm=systemUrgentAlarm, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcTrapDestinationIp=dcTrapDestinationIp, dcSystemMonitor=dcSystemMonitor, controllerEvents=controllerEvents, dcBoostChargeIstop=dcBoostChargeIstop, dcControlEventIndex=dcControlEventIndex, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcRectifierTable=dcRectifierTable, dcGenericAlarmEventValue=dcGenericAlarmEventValue, alarmTableGroup=alarmTableGroup, dcTrapDestinationIndex=dcTrapDestinationIndex, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcCriticalAlarmName=dcCriticalAlarmName, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcRunawayTemp=dcRunawayTemp, dcCriticalAlarmValue=dcCriticalAlarmValue, miscGroup=miscGroup, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcEqualize=dcEqualize, dcConfig=dcConfig, dcMinimumLoadStep=dcMinimumLoadStep, dcPowerLimitation=dcPowerLimitation, dcBoostChargeParameter=dcBoostChargeParameter, dcBoostChargeIstart=dcBoostChargeIstart, dcEqualizeTimeLag=dcEqualizeTimeLag, dcEqualizeStatus=dcEqualizeStatus, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcNumberRectifiers=dcNumberRectifiers, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, controllerEventObjects=controllerEventObjects, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcStopTemp=dcStopTemp, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcSystemVoltage=dcSystemVoltage, dcMeterPanelEventTable=dcMeterPanelEventTable, dcRunawayVoltage=dcRunawayVoltage, dcAlarmEntry=dcAlarmEntry, systemAlarmGroup=systemAlarmGroup, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcLoadCurrent=dcLoadCurrent, dcBatteryTestInterval=dcBatteryTestInterval, dcSystemDateTime=dcSystemDateTime, systemCriticalAlarm=systemCriticalAlarm, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcHighStartTemp=dcHighStartTemp, dcHighStopVoltage=dcHighStopVoltage, dcAlarmTable=dcAlarmTable, dcBatteryTestStatus=dcBatteryTestStatus, orionBaseMibModule=orionBaseMibModule, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcControlEventEntry=dcControlEventEntry, dcBoostCharge=dcBoostCharge, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, genericAlarmTableGroup=genericAlarmTableGroup, dcBatteryCurrent=dcBatteryCurrent, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcEqualizeDuration=dcEqualizeDuration, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcRectifierEntry=dcRectifierEntry, dcMaximumLoadStep=dcMaximumLoadStep, controllerBasicCompl=controllerBasicCompl, dcBattery=dcBattery, dcBatteryTestResult=dcBatteryTestResult, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcEqualizeEnabled=dcEqualizeEnabled, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcControlEventIdentifier=dcControlEventIdentifier, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcRectifierGroupIndex=dcRectifierGroupIndex, dcBatteryTestParameter=dcBatteryTestParameter, dcEqualizeParameter=dcEqualizeParameter, dcAlarmIndex=dcAlarmIndex, dcGenericAlarmEventName=dcGenericAlarmEventName, dcGenericAlarmIndex=dcGenericAlarmIndex, dcTrapDestinationPort=dcTrapDestinationPort, dcLvdEntry=dcLvdEntry, dcSystemName=dcSystemName, dcEqualizeInterval=dcEqualizeInterval, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcSlope=dcSlope, dcLossOfBackupTime=dcLossOfBackupTime, dcPowerLimitationIndex=dcPowerLimitationIndex, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, batteryGroup=batteryGroup, rectifierGroupTableGroup=rectifierGroupTableGroup, defaultLogEventTableGroup=defaultLogEventTableGroup, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcRectifierIdentifier=dcRectifierIdentifier, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, eventHistoryTableGroup=eventHistoryTableGroup, dcChargeState=dcChargeState, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcEventHistoryEntry=dcEventHistoryEntry, dcEfficiencyCycling=dcEfficiencyCycling, PYSNMP_MODULE_ID=orionBaseMibModule, controllerEventsV2=controllerEventsV2, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcExpectedBackupTime=dcExpectedBackupTime, dcMeasurementValue=dcMeasurementValue, dcInputOutput=dcInputOutput, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, powerLimitationTableGroup=powerLimitationTableGroup, dcTempCompType=dcTempCompType, dcBatteryTestDateTime=dcBatteryTestDateTime, dcEventProcessingEventTable=dcEventProcessingEventTable, dcBoostChargeStatus=dcBoostChargeStatus, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcGenericAlarmTable=dcGenericAlarmTable, dcGenericAlarmEntry=dcGenericAlarmEntry, dcBatteryTestUsupport=dcBatteryTestUsupport, dcSiteName=dcSiteName, dcMeasurementName=dcMeasurementName, dcBatteryTestControl=dcBatteryTestControl, dcUrgentAlarmValue=dcUrgentAlarmValue, dcLowStopVoltage=dcLowStopVoltage, dcLvdIndex=dcLvdIndex, dcRectifier=dcRectifier, dcBoD=dcBoD, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcSystemAlarms=dcSystemAlarms, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcEventHistoryIndex=dcEventHistoryIndex, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcEventProcessingEventType=dcEventProcessingEventType, controllerGroups=controllerGroups)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcUaMax=dcUaMax, dcBatteryParameter=dcBatteryParameter, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcRectifierGroupTable=dcRectifierGroupTable, dcAlarmEventCategory=dcAlarmEventCategory, dcEnableUsTempComp=dcEnableUsTempComp, dcUsys20=dcUsys20, dcAlarmEventName=dcAlarmEventName, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcTotalBatteryCapacity=dcTotalBatteryCapacity)
