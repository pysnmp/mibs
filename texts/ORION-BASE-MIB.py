...
NotificationType, Integer32, IpAddress, Counter64, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Counter32, MibIdentifier, iso, Bits, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "IpAddress", "Counter64", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Counter32", "MibIdentifier", "iso", "Bits", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEventHistoryMessage=dcEventHistoryMessage, systemUrgentAlarm=systemUrgentAlarm, measurementTableGroup=measurementTableGroup, dcBatteryTestControl=dcBatteryTestControl, dcSoftwareVersion=dcSoftwareVersion, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, batteryStringTableGroup=batteryStringTableGroup, dcBatteryTestDateTime=dcBatteryTestDateTime, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcPowerLimitationIndex=dcPowerLimitationIndex, dcLvdName=dcLvdName, dcSlope=dcSlope, dcAlarmEventValue=dcAlarmEventValue, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcEfficiencyCycling=dcEfficiencyCycling, dcTempComp=dcTempComp, dcPowerLimitationTable=dcPowerLimitationTable, dcLvdEntry=dcLvdEntry, dcSystemName=dcSystemName, dcBoostChargeIstart=dcBoostChargeIstart, dcHighTemp=dcHighTemp, dcUrgentAlarmValue=dcUrgentAlarmValue, trapDestinationTableGroup=trapDestinationTableGroup, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcDefaultLogEventTable=dcDefaultLogEventTable, systemAlarmGroup=systemAlarmGroup, dcEventProcessingEventTable=dcEventProcessingEventTable, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcRectifierFunctions=dcRectifierFunctions, eventHistoryTableGroup=eventHistoryTableGroup, dcEqualizeParameter=dcEqualizeParameter, dcEqualizeEnabled=dcEqualizeEnabled, dcEqualizeInterval=dcEqualizeInterval, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcUsMin=dcUsMin, dcLowTempSlope=dcLowTempSlope, dcAlarmTable=dcAlarmTable, dcRectifierIdentifier=dcRectifierIdentifier, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcBatteryTestType=dcBatteryTestType, meterPanelEventTableGroup=meterPanelEventTableGroup, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcGenericAlarmIndex=dcGenericAlarmIndex, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcMeasurementTable=dcMeasurementTable, dcGenericAlarmTable=dcGenericAlarmTable, dcMainsFailureAlarm=dcMainsFailureAlarm, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcLowStartTemp=dcLowStartTemp, dcFloatCharge=dcFloatCharge, dcRunawayTemp=dcRunawayTemp, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcHighTempHyst=dcHighTempHyst, dcLvdTable=dcLvdTable, systemInfoGroup=systemInfoGroup, dcTempSupervision=dcTempSupervision, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcRectifierCurrent=dcRectifierCurrent, dcBatteryStringCapacity=dcBatteryStringCapacity, dcControlEventName=dcControlEventName, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, lvdTableGroup=lvdTableGroup, dcEqualizeLeadTime=dcEqualizeLeadTime, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcEventHistoryEntry=dcEventHistoryEntry, dcEventHistoryIndex=dcEventHistoryIndex, dcBatteryTestDuration=dcBatteryTestDuration, dcStopTemp=dcStopTemp, dcControlEventTable=dcControlEventTable, dcPowerLimitationStatus=dcPowerLimitationStatus, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcBatteryStringEntry=dcBatteryStringEntry, dcBatteryStringName=dcBatteryStringName, dcLowStopVoltage=dcLowStopVoltage, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcMeterPanelEventValue=dcMeterPanelEventValue, dcBoostCharge=dcBoostCharge, dcEqualizeControl=dcEqualizeControl, dcSiteName=dcSiteName, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, controllerObjects=controllerObjects, systemCriticalAlarm=systemCriticalAlarm, dcEqualizeStatus=dcEqualizeStatus, batteryGroup=batteryGroup, dcTrapDestinationIp=dcTrapDestinationIp, PYSNMP_MODULE_ID=orionBaseMibModule, dcFileProcessingStatus=dcFileProcessingStatus, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcHysteresis=dcHysteresis, dcBoostChargeStatus=dcBoostChargeStatus, dcPowerLimitationEntry=dcPowerLimitationEntry, dcRectifierStatus=dcRectifierStatus, dcBatteryCurrent=dcBatteryCurrent, notificationsGroup=notificationsGroup, dcMisc=dcMisc, dcBattery=dcBattery, dcSystemPower=dcSystemPower, dcPowerLimitationLimit=dcPowerLimitationLimit, defaultLogEventTableGroup=defaultLogEventTableGroup, dcSystemMonitor=dcSystemMonitor, dcSystemDateTime=dcSystemDateTime, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcMinimumLoadStep=dcMinimumLoadStep, dcUaMax=dcUaMax, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcBoostChargeParameter=dcBoostChargeParameter, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcControlEventIdentifier=dcControlEventIdentifier, dcEvtCtrlCharge=dcEvtCtrlCharge, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, orionBaseMibModule=orionBaseMibModule, dcGenericAlarmEventValue=dcGenericAlarmEventValue, controllerCompl=controllerCompl, dcRectifierGroupIndex=dcRectifierGroupIndex, dcAlarmIndex=dcAlarmIndex, dcAlarmEventName=dcAlarmEventName, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcMeasurementName=dcMeasurementName, dcRectifierEntry=dcRectifierEntry, miscGroup=miscGroup, systemNonUrgentAlarm=systemNonUrgentAlarm, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcBatteryStringIndex=dcBatteryStringIndex, dcRectifier=dcRectifier, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcControlEventIndex=dcControlEventIndex, controllerBasicCompl=controllerBasicCompl, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcGenericAlarmEventName=dcGenericAlarmEventName, dcRectifierTable=dcRectifierTable, eventProcessingEventTableGroup=eventProcessingEventTableGroup, controllerEventObjects=controllerEventObjects, dcInputOutput=dcInputOutput, dcBoostChargeIstop=dcBoostChargeIstop, controllerConfs=controllerConfs, dcEventHistoryTable=dcEventHistoryTable, dcTrapDestinationIndex=dcTrapDestinationIndex, dcBatteryTestStatus=dcBatteryTestStatus, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcBatteryStringTable=dcBatteryStringTable, rectifierTableGroup=rectifierTableGroup, dcBatteryTestInterval=dcBatteryTestInterval, dcSystemVoltage=dcSystemVoltage, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcGenericAlarmEntry=dcGenericAlarmEntry, controlEventTableGroup=controlEventTableGroup, dcExpectedBackupTime=dcExpectedBackupTime, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcBatteryParameter=dcBatteryParameter, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcNumberRectifiers=dcNumberRectifiers, dcMeasurement=dcMeasurement, dcBatteryTestUsupport=dcBatteryTestUsupport, dcMeterPanelEventTable=dcMeterPanelEventTable, dcBoostChargeControl=dcBoostChargeControl, controllerEvents=controllerEvents, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, genericAlarmTableGroup=genericAlarmTableGroup, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcSystemAlarms=dcSystemAlarms, dcEqualizeTimeLag=dcEqualizeTimeLag, dcTempCompType=dcTempCompType, dcBatteryTemperature=dcBatteryTemperature, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcControlEventValue=dcControlEventValue, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcEventProcessingEventType=dcEventProcessingEventType, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcMeterPanelEventName=dcMeterPanelEventName, dcUsys20=dcUsys20, dcStartTemp=dcStartTemp, dcCriticalAlarmValue=dcCriticalAlarmValue, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, rectifierGroupTableGroup=rectifierGroupTableGroup, controllerEventsV2=controllerEventsV2, dcMeasurementEntry=dcMeasurementEntry, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcUaMin=dcUaMin, dcRectifierGroupName=dcRectifierGroupName, dcControlEventEntry=dcControlEventEntry, dcLoadCurrent=dcLoadCurrent, dcTrapDestinationEntry=dcTrapDestinationEntry, dcAlarmEventCategory=dcAlarmEventCategory, dcBatteryTestResult=dcBatteryTestResult, dcPowerLimitationType=dcPowerLimitationType, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcBatteryTest=dcBatteryTest, dcTrapDestinationTable=dcTrapDestinationTable, dcBatteryTestParameter=dcBatteryTestParameter, dcEqualizeVoltage=dcEqualizeVoltage, dcHighStartTemp=dcHighStartTemp, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcEventProcessingEventName=dcEventProcessingEventName, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcMeasurementValue=dcMeasurementValue, dcPowerLimitation=dcPowerLimitation, powerLimitationTableGroup=powerLimitationTableGroup, dcUsMax=dcUsMax, dcEqualize=dcEqualize, dcHighTempSlope=dcHighTempSlope, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcBatteryTestTempTo=dcBatteryTestTempTo, controllerGroups=controllerGroups, dcHighStopVoltage=dcHighStopVoltage, dcConfig=dcConfig, systemMonitorGroup=systemMonitorGroup, dcBatteryTestResults=dcBatteryTestResults, dcRectifierIndex=dcRectifierIndex, dcChargeState=dcChargeState, dcBoostChargeType=dcBoostChargeType, dcAlarmEntry=dcAlarmEntry, dcLossOfBackupTime=dcLossOfBackupTime, dcRectifierGroupEntry=dcRectifierGroupEntry, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcDefaultLogEventName=dcDefaultLogEventName, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcEnableUsTempComp=dcEnableUsTempComp, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcMeasurementUnit=dcMeasurementUnit, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcSystemInfo=dcSystemInfo, dcMeterPanel=dcMeterPanel, dcMaximumLoadStep=dcMaximumLoadStep, dcEqualizeDuration=dcEqualizeDuration, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcMaxVoltage=dcMaxVoltage, dcRectifierGroupTable=dcRectifierGroupTable, dcTrapDestinationPort=dcTrapDestinationPort)
mibBuilder.exportSymbols("ORION-BASE-MIB", alarmTableGroup=alarmTableGroup, dcBoostChargeVoltage=dcBoostChargeVoltage, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcPowerLimitationEventName=dcPowerLimitationEventName, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcBoD=dcBoD, dcUrgentAlarmName=dcUrgentAlarmName, dcCriticalAlarmName=dcCriticalAlarmName, orionBaseMib=orionBaseMib, dcMeasurementIndex=dcMeasurementIndex, dcRunawayVoltage=dcRunawayVoltage, dcLvdIndex=dcLvdIndex, rectifierGroup=rectifierGroup, dcCurrentLimit=dcCurrentLimit)
