...
Bits, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Unsigned32, NotificationType, iso, Counter32, TimeTicks, Integer32, Counter64, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Unsigned32", "NotificationType", "iso", "Counter32", "TimeTicks", "Integer32", "Counter64", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcBatteryTestMinDuration=dcBatteryTestMinDuration, notificationsGroup=notificationsGroup, batteryGroup=batteryGroup, controllerEventObjects=controllerEventObjects, dcGenericAlarmIndex=dcGenericAlarmIndex, systemNonUrgentAlarm=systemNonUrgentAlarm, lvdTableGroup=lvdTableGroup, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcBoostChargeParameter=dcBoostChargeParameter, dcBoostChargeType=dcBoostChargeType, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcTrapDestinationEntry=dcTrapDestinationEntry, dcBatteryTestUsupport=dcBatteryTestUsupport, dcPowerLimitationTable=dcPowerLimitationTable, dcEventHistoryEntry=dcEventHistoryEntry, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcBatteryTemperature=dcBatteryTemperature, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcMeterPanelEventValue=dcMeterPanelEventValue, systemAlarmGroup=systemAlarmGroup, dcBatteryTest=dcBatteryTest, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcMaxVoltage=dcMaxVoltage, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcSoftwareVersion=dcSoftwareVersion, dcUaMin=dcUaMin, dcBatteryStringTable=dcBatteryStringTable, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcFloatCharge=dcFloatCharge, dcEqualizeTimeLag=dcEqualizeTimeLag, dcPowerLimitation=dcPowerLimitation, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcBoostChargeControl=dcBoostChargeControl, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcExpectedBackupTime=dcExpectedBackupTime, dcHighTemp=dcHighTemp, dcMeasurementIndex=dcMeasurementIndex, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcNumberRectifiersFailure=dcNumberRectifiersFailure, measurementTableGroup=measurementTableGroup, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, controllerConfs=controllerConfs, PYSNMP_MODULE_ID=orionBaseMibModule, dcLossOfBackupTime=dcLossOfBackupTime, dcSystemPower=dcSystemPower, dcEqualizeVoltage=dcEqualizeVoltage, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcRectifierIndex=dcRectifierIndex, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcPowerLimitationIndex=dcPowerLimitationIndex, dcTrapDestinationTable=dcTrapDestinationTable, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcTempComp=dcTempComp, dcAlarmEventName=dcAlarmEventName, dcControlEventTable=dcControlEventTable, dcEqualizeControl=dcEqualizeControl, dcMeterPanel=dcMeterPanel, trapDestinationTableGroup=trapDestinationTableGroup, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcSystemMonitor=dcSystemMonitor, dcStopTemp=dcStopTemp, dcTempSupervision=dcTempSupervision, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcTrapDestinationPort=dcTrapDestinationPort, systemMonitorGroup=systemMonitorGroup, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcGenericAlarmEventName=dcGenericAlarmEventName, dcBatteryStringName=dcBatteryStringName, dcLowStopVoltage=dcLowStopVoltage, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcRectifierGroupName=dcRectifierGroupName, dcPowerLimitationLimit=dcPowerLimitationLimit, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcMeasurementName=dcMeasurementName, controllerCompl=controllerCompl, dcBatteryParameter=dcBatteryParameter, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcUaMax=dcUaMax, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcRectifierIdentifier=dcRectifierIdentifier, systemUrgentAlarm=systemUrgentAlarm, dcEnableUsTempComp=dcEnableUsTempComp, dcBoostCharge=dcBoostCharge, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcLvdName=dcLvdName, dcAlarmEventValue=dcAlarmEventValue, dcBatteryTestType=dcBatteryTestType, dcMeasurementUnit=dcMeasurementUnit, dcControlEventIdentifier=dcControlEventIdentifier, dcBatteryCurrent=dcBatteryCurrent, dcInputOutput=dcInputOutput, dcChargeState=dcChargeState, dcAlarmIndex=dcAlarmIndex, dcGenericAlarmTable=dcGenericAlarmTable, dcControlEventEntry=dcControlEventEntry, batteryStringTableGroup=batteryStringTableGroup, dcControlEventName=dcControlEventName, powerLimitationTableGroup=powerLimitationTableGroup, dcSystemName=dcSystemName, dcEqualizeDuration=dcEqualizeDuration, dcEfficiencyCycling=dcEfficiencyCycling, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcMeterPanelEventTable=dcMeterPanelEventTable, systemCriticalAlarm=systemCriticalAlarm, dcRectifierStatus=dcRectifierStatus, dcBatteryStringIndex=dcBatteryStringIndex, dcUrgentAlarmValue=dcUrgentAlarmValue, dcHysteresis=dcHysteresis, dcAlarmTable=dcAlarmTable, alarmTableGroup=alarmTableGroup, dcEqualize=dcEqualize, dcRectifierEntry=dcRectifierEntry, dcBatteryTestResult=dcBatteryTestResult, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcLvdEntry=dcLvdEntry, dcSystemVoltage=dcSystemVoltage, dcBatteryTestDateTime=dcBatteryTestDateTime, dcControlEventValue=dcControlEventValue, dcDefaultLogEventTable=dcDefaultLogEventTable, dcPowerLimitationEventName=dcPowerLimitationEventName, dcSiteName=dcSiteName, controllerEventsV2=controllerEventsV2, defaultLogEventTableGroup=defaultLogEventTableGroup, dcRectifierGroupIndex=dcRectifierGroupIndex, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcRectifierFunctions=dcRectifierFunctions, dcUsMax=dcUsMax, dcUsMin=dcUsMin, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcEventProcessingEventType=dcEventProcessingEventType, orionBaseMibModule=orionBaseMibModule, dcCurrentLimit=dcCurrentLimit, dcEventHistoryMessage=dcEventHistoryMessage, dcSystemAlarms=dcSystemAlarms, dcSystemDateTime=dcSystemDateTime, dcBatteryTestStatus=dcBatteryTestStatus, dcEventProcessingEventName=dcEventProcessingEventName, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcEqualizeParameter=dcEqualizeParameter, controllerBasicCompl=controllerBasicCompl, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcEventProcessingEventTable=dcEventProcessingEventTable, dcTempCompType=dcTempCompType, dcMeasurementTable=dcMeasurementTable, dcMeterPanelEventName=dcMeterPanelEventName, rectifierGroupTableGroup=rectifierGroupTableGroup, dcHighTempSlope=dcHighTempSlope, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcTrapDestinationIp=dcTrapDestinationIp, dcBoostChargeIstart=dcBoostChargeIstart, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcEqualizeStatus=dcEqualizeStatus, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcEqualizeLeadTime=dcEqualizeLeadTime, dcMainsFailureAlarm=dcMainsFailureAlarm, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcHighTempHyst=dcHighTempHyst, dcBatteryStringEntry=dcBatteryStringEntry, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcLvdTable=dcLvdTable, dcEqualizeInterval=dcEqualizeInterval, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcPowerLimitationStatus=dcPowerLimitationStatus, dcEvtCtrlCharge=dcEvtCtrlCharge, dcPowerLimitationEntry=dcPowerLimitationEntry, controllerEvents=controllerEvents, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcLvdIndex=dcLvdIndex, controlEventTableGroup=controlEventTableGroup, dcConfig=dcConfig, rectifierGroup=rectifierGroup, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcUrgentAlarmName=dcUrgentAlarmName, dcFileProcessingStatus=dcFileProcessingStatus, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcCriticalAlarmName=dcCriticalAlarmName, eventHistoryTableGroup=eventHistoryTableGroup, dcEqualizeEnabled=dcEqualizeEnabled, dcPowerLimitationType=dcPowerLimitationType, dcBoD=dcBoD, dcSlope=dcSlope, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcBatteryTestInterval=dcBatteryTestInterval, orionBaseMib=orionBaseMib, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcLoadCurrent=dcLoadCurrent, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcBatteryTestTempTo=dcBatteryTestTempTo, dcControlEventIndex=dcControlEventIndex, dcLowTempSlope=dcLowTempSlope, controllerObjects=controllerObjects, dcBatteryTestDuration=dcBatteryTestDuration, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcEventHistoryIndex=dcEventHistoryIndex, dcDefaultLogEventName=dcDefaultLogEventName, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcRunawayVoltage=dcRunawayVoltage, dcUsys20=dcUsys20, genericAlarmTableGroup=genericAlarmTableGroup, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcCriticalAlarmValue=dcCriticalAlarmValue, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcMeasurementEntry=dcMeasurementEntry, systemInfoGroup=systemInfoGroup, dcRectifierTable=dcRectifierTable, dcRunawayTemp=dcRunawayTemp, dcRectifierGroupTable=dcRectifierGroupTable, dcDefaultLogEventIndex=dcDefaultLogEventIndex, controllerGroups=controllerGroups, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcAlarmEntry=dcAlarmEntry, miscGroup=miscGroup, dcMeasurement=dcMeasurement, dcRectifierCurrent=dcRectifierCurrent, dcStartTemp=dcStartTemp, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcNumberRectifiers=dcNumberRectifiers, dcSystemInfo=dcSystemInfo, dcBoostChargeIstop=dcBoostChargeIstop, dcBatteryTestParameter=dcBatteryTestParameter, dcMisc=dcMisc, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcMeasurementValue=dcMeasurementValue, dcHighStartTemp=dcHighStartTemp, dcRectifier=dcRectifier, dcBoostChargeStatus=dcBoostChargeStatus, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcBatteryTestResults=dcBatteryTestResults, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcBattery=dcBattery, dcLowStartTemp=dcLowStartTemp, dcEventHistoryTable=dcEventHistoryTable, dcBatteryStringCapacity=dcBatteryStringCapacity)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcTrapDestinationIndex=dcTrapDestinationIndex, dcAlarmEventCategory=dcAlarmEventCategory, dcGenericAlarmEntry=dcGenericAlarmEntry, meterPanelEventTableGroup=meterPanelEventTableGroup, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcRectifierGroupEntry=dcRectifierGroupEntry, dcMinimumLoadStep=dcMinimumLoadStep, dcBoostChargeVoltage=dcBoostChargeVoltage, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcHighStopVoltage=dcHighStopVoltage, rectifierTableGroup=rectifierTableGroup, dcMaximumLoadStep=dcMaximumLoadStep, dcBatteryTestControl=dcBatteryTestControl)
