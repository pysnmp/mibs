...
iso, Gauge32, Counter32, IpAddress, Integer32, ObjectIdentity, Unsigned32, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, enterprises, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Counter32", "IpAddress", "Integer32", "ObjectIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "enterprises", "Counter64", "Bits")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEfficiencyCycling=dcEfficiencyCycling, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcSystemName=dcSystemName, dcRunawayVoltage=dcRunawayVoltage, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcTempComp=dcTempComp, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcCriticalAlarmValue=dcCriticalAlarmValue, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcPowerLimitation=dcPowerLimitation, controllerEventsV2=controllerEventsV2, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcUrgentAlarmName=dcUrgentAlarmName, systemInfoGroup=systemInfoGroup, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcChargeState=dcChargeState, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcTrapDestinationEntry=dcTrapDestinationEntry, dcLvdName=dcLvdName, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcRectifierStatus=dcRectifierStatus, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcRectifierGroupName=dcRectifierGroupName, miscGroup=miscGroup, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcRectifierIndex=dcRectifierIndex, dcRectifier=dcRectifier, dcPowerLimitationStatus=dcPowerLimitationStatus, dcUrgentAlarmValue=dcUrgentAlarmValue, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcStartTemp=dcStartTemp, dcConfig=dcConfig, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcControlEventIdentifier=dcControlEventIdentifier, orionBaseMib=orionBaseMib, dcLoadCurrent=dcLoadCurrent, dcEventHistoryMessage=dcEventHistoryMessage, dcBatteryTestParameter=dcBatteryTestParameter, dcEnableUsTempComp=dcEnableUsTempComp, dcRectifierIdentifier=dcRectifierIdentifier, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcSystemAlarms=dcSystemAlarms, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcBoostChargeVoltage=dcBoostChargeVoltage, dcGenericAlarmIndex=dcGenericAlarmIndex, systemMonitorGroup=systemMonitorGroup, dcEqualizeLeadTime=dcEqualizeLeadTime, dcLowStopVoltage=dcLowStopVoltage, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcEventProcessingEventTable=dcEventProcessingEventTable, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcEventHistoryTable=dcEventHistoryTable, dcHighStopVoltage=dcHighStopVoltage, dcBoostChargeIstart=dcBoostChargeIstart, batteryGroup=batteryGroup, dcBatteryTest=dcBatteryTest, dcTrapDestinationPort=dcTrapDestinationPort, dcLowTempSlope=dcLowTempSlope, dcPowerLimitationIndex=dcPowerLimitationIndex, controllerCompl=controllerCompl, dcCriticalAlarmName=dcCriticalAlarmName, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcHighStartTemp=dcHighStartTemp, dcTrapDestinationTable=dcTrapDestinationTable, dcUsMin=dcUsMin, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcTrapDestinationIndex=dcTrapDestinationIndex, genericAlarmTableGroup=genericAlarmTableGroup, controllerConfs=controllerConfs, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcBatteryStringEntry=dcBatteryStringEntry, dcBatteryStringName=dcBatteryStringName, dcBattery=dcBattery, dcInputOutput=dcInputOutput, dcEqualizeVoltage=dcEqualizeVoltage, dcEqualize=dcEqualize, dcMeterPanel=dcMeterPanel, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcRectifierGroupEntry=dcRectifierGroupEntry, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcBoostChargeIstop=dcBoostChargeIstop, dcEqualizeTimeLag=dcEqualizeTimeLag, dcHighTempSlope=dcHighTempSlope, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcPowerLimitationType=dcPowerLimitationType, dcMeasurementEntry=dcMeasurementEntry, defaultLogEventTableGroup=defaultLogEventTableGroup, dcExpectedBackupTime=dcExpectedBackupTime, dcEventProcessingEventType=dcEventProcessingEventType, trapDestinationTableGroup=trapDestinationTableGroup, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcControlEventTable=dcControlEventTable, dcBatteryStringTable=dcBatteryStringTable, dcLossOfBackupTime=dcLossOfBackupTime, dcEqualizeStatus=dcEqualizeStatus, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcLvdEntry=dcLvdEntry, orionBaseMibModule=orionBaseMibModule, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcMeasurementValue=dcMeasurementValue, dcBatteryTestType=dcBatteryTestType, dcMinimumLoadStep=dcMinimumLoadStep, dcAlarmEventValue=dcAlarmEventValue, dcSlope=dcSlope, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcStopTemp=dcStopTemp, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcBatteryCurrent=dcBatteryCurrent, dcLvdDisconnectDelay=dcLvdDisconnectDelay, notificationsGroup=notificationsGroup, dcRectifierEntry=dcRectifierEntry, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcMaximumLoadStep=dcMaximumLoadStep, dcPowerLimitationLimit=dcPowerLimitationLimit, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcControlEventValue=dcControlEventValue, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, alarmTableGroup=alarmTableGroup, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcRectifierGroupIndex=dcRectifierGroupIndex, dcTempCompType=dcTempCompType, dcHighTemp=dcHighTemp, systemCriticalAlarm=systemCriticalAlarm, rectifierGroupTableGroup=rectifierGroupTableGroup, dcGenericAlarmTable=dcGenericAlarmTable, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, controllerGroups=controllerGroups, dcMeasurementName=dcMeasurementName, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, lvdTableGroup=lvdTableGroup, dcMeterPanelEventValue=dcMeterPanelEventValue, controlEventTableGroup=controlEventTableGroup, dcEqualizeDuration=dcEqualizeDuration, dcGenericAlarmEventName=dcGenericAlarmEventName, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcRunawayTemp=dcRunawayTemp, dcMainsFailureAlarm=dcMainsFailureAlarm, dcControlEventEntry=dcControlEventEntry, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, measurementTableGroup=measurementTableGroup, dcEventHistoryIndex=dcEventHistoryIndex, dcAlarmTable=dcAlarmTable, dcBoD=dcBoD, dcEventHistoryEntry=dcEventHistoryEntry, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcEqualizeInterval=dcEqualizeInterval, dcPowerLimitationEventName=dcPowerLimitationEventName, dcMeterPanelEventTable=dcMeterPanelEventTable, controllerBasicCompl=controllerBasicCompl, dcControlEventIndex=dcControlEventIndex, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcMeasurementIndex=dcMeasurementIndex, dcMeterPanelEventName=dcMeterPanelEventName, PYSNMP_MODULE_ID=orionBaseMibModule, dcGenericAlarmEntry=dcGenericAlarmEntry, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcPowerLimitationEntry=dcPowerLimitationEntry, dcLowStartTemp=dcLowStartTemp, dcAlarmEntry=dcAlarmEntry, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, powerLimitationTableGroup=powerLimitationTableGroup, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcUaMax=dcUaMax, dcBoostCharge=dcBoostCharge, dcBatteryTestTempTo=dcBatteryTestTempTo, batteryStringTableGroup=batteryStringTableGroup, dcUaMin=dcUaMin, dcUsMax=dcUsMax, dcCurrentLimit=dcCurrentLimit, dcFloatCharge=dcFloatCharge, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcLvdIndex=dcLvdIndex, dcBatteryParameter=dcBatteryParameter, dcTempSupervision=dcTempSupervision, dcRectifierCurrent=dcRectifierCurrent, systemAlarmGroup=systemAlarmGroup, dcSystemVoltage=dcSystemVoltage, dcMaxVoltage=dcMaxVoltage, dcBoostChargeStatus=dcBoostChargeStatus, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcBatteryTestInterval=dcBatteryTestInterval, dcRectifierGroupTable=dcRectifierGroupTable, dcMeasurement=dcMeasurement, dcNumberRectifiers=dcNumberRectifiers, dcRectifierTable=dcRectifierTable, dcTrapDestinationIp=dcTrapDestinationIp, dcMisc=dcMisc, dcBatteryTestControl=dcBatteryTestControl, rectifierGroup=rectifierGroup, dcEqualizeParameter=dcEqualizeParameter, dcBatteryTestUsupport=dcBatteryTestUsupport, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcBatteryStringIndex=dcBatteryStringIndex, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcBatteryTestDateTime=dcBatteryTestDateTime, dcEventProcessingEventName=dcEventProcessingEventName, controllerEvents=controllerEvents, dcEqualizeControl=dcEqualizeControl, dcBatteryTestDuration=dcBatteryTestDuration, dcMeterPanelEventIndex=dcMeterPanelEventIndex, systemNonUrgentAlarm=systemNonUrgentAlarm, systemUrgentAlarm=systemUrgentAlarm, dcEvtCtrlCharge=dcEvtCtrlCharge, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcEventProcessingEventIndex=dcEventProcessingEventIndex, meterPanelEventTableGroup=meterPanelEventTableGroup, rectifierTableGroup=rectifierTableGroup, dcControlEventName=dcControlEventName, dcBatteryTestResults=dcBatteryTestResults, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcAlarmEventCategory=dcAlarmEventCategory, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcUsys20=dcUsys20, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcSystemPower=dcSystemPower, dcLvdTable=dcLvdTable, dcDefaultLogEventTable=dcDefaultLogEventTable, controllerEventObjects=controllerEventObjects, dcSystemDateTime=dcSystemDateTime, dcBoostChargeControl=dcBoostChargeControl, dcSoftwareVersion=dcSoftwareVersion, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcDefaultLogEventName=dcDefaultLogEventName, dcPowerLimitationTable=dcPowerLimitationTable, dcBatteryTestStatus=dcBatteryTestStatus, dcRectifierFunctions=dcRectifierFunctions, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcHysteresis=dcHysteresis, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcBoostChargeType=dcBoostChargeType, dcSystemInfo=dcSystemInfo, controllerObjects=controllerObjects, dcSiteName=dcSiteName, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcFileProcessingStatus=dcFileProcessingStatus, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcBatteryStringCapacity=dcBatteryStringCapacity, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcBoostChargeParameter=dcBoostChargeParameter, dcBatteryTemperature=dcBatteryTemperature, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcSystemMonitor=dcSystemMonitor, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcMeasurementUnit=dcMeasurementUnit, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcBatteryTestResult=dcBatteryTestResult, dcMeasurementTable=dcMeasurementTable, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcAlarmEventName=dcAlarmEventName, dcEqualizeEnabled=dcEqualizeEnabled, dcAlarmIndex=dcAlarmIndex, eventHistoryTableGroup=eventHistoryTableGroup, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcHighTempHyst=dcHighTempHyst)
