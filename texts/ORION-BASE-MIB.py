...
ModuleIdentity, Bits, Unsigned32, ObjectIdentity, MibIdentifier, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Counter64, enterprises, Integer32, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Unsigned32", "ObjectIdentity", "MibIdentifier", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Counter64", "enterprises", "Integer32", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcHighTempSlope=dcHighTempSlope, dcSystemAlarms=dcSystemAlarms, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcTrapDestinationTable=dcTrapDestinationTable, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcMaximumLoadStep=dcMaximumLoadStep, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcRectifierCurrent=dcRectifierCurrent, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcUrgentAlarmValue=dcUrgentAlarmValue, dcPowerLimitationStatus=dcPowerLimitationStatus, dcEqualizeInterval=dcEqualizeInterval, dcEqualizeEnabled=dcEqualizeEnabled, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, controllerConfs=controllerConfs, dcEqualizeParameter=dcEqualizeParameter, rectifierTableGroup=rectifierTableGroup, dcGenericAlarmEventName=dcGenericAlarmEventName, dcBoostChargeControl=dcBoostChargeControl, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcMeterPanel=dcMeterPanel, dcAlarmEventValue=dcAlarmEventValue, dcBatteryTestInterval=dcBatteryTestInterval, dcEventHistoryIndex=dcEventHistoryIndex, orionBaseMibModule=orionBaseMibModule, dcBatteryTestStatus=dcBatteryTestStatus, dcUsMax=dcUsMax, dcStartTemp=dcStartTemp, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcAlarmEntry=dcAlarmEntry, dcTrapDestinationIndex=dcTrapDestinationIndex, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcTempComp=dcTempComp, dcBoostChargeIstop=dcBoostChargeIstop, dcUsys20=dcUsys20, dcSiteName=dcSiteName, dcMeterPanelEventValue=dcMeterPanelEventValue, dcLowTempSlope=dcLowTempSlope, dcMeasurementIndex=dcMeasurementIndex, dcBatteryTestUsupport=dcBatteryTestUsupport, dcSoftwareVersion=dcSoftwareVersion, PYSNMP_MODULE_ID=orionBaseMibModule, dcBatteryTemperature=dcBatteryTemperature, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcUsMin=dcUsMin, dcRectifierGroupIndex=dcRectifierGroupIndex, dcBatteryTestTempTo=dcBatteryTestTempTo, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcHighStartTemp=dcHighStartTemp, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, systemCriticalAlarm=systemCriticalAlarm, dcCurrentLimit=dcCurrentLimit, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcPowerLimitationType=dcPowerLimitationType, dcLvdEntry=dcLvdEntry, measurementTableGroup=measurementTableGroup, dcRectifierFunctions=dcRectifierFunctions, dcBoostChargeIstart=dcBoostChargeIstart, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcRectifierTable=dcRectifierTable, dcLossOfBackupTime=dcLossOfBackupTime, dcBatteryTestDateTime=dcBatteryTestDateTime, dcPowerLimitationLimit=dcPowerLimitationLimit, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcSystemPower=dcSystemPower, batteryGroup=batteryGroup, controlEventTableGroup=controlEventTableGroup, dcAlarmEventCategory=dcAlarmEventCategory, dcMaxVoltage=dcMaxVoltage, dcMainsFailureAlarm=dcMainsFailureAlarm, dcBoD=dcBoD, dcSlope=dcSlope, dcRectifierGroupEntry=dcRectifierGroupEntry, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcBoostChargeVoltage=dcBoostChargeVoltage, dcPowerLimitationIndex=dcPowerLimitationIndex, dcControlEventEntry=dcControlEventEntry, defaultLogEventTableGroup=defaultLogEventTableGroup, dcGenericAlarmIndex=dcGenericAlarmIndex, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcEventProcessingEventSelected=dcEventProcessingEventSelected, systemUrgentAlarm=systemUrgentAlarm, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcEventProcessingEventType=dcEventProcessingEventType, dcHighTempHyst=dcHighTempHyst, dcBatteryTestParameter=dcBatteryTestParameter, dcEqualize=dcEqualize, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcLvdTable=dcLvdTable, dcEventProcessingEventTable=dcEventProcessingEventTable, dcBatteryParameter=dcBatteryParameter, dcMisc=dcMisc, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcTrapDestinationPort=dcTrapDestinationPort, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcEventProcessingEventIndex=dcEventProcessingEventIndex, eventHistoryTableGroup=eventHistoryTableGroup, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBoostChargeType=dcBoostChargeType, controllerObjects=controllerObjects, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcRectifierIndex=dcRectifierIndex, dcMeasurementValue=dcMeasurementValue, dcBatteryTestResults=dcBatteryTestResults, dcExpectedBackupTime=dcExpectedBackupTime, controllerBasicCompl=controllerBasicCompl, dcLowStartTemp=dcLowStartTemp, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, trapDestinationTableGroup=trapDestinationTableGroup, controllerEventsV2=controllerEventsV2, dcBatteryTest=dcBatteryTest, dcPowerLimitationEventName=dcPowerLimitationEventName, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, systemNonUrgentAlarm=systemNonUrgentAlarm, dcLvdName=dcLvdName, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcEventProcessingEventName=dcEventProcessingEventName, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcDefaultLogEventName=dcDefaultLogEventName, dcMeterPanelEventTable=dcMeterPanelEventTable, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcEqualizeStatus=dcEqualizeStatus, dcTrapDestinationEntry=dcTrapDestinationEntry, rectifierGroupTableGroup=rectifierGroupTableGroup, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcSystemName=dcSystemName, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcRectifier=dcRectifier, dcPowerLimitationTable=dcPowerLimitationTable, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcEventHistoryEntry=dcEventHistoryEntry, dcHighTemp=dcHighTemp, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcDefaultLogEventTable=dcDefaultLogEventTable, dcBatteryTestDuration=dcBatteryTestDuration, systemInfoGroup=systemInfoGroup, dcControlEventName=dcControlEventName, dcUaMin=dcUaMin, dcStopTemp=dcStopTemp, dcRectifierEntry=dcRectifierEntry, dcEventHistoryTable=dcEventHistoryTable, dcSystemMonitor=dcSystemMonitor, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcEqualizeLeadTime=dcEqualizeLeadTime, dcGenericAlarmTable=dcGenericAlarmTable, dcInputOutput=dcInputOutput, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, batteryStringTableGroup=batteryStringTableGroup, dcBatteryStringIndex=dcBatteryStringIndex, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcAlarmIndex=dcAlarmIndex, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcEventHistoryMessage=dcEventHistoryMessage, dcTempCompType=dcTempCompType, dcBatteryStringCapacity=dcBatteryStringCapacity, dcMeasurementUnit=dcMeasurementUnit, genericAlarmTableGroup=genericAlarmTableGroup, dcMeasurementTable=dcMeasurementTable, dcSystemInfo=dcSystemInfo, dcBatteryCurrent=dcBatteryCurrent, dcTrapDestinationIp=dcTrapDestinationIp, dcRunawayTemp=dcRunawayTemp, dcEqualizeControl=dcEqualizeControl, alarmTableGroup=alarmTableGroup, controllerEvents=controllerEvents, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcUaMax=dcUaMax, dcEqualizeVoltage=dcEqualizeVoltage, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcControlEventValue=dcControlEventValue, dcSystemDateTime=dcSystemDateTime, meterPanelEventTableGroup=meterPanelEventTableGroup, dcBattery=dcBattery, dcRectifierIdentifier=dcRectifierIdentifier, dcLvdIndex=dcLvdIndex, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, systemMonitorGroup=systemMonitorGroup, notificationsGroup=notificationsGroup, dcCriticalAlarmName=dcCriticalAlarmName, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcHysteresis=dcHysteresis, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcHighStopVoltage=dcHighStopVoltage, dcSystemVoltage=dcSystemVoltage, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcDefaultLogEventEntry=dcDefaultLogEventEntry, lvdTableGroup=lvdTableGroup, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcRectifierStatus=dcRectifierStatus, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcRectifierGroupName=dcRectifierGroupName, miscGroup=miscGroup, dcMeterPanelEventName=dcMeterPanelEventName, dcLowStopVoltage=dcLowStopVoltage, dcUrgentAlarmName=dcUrgentAlarmName, dcChargeState=dcChargeState, dcBoostCharge=dcBoostCharge, dcMinimumLoadStep=dcMinimumLoadStep, dcControlEventIdentifier=dcControlEventIdentifier, dcLoadCurrent=dcLoadCurrent, dcBoostChargeStatus=dcBoostChargeStatus, dcMeasurementName=dcMeasurementName, rectifierGroup=rectifierGroup, controllerEventObjects=controllerEventObjects, dcTempSupervision=dcTempSupervision, dcAlarmTable=dcAlarmTable, dcFloatCharge=dcFloatCharge, dcBatteryTestControl=dcBatteryTestControl, dcPowerLimitation=dcPowerLimitation, dcFileProcessingStatus=dcFileProcessingStatus, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcBoostChargeParameter=dcBoostChargeParameter, dcBatteryTestType=dcBatteryTestType, dcBatteryStringName=dcBatteryStringName, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcMeasurementEntry=dcMeasurementEntry, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcBatteryStringEntry=dcBatteryStringEntry, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcMeasurementScaleFactor=dcMeasurementScaleFactor, systemAlarmGroup=systemAlarmGroup, dcConfig=dcConfig, dcEqualizeDuration=dcEqualizeDuration, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcBatteryTestResult=dcBatteryTestResult, dcMeasurement=dcMeasurement, dcEqualizeTimeLag=dcEqualizeTimeLag, dcAlarmEventName=dcAlarmEventName, dcBatteryStringTable=dcBatteryStringTable, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcRunawayVoltage=dcRunawayVoltage, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcNumberRectifiers=dcNumberRectifiers, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcDefaultLogEventLogged=dcDefaultLogEventLogged, controllerCompl=controllerCompl, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, orionBaseMib=orionBaseMib)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEnableUsTempComp=dcEnableUsTempComp, dcCriticalAlarmValue=dcCriticalAlarmValue, dcRectifierGroupTable=dcRectifierGroupTable, controllerGroups=controllerGroups, dcEvtCtrlCharge=dcEvtCtrlCharge, dcEfficiencyCycling=dcEfficiencyCycling, dcControlEventTable=dcControlEventTable, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcControlEventIndex=dcControlEventIndex, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcPowerLimitationEntry=dcPowerLimitationEntry, dcGenericAlarmEntry=dcGenericAlarmEntry, powerLimitationTableGroup=powerLimitationTableGroup, dcEvtCtrlChargeType=dcEvtCtrlChargeType)
