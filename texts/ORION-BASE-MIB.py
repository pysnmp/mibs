...
ObjectIdentity, Bits, TimeTicks, Counter64, Unsigned32, Gauge32, Integer32, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, NotificationType, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "TimeTicks", "Counter64", "Unsigned32", "Gauge32", "Integer32", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "NotificationType", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcMeasurementIndex=dcMeasurementIndex, dcGenericAlarmEventName=dcGenericAlarmEventName, dcExpectedBackupTime=dcExpectedBackupTime, dcCriticalAlarmValue=dcCriticalAlarmValue, dcUsys20=dcUsys20, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcRectifierEntry=dcRectifierEntry, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcRectifierTable=dcRectifierTable, dcSystemPower=dcSystemPower, dcUaMin=dcUaMin, dcBatteryTestUsupport=dcBatteryTestUsupport, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcBoostChargeParameter=dcBoostChargeParameter, dcGenericAlarmIndex=dcGenericAlarmIndex, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcUrgentAlarmName=dcUrgentAlarmName, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcEqualizeLeadTime=dcEqualizeLeadTime, dcEqualizeParameter=dcEqualizeParameter, dcBattery=dcBattery, dcBoostChargeControl=dcBoostChargeControl, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcEventProcessingEventTable=dcEventProcessingEventTable, notificationsGroup=notificationsGroup, dcRectifierGroupName=dcRectifierGroupName, dcTrapDestinationEntry=dcTrapDestinationEntry, dcAlarmTable=dcAlarmTable, dcRectifierIndex=dcRectifierIndex, dcSlope=dcSlope, dcControlEventName=dcControlEventName, dcBatteryParameter=dcBatteryParameter, dcCurrentLimit=dcCurrentLimit, dcBatteryStringEntry=dcBatteryStringEntry, meterPanelEventTableGroup=meterPanelEventTableGroup, dcSystemName=dcSystemName, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcAlarmEntry=dcAlarmEntry, dcEvtCtrlCharge=dcEvtCtrlCharge, dcMeasurementUnit=dcMeasurementUnit, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, controllerObjects=controllerObjects, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcPowerLimitationEventName=dcPowerLimitationEventName, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcAlarmIndex=dcAlarmIndex, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcBatteryTemperature=dcBatteryTemperature, genericAlarmTableGroup=genericAlarmTableGroup, dcEqualizeDuration=dcEqualizeDuration, dcEqualize=dcEqualize, dcPowerLimitationIndex=dcPowerLimitationIndex, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, miscGroup=miscGroup, dcPowerLimitationLimit=dcPowerLimitationLimit, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, trapDestinationTableGroup=trapDestinationTableGroup, dcUsMin=dcUsMin, dcLowStopVoltage=dcLowStopVoltage, systemNonUrgentAlarm=systemNonUrgentAlarm, dcTempCompType=dcTempCompType, dcDefaultLogEventTable=dcDefaultLogEventTable, dcBoD=dcBoD, dcBatteryTestType=dcBatteryTestType, dcRectifierFunctions=dcRectifierFunctions, dcMeasurementName=dcMeasurementName, eventHistoryTableGroup=eventHistoryTableGroup, dcBoostChargeIstart=dcBoostChargeIstart, dcTempComp=dcTempComp, dcUsMax=dcUsMax, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcRectifierGroupIndex=dcRectifierGroupIndex, dcLoadCurrent=dcLoadCurrent, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcStartTemp=dcStartTemp, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, controlEventTableGroup=controlEventTableGroup, dcBatteryTestDateTime=dcBatteryTestDateTime, dcPowerLimitationTable=dcPowerLimitationTable, dcAlarmEventIdentifier=dcAlarmEventIdentifier, batteryGroup=batteryGroup, dcSystemAlarms=dcSystemAlarms, systemUrgentAlarm=systemUrgentAlarm, dcGenericAlarmEntry=dcGenericAlarmEntry, PYSNMP_MODULE_ID=orionBaseMibModule, dcNumberRectifiers=dcNumberRectifiers, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcEqualizeTimeLag=dcEqualizeTimeLag, dcHysteresis=dcHysteresis, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, defaultLogEventTableGroup=defaultLogEventTableGroup, dcControlEventTable=dcControlEventTable, dcHighTempSlope=dcHighTempSlope, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcRectifierCurrent=dcRectifierCurrent, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBatteryTestStatus=dcBatteryTestStatus, dcMaximumLoadStep=dcMaximumLoadStep, dcFileProcessingStatus=dcFileProcessingStatus, dcBoostCharge=dcBoostCharge, dcBatteryTest=dcBatteryTest, dcRectifierGroupTable=dcRectifierGroupTable, dcTempSupervision=dcTempSupervision, dcBatteryTestControl=dcBatteryTestControl, dcAlarmEventCategory=dcAlarmEventCategory, dcLvdIndex=dcLvdIndex, lvdTableGroup=lvdTableGroup, dcUaMax=dcUaMax, dcPowerLimitationEntry=dcPowerLimitationEntry, dcBatteryTestResult=dcBatteryTestResult, dcHighTemp=dcHighTemp, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcSystemInfo=dcSystemInfo, dcMeterPanelEventTable=dcMeterPanelEventTable, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcRectifierStatus=dcRectifierStatus, dcMeasurementValue=dcMeasurementValue, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcPowerLimitationStatus=dcPowerLimitationStatus, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcSystemMonitor=dcSystemMonitor, dcControlEventValue=dcControlEventValue, dcMeasurement=dcMeasurement, dcMeterPanelEventValue=dcMeterPanelEventValue, dcAlarmEventValue=dcAlarmEventValue, rectifierGroup=rectifierGroup, measurementTableGroup=measurementTableGroup, dcControlEventIndex=dcControlEventIndex, dcControlEventEntry=dcControlEventEntry, dcFloatCharge=dcFloatCharge, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcTrapDestinationPort=dcTrapDestinationPort, dcRectifierGroupEntry=dcRectifierGroupEntry, dcMeasurementEntry=dcMeasurementEntry, orionBaseMib=orionBaseMib, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcUrgentAlarmValue=dcUrgentAlarmValue, rectifierTableGroup=rectifierTableGroup, dcHighStartTemp=dcHighStartTemp, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcInputOutput=dcInputOutput, controllerEventsV2=controllerEventsV2, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcBatteryStringIndex=dcBatteryStringIndex, dcMaxVoltage=dcMaxVoltage, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcEqualizeControl=dcEqualizeControl, dcEqualizeInterval=dcEqualizeInterval, dcSystemVoltage=dcSystemVoltage, dcEventProcessingEventName=dcEventProcessingEventName, systemInfoGroup=systemInfoGroup, dcPowerLimitation=dcPowerLimitation, dcEventHistoryMessage=dcEventHistoryMessage, dcBatteryTestResults=dcBatteryTestResults, dcMinimumLoadStep=dcMinimumLoadStep, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcDefaultLogEventName=dcDefaultLogEventName, dcEfficiencyCycling=dcEfficiencyCycling, dcRunawayVoltage=dcRunawayVoltage, dcBatteryTestTempTo=dcBatteryTestTempTo, dcBoostChargeType=dcBoostChargeType, dcMeterPanel=dcMeterPanel, dcRectifierIdentifier=dcRectifierIdentifier, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcEnableUsTempComp=dcEnableUsTempComp, dcEventHistoryTable=dcEventHistoryTable, dcGenericAlarmTable=dcGenericAlarmTable, dcBoostChargeStatus=dcBoostChargeStatus, dcHighStopVoltage=dcHighStopVoltage, dcEventProcessingEventType=dcEventProcessingEventType, dcRectifier=dcRectifier, dcCriticalAlarmName=dcCriticalAlarmName, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcRunawayTemp=dcRunawayTemp, dcBatteryTestParameter=dcBatteryTestParameter, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcControlEventIdentifier=dcControlEventIdentifier, dcBatteryStringTable=dcBatteryStringTable, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcHighTempHyst=dcHighTempHyst, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcLvdTable=dcLvdTable, dcBoostChargeIstop=dcBoostChargeIstop, dcAlarmEventName=dcAlarmEventName, dcMisc=dcMisc, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcMeterPanelEventName=dcMeterPanelEventName, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcConfig=dcConfig, dcBatteryStringCapacity=dcBatteryStringCapacity, dcMeasurementTable=dcMeasurementTable, dcChargeState=dcChargeState, dcMainsFailureAlarm=dcMainsFailureAlarm, dcLvdName=dcLvdName, dcBatteryCurrent=dcBatteryCurrent, dcTrapDestinationIp=dcTrapDestinationIp, dcLvdEntry=dcLvdEntry, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, alarmTableGroup=alarmTableGroup, dcTrapDestinationIndex=dcTrapDestinationIndex, systemMonitorGroup=systemMonitorGroup, dcStopTemp=dcStopTemp, eventProcessingEventTableGroup=eventProcessingEventTableGroup, batteryStringTableGroup=batteryStringTableGroup, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcEqualizeEnabled=dcEqualizeEnabled, orionBaseMibModule=orionBaseMibModule, dcSystemDateTime=dcSystemDateTime, controllerConfs=controllerConfs, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcBoostChargeVoltage=dcBoostChargeVoltage, dcLowTempSlope=dcLowTempSlope, dcEventHistoryEntry=dcEventHistoryEntry, powerLimitationTableGroup=powerLimitationTableGroup, dcEqualizeVoltage=dcEqualizeVoltage, controllerBasicCompl=controllerBasicCompl, systemCriticalAlarm=systemCriticalAlarm, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, controllerEvents=controllerEvents, dcEventHistoryIndex=dcEventHistoryIndex, dcEqualizeStatus=dcEqualizeStatus, controllerGroups=controllerGroups, dcSiteName=dcSiteName, dcPowerLimitationType=dcPowerLimitationType, dcTrapDestinationTable=dcTrapDestinationTable, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, systemAlarmGroup=systemAlarmGroup, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcBatteryTestDuration=dcBatteryTestDuration)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, controllerEventObjects=controllerEventObjects, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcSoftwareVersion=dcSoftwareVersion, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcLowStartTemp=dcLowStartTemp, dcBatteryStringName=dcBatteryStringName, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcLossOfBackupTime=dcLossOfBackupTime, dcBatteryTestInterval=dcBatteryTestInterval, rectifierGroupTableGroup=rectifierGroupTableGroup, controllerCompl=controllerCompl)
