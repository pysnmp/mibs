...
NotificationType, Counter32, IpAddress, Unsigned32, iso, TimeTicks, enterprises, Gauge32, MibIdentifier, Bits, Counter64, Integer32, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "IpAddress", "Unsigned32", "iso", "TimeTicks", "enterprises", "Gauge32", "MibIdentifier", "Bits", "Counter64", "Integer32", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", systemCriticalAlarm=systemCriticalAlarm, dcEqualizeStatus=dcEqualizeStatus, dcUrgentAlarmValue=dcUrgentAlarmValue, dcBoostChargeVoltage=dcBoostChargeVoltage, dcTempComp=dcTempComp, dcRunawayVoltage=dcRunawayVoltage, dcAlarmEventIdentifier=dcAlarmEventIdentifier, miscGroup=miscGroup, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, controllerEventsV2=controllerEventsV2, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcLoadCurrent=dcLoadCurrent, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, systemUrgentAlarm=systemUrgentAlarm, dcBatteryTemperature=dcBatteryTemperature, dcBoostChargeIstop=dcBoostChargeIstop, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, controllerCompl=controllerCompl, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcMeasurementEntry=dcMeasurementEntry, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcMeasurement=dcMeasurement, dcMeterPanelEventTable=dcMeterPanelEventTable, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcLossOfBackupTime=dcLossOfBackupTime, dcBoostCharge=dcBoostCharge, dcRectifierGroupName=dcRectifierGroupName, dcHighTempHyst=dcHighTempHyst, orionBaseMib=orionBaseMib, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcRectifierGroupIndex=dcRectifierGroupIndex, dcEqualizeEnabled=dcEqualizeEnabled, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcRectifierEntry=dcRectifierEntry, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcPowerLimitationLimit=dcPowerLimitationLimit, dcControlEventTable=dcControlEventTable, dcBatteryTestInterval=dcBatteryTestInterval, dcMeasurementValue=dcMeasurementValue, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcCriticalAlarmValue=dcCriticalAlarmValue, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcGenericAlarmEntry=dcGenericAlarmEntry, dcTrapDestinationIp=dcTrapDestinationIp, dcAlarmEventCategory=dcAlarmEventCategory, orionBaseMibModule=orionBaseMibModule, dcSystemVoltage=dcSystemVoltage, eventProcessingEventTableGroup=eventProcessingEventTableGroup, controllerEvents=controllerEvents, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcAlarmTable=dcAlarmTable, dcMainsFailureAlarm=dcMainsFailureAlarm, dcBatteryTest=dcBatteryTest, dcUaMin=dcUaMin, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcPowerLimitationType=dcPowerLimitationType, systemAlarmGroup=systemAlarmGroup, eventHistoryTableGroup=eventHistoryTableGroup, dcMeasurementName=dcMeasurementName, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcEventHistoryTable=dcEventHistoryTable, dcBattery=dcBattery, dcTrapDestinationPort=dcTrapDestinationPort, dcEqualize=dcEqualize, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcMaximumLoadStep=dcMaximumLoadStep, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcBatteryTestStatus=dcBatteryTestStatus, dcGenericAlarmEventName=dcGenericAlarmEventName, dcDefaultLogEventName=dcDefaultLogEventName, dcBatteryStringCapacity=dcBatteryStringCapacity, dcBatteryTestDuration=dcBatteryTestDuration, dcEqualizeInterval=dcEqualizeInterval, dcBatteryParameter=dcBatteryParameter, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcEventProcessingEventType=dcEventProcessingEventType, batteryGroup=batteryGroup, dcTrapDestinationEntry=dcTrapDestinationEntry, dcMisc=dcMisc, dcMeterPanelEventValue=dcMeterPanelEventValue, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcSiteName=dcSiteName, dcStartTemp=dcStartTemp, dcEventHistoryIndex=dcEventHistoryIndex, dcBoostChargeIstart=dcBoostChargeIstart, dcMeterPanelEventName=dcMeterPanelEventName, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcControlEventEntry=dcControlEventEntry, dcRectifierTable=dcRectifierTable, dcBatteryCurrent=dcBatteryCurrent, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcSystemAlarms=dcSystemAlarms, meterPanelEventTableGroup=meterPanelEventTableGroup, dcEventProcessingEventIndex=dcEventProcessingEventIndex, alarmTableGroup=alarmTableGroup, dcRectifierCurrent=dcRectifierCurrent, dcRectifierIdentifier=dcRectifierIdentifier, controllerConfs=controllerConfs, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcBoD=dcBoD, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcNumberRectifiers=dcNumberRectifiers, dcSystemInfo=dcSystemInfo, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcMeasurementUnit=dcMeasurementUnit, dcTempSupervision=dcTempSupervision, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcSystemDateTime=dcSystemDateTime, dcTempCompType=dcTempCompType, dcEqualizeLeadTime=dcEqualizeLeadTime, dcLvdIndex=dcLvdIndex, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, controllerObjects=controllerObjects, dcBoostChargeType=dcBoostChargeType, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, lvdTableGroup=lvdTableGroup, controllerGroups=controllerGroups, dcBoostChargeParameter=dcBoostChargeParameter, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcEventHistoryMessage=dcEventHistoryMessage, dcAlarmIndex=dcAlarmIndex, dcSlope=dcSlope, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcEqualizeTimeLag=dcEqualizeTimeLag, dcBatteryStringName=dcBatteryStringName, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcRectifier=dcRectifier, defaultLogEventTableGroup=defaultLogEventTableGroup, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcEnableUsTempComp=dcEnableUsTempComp, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcAlarmEventName=dcAlarmEventName, dcBoostChargeStatus=dcBoostChargeStatus, rectifierGroup=rectifierGroup, powerLimitationTableGroup=powerLimitationTableGroup, dcBatteryTestTempTo=dcBatteryTestTempTo, dcTrapDestinationTable=dcTrapDestinationTable, dcMeasurementTable=dcMeasurementTable, dcRunawayTemp=dcRunawayTemp, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcChargeState=dcChargeState, dcUsMin=dcUsMin, dcStopTemp=dcStopTemp, dcBatteryTestControl=dcBatteryTestControl, dcBatteryTestDateTime=dcBatteryTestDateTime, dcLowTempSlope=dcLowTempSlope, dcUsMax=dcUsMax, dcRectifierGroupEntry=dcRectifierGroupEntry, dcEventProcessingEventName=dcEventProcessingEventName, dcCurrentLimit=dcCurrentLimit, dcLowStopVoltage=dcLowStopVoltage, dcFloatCharge=dcFloatCharge, dcExpectedBackupTime=dcExpectedBackupTime, rectifierGroupTableGroup=rectifierGroupTableGroup, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcPowerLimitationEventName=dcPowerLimitationEventName, dcHighTemp=dcHighTemp, measurementTableGroup=measurementTableGroup, controllerBasicCompl=controllerBasicCompl, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcLvdName=dcLvdName, dcRectifierIndex=dcRectifierIndex, dcBatteryTestResult=dcBatteryTestResult, dcGenericAlarmTable=dcGenericAlarmTable, dcEfficiencyCycling=dcEfficiencyCycling, dcLvdEntry=dcLvdEntry, dcHighTempSlope=dcHighTempSlope, dcSoftwareVersion=dcSoftwareVersion, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcControlEventValue=dcControlEventValue, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcLowStartTemp=dcLowStartTemp, dcDefaultLogEventTable=dcDefaultLogEventTable, dcAlarmEventValue=dcAlarmEventValue, dcAlarmEntry=dcAlarmEntry, systemMonitorGroup=systemMonitorGroup, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, trapDestinationTableGroup=trapDestinationTableGroup, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcHighStartTemp=dcHighStartTemp, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcControlEventName=dcControlEventName, dcGenericAlarmIndex=dcGenericAlarmIndex, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcEventProcessingEventTable=dcEventProcessingEventTable, dcPowerLimitation=dcPowerLimitation, dcMeterPanel=dcMeterPanel, dcBatteryTestUsupport=dcBatteryTestUsupport, systemNonUrgentAlarm=systemNonUrgentAlarm, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcEventHistoryEntry=dcEventHistoryEntry, PYSNMP_MODULE_ID=orionBaseMibModule, dcSystemName=dcSystemName, dcEvtCtrlCharge=dcEvtCtrlCharge, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcHysteresis=dcHysteresis, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcCriticalAlarmName=dcCriticalAlarmName, rectifierTableGroup=rectifierTableGroup, dcBatteryStringIndex=dcBatteryStringIndex, dcControlEventIndex=dcControlEventIndex, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcSystemPower=dcSystemPower, dcUrgentAlarmName=dcUrgentAlarmName, dcBatteryTestResults=dcBatteryTestResults, dcUaMax=dcUaMax, dcInputOutput=dcInputOutput, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcPowerLimitationIndex=dcPowerLimitationIndex, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, systemInfoGroup=systemInfoGroup, dcBatteryTestParameter=dcBatteryTestParameter, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, genericAlarmTableGroup=genericAlarmTableGroup, dcTrapDestinationIndex=dcTrapDestinationIndex, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcBatteryTestType=dcBatteryTestType, dcRectifierFunctions=dcRectifierFunctions, dcEqualizeDuration=dcEqualizeDuration, dcConfig=dcConfig, dcPowerLimitationStatus=dcPowerLimitationStatus, dcControlEventIdentifier=dcControlEventIdentifier, notificationsGroup=notificationsGroup, batteryStringTableGroup=batteryStringTableGroup, dcHighStopVoltage=dcHighStopVoltage, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcRectifierGroupTable=dcRectifierGroupTable, dcLvdTable=dcLvdTable, dcBatteryStringEntry=dcBatteryStringEntry, dcBatteryStringTable=dcBatteryStringTable, dcFileProcessingStatus=dcFileProcessingStatus, dcPowerLimitationTable=dcPowerLimitationTable, dcSystemMonitor=dcSystemMonitor, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus)
mibBuilder.exportSymbols("ORION-BASE-MIB", controlEventTableGroup=controlEventTableGroup, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcEqualizeControl=dcEqualizeControl, dcEqualizeVoltage=dcEqualizeVoltage, dcMeasurementIndex=dcMeasurementIndex, dcBoostChargeControl=dcBoostChargeControl, dcEqualizeParameter=dcEqualizeParameter, dcMaxVoltage=dcMaxVoltage, dcRectifierStatus=dcRectifierStatus, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcMinimumLoadStep=dcMinimumLoadStep, controllerEventObjects=controllerEventObjects, dcUsys20=dcUsys20, dcPowerLimitationEntry=dcPowerLimitationEntry)
