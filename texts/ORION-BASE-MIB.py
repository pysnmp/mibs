...
Bits, Unsigned32, TimeTicks, NotificationType, Counter32, Counter64, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, iso, Gauge32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "TimeTicks", "NotificationType", "Counter32", "Counter64", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "iso", "Gauge32", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcFloatCharge=dcFloatCharge, dcEventHistoryTimestamp=dcEventHistoryTimestamp, systemInfoGroup=systemInfoGroup, defaultLogEventTableGroup=defaultLogEventTableGroup, dcRectifierEntry=dcRectifierEntry, dcEventHistoryTable=dcEventHistoryTable, dcControlEventIndex=dcControlEventIndex, dcLowStopVoltage=dcLowStopVoltage, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcPowerLimitationStatus=dcPowerLimitationStatus, dcEvtCtrlCharge=dcEvtCtrlCharge, dcBatteryStringTable=dcBatteryStringTable, meterPanelEventTableGroup=meterPanelEventTableGroup, dcPowerLimitation=dcPowerLimitation, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcEventHistoryIndex=dcEventHistoryIndex, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcBatteryTestTempTo=dcBatteryTestTempTo, dcGenericAlarmEntry=dcGenericAlarmEntry, dcSystemDateTime=dcSystemDateTime, dcBattery=dcBattery, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcLowTempSlope=dcLowTempSlope, dcInputOutput=dcInputOutput, dcBatteryTestDuration=dcBatteryTestDuration, dcUsMin=dcUsMin, dcEventHistoryEntry=dcEventHistoryEntry, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcTrapDestinationPort=dcTrapDestinationPort, rectifierGroupTableGroup=rectifierGroupTableGroup, dcEqualizeEnabled=dcEqualizeEnabled, dcEventProcessingEventTable=dcEventProcessingEventTable, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcAlarmEventCategory=dcAlarmEventCategory, dcGenericAlarmEventName=dcGenericAlarmEventName, dcUsMax=dcUsMax, dcEqualizeTimeLag=dcEqualizeTimeLag, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcEqualizeStatus=dcEqualizeStatus, dcHysteresis=dcHysteresis, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcUsys20=dcUsys20, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, systemUrgentAlarm=systemUrgentAlarm, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcLowStartTemp=dcLowStartTemp, dcSystemAlarms=dcSystemAlarms, dcBatteryTestResults=dcBatteryTestResults, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcRunawayVoltage=dcRunawayVoltage, dcAlarmEntry=dcAlarmEntry, dcPowerLimitationIndex=dcPowerLimitationIndex, dcDefaultLogEventTable=dcDefaultLogEventTable, dcEfficiencyCycling=dcEfficiencyCycling, dcLvdName=dcLvdName, dcMeterPanelEventTable=dcMeterPanelEventTable, batteryGroup=batteryGroup, controlEventTableGroup=controlEventTableGroup, dcNumberRectifiers=dcNumberRectifiers, orionBaseMibModule=orionBaseMibModule, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcSystemInfo=dcSystemInfo, orionBaseMib=orionBaseMib, dcControlEventEntry=dcControlEventEntry, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcGenericAlarmIndex=dcGenericAlarmIndex, dcControlEventValue=dcControlEventValue, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcSiteName=dcSiteName, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcConfig=dcConfig, dcRectifierGroupIndex=dcRectifierGroupIndex, controllerConfs=controllerConfs, dcEqualize=dcEqualize, dcCriticalAlarmName=dcCriticalAlarmName, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcMeasurementName=dcMeasurementName, rectifierTableGroup=rectifierTableGroup, dcBatteryTestControl=dcBatteryTestControl, alarmTableGroup=alarmTableGroup, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcBatteryStringName=dcBatteryStringName, dcMeasurementUnit=dcMeasurementUnit, lvdTableGroup=lvdTableGroup, dcControlEventIdentifier=dcControlEventIdentifier, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, systemNonUrgentAlarm=systemNonUrgentAlarm, dcBatteryTestType=dcBatteryTestType, dcBatteryStringIndex=dcBatteryStringIndex, dcTempSupervision=dcTempSupervision, controllerEventsV2=controllerEventsV2, dcEqualizeControl=dcEqualizeControl, systemMonitorGroup=systemMonitorGroup, dcBatteryTestDateTime=dcBatteryTestDateTime, dcBatteryParameter=dcBatteryParameter, dcEqualizeParameter=dcEqualizeParameter, controllerObjects=controllerObjects, dcBoostCharge=dcBoostCharge, dcEqualizeDuration=dcEqualizeDuration, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcRectifierIndex=dcRectifierIndex, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcTempComp=dcTempComp, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcHighStopVoltage=dcHighStopVoltage, dcSystemName=dcSystemName, dcBoostChargeIstop=dcBoostChargeIstop, dcTrapDestinationEntry=dcTrapDestinationEntry, dcUaMax=dcUaMax, dcStartTemp=dcStartTemp, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcMeasurementValue=dcMeasurementValue, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcRectifierGroupTable=dcRectifierGroupTable, dcEventProcessingEventName=dcEventProcessingEventName, dcMeasurementTable=dcMeasurementTable, dcTrapDestinationIndex=dcTrapDestinationIndex, systemCriticalAlarm=systemCriticalAlarm, miscGroup=miscGroup, dcCurrentLimit=dcCurrentLimit, dcSystemPower=dcSystemPower, dcTrapDestinationIp=dcTrapDestinationIp, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcFileProcessingStatus=dcFileProcessingStatus, dcMeterPanelEventName=dcMeterPanelEventName, dcRectifierTable=dcRectifierTable, dcCriticalAlarmValue=dcCriticalAlarmValue, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcEventProcessingEventType=dcEventProcessingEventType, trapDestinationTableGroup=trapDestinationTableGroup, dcBatteryCurrent=dcBatteryCurrent, dcSystemMonitor=dcSystemMonitor, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcTrapDestinationTable=dcTrapDestinationTable, eventHistoryTableGroup=eventHistoryTableGroup, dcAlarmEventValue=dcAlarmEventValue, dcPowerLimitationEntry=dcPowerLimitationEntry, dcUrgentAlarmValue=dcUrgentAlarmValue, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcBatteryTestUsupport=dcBatteryTestUsupport, dcExpectedBackupTime=dcExpectedBackupTime, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcPowerLimitationType=dcPowerLimitationType, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcMaxVoltage=dcMaxVoltage, genericAlarmTableGroup=genericAlarmTableGroup, dcBoostChargeParameter=dcBoostChargeParameter, controllerGroups=controllerGroups, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcRectifier=dcRectifier, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcBoD=dcBoD, dcRectifierGroupEntry=dcRectifierGroupEntry, dcMeasurement=dcMeasurement, dcLossOfBackupTime=dcLossOfBackupTime, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcUaMin=dcUaMin, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcMisc=dcMisc, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcControlEventName=dcControlEventName, dcBatteryTestStatus=dcBatteryTestStatus, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, measurementTableGroup=measurementTableGroup, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcLoadCurrent=dcLoadCurrent, dcUrgentAlarmName=dcUrgentAlarmName, dcBatteryStringEntry=dcBatteryStringEntry, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcLvdTable=dcLvdTable, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcBatteryTest=dcBatteryTest, dcMainsFailureAlarm=dcMainsFailureAlarm, dcBoostChargeStatus=dcBoostChargeStatus, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcRectifierGroupName=dcRectifierGroupName, dcDefaultLogEventEntry=dcDefaultLogEventEntry, batteryStringTableGroup=batteryStringTableGroup, systemAlarmGroup=systemAlarmGroup, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, rectifierGroup=rectifierGroup, dcBoostChargeIstart=dcBoostChargeIstart, dcSlope=dcSlope, dcPowerLimitationTable=dcPowerLimitationTable, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcHighTempSlope=dcHighTempSlope, dcEnableUsTempComp=dcEnableUsTempComp, dcGenericAlarmTable=dcGenericAlarmTable, dcEqualizeInterval=dcEqualizeInterval, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcMeasurementEntry=dcMeasurementEntry, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcAlarmTable=dcAlarmTable, powerLimitationTableGroup=powerLimitationTableGroup, dcBoostChargeTimeLag=dcBoostChargeTimeLag, PYSNMP_MODULE_ID=orionBaseMibModule, dcRunawayTemp=dcRunawayTemp, dcLvdIndex=dcLvdIndex, dcPowerLimitationEventName=dcPowerLimitationEventName, dcAlarmEventName=dcAlarmEventName, dcEventHistoryMessage=dcEventHistoryMessage, dcPowerLimitationLimit=dcPowerLimitationLimit, dcRectifierCurrent=dcRectifierCurrent, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcSystemVoltage=dcSystemVoltage, dcMaximumLoadStep=dcMaximumLoadStep, dcBoostChargeVoltage=dcBoostChargeVoltage, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcStopTemp=dcStopTemp, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcAlarmIndex=dcAlarmIndex, dcControlEventTable=dcControlEventTable, dcEqualizeVoltage=dcEqualizeVoltage, dcTempCompType=dcTempCompType, dcHighStartTemp=dcHighStartTemp, dcRectifierFunctions=dcRectifierFunctions, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcHighTempHyst=dcHighTempHyst, dcMinimumLoadStep=dcMinimumLoadStep, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcBatteryTestInterval=dcBatteryTestInterval, dcMeterPanelEventValue=dcMeterPanelEventValue, controllerBasicCompl=controllerBasicCompl, dcChargeState=dcChargeState, controllerEvents=controllerEvents, dcSoftwareVersion=dcSoftwareVersion, controllerEventObjects=controllerEventObjects, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcEqualizeLeadTime=dcEqualizeLeadTime, dcBatteryTestParameter=dcBatteryTestParameter, dcBatteryTestResult=dcBatteryTestResult, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, controllerCompl=controllerCompl, dcBatteryTemperature=dcBatteryTemperature, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcMeasurementIndex=dcMeasurementIndex, dcHighTemp=dcHighTemp, dcRectifierStatus=dcRectifierStatus, dcLvdEntry=dcLvdEntry, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcRectifierIdentifier=dcRectifierIdentifier, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcBatteryStringCapacity=dcBatteryStringCapacity, notificationsGroup=notificationsGroup, dcBoostChargeType=dcBoostChargeType, dcDefaultLogEventName=dcDefaultLogEventName, dcMeterPanel=dcMeterPanel, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcBoostChargeControl=dcBoostChargeControl)
