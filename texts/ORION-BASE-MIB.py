...
iso, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Bits, enterprises, Counter64, NotificationType, Unsigned32, IpAddress, Integer32, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Bits", "enterprises", "Counter64", "NotificationType", "Unsigned32", "IpAddress", "Integer32", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcSystemAlarms=dcSystemAlarms, dcBatteryTestInterval=dcBatteryTestInterval, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, systemAlarmGroup=systemAlarmGroup, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcControlEventTable=dcControlEventTable, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcBoD=dcBoD, dcRectifierGroupIndex=dcRectifierGroupIndex, dcEqualizeParameter=dcEqualizeParameter, dcControlEventName=dcControlEventName, dcSystemDateTime=dcSystemDateTime, dcUrgentAlarmName=dcUrgentAlarmName, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcFloatCharge=dcFloatCharge, dcLowStopVoltage=dcLowStopVoltage, dcEventHistoryIndex=dcEventHistoryIndex, dcMeterPanelEventTable=dcMeterPanelEventTable, controllerGroups=controllerGroups, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcMeterPanelEventValue=dcMeterPanelEventValue, orionBaseMibModule=orionBaseMibModule, measurementTableGroup=measurementTableGroup, dcMeasurementUnit=dcMeasurementUnit, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcLvdName=dcLvdName, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcRectifierEntry=dcRectifierEntry, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcPowerLimitationEventName=dcPowerLimitationEventName, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcDefaultLogEventIndex=dcDefaultLogEventIndex, orionBaseMib=orionBaseMib, dcRectifierGroupEntry=dcRectifierGroupEntry, dcHysteresis=dcHysteresis, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcPowerLimitationTable=dcPowerLimitationTable, dcRectifierStatus=dcRectifierStatus, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcStopTemp=dcStopTemp, dcTempCompType=dcTempCompType, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcBatteryParameter=dcBatteryParameter, controllerCompl=controllerCompl, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcControlEventIdentifier=dcControlEventIdentifier, dcChargeState=dcChargeState, rectifierGroup=rectifierGroup, dcMainsFailureAlarm=dcMainsFailureAlarm, dcTrapDestinationEntry=dcTrapDestinationEntry, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcMaximumLoadStep=dcMaximumLoadStep, dcUrgentAlarmValue=dcUrgentAlarmValue, dcMeterPanel=dcMeterPanel, dcSystemVoltage=dcSystemVoltage, dcEventHistoryEntry=dcEventHistoryEntry, dcGenericAlarmEventName=dcGenericAlarmEventName, batteryGroup=batteryGroup, dcEqualizeLeadTime=dcEqualizeLeadTime, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcRunawayTemp=dcRunawayTemp, dcBoostChargeParameter=dcBoostChargeParameter, dcEqualizeTimeLag=dcEqualizeTimeLag, dcFileProcessingStatus=dcFileProcessingStatus, controllerEventsV2=controllerEventsV2, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcTrapDestinationIp=dcTrapDestinationIp, dcMeasurementTable=dcMeasurementTable, systemUrgentAlarm=systemUrgentAlarm, dcNumberRectifiersFailure=dcNumberRectifiersFailure, powerLimitationTableGroup=powerLimitationTableGroup, dcLimitSwitchingTimes=dcLimitSwitchingTimes, controllerBasicCompl=controllerBasicCompl, dcMeterPanelEventName=dcMeterPanelEventName, dcGenericAlarmEventValue=dcGenericAlarmEventValue, systemCriticalAlarm=systemCriticalAlarm, dcPowerLimitationEntry=dcPowerLimitationEntry, dcBoostChargeTimeLag=dcBoostChargeTimeLag, eventHistoryTableGroup=eventHistoryTableGroup, dcRectifier=dcRectifier, dcDefaultLogEventName=dcDefaultLogEventName, dcBoostChargeType=dcBoostChargeType, dcUsMin=dcUsMin, dcAlarmIndex=dcAlarmIndex, controlEventTableGroup=controlEventTableGroup, dcBatteryStringCapacity=dcBatteryStringCapacity, miscGroup=miscGroup, defaultLogEventTableGroup=defaultLogEventTableGroup, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcEventHistoryMessage=dcEventHistoryMessage, dcEqualizeDuration=dcEqualizeDuration, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcRectifierIndex=dcRectifierIndex, dcMeasurementName=dcMeasurementName, dcCriticalAlarmName=dcCriticalAlarmName, dcInputOutput=dcInputOutput, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcRunawayVoltage=dcRunawayVoltage, dcEqualizeEnabled=dcEqualizeEnabled, dcAlarmEventCategory=dcAlarmEventCategory, controllerEventObjects=controllerEventObjects, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcBatteryTestType=dcBatteryTestType, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, systemMonitorGroup=systemMonitorGroup, dcEqualizeControl=dcEqualizeControl, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcDefaultLogEventTable=dcDefaultLogEventTable, dcEfficiencyCycling=dcEfficiencyCycling, dcPowerLimitationType=dcPowerLimitationType, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcLossOfBackupTime=dcLossOfBackupTime, dcMisc=dcMisc, dcExpectedBackupTime=dcExpectedBackupTime, lvdTableGroup=lvdTableGroup, dcEqualize=dcEqualize, dcBatteryTestDuration=dcBatteryTestDuration, dcBoostCharge=dcBoostCharge, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcLowStartTemp=dcLowStartTemp, dcBatteryTestParameter=dcBatteryTestParameter, dcLvdIndex=dcLvdIndex, dcAlarmEventName=dcAlarmEventName, dcHighTempSlope=dcHighTempSlope, dcSystemPower=dcSystemPower, dcMeasurementIndex=dcMeasurementIndex, dcControlEventIndex=dcControlEventIndex, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcLowTempSlope=dcLowTempSlope, dcSystemName=dcSystemName, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcCurrentLimit=dcCurrentLimit, dcUaMax=dcUaMax, dcPowerLimitation=dcPowerLimitation, dcBatteryTestUsupport=dcBatteryTestUsupport, controllerObjects=controllerObjects, dcLvdTable=dcLvdTable, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcBatteryTestControl=dcBatteryTestControl, dcControlEventValue=dcControlEventValue, dcSiteName=dcSiteName, dcGenericAlarmTable=dcGenericAlarmTable, dcBoostChargeStatus=dcBoostChargeStatus, dcTempComp=dcTempComp, dcPowerLimitationIndex=dcPowerLimitationIndex, dcHighTemp=dcHighTemp, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcUsys20=dcUsys20, dcSystemMonitor=dcSystemMonitor, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcLoadCurrent=dcLoadCurrent, dcSlope=dcSlope, dcBatteryTest=dcBatteryTest, dcBatteryTestResults=dcBatteryTestResults, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBatteryTemperature=dcBatteryTemperature, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcBatteryTestResult=dcBatteryTestResult, dcAlarmEventValue=dcAlarmEventValue, dcTrapDestinationTable=dcTrapDestinationTable, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcAlarmTable=dcAlarmTable, dcEventProcessingEventTable=dcEventProcessingEventTable, dcBoostChargeIstop=dcBoostChargeIstop, dcEventProcessingEventType=dcEventProcessingEventType, dcTempSupervision=dcTempSupervision, dcCriticalAlarmValue=dcCriticalAlarmValue, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcEventProcessingEventName=dcEventProcessingEventName, dcEqualizeVoltage=dcEqualizeVoltage, dcBoostChargeControl=dcBoostChargeControl, dcBatteryTestStatus=dcBatteryTestStatus, dcSoftwareVersion=dcSoftwareVersion, dcBatteryTestDateTime=dcBatteryTestDateTime, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcPowerLimitationLimit=dcPowerLimitationLimit, dcMinimumLoadStep=dcMinimumLoadStep, dcBoostChargeVoltage=dcBoostChargeVoltage, systemNonUrgentAlarm=systemNonUrgentAlarm, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcMeasurementScaleFactor=dcMeasurementScaleFactor, systemInfoGroup=systemInfoGroup, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcMeasurement=dcMeasurement, dcBatteryCurrent=dcBatteryCurrent, dcMeasurementEntry=dcMeasurementEntry, dcRectifierCurrent=dcRectifierCurrent, dcHighTempHyst=dcHighTempHyst, controllerConfs=controllerConfs, dcTrapDestinationPort=dcTrapDestinationPort, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcNumberRectifiers=dcNumberRectifiers, dcStartTemp=dcStartTemp, dcBatteryStringIndex=dcBatteryStringIndex, alarmTableGroup=alarmTableGroup, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcRectifierGroupName=dcRectifierGroupName, rectifierTableGroup=rectifierTableGroup, dcBattery=dcBattery, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcGenericAlarmEntry=dcGenericAlarmEntry, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcControlEventEntry=dcControlEventEntry, dcAlarmEntry=dcAlarmEntry, dcConfig=dcConfig, dcBatteryStringName=dcBatteryStringName, dcEqualizeStatus=dcEqualizeStatus, PYSNMP_MODULE_ID=orionBaseMibModule, dcLvdDisconnectDelay=dcLvdDisconnectDelay, genericAlarmTableGroup=genericAlarmTableGroup, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcUsMax=dcUsMax, dcEnableUsTempComp=dcEnableUsTempComp, rectifierGroupTableGroup=rectifierGroupTableGroup, dcRectifierIdentifier=dcRectifierIdentifier, dcPowerLimitationStatus=dcPowerLimitationStatus, dcTrapDestinationIndex=dcTrapDestinationIndex, dcBatteryStringEntry=dcBatteryStringEntry, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcSystemInfo=dcSystemInfo, dcBatteryStringTable=dcBatteryStringTable, notificationsGroup=notificationsGroup, dcBoostChargeIstart=dcBoostChargeIstart, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, meterPanelEventTableGroup=meterPanelEventTableGroup, batteryStringTableGroup=batteryStringTableGroup, trapDestinationTableGroup=trapDestinationTableGroup, dcEqualizeInterval=dcEqualizeInterval, dcUaMin=dcUaMin, dcRectifierFunctions=dcRectifierFunctions, dcHighStopVoltage=dcHighStopVoltage, dcMeasurementValue=dcMeasurementValue, dcGenericAlarmIndex=dcGenericAlarmIndex, dcEventHistoryTable=dcEventHistoryTable, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcHighStartTemp=dcHighStartTemp, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEvtCtrlCharge=dcEvtCtrlCharge, dcMaxVoltage=dcMaxVoltage, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcLvdEntry=dcLvdEntry, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcRectifierTable=dcRectifierTable, dcRectifierGroupTable=dcRectifierGroupTable, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcBatteryTestTempTo=dcBatteryTestTempTo, controllerEvents=controllerEvents)
