...
NotificationType, Counter64, Gauge32, TimeTicks, IpAddress, Integer32, enterprises, ModuleIdentity, Counter32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Gauge32", "TimeTicks", "IpAddress", "Integer32", "enterprises", "ModuleIdentity", "Counter32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcMinimumLoadStep=dcMinimumLoadStep, batteryGroup=batteryGroup, dcRectifierIdentifier=dcRectifierIdentifier, dcUaMin=dcUaMin, dcBoostCharge=dcBoostCharge, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcHighTemp=dcHighTemp, systemCriticalAlarm=systemCriticalAlarm, eventHistoryTableGroup=eventHistoryTableGroup, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcHighTempSlope=dcHighTempSlope, dcLvdIndex=dcLvdIndex, systemUrgentAlarm=systemUrgentAlarm, dcEqualizeParameter=dcEqualizeParameter, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcDefaultLogEventTable=dcDefaultLogEventTable, dcPowerLimitationIndex=dcPowerLimitationIndex, dcSystemVoltage=dcSystemVoltage, dcEfficiencyCycling=dcEfficiencyCycling, dcControlEventIndex=dcControlEventIndex, dcBatteryStringEntry=dcBatteryStringEntry, systemMonitorGroup=systemMonitorGroup, dcEqualizeStatus=dcEqualizeStatus, dcLowStartTemp=dcLowStartTemp, dcAlarmEventCategory=dcAlarmEventCategory, dcRectifierFunctions=dcRectifierFunctions, dcTrapDestinationIp=dcTrapDestinationIp, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcMeasurementName=dcMeasurementName, batteryStringTableGroup=batteryStringTableGroup, dcEqualizeLeadTime=dcEqualizeLeadTime, dcBattery=dcBattery, dcUsys20=dcUsys20, dcBatteryTestResult=dcBatteryTestResult, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcMaxVoltage=dcMaxVoltage, dcBatteryTestResults=dcBatteryTestResults, dcHighStopVoltage=dcHighStopVoltage, controllerEvents=controllerEvents, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcLowTempSlope=dcLowTempSlope, dcAlarmEntry=dcAlarmEntry, dcStartTemp=dcStartTemp, dcPowerLimitationStatus=dcPowerLimitationStatus, dcEventProcessingEventName=dcEventProcessingEventName, dcLvdEntry=dcLvdEntry, PYSNMP_MODULE_ID=orionBaseMibModule, controllerEventsV2=controllerEventsV2, dcBatteryTestStatus=dcBatteryTestStatus, dcSiteName=dcSiteName, dcBatteryTest=dcBatteryTest, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcBatteryStringIndex=dcBatteryStringIndex, dcMeterPanelEventTable=dcMeterPanelEventTable, dcUrgentAlarmValue=dcUrgentAlarmValue, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcBatteryCurrent=dcBatteryCurrent, dcEqualizeDuration=dcEqualizeDuration, dcBoostChargeVoltage=dcBoostChargeVoltage, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcRectifierIndex=dcRectifierIndex, dcConfig=dcConfig, dcFileProcessingStatus=dcFileProcessingStatus, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcControlEventTable=dcControlEventTable, rectifierGroupTableGroup=rectifierGroupTableGroup, dcBatteryTestDuration=dcBatteryTestDuration, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcChargeState=dcChargeState, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcBatteryParameter=dcBatteryParameter, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcSlope=dcSlope, dcControlEventName=dcControlEventName, dcLvdTable=dcLvdTable, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcAlarmTable=dcAlarmTable, dcUrgentAlarmName=dcUrgentAlarmName, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcUaMax=dcUaMax, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcRectifierStatus=dcRectifierStatus, dcTempSupervision=dcTempSupervision, dcRectifier=dcRectifier, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcCriticalAlarmValue=dcCriticalAlarmValue, dcMainsFailureAlarm=dcMainsFailureAlarm, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcBoostChargeType=dcBoostChargeType, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, lvdTableGroup=lvdTableGroup, dcBatteryTestInterval=dcBatteryTestInterval, dcEvtCtrlCharge=dcEvtCtrlCharge, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcGenericAlarmEventName=dcGenericAlarmEventName, dcTrapDestinationEntry=dcTrapDestinationEntry, controllerGroups=controllerGroups, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcBatteryTestControl=dcBatteryTestControl, dcPowerLimitation=dcPowerLimitation, dcRectifierGroupName=dcRectifierGroupName, dcEventHistoryEntry=dcEventHistoryEntry, systemInfoGroup=systemInfoGroup, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, notificationsGroup=notificationsGroup, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcEventProcessingEventType=dcEventProcessingEventType, dcSoftwareVersion=dcSoftwareVersion, dcGenericAlarmTable=dcGenericAlarmTable, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcLossOfBackupTime=dcLossOfBackupTime, dcHysteresis=dcHysteresis, dcEventProcessingEventTable=dcEventProcessingEventTable, dcBoostChargeControl=dcBoostChargeControl, dcHighTempHyst=dcHighTempHyst, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcLowStopVoltage=dcLowStopVoltage, dcCriticalAlarmName=dcCriticalAlarmName, dcHighStartTemp=dcHighStartTemp, dcMeterPanel=dcMeterPanel, dcRunawayVoltage=dcRunawayVoltage, dcExpectedBackupTime=dcExpectedBackupTime, dcAlarmEventName=dcAlarmEventName, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcTempCompType=dcTempCompType, dcSystemAlarms=dcSystemAlarms, orionBaseMib=orionBaseMib, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcEventHistoryIndex=dcEventHistoryIndex, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcRectifierGroupTable=dcRectifierGroupTable, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcBoD=dcBoD, dcSystemMonitor=dcSystemMonitor, dcTrapDestinationTable=dcTrapDestinationTable, dcRectifierTable=dcRectifierTable, dcPowerLimitationType=dcPowerLimitationType, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcBoostChargeStatus=dcBoostChargeStatus, dcBoostChargeIstop=dcBoostChargeIstop, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, meterPanelEventTableGroup=meterPanelEventTableGroup, measurementTableGroup=measurementTableGroup, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcSystemInfo=dcSystemInfo, dcFloatCharge=dcFloatCharge, dcMeasurementEntry=dcMeasurementEntry, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcGenericAlarmEntry=dcGenericAlarmEntry, dcRectifierEntry=dcRectifierEntry, rectifierTableGroup=rectifierTableGroup, dcBatteryTestType=dcBatteryTestType, controllerBasicCompl=controllerBasicCompl, orionBaseMibModule=orionBaseMibModule, dcEventHistoryMessage=dcEventHistoryMessage, dcRectifierGroupIndex=dcRectifierGroupIndex, trapDestinationTableGroup=trapDestinationTableGroup, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcControlEventValue=dcControlEventValue, dcControlEventEntry=dcControlEventEntry, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcRunawayTemp=dcRunawayTemp, dcSystemPower=dcSystemPower, dcAlarmIndex=dcAlarmIndex, dcMisc=dcMisc, controllerEventObjects=controllerEventObjects, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, powerLimitationTableGroup=powerLimitationTableGroup, dcEqualizeInterval=dcEqualizeInterval, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcBoostChargeParameter=dcBoostChargeParameter, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcBatteryTestParameter=dcBatteryTestParameter, dcBatteryTestTempTo=dcBatteryTestTempTo, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcUsMax=dcUsMax, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcEqualizeVoltage=dcEqualizeVoltage, dcEqualizeEnabled=dcEqualizeEnabled, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcPowerLimitationTable=dcPowerLimitationTable, systemAlarmGroup=systemAlarmGroup, dcEqualize=dcEqualize, dcSystemDateTime=dcSystemDateTime, alarmTableGroup=alarmTableGroup, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcRectifierCurrent=dcRectifierCurrent, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcBatteryStringTable=dcBatteryStringTable, dcLvdName=dcLvdName, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcPowerLimitationLimit=dcPowerLimitationLimit, controlEventTableGroup=controlEventTableGroup, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcPowerLimitationEventName=dcPowerLimitationEventName, dcEqualizeControl=dcEqualizeControl, defaultLogEventTableGroup=defaultLogEventTableGroup, dcEqualizeTimeLag=dcEqualizeTimeLag, controllerObjects=controllerObjects, dcBatteryStringCapacity=dcBatteryStringCapacity, dcBoostChargeIstart=dcBoostChargeIstart, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcPowerLimitationEntry=dcPowerLimitationEntry, genericAlarmTableGroup=genericAlarmTableGroup, dcDefaultLogEventName=dcDefaultLogEventName, dcMeterPanelEventName=dcMeterPanelEventName, dcNumberRectifiers=dcNumberRectifiers, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcTrapDestinationIndex=dcTrapDestinationIndex, dcBatteryTestUsupport=dcBatteryTestUsupport, dcMeasurementUnit=dcMeasurementUnit, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcMeasurement=dcMeasurement, dcBatteryTestDateTime=dcBatteryTestDateTime, dcMeasurementTable=dcMeasurementTable, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcTempComp=dcTempComp, controllerCompl=controllerCompl, dcMeasurementValue=dcMeasurementValue, dcCurrentLimit=dcCurrentLimit, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, miscGroup=miscGroup, rectifierGroup=rectifierGroup, dcAlarmEventValue=dcAlarmEventValue, dcMaximumLoadStep=dcMaximumLoadStep, dcMeasurementIndex=dcMeasurementIndex, dcTrapDestinationPort=dcTrapDestinationPort, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcLoadCurrent=dcLoadCurrent, dcUsMin=dcUsMin, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcEnableUsTempComp=dcEnableUsTempComp, systemNonUrgentAlarm=systemNonUrgentAlarm, dcMeterPanelEventValue=dcMeterPanelEventValue, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, controllerConfs=controllerConfs)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcInputOutput=dcInputOutput, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcEventHistoryTable=dcEventHistoryTable, dcGenericAlarmIndex=dcGenericAlarmIndex, dcRectifierGroupEntry=dcRectifierGroupEntry, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcSystemName=dcSystemName, dcBatteryTemperature=dcBatteryTemperature, dcStopTemp=dcStopTemp, dcBatteryStringName=dcBatteryStringName, dcControlEventIdentifier=dcControlEventIdentifier, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt)
