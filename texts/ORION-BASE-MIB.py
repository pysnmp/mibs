...
ModuleIdentity, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Bits, enterprises, ObjectIdentity, IpAddress, Unsigned32, Gauge32, Counter64, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Bits", "enterprises", "ObjectIdentity", "IpAddress", "Unsigned32", "Gauge32", "Counter64", "NotificationType", "iso")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcMainsFailureAlarm=dcMainsFailureAlarm, dcBoostChargeStatus=dcBoostChargeStatus, dcEventHistoryIndex=dcEventHistoryIndex, PYSNMP_MODULE_ID=orionBaseMibModule, dcHighTempSlope=dcHighTempSlope, dcEventHistoryTable=dcEventHistoryTable, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcPowerLimitationIndex=dcPowerLimitationIndex, dcUsMax=dcUsMax, dcMeterPanelEventIndex=dcMeterPanelEventIndex, alarmTableGroup=alarmTableGroup, controllerCompl=controllerCompl, dcExpectedBackupTime=dcExpectedBackupTime, systemInfoGroup=systemInfoGroup, dcRectifierGroupTable=dcRectifierGroupTable, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcEventProcessingEventType=dcEventProcessingEventType, dcBatteryTestResult=dcBatteryTestResult, dcSystemAlarms=dcSystemAlarms, dcBoostChargeVoltage=dcBoostChargeVoltage, dcAlarmEventValue=dcAlarmEventValue, dcMeterPanelEventTable=dcMeterPanelEventTable, systemCriticalAlarm=systemCriticalAlarm, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcEqualizeVoltage=dcEqualizeVoltage, rectifierGroup=rectifierGroup, dcLossOfBackupTime=dcLossOfBackupTime, dcUaMin=dcUaMin, dcEventHistoryEntry=dcEventHistoryEntry, dcPowerLimitation=dcPowerLimitation, dcRectifierStatus=dcRectifierStatus, dcTrapDestinationIp=dcTrapDestinationIp, eventHistoryTableGroup=eventHistoryTableGroup, dcCriticalAlarmValue=dcCriticalAlarmValue, dcStartTemp=dcStartTemp, dcControlEventName=dcControlEventName, dcEventProcessingEventName=dcEventProcessingEventName, orionBaseMib=orionBaseMib, controllerObjects=controllerObjects, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcUsys20=dcUsys20, controllerEvents=controllerEvents, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcSlope=dcSlope, dcRectifierGroupEntry=dcRectifierGroupEntry, dcLowTempSlope=dcLowTempSlope, dcLvdEntry=dcLvdEntry, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcTempSupervision=dcTempSupervision, dcGenericAlarmEventName=dcGenericAlarmEventName, dcTrapDestinationEntry=dcTrapDestinationEntry, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcBatteryTestResults=dcBatteryTestResults, dcSystemVoltage=dcSystemVoltage, dcLowStartTemp=dcLowStartTemp, lvdTableGroup=lvdTableGroup, dcRectifierGroupIndex=dcRectifierGroupIndex, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcDefaultLogEventIndex=dcDefaultLogEventIndex, genericAlarmTableGroup=genericAlarmTableGroup, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcGenericAlarmIndex=dcGenericAlarmIndex, dcBatteryTestUsupport=dcBatteryTestUsupport, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcLvdIndex=dcLvdIndex, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcRunawayTemp=dcRunawayTemp, dcEventHistoryMessage=dcEventHistoryMessage, dcPowerLimitationStatus=dcPowerLimitationStatus, dcRectifierIndex=dcRectifierIndex, miscGroup=miscGroup, dcGenericAlarmEntry=dcGenericAlarmEntry, dcFileProcessingStatus=dcFileProcessingStatus, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcAlarmEntry=dcAlarmEntry, dcAlarmEventCategory=dcAlarmEventCategory, dcLowStopVoltage=dcLowStopVoltage, dcHighTempHyst=dcHighTempHyst, dcEfficiencyCycling=dcEfficiencyCycling, dcPowerLimitationTable=dcPowerLimitationTable, dcPowerLimitationEventName=dcPowerLimitationEventName, meterPanelEventTableGroup=meterPanelEventTableGroup, dcEqualizeLeadTime=dcEqualizeLeadTime, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcMeasurementTable=dcMeasurementTable, dcBatteryParameter=dcBatteryParameter, dcBatteryTestControl=dcBatteryTestControl, dcEqualizeStatus=dcEqualizeStatus, dcRectifier=dcRectifier, dcRectifierFunctions=dcRectifierFunctions, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcHighStartTemp=dcHighStartTemp, batteryStringTableGroup=batteryStringTableGroup, dcStopTemp=dcStopTemp, dcAlarmIndex=dcAlarmIndex, dcBatteryTestTempTo=dcBatteryTestTempTo, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcRectifierTable=dcRectifierTable, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcEqualizeDuration=dcEqualizeDuration, trapDestinationTableGroup=trapDestinationTableGroup, dcEventProcessingEventTable=dcEventProcessingEventTable, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcDefaultLogEventEntry=dcDefaultLogEventEntry, powerLimitationTableGroup=powerLimitationTableGroup, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcMeasurement=dcMeasurement, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcPowerLimitationType=dcPowerLimitationType, dcBattery=dcBattery, orionBaseMibModule=orionBaseMibModule, dcSiteName=dcSiteName, dcRectifierCurrent=dcRectifierCurrent, dcTempCompType=dcTempCompType, dcTrapDestinationPort=dcTrapDestinationPort, dcBoostChargeIstop=dcBoostChargeIstop, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcLoadCurrent=dcLoadCurrent, dcBatteryTestStatus=dcBatteryTestStatus, dcEnableUsTempComp=dcEnableUsTempComp, dcControlEventIndex=dcControlEventIndex, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcBatteryTestDuration=dcBatteryTestDuration, controllerConfs=controllerConfs, dcMeasurementName=dcMeasurementName, rectifierTableGroup=rectifierTableGroup, dcMeterPanelEventValue=dcMeterPanelEventValue, dcBatteryCurrent=dcBatteryCurrent, controllerBasicCompl=controllerBasicCompl, dcControlEventTable=dcControlEventTable, dcControlEventIdentifier=dcControlEventIdentifier, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcEqualizeControl=dcEqualizeControl, dcBoostChargeIstart=dcBoostChargeIstart, dcBoostChargeType=dcBoostChargeType, dcBatteryTestParameter=dcBatteryTestParameter, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcMisc=dcMisc, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcSystemDateTime=dcSystemDateTime, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcEqualizeTimeLag=dcEqualizeTimeLag, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcMeterPanelEventName=dcMeterPanelEventName, dcMeasurementValue=dcMeasurementValue, dcBatteryTestType=dcBatteryTestType, rectifierGroupTableGroup=rectifierGroupTableGroup, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcDefaultLogEventTable=dcDefaultLogEventTable, dcBatteryStringName=dcBatteryStringName, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcBoostCharge=dcBoostCharge, dcFloatCharge=dcFloatCharge, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, controllerGroups=controllerGroups, dcEqualizeEnabled=dcEqualizeEnabled, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcSystemInfo=dcSystemInfo, dcSystemPower=dcSystemPower, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcMeasurementIndex=dcMeasurementIndex, batteryGroup=batteryGroup, dcConfig=dcConfig, dcChargeState=dcChargeState, dcAlarmEventName=dcAlarmEventName, dcRectifierGroupName=dcRectifierGroupName, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcControlEventEntry=dcControlEventEntry, systemUrgentAlarm=systemUrgentAlarm, dcLvdDisconnectDelay=dcLvdDisconnectDelay, notificationsGroup=notificationsGroup, dcRunawayVoltage=dcRunawayVoltage, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcBoostChargeControl=dcBoostChargeControl, dcBatteryTest=dcBatteryTest, dcMinimumLoadStep=dcMinimumLoadStep, dcLvdTable=dcLvdTable, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcInputOutput=dcInputOutput, dcMeterPanel=dcMeterPanel, dcUrgentAlarmName=dcUrgentAlarmName, dcSystemName=dcSystemName, dcNumberRectifiers=dcNumberRectifiers, dcUsMin=dcUsMin, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcUaMax=dcUaMax, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcHighStopVoltage=dcHighStopVoltage, dcBoD=dcBoD, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcCurrentLimit=dcCurrentLimit, dcTrapDestinationIndex=dcTrapDestinationIndex, dcRectifierEntry=dcRectifierEntry, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcLvdName=dcLvdName, controlEventTableGroup=controlEventTableGroup, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcEqualize=dcEqualize, controllerEventObjects=controllerEventObjects, controllerEventsV2=controllerEventsV2, dcAlarmTable=dcAlarmTable, dcCriticalAlarmName=dcCriticalAlarmName, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcBatteryStringTable=dcBatteryStringTable, dcBatteryStringEntry=dcBatteryStringEntry, dcBatteryStringIndex=dcBatteryStringIndex, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcMaximumLoadStep=dcMaximumLoadStep, dcRectifierIdentifier=dcRectifierIdentifier, dcPowerLimitationLimit=dcPowerLimitationLimit, dcEvtCtrlCharge=dcEvtCtrlCharge, dcBatteryTestInterval=dcBatteryTestInterval, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBoostChargeParameter=dcBoostChargeParameter, dcBatteryTestDateTime=dcBatteryTestDateTime, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcBatteryTemperature=dcBatteryTemperature, dcTotalBatteryCapacity=dcTotalBatteryCapacity, measurementTableGroup=measurementTableGroup, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcTrapDestinationTable=dcTrapDestinationTable, systemMonitorGroup=systemMonitorGroup, dcEqualizeInterval=dcEqualizeInterval, dcDefaultLogEventName=dcDefaultLogEventName, dcMaxVoltage=dcMaxVoltage, dcSystemMonitor=dcSystemMonitor, dcSoftwareVersion=dcSoftwareVersion, dcHysteresis=dcHysteresis, dcHighTemp=dcHighTemp, dcPowerLimitationEntry=dcPowerLimitationEntry, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcBatteryStringCapacity=dcBatteryStringCapacity, dcEqualizeParameter=dcEqualizeParameter, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcUrgentAlarmValue=dcUrgentAlarmValue)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcMeasurementUnit=dcMeasurementUnit, systemNonUrgentAlarm=systemNonUrgentAlarm, dcEventProcessingEventIndex=dcEventProcessingEventIndex, defaultLogEventTableGroup=defaultLogEventTableGroup, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcControlEventValue=dcControlEventValue, systemAlarmGroup=systemAlarmGroup, dcMeasurementEntry=dcMeasurementEntry, dcGenericAlarmTable=dcGenericAlarmTable, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcTempComp=dcTempComp)
