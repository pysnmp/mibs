...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, NotificationType, Gauge32, Counter64, ObjectIdentity, IpAddress, Bits, TimeTicks, MibIdentifier, enterprises, Unsigned32, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "NotificationType", "Gauge32", "Counter64", "ObjectIdentity", "IpAddress", "Bits", "TimeTicks", "MibIdentifier", "enterprises", "Unsigned32", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", PYSNMP_MODULE_ID=orionBaseMibModule, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcBatteryTestParameter=dcBatteryTestParameter, dcBatteryStringCapacity=dcBatteryStringCapacity, dcEventProcessingEventType=dcEventProcessingEventType, dcLossOfBackupTime=dcLossOfBackupTime, dcBoD=dcBoD, dcBatteryTestDateTime=dcBatteryTestDateTime, controllerObjects=controllerObjects, dcSystemVoltage=dcSystemVoltage, dcSoftwareVersion=dcSoftwareVersion, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcLvdName=dcLvdName, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcStopTemp=dcStopTemp, meterPanelEventTableGroup=meterPanelEventTableGroup, dcMeasurement=dcMeasurement, dcConfig=dcConfig, dcMisc=dcMisc, dcBoostChargeIstop=dcBoostChargeIstop, dcSlope=dcSlope, dcEqualizeDuration=dcEqualizeDuration, dcBoostChargeControl=dcBoostChargeControl, dcPowerLimitationEntry=dcPowerLimitationEntry, genericAlarmTableGroup=genericAlarmTableGroup, dcRectifierGroupEntry=dcRectifierGroupEntry, dcRectifierGroupName=dcRectifierGroupName, dcLvdTable=dcLvdTable, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcAlarmEventName=dcAlarmEventName, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcTrapDestinationIp=dcTrapDestinationIp, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcEqualizeControl=dcEqualizeControl, dcMeasurementName=dcMeasurementName, dcHighTemp=dcHighTemp, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcControlEventName=dcControlEventName, dcMaximumLoadStep=dcMaximumLoadStep, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcEvtCtrlCharge=dcEvtCtrlCharge, systemCriticalAlarm=systemCriticalAlarm, dcBatteryTestStatus=dcBatteryTestStatus, eventHistoryTableGroup=eventHistoryTableGroup, rectifierGroupTableGroup=rectifierGroupTableGroup, dcMeterPanelEventTable=dcMeterPanelEventTable, systemMonitorGroup=systemMonitorGroup, batteryGroup=batteryGroup, dcMinimumLoadStep=dcMinimumLoadStep, dcRectifierIdentifier=dcRectifierIdentifier, dcPowerLimitationTable=dcPowerLimitationTable, dcBatteryStringEntry=dcBatteryStringEntry, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcUaMin=dcUaMin, dcEventProcessingEventTable=dcEventProcessingEventTable, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcStartTemp=dcStartTemp, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcMeasurementValue=dcMeasurementValue, dcAlarmIndex=dcAlarmIndex, dcBatteryStringName=dcBatteryStringName, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcBatteryTest=dcBatteryTest, dcUrgentAlarmValue=dcUrgentAlarmValue, dcBatteryParameter=dcBatteryParameter, dcLowStartTemp=dcLowStartTemp, orionBaseMibModule=orionBaseMibModule, dcHighStopVoltage=dcHighStopVoltage, dcInputOutput=dcInputOutput, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcRunawayTemp=dcRunawayTemp, dcFileProcessingStatus=dcFileProcessingStatus, dcBattery=dcBattery, dcTempCompType=dcTempCompType, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, defaultLogEventTableGroup=defaultLogEventTableGroup, dcEqualizeParameter=dcEqualizeParameter, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcUsMin=dcUsMin, dcTrapDestinationIndex=dcTrapDestinationIndex, orionBaseMib=orionBaseMib, dcEqualizeLeadTime=dcEqualizeLeadTime, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcBatteryTestControl=dcBatteryTestControl, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcNumberRectifiers=dcNumberRectifiers, dcBatteryTestResults=dcBatteryTestResults, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcRectifierIndex=dcRectifierIndex, dcHighTempHyst=dcHighTempHyst, dcRectifierEntry=dcRectifierEntry, dcBatteryStringTable=dcBatteryStringTable, dcBatteryTestInterval=dcBatteryTestInterval, dcBatteryCurrent=dcBatteryCurrent, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcPowerLimitationStatus=dcPowerLimitationStatus, dcMeasurementIndex=dcMeasurementIndex, dcTrapDestinationTable=dcTrapDestinationTable, dcTempComp=dcTempComp, dcLvdIndex=dcLvdIndex, dcAlarmEntry=dcAlarmEntry, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcControlEventIndex=dcControlEventIndex, dcPowerLimitationLimit=dcPowerLimitationLimit, dcRectifierGroupIndex=dcRectifierGroupIndex, dcControlEventIdentifier=dcControlEventIdentifier, systemAlarmGroup=systemAlarmGroup, dcUsMax=dcUsMax, dcEnableUsTempComp=dcEnableUsTempComp, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, rectifierGroup=rectifierGroup, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, notificationsGroup=notificationsGroup, dcBoostChargeVoltage=dcBoostChargeVoltage, controllerEventsV2=controllerEventsV2, dcMeterPanel=dcMeterPanel, dcGenericAlarmIndex=dcGenericAlarmIndex, dcMainsFailureAlarm=dcMainsFailureAlarm, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, miscGroup=miscGroup, controlEventTableGroup=controlEventTableGroup, dcMeasurementEntry=dcMeasurementEntry, controllerEvents=controllerEvents, dcCriticalAlarmName=dcCriticalAlarmName, dcRectifierFunctions=dcRectifierFunctions, dcGenericAlarmEntry=dcGenericAlarmEntry, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcTrapDestinationPort=dcTrapDestinationPort, alarmTableGroup=alarmTableGroup, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcBoostChargeStatus=dcBoostChargeStatus, powerLimitationTableGroup=powerLimitationTableGroup, dcLvdEntry=dcLvdEntry, dcBatteryTestResult=dcBatteryTestResult, dcEqualizeInterval=dcEqualizeInterval, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcDefaultLogEventName=dcDefaultLogEventName, dcEventHistoryMessage=dcEventHistoryMessage, dcSiteName=dcSiteName, dcSystemDateTime=dcSystemDateTime, dcEqualizeVoltage=dcEqualizeVoltage, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcLowTempSlope=dcLowTempSlope, dcControlEventValue=dcControlEventValue, dcChargeState=dcChargeState, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcPowerLimitationType=dcPowerLimitationType, dcLowStopVoltage=dcLowStopVoltage, dcPowerLimitationIndex=dcPowerLimitationIndex, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcBoostChargeParameter=dcBoostChargeParameter, dcLvdDisconnectDelay=dcLvdDisconnectDelay, systemUrgentAlarm=systemUrgentAlarm, controllerEventObjects=controllerEventObjects, dcEqualizeTimeLag=dcEqualizeTimeLag, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcUsys20=dcUsys20, dcSystemPower=dcSystemPower, dcHysteresis=dcHysteresis, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcBoostChargeType=dcBoostChargeType, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcBatteryTestType=dcBatteryTestType, measurementTableGroup=measurementTableGroup, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcRectifierCurrent=dcRectifierCurrent, dcPowerLimitation=dcPowerLimitation, dcUaMax=dcUaMax, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcBatteryTestDuration=dcBatteryTestDuration, dcEventProcessingEventName=dcEventProcessingEventName, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcBoostCharge=dcBoostCharge, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcFloatCharge=dcFloatCharge, dcGenericAlarmEventName=dcGenericAlarmEventName, systemInfoGroup=systemInfoGroup, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcTrapDestinationEntry=dcTrapDestinationEntry, dcMaxVoltage=dcMaxVoltage, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcBatteryTestUsupport=dcBatteryTestUsupport, dcEventHistoryIndex=dcEventHistoryIndex, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, controllerBasicCompl=controllerBasicCompl, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcBatteryTemperature=dcBatteryTemperature, dcEqualizeEnabled=dcEqualizeEnabled, rectifierTableGroup=rectifierTableGroup, dcRectifier=dcRectifier, systemNonUrgentAlarm=systemNonUrgentAlarm, dcHighTempSlope=dcHighTempSlope, dcCriticalAlarmValue=dcCriticalAlarmValue, dcMeasurementUnit=dcMeasurementUnit, lvdTableGroup=lvdTableGroup, dcBatteryStringIndex=dcBatteryStringIndex, dcAlarmTable=dcAlarmTable, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcSystemInfo=dcSystemInfo, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcRectifierStatus=dcRectifierStatus, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcHighStartTemp=dcHighStartTemp, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcSystemMonitor=dcSystemMonitor, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcSystemAlarms=dcSystemAlarms, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, trapDestinationTableGroup=trapDestinationTableGroup, dcEventHistoryTable=dcEventHistoryTable, dcMeterPanelEventName=dcMeterPanelEventName, dcAlarmEventCategory=dcAlarmEventCategory, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcControlEventTable=dcControlEventTable, controllerCompl=controllerCompl, dcExpectedBackupTime=dcExpectedBackupTime, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcRectifierGroupTable=dcRectifierGroupTable, controllerConfs=controllerConfs, dcAlarmEventValue=dcAlarmEventValue, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcBatteryTestTempTo=dcBatteryTestTempTo, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, batteryStringTableGroup=batteryStringTableGroup, dcSystemName=dcSystemName, dcUrgentAlarmName=dcUrgentAlarmName, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcRunawayVoltage=dcRunawayVoltage, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcMeasurementTable=dcMeasurementTable, dcDefaultLogEventTable=dcDefaultLogEventTable, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcControlEventEntry=dcControlEventEntry, dcPowerLimitationEventName=dcPowerLimitationEventName, controllerGroups=controllerGroups, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcEfficiencyCycling=dcEfficiencyCycling, dcEqualizeStatus=dcEqualizeStatus)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcLoadCurrent=dcLoadCurrent, dcMeterPanelEventValue=dcMeterPanelEventValue, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcEqualize=dcEqualize, dcBoostChargeIstart=dcBoostChargeIstart, dcRectifierTable=dcRectifierTable, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcCurrentLimit=dcCurrentLimit, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcEventHistoryEntry=dcEventHistoryEntry, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcTempSupervision=dcTempSupervision, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcGenericAlarmTable=dcGenericAlarmTable)
