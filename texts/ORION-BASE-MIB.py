...
Counter32, Counter64, IpAddress, Unsigned32, Gauge32, TimeTicks, Integer32, NotificationType, iso, ObjectIdentity, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "IpAddress", "Unsigned32", "Gauge32", "TimeTicks", "Integer32", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcNumberRectifiers=dcNumberRectifiers, dcBatteryParameter=dcBatteryParameter, controllerBasicCompl=controllerBasicCompl, dcLvdName=dcLvdName, dcCriticalAlarmName=dcCriticalAlarmName, dcEventProcessingEventEntry=dcEventProcessingEventEntry, trapDestinationTableGroup=trapDestinationTableGroup, dcLowStopVoltage=dcLowStopVoltage, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcUaMax=dcUaMax, dcRectifierTable=dcRectifierTable, controllerGroups=controllerGroups, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcTrapDestinationIp=dcTrapDestinationIp, dcExpectedBackupTime=dcExpectedBackupTime, dcPowerLimitationType=dcPowerLimitationType, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcGenericAlarmIndex=dcGenericAlarmIndex, dcControlEventTable=dcControlEventTable, dcMeasurementEntry=dcMeasurementEntry, dcEqualizeEnabled=dcEqualizeEnabled, dcMeasurementUnit=dcMeasurementUnit, dcPowerLimitationIndex=dcPowerLimitationIndex, systemInfoGroup=systemInfoGroup, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, controllerCompl=controllerCompl, dcLvdIndex=dcLvdIndex, dcMisc=dcMisc, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcBoostChargeStatus=dcBoostChargeStatus, dcEventProcessingEventName=dcEventProcessingEventName, dcMaxVoltage=dcMaxVoltage, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcInputOutput=dcInputOutput, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcControlEventEntry=dcControlEventEntry, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcControlEventName=dcControlEventName, dcBoD=dcBoD, orionBaseMib=orionBaseMib, dcEventHistoryIndex=dcEventHistoryIndex, dcAlarmEntry=dcAlarmEntry, batteryGroup=batteryGroup, dcBattery=dcBattery, dcUrgentAlarmName=dcUrgentAlarmName, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcHysteresis=dcHysteresis, dcEqualizeControl=dcEqualizeControl, dcRectifierStatus=dcRectifierStatus, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcUsMin=dcUsMin, systemCriticalAlarm=systemCriticalAlarm, controllerEventObjects=controllerEventObjects, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, systemMonitorGroup=systemMonitorGroup, dcHighStartTemp=dcHighStartTemp, dcMainsFailureAlarm=dcMainsFailureAlarm, rectifierGroupTableGroup=rectifierGroupTableGroup, dcEqualizeInterval=dcEqualizeInterval, defaultLogEventTableGroup=defaultLogEventTableGroup, dcGenericAlarmEventName=dcGenericAlarmEventName, dcHighTempSlope=dcHighTempSlope, dcControlEventValue=dcControlEventValue, dcPowerLimitation=dcPowerLimitation, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcBatteryTestUsupport=dcBatteryTestUsupport, dcAlarmEventCategory=dcAlarmEventCategory, dcBatteryStringCapacity=dcBatteryStringCapacity, dcBatteryTestDateTime=dcBatteryTestDateTime, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcLvdTable=dcLvdTable, dcUsys20=dcUsys20, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, systemUrgentAlarm=systemUrgentAlarm, dcSystemAlarms=dcSystemAlarms, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcEqualizeLeadTime=dcEqualizeLeadTime, dcEventProcessingEventType=dcEventProcessingEventType, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcBatteryTestResults=dcBatteryTestResults, rectifierGroup=rectifierGroup, dcHighTempHyst=dcHighTempHyst, dcLvdEntry=dcLvdEntry, dcControlEventIdentifier=dcControlEventIdentifier, dcDefaultLogEventName=dcDefaultLogEventName, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcEventHistoryEntry=dcEventHistoryEntry, dcFileProcessingStatus=dcFileProcessingStatus, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, controllerEvents=controllerEvents, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcMeasurementTable=dcMeasurementTable, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcLoadCurrent=dcLoadCurrent, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcLowStartTemp=dcLowStartTemp, dcRectifierGroupIndex=dcRectifierGroupIndex, batteryStringTableGroup=batteryStringTableGroup, dcPowerLimitationEntry=dcPowerLimitationEntry, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcUaMin=dcUaMin, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcMeterPanelEventIndex=dcMeterPanelEventIndex, genericAlarmTableGroup=genericAlarmTableGroup, dcGenericAlarmEntry=dcGenericAlarmEntry, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcLowTempSlope=dcLowTempSlope, controllerObjects=controllerObjects, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcBoostChargeParameter=dcBoostChargeParameter, eventHistoryTableGroup=eventHistoryTableGroup, dcBoostChargeIstart=dcBoostChargeIstart, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcMeterPanelEventName=dcMeterPanelEventName, dcControlEventIndex=dcControlEventIndex, dcMaximumLoadStep=dcMaximumLoadStep, dcTempComp=dcTempComp, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcEventHistoryMessage=dcEventHistoryMessage, dcTempSupervision=dcTempSupervision, dcNumberCriticalAlarms=dcNumberCriticalAlarms, PYSNMP_MODULE_ID=orionBaseMibModule, dcRectifierGroupEntry=dcRectifierGroupEntry, dcBatteryStringName=dcBatteryStringName, dcBatteryTestDuration=dcBatteryTestDuration, dcBatteryTestResult=dcBatteryTestResult, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcDefaultLogEventTable=dcDefaultLogEventTable, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcPowerLimitationLimit=dcPowerLimitationLimit, dcBatteryTestInterval=dcBatteryTestInterval, dcBoostChargeType=dcBoostChargeType, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcSlope=dcSlope, dcTrapDestinationEntry=dcTrapDestinationEntry, dcBatteryTestType=dcBatteryTestType, notificationsGroup=notificationsGroup, dcBoostChargeVoltage=dcBoostChargeVoltage, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcRectifierEntry=dcRectifierEntry, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcSystemInfo=dcSystemInfo, dcChargeState=dcChargeState, dcRunawayVoltage=dcRunawayVoltage, dcUsMax=dcUsMax, dcMeterPanelEventTable=dcMeterPanelEventTable, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcTrapDestinationPort=dcTrapDestinationPort, dcAlarmEventName=dcAlarmEventName, dcBatteryStringTable=dcBatteryStringTable, controllerConfs=controllerConfs, dcSiteName=dcSiteName, dcSystemMonitor=dcSystemMonitor, dcFloatCharge=dcFloatCharge, dcMeasurement=dcMeasurement, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcAlarmTable=dcAlarmTable, dcBatteryTestStatus=dcBatteryTestStatus, dcEventProcessingEventTable=dcEventProcessingEventTable, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcBoostChargeTimeLag=dcBoostChargeTimeLag, meterPanelEventTableGroup=meterPanelEventTableGroup, dcMinimumLoadStep=dcMinimumLoadStep, orionBaseMibModule=orionBaseMibModule, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcMeasurementName=dcMeasurementName, dcCriticalAlarmValue=dcCriticalAlarmValue, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcMeterPanel=dcMeterPanel, dcStopTemp=dcStopTemp, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcMeasurementIndex=dcMeasurementIndex, dcTrapDestinationTable=dcTrapDestinationTable, systemAlarmGroup=systemAlarmGroup, alarmTableGroup=alarmTableGroup, lvdTableGroup=lvdTableGroup, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcCurrentLimit=dcCurrentLimit, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, rectifierTableGroup=rectifierTableGroup, dcBatteryStringEntry=dcBatteryStringEntry, dcTrapDestinationIndex=dcTrapDestinationIndex, controlEventTableGroup=controlEventTableGroup, dcRectifierFunctions=dcRectifierFunctions, dcRectifierGroupName=dcRectifierGroupName, dcEqualizeStatus=dcEqualizeStatus, dcPowerLimitationStatus=dcPowerLimitationStatus, dcAlarmIndex=dcAlarmIndex, dcBoostChargeIstop=dcBoostChargeIstop, dcRectifierIndex=dcRectifierIndex, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcEqualizeVoltage=dcEqualizeVoltage, dcSoftwareVersion=dcSoftwareVersion, dcBatteryTestControl=dcBatteryTestControl, dcAlarmEventValue=dcAlarmEventValue, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcBatteryTest=dcBatteryTest, dcRectifierGroupTable=dcRectifierGroupTable, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcPowerLimitationTable=dcPowerLimitationTable, measurementTableGroup=measurementTableGroup, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcSystemName=dcSystemName, dcRunawayTemp=dcRunawayTemp, dcEventProcessingEventIndex=dcEventProcessingEventIndex, powerLimitationTableGroup=powerLimitationTableGroup, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcRectifier=dcRectifier, dcUrgentAlarmValue=dcUrgentAlarmValue, miscGroup=miscGroup, dcEfficiencyCycling=dcEfficiencyCycling, dcRectifierCurrent=dcRectifierCurrent, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcBoostChargeControl=dcBoostChargeControl, dcEqualizeDuration=dcEqualizeDuration, dcHighTemp=dcHighTemp, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcTempCompType=dcTempCompType, dcEqualizeParameter=dcEqualizeParameter, dcPowerLimitationEventName=dcPowerLimitationEventName, dcEvtCtrlCharge=dcEvtCtrlCharge, dcSystemDateTime=dcSystemDateTime, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcGenericAlarmTable=dcGenericAlarmTable, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcLossOfBackupTime=dcLossOfBackupTime, dcMeasurementValue=dcMeasurementValue, dcBatteryStringIndex=dcBatteryStringIndex, controllerEventsV2=controllerEventsV2, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcEnableUsTempComp=dcEnableUsTempComp, dcEqualize=dcEqualize, dcSystemPower=dcSystemPower, dcMeterPanelEventValue=dcMeterPanelEventValue, systemNonUrgentAlarm=systemNonUrgentAlarm, dcBatteryTestParameter=dcBatteryTestParameter, dcEqualizeTimeLag=dcEqualizeTimeLag, dcBatteryTemperature=dcBatteryTemperature)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcBatteryCurrent=dcBatteryCurrent, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcBatteryTestTempTo=dcBatteryTestTempTo, dcSystemVoltage=dcSystemVoltage, dcStartTemp=dcStartTemp, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcHighStopVoltage=dcHighStopVoltage, dcBoostCharge=dcBoostCharge, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcConfig=dcConfig, dcEventHistoryTable=dcEventHistoryTable, dcRectifierIdentifier=dcRectifierIdentifier)
