...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcExpectedBackupTime=dcExpectedBackupTime, dcMeasurement=dcMeasurement, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcTempComp=dcTempComp, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcPowerLimitationStatus=dcPowerLimitationStatus, dcBatteryStringCapacity=dcBatteryStringCapacity, dcBoostCharge=dcBoostCharge, dcAlarmEventValue=dcAlarmEventValue, dcConfig=dcConfig, dcControlEventIndex=dcControlEventIndex, systemUrgentAlarm=systemUrgentAlarm, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcPowerLimitationIndex=dcPowerLimitationIndex, dcEqualizeLeadTime=dcEqualizeLeadTime, dcBoD=dcBoD, systemAlarmGroup=systemAlarmGroup, dcTrapDestinationIp=dcTrapDestinationIp, dcGenericAlarmEventName=dcGenericAlarmEventName, dcEnableUsTempComp=dcEnableUsTempComp, dcSystemMonitor=dcSystemMonitor, dcBoostChargeType=dcBoostChargeType, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcRectifierFunctions=dcRectifierFunctions, dcInputOutput=dcInputOutput, dcControlEventName=dcControlEventName, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcMeasurementUnit=dcMeasurementUnit, dcControlEventEntry=dcControlEventEntry, controllerEvents=controllerEvents, dcBatteryTestType=dcBatteryTestType, dcAlarmEntry=dcAlarmEntry, dcFileProcessingStatus=dcFileProcessingStatus, dcMeterPanel=dcMeterPanel, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcSystemPower=dcSystemPower, dcEvtCtrlCharge=dcEvtCtrlCharge, dcMeasurementValue=dcMeasurementValue, dcSystemInfo=dcSystemInfo, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcLowStartTemp=dcLowStartTemp, dcControlEventIdentifier=dcControlEventIdentifier, dcDefaultLogEventIndex=dcDefaultLogEventIndex, alarmTableGroup=alarmTableGroup, dcBatteryTest=dcBatteryTest, dcMeasurementEntry=dcMeasurementEntry, controllerGroups=controllerGroups, notificationsGroup=notificationsGroup, dcSiteName=dcSiteName, dcBatteryTestTempTo=dcBatteryTestTempTo, dcHighTempSlope=dcHighTempSlope, dcMaxVoltage=dcMaxVoltage, dcBoostChargeVoltage=dcBoostChargeVoltage, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcAlarmIndex=dcAlarmIndex, dcMisc=dcMisc, dcRectifierStatus=dcRectifierStatus, dcSystemDateTime=dcSystemDateTime, dcRectifierGroupName=dcRectifierGroupName, dcBoostChargeParameter=dcBoostChargeParameter, dcDefaultLogEventTable=dcDefaultLogEventTable, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcAlarmTable=dcAlarmTable, dcAlarmEventName=dcAlarmEventName, dcUsys20=dcUsys20, dcSoftwareVersion=dcSoftwareVersion, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcEventProcessingEventEntry=dcEventProcessingEventEntry, systemCriticalAlarm=systemCriticalAlarm, batteryStringTableGroup=batteryStringTableGroup, dcRectifierGroupTable=dcRectifierGroupTable, dcBatteryStringEntry=dcBatteryStringEntry, dcBatteryTestDuration=dcBatteryTestDuration, dcBatteryTestParameter=dcBatteryTestParameter, dcRectifier=dcRectifier, dcMinimumLoadStep=dcMinimumLoadStep, dcRunawayTemp=dcRunawayTemp, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, rectifierTableGroup=rectifierTableGroup, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcUrgentAlarmValue=dcUrgentAlarmValue, controllerCompl=controllerCompl, dcControlEventValue=dcControlEventValue, rectifierGroup=rectifierGroup, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcLvdEntry=dcLvdEntry, dcEfficiencyCycling=dcEfficiencyCycling, dcDefaultLogEventName=dcDefaultLogEventName, rectifierGroupTableGroup=rectifierGroupTableGroup, dcMeterPanelEventValue=dcMeterPanelEventValue, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcBatteryTestDateTime=dcBatteryTestDateTime, dcHighTempHyst=dcHighTempHyst, controllerEventObjects=controllerEventObjects, dcCriticalAlarmValue=dcCriticalAlarmValue, dcBoostChargeControl=dcBoostChargeControl, dcLossOfBackupTime=dcLossOfBackupTime, controllerEventsV2=controllerEventsV2, dcStartTemp=dcStartTemp, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, controlEventTableGroup=controlEventTableGroup, dcEqualize=dcEqualize, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcEventHistoryEntry=dcEventHistoryEntry, dcCriticalAlarmName=dcCriticalAlarmName, dcHysteresis=dcHysteresis, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcSlope=dcSlope, dcEventProcessingEventType=dcEventProcessingEventType, dcControlEventTable=dcControlEventTable, dcLoadCurrent=dcLoadCurrent, batteryGroup=batteryGroup, dcBatteryParameter=dcBatteryParameter, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcUsMax=dcUsMax, dcBatteryStringName=dcBatteryStringName, dcEqualizeInterval=dcEqualizeInterval, dcRectifierEntry=dcRectifierEntry, dcLvdIndex=dcLvdIndex, dcBoostChargeStatus=dcBoostChargeStatus, dcPowerLimitation=dcPowerLimitation, dcPowerLimitationLimit=dcPowerLimitationLimit, dcPowerLimitationEntry=dcPowerLimitationEntry, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcBatteryStringIndex=dcBatteryStringIndex, dcTrapDestinationTable=dcTrapDestinationTable, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcRunawayVoltage=dcRunawayVoltage, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcEqualizeStatus=dcEqualizeStatus, dcSystemName=dcSystemName, dcEqualizeDuration=dcEqualizeDuration, dcMeterPanelEventName=dcMeterPanelEventName, dcMeasurementTable=dcMeasurementTable, dcTrapDestinationEntry=dcTrapDestinationEntry, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcLowTempSlope=dcLowTempSlope, dcCurrentLimit=dcCurrentLimit, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, orionBaseMibModule=orionBaseMibModule, PYSNMP_MODULE_ID=orionBaseMibModule, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcRectifierTable=dcRectifierTable, eventHistoryTableGroup=eventHistoryTableGroup, dcEqualizeEnabled=dcEqualizeEnabled, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, measurementTableGroup=measurementTableGroup, dcGenericAlarmIndex=dcGenericAlarmIndex, dcNumberRectifiers=dcNumberRectifiers, dcUaMax=dcUaMax, dcAlarmEventIdentifier=dcAlarmEventIdentifier, systemInfoGroup=systemInfoGroup, dcEqualizeControl=dcEqualizeControl, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcFloatCharge=dcFloatCharge, dcTrapDestinationPort=dcTrapDestinationPort, controllerObjects=controllerObjects, dcSystemAlarms=dcSystemAlarms, dcBatteryTestControl=dcBatteryTestControl, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcPowerLimitationEventName=dcPowerLimitationEventName, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcRectifierIndex=dcRectifierIndex, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcMaximumLoadStep=dcMaximumLoadStep, dcBoostChargeIstart=dcBoostChargeIstart, lvdTableGroup=lvdTableGroup, dcEventProcessingEventTable=dcEventProcessingEventTable, dcMeterPanelEventTable=dcMeterPanelEventTable, dcGenericAlarmTable=dcGenericAlarmTable, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcUsMin=dcUsMin, systemNonUrgentAlarm=systemNonUrgentAlarm, meterPanelEventTableGroup=meterPanelEventTableGroup, dcMeasurementName=dcMeasurementName, controllerBasicCompl=controllerBasicCompl, dcBatteryCurrent=dcBatteryCurrent, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcHighStartTemp=dcHighStartTemp, dcHighTemp=dcHighTemp, dcBatteryTestResults=dcBatteryTestResults, dcTempSupervision=dcTempSupervision, dcLvdName=dcLvdName, dcUrgentAlarmName=dcUrgentAlarmName, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, orionBaseMib=orionBaseMib, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcEventProcessingEventName=dcEventProcessingEventName, dcBatteryTestUsupport=dcBatteryTestUsupport, dcNumberRectifiersOkay=dcNumberRectifiersOkay, miscGroup=miscGroup, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcMainsFailureAlarm=dcMainsFailureAlarm, dcEqualizeTimeLag=dcEqualizeTimeLag, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, trapDestinationTableGroup=trapDestinationTableGroup, dcHighStopVoltage=dcHighStopVoltage, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcBatteryStringTable=dcBatteryStringTable, dcBatteryTestStatus=dcBatteryTestStatus, powerLimitationTableGroup=powerLimitationTableGroup, dcEventHistoryMessage=dcEventHistoryMessage, dcBattery=dcBattery, dcSystemVoltage=dcSystemVoltage, dcBatteryTestInterval=dcBatteryTestInterval, dcStopTemp=dcStopTemp, dcEqualizeParameter=dcEqualizeParameter, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcBoostChargeIstop=dcBoostChargeIstop, dcGenericAlarmEntry=dcGenericAlarmEntry, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcTempCompType=dcTempCompType, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcRectifierGroupEntry=dcRectifierGroupEntry, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcNumberCriticalAlarms=dcNumberCriticalAlarms, genericAlarmTableGroup=genericAlarmTableGroup, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcRectifierIdentifier=dcRectifierIdentifier, dcEqualizeVoltage=dcEqualizeVoltage, defaultLogEventTableGroup=defaultLogEventTableGroup, dcEventHistoryTable=dcEventHistoryTable, dcMeasurementIndex=dcMeasurementIndex, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcRectifierCurrent=dcRectifierCurrent, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcPowerLimitationType=dcPowerLimitationType, dcChargeState=dcChargeState, dcBatteryTemperature=dcBatteryTemperature, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcTrapDestinationIndex=dcTrapDestinationIndex, dcLvdTable=dcLvdTable, controllerConfs=controllerConfs, systemMonitorGroup=systemMonitorGroup, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcLowStopVoltage=dcLowStopVoltage, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcEventHistoryIndex=dcEventHistoryIndex, dcRectifierGroupIndex=dcRectifierGroupIndex, dcAlarmEventCategory=dcAlarmEventCategory, dcUaMin=dcUaMin, dcBatteryTestResult=dcBatteryTestResult, dcPowerLimitationTable=dcPowerLimitationTable)
