...
Counter32, IpAddress, TimeTicks, enterprises, Unsigned32, Gauge32, Counter64, Integer32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "TimeTicks", "enterprises", "Unsigned32", "Gauge32", "Counter64", "Integer32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcSystemName=dcSystemName, dcEqualizeEnabled=dcEqualizeEnabled, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcBatteryCurrent=dcBatteryCurrent, dcBatteryTestUsupport=dcBatteryTestUsupport, dcEventHistoryMessage=dcEventHistoryMessage, dcTempCompType=dcTempCompType, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcUaMax=dcUaMax, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcMeasurementValue=dcMeasurementValue, dcBatteryTestControl=dcBatteryTestControl, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcRectifierCurrent=dcRectifierCurrent, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcControlEventIndex=dcControlEventIndex, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcBatteryTestParameter=dcBatteryTestParameter, systemAlarmGroup=systemAlarmGroup, dcPowerLimitationEntry=dcPowerLimitationEntry, eventHistoryTableGroup=eventHistoryTableGroup, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcBatteryTestResults=dcBatteryTestResults, dcPowerLimitationTable=dcPowerLimitationTable, dcBatteryTest=dcBatteryTest, dcPowerLimitationLimit=dcPowerLimitationLimit, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcHighStopVoltage=dcHighStopVoltage, dcBoostChargeIstop=dcBoostChargeIstop, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcMeterPanelEventTable=dcMeterPanelEventTable, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcMisc=dcMisc, dcEnableUsTempComp=dcEnableUsTempComp, alarmTableGroup=alarmTableGroup, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, genericAlarmTableGroup=genericAlarmTableGroup, controllerEvents=controllerEvents, dcBatteryTemperature=dcBatteryTemperature, dcAlarmIndex=dcAlarmIndex, dcControlEventName=dcControlEventName, dcDefaultLogEventTable=dcDefaultLogEventTable, dcGenericAlarmTable=dcGenericAlarmTable, dcBatteryStringCapacity=dcBatteryStringCapacity, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcBatteryStringIndex=dcBatteryStringIndex, trapDestinationTableGroup=trapDestinationTableGroup, dcEqualizeStatus=dcEqualizeStatus, dcRectifierGroupIndex=dcRectifierGroupIndex, dcUsys20=dcUsys20, systemCriticalAlarm=systemCriticalAlarm, dcSystemMonitor=dcSystemMonitor, dcBoostChargeControl=dcBoostChargeControl, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcAlarmEntry=dcAlarmEntry, dcBatteryStringEntry=dcBatteryStringEntry, dcBatteryStringName=dcBatteryStringName, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, miscGroup=miscGroup, lvdTableGroup=lvdTableGroup, dcMaximumLoadStep=dcMaximumLoadStep, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, meterPanelEventTableGroup=meterPanelEventTableGroup, dcHighTemp=dcHighTemp, dcLoadCurrent=dcLoadCurrent, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcLvdIndex=dcLvdIndex, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, controllerBasicCompl=controllerBasicCompl, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcRectifierEntry=dcRectifierEntry, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcFileProcessingStatus=dcFileProcessingStatus, dcPowerLimitationIndex=dcPowerLimitationIndex, dcEventProcessingEventName=dcEventProcessingEventName, dcLvdEntry=dcLvdEntry, notificationsGroup=notificationsGroup, dcEventHistoryTable=dcEventHistoryTable, dcTrapDestinationPort=dcTrapDestinationPort, dcRectifierStatus=dcRectifierStatus, dcCriticalAlarmName=dcCriticalAlarmName, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcSystemAlarms=dcSystemAlarms, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcTempComp=dcTempComp, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcCriticalAlarmValue=dcCriticalAlarmValue, dcEvtCtrlCharge=dcEvtCtrlCharge, dcMaxVoltage=dcMaxVoltage, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcDefaultLogEventIndex=dcDefaultLogEventIndex, orionBaseMib=orionBaseMib, dcLossOfBackupTime=dcLossOfBackupTime, dcEventHistoryIndex=dcEventHistoryIndex, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcMeterPanelEventName=dcMeterPanelEventName, dcDefaultLogEventName=dcDefaultLogEventName, rectifierTableGroup=rectifierTableGroup, powerLimitationTableGroup=powerLimitationTableGroup, dcRunawayVoltage=dcRunawayVoltage, dcSystemInfo=dcSystemInfo, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcTrapDestinationEntry=dcTrapDestinationEntry, dcEqualizeParameter=dcEqualizeParameter, dcLowTempSlope=dcLowTempSlope, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcSiteName=dcSiteName, dcBoostChargeType=dcBoostChargeType, dcStartTemp=dcStartTemp, systemInfoGroup=systemInfoGroup, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcSystemPower=dcSystemPower, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcUaMin=dcUaMin, dcEqualizeVoltage=dcEqualizeVoltage, dcFloatCharge=dcFloatCharge, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcTempSupervision=dcTempSupervision, dcGenericAlarmIndex=dcGenericAlarmIndex, dcTrapDestinationIndex=dcTrapDestinationIndex, dcSoftwareVersion=dcSoftwareVersion, dcEventProcessingEventType=dcEventProcessingEventType, systemMonitorGroup=systemMonitorGroup, dcLowStartTemp=dcLowStartTemp, dcRectifierIdentifier=dcRectifierIdentifier, dcRectifierTable=dcRectifierTable, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, controllerGroups=controllerGroups, dcAlarmEventName=dcAlarmEventName, controlEventTableGroup=controlEventTableGroup, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcMeasurementUnit=dcMeasurementUnit, dcExpectedBackupTime=dcExpectedBackupTime, dcHighTempHyst=dcHighTempHyst, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcPowerLimitation=dcPowerLimitation, dcBatteryTestResult=dcBatteryTestResult, dcBoostChargeParameter=dcBoostChargeParameter, PYSNMP_MODULE_ID=orionBaseMibModule, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcNumberRectifiers=dcNumberRectifiers, dcBatteryTestType=dcBatteryTestType, dcCurrentLimit=dcCurrentLimit, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcEqualize=dcEqualize, dcPowerLimitationStatus=dcPowerLimitationStatus, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcGenericAlarmEventName=dcGenericAlarmEventName, dcMeasurementIndex=dcMeasurementIndex, dcMeterPanelEventValue=dcMeterPanelEventValue, controllerEventsV2=controllerEventsV2, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcStopTemp=dcStopTemp, dcEventProcessingEventTable=dcEventProcessingEventTable, dcControlEventValue=dcControlEventValue, dcRectifier=dcRectifier, dcEqualizeInterval=dcEqualizeInterval, dcMeasurement=dcMeasurement, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcMeasurementTable=dcMeasurementTable, dcSystemDateTime=dcSystemDateTime, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcBatteryTestDateTime=dcBatteryTestDateTime, dcMinimumLoadStep=dcMinimumLoadStep, rectifierGroup=rectifierGroup, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcUsMax=dcUsMax, dcControlEventTable=dcControlEventTable, dcBatteryTestTempTo=dcBatteryTestTempTo, dcTrapDestinationTable=dcTrapDestinationTable, dcBatteryStringTable=dcBatteryStringTable, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcEqualizeDuration=dcEqualizeDuration, dcMainsFailureAlarm=dcMainsFailureAlarm, orionBaseMibModule=orionBaseMibModule, dcSystemVoltage=dcSystemVoltage, dcBoostChargeStatus=dcBoostChargeStatus, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcLvdName=dcLvdName, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcBatteryTestStatus=dcBatteryTestStatus, controllerEventObjects=controllerEventObjects, dcTrapDestinationIp=dcTrapDestinationIp, dcUrgentAlarmValue=dcUrgentAlarmValue, batteryStringTableGroup=batteryStringTableGroup, dcRunawayTemp=dcRunawayTemp, dcInputOutput=dcInputOutput, dcMeasurementEntry=dcMeasurementEntry, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcEfficiencyCycling=dcEfficiencyCycling, dcAlarmTable=dcAlarmTable, dcPowerLimitationType=dcPowerLimitationType, dcEqualizeTimeLag=dcEqualizeTimeLag, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcHighTempSlope=dcHighTempSlope, dcUrgentAlarmName=dcUrgentAlarmName, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, batteryGroup=batteryGroup, measurementTableGroup=measurementTableGroup, dcEqualizeLeadTime=dcEqualizeLeadTime, dcRectifierGroupTable=dcRectifierGroupTable, dcHighStartTemp=dcHighStartTemp, dcEventHistoryEntry=dcEventHistoryEntry, dcControlEventIdentifier=dcControlEventIdentifier, dcBoostChargeVoltage=dcBoostChargeVoltage, dcControlEventEntry=dcControlEventEntry, dcLvdTable=dcLvdTable, dcRectifierGroupName=dcRectifierGroupName, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, systemUrgentAlarm=systemUrgentAlarm, dcUsMin=dcUsMin, dcGenericAlarmEntry=dcGenericAlarmEntry, dcBoostCharge=dcBoostCharge, dcAlarmEventCategory=dcAlarmEventCategory, systemNonUrgentAlarm=systemNonUrgentAlarm, defaultLogEventTableGroup=defaultLogEventTableGroup, dcBoD=dcBoD, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcPowerLimitationEventName=dcPowerLimitationEventName, dcConfig=dcConfig, dcRectifierIndex=dcRectifierIndex, dcRectifierGroupEntry=dcRectifierGroupEntry, dcHysteresis=dcHysteresis, dcEqualizeControl=dcEqualizeControl, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcLowStopVoltage=dcLowStopVoltage, dcRectifierFunctions=dcRectifierFunctions, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, controllerCompl=controllerCompl, dcChargeState=dcChargeState, dcBatteryTestInterval=dcBatteryTestInterval)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcBattery=dcBattery, dcBatteryParameter=dcBatteryParameter, dcBoostChargeIstart=dcBoostChargeIstart, controllerObjects=controllerObjects, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcBatteryTestDuration=dcBatteryTestDuration, dcMeasurementName=dcMeasurementName, dcMeterPanel=dcMeterPanel, dcSlope=dcSlope, dcAlarmEventValue=dcAlarmEventValue, rectifierGroupTableGroup=rectifierGroupTableGroup, dcSystemVoltageSupervision=dcSystemVoltageSupervision, controllerConfs=controllerConfs)
