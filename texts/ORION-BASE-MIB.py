...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Counter32, Integer32, NotificationType, iso, MibIdentifier, Unsigned32, Gauge32, ModuleIdentity, Bits, ObjectIdentity, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Counter32", "Integer32", "NotificationType", "iso", "MibIdentifier", "Unsigned32", "Gauge32", "ModuleIdentity", "Bits", "ObjectIdentity", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcSystemDateTime=dcSystemDateTime, dcEventProcessingEventTable=dcEventProcessingEventTable, dcControlEventName=dcControlEventName, dcUsys20=dcUsys20, dcMeasurementIndex=dcMeasurementIndex, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcMisc=dcMisc, dcPowerLimitationEventName=dcPowerLimitationEventName, dcMeasurementName=dcMeasurementName, dcLowTempSlope=dcLowTempSlope, dcSystemName=dcSystemName, dcPowerLimitationIndex=dcPowerLimitationIndex, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcControlEventEntry=dcControlEventEntry, dcBatteryStringName=dcBatteryStringName, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, meterPanelEventTableGroup=meterPanelEventTableGroup, dcBatteryTestType=dcBatteryTestType, dcHighStopVoltage=dcHighStopVoltage, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcHighTemp=dcHighTemp, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcRectifier=dcRectifier, miscGroup=miscGroup, dcBoostChargeType=dcBoostChargeType, dcBatteryTestResults=dcBatteryTestResults, dcChargeState=dcChargeState, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcUrgentAlarmName=dcUrgentAlarmName, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcMeterPanelEventTable=dcMeterPanelEventTable, dcBoD=dcBoD, dcAlarmTable=dcAlarmTable, systemAlarmGroup=systemAlarmGroup, dcEqualizeParameter=dcEqualizeParameter, dcSystemMonitor=dcSystemMonitor, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, defaultLogEventTableGroup=defaultLogEventTableGroup, dcLvdEntry=dcLvdEntry, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcCriticalAlarmName=dcCriticalAlarmName, dcSystemPower=dcSystemPower, dcRunawayVoltage=dcRunawayVoltage, dcMeasurementValue=dcMeasurementValue, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcMeterPanelEventName=dcMeterPanelEventName, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcBatteryStringIndex=dcBatteryStringIndex, controllerEventObjects=controllerEventObjects, dcAlarmEventValue=dcAlarmEventValue, dcSoftwareVersion=dcSoftwareVersion, dcBatteryStringTable=dcBatteryStringTable, dcBoostChargeStatus=dcBoostChargeStatus, dcMeasurementTable=dcMeasurementTable, dcTempCompType=dcTempCompType, dcTrapDestinationIp=dcTrapDestinationIp, dcBattery=dcBattery, dcHysteresis=dcHysteresis, dcNumberRectifiers=dcNumberRectifiers, dcControlEventTable=dcControlEventTable, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcUsMax=dcUsMax, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcCriticalAlarmValue=dcCriticalAlarmValue, dcCurrentLimit=dcCurrentLimit, PYSNMP_MODULE_ID=orionBaseMibModule, rectifierGroup=rectifierGroup, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcTempSupervision=dcTempSupervision, dcLowStartTemp=dcLowStartTemp, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcEqualizeLeadTime=dcEqualizeLeadTime, dcRectifierStatus=dcRectifierStatus, dcBoostChargeIstop=dcBoostChargeIstop, dcUsMin=dcUsMin, dcEventHistoryIndex=dcEventHistoryIndex, dcEqualizeEnabled=dcEqualizeEnabled, dcLoadCurrent=dcLoadCurrent, dcEventProcessingEventType=dcEventProcessingEventType, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcGenericAlarmEntry=dcGenericAlarmEntry, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcLvdTable=dcLvdTable, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, alarmTableGroup=alarmTableGroup, dcSystemAlarms=dcSystemAlarms, dcEfficiencyCycling=dcEfficiencyCycling, genericAlarmTableGroup=genericAlarmTableGroup, orionBaseMibModule=orionBaseMibModule, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcMeterPanel=dcMeterPanel, dcMeasurementUnit=dcMeasurementUnit, systemNonUrgentAlarm=systemNonUrgentAlarm, dcEventProcessingEventSelected=dcEventProcessingEventSelected, lvdTableGroup=lvdTableGroup, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcHighTempSlope=dcHighTempSlope, dcAlarmIndex=dcAlarmIndex, dcStartTemp=dcStartTemp, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcSlope=dcSlope, dcSystemVoltage=dcSystemVoltage, dcBatteryCurrent=dcBatteryCurrent, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, notificationsGroup=notificationsGroup, dcRectifierGroupEntry=dcRectifierGroupEntry, dcBatteryStringCapacity=dcBatteryStringCapacity, controllerConfs=controllerConfs, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcBoostChargeIstart=dcBoostChargeIstart, dcBoostCharge=dcBoostCharge, dcStopTemp=dcStopTemp, dcEqualize=dcEqualize, dcControlEventIndex=dcControlEventIndex, dcEnableUsTempComp=dcEnableUsTempComp, dcBatteryTestControl=dcBatteryTestControl, dcEventHistoryTable=dcEventHistoryTable, batteryGroup=batteryGroup, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcBatteryTestDuration=dcBatteryTestDuration, rectifierGroupTableGroup=rectifierGroupTableGroup, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcMaximumLoadStep=dcMaximumLoadStep, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcBatteryTestInterval=dcBatteryTestInterval, dcConfig=dcConfig, dcMeterPanelEventIndex=dcMeterPanelEventIndex, systemCriticalAlarm=systemCriticalAlarm, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcRectifierGroupTable=dcRectifierGroupTable, dcTrapDestinationPort=dcTrapDestinationPort, dcPowerLimitationEntry=dcPowerLimitationEntry, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcEqualizeTimeLag=dcEqualizeTimeLag, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcUaMax=dcUaMax, controllerObjects=controllerObjects, dcEqualizeInterval=dcEqualizeInterval, dcGenericAlarmIndex=dcGenericAlarmIndex, dcFloatCharge=dcFloatCharge, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcBatteryTest=dcBatteryTest, dcBatteryStringEntry=dcBatteryStringEntry, dcPowerLimitationLimit=dcPowerLimitationLimit, dcRectifierTable=dcRectifierTable, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, systemInfoGroup=systemInfoGroup, dcMeterPanelEventEntry=dcMeterPanelEventEntry, controllerEvents=controllerEvents, dcBatteryTestUsupport=dcBatteryTestUsupport, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcDefaultLogEventName=dcDefaultLogEventName, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcMeterPanelEventValue=dcMeterPanelEventValue, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcRectifierEntry=dcRectifierEntry, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcLvdIndex=dcLvdIndex, dcSiteName=dcSiteName, dcRectifierIndex=dcRectifierIndex, dcRectifierIdentifier=dcRectifierIdentifier, dcDefaultLogEventTable=dcDefaultLogEventTable, dcPowerLimitationTable=dcPowerLimitationTable, dcSystemInfo=dcSystemInfo, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcEventHistoryMessage=dcEventHistoryMessage, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, systemMonitorGroup=systemMonitorGroup, dcUrgentAlarmValue=dcUrgentAlarmValue, dcEvtCtrlCharge=dcEvtCtrlCharge, dcEqualizeDuration=dcEqualizeDuration, dcAlarmEntry=dcAlarmEntry, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcRectifierGroupName=dcRectifierGroupName, orionBaseMib=orionBaseMib, dcInputOutput=dcInputOutput, dcBoostChargeControl=dcBoostChargeControl, dcPowerLimitation=dcPowerLimitation, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcTempComp=dcTempComp, dcRectifierCurrent=dcRectifierCurrent, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcEventHistoryEntry=dcEventHistoryEntry, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcAlarmEventCategory=dcAlarmEventCategory, dcBatteryParameter=dcBatteryParameter, dcBoostChargeVoltage=dcBoostChargeVoltage, dcTrapDestinationTable=dcTrapDestinationTable, trapDestinationTableGroup=trapDestinationTableGroup, dcGenericAlarmTable=dcGenericAlarmTable, dcRectifierFunctions=dcRectifierFunctions, dcControlEventIdentifier=dcControlEventIdentifier, dcFileProcessingStatus=dcFileProcessingStatus, dcHighStartTemp=dcHighStartTemp, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcUaMin=dcUaMin, dcRectifierGroupIndex=dcRectifierGroupIndex, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcEqualizeControl=dcEqualizeControl, dcBatteryTemperature=dcBatteryTemperature, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, eventHistoryTableGroup=eventHistoryTableGroup, controlEventTableGroup=controlEventTableGroup, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcRunawayTemp=dcRunawayTemp, dcBoostChargeParameter=dcBoostChargeParameter, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcMeasurementEntry=dcMeasurementEntry, dcMinimumLoadStep=dcMinimumLoadStep, dcBatteryTestResult=dcBatteryTestResult, rectifierTableGroup=rectifierTableGroup, dcEqualizeVoltage=dcEqualizeVoltage, dcMainsFailureAlarm=dcMainsFailureAlarm, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcBatteryTestTempFrom=dcBatteryTestTempFrom, controllerCompl=controllerCompl, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcEventProcessingEventName=dcEventProcessingEventName, dcBatteryTestStatus=dcBatteryTestStatus, dcBatteryTestMinDuration=dcBatteryTestMinDuration, controllerGroups=controllerGroups, dcAlarmEventName=dcAlarmEventName, dcBatteryTestTempTo=dcBatteryTestTempTo, dcBatteryTestParameter=dcBatteryTestParameter, dcMaxVoltage=dcMaxVoltage, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcHighTempHyst=dcHighTempHyst, dcEqualizeStatus=dcEqualizeStatus, dcLowStopVoltage=dcLowStopVoltage, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, controllerBasicCompl=controllerBasicCompl, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcGenericAlarmEventName=dcGenericAlarmEventName, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcControlEventValue=dcControlEventValue, dcTrapDestinationIndex=dcTrapDestinationIndex, systemUrgentAlarm=systemUrgentAlarm, dcMeasurement=dcMeasurement, dcDefaultLogEventEntry=dcDefaultLogEventEntry, powerLimitationTableGroup=powerLimitationTableGroup, dcEventProcessingEventIndex=dcEventProcessingEventIndex, controllerEventsV2=controllerEventsV2)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcBatteryTestDateTime=dcBatteryTestDateTime, dcBoostChargeTimeLag=dcBoostChargeTimeLag, batteryStringTableGroup=batteryStringTableGroup, dcPowerLimitationType=dcPowerLimitationType, measurementTableGroup=measurementTableGroup, dcTrapDestinationEntry=dcTrapDestinationEntry, dcPowerLimitationStatus=dcPowerLimitationStatus, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcLvdName=dcLvdName, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcLossOfBackupTime=dcLossOfBackupTime, dcExpectedBackupTime=dcExpectedBackupTime)
