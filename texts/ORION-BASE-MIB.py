...
ModuleIdentity, Gauge32, ObjectIdentity, Counter64, TimeTicks, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, iso, enterprises, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Counter64", "TimeTicks", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "iso", "enterprises", "Integer32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcHighTemp=dcHighTemp, dcEqualizeStatus=dcEqualizeStatus, controllerBasicCompl=controllerBasicCompl, dcPowerLimitationTable=dcPowerLimitationTable, dcMaxVoltage=dcMaxVoltage, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcEqualizeLeadTime=dcEqualizeLeadTime, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcLoadCurrent=dcLoadCurrent, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcBatteryStringTable=dcBatteryStringTable, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcBoostChargeStatus=dcBoostChargeStatus, alarmTableGroup=alarmTableGroup, dcUsMin=dcUsMin, systemAlarmGroup=systemAlarmGroup, dcPowerLimitationType=dcPowerLimitationType, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcSystemPower=dcSystemPower, dcControlEventName=dcControlEventName, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcControlEventIndex=dcControlEventIndex, dcTrapDestinationEntry=dcTrapDestinationEntry, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcRectifierIndex=dcRectifierIndex, dcSystemVoltage=dcSystemVoltage, dcChargeState=dcChargeState, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcPowerLimitationLimit=dcPowerLimitationLimit, dcStopTemp=dcStopTemp, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcBatteryTestControl=dcBatteryTestControl, dcBatteryStringIndex=dcBatteryStringIndex, dcRectifierIdentifier=dcRectifierIdentifier, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcEqualizeControl=dcEqualizeControl, dcRunawayTemp=dcRunawayTemp, dcBattery=dcBattery, dcBoostChargeVoltage=dcBoostChargeVoltage, dcAlarmIndex=dcAlarmIndex, dcBoostChargeControl=dcBoostChargeControl, dcBatteryStringCapacity=dcBatteryStringCapacity, batteryGroup=batteryGroup, dcUrgentAlarmName=dcUrgentAlarmName, dcPowerLimitation=dcPowerLimitation, measurementTableGroup=measurementTableGroup, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcEqualizeEnabled=dcEqualizeEnabled, dcSystemInfo=dcSystemInfo, dcEqualize=dcEqualize, dcSystemMonitor=dcSystemMonitor, dcControlEventTable=dcControlEventTable, dcNumberRectifiers=dcNumberRectifiers, dcEnableUsTempComp=dcEnableUsTempComp, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcPowerLimitationStatus=dcPowerLimitationStatus, dcCriticalAlarmName=dcCriticalAlarmName, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, controllerEventObjects=controllerEventObjects, dcRectifierFunctions=dcRectifierFunctions, dcEqualizeVoltage=dcEqualizeVoltage, dcRectifier=dcRectifier, dcEqualizeParameter=dcEqualizeParameter, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcMeasurement=dcMeasurement, dcBatteryTestDuration=dcBatteryTestDuration, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcEqualizeDuration=dcEqualizeDuration, dcHysteresis=dcHysteresis, dcUsMax=dcUsMax, dcBatteryTestParameter=dcBatteryTestParameter, dcMeasurementUnit=dcMeasurementUnit, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcBatteryTestStatus=dcBatteryTestStatus, dcFileProcessingStatus=dcFileProcessingStatus, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcEqualizeInterval=dcEqualizeInterval, dcMeterPanelEventIndex=dcMeterPanelEventIndex, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcStartTemp=dcStartTemp, controllerEvents=controllerEvents, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcEventHistoryTable=dcEventHistoryTable, dcMaximumLoadStep=dcMaximumLoadStep, dcRectifierEntry=dcRectifierEntry, dcEventHistoryMessage=dcEventHistoryMessage, dcGenericAlarmTable=dcGenericAlarmTable, dcRectifierGroupTable=dcRectifierGroupTable, dcInputOutput=dcInputOutput, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcBatteryTestType=dcBatteryTestType, dcBoostChargeType=dcBoostChargeType, dcHighStopVoltage=dcHighStopVoltage, dcEventHistoryIndex=dcEventHistoryIndex, dcLvdName=dcLvdName, dcBatteryCurrent=dcBatteryCurrent, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcTrapDestinationIp=dcTrapDestinationIp, dcGenericAlarmEntry=dcGenericAlarmEntry, dcCriticalAlarmValue=dcCriticalAlarmValue, dcLvdTable=dcLvdTable, systemNonUrgentAlarm=systemNonUrgentAlarm, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcSystemName=dcSystemName, dcMainsFailureAlarm=dcMainsFailureAlarm, dcBoostChargeIstop=dcBoostChargeIstop, controllerEventsV2=controllerEventsV2, powerLimitationTableGroup=powerLimitationTableGroup, dcPowerLimitationEventName=dcPowerLimitationEventName, dcRectifierStatus=dcRectifierStatus, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcUaMin=dcUaMin, dcMeterPanel=dcMeterPanel, systemInfoGroup=systemInfoGroup, dcMeterPanelEventValue=dcMeterPanelEventValue, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcMinimumLoadStep=dcMinimumLoadStep, dcBatteryTestResult=dcBatteryTestResult, dcAlarmEntry=dcAlarmEntry, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcUaMax=dcUaMax, dcSystemDateTime=dcSystemDateTime, dcBatteryTestInterval=dcBatteryTestInterval, trapDestinationTableGroup=trapDestinationTableGroup, meterPanelEventTableGroup=meterPanelEventTableGroup, dcLossOfBackupTime=dcLossOfBackupTime, dcEventProcessingEventTable=dcEventProcessingEventTable, dcLowStartTemp=dcLowStartTemp, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcEventHistoryEntry=dcEventHistoryEntry, miscGroup=miscGroup, dcEventProcessingEventName=dcEventProcessingEventName, rectifierGroupTableGroup=rectifierGroupTableGroup, dcMeterPanelEventName=dcMeterPanelEventName, batteryStringTableGroup=batteryStringTableGroup, dcMeasurementEntry=dcMeasurementEntry, rectifierTableGroup=rectifierTableGroup, dcEvtCtrlCharge=dcEvtCtrlCharge, dcEventProcessingEventEntry=dcEventProcessingEventEntry, orionBaseMibModule=orionBaseMibModule, dcBatteryParameter=dcBatteryParameter, dcHighTempSlope=dcHighTempSlope, lvdTableGroup=lvdTableGroup, dcControlEventEntry=dcControlEventEntry, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcAlarmEventValue=dcAlarmEventValue, dcFloatCharge=dcFloatCharge, dcBoD=dcBoD, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcMeasurementName=dcMeasurementName, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcPowerLimitationEntry=dcPowerLimitationEntry, dcBoostCharge=dcBoostCharge, dcRectifierTable=dcRectifierTable, dcMeasurementScaleFactor=dcMeasurementScaleFactor, systemUrgentAlarm=systemUrgentAlarm, dcBatteryTestTempTo=dcBatteryTestTempTo, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcLowStopVoltage=dcLowStopVoltage, dcLowTempSlope=dcLowTempSlope, dcRunawayVoltage=dcRunawayVoltage, controlEventTableGroup=controlEventTableGroup, dcTrapDestinationIndex=dcTrapDestinationIndex, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcRectifierCurrent=dcRectifierCurrent, dcBatteryTestUsupport=dcBatteryTestUsupport, dcEfficiencyCycling=dcEfficiencyCycling, controllerConfs=controllerConfs, controllerGroups=controllerGroups, dcSystemAlarms=dcSystemAlarms, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcLvdEntry=dcLvdEntry, dcDefaultLogEventName=dcDefaultLogEventName, controllerCompl=controllerCompl, dcEventProcessingEventType=dcEventProcessingEventType, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcRectifierGroupIndex=dcRectifierGroupIndex, dcGenericAlarmEventValue=dcGenericAlarmEventValue, defaultLogEventTableGroup=defaultLogEventTableGroup, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcPowerLimitationIndex=dcPowerLimitationIndex, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcMisc=dcMisc, genericAlarmTableGroup=genericAlarmTableGroup, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, rectifierGroup=rectifierGroup, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, PYSNMP_MODULE_ID=orionBaseMibModule, orionBaseMib=orionBaseMib, dcSoftwareVersion=dcSoftwareVersion, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, systemCriticalAlarm=systemCriticalAlarm, dcControlEventIdentifier=dcControlEventIdentifier, dcTrapDestinationPort=dcTrapDestinationPort, dcMeasurementValue=dcMeasurementValue, dcTrapDestinationTable=dcTrapDestinationTable, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcAlarmTable=dcAlarmTable, dcBatteryStringName=dcBatteryStringName, dcUsys20=dcUsys20, dcBatteryTestResults=dcBatteryTestResults, dcTempComp=dcTempComp, dcCurrentLimit=dcCurrentLimit, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcAlarmEventName=dcAlarmEventName, dcExpectedBackupTime=dcExpectedBackupTime, dcGenericAlarmEventName=dcGenericAlarmEventName, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcMeasurementTable=dcMeasurementTable, dcControlEventValue=dcControlEventValue, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcLvdIndex=dcLvdIndex, systemMonitorGroup=systemMonitorGroup, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcConfig=dcConfig, dcBatteryTest=dcBatteryTest, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcTempCompType=dcTempCompType, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcBoostChargeParameter=dcBoostChargeParameter, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcSlope=dcSlope, dcHighTempHyst=dcHighTempHyst, dcBatteryStringEntry=dcBatteryStringEntry, dcMeasurementIndex=dcMeasurementIndex, controllerObjects=controllerObjects, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcBatteryTemperature=dcBatteryTemperature, eventHistoryTableGroup=eventHistoryTableGroup, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcBatteryTestDateTime=dcBatteryTestDateTime, dcTempSupervision=dcTempSupervision, dcMeterPanelEventTable=dcMeterPanelEventTable, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcAlarmEventCategory=dcAlarmEventCategory, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcGenericAlarmIndex=dcGenericAlarmIndex)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcEqualizeTimeLag=dcEqualizeTimeLag, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcDefaultLogEventTable=dcDefaultLogEventTable, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcSiteName=dcSiteName, dcRectifierGroupName=dcRectifierGroupName, dcBoostChargeIstart=dcBoostChargeIstart, dcUrgentAlarmValue=dcUrgentAlarmValue, dcRectifierGroupEntry=dcRectifierGroupEntry, notificationsGroup=notificationsGroup, dcHighStartTemp=dcHighStartTemp, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff)
