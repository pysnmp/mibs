...
enterprises, Bits, Gauge32, Integer32, TimeTicks, ModuleIdentity, NotificationType, iso, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Gauge32", "Integer32", "TimeTicks", "ModuleIdentity", "NotificationType", "iso", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcMeasurementTable=dcMeasurementTable, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcStopTemp=dcStopTemp, dcMaximumLoadStep=dcMaximumLoadStep, dcRectifierGroupIndex=dcRectifierGroupIndex, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcRectifierGroupTable=dcRectifierGroupTable, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcRectifierStatus=dcRectifierStatus, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcMeterPanelEventName=dcMeterPanelEventName, dcBatteryTestResult=dcBatteryTestResult, batteryGroup=batteryGroup, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcPowerLimitation=dcPowerLimitation, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcGenericAlarmEventName=dcGenericAlarmEventName, powerLimitationTableGroup=powerLimitationTableGroup, dcSoftwareVersion=dcSoftwareVersion, dcControlEventIndex=dcControlEventIndex, dcRectifierIdentifier=dcRectifierIdentifier, dcTrapDestinationPort=dcTrapDestinationPort, dcTempComp=dcTempComp, orionBaseMib=orionBaseMib, dcAlarmEventName=dcAlarmEventName, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcHighTempSlope=dcHighTempSlope, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcBatteryStringName=dcBatteryStringName, dcUrgentAlarmValue=dcUrgentAlarmValue, notificationsGroup=notificationsGroup, dcCriticalAlarmName=dcCriticalAlarmName, dcLossOfBackupTime=dcLossOfBackupTime, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcAlarmEventCategory=dcAlarmEventCategory, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcEnableUsTempComp=dcEnableUsTempComp, PYSNMP_MODULE_ID=orionBaseMibModule, dcBatteryTestInterval=dcBatteryTestInterval, dcBatteryTestType=dcBatteryTestType, systemInfoGroup=systemInfoGroup, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcRunawayTemp=dcRunawayTemp, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcBoostChargeStatus=dcBoostChargeStatus, dcEqualizeEnabled=dcEqualizeEnabled, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcBatteryCurrent=dcBatteryCurrent, dcEventProcessingEventType=dcEventProcessingEventType, dcRectifierCurrent=dcRectifierCurrent, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcBatteryStringCapacity=dcBatteryStringCapacity, dcCurrentLimit=dcCurrentLimit, dcBoostChargeIstart=dcBoostChargeIstart, dcRectifierFunctions=dcRectifierFunctions, dcUaMin=dcUaMin, dcRectifier=dcRectifier, dcHighStopVoltage=dcHighStopVoltage, dcAlarmEntry=dcAlarmEntry, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcGenericAlarmEventValue=dcGenericAlarmEventValue, systemMonitorGroup=systemMonitorGroup, dcUrgentAlarmName=dcUrgentAlarmName, dcBoostChargeType=dcBoostChargeType, eventHistoryTableGroup=eventHistoryTableGroup, dcBatteryTestResults=dcBatteryTestResults, alarmTableGroup=alarmTableGroup, dcMeasurementValue=dcMeasurementValue, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcMisc=dcMisc, dcRectifierTable=dcRectifierTable, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcEqualizeParameter=dcEqualizeParameter, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcPowerLimitationIndex=dcPowerLimitationIndex, dcEvtCtrlCharge=dcEvtCtrlCharge, dcControlEventIdentifier=dcControlEventIdentifier, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcBatteryTestDuration=dcBatteryTestDuration, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, rectifierGroup=rectifierGroup, dcEqualizeInterval=dcEqualizeInterval, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcPowerLimitationEventName=dcPowerLimitationEventName, dcBatteryStringEntry=dcBatteryStringEntry, dcSystemVoltage=dcSystemVoltage, systemCriticalAlarm=systemCriticalAlarm, defaultLogEventTableGroup=defaultLogEventTableGroup, controllerEvents=controllerEvents, dcConfig=dcConfig, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcGenericAlarmEntry=dcGenericAlarmEntry, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcBatteryTemperature=dcBatteryTemperature, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcTempCompType=dcTempCompType, controllerCompl=controllerCompl, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcMeasurement=dcMeasurement, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcBoostChargeParameter=dcBoostChargeParameter, dcMainsFailureAlarm=dcMainsFailureAlarm, dcBatteryTestTempTo=dcBatteryTestTempTo, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcBoD=dcBoD, dcDefaultLogEventName=dcDefaultLogEventName, systemAlarmGroup=systemAlarmGroup, miscGroup=miscGroup, dcEventHistoryTable=dcEventHistoryTable, dcEventProcessingEventName=dcEventProcessingEventName, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcMeasurementUnit=dcMeasurementUnit, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcBattery=dcBattery, dcPowerLimitationStatus=dcPowerLimitationStatus, dcLvdTable=dcLvdTable, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcSiteName=dcSiteName, orionBaseMibModule=orionBaseMibModule, dcBoostChargeIstop=dcBoostChargeIstop, systemUrgentAlarm=systemUrgentAlarm, dcRunawayVoltage=dcRunawayVoltage, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcChargeState=dcChargeState, dcLvdEntry=dcLvdEntry, dcMeterPanel=dcMeterPanel, dcHighTemp=dcHighTemp, dcTrapDestinationIp=dcTrapDestinationIp, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcUsMin=dcUsMin, controlEventTableGroup=controlEventTableGroup, controllerObjects=controllerObjects, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcNumberRectifiers=dcNumberRectifiers, dcExpectedBackupTime=dcExpectedBackupTime, dcFileProcessingStatus=dcFileProcessingStatus, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcBoostChargeVoltage=dcBoostChargeVoltage, dcHysteresis=dcHysteresis, dcEqualize=dcEqualize, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcEventHistoryEntry=dcEventHistoryEntry, dcInputOutput=dcInputOutput, controllerEventsV2=controllerEventsV2, dcAlarmEventValue=dcAlarmEventValue, dcPowerLimitationLimit=dcPowerLimitationLimit, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcControlEventTable=dcControlEventTable, dcPowerLimitationEntry=dcPowerLimitationEntry, measurementTableGroup=measurementTableGroup, systemNonUrgentAlarm=systemNonUrgentAlarm, dcEqualizeDuration=dcEqualizeDuration, dcTrapDestinationTable=dcTrapDestinationTable, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcSystemPower=dcSystemPower, dcEventProcessingEventTable=dcEventProcessingEventTable, dcNumberUrgentAlarms=dcNumberUrgentAlarms, controllerGroups=controllerGroups, dcEventHistoryMessage=dcEventHistoryMessage, dcGenericAlarmIndex=dcGenericAlarmIndex, dcLowStopVoltage=dcLowStopVoltage, dcBatteryStringTable=dcBatteryStringTable, dcMeterPanelEventTable=dcMeterPanelEventTable, dcMeasurementName=dcMeasurementName, dcEqualizeControl=dcEqualizeControl, dcMeasurementIndex=dcMeasurementIndex, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcTempSupervision=dcTempSupervision, dcBatteryTestStatus=dcBatteryTestStatus, dcRectifierEntry=dcRectifierEntry, dcPowerLimitationType=dcPowerLimitationType, controllerBasicCompl=controllerBasicCompl, dcControlEventEntry=dcControlEventEntry, genericAlarmTableGroup=genericAlarmTableGroup, dcHighStartTemp=dcHighStartTemp, dcLoadCurrent=dcLoadCurrent, dcControlEventName=dcControlEventName, dcTrapDestinationEntry=dcTrapDestinationEntry, dcDefaultLogEventTable=dcDefaultLogEventTable, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcLowStartTemp=dcLowStartTemp, dcAlarmIndex=dcAlarmIndex, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcMinimumLoadStep=dcMinimumLoadStep, dcUsys20=dcUsys20, dcMeasurementEntry=dcMeasurementEntry, dcMeterPanelEventValue=dcMeterPanelEventValue, dcBatteryTestDateTime=dcBatteryTestDateTime, dcGenericAlarmTable=dcGenericAlarmTable, dcMaxVoltage=dcMaxVoltage, dcPowerLimitationTable=dcPowerLimitationTable, dcSystemName=dcSystemName, dcBatteryTestParameter=dcBatteryTestParameter, dcUaMax=dcUaMax, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcControlEventValue=dcControlEventValue, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcNonUrgentAlarmName=dcNonUrgentAlarmName, rectifierGroupTableGroup=rectifierGroupTableGroup, lvdTableGroup=lvdTableGroup, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcSystemMonitor=dcSystemMonitor, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, rectifierTableGroup=rectifierTableGroup, batteryStringTableGroup=batteryStringTableGroup, dcBatteryTestUsupport=dcBatteryTestUsupport, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcBoostCharge=dcBoostCharge, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcBoostChargeControl=dcBoostChargeControl, dcRectifierIndex=dcRectifierIndex, dcFloatCharge=dcFloatCharge, dcSystemDateTime=dcSystemDateTime, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcBatteryTestControl=dcBatteryTestControl, dcUsMax=dcUsMax, dcEqualizeStatus=dcEqualizeStatus, dcBatteryTest=dcBatteryTest, dcSystemInfo=dcSystemInfo, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcTrapDestinationIndex=dcTrapDestinationIndex, dcRectifierGroupName=dcRectifierGroupName, dcRectifierGroupEntry=dcRectifierGroupEntry, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcEqualizeTimeLag=dcEqualizeTimeLag, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, trapDestinationTableGroup=trapDestinationTableGroup, dcEqualizeLeadTime=dcEqualizeLeadTime, dcSystemAlarms=dcSystemAlarms, dcLowTempSlope=dcLowTempSlope, dcLvdName=dcLvdName, dcEventProcessingEventEntry=dcEventProcessingEventEntry, controllerEventObjects=controllerEventObjects, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcEfficiencyCycling=dcEfficiencyCycling)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcHighTempHyst=dcHighTempHyst, dcStartTemp=dcStartTemp, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcBatteryParameter=dcBatteryParameter, dcBatteryStringIndex=dcBatteryStringIndex, dcCriticalAlarmValue=dcCriticalAlarmValue, controllerConfs=controllerConfs, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcSlope=dcSlope, dcEventHistoryIndex=dcEventHistoryIndex, meterPanelEventTableGroup=meterPanelEventTableGroup, dcEqualizeVoltage=dcEqualizeVoltage, dcLvdIndex=dcLvdIndex, dcAlarmTable=dcAlarmTable)
