...
Counter64, TimeTicks, Gauge32, MibIdentifier, IpAddress, ModuleIdentity, Integer32, Bits, enterprises, ObjectIdentity, NotificationType, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Gauge32", "MibIdentifier", "IpAddress", "ModuleIdentity", "Integer32", "Bits", "enterprises", "ObjectIdentity", "NotificationType", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcLowStopVoltage=dcLowStopVoltage, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcBoostChargeIstop=dcBoostChargeIstop, rectifierTableGroup=rectifierTableGroup, dcBatteryTestDuration=dcBatteryTestDuration, dcRunawayVoltage=dcRunawayVoltage, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcLvdTable=dcLvdTable, dcSystemVoltage=dcSystemVoltage, dcBoostChargeParameter=dcBoostChargeParameter, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcBatteryTestType=dcBatteryTestType, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcAlarmTable=dcAlarmTable, dcBoD=dcBoD, dcTrapDestinationIndex=dcTrapDestinationIndex, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, controllerObjects=controllerObjects, dcExpectedBackupTime=dcExpectedBackupTime, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, measurementTableGroup=measurementTableGroup, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcTempCompType=dcTempCompType, dcMeterPanelEventValue=dcMeterPanelEventValue, dcUaMax=dcUaMax, dcEventHistoryIndex=dcEventHistoryIndex, systemInfoGroup=systemInfoGroup, dcEventProcessingEventTable=dcEventProcessingEventTable, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcLvdIndex=dcLvdIndex, dcPowerLimitationStatus=dcPowerLimitationStatus, dcLowStartTemp=dcLowStartTemp, dcPowerLimitation=dcPowerLimitation, dcEqualizeTimeLag=dcEqualizeTimeLag, dcLvdName=dcLvdName, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, rectifierGroupTableGroup=rectifierGroupTableGroup, dcGenericAlarmTable=dcGenericAlarmTable, dcLoadCurrent=dcLoadCurrent, dcSystemMonitor=dcSystemMonitor, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcBatteryTestUsupport=dcBatteryTestUsupport, dcMeasurementUnit=dcMeasurementUnit, meterPanelEventTableGroup=meterPanelEventTableGroup, trapDestinationTableGroup=trapDestinationTableGroup, dcAlarmEventName=dcAlarmEventName, dcMeterPanel=dcMeterPanel, dcBatteryStringName=dcBatteryStringName, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcRectifierFunctions=dcRectifierFunctions, dcBatteryStringCapacity=dcBatteryStringCapacity, dcControlEventValue=dcControlEventValue, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcCriticalAlarmName=dcCriticalAlarmName, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcBoostChargeControl=dcBoostChargeControl, dcBatteryStringEntry=dcBatteryStringEntry, dcDefaultLogEventName=dcDefaultLogEventName, miscGroup=miscGroup, dcBatteryTemperature=dcBatteryTemperature, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcCurrentLimit=dcCurrentLimit, dcSystemName=dcSystemName, dcGenericAlarmEventName=dcGenericAlarmEventName, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcSystemInfo=dcSystemInfo, dcEfficiencyCycling=dcEfficiencyCycling, dcEqualizeEnabled=dcEqualizeEnabled, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcSystemAlarms=dcSystemAlarms, dcMainsFailureAlarm=dcMainsFailureAlarm, dcAlarmEventValue=dcAlarmEventValue, dcMaximumLoadStep=dcMaximumLoadStep, defaultLogEventTableGroup=defaultLogEventTableGroup, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, genericAlarmTableGroup=genericAlarmTableGroup, controllerBasicCompl=controllerBasicCompl, dcMeterPanelEventTable=dcMeterPanelEventTable, dcSoftwareVersion=dcSoftwareVersion, powerLimitationTableGroup=powerLimitationTableGroup, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcEqualizeStatus=dcEqualizeStatus, dcTrapDestinationPort=dcTrapDestinationPort, dcHysteresis=dcHysteresis, dcMeasurementEntry=dcMeasurementEntry, dcTempComp=dcTempComp, dcSystemDateTime=dcSystemDateTime, dcSystemPower=dcSystemPower, dcBatteryTestInterval=dcBatteryTestInterval, dcRectifier=dcRectifier, dcEqualizeVoltage=dcEqualizeVoltage, dcGenericAlarmEntry=dcGenericAlarmEntry, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcHighTempSlope=dcHighTempSlope, dcRectifierGroupName=dcRectifierGroupName, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcHighStopVoltage=dcHighStopVoltage, dcBatteryTestTempTo=dcBatteryTestTempTo, systemUrgentAlarm=systemUrgentAlarm, dcNumberRectifiers=dcNumberRectifiers, dcMeasurementValue=dcMeasurementValue, dcPowerLimitationTable=dcPowerLimitationTable, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcEqualizeInterval=dcEqualizeInterval, dcRectifierIdentifier=dcRectifierIdentifier, dcMeterPanelEventName=dcMeterPanelEventName, dcCriticalAlarmValue=dcCriticalAlarmValue, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcBatteryTestStatus=dcBatteryTestStatus, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcBoostChargeType=dcBoostChargeType, dcAlarmEventIdentifier=dcAlarmEventIdentifier, batteryGroup=batteryGroup, dcMaxVoltage=dcMaxVoltage, dcFloatCharge=dcFloatCharge, dcRectifierIndex=dcRectifierIndex, dcBatteryStringIndex=dcBatteryStringIndex, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcStopTemp=dcStopTemp, dcNumberCriticalAlarms=dcNumberCriticalAlarms, systemCriticalAlarm=systemCriticalAlarm, dcBatteryTestResults=dcBatteryTestResults, dcEventProcessingEventType=dcEventProcessingEventType, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcRectifierStatus=dcRectifierStatus, dcConfig=dcConfig, controllerConfs=controllerConfs, controllerEvents=controllerEvents, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcControlEventEntry=dcControlEventEntry, dcBoostChargeStatus=dcBoostChargeStatus, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, PYSNMP_MODULE_ID=orionBaseMibModule, dcEqualizeControl=dcEqualizeControl, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcBatteryTestResult=dcBatteryTestResult, dcEqualizeLeadTime=dcEqualizeLeadTime, dcAlarmEntry=dcAlarmEntry, dcAlarmEventCategory=dcAlarmEventCategory, dcTrapDestinationTable=dcTrapDestinationTable, dcHighStartTemp=dcHighStartTemp, rectifierGroup=rectifierGroup, controllerEventObjects=controllerEventObjects, dcPowerLimitationType=dcPowerLimitationType, alarmTableGroup=alarmTableGroup, orionBaseMibModule=orionBaseMibModule, dcUrgentAlarmName=dcUrgentAlarmName, dcFileProcessingStatus=dcFileProcessingStatus, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, eventHistoryTableGroup=eventHistoryTableGroup, dcEventHistoryTable=dcEventHistoryTable, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcRunawayTemp=dcRunawayTemp, dcHighTempHyst=dcHighTempHyst, dcMeterPanelEventEntry=dcMeterPanelEventEntry, systemAlarmGroup=systemAlarmGroup, dcInputOutput=dcInputOutput, dcControlEventIndex=dcControlEventIndex, dcChargeState=dcChargeState, systemMonitorGroup=systemMonitorGroup, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcBatteryCurrent=dcBatteryCurrent, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcRectifierGroupTable=dcRectifierGroupTable, dcBatteryParameter=dcBatteryParameter, dcMeasurementIndex=dcMeasurementIndex, dcGenericAlarmIndex=dcGenericAlarmIndex, dcRectifierEntry=dcRectifierEntry, dcBatteryTestParameter=dcBatteryTestParameter, controllerEventsV2=controllerEventsV2, controllerGroups=controllerGroups, dcSiteName=dcSiteName, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcUsMax=dcUsMax, dcRectifierCurrent=dcRectifierCurrent, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcLvdEntry=dcLvdEntry, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcLowTempSlope=dcLowTempSlope, dcBoostChargeIstart=dcBoostChargeIstart, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, notificationsGroup=notificationsGroup, batteryStringTableGroup=batteryStringTableGroup, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcBoostChargeVoltage=dcBoostChargeVoltage, dcEqualize=dcEqualize, dcEqualizeParameter=dcEqualizeParameter, dcStartTemp=dcStartTemp, dcPowerLimitationEntry=dcPowerLimitationEntry, dcBatteryTestControl=dcBatteryTestControl, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcBatteryTestTempFrom=dcBatteryTestTempFrom, controllerCompl=controllerCompl, dcEqualizeDuration=dcEqualizeDuration, dcBatteryTestDateTime=dcBatteryTestDateTime, dcMeasurementName=dcMeasurementName, dcEnableUsTempComp=dcEnableUsTempComp, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcMinimumLoadStep=dcMinimumLoadStep, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, lvdTableGroup=lvdTableGroup, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcUrgentAlarmValue=dcUrgentAlarmValue, dcTrapDestinationIp=dcTrapDestinationIp, dcEventHistoryMessage=dcEventHistoryMessage, dcBoostCharge=dcBoostCharge, systemNonUrgentAlarm=systemNonUrgentAlarm, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcRectifierTable=dcRectifierTable, orionBaseMib=orionBaseMib, dcRectifierGroupIndex=dcRectifierGroupIndex, dcTempSupervision=dcTempSupervision, dcMeasurement=dcMeasurement, dcTrapDestinationEntry=dcTrapDestinationEntry, eventProcessingEventTableGroup=eventProcessingEventTableGroup, controlEventTableGroup=controlEventTableGroup, dcMisc=dcMisc, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcBattery=dcBattery, dcRectifierGroupEntry=dcRectifierGroupEntry, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcPowerLimitationIndex=dcPowerLimitationIndex, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcDefaultLogEventTable=dcDefaultLogEventTable, dcSlope=dcSlope, dcAlarmIndex=dcAlarmIndex, dcMeasurementTable=dcMeasurementTable, dcEventHistoryEntry=dcEventHistoryEntry, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcControlEventIdentifier=dcControlEventIdentifier, dcEventProcessingEventName=dcEventProcessingEventName, dcControlEventName=dcControlEventName, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcEvtCtrlCharge=dcEvtCtrlCharge)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcPowerLimitationEventName=dcPowerLimitationEventName, dcControlEventTable=dcControlEventTable, dcLossOfBackupTime=dcLossOfBackupTime, dcPowerLimitationLimit=dcPowerLimitationLimit, dcBatteryStringTable=dcBatteryStringTable, dcUsys20=dcUsys20, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcUsMin=dcUsMin, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcHighTemp=dcHighTemp, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcUaMin=dcUaMin, dcBatteryTest=dcBatteryTest)
