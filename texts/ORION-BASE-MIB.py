...
Counter32, ObjectIdentity, TimeTicks, Unsigned32, NotificationType, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits, Counter64, iso, enterprises, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "TimeTicks", "Unsigned32", "NotificationType", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits", "Counter64", "iso", "enterprises", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, batteryStringTableGroup=batteryStringTableGroup, dcSystemInfo=dcSystemInfo, dcAlarmIndex=dcAlarmIndex, dcFloatCharge=dcFloatCharge, dcCurrentLimit=dcCurrentLimit, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcRectifierEntry=dcRectifierEntry, controllerEventObjects=controllerEventObjects, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcBatteryStringEntry=dcBatteryStringEntry, dcSystemName=dcSystemName, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcAlarmTable=dcAlarmTable, dcBoostChargeIstop=dcBoostChargeIstop, dcBoD=dcBoD, dcStopTemp=dcStopTemp, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcMeasurementTable=dcMeasurementTable, alarmTableGroup=alarmTableGroup, dcMaximumLoadStep=dcMaximumLoadStep, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, controllerEventsV2=controllerEventsV2, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, controllerCompl=controllerCompl, dcBoostChargeIstart=dcBoostChargeIstart, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcBatteryTestTempTo=dcBatteryTestTempTo, dcEventProcessingEventType=dcEventProcessingEventType, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcRectifierGroupEntry=dcRectifierGroupEntry, dcControlEventName=dcControlEventName, controllerBasicCompl=controllerBasicCompl, dcTrapDestinationPort=dcTrapDestinationPort, dcHighTempHyst=dcHighTempHyst, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcLowStopVoltage=dcLowStopVoltage, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, systemAlarmGroup=systemAlarmGroup, dcLvdDisconnectDelay=dcLvdDisconnectDelay, dcLvdEntry=dcLvdEntry, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcPowerLimitationType=dcPowerLimitationType, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, batteryGroup=batteryGroup, dcTrapDestinationEntry=dcTrapDestinationEntry, orionBaseMib=orionBaseMib, dcDefaultLogEventTable=dcDefaultLogEventTable, dcMeterPanel=dcMeterPanel, dcMeasurement=dcMeasurement, dcConfig=dcConfig, dcRectifierFunctions=dcRectifierFunctions, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcEqualizeEnabled=dcEqualizeEnabled, dcUrgentAlarmName=dcUrgentAlarmName, dcBatteryTest=dcBatteryTest, dcEqualizeControl=dcEqualizeControl, dcTrapDestinationTable=dcTrapDestinationTable, dcRectifierStatus=dcRectifierStatus, dcUrgentAlarmValue=dcUrgentAlarmValue, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcAlarmEventValue=dcAlarmEventValue, dcBatteryTestParameter=dcBatteryTestParameter, dcBatteryTestResults=dcBatteryTestResults, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcPowerLimitationIndex=dcPowerLimitationIndex, dcBatteryStringName=dcBatteryStringName, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcControlEventTable=dcControlEventTable, lvdTableGroup=lvdTableGroup, dcLowStartTemp=dcLowStartTemp, dcBatteryCurrent=dcBatteryCurrent, dcControlEventIdentifier=dcControlEventIdentifier, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcEqualizeInterval=dcEqualizeInterval, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcCriticalAlarmValue=dcCriticalAlarmValue, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcRectifierIndex=dcRectifierIndex, dcBoostChargeParameter=dcBoostChargeParameter, controllerGroups=controllerGroups, systemCriticalAlarm=systemCriticalAlarm, dcCriticalAlarmName=dcCriticalAlarmName, dcMisc=dcMisc, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcAlarmEventCategory=dcAlarmEventCategory, dcBatteryTestStatus=dcBatteryTestStatus, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcEvtCtrlCharge=dcEvtCtrlCharge, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcInputOutput=dcInputOutput, dcRectifier=dcRectifier, dcRunawayTemp=dcRunawayTemp, dcDefaultLogEventName=dcDefaultLogEventName, dcLvdIndex=dcLvdIndex, systemUrgentAlarm=systemUrgentAlarm, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcBatteryTestResult=dcBatteryTestResult, notificationsGroup=notificationsGroup, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcRectifierGroupName=dcRectifierGroupName, dcRectifierCurrent=dcRectifierCurrent, dcUsys20=dcUsys20, dcEqualizeTimeLag=dcEqualizeTimeLag, dcMeterPanelEventEntry=dcMeterPanelEventEntry, miscGroup=miscGroup, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcExpectedBackupTime=dcExpectedBackupTime, dcStartTemp=dcStartTemp, dcMeasurementValue=dcMeasurementValue, dcBattery=dcBattery, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, rectifierGroup=rectifierGroup, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcFileProcessingStatus=dcFileProcessingStatus, dcSystemAlarms=dcSystemAlarms, dcEfficiencyCycling=dcEfficiencyCycling, dcMaxVoltage=dcMaxVoltage, dcTempComp=dcTempComp, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcGenericAlarmEventName=dcGenericAlarmEventName, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, systemInfoGroup=systemInfoGroup, dcBatteryTestDuration=dcBatteryTestDuration, dcMeterPanelEventValue=dcMeterPanelEventValue, dcRectifierTable=dcRectifierTable, dcLoadCurrent=dcLoadCurrent, dcEqualizeParameter=dcEqualizeParameter, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcBatteryTestType=dcBatteryTestType, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcEventHistoryMessage=dcEventHistoryMessage, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcRectifierGroupIndex=dcRectifierGroupIndex, dcBoostChargeControl=dcBoostChargeControl, dcLowTempSlope=dcLowTempSlope, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcHighStartTemp=dcHighStartTemp, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcMainsFailureAlarm=dcMainsFailureAlarm, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, eventHistoryTableGroup=eventHistoryTableGroup, dcBatteryStringIndex=dcBatteryStringIndex, dcBatteryStringCapacity=dcBatteryStringCapacity, powerLimitationTableGroup=powerLimitationTableGroup, dcSoftwareVersion=dcSoftwareVersion, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcControlEventValue=dcControlEventValue, dcHighTemp=dcHighTemp, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcPowerLimitationTable=dcPowerLimitationTable, dcMeasurementIndex=dcMeasurementIndex, dcBoostChargeType=dcBoostChargeType, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcRunawayVoltage=dcRunawayVoltage, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcSystemDateTime=dcSystemDateTime, dcAlarmEntry=dcAlarmEntry, dcNumberRectifiers=dcNumberRectifiers, dcEventProcessingEventName=dcEventProcessingEventName, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, rectifierTableGroup=rectifierTableGroup, dcBatteryParameter=dcBatteryParameter, dcPowerLimitation=dcPowerLimitation, dcGenericAlarmTable=dcGenericAlarmTable, dcMeasurementUnit=dcMeasurementUnit, dcUaMax=dcUaMax, dcUsMin=dcUsMin, dcEventHistoryTable=dcEventHistoryTable, dcGenericAlarmIndex=dcGenericAlarmIndex, PYSNMP_MODULE_ID=orionBaseMibModule, dcPowerLimitationStatus=dcPowerLimitationStatus, dcBoostChargeTimeLag=dcBoostChargeTimeLag, genericAlarmTableGroup=genericAlarmTableGroup, dcGenericAlarmEntry=dcGenericAlarmEntry, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcSystemVoltage=dcSystemVoltage, dcMinimumLoadStep=dcMinimumLoadStep, dcHighStopVoltage=dcHighStopVoltage, systemNonUrgentAlarm=systemNonUrgentAlarm, dcEventHistoryIndex=dcEventHistoryIndex, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcEqualizeStatus=dcEqualizeStatus, controllerObjects=controllerObjects, dcLvdName=dcLvdName, systemMonitorGroup=systemMonitorGroup, controllerConfs=controllerConfs, dcBoostCharge=dcBoostCharge, dcEqualizeDuration=dcEqualizeDuration, dcBoostChargeVoltage=dcBoostChargeVoltage, dcMeasurementEntry=dcMeasurementEntry, dcMeterPanelEventName=dcMeterPanelEventName, dcSiteName=dcSiteName, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcEqualizeLeadTime=dcEqualizeLeadTime, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, orionBaseMibModule=orionBaseMibModule, dcBatteryTemperature=dcBatteryTemperature, dcBoostChargeStatus=dcBoostChargeStatus, dcHysteresis=dcHysteresis, dcEnableUsTempComp=dcEnableUsTempComp, dcRectifierIdentifier=dcRectifierIdentifier, dcHighTempSlope=dcHighTempSlope, dcLvdTable=dcLvdTable, meterPanelEventTableGroup=meterPanelEventTableGroup, dcEventHistoryEntry=dcEventHistoryEntry, dcPowerLimitationEntry=dcPowerLimitationEntry, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcControlEventIndex=dcControlEventIndex, defaultLogEventTableGroup=defaultLogEventTableGroup, dcPowerLimitationEventName=dcPowerLimitationEventName, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcLossOfBackupTime=dcLossOfBackupTime, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcBatteryTestControl=dcBatteryTestControl, trapDestinationTableGroup=trapDestinationTableGroup, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcBatteryTestInterval=dcBatteryTestInterval, dcUaMin=dcUaMin, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcSystemMonitor=dcSystemMonitor, measurementTableGroup=measurementTableGroup, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcBatteryTestDateTime=dcBatteryTestDateTime, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcUsMax=dcUsMax, dcPowerLimitationLimit=dcPowerLimitationLimit, dcRectifierGroupTable=dcRectifierGroupTable, dcMeasurementName=dcMeasurementName, dcMeterPanelEventTable=dcMeterPanelEventTable, dcSystemPower=dcSystemPower, dcTempCompType=dcTempCompType, controlEventTableGroup=controlEventTableGroup, dcBatteryTestUsupport=dcBatteryTestUsupport, dcEqualizeVoltage=dcEqualizeVoltage, controllerEvents=controllerEvents, dcGenericAlarmEventValue=dcGenericAlarmEventValue)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcSlope=dcSlope, rectifierGroupTableGroup=rectifierGroupTableGroup, dcEventProcessingEventTable=dcEventProcessingEventTable, dcAlarmEventName=dcAlarmEventName, dcTrapDestinationIp=dcTrapDestinationIp, dcEqualize=dcEqualize, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcControlEventEntry=dcControlEventEntry, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcChargeState=dcChargeState, dcTrapDestinationIndex=dcTrapDestinationIndex, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcBatteryStringTable=dcBatteryStringTable, dcTempSupervision=dcTempSupervision)
