...
NotificationType, ModuleIdentity, iso, TimeTicks, Integer32, IpAddress, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, enterprises, Bits, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "iso", "TimeTicks", "Integer32", "IpAddress", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "enterprises", "Bits", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, dcBoostChargeType=dcBoostChargeType, dcLowStopVoltage=dcLowStopVoltage, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcSystemInfo=dcSystemInfo, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcLimitSwitchingTimes=dcLimitSwitchingTimes, controllerCompl=controllerCompl, dcBatteryStringName=dcBatteryStringName, alarmTableGroup=alarmTableGroup, dcEqualizeDuration=dcEqualizeDuration, systemUrgentAlarm=systemUrgentAlarm, rectifierGroupTableGroup=rectifierGroupTableGroup, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcEventHistoryIndex=dcEventHistoryIndex, dcBatteryStringIndex=dcBatteryStringIndex, dcBatteryTestType=dcBatteryTestType, dcBoostChargeVoltage=dcBoostChargeVoltage, dcBatteryStringEntry=dcBatteryStringEntry, dcMinimumLoadStep=dcMinimumLoadStep, dcTrapDestinationTable=dcTrapDestinationTable, dcAlarmIndex=dcAlarmIndex, dcBatteryTestDateTime=dcBatteryTestDateTime, systemCriticalAlarm=systemCriticalAlarm, dcEqualizeParameter=dcEqualizeParameter, dcPowerLimitationStatus=dcPowerLimitationStatus, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcBoostChargeControl=dcBoostChargeControl, dcDefaultLogEventIndex=dcDefaultLogEventIndex, batteryGroup=batteryGroup, dcGenericAlarmIndex=dcGenericAlarmIndex, dcSystemPower=dcSystemPower, dcRectifierGroupTable=dcRectifierGroupTable, controllerEventsV2=controllerEventsV2, dcAlarmEventName=dcAlarmEventName, dcMeasurement=dcMeasurement, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, dcHighStopVoltage=dcHighStopVoltage, dcTrapDestinationIndex=dcTrapDestinationIndex, dcPowerLimitationLimit=dcPowerLimitationLimit, controllerGroups=controllerGroups, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcSystemAlarms=dcSystemAlarms, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, lvdTableGroup=lvdTableGroup, dcRectifierStatus=dcRectifierStatus, dcHighTempSlope=dcHighTempSlope, dcTrapDestinationEntry=dcTrapDestinationEntry, dcPowerLimitation=dcPowerLimitation, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcMisc=dcMisc, dcControlEventIdentifier=dcControlEventIdentifier, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcEqualizeEnabled=dcEqualizeEnabled, dcMeterPanelEventName=dcMeterPanelEventName, dcRectifierGroupEntry=dcRectifierGroupEntry, dcBatteryParameter=dcBatteryParameter, dcTempComp=dcTempComp, dcInputOutput=dcInputOutput, dcEventHistoryMessage=dcEventHistoryMessage, dcTempCompType=dcTempCompType, dcUsMin=dcUsMin, dcEventProcessingEventType=dcEventProcessingEventType, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcMeasurementUnit=dcMeasurementUnit, dcMeterPanel=dcMeterPanel, dcEqualizeLeadTime=dcEqualizeLeadTime, dcControlEventEntry=dcControlEventEntry, systemInfoGroup=systemInfoGroup, dcBatteryStringCapacity=dcBatteryStringCapacity, dcBatteryCurrent=dcBatteryCurrent, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcAlarmTable=dcAlarmTable, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcBatteryTestControl=dcBatteryTestControl, dcDefaultLogEventName=dcDefaultLogEventName, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, orionBaseMib=orionBaseMib, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcMeasurementName=dcMeasurementName, dcMeasurementValue=dcMeasurementValue, dcMeterPanelEventTable=dcMeterPanelEventTable, dcBatteryTestResult=dcBatteryTestResult, dcEventHistoryTable=dcEventHistoryTable, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, PYSNMP_MODULE_ID=orionBaseMibModule, dcTrapDestinationPort=dcTrapDestinationPort, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, controllerObjects=controllerObjects, dcPowerLimitationIndex=dcPowerLimitationIndex, dcRectifierIdentifier=dcRectifierIdentifier, dcSystemVoltage=dcSystemVoltage, dcHysteresis=dcHysteresis, dcEqualize=dcEqualize, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcLvdIndex=dcLvdIndex, miscGroup=miscGroup, dcBatteryTestStatus=dcBatteryTestStatus, dcControlEventTable=dcControlEventTable, dcMeterPanelEventValue=dcMeterPanelEventValue, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcMeasurementIndex=dcMeasurementIndex, dcEventHistoryEntry=dcEventHistoryEntry, dcBoostChargeParameter=dcBoostChargeParameter, dcRectifierIndex=dcRectifierIndex, controlEventTableGroup=controlEventTableGroup, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcRectifierCurrent=dcRectifierCurrent, measurementTableGroup=measurementTableGroup, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcHighTempHyst=dcHighTempHyst, systemMonitorGroup=systemMonitorGroup, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcUaMax=dcUaMax, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, eventHistoryTableGroup=eventHistoryTableGroup, dcBatteryStringTable=dcBatteryStringTable, dcRectifierTable=dcRectifierTable, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcPowerLimitationEntry=dcPowerLimitationEntry, dcUrgentAlarmValue=dcUrgentAlarmValue, dcTempSupervision=dcTempSupervision, dcMainsFailureAlarm=dcMainsFailureAlarm, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcRectifierGroupName=dcRectifierGroupName, systemNonUrgentAlarm=systemNonUrgentAlarm, controllerBasicCompl=controllerBasicCompl, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, controllerEventObjects=controllerEventObjects, dcControlEventValue=dcControlEventValue, dcSystemDateTime=dcSystemDateTime, dcEqualizeVoltage=dcEqualizeVoltage, dcMaximumLoadStep=dcMaximumLoadStep, controllerEvents=controllerEvents, dcLvdEntry=dcLvdEntry, meterPanelEventTableGroup=meterPanelEventTableGroup, dcDefaultLogEventTable=dcDefaultLogEventTable, defaultLogEventTableGroup=defaultLogEventTableGroup, dcBatteryTestUsupport=dcBatteryTestUsupport, dcRectifierGroupIndex=dcRectifierGroupIndex, dcHighTemp=dcHighTemp, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcGenericAlarmEntry=dcGenericAlarmEntry, dcSiteName=dcSiteName, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcBoD=dcBoD, dcStopTemp=dcStopTemp, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcMeasurementEntry=dcMeasurementEntry, dcControlEventIndex=dcControlEventIndex, dcBatteryTemperature=dcBatteryTemperature, dcExpectedBackupTime=dcExpectedBackupTime, dcTrapDestinationIp=dcTrapDestinationIp, dcLvdTable=dcLvdTable, genericAlarmTableGroup=genericAlarmTableGroup, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcGenericAlarmTable=dcGenericAlarmTable, dcLowTempSlope=dcLowTempSlope, dcHighStartTemp=dcHighStartTemp, dcUsMax=dcUsMax, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcGenericAlarmEventName=dcGenericAlarmEventName, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, rectifierGroup=rectifierGroup, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcUrgentAlarmName=dcUrgentAlarmName, dcBatteryTestTempTo=dcBatteryTestTempTo, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, notificationsGroup=notificationsGroup, dcBatteryTestResults=dcBatteryTestResults, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcAlarmEventValue=dcAlarmEventValue, batteryStringTableGroup=batteryStringTableGroup, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcCriticalAlarmName=dcCriticalAlarmName, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcConfig=dcConfig, dcBoostCharge=dcBoostCharge, dcSystemName=dcSystemName, dcUaMin=dcUaMin, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcLowStartTemp=dcLowStartTemp, dcEqualizeInterval=dcEqualizeInterval, dcSlope=dcSlope, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcFileProcessingStatus=dcFileProcessingStatus, dcEfficiencyCycling=dcEfficiencyCycling, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcCriticalAlarmValue=dcCriticalAlarmValue, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcChargeState=dcChargeState, dcPowerLimitationEventName=dcPowerLimitationEventName, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcEnableUsTempComp=dcEnableUsTempComp, dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcLoadCurrent=dcLoadCurrent, dcEvtCtrlCharge=dcEvtCtrlCharge, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, rectifierTableGroup=rectifierTableGroup, dcEventProcessingEventTable=dcEventProcessingEventTable, dcLossOfBackupTime=dcLossOfBackupTime, dcControlEventName=dcControlEventName, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcEventProcessingEventName=dcEventProcessingEventName, dcLvdDisconnectDelay=dcLvdDisconnectDelay, orionBaseMibModule=orionBaseMibModule, systemAlarmGroup=systemAlarmGroup, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcRunawayTemp=dcRunawayTemp, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, trapDestinationTableGroup=trapDestinationTableGroup, dcUsys20=dcUsys20, powerLimitationTableGroup=powerLimitationTableGroup, dcBoostChargeIstop=dcBoostChargeIstop, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcPowerLimitationTable=dcPowerLimitationTable, dcBoostChargeIstart=dcBoostChargeIstart, dcLvdName=dcLvdName, dcRectifier=dcRectifier, dcRunawayVoltage=dcRunawayVoltage, dcCurrentLimit=dcCurrentLimit, dcBatteryTestDuration=dcBatteryTestDuration, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcSystemMonitor=dcSystemMonitor, dcBatteryTestInterval=dcBatteryTestInterval, dcRectifierFunctions=dcRectifierFunctions, dcEqualizeControl=dcEqualizeControl, dcMaxVoltage=dcMaxVoltage, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, dcAlarmEventCategory=dcAlarmEventCategory, dcBatteryTestParameter=dcBatteryTestParameter, dcEqualizeStatus=dcEqualizeStatus, dcPowerLimitationType=dcPowerLimitationType, dcNumberRectifiers=dcNumberRectifiers, dcRectifierEntry=dcRectifierEntry, dcMeasurementTable=dcMeasurementTable, controllerConfs=controllerConfs, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcSoftwareVersion=dcSoftwareVersion, dcBoostChargeStatus=dcBoostChargeStatus, dcEqualizeTimeLag=dcEqualizeTimeLag, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcFloatCharge=dcFloatCharge, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcAlarmEntry=dcAlarmEntry, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcBattery=dcBattery, dcBatteryTest=dcBatteryTest, dcStartTemp=dcStartTemp)
