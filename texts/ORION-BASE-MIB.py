...
ModuleIdentity, Counter32, ObjectIdentity, Integer32, Bits, TimeTicks, MibIdentifier, Unsigned32, IpAddress, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "ObjectIdentity", "Integer32", "Bits", "TimeTicks", "MibIdentifier", "Unsigned32", "IpAddress", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("ORION-BASE-MIB", dcSystemDateTime=dcSystemDateTime, dcTotalBatteryCapacity=dcTotalBatteryCapacity, dcBoostChargeTimeLag=dcBoostChargeTimeLag, dcBatteryStringIndex=dcBatteryStringIndex, dcSystemVoltageSupervision=dcSystemVoltageSupervision, dcUaMin=dcUaMin, controllerEventsV2=controllerEventsV2, dcRectifierCurrent=dcRectifierCurrent, orionBaseMibModule=orionBaseMibModule, controllerGroups=controllerGroups, dcBatteryTestResults=dcBatteryTestResults, dcEvtCtrlCharge=dcEvtCtrlCharge, dcInputOutput=dcInputOutput, dcNonUrgentAlarmName=dcNonUrgentAlarmName, dcBatteryTestTempTo=dcBatteryTestTempTo, dcRectifierGroupEntry=dcRectifierGroupEntry, controllerEventObjects=controllerEventObjects, dcBatteryTestControl=dcBatteryTestControl, dcEventHistoryTimestamp=dcEventHistoryTimestamp, dcEventProcessingEventTable=dcEventProcessingEventTable, dcMeasurementUnit=dcMeasurementUnit, dcDefaultLogEventIndex=dcDefaultLogEventIndex, dcPowerLimitationNoBatteryDischarge=dcPowerLimitationNoBatteryDischarge, dcBatteryTestMinDuration=dcBatteryTestMinDuration, dcEqualizeControl=dcEqualizeControl, dcMeterPanelEventTable=dcMeterPanelEventTable, dcAlarmEntry=dcAlarmEntry, dcForceSwitchingOncePerMonth=dcForceSwitchingOncePerMonth, dcEqualizeStatus=dcEqualizeStatus, dcRectifierGroupUmaxOff=dcRectifierGroupUmaxOff, dcPowerLimitationType=dcPowerLimitationType, systemAlarmGroup=systemAlarmGroup, dcPowerLimitationStatus=dcPowerLimitationStatus, dcTrapDestinationIp=dcTrapDestinationIp, dcEventProcessingEventType=dcEventProcessingEventType, dcHighStopVoltage=dcHighStopVoltage, controllerBasicCompl=controllerBasicCompl, dcBatteryTestDateTime=dcBatteryTestDateTime, dcSystemAlarms=dcSystemAlarms, dcFileProcessingStatus=dcFileProcessingStatus, dcBoostChargeIstop=dcBoostChargeIstop, dcEventProcessingEventEntry=dcEventProcessingEventEntry, dcMeterPanelEventValue=dcMeterPanelEventValue, dcBatteryStringCapacity=dcBatteryStringCapacity, dcLvdEntry=dcLvdEntry, dcAlarmEventIdentifier=dcAlarmEventIdentifier, dcHighTempHyst=dcHighTempHyst, systemUrgentAlarm=systemUrgentAlarm, dcMaxVoltage=dcMaxVoltage, dcNonUrgentAlarmValue=dcNonUrgentAlarmValue, miscGroup=miscGroup, dcEventHistoryEntry=dcEventHistoryEntry, dcRectifierGroupStartupCurrentLimit=dcRectifierGroupStartupCurrentLimit, dcUrgentAlarmValue=dcUrgentAlarmValue, dcEvtCtrlChargeMaxIBatt=dcEvtCtrlChargeMaxIBatt, eventHistoryTableGroup=eventHistoryTableGroup, batteryStringTableGroup=batteryStringTableGroup, dcUrgentAlarmIdentifier=dcUrgentAlarmIdentifier, dcAlarmIndex=dcAlarmIndex, dcRectifierGroupIndex=dcRectifierGroupIndex, dcRectifierGroupPowerupDelay=dcRectifierGroupPowerupDelay, dcSuppressUaLowEnabled=dcSuppressUaLowEnabled, dcLowTempSlope=dcLowTempSlope, systemInfoGroup=systemInfoGroup, dcUaMax=dcUaMax, genericAlarmTableGroup=genericAlarmTableGroup, dcLowStopVoltage=dcLowStopVoltage, dcRunawayTemp=dcRunawayTemp, dcEventHistoryTable=dcEventHistoryTable, dcSystemVoltage=dcSystemVoltage, controlEventTableGroup=controlEventTableGroup, dcGenericAlarmEventIdentifier=dcGenericAlarmEventIdentifier, dcPowerLimitationLimit=dcPowerLimitationLimit, dcDefaultLogEventName=dcDefaultLogEventName, lvdTableGroup=lvdTableGroup, dcBatteryTemperature=dcBatteryTemperature, dcRectifierGroupDefaultCurrentLimit=dcRectifierGroupDefaultCurrentLimit, dcConfig=dcConfig, dcMinimumLoadStep=dcMinimumLoadStep, dcTempComp=dcTempComp, dcCriticalAlarmValue=dcCriticalAlarmValue, dcMeterPanelEventIndex=dcMeterPanelEventIndex, dcBatteryTestInterval=dcBatteryTestInterval, dcTempSupervision=dcTempSupervision, dcMeterPanelEventEntry=dcMeterPanelEventEntry, dcExpectedBackupTime=dcExpectedBackupTime, controllerCompl=controllerCompl, dcTempCompType=dcTempCompType, dcMeterPanelEventName=dcMeterPanelEventName, systemCriticalAlarm=systemCriticalAlarm, dcMeasurementIndex=dcMeasurementIndex, dcSlope=dcSlope, dcNumberNonUrgentAlarms=dcNumberNonUrgentAlarms, dcMeterPanel=dcMeterPanel, dcRunawayVoltage=dcRunawayVoltage, dcControlEventTable=dcControlEventTable, dcEventProcessingEventIndex=dcEventProcessingEventIndex, dcControlEventIdentifier=dcControlEventIdentifier, dcLvdDisconnectDelay=dcLvdDisconnectDelay, controllerEvents=controllerEvents, dcEvtCtrlChargeStatus=dcEvtCtrlChargeStatus, dcEventProcessingEventName=dcEventProcessingEventName, defaultLogEventTableGroup=defaultLogEventTableGroup, dcRectifierGroupStartupVoltage=dcRectifierGroupStartupVoltage, dcSuppressUsLowEnabled=dcSuppressUsLowEnabled, dcBoostCharge=dcBoostCharge, dcMeasurementScaleFactor=dcMeasurementScaleFactor, dcControlEventName=dcControlEventName, dcTrapDestinationIndex=dcTrapDestinationIndex, dcRectifierGroupDefaultPowerLimit=dcRectifierGroupDefaultPowerLimit, dcMeasurementEntry=dcMeasurementEntry, trapDestinationTableGroup=trapDestinationTableGroup, dcMeasurement=dcMeasurement, dcEqualizeEnabled=dcEqualizeEnabled, dcRectifier=dcRectifier, dcPowerLimitation=dcPowerLimitation, systemNonUrgentAlarm=systemNonUrgentAlarm, dcBatteryTestDuration=dcBatteryTestDuration, dcEventHistoryIndex=dcEventHistoryIndex, dcGenericAlarmEventValue=dcGenericAlarmEventValue, dcUsys20=dcUsys20, dcBatteryTestIntervalEnabled=dcBatteryTestIntervalEnabled, dcEqualizeVoltage=dcEqualizeVoltage, dcSystemMonitor=dcSystemMonitor, dcDefaultLogEventEntry=dcDefaultLogEventEntry, dcBoostChargeType=dcBoostChargeType, dcCurrentLimit=dcCurrentLimit, orionBaseMib=orionBaseMib, dcAlarmTable=dcAlarmTable, dcNumberCriticalAlarms=dcNumberCriticalAlarms, dcBatteryCurrent=dcBatteryCurrent, meterPanelEventTableGroup=meterPanelEventTableGroup, measurementTableGroup=measurementTableGroup, dcLvdIndex=dcLvdIndex, dcAlarmEventValue=dcAlarmEventValue, controllerConfs=controllerConfs, dcRectifierGroupStartupTimeLimit=dcRectifierGroupStartupTimeLimit, dcEqualizeTimeLag=dcEqualizeTimeLag, dcBatteryStringMaxIBatt=dcBatteryStringMaxIBatt, dcBatteryTest=dcBatteryTest, dcTrapDestinationPort=dcTrapDestinationPort, dcNumberRectifiersFailure=dcNumberRectifiersFailure, dcCriticalAlarmName=dcCriticalAlarmName, dcBoostChargeInhibitTime=dcBoostChargeInhibitTime, dcAlarmEventName=dcAlarmEventName, dcUrgentAlarmName=dcUrgentAlarmName, dcEqualizeParameter=dcEqualizeParameter, dcMisc=dcMisc, dcControlEventIndex=dcControlEventIndex, dcNumberRectifiersOkay=dcNumberRectifiersOkay, dcHighTempSlope=dcHighTempSlope, dcBatteryTestStartTimeTo=dcBatteryTestStartTimeTo, dcBatteryTestVoltageWithinUfloatPeriod=dcBatteryTestVoltageWithinUfloatPeriod, dcRectifierGroupRectifierType=dcRectifierGroupRectifierType, dcBatteryTestStartTimeFrom=dcBatteryTestStartTimeFrom, dcRectifierIdentifier=dcRectifierIdentifier, dcStopTemp=dcStopTemp, dcChargeState=dcChargeState, dcEnableUsTempComp=dcEnableUsTempComp, dcEvtCtrlChargeVoltage=dcEvtCtrlChargeVoltage, dcEfficiencyCyclingEnabled=dcEfficiencyCyclingEnabled, dcBatteryTestVoltageWithinUfloat=dcBatteryTestVoltageWithinUfloat, dcTrapDestinationEntry=dcTrapDestinationEntry, dcHighStartTemp=dcHighStartTemp, dcAlarmEventCategory=dcAlarmEventCategory, dcRectifierGroupDefaultVoltage=dcRectifierGroupDefaultVoltage, dcEqualizeUseBattRoomFanEnabled=dcEqualizeUseBattRoomFanEnabled, batteryGroup=batteryGroup, dcCriticalAlarmIdentifier=dcCriticalAlarmIdentifier, dcEvtCtrlChargeParameter=dcEvtCtrlChargeParameter, dcEqualizeInhibitAfterBoost=dcEqualizeInhibitAfterBoost, dcStartTemp=dcStartTemp, dcHysteresis=dcHysteresis, dcDefaultLogEventLogged=dcDefaultLogEventLogged, dcControlEventEntry=dcControlEventEntry, dcRectifierStatus=dcRectifierStatus, dcHighTemp=dcHighTemp, rectifierTableGroup=rectifierTableGroup, dcBoostChargeStatus=dcBoostChargeStatus, dcMeasurementName=dcMeasurementName, dcPowerLimitationTable=dcPowerLimitationTable, dcMaximumLoadStep=dcMaximumLoadStep, dcBattery=dcBattery, systemMonitorGroup=systemMonitorGroup, dcEqualize=dcEqualize, dcNonUrgentAlarmIdentifier=dcNonUrgentAlarmIdentifier, dcUsMax=dcUsMax, dcBoD=dcBoD, dcLossOfBackupTimeEnabled=dcLossOfBackupTimeEnabled, dcGenericAlarmTable=dcGenericAlarmTable, dcLimitSwitchingTimes=dcLimitSwitchingTimes, dcBatteryParameter=dcBatteryParameter, dcGenericAlarmEntry=dcGenericAlarmEntry, dcPowerLimitationEntry=dcPowerLimitationEntry, dcTrapDestinationTable=dcTrapDestinationTable, dcLossOfBackupTimeStatus=dcLossOfBackupTimeStatus, dcControlEventValue=dcControlEventValue, alarmTableGroup=alarmTableGroup, notificationsGroup=notificationsGroup, rectifierGroupTableGroup=rectifierGroupTableGroup, dcRectifierGroupName=dcRectifierGroupName, dcLoadCurrent=dcLoadCurrent, dcMeasurementValue=dcMeasurementValue, dcBatteryTestParameter=dcBatteryTestParameter, dcBatteryTestResult=dcBatteryTestResult, dcEqualizeLeadTime=dcEqualizeLeadTime, dcMeterPanelEventHourMeterValue=dcMeterPanelEventHourMeterValue, dcBatteryTestUsupport=dcBatteryTestUsupport, dcBatteryTestEndVoltage=dcBatteryTestEndVoltage, dcBoostChargeParameter=dcBoostChargeParameter, rectifierGroup=rectifierGroup, dcBoostChargeUseBattRoomFanEnabled=dcBoostChargeUseBattRoomFanEnabled, dcRectifierGroupPowerupTime=dcRectifierGroupPowerupTime, dcEventProcessingEventSelected=dcEventProcessingEventSelected, dcNumberUrgentAlarms=dcNumberUrgentAlarms, dcRectifierEntry=dcRectifierEntry, dcMainsFailureAlarm=dcMainsFailureAlarm, dcRectifierGroupInputLowOff=dcRectifierGroupInputLowOff, controllerObjects=controllerObjects, dcRectifierGroupStartupPowerLimit=dcRectifierGroupStartupPowerLimit, powerLimitationTableGroup=powerLimitationTableGroup, dcResendActiveAlarmTraps=dcResendActiveAlarmTraps, dcSystemName=dcSystemName, dcGenericAlarmEventName=dcGenericAlarmEventName, dcSoftwareVersion=dcSoftwareVersion, dcLossOfBackupTime=dcLossOfBackupTime, dcGenericAlarmIndex=dcGenericAlarmIndex, dcBatteryTestType=dcBatteryTestType, dcDefaultLogEventTable=dcDefaultLogEventTable, dcLvdName=dcLvdName, dcSiteName=dcSiteName, dcBatteryStringName=dcBatteryStringName, dcBatteryTestDischargeCurrent=dcBatteryTestDischargeCurrent, dcBatteryTestFailureEvent=dcBatteryTestFailureEvent, dcUsMin=dcUsMin, dcBoostChargeVoltage=dcBoostChargeVoltage, dcSystemInfo=dcSystemInfo, dcSystemPower=dcSystemPower, PYSNMP_MODULE_ID=orionBaseMibModule, dcBoostChargeMaxDuration=dcBoostChargeMaxDuration, dcEvtCtrlChargeType=dcEvtCtrlChargeType, dcRectifierTable=dcRectifierTable, dcMeasurementTable=dcMeasurementTable, dcLvdTable=dcLvdTable, dcEqualizeStartTimeIntervalFrom=dcEqualizeStartTimeIntervalFrom, dcRectifierIndex=dcRectifierIndex, dcEqualizeStartTimeIntervalTo=dcEqualizeStartTimeIntervalTo, dcRectifierGroupTable=dcRectifierGroupTable, dcBatteryTestStatus=dcBatteryTestStatus, dcLowStartTemp=dcLowStartTemp, dcFloatCharge=dcFloatCharge, dcBoostChargeControl=dcBoostChargeControl, dcPowerLimitationEventName=dcPowerLimitationEventName, dcRectifierFunctions=dcRectifierFunctions)
mibBuilder.exportSymbols("ORION-BASE-MIB", dcEvtCtrlChargeTempCompEnabled=dcEvtCtrlChargeTempCompEnabled, dcBatteryStringEntry=dcBatteryStringEntry, dcEqualizeInterval=dcEqualizeInterval, dcNumberRectifiers=dcNumberRectifiers, dcEventProcessingEventAssigned=dcEventProcessingEventAssigned, dcEventHistoryMessage=dcEventHistoryMessage, dcEqualizeDuration=dcEqualizeDuration, dcRectifierGroupInputLowOn=dcRectifierGroupInputLowOn, dcBatteryStringTable=dcBatteryStringTable, dcEfficiencyCycling=dcEfficiencyCycling, dcBatteryTestTempFrom=dcBatteryTestTempFrom, dcPowerLimitationIndex=dcPowerLimitationIndex, eventProcessingEventTableGroup=eventProcessingEventTableGroup, dcBoostChargeIstart=dcBoostChargeIstart)
