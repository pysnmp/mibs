...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: apTextualConventions.setRevisionsDescriptions(('Initial revision.', 'Expanded ApHardwareModuleFamily with niu10g.', 'Updated Organization and Contact info.', 'Added ApDosThresholdTrafficType and\n                          ApDosThresholdCrossState', 'Added ApCounterStatsType', 'Added serverUnreachable to ApStirStatsType', 'Added vsSuccessVerification to ApStirStatsType', 'Added apMSRPKPICounterStatsType', 'Added apMSRPKPIStatsType', 'Updated KPI names in ApMsrpKpiStatsType', 'Updated REPORTRate KPIs in ApMsrpKpiStatsType', 'Enhanced ApStirStatsType', 'Added ApNSEPRealmRvalueDNIndex and\n                            ApNSEPRealmStatsType', 'Added asServiceUnreachable and\n                vsServiceUnreachable to ApStirStatsType',))
...
class ApMsrpKpiStatsType(TextualConvention, Integer32):
    description = 'Type of MSRP KPI stats '
    status = 'current'
...
class ApNSEPRealmRvalueDNIndex(TextualConvention, Integer32):
    description = 'Index of Rvalue and DialedNumber'
    status = 'current'
...
class ApNSEPRealmStatsType(TextualConvention, Integer32):
    description = 'Type of NSEP stats'
    status = 'current'
