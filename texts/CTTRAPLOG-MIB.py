...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", z80Time=z80Time, lastLoggedEntryLogId=lastLoggedEntryLogId, filterEntry=filterEntry, filterTimeLogged=filterTimeLogged, logCommand=logCommand, trapLogAcknowledged=trapLogAcknowledged, filterLogId=filterLogId, filterTrapOID=filterTrapOID, totalNumberOfEntries=totalNumberOfEntries, filterNvmpId=filterNvmpId, configTableEntry=configTableEntry, filterZ80Time=filterZ80Time, nvmpId=nvmpId, configTable=configTable, numEntriesRequested=numEntriesRequested, trapLogDescription=trapLogDescription, numEntriesAllocated=numEntriesAllocated, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogVarBind=trapLogVarBind, trapLoggerAgent=trapLoggerAgent, slotInChassis=slotInChassis, filterTrapLogDescription=filterTrapLogDescription, logId=logId, filterTrapLogVarBind=filterTrapLogVarBind, timeLogged=timeLogged, wrap=wrap, trapLogEntry=trapLogEntry, numEntriesLoggeds=numEntriesLoggeds, trapLogTable=trapLogTable, filterSlotInChassis=filterSlotInChassis, slotChassis=slotChassis, filterFilterId=filterFilterId, trapOID=trapOID, filterId=filterId, filterTable=filterTable)
