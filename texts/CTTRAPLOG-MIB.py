...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterId=filterId, configTableEntry=configTableEntry, numEntriesRequested=numEntriesRequested, logCommand=logCommand, numEntriesAllocated=numEntriesAllocated, trapOID=trapOID, filterNvmpId=filterNvmpId, numEntriesLoggeds=numEntriesLoggeds, filterTimeLogged=filterTimeLogged, slotChassis=slotChassis, filterEntry=filterEntry, trapLogEntry=trapLogEntry, filterTrapLogVarBind=filterTrapLogVarBind, lastLoggedEntryLogId=lastLoggedEntryLogId, trapLogVarBind=trapLogVarBind, filterTable=filterTable, filterSlotInChassis=filterSlotInChassis, trapLoggerAgent=trapLoggerAgent, filterTrapLogDescription=filterTrapLogDescription, configTable=configTable, filterTrapLogAcknowledged=filterTrapLogAcknowledged, totalNumberOfEntries=totalNumberOfEntries, wrap=wrap, logId=logId, filterZ80Time=filterZ80Time, trapLogDescription=trapLogDescription, nvmpId=nvmpId, filterTrapOID=filterTrapOID, timeLogged=timeLogged, filterLogId=filterLogId, slotInChassis=slotInChassis, filterFilterId=filterFilterId, z80Time=z80Time, trapLogAcknowledged=trapLogAcknowledged, trapLogTable=trapLogTable)
