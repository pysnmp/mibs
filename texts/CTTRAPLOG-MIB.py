...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", timeLogged=timeLogged, totalNumberOfEntries=totalNumberOfEntries, slotChassis=slotChassis, filterTrapLogDescription=filterTrapLogDescription, trapOID=trapOID, filterTrapLogAcknowledged=filterTrapLogAcknowledged, logCommand=logCommand, logId=logId, numEntriesRequested=numEntriesRequested, filterId=filterId, filterZ80Time=filterZ80Time, trapLoggerAgent=trapLoggerAgent, wrap=wrap, numEntriesLoggeds=numEntriesLoggeds, configTable=configTable, trapLogTable=trapLogTable, filterEntry=filterEntry, filterTrapLogVarBind=filterTrapLogVarBind, trapLogVarBind=trapLogVarBind, trapLogAcknowledged=trapLogAcknowledged, filterNvmpId=filterNvmpId, z80Time=z80Time, numEntriesAllocated=numEntriesAllocated, configTableEntry=configTableEntry, filterLogId=filterLogId, filterSlotInChassis=filterSlotInChassis, filterTrapOID=filterTrapOID, lastLoggedEntryLogId=lastLoggedEntryLogId, slotInChassis=slotInChassis, trapLogDescription=trapLogDescription, nvmpId=nvmpId, filterTimeLogged=filterTimeLogged, filterTable=filterTable, trapLogEntry=trapLogEntry, filterFilterId=filterFilterId)
