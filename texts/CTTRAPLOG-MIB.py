...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", slotChassis=slotChassis, filterTable=filterTable, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterEntry=filterEntry, trapLogEntry=trapLogEntry, filterTrapLogDescription=filterTrapLogDescription, filterSlotInChassis=filterSlotInChassis, numEntriesRequested=numEntriesRequested, filterId=filterId, numEntriesLoggeds=numEntriesLoggeds, filterTrapOID=filterTrapOID, numEntriesAllocated=numEntriesAllocated, configTable=configTable, lastLoggedEntryLogId=lastLoggedEntryLogId, nvmpId=nvmpId, filterNvmpId=filterNvmpId, trapOID=trapOID, configTableEntry=configTableEntry, trapLogDescription=trapLogDescription, timeLogged=timeLogged, trapLogAcknowledged=trapLogAcknowledged, logCommand=logCommand, trapLogTable=trapLogTable, trapLoggerAgent=trapLoggerAgent, filterLogId=filterLogId, filterZ80Time=filterZ80Time, logId=logId, filterFilterId=filterFilterId, slotInChassis=slotInChassis, filterTrapLogVarBind=filterTrapLogVarBind, z80Time=z80Time, wrap=wrap, totalNumberOfEntries=totalNumberOfEntries, filterTimeLogged=filterTimeLogged, trapLogVarBind=trapLogVarBind)
