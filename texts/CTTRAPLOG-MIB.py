...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterNvmpId=filterNvmpId, filterFilterId=filterFilterId, trapLoggerAgent=trapLoggerAgent, wrap=wrap, nvmpId=nvmpId, numEntriesAllocated=numEntriesAllocated, filterTable=filterTable, filterZ80Time=filterZ80Time, filterTrapLogVarBind=filterTrapLogVarBind, filterTrapLogDescription=filterTrapLogDescription, configTableEntry=configTableEntry, logId=logId, trapLogDescription=trapLogDescription, logCommand=logCommand, timeLogged=timeLogged, numEntriesRequested=numEntriesRequested, lastLoggedEntryLogId=lastLoggedEntryLogId, totalNumberOfEntries=totalNumberOfEntries, trapLogTable=trapLogTable, trapLogAcknowledged=trapLogAcknowledged, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogEntry=trapLogEntry, numEntriesLoggeds=numEntriesLoggeds, slotInChassis=slotInChassis, filterId=filterId, z80Time=z80Time, filterTrapOID=filterTrapOID, slotChassis=slotChassis, filterEntry=filterEntry, trapLogVarBind=trapLogVarBind, filterSlotInChassis=filterSlotInChassis, configTable=configTable, filterTimeLogged=filterTimeLogged, filterLogId=filterLogId, trapOID=trapOID)
