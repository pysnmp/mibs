...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", slotInChassis=slotInChassis, trapOID=trapOID, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterSlotInChassis=filterSlotInChassis, filterZ80Time=filterZ80Time, trapLogTable=trapLogTable, numEntriesAllocated=numEntriesAllocated, filterTrapLogVarBind=filterTrapLogVarBind, filterEntry=filterEntry, filterLogId=filterLogId, totalNumberOfEntries=totalNumberOfEntries, trapLogDescription=trapLogDescription, filterTrapOID=filterTrapOID, lastLoggedEntryLogId=lastLoggedEntryLogId, trapLogEntry=trapLogEntry, nvmpId=nvmpId, filterId=filterId, trapLogAcknowledged=trapLogAcknowledged, trapLoggerAgent=trapLoggerAgent, slotChassis=slotChassis, filterTimeLogged=filterTimeLogged, numEntriesRequested=numEntriesRequested, timeLogged=timeLogged, filterTrapLogDescription=filterTrapLogDescription, z80Time=z80Time, filterTable=filterTable, logId=logId, logCommand=logCommand, wrap=wrap, configTableEntry=configTableEntry, filterNvmpId=filterNvmpId, configTable=configTable, numEntriesLoggeds=numEntriesLoggeds, trapLogVarBind=trapLogVarBind, filterFilterId=filterFilterId)
