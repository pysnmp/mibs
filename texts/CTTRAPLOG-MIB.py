...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", trapLogVarBind=trapLogVarBind, filterTrapLogVarBind=filterTrapLogVarBind, filterTimeLogged=filterTimeLogged, totalNumberOfEntries=totalNumberOfEntries, trapLogTable=trapLogTable, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogEntry=trapLogEntry, lastLoggedEntryLogId=lastLoggedEntryLogId, wrap=wrap, trapLogDescription=trapLogDescription, numEntriesRequested=numEntriesRequested, numEntriesAllocated=numEntriesAllocated, logId=logId, nvmpId=nvmpId, numEntriesLoggeds=numEntriesLoggeds, filterFilterId=filterFilterId, filterTrapOID=filterTrapOID, filterLogId=filterLogId, filterId=filterId, slotInChassis=slotInChassis, slotChassis=slotChassis, timeLogged=timeLogged, filterZ80Time=filterZ80Time, z80Time=z80Time, logCommand=logCommand, filterTrapLogDescription=filterTrapLogDescription, trapLogAcknowledged=trapLogAcknowledged, configTable=configTable, filterSlotInChassis=filterSlotInChassis, trapLoggerAgent=trapLoggerAgent, filterEntry=filterEntry, configTableEntry=configTableEntry, filterTable=filterTable, filterNvmpId=filterNvmpId, trapOID=trapOID)
