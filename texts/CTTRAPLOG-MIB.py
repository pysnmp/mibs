...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", numEntriesLoggeds=numEntriesLoggeds, filterId=filterId, configTable=configTable, z80Time=z80Time, logCommand=logCommand, timeLogged=timeLogged, trapLogTable=trapLogTable, filterZ80Time=filterZ80Time, nvmpId=nvmpId, numEntriesAllocated=numEntriesAllocated, trapLoggerAgent=trapLoggerAgent, filterSlotInChassis=filterSlotInChassis, filterTable=filterTable, totalNumberOfEntries=totalNumberOfEntries, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogDescription=trapLogDescription, slotChassis=slotChassis, filterFilterId=filterFilterId, configTableEntry=configTableEntry, slotInChassis=slotInChassis, numEntriesRequested=numEntriesRequested, logId=logId, filterLogId=filterLogId, filterTrapLogDescription=filterTrapLogDescription, trapOID=trapOID, trapLogVarBind=trapLogVarBind, filterEntry=filterEntry, filterTrapLogVarBind=filterTrapLogVarBind, filterTimeLogged=filterTimeLogged, filterTrapOID=filterTrapOID, filterNvmpId=filterNvmpId, trapLogEntry=trapLogEntry, trapLogAcknowledged=trapLogAcknowledged, wrap=wrap, lastLoggedEntryLogId=lastLoggedEntryLogId)
