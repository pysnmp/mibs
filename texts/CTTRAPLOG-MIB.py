...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", slotChassis=slotChassis, configTable=configTable, trapLogAcknowledged=trapLogAcknowledged, nvmpId=nvmpId, logId=logId, filterZ80Time=filterZ80Time, filterEntry=filterEntry, filterTimeLogged=filterTimeLogged, trapLogEntry=trapLogEntry, totalNumberOfEntries=totalNumberOfEntries, trapLoggerAgent=trapLoggerAgent, timeLogged=timeLogged, filterTrapLogVarBind=filterTrapLogVarBind, trapLogTable=trapLogTable, wrap=wrap, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterTrapOID=filterTrapOID, filterFilterId=filterFilterId, lastLoggedEntryLogId=lastLoggedEntryLogId, configTableEntry=configTableEntry, numEntriesAllocated=numEntriesAllocated, slotInChassis=slotInChassis, numEntriesRequested=numEntriesRequested, filterTable=filterTable, filterLogId=filterLogId, trapOID=trapOID, logCommand=logCommand, filterNvmpId=filterNvmpId, trapLogVarBind=trapLogVarBind, filterTrapLogDescription=filterTrapLogDescription, numEntriesLoggeds=numEntriesLoggeds, trapLogDescription=trapLogDescription, filterId=filterId, z80Time=z80Time, filterSlotInChassis=filterSlotInChassis)
