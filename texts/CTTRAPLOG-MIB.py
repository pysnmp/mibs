...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterSlotInChassis=filterSlotInChassis, trapLogEntry=trapLogEntry, nvmpId=nvmpId, trapLoggerAgent=trapLoggerAgent, configTable=configTable, filterTrapLogDescription=filterTrapLogDescription, numEntriesRequested=numEntriesRequested, filterLogId=filterLogId, z80Time=z80Time, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterEntry=filterEntry, totalNumberOfEntries=totalNumberOfEntries, trapLogTable=trapLogTable, logId=logId, trapOID=trapOID, trapLogVarBind=trapLogVarBind, filterFilterId=filterFilterId, timeLogged=timeLogged, logCommand=logCommand, filterTable=filterTable, wrap=wrap, filterNvmpId=filterNvmpId, filterId=filterId, slotChassis=slotChassis, lastLoggedEntryLogId=lastLoggedEntryLogId, configTableEntry=configTableEntry, slotInChassis=slotInChassis, filterTimeLogged=filterTimeLogged, numEntriesLoggeds=numEntriesLoggeds, filterTrapOID=filterTrapOID, trapLogAcknowledged=trapLogAcknowledged, filterZ80Time=filterZ80Time, numEntriesAllocated=numEntriesAllocated, filterTrapLogVarBind=filterTrapLogVarBind, trapLogDescription=trapLogDescription)
