...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", logCommand=logCommand, numEntriesAllocated=numEntriesAllocated, numEntriesLoggeds=numEntriesLoggeds, trapOID=trapOID, filterLogId=filterLogId, filterNvmpId=filterNvmpId, configTable=configTable, trapLogDescription=trapLogDescription, trapLogEntry=trapLogEntry, configTableEntry=configTableEntry, trapLogVarBind=trapLogVarBind, filterTrapOID=filterTrapOID, filterZ80Time=filterZ80Time, filterFilterId=filterFilterId, trapLogAcknowledged=trapLogAcknowledged, timeLogged=timeLogged, z80Time=z80Time, logId=logId, wrap=wrap, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterId=filterId, trapLogTable=trapLogTable, filterSlotInChassis=filterSlotInChassis, nvmpId=nvmpId, filterEntry=filterEntry, trapLoggerAgent=trapLoggerAgent, filterTable=filterTable, numEntriesRequested=numEntriesRequested, slotChassis=slotChassis, filterTrapLogDescription=filterTrapLogDescription, slotInChassis=slotInChassis, totalNumberOfEntries=totalNumberOfEntries, filterTimeLogged=filterTimeLogged, filterTrapLogVarBind=filterTrapLogVarBind, lastLoggedEntryLogId=lastLoggedEntryLogId)
