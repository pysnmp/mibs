...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterTable=filterTable, configTable=configTable, trapLoggerAgent=trapLoggerAgent, numEntriesRequested=numEntriesRequested, filterEntry=filterEntry, filterNvmpId=filterNvmpId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, slotChassis=slotChassis, filterId=filterId, numEntriesLoggeds=numEntriesLoggeds, numEntriesAllocated=numEntriesAllocated, z80Time=z80Time, filterLogId=filterLogId, totalNumberOfEntries=totalNumberOfEntries, trapLogEntry=trapLogEntry, logCommand=logCommand, timeLogged=timeLogged, trapOID=trapOID, configTableEntry=configTableEntry, nvmpId=nvmpId, wrap=wrap, trapLogAcknowledged=trapLogAcknowledged, trapLogTable=trapLogTable, filterTimeLogged=filterTimeLogged, trapLogDescription=trapLogDescription, filterZ80Time=filterZ80Time, slotInChassis=slotInChassis, logId=logId, trapLogVarBind=trapLogVarBind, filterTrapLogVarBind=filterTrapLogVarBind, filterSlotInChassis=filterSlotInChassis, lastLoggedEntryLogId=lastLoggedEntryLogId, filterTrapLogDescription=filterTrapLogDescription, filterTrapOID=filterTrapOID, filterFilterId=filterFilterId)
