...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", totalNumberOfEntries=totalNumberOfEntries, filterTimeLogged=filterTimeLogged, numEntriesLoggeds=numEntriesLoggeds, filterFilterId=filterFilterId, filterTable=filterTable, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterSlotInChassis=filterSlotInChassis, trapOID=trapOID, filterNvmpId=filterNvmpId, logCommand=logCommand, trapLoggerAgent=trapLoggerAgent, filterZ80Time=filterZ80Time, trapLogDescription=trapLogDescription, slotChassis=slotChassis, filterTrapLogVarBind=filterTrapLogVarBind, slotInChassis=slotInChassis, trapLogEntry=trapLogEntry, configTable=configTable, z80Time=z80Time, filterTrapLogDescription=filterTrapLogDescription, configTableEntry=configTableEntry, logId=logId, filterEntry=filterEntry, numEntriesAllocated=numEntriesAllocated, timeLogged=timeLogged, filterLogId=filterLogId, lastLoggedEntryLogId=lastLoggedEntryLogId, numEntriesRequested=numEntriesRequested, trapLogTable=trapLogTable, nvmpId=nvmpId, trapLogAcknowledged=trapLogAcknowledged, trapLogVarBind=trapLogVarBind, wrap=wrap, filterTrapOID=filterTrapOID, filterId=filterId)
