...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterNvmpId=filterNvmpId, trapLogVarBind=trapLogVarBind, trapOID=trapOID, filterId=filterId, z80Time=z80Time, filterTable=filterTable, filterTrapLogVarBind=filterTrapLogVarBind, lastLoggedEntryLogId=lastLoggedEntryLogId, trapLogDescription=trapLogDescription, filterEntry=filterEntry, filterZ80Time=filterZ80Time, nvmpId=nvmpId, filterTrapOID=filterTrapOID, filterSlotInChassis=filterSlotInChassis, filterTrapLogDescription=filterTrapLogDescription, logCommand=logCommand, numEntriesLoggeds=numEntriesLoggeds, timeLogged=timeLogged, filterTimeLogged=filterTimeLogged, logId=logId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, totalNumberOfEntries=totalNumberOfEntries, numEntriesAllocated=numEntriesAllocated, trapLogEntry=trapLogEntry, slotChassis=slotChassis, wrap=wrap, filterFilterId=filterFilterId, configTable=configTable, filterLogId=filterLogId, configTableEntry=configTableEntry, trapLogAcknowledged=trapLogAcknowledged, numEntriesRequested=numEntriesRequested, slotInChassis=slotInChassis, trapLogTable=trapLogTable, trapLoggerAgent=trapLoggerAgent)
