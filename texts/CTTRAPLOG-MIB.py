...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterTable=filterTable, trapLogVarBind=trapLogVarBind, filterSlotInChassis=filterSlotInChassis, trapOID=trapOID, lastLoggedEntryLogId=lastLoggedEntryLogId, logCommand=logCommand, numEntriesLoggeds=numEntriesLoggeds, filterTrapLogDescription=filterTrapLogDescription, trapLogDescription=trapLogDescription, numEntriesAllocated=numEntriesAllocated, wrap=wrap, timeLogged=timeLogged, nvmpId=nvmpId, filterEntry=filterEntry, slotInChassis=slotInChassis, filterLogId=filterLogId, filterFilterId=filterFilterId, filterNvmpId=filterNvmpId, filterZ80Time=filterZ80Time, configTable=configTable, totalNumberOfEntries=totalNumberOfEntries, filterTrapLogVarBind=filterTrapLogVarBind, filterTimeLogged=filterTimeLogged, filterId=filterId, trapLogEntry=trapLogEntry, slotChassis=slotChassis, trapLogAcknowledged=trapLogAcknowledged, numEntriesRequested=numEntriesRequested, z80Time=z80Time, logId=logId, configTableEntry=configTableEntry, filterTrapOID=filterTrapOID, trapLogTable=trapLogTable, trapLoggerAgent=trapLoggerAgent, filterTrapLogAcknowledged=filterTrapLogAcknowledged)
