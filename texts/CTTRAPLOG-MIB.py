...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", trapLogAcknowledged=trapLogAcknowledged, logId=logId, trapLoggerAgent=trapLoggerAgent, totalNumberOfEntries=totalNumberOfEntries, logCommand=logCommand, slotInChassis=slotInChassis, filterTrapOID=filterTrapOID, filterFilterId=filterFilterId, filterTable=filterTable, trapLogTable=trapLogTable, trapLogVarBind=trapLogVarBind, timeLogged=timeLogged, trapLogDescription=trapLogDescription, filterNvmpId=filterNvmpId, filterTrapLogVarBind=filterTrapLogVarBind, filterTrapLogDescription=filterTrapLogDescription, filterSlotInChassis=filterSlotInChassis, numEntriesRequested=numEntriesRequested, filterId=filterId, trapLogEntry=trapLogEntry, filterEntry=filterEntry, configTableEntry=configTableEntry, numEntriesLoggeds=numEntriesLoggeds, filterZ80Time=filterZ80Time, wrap=wrap, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapOID=trapOID, nvmpId=nvmpId, configTable=configTable, filterLogId=filterLogId, filterTimeLogged=filterTimeLogged, slotChassis=slotChassis, numEntriesAllocated=numEntriesAllocated, lastLoggedEntryLogId=lastLoggedEntryLogId, z80Time=z80Time)
