...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", slotInChassis=slotInChassis, filterLogId=filterLogId, trapLogEntry=trapLogEntry, filterTable=filterTable, numEntriesLoggeds=numEntriesLoggeds, numEntriesRequested=numEntriesRequested, filterSlotInChassis=filterSlotInChassis, configTable=configTable, trapLogTable=trapLogTable, trapLoggerAgent=trapLoggerAgent, trapLogVarBind=trapLogVarBind, logCommand=logCommand, filterId=filterId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, wrap=wrap, trapLogAcknowledged=trapLogAcknowledged, timeLogged=timeLogged, filterEntry=filterEntry, z80Time=z80Time, filterTrapLogDescription=filterTrapLogDescription, filterNvmpId=filterNvmpId, filterFilterId=filterFilterId, filterTrapLogVarBind=filterTrapLogVarBind, filterZ80Time=filterZ80Time, trapOID=trapOID, totalNumberOfEntries=totalNumberOfEntries, numEntriesAllocated=numEntriesAllocated, slotChassis=slotChassis, filterTimeLogged=filterTimeLogged, trapLogDescription=trapLogDescription, configTableEntry=configTableEntry, logId=logId, filterTrapOID=filterTrapOID, lastLoggedEntryLogId=lastLoggedEntryLogId, nvmpId=nvmpId)
