...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", trapLogDescription=trapLogDescription, z80Time=z80Time, lastLoggedEntryLogId=lastLoggedEntryLogId, slotInChassis=slotInChassis, filterId=filterId, numEntriesLoggeds=numEntriesLoggeds, filterEntry=filterEntry, filterLogId=filterLogId, trapOID=trapOID, filterTrapLogDescription=filterTrapLogDescription, numEntriesRequested=numEntriesRequested, trapLogVarBind=trapLogVarBind, filterFilterId=filterFilterId, wrap=wrap, filterNvmpId=filterNvmpId, trapLogAcknowledged=trapLogAcknowledged, slotChassis=slotChassis, numEntriesAllocated=numEntriesAllocated, configTableEntry=configTableEntry, filterTrapLogVarBind=filterTrapLogVarBind, configTable=configTable, trapLoggerAgent=trapLoggerAgent, filterTable=filterTable, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterZ80Time=filterZ80Time, trapLogTable=trapLogTable, timeLogged=timeLogged, totalNumberOfEntries=totalNumberOfEntries, trapLogEntry=trapLogEntry, filterSlotInChassis=filterSlotInChassis, logCommand=logCommand, filterTimeLogged=filterTimeLogged, filterTrapOID=filterTrapOID, logId=logId, nvmpId=nvmpId)
