...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterTrapLogVarBind=filterTrapLogVarBind, filterId=filterId, numEntriesRequested=numEntriesRequested, timeLogged=timeLogged, filterFilterId=filterFilterId, filterLogId=filterLogId, logCommand=logCommand, lastLoggedEntryLogId=lastLoggedEntryLogId, numEntriesLoggeds=numEntriesLoggeds, configTable=configTable, nvmpId=nvmpId, slotChassis=slotChassis, trapLogVarBind=trapLogVarBind, trapLogAcknowledged=trapLogAcknowledged, wrap=wrap, trapLogTable=trapLogTable, filterTrapLogDescription=filterTrapLogDescription, trapOID=trapOID, filterEntry=filterEntry, trapLogDescription=trapLogDescription, logId=logId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLoggerAgent=trapLoggerAgent, filterNvmpId=filterNvmpId, filterTrapOID=filterTrapOID, filterTimeLogged=filterTimeLogged, numEntriesAllocated=numEntriesAllocated, trapLogEntry=trapLogEntry, totalNumberOfEntries=totalNumberOfEntries, z80Time=z80Time, configTableEntry=configTableEntry, filterZ80Time=filterZ80Time, filterSlotInChassis=filterSlotInChassis, filterTable=filterTable, slotInChassis=slotInChassis)
