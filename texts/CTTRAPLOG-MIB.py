...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterTimeLogged=filterTimeLogged, filterFilterId=filterFilterId, lastLoggedEntryLogId=lastLoggedEntryLogId, filterNvmpId=filterNvmpId, filterTable=filterTable, filterZ80Time=filterZ80Time, filterTrapOID=filterTrapOID, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterTrapLogVarBind=filterTrapLogVarBind, filterTrapLogDescription=filterTrapLogDescription, filterId=filterId, filterLogId=filterLogId, configTable=configTable, trapLogTable=trapLogTable, trapLogVarBind=trapLogVarBind, z80Time=z80Time, timeLogged=timeLogged, totalNumberOfEntries=totalNumberOfEntries, slotChassis=slotChassis, numEntriesRequested=numEntriesRequested, trapLogEntry=trapLogEntry, numEntriesAllocated=numEntriesAllocated, logId=logId, numEntriesLoggeds=numEntriesLoggeds, configTableEntry=configTableEntry, trapLogAcknowledged=trapLogAcknowledged, trapLogDescription=trapLogDescription, slotInChassis=slotInChassis, filterEntry=filterEntry, filterSlotInChassis=filterSlotInChassis, trapLoggerAgent=trapLoggerAgent, logCommand=logCommand, trapOID=trapOID, wrap=wrap, nvmpId=nvmpId)
