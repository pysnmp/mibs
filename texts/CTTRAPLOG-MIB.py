...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", numEntriesRequested=numEntriesRequested, trapLogVarBind=trapLogVarBind, filterSlotInChassis=filterSlotInChassis, wrap=wrap, numEntriesAllocated=numEntriesAllocated, configTable=configTable, numEntriesLoggeds=numEntriesLoggeds, filterTrapLogDescription=filterTrapLogDescription, trapLogTable=trapLogTable, filterTrapLogVarBind=filterTrapLogVarBind, trapLogAcknowledged=trapLogAcknowledged, trapLogEntry=trapLogEntry, filterId=filterId, filterEntry=filterEntry, logCommand=logCommand, slotChassis=slotChassis, trapOID=trapOID, trapLogDescription=trapLogDescription, filterNvmpId=filterNvmpId, filterFilterId=filterFilterId, filterTable=filterTable, filterTrapOID=filterTrapOID, trapLoggerAgent=trapLoggerAgent, z80Time=z80Time, logId=logId, lastLoggedEntryLogId=lastLoggedEntryLogId, configTableEntry=configTableEntry, filterTimeLogged=filterTimeLogged, filterLogId=filterLogId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, totalNumberOfEntries=totalNumberOfEntries, filterZ80Time=filterZ80Time, slotInChassis=slotInChassis, nvmpId=nvmpId, timeLogged=timeLogged)
