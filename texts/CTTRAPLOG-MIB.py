...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", numEntriesRequested=numEntriesRequested, trapLoggerAgent=trapLoggerAgent, slotInChassis=slotInChassis, z80Time=z80Time, filterTimeLogged=filterTimeLogged, numEntriesLoggeds=numEntriesLoggeds, filterTrapLogVarBind=filterTrapLogVarBind, filterLogId=filterLogId, filterFilterId=filterFilterId, filterTable=filterTable, nvmpId=nvmpId, configTableEntry=configTableEntry, trapLogDescription=trapLogDescription, trapLogVarBind=trapLogVarBind, lastLoggedEntryLogId=lastLoggedEntryLogId, timeLogged=timeLogged, trapLogTable=trapLogTable, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterSlotInChassis=filterSlotInChassis, wrap=wrap, trapLogEntry=trapLogEntry, numEntriesAllocated=numEntriesAllocated, trapLogAcknowledged=trapLogAcknowledged, filterZ80Time=filterZ80Time, configTable=configTable, filterEntry=filterEntry, totalNumberOfEntries=totalNumberOfEntries, logCommand=logCommand, trapOID=trapOID, logId=logId, filterTrapOID=filterTrapOID, filterNvmpId=filterNvmpId, slotChassis=slotChassis, filterTrapLogDescription=filterTrapLogDescription, filterId=filterId)
