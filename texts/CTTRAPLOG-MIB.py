...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", lastLoggedEntryLogId=lastLoggedEntryLogId, configTableEntry=configTableEntry, configTable=configTable, filterId=filterId, logCommand=logCommand, filterEntry=filterEntry, filterSlotInChassis=filterSlotInChassis, filterTrapOID=filterTrapOID, timeLogged=timeLogged, wrap=wrap, numEntriesAllocated=numEntriesAllocated, numEntriesLoggeds=numEntriesLoggeds, nvmpId=nvmpId, trapOID=trapOID, slotInChassis=slotInChassis, logId=logId, filterFilterId=filterFilterId, filterNvmpId=filterNvmpId, totalNumberOfEntries=totalNumberOfEntries, trapLoggerAgent=trapLoggerAgent, filterTable=filterTable, filterLogId=filterLogId, trapLogDescription=trapLogDescription, filterTimeLogged=filterTimeLogged, filterZ80Time=filterZ80Time, filterTrapLogVarBind=filterTrapLogVarBind, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogVarBind=trapLogVarBind, trapLogTable=trapLogTable, trapLogAcknowledged=trapLogAcknowledged, numEntriesRequested=numEntriesRequested, slotChassis=slotChassis, z80Time=z80Time, filterTrapLogDescription=filterTrapLogDescription, trapLogEntry=trapLogEntry)
