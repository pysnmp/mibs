...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", slotInChassis=slotInChassis, trapLogAcknowledged=trapLogAcknowledged, filterTrapLogDescription=filterTrapLogDescription, lastLoggedEntryLogId=lastLoggedEntryLogId, logId=logId, filterTimeLogged=filterTimeLogged, totalNumberOfEntries=totalNumberOfEntries, slotChassis=slotChassis, filterTable=filterTable, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogDescription=trapLogDescription, logCommand=logCommand, filterSlotInChassis=filterSlotInChassis, filterTrapLogVarBind=filterTrapLogVarBind, filterTrapOID=filterTrapOID, numEntriesAllocated=numEntriesAllocated, nvmpId=nvmpId, wrap=wrap, trapLogTable=trapLogTable, trapLoggerAgent=trapLoggerAgent, filterEntry=filterEntry, trapLogEntry=trapLogEntry, configTableEntry=configTableEntry, numEntriesLoggeds=numEntriesLoggeds, filterFilterId=filterFilterId, timeLogged=timeLogged, trapOID=trapOID, numEntriesRequested=numEntriesRequested, filterNvmpId=filterNvmpId, z80Time=z80Time, filterId=filterId, filterLogId=filterLogId, filterZ80Time=filterZ80Time, configTable=configTable, trapLogVarBind=trapLogVarBind)
