...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", numEntriesLoggeds=numEntriesLoggeds, trapLogAcknowledged=trapLogAcknowledged, numEntriesAllocated=numEntriesAllocated, filterEntry=filterEntry, lastLoggedEntryLogId=lastLoggedEntryLogId, slotChassis=slotChassis, filterZ80Time=filterZ80Time, trapLogEntry=trapLogEntry, totalNumberOfEntries=totalNumberOfEntries, configTableEntry=configTableEntry, trapLogVarBind=trapLogVarBind, filterSlotInChassis=filterSlotInChassis, filterId=filterId, filterFilterId=filterFilterId, trapLogDescription=trapLogDescription, filterTrapLogVarBind=filterTrapLogVarBind, filterTrapLogDescription=filterTrapLogDescription, trapOID=trapOID, trapLoggerAgent=trapLoggerAgent, filterLogId=filterLogId, filterNvmpId=filterNvmpId, logId=logId, configTable=configTable, timeLogged=timeLogged, slotInChassis=slotInChassis, logCommand=logCommand, nvmpId=nvmpId, trapLogTable=trapLogTable, filterTrapLogAcknowledged=filterTrapLogAcknowledged, z80Time=z80Time, filterTrapOID=filterTrapOID, filterTable=filterTable, wrap=wrap, filterTimeLogged=filterTimeLogged, numEntriesRequested=numEntriesRequested)
