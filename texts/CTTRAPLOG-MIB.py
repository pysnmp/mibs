...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterId=filterId, logId=logId, filterNvmpId=filterNvmpId, filterTimeLogged=filterTimeLogged, configTableEntry=configTableEntry, filterSlotInChassis=filterSlotInChassis, configTable=configTable, trapLogAcknowledged=trapLogAcknowledged, nvmpId=nvmpId, filterTable=filterTable, slotInChassis=slotInChassis, trapLoggerAgent=trapLoggerAgent, lastLoggedEntryLogId=lastLoggedEntryLogId, filterTrapLogVarBind=filterTrapLogVarBind, numEntriesAllocated=numEntriesAllocated, trapLogTable=trapLogTable, trapLogEntry=trapLogEntry, numEntriesLoggeds=numEntriesLoggeds, filterTrapOID=filterTrapOID, filterZ80Time=filterZ80Time, numEntriesRequested=numEntriesRequested, logCommand=logCommand, wrap=wrap, slotChassis=slotChassis, trapLogVarBind=trapLogVarBind, totalNumberOfEntries=totalNumberOfEntries, filterEntry=filterEntry, timeLogged=timeLogged, filterTrapLogDescription=filterTrapLogDescription, z80Time=z80Time, filterFilterId=filterFilterId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterLogId=filterLogId, trapLogDescription=trapLogDescription, trapOID=trapOID)
