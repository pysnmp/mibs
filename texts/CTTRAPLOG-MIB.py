...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", numEntriesRequested=numEntriesRequested, nvmpId=nvmpId, trapLogAcknowledged=trapLogAcknowledged, configTableEntry=configTableEntry, filterId=filterId, filterZ80Time=filterZ80Time, numEntriesLoggeds=numEntriesLoggeds, lastLoggedEntryLogId=lastLoggedEntryLogId, trapOID=trapOID, filterTable=filterTable, z80Time=z80Time, trapLogEntry=trapLogEntry, numEntriesAllocated=numEntriesAllocated, configTable=configTable, wrap=wrap, slotInChassis=slotInChassis, trapLogTable=trapLogTable, trapLoggerAgent=trapLoggerAgent, filterTrapLogVarBind=filterTrapLogVarBind, trapLogVarBind=trapLogVarBind, timeLogged=timeLogged, filterEntry=filterEntry, trapLogDescription=trapLogDescription, filterTimeLogged=filterTimeLogged, filterTrapOID=filterTrapOID, logId=logId, filterTrapLogDescription=filterTrapLogDescription, filterNvmpId=filterNvmpId, filterFilterId=filterFilterId, totalNumberOfEntries=totalNumberOfEntries, logCommand=logCommand, filterLogId=filterLogId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, slotChassis=slotChassis, filterSlotInChassis=filterSlotInChassis)
