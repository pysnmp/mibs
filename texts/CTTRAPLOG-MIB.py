...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", trapOID=trapOID, filterTimeLogged=filterTimeLogged, filterSlotInChassis=filterSlotInChassis, trapLoggerAgent=trapLoggerAgent, logCommand=logCommand, filterTrapLogDescription=filterTrapLogDescription, nvmpId=nvmpId, configTable=configTable, logId=logId, slotChassis=slotChassis, slotInChassis=slotInChassis, trapLogAcknowledged=trapLogAcknowledged, trapLogTable=trapLogTable, wrap=wrap, filterTrapLogAcknowledged=filterTrapLogAcknowledged, timeLogged=timeLogged, configTableEntry=configTableEntry, numEntriesLoggeds=numEntriesLoggeds, totalNumberOfEntries=totalNumberOfEntries, numEntriesRequested=numEntriesRequested, filterTrapOID=filterTrapOID, z80Time=z80Time, filterFilterId=filterFilterId, filterId=filterId, filterZ80Time=filterZ80Time, numEntriesAllocated=numEntriesAllocated, trapLogDescription=trapLogDescription, trapLogEntry=trapLogEntry, filterEntry=filterEntry, filterTrapLogVarBind=filterTrapLogVarBind, trapLogVarBind=trapLogVarBind, lastLoggedEntryLogId=lastLoggedEntryLogId, filterLogId=filterLogId, filterNvmpId=filterNvmpId, filterTable=filterTable)
