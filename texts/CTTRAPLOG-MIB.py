...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", slotChassis=slotChassis, filterTrapLogVarBind=filterTrapLogVarBind, filterTrapOID=filterTrapOID, wrap=wrap, filterTrapLogDescription=filterTrapLogDescription, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterSlotInChassis=filterSlotInChassis, logId=logId, lastLoggedEntryLogId=lastLoggedEntryLogId, trapLogVarBind=trapLogVarBind, filterZ80Time=filterZ80Time, trapLoggerAgent=trapLoggerAgent, filterLogId=filterLogId, trapLogTable=trapLogTable, trapLogDescription=trapLogDescription, nvmpId=nvmpId, configTable=configTable, numEntriesAllocated=numEntriesAllocated, numEntriesRequested=numEntriesRequested, filterNvmpId=filterNvmpId, configTableEntry=configTableEntry, filterTimeLogged=filterTimeLogged, filterEntry=filterEntry, numEntriesLoggeds=numEntriesLoggeds, z80Time=z80Time, logCommand=logCommand, trapLogAcknowledged=trapLogAcknowledged, slotInChassis=slotInChassis, timeLogged=timeLogged, trapOID=trapOID, filterTable=filterTable, trapLogEntry=trapLogEntry, filterId=filterId, totalNumberOfEntries=totalNumberOfEntries, filterFilterId=filterFilterId)
