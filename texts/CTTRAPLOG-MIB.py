...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", trapLogAcknowledged=trapLogAcknowledged, timeLogged=timeLogged, totalNumberOfEntries=totalNumberOfEntries, filterEntry=filterEntry, filterZ80Time=filterZ80Time, numEntriesAllocated=numEntriesAllocated, logId=logId, trapLogDescription=trapLogDescription, filterId=filterId, trapLogTable=trapLogTable, filterFilterId=filterFilterId, filterTimeLogged=filterTimeLogged, trapLoggerAgent=trapLoggerAgent, numEntriesRequested=numEntriesRequested, configTableEntry=configTableEntry, filterSlotInChassis=filterSlotInChassis, filterTable=filterTable, z80Time=z80Time, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapOID=trapOID, filterTrapLogVarBind=filterTrapLogVarBind, configTable=configTable, numEntriesLoggeds=numEntriesLoggeds, nvmpId=nvmpId, wrap=wrap, slotInChassis=slotInChassis, filterTrapOID=filterTrapOID, slotChassis=slotChassis, filterNvmpId=filterNvmpId, lastLoggedEntryLogId=lastLoggedEntryLogId, filterLogId=filterLogId, logCommand=logCommand, trapLogEntry=trapLogEntry, trapLogVarBind=trapLogVarBind, filterTrapLogDescription=filterTrapLogDescription)
