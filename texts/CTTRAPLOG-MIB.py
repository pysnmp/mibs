...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterLogId=filterLogId, configTable=configTable, logCommand=logCommand, nvmpId=nvmpId, logId=logId, slotChassis=slotChassis, numEntriesRequested=numEntriesRequested, trapLogEntry=trapLogEntry, filterZ80Time=filterZ80Time, slotInChassis=slotInChassis, numEntriesAllocated=numEntriesAllocated, filterTrapOID=filterTrapOID, z80Time=z80Time, filterNvmpId=filterNvmpId, totalNumberOfEntries=totalNumberOfEntries, filterTrapLogAcknowledged=filterTrapLogAcknowledged, configTableEntry=configTableEntry, trapLogAcknowledged=trapLogAcknowledged, trapLogTable=trapLogTable, timeLogged=timeLogged, numEntriesLoggeds=numEntriesLoggeds, wrap=wrap, lastLoggedEntryLogId=lastLoggedEntryLogId, trapLogVarBind=trapLogVarBind, filterTable=filterTable, filterTrapLogDescription=filterTrapLogDescription, filterFilterId=filterFilterId, filterSlotInChassis=filterSlotInChassis, filterTimeLogged=filterTimeLogged, trapLogDescription=trapLogDescription, filterId=filterId, trapLoggerAgent=trapLoggerAgent, filterEntry=filterEntry, filterTrapLogVarBind=filterTrapLogVarBind, trapOID=trapOID)
