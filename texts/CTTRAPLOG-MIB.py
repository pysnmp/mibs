...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", trapLogAcknowledged=trapLogAcknowledged, totalNumberOfEntries=totalNumberOfEntries, slotChassis=slotChassis, trapOID=trapOID, filterTable=filterTable, logId=logId, filterTrapLogDescription=filterTrapLogDescription, timeLogged=timeLogged, trapLogDescription=trapLogDescription, filterZ80Time=filterZ80Time, trapLogTable=trapLogTable, trapLoggerAgent=trapLoggerAgent, filterTrapLogVarBind=filterTrapLogVarBind, nvmpId=nvmpId, z80Time=z80Time, filterTrapLogAcknowledged=filterTrapLogAcknowledged, configTableEntry=configTableEntry, filterEntry=filterEntry, filterNvmpId=filterNvmpId, wrap=wrap, numEntriesRequested=numEntriesRequested, filterSlotInChassis=filterSlotInChassis, lastLoggedEntryLogId=lastLoggedEntryLogId, filterTrapOID=filterTrapOID, filterId=filterId, filterLogId=filterLogId, filterTimeLogged=filterTimeLogged, trapLogVarBind=trapLogVarBind, trapLogEntry=trapLogEntry, numEntriesLoggeds=numEntriesLoggeds, configTable=configTable, numEntriesAllocated=numEntriesAllocated, logCommand=logCommand, slotInChassis=slotInChassis, filterFilterId=filterFilterId)
