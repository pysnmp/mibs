...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", configTable=configTable, slotChassis=slotChassis, nvmpId=nvmpId, filterZ80Time=filterZ80Time, filterId=filterId, filterSlotInChassis=filterSlotInChassis, filterEntry=filterEntry, filterTrapLogDescription=filterTrapLogDescription, logCommand=logCommand, filterNvmpId=filterNvmpId, trapLogVarBind=trapLogVarBind, filterTimeLogged=filterTimeLogged, logId=logId, filterLogId=filterLogId, wrap=wrap, filterTrapOID=filterTrapOID, filterTable=filterTable, totalNumberOfEntries=totalNumberOfEntries, filterTrapLogVarBind=filterTrapLogVarBind, trapLogTable=trapLogTable, trapOID=trapOID, z80Time=z80Time, lastLoggedEntryLogId=lastLoggedEntryLogId, numEntriesRequested=numEntriesRequested, filterFilterId=filterFilterId, trapLogDescription=trapLogDescription, slotInChassis=slotInChassis, trapLoggerAgent=trapLoggerAgent, filterTrapLogAcknowledged=filterTrapLogAcknowledged, configTableEntry=configTableEntry, trapLogAcknowledged=trapLogAcknowledged, timeLogged=timeLogged, numEntriesAllocated=numEntriesAllocated, trapLogEntry=trapLogEntry, numEntriesLoggeds=numEntriesLoggeds)
