...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterTimeLogged=filterTimeLogged, filterId=filterId, slotChassis=slotChassis, filterNvmpId=filterNvmpId, configTable=configTable, totalNumberOfEntries=totalNumberOfEntries, trapLogAcknowledged=trapLogAcknowledged, filterTrapOID=filterTrapOID, configTableEntry=configTableEntry, filterSlotInChassis=filterSlotInChassis, trapLoggerAgent=trapLoggerAgent, numEntriesLoggeds=numEntriesLoggeds, trapLogTable=trapLogTable, trapLogVarBind=trapLogVarBind, filterTable=filterTable, filterEntry=filterEntry, filterTrapLogDescription=filterTrapLogDescription, filterFilterId=filterFilterId, trapOID=trapOID, filterTrapLogAcknowledged=filterTrapLogAcknowledged, nvmpId=nvmpId, timeLogged=timeLogged, logId=logId, lastLoggedEntryLogId=lastLoggedEntryLogId, numEntriesRequested=numEntriesRequested, trapLogEntry=trapLogEntry, slotInChassis=slotInChassis, filterLogId=filterLogId, wrap=wrap, z80Time=z80Time, logCommand=logCommand, filterTrapLogVarBind=filterTrapLogVarBind, numEntriesAllocated=numEntriesAllocated, trapLogDescription=trapLogDescription, filterZ80Time=filterZ80Time)
