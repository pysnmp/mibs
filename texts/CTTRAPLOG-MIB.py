...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", configTableEntry=configTableEntry, trapOID=trapOID, configTable=configTable, trapLogDescription=trapLogDescription, numEntriesRequested=numEntriesRequested, z80Time=z80Time, totalNumberOfEntries=totalNumberOfEntries, lastLoggedEntryLogId=lastLoggedEntryLogId, logCommand=logCommand, filterTimeLogged=filterTimeLogged, filterSlotInChassis=filterSlotInChassis, logId=logId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogVarBind=trapLogVarBind, filterId=filterId, filterTable=filterTable, trapLoggerAgent=trapLoggerAgent, slotChassis=slotChassis, filterEntry=filterEntry, filterTrapLogDescription=filterTrapLogDescription, timeLogged=timeLogged, filterLogId=filterLogId, trapLogTable=trapLogTable, numEntriesLoggeds=numEntriesLoggeds, slotInChassis=slotInChassis, nvmpId=nvmpId, trapLogAcknowledged=trapLogAcknowledged, filterTrapOID=filterTrapOID, filterFilterId=filterFilterId, filterTrapLogVarBind=filterTrapLogVarBind, trapLogEntry=trapLogEntry, filterNvmpId=filterNvmpId, numEntriesAllocated=numEntriesAllocated, wrap=wrap, filterZ80Time=filterZ80Time)
