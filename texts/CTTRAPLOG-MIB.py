...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", numEntriesAllocated=numEntriesAllocated, filterTable=filterTable, filterEntry=filterEntry, trapLogTable=trapLogTable, filterLogId=filterLogId, filterTimeLogged=filterTimeLogged, filterFilterId=filterFilterId, filterTrapOID=filterTrapOID, lastLoggedEntryLogId=lastLoggedEntryLogId, timeLogged=timeLogged, filterNvmpId=filterNvmpId, trapLogEntry=trapLogEntry, logId=logId, trapLogDescription=trapLogDescription, totalNumberOfEntries=totalNumberOfEntries, filterTrapLogAcknowledged=filterTrapLogAcknowledged, logCommand=logCommand, trapLogAcknowledged=trapLogAcknowledged, filterTrapLogDescription=filterTrapLogDescription, z80Time=z80Time, slotInChassis=slotInChassis, filterZ80Time=filterZ80Time, configTableEntry=configTableEntry, numEntriesRequested=numEntriesRequested, filterSlotInChassis=filterSlotInChassis, slotChassis=slotChassis, numEntriesLoggeds=numEntriesLoggeds, filterId=filterId, trapLogVarBind=trapLogVarBind, filterTrapLogVarBind=filterTrapLogVarBind, configTable=configTable, nvmpId=nvmpId, wrap=wrap, trapLoggerAgent=trapLoggerAgent, trapOID=trapOID)
