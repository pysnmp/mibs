...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", nvmpId=nvmpId, trapLoggerAgent=trapLoggerAgent, trapLogTable=trapLogTable, filterFilterId=filterFilterId, z80Time=z80Time, lastLoggedEntryLogId=lastLoggedEntryLogId, trapLogAcknowledged=trapLogAcknowledged, configTable=configTable, slotChassis=slotChassis, logId=logId, configTableEntry=configTableEntry, filterTrapOID=filterTrapOID, filterZ80Time=filterZ80Time, trapLogVarBind=trapLogVarBind, filterLogId=filterLogId, totalNumberOfEntries=totalNumberOfEntries, filterTable=filterTable, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogEntry=trapLogEntry, trapLogDescription=trapLogDescription, trapOID=trapOID, filterTrapLogVarBind=filterTrapLogVarBind, filterId=filterId, timeLogged=timeLogged, filterTimeLogged=filterTimeLogged, filterEntry=filterEntry, numEntriesAllocated=numEntriesAllocated, logCommand=logCommand, filterTrapLogDescription=filterTrapLogDescription, wrap=wrap, filterNvmpId=filterNvmpId, numEntriesLoggeds=numEntriesLoggeds, slotInChassis=slotInChassis, numEntriesRequested=numEntriesRequested, filterSlotInChassis=filterSlotInChassis)
