...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", logCommand=logCommand, filterLogId=filterLogId, filterTrapOID=filterTrapOID, numEntriesLoggeds=numEntriesLoggeds, totalNumberOfEntries=totalNumberOfEntries, trapLoggerAgent=trapLoggerAgent, configTableEntry=configTableEntry, filterSlotInChassis=filterSlotInChassis, trapLogTable=trapLogTable, filterTrapLogAcknowledged=filterTrapLogAcknowledged, logId=logId, trapLogVarBind=trapLogVarBind, filterTrapLogDescription=filterTrapLogDescription, filterNvmpId=filterNvmpId, filterTimeLogged=filterTimeLogged, numEntriesAllocated=numEntriesAllocated, trapLogDescription=trapLogDescription, trapLogAcknowledged=trapLogAcknowledged, filterTable=filterTable, wrap=wrap, trapLogEntry=trapLogEntry, trapOID=trapOID, filterFilterId=filterFilterId, timeLogged=timeLogged, z80Time=z80Time, slotChassis=slotChassis, numEntriesRequested=numEntriesRequested, lastLoggedEntryLogId=lastLoggedEntryLogId, filterEntry=filterEntry, configTable=configTable, nvmpId=nvmpId, filterId=filterId, filterTrapLogVarBind=filterTrapLogVarBind, filterZ80Time=filterZ80Time, slotInChassis=slotInChassis)
