...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", trapLoggerAgent=trapLoggerAgent, filterNvmpId=filterNvmpId, wrap=wrap, filterId=filterId, filterTrapLogDescription=filterTrapLogDescription, configTable=configTable, lastLoggedEntryLogId=lastLoggedEntryLogId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogDescription=trapLogDescription, numEntriesLoggeds=numEntriesLoggeds, trapOID=trapOID, logId=logId, filterFilterId=filterFilterId, filterLogId=filterLogId, trapLogVarBind=trapLogVarBind, filterSlotInChassis=filterSlotInChassis, filterTrapOID=filterTrapOID, logCommand=logCommand, nvmpId=nvmpId, configTableEntry=configTableEntry, trapLogAcknowledged=trapLogAcknowledged, filterZ80Time=filterZ80Time, timeLogged=timeLogged, totalNumberOfEntries=totalNumberOfEntries, filterTable=filterTable, z80Time=z80Time, slotInChassis=slotInChassis, trapLogTable=trapLogTable, trapLogEntry=trapLogEntry, slotChassis=slotChassis, filterEntry=filterEntry, filterTimeLogged=filterTimeLogged, filterTrapLogVarBind=filterTrapLogVarBind, numEntriesAllocated=numEntriesAllocated, numEntriesRequested=numEntriesRequested)
