...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", trapOID=trapOID, trapLogTable=trapLogTable, trapLogAcknowledged=trapLogAcknowledged, filterTrapLogDescription=filterTrapLogDescription, filterFilterId=filterFilterId, nvmpId=nvmpId, configTableEntry=configTableEntry, slotInChassis=slotInChassis, filterTrapLogVarBind=filterTrapLogVarBind, configTable=configTable, logId=logId, filterTimeLogged=filterTimeLogged, numEntriesAllocated=numEntriesAllocated, filterId=filterId, totalNumberOfEntries=totalNumberOfEntries, slotChassis=slotChassis, filterSlotInChassis=filterSlotInChassis, trapLogVarBind=trapLogVarBind, timeLogged=timeLogged, numEntriesRequested=numEntriesRequested, logCommand=logCommand, trapLogDescription=trapLogDescription, filterTrapOID=filterTrapOID, filterZ80Time=filterZ80Time, filterNvmpId=filterNvmpId, filterTable=filterTable, filterLogId=filterLogId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, z80Time=z80Time, filterEntry=filterEntry, lastLoggedEntryLogId=lastLoggedEntryLogId, trapLogEntry=trapLogEntry, numEntriesLoggeds=numEntriesLoggeds, trapLoggerAgent=trapLoggerAgent, wrap=wrap)
