...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", timeLogged=timeLogged, filterLogId=filterLogId, slotChassis=slotChassis, filterTrapOID=filterTrapOID, filterZ80Time=filterZ80Time, filterFilterId=filterFilterId, trapLogVarBind=trapLogVarBind, totalNumberOfEntries=totalNumberOfEntries, trapLogEntry=trapLogEntry, logId=logId, logCommand=logCommand, wrap=wrap, configTableEntry=configTableEntry, numEntriesRequested=numEntriesRequested, filterEntry=filterEntry, lastLoggedEntryLogId=lastLoggedEntryLogId, numEntriesAllocated=numEntriesAllocated, filterTable=filterTable, filterTrapLogDescription=filterTrapLogDescription, filterId=filterId, slotInChassis=slotInChassis, trapLogDescription=trapLogDescription, trapLogAcknowledged=trapLogAcknowledged, filterNvmpId=filterNvmpId, filterTimeLogged=filterTimeLogged, nvmpId=nvmpId, trapOID=trapOID, trapLoggerAgent=trapLoggerAgent, configTable=configTable, filterSlotInChassis=filterSlotInChassis, trapLogTable=trapLogTable, filterTrapLogVarBind=filterTrapLogVarBind, z80Time=z80Time, filterTrapLogAcknowledged=filterTrapLogAcknowledged, numEntriesLoggeds=numEntriesLoggeds)
