...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterTimeLogged=filterTimeLogged, configTable=configTable, lastLoggedEntryLogId=lastLoggedEntryLogId, filterSlotInChassis=filterSlotInChassis, trapOID=trapOID, logId=logId, trapLogEntry=trapLogEntry, trapLoggerAgent=trapLoggerAgent, filterTrapLogVarBind=filterTrapLogVarBind, trapLogTable=trapLogTable, configTableEntry=configTableEntry, filterTrapLogDescription=filterTrapLogDescription, logCommand=logCommand, slotInChassis=slotInChassis, filterLogId=filterLogId, nvmpId=nvmpId, trapLogVarBind=trapLogVarBind, totalNumberOfEntries=totalNumberOfEntries, numEntriesRequested=numEntriesRequested, z80Time=z80Time, filterId=filterId, slotChassis=slotChassis, timeLogged=timeLogged, filterNvmpId=filterNvmpId, filterTable=filterTable, filterEntry=filterEntry, filterZ80Time=filterZ80Time, filterTrapLogAcknowledged=filterTrapLogAcknowledged, numEntriesAllocated=numEntriesAllocated, numEntriesLoggeds=numEntriesLoggeds, wrap=wrap, trapLogDescription=trapLogDescription, trapLogAcknowledged=trapLogAcknowledged, filterFilterId=filterFilterId, filterTrapOID=filterTrapOID)
