...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", wrap=wrap, filterTable=filterTable, filterTrapOID=filterTrapOID, trapLogDescription=trapLogDescription, lastLoggedEntryLogId=lastLoggedEntryLogId, nvmpId=nvmpId, trapLogVarBind=trapLogVarBind, trapLogTable=trapLogTable, filterTimeLogged=filterTimeLogged, slotChassis=slotChassis, filterId=filterId, totalNumberOfEntries=totalNumberOfEntries, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterZ80Time=filterZ80Time, trapLogAcknowledged=trapLogAcknowledged, filterEntry=filterEntry, numEntriesRequested=numEntriesRequested, numEntriesAllocated=numEntriesAllocated, trapLoggerAgent=trapLoggerAgent, trapOID=trapOID, logId=logId, filterSlotInChassis=filterSlotInChassis, configTable=configTable, timeLogged=timeLogged, filterLogId=filterLogId, numEntriesLoggeds=numEntriesLoggeds, slotInChassis=slotInChassis, trapLogEntry=trapLogEntry, logCommand=logCommand, filterTrapLogDescription=filterTrapLogDescription, filterNvmpId=filterNvmpId, configTableEntry=configTableEntry, z80Time=z80Time, filterTrapLogVarBind=filterTrapLogVarBind, filterFilterId=filterFilterId)
