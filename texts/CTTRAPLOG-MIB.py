...
# ASN.1 source CTTRAPLOG-MIB
# Source digest sha256:6ef227044354299934dd440d1296309f8a84b522eee918bad5155cabbfe2e2d8
...
configTable = MibTable((1, 3, 6, 1, 4, 1, 52, 4, 1, 44, 2), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: configTable.setStatus('mandatory')
configTableEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 4, 1, 44, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTTRAPLOG-MIB", "slotInChassis"))
...
trapLogTable = MibTable((1, 3, 6, 1, 4, 1, 52, 4, 1, 44, 3), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: trapLogTable.setStatus('mandatory')
trapLogEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 4, 1, 44, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTTRAPLOG-MIB", "slotChassis"), (0, "CTTRAPLOG-MIB", "logId"))
...
filterTable = MibTable((1, 3, 6, 1, 4, 1, 52, 4, 1, 44, 4), ).setMaxAccess("notaccessible")
if mibBuilder.loadTexts: filterTable.setStatus('mandatory')
filterEntry = MibTableRow((1, 3, 6, 1, 4, 1, 52, 4, 1, 44, 4, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "CTTRAPLOG-MIB", "filterSlotInChassis"), (0, "CTTRAPLOG-MIB", "filterFilterId"), (0, "CTTRAPLOG-MIB", "filterLogId"))
...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", configTable=configTable, configTableEntry=configTableEntry, filterEntry=filterEntry, filterFilterId=filterFilterId, filterId=filterId, filterLogId=filterLogId, filterNvmpId=filterNvmpId, filterSlotInChassis=filterSlotInChassis, filterTable=filterTable, filterTimeLogged=filterTimeLogged, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterTrapLogDescription=filterTrapLogDescription, filterTrapLogVarBind=filterTrapLogVarBind, filterTrapOID=filterTrapOID, filterZ80Time=filterZ80Time, lastLoggedEntryLogId=lastLoggedEntryLogId, logCommand=logCommand, logId=logId, numEntriesAllocated=numEntriesAllocated, numEntriesLoggeds=numEntriesLoggeds, numEntriesRequested=numEntriesRequested, nvmpId=nvmpId, slotChassis=slotChassis, slotInChassis=slotInChassis, timeLogged=timeLogged, totalNumberOfEntries=totalNumberOfEntries, trapLogAcknowledged=trapLogAcknowledged, trapLogDescription=trapLogDescription, trapLogEntry=trapLogEntry, trapLogTable=trapLogTable, trapLogVarBind=trapLogVarBind, trapLoggerAgent=trapLoggerAgent, trapOID=trapOID, wrap=wrap, z80Time=z80Time)
