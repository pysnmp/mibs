...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterLogId=filterLogId, nvmpId=nvmpId, filterFilterId=filterFilterId, filterEntry=filterEntry, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogDescription=trapLogDescription, timeLogged=timeLogged, trapLoggerAgent=trapLoggerAgent, filterTrapLogVarBind=filterTrapLogVarBind, lastLoggedEntryLogId=lastLoggedEntryLogId, totalNumberOfEntries=totalNumberOfEntries, filterTrapLogDescription=filterTrapLogDescription, filterZ80Time=filterZ80Time, filterTimeLogged=filterTimeLogged, numEntriesLoggeds=numEntriesLoggeds, filterNvmpId=filterNvmpId, trapOID=trapOID, z80Time=z80Time, configTable=configTable, filterId=filterId, slotChassis=slotChassis, wrap=wrap, filterTable=filterTable, filterTrapOID=filterTrapOID, configTableEntry=configTableEntry, numEntriesRequested=numEntriesRequested, logId=logId, filterSlotInChassis=filterSlotInChassis, numEntriesAllocated=numEntriesAllocated, trapLogEntry=trapLogEntry, logCommand=logCommand, trapLogTable=trapLogTable, trapLogAcknowledged=trapLogAcknowledged, slotInChassis=slotInChassis, trapLogVarBind=trapLogVarBind)
