...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterId=filterId, slotInChassis=slotInChassis, totalNumberOfEntries=totalNumberOfEntries, trapOID=trapOID, wrap=wrap, filterEntry=filterEntry, z80Time=z80Time, logId=logId, timeLogged=timeLogged, nvmpId=nvmpId, lastLoggedEntryLogId=lastLoggedEntryLogId, slotChassis=slotChassis, filterTimeLogged=filterTimeLogged, configTable=configTable, numEntriesLoggeds=numEntriesLoggeds, filterTrapLogDescription=filterTrapLogDescription, filterLogId=filterLogId, configTableEntry=configTableEntry, logCommand=logCommand, trapLogTable=trapLogTable, trapLogDescription=trapLogDescription, filterNvmpId=filterNvmpId, trapLogVarBind=trapLogVarBind, filterSlotInChassis=filterSlotInChassis, trapLoggerAgent=trapLoggerAgent, numEntriesRequested=numEntriesRequested, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogEntry=trapLogEntry, filterTrapLogVarBind=filterTrapLogVarBind, trapLogAcknowledged=trapLogAcknowledged, filterTable=filterTable, filterZ80Time=filterZ80Time, numEntriesAllocated=numEntriesAllocated, filterTrapOID=filterTrapOID, filterFilterId=filterFilterId)
