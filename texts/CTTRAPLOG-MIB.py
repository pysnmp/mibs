...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", z80Time=z80Time, trapLogDescription=trapLogDescription, configTable=configTable, filterNvmpId=filterNvmpId, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterZ80Time=filterZ80Time, trapLogTable=trapLogTable, trapOID=trapOID, trapLogEntry=trapLogEntry, numEntriesLoggeds=numEntriesLoggeds, trapLogAcknowledged=trapLogAcknowledged, numEntriesRequested=numEntriesRequested, filterTrapLogVarBind=filterTrapLogVarBind, logCommand=logCommand, timeLogged=timeLogged, numEntriesAllocated=numEntriesAllocated, logId=logId, nvmpId=nvmpId, filterLogId=filterLogId, filterEntry=filterEntry, wrap=wrap, lastLoggedEntryLogId=lastLoggedEntryLogId, filterFilterId=filterFilterId, totalNumberOfEntries=totalNumberOfEntries, filterTrapOID=filterTrapOID, slotInChassis=slotInChassis, trapLoggerAgent=trapLoggerAgent, filterId=filterId, slotChassis=slotChassis, filterSlotInChassis=filterSlotInChassis, filterTimeLogged=filterTimeLogged, filterTable=filterTable, trapLogVarBind=trapLogVarBind, filterTrapLogDescription=filterTrapLogDescription, configTableEntry=configTableEntry)
