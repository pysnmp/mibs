...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", lastLoggedEntryLogId=lastLoggedEntryLogId, nvmpId=nvmpId, numEntriesAllocated=numEntriesAllocated, filterId=filterId, trapLogVarBind=trapLogVarBind, filterTable=filterTable, filterTrapLogDescription=filterTrapLogDescription, numEntriesRequested=numEntriesRequested, timeLogged=timeLogged, configTableEntry=configTableEntry, trapOID=trapOID, filterEntry=filterEntry, filterTimeLogged=filterTimeLogged, filterSlotInChassis=filterSlotInChassis, trapLogTable=trapLogTable, trapLoggerAgent=trapLoggerAgent, logId=logId, filterFilterId=filterFilterId, logCommand=logCommand, filterLogId=filterLogId, filterTrapOID=filterTrapOID, totalNumberOfEntries=totalNumberOfEntries, trapLogDescription=trapLogDescription, numEntriesLoggeds=numEntriesLoggeds, filterTrapLogAcknowledged=filterTrapLogAcknowledged, filterZ80Time=filterZ80Time, filterTrapLogVarBind=filterTrapLogVarBind, configTable=configTable, trapLogAcknowledged=trapLogAcknowledged, trapLogEntry=trapLogEntry, slotChassis=slotChassis, z80Time=z80Time, wrap=wrap, filterNvmpId=filterNvmpId, slotInChassis=slotInChassis)
