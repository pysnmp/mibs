...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterTimeLogged=filterTimeLogged, lastLoggedEntryLogId=lastLoggedEntryLogId, logCommand=logCommand, slotInChassis=slotInChassis, numEntriesRequested=numEntriesRequested, totalNumberOfEntries=totalNumberOfEntries, logId=logId, timeLogged=timeLogged, trapLogAcknowledged=trapLogAcknowledged, nvmpId=nvmpId, numEntriesLoggeds=numEntriesLoggeds, trapOID=trapOID, filterEntry=filterEntry, filterSlotInChassis=filterSlotInChassis, trapLogVarBind=trapLogVarBind, configTableEntry=configTableEntry, slotChassis=slotChassis, z80Time=z80Time, filterTrapLogVarBind=filterTrapLogVarBind, configTable=configTable, filterTable=filterTable, filterNvmpId=filterNvmpId, trapLogEntry=trapLogEntry, numEntriesAllocated=numEntriesAllocated, wrap=wrap, filterTrapOID=filterTrapOID, filterFilterId=filterFilterId, filterLogId=filterLogId, filterZ80Time=filterZ80Time, filterTrapLogDescription=filterTrapLogDescription, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogTable=trapLogTable, trapLoggerAgent=trapLoggerAgent, filterId=filterId, trapLogDescription=trapLogDescription)
