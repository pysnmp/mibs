...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", z80Time=z80Time, slotInChassis=slotInChassis, trapLogEntry=trapLogEntry, slotChassis=slotChassis, filterTrapLogAcknowledged=filterTrapLogAcknowledged, logId=logId, filterTable=filterTable, logCommand=logCommand, trapLogVarBind=trapLogVarBind, filterTrapLogDescription=filterTrapLogDescription, filterSlotInChassis=filterSlotInChassis, trapOID=trapOID, filterFilterId=filterFilterId, filterTrapOID=filterTrapOID, filterTimeLogged=filterTimeLogged, numEntriesRequested=numEntriesRequested, filterId=filterId, wrap=wrap, trapLogTable=trapLogTable, filterLogId=filterLogId, filterEntry=filterEntry, filterZ80Time=filterZ80Time, totalNumberOfEntries=totalNumberOfEntries, trapLogAcknowledged=trapLogAcknowledged, trapLogDescription=trapLogDescription, timeLogged=timeLogged, filterTrapLogVarBind=filterTrapLogVarBind, configTableEntry=configTableEntry, nvmpId=nvmpId, trapLoggerAgent=trapLoggerAgent, configTable=configTable, numEntriesLoggeds=numEntriesLoggeds, lastLoggedEntryLogId=lastLoggedEntryLogId, numEntriesAllocated=numEntriesAllocated, filterNvmpId=filterNvmpId)
