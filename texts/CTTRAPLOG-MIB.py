...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", slotInChassis=slotInChassis, trapLoggerAgent=trapLoggerAgent, trapLogVarBind=trapLogVarBind, logId=logId, timeLogged=timeLogged, filterTrapLogDescription=filterTrapLogDescription, filterLogId=filterLogId, wrap=wrap, configTable=configTable, trapLogTable=trapLogTable, configTableEntry=configTableEntry, filterSlotInChassis=filterSlotInChassis, filterId=filterId, numEntriesRequested=numEntriesRequested, nvmpId=nvmpId, filterTrapOID=filterTrapOID, slotChassis=slotChassis, filterFilterId=filterFilterId, logCommand=logCommand, totalNumberOfEntries=totalNumberOfEntries, filterTable=filterTable, filterTrapLogVarBind=filterTrapLogVarBind, filterZ80Time=filterZ80Time, filterEntry=filterEntry, filterTrapLogAcknowledged=filterTrapLogAcknowledged, numEntriesLoggeds=numEntriesLoggeds, filterNvmpId=filterNvmpId, trapLogEntry=trapLogEntry, trapLogDescription=trapLogDescription, filterTimeLogged=filterTimeLogged, lastLoggedEntryLogId=lastLoggedEntryLogId, trapOID=trapOID, z80Time=z80Time, numEntriesAllocated=numEntriesAllocated, trapLogAcknowledged=trapLogAcknowledged)
