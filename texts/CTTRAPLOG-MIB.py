...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterNvmpId=filterNvmpId, filterTrapLogVarBind=filterTrapLogVarBind, logId=logId, timeLogged=timeLogged, filterZ80Time=filterZ80Time, trapLogVarBind=trapLogVarBind, numEntriesAllocated=numEntriesAllocated, logCommand=logCommand, trapLogEntry=trapLogEntry, trapLoggerAgent=trapLoggerAgent, wrap=wrap, lastLoggedEntryLogId=lastLoggedEntryLogId, z80Time=z80Time, numEntriesLoggeds=numEntriesLoggeds, totalNumberOfEntries=totalNumberOfEntries, slotChassis=slotChassis, filterLogId=filterLogId, trapLogDescription=trapLogDescription, trapLogAcknowledged=trapLogAcknowledged, trapLogTable=trapLogTable, configTableEntry=configTableEntry, filterTable=filterTable, filterId=filterId, filterTimeLogged=filterTimeLogged, configTable=configTable, slotInChassis=slotInChassis, filterFilterId=filterFilterId, nvmpId=nvmpId, filterTrapLogDescription=filterTrapLogDescription, filterTrapOID=filterTrapOID, numEntriesRequested=numEntriesRequested, filterSlotInChassis=filterSlotInChassis, filterEntry=filterEntry, trapOID=trapOID, filterTrapLogAcknowledged=filterTrapLogAcknowledged)
