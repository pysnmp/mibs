...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", numEntriesAllocated=numEntriesAllocated, timeLogged=timeLogged, filterFilterId=filterFilterId, wrap=wrap, filterTable=filterTable, totalNumberOfEntries=totalNumberOfEntries, filterTrapLogVarBind=filterTrapLogVarBind, trapLogEntry=trapLogEntry, logCommand=logCommand, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLoggerAgent=trapLoggerAgent, slotChassis=slotChassis, filterNvmpId=filterNvmpId, numEntriesLoggeds=numEntriesLoggeds, trapOID=trapOID, trapLogTable=trapLogTable, slotInChassis=slotInChassis, configTable=configTable, numEntriesRequested=numEntriesRequested, filterZ80Time=filterZ80Time, z80Time=z80Time, filterId=filterId, filterEntry=filterEntry, filterSlotInChassis=filterSlotInChassis, trapLogDescription=trapLogDescription, lastLoggedEntryLogId=lastLoggedEntryLogId, logId=logId, filterLogId=filterLogId, filterTimeLogged=filterTimeLogged, nvmpId=nvmpId, trapLogAcknowledged=trapLogAcknowledged, trapLogVarBind=trapLogVarBind, configTableEntry=configTableEntry, filterTrapLogDescription=filterTrapLogDescription, filterTrapOID=filterTrapOID)
