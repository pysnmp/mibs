...
mibBuilder.exportSymbols("CTTRAPLOG-MIB", filterEntry=filterEntry, filterTable=filterTable, trapLogDescription=trapLogDescription, slotChassis=slotChassis, totalNumberOfEntries=totalNumberOfEntries, numEntriesLoggeds=numEntriesLoggeds, trapLogVarBind=trapLogVarBind, wrap=wrap, logId=logId, filterId=filterId, nvmpId=nvmpId, filterZ80Time=filterZ80Time, trapLogTable=trapLogTable, numEntriesRequested=numEntriesRequested, filterTrapLogDescription=filterTrapLogDescription, filterTrapLogAcknowledged=filterTrapLogAcknowledged, trapLogAcknowledged=trapLogAcknowledged, filterNvmpId=filterNvmpId, timeLogged=timeLogged, filterTrapLogVarBind=filterTrapLogVarBind, filterSlotInChassis=filterSlotInChassis, logCommand=logCommand, trapLoggerAgent=trapLoggerAgent, slotInChassis=slotInChassis, filterLogId=filterLogId, configTableEntry=configTableEntry, trapOID=trapOID, lastLoggedEntryLogId=lastLoggedEntryLogId, numEntriesAllocated=numEntriesAllocated, configTable=configTable, filterTrapOID=filterTrapOID, filterFilterId=filterFilterId, trapLogEntry=trapLogEntry, filterTimeLogged=filterTimeLogged, z80Time=z80Time)
