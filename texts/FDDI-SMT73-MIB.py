...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPORTAction=fddimibPORTAction, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPORTMyType=fddimibPORTMyType, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACSMTAddress=fddimibMACSMTAddress, FddiTimeNano=FddiTimeNano, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACFrameCts=fddimibMACFrameCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACLateCts=fddimibMACLateCts, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPATH=fddimibPATH, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPATHNumber=fddimibPATHNumber, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibSMTStationAction=fddimibSMTStationAction, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACTokenCts=fddimibMACTokenCts, fddimibSMTTNotify=fddimibSMTTNotify, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, FddiResourceId=FddiResourceId, fddimibSMTEntry=fddimibSMTEntry, FddiTimeMilli=FddiTimeMilli, fddimib=fddimib, fddimibSMTCFState=fddimibSMTCFState, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPATHIndex=fddimibPATHIndex, fddimibMACTMax=fddimibMACTMax, fddimibMACTable=fddimibMACTable, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACTvxValue=fddimibMACTvxValue, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTStationId=fddimibSMTStationId, fddimibPATHTable=fddimibPATHTable, fddimibMACTReq=fddimibMACTReq, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACLostCts=fddimibMACLostCts, fddimibSMT=fddimibSMT, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACEntry=fddimibMACEntry, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibSMTUserData=fddimibSMTUserData, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTPCMState=fddimibPORTPCMState, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACCountersTable=fddimibMACCountersTable, fddimibSMTIndex=fddimibSMTIndex, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACNumber=fddimibMACNumber, fddimibSMTNumber=fddimibSMTNumber, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddi=fddi, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTNumber=fddimibPORTNumber, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTTable=fddimibPORTTable, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMAC=fddimibMAC, fddimibMACCounters=fddimibMACCounters, fddimibSMTECMState=fddimibSMTECMState, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACIndex=fddimibMACIndex, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACRMTState=fddimibMACRMTState, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTIndex=fddimibPORTIndex, fddimibSMTTable=fddimibSMTTable, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPORT=fddimibPORT)
