...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPATHNumber=fddimibPATHNumber, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACTMax=fddimibMACTMax, fddimibMACCounters=fddimibMACCounters, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACIndex=fddimibMACIndex, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMAC=fddimibMAC, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTIndex=fddimibSMTIndex, fddimibMACTNeg=fddimibMACTNeg, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPORTConnectState=fddimibPORTConnectState, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMTEntry=fddimibSMTEntry, fddimibPORTNumber=fddimibPORTNumber, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTLerCutoff=fddimibPORTLerCutoff, FddiTimeNano=FddiTimeNano, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTMyType=fddimibPORTMyType, fddimibMACNumber=fddimibMACNumber, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibSMTCFState=fddimibSMTCFState, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACCountersEntry=fddimibMACCountersEntry, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPATHEntry=fddimibPATHEntry, fddimibSMTNumber=fddimibSMTNumber, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, FddiSMTStationIdType=FddiSMTStationIdType, fddimib=fddimib, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPORTIndex=fddimibPORTIndex, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACRMTState=fddimibMACRMTState, fddimibPATH=fddimibPATH, fddi=fddi, fddimibMACRingOpCts=fddimibMACRingOpCts, FddiResourceId=FddiResourceId, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibSMTStationId=fddimibSMTStationId, FddiTimeMilli=FddiTimeMilli, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPORTEntry=fddimibPORTEntry, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACTable=fddimibMACTable, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTTable=fddimibSMTTable, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACLateCts=fddimibMACLateCts, fddimibMACTReq=fddimibMACTReq, fddimibMACEntry=fddimibMACEntry, fddimibPORT=fddimibPORT, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTAction=fddimibPORTAction, fddimibSMT=fddimibSMT, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTECMState=fddimibSMTECMState, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPATHTable=fddimibPATHTable, fddimibPORTTable=fddimibPORTTable, fddimibSMTUserData=fddimibSMTUserData, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPATHIndex=fddimibPATHIndex, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr)
