...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMTStationAction=fddimibSMTStationAction, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTTable=fddimibPORTTable, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTNumber=fddimibPORTNumber, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORTIndex=fddimibPORTIndex, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTECMState=fddimibSMTECMState, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACEntry=fddimibMACEntry, fddimibPATHIndex=fddimibPATHIndex, fddimibSMT=fddimibSMT, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibSMTNumber=fddimibSMTNumber, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTCFState=fddimibSMTCFState, fddimibMACTable=fddimibMACTable, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPATHConfigEntry=fddimibPATHConfigEntry, FddiTimeNano=FddiTimeNano, fddimibSMTTable=fddimibSMTTable, fddimibPATHTable=fddimibPATHTable, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, FddiTimeMilli=FddiTimeMilli, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACCounters=fddimibMACCounters, fddimibPORT=fddimibPORT, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibSMTIndex=fddimibSMTIndex, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibSMTStationId=fddimibSMTStationId, fddimibMACLateCts=fddimibMACLateCts, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACRMTState=fddimibMACRMTState, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACTMax=fddimibMACTMax, fddimibMACTReq=fddimibMACTReq, fddimibSMTEntry=fddimibSMTEntry, fddi=fddi, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMAC=fddimibMAC, fddimibMACIndex=fddimibMACIndex, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPATHNumber=fddimibPATHNumber, fddimibPORTAction=fddimibPORTAction, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPORTMyType=fddimibPORTMyType, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACLostCts=fddimibMACLostCts, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTCurrentPath=fddimibPORTCurrentPath, FddiResourceId=FddiResourceId, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPATH=fddimibPATH, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTUserData=fddimibSMTUserData, fddimib=fddimib, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTTNotify=fddimibSMTTNotify, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACTNeg=fddimibMACTNeg, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACNumber=fddimibMACNumber, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPORTLerEstimate=fddimibPORTLerEstimate)
