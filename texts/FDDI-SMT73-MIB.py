...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTAction=fddimibPORTAction, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACTable=fddimibMACTable, FddiTimeNano=FddiTimeNano, fddimibMACTNeg=fddimibMACTNeg, fddimibSMT=fddimibSMT, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACEntry=fddimibMACEntry, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACIndex=fddimibMACIndex, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACRMTState=fddimibMACRMTState, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimib=fddimib, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORT=fddimibPORT, fddimibPORTTable=fddimibPORTTable, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPATHTable=fddimibPATHTable, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMAC=fddimibMAC, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACTMax=fddimibMACTMax, fddimibPATHNumber=fddimibPATHNumber, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPATH=fddimibPATH, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPORTMyType=fddimibPORTMyType, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACCounters=fddimibMACCounters, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPATHEntry=fddimibPATHEntry, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTTable=fddimibSMTTable, fddimibSMTNumber=fddimibSMTNumber, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACCountersTable=fddimibMACCountersTable, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, FddiTimeMilli=FddiTimeMilli, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACTReq=fddimibMACTReq, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTStationId=fddimibSMTStationId, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACSMTAddress=fddimibMACSMTAddress, fddi=fddi, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACFrameCts=fddimibMACFrameCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTNumber=fddimibPORTNumber, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTEntry=fddimibSMTEntry, fddimibPORTPCMState=fddimibPORTPCMState, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACLostCts=fddimibMACLostCts, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACNumber=fddimibMACNumber, fddimibSMTIndex=fddimibSMTIndex, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, FddiResourceId=FddiResourceId, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId)
