...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACTNeg=fddimibMACTNeg, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTEntry=fddimibSMTEntry, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibSMTOpVersionId=fddimibSMTOpVersionId, FddiTimeMilli=FddiTimeMilli, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPORTIndex=fddimibPORTIndex, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPORTAction=fddimibPORTAction, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPORTPCMState=fddimibPORTPCMState, fddimibSMTUserData=fddimibSMTUserData, fddimibPATH=fddimibPATH, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTTable=fddimibPORTTable, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACEntry=fddimibMACEntry, fddimibMACIndex=fddimibMACIndex, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPORT=fddimibPORT, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPATHNumber=fddimibPATHNumber, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACTReq=fddimibMACTReq, fddimibSMTTable=fddimibSMTTable, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACRMTState=fddimibMACRMTState, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACLateCts=fddimibMACLateCts, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, FddiResourceId=FddiResourceId, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACTable=fddimibMACTable, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTNumber=fddimibPORTNumber, fddimibMACTMax=fddimibMACTMax, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimib=fddimib, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibSMT=fddimibSMT, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddi=fddi, fddimibPORTLemCts=fddimibPORTLemCts, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibSMTNumber=fddimibSMTNumber, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, FddiTimeNano=FddiTimeNano, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACLostCts=fddimibMACLostCts, fddimibMACCounters=fddimibMACCounters, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMAC=fddimibMAC, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibSMTIndex=fddimibSMTIndex, fddimibPORTMyType=fddimibPORTMyType, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACNumber=fddimibMACNumber, fddimibPATHTable=fddimibPATHTable, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag)
