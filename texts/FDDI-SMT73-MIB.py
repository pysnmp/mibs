...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACCountersTable=fddimibMACCountersTable, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibSMTUserData=fddimibSMTUserData, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPORT=fddimibPORT, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, FddiTimeNano=FddiTimeNano, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACTMax=fddimibMACTMax, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, FddiResourceId=FddiResourceId, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTNumber=fddimibSMTNumber, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibSMTECMState=fddimibSMTECMState, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACTvxValue=fddimibMACTvxValue, fddimibPATHTable=fddimibPATHTable, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPATHIndex=fddimibPATHIndex, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACCounters=fddimibMACCounters, fddimibMACRMTState=fddimibMACRMTState, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPATH=fddimibPATH, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACEntry=fddimibMACEntry, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddi=fddi, fddimibSMTEntry=fddimibSMTEntry, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTAction=fddimibPORTAction, fddimibSMT=fddimibSMT, fddimibMACTable=fddimibMACTable, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACLateCts=fddimibMACLateCts, FddiTimeMilli=FddiTimeMilli, fddimibSMTStationId=fddimibSMTStationId, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPORTTable=fddimibPORTTable, fddimibMACRingOpCts=fddimibMACRingOpCts, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTMyType=fddimibPORTMyType, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTCFState=fddimibSMTCFState, fddimibMAC=fddimibMAC, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACNumber=fddimibMACNumber, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTNumber=fddimibPORTNumber, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPATHNumber=fddimibPATHNumber, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACIndex=fddimibMACIndex, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACTReq=fddimibMACTReq, fddimib=fddimib, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPATHEntry=fddimibPATHEntry, fddimibSMTIndex=fddimibSMTIndex, fddimibSMTTable=fddimibSMTTable, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy)
