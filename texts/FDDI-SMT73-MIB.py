...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACCopiedCts=fddimibMACCopiedCts, FddiTimeMilli=FddiTimeMilli, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibSMTMACCts=fddimibSMTMACCts, fddi=fddi, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, FddiResourceId=FddiResourceId, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibSMTECMState=fddimibSMTECMState, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTCFState=fddimibSMTCFState, fddimibMACTReq=fddimibMACTReq, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACIndex=fddimibMACIndex, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMTEntry=fddimibSMTEntry, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACTMax=fddimibMACTMax, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimib=fddimib, fddimibPORTAction=fddimibPORTAction, fddimibSMTTable=fddimibSMTTable, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTTable=fddimibPORTTable, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACCountersTable=fddimibMACCountersTable, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACCounters=fddimibMACCounters, fddimibPORTSMTIndex=fddimibPORTSMTIndex, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTNumber=fddimibSMTNumber, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTLerFlag=fddimibPORTLerFlag, FddiTimeNano=FddiTimeNano, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACTNeg=fddimibMACTNeg, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTMyType=fddimibPORTMyType, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTEntry=fddimibPORTEntry, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibSMT=fddimibSMT, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACTable=fddimibMACTable, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMAC=fddimibMAC, fddimibMACRMTState=fddimibMACRMTState, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACEntry=fddimibMACEntry, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTTNotify=fddimibSMTTNotify, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPORT=fddimibPORT, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACNumber=fddimibMACNumber, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPATHNumber=fddimibPATHNumber, fddimibSMTIndex=fddimibSMTIndex, fddimibPATH=fddimibPATH, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPATHTable=fddimibPATHTable, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTNumber=fddimibPORTNumber, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACLateCts=fddimibMACLateCts, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTIndex=fddimibPORTIndex, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTStationStatus=fddimibSMTStationStatus)
