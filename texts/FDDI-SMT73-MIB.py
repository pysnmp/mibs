...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMT=fddimibSMT, fddimibSMTStationAction=fddimibSMTStationAction, fddi=fddi, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPATHIndex=fddimibPATHIndex, fddimibMACTReq=fddimibMACTReq, fddimibSMTTNotify=fddimibSMTTNotify, fddimibSMTNumber=fddimibSMTNumber, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTCFState=fddimibSMTCFState, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATH=fddimibPATH, fddimibSMTIndex=fddimibSMTIndex, fddimibMACTMax=fddimibMACTMax, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTTable=fddimibSMTTable, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPATHTable=fddimibPATHTable, fddimibPORTTable=fddimibPORTTable, fddimibMACLostCts=fddimibMACLostCts, fddimibMACTokenCts=fddimibMACTokenCts, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACTvxValue=fddimibMACTvxValue, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACNumber=fddimibMACNumber, fddimibSMTECMState=fddimibSMTECMState, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibPORTAction=fddimibPORTAction, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPATHNumber=fddimibPATHNumber, fddimibMACRMTState=fddimibMACRMTState, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACTNeg=fddimibMACTNeg, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACCounters=fddimibMACCounters, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibSMTUserData=fddimibSMTUserData, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACIndex=fddimibMACIndex, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimib=fddimib, fddimibMACEntry=fddimibMACEntry, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, FddiTimeMilli=FddiTimeMilli, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPORTNumber=fddimibPORTNumber, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMAC=fddimibMAC, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORT=fddimibPORT, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACTable=fddimibMACTable, FddiResourceId=FddiResourceId, FddiTimeNano=FddiTimeNano, fddimibPORTMyType=fddimibPORTMyType, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTEntry=fddimibSMTEntry, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTNeighborType=fddimibPORTNeighborType)
