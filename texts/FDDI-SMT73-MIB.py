...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACTReq=fddimibMACTReq, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPORT=fddimibPORT, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTIndex=fddimibPORTIndex, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPATHNumber=fddimibPATHNumber, fddimibMACTable=fddimibMACTable, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, FddiTimeNano=FddiTimeNano, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibPATHTable=fddimibPATHTable, fddimibMACNumber=fddimibMACNumber, fddimibSMTCFState=fddimibSMTCFState, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACCounters=fddimibMACCounters, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACRMTState=fddimibMACRMTState, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACIndex=fddimibMACIndex, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPATH=fddimibPATH, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMT=fddimibSMT, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACEntry=fddimibMACEntry, fddimibMACLostCts=fddimibMACLostCts, fddimibSMTTable=fddimibSMTTable, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibSMTEntry=fddimibSMTEntry, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPORTNumber=fddimibPORTNumber, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPATHEntry=fddimibPATHEntry, fddimibSMTNumber=fddimibSMTNumber, fddimibMACTVXCapability=fddimibMACTVXCapability, FddiResourceId=FddiResourceId, fddimibMAC=fddimibMAC, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibSMTStationId=fddimibSMTStationId, fddimibPORTAction=fddimibPORTAction, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACLateCts=fddimibMACLateCts, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTEntry=fddimibPORTEntry, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimib=fddimib, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPORTMyType=fddimibPORTMyType, fddimibMACTMax=fddimibMACTMax, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddi=fddi, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACFrameCts=fddimibMACFrameCts, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTECMState=fddimibSMTECMState, FddiTimeMilli=FddiTimeMilli, fddimibPORTTable=fddimibPORTTable, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTIndex=fddimibSMTIndex, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy)
