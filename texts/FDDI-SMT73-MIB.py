...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACNumber=fddimibMACNumber, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTEntry=fddimibPORTEntry, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTEntry=fddimibSMTEntry, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibSMTTable=fddimibSMTTable, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibSMTNumber=fddimibSMTNumber, fddimibSMTIndex=fddimibSMTIndex, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMAC=fddimibMAC, fddimibMACTReq=fddimibMACTReq, fddimibPORTIndex=fddimibPORTIndex, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACLostCts=fddimibMACLostCts, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibSMTStationId=fddimibSMTStationId, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTAction=fddimibPORTAction, fddimibMACLateCts=fddimibMACLateCts, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACTMax=fddimibMACTMax, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPORTNumber=fddimibPORTNumber, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTMasterCts=fddimibSMTMasterCts, FddiTimeNano=FddiTimeNano, fddimibPATHIndex=fddimibPATHIndex, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, FddiResourceId=FddiResourceId, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPORT=fddimibPORT, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPATHTable=fddimibPATHTable, fddimibSMTTNotify=fddimibSMTTNotify, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACIndex=fddimibMACIndex, fddimibPATHEntry=fddimibPATHEntry, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPATH=fddimibPATH, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTMACIndicated=fddimibPORTMACIndicated, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTTable=fddimibPORTTable, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTConnectState=fddimibPORTConnectState, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPATHNumber=fddimibPATHNumber, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibSMT=fddimibSMT, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTPCMState=fddimibPORTPCMState, fddimibSMTCFState=fddimibSMTCFState, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPORTBSFlag=fddimibPORTBSFlag, fddi=fddi, fddimibMACEntry=fddimibMACEntry, fddimibMACTable=fddimibMACTable, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACRMTState=fddimibMACRMTState, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPORTMyType=fddimibPORTMyType, fddimibMACCounters=fddimibMACCounters, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACSMTIndex=fddimibMACSMTIndex, FddiTimeMilli=FddiTimeMilli, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimib=fddimib, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACTokenCts=fddimibMACTokenCts, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTNeighborType=fddimibPORTNeighborType)
