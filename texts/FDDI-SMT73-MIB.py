...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACNumber=fddimibMACNumber, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACIndex=fddimibMACIndex, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPORTIndex=fddimibPORTIndex, fddimibSMTStationAction=fddimibSMTStationAction, FddiTimeNano=FddiTimeNano, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPATH=fddimibPATH, fddimibMACRMTState=fddimibMACRMTState, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTUserData=fddimibSMTUserData, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibSMTCFState=fddimibSMTCFState, fddimibMACTable=fddimibMACTable, fddimibPORTAction=fddimibPORTAction, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACTNeg=fddimibMACTNeg, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACTMax=fddimibMACTMax, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, FddiResourceId=FddiResourceId, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTNeighborType=fddimibPORTNeighborType, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPATHTable=fddimibPATHTable, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPORTTable=fddimibPORTTable, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACTReq=fddimibMACTReq, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibSMTECMState=fddimibSMTECMState, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibSMTTable=fddimibSMTTable, fddi=fddi, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibSMTStationId=fddimibSMTStationId, fddimibPORTMyType=fddimibPORTMyType, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPATHEntry=fddimibPATHEntry, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMT=fddimibSMT, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimib=fddimib, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMAC=fddimibMAC, FddiTimeMilli=FddiTimeMilli, fddimibPORTNumber=fddimibPORTNumber, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibSMTIndex=fddimibSMTIndex, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACEntry=fddimibMACEntry, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTNumber=fddimibSMTNumber, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACLostCts=fddimibMACLostCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPATHNumber=fddimibPATHNumber, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPORT=fddimibPORT, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPORTConnectState=fddimibPORTConnectState, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACCounters=fddimibMACCounters, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTEntry=fddimibSMTEntry)
