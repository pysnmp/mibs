...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTLerFlag=fddimibPORTLerFlag, FddiTimeMilli=FddiTimeMilli, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACTReq=fddimibMACTReq, fddimibMACTvxValue=fddimibMACTvxValue, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTMyType=fddimibPORTMyType, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTStationId=fddimibSMTStationId, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACCounters=fddimibMACCounters, fddimibMACIndex=fddimibMACIndex, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMAC=fddimibMAC, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimib=fddimib, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACLostCts=fddimibMACLostCts, fddimibSMTNumber=fddimibSMTNumber, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTEntry=fddimibSMTEntry, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACTable=fddimibMACTable, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACTNeg=fddimibMACTNeg, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACNumber=fddimibMACNumber, fddimibMACRMTState=fddimibMACRMTState, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTStationAction=fddimibSMTStationAction, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPATHNumber=fddimibPATHNumber, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPATHTable=fddimibPATHTable, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPORT=fddimibPORT, fddimibPATH=fddimibPATH, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMT=fddimibSMT, fddimibSMTUserData=fddimibSMTUserData, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACSMTAddress=fddimibMACSMTAddress, fddi=fddi, fddimibSMTECMState=fddimibSMTECMState, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTTable=fddimibPORTTable, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACTMax=fddimibMACTMax, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPORTAction=fddimibPORTAction, fddimibMACEntry=fddimibMACEntry, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, FddiTimeNano=FddiTimeNano, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibSMTTable=fddimibSMTTable, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibSMTIndex=fddimibSMTIndex, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACDupAddressTest=fddimibMACDupAddressTest, FddiResourceId=FddiResourceId, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPATHIndex=fddimibPATHIndex, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTNumber=fddimibPORTNumber, fddimibMACTMaxCapability=fddimibMACTMaxCapability)
