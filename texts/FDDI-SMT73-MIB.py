...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORT=fddimibPORT, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTTable=fddimibSMTTable, fddimibMACNumber=fddimibMACNumber, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimib=fddimib, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACCounters=fddimibMACCounters, fddimibSMTECMState=fddimibSMTECMState, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibSMTUserData=fddimibSMTUserData, fddimibSMTCFState=fddimibSMTCFState, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACTable=fddimibMACTable, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibSMTEntry=fddimibSMTEntry, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, FddiTimeMilli=FddiTimeMilli, fddimibPATH=fddimibPATH, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTTable=fddimibPORTTable, fddimibSMT=fddimibSMT, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACTReq=fddimibMACTReq, fddimibMACRMTState=fddimibMACRMTState, fddimibPORTNumber=fddimibPORTNumber, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPATHNumber=fddimibPATHNumber, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPORTMyType=fddimibPORTMyType, fddimibSMTIndex=fddimibSMTIndex, FddiResourceId=FddiResourceId, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPATHTable=fddimibPATHTable, fddimibPORTAction=fddimibPORTAction, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACTMax=fddimibMACTMax, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACDupAddressTest=fddimibMACDupAddressTest, FddiTimeNano=FddiTimeNano, fddimibMACLostCts=fddimibMACLostCts, fddimibSMTNumber=fddimibSMTNumber, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddi=fddi, fddimibSMTStationId=fddimibSMTStationId, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACTNeg=fddimibMACTNeg, fddimibMACEntry=fddimibMACEntry, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPATHMaxTReq=fddimibPATHMaxTReq, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACIndex=fddimibMACIndex, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMAC=fddimibMAC, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTLerEstimate=fddimibPORTLerEstimate)
