...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACTNeg=fddimibMACTNeg, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimib=fddimib, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPATHTable=fddimibPATHTable, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTIndex=fddimibPORTIndex, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACNumber=fddimibMACNumber, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACIndex=fddimibMACIndex, fddimibSMT=fddimibSMT, fddimibSMTTable=fddimibSMTTable, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTTable=fddimibPORTTable, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTAction=fddimibPORTAction, fddimibPORT=fddimibPORT, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTMyType=fddimibPORTMyType, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, FddiTimeNano=FddiTimeNano, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPATHIndex=fddimibPATHIndex, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACTable=fddimibMACTable, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddi=fddi, fddimibSMTCFState=fddimibSMTCFState, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPATH=fddimibPATH, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACTMax=fddimibMACTMax, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibSMTIndex=fddimibSMTIndex, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, FddiTimeMilli=FddiTimeMilli, FddiResourceId=FddiResourceId, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMAC=fddimibMAC, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPATHEntry=fddimibPATHEntry, fddimibMACLateCts=fddimibMACLateCts, fddimibPATHNumber=fddimibPATHNumber, fddimibMACEntry=fddimibMACEntry, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibSMTUserData=fddimibSMTUserData, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTEntry=fddimibPORTEntry, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACCounters=fddimibMACCounters, fddimibPORTNumber=fddimibPORTNumber, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACFrameCts=fddimibMACFrameCts, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACTvxValue=fddimibMACTvxValue, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACTReq=fddimibMACTReq, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibSMTNumber=fddimibSMTNumber, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTEntry=fddimibSMTEntry, fddimibMACRMTState=fddimibMACRMTState, fddimibSMTOpVersionId=fddimibSMTOpVersionId)
