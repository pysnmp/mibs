...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPORTMyType=fddimibPORTMyType, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACCounters=fddimibMACCounters, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTEntry=fddimibSMTEntry, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPATHTable=fddimibPATHTable, fddimibMACTable=fddimibMACTable, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimib=fddimib, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACTokenCts=fddimibMACTokenCts, fddimibSMTNumber=fddimibSMTNumber, fddimibPORTBSFlag=fddimibPORTBSFlag, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPORTAction=fddimibPORTAction, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMTUserData=fddimibSMTUserData, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACLateCts=fddimibMACLateCts, fddimibPORTNumber=fddimibPORTNumber, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACTReq=fddimibMACTReq, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibSMTIndex=fddimibSMTIndex, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACEntry=fddimibMACEntry, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPORT=fddimibPORT, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTConnectState=fddimibPORTConnectState, fddimibPATH=fddimibPATH, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPATHNumber=fddimibPATHNumber, fddimibPORTTable=fddimibPORTTable, fddimibPATHEntry=fddimibPATHEntry, fddimibMACNumber=fddimibMACNumber, fddimibMACRMTState=fddimibMACRMTState, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMAC=fddimibMAC, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTCFState=fddimibSMTCFState, FddiResourceId=FddiResourceId, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibSMT=fddimibSMT, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibSMTTable=fddimibSMTTable, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACFrameCts=fddimibMACFrameCts, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACTMax=fddimibMACTMax, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTEntry=fddimibPORTEntry, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACTvxValue=fddimibMACTvxValue, FddiTimeMilli=FddiTimeMilli, fddimibMACCopiedCts=fddimibMACCopiedCts, FddiTimeNano=FddiTimeNano, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddi=fddi, fddimibSMTStationId=fddimibSMTStationId, fddimibMACIndex=fddimibMACIndex, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTPCMState=fddimibPORTPCMState, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPORTLemCts=fddimibPORTLemCts)
