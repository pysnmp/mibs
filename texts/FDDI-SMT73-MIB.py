...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, FddiTimeMilli=FddiTimeMilli, fddimibSMTEntry=fddimibSMTEntry, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPATHTable=fddimibPATHTable, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACIndex=fddimibMACIndex, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACFrameCts=fddimibMACFrameCts, FddiTimeNano=FddiTimeNano, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTPCMState=fddimibPORTPCMState, FddiResourceId=FddiResourceId, fddimibMACNumber=fddimibMACNumber, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTIndex=fddimibSMTIndex, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACCounters=fddimibMACCounters, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibPORTEntry=fddimibPORTEntry, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPORTIndex=fddimibPORTIndex, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTTable=fddimibPORTTable, fddimibMACTable=fddimibMACTable, fddimibPATHNumber=fddimibPATHNumber, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTTable=fddimibSMTTable, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimib=fddimib, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTMyType=fddimibPORTMyType, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPORTNumber=fddimibPORTNumber, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPATHIndex=fddimibPATHIndex, fddimibSMTCFState=fddimibSMTCFState, fddimibMACTMax=fddimibMACTMax, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibSMTUserData=fddimibSMTUserData, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACLostCts=fddimibMACLostCts, fddimibMACRMTState=fddimibMACRMTState, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPATHEntry=fddimibPATHEntry, fddi=fddi, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACEntry=fddimibMACEntry, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibSMTNumber=fddimibSMTNumber, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPORTAction=fddimibPORTAction, fddimibSMTStationId=fddimibSMTStationId, fddimibMAC=fddimibMAC, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACTReq=fddimibMACTReq, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPORT=fddimibPORT, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACTokenCts=fddimibMACTokenCts, fddimibSMTECMState=fddimibSMTECMState, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACTNeg=fddimibMACTNeg, fddimibSMT=fddimibSMT, fddimibPATH=fddimibPATH)
