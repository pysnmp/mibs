...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACCounters=fddimibMACCounters, fddimibMACIndex=fddimibMACIndex, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTTable=fddimibSMTTable, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACRMTState=fddimibMACRMTState, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACNumber=fddimibMACNumber, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMTEntry=fddimibSMTEntry, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPATH=fddimibPATH, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibSMTNumber=fddimibSMTNumber, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACEntry=fddimibMACEntry, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMAC=fddimibMAC, fddimibPATHNumber=fddimibPATHNumber, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMT=fddimibSMT, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTMyType=fddimibPORTMyType, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTTable=fddimibPORTTable, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTTNotify=fddimibSMTTNotify, fddi=fddi, fddimibPORTNumber=fddimibPORTNumber, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACTMax=fddimibMACTMax, FddiTimeNano=FddiTimeNano, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimib=fddimib, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACAvailablePaths=fddimibMACAvailablePaths, FddiResourceId=FddiResourceId, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPATHEntry=fddimibPATHEntry, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTEntry=fddimibPORTEntry, fddimibPATHIndex=fddimibPATHIndex, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, FddiTimeMilli=FddiTimeMilli, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORTAction=fddimibPORTAction, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTIndex=fddimibSMTIndex, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTConnectState=fddimibPORTConnectState, fddimibPORTIndex=fddimibPORTIndex, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPORT=fddimibPORT, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACLateCts=fddimibMACLateCts, fddimibMACTable=fddimibMACTable, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTCFState=fddimibSMTCFState, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPATHTable=fddimibPATHTable, fddimibMACTReq=fddimibMACTReq, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag)
