...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, FddiResourceId=FddiResourceId, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACCounters=fddimibMACCounters, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMT=fddimibSMT, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTCFState=fddimibSMTCFState, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACLostCts=fddimibMACLostCts, fddimibPATHTable=fddimibPATHTable, fddimibPORT=fddimibPORT, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMTTNotify=fddimibSMTTNotify, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACTMax=fddimibMACTMax, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibSMTEntry=fddimibSMTEntry, fddimibSMTNumber=fddimibSMTNumber, fddimibPORTIndex=fddimibPORTIndex, fddi=fddi, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACTReq=fddimibMACTReq, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, FddiTimeMilli=FddiTimeMilli, FddiTimeNano=FddiTimeNano, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTMyType=fddimibPORTMyType, fddimibSMTUserData=fddimibSMTUserData, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPATH=fddimibPATH, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTStationId=fddimibSMTStationId, fddimibPORTNumber=fddimibPORTNumber, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACTable=fddimibMACTable, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACRMTState=fddimibMACRMTState, fddimibPATHNumber=fddimibPATHNumber, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACNumber=fddimibMACNumber, fddimibPORTTable=fddimibPORTTable, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACIndex=fddimibMACIndex, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMAC=fddimibMAC, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTIndex=fddimibSMTIndex, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATHEntry=fddimibPATHEntry, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACTNeg=fddimibMACTNeg, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACDaFlag=fddimibMACDaFlag, fddimib=fddimib, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACEntry=fddimibMACEntry, fddimibSMTTable=fddimibSMTTable, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTAction=fddimibPORTAction, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts)
