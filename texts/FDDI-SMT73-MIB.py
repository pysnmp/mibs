...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTLerFlag=fddimibPORTLerFlag, fddi=fddi, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTAction=fddimibPORTAction, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTEntry=fddimibSMTEntry, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACTMax=fddimibMACTMax, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACCounters=fddimibMACCounters, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTEntry=fddimibPORTEntry, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACEntry=fddimibMACEntry, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACLateCts=fddimibMACLateCts, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTTable=fddimibSMTTable, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTTable=fddimibPORTTable, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMAC=fddimibMAC, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACTokenCts=fddimibMACTokenCts, fddimibSMTIndex=fddimibSMTIndex, fddimibPATHIndex=fddimibPATHIndex, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, FddiResourceId=FddiResourceId, fddimibSMTNumber=fddimibSMTNumber, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimib=fddimib, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACTReq=fddimibMACTReq, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTECMState=fddimibSMTECMState, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTHiVersionId=fddimibSMTHiVersionId, FddiTimeMilli=FddiTimeMilli, fddimibMACRMTState=fddimibMACRMTState, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPATHTable=fddimibPATHTable, fddimibMACTNeg=fddimibMACTNeg, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPATHNumber=fddimibPATHNumber, fddimibMACTMaxCapability=fddimibMACTMaxCapability, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORT=fddimibPORT, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACTable=fddimibMACTable, fddimibPORTNumber=fddimibPORTNumber, fddimibSMTTNotify=fddimibSMTTNotify, fddimibSMTStationId=fddimibSMTStationId, fddimibPATH=fddimibPATH, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMT=fddimibSMT, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACIndex=fddimibMACIndex, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, FddiTimeNano=FddiTimeNano, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTMyType=fddimibPORTMyType, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTUserData=fddimibSMTUserData, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTIndex=fddimibPORTIndex, fddimibMACNumber=fddimibMACNumber, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent)
