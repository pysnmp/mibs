...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTConnectState=fddimibPORTConnectState, FddiTimeNano=FddiTimeNano, fddimibPORTEntry=fddimibPORTEntry, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORT=fddimibPORT, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACIndex=fddimibMACIndex, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibSMTECMState=fddimibSMTECMState, fddimibPATHNumber=fddimibPATHNumber, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibSMTStationId=fddimibSMTStationId, fddimibMACNumber=fddimibMACNumber, fddimibSMTEntry=fddimibSMTEntry, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddi=fddi, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTNumber=fddimibSMTNumber, fddimibMACCounters=fddimibMACCounters, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPATHTable=fddimibPATHTable, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPORTMyType=fddimibPORTMyType, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACRMTState=fddimibMACRMTState, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPATH=fddimibPATH, fddimibPORTIndex=fddimibPORTIndex, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, FddiTimeMilli=FddiTimeMilli, fddimibPORTAction=fddimibPORTAction, fddimibPORTTable=fddimibPORTTable, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACTReq=fddimibMACTReq, fddimibSMTTable=fddimibSMTTable, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACDaFlag=fddimibMACDaFlag, fddimib=fddimib, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACTMax=fddimibMACTMax, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPORTPCMState=fddimibPORTPCMState, FddiResourceId=FddiResourceId, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMT=fddimibSMT, fddimibMAC=fddimibMAC, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACTable=fddimibMACTable, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTLemCts=fddimibPORTLemCts, fddimibSMTUserData=fddimibSMTUserData, fddimibMACEntry=fddimibMACEntry, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPATHIndex=fddimibPATHIndex, fddimibSMTIndex=fddimibSMTIndex, fddimibMACLostCts=fddimibMACLostCts, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTNumber=fddimibPORTNumber, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACTokenCts=fddimibMACTokenCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts)
