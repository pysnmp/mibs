...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibSMTStationId=fddimibSMTStationId, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACEntry=fddimibMACEntry, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTMyType=fddimibPORTMyType, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACTReq=fddimibMACTReq, fddimibPATH=fddimibPATH, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTNumber=fddimibPORTNumber, fddimibSMT=fddimibSMT, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPATHEntry=fddimibPATHEntry, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACLateCts=fddimibMACLateCts, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACLostCts=fddimibMACLostCts, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACTable=fddimibMACTable, fddi=fddi, fddimibMACCountersTable=fddimibMACCountersTable, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibSMTTNotify=fddimibSMTTNotify, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTConnectState=fddimibPORTConnectState, FddiTimeNano=FddiTimeNano, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, FddiResourceId=FddiResourceId, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACTMax=fddimibMACTMax, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTECMState=fddimibSMTECMState, fddimibMACCounters=fddimibMACCounters, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPATHNumber=fddimibPATHNumber, fddimibSMTTable=fddimibSMTTable, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPORT=fddimibPORT, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimib=fddimib, fddimibPORTAction=fddimibPORTAction, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibSMTIndex=fddimibSMTIndex, fddimibMACIndex=fddimibMACIndex, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTTable=fddimibPORTTable, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACNumber=fddimibMACNumber, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, FddiTimeMilli=FddiTimeMilli, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTEntry=fddimibSMTEntry, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACRMTState=fddimibMACRMTState, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPATHTable=fddimibPATHTable, fddimibMAC=fddimibMAC, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTCFState=fddimibSMTCFState, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibSMTNumber=fddimibSMTNumber, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACDupAddressTest=fddimibMACDupAddressTest)
