...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPORTNumber=fddimibPORTNumber, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACTable=fddimibMACTable, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibSMTTNotify=fddimibSMTTNotify, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORT=fddimibPORT, fddimibPORTAction=fddimibPORTAction, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddi=fddi, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, FddiTimeMilli=FddiTimeMilli, fddimibMACTMax=fddimibMACTMax, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACIndex=fddimibMACIndex, fddimibSMTNumber=fddimibSMTNumber, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACTReq=fddimibMACTReq, fddimibMACEntry=fddimibMACEntry, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPATHNumber=fddimibPATHNumber, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACLateCts=fddimibMACLateCts, fddimibSMT=fddimibSMT, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, FddiSMTStationIdType=FddiSMTStationIdType, FddiTimeNano=FddiTimeNano, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPORTTable=fddimibPORTTable, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTTable=fddimibSMTTable, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPATHTable=fddimibPATHTable, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACCounters=fddimibMACCounters, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTECMState=fddimibSMTECMState, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTIndex=fddimibSMTIndex, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMAC=fddimibMAC, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPORTMyType=fddimibPORTMyType, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimib=fddimib, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibSMTUserData=fddimibSMTUserData, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMTEntry=fddimibSMTEntry, fddimibPORTEntry=fddimibPORTEntry, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACTNeg=fddimibMACTNeg, fddimibPATH=fddimibPATH, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTPCMState=fddimibPORTPCMState, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTCFState=fddimibSMTCFState, fddimibMACNumber=fddimibMACNumber, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPATHIndex=fddimibPATHIndex, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTIndex=fddimibPORTIndex, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACRMTState=fddimibMACRMTState, FddiResourceId=FddiResourceId, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPATHEntry=fddimibPATHEntry, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio)
