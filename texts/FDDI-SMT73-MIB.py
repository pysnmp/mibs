...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACIndex=fddimibMACIndex, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPATHNumber=fddimibPATHNumber, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACCounters=fddimibMACCounters, fddimibSMTECMState=fddimibSMTECMState, fddimibPATHTable=fddimibPATHTable, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMT=fddimibSMT, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTMyType=fddimibPORTMyType, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, FddiTimeMilli=FddiTimeMilli, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACLostCts=fddimibMACLostCts, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORT=fddimibPORT, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTTable=fddimibPORTTable, fddimibMACTable=fddimibMACTable, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTConnectState=fddimibPORTConnectState, fddimibPORTAction=fddimibPORTAction, fddimibSMTNumber=fddimibSMTNumber, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACTNeg=fddimibMACTNeg, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibSMTCFState=fddimibSMTCFState, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPORTNumber=fddimibPORTNumber, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMAC=fddimibMAC, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACNumber=fddimibMACNumber, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACFrameCts=fddimibMACFrameCts, FddiResourceId=FddiResourceId, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibPORTEntry=fddimibPORTEntry, fddimibMACTokenCts=fddimibMACTokenCts, FddiTimeNano=FddiTimeNano, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibSMTStationId=fddimibSMTStationId, fddimibMACTReq=fddimibMACTReq, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPATHEntry=fddimibPATHEntry, fddimibSMTEntry=fddimibSMTEntry, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACRMTState=fddimibMACRMTState, fddimibPATH=fddimibPATH, fddimibSMTTable=fddimibSMTTable, fddimibMACTMax=fddimibMACTMax, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATHIndex=fddimibPATHIndex, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimib=fddimib, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACEntry=fddimibMACEntry, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMTIndex=fddimibSMTIndex, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddi=fddi, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPORTIndex=fddimibPORTIndex, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag)
