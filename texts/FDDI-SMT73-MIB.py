...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACCounters=fddimibMACCounters, fddimibMACTokenCts=fddimibMACTokenCts, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibSMTTable=fddimibSMTTable, fddimibPATHTable=fddimibPATHTable, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACIndex=fddimibMACIndex, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORT=fddimibPORT, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACFrameCts=fddimibMACFrameCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACEntry=fddimibMACEntry, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPORTTable=fddimibPORTTable, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACRMTState=fddimibMACRMTState, fddimibPATHEntry=fddimibPATHEntry, fddimibMACTable=fddimibMACTable, fddimibPORTNumber=fddimibPORTNumber, FddiTimeNano=FddiTimeNano, FddiTimeMilli=FddiTimeMilli, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACLostCts=fddimibMACLostCts, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTAction=fddimibPORTAction, fddimibPORTIndex=fddimibPORTIndex, fddimibSMTBypassPresent=fddimibSMTBypassPresent, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMTUserData=fddimibSMTUserData, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACTNeg=fddimibMACTNeg, fddimibMACTMax=fddimibMACTMax, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACLateCts=fddimibMACLateCts, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddi=fddi, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPORTSMTIndex=fddimibPORTSMTIndex, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACNumber=fddimibMACNumber, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, FddiResourceId=FddiResourceId, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibSMTStationId=fddimibSMTStationId, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACTReq=fddimibMACTReq, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibSMTEntry=fddimibSMTEntry, fddimibPATH=fddimibPATH, fddimibSMTIndex=fddimibSMTIndex, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibSMT=fddimibSMT, fddimibPATHIndex=fddimibPATHIndex, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimib=fddimib, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibSMTNumber=fddimibSMTNumber, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMAC=fddimibMAC, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPATHNumber=fddimibPATHNumber, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPORTMyType=fddimibPORTMyType, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTCFState=fddimibSMTCFState)
