...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibPORT=fddimibPORT, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACTMaxCapability=fddimibMACTMaxCapability, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACNumber=fddimibMACNumber, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTIndex=fddimibSMTIndex, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTIndex=fddimibPORTIndex, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACTMax=fddimibMACTMax, fddimibSMTTable=fddimibSMTTable, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, FddiTimeNano=FddiTimeNano, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPATH=fddimibPATH, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTEntry=fddimibSMTEntry, fddimibPORTMyType=fddimibPORTMyType, fddimibPATHTable=fddimibPATHTable, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPORTNumber=fddimibPORTNumber, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACRMTState=fddimibMACRMTState, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPATHEntry=fddimibPATHEntry, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddi=fddi, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACIndex=fddimibMACIndex, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTAction=fddimibPORTAction, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimib=fddimib, fddimibSMTUserData=fddimibSMTUserData, fddimibMACTReq=fddimibMACTReq, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTCFState=fddimibSMTCFState, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACTable=fddimibMACTable, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibSMTECMState=fddimibSMTECMState, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMAC=fddimibMAC, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPATHNumber=fddimibPATHNumber, fddimibMACFrameCts=fddimibMACFrameCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACCounters=fddimibMACCounters, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMTNumber=fddimibSMTNumber, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACEntry=fddimibMACEntry, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPATHMaxTReq=fddimibPATHMaxTReq, FddiResourceId=FddiResourceId, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibSMT=fddimibSMT, fddimibSMTStationId=fddimibSMTStationId, FddiTimeMilli=FddiTimeMilli, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibSMTTNotify=fddimibSMTTNotify, fddimibPATHIndex=fddimibPATHIndex, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPORTTable=fddimibPORTTable, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACLostCts=fddimibMACLostCts, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId)
