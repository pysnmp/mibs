...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPATHNumber=fddimibPATHNumber, fddimibMACLostCts=fddimibMACLostCts, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPORTNumber=fddimibPORTNumber, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACTable=fddimibMACTable, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATHEntry=fddimibPATHEntry, fddimibMACRingOpCts=fddimibMACRingOpCts, FddiTimeMilli=FddiTimeMilli, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTIndex=fddimibSMTIndex, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACLateCts=fddimibMACLateCts, fddimibPORTLemCts=fddimibPORTLemCts, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibSMTUserData=fddimibSMTUserData, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTIndex=fddimibPORTIndex, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACTReq=fddimibMACTReq, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMT=fddimibSMT, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACRMTState=fddimibMACRMTState, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTEntry=fddimibPORTEntry, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPORTAction=fddimibPORTAction, fddimibMACIndex=fddimibMACIndex, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACErrorCts=fddimibMACErrorCts, FddiResourceId=FddiResourceId, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTTNotify=fddimibSMTTNotify, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibSMTNumber=fddimibSMTNumber, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPATH=fddimibPATH, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACCounters=fddimibMACCounters, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACSMTIndex=fddimibMACSMTIndex, fddi=fddi, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMAC=fddimibMAC, fddimibPATHTable=fddimibPATHTable, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimib=fddimib, FddiTimeNano=FddiTimeNano, fddimibMACNumber=fddimibMACNumber, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPATHIndex=fddimibPATHIndex, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACTNeg=fddimibMACTNeg, fddimibSMTStationId=fddimibSMTStationId, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPORTPCMState=fddimibPORTPCMState, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMTTable=fddimibSMTTable, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTMyType=fddimibPORTMyType, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACTMax=fddimibMACTMax, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACEntry=fddimibMACEntry, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTEntry=fddimibSMTEntry, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTECMState=fddimibSMTECMState, fddimibPORT=fddimibPORT, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPORTTable=fddimibPORTTable, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions)
