...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPATH=fddimibPATH, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTEntry=fddimibSMTEntry, fddimibMAC=fddimibMAC, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTUserData=fddimibSMTUserData, fddimibPATHTable=fddimibPATHTable, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPORTNumber=fddimibPORTNumber, fddimibMACLateCts=fddimibMACLateCts, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORTAction=fddimibPORTAction, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddi=fddi, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACTable=fddimibMACTable, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPATHIndex=fddimibPATHIndex, fddimibSMT=fddimibSMT, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibSMTStationId=fddimibSMTStationId, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPATHEntry=fddimibPATHEntry, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, FddiResourceId=FddiResourceId, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACTMax=fddimibMACTMax, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACRMTState=fddimibMACRMTState, fddimibPATHNumber=fddimibPATHNumber, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACTReq=fddimibMACTReq, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACCounters=fddimibMACCounters, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACLostCts=fddimibMACLostCts, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACEntry=fddimibMACEntry, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPORTMyType=fddimibPORTMyType, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACNumber=fddimibMACNumber, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACTNeg=fddimibMACTNeg, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, FddiTimeMilli=FddiTimeMilli, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACIndex=fddimibMACIndex, FddiSMTStationIdType=FddiSMTStationIdType, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPORTEntry=fddimibPORTEntry, fddimib=fddimib, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPORTLemCts=fddimibPORTLemCts, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibSMTTable=fddimibSMTTable, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTCFState=fddimibSMTCFState, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPORTTable=fddimibPORTTable, fddimibSMTNumber=fddimibSMTNumber, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACRequestedPaths=fddimibMACRequestedPaths, FddiTimeNano=FddiTimeNano, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORT=fddimibPORT, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMTIndex=fddimibSMTIndex, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex)
