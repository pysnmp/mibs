...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACEntry=fddimibMACEntry, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTTable=fddimibSMTTable, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPATH=fddimibPATH, fddimibMACNumber=fddimibMACNumber, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMAC=fddimibMAC, fddimibPORT=fddimibPORT, fddimibPORTLemCts=fddimibPORTLemCts, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTNumber=fddimibPORTNumber, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPATHTable=fddimibPATHTable, FddiTimeNano=FddiTimeNano, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACCounters=fddimibMACCounters, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPATHIndex=fddimibPATHIndex, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMTStationAction=fddimibSMTStationAction, fddimibSMTUserData=fddimibSMTUserData, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACTMaxCapability=fddimibMACTMaxCapability, FddiTimeMilli=FddiTimeMilli, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACIndex=fddimibMACIndex, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACTNeg=fddimibMACTNeg, fddimibMACRMTState=fddimibMACRMTState, fddimibMACTable=fddimibMACTable, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibSMTCFState=fddimibSMTCFState, fddimibSMT=fddimibSMT, FddiResourceId=FddiResourceId, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPATHNumber=fddimibPATHNumber, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTPCMState=fddimibPORTPCMState, fddimibSMTEntry=fddimibSMTEntry, fddimibPORTTable=fddimibPORTTable, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTIndex=fddimibSMTIndex, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTStationId=fddimibSMTStationId, fddimibMACLateCts=fddimibMACLateCts, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACSMTIndex=fddimibMACSMTIndex, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPORTAction=fddimibPORTAction, fddi=fddi, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACTReq=fddimibMACTReq, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMTECMState=fddimibSMTECMState, fddimibPATHEntry=fddimibPATHEntry, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACTvxValue=fddimibMACTvxValue, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACTMax=fddimibMACTMax, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimib=fddimib, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibSMTNumber=fddimibSMTNumber, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPORTMyType=fddimibPORTMyType, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACFrameCts=fddimibMACFrameCts)
