...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORT=fddimibPORT, fddimibMACEntry=fddimibMACEntry, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACCounters=fddimibMACCounters, fddimibMACIndex=fddimibMACIndex, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACLateCts=fddimibMACLateCts, fddimibMACLostCts=fddimibMACLostCts, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMAC=fddimibMAC, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACTokenCts=fddimibMACTokenCts, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTNumber=fddimibPORTNumber, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPATHTable=fddimibPATHTable, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACTable=fddimibMACTable, fddimibSMTIndex=fddimibSMTIndex, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTUserData=fddimibSMTUserData, fddimibSMTTNotify=fddimibSMTTNotify, fddimibSMTOpVersionId=fddimibSMTOpVersionId, FddiTimeNano=FddiTimeNano, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibSMTNumber=fddimibSMTNumber, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACTReq=fddimibMACTReq, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACRMTState=fddimibMACRMTState, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPORTTable=fddimibPORTTable, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPATH=fddimibPATH, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMT=fddimibSMT, fddimibPORTAction=fddimibPORTAction, fddimibMACNumber=fddimibMACNumber, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTBypassPresent=fddimibSMTBypassPresent, FddiTimeMilli=FddiTimeMilli, fddimibPORTIndex=fddimibPORTIndex, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, FddiResourceId=FddiResourceId, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTEntry=fddimibPORTEntry, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPATHIndex=fddimibPATHIndex, fddimib=fddimib, fddimibSMTTable=fddimibSMTTable, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTEntry=fddimibSMTEntry, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACTNeg=fddimibMACTNeg, fddimibSMTECMState=fddimibSMTECMState, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddi=fddi, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACTMax=fddimibMACTMax, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibSMTStationId=fddimibSMTStationId, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibSMTCFState=fddimibSMTCFState, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPATHNumber=fddimibPATHNumber, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPORTMyType=fddimibPORTMyType)
