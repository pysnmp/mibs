...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPORTNumber=fddimibPORTNumber, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPATHNumber=fddimibPATHNumber, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTIndex=fddimibSMTIndex, fddimibMACEntry=fddimibMACEntry, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddi=fddi, fddimibMACCountersTable=fddimibMACCountersTable, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACIndex=fddimibMACIndex, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTLemCts=fddimibPORTLemCts, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMTTable=fddimibSMTTable, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTLoVersionId=fddimibSMTLoVersionId, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTUserData=fddimibSMTUserData, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACTMax=fddimibMACTMax, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPATHTable=fddimibPATHTable, FddiResourceId=FddiResourceId, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACCounters=fddimibMACCounters, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACDaFlag=fddimibMACDaFlag, FddiTimeMilli=FddiTimeMilli, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibSMTTNotify=fddimibSMTTNotify, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTCFState=fddimibSMTCFState, fddimibMACRMTState=fddimibMACRMTState, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTMyType=fddimibPORTMyType, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimib=fddimib, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTPCMState=fddimibPORTPCMState, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACTReq=fddimibMACTReq, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPORTTable=fddimibPORTTable, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPORTIndex=fddimibPORTIndex, fddimibMACTNeg=fddimibMACTNeg, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibSMT=fddimibSMT, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACTable=fddimibMACTable, FddiTimeNano=FddiTimeNano, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACTvxValue=fddimibMACTvxValue, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMAC=fddimibMAC, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACNumber=fddimibMACNumber, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTAction=fddimibPORTAction, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibSMTEntry=fddimibSMTEntry, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPORT=fddimibPORT, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPATHIndex=fddimibPATHIndex, fddimibSMTECMState=fddimibSMTECMState, fddimibSMTNumber=fddimibSMTNumber, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPATH=fddimibPATH, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibSMTBypassPresent=fddimibSMTBypassPresent)
