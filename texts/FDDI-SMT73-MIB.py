...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPORT=fddimibPORT, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTAction=fddimibPORTAction, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTEntry=fddimibSMTEntry, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTLerAlarm=fddimibPORTLerAlarm, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACLostCts=fddimibMACLostCts, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTNumber=fddimibSMTNumber, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACTable=fddimibMACTable, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACFrameCts=fddimibMACFrameCts, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPATHTable=fddimibPATHTable, fddimibMAC=fddimibMAC, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimib=fddimib, fddimibMACTMax=fddimibMACTMax, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibSMTECMState=fddimibSMTECMState, fddimibMACEntry=fddimibMACEntry, fddimibMACCopiedCts=fddimibMACCopiedCts, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACLateCts=fddimibMACLateCts, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMT=fddimibSMT, fddimibMACCounters=fddimibMACCounters, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTCFState=fddimibSMTCFState, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPATH=fddimibPATH, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACTvxValue=fddimibMACTvxValue, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPORTTable=fddimibPORTTable, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, FddiTimeMilli=FddiTimeMilli, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTTable=fddimibSMTTable, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPORTIndex=fddimibPORTIndex, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTNumber=fddimibPORTNumber, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPORTPCMState=fddimibPORTPCMState, fddimibSMTIndex=fddimibSMTIndex, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPATHNumber=fddimibPATHNumber, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibMACIndex=fddimibMACIndex, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACTNeg=fddimibMACTNeg, fddimibMACTReq=fddimibMACTReq, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACRMTState=fddimibMACRMTState, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibSMTTNotify=fddimibSMTTNotify, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTMyType=fddimibPORTMyType, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPATHIndex=fddimibPATHIndex, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACRingOpCts=fddimibMACRingOpCts, fddi=fddi, fddimibSMTStationAction=fddimibSMTStationAction, FddiTimeNano=FddiTimeNano, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACTVXCapability=fddimibMACTVXCapability, FddiResourceId=FddiResourceId, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACNumber=fddimibMACNumber)
