...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibSMTStationAction=fddimibSMTStationAction, FddiTimeNano=FddiTimeNano, FddiTimeMilli=FddiTimeMilli, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibSMTStationId=fddimibSMTStationId, fddimibMACRMTState=fddimibMACRMTState, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMT=fddimibSMT, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTAction=fddimibPORTAction, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibSMTTNotify=fddimibSMTTNotify, fddimib=fddimib, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTCFState=fddimibSMTCFState, fddimibMACTReq=fddimibMACTReq, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPATHTable=fddimibPATHTable, FddiMACLongAddressType=FddiMACLongAddressType, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibSMTIndex=fddimibSMTIndex, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACIfIndex=fddimibMACIfIndex, fddimibPORTEntry=fddimibPORTEntry, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPORTTable=fddimibPORTTable, fddimibMACTable=fddimibMACTable, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACNumber=fddimibMACNumber, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACLostCts=fddimibMACLostCts, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACCounters=fddimibMACCounters, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACTMax=fddimibMACTMax, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPATH=fddimibPATH, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibSMTTable=fddimibSMTTable, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACTNeg=fddimibMACTNeg, FddiResourceId=FddiResourceId, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMAC=fddimibMAC, fddimibPORTNumber=fddimibPORTNumber, fddi=fddi, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPORT=fddimibPORT, fddimibPORTMyType=fddimibPORTMyType, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACFrameCts=fddimibMACFrameCts, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACCountersTable=fddimibMACCountersTable, fddimibSMTNumber=fddimibSMTNumber, fddimibMACLateCts=fddimibMACLateCts, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACIndex=fddimibMACIndex, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTPCMState=fddimibPORTPCMState, fddimibSMTUserData=fddimibSMTUserData, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACEntry=fddimibMACEntry, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibSMTEntry=fddimibSMTEntry, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATHEntry=fddimibPATHEntry, fddimibPATHNumber=fddimibPATHNumber, fddimibPATHIndex=fddimibPATHIndex)
