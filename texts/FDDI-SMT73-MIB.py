...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACEntry=fddimibMACEntry, fddimibPORTIndex=fddimibPORTIndex, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibMACRMTState=fddimibMACRMTState, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTMACPlacement=fddimibPORTMACPlacement, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPATHNumber=fddimibPATHNumber, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACTReq=fddimibMACTReq, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPATHIndex=fddimibPATHIndex, FddiResourceId=FddiResourceId, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibSMTEntry=fddimibSMTEntry, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPATHEntry=fddimibPATHEntry, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTIndex=fddimibSMTIndex, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTMyType=fddimibPORTMyType, fddimibPATH=fddimibPATH, fddimibPORTNeighborType=fddimibPORTNeighborType, FddiTimeMilli=FddiTimeMilli, fddimibMACTNeg=fddimibMACTNeg, fddimibSMTTable=fddimibSMTTable, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibSMTNumber=fddimibSMTNumber, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTNumber=fddimibPORTNumber, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibMACIndex=fddimibMACIndex, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACLostCts=fddimibMACLostCts, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTAction=fddimibPORTAction, FddiTimeNano=FddiTimeNano, fddimibMACTable=fddimibMACTable, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimib=fddimib, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACCounters=fddimibMACCounters, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTTable=fddimibPORTTable, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACNumber=fddimibMACNumber, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMAC=fddimibMAC, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTTNotify=fddimibSMTTNotify, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPORT=fddimibPORT, fddimibMACTMax=fddimibMACTMax, fddimibPATHMaxTReq=fddimibPATHMaxTReq, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPATHTable=fddimibPATHTable, fddimibSMT=fddimibSMT, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddi=fddi, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACLateCts=fddimibMACLateCts, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag)
