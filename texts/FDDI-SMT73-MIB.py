...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACEntry=fddimibMACEntry, fddimib=fddimib, fddimibPATH=fddimibPATH, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTConnectState=fddimibPORTConnectState, FddiTimeMilli=FddiTimeMilli, fddimibMACTable=fddimibMACTable, fddimibPORT=fddimibPORT, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPATHNumber=fddimibPATHNumber, fddi=fddi, fddimibPORTMyType=fddimibPORTMyType, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibSMT=fddimibSMT, fddimibMACCounters=fddimibMACCounters, FddiTimeNano=FddiTimeNano, fddimibPORTNeighborType=fddimibPORTNeighborType, FddiResourceId=FddiResourceId, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPORTTable=fddimibPORTTable, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPORTEntry=fddimibPORTEntry, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibSMTNumber=fddimibSMTNumber, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTTable=fddimibSMTTable, fddimibPATHEntry=fddimibPATHEntry, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACTvxValue=fddimibMACTvxValue, fddimibPORTAction=fddimibPORTAction, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACTNeg=fddimibMACTNeg, fddimibMACIndex=fddimibMACIndex, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTNumber=fddimibPORTNumber, fddimibSMTEntry=fddimibSMTEntry, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibSMTIndex=fddimibSMTIndex, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACLostCts=fddimibMACLostCts, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACTMax=fddimibMACTMax, fddimibMACRMTState=fddimibMACRMTState, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTLemCts=fddimibPORTLemCts, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPORTIndex=fddimibPORTIndex, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPATHIndex=fddimibPATHIndex, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACTReq=fddimibMACTReq, fddimibPATHTable=fddimibPATHTable, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACLateCts=fddimibMACLateCts, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibSMTUserData=fddimibSMTUserData, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACNumber=fddimibMACNumber, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTECMState=fddimibSMTECMState, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMAC=fddimibMAC)
