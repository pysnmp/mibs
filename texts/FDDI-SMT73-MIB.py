...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACLateCts=fddimibMACLateCts, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibMACCounters=fddimibMACCounters, fddimibSMTNumber=fddimibSMTNumber, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPATH=fddimibPATH, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACRMTState=fddimibMACRMTState, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORTEntry=fddimibPORTEntry, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibMACTMax=fddimibMACTMax, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibSMTEntry=fddimibSMTEntry, fddimibPATHEntry=fddimibPATHEntry, fddimibMACTReq=fddimibMACTReq, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACNumber=fddimibMACNumber, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTAction=fddimibPORTAction, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, FddiTimeNano=FddiTimeNano, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACTNeg=fddimibMACTNeg, fddimibSMTTNotify=fddimibSMTTNotify, fddimibMACFrameCts=fddimibMACFrameCts, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibSMT=fddimibSMT, fddimibPORTIndex=fddimibPORTIndex, FddiResourceId=FddiResourceId, fddimibMACIndex=fddimibMACIndex, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACTVXCapability=fddimibMACTVXCapability, FddiTimeMilli=FddiTimeMilli, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPORTNumber=fddimibPORTNumber, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMAC=fddimibMAC, fddimibMACTable=fddimibMACTable, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibSMTUserData=fddimibSMTUserData, fddimibSMTTable=fddimibSMTTable, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPATHIndex=fddimibPATHIndex, fddi=fddi, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTMyType=fddimibPORTMyType, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTCFState=fddimibSMTCFState, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPATHNumber=fddimibPATHNumber, fddimibPORT=fddimibPORT, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimib=fddimib, fddimibSMTIndex=fddimibSMTIndex, fddimibPATHTable=fddimibPATHTable, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACEntry=fddimibMACEntry, fddimibPORTTable=fddimibPORTTable, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPATHSMTIndex=fddimibPATHSMTIndex)
