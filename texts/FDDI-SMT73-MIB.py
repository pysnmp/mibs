...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACErrorCts=fddimibMACErrorCts, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACRingOpCts=fddimibMACRingOpCts, fddi=fddi, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACLateCts=fddimibMACLateCts, fddimibSMT=fddimibSMT, fddimib=fddimib, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibSMTStationAction=fddimibSMTStationAction, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPATHIndex=fddimibPATHIndex, fddimibPATHNumber=fddimibPATHNumber, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibSMTTable=fddimibSMTTable, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, FddiResourceId=FddiResourceId, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTTable=fddimibPORTTable, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTAction=fddimibPORTAction, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACIndex=fddimibMACIndex, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPORTNumber=fddimibPORTNumber, fddimibSMTCFState=fddimibSMTCFState, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACCounters=fddimibMACCounters, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibMACRMTState=fddimibMACRMTState, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTIndex=fddimibSMTIndex, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPATHEntry=fddimibPATHEntry, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPATH=fddimibPATH, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibMACDaFlag=fddimibMACDaFlag, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACEntry=fddimibMACEntry, fddimibPORT=fddimibPORT, fddimibMACTMax=fddimibMACTMax, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibSMTUserData=fddimibSMTUserData, fddimibSMTEntry=fddimibSMTEntry, fddimibSMTTNotify=fddimibSMTTNotify, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTECMState=fddimibSMTECMState, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, FddiTimeMilli=FddiTimeMilli, fddimibSMTNumber=fddimibSMTNumber, fddimibPATHTable=fddimibPATHTable, fddimibMACTReq=fddimibMACTReq, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPORTConnectState=fddimibPORTConnectState, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACTable=fddimibMACTable, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPORTMyType=fddimibPORTMyType, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACNumber=fddimibMACNumber, fddimibMAC=fddimibMAC, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPORTIndex=fddimibPORTIndex, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibSMTStationId=fddimibSMTStationId, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, FddiTimeNano=FddiTimeNano, fddimibPATHSMTIndex=fddimibPATHSMTIndex)
