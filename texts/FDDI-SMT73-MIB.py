...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACCounters=fddimibMACCounters, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPORTIndex=fddimibPORTIndex, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibSMTCFState=fddimibSMTCFState, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPATHTable=fddimibPATHTable, fddimibSMTECMState=fddimibSMTECMState, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTTNotify=fddimibSMTTNotify, fddimibPORTEntry=fddimibPORTEntry, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibSMTNumber=fddimibSMTNumber, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimib=fddimib, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTTable=fddimibPORTTable, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPORTLemCts=fddimibPORTLemCts, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPORT=fddimibPORT, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACIndex=fddimibMACIndex, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORTNumber=fddimibPORTNumber, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPATH=fddimibPATH, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPORTAction=fddimibPORTAction, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACEntry=fddimibMACEntry, fddimibPATHIndex=fddimibPATHIndex, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMTIndex=fddimibSMTIndex, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTUserData=fddimibSMTUserData, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPATHEntry=fddimibPATHEntry, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACNumber=fddimibMACNumber, FddiTimeNano=FddiTimeNano, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibSMTStationAction=fddimibSMTStationAction, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACTReq=fddimibMACTReq, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACTvxValue=fddimibMACTvxValue, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACTMax=fddimibMACTMax, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPORTMyType=fddimibPORTMyType, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibSMTTable=fddimibSMTTable, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMAC=fddimibMAC, fddimibPATHNumber=fddimibPATHNumber, FddiResourceId=FddiResourceId, fddimibMACErrorCts=fddimibMACErrorCts, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMT=fddimibSMT, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACRMTState=fddimibMACRMTState, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddi=fddi, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTMACPlacement=fddimibPORTMACPlacement, FddiTimeMilli=FddiTimeMilli, fddimibPORTConnectState=fddimibPORTConnectState, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACTable=fddimibMACTable, fddimibMACLateCts=fddimibMACLateCts, fddimibSMTEntry=fddimibSMTEntry, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag)
