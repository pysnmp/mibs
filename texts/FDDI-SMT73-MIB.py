...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimib=fddimib, fddimibSMTIndex=fddimibSMTIndex, FddiTimeMilli=FddiTimeMilli, fddimibSMTEntry=fddimibSMTEntry, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibSMTTNotify=fddimibSMTTNotify, fddi=fddi, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibPORTTable=fddimibPORTTable, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACTable=fddimibMACTable, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTStationId=fddimibSMTStationId, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACLateCts=fddimibMACLateCts, fddimibPATHIndex=fddimibPATHIndex, fddimibMAC=fddimibMAC, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibPORTMyType=fddimibPORTMyType, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACRMTState=fddimibMACRMTState, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibSMTNumber=fddimibSMTNumber, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPATH=fddimibPATH, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACNumber=fddimibMACNumber, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibSMTUserData=fddimibSMTUserData, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMTTable=fddimibSMTTable, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibPATHTable=fddimibPATHTable, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibSMT=fddimibSMT, fddimibPORTPCMState=fddimibPORTPCMState, fddimibSMTCFState=fddimibSMTCFState, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACCountersEntry=fddimibMACCountersEntry, FddiResourceId=FddiResourceId, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibPORTLerAlarm=fddimibPORTLerAlarm, FddiTimeNano=FddiTimeNano, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACLostCts=fddimibMACLostCts, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACTNeg=fddimibMACTNeg, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibPATHEntry=fddimibPATHEntry, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibMACDaFlag=fddimibMACDaFlag, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACCounters=fddimibMACCounters, fddimibMACEntry=fddimibMACEntry, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTAction=fddimibPORTAction, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibPORT=fddimibPORT, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPORTConnectState=fddimibPORTConnectState, fddimibPATHNumber=fddimibPATHNumber, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibSMTECMState=fddimibSMTECMState, fddimibMACTMax=fddimibMACTMax, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACIndex=fddimibMACIndex, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACTReq=fddimibMACTReq, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibPORTNumber=fddimibPORTNumber, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths)
