...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTMACCts=fddimibSMTMACCts, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, FddiTimeMilli=FddiTimeMilli, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibMACErrorCts=fddimibMACErrorCts, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibPATHTable=fddimibPATHTable, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibSMTStationId=fddimibSMTStationId, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibSMT=fddimibSMT, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimib=fddimib, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPATHNumber=fddimibPATHNumber, fddimibPORT=fddimibPORT, fddimibPATH=fddimibPATH, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibSMTIndex=fddimibSMTIndex, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPORTNumber=fddimibPORTNumber, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACLostCts=fddimibMACLostCts, fddimibMACTMax=fddimibMACTMax, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACNumber=fddimibMACNumber, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMACIndex=fddimibMACIndex, fddimibPORTTable=fddimibPORTTable, fddimibMACEntry=fddimibMACEntry, fddimibPATHEntry=fddimibPATHEntry, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACIfIndex=fddimibMACIfIndex, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACCountersTable=fddimibMACCountersTable, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACTReq=fddimibMACTReq, fddimibMACFrameCts=fddimibMACFrameCts, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACRMTState=fddimibMACRMTState, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACTable=fddimibMACTable, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACTNeg=fddimibMACTNeg, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPATHSMTIndex=fddimibPATHSMTIndex, FddiTimeNano=FddiTimeNano, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTMyType=fddimibPORTMyType, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTEntry=fddimibPORTEntry, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMAC=fddimibMAC, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACTokenCts=fddimibMACTokenCts, fddimibPORTAction=fddimibPORTAction, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibSMTNumber=fddimibSMTNumber, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibMACLateCts=fddimibMACLateCts, FddiResourceId=FddiResourceId, fddimibMACCounters=fddimibMACCounters, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibMACCountersEntry=fddimibMACCountersEntry, fddi=fddi, fddimibSMTEntry=fddimibSMTEntry, fddimibPORTIndex=fddimibPORTIndex, fddimibSMTCFState=fddimibSMTCFState, fddimibSMTTable=fddimibSMTTable, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibSMTECMState=fddimibSMTECMState, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibSMTTNotify=fddimibSMTTNotify, fddimibPATHIndex=fddimibPATHIndex)
