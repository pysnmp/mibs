...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTEntry=fddimibPORTEntry, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibSMTTNotify=fddimibSMTTNotify, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibPORTPCMState=fddimibPORTPCMState, fddimibMACNumber=fddimibMACNumber, fddimibSMTEntry=fddimibSMTEntry, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, FddiSMTStationIdType=FddiSMTStationIdType, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACRMTState=fddimibMACRMTState, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACEntry=fddimibMACEntry, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTMyType=fddimibPORTMyType, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibMACCountersTable=fddimibMACCountersTable, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibMACFrameCts=fddimibMACFrameCts, FddiMACLongAddressType=FddiMACLongAddressType, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibPORTConnectState=fddimibPORTConnectState, fddimibMACCopiedCts=fddimibMACCopiedCts, FddiResourceId=FddiResourceId, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibPORTTable=fddimibPORTTable, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPATHNumber=fddimibPATHNumber, FddiTimeNano=FddiTimeNano, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibSMTIndex=fddimibSMTIndex, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTECMState=fddimibSMTECMState, fddimibPATHTable=fddimibPATHTable, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibSMTCFState=fddimibSMTCFState, fddimibPATHEntry=fddimibPATHEntry, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibPATH=fddimibPATH, fddimibSMTStationId=fddimibSMTStationId, fddimibMACCounters=fddimibMACCounters, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMAC=fddimibMAC, fddimibMACTMax=fddimibMACTMax, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibSMT=fddimibSMT, fddimibMACTvxValue=fddimibMACTvxValue, fddimibSMTTable=fddimibSMTTable, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPORTAction=fddimibPORTAction, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPORTIndex=fddimibPORTIndex, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTNumber=fddimibPORTNumber, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibSMTNumber=fddimibSMTNumber, fddimib=fddimib, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibPORTPCWithhold=fddimibPORTPCWithhold, FddiTimeMilli=FddiTimeMilli, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACTNeg=fddimibMACTNeg, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddi=fddi, fddimibMACIndex=fddimibMACIndex, fddimibMACTokenCts=fddimibMACTokenCts, fddimibMACTReq=fddimibMACTReq, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibSMTLoVersionId=fddimibSMTLoVersionId, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibMACIfIndex=fddimibMACIfIndex, fddimibSMTUserData=fddimibSMTUserData, fddimibMACTable=fddimibMACTable, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPORT=fddimibPORT, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibPORTLemCts=fddimibPORTLemCts, fddimibSMTStationAction=fddimibSMTStationAction, fddimibMACDaFlag=fddimibMACDaFlag, fddimibSMTMACCts=fddimibSMTMACCts, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPATHIndex=fddimibPATHIndex, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibMACLateCts=fddimibMACLateCts, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths)
