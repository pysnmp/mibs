...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: ciscoTextualConventions.setRevisionsDescriptions(('Added CountryCode textual convention.', 'Added SAPType textual convention.', 'Added InterfaceIndexOrZero textual convention.', 'Added new CiscoNetworkProtocol enumerations.', 'Miscellaneous updates/corrections, including making\n\t\tCiscoNetworkProtocol enumerations contiguous.', 'Added Port and IpProtocol textual conventions.',))
...
class CountryCode(TextualConvention, OctetString):
    description = 'Represents a case-insensitive 2-letter country code taken from\n              ISO-3166. Unrecognized countries are represented as empty string.\n             '
    status = 'current'
    displayHint = '2a'
...
class CiscoPort(TextualConvention, Integer32):
    reference = 'Transmission Control Protocol. J. Postel. RFC793,\n                User Datagram Protocol. J. Postel. RFC768'
