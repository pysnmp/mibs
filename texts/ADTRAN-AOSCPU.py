...
# ASN.1 source ADTRAN-AOSCPU
# Source digest sha256:410ca800253b2262f5178ee9e61f4e73e947956a9aae9c87b6c6d9a1dc9dceb1
...
if mibBuilder.loadTexts: adGenAOSCpuUtilMib.setLastUpdated('2009-04-30 00:00')
...
adGenAOSProcessTable = MibTable((1, 3, 6, 1, 4, 1, 664, 5, 53, 1, 4, 9), ).setMaxAccess("notaccessible")
...
adGenAOSProcessEntry = MibTableRow((1, 3, 6, 1, 4, 1, 664, 5, 53, 1, 4, 9, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "ADTRAN-AOSCPU", "adGenAOSProcID"))
...
adGenAOSProcID = MibTableColumn((1, 3, 6, 1, 4, 1, 664, 5, 53, 1, 4, 9, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("notaccessible")
...
adGenAOSResUtilThreshTable = MibTable((1, 3, 6, 1, 4, 1, 664, 5, 53, 1, 4, 10), ).setMaxAccess("notaccessible")
...
adGenAOSResUtilThreshEntry = MibTableRow((1, 3, 6, 1, 4, 1, 664, 5, 53, 1, 4, 10, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "ADTRAN-AOSCPU", "adGenAOSResType"), (0, "ADTRAN-AOSCPU", "adGenAOSResUtilThresh"), (0, "ADTRAN-AOSCPU", "adGenAOSResUtilTimeInterval"))
...
mibBuilder.exportSymbols("ADTRAN-AOSCPU", PYSNMP_MODULE_ID=adGenAOSCpuUtilMib, adAOSCompliance=adAOSCompliance, adAOSCpuCompliances=adAOSCpuCompliances, adAOSCpuGroups=adAOSCpuGroups, adGenAOS1MinCpuUtil=adGenAOS1MinCpuUtil, adGenAOS5MinCpuUtil=adGenAOS5MinCpuUtil, adGenAOSClearUtilizationStats=adGenAOSClearUtilizationStats, adGenAOSCpuConformance=adGenAOSCpuConformance, adGenAOSCpuGroup=adGenAOSCpuGroup, adGenAOSCpuUtil=adGenAOSCpuUtil, adGenAOSCpuUtilMib=adGenAOSCpuUtilMib, adGenAOSCurrentCpuUtil=adGenAOSCurrentCpuUtil, adGenAOSHeapFree=adGenAOSHeapFree, adGenAOSHeapSize=adGenAOSHeapSize, adGenAOSMaxCpuUtil=adGenAOSMaxCpuUtil, adGenAOSMemPool=adGenAOSMemPool, adGenAOSProc1SecLd=adGenAOSProc1SecLd, adGenAOSProcCount=adGenAOSProcCount, adGenAOSProcExecTime=adGenAOSProcExecTime, adGenAOSProcID=adGenAOSProcID, adGenAOSProcName=adGenAOSProcName, adGenAOSProcPriority=adGenAOSProcPriority, adGenAOSProcRunTime=adGenAOSProcRunTime, adGenAOSProcState=adGenAOSProcState, adGenAOSProcessEntry=adGenAOSProcessEntry, adGenAOSProcessGroup=adGenAOSProcessGroup, adGenAOSProcessTable=adGenAOSProcessTable, adGenAOSResType=adGenAOSResType, adGenAOSResUtilThresh=adGenAOSResUtilThresh, adGenAOSResUtilThreshAlarm=adGenAOSResUtilThreshAlarm, adGenAOSResUtilThreshEntry=adGenAOSResUtilThreshEntry, adGenAOSResUtilThreshNormal=adGenAOSResUtilThreshNormal, adGenAOSResUtilThreshRowStatus=adGenAOSResUtilThreshRowStatus, adGenAOSResUtilThreshTable=adGenAOSResUtilThreshTable, adGenAOSResUtilThreshTimestamp=adGenAOSResUtilThreshTimestamp, adGenAOSResUtilThreshTraps=adGenAOSResUtilThreshTraps, adGenAOSResUtilTimeInterval=adGenAOSResUtilTimeInterval, adGenAOSThresholdGroup=adGenAOSThresholdGroup, adGenAOSThresholdTrapGroup=adGenAOSThresholdTrapGroup)
