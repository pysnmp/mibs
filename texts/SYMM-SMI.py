...
Integer32, enterprises, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, IpAddress, MibIdentifier, iso, Bits, Counter64, NotificationType, ObjectIdentity, Gauge32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "IpAddress", "MibIdentifier", "iso", "Bits", "Counter64", "NotificationType", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPeer=ntpSysPeer, ntpSysError=ntpSysError, tymingTime=tymingTime, etcSerialNbr=etcSerialNbr, etcUpgradeServer=etcUpgradeServer, ntpSysPrecision=ntpSysPrecision, dialup=dialup, symmSnmpManagement=symmSnmpManagement, ntpSystem=ntpSystem, etcUpgrade=etcUpgrade, ntpSysMode=ntpSysMode, s100=s100, symmTimePictra=symmTimePictra, gpsMode=gpsMode, syncserver=syncserver, tymingVersion=tymingVersion, gpsPosition=gpsPosition, ntpSysNotrust=ntpSysNotrust, gpsHealth=gpsHealth, net=net, gpsSatlist=gpsSatlist, ntpSysSystem=ntpSysSystem, tymingFlyPeriod=tymingFlyPeriod, ntpSysPhase=ntpSysPhase, ntpSysRootDispersion=ntpSysRootDispersion, ts2000=ts2000, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDelay=ntpSysRootDelay, ntpSysPktsReceived=ntpSysPktsReceived, etcVersion=etcVersion, ntpSysPoll=ntpSysPoll, ntpSysClock=ntpSysClock, tymingStatus=tymingStatus, ts2100=ts2100, xli=xli, ntpSysVersion=ntpSysVersion, tyming=tyming, etcModel=etcModel, experiment=experiment, ntpSysRefID=ntpSysRefID, symmCmipManagement=symmCmipManagement, ntpSysStratum=ntpSysStratum, version=version, etcAlarmString=etcAlarmString, products=products, etc=etc, symmBroadband=symmBroadband, nts=nts, symmetricom=symmetricom, ntpSysRefTime=ntpSysRefTime, gps=gps, symmTTM=symmTTM, ntpSysFreq=ntpSysFreq, ntpSysProcessor=ntpSysProcessor, gpsUTCOffset=gpsUTCOffset, symmNetworkManagement=symmNetworkManagement, tymingSource=tymingSource, ntpSysLeap=ntpSysLeap, etcAlarm=etcAlarm)
