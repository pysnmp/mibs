...
Counter32, Unsigned32, ObjectIdentity, Gauge32, Bits, MibIdentifier, ModuleIdentity, Counter64, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, enterprises, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "ObjectIdentity", "Gauge32", "Bits", "MibIdentifier", "ModuleIdentity", "Counter64", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "enterprises", "NotificationType", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", nts=nts, ts2100=ts2100, ntpSysPrecision=ntpSysPrecision, ntpSysError=ntpSysError, ntpSysLeap=ntpSysLeap, tymingTime=tymingTime, experiment=experiment, ntpSysRootDelay=ntpSysRootDelay, tymingVersion=tymingVersion, ntpSystem=ntpSystem, ntpSysSystem=ntpSysSystem, tymingFlyPeriod=tymingFlyPeriod, gpsHealth=gpsHealth, etcAlarm=etcAlarm, symmSnmpManagement=symmSnmpManagement, ntpSysPktsReceived=ntpSysPktsReceived, tyming=tyming, products=products, ntpSysRefID=ntpSysRefID, syncserver=syncserver, net=net, ntpSysClock=ntpSysClock, ntpSysRefTime=ntpSysRefTime, xli=xli, ntpSysFreq=ntpSysFreq, ntpSysPeer=ntpSysPeer, PYSNMP_MODULE_ID=symmetricom, etcAlarmString=etcAlarmString, etcSerialNbr=etcSerialNbr, symmetricom=symmetricom, symmBroadband=symmBroadband, ntpSysStratum=ntpSysStratum, ntpSysProcessor=ntpSysProcessor, symmTTM=symmTTM, etc=etc, ntpSysPoll=ntpSysPoll, etcModel=etcModel, symmTimePictra=symmTimePictra, ts2000=ts2000, dialup=dialup, ntpSysMode=ntpSysMode, tymingSource=tymingSource, version=version, ntpSysNotrust=ntpSysNotrust, ntpSysRootDispersion=ntpSysRootDispersion, gpsMode=gpsMode, gpsPosition=gpsPosition, symmNetworkManagement=symmNetworkManagement, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, etcUpgrade=etcUpgrade, s100=s100, gpsUTCOffset=gpsUTCOffset, tymingStatus=tymingStatus, gps=gps, symmCmipManagement=symmCmipManagement, ntpSysVersion=ntpSysVersion, gpsSatlist=gpsSatlist, ntpSysPhase=ntpSysPhase)
