...
enterprises, TimeTicks, NotificationType, Counter64, iso, Bits, Unsigned32, Gauge32, ObjectIdentity, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "NotificationType", "Counter64", "iso", "Bits", "Unsigned32", "Gauge32", "ObjectIdentity", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefID=ntpSysRefID, symmBroadband=symmBroadband, ntpSysClock=ntpSysClock, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefTime=ntpSysRefTime, syncserver=syncserver, xli=xli, ntpSysPktsReceived=ntpSysPktsReceived, tyming=tyming, symmNetworkManagement=symmNetworkManagement, etcModel=etcModel, ntpSysError=ntpSysError, nts=nts, etcAlarmString=etcAlarmString, ntpSysPoll=ntpSysPoll, ntpSysNotrust=ntpSysNotrust, ntpSysStratum=ntpSysStratum, symmCmipManagement=symmCmipManagement, etcUpgradeServer=etcUpgradeServer, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, net=net, ntpSysFreq=ntpSysFreq, symmTimePictra=symmTimePictra, ntpSystem=ntpSystem, etcSerialNbr=etcSerialNbr, etcUpgrade=etcUpgrade, gpsPosition=gpsPosition, products=products, tymingTime=tymingTime, tymingFlyPeriod=tymingFlyPeriod, gpsMode=gpsMode, version=version, ts2100=ts2100, ntpSysVersion=ntpSysVersion, symmetricom=symmetricom, ts2000=ts2000, etcVersion=etcVersion, experiment=experiment, tymingVersion=tymingVersion, tymingStatus=tymingStatus, s100=s100, gps=gps, etc=etc, ntpSysProcessor=ntpSysProcessor, gpsHealth=gpsHealth, gpsUTCOffset=gpsUTCOffset, dialup=dialup, symmSnmpManagement=symmSnmpManagement, ntpSysSystem=ntpSysSystem, etcAlarm=etcAlarm, ntpSysPrecision=ntpSysPrecision, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDelay=ntpSysRootDelay, ntpSysMode=ntpSysMode, gpsSatlist=gpsSatlist, tymingSource=tymingSource, ntpSysPeer=ntpSysPeer, ntpSysLeap=ntpSysLeap)
