...
NotificationType, TimeTicks, Integer32, Gauge32, ModuleIdentity, Bits, Counter64, Counter32, Unsigned32, IpAddress, MibIdentifier, ObjectIdentity, NotificationType, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "Integer32", "Gauge32", "ModuleIdentity", "Bits", "Counter64", "Counter32", "Unsigned32", "IpAddress", "MibIdentifier", "ObjectIdentity", "NotificationType", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDispersion=ntpSysRootDispersion, nts=nts, ntpSysPeer=ntpSysPeer, ntpSysFreq=ntpSysFreq, ntpSysError=ntpSysError, xli=xli, symmTimePictra=symmTimePictra, gps=gps, symmetricom=symmetricom, ntpSysPoll=ntpSysPoll, tymingStatus=tymingStatus, tyming=tyming, ntpSysPktsReceived=ntpSysPktsReceived, etcSerialNbr=etcSerialNbr, etcAlarm=etcAlarm, net=net, ntpSysSystem=ntpSysSystem, ntpSysNotrust=ntpSysNotrust, gpsMode=gpsMode, ntpSysProcessor=ntpSysProcessor, syncserver=syncserver, ntpSysVersion=ntpSysVersion, ts2100=ts2100, etcUpgrade=etcUpgrade, ntpSysLeap=ntpSysLeap, gpsPosition=gpsPosition, tymingFlyPeriod=tymingFlyPeriod, s100=s100, etcAlarmString=etcAlarmString, tymingTime=tymingTime, ts2000=ts2000, gpsHealth=gpsHealth, experiment=experiment, ntpSysRefTime=ntpSysRefTime, etcVersion=etcVersion, symmSnmpManagement=symmSnmpManagement, etcUpgradeServer=etcUpgradeServer, symmTTM=symmTTM, ntpSysRootDelay=ntpSysRootDelay, products=products, symmCmipManagement=symmCmipManagement, ntpSysRefID=ntpSysRefID, ntpSysClock=ntpSysClock, etcModel=etcModel, tymingVersion=tymingVersion, gpsUTCOffset=gpsUTCOffset, ntpSysStratum=ntpSysStratum, ntpSysPrecision=ntpSysPrecision, gpsSatlist=gpsSatlist, etc=etc, ntpSysMode=ntpSysMode, tymingSource=tymingSource, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom, ntpSysPhase=ntpSysPhase, dialup=dialup, symmNetworkManagement=symmNetworkManagement, version=version, ntpSystem=ntpSystem)
