...
NotificationType, ObjectIdentity, Counter64, enterprises, IpAddress, MibIdentifier, ModuleIdentity, NotificationType, iso, Counter32, Unsigned32, Integer32, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Counter64", "enterprises", "IpAddress", "MibIdentifier", "ModuleIdentity", "NotificationType", "iso", "Counter32", "Unsigned32", "Integer32", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefID=ntpSysRefID, ntpSysNotrust=ntpSysNotrust, etcAlarmString=etcAlarmString, ntpSystem=ntpSystem, gpsUTCOffset=gpsUTCOffset, version=version, tymingFlyPeriod=tymingFlyPeriod, syncserver=syncserver, gps=gps, ntpSysRootDelay=ntpSysRootDelay, net=net, ntpSysLeap=ntpSysLeap, ts2000=ts2000, ntpSysPhase=ntpSysPhase, ntpSysSystem=ntpSysSystem, symmBroadband=symmBroadband, products=products, etcVersion=etcVersion, symmTTM=symmTTM, xli=xli, symmNetworkManagement=symmNetworkManagement, ntpSysClock=ntpSysClock, PYSNMP_MODULE_ID=symmetricom, ntpSysPktsReceived=ntpSysPktsReceived, ts2100=ts2100, ntpSysMode=ntpSysMode, ntpSysPoll=ntpSysPoll, ntpSysPrecision=ntpSysPrecision, ntpSysProcessor=ntpSysProcessor, dialup=dialup, ntpSysRefTime=ntpSysRefTime, s100=s100, tymingVersion=tymingVersion, ntpSysError=ntpSysError, etcSerialNbr=etcSerialNbr, symmCmipManagement=symmCmipManagement, etcAlarm=etcAlarm, tymingStatus=tymingStatus, etcUpgrade=etcUpgrade, symmetricom=symmetricom, gpsHealth=gpsHealth, tymingSource=tymingSource, experiment=experiment, etcModel=etcModel, ntpSysVersion=ntpSysVersion, gpsSatlist=gpsSatlist, ntpSysStratum=ntpSysStratum, etcUpgradeServer=etcUpgradeServer, ntpSysPeer=ntpSysPeer, symmTimePictra=symmTimePictra, tyming=tyming, ntpSysFreq=ntpSysFreq, symmSnmpManagement=symmSnmpManagement, tymingTime=tymingTime, nts=nts, gpsPosition=gpsPosition, etc=etc, gpsMode=gpsMode)
