...
IpAddress, ObjectIdentity, TimeTicks, Integer32, Bits, Counter64, Gauge32, Unsigned32, ModuleIdentity, Counter32, enterprises, NotificationType, NotificationType, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "TimeTicks", "Integer32", "Bits", "Counter64", "Gauge32", "Unsigned32", "ModuleIdentity", "Counter32", "enterprises", "NotificationType", "NotificationType", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysMode=ntpSysMode, gpsUTCOffset=gpsUTCOffset, symmSnmpManagement=symmSnmpManagement, ntpSysRefTime=ntpSysRefTime, ntpSysLeap=ntpSysLeap, ntpSysClock=ntpSysClock, ntpSystem=ntpSystem, ntpSysStratum=ntpSysStratum, ts2000=ts2000, symmetricom=symmetricom, ntpSysNotrust=ntpSysNotrust, etcUpgradeServer=etcUpgradeServer, symmCmipManagement=symmCmipManagement, ntpSysFreq=ntpSysFreq, PYSNMP_MODULE_ID=symmetricom, products=products, etcVersion=etcVersion, ntpSysPrecision=ntpSysPrecision, ntpSysPktsReceived=ntpSysPktsReceived, gpsHealth=gpsHealth, ntpSysPhase=ntpSysPhase, ntpSysSystem=ntpSysSystem, tyming=tyming, ntpSysProcessor=ntpSysProcessor, tymingTime=tymingTime, ntpSysRootDelay=ntpSysRootDelay, etcUpgrade=etcUpgrade, etcAlarm=etcAlarm, tymingFlyPeriod=tymingFlyPeriod, ts2100=ts2100, ntpSysRefID=ntpSysRefID, symmBroadband=symmBroadband, symmNetworkManagement=symmNetworkManagement, gpsMode=gpsMode, etcAlarmString=etcAlarmString, experiment=experiment, tymingVersion=tymingVersion, dialup=dialup, gpsPosition=gpsPosition, gpsSatlist=gpsSatlist, etcModel=etcModel, s100=s100, ntpSysVersion=ntpSysVersion, nts=nts, etc=etc, net=net, syncserver=syncserver, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, tymingStatus=tymingStatus, symmTimePictra=symmTimePictra, version=version, symmTTM=symmTTM, ntpSysRootDispersion=ntpSysRootDispersion, xli=xli, ntpSysError=ntpSysError, gps=gps, etcSerialNbr=etcSerialNbr, ntpSysPeer=ntpSysPeer)
