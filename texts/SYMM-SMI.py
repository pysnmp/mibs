...
TimeTicks, Bits, Integer32, Gauge32, Unsigned32, Counter64, ModuleIdentity, enterprises, IpAddress, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "Integer32", "Gauge32", "Unsigned32", "Counter64", "ModuleIdentity", "enterprises", "IpAddress", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysStratum=ntpSysStratum, ntpSysFreq=ntpSysFreq, etcVersion=etcVersion, nts=nts, etcAlarmString=etcAlarmString, etcSerialNbr=etcSerialNbr, gpsSatlist=gpsSatlist, ntpSysRootDelay=ntpSysRootDelay, ntpSysClock=ntpSysClock, tymingFlyPeriod=tymingFlyPeriod, etcAlarm=etcAlarm, syncserver=syncserver, ts2000=ts2000, etcUpgrade=etcUpgrade, gpsUTCOffset=gpsUTCOffset, experiment=experiment, version=version, gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, symmBroadband=symmBroadband, ntpSysPktsReceived=ntpSysPktsReceived, tymingVersion=tymingVersion, symmTimePictra=symmTimePictra, ntpSysPoll=ntpSysPoll, ntpSysError=ntpSysError, ntpSysRefTime=ntpSysRefTime, ntpSysSystem=ntpSysSystem, PYSNMP_MODULE_ID=symmetricom, s100=s100, ntpSysPrecision=ntpSysPrecision, tymingTime=tymingTime, ts2100=ts2100, ntpSysNotrust=ntpSysNotrust, symmetricom=symmetricom, etcModel=etcModel, symmCmipManagement=symmCmipManagement, dialup=dialup, xli=xli, ntpSysProcessor=ntpSysProcessor, symmTTM=symmTTM, products=products, tymingStatus=tymingStatus, etc=etc, tyming=tyming, ntpSysRefID=ntpSysRefID, ntpSysPhase=ntpSysPhase, etcUpgradeServer=etcUpgradeServer, net=net, tymingSource=tymingSource, ntpSysMode=ntpSysMode, gpsHealth=gpsHealth, ntpSysVersion=ntpSysVersion, gpsMode=gpsMode, ntpSystem=ntpSystem, ntpSysPeer=ntpSysPeer, gpsPosition=gpsPosition, symmNetworkManagement=symmNetworkManagement, ntpSysLeap=ntpSysLeap)
