...
mibBuilder.exportSymbols("SYMM-SMI", ntpSystem=ntpSystem, tymingSource=tymingSource, ntpSysPktsReceived=ntpSysPktsReceived, experiment=experiment, dialup=dialup, ts2100=ts2100, ntpSysPrecision=ntpSysPrecision, version=version, ts2000=ts2000, ntpSysPeer=ntpSysPeer, ntpSysLeap=ntpSysLeap, ntpSysVersion=ntpSysVersion, ntpSysNotrust=ntpSysNotrust, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, gpsSatlist=gpsSatlist, ntpSysSystem=ntpSysSystem, etcUpgradeServer=etcUpgradeServer, tymingVersion=tymingVersion, ntpSysPoll=ntpSysPoll, symmSnmpManagement=symmSnmpManagement, xli=xli, ntpSysStratum=ntpSysStratum, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefID=ntpSysRefID, ntpSysPhase=ntpSysPhase, ntpSysClock=ntpSysClock, gpsPosition=gpsPosition, etcAlarm=etcAlarm, PYSNMP_MODULE_ID=symmetricom, etcVersion=etcVersion, gpsMode=gpsMode, s100=s100, ntpSysProcessor=ntpSysProcessor, etcModel=etcModel, symmBroadband=symmBroadband, net=net, gps=gps, gpsHealth=gpsHealth, symmetricom=symmetricom, tymingTime=tymingTime, etcSerialNbr=etcSerialNbr, etc=etc, ntpSysFreq=ntpSysFreq, tymingStatus=tymingStatus, gpsUTCOffset=gpsUTCOffset, tyming=tyming, nts=nts, products=products, symmTTM=symmTTM, ntpSysMode=ntpSysMode, symmNetworkManagement=symmNetworkManagement, symmTimePictra=symmTimePictra, ntpSysRootDelay=ntpSysRootDelay, etcAlarmString=etcAlarmString, tymingFlyPeriod=tymingFlyPeriod, ntpSysRefTime=ntpSysRefTime, symmCmipManagement=symmCmipManagement, syncserver=syncserver)
