...
ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Unsigned32, Counter64, IpAddress, Bits, enterprises, Integer32, TimeTicks, NotificationType, MibIdentifier, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Unsigned32", "Counter64", "IpAddress", "Bits", "enterprises", "Integer32", "TimeTicks", "NotificationType", "MibIdentifier", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysStratum=ntpSysStratum, gpsUTCOffset=gpsUTCOffset, ntpSysNotrust=ntpSysNotrust, tymingVersion=tymingVersion, ntpSysRefID=ntpSysRefID, ts2000=ts2000, gpsSatlist=gpsSatlist, etcVersion=etcVersion, etcModel=etcModel, gps=gps, etcAlarmString=etcAlarmString, PYSNMP_MODULE_ID=symmetricom, ntpSysLeap=ntpSysLeap, ntpSysPeer=ntpSysPeer, experiment=experiment, products=products, etcAlarm=etcAlarm, ntpSysClock=ntpSysClock, xli=xli, ntpSystem=ntpSystem, net=net, tymingFlyPeriod=tymingFlyPeriod, ntpSysProcessor=ntpSysProcessor, ntpSysPhase=ntpSysPhase, symmTTM=symmTTM, ntpSysRootDispersion=ntpSysRootDispersion, gpsMode=gpsMode, etcUpgradeServer=etcUpgradeServer, nts=nts, ntpSysRootDelay=ntpSysRootDelay, etcSerialNbr=etcSerialNbr, syncserver=syncserver, version=version, gpsPosition=gpsPosition, dialup=dialup, symmTimePictra=symmTimePictra, tymingStatus=tymingStatus, ntpSysPoll=ntpSysPoll, s100=s100, ntpSysFreq=ntpSysFreq, ntpSysError=ntpSysError, symmCmipManagement=symmCmipManagement, ntpSysPktsReceived=ntpSysPktsReceived, tyming=tyming, ts2100=ts2100, symmNetworkManagement=symmNetworkManagement, symmBroadband=symmBroadband, ntpSysPrecision=ntpSysPrecision, ntpSysMode=ntpSysMode, ntpSysVersion=ntpSysVersion, etc=etc, ntpSysSystem=ntpSysSystem, gpsHealth=gpsHealth, ntpSysRefTime=ntpSysRefTime, tymingTime=tymingTime, symmSnmpManagement=symmSnmpManagement, etcUpgrade=etcUpgrade, symmetricom=symmetricom, tymingSource=tymingSource)
