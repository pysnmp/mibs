...
Bits, MibIdentifier, NotificationType, enterprises, iso, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, ObjectIdentity, TimeTicks, Counter32, Counter64, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "NotificationType", "enterprises", "iso", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "ObjectIdentity", "TimeTicks", "Counter32", "Counter64", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsHealth=gpsHealth, nts=nts, tymingFlyPeriod=tymingFlyPeriod, gpsSatlist=gpsSatlist, etcUpgrade=etcUpgrade, ntpSysRefID=ntpSysRefID, tymingTime=tymingTime, dialup=dialup, etcUpgradeServer=etcUpgradeServer, tymingStatus=tymingStatus, ntpSysRootDelay=ntpSysRootDelay, symmTTM=symmTTM, version=version, PYSNMP_MODULE_ID=symmetricom, experiment=experiment, ts2000=ts2000, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysVersion=ntpSysVersion, xli=xli, syncserver=syncserver, symmCmipManagement=symmCmipManagement, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, ntpSysFreq=ntpSysFreq, ntpSysMode=ntpSysMode, tymingVersion=tymingVersion, gpsPosition=gpsPosition, etcAlarm=etcAlarm, ntpSysClock=ntpSysClock, gpsUTCOffset=gpsUTCOffset, gpsMode=gpsMode, ntpSysPeer=ntpSysPeer, tyming=tyming, etcAlarmString=etcAlarmString, ts2100=ts2100, etcVersion=etcVersion, symmetricom=symmetricom, etcSerialNbr=etcSerialNbr, net=net, ntpSystem=ntpSystem, ntpSysError=ntpSysError, etc=etc, ntpSysSystem=ntpSysSystem, symmTimePictra=symmTimePictra, symmNetworkManagement=symmNetworkManagement, ntpSysNotrust=ntpSysNotrust, s100=s100, ntpSysLeap=ntpSysLeap, ntpSysPoll=ntpSysPoll, products=products, ntpSysPrecision=ntpSysPrecision, ntpSysRefTime=ntpSysRefTime, ntpSysPhase=ntpSysPhase, ntpSysProcessor=ntpSysProcessor, symmBroadband=symmBroadband, tymingSource=tymingSource, etcModel=etcModel, ntpSysStratum=ntpSysStratum, gps=gps)
