...
MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Bits, Counter64, NotificationType, NotificationType, ObjectIdentity, Gauge32, IpAddress, Unsigned32, enterprises, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Bits", "Counter64", "NotificationType", "NotificationType", "ObjectIdentity", "Gauge32", "IpAddress", "Unsigned32", "enterprises", "Integer32", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", s100=s100, ntpSysSystem=ntpSysSystem, tymingStatus=tymingStatus, symmBroadband=symmBroadband, ntpSysPeer=ntpSysPeer, ntpSysPrecision=ntpSysPrecision, ntpSysNotrust=ntpSysNotrust, gps=gps, ts2100=ts2100, products=products, ntpSysPktsReceived=ntpSysPktsReceived, symmTTM=symmTTM, gpsPosition=gpsPosition, dialup=dialup, version=version, tymingVersion=tymingVersion, etcUpgrade=etcUpgrade, ntpSysStratum=ntpSysStratum, ntpSysClock=ntpSysClock, symmSnmpManagement=symmSnmpManagement, net=net, symmetricom=symmetricom, tyming=tyming, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefTime=ntpSysRefTime, ntpSysPhase=ntpSysPhase, etcAlarm=etcAlarm, symmCmipManagement=symmCmipManagement, ntpSysFreq=ntpSysFreq, etcSerialNbr=etcSerialNbr, ntpSystem=ntpSystem, ntpSysPoll=ntpSysPoll, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, ntpSysMode=ntpSysMode, ntpSysRefID=ntpSysRefID, ntpSysVersion=ntpSysVersion, ntpSysLeap=ntpSysLeap, syncserver=syncserver, gpsMode=gpsMode, ntpSysRootDelay=ntpSysRootDelay, etcModel=etcModel, etcAlarmString=etcAlarmString, PYSNMP_MODULE_ID=symmetricom, experiment=experiment, gpsUTCOffset=gpsUTCOffset, tymingTime=tymingTime, gpsSatlist=gpsSatlist, nts=nts, xli=xli, symmNetworkManagement=symmNetworkManagement, ntpSysError=ntpSysError, etc=etc, ntpSysProcessor=ntpSysProcessor, tymingSource=tymingSource, gpsHealth=gpsHealth, tymingFlyPeriod=tymingFlyPeriod, ts2000=ts2000, symmTimePictra=symmTimePictra)
