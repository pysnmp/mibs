...
NotificationType, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Gauge32, Counter64, MibIdentifier, enterprises, ObjectIdentity, IpAddress, Counter32, Unsigned32, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Gauge32", "Counter64", "MibIdentifier", "enterprises", "ObjectIdentity", "IpAddress", "Counter32", "Unsigned32", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", etcVersion=etcVersion, version=version, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, ntpSysRefID=ntpSysRefID, ntpSysStratum=ntpSysStratum, net=net, symmNetworkManagement=symmNetworkManagement, ntpSysPhase=ntpSysPhase, ntpSysMode=ntpSysMode, tymingSource=tymingSource, xli=xli, symmTimePictra=symmTimePictra, tymingTime=tymingTime, etcUpgradeServer=etcUpgradeServer, gpsMode=gpsMode, symmCmipManagement=symmCmipManagement, symmBroadband=symmBroadband, ts2000=ts2000, PYSNMP_MODULE_ID=symmetricom, tyming=tyming, gpsSatlist=gpsSatlist, syncserver=syncserver, etcAlarmString=etcAlarmString, dialup=dialup, etc=etc, products=products, ts2100=ts2100, ntpSysRootDelay=ntpSysRootDelay, ntpSysRootDispersion=ntpSysRootDispersion, etcAlarm=etcAlarm, etcSerialNbr=etcSerialNbr, ntpSystem=ntpSystem, gps=gps, ntpSysRefTime=ntpSysRefTime, nts=nts, ntpSysPoll=ntpSysPoll, ntpSysLeap=ntpSysLeap, ntpSysFreq=ntpSysFreq, gpsHealth=gpsHealth, etcModel=etcModel, ntpSysProcessor=ntpSysProcessor, ntpSysPeer=ntpSysPeer, ntpSysPktsReceived=ntpSysPktsReceived, symmetricom=symmetricom, gpsPosition=gpsPosition, gpsUTCOffset=gpsUTCOffset, ntpSysSystem=ntpSysSystem, experiment=experiment, symmTTM=symmTTM, ntpSysPrecision=ntpSysPrecision, symmSnmpManagement=symmSnmpManagement, s100=s100, ntpSysError=ntpSysError, ntpSysVersion=ntpSysVersion, tymingVersion=tymingVersion, ntpSysNotrust=ntpSysNotrust, ntpSysClock=ntpSysClock, etcUpgrade=etcUpgrade)
