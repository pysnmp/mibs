...
mibBuilder.exportSymbols("SYMM-SMI", symmBroadband=symmBroadband, gpsUTCOffset=gpsUTCOffset, ts2000=ts2000, symmetricom=symmetricom, ntpSysFreq=ntpSysFreq, xli=xli, ntpSysRefID=ntpSysRefID, ntpSysPhase=ntpSysPhase, symmTTM=symmTTM, ntpSysMode=ntpSysMode, gps=gps, ts2100=ts2100, symmCmipManagement=symmCmipManagement, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRefTime=ntpSysRefTime, etcAlarmString=etcAlarmString, ntpSysSystem=ntpSysSystem, gpsMode=gpsMode, tymingTime=tymingTime, etcModel=etcModel, ntpSystem=ntpSystem, PYSNMP_MODULE_ID=symmetricom, tymingSource=tymingSource, products=products, net=net, gpsPosition=gpsPosition, gpsSatlist=gpsSatlist, nts=nts, ntpSysLeap=ntpSysLeap, s100=s100, ntpSysStratum=ntpSysStratum, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, ntpSysRootDelay=ntpSysRootDelay, ntpSysVersion=ntpSysVersion, version=version, tymingStatus=tymingStatus, syncserver=syncserver, etcVersion=etcVersion, experiment=experiment, gpsHealth=gpsHealth, symmTimePictra=symmTimePictra, ntpSysPoll=ntpSysPoll, tymingFlyPeriod=tymingFlyPeriod, ntpSysProcessor=ntpSysProcessor, etc=etc, ntpSysClock=ntpSysClock, symmNetworkManagement=symmNetworkManagement, etcUpgradeServer=etcUpgradeServer, ntpSysPrecision=ntpSysPrecision, dialup=dialup, tyming=tyming, ntpSysPeer=ntpSysPeer, etcSerialNbr=etcSerialNbr, tymingVersion=tymingVersion, etcAlarm=etcAlarm, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysNotrust=ntpSysNotrust, symmSnmpManagement=symmSnmpManagement)
