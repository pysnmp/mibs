...
ModuleIdentity, ObjectIdentity, Gauge32, iso, Counter32, IpAddress, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, NotificationType, NotificationType, enterprises, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Gauge32", "iso", "Counter32", "IpAddress", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "NotificationType", "NotificationType", "enterprises", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefTime=ntpSysRefTime, symmTTM=symmTTM, ntpSysVersion=ntpSysVersion, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysPeer=ntpSysPeer, etcSerialNbr=etcSerialNbr, nts=nts, ntpSysError=ntpSysError, ntpSystem=ntpSystem, ntpSysFreq=ntpSysFreq, ntpSysNotrust=ntpSysNotrust, ntpSysRefID=ntpSysRefID, s100=s100, gpsSatlist=gpsSatlist, ntpSysMode=ntpSysMode, tymingTime=tymingTime, ntpSysPrecision=ntpSysPrecision, symmetricom=symmetricom, tyming=tyming, gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, etcVersion=etcVersion, etcModel=etcModel, ntpSysStratum=ntpSysStratum, ntpSysPoll=ntpSysPoll, net=net, symmSnmpManagement=symmSnmpManagement, tymingFlyPeriod=tymingFlyPeriod, gpsHealth=gpsHealth, xli=xli, experiment=experiment, ntpSysProcessor=ntpSysProcessor, ntpSysLeap=ntpSysLeap, ntpSysClock=ntpSysClock, etcUpgradeServer=etcUpgradeServer, gpsPosition=gpsPosition, tymingStatus=tymingStatus, tymingVersion=tymingVersion, symmTimePictra=symmTimePictra, dialup=dialup, gpsMode=gpsMode, ntpSysRootDelay=ntpSysRootDelay, etcUpgrade=etcUpgrade, ts2100=ts2100, tymingSource=tymingSource, symmNetworkManagement=symmNetworkManagement, ts2000=ts2000, ntpSysPhase=ntpSysPhase, ntpSysSystem=ntpSysSystem, symmBroadband=symmBroadband, syncserver=syncserver, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, gpsUTCOffset=gpsUTCOffset, symmCmipManagement=symmCmipManagement, etc=etc, version=version, products=products, PYSNMP_MODULE_ID=symmetricom)
