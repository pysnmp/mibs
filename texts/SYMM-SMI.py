...
NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, TimeTicks, Counter64, Integer32, Unsigned32, IpAddress, MibIdentifier, Bits, Gauge32, iso, ObjectIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "TimeTicks", "Counter64", "Integer32", "Unsigned32", "IpAddress", "MibIdentifier", "Bits", "Gauge32", "iso", "ObjectIdentity", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysLeap=ntpSysLeap, PYSNMP_MODULE_ID=symmetricom, nts=nts, tymingSource=tymingSource, gpsHealth=gpsHealth, etcUpgrade=etcUpgrade, products=products, gpsPosition=gpsPosition, syncserver=syncserver, symmTTM=symmTTM, ntpSysFreq=ntpSysFreq, ntpSysPktsReceived=ntpSysPktsReceived, tymingFlyPeriod=tymingFlyPeriod, ntpSysRefID=ntpSysRefID, ntpSysMode=ntpSysMode, ntpSystem=ntpSystem, ntpSysSystem=ntpSysSystem, ntpSysVersion=ntpSysVersion, gpsMode=gpsMode, etcSerialNbr=etcSerialNbr, etcUpgradeServer=etcUpgradeServer, ntpSysNotrust=ntpSysNotrust, ntpSysProcessor=ntpSysProcessor, symmTimePictra=symmTimePictra, experiment=experiment, tymingStatus=tymingStatus, ntpSysPeer=ntpSysPeer, xli=xli, ts2000=ts2000, ntpSysRefTime=ntpSysRefTime, ntpSysPhase=ntpSysPhase, s100=s100, ntpSysPoll=ntpSysPoll, tyming=tyming, ntpSysError=ntpSysError, symmSnmpManagement=symmSnmpManagement, symmCmipManagement=symmCmipManagement, version=version, tymingVersion=tymingVersion, gpsUTCOffset=gpsUTCOffset, etcAlarmString=etcAlarmString, etcModel=etcModel, gpsSatlist=gpsSatlist, etcAlarm=etcAlarm, gps=gps, symmNetworkManagement=symmNetworkManagement, ntpSysRootDispersion=ntpSysRootDispersion, etcVersion=etcVersion, symmBroadband=symmBroadband, ntpSysRootDelay=ntpSysRootDelay, ts2100=ts2100, dialup=dialup, etc=etc, net=net, symmetricom=symmetricom, ntpSysClock=ntpSysClock, ntpSysStratum=ntpSysStratum, tymingTime=tymingTime, ntpSysPrecision=ntpSysPrecision)
