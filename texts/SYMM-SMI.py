...
NotificationType, iso, enterprises, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Counter32, ObjectIdentity, Bits, TimeTicks, ModuleIdentity, Unsigned32, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "enterprises", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Counter32", "ObjectIdentity", "Bits", "TimeTicks", "ModuleIdentity", "Unsigned32", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysError=ntpSysError, syncserver=syncserver, gpsSatlist=gpsSatlist, etcSerialNbr=etcSerialNbr, s100=s100, etcModel=etcModel, ntpSysFreq=ntpSysFreq, etcUpgrade=etcUpgrade, xli=xli, ntpSysNotrust=ntpSysNotrust, etc=etc, gps=gps, ntpSysPoll=ntpSysPoll, products=products, etcAlarmString=etcAlarmString, symmNetworkManagement=symmNetworkManagement, ntpSysMode=ntpSysMode, gpsUTCOffset=gpsUTCOffset, ntpSysProcessor=ntpSysProcessor, nts=nts, ntpSysPhase=ntpSysPhase, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefTime=ntpSysRefTime, ntpSysRefID=ntpSysRefID, symmSnmpManagement=symmSnmpManagement, tymingVersion=tymingVersion, etcUpgradeServer=etcUpgradeServer, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysVersion=ntpSysVersion, ts2000=ts2000, ntpSysClock=ntpSysClock, symmBroadband=symmBroadband, tymingSource=tymingSource, PYSNMP_MODULE_ID=symmetricom, ntpSystem=ntpSystem, ntpSysLeap=ntpSysLeap, ntpSysRootDelay=ntpSysRootDelay, tymingTime=tymingTime, symmTimePictra=symmTimePictra, experiment=experiment, version=version, gpsMode=gpsMode, etcVersion=etcVersion, ntpSysSystem=ntpSysSystem, dialup=dialup, ntpSysPrecision=ntpSysPrecision, ntpSysStratum=ntpSysStratum, symmetricom=symmetricom, net=net, tyming=tyming, ntpSysPeer=ntpSysPeer, etcAlarm=etcAlarm, gpsHealth=gpsHealth, symmTTM=symmTTM, ts2100=ts2100, tymingFlyPeriod=tymingFlyPeriod, symmCmipManagement=symmCmipManagement, gpsPosition=gpsPosition, tymingStatus=tymingStatus)
