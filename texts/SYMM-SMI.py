...
NotificationType, Gauge32, MibIdentifier, enterprises, Bits, NotificationType, iso, TimeTicks, Unsigned32, ObjectIdentity, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibIdentifier", "enterprises", "Bits", "NotificationType", "iso", "TimeTicks", "Unsigned32", "ObjectIdentity", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysVersion=ntpSysVersion, gpsPosition=gpsPosition, ntpSysRefTime=ntpSysRefTime, symmetricom=symmetricom, gpsHealth=gpsHealth, net=net, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, etc=etc, tymingStatus=tymingStatus, ntpSysNotrust=ntpSysNotrust, symmNetworkManagement=symmNetworkManagement, symmCmipManagement=symmCmipManagement, ntpSysRootDispersion=ntpSysRootDispersion, products=products, symmSnmpManagement=symmSnmpManagement, gpsUTCOffset=gpsUTCOffset, symmBroadband=symmBroadband, xli=xli, tyming=tyming, nts=nts, etcModel=etcModel, ts2000=ts2000, ntpSysRootDelay=ntpSysRootDelay, ntpSysStratum=ntpSysStratum, ntpSysError=ntpSysError, etcAlarm=etcAlarm, ntpSysPrecision=ntpSysPrecision, ntpSysFreq=ntpSysFreq, etcVersion=etcVersion, PYSNMP_MODULE_ID=symmetricom, symmTimePictra=symmTimePictra, etcUpgrade=etcUpgrade, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, ntpSysPhase=ntpSysPhase, dialup=dialup, experiment=experiment, version=version, ts2100=ts2100, syncserver=syncserver, ntpSysLeap=ntpSysLeap, s100=s100, tymingTime=tymingTime, ntpSysSystem=ntpSysSystem, tymingVersion=tymingVersion, gpsMode=gpsMode, gpsSatlist=gpsSatlist, etcSerialNbr=etcSerialNbr, etcUpgradeServer=etcUpgradeServer, symmTTM=symmTTM, ntpSysRefID=ntpSysRefID, ntpSysMode=ntpSysMode, etcAlarmString=etcAlarmString, tymingFlyPeriod=tymingFlyPeriod, ntpSystem=ntpSystem, gps=gps, ntpSysPeer=ntpSysPeer, ntpSysPktsReceived=ntpSysPktsReceived)
