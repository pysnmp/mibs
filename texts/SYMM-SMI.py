...
mibBuilder.exportSymbols("SYMM-SMI", symmNetworkManagement=symmNetworkManagement, ntpSysRootDispersion=ntpSysRootDispersion, etcVersion=etcVersion, symmetricom=symmetricom, symmTimePictra=symmTimePictra, etcAlarm=etcAlarm, s100=s100, xli=xli, etcSerialNbr=etcSerialNbr, gps=gps, etcModel=etcModel, ts2000=ts2000, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, experiment=experiment, tyming=tyming, ntpSysPeer=ntpSysPeer, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgrade=etcUpgrade, ntpSysPoll=ntpSysPoll, ntpSysProcessor=ntpSysProcessor, ntpSysPhase=ntpSysPhase, symmCmipManagement=symmCmipManagement, ts2100=ts2100, syncserver=syncserver, nts=nts, ntpSysClock=ntpSysClock, gpsMode=gpsMode, gpsHealth=gpsHealth, ntpSysNotrust=ntpSysNotrust, tymingStatus=tymingStatus, ntpSysError=ntpSysError, PYSNMP_MODULE_ID=symmetricom, net=net, ntpSysVersion=ntpSysVersion, tymingTime=tymingTime, symmTTM=symmTTM, gpsUTCOffset=gpsUTCOffset, version=version, ntpSysLeap=ntpSysLeap, tymingVersion=tymingVersion, ntpSysRefID=ntpSysRefID, ntpSystem=ntpSystem, tymingFlyPeriod=tymingFlyPeriod, etcAlarmString=etcAlarmString, dialup=dialup, ntpSysFreq=ntpSysFreq, ntpSysStratum=ntpSysStratum, ntpSysMode=ntpSysMode, gpsPosition=gpsPosition, etcUpgradeServer=etcUpgradeServer, symmSnmpManagement=symmSnmpManagement, ntpSysRefTime=ntpSysRefTime, tymingSource=tymingSource, products=products, etc=etc, gpsSatlist=gpsSatlist, symmBroadband=symmBroadband, ntpSysRootDelay=ntpSysRootDelay)
