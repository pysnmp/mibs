...
Gauge32, NotificationType, ModuleIdentity, Counter64, NotificationType, ObjectIdentity, iso, enterprises, MibIdentifier, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "ModuleIdentity", "Counter64", "NotificationType", "ObjectIdentity", "iso", "enterprises", "MibIdentifier", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsMode=gpsMode, etcModel=etcModel, ntpSysStratum=ntpSysStratum, tymingTime=tymingTime, tymingSource=tymingSource, gpsHealth=gpsHealth, symmTimePictra=symmTimePictra, ntpSysFreq=ntpSysFreq, ntpSysRootDelay=ntpSysRootDelay, net=net, ntpSysPeer=ntpSysPeer, ts2000=ts2000, gpsPosition=gpsPosition, ntpSysPhase=ntpSysPhase, ts2100=ts2100, ntpSysClock=ntpSysClock, gpsSatlist=gpsSatlist, symmetricom=symmetricom, etcUpgradeServer=etcUpgradeServer, etcVersion=etcVersion, etcAlarm=etcAlarm, experiment=experiment, ntpSystem=ntpSystem, ntpSysSystem=ntpSysSystem, etc=etc, ntpSysPoll=ntpSysPoll, symmBroadband=symmBroadband, ntpSysPktsReceived=ntpSysPktsReceived, PYSNMP_MODULE_ID=symmetricom, syncserver=syncserver, dialup=dialup, tyming=tyming, symmTTM=symmTTM, ntpSysRefID=ntpSysRefID, etcAlarmString=etcAlarmString, ntpSysRootDispersion=ntpSysRootDispersion, nts=nts, products=products, ntpSysVersion=ntpSysVersion, symmCmipManagement=symmCmipManagement, gps=gps, gpsUTCOffset=gpsUTCOffset, etcUpgrade=etcUpgrade, ntpSysPrecision=ntpSysPrecision, ntpSysNotrust=ntpSysNotrust, etcSerialNbr=etcSerialNbr, tymingFlyPeriod=tymingFlyPeriod, ntpSysRefTime=ntpSysRefTime, tymingVersion=tymingVersion, symmSnmpManagement=symmSnmpManagement, symmNetworkManagement=symmNetworkManagement, ntpSysMode=ntpSysMode, s100=s100, ntpSysError=ntpSysError, tymingStatus=tymingStatus, xli=xli, version=version, ntpSysProcessor=ntpSysProcessor, ntpSysLeap=ntpSysLeap)
