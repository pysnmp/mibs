...
TimeTicks, Counter64, IpAddress, Bits, Integer32, ObjectIdentity, NotificationType, ModuleIdentity, Unsigned32, NotificationType, MibIdentifier, Gauge32, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "IpAddress", "Bits", "Integer32", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Unsigned32", "NotificationType", "MibIdentifier", "Gauge32", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsUTCOffset=gpsUTCOffset, symmTimePictra=symmTimePictra, symmTTM=symmTTM, etc=etc, syncserver=syncserver, version=version, ntpSysPktsReceived=ntpSysPktsReceived, tyming=tyming, net=net, experiment=experiment, ts2100=ts2100, ntpSysClock=ntpSysClock, tymingSource=tymingSource, ts2000=ts2000, PYSNMP_MODULE_ID=symmetricom, tymingFlyPeriod=tymingFlyPeriod, symmCmipManagement=symmCmipManagement, ntpSysLeap=ntpSysLeap, gpsSatlist=gpsSatlist, etcSerialNbr=etcSerialNbr, ntpSysProcessor=ntpSysProcessor, symmBroadband=symmBroadband, etcVersion=etcVersion, ntpSysRootDelay=ntpSysRootDelay, ntpSysMode=ntpSysMode, ntpSysNotrust=ntpSysNotrust, etcAlarmString=etcAlarmString, tymingTime=tymingTime, symmNetworkManagement=symmNetworkManagement, ntpSysVersion=ntpSysVersion, ntpSysRefTime=ntpSysRefTime, tymingStatus=tymingStatus, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, etcAlarm=etcAlarm, ntpSysRefID=ntpSysRefID, ntpSysPhase=ntpSysPhase, nts=nts, ntpSysPoll=ntpSysPoll, gpsPosition=gpsPosition, products=products, etcUpgradeServer=etcUpgradeServer, ntpSysRootDispersion=ntpSysRootDispersion, gpsMode=gpsMode, ntpSysStratum=ntpSysStratum, dialup=dialup, ntpSysFreq=ntpSysFreq, symmSnmpManagement=symmSnmpManagement, ntpSystem=ntpSystem, ntpSysPeer=ntpSysPeer, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, s100=s100, etcModel=etcModel, gpsHealth=gpsHealth, symmetricom=symmetricom, gps=gps, tymingVersion=tymingVersion, xli=xli)
