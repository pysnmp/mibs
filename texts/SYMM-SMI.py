...
NotificationType, iso, enterprises, TimeTicks, Integer32, Counter64, Counter32, ModuleIdentity, MibIdentifier, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "enterprises", "TimeTicks", "Integer32", "Counter64", "Counter32", "ModuleIdentity", "MibIdentifier", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", etcSerialNbr=etcSerialNbr, version=version, ntpSystem=ntpSystem, etcUpgrade=etcUpgrade, etcAlarmString=etcAlarmString, ntpSysFreq=ntpSysFreq, gpsPosition=gpsPosition, ts2100=ts2100, symmSnmpManagement=symmSnmpManagement, ntpSysMode=ntpSysMode, ntpSysSystem=ntpSysSystem, symmetricom=symmetricom, dialup=dialup, ntpSysPeer=ntpSysPeer, ntpSysError=ntpSysError, tymingFlyPeriod=tymingFlyPeriod, PYSNMP_MODULE_ID=symmetricom, symmTTM=symmTTM, net=net, ntpSysLeap=ntpSysLeap, ntpSysStratum=ntpSysStratum, tymingTime=tymingTime, experiment=experiment, products=products, symmBroadband=symmBroadband, ntpSysRootDelay=ntpSysRootDelay, etcVersion=etcVersion, xli=xli, ntpSysPoll=ntpSysPoll, tymingStatus=tymingStatus, ntpSysNotrust=ntpSysNotrust, tymingSource=tymingSource, ts2000=ts2000, gpsHealth=gpsHealth, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, ntpSysVersion=ntpSysVersion, ntpSysPhase=ntpSysPhase, etcUpgradeServer=etcUpgradeServer, ntpSysPrecision=ntpSysPrecision, etcAlarm=etcAlarm, etc=etc, gps=gps, gpsUTCOffset=gpsUTCOffset, symmCmipManagement=symmCmipManagement, symmTimePictra=symmTimePictra, syncserver=syncserver, tyming=tyming, gpsSatlist=gpsSatlist, etcModel=etcModel, ntpSysRefID=ntpSysRefID, ntpSysRefTime=ntpSysRefTime, nts=nts, tymingVersion=tymingVersion, ntpSysRootDispersion=ntpSysRootDispersion, gpsMode=gpsMode, s100=s100, symmNetworkManagement=symmNetworkManagement, ntpSysPktsReceived=ntpSysPktsReceived)
