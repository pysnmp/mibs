...
TimeTicks, enterprises, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, NotificationType, ObjectIdentity, NotificationType, IpAddress, Integer32, Bits, MibIdentifier, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "NotificationType", "ObjectIdentity", "NotificationType", "IpAddress", "Integer32", "Bits", "MibIdentifier", "Counter64", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSystem=ntpSystem, tymingVersion=tymingVersion, net=net, tymingStatus=tymingStatus, ts2100=ts2100, ntpSysRefID=ntpSysRefID, gpsHealth=gpsHealth, ntpSysPoll=ntpSysPoll, symmNetworkManagement=symmNetworkManagement, experiment=experiment, tymingFlyPeriod=tymingFlyPeriod, etc=etc, gpsSatlist=gpsSatlist, gps=gps, ntpSysLeap=ntpSysLeap, ntpSysError=ntpSysError, ntpSysProcessor=ntpSysProcessor, etcAlarmString=etcAlarmString, etcVersion=etcVersion, symmTTM=symmTTM, PYSNMP_MODULE_ID=symmetricom, s100=s100, symmetricom=symmetricom, xli=xli, ntpSysMode=ntpSysMode, tymingSource=tymingSource, etcUpgrade=etcUpgrade, dialup=dialup, etcUpgradeServer=etcUpgradeServer, ntpSysPrecision=ntpSysPrecision, ntpSysVersion=ntpSysVersion, ts2000=ts2000, symmBroadband=symmBroadband, etcAlarm=etcAlarm, ntpSysClock=ntpSysClock, ntpSysRefTime=ntpSysRefTime, symmCmipManagement=symmCmipManagement, ntpSysStratum=ntpSysStratum, gpsUTCOffset=gpsUTCOffset, gpsPosition=gpsPosition, etcModel=etcModel, products=products, tymingTime=tymingTime, nts=nts, symmSnmpManagement=symmSnmpManagement, tyming=tyming, version=version, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysPeer=ntpSysPeer, ntpSysFreq=ntpSysFreq, ntpSysSystem=ntpSysSystem, ntpSysRootDispersion=ntpSysRootDispersion, syncserver=syncserver, symmTimePictra=symmTimePictra, ntpSysRootDelay=ntpSysRootDelay, ntpSysNotrust=ntpSysNotrust, gpsMode=gpsMode, etcSerialNbr=etcSerialNbr, ntpSysPhase=ntpSysPhase)
