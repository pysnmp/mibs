...
Bits, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, MibIdentifier, TimeTicks, IpAddress, iso, enterprises, ModuleIdentity, ObjectIdentity, NotificationType, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "MibIdentifier", "TimeTicks", "IpAddress", "iso", "enterprises", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("SYMM-SMI", symmTimePictra=symmTimePictra, etcUpgradeServer=etcUpgradeServer, ts2100=ts2100, symmTTM=symmTTM, gpsMode=gpsMode, etcModel=etcModel, dialup=dialup, ntpSysNotrust=ntpSysNotrust, PYSNMP_MODULE_ID=symmetricom, version=version, xli=xli, ntpSysPktsReceived=ntpSysPktsReceived, syncserver=syncserver, symmetricom=symmetricom, etcVersion=etcVersion, ntpSysRootDelay=ntpSysRootDelay, ntpSysPoll=ntpSysPoll, tymingFlyPeriod=tymingFlyPeriod, tyming=tyming, ntpSysProcessor=ntpSysProcessor, gpsHealth=gpsHealth, ntpSysPrecision=ntpSysPrecision, symmBroadband=symmBroadband, ntpSysRefID=ntpSysRefID, ntpSysMode=ntpSysMode, ntpSysStratum=ntpSysStratum, ntpSysPeer=ntpSysPeer, tymingVersion=tymingVersion, ntpSysClock=ntpSysClock, gpsPosition=gpsPosition, ntpSysRefTime=ntpSysRefTime, ntpSysSystem=ntpSysSystem, gpsSatlist=gpsSatlist, etcAlarmString=etcAlarmString, ntpSysRootDispersion=ntpSysRootDispersion, net=net, symmNetworkManagement=symmNetworkManagement, gps=gps, ts2000=ts2000, tymingSource=tymingSource, ntpSysFreq=ntpSysFreq, etcSerialNbr=etcSerialNbr, s100=s100, gpsUTCOffset=gpsUTCOffset, experiment=experiment, symmCmipManagement=symmCmipManagement, etc=etc, ntpSysVersion=ntpSysVersion, ntpSysError=ntpSysError, tymingTime=tymingTime, etcAlarm=etcAlarm, tymingStatus=tymingStatus, ntpSysPhase=ntpSysPhase, etcUpgrade=etcUpgrade, ntpSystem=ntpSystem, symmSnmpManagement=symmSnmpManagement, nts=nts, ntpSysLeap=ntpSysLeap, products=products)
