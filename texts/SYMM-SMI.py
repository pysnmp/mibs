...
enterprises, Bits, ModuleIdentity, Unsigned32, NotificationType, TimeTicks, NotificationType, Gauge32, ObjectIdentity, IpAddress, iso, Counter32, MibIdentifier, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "ModuleIdentity", "Unsigned32", "NotificationType", "TimeTicks", "NotificationType", "Gauge32", "ObjectIdentity", "IpAddress", "iso", "Counter32", "MibIdentifier", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", symmBroadband=symmBroadband, syncserver=syncserver, etcModel=etcModel, dialup=dialup, ntpSysRefID=ntpSysRefID, symmTimePictra=symmTimePictra, symmCmipManagement=symmCmipManagement, gpsSatlist=gpsSatlist, tyming=tyming, etcUpgrade=etcUpgrade, ntpSysClock=ntpSysClock, tymingStatus=tymingStatus, symmetricom=symmetricom, net=net, ntpSysRefTime=ntpSysRefTime, ntpSystem=ntpSystem, ntpSysNotrust=ntpSysNotrust, tymingSource=tymingSource, ntpSysMode=ntpSysMode, gpsHealth=gpsHealth, etcSerialNbr=etcSerialNbr, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysProcessor=ntpSysProcessor, tymingTime=tymingTime, gpsUTCOffset=gpsUTCOffset, ntpSysStratum=ntpSysStratum, ntpSysPeer=ntpSysPeer, PYSNMP_MODULE_ID=symmetricom, ts2000=ts2000, ntpSysRootDelay=ntpSysRootDelay, s100=s100, version=version, ntpSysFreq=ntpSysFreq, experiment=experiment, ntpSysPoll=ntpSysPoll, gpsMode=gpsMode, ntpSysPhase=ntpSysPhase, ntpSysVersion=ntpSysVersion, etcAlarm=etcAlarm, gps=gps, ntpSysLeap=ntpSysLeap, gpsPosition=gpsPosition, nts=nts, ntpSysError=ntpSysError, xli=xli, ntpSysPrecision=ntpSysPrecision, etcUpgradeServer=etcUpgradeServer, symmSnmpManagement=symmSnmpManagement, ts2100=ts2100, etc=etc, tymingFlyPeriod=tymingFlyPeriod, symmTTM=symmTTM, ntpSysPktsReceived=ntpSysPktsReceived, tymingVersion=tymingVersion, etcVersion=etcVersion, etcAlarmString=etcAlarmString, symmNetworkManagement=symmNetworkManagement, ntpSysSystem=ntpSysSystem, products=products)
