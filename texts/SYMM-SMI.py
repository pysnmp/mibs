...
Counter64, IpAddress, MibIdentifier, enterprises, iso, TimeTicks, Gauge32, ObjectIdentity, Integer32, Unsigned32, Counter32, NotificationType, Bits, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "MibIdentifier", "enterprises", "iso", "TimeTicks", "Gauge32", "ObjectIdentity", "Integer32", "Unsigned32", "Counter32", "NotificationType", "Bits", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysVersion=ntpSysVersion, ntpSysPoll=ntpSysPoll, tymingStatus=tymingStatus, symmTimePictra=symmTimePictra, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRootDelay=ntpSysRootDelay, etcSerialNbr=etcSerialNbr, gpsPosition=gpsPosition, tymingSource=tymingSource, etcAlarmString=etcAlarmString, products=products, ntpSysPhase=ntpSysPhase, ntpSysMode=ntpSysMode, tyming=tyming, ntpSysNotrust=ntpSysNotrust, etcAlarm=etcAlarm, ntpSysPeer=ntpSysPeer, symmBroadband=symmBroadband, dialup=dialup, ntpSysPrecision=ntpSysPrecision, tymingFlyPeriod=tymingFlyPeriod, symmNetworkManagement=symmNetworkManagement, gpsUTCOffset=gpsUTCOffset, net=net, ts2100=ts2100, ntpSysRefTime=ntpSysRefTime, experiment=experiment, ntpSystem=ntpSystem, ts2000=ts2000, ntpSysClock=ntpSysClock, tymingTime=tymingTime, gpsMode=gpsMode, symmSnmpManagement=symmSnmpManagement, gpsHealth=gpsHealth, ntpSysProcessor=ntpSysProcessor, ntpSysStratum=ntpSysStratum, ntpSysPktsReceived=ntpSysPktsReceived, version=version, nts=nts, etc=etc, gpsSatlist=gpsSatlist, s100=s100, etcUpgrade=etcUpgrade, etcVersion=etcVersion, ntpSysLeap=ntpSysLeap, symmetricom=symmetricom, ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, ntpSysFreq=ntpSysFreq, symmCmipManagement=symmCmipManagement, tymingVersion=tymingVersion, etcUpgradeServer=etcUpgradeServer, ntpSysRefID=ntpSysRefID, gps=gps, PYSNMP_MODULE_ID=symmetricom, syncserver=syncserver, symmTTM=symmTTM, etcModel=etcModel, xli=xli)
