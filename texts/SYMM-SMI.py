...
mibBuilder.exportSymbols("SYMM-SMI", nts=nts, tymingVersion=tymingVersion, gpsHealth=gpsHealth, ntpSysStratum=ntpSysStratum, symmNetworkManagement=symmNetworkManagement, ntpSysLeap=ntpSysLeap, symmSnmpManagement=symmSnmpManagement, s100=s100, ts2000=ts2000, products=products, gps=gps, etcAlarmString=etcAlarmString, ntpSysPeer=ntpSysPeer, gpsMode=gpsMode, symmCmipManagement=symmCmipManagement, syncserver=syncserver, dialup=dialup, etcVersion=etcVersion, etcUpgrade=etcUpgrade, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPrecision=ntpSysPrecision, version=version, ntpSysVersion=ntpSysVersion, etcSerialNbr=etcSerialNbr, xli=xli, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, ntpSysClock=ntpSysClock, ntpSysMode=ntpSysMode, ntpSysError=ntpSysError, symmBroadband=symmBroadband, ntpSysFreq=ntpSysFreq, net=net, ntpSysPktsReceived=ntpSysPktsReceived, gpsSatlist=gpsSatlist, experiment=experiment, tymingFlyPeriod=tymingFlyPeriod, etcAlarm=etcAlarm, ntpSysNotrust=ntpSysNotrust, ntpSysRefID=ntpSysRefID, etcModel=etcModel, ntpSystem=ntpSystem, ntpSysProcessor=ntpSysProcessor, tyming=tyming, ntpSysRefTime=ntpSysRefTime, ntpSysRootDelay=ntpSysRootDelay, ts2100=ts2100, gpsPosition=gpsPosition, etc=etc, gpsUTCOffset=gpsUTCOffset, ntpSysPoll=ntpSysPoll, symmTimePictra=symmTimePictra, tymingSource=tymingSource, PYSNMP_MODULE_ID=symmetricom, tymingTime=tymingTime, ntpSysSystem=ntpSysSystem, etcUpgradeServer=etcUpgradeServer, symmetricom=symmetricom, tymingStatus=tymingStatus)
