...
NotificationType, Gauge32, Counter32, enterprises, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Counter64, Bits, NotificationType, Integer32, TimeTicks, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter32", "enterprises", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Counter64", "Bits", "NotificationType", "Integer32", "TimeTicks", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysMode=ntpSysMode, ntpSysPrecision=ntpSysPrecision, ntpSysRootDelay=ntpSysRootDelay, etcVersion=etcVersion, ntpSysRefTime=ntpSysRefTime, nts=nts, symmCmipManagement=symmCmipManagement, etc=etc, tymingFlyPeriod=tymingFlyPeriod, etcAlarmString=etcAlarmString, ntpSysPeer=ntpSysPeer, etcAlarm=etcAlarm, etcUpgradeServer=etcUpgradeServer, experiment=experiment, gpsHealth=gpsHealth, symmTTM=symmTTM, tymingStatus=tymingStatus, ntpSysProcessor=ntpSysProcessor, tymingVersion=tymingVersion, tyming=tyming, ntpSysSystem=ntpSysSystem, version=version, ntpSysPhase=ntpSysPhase, ntpSysRefID=ntpSysRefID, ntpSysRootDispersion=ntpSysRootDispersion, ntpSystem=ntpSystem, gpsSatlist=gpsSatlist, products=products, gps=gps, xli=xli, etcUpgrade=etcUpgrade, gpsMode=gpsMode, syncserver=syncserver, ntpSysVersion=ntpSysVersion, etcModel=etcModel, symmetricom=symmetricom, ntpSysError=ntpSysError, PYSNMP_MODULE_ID=symmetricom, symmTimePictra=symmTimePictra, s100=s100, symmSnmpManagement=symmSnmpManagement, ts2100=ts2100, tymingTime=tymingTime, tymingSource=tymingSource, ntpSysClock=ntpSysClock, ntpSysLeap=ntpSysLeap, symmNetworkManagement=symmNetworkManagement, symmBroadband=symmBroadband, ts2000=ts2000, ntpSysStratum=ntpSysStratum, ntpSysNotrust=ntpSysNotrust, ntpSysFreq=ntpSysFreq, ntpSysPktsReceived=ntpSysPktsReceived, gpsPosition=gpsPosition, dialup=dialup, ntpSysPoll=ntpSysPoll, gpsUTCOffset=gpsUTCOffset, etcSerialNbr=etcSerialNbr, net=net)
