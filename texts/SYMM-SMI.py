...
iso, ModuleIdentity, MibIdentifier, ObjectIdentity, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Bits, NotificationType, NotificationType, Gauge32, TimeTicks, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "MibIdentifier", "ObjectIdentity", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Bits", "NotificationType", "NotificationType", "Gauge32", "TimeTicks", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("SYMM-SMI", etcUpgradeServer=etcUpgradeServer, PYSNMP_MODULE_ID=symmetricom, ntpSysNotrust=ntpSysNotrust, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysLeap=ntpSysLeap, nts=nts, ntpSysRefTime=ntpSysRefTime, gpsPosition=gpsPosition, symmBroadband=symmBroadband, symmTTM=symmTTM, ntpSysRootDelay=ntpSysRootDelay, syncserver=syncserver, ntpSysStratum=ntpSysStratum, gpsMode=gpsMode, net=net, etcSerialNbr=etcSerialNbr, ts2100=ts2100, etcAlarmString=etcAlarmString, xli=xli, etc=etc, ntpSysVersion=ntpSysVersion, ntpSystem=ntpSystem, products=products, etcUpgrade=etcUpgrade, ntpSysFreq=ntpSysFreq, tyming=tyming, tymingStatus=tymingStatus, ntpSysClock=ntpSysClock, ntpSysPhase=ntpSysPhase, tymingSource=tymingSource, version=version, etcVersion=etcVersion, ntpSysRefID=ntpSysRefID, etcAlarm=etcAlarm, gps=gps, s100=s100, ts2000=ts2000, ntpSysError=ntpSysError, ntpSysPrecision=ntpSysPrecision, experiment=experiment, ntpSysProcessor=ntpSysProcessor, ntpSysMode=ntpSysMode, tymingFlyPeriod=tymingFlyPeriod, ntpSysSystem=ntpSysSystem, symmCmipManagement=symmCmipManagement, tymingTime=tymingTime, gpsSatlist=gpsSatlist, gpsUTCOffset=gpsUTCOffset, ntpSysPoll=ntpSysPoll, symmSnmpManagement=symmSnmpManagement, symmetricom=symmetricom, dialup=dialup, ntpSysRootDispersion=ntpSysRootDispersion, etcModel=etcModel, symmTimePictra=symmTimePictra, symmNetworkManagement=symmNetworkManagement, gpsHealth=gpsHealth, tymingVersion=tymingVersion, ntpSysPeer=ntpSysPeer)
