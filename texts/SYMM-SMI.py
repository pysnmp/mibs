...
Counter64, Bits, TimeTicks, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Counter32, ObjectIdentity, NotificationType, NotificationType, Gauge32, enterprises, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "TimeTicks", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Counter32", "ObjectIdentity", "NotificationType", "NotificationType", "Gauge32", "enterprises", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, ntpSysError=ntpSysError, ntpSysMode=ntpSysMode, ntpSysRootDelay=ntpSysRootDelay, symmCmipManagement=symmCmipManagement, symmTimePictra=symmTimePictra, symmBroadband=symmBroadband, gpsSatlist=gpsSatlist, tymingStatus=tymingStatus, ntpSysPrecision=ntpSysPrecision, ntpSysNotrust=ntpSysNotrust, etcUpgrade=etcUpgrade, etcAlarm=etcAlarm, gpsHealth=gpsHealth, tyming=tyming, ntpSysFreq=ntpSysFreq, etcSerialNbr=etcSerialNbr, ntpSysPhase=ntpSysPhase, etcModel=etcModel, ts2000=ts2000, xli=xli, experiment=experiment, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPoll=ntpSysPoll, symmTTM=symmTTM, symmSnmpManagement=symmSnmpManagement, symmetricom=symmetricom, ntpSysVersion=ntpSysVersion, gps=gps, version=version, etcVersion=etcVersion, ntpSystem=ntpSystem, ntpSysLeap=ntpSysLeap, ntpSysRefTime=ntpSysRefTime, tymingVersion=tymingVersion, tymingFlyPeriod=tymingFlyPeriod, gpsMode=gpsMode, ntpSysStratum=ntpSysStratum, tymingSource=tymingSource, s100=s100, symmNetworkManagement=symmNetworkManagement, ts2100=ts2100, net=net, ntpSysRefID=ntpSysRefID, etcUpgradeServer=etcUpgradeServer, ntpSysClock=ntpSysClock, gpsPosition=gpsPosition, nts=nts, ntpSysProcessor=ntpSysProcessor, etcAlarmString=etcAlarmString, products=products, tymingTime=tymingTime, ntpSysSystem=ntpSysSystem, gpsUTCOffset=gpsUTCOffset, syncserver=syncserver, ntpSysPeer=ntpSysPeer, dialup=dialup, PYSNMP_MODULE_ID=symmetricom, etc=etc)
