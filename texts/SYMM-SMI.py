...
Gauge32, Counter32, ModuleIdentity, iso, TimeTicks, NotificationType, MibIdentifier, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, ObjectIdentity, NotificationType, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "ModuleIdentity", "iso", "TimeTicks", "NotificationType", "MibIdentifier", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "ObjectIdentity", "NotificationType", "enterprises", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", symmTimePictra=symmTimePictra, symmetricom=symmetricom, etc=etc, gpsPosition=gpsPosition, s100=s100, ntpSysPeer=ntpSysPeer, gpsMode=gpsMode, ntpSysLeap=ntpSysLeap, symmNetworkManagement=symmNetworkManagement, ntpSysPktsReceived=ntpSysPktsReceived, net=net, ts2000=ts2000, symmBroadband=symmBroadband, symmCmipManagement=symmCmipManagement, etcUpgrade=etcUpgrade, ntpSysRootDelay=ntpSysRootDelay, ntpSysNotrust=ntpSysNotrust, dialup=dialup, PYSNMP_MODULE_ID=symmetricom, ntpSysRefID=ntpSysRefID, nts=nts, ntpSysVersion=ntpSysVersion, tyming=tyming, ntpSysMode=ntpSysMode, etcUpgradeServer=etcUpgradeServer, tymingStatus=tymingStatus, xli=xli, ntpSysClock=ntpSysClock, experiment=experiment, ntpSysStratum=ntpSysStratum, products=products, etcVersion=etcVersion, ntpSysPrecision=ntpSysPrecision, etcAlarmString=etcAlarmString, symmTTM=symmTTM, ntpSysRootDispersion=ntpSysRootDispersion, etcAlarm=etcAlarm, ts2100=ts2100, ntpSysRefTime=ntpSysRefTime, ntpSysFreq=ntpSysFreq, syncserver=syncserver, ntpSysError=ntpSysError, etcSerialNbr=etcSerialNbr, symmSnmpManagement=symmSnmpManagement, tymingTime=tymingTime, gpsHealth=gpsHealth, gpsUTCOffset=gpsUTCOffset, version=version, ntpSystem=ntpSystem, ntpSysPhase=ntpSysPhase, tymingSource=tymingSource, gpsSatlist=gpsSatlist, etcModel=etcModel, gps=gps, ntpSysProcessor=ntpSysProcessor, ntpSysSystem=ntpSysSystem, tymingVersion=tymingVersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysPoll=ntpSysPoll)
