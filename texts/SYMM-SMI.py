...
mibBuilder.exportSymbols("SYMM-SMI", xli=xli, products=products, ntpSysPktsReceived=ntpSysPktsReceived, gpsUTCOffset=gpsUTCOffset, ntpSysClock=ntpSysClock, gpsPosition=gpsPosition, nts=nts, ntpSysPhase=ntpSysPhase, ntpSysMode=ntpSysMode, gpsHealth=gpsHealth, gpsSatlist=gpsSatlist, ntpSysNotrust=ntpSysNotrust, s100=s100, ntpSysRefID=ntpSysRefID, etcModel=etcModel, ntpSystem=ntpSystem, ntpSysStratum=ntpSysStratum, etcAlarmString=etcAlarmString, symmBroadband=symmBroadband, experiment=experiment, PYSNMP_MODULE_ID=symmetricom, tyming=tyming, etcSerialNbr=etcSerialNbr, symmTTM=symmTTM, etc=etc, ntpSysLeap=ntpSysLeap, etcUpgrade=etcUpgrade, ts2100=ts2100, gpsMode=gpsMode, etcVersion=etcVersion, tymingFlyPeriod=tymingFlyPeriod, tymingVersion=tymingVersion, version=version, ntpSysProcessor=ntpSysProcessor, tymingStatus=tymingStatus, ntpSysVersion=ntpSysVersion, ntpSysFreq=ntpSysFreq, syncserver=syncserver, etcUpgradeServer=etcUpgradeServer, ntpSysPeer=ntpSysPeer, ntpSysSystem=ntpSysSystem, tymingTime=tymingTime, symmCmipManagement=symmCmipManagement, symmTimePictra=symmTimePictra, ntpSysRootDelay=ntpSysRootDelay, gps=gps, net=net, symmetricom=symmetricom, ntpSysPoll=ntpSysPoll, ntpSysRefTime=ntpSysRefTime, ts2000=ts2000, dialup=dialup, tymingSource=tymingSource, symmSnmpManagement=symmSnmpManagement, etcAlarm=etcAlarm, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPrecision=ntpSysPrecision, symmNetworkManagement=symmNetworkManagement, ntpSysError=ntpSysError)
