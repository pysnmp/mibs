...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, ObjectIdentity, IpAddress, Integer32, TimeTicks, MibIdentifier, NotificationType, iso, Counter32, ModuleIdentity, Unsigned32, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "ObjectIdentity", "IpAddress", "Integer32", "TimeTicks", "MibIdentifier", "NotificationType", "iso", "Counter32", "ModuleIdentity", "Unsigned32", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", tymingSource=tymingSource, ntpSysSystem=ntpSysSystem, ntpSysPhase=ntpSysPhase, tymingTime=tymingTime, gpsHealth=gpsHealth, symmTimePictra=symmTimePictra, ntpSysStratum=ntpSysStratum, dialup=dialup, ntpSysProcessor=ntpSysProcessor, etcAlarmString=etcAlarmString, ntpSysLeap=ntpSysLeap, etcSerialNbr=etcSerialNbr, symmBroadband=symmBroadband, ts2000=ts2000, ntpSysRootDelay=ntpSysRootDelay, ntpSysNotrust=ntpSysNotrust, syncserver=syncserver, symmetricom=symmetricom, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, etcVersion=etcVersion, ntpSysFreq=ntpSysFreq, tymingVersion=tymingVersion, gpsMode=gpsMode, gpsSatlist=gpsSatlist, etcModel=etcModel, tyming=tyming, nts=nts, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRefTime=ntpSysRefTime, xli=xli, symmSnmpManagement=symmSnmpManagement, experiment=experiment, ntpSysPrecision=ntpSysPrecision, symmCmipManagement=symmCmipManagement, ntpSysPeer=ntpSysPeer, ntpSysVersion=ntpSysVersion, net=net, symmNetworkManagement=symmNetworkManagement, s100=s100, PYSNMP_MODULE_ID=symmetricom, symmTTM=symmTTM, etcAlarm=etcAlarm, ntpSysClock=ntpSysClock, etc=etc, ntpSysRootDispersion=ntpSysRootDispersion, products=products, gpsPosition=gpsPosition, version=version, ntpSysPoll=ntpSysPoll, ntpSysMode=ntpSysMode, ntpSystem=ntpSystem, gpsUTCOffset=gpsUTCOffset, etcUpgradeServer=etcUpgradeServer, ntpSysRefID=ntpSysRefID, ntpSysError=ntpSysError, etcUpgrade=etcUpgrade, gps=gps, ts2100=ts2100)
