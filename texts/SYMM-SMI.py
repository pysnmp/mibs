...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, ntpSysNotrust=ntpSysNotrust, ntpSysFreq=ntpSysFreq, ntpSysRootDelay=ntpSysRootDelay, tymingVersion=tymingVersion, products=products, tymingTime=tymingTime, ntpSysVersion=ntpSysVersion, gpsUTCOffset=gpsUTCOffset, ntpSysStratum=ntpSysStratum, ts2100=ts2100, ntpSysRefID=ntpSysRefID, ntpSysPrecision=ntpSysPrecision, symmCmipManagement=symmCmipManagement, etcAlarmString=etcAlarmString, ntpSysProcessor=ntpSysProcessor, dialup=dialup, net=net, tymingSource=tymingSource, etcAlarm=etcAlarm, gps=gps, symmSnmpManagement=symmSnmpManagement, nts=nts, ntpSysRefTime=ntpSysRefTime, etcUpgradeServer=etcUpgradeServer, s100=s100, symmTTM=symmTTM, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysMode=ntpSysMode, gpsPosition=gpsPosition, experiment=experiment, etcModel=etcModel, symmetricom=symmetricom, gpsSatlist=gpsSatlist, symmBroadband=symmBroadband, ntpSysPeer=ntpSysPeer, ntpSysClock=ntpSysClock, etcUpgrade=etcUpgrade, ntpSysPhase=ntpSysPhase, xli=xli, symmNetworkManagement=symmNetworkManagement, ntpSystem=ntpSystem, gpsHealth=gpsHealth, version=version, ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, tymingStatus=tymingStatus, syncserver=syncserver, ts2000=ts2000, tymingFlyPeriod=tymingFlyPeriod, PYSNMP_MODULE_ID=symmetricom, tyming=tyming, etcVersion=etcVersion, gpsMode=gpsMode, etc=etc, etcSerialNbr=etcSerialNbr, ntpSysLeap=ntpSysLeap, ntpSysPoll=ntpSysPoll, symmTimePictra=symmTimePictra)
