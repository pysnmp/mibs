...
MibIdentifier, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Counter64, NotificationType, iso, NotificationType, ModuleIdentity, Unsigned32, Gauge32, ObjectIdentity, enterprises, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Counter64", "NotificationType", "iso", "NotificationType", "ModuleIdentity", "Unsigned32", "Gauge32", "ObjectIdentity", "enterprises", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", symmTimePictra=symmTimePictra, dialup=dialup, ntpSysLeap=ntpSysLeap, ntpSysVersion=ntpSysVersion, net=net, PYSNMP_MODULE_ID=symmetricom, ntpSysRefID=ntpSysRefID, tymingStatus=tymingStatus, tymingVersion=tymingVersion, tymingSource=tymingSource, tyming=tyming, ntpSysNotrust=ntpSysNotrust, etcUpgradeServer=etcUpgradeServer, xli=xli, symmTTM=symmTTM, syncserver=syncserver, ntpSysPrecision=ntpSysPrecision, symmCmipManagement=symmCmipManagement, tymingFlyPeriod=tymingFlyPeriod, ntpSysSystem=ntpSysSystem, gpsPosition=gpsPosition, ntpSysPeer=ntpSysPeer, ntpSysPoll=ntpSysPoll, gpsMode=gpsMode, etcUpgrade=etcUpgrade, version=version, ntpSysFreq=ntpSysFreq, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysClock=ntpSysClock, products=products, etc=etc, ntpSysRefTime=ntpSysRefTime, symmNetworkManagement=symmNetworkManagement, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysMode=ntpSysMode, etcVersion=etcVersion, etcModel=etcModel, tymingTime=tymingTime, symmetricom=symmetricom, ntpSysProcessor=ntpSysProcessor, gpsUTCOffset=gpsUTCOffset, gpsSatlist=gpsSatlist, ntpSysError=ntpSysError, gpsHealth=gpsHealth, symmBroadband=symmBroadband, ts2100=ts2100, etcSerialNbr=etcSerialNbr, symmSnmpManagement=symmSnmpManagement, s100=s100, ntpSysPhase=ntpSysPhase, experiment=experiment, nts=nts, ntpSystem=ntpSystem, gps=gps, ntpSysRootDelay=ntpSysRootDelay, ntpSysStratum=ntpSysStratum, etcAlarmString=etcAlarmString, ts2000=ts2000, etcAlarm=etcAlarm)
