...
Gauge32, Unsigned32, ObjectIdentity, Counter64, TimeTicks, NotificationType, enterprises, Integer32, Counter32, ModuleIdentity, NotificationType, IpAddress, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "ObjectIdentity", "Counter64", "TimeTicks", "NotificationType", "enterprises", "Integer32", "Counter32", "ModuleIdentity", "NotificationType", "IpAddress", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", nts=nts, ntpSysNotrust=ntpSysNotrust, xli=xli, ntpSysError=ntpSysError, tymingFlyPeriod=tymingFlyPeriod, ntpSysClock=ntpSysClock, symmTTM=symmTTM, products=products, ntpSysRootDispersion=ntpSysRootDispersion, s100=s100, gpsHealth=gpsHealth, net=net, ntpSysLeap=ntpSysLeap, gpsUTCOffset=gpsUTCOffset, ntpSysPktsReceived=ntpSysPktsReceived, symmCmipManagement=symmCmipManagement, tymingStatus=tymingStatus, gpsPosition=gpsPosition, ntpSysStratum=ntpSysStratum, symmetricom=symmetricom, ntpSysFreq=ntpSysFreq, ntpSysPeer=ntpSysPeer, gpsSatlist=gpsSatlist, gpsMode=gpsMode, etcUpgrade=etcUpgrade, etc=etc, ntpSysRootDelay=ntpSysRootDelay, tymingSource=tymingSource, syncserver=syncserver, ntpSysRefID=ntpSysRefID, ntpSysPoll=ntpSysPoll, experiment=experiment, ntpSysMode=ntpSysMode, ntpSysVersion=ntpSysVersion, etcModel=etcModel, PYSNMP_MODULE_ID=symmetricom, etcSerialNbr=etcSerialNbr, ts2100=ts2100, symmBroadband=symmBroadband, ts2000=ts2000, etcAlarmString=etcAlarmString, gps=gps, version=version, dialup=dialup, ntpSysRefTime=ntpSysRefTime, symmTimePictra=symmTimePictra, tyming=tyming, ntpSysPhase=ntpSysPhase, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, ntpSysPrecision=ntpSysPrecision, ntpSystem=ntpSystem, ntpSysSystem=ntpSysSystem, tymingTime=tymingTime, tymingVersion=tymingVersion, symmNetworkManagement=symmNetworkManagement, symmSnmpManagement=symmSnmpManagement, ntpSysProcessor=ntpSysProcessor, etcAlarm=etcAlarm)
