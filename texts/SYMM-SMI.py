...
ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, Gauge32, Counter64, Counter32, iso, IpAddress, Integer32, ModuleIdentity, MibIdentifier, NotificationType, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "Gauge32", "Counter64", "Counter32", "iso", "IpAddress", "Integer32", "ModuleIdentity", "MibIdentifier", "NotificationType", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", syncserver=syncserver, ntpSysClock=ntpSysClock, ts2100=ts2100, tymingTime=tymingTime, ntpSysFreq=ntpSysFreq, symmNetworkManagement=symmNetworkManagement, symmTTM=symmTTM, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysVersion=ntpSysVersion, tymingFlyPeriod=tymingFlyPeriod, etcAlarm=etcAlarm, ntpSysRootDelay=ntpSysRootDelay, symmSnmpManagement=symmSnmpManagement, gpsPosition=gpsPosition, ntpSystem=ntpSystem, gpsUTCOffset=gpsUTCOffset, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefID=ntpSysRefID, tymingVersion=tymingVersion, ntpSysPeer=ntpSysPeer, etcSerialNbr=etcSerialNbr, ntpSysError=ntpSysError, tymingStatus=tymingStatus, ntpSysStratum=ntpSysStratum, nts=nts, products=products, xli=xli, etcModel=etcModel, symmBroadband=symmBroadband, ntpSysPrecision=ntpSysPrecision, etcUpgrade=etcUpgrade, net=net, ntpSysPhase=ntpSysPhase, dialup=dialup, etcUpgradeServer=etcUpgradeServer, s100=s100, gps=gps, experiment=experiment, ntpSysProcessor=ntpSysProcessor, ntpSysSystem=ntpSysSystem, etcAlarmString=etcAlarmString, PYSNMP_MODULE_ID=symmetricom, ntpSysRefTime=ntpSysRefTime, symmCmipManagement=symmCmipManagement, etcVersion=etcVersion, gpsHealth=gpsHealth, symmTimePictra=symmTimePictra, etc=etc, symmetricom=symmetricom, gpsSatlist=gpsSatlist, gpsMode=gpsMode, version=version, ntpSysNotrust=ntpSysNotrust, tyming=tyming, ts2000=ts2000, ntpSysLeap=ntpSysLeap, ntpSysMode=ntpSysMode)
