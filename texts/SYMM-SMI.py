...
iso, TimeTicks, ModuleIdentity, NotificationType, ObjectIdentity, Unsigned32, MibIdentifier, Counter32, Gauge32, NotificationType, enterprises, Counter64, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "ModuleIdentity", "NotificationType", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Counter32", "Gauge32", "NotificationType", "enterprises", "Counter64", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysMode=ntpSysMode, ntpSysPeer=ntpSysPeer, etcUpgrade=etcUpgrade, ntpSysProcessor=ntpSysProcessor, PYSNMP_MODULE_ID=symmetricom, symmTTM=symmTTM, symmetricom=symmetricom, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefID=ntpSysRefID, gpsMode=gpsMode, symmNetworkManagement=symmNetworkManagement, tymingFlyPeriod=tymingFlyPeriod, etcAlarm=etcAlarm, ntpSysError=ntpSysError, ntpSysStratum=ntpSysStratum, ntpSysLeap=ntpSysLeap, etcUpgradeServer=etcUpgradeServer, dialup=dialup, gpsUTCOffset=gpsUTCOffset, ntpSysFreq=ntpSysFreq, nts=nts, s100=s100, ntpSysVersion=ntpSysVersion, gps=gps, version=version, ntpSysRootDelay=ntpSysRootDelay, ntpSysClock=ntpSysClock, symmCmipManagement=symmCmipManagement, net=net, gpsPosition=gpsPosition, etc=etc, ntpSystem=ntpSystem, etcVersion=etcVersion, gpsHealth=gpsHealth, syncserver=syncserver, products=products, tymingStatus=tymingStatus, symmBroadband=symmBroadband, xli=xli, tyming=tyming, etcModel=etcModel, experiment=experiment, ts2100=ts2100, ts2000=ts2000, symmSnmpManagement=symmSnmpManagement, tymingVersion=tymingVersion, etcAlarmString=etcAlarmString, ntpSysRefTime=ntpSysRefTime, ntpSysPoll=ntpSysPoll, tymingTime=tymingTime, ntpSysSystem=ntpSysSystem, ntpSysPktsReceived=ntpSysPktsReceived, etcSerialNbr=etcSerialNbr, ntpSysPrecision=ntpSysPrecision, gpsSatlist=gpsSatlist, symmTimePictra=symmTimePictra, ntpSysPhase=ntpSysPhase, ntpSysNotrust=ntpSysNotrust, tymingSource=tymingSource)
