...
ObjectIdentity, NotificationType, Unsigned32, Integer32, Counter64, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, iso, enterprises, MibIdentifier, ModuleIdentity, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Unsigned32", "Integer32", "Counter64", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "iso", "enterprises", "MibIdentifier", "ModuleIdentity", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", symmetricom=symmetricom, s100=s100, tyming=tyming, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPktsReceived=ntpSysPktsReceived, symmBroadband=symmBroadband, gpsSatlist=gpsSatlist, tymingFlyPeriod=tymingFlyPeriod, symmCmipManagement=symmCmipManagement, tymingSource=tymingSource, ntpSysFreq=ntpSysFreq, ntpSysClock=ntpSysClock, experiment=experiment, version=version, dialup=dialup, gpsHealth=gpsHealth, symmTTM=symmTTM, tymingTime=tymingTime, symmTimePictra=symmTimePictra, etcAlarm=etcAlarm, tymingStatus=tymingStatus, ntpSysPhase=ntpSysPhase, gpsMode=gpsMode, ntpSysMode=ntpSysMode, net=net, products=products, symmNetworkManagement=symmNetworkManagement, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, etcUpgrade=etcUpgrade, ntpSysProcessor=ntpSysProcessor, gpsPosition=gpsPosition, ntpSysNotrust=ntpSysNotrust, ntpSysVersion=ntpSysVersion, ntpSysRefTime=ntpSysRefTime, tymingVersion=tymingVersion, syncserver=syncserver, ntpSysPeer=ntpSysPeer, nts=nts, ntpSysError=ntpSysError, gps=gps, etcVersion=etcVersion, ntpSystem=ntpSystem, ntpSysPoll=ntpSysPoll, xli=xli, ntpSysPrecision=ntpSysPrecision, ts2000=ts2000, etcAlarmString=etcAlarmString, ntpSysSystem=ntpSysSystem, etcModel=etcModel, etc=etc, ntpSysRootDelay=ntpSysRootDelay, etcUpgradeServer=etcUpgradeServer, PYSNMP_MODULE_ID=symmetricom, gpsUTCOffset=gpsUTCOffset, ntpSysLeap=ntpSysLeap, symmSnmpManagement=symmSnmpManagement, etcSerialNbr=etcSerialNbr, ts2100=ts2100)
