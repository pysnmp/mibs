...
enterprises, NotificationType, ModuleIdentity, Unsigned32, Integer32, Counter32, ObjectIdentity, iso, MibIdentifier, TimeTicks, Counter64, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "ModuleIdentity", "Unsigned32", "Integer32", "Counter32", "ObjectIdentity", "iso", "MibIdentifier", "TimeTicks", "Counter64", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, symmNetworkManagement=symmNetworkManagement, symmBroadband=symmBroadband, tyming=tyming, etc=etc, ntpSysVersion=ntpSysVersion, etcAlarmString=etcAlarmString, ntpSysNotrust=ntpSysNotrust, ntpSysPeer=ntpSysPeer, experiment=experiment, gpsHealth=gpsHealth, xli=xli, ntpSysPhase=ntpSysPhase, PYSNMP_MODULE_ID=symmetricom, gpsPosition=gpsPosition, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysMode=ntpSysMode, tymingStatus=tymingStatus, s100=s100, version=version, ts2000=ts2000, ntpSysPoll=ntpSysPoll, ntpSysSystem=ntpSysSystem, net=net, symmCmipManagement=symmCmipManagement, ntpSysProcessor=ntpSysProcessor, tymingTime=tymingTime, gpsSatlist=gpsSatlist, gpsMode=gpsMode, ntpSysFreq=ntpSysFreq, products=products, ts2100=ts2100, etcModel=etcModel, ntpSysPrecision=ntpSysPrecision, nts=nts, ntpSystem=ntpSystem, symmTTM=symmTTM, ntpSysRefTime=ntpSysRefTime, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, tymingVersion=tymingVersion, ntpSysRefID=ntpSysRefID, ntpSysError=ntpSysError, dialup=dialup, ntpSysRootDelay=ntpSysRootDelay, symmetricom=symmetricom, ntpSysStratum=ntpSysStratum, ntpSysLeap=ntpSysLeap, gpsUTCOffset=gpsUTCOffset, ntpSysClock=ntpSysClock, tymingSource=tymingSource, etcUpgradeServer=etcUpgradeServer, syncserver=syncserver, tymingFlyPeriod=tymingFlyPeriod, etcAlarm=etcAlarm, etcSerialNbr=etcSerialNbr, etcUpgrade=etcUpgrade, etcVersion=etcVersion)
