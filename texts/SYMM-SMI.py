...
ObjectIdentity, ModuleIdentity, Counter32, NotificationType, enterprises, MibIdentifier, Bits, Unsigned32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Integer32, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Counter32", "NotificationType", "enterprises", "MibIdentifier", "Bits", "Unsigned32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Integer32", "Gauge32", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", symmNetworkManagement=symmNetworkManagement, gps=gps, experiment=experiment, gpsPosition=gpsPosition, tymingVersion=tymingVersion, etcModel=etcModel, version=version, etcAlarmString=etcAlarmString, ntpSysVersion=ntpSysVersion, tymingSource=tymingSource, syncserver=syncserver, nts=nts, products=products, ntpSysRefID=ntpSysRefID, ntpSysPoll=ntpSysPoll, ntpSysClock=ntpSysClock, etc=etc, ntpSysLeap=ntpSysLeap, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysFreq=ntpSysFreq, gpsSatlist=gpsSatlist, tymingFlyPeriod=tymingFlyPeriod, ntpSysProcessor=ntpSysProcessor, gpsUTCOffset=gpsUTCOffset, etcUpgradeServer=etcUpgradeServer, ntpSysPhase=ntpSysPhase, ntpSystem=ntpSystem, symmetricom=symmetricom, ntpSysSystem=ntpSysSystem, ntpSysNotrust=ntpSysNotrust, tyming=tyming, dialup=dialup, ntpSysRefTime=ntpSysRefTime, tymingTime=tymingTime, symmSnmpManagement=symmSnmpManagement, symmTTM=symmTTM, ntpSysRootDelay=ntpSysRootDelay, s100=s100, symmTimePictra=symmTimePictra, symmBroadband=symmBroadband, gpsHealth=gpsHealth, gpsMode=gpsMode, tymingStatus=tymingStatus, ntpSysPrecision=ntpSysPrecision, ts2100=ts2100, symmCmipManagement=symmCmipManagement, ntpSysStratum=ntpSysStratum, etcSerialNbr=etcSerialNbr, ntpSysError=ntpSysError, etcUpgrade=etcUpgrade, ntpSysPeer=ntpSysPeer, xli=xli, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysMode=ntpSysMode, etcAlarm=etcAlarm, net=net, etcVersion=etcVersion, ts2000=ts2000, PYSNMP_MODULE_ID=symmetricom)
