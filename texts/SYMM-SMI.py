...
Counter32, Unsigned32, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Counter64, ModuleIdentity, MibIdentifier, NotificationType, Integer32, Bits, iso, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Counter64", "ModuleIdentity", "MibIdentifier", "NotificationType", "Integer32", "Bits", "iso", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("SYMM-SMI", xli=xli, ntpSysPktsReceived=ntpSysPktsReceived, etcAlarmString=etcAlarmString, dialup=dialup, tymingTime=tymingTime, tymingStatus=tymingStatus, syncserver=syncserver, ntpSysPhase=ntpSysPhase, symmTTM=symmTTM, experiment=experiment, ntpSysMode=ntpSysMode, ntpSystem=ntpSystem, gpsMode=gpsMode, ts2100=ts2100, symmetricom=symmetricom, ntpSysProcessor=ntpSysProcessor, ntpSysLeap=ntpSysLeap, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, tymingFlyPeriod=tymingFlyPeriod, gpsSatlist=gpsSatlist, tymingSource=tymingSource, etcVersion=etcVersion, gpsHealth=gpsHealth, ntpSysNotrust=ntpSysNotrust, etcAlarm=etcAlarm, symmSnmpManagement=symmSnmpManagement, ntpSysPeer=ntpSysPeer, version=version, products=products, ntpSysRefID=ntpSysRefID, net=net, tyming=tyming, ntpSysRefTime=ntpSysRefTime, ntpSysClock=ntpSysClock, gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, tymingVersion=tymingVersion, symmCmipManagement=symmCmipManagement, etcSerialNbr=etcSerialNbr, s100=s100, ntpSysSystem=ntpSysSystem, symmNetworkManagement=symmNetworkManagement, ntpSysPrecision=ntpSysPrecision, symmTimePictra=symmTimePictra, nts=nts, gpsPosition=gpsPosition, ts2000=ts2000, ntpSysStratum=ntpSysStratum, ntpSysError=ntpSysError, ntpSysRootDelay=ntpSysRootDelay, etcUpgrade=etcUpgrade, etc=etc, etcModel=etcModel, ntpSysVersion=ntpSysVersion, ntpSysFreq=ntpSysFreq, ntpSysPoll=ntpSysPoll, gpsUTCOffset=gpsUTCOffset, etcUpgradeServer=etcUpgradeServer)
