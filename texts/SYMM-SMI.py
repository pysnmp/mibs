...
NotificationType, Counter32, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, NotificationType, Unsigned32, Bits, ObjectIdentity, Integer32, MibIdentifier, Gauge32, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "NotificationType", "Unsigned32", "Bits", "ObjectIdentity", "Integer32", "MibIdentifier", "Gauge32", "iso", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", tymingFlyPeriod=tymingFlyPeriod, etcVersion=etcVersion, PYSNMP_MODULE_ID=symmetricom, ntpSysClock=ntpSysClock, ntpSysPhase=ntpSysPhase, dialup=dialup, ntpSysStratum=ntpSysStratum, gpsUTCOffset=gpsUTCOffset, gpsHealth=gpsHealth, etcAlarm=etcAlarm, syncserver=syncserver, ntpSysPrecision=ntpSysPrecision, tymingSource=tymingSource, ntpSysRefTime=ntpSysRefTime, ts2100=ts2100, tymingStatus=tymingStatus, symmTimePictra=symmTimePictra, ntpSysPeer=ntpSysPeer, ntpSysFreq=ntpSysFreq, version=version, etc=etc, ntpSysPktsReceived=ntpSysPktsReceived, tyming=tyming, xli=xli, ntpSysProcessor=ntpSysProcessor, s100=s100, ts2000=ts2000, symmBroadband=symmBroadband, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysError=ntpSysError, gpsMode=gpsMode, ntpSysRootDelay=ntpSysRootDelay, symmSnmpManagement=symmSnmpManagement, ntpSysNotrust=ntpSysNotrust, etcSerialNbr=etcSerialNbr, etcUpgradeServer=etcUpgradeServer, tymingTime=tymingTime, ntpSystem=ntpSystem, ntpSysRefID=ntpSysRefID, products=products, experiment=experiment, ntpSysSystem=ntpSysSystem, ntpSysMode=ntpSysMode, gpsPosition=gpsPosition, etcUpgrade=etcUpgrade, ntpSysLeap=ntpSysLeap, tymingVersion=tymingVersion, ntpSysPoll=ntpSysPoll, ntpSysVersion=ntpSysVersion, symmetricom=symmetricom, gpsSatlist=gpsSatlist, symmCmipManagement=symmCmipManagement, net=net, etcAlarmString=etcAlarmString, symmNetworkManagement=symmNetworkManagement, nts=nts, etcModel=etcModel, gps=gps, symmTTM=symmTTM)
