...
NotificationType, IpAddress, NotificationType, enterprises, Bits, Unsigned32, ModuleIdentity, Counter32, TimeTicks, Counter64, iso, Integer32, ObjectIdentity, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "NotificationType", "enterprises", "Bits", "Unsigned32", "ModuleIdentity", "Counter32", "TimeTicks", "Counter64", "iso", "Integer32", "ObjectIdentity", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", version=version, symmBroadband=symmBroadband, ntpSysPrecision=ntpSysPrecision, symmNetworkManagement=symmNetworkManagement, tyming=tyming, ntpSysPeer=ntpSysPeer, tymingFlyPeriod=tymingFlyPeriod, etcUpgrade=etcUpgrade, gpsSatlist=gpsSatlist, ts2000=ts2000, ntpSysProcessor=ntpSysProcessor, ntpSysRootDelay=ntpSysRootDelay, ntpSysVersion=ntpSysVersion, tymingSource=tymingSource, etcUpgradeServer=etcUpgradeServer, ntpSysPktsReceived=ntpSysPktsReceived, etcAlarm=etcAlarm, gpsHealth=gpsHealth, xli=xli, ntpSysRefTime=ntpSysRefTime, ntpSysStratum=ntpSysStratum, ntpSysPhase=ntpSysPhase, ntpSystem=ntpSystem, nts=nts, ntpSysFreq=ntpSysFreq, tymingVersion=tymingVersion, ntpSysMode=ntpSysMode, experiment=experiment, ntpSysLeap=ntpSysLeap, ntpSysSystem=ntpSysSystem, PYSNMP_MODULE_ID=symmetricom, etcModel=etcModel, tymingTime=tymingTime, ntpSysClock=ntpSysClock, products=products, ntpSysError=ntpSysError, etcAlarmString=etcAlarmString, dialup=dialup, etcSerialNbr=etcSerialNbr, gpsMode=gpsMode, symmTimePictra=symmTimePictra, s100=s100, gpsPosition=gpsPosition, tymingStatus=tymingStatus, ntpSysNotrust=ntpSysNotrust, gps=gps, symmTTM=symmTTM, ntpSysRootDispersion=ntpSysRootDispersion, symmetricom=symmetricom, ts2100=ts2100, symmSnmpManagement=symmSnmpManagement, syncserver=syncserver, net=net, ntpSysPoll=ntpSysPoll, etc=etc, gpsUTCOffset=gpsUTCOffset, etcVersion=etcVersion, ntpSysRefID=ntpSysRefID, symmCmipManagement=symmCmipManagement)
