...
Counter64, NotificationType, Counter32, TimeTicks, iso, ObjectIdentity, NotificationType, Gauge32, Integer32, ModuleIdentity, Unsigned32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Counter32", "TimeTicks", "iso", "ObjectIdentity", "NotificationType", "Gauge32", "Integer32", "ModuleIdentity", "Unsigned32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPrecision=ntpSysPrecision, gpsHealth=gpsHealth, etcVersion=etcVersion, xli=xli, ntpSysRootDispersion=ntpSysRootDispersion, gps=gps, gpsUTCOffset=gpsUTCOffset, etcAlarm=etcAlarm, etc=etc, nts=nts, syncserver=syncserver, gpsSatlist=gpsSatlist, symmetricom=symmetricom, ntpSystem=ntpSystem, ntpSysVersion=ntpSysVersion, ntpSysProcessor=ntpSysProcessor, ts2100=ts2100, ntpSysLeap=ntpSysLeap, tymingStatus=tymingStatus, symmCmipManagement=symmCmipManagement, tymingTime=tymingTime, tymingFlyPeriod=tymingFlyPeriod, etcModel=etcModel, etcUpgrade=etcUpgrade, tyming=tyming, symmTTM=symmTTM, PYSNMP_MODULE_ID=symmetricom, ntpSysNotrust=ntpSysNotrust, ntpSysRootDelay=ntpSysRootDelay, symmBroadband=symmBroadband, ntpSysPoll=ntpSysPoll, etcUpgradeServer=etcUpgradeServer, ntpSysRefTime=ntpSysRefTime, ntpSysFreq=ntpSysFreq, gpsMode=gpsMode, ts2000=ts2000, etcAlarmString=etcAlarmString, symmTimePictra=symmTimePictra, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, ntpSysSystem=ntpSysSystem, symmNetworkManagement=symmNetworkManagement, ntpSysPeer=ntpSysPeer, etcSerialNbr=etcSerialNbr, ntpSysClock=ntpSysClock, net=net, ntpSysRefID=ntpSysRefID, gpsPosition=gpsPosition, s100=s100, ntpSysError=ntpSysError, dialup=dialup, ntpSysPhase=ntpSysPhase, products=products, version=version, tymingVersion=tymingVersion, ntpSysStratum=ntpSysStratum, experiment=experiment, symmSnmpManagement=symmSnmpManagement, ntpSysMode=ntpSysMode)
