...
enterprises, TimeTicks, NotificationType, ModuleIdentity, Counter64, MibIdentifier, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, Bits, Gauge32, NotificationType, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "NotificationType", "ModuleIdentity", "Counter64", "MibIdentifier", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "Bits", "Gauge32", "NotificationType", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("SYMM-SMI", nts=nts, PYSNMP_MODULE_ID=symmetricom, symmSnmpManagement=symmSnmpManagement, experiment=experiment, ntpSysPrecision=ntpSysPrecision, gpsUTCOffset=gpsUTCOffset, ts2000=ts2000, ntpSysRootDelay=ntpSysRootDelay, ntpSysVersion=ntpSysVersion, syncserver=syncserver, tyming=tyming, ntpSysPhase=ntpSysPhase, ntpSysMode=ntpSysMode, gpsSatlist=gpsSatlist, etcAlarmString=etcAlarmString, tymingTime=tymingTime, ntpSysSystem=ntpSysSystem, gpsPosition=gpsPosition, ntpSysProcessor=ntpSysProcessor, etc=etc, ntpSysPeer=ntpSysPeer, ntpSysRefTime=ntpSysRefTime, etcUpgrade=etcUpgrade, etcVersion=etcVersion, symmetricom=symmetricom, tymingSource=tymingSource, etcUpgradeServer=etcUpgradeServer, ntpSysRefID=ntpSysRefID, ts2100=ts2100, products=products, xli=xli, etcAlarm=etcAlarm, ntpSysStratum=ntpSysStratum, ntpSysPoll=ntpSysPoll, ntpSysFreq=ntpSysFreq, tymingVersion=tymingVersion, symmBroadband=symmBroadband, s100=s100, gps=gps, ntpSysLeap=ntpSysLeap, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysError=ntpSysError, symmTTM=symmTTM, symmNetworkManagement=symmNetworkManagement, symmCmipManagement=symmCmipManagement, version=version, ntpSysClock=ntpSysClock, etcSerialNbr=etcSerialNbr, etcModel=etcModel, symmTimePictra=symmTimePictra, tymingStatus=tymingStatus, gpsHealth=gpsHealth, tymingFlyPeriod=tymingFlyPeriod, dialup=dialup, net=net, ntpSysNotrust=ntpSysNotrust, ntpSystem=ntpSystem, gpsMode=gpsMode)
