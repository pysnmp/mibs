...
ObjectIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, NotificationType, NotificationType, iso, enterprises, Unsigned32, Gauge32, TimeTicks, Counter64, Bits, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "NotificationType", "NotificationType", "iso", "enterprises", "Unsigned32", "Gauge32", "TimeTicks", "Counter64", "Bits", "MibIdentifier", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", symmetricom=symmetricom, symmCmipManagement=symmCmipManagement, symmTTM=symmTTM, dialup=dialup, etcUpgradeServer=etcUpgradeServer, ntpSysRefTime=ntpSysRefTime, gpsSatlist=gpsSatlist, products=products, etcAlarmString=etcAlarmString, ntpSysPoll=ntpSysPoll, ntpSysLeap=ntpSysLeap, symmNetworkManagement=symmNetworkManagement, gpsUTCOffset=gpsUTCOffset, ntpSysPeer=ntpSysPeer, etcAlarm=etcAlarm, tymingVersion=tymingVersion, PYSNMP_MODULE_ID=symmetricom, ntpSysClock=ntpSysClock, symmBroadband=symmBroadband, tymingStatus=tymingStatus, ntpSystem=ntpSystem, ntpSysRootDelay=ntpSysRootDelay, syncserver=syncserver, etcModel=etcModel, tyming=tyming, ntpSysRefID=ntpSysRefID, gpsMode=gpsMode, etcUpgrade=etcUpgrade, tymingSource=tymingSource, net=net, symmSnmpManagement=symmSnmpManagement, experiment=experiment, ntpSysFreq=ntpSysFreq, ts2100=ts2100, ntpSysMode=ntpSysMode, gpsPosition=gpsPosition, ts2000=ts2000, ntpSysError=ntpSysError, nts=nts, ntpSysPrecision=ntpSysPrecision, ntpSysRootDispersion=ntpSysRootDispersion, xli=xli, ntpSysPhase=ntpSysPhase, ntpSysVersion=ntpSysVersion, gps=gps, ntpSysProcessor=ntpSysProcessor, tymingTime=tymingTime, etcVersion=etcVersion, etc=etc, ntpSysPktsReceived=ntpSysPktsReceived, s100=s100, ntpSysSystem=ntpSysSystem, ntpSysStratum=ntpSysStratum, ntpSysNotrust=ntpSysNotrust, etcSerialNbr=etcSerialNbr, version=version, tymingFlyPeriod=tymingFlyPeriod, gpsHealth=gpsHealth, symmTimePictra=symmTimePictra)
