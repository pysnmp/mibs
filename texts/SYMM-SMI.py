...
mibBuilder.exportSymbols("SYMM-SMI", symmSnmpManagement=symmSnmpManagement, ntpSysRootDispersion=ntpSysRootDispersion, tymingSource=tymingSource, experiment=experiment, ntpSysPhase=ntpSysPhase, ntpSysPrecision=ntpSysPrecision, tyming=tyming, gpsHealth=gpsHealth, ntpSysStratum=ntpSysStratum, ntpSysMode=ntpSysMode, symmTTM=symmTTM, symmTimePictra=symmTimePictra, ntpSysRefID=ntpSysRefID, ntpSysFreq=ntpSysFreq, s100=s100, etcUpgrade=etcUpgrade, symmCmipManagement=symmCmipManagement, ntpSysLeap=ntpSysLeap, gpsUTCOffset=gpsUTCOffset, ntpSysVersion=ntpSysVersion, gpsSatlist=gpsSatlist, tymingVersion=tymingVersion, ntpSysRefTime=ntpSysRefTime, products=products, symmBroadband=symmBroadband, ntpSysNotrust=ntpSysNotrust, tymingStatus=tymingStatus, ntpSystem=ntpSystem, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgradeServer=etcUpgradeServer, etcSerialNbr=etcSerialNbr, etcVersion=etcVersion, ts2000=ts2000, etcAlarmString=etcAlarmString, ntpSysPeer=ntpSysPeer, ntpSysClock=ntpSysClock, symmNetworkManagement=symmNetworkManagement, ts2100=ts2100, ntpSysError=ntpSysError, tymingTime=tymingTime, xli=xli, ntpSysSystem=ntpSysSystem, net=net, symmetricom=symmetricom, gps=gps, syncserver=syncserver, ntpSysRootDelay=ntpSysRootDelay, tymingFlyPeriod=tymingFlyPeriod, etcModel=etcModel, ntpSysPoll=ntpSysPoll, version=version, etcAlarm=etcAlarm, PYSNMP_MODULE_ID=symmetricom, ntpSysProcessor=ntpSysProcessor, gpsMode=gpsMode, gpsPosition=gpsPosition, nts=nts, etc=etc, dialup=dialup)
