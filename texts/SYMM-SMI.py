...
IpAddress, ObjectIdentity, ModuleIdentity, NotificationType, Counter64, Unsigned32, TimeTicks, Integer32, Counter32, MibIdentifier, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Counter64", "Unsigned32", "TimeTicks", "Integer32", "Counter32", "MibIdentifier", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", net=net, ntpSysRootDelay=ntpSysRootDelay, ntpSysError=ntpSysError, tyming=tyming, etc=etc, ntpSysProcessor=ntpSysProcessor, ntpSysRefID=ntpSysRefID, tymingSource=tymingSource, gpsPosition=gpsPosition, ntpSystem=ntpSystem, ntpSysPrecision=ntpSysPrecision, ntpSysPhase=ntpSysPhase, ntpSysSystem=ntpSysSystem, xli=xli, etcVersion=etcVersion, ntpSysVersion=ntpSysVersion, gpsMode=gpsMode, ntpSysClock=ntpSysClock, ntpSysStratum=ntpSysStratum, experiment=experiment, ntpSysLeap=ntpSysLeap, ts2000=ts2000, etcUpgradeServer=etcUpgradeServer, etcAlarm=etcAlarm, etcModel=etcModel, ntpSysPoll=ntpSysPoll, products=products, PYSNMP_MODULE_ID=symmetricom, tymingVersion=tymingVersion, gpsSatlist=gpsSatlist, symmSnmpManagement=symmSnmpManagement, ntpSysRefTime=ntpSysRefTime, ntpSysMode=ntpSysMode, symmTTM=symmTTM, version=version, tymingStatus=tymingStatus, etcSerialNbr=etcSerialNbr, symmetricom=symmetricom, ntpSysPeer=ntpSysPeer, etcUpgrade=etcUpgrade, symmTimePictra=symmTimePictra, symmBroadband=symmBroadband, ntpSysNotrust=ntpSysNotrust, symmNetworkManagement=symmNetworkManagement, ntpSysFreq=ntpSysFreq, syncserver=syncserver, tymingFlyPeriod=tymingFlyPeriod, gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, gpsUTCOffset=gpsUTCOffset, nts=nts, gpsHealth=gpsHealth, ts2100=ts2100, tymingTime=tymingTime, s100=s100, etcAlarmString=etcAlarmString, dialup=dialup, symmCmipManagement=symmCmipManagement, ntpSysPktsReceived=ntpSysPktsReceived)
