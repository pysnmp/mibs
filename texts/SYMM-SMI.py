...
Counter32, IpAddress, Bits, Integer32, ObjectIdentity, MibIdentifier, enterprises, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Unsigned32, Counter64, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Bits", "Integer32", "ObjectIdentity", "MibIdentifier", "enterprises", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Unsigned32", "Counter64", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysFreq=ntpSysFreq, nts=nts, etcSerialNbr=etcSerialNbr, ntpSysSystem=ntpSysSystem, symmNetworkManagement=symmNetworkManagement, gpsPosition=gpsPosition, etcUpgrade=etcUpgrade, s100=s100, ntpSysError=ntpSysError, etcUpgradeServer=etcUpgradeServer, ntpSysPoll=ntpSysPoll, ntpSysNotrust=ntpSysNotrust, etcModel=etcModel, gpsSatlist=gpsSatlist, dialup=dialup, etcVersion=etcVersion, tymingTime=tymingTime, symmetricom=symmetricom, ntpSysPktsReceived=ntpSysPktsReceived, gpsHealth=gpsHealth, gpsMode=gpsMode, ntpSysRootDelay=ntpSysRootDelay, ntpSysVersion=ntpSysVersion, tymingStatus=tymingStatus, etcAlarm=etcAlarm, symmTTM=symmTTM, ntpSysClock=ntpSysClock, ntpSysRefID=ntpSysRefID, ntpSysRefTime=ntpSysRefTime, ntpSysPrecision=ntpSysPrecision, ntpSysRootDispersion=ntpSysRootDispersion, net=net, etc=etc, ntpSystem=ntpSystem, ntpSysMode=ntpSysMode, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom, xli=xli, tymingVersion=tymingVersion, products=products, tymingFlyPeriod=tymingFlyPeriod, etcAlarmString=etcAlarmString, version=version, syncserver=syncserver, tyming=tyming, experiment=experiment, ntpSysStratum=ntpSysStratum, ntpSysPhase=ntpSysPhase, ntpSysProcessor=ntpSysProcessor, tymingSource=tymingSource, symmCmipManagement=symmCmipManagement, gps=gps, ts2100=ts2100, gpsUTCOffset=gpsUTCOffset, ts2000=ts2000, ntpSysPeer=ntpSysPeer, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, ntpSysLeap=ntpSysLeap)
