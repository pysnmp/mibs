...
Counter64, TimeTicks, iso, Gauge32, NotificationType, ModuleIdentity, enterprises, NotificationType, MibIdentifier, Integer32, Counter32, Unsigned32, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "iso", "Gauge32", "NotificationType", "ModuleIdentity", "enterprises", "NotificationType", "MibIdentifier", "Integer32", "Counter32", "Unsigned32", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", version=version, ntpSysMode=ntpSysMode, gpsPosition=gpsPosition, PYSNMP_MODULE_ID=symmetricom, ntpSysProcessor=ntpSysProcessor, gpsSatlist=gpsSatlist, tyming=tyming, gpsUTCOffset=gpsUTCOffset, symmCmipManagement=symmCmipManagement, ntpSystem=ntpSystem, etc=etc, ntpSysRefTime=ntpSysRefTime, etcSerialNbr=etcSerialNbr, tymingStatus=tymingStatus, ntpSysLeap=ntpSysLeap, symmTimePictra=symmTimePictra, tymingTime=tymingTime, symmNetworkManagement=symmNetworkManagement, ntpSysPrecision=ntpSysPrecision, dialup=dialup, tymingFlyPeriod=tymingFlyPeriod, etcVersion=etcVersion, symmTTM=symmTTM, etcUpgrade=etcUpgrade, ntpSysRefID=ntpSysRefID, ntpSysVersion=ntpSysVersion, symmBroadband=symmBroadband, gps=gps, ts2000=ts2000, xli=xli, symmSnmpManagement=symmSnmpManagement, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPeer=ntpSysPeer, ntpSysFreq=ntpSysFreq, ntpSysSystem=ntpSysSystem, etcModel=etcModel, etcAlarmString=etcAlarmString, syncserver=syncserver, ts2100=ts2100, ntpSysStratum=ntpSysStratum, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, gpsHealth=gpsHealth, ntpSysError=ntpSysError, etcUpgradeServer=etcUpgradeServer, ntpSysNotrust=ntpSysNotrust, products=products, s100=s100, experiment=experiment, net=net, ntpSysRootDelay=ntpSysRootDelay, tymingVersion=tymingVersion, ntpSysPhase=ntpSysPhase, gpsMode=gpsMode, ntpSysClock=ntpSysClock, nts=nts, ntpSysPoll=ntpSysPoll, etcAlarm=etcAlarm, symmetricom=symmetricom)
