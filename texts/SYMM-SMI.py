...
Integer32, NotificationType, Counter64, Gauge32, MibIdentifier, iso, ObjectIdentity, enterprises, ModuleIdentity, Unsigned32, TimeTicks, Bits, IpAddress, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter64", "Gauge32", "MibIdentifier", "iso", "ObjectIdentity", "enterprises", "ModuleIdentity", "Unsigned32", "TimeTicks", "Bits", "IpAddress", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", etcUpgrade=etcUpgrade, tymingStatus=tymingStatus, gpsSatlist=gpsSatlist, tymingSource=tymingSource, dialup=dialup, tymingVersion=tymingVersion, syncserver=syncserver, experiment=experiment, etcModel=etcModel, PYSNMP_MODULE_ID=symmetricom, gps=gps, ntpSysPrecision=ntpSysPrecision, gpsMode=gpsMode, symmCmipManagement=symmCmipManagement, gpsHealth=gpsHealth, ntpSysLeap=ntpSysLeap, ntpSysPhase=ntpSysPhase, ntpSysRefTime=ntpSysRefTime, ntpSysNotrust=ntpSysNotrust, symmTTM=symmTTM, ntpSysPeer=ntpSysPeer, ntpSysVersion=ntpSysVersion, ntpSysRefID=ntpSysRefID, tymingFlyPeriod=tymingFlyPeriod, gpsUTCOffset=gpsUTCOffset, gpsPosition=gpsPosition, ntpSysSystem=ntpSysSystem, ntpSysRootDelay=ntpSysRootDelay, symmNetworkManagement=symmNetworkManagement, symmetricom=symmetricom, s100=s100, etc=etc, ts2000=ts2000, etcAlarmString=etcAlarmString, version=version, etcSerialNbr=etcSerialNbr, ntpSystem=ntpSystem, products=products, ntpSysPktsReceived=ntpSysPktsReceived, tymingTime=tymingTime, symmTimePictra=symmTimePictra, tyming=tyming, ntpSysMode=ntpSysMode, etcUpgradeServer=etcUpgradeServer, symmBroadband=symmBroadband, etcVersion=etcVersion, ntpSysStratum=ntpSysStratum, ntpSysPoll=ntpSysPoll, xli=xli, ntpSysClock=ntpSysClock, ts2100=ts2100, ntpSysFreq=ntpSysFreq, etcAlarm=etcAlarm, ntpSysProcessor=ntpSysProcessor, ntpSysError=ntpSysError, nts=nts, net=net, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement)
