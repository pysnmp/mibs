...
enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, IpAddress, Integer32, ModuleIdentity, NotificationType, Unsigned32, NotificationType, MibIdentifier, iso, Bits, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "IpAddress", "Integer32", "ModuleIdentity", "NotificationType", "Unsigned32", "NotificationType", "MibIdentifier", "iso", "Bits", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", symmetricom=symmetricom, symmNetworkManagement=symmNetworkManagement, dialup=dialup, net=net, etcUpgradeServer=etcUpgradeServer, nts=nts, etcSerialNbr=etcSerialNbr, symmBroadband=symmBroadband, etc=etc, ts2000=ts2000, s100=s100, version=version, gpsPosition=gpsPosition, etcAlarm=etcAlarm, ntpSysClock=ntpSysClock, etcModel=etcModel, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, ntpSysPoll=ntpSysPoll, gpsHealth=gpsHealth, tymingTime=tymingTime, experiment=experiment, etcVersion=etcVersion, xli=xli, ntpSysPrecision=ntpSysPrecision, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, etcAlarmString=etcAlarmString, tymingSource=tymingSource, gpsMode=gpsMode, gpsUTCOffset=gpsUTCOffset, ntpSysLeap=ntpSysLeap, ntpSysPeer=ntpSysPeer, syncserver=syncserver, ntpSysNotrust=ntpSysNotrust, ntpSystem=ntpSystem, gpsSatlist=gpsSatlist, tymingVersion=tymingVersion, ntpSysPhase=ntpSysPhase, ntpSysRefTime=ntpSysRefTime, ts2100=ts2100, symmCmipManagement=symmCmipManagement, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysFreq=ntpSysFreq, products=products, symmTimePictra=symmTimePictra, tymingFlyPeriod=tymingFlyPeriod, ntpSysMode=ntpSysMode, ntpSysVersion=ntpSysVersion, tyming=tyming, tymingStatus=tymingStatus, ntpSysSystem=ntpSysSystem, symmSnmpManagement=symmSnmpManagement, ntpSysRootDelay=ntpSysRootDelay, gps=gps, PYSNMP_MODULE_ID=symmetricom, ntpSysProcessor=ntpSysProcessor, ntpSysPktsReceived=ntpSysPktsReceived, symmTTM=symmTTM)
