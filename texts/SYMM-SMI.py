...
Integer32, NotificationType, Counter64, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, MibIdentifier, NotificationType, ModuleIdentity, Unsigned32, Bits, Counter32, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter64", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "MibIdentifier", "NotificationType", "ModuleIdentity", "Unsigned32", "Bits", "Counter32", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDispersion=ntpSysRootDispersion, ntpSysStratum=ntpSysStratum, ntpSysProcessor=ntpSysProcessor, symmCmipManagement=symmCmipManagement, symmBroadband=symmBroadband, dialup=dialup, ntpSysError=ntpSysError, etcModel=etcModel, ntpSysRootDelay=ntpSysRootDelay, experiment=experiment, ntpSysFreq=ntpSysFreq, ntpSysPoll=ntpSysPoll, etcAlarmString=etcAlarmString, ntpSysPrecision=ntpSysPrecision, gpsMode=gpsMode, xli=xli, version=version, ntpSysPhase=ntpSysPhase, ntpSystem=ntpSystem, ntpSysVersion=ntpSysVersion, nts=nts, ts2100=ts2100, ntpSysSystem=ntpSysSystem, tymingFlyPeriod=tymingFlyPeriod, gps=gps, symmNetworkManagement=symmNetworkManagement, PYSNMP_MODULE_ID=symmetricom, syncserver=syncserver, gpsHealth=gpsHealth, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, tymingVersion=tymingVersion, ntpSysMode=ntpSysMode, ntpSysNotrust=ntpSysNotrust, gpsUTCOffset=gpsUTCOffset, etcAlarm=etcAlarm, ntpSysRefTime=ntpSysRefTime, ntpSysClock=ntpSysClock, tymingTime=tymingTime, products=products, etcSerialNbr=etcSerialNbr, s100=s100, etcUpgrade=etcUpgrade, ts2000=ts2000, net=net, ntpSysPktsReceived=ntpSysPktsReceived, etcVersion=etcVersion, ntpSysPeer=ntpSysPeer, symmetricom=symmetricom, ntpSysLeap=ntpSysLeap, tyming=tyming, symmTTM=symmTTM, tymingStatus=tymingStatus, ntpSysRefID=ntpSysRefID, gpsPosition=gpsPosition, etcUpgradeServer=etcUpgradeServer, tymingSource=tymingSource, etc=etc, gpsSatlist=gpsSatlist)
