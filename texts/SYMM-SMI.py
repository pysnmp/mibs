...
Integer32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ObjectIdentity, NotificationType, TimeTicks, Bits, NotificationType, enterprises, Counter32, Gauge32, MibIdentifier, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ObjectIdentity", "NotificationType", "TimeTicks", "Bits", "NotificationType", "enterprises", "Counter32", "Gauge32", "MibIdentifier", "IpAddress", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", nts=nts, ntpSysLeap=ntpSysLeap, ntpSysClock=ntpSysClock, ntpSystem=ntpSystem, syncserver=syncserver, etcAlarm=etcAlarm, ntpSysSystem=ntpSysSystem, tymingFlyPeriod=tymingFlyPeriod, etcUpgradeServer=etcUpgradeServer, ntpSysRefID=ntpSysRefID, symmTTM=symmTTM, ntpSysRefTime=ntpSysRefTime, etcUpgrade=etcUpgrade, ntpSysPoll=ntpSysPoll, symmetricom=symmetricom, ntpSysPhase=ntpSysPhase, symmBroadband=symmBroadband, net=net, ntpSysPrecision=ntpSysPrecision, gps=gps, ntpSysStratum=ntpSysStratum, ntpSysMode=ntpSysMode, tymingVersion=tymingVersion, etcSerialNbr=etcSerialNbr, etcVersion=etcVersion, ntpSysVersion=ntpSysVersion, xli=xli, symmNetworkManagement=symmNetworkManagement, ts2100=ts2100, s100=s100, ntpSysError=ntpSysError, ntpSysNotrust=ntpSysNotrust, etcModel=etcModel, ntpSysPeer=ntpSysPeer, gpsHealth=gpsHealth, ntpSysFreq=ntpSysFreq, gpsPosition=gpsPosition, ntpSysPktsReceived=ntpSysPktsReceived, experiment=experiment, symmCmipManagement=symmCmipManagement, ntpSysRootDispersion=ntpSysRootDispersion, tyming=tyming, products=products, gpsMode=gpsMode, PYSNMP_MODULE_ID=symmetricom, version=version, etcAlarmString=etcAlarmString, ntpSysProcessor=ntpSysProcessor, gpsUTCOffset=gpsUTCOffset, tymingStatus=tymingStatus, dialup=dialup, symmTimePictra=symmTimePictra, etc=etc, ntpSysRootDelay=ntpSysRootDelay, symmSnmpManagement=symmSnmpManagement, gpsSatlist=gpsSatlist, tymingSource=tymingSource, tymingTime=tymingTime, ts2000=ts2000)
