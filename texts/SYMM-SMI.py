...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, TimeTicks, Counter32, MibIdentifier, Unsigned32, IpAddress, ObjectIdentity, Gauge32, NotificationType, enterprises, Counter64, Integer32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "TimeTicks", "Counter32", "MibIdentifier", "Unsigned32", "IpAddress", "ObjectIdentity", "Gauge32", "NotificationType", "enterprises", "Counter64", "Integer32", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsHealth=gpsHealth, ntpSysRefTime=ntpSysRefTime, gpsUTCOffset=gpsUTCOffset, gpsSatlist=gpsSatlist, etcUpgrade=etcUpgrade, etcAlarm=etcAlarm, symmTTM=symmTTM, experiment=experiment, ntpSystem=ntpSystem, tymingFlyPeriod=tymingFlyPeriod, etc=etc, tymingSource=tymingSource, nts=nts, symmNetworkManagement=symmNetworkManagement, ntpSysPoll=ntpSysPoll, ntpSysRootDelay=ntpSysRootDelay, gps=gps, symmetricom=symmetricom, ntpSysStratum=ntpSysStratum, ntpSysPktsReceived=ntpSysPktsReceived, symmTimePictra=symmTimePictra, dialup=dialup, net=net, etcVersion=etcVersion, etcAlarmString=etcAlarmString, ntpSysMode=ntpSysMode, gpsPosition=gpsPosition, products=products, tymingStatus=tymingStatus, ntpSysError=ntpSysError, symmBroadband=symmBroadband, s100=s100, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysSystem=ntpSysSystem, ntpSysNotrust=ntpSysNotrust, ts2100=ts2100, etcModel=etcModel, symmSnmpManagement=symmSnmpManagement, ntpSysFreq=ntpSysFreq, ntpSysLeap=ntpSysLeap, ntpSysPhase=ntpSysPhase, symmCmipManagement=symmCmipManagement, tymingTime=tymingTime, tymingVersion=tymingVersion, gpsMode=gpsMode, PYSNMP_MODULE_ID=symmetricom, ntpSysPrecision=ntpSysPrecision, tyming=tyming, syncserver=syncserver, ntpSysClock=ntpSysClock, etcSerialNbr=etcSerialNbr, ntpSysPeer=ntpSysPeer, ts2000=ts2000, ntpSysProcessor=ntpSysProcessor, version=version, etcUpgradeServer=etcUpgradeServer, ntpSysRefID=ntpSysRefID, xli=xli, ntpSysVersion=ntpSysVersion)
