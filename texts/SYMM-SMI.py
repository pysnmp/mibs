...
Gauge32, ModuleIdentity, Bits, Integer32, iso, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Counter32, NotificationType, Counter64, enterprises, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Bits", "Integer32", "iso", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Counter32", "NotificationType", "Counter64", "enterprises", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, syncserver=syncserver, ntpSysVersion=ntpSysVersion, gpsSatlist=gpsSatlist, etc=etc, gpsHealth=gpsHealth, ntpSysError=ntpSysError, ntpSysMode=ntpSysMode, etcModel=etcModel, tymingTime=tymingTime, experiment=experiment, etcVersion=etcVersion, tymingStatus=tymingStatus, etcUpgradeServer=etcUpgradeServer, etcAlarmString=etcAlarmString, tymingFlyPeriod=tymingFlyPeriod, ntpSystem=ntpSystem, dialup=dialup, gpsUTCOffset=gpsUTCOffset, gpsMode=gpsMode, ts2100=ts2100, products=products, symmTimePictra=symmTimePictra, nts=nts, net=net, ntpSysSystem=ntpSysSystem, etcUpgrade=etcUpgrade, tymingSource=tymingSource, tymingVersion=tymingVersion, ntpSysPhase=ntpSysPhase, etcAlarm=etcAlarm, symmCmipManagement=symmCmipManagement, ntpSysPeer=ntpSysPeer, symmSnmpManagement=symmSnmpManagement, PYSNMP_MODULE_ID=symmetricom, version=version, gps=gps, ntpSysStratum=ntpSysStratum, ntpSysNotrust=ntpSysNotrust, ntpSysPrecision=ntpSysPrecision, ntpSysRefTime=ntpSysRefTime, tyming=tyming, ntpSysRefID=ntpSysRefID, symmTTM=symmTTM, ntpSysFreq=ntpSysFreq, ts2000=ts2000, ntpSysProcessor=ntpSysProcessor, s100=s100, gpsPosition=gpsPosition, ntpSysLeap=ntpSysLeap, symmNetworkManagement=symmNetworkManagement, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRootDelay=ntpSysRootDelay, etcSerialNbr=etcSerialNbr, ntpSysPoll=ntpSysPoll, symmetricom=symmetricom, ntpSysClock=ntpSysClock, symmBroadband=symmBroadband, xli=xli)
