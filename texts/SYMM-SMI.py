...
NotificationType, Gauge32, Bits, iso, ObjectIdentity, NotificationType, Unsigned32, Counter64, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, ModuleIdentity, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Bits", "iso", "ObjectIdentity", "NotificationType", "Unsigned32", "Counter64", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "ModuleIdentity", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysStratum=ntpSysStratum, nts=nts, symmSnmpManagement=symmSnmpManagement, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, etcVersion=etcVersion, ntpSysRootDelay=ntpSysRootDelay, tymingFlyPeriod=tymingFlyPeriod, tymingSource=tymingSource, products=products, ntpSysPeer=ntpSysPeer, gpsUTCOffset=gpsUTCOffset, ntpSysRefID=ntpSysRefID, etcUpgradeServer=etcUpgradeServer, ntpSysLeap=ntpSysLeap, net=net, symmCmipManagement=symmCmipManagement, gpsPosition=gpsPosition, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, ntpSysFreq=ntpSysFreq, ntpSysVersion=ntpSysVersion, tymingVersion=tymingVersion, gpsHealth=gpsHealth, etcUpgrade=etcUpgrade, etcSerialNbr=etcSerialNbr, ts2100=ts2100, tymingStatus=tymingStatus, experiment=experiment, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysError=ntpSysError, PYSNMP_MODULE_ID=symmetricom, syncserver=syncserver, tyming=tyming, symmBroadband=symmBroadband, xli=xli, ntpSysRefTime=ntpSysRefTime, symmNetworkManagement=symmNetworkManagement, ntpSysMode=ntpSysMode, dialup=dialup, etc=etc, etcModel=etcModel, gps=gps, gpsSatlist=gpsSatlist, tymingTime=tymingTime, symmetricom=symmetricom, ntpSysSystem=ntpSysSystem, symmTimePictra=symmTimePictra, ntpSysProcessor=ntpSysProcessor, s100=s100, ntpSysClock=ntpSysClock, ntpSysNotrust=ntpSysNotrust, version=version, gpsMode=gpsMode, ntpSysPoll=ntpSysPoll, ntpSysRootDispersion=ntpSysRootDispersion, ntpSystem=ntpSystem, ts2000=ts2000, ntpSysPrecision=ntpSysPrecision)
