...
mibBuilder.exportSymbols("SYMM-SMI", gpsMode=gpsMode, gpsHealth=gpsHealth, nts=nts, ntpSysPeer=ntpSysPeer, net=net, ntpSysPhase=ntpSysPhase, symmetricom=symmetricom, ntpSysSystem=ntpSysSystem, etcAlarm=etcAlarm, gps=gps, etcUpgradeServer=etcUpgradeServer, gpsUTCOffset=gpsUTCOffset, tyming=tyming, etcUpgrade=etcUpgrade, etcModel=etcModel, etcAlarmString=etcAlarmString, ntpSysRefID=ntpSysRefID, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, symmCmipManagement=symmCmipManagement, tymingTime=tymingTime, etcSerialNbr=etcSerialNbr, ntpSysRefTime=ntpSysRefTime, ts2000=ts2000, ntpSysPoll=ntpSysPoll, ntpSystem=ntpSystem, products=products, s100=s100, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, gpsSatlist=gpsSatlist, ntpSysLeap=ntpSysLeap, ntpSysError=ntpSysError, gpsPosition=gpsPosition, dialup=dialup, etcVersion=etcVersion, symmNetworkManagement=symmNetworkManagement, syncserver=syncserver, ntpSysStratum=ntpSysStratum, ntpSysNotrust=ntpSysNotrust, xli=xli, etc=etc, ntpSysPrecision=ntpSysPrecision, tymingVersion=tymingVersion, tymingSource=tymingSource, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, ntpSysProcessor=ntpSysProcessor, ntpSysRootDelay=ntpSysRootDelay, ntpSysFreq=ntpSysFreq, symmTimePictra=symmTimePictra, ntpSysVersion=ntpSysVersion, ntpSysPktsReceived=ntpSysPktsReceived, symmTTM=symmTTM, ntpSysClock=ntpSysClock, ts2100=ts2100, ntpSysMode=ntpSysMode, experiment=experiment, version=version)
