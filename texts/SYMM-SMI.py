...
iso, Gauge32, NotificationType, NotificationType, TimeTicks, enterprises, IpAddress, ObjectIdentity, Counter64, MibIdentifier, ModuleIdentity, Counter32, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "NotificationType", "NotificationType", "TimeTicks", "enterprises", "IpAddress", "ObjectIdentity", "Counter64", "MibIdentifier", "ModuleIdentity", "Counter32", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSystem=ntpSystem, etcAlarmString=etcAlarmString, ntpSysMode=ntpSysMode, gpsSatlist=gpsSatlist, version=version, ntpSysPeer=ntpSysPeer, xli=xli, tymingStatus=tymingStatus, symmCmipManagement=symmCmipManagement, ntpSysNotrust=ntpSysNotrust, ts2100=ts2100, ntpSysPrecision=ntpSysPrecision, symmTTM=symmTTM, ntpSysRefID=ntpSysRefID, etcModel=etcModel, syncserver=syncserver, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgradeServer=etcUpgradeServer, ntpSysLeap=ntpSysLeap, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysFreq=ntpSysFreq, tymingTime=tymingTime, gpsPosition=gpsPosition, ntpSysRefTime=ntpSysRefTime, etcUpgrade=etcUpgrade, s100=s100, tyming=tyming, symmSnmpManagement=symmSnmpManagement, symmNetworkManagement=symmNetworkManagement, experiment=experiment, PYSNMP_MODULE_ID=symmetricom, ntpSysVersion=ntpSysVersion, gpsUTCOffset=gpsUTCOffset, nts=nts, ntpSysClock=ntpSysClock, etcVersion=etcVersion, gps=gps, ntpSysStratum=ntpSysStratum, symmTimePictra=symmTimePictra, ntpSysPhase=ntpSysPhase, ntpSysProcessor=ntpSysProcessor, symmetricom=symmetricom, dialup=dialup, etc=etc, ntpSysError=ntpSysError, tymingSource=tymingSource, ts2000=ts2000, gpsHealth=gpsHealth, etcSerialNbr=etcSerialNbr, etcAlarm=etcAlarm, tymingVersion=tymingVersion, symmBroadband=symmBroadband, gpsMode=gpsMode, ntpSysRootDelay=ntpSysRootDelay, ntpSysSystem=ntpSysSystem, net=net, tymingFlyPeriod=tymingFlyPeriod, products=products, ntpSysPoll=ntpSysPoll)
