...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, iso, Integer32, Counter64, Unsigned32, ObjectIdentity, MibIdentifier, NotificationType, ModuleIdentity, enterprises, IpAddress, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "iso", "Integer32", "Counter64", "Unsigned32", "ObjectIdentity", "MibIdentifier", "NotificationType", "ModuleIdentity", "enterprises", "IpAddress", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsUTCOffset=gpsUTCOffset, dialup=dialup, tymingVersion=tymingVersion, PYSNMP_MODULE_ID=symmetricom, nts=nts, version=version, symmCmipManagement=symmCmipManagement, ntpSysRootDelay=ntpSysRootDelay, etcAlarm=etcAlarm, etcUpgrade=etcUpgrade, gpsHealth=gpsHealth, products=products, symmNetworkManagement=symmNetworkManagement, symmTimePictra=symmTimePictra, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, etcModel=etcModel, ts2000=ts2000, gps=gps, symmTTM=symmTTM, ntpSystem=ntpSystem, ntpSysPrecision=ntpSysPrecision, ntpSysNotrust=ntpSysNotrust, experiment=experiment, tymingFlyPeriod=tymingFlyPeriod, gpsPosition=gpsPosition, gpsMode=gpsMode, ntpSysFreq=ntpSysFreq, etcVersion=etcVersion, ts2100=ts2100, ntpSysSystem=ntpSysSystem, etcSerialNbr=etcSerialNbr, ntpSysVersion=ntpSysVersion, ntpSysMode=ntpSysMode, gpsSatlist=gpsSatlist, etc=etc, ntpSysPhase=ntpSysPhase, ntpSysRootDispersion=ntpSysRootDispersion, etcAlarmString=etcAlarmString, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysClock=ntpSysClock, tymingSource=tymingSource, ntpSysPoll=ntpSysPoll, ntpSysPeer=ntpSysPeer, tymingStatus=tymingStatus, symmBroadband=symmBroadband, ntpSysLeap=ntpSysLeap, tyming=tyming, ntpSysRefTime=ntpSysRefTime, xli=xli, ntpSysProcessor=ntpSysProcessor, tymingTime=tymingTime, net=net, ntpSysError=ntpSysError, symmetricom=symmetricom, syncserver=syncserver, etcUpgradeServer=etcUpgradeServer, s100=s100, symmSnmpManagement=symmSnmpManagement)
