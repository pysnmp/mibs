...
IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, iso, Integer32, Gauge32, Unsigned32, TimeTicks, MibIdentifier, NotificationType, NotificationType, enterprises, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "iso", "Integer32", "Gauge32", "Unsigned32", "TimeTicks", "MibIdentifier", "NotificationType", "NotificationType", "enterprises", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", gps=gps, dialup=dialup, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, gpsHealth=gpsHealth, symmNetworkManagement=symmNetworkManagement, products=products, etcVersion=etcVersion, ntpSysPrecision=ntpSysPrecision, symmTimePictra=symmTimePictra, etcAlarm=etcAlarm, symmTTM=symmTTM, tymingSource=tymingSource, symmBroadband=symmBroadband, tymingTime=tymingTime, etc=etc, gpsUTCOffset=gpsUTCOffset, gpsMode=gpsMode, net=net, ts2100=ts2100, ntpSysLeap=ntpSysLeap, s100=s100, tymingFlyPeriod=tymingFlyPeriod, symmSnmpManagement=symmSnmpManagement, PYSNMP_MODULE_ID=symmetricom, ts2000=ts2000, etcUpgrade=etcUpgrade, etcModel=etcModel, etcSerialNbr=etcSerialNbr, ntpSysSystem=ntpSysSystem, gpsSatlist=gpsSatlist, gpsPosition=gpsPosition, ntpSysFreq=ntpSysFreq, ntpSysPhase=ntpSysPhase, ntpSysPoll=ntpSysPoll, tymingStatus=tymingStatus, ntpSysVersion=ntpSysVersion, ntpSysError=ntpSysError, syncserver=syncserver, version=version, ntpSysNotrust=ntpSysNotrust, tymingVersion=tymingVersion, ntpSysRefTime=ntpSysRefTime, ntpSysMode=ntpSysMode, etcUpgradeServer=etcUpgradeServer, etcAlarmString=etcAlarmString, ntpSysStratum=ntpSysStratum, nts=nts, xli=xli, ntpSysRootDispersion=ntpSysRootDispersion, symmetricom=symmetricom, symmCmipManagement=symmCmipManagement, ntpSysRefID=ntpSysRefID, ntpSysPktsReceived=ntpSysPktsReceived, experiment=experiment, ntpSystem=ntpSystem, ntpSysPeer=ntpSysPeer, ntpSysRootDelay=ntpSysRootDelay, tyming=tyming)
