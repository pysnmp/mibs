...
mibBuilder.exportSymbols("SYMM-SMI", etcModel=etcModel, nts=nts, dialup=dialup, etcAlarm=etcAlarm, gpsHealth=gpsHealth, ntpSysProcessor=ntpSysProcessor, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysNotrust=ntpSysNotrust, symmTimePictra=symmTimePictra, ntpSysLeap=ntpSysLeap, ntpSysPoll=ntpSysPoll, ntpSystem=ntpSystem, ntpSysRootDelay=ntpSysRootDelay, ntpSysPeer=ntpSysPeer, symmNetworkManagement=symmNetworkManagement, tymingFlyPeriod=tymingFlyPeriod, gpsUTCOffset=gpsUTCOffset, net=net, ntpSysMode=ntpSysMode, tymingVersion=tymingVersion, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysVersion=ntpSysVersion, tymingSource=tymingSource, symmCmipManagement=symmCmipManagement, etcSerialNbr=etcSerialNbr, symmSnmpManagement=symmSnmpManagement, ts2100=ts2100, xli=xli, ntpSysPhase=ntpSysPhase, ntpSysFreq=ntpSysFreq, symmTTM=symmTTM, ntpSysRefTime=ntpSysRefTime, products=products, tymingStatus=tymingStatus, symmetricom=symmetricom, tyming=tyming, etcVersion=etcVersion, ntpSysClock=ntpSysClock, version=version, ntpSysSystem=ntpSysSystem, tymingTime=tymingTime, ntpSysError=ntpSysError, ts2000=ts2000, gpsPosition=gpsPosition, etcAlarmString=etcAlarmString, etcUpgrade=etcUpgrade, gpsMode=gpsMode, ntpSysPrecision=ntpSysPrecision, etcUpgradeServer=etcUpgradeServer, ntpSysStratum=ntpSysStratum, s100=s100, ntpSysRefID=ntpSysRefID, etc=etc, gpsSatlist=gpsSatlist, syncserver=syncserver, gps=gps, PYSNMP_MODULE_ID=symmetricom, experiment=experiment, symmBroadband=symmBroadband)
