...
IpAddress, Counter64, Integer32, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, Bits, ModuleIdentity, iso, NotificationType, Unsigned32, Counter32, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Integer32", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "Bits", "ModuleIdentity", "iso", "NotificationType", "Unsigned32", "Counter32", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSystem=ntpSystem, dialup=dialup, etcSerialNbr=etcSerialNbr, tymingStatus=tymingStatus, ntpSysNotrust=ntpSysNotrust, s100=s100, ntpSysStratum=ntpSysStratum, symmTTM=symmTTM, etcVersion=etcVersion, etcUpgrade=etcUpgrade, etcUpgradeServer=etcUpgradeServer, gpsMode=gpsMode, version=version, symmBroadband=symmBroadband, syncserver=syncserver, symmNetworkManagement=symmNetworkManagement, ntpSysPeer=ntpSysPeer, ntpSysError=ntpSysError, etc=etc, gpsPosition=gpsPosition, tyming=tyming, PYSNMP_MODULE_ID=symmetricom, ntpSysLeap=ntpSysLeap, ntpSysRefID=ntpSysRefID, ntpSysFreq=ntpSysFreq, symmetricom=symmetricom, ntpSysPrecision=ntpSysPrecision, ntpSysVersion=ntpSysVersion, xli=xli, symmCmipManagement=symmCmipManagement, gps=gps, tymingFlyPeriod=tymingFlyPeriod, etcAlarmString=etcAlarmString, experiment=experiment, symmSnmpManagement=symmSnmpManagement, ntpSysClock=ntpSysClock, gpsUTCOffset=gpsUTCOffset, ntpSysSystem=ntpSysSystem, etcAlarm=etcAlarm, products=products, ntpSysRootDispersion=ntpSysRootDispersion, symmTimePictra=symmTimePictra, ts2100=ts2100, ntpSysRefTime=ntpSysRefTime, net=net, ntpSysProcessor=ntpSysProcessor, ntpSysPoll=ntpSysPoll, tymingVersion=tymingVersion, ntpSysPhase=ntpSysPhase, ntpSysPktsReceived=ntpSysPktsReceived, etcModel=etcModel, gpsHealth=gpsHealth, nts=nts, ntpSysRootDelay=ntpSysRootDelay, ntpSysMode=ntpSysMode, tymingTime=tymingTime, tymingSource=tymingSource, gpsSatlist=gpsSatlist, ts2000=ts2000)
