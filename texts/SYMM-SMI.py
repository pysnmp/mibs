...
mibBuilder.exportSymbols("SYMM-SMI", PYSNMP_MODULE_ID=symmetricom, symmSnmpManagement=symmSnmpManagement, products=products, ntpSysProcessor=ntpSysProcessor, ntpSysVersion=ntpSysVersion, ntpSysRootDispersion=ntpSysRootDispersion, etcModel=etcModel, tymingStatus=tymingStatus, ntpSysFreq=ntpSysFreq, xli=xli, gpsMode=gpsMode, symmCmipManagement=symmCmipManagement, s100=s100, symmNetworkManagement=symmNetworkManagement, ntpSysLeap=ntpSysLeap, ntpSysRefTime=ntpSysRefTime, ntpSysClock=ntpSysClock, ntpSystem=ntpSystem, etcAlarmString=etcAlarmString, ntpSysRootDelay=ntpSysRootDelay, ntpSysStratum=ntpSysStratum, symmTTM=symmTTM, ntpSysRefID=ntpSysRefID, syncserver=syncserver, etcSerialNbr=etcSerialNbr, nts=nts, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, ntpSysError=ntpSysError, etcVersion=etcVersion, experiment=experiment, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgrade=etcUpgrade, symmetricom=symmetricom, tymingFlyPeriod=tymingFlyPeriod, symmTimePictra=symmTimePictra, ntpSysPoll=ntpSysPoll, etcAlarm=etcAlarm, dialup=dialup, tymingTime=tymingTime, version=version, ntpSysPeer=ntpSysPeer, etc=etc, tymingSource=tymingSource, ntpSysNotrust=ntpSysNotrust, gpsPosition=gpsPosition, symmBroadband=symmBroadband, tyming=tyming, ntpSysPhase=ntpSysPhase, gpsSatlist=gpsSatlist, net=net, etcUpgradeServer=etcUpgradeServer, ts2100=ts2100, gpsUTCOffset=gpsUTCOffset, tymingVersion=tymingVersion, gpsHealth=gpsHealth, ntpSysMode=ntpSysMode, gps=gps, ts2000=ts2000)
