...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Integer32, NotificationType, TimeTicks, iso, ModuleIdentity, Unsigned32, MibIdentifier, Bits, NotificationType, ObjectIdentity, Counter64, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Integer32", "NotificationType", "TimeTicks", "iso", "ModuleIdentity", "Unsigned32", "MibIdentifier", "Bits", "NotificationType", "ObjectIdentity", "Counter64", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsUTCOffset=gpsUTCOffset, tymingTime=tymingTime, PYSNMP_MODULE_ID=symmetricom, symmSnmpManagement=symmSnmpManagement, net=net, tymingSource=tymingSource, symmCmipManagement=symmCmipManagement, ntpSysRootDelay=ntpSysRootDelay, ts2100=ts2100, tymingFlyPeriod=tymingFlyPeriod, etcAlarmString=etcAlarmString, s100=s100, ts2000=ts2000, tyming=tyming, ntpSysPrecision=ntpSysPrecision, xli=xli, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRefTime=ntpSysRefTime, ntpSysProcessor=ntpSysProcessor, tymingVersion=tymingVersion, syncserver=syncserver, symmetricom=symmetricom, etcModel=etcModel, ntpSysPeer=ntpSysPeer, tymingStatus=tymingStatus, etcUpgrade=etcUpgrade, ntpSysNotrust=ntpSysNotrust, experiment=experiment, ntpSysPhase=ntpSysPhase, ntpSysClock=ntpSysClock, symmBroadband=symmBroadband, etcUpgradeServer=etcUpgradeServer, version=version, etcVersion=etcVersion, gpsSatlist=gpsSatlist, gpsHealth=gpsHealth, symmTimePictra=symmTimePictra, ntpSysSystem=ntpSysSystem, ntpSysRefID=ntpSysRefID, ntpSysMode=ntpSysMode, ntpSysFreq=ntpSysFreq, gps=gps, ntpSysVersion=ntpSysVersion, ntpSystem=ntpSystem, ntpSysRootDispersion=ntpSysRootDispersion, symmNetworkManagement=symmNetworkManagement, etc=etc, ntpSysLeap=ntpSysLeap, ntpSysError=ntpSysError, gpsMode=gpsMode, ntpSysStratum=ntpSysStratum, nts=nts, symmTTM=symmTTM, gpsPosition=gpsPosition, ntpSysPoll=ntpSysPoll, etcAlarm=etcAlarm, etcSerialNbr=etcSerialNbr, dialup=dialup, products=products)
