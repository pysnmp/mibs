...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefTime=ntpSysRefTime, ntpSysMode=ntpSysMode, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, ntpSysRefID=ntpSysRefID, ntpSysPoll=ntpSysPoll, PYSNMP_MODULE_ID=symmetricom, gpsHealth=gpsHealth, version=version, ntpSysStratum=ntpSysStratum, etcSerialNbr=etcSerialNbr, ntpSysNotrust=ntpSysNotrust, ntpSysPeer=ntpSysPeer, products=products, etc=etc, etcUpgrade=etcUpgrade, ts2000=ts2000, ntpSysRootDispersion=ntpSysRootDispersion, tymingStatus=tymingStatus, nts=nts, symmetricom=symmetricom, experiment=experiment, etcAlarm=etcAlarm, ntpSystem=ntpSystem, syncserver=syncserver, ts2100=ts2100, tymingFlyPeriod=tymingFlyPeriod, symmNetworkManagement=symmNetworkManagement, ntpSysFreq=ntpSysFreq, net=net, tymingTime=tymingTime, ntpSysRootDelay=ntpSysRootDelay, ntpSysProcessor=ntpSysProcessor, tymingSource=tymingSource, gpsSatlist=gpsSatlist, symmSnmpManagement=symmSnmpManagement, symmCmipManagement=symmCmipManagement, symmBroadband=symmBroadband, xli=xli, ntpSysPrecision=ntpSysPrecision, symmTTM=symmTTM, ntpSysError=ntpSysError, ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem, gpsMode=gpsMode, etcAlarmString=etcAlarmString, ntpSysPhase=ntpSysPhase, etcModel=etcModel, ntpSysLeap=ntpSysLeap, ntpSysPktsReceived=ntpSysPktsReceived, symmTimePictra=symmTimePictra, tyming=tyming, ntpSysVersion=ntpSysVersion, tymingVersion=tymingVersion, s100=s100, gpsPosition=gpsPosition, dialup=dialup, gpsUTCOffset=gpsUTCOffset, gps=gps)
