...
Integer32, Counter32, MibIdentifier, NotificationType, ModuleIdentity, Gauge32, ObjectIdentity, iso, TimeTicks, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "MibIdentifier", "NotificationType", "ModuleIdentity", "Gauge32", "ObjectIdentity", "iso", "TimeTicks", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", tymingTime=tymingTime, ntpSysProcessor=ntpSysProcessor, tymingVersion=tymingVersion, symmNetworkManagement=symmNetworkManagement, products=products, dialup=dialup, syncserver=syncserver, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysMode=ntpSysMode, version=version, ntpSysPeer=ntpSysPeer, ntpSysError=ntpSysError, etcAlarmString=etcAlarmString, ntpSysFreq=ntpSysFreq, symmSnmpManagement=symmSnmpManagement, etcVersion=etcVersion, etcModel=etcModel, etcUpgradeServer=etcUpgradeServer, ntpSysClock=ntpSysClock, symmetricom=symmetricom, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysNotrust=ntpSysNotrust, gpsHealth=gpsHealth, symmBroadband=symmBroadband, ntpSysLeap=ntpSysLeap, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, etcUpgrade=etcUpgrade, symmTimePictra=symmTimePictra, experiment=experiment, symmCmipManagement=symmCmipManagement, ntpSysStratum=ntpSysStratum, PYSNMP_MODULE_ID=symmetricom, gpsPosition=gpsPosition, ts2100=ts2100, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, ts2000=ts2000, gpsSatlist=gpsSatlist, ntpSysVersion=ntpSysVersion, nts=nts, gpsMode=gpsMode, etc=etc, gpsUTCOffset=gpsUTCOffset, etcAlarm=etcAlarm, ntpSysRefTime=ntpSysRefTime, s100=s100, ntpSysPhase=ntpSysPhase, ntpSysRefID=ntpSysRefID, tyming=tyming, etcSerialNbr=etcSerialNbr, net=net, symmTTM=symmTTM, ntpSysSystem=ntpSysSystem, gps=gps, xli=xli, ntpSysPrecision=ntpSysPrecision, ntpSystem=ntpSystem, ntpSysRootDelay=ntpSysRootDelay)
