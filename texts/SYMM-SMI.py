...
enterprises, Gauge32, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, iso, TimeTicks, Unsigned32, NotificationType, IpAddress, ModuleIdentity, Counter32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "iso", "TimeTicks", "Unsigned32", "NotificationType", "IpAddress", "ModuleIdentity", "Counter32", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", tyming=tyming, ntpSysRefTime=ntpSysRefTime, nts=nts, ntpSysRootDelay=ntpSysRootDelay, ntpSysFreq=ntpSysFreq, ntpSysRefID=ntpSysRefID, ntpSysSystem=ntpSysSystem, ntpSysPhase=ntpSysPhase, s100=s100, ntpSysVersion=ntpSysVersion, ntpSysStratum=ntpSysStratum, tymingVersion=tymingVersion, symmBroadband=symmBroadband, ntpSysNotrust=ntpSysNotrust, symmNetworkManagement=symmNetworkManagement, gpsPosition=gpsPosition, symmTTM=symmTTM, ntpSysPoll=ntpSysPoll, ntpSysRootDispersion=ntpSysRootDispersion, etcUpgradeServer=etcUpgradeServer, tymingTime=tymingTime, tymingStatus=tymingStatus, ntpSysPeer=ntpSysPeer, etcUpgrade=etcUpgrade, symmSnmpManagement=symmSnmpManagement, ntpSysClock=ntpSysClock, syncserver=syncserver, ntpSysError=ntpSysError, etcAlarmString=etcAlarmString, xli=xli, ntpSysLeap=ntpSysLeap, tymingSource=tymingSource, etcVersion=etcVersion, gpsMode=gpsMode, ntpSysPktsReceived=ntpSysPktsReceived, ts2100=ts2100, version=version, ntpSystem=ntpSystem, etc=etc, gpsUTCOffset=gpsUTCOffset, net=net, ts2000=ts2000, ntpSysProcessor=ntpSysProcessor, ntpSysMode=ntpSysMode, tymingFlyPeriod=tymingFlyPeriod, gpsHealth=gpsHealth, etcSerialNbr=etcSerialNbr, products=products, PYSNMP_MODULE_ID=symmetricom, etcAlarm=etcAlarm, symmetricom=symmetricom, experiment=experiment, etcModel=etcModel, symmCmipManagement=symmCmipManagement, gpsSatlist=gpsSatlist, gps=gps, ntpSysPrecision=ntpSysPrecision, symmTimePictra=symmTimePictra, dialup=dialup)
