...
mibBuilder.exportSymbols("SYMM-SMI", symmSnmpManagement=symmSnmpManagement, ts2000=ts2000, ntpSysRefTime=ntpSysRefTime, ntpSysPoll=ntpSysPoll, tymingStatus=tymingStatus, gpsPosition=gpsPosition, gpsMode=gpsMode, version=version, ntpSysStratum=ntpSysStratum, symmCmipManagement=symmCmipManagement, etcSerialNbr=etcSerialNbr, s100=s100, tymingTime=tymingTime, etc=etc, ntpSysVersion=ntpSysVersion, ntpSysSystem=ntpSysSystem, ntpSysFreq=ntpSysFreq, ntpSystem=ntpSystem, nts=nts, net=net, gpsHealth=gpsHealth, dialup=dialup, tyming=tyming, ntpSysProcessor=ntpSysProcessor, ntpSysLeap=ntpSysLeap, ts2100=ts2100, ntpSysPhase=ntpSysPhase, gpsSatlist=gpsSatlist, ntpSysRefID=ntpSysRefID, gpsUTCOffset=gpsUTCOffset, symmetricom=symmetricom, etcVersion=etcVersion, etcUpgrade=etcUpgrade, symmTimePictra=symmTimePictra, etcModel=etcModel, ntpSysError=ntpSysError, xli=xli, experiment=experiment, ntpSysClock=ntpSysClock, symmTTM=symmTTM, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysNotrust=ntpSysNotrust, tymingSource=tymingSource, ntpSysPeer=ntpSysPeer, tymingFlyPeriod=tymingFlyPeriod, PYSNMP_MODULE_ID=symmetricom, products=products, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, ntpSysPrecision=ntpSysPrecision, ntpSysPktsReceived=ntpSysPktsReceived, symmBroadband=symmBroadband, tymingVersion=tymingVersion, syncserver=syncserver, gps=gps, ntpSysMode=ntpSysMode, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, ntpSysRootDelay=ntpSysRootDelay)
