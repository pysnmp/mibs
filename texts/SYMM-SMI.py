...
iso, Bits, enterprises, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, NotificationType, IpAddress, MibIdentifier, NotificationType, Counter32, ObjectIdentity, Counter64, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "enterprises", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "NotificationType", "IpAddress", "MibIdentifier", "NotificationType", "Counter32", "ObjectIdentity", "Counter64", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysLeap=ntpSysLeap, xli=xli, symmTTM=symmTTM, ntpSysNotrust=ntpSysNotrust, etcUpgradeServer=etcUpgradeServer, ntpSysRootDispersion=ntpSysRootDispersion, symmTimePictra=symmTimePictra, ntpSysStratum=ntpSysStratum, ntpSysPrecision=ntpSysPrecision, etcAlarm=etcAlarm, gpsHealth=gpsHealth, ts2100=ts2100, ntpSysClock=ntpSysClock, ntpSysError=ntpSysError, ntpSysRootDelay=ntpSysRootDelay, symmSnmpManagement=symmSnmpManagement, gps=gps, tymingStatus=tymingStatus, symmCmipManagement=symmCmipManagement, gpsMode=gpsMode, tymingVersion=tymingVersion, version=version, ntpSysPktsReceived=ntpSysPktsReceived, nts=nts, ntpSysRefID=ntpSysRefID, ntpSysProcessor=ntpSysProcessor, gpsSatlist=gpsSatlist, etcVersion=etcVersion, symmBroadband=symmBroadband, etc=etc, gpsPosition=gpsPosition, tyming=tyming, ntpSysSystem=ntpSysSystem, dialup=dialup, PYSNMP_MODULE_ID=symmetricom, products=products, tymingSource=tymingSource, etcModel=etcModel, etcSerialNbr=etcSerialNbr, ts2000=ts2000, ntpSystem=ntpSystem, symmNetworkManagement=symmNetworkManagement, ntpSysPhase=ntpSysPhase, ntpSysVersion=ntpSysVersion, etcAlarmString=etcAlarmString, symmetricom=symmetricom, tymingFlyPeriod=tymingFlyPeriod, ntpSysFreq=ntpSysFreq, syncserver=syncserver, ntpSysPeer=ntpSysPeer, s100=s100, ntpSysPoll=ntpSysPoll, gpsUTCOffset=gpsUTCOffset, ntpSysRefTime=ntpSysRefTime, ntpSysMode=ntpSysMode, tymingTime=tymingTime, net=net, experiment=experiment, etcUpgrade=etcUpgrade)
