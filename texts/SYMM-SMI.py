...
NotificationType, Integer32, IpAddress, iso, enterprises, Counter32, Unsigned32, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, NotificationType, Bits, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "IpAddress", "iso", "enterprises", "Counter32", "Unsigned32", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "NotificationType", "Bits", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", PYSNMP_MODULE_ID=symmetricom, ntpSysPktsReceived=ntpSysPktsReceived, tymingFlyPeriod=tymingFlyPeriod, tymingVersion=tymingVersion, xli=xli, gpsMode=gpsMode, gps=gps, ntpSysClock=ntpSysClock, etcModel=etcModel, version=version, net=net, ntpSysRefID=ntpSysRefID, ntpSysFreq=ntpSysFreq, ntpSysNotrust=ntpSysNotrust, tymingSource=tymingSource, etc=etc, experiment=experiment, syncserver=syncserver, ntpSystem=ntpSystem, ntpSysPoll=ntpSysPoll, ntpSysError=ntpSysError, gpsPosition=gpsPosition, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, dialup=dialup, ntpSysStratum=ntpSysStratum, tymingStatus=tymingStatus, symmTimePictra=symmTimePictra, symmCmipManagement=symmCmipManagement, symmSnmpManagement=symmSnmpManagement, symmNetworkManagement=symmNetworkManagement, tymingTime=tymingTime, etcSerialNbr=etcSerialNbr, symmBroadband=symmBroadband, ntpSysVersion=ntpSysVersion, symmetricom=symmetricom, gpsSatlist=gpsSatlist, ntpSysRefTime=ntpSysRefTime, ntpSysPeer=ntpSysPeer, ntpSysPhase=ntpSysPhase, ntpSysProcessor=ntpSysProcessor, gpsUTCOffset=gpsUTCOffset, etcAlarm=etcAlarm, products=products, ntpSysRootDelay=ntpSysRootDelay, ntpSysRootDispersion=ntpSysRootDispersion, etcVersion=etcVersion, etcAlarmString=etcAlarmString, gpsHealth=gpsHealth, etcUpgrade=etcUpgrade, ts2100=ts2100, etcUpgradeServer=etcUpgradeServer, ntpSysMode=ntpSysMode, s100=s100, nts=nts, ts2000=ts2000, symmTTM=symmTTM, ntpSysLeap=ntpSysLeap, tyming=tyming)
