...
enterprises, Unsigned32, ModuleIdentity, Counter64, iso, IpAddress, Bits, NotificationType, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, ObjectIdentity, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "ModuleIdentity", "Counter64", "iso", "IpAddress", "Bits", "NotificationType", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "ObjectIdentity", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", etcSerialNbr=etcSerialNbr, ntpSysRootDelay=ntpSysRootDelay, etcModel=etcModel, gpsHealth=gpsHealth, PYSNMP_MODULE_ID=symmetricom, ntpSysPeer=ntpSysPeer, tymingVersion=tymingVersion, dialup=dialup, gpsPosition=gpsPosition, gpsSatlist=gpsSatlist, ntpSysRefID=ntpSysRefID, gps=gps, ntpSysVersion=ntpSysVersion, ntpSysError=ntpSysError, symmSnmpManagement=symmSnmpManagement, ntpSysRefTime=ntpSysRefTime, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, ntpSysSystem=ntpSysSystem, tymingTime=tymingTime, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, etcUpgradeServer=etcUpgradeServer, symmetricom=symmetricom, etcAlarmString=etcAlarmString, ntpSysLeap=ntpSysLeap, ts2100=ts2100, xli=xli, syncserver=syncserver, ts2000=ts2000, ntpSysClock=ntpSysClock, etc=etc, products=products, etcVersion=etcVersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysMode=ntpSysMode, symmTimePictra=symmTimePictra, ntpSysPktsReceived=ntpSysPktsReceived, gpsMode=gpsMode, ntpSysPoll=ntpSysPoll, ntpSysPhase=ntpSysPhase, symmCmipManagement=symmCmipManagement, ntpSysStratum=ntpSysStratum, ntpSysPrecision=ntpSysPrecision, experiment=experiment, tymingStatus=tymingStatus, tymingSource=tymingSource, tyming=tyming, ntpSysRootDispersion=ntpSysRootDispersion, etcAlarm=etcAlarm, symmNetworkManagement=symmNetworkManagement, symmTTM=symmTTM, ntpSystem=ntpSystem, s100=s100, nts=nts, gpsUTCOffset=gpsUTCOffset, net=net, version=version, ntpSysFreq=ntpSysFreq)
