...
Bits, TimeTicks, IpAddress, iso, ObjectIdentity, MibIdentifier, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Unsigned32, ModuleIdentity, Counter32, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "IpAddress", "iso", "ObjectIdentity", "MibIdentifier", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Unsigned32", "ModuleIdentity", "Counter32", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", etcModel=etcModel, ntpSystem=ntpSystem, ntpSysRefID=ntpSysRefID, s100=s100, etc=etc, ntpSysPrecision=ntpSysPrecision, tymingStatus=tymingStatus, ts2100=ts2100, ntpSysError=ntpSysError, ntpSysVersion=ntpSysVersion, gpsUTCOffset=gpsUTCOffset, version=version, symmNetworkManagement=symmNetworkManagement, symmTTM=symmTTM, tymingFlyPeriod=tymingFlyPeriod, syncserver=syncserver, ntpSysRootDelay=ntpSysRootDelay, etcUpgrade=etcUpgrade, tymingSource=tymingSource, ntpSysLeap=ntpSysLeap, experiment=experiment, dialup=dialup, ntpSysPhase=ntpSysPhase, etcAlarmString=etcAlarmString, gpsSatlist=gpsSatlist, etcVersion=etcVersion, PYSNMP_MODULE_ID=symmetricom, ntpSysRefTime=ntpSysRefTime, ntpSysNotrust=ntpSysNotrust, gpsPosition=gpsPosition, symmSnmpManagement=symmSnmpManagement, gpsHealth=gpsHealth, ntpSysFreq=ntpSysFreq, products=products, ts2000=ts2000, ntpSysPoll=ntpSysPoll, net=net, gpsMode=gpsMode, etcAlarm=etcAlarm, ntpSysRootDispersion=ntpSysRootDispersion, xli=xli, etcSerialNbr=etcSerialNbr, tyming=tyming, symmCmipManagement=symmCmipManagement, ntpSysClock=ntpSysClock, ntpSysPktsReceived=ntpSysPktsReceived, symmTimePictra=symmTimePictra, ntpSysProcessor=ntpSysProcessor, ntpSysMode=ntpSysMode, ntpSysSystem=ntpSysSystem, tymingTime=tymingTime, tymingVersion=tymingVersion, gps=gps, symmBroadband=symmBroadband, etcUpgradeServer=etcUpgradeServer, ntpSysPeer=ntpSysPeer, ntpSysStratum=ntpSysStratum, symmetricom=symmetricom, nts=nts)
