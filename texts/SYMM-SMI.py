...
NotificationType, Integer32, Gauge32, iso, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Bits, Counter32, MibIdentifier, TimeTicks, IpAddress, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "Gauge32", "iso", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Bits", "Counter32", "MibIdentifier", "TimeTicks", "IpAddress", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPeer=ntpSysPeer, tymingFlyPeriod=tymingFlyPeriod, gpsHealth=gpsHealth, symmetricom=symmetricom, ntpSysLeap=ntpSysLeap, tymingStatus=tymingStatus, symmBroadband=symmBroadband, gpsPosition=gpsPosition, experiment=experiment, ntpSysRootDelay=ntpSysRootDelay, symmSnmpManagement=symmSnmpManagement, etcUpgradeServer=etcUpgradeServer, gps=gps, products=products, ntpSysRefTime=ntpSysRefTime, ntpSysPhase=ntpSysPhase, ntpSysError=ntpSysError, ts2000=ts2000, ntpSysRefID=ntpSysRefID, ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem, gpsUTCOffset=gpsUTCOffset, ntpSysMode=ntpSysMode, ntpSysStratum=ntpSysStratum, net=net, s100=s100, symmTTM=symmTTM, etcUpgrade=etcUpgrade, ntpSysPktsReceived=ntpSysPktsReceived, symmCmipManagement=symmCmipManagement, ntpSysProcessor=ntpSysProcessor, version=version, etc=etc, ntpSysPrecision=ntpSysPrecision, gpsSatlist=gpsSatlist, xli=xli, nts=nts, dialup=dialup, etcModel=etcModel, etcAlarmString=etcAlarmString, etcSerialNbr=etcSerialNbr, ts2100=ts2100, symmTimePictra=symmTimePictra, tymingVersion=tymingVersion, ntpSystem=ntpSystem, tyming=tyming, etcAlarm=etcAlarm, ntpSysVersion=ntpSysVersion, tymingTime=tymingTime, PYSNMP_MODULE_ID=symmetricom, tymingSource=tymingSource, etcVersion=etcVersion, ntpSysFreq=ntpSysFreq, gpsMode=gpsMode, ntpSysPoll=ntpSysPoll, symmNetworkManagement=symmNetworkManagement, syncserver=syncserver, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysNotrust=ntpSysNotrust)
