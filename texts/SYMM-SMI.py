...
Gauge32, iso, ModuleIdentity, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Counter64, MibIdentifier, TimeTicks, Unsigned32, ObjectIdentity, enterprises, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "ModuleIdentity", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Counter64", "MibIdentifier", "TimeTicks", "Unsigned32", "ObjectIdentity", "enterprises", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", s100=s100, ntpSysMode=ntpSysMode, xli=xli, ntpSysPoll=ntpSysPoll, version=version, ntpSysRefID=ntpSysRefID, tymingVersion=tymingVersion, symmCmipManagement=symmCmipManagement, ntpSysClock=ntpSysClock, nts=nts, gpsPosition=gpsPosition, symmSnmpManagement=symmSnmpManagement, ntpSysRefTime=ntpSysRefTime, ts2100=ts2100, syncserver=syncserver, dialup=dialup, net=net, ntpSysNotrust=ntpSysNotrust, ntpSysSystem=ntpSysSystem, ntpSystem=ntpSystem, ntpSysVersion=ntpSysVersion, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, tymingTime=tymingTime, etcVersion=etcVersion, experiment=experiment, ntpSysPrecision=ntpSysPrecision, ntpSysProcessor=ntpSysProcessor, ntpSysError=ntpSysError, gps=gps, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, etcUpgrade=etcUpgrade, ntpSysLeap=ntpSysLeap, etcModel=etcModel, etcSerialNbr=etcSerialNbr, ntpSysPhase=ntpSysPhase, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, tymingStatus=tymingStatus, gpsSatlist=gpsSatlist, gpsMode=gpsMode, ntpSysStratum=ntpSysStratum, symmTimePictra=symmTimePictra, tymingFlyPeriod=tymingFlyPeriod, PYSNMP_MODULE_ID=symmetricom, gpsUTCOffset=gpsUTCOffset, symmetricom=symmetricom, products=products, ntpSysPeer=ntpSysPeer, ts2000=ts2000, tyming=tyming, symmTTM=symmTTM, symmBroadband=symmBroadband, etc=etc, tymingSource=tymingSource, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysFreq=ntpSysFreq)
