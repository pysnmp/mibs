...
mibBuilder.exportSymbols("SYMM-SMI", symmetricom=symmetricom, gpsPosition=gpsPosition, etcUpgradeServer=etcUpgradeServer, ntpSysStratum=ntpSysStratum, ntpSysFreq=ntpSysFreq, symmCmipManagement=symmCmipManagement, ntpSysRefID=ntpSysRefID, symmBroadband=symmBroadband, ntpSystem=ntpSystem, tymingStatus=tymingStatus, gpsUTCOffset=gpsUTCOffset, ntpSysPoll=ntpSysPoll, gpsSatlist=gpsSatlist, gpsMode=gpsMode, net=net, ntpSysPktsReceived=ntpSysPktsReceived, gpsHealth=gpsHealth, s100=s100, ntpSysPhase=ntpSysPhase, ntpSysLeap=ntpSysLeap, tymingVersion=tymingVersion, tymingFlyPeriod=tymingFlyPeriod, etcVersion=etcVersion, tyming=tyming, tymingTime=tymingTime, etcAlarmString=etcAlarmString, gps=gps, etc=etc, PYSNMP_MODULE_ID=symmetricom, ts2100=ts2100, symmTTM=symmTTM, tymingSource=tymingSource, products=products, ntpSysRefTime=ntpSysRefTime, ntpSysRootDelay=ntpSysRootDelay, etcSerialNbr=etcSerialNbr, symmTimePictra=symmTimePictra, symmNetworkManagement=symmNetworkManagement, syncserver=syncserver, nts=nts, ntpSysError=ntpSysError, ntpSysMode=ntpSysMode, ntpSysVersion=ntpSysVersion, etcModel=etcModel, ntpSysPeer=ntpSysPeer, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, etcAlarm=etcAlarm, version=version, dialup=dialup, ntpSysPrecision=ntpSysPrecision, ntpSysClock=ntpSysClock, ts2000=ts2000, etcUpgrade=etcUpgrade, experiment=experiment, xli=xli, symmSnmpManagement=symmSnmpManagement, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysSystem=ntpSysSystem)
