...
Counter32, enterprises, Gauge32, NotificationType, Counter64, ModuleIdentity, IpAddress, Bits, MibIdentifier, NotificationType, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "Gauge32", "NotificationType", "Counter64", "ModuleIdentity", "IpAddress", "Bits", "MibIdentifier", "NotificationType", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysSystem=ntpSysSystem, etcAlarmString=etcAlarmString, symmetricom=symmetricom, ntpSystem=ntpSystem, tymingTime=tymingTime, ntpSysError=ntpSysError, ntpSysPhase=ntpSysPhase, symmTimePictra=symmTimePictra, ts2000=ts2000, tyming=tyming, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, symmSnmpManagement=symmSnmpManagement, etcSerialNbr=etcSerialNbr, tymingVersion=tymingVersion, gpsHealth=gpsHealth, etcAlarm=etcAlarm, ntpSysClock=ntpSysClock, etcVersion=etcVersion, xli=xli, ntpSysNotrust=ntpSysNotrust, gps=gps, dialup=dialup, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, gpsSatlist=gpsSatlist, tymingSource=tymingSource, version=version, etcUpgradeServer=etcUpgradeServer, net=net, symmNetworkManagement=symmNetworkManagement, ts2100=ts2100, symmBroadband=symmBroadband, ntpSysRefTime=ntpSysRefTime, ntpSysMode=ntpSysMode, ntpSysRootDelay=ntpSysRootDelay, gpsUTCOffset=gpsUTCOffset, etc=etc, ntpSysVersion=ntpSysVersion, etcModel=etcModel, gpsPosition=gpsPosition, s100=s100, symmTTM=symmTTM, symmCmipManagement=symmCmipManagement, nts=nts, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPeer=ntpSysPeer, ntpSysPoll=ntpSysPoll, PYSNMP_MODULE_ID=symmetricom, ntpSysPrecision=ntpSysPrecision, syncserver=syncserver, ntpSysFreq=ntpSysFreq, ntpSysPktsReceived=ntpSysPktsReceived, tymingStatus=tymingStatus, gpsMode=gpsMode, experiment=experiment, etcUpgrade=etcUpgrade, ntpSysProcessor=ntpSysProcessor, products=products)
