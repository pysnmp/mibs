...
enterprises, Bits, Gauge32, Unsigned32, Integer32, TimeTicks, Counter32, IpAddress, MibIdentifier, NotificationType, NotificationType, Counter64, ObjectIdentity, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Gauge32", "Unsigned32", "Integer32", "TimeTicks", "Counter32", "IpAddress", "MibIdentifier", "NotificationType", "NotificationType", "Counter64", "ObjectIdentity", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", PYSNMP_MODULE_ID=symmetricom, gps=gps, syncserver=syncserver, symmTimePictra=symmTimePictra, ntpSysRootDelay=ntpSysRootDelay, tymingSource=tymingSource, etcUpgrade=etcUpgrade, etcUpgradeServer=etcUpgradeServer, ntpSysPeer=ntpSysPeer, symmNetworkManagement=symmNetworkManagement, ntpSysError=ntpSysError, version=version, symmCmipManagement=symmCmipManagement, ntpSysNotrust=ntpSysNotrust, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysMode=ntpSysMode, ntpSysPoll=ntpSysPoll, s100=s100, tyming=tyming, products=products, etc=etc, symmetricom=symmetricom, symmBroadband=symmBroadband, ntpSysClock=ntpSysClock, net=net, ntpSysRefID=ntpSysRefID, tymingFlyPeriod=tymingFlyPeriod, etcAlarm=etcAlarm, ntpSysSystem=ntpSysSystem, dialup=dialup, xli=xli, symmSnmpManagement=symmSnmpManagement, ntpSysPhase=ntpSysPhase, tymingVersion=tymingVersion, ntpSystem=ntpSystem, ts2000=ts2000, ntpSysLeap=ntpSysLeap, ntpSysRefTime=ntpSysRefTime, nts=nts, ts2100=ts2100, tymingStatus=tymingStatus, tymingTime=tymingTime, gpsPosition=gpsPosition, ntpSysStratum=ntpSysStratum, etcVersion=etcVersion, gpsMode=gpsMode, ntpSysVersion=ntpSysVersion, etcSerialNbr=etcSerialNbr, gpsUTCOffset=gpsUTCOffset, etcModel=etcModel, gpsHealth=gpsHealth, etcAlarmString=etcAlarmString, ntpSysRootDispersion=ntpSysRootDispersion, symmTTM=symmTTM, ntpSysFreq=ntpSysFreq, ntpSysPrecision=ntpSysPrecision, gpsSatlist=gpsSatlist, experiment=experiment, ntpSysProcessor=ntpSysProcessor)
