...
Counter32, NotificationType, ObjectIdentity, Unsigned32, IpAddress, Integer32, NotificationType, iso, Bits, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "ObjectIdentity", "Unsigned32", "IpAddress", "Integer32", "NotificationType", "iso", "Bits", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysProcessor=ntpSysProcessor, etcSerialNbr=etcSerialNbr, etcAlarmString=etcAlarmString, ntpSystem=ntpSystem, tymingSource=tymingSource, gpsHealth=gpsHealth, products=products, gpsPosition=gpsPosition, etcAlarm=etcAlarm, ntpSysPeer=ntpSysPeer, ntpSysPoll=ntpSysPoll, version=version, ntpSysRefTime=ntpSysRefTime, xli=xli, ntpSysClock=ntpSysClock, symmTimePictra=symmTimePictra, ts2000=ts2000, ntpSysRefID=ntpSysRefID, tymingStatus=tymingStatus, ntpSysStratum=ntpSysStratum, tymingTime=tymingTime, etc=etc, tymingFlyPeriod=tymingFlyPeriod, ts2100=ts2100, syncserver=syncserver, ntpSysError=ntpSysError, symmTTM=symmTTM, symmCmipManagement=symmCmipManagement, tyming=tyming, dialup=dialup, ntpSysPktsReceived=ntpSysPktsReceived, symmSnmpManagement=symmSnmpManagement, ntpSysRootDispersion=ntpSysRootDispersion, gpsSatlist=gpsSatlist, PYSNMP_MODULE_ID=symmetricom, ntpSysNotrust=ntpSysNotrust, experiment=experiment, ntpSysSystem=ntpSysSystem, gpsUTCOffset=gpsUTCOffset, ntpSysLeap=ntpSysLeap, symmBroadband=symmBroadband, ntpSysPrecision=ntpSysPrecision, etcUpgradeServer=etcUpgradeServer, ntpSysVersion=ntpSysVersion, symmetricom=symmetricom, tymingVersion=tymingVersion, symmNetworkManagement=symmNetworkManagement, etcUpgrade=etcUpgrade, nts=nts, ntpSysPhase=ntpSysPhase, net=net, ntpSysFreq=ntpSysFreq, gpsMode=gpsMode, s100=s100, etcVersion=etcVersion, ntpSysRootDelay=ntpSysRootDelay, gps=gps, etcModel=etcModel, ntpSysMode=ntpSysMode)
