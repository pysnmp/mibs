...
Unsigned32, iso, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, NotificationType, Bits, ModuleIdentity, ObjectIdentity, Counter32, NotificationType, TimeTicks, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "NotificationType", "Bits", "ModuleIdentity", "ObjectIdentity", "Counter32", "NotificationType", "TimeTicks", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsMode=gpsMode, symmetricom=symmetricom, tyming=tyming, gpsHealth=gpsHealth, ntpSystem=ntpSystem, ntpSysNotrust=ntpSysNotrust, ntpSysRootDispersion=ntpSysRootDispersion, etcModel=etcModel, xli=xli, gpsPosition=gpsPosition, etcAlarmString=etcAlarmString, ntpSysMode=ntpSysMode, ntpSysPeer=ntpSysPeer, ntpSysPktsReceived=ntpSysPktsReceived, etcVersion=etcVersion, tymingVersion=tymingVersion, ts2100=ts2100, syncserver=syncserver, etc=etc, etcSerialNbr=etcSerialNbr, symmNetworkManagement=symmNetworkManagement, symmTTM=symmTTM, gpsSatlist=gpsSatlist, ntpSysError=ntpSysError, ntpSysPhase=ntpSysPhase, ntpSysPrecision=ntpSysPrecision, products=products, etcUpgradeServer=etcUpgradeServer, dialup=dialup, net=net, ntpSysRefTime=ntpSysRefTime, ntpSysRootDelay=ntpSysRootDelay, etcAlarm=etcAlarm, symmBroadband=symmBroadband, gps=gps, ntpSysLeap=ntpSysLeap, symmTimePictra=symmTimePictra, symmSnmpManagement=symmSnmpManagement, ntpSysSystem=ntpSysSystem, gpsUTCOffset=gpsUTCOffset, etcUpgrade=etcUpgrade, tymingFlyPeriod=tymingFlyPeriod, PYSNMP_MODULE_ID=symmetricom, ntpSysPoll=ntpSysPoll, tymingStatus=tymingStatus, tymingSource=tymingSource, nts=nts, ntpSysProcessor=ntpSysProcessor, s100=s100, symmCmipManagement=symmCmipManagement, ntpSysClock=ntpSysClock, ts2000=ts2000, ntpSysVersion=ntpSysVersion, experiment=experiment, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, tymingTime=tymingTime, version=version, ntpSysFreq=ntpSysFreq)
