...
Unsigned32, IpAddress, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, MibIdentifier, NotificationType, TimeTicks, NotificationType, Counter32, Bits, enterprises, Gauge32, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "NotificationType", "Counter32", "Bits", "enterprises", "Gauge32", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", etcModel=etcModel, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysNotrust=ntpSysNotrust, ntpSysPhase=ntpSysPhase, tymingStatus=tymingStatus, etcVersion=etcVersion, version=version, etc=etc, tymingVersion=tymingVersion, ntpSysLeap=ntpSysLeap, symmSnmpManagement=symmSnmpManagement, symmNetworkManagement=symmNetworkManagement, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDelay=ntpSysRootDelay, tymingSource=tymingSource, ntpSysPrecision=ntpSysPrecision, symmTTM=symmTTM, etcSerialNbr=etcSerialNbr, gps=gps, ts2000=ts2000, tyming=tyming, xli=xli, ntpSysStratum=ntpSysStratum, symmCmipManagement=symmCmipManagement, gpsPosition=gpsPosition, ntpSysRefTime=ntpSysRefTime, etcAlarmString=etcAlarmString, ntpSysClock=ntpSysClock, ntpSysRefID=ntpSysRefID, etcAlarm=etcAlarm, ntpSysError=ntpSysError, gpsMode=gpsMode, symmBroadband=symmBroadband, tymingFlyPeriod=tymingFlyPeriod, products=products, gpsHealth=gpsHealth, gpsSatlist=gpsSatlist, ntpSysPoll=ntpSysPoll, ntpSystem=ntpSystem, s100=s100, gpsUTCOffset=gpsUTCOffset, nts=nts, experiment=experiment, dialup=dialup, ntpSysProcessor=ntpSysProcessor, net=net, ntpSysSystem=ntpSysSystem, ntpSysVersion=ntpSysVersion, etcUpgradeServer=etcUpgradeServer, syncserver=syncserver, ntpSysFreq=ntpSysFreq, ts2100=ts2100, ntpSysRootDispersion=ntpSysRootDispersion, symmetricom=symmetricom, ntpSysMode=ntpSysMode, symmTimePictra=symmTimePictra, tymingTime=tymingTime, ntpSysPeer=ntpSysPeer, etcUpgrade=etcUpgrade)
