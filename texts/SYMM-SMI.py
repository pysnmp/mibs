...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysVersion=ntpSysVersion, symmTTM=symmTTM, tyming=tyming, symmTimePictra=symmTimePictra, gpsPosition=gpsPosition, PYSNMP_MODULE_ID=symmetricom, symmCmipManagement=symmCmipManagement, dialup=dialup, gps=gps, etc=etc, ntpSysStratum=ntpSysStratum, etcSerialNbr=etcSerialNbr, ts2100=ts2100, gpsSatlist=gpsSatlist, ntpSysRefTime=ntpSysRefTime, ntpSysError=ntpSysError, ntpSysRootDelay=ntpSysRootDelay, ntpSysNotrust=ntpSysNotrust, tymingTime=tymingTime, etcUpgradeServer=etcUpgradeServer, net=net, products=products, gpsHealth=gpsHealth, ntpSysRefID=ntpSysRefID, ntpSysLeap=ntpSysLeap, ntpSysSystem=ntpSysSystem, tymingVersion=tymingVersion, etcAlarmString=etcAlarmString, ts2000=ts2000, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, ntpSysClock=ntpSysClock, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, experiment=experiment, xli=xli, version=version, syncserver=syncserver, symmNetworkManagement=symmNetworkManagement, ntpSysProcessor=ntpSysProcessor, etcUpgrade=etcUpgrade, ntpSysPhase=ntpSysPhase, ntpSysPrecision=ntpSysPrecision, ntpSysPeer=ntpSysPeer, ntpSysFreq=ntpSysFreq, etcAlarm=etcAlarm, symmBroadband=symmBroadband, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, ntpSysMode=ntpSysMode, ntpSysPktsReceived=ntpSysPktsReceived, etcVersion=etcVersion, symmetricom=symmetricom, s100=s100, gpsUTCOffset=gpsUTCOffset, nts=nts, ntpSystem=ntpSystem, gpsMode=gpsMode, etcModel=etcModel)
