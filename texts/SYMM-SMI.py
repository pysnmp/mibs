...
NotificationType, ObjectIdentity, MibIdentifier, TimeTicks, Counter32, IpAddress, Counter64, Integer32, enterprises, iso, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Counter32", "IpAddress", "Counter64", "Integer32", "enterprises", "iso", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysStratum=ntpSysStratum, ntpSysProcessor=ntpSysProcessor, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgrade=etcUpgrade, s100=s100, gpsHealth=gpsHealth, ntpSysNotrust=ntpSysNotrust, gpsUTCOffset=gpsUTCOffset, net=net, products=products, symmTimePictra=symmTimePictra, ntpSysLeap=ntpSysLeap, xli=xli, gpsMode=gpsMode, etcUpgradeServer=etcUpgradeServer, symmSnmpManagement=symmSnmpManagement, syncserver=syncserver, symmBroadband=symmBroadband, symmNetworkManagement=symmNetworkManagement, ntpSysError=ntpSysError, symmetricom=symmetricom, ntpSysPrecision=ntpSysPrecision, ntpSysMode=ntpSysMode, gpsPosition=gpsPosition, ntpSysSystem=ntpSysSystem, ts2000=ts2000, ntpSysFreq=ntpSysFreq, nts=nts, ntpSysRefID=ntpSysRefID, tymingTime=tymingTime, ts2100=ts2100, etc=etc, etcAlarm=etcAlarm, dialup=dialup, ntpSysPeer=ntpSysPeer, etcModel=etcModel, symmCmipManagement=symmCmipManagement, ntpSysClock=ntpSysClock, PYSNMP_MODULE_ID=symmetricom, tymingStatus=tymingStatus, version=version, etcSerialNbr=etcSerialNbr, ntpSysVersion=ntpSysVersion, ntpSysRootDelay=ntpSysRootDelay, gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, gpsSatlist=gpsSatlist, etcAlarmString=etcAlarmString, ntpSysPhase=ntpSysPhase, experiment=experiment, tymingFlyPeriod=tymingFlyPeriod, ntpSystem=ntpSystem, etcVersion=etcVersion, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, ntpSysRefTime=ntpSysRefTime, tymingVersion=tymingVersion, symmTTM=symmTTM, tyming=tyming)
