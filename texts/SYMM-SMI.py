...
mibBuilder.exportSymbols("SYMM-SMI", products=products, nts=nts, ntpSysMode=ntpSysMode, ts2000=ts2000, gpsHealth=gpsHealth, gpsUTCOffset=gpsUTCOffset, ntpSysRefID=ntpSysRefID, gpsSatlist=gpsSatlist, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, version=version, ntpSysRootDelay=ntpSysRootDelay, ntpSysRefTime=ntpSysRefTime, symmSnmpManagement=symmSnmpManagement, symmCmipManagement=symmCmipManagement, ntpSysClock=ntpSysClock, dialup=dialup, ntpSysPrecision=ntpSysPrecision, gps=gps, tymingVersion=tymingVersion, ntpSysLeap=ntpSysLeap, ntpSysPktsReceived=ntpSysPktsReceived, etc=etc, gpsPosition=gpsPosition, etcUpgrade=etcUpgrade, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, etcAlarm=etcAlarm, ntpSystem=ntpSystem, ntpSysStratum=ntpSysStratum, tymingSource=tymingSource, gpsMode=gpsMode, symmTimePictra=symmTimePictra, symmBroadband=symmBroadband, ntpSysVersion=ntpSysVersion, ntpSysSystem=ntpSysSystem, net=net, ntpSysError=ntpSysError, tymingFlyPeriod=tymingFlyPeriod, symmNetworkManagement=symmNetworkManagement, etcUpgradeServer=etcUpgradeServer, ntpSysFreq=ntpSysFreq, s100=s100, tymingTime=tymingTime, ntpSysPoll=ntpSysPoll, PYSNMP_MODULE_ID=symmetricom, ntpSysProcessor=ntpSysProcessor, etcVersion=etcVersion, ntpSysNotrust=ntpSysNotrust, etcSerialNbr=etcSerialNbr, etcModel=etcModel, ntpSysPeer=ntpSysPeer, symmetricom=symmetricom, xli=xli, experiment=experiment, tyming=tyming, ts2100=ts2100, syncserver=syncserver, ntpSysRootDispersion=ntpSysRootDispersion)
