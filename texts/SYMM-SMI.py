...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Counter32, Integer32, ObjectIdentity, Bits, NotificationType, ModuleIdentity, TimeTicks, Gauge32, MibIdentifier, Unsigned32, Counter64, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Counter32", "Integer32", "ObjectIdentity", "Bits", "NotificationType", "ModuleIdentity", "TimeTicks", "Gauge32", "MibIdentifier", "Unsigned32", "Counter64", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", gps=gps, ntpSysClock=ntpSysClock, experiment=experiment, ntpSysStratum=ntpSysStratum, etc=etc, etcModel=etcModel, ntpSysError=ntpSysError, tymingVersion=tymingVersion, ntpSysRefTime=ntpSysRefTime, ntpSysProcessor=ntpSysProcessor, gpsSatlist=gpsSatlist, ntpSysVersion=ntpSysVersion, tyming=tyming, ntpSysPrecision=ntpSysPrecision, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, ntpSysNotrust=ntpSysNotrust, ntpSysMode=ntpSysMode, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, ntpSysPktsReceived=ntpSysPktsReceived, symmCmipManagement=symmCmipManagement, tymingStatus=tymingStatus, nts=nts, ntpSysRootDelay=ntpSysRootDelay, PYSNMP_MODULE_ID=symmetricom, symmSnmpManagement=symmSnmpManagement, ntpSysRootDispersion=ntpSysRootDispersion, symmetricom=symmetricom, ts2000=ts2000, gpsUTCOffset=gpsUTCOffset, tymingSource=tymingSource, gpsMode=gpsMode, ntpSysSystem=ntpSysSystem, etcAlarm=etcAlarm, ntpSysPoll=ntpSysPoll, etcUpgrade=etcUpgrade, ts2100=ts2100, gpsPosition=gpsPosition, syncserver=syncserver, tymingTime=tymingTime, symmNetworkManagement=symmNetworkManagement, ntpSystem=ntpSystem, gpsHealth=gpsHealth, products=products, xli=xli, ntpSysPeer=ntpSysPeer, etcAlarmString=etcAlarmString, symmTTM=symmTTM, ntpSysRefID=ntpSysRefID, ntpSysFreq=ntpSysFreq, symmBroadband=symmBroadband, dialup=dialup, version=version, symmTimePictra=symmTimePictra, net=net, s100=s100, ntpSysPhase=ntpSysPhase, etcSerialNbr=etcSerialNbr)
