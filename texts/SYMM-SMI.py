...
Gauge32, Integer32, iso, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, IpAddress, MibIdentifier, NotificationType, Unsigned32, TimeTicks, Bits, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "iso", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "IpAddress", "MibIdentifier", "NotificationType", "Unsigned32", "TimeTicks", "Bits", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", etcAlarmString=etcAlarmString, net=net, tyming=tyming, gps=gps, ntpSysRefID=ntpSysRefID, ntpSysClock=ntpSysClock, symmetricom=symmetricom, ntpSysPeer=ntpSysPeer, ntpSysProcessor=ntpSysProcessor, ntpSysPrecision=ntpSysPrecision, ntpSysSystem=ntpSysSystem, etcSerialNbr=etcSerialNbr, nts=nts, symmSnmpManagement=symmSnmpManagement, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, etcUpgrade=etcUpgrade, ts2100=ts2100, symmTTM=symmTTM, gpsHealth=gpsHealth, ntpSysVersion=ntpSysVersion, ntpSysRootDispersion=ntpSysRootDispersion, symmTimePictra=symmTimePictra, ntpSysError=ntpSysError, ntpSysMode=ntpSysMode, version=version, ntpSysStratum=ntpSysStratum, etc=etc, s100=s100, ntpSystem=ntpSystem, ntpSysPhase=ntpSysPhase, dialup=dialup, ntpSysPoll=ntpSysPoll, xli=xli, etcUpgradeServer=etcUpgradeServer, tymingTime=tymingTime, PYSNMP_MODULE_ID=symmetricom, ntpSysLeap=ntpSysLeap, ntpSysNotrust=ntpSysNotrust, gpsMode=gpsMode, gpsPosition=gpsPosition, ntpSysRootDelay=ntpSysRootDelay, tymingFlyPeriod=tymingFlyPeriod, gpsUTCOffset=gpsUTCOffset, symmNetworkManagement=symmNetworkManagement, ntpSysRefTime=ntpSysRefTime, tymingVersion=tymingVersion, etcVersion=etcVersion, etcModel=etcModel, products=products, ts2000=ts2000, tymingStatus=tymingStatus, etcAlarm=etcAlarm, syncserver=syncserver, symmBroadband=symmBroadband, gpsSatlist=gpsSatlist, experiment=experiment, symmCmipManagement=symmCmipManagement, ntpSysFreq=ntpSysFreq)
