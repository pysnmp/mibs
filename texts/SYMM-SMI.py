...
Counter32, Unsigned32, IpAddress, Integer32, Counter64, NotificationType, NotificationType, iso, enterprises, TimeTicks, ModuleIdentity, Bits, MibIdentifier, ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Unsigned32", "IpAddress", "Integer32", "Counter64", "NotificationType", "NotificationType", "iso", "enterprises", "TimeTicks", "ModuleIdentity", "Bits", "MibIdentifier", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysError=ntpSysError, symmBroadband=symmBroadband, etcUpgrade=etcUpgrade, products=products, tyming=tyming, dialup=dialup, net=net, ntpSysPrecision=ntpSysPrecision, etcModel=etcModel, etcAlarm=etcAlarm, ntpSysRefID=ntpSysRefID, ntpSystem=ntpSystem, symmSnmpManagement=symmSnmpManagement, symmTTM=symmTTM, ntpSysPoll=ntpSysPoll, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, ntpSysPeer=ntpSysPeer, etcVersion=etcVersion, xli=xli, etcAlarmString=etcAlarmString, ntpSysProcessor=ntpSysProcessor, experiment=experiment, gpsUTCOffset=gpsUTCOffset, s100=s100, symmTimePictra=symmTimePictra, ntpSysMode=ntpSysMode, ntpSysFreq=ntpSysFreq, tymingVersion=tymingVersion, ntpSysSystem=ntpSysSystem, ntpSysStratum=ntpSysStratum, ntpSysRootDispersion=ntpSysRootDispersion, tymingTime=tymingTime, ntpSysClock=ntpSysClock, PYSNMP_MODULE_ID=symmetricom, gps=gps, tymingFlyPeriod=tymingFlyPeriod, nts=nts, ntpSysNotrust=ntpSysNotrust, ts2100=ts2100, syncserver=syncserver, etcSerialNbr=etcSerialNbr, ntpSysPhase=ntpSysPhase, gpsHealth=gpsHealth, ntpSysVersion=ntpSysVersion, etc=etc, symmCmipManagement=symmCmipManagement, gpsSatlist=gpsSatlist, gpsMode=gpsMode, tymingStatus=tymingStatus, version=version, ntpSysLeap=ntpSysLeap, tymingSource=tymingSource, symmetricom=symmetricom, ts2000=ts2000, gpsPosition=gpsPosition, ntpSysRefTime=ntpSysRefTime, ntpSysRootDelay=ntpSysRootDelay, ntpSysPktsReceived=ntpSysPktsReceived)
