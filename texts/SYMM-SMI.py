...
Integer32, Bits, Counter32, ModuleIdentity, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, IpAddress, Gauge32, ObjectIdentity, Unsigned32, MibIdentifier, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Counter32", "ModuleIdentity", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "IpAddress", "Gauge32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "iso", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", nts=nts, dialup=dialup, etcVersion=etcVersion, gps=gps, net=net, etcUpgradeServer=etcUpgradeServer, ntpSysRootDelay=ntpSysRootDelay, ntpSysPhase=ntpSysPhase, etcModel=etcModel, ntpSysFreq=ntpSysFreq, ntpSysPrecision=ntpSysPrecision, etcUpgrade=etcUpgrade, xli=xli, gpsPosition=gpsPosition, tymingStatus=tymingStatus, version=version, etcAlarm=etcAlarm, symmCmipManagement=symmCmipManagement, tymingTime=tymingTime, symmTimePictra=symmTimePictra, ntpSysClock=ntpSysClock, symmSnmpManagement=symmSnmpManagement, ntpSysRefTime=ntpSysRefTime, syncserver=syncserver, etcSerialNbr=etcSerialNbr, tymingFlyPeriod=tymingFlyPeriod, ntpSysPeer=ntpSysPeer, experiment=experiment, ntpSystem=ntpSystem, symmNetworkManagement=symmNetworkManagement, etc=etc, products=products, ntpSysStratum=ntpSysStratum, ntpSysMode=ntpSysMode, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, ntpSysPoll=ntpSysPoll, s100=s100, ts2000=ts2000, symmBroadband=symmBroadband, ntpSysNotrust=ntpSysNotrust, gpsUTCOffset=gpsUTCOffset, etcAlarmString=etcAlarmString, ntpSysRootDispersion=ntpSysRootDispersion, symmetricom=symmetricom, gpsHealth=gpsHealth, tymingVersion=tymingVersion, ts2100=ts2100, gpsMode=gpsMode, PYSNMP_MODULE_ID=symmetricom, ntpSysLeap=ntpSysLeap, ntpSysRefID=ntpSysRefID, tyming=tyming, symmTTM=symmTTM, ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, gpsSatlist=gpsSatlist, ntpSysProcessor=ntpSysProcessor, ntpSysVersion=ntpSysVersion)
