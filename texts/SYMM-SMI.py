...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, Bits, NotificationType, ModuleIdentity, IpAddress, ObjectIdentity, Integer32, TimeTicks, MibIdentifier, iso, NotificationType, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "Bits", "NotificationType", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Integer32", "TimeTicks", "MibIdentifier", "iso", "NotificationType", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("SYMM-SMI", symmetricom=symmetricom, ntpSysError=ntpSysError, s100=s100, PYSNMP_MODULE_ID=symmetricom, ntpSysNotrust=ntpSysNotrust, version=version, syncserver=syncserver, gpsPosition=gpsPosition, etcUpgrade=etcUpgrade, gpsHealth=gpsHealth, gpsSatlist=gpsSatlist, symmBroadband=symmBroadband, ntpSysPrecision=ntpSysPrecision, ntpSysProcessor=ntpSysProcessor, symmNetworkManagement=symmNetworkManagement, gpsMode=gpsMode, tymingStatus=tymingStatus, gpsUTCOffset=gpsUTCOffset, net=net, ts2100=ts2100, etcModel=etcModel, etc=etc, products=products, tymingFlyPeriod=tymingFlyPeriod, ntpSystem=ntpSystem, gps=gps, ntpSysPeer=ntpSysPeer, etcSerialNbr=etcSerialNbr, etcUpgradeServer=etcUpgradeServer, symmTimePictra=symmTimePictra, experiment=experiment, ntpSysPktsReceived=ntpSysPktsReceived, dialup=dialup, tyming=tyming, symmTTM=symmTTM, ntpSysRefTime=ntpSysRefTime, symmSnmpManagement=symmSnmpManagement, ntpSysVersion=ntpSysVersion, ntpSysStratum=ntpSysStratum, ntpSysFreq=ntpSysFreq, tymingTime=tymingTime, ntpSysPoll=ntpSysPoll, ntpSysPhase=ntpSysPhase, ntpSysClock=ntpSysClock, ntpSysMode=ntpSysMode, nts=nts, ts2000=ts2000, symmCmipManagement=symmCmipManagement, tymingSource=tymingSource, ntpSysRefID=ntpSysRefID, ntpSysSystem=ntpSysSystem, xli=xli, etcVersion=etcVersion, tymingVersion=tymingVersion, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysLeap=ntpSysLeap, etcAlarm=etcAlarm, etcAlarmString=etcAlarmString, ntpSysRootDelay=ntpSysRootDelay)
