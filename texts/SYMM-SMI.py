...
ModuleIdentity, TimeTicks, Counter32, NotificationType, NotificationType, Unsigned32, Gauge32, iso, MibIdentifier, Bits, ObjectIdentity, enterprises, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Counter32", "NotificationType", "NotificationType", "Unsigned32", "Gauge32", "iso", "MibIdentifier", "Bits", "ObjectIdentity", "enterprises", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsHealth=gpsHealth, symmetricom=symmetricom, ntpSysSystem=ntpSysSystem, tymingVersion=tymingVersion, ntpSysPoll=ntpSysPoll, version=version, ntpSysLeap=ntpSysLeap, ntpSysPrecision=ntpSysPrecision, symmNetworkManagement=symmNetworkManagement, ntpSysPhase=ntpSysPhase, etcAlarm=etcAlarm, ntpSysStratum=ntpSysStratum, etcAlarmString=etcAlarmString, PYSNMP_MODULE_ID=symmetricom, gpsUTCOffset=gpsUTCOffset, xli=xli, s100=s100, ntpSysVersion=ntpSysVersion, symmTimePictra=symmTimePictra, symmTTM=symmTTM, gpsMode=gpsMode, ntpSysPktsReceived=ntpSysPktsReceived, etc=etc, tymingFlyPeriod=tymingFlyPeriod, symmCmipManagement=symmCmipManagement, experiment=experiment, tymingTime=tymingTime, etcUpgrade=etcUpgrade, symmSnmpManagement=symmSnmpManagement, gpsPosition=gpsPosition, nts=nts, ntpSysRefTime=ntpSysRefTime, ts2100=ts2100, ntpSysRootDispersion=ntpSysRootDispersion, gpsSatlist=gpsSatlist, syncserver=syncserver, etcUpgradeServer=etcUpgradeServer, etcModel=etcModel, ntpSysPeer=ntpSysPeer, ntpSysFreq=ntpSysFreq, net=net, ntpSysRefID=ntpSysRefID, dialup=dialup, ntpSysRootDelay=ntpSysRootDelay, ntpSysClock=ntpSysClock, etcVersion=etcVersion, ts2000=ts2000, gps=gps, ntpSysError=ntpSysError, products=products, ntpSystem=ntpSystem, ntpSysProcessor=ntpSysProcessor, tymingStatus=tymingStatus, tymingSource=tymingSource, etcSerialNbr=etcSerialNbr, tyming=tyming, ntpSysNotrust=ntpSysNotrust, symmBroadband=symmBroadband, ntpSysMode=ntpSysMode)
