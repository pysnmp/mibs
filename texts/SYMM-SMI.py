...
enterprises, Integer32, MibIdentifier, Bits, Unsigned32, IpAddress, Counter32, Gauge32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, ObjectIdentity, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Integer32", "MibIdentifier", "Bits", "Unsigned32", "IpAddress", "Counter32", "Gauge32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "ObjectIdentity", "iso", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", version=version, tymingTime=tymingTime, etcUpgrade=etcUpgrade, nts=nts, ntpSysPoll=ntpSysPoll, ntpSysError=ntpSysError, etcModel=etcModel, symmTimePictra=symmTimePictra, etc=etc, tymingFlyPeriod=tymingFlyPeriod, ntpSysPhase=ntpSysPhase, symmSnmpManagement=symmSnmpManagement, ntpSysPrecision=ntpSysPrecision, symmBroadband=symmBroadband, syncserver=syncserver, etcAlarmString=etcAlarmString, symmNetworkManagement=symmNetworkManagement, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysClock=ntpSysClock, tymingSource=tymingSource, experiment=experiment, ntpSysSystem=ntpSysSystem, tyming=tyming, dialup=dialup, gps=gps, xli=xli, ntpSysRefTime=ntpSysRefTime, products=products, ntpSysPeer=ntpSysPeer, symmetricom=symmetricom, ntpSystem=ntpSystem, ntpSysRefID=ntpSysRefID, ntpSysVersion=ntpSysVersion, gpsUTCOffset=gpsUTCOffset, gpsSatlist=gpsSatlist, etcVersion=etcVersion, symmTTM=symmTTM, gpsPosition=gpsPosition, ntpSysFreq=ntpSysFreq, net=net, s100=s100, etcSerialNbr=etcSerialNbr, ts2100=ts2100, ntpSysMode=ntpSysMode, ntpSysStratum=ntpSysStratum, PYSNMP_MODULE_ID=symmetricom, ntpSysProcessor=ntpSysProcessor, ts2000=ts2000, tymingVersion=tymingVersion, gpsHealth=gpsHealth, gpsMode=gpsMode, etcAlarm=etcAlarm, symmCmipManagement=symmCmipManagement, ntpSysRootDelay=ntpSysRootDelay, ntpSysPktsReceived=ntpSysPktsReceived, tymingStatus=tymingStatus, ntpSysLeap=ntpSysLeap, etcUpgradeServer=etcUpgradeServer, ntpSysNotrust=ntpSysNotrust)
