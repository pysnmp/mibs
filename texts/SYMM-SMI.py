...
mibBuilder.exportSymbols("SYMM-SMI", symmetricom=symmetricom, ntpSysRefID=ntpSysRefID, gpsUTCOffset=gpsUTCOffset, etcModel=etcModel, ntpSysRootDelay=ntpSysRootDelay, etcUpgrade=etcUpgrade, s100=s100, etcUpgradeServer=etcUpgradeServer, syncserver=syncserver, net=net, ntpSysPoll=ntpSysPoll, symmTimePictra=symmTimePictra, ntpSysClock=ntpSysClock, ntpSysPhase=ntpSysPhase, ntpSysSystem=ntpSysSystem, ntpSysMode=ntpSysMode, tymingTime=tymingTime, products=products, etcSerialNbr=etcSerialNbr, ntpSysPrecision=ntpSysPrecision, symmTTM=symmTTM, tymingFlyPeriod=tymingFlyPeriod, experiment=experiment, ntpSysPeer=ntpSysPeer, ntpSysFreq=ntpSysFreq, symmNetworkManagement=symmNetworkManagement, ts2000=ts2000, dialup=dialup, ts2100=ts2100, ntpSysVersion=ntpSysVersion, gpsHealth=gpsHealth, tymingStatus=tymingStatus, ntpSystem=ntpSystem, PYSNMP_MODULE_ID=symmetricom, etc=etc, symmCmipManagement=symmCmipManagement, symmSnmpManagement=symmSnmpManagement, gps=gps, ntpSysProcessor=ntpSysProcessor, ntpSysError=ntpSysError, etcVersion=etcVersion, gpsPosition=gpsPosition, ntpSysRootDispersion=ntpSysRootDispersion, symmBroadband=symmBroadband, ntpSysRefTime=ntpSysRefTime, version=version, etcAlarmString=etcAlarmString, tyming=tyming, nts=nts, ntpSysStratum=ntpSysStratum, gpsMode=gpsMode, xli=xli, ntpSysPktsReceived=ntpSysPktsReceived, tymingVersion=tymingVersion, ntpSysNotrust=ntpSysNotrust, tymingSource=tymingSource, etcAlarm=etcAlarm, gpsSatlist=gpsSatlist, ntpSysLeap=ntpSysLeap)
