...
ObjectIdentity, Counter64, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Unsigned32, NotificationType, NotificationType, Integer32, Counter32, Gauge32, MibIdentifier, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Unsigned32", "NotificationType", "NotificationType", "Integer32", "Counter32", "Gauge32", "MibIdentifier", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("SYMM-SMI", tymingStatus=tymingStatus, gpsUTCOffset=gpsUTCOffset, gpsHealth=gpsHealth, net=net, ntpSysFreq=ntpSysFreq, etcUpgrade=etcUpgrade, symmTTM=symmTTM, products=products, tymingVersion=tymingVersion, nts=nts, etcVersion=etcVersion, gpsSatlist=gpsSatlist, PYSNMP_MODULE_ID=symmetricom, syncserver=syncserver, etc=etc, gpsPosition=gpsPosition, ntpSysRootDelay=ntpSysRootDelay, ntpSysLeap=ntpSysLeap, xli=xli, tymingSource=tymingSource, gpsMode=gpsMode, etcAlarm=etcAlarm, symmTimePictra=symmTimePictra, ntpSysVersion=ntpSysVersion, tymingTime=tymingTime, ntpSysPeer=ntpSysPeer, ntpSysPhase=ntpSysPhase, ntpSystem=ntpSystem, s100=s100, symmNetworkManagement=symmNetworkManagement, symmSnmpManagement=symmSnmpManagement, ntpSysRefTime=ntpSysRefTime, etcUpgradeServer=etcUpgradeServer, symmetricom=symmetricom, ntpSysPrecision=ntpSysPrecision, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysSystem=ntpSysSystem, ts2100=ts2100, tyming=tyming, ntpSysError=ntpSysError, ntpSysMode=ntpSysMode, symmBroadband=symmBroadband, etcSerialNbr=etcSerialNbr, ntpSysNotrust=ntpSysNotrust, symmCmipManagement=symmCmipManagement, version=version, ts2000=ts2000, etcModel=etcModel, ntpSysPoll=ntpSysPoll, tymingFlyPeriod=tymingFlyPeriod, gps=gps, ntpSysRefID=ntpSysRefID, ntpSysStratum=ntpSysStratum, dialup=dialup, etcAlarmString=etcAlarmString, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, ntpSysPktsReceived=ntpSysPktsReceived, experiment=experiment)
