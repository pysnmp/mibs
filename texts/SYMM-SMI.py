...
Integer32, NotificationType, Gauge32, NotificationType, enterprises, Counter32, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, iso, TimeTicks, IpAddress, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Gauge32", "NotificationType", "enterprises", "Counter32", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "iso", "TimeTicks", "IpAddress", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", symmNetworkManagement=symmNetworkManagement, ntpSysError=ntpSysError, products=products, ntpSysPoll=ntpSysPoll, ts2100=ts2100, symmBroadband=symmBroadband, xli=xli, ntpSysNotrust=ntpSysNotrust, gpsSatlist=gpsSatlist, tyming=tyming, version=version, symmSnmpManagement=symmSnmpManagement, etc=etc, syncserver=syncserver, s100=s100, ts2000=ts2000, gps=gps, ntpSysStratum=ntpSysStratum, etcAlarmString=etcAlarmString, ntpSysRootDelay=ntpSysRootDelay, PYSNMP_MODULE_ID=symmetricom, etcModel=etcModel, ntpSysVersion=ntpSysVersion, ntpSysPhase=ntpSysPhase, gpsPosition=gpsPosition, ntpSysSystem=ntpSysSystem, tymingStatus=tymingStatus, ntpSysProcessor=ntpSysProcessor, etcVersion=etcVersion, etcSerialNbr=etcSerialNbr, ntpSysRefTime=ntpSysRefTime, experiment=experiment, ntpSystem=ntpSystem, etcAlarm=etcAlarm, symmCmipManagement=symmCmipManagement, etcUpgrade=etcUpgrade, dialup=dialup, tymingSource=tymingSource, symmTTM=symmTTM, gpsHealth=gpsHealth, etcUpgradeServer=etcUpgradeServer, ntpSysClock=ntpSysClock, ntpSysLeap=ntpSysLeap, net=net, symmTimePictra=symmTimePictra, ntpSysRefID=ntpSysRefID, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysMode=ntpSysMode, nts=nts, gpsUTCOffset=gpsUTCOffset, ntpSysFreq=ntpSysFreq, tymingVersion=tymingVersion, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPeer=ntpSysPeer, tymingFlyPeriod=tymingFlyPeriod, symmetricom=symmetricom, ntpSysPrecision=ntpSysPrecision, tymingTime=tymingTime, gpsMode=gpsMode)
