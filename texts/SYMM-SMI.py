...
iso, ObjectIdentity, ModuleIdentity, Integer32, NotificationType, MibIdentifier, Unsigned32, Counter64, TimeTicks, NotificationType, enterprises, IpAddress, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "ModuleIdentity", "Integer32", "NotificationType", "MibIdentifier", "Unsigned32", "Counter64", "TimeTicks", "NotificationType", "enterprises", "IpAddress", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", gps=gps, ntpSysPhase=ntpSysPhase, gpsUTCOffset=gpsUTCOffset, s100=s100, ntpSysClock=ntpSysClock, experiment=experiment, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, ntpSysVersion=ntpSysVersion, etcUpgradeServer=etcUpgradeServer, ntpSysError=ntpSysError, gpsSatlist=gpsSatlist, tymingTime=tymingTime, gpsPosition=gpsPosition, tymingStatus=tymingStatus, PYSNMP_MODULE_ID=symmetricom, xli=xli, ntpSysRootDispersion=ntpSysRootDispersion, tymingSource=tymingSource, symmetricom=symmetricom, ts2000=ts2000, tymingVersion=tymingVersion, etcModel=etcModel, symmSnmpManagement=symmSnmpManagement, etc=etc, syncserver=syncserver, ntpSystem=ntpSystem, tymingFlyPeriod=tymingFlyPeriod, gpsHealth=gpsHealth, ntpSysPoll=ntpSysPoll, ntpSysMode=ntpSysMode, ntpSysStratum=ntpSysStratum, ntpSysRefTime=ntpSysRefTime, ntpSysFreq=ntpSysFreq, nts=nts, dialup=dialup, etcUpgrade=etcUpgrade, ntpSysProcessor=ntpSysProcessor, symmBroadband=symmBroadband, ntpSysRootDelay=ntpSysRootDelay, ntpSysNotrust=ntpSysNotrust, ntpSysSystem=ntpSysSystem, net=net, products=products, symmTimePictra=symmTimePictra, ts2100=ts2100, symmNetworkManagement=symmNetworkManagement, symmTTM=symmTTM, ntpSysPktsReceived=ntpSysPktsReceived, version=version, gpsMode=gpsMode, etcSerialNbr=etcSerialNbr, tyming=tyming, ntpSysPeer=ntpSysPeer, symmCmipManagement=symmCmipManagement, ntpSysLeap=ntpSysLeap, ntpSysRefID=ntpSysRefID, etcVersion=etcVersion, ntpSysPrecision=ntpSysPrecision)
