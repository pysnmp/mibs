...
NotificationType, Counter32, Gauge32, MibIdentifier, Integer32, ModuleIdentity, Counter64, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, ObjectIdentity, IpAddress, iso, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Gauge32", "MibIdentifier", "Integer32", "ModuleIdentity", "Counter64", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "ObjectIdentity", "IpAddress", "iso", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefID=ntpSysRefID, ntpSysPrecision=ntpSysPrecision, version=version, ntpSystem=ntpSystem, net=net, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, ntpSysMode=ntpSysMode, etcAlarm=etcAlarm, syncserver=syncserver, ntpSysFreq=ntpSysFreq, tymingStatus=tymingStatus, symmetricom=symmetricom, tymingVersion=tymingVersion, gpsPosition=gpsPosition, etcUpgradeServer=etcUpgradeServer, etcAlarmString=etcAlarmString, PYSNMP_MODULE_ID=symmetricom, etc=etc, ntpSysPeer=ntpSysPeer, symmTTM=symmTTM, ntpSysProcessor=ntpSysProcessor, ntpSysClock=ntpSysClock, gpsMode=gpsMode, ntpSysRefTime=ntpSysRefTime, gps=gps, ntpSysError=ntpSysError, ts2000=ts2000, tymingTime=tymingTime, experiment=experiment, ts2100=ts2100, products=products, ntpSysPhase=ntpSysPhase, ntpSysNotrust=ntpSysNotrust, ntpSysPktsReceived=ntpSysPktsReceived, symmNetworkManagement=symmNetworkManagement, tymingSource=tymingSource, etcSerialNbr=etcSerialNbr, nts=nts, symmTimePictra=symmTimePictra, dialup=dialup, ntpSysVersion=ntpSysVersion, symmCmipManagement=symmCmipManagement, s100=s100, symmBroadband=symmBroadband, ntpSysPoll=ntpSysPoll, gpsUTCOffset=gpsUTCOffset, etcVersion=etcVersion, etcModel=etcModel, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, xli=xli, gpsSatlist=gpsSatlist, etcUpgrade=etcUpgrade, symmSnmpManagement=symmSnmpManagement, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysSystem=ntpSysSystem, tyming=tyming, ntpSysStratum=ntpSysStratum)
