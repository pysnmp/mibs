...
Counter64, ObjectIdentity, ModuleIdentity, Bits, Counter32, Unsigned32, iso, enterprises, TimeTicks, Integer32, Gauge32, NotificationType, MibIdentifier, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "ModuleIdentity", "Bits", "Counter32", "Unsigned32", "iso", "enterprises", "TimeTicks", "Integer32", "Gauge32", "NotificationType", "MibIdentifier", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", tymingStatus=tymingStatus, symmTTM=symmTTM, nts=nts, gpsUTCOffset=gpsUTCOffset, etcModel=etcModel, etcUpgrade=etcUpgrade, tymingTime=tymingTime, gpsPosition=gpsPosition, ntpSysVersion=ntpSysVersion, etcVersion=etcVersion, net=net, gpsMode=gpsMode, etcSerialNbr=etcSerialNbr, ntpSystem=ntpSystem, etcAlarmString=etcAlarmString, ntpSysSystem=ntpSysSystem, PYSNMP_MODULE_ID=symmetricom, gpsSatlist=gpsSatlist, ntpSysPhase=ntpSysPhase, ntpSysPrecision=ntpSysPrecision, xli=xli, ntpSysPeer=ntpSysPeer, ntpSysError=ntpSysError, ntpSysNotrust=ntpSysNotrust, syncserver=syncserver, s100=s100, symmetricom=symmetricom, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysFreq=ntpSysFreq, symmBroadband=symmBroadband, tymingSource=tymingSource, ntpSysMode=ntpSysMode, ntpSysRefID=ntpSysRefID, tymingFlyPeriod=tymingFlyPeriod, dialup=dialup, ntpSysProcessor=ntpSysProcessor, ts2100=ts2100, ntpSysRootDispersion=ntpSysRootDispersion, products=products, symmCmipManagement=symmCmipManagement, symmNetworkManagement=symmNetworkManagement, ts2000=ts2000, etcAlarm=etcAlarm, ntpSysLeap=ntpSysLeap, ntpSysStratum=ntpSysStratum, gpsHealth=gpsHealth, ntpSysClock=ntpSysClock, symmSnmpManagement=symmSnmpManagement, gps=gps, etc=etc, ntpSysRefTime=ntpSysRefTime, ntpSysPoll=ntpSysPoll, tymingVersion=tymingVersion, etcUpgradeServer=etcUpgradeServer, tyming=tyming, symmTimePictra=symmTimePictra, version=version, ntpSysRootDelay=ntpSysRootDelay, experiment=experiment)
