...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, NotificationType, Integer32, IpAddress, MibIdentifier, enterprises, Gauge32, Counter32, TimeTicks, NotificationType, Unsigned32, iso, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "NotificationType", "Integer32", "IpAddress", "MibIdentifier", "enterprises", "Gauge32", "Counter32", "TimeTicks", "NotificationType", "Unsigned32", "iso", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", symmCmipManagement=symmCmipManagement, gpsMode=gpsMode, ntpSysPktsReceived=ntpSysPktsReceived, syncserver=syncserver, tymingStatus=tymingStatus, etcModel=etcModel, ntpSysError=ntpSysError, net=net, etcSerialNbr=etcSerialNbr, etc=etc, ntpSysPhase=ntpSysPhase, nts=nts, experiment=experiment, ntpSysFreq=ntpSysFreq, ntpSysClock=ntpSysClock, gpsSatlist=gpsSatlist, tymingTime=tymingTime, ntpSysMode=ntpSysMode, symmTimePictra=symmTimePictra, symmTTM=symmTTM, xli=xli, ntpSystem=ntpSystem, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefTime=ntpSysRefTime, gpsUTCOffset=gpsUTCOffset, gps=gps, version=version, ntpSysRootDelay=ntpSysRootDelay, etcAlarm=etcAlarm, ntpSysRefID=ntpSysRefID, symmetricom=symmetricom, symmSnmpManagement=symmSnmpManagement, ntpSysVersion=ntpSysVersion, etcUpgradeServer=etcUpgradeServer, ts2100=ts2100, ntpSysProcessor=ntpSysProcessor, s100=s100, ntpSysPoll=ntpSysPoll, ntpSysLeap=ntpSysLeap, etcAlarmString=etcAlarmString, tymingSource=tymingSource, etcUpgrade=etcUpgrade, dialup=dialup, symmBroadband=symmBroadband, ntpSysPeer=ntpSysPeer, ntpSysNotrust=ntpSysNotrust, tymingFlyPeriod=tymingFlyPeriod, ntpSysStratum=ntpSysStratum, ntpSysSystem=ntpSysSystem, gpsPosition=gpsPosition, ntpSysPrecision=ntpSysPrecision, PYSNMP_MODULE_ID=symmetricom, gpsHealth=gpsHealth, products=products, symmNetworkManagement=symmNetworkManagement, tymingVersion=tymingVersion, ts2000=ts2000, etcVersion=etcVersion, tyming=tyming)
