...
enterprises, IpAddress, NotificationType, Bits, TimeTicks, Counter64, Gauge32, MibIdentifier, Unsigned32, ModuleIdentity, iso, NotificationType, ObjectIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "NotificationType", "Bits", "TimeTicks", "Counter64", "Gauge32", "MibIdentifier", "Unsigned32", "ModuleIdentity", "iso", "NotificationType", "ObjectIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsPosition=gpsPosition, ntpSysPeer=ntpSysPeer, products=products, ntpSysProcessor=ntpSysProcessor, experiment=experiment, ntpSysClock=ntpSysClock, xli=xli, ntpSysRefID=ntpSysRefID, nts=nts, ntpSysVersion=ntpSysVersion, tyming=tyming, etcUpgradeServer=etcUpgradeServer, tymingStatus=tymingStatus, tymingSource=tymingSource, symmCmipManagement=symmCmipManagement, ntpSysPrecision=ntpSysPrecision, etcModel=etcModel, PYSNMP_MODULE_ID=symmetricom, symmTimePictra=symmTimePictra, etc=etc, ntpSysMode=ntpSysMode, tymingVersion=tymingVersion, tymingFlyPeriod=tymingFlyPeriod, symmSnmpManagement=symmSnmpManagement, etcVersion=etcVersion, etcSerialNbr=etcSerialNbr, ntpSysPhase=ntpSysPhase, ts2000=ts2000, s100=s100, dialup=dialup, ntpSysPoll=ntpSysPoll, tymingTime=tymingTime, etcAlarmString=etcAlarmString, gps=gps, ntpSysSystem=ntpSysSystem, symmBroadband=symmBroadband, net=net, ntpSysLeap=ntpSysLeap, ntpSysNotrust=ntpSysNotrust, gpsHealth=gpsHealth, version=version, symmTTM=symmTTM, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysStratum=ntpSysStratum, ntpSysRootDispersion=ntpSysRootDispersion, gpsMode=gpsMode, symmNetworkManagement=symmNetworkManagement, gpsUTCOffset=gpsUTCOffset, gpsSatlist=gpsSatlist, ntpSysRootDelay=ntpSysRootDelay, syncserver=syncserver, ts2100=ts2100, ntpSysError=ntpSysError, symmetricom=symmetricom, ntpSystem=ntpSystem, etcAlarm=etcAlarm, ntpSysRefTime=ntpSysRefTime, ntpSysFreq=ntpSysFreq, etcUpgrade=etcUpgrade)
