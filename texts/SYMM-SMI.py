...
enterprises, Gauge32, Counter64, Unsigned32, MibIdentifier, ObjectIdentity, NotificationType, ModuleIdentity, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, NotificationType, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "Counter64", "Unsigned32", "MibIdentifier", "ObjectIdentity", "NotificationType", "ModuleIdentity", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "NotificationType", "Integer32", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysMode=ntpSysMode, syncserver=syncserver, symmCmipManagement=symmCmipManagement, etcVersion=etcVersion, tymingFlyPeriod=tymingFlyPeriod, gpsSatlist=gpsSatlist, s100=s100, tyming=tyming, ntpSysRootDelay=ntpSysRootDelay, etcSerialNbr=etcSerialNbr, ntpSysRootDispersion=ntpSysRootDispersion, symmTTM=symmTTM, PYSNMP_MODULE_ID=symmetricom, ntpSysStratum=ntpSysStratum, symmNetworkManagement=symmNetworkManagement, tymingTime=tymingTime, ntpSystem=ntpSystem, ntpSysPktsReceived=ntpSysPktsReceived, tymingVersion=tymingVersion, gpsHealth=gpsHealth, etcUpgrade=etcUpgrade, tymingSource=tymingSource, ntpSysSystem=ntpSysSystem, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, ts2100=ts2100, ntpSysPrecision=ntpSysPrecision, ntpSysProcessor=ntpSysProcessor, tymingStatus=tymingStatus, gpsMode=gpsMode, etc=etc, nts=nts, gpsPosition=gpsPosition, ntpSysLeap=ntpSysLeap, ntpSysClock=ntpSysClock, ntpSysPhase=ntpSysPhase, ntpSysRefTime=ntpSysRefTime, gps=gps, etcModel=etcModel, xli=xli, symmetricom=symmetricom, dialup=dialup, etcAlarm=etcAlarm, ntpSysPeer=ntpSysPeer, etcUpgradeServer=etcUpgradeServer, version=version, symmBroadband=symmBroadband, ntpSysVersion=ntpSysVersion, products=products, ntpSysError=ntpSysError, ntpSysRefID=ntpSysRefID, net=net, etcAlarmString=etcAlarmString, ntpSysFreq=ntpSysFreq, ntpSysNotrust=ntpSysNotrust, gpsUTCOffset=gpsUTCOffset, ntpSysPoll=ntpSysPoll, ts2000=ts2000, experiment=experiment)
