...
MibIdentifier, Counter64, Unsigned32, IpAddress, Counter32, ObjectIdentity, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, NotificationType, Bits, enterprises, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Unsigned32", "IpAddress", "Counter32", "ObjectIdentity", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "NotificationType", "Bits", "enterprises", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", PYSNMP_MODULE_ID=symmetricom, ntpSysRefTime=ntpSysRefTime, tymingStatus=tymingStatus, etcVersion=etcVersion, etc=etc, symmCmipManagement=symmCmipManagement, tymingTime=tymingTime, symmTTM=symmTTM, net=net, ntpSysSystem=ntpSysSystem, ntpSysError=ntpSysError, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, nts=nts, etcUpgradeServer=etcUpgradeServer, etcAlarm=etcAlarm, ntpSystem=ntpSystem, syncserver=syncserver, tymingFlyPeriod=tymingFlyPeriod, symmetricom=symmetricom, ts2000=ts2000, tymingVersion=tymingVersion, etcAlarmString=etcAlarmString, xli=xli, ts2100=ts2100, tyming=tyming, ntpSysNotrust=ntpSysNotrust, ntpSysMode=ntpSysMode, ntpSysLeap=ntpSysLeap, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysProcessor=ntpSysProcessor, gpsSatlist=gpsSatlist, s100=s100, ntpSysRootDelay=ntpSysRootDelay, ntpSysPhase=ntpSysPhase, etcModel=etcModel, ntpSysFreq=ntpSysFreq, symmBroadband=symmBroadband, version=version, symmNetworkManagement=symmNetworkManagement, experiment=experiment, ntpSysStratum=ntpSysStratum, ntpSysPrecision=ntpSysPrecision, ntpSysVersion=ntpSysVersion, products=products, gpsPosition=gpsPosition, tymingSource=tymingSource, etcSerialNbr=etcSerialNbr, ntpSysRefID=ntpSysRefID, gps=gps, gpsUTCOffset=gpsUTCOffset, ntpSysPeer=ntpSysPeer, ntpSysPoll=ntpSysPoll, gpsMode=gpsMode, gpsHealth=gpsHealth, symmTimePictra=symmTimePictra, dialup=dialup, ntpSysClock=ntpSysClock, etcUpgrade=etcUpgrade)
