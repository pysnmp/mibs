...
ObjectIdentity, NotificationType, Bits, ModuleIdentity, Counter64, Integer32, Unsigned32, iso, enterprises, Counter32, MibIdentifier, IpAddress, Gauge32, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "Bits", "ModuleIdentity", "Counter64", "Integer32", "Unsigned32", "iso", "enterprises", "Counter32", "MibIdentifier", "IpAddress", "Gauge32", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysLeap=ntpSysLeap, etcAlarm=etcAlarm, ntpSysPoll=ntpSysPoll, experiment=experiment, etcUpgrade=etcUpgrade, net=net, gps=gps, symmNetworkManagement=symmNetworkManagement, symmSnmpManagement=symmSnmpManagement, tymingVersion=tymingVersion, ntpSysStratum=ntpSysStratum, nts=nts, products=products, ntpSysRootDispersion=ntpSysRootDispersion, gpsPosition=gpsPosition, symmBroadband=symmBroadband, ntpSysMode=ntpSysMode, xli=xli, gpsSatlist=gpsSatlist, s100=s100, gpsMode=gpsMode, ntpSysSystem=ntpSysSystem, ntpSysRefTime=ntpSysRefTime, symmTimePictra=symmTimePictra, ntpSysVersion=ntpSysVersion, symmCmipManagement=symmCmipManagement, tymingTime=tymingTime, tymingSource=tymingSource, tyming=tyming, ntpSysPeer=ntpSysPeer, ntpSysPktsReceived=ntpSysPktsReceived, etcModel=etcModel, ntpSysProcessor=ntpSysProcessor, ntpSysRefID=ntpSysRefID, ntpSystem=ntpSystem, PYSNMP_MODULE_ID=symmetricom, ntpSysFreq=ntpSysFreq, dialup=dialup, ntpSysError=ntpSysError, ntpSysPrecision=ntpSysPrecision, ntpSysPhase=ntpSysPhase, tymingFlyPeriod=tymingFlyPeriod, ntpSysClock=ntpSysClock, ts2000=ts2000, etcVersion=etcVersion, syncserver=syncserver, version=version, tymingStatus=tymingStatus, gpsUTCOffset=gpsUTCOffset, ntpSysNotrust=ntpSysNotrust, etcSerialNbr=etcSerialNbr, etc=etc, etcUpgradeServer=etcUpgradeServer, ts2100=ts2100, ntpSysRootDelay=ntpSysRootDelay, symmTTM=symmTTM, gpsHealth=gpsHealth, symmetricom=symmetricom, etcAlarmString=etcAlarmString)
