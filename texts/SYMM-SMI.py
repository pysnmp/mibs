...
Integer32, Counter32, ModuleIdentity, ObjectIdentity, NotificationType, IpAddress, enterprises, Counter64, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, MibIdentifier, TimeTicks, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "IpAddress", "enterprises", "Counter64", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "MibIdentifier", "TimeTicks", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", tyming=tyming, PYSNMP_MODULE_ID=symmetricom, syncserver=syncserver, etcSerialNbr=etcSerialNbr, tymingStatus=tymingStatus, gpsMode=gpsMode, ntpSysRootDispersion=ntpSysRootDispersion, gps=gps, ntpSysRootDelay=ntpSysRootDelay, nts=nts, ntpSysVersion=ntpSysVersion, ts2000=ts2000, dialup=dialup, symmTimePictra=symmTimePictra, ntpSysRefTime=ntpSysRefTime, ntpSysNotrust=ntpSysNotrust, gpsUTCOffset=gpsUTCOffset, etcAlarmString=etcAlarmString, gpsHealth=gpsHealth, etcUpgrade=etcUpgrade, symmCmipManagement=symmCmipManagement, tymingTime=tymingTime, ntpSysStratum=ntpSysStratum, gpsPosition=gpsPosition, s100=s100, xli=xli, version=version, ntpSysPeer=ntpSysPeer, tymingSource=tymingSource, products=products, ntpSysError=ntpSysError, net=net, ntpSysFreq=ntpSysFreq, ntpSysSystem=ntpSysSystem, ts2100=ts2100, symmNetworkManagement=symmNetworkManagement, gpsSatlist=gpsSatlist, ntpSysLeap=ntpSysLeap, symmSnmpManagement=symmSnmpManagement, tymingFlyPeriod=tymingFlyPeriod, etcModel=etcModel, etcUpgradeServer=etcUpgradeServer, ntpSysPktsReceived=ntpSysPktsReceived, ntpSystem=ntpSystem, ntpSysPoll=ntpSysPoll, experiment=experiment, ntpSysProcessor=ntpSysProcessor, ntpSysPhase=ntpSysPhase, symmBroadband=symmBroadband, etc=etc, ntpSysMode=ntpSysMode, symmTTM=symmTTM, etcVersion=etcVersion, ntpSysClock=ntpSysClock, etcAlarm=etcAlarm, ntpSysRefID=ntpSysRefID, symmetricom=symmetricom, tymingVersion=tymingVersion, ntpSysPrecision=ntpSysPrecision)
