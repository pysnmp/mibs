...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Counter32, ObjectIdentity, Integer32, TimeTicks, MibIdentifier, ModuleIdentity, IpAddress, enterprises, NotificationType, iso, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Counter32", "ObjectIdentity", "Integer32", "TimeTicks", "MibIdentifier", "ModuleIdentity", "IpAddress", "enterprises", "NotificationType", "iso", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("SYMM-SMI", etcModel=etcModel, ntpSysPhase=ntpSysPhase, symmBroadband=symmBroadband, xli=xli, ntpSysNotrust=ntpSysNotrust, tymingFlyPeriod=tymingFlyPeriod, gpsUTCOffset=gpsUTCOffset, tymingSource=tymingSource, symmNetworkManagement=symmNetworkManagement, symmSnmpManagement=symmSnmpManagement, ntpSysVersion=ntpSysVersion, PYSNMP_MODULE_ID=symmetricom, ntpSysSystem=ntpSysSystem, symmetricom=symmetricom, gps=gps, net=net, symmTTM=symmTTM, gpsMode=gpsMode, symmCmipManagement=symmCmipManagement, ntpSysLeap=ntpSysLeap, gpsPosition=gpsPosition, etcAlarm=etcAlarm, gpsSatlist=gpsSatlist, symmTimePictra=symmTimePictra, ntpSysRefTime=ntpSysRefTime, ntpSysMode=ntpSysMode, etcAlarmString=etcAlarmString, tymingVersion=tymingVersion, ntpSysRootDispersion=ntpSysRootDispersion, dialup=dialup, s100=s100, nts=nts, ntpSysFreq=ntpSysFreq, gpsHealth=gpsHealth, experiment=experiment, etc=etc, ntpSysRefID=ntpSysRefID, ntpSystem=ntpSystem, ts2000=ts2000, ntpSysProcessor=ntpSysProcessor, tymingStatus=tymingStatus, version=version, ntpSysStratum=ntpSysStratum, ntpSysError=ntpSysError, syncserver=syncserver, ntpSysPoll=ntpSysPoll, tymingTime=tymingTime, etcVersion=etcVersion, ntpSysPeer=ntpSysPeer, ntpSysPrecision=ntpSysPrecision, products=products, ntpSysRootDelay=ntpSysRootDelay, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgradeServer=etcUpgradeServer, ts2100=ts2100, ntpSysClock=ntpSysClock, etcUpgrade=etcUpgrade, etcSerialNbr=etcSerialNbr, tyming=tyming)
