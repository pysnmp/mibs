...
Counter64, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, IpAddress, ObjectIdentity, MibIdentifier, Integer32, ModuleIdentity, Bits, Unsigned32, iso, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "IpAddress", "ObjectIdentity", "MibIdentifier", "Integer32", "ModuleIdentity", "Bits", "Unsigned32", "iso", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", symmBroadband=symmBroadband, ts2000=ts2000, tymingStatus=tymingStatus, ntpSysPrecision=ntpSysPrecision, s100=s100, symmNetworkManagement=symmNetworkManagement, gpsPosition=gpsPosition, gps=gps, ntpSysPeer=ntpSysPeer, etc=etc, symmTimePictra=symmTimePictra, experiment=experiment, syncserver=syncserver, tymingVersion=tymingVersion, ntpSysRefID=ntpSysRefID, ntpSysFreq=ntpSysFreq, nts=nts, ntpSysNotrust=ntpSysNotrust, ntpSysPktsReceived=ntpSysPktsReceived, symmTTM=symmTTM, dialup=dialup, ntpSysRootDispersion=ntpSysRootDispersion, etcAlarm=etcAlarm, etcAlarmString=etcAlarmString, ntpSysRefTime=ntpSysRefTime, ntpSystem=ntpSystem, ntpSysClock=ntpSysClock, etcUpgradeServer=etcUpgradeServer, etcVersion=etcVersion, ts2100=ts2100, tymingSource=tymingSource, ntpSysError=ntpSysError, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, gpsUTCOffset=gpsUTCOffset, symmSnmpManagement=symmSnmpManagement, tyming=tyming, ntpSysLeap=ntpSysLeap, gpsMode=gpsMode, products=products, tymingFlyPeriod=tymingFlyPeriod, etcSerialNbr=etcSerialNbr, ntpSysStratum=ntpSysStratum, etcUpgrade=etcUpgrade, ntpSysMode=ntpSysMode, tymingTime=tymingTime, version=version, symmCmipManagement=symmCmipManagement, ntpSysProcessor=ntpSysProcessor, symmetricom=symmetricom, ntpSysPhase=ntpSysPhase, ntpSysPoll=ntpSysPoll, etcModel=etcModel, net=net, xli=xli, PYSNMP_MODULE_ID=symmetricom, ntpSysVersion=ntpSysVersion, gpsSatlist=gpsSatlist, ntpSysSystem=ntpSysSystem)
