...
mibBuilder.exportSymbols("SYMM-SMI", gpsUTCOffset=gpsUTCOffset, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDispersion=ntpSysRootDispersion, etcAlarmString=etcAlarmString, ntpSysRefID=ntpSysRefID, s100=s100, gpsHealth=gpsHealth, tymingFlyPeriod=tymingFlyPeriod, tymingStatus=tymingStatus, symmTimePictra=symmTimePictra, symmBroadband=symmBroadband, ntpSysRefTime=ntpSysRefTime, products=products, gpsPosition=gpsPosition, ntpSysError=ntpSysError, etcModel=etcModel, xli=xli, nts=nts, gps=gps, experiment=experiment, ntpSysPeer=ntpSysPeer, ntpSysLeap=ntpSysLeap, symmetricom=symmetricom, symmSnmpManagement=symmSnmpManagement, gpsMode=gpsMode, net=net, tymingSource=tymingSource, ntpSysPktsReceived=ntpSysPktsReceived, symmNetworkManagement=symmNetworkManagement, symmTTM=symmTTM, etc=etc, tyming=tyming, ntpSysClock=ntpSysClock, etcUpgradeServer=etcUpgradeServer, tymingTime=tymingTime, etcUpgrade=etcUpgrade, gpsSatlist=gpsSatlist, ts2100=ts2100, ntpSysVersion=ntpSysVersion, tymingVersion=tymingVersion, ntpSysNotrust=ntpSysNotrust, version=version, ntpSysPhase=ntpSysPhase, ntpSysPoll=ntpSysPoll, syncserver=syncserver, ntpSysProcessor=ntpSysProcessor, ntpSysFreq=ntpSysFreq, ntpSystem=ntpSystem, etcAlarm=etcAlarm, ntpSysSystem=ntpSysSystem, ts2000=ts2000, ntpSysPrecision=ntpSysPrecision, symmCmipManagement=symmCmipManagement, etcVersion=etcVersion, etcSerialNbr=etcSerialNbr, ntpSysStratum=ntpSysStratum, ntpSysMode=ntpSysMode, ntpSysRootDelay=ntpSysRootDelay, dialup=dialup)
