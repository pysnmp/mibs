...
mibBuilder.exportSymbols("SYMM-SMI", etcSerialNbr=etcSerialNbr, tymingSource=tymingSource, s100=s100, ntpSysStratum=ntpSysStratum, ts2000=ts2000, symmBroadband=symmBroadband, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, ntpSysRefID=ntpSysRefID, gpsMode=gpsMode, experiment=experiment, dialup=dialup, ntpSysPeer=ntpSysPeer, etcUpgrade=etcUpgrade, xli=xli, ntpSysRootDispersion=ntpSysRootDispersion, syncserver=syncserver, nts=nts, net=net, symmTimePictra=symmTimePictra, ntpSysPoll=ntpSysPoll, version=version, ntpSysLeap=ntpSysLeap, ntpSysClock=ntpSysClock, gpsUTCOffset=gpsUTCOffset, gps=gps, etcVersion=etcVersion, etcAlarmString=etcAlarmString, ntpSystem=ntpSystem, etcModel=etcModel, ntpSysMode=ntpSysMode, ntpSysError=ntpSysError, ntpSysNotrust=ntpSysNotrust, ntpSysPhase=ntpSysPhase, ntpSysPktsReceived=ntpSysPktsReceived, products=products, ntpSysPrecision=ntpSysPrecision, ntpSysProcessor=ntpSysProcessor, tyming=tyming, ntpSysRootDelay=ntpSysRootDelay, ntpSysRefTime=ntpSysRefTime, symmSnmpManagement=symmSnmpManagement, ts2100=ts2100, etc=etc, etcAlarm=etcAlarm, symmCmipManagement=symmCmipManagement, tymingTime=tymingTime, ntpSysVersion=ntpSysVersion, symmetricom=symmetricom, symmTTM=symmTTM, gpsPosition=gpsPosition, tymingVersion=tymingVersion, gpsHealth=gpsHealth, gpsSatlist=gpsSatlist, ntpSysFreq=ntpSysFreq, ntpSysSystem=ntpSysSystem, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, PYSNMP_MODULE_ID=symmetricom)
