...
mibBuilder.exportSymbols("SYMM-SMI", ts2000=ts2000, ntpSysProcessor=ntpSysProcessor, tymingStatus=tymingStatus, ntpSysStratum=ntpSysStratum, ntpSysRootDelay=ntpSysRootDelay, ntpSysPeer=ntpSysPeer, ntpSysRefTime=ntpSysRefTime, ntpSysClock=ntpSysClock, ntpSysError=ntpSysError, etcModel=etcModel, symmetricom=symmetricom, gps=gps, ts2100=ts2100, dialup=dialup, ntpSysFreq=ntpSysFreq, ntpSystem=ntpSystem, ntpSysNotrust=ntpSysNotrust, ntpSysVersion=ntpSysVersion, ntpSysPktsReceived=ntpSysPktsReceived, tymingVersion=tymingVersion, tyming=tyming, gpsPosition=gpsPosition, etcVersion=etcVersion, etcAlarm=etcAlarm, etcAlarmString=etcAlarmString, net=net, ntpSysLeap=ntpSysLeap, symmTTM=symmTTM, tymingFlyPeriod=tymingFlyPeriod, etcUpgrade=etcUpgrade, xli=xli, symmBroadband=symmBroadband, ntpSysSystem=ntpSysSystem, ntpSysPrecision=ntpSysPrecision, ntpSysMode=ntpSysMode, tymingSource=tymingSource, products=products, version=version, ntpSysPhase=ntpSysPhase, gpsUTCOffset=gpsUTCOffset, gpsSatlist=gpsSatlist, gpsMode=gpsMode, tymingTime=tymingTime, etcUpgradeServer=etcUpgradeServer, ntpSysRefID=ntpSysRefID, syncserver=syncserver, etcSerialNbr=etcSerialNbr, symmCmipManagement=symmCmipManagement, symmTimePictra=symmTimePictra, s100=s100, ntpSysPoll=ntpSysPoll, gpsHealth=gpsHealth, symmSnmpManagement=symmSnmpManagement, symmNetworkManagement=symmNetworkManagement, ntpSysRootDispersion=ntpSysRootDispersion, experiment=experiment, PYSNMP_MODULE_ID=symmetricom, nts=nts, etc=etc)
