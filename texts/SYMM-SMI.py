...
Bits, Integer32, NotificationType, Unsigned32, Counter64, TimeTicks, Counter32, Gauge32, ModuleIdentity, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "NotificationType", "Unsigned32", "Counter64", "TimeTicks", "Counter32", "Gauge32", "ModuleIdentity", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, nts=nts, ntpSysRootDelay=ntpSysRootDelay, ntpSysLeap=ntpSysLeap, symmNetworkManagement=symmNetworkManagement, ts2000=ts2000, ntpSysPrecision=ntpSysPrecision, ntpSysRefID=ntpSysRefID, tyming=tyming, experiment=experiment, tymingSource=tymingSource, etcAlarm=etcAlarm, gpsHealth=gpsHealth, s100=s100, tymingVersion=tymingVersion, ntpSysSystem=ntpSysSystem, symmetricom=symmetricom, ntpSysProcessor=ntpSysProcessor, ntpSysVersion=ntpSysVersion, ntpSysRootDispersion=ntpSysRootDispersion, PYSNMP_MODULE_ID=symmetricom, gpsSatlist=gpsSatlist, ts2100=ts2100, etcVersion=etcVersion, ntpSysMode=ntpSysMode, ntpSysClock=ntpSysClock, etcUpgrade=etcUpgrade, xli=xli, gps=gps, tymingFlyPeriod=tymingFlyPeriod, symmCmipManagement=symmCmipManagement, symmBroadband=symmBroadband, tymingTime=tymingTime, products=products, symmTimePictra=symmTimePictra, symmSnmpManagement=symmSnmpManagement, etc=etc, tymingStatus=tymingStatus, dialup=dialup, gpsMode=gpsMode, etcSerialNbr=etcSerialNbr, symmTTM=symmTTM, ntpSysPoll=ntpSysPoll, etcUpgradeServer=etcUpgradeServer, ntpSysStratum=ntpSysStratum, ntpSysPhase=ntpSysPhase, ntpSysFreq=ntpSysFreq, gpsPosition=gpsPosition, version=version, ntpSysRefTime=ntpSysRefTime, etcAlarmString=etcAlarmString, ntpSysPeer=ntpSysPeer, net=net, ntpSysNotrust=ntpSysNotrust, gpsUTCOffset=gpsUTCOffset, etcModel=etcModel, syncserver=syncserver, ntpSysError=ntpSysError, ntpSystem=ntpSystem)
