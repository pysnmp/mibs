...
mibBuilder.exportSymbols("SYMM-SMI", gpsMode=gpsMode, dialup=dialup, symmBroadband=symmBroadband, experiment=experiment, xli=xli, ntpSysError=ntpSysError, ntpSysPoll=ntpSysPoll, etcUpgradeServer=etcUpgradeServer, ntpSysRefTime=ntpSysRefTime, gpsHealth=gpsHealth, symmTTM=symmTTM, tymingFlyPeriod=tymingFlyPeriod, tymingStatus=tymingStatus, ntpSystem=ntpSystem, ntpSysClock=ntpSysClock, etcModel=etcModel, nts=nts, etcAlarmString=etcAlarmString, tyming=tyming, etcSerialNbr=etcSerialNbr, ntpSysPrecision=ntpSysPrecision, ts2100=ts2100, gpsPosition=gpsPosition, ntpSysRootDelay=ntpSysRootDelay, symmTimePictra=symmTimePictra, ntpSysMode=ntpSysMode, gpsUTCOffset=gpsUTCOffset, ntpSysLeap=ntpSysLeap, tymingSource=tymingSource, ntpSysSystem=ntpSysSystem, gpsSatlist=gpsSatlist, PYSNMP_MODULE_ID=symmetricom, ntpSysStratum=ntpSysStratum, tymingVersion=tymingVersion, ntpSysPhase=ntpSysPhase, etcAlarm=etcAlarm, gps=gps, symmCmipManagement=symmCmipManagement, net=net, s100=s100, tymingTime=tymingTime, etcVersion=etcVersion, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysProcessor=ntpSysProcessor, products=products, version=version, etc=etc, ntpSysFreq=ntpSysFreq, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysVersion=ntpSysVersion, ntpSysRefID=ntpSysRefID, symmSnmpManagement=symmSnmpManagement, syncserver=syncserver, ntpSysPeer=ntpSysPeer, ntpSysNotrust=ntpSysNotrust, ts2000=ts2000, etcUpgrade=etcUpgrade, symmNetworkManagement=symmNetworkManagement, symmetricom=symmetricom)
