...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Gauge32, NotificationType, IpAddress, enterprises, Bits, Unsigned32, Counter32, Counter64, NotificationType, ObjectIdentity, MibIdentifier, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Gauge32", "NotificationType", "IpAddress", "enterprises", "Bits", "Unsigned32", "Counter32", "Counter64", "NotificationType", "ObjectIdentity", "MibIdentifier", "iso", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysProcessor=ntpSysProcessor, nts=nts, tymingVersion=tymingVersion, s100=s100, gpsHealth=gpsHealth, symmSnmpManagement=symmSnmpManagement, syncserver=syncserver, ntpSysFreq=ntpSysFreq, ntpSysMode=ntpSysMode, ntpSysVersion=ntpSysVersion, etcModel=etcModel, etcUpgrade=etcUpgrade, experiment=experiment, tymingTime=tymingTime, tymingSource=tymingSource, etcVersion=etcVersion, symmTimePictra=symmTimePictra, ts2100=ts2100, symmetricom=symmetricom, tymingFlyPeriod=tymingFlyPeriod, PYSNMP_MODULE_ID=symmetricom, gpsUTCOffset=gpsUTCOffset, etcSerialNbr=etcSerialNbr, ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem, symmBroadband=symmBroadband, ntpSysRefTime=ntpSysRefTime, tymingStatus=tymingStatus, etc=etc, etcAlarm=etcAlarm, ntpSysLeap=ntpSysLeap, xli=xli, symmCmipManagement=symmCmipManagement, ts2000=ts2000, ntpSystem=ntpSystem, ntpSysRefID=ntpSysRefID, gpsMode=gpsMode, net=net, ntpSysPeer=ntpSysPeer, gpsSatlist=gpsSatlist, ntpSysNotrust=ntpSysNotrust, etcAlarmString=etcAlarmString, gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, products=products, version=version, dialup=dialup, tyming=tyming, ntpSysStratum=ntpSysStratum, ntpSysPrecision=ntpSysPrecision, ntpSysPoll=ntpSysPoll, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, ntpSysError=ntpSysError, symmNetworkManagement=symmNetworkManagement, ntpSysRootDelay=ntpSysRootDelay, etcUpgradeServer=etcUpgradeServer, ntpSysPktsReceived=ntpSysPktsReceived, gpsPosition=gpsPosition)
