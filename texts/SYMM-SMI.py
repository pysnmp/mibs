...
Bits, Counter64, NotificationType, IpAddress, enterprises, MibIdentifier, NotificationType, Gauge32, ObjectIdentity, Integer32, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "NotificationType", "IpAddress", "enterprises", "MibIdentifier", "NotificationType", "Gauge32", "ObjectIdentity", "Integer32", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("SYMM-SMI", dialup=dialup, ntpSysPeer=ntpSysPeer, etcSerialNbr=etcSerialNbr, ntpSysClock=ntpSysClock, etcAlarm=etcAlarm, gpsSatlist=gpsSatlist, gpsUTCOffset=gpsUTCOffset, etcUpgrade=etcUpgrade, nts=nts, symmSnmpManagement=symmSnmpManagement, ntpSystem=ntpSystem, net=net, ntpSysPoll=ntpSysPoll, ntpSysPktsReceived=ntpSysPktsReceived, etcAlarmString=etcAlarmString, symmBroadband=symmBroadband, tymingTime=tymingTime, etc=etc, version=version, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPhase=ntpSysPhase, tymingStatus=tymingStatus, ntpSysVersion=ntpSysVersion, experiment=experiment, etcUpgradeServer=etcUpgradeServer, syncserver=syncserver, ntpSysLeap=ntpSysLeap, tyming=tyming, ntpSysNotrust=ntpSysNotrust, ntpSysProcessor=ntpSysProcessor, gps=gps, tymingVersion=tymingVersion, ts2000=ts2000, s100=s100, PYSNMP_MODULE_ID=symmetricom, symmetricom=symmetricom, gpsMode=gpsMode, ntpSysError=ntpSysError, ntpSysMode=ntpSysMode, xli=xli, ntpSysStratum=ntpSysStratum, ntpSysRootDelay=ntpSysRootDelay, ts2100=ts2100, ntpSysRefID=ntpSysRefID, etcModel=etcModel, tymingSource=tymingSource, gpsPosition=gpsPosition, ntpSysRefTime=ntpSysRefTime, ntpSysFreq=ntpSysFreq, tymingFlyPeriod=tymingFlyPeriod, ntpSysSystem=ntpSysSystem, symmCmipManagement=symmCmipManagement, etcVersion=etcVersion, products=products, symmNetworkManagement=symmNetworkManagement, symmTTM=symmTTM, symmTimePictra=symmTimePictra, gpsHealth=gpsHealth, ntpSysPrecision=ntpSysPrecision)
