...
ObjectIdentity, Bits, Unsigned32, NotificationType, enterprises, Counter32, MibIdentifier, TimeTicks, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, Counter64, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Unsigned32", "NotificationType", "enterprises", "Counter32", "MibIdentifier", "TimeTicks", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "Counter64", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ts2000=ts2000, ntpSysStratum=ntpSysStratum, ntpSysPrecision=ntpSysPrecision, ntpSysRootDispersion=ntpSysRootDispersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysVersion=ntpSysVersion, etcVersion=etcVersion, tymingStatus=tymingStatus, ntpSysLeap=ntpSysLeap, dialup=dialup, symmTTM=symmTTM, ntpSysMode=ntpSysMode, gpsMode=gpsMode, etcUpgrade=etcUpgrade, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, experiment=experiment, etc=etc, ntpSysFreq=ntpSysFreq, symmBroadband=symmBroadband, ntpSysPeer=ntpSysPeer, etcSerialNbr=etcSerialNbr, ntpSysNotrust=ntpSysNotrust, ntpSysProcessor=ntpSysProcessor, version=version, etcAlarmString=etcAlarmString, ntpSysError=ntpSysError, symmetricom=symmetricom, syncserver=syncserver, ntpSysSystem=ntpSysSystem, gpsSatlist=gpsSatlist, PYSNMP_MODULE_ID=symmetricom, products=products, etcUpgradeServer=etcUpgradeServer, s100=s100, symmSnmpManagement=symmSnmpManagement, etcModel=etcModel, tymingTime=tymingTime, ntpSysClock=ntpSysClock, etcAlarm=etcAlarm, ntpSysRefTime=ntpSysRefTime, symmCmipManagement=symmCmipManagement, tymingVersion=tymingVersion, symmNetworkManagement=symmNetworkManagement, gpsPosition=gpsPosition, ntpSysPoll=ntpSysPoll, net=net, symmTimePictra=symmTimePictra, ntpSysPhase=ntpSysPhase, nts=nts, gpsUTCOffset=gpsUTCOffset, xli=xli, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, ntpSysRefID=ntpSysRefID, tyming=tyming, ntpSystem=ntpSystem, ts2100=ts2100, gps=gps)
