...
Integer32, IpAddress, MibIdentifier, NotificationType, NotificationType, iso, TimeTicks, Counter32, Gauge32, Counter64, enterprises, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "MibIdentifier", "NotificationType", "NotificationType", "iso", "TimeTicks", "Counter32", "Gauge32", "Counter64", "enterprises", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysMode=ntpSysMode, etcVersion=etcVersion, xli=xli, etcUpgradeServer=etcUpgradeServer, ntpSysRefID=ntpSysRefID, ntpSysSystem=ntpSysSystem, symmNetworkManagement=symmNetworkManagement, s100=s100, gpsMode=gpsMode, experiment=experiment, etc=etc, etcModel=etcModel, etcUpgrade=etcUpgrade, gpsPosition=gpsPosition, gpsHealth=gpsHealth, products=products, symmTimePictra=symmTimePictra, version=version, ntpSystem=ntpSystem, net=net, ntpSysStratum=ntpSysStratum, tymingSource=tymingSource, ntpSysPhase=ntpSysPhase, ntpSysError=ntpSysError, nts=nts, syncserver=syncserver, ntpSysFreq=ntpSysFreq, ntpSysPoll=ntpSysPoll, ntpSysNotrust=ntpSysNotrust, ntpSysVersion=ntpSysVersion, ntpSysRootDispersion=ntpSysRootDispersion, tymingTime=tymingTime, dialup=dialup, ntpSysRootDelay=ntpSysRootDelay, symmetricom=symmetricom, etcSerialNbr=etcSerialNbr, ts2100=ts2100, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, tymingVersion=tymingVersion, ntpSysLeap=ntpSysLeap, etcAlarmString=etcAlarmString, tyming=tyming, symmSnmpManagement=symmSnmpManagement, symmBroadband=symmBroadband, ts2000=ts2000, ntpSysClock=ntpSysClock, etcAlarm=etcAlarm, gps=gps, PYSNMP_MODULE_ID=symmetricom, ntpSysPrecision=ntpSysPrecision, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRefTime=ntpSysRefTime, gpsUTCOffset=gpsUTCOffset, gpsSatlist=gpsSatlist, ntpSysPeer=ntpSysPeer, symmCmipManagement=symmCmipManagement, symmTTM=symmTTM, ntpSysProcessor=ntpSysProcessor)
