...
ModuleIdentity, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, NotificationType, IpAddress, MibIdentifier, iso, Integer32, Counter32, Gauge32, ObjectIdentity, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "NotificationType", "IpAddress", "MibIdentifier", "iso", "Integer32", "Counter32", "Gauge32", "ObjectIdentity", "TimeTicks", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", etcAlarm=etcAlarm, symmTTM=symmTTM, ntpSysNotrust=ntpSysNotrust, symmCmipManagement=symmCmipManagement, products=products, ts2100=ts2100, ntpSysRefTime=ntpSysRefTime, ntpSysError=ntpSysError, net=net, ntpSysClock=ntpSysClock, tymingFlyPeriod=tymingFlyPeriod, ntpSysFreq=ntpSysFreq, ntpSysPoll=ntpSysPoll, ntpSysStratum=ntpSysStratum, tymingTime=tymingTime, syncserver=syncserver, version=version, ntpSysSystem=ntpSysSystem, tyming=tyming, ntpSysMode=ntpSysMode, gpsMode=gpsMode, ntpSysVersion=ntpSysVersion, gpsSatlist=gpsSatlist, etcVersion=etcVersion, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, gpsHealth=gpsHealth, ntpSysRefID=ntpSysRefID, symmTimePictra=symmTimePictra, ntpSysRootDelay=ntpSysRootDelay, etcUpgradeServer=etcUpgradeServer, gps=gps, gpsUTCOffset=gpsUTCOffset, nts=nts, ntpSysPeer=ntpSysPeer, etcAlarmString=etcAlarmString, ntpSysPrecision=ntpSysPrecision, ntpSysPhase=ntpSysPhase, ntpSysProcessor=ntpSysProcessor, symmNetworkManagement=symmNetworkManagement, xli=xli, ntpSysRootDispersion=ntpSysRootDispersion, symmetricom=symmetricom, dialup=dialup, tymingStatus=tymingStatus, experiment=experiment, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, symmSnmpManagement=symmSnmpManagement, etc=etc, gpsPosition=gpsPosition, s100=s100, ntpSysLeap=ntpSysLeap, tymingVersion=tymingVersion, etcModel=etcModel, etcSerialNbr=etcSerialNbr, ts2000=ts2000, ntpSystem=ntpSystem, PYSNMP_MODULE_ID=symmetricom)
