...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, ntpSysLeap=ntpSysLeap, ntpSysSystem=ntpSysSystem, ntpSysStratum=ntpSysStratum, ts2100=ts2100, gpsMode=gpsMode, syncserver=syncserver, PYSNMP_MODULE_ID=symmetricom, ntpSysVersion=ntpSysVersion, symmTTM=symmTTM, version=version, tymingFlyPeriod=tymingFlyPeriod, net=net, etcSerialNbr=etcSerialNbr, symmSnmpManagement=symmSnmpManagement, tymingSource=tymingSource, gpsPosition=gpsPosition, symmBroadband=symmBroadband, tymingStatus=tymingStatus, s100=s100, ntpSysPrecision=ntpSysPrecision, products=products, ntpSysFreq=ntpSysFreq, etcModel=etcModel, gpsHealth=gpsHealth, experiment=experiment, ntpSysProcessor=ntpSysProcessor, dialup=dialup, ntpSysRefID=ntpSysRefID, ts2000=ts2000, xli=xli, etcUpgrade=etcUpgrade, symmTimePictra=symmTimePictra, ntpSysRootDelay=ntpSysRootDelay, ntpSysError=ntpSysError, tymingTime=tymingTime, ntpSysMode=ntpSysMode, ntpSysPeer=ntpSysPeer, etcUpgradeServer=etcUpgradeServer, tyming=tyming, symmetricom=symmetricom, ntpSystem=ntpSystem, etc=etc, nts=nts, ntpSysRefTime=ntpSysRefTime, symmCmipManagement=symmCmipManagement, ntpSysClock=ntpSysClock, gpsUTCOffset=gpsUTCOffset, gpsSatlist=gpsSatlist, etcAlarmString=etcAlarmString, ntpSysPhase=ntpSysPhase, ntpSysPoll=ntpSysPoll, tymingVersion=tymingVersion, etcAlarm=etcAlarm, etcVersion=etcVersion, symmNetworkManagement=symmNetworkManagement, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysNotrust=ntpSysNotrust, gps=gps)
