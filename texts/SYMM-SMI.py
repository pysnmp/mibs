...
ModuleIdentity, Integer32, Counter32, ObjectIdentity, enterprises, Bits, TimeTicks, IpAddress, NotificationType, Gauge32, NotificationType, iso, MibIdentifier, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Counter32", "ObjectIdentity", "enterprises", "Bits", "TimeTicks", "IpAddress", "NotificationType", "Gauge32", "NotificationType", "iso", "MibIdentifier", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", dialup=dialup, ntpSysPktsReceived=ntpSysPktsReceived, tymingFlyPeriod=tymingFlyPeriod, tyming=tyming, products=products, symmTTM=symmTTM, symmSnmpManagement=symmSnmpManagement, experiment=experiment, gpsPosition=gpsPosition, ntpSysPeer=ntpSysPeer, ntpSysRefID=ntpSysRefID, etcSerialNbr=etcSerialNbr, ntpSysClock=ntpSysClock, s100=s100, PYSNMP_MODULE_ID=symmetricom, ntpSysProcessor=ntpSysProcessor, ntpSysSystem=ntpSysSystem, ntpSysError=ntpSysError, ntpSysVersion=ntpSysVersion, ntpSysStratum=ntpSysStratum, ntpSysRefTime=ntpSysRefTime, tymingVersion=tymingVersion, net=net, etcUpgradeServer=etcUpgradeServer, ntpSysRootDispersion=ntpSysRootDispersion, version=version, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, gpsSatlist=gpsSatlist, etcAlarm=etcAlarm, gpsMode=gpsMode, syncserver=syncserver, gps=gps, ntpSysLeap=ntpSysLeap, ntpSysPrecision=ntpSysPrecision, tymingTime=tymingTime, symmNetworkManagement=symmNetworkManagement, etcUpgrade=etcUpgrade, symmCmipManagement=symmCmipManagement, ts2100=ts2100, ntpSysFreq=ntpSysFreq, ntpSysNotrust=ntpSysNotrust, xli=xli, tymingStatus=tymingStatus, tymingSource=tymingSource, etcModel=etcModel, etc=etc, ntpSysPhase=ntpSysPhase, symmTimePictra=symmTimePictra, symmBroadband=symmBroadband, gpsUTCOffset=gpsUTCOffset, ntpSystem=ntpSystem, etcVersion=etcVersion, symmetricom=symmetricom, etcAlarmString=etcAlarmString, nts=nts, ntpSysMode=ntpSysMode, ts2000=ts2000, ntpSysPoll=ntpSysPoll)
