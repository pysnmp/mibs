...
MibIdentifier, TimeTicks, enterprises, Integer32, IpAddress, Counter32, Gauge32, Counter64, ObjectIdentity, NotificationType, ModuleIdentity, NotificationType, Bits, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "enterprises", "Integer32", "IpAddress", "Counter32", "Gauge32", "Counter64", "ObjectIdentity", "NotificationType", "ModuleIdentity", "NotificationType", "Bits", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ts2000=ts2000, nts=nts, products=products, ntpSysRootDelay=ntpSysRootDelay, dialup=dialup, experiment=experiment, ntpSysPhase=ntpSysPhase, ntpSysPrecision=ntpSysPrecision, gpsMode=gpsMode, etcAlarm=etcAlarm, tymingTime=tymingTime, ntpSysVersion=ntpSysVersion, ntpSysError=ntpSysError, ntpSysClock=ntpSysClock, etc=etc, ntpSysRefTime=ntpSysRefTime, etcAlarmString=etcAlarmString, ntpSysFreq=ntpSysFreq, etcUpgradeServer=etcUpgradeServer, tymingSource=tymingSource, gps=gps, symmetricom=symmetricom, symmTTM=symmTTM, symmTimePictra=symmTimePictra, ntpSysMode=ntpSysMode, etcModel=etcModel, ntpSystem=ntpSystem, net=net, etcVersion=etcVersion, ts2100=ts2100, ntpSysPktsReceived=ntpSysPktsReceived, version=version, tymingStatus=tymingStatus, gpsPosition=gpsPosition, ntpSysPoll=ntpSysPoll, gpsHealth=gpsHealth, etcSerialNbr=etcSerialNbr, syncserver=syncserver, ntpSysSystem=ntpSysSystem, symmCmipManagement=symmCmipManagement, symmSnmpManagement=symmSnmpManagement, tymingFlyPeriod=tymingFlyPeriod, ntpSysRefID=ntpSysRefID, PYSNMP_MODULE_ID=symmetricom, tyming=tyming, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysProcessor=ntpSysProcessor, xli=xli, symmNetworkManagement=symmNetworkManagement, ntpSysLeap=ntpSysLeap, ntpSysNotrust=ntpSysNotrust, gpsUTCOffset=gpsUTCOffset, gpsSatlist=gpsSatlist, etcUpgrade=etcUpgrade, s100=s100, ntpSysPeer=ntpSysPeer, tymingVersion=tymingVersion, ntpSysStratum=ntpSysStratum, symmBroadband=symmBroadband)
