...
ObjectIdentity, TimeTicks, NotificationType, enterprises, Counter32, Counter64, Gauge32, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, NotificationType, Unsigned32, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "NotificationType", "enterprises", "Counter32", "Counter64", "Gauge32", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "NotificationType", "Unsigned32", "iso", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", etcVersion=etcVersion, ntpSysVersion=ntpSysVersion, gps=gps, etcAlarmString=etcAlarmString, symmetricom=symmetricom, ntpSysPeer=ntpSysPeer, gpsUTCOffset=gpsUTCOffset, etcUpgradeServer=etcUpgradeServer, ntpSysClock=ntpSysClock, ntpSysFreq=ntpSysFreq, ntpSysMode=ntpSysMode, syncserver=syncserver, symmCmipManagement=symmCmipManagement, tymingStatus=tymingStatus, etcUpgrade=etcUpgrade, ntpSysRefTime=ntpSysRefTime, etcAlarm=etcAlarm, ntpSysSystem=ntpSysSystem, etc=etc, symmTimePictra=symmTimePictra, ntpSysError=ntpSysError, gpsMode=gpsMode, ntpSysProcessor=ntpSysProcessor, tymingFlyPeriod=tymingFlyPeriod, etcSerialNbr=etcSerialNbr, ntpSysStratum=ntpSysStratum, products=products, ntpSysPrecision=ntpSysPrecision, ntpSysPoll=ntpSysPoll, ntpSysNotrust=ntpSysNotrust, ntpSysLeap=ntpSysLeap, s100=s100, tymingTime=tymingTime, ntpSysPktsReceived=ntpSysPktsReceived, etcModel=etcModel, xli=xli, tyming=tyming, experiment=experiment, symmSnmpManagement=symmSnmpManagement, gpsPosition=gpsPosition, gpsSatlist=gpsSatlist, nts=nts, dialup=dialup, tymingVersion=tymingVersion, tymingSource=tymingSource, ntpSystem=ntpSystem, gpsHealth=gpsHealth, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDispersion=ntpSysRootDispersion, symmNetworkManagement=symmNetworkManagement, symmBroadband=symmBroadband, ts2000=ts2000, ntpSysRefID=ntpSysRefID, version=version, symmTTM=symmTTM, ntpSysRootDelay=ntpSysRootDelay, ntpSysPhase=ntpSysPhase, ts2100=ts2100, net=net)
