...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPeer=ntpSysPeer, tymingTime=tymingTime, symmNetworkManagement=symmNetworkManagement, symmetricom=symmetricom, gpsPosition=gpsPosition, ntpSysNotrust=ntpSysNotrust, tymingSource=tymingSource, symmTimePictra=symmTimePictra, ntpSysFreq=ntpSysFreq, tyming=tyming, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, s100=s100, PYSNMP_MODULE_ID=symmetricom, ntpSysMode=ntpSysMode, gpsSatlist=gpsSatlist, gpsUTCOffset=gpsUTCOffset, etcAlarm=etcAlarm, ntpSysRootDelay=ntpSysRootDelay, ntpSysClock=ntpSysClock, nts=nts, ntpSysVersion=ntpSysVersion, ntpSystem=ntpSystem, tymingVersion=tymingVersion, ntpSysRootDispersion=ntpSysRootDispersion, version=version, etcUpgradeServer=etcUpgradeServer, symmSnmpManagement=symmSnmpManagement, ntpSysPoll=ntpSysPoll, ntpSysError=ntpSysError, etcAlarmString=etcAlarmString, ntpSysPrecision=ntpSysPrecision, net=net, symmCmipManagement=symmCmipManagement, experiment=experiment, etcVersion=etcVersion, gpsHealth=gpsHealth, ntpSysRefID=ntpSysRefID, ntpSysRefTime=ntpSysRefTime, ntpSysStratum=ntpSysStratum, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, dialup=dialup, ntpSysLeap=ntpSysLeap, ntpSysSystem=ntpSysSystem, etcSerialNbr=etcSerialNbr, ntpSysProcessor=ntpSysProcessor, etc=etc, gpsMode=gpsMode, tymingFlyPeriod=tymingFlyPeriod, ts2000=ts2000, xli=xli, ts2100=ts2100, tymingStatus=tymingStatus, etcModel=etcModel, products=products, gps=gps, ntpSysPktsReceived=ntpSysPktsReceived, syncserver=syncserver)
