...
NotificationType, ModuleIdentity, Unsigned32, ObjectIdentity, Bits, TimeTicks, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, iso, MibIdentifier, IpAddress, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "Bits", "TimeTicks", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "iso", "MibIdentifier", "IpAddress", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysNotrust=ntpSysNotrust, ntpSysLeap=ntpSysLeap, symmTTM=symmTTM, etcVersion=etcVersion, ntpSysSystem=ntpSysSystem, ntpSysProcessor=ntpSysProcessor, etcUpgrade=etcUpgrade, ntpSysRefTime=ntpSysRefTime, ntpSysError=ntpSysError, etcAlarmString=etcAlarmString, gpsMode=gpsMode, symmSnmpManagement=symmSnmpManagement, ntpSysRootDispersion=ntpSysRootDispersion, s100=s100, net=net, symmTimePictra=symmTimePictra, ntpSysClock=ntpSysClock, etcModel=etcModel, etcAlarm=etcAlarm, etcUpgradeServer=etcUpgradeServer, PYSNMP_MODULE_ID=symmetricom, gpsUTCOffset=gpsUTCOffset, ntpSysPktsReceived=ntpSysPktsReceived, etc=etc, gpsSatlist=gpsSatlist, xli=xli, ntpSysMode=ntpSysMode, version=version, tymingFlyPeriod=tymingFlyPeriod, tymingVersion=tymingVersion, etcSerialNbr=etcSerialNbr, dialup=dialup, symmCmipManagement=symmCmipManagement, gpsHealth=gpsHealth, symmNetworkManagement=symmNetworkManagement, tyming=tyming, ntpSysPoll=ntpSysPoll, products=products, symmetricom=symmetricom, syncserver=syncserver, gps=gps, ntpSysVersion=ntpSysVersion, tymingSource=tymingSource, ntpSysPhase=ntpSysPhase, experiment=experiment, ts2100=ts2100, tymingTime=tymingTime, ntpSysPrecision=ntpSysPrecision, nts=nts, tymingStatus=tymingStatus, ntpSysStratum=ntpSysStratum, ntpSystem=ntpSystem, ntpSysRootDelay=ntpSysRootDelay, symmBroadband=symmBroadband, ntpSysRefID=ntpSysRefID, gpsPosition=gpsPosition, ntpSysFreq=ntpSysFreq, ntpSysPeer=ntpSysPeer, ts2000=ts2000)
