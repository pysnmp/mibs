...
Unsigned32, Integer32, NotificationType, ObjectIdentity, MibIdentifier, Bits, NotificationType, ModuleIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, IpAddress, iso, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "NotificationType", "ObjectIdentity", "MibIdentifier", "Bits", "NotificationType", "ModuleIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "IpAddress", "iso", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", etcVersion=etcVersion, ntpSysPrecision=ntpSysPrecision, syncserver=syncserver, tymingStatus=tymingStatus, etcUpgrade=etcUpgrade, ntpSysRefID=ntpSysRefID, ts2100=ts2100, symmTTM=symmTTM, ntpSysMode=ntpSysMode, etc=etc, tymingFlyPeriod=tymingFlyPeriod, ntpSysPoll=ntpSysPoll, ntpSysSystem=ntpSysSystem, xli=xli, gpsHealth=gpsHealth, etcAlarm=etcAlarm, etcSerialNbr=etcSerialNbr, tymingTime=tymingTime, symmNetworkManagement=symmNetworkManagement, ntpSysVersion=ntpSysVersion, gpsMode=gpsMode, symmTimePictra=symmTimePictra, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, symmetricom=symmetricom, tymingSource=tymingSource, tyming=tyming, gpsPosition=gpsPosition, etcModel=etcModel, s100=s100, ntpSysNotrust=ntpSysNotrust, ntpSystem=ntpSystem, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, etcAlarmString=etcAlarmString, ntpSysLeap=ntpSysLeap, gps=gps, net=net, nts=nts, gpsSatlist=gpsSatlist, dialup=dialup, products=products, ntpSysPeer=ntpSysPeer, symmCmipManagement=symmCmipManagement, ts2000=ts2000, ntpSysFreq=ntpSysFreq, ntpSysRootDelay=ntpSysRootDelay, tymingVersion=tymingVersion, experiment=experiment, etcUpgradeServer=etcUpgradeServer, gpsUTCOffset=gpsUTCOffset, ntpSysRefTime=ntpSysRefTime, version=version, ntpSysStratum=ntpSysStratum, ntpSysPhase=ntpSysPhase, ntpSysError=ntpSysError, symmSnmpManagement=symmSnmpManagement)
