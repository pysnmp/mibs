...
ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, enterprises, Bits, IpAddress, NotificationType, NotificationType, TimeTicks, Integer32, Unsigned32, Counter32, MibIdentifier, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "enterprises", "Bits", "IpAddress", "NotificationType", "NotificationType", "TimeTicks", "Integer32", "Unsigned32", "Counter32", "MibIdentifier", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", symmTTM=symmTTM, gpsSatlist=gpsSatlist, ntpSysMode=ntpSysMode, ntpSysFreq=ntpSysFreq, version=version, tymingSource=tymingSource, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRootDelay=ntpSysRootDelay, gpsUTCOffset=gpsUTCOffset, symmSnmpManagement=symmSnmpManagement, PYSNMP_MODULE_ID=symmetricom, ts2100=ts2100, etcAlarmString=etcAlarmString, gpsPosition=gpsPosition, etcUpgradeServer=etcUpgradeServer, ts2000=ts2000, ntpSysProcessor=ntpSysProcessor, tymingFlyPeriod=tymingFlyPeriod, ntpSysPhase=ntpSysPhase, nts=nts, ntpSysStratum=ntpSysStratum, ntpSysError=ntpSysError, tymingTime=tymingTime, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, xli=xli, etcSerialNbr=etcSerialNbr, dialup=dialup, ntpSysRefID=ntpSysRefID, s100=s100, etcAlarm=etcAlarm, ntpSysPrecision=ntpSysPrecision, ntpSysClock=ntpSysClock, symmetricom=symmetricom, etc=etc, ntpSysPeer=ntpSysPeer, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPoll=ntpSysPoll, net=net, tymingStatus=tymingStatus, etcModel=etcModel, symmTimePictra=symmTimePictra, gps=gps, symmNetworkManagement=symmNetworkManagement, gpsMode=gpsMode, ntpSysNotrust=ntpSysNotrust, etcVersion=etcVersion, ntpSystem=ntpSystem, ntpSysSystem=ntpSysSystem, experiment=experiment, symmCmipManagement=symmCmipManagement, tymingVersion=tymingVersion, tyming=tyming, ntpSysLeap=ntpSysLeap, syncserver=syncserver, ntpSysVersion=ntpSysVersion, ntpSysRefTime=ntpSysRefTime, products=products, gpsHealth=gpsHealth)
