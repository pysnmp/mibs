...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, Counter32, enterprises, IpAddress, iso, MibIdentifier, Bits, ModuleIdentity, Counter64, Unsigned32, Gauge32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "Counter32", "enterprises", "IpAddress", "iso", "MibIdentifier", "Bits", "ModuleIdentity", "Counter64", "Unsigned32", "Gauge32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", net=net, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysNotrust=ntpSysNotrust, ntpSysPoll=ntpSysPoll, gpsSatlist=gpsSatlist, ntpSysSystem=ntpSysSystem, symmTimePictra=symmTimePictra, ntpSysLeap=ntpSysLeap, ntpSystem=ntpSystem, experiment=experiment, tymingSource=tymingSource, ntpSysMode=ntpSysMode, products=products, tymingVersion=tymingVersion, ntpSysStratum=ntpSysStratum, etcAlarm=etcAlarm, etcUpgrade=etcUpgrade, gpsPosition=gpsPosition, ntpSysPrecision=ntpSysPrecision, PYSNMP_MODULE_ID=symmetricom, ntpSysClock=ntpSysClock, tymingFlyPeriod=tymingFlyPeriod, etcAlarmString=etcAlarmString, tyming=tyming, gpsUTCOffset=gpsUTCOffset, ntpSysRootDelay=ntpSysRootDelay, ntpSysPeer=ntpSysPeer, tymingTime=tymingTime, etcModel=etcModel, tymingStatus=tymingStatus, ntpSysRefTime=ntpSysRefTime, nts=nts, gps=gps, symmetricom=symmetricom, ntpSysVersion=ntpSysVersion, symmTTM=symmTTM, dialup=dialup, ntpSysPhase=ntpSysPhase, symmBroadband=symmBroadband, xli=xli, ts2100=ts2100, etcSerialNbr=etcSerialNbr, etcUpgradeServer=etcUpgradeServer, gpsMode=gpsMode, version=version, etc=etc, ntpSysError=ntpSysError, gpsHealth=gpsHealth, s100=s100, symmNetworkManagement=symmNetworkManagement, ts2000=ts2000, ntpSysProcessor=ntpSysProcessor, etcVersion=etcVersion, ntpSysRefID=ntpSysRefID, symmSnmpManagement=symmSnmpManagement, syncserver=syncserver, ntpSysFreq=ntpSysFreq, symmCmipManagement=symmCmipManagement)
