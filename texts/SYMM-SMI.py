...
NotificationType, Counter64, Counter32, IpAddress, NotificationType, ObjectIdentity, iso, TimeTicks, Gauge32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Counter32", "IpAddress", "NotificationType", "ObjectIdentity", "iso", "TimeTicks", "Gauge32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "enterprises", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", tymingVersion=tymingVersion, symmBroadband=symmBroadband, dialup=dialup, gps=gps, gpsUTCOffset=gpsUTCOffset, symmCmipManagement=symmCmipManagement, s100=s100, version=version, ntpSysRefTime=ntpSysRefTime, ntpSysVersion=ntpSysVersion, symmNetworkManagement=symmNetworkManagement, etcSerialNbr=etcSerialNbr, ntpSysRootDispersion=ntpSysRootDispersion, products=products, gpsSatlist=gpsSatlist, gpsPosition=gpsPosition, symmTTM=symmTTM, ntpSysFreq=ntpSysFreq, ntpSysMode=ntpSysMode, etc=etc, symmSnmpManagement=symmSnmpManagement, ntpSysProcessor=ntpSysProcessor, ntpSysPoll=ntpSysPoll, net=net, ntpSysNotrust=ntpSysNotrust, ntpSystem=ntpSystem, nts=nts, experiment=experiment, etcVersion=etcVersion, syncserver=syncserver, etcModel=etcModel, ntpSysSystem=ntpSysSystem, ntpSysError=ntpSysError, symmetricom=symmetricom, ntpSysRefID=ntpSysRefID, ntpSysPrecision=ntpSysPrecision, etcUpgrade=etcUpgrade, tyming=tyming, symmTimePictra=symmTimePictra, etcUpgradeServer=etcUpgradeServer, ntpSysRootDelay=ntpSysRootDelay, xli=xli, etcAlarm=etcAlarm, etcAlarmString=etcAlarmString, ntpSysStratum=ntpSysStratum, tymingSource=tymingSource, ntpSysPktsReceived=ntpSysPktsReceived, tymingStatus=tymingStatus, tymingTime=tymingTime, PYSNMP_MODULE_ID=symmetricom, ntpSysPeer=ntpSysPeer, ntpSysLeap=ntpSysLeap, ts2100=ts2100, gpsHealth=gpsHealth, ts2000=ts2000, ntpSysClock=ntpSysClock, gpsMode=gpsMode, tymingFlyPeriod=tymingFlyPeriod, ntpSysPhase=ntpSysPhase)
