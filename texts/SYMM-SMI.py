...
Gauge32, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, ModuleIdentity, Unsigned32, Counter64, MibIdentifier, iso, NotificationType, Bits, ObjectIdentity, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "ModuleIdentity", "Unsigned32", "Counter64", "MibIdentifier", "iso", "NotificationType", "Bits", "ObjectIdentity", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysSystem=ntpSysSystem, etcAlarm=etcAlarm, ntpSysFreq=ntpSysFreq, ts2100=ts2100, experiment=experiment, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysLeap=ntpSysLeap, tymingStatus=tymingStatus, tymingTime=tymingTime, ntpSysProcessor=ntpSysProcessor, gpsUTCOffset=gpsUTCOffset, ntpSystem=ntpSystem, PYSNMP_MODULE_ID=symmetricom, version=version, ntpSysRootDelay=ntpSysRootDelay, etcSerialNbr=etcSerialNbr, syncserver=syncserver, gpsSatlist=gpsSatlist, ntpSysPoll=ntpSysPoll, etc=etc, symmTimePictra=symmTimePictra, etcVersion=etcVersion, etcAlarmString=etcAlarmString, ntpSysStratum=ntpSysStratum, ntpSysPrecision=ntpSysPrecision, tymingSource=tymingSource, gpsMode=gpsMode, symmetricom=symmetricom, ntpSysRefTime=ntpSysRefTime, ntpSysClock=ntpSysClock, ntpSysNotrust=ntpSysNotrust, gpsPosition=gpsPosition, ntpSysPeer=ntpSysPeer, ntpSysRefID=ntpSysRefID, etcModel=etcModel, gps=gps, symmSnmpManagement=symmSnmpManagement, tymingFlyPeriod=tymingFlyPeriod, ntpSysRootDispersion=ntpSysRootDispersion, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, ntpSysMode=ntpSysMode, xli=xli, ntpSysVersion=ntpSysVersion, symmNetworkManagement=symmNetworkManagement, s100=s100, tyming=tyming, net=net, ntpSysError=ntpSysError, products=products, gpsHealth=gpsHealth, etcUpgradeServer=etcUpgradeServer, nts=nts, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, ts2000=ts2000, dialup=dialup, symmCmipManagement=symmCmipManagement, tymingVersion=tymingVersion)
