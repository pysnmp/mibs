...
Bits, NotificationType, ObjectIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, IpAddress, MibIdentifier, Counter32, iso, Integer32, TimeTicks, Counter64, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "ObjectIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "IpAddress", "MibIdentifier", "Counter32", "iso", "Integer32", "TimeTicks", "Counter64", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsSatlist=gpsSatlist, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, experiment=experiment, symmTimePictra=symmTimePictra, ntpSysRefTime=ntpSysRefTime, gpsUTCOffset=gpsUTCOffset, ntpSysProcessor=ntpSysProcessor, ts2000=ts2000, version=version, etc=etc, ntpSysError=ntpSysError, ntpSysLeap=ntpSysLeap, ntpSysFreq=ntpSysFreq, ntpSysRootDelay=ntpSysRootDelay, tymingTime=tymingTime, s100=s100, etcAlarm=etcAlarm, ntpSysPrecision=ntpSysPrecision, symmTTM=symmTTM, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysVersion=ntpSysVersion, ntpSysRefID=ntpSysRefID, symmSnmpManagement=symmSnmpManagement, tymingVersion=tymingVersion, etcAlarmString=etcAlarmString, ntpSysStratum=ntpSysStratum, xli=xli, ntpSysPoll=ntpSysPoll, net=net, ntpSysPhase=ntpSysPhase, products=products, tymingStatus=tymingStatus, gpsPosition=gpsPosition, etcSerialNbr=etcSerialNbr, etcUpgradeServer=etcUpgradeServer, gpsHealth=gpsHealth, symmCmipManagement=symmCmipManagement, tymingFlyPeriod=tymingFlyPeriod, tyming=tyming, ntpSystem=ntpSystem, ntpSysMode=ntpSysMode, ntpSysPktsReceived=ntpSysPktsReceived, etcVersion=etcVersion, gps=gps, etcModel=etcModel, gpsMode=gpsMode, syncserver=syncserver, ntpSysNotrust=ntpSysNotrust, ts2100=ts2100, ntpSysSystem=ntpSysSystem, tymingSource=tymingSource, symmNetworkManagement=symmNetworkManagement, PYSNMP_MODULE_ID=symmetricom, ntpSysPeer=ntpSysPeer, ntpSysClock=ntpSysClock, symmetricom=symmetricom, dialup=dialup, nts=nts)
