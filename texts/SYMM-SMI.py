...
iso, IpAddress, Counter32, NotificationType, Gauge32, ModuleIdentity, Unsigned32, Bits, TimeTicks, NotificationType, Integer32, Counter64, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Counter32", "NotificationType", "Gauge32", "ModuleIdentity", "Unsigned32", "Bits", "TimeTicks", "NotificationType", "Integer32", "Counter64", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysSystem=ntpSysSystem, gpsUTCOffset=gpsUTCOffset, ntpSystem=ntpSystem, experiment=experiment, gps=gps, products=products, net=net, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, ntpSysPktsReceived=ntpSysPktsReceived, tymingStatus=tymingStatus, ntpSysMode=ntpSysMode, tymingTime=tymingTime, symmetricom=symmetricom, symmCmipManagement=symmCmipManagement, s100=s100, symmTTM=symmTTM, etcUpgradeServer=etcUpgradeServer, nts=nts, ntpSysPeer=ntpSysPeer, tymingVersion=tymingVersion, ts2000=ts2000, gpsHealth=gpsHealth, ntpSysFreq=ntpSysFreq, ntpSysRefTime=ntpSysRefTime, ntpSysClock=ntpSysClock, gpsPosition=gpsPosition, ts2100=ts2100, etc=etc, ntpSysPrecision=ntpSysPrecision, etcAlarmString=etcAlarmString, syncserver=syncserver, version=version, ntpSysLeap=ntpSysLeap, ntpSysNotrust=ntpSysNotrust, etcVersion=etcVersion, ntpSysProcessor=ntpSysProcessor, ntpSysRootDelay=ntpSysRootDelay, ntpSysError=ntpSysError, symmSnmpManagement=symmSnmpManagement, etcSerialNbr=etcSerialNbr, symmTimePictra=symmTimePictra, etcUpgrade=etcUpgrade, xli=xli, ntpSysPhase=ntpSysPhase, tyming=tyming, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPoll=ntpSysPoll, etcModel=etcModel, etcAlarm=etcAlarm, gpsSatlist=gpsSatlist, ntpSysVersion=ntpSysVersion, tymingFlyPeriod=tymingFlyPeriod, dialup=dialup, tymingSource=tymingSource, symmNetworkManagement=symmNetworkManagement, gpsMode=gpsMode)
