...
Bits, Gauge32, enterprises, iso, ObjectIdentity, NotificationType, MibIdentifier, Counter64, Counter32, TimeTicks, Unsigned32, NotificationType, ModuleIdentity, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "enterprises", "iso", "ObjectIdentity", "NotificationType", "MibIdentifier", "Counter64", "Counter32", "TimeTicks", "Unsigned32", "NotificationType", "ModuleIdentity", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", symmNetworkManagement=symmNetworkManagement, tymingFlyPeriod=tymingFlyPeriod, ntpSystem=ntpSystem, symmetricom=symmetricom, products=products, ntpSysStratum=ntpSysStratum, ntpSysNotrust=ntpSysNotrust, gpsPosition=gpsPosition, symmSnmpManagement=symmSnmpManagement, ntpSysClock=ntpSysClock, etcVersion=etcVersion, symmTTM=symmTTM, tymingTime=tymingTime, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDispersion=ntpSysRootDispersion, etcUpgradeServer=etcUpgradeServer, s100=s100, ntpSysMode=ntpSysMode, ntpSysFreq=ntpSysFreq, ntpSysSystem=ntpSysSystem, ntpSysRootDelay=ntpSysRootDelay, ntpSysVersion=ntpSysVersion, ntpSysLeap=ntpSysLeap, symmBroadband=symmBroadband, nts=nts, ts2100=ts2100, net=net, ntpSysPeer=ntpSysPeer, gpsHealth=gpsHealth, syncserver=syncserver, etcAlarmString=etcAlarmString, version=version, gps=gps, ntpSysPrecision=ntpSysPrecision, ntpSysError=ntpSysError, tymingVersion=tymingVersion, ntpSysRefTime=ntpSysRefTime, xli=xli, dialup=dialup, symmCmipManagement=symmCmipManagement, ntpSysRefID=ntpSysRefID, gpsUTCOffset=gpsUTCOffset, etcModel=etcModel, etcSerialNbr=etcSerialNbr, ntpSysPhase=ntpSysPhase, etcAlarm=etcAlarm, ntpSysProcessor=ntpSysProcessor, symmTimePictra=symmTimePictra, gpsSatlist=gpsSatlist, experiment=experiment, tymingSource=tymingSource, ntpSysPoll=ntpSysPoll, gpsMode=gpsMode, etcUpgrade=etcUpgrade, etc=etc, tyming=tyming, ntpSysPktsReceived=ntpSysPktsReceived, ts2000=ts2000, tymingStatus=tymingStatus)
