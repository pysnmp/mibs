...
MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, Counter32, ObjectIdentity, Bits, TimeTicks, Integer32, NotificationType, Gauge32, iso, IpAddress, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "Counter32", "ObjectIdentity", "Bits", "TimeTicks", "Integer32", "NotificationType", "Gauge32", "iso", "IpAddress", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDelay=ntpSysRootDelay, tymingSource=tymingSource, ntpSysSystem=ntpSysSystem, tymingStatus=tymingStatus, experiment=experiment, ts2000=ts2000, ntpSysMode=ntpSysMode, gpsSatlist=gpsSatlist, xli=xli, ntpSysVersion=ntpSysVersion, dialup=dialup, ntpSysNotrust=ntpSysNotrust, s100=s100, gpsMode=gpsMode, ts2100=ts2100, ntpSysRootDispersion=ntpSysRootDispersion, tymingVersion=tymingVersion, etcUpgrade=etcUpgrade, nts=nts, ntpSysError=ntpSysError, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysProcessor=ntpSysProcessor, etcVersion=etcVersion, etcSerialNbr=etcSerialNbr, tymingTime=tymingTime, PYSNMP_MODULE_ID=symmetricom, products=products, etcAlarmString=etcAlarmString, gps=gps, etcModel=etcModel, ntpSysPoll=ntpSysPoll, symmTimePictra=symmTimePictra, ntpSysFreq=ntpSysFreq, etc=etc, gpsHealth=gpsHealth, ntpSysLeap=ntpSysLeap, net=net, etcAlarm=etcAlarm, syncserver=syncserver, tymingFlyPeriod=tymingFlyPeriod, version=version, etcUpgradeServer=etcUpgradeServer, ntpSysClock=ntpSysClock, tyming=tyming, symmetricom=symmetricom, symmNetworkManagement=symmNetworkManagement, gpsPosition=gpsPosition, gpsUTCOffset=gpsUTCOffset, symmSnmpManagement=symmSnmpManagement, ntpSysPhase=ntpSysPhase, ntpSysStratum=ntpSysStratum, symmCmipManagement=symmCmipManagement, ntpSysRefTime=ntpSysRefTime, symmBroadband=symmBroadband, ntpSysPrecision=ntpSysPrecision, ntpSysRefID=ntpSysRefID, symmTTM=symmTTM, ntpSysPeer=ntpSysPeer, ntpSystem=ntpSystem)
