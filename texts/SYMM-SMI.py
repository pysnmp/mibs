...
TimeTicks, NotificationType, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Unsigned32, ModuleIdentity, iso, Counter32, Bits, NotificationType, IpAddress, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "iso", "Counter32", "Bits", "NotificationType", "IpAddress", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefID=ntpSysRefID, etcSerialNbr=etcSerialNbr, ntpSysPrecision=ntpSysPrecision, tymingTime=tymingTime, symmNetworkManagement=symmNetworkManagement, syncserver=syncserver, ntpSysRefTime=ntpSysRefTime, symmTimePictra=symmTimePictra, etcModel=etcModel, etcAlarm=etcAlarm, gpsHealth=gpsHealth, products=products, ntpSystem=ntpSystem, gpsSatlist=gpsSatlist, gps=gps, s100=s100, nts=nts, ntpSysPhase=ntpSysPhase, symmCmipManagement=symmCmipManagement, ntpSysPoll=ntpSysPoll, gpsPosition=gpsPosition, ntpSysRootDelay=ntpSysRootDelay, tyming=tyming, symmBroadband=symmBroadband, ntpSysError=ntpSysError, symmetricom=symmetricom, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, ntpSysPeer=ntpSysPeer, symmTTM=symmTTM, experiment=experiment, ntpSysLeap=ntpSysLeap, xli=xli, net=net, ntpSysStratum=ntpSysStratum, etcAlarmString=etcAlarmString, ts2100=ts2100, etc=etc, gpsUTCOffset=gpsUTCOffset, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, ts2000=ts2000, ntpSysMode=ntpSysMode, ntpSysFreq=ntpSysFreq, ntpSysNotrust=ntpSysNotrust, ntpSysSystem=ntpSysSystem, gpsMode=gpsMode, etcUpgradeServer=etcUpgradeServer, tymingVersion=tymingVersion, PYSNMP_MODULE_ID=symmetricom, etcVersion=etcVersion, dialup=dialup, tymingStatus=tymingStatus, etcUpgrade=etcUpgrade, tymingSource=tymingSource, tymingFlyPeriod=tymingFlyPeriod, version=version, ntpSysVersion=ntpSysVersion)
