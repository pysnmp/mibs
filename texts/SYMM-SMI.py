...
Bits, Unsigned32, Integer32, IpAddress, Gauge32, iso, ObjectIdentity, enterprises, Counter32, NotificationType, NotificationType, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "Integer32", "IpAddress", "Gauge32", "iso", "ObjectIdentity", "enterprises", "Counter32", "NotificationType", "NotificationType", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("SYMM-SMI", syncserver=syncserver, ntpSysPeer=ntpSysPeer, tyming=tyming, ntpSysPrecision=ntpSysPrecision, tymingSource=tymingSource, tymingTime=tymingTime, symmNetworkManagement=symmNetworkManagement, etcUpgrade=etcUpgrade, symmTTM=symmTTM, symmBroadband=symmBroadband, experiment=experiment, nts=nts, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, ntpSysVersion=ntpSysVersion, gpsPosition=gpsPosition, ntpSysRefID=ntpSysRefID, symmetricom=symmetricom, dialup=dialup, ntpSysPoll=ntpSysPoll, ntpSystem=ntpSystem, ntpSysFreq=ntpSysFreq, tymingVersion=tymingVersion, etcSerialNbr=etcSerialNbr, xli=xli, symmCmipManagement=symmCmipManagement, ntpSysStratum=ntpSysStratum, PYSNMP_MODULE_ID=symmetricom, s100=s100, gpsUTCOffset=gpsUTCOffset, etcUpgradeServer=etcUpgradeServer, etcModel=etcModel, net=net, ts2100=ts2100, ntpSysLeap=ntpSysLeap, gpsSatlist=gpsSatlist, tymingFlyPeriod=tymingFlyPeriod, etc=etc, ntpSysError=ntpSysError, ntpSysClock=ntpSysClock, etcAlarm=etcAlarm, ntpSysSystem=ntpSysSystem, ntpSysRootDispersion=ntpSysRootDispersion, gpsHealth=gpsHealth, etcAlarmString=etcAlarmString, gps=gps, products=products, ntpSysRefTime=ntpSysRefTime, tymingStatus=tymingStatus, ntpSysRootDelay=ntpSysRootDelay, ntpSysPhase=ntpSysPhase, gpsMode=gpsMode, ts2000=ts2000, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysMode=ntpSysMode, symmSnmpManagement=symmSnmpManagement, etcVersion=etcVersion, symmTimePictra=symmTimePictra, version=version)
