...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, etcUpgradeServer=etcUpgradeServer, symmTTM=symmTTM, PYSNMP_MODULE_ID=symmetricom, symmetricom=symmetricom, s100=s100, gps=gps, ntpSysRefTime=ntpSysRefTime, gpsUTCOffset=gpsUTCOffset, ntpSysFreq=ntpSysFreq, ntpSysClock=ntpSysClock, ts2100=ts2100, products=products, ntpSysSystem=ntpSysSystem, nts=nts, syncserver=syncserver, ntpSysMode=ntpSysMode, ntpSysError=ntpSysError, tymingTime=tymingTime, ntpSysStratum=ntpSysStratum, ntpSysRootDelay=ntpSysRootDelay, ntpSysRefID=ntpSysRefID, xli=xli, etcSerialNbr=etcSerialNbr, tyming=tyming, experiment=experiment, etcAlarm=etcAlarm, symmSnmpManagement=symmSnmpManagement, version=version, symmBroadband=symmBroadband, ntpSysNotrust=ntpSysNotrust, ntpSysVersion=ntpSysVersion, symmNetworkManagement=symmNetworkManagement, tymingStatus=tymingStatus, tymingVersion=tymingVersion, etcUpgrade=etcUpgrade, etcAlarmString=etcAlarmString, ntpSysPrecision=ntpSysPrecision, ntpSysPhase=ntpSysPhase, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysLeap=ntpSysLeap, gpsPosition=gpsPosition, gpsHealth=gpsHealth, ntpSysPoll=ntpSysPoll, etc=etc, tymingFlyPeriod=tymingFlyPeriod, symmTimePictra=symmTimePictra, dialup=dialup, etcVersion=etcVersion, ntpSysProcessor=ntpSysProcessor, tymingSource=tymingSource, ntpSystem=ntpSystem, net=net, symmCmipManagement=symmCmipManagement, gpsSatlist=gpsSatlist, gpsMode=gpsMode, ts2000=ts2000, ntpSysPeer=ntpSysPeer, etcModel=etcModel)
