...
Gauge32, NotificationType, enterprises, ObjectIdentity, iso, NotificationType, Counter32, Counter64, IpAddress, Bits, TimeTicks, MibIdentifier, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "enterprises", "ObjectIdentity", "iso", "NotificationType", "Counter32", "Counter64", "IpAddress", "Bits", "TimeTicks", "MibIdentifier", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysFreq=ntpSysFreq, gpsPosition=gpsPosition, PYSNMP_MODULE_ID=symmetricom, ntpSysPeer=ntpSysPeer, symmetricom=symmetricom, ntpSysPoll=ntpSysPoll, ntpSysLeap=ntpSysLeap, net=net, ntpSysError=ntpSysError, ntpSysStratum=ntpSysStratum, etc=etc, ntpSysPhase=ntpSysPhase, gps=gps, dialup=dialup, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, nts=nts, ts2000=ts2000, ts2100=ts2100, etcUpgradeServer=etcUpgradeServer, tymingFlyPeriod=tymingFlyPeriod, s100=s100, symmTTM=symmTTM, version=version, ntpSysPrecision=ntpSysPrecision, ntpSysRefTime=ntpSysRefTime, symmCmipManagement=symmCmipManagement, experiment=experiment, symmNetworkManagement=symmNetworkManagement, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefID=ntpSysRefID, syncserver=syncserver, etcUpgrade=etcUpgrade, ntpSysNotrust=ntpSysNotrust, gpsUTCOffset=gpsUTCOffset, products=products, xli=xli, gpsMode=gpsMode, symmSnmpManagement=symmSnmpManagement, ntpSysRootDelay=ntpSysRootDelay, tymingTime=tymingTime, etcAlarm=etcAlarm, gpsHealth=gpsHealth, ntpSysProcessor=ntpSysProcessor, etcVersion=etcVersion, ntpSysSystem=ntpSysSystem, gpsSatlist=gpsSatlist, symmTimePictra=symmTimePictra, ntpSystem=ntpSystem, tymingVersion=tymingVersion, etcModel=etcModel, ntpSysMode=ntpSysMode, symmBroadband=symmBroadband, tyming=tyming, ntpSysClock=ntpSysClock, etcSerialNbr=etcSerialNbr, ntpSysVersion=ntpSysVersion, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString)
