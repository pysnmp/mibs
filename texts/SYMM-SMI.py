...
Bits, Gauge32, Integer32, iso, NotificationType, enterprises, Counter32, ModuleIdentity, Unsigned32, Counter64, MibIdentifier, ObjectIdentity, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Gauge32", "Integer32", "iso", "NotificationType", "enterprises", "Counter32", "ModuleIdentity", "Unsigned32", "Counter64", "MibIdentifier", "ObjectIdentity", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPeer=ntpSysPeer, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, PYSNMP_MODULE_ID=symmetricom, dialup=dialup, ntpSystem=ntpSystem, ntpSysRefID=ntpSysRefID, ntpSysError=ntpSysError, symmTTM=symmTTM, ntpSysVersion=ntpSysVersion, etcAlarmString=etcAlarmString, ts2000=ts2000, s100=s100, ntpSysPhase=ntpSysPhase, xli=xli, experiment=experiment, ntpSysRootDelay=ntpSysRootDelay, ntpSysNotrust=ntpSysNotrust, symmTimePictra=symmTimePictra, ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem, etcModel=etcModel, gps=gps, etc=etc, gpsPosition=gpsPosition, ntpSysPoll=ntpSysPoll, ntpSysStratum=ntpSysStratum, ntpSysProcessor=ntpSysProcessor, gpsUTCOffset=gpsUTCOffset, etcVersion=etcVersion, ntpSysPktsReceived=ntpSysPktsReceived, nts=nts, gpsMode=gpsMode, tymingSource=tymingSource, tymingTime=tymingTime, ntpSysRefTime=ntpSysRefTime, ntpSysFreq=ntpSysFreq, symmBroadband=symmBroadband, gpsHealth=gpsHealth, ntpSysRootDispersion=ntpSysRootDispersion, etcSerialNbr=etcSerialNbr, tymingStatus=tymingStatus, net=net, version=version, ntpSysLeap=ntpSysLeap, symmetricom=symmetricom, symmSnmpManagement=symmSnmpManagement, tymingFlyPeriod=tymingFlyPeriod, ntpSysPrecision=ntpSysPrecision, ntpSysMode=ntpSysMode, etcUpgrade=etcUpgrade, gpsSatlist=gpsSatlist, tymingVersion=tymingVersion, etcAlarm=etcAlarm, symmCmipManagement=symmCmipManagement, tyming=tyming, products=products, ts2100=ts2100, syncserver=syncserver)
