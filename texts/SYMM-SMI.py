...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysClock=ntpSysClock, ntpSysPrecision=ntpSysPrecision, ntpSysNotrust=ntpSysNotrust, ts2100=ts2100, PYSNMP_MODULE_ID=symmetricom, ntpSysStratum=ntpSysStratum, gps=gps, tymingVersion=tymingVersion, tymingFlyPeriod=tymingFlyPeriod, symmetricom=symmetricom, etcModel=etcModel, tyming=tyming, etcAlarmString=etcAlarmString, symmBroadband=symmBroadband, syncserver=syncserver, symmTimePictra=symmTimePictra, ntpSysMode=ntpSysMode, etcSerialNbr=etcSerialNbr, ntpSysPktsReceived=ntpSysPktsReceived, version=version, gpsUTCOffset=gpsUTCOffset, ntpSysLeap=ntpSysLeap, gpsSatlist=gpsSatlist, ts2000=ts2000, ntpSysRefID=ntpSysRefID, s100=s100, products=products, ntpSysRefTime=ntpSysRefTime, ntpSystem=ntpSystem, ntpSysPhase=ntpSysPhase, xli=xli, ntpSysFreq=ntpSysFreq, etcUpgradeServer=etcUpgradeServer, tymingTime=tymingTime, gpsMode=gpsMode, ntpSysPeer=ntpSysPeer, etcAlarm=etcAlarm, net=net, symmSnmpManagement=symmSnmpManagement, symmTTM=symmTTM, ntpSysRootDispersion=ntpSysRootDispersion, tymingStatus=tymingStatus, ntpSysVersion=ntpSysVersion, gpsPosition=gpsPosition, ntpSysRootDelay=ntpSysRootDelay, ntpSysSystem=ntpSysSystem, nts=nts, ntpSysPoll=ntpSysPoll, symmCmipManagement=symmCmipManagement, experiment=experiment, ntpSysError=ntpSysError, ntpSysProcessor=ntpSysProcessor, gpsHealth=gpsHealth, symmNetworkManagement=symmNetworkManagement, etcVersion=etcVersion, etcUpgrade=etcUpgrade, tymingSource=tymingSource, dialup=dialup, etc=etc)
