...
iso, NotificationType, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, MibIdentifier, ObjectIdentity, Gauge32, ModuleIdentity, enterprises, Unsigned32, IpAddress, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "MibIdentifier", "ObjectIdentity", "Gauge32", "ModuleIdentity", "enterprises", "Unsigned32", "IpAddress", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("SYMM-SMI", etcModel=etcModel, ntpSysPrecision=ntpSysPrecision, dialup=dialup, tymingTime=tymingTime, etcSerialNbr=etcSerialNbr, symmNetworkManagement=symmNetworkManagement, ntpSysFreq=ntpSysFreq, ntpSysNotrust=ntpSysNotrust, etcUpgrade=etcUpgrade, etcVersion=etcVersion, tymingFlyPeriod=tymingFlyPeriod, etcUpgradeServer=etcUpgradeServer, gpsSatlist=gpsSatlist, xli=xli, syncserver=syncserver, ntpSysRootDelay=ntpSysRootDelay, symmBroadband=symmBroadband, etcAlarmString=etcAlarmString, experiment=experiment, ntpSysSystem=ntpSysSystem, ntpSysRefID=ntpSysRefID, ntpSystem=ntpSystem, ntpSysLeap=ntpSysLeap, s100=s100, ntpSysPktsReceived=ntpSysPktsReceived, version=version, ntpSysPoll=ntpSysPoll, ntpSysPeer=ntpSysPeer, ntpSysProcessor=ntpSysProcessor, gpsHealth=gpsHealth, ntpSysVersion=ntpSysVersion, nts=nts, ts2100=ts2100, ntpSysStratum=ntpSysStratum, ntpSysRootDispersion=ntpSysRootDispersion, net=net, ntpSysRefTime=ntpSysRefTime, tymingVersion=tymingVersion, symmCmipManagement=symmCmipManagement, etcAlarm=etcAlarm, symmSnmpManagement=symmSnmpManagement, tyming=tyming, etc=etc, tymingSource=tymingSource, symmTTM=symmTTM, ntpSysMode=ntpSysMode, gps=gps, ntpSysError=ntpSysError, symmetricom=symmetricom, PYSNMP_MODULE_ID=symmetricom, ntpSysPhase=ntpSysPhase, products=products, gpsUTCOffset=gpsUTCOffset, gpsMode=gpsMode, symmTimePictra=symmTimePictra, ntpSysClock=ntpSysClock, gpsPosition=gpsPosition, ts2000=ts2000, tymingStatus=tymingStatus)
