...
enterprises, TimeTicks, NotificationType, ObjectIdentity, iso, IpAddress, MibIdentifier, Integer32, Counter32, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "NotificationType", "ObjectIdentity", "iso", "IpAddress", "MibIdentifier", "Integer32", "Counter32", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("SYMM-SMI", tymingFlyPeriod=tymingFlyPeriod, etc=etc, ntpSysError=ntpSysError, ntpSysStratum=ntpSysStratum, dialup=dialup, ntpSysLeap=ntpSysLeap, ntpSysPoll=ntpSysPoll, ntpSysSystem=ntpSysSystem, etcUpgrade=etcUpgrade, tymingVersion=tymingVersion, symmCmipManagement=symmCmipManagement, tyming=tyming, ntpSysRefTime=ntpSysRefTime, syncserver=syncserver, ntpSysPktsReceived=ntpSysPktsReceived, tymingTime=tymingTime, ntpSysMode=ntpSysMode, ntpSystem=ntpSystem, ntpSysRootDelay=ntpSysRootDelay, gpsMode=gpsMode, ntpSysRefID=ntpSysRefID, etcModel=etcModel, ntpSysRootDispersion=ntpSysRootDispersion, ts2100=ts2100, ntpSysPhase=ntpSysPhase, version=version, symmTTM=symmTTM, symmTimePictra=symmTimePictra, ntpSysNotrust=ntpSysNotrust, etcVersion=etcVersion, gpsSatlist=gpsSatlist, etcAlarmString=etcAlarmString, symmSnmpManagement=symmSnmpManagement, net=net, ntpSysPrecision=ntpSysPrecision, symmetricom=symmetricom, ntpSysPeer=ntpSysPeer, gps=gps, symmBroadband=symmBroadband, ntpSysVersion=ntpSysVersion, symmNetworkManagement=symmNetworkManagement, tymingSource=tymingSource, ts2000=ts2000, etcUpgradeServer=etcUpgradeServer, tymingStatus=tymingStatus, s100=s100, PYSNMP_MODULE_ID=symmetricom, nts=nts, etcSerialNbr=etcSerialNbr, gpsHealth=gpsHealth, etcAlarm=etcAlarm, gpsUTCOffset=gpsUTCOffset, products=products, gpsPosition=gpsPosition, ntpSysFreq=ntpSysFreq, experiment=experiment, xli=xli, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor)
