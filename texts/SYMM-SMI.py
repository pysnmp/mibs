...
TimeTicks, Counter64, ObjectIdentity, IpAddress, Bits, MibIdentifier, Integer32, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, NotificationType, iso, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "ObjectIdentity", "IpAddress", "Bits", "MibIdentifier", "Integer32", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "NotificationType", "iso", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsMode=gpsMode, symmSnmpManagement=symmSnmpManagement, ntpSysRefID=ntpSysRefID, symmetricom=symmetricom, products=products, nts=nts, etcAlarmString=etcAlarmString, version=version, gpsHealth=gpsHealth, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, gpsPosition=gpsPosition, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysError=ntpSysError, ntpSysLeap=ntpSysLeap, dialup=dialup, ntpSysPoll=ntpSysPoll, symmTimePictra=symmTimePictra, net=net, etc=etc, tymingStatus=tymingStatus, gps=gps, ntpSysVersion=ntpSysVersion, ntpSysStratum=ntpSysStratum, gpsSatlist=gpsSatlist, ntpSysRefTime=ntpSysRefTime, etcUpgradeServer=etcUpgradeServer, ntpSysRootDispersion=ntpSysRootDispersion, tymingFlyPeriod=tymingFlyPeriod, syncserver=syncserver, etcModel=etcModel, ntpSysFreq=ntpSysFreq, symmNetworkManagement=symmNetworkManagement, s100=s100, ntpSysPrecision=ntpSysPrecision, tyming=tyming, etcUpgrade=etcUpgrade, gpsUTCOffset=gpsUTCOffset, ntpSysPeer=ntpSysPeer, tymingSource=tymingSource, PYSNMP_MODULE_ID=symmetricom, etcAlarm=etcAlarm, ntpSystem=ntpSystem, tymingVersion=tymingVersion, ntpSysSystem=ntpSysSystem, ts2000=ts2000, xli=xli, ntpSysMode=ntpSysMode, symmBroadband=symmBroadband, etcVersion=etcVersion, ntpSysNotrust=ntpSysNotrust, tymingTime=tymingTime, symmCmipManagement=symmCmipManagement, symmTTM=symmTTM, experiment=experiment, ntpSysRootDelay=ntpSysRootDelay, ntpSysPhase=ntpSysPhase, etcSerialNbr=etcSerialNbr, ts2100=ts2100)
