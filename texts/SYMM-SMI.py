...
Integer32, ModuleIdentity, Counter32, IpAddress, Unsigned32, TimeTicks, MibIdentifier, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, enterprises, NotificationType, Bits, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Counter32", "IpAddress", "Unsigned32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "enterprises", "NotificationType", "Bits", "NotificationType", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsHealth=gpsHealth, symmetricom=symmetricom, products=products, etc=etc, gpsMode=gpsMode, s100=s100, tymingStatus=tymingStatus, ntpSysPrecision=ntpSysPrecision, ntpSysPeer=ntpSysPeer, experiment=experiment, syncserver=syncserver, etcModel=etcModel, nts=nts, ntpSysClock=ntpSysClock, symmBroadband=symmBroadband, xli=xli, ntpSysError=ntpSysError, gpsPosition=gpsPosition, etcVersion=etcVersion, dialup=dialup, ntpSysRefID=ntpSysRefID, ntpSysPhase=ntpSysPhase, ntpSysLeap=ntpSysLeap, symmTTM=symmTTM, tymingVersion=tymingVersion, symmCmipManagement=symmCmipManagement, etcAlarm=etcAlarm, ts2100=ts2100, ntpSysMode=ntpSysMode, ntpSysNotrust=ntpSysNotrust, gps=gps, tymingSource=tymingSource, net=net, ntpSysStratum=ntpSysStratum, ntpSysPktsReceived=ntpSysPktsReceived, tymingFlyPeriod=tymingFlyPeriod, etcUpgrade=etcUpgrade, ntpSysSystem=ntpSysSystem, gpsUTCOffset=gpsUTCOffset, version=version, ntpSysFreq=ntpSysFreq, ntpSysVersion=ntpSysVersion, ntpSysPoll=ntpSysPoll, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDelay=ntpSysRootDelay, symmNetworkManagement=symmNetworkManagement, ntpSystem=ntpSystem, ts2000=ts2000, symmTimePictra=symmTimePictra, ntpSysProcessor=ntpSysProcessor, symmSnmpManagement=symmSnmpManagement, etcUpgradeServer=etcUpgradeServer, gpsSatlist=gpsSatlist, tyming=tyming, ntpSysRefTime=ntpSysRefTime, tymingTime=tymingTime, ntpSysRootDispersion=ntpSysRootDispersion, etcSerialNbr=etcSerialNbr, etcAlarmString=etcAlarmString)
