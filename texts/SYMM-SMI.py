...
mibBuilder.exportSymbols("SYMM-SMI", version=version, ntpSysSystem=ntpSysSystem, syncserver=syncserver, gps=gps, ntpSysNotrust=ntpSysNotrust, ntpSysRefID=ntpSysRefID, gpsSatlist=gpsSatlist, ntpSysPoll=ntpSysPoll, s100=s100, ntpSysClock=ntpSysClock, ntpSysProcessor=ntpSysProcessor, tymingFlyPeriod=tymingFlyPeriod, ntpSysRefTime=ntpSysRefTime, tymingVersion=tymingVersion, symmBroadband=symmBroadband, tyming=tyming, etcModel=etcModel, ntpSysVersion=ntpSysVersion, symmSnmpManagement=symmSnmpManagement, net=net, gpsMode=gpsMode, etcSerialNbr=etcSerialNbr, symmCmipManagement=symmCmipManagement, symmetricom=symmetricom, ts2100=ts2100, experiment=experiment, dialup=dialup, ntpSysError=ntpSysError, etcAlarm=etcAlarm, ntpSysStratum=ntpSysStratum, ntpSysPhase=ntpSysPhase, ntpSysRootDelay=ntpSysRootDelay, ntpSysMode=ntpSysMode, symmTimePictra=symmTimePictra, symmTTM=symmTTM, etcUpgradeServer=etcUpgradeServer, tymingTime=tymingTime, products=products, gpsPosition=gpsPosition, xli=xli, etc=etc, ntpSystem=ntpSystem, ts2000=ts2000, tymingStatus=tymingStatus, ntpSysPrecision=ntpSysPrecision, etcUpgrade=etcUpgrade, symmNetworkManagement=symmNetworkManagement, ntpSysFreq=ntpSysFreq, ntpSysLeap=ntpSysLeap, etcVersion=etcVersion, ntpSysPeer=ntpSysPeer, gpsHealth=gpsHealth, etcAlarmString=etcAlarmString, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPktsReceived=ntpSysPktsReceived, PYSNMP_MODULE_ID=symmetricom, tymingSource=tymingSource, gpsUTCOffset=gpsUTCOffset, nts=nts)
