...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPeer=ntpSysPeer, ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, gps=gps, symmCmipManagement=symmCmipManagement, syncserver=syncserver, ntpSysLeap=ntpSysLeap, ts2100=ts2100, products=products, tymingFlyPeriod=tymingFlyPeriod, ntpSysRootDelay=ntpSysRootDelay, etcSerialNbr=etcSerialNbr, etcAlarm=etcAlarm, gpsPosition=gpsPosition, ntpSysRefTime=ntpSysRefTime, ntpSysPhase=ntpSysPhase, symmNetworkManagement=symmNetworkManagement, ntpSysProcessor=ntpSysProcessor, symmTTM=symmTTM, etcUpgrade=etcUpgrade, s100=s100, tyming=tyming, ntpSysPoll=ntpSysPoll, gpsMode=gpsMode, symmBroadband=symmBroadband, net=net, etc=etc, gpsSatlist=gpsSatlist, symmSnmpManagement=symmSnmpManagement, ntpSysPktsReceived=ntpSysPktsReceived, xli=xli, experiment=experiment, tymingSource=tymingSource, symmetricom=symmetricom, ntpSysRefID=ntpSysRefID, version=version, ntpSysVersion=ntpSysVersion, etcUpgradeServer=etcUpgradeServer, ntpSystem=ntpSystem, etcModel=etcModel, ntpSysClock=ntpSysClock, symmTimePictra=symmTimePictra, ntpSysStratum=ntpSysStratum, tymingTime=tymingTime, PYSNMP_MODULE_ID=symmetricom, ntpSysFreq=ntpSysFreq, tymingStatus=tymingStatus, ntpSysMode=ntpSysMode, gpsUTCOffset=gpsUTCOffset, etcVersion=etcVersion, gpsHealth=gpsHealth, ntpSysPrecision=ntpSysPrecision, etcAlarmString=etcAlarmString, dialup=dialup, nts=nts, ntpSysNotrust=ntpSysNotrust, ts2000=ts2000, tymingVersion=tymingVersion)
