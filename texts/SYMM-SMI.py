...
Counter64, IpAddress, NotificationType, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, Counter32, TimeTicks, ModuleIdentity, Integer32, Unsigned32, NotificationType, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "NotificationType", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "Counter32", "TimeTicks", "ModuleIdentity", "Integer32", "Unsigned32", "NotificationType", "iso", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", gps=gps, ntpSysPrecision=ntpSysPrecision, ntpSysRefID=ntpSysRefID, etc=etc, ntpSysClock=ntpSysClock, tymingFlyPeriod=tymingFlyPeriod, ntpSysMode=ntpSysMode, symmetricom=symmetricom, ntpSystem=ntpSystem, version=version, tyming=tyming, tymingStatus=tymingStatus, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, symmSnmpManagement=symmSnmpManagement, ntpSysProcessor=ntpSysProcessor, syncserver=syncserver, net=net, gpsHealth=gpsHealth, tymingVersion=tymingVersion, xli=xli, ntpSysError=ntpSysError, nts=nts, PYSNMP_MODULE_ID=symmetricom, symmNetworkManagement=symmNetworkManagement, gpsUTCOffset=gpsUTCOffset, ntpSysVersion=ntpSysVersion, experiment=experiment, ntpSysStratum=ntpSysStratum, ntpSysPeer=ntpSysPeer, ntpSysFreq=ntpSysFreq, tymingSource=tymingSource, gpsPosition=gpsPosition, etcModel=etcModel, products=products, symmCmipManagement=symmCmipManagement, ntpSysLeap=ntpSysLeap, tymingTime=tymingTime, symmTimePictra=symmTimePictra, symmBroadband=symmBroadband, etcUpgrade=etcUpgrade, s100=s100, symmTTM=symmTTM, ntpSysNotrust=ntpSysNotrust, gpsSatlist=gpsSatlist, ntpSysRootDelay=ntpSysRootDelay, ntpSysPoll=ntpSysPoll, ntpSysRefTime=ntpSysRefTime, ntpSysPktsReceived=ntpSysPktsReceived, ts2000=ts2000, ntpSysPhase=ntpSysPhase, etcSerialNbr=etcSerialNbr, etcAlarm=etcAlarm, ts2100=ts2100, gpsMode=gpsMode, ntpSysSystem=ntpSysSystem, ntpSysRootDispersion=ntpSysRootDispersion, dialup=dialup, etcAlarmString=etcAlarmString)
