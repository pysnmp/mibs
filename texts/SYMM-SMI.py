...
Integer32, ObjectIdentity, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Unsigned32, Counter32, NotificationType, enterprises, Bits, Gauge32, NotificationType, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Unsigned32", "Counter32", "NotificationType", "enterprises", "Bits", "Gauge32", "NotificationType", "IpAddress", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", version=version, etcUpgradeServer=etcUpgradeServer, ntpSysError=ntpSysError, ntpSystem=ntpSystem, ntpSysRefID=ntpSysRefID, gpsPosition=gpsPosition, gpsUTCOffset=gpsUTCOffset, etcModel=etcModel, tymingFlyPeriod=tymingFlyPeriod, symmCmipManagement=symmCmipManagement, ts2100=ts2100, experiment=experiment, symmTTM=symmTTM, gps=gps, ntpSysMode=ntpSysMode, tyming=tyming, net=net, xli=xli, ntpSysPrecision=ntpSysPrecision, ntpSysPeer=ntpSysPeer, symmBroadband=symmBroadband, ntpSysFreq=ntpSysFreq, ntpSysClock=ntpSysClock, ntpSysLeap=ntpSysLeap, ntpSysVersion=ntpSysVersion, etcSerialNbr=etcSerialNbr, ntpSysPktsReceived=ntpSysPktsReceived, tymingVersion=tymingVersion, symmNetworkManagement=symmNetworkManagement, nts=nts, dialup=dialup, etcUpgrade=etcUpgrade, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, syncserver=syncserver, gpsHealth=gpsHealth, etcVersion=etcVersion, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, gpsSatlist=gpsSatlist, etc=etc, tymingTime=tymingTime, ntpSysRootDelay=ntpSysRootDelay, ntpSysRefTime=ntpSysRefTime, symmSnmpManagement=symmSnmpManagement, ntpSysStratum=ntpSysStratum, PYSNMP_MODULE_ID=symmetricom, ntpSysPhase=ntpSysPhase, symmTimePictra=symmTimePictra, products=products, ntpSysRootDispersion=ntpSysRootDispersion, gpsMode=gpsMode, etcAlarm=etcAlarm, symmetricom=symmetricom, ts2000=ts2000, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, s100=s100, ntpSysSystem=ntpSysSystem)
