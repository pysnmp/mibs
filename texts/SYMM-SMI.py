...
ObjectIdentity, enterprises, TimeTicks, Counter32, ModuleIdentity, Bits, Unsigned32, NotificationType, iso, Integer32, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "enterprises", "TimeTicks", "Counter32", "ModuleIdentity", "Bits", "Unsigned32", "NotificationType", "iso", "Integer32", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("SYMM-SMI", tyming=tyming, tymingFlyPeriod=tymingFlyPeriod, etcModel=etcModel, etcVersion=etcVersion, etcAlarmString=etcAlarmString, ntpSysPktsReceived=ntpSysPktsReceived, gpsSatlist=gpsSatlist, ntpSysStratum=ntpSysStratum, symmetricom=symmetricom, symmTTM=symmTTM, products=products, ntpSysPoll=ntpSysPoll, symmNetworkManagement=symmNetworkManagement, etcUpgrade=etcUpgrade, gps=gps, symmBroadband=symmBroadband, ts2100=ts2100, ntpSysRefTime=ntpSysRefTime, symmCmipManagement=symmCmipManagement, etcUpgradeServer=etcUpgradeServer, ts2000=ts2000, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, ntpSystem=ntpSystem, dialup=dialup, xli=xli, ntpSysPeer=ntpSysPeer, ntpSysPhase=ntpSysPhase, ntpSysProcessor=ntpSysProcessor, ntpSysMode=ntpSysMode, tymingStatus=tymingStatus, tymingVersion=tymingVersion, gpsMode=gpsMode, ntpSysLeap=ntpSysLeap, PYSNMP_MODULE_ID=symmetricom, version=version, gpsUTCOffset=gpsUTCOffset, etcSerialNbr=etcSerialNbr, net=net, ntpSysNotrust=ntpSysNotrust, gpsPosition=gpsPosition, ntpSysError=ntpSysError, ntpSysClock=ntpSysClock, experiment=experiment, ntpSysVersion=ntpSysVersion, etc=etc, etcAlarm=etcAlarm, ntpSysPrecision=ntpSysPrecision, gpsHealth=gpsHealth, ntpSysRefID=ntpSysRefID, ntpSysSystem=ntpSysSystem, nts=nts, tymingSource=tymingSource, tymingTime=tymingTime, ntpSysFreq=ntpSysFreq, ntpSysRootDelay=ntpSysRootDelay, syncserver=syncserver, s100=s100)
