...
ModuleIdentity, Counter64, NotificationType, IpAddress, iso, enterprises, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Unsigned32, Integer32, Gauge32, MibIdentifier, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "NotificationType", "IpAddress", "iso", "enterprises", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Unsigned32", "Integer32", "Gauge32", "MibIdentifier", "Bits", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDispersion=ntpSysRootDispersion, net=net, ntpSysRefTime=ntpSysRefTime, tymingTime=tymingTime, tymingVersion=tymingVersion, ntpSysError=ntpSysError, gpsSatlist=gpsSatlist, ntpSysMode=ntpSysMode, symmNetworkManagement=symmNetworkManagement, symmSnmpManagement=symmSnmpManagement, symmCmipManagement=symmCmipManagement, symmTTM=symmTTM, ts2100=ts2100, ntpSysPrecision=ntpSysPrecision, ntpSysClock=ntpSysClock, tymingStatus=tymingStatus, etcVersion=etcVersion, ntpSysPoll=ntpSysPoll, ntpSysProcessor=ntpSysProcessor, tymingSource=tymingSource, nts=nts, etcAlarm=etcAlarm, symmBroadband=symmBroadband, ntpSysSystem=ntpSysSystem, symmetricom=symmetricom, tymingFlyPeriod=tymingFlyPeriod, experiment=experiment, gpsPosition=gpsPosition, ntpSystem=ntpSystem, symmTimePictra=symmTimePictra, s100=s100, etcModel=etcModel, ntpSysRefID=ntpSysRefID, ntpSysPhase=ntpSysPhase, ts2000=ts2000, gpsUTCOffset=gpsUTCOffset, syncserver=syncserver, ntpSysFreq=ntpSysFreq, ntpSysPeer=ntpSysPeer, etc=etc, gpsMode=gpsMode, etcSerialNbr=etcSerialNbr, products=products, ntpSysStratum=ntpSysStratum, PYSNMP_MODULE_ID=symmetricom, etcAlarmString=etcAlarmString, tyming=tyming, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgrade=etcUpgrade, version=version, dialup=dialup, ntpSysNotrust=ntpSysNotrust, gpsHealth=gpsHealth, gps=gps, ntpSysRootDelay=ntpSysRootDelay, etcUpgradeServer=etcUpgradeServer, ntpSysLeap=ntpSysLeap, ntpSysVersion=ntpSysVersion, xli=xli)
