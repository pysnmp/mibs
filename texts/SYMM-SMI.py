...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysLeap=ntpSysLeap, symmTimePictra=symmTimePictra, gpsHealth=gpsHealth, xli=xli, ntpSysNotrust=ntpSysNotrust, ntpSysError=ntpSysError, ntpSysStratum=ntpSysStratum, ntpSysRootDelay=ntpSysRootDelay, ntpSysPrecision=ntpSysPrecision, tymingTime=tymingTime, etcSerialNbr=etcSerialNbr, etcAlarm=etcAlarm, ntpSysClock=ntpSysClock, etcUpgradeServer=etcUpgradeServer, syncserver=syncserver, gpsUTCOffset=gpsUTCOffset, gpsMode=gpsMode, symmCmipManagement=symmCmipManagement, ntpSysPeer=ntpSysPeer, ntpSysRefID=ntpSysRefID, ntpSysSystem=ntpSysSystem, symmBroadband=symmBroadband, gpsPosition=gpsPosition, etcVersion=etcVersion, ts2100=ts2100, ntpSysProcessor=ntpSysProcessor, ntpSysMode=ntpSysMode, ntpSysRootDispersion=ntpSysRootDispersion, etcAlarmString=etcAlarmString, gpsSatlist=gpsSatlist, tymingSource=tymingSource, ntpSysPhase=ntpSysPhase, tymingVersion=tymingVersion, ntpSysVersion=ntpSysVersion, etcModel=etcModel, tyming=tyming, symmetricom=symmetricom, ntpSysPktsReceived=ntpSysPktsReceived, products=products, PYSNMP_MODULE_ID=symmetricom, tymingFlyPeriod=tymingFlyPeriod, s100=s100, experiment=experiment, version=version, ntpSystem=ntpSystem, dialup=dialup, etc=etc, ntpSysFreq=ntpSysFreq, ntpSysRefTime=ntpSysRefTime, symmNetworkManagement=symmNetworkManagement, symmSnmpManagement=symmSnmpManagement, etcUpgrade=etcUpgrade, gps=gps, ts2000=ts2000, symmTTM=symmTTM, tymingStatus=tymingStatus, ntpSysPoll=ntpSysPoll, nts=nts, net=net)
