...
NotificationType, Counter64, enterprises, Integer32, NotificationType, ModuleIdentity, TimeTicks, Unsigned32, IpAddress, iso, MibIdentifier, Gauge32, ObjectIdentity, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "enterprises", "Integer32", "NotificationType", "ModuleIdentity", "TimeTicks", "Unsigned32", "IpAddress", "iso", "MibIdentifier", "Gauge32", "ObjectIdentity", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPeer=ntpSysPeer, syncserver=syncserver, symmNetworkManagement=symmNetworkManagement, xli=xli, ntpSysRefID=ntpSysRefID, tymingSource=tymingSource, etcAlarm=etcAlarm, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPrecision=ntpSysPrecision, ntpSysNotrust=ntpSysNotrust, s100=s100, symmetricom=symmetricom, ntpSysPoll=ntpSysPoll, gpsUTCOffset=gpsUTCOffset, tymingTime=tymingTime, symmBroadband=symmBroadband, symmSnmpManagement=symmSnmpManagement, ntpSysError=ntpSysError, gpsMode=gpsMode, gpsSatlist=gpsSatlist, ntpSysVersion=ntpSysVersion, products=products, etcUpgrade=etcUpgrade, symmTimePictra=symmTimePictra, gpsPosition=gpsPosition, symmTTM=symmTTM, ntpSysClock=ntpSysClock, ntpSysMode=ntpSysMode, etcVersion=etcVersion, experiment=experiment, dialup=dialup, version=version, ntpSysStratum=ntpSysStratum, etcModel=etcModel, ntpSysRootDelay=ntpSysRootDelay, ntpSysSystem=ntpSysSystem, etcAlarmString=etcAlarmString, ts2000=ts2000, tyming=tyming, tymingVersion=tymingVersion, symmCmipManagement=symmCmipManagement, etc=etc, etcSerialNbr=etcSerialNbr, tymingStatus=tymingStatus, etcUpgradeServer=etcUpgradeServer, net=net, ntpSysLeap=ntpSysLeap, gps=gps, ntpSysRefTime=ntpSysRefTime, PYSNMP_MODULE_ID=symmetricom, ntpSysFreq=ntpSysFreq, gpsHealth=gpsHealth, nts=nts, ntpSystem=ntpSystem, ts2100=ts2100, ntpSysPhase=ntpSysPhase, ntpSysProcessor=ntpSysProcessor, tymingFlyPeriod=tymingFlyPeriod, ntpSysPktsReceived=ntpSysPktsReceived)
