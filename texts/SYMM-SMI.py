...
Counter32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Gauge32, enterprises, NotificationType, Counter64, Unsigned32, IpAddress, NotificationType, ObjectIdentity, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Gauge32", "enterprises", "NotificationType", "Counter64", "Unsigned32", "IpAddress", "NotificationType", "ObjectIdentity", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", etcSerialNbr=etcSerialNbr, syncserver=syncserver, xli=xli, symmSnmpManagement=symmSnmpManagement, s100=s100, gpsPosition=gpsPosition, ntpSysClock=ntpSysClock, tymingVersion=tymingVersion, ntpSysVersion=ntpSysVersion, ts2100=ts2100, gps=gps, ntpSysRefTime=ntpSysRefTime, symmetricom=symmetricom, gpsUTCOffset=gpsUTCOffset, etcModel=etcModel, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, tyming=tyming, ntpSysMode=ntpSysMode, gpsSatlist=gpsSatlist, ntpSysProcessor=ntpSysProcessor, ntpSystem=ntpSystem, nts=nts, gpsHealth=gpsHealth, ntpSysPeer=ntpSysPeer, symmCmipManagement=symmCmipManagement, etcAlarm=etcAlarm, etc=etc, tymingTime=tymingTime, ts2000=ts2000, ntpSysPoll=ntpSysPoll, gpsMode=gpsMode, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, etcVersion=etcVersion, ntpSysNotrust=ntpSysNotrust, dialup=dialup, ntpSysSystem=ntpSysSystem, products=products, ntpSysRootDelay=ntpSysRootDelay, version=version, symmTimePictra=symmTimePictra, ntpSysPktsReceived=ntpSysPktsReceived, tymingSource=tymingSource, net=net, tymingFlyPeriod=tymingFlyPeriod, ntpSysPrecision=ntpSysPrecision, ntpSysRefID=ntpSysRefID, etcUpgradeServer=etcUpgradeServer, ntpSysFreq=ntpSysFreq, symmTTM=symmTTM, ntpSysRootDispersion=ntpSysRootDispersion, symmNetworkManagement=symmNetworkManagement, ntpSysLeap=ntpSysLeap, ntpSysStratum=ntpSysStratum, ntpSysPhase=ntpSysPhase, etcAlarmString=etcAlarmString, experiment=experiment, tymingStatus=tymingStatus)
