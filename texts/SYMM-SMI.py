...
mibBuilder.exportSymbols("SYMM-SMI", etcVersion=etcVersion, symmBroadband=symmBroadband, experiment=experiment, products=products, etcModel=etcModel, gpsHealth=gpsHealth, ntpSysStratum=ntpSysStratum, symmSnmpManagement=symmSnmpManagement, symmTimePictra=symmTimePictra, gpsPosition=gpsPosition, ntpSysError=ntpSysError, dialup=dialup, ntpSysRefTime=ntpSysRefTime, tymingSource=tymingSource, xli=xli, ntpSysFreq=ntpSysFreq, tyming=tyming, ntpSysMode=ntpSysMode, PYSNMP_MODULE_ID=symmetricom, ts2000=ts2000, ntpSysRefID=ntpSysRefID, ntpSysPktsReceived=ntpSysPktsReceived, symmCmipManagement=symmCmipManagement, etcSerialNbr=etcSerialNbr, symmetricom=symmetricom, gpsSatlist=gpsSatlist, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, gpsUTCOffset=gpsUTCOffset, tymingStatus=tymingStatus, syncserver=syncserver, symmNetworkManagement=symmNetworkManagement, gps=gps, symmTTM=symmTTM, version=version, ntpSysRootDelay=ntpSysRootDelay, ntpSysRootDispersion=ntpSysRootDispersion, nts=nts, ntpSysProcessor=ntpSysProcessor, net=net, etcAlarmString=etcAlarmString, ntpSysPoll=ntpSysPoll, ntpSysSystem=ntpSysSystem, tymingTime=tymingTime, ntpSysVersion=ntpSysVersion, etc=etc, ts2100=ts2100, ntpSysPhase=ntpSysPhase, etcUpgrade=etcUpgrade, ntpSysNotrust=ntpSysNotrust, ntpSysPeer=ntpSysPeer, gpsMode=gpsMode, tymingVersion=tymingVersion, etcUpgradeServer=etcUpgradeServer, ntpSysPrecision=ntpSysPrecision, s100=s100, ntpSystem=ntpSystem, ntpSysClock=ntpSysClock, etcAlarm=etcAlarm)
