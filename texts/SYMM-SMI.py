...
ObjectIdentity, NotificationType, iso, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, Unsigned32, Counter32, NotificationType, Bits, Counter64, Gauge32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "iso", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "Unsigned32", "Counter32", "NotificationType", "Bits", "Counter64", "Gauge32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, gpsUTCOffset=gpsUTCOffset, ntpSysMode=ntpSysMode, symmTimePictra=symmTimePictra, symmTTM=symmTTM, products=products, symmetricom=symmetricom, experiment=experiment, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, etcUpgrade=etcUpgrade, symmSnmpManagement=symmSnmpManagement, etcAlarmString=etcAlarmString, etc=etc, xli=xli, symmNetworkManagement=symmNetworkManagement, syncserver=syncserver, gpsSatlist=gpsSatlist, ntpSysVersion=ntpSysVersion, etcAlarm=etcAlarm, tymingFlyPeriod=tymingFlyPeriod, tymingSource=tymingSource, ts2100=ts2100, symmCmipManagement=symmCmipManagement, tymingVersion=tymingVersion, tymingStatus=tymingStatus, ntpSysNotrust=ntpSysNotrust, etcSerialNbr=etcSerialNbr, ts2000=ts2000, ntpSysPeer=ntpSysPeer, ntpSysFreq=ntpSysFreq, nts=nts, ntpSysSystem=ntpSysSystem, etcVersion=etcVersion, ntpSysStratum=ntpSysStratum, ntpSysClock=ntpSysClock, s100=s100, etcUpgradeServer=etcUpgradeServer, gpsMode=gpsMode, version=version, dialup=dialup, ntpSystem=ntpSystem, symmBroadband=symmBroadband, ntpSysPrecision=ntpSysPrecision, ntpSysError=ntpSysError, ntpSysRootDispersion=ntpSysRootDispersion, gps=gps, net=net, ntpSysPhase=ntpSysPhase, ntpSysLeap=ntpSysLeap, tyming=tyming, tymingTime=tymingTime, ntpSysRefID=ntpSysRefID, ntpSysRefTime=ntpSysRefTime, ntpSysPoll=ntpSysPoll, ntpSysProcessor=ntpSysProcessor, etcModel=etcModel, gpsPosition=gpsPosition, PYSNMP_MODULE_ID=symmetricom)
