...
Integer32, Gauge32, ModuleIdentity, ObjectIdentity, enterprises, TimeTicks, Counter64, Unsigned32, NotificationType, IpAddress, NotificationType, iso, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "ModuleIdentity", "ObjectIdentity", "enterprises", "TimeTicks", "Counter64", "Unsigned32", "NotificationType", "IpAddress", "NotificationType", "iso", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefID=ntpSysRefID, gpsHealth=gpsHealth, ntpSysFreq=ntpSysFreq, symmTimePictra=symmTimePictra, gpsUTCOffset=gpsUTCOffset, etcModel=etcModel, tymingVersion=tymingVersion, etcAlarmString=etcAlarmString, ntpSysProcessor=ntpSysProcessor, nts=nts, gpsMode=gpsMode, gps=gps, etc=etc, symmTTM=symmTTM, ntpSysError=ntpSysError, etcUpgradeServer=etcUpgradeServer, etcUpgrade=etcUpgrade, ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem, PYSNMP_MODULE_ID=symmetricom, version=version, ntpSysRefTime=ntpSysRefTime, etcVersion=etcVersion, ntpSysNotrust=ntpSysNotrust, ntpSysPeer=ntpSysPeer, ntpSysMode=ntpSysMode, tyming=tyming, ntpSysStratum=ntpSysStratum, ntpSysPhase=ntpSysPhase, symmCmipManagement=symmCmipManagement, gpsPosition=gpsPosition, symmBroadband=symmBroadband, symmNetworkManagement=symmNetworkManagement, experiment=experiment, ts2000=ts2000, syncserver=syncserver, dialup=dialup, symmSnmpManagement=symmSnmpManagement, ntpSysRootDelay=ntpSysRootDelay, etcAlarm=etcAlarm, ntpSysPoll=ntpSysPoll, ts2100=ts2100, tymingStatus=tymingStatus, ntpSysVersion=ntpSysVersion, xli=xli, net=net, ntpSysRootDispersion=ntpSysRootDispersion, tymingTime=tymingTime, tymingFlyPeriod=tymingFlyPeriod, gpsSatlist=gpsSatlist, ntpSysPktsReceived=ntpSysPktsReceived, etcSerialNbr=etcSerialNbr, tymingSource=tymingSource, s100=s100, ntpSysLeap=ntpSysLeap, ntpSysPrecision=ntpSysPrecision, symmetricom=symmetricom, ntpSystem=ntpSystem, products=products)
