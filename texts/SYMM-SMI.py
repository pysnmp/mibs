...
Counter32, Counter64, Gauge32, Bits, ModuleIdentity, MibIdentifier, IpAddress, TimeTicks, NotificationType, iso, NotificationType, Unsigned32, Integer32, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Gauge32", "Bits", "ModuleIdentity", "MibIdentifier", "IpAddress", "TimeTicks", "NotificationType", "iso", "NotificationType", "Unsigned32", "Integer32", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", syncserver=syncserver, etcUpgradeServer=etcUpgradeServer, ntpSysNotrust=ntpSysNotrust, ts2000=ts2000, ts2100=ts2100, ntpSysRefID=ntpSysRefID, tyming=tyming, ntpSysPoll=ntpSysPoll, gpsHealth=gpsHealth, xli=xli, ntpSysSystem=ntpSysSystem, etcUpgrade=etcUpgrade, s100=s100, ntpSysVersion=ntpSysVersion, experiment=experiment, symmetricom=symmetricom, tymingSource=tymingSource, net=net, gpsMode=gpsMode, gpsUTCOffset=gpsUTCOffset, ntpSysPrecision=ntpSysPrecision, gpsSatlist=gpsSatlist, ntpSysPhase=ntpSysPhase, symmTimePictra=symmTimePictra, ntpSysLeap=ntpSysLeap, ntpSysClock=ntpSysClock, symmCmipManagement=symmCmipManagement, gps=gps, ntpSysProcessor=ntpSysProcessor, PYSNMP_MODULE_ID=symmetricom, ntpSysMode=ntpSysMode, etcAlarm=etcAlarm, dialup=dialup, tymingTime=tymingTime, etcVersion=etcVersion, ntpSysStratum=ntpSysStratum, etc=etc, ntpSysError=ntpSysError, ntpSysRootDelay=ntpSysRootDelay, symmBroadband=symmBroadband, ntpSystem=ntpSystem, symmTTM=symmTTM, gpsPosition=gpsPosition, nts=nts, products=products, etcSerialNbr=etcSerialNbr, symmNetworkManagement=symmNetworkManagement, etcAlarmString=etcAlarmString, ntpSysRootDispersion=ntpSysRootDispersion, tymingFlyPeriod=tymingFlyPeriod, symmSnmpManagement=symmSnmpManagement, version=version, ntpSysPeer=ntpSysPeer, tymingStatus=tymingStatus, ntpSysRefTime=ntpSysRefTime, ntpSysPktsReceived=ntpSysPktsReceived, etcModel=etcModel, ntpSysFreq=ntpSysFreq, tymingVersion=tymingVersion)
