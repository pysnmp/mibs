...
Counter64, NotificationType, ModuleIdentity, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Unsigned32, Integer32, Counter32, Bits, IpAddress, MibIdentifier, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "ModuleIdentity", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Unsigned32", "Integer32", "Counter32", "Bits", "IpAddress", "MibIdentifier", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", version=version, etcAlarmString=etcAlarmString, tymingSource=tymingSource, s100=s100, ntpSysRefID=ntpSysRefID, PYSNMP_MODULE_ID=symmetricom, gpsSatlist=gpsSatlist, ntpSysPoll=ntpSysPoll, etc=etc, ntpSysSystem=ntpSysSystem, ntpSysMode=ntpSysMode, gpsPosition=gpsPosition, etcSerialNbr=etcSerialNbr, gpsUTCOffset=gpsUTCOffset, etcAlarm=etcAlarm, symmTTM=symmTTM, gpsHealth=gpsHealth, etcModel=etcModel, etcUpgradeServer=etcUpgradeServer, ntpSystem=ntpSystem, symmetricom=symmetricom, ntpSysVersion=ntpSysVersion, tyming=tyming, tymingVersion=tymingVersion, gps=gps, symmSnmpManagement=symmSnmpManagement, xli=xli, dialup=dialup, ntpSysPrecision=ntpSysPrecision, ntpSysPhase=ntpSysPhase, gpsMode=gpsMode, etcUpgrade=etcUpgrade, experiment=experiment, symmTimePictra=symmTimePictra, ts2000=ts2000, products=products, tymingStatus=tymingStatus, symmNetworkManagement=symmNetworkManagement, ntpSysFreq=ntpSysFreq, etcVersion=etcVersion, ts2100=ts2100, ntpSysRootDelay=ntpSysRootDelay, ntpSysProcessor=ntpSysProcessor, ntpSysError=ntpSysError, ntpSysLeap=ntpSysLeap, ntpSysRootDispersion=ntpSysRootDispersion, symmCmipManagement=symmCmipManagement, ntpSysPktsReceived=ntpSysPktsReceived, tymingFlyPeriod=tymingFlyPeriod, ntpSysClock=ntpSysClock, nts=nts, symmBroadband=symmBroadband, tymingTime=tymingTime, net=net, ntpSysPeer=ntpSysPeer, ntpSysRefTime=ntpSysRefTime, syncserver=syncserver, ntpSysStratum=ntpSysStratum, ntpSysNotrust=ntpSysNotrust)
