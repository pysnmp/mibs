...
Counter64, NotificationType, ObjectIdentity, NotificationType, ModuleIdentity, MibIdentifier, iso, TimeTicks, Integer32, enterprises, Counter32, Unsigned32, IpAddress, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "ObjectIdentity", "NotificationType", "ModuleIdentity", "MibIdentifier", "iso", "TimeTicks", "Integer32", "enterprises", "Counter32", "Unsigned32", "IpAddress", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", syncserver=syncserver, etcAlarm=etcAlarm, gpsHealth=gpsHealth, symmetricom=symmetricom, tymingStatus=tymingStatus, ts2000=ts2000, version=version, ntpSysPrecision=ntpSysPrecision, symmTimePictra=symmTimePictra, tymingFlyPeriod=tymingFlyPeriod, gpsMode=gpsMode, etcUpgrade=etcUpgrade, tymingSource=tymingSource, etcVersion=etcVersion, ntpSysRootDelay=ntpSysRootDelay, PYSNMP_MODULE_ID=symmetricom, dialup=dialup, symmSnmpManagement=symmSnmpManagement, ntpSysPeer=ntpSysPeer, s100=s100, ntpSysMode=ntpSysMode, products=products, tymingVersion=tymingVersion, ntpSysPoll=ntpSysPoll, etcUpgradeServer=etcUpgradeServer, ntpSysClock=ntpSysClock, ntpSysPhase=ntpSysPhase, ntpSysNotrust=ntpSysNotrust, symmCmipManagement=symmCmipManagement, etc=etc, ntpSysProcessor=ntpSysProcessor, gpsUTCOffset=gpsUTCOffset, experiment=experiment, etcSerialNbr=etcSerialNbr, etcModel=etcModel, tyming=tyming, ntpSysRootDispersion=ntpSysRootDispersion, symmNetworkManagement=symmNetworkManagement, gps=gps, ntpSysRefTime=ntpSysRefTime, ntpSysRefID=ntpSysRefID, ntpSysError=ntpSysError, ts2100=ts2100, ntpSysLeap=ntpSysLeap, tymingTime=tymingTime, ntpSysSystem=ntpSysSystem, ntpSysStratum=ntpSysStratum, gpsPosition=gpsPosition, symmBroadband=symmBroadband, ntpSysPktsReceived=ntpSysPktsReceived, xli=xli, gpsSatlist=gpsSatlist, ntpSysVersion=ntpSysVersion, etcAlarmString=etcAlarmString, symmTTM=symmTTM, nts=nts, net=net, ntpSysFreq=ntpSysFreq, ntpSystem=ntpSystem)
