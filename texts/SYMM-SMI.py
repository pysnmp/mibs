...
TimeTicks, ModuleIdentity, Counter64, MibIdentifier, Unsigned32, IpAddress, Bits, Counter32, iso, NotificationType, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Counter64", "MibIdentifier", "Unsigned32", "IpAddress", "Bits", "Counter32", "iso", "NotificationType", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", symmTTM=symmTTM, net=net, ntpSysError=ntpSysError, etcVersion=etcVersion, ntpSysRefID=ntpSysRefID, ntpSysPoll=ntpSysPoll, symmTimePictra=symmTimePictra, tymingStatus=tymingStatus, gpsPosition=gpsPosition, version=version, products=products, tymingFlyPeriod=tymingFlyPeriod, etcUpgradeServer=etcUpgradeServer, ntpSysRefTime=ntpSysRefTime, etc=etc, ntpSysRootDelay=ntpSysRootDelay, ntpSysPeer=ntpSysPeer, tyming=tyming, ntpSysFreq=ntpSysFreq, symmetricom=symmetricom, ntpSysPhase=ntpSysPhase, symmSnmpManagement=symmSnmpManagement, s100=s100, ntpSysNotrust=ntpSysNotrust, etcAlarm=etcAlarm, gpsMode=gpsMode, gps=gps, gpsHealth=gpsHealth, ntpSysVersion=ntpSysVersion, ntpSysPrecision=ntpSysPrecision, etcModel=etcModel, ntpSystem=ntpSystem, gpsSatlist=gpsSatlist, tymingVersion=tymingVersion, ntpSysSystem=ntpSysSystem, ts2000=ts2000, ntpSysRootDispersion=ntpSysRootDispersion, tymingSource=tymingSource, ntpSysLeap=ntpSysLeap, etcUpgrade=etcUpgrade, ntpSysProcessor=ntpSysProcessor, experiment=experiment, symmCmipManagement=symmCmipManagement, gpsUTCOffset=gpsUTCOffset, xli=xli, ntpSysPktsReceived=ntpSysPktsReceived, etcSerialNbr=etcSerialNbr, ntpSysStratum=ntpSysStratum, nts=nts, ntpSysClock=ntpSysClock, ntpSysMode=ntpSysMode, PYSNMP_MODULE_ID=symmetricom, symmNetworkManagement=symmNetworkManagement, etcAlarmString=etcAlarmString, tymingTime=tymingTime, ts2100=ts2100, dialup=dialup, syncserver=syncserver, symmBroadband=symmBroadband)
