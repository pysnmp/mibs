...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, ObjectIdentity, IpAddress, NotificationType, Unsigned32, enterprises, ModuleIdentity, MibIdentifier, Gauge32, Counter32, iso, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "ObjectIdentity", "IpAddress", "NotificationType", "Unsigned32", "enterprises", "ModuleIdentity", "MibIdentifier", "Gauge32", "Counter32", "iso", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysError=ntpSysError, etcSerialNbr=etcSerialNbr, ntpSysRefID=ntpSysRefID, version=version, ntpSysMode=ntpSysMode, ntpSysSystem=ntpSysSystem, ntpSysRootDelay=ntpSysRootDelay, ntpSysProcessor=ntpSysProcessor, ntpSysFreq=ntpSysFreq, symmSnmpManagement=symmSnmpManagement, gps=gps, syncserver=syncserver, etcVersion=etcVersion, xli=xli, products=products, gpsPosition=gpsPosition, experiment=experiment, ntpSysLeap=ntpSysLeap, gpsSatlist=gpsSatlist, ntpSysPoll=ntpSysPoll, tymingFlyPeriod=tymingFlyPeriod, ts2000=ts2000, gpsHealth=gpsHealth, ntpSysClock=ntpSysClock, dialup=dialup, net=net, symmNetworkManagement=symmNetworkManagement, symmTimePictra=symmTimePictra, ntpSystem=ntpSystem, ntpSysPktsReceived=ntpSysPktsReceived, symmBroadband=symmBroadband, ntpSysPeer=ntpSysPeer, etcUpgrade=etcUpgrade, s100=s100, nts=nts, PYSNMP_MODULE_ID=symmetricom, tymingTime=tymingTime, symmCmipManagement=symmCmipManagement, symmetricom=symmetricom, ts2100=ts2100, gpsUTCOffset=gpsUTCOffset, symmTTM=symmTTM, tyming=tyming, tymingSource=tymingSource, etcModel=etcModel, ntpSysPrecision=ntpSysPrecision, etcUpgradeServer=etcUpgradeServer, ntpSysStratum=ntpSysStratum, gpsMode=gpsMode, etcAlarm=etcAlarm, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPhase=ntpSysPhase, tymingVersion=tymingVersion, etcAlarmString=etcAlarmString, tymingStatus=tymingStatus, ntpSysRefTime=ntpSysRefTime, etc=etc, ntpSysVersion=ntpSysVersion, ntpSysNotrust=ntpSysNotrust)
