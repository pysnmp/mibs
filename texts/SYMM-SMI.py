...
NotificationType, iso, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, Counter32, Unsigned32, Bits, ModuleIdentity, ObjectIdentity, Gauge32, enterprises, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "Counter32", "Unsigned32", "Bits", "ModuleIdentity", "ObjectIdentity", "Gauge32", "enterprises", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysError=ntpSysError, ntpSysRootDelay=ntpSysRootDelay, etcModel=etcModel, ntpSysSystem=ntpSysSystem, net=net, ntpSysLeap=ntpSysLeap, symmCmipManagement=symmCmipManagement, etc=etc, tymingVersion=tymingVersion, ntpSysFreq=ntpSysFreq, gps=gps, ts2000=ts2000, symmNetworkManagement=symmNetworkManagement, tyming=tyming, ntpSysRefID=ntpSysRefID, ntpSysPhase=ntpSysPhase, symmetricom=symmetricom, nts=nts, dialup=dialup, ntpSysPeer=ntpSysPeer, ntpSysPrecision=ntpSysPrecision, ntpSysClock=ntpSysClock, gpsSatlist=gpsSatlist, symmTTM=symmTTM, etcVersion=etcVersion, syncserver=syncserver, etcSerialNbr=etcSerialNbr, etcUpgrade=etcUpgrade, etcAlarm=etcAlarm, ntpSysVersion=ntpSysVersion, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPktsReceived=ntpSysPktsReceived, products=products, ntpSysNotrust=ntpSysNotrust, gpsPosition=gpsPosition, symmSnmpManagement=symmSnmpManagement, ntpSysMode=ntpSysMode, experiment=experiment, symmTimePictra=symmTimePictra, etcUpgradeServer=etcUpgradeServer, ntpSysStratum=ntpSysStratum, xli=xli, version=version, tymingTime=tymingTime, ntpSystem=ntpSystem, ntpSysPoll=ntpSysPoll, ntpSysRefTime=ntpSysRefTime, gpsUTCOffset=gpsUTCOffset, tymingSource=tymingSource, PYSNMP_MODULE_ID=symmetricom, ts2100=ts2100, symmBroadband=symmBroadband, ntpSysProcessor=ntpSysProcessor, gpsHealth=gpsHealth, tymingFlyPeriod=tymingFlyPeriod, gpsMode=gpsMode, s100=s100, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString)
