...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, Integer32, iso, MibIdentifier, Counter64, NotificationType, Counter32, Gauge32, Bits, IpAddress, ModuleIdentity, Unsigned32, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "Integer32", "iso", "MibIdentifier", "Counter64", "NotificationType", "Counter32", "Gauge32", "Bits", "IpAddress", "ModuleIdentity", "Unsigned32", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysNotrust=ntpSysNotrust, symmTTM=symmTTM, ntpSysPktsReceived=ntpSysPktsReceived, symmTimePictra=symmTimePictra, tymingVersion=tymingVersion, symmetricom=symmetricom, ntpSysPoll=ntpSysPoll, gpsPosition=gpsPosition, net=net, xli=xli, ntpSystem=ntpSystem, ntpSysRefTime=ntpSysRefTime, ntpSysRefID=ntpSysRefID, etcUpgradeServer=etcUpgradeServer, ntpSysPrecision=ntpSysPrecision, ntpSysStratum=ntpSysStratum, ntpSysMode=ntpSysMode, tymingSource=tymingSource, experiment=experiment, gpsMode=gpsMode, ts2100=ts2100, etc=etc, etcUpgrade=etcUpgrade, ntpSysVersion=ntpSysVersion, gpsUTCOffset=gpsUTCOffset, etcVersion=etcVersion, tymingStatus=tymingStatus, symmBroadband=symmBroadband, ntpSysSystem=ntpSysSystem, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDispersion=ntpSysRootDispersion, etcAlarm=etcAlarm, etcAlarmString=etcAlarmString, ntpSysLeap=ntpSysLeap, ntpSysClock=ntpSysClock, tyming=tyming, ntpSysPeer=ntpSysPeer, s100=s100, syncserver=syncserver, version=version, ntpSysPhase=ntpSysPhase, gps=gps, ntpSysFreq=ntpSysFreq, etcModel=etcModel, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, dialup=dialup, tymingFlyPeriod=tymingFlyPeriod, symmCmipManagement=symmCmipManagement, ntpSysProcessor=ntpSysProcessor, nts=nts, symmSnmpManagement=symmSnmpManagement, ntpSysError=ntpSysError, gpsSatlist=gpsSatlist, tymingTime=tymingTime, symmNetworkManagement=symmNetworkManagement, etcSerialNbr=etcSerialNbr, ts2000=ts2000, products=products)
