...
iso, Counter32, Counter64, enterprises, Gauge32, Unsigned32, Integer32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, Bits, ModuleIdentity, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "Counter64", "enterprises", "Gauge32", "Unsigned32", "Integer32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "Bits", "ModuleIdentity", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", xli=xli, ntpSysStratum=ntpSysStratum, etcUpgrade=etcUpgrade, tymingTime=tymingTime, ntpSysRefTime=ntpSysRefTime, etcAlarm=etcAlarm, PYSNMP_MODULE_ID=symmetricom, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, etc=etc, s100=s100, symmNetworkManagement=symmNetworkManagement, ntpSysProcessor=ntpSysProcessor, ntpSysVersion=ntpSysVersion, ntpSysClock=ntpSysClock, etcModel=etcModel, ntpSysLeap=ntpSysLeap, gpsUTCOffset=gpsUTCOffset, ntpSysRootDelay=ntpSysRootDelay, ntpSysSystem=ntpSysSystem, ntpSystem=ntpSystem, symmTimePictra=symmTimePictra, nts=nts, ntpSysPrecision=ntpSysPrecision, symmBroadband=symmBroadband, dialup=dialup, symmSnmpManagement=symmSnmpManagement, symmetricom=symmetricom, symmTTM=symmTTM, tyming=tyming, version=version, ntpSysMode=ntpSysMode, gpsSatlist=gpsSatlist, ntpSysPhase=ntpSysPhase, net=net, etcSerialNbr=etcSerialNbr, symmCmipManagement=symmCmipManagement, ntpSysRefID=ntpSysRefID, etcAlarmString=etcAlarmString, syncserver=syncserver, ntpSysNotrust=ntpSysNotrust, ntpSysFreq=ntpSysFreq, tymingFlyPeriod=tymingFlyPeriod, ntpSysPktsReceived=ntpSysPktsReceived, gpsMode=gpsMode, products=products, tymingStatus=tymingStatus, ts2000=ts2000, ntpSysRootDispersion=ntpSysRootDispersion, etcVersion=etcVersion, experiment=experiment, tymingVersion=tymingVersion, ntpSysPeer=ntpSysPeer, ntpSysError=ntpSysError, gpsHealth=gpsHealth, gpsPosition=gpsPosition, ts2100=ts2100, etcUpgradeServer=etcUpgradeServer, gps=gps)
