...
Counter64, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, Counter32, Unsigned32, Bits, enterprises, NotificationType, MibIdentifier, ObjectIdentity, ModuleIdentity, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "Counter32", "Unsigned32", "Bits", "enterprises", "NotificationType", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "Gauge32", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, ntpSysClock=ntpSysClock, etcVersion=etcVersion, ntpSysPhase=ntpSysPhase, etcAlarm=etcAlarm, symmTimePictra=symmTimePictra, ntpSysPeer=ntpSysPeer, etcUpgradeServer=etcUpgradeServer, ntpSystem=ntpSystem, ntpSysStratum=ntpSysStratum, syncserver=syncserver, tymingTime=tymingTime, ntpSysError=ntpSysError, etcModel=etcModel, gpsHealth=gpsHealth, ntpSysPrecision=ntpSysPrecision, PYSNMP_MODULE_ID=symmetricom, gpsSatlist=gpsSatlist, symmTTM=symmTTM, dialup=dialup, ts2100=ts2100, ts2000=ts2000, symmSnmpManagement=symmSnmpManagement, tyming=tyming, ntpSysProcessor=ntpSysProcessor, gpsMode=gpsMode, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRootDelay=ntpSysRootDelay, ntpSysFreq=ntpSysFreq, symmNetworkManagement=symmNetworkManagement, tymingStatus=tymingStatus, symmBroadband=symmBroadband, etcAlarmString=etcAlarmString, s100=s100, version=version, ntpSysMode=ntpSysMode, gpsUTCOffset=gpsUTCOffset, products=products, gps=gps, ntpSysSystem=ntpSysSystem, net=net, tymingVersion=tymingVersion, etcSerialNbr=etcSerialNbr, etc=etc, ntpSysRefID=ntpSysRefID, symmCmipManagement=symmCmipManagement, xli=xli, ntpSysPoll=ntpSysPoll, tymingFlyPeriod=tymingFlyPeriod, gpsPosition=gpsPosition, etcUpgrade=etcUpgrade, ntpSysNotrust=ntpSysNotrust, experiment=experiment, ntpSysLeap=ntpSysLeap, symmetricom=symmetricom, nts=nts, ntpSysRefTime=ntpSysRefTime, ntpSysVersion=ntpSysVersion, tymingSource=tymingSource)
