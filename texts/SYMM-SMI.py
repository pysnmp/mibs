...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, IpAddress, ModuleIdentity, TimeTicks, NotificationType, Integer32, Counter64, MibIdentifier, ObjectIdentity, NotificationType, Counter32, enterprises, Unsigned32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "IpAddress", "ModuleIdentity", "TimeTicks", "NotificationType", "Integer32", "Counter64", "MibIdentifier", "ObjectIdentity", "NotificationType", "Counter32", "enterprises", "Unsigned32", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPoll=ntpSysPoll, s100=s100, ntpSysNotrust=ntpSysNotrust, etcAlarmString=etcAlarmString, symmBroadband=symmBroadband, ntpSysPktsReceived=ntpSysPktsReceived, experiment=experiment, tymingFlyPeriod=tymingFlyPeriod, gpsUTCOffset=gpsUTCOffset, etcUpgrade=etcUpgrade, tymingTime=tymingTime, gps=gps, ntpSysPrecision=ntpSysPrecision, net=net, tyming=tyming, tymingSource=tymingSource, gpsHealth=gpsHealth, products=products, ntpSysStratum=ntpSysStratum, ntpSysPhase=ntpSysPhase, etcModel=etcModel, etcVersion=etcVersion, gpsPosition=gpsPosition, PYSNMP_MODULE_ID=symmetricom, ts2100=ts2100, ntpSysRefTime=ntpSysRefTime, ntpSysVersion=ntpSysVersion, etc=etc, tymingStatus=tymingStatus, ntpSysProcessor=ntpSysProcessor, ntpSysFreq=ntpSysFreq, symmTTM=symmTTM, xli=xli, symmTimePictra=symmTimePictra, ntpSysRootDelay=ntpSysRootDelay, ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, etcUpgradeServer=etcUpgradeServer, ntpSysRefID=ntpSysRefID, syncserver=syncserver, ntpSystem=ntpSystem, etcAlarm=etcAlarm, symmSnmpManagement=symmSnmpManagement, ntpSysLeap=ntpSysLeap, tymingVersion=tymingVersion, ts2000=ts2000, dialup=dialup, ntpSysPeer=ntpSysPeer, ntpSysMode=ntpSysMode, version=version, gpsMode=gpsMode, symmetricom=symmetricom, etcSerialNbr=etcSerialNbr, nts=nts, symmNetworkManagement=symmNetworkManagement, ntpSysRootDispersion=ntpSysRootDispersion, gpsSatlist=gpsSatlist, ntpSysClock=ntpSysClock, symmCmipManagement=symmCmipManagement)
