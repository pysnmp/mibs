...
mibBuilder.exportSymbols("SYMM-SMI", nts=nts, ntpSysRefTime=ntpSysRefTime, ntpSysPeer=ntpSysPeer, ntpSysNotrust=ntpSysNotrust, tymingTime=tymingTime, ntpSysError=ntpSysError, symmCmipManagement=symmCmipManagement, ts2000=ts2000, ntpSysPktsReceived=ntpSysPktsReceived, symmTimePictra=symmTimePictra, etcModel=etcModel, products=products, ntpSysPhase=ntpSysPhase, ntpSysRootDelay=ntpSysRootDelay, s100=s100, gpsSatlist=gpsSatlist, xli=xli, version=version, ntpSysRootDispersion=ntpSysRootDispersion, gpsUTCOffset=gpsUTCOffset, etcVersion=etcVersion, symmBroadband=symmBroadband, ts2100=ts2100, net=net, ntpSysClock=ntpSysClock, tymingSource=tymingSource, tymingFlyPeriod=tymingFlyPeriod, etcSerialNbr=etcSerialNbr, dialup=dialup, ntpSysStratum=ntpSysStratum, etcUpgrade=etcUpgrade, ntpSystem=ntpSystem, ntpSysVersion=ntpSysVersion, ntpSysLeap=ntpSysLeap, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, ntpSysPrecision=ntpSysPrecision, ntpSysPoll=ntpSysPoll, PYSNMP_MODULE_ID=symmetricom, experiment=experiment, ntpSysFreq=ntpSysFreq, gpsMode=gpsMode, tymingVersion=tymingVersion, etcUpgradeServer=etcUpgradeServer, etc=etc, symmetricom=symmetricom, gpsHealth=gpsHealth, ntpSysSystem=ntpSysSystem, ntpSysMode=ntpSysMode, symmSnmpManagement=symmSnmpManagement, gpsPosition=gpsPosition, symmTTM=symmTTM, syncserver=syncserver, tyming=tyming, ntpSysProcessor=ntpSysProcessor, ntpSysRefID=ntpSysRefID, gps=gps, etcAlarm=etcAlarm, symmNetworkManagement=symmNetworkManagement)
