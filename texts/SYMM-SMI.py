...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, Bits, Integer32, enterprises, IpAddress, MibIdentifier, ModuleIdentity, Counter64, iso, ObjectIdentity, NotificationType, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "Bits", "Integer32", "enterprises", "IpAddress", "MibIdentifier", "ModuleIdentity", "Counter64", "iso", "ObjectIdentity", "NotificationType", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPoll=ntpSysPoll, ts2100=ts2100, products=products, nts=nts, ntpSysStratum=ntpSysStratum, gpsMode=gpsMode, s100=s100, ntpSysRootDispersion=ntpSysRootDispersion, symmetricom=symmetricom, experiment=experiment, ntpSysSystem=ntpSysSystem, gpsUTCOffset=gpsUTCOffset, tymingVersion=tymingVersion, ntpSystem=ntpSystem, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, ntpSysClock=ntpSysClock, ts2000=ts2000, tymingStatus=tymingStatus, ntpSysFreq=ntpSysFreq, etc=etc, ntpSysMode=ntpSysMode, etcSerialNbr=etcSerialNbr, ntpSysRefID=ntpSysRefID, ntpSysPhase=ntpSysPhase, symmBroadband=symmBroadband, etcUpgradeServer=etcUpgradeServer, ntpSysLeap=ntpSysLeap, symmCmipManagement=symmCmipManagement, syncserver=syncserver, ntpSysPeer=ntpSysPeer, tymingFlyPeriod=tymingFlyPeriod, tyming=tyming, version=version, gpsPosition=gpsPosition, etcModel=etcModel, ntpSysPrecision=ntpSysPrecision, ntpSysNotrust=ntpSysNotrust, symmTTM=symmTTM, net=net, etcAlarm=etcAlarm, symmTimePictra=symmTimePictra, ntpSysProcessor=ntpSysProcessor, PYSNMP_MODULE_ID=symmetricom, gps=gps, ntpSysPktsReceived=ntpSysPktsReceived, etcVersion=etcVersion, ntpSysVersion=ntpSysVersion, symmSnmpManagement=symmSnmpManagement, symmNetworkManagement=symmNetworkManagement, xli=xli, tymingTime=tymingTime, tymingSource=tymingSource, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, etcAlarmString=etcAlarmString, gpsSatlist=gpsSatlist, ntpSysRefTime=ntpSysRefTime, dialup=dialup)
