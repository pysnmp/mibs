...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Counter32, Integer32, NotificationType, iso, ObjectIdentity, MibIdentifier, TimeTicks, Counter64, ModuleIdentity, Gauge32, NotificationType, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Counter32", "Integer32", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Counter64", "ModuleIdentity", "Gauge32", "NotificationType", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", symmBroadband=symmBroadband, dialup=dialup, ts2100=ts2100, version=version, tymingVersion=tymingVersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysPrecision=ntpSysPrecision, etcUpgradeServer=etcUpgradeServer, etc=etc, symmCmipManagement=symmCmipManagement, ntpSysStratum=ntpSysStratum, xli=xli, ntpSysClock=ntpSysClock, nts=nts, ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, etcUpgrade=etcUpgrade, etcVersion=etcVersion, gpsSatlist=gpsSatlist, gpsMode=gpsMode, tymingTime=tymingTime, ntpSysProcessor=ntpSysProcessor, symmetricom=symmetricom, symmTimePictra=symmTimePictra, tyming=tyming, ntpSysRootDelay=ntpSysRootDelay, gps=gps, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysVersion=ntpSysVersion, gpsPosition=gpsPosition, gpsHealth=gpsHealth, ntpSysPoll=ntpSysPoll, syncserver=syncserver, symmSnmpManagement=symmSnmpManagement, ntpSysFreq=ntpSysFreq, ntpSysPktsReceived=ntpSysPktsReceived, etcModel=etcModel, ntpSysRefTime=ntpSysRefTime, etcAlarmString=etcAlarmString, products=products, ntpSysPeer=ntpSysPeer, ntpSysRefID=ntpSysRefID, ntpSysMode=ntpSysMode, symmTTM=symmTTM, s100=s100, gpsUTCOffset=gpsUTCOffset, etcSerialNbr=etcSerialNbr, tymingStatus=tymingStatus, ntpSystem=ntpSystem, ntpSysNotrust=ntpSysNotrust, PYSNMP_MODULE_ID=symmetricom, etcAlarm=etcAlarm, ntpSysPhase=ntpSysPhase, ts2000=ts2000, symmNetworkManagement=symmNetworkManagement, experiment=experiment, ntpSysLeap=ntpSysLeap, tymingSource=tymingSource, net=net)
