...
iso, NotificationType, Bits, enterprises, IpAddress, ObjectIdentity, MibIdentifier, Counter64, Integer32, Counter32, Gauge32, TimeTicks, Unsigned32, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Bits", "enterprises", "IpAddress", "ObjectIdentity", "MibIdentifier", "Counter64", "Integer32", "Counter32", "Gauge32", "TimeTicks", "Unsigned32", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", syncserver=syncserver, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysProcessor=ntpSysProcessor, gps=gps, ntpSysStratum=ntpSysStratum, etcUpgrade=etcUpgrade, experiment=experiment, s100=s100, ntpSystem=ntpSystem, ntpSysRefID=ntpSysRefID, ntpSysError=ntpSysError, gpsHealth=gpsHealth, ntpSysRootDelay=ntpSysRootDelay, PYSNMP_MODULE_ID=symmetricom, nts=nts, net=net, symmNetworkManagement=symmNetworkManagement, symmTTM=symmTTM, tymingSource=tymingSource, xli=xli, ntpSysNotrust=ntpSysNotrust, ts2000=ts2000, etcSerialNbr=etcSerialNbr, etcModel=etcModel, ntpSysSystem=ntpSysSystem, tymingVersion=tymingVersion, ntpSysLeap=ntpSysLeap, tymingTime=tymingTime, ntpSysFreq=ntpSysFreq, symmBroadband=symmBroadband, tymingFlyPeriod=tymingFlyPeriod, gpsSatlist=gpsSatlist, dialup=dialup, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysMode=ntpSysMode, gpsUTCOffset=gpsUTCOffset, etcAlarm=etcAlarm, ntpSysPhase=ntpSysPhase, ntpSysVersion=ntpSysVersion, ts2100=ts2100, ntpSysPrecision=ntpSysPrecision, ntpSysPeer=ntpSysPeer, symmTimePictra=symmTimePictra, symmCmipManagement=symmCmipManagement, products=products, gpsMode=gpsMode, etcAlarmString=etcAlarmString, symmSnmpManagement=symmSnmpManagement, etc=etc, tymingStatus=tymingStatus, ntpSysPoll=ntpSysPoll, gpsPosition=gpsPosition, etcUpgradeServer=etcUpgradeServer, version=version, etcVersion=etcVersion, symmetricom=symmetricom, tyming=tyming, ntpSysClock=ntpSysClock, ntpSysRefTime=ntpSysRefTime)
