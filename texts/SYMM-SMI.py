...
MibIdentifier, Counter64, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Gauge32, enterprises, NotificationType, Bits, iso, ModuleIdentity, Integer32, Unsigned32, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Gauge32", "enterprises", "NotificationType", "Bits", "iso", "ModuleIdentity", "Integer32", "Unsigned32", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", nts=nts, ntpSysError=ntpSysError, tymingStatus=tymingStatus, etcUpgradeServer=etcUpgradeServer, tymingVersion=tymingVersion, etcSerialNbr=etcSerialNbr, ntpSysStratum=ntpSysStratum, ntpSysPoll=ntpSysPoll, ntpSysRootDispersion=ntpSysRootDispersion, etcAlarmString=etcAlarmString, net=net, symmetricom=symmetricom, ntpSysSystem=ntpSysSystem, etcVersion=etcVersion, ntpSysClock=ntpSysClock, ts2100=ts2100, symmTTM=symmTTM, ts2000=ts2000, etcModel=etcModel, experiment=experiment, ntpSystem=ntpSystem, symmBroadband=symmBroadband, ntpSysFreq=ntpSysFreq, tymingTime=tymingTime, gpsSatlist=gpsSatlist, symmNetworkManagement=symmNetworkManagement, dialup=dialup, s100=s100, etcAlarm=etcAlarm, gpsMode=gpsMode, etcUpgrade=etcUpgrade, ntpSysRefID=ntpSysRefID, ntpSysProcessor=ntpSysProcessor, syncserver=syncserver, ntpSysPeer=ntpSysPeer, etc=etc, PYSNMP_MODULE_ID=symmetricom, gps=gps, ntpSysPhase=ntpSysPhase, gpsUTCOffset=gpsUTCOffset, xli=xli, ntpSysRefTime=ntpSysRefTime, ntpSysLeap=ntpSysLeap, tymingSource=tymingSource, gpsPosition=gpsPosition, ntpSysPrecision=ntpSysPrecision, symmTimePictra=symmTimePictra, ntpSysPktsReceived=ntpSysPktsReceived, tymingFlyPeriod=tymingFlyPeriod, products=products, tyming=tyming, version=version, ntpSysMode=ntpSysMode, symmSnmpManagement=symmSnmpManagement, gpsHealth=gpsHealth, ntpSysVersion=ntpSysVersion, ntpSysNotrust=ntpSysNotrust, symmCmipManagement=symmCmipManagement, ntpSysRootDelay=ntpSysRootDelay)
