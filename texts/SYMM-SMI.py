...
ObjectIdentity, Bits, enterprises, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Unsigned32, NotificationType, iso, NotificationType, TimeTicks, Gauge32, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "enterprises", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Unsigned32", "NotificationType", "iso", "NotificationType", "TimeTicks", "Gauge32", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysStratum=ntpSysStratum, etcAlarm=etcAlarm, ts2100=ts2100, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysPeer=ntpSysPeer, ntpSysRootDispersion=ntpSysRootDispersion, s100=s100, ntpSysFreq=ntpSysFreq, gpsPosition=gpsPosition, net=net, gpsMode=gpsMode, symmBroadband=symmBroadband, tymingTime=tymingTime, ntpSysPhase=ntpSysPhase, gpsUTCOffset=gpsUTCOffset, tymingStatus=tymingStatus, etc=etc, etcVersion=etcVersion, products=products, ntpSysPrecision=ntpSysPrecision, ntpSysRefTime=ntpSysRefTime, ntpSysNotrust=ntpSysNotrust, ntpSystem=ntpSystem, ntpSysSystem=ntpSysSystem, ntpSysProcessor=ntpSysProcessor, tyming=tyming, etcModel=etcModel, ntpSysPoll=ntpSysPoll, etcUpgrade=etcUpgrade, ntpSysVersion=ntpSysVersion, symmCmipManagement=symmCmipManagement, symmetricom=symmetricom, symmNetworkManagement=symmNetworkManagement, ntpSysError=ntpSysError, version=version, gps=gps, syncserver=syncserver, PYSNMP_MODULE_ID=symmetricom, xli=xli, experiment=experiment, dialup=dialup, etcAlarmString=etcAlarmString, tymingFlyPeriod=tymingFlyPeriod, gpsHealth=gpsHealth, ts2000=ts2000, ntpSysRootDelay=ntpSysRootDelay, ntpSysClock=ntpSysClock, ntpSysMode=ntpSysMode, etcSerialNbr=etcSerialNbr, ntpSysRefID=ntpSysRefID, etcUpgradeServer=etcUpgradeServer, tymingSource=tymingSource, ntpSysLeap=ntpSysLeap, nts=nts, symmSnmpManagement=symmSnmpManagement, tymingVersion=tymingVersion, symmTimePictra=symmTimePictra, gpsSatlist=gpsSatlist, symmTTM=symmTTM)
