...
NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, ModuleIdentity, NotificationType, Counter32, ObjectIdentity, TimeTicks, MibIdentifier, Unsigned32, Bits, IpAddress, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "ModuleIdentity", "NotificationType", "Counter32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Unsigned32", "Bits", "IpAddress", "Gauge32", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSystem=ntpSystem, products=products, etcSerialNbr=etcSerialNbr, symmTimePictra=symmTimePictra, ts2000=ts2000, syncserver=syncserver, tymingVersion=tymingVersion, gpsMode=gpsMode, dialup=dialup, gpsSatlist=gpsSatlist, tymingTime=tymingTime, symmNetworkManagement=symmNetworkManagement, tyming=tyming, ntpSysPoll=ntpSysPoll, gpsHealth=gpsHealth, ntpSysNotrust=ntpSysNotrust, etcUpgradeServer=etcUpgradeServer, ntpSysMode=ntpSysMode, net=net, nts=nts, symmBroadband=symmBroadband, tymingFlyPeriod=tymingFlyPeriod, gpsPosition=gpsPosition, etc=etc, ntpSysLeap=ntpSysLeap, gpsUTCOffset=gpsUTCOffset, gps=gps, ntpSysClock=ntpSysClock, ntpSysPhase=ntpSysPhase, symmetricom=symmetricom, ntpSysProcessor=ntpSysProcessor, ts2100=ts2100, version=version, etcModel=etcModel, ntpSysPeer=ntpSysPeer, s100=s100, experiment=experiment, ntpSysStratum=ntpSysStratum, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysVersion=ntpSysVersion, tymingSource=tymingSource, ntpSysSystem=ntpSysSystem, ntpSysFreq=ntpSysFreq, ntpSysPrecision=ntpSysPrecision, etcAlarm=etcAlarm, etcVersion=etcVersion, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefTime=ntpSysRefTime, symmSnmpManagement=symmSnmpManagement, etcUpgrade=etcUpgrade, ntpSysRootDelay=ntpSysRootDelay, symmTTM=symmTTM, ntpSysError=ntpSysError, symmCmipManagement=symmCmipManagement, xli=xli, PYSNMP_MODULE_ID=symmetricom, tymingStatus=tymingStatus, ntpSysRefID=ntpSysRefID, etcAlarmString=etcAlarmString)
