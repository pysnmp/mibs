...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, enterprises, Integer32, NotificationType, Counter64, ModuleIdentity, Gauge32, Bits, Counter32, MibIdentifier, IpAddress, ObjectIdentity, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "enterprises", "Integer32", "NotificationType", "Counter64", "ModuleIdentity", "Gauge32", "Bits", "Counter32", "MibIdentifier", "IpAddress", "ObjectIdentity", "NotificationType", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPktsReceived=ntpSysPktsReceived, symmNetworkManagement=symmNetworkManagement, gps=gps, etcUpgrade=etcUpgrade, gpsUTCOffset=gpsUTCOffset, symmSnmpManagement=symmSnmpManagement, dialup=dialup, ntpSysRefID=ntpSysRefID, PYSNMP_MODULE_ID=symmetricom, gpsHealth=gpsHealth, ntpSysVersion=ntpSysVersion, ntpSysNotrust=ntpSysNotrust, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRootDelay=ntpSysRootDelay, ntpSysStratum=ntpSysStratum, ntpSysLeap=ntpSysLeap, tymingSource=tymingSource, etcUpgradeServer=etcUpgradeServer, ntpSysPhase=ntpSysPhase, version=version, ts2100=ts2100, gpsSatlist=gpsSatlist, etc=etc, ts2000=ts2000, nts=nts, symmTimePictra=symmTimePictra, tymingFlyPeriod=tymingFlyPeriod, etcAlarm=etcAlarm, symmBroadband=symmBroadband, ntpSysFreq=ntpSysFreq, ntpSysProcessor=ntpSysProcessor, ntpSysPrecision=ntpSysPrecision, ntpSysPeer=ntpSysPeer, ntpSysClock=ntpSysClock, ntpSysPoll=ntpSysPoll, net=net, tymingTime=tymingTime, syncserver=syncserver, symmetricom=symmetricom, xli=xli, s100=s100, symmCmipManagement=symmCmipManagement, tyming=tyming, symmTTM=symmTTM, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, ntpSystem=ntpSystem, ntpSysMode=ntpSysMode, ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, tymingVersion=tymingVersion, gpsPosition=gpsPosition, etcVersion=etcVersion, etcSerialNbr=etcSerialNbr, etcModel=etcModel, gpsMode=gpsMode, ntpSysRefTime=ntpSysRefTime, products=products, experiment=experiment)
