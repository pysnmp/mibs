...
NotificationType, Counter32, enterprises, Gauge32, ModuleIdentity, Unsigned32, IpAddress, MibIdentifier, NotificationType, Integer32, ObjectIdentity, Counter64, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "enterprises", "Gauge32", "ModuleIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType", "Integer32", "ObjectIdentity", "Counter64", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", etcSerialNbr=etcSerialNbr, gps=gps, ntpSysRefID=ntpSysRefID, ts2000=ts2000, ntpSysPktsReceived=ntpSysPktsReceived, symmNetworkManagement=symmNetworkManagement, ntpSysPeer=ntpSysPeer, PYSNMP_MODULE_ID=symmetricom, symmSnmpManagement=symmSnmpManagement, etcAlarmString=etcAlarmString, ntpSysProcessor=ntpSysProcessor, etcAlarm=etcAlarm, ts2100=ts2100, ntpSysRootDispersion=ntpSysRootDispersion, net=net, ntpSysRefTime=ntpSysRefTime, ntpSysMode=ntpSysMode, tyming=tyming, tymingFlyPeriod=tymingFlyPeriod, dialup=dialup, gpsMode=gpsMode, etcVersion=etcVersion, ntpSysFreq=ntpSysFreq, ntpSysError=ntpSysError, ntpSysPoll=ntpSysPoll, etcUpgradeServer=etcUpgradeServer, tymingVersion=tymingVersion, ntpSysStratum=ntpSysStratum, symmTimePictra=symmTimePictra, tymingSource=tymingSource, ntpSysPrecision=ntpSysPrecision, gpsSatlist=gpsSatlist, version=version, ntpSysPhase=ntpSysPhase, gpsHealth=gpsHealth, tymingStatus=tymingStatus, symmetricom=symmetricom, tymingTime=tymingTime, ntpSysSystem=ntpSysSystem, ntpSysRootDelay=ntpSysRootDelay, ntpSysVersion=ntpSysVersion, ntpSysNotrust=ntpSysNotrust, syncserver=syncserver, xli=xli, ntpSystem=ntpSystem, gpsUTCOffset=gpsUTCOffset, etcModel=etcModel, nts=nts, ntpSysLeap=ntpSysLeap, symmBroadband=symmBroadband, products=products, etc=etc, gpsPosition=gpsPosition, experiment=experiment, symmCmipManagement=symmCmipManagement, etcUpgrade=etcUpgrade, s100=s100, symmTTM=symmTTM, ntpSysClock=ntpSysClock)
