...
enterprises, Unsigned32, ModuleIdentity, NotificationType, NotificationType, MibIdentifier, IpAddress, Counter32, TimeTicks, Counter64, Bits, Gauge32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "ModuleIdentity", "NotificationType", "NotificationType", "MibIdentifier", "IpAddress", "Counter32", "TimeTicks", "Counter64", "Bits", "Gauge32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("SYMM-SMI", etcVersion=etcVersion, gpsHealth=gpsHealth, ntpSysSystem=ntpSysSystem, etcAlarm=etcAlarm, gpsMode=gpsMode, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysClock=ntpSysClock, xli=xli, ntpSysPktsReceived=ntpSysPktsReceived, symmNetworkManagement=symmNetworkManagement, gps=gps, gpsPosition=gpsPosition, tyming=tyming, etc=etc, gpsUTCOffset=gpsUTCOffset, tymingTime=tymingTime, etcUpgrade=etcUpgrade, symmetricom=symmetricom, symmCmipManagement=symmCmipManagement, ntpSysPrecision=ntpSysPrecision, symmBroadband=symmBroadband, tymingSource=tymingSource, symmSnmpManagement=symmSnmpManagement, ntpSysPoll=ntpSysPoll, experiment=experiment, ntpSysRefTime=ntpSysRefTime, version=version, ntpSysPhase=ntpSysPhase, ts2100=ts2100, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, gpsSatlist=gpsSatlist, ts2000=ts2000, ntpSysError=ntpSysError, ntpSysVersion=ntpSysVersion, nts=nts, ntpSysRootDelay=ntpSysRootDelay, etcUpgradeServer=etcUpgradeServer, ntpSysNotrust=ntpSysNotrust, etcSerialNbr=etcSerialNbr, tymingVersion=tymingVersion, ntpSysMode=ntpSysMode, ntpSysFreq=ntpSysFreq, products=products, dialup=dialup, symmTTM=symmTTM, symmTimePictra=symmTimePictra, ntpSysProcessor=ntpSysProcessor, tymingStatus=tymingStatus, s100=s100, ntpSysRefID=ntpSysRefID, PYSNMP_MODULE_ID=symmetricom, net=net, syncserver=syncserver, etcAlarmString=etcAlarmString, ntpSystem=ntpSystem, ntpSysStratum=ntpSysStratum, etcModel=etcModel, ntpSysPeer=ntpSysPeer)
