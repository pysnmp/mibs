...
ObjectIdentity, Bits, Counter32, IpAddress, ModuleIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, enterprises, Integer32, TimeTicks, NotificationType, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "Counter32", "IpAddress", "ModuleIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "enterprises", "Integer32", "TimeTicks", "NotificationType", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysLeap=ntpSysLeap, ntpSysPoll=ntpSysPoll, symmBroadband=symmBroadband, symmTimePictra=symmTimePictra, ts2100=ts2100, syncserver=syncserver, symmNetworkManagement=symmNetworkManagement, etcModel=etcModel, symmetricom=symmetricom, ts2000=ts2000, etcVersion=etcVersion, etc=etc, gpsSatlist=gpsSatlist, ntpSysMode=ntpSysMode, gpsPosition=gpsPosition, symmSnmpManagement=symmSnmpManagement, ntpSysSystem=ntpSysSystem, ntpSysRootDelay=ntpSysRootDelay, ntpSysPhase=ntpSysPhase, ntpSysPeer=ntpSysPeer, products=products, gpsHealth=gpsHealth, ntpSysVersion=ntpSysVersion, etcAlarmString=etcAlarmString, ntpSystem=ntpSystem, ntpSysPktsReceived=ntpSysPktsReceived, symmTTM=symmTTM, gpsMode=gpsMode, tymingTime=tymingTime, nts=nts, version=version, tymingFlyPeriod=tymingFlyPeriod, etcUpgradeServer=etcUpgradeServer, ntpSysClock=ntpSysClock, net=net, ntpSysFreq=ntpSysFreq, ntpSysProcessor=ntpSysProcessor, gps=gps, tymingStatus=tymingStatus, etcAlarm=etcAlarm, etcUpgrade=etcUpgrade, ntpSysPrecision=ntpSysPrecision, s100=s100, ntpSysRootDispersion=ntpSysRootDispersion, xli=xli, ntpSysNotrust=ntpSysNotrust, tymingVersion=tymingVersion, ntpSysError=ntpSysError, tymingSource=tymingSource, etcSerialNbr=etcSerialNbr, ntpSysRefID=ntpSysRefID, experiment=experiment, tyming=tyming, ntpSysStratum=ntpSysStratum, gpsUTCOffset=gpsUTCOffset, symmCmipManagement=symmCmipManagement, PYSNMP_MODULE_ID=symmetricom, ntpSysRefTime=ntpSysRefTime, dialup=dialup)
