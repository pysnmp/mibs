...
ObjectIdentity, Integer32, NotificationType, Counter64, Counter32, ModuleIdentity, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, TimeTicks, IpAddress, iso, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "NotificationType", "Counter64", "Counter32", "ModuleIdentity", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "TimeTicks", "IpAddress", "iso", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", products=products, ntpSysRefID=ntpSysRefID, tymingStatus=tymingStatus, nts=nts, PYSNMP_MODULE_ID=symmetricom, ntpSysClock=ntpSysClock, etc=etc, symmNetworkManagement=symmNetworkManagement, ntpSysRootDelay=ntpSysRootDelay, ntpSysMode=ntpSysMode, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysVersion=ntpSysVersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysStratum=ntpSysStratum, ntpSysProcessor=ntpSysProcessor, experiment=experiment, tymingVersion=tymingVersion, net=net, ntpSysNotrust=ntpSysNotrust, tyming=tyming, s100=s100, xli=xli, etcUpgrade=etcUpgrade, ts2100=ts2100, ntpSysFreq=ntpSysFreq, gpsPosition=gpsPosition, version=version, symmSnmpManagement=symmSnmpManagement, etcUpgradeServer=etcUpgradeServer, symmCmipManagement=symmCmipManagement, ntpSysPhase=ntpSysPhase, tymingTime=tymingTime, etcSerialNbr=etcSerialNbr, ntpSysLeap=ntpSysLeap, etcAlarmString=etcAlarmString, ntpSysRefTime=ntpSysRefTime, ntpSystem=ntpSystem, symmetricom=symmetricom, symmBroadband=symmBroadband, ts2000=ts2000, dialup=dialup, ntpSysSystem=ntpSysSystem, gpsHealth=gpsHealth, etcModel=etcModel, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPoll=ntpSysPoll, gpsUTCOffset=gpsUTCOffset, gpsSatlist=gpsSatlist, symmTimePictra=symmTimePictra, symmTTM=symmTTM, ntpSysError=ntpSysError, etcVersion=etcVersion, syncserver=syncserver, ntpSysPeer=ntpSysPeer, etcAlarm=etcAlarm, gps=gps, tymingSource=tymingSource, ntpSysPrecision=ntpSysPrecision, gpsMode=gpsMode)
