...
Counter64, Gauge32, Bits, Unsigned32, TimeTicks, MibIdentifier, iso, Integer32, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, NotificationType, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "Bits", "Unsigned32", "TimeTicks", "MibIdentifier", "iso", "Integer32", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "NotificationType", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", symmetricom=symmetricom, products=products, version=version, gps=gps, tyming=tyming, ntpSysStratum=ntpSysStratum, tymingFlyPeriod=tymingFlyPeriod, experiment=experiment, ntpSysPeer=ntpSysPeer, etcUpgrade=etcUpgrade, gpsSatlist=gpsSatlist, ntpSysSystem=ntpSysSystem, gpsPosition=gpsPosition, etc=etc, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, ntpSysFreq=ntpSysFreq, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRootDelay=ntpSysRootDelay, ntpSysLeap=ntpSysLeap, gpsMode=gpsMode, net=net, tymingTime=tymingTime, ntpSysMode=ntpSysMode, gpsHealth=gpsHealth, PYSNMP_MODULE_ID=symmetricom, symmTimePictra=symmTimePictra, s100=s100, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysVersion=ntpSysVersion, ntpSysPhase=ntpSysPhase, gpsUTCOffset=gpsUTCOffset, etcAlarm=etcAlarm, ntpSysPrecision=ntpSysPrecision, tymingStatus=tymingStatus, etcSerialNbr=etcSerialNbr, dialup=dialup, etcUpgradeServer=etcUpgradeServer, ts2100=ts2100, ntpSysError=ntpSysError, ntpSysPoll=ntpSysPoll, symmNetworkManagement=symmNetworkManagement, nts=nts, symmCmipManagement=symmCmipManagement, symmSnmpManagement=symmSnmpManagement, symmBroadband=symmBroadband, ntpSysClock=ntpSysClock, tymingSource=tymingSource, etcVersion=etcVersion, xli=xli, tymingVersion=tymingVersion, etcModel=etcModel, ts2000=ts2000, syncserver=syncserver, etcAlarmString=etcAlarmString, symmTTM=symmTTM, ntpSystem=ntpSystem, ntpSysRefID=ntpSysRefID, ntpSysRefTime=ntpSysRefTime)
