...
mibBuilder.exportSymbols("SYMM-SMI", nts=nts, ntpSysPhase=ntpSysPhase, experiment=experiment, ntpSysLeap=ntpSysLeap, tymingStatus=tymingStatus, etcUpgrade=etcUpgrade, tymingSource=tymingSource, ntpSysMode=ntpSysMode, version=version, etcAlarm=etcAlarm, ntpSysStratum=ntpSysStratum, syncserver=syncserver, gpsSatlist=gpsSatlist, ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, tymingTime=tymingTime, etc=etc, symmTTM=symmTTM, gpsMode=gpsMode, ntpSysVersion=ntpSysVersion, tyming=tyming, xli=xli, PYSNMP_MODULE_ID=symmetricom, ntpSysRefTime=ntpSysRefTime, ntpSysPeer=ntpSysPeer, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, tymingFlyPeriod=tymingFlyPeriod, symmSnmpManagement=symmSnmpManagement, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPrecision=ntpSysPrecision, symmTimePictra=symmTimePictra, ntpSysFreq=ntpSysFreq, ntpSysRefID=ntpSysRefID, symmetricom=symmetricom, ntpSysPktsReceived=ntpSysPktsReceived, etcVersion=etcVersion, gpsHealth=gpsHealth, etcModel=etcModel, products=products, ntpSysClock=ntpSysClock, symmBroadband=symmBroadband, gpsUTCOffset=gpsUTCOffset, etcSerialNbr=etcSerialNbr, etcAlarmString=etcAlarmString, dialup=dialup, gpsPosition=gpsPosition, ts2000=ts2000, ntpSystem=ntpSystem, tymingVersion=tymingVersion, ntpSysPoll=ntpSysPoll, ts2100=ts2100, symmCmipManagement=symmCmipManagement, gps=gps, symmNetworkManagement=symmNetworkManagement, ntpSysRootDelay=ntpSysRootDelay, net=net, etcUpgradeServer=etcUpgradeServer, s100=s100)
