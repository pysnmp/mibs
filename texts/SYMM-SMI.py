...
enterprises, Counter64, Gauge32, Unsigned32, NotificationType, ObjectIdentity, IpAddress, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, Integer32, iso, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "Gauge32", "Unsigned32", "NotificationType", "ObjectIdentity", "IpAddress", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "Integer32", "iso", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", symmetricom=symmetricom, dialup=dialup, tymingStatus=tymingStatus, etcVersion=etcVersion, ntpSysSystem=ntpSysSystem, ntpSysPhase=ntpSysPhase, ntpSysNotrust=ntpSysNotrust, ntpSysPeer=ntpSysPeer, PYSNMP_MODULE_ID=symmetricom, products=products, ntpSysStratum=ntpSysStratum, ntpSysRootDelay=ntpSysRootDelay, ntpSysProcessor=ntpSysProcessor, ntpSysRefTime=ntpSysRefTime, nts=nts, version=version, ntpSysLeap=ntpSysLeap, symmCmipManagement=symmCmipManagement, gpsUTCOffset=gpsUTCOffset, net=net, ntpSysRefID=ntpSysRefID, syncserver=syncserver, gps=gps, etcAlarm=etcAlarm, gpsHealth=gpsHealth, ntpSysError=ntpSysError, ntpSysMode=ntpSysMode, symmTimePictra=symmTimePictra, etcAlarmString=etcAlarmString, s100=s100, ntpSysClock=ntpSysClock, tyming=tyming, tymingVersion=tymingVersion, tymingFlyPeriod=tymingFlyPeriod, etcSerialNbr=etcSerialNbr, etc=etc, symmBroadband=symmBroadband, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, tymingSource=tymingSource, gpsMode=gpsMode, ts2100=ts2100, ntpSysPrecision=ntpSysPrecision, xli=xli, ntpSysPoll=ntpSysPoll, ntpSysVersion=ntpSysVersion, symmNetworkManagement=symmNetworkManagement, etcModel=etcModel, tymingTime=tymingTime, etcUpgrade=etcUpgrade, etcUpgradeServer=etcUpgradeServer, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysFreq=ntpSysFreq, symmTTM=symmTTM, ts2000=ts2000, experiment=experiment, gpsPosition=gpsPosition, gpsSatlist=gpsSatlist, ntpSystem=ntpSystem)
