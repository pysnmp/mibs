...
Integer32, Counter32, ModuleIdentity, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, TimeTicks, IpAddress, NotificationType, ObjectIdentity, Bits, Counter64, enterprises, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "ModuleIdentity", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "TimeTicks", "IpAddress", "NotificationType", "ObjectIdentity", "Bits", "Counter64", "enterprises", "MibIdentifier")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPoll=ntpSysPoll, etcVersion=etcVersion, version=version, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysVersion=ntpSysVersion, ntpSysPrecision=ntpSysPrecision, ntpSysRefID=ntpSysRefID, ntpSysClock=ntpSysClock, tymingTime=tymingTime, ntpSysSystem=ntpSysSystem, ntpSysError=ntpSysError, gps=gps, dialup=dialup, symmTTM=symmTTM, s100=s100, tymingVersion=tymingVersion, symmCmipManagement=symmCmipManagement, ts2000=ts2000, gpsUTCOffset=gpsUTCOffset, PYSNMP_MODULE_ID=symmetricom, products=products, symmBroadband=symmBroadband, xli=xli, tymingStatus=tymingStatus, etcModel=etcModel, net=net, etcAlarm=etcAlarm, ntpSystem=ntpSystem, nts=nts, etc=etc, ntpSysProcessor=ntpSysProcessor, gpsMode=gpsMode, gpsHealth=gpsHealth, ntpSysPktsReceived=ntpSysPktsReceived, gpsSatlist=gpsSatlist, ntpSysStratum=ntpSysStratum, ntpSysLeap=ntpSysLeap, gpsPosition=gpsPosition, tymingFlyPeriod=tymingFlyPeriod, ts2100=ts2100, syncserver=syncserver, ntpSysFreq=ntpSysFreq, etcAlarmString=etcAlarmString, experiment=experiment, ntpSysNotrust=ntpSysNotrust, ntpSysRefTime=ntpSysRefTime, etcSerialNbr=etcSerialNbr, symmSnmpManagement=symmSnmpManagement, tymingSource=tymingSource, ntpSysPeer=ntpSysPeer, etcUpgrade=etcUpgrade, symmNetworkManagement=symmNetworkManagement, tyming=tyming, ntpSysRootDelay=ntpSysRootDelay, ntpSysPhase=ntpSysPhase, ntpSysMode=ntpSysMode, symmTimePictra=symmTimePictra, symmetricom=symmetricom, etcUpgradeServer=etcUpgradeServer)
