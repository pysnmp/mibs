...
iso, Bits, Integer32, ModuleIdentity, TimeTicks, MibIdentifier, NotificationType, Counter32, Counter64, enterprises, ObjectIdentity, IpAddress, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Integer32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "Counter32", "Counter64", "enterprises", "ObjectIdentity", "IpAddress", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("SYMM-SMI", etcAlarmString=etcAlarmString, syncserver=syncserver, ntpSysStratum=ntpSysStratum, etcVersion=etcVersion, etcUpgrade=etcUpgrade, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom, tymingSource=tymingSource, tymingVersion=tymingVersion, ntpSysPeer=ntpSysPeer, etcSerialNbr=etcSerialNbr, ntpSysLeap=ntpSysLeap, tymingTime=tymingTime, symmTTM=symmTTM, ntpSysRefID=ntpSysRefID, ts2100=ts2100, tyming=tyming, gps=gps, ntpSysVersion=ntpSysVersion, ntpSystem=ntpSystem, gpsHealth=gpsHealth, gpsMode=gpsMode, ntpSysSystem=ntpSysSystem, etcModel=etcModel, xli=xli, gpsPosition=gpsPosition, dialup=dialup, symmNetworkManagement=symmNetworkManagement, products=products, gpsSatlist=gpsSatlist, ntpSysError=ntpSysError, net=net, ntpSysRefTime=ntpSysRefTime, nts=nts, ntpSysRootDelay=ntpSysRootDelay, ntpSysNotrust=ntpSysNotrust, ts2000=ts2000, ntpSysClock=ntpSysClock, etcAlarm=etcAlarm, symmetricom=symmetricom, ntpSysPhase=ntpSysPhase, gpsUTCOffset=gpsUTCOffset, experiment=experiment, symmSnmpManagement=symmSnmpManagement, symmCmipManagement=symmCmipManagement, ntpSysPoll=ntpSysPoll, ntpSysFreq=ntpSysFreq, ntpSysProcessor=ntpSysProcessor, symmTimePictra=symmTimePictra, s100=s100, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgradeServer=etcUpgradeServer, tymingStatus=tymingStatus, etc=etc, version=version, tymingFlyPeriod=tymingFlyPeriod, ntpSysMode=ntpSysMode, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPrecision=ntpSysPrecision)
