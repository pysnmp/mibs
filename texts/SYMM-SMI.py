...
enterprises, Gauge32, NotificationType, IpAddress, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, ObjectIdentity, Unsigned32, Bits, TimeTicks, Counter64, MibIdentifier, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "NotificationType", "IpAddress", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "ObjectIdentity", "Unsigned32", "Bits", "TimeTicks", "Counter64", "MibIdentifier", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", symmTTM=symmTTM, gpsSatlist=gpsSatlist, ntpSysPhase=ntpSysPhase, experiment=experiment, gpsUTCOffset=gpsUTCOffset, dialup=dialup, tymingVersion=tymingVersion, etcUpgradeServer=etcUpgradeServer, ntpSysStratum=ntpSysStratum, ts2100=ts2100, gpsPosition=gpsPosition, ntpSysRootDelay=ntpSysRootDelay, ntpSysPrecision=ntpSysPrecision, symmTimePictra=symmTimePictra, symmBroadband=symmBroadband, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysMode=ntpSysMode, xli=xli, ntpSystem=ntpSystem, symmetricom=symmetricom, ntpSysRefID=ntpSysRefID, ntpSysPoll=ntpSysPoll, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, etcVersion=etcVersion, ntpSysSystem=ntpSysSystem, version=version, ntpSysRefTime=ntpSysRefTime, ntpSysError=ntpSysError, etc=etc, symmNetworkManagement=symmNetworkManagement, products=products, syncserver=syncserver, nts=nts, etcAlarm=etcAlarm, tymingFlyPeriod=tymingFlyPeriod, symmSnmpManagement=symmSnmpManagement, tymingTime=tymingTime, tymingSource=tymingSource, ntpSysProcessor=ntpSysProcessor, ts2000=ts2000, PYSNMP_MODULE_ID=symmetricom, ntpSysClock=ntpSysClock, etcUpgrade=etcUpgrade, s100=s100, ntpSysVersion=ntpSysVersion, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPeer=ntpSysPeer, gpsHealth=gpsHealth, gps=gps, symmCmipManagement=symmCmipManagement, etcSerialNbr=etcSerialNbr, tyming=tyming, net=net, ntpSysFreq=ntpSysFreq, etcModel=etcModel, ntpSysLeap=ntpSysLeap, ntpSysNotrust=ntpSysNotrust, gpsMode=gpsMode)
