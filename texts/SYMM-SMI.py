...
mibBuilder.exportSymbols("SYMM-SMI", gpsMode=gpsMode, ntpSysPktsReceived=ntpSysPktsReceived, gps=gps, experiment=experiment, ts2100=ts2100, ntpSysLeap=ntpSysLeap, ntpSysRefID=ntpSysRefID, ntpSysVersion=ntpSysVersion, ntpSysSystem=ntpSysSystem, tymingStatus=tymingStatus, gpsPosition=gpsPosition, gpsHealth=gpsHealth, ntpSysPhase=ntpSysPhase, etcAlarm=etcAlarm, symmTTM=symmTTM, tymingVersion=tymingVersion, ntpSysRootDelay=ntpSysRootDelay, ntpSystem=ntpSystem, symmetricom=symmetricom, symmSnmpManagement=symmSnmpManagement, ntpSysPrecision=ntpSysPrecision, symmTimePictra=symmTimePictra, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPoll=ntpSysPoll, etcUpgrade=etcUpgrade, syncserver=syncserver, net=net, ntpSysRefTime=ntpSysRefTime, dialup=dialup, ntpSysClock=ntpSysClock, ntpSysStratum=ntpSysStratum, tymingFlyPeriod=tymingFlyPeriod, ntpSysProcessor=ntpSysProcessor, gpsSatlist=gpsSatlist, etcVersion=etcVersion, etc=etc, xli=xli, tymingTime=tymingTime, ntpSysPeer=ntpSysPeer, ntpSysError=ntpSysError, etcUpgradeServer=etcUpgradeServer, tymingSource=tymingSource, ts2000=ts2000, products=products, symmCmipManagement=symmCmipManagement, ntpSysFreq=ntpSysFreq, etcModel=etcModel, symmBroadband=symmBroadband, gpsUTCOffset=gpsUTCOffset, ntpSysMode=ntpSysMode, version=version, symmNetworkManagement=symmNetworkManagement, ntpSysNotrust=ntpSysNotrust, PYSNMP_MODULE_ID=symmetricom, nts=nts, s100=s100, etcSerialNbr=etcSerialNbr, etcAlarmString=etcAlarmString, tyming=tyming)
