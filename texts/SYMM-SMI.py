...
enterprises, TimeTicks, NotificationType, Bits, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, ObjectIdentity, Counter32, MibIdentifier, NotificationType, IpAddress, Gauge32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "NotificationType", "Bits", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "ObjectIdentity", "Counter32", "MibIdentifier", "NotificationType", "IpAddress", "Gauge32", "Counter64")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysFreq=ntpSysFreq, symmTimePictra=symmTimePictra, ntpSysRefTime=ntpSysRefTime, products=products, etcUpgrade=etcUpgrade, ntpSystem=ntpSystem, etcSerialNbr=etcSerialNbr, ntpSysMode=ntpSysMode, tyming=tyming, gpsUTCOffset=gpsUTCOffset, tymingTime=tymingTime, etcVersion=etcVersion, etcAlarm=etcAlarm, ntpSysPeer=ntpSysPeer, symmCmipManagement=symmCmipManagement, symmSnmpManagement=symmSnmpManagement, gpsSatlist=gpsSatlist, ntpSysRefID=ntpSysRefID, ntpSysPhase=ntpSysPhase, net=net, ntpSysSystem=ntpSysSystem, ts2100=ts2100, gpsMode=gpsMode, ntpSysStratum=ntpSysStratum, symmNetworkManagement=symmNetworkManagement, ntpSysPoll=ntpSysPoll, ntpSysRootDelay=ntpSysRootDelay, experiment=experiment, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgradeServer=etcUpgradeServer, PYSNMP_MODULE_ID=symmetricom, symmetricom=symmetricom, ntpSysRootDispersion=ntpSysRootDispersion, ts2000=ts2000, gpsPosition=gpsPosition, ntpSysProcessor=ntpSysProcessor, s100=s100, version=version, symmBroadband=symmBroadband, ntpSysNotrust=ntpSysNotrust, tymingVersion=tymingVersion, symmTTM=symmTTM, tymingSource=tymingSource, tymingFlyPeriod=tymingFlyPeriod, nts=nts, ntpSysVersion=ntpSysVersion, gps=gps, xli=xli, ntpSysClock=ntpSysClock, gpsHealth=gpsHealth, ntpSysLeap=ntpSysLeap, ntpSysError=ntpSysError, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, etcModel=etcModel, syncserver=syncserver, ntpSysPrecision=ntpSysPrecision, etc=etc, dialup=dialup)
