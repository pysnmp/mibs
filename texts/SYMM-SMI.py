...
Counter64, TimeTicks, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, NotificationType, ModuleIdentity, iso, NotificationType, enterprises, Unsigned32, ObjectIdentity, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "NotificationType", "ModuleIdentity", "iso", "NotificationType", "enterprises", "Unsigned32", "ObjectIdentity", "Bits", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", symmNetworkManagement=symmNetworkManagement, dialup=dialup, nts=nts, symmSnmpManagement=symmSnmpManagement, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysMode=ntpSysMode, etc=etc, etcVersion=etcVersion, ntpSysRefTime=ntpSysRefTime, ts2000=ts2000, ntpSysRootDispersion=ntpSysRootDispersion, tyming=tyming, etcModel=etcModel, version=version, symmTTM=symmTTM, ntpSysFreq=ntpSysFreq, PYSNMP_MODULE_ID=symmetricom, gpsUTCOffset=gpsUTCOffset, experiment=experiment, symmTimePictra=symmTimePictra, ntpSysPrecision=ntpSysPrecision, ntpSysClock=ntpSysClock, ts2100=ts2100, etcUpgrade=etcUpgrade, s100=s100, ntpSysNotrust=ntpSysNotrust, xli=xli, ntpSysVersion=ntpSysVersion, symmBroadband=symmBroadband, ntpSystem=ntpSystem, tymingVersion=tymingVersion, ntpSysRefID=ntpSysRefID, gpsPosition=gpsPosition, tymingTime=tymingTime, ntpSysError=ntpSysError, tymingFlyPeriod=tymingFlyPeriod, gpsSatlist=gpsSatlist, etcUpgradeServer=etcUpgradeServer, gpsHealth=gpsHealth, products=products, etcAlarmString=etcAlarmString, ntpSysPeer=ntpSysPeer, ntpSysPhase=ntpSysPhase, net=net, tymingSource=tymingSource, symmetricom=symmetricom, gpsMode=gpsMode, etcSerialNbr=etcSerialNbr, ntpSysLeap=ntpSysLeap, ntpSysProcessor=ntpSysProcessor, ntpSysSystem=ntpSysSystem, syncserver=syncserver, ntpSysStratum=ntpSysStratum, tymingStatus=tymingStatus, etcAlarm=etcAlarm, ntpSysRootDelay=ntpSysRootDelay, symmCmipManagement=symmCmipManagement, ntpSysPoll=ntpSysPoll, gps=gps)
