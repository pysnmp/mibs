...
iso, Counter32, ModuleIdentity, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, NotificationType, Integer32, Counter64, IpAddress, enterprises, MibIdentifier, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "NotificationType", "Integer32", "Counter64", "IpAddress", "enterprises", "MibIdentifier", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", symmTimePictra=symmTimePictra, ntpSysRootDelay=ntpSysRootDelay, etcUpgradeServer=etcUpgradeServer, symmetricom=symmetricom, ntpSysRefID=ntpSysRefID, ts2000=ts2000, ts2100=ts2100, gpsHealth=gpsHealth, etcAlarmString=etcAlarmString, etc=etc, tymingVersion=tymingVersion, ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem, xli=xli, etcAlarm=etcAlarm, ntpSysMode=ntpSysMode, etcUpgrade=etcUpgrade, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, ntpSysPeer=ntpSysPeer, ntpSysFreq=ntpSysFreq, symmCmipManagement=symmCmipManagement, nts=nts, tymingTime=tymingTime, ntpSysNotrust=ntpSysNotrust, gpsMode=gpsMode, etcModel=etcModel, gpsUTCOffset=gpsUTCOffset, ntpSysVersion=ntpSysVersion, dialup=dialup, ntpSysRootDispersion=ntpSysRootDispersion, tymingStatus=tymingStatus, gpsSatlist=gpsSatlist, s100=s100, etcSerialNbr=etcSerialNbr, ntpSysError=ntpSysError, ntpSystem=ntpSystem, ntpSysPrecision=ntpSysPrecision, gpsPosition=gpsPosition, net=net, version=version, symmSnmpManagement=symmSnmpManagement, experiment=experiment, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, symmTTM=symmTTM, products=products, ntpSysProcessor=ntpSysProcessor, ntpSysRefTime=ntpSysRefTime, symmNetworkManagement=symmNetworkManagement, ntpSysStratum=ntpSysStratum, gps=gps, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom, tyming=tyming, ntpSysPhase=ntpSysPhase, syncserver=syncserver, ntpSysPktsReceived=ntpSysPktsReceived, etcVersion=etcVersion)
