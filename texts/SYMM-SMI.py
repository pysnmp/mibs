...
Counter32, NotificationType, Counter64, MibIdentifier, ObjectIdentity, TimeTicks, IpAddress, NotificationType, enterprises, Integer32, ModuleIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Counter64", "MibIdentifier", "ObjectIdentity", "TimeTicks", "IpAddress", "NotificationType", "enterprises", "Integer32", "ModuleIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysLeap=ntpSysLeap, ts2000=ts2000, tymingStatus=tymingStatus, net=net, ntpSysStratum=ntpSysStratum, gpsSatlist=gpsSatlist, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, gpsUTCOffset=gpsUTCOffset, gps=gps, tymingTime=tymingTime, ntpSysProcessor=ntpSysProcessor, etcAlarmString=etcAlarmString, symmTimePictra=symmTimePictra, etcModel=etcModel, ntpSysPeer=ntpSysPeer, ntpSysPrecision=ntpSysPrecision, experiment=experiment, ntpSysRefTime=ntpSysRefTime, symmBroadband=symmBroadband, etcAlarm=etcAlarm, tyming=tyming, syncserver=syncserver, ntpSysRootDispersion=ntpSysRootDispersion, gpsPosition=gpsPosition, etcSerialNbr=etcSerialNbr, products=products, ntpSysFreq=ntpSysFreq, ts2100=ts2100, ntpSysMode=ntpSysMode, ntpSysVersion=ntpSysVersion, ntpSysPhase=ntpSysPhase, nts=nts, tymingSource=tymingSource, symmTTM=symmTTM, etcUpgradeServer=etcUpgradeServer, symmetricom=symmetricom, etc=etc, xli=xli, etcVersion=etcVersion, symmNetworkManagement=symmNetworkManagement, s100=s100, version=version, ntpSysSystem=ntpSysSystem, tymingVersion=tymingVersion, PYSNMP_MODULE_ID=symmetricom, ntpSysPoll=ntpSysPoll, ntpSysClock=ntpSysClock, ntpSysRefID=ntpSysRefID, gpsHealth=gpsHealth, ntpSysRootDelay=ntpSysRootDelay, gpsMode=gpsMode, ntpSysNotrust=ntpSysNotrust, dialup=dialup, symmCmipManagement=symmCmipManagement, ntpSysPktsReceived=ntpSysPktsReceived, tymingFlyPeriod=tymingFlyPeriod, ntpSystem=ntpSystem, symmSnmpManagement=symmSnmpManagement)
