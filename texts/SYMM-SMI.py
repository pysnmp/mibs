...
mibBuilder.exportSymbols("SYMM-SMI", net=net, gpsSatlist=gpsSatlist, ntpSysRefID=ntpSysRefID, gpsPosition=gpsPosition, s100=s100, products=products, ntpSysPrecision=ntpSysPrecision, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRootDelay=ntpSysRootDelay, tymingFlyPeriod=tymingFlyPeriod, etcVersion=etcVersion, ntpSysVersion=ntpSysVersion, tymingStatus=tymingStatus, symmBroadband=symmBroadband, nts=nts, ntpSysLeap=ntpSysLeap, tymingTime=tymingTime, etcUpgrade=etcUpgrade, ts2000=ts2000, tymingSource=tymingSource, ntpSysStratum=ntpSysStratum, gpsUTCOffset=gpsUTCOffset, symmNetworkManagement=symmNetworkManagement, version=version, PYSNMP_MODULE_ID=symmetricom, ntpSysMode=ntpSysMode, etcAlarm=etcAlarm, ntpSysPoll=ntpSysPoll, gps=gps, ntpSysProcessor=ntpSysProcessor, etcUpgradeServer=etcUpgradeServer, symmetricom=symmetricom, symmTimePictra=symmTimePictra, ntpSysPhase=ntpSysPhase, dialup=dialup, symmTTM=symmTTM, ntpSysFreq=ntpSysFreq, tymingVersion=tymingVersion, etcModel=etcModel, etcAlarmString=etcAlarmString, tyming=tyming, ntpSysError=ntpSysError, ntpSysClock=ntpSysClock, gpsMode=gpsMode, ts2100=ts2100, xli=xli, syncserver=syncserver, etc=etc, etcSerialNbr=etcSerialNbr, ntpSystem=ntpSystem, symmSnmpManagement=symmSnmpManagement, ntpSysRefTime=ntpSysRefTime, experiment=experiment, ntpSysSystem=ntpSysSystem, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysPeer=ntpSysPeer, symmCmipManagement=symmCmipManagement, gpsHealth=gpsHealth, ntpSysNotrust=ntpSysNotrust)
