...
Bits, Counter32, IpAddress, enterprises, Unsigned32, Integer32, ObjectIdentity, ModuleIdentity, MibIdentifier, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "IpAddress", "enterprises", "Unsigned32", "Integer32", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", symmTimePictra=symmTimePictra, ts2100=ts2100, etcAlarmString=etcAlarmString, version=version, ntpSysRootDelay=ntpSysRootDelay, symmSnmpManagement=symmSnmpManagement, ntpSysPhase=ntpSysPhase, symmNetworkManagement=symmNetworkManagement, s100=s100, tymingStatus=tymingStatus, gpsSatlist=gpsSatlist, gpsPosition=gpsPosition, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefID=ntpSysRefID, net=net, gpsUTCOffset=gpsUTCOffset, nts=nts, products=products, tymingSource=tymingSource, symmCmipManagement=symmCmipManagement, dialup=dialup, ntpSysClock=ntpSysClock, etc=etc, ntpSysVersion=ntpSysVersion, tymingVersion=tymingVersion, ntpSysProcessor=ntpSysProcessor, ntpSysLeap=ntpSysLeap, gps=gps, PYSNMP_MODULE_ID=symmetricom, syncserver=syncserver, ntpSysStratum=ntpSysStratum, tyming=tyming, ntpSysFreq=ntpSysFreq, ntpSysPeer=ntpSysPeer, symmetricom=symmetricom, symmBroadband=symmBroadband, ntpSysNotrust=ntpSysNotrust, experiment=experiment, gpsMode=gpsMode, ntpSystem=ntpSystem, ntpSysMode=ntpSysMode, ntpSysRefTime=ntpSysRefTime, symmTTM=symmTTM, ts2000=ts2000, ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, gpsHealth=gpsHealth, etcModel=etcModel, tymingFlyPeriod=tymingFlyPeriod, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysPrecision=ntpSysPrecision, etcUpgrade=etcUpgrade, etcSerialNbr=etcSerialNbr, tymingTime=tymingTime, etcUpgradeServer=etcUpgradeServer, xli=xli, etcAlarm=etcAlarm, etcVersion=etcVersion, ntpSysPoll=ntpSysPoll)
