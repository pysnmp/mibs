...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, NotificationType, TimeTicks, NotificationType, Counter64, ModuleIdentity, Bits, enterprises, Gauge32, Unsigned32, IpAddress, iso, Integer32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "NotificationType", "TimeTicks", "NotificationType", "Counter64", "ModuleIdentity", "Bits", "enterprises", "Gauge32", "Unsigned32", "IpAddress", "iso", "Integer32", "MibIdentifier")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefID=ntpSysRefID, ntpSysClock=ntpSysClock, ts2000=ts2000, tymingVersion=tymingVersion, etcUpgradeServer=etcUpgradeServer, gpsSatlist=gpsSatlist, ntpSysRefTime=ntpSysRefTime, ntpSysMode=ntpSysMode, ntpSystem=ntpSystem, ntpSysPrecision=ntpSysPrecision, tymingSource=tymingSource, ntpSysLeap=ntpSysLeap, tymingStatus=tymingStatus, etcUpgrade=etcUpgrade, PYSNMP_MODULE_ID=symmetricom, ntpSysPoll=ntpSysPoll, ntpSysError=ntpSysError, ntpSysSystem=ntpSysSystem, ntpSysNotrust=ntpSysNotrust, nts=nts, version=version, etc=etc, ntpSysProcessor=ntpSysProcessor, gpsUTCOffset=gpsUTCOffset, ntpSysPktsReceived=ntpSysPktsReceived, etcModel=etcModel, symmBroadband=symmBroadband, products=products, symmSnmpManagement=symmSnmpManagement, tymingTime=tymingTime, symmCmipManagement=symmCmipManagement, experiment=experiment, etcAlarm=etcAlarm, syncserver=syncserver, tyming=tyming, ts2100=ts2100, ntpSysPhase=ntpSysPhase, etcVersion=etcVersion, symmTimePictra=symmTimePictra, dialup=dialup, gpsMode=gpsMode, xli=xli, etcAlarmString=etcAlarmString, symmTTM=symmTTM, net=net, ntpSysStratum=ntpSysStratum, gpsHealth=gpsHealth, gps=gps, symmetricom=symmetricom, gpsPosition=gpsPosition, s100=s100, etcSerialNbr=etcSerialNbr, ntpSysFreq=ntpSysFreq, ntpSysPeer=ntpSysPeer, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysVersion=ntpSysVersion, tymingFlyPeriod=tymingFlyPeriod, ntpSysRootDelay=ntpSysRootDelay, symmNetworkManagement=symmNetworkManagement)
