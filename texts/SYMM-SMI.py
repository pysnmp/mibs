...
NotificationType, IpAddress, MibIdentifier, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, iso, Integer32, Unsigned32, Gauge32, ObjectIdentity, Counter32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "MibIdentifier", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "iso", "Integer32", "Unsigned32", "Gauge32", "ObjectIdentity", "Counter32", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", symmBroadband=symmBroadband, tymingFlyPeriod=tymingFlyPeriod, symmTimePictra=symmTimePictra, tymingSource=tymingSource, etcAlarm=etcAlarm, gpsPosition=gpsPosition, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDelay=ntpSysRootDelay, tymingTime=tymingTime, ntpSysRefID=ntpSysRefID, ntpSysNotrust=ntpSysNotrust, tymingVersion=tymingVersion, etcSerialNbr=etcSerialNbr, etcUpgrade=etcUpgrade, ntpSysMode=ntpSysMode, syncserver=syncserver, ntpSysClock=ntpSysClock, etcAlarmString=etcAlarmString, s100=s100, net=net, ntpSysLeap=ntpSysLeap, ntpSysPoll=ntpSysPoll, ts2100=ts2100, symmSnmpManagement=symmSnmpManagement, ntpSysSystem=ntpSysSystem, tymingStatus=tymingStatus, version=version, experiment=experiment, gpsMode=gpsMode, dialup=dialup, ntpSysPhase=ntpSysPhase, symmetricom=symmetricom, symmNetworkManagement=symmNetworkManagement, ntpSysStratum=ntpSysStratum, gpsUTCOffset=gpsUTCOffset, ntpSysRefTime=ntpSysRefTime, ntpSystem=ntpSystem, ntpSysPeer=ntpSysPeer, gpsSatlist=gpsSatlist, gps=gps, etcUpgradeServer=etcUpgradeServer, ts2000=ts2000, products=products, ntpSysPrecision=ntpSysPrecision, ntpSysFreq=ntpSysFreq, ntpSysError=ntpSysError, ntpSysRootDispersion=ntpSysRootDispersion, etcVersion=etcVersion, ntpSysProcessor=ntpSysProcessor, xli=xli, ntpSysVersion=ntpSysVersion, tyming=tyming, nts=nts, symmCmipManagement=symmCmipManagement, ntpSysPktsReceived=ntpSysPktsReceived, gpsHealth=gpsHealth, etc=etc, symmTTM=symmTTM, etcModel=etcModel)
