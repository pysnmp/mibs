...
NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, Gauge32, Unsigned32, TimeTicks, MibIdentifier, ObjectIdentity, IpAddress, enterprises, iso, Integer32, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "Gauge32", "Unsigned32", "TimeTicks", "MibIdentifier", "ObjectIdentity", "IpAddress", "enterprises", "iso", "Integer32", "Counter64", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsSatlist=gpsSatlist, version=version, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, etc=etc, ntpSysFreq=ntpSysFreq, tymingStatus=tymingStatus, etcAlarmString=etcAlarmString, etcModel=etcModel, etcUpgradeServer=etcUpgradeServer, ntpSysMode=ntpSysMode, tymingSource=tymingSource, gpsHealth=gpsHealth, ntpSystem=ntpSystem, ntpSysRefTime=ntpSysRefTime, ntpSysVersion=ntpSysVersion, tymingVersion=tymingVersion, xli=xli, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysError=ntpSysError, ntpSysStratum=ntpSysStratum, symmCmipManagement=symmCmipManagement, etcUpgrade=etcUpgrade, ntpSysProcessor=ntpSysProcessor, net=net, symmBroadband=symmBroadband, gps=gps, ntpSysPoll=ntpSysPoll, tyming=tyming, ntpSysRefID=ntpSysRefID, etcVersion=etcVersion, gpsPosition=gpsPosition, gpsMode=gpsMode, etcAlarm=etcAlarm, ts2000=ts2000, gpsUTCOffset=gpsUTCOffset, symmTimePictra=symmTimePictra, symmetricom=symmetricom, tymingTime=tymingTime, symmTTM=symmTTM, ntpSysSystem=ntpSysSystem, products=products, symmSnmpManagement=symmSnmpManagement, ntpSysPeer=ntpSysPeer, ntpSysClock=ntpSysClock, PYSNMP_MODULE_ID=symmetricom, nts=nts, ntpSysPrecision=ntpSysPrecision, ntpSysPhase=ntpSysPhase, syncserver=syncserver, ntpSysRootDelay=ntpSysRootDelay, symmNetworkManagement=symmNetworkManagement, etcSerialNbr=etcSerialNbr, experiment=experiment, dialup=dialup, s100=s100, ntpSysNotrust=ntpSysNotrust, ntpSysPktsReceived=ntpSysPktsReceived, ts2100=ts2100)
