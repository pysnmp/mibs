...
Counter32, ModuleIdentity, IpAddress, MibIdentifier, enterprises, iso, Counter64, ObjectIdentity, Gauge32, Bits, Unsigned32, TimeTicks, NotificationType, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "IpAddress", "MibIdentifier", "enterprises", "iso", "Counter64", "ObjectIdentity", "Gauge32", "Bits", "Unsigned32", "TimeTicks", "NotificationType", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysLeap=ntpSysLeap, gpsMode=gpsMode, tymingTime=tymingTime, PYSNMP_MODULE_ID=symmetricom, ntpSysError=ntpSysError, ntpSysRootDelay=ntpSysRootDelay, ntpSysRefID=ntpSysRefID, etcModel=etcModel, ntpSysProcessor=ntpSysProcessor, gpsSatlist=gpsSatlist, ntpSysFreq=ntpSysFreq, ntpSysPeer=ntpSysPeer, net=net, etcUpgrade=etcUpgrade, etcUpgradeServer=etcUpgradeServer, symmetricom=symmetricom, etcVersion=etcVersion, symmTimePictra=symmTimePictra, ntpSysRootDispersion=ntpSysRootDispersion, gpsPosition=gpsPosition, xli=xli, symmNetworkManagement=symmNetworkManagement, tyming=tyming, experiment=experiment, ts2000=ts2000, ntpSysPhase=ntpSysPhase, etcAlarmString=etcAlarmString, etcAlarm=etcAlarm, dialup=dialup, products=products, ntpSysStratum=ntpSysStratum, ntpSysPrecision=ntpSysPrecision, version=version, tymingSource=tymingSource, gpsHealth=gpsHealth, ntpSysSystem=ntpSysSystem, ntpSysVersion=ntpSysVersion, etc=etc, ntpSysNotrust=ntpSysNotrust, symmSnmpManagement=symmSnmpManagement, tymingVersion=tymingVersion, s100=s100, gps=gps, ntpSysRefTime=ntpSysRefTime, ntpSystem=ntpSystem, ts2100=ts2100, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, gpsUTCOffset=gpsUTCOffset, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysMode=ntpSysMode, nts=nts, symmTTM=symmTTM, etcSerialNbr=etcSerialNbr, symmCmipManagement=symmCmipManagement, ntpSysClock=ntpSysClock, symmBroadband=symmBroadband, ntpSysPoll=ntpSysPoll, syncserver=syncserver)
