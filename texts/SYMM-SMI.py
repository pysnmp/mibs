...
TimeTicks, Integer32, IpAddress, Bits, ModuleIdentity, Unsigned32, ObjectIdentity, Counter32, iso, MibIdentifier, enterprises, NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "IpAddress", "Bits", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "Counter32", "iso", "MibIdentifier", "enterprises", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPrecision=ntpSysPrecision, gpsSatlist=gpsSatlist, etc=etc, experiment=experiment, products=products, ntpSysLeap=ntpSysLeap, tymingTime=tymingTime, syncserver=syncserver, gpsMode=gpsMode, ntpSysRefID=ntpSysRefID, ntpSysPoll=ntpSysPoll, gps=gps, etcUpgrade=etcUpgrade, symmTimePictra=symmTimePictra, symmSnmpManagement=symmSnmpManagement, symmTTM=symmTTM, ntpSysRootDelay=ntpSysRootDelay, ntpSysClock=ntpSysClock, etcUpgradeServer=etcUpgradeServer, tymingVersion=tymingVersion, ts2000=ts2000, ntpSysFreq=ntpSysFreq, ntpSysVersion=ntpSysVersion, ntpSystem=ntpSystem, ntpSysPeer=ntpSysPeer, symmCmipManagement=symmCmipManagement, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, gpsHealth=gpsHealth, net=net, ntpSysError=ntpSysError, ntpSysPhase=ntpSysPhase, tymingSource=tymingSource, ntpSysRefTime=ntpSysRefTime, etcVersion=etcVersion, version=version, xli=xli, ntpSysRootDispersion=ntpSysRootDispersion, s100=s100, etcSerialNbr=etcSerialNbr, symmetricom=symmetricom, gpsUTCOffset=gpsUTCOffset, ntpSysMode=ntpSysMode, etcAlarm=etcAlarm, tyming=tyming, PYSNMP_MODULE_ID=symmetricom, etcModel=etcModel, dialup=dialup, ntpSysPktsReceived=ntpSysPktsReceived, symmBroadband=symmBroadband, ts2100=ts2100, symmNetworkManagement=symmNetworkManagement, nts=nts, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, gpsPosition=gpsPosition, etcAlarmString=etcAlarmString, ntpSysStratum=ntpSysStratum, ntpSysSystem=ntpSysSystem)
