...
Gauge32, enterprises, MibIdentifier, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, Counter32, ModuleIdentity, Unsigned32, Counter64, ObjectIdentity, iso, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "MibIdentifier", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "Counter32", "ModuleIdentity", "Unsigned32", "Counter64", "ObjectIdentity", "iso", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsUTCOffset=gpsUTCOffset, ntpSysStratum=ntpSysStratum, ntpSysError=ntpSysError, gpsPosition=gpsPosition, etcVersion=etcVersion, ts2000=ts2000, gps=gps, etcUpgrade=etcUpgrade, tymingStatus=tymingStatus, tymingSource=tymingSource, symmetricom=symmetricom, etcUpgradeServer=etcUpgradeServer, ntpSysLeap=ntpSysLeap, gpsSatlist=gpsSatlist, ntpSysVersion=ntpSysVersion, ntpSystem=ntpSystem, dialup=dialup, ntpSysNotrust=ntpSysNotrust, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, gpsHealth=gpsHealth, ntpSysSystem=ntpSysSystem, net=net, tymingFlyPeriod=tymingFlyPeriod, ntpSysPhase=ntpSysPhase, tymingTime=tymingTime, ntpSysRootDelay=ntpSysRootDelay, tyming=tyming, symmSnmpManagement=symmSnmpManagement, ntpSysClock=ntpSysClock, ntpSysRefID=ntpSysRefID, symmCmipManagement=symmCmipManagement, ntpSysPrecision=ntpSysPrecision, ntpSysProcessor=ntpSysProcessor, symmTimePictra=symmTimePictra, ntpSysPoll=ntpSysPoll, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysMode=ntpSysMode, xli=xli, etcModel=etcModel, experiment=experiment, ntpSysRefTime=ntpSysRefTime, products=products, ntpSysFreq=ntpSysFreq, etcSerialNbr=etcSerialNbr, etcAlarm=etcAlarm, syncserver=syncserver, ntpSysRootDispersion=ntpSysRootDispersion, ts2100=ts2100, nts=nts, version=version, ntpSysPeer=ntpSysPeer, gpsMode=gpsMode, etc=etc, symmTTM=symmTTM, tymingVersion=tymingVersion, s100=s100, symmNetworkManagement=symmNetworkManagement, etcAlarmString=etcAlarmString)
