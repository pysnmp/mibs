...
TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, iso, Bits, MibIdentifier, IpAddress, Counter64, Integer32, enterprises, Counter32, ModuleIdentity, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "iso", "Bits", "MibIdentifier", "IpAddress", "Counter64", "Integer32", "enterprises", "Counter32", "ModuleIdentity", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDelay=ntpSysRootDelay, net=net, s100=s100, gpsSatlist=gpsSatlist, gps=gps, tyming=tyming, syncserver=syncserver, ntpSystem=ntpSystem, ntpSysError=ntpSysError, ntpSysRefID=ntpSysRefID, nts=nts, ntpSysStratum=ntpSysStratum, gpsHealth=gpsHealth, ntpSysPoll=ntpSysPoll, ntpSysFreq=ntpSysFreq, ts2100=ts2100, etcAlarm=etcAlarm, symmCmipManagement=symmCmipManagement, ntpSysClock=ntpSysClock, ntpSysPeer=ntpSysPeer, dialup=dialup, tymingSource=tymingSource, ntpSysNotrust=ntpSysNotrust, tymingStatus=tymingStatus, ntpSysPrecision=ntpSysPrecision, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, ntpSysVersion=ntpSysVersion, gpsUTCOffset=gpsUTCOffset, etcModel=etcModel, ntpSysRefTime=ntpSysRefTime, symmSnmpManagement=symmSnmpManagement, products=products, experiment=experiment, xli=xli, etcAlarmString=etcAlarmString, tymingTime=tymingTime, etcSerialNbr=etcSerialNbr, ntpSysSystem=ntpSysSystem, ntpSysPktsReceived=ntpSysPktsReceived, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom, ntpSysMode=ntpSysMode, tymingFlyPeriod=tymingFlyPeriod, symmNetworkManagement=symmNetworkManagement, etcUpgrade=etcUpgrade, ntpSysLeap=ntpSysLeap, ntpSysProcessor=ntpSysProcessor, gpsPosition=gpsPosition, tymingVersion=tymingVersion, symmTimePictra=symmTimePictra, ts2000=ts2000, gpsMode=gpsMode, ntpSysRootDispersion=ntpSysRootDispersion, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, version=version, symmetricom=symmetricom, etc=etc)
