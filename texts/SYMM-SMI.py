...
iso, Integer32, TimeTicks, Counter64, ObjectIdentity, IpAddress, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, ModuleIdentity, Gauge32, Unsigned32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "TimeTicks", "Counter64", "ObjectIdentity", "IpAddress", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "ModuleIdentity", "Gauge32", "Unsigned32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", PYSNMP_MODULE_ID=symmetricom, ntpSysVersion=ntpSysVersion, ntpSysRootDelay=ntpSysRootDelay, tymingSource=tymingSource, ntpSysPhase=ntpSysPhase, ntpSysPrecision=ntpSysPrecision, tymingFlyPeriod=tymingFlyPeriod, ts2000=ts2000, etcUpgrade=etcUpgrade, version=version, tymingTime=tymingTime, symmTTM=symmTTM, symmBroadband=symmBroadband, gpsHealth=gpsHealth, symmetricom=symmetricom, etcVersion=etcVersion, ntpSystem=ntpSystem, tymingVersion=tymingVersion, symmTimePictra=symmTimePictra, etcUpgradeServer=etcUpgradeServer, experiment=experiment, syncserver=syncserver, gpsSatlist=gpsSatlist, ntpSysSystem=ntpSysSystem, products=products, net=net, etcModel=etcModel, ntpSysRefID=ntpSysRefID, ts2100=ts2100, xli=xli, ntpSysClock=ntpSysClock, gpsPosition=gpsPosition, ntpSysFreq=ntpSysFreq, gpsUTCOffset=gpsUTCOffset, gpsMode=gpsMode, etc=etc, symmSnmpManagement=symmSnmpManagement, ntpSysStratum=ntpSysStratum, ntpSysProcessor=ntpSysProcessor, symmCmipManagement=symmCmipManagement, etcAlarm=etcAlarm, ntpSysLeap=ntpSysLeap, gps=gps, ntpSysRefTime=ntpSysRefTime, ntpSysPoll=ntpSysPoll, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPeer=ntpSysPeer, nts=nts, tymingStatus=tymingStatus, dialup=dialup, ntpSysNotrust=ntpSysNotrust, symmNetworkManagement=symmNetworkManagement, etcSerialNbr=etcSerialNbr, ntpSysError=ntpSysError, s100=s100, etcAlarmString=etcAlarmString, ntpSysMode=ntpSysMode, ntpSysPktsReceived=ntpSysPktsReceived, tyming=tyming)
