...
NotificationType, Integer32, enterprises, iso, Counter32, Counter64, ModuleIdentity, Gauge32, ObjectIdentity, MibIdentifier, IpAddress, TimeTicks, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "enterprises", "iso", "Counter32", "Counter64", "ModuleIdentity", "Gauge32", "ObjectIdentity", "MibIdentifier", "IpAddress", "TimeTicks", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDispersion=ntpSysRootDispersion, products=products, syncserver=syncserver, ntpSysVersion=ntpSysVersion, tymingStatus=tymingStatus, tymingFlyPeriod=tymingFlyPeriod, tymingSource=tymingSource, xli=xli, ntpSysNotrust=ntpSysNotrust, ntpSysPeer=ntpSysPeer, PYSNMP_MODULE_ID=symmetricom, etc=etc, net=net, ntpSysSystem=ntpSysSystem, ntpSysRefTime=ntpSysRefTime, experiment=experiment, etcUpgrade=etcUpgrade, etcSerialNbr=etcSerialNbr, ntpSysLeap=ntpSysLeap, gpsUTCOffset=gpsUTCOffset, ntpSysPrecision=ntpSysPrecision, symmNetworkManagement=symmNetworkManagement, symmCmipManagement=symmCmipManagement, symmBroadband=symmBroadband, ntpSysPktsReceived=ntpSysPktsReceived, tyming=tyming, ntpSysRefID=ntpSysRefID, ntpSysPoll=ntpSysPoll, ntpSysClock=ntpSysClock, tymingVersion=tymingVersion, symmTTM=symmTTM, ntpSysProcessor=ntpSysProcessor, gpsSatlist=gpsSatlist, symmetricom=symmetricom, tymingTime=tymingTime, etcUpgradeServer=etcUpgradeServer, gpsHealth=gpsHealth, dialup=dialup, ntpSysError=ntpSysError, gpsMode=gpsMode, etcAlarmString=etcAlarmString, symmSnmpManagement=symmSnmpManagement, ntpSystem=ntpSystem, ts2100=ts2100, etcAlarm=etcAlarm, etcModel=etcModel, nts=nts, gpsPosition=gpsPosition, gps=gps, ts2000=ts2000, symmTimePictra=symmTimePictra, ntpSysStratum=ntpSysStratum, version=version, ntpSysFreq=ntpSysFreq, s100=s100, etcVersion=etcVersion, ntpSysRootDelay=ntpSysRootDelay, ntpSysMode=ntpSysMode, ntpSysPhase=ntpSysPhase)
