...
ObjectIdentity, Counter64, iso, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, Gauge32, ModuleIdentity, IpAddress, Unsigned32, Bits, Counter32, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "iso", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "Gauge32", "ModuleIdentity", "IpAddress", "Unsigned32", "Bits", "Counter32", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPrecision=ntpSysPrecision, ntpSysClock=ntpSysClock, symmTimePictra=symmTimePictra, xli=xli, etcAlarm=etcAlarm, s100=s100, ntpSysFreq=ntpSysFreq, ts2000=ts2000, gpsHealth=gpsHealth, ntpSysLeap=ntpSysLeap, gps=gps, version=version, etc=etc, products=products, ts2100=ts2100, ntpSysPoll=ntpSysPoll, ntpSysPeer=ntpSysPeer, ntpSysPhase=ntpSysPhase, net=net, etcVersion=etcVersion, ntpSysProcessor=ntpSysProcessor, ntpSysError=ntpSysError, etcUpgrade=etcUpgrade, gpsMode=gpsMode, symmTTM=symmTTM, tyming=tyming, ntpSysSystem=ntpSysSystem, etcUpgradeServer=etcUpgradeServer, etcAlarmString=etcAlarmString, symmCmipManagement=symmCmipManagement, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, nts=nts, ntpSysPktsReceived=ntpSysPktsReceived, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom, ntpSysRootDelay=ntpSysRootDelay, tymingTime=tymingTime, etcSerialNbr=etcSerialNbr, ntpSystem=ntpSystem, tymingStatus=tymingStatus, symmNetworkManagement=symmNetworkManagement, ntpSysVersion=ntpSysVersion, gpsSatlist=gpsSatlist, syncserver=syncserver, experiment=experiment, ntpSysMode=ntpSysMode, tymingVersion=tymingVersion, gpsUTCOffset=gpsUTCOffset, etcModel=etcModel, gpsPosition=gpsPosition, tymingSource=tymingSource, ntpSysRefID=ntpSysRefID, ntpSysStratum=ntpSysStratum, ntpSysNotrust=ntpSysNotrust, ntpSysRefTime=ntpSysRefTime, dialup=dialup, tymingFlyPeriod=tymingFlyPeriod, symmetricom=symmetricom)
