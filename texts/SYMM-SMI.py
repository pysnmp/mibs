...
ObjectIdentity, Counter64, Unsigned32, TimeTicks, MibIdentifier, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Gauge32, IpAddress, Counter32, enterprises, NotificationType, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Unsigned32", "TimeTicks", "MibIdentifier", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Gauge32", "IpAddress", "Counter32", "enterprises", "NotificationType", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysSystem=ntpSysSystem, etcModel=etcModel, tymingFlyPeriod=tymingFlyPeriod, PYSNMP_MODULE_ID=symmetricom, experiment=experiment, tymingSource=tymingSource, etcUpgrade=etcUpgrade, ntpSysFreq=ntpSysFreq, gpsMode=gpsMode, ntpSysRootDispersion=ntpSysRootDispersion, etcSerialNbr=etcSerialNbr, symmNetworkManagement=symmNetworkManagement, ntpSysVersion=ntpSysVersion, syncserver=syncserver, gpsUTCOffset=gpsUTCOffset, tymingTime=tymingTime, ntpSysPrecision=ntpSysPrecision, ntpSysRootDelay=ntpSysRootDelay, ntpSysPhase=ntpSysPhase, ntpSystem=ntpSystem, etcUpgradeServer=etcUpgradeServer, gpsSatlist=gpsSatlist, net=net, ntpSysRefTime=ntpSysRefTime, ntpSysClock=ntpSysClock, etcVersion=etcVersion, ts2100=ts2100, ntpSysPeer=ntpSysPeer, ntpSysProcessor=ntpSysProcessor, products=products, gpsHealth=gpsHealth, ntpSysLeap=ntpSysLeap, tyming=tyming, tymingStatus=tymingStatus, dialup=dialup, etcAlarmString=etcAlarmString, ts2000=ts2000, symmTTM=symmTTM, ntpSysPktsReceived=ntpSysPktsReceived, tymingVersion=tymingVersion, etcAlarm=etcAlarm, symmCmipManagement=symmCmipManagement, symmetricom=symmetricom, symmBroadband=symmBroadband, version=version, nts=nts, ntpSysError=ntpSysError, etc=etc, ntpSysMode=ntpSysMode, xli=xli, gpsPosition=gpsPosition, gps=gps, ntpSysPoll=ntpSysPoll, ntpSysRefID=ntpSysRefID, ntpSysStratum=ntpSysStratum, ntpSysNotrust=ntpSysNotrust, s100=s100, symmTimePictra=symmTimePictra, symmSnmpManagement=symmSnmpManagement)
