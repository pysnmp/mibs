...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, ObjectIdentity, Integer32, Unsigned32, Bits, MibIdentifier, Gauge32, Counter64, ModuleIdentity, IpAddress, NotificationType, NotificationType, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "ObjectIdentity", "Integer32", "Unsigned32", "Bits", "MibIdentifier", "Gauge32", "Counter64", "ModuleIdentity", "IpAddress", "NotificationType", "NotificationType", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSystem=ntpSystem, gpsSatlist=gpsSatlist, products=products, tymingStatus=tymingStatus, gpsHealth=gpsHealth, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, version=version, symmTTM=symmTTM, ntpSysRefTime=ntpSysRefTime, symmSnmpManagement=symmSnmpManagement, gpsPosition=gpsPosition, gps=gps, ntpSysClock=ntpSysClock, tymingSource=tymingSource, ntpSysFreq=ntpSysFreq, symmNetworkManagement=symmNetworkManagement, symmCmipManagement=symmCmipManagement, symmetricom=symmetricom, dialup=dialup, etc=etc, etcVersion=etcVersion, ntpSysStratum=ntpSysStratum, syncserver=syncserver, tymingVersion=tymingVersion, etcAlarm=etcAlarm, ntpSysPktsReceived=ntpSysPktsReceived, etcModel=etcModel, etcAlarmString=etcAlarmString, ntpSysLeap=ntpSysLeap, ts2100=ts2100, tymingFlyPeriod=tymingFlyPeriod, ntpSysPoll=ntpSysPoll, ntpSysPhase=ntpSysPhase, gpsUTCOffset=gpsUTCOffset, gpsMode=gpsMode, tymingTime=tymingTime, ntpSysProcessor=ntpSysProcessor, ntpSysMode=ntpSysMode, net=net, ntpSysNotrust=ntpSysNotrust, symmTimePictra=symmTimePictra, ntpSysRootDispersion=ntpSysRootDispersion, nts=nts, s100=s100, xli=xli, etcUpgradeServer=etcUpgradeServer, ntpSysPeer=ntpSysPeer, etcSerialNbr=etcSerialNbr, ntpSysRootDelay=ntpSysRootDelay, ntpSysSystem=ntpSysSystem, ntpSysPrecision=ntpSysPrecision, ntpSysRefID=ntpSysRefID, ntpSysError=ntpSysError, ts2000=ts2000, tyming=tyming, ntpSysVersion=ntpSysVersion, etcUpgrade=etcUpgrade, experiment=experiment)
