...
Bits, IpAddress, Counter64, ModuleIdentity, MibIdentifier, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, iso, ObjectIdentity, NotificationType, Counter32, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "Counter64", "ModuleIdentity", "MibIdentifier", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "iso", "ObjectIdentity", "NotificationType", "Counter32", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPhase=ntpSysPhase, ts2000=ts2000, tymingSource=tymingSource, etcUpgradeServer=etcUpgradeServer, ntpSysError=ntpSysError, symmTTM=symmTTM, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefID=ntpSysRefID, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysVersion=ntpSysVersion, xli=xli, etcModel=etcModel, etcAlarm=etcAlarm, experiment=experiment, tymingVersion=tymingVersion, gpsMode=gpsMode, ntpSysPeer=ntpSysPeer, ntpSysFreq=ntpSysFreq, ntpSysPrecision=ntpSysPrecision, symmSnmpManagement=symmSnmpManagement, nts=nts, products=products, gpsHealth=gpsHealth, gpsSatlist=gpsSatlist, symmNetworkManagement=symmNetworkManagement, ntpSystem=ntpSystem, ntpSysPoll=ntpSysPoll, ntpSysRootDelay=ntpSysRootDelay, etc=etc, etcVersion=etcVersion, net=net, tymingStatus=tymingStatus, ts2100=ts2100, symmetricom=symmetricom, ntpSysStratum=ntpSysStratum, etcUpgrade=etcUpgrade, ntpSysClock=ntpSysClock, ntpSysRefTime=ntpSysRefTime, tymingTime=tymingTime, ntpSysMode=ntpSysMode, tyming=tyming, syncserver=syncserver, PYSNMP_MODULE_ID=symmetricom, ntpSysNotrust=ntpSysNotrust, gpsPosition=gpsPosition, ntpSysLeap=ntpSysLeap, tymingFlyPeriod=tymingFlyPeriod, symmCmipManagement=symmCmipManagement, symmBroadband=symmBroadband, gpsUTCOffset=gpsUTCOffset, dialup=dialup, ntpSysProcessor=ntpSysProcessor, etcAlarmString=etcAlarmString, ntpSysSystem=ntpSysSystem, version=version, etcSerialNbr=etcSerialNbr, symmTimePictra=symmTimePictra, gps=gps, s100=s100)
