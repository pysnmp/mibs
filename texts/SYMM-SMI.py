...
enterprises, TimeTicks, Counter64, IpAddress, ObjectIdentity, Unsigned32, ModuleIdentity, Gauge32, Integer32, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Counter64", "IpAddress", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Gauge32", "Integer32", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSystem=ntpSystem, gpsSatlist=gpsSatlist, symmCmipManagement=symmCmipManagement, ntpSysStratum=ntpSysStratum, ntpSysVersion=ntpSysVersion, etcModel=etcModel, etcUpgradeServer=etcUpgradeServer, symmTTM=symmTTM, ntpSysRefTime=ntpSysRefTime, ntpSysPeer=ntpSysPeer, s100=s100, nts=nts, xli=xli, symmBroadband=symmBroadband, tymingStatus=tymingStatus, syncserver=syncserver, etcAlarm=etcAlarm, ntpSysRefID=ntpSysRefID, ntpSysLeap=ntpSysLeap, PYSNMP_MODULE_ID=symmetricom, gps=gps, tymingTime=tymingTime, gpsUTCOffset=gpsUTCOffset, symmTimePictra=symmTimePictra, ntpSysRootDelay=ntpSysRootDelay, ntpSysPrecision=ntpSysPrecision, ntpSysPoll=ntpSysPoll, tymingFlyPeriod=tymingFlyPeriod, gpsPosition=gpsPosition, etc=etc, ntpSysMode=ntpSysMode, etcSerialNbr=etcSerialNbr, ntpSysPhase=ntpSysPhase, symmSnmpManagement=symmSnmpManagement, etcAlarmString=etcAlarmString, symmNetworkManagement=symmNetworkManagement, products=products, net=net, experiment=experiment, ts2000=ts2000, ntpSysFreq=ntpSysFreq, ntpSysError=ntpSysError, etcUpgrade=etcUpgrade, gpsMode=gpsMode, ntpSysProcessor=ntpSysProcessor, tymingSource=tymingSource, dialup=dialup, tymingVersion=tymingVersion, ntpSysPktsReceived=ntpSysPktsReceived, gpsHealth=gpsHealth, etcVersion=etcVersion, tyming=tyming, version=version, ts2100=ts2100, symmetricom=symmetricom, ntpSysNotrust=ntpSysNotrust, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem)
