...
ModuleIdentity, Unsigned32, ObjectIdentity, Gauge32, Counter64, NotificationType, Counter32, NotificationType, IpAddress, iso, Bits, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "Gauge32", "Counter64", "NotificationType", "Counter32", "NotificationType", "IpAddress", "iso", "Bits", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", experiment=experiment, xli=xli, ntpSysPhase=ntpSysPhase, PYSNMP_MODULE_ID=symmetricom, nts=nts, tyming=tyming, ntpSysLeap=ntpSysLeap, ntpSysPoll=ntpSysPoll, ntpSysNotrust=ntpSysNotrust, symmetricom=symmetricom, tymingTime=tymingTime, net=net, ntpSystem=ntpSystem, gpsUTCOffset=gpsUTCOffset, ntpSysRootDispersion=ntpSysRootDispersion, symmCmipManagement=symmCmipManagement, ntpSysStratum=ntpSysStratum, ntpSysRefID=ntpSysRefID, etcAlarm=etcAlarm, symmTimePictra=symmTimePictra, tymingVersion=tymingVersion, etc=etc, gpsMode=gpsMode, ntpSysFreq=ntpSysFreq, gpsSatlist=gpsSatlist, ntpSysVersion=ntpSysVersion, ntpSysSystem=ntpSysSystem, symmSnmpManagement=symmSnmpManagement, symmTTM=symmTTM, products=products, ntpSysPrecision=ntpSysPrecision, ntpSysRefTime=ntpSysRefTime, ntpSysProcessor=ntpSysProcessor, tymingFlyPeriod=tymingFlyPeriod, gps=gps, s100=s100, tymingSource=tymingSource, etcUpgradeServer=etcUpgradeServer, ts2100=ts2100, etcUpgrade=etcUpgrade, syncserver=syncserver, ntpSysError=ntpSysError, etcAlarmString=etcAlarmString, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysMode=ntpSysMode, symmBroadband=symmBroadband, symmNetworkManagement=symmNetworkManagement, ntpSysClock=ntpSysClock, ntpSysPeer=ntpSysPeer, etcVersion=etcVersion, dialup=dialup, gpsPosition=gpsPosition, etcSerialNbr=etcSerialNbr, etcModel=etcModel, ntpSysRootDelay=ntpSysRootDelay, version=version, ts2000=ts2000, tymingStatus=tymingStatus, gpsHealth=gpsHealth)
