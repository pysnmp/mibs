...
MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, Gauge32, ModuleIdentity, Integer32, Bits, ObjectIdentity, iso, Counter32, IpAddress, MibIdentifier, Unsigned32, NotificationType, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "Gauge32", "ModuleIdentity", "Integer32", "Bits", "ObjectIdentity", "iso", "Counter32", "IpAddress", "MibIdentifier", "Unsigned32", "NotificationType", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("SYMM-SMI", gpsHealth=gpsHealth, etcAlarm=etcAlarm, symmTTM=symmTTM, version=version, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysClock=ntpSysClock, xli=xli, ntpSysStratum=ntpSysStratum, symmBroadband=symmBroadband, ts2100=ts2100, symmNetworkManagement=symmNetworkManagement, ntpSystem=ntpSystem, gpsPosition=gpsPosition, ntpSysPeer=ntpSysPeer, tyming=tyming, etcUpgrade=etcUpgrade, ntpSysError=ntpSysError, products=products, symmCmipManagement=symmCmipManagement, ntpSysProcessor=ntpSysProcessor, ntpSysMode=ntpSysMode, tymingStatus=tymingStatus, gpsSatlist=gpsSatlist, etcUpgradeServer=etcUpgradeServer, ntpSysRefID=ntpSysRefID, ntpSysRefTime=ntpSysRefTime, gps=gps, net=net, gpsMode=gpsMode, ntpSysSystem=ntpSysSystem, etcModel=etcModel, ts2000=ts2000, tymingSource=tymingSource, tymingVersion=tymingVersion, etc=etc, ntpSysRootDelay=ntpSysRootDelay, experiment=experiment, ntpSysPrecision=ntpSysPrecision, ntpSysVersion=ntpSysVersion, PYSNMP_MODULE_ID=symmetricom, tymingTime=tymingTime, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPhase=ntpSysPhase, ntpSysNotrust=ntpSysNotrust, symmSnmpManagement=symmSnmpManagement, nts=nts, dialup=dialup, etcSerialNbr=etcSerialNbr, gpsUTCOffset=gpsUTCOffset, ntpSysLeap=ntpSysLeap, ntpSysPoll=ntpSysPoll, s100=s100, symmTimePictra=symmTimePictra, syncserver=syncserver, ntpSysFreq=ntpSysFreq, etcAlarmString=etcAlarmString, symmetricom=symmetricom, etcVersion=etcVersion, tymingFlyPeriod=tymingFlyPeriod)
