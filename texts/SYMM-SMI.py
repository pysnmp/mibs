...
IpAddress, Counter64, Gauge32, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, NotificationType, TimeTicks, NotificationType, MibIdentifier, enterprises, iso, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Gauge32", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "NotificationType", "TimeTicks", "NotificationType", "MibIdentifier", "enterprises", "iso", "Counter32", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysPrecision=ntpSysPrecision, etc=etc, ntpSysClock=ntpSysClock, tymingStatus=tymingStatus, symmetricom=symmetricom, tymingFlyPeriod=tymingFlyPeriod, etcUpgrade=etcUpgrade, experiment=experiment, tymingVersion=tymingVersion, symmNetworkManagement=symmNetworkManagement, etcUpgradeServer=etcUpgradeServer, ts2000=ts2000, ntpSysRootDelay=ntpSysRootDelay, gpsHealth=gpsHealth, net=net, symmSnmpManagement=symmSnmpManagement, gpsSatlist=gpsSatlist, symmCmipManagement=symmCmipManagement, etcAlarmString=etcAlarmString, tymingSource=tymingSource, ntpSysPoll=ntpSysPoll, tyming=tyming, gpsMode=gpsMode, ntpSysSystem=ntpSysSystem, symmTTM=symmTTM, ntpSysPhase=ntpSysPhase, gps=gps, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, ntpSysError=ntpSysError, nts=nts, etcVersion=etcVersion, symmBroadband=symmBroadband, ntpSysLeap=ntpSysLeap, version=version, ntpSystem=ntpSystem, etcAlarm=etcAlarm, symmTimePictra=symmTimePictra, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPeer=ntpSysPeer, tymingTime=tymingTime, PYSNMP_MODULE_ID=symmetricom, ntpSysStratum=ntpSysStratum, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRefTime=ntpSysRefTime, xli=xli, gpsUTCOffset=gpsUTCOffset, products=products, ntpSysMode=ntpSysMode, etcModel=etcModel, gpsPosition=gpsPosition, ts2100=ts2100, ntpSysVersion=ntpSysVersion, etcSerialNbr=etcSerialNbr, ntpSysRefID=ntpSysRefID, syncserver=syncserver, s100=s100, dialup=dialup, ntpSysFreq=ntpSysFreq)
