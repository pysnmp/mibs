...
Integer32, Counter32, ModuleIdentity, enterprises, Bits, ObjectIdentity, Unsigned32, Gauge32, TimeTicks, IpAddress, MibIdentifier, iso, Counter64, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "ModuleIdentity", "enterprises", "Bits", "ObjectIdentity", "Unsigned32", "Gauge32", "TimeTicks", "IpAddress", "MibIdentifier", "iso", "Counter64", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDelay=ntpSysRootDelay, symmCmipManagement=symmCmipManagement, tymingSource=tymingSource, syncserver=syncserver, etcAlarmString=etcAlarmString, ntpSysSystem=ntpSysSystem, PYSNMP_MODULE_ID=symmetricom, symmTimePictra=symmTimePictra, gpsMode=gpsMode, ntpSysPhase=ntpSysPhase, symmSnmpManagement=symmSnmpManagement, experiment=experiment, tymingTime=tymingTime, etcVersion=etcVersion, gps=gps, tymingStatus=tymingStatus, etcAlarm=etcAlarm, ntpSysVersion=ntpSysVersion, ntpSysRefTime=ntpSysRefTime, ntpSysPoll=ntpSysPoll, xli=xli, ntpSysError=ntpSysError, etcSerialNbr=etcSerialNbr, dialup=dialup, ntpSysLeap=ntpSysLeap, ntpSysMode=ntpSysMode, symmTTM=symmTTM, net=net, ntpSysClock=ntpSysClock, etc=etc, tymingVersion=tymingVersion, s100=s100, ts2000=ts2000, gpsHealth=gpsHealth, etcModel=etcModel, ntpSysPrecision=ntpSysPrecision, ntpSysRootDispersion=ntpSysRootDispersion, etcUpgradeServer=etcUpgradeServer, ntpSysStratum=ntpSysStratum, etcUpgrade=etcUpgrade, ntpSysPktsReceived=ntpSysPktsReceived, symmetricom=symmetricom, ntpSysPeer=ntpSysPeer, ntpSysRefID=ntpSysRefID, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, ntpSystem=ntpSystem, symmBroadband=symmBroadband, products=products, ntpSysFreq=ntpSysFreq, gpsSatlist=gpsSatlist, symmNetworkManagement=symmNetworkManagement, gpsUTCOffset=gpsUTCOffset, tyming=tyming, tymingFlyPeriod=tymingFlyPeriod, gpsPosition=gpsPosition, ts2100=ts2100, nts=nts, version=version)
