...
Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, ModuleIdentity, NotificationType, IpAddress, Integer32, Gauge32, Counter32, Counter64, enterprises, iso, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "ModuleIdentity", "NotificationType", "IpAddress", "Integer32", "Gauge32", "Counter32", "Counter64", "enterprises", "iso", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysNotrust=ntpSysNotrust, symmTTM=symmTTM, ntpSystem=ntpSystem, ntpSysError=ntpSysError, symmTimePictra=symmTimePictra, etcSerialNbr=etcSerialNbr, etcUpgrade=etcUpgrade, ntpSysPeer=ntpSysPeer, ntpSysStratum=ntpSysStratum, ntpSysProcessor=ntpSysProcessor, s100=s100, tymingFlyPeriod=tymingFlyPeriod, ntpSysLeap=ntpSysLeap, tyming=tyming, nts=nts, gpsMode=gpsMode, gpsSatlist=gpsSatlist, gpsPosition=gpsPosition, etc=etc, symmBroadband=symmBroadband, products=products, net=net, ntpSysClock=ntpSysClock, ntpSysRootDelay=ntpSysRootDelay, syncserver=syncserver, symmSnmpManagement=symmSnmpManagement, ts2000=ts2000, tymingSource=tymingSource, ntpSysMode=ntpSysMode, symmetricom=symmetricom, ntpSysSystem=ntpSysSystem, gpsUTCOffset=gpsUTCOffset, dialup=dialup, gpsHealth=gpsHealth, version=version, etcUpgradeServer=etcUpgradeServer, symmCmipManagement=symmCmipManagement, tymingStatus=tymingStatus, gps=gps, tymingVersion=tymingVersion, etcModel=etcModel, ntpSysPhase=ntpSysPhase, ntpSysFreq=ntpSysFreq, etcVersion=etcVersion, ts2100=ts2100, symmNetworkManagement=symmNetworkManagement, ntpSysPoll=ntpSysPoll, etcAlarmString=etcAlarmString, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefTime=ntpSysRefTime, experiment=experiment, ntpSysVersion=ntpSysVersion, tymingTime=tymingTime, xli=xli, etcAlarm=etcAlarm, ntpSysRefID=ntpSysRefID, ntpSysPrecision=ntpSysPrecision, ntpSysPktsReceived=ntpSysPktsReceived, PYSNMP_MODULE_ID=symmetricom)
