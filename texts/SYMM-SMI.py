...
Gauge32, ObjectIdentity, IpAddress, NotificationType, TimeTicks, Unsigned32, iso, MibIdentifier, enterprises, Bits, ModuleIdentity, Counter32, Counter64, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "IpAddress", "NotificationType", "TimeTicks", "Unsigned32", "iso", "MibIdentifier", "enterprises", "Bits", "ModuleIdentity", "Counter32", "Counter64", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", symmBroadband=symmBroadband, symmCmipManagement=symmCmipManagement, gpsPosition=gpsPosition, etcVersion=etcVersion, xli=xli, etcSerialNbr=etcSerialNbr, symmetricom=symmetricom, symmSnmpManagement=symmSnmpManagement, version=version, PYSNMP_MODULE_ID=symmetricom, ts2100=ts2100, syncserver=syncserver, symmTimePictra=symmTimePictra, etcUpgradeServer=etcUpgradeServer, tymingStatus=tymingStatus, ntpSysNotrust=ntpSysNotrust, tymingTime=tymingTime, ts2000=ts2000, symmNetworkManagement=symmNetworkManagement, ntpSysError=ntpSysError, ntpSysVersion=ntpSysVersion, gpsHealth=gpsHealth, ntpSysRefID=ntpSysRefID, tymingFlyPeriod=tymingFlyPeriod, ntpSystem=ntpSystem, nts=nts, ntpSysFreq=ntpSysFreq, tymingSource=tymingSource, ntpSysRefTime=ntpSysRefTime, net=net, ntpSysPrecision=ntpSysPrecision, etcUpgrade=etcUpgrade, ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem, ntpSysRootDelay=ntpSysRootDelay, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysPktsReceived=ntpSysPktsReceived, etcModel=etcModel, gpsSatlist=gpsSatlist, ntpSysPhase=ntpSysPhase, products=products, ntpSysProcessor=ntpSysProcessor, ntpSysLeap=ntpSysLeap, etcAlarmString=etcAlarmString, ntpSysPoll=ntpSysPoll, symmTTM=symmTTM, ntpSysStratum=ntpSysStratum, tymingVersion=tymingVersion, gpsMode=gpsMode, ntpSysPeer=ntpSysPeer, etcAlarm=etcAlarm, dialup=dialup, experiment=experiment, gps=gps, ntpSysMode=ntpSysMode, gpsUTCOffset=gpsUTCOffset, etc=etc, s100=s100, tyming=tyming)
