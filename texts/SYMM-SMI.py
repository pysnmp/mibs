...
mibBuilder.exportSymbols("SYMM-SMI", version=version, ntpSysPeer=ntpSysPeer, ntpSysLeap=ntpSysLeap, ntpSysClock=ntpSysClock, products=products, ntpSysMode=ntpSysMode, ntpSysError=ntpSysError, gpsHealth=gpsHealth, xli=xli, nts=nts, ntpSysRootDispersion=ntpSysRootDispersion, symmTTM=symmTTM, dialup=dialup, symmTimePictra=symmTimePictra, tyming=tyming, ntpSysRefID=ntpSysRefID, tymingVersion=tymingVersion, tymingTime=tymingTime, etcAlarmString=etcAlarmString, etc=etc, tymingFlyPeriod=tymingFlyPeriod, ntpSysVersion=ntpSysVersion, ntpSysRootDelay=ntpSysRootDelay, ntpSystem=ntpSystem, PYSNMP_MODULE_ID=symmetricom, tymingStatus=tymingStatus, etcSerialNbr=etcSerialNbr, ts2100=ts2100, ntpSysPrecision=ntpSysPrecision, ntpSysPktsReceived=ntpSysPktsReceived, s100=s100, ts2000=ts2000, tymingSource=tymingSource, etcUpgrade=etcUpgrade, ntpSysFreq=ntpSysFreq, gpsUTCOffset=gpsUTCOffset, ntpSysRefTime=ntpSysRefTime, gpsMode=gpsMode, symmCmipManagement=symmCmipManagement, symmSnmpManagement=symmSnmpManagement, syncserver=syncserver, ntpSysSystem=ntpSysSystem, symmBroadband=symmBroadband, etcModel=etcModel, ntpSysPoll=ntpSysPoll, ntpSysNotrust=ntpSysNotrust, ntpSysPhase=ntpSysPhase, experiment=experiment, gpsPosition=gpsPosition, symmetricom=symmetricom, symmNetworkManagement=symmNetworkManagement, gps=gps, etcVersion=etcVersion, etcUpgradeServer=etcUpgradeServer, net=net, ntpSysProcessor=ntpSysProcessor, etcAlarm=etcAlarm, gpsSatlist=gpsSatlist, ntpSysStratum=ntpSysStratum)
