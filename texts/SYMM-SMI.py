...
Bits, ModuleIdentity, Gauge32, Unsigned32, TimeTicks, MibIdentifier, Counter32, iso, Integer32, Counter64, ObjectIdentity, NotificationType, enterprises, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Gauge32", "Unsigned32", "TimeTicks", "MibIdentifier", "Counter32", "iso", "Integer32", "Counter64", "ObjectIdentity", "NotificationType", "enterprises", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefTime=ntpSysRefTime, gpsUTCOffset=gpsUTCOffset, ntpSystem=ntpSystem, symmCmipManagement=symmCmipManagement, syncserver=syncserver, ntpSysPrecision=ntpSysPrecision, ntpSysError=ntpSysError, ntpSysRefID=ntpSysRefID, ntpSysMode=ntpSysMode, PYSNMP_MODULE_ID=symmetricom, gpsMode=gpsMode, symmBroadband=symmBroadband, ntpSysProcessor=ntpSysProcessor, ts2100=ts2100, etcUpgradeServer=etcUpgradeServer, ntpSysNotrust=ntpSysNotrust, experiment=experiment, symmSnmpManagement=symmSnmpManagement, ntpSysFreq=ntpSysFreq, etcSerialNbr=etcSerialNbr, tyming=tyming, gpsPosition=gpsPosition, version=version, etc=etc, tymingSource=tymingSource, gpsHealth=gpsHealth, gps=gps, ntpSysRootDelay=ntpSysRootDelay, etcUpgrade=etcUpgrade, net=net, ntpSysPeer=ntpSysPeer, ntpSysSystem=ntpSysSystem, nts=nts, etcAlarm=etcAlarm, etcVersion=etcVersion, products=products, symmNetworkManagement=symmNetworkManagement, ntpSysPoll=ntpSysPoll, etcModel=etcModel, tymingVersion=tymingVersion, ts2000=ts2000, dialup=dialup, symmetricom=symmetricom, ntpSysVersion=ntpSysVersion, ntpSysLeap=ntpSysLeap, symmTimePictra=symmTimePictra, ntpSysStratum=ntpSysStratum, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysClock=ntpSysClock, etcAlarmString=etcAlarmString, symmTTM=symmTTM, s100=s100, tymingTime=tymingTime, gpsSatlist=gpsSatlist, tymingStatus=tymingStatus, ntpSysPhase=ntpSysPhase, xli=xli, tymingFlyPeriod=tymingFlyPeriod, ntpSysPktsReceived=ntpSysPktsReceived)
