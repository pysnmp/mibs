...
Gauge32, ModuleIdentity, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, ObjectIdentity, Counter64, Integer32, Unsigned32, MibIdentifier, Bits, iso, TimeTicks, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "ObjectIdentity", "Counter64", "Integer32", "Unsigned32", "MibIdentifier", "Bits", "iso", "TimeTicks", "enterprises")
...
mibBuilder.exportSymbols("SYMM-SMI", net=net, ntpSysPoll=ntpSysPoll, ntpSysFreq=ntpSysFreq, ntpSysNotrust=ntpSysNotrust, gpsHealth=gpsHealth, ntpSysStratum=ntpSysStratum, syncserver=syncserver, etcVersion=etcVersion, symmNetworkManagement=symmNetworkManagement, tymingTime=tymingTime, ntpSysPrecision=ntpSysPrecision, ntpSysRootDelay=ntpSysRootDelay, ntpSysPeer=ntpSysPeer, gpsSatlist=gpsSatlist, xli=xli, ntpSysError=ntpSysError, products=products, ntpSysClock=ntpSysClock, tymingStatus=tymingStatus, ntpSysPhase=ntpSysPhase, ntpSysProcessor=ntpSysProcessor, ntpSysVersion=ntpSysVersion, etcAlarmString=etcAlarmString, symmTTM=symmTTM, tyming=tyming, gpsMode=gpsMode, symmetricom=symmetricom, ts2000=ts2000, ntpSysRefTime=ntpSysRefTime, ntpSystem=ntpSystem, ntpSysSystem=ntpSysSystem, ntpSysPktsReceived=ntpSysPktsReceived, etcSerialNbr=etcSerialNbr, symmTimePictra=symmTimePictra, experiment=experiment, ts2100=ts2100, ntpSysRootDispersion=ntpSysRootDispersion, symmSnmpManagement=symmSnmpManagement, gps=gps, tymingSource=tymingSource, symmBroadband=symmBroadband, nts=nts, symmCmipManagement=symmCmipManagement, gpsUTCOffset=gpsUTCOffset, etcAlarm=etcAlarm, etcModel=etcModel, dialup=dialup, s100=s100, ntpSysLeap=ntpSysLeap, ntpSysRefID=ntpSysRefID, etc=etc, PYSNMP_MODULE_ID=symmetricom, etcUpgrade=etcUpgrade, ntpSysMode=ntpSysMode, version=version, gpsPosition=gpsPosition, tymingFlyPeriod=tymingFlyPeriod, etcUpgradeServer=etcUpgradeServer, tymingVersion=tymingVersion)
