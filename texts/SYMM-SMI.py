...
Integer32, ObjectIdentity, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, MibIdentifier, enterprises, Bits, TimeTicks, Gauge32, Counter32, Counter64, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "MibIdentifier", "enterprises", "Bits", "TimeTicks", "Gauge32", "Counter32", "Counter64", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", products=products, etcSerialNbr=etcSerialNbr, tyming=tyming, symmBroadband=symmBroadband, tymingSource=tymingSource, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysError=ntpSysError, ntpSysNotrust=ntpSysNotrust, etcAlarm=etcAlarm, s100=s100, ntpSysProcessor=ntpSysProcessor, ts2000=ts2000, ntpSysPktsReceived=ntpSysPktsReceived, tymingVersion=tymingVersion, ntpSysFreq=ntpSysFreq, ntpSysRefTime=ntpSysRefTime, PYSNMP_MODULE_ID=symmetricom, ntpSysStratum=ntpSysStratum, gpsPosition=gpsPosition, version=version, nts=nts, gpsUTCOffset=gpsUTCOffset, ntpSysPhase=ntpSysPhase, gpsSatlist=gpsSatlist, ntpSysRefID=ntpSysRefID, experiment=experiment, symmCmipManagement=symmCmipManagement, ntpSysSystem=ntpSysSystem, tymingStatus=tymingStatus, etc=etc, gpsHealth=gpsHealth, gpsMode=gpsMode, etcUpgradeServer=etcUpgradeServer, ts2100=ts2100, symmTimePictra=symmTimePictra, symmetricom=symmetricom, xli=xli, etcAlarmString=etcAlarmString, ntpSysClock=ntpSysClock, ntpSysPoll=ntpSysPoll, symmSnmpManagement=symmSnmpManagement, etcUpgrade=etcUpgrade, ntpSysPrecision=ntpSysPrecision, ntpSysMode=ntpSysMode, gps=gps, syncserver=syncserver, symmNetworkManagement=symmNetworkManagement, net=net, ntpSysPeer=ntpSysPeer, tymingFlyPeriod=tymingFlyPeriod, tymingTime=tymingTime, etcVersion=etcVersion, ntpSysVersion=ntpSysVersion, ntpSysRootDelay=ntpSysRootDelay, ntpSystem=ntpSystem, etcModel=etcModel, dialup=dialup, ntpSysLeap=ntpSysLeap, symmTTM=symmTTM)
