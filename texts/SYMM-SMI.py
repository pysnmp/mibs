...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, enterprises, Counter32, iso, Unsigned32, NotificationType, ObjectIdentity, Bits, ModuleIdentity, NotificationType, Counter64, TimeTicks, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "enterprises", "Counter32", "iso", "Unsigned32", "NotificationType", "ObjectIdentity", "Bits", "ModuleIdentity", "NotificationType", "Counter64", "TimeTicks", "MibIdentifier", "Gauge32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRootDelay=ntpSysRootDelay, gpsUTCOffset=gpsUTCOffset, ntpSystem=ntpSystem, ntpSysPeer=ntpSysPeer, ts2000=ts2000, tymingVersion=tymingVersion, etcUpgrade=etcUpgrade, gpsMode=gpsMode, etcUpgradeServer=etcUpgradeServer, tymingFlyPeriod=tymingFlyPeriod, nts=nts, gpsSatlist=gpsSatlist, ntpSysProcessor=ntpSysProcessor, ntpSysStratum=ntpSysStratum, symmSnmpManagement=symmSnmpManagement, ntpSysSystem=ntpSysSystem, gpsHealth=gpsHealth, dialup=dialup, gpsPosition=gpsPosition, PYSNMP_MODULE_ID=symmetricom, symmBroadband=symmBroadband, ntpSysVersion=ntpSysVersion, etcSerialNbr=etcSerialNbr, experiment=experiment, etcAlarm=etcAlarm, ntpSysError=ntpSysError, tymingStatus=tymingStatus, net=net, ntpSysPktsReceived=ntpSysPktsReceived, symmetricom=symmetricom, s100=s100, ntpSysMode=ntpSysMode, ntpSysPhase=ntpSysPhase, tymingTime=tymingTime, ntpSysLeap=ntpSysLeap, ntpSysNotrust=ntpSysNotrust, symmTTM=symmTTM, syncserver=syncserver, ts2100=ts2100, ntpSysFreq=ntpSysFreq, etcVersion=etcVersion, symmTimePictra=symmTimePictra, gps=gps, etc=etc, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysRefTime=ntpSysRefTime, etcAlarmString=etcAlarmString, ntpSysRefID=ntpSysRefID, ntpSysPoll=ntpSysPoll, ntpSysPrecision=ntpSysPrecision, tyming=tyming, symmNetworkManagement=symmNetworkManagement, version=version, ntpSysClock=ntpSysClock, products=products, etcModel=etcModel, tymingSource=tymingSource, symmCmipManagement=symmCmipManagement, xli=xli)
