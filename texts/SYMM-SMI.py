...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Integer32, Counter32, NotificationType, IpAddress, Bits, MibIdentifier, Gauge32, Unsigned32, TimeTicks, iso, ModuleIdentity, Counter64, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Integer32", "Counter32", "NotificationType", "IpAddress", "Bits", "MibIdentifier", "Gauge32", "Unsigned32", "TimeTicks", "iso", "ModuleIdentity", "Counter64", "NotificationType")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSystem=ntpSystem, symmCmipManagement=symmCmipManagement, gps=gps, gpsSatlist=gpsSatlist, products=products, tymingStatus=tymingStatus, ntpSysFreq=ntpSysFreq, ntpSysPeer=ntpSysPeer, etcModel=etcModel, ntpSysStratum=ntpSysStratum, symmetricom=symmetricom, tymingTime=tymingTime, ntpSysMode=ntpSysMode, gpsUTCOffset=gpsUTCOffset, etc=etc, ntpSysSystem=ntpSysSystem, xli=xli, symmSnmpManagement=symmSnmpManagement, version=version, etcUpgrade=etcUpgrade, etcAlarmString=etcAlarmString, tyming=tyming, etcAlarm=etcAlarm, ntpSysProcessor=ntpSysProcessor, ntpSysNotrust=ntpSysNotrust, etcVersion=etcVersion, experiment=experiment, ntpSysPhase=ntpSysPhase, syncserver=syncserver, symmTimePictra=symmTimePictra, ntpSysError=ntpSysError, tymingVersion=tymingVersion, gpsPosition=gpsPosition, symmBroadband=symmBroadband, ts2000=ts2000, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysClock=ntpSysClock, etcUpgradeServer=etcUpgradeServer, ntpSysVersion=ntpSysVersion, gpsMode=gpsMode, gpsHealth=gpsHealth, ntpSysPktsReceived=ntpSysPktsReceived, ntpSysRefID=ntpSysRefID, ntpSysPrecision=ntpSysPrecision, net=net, ntpSysPoll=ntpSysPoll, tymingSource=tymingSource, nts=nts, tymingFlyPeriod=tymingFlyPeriod, etcSerialNbr=etcSerialNbr, s100=s100, dialup=dialup, ntpSysLeap=ntpSysLeap, ntpSysRootDelay=ntpSysRootDelay, PYSNMP_MODULE_ID=symmetricom, symmNetworkManagement=symmNetworkManagement, ntpSysRefTime=ntpSysRefTime, symmTTM=symmTTM, ts2100=ts2100)
