...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, ObjectIdentity, Unsigned32, NotificationType, TimeTicks, IpAddress, iso, Gauge32, Counter32, enterprises, Integer32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "NotificationType", "TimeTicks", "IpAddress", "iso", "Gauge32", "Counter32", "enterprises", "Integer32", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("SYMM-SMI", experiment=experiment, symmTTM=symmTTM, ntpSysPeer=ntpSysPeer, gpsMode=gpsMode, tyming=tyming, tymingFlyPeriod=tymingFlyPeriod, ntpSysFreq=ntpSysFreq, symmSnmpManagement=symmSnmpManagement, etcModel=etcModel, products=products, symmTimePictra=symmTimePictra, gpsUTCOffset=gpsUTCOffset, dialup=dialup, ntpSysRefTime=ntpSysRefTime, ntpSysPktsReceived=ntpSysPktsReceived, symmCmipManagement=symmCmipManagement, ntpSysProcessor=ntpSysProcessor, xli=xli, etcUpgrade=etcUpgrade, ts2100=ts2100, ntpSysLeap=ntpSysLeap, tymingVersion=tymingVersion, gpsPosition=gpsPosition, symmBroadband=symmBroadband, PYSNMP_MODULE_ID=symmetricom, etcVersion=etcVersion, tymingTime=tymingTime, etcAlarmString=etcAlarmString, symmNetworkManagement=symmNetworkManagement, ntpSysClock=ntpSysClock, ntpSysNotrust=ntpSysNotrust, gpsSatlist=gpsSatlist, ntpSysRefID=ntpSysRefID, gps=gps, ntpSysMode=ntpSysMode, symmetricom=symmetricom, ntpSysVersion=ntpSysVersion, gpsHealth=gpsHealth, version=version, etcSerialNbr=etcSerialNbr, net=net, ntpSysPhase=ntpSysPhase, ntpSysSystem=ntpSysSystem, tymingSource=tymingSource, ntpSystem=ntpSystem, ntpSysStratum=ntpSysStratum, ntpSysPoll=ntpSysPoll, ntpSysPrecision=ntpSysPrecision, syncserver=syncserver, ntpSysError=ntpSysError, etcAlarm=etcAlarm, etc=etc, ts2000=ts2000, ntpSysRootDelay=ntpSysRootDelay, ntpSysRootDispersion=ntpSysRootDispersion, etcUpgradeServer=etcUpgradeServer, s100=s100, nts=nts, tymingStatus=tymingStatus)
