...
ModuleIdentity, Bits, NotificationType, Counter32, Counter64, NotificationType, MibIdentifier, ObjectIdentity, TimeTicks, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "NotificationType", "Counter32", "Counter64", "NotificationType", "MibIdentifier", "ObjectIdentity", "TimeTicks", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Integer32", "iso")
...
mibBuilder.exportSymbols("SYMM-SMI", etcAlarm=etcAlarm, ntpSysRootDelay=ntpSysRootDelay, symmetricom=symmetricom, ntpSysRefID=ntpSysRefID, gpsUTCOffset=gpsUTCOffset, nts=nts, symmBroadband=symmBroadband, ntpSysRefTime=ntpSysRefTime, gpsPosition=gpsPosition, ntpSysPrecision=ntpSysPrecision, gpsHealth=gpsHealth, etcSerialNbr=etcSerialNbr, etc=etc, net=net, products=products, xli=xli, ts2100=ts2100, ntpSysVersion=ntpSysVersion, ntpSysStratum=ntpSysStratum, gps=gps, symmSnmpManagement=symmSnmpManagement, symmTTM=symmTTM, etcVersion=etcVersion, ntpSysMode=ntpSysMode, etcUpgradeServer=etcUpgradeServer, symmNetworkManagement=symmNetworkManagement, ntpSysError=ntpSysError, ntpSysPhase=ntpSysPhase, ntpSysPeer=ntpSysPeer, ntpSysSystem=ntpSysSystem, dialup=dialup, tymingSource=tymingSource, ntpSysClock=ntpSysClock, ntpSysLeap=ntpSysLeap, ntpSysRootDispersion=ntpSysRootDispersion, ntpSysFreq=ntpSysFreq, etcUpgrade=etcUpgrade, ntpSysPoll=ntpSysPoll, tymingFlyPeriod=tymingFlyPeriod, etcAlarmString=etcAlarmString, symmCmipManagement=symmCmipManagement, ntpSysNotrust=ntpSysNotrust, ntpSysPktsReceived=ntpSysPktsReceived, ntpSystem=ntpSystem, experiment=experiment, ntpSysProcessor=ntpSysProcessor, tymingStatus=tymingStatus, tymingVersion=tymingVersion, PYSNMP_MODULE_ID=symmetricom, s100=s100, gpsSatlist=gpsSatlist, tyming=tyming, syncserver=syncserver, tymingTime=tymingTime, ts2000=ts2000, symmTimePictra=symmTimePictra, gpsMode=gpsMode, etcModel=etcModel, version=version)
