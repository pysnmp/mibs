...
NotificationType, ObjectIdentity, NotificationType, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Bits, Counter64, Gauge32, enterprises, Unsigned32, IpAddress, TimeTicks, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "NotificationType", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Bits", "Counter64", "Gauge32", "enterprises", "Unsigned32", "IpAddress", "TimeTicks", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefID=ntpSysRefID, ntpSystem=ntpSystem, products=products, symmTTM=symmTTM, symmCmipManagement=symmCmipManagement, ntpSysMode=ntpSysMode, tymingFlyPeriod=tymingFlyPeriod, tyming=tyming, ntpSysPoll=ntpSysPoll, symmSnmpManagement=symmSnmpManagement, etcUpgradeServer=etcUpgradeServer, experiment=experiment, ts2100=ts2100, version=version, ntpSysVersion=ntpSysVersion, nts=nts, gpsPosition=gpsPosition, symmTimePictra=symmTimePictra, ntpSysRefTime=ntpSysRefTime, syncserver=syncserver, ntpSysFreq=ntpSysFreq, ntpSysRootDelay=ntpSysRootDelay, ntpSysLeap=ntpSysLeap, ntpSysProcessor=ntpSysProcessor, symmetricom=symmetricom, ntpSysClock=ntpSysClock, ntpSysSystem=ntpSysSystem, etcAlarmString=etcAlarmString, ntpSysRootDispersion=ntpSysRootDispersion, gpsMode=gpsMode, s100=s100, xli=xli, net=net, ntpSysPeer=ntpSysPeer, gpsHealth=gpsHealth, ntpSysPhase=ntpSysPhase, symmNetworkManagement=symmNetworkManagement, etc=etc, ntpSysError=ntpSysError, etcSerialNbr=etcSerialNbr, tymingTime=tymingTime, tymingStatus=tymingStatus, ntpSysStratum=ntpSysStratum, ntpSysPktsReceived=ntpSysPktsReceived, ts2000=ts2000, etcModel=etcModel, ntpSysPrecision=ntpSysPrecision, gpsSatlist=gpsSatlist, tymingSource=tymingSource, symmBroadband=symmBroadband, tymingVersion=tymingVersion, etcVersion=etcVersion, etcUpgrade=etcUpgrade, ntpSysNotrust=ntpSysNotrust, dialup=dialup, etcAlarm=etcAlarm, PYSNMP_MODULE_ID=symmetricom, gpsUTCOffset=gpsUTCOffset, gps=gps)
