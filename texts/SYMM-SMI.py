...
enterprises, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, NotificationType, IpAddress, TimeTicks, iso, MibIdentifier, Integer32, ModuleIdentity, Bits, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "NotificationType", "IpAddress", "TimeTicks", "iso", "MibIdentifier", "Integer32", "ModuleIdentity", "Bits", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("SYMM-SMI", ntpSysRefTime=ntpSysRefTime, symmNetworkManagement=symmNetworkManagement, etc=etc, ntpSysPktsReceived=ntpSysPktsReceived, etcUpgradeServer=etcUpgradeServer, symmetricom=symmetricom, tymingVersion=tymingVersion, ts2100=ts2100, experiment=experiment, gpsPosition=gpsPosition, ntpSysPoll=ntpSysPoll, etcAlarm=etcAlarm, nts=nts, ntpSysSystem=ntpSysSystem, symmTimePictra=symmTimePictra, symmBroadband=symmBroadband, tymingStatus=tymingStatus, ntpSysProcessor=ntpSysProcessor, gpsMode=gpsMode, ntpSysVersion=ntpSysVersion, etcAlarmString=etcAlarmString, ts2000=ts2000, ntpSysPeer=ntpSysPeer, syncserver=syncserver, tyming=tyming, products=products, gpsSatlist=gpsSatlist, gpsHealth=gpsHealth, xli=xli, ntpSysFreq=ntpSysFreq, etcModel=etcModel, PYSNMP_MODULE_ID=symmetricom, gpsUTCOffset=gpsUTCOffset, ntpSysError=ntpSysError, gps=gps, ntpSysLeap=ntpSysLeap, ntpSysClock=ntpSysClock, ntpSysRootDelay=ntpSysRootDelay, tymingTime=tymingTime, tymingFlyPeriod=tymingFlyPeriod, version=version, ntpSysStratum=ntpSysStratum, etcUpgrade=etcUpgrade, ntpSysRefID=ntpSysRefID, ntpSystem=ntpSystem, ntpSysPrecision=ntpSysPrecision, symmSnmpManagement=symmSnmpManagement, net=net, etcVersion=etcVersion, s100=s100, symmTTM=symmTTM, dialup=dialup, ntpSysMode=ntpSysMode, etcSerialNbr=etcSerialNbr, tymingSource=tymingSource, ntpSysRootDispersion=ntpSysRootDispersion, symmCmipManagement=symmCmipManagement, ntpSysPhase=ntpSysPhase, ntpSysNotrust=ntpSysNotrust)
