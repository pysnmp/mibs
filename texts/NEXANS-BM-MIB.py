...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpEvent=sfpEvent, portNewMacAddress=portNewMacAddress, infoUnauthIpAddr=infoUnauthIpAddr, radiusMgmtAuthReject=radiusMgmtAuthReject, portPoePower=portPoePower, infoType=infoType, adminAlarmM2=adminAlarmM2, sfpInfoLength62um=sfpInfoLength62um, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoPowerVoltage2500=infoPowerVoltage2500, portLoopBcastFailure=portLoopBcastFailure, switchMgmtAuthFailure=switchMgmtAuthFailure, switchPoeOverloadFailure=switchPoeOverloadFailure, adminFunctionInputNameF1=adminFunctionInputNameF1, portDefaultPrioQueue=portDefaultPrioQueue, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpDiagTemperature=sfpDiagTemperature, switchInternalVoltageFailure=switchInternalVoltageFailure, infoAlarmStateM1=infoAlarmStateM1, internalMgmtWarning=internalMgmtWarning, portSecurityMacAddr1=portSecurityMacAddr1, adminAgentIpAddress=adminAgentIpAddress, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portAcApSetup=portAcApSetup, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, bmTraps=bmTraps, switchTemperatureFailure=switchTemperatureFailure, radiusPortSecurityReject=radiusPortSecurityReject, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, vlanDescr=vlanDescr, sfpInfoVendorName=sfpInfoVendorName, portErrorCounter=portErrorCounter, adminSwitchPortMirror=adminSwitchPortMirror, portPrioDot1p=portPrioDot1p, bmSwitchVlanEntry=bmSwitchVlanEntry, adminAgentNetmask=adminAgentNetmask, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminUnsecureVlanId=adminUnsecureVlanId, adminAlarmM1=adminAlarmM1, portSecurityMacAddr2=portSecurityMacAddr2, infoNoOfPorts=infoNoOfPorts, portPoeVoltage=portPoeVoltage, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portAdminState=portAdminState, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portDescr=portDescr, portTrunkingMode=portTrunkingMode, portPoeAdminState=portPoeAdminState, portPrioIp=portPrioIp, infoProductNo=infoProductNo, portSpeedDuplexSetup=portSpeedDuplexSetup, infoTemperature=infoTemperature, sfpInfoConnectorDescr=sfpInfoConnectorDescr, tftpMessage=tftpMessage, portBandwidthLimitRxd=portBandwidthLimitRxd, switchPoeVoltageFailure=switchPoeVoltageFailure, adminSwitchVlanTableMode=adminSwitchVlanTableMode, sfpDiagTxOutputPower=sfpDiagTxOutputPower, clientRemoved=clientRemoved, portName=portName, portBandwidthLimitTxd=portBandwidthLimitTxd, adminAgentPhysAddress=adminAgentPhysAddress, adminMgmtAccessList=adminMgmtAccessList, infoPowerVoltage3300=infoPowerVoltage3300, portDefaultVlanId=portDefaultVlanId, bmSwitchSfpEntry=bmSwitchSfpEntry, portSecurityFailure=portSecurityFailure, bmSwitchPortTable=bmSwitchPortTable, infoSeriesNo=infoSeriesNo, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, vlanIndex=vlanIndex, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminLedGlobalMode=adminLedGlobalMode, sfpState=sfpState, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoNewMacAddr=infoNewMacAddr, bmSwitchInfo=bmSwitchInfo, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portLinkState=portLinkState, bmSwitchVlan=bmSwitchVlan, infoLastTftpMessage=infoLastTftpMessage, bmSwitchSfpTable=bmSwitchSfpTable, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpPortIndex=sfpPortIndex, portPoePowerLimit=portPoePowerLimit, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAlarmNameM1=adminAlarmNameM1, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portLinkChange=portLinkChange, infoNoOfReboots=infoNoOfReboots, portSecurityAdminState=portSecurityAdminState, adminAlarmNameM2=adminAlarmNameM2, portIndex=portIndex, adminSnmpMacTableMode=adminSnmpMacTableMode, sfpInfoSerialNumber=sfpInfoSerialNumber, portPoeOverloadFailure=portPoeOverloadFailure, infoPoeInputPower=infoPoeInputPower, adminAgentDhcp=adminAgentDhcp, adminAgentVlanId=adminAgentVlanId, adminAgentPrioValue=adminAgentPrioValue, bmSwitchPort=bmSwitchPort, adminReset=adminReset, bmSwitchAdmin=bmSwitchAdmin, infoSerie=infoSerie, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoTotalConfigChanges=infoTotalConfigChanges, adminTftpAccess=adminTftpAccess, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, switchConfigurationChanged=switchConfigurationChanged, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, switchFunctionInputAlarm=switchFunctionInputAlarm, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpInfoWavelength=sfpInfoWavelength, portSecurityMacAddr3=portSecurityMacAddr3, bmSwitchMIB=bmSwitchMIB, adminMemoryCardMode=adminMemoryCardMode, infoPoeInputVoltage=infoPoeInputVoltage, sfpInfoDateCode=sfpInfoDateCode, sfpInfoLength9um=sfpInfoLength9um, PYSNMP_MODULE_ID=bmSwitchMIB, sfpInfoBitRate=sfpInfoBitRate, portRemoteFault=portRemoteFault, infoManufactureDate=infoManufactureDate, portVoiceVlanId=portVoiceVlanId, sfpInfoLength50um=sfpInfoLength50um, portLinkType=portLinkType, infoFunctionInputStateF1=infoFunctionInputStateF1, bmSwitchPortEntry=bmSwitchPortEntry, bmSwitchVlanTable=bmSwitchVlanTable, infoDescr=infoDescr, portErrorCountFailure=portErrorCountFailure, portErrorDisabled=portErrorDisabled, portPoeCurrent=portPoeCurrent, sfpInfoPartNumber=sfpInfoPartNumber, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portLimiterPacketType=portLimiterPacketType, portLEDYellow=portLEDYellow, portSecurityForwardingState=portSecurityForwardingState, infoLastSfpEventMessage=infoLastSfpEventMessage, portLEDGreen=portLEDGreen, vlanId=vlanId, infoAlarmStateM2=infoAlarmStateM2, bmSwitchSfp=bmSwitchSfp)
