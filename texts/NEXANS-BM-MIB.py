...
mibBuilder.exportSymbols("NEXANS-BM-MIB", sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portAdminState=portAdminState, portSecurityMacAddr3=portSecurityMacAddr3, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portLinkChange=portLinkChange, portPoeCurrent=portPoeCurrent, adminMemoryCardMode=adminMemoryCardMode, adminFunctionInputNameF1=adminFunctionInputNameF1, clientRemoved=clientRemoved, sfpInfoDateCode=sfpInfoDateCode, adminTftpAccess=adminTftpAccess, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, switchPoeOverloadFailure=switchPoeOverloadFailure, infoLastSfpEventMessage=infoLastSfpEventMessage, infoNoOfReboots=infoNoOfReboots, switchInternalVoltageFailure=switchInternalVoltageFailure, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portSpeedDuplexSetup=portSpeedDuplexSetup, infoPowerVoltage3300=infoPowerVoltage3300, infoDescr=infoDescr, switchPoeVoltageFailure=switchPoeVoltageFailure, adminAlarmNameM1=adminAlarmNameM1, bmSwitchSfp=bmSwitchSfp, sfpInfoSerialNumber=sfpInfoSerialNumber, adminAgentVlanId=adminAgentVlanId, portPrioIp=portPrioIp, portPrioDot1p=portPrioDot1p, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminAgentNetmask=adminAgentNetmask, bmSwitchPortEntry=bmSwitchPortEntry, switchFunctionInputAlarm=switchFunctionInputAlarm, portPoeVoltage=portPoeVoltage, sfpInfoLength9um=sfpInfoLength9um, portErrorCountFailure=portErrorCountFailure, infoTotalConfigChanges=infoTotalConfigChanges, infoAlarmStateM1=infoAlarmStateM1, bmTraps=bmTraps, sfpInfoPartNumber=sfpInfoPartNumber, bmSwitchVlanTable=bmSwitchVlanTable, radiusPortSecurityReject=radiusPortSecurityReject, portDefaultPrioQueue=portDefaultPrioQueue, adminAlarmM1=adminAlarmM1, sfpInfoVendorName=sfpInfoVendorName, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, infoPowerVoltage2500=infoPowerVoltage2500, portRemoteFault=portRemoteFault, adminSnmpMacTableMode=adminSnmpMacTableMode, infoFunctionInputStateF1=infoFunctionInputStateF1, infoAlarmStateM2=infoAlarmStateM2, internalMgmtWarning=internalMgmtWarning, sfpInfoBitRate=sfpInfoBitRate, switchMgmtAuthFailure=switchMgmtAuthFailure, bmSwitchAdmin=bmSwitchAdmin, adminLedGlobalMode=adminLedGlobalMode, tftpMessage=tftpMessage, infoSwitchHardwareVersion=infoSwitchHardwareVersion, bmSwitchPort=bmSwitchPort, portVoiceVlanId=portVoiceVlanId, portAcApSetup=portAcApSetup, infoLastTftpMessage=infoLastTftpMessage, adminAlarmNameM2=adminAlarmNameM2, portDescr=portDescr, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, bmSwitchSfpEntry=bmSwitchSfpEntry, portPoeAdminState=portPoeAdminState, portBandwidthLimitRxd=portBandwidthLimitRxd, portBandwidthLimitTxd=portBandwidthLimitTxd, vlanIndex=vlanIndex, sfpEvent=sfpEvent, portSecurityMacAddr1=portSecurityMacAddr1, switchTemperatureFailure=switchTemperatureFailure, sfpInfoLength62um=sfpInfoLength62um, portPoeOverloadFailure=portPoeOverloadFailure, PYSNMP_MODULE_ID=bmSwitchMIB, portSecurityFailure=portSecurityFailure, bmSwitchSfpTable=bmSwitchSfpTable, bmSwitchVlan=bmSwitchVlan, portSecurityForwardingState=portSecurityForwardingState, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portLimiterPacketType=portLimiterPacketType, adminMgmtAccessList=adminMgmtAccessList, portLEDGreen=portLEDGreen, adminUnsecureVlanId=adminUnsecureVlanId, portErrorCounter=portErrorCounter, portName=portName, portLinkType=portLinkType, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoTemperature=infoTemperature, portNewMacAddress=portNewMacAddress, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminAlarmM2=adminAlarmM2, adminAgentPrioValue=adminAgentPrioValue, portIndex=portIndex, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, sfpInfoLength50um=sfpInfoLength50um, portLEDYellow=portLEDYellow, infoProductNo=infoProductNo, portDefaultVlanId=portDefaultVlanId, portLoopBcastFailure=portLoopBcastFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, infoSecurityFailMacAddr=infoSecurityFailMacAddr, infoUnauthIpAddr=infoUnauthIpAddr, adminAgentDhcp=adminAgentDhcp, portErrorDisabled=portErrorDisabled, sfpPortIndex=sfpPortIndex, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoManufactureDate=infoManufactureDate, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, infoPoeInputPower=infoPoeInputPower, infoSeriesNo=infoSeriesNo, bmSwitchPortTable=bmSwitchPortTable, infoSerie=infoSerie, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpInfoWavelength=sfpInfoWavelength, portTrunkingMode=portTrunkingMode, bmSwitchVlanEntry=bmSwitchVlanEntry, adminReset=adminReset, portPoePower=portPoePower, adminAgentPhysAddress=adminAgentPhysAddress, vlanId=vlanId, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, bmSwitchInfo=bmSwitchInfo, bmSwitchMIB=bmSwitchMIB, infoNewMacAddr=infoNewMacAddr, adminSwitchPortMirror=adminSwitchPortMirror, switchConfigurationChanged=switchConfigurationChanged, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, sfpDiagTemperature=sfpDiagTemperature, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminAgentIpAddress=adminAgentIpAddress, vlanDescr=vlanDescr, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, radiusMgmtAuthReject=radiusMgmtAuthReject, portSecurityMacAddr2=portSecurityMacAddr2, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoType=infoType, portSecurityAdminState=portSecurityAdminState, sfpState=sfpState, portLinkState=portLinkState, infoPoeInputVoltage=infoPoeInputVoltage, portPoePowerLimit=portPoePowerLimit, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoNoOfPorts=infoNoOfPorts)
