...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portPrioDot1p=portPrioDot1p, portSecurityForwardingState=portSecurityForwardingState, portAdminState=portAdminState, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpInfoBitRate=sfpInfoBitRate, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminAlarmNameM2=adminAlarmNameM2, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpInfoWavelength=sfpInfoWavelength, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portAcApSetup=portAcApSetup, portLinkType=portLinkType, adminAlarmM1=adminAlarmM1, portSecurityMacAddr1=portSecurityMacAddr1, portErrorCounter=portErrorCounter, sfpPortIndex=sfpPortIndex, adminAgentVlanId=adminAgentVlanId, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portSpeedDuplexSetup=portSpeedDuplexSetup, vlanId=vlanId, portSecurityMacAddr2=portSecurityMacAddr2, adminAlarmM2=adminAlarmM2, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, sfpDiagRxIntputPower=sfpDiagRxIntputPower, tftpMessage=tftpMessage, adminReset=adminReset, adminUnsecureVlanId=adminUnsecureVlanId, bmSwitchVlanEntry=bmSwitchVlanEntry, portNewMacAddress=portNewMacAddress, sfpInfoLength9um=sfpInfoLength9um, infoAlarmStateM2=infoAlarmStateM2, vlanDescr=vlanDescr, switchConfigurationChanged=switchConfigurationChanged, bmSwitchAdmin=bmSwitchAdmin, infoAlarmStateM1=infoAlarmStateM1, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoLastSfpEventMessage=infoLastSfpEventMessage, adminSnmpMacTableMode=adminSnmpMacTableMode, sfpInfoDateCode=sfpInfoDateCode, switchPoeVoltageFailure=switchPoeVoltageFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, bmSwitchVlan=bmSwitchVlan, infoLastTftpMessage=infoLastTftpMessage, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portSecurityFailure=portSecurityFailure, infoManufactureDate=infoManufactureDate, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portLEDYellow=portLEDYellow, adminAgentIpAddress=adminAgentIpAddress, bmSwitchPortEntry=bmSwitchPortEntry, infoTemperature=infoTemperature, infoNoOfReboots=infoNoOfReboots, portLinkState=portLinkState, infoSerie=infoSerie, vlanIndex=vlanIndex, portBandwidthLimitTxd=portBandwidthLimitTxd, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portSecurityMacAddr3=portSecurityMacAddr3, bmSwitchSfp=bmSwitchSfp, portPrioIp=portPrioIp, portPoeAdminState=portPoeAdminState, bmSwitchSfpTable=bmSwitchSfpTable, bmTraps=bmTraps, sfpInfoConnectorDescr=sfpInfoConnectorDescr, sfpEvent=sfpEvent, portLoopBcastFailure=portLoopBcastFailure, portDescr=portDescr, switchTemperatureFailure=switchTemperatureFailure, bmSwitchPort=bmSwitchPort, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminMemoryCardMode=adminMemoryCardMode, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portErrorDisabled=portErrorDisabled, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoSeriesNo=infoSeriesNo, switchPoeOverloadFailure=switchPoeOverloadFailure, portVoiceVlanId=portVoiceVlanId, adminLedGlobalMode=adminLedGlobalMode, sfpDiagTemperature=sfpDiagTemperature, sfpInfoSerialNumber=sfpInfoSerialNumber, radiusPortSecurityReject=radiusPortSecurityReject, bmSwitchSfpEntry=bmSwitchSfpEntry, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoUnauthIpAddr=infoUnauthIpAddr, portPoePowerLimit=portPoePowerLimit, portDefaultPrioQueue=portDefaultPrioQueue, bmSwitchInfo=bmSwitchInfo, switchInternalVoltageFailure=switchInternalVoltageFailure, adminMgmtAccessList=adminMgmtAccessList, portBandwidthLimitRxd=portBandwidthLimitRxd, portName=portName, sfpInfoVendorName=sfpInfoVendorName, portPoeOverloadFailure=portPoeOverloadFailure, switchMgmtAuthFailure=switchMgmtAuthFailure, portRemoteFault=portRemoteFault, adminTftpAccess=adminTftpAccess, adminAlarmNameM1=adminAlarmNameM1, adminAgentNetmask=adminAgentNetmask, infoType=infoType, infoPoeInputPower=infoPoeInputPower, sfpInfoLength50um=sfpInfoLength50um, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpInfoLength62um=sfpInfoLength62um, internalMgmtWarning=internalMgmtWarning, portDefaultVlanId=portDefaultVlanId, portPoeVoltage=portPoeVoltage, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portLinkChange=portLinkChange, portIndex=portIndex, portLimiterPacketType=portLimiterPacketType, bmSwitchMIB=bmSwitchMIB, infoPowerVoltage2500=infoPowerVoltage2500, infoDescr=infoDescr, infoPowerVoltage3300=infoPowerVoltage3300, infoNoOfPorts=infoNoOfPorts, bmSwitchPortTable=bmSwitchPortTable, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoNewMacAddr=infoNewMacAddr, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, PYSNMP_MODULE_ID=bmSwitchMIB, infoFunctionInputStateF1=infoFunctionInputStateF1, portPoePower=portPoePower, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, radiusMgmtAuthReject=radiusMgmtAuthReject, bmSwitchVlanTable=bmSwitchVlanTable, adminSwitchPortMirror=adminSwitchPortMirror, sfpState=sfpState, adminSwitchVlanTableMode=adminSwitchVlanTableMode, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portPoeCurrent=portPoeCurrent, adminAgentDhcp=adminAgentDhcp, portSecurityAdminState=portSecurityAdminState, sfpInfoPartNumber=sfpInfoPartNumber, sfpDiagTxOutputPower=sfpDiagTxOutputPower, infoTotalConfigChanges=infoTotalConfigChanges, infoProductNo=infoProductNo, portTrunkingMode=portTrunkingMode, adminAgentPrioValue=adminAgentPrioValue, adminFunctionInputNameF1=adminFunctionInputNameF1, clientRemoved=clientRemoved, infoPoeInputVoltage=infoPoeInputVoltage, portErrorCountFailure=portErrorCountFailure, portLEDGreen=portLEDGreen, switchFunctionInputAlarm=switchFunctionInputAlarm, adminAgentPhysAddress=adminAgentPhysAddress)
