...
mibBuilder.exportSymbols("NEXANS-BM-MIB", adminAlarmM1=adminAlarmM1, adminAgentIpAddress=adminAgentIpAddress, sfpInfoLength62um=sfpInfoLength62um, portPoeCurrent=portPoeCurrent, portLinkState=portLinkState, portErrorCounter=portErrorCounter, switchConfigurationChanged=switchConfigurationChanged, sfpDiagTemperature=sfpDiagTemperature, portDefaultPrioQueue=portDefaultPrioQueue, radiusMgmtAuthReject=radiusMgmtAuthReject, internalMgmtWarning=internalMgmtWarning, adminAgentPhysAddress=adminAgentPhysAddress, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminSnmpMacTableMode=adminSnmpMacTableMode, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoPoeInputPower=infoPoeInputPower, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, switchInternalVoltageFailure=switchInternalVoltageFailure, infoProductNo=infoProductNo, infoPoeInputVoltage=infoPoeInputVoltage, portPoeVoltage=portPoeVoltage, portLEDYellow=portLEDYellow, infoTotalConfigChanges=infoTotalConfigChanges, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminLedGlobalMode=adminLedGlobalMode, bmSwitchAdmin=bmSwitchAdmin, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portPoePowerLimit=portPoePowerLimit, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpInfoBitRate=sfpInfoBitRate, adminAgentNetmask=adminAgentNetmask, infoAlarmStateM2=infoAlarmStateM2, portSecurityMacAddr1=portSecurityMacAddr1, infoUnauthIpAddr=infoUnauthIpAddr, sfpPortIndex=sfpPortIndex, infoAlarmStateM1=infoAlarmStateM1, sfpInfoPartNumber=sfpInfoPartNumber, sfpInfoLength50um=sfpInfoLength50um, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoFunctionInputStateF1=infoFunctionInputStateF1, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portPrioIp=portPrioIp, switchFunctionInputAlarm=switchFunctionInputAlarm, portErrorCountFailure=portErrorCountFailure, adminReset=adminReset, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portSecurityMacAddr3=portSecurityMacAddr3, clientRemoved=clientRemoved, portAcApSetup=portAcApSetup, adminMgmtAccessList=adminMgmtAccessList, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoManufactureDate=infoManufactureDate, portPoePower=portPoePower, portLimiterPacketType=portLimiterPacketType, portErrorDisabled=portErrorDisabled, bmSwitchPortTable=bmSwitchPortTable, vlanIndex=vlanIndex, portVoiceVlanId=portVoiceVlanId, sfpInfoWavelength=sfpInfoWavelength, portLEDGreen=portLEDGreen, bmTraps=bmTraps, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, radiusPortSecurityReject=radiusPortSecurityReject, vlanDescr=vlanDescr, portSecurityFailure=portSecurityFailure, infoTemperature=infoTemperature, infoType=infoType, portBandwidthLimitRxd=portBandwidthLimitRxd, infoSerie=infoSerie, portDefaultVlanId=portDefaultVlanId, portSpeedDuplexSetup=portSpeedDuplexSetup, adminAgentVlanId=adminAgentVlanId, adminFunctionInputNameF1=adminFunctionInputNameF1, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpInfoDateCode=sfpInfoDateCode, bmSwitchInfo=bmSwitchInfo, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portPoeOverloadFailure=portPoeOverloadFailure, sfpInfoVendorName=sfpInfoVendorName, adminAgentDhcp=adminAgentDhcp, portIndex=portIndex, bmSwitchSfpEntry=bmSwitchSfpEntry, switchTemperatureFailure=switchTemperatureFailure, sfpEvent=sfpEvent, PYSNMP_MODULE_ID=bmSwitchMIB, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, bmSwitchPort=bmSwitchPort, bmSwitchVlan=bmSwitchVlan, sfpState=sfpState, portTrunkingMode=portTrunkingMode, sfpInfoRevisionNumber=sfpInfoRevisionNumber, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portName=portName, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminSwitchPortMirror=adminSwitchPortMirror, infoPowerVoltage3300=infoPowerVoltage3300, sfpInfoLength9um=sfpInfoLength9um, adminUnsecureVlanId=adminUnsecureVlanId, portRemoteFault=portRemoteFault, bmSwitchSfpTable=bmSwitchSfpTable, adminAlarmM2=adminAlarmM2, portLinkChange=portLinkChange, portDescr=portDescr, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoSeriesNo=infoSeriesNo, infoNoOfPorts=infoNoOfPorts, portLinkType=portLinkType, portAdminState=portAdminState, infoPowerVoltage2500=infoPowerVoltage2500, adminAgentPrioValue=adminAgentPrioValue, infoLastSfpEventMessage=infoLastSfpEventMessage, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portSecurityAdminState=portSecurityAdminState, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoNewMacAddr=infoNewMacAddr, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, switchMgmtAuthFailure=switchMgmtAuthFailure, switchPoeOverloadFailure=switchPoeOverloadFailure, tftpMessage=tftpMessage, adminAlarmNameM2=adminAlarmNameM2, infoDescr=infoDescr, bmSwitchVlanEntry=bmSwitchVlanEntry, portPrioDot1p=portPrioDot1p, bmSwitchSfp=bmSwitchSfp, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portLoopBcastFailure=portLoopBcastFailure, adminMemoryCardMode=adminMemoryCardMode, switchPoeVoltageFailure=switchPoeVoltageFailure, bmSwitchMIB=bmSwitchMIB, vlanId=vlanId, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portBandwidthLimitTxd=portBandwidthLimitTxd, adminAlarmNameM1=adminAlarmNameM1, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminTftpAccess=adminTftpAccess, infoLastTftpMessage=infoLastTftpMessage, portSecurityForwardingState=portSecurityForwardingState, portNewMacAddress=portNewMacAddress, bmSwitchVlanTable=bmSwitchVlanTable, bmSwitchPortEntry=bmSwitchPortEntry, infoNoOfReboots=infoNoOfReboots, portSecurityMacAddr2=portSecurityMacAddr2, portPoeAdminState=portPoeAdminState)
