...
mibBuilder.exportSymbols("NEXANS-BM-MIB", sfpInfoLength62um=sfpInfoLength62um, bmTraps=bmTraps, portSecurityMacAddr1=portSecurityMacAddr1, adminAgentDhcp=adminAgentDhcp, portSecurityMacAddr2=portSecurityMacAddr2, switchTemperatureFailure=switchTemperatureFailure, portBandwidthLimitRxd=portBandwidthLimitRxd, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, bmSwitchVlanEntry=bmSwitchVlanEntry, bmSwitchSfp=bmSwitchSfp, infoTotalConfigChanges=infoTotalConfigChanges, adminSwitchPortMirror=adminSwitchPortMirror, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoTemperature=infoTemperature, portErrorCounter=portErrorCounter, infoFunctionInputStateF1=infoFunctionInputStateF1, adminFunctionInputNameF1=adminFunctionInputNameF1, bmSwitchPort=bmSwitchPort, portPoeAdminState=portPoeAdminState, infoPoeInputVoltage=infoPoeInputVoltage, infoPowerVoltage3300=infoPowerVoltage3300, adminMemoryCardMode=adminMemoryCardMode, portLEDYellow=portLEDYellow, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, bmSwitchVlanTable=bmSwitchVlanTable, adminReset=adminReset, PYSNMP_MODULE_ID=bmSwitchMIB, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminAlarmM2=adminAlarmM2, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpInfoWavelength=sfpInfoWavelength, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, infoProductNo=infoProductNo, infoPoeInputPower=infoPoeInputPower, infoUnauthIpAddr=infoUnauthIpAddr, bmSwitchSfpEntry=bmSwitchSfpEntry, infoType=infoType, portPoeVoltage=portPoeVoltage, sfpEvent=sfpEvent, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminTftpAccess=adminTftpAccess, portBandwidthLimitTxd=portBandwidthLimitTxd, infoPowerVoltage2500=infoPowerVoltage2500, portErrorCountFailure=portErrorCountFailure, adminLedGlobalMode=adminLedGlobalMode, infoNewMacAddr=infoNewMacAddr, adminAlarmNameM2=adminAlarmNameM2, bmSwitchPortTable=bmSwitchPortTable, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, radiusPortSecurityReject=radiusPortSecurityReject, infoAlarmStateM2=infoAlarmStateM2, adminUnsecureVlanId=adminUnsecureVlanId, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portIndex=portIndex, portErrorDisabled=portErrorDisabled, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portLinkType=portLinkType, sfpDiagTemperature=sfpDiagTemperature, adminAgentPrioValue=adminAgentPrioValue, sfpState=sfpState, infoSerie=infoSerie, switchInternalVoltageFailure=switchInternalVoltageFailure, sfpInfoRevisionNumber=sfpInfoRevisionNumber, radiusMgmtAuthReject=radiusMgmtAuthReject, infoSeriesNo=infoSeriesNo, sfpInfoDateCode=sfpInfoDateCode, portTrunkingMode=portTrunkingMode, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpInfoVendorName=sfpInfoVendorName, sfpInfoConnectorDescr=sfpInfoConnectorDescr, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, adminAgentVlanId=adminAgentVlanId, portSecurityFailure=portSecurityFailure, portLEDGreen=portLEDGreen, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, sfpInfoSerialNumber=sfpInfoSerialNumber, infoAlarmStateM1=infoAlarmStateM1, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminAgentIpAddress=adminAgentIpAddress, adminAlarmM1=adminAlarmM1, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portVoiceVlanId=portVoiceVlanId, adminSwitchVlanTableMode=adminSwitchVlanTableMode, bmSwitchVlan=bmSwitchVlan, bmSwitchAdmin=bmSwitchAdmin, portSecurityMacAddr3=portSecurityMacAddr3, switchPoeOverloadFailure=switchPoeOverloadFailure, portPoePower=portPoePower, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, adminSnmpMacTableMode=adminSnmpMacTableMode, adminMgmtAccessList=adminMgmtAccessList, portDescr=portDescr, bmSwitchMIB=bmSwitchMIB, switchConfigurationChanged=switchConfigurationChanged, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portAdminState=portAdminState, portPrioIp=portPrioIp, adminAlarmNameM1=adminAlarmNameM1, portAcApSetup=portAcApSetup, sfpInfoLength9um=sfpInfoLength9um, portLinkChange=portLinkChange, portSecurityAdminState=portSecurityAdminState, switchMgmtAuthFailure=switchMgmtAuthFailure, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminAgentPhysAddress=adminAgentPhysAddress, sfpInfoLength50um=sfpInfoLength50um, sfpInfoBitRate=sfpInfoBitRate, vlanId=vlanId, portDefaultPrioQueue=portDefaultPrioQueue, portName=portName, internalMgmtWarning=internalMgmtWarning, infoLastSfpEventMessage=infoLastSfpEventMessage, portPoeCurrent=portPoeCurrent, portSpeedDuplexSetup=portSpeedDuplexSetup, infoDescr=infoDescr, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, bmSwitchInfo=bmSwitchInfo, portPoePowerLimit=portPoePowerLimit, sfpInfoPartNumber=sfpInfoPartNumber, tftpMessage=tftpMessage, infoNoOfPorts=infoNoOfPorts, portLimiterPacketType=portLimiterPacketType, infoManufactureDate=infoManufactureDate, infoLastTftpMessage=infoLastTftpMessage, clientRemoved=clientRemoved, sfpPortIndex=sfpPortIndex, portLoopBcastFailure=portLoopBcastFailure, vlanDescr=vlanDescr, portDefaultVlanId=portDefaultVlanId, bmSwitchPortEntry=bmSwitchPortEntry, adminAgentNetmask=adminAgentNetmask, bmSwitchSfpTable=bmSwitchSfpTable, portLinkState=portLinkState, portNewMacAddress=portNewMacAddress, portSecurityForwardingState=portSecurityForwardingState, vlanIndex=vlanIndex, portPrioDot1p=portPrioDot1p, portRemoteFault=portRemoteFault, infoNoOfReboots=infoNoOfReboots, switchPoeVoltageFailure=switchPoeVoltageFailure, infoSwitchHardwareVersion=infoSwitchHardwareVersion, switchFunctionInputAlarm=switchFunctionInputAlarm, portPoeOverloadFailure=portPoeOverloadFailure)
