...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoUnauthIpAddr=infoUnauthIpAddr, portSecurityForwardingState=portSecurityForwardingState, adminUnsecureVlanId=adminUnsecureVlanId, adminAgentVlanId=adminAgentVlanId, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portVoiceVlanId=portVoiceVlanId, portPoeOverloadFailure=portPoeOverloadFailure, infoAlarmStateM1=infoAlarmStateM1, portLimiterPacketType=portLimiterPacketType, infoAlarmStateM2=infoAlarmStateM2, bmSwitchVlanTable=bmSwitchVlanTable, portIndex=portIndex, bmSwitchMIB=bmSwitchMIB, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portRemoteFault=portRemoteFault, portLoopBcastFailure=portLoopBcastFailure, adminMgmtAccessList=adminMgmtAccessList, infoTotalConfigChanges=infoTotalConfigChanges, infoTemperature=infoTemperature, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portPoeCurrent=portPoeCurrent, vlanDescr=vlanDescr, infoPoeInputPower=infoPoeInputPower, infoSerie=infoSerie, switchFunctionInputAlarm=switchFunctionInputAlarm, adminSwitchVlanTableMode=adminSwitchVlanTableMode, vlanIndex=vlanIndex, infoPowerVoltage2500=infoPowerVoltage2500, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoNewMacAddr=infoNewMacAddr, switchConfigurationChanged=switchConfigurationChanged, infoType=infoType, portDefaultVlanId=portDefaultVlanId, infoFunctionInputStateF1=infoFunctionInputStateF1, sfpInfoDateCode=sfpInfoDateCode, sfpInfoSerialNumber=sfpInfoSerialNumber, switchInternalVoltageFailure=switchInternalVoltageFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, sfpInfoBitRate=sfpInfoBitRate, sfpInfoLength50um=sfpInfoLength50um, portLinkChange=portLinkChange, portSecurityMacAddr2=portSecurityMacAddr2, bmSwitchVlanEntry=bmSwitchVlanEntry, adminAlarmM1=adminAlarmM1, adminReset=adminReset, sfpDiagTxOutputPower=sfpDiagTxOutputPower, bmSwitchSfpTable=bmSwitchSfpTable, portErrorDisabled=portErrorDisabled, infoLastTftpMessage=infoLastTftpMessage, adminLedGlobalMode=adminLedGlobalMode, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, sfpInfoRevisionNumber=sfpInfoRevisionNumber, bmTraps=bmTraps, portDefaultPrioQueue=portDefaultPrioQueue, portPoeVoltage=portPoeVoltage, sfpInfoLength62um=sfpInfoLength62um, infoNoOfReboots=infoNoOfReboots, bmSwitchSfp=bmSwitchSfp, internalMgmtWarning=internalMgmtWarning, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoManufactureDate=infoManufactureDate, sfpInfoLength9um=sfpInfoLength9um, portPrioIp=portPrioIp, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, sfpDiagRxIntputPower=sfpDiagRxIntputPower, vlanId=vlanId, bmSwitchPort=bmSwitchPort, adminSwitchPortMirror=adminSwitchPortMirror, adminAgentPhysAddress=adminAgentPhysAddress, switchPoeOverloadFailure=switchPoeOverloadFailure, adminAgentPrioValue=adminAgentPrioValue, sfpPortIndex=sfpPortIndex, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminAgentIpAddress=adminAgentIpAddress, portAdminState=portAdminState, portPoePower=portPoePower, sfpState=sfpState, adminAlarmNameM1=adminAlarmNameM1, portSecurityAdminState=portSecurityAdminState, infoDescr=infoDescr, portPoePowerLimit=portPoePowerLimit, adminMemoryCardMode=adminMemoryCardMode, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoLastSfpEventMessage=infoLastSfpEventMessage, portSecurityMacAddr3=portSecurityMacAddr3, switchMgmtAuthFailure=switchMgmtAuthFailure, bmSwitchSfpEntry=bmSwitchSfpEntry, adminTftpAccess=adminTftpAccess, sfpInfoWavelength=sfpInfoWavelength, portSpeedDuplexSetup=portSpeedDuplexSetup, portLEDGreen=portLEDGreen, bmSwitchAdmin=bmSwitchAdmin, bmSwitchPortTable=bmSwitchPortTable, radiusPortSecurityReject=radiusPortSecurityReject, infoSeriesNo=infoSeriesNo, infoPowerVoltage3300=infoPowerVoltage3300, portBandwidthLimitTxd=portBandwidthLimitTxd, portPrioDot1p=portPrioDot1p, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, bmSwitchVlan=bmSwitchVlan, adminAgentDhcp=adminAgentDhcp, portAcApSetup=portAcApSetup, sfpInfoPartNumber=sfpInfoPartNumber, portErrorCounter=portErrorCounter, portTrunkingMode=portTrunkingMode, infoNoOfPorts=infoNoOfPorts, portName=portName, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminFunctionInputNameF1=adminFunctionInputNameF1, portLEDYellow=portLEDYellow, portLinkState=portLinkState, bmSwitchInfo=bmSwitchInfo, PYSNMP_MODULE_ID=bmSwitchMIB, bmSwitchPortEntry=bmSwitchPortEntry, switchTemperatureFailure=switchTemperatureFailure, switchPoeVoltageFailure=switchPoeVoltageFailure, infoPoeInputVoltage=infoPoeInputVoltage, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portSecurityFailure=portSecurityFailure, clientRemoved=clientRemoved, portErrorCountFailure=portErrorCountFailure, portDescr=portDescr, portBandwidthLimitRxd=portBandwidthLimitRxd, sfpEvent=sfpEvent, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portLinkType=portLinkType, sfpDiagTemperature=sfpDiagTemperature, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, radiusMgmtAuthReject=radiusMgmtAuthReject, portSecurityMacAddr1=portSecurityMacAddr1, infoProductNo=infoProductNo, adminSnmpMacTableMode=adminSnmpMacTableMode, adminAgentNetmask=adminAgentNetmask, portPoeAdminState=portPoeAdminState, adminAlarmM2=adminAlarmM2, adminAlarmNameM2=adminAlarmNameM2, sfpInfoVendorName=sfpInfoVendorName, portNewMacAddress=portNewMacAddress, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, tftpMessage=tftpMessage)
