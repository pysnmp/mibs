...
mibBuilder.exportSymbols("NEXANS-BM-MIB", PYSNMP_MODULE_ID=bmSwitchMIB, portPoePowerLimit=portPoePowerLimit, infoLastTftpMessage=infoLastTftpMessage, adminMgmtAccessList=adminMgmtAccessList, infoUnauthIpAddr=infoUnauthIpAddr, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpInfoVendorName=sfpInfoVendorName, portPoePower=portPoePower, vlanDescr=vlanDescr, portSecurityAdminState=portSecurityAdminState, adminAgentNetmask=adminAgentNetmask, infoNoOfReboots=infoNoOfReboots, bmSwitchVlanEntry=bmSwitchVlanEntry, bmSwitchVlan=bmSwitchVlan, infoTemperature=infoTemperature, portLEDGreen=portLEDGreen, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminAgentPrioValue=adminAgentPrioValue, portErrorCountFailure=portErrorCountFailure, portBandwidthLimitRxd=portBandwidthLimitRxd, switchFunctionInputAlarm=switchFunctionInputAlarm, adminAgentVlanId=adminAgentVlanId, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoTotalConfigChanges=infoTotalConfigChanges, portErrorDisabled=portErrorDisabled, infoPowerVoltage2500=infoPowerVoltage2500, portLinkType=portLinkType, sfpInfoDateCode=sfpInfoDateCode, vlanIndex=vlanIndex, clientRemoved=clientRemoved, infoDescr=infoDescr, switchPoeVoltageFailure=switchPoeVoltageFailure, portName=portName, portIndex=portIndex, radiusPortSecurityReject=radiusPortSecurityReject, adminUnsecureVlanId=adminUnsecureVlanId, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, infoPowerVoltage3300=infoPowerVoltage3300, sfpInfoLength62um=sfpInfoLength62um, portSecurityFailure=portSecurityFailure, sfpInfoPartNumber=sfpInfoPartNumber, sfpInfoSerialNumber=sfpInfoSerialNumber, portPoeCurrent=portPoeCurrent, infoSerie=infoSerie, sfpEvent=sfpEvent, sfpDiagTemperature=sfpDiagTemperature, portPrioDot1p=portPrioDot1p, bmSwitchPortEntry=bmSwitchPortEntry, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminSwitchVlanTableMode=adminSwitchVlanTableMode, switchConfigurationChanged=switchConfigurationChanged, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portNewMacAddress=portNewMacAddress, sfpInfoBitRate=sfpInfoBitRate, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portSecurityMacAddr3=portSecurityMacAddr3, sfpInfoWavelength=sfpInfoWavelength, internalMgmtWarning=internalMgmtWarning, portRemoteFault=portRemoteFault, adminMemoryCardMode=adminMemoryCardMode, portVoiceVlanId=portVoiceVlanId, portAcApSetup=portAcApSetup, portSpeedDuplexSetup=portSpeedDuplexSetup, portDescr=portDescr, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, bmSwitchAdmin=bmSwitchAdmin, portLimiterPacketType=portLimiterPacketType, portLinkState=portLinkState, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminFunctionInputNameF1=adminFunctionInputNameF1, switchPoeOverloadFailure=switchPoeOverloadFailure, bmSwitchInfo=bmSwitchInfo, adminSwitchPortMirror=adminSwitchPortMirror, infoAlarmStateM2=infoAlarmStateM2, portErrorCounter=portErrorCounter, portPrioIp=portPrioIp, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoPoeInputPower=infoPoeInputPower, adminSnmpMacTableMode=adminSnmpMacTableMode, radiusMgmtAuthReject=radiusMgmtAuthReject, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminAlarmM1=adminAlarmM1, vlanId=vlanId, infoType=infoType, bmSwitchVlanTable=bmSwitchVlanTable, adminReset=adminReset, sfpState=sfpState, portDefaultVlanId=portDefaultVlanId, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminTftpAccess=adminTftpAccess, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoSeriesNo=infoSeriesNo, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoNoOfPorts=infoNoOfPorts, adminAgentDhcp=adminAgentDhcp, portPoeVoltage=portPoeVoltage, portTrunkingMode=portTrunkingMode, portSecurityForwardingState=portSecurityForwardingState, infoLastSfpEventMessage=infoLastSfpEventMessage, portLinkChange=portLinkChange, adminAlarmNameM2=adminAlarmNameM2, infoFunctionInputStateF1=infoFunctionInputStateF1, switchTemperatureFailure=switchTemperatureFailure, adminAgentIpAddress=adminAgentIpAddress, portPoeAdminState=portPoeAdminState, adminAlarmNameM1=adminAlarmNameM1, portAdminState=portAdminState, bmSwitchPortTable=bmSwitchPortTable, portPoeOverloadFailure=portPoeOverloadFailure, switchInternalVoltageFailure=switchInternalVoltageFailure, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portLoopBcastFailure=portLoopBcastFailure, adminAlarmM2=adminAlarmM2, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portSecurityMacAddr2=portSecurityMacAddr2, infoNewMacAddr=infoNewMacAddr, bmSwitchMIB=bmSwitchMIB, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portSecurityMacAddr1=portSecurityMacAddr1, adminLedGlobalMode=adminLedGlobalMode, portDefaultPrioQueue=portDefaultPrioQueue, adminAgentPhysAddress=adminAgentPhysAddress, bmSwitchPort=bmSwitchPort, infoProductNo=infoProductNo, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoPoeInputVoltage=infoPoeInputVoltage, portLEDYellow=portLEDYellow, sfpInfoLength9um=sfpInfoLength9um, bmSwitchSfp=bmSwitchSfp, sfpInfoLength50um=sfpInfoLength50um, bmTraps=bmTraps, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoManufactureDate=infoManufactureDate, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, tftpMessage=tftpMessage, sfpPortIndex=sfpPortIndex, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoAlarmStateM1=infoAlarmStateM1, bmSwitchSfpTable=bmSwitchSfpTable, switchMgmtAuthFailure=switchMgmtAuthFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId)
