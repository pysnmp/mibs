...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, iso, NotificationType, Gauge32, ObjectIdentity, MibIdentifier, Counter32, Counter64, ModuleIdentity, Unsigned32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "iso", "NotificationType", "Gauge32", "ObjectIdentity", "MibIdentifier", "Counter32", "Counter64", "ModuleIdentity", "Unsigned32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", adminAgentIpAddress=adminAgentIpAddress, portErrorCounter=portErrorCounter, sfpInfoWavelength=sfpInfoWavelength, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portSecurityFailure=portSecurityFailure, portSecurityMacAddr2=portSecurityMacAddr2, portPoeCurrent=portPoeCurrent, vlanDescr=vlanDescr, infoAlarmStateM1=infoAlarmStateM1, sfpInfoSerialNumber=sfpInfoSerialNumber, bmSwitchVlan=bmSwitchVlan, sfpInfoBitRate=sfpInfoBitRate, radiusMgmtAuthReject=radiusMgmtAuthReject, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, infoType=infoType, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, infoManufactureDate=infoManufactureDate, bmSwitchVlanEntry=bmSwitchVlanEntry, portLinkType=portLinkType, portErrorCountFailure=portErrorCountFailure, infoProductNo=infoProductNo, adminReset=adminReset, bmSwitchSfp=bmSwitchSfp, adminMemoryCardMode=adminMemoryCardMode, adminAlarmM1=adminAlarmM1, adminSnmpMacTableMode=adminSnmpMacTableMode, infoFunctionInputStateF1=infoFunctionInputStateF1, portSecurityMacAddr3=portSecurityMacAddr3, portPoePower=portPoePower, bmSwitchAdmin=bmSwitchAdmin, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portLimiterPacketType=portLimiterPacketType, bmSwitchPort=bmSwitchPort, infoLastSfpEventMessage=infoLastSfpEventMessage, portSecurityAdminState=portSecurityAdminState, adminAgentPhysAddress=adminAgentPhysAddress, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portIndex=portIndex, sfpDiagTemperature=sfpDiagTemperature, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminUnsecureVlanId=adminUnsecureVlanId, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portBandwidthLimitRxd=portBandwidthLimitRxd, portTrunkingMode=portTrunkingMode, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, clientRemoved=clientRemoved, bmSwitchPortEntry=bmSwitchPortEntry, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoNoOfPorts=infoNoOfPorts, infoDescr=infoDescr, bmSwitchMIB=bmSwitchMIB, infoSwitchHardwareVersion=infoSwitchHardwareVersion, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoPoeInputVoltage=infoPoeInputVoltage, vlanId=vlanId, infoNoOfReboots=infoNoOfReboots, infoUnauthIpAddr=infoUnauthIpAddr, switchPoeVoltageFailure=switchPoeVoltageFailure, sfpInfoLength50um=sfpInfoLength50um, adminAgentVlanId=adminAgentVlanId, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portPrioDot1p=portPrioDot1p, sfpState=sfpState, bmSwitchInfo=bmSwitchInfo, bmSwitchSfpEntry=bmSwitchSfpEntry, switchTemperatureFailure=switchTemperatureFailure, infoNewMacAddr=infoNewMacAddr, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portPrioIp=portPrioIp, infoTotalConfigChanges=infoTotalConfigChanges, portSpeedDuplexSetup=portSpeedDuplexSetup, adminAgentDhcp=adminAgentDhcp, adminAlarmNameM1=adminAlarmNameM1, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portSecurityMacAddr1=portSecurityMacAddr1, adminAlarmNameM2=adminAlarmNameM2, adminSwitchPortMirror=adminSwitchPortMirror, portDefaultVlanId=portDefaultVlanId, sfpDiagRxIntputPower=sfpDiagRxIntputPower, internalMgmtWarning=internalMgmtWarning, portAcApSetup=portAcApSetup, sfpInfoVendorName=sfpInfoVendorName, portSecurityForwardingState=portSecurityForwardingState, portAdminState=portAdminState, tftpMessage=tftpMessage, radiusPortSecurityReject=radiusPortSecurityReject, infoLastTftpMessage=infoLastTftpMessage, adminAlarmM2=adminAlarmM2, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoPoeInputPower=infoPoeInputPower, infoSeriesNo=infoSeriesNo, portPoeVoltage=portPoeVoltage, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoPowerVoltage2500=infoPowerVoltage2500, bmSwitchSfpTable=bmSwitchSfpTable, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoPowerVoltage3300=infoPowerVoltage3300, adminLedGlobalMode=adminLedGlobalMode, sfpInfoLength9um=sfpInfoLength9um, portLinkChange=portLinkChange, portVoiceVlanId=portVoiceVlanId, sfpEvent=sfpEvent, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, bmSwitchPortTable=bmSwitchPortTable, sfpInfoRevisionNumber=sfpInfoRevisionNumber, switchMgmtAuthFailure=switchMgmtAuthFailure, adminFunctionInputNameF1=adminFunctionInputNameF1, switchInternalVoltageFailure=switchInternalVoltageFailure, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminMgmtAccessList=adminMgmtAccessList, sfpInfoPartNumber=sfpInfoPartNumber, adminTftpAccess=adminTftpAccess, portNewMacAddress=portNewMacAddress, portLinkState=portLinkState, infoTemperature=infoTemperature, portRemoteFault=portRemoteFault, vlanIndex=vlanIndex, portPoePowerLimit=portPoePowerLimit, switchFunctionInputAlarm=switchFunctionInputAlarm, adminAgentPrioValue=adminAgentPrioValue, portLEDGreen=portLEDGreen, switchConfigurationChanged=switchConfigurationChanged, PYSNMP_MODULE_ID=bmSwitchMIB, adminAgentNetmask=adminAgentNetmask, portPoeOverloadFailure=portPoeOverloadFailure, portDefaultPrioQueue=portDefaultPrioQueue, portLEDYellow=portLEDYellow, portErrorDisabled=portErrorDisabled, infoSerie=infoSerie, sfpPortIndex=sfpPortIndex, bmTraps=bmTraps, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, switchPoeOverloadFailure=switchPoeOverloadFailure, sfpInfoDateCode=sfpInfoDateCode, infoAlarmStateM2=infoAlarmStateM2, sfpInfoLength62um=sfpInfoLength62um, bmSwitchVlanTable=bmSwitchVlanTable, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portBandwidthLimitTxd=portBandwidthLimitTxd, portPoeAdminState=portPoeAdminState, portName=portName, portDescr=portDescr, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portLoopBcastFailure=portLoopBcastFailure, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed)
