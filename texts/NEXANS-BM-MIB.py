...
ObjectIdentity, iso, Integer32, TimeTicks, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Gauge32, Unsigned32, Counter32, MibIdentifier, Bits, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Integer32", "TimeTicks", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Gauge32", "Unsigned32", "Counter32", "MibIdentifier", "Bits", "ModuleIdentity")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", tftpMessage=tftpMessage, adminAgentPrioValue=adminAgentPrioValue, infoAlarmStateM1=infoAlarmStateM1, portIndex=portIndex, portSecurityAdminState=portSecurityAdminState, portAcApSetup=portAcApSetup, switchPoeVoltageFailure=switchPoeVoltageFailure, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminAgentDhcp=adminAgentDhcp, infoDescr=infoDescr, sfpInfoLength62um=sfpInfoLength62um, sfpInfoSerialNumber=sfpInfoSerialNumber, clientRemoved=clientRemoved, infoType=infoType, sfpDiagRxIntputPower=sfpDiagRxIntputPower, bmSwitchVlanTable=bmSwitchVlanTable, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminAlarmM2=adminAlarmM2, portLoopBcastFailure=portLoopBcastFailure, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoProductNo=infoProductNo, infoFunctionInputStateF1=infoFunctionInputStateF1, adminAgentVlanId=adminAgentVlanId, infoSwitchHardwareVersion=infoSwitchHardwareVersion, bmSwitchPort=bmSwitchPort, bmSwitchSfp=bmSwitchSfp, portLinkType=portLinkType, portDefaultVlanId=portDefaultVlanId, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portBandwidthLimitTxd=portBandwidthLimitTxd, portSecurityMacAddr3=portSecurityMacAddr3, infoAlarmStateM2=infoAlarmStateM2, adminMgmtAccessList=adminMgmtAccessList, sfpInfoDateCode=sfpInfoDateCode, sfpState=sfpState, bmSwitchVlan=bmSwitchVlan, portLinkChange=portLinkChange, infoSeriesNo=infoSeriesNo, portDescr=portDescr, infoPowerVoltage3300=infoPowerVoltage3300, portSecurityMacAddr1=portSecurityMacAddr1, infoTemperature=infoTemperature, infoLastSfpEventMessage=infoLastSfpEventMessage, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portPrioIp=portPrioIp, portPoeVoltage=portPoeVoltage, internalMgmtWarning=internalMgmtWarning, vlanIndex=vlanIndex, sfpInfoWavelength=sfpInfoWavelength, portSecurityForwardingState=portSecurityForwardingState, bmTraps=bmTraps, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminSwitchPortMirror=adminSwitchPortMirror, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portErrorDisabled=portErrorDisabled, adminSnmpMacTableMode=adminSnmpMacTableMode, adminUnsecureVlanId=adminUnsecureVlanId, portBandwidthLimitRxd=portBandwidthLimitRxd, portDefaultPrioQueue=portDefaultPrioQueue, infoNewMacAddr=infoNewMacAddr, portPoePower=portPoePower, switchTemperatureFailure=switchTemperatureFailure, portSpeedDuplexSetup=portSpeedDuplexSetup, bmSwitchSfpTable=bmSwitchSfpTable, bmSwitchPortTable=bmSwitchPortTable, portAdminState=portAdminState, adminAgentNetmask=adminAgentNetmask, portTrunkingMode=portTrunkingMode, portErrorCounter=portErrorCounter, adminTftpAccess=adminTftpAccess, infoLastTftpMessage=infoLastTftpMessage, infoNoOfReboots=infoNoOfReboots, sfpInfoLength50um=sfpInfoLength50um, adminAlarmNameM1=adminAlarmNameM1, radiusMgmtAuthReject=radiusMgmtAuthReject, portPoeOverloadFailure=portPoeOverloadFailure, adminAgentPhysAddress=adminAgentPhysAddress, sfpInfoVendorName=sfpInfoVendorName, portLinkState=portLinkState, switchPoeOverloadFailure=switchPoeOverloadFailure, sfpInfoPartNumber=sfpInfoPartNumber, infoPoeInputPower=infoPoeInputPower, sfpEvent=sfpEvent, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portLEDGreen=portLEDGreen, portVoiceVlanId=portVoiceVlanId, sfpInfoLength9um=sfpInfoLength9um, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminLedGlobalMode=adminLedGlobalMode, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portName=portName, adminAlarmM1=adminAlarmM1, bmSwitchSfpEntry=bmSwitchSfpEntry, portSecurityFailure=portSecurityFailure, switchMgmtAuthFailure=switchMgmtAuthFailure, radiusPortSecurityReject=radiusPortSecurityReject, adminAlarmNameM2=adminAlarmNameM2, portPrioDot1p=portPrioDot1p, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminReset=adminReset, portPoeAdminState=portPoeAdminState, vlanId=vlanId, adminMemoryCardMode=adminMemoryCardMode, portSecurityMacAddr2=portSecurityMacAddr2, portPoePowerLimit=portPoePowerLimit, bmSwitchVlanEntry=bmSwitchVlanEntry, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, vlanDescr=vlanDescr, portPoeCurrent=portPoeCurrent, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portNewMacAddress=portNewMacAddress, bmSwitchMIB=bmSwitchMIB, switchFunctionInputAlarm=switchFunctionInputAlarm, infoPoeInputVoltage=infoPoeInputVoltage, infoNoOfPorts=infoNoOfPorts, sfpInfoBitRate=sfpInfoBitRate, bmSwitchInfo=bmSwitchInfo, infoPowerVoltage2500=infoPowerVoltage2500, infoUnauthIpAddr=infoUnauthIpAddr, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, bmSwitchAdmin=bmSwitchAdmin, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portLimiterPacketType=portLimiterPacketType, switchConfigurationChanged=switchConfigurationChanged, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoManufactureDate=infoManufactureDate, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpPortIndex=sfpPortIndex, adminFunctionInputNameF1=adminFunctionInputNameF1, portRemoteFault=portRemoteFault, adminAgentIpAddress=adminAgentIpAddress, infoTotalConfigChanges=infoTotalConfigChanges, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, PYSNMP_MODULE_ID=bmSwitchMIB, bmSwitchPortEntry=bmSwitchPortEntry, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portErrorCountFailure=portErrorCountFailure, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portLEDYellow=portLEDYellow, switchInternalVoltageFailure=switchInternalVoltageFailure, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoSerie=infoSerie, sfpDiagTemperature=sfpDiagTemperature)
