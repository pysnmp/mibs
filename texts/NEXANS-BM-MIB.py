...
mibBuilder.exportSymbols("NEXANS-BM-MIB", adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portIndex=portIndex, sfpInfoLength62um=sfpInfoLength62um, adminMemoryCardMode=adminMemoryCardMode, sfpState=sfpState, switchTemperatureFailure=switchTemperatureFailure, infoAlarmStateM1=infoAlarmStateM1, infoLastTftpMessage=infoLastTftpMessage, radiusMgmtAuthReject=radiusMgmtAuthReject, portRemoteFault=portRemoteFault, portBandwidthLimitTxd=portBandwidthLimitTxd, adminSnmpMacTableMode=adminSnmpMacTableMode, portPrioIp=portPrioIp, vlanIndex=vlanIndex, tftpMessage=tftpMessage, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoNoOfReboots=infoNoOfReboots, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAlarmNameM2=adminAlarmNameM2, portPoeVoltage=portPoeVoltage, radiusPortSecurityReject=radiusPortSecurityReject, sfpDiagTemperature=sfpDiagTemperature, clientRemoved=clientRemoved, portLEDYellow=portLEDYellow, portPoePowerLimit=portPoePowerLimit, portPoePower=portPoePower, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portDefaultPrioQueue=portDefaultPrioQueue, portVoiceVlanId=portVoiceVlanId, vlanId=vlanId, adminAlarmM1=adminAlarmM1, adminFunctionInputNameF1=adminFunctionInputNameF1, bmSwitchVlanEntry=bmSwitchVlanEntry, adminAgentIpAddress=adminAgentIpAddress, sfpPortIndex=sfpPortIndex, switchConfigurationChanged=switchConfigurationChanged, infoTotalConfigChanges=infoTotalConfigChanges, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, sfpEvent=sfpEvent, portSecurityAdminState=portSecurityAdminState, sfpInfoPartNumber=sfpInfoPartNumber, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portTrunkingMode=portTrunkingMode, bmSwitchInfo=bmSwitchInfo, adminTftpAccess=adminTftpAccess, bmSwitchSfpTable=bmSwitchSfpTable, infoPowerVoltage3300=infoPowerVoltage3300, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoAlarmStateM2=infoAlarmStateM2, portErrorDisabled=portErrorDisabled, infoFunctionInputStateF1=infoFunctionInputStateF1, adminLedGlobalMode=adminLedGlobalMode, vlanDescr=vlanDescr, adminSwitchVlanTableMode=adminSwitchVlanTableMode, infoSerie=infoSerie, infoProductNo=infoProductNo, infoSwitchHardwareVersion=infoSwitchHardwareVersion, bmSwitchPortTable=bmSwitchPortTable, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portBandwidthLimitRxd=portBandwidthLimitRxd, infoPoeInputVoltage=infoPoeInputVoltage, sfpInfoVendorName=sfpInfoVendorName, portLEDGreen=portLEDGreen, portSecurityForwardingState=portSecurityForwardingState, adminAgentPrioValue=adminAgentPrioValue, sfpInfoLength9um=sfpInfoLength9um, adminSwitchPortMirror=adminSwitchPortMirror, bmSwitchVlanTable=bmSwitchVlanTable, adminAgentNetmask=adminAgentNetmask, portLinkState=portLinkState, adminReset=adminReset, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, sfpInfoBitRate=sfpInfoBitRate, portSecurityMacAddr1=portSecurityMacAddr1, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoSeriesNo=infoSeriesNo, portSecurityFailure=portSecurityFailure, bmSwitchAdmin=bmSwitchAdmin, portPoeOverloadFailure=portPoeOverloadFailure, infoType=infoType, bmSwitchSfpEntry=bmSwitchSfpEntry, adminAgentDhcp=adminAgentDhcp, sfpInfoDateCode=sfpInfoDateCode, bmTraps=bmTraps, infoDescr=infoDescr, portErrorCountFailure=portErrorCountFailure, internalMgmtWarning=internalMgmtWarning, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portLimiterPacketType=portLimiterPacketType, adminAgentPhysAddress=adminAgentPhysAddress, adminAlarmM2=adminAlarmM2, portDefaultVlanId=portDefaultVlanId, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, switchInternalVoltageFailure=switchInternalVoltageFailure, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portAdminState=portAdminState, portAcApSetup=portAcApSetup, portDescr=portDescr, portPoeAdminState=portPoeAdminState, portErrorCounter=portErrorCounter, sfpInfoWavelength=sfpInfoWavelength, infoNewMacAddr=infoNewMacAddr, infoLastSfpEventMessage=infoLastSfpEventMessage, adminUnsecureVlanId=adminUnsecureVlanId, portPrioDot1p=portPrioDot1p, portName=portName, switchPoeOverloadFailure=switchPoeOverloadFailure, portLinkChange=portLinkChange, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpInfoLength50um=sfpInfoLength50um, portSpeedDuplexSetup=portSpeedDuplexSetup, infoPoeInputPower=infoPoeInputPower, switchIndustrialAlarmM2=switchIndustrialAlarmM2, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, switchMgmtAuthFailure=switchMgmtAuthFailure, bmSwitchVlan=bmSwitchVlan, adminAlarmNameM1=adminAlarmNameM1, switchFunctionInputAlarm=switchFunctionInputAlarm, bmSwitchSfp=bmSwitchSfp, bmSwitchPort=bmSwitchPort, PYSNMP_MODULE_ID=bmSwitchMIB, portNewMacAddress=portNewMacAddress, portSecurityMacAddr3=portSecurityMacAddr3, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, switchPoeVoltageFailure=switchPoeVoltageFailure, sfpInfoConnectorDescr=sfpInfoConnectorDescr, bmSwitchMIB=bmSwitchMIB, infoUnauthIpAddr=infoUnauthIpAddr, infoNoOfPorts=infoNoOfPorts, infoPowerVoltage2500=infoPowerVoltage2500, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portSecurityMacAddr2=portSecurityMacAddr2, infoManufactureDate=infoManufactureDate, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portLoopBcastFailure=portLoopBcastFailure, bmSwitchPortEntry=bmSwitchPortEntry, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portLinkType=portLinkType, infoTemperature=infoTemperature, adminMgmtAccessList=adminMgmtAccessList, adminAgentVlanId=adminAgentVlanId, sfpInfoSerialNumber=sfpInfoSerialNumber, portPoeCurrent=portPoeCurrent)
