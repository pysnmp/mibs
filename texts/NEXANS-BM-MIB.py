...
Integer32, IpAddress, Bits, Gauge32, Unsigned32, Counter32, ObjectIdentity, Counter64, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Bits", "Gauge32", "Unsigned32", "Counter32", "ObjectIdentity", "Counter64", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "NotificationType", "iso")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoFunctionInputStateF1=infoFunctionInputStateF1, bmSwitchMIB=bmSwitchMIB, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoTotalConfigChanges=infoTotalConfigChanges, adminAlarmM1=adminAlarmM1, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoType=infoType, bmSwitchSfpTable=bmSwitchSfpTable, portLinkType=portLinkType, infoUnauthIpAddr=infoUnauthIpAddr, portSecurityMacAddr3=portSecurityMacAddr3, portPoeVoltage=portPoeVoltage, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, switchPoeVoltageFailure=switchPoeVoltageFailure, portVoiceVlanId=portVoiceVlanId, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portPoeOverloadFailure=portPoeOverloadFailure, portLEDGreen=portLEDGreen, radiusPortSecurityReject=radiusPortSecurityReject, adminMemoryCardMode=adminMemoryCardMode, infoSwitchHardwareVersion=infoSwitchHardwareVersion, bmSwitchSfp=bmSwitchSfp, internalMgmtWarning=internalMgmtWarning, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portBandwidthLimitTxd=portBandwidthLimitTxd, portErrorCountFailure=portErrorCountFailure, portLEDYellow=portLEDYellow, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpInfoPartNumber=sfpInfoPartNumber, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, bmSwitchSfpEntry=bmSwitchSfpEntry, bmSwitchVlan=bmSwitchVlan, portErrorCounter=portErrorCounter, portNewMacAddress=portNewMacAddress, switchFunctionInputAlarm=switchFunctionInputAlarm, sfpInfoWavelength=sfpInfoWavelength, bmTraps=bmTraps, infoAlarmStateM2=infoAlarmStateM2, sfpInfoLength62um=sfpInfoLength62um, infoLastSfpEventMessage=infoLastSfpEventMessage, portSecurityForwardingState=portSecurityForwardingState, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portPoePowerLimit=portPoePowerLimit, infoSeriesNo=infoSeriesNo, portName=portName, bmSwitchInfo=bmSwitchInfo, adminSwitchPortMirror=adminSwitchPortMirror, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminAgentNetmask=adminAgentNetmask, switchMgmtAuthFailure=switchMgmtAuthFailure, adminAlarmNameM1=adminAlarmNameM1, portDefaultPrioQueue=portDefaultPrioQueue, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, adminFunctionInputNameF1=adminFunctionInputNameF1, adminLedGlobalMode=adminLedGlobalMode, switchConfigurationChanged=switchConfigurationChanged, adminTftpAccess=adminTftpAccess, infoProductNo=infoProductNo, bmSwitchPortEntry=bmSwitchPortEntry, portSecurityMacAddr1=portSecurityMacAddr1, infoNewMacAddr=infoNewMacAddr, portSpeedDuplexSetup=portSpeedDuplexSetup, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portLinkState=portLinkState, infoSecurityFailMacAddr=infoSecurityFailMacAddr, tftpMessage=tftpMessage, adminAgentPhysAddress=adminAgentPhysAddress, sfpEvent=sfpEvent, sfpInfoDateCode=sfpInfoDateCode, sfpInfoLength9um=sfpInfoLength9um, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, bmSwitchPortTable=bmSwitchPortTable, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminSnmpMacTableMode=adminSnmpMacTableMode, portBandwidthLimitRxd=portBandwidthLimitRxd, adminAlarmM2=adminAlarmM2, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, infoManufactureDate=infoManufactureDate, switchInternalVoltageFailure=switchInternalVoltageFailure, portAcApSetup=portAcApSetup, portAdminState=portAdminState, portDescr=portDescr, switchTemperatureFailure=switchTemperatureFailure, adminUnsecureVlanId=adminUnsecureVlanId, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, vlanIndex=vlanIndex, portPoeCurrent=portPoeCurrent, portLinkChange=portLinkChange, radiusMgmtAuthReject=radiusMgmtAuthReject, portSecurityAdminState=portSecurityAdminState, vlanId=vlanId, sfpDiagTemperature=sfpDiagTemperature, adminAgentVlanId=adminAgentVlanId, bmSwitchVlanTable=bmSwitchVlanTable, sfpInfoVendorName=sfpInfoVendorName, PYSNMP_MODULE_ID=bmSwitchMIB, portLimiterPacketType=portLimiterPacketType, portPoeAdminState=portPoeAdminState, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoPoeInputPower=infoPoeInputPower, infoNoOfPorts=infoNoOfPorts, portPrioDot1p=portPrioDot1p, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portIndex=portIndex, sfpPortIndex=sfpPortIndex, vlanDescr=vlanDescr, portSecurityMacAddr2=portSecurityMacAddr2, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpInfoBitRate=sfpInfoBitRate, portLoopBcastFailure=portLoopBcastFailure, adminAgentIpAddress=adminAgentIpAddress, adminMgmtAccessList=adminMgmtAccessList, infoTemperature=infoTemperature, clientRemoved=clientRemoved, bmSwitchPort=bmSwitchPort, sfpState=sfpState, adminReset=adminReset, portPrioIp=portPrioIp, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoPowerVoltage2500=infoPowerVoltage2500, bmSwitchVlanEntry=bmSwitchVlanEntry, bmSwitchAdmin=bmSwitchAdmin, adminAlarmNameM2=adminAlarmNameM2, infoPowerVoltage3300=infoPowerVoltage3300, portErrorDisabled=portErrorDisabled, infoDescr=infoDescr, infoPoeInputVoltage=infoPoeInputVoltage, sfpInfoSerialNumber=sfpInfoSerialNumber, portSecurityFailure=portSecurityFailure, infoLastTftpMessage=infoLastTftpMessage, infoSerie=infoSerie, infoNoOfReboots=infoNoOfReboots, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portTrunkingMode=portTrunkingMode, sfpInfoRevisionNumber=sfpInfoRevisionNumber, adminAgentPrioValue=adminAgentPrioValue, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portDefaultVlanId=portDefaultVlanId, adminAgentDhcp=adminAgentDhcp, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, switchPoeOverloadFailure=switchPoeOverloadFailure, sfpInfoLength50um=sfpInfoLength50um, infoAlarmStateM1=infoAlarmStateM1, portPoePower=portPoePower, portRemoteFault=portRemoteFault)
