...
# Produced by pysmi-1.1.12 at Tue Dec  3 11:43:25 2024
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, infoLastSfpEventMessage=infoLastSfpEventMessage, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminLedGlobalMode=adminLedGlobalMode, adminAgentPhysAddress=adminAgentPhysAddress, portSecurityForwardingState=portSecurityForwardingState, portLinkState=portLinkState, infoNoOfReboots=infoNoOfReboots, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portSecurityMacAddr3=portSecurityMacAddr3, portVoiceVlanId=portVoiceVlanId, sfpInfoPartNumber=sfpInfoPartNumber, portPoePowerLimit=portPoePowerLimit, portSpeedDuplexSetup=portSpeedDuplexSetup, portLinkChange=portLinkChange, adminAlarmM2=adminAlarmM2, portPrioDot1p=portPrioDot1p, infoUnauthIpAddr=infoUnauthIpAddr, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portPoeOverloadFailure=portPoeOverloadFailure, bmSwitchVlan=bmSwitchVlan, portIndex=portIndex, switchMgmtAuthFailure=switchMgmtAuthFailure, radiusPortSecurityReject=radiusPortSecurityReject, portLimiterPacketType=portLimiterPacketType, radiusMgmtAuthReject=radiusMgmtAuthReject, adminAgentIpAddress=adminAgentIpAddress, vlanDescr=vlanDescr, bmSwitchAdmin=bmSwitchAdmin, infoSerie=infoSerie, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portPrioIp=portPrioIp, bmSwitchMIB=bmSwitchMIB, adminAgentNetmask=adminAgentNetmask, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminAlarmNameM1=adminAlarmNameM1, infoProductNo=infoProductNo, sfpState=sfpState, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpInfoBitRate=sfpInfoBitRate, adminMgmtAccessList=adminMgmtAccessList, PYSNMP_MODULE_ID=bmSwitchMIB, adminReset=adminReset, bmSwitchSfp=bmSwitchSfp, infoNewMacAddr=infoNewMacAddr, adminFunctionInputNameF1=adminFunctionInputNameF1, portBandwidthLimitRxd=portBandwidthLimitRxd, infoPowerVoltage2500=infoPowerVoltage2500, switchPoeOverloadFailure=switchPoeOverloadFailure, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoFunctionInputStateF1=infoFunctionInputStateF1, portSecurityAdminState=portSecurityAdminState, infoTemperature=infoTemperature, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoNoOfPorts=infoNoOfPorts, infoSeriesNo=infoSeriesNo, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpInfoSerialNumber=sfpInfoSerialNumber, portLinkType=portLinkType, portPoePower=portPoePower, adminAgentPrioValue=adminAgentPrioValue, bmSwitchPortEntry=bmSwitchPortEntry, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpInfoVendorName=sfpInfoVendorName, tftpMessage=tftpMessage, infoPowerVoltage3300=infoPowerVoltage3300, portErrorDisabled=portErrorDisabled, sfpPortIndex=sfpPortIndex, vlanId=vlanId, infoPoeInputVoltage=infoPoeInputVoltage, infoType=infoType, portPoeCurrent=portPoeCurrent, bmSwitchPort=bmSwitchPort, infoAlarmStateM1=infoAlarmStateM1, bmTraps=bmTraps, bmSwitchInfo=bmSwitchInfo, bmSwitchPortTable=bmSwitchPortTable, portLEDYellow=portLEDYellow, adminAgentDhcp=adminAgentDhcp, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portLEDGreen=portLEDGreen, adminAgentVlanId=adminAgentVlanId, portName=portName, portErrorCounter=portErrorCounter, portErrorCountFailure=portErrorCountFailure, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, bmSwitchVlanTable=bmSwitchVlanTable, sfpInfoLength9um=sfpInfoLength9um, infoPoeInputPower=infoPoeInputPower, infoAlarmStateM2=infoAlarmStateM2, infoDescr=infoDescr, portSecurityMacAddr2=portSecurityMacAddr2, portSecurityFailure=portSecurityFailure, adminMemoryCardMode=adminMemoryCardMode, infoLastTftpMessage=infoLastTftpMessage, portAcApSetup=portAcApSetup, adminAlarmM1=adminAlarmM1, portTrunkingMode=portTrunkingMode, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portNewMacAddress=portNewMacAddress, adminAlarmNameM2=adminAlarmNameM2, switchInternalVoltageFailure=switchInternalVoltageFailure, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoTotalConfigChanges=infoTotalConfigChanges, sfpInfoLength62um=sfpInfoLength62um, switchConfigurationChanged=switchConfigurationChanged, internalMgmtWarning=internalMgmtWarning, sfpDiagTemperature=sfpDiagTemperature, adminSwitchPortMirror=adminSwitchPortMirror, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, adminUnsecureVlanId=adminUnsecureVlanId, switchIndustrialAlarmM1=switchIndustrialAlarmM1, vlanIndex=vlanIndex, sfpEvent=sfpEvent, adminSnmpMacTableMode=adminSnmpMacTableMode, portRemoteFault=portRemoteFault, portPoeAdminState=portPoeAdminState, adminTftpAccess=adminTftpAccess, portDefaultPrioQueue=portDefaultPrioQueue, switchTemperatureFailure=switchTemperatureFailure, portDefaultVlanId=portDefaultVlanId, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portLoopBcastFailure=portLoopBcastFailure, switchPoeVoltageFailure=switchPoeVoltageFailure, portDescr=portDescr, portSecurityMacAddr1=portSecurityMacAddr1, infoManufactureDate=infoManufactureDate, sfpInfoDateCode=sfpInfoDateCode, sfpInfoWavelength=sfpInfoWavelength, bmSwitchSfpTable=bmSwitchSfpTable, switchFunctionInputAlarm=switchFunctionInputAlarm, portPoeVoltage=portPoeVoltage, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpInfoConnectorDescr=sfpInfoConnectorDescr, sfpInfoLength50um=sfpInfoLength50um, portAdminState=portAdminState, portBandwidthLimitTxd=portBandwidthLimitTxd, clientRemoved=clientRemoved)
