...
mibBuilder.exportSymbols("NEXANS-BM-MIB", vlanIndex=vlanIndex, portSecurityForwardingState=portSecurityForwardingState, infoAlarmStateM2=infoAlarmStateM2, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, PYSNMP_MODULE_ID=bmSwitchMIB, portName=portName, portPoeCurrent=portPoeCurrent, portPoePowerLimit=portPoePowerLimit, bmSwitchPort=bmSwitchPort, infoPowerVoltage3300=infoPowerVoltage3300, portErrorCounter=portErrorCounter, portLEDGreen=portLEDGreen, portSecurityFailure=portSecurityFailure, switchConfigurationChanged=switchConfigurationChanged, portDefaultPrioQueue=portDefaultPrioQueue, clientRemoved=clientRemoved, adminReset=adminReset, portPoeVoltage=portPoeVoltage, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoNoOfReboots=infoNoOfReboots, switchPoeVoltageFailure=switchPoeVoltageFailure, adminAgentVlanId=adminAgentVlanId, bmSwitchSfp=bmSwitchSfp, bmSwitchVlanEntry=bmSwitchVlanEntry, switchPoeOverloadFailure=switchPoeOverloadFailure, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpInfoSerialNumber=sfpInfoSerialNumber, adminLedGlobalMode=adminLedGlobalMode, infoTemperature=infoTemperature, portNewMacAddress=portNewMacAddress, bmSwitchPortEntry=bmSwitchPortEntry, adminAgentNetmask=adminAgentNetmask, adminAgentPhysAddress=adminAgentPhysAddress, adminAlarmNameM2=adminAlarmNameM2, bmSwitchVlanTable=bmSwitchVlanTable, bmTraps=bmTraps, bmSwitchAdmin=bmSwitchAdmin, sfpInfoWavelength=sfpInfoWavelength, infoNewMacAddr=infoNewMacAddr, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, radiusPortSecurityReject=radiusPortSecurityReject, sfpPortIndex=sfpPortIndex, portDescr=portDescr, sfpState=sfpState, switchFunctionInputAlarm=switchFunctionInputAlarm, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoNoOfPorts=infoNoOfPorts, adminSnmpMacTableMode=adminSnmpMacTableMode, sfpInfoVendorName=sfpInfoVendorName, infoManufactureDate=infoManufactureDate, portPrioDot1p=portPrioDot1p, infoUnauthIpAddr=infoUnauthIpAddr, portSecurityAdminState=portSecurityAdminState, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpInfoBitRate=sfpInfoBitRate, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminAlarmM1=adminAlarmM1, portLEDYellow=portLEDYellow, sfpInfoPartNumber=sfpInfoPartNumber, bmSwitchSfpTable=bmSwitchSfpTable, sfpEvent=sfpEvent, infoAlarmStateM1=infoAlarmStateM1, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoType=infoType, bmSwitchPortTable=bmSwitchPortTable, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpInfoLength9um=sfpInfoLength9um, portLinkState=portLinkState, sfpInfoDateCode=sfpInfoDateCode, sfpDiagRxIntputPower=sfpDiagRxIntputPower, radiusMgmtAuthReject=radiusMgmtAuthReject, portPoePower=portPoePower, adminSwitchPortMirror=adminSwitchPortMirror, bmSwitchVlan=bmSwitchVlan, infoSerie=infoSerie, sfpDiagTemperature=sfpDiagTemperature, portSecurityMacAddr2=portSecurityMacAddr2, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminTftpAccess=adminTftpAccess, infoProductNo=infoProductNo, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portAcApSetup=portAcApSetup, portDefaultVlanId=portDefaultVlanId, switchInternalVoltageFailure=switchInternalVoltageFailure, infoTotalConfigChanges=infoTotalConfigChanges, portSecurityMacAddr1=portSecurityMacAddr1, adminMgmtAccessList=adminMgmtAccessList, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpInfoLength50um=sfpInfoLength50um, portVoiceVlanId=portVoiceVlanId, portLimiterPacketType=portLimiterPacketType, switchMgmtAuthFailure=switchMgmtAuthFailure, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminAgentDhcp=adminAgentDhcp, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoSecurityFailMacAddr=infoSecurityFailMacAddr, infoPowerVoltage2500=infoPowerVoltage2500, portErrorCountFailure=portErrorCountFailure, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoSeriesNo=infoSeriesNo, infoLastTftpMessage=infoLastTftpMessage, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portLinkChange=portLinkChange, vlanDescr=vlanDescr, internalMgmtWarning=internalMgmtWarning, switchTemperatureFailure=switchTemperatureFailure, adminAlarmNameM1=adminAlarmNameM1, portSecurityMacAddr3=portSecurityMacAddr3, adminFunctionInputNameF1=adminFunctionInputNameF1, adminMemoryCardMode=adminMemoryCardMode, portAdminState=portAdminState, adminAgentIpAddress=adminAgentIpAddress, portBandwidthLimitTxd=portBandwidthLimitTxd, infoDescr=infoDescr, portRemoteFault=portRemoteFault, portTrunkingMode=portTrunkingMode, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portPoeOverloadFailure=portPoeOverloadFailure, infoPoeInputPower=infoPoeInputPower, bmSwitchMIB=bmSwitchMIB, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portBandwidthLimitRxd=portBandwidthLimitRxd, infoFunctionInputStateF1=infoFunctionInputStateF1, adminUnsecureVlanId=adminUnsecureVlanId, portIndex=portIndex, tftpMessage=tftpMessage, portLoopBcastFailure=portLoopBcastFailure, portLinkType=portLinkType, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, bmSwitchInfo=bmSwitchInfo, infoPoeInputVoltage=infoPoeInputVoltage, vlanId=vlanId, portErrorDisabled=portErrorDisabled, infoLastSfpEventMessage=infoLastSfpEventMessage, sfpInfoLength62um=sfpInfoLength62um, adminAgentPrioValue=adminAgentPrioValue, portPrioIp=portPrioIp, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portPoeAdminState=portPoeAdminState, adminAlarmM2=adminAlarmM2)
