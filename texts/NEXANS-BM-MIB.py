...
TimeTicks, ObjectIdentity, iso, MibIdentifier, IpAddress, Unsigned32, ModuleIdentity, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "iso", "MibIdentifier", "IpAddress", "Unsigned32", "ModuleIdentity", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "Counter64", "Bits")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portTrunkingMode=portTrunkingMode, portSecurityFailure=portSecurityFailure, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, bmSwitchPortTable=bmSwitchPortTable, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpInfoPartNumber=sfpInfoPartNumber, portPoeAdminState=portPoeAdminState, bmSwitchInfo=bmSwitchInfo, adminSnmpMacTableMode=adminSnmpMacTableMode, infoDescr=infoDescr, portSecurityAdminState=portSecurityAdminState, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoUnauthIpAddr=infoUnauthIpAddr, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoAlarmStateM1=infoAlarmStateM1, portDescr=portDescr, sfpState=sfpState, infoLastTftpMessage=infoLastTftpMessage, adminLedGlobalMode=adminLedGlobalMode, sfpInfoLength62um=sfpInfoLength62um, sfpInfoBitRate=sfpInfoBitRate, infoPoeInputVoltage=infoPoeInputVoltage, sfpInfoWavelength=sfpInfoWavelength, adminFunctionInputNameF1=adminFunctionInputNameF1, portPoeVoltage=portPoeVoltage, bmSwitchSfpTable=bmSwitchSfpTable, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminMemoryCardMode=adminMemoryCardMode, switchInternalVoltageFailure=switchInternalVoltageFailure, portErrorCountFailure=portErrorCountFailure, radiusPortSecurityReject=radiusPortSecurityReject, portRemoteFault=portRemoteFault, bmSwitchSfp=bmSwitchSfp, switchIndustrialAlarmM2=switchIndustrialAlarmM2, radiusMgmtAuthReject=radiusMgmtAuthReject, portAcApSetup=portAcApSetup, portSecurityMacAddr3=portSecurityMacAddr3, portLEDGreen=portLEDGreen, infoManufactureDate=infoManufactureDate, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminMgmtAccessList=adminMgmtAccessList, portSecurityForwardingState=portSecurityForwardingState, switchConfigurationChanged=switchConfigurationChanged, portLoopBcastFailure=portLoopBcastFailure, portSecurityMacAddr1=portSecurityMacAddr1, portName=portName, sfpDiagTemperature=sfpDiagTemperature, portLEDYellow=portLEDYellow, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminAgentPhysAddress=adminAgentPhysAddress, portLinkState=portLinkState, portPrioIp=portPrioIp, portPrioDot1p=portPrioDot1p, adminAgentVlanId=adminAgentVlanId, portPoeCurrent=portPoeCurrent, portSpeedDuplexSetup=portSpeedDuplexSetup, bmSwitchPort=bmSwitchPort, infoNewMacAddr=infoNewMacAddr, infoTemperature=infoTemperature, infoAlarmStateM2=infoAlarmStateM2, switchTemperatureFailure=switchTemperatureFailure, portAdminState=portAdminState, portLinkType=portLinkType, portLimiterPacketType=portLimiterPacketType, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portVoiceVlanId=portVoiceVlanId, sfpInfoLength9um=sfpInfoLength9um, infoNoOfPorts=infoNoOfPorts, vlanIndex=vlanIndex, adminAgentIpAddress=adminAgentIpAddress, adminAlarmNameM1=adminAlarmNameM1, switchPoeVoltageFailure=switchPoeVoltageFailure, infoNoOfReboots=infoNoOfReboots, portDefaultVlanId=portDefaultVlanId, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portErrorDisabled=portErrorDisabled, clientRemoved=clientRemoved, infoSerie=infoSerie, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminTftpAccess=adminTftpAccess, infoFunctionInputStateF1=infoFunctionInputStateF1, adminAlarmM2=adminAlarmM2, switchFunctionInputAlarm=switchFunctionInputAlarm, infoPowerVoltage2500=infoPowerVoltage2500, adminAgentDhcp=adminAgentDhcp, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpEvent=sfpEvent, adminUnsecureVlanId=adminUnsecureVlanId, portLinkChange=portLinkChange, infoProductNo=infoProductNo, portPoeOverloadFailure=portPoeOverloadFailure, infoPowerVoltage3300=infoPowerVoltage3300, adminSwitchPortMirror=adminSwitchPortMirror, portErrorCounter=portErrorCounter, portNewMacAddress=portNewMacAddress, adminAgentPrioValue=adminAgentPrioValue, bmSwitchMIB=bmSwitchMIB, adminAlarmNameM2=adminAlarmNameM2, sfpPortIndex=sfpPortIndex, portDefaultPrioQueue=portDefaultPrioQueue, PYSNMP_MODULE_ID=bmSwitchMIB, bmSwitchVlan=bmSwitchVlan, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portIndex=portIndex, bmSwitchVlanTable=bmSwitchVlanTable, infoTotalConfigChanges=infoTotalConfigChanges, vlanDescr=vlanDescr, bmSwitchPortEntry=bmSwitchPortEntry, bmTraps=bmTraps, tftpMessage=tftpMessage, portBandwidthLimitRxd=portBandwidthLimitRxd, sfpInfoRevisionNumber=sfpInfoRevisionNumber, adminAlarmM1=adminAlarmM1, adminAgentNetmask=adminAgentNetmask, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpInfoVendorName=sfpInfoVendorName, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portPoePowerLimit=portPoePowerLimit, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portPoePower=portPoePower, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoSeriesNo=infoSeriesNo, vlanId=vlanId, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoPoeInputPower=infoPoeInputPower, infoLastSfpEventMessage=infoLastSfpEventMessage, sfpInfoDateCode=sfpInfoDateCode, sfpInfoLength50um=sfpInfoLength50um, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portSecurityMacAddr2=portSecurityMacAddr2, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminReset=adminReset, infoType=infoType, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpDiagTxOutputPower=sfpDiagTxOutputPower, internalMgmtWarning=internalMgmtWarning, bmSwitchAdmin=bmSwitchAdmin, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, switchPoeOverloadFailure=switchPoeOverloadFailure, switchMgmtAuthFailure=switchMgmtAuthFailure, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit)
