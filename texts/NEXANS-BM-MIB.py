...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portIndex=portIndex, sfpEvent=sfpEvent, portBandwidthLimitRxd=portBandwidthLimitRxd, infoPoeInputVoltage=infoPoeInputVoltage, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portRemoteFault=portRemoteFault, tftpMessage=tftpMessage, sfpInfoSerialNumber=sfpInfoSerialNumber, bmSwitchPortTable=bmSwitchPortTable, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminAgentVlanId=adminAgentVlanId, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, vlanId=vlanId, infoProductNo=infoProductNo, vlanDescr=vlanDescr, switchPoeOverloadFailure=switchPoeOverloadFailure, bmSwitchVlan=bmSwitchVlan, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminUnsecureVlanId=adminUnsecureVlanId, adminAlarmNameM1=adminAlarmNameM1, radiusMgmtAuthReject=radiusMgmtAuthReject, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoAlarmStateM1=infoAlarmStateM1, infoNewMacAddr=infoNewMacAddr, sfpInfoLength62um=sfpInfoLength62um, sfpInfoDateCode=sfpInfoDateCode, portLimiterPacketType=portLimiterPacketType, bmSwitchSfp=bmSwitchSfp, bmSwitchPort=bmSwitchPort, adminAgentPhysAddress=adminAgentPhysAddress, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, bmSwitchAdmin=bmSwitchAdmin, portErrorCountFailure=portErrorCountFailure, sfpDiagTemperature=sfpDiagTemperature, adminSwitchPortMirror=adminSwitchPortMirror, portPoeAdminState=portPoeAdminState, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, infoAlarmStateM2=infoAlarmStateM2, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portSecurityAdminState=portSecurityAdminState, bmSwitchMIB=bmSwitchMIB, adminMemoryCardMode=adminMemoryCardMode, portLinkChange=portLinkChange, switchPoeVoltageFailure=switchPoeVoltageFailure, portBandwidthLimitTxd=portBandwidthLimitTxd, portName=portName, portPrioDot1p=portPrioDot1p, infoFunctionInputStateF1=infoFunctionInputStateF1, infoLastTftpMessage=infoLastTftpMessage, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portPoeVoltage=portPoeVoltage, switchTemperatureFailure=switchTemperatureFailure, portErrorCounter=portErrorCounter, bmSwitchSfpEntry=bmSwitchSfpEntry, switchConfigurationChanged=switchConfigurationChanged, infoTemperature=infoTemperature, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portPoePower=portPoePower, portPoeCurrent=portPoeCurrent, bmSwitchInfo=bmSwitchInfo, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portVoiceVlanId=portVoiceVlanId, sfpInfoLength9um=sfpInfoLength9um, adminAgentDhcp=adminAgentDhcp, infoSerie=infoSerie, infoManufactureDate=infoManufactureDate, portSecurityMacAddr1=portSecurityMacAddr1, portLinkType=portLinkType, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminAgentPrioValue=adminAgentPrioValue, adminMgmtAccessList=adminMgmtAccessList, sfpInfoVendorName=sfpInfoVendorName, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portDefaultPrioQueue=portDefaultPrioQueue, clientRemoved=clientRemoved, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, switchMgmtAuthFailure=switchMgmtAuthFailure, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portSecurityFailure=portSecurityFailure, sfpPortIndex=sfpPortIndex, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, infoType=infoType, infoPoeInputPower=infoPoeInputPower, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portSecurityMacAddr3=portSecurityMacAddr3, infoUnauthIpAddr=infoUnauthIpAddr, portTrunkingMode=portTrunkingMode, portDefaultVlanId=portDefaultVlanId, portSecurityMacAddr2=portSecurityMacAddr2, portLoopBcastFailure=portLoopBcastFailure, switchFunctionInputAlarm=switchFunctionInputAlarm, bmSwitchPortEntry=bmSwitchPortEntry, portAdminState=portAdminState, switchInternalVoltageFailure=switchInternalVoltageFailure, infoSeriesNo=infoSeriesNo, portLEDYellow=portLEDYellow, adminLedGlobalMode=adminLedGlobalMode, portNewMacAddress=portNewMacAddress, PYSNMP_MODULE_ID=bmSwitchMIB, infoTotalConfigChanges=infoTotalConfigChanges, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoPowerVoltage2500=infoPowerVoltage2500, sfpInfoWavelength=sfpInfoWavelength, infoPowerVoltage3300=infoPowerVoltage3300, adminSnmpMacTableMode=adminSnmpMacTableMode, portPoeOverloadFailure=portPoeOverloadFailure, infoNoOfPorts=infoNoOfPorts, portAcApSetup=portAcApSetup, portPrioIp=portPrioIp, bmSwitchSfpTable=bmSwitchSfpTable, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portLEDGreen=portLEDGreen, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portDescr=portDescr, adminFunctionInputNameF1=adminFunctionInputNameF1, infoNoOfReboots=infoNoOfReboots, internalMgmtWarning=internalMgmtWarning, infoLastSfpEventMessage=infoLastSfpEventMessage, adminAgentIpAddress=adminAgentIpAddress, sfpInfoLength50um=sfpInfoLength50um, infoDescr=infoDescr, portErrorDisabled=portErrorDisabled, portLinkState=portLinkState, bmSwitchVlanTable=bmSwitchVlanTable, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminReset=adminReset, adminAgentNetmask=adminAgentNetmask, bmSwitchVlanEntry=bmSwitchVlanEntry, bmTraps=bmTraps, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminAlarmNameM2=adminAlarmNameM2, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portPoePowerLimit=portPoePowerLimit, sfpInfoBitRate=sfpInfoBitRate, vlanIndex=vlanIndex, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpState=sfpState, sfpInfoPartNumber=sfpInfoPartNumber, adminAlarmM2=adminAlarmM2, radiusPortSecurityReject=radiusPortSecurityReject, adminTftpAccess=adminTftpAccess, portSecurityForwardingState=portSecurityForwardingState, adminAlarmM1=adminAlarmM1)
