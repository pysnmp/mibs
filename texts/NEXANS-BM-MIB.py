...
Bits, NotificationType, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Counter32, Gauge32, ModuleIdentity, Integer32, iso, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Counter32", "Gauge32", "ModuleIdentity", "Integer32", "iso", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portSecurityForwardingState=portSecurityForwardingState, bmSwitchAdmin=bmSwitchAdmin, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoAlarmStateM1=infoAlarmStateM1, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminMgmtAccessList=adminMgmtAccessList, portPoeOverloadFailure=portPoeOverloadFailure, infoPowerVoltage3300=infoPowerVoltage3300, infoManufactureDate=infoManufactureDate, radiusPortSecurityReject=radiusPortSecurityReject, adminAlarmM1=adminAlarmM1, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminTftpAccess=adminTftpAccess, sfpInfoRevisionNumber=sfpInfoRevisionNumber, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portDefaultVlanId=portDefaultVlanId, portLinkType=portLinkType, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portLinkState=portLinkState, portBandwidthLimitRxd=portBandwidthLimitRxd, bmSwitchSfpTable=bmSwitchSfpTable, sfpInfoDateCode=sfpInfoDateCode, infoPowerVoltage2500=infoPowerVoltage2500, radiusMgmtAuthReject=radiusMgmtAuthReject, infoAlarmStateM2=infoAlarmStateM2, portLinkChange=portLinkChange, portSecurityMacAddr3=portSecurityMacAddr3, sfpInfoSerialNumber=sfpInfoSerialNumber, adminAlarmNameM1=adminAlarmNameM1, bmSwitchVlanTable=bmSwitchVlanTable, sfpInfoLength62um=sfpInfoLength62um, portSecurityAdminState=portSecurityAdminState, adminMemoryCardMode=adminMemoryCardMode, infoPoeInputVoltage=infoPoeInputVoltage, bmSwitchInfo=bmSwitchInfo, infoNewMacAddr=infoNewMacAddr, infoTotalConfigChanges=infoTotalConfigChanges, PYSNMP_MODULE_ID=bmSwitchMIB, portAdminState=portAdminState, portBandwidthLimitTxd=portBandwidthLimitTxd, adminAgentIpAddress=adminAgentIpAddress, sfpState=sfpState, portRemoteFault=portRemoteFault, portDescr=portDescr, portDefaultPrioQueue=portDefaultPrioQueue, bmSwitchPort=bmSwitchPort, infoFunctionInputStateF1=infoFunctionInputStateF1, portLimiterPacketType=portLimiterPacketType, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminSwitchPortMirror=adminSwitchPortMirror, infoSeriesNo=infoSeriesNo, sfpInfoBitRate=sfpInfoBitRate, bmSwitchSfp=bmSwitchSfp, sfpEvent=sfpEvent, infoUnauthIpAddr=infoUnauthIpAddr, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portPrioDot1p=portPrioDot1p, portSecurityFailure=portSecurityFailure, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, switchPoeOverloadFailure=switchPoeOverloadFailure, portErrorDisabled=portErrorDisabled, vlanIndex=vlanIndex, sfpDiagTemperature=sfpDiagTemperature, adminSnmpMacTableMode=adminSnmpMacTableMode, portErrorCounter=portErrorCounter, vlanDescr=vlanDescr, sfpInfoPartNumber=sfpInfoPartNumber, sfpInfoLength50um=sfpInfoLength50um, sfpInfoLength9um=sfpInfoLength9um, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpInfoWavelength=sfpInfoWavelength, infoTemperature=infoTemperature, portAcApSetup=portAcApSetup, infoType=infoType, infoNoOfPorts=infoNoOfPorts, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminAgentDhcp=adminAgentDhcp, bmSwitchPortTable=bmSwitchPortTable, portPoePower=portPoePower, sfpInfoVendorName=sfpInfoVendorName, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, bmSwitchVlanEntry=bmSwitchVlanEntry, internalMgmtWarning=internalMgmtWarning, adminAlarmNameM2=adminAlarmNameM2, portPoeCurrent=portPoeCurrent, adminAgentNetmask=adminAgentNetmask, adminAgentPrioValue=adminAgentPrioValue, portSecurityMacAddr1=portSecurityMacAddr1, adminAlarmM2=adminAlarmM2, clientRemoved=clientRemoved, portTrunkingMode=portTrunkingMode, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminUnsecureVlanId=adminUnsecureVlanId, portPoeVoltage=portPoeVoltage, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, bmTraps=bmTraps, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, switchTemperatureFailure=switchTemperatureFailure, bmSwitchPortEntry=bmSwitchPortEntry, adminSwitchVlanTableMode=adminSwitchVlanTableMode, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoDescr=infoDescr, portName=portName, switchMgmtAuthFailure=switchMgmtAuthFailure, portLEDYellow=portLEDYellow, infoLastSfpEventMessage=infoLastSfpEventMessage, portIndex=portIndex, sfpDiagRxIntputPower=sfpDiagRxIntputPower, switchPoeVoltageFailure=switchPoeVoltageFailure, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpPortIndex=sfpPortIndex, bmSwitchSfpEntry=bmSwitchSfpEntry, portVoiceVlanId=portVoiceVlanId, adminAgentVlanId=adminAgentVlanId, portPoeAdminState=portPoeAdminState, switchConfigurationChanged=switchConfigurationChanged, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminAgentPhysAddress=adminAgentPhysAddress, adminReset=adminReset, portSecurityMacAddr2=portSecurityMacAddr2, infoPoeInputPower=infoPoeInputPower, adminLedGlobalMode=adminLedGlobalMode, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portPrioIp=portPrioIp, bmSwitchMIB=bmSwitchMIB, portLoopBcastFailure=portLoopBcastFailure, portErrorCountFailure=portErrorCountFailure, portLEDGreen=portLEDGreen, infoProductNo=infoProductNo, infoLastTftpMessage=infoLastTftpMessage, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, vlanId=vlanId, tftpMessage=tftpMessage, infoSerie=infoSerie, switchFunctionInputAlarm=switchFunctionInputAlarm, infoNoOfReboots=infoNoOfReboots, adminFunctionInputNameF1=adminFunctionInputNameF1, portNewMacAddress=portNewMacAddress, switchInternalVoltageFailure=switchInternalVoltageFailure, bmSwitchVlan=bmSwitchVlan, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portPoePowerLimit=portPoePowerLimit)
