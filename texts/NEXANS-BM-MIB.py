...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portBandwidthLimitTxd=portBandwidthLimitTxd, sfpInfoBitRate=sfpInfoBitRate, portErrorDisabled=portErrorDisabled, sfpEvent=sfpEvent, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpInfoLength9um=sfpInfoLength9um, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoAlarmStateM2=infoAlarmStateM2, portLinkType=portLinkType, infoPoeInputPower=infoPoeInputPower, portIndex=portIndex, infoSecurityFailMacAddr=infoSecurityFailMacAddr, bmSwitchPortEntry=bmSwitchPortEntry, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoSerie=infoSerie, portLinkState=portLinkState, bmSwitchMIB=bmSwitchMIB, infoPoeInputVoltage=infoPoeInputVoltage, adminMgmtAccessList=adminMgmtAccessList, switchFunctionInputAlarm=switchFunctionInputAlarm, adminTftpAccess=adminTftpAccess, adminAgentPhysAddress=adminAgentPhysAddress, portName=portName, bmSwitchSfpTable=bmSwitchSfpTable, bmSwitchPort=bmSwitchPort, portPrioDot1p=portPrioDot1p, adminFunctionInputNameF1=adminFunctionInputNameF1, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, sfpState=sfpState, sfpDiagTemperature=sfpDiagTemperature, portSpeedDuplexSetup=portSpeedDuplexSetup, infoLastTftpMessage=infoLastTftpMessage, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, sfpInfoDateCode=sfpInfoDateCode, infoNoOfPorts=infoNoOfPorts, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portDefaultPrioQueue=portDefaultPrioQueue, portSecurityAdminState=portSecurityAdminState, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminSnmpMacTableMode=adminSnmpMacTableMode, portPrioIp=portPrioIp, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, adminUnsecureVlanId=adminUnsecureVlanId, sfpDiagRxIntputPower=sfpDiagRxIntputPower, internalMgmtWarning=internalMgmtWarning, infoNewMacAddr=infoNewMacAddr, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portSecurityMacAddr3=portSecurityMacAddr3, bmTraps=bmTraps, adminAlarmM2=adminAlarmM2, portSecurityFailure=portSecurityFailure, portPoeOverloadFailure=portPoeOverloadFailure, portNewMacAddress=portNewMacAddress, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, infoType=infoType, infoUnauthIpAddr=infoUnauthIpAddr, portSecurityMacAddr1=portSecurityMacAddr1, bmSwitchAdmin=bmSwitchAdmin, portPoeAdminState=portPoeAdminState, adminMemoryCardMode=adminMemoryCardMode, portPoePowerLimit=portPoePowerLimit, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpInfoLength50um=sfpInfoLength50um, portTrunkingMode=portTrunkingMode, adminAgentDhcp=adminAgentDhcp, portAdminState=portAdminState, portSecurityForwardingState=portSecurityForwardingState, portLimiterPacketType=portLimiterPacketType, infoAlarmStateM1=infoAlarmStateM1, portAcApSetup=portAcApSetup, bmSwitchSfp=bmSwitchSfp, adminAgentIpAddress=adminAgentIpAddress, portLinkChange=portLinkChange, bmSwitchVlanTable=bmSwitchVlanTable, sfpInfoPartNumber=sfpInfoPartNumber, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portDefaultVlanId=portDefaultVlanId, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portLEDYellow=portLEDYellow, infoProductNo=infoProductNo, vlanIndex=vlanIndex, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, bmSwitchInfo=bmSwitchInfo, infoDescr=infoDescr, adminReset=adminReset, portDescr=portDescr, portLEDGreen=portLEDGreen, vlanId=vlanId, switchMgmtAuthFailure=switchMgmtAuthFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portSecurityMacAddr2=portSecurityMacAddr2, portVoiceVlanId=portVoiceVlanId, bmSwitchVlan=bmSwitchVlan, sfpPortIndex=sfpPortIndex, portPoePower=portPoePower, clientRemoved=clientRemoved, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, switchInternalVoltageFailure=switchInternalVoltageFailure, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminAgentNetmask=adminAgentNetmask, adminAlarmM1=adminAlarmM1, portPoeCurrent=portPoeCurrent, sfpInfoLength62um=sfpInfoLength62um, portErrorCounter=portErrorCounter, radiusPortSecurityReject=radiusPortSecurityReject, infoSeriesNo=infoSeriesNo, infoLastSfpEventMessage=infoLastSfpEventMessage, adminAlarmNameM2=adminAlarmNameM2, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpInfoWavelength=sfpInfoWavelength, portErrorCountFailure=portErrorCountFailure, switchConfigurationChanged=switchConfigurationChanged, sfpInfoSerialNumber=sfpInfoSerialNumber, infoNoOfReboots=infoNoOfReboots, infoTotalConfigChanges=infoTotalConfigChanges, portRemoteFault=portRemoteFault, adminLedGlobalMode=adminLedGlobalMode, adminAgentVlanId=adminAgentVlanId, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, switchPoeOverloadFailure=switchPoeOverloadFailure, switchTemperatureFailure=switchTemperatureFailure, sfpInfoVendorName=sfpInfoVendorName, tftpMessage=tftpMessage, portLoopBcastFailure=portLoopBcastFailure, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoTemperature=infoTemperature, infoPowerVoltage2500=infoPowerVoltage2500, portPoeVoltage=portPoeVoltage, switchPoeVoltageFailure=switchPoeVoltageFailure, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoFunctionInputStateF1=infoFunctionInputStateF1, portBandwidthLimitRxd=portBandwidthLimitRxd, bmSwitchPortTable=bmSwitchPortTable, PYSNMP_MODULE_ID=bmSwitchMIB, vlanDescr=vlanDescr, infoPowerVoltage3300=infoPowerVoltage3300, adminSwitchPortMirror=adminSwitchPortMirror, infoManufactureDate=infoManufactureDate, radiusMgmtAuthReject=radiusMgmtAuthReject, adminAlarmNameM1=adminAlarmNameM1, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, bmSwitchSfpEntry=bmSwitchSfpEntry, adminAgentPrioValue=adminAgentPrioValue, sfpDiagTxOutputPower=sfpDiagTxOutputPower)
