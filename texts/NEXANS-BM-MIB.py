...
# ASN.1 source NEXANS-BM-MIB
# Source digest sha256:e6411c1394a15bcda57591e09bbe66b182649fc5b30e7c4f7924606072d2ca87
...
if mibBuilder.loadTexts: bmSwitchMIB.setLastUpdated('2014-01-29 00:00')
...
bmSwitchPortTable = MibTable((1, 3, 6, 1, 4, 1, 266, 20, 3, 1), ).setMaxAccess("notaccessible")
...
bmSwitchPortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 266, 20, 3, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "NEXANS-BM-MIB", "portIndex"))
...
portName = MibTableColumn((1, 3, 6, 1, 4, 1, 266, 20, 3, 1, 1, 3), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 15)).clone('')).setMaxAccess("readwrite")
...
bmSwitchVlanTable = MibTable((1, 3, 6, 1, 4, 1, 266, 20, 4, 1), ).setMaxAccess("notaccessible")
...
bmSwitchVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 266, 20, 4, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "NEXANS-BM-MIB", "vlanIndex"))
...
bmSwitchSfpTable = MibTable((1, 3, 6, 1, 4, 1, 266, 20, 5, 1), ).setMaxAccess("notaccessible")
...
bmSwitchSfpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 266, 20, 5, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "NEXANS-BM-MIB", "sfpPortIndex"))
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", PYSNMP_MODULE_ID=bmSwitchMIB, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminAgentDhcp=adminAgentDhcp, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, adminAgentIpAddress=adminAgentIpAddress, adminAgentNetmask=adminAgentNetmask, adminAgentPhysAddress=adminAgentPhysAddress, adminAgentPrioValue=adminAgentPrioValue, adminAgentVlanId=adminAgentVlanId, adminAlarmM1=adminAlarmM1, adminAlarmM2=adminAlarmM2, adminAlarmNameM1=adminAlarmNameM1, adminAlarmNameM2=adminAlarmNameM2, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminFunctionInputNameF1=adminFunctionInputNameF1, adminLedGlobalMode=adminLedGlobalMode, adminMemoryCardMode=adminMemoryCardMode, adminMgmtAccessList=adminMgmtAccessList, adminReset=adminReset, adminSnmpMacTableMode=adminSnmpMacTableMode, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminSwitchPortMirror=adminSwitchPortMirror, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminTftpAccess=adminTftpAccess, adminUnsecureVlanId=adminUnsecureVlanId, bmSwitchAdmin=bmSwitchAdmin, bmSwitchInfo=bmSwitchInfo, bmSwitchMIB=bmSwitchMIB, bmSwitchPort=bmSwitchPort, bmSwitchPortEntry=bmSwitchPortEntry, bmSwitchPortTable=bmSwitchPortTable, bmSwitchSfp=bmSwitchSfp, bmSwitchSfpEntry=bmSwitchSfpEntry, bmSwitchSfpTable=bmSwitchSfpTable, bmSwitchVlan=bmSwitchVlan, bmSwitchVlanEntry=bmSwitchVlanEntry, bmSwitchVlanTable=bmSwitchVlanTable, bmTraps=bmTraps, clientRemoved=clientRemoved, infoAlarmStateM1=infoAlarmStateM1, infoAlarmStateM2=infoAlarmStateM2, infoDescr=infoDescr, infoFunctionInputStateF1=infoFunctionInputStateF1, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, infoLastSfpEventMessage=infoLastSfpEventMessage, infoLastTftpMessage=infoLastTftpMessage, infoManufactureDate=infoManufactureDate, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoNewMacAddr=infoNewMacAddr, infoNoOfPorts=infoNoOfPorts, infoNoOfReboots=infoNoOfReboots, infoPoeInputPower=infoPoeInputPower, infoPoeInputVoltage=infoPoeInputVoltage, infoPowerVoltage2500=infoPowerVoltage2500, infoPowerVoltage3300=infoPowerVoltage3300, infoProductNo=infoProductNo, infoSecurityFailMacAddr=infoSecurityFailMacAddr, infoSerie=infoSerie, infoSeriesNo=infoSeriesNo, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoTemperature=infoTemperature, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, infoTotalConfigChanges=infoTotalConfigChanges, infoType=infoType, infoUnauthIpAddr=infoUnauthIpAddr, internalMgmtWarning=internalMgmtWarning, portAcApSetup=portAcApSetup, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portAdminState=portAdminState, portBandwidthLimitRxd=portBandwidthLimitRxd, portBandwidthLimitTxd=portBandwidthLimitTxd, portDefaultPrioQueue=portDefaultPrioQueue, portDefaultVlanId=portDefaultVlanId, portDescr=portDescr, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portErrorCountFailure=portErrorCountFailure, portErrorCounter=portErrorCounter, portErrorDisabled=portErrorDisabled, portIndex=portIndex, portLEDGreen=portLEDGreen, portLEDYellow=portLEDYellow, portLimiterPacketType=portLimiterPacketType, portLinkChange=portLinkChange, portLinkState=portLinkState, portLinkType=portLinkType, portLoopBcastFailure=portLoopBcastFailure, portName=portName, portNewMacAddress=portNewMacAddress, portPoeAdminState=portPoeAdminState, portPoeCurrent=portPoeCurrent, portPoeOverloadFailure=portPoeOverloadFailure, portPoePower=portPoePower, portPoePowerLimit=portPoePowerLimit, portPoeVoltage=portPoeVoltage, portPrioDot1p=portPrioDot1p, portPrioIp=portPrioIp, portRemoteFault=portRemoteFault, portSecurityAdminState=portSecurityAdminState, portSecurityFailure=portSecurityFailure, portSecurityForwardingState=portSecurityForwardingState, portSecurityMacAddr1=portSecurityMacAddr1, portSecurityMacAddr2=portSecurityMacAddr2, portSecurityMacAddr3=portSecurityMacAddr3, portSpeedDuplexSetup=portSpeedDuplexSetup, portTrunkingMode=portTrunkingMode, portVoiceVlanId=portVoiceVlanId, radiusMgmtAuthReject=radiusMgmtAuthReject, radiusPortSecurityReject=radiusPortSecurityReject, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpDiagTemperature=sfpDiagTemperature, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, sfpEvent=sfpEvent, sfpInfoBitRate=sfpInfoBitRate, sfpInfoConnectorDescr=sfpInfoConnectorDescr, sfpInfoDateCode=sfpInfoDateCode, sfpInfoLength50um=sfpInfoLength50um, sfpInfoLength62um=sfpInfoLength62um, sfpInfoLength9um=sfpInfoLength9um, sfpInfoPartNumber=sfpInfoPartNumber, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpInfoVendorName=sfpInfoVendorName, sfpInfoWavelength=sfpInfoWavelength, sfpPortIndex=sfpPortIndex, sfpState=sfpState, switchConfigurationChanged=switchConfigurationChanged, switchFunctionInputAlarm=switchFunctionInputAlarm, switchIndustrialAlarmM1=switchIndustrialAlarmM1, switchIndustrialAlarmM2=switchIndustrialAlarmM2, switchInternalVoltageFailure=switchInternalVoltageFailure, switchMgmtAuthFailure=switchMgmtAuthFailure, switchPoeOverloadFailure=switchPoeOverloadFailure, switchPoeVoltageFailure=switchPoeVoltageFailure, switchTemperatureFailure=switchTemperatureFailure, tftpMessage=tftpMessage, vlanDescr=vlanDescr, vlanId=vlanId, vlanIndex=vlanIndex)
