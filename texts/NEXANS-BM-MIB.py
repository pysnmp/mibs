...
TimeTicks, NotificationType, IpAddress, ObjectIdentity, Unsigned32, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, iso, Counter64, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "IpAddress", "ObjectIdentity", "Unsigned32", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "iso", "Counter64", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portPoePower=portPoePower, adminAgentIpAddress=adminAgentIpAddress, infoProductNo=infoProductNo, portDescr=portDescr, infoNoOfPorts=infoNoOfPorts, infoLastTftpMessage=infoLastTftpMessage, sfpInfoLength62um=sfpInfoLength62um, infoPoeInputVoltage=infoPoeInputVoltage, infoManufactureDate=infoManufactureDate, adminAlarmNameM1=adminAlarmNameM1, infoType=infoType, sfpInfoVendorName=sfpInfoVendorName, infoPoeInputPower=infoPoeInputPower, portErrorDisabled=portErrorDisabled, switchConfigurationChanged=switchConfigurationChanged, bmSwitchMIB=bmSwitchMIB, infoAlarmStateM2=infoAlarmStateM2, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portPrioIp=portPrioIp, adminSnmpMacTableMode=adminSnmpMacTableMode, vlanDescr=vlanDescr, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portSecurityAdminState=portSecurityAdminState, portLinkChange=portLinkChange, infoSwitchHardwareVersion=infoSwitchHardwareVersion, switchPoeOverloadFailure=switchPoeOverloadFailure, infoTotalConfigChanges=infoTotalConfigChanges, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, bmSwitchInfo=bmSwitchInfo, sfpInfoPartNumber=sfpInfoPartNumber, sfpInfoDateCode=sfpInfoDateCode, infoNoOfReboots=infoNoOfReboots, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portSpeedDuplexSetup=portSpeedDuplexSetup, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portPoeCurrent=portPoeCurrent, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, bmTraps=bmTraps, adminLedGlobalMode=adminLedGlobalMode, portBandwidthLimitRxd=portBandwidthLimitRxd, adminAlarmM1=adminAlarmM1, sfpInfoLength9um=sfpInfoLength9um, switchMgmtAuthFailure=switchMgmtAuthFailure, adminMemoryCardMode=adminMemoryCardMode, adminAgentPhysAddress=adminAgentPhysAddress, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpEvent=sfpEvent, portPoeVoltage=portPoeVoltage, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpDiagTxOutputPower=sfpDiagTxOutputPower, bmSwitchSfp=bmSwitchSfp, portErrorCounter=portErrorCounter, infoTemperature=infoTemperature, sfpInfoWavelength=sfpInfoWavelength, tftpMessage=tftpMessage, bmSwitchVlanTable=bmSwitchVlanTable, portAdminState=portAdminState, portErrorCountFailure=portErrorCountFailure, switchTemperatureFailure=switchTemperatureFailure, clientRemoved=clientRemoved, portPrioDot1p=portPrioDot1p, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portPoePowerLimit=portPoePowerLimit, portLEDYellow=portLEDYellow, sfpState=sfpState, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpInfoLength50um=sfpInfoLength50um, portSecurityMacAddr2=portSecurityMacAddr2, portRemoteFault=portRemoteFault, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpPortIndex=sfpPortIndex, infoFunctionInputStateF1=infoFunctionInputStateF1, bmSwitchPortEntry=bmSwitchPortEntry, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpDiagTemperature=sfpDiagTemperature, portDefaultVlanId=portDefaultVlanId, infoSecurityFailMacAddr=infoSecurityFailMacAddr, radiusMgmtAuthReject=radiusMgmtAuthReject, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, bmSwitchAdmin=bmSwitchAdmin, bmSwitchSfpTable=bmSwitchSfpTable, infoPowerVoltage3300=infoPowerVoltage3300, switchIndustrialAlarmM1=switchIndustrialAlarmM1, bmSwitchPortTable=bmSwitchPortTable, portLEDGreen=portLEDGreen, adminAlarmM2=adminAlarmM2, portLoopBcastFailure=portLoopBcastFailure, adminTftpAccess=adminTftpAccess, internalMgmtWarning=internalMgmtWarning, infoLastSfpEventMessage=infoLastSfpEventMessage, switchFunctionInputAlarm=switchFunctionInputAlarm, adminAlarmNameM2=adminAlarmNameM2, portName=portName, radiusPortSecurityReject=radiusPortSecurityReject, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portSecurityMacAddr1=portSecurityMacAddr1, vlanId=vlanId, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portLinkType=portLinkType, portSecurityFailure=portSecurityFailure, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portTrunkingMode=portTrunkingMode, vlanIndex=vlanIndex, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, sfpInfoBitRate=sfpInfoBitRate, infoSeriesNo=infoSeriesNo, bmSwitchSfpEntry=bmSwitchSfpEntry, infoPowerVoltage2500=infoPowerVoltage2500, portVoiceVlanId=portVoiceVlanId, portLinkState=portLinkState, bmSwitchPort=bmSwitchPort, portPoeAdminState=portPoeAdminState, adminAgentPrioValue=adminAgentPrioValue, adminAgentDhcp=adminAgentDhcp, infoUnauthIpAddr=infoUnauthIpAddr, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portAcApSetup=portAcApSetup, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portLimiterPacketType=portLimiterPacketType, adminFunctionInputNameF1=adminFunctionInputNameF1, portPoeOverloadFailure=portPoeOverloadFailure, portIndex=portIndex, infoSerie=infoSerie, adminMgmtAccessList=adminMgmtAccessList, portSecurityMacAddr3=portSecurityMacAddr3, portDefaultPrioQueue=portDefaultPrioQueue, adminSwitchPortMirror=adminSwitchPortMirror, adminAgentNetmask=adminAgentNetmask, infoDescr=infoDescr, adminUnsecureVlanId=adminUnsecureVlanId, sfpInfoRevisionNumber=sfpInfoRevisionNumber, PYSNMP_MODULE_ID=bmSwitchMIB, bmSwitchVlan=bmSwitchVlan, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portNewMacAddress=portNewMacAddress, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, switchInternalVoltageFailure=switchInternalVoltageFailure, infoAlarmStateM1=infoAlarmStateM1, adminReset=adminReset, portSecurityForwardingState=portSecurityForwardingState, sfpInfoSerialNumber=sfpInfoSerialNumber, infoNewMacAddr=infoNewMacAddr, switchPoeVoltageFailure=switchPoeVoltageFailure, adminAgentVlanId=adminAgentVlanId)
