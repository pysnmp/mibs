...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoNoOfReboots=infoNoOfReboots, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portName=portName, portNewMacAddress=portNewMacAddress, adminSnmpMacTableMode=adminSnmpMacTableMode, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portSecurityFailure=portSecurityFailure, adminTftpAccess=adminTftpAccess, infoManufactureDate=infoManufactureDate, portBandwidthLimitTxd=portBandwidthLimitTxd, clientRemoved=clientRemoved, adminAgentIpAddress=adminAgentIpAddress, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portSecurityMacAddr1=portSecurityMacAddr1, adminAgentNetmask=adminAgentNetmask, infoPoeInputPower=infoPoeInputPower, portAdminState=portAdminState, switchFunctionInputAlarm=switchFunctionInputAlarm, portDefaultVlanId=portDefaultVlanId, portLinkChange=portLinkChange, infoPowerVoltage2500=infoPowerVoltage2500, vlanIndex=vlanIndex, adminUnsecureVlanId=adminUnsecureVlanId, sfpInfoWavelength=sfpInfoWavelength, infoFunctionInputStateF1=infoFunctionInputStateF1, bmSwitchInfo=bmSwitchInfo, infoProductNo=infoProductNo, infoType=infoType, portPoeCurrent=portPoeCurrent, switchPoeVoltageFailure=switchPoeVoltageFailure, adminAlarmNameM2=adminAlarmNameM2, portPrioIp=portPrioIp, tftpMessage=tftpMessage, infoAlarmStateM2=infoAlarmStateM2, portErrorCounter=portErrorCounter, portLimiterPacketType=portLimiterPacketType, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoSerie=infoSerie, infoDescr=infoDescr, portErrorCountFailure=portErrorCountFailure, portLoopBcastFailure=portLoopBcastFailure, portDescr=portDescr, bmSwitchVlan=bmSwitchVlan, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portSecurityMacAddr2=portSecurityMacAddr2, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpInfoConnectorDescr=sfpInfoConnectorDescr, sfpInfoDateCode=sfpInfoDateCode, adminReset=adminReset, switchInternalVoltageFailure=switchInternalVoltageFailure, portLinkType=portLinkType, sfpState=sfpState, adminAlarmNameM1=adminAlarmNameM1, switchTemperatureFailure=switchTemperatureFailure, sfpInfoRevisionNumber=sfpInfoRevisionNumber, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portVoiceVlanId=portVoiceVlanId, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portPoePowerLimit=portPoePowerLimit, sfpDiagTemperature=sfpDiagTemperature, adminAgentVlanId=adminAgentVlanId, switchConfigurationChanged=switchConfigurationChanged, infoNoOfPorts=infoNoOfPorts, adminAgentPrioValue=adminAgentPrioValue, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, switchPoeOverloadFailure=switchPoeOverloadFailure, sfpInfoLength62um=sfpInfoLength62um, sfpInfoLength50um=sfpInfoLength50um, switchMgmtAuthFailure=switchMgmtAuthFailure, bmSwitchAdmin=bmSwitchAdmin, sfpEvent=sfpEvent, portPoeVoltage=portPoeVoltage, portLEDYellow=portLEDYellow, internalMgmtWarning=internalMgmtWarning, portPoeOverloadFailure=portPoeOverloadFailure, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portSecurityForwardingState=portSecurityForwardingState, portAcApSetup=portAcApSetup, adminFunctionInputNameF1=adminFunctionInputNameF1, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, sfpPortIndex=sfpPortIndex, infoPowerVoltage3300=infoPowerVoltage3300, infoLastTftpMessage=infoLastTftpMessage, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, vlanDescr=vlanDescr, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminMemoryCardMode=adminMemoryCardMode, adminAlarmM2=adminAlarmM2, infoAlarmStateM1=infoAlarmStateM1, portSecurityAdminState=portSecurityAdminState, radiusPortSecurityReject=radiusPortSecurityReject, infoPoeInputVoltage=infoPoeInputVoltage, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, bmSwitchPort=bmSwitchPort, adminMgmtAccessList=adminMgmtAccessList, portSpeedDuplexSetup=portSpeedDuplexSetup, portBandwidthLimitRxd=portBandwidthLimitRxd, bmSwitchPortEntry=bmSwitchPortEntry, infoNewMacAddr=infoNewMacAddr, bmSwitchPortTable=bmSwitchPortTable, portErrorDisabled=portErrorDisabled, infoSwitchHardwareVersion=infoSwitchHardwareVersion, bmSwitchSfp=bmSwitchSfp, portIndex=portIndex, portLinkState=portLinkState, adminAgentPhysAddress=adminAgentPhysAddress, bmSwitchVlanTable=bmSwitchVlanTable, adminSwitchPortMirror=adminSwitchPortMirror, adminAgentDhcp=adminAgentDhcp, sfpInfoLength9um=sfpInfoLength9um, portPoeAdminState=portPoeAdminState, adminLedGlobalMode=adminLedGlobalMode, adminAlarmM1=adminAlarmM1, portSecurityMacAddr3=portSecurityMacAddr3, infoTemperature=infoTemperature, infoUnauthIpAddr=infoUnauthIpAddr, portTrunkingMode=portTrunkingMode, sfpInfoVendorName=sfpInfoVendorName, vlanId=vlanId, infoSeriesNo=infoSeriesNo, portRemoteFault=portRemoteFault, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpInfoPartNumber=sfpInfoPartNumber, PYSNMP_MODULE_ID=bmSwitchMIB, sfpInfoBitRate=sfpInfoBitRate, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, infoLastSfpEventMessage=infoLastSfpEventMessage, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, bmSwitchMIB=bmSwitchMIB, portPrioDot1p=portPrioDot1p, bmSwitchVlanEntry=bmSwitchVlanEntry, bmSwitchSfpTable=bmSwitchSfpTable, bmTraps=bmTraps, portDefaultPrioQueue=portDefaultPrioQueue, portLEDGreen=portLEDGreen, infoTotalConfigChanges=infoTotalConfigChanges, radiusMgmtAuthReject=radiusMgmtAuthReject, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portPoePower=portPoePower)
