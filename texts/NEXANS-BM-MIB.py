...
mibBuilder.exportSymbols("NEXANS-BM-MIB", bmSwitchSfp=bmSwitchSfp, portSecurityMacAddr2=portSecurityMacAddr2, portPoeVoltage=portPoeVoltage, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portIndex=portIndex, portLinkChange=portLinkChange, radiusPortSecurityReject=radiusPortSecurityReject, sfpInfoPartNumber=sfpInfoPartNumber, switchPoeVoltageFailure=switchPoeVoltageFailure, portVoiceVlanId=portVoiceVlanId, adminAlarmM2=adminAlarmM2, vlanDescr=vlanDescr, portAdminState=portAdminState, portPrioIp=portPrioIp, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpInfoSerialNumber=sfpInfoSerialNumber, bmSwitchPortEntry=bmSwitchPortEntry, infoPowerVoltage2500=infoPowerVoltage2500, portDefaultPrioQueue=portDefaultPrioQueue, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, infoTemperature=infoTemperature, bmSwitchPort=bmSwitchPort, adminAgentIpAddress=adminAgentIpAddress, portSecurityMacAddr3=portSecurityMacAddr3, bmSwitchSfpTable=bmSwitchSfpTable, sfpPortIndex=sfpPortIndex, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, sfpEvent=sfpEvent, vlanIndex=vlanIndex, infoPowerVoltage3300=infoPowerVoltage3300, sfpDiagRxIntputPower=sfpDiagRxIntputPower, bmSwitchAdmin=bmSwitchAdmin, bmSwitchSfpEntry=bmSwitchSfpEntry, adminAlarmNameM2=adminAlarmNameM2, portPoeOverloadFailure=portPoeOverloadFailure, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpInfoWavelength=sfpInfoWavelength, portPoePower=portPoePower, portSecurityAdminState=portSecurityAdminState, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminAgentDhcp=adminAgentDhcp, portSpeedDuplexSetup=portSpeedDuplexSetup, adminSnmpMacTableMode=adminSnmpMacTableMode, switchPoeOverloadFailure=switchPoeOverloadFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portName=portName, adminAlarmNameM1=adminAlarmNameM1, portLEDYellow=portLEDYellow, portBandwidthLimitTxd=portBandwidthLimitTxd, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpInfoLength9um=sfpInfoLength9um, vlanId=vlanId, infoPoeInputPower=infoPoeInputPower, portPoeCurrent=portPoeCurrent, sfpInfoDateCode=sfpInfoDateCode, portRemoteFault=portRemoteFault, switchFunctionInputAlarm=switchFunctionInputAlarm, infoMgmtHardwareVersion=infoMgmtHardwareVersion, clientRemoved=clientRemoved, adminLedGlobalMode=adminLedGlobalMode, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoSeriesNo=infoSeriesNo, adminAgentPhysAddress=adminAgentPhysAddress, adminFunctionInputNameF1=adminFunctionInputNameF1, infoTotalConfigChanges=infoTotalConfigChanges, adminUnsecureVlanId=adminUnsecureVlanId, sfpState=sfpState, infoSerie=infoSerie, adminAgentNetmask=adminAgentNetmask, infoUnauthIpAddr=infoUnauthIpAddr, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, adminAlarmM1=adminAlarmM1, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpInfoVendorName=sfpInfoVendorName, infoLastTftpMessage=infoLastTftpMessage, portPoeAdminState=portPoeAdminState, sfpInfoRevisionNumber=sfpInfoRevisionNumber, switchTemperatureFailure=switchTemperatureFailure, bmSwitchPortTable=bmSwitchPortTable, infoType=infoType, internalMgmtWarning=internalMgmtWarning, portSecurityForwardingState=portSecurityForwardingState, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminMemoryCardMode=adminMemoryCardMode, bmSwitchVlan=bmSwitchVlan, bmSwitchInfo=bmSwitchInfo, sfpDiagTemperature=sfpDiagTemperature, bmSwitchVlanTable=bmSwitchVlanTable, adminMgmtAccessList=adminMgmtAccessList, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portErrorDisabled=portErrorDisabled, portPrioDot1p=portPrioDot1p, infoProductNo=infoProductNo, portLEDGreen=portLEDGreen, adminAgentPrioValue=adminAgentPrioValue, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoDescr=infoDescr, portLimiterPacketType=portLimiterPacketType, sfpInfoLength50um=sfpInfoLength50um, switchMgmtAuthFailure=switchMgmtAuthFailure, tftpMessage=tftpMessage, infoAlarmStateM2=infoAlarmStateM2, infoPoeInputVoltage=infoPoeInputVoltage, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portLinkState=portLinkState, portDescr=portDescr, infoNoOfReboots=infoNoOfReboots, bmSwitchMIB=bmSwitchMIB, infoAlarmStateM1=infoAlarmStateM1, switchInternalVoltageFailure=switchInternalVoltageFailure, adminReset=adminReset, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portSecurityMacAddr1=portSecurityMacAddr1, portBandwidthLimitRxd=portBandwidthLimitRxd, PYSNMP_MODULE_ID=bmSwitchMIB, portLoopBcastFailure=portLoopBcastFailure, adminAgentVlanId=adminAgentVlanId, portLinkType=portLinkType, portSecurityFailure=portSecurityFailure, infoLastSfpEventMessage=infoLastSfpEventMessage, infoFunctionInputStateF1=infoFunctionInputStateF1, infoNoOfPorts=infoNoOfPorts, adminSwitchPortMirror=adminSwitchPortMirror, adminTftpAccess=adminTftpAccess, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, radiusMgmtAuthReject=radiusMgmtAuthReject, portDefaultVlanId=portDefaultVlanId, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portAcApSetup=portAcApSetup, switchConfigurationChanged=switchConfigurationChanged, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portErrorCountFailure=portErrorCountFailure, portTrunkingMode=portTrunkingMode, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portNewMacAddress=portNewMacAddress, bmTraps=bmTraps, infoNewMacAddr=infoNewMacAddr, sfpInfoLength62um=sfpInfoLength62um, infoManufactureDate=infoManufactureDate, portErrorCounter=portErrorCounter, portPoePowerLimit=portPoePowerLimit, sfpInfoBitRate=sfpInfoBitRate)
