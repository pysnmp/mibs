...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portSecurityMacAddr1=portSecurityMacAddr1, portBandwidthLimitTxd=portBandwidthLimitTxd, bmSwitchInfo=bmSwitchInfo, portPoeAdminState=portPoeAdminState, sfpInfoVendorName=sfpInfoVendorName, adminReset=adminReset, adminAlarmNameM2=adminAlarmNameM2, infoLastTftpMessage=infoLastTftpMessage, adminAlarmM2=adminAlarmM2, adminAgentPrioValue=adminAgentPrioValue, portSecurityMacAddr3=portSecurityMacAddr3, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, sfpInfoRevisionNumber=sfpInfoRevisionNumber, adminTftpAccess=adminTftpAccess, adminMemoryCardMode=adminMemoryCardMode, infoManufactureDate=infoManufactureDate, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminAgentNetmask=adminAgentNetmask, adminSnmpMacTableMode=adminSnmpMacTableMode, portPoeCurrent=portPoeCurrent, infoMgmtHardwareVersion=infoMgmtHardwareVersion, bmTraps=bmTraps, infoSerie=infoSerie, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoProductNo=infoProductNo, portNewMacAddress=portNewMacAddress, switchFunctionInputAlarm=switchFunctionInputAlarm, clientRemoved=clientRemoved, infoPoeInputPower=infoPoeInputPower, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpInfoPartNumber=sfpInfoPartNumber, bmSwitchVlan=bmSwitchVlan, portSecurityAdminState=portSecurityAdminState, infoNoOfPorts=infoNoOfPorts, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, infoLastSfpEventMessage=infoLastSfpEventMessage, switchInternalVoltageFailure=switchInternalVoltageFailure, portSecurityMacAddr2=portSecurityMacAddr2, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, sfpState=sfpState, infoPowerVoltage2500=infoPowerVoltage2500, switchConfigurationChanged=switchConfigurationChanged, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminUnsecureVlanId=adminUnsecureVlanId, portLEDYellow=portLEDYellow, portAdminState=portAdminState, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, vlanDescr=vlanDescr, sfpDiagRxIntputPower=sfpDiagRxIntputPower, bmSwitchMIB=bmSwitchMIB, portTrunkingMode=portTrunkingMode, infoFunctionInputStateF1=infoFunctionInputStateF1, adminMgmtAccessList=adminMgmtAccessList, adminAgentVlanId=adminAgentVlanId, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpInfoSerialNumber=sfpInfoSerialNumber, infoTemperature=infoTemperature, infoNoOfReboots=infoNoOfReboots, portLoopBcastFailure=portLoopBcastFailure, adminAgentIpAddress=adminAgentIpAddress, vlanIndex=vlanIndex, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpInfoLength62um=sfpInfoLength62um, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portLinkChange=portLinkChange, bmSwitchVlanTable=bmSwitchVlanTable, infoAlarmStateM1=infoAlarmStateM1, bmSwitchAdmin=bmSwitchAdmin, portPoeOverloadFailure=portPoeOverloadFailure, bmSwitchPortEntry=bmSwitchPortEntry, adminFunctionInputNameF1=adminFunctionInputNameF1, portDefaultVlanId=portDefaultVlanId, portSecurityFailure=portSecurityFailure, portRemoteFault=portRemoteFault, adminAgentDhcp=adminAgentDhcp, portName=portName, portSpeedDuplexSetup=portSpeedDuplexSetup, portAcApSetup=portAcApSetup, portErrorCounter=portErrorCounter, infoSeriesNo=infoSeriesNo, infoTotalConfigChanges=infoTotalConfigChanges, portLEDGreen=portLEDGreen, PYSNMP_MODULE_ID=bmSwitchMIB, internalMgmtWarning=internalMgmtWarning, sfpDiagTemperature=sfpDiagTemperature, infoUnauthIpAddr=infoUnauthIpAddr, portDefaultPrioQueue=portDefaultPrioQueue, infoNewMacAddr=infoNewMacAddr, adminAlarmNameM1=adminAlarmNameM1, bmSwitchVlanEntry=bmSwitchVlanEntry, radiusPortSecurityReject=radiusPortSecurityReject, sfpInfoBitRate=sfpInfoBitRate, portPoePower=portPoePower, sfpInfoLength50um=sfpInfoLength50um, infoType=infoType, adminSwitchVlanTableMode=adminSwitchVlanTableMode, infoPoeInputVoltage=infoPoeInputVoltage, portVoiceVlanId=portVoiceVlanId, portPrioDot1p=portPrioDot1p, radiusMgmtAuthReject=radiusMgmtAuthReject, tftpMessage=tftpMessage, adminAlarmM1=adminAlarmM1, switchMgmtAuthFailure=switchMgmtAuthFailure, portLimiterPacketType=portLimiterPacketType, bmSwitchPort=bmSwitchPort, infoAlarmStateM2=infoAlarmStateM2, portDescr=portDescr, portSecurityForwardingState=portSecurityForwardingState, portPrioIp=portPrioIp, switchTemperatureFailure=switchTemperatureFailure, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portLinkState=portLinkState, sfpEvent=sfpEvent, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoPowerVoltage3300=infoPowerVoltage3300, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoDescr=infoDescr, bmSwitchSfpTable=bmSwitchSfpTable, adminSwitchPortMirror=adminSwitchPortMirror, sfpPortIndex=sfpPortIndex, switchPoeOverloadFailure=switchPoeOverloadFailure, sfpInfoLength9um=sfpInfoLength9um, portPoeVoltage=portPoeVoltage, portPoePowerLimit=portPoePowerLimit, sfpInfoWavelength=sfpInfoWavelength, adminAgentPhysAddress=adminAgentPhysAddress, adminLedGlobalMode=adminLedGlobalMode, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, bmSwitchPortTable=bmSwitchPortTable, switchPoeVoltageFailure=switchPoeVoltageFailure, portBandwidthLimitRxd=portBandwidthLimitRxd, bmSwitchSfp=bmSwitchSfp, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpInfoDateCode=sfpInfoDateCode, portErrorCountFailure=portErrorCountFailure, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, switchIndustrialAlarmM2=switchIndustrialAlarmM2, vlanId=vlanId, portLinkType=portLinkType, portErrorDisabled=portErrorDisabled, portIndex=portIndex)
