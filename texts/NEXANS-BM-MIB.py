...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portPoeVoltage=portPoeVoltage, portPrioIp=portPrioIp, portSecurityMacAddr3=portSecurityMacAddr3, bmSwitchVlan=bmSwitchVlan, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpInfoWavelength=sfpInfoWavelength, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portLEDGreen=portLEDGreen, portVoiceVlanId=portVoiceVlanId, adminFunctionInputNameF1=adminFunctionInputNameF1, portSecurityFailure=portSecurityFailure, adminAgentDhcp=adminAgentDhcp, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, radiusPortSecurityReject=radiusPortSecurityReject, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpInfoBitRate=sfpInfoBitRate, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoPowerVoltage3300=infoPowerVoltage3300, bmSwitchSfpEntry=bmSwitchSfpEntry, portSecurityMacAddr1=portSecurityMacAddr1, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portLEDYellow=portLEDYellow, portPoeOverloadFailure=portPoeOverloadFailure, portAdminState=portAdminState, adminAgentPhysAddress=adminAgentPhysAddress, radiusMgmtAuthReject=radiusMgmtAuthReject, adminAlarmM2=adminAlarmM2, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminAlarmNameM2=adminAlarmNameM2, vlanDescr=vlanDescr, sfpEvent=sfpEvent, portBandwidthLimitRxd=portBandwidthLimitRxd, portPoePowerLimit=portPoePowerLimit, sfpInfoPartNumber=sfpInfoPartNumber, adminSwitchPortMirror=adminSwitchPortMirror, switchMgmtAuthFailure=switchMgmtAuthFailure, adminAgentNetmask=adminAgentNetmask, portDefaultPrioQueue=portDefaultPrioQueue, adminAgentIpAddress=adminAgentIpAddress, infoPoeInputPower=infoPoeInputPower, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, infoLastSfpEventMessage=infoLastSfpEventMessage, infoPowerVoltage2500=infoPowerVoltage2500, infoLastTftpMessage=infoLastTftpMessage, clientRemoved=clientRemoved, adminAgentVlanId=adminAgentVlanId, switchConfigurationChanged=switchConfigurationChanged, portSecurityForwardingState=portSecurityForwardingState, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, bmSwitchInfo=bmSwitchInfo, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, bmSwitchVlanEntry=bmSwitchVlanEntry, bmSwitchPortEntry=bmSwitchPortEntry, bmTraps=bmTraps, portIndex=portIndex, portNewMacAddress=portNewMacAddress, portPoeCurrent=portPoeCurrent, sfpPortIndex=sfpPortIndex, portLimiterPacketType=portLimiterPacketType, adminAlarmNameM1=adminAlarmNameM1, infoUnauthIpAddr=infoUnauthIpAddr, switchTemperatureFailure=switchTemperatureFailure, adminAgentPrioValue=adminAgentPrioValue, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoAlarmStateM1=infoAlarmStateM1, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminReset=adminReset, bmSwitchVlanTable=bmSwitchVlanTable, infoSecurityFailMacAddr=infoSecurityFailMacAddr, bmSwitchSfpTable=bmSwitchSfpTable, sfpInfoRevisionNumber=sfpInfoRevisionNumber, bmSwitchPort=bmSwitchPort, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, PYSNMP_MODULE_ID=bmSwitchMIB, portLinkState=portLinkState, infoDescr=infoDescr, bmSwitchPortTable=bmSwitchPortTable, sfpInfoVendorName=sfpInfoVendorName, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoNoOfReboots=infoNoOfReboots, portSpeedDuplexSetup=portSpeedDuplexSetup, adminUnsecureVlanId=adminUnsecureVlanId, sfpInfoLength9um=sfpInfoLength9um, infoTemperature=infoTemperature, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoAlarmStateM2=infoAlarmStateM2, infoSeriesNo=infoSeriesNo, portDescr=portDescr, portPoePower=portPoePower, switchPoeOverloadFailure=switchPoeOverloadFailure, sfpInfoDateCode=sfpInfoDateCode, infoNoOfPorts=infoNoOfPorts, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portLinkType=portLinkType, sfpDiagTemperature=sfpDiagTemperature, infoFunctionInputStateF1=infoFunctionInputStateF1, portLinkChange=portLinkChange, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portAcApSetup=portAcApSetup, vlanId=vlanId, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, switchInternalVoltageFailure=switchInternalVoltageFailure, tftpMessage=tftpMessage, portTrunkingMode=portTrunkingMode, portDefaultVlanId=portDefaultVlanId, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoManufactureDate=infoManufactureDate, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminTftpAccess=adminTftpAccess, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, bmSwitchAdmin=bmSwitchAdmin, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portErrorDisabled=portErrorDisabled, switchPoeVoltageFailure=switchPoeVoltageFailure, adminMemoryCardMode=adminMemoryCardMode, portSecurityAdminState=portSecurityAdminState, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, switchFunctionInputAlarm=switchFunctionInputAlarm, sfpInfoLength50um=sfpInfoLength50um, sfpState=sfpState, infoTotalConfigChanges=infoTotalConfigChanges, infoProductNo=infoProductNo, infoSerie=infoSerie, infoType=infoType, portBandwidthLimitTxd=portBandwidthLimitTxd, infoNewMacAddr=infoNewMacAddr, portErrorCounter=portErrorCounter, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, vlanIndex=vlanIndex, adminAlarmM1=adminAlarmM1, portErrorCountFailure=portErrorCountFailure, bmSwitchSfp=bmSwitchSfp, portRemoteFault=portRemoteFault, sfpInfoSerialNumber=sfpInfoSerialNumber, adminSnmpMacTableMode=adminSnmpMacTableMode, portName=portName, portLoopBcastFailure=portLoopBcastFailure, bmSwitchMIB=bmSwitchMIB, sfpInfoLength62um=sfpInfoLength62um, adminMgmtAccessList=adminMgmtAccessList, portSecurityMacAddr2=portSecurityMacAddr2, adminLedGlobalMode=adminLedGlobalMode, infoPoeInputVoltage=infoPoeInputVoltage, portPrioDot1p=portPrioDot1p, portPoeAdminState=portPoeAdminState, internalMgmtWarning=internalMgmtWarning)
