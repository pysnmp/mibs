...
Integer32, NotificationType, Counter64, Unsigned32, MibIdentifier, iso, ModuleIdentity, Counter32, IpAddress, Bits, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "Counter64", "Unsigned32", "MibIdentifier", "iso", "ModuleIdentity", "Counter32", "IpAddress", "Bits", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portSecurityMacAddr2=portSecurityMacAddr2, switchIndustrialAlarmM1=switchIndustrialAlarmM1, radiusPortSecurityReject=radiusPortSecurityReject, infoAlarmStateM1=infoAlarmStateM1, sfpInfoConnectorDescr=sfpInfoConnectorDescr, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoLastSfpEventMessage=infoLastSfpEventMessage, adminAgentVlanId=adminAgentVlanId, portLimiterPacketType=portLimiterPacketType, portVoiceVlanId=portVoiceVlanId, infoPowerVoltage3300=infoPowerVoltage3300, portLEDGreen=portLEDGreen, radiusMgmtAuthReject=radiusMgmtAuthReject, portPoeCurrent=portPoeCurrent, portSecurityMacAddr3=portSecurityMacAddr3, portErrorCountFailure=portErrorCountFailure, adminAgentPrioValue=adminAgentPrioValue, portDefaultVlanId=portDefaultVlanId, sfpDiagTemperature=sfpDiagTemperature, infoAlarmStateM2=infoAlarmStateM2, infoLastTftpMessage=infoLastTftpMessage, portLinkState=portLinkState, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, switchFunctionInputAlarm=switchFunctionInputAlarm, bmSwitchSfpTable=bmSwitchSfpTable, portPoeAdminState=portPoeAdminState, portIndex=portIndex, portPoeVoltage=portPoeVoltage, infoFunctionInputStateF1=infoFunctionInputStateF1, adminAgentDhcp=adminAgentDhcp, portName=portName, sfpEvent=sfpEvent, infoType=infoType, switchTemperatureFailure=switchTemperatureFailure, infoSeriesNo=infoSeriesNo, adminUnsecureVlanId=adminUnsecureVlanId, portSpeedDuplexSetup=portSpeedDuplexSetup, infoNoOfPorts=infoNoOfPorts, portTrunkingMode=portTrunkingMode, portErrorCounter=portErrorCounter, adminAlarmNameM1=adminAlarmNameM1, vlanDescr=vlanDescr, infoPoeInputPower=infoPoeInputPower, adminAlarmNameM2=adminAlarmNameM2, adminAlarmM2=adminAlarmM2, portLinkChange=portLinkChange, portDefaultPrioQueue=portDefaultPrioQueue, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminTftpAccess=adminTftpAccess, sfpInfoDateCode=sfpInfoDateCode, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portAcApSetup=portAcApSetup, bmSwitchPortEntry=bmSwitchPortEntry, portSecurityForwardingState=portSecurityForwardingState, adminAgentPhysAddress=adminAgentPhysAddress, portErrorDisabled=portErrorDisabled, infoPowerVoltage2500=infoPowerVoltage2500, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portBandwidthLimitRxd=portBandwidthLimitRxd, sfpInfoSerialNumber=sfpInfoSerialNumber, infoDescr=infoDescr, infoNewMacAddr=infoNewMacAddr, bmSwitchVlan=bmSwitchVlan, infoProductNo=infoProductNo, sfpInfoBitRate=sfpInfoBitRate, sfpInfoVendorName=sfpInfoVendorName, bmSwitchAdmin=bmSwitchAdmin, switchInternalVoltageFailure=switchInternalVoltageFailure, sfpState=sfpState, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminAlarmM1=adminAlarmM1, adminSwitchVlanTableMode=adminSwitchVlanTableMode, sfpInfoLength9um=sfpInfoLength9um, adminReset=adminReset, portDescr=portDescr, bmSwitchVlanTable=bmSwitchVlanTable, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portSecurityFailure=portSecurityFailure, portPoeOverloadFailure=portPoeOverloadFailure, portPoePowerLimit=portPoePowerLimit, sfpPortIndex=sfpPortIndex, portLoopBcastFailure=portLoopBcastFailure, clientRemoved=clientRemoved, vlanId=vlanId, portRemoteFault=portRemoteFault, portAdminState=portAdminState, switchPoeVoltageFailure=switchPoeVoltageFailure, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminLedGlobalMode=adminLedGlobalMode, portNewMacAddress=portNewMacAddress, infoPoeInputVoltage=infoPoeInputVoltage, infoTemperature=infoTemperature, bmSwitchPort=bmSwitchPort, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpInfoPartNumber=sfpInfoPartNumber, bmSwitchPortTable=bmSwitchPortTable, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, switchMgmtAuthFailure=switchMgmtAuthFailure, adminAgentNetmask=adminAgentNetmask, portBandwidthLimitTxd=portBandwidthLimitTxd, adminSnmpMacTableMode=adminSnmpMacTableMode, adminSwitchPortMirror=adminSwitchPortMirror, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portLinkType=portLinkType, infoManufactureDate=infoManufactureDate, infoSerie=infoSerie, portPrioDot1p=portPrioDot1p, sfpInfoLength50um=sfpInfoLength50um, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, adminFunctionInputNameF1=adminFunctionInputNameF1, adminAgentIpAddress=adminAgentIpAddress, portSecurityMacAddr1=portSecurityMacAddr1, portPoePower=portPoePower, bmTraps=bmTraps, sfpInfoLength62um=sfpInfoLength62um, portPrioIp=portPrioIp, bmSwitchSfpEntry=bmSwitchSfpEntry, adminMgmtAccessList=adminMgmtAccessList, bmSwitchSfp=bmSwitchSfp, portSecurityAdminState=portSecurityAdminState, vlanIndex=vlanIndex, PYSNMP_MODULE_ID=bmSwitchMIB, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, bmSwitchInfo=bmSwitchInfo, tftpMessage=tftpMessage, infoTotalConfigChanges=infoTotalConfigChanges, internalMgmtWarning=internalMgmtWarning, sfpInfoWavelength=sfpInfoWavelength, portLEDYellow=portLEDYellow, bmSwitchMIB=bmSwitchMIB, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, switchPoeOverloadFailure=switchPoeOverloadFailure, infoUnauthIpAddr=infoUnauthIpAddr, switchConfigurationChanged=switchConfigurationChanged, adminMemoryCardMode=adminMemoryCardMode, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, infoNoOfReboots=infoNoOfReboots)
