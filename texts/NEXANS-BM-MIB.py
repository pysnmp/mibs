...
mibBuilder.exportSymbols("NEXANS-BM-MIB", sfpInfoLength9um=sfpInfoLength9um, bmSwitchPort=bmSwitchPort, adminTftpAccess=adminTftpAccess, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpInfoBitRate=sfpInfoBitRate, portDefaultPrioQueue=portDefaultPrioQueue, bmSwitchMIB=bmSwitchMIB, adminAgentVlanId=adminAgentVlanId, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portPoeCurrent=portPoeCurrent, infoSeriesNo=infoSeriesNo, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoPowerVoltage2500=infoPowerVoltage2500, switchConfigurationChanged=switchConfigurationChanged, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portErrorCountFailure=portErrorCountFailure, sfpPortIndex=sfpPortIndex, adminSwitchPortMirror=adminSwitchPortMirror, portBandwidthLimitRxd=portBandwidthLimitRxd, infoNoOfPorts=infoNoOfPorts, adminAlarmNameM1=adminAlarmNameM1, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpEvent=sfpEvent, infoType=infoType, switchPoeVoltageFailure=switchPoeVoltageFailure, infoNewMacAddr=infoNewMacAddr, portErrorCounter=portErrorCounter, infoLastSfpEventMessage=infoLastSfpEventMessage, infoTotalConfigChanges=infoTotalConfigChanges, clientRemoved=clientRemoved, adminAlarmM2=adminAlarmM2, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpState=sfpState, bmSwitchSfpTable=bmSwitchSfpTable, infoFunctionInputStateF1=infoFunctionInputStateF1, sfpInfoPartNumber=sfpInfoPartNumber, adminMemoryCardMode=adminMemoryCardMode, tftpMessage=tftpMessage, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portSecurityAdminState=portSecurityAdminState, infoProductNo=infoProductNo, portName=portName, infoTemperature=infoTemperature, portLoopBcastFailure=portLoopBcastFailure, portPrioIp=portPrioIp, sfpInfoWavelength=sfpInfoWavelength, adminAgentDhcp=adminAgentDhcp, PYSNMP_MODULE_ID=bmSwitchMIB, portSecurityMacAddr2=portSecurityMacAddr2, switchIndustrialAlarmM2=switchIndustrialAlarmM2, radiusPortSecurityReject=radiusPortSecurityReject, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminAgentPrioValue=adminAgentPrioValue, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portSecurityForwardingState=portSecurityForwardingState, portRemoteFault=portRemoteFault, portPoePower=portPoePower, portSecurityFailure=portSecurityFailure, portDefaultVlanId=portDefaultVlanId, portTrunkingMode=portTrunkingMode, adminSwitchVlanTableMode=adminSwitchVlanTableMode, bmSwitchAdmin=bmSwitchAdmin, bmSwitchSfp=bmSwitchSfp, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portLinkState=portLinkState, sfpInfoConnectorDescr=sfpInfoConnectorDescr, switchTemperatureFailure=switchTemperatureFailure, adminAlarmNameM2=adminAlarmNameM2, portPoeAdminState=portPoeAdminState, portDescr=portDescr, portErrorDisabled=portErrorDisabled, portSecurityMacAddr1=portSecurityMacAddr1, portVoiceVlanId=portVoiceVlanId, switchInternalVoltageFailure=switchInternalVoltageFailure, infoManufactureDate=infoManufactureDate, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portPrioDot1p=portPrioDot1p, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, bmSwitchVlanEntry=bmSwitchVlanEntry, adminSnmpMacTableMode=adminSnmpMacTableMode, portIndex=portIndex, adminAgentPhysAddress=adminAgentPhysAddress, adminFunctionInputNameF1=adminFunctionInputNameF1, vlanIndex=vlanIndex, infoPoeInputPower=infoPoeInputPower, portAdminState=portAdminState, portLEDGreen=portLEDGreen, portNewMacAddress=portNewMacAddress, portPoeVoltage=portPoeVoltage, adminLedGlobalMode=adminLedGlobalMode, infoAlarmStateM1=infoAlarmStateM1, infoDescr=infoDescr, portLEDYellow=portLEDYellow, portPoePowerLimit=portPoePowerLimit, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoPowerVoltage3300=infoPowerVoltage3300, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpDiagTemperature=sfpDiagTemperature, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, internalMgmtWarning=internalMgmtWarning, portLimiterPacketType=portLimiterPacketType, portPoeOverloadFailure=portPoeOverloadFailure, switchPoeOverloadFailure=switchPoeOverloadFailure, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portLinkType=portLinkType, bmSwitchVlan=bmSwitchVlan, adminMgmtAccessList=adminMgmtAccessList, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, bmTraps=bmTraps, bmSwitchPortTable=bmSwitchPortTable, sfpDiagTxOutputPower=sfpDiagTxOutputPower, bmSwitchVlanTable=bmSwitchVlanTable, infoUnauthIpAddr=infoUnauthIpAddr, vlanId=vlanId, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, vlanDescr=vlanDescr, bmSwitchPortEntry=bmSwitchPortEntry, adminAlarmM1=adminAlarmM1, sfpInfoDateCode=sfpInfoDateCode, infoAlarmStateM2=infoAlarmStateM2, infoPoeInputVoltage=infoPoeInputVoltage, sfpInfoVendorName=sfpInfoVendorName, portAcApSetup=portAcApSetup, switchMgmtAuthFailure=switchMgmtAuthFailure, radiusMgmtAuthReject=radiusMgmtAuthReject, adminUnsecureVlanId=adminUnsecureVlanId, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoSecurityFailMacAddr=infoSecurityFailMacAddr, switchFunctionInputAlarm=switchFunctionInputAlarm, sfpInfoLength62um=sfpInfoLength62um, infoSerie=infoSerie, adminReset=adminReset, sfpInfoLength50um=sfpInfoLength50um, infoLastTftpMessage=infoLastTftpMessage, bmSwitchInfo=bmSwitchInfo, adminAgentNetmask=adminAgentNetmask, infoNoOfReboots=infoNoOfReboots, adminAgentIpAddress=adminAgentIpAddress, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portLinkChange=portLinkChange, bmSwitchSfpEntry=bmSwitchSfpEntry, portSecurityMacAddr3=portSecurityMacAddr3)
