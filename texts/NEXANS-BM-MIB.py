...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoTemperature=infoTemperature, bmSwitchPortTable=bmSwitchPortTable, adminAlarmNameM1=adminAlarmNameM1, bmSwitchAdmin=bmSwitchAdmin, switchFunctionInputAlarm=switchFunctionInputAlarm, sfpInfoLength9um=sfpInfoLength9um, vlanIndex=vlanIndex, PYSNMP_MODULE_ID=bmSwitchMIB, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, infoTotalConfigChanges=infoTotalConfigChanges, sfpState=sfpState, infoSerie=infoSerie, adminFunctionInputNameF1=adminFunctionInputNameF1, sfpInfoConnectorDescr=sfpInfoConnectorDescr, switchTemperatureFailure=switchTemperatureFailure, portPoeAdminState=portPoeAdminState, radiusPortSecurityReject=radiusPortSecurityReject, bmTraps=bmTraps, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, bmSwitchPortEntry=bmSwitchPortEntry, adminMemoryCardMode=adminMemoryCardMode, adminMgmtAccessList=adminMgmtAccessList, tftpMessage=tftpMessage, bmSwitchMIB=bmSwitchMIB, portDefaultVlanId=portDefaultVlanId, portSpeedDuplexSetup=portSpeedDuplexSetup, infoNoOfReboots=infoNoOfReboots, sfpInfoDateCode=sfpInfoDateCode, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminAlarmM2=adminAlarmM2, bmSwitchSfp=bmSwitchSfp, sfpInfoPartNumber=sfpInfoPartNumber, portDefaultPrioQueue=portDefaultPrioQueue, adminTftpAccess=adminTftpAccess, bmSwitchInfo=bmSwitchInfo, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpInfoSerialNumber=sfpInfoSerialNumber, portSecurityMacAddr2=portSecurityMacAddr2, sfpInfoWavelength=sfpInfoWavelength, adminSwitchVlanTableMode=adminSwitchVlanTableMode, infoPoeInputPower=infoPoeInputPower, portNewMacAddress=portNewMacAddress, portSecurityAdminState=portSecurityAdminState, switchConfigurationChanged=switchConfigurationChanged, portSecurityMacAddr3=portSecurityMacAddr3, portBandwidthLimitTxd=portBandwidthLimitTxd, infoFunctionInputStateF1=infoFunctionInputStateF1, bmSwitchVlan=bmSwitchVlan, portErrorDisabled=portErrorDisabled, internalMgmtWarning=internalMgmtWarning, switchPoeVoltageFailure=switchPoeVoltageFailure, clientRemoved=clientRemoved, portTrunkingMode=portTrunkingMode, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoNewMacAddr=infoNewMacAddr, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminAlarmNameM2=adminAlarmNameM2, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, adminSwitchPortMirror=adminSwitchPortMirror, portDescr=portDescr, portSecurityFailure=portSecurityFailure, adminAgentVlanId=adminAgentVlanId, infoProductNo=infoProductNo, infoSeriesNo=infoSeriesNo, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, sfpPortIndex=sfpPortIndex, sfpInfoRevisionNumber=sfpInfoRevisionNumber, adminLedGlobalMode=adminLedGlobalMode, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portLEDGreen=portLEDGreen, adminSnmpMacTableMode=adminSnmpMacTableMode, portBandwidthLimitRxd=portBandwidthLimitRxd, adminAgentIpAddress=adminAgentIpAddress, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portIndex=portIndex, portPoePowerLimit=portPoePowerLimit, vlanDescr=vlanDescr, infoLastTftpMessage=infoLastTftpMessage, adminAgentDhcp=adminAgentDhcp, portLinkState=portLinkState, adminAlarmM1=adminAlarmM1, portLinkType=portLinkType, switchInternalVoltageFailure=switchInternalVoltageFailure, adminReset=adminReset, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portSecurityForwardingState=portSecurityForwardingState, portPrioDot1p=portPrioDot1p, adminAgentNetmask=adminAgentNetmask, switchPoeOverloadFailure=switchPoeOverloadFailure, bmSwitchVlanEntry=bmSwitchVlanEntry, portVoiceVlanId=portVoiceVlanId, portSecurityMacAddr1=portSecurityMacAddr1, portLimiterPacketType=portLimiterPacketType, portLoopBcastFailure=portLoopBcastFailure, adminAgentPrioValue=adminAgentPrioValue, portLinkChange=portLinkChange, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, bmSwitchVlanTable=bmSwitchVlanTable, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portPoeOverloadFailure=portPoeOverloadFailure, sfpInfoVendorName=sfpInfoVendorName, sfpInfoLength62um=sfpInfoLength62um, infoAlarmStateM1=infoAlarmStateM1, switchMgmtAuthFailure=switchMgmtAuthFailure, radiusMgmtAuthReject=radiusMgmtAuthReject, bmSwitchPort=bmSwitchPort, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, adminUnsecureVlanId=adminUnsecureVlanId, infoLastSfpEventMessage=infoLastSfpEventMessage, infoNoOfPorts=infoNoOfPorts, portPoePower=portPoePower, bmSwitchSfpTable=bmSwitchSfpTable, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoType=infoType, portPoeCurrent=portPoeCurrent, portName=portName, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, sfpDiagTemperature=sfpDiagTemperature, portLEDYellow=portLEDYellow, sfpInfoBitRate=sfpInfoBitRate, portAcApSetup=portAcApSetup, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpInfoLength50um=sfpInfoLength50um, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoUnauthIpAddr=infoUnauthIpAddr, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portAdminState=portAdminState, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portRemoteFault=portRemoteFault, infoDescr=infoDescr, infoPowerVoltage2500=infoPowerVoltage2500, infoManufactureDate=infoManufactureDate, infoPowerVoltage3300=infoPowerVoltage3300, sfpEvent=sfpEvent, portPrioIp=portPrioIp, infoAlarmStateM2=infoAlarmStateM2, portErrorCounter=portErrorCounter, adminAgentPhysAddress=adminAgentPhysAddress, portErrorCountFailure=portErrorCountFailure, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portPoeVoltage=portPoeVoltage, infoPoeInputVoltage=infoPoeInputVoltage, vlanId=vlanId)
