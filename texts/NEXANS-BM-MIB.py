...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoDescr=infoDescr, infoManufactureDate=infoManufactureDate, portIndex=portIndex, portVoiceVlanId=portVoiceVlanId, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portLoopBcastFailure=portLoopBcastFailure, portAcApSetup=portAcApSetup, bmSwitchAdmin=bmSwitchAdmin, infoTemperature=infoTemperature, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portPoeVoltage=portPoeVoltage, radiusPortSecurityReject=radiusPortSecurityReject, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portName=portName, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoNoOfReboots=infoNoOfReboots, portErrorDisabled=portErrorDisabled, infoUnauthIpAddr=infoUnauthIpAddr, portErrorCounter=portErrorCounter, switchMgmtAuthFailure=switchMgmtAuthFailure, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, adminAlarmM2=adminAlarmM2, sfpInfoLength50um=sfpInfoLength50um, portAdminState=portAdminState, adminTftpAccess=adminTftpAccess, portPoeAdminState=portPoeAdminState, adminAgentNetmask=adminAgentNetmask, PYSNMP_MODULE_ID=bmSwitchMIB, infoLastSfpEventMessage=infoLastSfpEventMessage, infoAlarmStateM2=infoAlarmStateM2, switchFunctionInputAlarm=switchFunctionInputAlarm, bmSwitchInfo=bmSwitchInfo, adminSwitchPortMirror=adminSwitchPortMirror, sfpDiagTemperature=sfpDiagTemperature, adminAlarmNameM2=adminAlarmNameM2, portPoePowerLimit=portPoePowerLimit, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpInfoDateCode=sfpInfoDateCode, sfpDiagRxIntputPower=sfpDiagRxIntputPower, switchConfigurationChanged=switchConfigurationChanged, infoPoeInputPower=infoPoeInputPower, adminLedGlobalMode=adminLedGlobalMode, portBandwidthLimitRxd=portBandwidthLimitRxd, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portDefaultVlanId=portDefaultVlanId, portErrorCountFailure=portErrorCountFailure, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portSecurityAdminState=portSecurityAdminState, clientRemoved=clientRemoved, portNewMacAddress=portNewMacAddress, adminUnsecureVlanId=adminUnsecureVlanId, portLEDYellow=portLEDYellow, portSpeedDuplexSetup=portSpeedDuplexSetup, adminAgentPrioValue=adminAgentPrioValue, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminFunctionInputNameF1=adminFunctionInputNameF1, switchTemperatureFailure=switchTemperatureFailure, sfpInfoPartNumber=sfpInfoPartNumber, bmSwitchSfpTable=bmSwitchSfpTable, adminAgentVlanId=adminAgentVlanId, infoFunctionInputStateF1=infoFunctionInputStateF1, portSecurityMacAddr1=portSecurityMacAddr1, bmSwitchPort=bmSwitchPort, infoProductNo=infoProductNo, bmSwitchVlanTable=bmSwitchVlanTable, sfpInfoLength62um=sfpInfoLength62um, infoNoOfPorts=infoNoOfPorts, adminAgentDhcp=adminAgentDhcp, adminAlarmM1=adminAlarmM1, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portDefaultPrioQueue=portDefaultPrioQueue, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoAlarmStateM1=infoAlarmStateM1, portSecurityMacAddr3=portSecurityMacAddr3, bmTraps=bmTraps, portPoePower=portPoePower, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoPowerVoltage2500=infoPowerVoltage2500, tftpMessage=tftpMessage, infoLastTftpMessage=infoLastTftpMessage, sfpInfoVendorName=sfpInfoVendorName, infoSecurityFailMacAddr=infoSecurityFailMacAddr, bmSwitchMIB=bmSwitchMIB, portLinkState=portLinkState, bmSwitchVlanEntry=bmSwitchVlanEntry, portLEDGreen=portLEDGreen, portBandwidthLimitTxd=portBandwidthLimitTxd, portPrioIp=portPrioIp, portSecurityForwardingState=portSecurityForwardingState, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminAgentIpAddress=adminAgentIpAddress, adminSnmpMacTableMode=adminSnmpMacTableMode, adminMgmtAccessList=adminMgmtAccessList, adminAlarmNameM1=adminAlarmNameM1, portSecurityMacAddr2=portSecurityMacAddr2, portDescr=portDescr, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpPortIndex=sfpPortIndex, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpState=sfpState, vlanId=vlanId, vlanDescr=vlanDescr, infoSerie=infoSerie, portPoeOverloadFailure=portPoeOverloadFailure, sfpEvent=sfpEvent, portRemoteFault=portRemoteFault, radiusMgmtAuthReject=radiusMgmtAuthReject, sfpInfoLength9um=sfpInfoLength9um, switchInternalVoltageFailure=switchInternalVoltageFailure, switchPoeVoltageFailure=switchPoeVoltageFailure, infoPoeInputVoltage=infoPoeInputVoltage, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, sfpInfoWavelength=sfpInfoWavelength, adminMemoryCardMode=adminMemoryCardMode, switchPoeOverloadFailure=switchPoeOverloadFailure, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoType=infoType, sfpInfoSerialNumber=sfpInfoSerialNumber, portLinkType=portLinkType, adminReset=adminReset, portSecurityFailure=portSecurityFailure, sfpInfoBitRate=sfpInfoBitRate, bmSwitchSfpEntry=bmSwitchSfpEntry, vlanIndex=vlanIndex, bmSwitchVlan=bmSwitchVlan, portLinkChange=portLinkChange, bmSwitchPortTable=bmSwitchPortTable, infoTotalConfigChanges=infoTotalConfigChanges, bmSwitchSfp=bmSwitchSfp, infoSeriesNo=infoSeriesNo, bmSwitchPortEntry=bmSwitchPortEntry, infoNewMacAddr=infoNewMacAddr, adminAgentPhysAddress=adminAgentPhysAddress, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portPoeCurrent=portPoeCurrent, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portTrunkingMode=portTrunkingMode, portLimiterPacketType=portLimiterPacketType, internalMgmtWarning=internalMgmtWarning, infoPowerVoltage3300=infoPowerVoltage3300, portPrioDot1p=portPrioDot1p, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning)
