...
mibBuilder.exportSymbols("NEXANS-BM-MIB", sfpDiagRxIntputPower=sfpDiagRxIntputPower, portLoopBcastFailure=portLoopBcastFailure, portPrioIp=portPrioIp, PYSNMP_MODULE_ID=bmSwitchMIB, infoSecurityFailMacAddr=infoSecurityFailMacAddr, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminAlarmM1=adminAlarmM1, portSecurityAdminState=portSecurityAdminState, clientRemoved=clientRemoved, internalMgmtWarning=internalMgmtWarning, bmTraps=bmTraps, sfpInfoVendorName=sfpInfoVendorName, infoProductNo=infoProductNo, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portVoiceVlanId=portVoiceVlanId, portPoeOverloadFailure=portPoeOverloadFailure, bmSwitchSfp=bmSwitchSfp, portBandwidthLimitRxd=portBandwidthLimitRxd, portErrorCounter=portErrorCounter, adminAgentIpAddress=adminAgentIpAddress, sfpState=sfpState, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, adminAlarmNameM2=adminAlarmNameM2, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portTrunkingMode=portTrunkingMode, infoLastSfpEventMessage=infoLastSfpEventMessage, infoNoOfReboots=infoNoOfReboots, adminAlarmNameM1=adminAlarmNameM1, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, vlanIndex=vlanIndex, sfpInfoWavelength=sfpInfoWavelength, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portPoePowerLimit=portPoePowerLimit, vlanId=vlanId, bmSwitchInfo=bmSwitchInfo, adminMgmtAccessList=adminMgmtAccessList, bmSwitchVlanEntry=bmSwitchVlanEntry, infoSeriesNo=infoSeriesNo, adminSnmpMacTableMode=adminSnmpMacTableMode, bmSwitchPort=bmSwitchPort, portName=portName, portSecurityMacAddr3=portSecurityMacAddr3, portPrioDot1p=portPrioDot1p, portLEDYellow=portLEDYellow, infoUnauthIpAddr=infoUnauthIpAddr, portLimiterPacketType=portLimiterPacketType, sfpInfoLength50um=sfpInfoLength50um, sfpEvent=sfpEvent, infoSerie=infoSerie, bmSwitchVlanTable=bmSwitchVlanTable, switchConfigurationChanged=switchConfigurationChanged, portSecurityForwardingState=portSecurityForwardingState, infoNoOfPorts=infoNoOfPorts, sfpDiagTemperature=sfpDiagTemperature, adminTftpAccess=adminTftpAccess, bmSwitchAdmin=bmSwitchAdmin, portSpeedDuplexSetup=portSpeedDuplexSetup, infoAlarmStateM1=infoAlarmStateM1, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpInfoRevisionNumber=sfpInfoRevisionNumber, adminFunctionInputNameF1=adminFunctionInputNameF1, adminAgentNetmask=adminAgentNetmask, portRemoteFault=portRemoteFault, adminLedGlobalMode=adminLedGlobalMode, portPoeCurrent=portPoeCurrent, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, adminAgentPhysAddress=adminAgentPhysAddress, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portDefaultVlanId=portDefaultVlanId, portSecurityFailure=portSecurityFailure, portNewMacAddress=portNewMacAddress, infoManufactureDate=infoManufactureDate, sfpInfoSerialNumber=sfpInfoSerialNumber, switchPoeVoltageFailure=switchPoeVoltageFailure, switchFunctionInputAlarm=switchFunctionInputAlarm, infoLastTftpMessage=infoLastTftpMessage, portSecurityMacAddr1=portSecurityMacAddr1, sfpPortIndex=sfpPortIndex, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, bmSwitchSfpTable=bmSwitchSfpTable, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpInfoPartNumber=sfpInfoPartNumber, sfpInfoLength62um=sfpInfoLength62um, adminReset=adminReset, portAcApSetup=portAcApSetup, bmSwitchPortTable=bmSwitchPortTable, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, switchMgmtAuthFailure=switchMgmtAuthFailure, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portLinkChange=portLinkChange, radiusMgmtAuthReject=radiusMgmtAuthReject, adminMemoryCardMode=adminMemoryCardMode, portLinkType=portLinkType, infoTotalConfigChanges=infoTotalConfigChanges, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoTemperature=infoTemperature, switchInternalVoltageFailure=switchInternalVoltageFailure, portErrorCountFailure=portErrorCountFailure, portErrorDisabled=portErrorDisabled, infoNewMacAddr=infoNewMacAddr, sfpInfoDateCode=sfpInfoDateCode, switchPoeOverloadFailure=switchPoeOverloadFailure, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portDefaultPrioQueue=portDefaultPrioQueue, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, tftpMessage=tftpMessage, adminSwitchPortMirror=adminSwitchPortMirror, portSecurityMacAddr2=portSecurityMacAddr2, infoPoeInputPower=infoPoeInputPower, infoFunctionInputStateF1=infoFunctionInputStateF1, infoType=infoType, adminAgentDhcp=adminAgentDhcp, portLEDGreen=portLEDGreen, radiusPortSecurityReject=radiusPortSecurityReject, portLinkState=portLinkState, portPoePower=portPoePower, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminAlarmM2=adminAlarmM2, adminAgentPrioValue=adminAgentPrioValue, infoDescr=infoDescr, sfpInfoBitRate=sfpInfoBitRate, adminSwitchVlanTableMode=adminSwitchVlanTableMode, sfpInfoLength9um=sfpInfoLength9um, bmSwitchVlan=bmSwitchVlan, bmSwitchMIB=bmSwitchMIB, portPoeAdminState=portPoeAdminState, adminAgentVlanId=adminAgentVlanId, infoPoeInputVoltage=infoPoeInputVoltage, switchTemperatureFailure=switchTemperatureFailure, infoPowerVoltage2500=infoPowerVoltage2500, infoAlarmStateM2=infoAlarmStateM2, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portAdminState=portAdminState, vlanDescr=vlanDescr, portPoeVoltage=portPoeVoltage, infoPowerVoltage3300=infoPowerVoltage3300, bmSwitchPortEntry=bmSwitchPortEntry, adminUnsecureVlanId=adminUnsecureVlanId, sfpDiagTxOutputPower=sfpDiagTxOutputPower, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portDescr=portDescr, portIndex=portIndex, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoMgmtHardwareVersion=infoMgmtHardwareVersion)
