...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoPowerVoltage3300=infoPowerVoltage3300, sfpState=sfpState, infoDescr=infoDescr, adminSwitchPortMirror=adminSwitchPortMirror, portErrorCounter=portErrorCounter, infoNewMacAddr=infoNewMacAddr, bmTraps=bmTraps, portSecurityMacAddr3=portSecurityMacAddr3, portPrioIp=portPrioIp, portLEDYellow=portLEDYellow, adminTftpAccess=adminTftpAccess, infoAlarmStateM1=infoAlarmStateM1, switchMgmtAuthFailure=switchMgmtAuthFailure, sfpInfoSerialNumber=sfpInfoSerialNumber, portLEDGreen=portLEDGreen, bmSwitchPortTable=bmSwitchPortTable, portAdminState=portAdminState, portTrunkingMode=portTrunkingMode, adminFunctionInputNameF1=adminFunctionInputNameF1, bmSwitchSfpEntry=bmSwitchSfpEntry, infoNoOfReboots=infoNoOfReboots, portPoePowerLimit=portPoePowerLimit, PYSNMP_MODULE_ID=bmSwitchMIB, portPoePower=portPoePower, adminAlarmM2=adminAlarmM2, portPoeAdminState=portPoeAdminState, switchPoeVoltageFailure=switchPoeVoltageFailure, bmSwitchAdmin=bmSwitchAdmin, portSecurityMacAddr1=portSecurityMacAddr1, vlanDescr=vlanDescr, portVoiceVlanId=portVoiceVlanId, sfpInfoLength62um=sfpInfoLength62um, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, switchConfigurationChanged=switchConfigurationChanged, adminAgentPrioValue=adminAgentPrioValue, infoManufactureDate=infoManufactureDate, infoPoeInputVoltage=infoPoeInputVoltage, infoLastSfpEventMessage=infoLastSfpEventMessage, bmSwitchVlanTable=bmSwitchVlanTable, portDefaultPrioQueue=portDefaultPrioQueue, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portLinkType=portLinkType, bmSwitchVlanEntry=bmSwitchVlanEntry, portDescr=portDescr, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portSpeedDuplexSetup=portSpeedDuplexSetup, adminSwitchVlanTableMode=adminSwitchVlanTableMode, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoNoOfPorts=infoNoOfPorts, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminUnsecureVlanId=adminUnsecureVlanId, sfpInfoPartNumber=sfpInfoPartNumber, adminMemoryCardMode=adminMemoryCardMode, portNewMacAddress=portNewMacAddress, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoLastTftpMessage=infoLastTftpMessage, adminSnmpMacTableMode=adminSnmpMacTableMode, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoPoeInputPower=infoPoeInputPower, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpInfoRevisionNumber=sfpInfoRevisionNumber, bmSwitchPort=bmSwitchPort, infoProductNo=infoProductNo, radiusPortSecurityReject=radiusPortSecurityReject, infoTotalConfigChanges=infoTotalConfigChanges, infoFunctionInputStateF1=infoFunctionInputStateF1, portLinkState=portLinkState, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, vlanId=vlanId, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAlarmNameM1=adminAlarmNameM1, tftpMessage=tftpMessage, sfpEvent=sfpEvent, adminAgentDhcp=adminAgentDhcp, portAcApSetup=portAcApSetup, sfpInfoLength50um=sfpInfoLength50um, portRemoteFault=portRemoteFault, sfpInfoLength9um=sfpInfoLength9um, sfpInfoBitRate=sfpInfoBitRate, sfpDiagTemperature=sfpDiagTemperature, internalMgmtWarning=internalMgmtWarning, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, switchFunctionInputAlarm=switchFunctionInputAlarm, portErrorCountFailure=portErrorCountFailure, portBandwidthLimitRxd=portBandwidthLimitRxd, portBandwidthLimitTxd=portBandwidthLimitTxd, infoPowerVoltage2500=infoPowerVoltage2500, infoSerie=infoSerie, portIndex=portIndex, adminAgentIpAddress=adminAgentIpAddress, bmSwitchMIB=bmSwitchMIB, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portPoeOverloadFailure=portPoeOverloadFailure, portDefaultVlanId=portDefaultVlanId, sfpInfoDateCode=sfpInfoDateCode, sfpInfoWavelength=sfpInfoWavelength, adminReset=adminReset, portSecurityForwardingState=portSecurityForwardingState, clientRemoved=clientRemoved, infoSecurityFailMacAddr=infoSecurityFailMacAddr, switchTemperatureFailure=switchTemperatureFailure, sfpPortIndex=sfpPortIndex, adminLedGlobalMode=adminLedGlobalMode, switchInternalVoltageFailure=switchInternalVoltageFailure, adminAlarmM1=adminAlarmM1, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portName=portName, portLoopBcastFailure=portLoopBcastFailure, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, bmSwitchSfpTable=bmSwitchSfpTable, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoAlarmStateM2=infoAlarmStateM2, sfpInfoVendorName=sfpInfoVendorName, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portLinkChange=portLinkChange, portSecurityFailure=portSecurityFailure, bmSwitchVlan=bmSwitchVlan, sfpDiagRxIntputPower=sfpDiagRxIntputPower, radiusMgmtAuthReject=radiusMgmtAuthReject, bmSwitchInfo=bmSwitchInfo, switchPoeOverloadFailure=switchPoeOverloadFailure, portErrorDisabled=portErrorDisabled, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portSecurityAdminState=portSecurityAdminState, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminAgentPhysAddress=adminAgentPhysAddress, vlanIndex=vlanIndex, infoType=infoType, portPoeCurrent=portPoeCurrent, portLimiterPacketType=portLimiterPacketType, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, adminAlarmNameM2=adminAlarmNameM2, infoTemperature=infoTemperature, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminAgentNetmask=adminAgentNetmask, bmSwitchSfp=bmSwitchSfp, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoUnauthIpAddr=infoUnauthIpAddr, portPoeVoltage=portPoeVoltage, adminAgentVlanId=adminAgentVlanId, portSecurityMacAddr2=portSecurityMacAddr2, portPrioDot1p=portPrioDot1p, bmSwitchPortEntry=bmSwitchPortEntry, adminMgmtAccessList=adminMgmtAccessList, infoSeriesNo=infoSeriesNo)
