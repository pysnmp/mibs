...
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, Gauge32, iso, Integer32, ObjectIdentity, Unsigned32, NotificationType, ModuleIdentity, Counter32, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "Gauge32", "iso", "Integer32", "ObjectIdentity", "Unsigned32", "NotificationType", "ModuleIdentity", "Counter32", "IpAddress", "MibIdentifier")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", vlanId=vlanId, portErrorCountFailure=portErrorCountFailure, infoNewMacAddr=infoNewMacAddr, infoPoeInputPower=infoPoeInputPower, portVoiceVlanId=portVoiceVlanId, portErrorDisabled=portErrorDisabled, infoNoOfPorts=infoNoOfPorts, bmSwitchPortTable=bmSwitchPortTable, bmSwitchVlan=bmSwitchVlan, adminFunctionInputNameF1=adminFunctionInputNameF1, portBandwidthLimitRxd=portBandwidthLimitRxd, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, adminAgentIpAddress=adminAgentIpAddress, infoPowerVoltage2500=infoPowerVoltage2500, portLoopBcastFailure=portLoopBcastFailure, infoTotalConfigChanges=infoTotalConfigChanges, adminMemoryCardMode=adminMemoryCardMode, PYSNMP_MODULE_ID=bmSwitchMIB, bmSwitchMIB=bmSwitchMIB, bmSwitchPort=bmSwitchPort, portLinkType=portLinkType, portLEDGreen=portLEDGreen, sfpDiagTemperature=sfpDiagTemperature, sfpInfoWavelength=sfpInfoWavelength, clientRemoved=clientRemoved, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminAlarmM2=adminAlarmM2, adminMgmtAccessList=adminMgmtAccessList, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portPoePowerLimit=portPoePowerLimit, portPoeOverloadFailure=portPoeOverloadFailure, switchFunctionInputAlarm=switchFunctionInputAlarm, infoSerie=infoSerie, infoType=infoType, sfpInfoLength50um=sfpInfoLength50um, portSpeedDuplexSetup=portSpeedDuplexSetup, bmSwitchVlanTable=bmSwitchVlanTable, adminAlarmM1=adminAlarmM1, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoFunctionInputStateF1=infoFunctionInputStateF1, infoUnauthIpAddr=infoUnauthIpAddr, sfpInfoLength62um=sfpInfoLength62um, portErrorCounter=portErrorCounter, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, bmSwitchSfpEntry=bmSwitchSfpEntry, portPoeCurrent=portPoeCurrent, internalMgmtWarning=internalMgmtWarning, portSecurityForwardingState=portSecurityForwardingState, infoNoOfReboots=infoNoOfReboots, sfpInfoLength9um=sfpInfoLength9um, infoLastSfpEventMessage=infoLastSfpEventMessage, switchPoeOverloadFailure=switchPoeOverloadFailure, portAdminState=portAdminState, infoDescr=infoDescr, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpInfoRevisionNumber=sfpInfoRevisionNumber, infoPoeInputVoltage=infoPoeInputVoltage, switchConfigurationChanged=switchConfigurationChanged, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminAgentDhcp=adminAgentDhcp, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, sfpInfoSerialNumber=sfpInfoSerialNumber, infoSeriesNo=infoSeriesNo, sfpInfoDateCode=sfpInfoDateCode, sfpEvent=sfpEvent, infoTemperature=infoTemperature, adminAlarmNameM2=adminAlarmNameM2, adminSwitchVlanTableMode=adminSwitchVlanTableMode, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, switchTemperatureFailure=switchTemperatureFailure, portSecurityMacAddr2=portSecurityMacAddr2, bmTraps=bmTraps, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portLinkChange=portLinkChange, infoLastTftpMessage=infoLastTftpMessage, portLimiterPacketType=portLimiterPacketType, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portSecurityMacAddr3=portSecurityMacAddr3, infoProductNo=infoProductNo, adminUnsecureVlanId=adminUnsecureVlanId, switchMgmtAuthFailure=switchMgmtAuthFailure, portName=portName, sfpPortIndex=sfpPortIndex, adminAlarmNameM1=adminAlarmNameM1, portPoeVoltage=portPoeVoltage, portPoePower=portPoePower, portDescr=portDescr, portSecurityMacAddr1=portSecurityMacAddr1, adminReset=adminReset, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminAgentNetmask=adminAgentNetmask, portAcApSetup=portAcApSetup, tftpMessage=tftpMessage, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portBandwidthLimitTxd=portBandwidthLimitTxd, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portPrioIp=portPrioIp, sfpState=sfpState, switchInternalVoltageFailure=switchInternalVoltageFailure, bmSwitchSfp=bmSwitchSfp, sfpInfoVendorName=sfpInfoVendorName, portPrioDot1p=portPrioDot1p, portSecurityFailure=portSecurityFailure, sfpInfoPartNumber=sfpInfoPartNumber, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portIndex=portIndex, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoAlarmStateM1=infoAlarmStateM1, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminSnmpMacTableMode=adminSnmpMacTableMode, adminSwitchPortMirror=adminSwitchPortMirror, bmSwitchSfpTable=bmSwitchSfpTable, infoPowerVoltage3300=infoPowerVoltage3300, adminAgentPrioValue=adminAgentPrioValue, portSecurityAdminState=portSecurityAdminState, portRemoteFault=portRemoteFault, infoAlarmStateM2=infoAlarmStateM2, portDefaultVlanId=portDefaultVlanId, bmSwitchVlanEntry=bmSwitchVlanEntry, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portPoeAdminState=portPoeAdminState, portLEDYellow=portLEDYellow, portTrunkingMode=portTrunkingMode, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpInfoBitRate=sfpInfoBitRate, portLinkState=portLinkState, vlanDescr=vlanDescr, radiusMgmtAuthReject=radiusMgmtAuthReject, bmSwitchAdmin=bmSwitchAdmin, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, switchPoeVoltageFailure=switchPoeVoltageFailure, vlanIndex=vlanIndex, bmSwitchInfo=bmSwitchInfo, adminTftpAccess=adminTftpAccess, infoManufactureDate=infoManufactureDate, portNewMacAddress=portNewMacAddress, portDefaultPrioQueue=portDefaultPrioQueue, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminLedGlobalMode=adminLedGlobalMode, radiusPortSecurityReject=radiusPortSecurityReject, bmSwitchPortEntry=bmSwitchPortEntry, adminAgentVlanId=adminAgentVlanId, adminAgentPhysAddress=adminAgentPhysAddress)
