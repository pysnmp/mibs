...
mibBuilder.exportSymbols("NEXANS-BM-MIB", adminSwitchVlanTableMode=adminSwitchVlanTableMode, sfpInfoLength9um=sfpInfoLength9um, adminAlarmNameM2=adminAlarmNameM2, adminAgentNetmask=adminAgentNetmask, bmSwitchMIB=bmSwitchMIB, bmSwitchPort=bmSwitchPort, portLinkChange=portLinkChange, switchConfigurationChanged=switchConfigurationChanged, portPrioDot1p=portPrioDot1p, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpInfoConnectorDescr=sfpInfoConnectorDescr, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portPrioIp=portPrioIp, adminAlarmM2=adminAlarmM2, adminMemoryCardMode=adminMemoryCardMode, sfpDiagRxIntputPower=sfpDiagRxIntputPower, bmTraps=bmTraps, portSecurityMacAddr3=portSecurityMacAddr3, adminAgentPhysAddress=adminAgentPhysAddress, portLinkType=portLinkType, infoTemperature=infoTemperature, infoLastTftpMessage=infoLastTftpMessage, adminAgentDhcp=adminAgentDhcp, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portPoeVoltage=portPoeVoltage, bmSwitchSfp=bmSwitchSfp, portSecurityMacAddr2=portSecurityMacAddr2, portSecurityAdminState=portSecurityAdminState, portVoiceVlanId=portVoiceVlanId, portSecurityFailure=portSecurityFailure, switchMgmtAuthFailure=switchMgmtAuthFailure, infoNoOfPorts=infoNoOfPorts, infoTotalConfigChanges=infoTotalConfigChanges, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpInfoBitRate=sfpInfoBitRate, sfpDiagTxOutputPower=sfpDiagTxOutputPower, switchPoeOverloadFailure=switchPoeOverloadFailure, portAdminState=portAdminState, bmSwitchAdmin=bmSwitchAdmin, infoSeriesNo=infoSeriesNo, portIndex=portIndex, sfpEvent=sfpEvent, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpInfoLength50um=sfpInfoLength50um, switchPoeVoltageFailure=switchPoeVoltageFailure, adminAlarmNameM1=adminAlarmNameM1, sfpInfoWavelength=sfpInfoWavelength, infoNoOfReboots=infoNoOfReboots, adminSnmpMacTableMode=adminSnmpMacTableMode, portLimiterPacketType=portLimiterPacketType, sfpInfoRevisionNumber=sfpInfoRevisionNumber, infoProductNo=infoProductNo, adminTftpAccess=adminTftpAccess, adminAlarmM1=adminAlarmM1, infoAlarmStateM1=infoAlarmStateM1, portLEDGreen=portLEDGreen, sfpState=sfpState, sfpInfoDateCode=sfpInfoDateCode, portBandwidthLimitTxd=portBandwidthLimitTxd, infoPowerVoltage3300=infoPowerVoltage3300, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminMgmtAccessList=adminMgmtAccessList, sfpPortIndex=sfpPortIndex, internalMgmtWarning=internalMgmtWarning, portErrorDisabled=portErrorDisabled, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portDefaultVlanId=portDefaultVlanId, portLoopBcastFailure=portLoopBcastFailure, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoSecurityFailMacAddr=infoSecurityFailMacAddr, clientRemoved=clientRemoved, bmSwitchVlan=bmSwitchVlan, infoNewMacAddr=infoNewMacAddr, portSecurityForwardingState=portSecurityForwardingState, portNewMacAddress=portNewMacAddress, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, radiusPortSecurityReject=radiusPortSecurityReject, sfpDiagTemperature=sfpDiagTemperature, adminLedGlobalMode=adminLedGlobalMode, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portRemoteFault=portRemoteFault, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, vlanId=vlanId, infoPowerVoltage2500=infoPowerVoltage2500, infoType=infoType, portLEDYellow=portLEDYellow, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portDefaultPrioQueue=portDefaultPrioQueue, portErrorCountFailure=portErrorCountFailure, PYSNMP_MODULE_ID=bmSwitchMIB, portAcApSetup=portAcApSetup, infoPoeInputPower=infoPoeInputPower, vlanDescr=vlanDescr, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminReset=adminReset, sfpInfoSerialNumber=sfpInfoSerialNumber, portSecurityMacAddr1=portSecurityMacAddr1, sfpInfoPartNumber=sfpInfoPartNumber, portPoePowerLimit=portPoePowerLimit, bmSwitchSfpTable=bmSwitchSfpTable, vlanIndex=vlanIndex, infoFunctionInputStateF1=infoFunctionInputStateF1, bmSwitchPortTable=bmSwitchPortTable, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, radiusMgmtAuthReject=radiusMgmtAuthReject, infoDescr=infoDescr, portErrorCounter=portErrorCounter, portPoePower=portPoePower, portName=portName, portLinkState=portLinkState, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, switchFunctionInputAlarm=switchFunctionInputAlarm, adminSwitchPortMirror=adminSwitchPortMirror, adminAgentIpAddress=adminAgentIpAddress, infoUnauthIpAddr=infoUnauthIpAddr, infoSerie=infoSerie, sfpInfoVendorName=sfpInfoVendorName, portPoeCurrent=portPoeCurrent, adminAgentPrioValue=adminAgentPrioValue, sfpInfoLength62um=sfpInfoLength62um, portDescr=portDescr, tftpMessage=tftpMessage, bmSwitchInfo=bmSwitchInfo, infoLastSfpEventMessage=infoLastSfpEventMessage, infoAlarmStateM2=infoAlarmStateM2, infoMgmtHardwareVersion=infoMgmtHardwareVersion, switchTemperatureFailure=switchTemperatureFailure, bmSwitchPortEntry=bmSwitchPortEntry, adminFunctionInputNameF1=adminFunctionInputNameF1, adminAgentVlanId=adminAgentVlanId, infoManufactureDate=infoManufactureDate, infoPoeInputVoltage=infoPoeInputVoltage, portPoeAdminState=portPoeAdminState, bmSwitchVlanEntry=bmSwitchVlanEntry, adminUnsecureVlanId=adminUnsecureVlanId, portBandwidthLimitRxd=portBandwidthLimitRxd, portTrunkingMode=portTrunkingMode, switchInternalVoltageFailure=switchInternalVoltageFailure, bmSwitchVlanTable=bmSwitchVlanTable, portPoeOverloadFailure=portPoeOverloadFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm)
