...
NotificationType, Integer32, iso, Gauge32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, ObjectIdentity, Unsigned32, ModuleIdentity, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "iso", "Gauge32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portLinkType=portLinkType, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portLoopBcastFailure=portLoopBcastFailure, PYSNMP_MODULE_ID=bmSwitchMIB, portAcApSetup=portAcApSetup, portErrorCountFailure=portErrorCountFailure, infoAlarmStateM1=infoAlarmStateM1, switchIndustrialAlarmM2=switchIndustrialAlarmM2, bmSwitchVlan=bmSwitchVlan, bmSwitchMIB=bmSwitchMIB, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portPoeOverloadFailure=portPoeOverloadFailure, infoTemperature=infoTemperature, sfpInfoDateCode=sfpInfoDateCode, portBandwidthLimitTxd=portBandwidthLimitTxd, infoNoOfReboots=infoNoOfReboots, vlanDescr=vlanDescr, switchInternalVoltageFailure=switchInternalVoltageFailure, infoManufactureDate=infoManufactureDate, adminUnsecureVlanId=adminUnsecureVlanId, infoSwitchHardwareVersion=infoSwitchHardwareVersion, bmSwitchVlanEntry=bmSwitchVlanEntry, portBandwidthLimitRxd=portBandwidthLimitRxd, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminAlarmNameM2=adminAlarmNameM2, adminAgentPhysAddress=adminAgentPhysAddress, portLEDYellow=portLEDYellow, adminFunctionInputNameF1=adminFunctionInputNameF1, portPoeAdminState=portPoeAdminState, bmSwitchPort=bmSwitchPort, switchMgmtAuthFailure=switchMgmtAuthFailure, infoAlarmStateM2=infoAlarmStateM2, vlanIndex=vlanIndex, sfpEvent=sfpEvent, infoDescr=infoDescr, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminSnmpMacTableMode=adminSnmpMacTableMode, portTrunkingMode=portTrunkingMode, adminSwitchPortMirror=adminSwitchPortMirror, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portSecurityMacAddr1=portSecurityMacAddr1, switchFunctionInputAlarm=switchFunctionInputAlarm, sfpInfoConnectorDescr=sfpInfoConnectorDescr, sfpInfoPartNumber=sfpInfoPartNumber, sfpInfoWavelength=sfpInfoWavelength, sfpDiagTemperature=sfpDiagTemperature, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpInfoBitRate=sfpInfoBitRate, infoType=infoType, radiusMgmtAuthReject=radiusMgmtAuthReject, portPoePowerLimit=portPoePowerLimit, portPoeCurrent=portPoeCurrent, sfpState=sfpState, vlanId=vlanId, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpInfoVendorName=sfpInfoVendorName, infoSeriesNo=infoSeriesNo, bmSwitchPortTable=bmSwitchPortTable, infoFunctionInputStateF1=infoFunctionInputStateF1, portPoeVoltage=portPoeVoltage, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portLimiterPacketType=portLimiterPacketType, portSecurityFailure=portSecurityFailure, infoPowerVoltage3300=infoPowerVoltage3300, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, bmSwitchSfpTable=bmSwitchSfpTable, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portRemoteFault=portRemoteFault, portSecurityAdminState=portSecurityAdminState, infoLastTftpMessage=infoLastTftpMessage, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portErrorDisabled=portErrorDisabled, clientRemoved=clientRemoved, switchPoeOverloadFailure=switchPoeOverloadFailure, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portDefaultVlanId=portDefaultVlanId, sfpPortIndex=sfpPortIndex, portVoiceVlanId=portVoiceVlanId, bmSwitchSfpEntry=bmSwitchSfpEntry, bmSwitchSfp=bmSwitchSfp, portPrioIp=portPrioIp, portPrioDot1p=portPrioDot1p, radiusPortSecurityReject=radiusPortSecurityReject, sfpInfoLength62um=sfpInfoLength62um, portLinkChange=portLinkChange, adminAgentDhcp=adminAgentDhcp, portDescr=portDescr, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminAlarmNameM1=adminAlarmNameM1, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, infoSerie=infoSerie, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portDefaultPrioQueue=portDefaultPrioQueue, infoNewMacAddr=infoNewMacAddr, infoPowerVoltage2500=infoPowerVoltage2500, bmTraps=bmTraps, switchTemperatureFailure=switchTemperatureFailure, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminReset=adminReset, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminAlarmM1=adminAlarmM1, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, internalMgmtWarning=internalMgmtWarning, portName=portName, sfpInfoLength50um=sfpInfoLength50um, switchIndustrialAlarmM1=switchIndustrialAlarmM1, bmSwitchPortEntry=bmSwitchPortEntry, infoNoOfPorts=infoNoOfPorts, portLinkState=portLinkState, portSecurityMacAddr3=portSecurityMacAddr3, infoProductNo=infoProductNo, adminMgmtAccessList=adminMgmtAccessList, infoPoeInputVoltage=infoPoeInputVoltage, adminAgentIpAddress=adminAgentIpAddress, portSecurityForwardingState=portSecurityForwardingState, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portLEDGreen=portLEDGreen, bmSwitchInfo=bmSwitchInfo, infoPoeInputPower=infoPoeInputPower, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminLedGlobalMode=adminLedGlobalMode, adminMemoryCardMode=adminMemoryCardMode, portPoePower=portPoePower, bmSwitchAdmin=bmSwitchAdmin, portAdminState=portAdminState, portSecurityMacAddr2=portSecurityMacAddr2, infoLastSfpEventMessage=infoLastSfpEventMessage, infoUnauthIpAddr=infoUnauthIpAddr, portNewMacAddress=portNewMacAddress, switchPoeVoltageFailure=switchPoeVoltageFailure, sfpInfoLength9um=sfpInfoLength9um, infoTotalConfigChanges=infoTotalConfigChanges, adminTftpAccess=adminTftpAccess, adminAgentPrioValue=adminAgentPrioValue, switchConfigurationChanged=switchConfigurationChanged, bmSwitchVlanTable=bmSwitchVlanTable, portIndex=portIndex, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminAlarmM2=adminAlarmM2, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminAgentVlanId=adminAgentVlanId, adminAgentNetmask=adminAgentNetmask, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, tftpMessage=tftpMessage, portErrorCounter=portErrorCounter)
