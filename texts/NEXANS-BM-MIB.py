...
mibBuilder.exportSymbols("NEXANS-BM-MIB", adminSwitchVlanTableMode=adminSwitchVlanTableMode, infoFunctionInputStateF1=infoFunctionInputStateF1, portLinkType=portLinkType, sfpInfoLength9um=sfpInfoLength9um, portPoeAdminState=portPoeAdminState, portLinkChange=portLinkChange, infoTotalConfigChanges=infoTotalConfigChanges, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portSpeedDuplexSetup=portSpeedDuplexSetup, portNewMacAddress=portNewMacAddress, infoLastSfpEventMessage=infoLastSfpEventMessage, portLimiterPacketType=portLimiterPacketType, infoType=infoType, adminAgentDhcp=adminAgentDhcp, portDefaultPrioQueue=portDefaultPrioQueue, portDescr=portDescr, infoNewMacAddr=infoNewMacAddr, portLEDGreen=portLEDGreen, sfpInfoLength50um=sfpInfoLength50um, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoPowerVoltage2500=infoPowerVoltage2500, portPoeCurrent=portPoeCurrent, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpInfoConnectorDescr=sfpInfoConnectorDescr, sfpInfoSerialNumber=sfpInfoSerialNumber, infoProductNo=infoProductNo, infoAlarmStateM2=infoAlarmStateM2, portSecurityFailure=portSecurityFailure, adminAlarmNameM2=adminAlarmNameM2, bmSwitchVlan=bmSwitchVlan, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, infoNoOfReboots=infoNoOfReboots, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, bmSwitchPortEntry=bmSwitchPortEntry, vlanId=vlanId, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portSecurityMacAddr2=portSecurityMacAddr2, bmSwitchInfo=bmSwitchInfo, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, radiusMgmtAuthReject=radiusMgmtAuthReject, sfpInfoWavelength=sfpInfoWavelength, bmSwitchMIB=bmSwitchMIB, portSecurityMacAddr3=portSecurityMacAddr3, portAdminState=portAdminState, adminUnsecureVlanId=adminUnsecureVlanId, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, vlanIndex=vlanIndex, infoPoeInputPower=infoPoeInputPower, portRemoteFault=portRemoteFault, portErrorCountFailure=portErrorCountFailure, bmTraps=bmTraps, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, switchMgmtAuthFailure=switchMgmtAuthFailure, portName=portName, adminAlarmM1=adminAlarmM1, portDefaultVlanId=portDefaultVlanId, infoSerie=infoSerie, clientRemoved=clientRemoved, sfpInfoPartNumber=sfpInfoPartNumber, portLoopBcastFailure=portLoopBcastFailure, portSecurityAdminState=portSecurityAdminState, switchPoeVoltageFailure=switchPoeVoltageFailure, adminAgentIpAddress=adminAgentIpAddress, sfpInfoDateCode=sfpInfoDateCode, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoDescr=infoDescr, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoPoeInputVoltage=infoPoeInputVoltage, radiusPortSecurityReject=radiusPortSecurityReject, portSecurityMacAddr1=portSecurityMacAddr1, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminLedGlobalMode=adminLedGlobalMode, switchInternalVoltageFailure=switchInternalVoltageFailure, portBandwidthLimitRxd=portBandwidthLimitRxd, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, sfpInfoVendorName=sfpInfoVendorName, adminAgentPrioValue=adminAgentPrioValue, switchTemperatureFailure=switchTemperatureFailure, bmSwitchSfpTable=bmSwitchSfpTable, infoSeriesNo=infoSeriesNo, bmSwitchSfp=bmSwitchSfp, adminTftpAccess=adminTftpAccess, sfpPortIndex=sfpPortIndex, vlanDescr=vlanDescr, sfpDiagTxOutputPower=sfpDiagTxOutputPower, infoUnauthIpAddr=infoUnauthIpAddr, adminFunctionInputNameF1=adminFunctionInputNameF1, portTrunkingMode=portTrunkingMode, sfpInfoBitRate=sfpInfoBitRate, switchPoeOverloadFailure=switchPoeOverloadFailure, bmSwitchPortTable=bmSwitchPortTable, portLEDYellow=portLEDYellow, sfpInfoLength62um=sfpInfoLength62um, sfpDiagTemperature=sfpDiagTemperature, adminSnmpMacTableMode=adminSnmpMacTableMode, infoPowerVoltage3300=infoPowerVoltage3300, portErrorCounter=portErrorCounter, adminAgentVlanId=adminAgentVlanId, portPoeVoltage=portPoeVoltage, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, internalMgmtWarning=internalMgmtWarning, portErrorDisabled=portErrorDisabled, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portPoeOverloadFailure=portPoeOverloadFailure, portLinkState=portLinkState, bmSwitchPort=bmSwitchPort, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portBandwidthLimitTxd=portBandwidthLimitTxd, PYSNMP_MODULE_ID=bmSwitchMIB, sfpEvent=sfpEvent, adminAgentPhysAddress=adminAgentPhysAddress, bmSwitchSfpEntry=bmSwitchSfpEntry, portPrioDot1p=portPrioDot1p, adminMgmtAccessList=adminMgmtAccessList, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminMemoryCardMode=adminMemoryCardMode, bmSwitchVlanTable=bmSwitchVlanTable, infoTemperature=infoTemperature, infoAlarmStateM1=infoAlarmStateM1, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portPoePower=portPoePower, infoLastTftpMessage=infoLastTftpMessage, portSecurityForwardingState=portSecurityForwardingState, infoNoOfPorts=infoNoOfPorts, portVoiceVlanId=portVoiceVlanId, portPoePowerLimit=portPoePowerLimit, portIndex=portIndex, adminAlarmNameM1=adminAlarmNameM1, sfpState=sfpState, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminAlarmM2=adminAlarmM2, tftpMessage=tftpMessage, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, switchFunctionInputAlarm=switchFunctionInputAlarm, adminAgentNetmask=adminAgentNetmask, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portPrioIp=portPrioIp, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, bmSwitchVlanEntry=bmSwitchVlanEntry, adminSwitchPortMirror=adminSwitchPortMirror, infoManufactureDate=infoManufactureDate, switchConfigurationChanged=switchConfigurationChanged, bmSwitchAdmin=bmSwitchAdmin, adminReset=adminReset, portAcApSetup=portAcApSetup)
