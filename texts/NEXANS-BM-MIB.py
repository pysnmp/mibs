...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portDefaultVlanId=portDefaultVlanId, infoNoOfReboots=infoNoOfReboots, portErrorCounter=portErrorCounter, bmSwitchAdmin=bmSwitchAdmin, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, adminMemoryCardMode=adminMemoryCardMode, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, bmSwitchMIB=bmSwitchMIB, bmSwitchVlan=bmSwitchVlan, portLEDGreen=portLEDGreen, bmTraps=bmTraps, infoUnauthIpAddr=infoUnauthIpAddr, internalMgmtWarning=internalMgmtWarning, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpInfoSerialNumber=sfpInfoSerialNumber, adminAgentNetmask=adminAgentNetmask, switchInternalVoltageFailure=switchInternalVoltageFailure, portLimiterPacketType=portLimiterPacketType, adminAlarmM2=adminAlarmM2, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpInfoVendorName=sfpInfoVendorName, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portPoePower=portPoePower, portAcApSetup=portAcApSetup, infoPowerVoltage3300=infoPowerVoltage3300, infoPoeInputVoltage=infoPoeInputVoltage, portBandwidthLimitRxd=portBandwidthLimitRxd, vlanId=vlanId, sfpInfoPartNumber=sfpInfoPartNumber, infoNoOfPorts=infoNoOfPorts, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, vlanIndex=vlanIndex, bmSwitchVlanTable=bmSwitchVlanTable, adminAgentPhysAddress=adminAgentPhysAddress, portSecurityForwardingState=portSecurityForwardingState, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portNewMacAddress=portNewMacAddress, sfpEvent=sfpEvent, switchTemperatureFailure=switchTemperatureFailure, portVoiceVlanId=portVoiceVlanId, sfpInfoLength50um=sfpInfoLength50um, adminLedGlobalMode=adminLedGlobalMode, adminMgmtAccessList=adminMgmtAccessList, infoTemperature=infoTemperature, portRemoteFault=portRemoteFault, bmSwitchSfp=bmSwitchSfp, bmSwitchPortTable=bmSwitchPortTable, portPoeCurrent=portPoeCurrent, infoSeriesNo=infoSeriesNo, infoLastSfpEventMessage=infoLastSfpEventMessage, adminAgentVlanId=adminAgentVlanId, portPrioDot1p=portPrioDot1p, portLoopBcastFailure=portLoopBcastFailure, infoProductNo=infoProductNo, portPoePowerLimit=portPoePowerLimit, portTrunkingMode=portTrunkingMode, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminAgentDhcp=adminAgentDhcp, switchPoeOverloadFailure=switchPoeOverloadFailure, portPoeOverloadFailure=portPoeOverloadFailure, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portErrorDisabled=portErrorDisabled, portBandwidthLimitTxd=portBandwidthLimitTxd, bmSwitchInfo=bmSwitchInfo, infoType=infoType, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portPoeAdminState=portPoeAdminState, portSecurityAdminState=portSecurityAdminState, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoDescr=infoDescr, bmSwitchPortEntry=bmSwitchPortEntry, switchFunctionInputAlarm=switchFunctionInputAlarm, adminAgentIpAddress=adminAgentIpAddress, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, sfpInfoLength62um=sfpInfoLength62um, vlanDescr=vlanDescr, sfpInfoLength9um=sfpInfoLength9um, portLinkState=portLinkState, clientRemoved=clientRemoved, adminUnsecureVlanId=adminUnsecureVlanId, portDescr=portDescr, adminAlarmM1=adminAlarmM1, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoSerie=infoSerie, sfpInfoDateCode=sfpInfoDateCode, sfpState=sfpState, infoManufactureDate=infoManufactureDate, sfpDiagTemperature=sfpDiagTemperature, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminAgentPrioValue=adminAgentPrioValue, adminSwitchPortMirror=adminSwitchPortMirror, tftpMessage=tftpMessage, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, bmSwitchPort=bmSwitchPort, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, sfpPortIndex=sfpPortIndex, infoLastTftpMessage=infoLastTftpMessage, infoNewMacAddr=infoNewMacAddr, infoAlarmStateM2=infoAlarmStateM2, infoAlarmStateM1=infoAlarmStateM1, adminSnmpMacTableMode=adminSnmpMacTableMode, portPrioIp=portPrioIp, radiusMgmtAuthReject=radiusMgmtAuthReject, portDefaultPrioQueue=portDefaultPrioQueue, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, bmSwitchSfpTable=bmSwitchSfpTable, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portSecurityMacAddr3=portSecurityMacAddr3, adminAlarmNameM1=adminAlarmNameM1, infoTotalConfigChanges=infoTotalConfigChanges, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoPowerVoltage2500=infoPowerVoltage2500, switchConfigurationChanged=switchConfigurationChanged, portLinkType=portLinkType, bmSwitchSfpEntry=bmSwitchSfpEntry, portErrorCountFailure=portErrorCountFailure, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, switchPoeVoltageFailure=switchPoeVoltageFailure, portSpeedDuplexSetup=portSpeedDuplexSetup, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portSecurityMacAddr1=portSecurityMacAddr1, adminAlarmNameM2=adminAlarmNameM2, portIndex=portIndex, portSecurityFailure=portSecurityFailure, portSecurityMacAddr2=portSecurityMacAddr2, radiusPortSecurityReject=radiusPortSecurityReject, adminFunctionInputNameF1=adminFunctionInputNameF1, PYSNMP_MODULE_ID=bmSwitchMIB, portLEDYellow=portLEDYellow, portPoeVoltage=portPoeVoltage, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminReset=adminReset, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpInfoWavelength=sfpInfoWavelength, portAdminState=portAdminState, portLinkChange=portLinkChange, adminTftpAccess=adminTftpAccess, sfpInfoBitRate=sfpInfoBitRate, portName=portName, switchMgmtAuthFailure=switchMgmtAuthFailure, infoPoeInputPower=infoPoeInputPower, infoFunctionInputStateF1=infoFunctionInputStateF1)
