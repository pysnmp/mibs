...
mibBuilder.exportSymbols("NEXANS-BM-MIB", bmSwitchVlanEntry=bmSwitchVlanEntry, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portPoeCurrent=portPoeCurrent, portNewMacAddress=portNewMacAddress, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminSnmpMacTableMode=adminSnmpMacTableMode, adminAlarmNameM1=adminAlarmNameM1, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoDescr=infoDescr, adminMgmtAccessList=adminMgmtAccessList, portLEDYellow=portLEDYellow, adminAgentPrioValue=adminAgentPrioValue, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portLEDGreen=portLEDGreen, sfpInfoPartNumber=sfpInfoPartNumber, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portErrorCountFailure=portErrorCountFailure, bmSwitchSfp=bmSwitchSfp, portPoeOverloadFailure=portPoeOverloadFailure, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoLastTftpMessage=infoLastTftpMessage, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, infoTemperature=infoTemperature, infoPowerVoltage3300=infoPowerVoltage3300, bmSwitchInfo=bmSwitchInfo, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminAlarmM1=adminAlarmM1, infoAlarmStateM2=infoAlarmStateM2, infoNewMacAddr=infoNewMacAddr, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portSecurityMacAddr2=portSecurityMacAddr2, portDefaultVlanId=portDefaultVlanId, portPoePower=portPoePower, sfpInfoLength50um=sfpInfoLength50um, infoNoOfReboots=infoNoOfReboots, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, sfpInfoWavelength=sfpInfoWavelength, portVoiceVlanId=portVoiceVlanId, infoSerie=infoSerie, portPrioDot1p=portPrioDot1p, adminAlarmNameM2=adminAlarmNameM2, adminAlarmM2=adminAlarmM2, bmSwitchPort=bmSwitchPort, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portSecurityMacAddr1=portSecurityMacAddr1, portSecurityMacAddr3=portSecurityMacAddr3, infoUnauthIpAddr=infoUnauthIpAddr, portSecurityFailure=portSecurityFailure, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoFunctionInputStateF1=infoFunctionInputStateF1, switchFunctionInputAlarm=switchFunctionInputAlarm, infoManufactureDate=infoManufactureDate, portDescr=portDescr, infoPoeInputVoltage=infoPoeInputVoltage, adminTftpAccess=adminTftpAccess, sfpPortIndex=sfpPortIndex, adminAgentVlanId=adminAgentVlanId, portPoeAdminState=portPoeAdminState, portRemoteFault=portRemoteFault, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, clientRemoved=clientRemoved, portLoopBcastFailure=portLoopBcastFailure, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminReset=adminReset, sfpState=sfpState, portErrorCounter=portErrorCounter, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoLastSfpEventMessage=infoLastSfpEventMessage, portPrioIp=portPrioIp, adminAgentNetmask=adminAgentNetmask, portLinkState=portLinkState, portName=portName, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpInfoConnectorDescr=sfpInfoConnectorDescr, switchIndustrialAlarmM1=switchIndustrialAlarmM1, switchConfigurationChanged=switchConfigurationChanged, adminAgentIpAddress=adminAgentIpAddress, switchMgmtAuthFailure=switchMgmtAuthFailure, portBandwidthLimitRxd=portBandwidthLimitRxd, bmSwitchVlan=bmSwitchVlan, adminMemoryCardMode=adminMemoryCardMode, infoAlarmStateM1=infoAlarmStateM1, portLinkChange=portLinkChange, bmSwitchPortEntry=bmSwitchPortEntry, adminAgentDhcp=adminAgentDhcp, sfpInfoDateCode=sfpInfoDateCode, infoSeriesNo=infoSeriesNo, infoPowerVoltage2500=infoPowerVoltage2500, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portSecurityForwardingState=portSecurityForwardingState, bmSwitchAdmin=bmSwitchAdmin, infoNoOfPorts=infoNoOfPorts, tftpMessage=tftpMessage, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, infoProductNo=infoProductNo, adminLedGlobalMode=adminLedGlobalMode, portPoePowerLimit=portPoePowerLimit, switchPoeOverloadFailure=switchPoeOverloadFailure, bmSwitchPortTable=bmSwitchPortTable, sfpInfoLength9um=sfpInfoLength9um, infoType=infoType, bmSwitchSfpEntry=bmSwitchSfpEntry, adminUnsecureVlanId=adminUnsecureVlanId, portAdminState=portAdminState, sfpEvent=sfpEvent, portPoeVoltage=portPoeVoltage, vlanId=vlanId, portDefaultPrioQueue=portDefaultPrioQueue, portErrorDisabled=portErrorDisabled, radiusPortSecurityReject=radiusPortSecurityReject, adminSwitchPortMirror=adminSwitchPortMirror, infoPoeInputPower=infoPoeInputPower, portTrunkingMode=portTrunkingMode, sfpInfoLength62um=sfpInfoLength62um, switchPoeVoltageFailure=switchPoeVoltageFailure, portSecurityAdminState=portSecurityAdminState, infoSwitchHardwareVersion=infoSwitchHardwareVersion, PYSNMP_MODULE_ID=bmSwitchMIB, portIndex=portIndex, sfpInfoRevisionNumber=sfpInfoRevisionNumber, vlanDescr=vlanDescr, switchInternalVoltageFailure=switchInternalVoltageFailure, portLinkType=portLinkType, sfpDiagTemperature=sfpDiagTemperature, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, internalMgmtWarning=internalMgmtWarning, adminFunctionInputNameF1=adminFunctionInputNameF1, infoTotalConfigChanges=infoTotalConfigChanges, portAcApSetup=portAcApSetup, adminAgentPhysAddress=adminAgentPhysAddress, vlanIndex=vlanIndex, sfpInfoSerialNumber=sfpInfoSerialNumber, switchTemperatureFailure=switchTemperatureFailure, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, bmTraps=bmTraps, radiusMgmtAuthReject=radiusMgmtAuthReject, bmSwitchMIB=bmSwitchMIB, bmSwitchSfpTable=bmSwitchSfpTable, portLimiterPacketType=portLimiterPacketType, sfpInfoVendorName=sfpInfoVendorName, sfpDiagTxOutputPower=sfpDiagTxOutputPower, bmSwitchVlanTable=bmSwitchVlanTable, sfpInfoBitRate=sfpInfoBitRate)
