...
Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, iso, ObjectIdentity, Counter32, Counter64, Gauge32, TimeTicks, Unsigned32, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "iso", "ObjectIdentity", "Counter32", "Counter64", "Gauge32", "TimeTicks", "Unsigned32", "IpAddress", "NotificationType")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", adminFunctionInputNameF1=adminFunctionInputNameF1, adminAlarmM2=adminAlarmM2, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminAlarmNameM2=adminAlarmNameM2, portLinkState=portLinkState, sfpInfoDateCode=sfpInfoDateCode, portErrorCounter=portErrorCounter, adminMgmtAccessList=adminMgmtAccessList, portSecurityMacAddr1=portSecurityMacAddr1, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminSnmpMacTableMode=adminSnmpMacTableMode, infoAlarmStateM1=infoAlarmStateM1, portSecurityForwardingState=portSecurityForwardingState, infoProductNo=infoProductNo, clientRemoved=clientRemoved, infoLastSfpEventMessage=infoLastSfpEventMessage, portIndex=portIndex, vlanId=vlanId, bmSwitchSfpEntry=bmSwitchSfpEntry, portLinkChange=portLinkChange, radiusMgmtAuthReject=radiusMgmtAuthReject, infoSeriesNo=infoSeriesNo, portSecurityMacAddr3=portSecurityMacAddr3, bmSwitchSfpTable=bmSwitchSfpTable, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminAgentVlanId=adminAgentVlanId, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpInfoSerialNumber=sfpInfoSerialNumber, infoNoOfReboots=infoNoOfReboots, infoLastTftpMessage=infoLastTftpMessage, adminAlarmM1=adminAlarmM1, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminAgentDhcp=adminAgentDhcp, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, switchPoeVoltageFailure=switchPoeVoltageFailure, infoFunctionInputStateF1=infoFunctionInputStateF1, portDefaultVlanId=portDefaultVlanId, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoNoOfPorts=infoNoOfPorts, sfpInfoPartNumber=sfpInfoPartNumber, radiusPortSecurityReject=radiusPortSecurityReject, portLEDGreen=portLEDGreen, adminTftpAccess=adminTftpAccess, sfpInfoLength50um=sfpInfoLength50um, bmSwitchPort=bmSwitchPort, portAcApSetup=portAcApSetup, bmSwitchMIB=bmSwitchMIB, infoDescr=infoDescr, sfpInfoConnectorDescr=sfpInfoConnectorDescr, switchInternalVoltageFailure=switchInternalVoltageFailure, adminAgentPrioValue=adminAgentPrioValue, portBandwidthLimitTxd=portBandwidthLimitTxd, portLoopBcastFailure=portLoopBcastFailure, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpEvent=sfpEvent, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAgentIpAddress=adminAgentIpAddress, adminAgentNetmask=adminAgentNetmask, portDescr=portDescr, adminAgentPhysAddress=adminAgentPhysAddress, portVoiceVlanId=portVoiceVlanId, portSecurityFailure=portSecurityFailure, infoAlarmStateM2=infoAlarmStateM2, portName=portName, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portSecurityMacAddr2=portSecurityMacAddr2, portNewMacAddress=portNewMacAddress, infoPowerVoltage3300=infoPowerVoltage3300, infoSerie=infoSerie, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpPortIndex=sfpPortIndex, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portBandwidthLimitRxd=portBandwidthLimitRxd, tftpMessage=tftpMessage, infoPowerVoltage2500=infoPowerVoltage2500, infoTemperature=infoTemperature, portLEDYellow=portLEDYellow, portPoeOverloadFailure=portPoeOverloadFailure, sfpInfoVendorName=sfpInfoVendorName, sfpInfoLength62um=sfpInfoLength62um, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminReset=adminReset, portErrorCountFailure=portErrorCountFailure, bmSwitchVlanTable=bmSwitchVlanTable, portPrioIp=portPrioIp, sfpState=sfpState, sfpInfoWavelength=sfpInfoWavelength, bmSwitchInfo=bmSwitchInfo, infoNewMacAddr=infoNewMacAddr, bmSwitchSfp=bmSwitchSfp, bmTraps=bmTraps, switchFunctionInputAlarm=switchFunctionInputAlarm, vlanIndex=vlanIndex, switchPoeOverloadFailure=switchPoeOverloadFailure, portAdminState=portAdminState, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portDefaultPrioQueue=portDefaultPrioQueue, portPoeVoltage=portPoeVoltage, portErrorDisabled=portErrorDisabled, adminMemoryCardMode=adminMemoryCardMode, bmSwitchPortEntry=bmSwitchPortEntry, bmSwitchVlan=bmSwitchVlan, adminAlarmNameM1=adminAlarmNameM1, portSecurityAdminState=portSecurityAdminState, portPoePower=portPoePower, portPoePowerLimit=portPoePowerLimit, infoPoeInputVoltage=infoPoeInputVoltage, bmSwitchPortTable=bmSwitchPortTable, portPoeCurrent=portPoeCurrent, vlanDescr=vlanDescr, adminLedGlobalMode=adminLedGlobalMode, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portRemoteFault=portRemoteFault, internalMgmtWarning=internalMgmtWarning, sfpInfoLength9um=sfpInfoLength9um, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, PYSNMP_MODULE_ID=bmSwitchMIB, adminSwitchPortMirror=adminSwitchPortMirror, adminUnsecureVlanId=adminUnsecureVlanId, sfpInfoBitRate=sfpInfoBitRate, switchMgmtAuthFailure=switchMgmtAuthFailure, switchTemperatureFailure=switchTemperatureFailure, bmSwitchVlanEntry=bmSwitchVlanEntry, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portLinkType=portLinkType, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, bmSwitchAdmin=bmSwitchAdmin, infoType=infoType, sfpDiagTemperature=sfpDiagTemperature, switchConfigurationChanged=switchConfigurationChanged, infoPoeInputPower=infoPoeInputPower, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoUnauthIpAddr=infoUnauthIpAddr, portLimiterPacketType=portLimiterPacketType, infoManufactureDate=infoManufactureDate, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portTrunkingMode=portTrunkingMode, portPrioDot1p=portPrioDot1p, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoTotalConfigChanges=infoTotalConfigChanges, portPoeAdminState=portPoeAdminState, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit)
