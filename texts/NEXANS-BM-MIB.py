...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoSecurityFailMacAddr=infoSecurityFailMacAddr, infoSeriesNo=infoSeriesNo, portRemoteFault=portRemoteFault, portSecurityMacAddr3=portSecurityMacAddr3, sfpInfoDateCode=sfpInfoDateCode, infoLastSfpEventMessage=infoLastSfpEventMessage, portSecurityMacAddr1=portSecurityMacAddr1, bmSwitchInfo=bmSwitchInfo, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpInfoWavelength=sfpInfoWavelength, switchFunctionInputAlarm=switchFunctionInputAlarm, infoTemperature=infoTemperature, portErrorCounter=portErrorCounter, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, clientRemoved=clientRemoved, radiusPortSecurityReject=radiusPortSecurityReject, portAcApSetup=portAcApSetup, portDescr=portDescr, portDefaultVlanId=portDefaultVlanId, portSecurityFailure=portSecurityFailure, sfpInfoBitRate=sfpInfoBitRate, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoNoOfPorts=infoNoOfPorts, infoType=infoType, switchTemperatureFailure=switchTemperatureFailure, bmSwitchPortEntry=bmSwitchPortEntry, portIndex=portIndex, infoPoeInputPower=infoPoeInputPower, infoPowerVoltage3300=infoPowerVoltage3300, infoSerie=infoSerie, sfpInfoPartNumber=sfpInfoPartNumber, bmSwitchVlan=bmSwitchVlan, bmSwitchVlanTable=bmSwitchVlanTable, infoProductNo=infoProductNo, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpState=sfpState, infoAlarmStateM2=infoAlarmStateM2, adminAlarmM2=adminAlarmM2, portBandwidthLimitRxd=portBandwidthLimitRxd, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminLedGlobalMode=adminLedGlobalMode, portErrorDisabled=portErrorDisabled, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portAdminState=portAdminState, sfpPortIndex=sfpPortIndex, infoLastTftpMessage=infoLastTftpMessage, adminAgentPrioValue=adminAgentPrioValue, adminSnmpMacTableMode=adminSnmpMacTableMode, bmSwitchSfpEntry=bmSwitchSfpEntry, bmSwitchPort=bmSwitchPort, adminAgentIpAddress=adminAgentIpAddress, portLinkType=portLinkType, portName=portName, radiusMgmtAuthReject=radiusMgmtAuthReject, portPoePowerLimit=portPoePowerLimit, portNewMacAddress=portNewMacAddress, bmSwitchPortTable=bmSwitchPortTable, sfpDiagTemperature=sfpDiagTemperature, portPoeOverloadFailure=portPoeOverloadFailure, bmSwitchMIB=bmSwitchMIB, tftpMessage=tftpMessage, infoFunctionInputStateF1=infoFunctionInputStateF1, adminAgentVlanId=adminAgentVlanId, switchConfigurationChanged=switchConfigurationChanged, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portSecurityAdminState=portSecurityAdminState, infoNewMacAddr=infoNewMacAddr, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portErrorCountFailure=portErrorCountFailure, adminSwitchPortMirror=adminSwitchPortMirror, adminMgmtAccessList=adminMgmtAccessList, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, sfpInfoLength62um=sfpInfoLength62um, infoManufactureDate=infoManufactureDate, switchPoeOverloadFailure=switchPoeOverloadFailure, switchPoeVoltageFailure=switchPoeVoltageFailure, infoUnauthIpAddr=infoUnauthIpAddr, portVoiceVlanId=portVoiceVlanId, adminFunctionInputNameF1=adminFunctionInputNameF1, sfpInfoVendorName=sfpInfoVendorName, adminAlarmM1=adminAlarmM1, sfpEvent=sfpEvent, adminTftpAccess=adminTftpAccess, infoMgmtHardwareVersion=infoMgmtHardwareVersion, bmSwitchSfp=bmSwitchSfp, adminAgentPhysAddress=adminAgentPhysAddress, portSpeedDuplexSetup=portSpeedDuplexSetup, portLEDGreen=portLEDGreen, portDefaultPrioQueue=portDefaultPrioQueue, portLimiterPacketType=portLimiterPacketType, vlanDescr=vlanDescr, portSecurityForwardingState=portSecurityForwardingState, portLinkChange=portLinkChange, switchInternalVoltageFailure=switchInternalVoltageFailure, infoDescr=infoDescr, internalMgmtWarning=internalMgmtWarning, portLinkState=portLinkState, sfpInfoSerialNumber=sfpInfoSerialNumber, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminAlarmNameM2=adminAlarmNameM2, infoPowerVoltage2500=infoPowerVoltage2500, vlanIndex=vlanIndex, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portPoePower=portPoePower, infoAlarmStateM1=infoAlarmStateM1, infoTotalConfigChanges=infoTotalConfigChanges, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portLEDYellow=portLEDYellow, sfpInfoLength50um=sfpInfoLength50um, portPrioDot1p=portPrioDot1p, portLoopBcastFailure=portLoopBcastFailure, bmSwitchSfpTable=bmSwitchSfpTable, adminAgentDhcp=adminAgentDhcp, adminMemoryCardMode=adminMemoryCardMode, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portPrioIp=portPrioIp, infoPoeInputVoltage=infoPoeInputVoltage, bmTraps=bmTraps, portPoeCurrent=portPoeCurrent, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portPoeAdminState=portPoeAdminState, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminAlarmNameM1=adminAlarmNameM1, vlanId=vlanId, adminUnsecureVlanId=adminUnsecureVlanId, adminReset=adminReset, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, bmSwitchAdmin=bmSwitchAdmin, sfpInfoLength9um=sfpInfoLength9um, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, infoNoOfReboots=infoNoOfReboots, portSecurityMacAddr2=portSecurityMacAddr2, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, PYSNMP_MODULE_ID=bmSwitchMIB, adminAgentNetmask=adminAgentNetmask, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portTrunkingMode=portTrunkingMode, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminSwitchVlanTableMode=adminSwitchVlanTableMode, switchMgmtAuthFailure=switchMgmtAuthFailure, portPoeVoltage=portPoeVoltage, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue)
