...
iso, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Gauge32, ModuleIdentity, Unsigned32, IpAddress, TimeTicks, Integer32, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Gauge32", "ModuleIdentity", "Unsigned32", "IpAddress", "TimeTicks", "Integer32", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portPoePowerLimit=portPoePowerLimit, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, bmSwitchVlanTable=bmSwitchVlanTable, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminAgentIpAddress=adminAgentIpAddress, adminAgentDhcp=adminAgentDhcp, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoProductNo=infoProductNo, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoNewMacAddr=infoNewMacAddr, adminAlarmM2=adminAlarmM2, portDefaultVlanId=portDefaultVlanId, infoPoeInputVoltage=infoPoeInputVoltage, infoSecurityFailMacAddr=infoSecurityFailMacAddr, infoLastSfpEventMessage=infoLastSfpEventMessage, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpInfoPartNumber=sfpInfoPartNumber, portVoiceVlanId=portVoiceVlanId, switchPoeOverloadFailure=switchPoeOverloadFailure, adminTftpAccess=adminTftpAccess, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, infoSeriesNo=infoSeriesNo, portRemoteFault=portRemoteFault, adminAgentVlanId=adminAgentVlanId, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portIndex=portIndex, portName=portName, adminSwitchVlanTableMode=adminSwitchVlanTableMode, vlanDescr=vlanDescr, infoNoOfReboots=infoNoOfReboots, infoType=infoType, portAdminState=portAdminState, infoAlarmStateM2=infoAlarmStateM2, portSecurityFailure=portSecurityFailure, bmSwitchPortEntry=bmSwitchPortEntry, portSecurityMacAddr2=portSecurityMacAddr2, portSecurityMacAddr1=portSecurityMacAddr1, adminLedGlobalMode=adminLedGlobalMode, portSecurityForwardingState=portSecurityForwardingState, bmTraps=bmTraps, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, switchInternalVoltageFailure=switchInternalVoltageFailure, infoNoOfPorts=infoNoOfPorts, portErrorCounter=portErrorCounter, portPoeCurrent=portPoeCurrent, bmSwitchVlan=bmSwitchVlan, infoTemperature=infoTemperature, portPrioDot1p=portPrioDot1p, bmSwitchMIB=bmSwitchMIB, portTrunkingMode=portTrunkingMode, tftpMessage=tftpMessage, infoLastTftpMessage=infoLastTftpMessage, sfpInfoLength62um=sfpInfoLength62um, portLinkType=portLinkType, adminAgentPhysAddress=adminAgentPhysAddress, infoManufactureDate=infoManufactureDate, adminReset=adminReset, infoPowerVoltage3300=infoPowerVoltage3300, portSecurityAdminState=portSecurityAdminState, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, bmSwitchInfo=bmSwitchInfo, bmSwitchSfpEntry=bmSwitchSfpEntry, infoAlarmStateM1=infoAlarmStateM1, portLoopBcastFailure=portLoopBcastFailure, switchConfigurationChanged=switchConfigurationChanged, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpState=sfpState, infoFunctionInputStateF1=infoFunctionInputStateF1, adminAlarmM1=adminAlarmM1, adminMgmtAccessList=adminMgmtAccessList, portPoeVoltage=portPoeVoltage, vlanId=vlanId, adminAlarmNameM2=adminAlarmNameM2, bmSwitchPortTable=bmSwitchPortTable, portLimiterPacketType=portLimiterPacketType, portLinkChange=portLinkChange, portDefaultPrioQueue=portDefaultPrioQueue, portPoePower=portPoePower, portErrorDisabled=portErrorDisabled, infoSerie=infoSerie, sfpDiagTxOutputPower=sfpDiagTxOutputPower, switchPoeVoltageFailure=switchPoeVoltageFailure, radiusMgmtAuthReject=radiusMgmtAuthReject, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpDiagTemperature=sfpDiagTemperature, infoTotalConfigChanges=infoTotalConfigChanges, infoDescr=infoDescr, adminAgentNetmask=adminAgentNetmask, portPoeAdminState=portPoeAdminState, infoPoeInputPower=infoPoeInputPower, switchTemperatureFailure=switchTemperatureFailure, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoPowerVoltage2500=infoPowerVoltage2500, vlanIndex=vlanIndex, internalMgmtWarning=internalMgmtWarning, portNewMacAddress=portNewMacAddress, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portDescr=portDescr, bmSwitchSfpTable=bmSwitchSfpTable, sfpInfoBitRate=sfpInfoBitRate, adminSwitchPortMirror=adminSwitchPortMirror, PYSNMP_MODULE_ID=bmSwitchMIB, sfpPortIndex=sfpPortIndex, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminSnmpMacTableMode=adminSnmpMacTableMode, portLEDYellow=portLEDYellow, radiusPortSecurityReject=radiusPortSecurityReject, portSpeedDuplexSetup=portSpeedDuplexSetup, switchFunctionInputAlarm=switchFunctionInputAlarm, bmSwitchAdmin=bmSwitchAdmin, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, sfpInfoLength9um=sfpInfoLength9um, portBandwidthLimitRxd=portBandwidthLimitRxd, sfpInfoLength50um=sfpInfoLength50um, sfpInfoDateCode=sfpInfoDateCode, adminUnsecureVlanId=adminUnsecureVlanId, bmSwitchSfp=bmSwitchSfp, adminAgentPrioValue=adminAgentPrioValue, switchMgmtAuthFailure=switchMgmtAuthFailure, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminFunctionInputNameF1=adminFunctionInputNameF1, portBandwidthLimitTxd=portBandwidthLimitTxd, portAcApSetup=portAcApSetup, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portErrorCountFailure=portErrorCountFailure, clientRemoved=clientRemoved, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminAlarmNameM1=adminAlarmNameM1, infoUnauthIpAddr=infoUnauthIpAddr, portLEDGreen=portLEDGreen, portPoeOverloadFailure=portPoeOverloadFailure, portPrioIp=portPrioIp, portSecurityMacAddr3=portSecurityMacAddr3, sfpInfoVendorName=sfpInfoVendorName, sfpInfoConnectorDescr=sfpInfoConnectorDescr, sfpEvent=sfpEvent, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portLinkState=portLinkState, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpInfoWavelength=sfpInfoWavelength, adminMemoryCardMode=adminMemoryCardMode, bmSwitchPort=bmSwitchPort)
