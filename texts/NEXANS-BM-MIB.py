...
mibBuilder.exportSymbols("NEXANS-BM-MIB", sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoUnauthIpAddr=infoUnauthIpAddr, clientRemoved=clientRemoved, sfpEvent=sfpEvent, switchFunctionInputAlarm=switchFunctionInputAlarm, bmSwitchVlanTable=bmSwitchVlanTable, adminAlarmM1=adminAlarmM1, portDefaultPrioQueue=portDefaultPrioQueue, adminAlarmM2=adminAlarmM2, infoPowerVoltage3300=infoPowerVoltage3300, portSecurityMacAddr2=portSecurityMacAddr2, portLEDYellow=portLEDYellow, portPoeCurrent=portPoeCurrent, portDefaultVlanId=portDefaultVlanId, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminLedGlobalMode=adminLedGlobalMode, switchMgmtAuthFailure=switchMgmtAuthFailure, portSecurityFailure=portSecurityFailure, portPrioIp=portPrioIp, vlanDescr=vlanDescr, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminMemoryCardMode=adminMemoryCardMode, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminMgmtAccessList=adminMgmtAccessList, portBandwidthLimitTxd=portBandwidthLimitTxd, portLoopBcastFailure=portLoopBcastFailure, portSecurityMacAddr1=portSecurityMacAddr1, portVoiceVlanId=portVoiceVlanId, bmSwitchMIB=bmSwitchMIB, infoDescr=infoDescr, bmTraps=bmTraps, sfpInfoBitRate=sfpInfoBitRate, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpInfoConnectorDescr=sfpInfoConnectorDescr, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoNoOfPorts=infoNoOfPorts, infoManufactureDate=infoManufactureDate, portErrorDisabled=portErrorDisabled, portName=portName, tftpMessage=tftpMessage, portAdminState=portAdminState, infoAlarmStateM1=infoAlarmStateM1, adminAgentVlanId=adminAgentVlanId, adminAgentPrioValue=adminAgentPrioValue, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpInfoLength50um=sfpInfoLength50um, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, infoLastTftpMessage=infoLastTftpMessage, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, bmSwitchSfpEntry=bmSwitchSfpEntry, portErrorCounter=portErrorCounter, bmSwitchSfpTable=bmSwitchSfpTable, infoProductNo=infoProductNo, portPrioDot1p=portPrioDot1p, portRemoteFault=portRemoteFault, sfpInfoDateCode=sfpInfoDateCode, vlanIndex=vlanIndex, infoFunctionInputStateF1=infoFunctionInputStateF1, adminAgentPhysAddress=adminAgentPhysAddress, bmSwitchPortEntry=bmSwitchPortEntry, switchConfigurationChanged=switchConfigurationChanged, bmSwitchInfo=bmSwitchInfo, portPoeAdminState=portPoeAdminState, portIndex=portIndex, infoPoeInputVoltage=infoPoeInputVoltage, portLinkChange=portLinkChange, adminAgentIpAddress=adminAgentIpAddress, bmSwitchAdmin=bmSwitchAdmin, portBandwidthLimitRxd=portBandwidthLimitRxd, infoSerie=infoSerie, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portNewMacAddress=portNewMacAddress, portErrorCountFailure=portErrorCountFailure, portLimiterPacketType=portLimiterPacketType, infoLastSfpEventMessage=infoLastSfpEventMessage, adminSnmpMacTableMode=adminSnmpMacTableMode, portPoePower=portPoePower, switchPoeVoltageFailure=switchPoeVoltageFailure, sfpInfoLength62um=sfpInfoLength62um, sfpInfoVendorName=sfpInfoVendorName, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, switchTemperatureFailure=switchTemperatureFailure, infoType=infoType, portSecurityForwardingState=portSecurityForwardingState, radiusMgmtAuthReject=radiusMgmtAuthReject, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portPoeVoltage=portPoeVoltage, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpDiagTxOutputPower=sfpDiagTxOutputPower, switchIndustrialAlarmM1=switchIndustrialAlarmM1, switchPoeOverloadFailure=switchPoeOverloadFailure, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpInfoPartNumber=sfpInfoPartNumber, PYSNMP_MODULE_ID=bmSwitchMIB, infoNewMacAddr=infoNewMacAddr, bmSwitchVlan=bmSwitchVlan, portTrunkingMode=portTrunkingMode, adminSwitchPortMirror=adminSwitchPortMirror, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, internalMgmtWarning=internalMgmtWarning, sfpInfoSerialNumber=sfpInfoSerialNumber, infoNoOfReboots=infoNoOfReboots, adminUnsecureVlanId=adminUnsecureVlanId, bmSwitchPortTable=bmSwitchPortTable, sfpDiagTemperature=sfpDiagTemperature, adminAlarmNameM1=adminAlarmNameM1, portSpeedDuplexSetup=portSpeedDuplexSetup, adminFunctionInputNameF1=adminFunctionInputNameF1, portLinkState=portLinkState, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminAlarmNameM2=adminAlarmNameM2, adminSwitchVlanTableMode=adminSwitchVlanTableMode, sfpPortIndex=sfpPortIndex, infoPowerVoltage2500=infoPowerVoltage2500, portPoePowerLimit=portPoePowerLimit, infoPoeInputPower=infoPoeInputPower, adminAgentDhcp=adminAgentDhcp, bmSwitchSfp=bmSwitchSfp, radiusPortSecurityReject=radiusPortSecurityReject, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpInfoWavelength=sfpInfoWavelength, portAcApSetup=portAcApSetup, portPoeOverloadFailure=portPoeOverloadFailure, infoAlarmStateM2=infoAlarmStateM2, infoSeriesNo=infoSeriesNo, infoTotalConfigChanges=infoTotalConfigChanges, switchInternalVoltageFailure=switchInternalVoltageFailure, sfpState=sfpState, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, vlanId=vlanId, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portDescr=portDescr, portSecurityAdminState=portSecurityAdminState, sfpInfoLength9um=sfpInfoLength9um, bmSwitchPort=bmSwitchPort, adminTftpAccess=adminTftpAccess, infoTemperature=infoTemperature, portLEDGreen=portLEDGreen, portSecurityMacAddr3=portSecurityMacAddr3, adminReset=adminReset, portLinkType=portLinkType, adminAgentNetmask=adminAgentNetmask)
