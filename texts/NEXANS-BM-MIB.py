...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portName=portName, switchFunctionInputAlarm=switchFunctionInputAlarm, infoNewMacAddr=infoNewMacAddr, bmSwitchPort=bmSwitchPort, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminReset=adminReset, infoUnauthIpAddr=infoUnauthIpAddr, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portAdminState=portAdminState, vlanId=vlanId, portSpeedDuplexSetup=portSpeedDuplexSetup, portSecurityFailure=portSecurityFailure, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoNoOfPorts=infoNoOfPorts, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoPowerVoltage2500=infoPowerVoltage2500, adminAgentDhcp=adminAgentDhcp, sfpState=sfpState, switchMgmtAuthFailure=switchMgmtAuthFailure, bmSwitchPortEntry=bmSwitchPortEntry, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, sfpInfoLength62um=sfpInfoLength62um, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoLastTftpMessage=infoLastTftpMessage, adminAgentIpAddress=adminAgentIpAddress, portAcApSetup=portAcApSetup, bmSwitchPortTable=bmSwitchPortTable, bmSwitchSfp=bmSwitchSfp, infoSeriesNo=infoSeriesNo, adminAlarmNameM2=adminAlarmNameM2, sfpInfoSerialNumber=sfpInfoSerialNumber, infoProductNo=infoProductNo, portDescr=portDescr, switchInternalVoltageFailure=switchInternalVoltageFailure, portPrioDot1p=portPrioDot1p, infoSerie=infoSerie, infoTotalConfigChanges=infoTotalConfigChanges, portSecurityMacAddr2=portSecurityMacAddr2, portLEDGreen=portLEDGreen, adminSwitchPortMirror=adminSwitchPortMirror, sfpInfoVendorName=sfpInfoVendorName, adminAlarmM1=adminAlarmM1, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portPoeAdminState=portPoeAdminState, sfpInfoLength9um=sfpInfoLength9um, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminAgentPhysAddress=adminAgentPhysAddress, portLinkState=portLinkState, switchPoeVoltageFailure=switchPoeVoltageFailure, portErrorDisabled=portErrorDisabled, portSecurityMacAddr1=portSecurityMacAddr1, bmSwitchAdmin=bmSwitchAdmin, portErrorCountFailure=portErrorCountFailure, sfpDiagTxOutputPower=sfpDiagTxOutputPower, infoAlarmStateM2=infoAlarmStateM2, portSecurityMacAddr3=portSecurityMacAddr3, portPoePower=portPoePower, sfpInfoBitRate=sfpInfoBitRate, switchTemperatureFailure=switchTemperatureFailure, portIndex=portIndex, portBandwidthLimitRxd=portBandwidthLimitRxd, switchPoeOverloadFailure=switchPoeOverloadFailure, portLoopBcastFailure=portLoopBcastFailure, portPoeVoltage=portPoeVoltage, portPrioIp=portPrioIp, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, sfpPortIndex=sfpPortIndex, portDefaultPrioQueue=portDefaultPrioQueue, infoAlarmStateM1=infoAlarmStateM1, PYSNMP_MODULE_ID=bmSwitchMIB, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portSecurityForwardingState=portSecurityForwardingState, adminTftpAccess=adminTftpAccess, adminAlarmM2=adminAlarmM2, infoPowerVoltage3300=infoPowerVoltage3300, sfpEvent=sfpEvent, adminUnsecureVlanId=adminUnsecureVlanId, portLinkChange=portLinkChange, adminAgentVlanId=adminAgentVlanId, portDefaultVlanId=portDefaultVlanId, sfpInfoLength50um=sfpInfoLength50um, infoPoeInputPower=infoPoeInputPower, portTrunkingMode=portTrunkingMode, radiusMgmtAuthReject=radiusMgmtAuthReject, bmSwitchVlan=bmSwitchVlan, portPoeOverloadFailure=portPoeOverloadFailure, portPoePowerLimit=portPoePowerLimit, portErrorCounter=portErrorCounter, portBandwidthLimitTxd=portBandwidthLimitTxd, tftpMessage=tftpMessage, clientRemoved=clientRemoved, infoTemperature=infoTemperature, adminAlarmNameM1=adminAlarmNameM1, vlanDescr=vlanDescr, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portLimiterPacketType=portLimiterPacketType, bmTraps=bmTraps, adminFunctionInputNameF1=adminFunctionInputNameF1, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoLastSfpEventMessage=infoLastSfpEventMessage, switchIndustrialAlarmM1=switchIndustrialAlarmM1, switchConfigurationChanged=switchConfigurationChanged, portLEDYellow=portLEDYellow, bmSwitchVlanTable=bmSwitchVlanTable, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminAgentNetmask=adminAgentNetmask, bmSwitchInfo=bmSwitchInfo, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoFunctionInputStateF1=infoFunctionInputStateF1, infoType=infoType, portLinkType=portLinkType, portSecurityAdminState=portSecurityAdminState, sfpInfoDateCode=sfpInfoDateCode, portVoiceVlanId=portVoiceVlanId, portNewMacAddress=portNewMacAddress, sfpInfoWavelength=sfpInfoWavelength, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoDescr=infoDescr, infoNoOfReboots=infoNoOfReboots, bmSwitchMIB=bmSwitchMIB, infoPoeInputVoltage=infoPoeInputVoltage, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpDiagTemperature=sfpDiagTemperature, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, switchIndustrialAlarmM2=switchIndustrialAlarmM2, radiusPortSecurityReject=radiusPortSecurityReject, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminAgentPrioValue=adminAgentPrioValue, sfpInfoPartNumber=sfpInfoPartNumber, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, internalMgmtWarning=internalMgmtWarning, adminMemoryCardMode=adminMemoryCardMode, portRemoteFault=portRemoteFault, adminMgmtAccessList=adminMgmtAccessList, adminLedGlobalMode=adminLedGlobalMode, bmSwitchSfpTable=bmSwitchSfpTable, infoSecurityFailMacAddr=infoSecurityFailMacAddr, infoManufactureDate=infoManufactureDate, adminSnmpMacTableMode=adminSnmpMacTableMode, portPoeCurrent=portPoeCurrent, bmSwitchSfpEntry=bmSwitchSfpEntry, adminSwitchVlanTableMode=adminSwitchVlanTableMode, vlanIndex=vlanIndex, sfpDiagRxIntputPower=sfpDiagRxIntputPower)
