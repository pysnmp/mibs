...
mibBuilder.exportSymbols("NEXANS-BM-MIB", bmSwitchVlanTable=bmSwitchVlanTable, portLEDYellow=portLEDYellow, portPoeVoltage=portPoeVoltage, infoSeriesNo=infoSeriesNo, infoNoOfReboots=infoNoOfReboots, sfpInfoVendorName=sfpInfoVendorName, infoAlarmStateM1=infoAlarmStateM1, sfpInfoBitRate=sfpInfoBitRate, internalMgmtWarning=internalMgmtWarning, portAdminState=portAdminState, infoPoeInputVoltage=infoPoeInputVoltage, switchPoeOverloadFailure=switchPoeOverloadFailure, radiusMgmtAuthReject=radiusMgmtAuthReject, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portSecurityAdminState=portSecurityAdminState, portAcApSetup=portAcApSetup, portSecurityFailure=portSecurityFailure, bmSwitchInfo=bmSwitchInfo, infoNewMacAddr=infoNewMacAddr, portIndex=portIndex, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpInfoRevisionNumber=sfpInfoRevisionNumber, adminFunctionInputNameF1=adminFunctionInputNameF1, portSpeedDuplexSetup=portSpeedDuplexSetup, portSecurityMacAddr2=portSecurityMacAddr2, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portPoeAdminState=portPoeAdminState, adminAgentDhcp=adminAgentDhcp, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, adminSnmpMacTableMode=adminSnmpMacTableMode, portLEDGreen=portLEDGreen, vlanIndex=vlanIndex, sfpInfoDateCode=sfpInfoDateCode, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portErrorCounter=portErrorCounter, portBandwidthLimitRxd=portBandwidthLimitRxd, portLimiterPacketType=portLimiterPacketType, bmSwitchPort=bmSwitchPort, adminAgentPrioValue=adminAgentPrioValue, portPrioIp=portPrioIp, bmSwitchVlan=bmSwitchVlan, adminMemoryCardMode=adminMemoryCardMode, bmSwitchPortTable=bmSwitchPortTable, portLinkChange=portLinkChange, adminAgentVlanId=adminAgentVlanId, portErrorCountFailure=portErrorCountFailure, portPrioDot1p=portPrioDot1p, switchFunctionInputAlarm=switchFunctionInputAlarm, infoManufactureDate=infoManufactureDate, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portSecurityForwardingState=portSecurityForwardingState, portTrunkingMode=portTrunkingMode, bmSwitchSfpEntry=bmSwitchSfpEntry, portDefaultPrioQueue=portDefaultPrioQueue, sfpInfoPartNumber=sfpInfoPartNumber, portLinkState=portLinkState, sfpEvent=sfpEvent, bmSwitchSfpTable=bmSwitchSfpTable, switchMgmtAuthFailure=switchMgmtAuthFailure, adminSwitchPortMirror=adminSwitchPortMirror, bmSwitchAdmin=bmSwitchAdmin, portLoopBcastFailure=portLoopBcastFailure, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoLastTftpMessage=infoLastTftpMessage, infoType=infoType, infoFunctionInputStateF1=infoFunctionInputStateF1, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portErrorDisabled=portErrorDisabled, switchPoeVoltageFailure=switchPoeVoltageFailure, portSecurityMacAddr3=portSecurityMacAddr3, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portPoePower=portPoePower, portPoePowerLimit=portPoePowerLimit, vlanDescr=vlanDescr, sfpInfoSerialNumber=sfpInfoSerialNumber, adminReset=adminReset, infoPoeInputPower=infoPoeInputPower, tftpMessage=tftpMessage, sfpState=sfpState, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminMgmtAccessList=adminMgmtAccessList, adminAlarmNameM1=adminAlarmNameM1, bmSwitchMIB=bmSwitchMIB, sfpInfoLength9um=sfpInfoLength9um, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminAgentPhysAddress=adminAgentPhysAddress, vlanId=vlanId, sfpInfoLength50um=sfpInfoLength50um, portDescr=portDescr, infoPowerVoltage2500=infoPowerVoltage2500, infoPowerVoltage3300=infoPowerVoltage3300, portPoeOverloadFailure=portPoeOverloadFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portDefaultVlanId=portDefaultVlanId, portLinkType=portLinkType, clientRemoved=clientRemoved, portPoeCurrent=portPoeCurrent, sfpDiagTxOutputPower=sfpDiagTxOutputPower, infoSerie=infoSerie, adminAgentNetmask=adminAgentNetmask, portVoiceVlanId=portVoiceVlanId, infoNoOfPorts=infoNoOfPorts, infoProductNo=infoProductNo, adminUnsecureVlanId=adminUnsecureVlanId, adminAlarmNameM2=adminAlarmNameM2, sfpDiagTemperature=sfpDiagTemperature, bmSwitchSfp=bmSwitchSfp, infoLastSfpEventMessage=infoLastSfpEventMessage, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, infoDescr=infoDescr, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminTftpAccess=adminTftpAccess, infoUnauthIpAddr=infoUnauthIpAddr, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, switchConfigurationChanged=switchConfigurationChanged, PYSNMP_MODULE_ID=bmSwitchMIB, portName=portName, adminLedGlobalMode=adminLedGlobalMode, portBandwidthLimitTxd=portBandwidthLimitTxd, portNewMacAddress=portNewMacAddress, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portSecurityMacAddr1=portSecurityMacAddr1, portRemoteFault=portRemoteFault, switchInternalVoltageFailure=switchInternalVoltageFailure, switchTemperatureFailure=switchTemperatureFailure, bmTraps=bmTraps, bmSwitchPortEntry=bmSwitchPortEntry, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminAgentIpAddress=adminAgentIpAddress, sfpInfoWavelength=sfpInfoWavelength, sfpPortIndex=sfpPortIndex, infoTemperature=infoTemperature, adminAlarmM2=adminAlarmM2, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoAlarmStateM2=infoAlarmStateM2, radiusPortSecurityReject=radiusPortSecurityReject, bmSwitchVlanEntry=bmSwitchVlanEntry, infoTotalConfigChanges=infoTotalConfigChanges, sfpInfoLength62um=sfpInfoLength62um, adminAlarmM1=adminAlarmM1)
