...
mibBuilder.exportSymbols("NEXANS-BM-MIB", bmSwitchSfpEntry=bmSwitchSfpEntry, bmSwitchSfp=bmSwitchSfp, portLEDGreen=portLEDGreen, portSecurityForwardingState=portSecurityForwardingState, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, switchMgmtAuthFailure=switchMgmtAuthFailure, portLinkState=portLinkState, bmSwitchPort=bmSwitchPort, PYSNMP_MODULE_ID=bmSwitchMIB, portLinkType=portLinkType, sfpPortIndex=sfpPortIndex, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portVoiceVlanId=portVoiceVlanId, portDescr=portDescr, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoLastTftpMessage=infoLastTftpMessage, infoDescr=infoDescr, adminAgentVlanId=adminAgentVlanId, sfpInfoDateCode=sfpInfoDateCode, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, adminTftpAccess=adminTftpAccess, portSecurityFailure=portSecurityFailure, adminMemoryCardMode=adminMemoryCardMode, radiusPortSecurityReject=radiusPortSecurityReject, portSecurityMacAddr2=portSecurityMacAddr2, infoNoOfPorts=infoNoOfPorts, portAcApSetup=portAcApSetup, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminAgentPrioValue=adminAgentPrioValue, bmSwitchInfo=bmSwitchInfo, switchPoeOverloadFailure=switchPoeOverloadFailure, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portDefaultVlanId=portDefaultVlanId, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminMgmtAccessList=adminMgmtAccessList, portNewMacAddress=portNewMacAddress, bmSwitchVlanTable=bmSwitchVlanTable, infoFunctionInputStateF1=infoFunctionInputStateF1, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoPowerVoltage3300=infoPowerVoltage3300, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, sfpInfoLength9um=sfpInfoLength9um, portSecurityAdminState=portSecurityAdminState, infoType=infoType, sfpInfoLength62um=sfpInfoLength62um, infoPoeInputPower=infoPoeInputPower, adminAgentIpAddress=adminAgentIpAddress, sfpInfoVendorName=sfpInfoVendorName, sfpDiagTemperature=sfpDiagTemperature, portErrorCounter=portErrorCounter, vlanId=vlanId, adminLedGlobalMode=adminLedGlobalMode, sfpInfoSerialNumber=sfpInfoSerialNumber, adminAgentPhysAddress=adminAgentPhysAddress, infoTemperature=infoTemperature, portErrorDisabled=portErrorDisabled, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portPrioIp=portPrioIp, portPoeVoltage=portPoeVoltage, portName=portName, infoProductNo=infoProductNo, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, internalMgmtWarning=internalMgmtWarning, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminAlarmNameM2=adminAlarmNameM2, adminReset=adminReset, infoAlarmStateM2=infoAlarmStateM2, adminUnsecureVlanId=adminUnsecureVlanId, portPoeCurrent=portPoeCurrent, portLinkChange=portLinkChange, infoUnauthIpAddr=infoUnauthIpAddr, portDefaultPrioQueue=portDefaultPrioQueue, infoPowerVoltage2500=infoPowerVoltage2500, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portPoePowerLimit=portPoePowerLimit, sfpDiagTxOutputPower=sfpDiagTxOutputPower, vlanIndex=vlanIndex, sfpInfoPartNumber=sfpInfoPartNumber, adminAgentDhcp=adminAgentDhcp, switchTemperatureFailure=switchTemperatureFailure, vlanDescr=vlanDescr, sfpEvent=sfpEvent, infoManufactureDate=infoManufactureDate, bmTraps=bmTraps, portRemoteFault=portRemoteFault, portPoeOverloadFailure=portPoeOverloadFailure, sfpInfoLength50um=sfpInfoLength50um, portBandwidthLimitRxd=portBandwidthLimitRxd, portIndex=portIndex, portPoeAdminState=portPoeAdminState, infoSeriesNo=infoSeriesNo, sfpInfoBitRate=sfpInfoBitRate, portErrorCountFailure=portErrorCountFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portLEDYellow=portLEDYellow, adminFunctionInputNameF1=adminFunctionInputNameF1, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminAlarmNameM1=adminAlarmNameM1, portLimiterPacketType=portLimiterPacketType, switchConfigurationChanged=switchConfigurationChanged, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminAgentNetmask=adminAgentNetmask, bmSwitchPortEntry=bmSwitchPortEntry, portPrioDot1p=portPrioDot1p, bmSwitchSfpTable=bmSwitchSfpTable, switchFunctionInputAlarm=switchFunctionInputAlarm, bmSwitchMIB=bmSwitchMIB, portSecurityMacAddr3=portSecurityMacAddr3, bmSwitchPortTable=bmSwitchPortTable, infoLastSfpEventMessage=infoLastSfpEventMessage, radiusMgmtAuthReject=radiusMgmtAuthReject, switchInternalVoltageFailure=switchInternalVoltageFailure, portLoopBcastFailure=portLoopBcastFailure, adminSwitchPortMirror=adminSwitchPortMirror, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoNoOfReboots=infoNoOfReboots, portSpeedDuplexSetup=portSpeedDuplexSetup, portTrunkingMode=portTrunkingMode, infoPoeInputVoltage=infoPoeInputVoltage, portAdminState=portAdminState, sfpState=sfpState, infoSerie=infoSerie, portSecurityMacAddr1=portSecurityMacAddr1, clientRemoved=clientRemoved, adminAlarmM2=adminAlarmM2, portBandwidthLimitTxd=portBandwidthLimitTxd, switchIndustrialAlarmM2=switchIndustrialAlarmM2, switchPoeVoltageFailure=switchPoeVoltageFailure, bmSwitchVlan=bmSwitchVlan, sfpInfoRevisionNumber=sfpInfoRevisionNumber, tftpMessage=tftpMessage, bmSwitchAdmin=bmSwitchAdmin, adminSnmpMacTableMode=adminSnmpMacTableMode, adminAlarmM1=adminAlarmM1, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoNewMacAddr=infoNewMacAddr, sfpInfoWavelength=sfpInfoWavelength, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoAlarmStateM1=infoAlarmStateM1, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portPoePower=portPoePower, infoTotalConfigChanges=infoTotalConfigChanges)
