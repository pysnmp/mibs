...
ModuleIdentity, Gauge32, Bits, Unsigned32, Counter64, Integer32, Counter32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Bits", "Unsigned32", "Counter64", "Integer32", "Counter32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", bmSwitchSfp=bmSwitchSfp, portErrorDisabled=portErrorDisabled, PYSNMP_MODULE_ID=bmSwitchMIB, adminUnsecureVlanId=adminUnsecureVlanId, sfpInfoPartNumber=sfpInfoPartNumber, sfpInfoDateCode=sfpInfoDateCode, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portLoopBcastFailure=portLoopBcastFailure, portAcApSetup=portAcApSetup, infoPowerVoltage3300=infoPowerVoltage3300, sfpPortIndex=sfpPortIndex, infoSeriesNo=infoSeriesNo, adminLedGlobalMode=adminLedGlobalMode, portRemoteFault=portRemoteFault, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpInfoLength62um=sfpInfoLength62um, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminAgentIpAddress=adminAgentIpAddress, portPoePowerLimit=portPoePowerLimit, infoNoOfPorts=infoNoOfPorts, portLinkChange=portLinkChange, sfpInfoBitRate=sfpInfoBitRate, portSecurityMacAddr2=portSecurityMacAddr2, infoNewMacAddr=infoNewMacAddr, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, switchConfigurationChanged=switchConfigurationChanged, adminAgentNetmask=adminAgentNetmask, portTrunkingMode=portTrunkingMode, portDescr=portDescr, radiusPortSecurityReject=radiusPortSecurityReject, vlanIndex=vlanIndex, infoPowerVoltage2500=infoPowerVoltage2500, infoSerie=infoSerie, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, sfpInfoLength9um=sfpInfoLength9um, bmSwitchPortTable=bmSwitchPortTable, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portLEDYellow=portLEDYellow, portNewMacAddress=portNewMacAddress, adminReset=adminReset, infoUnauthIpAddr=infoUnauthIpAddr, bmSwitchVlan=bmSwitchVlan, portSecurityMacAddr1=portSecurityMacAddr1, switchPoeOverloadFailure=switchPoeOverloadFailure, infoTotalConfigChanges=infoTotalConfigChanges, portName=portName, portDefaultVlanId=portDefaultVlanId, bmTraps=bmTraps, portSpeedDuplexSetup=portSpeedDuplexSetup, portPrioIp=portPrioIp, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoDescr=infoDescr, bmSwitchPortEntry=bmSwitchPortEntry, bmSwitchMIB=bmSwitchMIB, infoLastTftpMessage=infoLastTftpMessage, infoAlarmStateM2=infoAlarmStateM2, adminAlarmM2=adminAlarmM2, portLinkState=portLinkState, bmSwitchSfpEntry=bmSwitchSfpEntry, adminAgentPhysAddress=adminAgentPhysAddress, infoAlarmStateM1=infoAlarmStateM1, portErrorCountFailure=portErrorCountFailure, adminMgmtAccessList=adminMgmtAccessList, infoTemperature=infoTemperature, portSecurityForwardingState=portSecurityForwardingState, infoPoeInputPower=infoPoeInputPower, bmSwitchVlanTable=bmSwitchVlanTable, portIndex=portIndex, adminSwitchVlanTableMode=adminSwitchVlanTableMode, bmSwitchAdmin=bmSwitchAdmin, infoFunctionInputStateF1=infoFunctionInputStateF1, portSecurityFailure=portSecurityFailure, sfpInfoWavelength=sfpInfoWavelength, bmSwitchPort=bmSwitchPort, switchInternalVoltageFailure=switchInternalVoltageFailure, portPoeVoltage=portPoeVoltage, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, sfpInfoLength50um=sfpInfoLength50um, sfpInfoVendorName=sfpInfoVendorName, portPoeOverloadFailure=portPoeOverloadFailure, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portAdminState=portAdminState, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portBandwidthLimitRxd=portBandwidthLimitRxd, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminAgentDhcp=adminAgentDhcp, adminAlarmM1=adminAlarmM1, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminFunctionInputNameF1=adminFunctionInputNameF1, adminSwitchPortMirror=adminSwitchPortMirror, adminAlarmNameM2=adminAlarmNameM2, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portSecurityMacAddr3=portSecurityMacAddr3, switchMgmtAuthFailure=switchMgmtAuthFailure, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoNoOfReboots=infoNoOfReboots, infoLastSfpEventMessage=infoLastSfpEventMessage, bmSwitchInfo=bmSwitchInfo, sfpInfoSerialNumber=sfpInfoSerialNumber, infoPoeInputVoltage=infoPoeInputVoltage, radiusMgmtAuthReject=radiusMgmtAuthReject, portPoeAdminState=portPoeAdminState, switchPoeVoltageFailure=switchPoeVoltageFailure, portPoeCurrent=portPoeCurrent, adminMemoryCardMode=adminMemoryCardMode, sfpEvent=sfpEvent, adminAlarmNameM1=adminAlarmNameM1, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpState=sfpState, portDefaultPrioQueue=portDefaultPrioQueue, adminAgentPrioValue=adminAgentPrioValue, infoType=infoType, portPoePower=portPoePower, portLinkType=portLinkType, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, internalMgmtWarning=internalMgmtWarning, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, vlanId=vlanId, portPrioDot1p=portPrioDot1p, bmSwitchVlanEntry=bmSwitchVlanEntry, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, clientRemoved=clientRemoved, portLEDGreen=portLEDGreen, switchTemperatureFailure=switchTemperatureFailure, portBandwidthLimitTxd=portBandwidthLimitTxd, infoProductNo=infoProductNo, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminSnmpMacTableMode=adminSnmpMacTableMode, adminAgentVlanId=adminAgentVlanId, vlanDescr=vlanDescr, portSecurityAdminState=portSecurityAdminState, portErrorCounter=portErrorCounter, sfpInfoRevisionNumber=sfpInfoRevisionNumber, switchFunctionInputAlarm=switchFunctionInputAlarm, infoManufactureDate=infoManufactureDate, portVoiceVlanId=portVoiceVlanId, tftpMessage=tftpMessage, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portLimiterPacketType=portLimiterPacketType, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, bmSwitchSfpTable=bmSwitchSfpTable, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, sfpDiagTemperature=sfpDiagTemperature, adminTftpAccess=adminTftpAccess)
