...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portLoopBcastFailure=portLoopBcastFailure, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpInfoLength50um=sfpInfoLength50um, adminAgentIpAddress=adminAgentIpAddress, infoLastSfpEventMessage=infoLastSfpEventMessage, infoTotalConfigChanges=infoTotalConfigChanges, portSecurityMacAddr2=portSecurityMacAddr2, vlanId=vlanId, adminTftpAccess=adminTftpAccess, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, radiusPortSecurityReject=radiusPortSecurityReject, bmSwitchPort=bmSwitchPort, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoPoeInputPower=infoPoeInputPower, infoAlarmStateM1=infoAlarmStateM1, portSecurityMacAddr1=portSecurityMacAddr1, portPrioIp=portPrioIp, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoManufactureDate=infoManufactureDate, sfpInfoBitRate=sfpInfoBitRate, adminFunctionInputNameF1=adminFunctionInputNameF1, portBandwidthLimitTxd=portBandwidthLimitTxd, adminAlarmM1=adminAlarmM1, sfpPortIndex=sfpPortIndex, switchTemperatureFailure=switchTemperatureFailure, internalMgmtWarning=internalMgmtWarning, sfpInfoVendorName=sfpInfoVendorName, portLinkType=portLinkType, bmSwitchSfpTable=bmSwitchSfpTable, bmSwitchPortTable=bmSwitchPortTable, portErrorDisabled=portErrorDisabled, infoNewMacAddr=infoNewMacAddr, portAdminState=portAdminState, adminAgentPrioValue=adminAgentPrioValue, infoLastTftpMessage=infoLastTftpMessage, switchInternalVoltageFailure=switchInternalVoltageFailure, bmSwitchSfpEntry=bmSwitchSfpEntry, portLEDYellow=portLEDYellow, adminAgentDhcp=adminAgentDhcp, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminUnsecureVlanId=adminUnsecureVlanId, portErrorCounter=portErrorCounter, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, sfpDiagTemperature=sfpDiagTemperature, portPoePower=portPoePower, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminAlarmM2=adminAlarmM2, infoSerie=infoSerie, adminReset=adminReset, portLinkState=portLinkState, infoPowerVoltage3300=infoPowerVoltage3300, infoType=infoType, portSecurityMacAddr3=portSecurityMacAddr3, clientRemoved=clientRemoved, bmSwitchSfp=bmSwitchSfp, adminSwitchPortMirror=adminSwitchPortMirror, adminAgentPhysAddress=adminAgentPhysAddress, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, bmSwitchAdmin=bmSwitchAdmin, infoPoeInputVoltage=infoPoeInputVoltage, portDescr=portDescr, portRemoteFault=portRemoteFault, portPoeVoltage=portPoeVoltage, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portLinkChange=portLinkChange, infoNoOfReboots=infoNoOfReboots, infoUnauthIpAddr=infoUnauthIpAddr, bmSwitchPortEntry=bmSwitchPortEntry, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portSpeedDuplexSetup=portSpeedDuplexSetup, adminMemoryCardMode=adminMemoryCardMode, portSecurityFailure=portSecurityFailure, sfpInfoPartNumber=sfpInfoPartNumber, portTrunkingMode=portTrunkingMode, switchPoeVoltageFailure=switchPoeVoltageFailure, infoNoOfPorts=infoNoOfPorts, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoSwitchHardwareVersion=infoSwitchHardwareVersion, vlanDescr=vlanDescr, radiusMgmtAuthReject=radiusMgmtAuthReject, bmSwitchVlanEntry=bmSwitchVlanEntry, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpInfoLength62um=sfpInfoLength62um, portLimiterPacketType=portLimiterPacketType, portIndex=portIndex, portSecurityAdminState=portSecurityAdminState, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, sfpInfoDateCode=sfpInfoDateCode, bmSwitchVlanTable=bmSwitchVlanTable, infoPowerVoltage2500=infoPowerVoltage2500, switchMgmtAuthFailure=switchMgmtAuthFailure, portSecurityForwardingState=portSecurityForwardingState, portPoeCurrent=portPoeCurrent, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, infoSeriesNo=infoSeriesNo, adminSnmpMacTableMode=adminSnmpMacTableMode, switchPoeOverloadFailure=switchPoeOverloadFailure, infoProductNo=infoProductNo, adminAgentNetmask=adminAgentNetmask, portErrorCountFailure=portErrorCountFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, bmSwitchMIB=bmSwitchMIB, sfpInfoLength9um=sfpInfoLength9um, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpInfoWavelength=sfpInfoWavelength, sfpDiagTxOutputPower=sfpDiagTxOutputPower, bmTraps=bmTraps, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, infoDescr=infoDescr, switchConfigurationChanged=switchConfigurationChanged, adminLedGlobalMode=adminLedGlobalMode, portVoiceVlanId=portVoiceVlanId, bmSwitchInfo=bmSwitchInfo, adminMgmtAccessList=adminMgmtAccessList, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminAgentVlanId=adminAgentVlanId, tftpMessage=tftpMessage, portBandwidthLimitRxd=portBandwidthLimitRxd, adminAlarmNameM2=adminAlarmNameM2, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoAlarmStateM2=infoAlarmStateM2, adminAlarmNameM1=adminAlarmNameM1, infoTemperature=infoTemperature, sfpState=sfpState, infoFunctionInputStateF1=infoFunctionInputStateF1, portPoeAdminState=portPoeAdminState, vlanIndex=vlanIndex, portNewMacAddress=portNewMacAddress, portAcApSetup=portAcApSetup, sfpEvent=sfpEvent, switchFunctionInputAlarm=switchFunctionInputAlarm, portDefaultVlanId=portDefaultVlanId, portDefaultPrioQueue=portDefaultPrioQueue, portPoeOverloadFailure=portPoeOverloadFailure, bmSwitchVlan=bmSwitchVlan, portPrioDot1p=portPrioDot1p, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portPoePowerLimit=portPoePowerLimit, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, PYSNMP_MODULE_ID=bmSwitchMIB, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portLEDGreen=portLEDGreen, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portName=portName)
