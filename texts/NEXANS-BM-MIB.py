...
MibIdentifier, IpAddress, Bits, TimeTicks, Unsigned32, ModuleIdentity, Counter32, Integer32, NotificationType, Counter64, Gauge32, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "IpAddress", "Bits", "TimeTicks", "Unsigned32", "ModuleIdentity", "Counter32", "Integer32", "NotificationType", "Counter64", "Gauge32", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", sfpInfoVendorName=sfpInfoVendorName, portTrunkingMode=portTrunkingMode, sfpDiagTemperature=sfpDiagTemperature, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminAlarmM1=adminAlarmM1, portPoeOverloadFailure=portPoeOverloadFailure, infoAlarmStateM2=infoAlarmStateM2, radiusPortSecurityReject=radiusPortSecurityReject, infoNoOfReboots=infoNoOfReboots, portSecurityAdminState=portSecurityAdminState, switchTemperatureFailure=switchTemperatureFailure, switchMgmtAuthFailure=switchMgmtAuthFailure, portLinkState=portLinkState, sfpEvent=sfpEvent, bmTraps=bmTraps, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portDescr=portDescr, portAdminState=portAdminState, portBandwidthLimitRxd=portBandwidthLimitRxd, portErrorCountFailure=portErrorCountFailure, adminAgentNetmask=adminAgentNetmask, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portSecurityFailure=portSecurityFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminAlarmNameM2=adminAlarmNameM2, infoNoOfPorts=infoNoOfPorts, portDefaultPrioQueue=portDefaultPrioQueue, bmSwitchVlanTable=bmSwitchVlanTable, infoManufactureDate=infoManufactureDate, adminMgmtAccessList=adminMgmtAccessList, portPoePowerLimit=portPoePowerLimit, bmSwitchMIB=bmSwitchMIB, adminSwitchVlanTableMode=adminSwitchVlanTableMode, bmSwitchPortEntry=bmSwitchPortEntry, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portSecurityForwardingState=portSecurityForwardingState, adminAgentPrioValue=adminAgentPrioValue, sfpPortIndex=sfpPortIndex, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminAlarmM2=adminAlarmM2, portErrorCounter=portErrorCounter, portLinkChange=portLinkChange, bmSwitchVlan=bmSwitchVlan, infoType=infoType, adminSnmpMacTableMode=adminSnmpMacTableMode, adminAlarmNameM1=adminAlarmNameM1, infoPowerVoltage3300=infoPowerVoltage3300, bmSwitchAdmin=bmSwitchAdmin, tftpMessage=tftpMessage, portErrorDisabled=portErrorDisabled, infoSeriesNo=infoSeriesNo, bmSwitchSfpEntry=bmSwitchSfpEntry, infoPoeInputVoltage=infoPoeInputVoltage, radiusMgmtAuthReject=radiusMgmtAuthReject, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portSecurityMacAddr3=portSecurityMacAddr3, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portLoopBcastFailure=portLoopBcastFailure, bmSwitchPortTable=bmSwitchPortTable, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminTftpAccess=adminTftpAccess, sfpInfoPartNumber=sfpInfoPartNumber, adminLedGlobalMode=adminLedGlobalMode, sfpInfoWavelength=sfpInfoWavelength, switchInternalVoltageFailure=switchInternalVoltageFailure, adminSwitchPortMirror=adminSwitchPortMirror, infoDescr=infoDescr, adminMemoryCardMode=adminMemoryCardMode, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoTemperature=infoTemperature, sfpInfoBitRate=sfpInfoBitRate, bmSwitchPort=bmSwitchPort, infoAlarmStateM1=infoAlarmStateM1, portSpeedDuplexSetup=portSpeedDuplexSetup, portLEDGreen=portLEDGreen, portPoePower=portPoePower, portPoeCurrent=portPoeCurrent, infoFunctionInputStateF1=infoFunctionInputStateF1, infoTotalConfigChanges=infoTotalConfigChanges, adminAgentPhysAddress=adminAgentPhysAddress, PYSNMP_MODULE_ID=bmSwitchMIB, infoPowerVoltage2500=infoPowerVoltage2500, adminAgentIpAddress=adminAgentIpAddress, portAcApSetup=portAcApSetup, bmSwitchSfpTable=bmSwitchSfpTable, vlanId=vlanId, portVoiceVlanId=portVoiceVlanId, portNewMacAddress=portNewMacAddress, portDefaultVlanId=portDefaultVlanId, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portName=portName, switchPoeOverloadFailure=switchPoeOverloadFailure, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoNewMacAddr=infoNewMacAddr, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoSerie=infoSerie, adminFunctionInputNameF1=adminFunctionInputNameF1, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoPoeInputPower=infoPoeInputPower, portBandwidthLimitTxd=portBandwidthLimitTxd, infoUnauthIpAddr=infoUnauthIpAddr, portSecurityMacAddr2=portSecurityMacAddr2, sfpInfoLength62um=sfpInfoLength62um, sfpInfoLength50um=sfpInfoLength50um, portRemoteFault=portRemoteFault, adminAgentDhcp=adminAgentDhcp, clientRemoved=clientRemoved, switchFunctionInputAlarm=switchFunctionInputAlarm, portPrioDot1p=portPrioDot1p, switchPoeVoltageFailure=switchPoeVoltageFailure, portLinkType=portLinkType, sfpInfoLength9um=sfpInfoLength9um, adminReset=adminReset, portPoeAdminState=portPoeAdminState, adminAgentVlanId=adminAgentVlanId, infoLastTftpMessage=infoLastTftpMessage, adminUnsecureVlanId=adminUnsecureVlanId, infoLastSfpEventMessage=infoLastSfpEventMessage, portSecurityMacAddr1=portSecurityMacAddr1, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, sfpInfoDateCode=sfpInfoDateCode, portPrioIp=portPrioIp, sfpState=sfpState, switchConfigurationChanged=switchConfigurationChanged, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portLEDYellow=portLEDYellow, vlanDescr=vlanDescr, portLimiterPacketType=portLimiterPacketType, infoProductNo=infoProductNo, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portPoeVoltage=portPoeVoltage, bmSwitchSfp=bmSwitchSfp, bmSwitchInfo=bmSwitchInfo, sfpInfoSerialNumber=sfpInfoSerialNumber, vlanIndex=vlanIndex, internalMgmtWarning=internalMgmtWarning, portIndex=portIndex)
