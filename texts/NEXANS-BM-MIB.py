...
mibBuilder.exportSymbols("NEXANS-BM-MIB", bmSwitchPortEntry=bmSwitchPortEntry, portPrioDot1p=portPrioDot1p, adminAgentVlanId=adminAgentVlanId, infoPoeInputVoltage=infoPoeInputVoltage, portDescr=portDescr, sfpInfoDateCode=sfpInfoDateCode, portErrorCountFailure=portErrorCountFailure, portPoeOverloadFailure=portPoeOverloadFailure, switchFunctionInputAlarm=switchFunctionInputAlarm, sfpInfoWavelength=sfpInfoWavelength, infoUnauthIpAddr=infoUnauthIpAddr, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminAgentPrioValue=adminAgentPrioValue, switchInternalVoltageFailure=switchInternalVoltageFailure, sfpState=sfpState, adminTftpAccess=adminTftpAccess, infoAlarmStateM2=infoAlarmStateM2, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpDiagTxOutputPower=sfpDiagTxOutputPower, infoNewMacAddr=infoNewMacAddr, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpDiagTemperature=sfpDiagTemperature, infoProductNo=infoProductNo, PYSNMP_MODULE_ID=bmSwitchMIB, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portLEDGreen=portLEDGreen, portSecurityForwardingState=portSecurityForwardingState, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, bmSwitchInfo=bmSwitchInfo, infoTemperature=infoTemperature, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, vlanDescr=vlanDescr, portLEDYellow=portLEDYellow, switchPoeOverloadFailure=switchPoeOverloadFailure, portTrunkingMode=portTrunkingMode, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpInfoLength62um=sfpInfoLength62um, portNewMacAddress=portNewMacAddress, adminAlarmM1=adminAlarmM1, internalMgmtWarning=internalMgmtWarning, portPoeVoltage=portPoeVoltage, portVoiceVlanId=portVoiceVlanId, adminLedGlobalMode=adminLedGlobalMode, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portAdminState=portAdminState, portDefaultPrioQueue=portDefaultPrioQueue, infoFunctionInputStateF1=infoFunctionInputStateF1, infoSerie=infoSerie, adminSwitchPortMirror=adminSwitchPortMirror, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpInfoLength50um=sfpInfoLength50um, bmSwitchPort=bmSwitchPort, vlanId=vlanId, adminMemoryCardMode=adminMemoryCardMode, portBandwidthLimitRxd=portBandwidthLimitRxd, bmSwitchVlan=bmSwitchVlan, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portSecurityAdminState=portSecurityAdminState, portIndex=portIndex, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portAcApSetup=portAcApSetup, bmSwitchAdmin=bmSwitchAdmin, bmSwitchVlanTable=bmSwitchVlanTable, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, vlanIndex=vlanIndex, infoPoeInputPower=infoPoeInputPower, tftpMessage=tftpMessage, sfpEvent=sfpEvent, infoType=infoType, infoLastSfpEventMessage=infoLastSfpEventMessage, infoNoOfPorts=infoNoOfPorts, adminUnsecureVlanId=adminUnsecureVlanId, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portPoeCurrent=portPoeCurrent, portSpeedDuplexSetup=portSpeedDuplexSetup, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminMgmtAccessList=adminMgmtAccessList, infoManufactureDate=infoManufactureDate, switchTemperatureFailure=switchTemperatureFailure, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoDescr=infoDescr, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portSecurityFailure=portSecurityFailure, infoAlarmStateM1=infoAlarmStateM1, radiusPortSecurityReject=radiusPortSecurityReject, portPoeAdminState=portPoeAdminState, sfpPortIndex=sfpPortIndex, bmSwitchPortTable=bmSwitchPortTable, bmTraps=bmTraps, switchConfigurationChanged=switchConfigurationChanged, adminAlarmNameM1=adminAlarmNameM1, portPoePower=portPoePower, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpInfoVendorName=sfpInfoVendorName, portLinkState=portLinkState, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminSnmpMacTableMode=adminSnmpMacTableMode, infoTotalConfigChanges=infoTotalConfigChanges, portSecurityMacAddr1=portSecurityMacAddr1, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoNoOfReboots=infoNoOfReboots, sfpInfoLength9um=sfpInfoLength9um, switchMgmtAuthFailure=switchMgmtAuthFailure, adminFunctionInputNameF1=adminFunctionInputNameF1, adminSwitchVlanTableMode=adminSwitchVlanTableMode, switchPoeVoltageFailure=switchPoeVoltageFailure, portRemoteFault=portRemoteFault, sfpInfoPartNumber=sfpInfoPartNumber, adminAgentNetmask=adminAgentNetmask, adminAgentDhcp=adminAgentDhcp, infoLastTftpMessage=infoLastTftpMessage, bmSwitchSfp=bmSwitchSfp, portSecurityMacAddr2=portSecurityMacAddr2, sfpInfoSerialNumber=sfpInfoSerialNumber, radiusMgmtAuthReject=radiusMgmtAuthReject, portName=portName, adminReset=adminReset, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portLimiterPacketType=portLimiterPacketType, portSecurityMacAddr3=portSecurityMacAddr3, portLinkChange=portLinkChange, portLoopBcastFailure=portLoopBcastFailure, infoSeriesNo=infoSeriesNo, adminAgentIpAddress=adminAgentIpAddress, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, clientRemoved=clientRemoved, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminAlarmNameM2=adminAlarmNameM2, infoPowerVoltage3300=infoPowerVoltage3300, portLinkType=portLinkType, portDefaultVlanId=portDefaultVlanId, portErrorCounter=portErrorCounter, infoPowerVoltage2500=infoPowerVoltage2500, sfpInfoBitRate=sfpInfoBitRate, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminAgentPhysAddress=adminAgentPhysAddress, portPoePowerLimit=portPoePowerLimit, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, bmSwitchSfpTable=bmSwitchSfpTable, portPrioIp=portPrioIp, adminAlarmM2=adminAlarmM2, bmSwitchMIB=bmSwitchMIB, portErrorDisabled=portErrorDisabled, bmSwitchVlanEntry=bmSwitchVlanEntry)
