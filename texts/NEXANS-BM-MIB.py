...
NotificationType, IpAddress, iso, MibIdentifier, ModuleIdentity, Unsigned32, TimeTicks, Gauge32, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "IpAddress", "iso", "MibIdentifier", "ModuleIdentity", "Unsigned32", "TimeTicks", "Gauge32", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "Bits")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portPoeCurrent=portPoeCurrent, clientRemoved=clientRemoved, bmSwitchSfpTable=bmSwitchSfpTable, switchFunctionInputAlarm=switchFunctionInputAlarm, sfpState=sfpState, infoSerie=infoSerie, infoPoeInputVoltage=infoPoeInputVoltage, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpInfoLength9um=sfpInfoLength9um, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoTotalConfigChanges=infoTotalConfigChanges, adminAgentPrioValue=adminAgentPrioValue, portDefaultPrioQueue=portDefaultPrioQueue, sfpInfoPartNumber=sfpInfoPartNumber, infoFunctionInputStateF1=infoFunctionInputStateF1, adminAlarmM2=adminAlarmM2, portSecurityAdminState=portSecurityAdminState, portLoopBcastFailure=portLoopBcastFailure, portSecurityFailure=portSecurityFailure, bmSwitchVlanTable=bmSwitchVlanTable, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portPrioDot1p=portPrioDot1p, portPoeVoltage=portPoeVoltage, internalMgmtWarning=internalMgmtWarning, adminMgmtAccessList=adminMgmtAccessList, infoManufactureDate=infoManufactureDate, switchIndustrialAlarmM1=switchIndustrialAlarmM1, sfpInfoVendorName=sfpInfoVendorName, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoType=infoType, infoLastSfpEventMessage=infoLastSfpEventMessage, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portSecurityMacAddr3=portSecurityMacAddr3, portTrunkingMode=portTrunkingMode, adminMemoryCardMode=adminMemoryCardMode, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, radiusMgmtAuthReject=radiusMgmtAuthReject, sfpInfoLength62um=sfpInfoLength62um, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portAdminState=portAdminState, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portPoeAdminState=portPoeAdminState, adminSnmpMacTableMode=adminSnmpMacTableMode, infoAlarmStateM2=infoAlarmStateM2, infoPowerVoltage2500=infoPowerVoltage2500, portPoeOverloadFailure=portPoeOverloadFailure, sfpPortIndex=sfpPortIndex, switchInternalVoltageFailure=switchInternalVoltageFailure, portErrorDisabled=portErrorDisabled, adminFunctionInputNameF1=adminFunctionInputNameF1, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, infoNoOfPorts=infoNoOfPorts, adminAgentIpAddress=adminAgentIpAddress, infoSeriesNo=infoSeriesNo, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portAcApSetup=portAcApSetup, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, bmSwitchSfp=bmSwitchSfp, bmSwitchPort=bmSwitchPort, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminSwitchPortMirror=adminSwitchPortMirror, portBandwidthLimitTxd=portBandwidthLimitTxd, portSecurityMacAddr1=portSecurityMacAddr1, infoAlarmStateM1=infoAlarmStateM1, adminUnsecureVlanId=adminUnsecureVlanId, bmTraps=bmTraps, portRemoteFault=portRemoteFault, portLinkState=portLinkState, portIndex=portIndex, adminAgentVlanId=adminAgentVlanId, adminAgentPhysAddress=adminAgentPhysAddress, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminReset=adminReset, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoPoeInputPower=infoPoeInputPower, portSecurityMacAddr2=portSecurityMacAddr2, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portNewMacAddress=portNewMacAddress, portPoePower=portPoePower, vlanIndex=vlanIndex, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminAlarmM1=adminAlarmM1, sfpInfoLength50um=sfpInfoLength50um, tftpMessage=tftpMessage, portErrorCountFailure=portErrorCountFailure, infoNoOfReboots=infoNoOfReboots, bmSwitchMIB=bmSwitchMIB, infoPowerVoltage3300=infoPowerVoltage3300, portPoePowerLimit=portPoePowerLimit, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpInfoRevisionNumber=sfpInfoRevisionNumber, adminAgentNetmask=adminAgentNetmask, portDefaultVlanId=portDefaultVlanId, vlanDescr=vlanDescr, infoNewMacAddr=infoNewMacAddr, switchConfigurationChanged=switchConfigurationChanged, switchPoeVoltageFailure=switchPoeVoltageFailure, radiusPortSecurityReject=radiusPortSecurityReject, vlanId=vlanId, bmSwitchPortTable=bmSwitchPortTable, portPrioIp=portPrioIp, portLinkType=portLinkType, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpEvent=sfpEvent, portLEDYellow=portLEDYellow, portName=portName, bmSwitchPortEntry=bmSwitchPortEntry, sfpInfoDateCode=sfpInfoDateCode, switchTemperatureFailure=switchTemperatureFailure, bmSwitchAdmin=bmSwitchAdmin, infoDescr=infoDescr, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAlarmNameM1=adminAlarmNameM1, portVoiceVlanId=portVoiceVlanId, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portSecurityForwardingState=portSecurityForwardingState, sfpDiagTemperature=sfpDiagTemperature, infoMgmtHardwareVersion=infoMgmtHardwareVersion, bmSwitchVlan=bmSwitchVlan, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoUnauthIpAddr=infoUnauthIpAddr, bmSwitchInfo=bmSwitchInfo, portBandwidthLimitRxd=portBandwidthLimitRxd, sfpInfoBitRate=sfpInfoBitRate, switchPoeOverloadFailure=switchPoeOverloadFailure, portLEDGreen=portLEDGreen, adminLedGlobalMode=adminLedGlobalMode, switchMgmtAuthFailure=switchMgmtAuthFailure, adminAlarmNameM2=adminAlarmNameM2, infoProductNo=infoProductNo, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminAgentDhcp=adminAgentDhcp, portLimiterPacketType=portLimiterPacketType, infoTemperature=infoTemperature, infoLastTftpMessage=infoLastTftpMessage, PYSNMP_MODULE_ID=bmSwitchMIB, portErrorCounter=portErrorCounter, bmSwitchSfpEntry=bmSwitchSfpEntry, adminTftpAccess=adminTftpAccess, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portLinkChange=portLinkChange, sfpInfoWavelength=sfpInfoWavelength, portDescr=portDescr, sfpInfoSerialNumber=sfpInfoSerialNumber)
