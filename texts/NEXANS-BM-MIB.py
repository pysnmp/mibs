...
Integer32, Counter32, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, TimeTicks, MibIdentifier, IpAddress, ObjectIdentity, NotificationType, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "TimeTicks", "MibIdentifier", "IpAddress", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoPoeInputPower=infoPoeInputPower, adminReset=adminReset, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portLinkChange=portLinkChange, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminAgentNetmask=adminAgentNetmask, portPrioIp=portPrioIp, adminAlarmNameM1=adminAlarmNameM1, adminUnsecureVlanId=adminUnsecureVlanId, portPrioDot1p=portPrioDot1p, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpInfoBitRate=sfpInfoBitRate, sfpEvent=sfpEvent, adminAlarmNameM2=adminAlarmNameM2, bmSwitchMIB=bmSwitchMIB, portErrorCounter=portErrorCounter, portPoeCurrent=portPoeCurrent, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAlarmM2=adminAlarmM2, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoUnauthIpAddr=infoUnauthIpAddr, infoFunctionInputStateF1=infoFunctionInputStateF1, bmSwitchInfo=bmSwitchInfo, adminMemoryCardMode=adminMemoryCardMode, sfpDiagTemperature=sfpDiagTemperature, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portDefaultVlanId=portDefaultVlanId, bmTraps=bmTraps, portBandwidthLimitRxd=portBandwidthLimitRxd, sfpInfoLength50um=sfpInfoLength50um, internalMgmtWarning=internalMgmtWarning, infoAlarmStateM2=infoAlarmStateM2, portName=portName, sfpInfoLength9um=sfpInfoLength9um, adminAgentPrioValue=adminAgentPrioValue, adminFunctionInputNameF1=adminFunctionInputNameF1, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminMgmtAccessList=adminMgmtAccessList, bmSwitchPortTable=bmSwitchPortTable, adminSwitchVlanTableMode=adminSwitchVlanTableMode, bmSwitchVlan=bmSwitchVlan, portSecurityForwardingState=portSecurityForwardingState, portVoiceVlanId=portVoiceVlanId, portLoopBcastFailure=portLoopBcastFailure, infoAlarmStateM1=infoAlarmStateM1, switchFunctionInputAlarm=switchFunctionInputAlarm, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portLEDYellow=portLEDYellow, portLinkType=portLinkType, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portLEDGreen=portLEDGreen, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portSecurityMacAddr1=portSecurityMacAddr1, sfpPortIndex=sfpPortIndex, switchInternalVoltageFailure=switchInternalVoltageFailure, portLimiterPacketType=portLimiterPacketType, infoManufactureDate=infoManufactureDate, infoProductNo=infoProductNo, sfpInfoPartNumber=sfpInfoPartNumber, portSecurityAdminState=portSecurityAdminState, portPoePower=portPoePower, adminSwitchPortMirror=adminSwitchPortMirror, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portDescr=portDescr, portRemoteFault=portRemoteFault, adminLedGlobalMode=adminLedGlobalMode, switchMgmtAuthFailure=switchMgmtAuthFailure, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminAgentPhysAddress=adminAgentPhysAddress, sfpInfoSerialNumber=sfpInfoSerialNumber, portSecurityFailure=portSecurityFailure, adminAlarmM1=adminAlarmM1, infoType=infoType, switchTemperatureFailure=switchTemperatureFailure, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoNewMacAddr=infoNewMacAddr, bmSwitchSfpTable=bmSwitchSfpTable, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portNewMacAddress=portNewMacAddress, bmSwitchAdmin=bmSwitchAdmin, portAcApSetup=portAcApSetup, portLinkState=portLinkState, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portAdminState=portAdminState, infoPowerVoltage3300=infoPowerVoltage3300, sfpInfoDateCode=sfpInfoDateCode, portErrorDisabled=portErrorDisabled, infoNoOfPorts=infoNoOfPorts, infoSerie=infoSerie, portTrunkingMode=portTrunkingMode, PYSNMP_MODULE_ID=bmSwitchMIB, infoTemperature=infoTemperature, switchPoeOverloadFailure=switchPoeOverloadFailure, adminSnmpMacTableMode=adminSnmpMacTableMode, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpInfoWavelength=sfpInfoWavelength, radiusPortSecurityReject=radiusPortSecurityReject, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, bmSwitchVlanTable=bmSwitchVlanTable, portPoeAdminState=portPoeAdminState, infoLastSfpEventMessage=infoLastSfpEventMessage, portErrorCountFailure=portErrorCountFailure, clientRemoved=clientRemoved, switchPoeVoltageFailure=switchPoeVoltageFailure, portIndex=portIndex, portBandwidthLimitTxd=portBandwidthLimitTxd, infoPoeInputVoltage=infoPoeInputVoltage, bmSwitchPort=bmSwitchPort, portPoePowerLimit=portPoePowerLimit, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpInfoLength62um=sfpInfoLength62um, infoSeriesNo=infoSeriesNo, adminAgentIpAddress=adminAgentIpAddress, bmSwitchSfpEntry=bmSwitchSfpEntry, adminAgentDhcp=adminAgentDhcp, infoTotalConfigChanges=infoTotalConfigChanges, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portPoeOverloadFailure=portPoeOverloadFailure, sfpState=sfpState, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoNoOfReboots=infoNoOfReboots, vlanId=vlanId, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminTftpAccess=adminTftpAccess, radiusMgmtAuthReject=radiusMgmtAuthReject, infoPowerVoltage2500=infoPowerVoltage2500, portSecurityMacAddr2=portSecurityMacAddr2, bmSwitchPortEntry=bmSwitchPortEntry, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoDescr=infoDescr, tftpMessage=tftpMessage, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpInfoVendorName=sfpInfoVendorName, bmSwitchSfp=bmSwitchSfp, portDefaultPrioQueue=portDefaultPrioQueue, portPoeVoltage=portPoeVoltage, portSecurityMacAddr3=portSecurityMacAddr3, vlanDescr=vlanDescr, adminAgentVlanId=adminAgentVlanId, portSpeedDuplexSetup=portSpeedDuplexSetup, switchConfigurationChanged=switchConfigurationChanged, infoLastTftpMessage=infoLastTftpMessage, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, vlanIndex=vlanIndex)
