...
TimeTicks, IpAddress, NotificationType, Integer32, Unsigned32, Gauge32, ModuleIdentity, Counter32, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "NotificationType", "Integer32", "Unsigned32", "Gauge32", "ModuleIdentity", "Counter32", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portSecurityAdminState=portSecurityAdminState, infoAlarmStateM1=infoAlarmStateM1, portNewMacAddress=portNewMacAddress, portLinkChange=portLinkChange, sfpInfoBitRate=sfpInfoBitRate, portErrorDisabled=portErrorDisabled, infoPoeInputPower=infoPoeInputPower, bmSwitchInfo=bmSwitchInfo, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, internalMgmtWarning=internalMgmtWarning, portBandwidthLimitRxd=portBandwidthLimitRxd, switchPoeVoltageFailure=switchPoeVoltageFailure, infoSerie=infoSerie, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminUnsecureVlanId=adminUnsecureVlanId, portRemoteFault=portRemoteFault, infoLastTftpMessage=infoLastTftpMessage, portSecurityMacAddr2=portSecurityMacAddr2, switchPoeOverloadFailure=switchPoeOverloadFailure, adminAgentDhcp=adminAgentDhcp, bmSwitchSfp=bmSwitchSfp, adminFunctionInputNameF1=adminFunctionInputNameF1, portSecurityForwardingState=portSecurityForwardingState, adminAlarmM2=adminAlarmM2, adminMgmtAccessList=adminMgmtAccessList, portPoePowerLimit=portPoePowerLimit, portVoiceVlanId=portVoiceVlanId, infoTemperature=infoTemperature, portDescr=portDescr, infoNoOfReboots=infoNoOfReboots, switchFunctionInputAlarm=switchFunctionInputAlarm, infoPowerVoltage2500=infoPowerVoltage2500, portLinkType=portLinkType, PYSNMP_MODULE_ID=bmSwitchMIB, switchTemperatureFailure=switchTemperatureFailure, adminAgentPrioValue=adminAgentPrioValue, portPoeCurrent=portPoeCurrent, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portSecurityMacAddr1=portSecurityMacAddr1, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpDiagTemperature=sfpDiagTemperature, bmSwitchVlan=bmSwitchVlan, portAdminState=portAdminState, radiusMgmtAuthReject=radiusMgmtAuthReject, vlanId=vlanId, infoNoOfPorts=infoNoOfPorts, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, bmSwitchMIB=bmSwitchMIB, portErrorCounter=portErrorCounter, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, infoType=infoType, infoManufactureDate=infoManufactureDate, infoProductNo=infoProductNo, infoNewMacAddr=infoNewMacAddr, portPrioDot1p=portPrioDot1p, sfpInfoLength62um=sfpInfoLength62um, infoPowerVoltage3300=infoPowerVoltage3300, bmSwitchVlanTable=bmSwitchVlanTable, clientRemoved=clientRemoved, portIndex=portIndex, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portName=portName, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoTotalConfigChanges=infoTotalConfigChanges, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, adminReset=adminReset, adminLedGlobalMode=adminLedGlobalMode, portDefaultPrioQueue=portDefaultPrioQueue, portLEDGreen=portLEDGreen, infoMgmtHardwareVersion=infoMgmtHardwareVersion, bmSwitchPortTable=bmSwitchPortTable, sfpInfoSerialNumber=sfpInfoSerialNumber, portPoePower=portPoePower, vlanDescr=vlanDescr, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoAlarmStateM2=infoAlarmStateM2, adminAlarmM1=adminAlarmM1, portPoeOverloadFailure=portPoeOverloadFailure, sfpInfoWavelength=sfpInfoWavelength, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, bmSwitchPort=bmSwitchPort, sfpInfoPartNumber=sfpInfoPartNumber, bmSwitchSfpEntry=bmSwitchSfpEntry, bmSwitchSfpTable=bmSwitchSfpTable, sfpInfoDateCode=sfpInfoDateCode, adminAlarmNameM2=adminAlarmNameM2, portSecurityFailure=portSecurityFailure, adminAgentNetmask=adminAgentNetmask, portPoeVoltage=portPoeVoltage, infoSeriesNo=infoSeriesNo, sfpInfoLength9um=sfpInfoLength9um, portLinkState=portLinkState, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpInfoVendorName=sfpInfoVendorName, switchInternalVoltageFailure=switchInternalVoltageFailure, switchMgmtAuthFailure=switchMgmtAuthFailure, adminAgentVlanId=adminAgentVlanId, radiusPortSecurityReject=radiusPortSecurityReject, portTrunkingMode=portTrunkingMode, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminAlarmNameM1=adminAlarmNameM1, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portLoopBcastFailure=portLoopBcastFailure, sfpState=sfpState, portAcApSetup=portAcApSetup, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portSecurityMacAddr3=portSecurityMacAddr3, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminAgentIpAddress=adminAgentIpAddress, adminSwitchPortMirror=adminSwitchPortMirror, sfpPortIndex=sfpPortIndex, bmSwitchVlanEntry=bmSwitchVlanEntry, bmTraps=bmTraps, adminSnmpMacTableMode=adminSnmpMacTableMode, infoPoeInputVoltage=infoPoeInputVoltage, portSpeedDuplexSetup=portSpeedDuplexSetup, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, infoFunctionInputStateF1=infoFunctionInputStateF1, portPrioIp=portPrioIp, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, switchConfigurationChanged=switchConfigurationChanged, bmSwitchPortEntry=bmSwitchPortEntry, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, tftpMessage=tftpMessage, sfpEvent=sfpEvent, infoDescr=infoDescr, adminTftpAccess=adminTftpAccess, portDefaultVlanId=portDefaultVlanId, infoLastSfpEventMessage=infoLastSfpEventMessage, portLEDYellow=portLEDYellow, sfpInfoLength50um=sfpInfoLength50um, bmSwitchAdmin=bmSwitchAdmin, vlanIndex=vlanIndex, infoUnauthIpAddr=infoUnauthIpAddr, portPoeAdminState=portPoeAdminState, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portBandwidthLimitTxd=portBandwidthLimitTxd, adminMemoryCardMode=adminMemoryCardMode, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminAgentPhysAddress=adminAgentPhysAddress, portErrorCountFailure=portErrorCountFailure, portLimiterPacketType=portLimiterPacketType)
