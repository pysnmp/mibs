...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portIndex=portIndex, vlanDescr=vlanDescr, portAdminState=portAdminState, portRemoteFault=portRemoteFault, radiusMgmtAuthReject=radiusMgmtAuthReject, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, bmSwitchPortEntry=bmSwitchPortEntry, adminAlarmM2=adminAlarmM2, switchIndustrialAlarmM1=switchIndustrialAlarmM1, sfpInfoSerialNumber=sfpInfoSerialNumber, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpEvent=sfpEvent, adminReset=adminReset, vlanIndex=vlanIndex, infoTemperature=infoTemperature, portName=portName, portPrioDot1p=portPrioDot1p, infoPoeInputVoltage=infoPoeInputVoltage, portVoiceVlanId=portVoiceVlanId, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, infoLastTftpMessage=infoLastTftpMessage, portLEDGreen=portLEDGreen, portDefaultVlanId=portDefaultVlanId, portSecurityForwardingState=portSecurityForwardingState, tftpMessage=tftpMessage, portLimiterPacketType=portLimiterPacketType, switchTemperatureFailure=switchTemperatureFailure, sfpInfoConnectorDescr=sfpInfoConnectorDescr, vlanId=vlanId, infoPowerVoltage2500=infoPowerVoltage2500, sfpInfoBitRate=sfpInfoBitRate, switchConfigurationChanged=switchConfigurationChanged, infoTotalConfigChanges=infoTotalConfigChanges, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, clientRemoved=clientRemoved, sfpInfoLength62um=sfpInfoLength62um, infoNewMacAddr=infoNewMacAddr, portPoeOverloadFailure=portPoeOverloadFailure, infoProductNo=infoProductNo, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portLinkType=portLinkType, infoAlarmStateM2=infoAlarmStateM2, adminSwitchPortMirror=adminSwitchPortMirror, adminSnmpMacTableMode=adminSnmpMacTableMode, portSecurityMacAddr2=portSecurityMacAddr2, portPoeAdminState=portPoeAdminState, adminUnsecureVlanId=adminUnsecureVlanId, portPoePowerLimit=portPoePowerLimit, infoType=infoType, sfpPortIndex=sfpPortIndex, infoSeriesNo=infoSeriesNo, sfpInfoVendorName=sfpInfoVendorName, bmSwitchVlanTable=bmSwitchVlanTable, bmSwitchSfpTable=bmSwitchSfpTable, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portPoePower=portPoePower, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portSecurityFailure=portSecurityFailure, portErrorCountFailure=portErrorCountFailure, portSpeedDuplexSetup=portSpeedDuplexSetup, portBandwidthLimitRxd=portBandwidthLimitRxd, portDefaultPrioQueue=portDefaultPrioQueue, infoLastSfpEventMessage=infoLastSfpEventMessage, adminAgentDhcp=adminAgentDhcp, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, infoFunctionInputStateF1=infoFunctionInputStateF1, portDescr=portDescr, adminMemoryCardMode=adminMemoryCardMode, bmSwitchVlanEntry=bmSwitchVlanEntry, portLinkChange=portLinkChange, adminMgmtAccessList=adminMgmtAccessList, sfpInfoDateCode=sfpInfoDateCode, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portLEDYellow=portLEDYellow, sfpInfoLength9um=sfpInfoLength9um, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portErrorCounter=portErrorCounter, infoManufactureDate=infoManufactureDate, infoSerie=infoSerie, adminAlarmNameM2=adminAlarmNameM2, radiusPortSecurityReject=radiusPortSecurityReject, portPoeVoltage=portPoeVoltage, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, switchMgmtAuthFailure=switchMgmtAuthFailure, adminAgentPrioValue=adminAgentPrioValue, infoAlarmStateM1=infoAlarmStateM1, infoPoeInputPower=infoPoeInputPower, bmSwitchMIB=bmSwitchMIB, adminAgentVlanId=adminAgentVlanId, portLinkState=portLinkState, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminAlarmNameM1=adminAlarmNameM1, infoPowerVoltage3300=infoPowerVoltage3300, bmSwitchVlan=bmSwitchVlan, adminAgentPhysAddress=adminAgentPhysAddress, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, internalMgmtWarning=internalMgmtWarning, portPoeCurrent=portPoeCurrent, portPrioIp=portPrioIp, bmSwitchPortTable=bmSwitchPortTable, portAcApSetup=portAcApSetup, sfpDiagTemperature=sfpDiagTemperature, portErrorDisabled=portErrorDisabled, portNewMacAddress=portNewMacAddress, bmSwitchPort=bmSwitchPort, bmSwitchInfo=bmSwitchInfo, adminAgentNetmask=adminAgentNetmask, bmSwitchSfpEntry=bmSwitchSfpEntry, portSecurityMacAddr3=portSecurityMacAddr3, portSecurityAdminState=portSecurityAdminState, infoNoOfReboots=infoNoOfReboots, bmSwitchAdmin=bmSwitchAdmin, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpInfoWavelength=sfpInfoWavelength, portLoopBcastFailure=portLoopBcastFailure, sfpInfoPartNumber=sfpInfoPartNumber, switchPoeVoltageFailure=switchPoeVoltageFailure, bmTraps=bmTraps, switchFunctionInputAlarm=switchFunctionInputAlarm, infoUnauthIpAddr=infoUnauthIpAddr, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, sfpState=sfpState, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminAlarmM1=adminAlarmM1, switchPoeOverloadFailure=switchPoeOverloadFailure, portSecurityMacAddr1=portSecurityMacAddr1, switchInternalVoltageFailure=switchInternalVoltageFailure, adminAgentIpAddress=adminAgentIpAddress, adminTftpAccess=adminTftpAccess, PYSNMP_MODULE_ID=bmSwitchMIB, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoNoOfPorts=infoNoOfPorts, adminLedGlobalMode=adminLedGlobalMode, sfpInfoLength50um=sfpInfoLength50um, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminFunctionInputNameF1=adminFunctionInputNameF1, infoDescr=infoDescr, portTrunkingMode=portTrunkingMode, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, bmSwitchSfp=bmSwitchSfp, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit)
