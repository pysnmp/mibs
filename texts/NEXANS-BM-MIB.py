...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portAdminState=portAdminState, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portRemoteFault=portRemoteFault, portLinkChange=portLinkChange, radiusMgmtAuthReject=radiusMgmtAuthReject, adminAlarmM1=adminAlarmM1, portErrorCountFailure=portErrorCountFailure, portPoePower=portPoePower, adminAlarmNameM1=adminAlarmNameM1, portAcApSetup=portAcApSetup, bmSwitchAdmin=bmSwitchAdmin, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portIndex=portIndex, switchConfigurationChanged=switchConfigurationChanged, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoProductNo=infoProductNo, portPoeAdminState=portPoeAdminState, infoPowerVoltage3300=infoPowerVoltage3300, adminUnsecureVlanId=adminUnsecureVlanId, switchMgmtAuthFailure=switchMgmtAuthFailure, sfpState=sfpState, infoSecurityFailMacAddr=infoSecurityFailMacAddr, infoManufactureDate=infoManufactureDate, clientRemoved=clientRemoved, infoNoOfPorts=infoNoOfPorts, bmSwitchVlanTable=bmSwitchVlanTable, sfpInfoLength9um=sfpInfoLength9um, infoSerie=infoSerie, bmSwitchPortTable=bmSwitchPortTable, sfpPortIndex=sfpPortIndex, portErrorCounter=portErrorCounter, portSecurityMacAddr2=portSecurityMacAddr2, adminSnmpMacTableMode=adminSnmpMacTableMode, portDefaultPrioQueue=portDefaultPrioQueue, portPrioDot1p=portPrioDot1p, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portErrorDisabled=portErrorDisabled, adminLedGlobalMode=adminLedGlobalMode, portLinkType=portLinkType, portPoeVoltage=portPoeVoltage, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpDiagRxIntputPower=sfpDiagRxIntputPower, sfpDiagTemperature=sfpDiagTemperature, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portPrioIp=portPrioIp, bmSwitchInfo=bmSwitchInfo, portPoePowerLimit=portPoePowerLimit, sfpInfoLength62um=sfpInfoLength62um, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portLimiterPacketType=portLimiterPacketType, infoPowerVoltage2500=infoPowerVoltage2500, bmSwitchVlanEntry=bmSwitchVlanEntry, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoLastSfpEventMessage=infoLastSfpEventMessage, switchPoeVoltageFailure=switchPoeVoltageFailure, adminAgentPhysAddress=adminAgentPhysAddress, bmSwitchSfpEntry=bmSwitchSfpEntry, portDescr=portDescr, portLoopBcastFailure=portLoopBcastFailure, internalMgmtWarning=internalMgmtWarning, infoUnauthIpAddr=infoUnauthIpAddr, sfpInfoBitRate=sfpInfoBitRate, switchFunctionInputAlarm=switchFunctionInputAlarm, portBandwidthLimitRxd=portBandwidthLimitRxd, infoAlarmStateM2=infoAlarmStateM2, adminAlarmM2=adminAlarmM2, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portLEDYellow=portLEDYellow, sfpInfoLength50um=sfpInfoLength50um, infoAlarmStateM1=infoAlarmStateM1, portSpeedDuplexSetup=portSpeedDuplexSetup, adminMgmtAccessList=adminMgmtAccessList, adminAlarmNameM2=adminAlarmNameM2, portLEDGreen=portLEDGreen, portBandwidthLimitTxd=portBandwidthLimitTxd, portNewMacAddress=portNewMacAddress, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpDiagTxOutputPower=sfpDiagTxOutputPower, infoTemperature=infoTemperature, adminAgentDhcp=adminAgentDhcp, switchTemperatureFailure=switchTemperatureFailure, vlanId=vlanId, bmSwitchMIB=bmSwitchMIB, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminFunctionInputNameF1=adminFunctionInputNameF1, infoType=infoType, radiusPortSecurityReject=radiusPortSecurityReject, sfpInfoVendorName=sfpInfoVendorName, portVoiceVlanId=portVoiceVlanId, portSecurityMacAddr3=portSecurityMacAddr3, portSecurityAdminState=portSecurityAdminState, PYSNMP_MODULE_ID=bmSwitchMIB, infoTotalConfigChanges=infoTotalConfigChanges, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, sfpInfoWavelength=sfpInfoWavelength, adminSwitchVlanTableMode=adminSwitchVlanTableMode, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoSeriesNo=infoSeriesNo, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminAgentVlanId=adminAgentVlanId, infoFunctionInputStateF1=infoFunctionInputStateF1, infoPoeInputVoltage=infoPoeInputVoltage, switchPoeOverloadFailure=switchPoeOverloadFailure, sfpEvent=sfpEvent, portPoeCurrent=portPoeCurrent, portName=portName, switchInternalVoltageFailure=switchInternalVoltageFailure, portDefaultVlanId=portDefaultVlanId, vlanDescr=vlanDescr, sfpInfoDateCode=sfpInfoDateCode, bmTraps=bmTraps, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminAgentPrioValue=adminAgentPrioValue, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoLastTftpMessage=infoLastTftpMessage, portTrunkingMode=portTrunkingMode, bmSwitchVlan=bmSwitchVlan, bmSwitchSfp=bmSwitchSfp, infoNewMacAddr=infoNewMacAddr, bmSwitchSfpTable=bmSwitchSfpTable, bmSwitchPortEntry=bmSwitchPortEntry, adminReset=adminReset, adminTftpAccess=adminTftpAccess, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portSecurityFailure=portSecurityFailure, adminMemoryCardMode=adminMemoryCardMode, infoDescr=infoDescr, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpInfoRevisionNumber=sfpInfoRevisionNumber, vlanIndex=vlanIndex, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, portPoeOverloadFailure=portPoeOverloadFailure, portSecurityMacAddr1=portSecurityMacAddr1, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portLinkState=portLinkState, adminAgentIpAddress=adminAgentIpAddress, bmSwitchPort=bmSwitchPort, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, switchIndustrialAlarmM1=switchIndustrialAlarmM1, tftpMessage=tftpMessage, adminAgentNetmask=adminAgentNetmask, portSecurityForwardingState=portSecurityForwardingState, infoNoOfReboots=infoNoOfReboots, infoPoeInputPower=infoPoeInputPower, sfpInfoPartNumber=sfpInfoPartNumber, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminSwitchPortMirror=adminSwitchPortMirror)
