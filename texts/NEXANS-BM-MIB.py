...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portLinkType=portLinkType, switchIndustrialAlarmM2=switchIndustrialAlarmM2, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portSecurityFailure=portSecurityFailure, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, bmSwitchVlan=bmSwitchVlan, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, portErrorCountFailure=portErrorCountFailure, infoAlarmStateM2=infoAlarmStateM2, adminAlarmM1=adminAlarmM1, infoLastSfpEventMessage=infoLastSfpEventMessage, portPoePowerLimit=portPoePowerLimit, sfpInfoSerialNumber=sfpInfoSerialNumber, bmSwitchPort=bmSwitchPort, portDefaultPrioQueue=portDefaultPrioQueue, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, bmSwitchSfp=bmSwitchSfp, bmSwitchVlanTable=bmSwitchVlanTable, portVoiceVlanId=portVoiceVlanId, adminTftpAccess=adminTftpAccess, bmTraps=bmTraps, infoUnauthIpAddr=infoUnauthIpAddr, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portLEDYellow=portLEDYellow, portPoeVoltage=portPoeVoltage, tftpMessage=tftpMessage, infoDescr=infoDescr, portTrunkingMode=portTrunkingMode, sfpDiagTemperature=sfpDiagTemperature, infoNewMacAddr=infoNewMacAddr, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpInfoRevisionNumber=sfpInfoRevisionNumber, infoProductNo=infoProductNo, switchMgmtAuthFailure=switchMgmtAuthFailure, switchFunctionInputAlarm=switchFunctionInputAlarm, sfpDiagRxIntputPower=sfpDiagRxIntputPower, clientRemoved=clientRemoved, bmSwitchAdmin=bmSwitchAdmin, adminMemoryCardMode=adminMemoryCardMode, internalMgmtWarning=internalMgmtWarning, adminSwitchVlanTableMode=adminSwitchVlanTableMode, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminAgentDhcp=adminAgentDhcp, bmSwitchSfpTable=bmSwitchSfpTable, infoNoOfPorts=infoNoOfPorts, adminAgentNetmask=adminAgentNetmask, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoType=infoType, portDescr=portDescr, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portErrorCounter=portErrorCounter, portLEDGreen=portLEDGreen, infoTotalConfigChanges=infoTotalConfigChanges, adminLedGlobalMode=adminLedGlobalMode, sfpInfoBitRate=sfpInfoBitRate, sfpInfoLength50um=sfpInfoLength50um, vlanIndex=vlanIndex, infoAlarmStateM1=infoAlarmStateM1, portPoeCurrent=portPoeCurrent, bmSwitchSfpEntry=bmSwitchSfpEntry, switchConfigurationChanged=switchConfigurationChanged, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, vlanDescr=vlanDescr, infoTemperature=infoTemperature, sfpInfoLength9um=sfpInfoLength9um, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portName=portName, portLimiterPacketType=portLimiterPacketType, portPrioIp=portPrioIp, sfpInfoPartNumber=sfpInfoPartNumber, sfpInfoDateCode=sfpInfoDateCode, portSecurityAdminState=portSecurityAdminState, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, switchIndustrialAlarmM1=switchIndustrialAlarmM1, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpInfoLength62um=sfpInfoLength62um, adminSwitchPortMirror=adminSwitchPortMirror, switchPoeVoltageFailure=switchPoeVoltageFailure, sfpInfoWavelength=sfpInfoWavelength, bmSwitchVlanEntry=bmSwitchVlanEntry, portLinkChange=portLinkChange, infoFunctionInputStateF1=infoFunctionInputStateF1, adminReset=adminReset, portSpeedDuplexSetup=portSpeedDuplexSetup, vlanId=vlanId, switchPoeOverloadFailure=switchPoeOverloadFailure, bmSwitchMIB=bmSwitchMIB, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portPoeOverloadFailure=portPoeOverloadFailure, switchInternalVoltageFailure=switchInternalVoltageFailure, portErrorDisabled=portErrorDisabled, bmSwitchInfo=bmSwitchInfo, adminSnmpMacTableMode=adminSnmpMacTableMode, adminAlarmNameM2=adminAlarmNameM2, PYSNMP_MODULE_ID=bmSwitchMIB, sfpInfoVendorName=sfpInfoVendorName, portAcApSetup=portAcApSetup, portLinkState=portLinkState, infoManufactureDate=infoManufactureDate, switchTemperatureFailure=switchTemperatureFailure, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portPoePower=portPoePower, portNewMacAddress=portNewMacAddress, portSecurityMacAddr2=portSecurityMacAddr2, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, adminFunctionInputNameF1=adminFunctionInputNameF1, bmSwitchPortEntry=bmSwitchPortEntry, sfpState=sfpState, adminUnsecureVlanId=adminUnsecureVlanId, infoPowerVoltage2500=infoPowerVoltage2500, portPrioDot1p=portPrioDot1p, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpPortIndex=sfpPortIndex, adminAgentIpAddress=adminAgentIpAddress, infoPoeInputPower=infoPoeInputPower, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portLoopBcastFailure=portLoopBcastFailure, portDefaultVlanId=portDefaultVlanId, adminAgentPrioValue=adminAgentPrioValue, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminAgentPhysAddress=adminAgentPhysAddress, sfpEvent=sfpEvent, portSecurityForwardingState=portSecurityForwardingState, portSecurityMacAddr3=portSecurityMacAddr3, adminAlarmM2=adminAlarmM2, adminAgentVlanId=adminAgentVlanId, adminMgmtAccessList=adminMgmtAccessList, bmSwitchPortTable=bmSwitchPortTable, infoSeriesNo=infoSeriesNo, portIndex=portIndex, radiusPortSecurityReject=radiusPortSecurityReject, infoPoeInputVoltage=infoPoeInputVoltage, infoLastTftpMessage=infoLastTftpMessage, infoPowerVoltage3300=infoPowerVoltage3300, infoNoOfReboots=infoNoOfReboots, portAdminState=portAdminState, portBandwidthLimitRxd=portBandwidthLimitRxd, infoSerie=infoSerie, portSecurityMacAddr1=portSecurityMacAddr1, adminAlarmNameM1=adminAlarmNameM1, portPoeAdminState=portPoeAdminState, radiusMgmtAuthReject=radiusMgmtAuthReject, portRemoteFault=portRemoteFault)
