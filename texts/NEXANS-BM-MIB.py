...
iso, TimeTicks, NotificationType, Gauge32, MibIdentifier, Bits, ModuleIdentity, Counter32, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "NotificationType", "Gauge32", "MibIdentifier", "Bits", "ModuleIdentity", "Counter32", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", bmSwitchPortTable=bmSwitchPortTable, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portLoopBcastFailure=portLoopBcastFailure, infoManufactureDate=infoManufactureDate, switchTemperatureFailure=switchTemperatureFailure, switchPoeVoltageFailure=switchPoeVoltageFailure, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, bmSwitchSfpEntry=bmSwitchSfpEntry, switchPoeOverloadFailure=switchPoeOverloadFailure, infoType=infoType, portLinkChange=portLinkChange, adminAgentIpAddress=adminAgentIpAddress, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portPoePowerLimit=portPoePowerLimit, portDescr=portDescr, portSecurityMacAddr2=portSecurityMacAddr2, sfpInfoBitRate=sfpInfoBitRate, adminFunctionInputNameF1=adminFunctionInputNameF1, infoPowerVoltage3300=infoPowerVoltage3300, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portTrunkingMode=portTrunkingMode, bmSwitchVlanTable=bmSwitchVlanTable, portSecurityForwardingState=portSecurityForwardingState, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, bmTraps=bmTraps, portAdminState=portAdminState, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpInfoLength9um=sfpInfoLength9um, sfpInfoLength50um=sfpInfoLength50um, infoDescr=infoDescr, switchInternalVoltageFailure=switchInternalVoltageFailure, infoSeriesNo=infoSeriesNo, adminMemoryCardMode=adminMemoryCardMode, vlanId=vlanId, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoPoeInputPower=infoPoeInputPower, bmSwitchInfo=bmSwitchInfo, infoProductNo=infoProductNo, adminAgentNetmask=adminAgentNetmask, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpInfoPartNumber=sfpInfoPartNumber, adminAgentDhcp=adminAgentDhcp, portBandwidthLimitTxd=portBandwidthLimitTxd, radiusMgmtAuthReject=radiusMgmtAuthReject, sfpInfoWavelength=sfpInfoWavelength, infoAlarmStateM2=infoAlarmStateM2, adminMgmtAccessList=adminMgmtAccessList, radiusPortSecurityReject=radiusPortSecurityReject, portDefaultPrioQueue=portDefaultPrioQueue, tftpMessage=tftpMessage, portSecurityAdminState=portSecurityAdminState, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, infoNoOfReboots=infoNoOfReboots, switchMgmtAuthFailure=switchMgmtAuthFailure, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminAlarmM2=adminAlarmM2, portPoePower=portPoePower, portDefaultVlanId=portDefaultVlanId, adminLedGlobalMode=adminLedGlobalMode, sfpInfoConnectorDescr=sfpInfoConnectorDescr, bmSwitchPort=bmSwitchPort, portErrorCountFailure=portErrorCountFailure, portSecurityFailure=portSecurityFailure, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portVoiceVlanId=portVoiceVlanId, sfpInfoVendorName=sfpInfoVendorName, adminAgentPrioValue=adminAgentPrioValue, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portPoeOverloadFailure=portPoeOverloadFailure, infoPoeInputVoltage=infoPoeInputVoltage, adminSwitchPortMirror=adminSwitchPortMirror, portPrioDot1p=portPrioDot1p, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpDiagTxOutputPower=sfpDiagTxOutputPower, bmSwitchVlan=bmSwitchVlan, infoNewMacAddr=infoNewMacAddr, vlanIndex=vlanIndex, switchConfigurationChanged=switchConfigurationChanged, adminAlarmM1=adminAlarmM1, adminUnsecureVlanId=adminUnsecureVlanId, adminAgentPhysAddress=adminAgentPhysAddress, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoUnauthIpAddr=infoUnauthIpAddr, portLimiterPacketType=portLimiterPacketType, vlanDescr=vlanDescr, infoFunctionInputStateF1=infoFunctionInputStateF1, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminReset=adminReset, portNewMacAddress=portNewMacAddress, sfpPortIndex=sfpPortIndex, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoSerie=infoSerie, infoTemperature=infoTemperature, bmSwitchSfpTable=bmSwitchSfpTable, adminAlarmNameM2=adminAlarmNameM2, bmSwitchVlanEntry=bmSwitchVlanEntry, sfpDiagTemperature=sfpDiagTemperature, portRemoteFault=portRemoteFault, bmSwitchSfp=bmSwitchSfp, clientRemoved=clientRemoved, portSecurityMacAddr3=portSecurityMacAddr3, sfpInfoDateCode=sfpInfoDateCode, adminTftpAccess=adminTftpAccess, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAlarmNameM1=adminAlarmNameM1, switchFunctionInputAlarm=switchFunctionInputAlarm, infoSecurityFailMacAddr=infoSecurityFailMacAddr, bmSwitchPortEntry=bmSwitchPortEntry, portErrorCounter=portErrorCounter, portIndex=portIndex, bmSwitchAdmin=bmSwitchAdmin, portPoeVoltage=portPoeVoltage, portPrioIp=portPrioIp, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoLastSfpEventMessage=infoLastSfpEventMessage, portName=portName, internalMgmtWarning=internalMgmtWarning, infoAlarmStateM1=infoAlarmStateM1, portAcApSetup=portAcApSetup, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portPoeCurrent=portPoeCurrent, infoTotalConfigChanges=infoTotalConfigChanges, portPoeAdminState=portPoeAdminState, portLEDYellow=portLEDYellow, infoPowerVoltage2500=infoPowerVoltage2500, sfpInfoLength62um=sfpInfoLength62um, portErrorDisabled=portErrorDisabled, bmSwitchMIB=bmSwitchMIB, adminAgentVlanId=adminAgentVlanId, portLinkState=portLinkState, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, PYSNMP_MODULE_ID=bmSwitchMIB, portSecurityMacAddr1=portSecurityMacAddr1, sfpInfoRevisionNumber=sfpInfoRevisionNumber, adminSnmpMacTableMode=adminSnmpMacTableMode, portSpeedDuplexSetup=portSpeedDuplexSetup, portLEDGreen=portLEDGreen, portBandwidthLimitRxd=portBandwidthLimitRxd, sfpState=sfpState, infoNoOfPorts=infoNoOfPorts, portLinkType=portLinkType, sfpEvent=sfpEvent, infoLastTftpMessage=infoLastTftpMessage)
