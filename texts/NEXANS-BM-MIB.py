...
TimeTicks, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, Gauge32, IpAddress, NotificationType, iso, Counter64, Integer32, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "Gauge32", "IpAddress", "NotificationType", "iso", "Counter64", "Integer32", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portLoopBcastFailure=portLoopBcastFailure, infoPowerVoltage3300=infoPowerVoltage3300, infoAlarmStateM1=infoAlarmStateM1, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, internalMgmtWarning=internalMgmtWarning, infoNoOfPorts=infoNoOfPorts, sfpDiagRxIntputPower=sfpDiagRxIntputPower, infoSeriesNo=infoSeriesNo, bmSwitchPortEntry=bmSwitchPortEntry, infoManufactureDate=infoManufactureDate, portPoeAdminState=portPoeAdminState, portSecurityForwardingState=portSecurityForwardingState, infoPowerVoltage2500=infoPowerVoltage2500, portDefaultPrioQueue=portDefaultPrioQueue, portSecurityMacAddr1=portSecurityMacAddr1, sfpDiagTemperature=sfpDiagTemperature, bmTraps=bmTraps, portVoiceVlanId=portVoiceVlanId, adminAlarmM2=adminAlarmM2, infoUnauthIpAddr=infoUnauthIpAddr, portName=portName, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portBandwidthLimitTxd=portBandwidthLimitTxd, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, sfpInfoWavelength=sfpInfoWavelength, sfpInfoLength9um=sfpInfoLength9um, adminSwitchPortMirror=adminSwitchPortMirror, infoFunctionInputStateF1=infoFunctionInputStateF1, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, adminMemoryCardMode=adminMemoryCardMode, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portPoeCurrent=portPoeCurrent, portRemoteFault=portRemoteFault, switchTemperatureFailure=switchTemperatureFailure, infoDescr=infoDescr, infoLastTftpMessage=infoLastTftpMessage, infoProductNo=infoProductNo, sfpInfoPartNumber=sfpInfoPartNumber, portErrorDisabled=portErrorDisabled, portSecurityMacAddr3=portSecurityMacAddr3, switchPoeVoltageFailure=switchPoeVoltageFailure, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, switchPoeOverloadFailure=switchPoeOverloadFailure, adminSnmpMacTableMode=adminSnmpMacTableMode, tftpMessage=tftpMessage, bmSwitchInfo=bmSwitchInfo, sfpState=sfpState, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoMgmtHardwareVersion=infoMgmtHardwareVersion, bmSwitchMIB=bmSwitchMIB, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portLinkState=portLinkState, portLEDYellow=portLEDYellow, switchConfigurationChanged=switchConfigurationChanged, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portErrorCounter=portErrorCounter, infoPoeInputPower=infoPoeInputPower, sfpInfoVendorName=sfpInfoVendorName, bmSwitchSfpTable=bmSwitchSfpTable, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portTrunkingMode=portTrunkingMode, radiusPortSecurityReject=radiusPortSecurityReject, bmSwitchVlan=bmSwitchVlan, portLEDGreen=portLEDGreen, PYSNMP_MODULE_ID=bmSwitchMIB, vlanDescr=vlanDescr, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpInfoRevisionNumber=sfpInfoRevisionNumber, infoSwitchHardwareVersion=infoSwitchHardwareVersion, clientRemoved=clientRemoved, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, switchMgmtAuthFailure=switchMgmtAuthFailure, switchFunctionInputAlarm=switchFunctionInputAlarm, adminTftpAccess=adminTftpAccess, portDescr=portDescr, vlanId=vlanId, portNewMacAddress=portNewMacAddress, bmSwitchPortTable=bmSwitchPortTable, portSecurityFailure=portSecurityFailure, adminFunctionInputNameF1=adminFunctionInputNameF1, portAcApSetup=portAcApSetup, adminAgentVlanId=adminAgentVlanId, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portPrioDot1p=portPrioDot1p, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminUnsecureVlanId=adminUnsecureVlanId, portPoeVoltage=portPoeVoltage, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, switchInternalVoltageFailure=switchInternalVoltageFailure, portSecurityMacAddr2=portSecurityMacAddr2, infoAlarmStateM2=infoAlarmStateM2, bmSwitchVlanEntry=bmSwitchVlanEntry, adminAgentPrioValue=adminAgentPrioValue, adminAgentIpAddress=adminAgentIpAddress, portAdminState=portAdminState, portSecurityAdminState=portSecurityAdminState, portPoePower=portPoePower, portPrioIp=portPrioIp, sfpDiagTxOutputPower=sfpDiagTxOutputPower, infoTotalConfigChanges=infoTotalConfigChanges, bmSwitchVlanTable=bmSwitchVlanTable, infoTemperature=infoTemperature, infoNoOfReboots=infoNoOfReboots, adminReset=adminReset, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, bmSwitchSfpEntry=bmSwitchSfpEntry, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portErrorCountFailure=portErrorCountFailure, sfpInfoLength50um=sfpInfoLength50um, adminAgentDhcp=adminAgentDhcp, portPoePowerLimit=portPoePowerLimit, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminAgentPhysAddress=adminAgentPhysAddress, adminAlarmNameM1=adminAlarmNameM1, radiusMgmtAuthReject=radiusMgmtAuthReject, sfpInfoBitRate=sfpInfoBitRate, adminAgentNetmask=adminAgentNetmask, portLinkChange=portLinkChange, bmSwitchAdmin=bmSwitchAdmin, portBandwidthLimitRxd=portBandwidthLimitRxd, adminLedGlobalMode=adminLedGlobalMode, portLinkType=portLinkType, bmSwitchPort=bmSwitchPort, vlanIndex=vlanIndex, infoLastSfpEventMessage=infoLastSfpEventMessage, infoPoeInputVoltage=infoPoeInputVoltage, infoNewMacAddr=infoNewMacAddr, sfpInfoDateCode=sfpInfoDateCode, sfpEvent=sfpEvent, adminAlarmNameM2=adminAlarmNameM2, adminMgmtAccessList=adminMgmtAccessList, adminAlarmM1=adminAlarmM1, portPoeOverloadFailure=portPoeOverloadFailure, infoType=infoType, bmSwitchSfp=bmSwitchSfp, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpInfoLength62um=sfpInfoLength62um, portLimiterPacketType=portLimiterPacketType, portIndex=portIndex, portDefaultVlanId=portDefaultVlanId, infoSerie=infoSerie, sfpPortIndex=sfpPortIndex, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portSpeedDuplexSetup=portSpeedDuplexSetup, switchIndustrialAlarmM1=switchIndustrialAlarmM1)
