...
mibBuilder.exportSymbols("NEXANS-BM-MIB", switchPoeOverloadFailure=switchPoeOverloadFailure, portLimiterPacketType=portLimiterPacketType, switchConfigurationChanged=switchConfigurationChanged, portErrorCountFailure=portErrorCountFailure, radiusPortSecurityReject=radiusPortSecurityReject, adminMemoryCardMode=adminMemoryCardMode, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portErrorCounter=portErrorCounter, infoManufactureDate=infoManufactureDate, bmSwitchMIB=bmSwitchMIB, switchIndustrialAlarmM1=switchIndustrialAlarmM1, infoLastTftpMessage=infoLastTftpMessage, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpInfoVendorName=sfpInfoVendorName, adminLedGlobalMode=adminLedGlobalMode, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, sfpInfoSerialNumber=sfpInfoSerialNumber, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminAlarmM1=adminAlarmM1, adminFunctionInputNameF1=adminFunctionInputNameF1, bmTraps=bmTraps, bmSwitchVlan=bmSwitchVlan, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpInfoWavelength=sfpInfoWavelength, sfpInfoBitRate=sfpInfoBitRate, infoSwitchHardwareVersion=infoSwitchHardwareVersion, infoTotalConfigChanges=infoTotalConfigChanges, portPoeOverloadFailure=portPoeOverloadFailure, infoSeriesNo=infoSeriesNo, portLEDGreen=portLEDGreen, portPoeCurrent=portPoeCurrent, adminAlarmNameM1=adminAlarmNameM1, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, PYSNMP_MODULE_ID=bmSwitchMIB, infoNoOfReboots=infoNoOfReboots, adminAgentPhysAddress=adminAgentPhysAddress, sfpInfoLength50um=sfpInfoLength50um, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portLinkType=portLinkType, portPoePower=portPoePower, adminMgmtAccessList=adminMgmtAccessList, adminAlarmNameM2=adminAlarmNameM2, portDefaultPrioQueue=portDefaultPrioQueue, vlanIndex=vlanIndex, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoNewMacAddr=infoNewMacAddr, sfpEvent=sfpEvent, portLEDYellow=portLEDYellow, clientRemoved=clientRemoved, bmSwitchAdmin=bmSwitchAdmin, infoFunctionInputStateF1=infoFunctionInputStateF1, infoAlarmStateM1=infoAlarmStateM1, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, sfpInfoDateCode=sfpInfoDateCode, bmSwitchInfo=bmSwitchInfo, infoPoeInputPower=infoPoeInputPower, portLinkState=portLinkState, switchPoeVoltageFailure=switchPoeVoltageFailure, sfpInfoConnectorDescr=sfpInfoConnectorDescr, sfpDiagTemperature=sfpDiagTemperature, adminSnmpMacTableMode=adminSnmpMacTableMode, adminTftpAccess=adminTftpAccess, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portDescr=portDescr, portIndex=portIndex, internalMgmtWarning=internalMgmtWarning, tftpMessage=tftpMessage, portSecurityFailure=portSecurityFailure, bmSwitchVlanEntry=bmSwitchVlanEntry, portNewMacAddress=portNewMacAddress, bmSwitchPortEntry=bmSwitchPortEntry, sfpState=sfpState, switchTemperatureFailure=switchTemperatureFailure, portLoopBcastFailure=portLoopBcastFailure, portAdminState=portAdminState, switchMgmtAuthFailure=switchMgmtAuthFailure, infoSerie=infoSerie, bmSwitchSfp=bmSwitchSfp, infoType=infoType, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, adminAgentVlanId=adminAgentVlanId, sfpInfoLength62um=sfpInfoLength62um, portSecurityAdminState=portSecurityAdminState, bmSwitchSfpTable=bmSwitchSfpTable, adminSwitchPortMirror=adminSwitchPortMirror, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portDefaultVlanId=portDefaultVlanId, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portTrunkingMode=portTrunkingMode, portSecurityMacAddr3=portSecurityMacAddr3, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portVoiceVlanId=portVoiceVlanId, sfpInfoPartNumber=sfpInfoPartNumber, infoNoOfPorts=infoNoOfPorts, portPoeAdminState=portPoeAdminState, adminAgentIpAddress=adminAgentIpAddress, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, sfpInfoLength9um=sfpInfoLength9um, portBandwidthLimitTxd=portBandwidthLimitTxd, portErrorDisabled=portErrorDisabled, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portName=portName, infoPowerVoltage2500=infoPowerVoltage2500, bmSwitchPortTable=bmSwitchPortTable, vlanId=vlanId, bmSwitchVlanTable=bmSwitchVlanTable, adminReset=adminReset, portSecurityMacAddr1=portSecurityMacAddr1, infoProductNo=infoProductNo, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoUnauthIpAddr=infoUnauthIpAddr, infoDescr=infoDescr, switchInternalVoltageFailure=switchInternalVoltageFailure, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portPrioDot1p=portPrioDot1p, vlanDescr=vlanDescr, portBandwidthLimitRxd=portBandwidthLimitRxd, switchFunctionInputAlarm=switchFunctionInputAlarm, portAcApSetup=portAcApSetup, portSecurityMacAddr2=portSecurityMacAddr2, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portPrioIp=portPrioIp, adminAlarmM2=adminAlarmM2, radiusMgmtAuthReject=radiusMgmtAuthReject, infoPoeInputVoltage=infoPoeInputVoltage, portPoePowerLimit=portPoePowerLimit, portSecurityForwardingState=portSecurityForwardingState, infoLastSfpEventMessage=infoLastSfpEventMessage, portPoeVoltage=portPoeVoltage, infoAlarmStateM2=infoAlarmStateM2, sfpPortIndex=sfpPortIndex, adminAgentNetmask=adminAgentNetmask, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoPowerVoltage3300=infoPowerVoltage3300, infoTemperature=infoTemperature, adminUnsecureVlanId=adminUnsecureVlanId, sfpDiagTxOutputPower=sfpDiagTxOutputPower, adminAgentDhcp=adminAgentDhcp, adminAgentPrioValue=adminAgentPrioValue, bmSwitchPort=bmSwitchPort, portRemoteFault=portRemoteFault, portLinkChange=portLinkChange)
