...
TimeTicks, ModuleIdentity, NotificationType, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Unsigned32, MibIdentifier, iso, IpAddress, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "NotificationType", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Unsigned32", "MibIdentifier", "iso", "IpAddress", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portSecurityFailure=portSecurityFailure, portRemoteFault=portRemoteFault, adminTftpAccess=adminTftpAccess, PYSNMP_MODULE_ID=bmSwitchMIB, adminAgentPhysAddress=adminAgentPhysAddress, portPrioDot1p=portPrioDot1p, portName=portName, switchTemperatureFailure=switchTemperatureFailure, switchIndustrialAlarmM2=switchIndustrialAlarmM2, portSpeedDuplexSetup=portSpeedDuplexSetup, bmSwitchPort=bmSwitchPort, radiusPortSecurityReject=radiusPortSecurityReject, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portLinkState=portLinkState, infoTotalConfigChanges=infoTotalConfigChanges, portDefaultPrioQueue=portDefaultPrioQueue, infoSeriesNo=infoSeriesNo, bmSwitchVlanEntry=bmSwitchVlanEntry, switchPoeVoltageFailure=switchPoeVoltageFailure, portTrunkingMode=portTrunkingMode, internalMgmtWarning=internalMgmtWarning, bmSwitchPortTable=bmSwitchPortTable, sfpInfoLength50um=sfpInfoLength50um, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, switchMgmtAuthFailure=switchMgmtAuthFailure, infoNoOfReboots=infoNoOfReboots, bmSwitchPortEntry=bmSwitchPortEntry, portPoePower=portPoePower, infoUnauthIpAddr=infoUnauthIpAddr, portPoePowerLimit=portPoePowerLimit, portLEDYellow=portLEDYellow, portNewMacAddress=portNewMacAddress, tftpMessage=tftpMessage, portLinkChange=portLinkChange, portSecurityMacAddr2=portSecurityMacAddr2, adminAlarmM1=adminAlarmM1, infoPowerVoltage3300=infoPowerVoltage3300, infoNewMacAddr=infoNewMacAddr, bmSwitchSfpEntry=bmSwitchSfpEntry, switchConfigurationChanged=switchConfigurationChanged, portErrorDisabled=portErrorDisabled, adminMemoryCardMode=adminMemoryCardMode, infoAlarmStateM1=infoAlarmStateM1, switchIndustrialAlarmM1=switchIndustrialAlarmM1, sfpInfoWavelength=sfpInfoWavelength, sfpDiagTemperature=sfpDiagTemperature, switchFunctionInputAlarm=switchFunctionInputAlarm, portSecurityAdminState=portSecurityAdminState, portDescr=portDescr, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminAlarmM2=adminAlarmM2, adminUnsecureVlanId=adminUnsecureVlanId, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, bmSwitchSfp=bmSwitchSfp, bmSwitchMIB=bmSwitchMIB, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpEvent=sfpEvent, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portPoeAdminState=portPoeAdminState, adminAlarmNameM1=adminAlarmNameM1, bmSwitchVlan=bmSwitchVlan, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, adminSwitchPortMirror=adminSwitchPortMirror, sfpState=sfpState, portPoeOverloadFailure=portPoeOverloadFailure, portBandwidthLimitRxd=portBandwidthLimitRxd, infoNoOfPorts=infoNoOfPorts, sfpPortIndex=sfpPortIndex, portLoopBcastFailure=portLoopBcastFailure, adminAgentDhcp=adminAgentDhcp, adminAgentPrioValue=adminAgentPrioValue, adminAgentVlanId=adminAgentVlanId, vlanIndex=vlanIndex, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpInfoBitRate=sfpInfoBitRate, portErrorCountFailure=portErrorCountFailure, bmTraps=bmTraps, infoType=infoType, infoProductNo=infoProductNo, vlanDescr=vlanDescr, portDefaultVlanId=portDefaultVlanId, infoPoeInputVoltage=infoPoeInputVoltage, portPoeCurrent=portPoeCurrent, infoTemperature=infoTemperature, infoLastTftpMessage=infoLastTftpMessage, sfpInfoLength62um=sfpInfoLength62um, adminAgentIpAddress=adminAgentIpAddress, infoLastSfpEventMessage=infoLastSfpEventMessage, sfpDiagTxOutputPower=sfpDiagTxOutputPower, bmSwitchInfo=bmSwitchInfo, portPrioIp=portPrioIp, infoSerie=infoSerie, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, bmSwitchSfpTable=bmSwitchSfpTable, adminAgentNetmask=adminAgentNetmask, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portSecurityForwardingState=portSecurityForwardingState, portLEDGreen=portLEDGreen, radiusMgmtAuthReject=radiusMgmtAuthReject, switchInternalVoltageFailure=switchInternalVoltageFailure, portAdminState=portAdminState, adminLedGlobalMode=adminLedGlobalMode, portIndex=portIndex, sfpInfoDateCode=sfpInfoDateCode, infoFunctionInputStateF1=infoFunctionInputStateF1, portBandwidthLimitTxd=portBandwidthLimitTxd, adminSnmpMacTableMode=adminSnmpMacTableMode, portLinkType=portLinkType, adminFunctionInputNameF1=adminFunctionInputNameF1, sfpInfoRevisionNumber=sfpInfoRevisionNumber, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portSecurityMacAddr1=portSecurityMacAddr1, switchPoeOverloadFailure=switchPoeOverloadFailure, portVoiceVlanId=portVoiceVlanId, infoPoeInputPower=infoPoeInputPower, infoAlarmStateM2=infoAlarmStateM2, infoDescr=infoDescr, adminMgmtAccessList=adminMgmtAccessList, portAcApSetup=portAcApSetup, vlanId=vlanId, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, bmSwitchVlanTable=bmSwitchVlanTable, adminReset=adminReset, portPoeVoltage=portPoeVoltage, sfpInfoVendorName=sfpInfoVendorName, clientRemoved=clientRemoved, sfpInfoSerialNumber=sfpInfoSerialNumber, bmSwitchAdmin=bmSwitchAdmin, portLimiterPacketType=portLimiterPacketType, adminAlarmNameM2=adminAlarmNameM2, sfpInfoLength9um=sfpInfoLength9um, portSecurityMacAddr3=portSecurityMacAddr3, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portErrorCounter=portErrorCounter, adminSwitchVlanTableMode=adminSwitchVlanTableMode, infoManufactureDate=infoManufactureDate, sfpInfoPartNumber=sfpInfoPartNumber, infoPowerVoltage2500=infoPowerVoltage2500, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit)
