...
mibBuilder.exportSymbols("NEXANS-BM-MIB", adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, infoLastTftpMessage=infoLastTftpMessage, portSecurityMacAddr3=portSecurityMacAddr3, sfpInfoLength9um=sfpInfoLength9um, portSecurityMacAddr2=portSecurityMacAddr2, portName=portName, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portBandwidthLimitRxd=portBandwidthLimitRxd, portNewMacAddress=portNewMacAddress, radiusMgmtAuthReject=radiusMgmtAuthReject, infoNewMacAddr=infoNewMacAddr, portLEDGreen=portLEDGreen, bmSwitchVlan=bmSwitchVlan, infoAlarmStateM2=infoAlarmStateM2, portRemoteFault=portRemoteFault, sfpDiagRxIntputPower=sfpDiagRxIntputPower, adminMemoryCardMode=adminMemoryCardMode, sfpInfoBitRate=sfpInfoBitRate, switchConfigurationChanged=switchConfigurationChanged, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, tftpMessage=tftpMessage, infoSerie=infoSerie, portLinkType=portLinkType, adminAgentDhcp=adminAgentDhcp, portIndex=portIndex, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portPrioIp=portPrioIp, infoPowerVoltage3300=infoPowerVoltage3300, bmSwitchMIB=bmSwitchMIB, infoType=infoType, infoPowerVoltage2500=infoPowerVoltage2500, switchPoeVoltageFailure=switchPoeVoltageFailure, portSecurityForwardingState=portSecurityForwardingState, portPrioDot1p=portPrioDot1p, portDescr=portDescr, sfpState=sfpState, sfpInfoVendorName=sfpInfoVendorName, portPoeCurrent=portPoeCurrent, adminTftpAccess=adminTftpAccess, bmTraps=bmTraps, vlanDescr=vlanDescr, infoUnauthIpAddr=infoUnauthIpAddr, sfpInfoDateCode=sfpInfoDateCode, portErrorCountFailure=portErrorCountFailure, infoDescr=infoDescr, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portErrorCounter=portErrorCounter, adminAlarmNameM2=adminAlarmNameM2, portPoePower=portPoePower, infoNoOfReboots=infoNoOfReboots, radiusPortSecurityReject=radiusPortSecurityReject, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portLimiterPacketType=portLimiterPacketType, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpDiagTemperature=sfpDiagTemperature, portLinkChange=portLinkChange, switchMgmtAuthFailure=switchMgmtAuthFailure, portPoeOverloadFailure=portPoeOverloadFailure, infoFunctionInputStateF1=infoFunctionInputStateF1, bmSwitchVlanTable=bmSwitchVlanTable, clientRemoved=clientRemoved, bmSwitchSfpEntry=bmSwitchSfpEntry, portLEDYellow=portLEDYellow, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portAcApSetup=portAcApSetup, infoSwitchHardwareVersion=infoSwitchHardwareVersion, sfpInfoPartNumber=sfpInfoPartNumber, adminReset=adminReset, infoSeriesNo=infoSeriesNo, sfpPortIndex=sfpPortIndex, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portErrorDisabled=portErrorDisabled, infoLastSfpEventMessage=infoLastSfpEventMessage, portLoopBcastFailure=portLoopBcastFailure, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoTotalConfigChanges=infoTotalConfigChanges, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, infoSecurityFailMacAddr=infoSecurityFailMacAddr, internalMgmtWarning=internalMgmtWarning, infoMgmtHardwareVersion=infoMgmtHardwareVersion, adminAlarmNameM1=adminAlarmNameM1, adminUnsecureVlanId=adminUnsecureVlanId, adminAgentVlanId=adminAgentVlanId, sfpInfoLength62um=sfpInfoLength62um, sfpInfoConnectorDescr=sfpInfoConnectorDescr, sfpDiagTxOutputPower=sfpDiagTxOutputPower, sfpInfoSerialNumber=sfpInfoSerialNumber, portLinkState=portLinkState, portVoiceVlanId=portVoiceVlanId, adminSwitchVlanTableMode=adminSwitchVlanTableMode, adminAgentPhysAddress=adminAgentPhysAddress, adminSnmpMacTableMode=adminSnmpMacTableMode, portPoePowerLimit=portPoePowerLimit, switchFunctionInputAlarm=switchFunctionInputAlarm, adminAgentNetmask=adminAgentNetmask, adminMgmtAccessList=adminMgmtAccessList, adminAlarmM1=adminAlarmM1, switchIndustrialAlarmM2=switchIndustrialAlarmM2, PYSNMP_MODULE_ID=bmSwitchMIB, vlanIndex=vlanIndex, switchPoeOverloadFailure=switchPoeOverloadFailure, portTrunkingMode=portTrunkingMode, bmSwitchSfp=bmSwitchSfp, infoAlarmStateM1=infoAlarmStateM1, portPoeAdminState=portPoeAdminState, adminSwitchPortMirror=adminSwitchPortMirror, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, switchInternalVoltageFailure=switchInternalVoltageFailure, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, portSecurityFailure=portSecurityFailure, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portSecurityAdminState=portSecurityAdminState, bmSwitchVlanEntry=bmSwitchVlanEntry, infoManufactureDate=infoManufactureDate, sfpInfoLength50um=sfpInfoLength50um, infoNoOfPorts=infoNoOfPorts, adminLedGlobalMode=adminLedGlobalMode, bmSwitchPortEntry=bmSwitchPortEntry, bmSwitchPortTable=bmSwitchPortTable, bmSwitchInfo=bmSwitchInfo, bmSwitchPort=bmSwitchPort, adminAlarmM2=adminAlarmM2, sfpInfoWavelength=sfpInfoWavelength, vlanId=vlanId, portDefaultVlanId=portDefaultVlanId, infoProductNo=infoProductNo, portDefaultPrioQueue=portDefaultPrioQueue, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portAdminState=portAdminState, adminFunctionInputNameF1=adminFunctionInputNameF1, infoPoeInputPower=infoPoeInputPower, adminAgentPrioValue=adminAgentPrioValue, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portSpeedDuplexSetup=portSpeedDuplexSetup, bmSwitchAdmin=bmSwitchAdmin, portPoeVoltage=portPoeVoltage, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, sfpEvent=sfpEvent, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, bmSwitchSfpTable=bmSwitchSfpTable, infoPoeInputVoltage=infoPoeInputVoltage, adminAgentIpAddress=adminAgentIpAddress, switchTemperatureFailure=switchTemperatureFailure, portSecurityMacAddr1=portSecurityMacAddr1, infoTemperature=infoTemperature)
