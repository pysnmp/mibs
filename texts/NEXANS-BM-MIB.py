...
ObjectIdentity, MibIdentifier, NotificationType, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Bits, Unsigned32, Gauge32, Counter32, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "NotificationType", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Bits", "Unsigned32", "Gauge32", "Counter32", "Counter64", "iso")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", vlanIndex=vlanIndex, adminAgentDhcp=adminAgentDhcp, adminLedGlobalMode=adminLedGlobalMode, portErrorCounter=portErrorCounter, portAcApSetup=portAcApSetup, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminAgentNetmask=adminAgentNetmask, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, adminAgentPhysAddress=adminAgentPhysAddress, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portPrioDot1p=portPrioDot1p, adminReset=adminReset, sfpPortIndex=sfpPortIndex, portBandwidthLimitRxd=portBandwidthLimitRxd, adminSnmpMacTableMode=adminSnmpMacTableMode, infoTemperature=infoTemperature, bmSwitchVlanEntry=bmSwitchVlanEntry, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminAlarmNameM2=adminAlarmNameM2, portLinkType=portLinkType, adminAlarmNameM1=adminAlarmNameM1, bmSwitchSfpTable=bmSwitchSfpTable, radiusMgmtAuthReject=radiusMgmtAuthReject, adminAgentVlanId=adminAgentVlanId, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, sfpInfoVendorName=sfpInfoVendorName, clientRemoved=clientRemoved, infoFunctionInputStateF1=infoFunctionInputStateF1, portIndex=portIndex, portDescr=portDescr, vlanId=vlanId, bmSwitchPort=bmSwitchPort, sfpInfoLength9um=sfpInfoLength9um, bmSwitchPortTable=bmSwitchPortTable, sfpInfoWavelength=sfpInfoWavelength, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, bmSwitchVlanTable=bmSwitchVlanTable, portDefaultPrioQueue=portDefaultPrioQueue, sfpInfoPartNumber=sfpInfoPartNumber, portPoeAdminState=portPoeAdminState, portSecurityMacAddr2=portSecurityMacAddr2, portAdminState=portAdminState, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, infoManufactureDate=infoManufactureDate, infoProductNo=infoProductNo, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, bmSwitchInfo=bmSwitchInfo, adminFunctionInputNameF1=adminFunctionInputNameF1, sfpInfoDateCode=sfpInfoDateCode, infoSecurityFailMacAddr=infoSecurityFailMacAddr, bmSwitchPortEntry=bmSwitchPortEntry, portSecurityForwardingState=portSecurityForwardingState, infoLastTftpMessage=infoLastTftpMessage, tftpMessage=tftpMessage, infoSerie=infoSerie, PYSNMP_MODULE_ID=bmSwitchMIB, portSecurityMacAddr1=portSecurityMacAddr1, adminUnsecureVlanId=adminUnsecureVlanId, infoPowerVoltage2500=infoPowerVoltage2500, bmTraps=bmTraps, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpDiagTemperature=sfpDiagTemperature, portRemoteFault=portRemoteFault, sfpInfoLength50um=sfpInfoLength50um, portLinkChange=portLinkChange, portBandwidthLimitTxd=portBandwidthLimitTxd, infoNoOfPorts=infoNoOfPorts, adminMgmtAccessList=adminMgmtAccessList, portLEDYellow=portLEDYellow, portPrioIp=portPrioIp, bmSwitchSfp=bmSwitchSfp, sfpInfoLength62um=sfpInfoLength62um, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, infoType=infoType, infoTotalConfigChanges=infoTotalConfigChanges, portSecurityMacAddr3=portSecurityMacAddr3, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portLoopBcastFailure=portLoopBcastFailure, adminSwitchPortMirror=adminSwitchPortMirror, portPoeVoltage=portPoeVoltage, switchPoeOverloadFailure=switchPoeOverloadFailure, infoAlarmStateM2=infoAlarmStateM2, infoAlarmStateM1=infoAlarmStateM1, portLimiterPacketType=portLimiterPacketType, portVoiceVlanId=portVoiceVlanId, switchPoeVoltageFailure=switchPoeVoltageFailure, sfpInfoConnectorDescr=sfpInfoConnectorDescr, portSecurityFailure=portSecurityFailure, adminAlarmM1=adminAlarmM1, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminMemoryCardMode=adminMemoryCardMode, infoNoOfReboots=infoNoOfReboots, adminTftpAccess=adminTftpAccess, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, portDefaultVlanId=portDefaultVlanId, portNewMacAddress=portNewMacAddress, portSecurityAdminState=portSecurityAdminState, infoLastSfpEventMessage=infoLastSfpEventMessage, portPoePower=portPoePower, switchMgmtAuthFailure=switchMgmtAuthFailure, switchTemperatureFailure=switchTemperatureFailure, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, switchIndustrialAlarmM1=switchIndustrialAlarmM1, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, portTrunkingMode=portTrunkingMode, radiusPortSecurityReject=radiusPortSecurityReject, adminSwitchVlanTableMode=adminSwitchVlanTableMode, sfpDiagRxIntputPower=sfpDiagRxIntputPower, vlanDescr=vlanDescr, portPoePowerLimit=portPoePowerLimit, sfpInfoBitRate=sfpInfoBitRate, adminAlarmM2=adminAlarmM2, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portErrorDisabled=portErrorDisabled, portLEDGreen=portLEDGreen, infoUnauthIpAddr=infoUnauthIpAddr, switchFunctionInputAlarm=switchFunctionInputAlarm, switchConfigurationChanged=switchConfigurationChanged, sfpInfoSerialNumber=sfpInfoSerialNumber, sfpState=sfpState, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portErrorCountFailure=portErrorCountFailure, internalMgmtWarning=internalMgmtWarning, infoPoeInputVoltage=infoPoeInputVoltage, portPoeCurrent=portPoeCurrent, switchInternalVoltageFailure=switchInternalVoltageFailure, infoPoeInputPower=infoPoeInputPower, portPoeOverloadFailure=portPoeOverloadFailure, bmSwitchVlan=bmSwitchVlan, bmSwitchMIB=bmSwitchMIB, infoNewMacAddr=infoNewMacAddr, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpEvent=sfpEvent, portName=portName, adminAgentIpAddress=adminAgentIpAddress, infoSeriesNo=infoSeriesNo, bmSwitchAdmin=bmSwitchAdmin, infoDescr=infoDescr, adminAgentPrioValue=adminAgentPrioValue, infoPowerVoltage3300=infoPowerVoltage3300, portLinkState=portLinkState)
