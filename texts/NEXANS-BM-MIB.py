...
ObjectIdentity, iso, Integer32, Gauge32, ModuleIdentity, NotificationType, Counter32, Counter64, TimeTicks, MibIdentifier, Unsigned32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Integer32", "Gauge32", "ModuleIdentity", "NotificationType", "Counter32", "Counter64", "TimeTicks", "MibIdentifier", "Unsigned32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", portRemoteFault=portRemoteFault, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, switchPoeOverloadFailure=switchPoeOverloadFailure, bmSwitchSfp=bmSwitchSfp, sfpInfoBitRate=sfpInfoBitRate, infoPowerVoltage2500=infoPowerVoltage2500, adminAgentNetmask=adminAgentNetmask, portBandwidthLimitTxd=portBandwidthLimitTxd, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, adminFunctionInputNameF1=adminFunctionInputNameF1, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoAlarmStateM2=infoAlarmStateM2, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portPoeAdminState=portPoeAdminState, sfpInfoSerialNumber=sfpInfoSerialNumber, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, vlanDescr=vlanDescr, portLinkChange=portLinkChange, bmSwitchMIB=bmSwitchMIB, switchMgmtAuthFailure=switchMgmtAuthFailure, portErrorCountFailure=portErrorCountFailure, adminAlarmM1=adminAlarmM1, portErrorDisabled=portErrorDisabled, adminMgmtAccessList=adminMgmtAccessList, adminAlarmNameM2=adminAlarmNameM2, adminSnmpMacTableMode=adminSnmpMacTableMode, portDescr=portDescr, portPoeVoltage=portPoeVoltage, adminMemoryCardMode=adminMemoryCardMode, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoSerie=infoSerie, sfpInfoWavelength=sfpInfoWavelength, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpInfoRevisionNumber=sfpInfoRevisionNumber, infoAlarmStateM1=infoAlarmStateM1, infoNoOfReboots=infoNoOfReboots, adminAlarmM2=adminAlarmM2, adminUnsecureVlanId=adminUnsecureVlanId, portBandwidthLimitRxd=portBandwidthLimitRxd, infoPoeInputVoltage=infoPoeInputVoltage, switchConfigurationChanged=switchConfigurationChanged, infoUnauthIpAddr=infoUnauthIpAddr, bmSwitchAdmin=bmSwitchAdmin, portPoePowerLimit=portPoePowerLimit, infoPoeInputPower=infoPoeInputPower, bmSwitchSfpTable=bmSwitchSfpTable, sfpInfoVendorName=sfpInfoVendorName, portErrorCounter=portErrorCounter, infoDescr=infoDescr, portLoopBcastFailure=portLoopBcastFailure, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portAdminState=portAdminState, infoFunctionInputStateF1=infoFunctionInputStateF1, sfpInfoDateCode=sfpInfoDateCode, adminAgentDhcp=adminAgentDhcp, adminReset=adminReset, portPoeOverloadFailure=portPoeOverloadFailure, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoNewMacAddr=infoNewMacAddr, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, switchIndustrialAlarmM1=switchIndustrialAlarmM1, switchFunctionInputAlarm=switchFunctionInputAlarm, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, infoSeriesNo=infoSeriesNo, portNewMacAddress=portNewMacAddress, infoPowerVoltage3300=infoPowerVoltage3300, tftpMessage=tftpMessage, portSecurityAdminState=portSecurityAdminState, portTrunkingMode=portTrunkingMode, sfpState=sfpState, adminAgentIpAddress=adminAgentIpAddress, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, portPrioIp=portPrioIp, infoNoOfPorts=infoNoOfPorts, infoSecurityFailMacAddr=infoSecurityFailMacAddr, adminTftpAccess=adminTftpAccess, switchInternalVoltageFailure=switchInternalVoltageFailure, portVoiceVlanId=portVoiceVlanId, adminAgentPhysAddress=adminAgentPhysAddress, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portLEDYellow=portLEDYellow, infoProductNo=infoProductNo, adminSwitchPortMirror=adminSwitchPortMirror, sfpInfoLength62um=sfpInfoLength62um, portSecurityFailure=portSecurityFailure, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portSecurityMacAddr3=portSecurityMacAddr3, portSecurityMacAddr2=portSecurityMacAddr2, portLimiterPacketType=portLimiterPacketType, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, switchTemperatureFailure=switchTemperatureFailure, vlanId=vlanId, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, bmSwitchPortEntry=bmSwitchPortEntry, portDefaultVlanId=portDefaultVlanId, sfpInfoLength9um=sfpInfoLength9um, radiusMgmtAuthReject=radiusMgmtAuthReject, infoType=infoType, portName=portName, adminAgentPrioValue=adminAgentPrioValue, bmSwitchSfpEntry=bmSwitchSfpEntry, PYSNMP_MODULE_ID=bmSwitchMIB, sfpDiagRxIntputPower=sfpDiagRxIntputPower, vlanIndex=vlanIndex, adminLedGlobalMode=adminLedGlobalMode, bmSwitchVlanEntry=bmSwitchVlanEntry, bmSwitchVlan=bmSwitchVlan, bmTraps=bmTraps, bmSwitchPortTable=bmSwitchPortTable, portLinkState=portLinkState, portLEDGreen=portLEDGreen, infoLastTftpMessage=infoLastTftpMessage, portSecurityMacAddr1=portSecurityMacAddr1, portPoeCurrent=portPoeCurrent, portSecurityForwardingState=portSecurityForwardingState, sfpEvent=sfpEvent, sfpDiagTemperature=sfpDiagTemperature, bmSwitchInfo=bmSwitchInfo, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoTemperature=infoTemperature, infoManufactureDate=infoManufactureDate, portPrioDot1p=portPrioDot1p, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoLastSfpEventMessage=infoLastSfpEventMessage, bmSwitchVlanTable=bmSwitchVlanTable, portDefaultPrioQueue=portDefaultPrioQueue, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, portIndex=portIndex, clientRemoved=clientRemoved, portPoePower=portPoePower, infoSwitchHardwareVersion=infoSwitchHardwareVersion, internalMgmtWarning=internalMgmtWarning, portLinkType=portLinkType, radiusPortSecurityReject=radiusPortSecurityReject, sfpPortIndex=sfpPortIndex, adminAgentVlanId=adminAgentVlanId, switchPoeVoltageFailure=switchPoeVoltageFailure, infoTotalConfigChanges=infoTotalConfigChanges, adminAlarmNameM1=adminAlarmNameM1, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portAcApSetup=portAcApSetup, sfpInfoPartNumber=sfpInfoPartNumber, sfpInfoLength50um=sfpInfoLength50um, bmSwitchPort=bmSwitchPort)
