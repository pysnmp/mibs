...
Integer32, IpAddress, ObjectIdentity, MibIdentifier, ModuleIdentity, Unsigned32, Counter64, Gauge32, TimeTicks, Bits, Counter32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Counter64", "Gauge32", "TimeTicks", "Bits", "Counter32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", adminMgmtAccessList=adminMgmtAccessList, portSecurityForwardingState=portSecurityForwardingState, portLinkType=portLinkType, portErrorCountFailure=portErrorCountFailure, sfpInfoDateCode=sfpInfoDateCode, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, portDefaultPrioQueue=portDefaultPrioQueue, infoProductNo=infoProductNo, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpEvent=sfpEvent, adminSwitchVlanTableMode=adminSwitchVlanTableMode, infoFunctionInputStateF1=infoFunctionInputStateF1, infoUnauthIpAddr=infoUnauthIpAddr, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpInfoSerialNumber=sfpInfoSerialNumber, portName=portName, sfpDiagTemperature=sfpDiagTemperature, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminTftpAccess=adminTftpAccess, adminAlarmM2=adminAlarmM2, sfpInfoPartNumber=sfpInfoPartNumber, portVoiceVlanId=portVoiceVlanId, portRemoteFault=portRemoteFault, portPoeOverloadFailure=portPoeOverloadFailure, portSecurityAdminState=portSecurityAdminState, sfpInfoRevisionNumber=sfpInfoRevisionNumber, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portErrorCounter=portErrorCounter, infoTotalConfigChanges=infoTotalConfigChanges, bmSwitchPortEntry=bmSwitchPortEntry, portErrorDisabled=portErrorDisabled, switchFunctionInputAlarm=switchFunctionInputAlarm, sfpInfoLength9um=sfpInfoLength9um, bmSwitchSfp=bmSwitchSfp, tftpMessage=tftpMessage, portSecurityMacAddr2=portSecurityMacAddr2, infoPoeInputPower=infoPoeInputPower, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, adminUnsecureVlanId=adminUnsecureVlanId, portAcApSetup=portAcApSetup, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, bmTraps=bmTraps, adminAgentIpAddress=adminAgentIpAddress, adminAlarmM1=adminAlarmM1, adminFunctionInputNameF1=adminFunctionInputNameF1, adminAgentPhysAddress=adminAgentPhysAddress, sfpInfoWavelength=sfpInfoWavelength, infoSerie=infoSerie, infoLastTftpMessage=infoLastTftpMessage, portSecurityMacAddr3=portSecurityMacAddr3, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, adminAlarmNameM1=adminAlarmNameM1, radiusMgmtAuthReject=radiusMgmtAuthReject, infoSeriesNo=infoSeriesNo, infoPowerVoltage3300=infoPowerVoltage3300, portIndex=portIndex, portLimiterPacketType=portLimiterPacketType, sfpPortIndex=sfpPortIndex, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, switchMgmtAuthFailure=switchMgmtAuthFailure, sfpInfoLength62um=sfpInfoLength62um, adminSnmpMacTableMode=adminSnmpMacTableMode, infoPowerVoltage2500=infoPowerVoltage2500, radiusPortSecurityReject=radiusPortSecurityReject, adminAlarmNameM2=adminAlarmNameM2, switchInternalVoltageFailure=switchInternalVoltageFailure, vlanIndex=vlanIndex, infoAlarmStateM2=infoAlarmStateM2, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, portTrunkingMode=portTrunkingMode, adminAgentDhcp=adminAgentDhcp, infoNoOfPorts=infoNoOfPorts, sfpInfoVendorName=sfpInfoVendorName, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, portBandwidthLimitTxd=portBandwidthLimitTxd, portNewMacAddress=portNewMacAddress, portPrioDot1p=portPrioDot1p, portLinkState=portLinkState, infoLastSfpEventMessage=infoLastSfpEventMessage, adminMemoryCardMode=adminMemoryCardMode, bmSwitchSfpEntry=bmSwitchSfpEntry, sfpDiagTxOutputPower=sfpDiagTxOutputPower, vlanDescr=vlanDescr, adminAgentNetmask=adminAgentNetmask, portLEDYellow=portLEDYellow, portAdminState=portAdminState, bmSwitchVlanTable=bmSwitchVlanTable, portSecurityMacAddr1=portSecurityMacAddr1, sfpInfoConnectorDescr=sfpInfoConnectorDescr, adminAgentVlanId=adminAgentVlanId, portPoePowerLimit=portPoePowerLimit, infoTemperature=infoTemperature, portSecurityFailure=portSecurityFailure, portLinkChange=portLinkChange, PYSNMP_MODULE_ID=bmSwitchMIB, vlanId=vlanId, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, portPoePower=portPoePower, infoNoOfReboots=infoNoOfReboots, infoDescr=infoDescr, infoAlarmStateM1=infoAlarmStateM1, portBandwidthLimitRxd=portBandwidthLimitRxd, bmSwitchMIB=bmSwitchMIB, portPoeVoltage=portPoeVoltage, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portLEDGreen=portLEDGreen, switchPoeVoltageFailure=switchPoeVoltageFailure, portDescr=portDescr, bmSwitchInfo=bmSwitchInfo, clientRemoved=clientRemoved, bmSwitchAdmin=bmSwitchAdmin, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, sfpState=sfpState, bmSwitchSfpTable=bmSwitchSfpTable, bmSwitchPortTable=bmSwitchPortTable, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminReset=adminReset, infoMgmtHardwareVersion=infoMgmtHardwareVersion, sfpInfoBitRate=sfpInfoBitRate, switchTemperatureFailure=switchTemperatureFailure, adminAgentPrioValue=adminAgentPrioValue, bmSwitchVlanEntry=bmSwitchVlanEntry, portPrioIp=portPrioIp, infoManufactureDate=infoManufactureDate, portLoopBcastFailure=portLoopBcastFailure, switchPoeOverloadFailure=switchPoeOverloadFailure, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, infoPoeInputVoltage=infoPoeInputVoltage, internalMgmtWarning=internalMgmtWarning, portPoeCurrent=portPoeCurrent, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminSwitchPortMirror=adminSwitchPortMirror, infoType=infoType, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoNewMacAddr=infoNewMacAddr, sfpInfoLength50um=sfpInfoLength50um, portPoeAdminState=portPoeAdminState, switchConfigurationChanged=switchConfigurationChanged, bmSwitchVlan=bmSwitchVlan, adminLedGlobalMode=adminLedGlobalMode, bmSwitchPort=bmSwitchPort, portDefaultVlanId=portDefaultVlanId)
