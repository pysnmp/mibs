...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, MibIdentifier, Bits, Counter64, iso, ObjectIdentity, Integer32, NotificationType, TimeTicks, Unsigned32, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "MibIdentifier", "Bits", "Counter64", "iso", "ObjectIdentity", "Integer32", "NotificationType", "TimeTicks", "Unsigned32", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("NEXANS-BM-MIB", infoType=infoType, adminAlarmM1=adminAlarmM1, portDefaultVlanId=portDefaultVlanId, adminAgentIpAddress=adminAgentIpAddress, bmSwitchMIB=bmSwitchMIB, switchInternalVoltageFailure=switchInternalVoltageFailure, infoSerie=infoSerie, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portTrunkingMode=portTrunkingMode, portLimiterPacketType=portLimiterPacketType, vlanId=vlanId, tftpMessage=tftpMessage, infoSwitchHardwareVersion=infoSwitchHardwareVersion, adminAgentDhcp=adminAgentDhcp, infoPowerVoltage3300=infoPowerVoltage3300, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, adminAlarmNameM1=adminAlarmNameM1, sfpInfoDateCode=sfpInfoDateCode, portBandwidthLimitRxd=portBandwidthLimitRxd, portErrorCounter=portErrorCounter, adminAgentVlanId=adminAgentVlanId, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, bmTraps=bmTraps, portErrorCountFailure=portErrorCountFailure, sfpInfoBitRate=sfpInfoBitRate, bmSwitchSfpEntry=bmSwitchSfpEntry, portLinkState=portLinkState, sfpDiagTxOutputPower=sfpDiagTxOutputPower, portDescr=portDescr, switchConfigurationChanged=switchConfigurationChanged, sfpInfoConnectorDescr=sfpInfoConnectorDescr, switchMgmtAuthFailure=switchMgmtAuthFailure, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, bmSwitchVlanTable=bmSwitchVlanTable, portPoePower=portPoePower, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, bmSwitchInfo=bmSwitchInfo, infoProductNo=infoProductNo, portSecurityForwardingState=portSecurityForwardingState, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portIndex=portIndex, sfpInfoVendorName=sfpInfoVendorName, bmSwitchSfp=bmSwitchSfp, switchTemperatureFailure=switchTemperatureFailure, adminMemoryCardMode=adminMemoryCardMode, portName=portName, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, portPoeAdminState=portPoeAdminState, infoPoeInputVoltage=infoPoeInputVoltage, portErrorDisabled=portErrorDisabled, adminMgmtAccessList=adminMgmtAccessList, infoSeriesNo=infoSeriesNo, portLEDYellow=portLEDYellow, switchIndustrialAlarmM1=switchIndustrialAlarmM1, radiusPortSecurityReject=radiusPortSecurityReject, bmSwitchPortTable=bmSwitchPortTable, infoPowerVoltage2500=infoPowerVoltage2500, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, portNewMacAddress=portNewMacAddress, sfpDiagTemperature=sfpDiagTemperature, switchPoeVoltageFailure=switchPoeVoltageFailure, infoUnauthIpAddr=infoUnauthIpAddr, adminAlarmNameM2=adminAlarmNameM2, sfpInfoSerialNumber=sfpInfoSerialNumber, portAcApSetup=portAcApSetup, adminReset=adminReset, PYSNMP_MODULE_ID=bmSwitchMIB, infoMgmtHardwareVersion=infoMgmtHardwareVersion, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portPoeOverloadFailure=portPoeOverloadFailure, infoPoeInputPower=infoPoeInputPower, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, switchIndustrialAlarmM2=switchIndustrialAlarmM2, adminFunctionInputNameF1=adminFunctionInputNameF1, adminTftpAccess=adminTftpAccess, infoNewMacAddr=infoNewMacAddr, infoFunctionInputStateF1=infoFunctionInputStateF1, portDefaultPrioQueue=portDefaultPrioQueue, infoTemperature=infoTemperature, adminLedGlobalMode=adminLedGlobalMode, portSecurityFailure=portSecurityFailure, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, infoSecurityFailMacAddr=infoSecurityFailMacAddr, sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, switchPoeOverloadFailure=switchPoeOverloadFailure, sfpState=sfpState, infoNoOfReboots=infoNoOfReboots, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, infoAlarmStateM1=infoAlarmStateM1, sfpInfoLength50um=sfpInfoLength50um, adminSnmpMacTableMode=adminSnmpMacTableMode, bmSwitchVlan=bmSwitchVlan, portPoeVoltage=portPoeVoltage, adminAlarmM2=adminAlarmM2, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, clientRemoved=clientRemoved, bmSwitchPortEntry=bmSwitchPortEntry, adminAgentNetmask=adminAgentNetmask, portSecurityMacAddr1=portSecurityMacAddr1, sfpInfoWavelength=sfpInfoWavelength, adminAgentPhysAddress=adminAgentPhysAddress, infoManufactureDate=infoManufactureDate, portAdminState=portAdminState, portLEDGreen=portLEDGreen, bmSwitchPort=bmSwitchPort, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, vlanDescr=vlanDescr, infoLastSfpEventMessage=infoLastSfpEventMessage, portPrioIp=portPrioIp, portLoopBcastFailure=portLoopBcastFailure, sfpInfoPartNumber=sfpInfoPartNumber, portBandwidthLimitTxd=portBandwidthLimitTxd, portSecurityMacAddr2=portSecurityMacAddr2, portPoeCurrent=portPoeCurrent, portPrioDot1p=portPrioDot1p, infoDescr=infoDescr, portLinkChange=portLinkChange, portPoePowerLimit=portPoePowerLimit, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, radiusMgmtAuthReject=radiusMgmtAuthReject, adminUnsecureVlanId=adminUnsecureVlanId, sfpInfoRevisionNumber=sfpInfoRevisionNumber, portSecurityAdminState=portSecurityAdminState, portRemoteFault=portRemoteFault, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portSecurityMacAddr3=portSecurityMacAddr3, sfpPortIndex=sfpPortIndex, portVoiceVlanId=portVoiceVlanId, internalMgmtWarning=internalMgmtWarning, infoLastTftpMessage=infoLastTftpMessage, portLinkType=portLinkType, adminSwitchPortMirror=adminSwitchPortMirror, portSpeedDuplexSetup=portSpeedDuplexSetup, sfpInfoLength62um=sfpInfoLength62um, bmSwitchAdmin=bmSwitchAdmin, adminAgentPrioValue=adminAgentPrioValue, sfpInfoLength9um=sfpInfoLength9um, infoAlarmStateM2=infoAlarmStateM2, sfpEvent=sfpEvent, switchFunctionInputAlarm=switchFunctionInputAlarm, infoNoOfPorts=infoNoOfPorts, bmSwitchVlanEntry=bmSwitchVlanEntry, vlanIndex=vlanIndex, bmSwitchSfpTable=bmSwitchSfpTable, infoTotalConfigChanges=infoTotalConfigChanges)
