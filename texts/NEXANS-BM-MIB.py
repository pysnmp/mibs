...
mibBuilder.exportSymbols("NEXANS-BM-MIB", sfpAlarmTxOutputPowerLowerLimit=sfpAlarmTxOutputPowerLowerLimit, infoTemperatureMaxAllowed=infoTemperatureMaxAllowed, adminAlarmNameM2=adminAlarmNameM2, portPoeVoltage=portPoeVoltage, portLinkType=portLinkType, bmSwitchVlanTable=bmSwitchVlanTable, infoSerie=infoSerie, portErrorCounter=portErrorCounter, bmSwitchVlanEntry=bmSwitchVlanEntry, switchPoeOverloadFailure=switchPoeOverloadFailure, vlanDescr=vlanDescr, bmSwitchInfo=bmSwitchInfo, sfpDiagRxInputPowerDbm=sfpDiagRxInputPowerDbm, portVoiceVlanId=portVoiceVlanId, portLinkChange=portLinkChange, adminAgentVlanId=adminAgentVlanId, portLEDGreen=portLEDGreen, adminAgentPhysAddress=adminAgentPhysAddress, sfpState=sfpState, portDescr=portDescr, sfpInfoPartNumber=sfpInfoPartNumber, vlanId=vlanId, infoSecurityFailMacAddr=infoSecurityFailMacAddr, portSecurityMacAddr2=portSecurityMacAddr2, sfpInfoVendorName=sfpInfoVendorName, adminAgentNetmask=adminAgentNetmask, portLimiterPacketType=portLimiterPacketType, bmSwitchMIB=bmSwitchMIB, bmTraps=bmTraps, switchInternalVoltageFailure=switchInternalVoltageFailure, portPoeAdminState=portPoeAdminState, portSecurityMacAddr3=portSecurityMacAddr3, switchIndustrialAlarmM2=switchIndustrialAlarmM2, infoMgmtFirmwareVersion=infoMgmtFirmwareVersion, vlanIndex=vlanIndex, infoType=infoType, infoSwitchHardwareVersion=infoSwitchHardwareVersion, portSpeedDuplexSetup=portSpeedDuplexSetup, adminFunctionInputNameF1=adminFunctionInputNameF1, portBandwidthLimitTxd=portBandwidthLimitTxd, infoProductNo=infoProductNo, portDefaultPrioQueue=portDefaultPrioQueue, switchIndustrialAlarmM1=switchIndustrialAlarmM1, portPoeOverloadFailure=portPoeOverloadFailure, radiusPortSecurityReject=radiusPortSecurityReject, infoUnauthIpAddr=infoUnauthIpAddr, switchFunctionInputAlarm=switchFunctionInputAlarm, adminUnsecureVlanId=adminUnsecureVlanId, portSecurityMacAddr1=portSecurityMacAddr1, infoPowerVoltage2500=infoPowerVoltage2500, adminAgentDhcp=adminAgentDhcp, adminAlarmNameM1=adminAlarmNameM1, sfpDiagTemperature=sfpDiagTemperature, internalMgmtWarning=internalMgmtWarning, portErrorCountFailure=portErrorCountFailure, switchConfigurationChanged=switchConfigurationChanged, adminMemoryCardMode=adminMemoryCardMode, sfpInfoLength9um=sfpInfoLength9um, bmSwitchPortEntry=bmSwitchPortEntry, bmSwitchVlan=bmSwitchVlan, adminDot1xAuthFailureVlanId=adminDot1xAuthFailureVlanId, sfpInfoLength50um=sfpInfoLength50um, infoNoOfPorts=infoNoOfPorts, bmSwitchPortTable=bmSwitchPortTable, infoNoOfReboots=infoNoOfReboots, sfpInfoSerialNumber=sfpInfoSerialNumber, adminLedGlobalMode=adminLedGlobalMode, infoMgmtHardwareVersion=infoMgmtHardwareVersion, portLoopBcastFailure=portLoopBcastFailure, sfpInfoRevisionNumber=sfpInfoRevisionNumber, sfpInfoLength62um=sfpInfoLength62um, adminSnmpMacTableMode=adminSnmpMacTableMode, sfpDiagTxBiasCurrent=sfpDiagTxBiasCurrent, adminTftpAccess=adminTftpAccess, bmSwitchAdmin=bmSwitchAdmin, portPoeCurrent=portPoeCurrent, portNewMacAddress=portNewMacAddress, adminReset=adminReset, clientRemoved=clientRemoved, infoAlarmStateM1=infoAlarmStateM1, switchTemperatureFailure=switchTemperatureFailure, infoLastTftpMessage=infoLastTftpMessage, portBandwidthLimitRxd=portBandwidthLimitRxd, sfpInfoConnectorDescr=sfpInfoConnectorDescr, infoPoeInputVoltage=infoPoeInputVoltage, portName=portName, portPrioDot1p=portPrioDot1p, portLEDYellow=portLEDYellow, portDot1qDefaultPrioValue=portDot1qDefaultPrioValue, adminSwitchPoEPowerLimit=adminSwitchPoEPowerLimit, bmSwitchSfpTable=bmSwitchSfpTable, sfpInfoBitRate=sfpInfoBitRate, infoLastSfpEventMessage=infoLastSfpEventMessage, portTrunkingMode=portTrunkingMode, adminAddrAgingTimeMinutes=adminAddrAgingTimeMinutes, portDefaultVlanId=portDefaultVlanId, portPrioIp=portPrioIp, adminAgentIpAddress=adminAgentIpAddress, sfpDiagRxIntputPower=sfpDiagRxIntputPower, portSecurityFailure=portSecurityFailure, infoLastInternalMgmtWarning=infoLastInternalMgmtWarning, tftpMessage=tftpMessage, portRemoteFault=portRemoteFault, portPoePowerLimit=portPoePowerLimit, portLinkState=portLinkState, adminMgmtAccessList=adminMgmtAccessList, sfpAlarmRxInputPowerLowerLimit=sfpAlarmRxInputPowerLowerLimit, adminSwitchPortMirror=adminSwitchPortMirror, bmSwitchPort=bmSwitchPort, portPoePower=portPoePower, sfpInfoDateCode=sfpInfoDateCode, switchPoeVoltageFailure=switchPoeVoltageFailure, infoPoeInputPower=infoPoeInputPower, portSecurityForwardingState=portSecurityForwardingState, sfpPortIndex=sfpPortIndex, sfpAlarmTxBiasCurrentUpperLimit=sfpAlarmTxBiasCurrentUpperLimit, adminAlarmM1=adminAlarmM1, portIndex=portIndex, infoTotalConfigChanges=infoTotalConfigChanges, adminAgentDefRouterIpAddress=adminAgentDefRouterIpAddress, sfpEvent=sfpEvent, sfpDiagTxOutputPowerDbm=sfpDiagTxOutputPowerDbm, PYSNMP_MODULE_ID=bmSwitchMIB, infoTemperature=infoTemperature, bmSwitchSfp=bmSwitchSfp, sfpDiagSupplyVoltage=sfpDiagSupplyVoltage, infoNewMacAddr=infoNewMacAddr, portAdminState=portAdminState, infoAlarmStateM2=infoAlarmStateM2, adminAgentDhcpServerIpAddress=adminAgentDhcpServerIpAddress, portSecurityAdminState=portSecurityAdminState, infoDescr=infoDescr, adminAlarmM2=adminAlarmM2, adminAgentPrioValue=adminAgentPrioValue, portAcApSetup=portAcApSetup, sfpInfoWavelength=sfpInfoWavelength, bmSwitchSfpEntry=bmSwitchSfpEntry, adminSwitchVlanTableMode=adminSwitchVlanTableMode, portActiveLoopDetectionFailure=portActiveLoopDetectionFailure, infoFunctionInputStateF1=infoFunctionInputStateF1, portErrorDisabled=portErrorDisabled, infoManufactureDate=infoManufactureDate, switchMgmtAuthFailure=switchMgmtAuthFailure, infoSeriesNo=infoSeriesNo, infoPowerVoltage3300=infoPowerVoltage3300, sfpDiagTxOutputPower=sfpDiagTxOutputPower, radiusMgmtAuthReject=radiusMgmtAuthReject)
