...
# ASN.1 source file:///home/runner/work/mibs/mibs/src/standard/APPN-MIB
...
ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, MibIdentifier, iso, ModuleIdentity, Gauge32, Counter64, IpAddress, Bits, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "MibIdentifier", "iso", "ModuleIdentity", "Gauge32", "Counter64", "IpAddress", "Bits", "TimeTicks", "Counter32")
DisplayString, TruthValue, VariablePointer, TextualConvention, TimeStamp, DateAndTime, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "VariablePointer", "TextualConvention", "TimeStamp", "DateAndTime", "RowPointer")
...
mibBuilder.exportSymbols("APPN-MIB", appnNnTgFRRsn=appnNnTgFRRsn, appnNnTgFRHprSup=appnNnTgFRHprSup, appnNnTopoConfGroup=appnNnTopoConfGroup, appnLsStatusTable=appnLsStatusTable, appnLocalEnTgEntryTimeLeft=appnLocalEnTgEntryTimeLeft, appnEnUniqueConfGroup=appnEnUniqueConfGroup, appnDirTableConfGroup2=appnDirTableConfGroup2, appnNodeHprIntRteSetups=appnNodeHprIntRteSetups, appnNnTgFRUsr3=appnNnTgFRUsr3, appnNodeNnIsrDepleted=appnNodeNnIsrDepleted, appnLsAdjCpName=appnLsAdjCpName, appnNnTgFRDestVirtual=appnNnTgFRDestVirtual, appnLsAdjNodeType=appnLsAdjNodeType, appnDirNotFoundLocates=appnDirNotFoundLocates, appnNnTgFRUsr1=appnNnTgFRUsr1, AppnTgDelay=AppnTgDelay, appnLsStatusGeneralSense=appnLsStatusGeneralSense, appnIsInP2SFmdBytes=appnIsInP2SFmdBytes, appnIsInP2SNonFmdPius=appnIsInP2SNonFmdPius, appnLocalEnTopoConfGroup2=appnLocalEnTopoConfGroup2, appnNnNodeFREntryTimeLeft=appnNnNodeFREntryTimeLeft, appnVrnInfo=appnVrnInfo, appnNnTgFRDestHprTrans=appnNnTgFRDestHprTrans, appnLocalTgDest=appnLocalTgDest, appnCosModeName=appnCosModeName, appnLsInXidFrames=appnLsInXidFrames, appnNnUniqueInfoAndCaps=appnNnUniqueInfoAndCaps, appnIsInPsSendRpc=appnIsInPsSendRpc, appnCosTgRowConnCostMin=appnCosTgRowConnCostMin, appnVrnName=appnVrnName, appnIsInFqCpName=appnIsInFqCpName, appnCosTgRowTable=appnCosTgRowTable, appnIsInTable=appnIsInTable, appnNodeNnSafeStoreFreq=appnNodeNnSafeStoreFreq, appnDirTableConfGroup=appnDirTableConfGroup, appnLocalEnTgDestVirtual=appnLocalEnTgDestVirtual, appnIsInPriLuName=appnIsInPriLuName, appnHprBfConfGroup=appnHprBfConfGroup, appnLocalEnTgEntry=appnLocalEnTgEntry, appnPortCommand=appnPortCommand, appnTraps=appnTraps, appnLinkConfGroup=appnLinkConfGroup, appnNnTgFRMltgLinkType=appnNnTgFRMltgLinkType, appnCosNodeRowResistMax=appnCosNodeRowResistMax, appnLsEchoRsps=appnLsEchoRsps, appnPortMaxIframeWindow=appnPortMaxIframeWindow, appnLsStatusCpName=appnLsStatusCpName, appnIsInS2PFmdBytes=appnIsInS2PFmdBytes, appnNodeNnGateway=appnNodeNnGateway, appnDirOutBcastLocates=appnDirOutBcastLocates, appnLocalEnTgUsr3=appnLocalEnTgUsr3, appnNnNodeFRGateway=appnNnNodeFRGateway, appnTrapConfGroup=appnTrapConfGroup, appnLsStatusEntry=appnLsStatusEntry, appnDirCurCaches=appnDirCurCaches, appnPortDefLsBadXids=appnPortDefLsBadXids, appnIsInTransPriority=appnIsInTransPriority, appnHprRtpConfGroup=appnHprRtpConfGroup, appnPortName=appnPortName, appnLocalEnTgTable=appnLocalEnTgTable, appnCosTgRowByteCostMin=appnCosTgRowByteCostMin, appnIsInSecLuName=appnIsInSecLuName, appnIsRtpTcid=appnIsRtpTcid, appnIsInGlobeCtrOperStatus=appnIsInGlobeCtrOperStatus, appnNnTopoConfGroup2=appnNnTopoConfGroup2, appnLsLocalAddr=appnLsLocalAddr, appnNnTopology=appnNnTopology, appnNnTgTopologyFRTable=appnNnTgTopologyFRTable, appnNnTopoTotalTduWars=appnNnTopoTotalTduWars, appnCosTgRowIndex=appnCosTgRowIndex, appnNodeHprEndRteRejects=appnNodeHprEndRteRejects, appnLsMaxSendBtuSize=appnLsMaxSendBtuSize, appnPortInformation=appnPortInformation, appnIsInPsSendMaxBtuSize=appnIsInPsSendMaxBtuSize, appnCompliance2=appnCompliance2, AppnLinkStationCounter=AppnLinkStationCounter, appnNodeHprIntRteRejects=appnNodeHprIntRteRejects, appnIsInGlobeRscv=appnIsInGlobeRscv, appnIsInSsSendPacingType=appnIsInSsSendPacingType, appnLsCpCpSessionSupport=appnLsCpCpSessionSupport, appnNnNodeFRHprSupport=appnNnNodeFRHprSupport, appnNodeNnCentralDirectory=appnNodeNnCentralDirectory, appnIsInGlobeHprBfActSess=appnIsInGlobeHprBfActSess, appnLocalTgEntry=appnLocalTgEntry, appnIsInSsAdjTgNum=appnIsInSsAdjTgNum, appnLocalTgEffCap=appnLocalTgEffCap, appnPortNegotLs=appnPortNegotLs, appnCosTgRowSecurityMax=appnCosTgRowSecurityMax, appnPortDynamicLinkSupport=appnPortDynamicLinkSupport, appnNnNodeFRFrsn=appnNnNodeFRFrsn, appnNodeNnTreeCache=appnNodeNnTreeCache, appnNnTgFRDelay=appnNnTgFRDelay, appnLsSpecific=appnLsSpecific, appnLsTgNum=appnLsTgNum, appnLocalTgHprSup=appnLocalTgHprSup, appnLsRevAnrLabel=appnLsRevAnrLabel, appnNnNodeFRIsr=appnNnNodeFRIsr, appnLsStatusRetry=appnLsStatusRetry, appnNnNodeFRGarbageCollect=appnNnNodeFRGarbageCollect, appnNnTgFRSubareaNum=appnNnTgFRSubareaNum, appnNnNodeFRRouteAddResist=appnNnNodeFRRouteAddResist, appnNnTgFRByteCost=appnNnTgFRByteCost, appnNodeCpName=appnNodeCpName, appnNodeNnPeriBorderSup=appnNodeNnPeriBorderSup, appnDirInLocates=appnDirInLocates, appnLsTable=appnLsTable, appnNodeMaxSessPerRtpConn=appnNodeMaxSessPerRtpConn, appnIsInModeName=appnIsInModeName, appnEnUniqueCaps=appnEnUniqueCaps, appnGroups=appnGroups, appnDirTable=appnDirTable, appnNnNodeFRIsrDepleted=appnNnNodeFRIsrDepleted, appnLsPartnerNodeId=appnLsPartnerNodeId, appnNodeType=appnNodeType, appnIsInPcid=appnIsInPcid, appnIsInGlobal=appnIsInGlobal, appnNnNodeFRRsn=appnNnNodeFRRsn, appnGeneralConfGroup2=appnGeneralConfGroup2, appnLsGoodXids=appnLsGoodXids, appnLocalTgConfGroup=appnLocalTgConfGroup, appnLocalTgUsr2=appnLocalTgUsr2, appnCosTgRowByteCostMax=appnCosTgRowByteCostMax, appnPortDynLsBadXids=appnPortDynLsBadXids, appnLocalTgByteCost=appnLocalTgByteCost, appnNnTopoMaxNodes=appnNnTopoMaxNodes, appnNnTgFRBranchTg=appnNnTgFRBranchTg, appnCosTgRowEffCapMin=appnCosTgRowEffCapMin, appnIsInS2PNonFmdBytes=appnIsInS2PNonFmdBytes, appnNodeMibVersion=appnNodeMibVersion, appnNnTopoTgPurges=appnNnTopoTgPurges, appnIsInPsAdjTgNum=appnIsInPsAdjTgNum, appnNnTgTopologyFREntry=appnNnTgTopologyFREntry, appnIsInGlobeRscvTime=appnIsInGlobeRscvTime, appnCosTgRowUsr2Min=appnCosTgRowUsr2Min, appnNodeId=appnNodeId, appnCos=appnCos, appnLocalEnTgEffCap=appnLocalEnTgEffCap, appnLsStatusLocalAddr=appnLsStatusLocalAddr, appnNodeHprEndRteSetups=appnNodeHprEndRteSetups, appnNnTgFRQuiescing=appnNnTgFRQuiescing, appnVrnEntry=appnVrnEntry, appnDir=appnDir, appnPortDlcType=appnPortDlcType, appnDirPerf=appnDirPerf, appnNodeEnModeCosMap=appnNodeEnModeCosMap, appnLsStatusEndSense=appnLsStatusEndSense, appnCosName=appnCosName, appnLocalTgMltgLinkType=appnLocalTgMltgLinkType, appnNnTopo=appnNnTopo, appnLsOutXidFrames=appnLsOutXidFrames, appnIsInPsRecvPacingType=appnIsInPsRecvPacingType, appnLsStatusXidLocalSense=appnLsStatusXidLocalSense, appnCosTgRowSecurityMin=appnCosTgRowSecurityMin, appnNnNodeFRBranchAwareness=appnNnNodeFRBranchAwareness, appnPortConfGroup=appnPortConfGroup, appnNnNodeFRQuiescing=appnNnNodeFRQuiescing, appnIsInS2PFmdPius=appnIsInS2PFmdPius, appnCosTgRowUsr1Min=appnCosTgRowUsr1Min, appnCosTgRowName=appnCosTgRowName, appnLsBadXids=appnLsBadXids, affectedObject=affectedObject, appnLsCurrentStateTime=appnLsCurrentStateTime, appnIsInS2PNonFmdPius=appnIsInS2PNonFmdPius, appnNodeNnInterchangeSup=appnNodeNnInterchangeSup, appnNodeAdaptiveBindPacing=appnNodeAdaptiveBindPacing, appnPortOperState=appnPortOperState, appnCosModeEntry=appnCosModeEntry, appnNnTgFRDlcData=appnNnTgFRDlcData, appnLsOutMsgFrames=appnLsOutMsgFrames, AppnTgDlcData=AppnTgDlcData, appnVrnConfGroup=appnVrnConfGroup, appnCosTgRowUsr3Min=appnCosTgRowUsr3Min, appnLsStatusDlcType=appnLsStatusDlcType, appnNodeUpTime=appnNodeUpTime, appnNnTgFRUsr2=appnNnTgFRUsr2, appnLocalTgDlcData=appnLocalTgDlcData, appnPortTable=appnPortTable, appnCosTransPriority=appnCosTransPriority, appnDirLuName=appnDirLuName, appnLocalEnTgNum=appnLocalEnTgNum, appnNodeHprOrgRteSetups=appnNodeHprOrgRteSetups, appnDirNnServerName=appnDirNnServerName, appnPortMaxRcvBtuSize=appnPortMaxRcvBtuSize, appnLsActOnDemand=appnLsActOnDemand, appnLocalTgTable=appnLocalTgTable, appnDirInBcastLocates=appnDirInBcastLocates, appnCosTgRowEffCapMax=appnCosTgRowEffCapMax, appnLsLimResource=appnLsLimResource, appnHprCtrlFlowsRtpConfGroup=appnHprCtrlFlowsRtpConfGroup, appnLocalTgBranchLinkType=appnLocalTgBranchLinkType, appnCosModeCosName=appnCosModeCosName, appnLsMaxDelay=appnLsMaxDelay, appnNnNodeFRType=appnNnNodeFRType, appnIsInSsRecvNxWndwSize=appnIsInSsRecvNxWndwSize, appnCosNodeRowTable=appnCosNodeRowTable, appnLsStatusRemoteAddr=appnLsStatusRemoteAddr, appnLsRemoteLsName=appnLsRemoteLsName, appnLocalTgNum=appnLocalTgNum, SnaClassOfServiceName=SnaClassOfServiceName, alertTrap=alertTrap, appnLocalTgConnCost=appnLocalTgConnCost, appnNodeHprOrgRteRejects=appnNodeHprOrgRteRejects, SnaModeName=SnaModeName, appnNodeNnExteBorderSup=appnNodeNnExteBorderSup, appnNnNodeFRInterchangeSup=appnNnNodeFRInterchangeSup, appnLocalTgOperational=appnLocalTgOperational, appnNodeNnCongested=appnNodeNnCongested, appnIsInP2SNonFmdBytes=appnIsInP2SNonFmdBytes, appnPortEntry=appnPortEntry, appnLsMltgMember=appnLsMltgMember, appnCosTgRowConnCostMax=appnCosTgRowConnCostMax, appnNodeLsCounterType=appnNodeLsCounterType, appnLocalTgPortName=appnLocalTgPortName, appnNnNodeFRName=appnNnNodeFRName, appnCosTgRowDelayMax=appnCosTgRowDelayMax, appnCosTgRowWgt=appnCosTgRowWgt, appnLocalDirPerfConfGroup=appnLocalDirPerfConfGroup, SnaSenseData=SnaSenseData, appnNodeHprSupport=appnNodeHprSupport, AppnTopologyEntryTimeLeft=AppnTopologyEntryTimeLeft, appnDirMaxCaches=appnDirMaxCaches, appnLocalTopology=appnLocalTopology, appnIsInSsSendNxWndwSize=appnIsInSsSendNxWndwSize, appnCosTgRowEntry=appnCosTgRowEntry, appnIsInSessType=appnIsInSessType, appnLocalTgDestVirtual=appnLocalTgDestVirtual, appnLsInXidBytes=appnLsInXidBytes, appnLsCommand=appnLsCommand, appnIsInSsRecvRpc=appnIsInSsRecvRpc, appnLsCurrentDelay=appnLsCurrentDelay, appnCosNameEntry=appnCosNameEntry, appnLocalEnTgSecurity=appnLocalEnTgSecurity, appnNnTgFRTypeIndicator=appnNnTgFRTypeIndicator, appnIsInPsRecvRpc=appnIsInPsRecvRpc, appnNnTgFREffCap=appnNnTgFREffCap, appnLsOutMsgBytes=appnLsOutMsgBytes, appnPortLsRole=appnPortLsRole, appnVrnTgNum=appnVrnTgNum, appnLsStatusXidByteInError=appnLsStatusXidByteInError, appnNodeBrNn=appnNodeBrNn, appnLsCounterDisconTime=appnLsCounterDisconTime, appnCosNodeRowMaxCongestAllow=appnCosNodeRowMaxCongestAllow, appnDirNotFoundBcastLocates=appnDirNotFoundBcastLocates, appnDirLuLocation=appnDirLuLocation, appnLocalEnTgDlcData=appnLocalEnTgDlcData, appnCosConfGroup=appnCosConfGroup, appnLsStatusXidRemoteSense=appnLsStatusXidRemoteSense, appnLsActiveTime=appnLsActiveTime, appnLsDlcType=appnLsDlcType, appnLsName=appnLsName, appnLsRemoteAddr=appnLsRemoteAddr, appnLsDynamic=appnLsDynamic, appnDirEntry=appnDirEntry, appnDirType=appnDirType)
mibBuilder.exportSymbols("APPN-MIB", appnNodeEnLuSearch=appnNodeEnLuSearch, appnLocalEnTgOperational=appnLocalEnTgOperational, appnNodeNnFrsn=appnNodeNnFrsn, appnCosNodeRowResistMin=appnCosNodeRowResistMin, appnPortDefLsGoodXids=appnPortDefLsGoodXids, appnLocalTgQuiescing=appnLocalTgQuiescing, appnNode=appnNode, appnCosNodeRowName=appnCosNodeRowName, appnLsStatusPartnerId=appnLsStatusPartnerId, appnLsRouteNceId=appnLsRouteNceId, appnLsBfNceId=appnLsBfNceId, appnLocalTgDelay=appnLocalTgDelay, appnIsRtpEntry=appnIsRtpEntry, appnLocalEnTgConnCost=appnLocalEnTgConnCost, appnNnTopoNodePurges=appnNnTopoNodePurges, appnGeneralInfoAndCaps=appnGeneralInfoAndCaps, AppnNodeCounter=AppnNodeCounter, appnLocalTgUsr3=appnLocalTgUsr3, appnIsInRtpNceId=appnIsInRtpNceId, appnIsInEntry=appnIsInEntry, appnLocalEnTgByteCost=appnLocalEnTgByteCost, appnIsInCosName=appnIsInCosName, appnDirRegEntries=appnDirRegEntries, appnLocalEnTgDelay=appnLocalEnTgDelay, appnCompliance=appnCompliance, appnIsInPsSendNxWndwSize=appnIsInPsSendNxWndwSize, appnIsInP2SFmdPius=appnIsInP2SFmdPius, appnLsPortName=appnLsPortName, appnNnTopologyFREntry=appnNnTopologyFREntry, appnPortCounterDisconTime=appnPortCounterDisconTime, appnNodeNnRouteAddResist=appnNodeNnRouteAddResist, appnLocalTgConfGroup2=appnLocalTgConfGroup2, appnIsInSessState=appnIsInSessState, appnIntSessConfGroup=appnIntSessConfGroup, appnConformance=appnConformance, appnIsInPsSendPacingType=appnIsInPsSendPacingType, appnCosTgRowUsr1Max=appnCosTgRowUsr1Max, appnLocalEnTgMltgLinkType=appnLocalEnTgMltgLinkType, appnNodeNnRsn=appnNodeNnRsn, PYSNMP_MODULE_ID=appnMIB, appnNnTgFROperational=appnNnTgFROperational, appnLsOperState=appnLsOperState, appnNnTopologyFRTable=appnNnTopologyFRTable, appnIsInPsAdjCpName=appnIsInPsAdjCpName, appnLsInMsgFrames=appnLsInMsgFrames, appnNnTgFRGarbageCollect=appnNnTgFRGarbageCollect, appnIsRtpSessions=appnIsRtpSessions, appnLsInMsgBytes=appnLsInMsgBytes, appnIsInSsSendMaxBtuSize=appnIsInSsSendMaxBtuSize, appnDirCurHomeEntries=appnDirCurHomeEntries, appnNnTgFRSecurity=appnNnTgFRSecurity, appnIsInSsAdjCpName=appnIsInSsAdjCpName, appnIsRtpTable=appnIsRtpTable, appnLocalTgCpCpSession=appnLocalTgCpCpSession, appnNodeNnQuiescing=appnNodeNnQuiescing, appnNnTgFREntryTimeLeft=appnNnTgFREntryTimeLeft, appnIsInSsRecvPacingType=appnIsInSsRecvPacingType, appnLsEntry=appnLsEntry, appnNodeNnIsr=appnNodeNnIsr, appnLsStatusTime=appnLsStatusTime, appnCosNodeRowIndex=appnCosNodeRowIndex, appnVrnPortName=appnVrnPortName, appnDirOutLocates=appnDirOutLocates, appnCosTgRowUsr2Max=appnCosTgRowUsr2Max, appnPortDlcLocalAddr=appnPortDlcLocalAddr, appnNodeCounterDisconTime=appnNodeCounterDisconTime, alertIdNumber=alertIdNumber, appnCosNameTable=appnCosNameTable, appnDirLuOwnerName=appnDirLuOwnerName, appnNnTgFRNum=appnNnTgFRNum, appnNn=appnNn, appnLocalEnTgUsr2=appnLocalEnTgUsr2, appnNnTgFRIntersubnet=appnNnTgFRIntersubnet, appnNnTgFRConnCost=appnNnTgFRConnCost, appnLinkStationInformation=appnLinkStationInformation, appnDirLocateOutstands=appnDirLocateOutstands, appnIsInSsSendRpc=appnIsInSsSendRpc, appnPortDynLsGoodXids=appnPortDynLsGoodXids, appnNnNodeFRCentralDirectory=appnNnNodeFRCentralDirectory, appnNnTopoCurNumNodes=appnNnTopoCurNumNodes, appnCompliances=appnCompliances, appnDirApparentLuOwnerName=appnDirApparentLuOwnerName, appnLocalEnTopoConfGroup=appnLocalEnTopoConfGroup, appnCosNodeRowWgt=appnCosNodeRowWgt, appnLsErrRecoSup=appnLsErrRecoSup, appnNnTgFRFrsn=appnNnTgFRFrsn, appnNnNodeFRCongested=appnNnNodeFRCongested, appnObjects=appnObjects, appnLsStatusLsName=appnLsStatusLsName, appnNnTgFRDest=appnNnTgFRDest, appnPortSpecific=appnPortSpecific, appnCosTgRowUsr3Max=appnCosTgRowUsr3Max, appnIsInPsRecvNxWndwSize=appnIsInPsRecvNxWndwSize, AppnPortCounter=AppnPortCounter, appnNnNodeFRExteBorderSup=appnNnNodeFRExteBorderSup, appnCosNodeRowMinCongestAllow=appnCosNodeRowMinCongestAllow, appnGeneralConfGroup=appnGeneralConfGroup, appnPortPortType=appnPortPortType, appnLocalTgSecurity=appnLocalTgSecurity, appnLsStatusIndex=appnLsStatusIndex, appnHprBaseConfGroup=appnHprBaseConfGroup, appnLsCpCpNceId=appnLsCpCpNceId, appnLsForAnrLabel=appnLsForAnrLabel, appnLsMigration=appnLsMigration, appnLocalEnTgDest=appnLocalEnTgDest, appnCosModeTable=appnCosModeTable, appnNodeParallelTg=appnNodeParallelTg, appnIsInGlobeCtrStatusTime=appnIsInGlobeCtrStatusTime, appnIsInGlobeActSess=appnIsInGlobeActSess, SnaNodeIdentification=SnaNodeIdentification, SnaControlPointName=SnaControlPointName, appnCosTgRowDelayMin=appnCosTgRowDelayMin, appnSessIntermediate=appnSessIntermediate, appnLsStatusXidBitInError=appnLsStatusXidBitInError, appnNnTgFROwner=appnNnTgFROwner, appnTrapNotifGroup=appnTrapNotifGroup, appnPortSIMRIM=appnPortSIMRIM, appnMIB=appnMIB, appnLocalTgUsr1=appnLocalTgUsr1, appnIsInRouteInfo=appnIsInRouteInfo, AppnTgSecurity=AppnTgSecurity, appnLsHprSup=appnLsHprSup, appnNodeEnNnServer=appnNodeEnNnServer, AppnTgEffectiveCapacity=AppnTgEffectiveCapacity, appnIsRtpNceId=appnIsRtpNceId, appnLsStatusTgNum=appnLsStatusTgNum, appnIsInCtrUpTime=appnIsInCtrUpTime, appnLsOutXidBytes=appnLsOutXidBytes, appnLocalEnTgCpCpSession=appnLocalEnTgCpCpSession, appnCosNodeRowEntry=appnCosNodeRowEntry, appnLsMinDelay=appnLsMinDelay, appnIsInRtpTcid=appnIsInRtpTcid, appnNnNodeFRPeriBorderSup=appnNnNodeFRPeriBorderSup, appnIsInSessUpTime=appnIsInSessUpTime, appnLinkConfGroup2=appnLinkConfGroup2, appnLsMaxDelayTime=appnLsMaxDelayTime, appnVrnTable=appnVrnTable, appnLocalEnTgUsr1=appnLocalEnTgUsr1, appnBrNnConfGroup=appnBrNnConfGroup, DisplayableDlcAddress=DisplayableDlcAddress, appnLocalTgIntersubnet=appnLocalTgIntersubnet, appnNnTgFRCpCpSession=appnNnTgFRCpCpSession, appnLocalEnTgOrigin=appnLocalEnTgOrigin, appnIsInGlobeCtrAdminStatus=appnIsInGlobeCtrAdminStatus, appnNnUniqueConfGroup=appnNnUniqueConfGroup)
