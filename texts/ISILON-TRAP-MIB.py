...
Counter64, ModuleIdentity, IpAddress, Integer32, Gauge32, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Bits, MibIdentifier, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "IpAddress", "Integer32", "Gauge32", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Bits", "MibIdentifier", "NotificationType", "iso")
...
mibBuilder.exportSymbols("ISILON-TRAP-MIB", cloudpoolObjectNotFoundErrorCrit=cloudpoolObjectNotFoundErrorCrit, nodeStatusInfo=nodeStatusInfo, avscanErrorInfo=avscanErrorInfo, avscanInfectedFileCrit=avscanInfectedFileCrit, snapshotTraps=snapshotTraps, hwPwrSupplyOverCrit=hwPwrSupplyOverCrit, winIDmapCoalesce=winIDmapCoalesce, upgradeClusterEventInfo=upgradeClusterEventInfo, nodeCPUWarn=nodeCPUWarn, winSmbUpgradeCrit=winSmbUpgradeCrit, hardwareTrapsGroup=hardwareTrapsGroup, avscanCoalescedCrit=avscanCoalescedCrit, mixedSedNonSedCluster=mixedSedNonSedCluster, hwErrorCrit=hwErrorCrit, diskErrorWarn=diskErrorWarn, hwCurrentOverInfo=hwCurrentOverInfo, hwVoltageUnderInfo=hwVoltageUnderInfo, avscanCoalesced=avscanCoalesced, upgradeRollbackStartInfo=upgradeRollbackStartInfo, licenseExpirationInfo=licenseExpirationInfo, hwVoltageOverWarn=hwVoltageOverWarn, hwVoltageOver=hwVoltageOver, hwTempUnder=hwTempUnder, hwFanOver=hwFanOver, instanceIdentifier=instanceIdentifier, quotaThreshErrorInfo=quotaThreshErrorInfo, diskPoolUsageWarn=diskPoolUsageWarn, sensorCoalescedEmerg=sensorCoalescedEmerg, hwCurrent=hwCurrent, hwCurrentUnderEmerg=hwCurrentUnderEmerg, winNetMapFullCrit=winNetMapFullCrit, storageTransportTrapsGroup=storageTransportTrapsGroup, clockSkewCrit=clockSkewCrit, diskPoolOldDbVersion=diskPoolOldDbVersion, cloudpoolCertificateError=cloudpoolCertificateError, trapCompliance=trapCompliance, voltsCoalescedCrit=voltsCoalescedCrit, nodeShutdownFailCrit=nodeShutdownFailCrit, voltsCoalescedEmerg=voltsCoalescedEmerg, winAuthUpgrade=winAuthUpgrade, nodeStatusCoalescingCrit=nodeStatusCoalescingCrit, systemDiskTrapsGroup=systemDiskTrapsGroup, netStatus=netStatus, licenseExpiration=licenseExpiration, bootDiskFailWarn=bootDiskFailWarn, voltsCoalescedWarn=voltsCoalescedWarn, avscanTraps=avscanTraps, hwTempOverEmerg=hwTempOverEmerg, jobEngineErrorCrit=jobEngineErrorCrit, upgradeNodeEventCrit=upgradeNodeEventCrit, winNetAuthWarn=winNetAuthWarn, upgradeFinishInfo=upgradeFinishInfo, upgradeClusterEventWarn=upgradeClusterEventWarn, winAuthCoalesce=winAuthCoalesce, sensorCoalescedCrit=sensorCoalescedCrit, hwTempUnderCrit=hwTempUnderCrit, nodeStatusCrit=nodeStatusCrit, hwFanOverInfo=hwFanOverInfo, diskPoolUsage=diskPoolUsage, nodeStatusCoalescing=nodeStatusCoalescing, hwCpuThrottle=hwCpuThrottle, hardwareErrorInfo=hardwareErrorInfo, mcpProcKilled=mcpProcKilled, cloudpoolObjectNotFoundError=cloudpoolObjectNotFoundError, nodeShutdown=nodeShutdown, phy=phy, avscanCoalescedInfo=avscanCoalescedInfo, groupStateTrapsGroup=groupStateTrapsGroup, hardwareErrorMsg=hardwareErrorMsg, networkingTrapsGroup=networkingTrapsGroup, jobEngineErrorInfo=jobEngineErrorInfo, netStatusCoalescingCrit=netStatusCoalescingCrit, mountdClientMountFailed=mountdClientMountFailed, nfsCookieTranslationFailedInfo=nfsCookieTranslationFailedInfo, errorMessage=errorMessage, mountdHostLookupFailed=mountdHostLookupFailed, cloudpoolAuthenticationError=cloudpoolAuthenticationError, storageTransportCoalescedEmerg=storageTransportCoalescedEmerg, errno=errno, cloudpoolNetworkErrorCrit=cloudpoolNetworkErrorCrit, oid=oid, measuredValue=measuredValue, hwTempUnderEmerg=hwTempUnderEmerg, trapGroupCompliance=trapGroupCompliance, deviceIdentifier=deviceIdentifier, hwPwrSupplyOver=hwPwrSupplyOver, hwFanUnderCrit=hwFanUnderCrit, upgradeNodeEventInfo=upgradeNodeEventInfo, hwCurrentOverCrit=hwCurrentOverCrit, stringArg=stringArg, avscanInfectedFileWarn=avscanInfectedFileWarn, hardwareCoalescedWarn=hardwareCoalescedWarn, hwPwrSupplyUnder=hwPwrSupplyUnder, upgradeFinish=upgradeFinish, snapshotReserveCrit=snapshotReserveCrit, upgradeRollbackStart=upgradeRollbackStart, testEventCrit=testEventCrit, hwCurrentOverWarn=hwCurrentOverWarn, hwTempOverCrit=hwTempOverCrit, upgradeStartInfo=upgradeStartInfo, jobEngineErrorWarn=jobEngineErrorWarn, sensorCoalescedWarn=sensorCoalescedWarn, sensorMonitorCrit=sensorMonitorCrit, ssdUsageInfo=ssdUsageInfo, groupStateTraps=groupStateTraps, nodeExpStatus=nodeExpStatus, ssdUsageWarn=ssdUsageWarn, clusterStorageUsage=clusterStorageUsage, avscanNoServersConfInfo=avscanNoServersConfInfo, flexProtectRunningInfo=flexProtectRunningInfo, bootDiskMirrorReqMissing=bootDiskMirrorReqMissing, hwCurrentUnderWarn=hwCurrentUnderWarn, hwCpuThrottleCrit=hwCpuThrottleCrit, snapshotReserveWarn=snapshotReserveWarn, sensorTraps=sensorTraps, partitionUsageWarn=partitionUsageWarn, hwFanCrit=hwFanCrit, mcpProcKilledWarn=mcpProcKilledWarn, voltsCoalesced=voltsCoalesced, hwFan=hwFan, hwTempOverInfo=hwTempOverInfo, winNetMapFull=winNetMapFull, siqTargetCoalescedWarn=siqTargetCoalescedWarn, upgradeNodeEvent=upgradeNodeEvent, hwTempUnderInfo=hwTempUnderInfo, cloudpoolDataCorruptionIntegrityError=cloudpoolDataCorruptionIntegrityError, hwVoltageUnderWarn=hwVoltageUnderWarn, hardwareCoalescedCrit=hardwareCoalescedCrit, diskErrorCoalesced=diskErrorCoalesced, hwVoltageOverCrit=hwVoltageOverCrit, snapshotTrapsGroup=snapshotTrapsGroup, quotaNotifyError=quotaNotifyError, sasPhyError=sasPhyError, hwPwrSupplyOverWarn=hwPwrSupplyOverWarn, hwCurrentOverEmerg=hwCurrentOverEmerg, avscanErrorCrit=avscanErrorCrit, hwVoltageOverInfo=hwVoltageOverInfo, hwPowerCrit=hwPowerCrit, winIDmapCoalesceWarn=winIDmapCoalesceWarn, fanCoalescedWarn=fanCoalescedWarn, netStatusWarn=netStatusWarn, firmwareUpdateIncomplete=firmwareUpdateIncomplete, filesysError=filesysError, sensorCoalesced=sensorCoalesced, winIDmapCoalesceCrit=winIDmapCoalesceCrit, avscanNoServersConfCrit=avscanNoServersConfCrit, hardwareErrorWarn=hardwareErrorWarn, hwCurrentUnder=hwCurrentUnder, hardwareErrorCrit=hardwareErrorCrit, siqEventCrit=siqEventCrit, mixedSedNonSedClusterCrit=mixedSedNonSedClusterCrit, avscanError=avscanError, cloudpoolCertificateErrorCrit=cloudpoolCertificateErrorCrit, driveStatus=driveStatus, hwFanOverWarn=hwFanOverWarn, nodeStatusCoalescingWarn=nodeStatusCoalescingWarn, sensorMonitor=sensorMonitor, netProtoTrapsGroup=netProtoTrapsGroup, avscanNoServersConf=avscanNoServersConf, diskPoolUsageCrit=diskPoolUsageCrit, flexProtectRunningWarn=flexProtectRunningWarn, snapshotErrorWarn=snapshotErrorWarn, hwFanOverCrit=hwFanOverCrit, nodeRebootCoalesced=nodeRebootCoalesced, hardwareError=hardwareError, netStatusCoalescingWarn=netStatusCoalescingWarn, winNetAuthCrit=winNetAuthCrit, hardwareCoalescedEmerg=hardwareCoalescedEmerg, bootDiskFail=bootDiskFail, storageTransportTraps=storageTransportTraps, nodeShutdownFail=nodeShutdownFail, hwFanWarn=hwFanWarn, hardwareErrorMsgWarn=hardwareErrorMsgWarn, tempCoalesced=tempCoalesced, upgradeNodeEventWarn=upgradeNodeEventWarn, filesysCoalesceCrit=filesysCoalesceCrit, lwioParamCrit=lwioParamCrit, mountdHostLookupFailedInfo=mountdHostLookupFailedInfo, filesystemTrapsGroup=filesystemTrapsGroup, PYSNMP_MODULE_ID=isilonTraps, avscanInfectedFile=avscanInfectedFile, partitionUsage=partitionUsage, winAuthCoalesceCrit=winAuthCoalesceCrit, cloudpoolAuthorizationError=cloudpoolAuthorizationError, cloudpoolDataCorruptionIntegrityErrorEmerg=cloudpoolDataCorruptionIntegrityErrorEmerg, syncIQTraps=syncIQTraps, storageCoalescedWarn=storageCoalescedWarn, firmwareUpdateIncompleteWarn=firmwareUpdateIncompleteWarn, units=units, nodeExpStatusCrit=nodeExpStatusCrit, cloudPoolsTrapsGroup=cloudPoolsTrapsGroup, networkingTraps=networkingTraps, nodeStatus=nodeStatus, filesysCoalesceWarn=filesysCoalesceWarn, upgradeStart=upgradeStart, hwPower=hwPower, smartQuotaTrapsGroup=smartQuotaTrapsGroup, diskNodeOfflineCrit=diskNodeOfflineCrit, fanCoalesced=fanCoalesced, avscanNoServersConfWarn=avscanNoServersConfWarn, fanCoalescedEmerg=fanCoalescedEmerg, siqEvent=siqEvent, nodeCPUInfo=nodeCPUInfo, nodeShutdownInfo=nodeShutdownInfo, winTimeConnectivityLostWarn=winTimeConnectivityLostWarn, filesysErrorInfo=filesysErrorInfo, hwPowerWarn=hwPowerWarn, diskError=diskError, siqPolicyCoalescedCrit=siqPolicyCoalescedCrit, hwTempOver=hwTempOver, hwCurrentUnderCrit=hwCurrentUnderCrit, upgradeClusterEventCrit=upgradeClusterEventCrit, ifName=ifName, clockSkew=clockSkew, hwCurrentUnderInfo=hwCurrentUnderInfo, winNetworkCoalesceCrit=winNetworkCoalesceCrit, i64Arg=i64Arg, storageTransportCoalesced=storageTransportCoalesced, upgradeClusterEvent=upgradeClusterEvent, hwVoltageUnder=hwVoltageUnder, quotaErrorWarn=quotaErrorWarn, lwioParam=lwioParam, avscanInfectedFileInfo=avscanInfectedFileInfo, hwCurrentOver=hwCurrentOver, siqErrorWarn=siqErrorWarn, driveStatusWarn=driveStatusWarn, siqPolicyCoalesced=siqPolicyCoalesced, systemDiskTraps=systemDiskTraps, siqTargetCoalesced=siqTargetCoalesced, tempCoalescedWarn=tempCoalescedWarn, partitionUsageInfo=partitionUsageInfo, winNetworkCoalesce=winNetworkCoalesce, siqPolicyCoalescedWarn=siqPolicyCoalescedWarn, bay=bay, hwFanUnderWarn=hwFanUnderWarn, upgradeTrapsGroup=upgradeTrapsGroup, hwError=hwError, hwTempUnderWarn=hwTempUnderWarn, filesystemTraps=filesystemTraps, avscanCoalescedWarn=avscanCoalescedWarn, driveStatusInfo=driveStatusInfo, ssdUsageCrit=ssdUsageCrit, mcpProcFailed=mcpProcFailed, storageCoalescedCrit=storageCoalescedCrit, diskNodeOffline=diskNodeOffline, hwMem=hwMem, syncIQTrapsGroup=syncIQTrapsGroup, upgradeTraps=upgradeTraps, cloudpoolNoUsableAccountFoundErrorCrit=cloudpoolNoUsableAccountFoundErrorCrit, smartQuotaTraps=smartQuotaTraps, cloudpoolBucketNotFoundError=cloudpoolBucketNotFoundError, hwVoltageUnderCrit=hwVoltageUnderCrit, jobEngineError=jobEngineError, avscanTrapsGroup=avscanTrapsGroup)
mibBuilder.exportSymbols("ISILON-TRAP-MIB", cloudpoolAuthorizationErrorCrit=cloudpoolAuthorizationErrorCrit, hwTemp=hwTemp, filesysCoalesce=filesysCoalesce, hardwareCoalesced=hardwareCoalesced, filesysErrorWarn=filesysErrorWarn, i32Arg=i32Arg, licenseExpirationWarn=licenseExpirationWarn, message=message, avscanErrorWarn=avscanErrorWarn, fanCoalescedCrit=fanCoalescedCrit, winSmbUpgradeWarn=winSmbUpgradeWarn, winAuthCoalesceWarn=winAuthCoalesceWarn, sensorTrapsGroup=sensorTrapsGroup, netStatusCrit=netStatusCrit, hwTempOverWarn=hwTempOverWarn, nfsCookieTranslationFailed=nfsCookieTranslationFailed, isilonTraps=isilonTraps, clusterStorageUsageWarn=clusterStorageUsageWarn, nodeRebootCoalescedInfo=nodeRebootCoalescedInfo, sasPhyErrorControllerWarn=sasPhyErrorControllerWarn, diskErrorCoalescedWarn=diskErrorCoalescedWarn, bootdiskMirrorReqMissingCrit=bootdiskMirrorReqMissingCrit, winSmbUpgrade=winSmbUpgrade, hwMemCrit=hwMemCrit, cloudpoolNetworkError=cloudpoolNetworkError, mcpProcFailedWarn=mcpProcFailedWarn, snapshotReserve=snapshotReserve, driveStatusCrit=driveStatusCrit, cloudPoolsTraps=cloudPoolsTraps, siqError=siqError, flexProtectRunningCrit=flexProtectRunningCrit, sensorMonitorWarn=sensorMonitorWarn, siqEventWarn=siqEventWarn, jobEngineErrorEmerg=jobEngineErrorEmerg, winAuthUpgradeCrit=winAuthUpgradeCrit, hwVoltage=hwVoltage, measuredValueStr=measuredValueStr, diskErrorCoalescedCrit=diskErrorCoalescedCrit, diskPoolOldDbVersionWarn=diskPoolOldDbVersionWarn, partitionUsageCrit=partitionUsageCrit, netStatusCoalescing=netStatusCoalescing, flexProtectRunning=flexProtectRunning, sasPhyErrorExpanderWarn=sasPhyErrorExpanderWarn, hwPwrSupply=hwPwrSupply, hwPwrSupplyUnderWarn=hwPwrSupplyUnderWarn, nodeIdentifier=nodeIdentifier, hardwareErrorMsgCrit=hardwareErrorMsgCrit, winNetAuth=winNetAuth, clusterStorageUsageCrit=clusterStorageUsageCrit, testEvent=testEvent, winTimeConnectivityLost=winTimeConnectivityLost, ssdUsage=ssdUsage, cloudpoolBucketNotFoundErrorCrit=cloudpoolBucketNotFoundErrorCrit, sharePermsUpgradeFail=sharePermsUpgradeFail, hwFanUnder=hwFanUnder, netProtoTraps=netProtoTraps, hwFanUnderInfo=hwFanUnderInfo, variablesGroup=variablesGroup, quotaThreshError=quotaThreshError, tempCoalescedCrit=tempCoalescedCrit, tempCoalescedEmerg=tempCoalescedEmerg, softwareTraps=softwareTraps, siqTargetCoalescedCrit=siqTargetCoalescedCrit, hardwareTraps=hardwareTraps, hwPwrSupplyUnderCrit=hwPwrSupplyUnderCrit, snapshotError=snapshotError, winNetworkCoalesceWarn=winNetworkCoalesceWarn, filesysErrorCrit=filesysErrorCrit, sharePermsUpgradeFailCrit=sharePermsUpgradeFailCrit, quotaError=quotaError, trapConformance=trapConformance, variables=variables, cloudpoolAuthenticationErrorCrit=cloudpoolAuthenticationErrorCrit, nodeCPU=nodeCPU, bootDiskFailCrit=bootDiskFailCrit, softwareTrapsGroup=softwareTrapsGroup, cloudpoolNoUsableAccountFoundError=cloudpoolNoUsableAccountFoundError, quotaNotifyErrorWarn=quotaNotifyErrorWarn, mountdClientMountFailedInfo=mountdClientMountFailedInfo)
