...
ModuleIdentity, Unsigned32, Gauge32, TimeTicks, iso, Bits, Integer32, Counter32, IpAddress, Counter64, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Gauge32", "TimeTicks", "iso", "Bits", "Integer32", "Counter32", "IpAddress", "Counter64", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier")
...
mibBuilder.exportSymbols("ISILON-TRAP-MIB", netStatusWarn=netStatusWarn, hwPwrSupplyOverWarn=hwPwrSupplyOverWarn, nodeRebootCoalescedInfo=nodeRebootCoalescedInfo, avscanInfectedFileWarn=avscanInfectedFileWarn, cloudpoolObjectNotFoundErrorCrit=cloudpoolObjectNotFoundErrorCrit, hardwareTraps=hardwareTraps, netProtoTraps=netProtoTraps, cloudpoolDataCorruptionIntegrityError=cloudpoolDataCorruptionIntegrityError, snapshotReserveWarn=snapshotReserveWarn, siqEvent=siqEvent, snapshotTraps=snapshotTraps, filesysCoalesce=filesysCoalesce, tempCoalescedEmerg=tempCoalescedEmerg, cloudPoolsTrapsGroup=cloudPoolsTrapsGroup, winAuthCoalesceCrit=winAuthCoalesceCrit, diskErrorWarn=diskErrorWarn, snapshotError=snapshotError, partitionUsageCrit=partitionUsageCrit, nodeShutdownFailCrit=nodeShutdownFailCrit, syncIQTrapsGroup=syncIQTrapsGroup, fanCoalesced=fanCoalesced, winNetMapFull=winNetMapFull, quotaThreshError=quotaThreshError, nodeStatusInfo=nodeStatusInfo, avscanInfectedFile=avscanInfectedFile, flexProtectRunningInfo=flexProtectRunningInfo, hwVoltageOverCrit=hwVoltageOverCrit, winNetworkCoalesceCrit=winNetworkCoalesceCrit, hwFanUnderCrit=hwFanUnderCrit, filesysErrorCrit=filesysErrorCrit, upgradeNodeEventCrit=upgradeNodeEventCrit, hwVoltageUnderInfo=hwVoltageUnderInfo, mountdHostLookupFailedInfo=mountdHostLookupFailedInfo, tempCoalesced=tempCoalesced, diskErrorCoalescedWarn=diskErrorCoalescedWarn, cloudpoolCertificateError=cloudpoolCertificateError, upgradeStartInfo=upgradeStartInfo, hwCurrentOverInfo=hwCurrentOverInfo, jobEngineErrorInfo=jobEngineErrorInfo, tempCoalescedCrit=tempCoalescedCrit, nodeCPU=nodeCPU, mountdClientMountFailedInfo=mountdClientMountFailedInfo, hardwareErrorWarn=hardwareErrorWarn, nodeCPUInfo=nodeCPUInfo, lwioParamCrit=lwioParamCrit, hwVoltageOver=hwVoltageOver, upgradeClusterEventWarn=upgradeClusterEventWarn, ssdUsage=ssdUsage, licenseExpirationInfo=licenseExpirationInfo, PYSNMP_MODULE_ID=isilonTraps, cloudpoolObjectNotFoundError=cloudpoolObjectNotFoundError, hwCurrent=hwCurrent, diskError=diskError, upgradeNodeEventInfo=upgradeNodeEventInfo, diskNodeOfflineCrit=diskNodeOfflineCrit, sensorCoalescedWarn=sensorCoalescedWarn, storageCoalescedWarn=storageCoalescedWarn, sensorMonitorWarn=sensorMonitorWarn, fanCoalescedEmerg=fanCoalescedEmerg, siqPolicyCoalescedWarn=siqPolicyCoalescedWarn, hwFanOverCrit=hwFanOverCrit, hwVoltageOverWarn=hwVoltageOverWarn, sensorTraps=sensorTraps, quotaThreshErrorInfo=quotaThreshErrorInfo, hardwareErrorMsg=hardwareErrorMsg, winAuthCoalesce=winAuthCoalesce, avscanInfectedFileInfo=avscanInfectedFileInfo, cloudpoolNetworkErrorCrit=cloudpoolNetworkErrorCrit, ssdUsageInfo=ssdUsageInfo, upgradeNodeEvent=upgradeNodeEvent, hwPwrSupplyOverCrit=hwPwrSupplyOverCrit, voltsCoalescedCrit=voltsCoalescedCrit, avscanErrorInfo=avscanErrorInfo, nodeStatus=nodeStatus, storageTransportCoalescedEmerg=storageTransportCoalescedEmerg, bootdiskMirrorReqMissingCrit=bootdiskMirrorReqMissingCrit, winNetMapFullCrit=winNetMapFullCrit, diskErrorCoalesced=diskErrorCoalesced, partitionUsageWarn=partitionUsageWarn, tempCoalescedWarn=tempCoalescedWarn, diskPoolUsage=diskPoolUsage, netStatusCrit=netStatusCrit, cloudPoolsTraps=cloudPoolsTraps, winNetAuthWarn=winNetAuthWarn, firmwareUpdateIncomplete=firmwareUpdateIncomplete, sasPhyErrorExpanderWarn=sasPhyErrorExpanderWarn, testEvent=testEvent, avscanCoalescedWarn=avscanCoalescedWarn, upgradeClusterEventInfo=upgradeClusterEventInfo, deviceIdentifier=deviceIdentifier, hardwareErrorCrit=hardwareErrorCrit, driveStatus=driveStatus, licenseExpirationWarn=licenseExpirationWarn, groupStateTraps=groupStateTraps, winNetAuth=winNetAuth, hardwareCoalescedWarn=hardwareCoalescedWarn, netStatusCoalescingCrit=netStatusCoalescingCrit, avscanTraps=avscanTraps, driveStatusInfo=driveStatusInfo, hwTempOverEmerg=hwTempOverEmerg, storageTransportCoalesced=storageTransportCoalesced, sensorCoalescedEmerg=sensorCoalescedEmerg, storageCoalescedCrit=storageCoalescedCrit, upgradeFinishInfo=upgradeFinishInfo, clusterStorageUsageCrit=clusterStorageUsageCrit, sensorCoalesced=sensorCoalesced, cloudpoolNetworkError=cloudpoolNetworkError, hwMem=hwMem, nodeShutdown=nodeShutdown, winIDmapCoalesceCrit=winIDmapCoalesceCrit, hwCurrentOverCrit=hwCurrentOverCrit, lwioParam=lwioParam, hwFanOver=hwFanOver, trapConformance=trapConformance, hardwareErrorInfo=hardwareErrorInfo, netProtoTrapsGroup=netProtoTrapsGroup, partitionUsage=partitionUsage, hwPwrSupplyUnderCrit=hwPwrSupplyUnderCrit, hwPwrSupplyUnderWarn=hwPwrSupplyUnderWarn, hwCurrentUnderWarn=hwCurrentUnderWarn, filesysErrorInfo=filesysErrorInfo, winNetAuthCrit=winNetAuthCrit, hwError=hwError, snapshotReserveCrit=snapshotReserveCrit, driveStatusWarn=driveStatusWarn, i64Arg=i64Arg, snapshotErrorWarn=snapshotErrorWarn, winTimeConnectivityLostWarn=winTimeConnectivityLostWarn, fanCoalescedWarn=fanCoalescedWarn, bootDiskMirrorReqMissing=bootDiskMirrorReqMissing, netStatus=netStatus, winSmbUpgrade=winSmbUpgrade, sharePermsUpgradeFail=sharePermsUpgradeFail, winAuthUpgrade=winAuthUpgrade, smartQuotaTrapsGroup=smartQuotaTrapsGroup, ssdUsageWarn=ssdUsageWarn, cloudpoolAuthenticationError=cloudpoolAuthenticationError, netStatusCoalescing=netStatusCoalescing, nodeShutdownFail=nodeShutdownFail, errorMessage=errorMessage, avscanNoServersConfInfo=avscanNoServersConfInfo, voltsCoalescedEmerg=voltsCoalescedEmerg, hwCurrentUnderCrit=hwCurrentUnderCrit, siqError=siqError, snapshotReserve=snapshotReserve, nodeCPUWarn=nodeCPUWarn, hwTemp=hwTemp, mixedSedNonSedCluster=mixedSedNonSedCluster, upgradeRollbackStartInfo=upgradeRollbackStartInfo, hwTempOverCrit=hwTempOverCrit, hwPower=hwPower, cloudpoolBucketNotFoundError=cloudpoolBucketNotFoundError, diskPoolUsageCrit=diskPoolUsageCrit, winNetworkCoalesce=winNetworkCoalesce, diskPoolOldDbVersionWarn=diskPoolOldDbVersionWarn, variablesGroup=variablesGroup, quotaNotifyErrorWarn=quotaNotifyErrorWarn, hwCurrentUnderEmerg=hwCurrentUnderEmerg, siqTargetCoalescedWarn=siqTargetCoalescedWarn, hwPowerCrit=hwPowerCrit, winNetworkCoalesceWarn=winNetworkCoalesceWarn, quotaError=quotaError, snapshotTrapsGroup=snapshotTrapsGroup, measuredValue=measuredValue, hwTempOverWarn=hwTempOverWarn, driveStatusCrit=driveStatusCrit, upgradeRollbackStart=upgradeRollbackStart, nodeStatusCrit=nodeStatusCrit, siqEventCrit=siqEventCrit, groupStateTrapsGroup=groupStateTrapsGroup, avscanNoServersConfWarn=avscanNoServersConfWarn, clockSkew=clockSkew, upgradeStart=upgradeStart, mcpProcKilledWarn=mcpProcKilledWarn, sensorCoalescedCrit=sensorCoalescedCrit, nodeStatusCoalescing=nodeStatusCoalescing, netStatusCoalescingWarn=netStatusCoalescingWarn, mountdClientMountFailed=mountdClientMountFailed, sensorTrapsGroup=sensorTrapsGroup, nodeExpStatus=nodeExpStatus, upgradeNodeEventWarn=upgradeNodeEventWarn, sharePermsUpgradeFailCrit=sharePermsUpgradeFailCrit, hwCurrentUnder=hwCurrentUnder, jobEngineErrorEmerg=jobEngineErrorEmerg, diskNodeOffline=diskNodeOffline, softwareTraps=softwareTraps, hwVoltageUnderWarn=hwVoltageUnderWarn, errno=errno, avscanTrapsGroup=avscanTrapsGroup, diskErrorCoalescedCrit=diskErrorCoalescedCrit, nodeExpStatusCrit=nodeExpStatusCrit, sasPhyErrorControllerWarn=sasPhyErrorControllerWarn, clockSkewCrit=clockSkewCrit, avscanInfectedFileCrit=avscanInfectedFileCrit, upgradeFinish=upgradeFinish, hardwareCoalesced=hardwareCoalesced, jobEngineErrorWarn=jobEngineErrorWarn, hwTempUnderInfo=hwTempUnderInfo, smartQuotaTraps=smartQuotaTraps, i32Arg=i32Arg, nfsCookieTranslationFailedInfo=nfsCookieTranslationFailedInfo, ifName=ifName, hwCpuThrottle=hwCpuThrottle, flexProtectRunning=flexProtectRunning, filesysErrorWarn=filesysErrorWarn, networkingTraps=networkingTraps, upgradeTraps=upgradeTraps, mixedSedNonSedClusterCrit=mixedSedNonSedClusterCrit, hwFanUnderWarn=hwFanUnderWarn, hwMemCrit=hwMemCrit, hwCurrentOverWarn=hwCurrentOverWarn, nodeIdentifier=nodeIdentifier, bootDiskFailCrit=bootDiskFailCrit, hwFanWarn=hwFanWarn, cloudpoolAuthorizationError=cloudpoolAuthorizationError, winSmbUpgradeWarn=winSmbUpgradeWarn, hwTempUnderEmerg=hwTempUnderEmerg, systemDiskTrapsGroup=systemDiskTrapsGroup, filesysError=filesysError, siqPolicyCoalesced=siqPolicyCoalesced, filesysCoalesceCrit=filesysCoalesceCrit, quotaErrorWarn=quotaErrorWarn, clusterStorageUsage=clusterStorageUsage, upgradeClusterEvent=upgradeClusterEvent, mcpProcFailed=mcpProcFailed, cloudpoolAuthorizationErrorCrit=cloudpoolAuthorizationErrorCrit, hwTempUnder=hwTempUnder, siqTargetCoalescedCrit=siqTargetCoalescedCrit, measuredValueStr=measuredValueStr, jobEngineErrorCrit=jobEngineErrorCrit, trapGroupCompliance=trapGroupCompliance, voltsCoalesced=voltsCoalesced, syncIQTraps=syncIQTraps, sensorMonitorCrit=sensorMonitorCrit, nodeStatusCoalescingWarn=nodeStatusCoalescingWarn, fanCoalescedCrit=fanCoalescedCrit, siqTargetCoalesced=siqTargetCoalesced, avscanCoalesced=avscanCoalesced, nodeShutdownInfo=nodeShutdownInfo, avscanCoalescedCrit=avscanCoalescedCrit, oid=oid, hwPwrSupplyOver=hwPwrSupplyOver, cloudpoolNoUsableAccountFoundError=cloudpoolNoUsableAccountFoundError, hwVoltageOverInfo=hwVoltageOverInfo, cloudpoolCertificateErrorCrit=cloudpoolCertificateErrorCrit, nodeRebootCoalesced=nodeRebootCoalesced, hwTempOver=hwTempOver, filesystemTrapsGroup=filesystemTrapsGroup, ssdUsageCrit=ssdUsageCrit, hardwareError=hardwareError, hwVoltageUnder=hwVoltageUnder, avscanError=avscanError, cloudpoolDataCorruptionIntegrityErrorEmerg=cloudpoolDataCorruptionIntegrityErrorEmerg, sensorMonitor=sensorMonitor)
mibBuilder.exportSymbols("ISILON-TRAP-MIB", cloudpoolBucketNotFoundErrorCrit=cloudpoolBucketNotFoundErrorCrit, hwTempUnderCrit=hwTempUnderCrit, hwVoltageUnderCrit=hwVoltageUnderCrit, hwCurrentOverEmerg=hwCurrentOverEmerg, filesystemTraps=filesystemTraps, storageTransportTrapsGroup=storageTransportTrapsGroup, isilonTraps=isilonTraps, sasPhyError=sasPhyError, stringArg=stringArg, flexProtectRunningWarn=flexProtectRunningWarn, hwTempOverInfo=hwTempOverInfo, hwCurrentOver=hwCurrentOver, nodeStatusCoalescingCrit=nodeStatusCoalescingCrit, hwFanUnder=hwFanUnder, licenseExpiration=licenseExpiration, variables=variables, mcpProcFailedWarn=mcpProcFailedWarn, hwPwrSupply=hwPwrSupply, voltsCoalescedWarn=voltsCoalescedWarn, siqPolicyCoalescedCrit=siqPolicyCoalescedCrit, winTimeConnectivityLost=winTimeConnectivityLost, bootDiskFailWarn=bootDiskFailWarn, hardwareCoalescedEmerg=hardwareCoalescedEmerg, diskPoolOldDbVersion=diskPoolOldDbVersion, hwCurrentUnderInfo=hwCurrentUnderInfo, diskPoolUsageWarn=diskPoolUsageWarn, flexProtectRunningCrit=flexProtectRunningCrit, hwFanUnderInfo=hwFanUnderInfo, hwVoltage=hwVoltage, hardwareErrorMsgCrit=hardwareErrorMsgCrit, hwPowerWarn=hwPowerWarn, units=units, avscanErrorCrit=avscanErrorCrit, hwFanOverInfo=hwFanOverInfo, avscanErrorWarn=avscanErrorWarn, hwFan=hwFan, networkingTrapsGroup=networkingTrapsGroup, softwareTrapsGroup=softwareTrapsGroup, hardwareErrorMsgWarn=hardwareErrorMsgWarn, jobEngineError=jobEngineError, hwFanOverWarn=hwFanOverWarn, hwTempUnderWarn=hwTempUnderWarn, clusterStorageUsageWarn=clusterStorageUsageWarn, systemDiskTraps=systemDiskTraps, trapCompliance=trapCompliance, hwPwrSupplyUnder=hwPwrSupplyUnder, testEventCrit=testEventCrit, message=message, upgradeClusterEventCrit=upgradeClusterEventCrit, hwErrorCrit=hwErrorCrit, filesysCoalesceWarn=filesysCoalesceWarn, siqErrorWarn=siqErrorWarn, winIDmapCoalesce=winIDmapCoalesce, hardwareCoalescedCrit=hardwareCoalescedCrit, bootDiskFail=bootDiskFail, partitionUsageInfo=partitionUsageInfo, phy=phy, firmwareUpdateIncompleteWarn=firmwareUpdateIncompleteWarn, nfsCookieTranslationFailed=nfsCookieTranslationFailed, winAuthUpgradeCrit=winAuthUpgradeCrit, hardwareTrapsGroup=hardwareTrapsGroup, avscanCoalescedInfo=avscanCoalescedInfo, quotaNotifyError=quotaNotifyError, instanceIdentifier=instanceIdentifier, winIDmapCoalesceWarn=winIDmapCoalesceWarn, winSmbUpgradeCrit=winSmbUpgradeCrit, cloudpoolNoUsableAccountFoundErrorCrit=cloudpoolNoUsableAccountFoundErrorCrit, hwFanCrit=hwFanCrit, avscanNoServersConfCrit=avscanNoServersConfCrit, storageTransportTraps=storageTransportTraps, upgradeTrapsGroup=upgradeTrapsGroup, mcpProcKilled=mcpProcKilled, siqEventWarn=siqEventWarn, cloudpoolAuthenticationErrorCrit=cloudpoolAuthenticationErrorCrit, hwCpuThrottleCrit=hwCpuThrottleCrit, bay=bay, winAuthCoalesceWarn=winAuthCoalesceWarn, avscanNoServersConf=avscanNoServersConf, mountdHostLookupFailed=mountdHostLookupFailed)
