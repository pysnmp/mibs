...
# Produced by pysmi-1.1.8 at Mon Jan 16 15:33:08 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, Unsigned32, iso, Bits, enterprises, NotificationType, Gauge32, ModuleIdentity, Counter32, ObjectIdentity, TimeTicks, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "Unsigned32", "iso", "Bits", "enterprises", "NotificationType", "Gauge32", "ModuleIdentity", "Counter32", "ObjectIdentity", "TimeTicks", "Counter64", "IpAddress")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", deviceTemperatureUnit=deviceTemperatureUnit, network=network, macAddress=macAddress, PYSNMP_MODULE_ID=iBoot_PDU_Agent, gateway=gateway, outletInitialState=outletInitialState, outletCycleTime=outletCycleTime, iBoot_PDU_Agent=iBoot_PDU_Agent, ipMode=ipMode, sslPort=sslPort, outletName=outletName, dnsServer2=dnsServer2, outletEntry=outletEntry, snmpTrapCommunity=snmpTrapCommunity, deviceMaxCurrent=deviceMaxCurrent, deviceNumberOfLineCords=deviceNumberOfLineCords, sslEnabled=sslEnabled, outletActualStatus=outletActualStatus, deviceFamily=deviceFamily, console=console, notifications=notifications, deviceCalibrated=deviceCalibrated, outletDelayTime=outletDelayTime, serialPortEnabled=serialPortEnabled, telnetEnabled=telnetEnabled, dnsServer1=dnsServer1, currentLC1=currentLC1, temperature2=temperature2, device=device, sensors=sensors, snmpManagerAddress=snmpManagerAddress, rebootRequired=rebootRequired, setFactoryDefaults=setFactoryDefaults, TC1=TC1, snmpEnabled=snmpEnabled, dataprobe=dataprobe, subnetMask=subnetMask, voltageLC2=voltageLC2, cloudActivationCode=cloudActivationCode, outletChange=outletChange, deviceNumberOfOutlets=deviceNumberOfOutlets, snmp=snmp, snmpWriteCommunity=snmpWriteCommunity, modemCountryCode=modemCountryCode, rebootSystem=rebootSystem, ipAddress=ipAddress, outletControl=outletControl, snmpManagerName=snmpManagerName, sshEnabled=sshEnabled, cloudUUID=cloudUUID, telnetPort=telnetPort, webPort=webPort, snmpManagerEntry=snmpManagerEntry, deviceConnector=deviceConnector, deviceName=deviceName, outletTable=outletTable, outletIndex=outletIndex, deviceModelName=deviceModelName, deviceTimeZone=deviceTimeZone, sshPort=sshPort, outletStatus=outletStatus, firmwareVersion=firmwareVersion, snmpManagerIndex=snmpManagerIndex, webEnabled=webEnabled, voltageLC1=voltageLC1, currentLC2=currentLC2, temperature1=temperature1, cloudServerAddress=cloudServerAddress, snmpManagerTable=snmpManagerTable, cloudServiceEnabled=cloudServiceEnabled, consoleTimeout=consoleTimeout, snmpReadCommunity=snmpReadCommunity)
