...
iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter64, ObjectIdentity, TimeTicks, Bits, Unsigned32, Gauge32, ModuleIdentity, Integer32, IpAddress, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter64", "ObjectIdentity", "TimeTicks", "Bits", "Unsigned32", "Gauge32", "ModuleIdentity", "Integer32", "IpAddress", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", outletStatus=outletStatus, outletCycleTime=outletCycleTime, temperature1=temperature1, dnsServer1=dnsServer1, deviceTemperatureUnit=deviceTemperatureUnit, sslPort=sslPort, snmpWriteCommunity=snmpWriteCommunity, outletName=outletName, currentLC1=currentLC1, cloudActivationCode=cloudActivationCode, outletIndex=outletIndex, notifications=notifications, snmpManagerIndex=snmpManagerIndex, telnetEnabled=telnetEnabled, ipMode=ipMode, voltageLC2=voltageLC2, setFactoryDefaults=setFactoryDefaults, subnetMask=subnetMask, outletTable=outletTable, outletChange=outletChange, deviceTimeZone=deviceTimeZone, webPort=webPort, sensors=sensors, snmp=snmp, consoleTimeout=consoleTimeout, telnetPort=telnetPort, modemCountryCode=modemCountryCode, snmpReadCommunity=snmpReadCommunity, gateway=gateway, snmpManagerAddress=snmpManagerAddress, snmpManagerName=snmpManagerName, cloudUUID=cloudUUID, deviceMaxCurrent=deviceMaxCurrent, outletEntry=outletEntry, sshEnabled=sshEnabled, snmpManagerEntry=snmpManagerEntry, dataprobe=dataprobe, ipAddress=ipAddress, deviceNumberOfLineCords=deviceNumberOfLineCords, firmwareVersion=firmwareVersion, outletInitialState=outletInitialState, snmpManagerTable=snmpManagerTable, deviceConnector=deviceConnector, outletDelayTime=outletDelayTime, rebootRequired=rebootRequired, dnsServer2=dnsServer2, webEnabled=webEnabled, deviceFamily=deviceFamily, serialPortEnabled=serialPortEnabled, outletActualStatus=outletActualStatus, currentLC2=currentLC2, snmpEnabled=snmpEnabled, deviceNumberOfOutlets=deviceNumberOfOutlets, macAddress=macAddress, device=device, snmpTrapCommunity=snmpTrapCommunity, cloudServerAddress=cloudServerAddress, cloudServiceEnabled=cloudServiceEnabled, TC1=TC1, network=network, outletControl=outletControl, rebootSystem=rebootSystem, deviceModelName=deviceModelName, voltageLC1=voltageLC1, temperature2=temperature2, iBoot_PDU_Agent=iBoot_PDU_Agent, deviceName=deviceName, console=console, sshPort=sshPort, deviceCalibrated=deviceCalibrated, sslEnabled=sslEnabled, PYSNMP_MODULE_ID=iBoot_PDU_Agent)
