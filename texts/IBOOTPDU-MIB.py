...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Gauge32, Integer32, TimeTicks, enterprises, ModuleIdentity, ObjectIdentity, Counter64, NotificationType, Unsigned32, Bits, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Gauge32", "Integer32", "TimeTicks", "enterprises", "ModuleIdentity", "ObjectIdentity", "Counter64", "NotificationType", "Unsigned32", "Bits", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", cloudServiceEnabled=cloudServiceEnabled, outletIndex=outletIndex, PYSNMP_MODULE_ID=iBoot_PDU_Agent, sshPort=sshPort, deviceModelName=deviceModelName, deviceTemperatureUnit=deviceTemperatureUnit, deviceCalibrated=deviceCalibrated, serialPortEnabled=serialPortEnabled, telnetPort=telnetPort, device=device, outletStatus=outletStatus, subnetMask=subnetMask, snmpManagerEntry=snmpManagerEntry, outletDelayTime=outletDelayTime, cloudServerAddress=cloudServerAddress, currentLC2=currentLC2, outletActualStatus=outletActualStatus, rebootRequired=rebootRequired, sshEnabled=sshEnabled, deviceNumberOfOutlets=deviceNumberOfOutlets, cloudActivationCode=cloudActivationCode, sslPort=sslPort, snmpManagerTable=snmpManagerTable, deviceMaxCurrent=deviceMaxCurrent, dataprobe=dataprobe, snmpManagerName=snmpManagerName, telnetEnabled=telnetEnabled, sensors=sensors, temperature2=temperature2, deviceConnector=deviceConnector, notifications=notifications, network=network, deviceNumberOfLineCords=deviceNumberOfLineCords, snmpTrapCommunity=snmpTrapCommunity, snmpEnabled=snmpEnabled, console=console, cloudUUID=cloudUUID, outletTable=outletTable, firmwareVersion=firmwareVersion, rebootSystem=rebootSystem, deviceName=deviceName, gateway=gateway, TC1=TC1, webEnabled=webEnabled, voltageLC2=voltageLC2, webPort=webPort, sslEnabled=sslEnabled, snmpManagerIndex=snmpManagerIndex, ipMode=ipMode, outletCycleTime=outletCycleTime, outletControl=outletControl, ipAddress=ipAddress, snmpManagerAddress=snmpManagerAddress, outletInitialState=outletInitialState, voltageLC1=voltageLC1, consoleTimeout=consoleTimeout, deviceTimeZone=deviceTimeZone, dnsServer1=dnsServer1, outletName=outletName, snmpWriteCommunity=snmpWriteCommunity, modemCountryCode=modemCountryCode, snmpReadCommunity=snmpReadCommunity, iBoot_PDU_Agent=iBoot_PDU_Agent, currentLC1=currentLC1, deviceFamily=deviceFamily, setFactoryDefaults=setFactoryDefaults, macAddress=macAddress, outletChange=outletChange, temperature1=temperature1, dnsServer2=dnsServer2, outletEntry=outletEntry, snmp=snmp)
