...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, ModuleIdentity, Counter32, MibIdentifier, Integer32, NotificationType, IpAddress, Bits, ObjectIdentity, iso, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "ModuleIdentity", "Counter32", "MibIdentifier", "Integer32", "NotificationType", "IpAddress", "Bits", "ObjectIdentity", "iso", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", voltageLC2=voltageLC2, telnetEnabled=telnetEnabled, deviceNumberOfLineCords=deviceNumberOfLineCords, firmwareVersion=firmwareVersion, webEnabled=webEnabled, voltageLC1=voltageLC1, dnsServer1=dnsServer1, snmpWriteCommunity=snmpWriteCommunity, snmpTrapCommunity=snmpTrapCommunity, outletName=outletName, deviceTimeZone=deviceTimeZone, macAddress=macAddress, dataprobe=dataprobe, deviceFamily=deviceFamily, rebootRequired=rebootRequired, outletCycleTime=outletCycleTime, notifications=notifications, outletInitialState=outletInitialState, temperature2=temperature2, telnetPort=telnetPort, snmpManagerTable=snmpManagerTable, currentLC2=currentLC2, outletDelayTime=outletDelayTime, snmpManagerName=snmpManagerName, snmpReadCommunity=snmpReadCommunity, deviceTemperatureUnit=deviceTemperatureUnit, deviceModelName=deviceModelName, sslEnabled=sslEnabled, snmpManagerIndex=snmpManagerIndex, outletStatus=outletStatus, TC1=TC1, outletActualStatus=outletActualStatus, dnsServer2=dnsServer2, deviceCalibrated=deviceCalibrated, cloudActivationCode=cloudActivationCode, sshEnabled=sshEnabled, console=console, network=network, rebootSystem=rebootSystem, device=device, deviceMaxCurrent=deviceMaxCurrent, cloudServiceEnabled=cloudServiceEnabled, outletTable=outletTable, snmp=snmp, outletIndex=outletIndex, temperature1=temperature1, cloudUUID=cloudUUID, sensors=sensors, cloudServerAddress=cloudServerAddress, sshPort=sshPort, snmpManagerEntry=snmpManagerEntry, ipAddress=ipAddress, setFactoryDefaults=setFactoryDefaults, subnetMask=subnetMask, sslPort=sslPort, modemCountryCode=modemCountryCode, snmpManagerAddress=snmpManagerAddress, outletEntry=outletEntry, serialPortEnabled=serialPortEnabled, webPort=webPort, currentLC1=currentLC1, outletChange=outletChange, PYSNMP_MODULE_ID=iBoot_PDU_Agent, outletControl=outletControl, consoleTimeout=consoleTimeout, deviceNumberOfOutlets=deviceNumberOfOutlets, deviceConnector=deviceConnector, deviceName=deviceName, ipMode=ipMode, snmpEnabled=snmpEnabled, iBoot_PDU_Agent=iBoot_PDU_Agent, gateway=gateway)
