...
# Produced by pysmi-1.1.8 at Thu Jan  5 09:02:59 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, NotificationType, Bits, ModuleIdentity, MibIdentifier, TimeTicks, Integer32, IpAddress, iso, Gauge32, Counter32, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "NotificationType", "Bits", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Integer32", "IpAddress", "iso", "Gauge32", "Counter32", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", deviceNumberOfLineCords=deviceNumberOfLineCords, cloudServerAddress=cloudServerAddress, ipAddress=ipAddress, sensors=sensors, cloudServiceEnabled=cloudServiceEnabled, deviceTemperatureUnit=deviceTemperatureUnit, cloudActivationCode=cloudActivationCode, gateway=gateway, outletCycleTime=outletCycleTime, temperature1=temperature1, snmpManagerTable=snmpManagerTable, setFactoryDefaults=setFactoryDefaults, dnsServer1=dnsServer1, deviceConnector=deviceConnector, outletEntry=outletEntry, currentLC1=currentLC1, deviceNumberOfOutlets=deviceNumberOfOutlets, temperature2=temperature2, snmpManagerAddress=snmpManagerAddress, outletStatus=outletStatus, sshPort=sshPort, snmpManagerEntry=snmpManagerEntry, outletTable=outletTable, PYSNMP_MODULE_ID=iBoot_PDU_Agent, deviceTimeZone=deviceTimeZone, sslEnabled=sslEnabled, telnetEnabled=telnetEnabled, rebootRequired=rebootRequired, outletInitialState=outletInitialState, consoleTimeout=consoleTimeout, ipMode=ipMode, deviceMaxCurrent=deviceMaxCurrent, outletDelayTime=outletDelayTime, snmpReadCommunity=snmpReadCommunity, voltageLC1=voltageLC1, telnetPort=telnetPort, dnsServer2=dnsServer2, outletChange=outletChange, outletName=outletName, cloudUUID=cloudUUID, rebootSystem=rebootSystem, subnetMask=subnetMask, snmpWriteCommunity=snmpWriteCommunity, webPort=webPort, outletActualStatus=outletActualStatus, voltageLC2=voltageLC2, serialPortEnabled=serialPortEnabled, sslPort=sslPort, snmpEnabled=snmpEnabled, firmwareVersion=firmwareVersion, snmpManagerName=snmpManagerName, macAddress=macAddress, deviceName=deviceName, deviceFamily=deviceFamily, outletIndex=outletIndex, snmpManagerIndex=snmpManagerIndex, dataprobe=dataprobe, sshEnabled=sshEnabled, snmp=snmp, iBoot_PDU_Agent=iBoot_PDU_Agent, modemCountryCode=modemCountryCode, device=device, webEnabled=webEnabled, currentLC2=currentLC2, deviceCalibrated=deviceCalibrated, deviceModelName=deviceModelName, snmpTrapCommunity=snmpTrapCommunity, outletControl=outletControl, TC1=TC1, network=network, notifications=notifications, console=console)
