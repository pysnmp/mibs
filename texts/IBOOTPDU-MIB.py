...
# Produced by pysmi-1.1.12 at Fri Nov 22 15:37:50 2024
...
Bits, Unsigned32, Gauge32, NotificationType, ModuleIdentity, iso, Counter64, enterprises, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, IpAddress, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Unsigned32", "Gauge32", "NotificationType", "ModuleIdentity", "iso", "Counter64", "enterprises", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "IpAddress", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", webPort=webPort, outletName=outletName, temperature1=temperature1, sshEnabled=sshEnabled, deviceModelName=deviceModelName, dataprobe=dataprobe, snmpManagerName=snmpManagerName, firmwareVersion=firmwareVersion, cloudActivationCode=cloudActivationCode, telnetEnabled=telnetEnabled, setFactoryDefaults=setFactoryDefaults, outletCycleTime=outletCycleTime, currentLC2=currentLC2, temperature2=temperature2, deviceNumberOfOutlets=deviceNumberOfOutlets, deviceTimeZone=deviceTimeZone, sslEnabled=sslEnabled, snmpTrapCommunity=snmpTrapCommunity, ipAddress=ipAddress, deviceTemperatureUnit=deviceTemperatureUnit, deviceConnector=deviceConnector, ipMode=ipMode, webEnabled=webEnabled, outletActualStatus=outletActualStatus, currentLC1=currentLC1, gateway=gateway, telnetPort=telnetPort, deviceMaxCurrent=deviceMaxCurrent, console=console, snmpWriteCommunity=snmpWriteCommunity, deviceCalibrated=deviceCalibrated, voltageLC1=voltageLC1, snmp=snmp, cloudServiceEnabled=cloudServiceEnabled, sensors=sensors, device=device, voltageLC2=voltageLC2, TC1=TC1, rebootRequired=rebootRequired, snmpManagerEntry=snmpManagerEntry, outletChange=outletChange, outletControl=outletControl, PYSNMP_MODULE_ID=iBoot_PDU_Agent, outletDelayTime=outletDelayTime, sshPort=sshPort, deviceFamily=deviceFamily, dnsServer1=dnsServer1, snmpReadCommunity=snmpReadCommunity, snmpManagerTable=snmpManagerTable, snmpManagerIndex=snmpManagerIndex, outletIndex=outletIndex, dnsServer2=dnsServer2, outletTable=outletTable, iBoot_PDU_Agent=iBoot_PDU_Agent, snmpManagerAddress=snmpManagerAddress, cloudServerAddress=cloudServerAddress, outletInitialState=outletInitialState, deviceName=deviceName, sslPort=sslPort, outletEntry=outletEntry, modemCountryCode=modemCountryCode, deviceNumberOfLineCords=deviceNumberOfLineCords, rebootSystem=rebootSystem, serialPortEnabled=serialPortEnabled, notifications=notifications, consoleTimeout=consoleTimeout, subnetMask=subnetMask, outletStatus=outletStatus, network=network, snmpEnabled=snmpEnabled, cloudUUID=cloudUUID, macAddress=macAddress)
