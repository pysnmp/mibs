...
ObjectIdentity, MibIdentifier, Counter32, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, Bits, TimeTicks, NotificationType, Counter64, Gauge32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Counter32", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "Bits", "TimeTicks", "NotificationType", "Counter64", "Gauge32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", sslPort=sslPort, notifications=notifications, telnetPort=telnetPort, deviceNumberOfLineCords=deviceNumberOfLineCords, serialPortEnabled=serialPortEnabled, outletActualStatus=outletActualStatus, outletCycleTime=outletCycleTime, modemCountryCode=modemCountryCode, snmpWriteCommunity=snmpWriteCommunity, iBoot_PDU_Agent=iBoot_PDU_Agent, outletControl=outletControl, deviceTemperatureUnit=deviceTemperatureUnit, dnsServer1=dnsServer1, cloudServiceEnabled=cloudServiceEnabled, webEnabled=webEnabled, PYSNMP_MODULE_ID=iBoot_PDU_Agent, snmpManagerIndex=snmpManagerIndex, snmpManagerName=snmpManagerName, deviceTimeZone=deviceTimeZone, outletEntry=outletEntry, deviceName=deviceName, outletIndex=outletIndex, snmpReadCommunity=snmpReadCommunity, snmpManagerTable=snmpManagerTable, console=console, deviceFamily=deviceFamily, network=network, snmpManagerEntry=snmpManagerEntry, currentLC1=currentLC1, deviceCalibrated=deviceCalibrated, ipMode=ipMode, voltageLC2=voltageLC2, outletName=outletName, sensors=sensors, setFactoryDefaults=setFactoryDefaults, deviceConnector=deviceConnector, currentLC2=currentLC2, deviceNumberOfOutlets=deviceNumberOfOutlets, sslEnabled=sslEnabled, gateway=gateway, rebootRequired=rebootRequired, voltageLC1=voltageLC1, telnetEnabled=telnetEnabled, dataprobe=dataprobe, TC1=TC1, cloudServerAddress=cloudServerAddress, snmpEnabled=snmpEnabled, snmpTrapCommunity=snmpTrapCommunity, cloudActivationCode=cloudActivationCode, ipAddress=ipAddress, device=device, sshEnabled=sshEnabled, macAddress=macAddress, temperature2=temperature2, firmwareVersion=firmwareVersion, deviceMaxCurrent=deviceMaxCurrent, outletDelayTime=outletDelayTime, snmpManagerAddress=snmpManagerAddress, consoleTimeout=consoleTimeout, outletChange=outletChange, outletTable=outletTable, dnsServer2=dnsServer2, snmp=snmp, sshPort=sshPort, outletInitialState=outletInitialState, subnetMask=subnetMask, webPort=webPort, deviceModelName=deviceModelName, outletStatus=outletStatus, temperature1=temperature1, cloudUUID=cloudUUID, rebootSystem=rebootSystem)
