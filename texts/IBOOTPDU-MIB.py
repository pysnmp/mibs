...
# Produced by pysmi-1.1.8 at Thu Oct 12 08:15:37 2023
...
NotificationType, Counter64, Integer32, TimeTicks, IpAddress, ObjectIdentity, Unsigned32, Gauge32, Bits, MibIdentifier, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Integer32", "TimeTicks", "IpAddress", "ObjectIdentity", "Unsigned32", "Gauge32", "Bits", "MibIdentifier", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "enterprises")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", deviceNumberOfOutlets=deviceNumberOfOutlets, temperature2=temperature2, currentLC2=currentLC2, rebootRequired=rebootRequired, outletIndex=outletIndex, outletCycleTime=outletCycleTime, cloudServiceEnabled=cloudServiceEnabled, cloudUUID=cloudUUID, macAddress=macAddress, dnsServer1=dnsServer1, dataprobe=dataprobe, deviceNumberOfLineCords=deviceNumberOfLineCords, snmpEnabled=snmpEnabled, snmp=snmp, temperature1=temperature1, cloudServerAddress=cloudServerAddress, outletChange=outletChange, webEnabled=webEnabled, telnetPort=telnetPort, gateway=gateway, firmwareVersion=firmwareVersion, deviceModelName=deviceModelName, webPort=webPort, outletStatus=outletStatus, snmpManagerAddress=snmpManagerAddress, snmpManagerName=snmpManagerName, outletActualStatus=outletActualStatus, TC1=TC1, sshPort=sshPort, deviceTemperatureUnit=deviceTemperatureUnit, deviceTimeZone=deviceTimeZone, outletControl=outletControl, ipAddress=ipAddress, network=network, PYSNMP_MODULE_ID=iBoot_PDU_Agent, cloudActivationCode=cloudActivationCode, outletDelayTime=outletDelayTime, outletName=outletName, notifications=notifications, snmpManagerTable=snmpManagerTable, snmpWriteCommunity=snmpWriteCommunity, snmpTrapCommunity=snmpTrapCommunity, outletTable=outletTable, deviceName=deviceName, setFactoryDefaults=setFactoryDefaults, deviceCalibrated=deviceCalibrated, sslEnabled=sslEnabled, snmpManagerIndex=snmpManagerIndex, sensors=sensors, deviceMaxCurrent=deviceMaxCurrent, consoleTimeout=consoleTimeout, console=console, snmpReadCommunity=snmpReadCommunity, voltageLC2=voltageLC2, outletInitialState=outletInitialState, dnsServer2=dnsServer2, telnetEnabled=telnetEnabled, voltageLC1=voltageLC1, ipMode=ipMode, outletEntry=outletEntry, serialPortEnabled=serialPortEnabled, iBoot_PDU_Agent=iBoot_PDU_Agent, snmpManagerEntry=snmpManagerEntry, currentLC1=currentLC1, device=device, deviceConnector=deviceConnector, deviceFamily=deviceFamily, modemCountryCode=modemCountryCode, sslPort=sslPort, subnetMask=subnetMask, sshEnabled=sshEnabled, rebootSystem=rebootSystem)
