...
enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, NotificationType, TimeTicks, MibIdentifier, Gauge32, Counter32, ModuleIdentity, Bits, ObjectIdentity, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "NotificationType", "TimeTicks", "MibIdentifier", "Gauge32", "Counter32", "ModuleIdentity", "Bits", "ObjectIdentity", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", dnsServer1=dnsServer1, cloudActivationCode=cloudActivationCode, telnetEnabled=telnetEnabled, deviceTemperatureUnit=deviceTemperatureUnit, macAddress=macAddress, snmpTrapCommunity=snmpTrapCommunity, snmpManagerIndex=snmpManagerIndex, outletIndex=outletIndex, currentLC1=currentLC1, voltageLC2=voltageLC2, notifications=notifications, deviceName=deviceName, cloudServiceEnabled=cloudServiceEnabled, telnetPort=telnetPort, outletName=outletName, sslPort=sslPort, outletTable=outletTable, outletActualStatus=outletActualStatus, deviceCalibrated=deviceCalibrated, subnetMask=subnetMask, snmp=snmp, sslEnabled=sslEnabled, webPort=webPort, deviceNumberOfLineCords=deviceNumberOfLineCords, consoleTimeout=consoleTimeout, snmpReadCommunity=snmpReadCommunity, console=console, snmpManagerEntry=snmpManagerEntry, outletEntry=outletEntry, network=network, deviceFamily=deviceFamily, deviceConnector=deviceConnector, deviceMaxCurrent=deviceMaxCurrent, PYSNMP_MODULE_ID=iBoot_PDU_Agent, snmpManagerTable=snmpManagerTable, outletInitialState=outletInitialState, serialPortEnabled=serialPortEnabled, snmpManagerAddress=snmpManagerAddress, rebootSystem=rebootSystem, ipMode=ipMode, outletCycleTime=outletCycleTime, iBoot_PDU_Agent=iBoot_PDU_Agent, sensors=sensors, device=device, sshPort=sshPort, deviceTimeZone=deviceTimeZone, rebootRequired=rebootRequired, gateway=gateway, snmpEnabled=snmpEnabled, outletControl=outletControl, currentLC2=currentLC2, temperature2=temperature2, modemCountryCode=modemCountryCode, temperature1=temperature1, TC1=TC1, firmwareVersion=firmwareVersion, outletDelayTime=outletDelayTime, snmpManagerName=snmpManagerName, sshEnabled=sshEnabled, ipAddress=ipAddress, dnsServer2=dnsServer2, webEnabled=webEnabled, cloudServerAddress=cloudServerAddress, outletStatus=outletStatus, outletChange=outletChange, voltageLC1=voltageLC1, dataprobe=dataprobe, snmpWriteCommunity=snmpWriteCommunity, cloudUUID=cloudUUID, deviceNumberOfOutlets=deviceNumberOfOutlets, deviceModelName=deviceModelName, setFactoryDefaults=setFactoryDefaults)
