...
Counter32, TimeTicks, Gauge32, Counter64, ModuleIdentity, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, NotificationType, MibIdentifier, enterprises, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "Gauge32", "Counter64", "ModuleIdentity", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "NotificationType", "MibIdentifier", "enterprises", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", serialPortEnabled=serialPortEnabled, cloudActivationCode=cloudActivationCode, cloudServiceEnabled=cloudServiceEnabled, rebootSystem=rebootSystem, deviceName=deviceName, ipMode=ipMode, deviceModelName=deviceModelName, snmpWriteCommunity=snmpWriteCommunity, outletEntry=outletEntry, deviceConnector=deviceConnector, sslEnabled=sslEnabled, dataprobe=dataprobe, gateway=gateway, snmpManagerAddress=snmpManagerAddress, cloudServerAddress=cloudServerAddress, telnetPort=telnetPort, outletInitialState=outletInitialState, temperature1=temperature1, deviceTemperatureUnit=deviceTemperatureUnit, outletDelayTime=outletDelayTime, deviceNumberOfOutlets=deviceNumberOfOutlets, outletActualStatus=outletActualStatus, TC1=TC1, iBoot_PDU_Agent=iBoot_PDU_Agent, setFactoryDefaults=setFactoryDefaults, modemCountryCode=modemCountryCode, telnetEnabled=telnetEnabled, sshPort=sshPort, PYSNMP_MODULE_ID=iBoot_PDU_Agent, snmpManagerIndex=snmpManagerIndex, snmpReadCommunity=snmpReadCommunity, snmpManagerTable=snmpManagerTable, currentLC2=currentLC2, consoleTimeout=consoleTimeout, notifications=notifications, outletName=outletName, deviceFamily=deviceFamily, deviceCalibrated=deviceCalibrated, macAddress=macAddress, dnsServer2=dnsServer2, sslPort=sslPort, snmpTrapCommunity=snmpTrapCommunity, outletIndex=outletIndex, deviceNumberOfLineCords=deviceNumberOfLineCords, snmpEnabled=snmpEnabled, cloudUUID=cloudUUID, webPort=webPort, outletStatus=outletStatus, outletControl=outletControl, ipAddress=ipAddress, deviceMaxCurrent=deviceMaxCurrent, currentLC1=currentLC1, firmwareVersion=firmwareVersion, deviceTimeZone=deviceTimeZone, webEnabled=webEnabled, device=device, snmpManagerName=snmpManagerName, snmpManagerEntry=snmpManagerEntry, voltageLC2=voltageLC2, sshEnabled=sshEnabled, temperature2=temperature2, voltageLC1=voltageLC1, rebootRequired=rebootRequired, subnetMask=subnetMask, dnsServer1=dnsServer1, snmp=snmp, network=network, outletTable=outletTable, outletChange=outletChange, console=console, outletCycleTime=outletCycleTime, sensors=sensors)
