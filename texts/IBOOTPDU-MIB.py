...
TimeTicks, MibIdentifier, NotificationType, IpAddress, ModuleIdentity, Gauge32, enterprises, Integer32, Unsigned32, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "NotificationType", "IpAddress", "ModuleIdentity", "Gauge32", "enterprises", "Integer32", "Unsigned32", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", snmp=snmp, serialPortEnabled=serialPortEnabled, temperature1=temperature1, macAddress=macAddress, outletCycleTime=outletCycleTime, deviceModelName=deviceModelName, currentLC1=currentLC1, telnetPort=telnetPort, outletTable=outletTable, setFactoryDefaults=setFactoryDefaults, snmpManagerEntry=snmpManagerEntry, cloudActivationCode=cloudActivationCode, consoleTimeout=consoleTimeout, snmpManagerName=snmpManagerName, outletControl=outletControl, outletActualStatus=outletActualStatus, network=network, snmpManagerAddress=snmpManagerAddress, sensors=sensors, dnsServer2=dnsServer2, cloudServerAddress=cloudServerAddress, outletChange=outletChange, deviceMaxCurrent=deviceMaxCurrent, temperature2=temperature2, currentLC2=currentLC2, snmpWriteCommunity=snmpWriteCommunity, voltageLC1=voltageLC1, console=console, snmpReadCommunity=snmpReadCommunity, webEnabled=webEnabled, dataprobe=dataprobe, subnetMask=subnetMask, rebootRequired=rebootRequired, cloudServiceEnabled=cloudServiceEnabled, sshPort=sshPort, webPort=webPort, PYSNMP_MODULE_ID=iBoot_PDU_Agent, deviceNumberOfOutlets=deviceNumberOfOutlets, deviceTimeZone=deviceTimeZone, ipAddress=ipAddress, outletName=outletName, ipMode=ipMode, outletDelayTime=outletDelayTime, sslEnabled=sslEnabled, sshEnabled=sshEnabled, modemCountryCode=modemCountryCode, outletIndex=outletIndex, dnsServer1=dnsServer1, outletStatus=outletStatus, cloudUUID=cloudUUID, voltageLC2=voltageLC2, firmwareVersion=firmwareVersion, snmpManagerIndex=snmpManagerIndex, notifications=notifications, TC1=TC1, outletEntry=outletEntry, sslPort=sslPort, iBoot_PDU_Agent=iBoot_PDU_Agent, deviceTemperatureUnit=deviceTemperatureUnit, deviceName=deviceName, deviceCalibrated=deviceCalibrated, snmpManagerTable=snmpManagerTable, device=device, deviceConnector=deviceConnector, rebootSystem=rebootSystem, gateway=gateway, deviceNumberOfLineCords=deviceNumberOfLineCords, outletInitialState=outletInitialState, snmpTrapCommunity=snmpTrapCommunity, telnetEnabled=telnetEnabled, snmpEnabled=snmpEnabled, deviceFamily=deviceFamily)
