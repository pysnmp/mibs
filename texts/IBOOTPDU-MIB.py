...
NotificationType, ObjectIdentity, iso, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Counter64, TimeTicks, Unsigned32, enterprises, MibIdentifier, Gauge32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "iso", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Counter64", "TimeTicks", "Unsigned32", "enterprises", "MibIdentifier", "Gauge32", "Bits", "Integer32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", currentLC2=currentLC2, snmpManagerIndex=snmpManagerIndex, outletCycleTime=outletCycleTime, deviceTemperatureUnit=deviceTemperatureUnit, serialPortEnabled=serialPortEnabled, cloudServiceEnabled=cloudServiceEnabled, deviceTimeZone=deviceTimeZone, temperature1=temperature1, snmpReadCommunity=snmpReadCommunity, rebootSystem=rebootSystem, outletIndex=outletIndex, deviceNumberOfLineCords=deviceNumberOfLineCords, modemCountryCode=modemCountryCode, outletDelayTime=outletDelayTime, deviceName=deviceName, snmp=snmp, setFactoryDefaults=setFactoryDefaults, cloudServerAddress=cloudServerAddress, iBoot_PDU_Agent=iBoot_PDU_Agent, dnsServer2=dnsServer2, telnetPort=telnetPort, webEnabled=webEnabled, outletInitialState=outletInitialState, sensors=sensors, deviceConnector=deviceConnector, outletChange=outletChange, snmpWriteCommunity=snmpWriteCommunity, outletName=outletName, snmpManagerAddress=snmpManagerAddress, dnsServer1=dnsServer1, snmpManagerEntry=snmpManagerEntry, outletActualStatus=outletActualStatus, snmpTrapCommunity=snmpTrapCommunity, deviceCalibrated=deviceCalibrated, console=console, PYSNMP_MODULE_ID=iBoot_PDU_Agent, consoleTimeout=consoleTimeout, TC1=TC1, sshPort=sshPort, voltageLC1=voltageLC1, firmwareVersion=firmwareVersion, device=device, notifications=notifications, snmpManagerName=snmpManagerName, deviceFamily=deviceFamily, outletEntry=outletEntry, cloudActivationCode=cloudActivationCode, temperature2=temperature2, rebootRequired=rebootRequired, currentLC1=currentLC1, outletStatus=outletStatus, sshEnabled=sshEnabled, snmpEnabled=snmpEnabled, deviceNumberOfOutlets=deviceNumberOfOutlets, snmpManagerTable=snmpManagerTable, sslEnabled=sslEnabled, ipAddress=ipAddress, cloudUUID=cloudUUID, webPort=webPort, network=network, macAddress=macAddress, deviceModelName=deviceModelName, voltageLC2=voltageLC2, telnetEnabled=telnetEnabled, dataprobe=dataprobe, outletControl=outletControl, subnetMask=subnetMask, deviceMaxCurrent=deviceMaxCurrent, outletTable=outletTable, ipMode=ipMode, gateway=gateway, sslPort=sslPort)
