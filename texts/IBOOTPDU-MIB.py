...
enterprises, Counter64, TimeTicks, ObjectIdentity, NotificationType, Integer32, iso, MibIdentifier, Bits, IpAddress, Gauge32, ModuleIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Counter64", "TimeTicks", "ObjectIdentity", "NotificationType", "Integer32", "iso", "MibIdentifier", "Bits", "IpAddress", "Gauge32", "ModuleIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", subnetMask=subnetMask, gateway=gateway, firmwareVersion=firmwareVersion, outletName=outletName, device=device, temperature1=temperature1, deviceNumberOfLineCords=deviceNumberOfLineCords, outletChange=outletChange, cloudServerAddress=cloudServerAddress, PYSNMP_MODULE_ID=iBoot_PDU_Agent, cloudServiceEnabled=cloudServiceEnabled, macAddress=macAddress, ipAddress=ipAddress, snmpManagerName=snmpManagerName, outletActualStatus=outletActualStatus, telnetPort=telnetPort, snmpManagerIndex=snmpManagerIndex, snmp=snmp, sslEnabled=sslEnabled, sensors=sensors, deviceFamily=deviceFamily, cloudUUID=cloudUUID, notifications=notifications, outletEntry=outletEntry, snmpEnabled=snmpEnabled, outletCycleTime=outletCycleTime, voltageLC2=voltageLC2, snmpTrapCommunity=snmpTrapCommunity, outletIndex=outletIndex, deviceConnector=deviceConnector, deviceTimeZone=deviceTimeZone, snmpManagerAddress=snmpManagerAddress, sslPort=sslPort, outletTable=outletTable, webEnabled=webEnabled, deviceCalibrated=deviceCalibrated, snmpWriteCommunity=snmpWriteCommunity, deviceModelName=deviceModelName, dnsServer1=dnsServer1, console=console, setFactoryDefaults=setFactoryDefaults, deviceMaxCurrent=deviceMaxCurrent, sshPort=sshPort, deviceTemperatureUnit=deviceTemperatureUnit, webPort=webPort, outletDelayTime=outletDelayTime, snmpReadCommunity=snmpReadCommunity, voltageLC1=voltageLC1, modemCountryCode=modemCountryCode, dnsServer2=dnsServer2, cloudActivationCode=cloudActivationCode, consoleTimeout=consoleTimeout, snmpManagerEntry=snmpManagerEntry, rebootRequired=rebootRequired, sshEnabled=sshEnabled, serialPortEnabled=serialPortEnabled, currentLC2=currentLC2, network=network, dataprobe=dataprobe, ipMode=ipMode, iBoot_PDU_Agent=iBoot_PDU_Agent, currentLC1=currentLC1, TC1=TC1, outletControl=outletControl, snmpManagerTable=snmpManagerTable, deviceName=deviceName, rebootSystem=rebootSystem, telnetEnabled=telnetEnabled, temperature2=temperature2, outletStatus=outletStatus, outletInitialState=outletInitialState, deviceNumberOfOutlets=deviceNumberOfOutlets)
