...
# Produced by pysmi-1.1.12 at Fri Jul 19 11:34:12 2024
...
ObjectIdentity, IpAddress, enterprises, Gauge32, iso, NotificationType, Integer32, MibIdentifier, Counter32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "enterprises", "Gauge32", "iso", "NotificationType", "Integer32", "MibIdentifier", "Counter32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "Unsigned32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", PYSNMP_MODULE_ID=iBoot_PDU_Agent, outletName=outletName, dataprobe=dataprobe, telnetEnabled=telnetEnabled, snmpManagerIndex=snmpManagerIndex, snmpManagerAddress=snmpManagerAddress, temperature1=temperature1, temperature2=temperature2, sensors=sensors, sslPort=sslPort, outletEntry=outletEntry, deviceFamily=deviceFamily, network=network, cloudServiceEnabled=cloudServiceEnabled, outletStatus=outletStatus, outletCycleTime=outletCycleTime, snmpTrapCommunity=snmpTrapCommunity, currentLC1=currentLC1, device=device, deviceNumberOfOutlets=deviceNumberOfOutlets, snmpManagerName=snmpManagerName, notifications=notifications, deviceCalibrated=deviceCalibrated, subnetMask=subnetMask, outletInitialState=outletInitialState, firmwareVersion=firmwareVersion, dnsServer2=dnsServer2, snmp=snmp, webPort=webPort, outletChange=outletChange, dnsServer1=dnsServer1, deviceName=deviceName, outletDelayTime=outletDelayTime, snmpWriteCommunity=snmpWriteCommunity, deviceMaxCurrent=deviceMaxCurrent, cloudActivationCode=cloudActivationCode, snmpReadCommunity=snmpReadCommunity, telnetPort=telnetPort, cloudUUID=cloudUUID, voltageLC2=voltageLC2, rebootRequired=rebootRequired, webEnabled=webEnabled, cloudServerAddress=cloudServerAddress, TC1=TC1, macAddress=macAddress, ipAddress=ipAddress, snmpEnabled=snmpEnabled, sshPort=sshPort, snmpManagerEntry=snmpManagerEntry, outletControl=outletControl, iBoot_PDU_Agent=iBoot_PDU_Agent, deviceTimeZone=deviceTimeZone, outletIndex=outletIndex, console=console, deviceNumberOfLineCords=deviceNumberOfLineCords, snmpManagerTable=snmpManagerTable, modemCountryCode=modemCountryCode, consoleTimeout=consoleTimeout, serialPortEnabled=serialPortEnabled, rebootSystem=rebootSystem, outletTable=outletTable, sshEnabled=sshEnabled, setFactoryDefaults=setFactoryDefaults, ipMode=ipMode, currentLC2=currentLC2, deviceConnector=deviceConnector, outletActualStatus=outletActualStatus, sslEnabled=sslEnabled, deviceModelName=deviceModelName, deviceTemperatureUnit=deviceTemperatureUnit, gateway=gateway, voltageLC1=voltageLC1)
