...
IpAddress, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, MibIdentifier, Unsigned32, Counter64, Bits, Counter32, TimeTicks, NotificationType, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "Counter64", "Bits", "Counter32", "TimeTicks", "NotificationType", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", telnetEnabled=telnetEnabled, snmpWriteCommunity=snmpWriteCommunity, snmpManagerEntry=snmpManagerEntry, console=console, outletInitialState=outletInitialState, outletDelayTime=outletDelayTime, outletEntry=outletEntry, outletStatus=outletStatus, notifications=notifications, dnsServer2=dnsServer2, deviceFamily=deviceFamily, iBoot_PDU_Agent=iBoot_PDU_Agent, cloudServiceEnabled=cloudServiceEnabled, macAddress=macAddress, sslPort=sslPort, webEnabled=webEnabled, cloudServerAddress=cloudServerAddress, setFactoryDefaults=setFactoryDefaults, sshEnabled=sshEnabled, snmpManagerName=snmpManagerName, currentLC2=currentLC2, snmpManagerTable=snmpManagerTable, dataprobe=dataprobe, snmpReadCommunity=snmpReadCommunity, deviceConnector=deviceConnector, snmpManagerIndex=snmpManagerIndex, ipMode=ipMode, gateway=gateway, snmpEnabled=snmpEnabled, rebootSystem=rebootSystem, firmwareVersion=firmwareVersion, rebootRequired=rebootRequired, outletChange=outletChange, cloudUUID=cloudUUID, webPort=webPort, currentLC1=currentLC1, sensors=sensors, serialPortEnabled=serialPortEnabled, snmpManagerAddress=snmpManagerAddress, voltageLC2=voltageLC2, deviceMaxCurrent=deviceMaxCurrent, snmpTrapCommunity=snmpTrapCommunity, deviceCalibrated=deviceCalibrated, TC1=TC1, temperature1=temperature1, deviceName=deviceName, device=device, sshPort=sshPort, outletActualStatus=outletActualStatus, telnetPort=telnetPort, PYSNMP_MODULE_ID=iBoot_PDU_Agent, deviceTimeZone=deviceTimeZone, outletIndex=outletIndex, deviceModelName=deviceModelName, network=network, modemCountryCode=modemCountryCode, consoleTimeout=consoleTimeout, ipAddress=ipAddress, subnetMask=subnetMask, dnsServer1=dnsServer1, deviceNumberOfOutlets=deviceNumberOfOutlets, deviceNumberOfLineCords=deviceNumberOfLineCords, deviceTemperatureUnit=deviceTemperatureUnit, outletName=outletName, sslEnabled=sslEnabled, cloudActivationCode=cloudActivationCode, outletTable=outletTable, outletControl=outletControl, outletCycleTime=outletCycleTime, voltageLC1=voltageLC1, temperature2=temperature2, snmp=snmp)
