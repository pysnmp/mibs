...
iso, enterprises, Bits, Gauge32, Integer32, Unsigned32, ObjectIdentity, TimeTicks, IpAddress, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "Bits", "Gauge32", "Integer32", "Unsigned32", "ObjectIdentity", "TimeTicks", "IpAddress", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "MibIdentifier")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", macAddress=macAddress, outletEntry=outletEntry, deviceTimeZone=deviceTimeZone, currentLC1=currentLC1, cloudActivationCode=cloudActivationCode, snmpManagerAddress=snmpManagerAddress, modemCountryCode=modemCountryCode, webPort=webPort, sshPort=sshPort, sslPort=sslPort, dnsServer1=dnsServer1, sensors=sensors, deviceFamily=deviceFamily, deviceCalibrated=deviceCalibrated, snmpWriteCommunity=snmpWriteCommunity, firmwareVersion=firmwareVersion, setFactoryDefaults=setFactoryDefaults, PYSNMP_MODULE_ID=iBoot_PDU_Agent, snmpManagerIndex=snmpManagerIndex, snmpManagerName=snmpManagerName, snmpTrapCommunity=snmpTrapCommunity, outletName=outletName, dataprobe=dataprobe, outletInitialState=outletInitialState, outletActualStatus=outletActualStatus, snmpManagerTable=snmpManagerTable, telnetPort=telnetPort, iBoot_PDU_Agent=iBoot_PDU_Agent, deviceNumberOfOutlets=deviceNumberOfOutlets, serialPortEnabled=serialPortEnabled, telnetEnabled=telnetEnabled, temperature2=temperature2, ipMode=ipMode, voltageLC2=voltageLC2, cloudServiceEnabled=cloudServiceEnabled, voltageLC1=voltageLC1, console=console, temperature1=temperature1, sslEnabled=sslEnabled, snmpEnabled=snmpEnabled, snmpManagerEntry=snmpManagerEntry, currentLC2=currentLC2, TC1=TC1, deviceTemperatureUnit=deviceTemperatureUnit, outletControl=outletControl, gateway=gateway, deviceConnector=deviceConnector, rebootSystem=rebootSystem, outletDelayTime=outletDelayTime, notifications=notifications, deviceMaxCurrent=deviceMaxCurrent, rebootRequired=rebootRequired, outletCycleTime=outletCycleTime, outletStatus=outletStatus, webEnabled=webEnabled, outletIndex=outletIndex, dnsServer2=dnsServer2, deviceName=deviceName, snmpReadCommunity=snmpReadCommunity, network=network, deviceModelName=deviceModelName, cloudServerAddress=cloudServerAddress, outletChange=outletChange, ipAddress=ipAddress, sshEnabled=sshEnabled, deviceNumberOfLineCords=deviceNumberOfLineCords, consoleTimeout=consoleTimeout, subnetMask=subnetMask, cloudUUID=cloudUUID, device=device, outletTable=outletTable, snmp=snmp)
