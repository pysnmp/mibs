...
# Produced by pysmi-1.1.8 at Thu Sep  7 14:22:47 2023
...
ObjectIdentity, Counter64, iso, MibIdentifier, Counter32, Integer32, Unsigned32, NotificationType, IpAddress, ModuleIdentity, enterprises, Gauge32, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "iso", "MibIdentifier", "Counter32", "Integer32", "Unsigned32", "NotificationType", "IpAddress", "ModuleIdentity", "enterprises", "Gauge32", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", dataprobe=dataprobe, deviceTemperatureUnit=deviceTemperatureUnit, deviceConnector=deviceConnector, telnetEnabled=telnetEnabled, TC1=TC1, snmpTrapCommunity=snmpTrapCommunity, outletIndex=outletIndex, device=device, cloudServiceEnabled=cloudServiceEnabled, deviceTimeZone=deviceTimeZone, network=network, snmpManagerIndex=snmpManagerIndex, deviceFamily=deviceFamily, outletChange=outletChange, PYSNMP_MODULE_ID=iBoot_PDU_Agent, dnsServer2=dnsServer2, voltageLC1=voltageLC1, rebootRequired=rebootRequired, sslPort=sslPort, setFactoryDefaults=setFactoryDefaults, macAddress=macAddress, temperature2=temperature2, modemCountryCode=modemCountryCode, snmpEnabled=snmpEnabled, snmp=snmp, temperature1=temperature1, snmpManagerName=snmpManagerName, sensors=sensors, deviceCalibrated=deviceCalibrated, webEnabled=webEnabled, snmpManagerTable=snmpManagerTable, outletTable=outletTable, dnsServer1=dnsServer1, snmpReadCommunity=snmpReadCommunity, outletStatus=outletStatus, rebootSystem=rebootSystem, cloudServerAddress=cloudServerAddress, sslEnabled=sslEnabled, cloudActivationCode=cloudActivationCode, snmpManagerEntry=snmpManagerEntry, outletDelayTime=outletDelayTime, iBoot_PDU_Agent=iBoot_PDU_Agent, outletCycleTime=outletCycleTime, currentLC2=currentLC2, deviceNumberOfOutlets=deviceNumberOfOutlets, webPort=webPort, ipAddress=ipAddress, deviceName=deviceName, deviceModelName=deviceModelName, telnetPort=telnetPort, sshEnabled=sshEnabled, ipMode=ipMode, subnetMask=subnetMask, outletEntry=outletEntry, currentLC1=currentLC1, voltageLC2=voltageLC2, gateway=gateway, outletName=outletName, outletActualStatus=outletActualStatus, serialPortEnabled=serialPortEnabled, snmpManagerAddress=snmpManagerAddress, consoleTimeout=consoleTimeout, notifications=notifications, console=console, firmwareVersion=firmwareVersion, outletControl=outletControl, deviceMaxCurrent=deviceMaxCurrent, deviceNumberOfLineCords=deviceNumberOfLineCords, sshPort=sshPort, snmpWriteCommunity=snmpWriteCommunity, outletInitialState=outletInitialState, cloudUUID=cloudUUID)
