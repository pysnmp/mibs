...
# Produced by pysmi-1.1.8 at Tue Sep 12 06:57:21 2023
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, IpAddress, Bits, Integer32, ModuleIdentity, Counter32, NotificationType, Counter64, Gauge32, ObjectIdentity, iso, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "IpAddress", "Bits", "Integer32", "ModuleIdentity", "Counter32", "NotificationType", "Counter64", "Gauge32", "ObjectIdentity", "iso", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", temperature1=temperature1, gateway=gateway, cloudUUID=cloudUUID, subnetMask=subnetMask, outletChange=outletChange, dnsServer1=dnsServer1, ipMode=ipMode, outletInitialState=outletInitialState, device=device, dataprobe=dataprobe, sshPort=sshPort, notifications=notifications, outletControl=outletControl, deviceNumberOfOutlets=deviceNumberOfOutlets, serialPortEnabled=serialPortEnabled, temperature2=temperature2, cloudActivationCode=cloudActivationCode, outletIndex=outletIndex, rebootRequired=rebootRequired, ipAddress=ipAddress, voltageLC2=voltageLC2, PYSNMP_MODULE_ID=iBoot_PDU_Agent, deviceNumberOfLineCords=deviceNumberOfLineCords, snmpEnabled=snmpEnabled, outletCycleTime=outletCycleTime, snmp=snmp, outletDelayTime=outletDelayTime, outletName=outletName, cloudServiceEnabled=cloudServiceEnabled, sslEnabled=sslEnabled, snmpTrapCommunity=snmpTrapCommunity, TC1=TC1, outletStatus=outletStatus, deviceTimeZone=deviceTimeZone, outletTable=outletTable, currentLC2=currentLC2, cloudServerAddress=cloudServerAddress, snmpManagerTable=snmpManagerTable, telnetEnabled=telnetEnabled, snmpWriteCommunity=snmpWriteCommunity, deviceTemperatureUnit=deviceTemperatureUnit, sslPort=sslPort, snmpManagerIndex=snmpManagerIndex, snmpReadCommunity=snmpReadCommunity, snmpManagerName=snmpManagerName, deviceCalibrated=deviceCalibrated, setFactoryDefaults=setFactoryDefaults, outletActualStatus=outletActualStatus, deviceModelName=deviceModelName, firmwareVersion=firmwareVersion, consoleTimeout=consoleTimeout, webPort=webPort, rebootSystem=rebootSystem, webEnabled=webEnabled, outletEntry=outletEntry, console=console, deviceMaxCurrent=deviceMaxCurrent, currentLC1=currentLC1, iBoot_PDU_Agent=iBoot_PDU_Agent, sshEnabled=sshEnabled, snmpManagerEntry=snmpManagerEntry, telnetPort=telnetPort, network=network, deviceConnector=deviceConnector, deviceName=deviceName, modemCountryCode=modemCountryCode, snmpManagerAddress=snmpManagerAddress, macAddress=macAddress, deviceFamily=deviceFamily, voltageLC1=voltageLC1, sensors=sensors, dnsServer2=dnsServer2)
