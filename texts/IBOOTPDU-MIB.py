...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Integer32, Unsigned32, TimeTicks, Counter32, Counter64, MibIdentifier, iso, ModuleIdentity, NotificationType, ObjectIdentity, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Integer32", "Unsigned32", "TimeTicks", "Counter32", "Counter64", "MibIdentifier", "iso", "ModuleIdentity", "NotificationType", "ObjectIdentity", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", deviceModelName=deviceModelName, cloudServerAddress=cloudServerAddress, deviceTimeZone=deviceTimeZone, ipMode=ipMode, rebootSystem=rebootSystem, deviceMaxCurrent=deviceMaxCurrent, outletChange=outletChange, outletDelayTime=outletDelayTime, telnetPort=telnetPort, snmp=snmp, outletStatus=outletStatus, outletActualStatus=outletActualStatus, outletIndex=outletIndex, temperature2=temperature2, snmpManagerName=snmpManagerName, setFactoryDefaults=setFactoryDefaults, sshEnabled=sshEnabled, snmpManagerTable=snmpManagerTable, webEnabled=webEnabled, subnetMask=subnetMask, outletCycleTime=outletCycleTime, outletInitialState=outletInitialState, currentLC1=currentLC1, currentLC2=currentLC2, sensors=sensors, voltageLC1=voltageLC1, firmwareVersion=firmwareVersion, serialPortEnabled=serialPortEnabled, dnsServer2=dnsServer2, deviceTemperatureUnit=deviceTemperatureUnit, iBoot_PDU_Agent=iBoot_PDU_Agent, snmpWriteCommunity=snmpWriteCommunity, telnetEnabled=telnetEnabled, outletName=outletName, cloudUUID=cloudUUID, ipAddress=ipAddress, cloudServiceEnabled=cloudServiceEnabled, snmpManagerAddress=snmpManagerAddress, outletControl=outletControl, deviceNumberOfLineCords=deviceNumberOfLineCords, snmpManagerIndex=snmpManagerIndex, notifications=notifications, deviceCalibrated=deviceCalibrated, snmpManagerEntry=snmpManagerEntry, temperature1=temperature1, rebootRequired=rebootRequired, deviceFamily=deviceFamily, modemCountryCode=modemCountryCode, webPort=webPort, network=network, dataprobe=dataprobe, macAddress=macAddress, sslEnabled=sslEnabled, deviceName=deviceName, snmpTrapCommunity=snmpTrapCommunity, console=console, deviceConnector=deviceConnector, device=device, snmpReadCommunity=snmpReadCommunity, outletEntry=outletEntry, sslPort=sslPort, gateway=gateway, snmpEnabled=snmpEnabled, voltageLC2=voltageLC2, TC1=TC1, consoleTimeout=consoleTimeout, deviceNumberOfOutlets=deviceNumberOfOutlets, sshPort=sshPort, outletTable=outletTable, PYSNMP_MODULE_ID=iBoot_PDU_Agent, cloudActivationCode=cloudActivationCode, dnsServer1=dnsServer1)
