...
IpAddress, Counter64, Counter32, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, ModuleIdentity, Integer32, NotificationType, MibIdentifier, iso, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Counter32", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "ModuleIdentity", "Integer32", "NotificationType", "MibIdentifier", "iso", "Bits", "enterprises")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", outletEntry=outletEntry, webEnabled=webEnabled, outletActualStatus=outletActualStatus, macAddress=macAddress, deviceConnector=deviceConnector, temperature2=temperature2, deviceFamily=deviceFamily, sslPort=sslPort, currentLC2=currentLC2, snmpWriteCommunity=snmpWriteCommunity, snmpManagerIndex=snmpManagerIndex, snmpTrapCommunity=snmpTrapCommunity, cloudUUID=cloudUUID, device=device, cloudServiceEnabled=cloudServiceEnabled, outletIndex=outletIndex, iBoot_PDU_Agent=iBoot_PDU_Agent, consoleTimeout=consoleTimeout, TC1=TC1, outletCycleTime=outletCycleTime, outletChange=outletChange, currentLC1=currentLC1, deviceTimeZone=deviceTimeZone, telnetEnabled=telnetEnabled, snmpManagerAddress=snmpManagerAddress, serialPortEnabled=serialPortEnabled, outletInitialState=outletInitialState, outletName=outletName, temperature1=temperature1, modemCountryCode=modemCountryCode, gateway=gateway, snmpReadCommunity=snmpReadCommunity, deviceModelName=deviceModelName, ipMode=ipMode, sslEnabled=sslEnabled, outletTable=outletTable, network=network, firmwareVersion=firmwareVersion, rebootRequired=rebootRequired, deviceCalibrated=deviceCalibrated, rebootSystem=rebootSystem, deviceNumberOfLineCords=deviceNumberOfLineCords, deviceTemperatureUnit=deviceTemperatureUnit, sshPort=sshPort, snmpManagerTable=snmpManagerTable, PYSNMP_MODULE_ID=iBoot_PDU_Agent, outletControl=outletControl, voltageLC2=voltageLC2, deviceMaxCurrent=deviceMaxCurrent, sensors=sensors, deviceName=deviceName, dnsServer1=dnsServer1, outletStatus=outletStatus, outletDelayTime=outletDelayTime, deviceNumberOfOutlets=deviceNumberOfOutlets, snmpManagerName=snmpManagerName, snmpManagerEntry=snmpManagerEntry, snmp=snmp, notifications=notifications, dataprobe=dataprobe, sshEnabled=sshEnabled, voltageLC1=voltageLC1, subnetMask=subnetMask, cloudActivationCode=cloudActivationCode, console=console, ipAddress=ipAddress, webPort=webPort, setFactoryDefaults=setFactoryDefaults, telnetPort=telnetPort, snmpEnabled=snmpEnabled, dnsServer2=dnsServer2, cloudServerAddress=cloudServerAddress)
