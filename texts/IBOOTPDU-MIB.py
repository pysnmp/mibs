...
# Produced by pysmi-1.1.8 at Tue Sep 12 09:36:26 2023
...
iso, NotificationType, ModuleIdentity, Counter32, Bits, Gauge32, MibIdentifier, TimeTicks, Unsigned32, enterprises, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "ModuleIdentity", "Counter32", "Bits", "Gauge32", "MibIdentifier", "TimeTicks", "Unsigned32", "enterprises", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", firmwareVersion=firmwareVersion, outletIndex=outletIndex, dnsServer2=dnsServer2, voltageLC1=voltageLC1, setFactoryDefaults=setFactoryDefaults, deviceModelName=deviceModelName, deviceNumberOfOutlets=deviceNumberOfOutlets, iBoot_PDU_Agent=iBoot_PDU_Agent, rebootSystem=rebootSystem, dataprobe=dataprobe, snmpManagerEntry=snmpManagerEntry, sshEnabled=sshEnabled, consoleTimeout=consoleTimeout, modemCountryCode=modemCountryCode, telnetEnabled=telnetEnabled, outletEntry=outletEntry, sensors=sensors, device=device, telnetPort=telnetPort, deviceNumberOfLineCords=deviceNumberOfLineCords, outletName=outletName, outletInitialState=outletInitialState, outletChange=outletChange, webEnabled=webEnabled, outletActualStatus=outletActualStatus, sslPort=sslPort, temperature2=temperature2, serialPortEnabled=serialPortEnabled, snmpReadCommunity=snmpReadCommunity, console=console, deviceConnector=deviceConnector, rebootRequired=rebootRequired, snmpWriteCommunity=snmpWriteCommunity, snmp=snmp, cloudUUID=cloudUUID, ipAddress=ipAddress, subnetMask=subnetMask, snmpManagerTable=snmpManagerTable, cloudActivationCode=cloudActivationCode, outletTable=outletTable, deviceFamily=deviceFamily, deviceCalibrated=deviceCalibrated, outletControl=outletControl, snmpManagerAddress=snmpManagerAddress, macAddress=macAddress, outletStatus=outletStatus, snmpManagerIndex=snmpManagerIndex, notifications=notifications, deviceTemperatureUnit=deviceTemperatureUnit, outletDelayTime=outletDelayTime, webPort=webPort, outletCycleTime=outletCycleTime, currentLC1=currentLC1, temperature1=temperature1, PYSNMP_MODULE_ID=iBoot_PDU_Agent, voltageLC2=voltageLC2, deviceName=deviceName, deviceTimeZone=deviceTimeZone, dnsServer1=dnsServer1, snmpManagerName=snmpManagerName, cloudServerAddress=cloudServerAddress, sslEnabled=sslEnabled, currentLC2=currentLC2, sshPort=sshPort, deviceMaxCurrent=deviceMaxCurrent, snmpEnabled=snmpEnabled, network=network, snmpTrapCommunity=snmpTrapCommunity, ipMode=ipMode, gateway=gateway, cloudServiceEnabled=cloudServiceEnabled, TC1=TC1)
