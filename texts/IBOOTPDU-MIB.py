...
# Produced by pysmi-1.1.8 at Fri Jan 27 13:55:31 2023
...
ObjectIdentity, iso, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Integer32, Counter64, Gauge32, NotificationType, Counter32, MibIdentifier, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Integer32", "Counter64", "Gauge32", "NotificationType", "Counter32", "MibIdentifier", "Bits", "enterprises")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", snmpManagerAddress=snmpManagerAddress, deviceCalibrated=deviceCalibrated, setFactoryDefaults=setFactoryDefaults, deviceFamily=deviceFamily, deviceMaxCurrent=deviceMaxCurrent, outletStatus=outletStatus, outletActualStatus=outletActualStatus, outletIndex=outletIndex, notifications=notifications, iBoot_PDU_Agent=iBoot_PDU_Agent, outletDelayTime=outletDelayTime, sslEnabled=sslEnabled, snmpTrapCommunity=snmpTrapCommunity, PYSNMP_MODULE_ID=iBoot_PDU_Agent, deviceName=deviceName, cloudActivationCode=cloudActivationCode, webPort=webPort, serialPortEnabled=serialPortEnabled, sshEnabled=sshEnabled, device=device, network=network, snmpReadCommunity=snmpReadCommunity, macAddress=macAddress, dataprobe=dataprobe, outletEntry=outletEntry, firmwareVersion=firmwareVersion, cloudServerAddress=cloudServerAddress, outletCycleTime=outletCycleTime, dnsServer2=dnsServer2, deviceNumberOfOutlets=deviceNumberOfOutlets, console=console, sensors=sensors, snmpEnabled=snmpEnabled, snmpWriteCommunity=snmpWriteCommunity, outletInitialState=outletInitialState, voltageLC1=voltageLC1, currentLC2=currentLC2, telnetEnabled=telnetEnabled, telnetPort=telnetPort, webEnabled=webEnabled, TC1=TC1, deviceNumberOfLineCords=deviceNumberOfLineCords, ipMode=ipMode, sshPort=sshPort, cloudUUID=cloudUUID, snmpManagerTable=snmpManagerTable, snmpManagerEntry=snmpManagerEntry, dnsServer1=dnsServer1, outletName=outletName, currentLC1=currentLC1, gateway=gateway, deviceTimeZone=deviceTimeZone, subnetMask=subnetMask, rebootSystem=rebootSystem, snmp=snmp, outletTable=outletTable, temperature2=temperature2, outletChange=outletChange, deviceConnector=deviceConnector, sslPort=sslPort, temperature1=temperature1, deviceTemperatureUnit=deviceTemperatureUnit, consoleTimeout=consoleTimeout, snmpManagerName=snmpManagerName, snmpManagerIndex=snmpManagerIndex, modemCountryCode=modemCountryCode, outletControl=outletControl, deviceModelName=deviceModelName, rebootRequired=rebootRequired, voltageLC2=voltageLC2, cloudServiceEnabled=cloudServiceEnabled, ipAddress=ipAddress)
