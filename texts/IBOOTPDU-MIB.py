...
Bits, ObjectIdentity, Unsigned32, IpAddress, Counter32, Gauge32, iso, Integer32, Counter64, enterprises, MibIdentifier, NotificationType, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Unsigned32", "IpAddress", "Counter32", "Gauge32", "iso", "Integer32", "Counter64", "enterprises", "MibIdentifier", "NotificationType", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", deviceNumberOfOutlets=deviceNumberOfOutlets, sslPort=sslPort, outletStatus=outletStatus, sshPort=sshPort, deviceConnector=deviceConnector, telnetPort=telnetPort, deviceTimeZone=deviceTimeZone, subnetMask=subnetMask, gateway=gateway, snmpTrapCommunity=snmpTrapCommunity, voltageLC1=voltageLC1, sslEnabled=sslEnabled, deviceName=deviceName, snmpManagerEntry=snmpManagerEntry, firmwareVersion=firmwareVersion, consoleTimeout=consoleTimeout, PYSNMP_MODULE_ID=iBoot_PDU_Agent, deviceTemperatureUnit=deviceTemperatureUnit, snmpEnabled=snmpEnabled, rebootRequired=rebootRequired, modemCountryCode=modemCountryCode, dataprobe=dataprobe, setFactoryDefaults=setFactoryDefaults, rebootSystem=rebootSystem, outletEntry=outletEntry, outletInitialState=outletInitialState, telnetEnabled=telnetEnabled, snmpManagerAddress=snmpManagerAddress, deviceModelName=deviceModelName, serialPortEnabled=serialPortEnabled, deviceCalibrated=deviceCalibrated, device=device, outletCycleTime=outletCycleTime, cloudUUID=cloudUUID, temperature1=temperature1, snmpWriteCommunity=snmpWriteCommunity, webEnabled=webEnabled, currentLC1=currentLC1, snmpManagerName=snmpManagerName, outletTable=outletTable, cloudActivationCode=cloudActivationCode, deviceNumberOfLineCords=deviceNumberOfLineCords, console=console, dnsServer1=dnsServer1, cloudServerAddress=cloudServerAddress, notifications=notifications, snmpManagerIndex=snmpManagerIndex, snmpManagerTable=snmpManagerTable, outletActualStatus=outletActualStatus, snmp=snmp, temperature2=temperature2, outletName=outletName, deviceMaxCurrent=deviceMaxCurrent, macAddress=macAddress, dnsServer2=dnsServer2, ipMode=ipMode, iBoot_PDU_Agent=iBoot_PDU_Agent, TC1=TC1, deviceFamily=deviceFamily, outletIndex=outletIndex, voltageLC2=voltageLC2, outletDelayTime=outletDelayTime, outletChange=outletChange, sshEnabled=sshEnabled, webPort=webPort, network=network, cloudServiceEnabled=cloudServiceEnabled, snmpReadCommunity=snmpReadCommunity, outletControl=outletControl, currentLC2=currentLC2, ipAddress=ipAddress, sensors=sensors)
