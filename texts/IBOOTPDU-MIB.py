...
ModuleIdentity, Gauge32, MibIdentifier, IpAddress, iso, NotificationType, TimeTicks, Counter64, Unsigned32, enterprises, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "MibIdentifier", "IpAddress", "iso", "NotificationType", "TimeTicks", "Counter64", "Unsigned32", "enterprises", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", deviceCalibrated=deviceCalibrated, rebootSystem=rebootSystem, setFactoryDefaults=setFactoryDefaults, ipAddress=ipAddress, TC1=TC1, console=console, dnsServer2=dnsServer2, deviceFamily=deviceFamily, snmpManagerTable=snmpManagerTable, deviceConnector=deviceConnector, currentLC2=currentLC2, telnetPort=telnetPort, outletInitialState=outletInitialState, network=network, outletChange=outletChange, temperature2=temperature2, telnetEnabled=telnetEnabled, deviceModelName=deviceModelName, deviceTimeZone=deviceTimeZone, dnsServer1=dnsServer1, outletName=outletName, outletActualStatus=outletActualStatus, dataprobe=dataprobe, snmpEnabled=snmpEnabled, outletStatus=outletStatus, sslPort=sslPort, deviceNumberOfOutlets=deviceNumberOfOutlets, deviceName=deviceName, cloudUUID=cloudUUID, outletCycleTime=outletCycleTime, sshPort=sshPort, subnetMask=subnetMask, PYSNMP_MODULE_ID=iBoot_PDU_Agent, gateway=gateway, outletControl=outletControl, firmwareVersion=firmwareVersion, snmpManagerName=snmpManagerName, macAddress=macAddress, sensors=sensors, snmpTrapCommunity=snmpTrapCommunity, ipMode=ipMode, cloudServiceEnabled=cloudServiceEnabled, sslEnabled=sslEnabled, webEnabled=webEnabled, currentLC1=currentLC1, notifications=notifications, sshEnabled=sshEnabled, modemCountryCode=modemCountryCode, voltageLC2=voltageLC2, iBoot_PDU_Agent=iBoot_PDU_Agent, device=device, snmpManagerAddress=snmpManagerAddress, outletEntry=outletEntry, outletIndex=outletIndex, voltageLC1=voltageLC1, cloudServerAddress=cloudServerAddress, deviceTemperatureUnit=deviceTemperatureUnit, cloudActivationCode=cloudActivationCode, snmpManagerEntry=snmpManagerEntry, snmpReadCommunity=snmpReadCommunity, serialPortEnabled=serialPortEnabled, rebootRequired=rebootRequired, consoleTimeout=consoleTimeout, snmpManagerIndex=snmpManagerIndex, temperature1=temperature1, outletDelayTime=outletDelayTime, outletTable=outletTable, snmpWriteCommunity=snmpWriteCommunity, webPort=webPort, snmp=snmp, deviceNumberOfLineCords=deviceNumberOfLineCords, deviceMaxCurrent=deviceMaxCurrent)
