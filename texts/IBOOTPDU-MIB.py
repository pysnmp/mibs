...
iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, Counter64, Bits, IpAddress, ModuleIdentity, Counter32, NotificationType, TimeTicks, Gauge32, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "Counter64", "Bits", "IpAddress", "ModuleIdentity", "Counter32", "NotificationType", "TimeTicks", "Gauge32", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", snmpTrapCommunity=snmpTrapCommunity, snmpManagerAddress=snmpManagerAddress, firmwareVersion=firmwareVersion, deviceCalibrated=deviceCalibrated, sshPort=sshPort, TC1=TC1, outletEntry=outletEntry, gateway=gateway, outletName=outletName, voltageLC2=voltageLC2, ipAddress=ipAddress, console=console, cloudServiceEnabled=cloudServiceEnabled, cloudActivationCode=cloudActivationCode, rebootRequired=rebootRequired, snmpEnabled=snmpEnabled, snmpWriteCommunity=snmpWriteCommunity, consoleTimeout=consoleTimeout, voltageLC1=voltageLC1, currentLC2=currentLC2, temperature1=temperature1, temperature2=temperature2, deviceTimeZone=deviceTimeZone, iBoot_PDU_Agent=iBoot_PDU_Agent, deviceNumberOfLineCords=deviceNumberOfLineCords, snmpReadCommunity=snmpReadCommunity, subnetMask=subnetMask, outletChange=outletChange, deviceTemperatureUnit=deviceTemperatureUnit, macAddress=macAddress, sslEnabled=sslEnabled, deviceNumberOfOutlets=deviceNumberOfOutlets, ipMode=ipMode, outletActualStatus=outletActualStatus, currentLC1=currentLC1, outletCycleTime=outletCycleTime, cloudServerAddress=cloudServerAddress, deviceName=deviceName, telnetPort=telnetPort, setFactoryDefaults=setFactoryDefaults, device=device, PYSNMP_MODULE_ID=iBoot_PDU_Agent, outletInitialState=outletInitialState, outletIndex=outletIndex, snmp=snmp, sslPort=sslPort, dnsServer1=dnsServer1, dataprobe=dataprobe, network=network, outletControl=outletControl, modemCountryCode=modemCountryCode, snmpManagerEntry=snmpManagerEntry, snmpManagerName=snmpManagerName, snmpManagerTable=snmpManagerTable, serialPortEnabled=serialPortEnabled, sshEnabled=sshEnabled, outletTable=outletTable, outletStatus=outletStatus, deviceModelName=deviceModelName, sensors=sensors, notifications=notifications, rebootSystem=rebootSystem, deviceMaxCurrent=deviceMaxCurrent, webEnabled=webEnabled, deviceConnector=deviceConnector, deviceFamily=deviceFamily, webPort=webPort, dnsServer2=dnsServer2, snmpManagerIndex=snmpManagerIndex, cloudUUID=cloudUUID, telnetEnabled=telnetEnabled, outletDelayTime=outletDelayTime)
