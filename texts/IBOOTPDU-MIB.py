...
# Produced by pysmi-1.1.8 at Thu Dec 15 08:22:54 2022
...
ObjectIdentity, TimeTicks, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, Gauge32, enterprises, NotificationType, MibIdentifier, IpAddress, Counter64, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "Gauge32", "enterprises", "NotificationType", "MibIdentifier", "IpAddress", "Counter64", "iso", "Counter32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", subnetMask=subnetMask, deviceConnector=deviceConnector, ipAddress=ipAddress, cloudServerAddress=cloudServerAddress, outletStatus=outletStatus, deviceTemperatureUnit=deviceTemperatureUnit, snmpReadCommunity=snmpReadCommunity, outletTable=outletTable, deviceName=deviceName, cloudServiceEnabled=cloudServiceEnabled, temperature2=temperature2, sensors=sensors, webPort=webPort, webEnabled=webEnabled, telnetPort=telnetPort, snmpManagerEntry=snmpManagerEntry, setFactoryDefaults=setFactoryDefaults, snmpManagerTable=snmpManagerTable, modemCountryCode=modemCountryCode, deviceNumberOfOutlets=deviceNumberOfOutlets, dnsServer1=dnsServer1, snmpWriteCommunity=snmpWriteCommunity, ipMode=ipMode, deviceTimeZone=deviceTimeZone, macAddress=macAddress, temperature1=temperature1, rebootRequired=rebootRequired, firmwareVersion=firmwareVersion, currentLC1=currentLC1, outletDelayTime=outletDelayTime, deviceMaxCurrent=deviceMaxCurrent, TC1=TC1, device=device, serialPortEnabled=serialPortEnabled, snmp=snmp, dnsServer2=dnsServer2, sshPort=sshPort, outletChange=outletChange, consoleTimeout=consoleTimeout, notifications=notifications, outletInitialState=outletInitialState, snmpEnabled=snmpEnabled, voltageLC2=voltageLC2, gateway=gateway, sshEnabled=sshEnabled, iBoot_PDU_Agent=iBoot_PDU_Agent, rebootSystem=rebootSystem, outletCycleTime=outletCycleTime, deviceNumberOfLineCords=deviceNumberOfLineCords, console=console, deviceModelName=deviceModelName, sslPort=sslPort, dataprobe=dataprobe, sslEnabled=sslEnabled, snmpManagerAddress=snmpManagerAddress, cloudUUID=cloudUUID, outletEntry=outletEntry, PYSNMP_MODULE_ID=iBoot_PDU_Agent, snmpManagerIndex=snmpManagerIndex, outletActualStatus=outletActualStatus, outletIndex=outletIndex, outletControl=outletControl, voltageLC1=voltageLC1, deviceFamily=deviceFamily, snmpTrapCommunity=snmpTrapCommunity, telnetEnabled=telnetEnabled, outletName=outletName, deviceCalibrated=deviceCalibrated, snmpManagerName=snmpManagerName, network=network, currentLC2=currentLC2, cloudActivationCode=cloudActivationCode)
