...
MibIdentifier, ObjectIdentity, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Unsigned32, IpAddress, ModuleIdentity, enterprises, Bits, NotificationType, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Unsigned32", "IpAddress", "ModuleIdentity", "enterprises", "Bits", "NotificationType", "Counter32", "TimeTicks")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", ipAddress=ipAddress, cloudActivationCode=cloudActivationCode, sshEnabled=sshEnabled, console=console, macAddress=macAddress, outletCycleTime=outletCycleTime, deviceMaxCurrent=deviceMaxCurrent, deviceNumberOfLineCords=deviceNumberOfLineCords, cloudUUID=cloudUUID, snmpWriteCommunity=snmpWriteCommunity, cloudServerAddress=cloudServerAddress, deviceTemperatureUnit=deviceTemperatureUnit, outletActualStatus=outletActualStatus, temperature1=temperature1, device=device, serialPortEnabled=serialPortEnabled, consoleTimeout=consoleTimeout, firmwareVersion=firmwareVersion, PYSNMP_MODULE_ID=iBoot_PDU_Agent, TC1=TC1, deviceFamily=deviceFamily, snmpReadCommunity=snmpReadCommunity, outletTable=outletTable, outletStatus=outletStatus, dnsServer2=dnsServer2, ipMode=ipMode, sensors=sensors, voltageLC2=voltageLC2, sslEnabled=sslEnabled, snmpManagerIndex=snmpManagerIndex, outletEntry=outletEntry, deviceCalibrated=deviceCalibrated, outletControl=outletControl, dataprobe=dataprobe, setFactoryDefaults=setFactoryDefaults, snmpManagerName=snmpManagerName, deviceConnector=deviceConnector, telnetEnabled=telnetEnabled, sslPort=sslPort, voltageLC1=voltageLC1, gateway=gateway, outletName=outletName, snmp=snmp, rebootRequired=rebootRequired, network=network, outletDelayTime=outletDelayTime, currentLC1=currentLC1, snmpManagerTable=snmpManagerTable, outletChange=outletChange, deviceModelName=deviceModelName, iBoot_PDU_Agent=iBoot_PDU_Agent, deviceTimeZone=deviceTimeZone, outletInitialState=outletInitialState, currentLC2=currentLC2, webEnabled=webEnabled, subnetMask=subnetMask, modemCountryCode=modemCountryCode, outletIndex=outletIndex, telnetPort=telnetPort, deviceNumberOfOutlets=deviceNumberOfOutlets, snmpManagerAddress=snmpManagerAddress, snmpTrapCommunity=snmpTrapCommunity, webPort=webPort, temperature2=temperature2, notifications=notifications, cloudServiceEnabled=cloudServiceEnabled, sshPort=sshPort, dnsServer1=dnsServer1, rebootSystem=rebootSystem, snmpManagerEntry=snmpManagerEntry, deviceName=deviceName, snmpEnabled=snmpEnabled)
