...
ObjectIdentity, Unsigned32, ModuleIdentity, enterprises, Gauge32, Counter32, IpAddress, NotificationType, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "enterprises", "Gauge32", "Counter32", "IpAddress", "NotificationType", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", deviceModelName=deviceModelName, deviceNumberOfLineCords=deviceNumberOfLineCords, deviceCalibrated=deviceCalibrated, voltageLC2=voltageLC2, deviceNumberOfOutlets=deviceNumberOfOutlets, ipMode=ipMode, sslEnabled=sslEnabled, snmpReadCommunity=snmpReadCommunity, firmwareVersion=firmwareVersion, subnetMask=subnetMask, webPort=webPort, snmpManagerIndex=snmpManagerIndex, outletStatus=outletStatus, telnetEnabled=telnetEnabled, gateway=gateway, outletActualStatus=outletActualStatus, cloudServiceEnabled=cloudServiceEnabled, console=console, outletDelayTime=outletDelayTime, temperature2=temperature2, outletChange=outletChange, outletInitialState=outletInitialState, modemCountryCode=modemCountryCode, serialPortEnabled=serialPortEnabled, TC1=TC1, outletControl=outletControl, snmp=snmp, dnsServer1=dnsServer1, webEnabled=webEnabled, currentLC1=currentLC1, snmpManagerEntry=snmpManagerEntry, outletCycleTime=outletCycleTime, outletEntry=outletEntry, deviceTimeZone=deviceTimeZone, device=device, network=network, deviceMaxCurrent=deviceMaxCurrent, sshEnabled=sshEnabled, temperature1=temperature1, ipAddress=ipAddress, rebootSystem=rebootSystem, setFactoryDefaults=setFactoryDefaults, snmpWriteCommunity=snmpWriteCommunity, snmpManagerAddress=snmpManagerAddress, dnsServer2=dnsServer2, outletIndex=outletIndex, sensors=sensors, deviceName=deviceName, iBoot_PDU_Agent=iBoot_PDU_Agent, dataprobe=dataprobe, cloudUUID=cloudUUID, sslPort=sslPort, telnetPort=telnetPort, deviceTemperatureUnit=deviceTemperatureUnit, sshPort=sshPort, macAddress=macAddress, outletName=outletName, consoleTimeout=consoleTimeout, snmpManagerName=snmpManagerName, voltageLC1=voltageLC1, snmpManagerTable=snmpManagerTable, rebootRequired=rebootRequired, snmpTrapCommunity=snmpTrapCommunity, notifications=notifications, deviceFamily=deviceFamily, PYSNMP_MODULE_ID=iBoot_PDU_Agent, deviceConnector=deviceConnector, cloudServerAddress=cloudServerAddress, cloudActivationCode=cloudActivationCode, currentLC2=currentLC2, snmpEnabled=snmpEnabled, outletTable=outletTable)
