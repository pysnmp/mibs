...
Gauge32, Unsigned32, NotificationType, Counter32, Counter64, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Bits, ObjectIdentity, MibIdentifier, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "NotificationType", "Counter32", "Counter64", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Bits", "ObjectIdentity", "MibIdentifier", "IpAddress", "iso")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", dnsServer2=dnsServer2, outletActualStatus=outletActualStatus, sshEnabled=sshEnabled, firmwareVersion=firmwareVersion, rebootSystem=rebootSystem, ipAddress=ipAddress, sshPort=sshPort, webPort=webPort, outletTable=outletTable, snmpWriteCommunity=snmpWriteCommunity, outletControl=outletControl, deviceName=deviceName, deviceModelName=deviceModelName, deviceFamily=deviceFamily, cloudServiceEnabled=cloudServiceEnabled, outletName=outletName, subnetMask=subnetMask, telnetEnabled=telnetEnabled, ipMode=ipMode, outletStatus=outletStatus, cloudUUID=cloudUUID, iBoot_PDU_Agent=iBoot_PDU_Agent, snmpManagerAddress=snmpManagerAddress, deviceCalibrated=deviceCalibrated, outletDelayTime=outletDelayTime, outletEntry=outletEntry, console=console, network=network, cloudActivationCode=cloudActivationCode, macAddress=macAddress, telnetPort=telnetPort, deviceTemperatureUnit=deviceTemperatureUnit, device=device, outletIndex=outletIndex, PYSNMP_MODULE_ID=iBoot_PDU_Agent, cloudServerAddress=cloudServerAddress, outletCycleTime=outletCycleTime, deviceTimeZone=deviceTimeZone, setFactoryDefaults=setFactoryDefaults, temperature2=temperature2, currentLC2=currentLC2, sensors=sensors, outletChange=outletChange, dnsServer1=dnsServer1, deviceConnector=deviceConnector, notifications=notifications, serialPortEnabled=serialPortEnabled, snmpEnabled=snmpEnabled, TC1=TC1, consoleTimeout=consoleTimeout, snmpTrapCommunity=snmpTrapCommunity, sslPort=sslPort, modemCountryCode=modemCountryCode, rebootRequired=rebootRequired, sslEnabled=sslEnabled, voltageLC2=voltageLC2, gateway=gateway, currentLC1=currentLC1, temperature1=temperature1, dataprobe=dataprobe, deviceMaxCurrent=deviceMaxCurrent, snmpReadCommunity=snmpReadCommunity, webEnabled=webEnabled, snmpManagerEntry=snmpManagerEntry, snmp=snmp, snmpManagerName=snmpManagerName, voltageLC1=voltageLC1, snmpManagerIndex=snmpManagerIndex, outletInitialState=outletInitialState, deviceNumberOfOutlets=deviceNumberOfOutlets, snmpManagerTable=snmpManagerTable, deviceNumberOfLineCords=deviceNumberOfLineCords)
