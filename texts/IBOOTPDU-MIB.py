...
MibIdentifier, Counter64, NotificationType, Gauge32, ObjectIdentity, ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, iso, Unsigned32, TimeTicks, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "NotificationType", "Gauge32", "ObjectIdentity", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "iso", "Unsigned32", "TimeTicks", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", snmpManagerAddress=snmpManagerAddress, outletInitialState=outletInitialState, cloudServerAddress=cloudServerAddress, deviceCalibrated=deviceCalibrated, rebootSystem=rebootSystem, deviceName=deviceName, webPort=webPort, dataprobe=dataprobe, telnetEnabled=telnetEnabled, sensors=sensors, outletActualStatus=outletActualStatus, outletTable=outletTable, deviceModelName=deviceModelName, telnetPort=telnetPort, temperature1=temperature1, outletChange=outletChange, modemCountryCode=modemCountryCode, dnsServer2=dnsServer2, voltageLC2=voltageLC2, outletDelayTime=outletDelayTime, iBoot_PDU_Agent=iBoot_PDU_Agent, ipAddress=ipAddress, deviceTimeZone=deviceTimeZone, snmpManagerTable=snmpManagerTable, deviceTemperatureUnit=deviceTemperatureUnit, cloudActivationCode=cloudActivationCode, device=device, deviceNumberOfOutlets=deviceNumberOfOutlets, outletEntry=outletEntry, macAddress=macAddress, currentLC2=currentLC2, network=network, snmp=snmp, consoleTimeout=consoleTimeout, outletStatus=outletStatus, setFactoryDefaults=setFactoryDefaults, snmpWriteCommunity=snmpWriteCommunity, PYSNMP_MODULE_ID=iBoot_PDU_Agent, snmpManagerEntry=snmpManagerEntry, cloudUUID=cloudUUID, subnetMask=subnetMask, outletIndex=outletIndex, outletControl=outletControl, deviceFamily=deviceFamily, deviceMaxCurrent=deviceMaxCurrent, serialPortEnabled=serialPortEnabled, cloudServiceEnabled=cloudServiceEnabled, deviceConnector=deviceConnector, ipMode=ipMode, webEnabled=webEnabled, dnsServer1=dnsServer1, sslPort=sslPort, sslEnabled=sslEnabled, snmpReadCommunity=snmpReadCommunity, currentLC1=currentLC1, outletCycleTime=outletCycleTime, firmwareVersion=firmwareVersion, notifications=notifications, TC1=TC1, sshPort=sshPort, snmpManagerName=snmpManagerName, outletName=outletName, temperature2=temperature2, console=console, deviceNumberOfLineCords=deviceNumberOfLineCords, snmpManagerIndex=snmpManagerIndex, voltageLC1=voltageLC1, sshEnabled=sshEnabled, snmpEnabled=snmpEnabled, rebootRequired=rebootRequired, snmpTrapCommunity=snmpTrapCommunity, gateway=gateway)
