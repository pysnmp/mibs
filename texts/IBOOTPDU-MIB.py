...
NotificationType, Counter64, TimeTicks, ObjectIdentity, Unsigned32, MibIdentifier, IpAddress, ModuleIdentity, Integer32, Bits, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "TimeTicks", "ObjectIdentity", "Unsigned32", "MibIdentifier", "IpAddress", "ModuleIdentity", "Integer32", "Bits", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", outletActualStatus=outletActualStatus, macAddress=macAddress, deviceTemperatureUnit=deviceTemperatureUnit, temperature2=temperature2, deviceNumberOfLineCords=deviceNumberOfLineCords, gateway=gateway, sensors=sensors, voltageLC2=voltageLC2, snmpManagerAddress=snmpManagerAddress, device=device, sslPort=sslPort, firmwareVersion=firmwareVersion, TC1=TC1, ipMode=ipMode, deviceConnector=deviceConnector, deviceName=deviceName, rebootSystem=rebootSystem, network=network, deviceFamily=deviceFamily, telnetEnabled=telnetEnabled, snmpManagerEntry=snmpManagerEntry, snmpEnabled=snmpEnabled, snmpReadCommunity=snmpReadCommunity, snmpManagerName=snmpManagerName, outletDelayTime=outletDelayTime, outletInitialState=outletInitialState, deviceModelName=deviceModelName, outletStatus=outletStatus, currentLC1=currentLC1, temperature1=temperature1, PYSNMP_MODULE_ID=iBoot_PDU_Agent, deviceTimeZone=deviceTimeZone, sshEnabled=sshEnabled, currentLC2=currentLC2, modemCountryCode=modemCountryCode, snmpWriteCommunity=snmpWriteCommunity, serialPortEnabled=serialPortEnabled, sshPort=sshPort, webPort=webPort, deviceNumberOfOutlets=deviceNumberOfOutlets, dnsServer1=dnsServer1, outletControl=outletControl, deviceMaxCurrent=deviceMaxCurrent, cloudActivationCode=cloudActivationCode, voltageLC1=voltageLC1, iBoot_PDU_Agent=iBoot_PDU_Agent, rebootRequired=rebootRequired, setFactoryDefaults=setFactoryDefaults, console=console, snmpManagerTable=snmpManagerTable, snmpTrapCommunity=snmpTrapCommunity, outletChange=outletChange, outletCycleTime=outletCycleTime, outletTable=outletTable, cloudServerAddress=cloudServerAddress, sslEnabled=sslEnabled, webEnabled=webEnabled, telnetPort=telnetPort, deviceCalibrated=deviceCalibrated, dataprobe=dataprobe, cloudUUID=cloudUUID, cloudServiceEnabled=cloudServiceEnabled, ipAddress=ipAddress, snmpManagerIndex=snmpManagerIndex, outletName=outletName, outletEntry=outletEntry, notifications=notifications, consoleTimeout=consoleTimeout, dnsServer2=dnsServer2, outletIndex=outletIndex, subnetMask=subnetMask, snmp=snmp)
