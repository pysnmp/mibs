...
iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, ModuleIdentity, IpAddress, Counter64, TimeTicks, Counter32, enterprises, Bits, MibIdentifier, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "ModuleIdentity", "IpAddress", "Counter64", "TimeTicks", "Counter32", "enterprises", "Bits", "MibIdentifier", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", voltageLC1=voltageLC1, snmpReadCommunity=snmpReadCommunity, deviceMaxCurrent=deviceMaxCurrent, cloudServerAddress=cloudServerAddress, sshPort=sshPort, dnsServer2=dnsServer2, setFactoryDefaults=setFactoryDefaults, sensors=sensors, temperature2=temperature2, consoleTimeout=consoleTimeout, telnetPort=telnetPort, currentLC1=currentLC1, iBoot_PDU_Agent=iBoot_PDU_Agent, outletEntry=outletEntry, snmpEnabled=snmpEnabled, snmpManagerName=snmpManagerName, snmpManagerTable=snmpManagerTable, snmpTrapCommunity=snmpTrapCommunity, firmwareVersion=firmwareVersion, rebootSystem=rebootSystem, rebootRequired=rebootRequired, ipAddress=ipAddress, snmpManagerEntry=snmpManagerEntry, deviceNumberOfLineCords=deviceNumberOfLineCords, TC1=TC1, deviceTemperatureUnit=deviceTemperatureUnit, outletTable=outletTable, deviceNumberOfOutlets=deviceNumberOfOutlets, network=network, cloudServiceEnabled=cloudServiceEnabled, currentLC2=currentLC2, deviceName=deviceName, outletChange=outletChange, cloudActivationCode=cloudActivationCode, webPort=webPort, snmpManagerIndex=snmpManagerIndex, deviceTimeZone=deviceTimeZone, console=console, serialPortEnabled=serialPortEnabled, dnsServer1=dnsServer1, outletInitialState=outletInitialState, temperature1=temperature1, deviceModelName=deviceModelName, cloudUUID=cloudUUID, outletCycleTime=outletCycleTime, voltageLC2=voltageLC2, subnetMask=subnetMask, deviceCalibrated=deviceCalibrated, device=device, dataprobe=dataprobe, gateway=gateway, sslPort=sslPort, outletIndex=outletIndex, notifications=notifications, outletControl=outletControl, outletName=outletName, deviceConnector=deviceConnector, snmpWriteCommunity=snmpWriteCommunity, macAddress=macAddress, modemCountryCode=modemCountryCode, telnetEnabled=telnetEnabled, snmpManagerAddress=snmpManagerAddress, outletStatus=outletStatus, webEnabled=webEnabled, outletActualStatus=outletActualStatus, PYSNMP_MODULE_ID=iBoot_PDU_Agent, sslEnabled=sslEnabled, outletDelayTime=outletDelayTime, snmp=snmp, deviceFamily=deviceFamily, sshEnabled=sshEnabled, ipMode=ipMode)
