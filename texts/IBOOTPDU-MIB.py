...
Counter32, Integer32, Bits, Gauge32, TimeTicks, enterprises, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, iso, Unsigned32, NotificationType, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "Bits", "Gauge32", "TimeTicks", "enterprises", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "iso", "Unsigned32", "NotificationType", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("IBOOTPDU-MIB", cloudServerAddress=cloudServerAddress, outletActualStatus=outletActualStatus, dnsServer1=dnsServer1, TC1=TC1, setFactoryDefaults=setFactoryDefaults, consoleTimeout=consoleTimeout, snmpWriteCommunity=snmpWriteCommunity, outletTable=outletTable, cloudServiceEnabled=cloudServiceEnabled, sshPort=sshPort, macAddress=macAddress, outletInitialState=outletInitialState, modemCountryCode=modemCountryCode, deviceMaxCurrent=deviceMaxCurrent, console=console, temperature2=temperature2, PYSNMP_MODULE_ID=iBoot_PDU_Agent, sensors=sensors, network=network, ipMode=ipMode, webPort=webPort, outletDelayTime=outletDelayTime, outletEntry=outletEntry, snmpManagerTable=snmpManagerTable, snmp=snmp, gateway=gateway, voltageLC1=voltageLC1, rebootRequired=rebootRequired, deviceFamily=deviceFamily, cloudUUID=cloudUUID, snmpManagerEntry=snmpManagerEntry, deviceNumberOfLineCords=deviceNumberOfLineCords, snmpManagerName=snmpManagerName, snmpTrapCommunity=snmpTrapCommunity, sslPort=sslPort, serialPortEnabled=serialPortEnabled, temperature1=temperature1, deviceConnector=deviceConnector, snmpEnabled=snmpEnabled, outletIndex=outletIndex, deviceTemperatureUnit=deviceTemperatureUnit, cloudActivationCode=cloudActivationCode, outletName=outletName, outletCycleTime=outletCycleTime, device=device, deviceName=deviceName, outletChange=outletChange, dataprobe=dataprobe, deviceCalibrated=deviceCalibrated, ipAddress=ipAddress, voltageLC2=voltageLC2, sslEnabled=sslEnabled, snmpManagerIndex=snmpManagerIndex, currentLC2=currentLC2, rebootSystem=rebootSystem, snmpReadCommunity=snmpReadCommunity, telnetEnabled=telnetEnabled, outletStatus=outletStatus, currentLC1=currentLC1, telnetPort=telnetPort, deviceTimeZone=deviceTimeZone, notifications=notifications, webEnabled=webEnabled, iBoot_PDU_Agent=iBoot_PDU_Agent, dnsServer2=dnsServer2, deviceModelName=deviceModelName, sshEnabled=sshEnabled, outletControl=outletControl, deviceNumberOfOutlets=deviceNumberOfOutlets, firmwareVersion=firmwareVersion, subnetMask=subnetMask, snmpManagerAddress=snmpManagerAddress)
