...
IpAddress, ModuleIdentity, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, NotificationType, TimeTicks, experimental, ObjectIdentity, Integer32, Bits, MibIdentifier, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "NotificationType", "TimeTicks", "experimental", "ObjectIdentity", "Integer32", "Bits", "MibIdentifier", "Gauge32")
TextualConvention, DisplayString, RowPointer, TruthValue, RowStatus, StorageType, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "RowPointer", "TruthValue", "RowStatus", "StorageType", "TimeStamp")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsXCEntry=mplsXCEntry, mplsInSegmentErrors=mplsInSegmentErrors, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsLsrGroups=mplsLsrGroups, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsPerfGroup=mplsPerfGroup, MplsLSPID=MplsLSPID, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsInSegmentEntry=mplsInSegmentEntry, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsOutSegmentDown=mplsOutSegmentDown, PYSNMP_MODULE_ID=mplsLsrMIB, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInSegmentOwner=mplsInSegmentOwner, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsLabelStackTable=mplsLabelStackTable, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsInSegmentNPop=mplsInSegmentNPop, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsXCGroup=mplsXCGroup, mplsLsrNotifications=mplsLsrNotifications, MplsLabel=MplsLabel, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsLabelStackGroup=mplsLabelStackGroup, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsXCUp=mplsXCUp, mplsLabelStackLabel=mplsLabelStackLabel, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, MplsBufferSize=MplsBufferSize, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsLsrObjects=mplsLsrObjects, mplsInterfacePerfEntry=mplsInterfacePerfEntry, MplsObjectOwner=MplsObjectOwner, mplsLabelStackEntry=mplsLabelStackEntry, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsInSegmentLabel=mplsInSegmentLabel, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, MplsBurstSize=MplsBurstSize, mplsInSegmentUp=mplsInSegmentUp, mplsInSegmentGroup=mplsInSegmentGroup, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInSegmentDown=mplsInSegmentDown, mplsLsrCompliances=mplsLsrCompliances, mplsLabelStackIndex=mplsLabelStackIndex, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsOutSegmentTable=mplsOutSegmentTable, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsXCDown=mplsXCDown, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsLsrMIB=mplsLsrMIB, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsXCRowStatus=mplsXCRowStatus, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsXCOwner=mplsXCOwner, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsOutSegmentUp=mplsOutSegmentUp, mplsXCStorageType=mplsXCStorageType, mplsXCIndexNext=mplsXCIndexNext, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInSegmentTable=mplsInSegmentTable, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsTrafficParamTable=mplsTrafficParamTable, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsXCTable=mplsXCTable, MplsBitRate=MplsBitRate, mplsXCAdminStatus=mplsXCAdminStatus, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsXCLspId=mplsXCLspId, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInSegmentOctets=mplsInSegmentOctets, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsXCIndex=mplsXCIndex, mplsXCTrapEnable=mplsXCTrapEnable, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsXCIsPersistent=mplsXCIsPersistent, mplsXCOperStatus=mplsXCOperStatus, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsInterfaceGroup=mplsInterfaceGroup, mplsInSegmentPackets=mplsInSegmentPackets, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsLsrConformance=mplsLsrConformance)
