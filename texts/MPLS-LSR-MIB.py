...
StorageType, TimeStamp, TruthValue, DisplayString, RowPointer, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "StorageType", "TimeStamp", "TruthValue", "DisplayString", "RowPointer", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsOutSegmentOwner=mplsOutSegmentOwner, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsInSegmentUp=mplsInSegmentUp, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsLabelStackStorageType=mplsLabelStackStorageType, MplsLSPID=MplsLSPID, mplsLabelStackTable=mplsLabelStackTable, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsLsrGroups=mplsLsrGroups, mplsInSegmentOctets=mplsInSegmentOctets, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsXCStorageType=mplsXCStorageType, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsLabelStackGroup=mplsLabelStackGroup, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsXCAdminStatus=mplsXCAdminStatus, mplsOutSegmentPackets=mplsOutSegmentPackets, MplsBitRate=MplsBitRate, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsInSegmentEntry=mplsInSegmentEntry, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsInSegmentNPop=mplsInSegmentNPop, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsInSegmentOperStatus=mplsInSegmentOperStatus, MplsBurstSize=MplsBurstSize, mplsOutSegmentDown=mplsOutSegmentDown, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsXCGroup=mplsXCGroup, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInSegmentOwner=mplsInSegmentOwner, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsPerfGroup=mplsPerfGroup, mplsLsrMIB=mplsLsrMIB, mplsInSegmentGroup=mplsInSegmentGroup, mplsLabelStackLabel=mplsLabelStackLabel, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsInSegmentDown=mplsInSegmentDown, mplsLabelStackIndex=mplsLabelStackIndex, mplsXCIsPersistent=mplsXCIsPersistent, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsXCOperStatus=mplsXCOperStatus, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsXCIndexNext=mplsXCIndexNext, mplsLsrObjects=mplsLsrObjects, mplsLsrConformance=mplsLsrConformance, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsOutSegmentTable=mplsOutSegmentTable, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsXCIndex=mplsXCIndex, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsTrafficParamTable=mplsTrafficParamTable, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInterfaceInDiscards=mplsInterfaceInDiscards, MplsObjectOwner=MplsObjectOwner, mplsInSegmentLabel=mplsInSegmentLabel, mplsXCTrapEnable=mplsXCTrapEnable, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsXCRowStatus=mplsXCRowStatus, mplsLabelStackEntry=mplsLabelStackEntry, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInterfacePerfEntry=mplsInterfacePerfEntry, MplsBufferSize=MplsBufferSize, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsXCLspId=mplsXCLspId, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsLsrCompliances=mplsLsrCompliances, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsInSegmentErrors=mplsInSegmentErrors, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsInSegmentPackets=mplsInSegmentPackets, PYSNMP_MODULE_ID=mplsLsrMIB, mplsInterfaceGroup=mplsInterfaceGroup, mplsXCTable=mplsXCTable, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsLsrNotifications=mplsLsrNotifications, mplsInSegmentTable=mplsInSegmentTable, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsXCOwner=mplsXCOwner, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsXCDown=mplsXCDown, mplsOutSegmentUp=mplsOutSegmentUp, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsXCEntry=mplsXCEntry, mplsXCUp=mplsXCUp, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, MplsLabel=MplsLabel)
