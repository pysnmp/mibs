...
TruthValue, StorageType, RowStatus, DisplayString, RowPointer, TextualConvention, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "StorageType", "RowStatus", "DisplayString", "RowPointer", "TextualConvention", "TimeStamp")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsXCUp=mplsXCUp, MplsBufferSize=MplsBufferSize, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsXCTrapEnable=mplsXCTrapEnable, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsLsrGroups=mplsLsrGroups, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsTrafficParamTable=mplsTrafficParamTable, mplsInSegmentUp=mplsInSegmentUp, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInSegmentPackets=mplsInSegmentPackets, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsLabelStackIndex=mplsLabelStackIndex, mplsOutSegmentTable=mplsOutSegmentTable, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsXCRowStatus=mplsXCRowStatus, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsOutSegmentDown=mplsOutSegmentDown, MplsBitRate=MplsBitRate, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsLabelStackLabel=mplsLabelStackLabel, MplsLabel=MplsLabel, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsLsrCompliances=mplsLsrCompliances, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInSegmentEntry=mplsInSegmentEntry, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsLsrConformance=mplsLsrConformance, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsLsrNotifications=mplsLsrNotifications, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsXCIsPersistent=mplsXCIsPersistent, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, MplsLSPID=MplsLSPID, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsInSegmentOwner=mplsInSegmentOwner, mplsPerfGroup=mplsPerfGroup, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsXCTable=mplsXCTable, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsXCDown=mplsXCDown, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsLsrObjects=mplsLsrObjects, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInterfaceGroup=mplsInterfaceGroup, mplsInSegmentGroup=mplsInSegmentGroup, mplsInSegmentNPop=mplsInSegmentNPop, mplsXCOwner=mplsXCOwner, PYSNMP_MODULE_ID=mplsLsrMIB, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInSegmentLabel=mplsInSegmentLabel, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsXCLspId=mplsXCLspId, mplsXCAdminStatus=mplsXCAdminStatus, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsInSegmentDown=mplsInSegmentDown, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsXCOperStatus=mplsXCOperStatus, MplsBurstSize=MplsBurstSize, MplsObjectOwner=MplsObjectOwner, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsXCIndexNext=mplsXCIndexNext, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsLabelStackEntry=mplsLabelStackEntry, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInSegmentErrors=mplsInSegmentErrors, mplsLabelStackTable=mplsLabelStackTable, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsLabelStackGroup=mplsLabelStackGroup, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsXCEntry=mplsXCEntry, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInSegmentOctets=mplsInSegmentOctets, mplsXCGroup=mplsXCGroup, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsXCStorageType=mplsXCStorageType, mplsInSegmentTable=mplsInSegmentTable, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsOutSegmentUp=mplsOutSegmentUp, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsLsrMIB=mplsLsrMIB, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsXCIndex=mplsXCIndex, mplsInterfaceConfEntry=mplsInterfaceConfEntry)
