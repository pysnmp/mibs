...
DisplayString, TextualConvention, TruthValue, RowStatus, TimeStamp, RowPointer, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TruthValue", "RowStatus", "TimeStamp", "RowPointer", "StorageType")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsLabelStackTable=mplsLabelStackTable, mplsTrafficParamTable=mplsTrafficParamTable, mplsInSegmentNPop=mplsInSegmentNPop, mplsInSegmentUp=mplsInSegmentUp, mplsInSegmentDown=mplsInSegmentDown, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsXCTrapEnable=mplsXCTrapEnable, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsInSegmentErrors=mplsInSegmentErrors, mplsXCIsPersistent=mplsXCIsPersistent, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsXCAdminStatus=mplsXCAdminStatus, mplsInSegmentPackets=mplsInSegmentPackets, mplsLabelStackGroup=mplsLabelStackGroup, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, MplsBufferSize=MplsBufferSize, PYSNMP_MODULE_ID=mplsLsrMIB, mplsXCOperStatus=mplsXCOperStatus, mplsLsrCompliances=mplsLsrCompliances, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsLsrMIB=mplsLsrMIB, mplsLabelStackLabel=mplsLabelStackLabel, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsLsrNotifications=mplsLsrNotifications, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsInSegmentTable=mplsInSegmentTable, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsLsrGroups=mplsLsrGroups, mplsXCIndexNext=mplsXCIndexNext, mplsXCLspId=mplsXCLspId, mplsInSegmentEntry=mplsInSegmentEntry, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, MplsObjectOwner=MplsObjectOwner, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsXCDown=mplsXCDown, mplsXCUp=mplsXCUp, mplsInSegmentOctets=mplsInSegmentOctets, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsInSegmentGroup=mplsInSegmentGroup, mplsOutSegmentUp=mplsOutSegmentUp, mplsLabelStackIndex=mplsLabelStackIndex, mplsInSegmentLabel=mplsInSegmentLabel, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, MplsBurstSize=MplsBurstSize, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsXCTable=mplsXCTable, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsXCIndex=mplsXCIndex, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, MplsLSPID=MplsLSPID, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsXCOwner=mplsXCOwner, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, MplsLabel=MplsLabel, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsLsrConformance=mplsLsrConformance, mplsOutSegmentTable=mplsOutSegmentTable, mplsXCEntry=mplsXCEntry, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsXCStorageType=mplsXCStorageType, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsInSegmentOwner=mplsInSegmentOwner, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsLsrObjects=mplsLsrObjects, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsOutSegmentDown=mplsOutSegmentDown, mplsPerfGroup=mplsPerfGroup, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInterfaceGroup=mplsInterfaceGroup, mplsInterfaceConfTable=mplsInterfaceConfTable, MplsBitRate=MplsBitRate, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsLabelStackEntry=mplsLabelStackEntry, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsXCRowStatus=mplsXCRowStatus, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsXCGroup=mplsXCGroup)
