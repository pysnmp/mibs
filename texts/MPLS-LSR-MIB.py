...
TimeStamp, StorageType, RowPointer, DisplayString, TruthValue, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "StorageType", "RowPointer", "DisplayString", "TruthValue", "RowStatus", "TextualConvention")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsLsrObjects=mplsLsrObjects, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsXCAdminStatus=mplsXCAdminStatus, mplsXCOperStatus=mplsXCOperStatus, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsXCIsPersistent=mplsXCIsPersistent, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsXCIndexNext=mplsXCIndexNext, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsXCGroup=mplsXCGroup, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsXCTable=mplsXCTable, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsInSegmentGroup=mplsInSegmentGroup, mplsInSegmentUp=mplsInSegmentUp, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInSegmentEntry=mplsInSegmentEntry, MplsBitRate=MplsBitRate, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsOutSegmentTable=mplsOutSegmentTable, MplsObjectOwner=MplsObjectOwner, mplsLsrGroups=mplsLsrGroups, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsInterfaceGroup=mplsInterfaceGroup, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsInSegmentTable=mplsInSegmentTable, mplsOutSegmentDown=mplsOutSegmentDown, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsXCRowStatus=mplsXCRowStatus, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsLsrMIB=mplsLsrMIB, mplsLsrConformance=mplsLsrConformance, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInSegmentPackets=mplsInSegmentPackets, mplsLabelStackEntry=mplsLabelStackEntry, PYSNMP_MODULE_ID=mplsLsrMIB, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsPerfGroup=mplsPerfGroup, mplsInSegmentDown=mplsInSegmentDown, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsXCTrapEnable=mplsXCTrapEnable, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsTrafficParamTable=mplsTrafficParamTable, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsInSegmentOctets=mplsInSegmentOctets, mplsXCLspId=mplsXCLspId, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInterfaceOutFragments=mplsInterfaceOutFragments, MplsLSPID=MplsLSPID, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsOutSegmentUp=mplsOutSegmentUp, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsLabelStackIndex=mplsLabelStackIndex, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsXCDown=mplsXCDown, mplsLabelStackLabel=mplsLabelStackLabel, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, MplsBurstSize=MplsBurstSize, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsLabelStackGroup=mplsLabelStackGroup, mplsXCEntry=mplsXCEntry, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsInSegmentLabel=mplsInSegmentLabel, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsInSegmentErrors=mplsInSegmentErrors, mplsLsrNotifications=mplsLsrNotifications, mplsInSegmentOwner=mplsInSegmentOwner, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsLabelStackTable=mplsLabelStackTable, MplsBufferSize=MplsBufferSize, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsTrafficParamGroup=mplsTrafficParamGroup, MplsLabel=MplsLabel, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsXCIndex=mplsXCIndex, mplsXCStorageType=mplsXCStorageType, mplsXCUp=mplsXCUp, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInSegmentNPop=mplsInSegmentNPop, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsXCOwner=mplsXCOwner, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsLsrCompliances=mplsLsrCompliances)
