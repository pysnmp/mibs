...
RowPointer, DisplayString, TimeStamp, RowStatus, TruthValue, TextualConvention, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "DisplayString", "TimeStamp", "RowStatus", "TruthValue", "TextualConvention", "StorageType")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsXCIndex=mplsXCIndex, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsXCOwner=mplsXCOwner, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsXCIndexNext=mplsXCIndexNext, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInSegmentErrors=mplsInSegmentErrors, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsInSegmentEntry=mplsInSegmentEntry, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInterfaceGroup=mplsInterfaceGroup, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsInSegmentOctets=mplsInSegmentOctets, mplsInSegmentTable=mplsInSegmentTable, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, MplsBufferSize=MplsBufferSize, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsXCDown=mplsXCDown, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, PYSNMP_MODULE_ID=mplsLsrMIB, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsXCOperStatus=mplsXCOperStatus, mplsXCUp=mplsXCUp, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsInSegmentGroup=mplsInSegmentGroup, mplsLsrObjects=mplsLsrObjects, mplsLabelStackEntry=mplsLabelStackEntry, mplsOutSegmentDown=mplsOutSegmentDown, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsLsrGroups=mplsLsrGroups, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsLsrCompliances=mplsLsrCompliances, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsXCEntry=mplsXCEntry, mplsInSegmentUp=mplsInSegmentUp, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, MplsBurstSize=MplsBurstSize, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsLsrMIB=mplsLsrMIB, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsXCIsPersistent=mplsXCIsPersistent, mplsXCRowStatus=mplsXCRowStatus, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsXCGroup=mplsXCGroup, mplsLsrConformance=mplsLsrConformance, mplsInSegmentDown=mplsInSegmentDown, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsPerfGroup=mplsPerfGroup, mplsOutSegmentTable=mplsOutSegmentTable, mplsOutSegmentUp=mplsOutSegmentUp, MplsLSPID=MplsLSPID, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsLabelStackTable=mplsLabelStackTable, MplsBitRate=MplsBitRate, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsXCTrapEnable=mplsXCTrapEnable, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInSegmentLabel=mplsInSegmentLabel, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsXCTable=mplsXCTable, mplsLabelStackGroup=mplsLabelStackGroup, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsTrafficParamTable=mplsTrafficParamTable, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsXCStorageType=mplsXCStorageType, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsLabelStackLabel=mplsLabelStackLabel, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsXCLspId=mplsXCLspId, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsXCAdminStatus=mplsXCAdminStatus, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsInSegmentPackets=mplsInSegmentPackets, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, MplsObjectOwner=MplsObjectOwner, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsLabelStackIndex=mplsLabelStackIndex, MplsLabel=MplsLabel, mplsInSegmentNPop=mplsInSegmentNPop, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInSegmentOwner=mplsInSegmentOwner, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsLsrNotifications=mplsLsrNotifications, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsInSegmentDiscards=mplsInSegmentDiscards)
