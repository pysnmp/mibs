...
DisplayString, TimeStamp, TextualConvention, TruthValue, RowStatus, RowPointer, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "TextualConvention", "TruthValue", "RowStatus", "RowPointer", "StorageType")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsXCIndexNext=mplsXCIndexNext, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsInSegmentTable=mplsInSegmentTable, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentDown=mplsInSegmentDown, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsXCRowStatus=mplsXCRowStatus, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsTrafficParamTable=mplsTrafficParamTable, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsXCUp=mplsXCUp, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, MplsBurstSize=MplsBurstSize, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsLabelStackLabel=mplsLabelStackLabel, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsLabelStackEntry=mplsLabelStackEntry, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInSegmentOctets=mplsInSegmentOctets, MplsLabel=MplsLabel, mplsInSegmentErrors=mplsInSegmentErrors, mplsLabelStackIndex=mplsLabelStackIndex, mplsLsrNotifications=mplsLsrNotifications, mplsXCIndex=mplsXCIndex, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsXCOperStatus=mplsXCOperStatus, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsLsrGroups=mplsLsrGroups, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsOutSegmentUp=mplsOutSegmentUp, mplsInSegmentNPop=mplsInSegmentNPop, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsXCAdminStatus=mplsXCAdminStatus, mplsXCTrapEnable=mplsXCTrapEnable, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsOutSegmentDown=mplsOutSegmentDown, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsOutSegmentTable=mplsOutSegmentTable, mplsXCIsPersistent=mplsXCIsPersistent, mplsInSegmentGroup=mplsInSegmentGroup, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsXCDown=mplsXCDown, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsInSegmentUp=mplsInSegmentUp, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, MplsBitRate=MplsBitRate, PYSNMP_MODULE_ID=mplsLsrMIB, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsLsrConformance=mplsLsrConformance, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsXCOwner=mplsXCOwner, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsLabelStackGroup=mplsLabelStackGroup, mplsLsrMIB=mplsLsrMIB, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsLsrObjects=mplsLsrObjects, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsInSegmentEntry=mplsInSegmentEntry, MplsLSPID=MplsLSPID, mplsLsrCompliances=mplsLsrCompliances, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsInterfaceGroup=mplsInterfaceGroup, mplsXCEntry=mplsXCEntry, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, MplsObjectOwner=MplsObjectOwner, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, MplsBufferSize=MplsBufferSize, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsLabelStackTable=mplsLabelStackTable, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsXCLspId=mplsXCLspId, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsPerfGroup=mplsPerfGroup, mplsXCStorageType=mplsXCStorageType, mplsInSegmentLabel=mplsInSegmentLabel, mplsXCGroup=mplsXCGroup, mplsXCTable=mplsXCTable, mplsInSegmentPackets=mplsInSegmentPackets, mplsInSegmentOwner=mplsInSegmentOwner, mplsOutSegmentDiscards=mplsOutSegmentDiscards)
