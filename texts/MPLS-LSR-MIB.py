...
DisplayString, TimeStamp, StorageType, TextualConvention, RowStatus, TruthValue, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "StorageType", "TextualConvention", "RowStatus", "TruthValue", "RowPointer")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsXCDown=mplsXCDown, mplsXCIndex=mplsXCIndex, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInSegmentOctets=mplsInSegmentOctets, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsLabelStackEntry=mplsLabelStackEntry, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsPerfGroup=mplsPerfGroup, MplsBurstSize=MplsBurstSize, mplsXCLspId=mplsXCLspId, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentTable=mplsOutSegmentTable, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsLsrObjects=mplsLsrObjects, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsInSegmentOwner=mplsInSegmentOwner, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsXCTrapEnable=mplsXCTrapEnable, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsXCIndexNext=mplsXCIndexNext, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, MplsLabel=MplsLabel, mplsInSegmentDown=mplsInSegmentDown, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsXCOwner=mplsXCOwner, mplsInterfaceGroup=mplsInterfaceGroup, mplsLabelStackTable=mplsLabelStackTable, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, PYSNMP_MODULE_ID=mplsLsrMIB, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsLabelStackIndex=mplsLabelStackIndex, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsInSegmentNPop=mplsInSegmentNPop, mplsInSegmentLabel=mplsInSegmentLabel, MplsLSPID=MplsLSPID, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsLsrMIB=mplsLsrMIB, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, MplsObjectOwner=MplsObjectOwner, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsLsrGroups=mplsLsrGroups, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsInSegmentErrors=mplsInSegmentErrors, mplsInSegmentPackets=mplsInSegmentPackets, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, MplsBufferSize=MplsBufferSize, mplsXCEntry=mplsXCEntry, mplsTrafficParamTable=mplsTrafficParamTable, mplsOutSegmentDown=mplsOutSegmentDown, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsXCGroup=mplsXCGroup, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsXCIsPersistent=mplsXCIsPersistent, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsXCStorageType=mplsXCStorageType, mplsXCAdminStatus=mplsXCAdminStatus, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsXCOperStatus=mplsXCOperStatus, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsLabelStackGroup=mplsLabelStackGroup, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsXCRowStatus=mplsXCRowStatus, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsInSegmentGroup=mplsInSegmentGroup, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsLabelStackLabel=mplsLabelStackLabel, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsLsrConformance=mplsLsrConformance, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsOutSegmentUp=mplsOutSegmentUp, mplsLsrCompliances=mplsLsrCompliances, mplsInSegmentUp=mplsInSegmentUp, mplsLsrNotifications=mplsLsrNotifications, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, MplsBitRate=MplsBitRate, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsXCUp=mplsXCUp, mplsInSegmentTable=mplsInSegmentTable, mplsXCTable=mplsXCTable, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsLsrNotificationGroup=mplsLsrNotificationGroup)
