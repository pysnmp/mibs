...
TimeStamp, TextualConvention, RowStatus, DisplayString, TruthValue, StorageType, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "TextualConvention", "RowStatus", "DisplayString", "TruthValue", "StorageType", "RowPointer")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsXCTable=mplsXCTable, mplsXCIndexNext=mplsXCIndexNext, mplsXCStorageType=mplsXCStorageType, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsLsrGroups=mplsLsrGroups, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsXCIsPersistent=mplsXCIsPersistent, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsOutSegmentUp=mplsOutSegmentUp, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsPerfGroup=mplsPerfGroup, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsXCIndex=mplsXCIndex, mplsLabelStackGroup=mplsLabelStackGroup, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsXCLspId=mplsXCLspId, MplsLSPID=MplsLSPID, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInSegmentEntry=mplsInSegmentEntry, MplsBufferSize=MplsBufferSize, mplsXCOwner=mplsXCOwner, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsXCDown=mplsXCDown, mplsInSegmentHCOctets=mplsInSegmentHCOctets, PYSNMP_MODULE_ID=mplsLsrMIB, mplsXCGroup=mplsXCGroup, mplsLsrConformance=mplsLsrConformance, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsInterfaceGroup=mplsInterfaceGroup, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsTrafficParamTable=mplsTrafficParamTable, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsInSegmentTable=mplsInSegmentTable, mplsLabelStackIndex=mplsLabelStackIndex, mplsInSegmentDown=mplsInSegmentDown, mplsLabelStackEntry=mplsLabelStackEntry, mplsLsrMIB=mplsLsrMIB, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInSegmentNPop=mplsInSegmentNPop, MplsBurstSize=MplsBurstSize, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsXCAdminStatus=mplsXCAdminStatus, mplsInSegmentOwner=mplsInSegmentOwner, mplsInSegmentErrors=mplsInSegmentErrors, mplsInSegmentLabel=mplsInSegmentLabel, mplsOutSegmentDown=mplsOutSegmentDown, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsXCTrapEnable=mplsXCTrapEnable, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInSegmentUp=mplsInSegmentUp, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsOutSegmentTable=mplsOutSegmentTable, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, MplsObjectOwner=MplsObjectOwner, mplsXCUp=mplsXCUp, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsLsrNotifications=mplsLsrNotifications, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsInSegmentPackets=mplsInSegmentPackets, mplsXCOperStatus=mplsXCOperStatus, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInSegmentOctets=mplsInSegmentOctets, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, MplsLabel=MplsLabel, mplsInSegmentGroup=mplsInSegmentGroup, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsXCRowStatus=mplsXCRowStatus, mplsLsrObjects=mplsLsrObjects, mplsXCEntry=mplsXCEntry, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsLsrCompliances=mplsLsrCompliances, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsLabelStackTable=mplsLabelStackTable, MplsBitRate=MplsBitRate, mplsLabelStackLabel=mplsLabelStackLabel)
