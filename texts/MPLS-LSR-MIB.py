...
TruthValue, DisplayString, RowStatus, RowPointer, TimeStamp, TextualConvention, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "RowStatus", "RowPointer", "TimeStamp", "TextualConvention", "StorageType")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", MplsLSPID=MplsLSPID, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsXCOwner=mplsXCOwner, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, MplsBitRate=MplsBitRate, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInSegmentLabel=mplsInSegmentLabel, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsXCStorageType=mplsXCStorageType, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsXCTrapEnable=mplsXCTrapEnable, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsXCUp=mplsXCUp, mplsLabelStackGroup=mplsLabelStackGroup, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsLsrCompliances=mplsLsrCompliances, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsOutSegmentDown=mplsOutSegmentDown, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentErrors=mplsInSegmentErrors, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, MplsObjectOwner=MplsObjectOwner, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsInSegmentTable=mplsInSegmentTable, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsLabelStackTable=mplsLabelStackTable, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsXCLspId=mplsXCLspId, mplsPerfGroup=mplsPerfGroup, mplsXCRowStatus=mplsXCRowStatus, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsLsrObjects=mplsLsrObjects, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsLabelStackLabel=mplsLabelStackLabel, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsXCEntry=mplsXCEntry, mplsXCTable=mplsXCTable, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInSegmentOctets=mplsInSegmentOctets, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInSegmentOwner=mplsInSegmentOwner, mplsInSegmentDown=mplsInSegmentDown, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsLabelStackRowStatus=mplsLabelStackRowStatus, PYSNMP_MODULE_ID=mplsLsrMIB, mplsLabelStackIndex=mplsLabelStackIndex, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, MplsBufferSize=MplsBufferSize, mplsLsrGroups=mplsLsrGroups, mplsTrafficParamTable=mplsTrafficParamTable, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsInterfaceGroup=mplsInterfaceGroup, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsXCOperStatus=mplsXCOperStatus, mplsXCDown=mplsXCDown, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsXCIndex=mplsXCIndex, mplsLsrConformance=mplsLsrConformance, MplsLabel=MplsLabel, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsXCAdminStatus=mplsXCAdminStatus, mplsLsrMIB=mplsLsrMIB, MplsBurstSize=MplsBurstSize, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsLsrNotifications=mplsLsrNotifications, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsInSegmentNPop=mplsInSegmentNPop, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsInSegmentUp=mplsInSegmentUp, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsXCIsPersistent=mplsXCIsPersistent, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsXCGroup=mplsXCGroup, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsOutSegmentTable=mplsOutSegmentTable, mplsXCIndexNext=mplsXCIndexNext, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsInSegmentGroup=mplsInSegmentGroup, mplsLabelStackEntry=mplsLabelStackEntry, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsInSegmentPackets=mplsInSegmentPackets, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsOutSegmentUp=mplsOutSegmentUp)
