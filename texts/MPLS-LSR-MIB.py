...
RowPointer, TextualConvention, TimeStamp, StorageType, DisplayString, RowStatus, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TextualConvention", "TimeStamp", "StorageType", "DisplayString", "RowStatus", "TruthValue")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsXCLspId=mplsXCLspId, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, MplsBufferSize=MplsBufferSize, mplsLsrCompliances=mplsLsrCompliances, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsXCDown=mplsXCDown, mplsXCOperStatus=mplsXCOperStatus, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsXCOwner=mplsXCOwner, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, MplsLabel=MplsLabel, mplsOutSegmentGroup=mplsOutSegmentGroup, MplsBurstSize=MplsBurstSize, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsLabelStackIndex=mplsLabelStackIndex, mplsInSegmentOctets=mplsInSegmentOctets, mplsLabelStackEntry=mplsLabelStackEntry, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsLsrMIB=mplsLsrMIB, mplsLsrNotifications=mplsLsrNotifications, mplsXCAdminStatus=mplsXCAdminStatus, mplsOutSegmentStorageType=mplsOutSegmentStorageType, PYSNMP_MODULE_ID=mplsLsrMIB, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsXCGroup=mplsXCGroup, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsOutSegmentUp=mplsOutSegmentUp, mplsXCTable=mplsXCTable, mplsInterfaceGroup=mplsInterfaceGroup, mplsInterfaceInDiscards=mplsInterfaceInDiscards, MplsObjectOwner=MplsObjectOwner, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsInSegmentNPop=mplsInSegmentNPop, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsXCEntry=mplsXCEntry, mplsInSegmentDown=mplsInSegmentDown, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsXCTrapEnable=mplsXCTrapEnable, mplsOutSegmentDown=mplsOutSegmentDown, MplsBitRate=MplsBitRate, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsOutSegmentTable=mplsOutSegmentTable, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsLabelStackGroup=mplsLabelStackGroup, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsTrafficParamTable=mplsTrafficParamTable, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsInSegmentTable=mplsInSegmentTable, mplsInSegmentGroup=mplsInSegmentGroup, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsLsrObjects=mplsLsrObjects, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsInSegmentLabel=mplsInSegmentLabel, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInSegmentErrors=mplsInSegmentErrors, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsInSegmentOwner=mplsInSegmentOwner, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsXCIndexNext=mplsXCIndexNext, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsInSegmentEntry=mplsInSegmentEntry, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, MplsLSPID=MplsLSPID, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsPerfGroup=mplsPerfGroup, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsXCIndex=mplsXCIndex, mplsLsrConformance=mplsLsrConformance, mplsLabelStackTable=mplsLabelStackTable, mplsXCRowStatus=mplsXCRowStatus, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsXCIsPersistent=mplsXCIsPersistent, mplsInSegmentPackets=mplsInSegmentPackets, mplsLsrGroups=mplsLsrGroups, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsInSegmentUp=mplsInSegmentUp, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsXCStorageType=mplsXCStorageType, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsLabelStackLabel=mplsLabelStackLabel, mplsXCUp=mplsXCUp)
