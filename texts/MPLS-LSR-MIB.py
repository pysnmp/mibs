...
RowPointer, TimeStamp, TextualConvention, DisplayString, RowStatus, TruthValue, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "RowPointer", "TimeStamp", "TextualConvention", "DisplayString", "RowStatus", "TruthValue", "StorageType")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsXCOwner=mplsXCOwner, mplsInterfaceGroup=mplsInterfaceGroup, mplsXCLspId=mplsXCLspId, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsXCRowStatus=mplsXCRowStatus, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsLsrObjects=mplsLsrObjects, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsLabelStackTable=mplsLabelStackTable, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInSegmentXCIndex=mplsInSegmentXCIndex, MplsLabel=MplsLabel, mplsLabelStackEntry=mplsLabelStackEntry, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsInSegmentPackets=mplsInSegmentPackets, mplsXCDown=mplsXCDown, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsXCGroup=mplsXCGroup, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsLabelStackLabel=mplsLabelStackLabel, mplsXCIsPersistent=mplsXCIsPersistent, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInSegmentOctets=mplsInSegmentOctets, MplsBufferSize=MplsBufferSize, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, MplsObjectOwner=MplsObjectOwner, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsXCAdminStatus=mplsXCAdminStatus, MplsBitRate=MplsBitRate, mplsXCTable=mplsXCTable, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, PYSNMP_MODULE_ID=mplsLsrMIB, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsLabelStackGroup=mplsLabelStackGroup, MplsLSPID=MplsLSPID, mplsInSegmentErrors=mplsInSegmentErrors, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInSegmentLabel=mplsInSegmentLabel, mplsXCStorageType=mplsXCStorageType, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsXCOperStatus=mplsXCOperStatus, mplsPerfGroup=mplsPerfGroup, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsLsrNotifications=mplsLsrNotifications, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsLsrCompliances=mplsLsrCompliances, mplsXCEntry=mplsXCEntry, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInSegmentDown=mplsInSegmentDown, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsTrafficParamTable=mplsTrafficParamTable, mplsXCUp=mplsXCUp, mplsXCTrapEnable=mplsXCTrapEnable, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, MplsBurstSize=MplsBurstSize, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsOutSegmentUp=mplsOutSegmentUp, mplsLabelStackIndex=mplsLabelStackIndex, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsLsrGroups=mplsLsrGroups, mplsInSegmentGroup=mplsInSegmentGroup, mplsOutSegmentDown=mplsOutSegmentDown, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsLsrConformance=mplsLsrConformance, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsInSegmentNPop=mplsInSegmentNPop, mplsXCIndexNext=mplsXCIndexNext, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInSegmentEntry=mplsInSegmentEntry, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsXCIndex=mplsXCIndex, mplsInSegmentUp=mplsInSegmentUp, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsOutSegmentTable=mplsOutSegmentTable, mplsLsrMIB=mplsLsrMIB, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsInSegmentOwner=mplsInSegmentOwner, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsInSegmentTable=mplsInSegmentTable)
