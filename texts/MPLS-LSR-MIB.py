...
TruthValue, TimeStamp, StorageType, TextualConvention, RowStatus, DisplayString, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeStamp", "StorageType", "TextualConvention", "RowStatus", "DisplayString", "RowPointer")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsLsrGroups=mplsLsrGroups, mplsLabelStackLabel=mplsLabelStackLabel, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsInSegmentLabel=mplsInSegmentLabel, mplsLabelStackTable=mplsLabelStackTable, mplsInSegmentUp=mplsInSegmentUp, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsInterfaceGroup=mplsInterfaceGroup, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsOutSegmentTable=mplsOutSegmentTable, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsXCGroup=mplsXCGroup, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsLabelStackIndex=mplsLabelStackIndex, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsXCIndex=mplsXCIndex, mplsInSegmentGroup=mplsInSegmentGroup, mplsXCUp=mplsXCUp, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, MplsLSPID=MplsLSPID, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, MplsBurstSize=MplsBurstSize, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsLabelStackGroup=mplsLabelStackGroup, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, MplsObjectOwner=MplsObjectOwner, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, PYSNMP_MODULE_ID=mplsLsrMIB, mplsXCIsPersistent=mplsXCIsPersistent, mplsInSegmentPackets=mplsInSegmentPackets, mplsInSegmentDown=mplsInSegmentDown, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsLsrNotifications=mplsLsrNotifications, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsInSegmentOctets=mplsInSegmentOctets, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsXCOwner=mplsXCOwner, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsOutSegmentUp=mplsOutSegmentUp, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsLsrMIB=mplsLsrMIB, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsInSegmentOwner=mplsInSegmentOwner, mplsXCTable=mplsXCTable, mplsTrafficParamTable=mplsTrafficParamTable, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsXCOperStatus=mplsXCOperStatus, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsXCEntry=mplsXCEntry, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsXCRowStatus=mplsXCRowStatus, mplsXCDown=mplsXCDown, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsLsrObjects=mplsLsrObjects, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsXCTrapEnable=mplsXCTrapEnable, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsXCLspId=mplsXCLspId, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsXCStorageType=mplsXCStorageType, mplsInSegmentTable=mplsInSegmentTable, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsXCAdminStatus=mplsXCAdminStatus, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsLsrCompliances=mplsLsrCompliances, mplsInSegmentErrors=mplsInSegmentErrors, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, MplsLabel=MplsLabel, mplsLabelStackEntry=mplsLabelStackEntry, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsInSegmentNPop=mplsInSegmentNPop, MplsBufferSize=MplsBufferSize, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsPerfGroup=mplsPerfGroup, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsXCIndexNext=mplsXCIndexNext, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsOutSegmentDown=mplsOutSegmentDown, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsLsrConformance=mplsLsrConformance, MplsBitRate=MplsBitRate, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsLsrModuleCompliance=mplsLsrModuleCompliance)
