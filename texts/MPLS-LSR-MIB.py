...
TruthValue, TextualConvention, StorageType, TimeStamp, DisplayString, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "StorageType", "TimeStamp", "DisplayString", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsLsrObjects=mplsLsrObjects, MplsObjectOwner=MplsObjectOwner, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsOutSegmentTable=mplsOutSegmentTable, mplsOutSegmentOwner=mplsOutSegmentOwner, MplsBufferSize=MplsBufferSize, mplsLabelStackGroup=mplsLabelStackGroup, mplsLabelStackTable=mplsLabelStackTable, mplsXCTrapEnable=mplsXCTrapEnable, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsXCAdminStatus=mplsXCAdminStatus, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsXCStorageType=mplsXCStorageType, mplsLsrGroups=mplsLsrGroups, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsLabelStackIndex=mplsLabelStackIndex, mplsInSegmentTable=mplsInSegmentTable, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsXCGroup=mplsXCGroup, MplsBitRate=MplsBitRate, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsPerfGroup=mplsPerfGroup, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsInSegmentUp=mplsInSegmentUp, mplsInSegmentPackets=mplsInSegmentPackets, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsInSegmentLabel=mplsInSegmentLabel, mplsInSegmentOctets=mplsInSegmentOctets, MplsBurstSize=MplsBurstSize, mplsXCIsPersistent=mplsXCIsPersistent, mplsInSegmentOwner=mplsInSegmentOwner, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsTrafficParamTable=mplsTrafficParamTable, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, MplsLabel=MplsLabel, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInSegmentErrors=mplsInSegmentErrors, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsInSegmentDown=mplsInSegmentDown, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsLsrConformance=mplsLsrConformance, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsLabelStackEntry=mplsLabelStackEntry, mplsOutSegmentUp=mplsOutSegmentUp, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsXCOwner=mplsXCOwner, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsXCOperStatus=mplsXCOperStatus, mplsXCUp=mplsXCUp, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsInSegmentGroup=mplsInSegmentGroup, mplsInSegmentEntry=mplsInSegmentEntry, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsXCTable=mplsXCTable, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsLsrNotifications=mplsLsrNotifications, mplsInterfaceGroup=mplsInterfaceGroup, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsInSegmentNPop=mplsInSegmentNPop, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsLsrMIB=mplsLsrMIB, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsOutSegmentDown=mplsOutSegmentDown, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsXCEntry=mplsXCEntry, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsXCDown=mplsXCDown, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsLsrCompliances=mplsLsrCompliances, mplsLabelStackLabel=mplsLabelStackLabel, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, MplsLSPID=MplsLSPID, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsXCRowStatus=mplsXCRowStatus, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsXCLspId=mplsXCLspId, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsXCIndex=mplsXCIndex, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsXCIndexNext=mplsXCIndexNext, PYSNMP_MODULE_ID=mplsLsrMIB, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsTrafficParamStorageType=mplsTrafficParamStorageType)
