...
RowStatus, DisplayString, TruthValue, TextualConvention, StorageType, TimeStamp, RowPointer = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TruthValue", "TextualConvention", "StorageType", "TimeStamp", "RowPointer")
...
mibBuilder.exportSymbols("MPLS-LSR-MIB", mplsLabelStackIndex=mplsLabelStackIndex, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsInSegmentLabel=mplsInSegmentLabel, mplsInSegmentAdminStatus=mplsInSegmentAdminStatus, mplsOutSegmentTable=mplsOutSegmentTable, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsXCDown=mplsXCDown, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsLsrObjects=mplsLsrObjects, mplsXCAdminStatus=mplsXCAdminStatus, mplsXCOwner=mplsXCOwner, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsInSegmentTable=mplsInSegmentTable, mplsLabelStackLabel=mplsLabelStackLabel, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, mplsXCRowStatus=mplsXCRowStatus, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsInterfaceInPackets=mplsInterfaceInPackets, mplsLsrNotifications=mplsLsrNotifications, mplsInterfaceOutDiscards=mplsInterfaceOutDiscards, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsXCOperStatus=mplsXCOperStatus, mplsXCGroup=mplsXCGroup, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsInSegmentEntry=mplsInSegmentEntry, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsInSegmentTrapEnable=mplsInSegmentTrapEnable, mplsOutSegmentTrapEnable=mplsOutSegmentTrapEnable, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsInSegmentUp=mplsInSegmentUp, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsXCUp=mplsXCUp, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsXCLspId=mplsXCLspId, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, mplsXCStorageType=mplsXCStorageType, mplsXCIsPersistent=mplsXCIsPersistent, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInterfaceTotalBuffer=mplsInterfaceTotalBuffer, mplsInterfaceInDiscards=mplsInterfaceInDiscards, mplsInterfaceGroup=mplsInterfaceGroup, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, MplsBurstSize=MplsBurstSize, mplsInSegmentStorageType=mplsInSegmentStorageType, MplsBufferSize=MplsBufferSize, mplsOutSegmentOperStatus=mplsOutSegmentOperStatus, mplsXCIndexNext=mplsXCIndexNext, mplsInSegmentPerfTable=mplsInSegmentPerfTable, MplsObjectOwner=MplsObjectOwner, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInSegmentOctets=mplsInSegmentOctets, mplsInSegmentOperStatus=mplsInSegmentOperStatus, mplsXCEntry=mplsXCEntry, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsOutSegmentDown=mplsOutSegmentDown, mplsOutSegmentDiscards=mplsOutSegmentDiscards, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsLsrGroups=mplsLsrGroups, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsLabelStackTable=mplsLabelStackTable, MplsLSPID=MplsLSPID, mplsTrafficParamTable=mplsTrafficParamTable, mplsInSegmentOwner=mplsInSegmentOwner, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsXCTable=mplsXCTable, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsLabelStackEntry=mplsLabelStackEntry, mplsXCIndex=mplsXCIndex, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, MplsLabel=MplsLabel, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsPerfGroup=mplsPerfGroup, mplsInSegmentNPop=mplsInSegmentNPop, mplsInterfaceOutPackets=mplsInterfaceOutPackets, mplsInSegmentErrors=mplsInSegmentErrors, mplsOutSegmentAdminStatus=mplsOutSegmentAdminStatus, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsOutSegmentUp=mplsOutSegmentUp, mplsLabelStackGroup=mplsLabelStackGroup, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsInSegmentPackets=mplsInSegmentPackets, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInterfaceAvailableBuffer=mplsInterfaceAvailableBuffer, mplsLabelStackRowStatus=mplsLabelStackRowStatus, MplsBitRate=MplsBitRate, mplsInSegmentDown=mplsInSegmentDown, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, PYSNMP_MODULE_ID=mplsLsrMIB, mplsLsrConformance=mplsLsrConformance, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsXCTrapEnable=mplsXCTrapEnable, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsInSegmentGroup=mplsInSegmentGroup, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsLsrMIB=mplsLsrMIB, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsLsrCompliances=mplsLsrCompliances, mplsOutSegmentOctets=mplsOutSegmentOctets)
