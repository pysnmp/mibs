...
Bits, TimeTicks, MibIdentifier, Unsigned32, Counter64, Gauge32, iso, Counter32, IpAddress, NotificationType, ObjectIdentity, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "MibIdentifier", "Unsigned32", "Counter64", "Gauge32", "iso", "Counter32", "IpAddress", "NotificationType", "ObjectIdentity", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkVLAN=gtNetworkVLAN, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTimeZone=gtTimeZone, gtPortsFloodMulticast=gtPortsFloodMulticast, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtHMSGroupName=gtHMSGroupName, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSyslogState=gtSyslogState, gtNetworkPortVLAN=gtNetworkPortVLAN, gtModuleBackupControl=gtModuleBackupControl, gtFilename=gtFilename, gtSWOptionsTable=gtSWOptionsTable, gtWebProtocol=gtWebProtocol, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceSNMP=gtInterfaceSNMP, gtDNSTable=gtDNSTable, gtPortsTable=gtPortsTable, gtServicesEntry=gtServicesEntry, gtNetworkTable=gtNetworkTable, gtWebAuth=gtWebAuth, gtTrapDestPort=gtTrapDestPort, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserPassword=gtUserPassword, gtSWOption=gtSWOption, gtModuleBackupTable=gtModuleBackupTable, gtSyslogTable=gtSyslogTable, gtGroupEntry=gtGroupEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupAccesslist=gtGroupAccesslist, gtGroupRights=gtGroupRights, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserIdx=gtUserIdx, gtWebEnable=gtWebEnable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtGroupIdx=gtGroupIdx, gtModuleBackup=gtModuleBackup, gtNTPServerEntry=gtNTPServerEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtDNSEntry=gtDNSEntry, gtUserAuthTable=gtUserAuthTable, gtPortsLinkup=gtPortsLinkup, gtDateAndTime=gtDateAndTime, gtDateAndTimeTable=gtDateAndTimeTable, gtUser=gtUser, gtPortsNumber=gtPortsNumber, gtAccesslistEntry=gtAccesslistEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceCLI=gtInterfaceCLI, gtModuleUpdate=gtModuleUpdate, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSyslogEntry=gtSyslogEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtSFPSpeed=gtSFPSpeed, gtSFTPServer=gtSFTPServer, gtSFPEntry=gtSFPEntry, gtInterfaceTable=gtInterfaceTable, gtSNMP=gtSNMP, gtDNSServerIP=gtDNSServerIP, gtUserParamIdx=gtUserParamIdx, gtTimeLocal=gtTimeLocal, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtNTPServerAddress=gtNTPServerAddress, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceStreaming=gtInterfaceStreaming, gtUpdateFile=gtUpdateFile, gtSettingsObjects=gtSettingsObjects, gtModuleBackupDate=gtModuleBackupDate, gtServices=gtServices, gtHMSNumMembers=gtHMSNumMembers, gtHMSEntry=gtHMSEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtSettingsConformance=gtSettingsConformance, gtBackupControl=gtBackupControl, gtInterfaceDHCPState=gtInterfaceDHCPState, PYSNMP_MODULE_ID=gtSettingsMIB, gtNetworkPortsEntry=gtNetworkPortsEntry, gtGroupName=gtGroupName, gtGeneral=gtGeneral, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtAccesslistName=gtAccesslistName, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSLAExpires=gtSLAExpires, gtTimeUTC=gtTimeUTC, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceName=gtInterfaceName, gtTrapUser=gtTrapUser, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSyslogIP=gtSyslogIP, gtUserTable=gtUserTable, gtNetworkEntry=gtNetworkEntry, gtInterfaceEntry=gtInterfaceEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUserAccesslist=gtUserAccesslist, gtTrapComString=gtTrapComString, gtTrapDestTable=gtTrapDestTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtHMSNumAvailModules=gtHMSNumAvailModules, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNumSFP=gtNumSFP, gtSFTPPort=gtSFTPPort, gtNTPServerNumber=gtNTPServerNumber, gtNetworkPortNumber=gtNetworkPortNumber, gtSettingsCompliances=gtSettingsCompliances, gtNetworking=gtNetworking, gtSFTPPassword=gtSFTPPassword, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSettingsMIB=gtSettingsMIB, gtTrapPDU=gtTrapPDU, gtNetworkName=gtNetworkName, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSFPType=gtSFPType, gtInterfaceIGMP=gtInterfaceIGMP, gtSFPNumber=gtSFPNumber, gtBackupSFTPServer=gtBackupSFTPServer, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtHMSComMethod=gtHMSComMethod, gtUserRowStatus=gtUserRowStatus, gtInterfaceState=gtInterfaceState, gtAccesslistTable=gtAccesslistTable, gtPortsEntry=gtPortsEntry, gtChassisRedundancy=gtChassisRedundancy, gtTrapDestIP=gtTrapDestIP, gtUserGroup=gtUserGroup, gtSettingsGroups=gtSettingsGroups, gtAgentPort=gtAgentPort, gtModuleBackupEntry=gtModuleBackupEntry, gtAgentComReadString=gtAgentComReadString, gtInterfaceVLAN=gtInterfaceVLAN, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupStatus=gtBackupStatus, gtSettingsNotifications=gtSettingsNotifications, gtSLAEntry=gtSLAEntry, gtNetworkPortName=gtNetworkPortName, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSNMPTable=gtSNMPTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapDestRowStatus=gtTrapDestRowStatus, gtTrapState=gtTrapState, gtSLARegistered=gtSLARegistered, gtGroupParamIdx=gtGroupParamIdx, gtCurrentUserName=gtCurrentUserName, gtSNMPEntry=gtSNMPEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceNumber=gtInterfaceNumber, gtSFPTable=gtSFPTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtGroupTable=gtGroupTable, gtNetworkPortState=gtNetworkPortState, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSwitch=gtSwitch, gtInterfaceIPv4=gtInterfaceIPv4, gtModuleBackupStatus=gtModuleBackupStatus, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsName=gtPortsName, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtTrapDestEntry=gtTrapDestEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAccesslistIPRange=gtAccesslistIPRange, gtServicesTable=gtServicesTable, gtUpdateStatus=gtUpdateStatus, gtSFPPlugged=gtSFPPlugged, gtNTPServerTable=gtNTPServerTable, gtHMSTable=gtHMSTable, gtInterfaceMAC=gtInterfaceMAC, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSLATable=gtSLATable, gtUserEntry=gtUserEntry, gtUserName=gtUserName, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFPLink=gtSFPLink, gtUpdateControl=gtUpdateControl, gtSFTPUsername=gtSFTPUsername, gtUserAuthEntry=gtUserAuthEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtAgentState=gtAgentState, gtTrapDestNumber=gtTrapDestNumber, gtDNSNumber=gtDNSNumber, gtPortsBitrateTransmit=gtPortsBitrateTransmit)
