...
MibIdentifier, TimeTicks, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Integer32, Counter64, ObjectIdentity, NotificationType, IpAddress, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Integer32", "Counter64", "ObjectIdentity", "NotificationType", "IpAddress", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtCurrentUserName=gtCurrentUserName, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtChassisRedundancy=gtChassisRedundancy, gtAccesslistIdx=gtAccesslistIdx, gtHMSGroupName=gtHMSGroupName, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtAgentComWriteString=gtAgentComWriteString, gtGroupTable=gtGroupTable, gtUserPassword=gtUserPassword, gtInterfaceIfIndex=gtInterfaceIfIndex, gtPortsName=gtPortsName, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserRowStatus=gtUserRowStatus, gtUserGroup=gtUserGroup, gtGroupEntry=gtGroupEntry, gtSFPPlugged=gtSFPPlugged, gtSFTPUsername=gtSFTPUsername, gtUserParamIdx=gtUserParamIdx, gtUpdateFilesEntry=gtUpdateFilesEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSyslogEntry=gtSyslogEntry, gtAccesslistTable=gtAccesslistTable, gtUserEntry=gtUserEntry, gtSettingsConformance=gtSettingsConformance, gtDNSNumber=gtDNSNumber, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtWebEnable=gtWebEnable, gtSettingsGroups=gtSettingsGroups, gtUserIdx=gtUserIdx, gtBackupControl=gtBackupControl, gtAccesslistEntry=gtAccesslistEntry, gtTimeZone=gtTimeZone, gtWebProtocol=gtWebProtocol, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceMAC=gtInterfaceMAC, gtSNMP=gtSNMP, gtPortsLinkup=gtPortsLinkup, gtInterfaceState=gtInterfaceState, gtAgentPort=gtAgentPort, gtTimeUTC=gtTimeUTC, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSFPEntry=gtSFPEntry, gtNetworkEntry=gtNetworkEntry, gtTrapPDU=gtTrapPDU, gtUpdateFilesTable=gtUpdateFilesTable, gtServicesEntry=gtServicesEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtModuleBackupTable=gtModuleBackupTable, gtNetworkPortName=gtNetworkPortName, gtModuleBackupStatus=gtModuleBackupStatus, PYSNMP_MODULE_ID=gtSettingsMIB, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceVLAN=gtInterfaceVLAN, gtSettingsObjects=gtSettingsObjects, gtTrapComString=gtTrapComString, gtSyslogState=gtSyslogState, gtPortsEntry=gtPortsEntry, gtNetworkPortState=gtNetworkPortState, gtModuleBackupEntry=gtModuleBackupEntry, gtSFTPServer=gtSFTPServer, gtSNMPEntry=gtSNMPEntry, gtSettingsNotifications=gtSettingsNotifications, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceStreaming=gtInterfaceStreaming, gtSFPSpeed=gtSFPSpeed, gtUpdateStatus=gtUpdateStatus, gtDateAndTime=gtDateAndTime, gtUserName=gtUserName, gtAgentSecurityLevel=gtAgentSecurityLevel, gtAgentState=gtAgentState, gtUserAuthEntry=gtUserAuthEntry, gtServicesTable=gtServicesTable, gtSWOptionsTable=gtSWOptionsTable, gtSWOption=gtSWOption, gtNumSFP=gtNumSFP, gtNTPServerRowStatus=gtNTPServerRowStatus, gtModuleBackupDate=gtModuleBackupDate, gtSLAExpires=gtSLAExpires, gtSLAEntry=gtSLAEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapSNMPVersion=gtTrapSNMPVersion, gtGroupAccesslist=gtGroupAccesslist, gtDNSServerIP=gtDNSServerIP, gtSyslogTable=gtSyslogTable, gtTrapUser=gtTrapUser, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtTrapDestPort=gtTrapDestPort, gtInterfaceTable=gtInterfaceTable, gtWebAuth=gtWebAuth, gtNTPServerAddress=gtNTPServerAddress, gtSFTPPassword=gtSFTPPassword, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSWOptionsIdx=gtSWOptionsIdx, gtBackupStatus=gtBackupStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNTPServerTable=gtNTPServerTable, gtAccesslistIPRange=gtAccesslistIPRange, gtHMSComMethod=gtHMSComMethod, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSettingsMIB=gtSettingsMIB, gtInterfaceCLI=gtInterfaceCLI, gtHMSEntry=gtHMSEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtGeneral=gtGeneral, gtInterfaceIGMP=gtInterfaceIGMP, gtTrapDestTable=gtTrapDestTable, gtSettingsCompliances=gtSettingsCompliances, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceName=gtInterfaceName, gtSFPNumber=gtSFPNumber, gtInterfaceNumber=gtInterfaceNumber, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSFPType=gtSFPType, gtDNSTable=gtDNSTable, gtDNSEntry=gtDNSEntry, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNetworkTable=gtNetworkTable, gtTimeLocal=gtTimeLocal, gtPortsFloodMulticast=gtPortsFloodMulticast, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDaylightAdjustment=gtDaylightAdjustment, gtUpdateControl=gtUpdateControl, gtTrapDestEntry=gtTrapDestEntry, gtTrapState=gtTrapState, gtHMSNumAvailModules=gtHMSNumAvailModules, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtModuleBackup=gtModuleBackup, gtSFTPPort=gtSFTPPort, gtAgentComReadString=gtAgentComReadString, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFPTable=gtSFPTable, gtNetworkPortsTable=gtNetworkPortsTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtBackupSFTPServer=gtBackupSFTPServer, gtSFPLink=gtSFPLink, gtHMSNumMembers=gtHMSNumMembers, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSWOptionsEntry=gtSWOptionsEntry, gtUser=gtUser, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceIPv4=gtInterfaceIPv4, gtHMSTable=gtHMSTable, gtPortsTable=gtPortsTable, gtFilename=gtFilename, gtAccesslistName=gtAccesslistName, gtInterfaceDHCPState=gtInterfaceDHCPState, gtModuleUpdate=gtModuleUpdate, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtGroupIdx=gtGroupIdx, gtGroupParamIdx=gtGroupParamIdx, gtNetworkVLAN=gtNetworkVLAN, gtUserAuthEnabled=gtUserAuthEnabled, gtSwitch=gtSwitch, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtPortsNumber=gtPortsNumber, gtTrapDestNumber=gtTrapDestNumber, gtSLATable=gtSLATable, gtSyslogIP=gtSyslogIP, gtUserTable=gtUserTable, gtUserAuthTable=gtUserAuthTable, gtInterfaceSNMP=gtInterfaceSNMP, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNetworkPortNumber=gtNetworkPortNumber, gtUpdateFile=gtUpdateFile, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUserAccesslist=gtUserAccesslist, gtGroupName=gtGroupName, gtCurrentTimeSource=gtCurrentTimeSource, gtPortsBitrateReceive=gtPortsBitrateReceive, gtServices=gtServices, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSLARegistered=gtSLARegistered, gtNetworkName=gtNetworkName, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceEntry=gtInterfaceEntry, gtSNMPTable=gtSNMPTable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapDestIP=gtTrapDestIP, gtNetworking=gtNetworking, gtDateAndTimeEntry=gtDateAndTimeEntry, gtModuleBackupControl=gtModuleBackupControl, gtBackupSFTPPort=gtBackupSFTPPort, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtGroupRights=gtGroupRights)
