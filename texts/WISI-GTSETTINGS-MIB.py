...
Counter32, Gauge32, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, ModuleIdentity, Bits, Counter64, NotificationType, ObjectIdentity, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "ModuleIdentity", "Bits", "Counter64", "NotificationType", "ObjectIdentity", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtModuleBackup=gtModuleBackup, gtTrapDestPort=gtTrapDestPort, gtAccesslistName=gtAccesslistName, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNetworkPortState=gtNetworkPortState, gtUserName=gtUserName, gtChassisRedundancy=gtChassisRedundancy, gtNTPServerEntry=gtNTPServerEntry, gtUserAuthTable=gtUserAuthTable, gtSyslogState=gtSyslogState, gtPortsLinkup=gtPortsLinkup, gtTrapDestNumber=gtTrapDestNumber, gtSFTPUsername=gtSFTPUsername, gtBackupStatus=gtBackupStatus, gtSLAExpires=gtSLAExpires, gtSFPNumber=gtSFPNumber, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtTimeUTC=gtTimeUTC, gtNetworkPortsEntry=gtNetworkPortsEntry, gtServicesEntry=gtServicesEntry, gtUserEntry=gtUserEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNTPServerAddress=gtNTPServerAddress, gtUser=gtUser, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceNumber=gtInterfaceNumber, gtUserIdx=gtUserIdx, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtDateAndTime=gtDateAndTime, gtNetworkTable=gtNetworkTable, gtInterfaceMAC=gtInterfaceMAC, gtTrapDestIP=gtTrapDestIP, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSFPType=gtSFPType, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSNMPTable=gtSNMPTable, gtGroupTable=gtGroupTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTimeLocal=gtTimeLocal, gtTrapComString=gtTrapComString, gtSWOption=gtSWOption, gtGroupRights=gtGroupRights, gtWebEnable=gtWebEnable, gtFilename=gtFilename, PYSNMP_MODULE_ID=gtSettingsMIB, gtAgentState=gtAgentState, gtNetworkPortsTable=gtNetworkPortsTable, gtAccesslistIdx=gtAccesslistIdx, gtUpdateControl=gtUpdateControl, gtIGMPQueryInterval=gtIGMPQueryInterval, gtModuleBackupStatus=gtModuleBackupStatus, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNetworkPortName=gtNetworkPortName, gtServices=gtServices, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTrapDestTable=gtTrapDestTable, gtBackupSFTPServer=gtBackupSFTPServer, gtDNSTable=gtDNSTable, gtSFTPPort=gtSFTPPort, gtPortsNumber=gtPortsNumber, gtSettingsNotifications=gtSettingsNotifications, gtAccesslistTable=gtAccesslistTable, gtNetworkName=gtNetworkName, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSettingsGroups=gtSettingsGroups, gtUserAccesslist=gtUserAccesslist, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtPortsEntry=gtPortsEntry, gtWebAuth=gtWebAuth, gtSyslogIP=gtSyslogIP, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtCurrentTimeSource=gtCurrentTimeSource, gtSFPSpeed=gtSFPSpeed, gtTrapSNMPVersion=gtTrapSNMPVersion, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUpdateFilesTable=gtUpdateFilesTable, gtCurrentUserName=gtCurrentUserName, gtNetworkEntry=gtNetworkEntry, gtHMSNumMembers=gtHMSNumMembers, gtInterfaceName=gtInterfaceName, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtNetworkVLAN=gtNetworkVLAN, gtHMSGroupName=gtHMSGroupName, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSLAEntry=gtSLAEntry, gtTrapPDU=gtTrapPDU, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSWOptionsTable=gtSWOptionsTable, gtSFPPlugged=gtSFPPlugged, gtAgentPort=gtAgentPort, gtSettingsConformance=gtSettingsConformance, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtModuleBackupTable=gtModuleBackupTable, gtSFPEntry=gtSFPEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtGroupIdx=gtGroupIdx, gtDaylightAdjustment=gtDaylightAdjustment, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtModuleUpdate=gtModuleUpdate, gtInterfaceState=gtInterfaceState, gtHMSEntry=gtHMSEntry, gtUserParamIdx=gtUserParamIdx, gtNTPServerRowStatus=gtNTPServerRowStatus, gtGroupEntry=gtGroupEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtUserAuthEntry=gtUserAuthEntry, gtTrapUser=gtTrapUser, gtAgentSecurityLevel=gtAgentSecurityLevel, gtPortsTable=gtPortsTable, gtAgentComReadString=gtAgentComReadString, gtInterfaceIGMP=gtInterfaceIGMP, gtModuleBackupControl=gtModuleBackupControl, gtSLARegistered=gtSLARegistered, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSettingsObjects=gtSettingsObjects, gtNTPServerTable=gtNTPServerTable, gtNTPServerNumber=gtNTPServerNumber, gtTrapState=gtTrapState, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUpdateStatus=gtUpdateStatus, gtSFTPServer=gtSFTPServer, gtCurrentUserPassword=gtCurrentUserPassword, gtGroupAccesslist=gtGroupAccesslist, gtNumSFP=gtNumSFP, gtSFPTable=gtSFPTable, gtWebProtocol=gtWebProtocol, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSwitch=gtSwitch, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtBackupSFTPPassword=gtBackupSFTPPassword, gtAccesslistEntry=gtAccesslistEntry, gtBackupControl=gtBackupControl, gtUserGroup=gtUserGroup, gtGroupParamIdx=gtGroupParamIdx, gtAccesslistIPRange=gtAccesslistIPRange, gtUserAuthEnabled=gtUserAuthEnabled, gtSWOptionsIdx=gtSWOptionsIdx, gtSFPLink=gtSFPLink, gtServicesTable=gtServicesTable, gtModuleBackupDate=gtModuleBackupDate, gtUserPassword=gtUserPassword, gtInterfaceEntry=gtInterfaceEntry, gtTrapDestEntry=gtTrapDestEntry, gtInterfaceCLI=gtInterfaceCLI, gtHeadendSystemManagement=gtHeadendSystemManagement, gtBackupSFTPPort=gtBackupSFTPPort, gtSyslogEntry=gtSyslogEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceVLAN=gtInterfaceVLAN, gtSNMPEntry=gtSNMPEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtDNSEntry=gtDNSEntry, gtTrapDestRowStatus=gtTrapDestRowStatus, gtBackupSFTPUsername=gtBackupSFTPUsername, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtModuleBackupEntry=gtModuleBackupEntry, gtUserTable=gtUserTable, gtHMSComMethod=gtHMSComMethod, gtSettingsCompliances=gtSettingsCompliances, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUpdateFile=gtUpdateFile, gtPortsName=gtPortsName, gtSLATable=gtSLATable, gtDNSNumber=gtDNSNumber, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSyslogTable=gtSyslogTable, gtGroupName=gtGroupName, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworking=gtNetworking, gtTimeZone=gtTimeZone, gtInterfaceIPv4=gtInterfaceIPv4, gtSNMP=gtSNMP, gtHMSTable=gtHMSTable, gtSettingsMIB=gtSettingsMIB, gtInterfaceSNMP=gtInterfaceSNMP, gtSFTPPassword=gtSFTPPassword, gtInterfaceTable=gtInterfaceTable, gtUserRowStatus=gtUserRowStatus, gtDateAndTimeTable=gtDateAndTimeTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtAgentComWriteString=gtAgentComWriteString, gtGeneral=gtGeneral, gtDNSServerIP=gtDNSServerIP, gtInterfaceDHCPState=gtInterfaceDHCPState)
