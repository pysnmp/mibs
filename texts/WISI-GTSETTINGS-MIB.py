...
Bits, TimeTicks, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64, Unsigned32, Counter32, IpAddress, Integer32, NotificationType, ModuleIdentity, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64", "Unsigned32", "Counter32", "IpAddress", "Integer32", "NotificationType", "ModuleIdentity", "iso", "MibIdentifier")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtServicesTable=gtServicesTable, gtUserAuthTable=gtUserAuthTable, gtSyslogIP=gtSyslogIP, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSFPNumber=gtSFPNumber, gtTrapDestPort=gtTrapDestPort, gtAgentState=gtAgentState, gtSettingsGroups=gtSettingsGroups, gtFilename=gtFilename, gtNetworkName=gtNetworkName, gtServicesEntry=gtServicesEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceIfIndex=gtInterfaceIfIndex, gtGroupAccesslist=gtGroupAccesslist, gtBackupControl=gtBackupControl, gtDNSServerIP=gtDNSServerIP, gtNumSFP=gtNumSFP, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapDestTable=gtTrapDestTable, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceNumber=gtInterfaceNumber, gtUserAuthEntry=gtUserAuthEntry, gtAccesslistParamIdx=gtAccesslistParamIdx, gtGeneral=gtGeneral, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPPort=gtBackupSFTPPort, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSWOptionsTable=gtSWOptionsTable, gtTrapDestNumber=gtTrapDestNumber, gtInterfaceCLI=gtInterfaceCLI, gtBackupSFTPPassword=gtBackupSFTPPassword, PYSNMP_MODULE_ID=gtSettingsMIB, gtUserGroup=gtUserGroup, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSettingsConformance=gtSettingsConformance, gtPortsNumber=gtPortsNumber, gtDNSNumber=gtDNSNumber, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkPortsTable=gtNetworkPortsTable, gtPortsEntry=gtPortsEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceIPv4=gtInterfaceIPv4, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtCurrentUserPassword=gtCurrentUserPassword, gtChassisRedundancy=gtChassisRedundancy, gtSFPLink=gtSFPLink, gtUpdateFilesTable=gtUpdateFilesTable, gtHMSGroupName=gtHMSGroupName, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFTPServer=gtSFTPServer, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFTPUsername=gtSFTPUsername, gtNTPServerEntry=gtNTPServerEntry, gtTrapUser=gtTrapUser, gtTrapDestIP=gtTrapDestIP, gtSNMPEntry=gtSNMPEntry, gtDateAndTime=gtDateAndTime, gtUserParamIdx=gtUserParamIdx, gtAccesslistTable=gtAccesslistTable, gtAgentPort=gtAgentPort, gtGroupParamIdx=gtGroupParamIdx, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceEntry=gtInterfaceEntry, gtAgentComWriteString=gtAgentComWriteString, gtGroupName=gtGroupName, gtWebAuth=gtWebAuth, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtModuleBackupStatus=gtModuleBackupStatus, gtSFTPPassword=gtSFTPPassword, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtUserIdx=gtUserIdx, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSwitch=gtSwitch, gtAccesslistName=gtAccesslistName, gtSFPSpeed=gtSFPSpeed, gtSFPTable=gtSFPTable, gtAgentComReadString=gtAgentComReadString, gtBackupSFTPServer=gtBackupSFTPServer, gtUserTable=gtUserTable, gtUpdateControl=gtUpdateControl, gtUserAccesslist=gtUserAccesslist, gtSettingsMIB=gtSettingsMIB, gtModuleBackup=gtModuleBackup, gtUserPassword=gtUserPassword, gtUserRowStatus=gtUserRowStatus, gtSWOption=gtSWOption, gtGroupEntry=gtGroupEntry, gtNetworkTable=gtNetworkTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceIGMP=gtInterfaceIGMP, gtCurrentUserName=gtCurrentUserName, gtSettingsObjects=gtSettingsObjects, gtNTPServerRowStatus=gtNTPServerRowStatus, gtBackupSFTPUsername=gtBackupSFTPUsername, gtHMSEntry=gtHMSEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceState=gtInterfaceState, gtNTPServerTable=gtNTPServerTable, gtSFPPlugged=gtSFPPlugged, gtSNMPTable=gtSNMPTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtTrapState=gtTrapState, gtSyslogState=gtSyslogState, gtHMSNumMembers=gtHMSNumMembers, gtPortsLinkup=gtPortsLinkup, gtNetworkPortsEntry=gtNetworkPortsEntry, gtWebEnable=gtWebEnable, gtGroupRights=gtGroupRights, gtSWOptionsIdx=gtSWOptionsIdx, gtTimeUTC=gtTimeUTC, gtSFPEntry=gtSFPEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUpdateStatus=gtUpdateStatus, gtInterfaceName=gtInterfaceName, gtInterfaceMAC=gtInterfaceMAC, gtSettingsCompliances=gtSettingsCompliances, gtNetworkEntry=gtNetworkEntry, gtBackupStatus=gtBackupStatus, gtTrapDestEntry=gtTrapDestEntry, gtSyslogTable=gtSyslogTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSLAEntry=gtSLAEntry, gtNetworkPortState=gtNetworkPortState, gtInterfaceVLAN=gtInterfaceVLAN, gtUserEntry=gtUserEntry, gtAccesslistIdx=gtAccesslistIdx, gtNTPServerNumber=gtNTPServerNumber, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtNetworkPortName=gtNetworkPortName, gtNetworking=gtNetworking, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSLARegistered=gtSLARegistered, gtPortsName=gtPortsName, gtWebProtocol=gtWebProtocol, gtTrapComString=gtTrapComString, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtNetworkVLAN=gtNetworkVLAN, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtNetworkPortVLAN=gtNetworkPortVLAN, gtDNSEntry=gtDNSEntry, gtSFTPPort=gtSFTPPort, gtModuleBackupTable=gtModuleBackupTable, gtNTPServerAddress=gtNTPServerAddress, gtHMSComMethod=gtHMSComMethod, gtUserAuthEnabled=gtUserAuthEnabled, gtModuleBackupEntry=gtModuleBackupEntry, gtUpdateFile=gtUpdateFile, gtServices=gtServices, gtUserName=gtUserName, gtInterfaceSNMP=gtInterfaceSNMP, gtTrapPDU=gtTrapPDU, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSyslogEntry=gtSyslogEntry, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceStreaming=gtInterfaceStreaming, gtDNSTable=gtDNSTable, gtGroupIdx=gtGroupIdx, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSNMP=gtSNMP, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSWOptionsEntry=gtSWOptionsEntry, gtModuleUpdate=gtModuleUpdate, gtUser=gtUser, gtTrapSecurityLevel=gtTrapSecurityLevel, gtCurrentTimeSource=gtCurrentTimeSource, gtNetworkPortNumber=gtNetworkPortNumber, gtDateAndTimeTable=gtDateAndTimeTable, gtTimeZone=gtTimeZone, gtTrapDestRowStatus=gtTrapDestRowStatus, gtPortsTable=gtPortsTable, gtDaylightAdjustment=gtDaylightAdjustment, gtGroupTable=gtGroupTable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSLATable=gtSLATable, gtSFPType=gtSFPType, gtInterfaceTable=gtInterfaceTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtHMSTable=gtHMSTable, gtTimeLocal=gtTimeLocal, gtSLAExpires=gtSLAExpires)
