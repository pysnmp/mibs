...
Integer32, Bits, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, ObjectIdentity, iso, NotificationType, ModuleIdentity, Counter64, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "ObjectIdentity", "iso", "NotificationType", "ModuleIdentity", "Counter64", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNTPServerEntry=gtNTPServerEntry, gtModuleUpdate=gtModuleUpdate, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkTable=gtNetworkTable, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNetworking=gtNetworking, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSFPLink=gtSFPLink, gtSNMPEntry=gtSNMPEntry, gtWebProtocol=gtWebProtocol, gtAgentComReadString=gtAgentComReadString, gtHMSGroupName=gtHMSGroupName, gtUserAccesslist=gtUserAccesslist, gtPortsName=gtPortsName, gtBackupSFTPPassword=gtBackupSFTPPassword, gtHMSComMethod=gtHMSComMethod, gtGroupIdx=gtGroupIdx, gtNTPServerTable=gtNTPServerTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtUserTable=gtUserTable, gtNumSFP=gtNumSFP, gtAccesslistName=gtAccesslistName, gtChassisRedundancy=gtChassisRedundancy, gtBackupSFTPPort=gtBackupSFTPPort, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsNumber=gtPortsNumber, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtSFPNumber=gtSFPNumber, gtInterfaceNumber=gtInterfaceNumber, gtAccesslistParamIdx=gtAccesslistParamIdx, gtModuleRedundancyMode=gtModuleRedundancyMode, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTimeUTC=gtTimeUTC, gtTrapDestPort=gtTrapDestPort, gtDateAndTimeTable=gtDateAndTimeTable, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceEntry=gtInterfaceEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtPortsTable=gtPortsTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSyslogState=gtSyslogState, gtSFPSpeed=gtSFPSpeed, gtInterfaceIPv4=gtInterfaceIPv4, gtCurrentTimeSource=gtCurrentTimeSource, gtUserGroup=gtUserGroup, gtUserAuthEntry=gtUserAuthEntry, gtUserAuthTable=gtUserAuthTable, gtModuleBackupStatus=gtModuleBackupStatus, gtUserEntry=gtUserEntry, gtUserParamIdx=gtUserParamIdx, gtSyslogTable=gtSyslogTable, gtInterfaceCLI=gtInterfaceCLI, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtAgentState=gtAgentState, gtSwitch=gtSwitch, gtInterfaceIGMP=gtInterfaceIGMP, gtDNSTable=gtDNSTable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtBackupStatus=gtBackupStatus, gtHMSNumMembers=gtHMSNumMembers, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupControl=gtBackupControl, gtSLARegistered=gtSLARegistered, gtSyslogIP=gtSyslogIP, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkPortState=gtNetworkPortState, gtInterfaceName=gtInterfaceName, gtDaylightAdjustment=gtDaylightAdjustment, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNetworkPortsTable=gtNetworkPortsTable, gtTrapDestIP=gtTrapDestIP, gtTrapUser=gtTrapUser, gtUserAuthEnabled=gtUserAuthEnabled, gtSFTPUsername=gtSFTPUsername, gtBackupSFTPServer=gtBackupSFTPServer, gtPortsLinkup=gtPortsLinkup, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtDNSNumber=gtDNSNumber, gtServices=gtServices, gtModuleBackupTable=gtModuleBackupTable, gtGroupEntry=gtGroupEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtHMSEntry=gtHMSEntry, gtUser=gtUser, gtUserIdx=gtUserIdx, gtUserName=gtUserName, gtSWOptionsTable=gtSWOptionsTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtNetworkEntry=gtNetworkEntry, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSyslogEntry=gtSyslogEntry, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtServicesEntry=gtServicesEntry, gtNetworkVLAN=gtNetworkVLAN, gtGroupTable=gtGroupTable, gtUserRowStatus=gtUserRowStatus, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSWOptionsEntry=gtSWOptionsEntry, gtGeneral=gtGeneral, gtModuleBackup=gtModuleBackup, gtSFPEntry=gtSFPEntry, gtInterfaceMAC=gtInterfaceMAC, gtAgentPort=gtAgentPort, gtNetworkName=gtNetworkName, gtSFTPServer=gtSFTPServer, gtSLAEntry=gtSLAEntry, gtNTPServerNumber=gtNTPServerNumber, gtGroupName=gtGroupName, gtWebAuth=gtWebAuth, gtPortsEntry=gtPortsEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtSFTPPort=gtSFTPPort, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUpdateFile=gtUpdateFile, gtSFTPPassword=gtSFTPPassword, gtInterfaceState=gtInterfaceState, gtNetworkPortName=gtNetworkPortName, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtTrapDestNumber=gtTrapDestNumber, gtUpdateControl=gtUpdateControl, gtInterfaceTable=gtInterfaceTable, gtTrapState=gtTrapState, gtDNSServerIP=gtDNSServerIP, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSettingsObjects=gtSettingsObjects, gtSWOption=gtSWOption, gtSLAExpires=gtSLAExpires, gtCurrentUserPassword=gtCurrentUserPassword, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtFilename=gtFilename, gtGroupRights=gtGroupRights, gtBackupSFTPUsername=gtBackupSFTPUsername, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSettingsMIB=gtSettingsMIB, gtSNMP=gtSNMP, gtNetworkPortVLAN=gtNetworkPortVLAN, gtInterfaceSNMP=gtInterfaceSNMP, gtTrapSNMPVersion=gtTrapSNMPVersion, gtHMSTable=gtHMSTable, gtSettingsNotifications=gtSettingsNotifications, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUpdateStatus=gtUpdateStatus, gtInterfaceVLAN=gtInterfaceVLAN, gtCurrentUserName=gtCurrentUserName, gtModuleBackupEntry=gtModuleBackupEntry, gtAccesslistTable=gtAccesslistTable, gtTrapDestTable=gtTrapDestTable, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFPType=gtSFPType, gtSettingsCompliances=gtSettingsCompliances, gtTrapPDU=gtTrapPDU, gtDNSEntry=gtDNSEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSettingsGroups=gtSettingsGroups, gtModuleBackupDate=gtModuleBackupDate, gtHeadendSystemManagement=gtHeadendSystemManagement, gtModuleBackupControl=gtModuleBackupControl, gtGroupAccesslist=gtGroupAccesslist, gtAgentComWriteString=gtAgentComWriteString, gtSFPTable=gtSFPTable, gtSLATable=gtSLATable, gtTimeZone=gtTimeZone, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtTimeLocal=gtTimeLocal, gtTrapComString=gtTrapComString, gtWebEnable=gtWebEnable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapDestEntry=gtTrapDestEntry, gtServicesTable=gtServicesTable, gtSNMPTable=gtSNMPTable, gtUserPassword=gtUserPassword, gtAccesslistEntry=gtAccesslistEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSFPPlugged=gtSFPPlugged, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSettingsConformance=gtSettingsConformance, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceStreaming=gtInterfaceStreaming, gtDateAndTime=gtDateAndTime)
