...
MibIdentifier, Bits, IpAddress, Integer32, NotificationType, ModuleIdentity, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Unsigned32, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "IpAddress", "Integer32", "NotificationType", "ModuleIdentity", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Unsigned32", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtTrapUser=gtTrapUser, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtNTPServerNumber=gtNTPServerNumber, gtModuleBackupControl=gtModuleBackupControl, gtAgentComReadString=gtAgentComReadString, gtInterfaceSNMP=gtInterfaceSNMP, gtGroupParamIdx=gtGroupParamIdx, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUpdateFile=gtUpdateFile, gtPortsFloodMulticast=gtPortsFloodMulticast, gtHMSNumMembers=gtHMSNumMembers, gtSyslogEntry=gtSyslogEntry, gtInterfaceName=gtInterfaceName, gtUserParamIdx=gtUserParamIdx, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtServices=gtServices, gtWebProtocol=gtWebProtocol, gtGroupRights=gtGroupRights, gtSWOptionsEntry=gtSWOptionsEntry, gtSFPType=gtSFPType, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSettingsCompliances=gtSettingsCompliances, gtPortsTable=gtPortsTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSFPSpeed=gtSFPSpeed, gtSettingsGroups=gtSettingsGroups, gtSettingsConformance=gtSettingsConformance, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtDNSServerIP=gtDNSServerIP, gtWebAuth=gtWebAuth, gtNetworkPortState=gtNetworkPortState, gtTrapComString=gtTrapComString, gtCurrentUserPassword=gtCurrentUserPassword, gtUserEntry=gtUserEntry, gtServicesTable=gtServicesTable, gtDateAndTimeTable=gtDateAndTimeTable, gtDNSEntry=gtDNSEntry, gtSWOption=gtSWOption, gtModuleBackupEntry=gtModuleBackupEntry, gtUserAuthEntry=gtUserAuthEntry, gtTimeUTC=gtTimeUTC, gtInterfaceMAC=gtInterfaceMAC, gtSwitch=gtSwitch, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSettingsObjects=gtSettingsObjects, gtSFTPServer=gtSFTPServer, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSWOptionsTable=gtSWOptionsTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtPortsEntry=gtPortsEntry, gtBackupSFTPFilename=gtBackupSFTPFilename, gtAgentPort=gtAgentPort, gtSettingsMIB=gtSettingsMIB, gtSLATable=gtSLATable, gtFilename=gtFilename, gtNetworkPortNumber=gtNetworkPortNumber, gtTrapState=gtTrapState, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSFPTable=gtSFPTable, gtUserAccesslist=gtUserAccesslist, gtUserTable=gtUserTable, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSNMPTable=gtSNMPTable, gtAccesslistName=gtAccesslistName, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTimeLocal=gtTimeLocal, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUpdateFilesTable=gtUpdateFilesTable, gtSFPNumber=gtSFPNumber, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUpdateStatus=gtUpdateStatus, gtSFPLink=gtSFPLink, gtDaylightAdjustment=gtDaylightAdjustment, gtSNMP=gtSNMP, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTimeZone=gtTimeZone, gtTrapDestNumber=gtTrapDestNumber, gtNetworkPortName=gtNetworkPortName, gtTrapPDU=gtTrapPDU, gtUserRowStatus=gtUserRowStatus, gtTrapDestIP=gtTrapDestIP, gtModuleBackupDate=gtModuleBackupDate, gtHMSGroupName=gtHMSGroupName, gtDateAndTime=gtDateAndTime, gtNetworkEntry=gtNetworkEntry, gtChassisRedundancy=gtChassisRedundancy, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceNumber=gtInterfaceNumber, gtGeneral=gtGeneral, gtUserIdx=gtUserIdx, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNTPServerTable=gtNTPServerTable, gtBackupControl=gtBackupControl, gtSFTPPort=gtSFTPPort, gtPortsLinkup=gtPortsLinkup, gtSFTPUsername=gtSFTPUsername, gtInterfaceIGMP=gtInterfaceIGMP, gtDNSNumber=gtDNSNumber, gtUserName=gtUserName, gtDateAndTimeEntry=gtDateAndTimeEntry, gtCurrentUserName=gtCurrentUserName, gtGroupTable=gtGroupTable, gtGroupName=gtGroupName, gtCurrentTimeSource=gtCurrentTimeSource, gtAgentState=gtAgentState, gtModuleUpdate=gtModuleUpdate, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtModuleBackupStatus=gtModuleBackupStatus, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapDestTable=gtTrapDestTable, gtGroupIdx=gtGroupIdx, gtHMSNumAvailModules=gtHMSNumAvailModules, gtHMSTable=gtHMSTable, gtSyslogTable=gtSyslogTable, gtModuleBackupTable=gtModuleBackupTable, gtSLAExpires=gtSLAExpires, gtNTPServerEntry=gtNTPServerEntry, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSFPPlugged=gtSFPPlugged, gtAccesslistParamIdx=gtAccesslistParamIdx, gtPortsName=gtPortsName, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUserPassword=gtUserPassword, gtNetworkVLAN=gtNetworkVLAN, gtBackupSFTPPort=gtBackupSFTPPort, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNetworkPortsEntry=gtNetworkPortsEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtNetworkPortsTable=gtNetworkPortsTable, gtPortsNumber=gtPortsNumber, gtHMSComMethod=gtHMSComMethod, gtUserGroup=gtUserGroup, gtAccesslistEntry=gtAccesslistEntry, gtServicesEntry=gtServicesEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtBackupStatus=gtBackupStatus, PYSNMP_MODULE_ID=gtSettingsMIB, gtNumSFP=gtNumSFP, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNetworkName=gtNetworkName, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceEntry=gtInterfaceEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSyslogIP=gtSyslogIP, gtInterfaceTable=gtInterfaceTable, gtSFTPPassword=gtSFTPPassword, gtGroupAccesslist=gtGroupAccesslist, gtWebEnable=gtWebEnable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtUser=gtUser, gtInterfaceIfIndex=gtInterfaceIfIndex, gtTrapDestPort=gtTrapDestPort, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceState=gtInterfaceState, gtSFPEntry=gtSFPEntry, gtBackupSFTPServer=gtBackupSFTPServer, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceIPv4=gtInterfaceIPv4, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSLAEntry=gtSLAEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworking=gtNetworking, gtDNSTable=gtDNSTable, gtSNMPEntry=gtSNMPEntry, gtSettingsNotifications=gtSettingsNotifications, gtHMSEntry=gtHMSEntry, gtInterfaceCLI=gtInterfaceCLI, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleBackup=gtModuleBackup, gtUserAuthTable=gtUserAuthTable, gtUpdateControl=gtUpdateControl, gtAgentComWriteString=gtAgentComWriteString, gtNetworkTable=gtNetworkTable, gtSLARegistered=gtSLARegistered, gtInterfaceStreaming=gtInterfaceStreaming, gtGroupEntry=gtGroupEntry, gtAccesslistIdx=gtAccesslistIdx, gtSyslogState=gtSyslogState, gtTrapDestEntry=gtTrapDestEntry, gtUpdateFilesEntry=gtUpdateFilesEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtAccesslistTable=gtAccesslistTable)
