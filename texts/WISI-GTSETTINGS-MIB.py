...
iso, Integer32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, MibIdentifier, Unsigned32, Counter64, Bits, TimeTicks, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Counter64", "Bits", "TimeTicks", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtTrapDestRowStatus=gtTrapDestRowStatus, gtDNSTable=gtDNSTable, gtModuleBackupControl=gtModuleBackupControl, gtCurrentUserName=gtCurrentUserName, gtNetworking=gtNetworking, gtSettingsCompliances=gtSettingsCompliances, gtTimeLocal=gtTimeLocal, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSFPTable=gtSFPTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtServices=gtServices, gtHMSEntry=gtHMSEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtModuleBackupStatus=gtModuleBackupStatus, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceRowStatus=gtInterfaceRowStatus, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapDestTable=gtTrapDestTable, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTrapDestPort=gtTrapDestPort, gtUserAuthEnabled=gtUserAuthEnabled, gtBackupStatus=gtBackupStatus, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTrapState=gtTrapState, gtGroupEntry=gtGroupEntry, gtSettingsNotifications=gtSettingsNotifications, gtAccesslistParamIdx=gtAccesslistParamIdx, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapUser=gtTrapUser, gtSNMPTable=gtSNMPTable, gtNetworkPortNumber=gtNetworkPortNumber, gtDNSEntry=gtDNSEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtCurrentUserPassword=gtCurrentUserPassword, gtTrapSecurityLevel=gtTrapSecurityLevel, gtUserEntry=gtUserEntry, gtHeadendSystemManagement=gtHeadendSystemManagement, gtDNSNumber=gtDNSNumber, gtDateAndTime=gtDateAndTime, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSWOptionsEntry=gtSWOptionsEntry, gtSLAEntry=gtSLAEntry, gtInterfaceTable=gtInterfaceTable, gtModuleBackupEntry=gtModuleBackupEntry, gtSNMPEntry=gtSNMPEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceStreaming=gtInterfaceStreaming, gtUserName=gtUserName, gtGroupIdx=gtGroupIdx, gtSFPPlugged=gtSFPPlugged, gtSLARegistered=gtSLARegistered, gtTrapDestNumber=gtTrapDestNumber, gtWebAuth=gtWebAuth, gtInterfaceIPv4=gtInterfaceIPv4, gtSFPEntry=gtSFPEntry, gtUserParamIdx=gtUserParamIdx, gtNetworkTable=gtNetworkTable, gtSWOption=gtSWOption, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSNMP=gtSNMP, gtSyslogIP=gtSyslogIP, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, PYSNMP_MODULE_ID=gtSettingsMIB, gtPortsNumber=gtPortsNumber, gtUserAuthTable=gtUserAuthTable, gtUserTable=gtUserTable, gtModuleUpdate=gtModuleUpdate, gtHMSTable=gtHMSTable, gtUserAuthEntry=gtUserAuthEntry, gtSFPType=gtSFPType, gtHMSComMethod=gtHMSComMethod, gtAccesslistEntry=gtAccesslistEntry, gtSFTPPort=gtSFTPPort, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtNetworkPortsEntry=gtNetworkPortsEntry, gtPortsLinkup=gtPortsLinkup, gtAgentPort=gtAgentPort, gtWebProtocol=gtWebProtocol, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapSNMPVersion=gtTrapSNMPVersion, gtUserPassword=gtUserPassword, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtGroupAccesslist=gtGroupAccesslist, gtNetworkEntry=gtNetworkEntry, gtInterfaceState=gtInterfaceState, gtSettingsGroups=gtSettingsGroups, gtWebEnable=gtWebEnable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtPortsTable=gtPortsTable, gtNetworkName=gtNetworkName, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTimeUTC=gtTimeUTC, gtBackupSFTPServer=gtBackupSFTPServer, gtUpdateStatus=gtUpdateStatus, gtAgentComReadString=gtAgentComReadString, gtTrapComString=gtTrapComString, gtModuleBackup=gtModuleBackup, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSFPSpeed=gtSFPSpeed, gtCurrentTimeSource=gtCurrentTimeSource, gtSLAExpires=gtSLAExpires, gtDNSServerIP=gtDNSServerIP, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNetworkVLAN=gtNetworkVLAN, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtAccesslistTable=gtAccesslistTable, gtTrapDestEntry=gtTrapDestEntry, gtAccesslistIdx=gtAccesslistIdx, gtSWOptionsTable=gtSWOptionsTable, gtNTPServerNumber=gtNTPServerNumber, gtChassisRedundancy=gtChassisRedundancy, gtGeneral=gtGeneral, gtNTPServerAddress=gtNTPServerAddress, gtGroupTable=gtGroupTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAgentState=gtAgentState, gtModuleRedundancyMode=gtModuleRedundancyMode, gtHMSNumAvailModules=gtHMSNumAvailModules, gtGroupParamIdx=gtGroupParamIdx, gtSFPNumber=gtSFPNumber, gtNTPServerTable=gtNTPServerTable, gtGroupRights=gtGroupRights, gtGroupName=gtGroupName, gtNTPServerEntry=gtNTPServerEntry, gtTimeZone=gtTimeZone, gtSFTPServer=gtSFTPServer, gtNetworkPortVLAN=gtNetworkPortVLAN, gtTrapPDU=gtTrapPDU, gtBackupSFTPPassword=gtBackupSFTPPassword, gtHMSGroupName=gtHMSGroupName, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtServicesEntry=gtServicesEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtNetworkPortName=gtNetworkPortName, gtHMSNumMembers=gtHMSNumMembers, gtDateAndTimeTable=gtDateAndTimeTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceMAC=gtInterfaceMAC, gtBackupControl=gtBackupControl, gtBackupSFTPPort=gtBackupSFTPPort, gtUserRowStatus=gtUserRowStatus, gtUser=gtUser, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSFTPUsername=gtSFTPUsername, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPFilename=gtBackupSFTPFilename, gtPortsName=gtPortsName, gtSyslogEntry=gtSyslogEntry, gtSyslogState=gtSyslogState, gtPortsFloodMulticast=gtPortsFloodMulticast, gtServicesTable=gtServicesTable, gtUpdateControl=gtUpdateControl, gtSettingsConformance=gtSettingsConformance, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkPortState=gtNetworkPortState, gtAccesslistName=gtAccesslistName, gtInterfaceCLI=gtInterfaceCLI, gtUpdateFilesEntry=gtUpdateFilesEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceEntry=gtInterfaceEntry, gtSettingsObjects=gtSettingsObjects, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceIGMP=gtInterfaceIGMP, gtSLATable=gtSLATable, gtModuleBackupTable=gtModuleBackupTable, gtPortsEntry=gtPortsEntry, gtInterfaceName=gtInterfaceName, gtSyslogTable=gtSyslogTable, gtSettingsMIB=gtSettingsMIB, gtUpdateFile=gtUpdateFile, gtUserIdx=gtUserIdx, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSFPLink=gtSFPLink, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtTrapDestIP=gtTrapDestIP, gtFilename=gtFilename, gtSFTPPassword=gtSFTPPassword, gtUserAccesslist=gtUserAccesslist, gtNumSFP=gtNumSFP, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserGroup=gtUserGroup, gtSwitch=gtSwitch)
