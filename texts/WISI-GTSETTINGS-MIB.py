...
MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Counter32, Gauge32, ObjectIdentity, NotificationType, Unsigned32, IpAddress, ModuleIdentity, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Counter32", "Gauge32", "ObjectIdentity", "NotificationType", "Unsigned32", "IpAddress", "ModuleIdentity", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtHMSNumMembers=gtHMSNumMembers, gtPortsEntry=gtPortsEntry, gtTimeUTC=gtTimeUTC, gtUpdateStatus=gtUpdateStatus, gtInterfaceName=gtInterfaceName, gtInterfaceStreaming=gtInterfaceStreaming, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSettingsNotifications=gtSettingsNotifications, gtUserTable=gtUserTable, gtSFTPUsername=gtSFTPUsername, gtNetworkPortName=gtNetworkPortName, gtPortsFloodMulticast=gtPortsFloodMulticast, gtModuleBackupTable=gtModuleBackupTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNTPServerEntry=gtNTPServerEntry, gtPortsLinkup=gtPortsLinkup, gtInterfaceMAC=gtInterfaceMAC, gtInterfaceWebMgt=gtInterfaceWebMgt, gtAgentState=gtAgentState, gtGroupRights=gtGroupRights, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtModuleUpdate=gtModuleUpdate, gtGroupTable=gtGroupTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNumSFP=gtNumSFP, gtDNSNumber=gtDNSNumber, gtBackupStatus=gtBackupStatus, gtTrapDestIP=gtTrapDestIP, gtSyslogIP=gtSyslogIP, gtInterfaceSNMP=gtInterfaceSNMP, gtNTPServerTable=gtNTPServerTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserIdx=gtUserIdx, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNetworkVLAN=gtNetworkVLAN, gtSFPEntry=gtSFPEntry, gtUserGroup=gtUserGroup, gtTimeZone=gtTimeZone, gtSLARegistered=gtSLARegistered, gtSFTPPassword=gtSFTPPassword, gtDateAndTimeTable=gtDateAndTimeTable, gtSFPType=gtSFPType, gtHMSEntry=gtHMSEntry, gtPortsTable=gtPortsTable, gtModuleBackupDate=gtModuleBackupDate, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtAccesslistEntry=gtAccesslistEntry, gtSettingsObjects=gtSettingsObjects, gtHMSTable=gtHMSTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSWOption=gtSWOption, gtSFPLink=gtSFPLink, gtSLAExpires=gtSLAExpires, gtBackupControl=gtBackupControl, gtHMSGroupName=gtHMSGroupName, gtSettingsGroups=gtSettingsGroups, gtSWOptionsIdx=gtSWOptionsIdx, gtTimeLocal=gtTimeLocal, gtGroupName=gtGroupName, gtGroupAccesslist=gtGroupAccesslist, gtNetworkPortsTable=gtNetworkPortsTable, gtPortsName=gtPortsName, gtUserName=gtUserName, gtAccesslistIPRange=gtAccesslistIPRange, gtCurrentUserPassword=gtCurrentUserPassword, gtModuleBackupStatus=gtModuleBackupStatus, gtBackupSFTPServer=gtBackupSFTPServer, gtSNMPTable=gtSNMPTable, gtTrapDestPort=gtTrapDestPort, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSettingsConformance=gtSettingsConformance, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNTPServerAddress=gtNTPServerAddress, gtUpdateFilesEntry=gtUpdateFilesEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSettingsCompliances=gtSettingsCompliances, gtAccesslistTable=gtAccesslistTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtWebAuth=gtWebAuth, gtModuleBackup=gtModuleBackup, gtSFPTable=gtSFPTable, gtSNMPEntry=gtSNMPEntry, gtTrapDestNumber=gtTrapDestNumber, gtAccesslistName=gtAccesslistName, gtGroupParamIdx=gtGroupParamIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUserAuthTable=gtUserAuthTable, gtDateAndTimeEntry=gtDateAndTimeEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceState=gtInterfaceState, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapComString=gtTrapComString, PYSNMP_MODULE_ID=gtSettingsMIB, gtDNSEntry=gtDNSEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtTrapDestTable=gtTrapDestTable, gtUserRowStatus=gtUserRowStatus, gtModuleBackupControl=gtModuleBackupControl, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFTPPort=gtSFTPPort, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapDestEntry=gtTrapDestEntry, gtDNSServerIP=gtDNSServerIP, gtAgentComReadString=gtAgentComReadString, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSFPPlugged=gtSFPPlugged, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtFilename=gtFilename, gtNetworkPortNumber=gtNetworkPortNumber, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtGroupIdx=gtGroupIdx, gtServicesTable=gtServicesTable, gtWebProtocol=gtWebProtocol, gtBackupSFTPUsername=gtBackupSFTPUsername, gtPortsNumber=gtPortsNumber, gtUpdateControl=gtUpdateControl, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtInterfaceCLI=gtInterfaceCLI, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSWOptionsTable=gtSWOptionsTable, gtSWOptionsEntry=gtSWOptionsEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtAgentComWriteString=gtAgentComWriteString, gtSLAEntry=gtSLAEntry, gtNetworking=gtNetworking, gtUserAccesslist=gtUserAccesslist, gtHMSComMethod=gtHMSComMethod, gtTrapUser=gtTrapUser, gtBackupSFTPFilename=gtBackupSFTPFilename, gtAccesslistIdx=gtAccesslistIdx, gtSyslogEntry=gtSyslogEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtSyslogState=gtSyslogState, gtCurrentTimeSource=gtCurrentTimeSource, gtGroupEntry=gtGroupEntry, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtServicesEntry=gtServicesEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTrapPDU=gtTrapPDU, gtServices=gtServices, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceTable=gtInterfaceTable, gtSyslogTable=gtSyslogTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFPSpeed=gtSFPSpeed, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceIGMP=gtInterfaceIGMP, gtUserPassword=gtUserPassword, gtNetworkEntry=gtNetworkEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtSFPNumber=gtSFPNumber, gtAgentPort=gtAgentPort, gtTrapDestRowStatus=gtTrapDestRowStatus, gtUserAuthEntry=gtUserAuthEntry, gtNetworkPortState=gtNetworkPortState, gtNetworkName=gtNetworkName, gtSFTPServer=gtSFTPServer, gtModuleBackupEntry=gtModuleBackupEntry, gtDateAndTime=gtDateAndTime, gtHMSNumAvailModules=gtHMSNumAvailModules, gtUpdateFilesTable=gtUpdateFilesTable, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtChassisRedundancy=gtChassisRedundancy, gtGeneral=gtGeneral, gtWebEnable=gtWebEnable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUpdateFile=gtUpdateFile, gtSLATable=gtSLATable, gtDNSTable=gtDNSTable, gtTrapState=gtTrapState, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkTable=gtNetworkTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUserEntry=gtUserEntry, gtCurrentUserName=gtCurrentUserName, gtSwitch=gtSwitch, gtUser=gtUser, gtUserParamIdx=gtUserParamIdx, gtSettingsMIB=gtSettingsMIB, gtSNMP=gtSNMP)
