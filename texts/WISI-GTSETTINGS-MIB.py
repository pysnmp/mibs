...
Counter32, Gauge32, ObjectIdentity, MibIdentifier, Bits, Counter64, NotificationType, Integer32, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "ObjectIdentity", "MibIdentifier", "Bits", "Counter64", "NotificationType", "Integer32", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtUserParamIdx=gtUserParamIdx, gtModuleBackupTable=gtModuleBackupTable, gtAgentComReadString=gtAgentComReadString, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceEntry=gtInterfaceEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtTrapDestPort=gtTrapDestPort, gtPortsLinkup=gtPortsLinkup, gtModuleBackupControl=gtModuleBackupControl, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserAuthEntry=gtUserAuthEntry, gtTrapDestNumber=gtTrapDestNumber, PYSNMP_MODULE_ID=gtSettingsMIB, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSettingsNotifications=gtSettingsNotifications, gtNumSFP=gtNumSFP, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtAccesslistTable=gtAccesslistTable, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtBackupSFTPPassword=gtBackupSFTPPassword, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtAccesslistName=gtAccesslistName, gtSLAExpires=gtSLAExpires, gtSFPPlugged=gtSFPPlugged, gtAccesslistParamIdx=gtAccesslistParamIdx, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtTrapComString=gtTrapComString, gtUserEntry=gtUserEntry, gtWebProtocol=gtWebProtocol, gtDNSEntry=gtDNSEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUpdateStatus=gtUpdateStatus, gtInterfaceNumber=gtInterfaceNumber, gtDateAndTimeTable=gtDateAndTimeTable, gtTimeZone=gtTimeZone, gtNTPServerTable=gtNTPServerTable, gtNetworkTable=gtNetworkTable, gtInterfaceStreaming=gtInterfaceStreaming, gtGroupParamIdx=gtGroupParamIdx, gtWebAuth=gtWebAuth, gtGroupTable=gtGroupTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSNMP=gtSNMP, gtTrapDestIP=gtTrapDestIP, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSWOption=gtSWOption, gtUserTable=gtUserTable, gtNetworkVLAN=gtNetworkVLAN, gtHMSGroupName=gtHMSGroupName, gtBackupSFTPServer=gtBackupSFTPServer, gtUpdateFilesEntry=gtUpdateFilesEntry, gtFilename=gtFilename, gtDateAndTime=gtDateAndTime, gtPortsName=gtPortsName, gtInterfaceIGMP=gtInterfaceIGMP, gtSFTPUsername=gtSFTPUsername, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSFPType=gtSFPType, gtAgentComWriteString=gtAgentComWriteString, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSFPTable=gtSFPTable, gtInterfaceTable=gtInterfaceTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtWebEnable=gtWebEnable, gtUserIdx=gtUserIdx, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceIPv4=gtInterfaceIPv4, gtNTPServerEntry=gtNTPServerEntry, gtSyslogTable=gtSyslogTable, gtNetworkName=gtNetworkName, gtTrapPDU=gtTrapPDU, gtNetworkPortsEntry=gtNetworkPortsEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSettingsGroups=gtSettingsGroups, gtModuleBackup=gtModuleBackup, gtGroupEntry=gtGroupEntry, gtDNSTable=gtDNSTable, gtSLAEntry=gtSLAEntry, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUserRowStatus=gtUserRowStatus, gtNTPServerAddress=gtNTPServerAddress, gtServicesTable=gtServicesTable, gtGroupIdx=gtGroupIdx, gtPortsFloodMulticast=gtPortsFloodMulticast, gtModuleUpdate=gtModuleUpdate, gtNetworkPortName=gtNetworkPortName, gtSFTPPassword=gtSFTPPassword, gtNetworking=gtNetworking, gtServices=gtServices, gtInterfaceRowStatus=gtInterfaceRowStatus, gtTrapDestRowStatus=gtTrapDestRowStatus, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceName=gtInterfaceName, gtNTPServerNumber=gtNTPServerNumber, gtGroupRights=gtGroupRights, gtSwitch=gtSwitch, gtSyslogState=gtSyslogState, gtUserAccesslist=gtUserAccesslist, gtSLATable=gtSLATable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtGroupName=gtGroupName, gtInterfaceCLI=gtInterfaceCLI, gtSFTPPort=gtSFTPPort, gtTimeLocal=gtTimeLocal, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtAgentState=gtAgentState, gtAgentPort=gtAgentPort, gtTrapUser=gtTrapUser, gtHMSTable=gtHMSTable, gtChassisRedundancy=gtChassisRedundancy, gtServicesEntry=gtServicesEntry, gtUserName=gtUserName, gtSyslogEntry=gtSyslogEntry, gtSFPNumber=gtSFPNumber, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceSNMP=gtInterfaceSNMP, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserAuthEnabled=gtUserAuthEnabled, gtModuleBackupEntry=gtModuleBackupEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkPortState=gtNetworkPortState, gtGroupAccesslist=gtGroupAccesslist, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapDestTable=gtTrapDestTable, gtSettingsMIB=gtSettingsMIB, gtSFTPServer=gtSFTPServer, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceWebMgt=gtInterfaceWebMgt, gtDNSServerIP=gtDNSServerIP, gtTrapDestEntry=gtTrapDestEntry, gtModuleBackupDate=gtModuleBackupDate, gtSFPEntry=gtSFPEntry, gtSNMPTable=gtSNMPTable, gtUserGroup=gtUserGroup, gtSWOptionsIdx=gtSWOptionsIdx, gtSettingsObjects=gtSettingsObjects, gtSNMPEntry=gtSNMPEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtGeneral=gtGeneral, gtSFPSpeed=gtSFPSpeed, gtUser=gtUser, gtInterfaceMAC=gtInterfaceMAC, gtNetworkPortsTable=gtNetworkPortsTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtModuleBackupStatus=gtModuleBackupStatus, gtHMSComMethod=gtHMSComMethod, gtBackupStatus=gtBackupStatus, gtCurrentTimeSource=gtCurrentTimeSource, gtCurrentUserName=gtCurrentUserName, gtUpdateFile=gtUpdateFile, gtPortsTable=gtPortsTable, gtSWOptionsEntry=gtSWOptionsEntry, gtBackupControl=gtBackupControl, gtDNSNumber=gtDNSNumber, gtSettingsCompliances=gtSettingsCompliances, gtUserAuthTable=gtUserAuthTable, gtBackupSFTPPort=gtBackupSFTPPort, gtSWOptionsTable=gtSWOptionsTable, gtAccesslistIdx=gtAccesslistIdx, gtAccesslistEntry=gtAccesslistEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtTrapState=gtTrapState, gtHMSEntry=gtHMSEntry, gtNetworkEntry=gtNetworkEntry, gtInterfaceState=gtInterfaceState, gtHMSNumMembers=gtHMSNumMembers, gtSettingsConformance=gtSettingsConformance, gtUpdateControl=gtUpdateControl, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceDHCPState=gtInterfaceDHCPState, gtPortsNumber=gtPortsNumber, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtTimeUTC=gtTimeUTC, gtSLARegistered=gtSLARegistered, gtSFPLink=gtSFPLink, gtInterfaceVLAN=gtInterfaceVLAN, gtUserPassword=gtUserPassword, gtPortsEntry=gtPortsEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtAccesslistIPRange=gtAccesslistIPRange, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSyslogIP=gtSyslogIP, gtIGMPQueryInterval=gtIGMPQueryInterval)
