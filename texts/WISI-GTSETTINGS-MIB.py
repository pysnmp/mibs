...
Bits, Integer32, NotificationType, ModuleIdentity, Unsigned32, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Counter64, ObjectIdentity, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "NotificationType", "ModuleIdentity", "Unsigned32", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Counter64", "ObjectIdentity", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtDateAndTimeEntry=gtDateAndTimeEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserAuthEnabled=gtUserAuthEnabled, gtGroupRights=gtGroupRights, gtBackupSFTPServer=gtBackupSFTPServer, gtGroupAccesslist=gtGroupAccesslist, gtUser=gtUser, gtSLAExpires=gtSLAExpires, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapSNMPVersion=gtTrapSNMPVersion, gtDNSNumber=gtDNSNumber, gtInterfaceWebMgt=gtInterfaceWebMgt, gtGroupEntry=gtGroupEntry, gtPortsEntry=gtPortsEntry, gtSyslogIP=gtSyslogIP, gtSFPLink=gtSFPLink, gtFilename=gtFilename, gtInterfaceStreaming=gtInterfaceStreaming, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceSNMP=gtInterfaceSNMP, gtAgentState=gtAgentState, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAccesslistEntry=gtAccesslistEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSNMPTable=gtSNMPTable, gtDateAndTimeTable=gtDateAndTimeTable, gtAccesslistIPRange=gtAccesslistIPRange, gtWebEnable=gtWebEnable, gtNetworking=gtNetworking, gtAgentComReadString=gtAgentComReadString, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSettingsNotifications=gtSettingsNotifications, gtBackupControl=gtBackupControl, gtSFTPPort=gtSFTPPort, gtNetworkTable=gtNetworkTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtHMSNumAvailModules=gtHMSNumAvailModules, gtDaylightAdjustment=gtDaylightAdjustment, gtUserTable=gtUserTable, gtSFTPUsername=gtSFTPUsername, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTrapDestPort=gtTrapDestPort, gtTrapDestTable=gtTrapDestTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtModuleUpdate=gtModuleUpdate, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapDestNumber=gtTrapDestNumber, gtUserAccesslist=gtUserAccesslist, gtSettingsGroups=gtSettingsGroups, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNTPServerEntry=gtNTPServerEntry, gtDateAndTime=gtDateAndTime, gtUserRowStatus=gtUserRowStatus, gtModuleRedundancyMode=gtModuleRedundancyMode, gtDNSTable=gtDNSTable, gtAgentComWriteString=gtAgentComWriteString, gtSLAEntry=gtSLAEntry, gtPortsLinkup=gtPortsLinkup, gtWebAuth=gtWebAuth, gtHMSEntry=gtHMSEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtUserName=gtUserName, gtPortsTable=gtPortsTable, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtWebProtocol=gtWebProtocol, gtInterfaceTable=gtInterfaceTable, gtTrapDestIP=gtTrapDestIP, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapPDU=gtTrapPDU, gtNumSFP=gtNumSFP, gtModuleBackup=gtModuleBackup, gtCurrentUserName=gtCurrentUserName, gtBackupSFTPPort=gtBackupSFTPPort, gtTimeUTC=gtTimeUTC, gtGeneral=gtGeneral, gtBackupStatus=gtBackupStatus, gtNetworkVLAN=gtNetworkVLAN, gtModuleBackupEntry=gtModuleBackupEntry, gtSWOptionsTable=gtSWOptionsTable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSyslogState=gtSyslogState, gtTrapComString=gtTrapComString, gtGroupName=gtGroupName, gtAccesslistTable=gtAccesslistTable, gtSWOptionsEntry=gtSWOptionsEntry, gtPortsNumber=gtPortsNumber, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleBackupControl=gtModuleBackupControl, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceIPv4=gtInterfaceIPv4, gtSFPTable=gtSFPTable, gtUserParamIdx=gtUserParamIdx, gtSettingsMIB=gtSettingsMIB, gtNetworkPortsTable=gtNetworkPortsTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSFTPPassword=gtSFTPPassword, gtAgentPort=gtAgentPort, gtSLATable=gtSLATable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtModuleBackupTable=gtModuleBackupTable, gtNTPServerAddress=gtNTPServerAddress, gtTrapState=gtTrapState, gtAccesslistParamIdx=gtAccesslistParamIdx, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUserIdx=gtUserIdx, gtSFPEntry=gtSFPEntry, gtHMSTable=gtHMSTable, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceName=gtInterfaceName, gtSWOptionsIdx=gtSWOptionsIdx, gtTrapDestEntry=gtTrapDestEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtUpdateStatus=gtUpdateStatus, gtSyslogTable=gtSyslogTable, gtHMSComMethod=gtHMSComMethod, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceNumber=gtInterfaceNumber, gtUserAuthTable=gtUserAuthTable, gtDNSServerIP=gtDNSServerIP, gtUpdateFile=gtUpdateFile, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceEntry=gtInterfaceEntry, gtSFPType=gtSFPType, gtTimeZone=gtTimeZone, gtSWOption=gtSWOption, gtSFPSpeed=gtSFPSpeed, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSNMP=gtSNMP, gtNTPServerTable=gtNTPServerTable, gtAccesslistIdx=gtAccesslistIdx, gtBackupSFTPPassword=gtBackupSFTPPassword, gtDNSEntry=gtDNSEntry, gtSwitch=gtSwitch, gtNetworkPortVLAN=gtNetworkPortVLAN, gtInterfaceDHCPState=gtInterfaceDHCPState, gtGroupParamIdx=gtGroupParamIdx, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtInterfaceIGMP=gtInterfaceIGMP, gtServicesEntry=gtServicesEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtHMSNumMembers=gtHMSNumMembers, gtUserAuthEntry=gtUserAuthEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtNetworkPortNumber=gtNetworkPortNumber, gtSettingsObjects=gtSettingsObjects, gtInterfaceMAC=gtInterfaceMAC, gtNetworkPortsEntry=gtNetworkPortsEntry, gtServices=gtServices, gtUserEntry=gtUserEntry, gtGroupIdx=gtGroupIdx, gtNetworkPortName=gtNetworkPortName, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNTPServerNumber=gtNTPServerNumber, gtSettingsConformance=gtSettingsConformance, gtInterfaceCLI=gtInterfaceCLI, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSLARegistered=gtSLARegistered, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUpdateControl=gtUpdateControl, gtPortsName=gtPortsName, gtAccesslistName=gtAccesslistName, gtInterfaceState=gtInterfaceState, gtServicesTable=gtServicesTable, gtGroupTable=gtGroupTable, gtTrapUser=gtTrapUser, gtChassisRedundancy=gtChassisRedundancy, gtNetworkEntry=gtNetworkEntry, gtUpdateFilesEntry=gtUpdateFilesEntry, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFTPServer=gtSFTPServer, gtSFPNumber=gtSFPNumber, gtHMSGroupName=gtHMSGroupName, gtSyslogEntry=gtSyslogEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSFPPlugged=gtSFPPlugged, gtCurrentTimeSource=gtCurrentTimeSource, gtUserPassword=gtUserPassword, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTimeLocal=gtTimeLocal, gtSNMPEntry=gtSNMPEntry, gtNetworkPortState=gtNetworkPortState, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkName=gtNetworkName, gtUserGroup=gtUserGroup)
