...
NotificationType, MibIdentifier, ModuleIdentity, Counter64, Gauge32, Integer32, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, ObjectIdentity, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "ModuleIdentity", "Counter64", "Gauge32", "Integer32", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "ObjectIdentity", "IpAddress", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtTrapDestEntry=gtTrapDestEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtSyslogState=gtSyslogState, gtHMSNumMembers=gtHMSNumMembers, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTrapComString=gtTrapComString, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSFPEntry=gtSFPEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUpdateFile=gtUpdateFile, gtTrapPDU=gtTrapPDU, gtNetworkPortsEntry=gtNetworkPortsEntry, gtInterfaceTable=gtInterfaceTable, gtTimeUTC=gtTimeUTC, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceCLI=gtInterfaceCLI, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSFPNumber=gtSFPNumber, gtSLARegistered=gtSLARegistered, gtInterfaceState=gtInterfaceState, gtUserParamIdx=gtUserParamIdx, gtAgentPort=gtAgentPort, gtCurrentUserName=gtCurrentUserName, gtNetworkTable=gtNetworkTable, gtHMSEntry=gtHMSEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtNetworking=gtNetworking, gtSWOptionsEntry=gtSWOptionsEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceName=gtInterfaceName, gtSLATable=gtSLATable, gtNTPServerEntry=gtNTPServerEntry, gtUpdateStatus=gtUpdateStatus, gtSWOptionsTable=gtSWOptionsTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtDateAndTimeEntry=gtDateAndTimeEntry, gtWebProtocol=gtWebProtocol, gtSFTPPort=gtSFTPPort, gtInterfaceEntry=gtInterfaceEntry, gtGroupEntry=gtGroupEntry, gtWebEnable=gtWebEnable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtDNSNumber=gtDNSNumber, gtSettingsGroups=gtSettingsGroups, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSettingsConformance=gtSettingsConformance, gtSFTPServer=gtSFTPServer, gtUserPassword=gtUserPassword, gtServicesEntry=gtServicesEntry, gtSettingsMIB=gtSettingsMIB, gtUserTable=gtUserTable, gtSLAEntry=gtSLAEntry, gtDNSTable=gtDNSTable, gtNetworkPortsTable=gtNetworkPortsTable, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceMAC=gtInterfaceMAC, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtPortsLinkup=gtPortsLinkup, gtPortsNumber=gtPortsNumber, gtHMSNumAvailModules=gtHMSNumAvailModules, gtGroupTable=gtGroupTable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtAgentComReadString=gtAgentComReadString, gtUserGroup=gtUserGroup, gtSFTPUsername=gtSFTPUsername, gtBackupControl=gtBackupControl, gtSyslogEntry=gtSyslogEntry, gtFilename=gtFilename, gtTimeZone=gtTimeZone, gtTrapState=gtTrapState, gtUserRowStatus=gtUserRowStatus, gtServicesTable=gtServicesTable, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtBackupStatus=gtBackupStatus, gtWebAuth=gtWebAuth, gtInterfaceIGMP=gtInterfaceIGMP, gtUpdateFilesTable=gtUpdateFilesTable, gtModuleBackupStatus=gtModuleBackupStatus, gtSwitch=gtSwitch, gtNetworkPortName=gtNetworkPortName, gtGroupAccesslist=gtGroupAccesslist, gtTimeLocal=gtTimeLocal, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSFPLink=gtSFPLink, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceIfIndex=gtInterfaceIfIndex, gtTrapUser=gtTrapUser, gtUserEntry=gtUserEntry, gtModuleBackupTable=gtModuleBackupTable, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtIGMPQueryInterval=gtIGMPQueryInterval, gtUpdateControl=gtUpdateControl, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkName=gtNetworkName, PYSNMP_MODULE_ID=gtSettingsMIB, gtUserAuthEnabled=gtUserAuthEnabled, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSFPType=gtSFPType, gtInterfaceIPv4=gtInterfaceIPv4, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSettingsObjects=gtSettingsObjects, gtUserAccesslist=gtUserAccesslist, gtGroupParamIdx=gtGroupParamIdx, gtUserIdx=gtUserIdx, gtSettingsNotifications=gtSettingsNotifications, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsName=gtPortsName, gtModuleBackupDate=gtModuleBackupDate, gtTrapDestIP=gtTrapDestIP, gtGroupName=gtGroupName, gtNTPServerNumber=gtNTPServerNumber, gtSLAExpires=gtSLAExpires, gtUserAuthTable=gtUserAuthTable, gtModuleBackupEntry=gtModuleBackupEntry, gtTrapDestPort=gtTrapDestPort, gtSFTPPassword=gtSFTPPassword, gtCurrentTimeSource=gtCurrentTimeSource, gtDNSEntry=gtDNSEntry, gtGeneral=gtGeneral, gtTrapSNMPVersion=gtTrapSNMPVersion, gtChassisRedundancy=gtChassisRedundancy, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceNumber=gtInterfaceNumber, gtNTPServerRowStatus=gtNTPServerRowStatus, gtDNSServerIP=gtDNSServerIP, gtNTPServerAddress=gtNTPServerAddress, gtTrapDestNumber=gtTrapDestNumber, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtPortsTable=gtPortsTable, gtTrapDestTable=gtTrapDestTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAccesslistIPRange=gtAccesslistIPRange, gtSettingsCompliances=gtSettingsCompliances, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtPortsFloodMulticast=gtPortsFloodMulticast, gtNetworkEntry=gtNetworkEntry, gtNetworkPortState=gtNetworkPortState, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtAgentComWriteString=gtAgentComWriteString, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtUserName=gtUserName, gtSyslogIP=gtSyslogIP, gtUser=gtUser, gtModuleBackup=gtModuleBackup, gtModuleUpdate=gtModuleUpdate, gtSFPSpeed=gtSFPSpeed, gtAccesslistName=gtAccesslistName, gtAccesslistTable=gtAccesslistTable, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSWOption=gtSWOption, gtSFPTable=gtSFPTable, gtDateAndTime=gtDateAndTime, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNTPServerTable=gtNTPServerTable, gtNumSFP=gtNumSFP, gtSFPPlugged=gtSFPPlugged, gtInterfaceStreaming=gtInterfaceStreaming, gtAccesslistEntry=gtAccesslistEntry, gtBackupSFTPServer=gtBackupSFTPServer, gtGroupIdx=gtGroupIdx, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSNMP=gtSNMP, gtAgentState=gtAgentState, gtBackupSFTPPassword=gtBackupSFTPPassword, gtHMSComMethod=gtHMSComMethod, gtGroupRights=gtGroupRights, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUserAuthEntry=gtUserAuthEntry, gtSyslogTable=gtSyslogTable, gtHMSTable=gtHMSTable, gtSNMPEntry=gtSNMPEntry, gtPortsEntry=gtPortsEntry, gtHMSGroupName=gtHMSGroupName, gtSNMPTable=gtSNMPTable, gtInterfaceVLAN=gtInterfaceVLAN, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtAgentSecurityLevel=gtAgentSecurityLevel, gtNetworkPortVLAN=gtNetworkPortVLAN, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkVLAN=gtNetworkVLAN, gtModuleBackupControl=gtModuleBackupControl, gtServices=gtServices)
