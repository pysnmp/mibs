...
Integer32, ObjectIdentity, MibIdentifier, IpAddress, iso, Counter64, Bits, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Unsigned32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "MibIdentifier", "IpAddress", "iso", "Counter64", "Bits", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Unsigned32", "ModuleIdentity")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSettingsGroups=gtSettingsGroups, gtSettingsNotifications=gtSettingsNotifications, gtAccesslistParamIdx=gtAccesslistParamIdx, gtHMSGroupName=gtHMSGroupName, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSLATable=gtSLATable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSLAEntry=gtSLAEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtBackupSFTPPassword=gtBackupSFTPPassword, gtModuleBackup=gtModuleBackup, gtSWOptionsIdx=gtSWOptionsIdx, gtSWOptionsEntry=gtSWOptionsEntry, gtSyslogState=gtSyslogState, gtInterfaceRowStatus=gtInterfaceRowStatus, gtPortsBitrateReceive=gtPortsBitrateReceive, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAgentComReadString=gtAgentComReadString, gtInterfaceVLAN=gtInterfaceVLAN, gtUserName=gtUserName, gtSettingsCompliances=gtSettingsCompliances, gtGroupTable=gtGroupTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSNMP=gtSNMP, gtHMSTable=gtHMSTable, gtSFTPServer=gtSFTPServer, gtIGMPQueryInterval=gtIGMPQueryInterval, gtModuleBackupTable=gtModuleBackupTable, gtUpdateControl=gtUpdateControl, gtUserTable=gtUserTable, gtSFPNumber=gtSFPNumber, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtWebEnable=gtWebEnable, gtSNMPEntry=gtSNMPEntry, gtDateAndTime=gtDateAndTime, gtServicesTable=gtServicesTable, gtSWOptionsTable=gtSWOptionsTable, gtGroupParamIdx=gtGroupParamIdx, gtTrapUser=gtTrapUser, gtUpdateFilesTable=gtUpdateFilesTable, gtHeadendSystemManagement=gtHeadendSystemManagement, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceCLI=gtInterfaceCLI, gtSFPPlugged=gtSFPPlugged, gtUserGroup=gtUserGroup, gtAgentState=gtAgentState, gtNTPServerAddress=gtNTPServerAddress, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtHMSEntry=gtHMSEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtAgentComWriteString=gtAgentComWriteString, gtUserIdx=gtUserIdx, gtAccesslistIdx=gtAccesslistIdx, gtTrapSNMPVersion=gtTrapSNMPVersion, gtUserParamIdx=gtUserParamIdx, gtInterfaceMAC=gtInterfaceMAC, gtTrapDestNumber=gtTrapDestNumber, gtBackupSFTPServer=gtBackupSFTPServer, gtDNSNumber=gtDNSNumber, gtSwitch=gtSwitch, gtHMSNumAvailModules=gtHMSNumAvailModules, gtDateAndTimeTable=gtDateAndTimeTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtDNSTable=gtDNSTable, gtUserAccesslist=gtUserAccesslist, gtInterfaceTable=gtInterfaceTable, gtTimeZone=gtTimeZone, gtBackupSFTPPort=gtBackupSFTPPort, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtModuleBackupStatus=gtModuleBackupStatus, gtSFPLink=gtSFPLink, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceState=gtInterfaceState, gtBackupControl=gtBackupControl, gtPortsNumber=gtPortsNumber, gtTrapDestIP=gtTrapDestIP, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtInterfaceNumber=gtInterfaceNumber, gtModuleUpdate=gtModuleUpdate, gtInterfaceWebMgt=gtInterfaceWebMgt, gtServices=gtServices, gtCurrentTimeSource=gtCurrentTimeSource, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtNetworking=gtNetworking, gtNetworkTable=gtNetworkTable, gtSettingsObjects=gtSettingsObjects, gtNetworkPortName=gtNetworkPortName, gtSFTPUsername=gtSFTPUsername, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSettingsConformance=gtSettingsConformance, gtSFPTable=gtSFPTable, gtNetworkVLAN=gtNetworkVLAN, gtWebProtocol=gtWebProtocol, gtUpdateStatus=gtUpdateStatus, gtBackupStatus=gtBackupStatus, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtUserEntry=gtUserEntry, gtUpdateFile=gtUpdateFile, gtTrapDestPort=gtTrapDestPort, gtGroupName=gtGroupName, gtUserAuthTable=gtUserAuthTable, gtModuleBackupControl=gtModuleBackupControl, gtTrapPDU=gtTrapPDU, gtNTPServerRowStatus=gtNTPServerRowStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSyslogIP=gtSyslogIP, gtInterfaceIGMP=gtInterfaceIGMP, gtNTPServerNumber=gtNTPServerNumber, gtGroupIdx=gtGroupIdx, gtInterfaceSNMP=gtInterfaceSNMP, gtSFPEntry=gtSFPEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtNTPServerTable=gtNTPServerTable, gtUserPassword=gtUserPassword, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceName=gtInterfaceName, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNumSFP=gtNumSFP, gtBackupSFTPUsername=gtBackupSFTPUsername, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTimeUTC=gtTimeUTC, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUserAuthEntry=gtUserAuthEntry, gtTimeLocal=gtTimeLocal, gtAgentSecurityLevel=gtAgentSecurityLevel, gtTrapDestRowStatus=gtTrapDestRowStatus, gtPortsLinkup=gtPortsLinkup, gtDateAndTimeEntry=gtDateAndTimeEntry, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSNMPTable=gtSNMPTable, gtPortsEntry=gtPortsEntry, gtHMSNumMembers=gtHMSNumMembers, gtModuleRedundancyMode=gtModuleRedundancyMode, gtCurrentUserName=gtCurrentUserName, gtTrapDestTable=gtTrapDestTable, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSettingsMIB=gtSettingsMIB, gtTrapComString=gtTrapComString, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFTPPassword=gtSFTPPassword, gtAccesslistIPRange=gtAccesslistIPRange, gtSWOption=gtSWOption, gtSFPType=gtSFPType, gtSLARegistered=gtSLARegistered, gtInterfaceStreaming=gtInterfaceStreaming, gtTrapDestEntry=gtTrapDestEntry, gtFilename=gtFilename, gtGroupAccesslist=gtGroupAccesslist, gtDNSEntry=gtDNSEntry, gtHMSComMethod=gtHMSComMethod, gtSFTPPort=gtSFTPPort, gtNetworkEntry=gtNetworkEntry, gtSLAExpires=gtSLAExpires, gtPortsTable=gtPortsTable, gtInterfaceEntry=gtInterfaceEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtBackupSFTPFilename=gtBackupSFTPFilename, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtAccesslistName=gtAccesslistName, gtChassisRedundancy=gtChassisRedundancy, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtPortsName=gtPortsName, gtAccesslistTable=gtAccesslistTable, gtNetworkPortsTable=gtNetworkPortsTable, gtSyslogEntry=gtSyslogEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSFPSpeed=gtSFPSpeed, gtUserRowStatus=gtUserRowStatus, gtGroupEntry=gtGroupEntry, gtModuleBackupDate=gtModuleBackupDate, gtTrapState=gtTrapState, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUserAuthEnabled=gtUserAuthEnabled, gtGeneral=gtGeneral, gtUser=gtUser, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtAccesslistEntry=gtAccesslistEntry, gtModuleBackupEntry=gtModuleBackupEntry, gtSyslogTable=gtSyslogTable, gtServicesEntry=gtServicesEntry, gtNetworkPortState=gtNetworkPortState, gtNTPServerEntry=gtNTPServerEntry, gtAgentPort=gtAgentPort, gtWebAuth=gtWebAuth, gtInterfaceIPv4=gtInterfaceIPv4, gtDNSServerIP=gtDNSServerIP, gtNetworkName=gtNetworkName, gtGroupRights=gtGroupRights)
