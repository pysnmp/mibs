...
iso, Bits, ModuleIdentity, Counter64, TimeTicks, Unsigned32, Counter32, NotificationType, Integer32, Gauge32, IpAddress, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "ModuleIdentity", "Counter64", "TimeTicks", "Unsigned32", "Counter32", "NotificationType", "Integer32", "Gauge32", "IpAddress", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtDNSEntry=gtDNSEntry, gtSFTPServer=gtSFTPServer, gtSettingsConformance=gtSettingsConformance, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtPortsFloodMulticast=gtPortsFloodMulticast, gtServices=gtServices, gtHMSNumMembers=gtHMSNumMembers, gtHMSGroupName=gtHMSGroupName, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSettingsObjects=gtSettingsObjects, gtSFTPUsername=gtSFTPUsername, gtModuleUpdate=gtModuleUpdate, gtSyslogTable=gtSyslogTable, gtNetworkTable=gtNetworkTable, gtSLAEntry=gtSLAEntry, gtInterfaceName=gtInterfaceName, gtDNSTable=gtDNSTable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtNetworkPortName=gtNetworkPortName, gtTimeUTC=gtTimeUTC, gtUserPassword=gtUserPassword, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtBackupControl=gtBackupControl, gtNetworkEntry=gtNetworkEntry, gtTrapPDU=gtTrapPDU, gtModuleBackupControl=gtModuleBackupControl, gtUpdateFilesEntry=gtUpdateFilesEntry, gtUser=gtUser, gtAccesslistName=gtAccesslistName, gtSLARegistered=gtSLARegistered, gtTrapDestNumber=gtTrapDestNumber, gtAccesslistEntry=gtAccesslistEntry, gtTimeZone=gtTimeZone, gtNTPServerNumber=gtNTPServerNumber, gtGroupTable=gtGroupTable, gtNetworking=gtNetworking, gtInterfaceWebMgt=gtInterfaceWebMgt, gtDNSNumber=gtDNSNumber, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkPortVLAN=gtNetworkPortVLAN, gtAccesslistIdx=gtAccesslistIdx, gtUserRowStatus=gtUserRowStatus, gtSFTPPassword=gtSFTPPassword, gtNTPServerAddress=gtNTPServerAddress, gtAgentComWriteString=gtAgentComWriteString, gtTimeLocal=gtTimeLocal, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceNumber=gtInterfaceNumber, gtInterfaceTable=gtInterfaceTable, gtInterfaceEntry=gtInterfaceEntry, gtPortsLinkup=gtPortsLinkup, gtPortsName=gtPortsName, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSFPPlugged=gtSFPPlugged, gtWebEnable=gtWebEnable, gtSFPLink=gtSFPLink, gtAccesslistTable=gtAccesslistTable, gtNetworkPortsTable=gtNetworkPortsTable, gtDateAndTimeTable=gtDateAndTimeTable, gtServicesEntry=gtServicesEntry, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceIGMP=gtInterfaceIGMP, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFPTable=gtSFPTable, gtNetworkName=gtNetworkName, gtSwitch=gtSwitch, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceMAC=gtInterfaceMAC, gtInterfaceIPv4=gtInterfaceIPv4, gtAgentComReadString=gtAgentComReadString, gtDateAndTimeEntry=gtDateAndTimeEntry, gtModuleBackupTable=gtModuleBackupTable, gtHMSTable=gtHMSTable, gtTrapDestEntry=gtTrapDestEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtUserName=gtUserName, gtSFPSpeed=gtSFPSpeed, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtCurrentUserPassword=gtCurrentUserPassword, PYSNMP_MODULE_ID=gtSettingsMIB, gtUpdateControl=gtUpdateControl, gtInterfaceStreaming=gtInterfaceStreaming, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkPortNumber=gtNetworkPortNumber, gtModuleBackupEntry=gtModuleBackupEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSNMPEntry=gtSNMPEntry, gtUserAccesslist=gtUserAccesslist, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtWebProtocol=gtWebProtocol, gtUpdateFile=gtUpdateFile, gtGeneral=gtGeneral, gtSWOptionsEntry=gtSWOptionsEntry, gtUserEntry=gtUserEntry, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceDHCPState=gtInterfaceDHCPState, gtModuleBackup=gtModuleBackup, gtTrapState=gtTrapState, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUserAuthTable=gtUserAuthTable, gtAgentPort=gtAgentPort, gtSFPEntry=gtSFPEntry, gtDNSServerIP=gtDNSServerIP, gtUserIdx=gtUserIdx, gtBackupSFTPPort=gtBackupSFTPPort, gtBackupSFTPUsername=gtBackupSFTPUsername, gtTrapUser=gtTrapUser, gtModuleBackupStatus=gtModuleBackupStatus, gtTrapComString=gtTrapComString, gtUserGroup=gtUserGroup, gtHMSNumAvailModules=gtHMSNumAvailModules, gtServicesTable=gtServicesTable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUpdateFilesTable=gtUpdateFilesTable, gtSyslogIP=gtSyslogIP, gtSFTPPort=gtSFTPPort, gtInterfaceRowStatus=gtInterfaceRowStatus, gtFilename=gtFilename, gtAgentState=gtAgentState, gtWebAuth=gtWebAuth, gtPortsEntry=gtPortsEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSFPNumber=gtSFPNumber, gtInterfaceState=gtInterfaceState, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtHMSEntry=gtHMSEntry, gtSFPType=gtSFPType, gtSNMP=gtSNMP, gtTrapDestPort=gtTrapDestPort, gtSLATable=gtSLATable, gtNetworkPortState=gtNetworkPortState, gtInterfaceSNMP=gtInterfaceSNMP, gtUserParamIdx=gtUserParamIdx, gtSettingsGroups=gtSettingsGroups, gtNTPServerEntry=gtNTPServerEntry, gtGroupIdx=gtGroupIdx, gtUserAuthEntry=gtUserAuthEntry, gtModuleBackupDate=gtModuleBackupDate, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtCurrentUserName=gtCurrentUserName, gtGroupName=gtGroupName, gtSWOption=gtSWOption, gtDaylightAdjustment=gtDaylightAdjustment, gtUpdateStatus=gtUpdateStatus, gtSLAExpires=gtSLAExpires, gtTrapDestRowStatus=gtTrapDestRowStatus, gtPortsNumber=gtPortsNumber, gtSettingsNotifications=gtSettingsNotifications, gtTrapDestTable=gtTrapDestTable, gtSWOptionsTable=gtSWOptionsTable, gtGroupAccesslist=gtGroupAccesslist, gtCurrentTimeSource=gtCurrentTimeSource, gtSettingsMIB=gtSettingsMIB, gtPortsTable=gtPortsTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceVLAN=gtInterfaceVLAN, gtGroupParamIdx=gtGroupParamIdx, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSyslogEntry=gtSyslogEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNTPServerTable=gtNTPServerTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtNumSFP=gtNumSFP, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceCLI=gtInterfaceCLI, gtChassisRedundancy=gtChassisRedundancy, gtTrapDestIP=gtTrapDestIP, gtDateAndTime=gtDateAndTime, gtInterfaceIfIndex=gtInterfaceIfIndex, gtGroupRights=gtGroupRights, gtUserTable=gtUserTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSyslogState=gtSyslogState, gtBackupStatus=gtBackupStatus, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSNMPTable=gtSNMPTable, gtNetworkVLAN=gtNetworkVLAN, gtHMSComMethod=gtHMSComMethod, gtUserAuthEnabled=gtUserAuthEnabled, gtGroupEntry=gtGroupEntry, gtBackupSFTPServer=gtBackupSFTPServer, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx)
