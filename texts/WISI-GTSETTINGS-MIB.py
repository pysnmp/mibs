...
Counter64, NotificationType, Integer32, Counter32, TimeTicks, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, ModuleIdentity, Bits, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "Integer32", "Counter32", "TimeTicks", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Bits", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtTrapSecurityLevel=gtTrapSecurityLevel, gtPortsLinkup=gtPortsLinkup, gtDaylightAdjustment=gtDaylightAdjustment, gtServicesTable=gtServicesTable, gtWebEnable=gtWebEnable, gtGroupEntry=gtGroupEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFPEntry=gtSFPEntry, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtInterfaceVLAN=gtInterfaceVLAN, gtGroupName=gtGroupName, gtTrapDestPort=gtTrapDestPort, gtInterfaceTable=gtInterfaceTable, gtGroupIdx=gtGroupIdx, gtGroupTable=gtGroupTable, gtModuleUpdate=gtModuleUpdate, gtSLAExpires=gtSLAExpires, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSLAEntry=gtSLAEntry, gtSFPType=gtSFPType, gtSFPPlugged=gtSFPPlugged, gtBackupControl=gtBackupControl, gtModuleBackup=gtModuleBackup, gtSFPNumber=gtSFPNumber, gtDNSNumber=gtDNSNumber, gtServicesEntry=gtServicesEntry, gtAgentComWriteString=gtAgentComWriteString, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNetworkEntry=gtNetworkEntry, gtGroupAccesslist=gtGroupAccesslist, gtSyslogTable=gtSyslogTable, gtGroupRights=gtGroupRights, gtUserAuthTable=gtUserAuthTable, gtAgentComReadString=gtAgentComReadString, gtBackupSFTPServer=gtBackupSFTPServer, gtModuleBackupStatus=gtModuleBackupStatus, gtSNMP=gtSNMP, gtDateAndTimeTable=gtDateAndTimeTable, gtSWOptionsIdx=gtSWOptionsIdx, gtSyslogIP=gtSyslogIP, gtDateAndTimeEntry=gtDateAndTimeEntry, gtTimeUTC=gtTimeUTC, gtNTPServerRowStatus=gtNTPServerRowStatus, gtInterfaceSNMP=gtInterfaceSNMP, gtDateAndTime=gtDateAndTime, gtSWOption=gtSWOption, gtCurrentUserPassword=gtCurrentUserPassword, gtSettingsGroups=gtSettingsGroups, gtInterfaceName=gtInterfaceName, gtInterfaceNumber=gtInterfaceNumber, gtSWOptionsEntry=gtSWOptionsEntry, gtNTPServerTable=gtNTPServerTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtUpdateFilesTable=gtUpdateFilesTable, gtTrapDestNumber=gtTrapDestNumber, gtSFTPPort=gtSFTPPort, gtSFTPUsername=gtSFTPUsername, gtSWOptionsTable=gtSWOptionsTable, gtUserGroup=gtUserGroup, gtHMSComMethod=gtHMSComMethod, gtWebAuth=gtWebAuth, gtSLARegistered=gtSLARegistered, gtInterfaceIGMP=gtInterfaceIGMP, gtUpdateFile=gtUpdateFile, gtPortsBitrateReceive=gtPortsBitrateReceive, gtUser=gtUser, gtUpdateControl=gtUpdateControl, gtAccesslistName=gtAccesslistName, gtNTPServerNumber=gtNTPServerNumber, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSFTPPassword=gtSFTPPassword, gtUserIdx=gtUserIdx, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNetworkName=gtNetworkName, gtUserRowStatus=gtUserRowStatus, gtServices=gtServices, gtBackupStatus=gtBackupStatus, gtInterfaceDHCPState=gtInterfaceDHCPState, gtBackupSFTPPort=gtBackupSFTPPort, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtAccesslistTable=gtAccesslistTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSFPSpeed=gtSFPSpeed, gtAgentState=gtAgentState, gtGroupParamIdx=gtGroupParamIdx, gtPortsTable=gtPortsTable, gtTrapDestEntry=gtTrapDestEntry, gtUserAuthEntry=gtUserAuthEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtUserParamIdx=gtUserParamIdx, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtModuleBackupTable=gtModuleBackupTable, gtSettingsMIB=gtSettingsMIB, gtNetworkPortState=gtNetworkPortState, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtFilename=gtFilename, gtSyslogState=gtSyslogState, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceCLI=gtInterfaceCLI, gtUserEntry=gtUserEntry, gtUserName=gtUserName, gtTimeZone=gtTimeZone, gtSFPTable=gtSFPTable, gtTrapComString=gtTrapComString, gtSFTPServer=gtSFTPServer, gtNetworkTable=gtNetworkTable, gtIGMPQueryInterval=gtIGMPQueryInterval, PYSNMP_MODULE_ID=gtSettingsMIB, gtBackupSFTPUsername=gtBackupSFTPUsername, gtPortsNumber=gtPortsNumber, gtPortsName=gtPortsName, gtInterfaceState=gtInterfaceState, gtNetworking=gtNetworking, gtTrapPDU=gtTrapPDU, gtNetworkPortsTable=gtNetworkPortsTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtHMSEntry=gtHMSEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSettingsObjects=gtSettingsObjects, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSLATable=gtSLATable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUserTable=gtUserTable, gtModuleBackupEntry=gtModuleBackupEntry, gtAgentPort=gtAgentPort, gtSyslogEntry=gtSyslogEntry, gtCurrentUserName=gtCurrentUserName, gtWebProtocol=gtWebProtocol, gtHMSGroupName=gtHMSGroupName, gtAccesslistParamIdx=gtAccesslistParamIdx, gtHMSNumMembers=gtHMSNumMembers, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceStreaming=gtInterfaceStreaming, gtHMSNumAvailModules=gtHMSNumAvailModules, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtGeneral=gtGeneral, gtSNMPTable=gtSNMPTable, gtTrapDestTable=gtTrapDestTable, gtSNMPEntry=gtSNMPEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtAccesslistIdx=gtAccesslistIdx, gtTrapState=gtTrapState, gtChassisRedundancy=gtChassisRedundancy, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtTrapUser=gtTrapUser, gtNumSFP=gtNumSFP, gtSettingsConformance=gtSettingsConformance, gtSFPLink=gtSFPLink, gtModuleBackupControl=gtModuleBackupControl, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceEntry=gtInterfaceEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtDNSServerIP=gtDNSServerIP, gtPortsEntry=gtPortsEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkPortName=gtNetworkPortName, gtModuleBackupDate=gtModuleBackupDate, gtUpdateFilesEntry=gtUpdateFilesEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtNTPServerAddress=gtNTPServerAddress, gtAccesslistEntry=gtAccesslistEntry, gtUpdateStatus=gtUpdateStatus, gtNTPServerEntry=gtNTPServerEntry, gtNetworkVLAN=gtNetworkVLAN, gtTrapDestIP=gtTrapDestIP, gtInterfaceMAC=gtInterfaceMAC, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtDNSEntry=gtDNSEntry, gtSwitch=gtSwitch, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUserPassword=gtUserPassword, gtHeadendSystemManagement=gtHeadendSystemManagement, gtBackupSFTPFilename=gtBackupSFTPFilename, gtTrapDestRowStatus=gtTrapDestRowStatus, gtDNSTable=gtDNSTable, gtTimeLocal=gtTimeLocal, gtNetworkPortsEntry=gtNetworkPortsEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSettingsCompliances=gtSettingsCompliances, gtHMSTable=gtHMSTable, gtUserAccesslist=gtUserAccesslist, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtPortsFloodMulticast=gtPortsFloodMulticast)
