...
ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, TimeTicks, Counter32, MibIdentifier, Counter64, Bits, ModuleIdentity, IpAddress, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "TimeTicks", "Counter32", "MibIdentifier", "Counter64", "Bits", "ModuleIdentity", "IpAddress", "NotificationType", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtIGMPQueryInterval=gtIGMPQueryInterval, gtHMSComMethod=gtHMSComMethod, gtAccesslistName=gtAccesslistName, gtSFTPUsername=gtSFTPUsername, gtTrapSNMPVersion=gtTrapSNMPVersion, gtDaylightAdjustment=gtDaylightAdjustment, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtModuleBackup=gtModuleBackup, gtDNSEntry=gtDNSEntry, gtTrapDestPort=gtTrapDestPort, gtTrapDestTable=gtTrapDestTable, gtGroupIdx=gtGroupIdx, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkVLAN=gtNetworkVLAN, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNTPServerEntry=gtNTPServerEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtNTPServerTable=gtNTPServerTable, gtFilename=gtFilename, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUpdateFilesTable=gtUpdateFilesTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSettingsObjects=gtSettingsObjects, gtNetworkEntry=gtNetworkEntry, gtWebEnable=gtWebEnable, gtNetworkPortState=gtNetworkPortState, PYSNMP_MODULE_ID=gtSettingsMIB, gtSWOptionsEntry=gtSWOptionsEntry, gtUserIdx=gtUserIdx, gtUserName=gtUserName, gtAccesslistTable=gtAccesslistTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUserAccesslist=gtUserAccesslist, gtDateAndTimeEntry=gtDateAndTimeEntry, gtModuleBackupDate=gtModuleBackupDate, gtHMSTable=gtHMSTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceSNMP=gtInterfaceSNMP, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapPDU=gtTrapPDU, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupName=gtGroupName, gtUserEntry=gtUserEntry, gtUserParamIdx=gtUserParamIdx, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserGroup=gtUserGroup, gtNetworkPortVLAN=gtNetworkPortVLAN, gtSLARegistered=gtSLARegistered, gtModuleBackupTable=gtModuleBackupTable, gtBackupSFTPServer=gtBackupSFTPServer, gtInterfaceIGMP=gtInterfaceIGMP, gtInterfaceIPv4=gtInterfaceIPv4, gtNetworkPortName=gtNetworkPortName, gtInterfaceMAC=gtInterfaceMAC, gtGroupEntry=gtGroupEntry, gtSLAEntry=gtSLAEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceCLI=gtInterfaceCLI, gtSettingsMIB=gtSettingsMIB, gtSFPTable=gtSFPTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtDNSServerIP=gtDNSServerIP, gtInterfaceVLAN=gtInterfaceVLAN, gtSettingsCompliances=gtSettingsCompliances, gtNetworkPortNumber=gtNetworkPortNumber, gtDateAndTime=gtDateAndTime, gtSFPNumber=gtSFPNumber, gtModuleBackupControl=gtModuleBackupControl, gtGroupTable=gtGroupTable, gtSFTPServer=gtSFTPServer, gtTrapComString=gtTrapComString, gtGroupAccesslist=gtGroupAccesslist, gtSFPLink=gtSFPLink, gtSLAExpires=gtSLAExpires, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceTable=gtInterfaceTable, gtSettingsGroups=gtSettingsGroups, gtSFTPPort=gtSFTPPort, gtSettingsNotifications=gtSettingsNotifications, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtNetworking=gtNetworking, gtCurrentUserName=gtCurrentUserName, gtInterfaceStreaming=gtInterfaceStreaming, gtHMSEntry=gtHMSEntry, gtSyslogEntry=gtSyslogEntry, gtAgentPort=gtAgentPort, gtSNMPEntry=gtSNMPEntry, gtSettingsConformance=gtSettingsConformance, gtBackupSFTPFilename=gtBackupSFTPFilename, gtPortsTable=gtPortsTable, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSyslogState=gtSyslogState, gtUserAuthTable=gtUserAuthTable, gtSwitch=gtSwitch, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAccesslistIdx=gtAccesslistIdx, gtCurrentTimeSource=gtCurrentTimeSource, gtSWOptionsIdx=gtSWOptionsIdx, gtSFPPlugged=gtSFPPlugged, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtTrapState=gtTrapState, gtSFTPPassword=gtSFTPPassword, gtUserTable=gtUserTable, gtBackupControl=gtBackupControl, gtSWOptionsTable=gtSWOptionsTable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtTimeLocal=gtTimeLocal, gtWebAuth=gtWebAuth, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtDNSTable=gtDNSTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtServicesEntry=gtServicesEntry, gtSFPEntry=gtSFPEntry, gtServicesTable=gtServicesTable, gtAccesslistIPRange=gtAccesslistIPRange, gtTimeZone=gtTimeZone, gtInterfaceState=gtInterfaceState, gtSNMPTable=gtSNMPTable, gtAgentState=gtAgentState, gtWebProtocol=gtWebProtocol, gtSLATable=gtSLATable, gtNetworkTable=gtNetworkTable, gtNTPServerNumber=gtNTPServerNumber, gtUpdateStatus=gtUpdateStatus, gtTrapUser=gtTrapUser, gtAccesslistEntry=gtAccesslistEntry, gtGroupRights=gtGroupRights, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtGroupParamIdx=gtGroupParamIdx, gtUserAuthEntry=gtUserAuthEntry, gtSFPSpeed=gtSFPSpeed, gtDNSNumber=gtDNSNumber, gtTrapDestEntry=gtTrapDestEntry, gtAgentComReadString=gtAgentComReadString, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceName=gtInterfaceName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtCurrentUserPassword=gtCurrentUserPassword, gtAgentSecurityLevel=gtAgentSecurityLevel, gtPortsName=gtPortsName, gtServices=gtServices, gtUser=gtUser, gtHMSGroupName=gtHMSGroupName, gtSFPType=gtSFPType, gtUserPassword=gtUserPassword, gtInterfaceNumber=gtInterfaceNumber, gtTimeUTC=gtTimeUTC, gtBackupStatus=gtBackupStatus, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtModuleBackupStatus=gtModuleBackupStatus, gtModuleUpdate=gtModuleUpdate, gtNetworkName=gtNetworkName, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSWOption=gtSWOption, gtInterfaceEntry=gtInterfaceEntry, gtTrapDestNumber=gtTrapDestNumber, gtModuleBackupEntry=gtModuleBackupEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSyslogTable=gtSyslogTable, gtPortsEntry=gtPortsEntry, gtUpdateControl=gtUpdateControl, gtUpdateFile=gtUpdateFile, gtChassisRedundancy=gtChassisRedundancy, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtPortsLinkup=gtPortsLinkup, gtGeneral=gtGeneral, gtPortsNumber=gtPortsNumber, gtSyslogIP=gtSyslogIP, gtTrapDestIP=gtTrapDestIP, gtUserAuthEnabled=gtUserAuthEnabled, gtNumSFP=gtNumSFP, gtHMSNumMembers=gtHMSNumMembers, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSNMP=gtSNMP, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtNTPServerAddress=gtNTPServerAddress, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserRowStatus=gtUserRowStatus)
