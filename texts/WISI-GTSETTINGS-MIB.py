...
Bits, NotificationType, Integer32, ModuleIdentity, IpAddress, Counter64, iso, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, MibIdentifier, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Integer32", "ModuleIdentity", "IpAddress", "Counter64", "iso", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "MibIdentifier", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtTimeLocal=gtTimeLocal, gtDaylightAdjustment=gtDaylightAdjustment, gtAgentPort=gtAgentPort, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtDNSEntry=gtDNSEntry, gtSLARegistered=gtSLARegistered, gtInterfaceRowStatus=gtInterfaceRowStatus, gtGroupAccesslist=gtGroupAccesslist, gtServicesEntry=gtServicesEntry, gtAgentComWriteString=gtAgentComWriteString, gtSFTPUsername=gtSFTPUsername, gtInterfaceIPv4=gtInterfaceIPv4, gtDateAndTimeEntry=gtDateAndTimeEntry, gtUserName=gtUserName, gtWebAuth=gtWebAuth, gtModuleBackupControl=gtModuleBackupControl, gtCurrentUserName=gtCurrentUserName, gtAgentComReadString=gtAgentComReadString, gtTrapPDU=gtTrapPDU, gtSNMPTable=gtSNMPTable, gtAccesslistTable=gtAccesslistTable, gtTrapState=gtTrapState, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceWebMgt=gtInterfaceWebMgt, gtModuleRedundancyMode=gtModuleRedundancyMode, gtBackupSFTPUsername=gtBackupSFTPUsername, gtModuleBackupEntry=gtModuleBackupEntry, gtSettingsMIB=gtSettingsMIB, gtAccesslistName=gtAccesslistName, gtServicesTable=gtServicesTable, gtBackupControl=gtBackupControl, gtInterfaceIGMP=gtInterfaceIGMP, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNetworkEntry=gtNetworkEntry, gtInterfaceEntry=gtInterfaceEntry, gtSFPType=gtSFPType, gtGroupParamIdx=gtGroupParamIdx, gtNTPServerAddress=gtNTPServerAddress, gtSettingsNotifications=gtSettingsNotifications, gtAgentState=gtAgentState, gtTrapDestIP=gtTrapDestIP, gtNumSFP=gtNumSFP, gtUserAccesslist=gtUserAccesslist, gtModuleBackupDate=gtModuleBackupDate, gtUserAuthEnabled=gtUserAuthEnabled, gtUserParamIdx=gtUserParamIdx, gtNetworkPortName=gtNetworkPortName, gtFilename=gtFilename, gtUserEntry=gtUserEntry, gtUpdateFilesEntry=gtUpdateFilesEntry, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtDateAndTime=gtDateAndTime, gtDNSServerIP=gtDNSServerIP, PYSNMP_MODULE_ID=gtSettingsMIB, gtNTPServerNumber=gtNTPServerNumber, gtSyslogEntry=gtSyslogEntry, gtTrapSNMPVersion=gtTrapSNMPVersion, gtPortsTable=gtPortsTable, gtModuleBackupStatus=gtModuleBackupStatus, gtGroupRights=gtGroupRights, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtTrapUser=gtTrapUser, gtNetworkPortNumber=gtNetworkPortNumber, gtUpdateFile=gtUpdateFile, gtTrapDestPort=gtTrapDestPort, gtTrapComString=gtTrapComString, gtHMSTable=gtHMSTable, gtBackupSFTPServer=gtBackupSFTPServer, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFPSpeed=gtSFPSpeed, gtInterfaceName=gtInterfaceName, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUpdateControl=gtUpdateControl, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapSecurityLevel=gtTrapSecurityLevel, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSyslogState=gtSyslogState, gtTimeUTC=gtTimeUTC, gtSWOption=gtSWOption, gtUserGroup=gtUserGroup, gtSettingsCompliances=gtSettingsCompliances, gtSNMPEntry=gtSNMPEntry, gtPortsEntry=gtPortsEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtAccesslistIdx=gtAccesslistIdx, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTimeZone=gtTimeZone, gtInterfaceMAC=gtInterfaceMAC, gtNTPServerEntry=gtNTPServerEntry, gtSLAEntry=gtSLAEntry, gtSFPPlugged=gtSFPPlugged, gtInterfaceTable=gtInterfaceTable, gtHMSGroupName=gtHMSGroupName, gtHMSNumMembers=gtHMSNumMembers, gtChassisRedundancy=gtChassisRedundancy, gtModuleBackupTable=gtModuleBackupTable, gtGeneral=gtGeneral, gtUser=gtUser, gtSLATable=gtSLATable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtUserAuthEntry=gtUserAuthEntry, gtGroupName=gtGroupName, gtNetworking=gtNetworking, gtSWOptionsTable=gtSWOptionsTable, gtModuleBackup=gtModuleBackup, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsName=gtPortsName, gtInterfaceVLAN=gtInterfaceVLAN, gtDNSTable=gtDNSTable, gtSyslogIP=gtSyslogIP, gtSyslogTable=gtSyslogTable, gtBackupStatus=gtBackupStatus, gtAccesslistIPRange=gtAccesslistIPRange, gtPortsFloodMulticast=gtPortsFloodMulticast, gtUserAuthTable=gtUserAuthTable, gtInterfaceStreaming=gtInterfaceStreaming, gtBackupSFTPPort=gtBackupSFTPPort, gtSFPLink=gtSFPLink, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceState=gtInterfaceState, gtPortsLinkup=gtPortsLinkup, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSWOptionsEntry=gtSWOptionsEntry, gtUserIdx=gtUserIdx, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtUserTable=gtUserTable, gtSFPEntry=gtSFPEntry, gtSFPTable=gtSFPTable, gtNetworkPortVLAN=gtNetworkPortVLAN, gtGroupTable=gtGroupTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSwitch=gtSwitch, gtTrapDestEntry=gtTrapDestEntry, gtGroupIdx=gtGroupIdx, gtUpdateStatus=gtUpdateStatus, gtHMSEntry=gtHMSEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtInterfaceCLI=gtInterfaceCLI, gtTrapDestTable=gtTrapDestTable, gtSFTPPort=gtSFTPPort, gtSettingsConformance=gtSettingsConformance, gtSFTPServer=gtSFTPServer, gtSNMP=gtSNMP, gtSettingsGroups=gtSettingsGroups, gtHMSComMethod=gtHMSComMethod, gtAgentSecurityLevel=gtAgentSecurityLevel, gtAccesslistParamIdx=gtAccesslistParamIdx, gtNetworkName=gtNetworkName, gtTrapDestNumber=gtTrapDestNumber, gtWebEnable=gtWebEnable, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceSNMP=gtInterfaceSNMP, gtAccesslistEntry=gtAccesslistEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserRowStatus=gtUserRowStatus, gtWebProtocol=gtWebProtocol, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtBackupSFTPFilename=gtBackupSFTPFilename, gtNTPServerTable=gtNTPServerTable, gtPortsNumber=gtPortsNumber, gtNetworkTable=gtNetworkTable, gtDNSNumber=gtDNSNumber, gtServices=gtServices, gtSFTPPassword=gtSFTPPassword, gtSettingsObjects=gtSettingsObjects, gtModuleUpdate=gtModuleUpdate, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtCurrentTimeSource=gtCurrentTimeSource, gtNetworkVLAN=gtNetworkVLAN, gtGroupEntry=gtGroupEntry, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSFPNumber=gtSFPNumber, gtInterfaceNumber=gtInterfaceNumber, gtUserPassword=gtUserPassword, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSLAExpires=gtSLAExpires, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkPortState=gtNetworkPortState)
