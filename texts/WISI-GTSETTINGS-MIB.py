...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Counter32, Gauge32, NotificationType, Unsigned32, iso, ObjectIdentity, TimeTicks, MibIdentifier, ModuleIdentity, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Counter32", "Gauge32", "NotificationType", "Unsigned32", "iso", "ObjectIdentity", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtHMSNumAvailModules=gtHMSNumAvailModules, gtSettingsMIB=gtSettingsMIB, gtAccesslistEntry=gtAccesslistEntry, gtSNMPEntry=gtSNMPEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtServicesTable=gtServicesTable, gtHMSComMethod=gtHMSComMethod, gtGroupTable=gtGroupTable, gtUpdateFile=gtUpdateFile, gtUserEntry=gtUserEntry, gtHMSGroupName=gtHMSGroupName, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTrapDestPort=gtTrapDestPort, gtModuleBackupTable=gtModuleBackupTable, gtAgentComReadString=gtAgentComReadString, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSyslogEntry=gtSyslogEntry, gtWebEnable=gtWebEnable, gtInterfaceIGMP=gtInterfaceIGMP, gtUserAuthEntry=gtUserAuthEntry, gtTrapUser=gtTrapUser, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceNumber=gtInterfaceNumber, gtSNMP=gtSNMP, gtChassisRedundancy=gtChassisRedundancy, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceWebMgt=gtInterfaceWebMgt, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSyslogState=gtSyslogState, gtInterfaceVLAN=gtInterfaceVLAN, gtDateAndTimeTable=gtDateAndTimeTable, gtModuleBackupDate=gtModuleBackupDate, gtHMSNumMembers=gtHMSNumMembers, gtGroupEntry=gtGroupEntry, gtWebProtocol=gtWebProtocol, gtInterfaceTable=gtInterfaceTable, gtNTPServerEntry=gtNTPServerEntry, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtModuleRedundancyMode=gtModuleRedundancyMode, gtAccesslistName=gtAccesslistName, gtSettingsNotifications=gtSettingsNotifications, gtUser=gtUser, gtTimeLocal=gtTimeLocal, gtNetworkVLAN=gtNetworkVLAN, gtGroupName=gtGroupName, gtSFPType=gtSFPType, gtServices=gtServices, gtSLAExpires=gtSLAExpires, gtNetworkPortsEntry=gtNetworkPortsEntry, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSFTPPassword=gtSFTPPassword, gtTimeUTC=gtTimeUTC, gtDNSEntry=gtDNSEntry, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtPortsEntry=gtPortsEntry, gtSettingsGroups=gtSettingsGroups, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNTPServerTable=gtNTPServerTable, gtNetworkPortState=gtNetworkPortState, gtAccesslistTable=gtAccesslistTable, gtTrapDestNumber=gtTrapDestNumber, gtModuleBackupStatus=gtModuleBackupStatus, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtFilename=gtFilename, gtSFPTable=gtSFPTable, gtSFPNumber=gtSFPNumber, gtHMSEntry=gtHMSEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNTPServerNumber=gtNTPServerNumber, gtModuleBackupControl=gtModuleBackupControl, gtSNMPTable=gtSNMPTable, gtInterfaceMAC=gtInterfaceMAC, gtDNSNumber=gtDNSNumber, gtNumSFP=gtNumSFP, gtAgentState=gtAgentState, gtSWOptionsEntry=gtSWOptionsEntry, gtTrapDestTable=gtTrapDestTable, gtInterfaceSNMP=gtInterfaceSNMP, gtNetworkTable=gtNetworkTable, gtInterfaceEntry=gtInterfaceEntry, gtSFPEntry=gtSFPEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtPortsNumber=gtPortsNumber, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTrapComString=gtTrapComString, gtSWOption=gtSWOption, gtUserIdx=gtUserIdx, gtSyslogTable=gtSyslogTable, gtUserAuthTable=gtUserAuthTable, gtSFTPServer=gtSFTPServer, gtUpdateStatus=gtUpdateStatus, gtSFPLink=gtSFPLink, gtSLATable=gtSLATable, gtSyslogIP=gtSyslogIP, gtSLARegistered=gtSLARegistered, gtAccesslistIPRange=gtAccesslistIPRange, gtInterfaceState=gtInterfaceState, gtPortsTable=gtPortsTable, gtSettingsObjects=gtSettingsObjects, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtModuleBackupEntry=gtModuleBackupEntry, gtTrapPDU=gtTrapPDU, gtSettingsConformance=gtSettingsConformance, gtGroupAccesslist=gtGroupAccesslist, gtInterfaceIfIndex=gtInterfaceIfIndex, gtBackupStatus=gtBackupStatus, gtNetworkPortVLAN=gtNetworkPortVLAN, gtWebAuth=gtWebAuth, gtInterfaceStreaming=gtInterfaceStreaming, gtNetworkPortsTable=gtNetworkPortsTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSFPPlugged=gtSFPPlugged, gtNetworking=gtNetworking, gtUserPassword=gtUserPassword, gtBackupSFTPPort=gtBackupSFTPPort, gtInterfaceCLI=gtInterfaceCLI, gtNTPServerAddress=gtNTPServerAddress, gtUserName=gtUserName, gtNetworkPortNumber=gtNetworkPortNumber, gtSFPSpeed=gtSFPSpeed, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAgentComWriteString=gtAgentComWriteString, gtUserAccesslist=gtUserAccesslist, gtHMSTable=gtHMSTable, gtGroupParamIdx=gtGroupParamIdx, gtCurrentTimeSource=gtCurrentTimeSource, gtNTPServerRowStatus=gtNTPServerRowStatus, gtBackupSFTPPassword=gtBackupSFTPPassword, gtTrapState=gtTrapState, gtUserParamIdx=gtUserParamIdx, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtDateAndTime=gtDateAndTime, gtModuleBackup=gtModuleBackup, gtBackupSFTPServer=gtBackupSFTPServer, gtUpdateControl=gtUpdateControl, gtDateAndTimeEntry=gtDateAndTimeEntry, gtModuleUpdate=gtModuleUpdate, gtInterfaceDHCPState=gtInterfaceDHCPState, gtServicesEntry=gtServicesEntry, gtNetworkName=gtNetworkName, gtCurrentUserName=gtCurrentUserName, gtUserGroup=gtUserGroup, gtUserAuthEnabled=gtUserAuthEnabled, gtGeneral=gtGeneral, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFTPPort=gtSFTPPort, gtGroupRights=gtGroupRights, gtUserRowStatus=gtUserRowStatus, gtAgentPort=gtAgentPort, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsLinkup=gtPortsLinkup, gtNetworkEntry=gtNetworkEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtDNSTable=gtDNSTable, gtGroupIdx=gtGroupIdx, gtSWOptionsTable=gtSWOptionsTable, gtDNSServerIP=gtDNSServerIP, gtTimeZone=gtTimeZone, gtPortsName=gtPortsName, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtAccesslistIdx=gtAccesslistIdx, gtSettingsCompliances=gtSettingsCompliances, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSLAEntry=gtSLAEntry, gtNetworkPortName=gtNetworkPortName, gtSFTPUsername=gtSFTPUsername, gtUserTable=gtUserTable, gtSWOptionsIdx=gtSWOptionsIdx, gtSwitch=gtSwitch, gtTrapDestIP=gtTrapDestIP, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceIPv4=gtInterfaceIPv4, gtDaylightAdjustment=gtDaylightAdjustment, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceName=gtInterfaceName, gtBackupControl=gtBackupControl, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtAccesslistParamIdx=gtAccesslistParamIdx, gtTrapDestEntry=gtTrapDestEntry)
