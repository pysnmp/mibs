...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, Bits, Counter32, Counter64, iso, IpAddress, ModuleIdentity, Integer32, Gauge32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "Bits", "Counter32", "Counter64", "iso", "IpAddress", "ModuleIdentity", "Integer32", "Gauge32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtNetworkPortsEntry=gtNetworkPortsEntry, gtSyslogTable=gtSyslogTable, gtAccesslistEntry=gtAccesslistEntry, gtDNSEntry=gtDNSEntry, gtGroupAccesslist=gtGroupAccesslist, gtUpdateFilesTable=gtUpdateFilesTable, gtSFPSpeed=gtSFPSpeed, gtServices=gtServices, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSLAEntry=gtSLAEntry, gtAgentState=gtAgentState, gtTrapDestNumber=gtTrapDestNumber, gtAccesslistIdx=gtAccesslistIdx, gtTrapDestTable=gtTrapDestTable, gtUserTable=gtUserTable, gtModuleBackup=gtModuleBackup, gtSFPTable=gtSFPTable, gtInterfaceVLAN=gtInterfaceVLAN, PYSNMP_MODULE_ID=gtSettingsMIB, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceCLI=gtInterfaceCLI, gtSettingsNotifications=gtSettingsNotifications, gtGroupName=gtGroupName, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSyslogEntry=gtSyslogEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtTrapDestIP=gtTrapDestIP, gtAccesslistName=gtAccesslistName, gtSFTPPort=gtSFTPPort, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSettingsGroups=gtSettingsGroups, gtTrapUser=gtTrapUser, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNetworkPortNumber=gtNetworkPortNumber, gtSFPNumber=gtSFPNumber, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSLARegistered=gtSLARegistered, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUpdateFile=gtUpdateFile, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSNMPEntry=gtSNMPEntry, gtTrapComString=gtTrapComString, gtDNSServerIP=gtDNSServerIP, gtTrapDestRowStatus=gtTrapDestRowStatus, gtGroupParamIdx=gtGroupParamIdx, gtSFTPServer=gtSFTPServer, gtSWOptionsTable=gtSWOptionsTable, gtAgentSecurityLevel=gtAgentSecurityLevel, gtUserEntry=gtUserEntry, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNetworkPortName=gtNetworkPortName, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceSNMP=gtInterfaceSNMP, gtInterfaceRowStatus=gtInterfaceRowStatus, gtTrapDestEntry=gtTrapDestEntry, gtSettingsCompliances=gtSettingsCompliances, gtModuleBackupEntry=gtModuleBackupEntry, gtServicesTable=gtServicesTable, gtNumSFP=gtNumSFP, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSettingsMIB=gtSettingsMIB, gtPortsBitrateReceive=gtPortsBitrateReceive, gtFilename=gtFilename, gtSWOption=gtSWOption, gtUser=gtUser, gtUserAuthTable=gtUserAuthTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSettingsObjects=gtSettingsObjects, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtGeneral=gtGeneral, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceWebMgt=gtInterfaceWebMgt, gtAccesslistTable=gtAccesslistTable, gtNetworking=gtNetworking, gtNetworkPortState=gtNetworkPortState, gtTrapState=gtTrapState, gtDaylightAdjustment=gtDaylightAdjustment, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserRowStatus=gtUserRowStatus, gtWebEnable=gtWebEnable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtPortsName=gtPortsName, gtBackupSFTPFilename=gtBackupSFTPFilename, gtUserAuthEntry=gtUserAuthEntry, gtSNMPTable=gtSNMPTable, gtInterfaceNumber=gtInterfaceNumber, gtNetworkEntry=gtNetworkEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNTPServerNumber=gtNTPServerNumber, gtUserAccesslist=gtUserAccesslist, gtTrapPDU=gtTrapPDU, gtPortsNumber=gtPortsNumber, gtDateAndTimeEntry=gtDateAndTimeEntry, gtAgentPort=gtAgentPort, gtGroupRights=gtGroupRights, gtSyslogIP=gtSyslogIP, gtChassisRedundancy=gtChassisRedundancy, gtInterfaceState=gtInterfaceState, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceEntry=gtInterfaceEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtTrapDestPort=gtTrapDestPort, gtPortsTable=gtPortsTable, gtUserName=gtUserName, gtGroupIdx=gtGroupIdx, gtPortsLinkup=gtPortsLinkup, gtModuleBackupStatus=gtModuleBackupStatus, gtWebProtocol=gtWebProtocol, gtSFPLink=gtSFPLink, gtUserPassword=gtUserPassword, gtGroupTable=gtGroupTable, gtNTPServerEntry=gtNTPServerEntry, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtInterfaceIGMP=gtInterfaceIGMP, gtSwitch=gtSwitch, gtServicesEntry=gtServicesEntry, gtSLAExpires=gtSLAExpires, gtNetworkTable=gtNetworkTable, gtInterfaceTable=gtInterfaceTable, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceDHCPState=gtInterfaceDHCPState, gtModuleBackupTable=gtModuleBackupTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSFPType=gtSFPType, gtCurrentTimeSource=gtCurrentTimeSource, gtSFPEntry=gtSFPEntry, gtHMSTable=gtHMSTable, gtBackupSFTPPort=gtBackupSFTPPort, gtUpdateControl=gtUpdateControl, gtDateAndTime=gtDateAndTime, gtBackupSFTPServer=gtBackupSFTPServer, gtSFTPUsername=gtSFTPUsername, gtModuleUpdate=gtModuleUpdate, gtHMSNumMembers=gtHMSNumMembers, gtDNSTable=gtDNSTable, gtNetworkVLAN=gtNetworkVLAN, gtTimeUTC=gtTimeUTC, gtTimeZone=gtTimeZone, gtAgentComReadString=gtAgentComReadString, gtSyslogState=gtSyslogState, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceStreaming=gtInterfaceStreaming, gtSFPPlugged=gtSFPPlugged, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtModuleBackupControl=gtModuleBackupControl, gtUserGroup=gtUserGroup, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtPortsEntry=gtPortsEntry, gtUpdateStatus=gtUpdateStatus, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtWebAuth=gtWebAuth, gtSettingsConformance=gtSettingsConformance, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceMAC=gtInterfaceMAC, gtDateAndTimeTable=gtDateAndTimeTable, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtTimeLocal=gtTimeLocal, gtCurrentUserName=gtCurrentUserName, gtUpdateFilesEntry=gtUpdateFilesEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtSNMP=gtSNMP, gtUserParamIdx=gtUserParamIdx, gtUserAuthEnabled=gtUserAuthEnabled, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtBackupControl=gtBackupControl, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSFTPPassword=gtSFTPPassword, gtHMSEntry=gtHMSEntry, gtNTPServerTable=gtNTPServerTable, gtBackupStatus=gtBackupStatus, gtPortsFloodMulticast=gtPortsFloodMulticast, gtNetworkName=gtNetworkName, gtSLATable=gtSLATable, gtDNSNumber=gtDNSNumber, gtInterfaceName=gtInterfaceName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtAccesslistParamIdx=gtAccesslistParamIdx, gtHMSGroupName=gtHMSGroupName, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtHMSComMethod=gtHMSComMethod, gtHeadendSystemManagement=gtHeadendSystemManagement, gtUserIdx=gtUserIdx, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtGroupEntry=gtGroupEntry)
