...
Counter32, MibIdentifier, IpAddress, Gauge32, Counter64, Unsigned32, Integer32, ModuleIdentity, NotificationType, iso, Bits, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "IpAddress", "Gauge32", "Counter64", "Unsigned32", "Integer32", "ModuleIdentity", "NotificationType", "iso", "Bits", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtTrapUser=gtTrapUser, gtInterfaceVLAN=gtInterfaceVLAN, gtGroupEntry=gtGroupEntry, gtSFPType=gtSFPType, gtServices=gtServices, gtNetworkTable=gtNetworkTable, gtHMSNumMembers=gtHMSNumMembers, gtSyslogIP=gtSyslogIP, gtInterfaceStreaming=gtInterfaceStreaming, gtModuleBackupStatus=gtModuleBackupStatus, gtSNMPTable=gtSNMPTable, gtUserAuthTable=gtUserAuthTable, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtModuleBackupTable=gtModuleBackupTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtPortsEntry=gtPortsEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtSWOptionsEntry=gtSWOptionsEntry, gtSFPSpeed=gtSFPSpeed, gtBackupControl=gtBackupControl, gtPortsLinkup=gtPortsLinkup, gtDNSNumber=gtDNSNumber, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkPortState=gtNetworkPortState, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceCLI=gtInterfaceCLI, gtSLAExpires=gtSLAExpires, gtInterfaceMAC=gtInterfaceMAC, gtUpdateStatus=gtUpdateStatus, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtUserRowStatus=gtUserRowStatus, gtAgentPort=gtAgentPort, gtAccesslistParamIdx=gtAccesslistParamIdx, gtCurrentTimeSource=gtCurrentTimeSource, gtSLARegistered=gtSLARegistered, gtInterfaceState=gtInterfaceState, gtInterfaceIGMP=gtInterfaceIGMP, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtAccesslistName=gtAccesslistName, gtTrapDestNumber=gtTrapDestNumber, gtNTPServerNumber=gtNTPServerNumber, gtAccesslistTable=gtAccesslistTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtUserName=gtUserName, gtDateAndTime=gtDateAndTime, gtUserAuthEntry=gtUserAuthEntry, gtTrapState=gtTrapState, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSWOption=gtSWOption, gtSwitch=gtSwitch, gtTrapComString=gtTrapComString, gtSettingsConformance=gtSettingsConformance, gtUser=gtUser, gtNTPServerEntry=gtNTPServerEntry, gtNetworking=gtNetworking, gtFilename=gtFilename, gtPortsName=gtPortsName, gtSettingsObjects=gtSettingsObjects, gtHMSTable=gtHMSTable, gtSettingsNotifications=gtSettingsNotifications, gtUpdateFilesTable=gtUpdateFilesTable, gtGroupAccesslist=gtGroupAccesslist, gtAccesslistIdx=gtAccesslistIdx, gtInterfaceTable=gtInterfaceTable, gtWebAuth=gtWebAuth, gtServicesTable=gtServicesTable, gtAgentComReadString=gtAgentComReadString, gtSWOptionsIdx=gtSWOptionsIdx, gtAgentState=gtAgentState, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtNetworkPortsTable=gtNetworkPortsTable, gtDNSEntry=gtDNSEntry, gtTrapDestPort=gtTrapDestPort, gtHeadendSystemManagement=gtHeadendSystemManagement, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtModuleBackupControl=gtModuleBackupControl, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceIPv4=gtInterfaceIPv4, gtSNMPEntry=gtSNMPEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtAccesslistEntry=gtAccesslistEntry, gtAgentComWriteString=gtAgentComWriteString, gtTrapPDU=gtTrapPDU, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSettingsGroups=gtSettingsGroups, gtPortsTable=gtPortsTable, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSFPNumber=gtSFPNumber, gtModuleBackupEntry=gtModuleBackupEntry, gtModuleBackupDate=gtModuleBackupDate, gtSyslogTable=gtSyslogTable, gtCurrentUserPassword=gtCurrentUserPassword, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapDestTable=gtTrapDestTable, gtUserIdx=gtUserIdx, gtSettingsMIB=gtSettingsMIB, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUserAccesslist=gtUserAccesslist, gtSFPEntry=gtSFPEntry, gtSLATable=gtSLATable, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtPortsBitrateReceive=gtPortsBitrateReceive, gtCurrentUserName=gtCurrentUserName, gtBackupSFTPServer=gtBackupSFTPServer, gtSFTPPassword=gtSFTPPassword, gtModuleBackup=gtModuleBackup, gtInterfaceSNMP=gtInterfaceSNMP, gtBackupSFTPPort=gtBackupSFTPPort, gtNTPServerTable=gtNTPServerTable, gtNetworkPortName=gtNetworkPortName, gtGroupRights=gtGroupRights, gtSFPPlugged=gtSFPPlugged, PYSNMP_MODULE_ID=gtSettingsMIB, gtWebEnable=gtWebEnable, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSFTPPort=gtSFTPPort, gtNumSFP=gtNumSFP, gtNetworkName=gtNetworkName, gtDNSServerIP=gtDNSServerIP, gtTrapSecurityLevel=gtTrapSecurityLevel, gtBackupSFTPFilename=gtBackupSFTPFilename, gtGroupParamIdx=gtGroupParamIdx, gtSLAEntry=gtSLAEntry, gtGroupName=gtGroupName, gtWebProtocol=gtWebProtocol, gtBackupStatus=gtBackupStatus, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtUpdateControl=gtUpdateControl, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkPortVLAN=gtNetworkPortVLAN, gtGeneral=gtGeneral, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtDateAndTimeEntry=gtDateAndTimeEntry, gtNTPServerAddress=gtNTPServerAddress, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtNetworkPortsEntry=gtNetworkPortsEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSFPLink=gtSFPLink, gtChassisRedundancy=gtChassisRedundancy, gtUpdateFile=gtUpdateFile, gtIGMPQueryInterval=gtIGMPQueryInterval, gtHMSGroupName=gtHMSGroupName, gtNTPServerRowStatus=gtNTPServerRowStatus, gtGroupTable=gtGroupTable, gtHMSEntry=gtHMSEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtServicesEntry=gtServicesEntry, gtDNSTable=gtDNSTable, gtTimeLocal=gtTimeLocal, gtTrapDestEntry=gtTrapDestEntry, gtInterfaceName=gtInterfaceName, gtTrapDestRowStatus=gtTrapDestRowStatus, gtNetworkEntry=gtNetworkEntry, gtTimeUTC=gtTimeUTC, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceEntry=gtInterfaceEntry, gtTimeZone=gtTimeZone, gtSWOptionsTable=gtSWOptionsTable, gtUserAuthEnabled=gtUserAuthEnabled, gtSFTPUsername=gtSFTPUsername, gtSFPTable=gtSFPTable, gtGroupIdx=gtGroupIdx, gtTrapDestIP=gtTrapDestIP, gtSyslogEntry=gtSyslogEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtInterfaceNumber=gtInterfaceNumber, gtAgentSecurityLevel=gtAgentSecurityLevel, gtBackupSFTPPassword=gtBackupSFTPPassword, gtUserPassword=gtUserPassword, gtUserParamIdx=gtUserParamIdx, gtUserTable=gtUserTable, gtUserEntry=gtUserEntry, gtSFTPServer=gtSFTPServer, gtNetworkPortNumber=gtNetworkPortNumber, gtUserGroup=gtUserGroup, gtSyslogState=gtSyslogState, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSNMP=gtSNMP, gtHMSComMethod=gtHMSComMethod, gtPortsNumber=gtPortsNumber, gtNetworkVLAN=gtNetworkVLAN, gtModuleUpdate=gtModuleUpdate)
