...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Integer32, ModuleIdentity, TimeTicks, Bits, Counter64, Gauge32, ObjectIdentity, IpAddress, NotificationType, Counter32, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Integer32", "ModuleIdentity", "TimeTicks", "Bits", "Counter64", "Gauge32", "ObjectIdentity", "IpAddress", "NotificationType", "Counter32", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtAgentPort=gtAgentPort, PYSNMP_MODULE_ID=gtSettingsMIB, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNetworkName=gtNetworkName, gtModuleBackupEntry=gtModuleBackupEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtCurrentTimeSource=gtCurrentTimeSource, gtUserRowStatus=gtUserRowStatus, gtGroupAccesslist=gtGroupAccesslist, gtSettingsNotifications=gtSettingsNotifications, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceEntry=gtInterfaceEntry, gtNetworking=gtNetworking, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSettingsConformance=gtSettingsConformance, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtInterfaceIPv4=gtInterfaceIPv4, gtUserAuthEnabled=gtUserAuthEnabled, gtAgentState=gtAgentState, gtBackupSFTPServer=gtBackupSFTPServer, gtAgentComReadString=gtAgentComReadString, gtUserAccesslist=gtUserAccesslist, gtTrapPDU=gtTrapPDU, gtUserAuthEntry=gtUserAuthEntry, gtChassisRedundancy=gtChassisRedundancy, gtNetworkTable=gtNetworkTable, gtPortsLinkup=gtPortsLinkup, gtGroupIdx=gtGroupIdx, gtBackupControl=gtBackupControl, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSLAEntry=gtSLAEntry, gtSyslogState=gtSyslogState, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtHeadendSystemManagement=gtHeadendSystemManagement, gtInterfaceSNMP=gtInterfaceSNMP, gtNTPServerTable=gtNTPServerTable, gtInterfaceStreaming=gtInterfaceStreaming, gtTrapDestNumber=gtTrapDestNumber, gtModuleUpdate=gtModuleUpdate, gtSettingsMIB=gtSettingsMIB, gtGroupRights=gtGroupRights, gtNetworkPortsTable=gtNetworkPortsTable, gtSLAExpires=gtSLAExpires, gtTrapComString=gtTrapComString, gtTrapDestTable=gtTrapDestTable, gtSWOptionsIdx=gtSWOptionsIdx, gtNetworkPortsEntry=gtNetworkPortsEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtSNMPEntry=gtSNMPEntry, gtUserPassword=gtUserPassword, gtUserName=gtUserName, gtGeneral=gtGeneral, gtHMSTable=gtHMSTable, gtServicesTable=gtServicesTable, gtTrapDestIP=gtTrapDestIP, gtServicesEntry=gtServicesEntry, gtInterfaceDHCPState=gtInterfaceDHCPState, gtNetworkPortName=gtNetworkPortName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceNumber=gtInterfaceNumber, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSNMPTable=gtSNMPTable, gtUserIdx=gtUserIdx, gtTimeLocal=gtTimeLocal, gtPortsName=gtPortsName, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSFPLink=gtSFPLink, gtTrapState=gtTrapState, gtAccesslistName=gtAccesslistName, gtBackupStatus=gtBackupStatus, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtGroupEntry=gtGroupEntry, gtSettingsCompliances=gtSettingsCompliances, gtUser=gtUser, gtNTPServerEntry=gtNTPServerEntry, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtAccesslistEntry=gtAccesslistEntry, gtDNSNumber=gtDNSNumber, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSLARegistered=gtSLARegistered, gtAccesslistIdx=gtAccesslistIdx, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtCurrentUserPassword=gtCurrentUserPassword, gtUserEntry=gtUserEntry, gtSFPEntry=gtSFPEntry, gtTimeZone=gtTimeZone, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSWOption=gtSWOption, gtInterfaceName=gtInterfaceName, gtSettingsGroups=gtSettingsGroups, gtSFTPPassword=gtSFTPPassword, gtNetworkVLAN=gtNetworkVLAN, gtDNSServerIP=gtDNSServerIP, gtPortsNumber=gtPortsNumber, gtNetworkEntry=gtNetworkEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSWOptionsEntry=gtSWOptionsEntry, gtSettingsObjects=gtSettingsObjects, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTrapSNMPVersion=gtTrapSNMPVersion, gtTrapDestRowStatus=gtTrapDestRowStatus, gtSFTPServer=gtSFTPServer, gtUserParamIdx=gtUserParamIdx, gtHMSComMethod=gtHMSComMethod, gtUserGroup=gtUserGroup, gtTrapDestPort=gtTrapDestPort, gtSLATable=gtSLATable, gtInterfaceIGMP=gtInterfaceIGMP, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtInterfaceState=gtInterfaceState, gtHMSEntry=gtHMSEntry, gtTimeUTC=gtTimeUTC, gtModuleBackupTable=gtModuleBackupTable, gtDaylightAdjustment=gtDaylightAdjustment, gtInterfaceRowStatus=gtInterfaceRowStatus, gtGroupTable=gtGroupTable, gtSyslogIP=gtSyslogIP, gtAccesslistIPRange=gtAccesslistIPRange, gtSwitch=gtSwitch, gtTrapUser=gtTrapUser, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtServices=gtServices, gtHMSGroupName=gtHMSGroupName, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtWebProtocol=gtWebProtocol, gtSFPType=gtSFPType, gtPortsEntry=gtPortsEntry, gtInterfaceMAC=gtInterfaceMAC, gtDateAndTimeTable=gtDateAndTimeTable, gtUpdateFile=gtUpdateFile, gtSFTPPort=gtSFTPPort, gtInterfaceVLAN=gtInterfaceVLAN, gtPortsTable=gtPortsTable, gtSFPTable=gtSFPTable, gtUpdateStatus=gtUpdateStatus, gtAccesslistTable=gtAccesslistTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtUpdateFilesEntry=gtUpdateFilesEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtUpdateControl=gtUpdateControl, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtNetworkPortNumber=gtNetworkPortNumber, gtDNSEntry=gtDNSEntry, gtAgentComWriteString=gtAgentComWriteString, gtGroupParamIdx=gtGroupParamIdx, gtHMSNumMembers=gtHMSNumMembers, gtDNSTable=gtDNSTable, gtWebEnable=gtWebEnable, gtWebAuth=gtWebAuth, gtSFPNumber=gtSFPNumber, gtInterfaceTable=gtInterfaceTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSFTPUsername=gtSFTPUsername, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSyslogTable=gtSyslogTable, gtSyslogEntry=gtSyslogEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceCLI=gtInterfaceCLI, gtSWOptionsTable=gtSWOptionsTable, gtNTPServerAddress=gtNTPServerAddress, gtModuleBackupControl=gtModuleBackupControl, gtSNMP=gtSNMP, gtBackupSFTPPort=gtBackupSFTPPort, gtFilename=gtFilename, gtCurrentUserName=gtCurrentUserName, gtSFPPlugged=gtSFPPlugged, gtNetworkPortState=gtNetworkPortState, gtTrapDestEntry=gtTrapDestEntry, gtModuleBackup=gtModuleBackup, gtSFPSpeed=gtSFPSpeed, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUserTable=gtUserTable, gtGroupName=gtGroupName, gtNumSFP=gtNumSFP, gtUserAuthTable=gtUserAuthTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceWebMgt=gtInterfaceWebMgt, gtAccesslistParamIdx=gtAccesslistParamIdx, gtDateAndTime=gtDateAndTime, gtAgentSecurityLevel=gtAgentSecurityLevel)
