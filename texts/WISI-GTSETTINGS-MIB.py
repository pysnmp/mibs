...
TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, ObjectIdentity, Integer32, Counter64, Bits, MibIdentifier, Gauge32, NotificationType, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Integer32", "Counter64", "Bits", "MibIdentifier", "Gauge32", "NotificationType", "iso", "Counter32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSWOption=gtSWOption, gtNetworkName=gtNetworkName, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapUser=gtTrapUser, gtNTPServerTable=gtNTPServerTable, gtSettingsGroups=gtSettingsGroups, gtUserParamIdx=gtUserParamIdx, gtServicesTable=gtServicesTable, gtModuleBackupTable=gtModuleBackupTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSNMP=gtSNMP, gtSNMPEntry=gtSNMPEntry, gtSettingsConformance=gtSettingsConformance, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceIPv4=gtInterfaceIPv4, gtTrapDestTable=gtTrapDestTable, gtUserAuthEnabled=gtUserAuthEnabled, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceState=gtInterfaceState, gtBackupControl=gtBackupControl, gtModuleBackupDate=gtModuleBackupDate, gtPortsEntry=gtPortsEntry, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSettingsObjects=gtSettingsObjects, gtUserRowStatus=gtUserRowStatus, gtAccesslistParamIdx=gtAccesslistParamIdx, gtBackupSFTPPassword=gtBackupSFTPPassword, gtServicesEntry=gtServicesEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtNetworkTable=gtNetworkTable, gtNetworkVLAN=gtNetworkVLAN, gtNTPServerEntry=gtNTPServerEntry, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSFPTable=gtSFPTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtServices=gtServices, gtNetworkPortState=gtNetworkPortState, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceStreaming=gtInterfaceStreaming, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceName=gtInterfaceName, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, PYSNMP_MODULE_ID=gtSettingsMIB, gtUserAuthEntry=gtUserAuthEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtModuleBackupEntry=gtModuleBackupEntry, gtHMSTable=gtHMSTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtTrapDestIP=gtTrapDestIP, gtGroupRights=gtGroupRights, gtGroupName=gtGroupName, gtAccesslistIdx=gtAccesslistIdx, gtCurrentUserName=gtCurrentUserName, gtNetworkEntry=gtNetworkEntry, gtInterfaceTable=gtInterfaceTable, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtPortsLinkup=gtPortsLinkup, gtSyslogTable=gtSyslogTable, gtSLAExpires=gtSLAExpires, gtSWOptionsIdx=gtSWOptionsIdx, gtInterfaceIGMP=gtInterfaceIGMP, gtBackupSFTPPort=gtBackupSFTPPort, gtSFPLink=gtSFPLink, gtBackupStatus=gtBackupStatus, gtSettingsMIB=gtSettingsMIB, gtUserTable=gtUserTable, gtAgentComReadString=gtAgentComReadString, gtGroupIdx=gtGroupIdx, gtTrapDestPort=gtTrapDestPort, gtCurrentUserPassword=gtCurrentUserPassword, gtNumSFP=gtNumSFP, gtHMSNumMembers=gtHMSNumMembers, gtSLARegistered=gtSLARegistered, gtInterfaceSNMP=gtInterfaceSNMP, gtSettingsNotifications=gtSettingsNotifications, gtAgentState=gtAgentState, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtUserPassword=gtUserPassword, gtNTPServerAddress=gtNTPServerAddress, gtTrapState=gtTrapState, gtAgentPort=gtAgentPort, gtSFPType=gtSFPType, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUpdateControl=gtUpdateControl, gtSFTPServer=gtSFTPServer, gtHMSComMethod=gtHMSComMethod, gtNetworkPortName=gtNetworkPortName, gtSLATable=gtSLATable, gtSNMPTable=gtSNMPTable, gtUserAuthTable=gtUserAuthTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtHMSNumAvailModules=gtHMSNumAvailModules, gtHMSEntry=gtHMSEntry, gtTrapSecurityLevel=gtTrapSecurityLevel, gtInterfaceNumber=gtInterfaceNumber, gtBackupSFTPServer=gtBackupSFTPServer, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFTPPort=gtSFTPPort, gtNTPServerNumber=gtNTPServerNumber, gtGroupAccesslist=gtGroupAccesslist, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtChassisRedundancy=gtChassisRedundancy, gtPortsName=gtPortsName, gtDateAndTimeTable=gtDateAndTimeTable, gtSFPPlugged=gtSFPPlugged, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtAccesslistTable=gtAccesslistTable, gtUpdateStatus=gtUpdateStatus, gtDateAndTime=gtDateAndTime, gtFilename=gtFilename, gtInterfaceMAC=gtInterfaceMAC, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNTPServerRowStatus=gtNTPServerRowStatus, gtAgentComWriteString=gtAgentComWriteString, gtGroupEntry=gtGroupEntry, gtInterfaceVLAN=gtInterfaceVLAN, gtAccesslistName=gtAccesslistName, gtSWOptionsTable=gtSWOptionsTable, gtSwitch=gtSwitch, gtUserAccesslist=gtUserAccesslist, gtAccesslistEntry=gtAccesslistEntry, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSFTPPassword=gtSFTPPassword, gtTrapComString=gtTrapComString, gtSFPNumber=gtSFPNumber, gtGeneral=gtGeneral, gtUserIdx=gtUserIdx, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUserEntry=gtUserEntry, gtNetworking=gtNetworking, gtDNSTable=gtDNSTable, gtNetworkPortsTable=gtNetworkPortsTable, gtUser=gtUser, gtBackupSFTPUsername=gtBackupSFTPUsername, gtModuleBackupControl=gtModuleBackupControl, gtPortsFloodMulticast=gtPortsFloodMulticast, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtModuleBackup=gtModuleBackup, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAccesslistIPRange=gtAccesslistIPRange, gtDNSServerIP=gtDNSServerIP, gtUserName=gtUserName, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUpdateFile=gtUpdateFile, gtTrapDestNumber=gtTrapDestNumber, gtSyslogState=gtSyslogState, gtSFTPUsername=gtSFTPUsername, gtDNSEntry=gtDNSEntry, gtInterfaceCLI=gtInterfaceCLI, gtSyslogIP=gtSyslogIP, gtWebEnable=gtWebEnable, gtInterfaceEntry=gtInterfaceEntry, gtTimeZone=gtTimeZone, gtTrapDestEntry=gtTrapDestEntry, gtIGMPQueryInterval=gtIGMPQueryInterval, gtTimeLocal=gtTimeLocal, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtDaylightAdjustment=gtDaylightAdjustment, gtWebAuth=gtWebAuth, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFPSpeed=gtSFPSpeed, gtDNSNumber=gtDNSNumber, gtWebProtocol=gtWebProtocol, gtSLAEntry=gtSLAEntry, gtUserGroup=gtUserGroup, gtModuleBackupStatus=gtModuleBackupStatus, gtPortsNumber=gtPortsNumber, gtDateAndTimeEntry=gtDateAndTimeEntry, gtGroupParamIdx=gtGroupParamIdx, gtCurrentTimeSource=gtCurrentTimeSource, gtSFPEntry=gtSFPEntry, gtTimeUTC=gtTimeUTC, gtHMSGroupName=gtHMSGroupName, gtTrapDestRowStatus=gtTrapDestRowStatus, gtGroupTable=gtGroupTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNetworkPortNumber=gtNetworkPortNumber, gtPortsTable=gtPortsTable, gtInterfaceDHCPState=gtInterfaceDHCPState, gtModuleUpdate=gtModuleUpdate, gtSyslogEntry=gtSyslogEntry, gtTrapPDU=gtTrapPDU)
