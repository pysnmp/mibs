...
NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Bits, Unsigned32, Counter64, Gauge32, IpAddress, iso, ObjectIdentity, ModuleIdentity, TimeTicks, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Bits", "Unsigned32", "Counter64", "Gauge32", "IpAddress", "iso", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "MibIdentifier")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtInterfaceCLI=gtInterfaceCLI, gtAgentState=gtAgentState, gtNTPServerAddress=gtNTPServerAddress, gtSettingsCompliances=gtSettingsCompliances, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtSFPTable=gtSFPTable, gtNetworkName=gtNetworkName, gtInterfaceIfIndex=gtInterfaceIfIndex, gtFilename=gtFilename, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSNMPEntry=gtSNMPEntry, gtUpdateStatus=gtUpdateStatus, gtHMSGroupName=gtHMSGroupName, gtUpdateFile=gtUpdateFile, gtPortsLinkup=gtPortsLinkup, gtBackupSFTPPort=gtBackupSFTPPort, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDNSNumber=gtDNSNumber, gtPortsName=gtPortsName, gtDNSTable=gtDNSTable, gtModuleBackupDate=gtModuleBackupDate, gtAccesslistTable=gtAccesslistTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSwitch=gtSwitch, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtDNSEntry=gtDNSEntry, gtServicesEntry=gtServicesEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtSWOption=gtSWOption, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtPortsEntry=gtPortsEntry, gtTimeUTC=gtTimeUTC, gtSFPNumber=gtSFPNumber, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtUserAuthTable=gtUserAuthTable, gtNetworkPortsTable=gtNetworkPortsTable, gtTrapSNMPVersion=gtTrapSNMPVersion, gtSLAEntry=gtSLAEntry, gtModuleBackupTable=gtModuleBackupTable, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtUpdateFilesEntry=gtUpdateFilesEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtGroupTable=gtGroupTable, gtPortsTable=gtPortsTable, gtInterfaceStreaming=gtInterfaceStreaming, gtAccesslistEntry=gtAccesslistEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtModuleUpdate=gtModuleUpdate, gtUser=gtUser, gtServices=gtServices, gtTrapDestRowStatus=gtTrapDestRowStatus, gtTrapDestPort=gtTrapDestPort, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUserRowStatus=gtUserRowStatus, gtNetworking=gtNetworking, gtHMSEntry=gtHMSEntry, gtUserIdx=gtUserIdx, gtModuleBackupControl=gtModuleBackupControl, gtTrapDestNumber=gtTrapDestNumber, gtSettingsNotifications=gtSettingsNotifications, gtTrapPDU=gtTrapPDU, gtSWOptionsTable=gtSWOptionsTable, gtModuleBackup=gtModuleBackup, gtPortsBitrateReceive=gtPortsBitrateReceive, gtTrapState=gtTrapState, gtGroupName=gtGroupName, gtBackupSFTPFilename=gtBackupSFTPFilename, gtAccesslistIdx=gtAccesslistIdx, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtInterfaceNumber=gtInterfaceNumber, gtModuleBackupEntry=gtModuleBackupEntry, gtSFTPPassword=gtSFTPPassword, gtNetworkVLAN=gtNetworkVLAN, gtUserName=gtUserName, gtAgentComWriteString=gtAgentComWriteString, gtTrapDestIP=gtTrapDestIP, gtSLATable=gtSLATable, gtGeneral=gtGeneral, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtGroupRights=gtGroupRights, gtAgentComReadString=gtAgentComReadString, gtGroupAccesslist=gtGroupAccesslist, gtAccesslistIPRange=gtAccesslistIPRange, gtNetworkPortsEntry=gtNetworkPortsEntry, gtUserGroup=gtUserGroup, gtTimeLocal=gtTimeLocal, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkEntry=gtNetworkEntry, gtInterfaceEntry=gtInterfaceEntry, gtNTPServerNumber=gtNTPServerNumber, gtUserEntry=gtUserEntry, gtInterfaceState=gtInterfaceState, gtUserAccesslist=gtUserAccesslist, gtNetworkPortState=gtNetworkPortState, gtAccesslistName=gtAccesslistName, gtSNMPTable=gtSNMPTable, gtInterfaceIGMP=gtInterfaceIGMP, gtHMSTable=gtHMSTable, gtTrapDestTable=gtTrapDestTable, gtSyslogEntry=gtSyslogEntry, gtNetworkPortName=gtNetworkPortName, gtSettingsObjects=gtSettingsObjects, gtSettingsConformance=gtSettingsConformance, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFTPServer=gtSFTPServer, gtBackupSFTPUsername=gtBackupSFTPUsername, gtTrapSecurityLevel=gtTrapSecurityLevel, gtGroupParamIdx=gtGroupParamIdx, gtDateAndTime=gtDateAndTime, gtSWOptionsEntry=gtSWOptionsEntry, gtWebProtocol=gtWebProtocol, gtInterfaceWebMgt=gtInterfaceWebMgt, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtGroupEntry=gtGroupEntry, gtNTPServerRowStatus=gtNTPServerRowStatus, gtSFPSpeed=gtSFPSpeed, gtModuleRedundancyMode=gtModuleRedundancyMode, gtNetworkTable=gtNetworkTable, gtDateAndTimeEntry=gtDateAndTimeEntry, gtInterfaceTable=gtInterfaceTable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceMAC=gtInterfaceMAC, gtSettingsGroups=gtSettingsGroups, gtHMSComMethod=gtHMSComMethod, gtSFPEntry=gtSFPEntry, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSyslogTable=gtSyslogTable, gtInterfaceIPv4=gtInterfaceIPv4, gtCurrentUserPassword=gtCurrentUserPassword, gtHMSNumMembers=gtHMSNumMembers, gtSNMP=gtSNMP, gtInterfaceSNMP=gtInterfaceSNMP, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFPPlugged=gtSFPPlugged, gtCurrentUserName=gtCurrentUserName, gtSFPType=gtSFPType, gtUpdateFilesTable=gtUpdateFilesTable, gtSFTPUsername=gtSFTPUsername, gtSyslogState=gtSyslogState, gtSyslogIP=gtSyslogIP, gtInterfaceName=gtInterfaceName, gtTrapUser=gtTrapUser, gtUserAuthEnabled=gtUserAuthEnabled, gtSFTPPort=gtSFTPPort, gtTrapComString=gtTrapComString, gtDNSServerIP=gtDNSServerIP, gtNetworkPortVLAN=gtNetworkPortVLAN, gtCurrentTimeSource=gtCurrentTimeSource, gtSFPLink=gtSFPLink, gtBackupControl=gtBackupControl, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtChassisRedundancy=gtChassisRedundancy, gtModuleBackupStatus=gtModuleBackupStatus, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtBackupStatus=gtBackupStatus, gtDateAndTimeTable=gtDateAndTimeTable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSLARegistered=gtSLARegistered, gtGroupIdx=gtGroupIdx, gtNTPServerEntry=gtNTPServerEntry, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceVLAN=gtInterfaceVLAN, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSWOptionsIdx=gtSWOptionsIdx, gtNumSFP=gtNumSFP, gtUpdateControl=gtUpdateControl, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtWebEnable=gtWebEnable, gtWebAuth=gtWebAuth, gtBackupSFTPServer=gtBackupSFTPServer, gtNTPServerTable=gtNTPServerTable, gtUserParamIdx=gtUserParamIdx, gtPortsNumber=gtPortsNumber, gtTimeZone=gtTimeZone, gtUserPassword=gtUserPassword, gtInterfaceRowStatus=gtInterfaceRowStatus, gtTrapDestEntry=gtTrapDestEntry, gtSLAExpires=gtSLAExpires, gtUserTable=gtUserTable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAgentPort=gtAgentPort, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSettingsMIB=gtSettingsMIB, gtServicesTable=gtServicesTable, gtInterfaceUseVLAN=gtInterfaceUseVLAN)
