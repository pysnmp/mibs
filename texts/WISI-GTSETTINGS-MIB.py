...
Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, Bits, TimeTicks, MibIdentifier, ModuleIdentity, Integer32, Unsigned32, Counter32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "Bits", "TimeTicks", "MibIdentifier", "ModuleIdentity", "Integer32", "Unsigned32", "Counter32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtPortsBitrateReceive=gtPortsBitrateReceive, gtNetworkVLAN=gtNetworkVLAN, gtSWOptionsIdx=gtSWOptionsIdx, gtSyslogEntry=gtSyslogEntry, gtPortsNumber=gtPortsNumber, gtInterfaceCLI=gtInterfaceCLI, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtNetworkTable=gtNetworkTable, gtNetworkPortName=gtNetworkPortName, gtGroupTable=gtGroupTable, gtSFTPPort=gtSFTPPort, gtSettingsConformance=gtSettingsConformance, gtGroupIdx=gtGroupIdx, gtSettingsObjects=gtSettingsObjects, gtSettingsMIB=gtSettingsMIB, gtServices=gtServices, gtCurrentUserPassword=gtCurrentUserPassword, gtServicesTable=gtServicesTable, gtSettingsNotifications=gtSettingsNotifications, gtNTPServerNumber=gtNTPServerNumber, gtUserRowStatus=gtUserRowStatus, gtTrapUser=gtTrapUser, gtHMSNumMembers=gtHMSNumMembers, gtAccesslistParamIdx=gtAccesslistParamIdx, gtDNSServerIP=gtDNSServerIP, gtTimeZone=gtTimeZone, gtSettingsGroups=gtSettingsGroups, gtUserPassword=gtUserPassword, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtModuleBackupTable=gtModuleBackupTable, gtWebEnable=gtWebEnable, gtInterfaceVLAN=gtInterfaceVLAN, gtInterfaceWebMgt=gtInterfaceWebMgt, gtInterfaceMAC=gtInterfaceMAC, gtSFTPUsername=gtSFTPUsername, gtSNMPEntry=gtSNMPEntry, gtUserAuthTable=gtUserAuthTable, gtDaylightAdjustment=gtDaylightAdjustment, gtGroupAccesslist=gtGroupAccesslist, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtSFTPPassword=gtSFTPPassword, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSNMPTable=gtSNMPTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtNetworkPortsTable=gtNetworkPortsTable, gtUserEntry=gtUserEntry, gtNTPServerTable=gtNTPServerTable, gtUpdateFile=gtUpdateFile, gtGeneral=gtGeneral, gtNTPServerAddress=gtNTPServerAddress, gtGroupEntry=gtGroupEntry, gtSFPPlugged=gtSFPPlugged, gtSFPEntry=gtSFPEntry, gtSyslogIP=gtSyslogIP, gtUserParamIdx=gtUserParamIdx, gtWebProtocol=gtWebProtocol, gtInterfaceName=gtInterfaceName, gtTrapSNMPVersion=gtTrapSNMPVersion, gtAccesslistIPRange=gtAccesslistIPRange, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSLAEntry=gtSLAEntry, gtUpdateStatus=gtUpdateStatus, gtWebAuth=gtWebAuth, gtSyslogState=gtSyslogState, gtHMSTable=gtHMSTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtBackupStatus=gtBackupStatus, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtSWOptionsTable=gtSWOptionsTable, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtInterfaceIfIndex=gtInterfaceIfIndex, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtAccesslistIdx=gtAccesslistIdx, gtUpdateControl=gtUpdateControl, gtBackupSFTPFilename=gtBackupSFTPFilename, gtSWOptionsEntry=gtSWOptionsEntry, gtPortsName=gtPortsName, gtNetworkEntry=gtNetworkEntry, gtGroupRights=gtGroupRights, gtChassisRedundancy=gtChassisRedundancy, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNTPServerEntry=gtNTPServerEntry, gtTrapPDU=gtTrapPDU, gtNetworkName=gtNetworkName, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSFPNumber=gtSFPNumber, gtCurrentTimeSource=gtCurrentTimeSource, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtTimeLocal=gtTimeLocal, gtBackupControl=gtBackupControl, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSyslogTable=gtSyslogTable, gtNetworking=gtNetworking, gtModuleUpdate=gtModuleUpdate, gtAgentComWriteString=gtAgentComWriteString, gtHeadendSystemManagement=gtHeadendSystemManagement, gtAgentSecurityLevel=gtAgentSecurityLevel, gtInterfaceRowStatus=gtInterfaceRowStatus, gtFilename=gtFilename, gtInterfaceState=gtInterfaceState, gtModuleBackupControl=gtModuleBackupControl, gtSFPTable=gtSFPTable, gtSLAExpires=gtSLAExpires, gtDNSNumber=gtDNSNumber, gtGroupName=gtGroupName, gtServicesEntry=gtServicesEntry, gtGroupParamIdx=gtGroupParamIdx, gtAccesslistTable=gtAccesslistTable, gtModuleBackup=gtModuleBackup, gtDateAndTimeTable=gtDateAndTimeTable, gtTimeUTC=gtTimeUTC, gtTrapDestTable=gtTrapDestTable, gtUserName=gtUserName, gtCurrentUserName=gtCurrentUserName, gtNetworkPortVLAN=gtNetworkPortVLAN, gtAgentPort=gtAgentPort, gtAgentComReadString=gtAgentComReadString, gtSettingsCompliances=gtSettingsCompliances, gtTrapSecurityLevel=gtTrapSecurityLevel, gtModuleBackupEntry=gtModuleBackupEntry, gtTrapDestEntry=gtTrapDestEntry, gtPortsTable=gtPortsTable, gtDateAndTime=gtDateAndTime, gtTrapState=gtTrapState, gtTrapDestNumber=gtTrapDestNumber, gtPortsLinkup=gtPortsLinkup, gtSLATable=gtSLATable, gtDNSEntry=gtDNSEntry, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSNMP=gtSNMP, gtTrapComString=gtTrapComString, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceStreaming=gtInterfaceStreaming, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtHMSNumAvailModules=gtHMSNumAvailModules, gtNetworkPortState=gtNetworkPortState, gtInterfaceTable=gtInterfaceTable, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceEntry=gtInterfaceEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSLARegistered=gtSLARegistered, gtTrapDestIP=gtTrapDestIP, gtInterfaceIGMP=gtInterfaceIGMP, gtBackupSFTPServer=gtBackupSFTPServer, gtNetworkPortsEntry=gtNetworkPortsEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtNTPServerRowStatus=gtNTPServerRowStatus, gtPortsEntry=gtPortsEntry, gtSFPLink=gtSFPLink, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtUserAccesslist=gtUserAccesslist, gtUserGroup=gtUserGroup, gtIGMPQueryInterval=gtIGMPQueryInterval, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceSNMP=gtInterfaceSNMP, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserAuthEnabled=gtUserAuthEnabled, gtSFPType=gtSFPType, gtUser=gtUser, gtUserTable=gtUserTable, gtBackupSFTPPort=gtBackupSFTPPort, gtUserIdx=gtUserIdx, gtNetworkPortNumber=gtNetworkPortNumber, gtDNSTable=gtDNSTable, gtTrapDestPort=gtTrapDestPort, gtAccesslistEntry=gtAccesslistEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtInterfaceDHCPState=gtInterfaceDHCPState, gtHMSEntry=gtHMSEntry, gtSWOption=gtSWOption, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSFTPServer=gtSFTPServer, gtUserAuthEntry=gtUserAuthEntry, gtAccesslistName=gtAccesslistName, gtNumSFP=gtNumSFP, gtSwitch=gtSwitch, gtHMSComMethod=gtHMSComMethod, gtHMSGroupName=gtHMSGroupName, gtAgentState=gtAgentState, gtModuleBackupDate=gtModuleBackupDate, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSFPSpeed=gtSFPSpeed, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtInterfaceNumber=gtInterfaceNumber, gtModuleBackupStatus=gtModuleBackupStatus)
