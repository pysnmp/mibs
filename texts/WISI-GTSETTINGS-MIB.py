...
Counter32, TimeTicks, ObjectIdentity, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Gauge32, MibIdentifier, Counter64, IpAddress, iso, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "TimeTicks", "ObjectIdentity", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Gauge32", "MibIdentifier", "Counter64", "IpAddress", "iso", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtAccesslistParamIdx=gtAccesslistParamIdx, gtSFPNumber=gtSFPNumber, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSNMPEntry=gtSNMPEntry, gtUserRowStatus=gtUserRowStatus, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtTrapDestPort=gtTrapDestPort, gtSettingsGroups=gtSettingsGroups, gtInterfaceTable=gtInterfaceTable, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTrapDestNumber=gtTrapDestNumber, gtServices=gtServices, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtSWOption=gtSWOption, gtTrapState=gtTrapState, gtDNSEntry=gtDNSEntry, gtHMSTable=gtHMSTable, gtUserAuthEntry=gtUserAuthEntry, gtDNSServerIP=gtDNSServerIP, gtUpdateControl=gtUpdateControl, gtSFTPServer=gtSFTPServer, gtInterfaceRowStatus=gtInterfaceRowStatus, gtUpdateFilesEntry=gtUpdateFilesEntry, gtGroupAccesslist=gtGroupAccesslist, gtWebEnable=gtWebEnable, gtBackupSFTPFilename=gtBackupSFTPFilename, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtCurrentUserPassword=gtCurrentUserPassword, gtAgentComWriteString=gtAgentComWriteString, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtSWOptionsIdx=gtSWOptionsIdx, gtUserParamIdx=gtUserParamIdx, gtTimeLocal=gtTimeLocal, gtTrapDestEntry=gtTrapDestEntry, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtBackupSFTPPort=gtBackupSFTPPort, gtSyslogState=gtSyslogState, gtHMSEntry=gtHMSEntry, gtUserAuthTable=gtUserAuthTable, gtNetworking=gtNetworking, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtChassisRedundancy=gtChassisRedundancy, gtUserAccesslist=gtUserAccesslist, gtSFTPPassword=gtSFTPPassword, gtTrapComString=gtTrapComString, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceMAC=gtInterfaceMAC, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSettingsNotifications=gtSettingsNotifications, gtNTPServerTable=gtNTPServerTable, gtGroupIdx=gtGroupIdx, gtNetworkPortsTable=gtNetworkPortsTable, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtNTPServerEntry=gtNTPServerEntry, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtSFPSpeed=gtSFPSpeed, gtNetworkEntry=gtNetworkEntry, gtModuleBackup=gtModuleBackup, gtHMSNumAvailModules=gtHMSNumAvailModules, gtWebProtocol=gtWebProtocol, gtInterfaceEntry=gtInterfaceEntry, gtDaylightAdjustment=gtDaylightAdjustment, gtSFPPlugged=gtSFPPlugged, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtHMSNumMembers=gtHMSNumMembers, gtAccesslistName=gtAccesslistName, gtModuleBackupStatus=gtModuleBackupStatus, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSettingsMIB=gtSettingsMIB, gtGroupEntry=gtGroupEntry, gtNumSFP=gtNumSFP, gtFilename=gtFilename, gtSFTPUsername=gtSFTPUsername, gtDNSNumber=gtDNSNumber, gtGroupName=gtGroupName, gtNetworkPortName=gtNetworkPortName, gtAccesslistEntry=gtAccesslistEntry, gtAccesslistIdx=gtAccesslistIdx, gtUserPassword=gtUserPassword, gtSFTPPort=gtSFTPPort, gtSFPType=gtSFPType, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtBackupSFTPServer=gtBackupSFTPServer, gtDNSTable=gtDNSTable, gtAgentComReadString=gtAgentComReadString, gtCurrentTimeSource=gtCurrentTimeSource, gtUpdateFile=gtUpdateFile, gtBackupSFTPPassword=gtBackupSFTPPassword, gtHMSGroupName=gtHMSGroupName, gtDateAndTimeTable=gtDateAndTimeTable, gtNetworkName=gtNetworkName, gtGroupRights=gtGroupRights, gtSLATable=gtSLATable, gtInterfaceState=gtInterfaceState, gtTimeUTC=gtTimeUTC, gtModuleUpdate=gtModuleUpdate, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapDestIP=gtTrapDestIP, gtAccesslistIPRange=gtAccesslistIPRange, gtModuleBackupControl=gtModuleBackupControl, gtNetworkTable=gtNetworkTable, gtInterfaceSNMP=gtInterfaceSNMP, gtUserTable=gtUserTable, gtGeneral=gtGeneral, gtInterfaceDHCPState=gtInterfaceDHCPState, gtSFPEntry=gtSFPEntry, gtBackupStatus=gtBackupStatus, gtTrapDestTable=gtTrapDestTable, gtInterfaceStreaming=gtInterfaceStreaming, gtSyslogEntry=gtSyslogEntry, PYSNMP_MODULE_ID=gtSettingsMIB, gtSettingsConformance=gtSettingsConformance, gtTimeZone=gtTimeZone, gtNetworkPortVLAN=gtNetworkPortVLAN, gtPortsTable=gtPortsTable, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceCLI=gtInterfaceCLI, gtSNMPTable=gtSNMPTable, gtAgentState=gtAgentState, gtTrapPDU=gtTrapPDU, gtPortsLinkup=gtPortsLinkup, gtBackupSFTPUsername=gtBackupSFTPUsername, gtDateAndTimeEntry=gtDateAndTimeEntry, gtServicesEntry=gtServicesEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtAccesslistTable=gtAccesslistTable, gtInterfaceIGMP=gtInterfaceIGMP, gtModuleRedundancyMode=gtModuleRedundancyMode, gtUserIdx=gtUserIdx, gtSWOptionsEntry=gtSWOptionsEntry, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtGroupParamIdx=gtGroupParamIdx, gtModuleBackupDate=gtModuleBackupDate, gtSFPLink=gtSFPLink, gtWebAuth=gtWebAuth, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSettingsCompliances=gtSettingsCompliances, gtInterfaceNumber=gtInterfaceNumber, gtNetworkPortState=gtNetworkPortState, gtPortsEntry=gtPortsEntry, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSWOptionsTable=gtSWOptionsTable, gtUserGroup=gtUserGroup, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUpdateStatus=gtUpdateStatus, gtNetworkVLAN=gtNetworkVLAN, gtSLARegistered=gtSLARegistered, gtNTPServerNumber=gtNTPServerNumber, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtTrapSNMPVersion=gtTrapSNMPVersion, gtBackupControl=gtBackupControl, gtInterfaceIfIndex=gtInterfaceIfIndex, gtSNMP=gtSNMP, gtSyslogTable=gtSyslogTable, gtSyslogIP=gtSyslogIP, gtSettingsObjects=gtSettingsObjects, gtTrapDestRowStatus=gtTrapDestRowStatus, gtModuleBackupTable=gtModuleBackupTable, gtAgentPort=gtAgentPort, gtServicesTable=gtServicesTable, gtHMSComMethod=gtHMSComMethod, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtInterfaceVLAN=gtInterfaceVLAN, gtTrapUser=gtTrapUser, gtUser=gtUser, gtCurrentUserName=gtCurrentUserName, gtUserAuthEnabled=gtUserAuthEnabled, gtPortsName=gtPortsName, gtSLAEntry=gtSLAEntry, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSLAExpires=gtSLAExpires, gtUserName=gtUserName, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserEntry=gtUserEntry, gtNetworkPortNumber=gtNetworkPortNumber, gtSwitch=gtSwitch, gtGroupTable=gtGroupTable, gtDateAndTime=gtDateAndTime, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtUpdateFilesTable=gtUpdateFilesTable, gtInterfaceIPv4=gtInterfaceIPv4, gtInterfaceName=gtInterfaceName, gtAgentSecurityLevel=gtAgentSecurityLevel, gtModuleBackupEntry=gtModuleBackupEntry, gtNTPServerAddress=gtNTPServerAddress, gtPortsNumber=gtPortsNumber, gtSFPTable=gtSFPTable)
