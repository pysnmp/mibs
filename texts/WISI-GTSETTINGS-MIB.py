...
MibIdentifier, Gauge32, ObjectIdentity, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, iso, Unsigned32, Counter32, Bits, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "ObjectIdentity", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "iso", "Unsigned32", "Counter32", "Bits", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSettingsMIB=gtSettingsMIB, gtSFTPPassword=gtSFTPPassword, gtUpdateFilesTable=gtUpdateFilesTable, gtTrapState=gtTrapState, gtUserTable=gtUserTable, gtGroupIdx=gtGroupIdx, gtUser=gtUser, gtPortsTable=gtPortsTable, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceIGMP=gtInterfaceIGMP, gtBackupStatus=gtBackupStatus, gtNTPServerAddress=gtNTPServerAddress, gtTrapComString=gtTrapComString, gtTrapSNMPVersion=gtTrapSNMPVersion, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtUserEntry=gtUserEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtSyslogState=gtSyslogState, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtInterfaceMAC=gtInterfaceMAC, gtInterfaceSNMP=gtInterfaceSNMP, gtSLATable=gtSLATable, gtSyslogIP=gtSyslogIP, gtInterfaceCLI=gtInterfaceCLI, gtModuleBackupControl=gtModuleBackupControl, gtNetworkPortState=gtNetworkPortState, gtChassisRedundancy=gtChassisRedundancy, gtSFPLink=gtSFPLink, gtNTPServerEntry=gtNTPServerEntry, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtHeadendSystemManagement=gtHeadendSystemManagement, gtHMSNumAvailModules=gtHMSNumAvailModules, gtTrapPDU=gtTrapPDU, gtNetworkVLAN=gtNetworkVLAN, gtBackupSFTPFilename=gtBackupSFTPFilename, gtFilename=gtFilename, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtUserAuthEntry=gtUserAuthEntry, gtBackupSFTPPassword=gtBackupSFTPPassword, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSWOptionsTable=gtSWOptionsTable, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtNTPServerTable=gtNTPServerTable, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSNMPTable=gtSNMPTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtTrapDestTable=gtTrapDestTable, gtPortsNumber=gtPortsNumber, gtBackupControl=gtBackupControl, gtPortsEntry=gtPortsEntry, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSFPNumber=gtSFPNumber, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtSFPPlugged=gtSFPPlugged, gtPortsLinkup=gtPortsLinkup, gtInterfaceDHCPState=gtInterfaceDHCPState, gtDNSEntry=gtDNSEntry, gtSFPType=gtSFPType, gtServicesTable=gtServicesTable, gtDNSServerIP=gtDNSServerIP, gtNetworkPortVLAN=gtNetworkPortVLAN, gtNetworkPortsEntry=gtNetworkPortsEntry, gtInterfaceWebMgt=gtInterfaceWebMgt, gtSettingsCompliances=gtSettingsCompliances, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtSwitch=gtSwitch, gtModuleBackupTable=gtModuleBackupTable, gtNetworkEntry=gtNetworkEntry, gtSFPEntry=gtSFPEntry, gtSettingsConformance=gtSettingsConformance, gtPortsFloodMulticast=gtPortsFloodMulticast, gtAgentSecurityLevel=gtAgentSecurityLevel, gtSFTPServer=gtSFTPServer, gtInterfaceState=gtInterfaceState, gtUserAuthTable=gtUserAuthTable, gtHMSTable=gtHMSTable, gtAccesslistIPRange=gtAccesslistIPRange, gtSLAEntry=gtSLAEntry, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworking=gtNetworking, gtTrapSecurityLevel=gtTrapSecurityLevel, gtGroupParamIdx=gtGroupParamIdx, gtModuleRedundancyMode=gtModuleRedundancyMode, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtUserAuthEnabled=gtUserAuthEnabled, gtUpdateControl=gtUpdateControl, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceIPv4=gtInterfaceIPv4, gtModuleBackupEntry=gtModuleBackupEntry, gtCurrentUserName=gtCurrentUserName, gtSFTPUsername=gtSFTPUsername, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtHMSEntry=gtHMSEntry, gtSyslogTable=gtSyslogTable, gtInterfaceTable=gtInterfaceTable, gtNetworkTable=gtNetworkTable, gtInterfaceName=gtInterfaceName, gtSettingsObjects=gtSettingsObjects, gtAgentComReadString=gtAgentComReadString, gtGroupTable=gtGroupTable, gtDaylightAdjustment=gtDaylightAdjustment, gtCurrentUserPassword=gtCurrentUserPassword, gtInterfaceEntry=gtInterfaceEntry, gtModuleBackupStatus=gtModuleBackupStatus, gtServices=gtServices, gtNumSFP=gtNumSFP, gtSLARegistered=gtSLARegistered, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtAccesslistName=gtAccesslistName, gtServicesEntry=gtServicesEntry, gtGeneral=gtGeneral, gtAgentState=gtAgentState, gtNTPServerNumber=gtNTPServerNumber, gtHMSComMethod=gtHMSComMethod, gtTrapDestPort=gtTrapDestPort, gtModuleBackupDate=gtModuleBackupDate, gtNetworkPortName=gtNetworkPortName, gtDNSTable=gtDNSTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtAgentComWriteString=gtAgentComWriteString, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSLAExpires=gtSLAExpires, gtWebProtocol=gtWebProtocol, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTimeLocal=gtTimeLocal, gtModuleBackup=gtModuleBackup, gtUserRowStatus=gtUserRowStatus, gtGroupEntry=gtGroupEntry, gtInterfaceStreaming=gtInterfaceStreaming, gtAccesslistTable=gtAccesslistTable, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapDestNumber=gtTrapDestNumber, gtTrapDestIP=gtTrapDestIP, gtSFPTable=gtSFPTable, gtUserParamIdx=gtUserParamIdx, gtGroupAccesslist=gtGroupAccesslist, gtSettingsGroups=gtSettingsGroups, gtSFPSpeed=gtSFPSpeed, gtAccesslistEntry=gtAccesslistEntry, gtNetworkName=gtNetworkName, gtTrapUser=gtTrapUser, gtUpdateFile=gtUpdateFile, gtSWOption=gtSWOption, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtBackupSFTPServer=gtBackupSFTPServer, gtSFTPPort=gtSFTPPort, gtTrapDestEntry=gtTrapDestEntry, gtSNMP=gtSNMP, gtUserAccesslist=gtUserAccesslist, gtNetworkPortsTable=gtNetworkPortsTable, gtUpdateStatus=gtUpdateStatus, gtGroupRights=gtGroupRights, gtDNSNumber=gtDNSNumber, gtTimeUTC=gtTimeUTC, gtUpdateFilesEntry=gtUpdateFilesEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtCurrentTimeSource=gtCurrentTimeSource, gtTimeZone=gtTimeZone, gtSyslogEntry=gtSyslogEntry, gtWebEnable=gtWebEnable, gtSWOptionsEntry=gtSWOptionsEntry, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtGroupName=gtGroupName, gtDateAndTime=gtDateAndTime, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtAccesslistParamIdx=gtAccesslistParamIdx, gtInterfaceRowStatus=gtInterfaceRowStatus, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtAgentPort=gtAgentPort, gtInterfaceNumber=gtInterfaceNumber, gtUserIdx=gtUserIdx, gtUserGroup=gtUserGroup, gtSNMPEntry=gtSNMPEntry, gtAccesslistIdx=gtAccesslistIdx, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceVLAN=gtInterfaceVLAN, gtModuleUpdate=gtModuleUpdate, gtInterfaceIfIndex=gtInterfaceIfIndex, gtUserPassword=gtUserPassword, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtWebAuth=gtWebAuth, gtHMSNumMembers=gtHMSNumMembers, gtPortsName=gtPortsName, gtUserName=gtUserName, gtHMSGroupName=gtHMSGroupName, gtSWOptionsIdx=gtSWOptionsIdx, gtSettingsNotifications=gtSettingsNotifications)
