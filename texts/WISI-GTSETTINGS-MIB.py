...
Integer32, TimeTicks, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, ModuleIdentity, Counter32, iso, MibIdentifier, ObjectIdentity, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "ModuleIdentity", "Counter32", "iso", "MibIdentifier", "ObjectIdentity", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtTrapState=gtTrapState, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSyslogTable=gtSyslogTable, gtNetworkTable=gtNetworkTable, gtGroupEntry=gtGroupEntry, gtUserParamIdx=gtUserParamIdx, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtPortsEntry=gtPortsEntry, gtInterfaceNumber=gtInterfaceNumber, gtAccesslistIdx=gtAccesslistIdx, gtAgentComReadString=gtAgentComReadString, gtBackupSFTPUsername=gtBackupSFTPUsername, gtHMSEntry=gtHMSEntry, gtGroupRights=gtGroupRights, gtSFPType=gtSFPType, gtTimeLocal=gtTimeLocal, gtUserAuthEntry=gtUserAuthEntry, gtInterfaceRowStatus=gtInterfaceRowStatus, gtServicesEntry=gtServicesEntry, gtSNMPTable=gtSNMPTable, gtInterfaceEntry=gtInterfaceEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtPortsLinkup=gtPortsLinkup, gtTimeZone=gtTimeZone, gtUpdateFilesTable=gtUpdateFilesTable, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNetworkPortsEntry=gtNetworkPortsEntry, gtModuleBackup=gtModuleBackup, gtInterfaceName=gtInterfaceName, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtDNSEntry=gtDNSEntry, gtInterfaceTable=gtInterfaceTable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtCurrentTimeSource=gtCurrentTimeSource, gtSFTPPassword=gtSFTPPassword, gtModuleUpdate=gtModuleUpdate, gtSLATable=gtSLATable, gtUserAuthTable=gtUserAuthTable, gtModuleBackupEntry=gtModuleBackupEntry, gtInterfaceSNMP=gtInterfaceSNMP, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceMAC=gtInterfaceMAC, gtSwitch=gtSwitch, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapPDU=gtTrapPDU, gtNetworkPortNumber=gtNetworkPortNumber, gtUserPassword=gtUserPassword, gtAccesslistIPRange=gtAccesslistIPRange, gtSettingsNotifications=gtSettingsNotifications, gtSLAExpires=gtSLAExpires, gtSWOption=gtSWOption, gtGeneral=gtGeneral, gtPortsNumber=gtPortsNumber, gtDNSTable=gtDNSTable, gtUserName=gtUserName, gtGroupIdx=gtGroupIdx, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtUserAuthEnabled=gtUserAuthEnabled, gtFilename=gtFilename, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtPortsTable=gtPortsTable, gtNetworkName=gtNetworkName, gtAccesslistParamIdx=gtAccesslistParamIdx, gtHMSComMethod=gtHMSComMethod, gtUserTable=gtUserTable, gtHMSNumMembers=gtHMSNumMembers, gtNTPServerEntry=gtNTPServerEntry, gtAccesslistEntry=gtAccesslistEntry, gtServicesTable=gtServicesTable, gtAccesslistName=gtAccesslistName, gtAgentPort=gtAgentPort, gtModuleBackupTable=gtModuleBackupTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtBackupStatus=gtBackupStatus, gtServices=gtServices, gtNetworkPortState=gtNetworkPortState, gtNTPServerRowStatus=gtNTPServerRowStatus, gtInterfaceWebMgt=gtInterfaceWebMgt, gtBackupControl=gtBackupControl, gtHMSTable=gtHMSTable, gtSWOptionsTable=gtSWOptionsTable, gtWebProtocol=gtWebProtocol, gtSFTPUsername=gtSFTPUsername, gtSFPTable=gtSFPTable, gtTrapDestIP=gtTrapDestIP, gtAgentComWriteString=gtAgentComWriteString, gtInterfaceVLAN=gtInterfaceVLAN, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtUser=gtUser, gtSyslogState=gtSyslogState, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtModuleRedundancyMode=gtModuleRedundancyMode, gtSFTPPort=gtSFTPPort, gtNetworkPortName=gtNetworkPortName, gtModuleBackupDate=gtModuleBackupDate, gtTimeUTC=gtTimeUTC, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtTrapSNMPVersion=gtTrapSNMPVersion, gtNetworkPortVLAN=gtNetworkPortVLAN, gtUserEntry=gtUserEntry, gtInterfaceCLI=gtInterfaceCLI, gtPortsFloodMulticast=gtPortsFloodMulticast, gtTrapDestEntry=gtTrapDestEntry, gtUpdateFile=gtUpdateFile, gtDNSServerIP=gtDNSServerIP, gtCurrentUserPassword=gtCurrentUserPassword, gtSFPEntry=gtSFPEntry, gtDateAndTimeTable=gtDateAndTimeTable, gtHeadendSystemManagement=gtHeadendSystemManagement, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtTrapDestPort=gtTrapDestPort, gtUpdateStatus=gtUpdateStatus, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtSFPSpeed=gtSFPSpeed, gtTrapUser=gtTrapUser, gtModuleBackupStatus=gtModuleBackupStatus, gtUserAccesslist=gtUserAccesslist, gtSettingsObjects=gtSettingsObjects, gtNumSFP=gtNumSFP, gtAgentState=gtAgentState, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtSyslogEntry=gtSyslogEntry, gtGroupParamIdx=gtGroupParamIdx, gtInterfaceIPv4=gtInterfaceIPv4, gtNTPServerAddress=gtNTPServerAddress, gtNetworkPortsTable=gtNetworkPortsTable, gtGroupAccesslist=gtGroupAccesslist, gtTrapComString=gtTrapComString, gtCurrentUserName=gtCurrentUserName, gtSettingsGroups=gtSettingsGroups, gtWebAuth=gtWebAuth, gtTrapDestRowStatus=gtTrapDestRowStatus, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtTrapDestNumber=gtTrapDestNumber, gtInterfaceDHCPState=gtInterfaceDHCPState, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSNMP=gtSNMP, gtChassisRedundancy=gtChassisRedundancy, gtSLAEntry=gtSLAEntry, gtSFTPServer=gtSFTPServer, gtModuleBackupControl=gtModuleBackupControl, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSettingsConformance=gtSettingsConformance, gtDateAndTime=gtDateAndTime, PYSNMP_MODULE_ID=gtSettingsMIB, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtBackupSFTPFilename=gtBackupSFTPFilename, gtHMSNumAvailModules=gtHMSNumAvailModules, gtBackupSFTPServer=gtBackupSFTPServer, gtTrapSecurityLevel=gtTrapSecurityLevel, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSLARegistered=gtSLARegistered, gtSFPNumber=gtSFPNumber, gtIGMPQueryInterval=gtIGMPQueryInterval, gtNetworkVLAN=gtNetworkVLAN, gtUpdateControl=gtUpdateControl, gtInterfaceState=gtInterfaceState, gtDNSNumber=gtDNSNumber, gtUserRowStatus=gtUserRowStatus, gtHMSGroupName=gtHMSGroupName, gtInterfaceIGMP=gtInterfaceIGMP, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtSettingsMIB=gtSettingsMIB, gtUserGroup=gtUserGroup, gtUserIdx=gtUserIdx, gtGroupName=gtGroupName, gtSNMPEntry=gtSNMPEntry, gtTrapDestTable=gtTrapDestTable, gtSettingsCompliances=gtSettingsCompliances, gtSFPLink=gtSFPLink, gtNTPServerTable=gtNTPServerTable, gtWebEnable=gtWebEnable, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtInterfaceStreaming=gtInterfaceStreaming, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtAgentSecurityLevel=gtAgentSecurityLevel, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSFPPlugged=gtSFPPlugged, gtDateAndTimeEntry=gtDateAndTimeEntry, gtNetworking=gtNetworking, gtNetworkEntry=gtNetworkEntry, gtSyslogIP=gtSyslogIP, gtInterfaceIfIndex=gtInterfaceIfIndex, gtNTPServerNumber=gtNTPServerNumber, gtSWOptionsIdx=gtSWOptionsIdx, gtGroupTable=gtGroupTable, gtBackupSFTPPort=gtBackupSFTPPort, gtAccesslistTable=gtAccesslistTable, gtPortsName=gtPortsName)
