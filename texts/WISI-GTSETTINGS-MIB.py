...
MibIdentifier, Unsigned32, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Counter64, ObjectIdentity, NotificationType, TimeTicks, Gauge32, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Counter64", "ObjectIdentity", "NotificationType", "TimeTicks", "Gauge32", "Counter32", "iso")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtInterfaceState=gtInterfaceState, gtSLAEntry=gtSLAEntry, gtAccesslistEntry=gtAccesslistEntry, gtAccesslistIPRange=gtAccesslistIPRange, gtTrapPDU=gtTrapPDU, gtTrapDestTable=gtTrapDestTable, gtBackupSFTPPassword=gtBackupSFTPPassword, gtInterfaceWebMgt=gtInterfaceWebMgt, gtHMSNumAvailModules=gtHMSNumAvailModules, gtServicesEntry=gtServicesEntry, gtNetworkPortName=gtNetworkPortName, gtSWOption=gtSWOption, gtNetworkPortVLAN=gtNetworkPortVLAN, gtInterfaceRowStatus=gtInterfaceRowStatus, gtNetworkTable=gtNetworkTable, gtModuleBackupControl=gtModuleBackupControl, gtUserAuthTable=gtUserAuthTable, gtSFPNumber=gtSFPNumber, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtUpdateFilesTable=gtUpdateFilesTable, gtModuleUpdate=gtModuleUpdate, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtBackupStatus=gtBackupStatus, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceName=gtInterfaceName, gtDNSTable=gtDNSTable, gtSFPTable=gtSFPTable, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtNTPServerEntry=gtNTPServerEntry, gtSettingsCompliances=gtSettingsCompliances, gtSWOptionsTable=gtSWOptionsTable, gtHMSNumMembers=gtHMSNumMembers, gtInterfaceIPv4=gtInterfaceIPv4, gtBackupSFTPServer=gtBackupSFTPServer, gtSettingsGroups=gtSettingsGroups, gtUserParamIdx=gtUserParamIdx, gtSettingsConformance=gtSettingsConformance, gtBackupControl=gtBackupControl, gtNetworking=gtNetworking, gtServices=gtServices, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSFPEntry=gtSFPEntry, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtWebAuth=gtWebAuth, gtBackupSFTPFilename=gtBackupSFTPFilename, gtAccesslistName=gtAccesslistName, gtGeneral=gtGeneral, gtInterfaceVLAN=gtInterfaceVLAN, gtNetworkPortNumber=gtNetworkPortNumber, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSFPLink=gtSFPLink, gtUserAuthEntry=gtUserAuthEntry, gtSyslogIP=gtSyslogIP, gtUserAccesslist=gtUserAccesslist, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtDateAndTime=gtDateAndTime, gtGroupIdx=gtGroupIdx, gtUserAuthEnabled=gtUserAuthEnabled, gtAgentComReadString=gtAgentComReadString, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtAccesslistTable=gtAccesslistTable, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtCurrentTimeSource=gtCurrentTimeSource, gtTrapDestEntry=gtTrapDestEntry, gtSwitch=gtSwitch, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtTrapComString=gtTrapComString, PYSNMP_MODULE_ID=gtSettingsMIB, gtTimeLocal=gtTimeLocal, gtNetworkName=gtNetworkName, gtInterfaceIfIndex=gtInterfaceIfIndex, gtInterfaceStreaming=gtInterfaceStreaming, gtSFTPPort=gtSFTPPort, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtSFTPUsername=gtSFTPUsername, gtCurrentUserName=gtCurrentUserName, gtInterfaceCLI=gtInterfaceCLI, gtUser=gtUser, gtNetworkPortState=gtNetworkPortState, gtInterfaceEntry=gtInterfaceEntry, gtSettingsObjects=gtSettingsObjects, gtFilename=gtFilename, gtPortsEntry=gtPortsEntry, gtUserGroup=gtUserGroup, gtUserName=gtUserName, gtPortsBitrateReceive=gtPortsBitrateReceive, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtDateAndTimeTable=gtDateAndTimeTable, gtSFPSpeed=gtSFPSpeed, gtSyslogTable=gtSyslogTable, gtModuleBackupStatus=gtModuleBackupStatus, gtHMSComMethod=gtHMSComMethod, gtSNMP=gtSNMP, gtNTPServerTable=gtNTPServerTable, gtNetworkPortsEntry=gtNetworkPortsEntry, gtAgentState=gtAgentState, gtTrapState=gtTrapState, gtUpdateControl=gtUpdateControl, gtWebProtocol=gtWebProtocol, gtTrapDestRowStatus=gtTrapDestRowStatus, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtGroupAccesslist=gtGroupAccesslist, gtModuleBackupEntry=gtModuleBackupEntry, gtHMSGroupName=gtHMSGroupName, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtAgentSecurityLevel=gtAgentSecurityLevel, gtModuleBackup=gtModuleBackup, gtGroupEntry=gtGroupEntry, gtUpdateFilesEntry=gtUpdateFilesEntry, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtUserEntry=gtUserEntry, gtUpdateFile=gtUpdateFile, gtModuleBackupDate=gtModuleBackupDate, gtHMSEntry=gtHMSEntry, gtUserTable=gtUserTable, gtSWOptionsEntry=gtSWOptionsEntry, gtGroupTable=gtGroupTable, gtNumSFP=gtNumSFP, gtSyslogState=gtSyslogState, gtInterfaceMAC=gtInterfaceMAC, gtSettingsNotifications=gtSettingsNotifications, gtInterfaceSNMP=gtInterfaceSNMP, gtSNMPEntry=gtSNMPEntry, gtPortsNumber=gtPortsNumber, gtTimeUTC=gtTimeUTC, gtGroupName=gtGroupName, gtUserIdx=gtUserIdx, gtNTPServerNumber=gtNTPServerNumber, gtInterfaceDHCPState=gtInterfaceDHCPState, gtTrapDestIP=gtTrapDestIP, gtAccesslistParamIdx=gtAccesslistParamIdx, gtSFTPPassword=gtSFTPPassword, gtSNMPTable=gtSNMPTable, gtInterfaceIGMP=gtInterfaceIGMP, gtBackupSFTPPort=gtBackupSFTPPort, gtHMSTable=gtHMSTable, gtTimeZone=gtTimeZone, gtSWOptionsIdx=gtSWOptionsIdx, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtAgentPort=gtAgentPort, gtSLAExpires=gtSLAExpires, gtInterfaceNumber=gtInterfaceNumber, gtTrapDestPort=gtTrapDestPort, gtPortsFloodMulticast=gtPortsFloodMulticast, gtSFPPlugged=gtSFPPlugged, gtUserRowStatus=gtUserRowStatus, gtPortsLinkup=gtPortsLinkup, gtWebEnable=gtWebEnable, gtSyslogEntry=gtSyslogEntry, gtBackupSFTPUsername=gtBackupSFTPUsername, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSLATable=gtSLATable, gtPortsName=gtPortsName, gtDNSEntry=gtDNSEntry, gtNTPServerAddress=gtNTPServerAddress, gtUpdateStatus=gtUpdateStatus, gtTrapUser=gtTrapUser, gtNetworkEntry=gtNetworkEntry, gtChassisRedundancy=gtChassisRedundancy, gtCurrentUserPassword=gtCurrentUserPassword, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtNetworkPortsTable=gtNetworkPortsTable, gtSFTPServer=gtSFTPServer, gtDateAndTimeEntry=gtDateAndTimeEntry, gtDNSServerIP=gtDNSServerIP, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtServicesTable=gtServicesTable, gtModuleRedundancyMode=gtModuleRedundancyMode, gtDaylightAdjustment=gtDaylightAdjustment, gtPortsTable=gtPortsTable, gtDNSNumber=gtDNSNumber, gtGroupRights=gtGroupRights, gtAccesslistIdx=gtAccesslistIdx, gtNTPServerRowStatus=gtNTPServerRowStatus, gtTrapSNMPVersion=gtTrapSNMPVersion, gtGroupParamIdx=gtGroupParamIdx, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceTable=gtInterfaceTable, gtTrapDestNumber=gtTrapDestNumber, gtSFPType=gtSFPType, gtUserPassword=gtUserPassword, gtAgentComWriteString=gtAgentComWriteString, gtSLARegistered=gtSLARegistered, gtNetworkVLAN=gtNetworkVLAN, gtModuleBackupTable=gtModuleBackupTable, gtSettingsMIB=gtSettingsMIB)
