...
IpAddress, Unsigned32, ModuleIdentity, Integer32, Counter32, Counter64, TimeTicks, ObjectIdentity, Bits, NotificationType, Gauge32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "ModuleIdentity", "Integer32", "Counter32", "Counter64", "TimeTicks", "ObjectIdentity", "Bits", "NotificationType", "Gauge32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtGroupName=gtGroupName, gtDNSEntry=gtDNSEntry, gtCurrentTimeSource=gtCurrentTimeSource, gtUserParamIdx=gtUserParamIdx, gtTrapDestPort=gtTrapDestPort, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtModuleUpdate=gtModuleUpdate, gtHMSEntry=gtHMSEntry, gtTrapDestEntry=gtTrapDestEntry, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUpdateFile=gtUpdateFile, gtTrapSecurityLevel=gtTrapSecurityLevel, gtSLATable=gtSLATable, gtUpdateStatus=gtUpdateStatus, gtHMSTable=gtHMSTable, gtHMSNumAvailModules=gtHMSNumAvailModules, gtSFTPPassword=gtSFTPPassword, gtSFPType=gtSFPType, gtNetworkPortVLAN=gtNetworkPortVLAN, gtDNSTable=gtDNSTable, gtInterfaceIfIndex=gtInterfaceIfIndex, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtHMSGroupName=gtHMSGroupName, gtBackupControl=gtBackupControl, gtInterfaceStreaming=gtInterfaceStreaming, gtUserIdx=gtUserIdx, gtBackupSFTPPort=gtBackupSFTPPort, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtUserPassword=gtUserPassword, gtSWOptionsIdx=gtSWOptionsIdx, gtGeneral=gtGeneral, gtInterfaceTable=gtInterfaceTable, gtModuleBackupControl=gtModuleBackupControl, gtNumSFP=gtNumSFP, gtNetworkTable=gtNetworkTable, gtTimeLocal=gtTimeLocal, gtModuleBackupDate=gtModuleBackupDate, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtBackupSFTPUsername=gtBackupSFTPUsername, gtServicesEntry=gtServicesEntry, gtUserGroup=gtUserGroup, gtModuleBackupStatus=gtModuleBackupStatus, gtModuleBackupEntry=gtModuleBackupEntry, gtAgentComReadString=gtAgentComReadString, gtTrapDestRowStatus=gtTrapDestRowStatus, gtAccesslistIdx=gtAccesslistIdx, gtBackupSFTPPassword=gtBackupSFTPPassword, gtAgentPort=gtAgentPort, gtUser=gtUser, gtDateAndTime=gtDateAndTime, gtUserRowStatus=gtUserRowStatus, gtTrapPDU=gtTrapPDU, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtNetworkPortState=gtNetworkPortState, gtServices=gtServices, gtGroupEntry=gtGroupEntry, gtCurrentUserPassword=gtCurrentUserPassword, gtWebEnable=gtWebEnable, gtGroupRights=gtGroupRights, gtSNMPEntry=gtSNMPEntry, gtInterfaceDHCPState=gtInterfaceDHCPState, gtInterfaceIPv4=gtInterfaceIPv4, gtGroupParamIdx=gtGroupParamIdx, gtNetworkPortNumber=gtNetworkPortNumber, gtNetworkName=gtNetworkName, gtSFPPlugged=gtSFPPlugged, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtNTPServerRowStatus=gtNTPServerRowStatus, gtUserTable=gtUserTable, gtSwitch=gtSwitch, gtCurrentUserName=gtCurrentUserName, gtNetworkPortName=gtNetworkPortName, gtTrapState=gtTrapState, gtTrapDestNumber=gtTrapDestNumber, gtBackupSFTPFilename=gtBackupSFTPFilename, gtPortsEntry=gtPortsEntry, gtUserAuthEnabled=gtUserAuthEnabled, gtSyslogEntry=gtSyslogEntry, gtAgentState=gtAgentState, gtSFTPServer=gtSFTPServer, gtGroupIdx=gtGroupIdx, gtSFTPPort=gtSFTPPort, gtInterfaceCLI=gtInterfaceCLI, gtNTPServerNumber=gtNTPServerNumber, gtTrapDestIP=gtTrapDestIP, gtDateAndTimeEntry=gtDateAndTimeEntry, gtSFTPUsername=gtSFTPUsername, gtSettingsConformance=gtSettingsConformance, gtSettingsGroups=gtSettingsGroups, gtNetworkPortsTable=gtNetworkPortsTable, gtBackupStatus=gtBackupStatus, gtWebAuth=gtWebAuth, gtFilename=gtFilename, gtNetworkPortsEntry=gtNetworkPortsEntry, gtSettingsNotifications=gtSettingsNotifications, gtHMSNumMembers=gtHMSNumMembers, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtGroupTable=gtGroupTable, gtSettingsCompliances=gtSettingsCompliances, gtNTPServerEntry=gtNTPServerEntry, gtSFPSpeed=gtSFPSpeed, gtTrapComString=gtTrapComString, gtAccesslistName=gtAccesslistName, gtUserEntry=gtUserEntry, gtSWOptionsEntry=gtSWOptionsEntry, gtPortsTable=gtPortsTable, gtInterfaceIGMP=gtInterfaceIGMP, gtServicesTable=gtServicesTable, gtChassisRedundancy=gtChassisRedundancy, gtAgentSecurityLevel=gtAgentSecurityLevel, gtTrapDestTable=gtTrapDestTable, gtHMSComMethod=gtHMSComMethod, gtInterfaceEntry=gtInterfaceEntry, gtNTPServerAddress=gtNTPServerAddress, gtSFPLink=gtSFPLink, gtInterfaceSNMP=gtInterfaceSNMP, gtAccesslistTable=gtAccesslistTable, gtSyslogTable=gtSyslogTable, gtNetworking=gtNetworking, gtNTPServerTable=gtNTPServerTable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtNetworkEntry=gtNetworkEntry, gtInterfaceName=gtInterfaceName, gtInterfaceMAC=gtInterfaceMAC, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtTimeZone=gtTimeZone, gtSettingsObjects=gtSettingsObjects, gtSNMP=gtSNMP, gtSyslogState=gtSyslogState, gtBackupSFTPServer=gtBackupSFTPServer, gtUserAuthTable=gtUserAuthTable, gtDNSNumber=gtDNSNumber, gtDateAndTimeTable=gtDateAndTimeTable, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtInterfaceWebMgt=gtInterfaceWebMgt, gtUpdateFilesEntry=gtUpdateFilesEntry, gtDNSServerIP=gtDNSServerIP, gtNetworkVLAN=gtNetworkVLAN, gtModuleBackup=gtModuleBackup, gtTrapUser=gtTrapUser, gtUserAccesslist=gtUserAccesslist, gtPortsFloodMulticast=gtPortsFloodMulticast, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtSLAEntry=gtSLAEntry, gtSyslogIP=gtSyslogIP, gtWebProtocol=gtWebProtocol, gtUpdateFilesTable=gtUpdateFilesTable, gtAgentComWriteString=gtAgentComWriteString, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtSWOptionsTable=gtSWOptionsTable, gtPortsNumber=gtPortsNumber, gtModuleRedundancyMode=gtModuleRedundancyMode, gtInterfaceNumber=gtInterfaceNumber, gtDaylightAdjustment=gtDaylightAdjustment, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtSettingsMIB=gtSettingsMIB, gtSLARegistered=gtSLARegistered, gtUserAuthEntry=gtUserAuthEntry, gtUserName=gtUserName, gtSLAExpires=gtSLAExpires, gtPortsBitrateReceive=gtPortsBitrateReceive, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtPortsLinkup=gtPortsLinkup, gtIGMPQueryInterval=gtIGMPQueryInterval, gtInterfaceVLAN=gtInterfaceVLAN, PYSNMP_MODULE_ID=gtSettingsMIB, gtInterfaceRowStatus=gtInterfaceRowStatus, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtAccesslistEntry=gtAccesslistEntry, gtSFPNumber=gtSFPNumber, gtSFPEntry=gtSFPEntry, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtTimeUTC=gtTimeUTC, gtSNMPTable=gtSNMPTable, gtAccesslistIPRange=gtAccesslistIPRange, gtGroupAccesslist=gtGroupAccesslist, gtUpdateControl=gtUpdateControl, gtHeadendSystemManagement=gtHeadendSystemManagement, gtTrapSNMPVersion=gtTrapSNMPVersion, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtModuleBackupTable=gtModuleBackupTable, gtSWOption=gtSWOption, gtPortsName=gtPortsName, gtInterfaceState=gtInterfaceState, gtSFPTable=gtSFPTable)
