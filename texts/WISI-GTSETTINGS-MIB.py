...
MibIdentifier, Bits, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Counter64, NotificationType, iso, Counter32, TimeTicks, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Counter64", "NotificationType", "iso", "Counter32", "TimeTicks", "ModuleIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("WISI-GTSETTINGS-MIB", gtCurrentUserName=gtCurrentUserName, gtPortsFloodMulticast=gtPortsFloodMulticast, gtModuleBackupStatus=gtModuleBackupStatus, gtSNMPEntry=gtSNMPEntry, gtSFTPPassword=gtSFTPPassword, gtUser=gtUser, gtInterfaceSimulcrypt=gtInterfaceSimulcrypt, gtGroupEntry=gtGroupEntry, gtGroupIdx=gtGroupIdx, gtNetworkIGMPQuerierState=gtNetworkIGMPQuerierState, gtSwitch=gtSwitch, gtModuleBackupControl=gtModuleBackupControl, gtUserGroup=gtUserGroup, gtUserTable=gtUserTable, gtWebProtocol=gtWebProtocol, gtSLAExpires=gtSLAExpires, gtTrapComString=gtTrapComString, gtBackupSFTPFilename=gtBackupSFTPFilename, gtAgentSecurityLevel=gtAgentSecurityLevel, gtTrapUser=gtTrapUser, gtSettingsNotifications=gtSettingsNotifications, gtNetworkIGMPSnoopingState=gtNetworkIGMPSnoopingState, gtTrapPDU=gtTrapPDU, gtTrapDestPort=gtTrapDestPort, gtSFTPPort=gtSFTPPort, gtBackupSFTPServer=gtBackupSFTPServer, gtIGMPLastMemberQueryCount=gtIGMPLastMemberQueryCount, gtInterfaceMAC=gtInterfaceMAC, gtDaylightAdjustment=gtDaylightAdjustment, gtTrapDestRowStatus=gtTrapDestRowStatus, gtPortsName=gtPortsName, gtUserParamIdx=gtUserParamIdx, gtSettingsObjects=gtSettingsObjects, gtNetworking=gtNetworking, gtSFTPServer=gtSFTPServer, gtSettingsMIB=gtSettingsMIB, gtTrapDestTable=gtTrapDestTable, gtInterfaceDHCPState=gtInterfaceDHCPState, gtServices=gtServices, gtSFPLink=gtSFPLink, gtNetworkPortNumber=gtNetworkPortNumber, gtInterfaceWebMgt=gtInterfaceWebMgt, gtTrapState=gtTrapState, gtSLARegistered=gtSLARegistered, gtNetworkIGMPQuerierIP=gtNetworkIGMPQuerierIP, gtServicesEntry=gtServicesEntry, gtPortsEntry=gtPortsEntry, gtUserName=gtUserName, gtAgentPort=gtAgentPort, gtInterfaceIPv4Gateway=gtInterfaceIPv4Gateway, gtInterfaceRowStatus=gtInterfaceRowStatus, gtDNSTable=gtDNSTable, gtSFPNumber=gtSFPNumber, gtSyslogState=gtSyslogState, gtHMSComMethod=gtHMSComMethod, gtUpdateControl=gtUpdateControl, gtNetworkTable=gtNetworkTable, PYSNMP_MODULE_ID=gtSettingsMIB, gtTrapDestEntry=gtTrapDestEntry, gtDNSNumber=gtDNSNumber, gtCurrentUserPassword=gtCurrentUserPassword, gtSyslogEntry=gtSyslogEntry, gtInterfaceState=gtInterfaceState, gtHMSNumMembers=gtHMSNumMembers, gtModuleBackup=gtModuleBackup, gtGroupRights=gtGroupRights, gtAccesslistIdx=gtAccesslistIdx, gtNTPServerRowStatus=gtNTPServerRowStatus, gtModuleRedundancyMode=gtModuleRedundancyMode, gtFilename=gtFilename, gtIGMPQuerierResponseTime=gtIGMPQuerierResponseTime, gtSFPPlugged=gtSFPPlugged, gtUserAccesslist=gtUserAccesslist, gtUserAuthEnabled=gtUserAuthEnabled, gtUserEntry=gtUserEntry, gtBackupStatus=gtBackupStatus, gtAgentComReadString=gtAgentComReadString, gtSettingsGroups=gtSettingsGroups, gtUserIdx=gtUserIdx, gtUserAuthTable=gtUserAuthTable, gtInterfaceTable=gtInterfaceTable, gtAccesslistIPRange=gtAccesslistIPRange, gtPortsLinkup=gtPortsLinkup, gtHMSTable=gtHMSTable, gtSFPEntry=gtSFPEntry, gtTimeLocal=gtTimeLocal, gtSettingsCompliances=gtSettingsCompliances, gtSWOptionsEntry=gtSWOptionsEntry, gtUpdateFilesTable=gtUpdateFilesTable, gtUpdateFilesEntry=gtUpdateFilesEntry, gtSFPType=gtSFPType, gtGroupTable=gtGroupTable, gtGroupAccesslist=gtGroupAccesslist, gtSLAEntry=gtSLAEntry, gtPortsBitrateReceive=gtPortsBitrateReceive, gtInterfaceUseVLAN=gtInterfaceUseVLAN, gtDNSServerIP=gtDNSServerIP, gtSFTPHostPublicKeyMD5=gtSFTPHostPublicKeyMD5, gtSettingsConformance=gtSettingsConformance, gtPortsTable=gtPortsTable, gtInterfaceSNMP=gtInterfaceSNMP, gtInterfaceStreaming=gtInterfaceStreaming, gtDateAndTimeTable=gtDateAndTimeTable, gtInterfaceIGMP=gtInterfaceIGMP, gtTrapSNMPVersion=gtTrapSNMPVersion, gtModuleBackupEntry=gtModuleBackupEntry, gtModuleUpdate=gtModuleUpdate, gtInterfaceName=gtInterfaceName, gtTrapDestNumber=gtTrapDestNumber, gtIGMPQueryStartupCount=gtIGMPQueryStartupCount, gtBackupControl=gtBackupControl, gtUpdateFilesTableIdx=gtUpdateFilesTableIdx, gtInterfaceIPv4=gtInterfaceIPv4, gtSNMP=gtSNMP, gtNetworkVLAN=gtNetworkVLAN, gtModuleBackupDate=gtModuleBackupDate, gtUpdateFile=gtUpdateFile, gtUserAuthEntry=gtUserAuthEntry, gtSyslogTable=gtSyslogTable, gtSettingsNotifyInterfaceChanged=gtSettingsNotifyInterfaceChanged, gtNetworkPortsTable=gtNetworkPortsTable, gtSWOptionsIdx=gtSWOptionsIdx, gtDNSEntry=gtDNSEntry, gtInterfaceVLAN=gtInterfaceVLAN, gtUserPassword=gtUserPassword, gtModuleRedundancyGroup=gtModuleRedundancyGroup, gtSyslogIP=gtSyslogIP, gtHeadendSystemManagement=gtHeadendSystemManagement, gtSFPSpeed=gtSFPSpeed, gtGroupName=gtGroupName, gtTrapSecurityLevel=gtTrapSecurityLevel, gtDateAndTime=gtDateAndTime, gtSFTPUsername=gtSFTPUsername, gtAgentState=gtAgentState, gtNTPServerEntry=gtNTPServerEntry, gtSettingsNotifyWebChanged=gtSettingsNotifyWebChanged, gtChassisRedundancy=gtChassisRedundancy, gtWebEnable=gtWebEnable, gtServicesTable=gtServicesTable, gtWebAuth=gtWebAuth, gtBackupSFTPHostPublicKeyMD5=gtBackupSFTPHostPublicKeyMD5, gtPortsBitrateTransmit=gtPortsBitrateTransmit, gtNetworkName=gtNetworkName, gtNTPServerTable=gtNTPServerTable, gtAccesslistTable=gtAccesslistTable, gtIGMPQueryStartupInterval=gtIGMPQueryStartupInterval, gtBackupSFTPPassword=gtBackupSFTPPassword, gtSLATable=gtSLATable, gtHMSEntry=gtHMSEntry, gtHMSNumAvailModules=gtHMSNumAvailModules, gtInterfaceCLI=gtInterfaceCLI, gtTimeUTC=gtTimeUTC, gtModuleBackupTable=gtModuleBackupTable, gtHMSGroupName=gtHMSGroupName, gtTimeZone=gtTimeZone, gtNetworkEntry=gtNetworkEntry, gtNetworkPortVLAN=gtNetworkPortVLAN, gtDateAndTimeEntry=gtDateAndTimeEntry, gtInterfaceNumber=gtInterfaceNumber, gtNTPServerNumber=gtNTPServerNumber, gtAccesslistParamIdx=gtAccesslistParamIdx, gtUserRowStatus=gtUserRowStatus, gtCurrentTimeSource=gtCurrentTimeSource, gtGeneral=gtGeneral, gtBackupPrivateKeyFilename=gtBackupPrivateKeyFilename, gtSFPTable=gtSFPTable, gtIGMPLastMemberQueryInterval=gtIGMPLastMemberQueryInterval, gtAgentComWriteString=gtAgentComWriteString, gtNetworkPortState=gtNetworkPortState, gtBackupSFTPUsername=gtBackupSFTPUsername, gtInterfaceIPv4Mask=gtInterfaceIPv4Mask, gtNetworkPortName=gtNetworkPortName, gtIGMPQueryInterval=gtIGMPQueryInterval, gtSWOption=gtSWOption, gtSNMPTable=gtSNMPTable, gtBackupSFTPPort=gtBackupSFTPPort, gtGroupParamIdx=gtGroupParamIdx, gtPortsNumber=gtPortsNumber, gtAccesslistName=gtAccesslistName, gtUpdateStatus=gtUpdateStatus, gtNetworkPortsEntry=gtNetworkPortsEntry, gtNumSFP=gtNumSFP, gtIGMPQuerierVersion=gtIGMPQuerierVersion, gtAccesslistEntry=gtAccesslistEntry, gtInterfaceIfIndex=gtInterfaceIfIndex, gtTrapDestIP=gtTrapDestIP, gtNTPServerAddress=gtNTPServerAddress, gtInterfaceEntry=gtInterfaceEntry, gtIGMPQuerierRobustness=gtIGMPQuerierRobustness, gtSWOptionsTable=gtSWOptionsTable)
