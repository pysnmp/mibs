...
AcmModulationT, EthPortMode, TimeZoneT, VlanStatusT, VlanGroupT, Te1LoopBackModeT, ExaltEnableT, EthMainStatusT, FileTransferTypeT, AlarmLevelT, exaltcommunications, AuxNmsMode, Te1LineCodeT, NtpClientEnableT, EnableStatusT, Led4ColorT, Te1LboT, FileTransferStartT, Te1StatusT, EthAuxStatusT = mibBuilder.importSymbols("ExaltComm", "AcmModulationT", "EthPortMode", "TimeZoneT", "VlanStatusT", "VlanGroupT", "Te1LoopBackModeT", "ExaltEnableT", "EthMainStatusT", "FileTransferTypeT", "AlarmLevelT", "exaltcommunications", "AuxNmsMode", "Te1LineCodeT", "NtpClientEnableT", "EnableStatusT", "Led4ColorT", "Te1LboT", "FileTransferStartT", "Te1StatusT", "EthAuxStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", te1LoopBackMode=te1LoopBackMode, locSysAlarms=locSysAlarms, trapv1Enable=trapv1Enable, locMaximumTxModulation=locMaximumTxModulation, remCurrentBER=remCurrentBER, radioConfig=radioConfig, remLinkStateH=remLinkStateH, te1Interfaces=te1Interfaces, locTe1Alarms=locTe1Alarms, ipAddress=ipAddress, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locCurrentTemp=locCurrentTemp, locCurrentBER=locCurrentBER, locErrorDuration=locErrorDuration, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, remSampleDuration=remSampleDuration, locSampleDurationStr=locSampleDurationStr, remTe1AlarmsEntry=remTe1AlarmsEntry, productsMIBGroups=productsMIBGroups, remTempAlarm=remTempAlarm, locTempAlarm=locTempAlarm, locMaxRSL=locMaxRSL, radioAdmin=radioAdmin, t1LBO=t1LBO, locCurrentRSL=locCurrentRSL, commitNtpSettings=commitNtpSettings, ntpServer4IpAddr=ntpServer4IpAddr, remErrorDuration=remErrorDuration, aesKey=aesKey, ipAddressNetmask=ipAddressNetmask, defaultGateway=defaultGateway, trapLocRslThreshold=trapLocRslThreshold, te1AIS=te1AIS, locMinRSLstr=locMinRSLstr, radioMonitor=radioMonitor, aesEnable=aesEnable, productsMIB=productsMIB, remUnavailDuration=remUnavailDuration, radioInfo=radioInfo, userPassword=userPassword, factoryFwFilename=factoryFwFilename, remResetStats=remResetStats, perfRemote=perfRemote, outboundEthernetThroughput=outboundEthernetThroughput, locLinkStateH=locLinkStateH, locMinRSL=locMinRSL, te1NumChannels=te1NumChannels, locUnavailDurationStr=locUnavailDurationStr, transferType=transferType, rnLocal=rnLocal, trapRemAlarmStat=trapRemAlarmStat, selectT1orE1=selectT1orE1, sysTime=sysTime, ipRemote=ipRemote, performance=performance, productsMIBCompliances=productsMIBCompliances, productsMIBConformance=productsMIBConformance, trapIpaddr1=trapIpaddr1, rdkDbVer=rdkDbVer, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, ntpTimeZoneSelect=ntpTimeZoneSelect, remCurrentBERstr=remCurrentBERstr, almRemote=almRemote, locActiveTxModulation=locActiveTxModulation, locEthUtilizationWatermark=locEthUtilizationWatermark, locMinimumTxModulation=locMinimumTxModulation, remErrorDurationStr=remErrorDurationStr, trapReboot=trapReboot, commitAdminSettings=commitAdminSettings, productsAllObjects=productsAllObjects, snmpConfig=snmpConfig, remTE1Alarms=remTE1Alarms, locCurrentRSLstr=locCurrentRSLstr, te1=te1, locCurrentTempS=locCurrentTempS, locTe1LinkSummary=locTe1LinkSummary, trapv3Enable=trapv3Enable, trapIpaddr3=trapIpaddr3, rxFreqRange=rxFreqRange, perfLocal=perfLocal, interfaceType=interfaceType, remLinkStateV=remLinkStateV, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, transferStatus=transferStatus, locEthUtilizationOut=locEthUtilizationOut, locErrorDurationStr=locErrorDurationStr, alternateFwFilename=alternateFwFilename, remLinkSecMismatch=remLinkSecMismatch, ntpServer2IpAddr=ntpServer2IpAddr, trapLocLinkStat=trapLocLinkStat, locTe1AlarmsEntry=locTe1AlarmsEntry, locResetStats=locResetStats, aggregateUserThroughput=aggregateUserThroughput, locMinimumRxModulation=locMinimumRxModulation, remCurrentRSLstr=remCurrentRSLstr, locEthSpeed=locEthSpeed, ntpServer1IpAddr=ntpServer1IpAddr, locSampleDuration=locSampleDuration, rnRemote=rnRemote, modelName=modelName, trapIpaddrEnable4=trapIpaddrEnable4, locEthPerfInterfaces=locEthPerfInterfaces, locLinkStateV=locLinkStateV, PYSNMP_MODULE_ID=productsMIB, trapLocAlarmStat=trapLocAlarmStat, serialNumber=serialNumber, interface=interface, remTe1LinkSummary=remTe1LinkSummary, uploadFilename=uploadFilename, locEthAlarms=locEthAlarms, rfFreqBand=rfFreqBand, linkName=linkName, ntpClientEnable=ntpClientEnable, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, remMaxRSL=remMaxRSL, inboundEthernetThroughput=inboundEthernetThroughput, commitSystemSettings=commitSystemSettings, swapFWimage=swapFWimage, locMinRSLtimestamp=locMinRSLtimestamp, te1NumActiveChannels=te1NumActiveChannels, remCurrentTemp=remCurrentTemp, ntp=ntp, trapIpaddrEnable3=trapIpaddrEnable3, remMaxRSLstr=remMaxRSLstr, systemConfig=systemConfig, almLocal=almLocal, locLinkSecMismatch=locLinkSecMismatch, bootVersion=bootVersion, remTe1Alarm=remTe1Alarm, remTe1Alarms=remTe1Alarms, remMinRSL=remMinRSL, ipLocal=ipLocal, commitTe1Settings=commitTe1Settings, PwType=PwType, radioName=radioName, subnetMask=subnetMask, commitSnmpSettings=commitSnmpSettings, locTe1Alarm=locTe1Alarm, trapLocRslStat=trapLocRslStat, transferStart=transferStart, firmwareVersion=firmwareVersion, trapAuth=trapAuth, trapLocTempStat=trapLocTempStat, remSampleDurationStr=remSampleDurationStr, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, trapIpaddr4=trapIpaddr4, ntpServer3IpAddr=ntpServer3IpAddr, remEthAlarms=remEthAlarms, trapIpaddr2=trapIpaddr2, remMinRSLstr=remMinRSLstr, txFreqRange=txFreqRange, fileManagement=fileManagement, fileTransfer=fileTransfer, te1Interface=te1Interface, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, t1LineCode=t1LineCode, locMaxRSLstr=locMaxRSLstr, hwId=hwId, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, userThroughput=userThroughput, remUnavailDurationStr=remUnavailDurationStr, locLinkState=locLinkState, locTE1Alarms=locTE1Alarms, alarms=alarms, sysDate=sysDate, adminPassword=adminPassword, licenseFeatures=licenseFeatures, radioReboot=radioReboot, productsMIBNotifications=productsMIBNotifications, remCurrentRSL=remCurrentRSL, locEthUtilizationIn=locEthUtilizationIn, locCurrentBERstr=locCurrentBERstr, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remSysAlarms=remSysAlarms, partNumber=partNumber, locMaximumRxModulation=locMaximumRxModulation, linkSecKey=linkSecKey, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, remMinRSLtimestamp=remMinRSLtimestamp, licKey=licKey, remLinkState=remLinkState, locUnavailDuration=locUnavailDuration, currentFwFilename=currentFwFilename, modelNumber=modelNumber, locActiveRxModulation=locActiveRxModulation, trapIpaddrEnable1=trapIpaddrEnable1, te1Status=te1Status, productsMIBObjects=productsMIBObjects, trapv2cEnable=trapv2cEnable, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remCurrentTempS=remCurrentTempS, trapIpaddrEnable2=trapIpaddrEnable2, tftpServerIp=tftpServerIp)
