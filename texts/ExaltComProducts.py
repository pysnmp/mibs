...
TimeZoneT, EnableStatusT, EthAuxStatusT, ExaltEnableT, Te1StatusT, AcmModulationT, Te1LboT, FileTransferStartT, NtpClientEnableT, FileTransferTypeT, Te1LoopBackModeT, VlanGroupT, VlanStatusT, AuxNmsMode, AlarmLevelT, exaltcommunications, Led4ColorT, Te1LineCodeT, EthPortMode, EthMainStatusT = mibBuilder.importSymbols("ExaltComm", "TimeZoneT", "EnableStatusT", "EthAuxStatusT", "ExaltEnableT", "Te1StatusT", "AcmModulationT", "Te1LboT", "FileTransferStartT", "NtpClientEnableT", "FileTransferTypeT", "Te1LoopBackModeT", "VlanGroupT", "VlanStatusT", "AuxNmsMode", "AlarmLevelT", "exaltcommunications", "Led4ColorT", "Te1LineCodeT", "EthPortMode", "EthMainStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", modelNumber=modelNumber, snmpConfig=snmpConfig, locTempAlarm=locTempAlarm, remLinkStateV=remLinkStateV, ntpTimeZoneSelect=ntpTimeZoneSelect, remTE1Alarms=remTE1Alarms, ipRemote=ipRemote, locErrorDurationStr=locErrorDurationStr, remLinkState=remLinkState, userPassword=userPassword, locTe1LinkSummary=locTe1LinkSummary, locSysAlarms=locSysAlarms, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remSysAlarms=remSysAlarms, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, alternateFwFilename=alternateFwFilename, locActiveTxModulation=locActiveTxModulation, subnetMask=subnetMask, trapv3Enable=trapv3Enable, uploadFilename=uploadFilename, trapLocAlarmStat=trapLocAlarmStat, trapv1Enable=trapv1Enable, trapIpaddr3=trapIpaddr3, factoryFwFilename=factoryFwFilename, remCurrentTemp=remCurrentTemp, rxFreqRange=rxFreqRange, aesEnable=aesEnable, linkSecKey=linkSecKey, locLinkStateV=locLinkStateV, locTe1AlarmsEntry=locTe1AlarmsEntry, remLinkSecMismatch=remLinkSecMismatch, locMaximumRxModulation=locMaximumRxModulation, remResetStats=remResetStats, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, licenseFeatures=licenseFeatures, adminPassword=adminPassword, trapLocTempStat=trapLocTempStat, locMaxRSL=locMaxRSL, locEthPerfInterfaces=locEthPerfInterfaces, locEthUtilizationOut=locEthUtilizationOut, remErrorDuration=remErrorDuration, remCurrentRSL=remCurrentRSL, commitTe1Settings=commitTe1Settings, locTe1Alarm=locTe1Alarm, remCurrentBER=remCurrentBER, interface=interface, radioMonitor=radioMonitor, remCurrentRSLstr=remCurrentRSLstr, aggregateUserThroughput=aggregateUserThroughput, radioAdmin=radioAdmin, licKey=licKey, modelName=modelName, transferStatus=transferStatus, locCurrentRSL=locCurrentRSL, t1LineCode=t1LineCode, te1LoopBackMode=te1LoopBackMode, locMinRSL=locMinRSL, trapReboot=trapReboot, partNumber=partNumber, locCurrentTempS=locCurrentTempS, bootVersion=bootVersion, productsMIBObjects=productsMIBObjects, trapLocRslStat=trapLocRslStat, outboundEthernetThroughput=outboundEthernetThroughput, trapIpaddr1=trapIpaddr1, almRemote=almRemote, rfFreqBand=rfFreqBand, performance=performance, ntp=ntp, productsMIBConformance=productsMIBConformance, PYSNMP_MODULE_ID=productsMIB, locUnavailDurationStr=locUnavailDurationStr, trapv2cEnable=trapv2cEnable, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, trapIpaddrEnable2=trapIpaddrEnable2, remCurrentTempS=remCurrentTempS, commitNtpSettings=commitNtpSettings, trapIpaddrEnable3=trapIpaddrEnable3, remTe1Alarm=remTe1Alarm, productsMIBCompliances=productsMIBCompliances, commitSystemSettings=commitSystemSettings, locResetStats=locResetStats, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, defaultGateway=defaultGateway, locLinkSecMismatch=locLinkSecMismatch, radioConfig=radioConfig, trapIpaddrEnable4=trapIpaddrEnable4, productsMIB=productsMIB, locEthUtilizationIn=locEthUtilizationIn, locMinimumTxModulation=locMinimumTxModulation, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locMaxRSLstr=locMaxRSLstr, locSampleDurationStr=locSampleDurationStr, systemConfig=systemConfig, radioReboot=radioReboot, serialNumber=serialNumber, remErrorDurationStr=remErrorDurationStr, ipAddress=ipAddress, ntpServer2IpAddr=ntpServer2IpAddr, locSampleDuration=locSampleDuration, te1Interface=te1Interface, rnLocal=rnLocal, remSampleDuration=remSampleDuration, currentFwFilename=currentFwFilename, locLinkStateH=locLinkStateH, trapIpaddrEnable1=trapIpaddrEnable1, locEthUtilizationWatermark=locEthUtilizationWatermark, remTe1LinkSummary=remTe1LinkSummary, aesKey=aesKey, swapFWimage=swapFWimage, fileManagement=fileManagement, perfLocal=perfLocal, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, remMinRSLtimestamp=remMinRSLtimestamp, ntpServer3IpAddr=ntpServer3IpAddr, ntpServer1IpAddr=ntpServer1IpAddr, locEthAlarms=locEthAlarms, te1NumChannels=te1NumChannels, trapLocLinkStat=trapLocLinkStat, transferStart=transferStart, trapIpaddr4=trapIpaddr4, remSampleDurationStr=remSampleDurationStr, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locMinimumRxModulation=locMinimumRxModulation, productsMIBGroups=productsMIBGroups, commitAdminSettings=commitAdminSettings, locTe1Alarms=locTe1Alarms, remTempAlarm=remTempAlarm, sysTime=sysTime, remEthAlarms=remEthAlarms, inboundEthernetThroughput=inboundEthernetThroughput, te1Interfaces=te1Interfaces, selectT1orE1=selectT1orE1, locCurrentTemp=locCurrentTemp, radioName=radioName, radioInfo=radioInfo, hwId=hwId, locLinkState=locLinkState, ipLocal=ipLocal, alarms=alarms, ntpServer4IpAddr=ntpServer4IpAddr, remUnavailDurationStr=remUnavailDurationStr, remMinRSLstr=remMinRSLstr, locEthSpeed=locEthSpeed, trapAuth=trapAuth, linkName=linkName, locMaximumTxModulation=locMaximumTxModulation, remMaxRSLstr=remMaxRSLstr, locMinRSLstr=locMinRSLstr, te1=te1, PwType=PwType, locUnavailDuration=locUnavailDuration, t1LBO=t1LBO, commitSnmpSettings=commitSnmpSettings, rdkDbVer=rdkDbVer, locErrorDuration=locErrorDuration, locCurrentBERstr=locCurrentBERstr, productsMIBNotifications=productsMIBNotifications, perfRemote=perfRemote, remMinRSL=remMinRSL, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, userThroughput=userThroughput, ntpClientEnable=ntpClientEnable, remTe1AlarmsEntry=remTe1AlarmsEntry, almLocal=almLocal, te1Status=te1Status, te1NumActiveChannels=te1NumActiveChannels, remCurrentBERstr=remCurrentBERstr, trapRemAlarmStat=trapRemAlarmStat, remLinkStateH=remLinkStateH, remMaxRSL=remMaxRSL, transferType=transferType, ipAddressNetmask=ipAddressNetmask, locMinRSLtimestamp=locMinRSLtimestamp, trapLocRslThreshold=trapLocRslThreshold, te1AIS=te1AIS, locTE1Alarms=locTE1Alarms, productsAllObjects=productsAllObjects, locCurrentRSLstr=locCurrentRSLstr, interfaceType=interfaceType, trapIpaddr2=trapIpaddr2, remUnavailDuration=remUnavailDuration, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, firmwareVersion=firmwareVersion, locCurrentBER=locCurrentBER, remTe1Alarms=remTe1Alarms, txFreqRange=txFreqRange, locActiveRxModulation=locActiveRxModulation, sysDate=sysDate, tftpServerIp=tftpServerIp, fileTransfer=fileTransfer, rnRemote=rnRemote)
