...
EnableStatusT, AcmModulationT, EthPortMode, FileTransferStartT, Te1LoopBackModeT, EthAuxStatusT, Te1LineCodeT, Te1StatusT, Led4ColorT, TimeZoneT, EthMainStatusT, VlanStatusT, exaltcommunications, AlarmLevelT, Te1LboT, ExaltEnableT, AuxNmsMode, FileTransferTypeT, NtpClientEnableT, VlanGroupT = mibBuilder.importSymbols("ExaltComm", "EnableStatusT", "AcmModulationT", "EthPortMode", "FileTransferStartT", "Te1LoopBackModeT", "EthAuxStatusT", "Te1LineCodeT", "Te1StatusT", "Led4ColorT", "TimeZoneT", "EthMainStatusT", "VlanStatusT", "exaltcommunications", "AlarmLevelT", "Te1LboT", "ExaltEnableT", "AuxNmsMode", "FileTransferTypeT", "NtpClientEnableT", "VlanGroupT")
...
mibBuilder.exportSymbols("ExaltComProducts", locActiveRxModulation=locActiveRxModulation, te1Interface=te1Interface, firmwareVersion=firmwareVersion, transferType=transferType, trapv2cEnable=trapv2cEnable, aesKey=aesKey, inboundEthernetThroughput=inboundEthernetThroughput, locMinRSLtimestamp=locMinRSLtimestamp, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, locMinRSL=locMinRSL, locTempAlarm=locTempAlarm, rnRemote=rnRemote, tftpServerIp=tftpServerIp, locLinkStateH=locLinkStateH, performance=performance, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, ntpServer2IpAddr=ntpServer2IpAddr, productsMIBCompliances=productsMIBCompliances, remLinkStateV=remLinkStateV, almRemote=almRemote, locCurrentBER=locCurrentBER, remLinkSecMismatch=remLinkSecMismatch, modelName=modelName, aesEnable=aesEnable, t1LineCode=t1LineCode, radioReboot=radioReboot, te1LoopBackMode=te1LoopBackMode, remCurrentRSLstr=remCurrentRSLstr, remResetStats=remResetStats, commitSystemSettings=commitSystemSettings, locTe1LinkSummary=locTe1LinkSummary, remMinRSLtimestamp=remMinRSLtimestamp, remSampleDurationStr=remSampleDurationStr, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locEthUtilizationWatermark=locEthUtilizationWatermark, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remMaxRSL=remMaxRSL, remLinkStateH=remLinkStateH, systemConfig=systemConfig, txFreqRange=txFreqRange, trapIpaddr4=trapIpaddr4, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, trapIpaddr2=trapIpaddr2, locLinkStateV=locLinkStateV, transferStatus=transferStatus, outboundEthernetThroughput=outboundEthernetThroughput, locMinimumTxModulation=locMinimumTxModulation, productsMIB=productsMIB, serialNumber=serialNumber, linkName=linkName, remTE1Alarms=remTE1Alarms, locErrorDurationStr=locErrorDurationStr, trapIpaddr1=trapIpaddr1, commitAdminSettings=commitAdminSettings, trapIpaddrEnable1=trapIpaddrEnable1, remCurrentBER=remCurrentBER, swapFWimage=swapFWimage, uploadFilename=uploadFilename, t1LBO=t1LBO, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, licenseFeatures=licenseFeatures, locMinimumRxModulation=locMinimumRxModulation, ntpClientEnable=ntpClientEnable, productsMIBNotifications=productsMIBNotifications, locSysAlarms=locSysAlarms, locEthAlarms=locEthAlarms, ipAddress=ipAddress, trapv3Enable=trapv3Enable, locLinkSecMismatch=locLinkSecMismatch, interface=interface, linkSecKey=linkSecKey, locActiveTxModulation=locActiveTxModulation, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, adminPassword=adminPassword, commitNtpSettings=commitNtpSettings, interfaceType=interfaceType, locTE1Alarms=locTE1Alarms, locEthPerfInterfaces=locEthPerfInterfaces, remTempAlarm=remTempAlarm, ipLocal=ipLocal, te1Interfaces=te1Interfaces, te1NumActiveChannels=te1NumActiveChannels, trapLocRslThreshold=trapLocRslThreshold, fileTransfer=fileTransfer, commitTe1Settings=commitTe1Settings, licKey=licKey, ntpTimeZoneSelect=ntpTimeZoneSelect, remTe1LinkSummary=remTe1LinkSummary, rdkDbVer=rdkDbVer, locMaximumRxModulation=locMaximumRxModulation, aggregateUserThroughput=aggregateUserThroughput, bootVersion=bootVersion, sysTime=sysTime, fileManagement=fileManagement, te1=te1, locResetStats=locResetStats, locUnavailDurationStr=locUnavailDurationStr, remLinkState=remLinkState, sysDate=sysDate, locErrorDuration=locErrorDuration, ntpServer4IpAddr=ntpServer4IpAddr, hwId=hwId, locMaximumTxModulation=locMaximumTxModulation, trapAuth=trapAuth, PwType=PwType, remMaxRSLstr=remMaxRSLstr, te1AIS=te1AIS, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, remEthAlarms=remEthAlarms, commitSnmpSettings=commitSnmpSettings, remTe1Alarm=remTe1Alarm, remUnavailDuration=remUnavailDuration, locCurrentRSL=locCurrentRSL, locSampleDuration=locSampleDuration, locEthSpeed=locEthSpeed, userPassword=userPassword, currentFwFilename=currentFwFilename, radioName=radioName, locMaxRSLstr=locMaxRSLstr, PYSNMP_MODULE_ID=productsMIB, alarms=alarms, ipAddressNetmask=ipAddressNetmask, te1NumChannels=te1NumChannels, perfRemote=perfRemote, locCurrentRSLstr=locCurrentRSLstr, remTe1AlarmsEntry=remTe1AlarmsEntry, locMinRSLstr=locMinRSLstr, radioInfo=radioInfo, ipRemote=ipRemote, trapLocAlarmStat=trapLocAlarmStat, selectT1orE1=selectT1orE1, trapv1Enable=trapv1Enable, trapIpaddrEnable3=trapIpaddrEnable3, locCurrentTempS=locCurrentTempS, locLinkState=locLinkState, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, remErrorDurationStr=remErrorDurationStr, trapIpaddrEnable2=trapIpaddrEnable2, radioConfig=radioConfig, perfLocal=perfLocal, productsAllObjects=productsAllObjects, trapIpaddr3=trapIpaddr3, trapLocTempStat=trapLocTempStat, remTe1Alarms=remTe1Alarms, rfFreqBand=rfFreqBand, remSysAlarms=remSysAlarms, remCurrentTemp=remCurrentTemp, remUnavailDurationStr=remUnavailDurationStr, productsMIBGroups=productsMIBGroups, locSampleDurationStr=locSampleDurationStr, ntpServer1IpAddr=ntpServer1IpAddr, trapLocRslStat=trapLocRslStat, partNumber=partNumber, remMinRSL=remMinRSL, locTe1Alarm=locTe1Alarm, userThroughput=userThroughput, trapRemAlarmStat=trapRemAlarmStat, ntpServer3IpAddr=ntpServer3IpAddr, locEthUtilizationOut=locEthUtilizationOut, trapLocLinkStat=trapLocLinkStat, defaultGateway=defaultGateway, trapReboot=trapReboot, remErrorDuration=remErrorDuration, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remMinRSLstr=remMinRSLstr, ntp=ntp, subnetMask=subnetMask, locEthUtilizationIn=locEthUtilizationIn, locUnavailDuration=locUnavailDuration, locMaxRSL=locMaxRSL, snmpConfig=snmpConfig, remCurrentTempS=remCurrentTempS, te1Status=te1Status, rxFreqRange=rxFreqRange, alternateFwFilename=alternateFwFilename, remSampleDuration=remSampleDuration, productsMIBConformance=productsMIBConformance, transferStart=transferStart, trapIpaddrEnable4=trapIpaddrEnable4, locCurrentTemp=locCurrentTemp, almLocal=almLocal, remCurrentBERstr=remCurrentBERstr, remCurrentRSL=remCurrentRSL, locTe1Alarms=locTe1Alarms, radioMonitor=radioMonitor, locCurrentBERstr=locCurrentBERstr, modelNumber=modelNumber, radioAdmin=radioAdmin, productsMIBObjects=productsMIBObjects, locTe1AlarmsEntry=locTe1AlarmsEntry, rnLocal=rnLocal, factoryFwFilename=factoryFwFilename)
