...
TimeZoneT, AuxNmsMode, Te1LoopBackModeT, VlanGroupT, AcmModulationT, Te1LboT, Te1LineCodeT, Te1StatusT, EthPortMode, EnableStatusT, EthAuxStatusT, EthMainStatusT, Led4ColorT, FileTransferStartT, AlarmLevelT, ExaltEnableT, VlanStatusT, exaltcommunications, FileTransferTypeT, NtpClientEnableT = mibBuilder.importSymbols("ExaltComm", "TimeZoneT", "AuxNmsMode", "Te1LoopBackModeT", "VlanGroupT", "AcmModulationT", "Te1LboT", "Te1LineCodeT", "Te1StatusT", "EthPortMode", "EnableStatusT", "EthAuxStatusT", "EthMainStatusT", "Led4ColorT", "FileTransferStartT", "AlarmLevelT", "ExaltEnableT", "VlanStatusT", "exaltcommunications", "FileTransferTypeT", "NtpClientEnableT")
...
mibBuilder.exportSymbols("ExaltComProducts", te1Status=te1Status, locEthUtilizationIn=locEthUtilizationIn, locCurrentRSL=locCurrentRSL, trapLocAlarmStat=trapLocAlarmStat, remSampleDuration=remSampleDuration, rnLocal=rnLocal, ntpTimeZoneSelect=ntpTimeZoneSelect, inboundEthernetThroughput=inboundEthernetThroughput, locMaxRSL=locMaxRSL, trapRemAlarmStat=trapRemAlarmStat, rxFreqRange=rxFreqRange, perfRemote=perfRemote, remTe1AlarmsEntry=remTe1AlarmsEntry, ntpServer2IpAddr=ntpServer2IpAddr, trapIpaddr3=trapIpaddr3, locMinimumRxModulation=locMinimumRxModulation, locCurrentTemp=locCurrentTemp, outboundEthernetThroughput=outboundEthernetThroughput, locMinRSLstr=locMinRSLstr, remTE1Alarms=remTE1Alarms, currentFwFilename=currentFwFilename, uploadFilename=uploadFilename, partNumber=partNumber, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, commitAdminSettings=commitAdminSettings, radioAdmin=radioAdmin, productsMIBConformance=productsMIBConformance, locMaximumTxModulation=locMaximumTxModulation, alarms=alarms, remCurrentRSL=remCurrentRSL, trapAuth=trapAuth, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, te1AIS=te1AIS, PYSNMP_MODULE_ID=productsMIB, remErrorDuration=remErrorDuration, locErrorDuration=locErrorDuration, fileManagement=fileManagement, locEthAlarms=locEthAlarms, firmwareVersion=firmwareVersion, radioMonitor=radioMonitor, licenseFeatures=licenseFeatures, locCurrentRSLstr=locCurrentRSLstr, userThroughput=userThroughput, te1Interfaces=te1Interfaces, trapIpaddrEnable1=trapIpaddrEnable1, ntpServer4IpAddr=ntpServer4IpAddr, snmpConfig=snmpConfig, ntpServer1IpAddr=ntpServer1IpAddr, ntpClientEnable=ntpClientEnable, locLinkStateV=locLinkStateV, remSysAlarms=remSysAlarms, factoryFwFilename=factoryFwFilename, locMaximumRxModulation=locMaximumRxModulation, remCurrentBER=remCurrentBER, locTempAlarm=locTempAlarm, remMinRSL=remMinRSL, ntpServer3IpAddr=ntpServer3IpAddr, locSampleDurationStr=locSampleDurationStr, selectT1orE1=selectT1orE1, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, trapv2cEnable=trapv2cEnable, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remUnavailDurationStr=remUnavailDurationStr, remMaxRSLstr=remMaxRSLstr, perfLocal=perfLocal, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, aesKey=aesKey, locCurrentBERstr=locCurrentBERstr, remLinkState=remLinkState, locTe1AlarmsEntry=locTe1AlarmsEntry, locMaxRSLstr=locMaxRSLstr, txFreqRange=txFreqRange, ntp=ntp, linkSecKey=linkSecKey, commitNtpSettings=commitNtpSettings, locSysAlarms=locSysAlarms, rfFreqBand=rfFreqBand, aggregateUserThroughput=aggregateUserThroughput, t1LineCode=t1LineCode, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remErrorDurationStr=remErrorDurationStr, commitSnmpSettings=commitSnmpSettings, locLinkState=locLinkState, remTe1Alarms=remTe1Alarms, locTE1Alarms=locTE1Alarms, adminPassword=adminPassword, rdkDbVer=rdkDbVer, remSampleDurationStr=remSampleDurationStr, te1LoopBackMode=te1LoopBackMode, productsMIBCompliances=productsMIBCompliances, radioName=radioName, aesEnable=aesEnable, productsMIBGroups=productsMIBGroups, ipRemote=ipRemote, trapIpaddr4=trapIpaddr4, locEthUtilizationWatermark=locEthUtilizationWatermark, modelName=modelName, trapIpaddrEnable3=trapIpaddrEnable3, fileTransfer=fileTransfer, tftpServerIp=tftpServerIp, remTe1Alarm=remTe1Alarm, radioInfo=radioInfo, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, te1Interface=te1Interface, ipAddress=ipAddress, licKey=licKey, trapReboot=trapReboot, trapIpaddr1=trapIpaddr1, te1=te1, trapLocRslStat=trapLocRslStat, locUnavailDuration=locUnavailDuration, remLinkStateH=remLinkStateH, sysTime=sysTime, almLocal=almLocal, remCurrentRSLstr=remCurrentRSLstr, transferStart=transferStart, locTe1LinkSummary=locTe1LinkSummary, almRemote=almRemote, locUnavailDurationStr=locUnavailDurationStr, subnetMask=subnetMask, systemConfig=systemConfig, trapIpaddrEnable2=trapIpaddrEnable2, defaultGateway=defaultGateway, trapLocTempStat=trapLocTempStat, userPassword=userPassword, locActiveTxModulation=locActiveTxModulation, interface=interface, t1LBO=t1LBO, trapv3Enable=trapv3Enable, remMinRSLstr=remMinRSLstr, te1NumChannels=te1NumChannels, remCurrentTemp=remCurrentTemp, bootVersion=bootVersion, productsMIBObjects=productsMIBObjects, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, radioConfig=radioConfig, locCurrentTempS=locCurrentTempS, PwType=PwType, remResetStats=remResetStats, interfaceType=interfaceType, locResetStats=locResetStats, locMinimumTxModulation=locMinimumTxModulation, sysDate=sysDate, remLinkSecMismatch=remLinkSecMismatch, remTempAlarm=remTempAlarm, hwId=hwId, ipLocal=ipLocal, remCurrentTempS=remCurrentTempS, trapLocLinkStat=trapLocLinkStat, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, locCurrentBER=locCurrentBER, performance=performance, locActiveRxModulation=locActiveRxModulation, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, productsAllObjects=productsAllObjects, trapIpaddrEnable4=trapIpaddrEnable4, remEthAlarms=remEthAlarms, locTe1Alarms=locTe1Alarms, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remMaxRSL=remMaxRSL, te1NumActiveChannels=te1NumActiveChannels, remUnavailDuration=remUnavailDuration, remMinRSLtimestamp=remMinRSLtimestamp, rnRemote=rnRemote, locSampleDuration=locSampleDuration, swapFWimage=swapFWimage, locTe1Alarm=locTe1Alarm, locMinRSL=locMinRSL, productsMIBNotifications=productsMIBNotifications, linkName=linkName, locEthUtilizationOut=locEthUtilizationOut, commitSystemSettings=commitSystemSettings, transferType=transferType, productsMIB=productsMIB, ipAddressNetmask=ipAddressNetmask, remTe1LinkSummary=remTe1LinkSummary, locEthSpeed=locEthSpeed, modelNumber=modelNumber, transferStatus=transferStatus, locEthPerfInterfaces=locEthPerfInterfaces, alternateFwFilename=alternateFwFilename, commitTe1Settings=commitTe1Settings, serialNumber=serialNumber, trapv1Enable=trapv1Enable, locMinRSLtimestamp=locMinRSLtimestamp, trapLocRslThreshold=trapLocRslThreshold, trapIpaddr2=trapIpaddr2, locErrorDurationStr=locErrorDurationStr, locLinkStateH=locLinkStateH, locLinkSecMismatch=locLinkSecMismatch, remLinkStateV=remLinkStateV, remCurrentBERstr=remCurrentBERstr, radioReboot=radioReboot)
