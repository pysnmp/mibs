...
EthPortMode, ExaltEnableT, AuxNmsMode, exaltcommunications, FileTransferTypeT, Te1StatusT, VlanGroupT, FileTransferStartT, Te1LoopBackModeT, Te1LineCodeT, VlanStatusT, AcmModulationT, EnableStatusT, NtpClientEnableT, TimeZoneT, Led4ColorT, EthMainStatusT, Te1LboT, AlarmLevelT, EthAuxStatusT = mibBuilder.importSymbols("ExaltComm", "EthPortMode", "ExaltEnableT", "AuxNmsMode", "exaltcommunications", "FileTransferTypeT", "Te1StatusT", "VlanGroupT", "FileTransferStartT", "Te1LoopBackModeT", "Te1LineCodeT", "VlanStatusT", "AcmModulationT", "EnableStatusT", "NtpClientEnableT", "TimeZoneT", "Led4ColorT", "EthMainStatusT", "Te1LboT", "AlarmLevelT", "EthAuxStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", aesEnable=aesEnable, locMinRSLstr=locMinRSLstr, ipAddressNetmask=ipAddressNetmask, alternateFwFilename=alternateFwFilename, locLinkStateH=locLinkStateH, commitSystemSettings=commitSystemSettings, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locActiveTxModulation=locActiveTxModulation, trapv3Enable=trapv3Enable, locTe1Alarms=locTe1Alarms, modelNumber=modelNumber, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, trapIpaddr2=trapIpaddr2, productsMIB=productsMIB, trapLocAlarmStat=trapLocAlarmStat, remCurrentTempS=remCurrentTempS, locMinRSL=locMinRSL, radioReboot=radioReboot, ntpServer1IpAddr=ntpServer1IpAddr, remResetStats=remResetStats, productsMIBObjects=productsMIBObjects, alarms=alarms, locEthUtilizationIn=locEthUtilizationIn, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, rxFreqRange=rxFreqRange, trapReboot=trapReboot, trapLocRslThreshold=trapLocRslThreshold, remMinRSLtimestamp=remMinRSLtimestamp, linkName=linkName, remLinkState=remLinkState, trapIpaddrEnable3=trapIpaddrEnable3, locCurrentBERstr=locCurrentBERstr, fileManagement=fileManagement, locCurrentRSL=locCurrentRSL, trapIpaddr3=trapIpaddr3, locMinimumRxModulation=locMinimumRxModulation, systemConfig=systemConfig, remCurrentTemp=remCurrentTemp, trapLocRslStat=trapLocRslStat, inboundEthernetThroughput=inboundEthernetThroughput, snmpConfig=snmpConfig, locMaxRSLstr=locMaxRSLstr, interface=interface, trapIpaddrEnable2=trapIpaddrEnable2, ipLocal=ipLocal, locCurrentRSLstr=locCurrentRSLstr, hwId=hwId, tftpServerIp=tftpServerIp, remTe1Alarms=remTe1Alarms, t1LBO=t1LBO, transferStatus=transferStatus, radioAdmin=radioAdmin, commitSnmpSettings=commitSnmpSettings, remLinkStateV=remLinkStateV, userPassword=userPassword, txFreqRange=txFreqRange, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, selectT1orE1=selectT1orE1, productsMIBCompliances=productsMIBCompliances, rnLocal=rnLocal, locErrorDurationStr=locErrorDurationStr, remMaxRSL=remMaxRSL, te1Interfaces=te1Interfaces, modelName=modelName, partNumber=partNumber, radioMonitor=radioMonitor, locEthSpeed=locEthSpeed, ntpServer3IpAddr=ntpServer3IpAddr, commitAdminSettings=commitAdminSettings, licenseFeatures=licenseFeatures, currentFwFilename=currentFwFilename, locErrorDuration=locErrorDuration, PwType=PwType, ipAddress=ipAddress, remSampleDurationStr=remSampleDurationStr, almLocal=almLocal, serialNumber=serialNumber, radioInfo=radioInfo, interfaceType=interfaceType, trapIpaddrEnable4=trapIpaddrEnable4, remCurrentBERstr=remCurrentBERstr, perfLocal=perfLocal, remErrorDurationStr=remErrorDurationStr, locLinkSecMismatch=locLinkSecMismatch, trapIpaddr4=trapIpaddr4, fileTransfer=fileTransfer, ntpServer2IpAddr=ntpServer2IpAddr, remMinRSL=remMinRSL, locLinkState=locLinkState, uploadFilename=uploadFilename, remUnavailDurationStr=remUnavailDurationStr, productsMIBGroups=productsMIBGroups, remSampleDuration=remSampleDuration, trapAuth=trapAuth, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, sysTime=sysTime, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, remMinRSLstr=remMinRSLstr, firmwareVersion=firmwareVersion, subnetMask=subnetMask, te1Status=te1Status, locEthUtilizationWatermark=locEthUtilizationWatermark, locEthAlarms=locEthAlarms, remMaxRSLstr=remMaxRSLstr, trapIpaddrEnable1=trapIpaddrEnable1, locTE1Alarms=locTE1Alarms, te1AIS=te1AIS, locUnavailDuration=locUnavailDuration, transferStart=transferStart, swapFWimage=swapFWimage, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, remCurrentRSL=remCurrentRSL, ipRemote=ipRemote, locTempAlarm=locTempAlarm, t1LineCode=t1LineCode, locLinkStateV=locLinkStateV, trapv2cEnable=trapv2cEnable, productsMIBNotifications=productsMIBNotifications, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, te1NumChannels=te1NumChannels, almRemote=almRemote, ntpClientEnable=ntpClientEnable, remErrorDuration=remErrorDuration, te1LoopBackMode=te1LoopBackMode, te1NumActiveChannels=te1NumActiveChannels, rnRemote=rnRemote, bootVersion=bootVersion, locTe1Alarm=locTe1Alarm, remTe1LinkSummary=remTe1LinkSummary, locMaximumRxModulation=locMaximumRxModulation, locCurrentBER=locCurrentBER, outboundEthernetThroughput=outboundEthernetThroughput, te1Interface=te1Interface, performance=performance, remEthAlarms=remEthAlarms, trapLocLinkStat=trapLocLinkStat, ntpTimeZoneSelect=ntpTimeZoneSelect, locEthPerfInterfaces=locEthPerfInterfaces, locEthUtilizationOut=locEthUtilizationOut, defaultGateway=defaultGateway, locMaxRSL=locMaxRSL, locSampleDurationStr=locSampleDurationStr, rfFreqBand=rfFreqBand, locResetStats=locResetStats, locTe1LinkSummary=locTe1LinkSummary, productsAllObjects=productsAllObjects, commitTe1Settings=commitTe1Settings, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locMaximumTxModulation=locMaximumTxModulation, linkSecKey=linkSecKey, trapRemAlarmStat=trapRemAlarmStat, ntp=ntp, commitNtpSettings=commitNtpSettings, te1=te1, factoryFwFilename=factoryFwFilename, remTe1AlarmsEntry=remTe1AlarmsEntry, locMinRSLtimestamp=locMinRSLtimestamp, transferType=transferType, remTempAlarm=remTempAlarm, perfRemote=perfRemote, locCurrentTempS=locCurrentTempS, locActiveRxModulation=locActiveRxModulation, locMinimumTxModulation=locMinimumTxModulation, trapv1Enable=trapv1Enable, remTE1Alarms=remTE1Alarms, locCurrentTemp=locCurrentTemp, remSysAlarms=remSysAlarms, locSampleDuration=locSampleDuration, remCurrentRSLstr=remCurrentRSLstr, aggregateUserThroughput=aggregateUserThroughput, ntpServer4IpAddr=ntpServer4IpAddr, radioName=radioName, locSysAlarms=locSysAlarms, remTe1Alarm=remTe1Alarm, locTe1AlarmsEntry=locTe1AlarmsEntry, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, locUnavailDurationStr=locUnavailDurationStr, aesKey=aesKey, sysDate=sysDate, trapIpaddr1=trapIpaddr1, rdkDbVer=rdkDbVer, licKey=licKey, radioConfig=radioConfig, remUnavailDuration=remUnavailDuration, remCurrentBER=remCurrentBER, remLinkSecMismatch=remLinkSecMismatch, productsMIBConformance=productsMIBConformance, userThroughput=userThroughput, PYSNMP_MODULE_ID=productsMIB, adminPassword=adminPassword, trapLocTempStat=trapLocTempStat, remLinkStateH=remLinkStateH)
