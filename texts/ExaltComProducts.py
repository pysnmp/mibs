...
EthAuxStatusT, EthPortMode, Te1LoopBackModeT, Te1LboT, VlanStatusT, TimeZoneT, AuxNmsMode, ExaltEnableT, FileTransferStartT, EnableStatusT, exaltcommunications, EthMainStatusT, Led4ColorT, FileTransferTypeT, VlanGroupT, AlarmLevelT, Te1LineCodeT, AcmModulationT, NtpClientEnableT, Te1StatusT = mibBuilder.importSymbols("ExaltComm", "EthAuxStatusT", "EthPortMode", "Te1LoopBackModeT", "Te1LboT", "VlanStatusT", "TimeZoneT", "AuxNmsMode", "ExaltEnableT", "FileTransferStartT", "EnableStatusT", "exaltcommunications", "EthMainStatusT", "Led4ColorT", "FileTransferTypeT", "VlanGroupT", "AlarmLevelT", "Te1LineCodeT", "AcmModulationT", "NtpClientEnableT", "Te1StatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", partNumber=partNumber, remEthAlarms=remEthAlarms, alarms=alarms, remCurrentRSLstr=remCurrentRSLstr, locMaxRSL=locMaxRSL, remSampleDurationStr=remSampleDurationStr, trapIpaddr2=trapIpaddr2, licenseFeatures=licenseFeatures, trapv1Enable=trapv1Enable, factoryFwFilename=factoryFwFilename, alternateFwFilename=alternateFwFilename, aggregateUserThroughput=aggregateUserThroughput, linkName=linkName, commitTe1Settings=commitTe1Settings, transferStart=transferStart, ntpServer4IpAddr=ntpServer4IpAddr, locUnavailDurationStr=locUnavailDurationStr, locResetStats=locResetStats, productsMIBNotifications=productsMIBNotifications, locCurrentTemp=locCurrentTemp, locMinRSL=locMinRSL, modelName=modelName, remTe1Alarms=remTe1Alarms, ntpServer3IpAddr=ntpServer3IpAddr, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locCurrentTempS=locCurrentTempS, te1Interface=te1Interface, remSampleDuration=remSampleDuration, locSysAlarms=locSysAlarms, hwId=hwId, locCurrentBER=locCurrentBER, rfFreqBand=rfFreqBand, trapIpaddrEnable3=trapIpaddrEnable3, remMinRSLstr=remMinRSLstr, locEthUtilizationOut=locEthUtilizationOut, commitNtpSettings=commitNtpSettings, locTe1Alarm=locTe1Alarm, modelNumber=modelNumber, trapIpaddr1=trapIpaddr1, locCurrentBERstr=locCurrentBERstr, te1NumActiveChannels=te1NumActiveChannels, remLinkStateH=remLinkStateH, linkSecKey=linkSecKey, t1LineCode=t1LineCode, productsMIBGroups=productsMIBGroups, locSampleDuration=locSampleDuration, locCurrentRSLstr=locCurrentRSLstr, inboundEthernetThroughput=inboundEthernetThroughput, radioReboot=radioReboot, locMinimumRxModulation=locMinimumRxModulation, te1Interfaces=te1Interfaces, radioMonitor=radioMonitor, remCurrentBER=remCurrentBER, trapLocRslThreshold=trapLocRslThreshold, rnRemote=rnRemote, aesKey=aesKey, trapIpaddrEnable1=trapIpaddrEnable1, transferType=transferType, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, ntpTimeZoneSelect=ntpTimeZoneSelect, systemConfig=systemConfig, remCurrentTempS=remCurrentTempS, adminPassword=adminPassword, currentFwFilename=currentFwFilename, remUnavailDurationStr=remUnavailDurationStr, locMinRSLtimestamp=locMinRSLtimestamp, locEthUtilizationIn=locEthUtilizationIn, ipLocal=ipLocal, rxFreqRange=rxFreqRange, productsMIBCompliances=productsMIBCompliances, userThroughput=userThroughput, tftpServerIp=tftpServerIp, trapLocLinkStat=trapLocLinkStat, radioConfig=radioConfig, txFreqRange=txFreqRange, commitAdminSettings=commitAdminSettings, remMinRSL=remMinRSL, uploadFilename=uploadFilename, ipAddress=ipAddress, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, locTempAlarm=locTempAlarm, trapIpaddr3=trapIpaddr3, outboundEthernetThroughput=outboundEthernetThroughput, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, remMaxRSL=remMaxRSL, licKey=licKey, radioName=radioName, trapLocRslStat=trapLocRslStat, swapFWimage=swapFWimage, sysTime=sysTime, locEthSpeed=locEthSpeed, remCurrentRSL=remCurrentRSL, commitSystemSettings=commitSystemSettings, defaultGateway=defaultGateway, productsAllObjects=productsAllObjects, ipAddressNetmask=ipAddressNetmask, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locErrorDurationStr=locErrorDurationStr, remResetStats=remResetStats, remTe1LinkSummary=remTe1LinkSummary, PYSNMP_MODULE_ID=productsMIB, te1NumChannels=te1NumChannels, remTe1AlarmsEntry=remTe1AlarmsEntry, locActiveTxModulation=locActiveTxModulation, locSampleDurationStr=locSampleDurationStr, trapIpaddrEnable2=trapIpaddrEnable2, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, transferStatus=transferStatus, snmpConfig=snmpConfig, te1Status=te1Status, remLinkState=remLinkState, trapIpaddrEnable4=trapIpaddrEnable4, locActiveRxModulation=locActiveRxModulation, almLocal=almLocal, productsMIBConformance=productsMIBConformance, ntpClientEnable=ntpClientEnable, locEthUtilizationWatermark=locEthUtilizationWatermark, t1LBO=t1LBO, ntpServer1IpAddr=ntpServer1IpAddr, bootVersion=bootVersion, locMaximumTxModulation=locMaximumTxModulation, remTe1Alarm=remTe1Alarm, productsMIB=productsMIB, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locMinRSLstr=locMinRSLstr, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remCurrentTemp=remCurrentTemp, remMinRSLtimestamp=remMinRSLtimestamp, PwType=PwType, perfRemote=perfRemote, remMaxRSLstr=remMaxRSLstr, rdkDbVer=rdkDbVer, trapAuth=trapAuth, locLinkState=locLinkState, locLinkStateH=locLinkStateH, locMinimumTxModulation=locMinimumTxModulation, interfaceType=interfaceType, remLinkStateV=remLinkStateV, locCurrentRSL=locCurrentRSL, locMaxRSLstr=locMaxRSLstr, remTE1Alarms=remTE1Alarms, trapRemAlarmStat=trapRemAlarmStat, perfLocal=perfLocal, remTempAlarm=remTempAlarm, remErrorDurationStr=remErrorDurationStr, te1=te1, ipRemote=ipRemote, locUnavailDuration=locUnavailDuration, remCurrentBERstr=remCurrentBERstr, radioAdmin=radioAdmin, ntpServer2IpAddr=ntpServer2IpAddr, locTE1Alarms=locTE1Alarms, remSysAlarms=remSysAlarms, te1AIS=te1AIS, firmwareVersion=firmwareVersion, locEthPerfInterfaces=locEthPerfInterfaces, trapv2cEnable=trapv2cEnable, remUnavailDuration=remUnavailDuration, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locTe1LinkSummary=locTe1LinkSummary, radioInfo=radioInfo, subnetMask=subnetMask, locErrorDuration=locErrorDuration, commitSnmpSettings=commitSnmpSettings, remErrorDuration=remErrorDuration, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, fileManagement=fileManagement, trapLocTempStat=trapLocTempStat, serialNumber=serialNumber, ntp=ntp, performance=performance, trapLocAlarmStat=trapLocAlarmStat, locMaximumRxModulation=locMaximumRxModulation, aesEnable=aesEnable, almRemote=almRemote, trapReboot=trapReboot, locLinkStateV=locLinkStateV, trapIpaddr4=trapIpaddr4, locLinkSecMismatch=locLinkSecMismatch, fileTransfer=fileTransfer, locEthAlarms=locEthAlarms, productsMIBObjects=productsMIBObjects, remLinkSecMismatch=remLinkSecMismatch, interface=interface, locTe1AlarmsEntry=locTe1AlarmsEntry, trapv3Enable=trapv3Enable, locTe1Alarms=locTe1Alarms, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, te1LoopBackMode=te1LoopBackMode, userPassword=userPassword, sysDate=sysDate, selectT1orE1=selectT1orE1, rnLocal=rnLocal)
