...
ExaltEnableT, NtpClientEnableT, Te1StatusT, TimeZoneT, AuxNmsMode, FileTransferStartT, VlanStatusT, EthAuxStatusT, EnableStatusT, AlarmLevelT, Te1LineCodeT, FileTransferTypeT, VlanGroupT, Led4ColorT, AcmModulationT, Te1LoopBackModeT, EthMainStatusT, EthPortMode, Te1LboT, exaltcommunications = mibBuilder.importSymbols("ExaltComm", "ExaltEnableT", "NtpClientEnableT", "Te1StatusT", "TimeZoneT", "AuxNmsMode", "FileTransferStartT", "VlanStatusT", "EthAuxStatusT", "EnableStatusT", "AlarmLevelT", "Te1LineCodeT", "FileTransferTypeT", "VlanGroupT", "Led4ColorT", "AcmModulationT", "Te1LoopBackModeT", "EthMainStatusT", "EthPortMode", "Te1LboT", "exaltcommunications")
...
mibBuilder.exportSymbols("ExaltComProducts", locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locUnavailDuration=locUnavailDuration, currentFwFilename=currentFwFilename, ipAddress=ipAddress, hwId=hwId, trapv1Enable=trapv1Enable, t1LineCode=t1LineCode, ntpServer2IpAddr=ntpServer2IpAddr, PwType=PwType, PYSNMP_MODULE_ID=productsMIB, commitTe1Settings=commitTe1Settings, te1AIS=te1AIS, swapFWimage=swapFWimage, locEthPerfInterfaces=locEthPerfInterfaces, trapLocTempStat=trapLocTempStat, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locMinimumRxModulation=locMinimumRxModulation, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, aggregateUserThroughput=aggregateUserThroughput, firmwareVersion=firmwareVersion, inboundEthernetThroughput=inboundEthernetThroughput, remErrorDuration=remErrorDuration, locTe1AlarmsEntry=locTe1AlarmsEntry, te1LoopBackMode=te1LoopBackMode, alternateFwFilename=alternateFwFilename, remUnavailDuration=remUnavailDuration, ntpClientEnable=ntpClientEnable, locCurrentTempS=locCurrentTempS, tftpServerIp=tftpServerIp, remEthAlarms=remEthAlarms, locTe1LinkSummary=locTe1LinkSummary, rfFreqBand=rfFreqBand, modelNumber=modelNumber, locLinkSecMismatch=locLinkSecMismatch, ntpTimeZoneSelect=ntpTimeZoneSelect, trapIpaddrEnable3=trapIpaddrEnable3, te1Interface=te1Interface, remCurrentTempS=remCurrentTempS, locEthUtilizationWatermark=locEthUtilizationWatermark, sysTime=sysTime, remSampleDuration=remSampleDuration, aesEnable=aesEnable, locTe1Alarms=locTe1Alarms, licKey=licKey, interfaceType=interfaceType, ntpServer4IpAddr=ntpServer4IpAddr, productsMIB=productsMIB, trapLocRslStat=trapLocRslStat, locMaximumTxModulation=locMaximumTxModulation, trapLocLinkStat=trapLocLinkStat, locTe1Alarm=locTe1Alarm, rnRemote=rnRemote, ntpServer1IpAddr=ntpServer1IpAddr, transferType=transferType, trapv3Enable=trapv3Enable, locResetStats=locResetStats, locLinkState=locLinkState, remMinRSL=remMinRSL, perfLocal=perfLocal, locCurrentRSLstr=locCurrentRSLstr, locMinRSL=locMinRSL, serialNumber=serialNumber, commitAdminSettings=commitAdminSettings, locLinkStateH=locLinkStateH, radioName=radioName, ipRemote=ipRemote, alarms=alarms, locLinkStateV=locLinkStateV, remLinkStateV=remLinkStateV, performance=performance, remMaxRSLstr=remMaxRSLstr, outboundEthernetThroughput=outboundEthernetThroughput, ipAddressNetmask=ipAddressNetmask, te1NumChannels=te1NumChannels, factoryFwFilename=factoryFwFilename, locMinRSLtimestamp=locMinRSLtimestamp, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, trapRemAlarmStat=trapRemAlarmStat, trapIpaddrEnable4=trapIpaddrEnable4, radioConfig=radioConfig, transferStatus=transferStatus, locSysAlarms=locSysAlarms, linkName=linkName, trapLocRslThreshold=trapLocRslThreshold, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, trapv2cEnable=trapv2cEnable, locCurrentTemp=locCurrentTemp, subnetMask=subnetMask, radioMonitor=radioMonitor, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remMaxRSL=remMaxRSL, userPassword=userPassword, locCurrentBER=locCurrentBER, productsMIBCompliances=productsMIBCompliances, remLinkStateH=remLinkStateH, te1Status=te1Status, locMaxRSL=locMaxRSL, locMaximumRxModulation=locMaximumRxModulation, commitNtpSettings=commitNtpSettings, trapLocAlarmStat=trapLocAlarmStat, locUnavailDurationStr=locUnavailDurationStr, fileManagement=fileManagement, commitSystemSettings=commitSystemSettings, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locMinimumTxModulation=locMinimumTxModulation, productsMIBNotifications=productsMIBNotifications, remCurrentBER=remCurrentBER, remCurrentTemp=remCurrentTemp, adminPassword=adminPassword, locTE1Alarms=locTE1Alarms, remCurrentBERstr=remCurrentBERstr, partNumber=partNumber, locSampleDurationStr=locSampleDurationStr, txFreqRange=txFreqRange, radioAdmin=radioAdmin, locErrorDurationStr=locErrorDurationStr, locMaxRSLstr=locMaxRSLstr, linkSecKey=linkSecKey, productsMIBObjects=productsMIBObjects, remTe1LinkSummary=remTe1LinkSummary, sysDate=sysDate, locTempAlarm=locTempAlarm, remTempAlarm=remTempAlarm, locCurrentRSL=locCurrentRSL, almLocal=almLocal, ntp=ntp, productsMIBConformance=productsMIBConformance, systemConfig=systemConfig, te1NumActiveChannels=te1NumActiveChannels, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, snmpConfig=snmpConfig, rxFreqRange=rxFreqRange, fileTransfer=fileTransfer, remTe1Alarms=remTe1Alarms, trapIpaddrEnable2=trapIpaddrEnable2, trapIpaddr2=trapIpaddr2, trapAuth=trapAuth, licenseFeatures=licenseFeatures, trapIpaddrEnable1=trapIpaddrEnable1, remTe1AlarmsEntry=remTe1AlarmsEntry, trapIpaddr1=trapIpaddr1, remSysAlarms=remSysAlarms, locEthAlarms=locEthAlarms, modelName=modelName, te1Interfaces=te1Interfaces, locMinRSLstr=locMinRSLstr, remMinRSLtimestamp=remMinRSLtimestamp, defaultGateway=defaultGateway, trapIpaddr4=trapIpaddr4, remTe1Alarm=remTe1Alarm, remCurrentRSL=remCurrentRSL, bootVersion=bootVersion, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, radioInfo=radioInfo, locCurrentBERstr=locCurrentBERstr, commitSnmpSettings=commitSnmpSettings, interface=interface, t1LBO=t1LBO, userThroughput=userThroughput, rnLocal=rnLocal, almRemote=almRemote, selectT1orE1=selectT1orE1, locActiveRxModulation=locActiveRxModulation, remLinkSecMismatch=remLinkSecMismatch, radioReboot=radioReboot, remCurrentRSLstr=remCurrentRSLstr, aesKey=aesKey, productsAllObjects=productsAllObjects, ntpServer3IpAddr=ntpServer3IpAddr, locEthUtilizationIn=locEthUtilizationIn, remUnavailDurationStr=remUnavailDurationStr, uploadFilename=uploadFilename, remResetStats=remResetStats, productsMIBGroups=productsMIBGroups, locActiveTxModulation=locActiveTxModulation, remSampleDurationStr=remSampleDurationStr, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remMinRSLstr=remMinRSLstr, transferStart=transferStart, locEthSpeed=locEthSpeed, trapReboot=trapReboot, te1=te1, locErrorDuration=locErrorDuration, locEthUtilizationOut=locEthUtilizationOut, ipLocal=ipLocal, perfRemote=perfRemote, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remTE1Alarms=remTE1Alarms, remLinkState=remLinkState, locSampleDuration=locSampleDuration, remErrorDurationStr=remErrorDurationStr, rdkDbVer=rdkDbVer, trapIpaddr3=trapIpaddr3)
