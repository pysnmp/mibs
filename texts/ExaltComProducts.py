...
Te1StatusT, Te1LineCodeT, Led4ColorT, EthPortMode, AcmModulationT, EthAuxStatusT, ExaltEnableT, Te1LoopBackModeT, EnableStatusT, AlarmLevelT, TimeZoneT, exaltcommunications, NtpClientEnableT, VlanStatusT, FileTransferTypeT, EthMainStatusT, VlanGroupT, FileTransferStartT, Te1LboT, AuxNmsMode = mibBuilder.importSymbols("ExaltComm", "Te1StatusT", "Te1LineCodeT", "Led4ColorT", "EthPortMode", "AcmModulationT", "EthAuxStatusT", "ExaltEnableT", "Te1LoopBackModeT", "EnableStatusT", "AlarmLevelT", "TimeZoneT", "exaltcommunications", "NtpClientEnableT", "VlanStatusT", "FileTransferTypeT", "EthMainStatusT", "VlanGroupT", "FileTransferStartT", "Te1LboT", "AuxNmsMode")
...
mibBuilder.exportSymbols("ExaltComProducts", te1NumChannels=te1NumChannels, txFreqRange=txFreqRange, ntp=ntp, locMaxRSLstr=locMaxRSLstr, trapIpaddr4=trapIpaddr4, rnLocal=rnLocal, locMinRSLtimestamp=locMinRSLtimestamp, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remLinkState=remLinkState, rnRemote=rnRemote, rdkDbVer=rdkDbVer, locTe1AlarmsEntry=locTe1AlarmsEntry, locActiveRxModulation=locActiveRxModulation, remLinkSecMismatch=remLinkSecMismatch, radioMonitor=radioMonitor, rxFreqRange=rxFreqRange, trapLocAlarmStat=trapLocAlarmStat, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, licenseFeatures=licenseFeatures, locResetStats=locResetStats, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, PwType=PwType, aggregateUserThroughput=aggregateUserThroughput, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locSampleDuration=locSampleDuration, remMinRSLtimestamp=remMinRSLtimestamp, userThroughput=userThroughput, adminPassword=adminPassword, trapIpaddrEnable3=trapIpaddrEnable3, userPassword=userPassword, locTe1Alarm=locTe1Alarm, locEthUtilizationOut=locEthUtilizationOut, remCurrentBER=remCurrentBER, inboundEthernetThroughput=inboundEthernetThroughput, locMinRSL=locMinRSL, bootVersion=bootVersion, fileManagement=fileManagement, commitAdminSettings=commitAdminSettings, locEthUtilizationWatermark=locEthUtilizationWatermark, remMaxRSLstr=remMaxRSLstr, swapFWimage=swapFWimage, remMinRSLstr=remMinRSLstr, radioReboot=radioReboot, locErrorDuration=locErrorDuration, te1Interfaces=te1Interfaces, locUnavailDuration=locUnavailDuration, locMaximumRxModulation=locMaximumRxModulation, currentFwFilename=currentFwFilename, t1LBO=t1LBO, locTempAlarm=locTempAlarm, sysDate=sysDate, productsAllObjects=productsAllObjects, commitSnmpSettings=commitSnmpSettings, selectT1orE1=selectT1orE1, trapIpaddrEnable4=trapIpaddrEnable4, locMinimumTxModulation=locMinimumTxModulation, trapLocRslStat=trapLocRslStat, locMaxRSL=locMaxRSL, locLinkSecMismatch=locLinkSecMismatch, locLinkStateV=locLinkStateV, remResetStats=remResetStats, commitNtpSettings=commitNtpSettings, aesKey=aesKey, alarms=alarms, remTe1LinkSummary=remTe1LinkSummary, modelName=modelName, productsMIBGroups=productsMIBGroups, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, productsMIBConformance=productsMIBConformance, sysTime=sysTime, te1Interface=te1Interface, remErrorDuration=remErrorDuration, ipRemote=ipRemote, licKey=licKey, locMinRSLstr=locMinRSLstr, interface=interface, almLocal=almLocal, productsMIBCompliances=productsMIBCompliances, locActiveTxModulation=locActiveTxModulation, trapReboot=trapReboot, ntpServer2IpAddr=ntpServer2IpAddr, ntpTimeZoneSelect=ntpTimeZoneSelect, te1NumActiveChannels=te1NumActiveChannels, locCurrentRSL=locCurrentRSL, subnetMask=subnetMask, trapIpaddr2=trapIpaddr2, remCurrentTempS=remCurrentTempS, perfLocal=perfLocal, locEthUtilizationIn=locEthUtilizationIn, locCurrentBER=locCurrentBER, ipAddressNetmask=ipAddressNetmask, remLinkStateV=remLinkStateV, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, partNumber=partNumber, locCurrentRSLstr=locCurrentRSLstr, trapLocTempStat=trapLocTempStat, remUnavailDuration=remUnavailDuration, perfRemote=perfRemote, ipAddress=ipAddress, remCurrentTemp=remCurrentTemp, modelNumber=modelNumber, trapv1Enable=trapv1Enable, trapLocRslThreshold=trapLocRslThreshold, te1=te1, te1LoopBackMode=te1LoopBackMode, locCurrentTemp=locCurrentTemp, remTempAlarm=remTempAlarm, locSampleDurationStr=locSampleDurationStr, trapAuth=trapAuth, ntpServer4IpAddr=ntpServer4IpAddr, locTE1Alarms=locTE1Alarms, aesEnable=aesEnable, productsMIBNotifications=productsMIBNotifications, trapv3Enable=trapv3Enable, locSysAlarms=locSysAlarms, remCurrentBERstr=remCurrentBERstr, remTe1Alarm=remTe1Alarm, radioConfig=radioConfig, locCurrentTempS=locCurrentTempS, trapv2cEnable=trapv2cEnable, ntpServer1IpAddr=ntpServer1IpAddr, uploadFilename=uploadFilename, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, tftpServerIp=tftpServerIp, hwId=hwId, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, locTe1LinkSummary=locTe1LinkSummary, remTE1Alarms=remTE1Alarms, remLinkStateH=remLinkStateH, remMaxRSL=remMaxRSL, locMaximumTxModulation=locMaximumTxModulation, productsMIB=productsMIB, snmpConfig=snmpConfig, radioName=radioName, commitSystemSettings=commitSystemSettings, alternateFwFilename=alternateFwFilename, locLinkStateH=locLinkStateH, locUnavailDurationStr=locUnavailDurationStr, locLinkState=locLinkState, locEthSpeed=locEthSpeed, radioInfo=radioInfo, locErrorDurationStr=locErrorDurationStr, systemConfig=systemConfig, remCurrentRSL=remCurrentRSL, commitTe1Settings=commitTe1Settings, trapIpaddr3=trapIpaddr3, outboundEthernetThroughput=outboundEthernetThroughput, firmwareVersion=firmwareVersion, remSysAlarms=remSysAlarms, productsMIBObjects=productsMIBObjects, ntpClientEnable=ntpClientEnable, te1Status=te1Status, locEthPerfInterfaces=locEthPerfInterfaces, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, PYSNMP_MODULE_ID=productsMIB, locEthAlarms=locEthAlarms, trapIpaddr1=trapIpaddr1, almRemote=almRemote, trapLocLinkStat=trapLocLinkStat, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, transferStatus=transferStatus, fileTransfer=fileTransfer, remEthAlarms=remEthAlarms, linkName=linkName, interfaceType=interfaceType, factoryFwFilename=factoryFwFilename, rfFreqBand=rfFreqBand, locMinimumRxModulation=locMinimumRxModulation, remCurrentRSLstr=remCurrentRSLstr, remErrorDurationStr=remErrorDurationStr, t1LineCode=t1LineCode, locTe1Alarms=locTe1Alarms, remMinRSL=remMinRSL, transferStart=transferStart, trapIpaddrEnable2=trapIpaddrEnable2, remSampleDurationStr=remSampleDurationStr, trapRemAlarmStat=trapRemAlarmStat, remSampleDuration=remSampleDuration, defaultGateway=defaultGateway, linkSecKey=linkSecKey, ntpServer3IpAddr=ntpServer3IpAddr, performance=performance, trapIpaddrEnable1=trapIpaddrEnable1, ipLocal=ipLocal, remTe1Alarms=remTe1Alarms, radioAdmin=radioAdmin, remUnavailDurationStr=remUnavailDurationStr, locCurrentBERstr=locCurrentBERstr, te1AIS=te1AIS, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, remTe1AlarmsEntry=remTe1AlarmsEntry, transferType=transferType, serialNumber=serialNumber)
