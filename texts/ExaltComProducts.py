...
Te1LoopBackModeT, EthMainStatusT, FileTransferStartT, Led4ColorT, Te1StatusT, EthAuxStatusT, NtpClientEnableT, AcmModulationT, exaltcommunications, EnableStatusT, AlarmLevelT, VlanGroupT, VlanStatusT, Te1LineCodeT, ExaltEnableT, Te1LboT, TimeZoneT, EthPortMode, FileTransferTypeT, AuxNmsMode = mibBuilder.importSymbols("ExaltComm", "Te1LoopBackModeT", "EthMainStatusT", "FileTransferStartT", "Led4ColorT", "Te1StatusT", "EthAuxStatusT", "NtpClientEnableT", "AcmModulationT", "exaltcommunications", "EnableStatusT", "AlarmLevelT", "VlanGroupT", "VlanStatusT", "Te1LineCodeT", "ExaltEnableT", "Te1LboT", "TimeZoneT", "EthPortMode", "FileTransferTypeT", "AuxNmsMode")
...
mibBuilder.exportSymbols("ExaltComProducts", trapIpaddr1=trapIpaddr1, ntpServer4IpAddr=ntpServer4IpAddr, trapIpaddr2=trapIpaddr2, radioInfo=radioInfo, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, sysDate=sysDate, locActiveTxModulation=locActiveTxModulation, remErrorDuration=remErrorDuration, locTe1LinkSummary=locTe1LinkSummary, remSampleDuration=remSampleDuration, bootVersion=bootVersion, te1LoopBackMode=te1LoopBackMode, remCurrentTempS=remCurrentTempS, trapIpaddrEnable1=trapIpaddrEnable1, remLinkState=remLinkState, ntpServer2IpAddr=ntpServer2IpAddr, locMinimumTxModulation=locMinimumTxModulation, remUnavailDurationStr=remUnavailDurationStr, userThroughput=userThroughput, trapAuth=trapAuth, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, tftpServerIp=tftpServerIp, remErrorDurationStr=remErrorDurationStr, PwType=PwType, remMinRSLstr=remMinRSLstr, aesEnable=aesEnable, modelNumber=modelNumber, te1Interfaces=te1Interfaces, trapReboot=trapReboot, remLinkSecMismatch=remLinkSecMismatch, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, swapFWimage=swapFWimage, almRemote=almRemote, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, radioAdmin=radioAdmin, alarms=alarms, locCurrentTemp=locCurrentTemp, partNumber=partNumber, commitNtpSettings=commitNtpSettings, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, fileTransfer=fileTransfer, aesKey=aesKey, outboundEthernetThroughput=outboundEthernetThroughput, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, t1LineCode=t1LineCode, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locTempAlarm=locTempAlarm, ipAddress=ipAddress, remSysAlarms=remSysAlarms, transferStart=transferStart, commitAdminSettings=commitAdminSettings, defaultGateway=defaultGateway, PYSNMP_MODULE_ID=productsMIB, remMaxRSL=remMaxRSL, remSampleDurationStr=remSampleDurationStr, trapLocTempStat=trapLocTempStat, locSysAlarms=locSysAlarms, locTe1Alarms=locTe1Alarms, productsMIBConformance=productsMIBConformance, ipLocal=ipLocal, hwId=hwId, trapLocLinkStat=trapLocLinkStat, transferType=transferType, trapLocRslStat=trapLocRslStat, locMinRSLtimestamp=locMinRSLtimestamp, locMinRSLstr=locMinRSLstr, commitTe1Settings=commitTe1Settings, rxFreqRange=rxFreqRange, productsMIBCompliances=productsMIBCompliances, remTe1AlarmsEntry=remTe1AlarmsEntry, ipRemote=ipRemote, locMaxRSL=locMaxRSL, locMaxRSLstr=locMaxRSLstr, radioMonitor=radioMonitor, locUnavailDuration=locUnavailDuration, locCurrentTempS=locCurrentTempS, remLinkStateV=remLinkStateV, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locErrorDurationStr=locErrorDurationStr, trapLocRslThreshold=trapLocRslThreshold, remLinkStateH=remLinkStateH, snmpConfig=snmpConfig, performance=performance, locCurrentBERstr=locCurrentBERstr, locSampleDuration=locSampleDuration, sysTime=sysTime, serialNumber=serialNumber, remTempAlarm=remTempAlarm, rnLocal=rnLocal, commitSnmpSettings=commitSnmpSettings, ntpServer3IpAddr=ntpServer3IpAddr, locTe1Alarm=locTe1Alarm, locResetStats=locResetStats, systemConfig=systemConfig, locEthSpeed=locEthSpeed, locErrorDuration=locErrorDuration, locEthPerfInterfaces=locEthPerfInterfaces, locActiveRxModulation=locActiveRxModulation, te1Interface=te1Interface, rfFreqBand=rfFreqBand, interfaceType=interfaceType, perfRemote=perfRemote, commitSystemSettings=commitSystemSettings, trapv1Enable=trapv1Enable, remMinRSLtimestamp=remMinRSLtimestamp, rdkDbVer=rdkDbVer, locEthUtilizationIn=locEthUtilizationIn, remCurrentTemp=remCurrentTemp, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, firmwareVersion=firmwareVersion, adminPassword=adminPassword, radioConfig=radioConfig, uploadFilename=uploadFilename, trapIpaddrEnable4=trapIpaddrEnable4, transferStatus=transferStatus, ntpServer1IpAddr=ntpServer1IpAddr, licKey=licKey, trapRemAlarmStat=trapRemAlarmStat, locCurrentRSL=locCurrentRSL, perfLocal=perfLocal, remTe1Alarms=remTe1Alarms, remCurrentRSL=remCurrentRSL, locMinRSL=locMinRSL, remCurrentRSLstr=remCurrentRSLstr, ntpClientEnable=ntpClientEnable, ntpTimeZoneSelect=ntpTimeZoneSelect, locUnavailDurationStr=locUnavailDurationStr, linkSecKey=linkSecKey, remMaxRSLstr=remMaxRSLstr, currentFwFilename=currentFwFilename, productsMIB=productsMIB, modelName=modelName, selectT1orE1=selectT1orE1, linkName=linkName, interface=interface, locEthUtilizationOut=locEthUtilizationOut, locTE1Alarms=locTE1Alarms, alternateFwFilename=alternateFwFilename, txFreqRange=txFreqRange, factoryFwFilename=factoryFwFilename, te1Status=te1Status, ntp=ntp, remResetStats=remResetStats, aggregateUserThroughput=aggregateUserThroughput, remEthAlarms=remEthAlarms, trapv3Enable=trapv3Enable, locMinimumRxModulation=locMinimumRxModulation, locSampleDurationStr=locSampleDurationStr, locMaximumTxModulation=locMaximumTxModulation, remTe1Alarm=remTe1Alarm, ipAddressNetmask=ipAddressNetmask, locCurrentRSLstr=locCurrentRSLstr, rnRemote=rnRemote, userPassword=userPassword, te1AIS=te1AIS, trapLocAlarmStat=trapLocAlarmStat, productsMIBGroups=productsMIBGroups, almLocal=almLocal, remCurrentBER=remCurrentBER, remCurrentBERstr=remCurrentBERstr, productsMIBNotifications=productsMIBNotifications, locTe1AlarmsEntry=locTe1AlarmsEntry, locLinkState=locLinkState, locEthAlarms=locEthAlarms, te1NumChannels=te1NumChannels, t1LBO=t1LBO, remUnavailDuration=remUnavailDuration, productsAllObjects=productsAllObjects, trapv2cEnable=trapv2cEnable, locLinkSecMismatch=locLinkSecMismatch, locEthUtilizationWatermark=locEthUtilizationWatermark, remTe1LinkSummary=remTe1LinkSummary, remMinRSL=remMinRSL, productsMIBObjects=productsMIBObjects, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, fileManagement=fileManagement, trapIpaddr3=trapIpaddr3, locMaximumRxModulation=locMaximumRxModulation, locLinkStateV=locLinkStateV, trapIpaddrEnable2=trapIpaddrEnable2, radioReboot=radioReboot, locLinkStateH=locLinkStateH, subnetMask=subnetMask, trapIpaddr4=trapIpaddr4, trapIpaddrEnable3=trapIpaddrEnable3, radioName=radioName, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, licenseFeatures=licenseFeatures, locCurrentBER=locCurrentBER, inboundEthernetThroughput=inboundEthernetThroughput, remTE1Alarms=remTE1Alarms, te1=te1, te1NumActiveChannels=te1NumActiveChannels)
