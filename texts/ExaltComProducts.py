...
EnableStatusT, EthMainStatusT, VlanGroupT, AuxNmsMode, AcmModulationT, TimeZoneT, NtpClientEnableT, ExaltEnableT, Te1LoopBackModeT, FileTransferTypeT, AlarmLevelT, Te1StatusT, exaltcommunications, VlanStatusT, Te1LboT, EthPortMode, Led4ColorT, EthAuxStatusT, Te1LineCodeT, FileTransferStartT = mibBuilder.importSymbols("ExaltComm", "EnableStatusT", "EthMainStatusT", "VlanGroupT", "AuxNmsMode", "AcmModulationT", "TimeZoneT", "NtpClientEnableT", "ExaltEnableT", "Te1LoopBackModeT", "FileTransferTypeT", "AlarmLevelT", "Te1StatusT", "exaltcommunications", "VlanStatusT", "Te1LboT", "EthPortMode", "Led4ColorT", "EthAuxStatusT", "Te1LineCodeT", "FileTransferStartT")
...
mibBuilder.exportSymbols("ExaltComProducts", locMaxRSL=locMaxRSL, trapIpaddr1=trapIpaddr1, remMaxRSL=remMaxRSL, licKey=licKey, ipLocal=ipLocal, transferStatus=transferStatus, remLinkStateV=remLinkStateV, userThroughput=userThroughput, remTe1LinkSummary=remTe1LinkSummary, trapLocLinkStat=trapLocLinkStat, alternateFwFilename=alternateFwFilename, locErrorDurationStr=locErrorDurationStr, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locCurrentTemp=locCurrentTemp, locSampleDurationStr=locSampleDurationStr, locMinRSLstr=locMinRSLstr, trapLocAlarmStat=trapLocAlarmStat, remErrorDurationStr=remErrorDurationStr, fileTransfer=fileTransfer, remUnavailDuration=remUnavailDuration, locEthPerfInterfaces=locEthPerfInterfaces, locActiveRxModulation=locActiveRxModulation, radioName=radioName, perfLocal=perfLocal, remLinkSecMismatch=remLinkSecMismatch, trapv1Enable=trapv1Enable, remSysAlarms=remSysAlarms, interface=interface, swapFWimage=swapFWimage, t1LBO=t1LBO, ipAddressNetmask=ipAddressNetmask, tftpServerIp=tftpServerIp, performance=performance, modelNumber=modelNumber, sysDate=sysDate, remMinRSL=remMinRSL, remResetStats=remResetStats, factoryFwFilename=factoryFwFilename, trapIpaddrEnable3=trapIpaddrEnable3, perfRemote=perfRemote, te1Interfaces=te1Interfaces, sysTime=sysTime, remCurrentRSLstr=remCurrentRSLstr, rnRemote=rnRemote, remTe1Alarm=remTe1Alarm, remCurrentBER=remCurrentBER, remCurrentTemp=remCurrentTemp, inboundEthernetThroughput=inboundEthernetThroughput, outboundEthernetThroughput=outboundEthernetThroughput, remLinkStateH=remLinkStateH, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, radioConfig=radioConfig, ipAddress=ipAddress, locMaxRSLstr=locMaxRSLstr, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, rxFreqRange=rxFreqRange, trapLocTempStat=trapLocTempStat, productsMIB=productsMIB, remUnavailDurationStr=remUnavailDurationStr, locCurrentBER=locCurrentBER, locCurrentRSLstr=locCurrentRSLstr, trapAuth=trapAuth, locSampleDuration=locSampleDuration, systemConfig=systemConfig, txFreqRange=txFreqRange, productsMIBObjects=productsMIBObjects, radioMonitor=radioMonitor, remEthAlarms=remEthAlarms, modelName=modelName, remTempAlarm=remTempAlarm, trapReboot=trapReboot, te1Interface=te1Interface, locLinkStateV=locLinkStateV, currentFwFilename=currentFwFilename, locSysAlarms=locSysAlarms, productsMIBConformance=productsMIBConformance, locMaximumRxModulation=locMaximumRxModulation, transferType=transferType, trapIpaddr3=trapIpaddr3, ipRemote=ipRemote, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, productsMIBGroups=productsMIBGroups, interfaceType=interfaceType, transferStart=transferStart, locErrorDuration=locErrorDuration, trapLocRslStat=trapLocRslStat, almRemote=almRemote, remCurrentBERstr=remCurrentBERstr, locTe1Alarms=locTe1Alarms, almLocal=almLocal, locCurrentRSL=locCurrentRSL, remCurrentRSL=remCurrentRSL, commitNtpSettings=commitNtpSettings, PwType=PwType, linkSecKey=linkSecKey, remTe1AlarmsEntry=remTe1AlarmsEntry, userPassword=userPassword, productsAllObjects=productsAllObjects, commitSystemSettings=commitSystemSettings, te1AIS=te1AIS, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, radioReboot=radioReboot, locResetStats=locResetStats, t1LineCode=t1LineCode, radioInfo=radioInfo, trapv2cEnable=trapv2cEnable, trapRemAlarmStat=trapRemAlarmStat, trapv3Enable=trapv3Enable, PYSNMP_MODULE_ID=productsMIB, ntp=ntp, locMinRSL=locMinRSL, snmpConfig=snmpConfig, rnLocal=rnLocal, aesEnable=aesEnable, locEthAlarms=locEthAlarms, locActiveTxModulation=locActiveTxModulation, remErrorDuration=remErrorDuration, trapIpaddrEnable4=trapIpaddrEnable4, ntpServer4IpAddr=ntpServer4IpAddr, rdkDbVer=rdkDbVer, remLinkState=remLinkState, ntpTimeZoneSelect=ntpTimeZoneSelect, locMinimumRxModulation=locMinimumRxModulation, te1NumActiveChannels=te1NumActiveChannels, locLinkStateH=locLinkStateH, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locMinRSLtimestamp=locMinRSLtimestamp, trapIpaddrEnable1=trapIpaddrEnable1, locCurrentBERstr=locCurrentBERstr, te1NumChannels=te1NumChannels, selectT1orE1=selectT1orE1, remMinRSLstr=remMinRSLstr, trapIpaddrEnable2=trapIpaddrEnable2, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, remTE1Alarms=remTE1Alarms, serialNumber=serialNumber, remMinRSLtimestamp=remMinRSLtimestamp, ntpServer2IpAddr=ntpServer2IpAddr, partNumber=partNumber, licenseFeatures=licenseFeatures, locMaximumTxModulation=locMaximumTxModulation, locEthUtilizationWatermark=locEthUtilizationWatermark, bootVersion=bootVersion, remMaxRSLstr=remMaxRSLstr, locMinimumTxModulation=locMinimumTxModulation, productsMIBCompliances=productsMIBCompliances, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, linkName=linkName, locLinkState=locLinkState, locLinkSecMismatch=locLinkSecMismatch, locEthUtilizationOut=locEthUtilizationOut, ntpClientEnable=ntpClientEnable, fileManagement=fileManagement, trapIpaddr4=trapIpaddr4, locCurrentTempS=locCurrentTempS, locEthSpeed=locEthSpeed, trapIpaddr2=trapIpaddr2, te1LoopBackMode=te1LoopBackMode, subnetMask=subnetMask, firmwareVersion=firmwareVersion, rfFreqBand=rfFreqBand, commitTe1Settings=commitTe1Settings, locTE1Alarms=locTE1Alarms, locTe1AlarmsEntry=locTe1AlarmsEntry, radioAdmin=radioAdmin, locEthUtilizationIn=locEthUtilizationIn, commitAdminSettings=commitAdminSettings, locUnavailDuration=locUnavailDuration, locUnavailDurationStr=locUnavailDurationStr, ntpServer3IpAddr=ntpServer3IpAddr, remSampleDurationStr=remSampleDurationStr, te1Status=te1Status, remCurrentTempS=remCurrentTempS, remTe1Alarms=remTe1Alarms, adminPassword=adminPassword, aggregateUserThroughput=aggregateUserThroughput, commitSnmpSettings=commitSnmpSettings, locTe1Alarm=locTe1Alarm, locTe1LinkSummary=locTe1LinkSummary, productsMIBNotifications=productsMIBNotifications, ntpServer1IpAddr=ntpServer1IpAddr, locTempAlarm=locTempAlarm, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, trapLocRslThreshold=trapLocRslThreshold, alarms=alarms, uploadFilename=uploadFilename, aesKey=aesKey, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, hwId=hwId, remSampleDuration=remSampleDuration, te1=te1, defaultGateway=defaultGateway)
