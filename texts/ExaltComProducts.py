...
TimeZoneT, VlanGroupT, Te1LoopBackModeT, AuxNmsMode, ExaltEnableT, EthPortMode, AcmModulationT, NtpClientEnableT, Te1LineCodeT, Te1StatusT, EnableStatusT, FileTransferStartT, AlarmLevelT, VlanStatusT, Led4ColorT, exaltcommunications, EthAuxStatusT, Te1LboT, FileTransferTypeT, EthMainStatusT = mibBuilder.importSymbols("ExaltComm", "TimeZoneT", "VlanGroupT", "Te1LoopBackModeT", "AuxNmsMode", "ExaltEnableT", "EthPortMode", "AcmModulationT", "NtpClientEnableT", "Te1LineCodeT", "Te1StatusT", "EnableStatusT", "FileTransferStartT", "AlarmLevelT", "VlanStatusT", "Led4ColorT", "exaltcommunications", "EthAuxStatusT", "Te1LboT", "FileTransferTypeT", "EthMainStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", locCurrentRSLstr=locCurrentRSLstr, productsMIBNotifications=productsMIBNotifications, locMaximumTxModulation=locMaximumTxModulation, partNumber=partNumber, ipLocal=ipLocal, trapIpaddr2=trapIpaddr2, modelName=modelName, locTE1Alarms=locTE1Alarms, radioReboot=radioReboot, trapAuth=trapAuth, firmwareVersion=firmwareVersion, fileTransfer=fileTransfer, snmpConfig=snmpConfig, aesKey=aesKey, radioInfo=radioInfo, selectT1orE1=selectT1orE1, remTE1Alarms=remTE1Alarms, locEthPerfInterfaces=locEthPerfInterfaces, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, remCurrentRSL=remCurrentRSL, trapv2cEnable=trapv2cEnable, locErrorDuration=locErrorDuration, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, interface=interface, PwType=PwType, almRemote=almRemote, remMaxRSLstr=remMaxRSLstr, defaultGateway=defaultGateway, trapLocTempStat=trapLocTempStat, locUnavailDurationStr=locUnavailDurationStr, remLinkStateV=remLinkStateV, productsMIBGroups=productsMIBGroups, remTe1Alarm=remTe1Alarm, locCurrentBERstr=locCurrentBERstr, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, remTe1Alarms=remTe1Alarms, locMinimumTxModulation=locMinimumTxModulation, trapIpaddrEnable1=trapIpaddrEnable1, commitAdminSettings=commitAdminSettings, t1LBO=t1LBO, remEthAlarms=remEthAlarms, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locUnavailDuration=locUnavailDuration, bootVersion=bootVersion, locResetStats=locResetStats, remSampleDuration=remSampleDuration, sysTime=sysTime, locCurrentTempS=locCurrentTempS, locTe1LinkSummary=locTe1LinkSummary, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, uploadFilename=uploadFilename, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, rxFreqRange=rxFreqRange, trapIpaddrEnable4=trapIpaddrEnable4, remTe1LinkSummary=remTe1LinkSummary, te1=te1, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, ipAddressNetmask=ipAddressNetmask, locSampleDuration=locSampleDuration, te1Interfaces=te1Interfaces, productsMIBObjects=productsMIBObjects, locLinkSecMismatch=locLinkSecMismatch, outboundEthernetThroughput=outboundEthernetThroughput, locCurrentTemp=locCurrentTemp, locTempAlarm=locTempAlarm, inboundEthernetThroughput=inboundEthernetThroughput, userThroughput=userThroughput, linkName=linkName, locActiveRxModulation=locActiveRxModulation, trapIpaddr4=trapIpaddr4, PYSNMP_MODULE_ID=productsMIB, trapIpaddrEnable3=trapIpaddrEnable3, remLinkSecMismatch=remLinkSecMismatch, alarms=alarms, locTe1AlarmsEntry=locTe1AlarmsEntry, te1LoopBackMode=te1LoopBackMode, serialNumber=serialNumber, transferType=transferType, remCurrentTemp=remCurrentTemp, remMinRSLtimestamp=remMinRSLtimestamp, remResetStats=remResetStats, remLinkStateH=remLinkStateH, subnetMask=subnetMask, trapIpaddr1=trapIpaddr1, licKey=licKey, rfFreqBand=rfFreqBand, remCurrentBER=remCurrentBER, remSampleDurationStr=remSampleDurationStr, rnLocal=rnLocal, factoryFwFilename=factoryFwFilename, remErrorDuration=remErrorDuration, aesEnable=aesEnable, remCurrentBERstr=remCurrentBERstr, radioMonitor=radioMonitor, perfRemote=perfRemote, locEthUtilizationIn=locEthUtilizationIn, locMinRSLtimestamp=locMinRSLtimestamp, trapLocAlarmStat=trapLocAlarmStat, almLocal=almLocal, systemConfig=systemConfig, locCurrentBER=locCurrentBER, radioAdmin=radioAdmin, productsMIBConformance=productsMIBConformance, ntpServer1IpAddr=ntpServer1IpAddr, ntpServer3IpAddr=ntpServer3IpAddr, fileManagement=fileManagement, productsAllObjects=productsAllObjects, ntpServer2IpAddr=ntpServer2IpAddr, transferStart=transferStart, remLinkState=remLinkState, remTe1AlarmsEntry=remTe1AlarmsEntry, aggregateUserThroughput=aggregateUserThroughput, locLinkState=locLinkState, locMinRSL=locMinRSL, remSysAlarms=remSysAlarms, trapReboot=trapReboot, trapv1Enable=trapv1Enable, performance=performance, remUnavailDuration=remUnavailDuration, trapRemAlarmStat=trapRemAlarmStat, locEthAlarms=locEthAlarms, remCurrentTempS=remCurrentTempS, trapLocLinkStat=trapLocLinkStat, locErrorDurationStr=locErrorDurationStr, locSysAlarms=locSysAlarms, ntp=ntp, productsMIBCompliances=productsMIBCompliances, tftpServerIp=tftpServerIp, locTe1Alarm=locTe1Alarm, ntpClientEnable=ntpClientEnable, locLinkStateH=locLinkStateH, locMinimumRxModulation=locMinimumRxModulation, remCurrentRSLstr=remCurrentRSLstr, ntpTimeZoneSelect=ntpTimeZoneSelect, txFreqRange=txFreqRange, commitTe1Settings=commitTe1Settings, remErrorDurationStr=remErrorDurationStr, adminPassword=adminPassword, commitSystemSettings=commitSystemSettings, locMinRSLstr=locMinRSLstr, remMinRSL=remMinRSL, transferStatus=transferStatus, userPassword=userPassword, remUnavailDurationStr=remUnavailDurationStr, te1NumChannels=te1NumChannels, locTe1Alarms=locTe1Alarms, trapv3Enable=trapv3Enable, interfaceType=interfaceType, licenseFeatures=licenseFeatures, locActiveTxModulation=locActiveTxModulation, modelNumber=modelNumber, locEthUtilizationOut=locEthUtilizationOut, rdkDbVer=rdkDbVer, locEthUtilizationWatermark=locEthUtilizationWatermark, radioName=radioName, sysDate=sysDate, ipRemote=ipRemote, te1AIS=te1AIS, productsMIB=productsMIB, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, trapIpaddrEnable2=trapIpaddrEnable2, trapIpaddr3=trapIpaddr3, t1LineCode=t1LineCode, te1NumActiveChannels=te1NumActiveChannels, radioConfig=radioConfig, commitSnmpSettings=commitSnmpSettings, te1Interface=te1Interface, locSampleDurationStr=locSampleDurationStr, remMinRSLstr=remMinRSLstr, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, ipAddress=ipAddress, linkSecKey=linkSecKey, remTempAlarm=remTempAlarm, locMaxRSLstr=locMaxRSLstr, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locCurrentRSL=locCurrentRSL, te1Status=te1Status, locMaxRSL=locMaxRSL, trapLocRslStat=trapLocRslStat, hwId=hwId, locMaximumRxModulation=locMaximumRxModulation, remMaxRSL=remMaxRSL, locEthSpeed=locEthSpeed, alternateFwFilename=alternateFwFilename, currentFwFilename=currentFwFilename, commitNtpSettings=commitNtpSettings, swapFWimage=swapFWimage, perfLocal=perfLocal, locLinkStateV=locLinkStateV, trapLocRslThreshold=trapLocRslThreshold, ntpServer4IpAddr=ntpServer4IpAddr, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, rnRemote=rnRemote)
