...
AcmModulationT, VlanStatusT, Te1LoopBackModeT, AuxNmsMode, Te1LineCodeT, FileTransferStartT, NtpClientEnableT, EnableStatusT, AlarmLevelT, FileTransferTypeT, Led4ColorT, EthMainStatusT, VlanGroupT, Te1StatusT, ExaltEnableT, TimeZoneT, EthAuxStatusT, exaltcommunications, EthPortMode, Te1LboT = mibBuilder.importSymbols("ExaltComm", "AcmModulationT", "VlanStatusT", "Te1LoopBackModeT", "AuxNmsMode", "Te1LineCodeT", "FileTransferStartT", "NtpClientEnableT", "EnableStatusT", "AlarmLevelT", "FileTransferTypeT", "Led4ColorT", "EthMainStatusT", "VlanGroupT", "Te1StatusT", "ExaltEnableT", "TimeZoneT", "EthAuxStatusT", "exaltcommunications", "EthPortMode", "Te1LboT")
...
mibBuilder.exportSymbols("ExaltComProducts", locLinkState=locLinkState, licKey=licKey, locLinkStateH=locLinkStateH, productsMIBObjects=productsMIBObjects, userPassword=userPassword, te1NumActiveChannels=te1NumActiveChannels, ntpTimeZoneSelect=ntpTimeZoneSelect, remSysAlarms=remSysAlarms, locMinRSLtimestamp=locMinRSLtimestamp, commitNtpSettings=commitNtpSettings, remLinkSecMismatch=remLinkSecMismatch, locErrorDuration=locErrorDuration, remMinRSL=remMinRSL, fileTransfer=fileTransfer, inboundEthernetThroughput=inboundEthernetThroughput, trapLocRslThreshold=trapLocRslThreshold, aesEnable=aesEnable, remTe1LinkSummary=remTe1LinkSummary, locCurrentTempS=locCurrentTempS, perfLocal=perfLocal, locMaximumTxModulation=locMaximumTxModulation, interfaceType=interfaceType, locResetStats=locResetStats, remTe1AlarmsEntry=remTe1AlarmsEntry, radioConfig=radioConfig, commitAdminSettings=commitAdminSettings, currentFwFilename=currentFwFilename, locActiveRxModulation=locActiveRxModulation, remLinkStateV=remLinkStateV, ntpServer3IpAddr=ntpServer3IpAddr, locTe1AlarmsEntry=locTe1AlarmsEntry, locMinimumRxModulation=locMinimumRxModulation, te1Status=te1Status, te1LoopBackMode=te1LoopBackMode, productsMIBConformance=productsMIBConformance, transferType=transferType, rdkDbVer=rdkDbVer, trapv3Enable=trapv3Enable, remMaxRSL=remMaxRSL, te1Interface=te1Interface, uploadFilename=uploadFilename, t1LBO=t1LBO, remCurrentBERstr=remCurrentBERstr, te1NumChannels=te1NumChannels, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, trapv1Enable=trapv1Enable, linkSecKey=linkSecKey, locLinkStateV=locLinkStateV, PYSNMP_MODULE_ID=productsMIB, defaultGateway=defaultGateway, remLinkState=remLinkState, trapIpaddrEnable2=trapIpaddrEnable2, locCurrentRSLstr=locCurrentRSLstr, locEthPerfInterfaces=locEthPerfInterfaces, locTempAlarm=locTempAlarm, locSampleDuration=locSampleDuration, trapAuth=trapAuth, aesKey=aesKey, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, adminPassword=adminPassword, ipLocal=ipLocal, te1AIS=te1AIS, ntpServer1IpAddr=ntpServer1IpAddr, subnetMask=subnetMask, locCurrentBERstr=locCurrentBERstr, locMaxRSL=locMaxRSL, ipAddressNetmask=ipAddressNetmask, almLocal=almLocal, remLinkStateH=remLinkStateH, tftpServerIp=tftpServerIp, trapLocTempStat=trapLocTempStat, commitTe1Settings=commitTe1Settings, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, productsMIB=productsMIB, locMinRSL=locMinRSL, locMinimumTxModulation=locMinimumTxModulation, PwType=PwType, radioInfo=radioInfo, locUnavailDuration=locUnavailDuration, modelNumber=modelNumber, interface=interface, te1Interfaces=te1Interfaces, remEthAlarms=remEthAlarms, selectT1orE1=selectT1orE1, remUnavailDurationStr=remUnavailDurationStr, locTE1Alarms=locTE1Alarms, remCurrentTemp=remCurrentTemp, trapIpaddr4=trapIpaddr4, ntpServer2IpAddr=ntpServer2IpAddr, locMinRSLstr=locMinRSLstr, swapFWimage=swapFWimage, radioMonitor=radioMonitor, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locEthUtilizationOut=locEthUtilizationOut, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, remCurrentBER=remCurrentBER, remErrorDuration=remErrorDuration, te1=te1, trapLocRslStat=trapLocRslStat, txFreqRange=txFreqRange, rxFreqRange=rxFreqRange, rfFreqBand=rfFreqBand, ntpServer4IpAddr=ntpServer4IpAddr, locActiveTxModulation=locActiveTxModulation, remMaxRSLstr=remMaxRSLstr, remSampleDuration=remSampleDuration, perfRemote=perfRemote, outboundEthernetThroughput=outboundEthernetThroughput, radioReboot=radioReboot, trapIpaddr2=trapIpaddr2, hwId=hwId, modelName=modelName, transferStart=transferStart, trapLocAlarmStat=trapLocAlarmStat, trapIpaddr1=trapIpaddr1, remUnavailDuration=remUnavailDuration, remTe1Alarm=remTe1Alarm, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locEthAlarms=locEthAlarms, locMaxRSLstr=locMaxRSLstr, trapReboot=trapReboot, commitSystemSettings=commitSystemSettings, alarms=alarms, locLinkSecMismatch=locLinkSecMismatch, locCurrentTemp=locCurrentTemp, almRemote=almRemote, locTe1LinkSummary=locTe1LinkSummary, locMaximumRxModulation=locMaximumRxModulation, t1LineCode=t1LineCode, remSampleDurationStr=remSampleDurationStr, rnRemote=rnRemote, systemConfig=systemConfig, alternateFwFilename=alternateFwFilename, partNumber=partNumber, remErrorDurationStr=remErrorDurationStr, trapIpaddrEnable3=trapIpaddrEnable3, remCurrentRSLstr=remCurrentRSLstr, locErrorDurationStr=locErrorDurationStr, sysTime=sysTime, licenseFeatures=licenseFeatures, trapRemAlarmStat=trapRemAlarmStat, ntpClientEnable=ntpClientEnable, productsMIBGroups=productsMIBGroups, remCurrentTempS=remCurrentTempS, locCurrentRSL=locCurrentRSL, snmpConfig=snmpConfig, remTe1Alarms=remTe1Alarms, performance=performance, remCurrentRSL=remCurrentRSL, locUnavailDurationStr=locUnavailDurationStr, userThroughput=userThroughput, trapIpaddrEnable4=trapIpaddrEnable4, commitSnmpSettings=commitSnmpSettings, remMinRSLtimestamp=remMinRSLtimestamp, locTe1Alarm=locTe1Alarm, locCurrentBER=locCurrentBER, radioName=radioName, serialNumber=serialNumber, productsAllObjects=productsAllObjects, trapIpaddrEnable1=trapIpaddrEnable1, locEthUtilizationWatermark=locEthUtilizationWatermark, productsMIBNotifications=productsMIBNotifications, ntp=ntp, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locTe1Alarms=locTe1Alarms, locEthUtilizationIn=locEthUtilizationIn, rnLocal=rnLocal, firmwareVersion=firmwareVersion, remResetStats=remResetStats, locEthSpeed=locEthSpeed, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remMinRSLstr=remMinRSLstr, ipAddress=ipAddress, fileManagement=fileManagement, factoryFwFilename=factoryFwFilename, transferStatus=transferStatus, trapv2cEnable=trapv2cEnable, linkName=linkName, productsMIBCompliances=productsMIBCompliances, ipRemote=ipRemote, trapIpaddr3=trapIpaddr3, locSampleDurationStr=locSampleDurationStr, trapLocLinkStat=trapLocLinkStat, remTE1Alarms=remTE1Alarms, bootVersion=bootVersion, remTempAlarm=remTempAlarm, aggregateUserThroughput=aggregateUserThroughput, locSysAlarms=locSysAlarms, radioAdmin=radioAdmin, sysDate=sysDate, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput)
