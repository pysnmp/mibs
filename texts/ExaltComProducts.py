...
Led4ColorT, AcmModulationT, FileTransferStartT, Te1StatusT, Te1LoopBackModeT, Te1LineCodeT, EnableStatusT, NtpClientEnableT, ExaltEnableT, EthMainStatusT, VlanGroupT, Te1LboT, TimeZoneT, EthAuxStatusT, exaltcommunications, AlarmLevelT, VlanStatusT, EthPortMode, FileTransferTypeT, AuxNmsMode = mibBuilder.importSymbols("ExaltComm", "Led4ColorT", "AcmModulationT", "FileTransferStartT", "Te1StatusT", "Te1LoopBackModeT", "Te1LineCodeT", "EnableStatusT", "NtpClientEnableT", "ExaltEnableT", "EthMainStatusT", "VlanGroupT", "Te1LboT", "TimeZoneT", "EthAuxStatusT", "exaltcommunications", "AlarmLevelT", "VlanStatusT", "EthPortMode", "FileTransferTypeT", "AuxNmsMode")
...
mibBuilder.exportSymbols("ExaltComProducts", trapLocRslThreshold=trapLocRslThreshold, te1NumActiveChannels=te1NumActiveChannels, transferStart=transferStart, remCurrentBER=remCurrentBER, fileManagement=fileManagement, locLinkState=locLinkState, snmpConfig=snmpConfig, locCurrentBER=locCurrentBER, userPassword=userPassword, remResetStats=remResetStats, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, trapv2cEnable=trapv2cEnable, locErrorDurationStr=locErrorDurationStr, productsMIBGroups=productsMIBGroups, locMaxRSL=locMaxRSL, linkName=linkName, remMaxRSL=remMaxRSL, locTe1Alarms=locTe1Alarms, productsMIBNotifications=productsMIBNotifications, perfLocal=perfLocal, locUnavailDuration=locUnavailDuration, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, remErrorDuration=remErrorDuration, radioMonitor=radioMonitor, locUnavailDurationStr=locUnavailDurationStr, trapIpaddrEnable3=trapIpaddrEnable3, te1Interfaces=te1Interfaces, partNumber=partNumber, remCurrentTempS=remCurrentTempS, commitTe1Settings=commitTe1Settings, tftpServerIp=tftpServerIp, radioReboot=radioReboot, trapIpaddr3=trapIpaddr3, remLinkStateH=remLinkStateH, interfaceType=interfaceType, locActiveRxModulation=locActiveRxModulation, ntpServer3IpAddr=ntpServer3IpAddr, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, perfRemote=perfRemote, remSampleDurationStr=remSampleDurationStr, locEthUtilizationOut=locEthUtilizationOut, modelNumber=modelNumber, productsMIBConformance=productsMIBConformance, commitSystemSettings=commitSystemSettings, adminPassword=adminPassword, almLocal=almLocal, remSysAlarms=remSysAlarms, locMinimumTxModulation=locMinimumTxModulation, productsAllObjects=productsAllObjects, serialNumber=serialNumber, rnRemote=rnRemote, te1Interface=te1Interface, transferStatus=transferStatus, remLinkSecMismatch=remLinkSecMismatch, trapRemAlarmStat=trapRemAlarmStat, outboundEthernetThroughput=outboundEthernetThroughput, defaultGateway=defaultGateway, licKey=licKey, te1=te1, trapv1Enable=trapv1Enable, locTe1AlarmsEntry=locTe1AlarmsEntry, rfFreqBand=rfFreqBand, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locMaximumRxModulation=locMaximumRxModulation, remEthAlarms=remEthAlarms, locActiveTxModulation=locActiveTxModulation, interface=interface, licenseFeatures=licenseFeatures, t1LineCode=t1LineCode, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, ntpServer2IpAddr=ntpServer2IpAddr, trapLocRslStat=trapLocRslStat, locEthUtilizationIn=locEthUtilizationIn, userThroughput=userThroughput, locMaximumTxModulation=locMaximumTxModulation, radioConfig=radioConfig, ipLocal=ipLocal, trapLocAlarmStat=trapLocAlarmStat, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, fileTransfer=fileTransfer, modelName=modelName, commitSnmpSettings=commitSnmpSettings, bootVersion=bootVersion, locEthSpeed=locEthSpeed, locSysAlarms=locSysAlarms, currentFwFilename=currentFwFilename, locResetStats=locResetStats, remErrorDurationStr=remErrorDurationStr, locTempAlarm=locTempAlarm, locTe1LinkSummary=locTe1LinkSummary, remTe1Alarms=remTe1Alarms, sysTime=sysTime, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, productsMIBCompliances=productsMIBCompliances, locEthPerfInterfaces=locEthPerfInterfaces, commitAdminSettings=commitAdminSettings, ntpServer1IpAddr=ntpServer1IpAddr, PwType=PwType, t1LBO=t1LBO, locMinRSL=locMinRSL, remMinRSLstr=remMinRSLstr, locLinkStateV=locLinkStateV, alternateFwFilename=alternateFwFilename, remTE1Alarms=remTE1Alarms, PYSNMP_MODULE_ID=productsMIB, remSampleDuration=remSampleDuration, te1Status=te1Status, remCurrentTemp=remCurrentTemp, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, trapLocTempStat=trapLocTempStat, almRemote=almRemote, rdkDbVer=rdkDbVer, selectT1orE1=selectT1orE1, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locLinkStateH=locLinkStateH, inboundEthernetThroughput=inboundEthernetThroughput, trapIpaddr2=trapIpaddr2, subnetMask=subnetMask, locSampleDurationStr=locSampleDurationStr, remMinRSL=remMinRSL, trapAuth=trapAuth, aesKey=aesKey, ipAddress=ipAddress, rnLocal=rnLocal, locEthAlarms=locEthAlarms, locCurrentRSL=locCurrentRSL, ipAddressNetmask=ipAddressNetmask, commitNtpSettings=commitNtpSettings, remTe1AlarmsEntry=remTe1AlarmsEntry, trapIpaddrEnable2=trapIpaddrEnable2, sysDate=sysDate, trapIpaddr4=trapIpaddr4, locCurrentBERstr=locCurrentBERstr, rxFreqRange=rxFreqRange, factoryFwFilename=factoryFwFilename, productsMIBObjects=productsMIBObjects, locTE1Alarms=locTE1Alarms, alarms=alarms, ntpServer4IpAddr=ntpServer4IpAddr, radioName=radioName, remCurrentBERstr=remCurrentBERstr, productsMIB=productsMIB, locEthUtilizationWatermark=locEthUtilizationWatermark, trapIpaddrEnable1=trapIpaddrEnable1, locErrorDuration=locErrorDuration, systemConfig=systemConfig, linkSecKey=linkSecKey, radioAdmin=radioAdmin, locSampleDuration=locSampleDuration, locCurrentTemp=locCurrentTemp, remTe1LinkSummary=remTe1LinkSummary, locMinRSLstr=locMinRSLstr, aesEnable=aesEnable, remMinRSLtimestamp=remMinRSLtimestamp, swapFWimage=swapFWimage, remCurrentRSLstr=remCurrentRSLstr, trapv3Enable=trapv3Enable, aggregateUserThroughput=aggregateUserThroughput, performance=performance, remMaxRSLstr=remMaxRSLstr, hwId=hwId, remLinkState=remLinkState, ntpClientEnable=ntpClientEnable, trapIpaddr1=trapIpaddr1, te1LoopBackMode=te1LoopBackMode, transferType=transferType, trapReboot=trapReboot, locMinimumRxModulation=locMinimumRxModulation, locLinkSecMismatch=locLinkSecMismatch, te1NumChannels=te1NumChannels, uploadFilename=uploadFilename, locCurrentTempS=locCurrentTempS, remLinkStateV=remLinkStateV, txFreqRange=txFreqRange, ipRemote=ipRemote, firmwareVersion=firmwareVersion, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remTe1Alarm=remTe1Alarm, remUnavailDuration=remUnavailDuration, locMaxRSLstr=locMaxRSLstr, locMinRSLtimestamp=locMinRSLtimestamp, te1AIS=te1AIS, remTempAlarm=remTempAlarm, ntp=ntp, remUnavailDurationStr=remUnavailDurationStr, trapIpaddrEnable4=trapIpaddrEnable4, locCurrentRSLstr=locCurrentRSLstr, locTe1Alarm=locTe1Alarm, radioInfo=radioInfo, ntpTimeZoneSelect=ntpTimeZoneSelect, trapLocLinkStat=trapLocLinkStat, remCurrentRSL=remCurrentRSL)
