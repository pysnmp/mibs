...
EnableStatusT, AcmModulationT, EthAuxStatusT, FileTransferStartT, VlanGroupT, Led4ColorT, Te1StatusT, EthMainStatusT, Te1LboT, Te1LineCodeT, exaltcommunications, EthPortMode, NtpClientEnableT, ExaltEnableT, Te1LoopBackModeT, VlanStatusT, AlarmLevelT, FileTransferTypeT, TimeZoneT, AuxNmsMode = mibBuilder.importSymbols("ExaltComm", "EnableStatusT", "AcmModulationT", "EthAuxStatusT", "FileTransferStartT", "VlanGroupT", "Led4ColorT", "Te1StatusT", "EthMainStatusT", "Te1LboT", "Te1LineCodeT", "exaltcommunications", "EthPortMode", "NtpClientEnableT", "ExaltEnableT", "Te1LoopBackModeT", "VlanStatusT", "AlarmLevelT", "FileTransferTypeT", "TimeZoneT", "AuxNmsMode")
...
mibBuilder.exportSymbols("ExaltComProducts", trapIpaddr4=trapIpaddr4, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locUnavailDuration=locUnavailDuration, te1Interfaces=te1Interfaces, hwId=hwId, fileTransfer=fileTransfer, radioInfo=radioInfo, locEthPerfInterfaces=locEthPerfInterfaces, locMaxRSL=locMaxRSL, ntp=ntp, trapv1Enable=trapv1Enable, uploadFilename=uploadFilename, te1Status=te1Status, locSampleDuration=locSampleDuration, userPassword=userPassword, transferStatus=transferStatus, remCurrentBER=remCurrentBER, trapIpaddr1=trapIpaddr1, commitSnmpSettings=commitSnmpSettings, locLinkSecMismatch=locLinkSecMismatch, productsAllObjects=productsAllObjects, locEthUtilizationOut=locEthUtilizationOut, te1NumActiveChannels=te1NumActiveChannels, currentFwFilename=currentFwFilename, remSampleDurationStr=remSampleDurationStr, aggregateUserThroughput=aggregateUserThroughput, productsMIBCompliances=productsMIBCompliances, remTe1AlarmsEntry=remTe1AlarmsEntry, interface=interface, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, radioName=radioName, trapAuth=trapAuth, locEthSpeed=locEthSpeed, remTe1Alarms=remTe1Alarms, locActiveRxModulation=locActiveRxModulation, productsMIBGroups=productsMIBGroups, trapIpaddrEnable1=trapIpaddrEnable1, radioReboot=radioReboot, linkSecKey=linkSecKey, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, rfFreqBand=rfFreqBand, te1LoopBackMode=te1LoopBackMode, remMaxRSL=remMaxRSL, locEthAlarms=locEthAlarms, rdkDbVer=rdkDbVer, PYSNMP_MODULE_ID=productsMIB, trapv3Enable=trapv3Enable, remCurrentBERstr=remCurrentBERstr, remCurrentRSL=remCurrentRSL, trapIpaddr3=trapIpaddr3, userThroughput=userThroughput, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, trapv2cEnable=trapv2cEnable, selectT1orE1=selectT1orE1, locLinkStateV=locLinkStateV, locErrorDurationStr=locErrorDurationStr, locMaximumTxModulation=locMaximumTxModulation, remCurrentRSLstr=remCurrentRSLstr, remResetStats=remResetStats, ipAddress=ipAddress, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, remSysAlarms=remSysAlarms, productsMIBNotifications=productsMIBNotifications, trapIpaddrEnable2=trapIpaddrEnable2, radioConfig=radioConfig, trapLocTempStat=trapLocTempStat, remLinkState=remLinkState, modelNumber=modelNumber, remMaxRSLstr=remMaxRSLstr, trapReboot=trapReboot, licenseFeatures=licenseFeatures, remCurrentTemp=remCurrentTemp, remMinRSL=remMinRSL, locCurrentRSL=locCurrentRSL, locMinRSLstr=locMinRSLstr, almLocal=almLocal, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, tftpServerIp=tftpServerIp, trapIpaddr2=trapIpaddr2, fileManagement=fileManagement, ntpServer4IpAddr=ntpServer4IpAddr, locCurrentTempS=locCurrentTempS, trapLocRslStat=trapLocRslStat, defaultGateway=defaultGateway, trapIpaddrEnable4=trapIpaddrEnable4, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, aesEnable=aesEnable, locMaximumRxModulation=locMaximumRxModulation, alarms=alarms, remLinkSecMismatch=remLinkSecMismatch, subnetMask=subnetMask, sysDate=sysDate, remUnavailDurationStr=remUnavailDurationStr, locTe1Alarm=locTe1Alarm, locLinkStateH=locLinkStateH, modelName=modelName, t1LBO=t1LBO, remEthAlarms=remEthAlarms, locEthUtilizationIn=locEthUtilizationIn, remErrorDuration=remErrorDuration, productsMIBObjects=productsMIBObjects, remCurrentTempS=remCurrentTempS, perfLocal=perfLocal, adminPassword=adminPassword, alternateFwFilename=alternateFwFilename, locTe1AlarmsEntry=locTe1AlarmsEntry, locCurrentBER=locCurrentBER, locTE1Alarms=locTE1Alarms, remLinkStateV=remLinkStateV, systemConfig=systemConfig, te1NumChannels=te1NumChannels, aesKey=aesKey, txFreqRange=txFreqRange, trapRemAlarmStat=trapRemAlarmStat, locMinimumTxModulation=locMinimumTxModulation, snmpConfig=snmpConfig, locMaxRSLstr=locMaxRSLstr, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, commitTe1Settings=commitTe1Settings, trapLocLinkStat=trapLocLinkStat, ntpServer3IpAddr=ntpServer3IpAddr, ipRemote=ipRemote, locErrorDuration=locErrorDuration, locTempAlarm=locTempAlarm, ipAddressNetmask=ipAddressNetmask, commitAdminSettings=commitAdminSettings, remErrorDurationStr=remErrorDurationStr, locUnavailDurationStr=locUnavailDurationStr, te1AIS=te1AIS, perfRemote=perfRemote, locMinRSLtimestamp=locMinRSLtimestamp, locEthUtilizationWatermark=locEthUtilizationWatermark, locActiveTxModulation=locActiveTxModulation, rnLocal=rnLocal, locResetStats=locResetStats, radioAdmin=radioAdmin, trapLocRslThreshold=trapLocRslThreshold, outboundEthernetThroughput=outboundEthernetThroughput, inboundEthernetThroughput=inboundEthernetThroughput, PwType=PwType, remSampleDuration=remSampleDuration, locMinRSL=locMinRSL, t1LineCode=t1LineCode, locTe1Alarms=locTe1Alarms, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remTe1Alarm=remTe1Alarm, interfaceType=interfaceType, commitNtpSettings=commitNtpSettings, trapLocAlarmStat=trapLocAlarmStat, locCurrentRSLstr=locCurrentRSLstr, rxFreqRange=rxFreqRange, remMinRSLstr=remMinRSLstr, commitSystemSettings=commitSystemSettings, factoryFwFilename=factoryFwFilename, remTe1LinkSummary=remTe1LinkSummary, serialNumber=serialNumber, transferStart=transferStart, remMinRSLtimestamp=remMinRSLtimestamp, locSysAlarms=locSysAlarms, locMinimumRxModulation=locMinimumRxModulation, te1Interface=te1Interface, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, remUnavailDuration=remUnavailDuration, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, firmwareVersion=firmwareVersion, productsMIBConformance=productsMIBConformance, linkName=linkName, ntpClientEnable=ntpClientEnable, locTe1LinkSummary=locTe1LinkSummary, locSampleDurationStr=locSampleDurationStr, productsMIB=productsMIB, ipLocal=ipLocal, locCurrentTemp=locCurrentTemp, bootVersion=bootVersion, transferType=transferType, rnRemote=rnRemote, locLinkState=locLinkState, sysTime=sysTime, performance=performance, ntpServer2IpAddr=ntpServer2IpAddr, trapIpaddrEnable3=trapIpaddrEnable3, swapFWimage=swapFWimage, ntpServer1IpAddr=ntpServer1IpAddr, te1=te1, remLinkStateH=remLinkStateH, almRemote=almRemote, remTempAlarm=remTempAlarm, remTE1Alarms=remTE1Alarms, radioMonitor=radioMonitor, partNumber=partNumber, licKey=licKey, ntpTimeZoneSelect=ntpTimeZoneSelect, locCurrentBERstr=locCurrentBERstr)
