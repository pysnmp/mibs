...
EthMainStatusT, FileTransferTypeT, Led4ColorT, NtpClientEnableT, VlanStatusT, exaltcommunications, EthPortMode, Te1LboT, VlanGroupT, AuxNmsMode, Te1StatusT, EnableStatusT, ExaltEnableT, TimeZoneT, AcmModulationT, FileTransferStartT, AlarmLevelT, EthAuxStatusT, Te1LoopBackModeT, Te1LineCodeT = mibBuilder.importSymbols("ExaltComm", "EthMainStatusT", "FileTransferTypeT", "Led4ColorT", "NtpClientEnableT", "VlanStatusT", "exaltcommunications", "EthPortMode", "Te1LboT", "VlanGroupT", "AuxNmsMode", "Te1StatusT", "EnableStatusT", "ExaltEnableT", "TimeZoneT", "AcmModulationT", "FileTransferStartT", "AlarmLevelT", "EthAuxStatusT", "Te1LoopBackModeT", "Te1LineCodeT")
...
mibBuilder.exportSymbols("ExaltComProducts", locLinkStateV=locLinkStateV, remCurrentRSL=remCurrentRSL, locEthUtilizationOut=locEthUtilizationOut, serialNumber=serialNumber, licenseFeatures=licenseFeatures, inboundEthernetThroughput=inboundEthernetThroughput, trapReboot=trapReboot, ntpServer1IpAddr=ntpServer1IpAddr, sysTime=sysTime, locTe1LinkSummary=locTe1LinkSummary, remMinRSL=remMinRSL, ntpClientEnable=ntpClientEnable, locMinRSLtimestamp=locMinRSLtimestamp, trapIpaddrEnable1=trapIpaddrEnable1, rdkDbVer=rdkDbVer, rfFreqBand=rfFreqBand, te1=te1, uploadFilename=uploadFilename, locCurrentTempS=locCurrentTempS, locCurrentBER=locCurrentBER, locMinRSL=locMinRSL, productsMIB=productsMIB, t1LBO=t1LBO, fileManagement=fileManagement, te1NumActiveChannels=te1NumActiveChannels, modelNumber=modelNumber, ipRemote=ipRemote, te1Status=te1Status, locMaxRSL=locMaxRSL, commitNtpSettings=commitNtpSettings, locErrorDuration=locErrorDuration, remTe1AlarmsEntry=remTe1AlarmsEntry, firmwareVersion=firmwareVersion, aesKey=aesKey, rnLocal=rnLocal, remMaxRSL=remMaxRSL, remTE1Alarms=remTE1Alarms, trapv2cEnable=trapv2cEnable, swapFWimage=swapFWimage, almLocal=almLocal, trapIpaddr2=trapIpaddr2, transferStatus=transferStatus, locLinkState=locLinkState, locActiveTxModulation=locActiveTxModulation, transferType=transferType, commitSnmpSettings=commitSnmpSettings, rnRemote=rnRemote, trapLocTempStat=trapLocTempStat, locCurrentTemp=locCurrentTemp, rxFreqRange=rxFreqRange, trapv3Enable=trapv3Enable, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, locTe1Alarms=locTe1Alarms, perfRemote=perfRemote, locSysAlarms=locSysAlarms, remSampleDurationStr=remSampleDurationStr, ntpServer2IpAddr=ntpServer2IpAddr, remCurrentTemp=remCurrentTemp, te1AIS=te1AIS, ntpServer4IpAddr=ntpServer4IpAddr, remErrorDurationStr=remErrorDurationStr, trapLocLinkStat=trapLocLinkStat, locMinimumRxModulation=locMinimumRxModulation, locEthUtilizationWatermark=locEthUtilizationWatermark, locLinkSecMismatch=locLinkSecMismatch, remLinkSecMismatch=remLinkSecMismatch, aggregateUserThroughput=aggregateUserThroughput, remTe1Alarm=remTe1Alarm, transferStart=transferStart, locEthPerfInterfaces=locEthPerfInterfaces, trapIpaddrEnable2=trapIpaddrEnable2, userPassword=userPassword, trapIpaddr3=trapIpaddr3, te1Interfaces=te1Interfaces, remCurrentRSLstr=remCurrentRSLstr, productsMIBNotifications=productsMIBNotifications, trapIpaddr4=trapIpaddr4, snmpConfig=snmpConfig, locEthUtilizationIn=locEthUtilizationIn, adminPassword=adminPassword, locEthSpeed=locEthSpeed, alternateFwFilename=alternateFwFilename, PwType=PwType, interfaceType=interfaceType, remSysAlarms=remSysAlarms, locLinkStateH=locLinkStateH, locMinRSLstr=locMinRSLstr, locCurrentRSLstr=locCurrentRSLstr, remMinRSLtimestamp=remMinRSLtimestamp, userThroughput=userThroughput, radioReboot=radioReboot, commitTe1Settings=commitTe1Settings, remEthAlarms=remEthAlarms, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locResetStats=locResetStats, productsMIBGroups=productsMIBGroups, productsAllObjects=productsAllObjects, licKey=licKey, radioInfo=radioInfo, subnetMask=subnetMask, te1NumChannels=te1NumChannels, commitAdminSettings=commitAdminSettings, remTempAlarm=remTempAlarm, commitSystemSettings=commitSystemSettings, linkName=linkName, remMinRSLstr=remMinRSLstr, locActiveRxModulation=locActiveRxModulation, remSampleDuration=remSampleDuration, alarms=alarms, remCurrentBERstr=remCurrentBERstr, PYSNMP_MODULE_ID=productsMIB, productsMIBCompliances=productsMIBCompliances, te1Interface=te1Interface, radioAdmin=radioAdmin, outboundEthernetThroughput=outboundEthernetThroughput, remTe1Alarms=remTe1Alarms, ipLocal=ipLocal, ntpTimeZoneSelect=ntpTimeZoneSelect, remUnavailDurationStr=remUnavailDurationStr, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, performance=performance, selectT1orE1=selectT1orE1, productsMIBObjects=productsMIBObjects, locErrorDurationStr=locErrorDurationStr, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, factoryFwFilename=factoryFwFilename, remCurrentBER=remCurrentBER, ipAddress=ipAddress, t1LineCode=t1LineCode, trapLocRslStat=trapLocRslStat, trapAuth=trapAuth, remMaxRSLstr=remMaxRSLstr, locSampleDurationStr=locSampleDurationStr, defaultGateway=defaultGateway, remResetStats=remResetStats, trapLocAlarmStat=trapLocAlarmStat, locCurrentBERstr=locCurrentBERstr, systemConfig=systemConfig, remLinkStateH=remLinkStateH, radioName=radioName, currentFwFilename=currentFwFilename, locTe1AlarmsEntry=locTe1AlarmsEntry, locUnavailDuration=locUnavailDuration, trapIpaddr1=trapIpaddr1, locMaximumRxModulation=locMaximumRxModulation, aesEnable=aesEnable, modelName=modelName, trapIpaddrEnable4=trapIpaddrEnable4, bootVersion=bootVersion, tftpServerIp=tftpServerIp, remTe1LinkSummary=remTe1LinkSummary, locTempAlarm=locTempAlarm, radioConfig=radioConfig, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, hwId=hwId, almRemote=almRemote, locUnavailDurationStr=locUnavailDurationStr, locTe1Alarm=locTe1Alarm, locMaximumTxModulation=locMaximumTxModulation, remUnavailDuration=remUnavailDuration, trapIpaddrEnable3=trapIpaddrEnable3, ntp=ntp, remLinkState=remLinkState, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, ntpServer3IpAddr=ntpServer3IpAddr, sysDate=sysDate, trapRemAlarmStat=trapRemAlarmStat, productsMIBConformance=productsMIBConformance, te1LoopBackMode=te1LoopBackMode, interface=interface, locTE1Alarms=locTE1Alarms, radioMonitor=radioMonitor, linkSecKey=linkSecKey, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, ipAddressNetmask=ipAddressNetmask, perfLocal=perfLocal, locSampleDuration=locSampleDuration, locCurrentRSL=locCurrentRSL, trapv1Enable=trapv1Enable, remCurrentTempS=remCurrentTempS, remLinkStateV=remLinkStateV, locEthAlarms=locEthAlarms, locMinimumTxModulation=locMinimumTxModulation, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, fileTransfer=fileTransfer, remErrorDuration=remErrorDuration, partNumber=partNumber, locMaxRSLstr=locMaxRSLstr, trapLocRslThreshold=trapLocRslThreshold, txFreqRange=txFreqRange)
