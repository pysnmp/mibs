...
VlanGroupT, EthPortMode, Te1LboT, VlanStatusT, FileTransferStartT, exaltcommunications, ExaltEnableT, AuxNmsMode, EthAuxStatusT, AlarmLevelT, FileTransferTypeT, Te1LineCodeT, Te1LoopBackModeT, TimeZoneT, EthMainStatusT, NtpClientEnableT, EnableStatusT, Te1StatusT, Led4ColorT, AcmModulationT = mibBuilder.importSymbols("ExaltComm", "VlanGroupT", "EthPortMode", "Te1LboT", "VlanStatusT", "FileTransferStartT", "exaltcommunications", "ExaltEnableT", "AuxNmsMode", "EthAuxStatusT", "AlarmLevelT", "FileTransferTypeT", "Te1LineCodeT", "Te1LoopBackModeT", "TimeZoneT", "EthMainStatusT", "NtpClientEnableT", "EnableStatusT", "Te1StatusT", "Led4ColorT", "AcmModulationT")
...
mibBuilder.exportSymbols("ExaltComProducts", commitNtpSettings=commitNtpSettings, remCurrentBERstr=remCurrentBERstr, uploadFilename=uploadFilename, ipAddressNetmask=ipAddressNetmask, trapIpaddrEnable4=trapIpaddrEnable4, remMaxRSL=remMaxRSL, remCurrentBER=remCurrentBER, locLinkState=locLinkState, alarms=alarms, locErrorDuration=locErrorDuration, trapLocAlarmStat=trapLocAlarmStat, trapLocRslThreshold=trapLocRslThreshold, sysDate=sysDate, radioConfig=radioConfig, locCurrentTemp=locCurrentTemp, radioInfo=radioInfo, PYSNMP_MODULE_ID=productsMIB, radioName=radioName, trapIpaddrEnable3=trapIpaddrEnable3, transferStart=transferStart, te1Interfaces=te1Interfaces, commitSystemSettings=commitSystemSettings, remLinkStateH=remLinkStateH, locMinRSLstr=locMinRSLstr, remErrorDurationStr=remErrorDurationStr, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, ipAddress=ipAddress, trapAuth=trapAuth, trapIpaddr1=trapIpaddr1, interface=interface, locTe1Alarm=locTe1Alarm, locSampleDurationStr=locSampleDurationStr, remErrorDuration=remErrorDuration, adminPassword=adminPassword, partNumber=partNumber, locTE1Alarms=locTE1Alarms, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locTempAlarm=locTempAlarm, licenseFeatures=licenseFeatures, sysTime=sysTime, transferStatus=transferStatus, remMinRSL=remMinRSL, linkSecKey=linkSecKey, te1LoopBackMode=te1LoopBackMode, locEthSpeed=locEthSpeed, locActiveRxModulation=locActiveRxModulation, locTe1LinkSummary=locTe1LinkSummary, trapIpaddr4=trapIpaddr4, te1Interface=te1Interface, perfRemote=perfRemote, locMaxRSLstr=locMaxRSLstr, remEthAlarms=remEthAlarms, productsMIBCompliances=productsMIBCompliances, ntpServer2IpAddr=ntpServer2IpAddr, locLinkSecMismatch=locLinkSecMismatch, rdkDbVer=rdkDbVer, fileManagement=fileManagement, aesEnable=aesEnable, swapFWimage=swapFWimage, locResetStats=locResetStats, outboundEthernetThroughput=outboundEthernetThroughput, bootVersion=bootVersion, productsMIB=productsMIB, remLinkState=remLinkState, remMinRSLtimestamp=remMinRSLtimestamp, aggregateUserThroughput=aggregateUserThroughput, trapv3Enable=trapv3Enable, commitSnmpSettings=commitSnmpSettings, t1LBO=t1LBO, locCurrentBER=locCurrentBER, commitAdminSettings=commitAdminSettings, licKey=licKey, selectT1orE1=selectT1orE1, radioReboot=radioReboot, currentFwFilename=currentFwFilename, remCurrentRSL=remCurrentRSL, trapIpaddr2=trapIpaddr2, trapv2cEnable=trapv2cEnable, userThroughput=userThroughput, linkName=linkName, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, ntp=ntp, trapIpaddrEnable2=trapIpaddrEnable2, userPassword=userPassword, remLinkSecMismatch=remLinkSecMismatch, locCurrentRSLstr=locCurrentRSLstr, rnLocal=rnLocal, te1NumActiveChannels=te1NumActiveChannels, locMinRSL=locMinRSL, locLinkStateH=locLinkStateH, locEthPerfInterfaces=locEthPerfInterfaces, remUnavailDuration=remUnavailDuration, remTempAlarm=remTempAlarm, modelName=modelName, almRemote=almRemote, locSampleDuration=locSampleDuration, remTE1Alarms=remTE1Alarms, remResetStats=remResetStats, transferType=transferType, locMaximumTxModulation=locMaximumTxModulation, locCurrentBERstr=locCurrentBERstr, snmpConfig=snmpConfig, locSysAlarms=locSysAlarms, te1Status=te1Status, remCurrentTemp=remCurrentTemp, productsAllObjects=productsAllObjects, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, trapIpaddrEnable1=trapIpaddrEnable1, locEthUtilizationOut=locEthUtilizationOut, firmwareVersion=firmwareVersion, ntpTimeZoneSelect=ntpTimeZoneSelect, commitTe1Settings=commitTe1Settings, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, interfaceType=interfaceType, trapv1Enable=trapv1Enable, tftpServerIp=tftpServerIp, alternateFwFilename=alternateFwFilename, txFreqRange=txFreqRange, trapLocTempStat=trapLocTempStat, remCurrentTempS=remCurrentTempS, ipLocal=ipLocal, remMaxRSLstr=remMaxRSLstr, locEthAlarms=locEthAlarms, productsMIBGroups=productsMIBGroups, remSampleDuration=remSampleDuration, ntpServer4IpAddr=ntpServer4IpAddr, locMaxRSL=locMaxRSL, remCurrentRSLstr=remCurrentRSLstr, locTe1AlarmsEntry=locTe1AlarmsEntry, rfFreqBand=rfFreqBand, te1=te1, ntpServer3IpAddr=ntpServer3IpAddr, locCurrentRSL=locCurrentRSL, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locEthUtilizationWatermark=locEthUtilizationWatermark, defaultGateway=defaultGateway, remSysAlarms=remSysAlarms, remTe1Alarms=remTe1Alarms, locUnavailDuration=locUnavailDuration, remTe1LinkSummary=remTe1LinkSummary, factoryFwFilename=factoryFwFilename, t1LineCode=t1LineCode, locEthUtilizationIn=locEthUtilizationIn, remSampleDurationStr=remSampleDurationStr, rnRemote=rnRemote, trapRemAlarmStat=trapRemAlarmStat, almLocal=almLocal, perfLocal=perfLocal, modelNumber=modelNumber, trapLocLinkStat=trapLocLinkStat, systemConfig=systemConfig, locActiveTxModulation=locActiveTxModulation, trapLocRslStat=trapLocRslStat, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, productsMIBNotifications=productsMIBNotifications, remTe1AlarmsEntry=remTe1AlarmsEntry, ipRemote=ipRemote, locTe1Alarms=locTe1Alarms, remLinkStateV=remLinkStateV, productsMIBConformance=productsMIBConformance, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remTe1Alarm=remTe1Alarm, performance=performance, subnetMask=subnetMask, locMinimumRxModulation=locMinimumRxModulation, locCurrentTempS=locCurrentTempS, trapIpaddr3=trapIpaddr3, radioMonitor=radioMonitor, locMinimumTxModulation=locMinimumTxModulation, ntpServer1IpAddr=ntpServer1IpAddr, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, hwId=hwId, locLinkStateV=locLinkStateV, locUnavailDurationStr=locUnavailDurationStr, serialNumber=serialNumber, fileTransfer=fileTransfer, remMinRSLstr=remMinRSLstr, inboundEthernetThroughput=inboundEthernetThroughput, locMinRSLtimestamp=locMinRSLtimestamp, remUnavailDurationStr=remUnavailDurationStr, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, PwType=PwType, ntpClientEnable=ntpClientEnable, locMaximumRxModulation=locMaximumRxModulation, trapReboot=trapReboot, aesKey=aesKey, locErrorDurationStr=locErrorDurationStr, te1AIS=te1AIS, rxFreqRange=rxFreqRange, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, te1NumChannels=te1NumChannels, productsMIBObjects=productsMIBObjects, radioAdmin=radioAdmin)
