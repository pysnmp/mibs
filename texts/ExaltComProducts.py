...
TimeZoneT, VlanGroupT, AuxNmsMode, Te1LineCodeT, EthAuxStatusT, AlarmLevelT, EthPortMode, EthMainStatusT, ExaltEnableT, exaltcommunications, NtpClientEnableT, Te1LboT, Te1LoopBackModeT, Led4ColorT, Te1StatusT, AcmModulationT, FileTransferStartT, VlanStatusT, EnableStatusT, FileTransferTypeT = mibBuilder.importSymbols("ExaltComm", "TimeZoneT", "VlanGroupT", "AuxNmsMode", "Te1LineCodeT", "EthAuxStatusT", "AlarmLevelT", "EthPortMode", "EthMainStatusT", "ExaltEnableT", "exaltcommunications", "NtpClientEnableT", "Te1LboT", "Te1LoopBackModeT", "Led4ColorT", "Te1StatusT", "AcmModulationT", "FileTransferStartT", "VlanStatusT", "EnableStatusT", "FileTransferTypeT")
...
mibBuilder.exportSymbols("ExaltComProducts", swapFWimage=swapFWimage, ntpServer3IpAddr=ntpServer3IpAddr, remCurrentTemp=remCurrentTemp, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, remTE1Alarms=remTE1Alarms, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, te1Status=te1Status, locTe1Alarms=locTe1Alarms, aggregateUserThroughput=aggregateUserThroughput, productsMIBGroups=productsMIBGroups, locErrorDurationStr=locErrorDurationStr, licenseFeatures=licenseFeatures, ntp=ntp, radioConfig=radioConfig, locMinimumRxModulation=locMinimumRxModulation, locLinkStateV=locLinkStateV, ipAddress=ipAddress, inboundEthernetThroughput=inboundEthernetThroughput, locMaxRSLstr=locMaxRSLstr, locMinRSLtimestamp=locMinRSLtimestamp, locEthUtilizationOut=locEthUtilizationOut, transferStart=transferStart, locCurrentBER=locCurrentBER, PYSNMP_MODULE_ID=productsMIB, remLinkState=remLinkState, trapLocLinkStat=trapLocLinkStat, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, transferStatus=transferStatus, linkSecKey=linkSecKey, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, trapIpaddr1=trapIpaddr1, remCurrentTempS=remCurrentTempS, remLinkStateV=remLinkStateV, locCurrentTempS=locCurrentTempS, locCurrentRSLstr=locCurrentRSLstr, remTe1Alarms=remTe1Alarms, locMinimumTxModulation=locMinimumTxModulation, trapIpaddrEnable2=trapIpaddrEnable2, trapIpaddrEnable3=trapIpaddrEnable3, locEthAlarms=locEthAlarms, defaultGateway=defaultGateway, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, remTe1Alarm=remTe1Alarm, modelName=modelName, t1LBO=t1LBO, remUnavailDurationStr=remUnavailDurationStr, locMaxRSL=locMaxRSL, productsMIBNotifications=productsMIBNotifications, trapReboot=trapReboot, remMinRSL=remMinRSL, currentFwFilename=currentFwFilename, te1NumActiveChannels=te1NumActiveChannels, ntpTimeZoneSelect=ntpTimeZoneSelect, bootVersion=bootVersion, locTE1Alarms=locTE1Alarms, locUnavailDuration=locUnavailDuration, aesEnable=aesEnable, remUnavailDuration=remUnavailDuration, remCurrentBER=remCurrentBER, trapIpaddr3=trapIpaddr3, locTempAlarm=locTempAlarm, locMinRSLstr=locMinRSLstr, sysDate=sysDate, selectT1orE1=selectT1orE1, productsMIB=productsMIB, transferType=transferType, radioMonitor=radioMonitor, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, snmpConfig=snmpConfig, trapv3Enable=trapv3Enable, firmwareVersion=firmwareVersion, te1LoopBackMode=te1LoopBackMode, locUnavailDurationStr=locUnavailDurationStr, almRemote=almRemote, perfLocal=perfLocal, remTe1LinkSummary=remTe1LinkSummary, locCurrentRSL=locCurrentRSL, locSysAlarms=locSysAlarms, trapv2cEnable=trapv2cEnable, remSampleDuration=remSampleDuration, trapLocTempStat=trapLocTempStat, remMaxRSLstr=remMaxRSLstr, remCurrentBERstr=remCurrentBERstr, remResetStats=remResetStats, userThroughput=userThroughput, aesKey=aesKey, locTe1LinkSummary=locTe1LinkSummary, commitTe1Settings=commitTe1Settings, locResetStats=locResetStats, locLinkState=locLinkState, t1LineCode=t1LineCode, remLinkSecMismatch=remLinkSecMismatch, remTe1AlarmsEntry=remTe1AlarmsEntry, radioName=radioName, locLinkStateH=locLinkStateH, trapIpaddrEnable1=trapIpaddrEnable1, trapv1Enable=trapv1Enable, outboundEthernetThroughput=outboundEthernetThroughput, radioReboot=radioReboot, productsAllObjects=productsAllObjects, interface=interface, fileManagement=fileManagement, remErrorDuration=remErrorDuration, trapLocRslThreshold=trapLocRslThreshold, ipLocal=ipLocal, modelNumber=modelNumber, commitNtpSettings=commitNtpSettings, interfaceType=interfaceType, productsMIBCompliances=productsMIBCompliances, trapLocRslStat=trapLocRslStat, locTe1Alarm=locTe1Alarm, locEthUtilizationWatermark=locEthUtilizationWatermark, txFreqRange=txFreqRange, almLocal=almLocal, locCurrentTemp=locCurrentTemp, productsMIBObjects=productsMIBObjects, locTe1AlarmsEntry=locTe1AlarmsEntry, remMinRSLstr=remMinRSLstr, trapIpaddrEnable4=trapIpaddrEnable4, performance=performance, radioAdmin=radioAdmin, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, te1Interfaces=te1Interfaces, remLinkStateH=remLinkStateH, remSampleDurationStr=remSampleDurationStr, serialNumber=serialNumber, ipAddressNetmask=ipAddressNetmask, locMaximumRxModulation=locMaximumRxModulation, ntpClientEnable=ntpClientEnable, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, rxFreqRange=rxFreqRange, trapRemAlarmStat=trapRemAlarmStat, locLinkSecMismatch=locLinkSecMismatch, locErrorDuration=locErrorDuration, remEthAlarms=remEthAlarms, locActiveRxModulation=locActiveRxModulation, ipRemote=ipRemote, ntpServer2IpAddr=ntpServer2IpAddr, uploadFilename=uploadFilename, partNumber=partNumber, factoryFwFilename=factoryFwFilename, te1NumChannels=te1NumChannels, te1Interface=te1Interface, commitSystemSettings=commitSystemSettings, trapIpaddr2=trapIpaddr2, fileTransfer=fileTransfer, locSampleDurationStr=locSampleDurationStr, commitAdminSettings=commitAdminSettings, subnetMask=subnetMask, rnLocal=rnLocal, remErrorDurationStr=remErrorDurationStr, remTempAlarm=remTempAlarm, locMaximumTxModulation=locMaximumTxModulation, trapIpaddr4=trapIpaddr4, hwId=hwId, tftpServerIp=tftpServerIp, PwType=PwType, trapAuth=trapAuth, remSysAlarms=remSysAlarms, locActiveTxModulation=locActiveTxModulation, licKey=licKey, commitSnmpSettings=commitSnmpSettings, alternateFwFilename=alternateFwFilename, ntpServer4IpAddr=ntpServer4IpAddr, trapLocAlarmStat=trapLocAlarmStat, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remCurrentRSLstr=remCurrentRSLstr, alarms=alarms, locMinRSL=locMinRSL, locEthPerfInterfaces=locEthPerfInterfaces, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, productsMIBConformance=productsMIBConformance, rdkDbVer=rdkDbVer, remMinRSLtimestamp=remMinRSLtimestamp, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, ntpServer1IpAddr=ntpServer1IpAddr, locEthSpeed=locEthSpeed, locSampleDuration=locSampleDuration, te1AIS=te1AIS, sysTime=sysTime, userPassword=userPassword, rfFreqBand=rfFreqBand, rnRemote=rnRemote, linkName=linkName, adminPassword=adminPassword, locCurrentBERstr=locCurrentBERstr, locEthUtilizationIn=locEthUtilizationIn, remMaxRSL=remMaxRSL, radioInfo=radioInfo, perfRemote=perfRemote, remCurrentRSL=remCurrentRSL, te1=te1, systemConfig=systemConfig)
