...
AcmModulationT, VlanStatusT, Te1LoopBackModeT, AuxNmsMode, NtpClientEnableT, AlarmLevelT, Te1LineCodeT, VlanGroupT, FileTransferStartT, EthAuxStatusT, exaltcommunications, TimeZoneT, EthMainStatusT, Led4ColorT, FileTransferTypeT, Te1StatusT, EthPortMode, ExaltEnableT, Te1LboT, EnableStatusT = mibBuilder.importSymbols("ExaltComm", "AcmModulationT", "VlanStatusT", "Te1LoopBackModeT", "AuxNmsMode", "NtpClientEnableT", "AlarmLevelT", "Te1LineCodeT", "VlanGroupT", "FileTransferStartT", "EthAuxStatusT", "exaltcommunications", "TimeZoneT", "EthMainStatusT", "Led4ColorT", "FileTransferTypeT", "Te1StatusT", "EthPortMode", "ExaltEnableT", "Te1LboT", "EnableStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", transferType=transferType, currentFwFilename=currentFwFilename, ipRemote=ipRemote, locLinkStateV=locLinkStateV, remCurrentTemp=remCurrentTemp, modelNumber=modelNumber, systemConfig=systemConfig, userPassword=userPassword, locUnavailDurationStr=locUnavailDurationStr, remCurrentRSL=remCurrentRSL, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locActiveTxModulation=locActiveTxModulation, remLinkSecMismatch=remLinkSecMismatch, trapv3Enable=trapv3Enable, factoryFwFilename=factoryFwFilename, commitSystemSettings=commitSystemSettings, trapIpaddr2=trapIpaddr2, remMinRSL=remMinRSL, locUnavailDuration=locUnavailDuration, rdkDbVer=rdkDbVer, commitSnmpSettings=commitSnmpSettings, firmwareVersion=firmwareVersion, rxFreqRange=rxFreqRange, serialNumber=serialNumber, interface=interface, fileManagement=fileManagement, remCurrentRSLstr=remCurrentRSLstr, productsMIBObjects=productsMIBObjects, perfRemote=perfRemote, productsMIBConformance=productsMIBConformance, locLinkState=locLinkState, radioInfo=radioInfo, bootVersion=bootVersion, radioMonitor=radioMonitor, productsMIBCompliances=productsMIBCompliances, te1NumChannels=te1NumChannels, te1NumActiveChannels=te1NumActiveChannels, locMinRSL=locMinRSL, locMaximumTxModulation=locMaximumTxModulation, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, txFreqRange=txFreqRange, locTe1Alarm=locTe1Alarm, remMinRSLtimestamp=remMinRSLtimestamp, radioReboot=radioReboot, trapv2cEnable=trapv2cEnable, trapIpaddr1=trapIpaddr1, locTE1Alarms=locTE1Alarms, trapIpaddrEnable3=trapIpaddrEnable3, adminPassword=adminPassword, locEthAlarms=locEthAlarms, locCurrentRSL=locCurrentRSL, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locSysAlarms=locSysAlarms, hwId=hwId, subnetMask=subnetMask, locTe1LinkSummary=locTe1LinkSummary, remTe1Alarm=remTe1Alarm, remMinRSLstr=remMinRSLstr, radioAdmin=radioAdmin, remSampleDurationStr=remSampleDurationStr, userThroughput=userThroughput, ntpServer2IpAddr=ntpServer2IpAddr, almLocal=almLocal, locEthSpeed=locEthSpeed, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locActiveRxModulation=locActiveRxModulation, locMaxRSLstr=locMaxRSLstr, trapv1Enable=trapv1Enable, ntpServer4IpAddr=ntpServer4IpAddr, trapIpaddrEnable1=trapIpaddrEnable1, uploadFilename=uploadFilename, remSysAlarms=remSysAlarms, locEthUtilizationWatermark=locEthUtilizationWatermark, ntpServer3IpAddr=ntpServer3IpAddr, locCurrentRSLstr=locCurrentRSLstr, ntpServer1IpAddr=ntpServer1IpAddr, selectT1orE1=selectT1orE1, remUnavailDurationStr=remUnavailDurationStr, commitNtpSettings=commitNtpSettings, te1Interfaces=te1Interfaces, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, aggregateUserThroughput=aggregateUserThroughput, transferStatus=transferStatus, alternateFwFilename=alternateFwFilename, locTempAlarm=locTempAlarm, ntpClientEnable=ntpClientEnable, trapIpaddrEnable2=trapIpaddrEnable2, remResetStats=remResetStats, ipLocal=ipLocal, commitAdminSettings=commitAdminSettings, locTe1AlarmsEntry=locTe1AlarmsEntry, locCurrentBER=locCurrentBER, productsAllObjects=productsAllObjects, remMaxRSLstr=remMaxRSLstr, remMaxRSL=remMaxRSL, defaultGateway=defaultGateway, radioName=radioName, trapLocRslThreshold=trapLocRslThreshold, locSampleDurationStr=locSampleDurationStr, rnLocal=rnLocal, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, remUnavailDuration=remUnavailDuration, locMinimumRxModulation=locMinimumRxModulation, licenseFeatures=licenseFeatures, locMinRSLtimestamp=locMinRSLtimestamp, performance=performance, tftpServerIp=tftpServerIp, trapIpaddr3=trapIpaddr3, locCurrentTempS=locCurrentTempS, locEthUtilizationOut=locEthUtilizationOut, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, inboundEthernetThroughput=inboundEthernetThroughput, radioConfig=radioConfig, almRemote=almRemote, locTe1Alarms=locTe1Alarms, interfaceType=interfaceType, PwType=PwType, locErrorDuration=locErrorDuration, remCurrentBER=remCurrentBER, alarms=alarms, ipAddress=ipAddress, fileTransfer=fileTransfer, trapIpaddr4=trapIpaddr4, rnRemote=rnRemote, trapLocRslStat=trapLocRslStat, remLinkState=remLinkState, remTe1LinkSummary=remTe1LinkSummary, locErrorDurationStr=locErrorDurationStr, remSampleDuration=remSampleDuration, licKey=licKey, trapLocTempStat=trapLocTempStat, outboundEthernetThroughput=outboundEthernetThroughput, te1AIS=te1AIS, te1LoopBackMode=te1LoopBackMode, PYSNMP_MODULE_ID=productsMIB, trapIpaddrEnable4=trapIpaddrEnable4, aesKey=aesKey, locMaxRSL=locMaxRSL, ipAddressNetmask=ipAddressNetmask, linkSecKey=linkSecKey, trapRemAlarmStat=trapRemAlarmStat, swapFWimage=swapFWimage, remCurrentBERstr=remCurrentBERstr, ntp=ntp, te1=te1, remCurrentTempS=remCurrentTempS, productsMIB=productsMIB, productsMIBNotifications=productsMIBNotifications, remErrorDurationStr=remErrorDurationStr, t1LBO=t1LBO, remEthAlarms=remEthAlarms, productsMIBGroups=productsMIBGroups, transferStart=transferStart, locLinkStateH=locLinkStateH, remLinkStateV=remLinkStateV, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, commitTe1Settings=commitTe1Settings, trapAuth=trapAuth, trapReboot=trapReboot, te1Interface=te1Interface, locSampleDuration=locSampleDuration, t1LineCode=t1LineCode, partNumber=partNumber, locMinimumTxModulation=locMinimumTxModulation, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, locEthUtilizationIn=locEthUtilizationIn, te1Status=te1Status, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, remTe1Alarms=remTe1Alarms, sysDate=sysDate, aesEnable=aesEnable, locMaximumRxModulation=locMaximumRxModulation, modelName=modelName, locLinkSecMismatch=locLinkSecMismatch, remLinkStateH=remLinkStateH, rfFreqBand=rfFreqBand, snmpConfig=snmpConfig, locResetStats=locResetStats, trapLocAlarmStat=trapLocAlarmStat, trapLocLinkStat=trapLocLinkStat, locCurrentBERstr=locCurrentBERstr, perfLocal=perfLocal, locMinRSLstr=locMinRSLstr, remErrorDuration=remErrorDuration, ntpTimeZoneSelect=ntpTimeZoneSelect, remTempAlarm=remTempAlarm, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locCurrentTemp=locCurrentTemp, sysTime=sysTime, linkName=linkName, remTE1Alarms=remTE1Alarms, locEthPerfInterfaces=locEthPerfInterfaces, remTe1AlarmsEntry=remTe1AlarmsEntry)
