...
EthAuxStatusT, EthPortMode, EthMainStatusT, AuxNmsMode, EnableStatusT, ExaltEnableT, Te1LboT, AcmModulationT, VlanGroupT, exaltcommunications, FileTransferStartT, Te1LineCodeT, TimeZoneT, Te1LoopBackModeT, NtpClientEnableT, Led4ColorT, Te1StatusT, VlanStatusT, AlarmLevelT, FileTransferTypeT = mibBuilder.importSymbols("ExaltComm", "EthAuxStatusT", "EthPortMode", "EthMainStatusT", "AuxNmsMode", "EnableStatusT", "ExaltEnableT", "Te1LboT", "AcmModulationT", "VlanGroupT", "exaltcommunications", "FileTransferStartT", "Te1LineCodeT", "TimeZoneT", "Te1LoopBackModeT", "NtpClientEnableT", "Led4ColorT", "Te1StatusT", "VlanStatusT", "AlarmLevelT", "FileTransferTypeT")
...
mibBuilder.exportSymbols("ExaltComProducts", te1=te1, transferType=transferType, almRemote=almRemote, locMinimumTxModulation=locMinimumTxModulation, locCurrentTempS=locCurrentTempS, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, trapv3Enable=trapv3Enable, locCurrentTemp=locCurrentTemp, trapLocAlarmStat=trapLocAlarmStat, te1NumActiveChannels=te1NumActiveChannels, locTe1LinkSummary=locTe1LinkSummary, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, ipRemote=ipRemote, radioReboot=radioReboot, subnetMask=subnetMask, interfaceType=interfaceType, rfFreqBand=rfFreqBand, remMinRSL=remMinRSL, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locCurrentRSL=locCurrentRSL, userPassword=userPassword, radioInfo=radioInfo, tftpServerIp=tftpServerIp, perfLocal=perfLocal, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, trapRemAlarmStat=trapRemAlarmStat, locSysAlarms=locSysAlarms, locMinRSLtimestamp=locMinRSLtimestamp, ntpClientEnable=ntpClientEnable, remLinkSecMismatch=remLinkSecMismatch, userThroughput=userThroughput, commitTe1Settings=commitTe1Settings, trapIpaddrEnable1=trapIpaddrEnable1, remLinkStateH=remLinkStateH, locEthUtilizationWatermark=locEthUtilizationWatermark, locCurrentBER=locCurrentBER, remCurrentRSL=remCurrentRSL, remMinRSLstr=remMinRSLstr, commitAdminSettings=commitAdminSettings, te1LoopBackMode=te1LoopBackMode, partNumber=partNumber, modelNumber=modelNumber, productsMIBConformance=productsMIBConformance, ipLocal=ipLocal, locTempAlarm=locTempAlarm, locSampleDuration=locSampleDuration, locLinkSecMismatch=locLinkSecMismatch, rnRemote=rnRemote, trapIpaddr1=trapIpaddr1, interface=interface, outboundEthernetThroughput=outboundEthernetThroughput, radioAdmin=radioAdmin, ntp=ntp, locTe1Alarm=locTe1Alarm, locMinRSL=locMinRSL, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, snmpConfig=snmpConfig, bootVersion=bootVersion, locTe1Alarms=locTe1Alarms, locMinRSLstr=locMinRSLstr, aggregateUserThroughput=aggregateUserThroughput, aesEnable=aesEnable, locEthUtilizationIn=locEthUtilizationIn, sysDate=sysDate, trapIpaddrEnable2=trapIpaddrEnable2, PwType=PwType, trapIpaddr4=trapIpaddr4, swapFWimage=swapFWimage, commitNtpSettings=commitNtpSettings, locEthAlarms=locEthAlarms, remTe1AlarmsEntry=remTe1AlarmsEntry, remCurrentBERstr=remCurrentBERstr, remCurrentRSLstr=remCurrentRSLstr, remMaxRSLstr=remMaxRSLstr, locCurrentBERstr=locCurrentBERstr, locLinkStateV=locLinkStateV, ntpServer4IpAddr=ntpServer4IpAddr, remTe1LinkSummary=remTe1LinkSummary, PYSNMP_MODULE_ID=productsMIB, factoryFwFilename=factoryFwFilename, remSampleDurationStr=remSampleDurationStr, rxFreqRange=rxFreqRange, remMinRSLtimestamp=remMinRSLtimestamp, productsMIBNotifications=productsMIBNotifications, te1Status=te1Status, fileTransfer=fileTransfer, linkName=linkName, trapIpaddrEnable3=trapIpaddrEnable3, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locCurrentRSLstr=locCurrentRSLstr, locMaximumRxModulation=locMaximumRxModulation, remResetStats=remResetStats, locActiveTxModulation=locActiveTxModulation, radioConfig=radioConfig, locLinkState=locLinkState, remSampleDuration=remSampleDuration, trapLocLinkStat=trapLocLinkStat, sysTime=sysTime, trapIpaddr3=trapIpaddr3, trapIpaddrEnable4=trapIpaddrEnable4, commitSystemSettings=commitSystemSettings, currentFwFilename=currentFwFilename, remLinkState=remLinkState, locActiveRxModulation=locActiveRxModulation, ntpServer2IpAddr=ntpServer2IpAddr, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remEthAlarms=remEthAlarms, radioMonitor=radioMonitor, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, t1LBO=t1LBO, fileManagement=fileManagement, uploadFilename=uploadFilename, txFreqRange=txFreqRange, radioName=radioName, systemConfig=systemConfig, trapLocRslThreshold=trapLocRslThreshold, adminPassword=adminPassword, productsMIBGroups=productsMIBGroups, remErrorDuration=remErrorDuration, remUnavailDurationStr=remUnavailDurationStr, te1Interface=te1Interface, inboundEthernetThroughput=inboundEthernetThroughput, almLocal=almLocal, licKey=licKey, serialNumber=serialNumber, trapLocTempStat=trapLocTempStat, trapv1Enable=trapv1Enable, ipAddress=ipAddress, trapv2cEnable=trapv2cEnable, remTE1Alarms=remTE1Alarms, defaultGateway=defaultGateway, locResetStats=locResetStats, te1AIS=te1AIS, locErrorDuration=locErrorDuration, ntpServer1IpAddr=ntpServer1IpAddr, productsMIB=productsMIB, locTe1AlarmsEntry=locTe1AlarmsEntry, rdkDbVer=rdkDbVer, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remMaxRSL=remMaxRSL, locLinkStateH=locLinkStateH, remLinkStateV=remLinkStateV, remCurrentBER=remCurrentBER, locMaximumTxModulation=locMaximumTxModulation, ipAddressNetmask=ipAddressNetmask, licenseFeatures=licenseFeatures, trapReboot=trapReboot, remCurrentTempS=remCurrentTempS, locUnavailDuration=locUnavailDuration, locMinimumRxModulation=locMinimumRxModulation, hwId=hwId, remTempAlarm=remTempAlarm, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, remUnavailDuration=remUnavailDuration, remSysAlarms=remSysAlarms, locEthSpeed=locEthSpeed, te1NumChannels=te1NumChannels, performance=performance, productsAllObjects=productsAllObjects, ntpTimeZoneSelect=ntpTimeZoneSelect, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remCurrentTemp=remCurrentTemp, t1LineCode=t1LineCode, trapLocRslStat=trapLocRslStat, selectT1orE1=selectT1orE1, locMaxRSLstr=locMaxRSLstr, remErrorDurationStr=remErrorDurationStr, transferStatus=transferStatus, commitSnmpSettings=commitSnmpSettings, locEthUtilizationOut=locEthUtilizationOut, trapIpaddr2=trapIpaddr2, remTe1Alarms=remTe1Alarms, linkSecKey=linkSecKey, firmwareVersion=firmwareVersion, locTE1Alarms=locTE1Alarms, locSampleDurationStr=locSampleDurationStr, trapAuth=trapAuth, locMaxRSL=locMaxRSL, locEthPerfInterfaces=locEthPerfInterfaces, locUnavailDurationStr=locUnavailDurationStr, remTe1Alarm=remTe1Alarm, aesKey=aesKey, locErrorDurationStr=locErrorDurationStr, te1Interfaces=te1Interfaces, rnLocal=rnLocal, perfRemote=perfRemote, productsMIBObjects=productsMIBObjects, modelName=modelName, alternateFwFilename=alternateFwFilename, productsMIBCompliances=productsMIBCompliances, alarms=alarms, transferStart=transferStart, ntpServer3IpAddr=ntpServer3IpAddr)
