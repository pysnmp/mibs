...
AuxNmsMode, FileTransferTypeT, Te1LoopBackModeT, Te1LboT, Led4ColorT, Te1StatusT, Te1LineCodeT, EthAuxStatusT, AcmModulationT, EnableStatusT, ExaltEnableT, VlanGroupT, NtpClientEnableT, exaltcommunications, EthPortMode, EthMainStatusT, TimeZoneT, FileTransferStartT, VlanStatusT, AlarmLevelT = mibBuilder.importSymbols("ExaltComm", "AuxNmsMode", "FileTransferTypeT", "Te1LoopBackModeT", "Te1LboT", "Led4ColorT", "Te1StatusT", "Te1LineCodeT", "EthAuxStatusT", "AcmModulationT", "EnableStatusT", "ExaltEnableT", "VlanGroupT", "NtpClientEnableT", "exaltcommunications", "EthPortMode", "EthMainStatusT", "TimeZoneT", "FileTransferStartT", "VlanStatusT", "AlarmLevelT")
...
mibBuilder.exportSymbols("ExaltComProducts", locErrorDuration=locErrorDuration, remSampleDuration=remSampleDuration, productsMIBNotifications=productsMIBNotifications, locSysAlarms=locSysAlarms, productsMIBConformance=productsMIBConformance, fileManagement=fileManagement, rnRemote=rnRemote, partNumber=partNumber, locTe1Alarms=locTe1Alarms, ipAddress=ipAddress, trapLocTempStat=trapLocTempStat, commitTe1Settings=commitTe1Settings, locCurrentBERstr=locCurrentBERstr, remSampleDurationStr=remSampleDurationStr, locLinkStateH=locLinkStateH, selectT1orE1=selectT1orE1, remLinkStateH=remLinkStateH, locEthUtilizationOut=locEthUtilizationOut, trapv1Enable=trapv1Enable, tftpServerIp=tftpServerIp, locCurrentBER=locCurrentBER, locMaxRSLstr=locMaxRSLstr, defaultGateway=defaultGateway, rfFreqBand=rfFreqBand, linkSecKey=linkSecKey, almRemote=almRemote, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, userThroughput=userThroughput, remLinkSecMismatch=remLinkSecMismatch, locLinkState=locLinkState, locTe1Alarm=locTe1Alarm, remTe1LinkSummary=remTe1LinkSummary, rdkDbVer=rdkDbVer, productsMIBCompliances=productsMIBCompliances, ipLocal=ipLocal, remMaxRSL=remMaxRSL, te1=te1, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, fileTransfer=fileTransfer, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, inboundEthernetThroughput=inboundEthernetThroughput, ntpServer4IpAddr=ntpServer4IpAddr, rxFreqRange=rxFreqRange, locMaximumTxModulation=locMaximumTxModulation, sysDate=sysDate, remCurrentRSLstr=remCurrentRSLstr, remTe1Alarms=remTe1Alarms, remSysAlarms=remSysAlarms, outboundEthernetThroughput=outboundEthernetThroughput, te1NumChannels=te1NumChannels, userPassword=userPassword, locCurrentRSL=locCurrentRSL, aesKey=aesKey, rnLocal=rnLocal, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, remMinRSL=remMinRSL, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, ntpClientEnable=ntpClientEnable, radioMonitor=radioMonitor, serialNumber=serialNumber, adminPassword=adminPassword, PYSNMP_MODULE_ID=productsMIB, te1Status=te1Status, te1Interface=te1Interface, currentFwFilename=currentFwFilename, modelName=modelName, performance=performance, snmpConfig=snmpConfig, remErrorDuration=remErrorDuration, remErrorDurationStr=remErrorDurationStr, locSampleDuration=locSampleDuration, t1LBO=t1LBO, perfLocal=perfLocal, locResetStats=locResetStats, remLinkStateV=remLinkStateV, bootVersion=bootVersion, ipAddressNetmask=ipAddressNetmask, transferStatus=transferStatus, commitSnmpSettings=commitSnmpSettings, productsMIB=productsMIB, trapReboot=trapReboot, commitSystemSettings=commitSystemSettings, aggregateUserThroughput=aggregateUserThroughput, trapLocRslStat=trapLocRslStat, trapLocRslThreshold=trapLocRslThreshold, uploadFilename=uploadFilename, te1AIS=te1AIS, remTe1AlarmsEntry=remTe1AlarmsEntry, locCurrentRSLstr=locCurrentRSLstr, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, productsAllObjects=productsAllObjects, te1Interfaces=te1Interfaces, locTe1LinkSummary=locTe1LinkSummary, remCurrentRSL=remCurrentRSL, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locMinRSLtimestamp=locMinRSLtimestamp, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, radioReboot=radioReboot, sysTime=sysTime, swapFWimage=swapFWimage, interfaceType=interfaceType, locEthAlarms=locEthAlarms, locCurrentTempS=locCurrentTempS, transferStart=transferStart, locEthUtilizationWatermark=locEthUtilizationWatermark, modelNumber=modelNumber, locUnavailDuration=locUnavailDuration, te1NumActiveChannels=te1NumActiveChannels, locTE1Alarms=locTE1Alarms, txFreqRange=txFreqRange, locActiveTxModulation=locActiveTxModulation, remUnavailDuration=remUnavailDuration, PwType=PwType, trapIpaddr3=trapIpaddr3, te1LoopBackMode=te1LoopBackMode, almLocal=almLocal, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, productsMIBGroups=productsMIBGroups, transferType=transferType, locEthSpeed=locEthSpeed, aesEnable=aesEnable, ntp=ntp, alarms=alarms, locMinimumTxModulation=locMinimumTxModulation, radioAdmin=radioAdmin, trapRemAlarmStat=trapRemAlarmStat, remLinkState=remLinkState, productsMIBObjects=productsMIBObjects, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, perfRemote=perfRemote, remUnavailDurationStr=remUnavailDurationStr, trapv2cEnable=trapv2cEnable, trapIpaddr1=trapIpaddr1, linkName=linkName, remMinRSLtimestamp=remMinRSLtimestamp, ntpServer3IpAddr=ntpServer3IpAddr, radioInfo=radioInfo, trapIpaddrEnable3=trapIpaddrEnable3, locCurrentTemp=locCurrentTemp, trapIpaddrEnable2=trapIpaddrEnable2, ntpServer1IpAddr=ntpServer1IpAddr, remMinRSLstr=remMinRSLstr, remResetStats=remResetStats, locErrorDurationStr=locErrorDurationStr, subnetMask=subnetMask, trapIpaddr4=trapIpaddr4, radioConfig=radioConfig, locEthUtilizationIn=locEthUtilizationIn, trapIpaddrEnable1=trapIpaddrEnable1, interface=interface, locTempAlarm=locTempAlarm, remEthAlarms=remEthAlarms, trapAuth=trapAuth, radioName=radioName, t1LineCode=t1LineCode, licKey=licKey, locUnavailDurationStr=locUnavailDurationStr, remCurrentBER=remCurrentBER, hwId=hwId, firmwareVersion=firmwareVersion, locMinRSL=locMinRSL, locLinkStateV=locLinkStateV, commitNtpSettings=commitNtpSettings, locMaximumRxModulation=locMaximumRxModulation, locMinimumRxModulation=locMinimumRxModulation, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, licenseFeatures=licenseFeatures, remCurrentBERstr=remCurrentBERstr, locLinkSecMismatch=locLinkSecMismatch, locSampleDurationStr=locSampleDurationStr, locActiveRxModulation=locActiveRxModulation, trapIpaddr2=trapIpaddr2, trapIpaddrEnable4=trapIpaddrEnable4, trapLocLinkStat=trapLocLinkStat, ntpTimeZoneSelect=ntpTimeZoneSelect, remCurrentTempS=remCurrentTempS, trapLocAlarmStat=trapLocAlarmStat, commitAdminSettings=commitAdminSettings, ipRemote=ipRemote, ntpServer2IpAddr=ntpServer2IpAddr, locMinRSLstr=locMinRSLstr, remMaxRSLstr=remMaxRSLstr, systemConfig=systemConfig, remTE1Alarms=remTE1Alarms, remTempAlarm=remTempAlarm, locMaxRSL=locMaxRSL, remCurrentTemp=remCurrentTemp, locEthPerfInterfaces=locEthPerfInterfaces, alternateFwFilename=alternateFwFilename, locTe1AlarmsEntry=locTe1AlarmsEntry, trapv3Enable=trapv3Enable, remTe1Alarm=remTe1Alarm, factoryFwFilename=factoryFwFilename)
