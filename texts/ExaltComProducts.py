...
TimeZoneT, ExaltEnableT, VlanGroupT, EnableStatusT, FileTransferTypeT, AcmModulationT, exaltcommunications, Te1LineCodeT, NtpClientEnableT, Te1LboT, Te1LoopBackModeT, AuxNmsMode, AlarmLevelT, EthMainStatusT, EthAuxStatusT, Led4ColorT, FileTransferStartT, VlanStatusT, Te1StatusT, EthPortMode = mibBuilder.importSymbols("ExaltComm", "TimeZoneT", "ExaltEnableT", "VlanGroupT", "EnableStatusT", "FileTransferTypeT", "AcmModulationT", "exaltcommunications", "Te1LineCodeT", "NtpClientEnableT", "Te1LboT", "Te1LoopBackModeT", "AuxNmsMode", "AlarmLevelT", "EthMainStatusT", "EthAuxStatusT", "Led4ColorT", "FileTransferStartT", "VlanStatusT", "Te1StatusT", "EthPortMode")
...
mibBuilder.exportSymbols("ExaltComProducts", remTe1AlarmsEntry=remTe1AlarmsEntry, perfRemote=perfRemote, locMaxRSLstr=locMaxRSLstr, remErrorDuration=remErrorDuration, locMaximumRxModulation=locMaximumRxModulation, locActiveTxModulation=locActiveTxModulation, remMinRSL=remMinRSL, almRemote=almRemote, productsMIBObjects=productsMIBObjects, uploadFilename=uploadFilename, productsMIBCompliances=productsMIBCompliances, ntpServer1IpAddr=ntpServer1IpAddr, locLinkState=locLinkState, trapIpaddrEnable4=trapIpaddrEnable4, locActiveRxModulation=locActiveRxModulation, t1LineCode=t1LineCode, rnLocal=rnLocal, linkSecKey=linkSecKey, productsMIBNotifications=productsMIBNotifications, locErrorDuration=locErrorDuration, locTempAlarm=locTempAlarm, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, locMinRSLtimestamp=locMinRSLtimestamp, aesEnable=aesEnable, radioInfo=radioInfo, locCurrentBERstr=locCurrentBERstr, sysTime=sysTime, linkName=linkName, locTe1AlarmsEntry=locTe1AlarmsEntry, partNumber=partNumber, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, rdkDbVer=rdkDbVer, remTe1LinkSummary=remTe1LinkSummary, remLinkStateH=remLinkStateH, remCurrentTempS=remCurrentTempS, locUnavailDuration=locUnavailDuration, subnetMask=subnetMask, ntpServer3IpAddr=ntpServer3IpAddr, remLinkSecMismatch=remLinkSecMismatch, locCurrentRSLstr=locCurrentRSLstr, remMinRSLstr=remMinRSLstr, aggregateUserThroughput=aggregateUserThroughput, trapLocRslThreshold=trapLocRslThreshold, rfFreqBand=rfFreqBand, remLinkState=remLinkState, remCurrentRSLstr=remCurrentRSLstr, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, te1Interfaces=te1Interfaces, trapIpaddr2=trapIpaddr2, locEthUtilizationIn=locEthUtilizationIn, PYSNMP_MODULE_ID=productsMIB, ntpServer2IpAddr=ntpServer2IpAddr, locMaximumTxModulation=locMaximumTxModulation, selectT1orE1=selectT1orE1, productsMIBGroups=productsMIBGroups, commitSnmpSettings=commitSnmpSettings, productsMIBConformance=productsMIBConformance, trapIpaddr1=trapIpaddr1, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, userPassword=userPassword, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, trapLocLinkStat=trapLocLinkStat, te1NumActiveChannels=te1NumActiveChannels, almLocal=almLocal, locLinkStateV=locLinkStateV, remCurrentRSL=remCurrentRSL, trapv2cEnable=trapv2cEnable, remMaxRSLstr=remMaxRSLstr, interface=interface, ipAddressNetmask=ipAddressNetmask, transferType=transferType, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, inboundEthernetThroughput=inboundEthernetThroughput, locCurrentTemp=locCurrentTemp, transferStart=transferStart, outboundEthernetThroughput=outboundEthernetThroughput, locTe1Alarms=locTe1Alarms, modelName=modelName, remCurrentTemp=remCurrentTemp, serialNumber=serialNumber, remSysAlarms=remSysAlarms, te1Status=te1Status, trapIpaddrEnable2=trapIpaddrEnable2, ntpTimeZoneSelect=ntpTimeZoneSelect, interfaceType=interfaceType, te1=te1, perfLocal=perfLocal, fileTransfer=fileTransfer, remTE1Alarms=remTE1Alarms, locMinimumTxModulation=locMinimumTxModulation, snmpConfig=snmpConfig, currentFwFilename=currentFwFilename, locSysAlarms=locSysAlarms, locSampleDuration=locSampleDuration, locEthUtilizationWatermark=locEthUtilizationWatermark, bootVersion=bootVersion, remUnavailDurationStr=remUnavailDurationStr, locTE1Alarms=locTE1Alarms, trapLocRslStat=trapLocRslStat, locMinRSL=locMinRSL, defaultGateway=defaultGateway, aesKey=aesKey, productsMIB=productsMIB, locErrorDurationStr=locErrorDurationStr, ipLocal=ipLocal, licKey=licKey, commitNtpSettings=commitNtpSettings, locTe1Alarm=locTe1Alarm, locCurrentBER=locCurrentBER, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, te1Interface=te1Interface, systemConfig=systemConfig, ntpServer4IpAddr=ntpServer4IpAddr, trapIpaddrEnable1=trapIpaddrEnable1, locEthUtilizationOut=locEthUtilizationOut, alarms=alarms, radioConfig=radioConfig, te1AIS=te1AIS, remTe1Alarms=remTe1Alarms, trapv3Enable=trapv3Enable, remCurrentBER=remCurrentBER, remSampleDuration=remSampleDuration, trapRemAlarmStat=trapRemAlarmStat, locEthPerfInterfaces=locEthPerfInterfaces, hwId=hwId, remTe1Alarm=remTe1Alarm, trapIpaddr4=trapIpaddr4, ipRemote=ipRemote, locMinimumRxModulation=locMinimumRxModulation, PwType=PwType, tftpServerIp=tftpServerIp, locCurrentRSL=locCurrentRSL, factoryFwFilename=factoryFwFilename, locResetStats=locResetStats, modelNumber=modelNumber, sysDate=sysDate, commitTe1Settings=commitTe1Settings, productsAllObjects=productsAllObjects, locEthAlarms=locEthAlarms, remMinRSLtimestamp=remMinRSLtimestamp, trapReboot=trapReboot, radioName=radioName, licenseFeatures=licenseFeatures, txFreqRange=txFreqRange, rxFreqRange=rxFreqRange, radioReboot=radioReboot, trapv1Enable=trapv1Enable, remUnavailDuration=remUnavailDuration, swapFWimage=swapFWimage, ipAddress=ipAddress, remCurrentBERstr=remCurrentBERstr, remErrorDurationStr=remErrorDurationStr, ntp=ntp, radioMonitor=radioMonitor, trapIpaddr3=trapIpaddr3, performance=performance, te1LoopBackMode=te1LoopBackMode, locMaxRSL=locMaxRSL, userThroughput=userThroughput, trapLocTempStat=trapLocTempStat, fileManagement=fileManagement, locSampleDurationStr=locSampleDurationStr, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locCurrentTempS=locCurrentTempS, locLinkSecMismatch=locLinkSecMismatch, locEthSpeed=locEthSpeed, remTempAlarm=remTempAlarm, trapIpaddrEnable3=trapIpaddrEnable3, commitSystemSettings=commitSystemSettings, radioAdmin=radioAdmin, locTe1LinkSummary=locTe1LinkSummary, alternateFwFilename=alternateFwFilename, t1LBO=t1LBO, remMaxRSL=remMaxRSL, locLinkStateH=locLinkStateH, te1NumChannels=te1NumChannels, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, commitAdminSettings=commitAdminSettings, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, adminPassword=adminPassword, rnRemote=rnRemote, ntpClientEnable=ntpClientEnable, firmwareVersion=firmwareVersion, remLinkStateV=remLinkStateV, locUnavailDurationStr=locUnavailDurationStr, transferStatus=transferStatus, remSampleDurationStr=remSampleDurationStr, trapLocAlarmStat=trapLocAlarmStat, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, trapAuth=trapAuth, locMinRSLstr=locMinRSLstr, remEthAlarms=remEthAlarms, remResetStats=remResetStats)
