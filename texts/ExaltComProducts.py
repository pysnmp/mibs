...
EthMainStatusT, FileTransferStartT, Te1StatusT, AlarmLevelT, TimeZoneT, EthPortMode, exaltcommunications, VlanGroupT, ExaltEnableT, FileTransferTypeT, NtpClientEnableT, AuxNmsMode, Te1LoopBackModeT, Te1LineCodeT, VlanStatusT, EthAuxStatusT, Te1LboT, AcmModulationT, Led4ColorT, EnableStatusT = mibBuilder.importSymbols("ExaltComm", "EthMainStatusT", "FileTransferStartT", "Te1StatusT", "AlarmLevelT", "TimeZoneT", "EthPortMode", "exaltcommunications", "VlanGroupT", "ExaltEnableT", "FileTransferTypeT", "NtpClientEnableT", "AuxNmsMode", "Te1LoopBackModeT", "Te1LineCodeT", "VlanStatusT", "EthAuxStatusT", "Te1LboT", "AcmModulationT", "Led4ColorT", "EnableStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", locMinimumRxModulation=locMinimumRxModulation, factoryFwFilename=factoryFwFilename, trapv2cEnable=trapv2cEnable, remLinkSecMismatch=remLinkSecMismatch, trapIpaddr4=trapIpaddr4, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, t1LBO=t1LBO, fileTransfer=fileTransfer, locSysAlarms=locSysAlarms, interfaceType=interfaceType, trapIpaddr3=trapIpaddr3, trapv1Enable=trapv1Enable, aesKey=aesKey, locLinkStateH=locLinkStateH, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, systemConfig=systemConfig, PYSNMP_MODULE_ID=productsMIB, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, productsMIBGroups=productsMIBGroups, remMinRSLtimestamp=remMinRSLtimestamp, commitSystemSettings=commitSystemSettings, linkName=linkName, remCurrentTempS=remCurrentTempS, locMaxRSLstr=locMaxRSLstr, commitNtpSettings=commitNtpSettings, locTe1LinkSummary=locTe1LinkSummary, trapIpaddrEnable2=trapIpaddrEnable2, PwType=PwType, remUnavailDurationStr=remUnavailDurationStr, remEthAlarms=remEthAlarms, productsMIBCompliances=productsMIBCompliances, txFreqRange=txFreqRange, trapIpaddrEnable4=trapIpaddrEnable4, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, rnRemote=rnRemote, locMinRSLtimestamp=locMinRSLtimestamp, locResetStats=locResetStats, remSampleDurationStr=remSampleDurationStr, trapIpaddr2=trapIpaddr2, productsMIBNotifications=productsMIBNotifications, tftpServerIp=tftpServerIp, trapv3Enable=trapv3Enable, remTe1Alarm=remTe1Alarm, ipAddressNetmask=ipAddressNetmask, sysDate=sysDate, te1Interface=te1Interface, remLinkStateV=remLinkStateV, remTe1LinkSummary=remTe1LinkSummary, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remCurrentBERstr=remCurrentBERstr, remUnavailDuration=remUnavailDuration, locEthSpeed=locEthSpeed, remSampleDuration=remSampleDuration, productsAllObjects=productsAllObjects, locTempAlarm=locTempAlarm, fileManagement=fileManagement, locLinkSecMismatch=locLinkSecMismatch, radioAdmin=radioAdmin, ntpServer3IpAddr=ntpServer3IpAddr, remErrorDuration=remErrorDuration, trapIpaddr1=trapIpaddr1, locMaximumRxModulation=locMaximumRxModulation, swapFWimage=swapFWimage, locErrorDurationStr=locErrorDurationStr, trapLocLinkStat=trapLocLinkStat, locErrorDuration=locErrorDuration, firmwareVersion=firmwareVersion, aesEnable=aesEnable, remMinRSLstr=remMinRSLstr, remMaxRSLstr=remMaxRSLstr, te1LoopBackMode=te1LoopBackMode, locLinkState=locLinkState, locCurrentBER=locCurrentBER, remErrorDurationStr=remErrorDurationStr, remSysAlarms=remSysAlarms, locEthAlarms=locEthAlarms, userPassword=userPassword, licKey=licKey, trapReboot=trapReboot, remMinRSL=remMinRSL, transferStatus=transferStatus, modelName=modelName, locActiveRxModulation=locActiveRxModulation, te1AIS=te1AIS, rdkDbVer=rdkDbVer, remCurrentTemp=remCurrentTemp, adminPassword=adminPassword, snmpConfig=snmpConfig, radioReboot=radioReboot, bootVersion=bootVersion, commitTe1Settings=commitTe1Settings, productsMIBConformance=productsMIBConformance, commitSnmpSettings=commitSnmpSettings, remLinkState=remLinkState, almLocal=almLocal, trapAuth=trapAuth, locTe1Alarms=locTe1Alarms, productsMIBObjects=productsMIBObjects, ipRemote=ipRemote, outboundEthernetThroughput=outboundEthernetThroughput, locEthUtilizationIn=locEthUtilizationIn, locEthUtilizationOut=locEthUtilizationOut, locMinRSL=locMinRSL, perfRemote=perfRemote, te1NumActiveChannels=te1NumActiveChannels, linkSecKey=linkSecKey, rnLocal=rnLocal, locTe1AlarmsEntry=locTe1AlarmsEntry, remResetStats=remResetStats, remTe1Alarms=remTe1Alarms, locUnavailDuration=locUnavailDuration, locTe1Alarm=locTe1Alarm, te1Status=te1Status, userThroughput=userThroughput, locCurrentTempS=locCurrentTempS, defaultGateway=defaultGateway, locSampleDuration=locSampleDuration, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, trapIpaddrEnable3=trapIpaddrEnable3, trapLocRslStat=trapLocRslStat, ntpServer4IpAddr=ntpServer4IpAddr, trapLocTempStat=trapLocTempStat, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, radioInfo=radioInfo, locLinkStateV=locLinkStateV, radioConfig=radioConfig, licenseFeatures=licenseFeatures, ntp=ntp, locEthPerfInterfaces=locEthPerfInterfaces, locMinRSLstr=locMinRSLstr, sysTime=sysTime, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, ipAddress=ipAddress, remTe1AlarmsEntry=remTe1AlarmsEntry, rfFreqBand=rfFreqBand, partNumber=partNumber, locMinimumTxModulation=locMinimumTxModulation, commitAdminSettings=commitAdminSettings, subnetMask=subnetMask, trapLocAlarmStat=trapLocAlarmStat, trapIpaddrEnable1=trapIpaddrEnable1, transferStart=transferStart, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locUnavailDurationStr=locUnavailDurationStr, remCurrentBER=remCurrentBER, aggregateUserThroughput=aggregateUserThroughput, locCurrentRSLstr=locCurrentRSLstr, selectT1orE1=selectT1orE1, te1=te1, locCurrentBERstr=locCurrentBERstr, alarms=alarms, locTE1Alarms=locTE1Alarms, currentFwFilename=currentFwFilename, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, performance=performance, ntpServer2IpAddr=ntpServer2IpAddr, interface=interface, remMaxRSL=remMaxRSL, remCurrentRSL=remCurrentRSL, te1NumChannels=te1NumChannels, remLinkStateH=remLinkStateH, locMaxRSL=locMaxRSL, locSampleDurationStr=locSampleDurationStr, locMaximumTxModulation=locMaximumTxModulation, remCurrentRSLstr=remCurrentRSLstr, inboundEthernetThroughput=inboundEthernetThroughput, locEthUtilizationWatermark=locEthUtilizationWatermark, ntpTimeZoneSelect=ntpTimeZoneSelect, productsMIB=productsMIB, ntpClientEnable=ntpClientEnable, te1Interfaces=te1Interfaces, almRemote=almRemote, hwId=hwId, remTempAlarm=remTempAlarm, remTE1Alarms=remTE1Alarms, alternateFwFilename=alternateFwFilename, rxFreqRange=rxFreqRange, transferType=transferType, locActiveTxModulation=locActiveTxModulation, trapRemAlarmStat=trapRemAlarmStat, locCurrentTemp=locCurrentTemp, serialNumber=serialNumber, perfLocal=perfLocal, radioMonitor=radioMonitor, trapLocRslThreshold=trapLocRslThreshold, t1LineCode=t1LineCode, locCurrentRSL=locCurrentRSL, uploadFilename=uploadFilename, ipLocal=ipLocal, modelNumber=modelNumber, ntpServer1IpAddr=ntpServer1IpAddr, radioName=radioName)
