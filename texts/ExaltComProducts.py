...
TimeZoneT, Te1StatusT, EthAuxStatusT, EthMainStatusT, AcmModulationT, Te1LoopBackModeT, AuxNmsMode, FileTransferTypeT, EthPortMode, VlanGroupT, EnableStatusT, ExaltEnableT, Te1LboT, NtpClientEnableT, Led4ColorT, VlanStatusT, exaltcommunications, Te1LineCodeT, FileTransferStartT, AlarmLevelT = mibBuilder.importSymbols("ExaltComm", "TimeZoneT", "Te1StatusT", "EthAuxStatusT", "EthMainStatusT", "AcmModulationT", "Te1LoopBackModeT", "AuxNmsMode", "FileTransferTypeT", "EthPortMode", "VlanGroupT", "EnableStatusT", "ExaltEnableT", "Te1LboT", "NtpClientEnableT", "Led4ColorT", "VlanStatusT", "exaltcommunications", "Te1LineCodeT", "FileTransferStartT", "AlarmLevelT")
...
mibBuilder.exportSymbols("ExaltComProducts", commitSystemSettings=commitSystemSettings, remResetStats=remResetStats, locLinkStateH=locLinkStateH, txFreqRange=txFreqRange, interface=interface, remMinRSL=remMinRSL, userThroughput=userThroughput, te1NumChannels=te1NumChannels, locSysAlarms=locSysAlarms, remCurrentTemp=remCurrentTemp, locUnavailDuration=locUnavailDuration, remTempAlarm=remTempAlarm, defaultGateway=defaultGateway, trapIpaddr2=trapIpaddr2, locTempAlarm=locTempAlarm, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, bootVersion=bootVersion, te1=te1, remTE1Alarms=remTE1Alarms, t1LineCode=t1LineCode, subnetMask=subnetMask, te1LoopBackMode=te1LoopBackMode, remErrorDurationStr=remErrorDurationStr, ntpClientEnable=ntpClientEnable, remMaxRSL=remMaxRSL, radioReboot=radioReboot, hwId=hwId, trapIpaddrEnable1=trapIpaddrEnable1, linkSecKey=linkSecKey, aesKey=aesKey, ntpServer1IpAddr=ntpServer1IpAddr, locCurrentTemp=locCurrentTemp, outboundEthernetThroughput=outboundEthernetThroughput, trapv3Enable=trapv3Enable, trapLocRslStat=trapLocRslStat, selectT1orE1=selectT1orE1, almRemote=almRemote, ntpServer2IpAddr=ntpServer2IpAddr, locEthUtilizationWatermark=locEthUtilizationWatermark, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, adminPassword=adminPassword, trapIpaddrEnable4=trapIpaddrEnable4, trapLocAlarmStat=trapLocAlarmStat, PwType=PwType, aesEnable=aesEnable, locEthAlarms=locEthAlarms, currentFwFilename=currentFwFilename, userPassword=userPassword, locCurrentBER=locCurrentBER, remUnavailDuration=remUnavailDuration, radioConfig=radioConfig, remLinkSecMismatch=remLinkSecMismatch, ntpServer4IpAddr=ntpServer4IpAddr, rdkDbVer=rdkDbVer, locTe1Alarms=locTe1Alarms, rfFreqBand=rfFreqBand, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, te1AIS=te1AIS, remSampleDuration=remSampleDuration, linkName=linkName, modelName=modelName, trapRemAlarmStat=trapRemAlarmStat, ntpServer3IpAddr=ntpServer3IpAddr, locErrorDurationStr=locErrorDurationStr, remCurrentTempS=remCurrentTempS, perfLocal=perfLocal, productsMIBConformance=productsMIBConformance, performance=performance, remMaxRSLstr=remMaxRSLstr, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, serialNumber=serialNumber, commitTe1Settings=commitTe1Settings, ipAddress=ipAddress, locMinimumRxModulation=locMinimumRxModulation, transferStart=transferStart, inboundEthernetThroughput=inboundEthernetThroughput, locTe1Alarm=locTe1Alarm, productsMIB=productsMIB, ipRemote=ipRemote, fileManagement=fileManagement, alarms=alarms, locCurrentRSLstr=locCurrentRSLstr, locMinRSL=locMinRSL, locEthSpeed=locEthSpeed, remTe1Alarms=remTe1Alarms, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remCurrentBER=remCurrentBER, trapIpaddr3=trapIpaddr3, locCurrentTempS=locCurrentTempS, remLinkStateV=remLinkStateV, trapAuth=trapAuth, ipLocal=ipLocal, transferStatus=transferStatus, locLinkState=locLinkState, locUnavailDurationStr=locUnavailDurationStr, te1NumActiveChannels=te1NumActiveChannels, locActiveRxModulation=locActiveRxModulation, commitNtpSettings=commitNtpSettings, remCurrentBERstr=remCurrentBERstr, swapFWimage=swapFWimage, remLinkState=remLinkState, remErrorDuration=remErrorDuration, locEthUtilizationIn=locEthUtilizationIn, locResetStats=locResetStats, locCurrentBERstr=locCurrentBERstr, rnLocal=rnLocal, snmpConfig=snmpConfig, remCurrentRSLstr=remCurrentRSLstr, remTe1AlarmsEntry=remTe1AlarmsEntry, trapIpaddrEnable2=trapIpaddrEnable2, partNumber=partNumber, trapv1Enable=trapv1Enable, almLocal=almLocal, rnRemote=rnRemote, locEthPerfInterfaces=locEthPerfInterfaces, rxFreqRange=rxFreqRange, remSysAlarms=remSysAlarms, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, aggregateUserThroughput=aggregateUserThroughput, locMaximumTxModulation=locMaximumTxModulation, locMinRSLtimestamp=locMinRSLtimestamp, te1Status=te1Status, productsMIBObjects=productsMIBObjects, productsMIBNotifications=productsMIBNotifications, ipAddressNetmask=ipAddressNetmask, trapIpaddrEnable3=trapIpaddrEnable3, productsMIBCompliances=productsMIBCompliances, locMaxRSL=locMaxRSL, sysTime=sysTime, uploadFilename=uploadFilename, remTe1Alarm=remTe1Alarm, locMinimumTxModulation=locMinimumTxModulation, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, trapIpaddr4=trapIpaddr4, trapReboot=trapReboot, trapLocRslThreshold=trapLocRslThreshold, locMaximumRxModulation=locMaximumRxModulation, remMinRSLstr=remMinRSLstr, interfaceType=interfaceType, remSampleDurationStr=remSampleDurationStr, locMaxRSLstr=locMaxRSLstr, commitAdminSettings=commitAdminSettings, locActiveTxModulation=locActiveTxModulation, locEthUtilizationOut=locEthUtilizationOut, commitSnmpSettings=commitSnmpSettings, trapv2cEnable=trapv2cEnable, remTe1LinkSummary=remTe1LinkSummary, licenseFeatures=licenseFeatures, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, fileTransfer=fileTransfer, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locErrorDuration=locErrorDuration, tftpServerIp=tftpServerIp, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, productsAllObjects=productsAllObjects, trapLocTempStat=trapLocTempStat, locSampleDurationStr=locSampleDurationStr, sysDate=sysDate, licKey=licKey, transferType=transferType, remUnavailDurationStr=remUnavailDurationStr, locTe1LinkSummary=locTe1LinkSummary, remMinRSLtimestamp=remMinRSLtimestamp, radioName=radioName, remLinkStateH=remLinkStateH, productsMIBGroups=productsMIBGroups, radioAdmin=radioAdmin, remCurrentRSL=remCurrentRSL, ntpTimeZoneSelect=ntpTimeZoneSelect, te1Interfaces=te1Interfaces, trapIpaddr1=trapIpaddr1, alternateFwFilename=alternateFwFilename, modelNumber=modelNumber, systemConfig=systemConfig, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, perfRemote=perfRemote, t1LBO=t1LBO, factoryFwFilename=factoryFwFilename, radioInfo=radioInfo, trapLocLinkStat=trapLocLinkStat, locLinkStateV=locLinkStateV, PYSNMP_MODULE_ID=productsMIB, locTe1AlarmsEntry=locTe1AlarmsEntry, locMinRSLstr=locMinRSLstr, radioMonitor=radioMonitor, locLinkSecMismatch=locLinkSecMismatch, ntp=ntp, firmwareVersion=firmwareVersion, locSampleDuration=locSampleDuration, te1Interface=te1Interface, locCurrentRSL=locCurrentRSL, locTE1Alarms=locTE1Alarms, remEthAlarms=remEthAlarms)
