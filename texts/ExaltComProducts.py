...
Te1LineCodeT, AcmModulationT, NtpClientEnableT, TimeZoneT, FileTransferStartT, ExaltEnableT, FileTransferTypeT, AlarmLevelT, Te1LoopBackModeT, exaltcommunications, Te1LboT, Te1StatusT, EnableStatusT, EthAuxStatusT, EthMainStatusT, Led4ColorT, EthPortMode, AuxNmsMode, VlanStatusT, VlanGroupT = mibBuilder.importSymbols("ExaltComm", "Te1LineCodeT", "AcmModulationT", "NtpClientEnableT", "TimeZoneT", "FileTransferStartT", "ExaltEnableT", "FileTransferTypeT", "AlarmLevelT", "Te1LoopBackModeT", "exaltcommunications", "Te1LboT", "Te1StatusT", "EnableStatusT", "EthAuxStatusT", "EthMainStatusT", "Led4ColorT", "EthPortMode", "AuxNmsMode", "VlanStatusT", "VlanGroupT")
...
mibBuilder.exportSymbols("ExaltComProducts", te1NumActiveChannels=te1NumActiveChannels, firmwareVersion=firmwareVersion, hwId=hwId, locTe1LinkSummary=locTe1LinkSummary, locEthUtilizationOut=locEthUtilizationOut, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, bootVersion=bootVersion, radioAdmin=radioAdmin, linkSecKey=linkSecKey, commitSystemSettings=commitSystemSettings, remLinkState=remLinkState, locMinRSLstr=locMinRSLstr, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remCurrentBER=remCurrentBER, radioName=radioName, locActiveTxModulation=locActiveTxModulation, t1LBO=t1LBO, te1Status=te1Status, remCurrentTempS=remCurrentTempS, locEthSpeed=locEthSpeed, ntpClientEnable=ntpClientEnable, locTe1Alarms=locTe1Alarms, currentFwFilename=currentFwFilename, locMinRSL=locMinRSL, trapAuth=trapAuth, trapIpaddrEnable3=trapIpaddrEnable3, remLinkStateV=remLinkStateV, sysTime=sysTime, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, rdkDbVer=rdkDbVer, snmpConfig=snmpConfig, locMinimumTxModulation=locMinimumTxModulation, txFreqRange=txFreqRange, rnLocal=rnLocal, locTempAlarm=locTempAlarm, productsMIBConformance=productsMIBConformance, modelNumber=modelNumber, remTe1AlarmsEntry=remTe1AlarmsEntry, locCurrentTemp=locCurrentTemp, rfFreqBand=rfFreqBand, trapIpaddrEnable4=trapIpaddrEnable4, perfRemote=perfRemote, userThroughput=userThroughput, userPassword=userPassword, te1LoopBackMode=te1LoopBackMode, te1=te1, alarms=alarms, trapIpaddr4=trapIpaddr4, locCurrentRSL=locCurrentRSL, commitTe1Settings=commitTe1Settings, ntpServer2IpAddr=ntpServer2IpAddr, remSysAlarms=remSysAlarms, locSysAlarms=locSysAlarms, trapLocAlarmStat=trapLocAlarmStat, trapLocRslStat=trapLocRslStat, productsMIBCompliances=productsMIBCompliances, selectT1orE1=selectT1orE1, trapRemAlarmStat=trapRemAlarmStat, locTe1Alarm=locTe1Alarm, locActiveRxModulation=locActiveRxModulation, tftpServerIp=tftpServerIp, sysDate=sysDate, productsMIBNotifications=productsMIBNotifications, trapv1Enable=trapv1Enable, locMinRSLtimestamp=locMinRSLtimestamp, adminPassword=adminPassword, locLinkState=locLinkState, locMaxRSLstr=locMaxRSLstr, ipAddressNetmask=ipAddressNetmask, radioConfig=radioConfig, aesEnable=aesEnable, ntp=ntp, t1LineCode=t1LineCode, te1NumChannels=te1NumChannels, ipRemote=ipRemote, trapIpaddrEnable2=trapIpaddrEnable2, fileManagement=fileManagement, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remErrorDuration=remErrorDuration, trapLocRslThreshold=trapLocRslThreshold, alternateFwFilename=alternateFwFilename, te1Interfaces=te1Interfaces, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, trapLocTempStat=trapLocTempStat, ntpServer4IpAddr=ntpServer4IpAddr, linkName=linkName, trapIpaddrEnable1=trapIpaddrEnable1, remTe1Alarm=remTe1Alarm, locMaximumTxModulation=locMaximumTxModulation, locLinkStateH=locLinkStateH, locResetStats=locResetStats, trapIpaddr3=trapIpaddr3, serialNumber=serialNumber, trapIpaddr2=trapIpaddr2, factoryFwFilename=factoryFwFilename, te1AIS=te1AIS, transferStatus=transferStatus, swapFWimage=swapFWimage, licenseFeatures=licenseFeatures, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, remResetStats=remResetStats, defaultGateway=defaultGateway, remTempAlarm=remTempAlarm, remTe1LinkSummary=remTe1LinkSummary, trapReboot=trapReboot, locEthUtilizationWatermark=locEthUtilizationWatermark, fileTransfer=fileTransfer, locTe1AlarmsEntry=locTe1AlarmsEntry, remUnavailDurationStr=remUnavailDurationStr, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, remSampleDuration=remSampleDuration, te1Interface=te1Interface, ipAddress=ipAddress, almRemote=almRemote, locEthAlarms=locEthAlarms, locMaxRSL=locMaxRSL, transferStart=transferStart, locErrorDurationStr=locErrorDurationStr, locUnavailDuration=locUnavailDuration, aggregateUserThroughput=aggregateUserThroughput, locLinkSecMismatch=locLinkSecMismatch, remEthAlarms=remEthAlarms, locTE1Alarms=locTE1Alarms, remCurrentBERstr=remCurrentBERstr, locCurrentBERstr=locCurrentBERstr, remCurrentRSLstr=remCurrentRSLstr, trapLocLinkStat=trapLocLinkStat, interface=interface, systemConfig=systemConfig, ntpServer3IpAddr=ntpServer3IpAddr, radioMonitor=radioMonitor, remTe1Alarms=remTe1Alarms, ntpServer1IpAddr=ntpServer1IpAddr, modelName=modelName, remSampleDurationStr=remSampleDurationStr, remCurrentTemp=remCurrentTemp, locErrorDuration=locErrorDuration, locUnavailDurationStr=locUnavailDurationStr, locLinkStateV=locLinkStateV, remMinRSLtimestamp=remMinRSLtimestamp, aesKey=aesKey, productsMIBGroups=productsMIBGroups, remCurrentRSL=remCurrentRSL, uploadFilename=uploadFilename, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locCurrentRSLstr=locCurrentRSLstr, locMinimumRxModulation=locMinimumRxModulation, remLinkStateH=remLinkStateH, productsAllObjects=productsAllObjects, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, almLocal=almLocal, radioInfo=radioInfo, locSampleDuration=locSampleDuration, PYSNMP_MODULE_ID=productsMIB, rnRemote=rnRemote, commitSnmpSettings=commitSnmpSettings, locSampleDurationStr=locSampleDurationStr, locMaximumRxModulation=locMaximumRxModulation, subnetMask=subnetMask, locCurrentTempS=locCurrentTempS, ntpTimeZoneSelect=ntpTimeZoneSelect, trapv2cEnable=trapv2cEnable, partNumber=partNumber, remMinRSL=remMinRSL, radioReboot=radioReboot, licKey=licKey, trapv3Enable=trapv3Enable, remMaxRSLstr=remMaxRSLstr, remTE1Alarms=remTE1Alarms, trapIpaddr1=trapIpaddr1, productsMIB=productsMIB, productsMIBObjects=productsMIBObjects, rxFreqRange=rxFreqRange, remMaxRSL=remMaxRSL, remUnavailDuration=remUnavailDuration, locEthUtilizationIn=locEthUtilizationIn, remMinRSLstr=remMinRSLstr, remLinkSecMismatch=remLinkSecMismatch, perfLocal=perfLocal, outboundEthernetThroughput=outboundEthernetThroughput, ipLocal=ipLocal, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, locEthPerfInterfaces=locEthPerfInterfaces, remErrorDurationStr=remErrorDurationStr, interfaceType=interfaceType, inboundEthernetThroughput=inboundEthernetThroughput, transferType=transferType, commitNtpSettings=commitNtpSettings, PwType=PwType, commitAdminSettings=commitAdminSettings, performance=performance, locCurrentBER=locCurrentBER)
