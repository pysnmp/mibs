...
TimeZoneT, EnableStatusT, AlarmLevelT, VlanStatusT, exaltcommunications, Te1StatusT, EthAuxStatusT, EthMainStatusT, Te1LboT, Led4ColorT, EthPortMode, Te1LineCodeT, AuxNmsMode, FileTransferStartT, ExaltEnableT, NtpClientEnableT, FileTransferTypeT, AcmModulationT, Te1LoopBackModeT, VlanGroupT = mibBuilder.importSymbols("ExaltComm", "TimeZoneT", "EnableStatusT", "AlarmLevelT", "VlanStatusT", "exaltcommunications", "Te1StatusT", "EthAuxStatusT", "EthMainStatusT", "Te1LboT", "Led4ColorT", "EthPortMode", "Te1LineCodeT", "AuxNmsMode", "FileTransferStartT", "ExaltEnableT", "NtpClientEnableT", "FileTransferTypeT", "AcmModulationT", "Te1LoopBackModeT", "VlanGroupT")
...
mibBuilder.exportSymbols("ExaltComProducts", performance=performance, remMinRSLstr=remMinRSLstr, trapLocRslThreshold=trapLocRslThreshold, selectT1orE1=selectT1orE1, locTempAlarm=locTempAlarm, te1Status=te1Status, locErrorDuration=locErrorDuration, interfaceType=interfaceType, locCurrentBER=locCurrentBER, aesEnable=aesEnable, locCurrentTemp=locCurrentTemp, locCurrentTempS=locCurrentTempS, locTe1Alarm=locTe1Alarm, remSampleDuration=remSampleDuration, productsMIB=productsMIB, te1NumActiveChannels=te1NumActiveChannels, commitAdminSettings=commitAdminSettings, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remCurrentRSL=remCurrentRSL, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, rdkDbVer=rdkDbVer, perfRemote=perfRemote, radioReboot=radioReboot, locMinimumTxModulation=locMinimumTxModulation, locLinkSecMismatch=locLinkSecMismatch, trapRemAlarmStat=trapRemAlarmStat, adminPassword=adminPassword, almRemote=almRemote, productsMIBObjects=productsMIBObjects, remCurrentTemp=remCurrentTemp, locResetStats=locResetStats, remResetStats=remResetStats, locEthSpeed=locEthSpeed, locCurrentBERstr=locCurrentBERstr, modelNumber=modelNumber, locTe1LinkSummary=locTe1LinkSummary, locMinRSLstr=locMinRSLstr, firmwareVersion=firmwareVersion, locMinRSLtimestamp=locMinRSLtimestamp, remMinRSLtimestamp=remMinRSLtimestamp, ntpServer3IpAddr=ntpServer3IpAddr, defaultGateway=defaultGateway, remTe1Alarm=remTe1Alarm, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remMaxRSL=remMaxRSL, productsAllObjects=productsAllObjects, ntpServer1IpAddr=ntpServer1IpAddr, interface=interface, ipAddressNetmask=ipAddressNetmask, snmpConfig=snmpConfig, fileManagement=fileManagement, linkSecKey=linkSecKey, ipLocal=ipLocal, radioAdmin=radioAdmin, locSampleDurationStr=locSampleDurationStr, transferType=transferType, inboundEthernetThroughput=inboundEthernetThroughput, transferStart=transferStart, locTe1Alarms=locTe1Alarms, locTe1AlarmsEntry=locTe1AlarmsEntry, trapv1Enable=trapv1Enable, userPassword=userPassword, te1NumChannels=te1NumChannels, locUnavailDuration=locUnavailDuration, userThroughput=userThroughput, rnLocal=rnLocal, remUnavailDurationStr=remUnavailDurationStr, remTe1AlarmsEntry=remTe1AlarmsEntry, trapAuth=trapAuth, ipRemote=ipRemote, sysTime=sysTime, remTe1Alarms=remTe1Alarms, sysDate=sysDate, trapv3Enable=trapv3Enable, t1LineCode=t1LineCode, remErrorDurationStr=remErrorDurationStr, trapLocAlarmStat=trapLocAlarmStat, locSysAlarms=locSysAlarms, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, productsMIBConformance=productsMIBConformance, commitNtpSettings=commitNtpSettings, locLinkState=locLinkState, locEthUtilizationWatermark=locEthUtilizationWatermark, productsMIBGroups=productsMIBGroups, licKey=licKey, t1LBO=t1LBO, remLinkStateH=remLinkStateH, te1AIS=te1AIS, aggregateUserThroughput=aggregateUserThroughput, locActiveRxModulation=locActiveRxModulation, te1Interface=te1Interface, trapIpaddrEnable4=trapIpaddrEnable4, outboundEthernetThroughput=outboundEthernetThroughput, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, alternateFwFilename=alternateFwFilename, licenseFeatures=licenseFeatures, swapFWimage=swapFWimage, txFreqRange=txFreqRange, bootVersion=bootVersion, trapv2cEnable=trapv2cEnable, rfFreqBand=rfFreqBand, serialNumber=serialNumber, commitSnmpSettings=commitSnmpSettings, ntpServer4IpAddr=ntpServer4IpAddr, locLinkStateV=locLinkStateV, trapIpaddr1=trapIpaddr1, rnRemote=rnRemote, locMaximumRxModulation=locMaximumRxModulation, locEthAlarms=locEthAlarms, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, factoryFwFilename=factoryFwFilename, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, tftpServerIp=tftpServerIp, trapLocLinkStat=trapLocLinkStat, trapLocRslStat=trapLocRslStat, remEthAlarms=remEthAlarms, locMaxRSL=locMaxRSL, locEthUtilizationOut=locEthUtilizationOut, ntpTimeZoneSelect=ntpTimeZoneSelect, trapLocTempStat=trapLocTempStat, alarms=alarms, fileTransfer=fileTransfer, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remCurrentBERstr=remCurrentBERstr, locTE1Alarms=locTE1Alarms, locCurrentRSLstr=locCurrentRSLstr, ntpServer2IpAddr=ntpServer2IpAddr, rxFreqRange=rxFreqRange, locUnavailDurationStr=locUnavailDurationStr, te1=te1, trapIpaddrEnable1=trapIpaddrEnable1, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, linkName=linkName, PYSNMP_MODULE_ID=productsMIB, aesKey=aesKey, remTe1LinkSummary=remTe1LinkSummary, remLinkSecMismatch=remLinkSecMismatch, locCurrentRSL=locCurrentRSL, commitSystemSettings=commitSystemSettings, te1LoopBackMode=te1LoopBackMode, remMaxRSLstr=remMaxRSLstr, remSampleDurationStr=remSampleDurationStr, trapIpaddr3=trapIpaddr3, trapIpaddr4=trapIpaddr4, remCurrentRSLstr=remCurrentRSLstr, trapIpaddr2=trapIpaddr2, locMinimumRxModulation=locMinimumRxModulation, uploadFilename=uploadFilename, ntp=ntp, radioName=radioName, remMinRSL=remMinRSL, remUnavailDuration=remUnavailDuration, remCurrentTempS=remCurrentTempS, systemConfig=systemConfig, remCurrentBER=remCurrentBER, perfLocal=perfLocal, partNumber=partNumber, currentFwFilename=currentFwFilename, locMinRSL=locMinRSL, locActiveTxModulation=locActiveTxModulation, productsMIBCompliances=productsMIBCompliances, radioInfo=radioInfo, almLocal=almLocal, modelName=modelName, locEthUtilizationIn=locEthUtilizationIn, radioMonitor=radioMonitor, ipAddress=ipAddress, hwId=hwId, locMaximumTxModulation=locMaximumTxModulation, locErrorDurationStr=locErrorDurationStr, commitTe1Settings=commitTe1Settings, remLinkStateV=remLinkStateV, ntpClientEnable=ntpClientEnable, locEthPerfInterfaces=locEthPerfInterfaces, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, remErrorDuration=remErrorDuration, locSampleDuration=locSampleDuration, remTE1Alarms=remTE1Alarms, transferStatus=transferStatus, locMaxRSLstr=locMaxRSLstr, trapIpaddrEnable2=trapIpaddrEnable2, productsMIBNotifications=productsMIBNotifications, subnetMask=subnetMask, remSysAlarms=remSysAlarms, trapReboot=trapReboot, locLinkStateH=locLinkStateH, PwType=PwType, remLinkState=remLinkState, trapIpaddrEnable3=trapIpaddrEnable3, radioConfig=radioConfig, remTempAlarm=remTempAlarm, te1Interfaces=te1Interfaces)
