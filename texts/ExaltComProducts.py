...
Te1LboT, NtpClientEnableT, ExaltEnableT, Te1LineCodeT, FileTransferStartT, EthAuxStatusT, AlarmLevelT, EnableStatusT, EthMainStatusT, TimeZoneT, VlanGroupT, Te1LoopBackModeT, Led4ColorT, EthPortMode, exaltcommunications, AcmModulationT, VlanStatusT, FileTransferTypeT, AuxNmsMode, Te1StatusT = mibBuilder.importSymbols("ExaltComm", "Te1LboT", "NtpClientEnableT", "ExaltEnableT", "Te1LineCodeT", "FileTransferStartT", "EthAuxStatusT", "AlarmLevelT", "EnableStatusT", "EthMainStatusT", "TimeZoneT", "VlanGroupT", "Te1LoopBackModeT", "Led4ColorT", "EthPortMode", "exaltcommunications", "AcmModulationT", "VlanStatusT", "FileTransferTypeT", "AuxNmsMode", "Te1StatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", ipRemote=ipRemote, locTe1Alarms=locTe1Alarms, tftpServerIp=tftpServerIp, almRemote=almRemote, locMaxRSL=locMaxRSL, interface=interface, licenseFeatures=licenseFeatures, licKey=licKey, commitSnmpSettings=commitSnmpSettings, te1NumChannels=te1NumChannels, remMinRSL=remMinRSL, aesEnable=aesEnable, remCurrentBER=remCurrentBER, firmwareVersion=firmwareVersion, linkName=linkName, trapIpaddr2=trapIpaddr2, trapIpaddrEnable3=trapIpaddrEnable3, remTE1Alarms=remTE1Alarms, locTE1Alarms=locTE1Alarms, locEthUtilizationWatermark=locEthUtilizationWatermark, t1LBO=t1LBO, transferType=transferType, remTempAlarm=remTempAlarm, almLocal=almLocal, locSampleDurationStr=locSampleDurationStr, locEthUtilizationIn=locEthUtilizationIn, productsMIBCompliances=productsMIBCompliances, locMaximumRxModulation=locMaximumRxModulation, trapIpaddr3=trapIpaddr3, ntpServer3IpAddr=ntpServer3IpAddr, locUnavailDuration=locUnavailDuration, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, ntpTimeZoneSelect=ntpTimeZoneSelect, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, ipAddressNetmask=ipAddressNetmask, trapIpaddr4=trapIpaddr4, trapv2cEnable=trapv2cEnable, aesKey=aesKey, locCurrentTemp=locCurrentTemp, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, te1NumActiveChannels=te1NumActiveChannels, commitAdminSettings=commitAdminSettings, rxFreqRange=rxFreqRange, productsMIBNotifications=productsMIBNotifications, ntpServer2IpAddr=ntpServer2IpAddr, locCurrentTempS=locCurrentTempS, productsAllObjects=productsAllObjects, rnRemote=rnRemote, radioMonitor=radioMonitor, swapFWimage=swapFWimage, factoryFwFilename=factoryFwFilename, radioInfo=radioInfo, sysTime=sysTime, trapLocAlarmStat=trapLocAlarmStat, outboundEthernetThroughput=outboundEthernetThroughput, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locErrorDurationStr=locErrorDurationStr, locSampleDuration=locSampleDuration, remCurrentTemp=remCurrentTemp, te1=te1, snmpConfig=snmpConfig, trapAuth=trapAuth, remCurrentRSL=remCurrentRSL, userThroughput=userThroughput, productsMIBGroups=productsMIBGroups, perfLocal=perfLocal, locLinkState=locLinkState, sysDate=sysDate, subnetMask=subnetMask, trapIpaddrEnable1=trapIpaddrEnable1, trapRemAlarmStat=trapRemAlarmStat, trapIpaddr1=trapIpaddr1, remUnavailDuration=remUnavailDuration, trapLocRslStat=trapLocRslStat, locEthUtilizationOut=locEthUtilizationOut, locLinkStateH=locLinkStateH, remResetStats=remResetStats, remLinkStateV=remLinkStateV, transferStart=transferStart, remTe1LinkSummary=remTe1LinkSummary, remLinkState=remLinkState, remTe1Alarm=remTe1Alarm, userPassword=userPassword, radioConfig=radioConfig, commitSystemSettings=commitSystemSettings, t1LineCode=t1LineCode, rnLocal=rnLocal, locTe1AlarmsEntry=locTe1AlarmsEntry, commitTe1Settings=commitTe1Settings, locMinimumRxModulation=locMinimumRxModulation, rfFreqBand=rfFreqBand, uploadFilename=uploadFilename, locResetStats=locResetStats, ntpClientEnable=ntpClientEnable, ntp=ntp, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, productsMIB=productsMIB, locLinkStateV=locLinkStateV, fileTransfer=fileTransfer, remLinkStateH=remLinkStateH, locActiveTxModulation=locActiveTxModulation, PYSNMP_MODULE_ID=productsMIB, ntpServer1IpAddr=ntpServer1IpAddr, remUnavailDurationStr=remUnavailDurationStr, te1Status=te1Status, radioName=radioName, radioAdmin=radioAdmin, modelNumber=modelNumber, inboundEthernetThroughput=inboundEthernetThroughput, productsMIBConformance=productsMIBConformance, remErrorDuration=remErrorDuration, serialNumber=serialNumber, ntpServer4IpAddr=ntpServer4IpAddr, trapv3Enable=trapv3Enable, locMaxRSLstr=locMaxRSLstr, productsMIBObjects=productsMIBObjects, locEthAlarms=locEthAlarms, txFreqRange=txFreqRange, locEthSpeed=locEthSpeed, aggregateUserThroughput=aggregateUserThroughput, te1AIS=te1AIS, locUnavailDurationStr=locUnavailDurationStr, locCurrentBERstr=locCurrentBERstr, locMinRSLtimestamp=locMinRSLtimestamp, trapReboot=trapReboot, remSampleDurationStr=remSampleDurationStr, bootVersion=bootVersion, rdkDbVer=rdkDbVer, remCurrentTempS=remCurrentTempS, te1Interface=te1Interface, remCurrentBERstr=remCurrentBERstr, defaultGateway=defaultGateway, remLinkSecMismatch=remLinkSecMismatch, alarms=alarms, remTe1AlarmsEntry=remTe1AlarmsEntry, commitNtpSettings=commitNtpSettings, currentFwFilename=currentFwFilename, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locMinRSL=locMinRSL, radioReboot=radioReboot, trapIpaddrEnable4=trapIpaddrEnable4, trapLocTempStat=trapLocTempStat, locTempAlarm=locTempAlarm, trapv1Enable=trapv1Enable, remSysAlarms=remSysAlarms, locTe1Alarm=locTe1Alarm, interfaceType=interfaceType, fileManagement=fileManagement, locEthPerfInterfaces=locEthPerfInterfaces, locLinkSecMismatch=locLinkSecMismatch, remMinRSLtimestamp=remMinRSLtimestamp, locMinimumTxModulation=locMinimumTxModulation, alternateFwFilename=alternateFwFilename, partNumber=partNumber, remSampleDuration=remSampleDuration, remMinRSLstr=remMinRSLstr, te1LoopBackMode=te1LoopBackMode, locCurrentRSL=locCurrentRSL, remTe1Alarms=remTe1Alarms, ipLocal=ipLocal, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, locCurrentRSLstr=locCurrentRSLstr, perfRemote=perfRemote, remCurrentRSLstr=remCurrentRSLstr, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remErrorDurationStr=remErrorDurationStr, locTe1LinkSummary=locTe1LinkSummary, locMaximumTxModulation=locMaximumTxModulation, te1Interfaces=te1Interfaces, modelName=modelName, linkSecKey=linkSecKey, transferStatus=transferStatus, locErrorDuration=locErrorDuration, locCurrentBER=locCurrentBER, selectT1orE1=selectT1orE1, trapIpaddrEnable2=trapIpaddrEnable2, trapLocRslThreshold=trapLocRslThreshold, remMaxRSLstr=remMaxRSLstr, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locMinRSLstr=locMinRSLstr, remEthAlarms=remEthAlarms, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, hwId=hwId, performance=performance, systemConfig=systemConfig, trapLocLinkStat=trapLocLinkStat, remMaxRSL=remMaxRSL, PwType=PwType, adminPassword=adminPassword, ipAddress=ipAddress, locSysAlarms=locSysAlarms, locActiveRxModulation=locActiveRxModulation)
