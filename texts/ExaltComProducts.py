...
ExaltEnableT, Te1LoopBackModeT, EthMainStatusT, Te1LboT, EnableStatusT, NtpClientEnableT, AlarmLevelT, AcmModulationT, exaltcommunications, TimeZoneT, EthPortMode, VlanGroupT, Te1LineCodeT, VlanStatusT, FileTransferTypeT, EthAuxStatusT, Te1StatusT, FileTransferStartT, AuxNmsMode, Led4ColorT = mibBuilder.importSymbols("ExaltComm", "ExaltEnableT", "Te1LoopBackModeT", "EthMainStatusT", "Te1LboT", "EnableStatusT", "NtpClientEnableT", "AlarmLevelT", "AcmModulationT", "exaltcommunications", "TimeZoneT", "EthPortMode", "VlanGroupT", "Te1LineCodeT", "VlanStatusT", "FileTransferTypeT", "EthAuxStatusT", "Te1StatusT", "FileTransferStartT", "AuxNmsMode", "Led4ColorT")
...
mibBuilder.exportSymbols("ExaltComProducts", trapIpaddr4=trapIpaddr4, aesKey=aesKey, locEthUtilizationIn=locEthUtilizationIn, selectT1orE1=selectT1orE1, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, PwType=PwType, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remMaxRSLstr=remMaxRSLstr, ntpServer1IpAddr=ntpServer1IpAddr, remTe1LinkSummary=remTe1LinkSummary, locCurrentBERstr=locCurrentBERstr, locResetStats=locResetStats, PYSNMP_MODULE_ID=productsMIB, remTe1Alarms=remTe1Alarms, ipRemote=ipRemote, trapIpaddrEnable2=trapIpaddrEnable2, locSampleDuration=locSampleDuration, factoryFwFilename=factoryFwFilename, outboundEthernetThroughput=outboundEthernetThroughput, remUnavailDurationStr=remUnavailDurationStr, rnRemote=rnRemote, radioConfig=radioConfig, productsMIBGroups=productsMIBGroups, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locEthUtilizationOut=locEthUtilizationOut, locTempAlarm=locTempAlarm, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, te1AIS=te1AIS, locUnavailDurationStr=locUnavailDurationStr, productsMIBNotifications=productsMIBNotifications, remLinkSecMismatch=remLinkSecMismatch, ntp=ntp, subnetMask=subnetMask, locMaximumTxModulation=locMaximumTxModulation, defaultGateway=defaultGateway, locMinimumTxModulation=locMinimumTxModulation, alternateFwFilename=alternateFwFilename, locCurrentRSL=locCurrentRSL, locActiveRxModulation=locActiveRxModulation, locActiveTxModulation=locActiveTxModulation, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, radioMonitor=radioMonitor, sysDate=sysDate, ntpClientEnable=ntpClientEnable, productsAllObjects=productsAllObjects, locMinRSLtimestamp=locMinRSLtimestamp, locSampleDurationStr=locSampleDurationStr, trapLocRslThreshold=trapLocRslThreshold, locErrorDurationStr=locErrorDurationStr, bootVersion=bootVersion, t1LineCode=t1LineCode, licKey=licKey, snmpConfig=snmpConfig, firmwareVersion=firmwareVersion, locMaxRSL=locMaxRSL, performance=performance, trapRemAlarmStat=trapRemAlarmStat, locCurrentBER=locCurrentBER, ntpTimeZoneSelect=ntpTimeZoneSelect, ipLocal=ipLocal, commitNtpSettings=commitNtpSettings, remMinRSL=remMinRSL, currentFwFilename=currentFwFilename, remLinkState=remLinkState, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, ntpServer4IpAddr=ntpServer4IpAddr, serialNumber=serialNumber, ipAddress=ipAddress, commitTe1Settings=commitTe1Settings, locErrorDuration=locErrorDuration, modelName=modelName, commitAdminSettings=commitAdminSettings, te1LoopBackMode=te1LoopBackMode, remTE1Alarms=remTE1Alarms, userPassword=userPassword, trapLocTempStat=trapLocTempStat, ipAddressNetmask=ipAddressNetmask, adminPassword=adminPassword, rdkDbVer=rdkDbVer, inboundEthernetThroughput=inboundEthernetThroughput, remTempAlarm=remTempAlarm, locSysAlarms=locSysAlarms, remLinkStateV=remLinkStateV, interfaceType=interfaceType, te1Interface=te1Interface, aggregateUserThroughput=aggregateUserThroughput, locLinkStateH=locLinkStateH, remSampleDuration=remSampleDuration, trapLocLinkStat=trapLocLinkStat, locEthSpeed=locEthSpeed, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, radioReboot=radioReboot, trapv3Enable=trapv3Enable, radioInfo=radioInfo, remCurrentRSL=remCurrentRSL, remMinRSLtimestamp=remMinRSLtimestamp, trapIpaddr1=trapIpaddr1, locMaxRSLstr=locMaxRSLstr, rxFreqRange=rxFreqRange, sysTime=sysTime, trapIpaddrEnable4=trapIpaddrEnable4, te1Status=te1Status, systemConfig=systemConfig, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, te1NumActiveChannels=te1NumActiveChannels, locEthUtilizationWatermark=locEthUtilizationWatermark, locCurrentRSLstr=locCurrentRSLstr, tftpServerIp=tftpServerIp, partNumber=partNumber, radioAdmin=radioAdmin, trapv2cEnable=trapv2cEnable, almRemote=almRemote, modelNumber=modelNumber, locMinRSLstr=locMinRSLstr, locMinimumRxModulation=locMinimumRxModulation, trapReboot=trapReboot, remCurrentTemp=remCurrentTemp, remCurrentBER=remCurrentBER, locTe1Alarm=locTe1Alarm, remLinkStateH=remLinkStateH, locCurrentTempS=locCurrentTempS, remMaxRSL=remMaxRSL, perfRemote=perfRemote, remUnavailDuration=remUnavailDuration, trapLocRslStat=trapLocRslStat, te1Interfaces=te1Interfaces, productsMIBConformance=productsMIBConformance, locEthAlarms=locEthAlarms, remCurrentBERstr=remCurrentBERstr, aesEnable=aesEnable, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, productsMIBCompliances=productsMIBCompliances, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, trapAuth=trapAuth, remMinRSLstr=remMinRSLstr, remSampleDurationStr=remSampleDurationStr, licenseFeatures=licenseFeatures, locLinkState=locLinkState, transferStart=transferStart, interface=interface, perfLocal=perfLocal, transferStatus=transferStatus, locEthPerfInterfaces=locEthPerfInterfaces, almLocal=almLocal, locTe1LinkSummary=locTe1LinkSummary, locCurrentTemp=locCurrentTemp, locTe1AlarmsEntry=locTe1AlarmsEntry, ntpServer2IpAddr=ntpServer2IpAddr, locMaximumRxModulation=locMaximumRxModulation, swapFWimage=swapFWimage, remErrorDurationStr=remErrorDurationStr, locLinkStateV=locLinkStateV, productsMIBObjects=productsMIBObjects, transferType=transferType, rfFreqBand=rfFreqBand, locTE1Alarms=locTE1Alarms, alarms=alarms, trapIpaddrEnable3=trapIpaddrEnable3, ntpServer3IpAddr=ntpServer3IpAddr, locTe1Alarms=locTe1Alarms, txFreqRange=txFreqRange, fileManagement=fileManagement, remEthAlarms=remEthAlarms, trapv1Enable=trapv1Enable, t1LBO=t1LBO, commitSnmpSettings=commitSnmpSettings, hwId=hwId, te1NumChannels=te1NumChannels, trapIpaddr2=trapIpaddr2, productsMIB=productsMIB, te1=te1, trapIpaddrEnable1=trapIpaddrEnable1, remSysAlarms=remSysAlarms, remCurrentRSLstr=remCurrentRSLstr, radioName=radioName, linkSecKey=linkSecKey, trapIpaddr3=trapIpaddr3, remTe1AlarmsEntry=remTe1AlarmsEntry, locMinRSL=locMinRSL, remErrorDuration=remErrorDuration, fileTransfer=fileTransfer, trapLocAlarmStat=trapLocAlarmStat, userThroughput=userThroughput, remCurrentTempS=remCurrentTempS, remTe1Alarm=remTe1Alarm, locUnavailDuration=locUnavailDuration, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, rnLocal=rnLocal, remResetStats=remResetStats, uploadFilename=uploadFilename, locLinkSecMismatch=locLinkSecMismatch, linkName=linkName, commitSystemSettings=commitSystemSettings)
