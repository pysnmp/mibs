...
EnableStatusT, Te1LineCodeT, AlarmLevelT, TimeZoneT, VlanGroupT, NtpClientEnableT, FileTransferStartT, Te1LoopBackModeT, Te1LboT, AcmModulationT, FileTransferTypeT, Te1StatusT, VlanStatusT, ExaltEnableT, EthAuxStatusT, EthPortMode, EthMainStatusT, exaltcommunications, AuxNmsMode, Led4ColorT = mibBuilder.importSymbols("ExaltComm", "EnableStatusT", "Te1LineCodeT", "AlarmLevelT", "TimeZoneT", "VlanGroupT", "NtpClientEnableT", "FileTransferStartT", "Te1LoopBackModeT", "Te1LboT", "AcmModulationT", "FileTransferTypeT", "Te1StatusT", "VlanStatusT", "ExaltEnableT", "EthAuxStatusT", "EthPortMode", "EthMainStatusT", "exaltcommunications", "AuxNmsMode", "Led4ColorT")
...
mibBuilder.exportSymbols("ExaltComProducts", productsMIBConformance=productsMIBConformance, sysDate=sysDate, productsMIBNotifications=productsMIBNotifications, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locMinRSLtimestamp=locMinRSLtimestamp, aggregateUserThroughput=aggregateUserThroughput, locActiveTxModulation=locActiveTxModulation, perfLocal=perfLocal, trapIpaddr1=trapIpaddr1, locErrorDuration=locErrorDuration, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, trapAuth=trapAuth, remSampleDuration=remSampleDuration, ipRemote=ipRemote, ntpServer2IpAddr=ntpServer2IpAddr, PYSNMP_MODULE_ID=productsMIB, locLinkState=locLinkState, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, te1NumActiveChannels=te1NumActiveChannels, trapLocRslThreshold=trapLocRslThreshold, transferStart=transferStart, ipAddress=ipAddress, hwId=hwId, almRemote=almRemote, productsMIBGroups=productsMIBGroups, locEthUtilizationIn=locEthUtilizationIn, remLinkStateH=remLinkStateH, remCurrentTemp=remCurrentTemp, radioInfo=radioInfo, PwType=PwType, remMinRSLtimestamp=remMinRSLtimestamp, remUnavailDurationStr=remUnavailDurationStr, remCurrentRSL=remCurrentRSL, te1LoopBackMode=te1LoopBackMode, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, radioReboot=radioReboot, locTe1Alarm=locTe1Alarm, productsMIBObjects=productsMIBObjects, partNumber=partNumber, locMinimumTxModulation=locMinimumTxModulation, locResetStats=locResetStats, trapIpaddrEnable2=trapIpaddrEnable2, productsMIBCompliances=productsMIBCompliances, rxFreqRange=rxFreqRange, remTe1AlarmsEntry=remTe1AlarmsEntry, rnRemote=rnRemote, trapLocLinkStat=trapLocLinkStat, factoryFwFilename=factoryFwFilename, remTE1Alarms=remTE1Alarms, te1AIS=te1AIS, trapv3Enable=trapv3Enable, adminPassword=adminPassword, trapIpaddrEnable4=trapIpaddrEnable4, remSysAlarms=remSysAlarms, locCurrentRSL=locCurrentRSL, ntp=ntp, bootVersion=bootVersion, locTE1Alarms=locTE1Alarms, locTe1AlarmsEntry=locTe1AlarmsEntry, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, licenseFeatures=licenseFeatures, ntpServer3IpAddr=ntpServer3IpAddr, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remMaxRSLstr=remMaxRSLstr, ipLocal=ipLocal, te1Interfaces=te1Interfaces, commitSystemSettings=commitSystemSettings, radioConfig=radioConfig, trapIpaddr2=trapIpaddr2, remTempAlarm=remTempAlarm, locTe1LinkSummary=locTe1LinkSummary, locMinRSL=locMinRSL, locSampleDuration=locSampleDuration, radioAdmin=radioAdmin, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locEthUtilizationOut=locEthUtilizationOut, remLinkSecMismatch=remLinkSecMismatch, perfRemote=perfRemote, interfaceType=interfaceType, commitNtpSettings=commitNtpSettings, te1Interface=te1Interface, trapv2cEnable=trapv2cEnable, remResetStats=remResetStats, fileManagement=fileManagement, rdkDbVer=rdkDbVer, remMinRSL=remMinRSL, ipAddressNetmask=ipAddressNetmask, productsAllObjects=productsAllObjects, interface=interface, tftpServerIp=tftpServerIp, locUnavailDuration=locUnavailDuration, ntpServer1IpAddr=ntpServer1IpAddr, transferStatus=transferStatus, trapIpaddrEnable1=trapIpaddrEnable1, remCurrentRSLstr=remCurrentRSLstr, remMaxRSL=remMaxRSL, remErrorDuration=remErrorDuration, remTe1Alarms=remTe1Alarms, uploadFilename=uploadFilename, remLinkState=remLinkState, modelNumber=modelNumber, trapIpaddrEnable3=trapIpaddrEnable3, locCurrentRSLstr=locCurrentRSLstr, trapv1Enable=trapv1Enable, modelName=modelName, locMaxRSL=locMaxRSL, almLocal=almLocal, trapLocAlarmStat=trapLocAlarmStat, locEthAlarms=locEthAlarms, locCurrentTemp=locCurrentTemp, locCurrentTempS=locCurrentTempS, sysTime=sysTime, transferType=transferType, ntpTimeZoneSelect=ntpTimeZoneSelect, fileTransfer=fileTransfer, remTe1LinkSummary=remTe1LinkSummary, locEthPerfInterfaces=locEthPerfInterfaces, remMinRSLstr=remMinRSLstr, locEthSpeed=locEthSpeed, aesEnable=aesEnable, locSampleDurationStr=locSampleDurationStr, locLinkSecMismatch=locLinkSecMismatch, commitTe1Settings=commitTe1Settings, alternateFwFilename=alternateFwFilename, remCurrentBERstr=remCurrentBERstr, locErrorDurationStr=locErrorDurationStr, serialNumber=serialNumber, trapIpaddr4=trapIpaddr4, snmpConfig=snmpConfig, remTe1Alarm=remTe1Alarm, locCurrentBERstr=locCurrentBERstr, locMaximumRxModulation=locMaximumRxModulation, ntpClientEnable=ntpClientEnable, remUnavailDuration=remUnavailDuration, t1LineCode=t1LineCode, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, firmwareVersion=firmwareVersion, txFreqRange=txFreqRange, locLinkStateH=locLinkStateH, productsMIB=productsMIB, performance=performance, inboundEthernetThroughput=inboundEthernetThroughput, locMaximumTxModulation=locMaximumTxModulation, trapLocRslStat=trapLocRslStat, locTempAlarm=locTempAlarm, locUnavailDurationStr=locUnavailDurationStr, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, userPassword=userPassword, remSampleDurationStr=remSampleDurationStr, locTe1Alarms=locTe1Alarms, linkName=linkName, subnetMask=subnetMask, remLinkStateV=remLinkStateV, trapReboot=trapReboot, radioName=radioName, ntpServer4IpAddr=ntpServer4IpAddr, licKey=licKey, outboundEthernetThroughput=outboundEthernetThroughput, trapRemAlarmStat=trapRemAlarmStat, locMinRSLstr=locMinRSLstr, alarms=alarms, locEthUtilizationWatermark=locEthUtilizationWatermark, t1LBO=t1LBO, currentFwFilename=currentFwFilename, systemConfig=systemConfig, remErrorDurationStr=remErrorDurationStr, radioMonitor=radioMonitor, te1=te1, remCurrentTempS=remCurrentTempS, rnLocal=rnLocal, locSysAlarms=locSysAlarms, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, rfFreqBand=rfFreqBand, linkSecKey=linkSecKey, locActiveRxModulation=locActiveRxModulation, remCurrentBER=remCurrentBER, trapLocTempStat=trapLocTempStat, trapIpaddr3=trapIpaddr3, defaultGateway=defaultGateway, aesKey=aesKey, te1NumChannels=te1NumChannels, locLinkStateV=locLinkStateV, locMaxRSLstr=locMaxRSLstr, userThroughput=userThroughput, commitSnmpSettings=commitSnmpSettings, commitAdminSettings=commitAdminSettings, selectT1orE1=selectT1orE1, te1Status=te1Status, remEthAlarms=remEthAlarms, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, swapFWimage=swapFWimage, locMinimumRxModulation=locMinimumRxModulation, locCurrentBER=locCurrentBER)
