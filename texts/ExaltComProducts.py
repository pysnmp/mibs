...
VlanStatusT, EthPortMode, AuxNmsMode, NtpClientEnableT, FileTransferTypeT, AlarmLevelT, ExaltEnableT, EthMainStatusT, Te1StatusT, Te1LoopBackModeT, VlanGroupT, EthAuxStatusT, TimeZoneT, Led4ColorT, exaltcommunications, AcmModulationT, Te1LineCodeT, EnableStatusT, Te1LboT, FileTransferStartT = mibBuilder.importSymbols("ExaltComm", "VlanStatusT", "EthPortMode", "AuxNmsMode", "NtpClientEnableT", "FileTransferTypeT", "AlarmLevelT", "ExaltEnableT", "EthMainStatusT", "Te1StatusT", "Te1LoopBackModeT", "VlanGroupT", "EthAuxStatusT", "TimeZoneT", "Led4ColorT", "exaltcommunications", "AcmModulationT", "Te1LineCodeT", "EnableStatusT", "Te1LboT", "FileTransferStartT")
...
mibBuilder.exportSymbols("ExaltComProducts", rdkDbVer=rdkDbVer, locMinRSLstr=locMinRSLstr, tftpServerIp=tftpServerIp, trapIpaddrEnable4=trapIpaddrEnable4, trapIpaddrEnable2=trapIpaddrEnable2, remLinkStateH=remLinkStateH, rnRemote=rnRemote, productsMIBObjects=productsMIBObjects, trapRemAlarmStat=trapRemAlarmStat, commitSystemSettings=commitSystemSettings, remTe1LinkSummary=remTe1LinkSummary, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remLinkStateV=remLinkStateV, remErrorDuration=remErrorDuration, trapv1Enable=trapv1Enable, locTe1AlarmsEntry=locTe1AlarmsEntry, trapLocAlarmStat=trapLocAlarmStat, locUnavailDuration=locUnavailDuration, remMaxRSL=remMaxRSL, PYSNMP_MODULE_ID=productsMIB, ntp=ntp, remCurrentTempS=remCurrentTempS, trapIpaddr2=trapIpaddr2, productsMIBGroups=productsMIBGroups, locResetStats=locResetStats, remSampleDuration=remSampleDuration, locTempAlarm=locTempAlarm, trapv3Enable=trapv3Enable, trapIpaddrEnable3=trapIpaddrEnable3, remTe1AlarmsEntry=remTe1AlarmsEntry, rxFreqRange=rxFreqRange, locEthAlarms=locEthAlarms, PwType=PwType, remResetStats=remResetStats, trapLocLinkStat=trapLocLinkStat, trapLocRslThreshold=trapLocRslThreshold, te1=te1, remSysAlarms=remSysAlarms, locEthUtilizationIn=locEthUtilizationIn, rfFreqBand=rfFreqBand, locLinkState=locLinkState, radioInfo=radioInfo, locActiveTxModulation=locActiveTxModulation, firmwareVersion=firmwareVersion, locSampleDurationStr=locSampleDurationStr, almLocal=almLocal, sysTime=sysTime, locTe1Alarms=locTe1Alarms, defaultGateway=defaultGateway, locCurrentRSL=locCurrentRSL, fileTransfer=fileTransfer, selectT1orE1=selectT1orE1, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, trapReboot=trapReboot, outboundEthernetThroughput=outboundEthernetThroughput, trapIpaddr4=trapIpaddr4, radioReboot=radioReboot, locTe1LinkSummary=locTe1LinkSummary, radioMonitor=radioMonitor, te1NumChannels=te1NumChannels, locLinkSecMismatch=locLinkSecMismatch, aggregateUserThroughput=aggregateUserThroughput, te1Interfaces=te1Interfaces, uploadFilename=uploadFilename, remErrorDurationStr=remErrorDurationStr, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, linkSecKey=linkSecKey, commitAdminSettings=commitAdminSettings, productsMIBConformance=productsMIBConformance, commitTe1Settings=commitTe1Settings, modelNumber=modelNumber, locCurrentBERstr=locCurrentBERstr, remCurrentRSLstr=remCurrentRSLstr, locEthUtilizationWatermark=locEthUtilizationWatermark, locCurrentTemp=locCurrentTemp, locMaximumTxModulation=locMaximumTxModulation, remMinRSLtimestamp=remMinRSLtimestamp, locCurrentRSLstr=locCurrentRSLstr, locErrorDurationStr=locErrorDurationStr, aesKey=aesKey, locMinRSL=locMinRSL, remLinkState=remLinkState, radioAdmin=radioAdmin, remSampleDurationStr=remSampleDurationStr, sysDate=sysDate, remCurrentTemp=remCurrentTemp, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locErrorDuration=locErrorDuration, perfRemote=perfRemote, locEthUtilizationOut=locEthUtilizationOut, transferStart=transferStart, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, userPassword=userPassword, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, ntpServer3IpAddr=ntpServer3IpAddr, locMaxRSL=locMaxRSL, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, locEthPerfInterfaces=locEthPerfInterfaces, performance=performance, remCurrentBERstr=remCurrentBERstr, productsMIBCompliances=productsMIBCompliances, remTempAlarm=remTempAlarm, locMinimumTxModulation=locMinimumTxModulation, licenseFeatures=licenseFeatures, locTe1Alarm=locTe1Alarm, txFreqRange=txFreqRange, commitSnmpSettings=commitSnmpSettings, te1LoopBackMode=te1LoopBackMode, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, locMinRSLtimestamp=locMinRSLtimestamp, userThroughput=userThroughput, t1LineCode=t1LineCode, trapIpaddrEnable1=trapIpaddrEnable1, locUnavailDurationStr=locUnavailDurationStr, locMaximumRxModulation=locMaximumRxModulation, systemConfig=systemConfig, remCurrentBER=remCurrentBER, remMinRSL=remMinRSL, ntpTimeZoneSelect=ntpTimeZoneSelect, remMaxRSLstr=remMaxRSLstr, productsMIBNotifications=productsMIBNotifications, ntpServer4IpAddr=ntpServer4IpAddr, t1LBO=t1LBO, remEthAlarms=remEthAlarms, aesEnable=aesEnable, locSysAlarms=locSysAlarms, te1AIS=te1AIS, interfaceType=interfaceType, almRemote=almRemote, trapLocTempStat=trapLocTempStat, locMinimumRxModulation=locMinimumRxModulation, remUnavailDuration=remUnavailDuration, productsMIB=productsMIB, ntpServer2IpAddr=ntpServer2IpAddr, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, hwId=hwId, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, radioConfig=radioConfig, locLinkStateH=locLinkStateH, remUnavailDurationStr=remUnavailDurationStr, ipLocal=ipLocal, perfLocal=perfLocal, locActiveRxModulation=locActiveRxModulation, alternateFwFilename=alternateFwFilename, remLinkSecMismatch=remLinkSecMismatch, productsAllObjects=productsAllObjects, te1Status=te1Status, modelName=modelName, remTe1Alarms=remTe1Alarms, currentFwFilename=currentFwFilename, swapFWimage=swapFWimage, interface=interface, trapIpaddr3=trapIpaddr3, adminPassword=adminPassword, trapIpaddr1=trapIpaddr1, snmpConfig=snmpConfig, radioName=radioName, licKey=licKey, te1NumActiveChannels=te1NumActiveChannels, subnetMask=subnetMask, remMinRSLstr=remMinRSLstr, locTE1Alarms=locTE1Alarms, trapAuth=trapAuth, remTE1Alarms=remTE1Alarms, transferType=transferType, locCurrentBER=locCurrentBER, transferStatus=transferStatus, partNumber=partNumber, remTe1Alarm=remTe1Alarm, rnLocal=rnLocal, commitNtpSettings=commitNtpSettings, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, ipAddress=ipAddress, ntpServer1IpAddr=ntpServer1IpAddr, locCurrentTempS=locCurrentTempS, serialNumber=serialNumber, ipAddressNetmask=ipAddressNetmask, locMaxRSLstr=locMaxRSLstr, inboundEthernetThroughput=inboundEthernetThroughput, te1Interface=te1Interface, factoryFwFilename=factoryFwFilename, ntpClientEnable=ntpClientEnable, linkName=linkName, ipRemote=ipRemote, alarms=alarms, trapLocRslStat=trapLocRslStat, locEthSpeed=locEthSpeed, trapv2cEnable=trapv2cEnable, remCurrentRSL=remCurrentRSL, locLinkStateV=locLinkStateV, bootVersion=bootVersion, locSampleDuration=locSampleDuration, fileManagement=fileManagement)
