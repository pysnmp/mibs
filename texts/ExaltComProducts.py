...
VlanGroupT, NtpClientEnableT, Te1StatusT, AlarmLevelT, Led4ColorT, AcmModulationT, EthPortMode, EthAuxStatusT, AuxNmsMode, FileTransferTypeT, VlanStatusT, exaltcommunications, EnableStatusT, FileTransferStartT, Te1LoopBackModeT, Te1LineCodeT, Te1LboT, EthMainStatusT, TimeZoneT, ExaltEnableT = mibBuilder.importSymbols("ExaltComm", "VlanGroupT", "NtpClientEnableT", "Te1StatusT", "AlarmLevelT", "Led4ColorT", "AcmModulationT", "EthPortMode", "EthAuxStatusT", "AuxNmsMode", "FileTransferTypeT", "VlanStatusT", "exaltcommunications", "EnableStatusT", "FileTransferStartT", "Te1LoopBackModeT", "Te1LineCodeT", "Te1LboT", "EthMainStatusT", "TimeZoneT", "ExaltEnableT")
...
mibBuilder.exportSymbols("ExaltComProducts", locEthUtilizationOut=locEthUtilizationOut, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remTE1Alarms=remTE1Alarms, remCurrentBER=remCurrentBER, outboundEthernetThroughput=outboundEthernetThroughput, userThroughput=userThroughput, trapLocRslThreshold=trapLocRslThreshold, productsMIBConformance=productsMIBConformance, txFreqRange=txFreqRange, remMinRSLtimestamp=remMinRSLtimestamp, linkName=linkName, partNumber=partNumber, remEthAlarms=remEthAlarms, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, remTe1LinkSummary=remTe1LinkSummary, ipAddress=ipAddress, PwType=PwType, locMaximumRxModulation=locMaximumRxModulation, interfaceType=interfaceType, remMinRSL=remMinRSL, locCurrentRSL=locCurrentRSL, locSampleDurationStr=locSampleDurationStr, commitAdminSettings=commitAdminSettings, productsAllObjects=productsAllObjects, productsMIBGroups=productsMIBGroups, trapIpaddrEnable2=trapIpaddrEnable2, trapLocAlarmStat=trapLocAlarmStat, tftpServerIp=tftpServerIp, locLinkState=locLinkState, trapLocTempStat=trapLocTempStat, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, adminPassword=adminPassword, trapv1Enable=trapv1Enable, remCurrentTemp=remCurrentTemp, locUnavailDuration=locUnavailDuration, locResetStats=locResetStats, snmpConfig=snmpConfig, trapLocRslStat=trapLocRslStat, radioName=radioName, locCurrentBER=locCurrentBER, te1Interfaces=te1Interfaces, almRemote=almRemote, remCurrentBERstr=remCurrentBERstr, ntpServer3IpAddr=ntpServer3IpAddr, trapIpaddrEnable3=trapIpaddrEnable3, aggregateUserThroughput=aggregateUserThroughput, locTe1AlarmsEntry=locTe1AlarmsEntry, trapLocLinkStat=trapLocLinkStat, t1LBO=t1LBO, locActiveTxModulation=locActiveTxModulation, remTe1AlarmsEntry=remTe1AlarmsEntry, locMinimumRxModulation=locMinimumRxModulation, remSysAlarms=remSysAlarms, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, rnLocal=rnLocal, swapFWimage=swapFWimage, remCurrentRSLstr=remCurrentRSLstr, locLinkSecMismatch=locLinkSecMismatch, locActiveRxModulation=locActiveRxModulation, locTe1Alarm=locTe1Alarm, inboundEthernetThroughput=inboundEthernetThroughput, ipLocal=ipLocal, hwId=hwId, ntpClientEnable=ntpClientEnable, ntpServer2IpAddr=ntpServer2IpAddr, uploadFilename=uploadFilename, rfFreqBand=rfFreqBand, aesEnable=aesEnable, transferStart=transferStart, remSampleDuration=remSampleDuration, te1Status=te1Status, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, remLinkState=remLinkState, locCurrentRSLstr=locCurrentRSLstr, locSampleDuration=locSampleDuration, trapRemAlarmStat=trapRemAlarmStat, perfRemote=perfRemote, alarms=alarms, locSysAlarms=locSysAlarms, remLinkSecMismatch=remLinkSecMismatch, commitTe1Settings=commitTe1Settings, userPassword=userPassword, transferStatus=transferStatus, remUnavailDurationStr=remUnavailDurationStr, remErrorDurationStr=remErrorDurationStr, remMaxRSL=remMaxRSL, subnetMask=subnetMask, commitSnmpSettings=commitSnmpSettings, locLinkStateH=locLinkStateH, PYSNMP_MODULE_ID=productsMIB, remLinkStateH=remLinkStateH, sysDate=sysDate, te1Interface=te1Interface, remErrorDuration=remErrorDuration, locTempAlarm=locTempAlarm, fileManagement=fileManagement, locTe1Alarms=locTe1Alarms, remResetStats=remResetStats, licKey=licKey, te1NumActiveChannels=te1NumActiveChannels, trapIpaddrEnable4=trapIpaddrEnable4, remTe1Alarm=remTe1Alarm, remCurrentRSL=remCurrentRSL, remMinRSLstr=remMinRSLstr, locMinimumTxModulation=locMinimumTxModulation, te1=te1, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, t1LineCode=t1LineCode, alternateFwFilename=alternateFwFilename, commitNtpSettings=commitNtpSettings, trapIpaddr3=trapIpaddr3, trapIpaddr1=trapIpaddr1, locMaxRSLstr=locMaxRSLstr, productsMIBNotifications=productsMIBNotifications, selectT1orE1=selectT1orE1, remSampleDurationStr=remSampleDurationStr, trapIpaddrEnable1=trapIpaddrEnable1, commitSystemSettings=commitSystemSettings, trapAuth=trapAuth, radioReboot=radioReboot, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locEthPerfInterfaces=locEthPerfInterfaces, trapIpaddr4=trapIpaddr4, productsMIBObjects=productsMIBObjects, fileTransfer=fileTransfer, locCurrentBERstr=locCurrentBERstr, locCurrentTemp=locCurrentTemp, rdkDbVer=rdkDbVer, remUnavailDuration=remUnavailDuration, locEthUtilizationWatermark=locEthUtilizationWatermark, locUnavailDurationStr=locUnavailDurationStr, remCurrentTempS=remCurrentTempS, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locEthAlarms=locEthAlarms, remLinkStateV=remLinkStateV, locEthSpeed=locEthSpeed, radioAdmin=radioAdmin, transferType=transferType, te1AIS=te1AIS, modelName=modelName, radioMonitor=radioMonitor, firmwareVersion=firmwareVersion, locMaxRSL=locMaxRSL, systemConfig=systemConfig, factoryFwFilename=factoryFwFilename, locMinRSLstr=locMinRSLstr, linkSecKey=linkSecKey, ntp=ntp, remTe1Alarms=remTe1Alarms, perfLocal=perfLocal, remTempAlarm=remTempAlarm, locMinRSLtimestamp=locMinRSLtimestamp, locTE1Alarms=locTE1Alarms, bootVersion=bootVersion, serialNumber=serialNumber, locLinkStateV=locLinkStateV, locCurrentTempS=locCurrentTempS, locTe1LinkSummary=locTe1LinkSummary, trapv2cEnable=trapv2cEnable, ntpServer4IpAddr=ntpServer4IpAddr, currentFwFilename=currentFwFilename, trapReboot=trapReboot, te1LoopBackMode=te1LoopBackMode, aesKey=aesKey, almLocal=almLocal, radioInfo=radioInfo, ntpTimeZoneSelect=ntpTimeZoneSelect, productsMIBCompliances=productsMIBCompliances, locEthUtilizationIn=locEthUtilizationIn, modelNumber=modelNumber, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, licenseFeatures=licenseFeatures, ipAddressNetmask=ipAddressNetmask, locMinRSL=locMinRSL, sysTime=sysTime, ipRemote=ipRemote, ntpServer1IpAddr=ntpServer1IpAddr, radioConfig=radioConfig, rxFreqRange=rxFreqRange, performance=performance, remMaxRSLstr=remMaxRSLstr, rnRemote=rnRemote, interface=interface, defaultGateway=defaultGateway, locErrorDuration=locErrorDuration, productsMIB=productsMIB, locErrorDurationStr=locErrorDurationStr, trapIpaddr2=trapIpaddr2, trapv3Enable=trapv3Enable, te1NumChannels=te1NumChannels, locMaximumTxModulation=locMaximumTxModulation)
