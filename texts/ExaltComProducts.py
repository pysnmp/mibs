...
EthPortMode, Te1StatusT, TimeZoneT, EthAuxStatusT, ExaltEnableT, AcmModulationT, Te1LoopBackModeT, AlarmLevelT, Te1LineCodeT, VlanStatusT, FileTransferTypeT, NtpClientEnableT, Te1LboT, EthMainStatusT, AuxNmsMode, EnableStatusT, VlanGroupT, exaltcommunications, Led4ColorT, FileTransferStartT = mibBuilder.importSymbols("ExaltComm", "EthPortMode", "Te1StatusT", "TimeZoneT", "EthAuxStatusT", "ExaltEnableT", "AcmModulationT", "Te1LoopBackModeT", "AlarmLevelT", "Te1LineCodeT", "VlanStatusT", "FileTransferTypeT", "NtpClientEnableT", "Te1LboT", "EthMainStatusT", "AuxNmsMode", "EnableStatusT", "VlanGroupT", "exaltcommunications", "Led4ColorT", "FileTransferStartT")
...
mibBuilder.exportSymbols("ExaltComProducts", trapv1Enable=trapv1Enable, remCurrentRSLstr=remCurrentRSLstr, remMinRSLtimestamp=remMinRSLtimestamp, ipAddress=ipAddress, radioInfo=radioInfo, trapLocRslThreshold=trapLocRslThreshold, uploadFilename=uploadFilename, remSysAlarms=remSysAlarms, trapLocAlarmStat=trapLocAlarmStat, remEthAlarms=remEthAlarms, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, fileTransfer=fileTransfer, factoryFwFilename=factoryFwFilename, locSampleDurationStr=locSampleDurationStr, trapIpaddrEnable1=trapIpaddrEnable1, remTe1AlarmsEntry=remTe1AlarmsEntry, remLinkStateH=remLinkStateH, adminPassword=adminPassword, locTe1AlarmsEntry=locTe1AlarmsEntry, alarms=alarms, locLinkStateH=locLinkStateH, radioAdmin=radioAdmin, rnLocal=rnLocal, te1=te1, aesKey=aesKey, locCurrentBERstr=locCurrentBERstr, performance=performance, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, trapAuth=trapAuth, licKey=licKey, locTE1Alarms=locTE1Alarms, remTempAlarm=remTempAlarm, te1LoopBackMode=te1LoopBackMode, perfLocal=perfLocal, ntpTimeZoneSelect=ntpTimeZoneSelect, trapIpaddrEnable4=trapIpaddrEnable4, subnetMask=subnetMask, remTe1Alarms=remTe1Alarms, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, swapFWimage=swapFWimage, locTe1LinkSummary=locTe1LinkSummary, locLinkStateV=locLinkStateV, te1Interface=te1Interface, trapIpaddr4=trapIpaddr4, PYSNMP_MODULE_ID=productsMIB, trapIpaddr3=trapIpaddr3, productsMIBNotifications=productsMIBNotifications, te1NumActiveChannels=te1NumActiveChannels, systemConfig=systemConfig, locEthUtilizationOut=locEthUtilizationOut, selectT1orE1=selectT1orE1, rfFreqBand=rfFreqBand, txFreqRange=txFreqRange, productsMIBObjects=productsMIBObjects, ipAddressNetmask=ipAddressNetmask, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locLinkSecMismatch=locLinkSecMismatch, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, snmpConfig=snmpConfig, licenseFeatures=licenseFeatures, locMaxRSL=locMaxRSL, locResetStats=locResetStats, productsMIBConformance=productsMIBConformance, rnRemote=rnRemote, remMaxRSLstr=remMaxRSLstr, fileManagement=fileManagement, locMinRSLtimestamp=locMinRSLtimestamp, ipLocal=ipLocal, trapLocLinkStat=trapLocLinkStat, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, commitSystemSettings=commitSystemSettings, ntpServer2IpAddr=ntpServer2IpAddr, locEthUtilizationIn=locEthUtilizationIn, aggregateUserThroughput=aggregateUserThroughput, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remErrorDuration=remErrorDuration, ntp=ntp, remMinRSL=remMinRSL, locEthAlarms=locEthAlarms, almRemote=almRemote, ipRemote=ipRemote, te1Status=te1Status, linkSecKey=linkSecKey, transferStart=transferStart, aesEnable=aesEnable, locEthUtilizationWatermark=locEthUtilizationWatermark, tftpServerIp=tftpServerIp, remCurrentBER=remCurrentBER, locTempAlarm=locTempAlarm, locSysAlarms=locSysAlarms, locCurrentRSL=locCurrentRSL, trapIpaddr1=trapIpaddr1, locEthSpeed=locEthSpeed, locErrorDurationStr=locErrorDurationStr, locMinimumTxModulation=locMinimumTxModulation, transferType=transferType, linkName=linkName, commitTe1Settings=commitTe1Settings, perfRemote=perfRemote, remUnavailDurationStr=remUnavailDurationStr, userPassword=userPassword, remSampleDuration=remSampleDuration, te1Interfaces=te1Interfaces, remLinkState=remLinkState, trapRemAlarmStat=trapRemAlarmStat, locCurrentBER=locCurrentBER, productsMIBCompliances=productsMIBCompliances, ntpServer1IpAddr=ntpServer1IpAddr, interfaceType=interfaceType, outboundEthernetThroughput=outboundEthernetThroughput, locActiveTxModulation=locActiveTxModulation, trapIpaddrEnable3=trapIpaddrEnable3, userThroughput=userThroughput, defaultGateway=defaultGateway, locEthPerfInterfaces=locEthPerfInterfaces, firmwareVersion=firmwareVersion, radioName=radioName, locSampleDuration=locSampleDuration, remErrorDurationStr=remErrorDurationStr, sysTime=sysTime, trapIpaddr2=trapIpaddr2, remCurrentBERstr=remCurrentBERstr, commitSnmpSettings=commitSnmpSettings, remTe1Alarm=remTe1Alarm, trapIpaddrEnable2=trapIpaddrEnable2, remCurrentTempS=remCurrentTempS, hwId=hwId, modelName=modelName, remCurrentRSL=remCurrentRSL, trapReboot=trapReboot, t1LBO=t1LBO, t1LineCode=t1LineCode, radioConfig=radioConfig, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, trapLocTempStat=trapLocTempStat, rdkDbVer=rdkDbVer, remMaxRSL=remMaxRSL, locMinRSLstr=locMinRSLstr, productsMIBGroups=productsMIBGroups, productsAllObjects=productsAllObjects, locActiveRxModulation=locActiveRxModulation, transferStatus=transferStatus, locMaximumRxModulation=locMaximumRxModulation, modelNumber=modelNumber, remTE1Alarms=remTE1Alarms, locUnavailDurationStr=locUnavailDurationStr, remTe1LinkSummary=remTe1LinkSummary, PwType=PwType, locLinkState=locLinkState, almLocal=almLocal, sysDate=sysDate, te1NumChannels=te1NumChannels, locTe1Alarm=locTe1Alarm, locMaximumTxModulation=locMaximumTxModulation, trapv2cEnable=trapv2cEnable, remLinkStateV=remLinkStateV, currentFwFilename=currentFwFilename, ntpServer3IpAddr=ntpServer3IpAddr, remLinkSecMismatch=remLinkSecMismatch, bootVersion=bootVersion, locErrorDuration=locErrorDuration, locMaxRSLstr=locMaxRSLstr, locMinRSL=locMinRSL, ntpClientEnable=ntpClientEnable, partNumber=partNumber, locMinimumRxModulation=locMinimumRxModulation, trapLocRslStat=trapLocRslStat, serialNumber=serialNumber, alternateFwFilename=alternateFwFilename, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, radioMonitor=radioMonitor, remSampleDurationStr=remSampleDurationStr, remCurrentTemp=remCurrentTemp, locUnavailDuration=locUnavailDuration, interface=interface, ntpServer4IpAddr=ntpServer4IpAddr, rxFreqRange=rxFreqRange, te1AIS=te1AIS, remUnavailDuration=remUnavailDuration, locCurrentTemp=locCurrentTemp, commitAdminSettings=commitAdminSettings, commitNtpSettings=commitNtpSettings, remMinRSLstr=remMinRSLstr, locTe1Alarms=locTe1Alarms, locCurrentRSLstr=locCurrentRSLstr, remResetStats=remResetStats, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locCurrentTempS=locCurrentTempS, trapv3Enable=trapv3Enable, inboundEthernetThroughput=inboundEthernetThroughput, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, productsMIB=productsMIB, radioReboot=radioReboot)
