...
VlanGroupT, EthAuxStatusT, VlanStatusT, Te1StatusT, Led4ColorT, AcmModulationT, Te1LboT, EnableStatusT, FileTransferTypeT, exaltcommunications, FileTransferStartT, TimeZoneT, ExaltEnableT, NtpClientEnableT, Te1LineCodeT, Te1LoopBackModeT, AlarmLevelT, EthPortMode, EthMainStatusT, AuxNmsMode = mibBuilder.importSymbols("ExaltComm", "VlanGroupT", "EthAuxStatusT", "VlanStatusT", "Te1StatusT", "Led4ColorT", "AcmModulationT", "Te1LboT", "EnableStatusT", "FileTransferTypeT", "exaltcommunications", "FileTransferStartT", "TimeZoneT", "ExaltEnableT", "NtpClientEnableT", "Te1LineCodeT", "Te1LoopBackModeT", "AlarmLevelT", "EthPortMode", "EthMainStatusT", "AuxNmsMode")
...
mibBuilder.exportSymbols("ExaltComProducts", locCurrentRSL=locCurrentRSL, locMinRSLtimestamp=locMinRSLtimestamp, locResetStats=locResetStats, remSampleDurationStr=remSampleDurationStr, transferStatus=transferStatus, productsMIBNotifications=productsMIBNotifications, radioAdmin=radioAdmin, remTe1Alarms=remTe1Alarms, remLinkStateH=remLinkStateH, trapAuth=trapAuth, trapIpaddrEnable4=trapIpaddrEnable4, locCurrentRSLstr=locCurrentRSLstr, trapIpaddr3=trapIpaddr3, bootVersion=bootVersion, rnRemote=rnRemote, locLinkStateH=locLinkStateH, trapv2cEnable=trapv2cEnable, ntpServer1IpAddr=ntpServer1IpAddr, fileTransfer=fileTransfer, ipLocal=ipLocal, licenseFeatures=licenseFeatures, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, selectT1orE1=selectT1orE1, locTe1LinkSummary=locTe1LinkSummary, locMinRSLstr=locMinRSLstr, trapIpaddrEnable1=trapIpaddrEnable1, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remTe1Alarm=remTe1Alarm, rfFreqBand=rfFreqBand, remCurrentBER=remCurrentBER, te1AIS=te1AIS, locErrorDurationStr=locErrorDurationStr, locEthUtilizationWatermark=locEthUtilizationWatermark, remCurrentTempS=remCurrentTempS, trapLocTempStat=trapLocTempStat, te1Interfaces=te1Interfaces, sysDate=sysDate, te1LoopBackMode=te1LoopBackMode, linkSecKey=linkSecKey, te1=te1, alternateFwFilename=alternateFwFilename, locCurrentBER=locCurrentBER, licKey=licKey, swapFWimage=swapFWimage, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remLinkSecMismatch=remLinkSecMismatch, locMinRSL=locMinRSL, ntpServer3IpAddr=ntpServer3IpAddr, locActiveRxModulation=locActiveRxModulation, firmwareVersion=firmwareVersion, rdkDbVer=rdkDbVer, rnLocal=rnLocal, locMinimumTxModulation=locMinimumTxModulation, t1LineCode=t1LineCode, remUnavailDuration=remUnavailDuration, locSampleDurationStr=locSampleDurationStr, productsMIBCompliances=productsMIBCompliances, remCurrentRSLstr=remCurrentRSLstr, trapIpaddrEnable3=trapIpaddrEnable3, remCurrentTemp=remCurrentTemp, locUnavailDuration=locUnavailDuration, remCurrentBERstr=remCurrentBERstr, remMinRSL=remMinRSL, ipAddressNetmask=ipAddressNetmask, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, productsMIBConformance=productsMIBConformance, locMaxRSL=locMaxRSL, commitSnmpSettings=commitSnmpSettings, locMaximumRxModulation=locMaximumRxModulation, trapIpaddr2=trapIpaddr2, ntpClientEnable=ntpClientEnable, radioName=radioName, trapLocAlarmStat=trapLocAlarmStat, t1LBO=t1LBO, perfRemote=perfRemote, remTempAlarm=remTempAlarm, serialNumber=serialNumber, factoryFwFilename=factoryFwFilename, productsAllObjects=productsAllObjects, snmpConfig=snmpConfig, alarms=alarms, te1Status=te1Status, productsMIB=productsMIB, productsMIBObjects=productsMIBObjects, userThroughput=userThroughput, locTe1AlarmsEntry=locTe1AlarmsEntry, locLinkState=locLinkState, remMinRSLstr=remMinRSLstr, trapIpaddr1=trapIpaddr1, ntpServer4IpAddr=ntpServer4IpAddr, inboundEthernetThroughput=inboundEthernetThroughput, remMaxRSL=remMaxRSL, te1NumChannels=te1NumChannels, locTe1Alarms=locTe1Alarms, remLinkStateV=remLinkStateV, PwType=PwType, te1NumActiveChannels=te1NumActiveChannels, systemConfig=systemConfig, locUnavailDurationStr=locUnavailDurationStr, trapv1Enable=trapv1Enable, te1Interface=te1Interface, locCurrentBERstr=locCurrentBERstr, locEthUtilizationOut=locEthUtilizationOut, trapIpaddrEnable2=trapIpaddrEnable2, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, remMinRSLtimestamp=remMinRSLtimestamp, ntpTimeZoneSelect=ntpTimeZoneSelect, locCurrentTemp=locCurrentTemp, tftpServerIp=tftpServerIp, remSysAlarms=remSysAlarms, trapRemAlarmStat=trapRemAlarmStat, locMaximumTxModulation=locMaximumTxModulation, uploadFilename=uploadFilename, ntp=ntp, remTe1AlarmsEntry=remTe1AlarmsEntry, linkName=linkName, outboundEthernetThroughput=outboundEthernetThroughput, trapIpaddr4=trapIpaddr4, locErrorDuration=locErrorDuration, partNumber=partNumber, radioConfig=radioConfig, interface=interface, locEthUtilizationIn=locEthUtilizationIn, rxFreqRange=rxFreqRange, PYSNMP_MODULE_ID=productsMIB, locActiveTxModulation=locActiveTxModulation, ipAddress=ipAddress, trapLocRslStat=trapLocRslStat, radioMonitor=radioMonitor, locMaxRSLstr=locMaxRSLstr, sysTime=sysTime, commitAdminSettings=commitAdminSettings, commitSystemSettings=commitSystemSettings, commitTe1Settings=commitTe1Settings, transferType=transferType, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, aesEnable=aesEnable, trapLocLinkStat=trapLocLinkStat, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, fileManagement=fileManagement, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, remResetStats=remResetStats, remTE1Alarms=remTE1Alarms, aggregateUserThroughput=aggregateUserThroughput, remErrorDuration=remErrorDuration, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remErrorDurationStr=remErrorDurationStr, trapv3Enable=trapv3Enable, ntpServer2IpAddr=ntpServer2IpAddr, locLinkSecMismatch=locLinkSecMismatch, txFreqRange=txFreqRange, performance=performance, modelNumber=modelNumber, locTempAlarm=locTempAlarm, defaultGateway=defaultGateway, currentFwFilename=currentFwFilename, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, remMaxRSLstr=remMaxRSLstr, interfaceType=interfaceType, remTe1LinkSummary=remTe1LinkSummary, locEthAlarms=locEthAlarms, productsMIBGroups=productsMIBGroups, adminPassword=adminPassword, locTe1Alarm=locTe1Alarm, aesKey=aesKey, locEthSpeed=locEthSpeed, remCurrentRSL=remCurrentRSL, remUnavailDurationStr=remUnavailDurationStr, remSampleDuration=remSampleDuration, almRemote=almRemote, locSampleDuration=locSampleDuration, hwId=hwId, commitNtpSettings=commitNtpSettings, ipRemote=ipRemote, transferStart=transferStart, remEthAlarms=remEthAlarms, trapLocRslThreshold=trapLocRslThreshold, radioReboot=radioReboot, modelName=modelName, locLinkStateV=locLinkStateV, almLocal=almLocal, locMinimumRxModulation=locMinimumRxModulation, radioInfo=radioInfo, locCurrentTempS=locCurrentTempS, remLinkState=remLinkState, perfLocal=perfLocal, userPassword=userPassword, locEthPerfInterfaces=locEthPerfInterfaces, subnetMask=subnetMask, locTE1Alarms=locTE1Alarms, locSysAlarms=locSysAlarms, trapReboot=trapReboot)
