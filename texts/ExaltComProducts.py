...
EthMainStatusT, EthAuxStatusT, EnableStatusT, VlanStatusT, VlanGroupT, AlarmLevelT, ExaltEnableT, Led4ColorT, FileTransferStartT, Te1LineCodeT, exaltcommunications, Te1LoopBackModeT, AuxNmsMode, AcmModulationT, EthPortMode, Te1LboT, Te1StatusT, NtpClientEnableT, FileTransferTypeT, TimeZoneT = mibBuilder.importSymbols("ExaltComm", "EthMainStatusT", "EthAuxStatusT", "EnableStatusT", "VlanStatusT", "VlanGroupT", "AlarmLevelT", "ExaltEnableT", "Led4ColorT", "FileTransferStartT", "Te1LineCodeT", "exaltcommunications", "Te1LoopBackModeT", "AuxNmsMode", "AcmModulationT", "EthPortMode", "Te1LboT", "Te1StatusT", "NtpClientEnableT", "FileTransferTypeT", "TimeZoneT")
...
mibBuilder.exportSymbols("ExaltComProducts", locErrorDuration=locErrorDuration, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, hwId=hwId, trapv3Enable=trapv3Enable, remLinkStateH=remLinkStateH, remCurrentRSL=remCurrentRSL, trapReboot=trapReboot, adminPassword=adminPassword, remTempAlarm=remTempAlarm, rdkDbVer=rdkDbVer, trapRemAlarmStat=trapRemAlarmStat, almRemote=almRemote, trapIpaddr2=trapIpaddr2, remMinRSLstr=remMinRSLstr, ntpTimeZoneSelect=ntpTimeZoneSelect, remResetStats=remResetStats, transferStart=transferStart, locCurrentTempS=locCurrentTempS, aesEnable=aesEnable, sysDate=sysDate, locEthSpeed=locEthSpeed, ntp=ntp, interface=interface, ntpClientEnable=ntpClientEnable, te1NumChannels=te1NumChannels, userThroughput=userThroughput, productsMIBCompliances=productsMIBCompliances, te1Interfaces=te1Interfaces, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, productsMIBNotifications=productsMIBNotifications, ntpServer1IpAddr=ntpServer1IpAddr, currentFwFilename=currentFwFilename, locMaxRSL=locMaxRSL, productsMIBConformance=productsMIBConformance, transferType=transferType, radioMonitor=radioMonitor, locResetStats=locResetStats, locTE1Alarms=locTE1Alarms, locCurrentRSL=locCurrentRSL, remTE1Alarms=remTE1Alarms, remMinRSL=remMinRSL, tftpServerIp=tftpServerIp, factoryFwFilename=factoryFwFilename, locTe1Alarms=locTe1Alarms, locEthUtilizationWatermark=locEthUtilizationWatermark, rxFreqRange=rxFreqRange, locActiveTxModulation=locActiveTxModulation, modelName=modelName, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remCurrentBER=remCurrentBER, locMinRSL=locMinRSL, commitAdminSettings=commitAdminSettings, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remMaxRSL=remMaxRSL, locLinkStateH=locLinkStateH, remLinkState=remLinkState, almLocal=almLocal, outboundEthernetThroughput=outboundEthernetThroughput, interfaceType=interfaceType, locTe1LinkSummary=locTe1LinkSummary, PwType=PwType, remUnavailDurationStr=remUnavailDurationStr, te1AIS=te1AIS, trapIpaddr1=trapIpaddr1, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locErrorDurationStr=locErrorDurationStr, txFreqRange=txFreqRange, trapLocAlarmStat=trapLocAlarmStat, remCurrentRSLstr=remCurrentRSLstr, remTe1Alarms=remTe1Alarms, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, linkName=linkName, remCurrentTempS=remCurrentTempS, productsMIBObjects=productsMIBObjects, locCurrentBERstr=locCurrentBERstr, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, defaultGateway=defaultGateway, locTe1AlarmsEntry=locTe1AlarmsEntry, locUnavailDurationStr=locUnavailDurationStr, radioInfo=radioInfo, ipRemote=ipRemote, locCurrentTemp=locCurrentTemp, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, userPassword=userPassword, aggregateUserThroughput=aggregateUserThroughput, locCurrentBER=locCurrentBER, locMaxRSLstr=locMaxRSLstr, trapIpaddrEnable2=trapIpaddrEnable2, trapLocRslStat=trapLocRslStat, performance=performance, trapLocLinkStat=trapLocLinkStat, trapAuth=trapAuth, trapv1Enable=trapv1Enable, licKey=licKey, remMaxRSLstr=remMaxRSLstr, remErrorDurationStr=remErrorDurationStr, productsMIB=productsMIB, trapv2cEnable=trapv2cEnable, trapLocRslThreshold=trapLocRslThreshold, t1LBO=t1LBO, locEthPerfInterfaces=locEthPerfInterfaces, locActiveRxModulation=locActiveRxModulation, trapIpaddrEnable4=trapIpaddrEnable4, sysTime=sysTime, remTe1AlarmsEntry=remTe1AlarmsEntry, alternateFwFilename=alternateFwFilename, licenseFeatures=licenseFeatures, ipAddressNetmask=ipAddressNetmask, trapIpaddr3=trapIpaddr3, locEthUtilizationOut=locEthUtilizationOut, locTempAlarm=locTempAlarm, remLinkStateV=remLinkStateV, trapIpaddr4=trapIpaddr4, locLinkStateV=locLinkStateV, bootVersion=bootVersion, te1NumActiveChannels=te1NumActiveChannels, systemConfig=systemConfig, fileTransfer=fileTransfer, aesKey=aesKey, trapIpaddrEnable1=trapIpaddrEnable1, fileManagement=fileManagement, locSysAlarms=locSysAlarms, remTe1Alarm=remTe1Alarm, locMaximumTxModulation=locMaximumTxModulation, remCurrentBERstr=remCurrentBERstr, remSampleDuration=remSampleDuration, remEthAlarms=remEthAlarms, selectT1orE1=selectT1orE1, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, productsMIBGroups=productsMIBGroups, rnRemote=rnRemote, remLinkSecMismatch=remLinkSecMismatch, trapLocTempStat=trapLocTempStat, ntpServer4IpAddr=ntpServer4IpAddr, ntpServer2IpAddr=ntpServer2IpAddr, rfFreqBand=rfFreqBand, commitTe1Settings=commitTe1Settings, locLinkState=locLinkState, modelNumber=modelNumber, te1Interface=te1Interface, remTe1LinkSummary=remTe1LinkSummary, locMinRSLstr=locMinRSLstr, snmpConfig=snmpConfig, radioReboot=radioReboot, remCurrentTemp=remCurrentTemp, transferStatus=transferStatus, perfRemote=perfRemote, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, PYSNMP_MODULE_ID=productsMIB, trapIpaddrEnable3=trapIpaddrEnable3, remSampleDurationStr=remSampleDurationStr, remMinRSLtimestamp=remMinRSLtimestamp, ipAddress=ipAddress, uploadFilename=uploadFilename, locCurrentRSLstr=locCurrentRSLstr, remUnavailDuration=remUnavailDuration, locEthUtilizationIn=locEthUtilizationIn, remSysAlarms=remSysAlarms, locSampleDurationStr=locSampleDurationStr, radioConfig=radioConfig, ntpServer3IpAddr=ntpServer3IpAddr, t1LineCode=t1LineCode, locTe1Alarm=locTe1Alarm, remErrorDuration=remErrorDuration, locEthAlarms=locEthAlarms, swapFWimage=swapFWimage, ipLocal=ipLocal, te1LoopBackMode=te1LoopBackMode, radioAdmin=radioAdmin, commitSystemSettings=commitSystemSettings, linkSecKey=linkSecKey, productsAllObjects=productsAllObjects, radioName=radioName, locUnavailDuration=locUnavailDuration, inboundEthernetThroughput=inboundEthernetThroughput, locMinRSLtimestamp=locMinRSLtimestamp, te1=te1, locMinimumTxModulation=locMinimumTxModulation, te1Status=te1Status, locMaximumRxModulation=locMaximumRxModulation, locMinimumRxModulation=locMinimumRxModulation, partNumber=partNumber, serialNumber=serialNumber, rnLocal=rnLocal, commitSnmpSettings=commitSnmpSettings, subnetMask=subnetMask, alarms=alarms, locLinkSecMismatch=locLinkSecMismatch, firmwareVersion=firmwareVersion, locSampleDuration=locSampleDuration, commitNtpSettings=commitNtpSettings, perfLocal=perfLocal)
