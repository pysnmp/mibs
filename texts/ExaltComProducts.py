...
EnableStatusT, VlanStatusT, Te1StatusT, AuxNmsMode, FileTransferTypeT, Te1LboT, EthPortMode, Te1LineCodeT, AcmModulationT, ExaltEnableT, NtpClientEnableT, EthMainStatusT, AlarmLevelT, EthAuxStatusT, VlanGroupT, TimeZoneT, FileTransferStartT, Te1LoopBackModeT, exaltcommunications, Led4ColorT = mibBuilder.importSymbols("ExaltComm", "EnableStatusT", "VlanStatusT", "Te1StatusT", "AuxNmsMode", "FileTransferTypeT", "Te1LboT", "EthPortMode", "Te1LineCodeT", "AcmModulationT", "ExaltEnableT", "NtpClientEnableT", "EthMainStatusT", "AlarmLevelT", "EthAuxStatusT", "VlanGroupT", "TimeZoneT", "FileTransferStartT", "Te1LoopBackModeT", "exaltcommunications", "Led4ColorT")
...
mibBuilder.exportSymbols("ExaltComProducts", trapIpaddrEnable4=trapIpaddrEnable4, locEthPerfInterfaces=locEthPerfInterfaces, firmwareVersion=firmwareVersion, rdkDbVer=rdkDbVer, remCurrentTemp=remCurrentTemp, ntpClientEnable=ntpClientEnable, almRemote=almRemote, trapLocLinkStat=trapLocLinkStat, inboundEthernetThroughput=inboundEthernetThroughput, trapIpaddr3=trapIpaddr3, trapLocTempStat=trapLocTempStat, locCurrentRSLstr=locCurrentRSLstr, userThroughput=userThroughput, te1AIS=te1AIS, ipAddress=ipAddress, licKey=licKey, remTE1Alarms=remTE1Alarms, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, remTe1AlarmsEntry=remTe1AlarmsEntry, remUnavailDurationStr=remUnavailDurationStr, commitSnmpSettings=commitSnmpSettings, remSampleDuration=remSampleDuration, locErrorDurationStr=locErrorDurationStr, ntpTimeZoneSelect=ntpTimeZoneSelect, ipAddressNetmask=ipAddressNetmask, partNumber=partNumber, locCurrentBERstr=locCurrentBERstr, aesKey=aesKey, locTempAlarm=locTempAlarm, factoryFwFilename=factoryFwFilename, te1Status=te1Status, transferStart=transferStart, rnRemote=rnRemote, alternateFwFilename=alternateFwFilename, defaultGateway=defaultGateway, txFreqRange=txFreqRange, trapLocAlarmStat=trapLocAlarmStat, commitAdminSettings=commitAdminSettings, te1=te1, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, linkSecKey=linkSecKey, remMinRSLtimestamp=remMinRSLtimestamp, userPassword=userPassword, outboundEthernetThroughput=outboundEthernetThroughput, PwType=PwType, remCurrentRSLstr=remCurrentRSLstr, locMinimumTxModulation=locMinimumTxModulation, locUnavailDurationStr=locUnavailDurationStr, trapIpaddrEnable1=trapIpaddrEnable1, trapv3Enable=trapv3Enable, remTe1LinkSummary=remTe1LinkSummary, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, ipRemote=ipRemote, fileTransfer=fileTransfer, locSysAlarms=locSysAlarms, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, alarms=alarms, trapIpaddrEnable3=trapIpaddrEnable3, hwId=hwId, locLinkStateV=locLinkStateV, performance=performance, remMinRSL=remMinRSL, subnetMask=subnetMask, remCurrentTempS=remCurrentTempS, PYSNMP_MODULE_ID=productsMIB, rnLocal=rnLocal, almLocal=almLocal, perfLocal=perfLocal, sysDate=sysDate, locUnavailDuration=locUnavailDuration, locActiveTxModulation=locActiveTxModulation, productsMIBCompliances=productsMIBCompliances, te1NumChannels=te1NumChannels, remTe1Alarms=remTe1Alarms, remLinkState=remLinkState, trapIpaddrEnable2=trapIpaddrEnable2, locMinimumRxModulation=locMinimumRxModulation, locMaximumTxModulation=locMaximumTxModulation, locActiveRxModulation=locActiveRxModulation, remUnavailDuration=remUnavailDuration, locLinkStateH=locLinkStateH, te1LoopBackMode=te1LoopBackMode, locEthAlarms=locEthAlarms, te1Interfaces=te1Interfaces, trapReboot=trapReboot, locTe1LinkSummary=locTe1LinkSummary, locMaxRSL=locMaxRSL, uploadFilename=uploadFilename, transferType=transferType, bootVersion=bootVersion, serialNumber=serialNumber, systemConfig=systemConfig, trapIpaddr4=trapIpaddr4, t1LBO=t1LBO, locResetStats=locResetStats, ntpServer4IpAddr=ntpServer4IpAddr, remLinkStateV=remLinkStateV, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, trapv2cEnable=trapv2cEnable, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, selectT1orE1=selectT1orE1, trapv1Enable=trapv1Enable, locLinkSecMismatch=locLinkSecMismatch, aesEnable=aesEnable, remLinkSecMismatch=remLinkSecMismatch, locMaxRSLstr=locMaxRSLstr, commitNtpSettings=commitNtpSettings, locEthUtilizationWatermark=locEthUtilizationWatermark, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remTe1Alarm=remTe1Alarm, remErrorDuration=remErrorDuration, trapLocRslStat=trapLocRslStat, rxFreqRange=rxFreqRange, currentFwFilename=currentFwFilename, remErrorDurationStr=remErrorDurationStr, sysTime=sysTime, locLinkState=locLinkState, locCurrentBER=locCurrentBER, ntpServer3IpAddr=ntpServer3IpAddr, locTe1Alarms=locTe1Alarms, locTe1AlarmsEntry=locTe1AlarmsEntry, tftpServerIp=tftpServerIp, locEthUtilizationOut=locEthUtilizationOut, productsAllObjects=productsAllObjects, locSampleDurationStr=locSampleDurationStr, locErrorDuration=locErrorDuration, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, te1Interface=te1Interface, remSysAlarms=remSysAlarms, locMaximumRxModulation=locMaximumRxModulation, adminPassword=adminPassword, radioAdmin=radioAdmin, ntp=ntp, perfRemote=perfRemote, te1NumActiveChannels=te1NumActiveChannels, linkName=linkName, radioReboot=radioReboot, locMinRSLstr=locMinRSLstr, locSampleDuration=locSampleDuration, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, productsMIBGroups=productsMIBGroups, interface=interface, productsMIB=productsMIB, trapAuth=trapAuth, snmpConfig=snmpConfig, radioInfo=radioInfo, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locTE1Alarms=locTE1Alarms, commitSystemSettings=commitSystemSettings, licenseFeatures=licenseFeatures, ipLocal=ipLocal, locEthUtilizationIn=locEthUtilizationIn, transferStatus=transferStatus, locMinRSLtimestamp=locMinRSLtimestamp, productsMIBObjects=productsMIBObjects, radioConfig=radioConfig, remCurrentBERstr=remCurrentBERstr, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remMinRSLstr=remMinRSLstr, productsMIBConformance=productsMIBConformance, commitTe1Settings=commitTe1Settings, remCurrentRSL=remCurrentRSL, locTe1Alarm=locTe1Alarm, radioMonitor=radioMonitor, locEthSpeed=locEthSpeed, rfFreqBand=rfFreqBand, swapFWimage=swapFWimage, modelName=modelName, remTempAlarm=remTempAlarm, productsMIBNotifications=productsMIBNotifications, trapIpaddr2=trapIpaddr2, fileManagement=fileManagement, aggregateUserThroughput=aggregateUserThroughput, radioName=radioName, locCurrentTemp=locCurrentTemp, remMaxRSLstr=remMaxRSLstr, modelNumber=modelNumber, ntpServer2IpAddr=ntpServer2IpAddr, remMaxRSL=remMaxRSL, remResetStats=remResetStats, trapIpaddr1=trapIpaddr1, t1LineCode=t1LineCode, locCurrentRSL=locCurrentRSL, remCurrentBER=remCurrentBER, remEthAlarms=remEthAlarms, remLinkStateH=remLinkStateH, remSampleDurationStr=remSampleDurationStr, locMinRSL=locMinRSL, trapLocRslThreshold=trapLocRslThreshold, trapRemAlarmStat=trapRemAlarmStat, interfaceType=interfaceType, ntpServer1IpAddr=ntpServer1IpAddr, locCurrentTempS=locCurrentTempS)
