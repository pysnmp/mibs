...
exaltcommunications, EthMainStatusT, VlanStatusT, AuxNmsMode, NtpClientEnableT, VlanGroupT, Te1LboT, FileTransferStartT, Te1LineCodeT, TimeZoneT, FileTransferTypeT, EthAuxStatusT, Te1LoopBackModeT, AlarmLevelT, ExaltEnableT, Te1StatusT, EnableStatusT, Led4ColorT, AcmModulationT, EthPortMode = mibBuilder.importSymbols("ExaltComm", "exaltcommunications", "EthMainStatusT", "VlanStatusT", "AuxNmsMode", "NtpClientEnableT", "VlanGroupT", "Te1LboT", "FileTransferStartT", "Te1LineCodeT", "TimeZoneT", "FileTransferTypeT", "EthAuxStatusT", "Te1LoopBackModeT", "AlarmLevelT", "ExaltEnableT", "Te1StatusT", "EnableStatusT", "Led4ColorT", "AcmModulationT", "EthPortMode")
...
mibBuilder.exportSymbols("ExaltComProducts", locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remMaxRSLstr=remMaxRSLstr, ipRemote=ipRemote, ntpServer3IpAddr=ntpServer3IpAddr, trapLocLinkStat=trapLocLinkStat, remCurrentRSLstr=remCurrentRSLstr, locMaximumRxModulation=locMaximumRxModulation, systemConfig=systemConfig, remSysAlarms=remSysAlarms, swapFWimage=swapFWimage, commitSnmpSettings=commitSnmpSettings, locMinimumRxModulation=locMinimumRxModulation, outboundEthernetThroughput=outboundEthernetThroughput, rnLocal=rnLocal, locMaximumTxModulation=locMaximumTxModulation, performance=performance, fileManagement=fileManagement, remTe1LinkSummary=remTe1LinkSummary, perfRemote=perfRemote, productsMIBGroups=productsMIBGroups, locTe1LinkSummary=locTe1LinkSummary, remLinkStateH=remLinkStateH, locCurrentBER=locCurrentBER, trapv1Enable=trapv1Enable, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, tftpServerIp=tftpServerIp, locMinRSLstr=locMinRSLstr, trapIpaddr4=trapIpaddr4, rfFreqBand=rfFreqBand, remTempAlarm=remTempAlarm, remLinkState=remLinkState, locMinRSLtimestamp=locMinRSLtimestamp, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, radioReboot=radioReboot, productsMIBCompliances=productsMIBCompliances, trapv2cEnable=trapv2cEnable, productsMIBObjects=productsMIBObjects, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, te1Interfaces=te1Interfaces, te1AIS=te1AIS, sysDate=sysDate, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, trapIpaddr2=trapIpaddr2, t1LineCode=t1LineCode, transferStatus=transferStatus, almRemote=almRemote, locSampleDuration=locSampleDuration, locCurrentTempS=locCurrentTempS, locTe1Alarm=locTe1Alarm, remTe1AlarmsEntry=remTe1AlarmsEntry, remTe1Alarm=remTe1Alarm, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, trapLocAlarmStat=trapLocAlarmStat, remCurrentTempS=remCurrentTempS, trapIpaddr1=trapIpaddr1, remResetStats=remResetStats, linkName=linkName, adminPassword=adminPassword, defaultGateway=defaultGateway, selectT1orE1=selectT1orE1, interfaceType=interfaceType, remLinkSecMismatch=remLinkSecMismatch, radioName=radioName, locLinkSecMismatch=locLinkSecMismatch, remCurrentRSL=remCurrentRSL, productsAllObjects=productsAllObjects, remMaxRSL=remMaxRSL, trapIpaddrEnable2=trapIpaddrEnable2, licenseFeatures=licenseFeatures, sysTime=sysTime, fileTransfer=fileTransfer, remUnavailDuration=remUnavailDuration, productsMIBConformance=productsMIBConformance, locUnavailDuration=locUnavailDuration, te1NumActiveChannels=te1NumActiveChannels, factoryFwFilename=factoryFwFilename, locEthUtilizationWatermark=locEthUtilizationWatermark, ipLocal=ipLocal, te1Status=te1Status, locCurrentRSLstr=locCurrentRSLstr, locErrorDurationStr=locErrorDurationStr, PwType=PwType, trapLocTempStat=trapLocTempStat, remErrorDuration=remErrorDuration, productsMIB=productsMIB, trapLocRslStat=trapLocRslStat, remMinRSL=remMinRSL, aesKey=aesKey, radioInfo=radioInfo, remMinRSLstr=remMinRSLstr, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locSampleDurationStr=locSampleDurationStr, rxFreqRange=rxFreqRange, trapIpaddrEnable3=trapIpaddrEnable3, txFreqRange=txFreqRange, locEthPerfInterfaces=locEthPerfInterfaces, locTempAlarm=locTempAlarm, remSampleDurationStr=remSampleDurationStr, locEthUtilizationIn=locEthUtilizationIn, commitNtpSettings=commitNtpSettings, t1LBO=t1LBO, bootVersion=bootVersion, locCurrentBERstr=locCurrentBERstr, trapRemAlarmStat=trapRemAlarmStat, locMaxRSLstr=locMaxRSLstr, licKey=licKey, locTE1Alarms=locTE1Alarms, snmpConfig=snmpConfig, hwId=hwId, trapIpaddrEnable4=trapIpaddrEnable4, ntpClientEnable=ntpClientEnable, uploadFilename=uploadFilename, locEthAlarms=locEthAlarms, serialNumber=serialNumber, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, modelNumber=modelNumber, PYSNMP_MODULE_ID=productsMIB, rdkDbVer=rdkDbVer, trapAuth=trapAuth, alarms=alarms, locMaxRSL=locMaxRSL, locEthUtilizationOut=locEthUtilizationOut, locTe1AlarmsEntry=locTe1AlarmsEntry, aesEnable=aesEnable, ipAddress=ipAddress, interface=interface, currentFwFilename=currentFwFilename, remLinkStateV=remLinkStateV, remCurrentBER=remCurrentBER, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remCurrentTemp=remCurrentTemp, commitSystemSettings=commitSystemSettings, locSysAlarms=locSysAlarms, locTe1Alarms=locTe1Alarms, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remTE1Alarms=remTE1Alarms, remSampleDuration=remSampleDuration, almLocal=almLocal, subnetMask=subnetMask, ntpServer1IpAddr=ntpServer1IpAddr, ntp=ntp, userPassword=userPassword, productsMIBNotifications=productsMIBNotifications, transferStart=transferStart, aggregateUserThroughput=aggregateUserThroughput, te1=te1, radioMonitor=radioMonitor, remEthAlarms=remEthAlarms, locErrorDuration=locErrorDuration, remUnavailDurationStr=remUnavailDurationStr, remTe1Alarms=remTe1Alarms, commitTe1Settings=commitTe1Settings, locLinkStateV=locLinkStateV, partNumber=partNumber, ntpServer2IpAddr=ntpServer2IpAddr, locMinRSL=locMinRSL, ntpServer4IpAddr=ntpServer4IpAddr, locResetStats=locResetStats, locCurrentRSL=locCurrentRSL, locUnavailDurationStr=locUnavailDurationStr, trapIpaddr3=trapIpaddr3, te1Interface=te1Interface, te1NumChannels=te1NumChannels, remErrorDurationStr=remErrorDurationStr, locLinkState=locLinkState, modelName=modelName, radioConfig=radioConfig, userThroughput=userThroughput, te1LoopBackMode=te1LoopBackMode, firmwareVersion=firmwareVersion, trapIpaddrEnable1=trapIpaddrEnable1, perfLocal=perfLocal, locMinimumTxModulation=locMinimumTxModulation, remMinRSLtimestamp=remMinRSLtimestamp, locEthSpeed=locEthSpeed, transferType=transferType, ipAddressNetmask=ipAddressNetmask, inboundEthernetThroughput=inboundEthernetThroughput, locActiveTxModulation=locActiveTxModulation, rnRemote=rnRemote, commitAdminSettings=commitAdminSettings, trapReboot=trapReboot, alternateFwFilename=alternateFwFilename, locCurrentTemp=locCurrentTemp, locActiveRxModulation=locActiveRxModulation, ntpTimeZoneSelect=ntpTimeZoneSelect, trapv3Enable=trapv3Enable, remCurrentBERstr=remCurrentBERstr, locLinkStateH=locLinkStateH, trapLocRslThreshold=trapLocRslThreshold, radioAdmin=radioAdmin, linkSecKey=linkSecKey)
