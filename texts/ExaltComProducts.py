...
FileTransferTypeT, exaltcommunications, EnableStatusT, EthPortMode, NtpClientEnableT, Te1StatusT, TimeZoneT, EthMainStatusT, VlanStatusT, EthAuxStatusT, Te1LboT, AuxNmsMode, AcmModulationT, ExaltEnableT, Te1LineCodeT, VlanGroupT, Te1LoopBackModeT, AlarmLevelT, Led4ColorT, FileTransferStartT = mibBuilder.importSymbols("ExaltComm", "FileTransferTypeT", "exaltcommunications", "EnableStatusT", "EthPortMode", "NtpClientEnableT", "Te1StatusT", "TimeZoneT", "EthMainStatusT", "VlanStatusT", "EthAuxStatusT", "Te1LboT", "AuxNmsMode", "AcmModulationT", "ExaltEnableT", "Te1LineCodeT", "VlanGroupT", "Te1LoopBackModeT", "AlarmLevelT", "Led4ColorT", "FileTransferStartT")
...
mibBuilder.exportSymbols("ExaltComProducts", rfFreqBand=rfFreqBand, trapv2cEnable=trapv2cEnable, trapIpaddr1=trapIpaddr1, remTe1AlarmsEntry=remTe1AlarmsEntry, firmwareVersion=firmwareVersion, trapIpaddr2=trapIpaddr2, remLinkState=remLinkState, t1LBO=t1LBO, locTe1Alarm=locTe1Alarm, interfaceType=interfaceType, almRemote=almRemote, locEthPerfInterfaces=locEthPerfInterfaces, ntp=ntp, locUnavailDurationStr=locUnavailDurationStr, trapv3Enable=trapv3Enable, radioConfig=radioConfig, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, partNumber=partNumber, fileTransfer=fileTransfer, perfLocal=perfLocal, locTE1Alarms=locTE1Alarms, radioInfo=radioInfo, locEthUtilizationWatermark=locEthUtilizationWatermark, trapIpaddr3=trapIpaddr3, locSampleDurationStr=locSampleDurationStr, hwId=hwId, productsMIBObjects=productsMIBObjects, ipRemote=ipRemote, remTe1Alarm=remTe1Alarm, productsMIBGroups=productsMIBGroups, snmpConfig=snmpConfig, locEthAlarms=locEthAlarms, rnLocal=rnLocal, locSampleDuration=locSampleDuration, transferStatus=transferStatus, trapLocRslThreshold=trapLocRslThreshold, locMaxRSL=locMaxRSL, remLinkStateH=remLinkStateH, remTe1LinkSummary=remTe1LinkSummary, remMinRSL=remMinRSL, locUnavailDuration=locUnavailDuration, remSampleDurationStr=remSampleDurationStr, rnRemote=rnRemote, performance=performance, userPassword=userPassword, productsMIBNotifications=productsMIBNotifications, aggregateUserThroughput=aggregateUserThroughput, radioAdmin=radioAdmin, trapLocRslStat=trapLocRslStat, radioReboot=radioReboot, subnetMask=subnetMask, licKey=licKey, locActiveRxModulation=locActiveRxModulation, remCurrentRSL=remCurrentRSL, trapLocAlarmStat=trapLocAlarmStat, trapReboot=trapReboot, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locMinRSL=locMinRSL, commitTe1Settings=commitTe1Settings, ntpClientEnable=ntpClientEnable, locMinRSLtimestamp=locMinRSLtimestamp, systemConfig=systemConfig, interface=interface, locMinimumRxModulation=locMinimumRxModulation, ntpTimeZoneSelect=ntpTimeZoneSelect, locLinkState=locLinkState, ntpServer3IpAddr=ntpServer3IpAddr, remLinkStateV=remLinkStateV, remUnavailDuration=remUnavailDuration, remTE1Alarms=remTE1Alarms, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, sysTime=sysTime, locMinimumTxModulation=locMinimumTxModulation, locErrorDurationStr=locErrorDurationStr, locEthUtilizationOut=locEthUtilizationOut, tftpServerIp=tftpServerIp, trapLocTempStat=trapLocTempStat, remResetStats=remResetStats, txFreqRange=txFreqRange, locMaxRSLstr=locMaxRSLstr, transferType=transferType, locEthSpeed=locEthSpeed, modelNumber=modelNumber, ntpServer1IpAddr=ntpServer1IpAddr, te1Status=te1Status, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, aesEnable=aesEnable, ntpServer2IpAddr=ntpServer2IpAddr, te1=te1, locCurrentRSLstr=locCurrentRSLstr, te1Interface=te1Interface, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locLinkStateV=locLinkStateV, sysDate=sysDate, remTe1Alarms=remTe1Alarms, trapIpaddrEnable1=trapIpaddrEnable1, commitNtpSettings=commitNtpSettings, defaultGateway=defaultGateway, fileManagement=fileManagement, perfRemote=perfRemote, currentFwFilename=currentFwFilename, remMaxRSL=remMaxRSL, remSysAlarms=remSysAlarms, alternateFwFilename=alternateFwFilename, uploadFilename=uploadFilename, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, productsMIB=productsMIB, remCurrentTempS=remCurrentTempS, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remErrorDuration=remErrorDuration, remErrorDurationStr=remErrorDurationStr, locTempAlarm=locTempAlarm, remCurrentBER=remCurrentBER, serialNumber=serialNumber, remMaxRSLstr=remMaxRSLstr, remCurrentRSLstr=remCurrentRSLstr, productsAllObjects=productsAllObjects, trapIpaddrEnable2=trapIpaddrEnable2, remEthAlarms=remEthAlarms, PwType=PwType, rxFreqRange=rxFreqRange, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locTe1AlarmsEntry=locTe1AlarmsEntry, remMinRSLtimestamp=remMinRSLtimestamp, outboundEthernetThroughput=outboundEthernetThroughput, te1NumActiveChannels=te1NumActiveChannels, productsMIBConformance=productsMIBConformance, commitSnmpSettings=commitSnmpSettings, locMinRSLstr=locMinRSLstr, ipLocal=ipLocal, locCurrentBERstr=locCurrentBERstr, radioMonitor=radioMonitor, swapFWimage=swapFWimage, PYSNMP_MODULE_ID=productsMIB, te1NumChannels=te1NumChannels, locCurrentBER=locCurrentBER, remCurrentBERstr=remCurrentBERstr, remCurrentTemp=remCurrentTemp, trapIpaddrEnable4=trapIpaddrEnable4, locEthUtilizationIn=locEthUtilizationIn, ntpServer4IpAddr=ntpServer4IpAddr, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, t1LineCode=t1LineCode, selectT1orE1=selectT1orE1, almLocal=almLocal, trapLocLinkStat=trapLocLinkStat, trapAuth=trapAuth, inboundEthernetThroughput=inboundEthernetThroughput, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, bootVersion=bootVersion, te1AIS=te1AIS, commitAdminSettings=commitAdminSettings, locCurrentTempS=locCurrentTempS, alarms=alarms, trapv1Enable=trapv1Enable, linkSecKey=linkSecKey, trapRemAlarmStat=trapRemAlarmStat, transferStart=transferStart, locLinkStateH=locLinkStateH, remLinkSecMismatch=remLinkSecMismatch, productsMIBCompliances=productsMIBCompliances, linkName=linkName, remSampleDuration=remSampleDuration, te1Interfaces=te1Interfaces, locTe1Alarms=locTe1Alarms, locErrorDuration=locErrorDuration, remUnavailDurationStr=remUnavailDurationStr, aesKey=aesKey, ipAddressNetmask=ipAddressNetmask, locCurrentRSL=locCurrentRSL, locActiveTxModulation=locActiveTxModulation, commitSystemSettings=commitSystemSettings, locMaximumTxModulation=locMaximumTxModulation, locResetStats=locResetStats, rdkDbVer=rdkDbVer, locTe1LinkSummary=locTe1LinkSummary, te1LoopBackMode=te1LoopBackMode, ipAddress=ipAddress, remMinRSLstr=remMinRSLstr, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, trapIpaddrEnable3=trapIpaddrEnable3, licenseFeatures=licenseFeatures, factoryFwFilename=factoryFwFilename, adminPassword=adminPassword, trapIpaddr4=trapIpaddr4, modelName=modelName, radioName=radioName, locSysAlarms=locSysAlarms, locCurrentTemp=locCurrentTemp, locLinkSecMismatch=locLinkSecMismatch, remTempAlarm=remTempAlarm, userThroughput=userThroughput, locMaximumRxModulation=locMaximumRxModulation)
