...
ExaltEnableT, TimeZoneT, VlanStatusT, NtpClientEnableT, Te1StatusT, Te1LboT, Te1LineCodeT, EnableStatusT, EthMainStatusT, AuxNmsMode, AcmModulationT, VlanGroupT, Led4ColorT, AlarmLevelT, Te1LoopBackModeT, exaltcommunications, EthPortMode, FileTransferTypeT, EthAuxStatusT, FileTransferStartT = mibBuilder.importSymbols("ExaltComm", "ExaltEnableT", "TimeZoneT", "VlanStatusT", "NtpClientEnableT", "Te1StatusT", "Te1LboT", "Te1LineCodeT", "EnableStatusT", "EthMainStatusT", "AuxNmsMode", "AcmModulationT", "VlanGroupT", "Led4ColorT", "AlarmLevelT", "Te1LoopBackModeT", "exaltcommunications", "EthPortMode", "FileTransferTypeT", "EthAuxStatusT", "FileTransferStartT")
...
mibBuilder.exportSymbols("ExaltComProducts", locCurrentRSLstr=locCurrentRSLstr, remTe1AlarmsEntry=remTe1AlarmsEntry, locSysAlarms=locSysAlarms, subnetMask=subnetMask, remEthAlarms=remEthAlarms, remTe1LinkSummary=remTe1LinkSummary, locActiveTxModulation=locActiveTxModulation, locResetStats=locResetStats, productsMIBCompliances=productsMIBCompliances, uploadFilename=uploadFilename, radioConfig=radioConfig, fileTransfer=fileTransfer, rnLocal=rnLocal, locEthAlarms=locEthAlarms, locActiveRxModulation=locActiveRxModulation, locTE1Alarms=locTE1Alarms, remLinkStateV=remLinkStateV, trapIpaddr1=trapIpaddr1, trapRemAlarmStat=trapRemAlarmStat, factoryFwFilename=factoryFwFilename, locTe1AlarmsEntry=locTe1AlarmsEntry, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locCurrentRSL=locCurrentRSL, ntpServer4IpAddr=ntpServer4IpAddr, locLinkSecMismatch=locLinkSecMismatch, rnRemote=rnRemote, almLocal=almLocal, locLinkState=locLinkState, radioMonitor=radioMonitor, ntpServer1IpAddr=ntpServer1IpAddr, commitTe1Settings=commitTe1Settings, locMinRSLtimestamp=locMinRSLtimestamp, locMaxRSLstr=locMaxRSLstr, PYSNMP_MODULE_ID=productsMIB, perfLocal=perfLocal, rxFreqRange=rxFreqRange, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, remResetStats=remResetStats, radioInfo=radioInfo, trapIpaddrEnable4=trapIpaddrEnable4, userPassword=userPassword, remMinRSLtimestamp=remMinRSLtimestamp, systemConfig=systemConfig, locUnavailDuration=locUnavailDuration, remUnavailDurationStr=remUnavailDurationStr, aggregateUserThroughput=aggregateUserThroughput, ipAddress=ipAddress, locMinRSLstr=locMinRSLstr, locErrorDuration=locErrorDuration, locMaximumRxModulation=locMaximumRxModulation, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, trapAuth=trapAuth, trapIpaddrEnable2=trapIpaddrEnable2, locErrorDurationStr=locErrorDurationStr, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, licenseFeatures=licenseFeatures, remSysAlarms=remSysAlarms, te1NumActiveChannels=te1NumActiveChannels, locTe1LinkSummary=locTe1LinkSummary, remCurrentTemp=remCurrentTemp, remUnavailDuration=remUnavailDuration, ntpServer3IpAddr=ntpServer3IpAddr, remMinRSL=remMinRSL, remLinkStateH=remLinkStateH, PwType=PwType, trapLocTempStat=trapLocTempStat, remLinkSecMismatch=remLinkSecMismatch, trapIpaddr2=trapIpaddr2, locEthUtilizationIn=locEthUtilizationIn, performance=performance, commitAdminSettings=commitAdminSettings, swapFWimage=swapFWimage, linkSecKey=linkSecKey, locTempAlarm=locTempAlarm, trapv2cEnable=trapv2cEnable, aesKey=aesKey, locCurrentTemp=locCurrentTemp, t1LBO=t1LBO, fileManagement=fileManagement, productsMIB=productsMIB, ipLocal=ipLocal, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locTe1Alarm=locTe1Alarm, productsMIBNotifications=productsMIBNotifications, productsMIBGroups=productsMIBGroups, locMinRSL=locMinRSL, trapLocRslThreshold=trapLocRslThreshold, modelNumber=modelNumber, remMaxRSLstr=remMaxRSLstr, tftpServerIp=tftpServerIp, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remMaxRSL=remMaxRSL, userThroughput=userThroughput, outboundEthernetThroughput=outboundEthernetThroughput, remCurrentBERstr=remCurrentBERstr, partNumber=partNumber, txFreqRange=txFreqRange, trapReboot=trapReboot, t1LineCode=t1LineCode, alarms=alarms, te1Status=te1Status, productsAllObjects=productsAllObjects, te1LoopBackMode=te1LoopBackMode, remSampleDuration=remSampleDuration, sysDate=sysDate, locEthSpeed=locEthSpeed, commitSnmpSettings=commitSnmpSettings, transferType=transferType, rfFreqBand=rfFreqBand, remTempAlarm=remTempAlarm, licKey=licKey, locEthPerfInterfaces=locEthPerfInterfaces, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, trapIpaddr4=trapIpaddr4, commitNtpSettings=commitNtpSettings, locEthUtilizationOut=locEthUtilizationOut, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, aesEnable=aesEnable, remLinkState=remLinkState, locMaximumTxModulation=locMaximumTxModulation, snmpConfig=snmpConfig, radioName=radioName, hwId=hwId, locSampleDuration=locSampleDuration, locUnavailDurationStr=locUnavailDurationStr, remTe1Alarm=remTe1Alarm, ntpClientEnable=ntpClientEnable, ntpTimeZoneSelect=ntpTimeZoneSelect, remMinRSLstr=remMinRSLstr, transferStatus=transferStatus, commitSystemSettings=commitSystemSettings, trapv1Enable=trapv1Enable, firmwareVersion=firmwareVersion, remCurrentBER=remCurrentBER, interface=interface, trapLocRslStat=trapLocRslStat, trapIpaddrEnable1=trapIpaddrEnable1, radioAdmin=radioAdmin, remCurrentRSL=remCurrentRSL, productsMIBObjects=productsMIBObjects, remCurrentTempS=remCurrentTempS, bootVersion=bootVersion, trapLocLinkStat=trapLocLinkStat, remTE1Alarms=remTE1Alarms, te1Interface=te1Interface, locCurrentBER=locCurrentBER, sysTime=sysTime, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, almRemote=almRemote, remTe1Alarms=remTe1Alarms, locLinkStateV=locLinkStateV, locSampleDurationStr=locSampleDurationStr, ntpServer2IpAddr=ntpServer2IpAddr, defaultGateway=defaultGateway, locMinimumTxModulation=locMinimumTxModulation, locEthUtilizationWatermark=locEthUtilizationWatermark, te1Interfaces=te1Interfaces, modelName=modelName, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remSampleDurationStr=remSampleDurationStr, currentFwFilename=currentFwFilename, locCurrentBERstr=locCurrentBERstr, interfaceType=interfaceType, perfRemote=perfRemote, remErrorDuration=remErrorDuration, productsMIBConformance=productsMIBConformance, radioReboot=radioReboot, locTe1Alarms=locTe1Alarms, ipRemote=ipRemote, trapIpaddr3=trapIpaddr3, serialNumber=serialNumber, alternateFwFilename=alternateFwFilename, locMinimumRxModulation=locMinimumRxModulation, te1NumChannels=te1NumChannels, inboundEthernetThroughput=inboundEthernetThroughput, adminPassword=adminPassword, locLinkStateH=locLinkStateH, remErrorDurationStr=remErrorDurationStr, ipAddressNetmask=ipAddressNetmask, trapIpaddrEnable3=trapIpaddrEnable3, te1AIS=te1AIS, linkName=linkName, transferStart=transferStart, locCurrentTempS=locCurrentTempS, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, ntp=ntp, selectT1orE1=selectT1orE1, trapLocAlarmStat=trapLocAlarmStat, locMaxRSL=locMaxRSL, te1=te1, rdkDbVer=rdkDbVer, remCurrentRSLstr=remCurrentRSLstr, trapv3Enable=trapv3Enable)
