...
Te1StatusT, FileTransferTypeT, TimeZoneT, EthAuxStatusT, ExaltEnableT, Te1LineCodeT, AuxNmsMode, exaltcommunications, VlanGroupT, Led4ColorT, AcmModulationT, AlarmLevelT, EthMainStatusT, EthPortMode, Te1LoopBackModeT, FileTransferStartT, VlanStatusT, NtpClientEnableT, Te1LboT, EnableStatusT = mibBuilder.importSymbols("ExaltComm", "Te1StatusT", "FileTransferTypeT", "TimeZoneT", "EthAuxStatusT", "ExaltEnableT", "Te1LineCodeT", "AuxNmsMode", "exaltcommunications", "VlanGroupT", "Led4ColorT", "AcmModulationT", "AlarmLevelT", "EthMainStatusT", "EthPortMode", "Te1LoopBackModeT", "FileTransferStartT", "VlanStatusT", "NtpClientEnableT", "Te1LboT", "EnableStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", userPassword=userPassword, remCurrentBERstr=remCurrentBERstr, locErrorDurationStr=locErrorDurationStr, trapIpaddr2=trapIpaddr2, remErrorDurationStr=remErrorDurationStr, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locLinkState=locLinkState, interface=interface, aggregateUserThroughput=aggregateUserThroughput, productsMIBConformance=productsMIBConformance, trapv1Enable=trapv1Enable, locEthUtilizationOut=locEthUtilizationOut, radioName=radioName, locEthSpeed=locEthSpeed, linkSecKey=linkSecKey, trapLocAlarmStat=trapLocAlarmStat, remLinkStateH=remLinkStateH, currentFwFilename=currentFwFilename, remTe1LinkSummary=remTe1LinkSummary, PYSNMP_MODULE_ID=productsMIB, te1=te1, alternateFwFilename=alternateFwFilename, transferStatus=transferStatus, locMinRSLstr=locMinRSLstr, commitNtpSettings=commitNtpSettings, serialNumber=serialNumber, te1Interfaces=te1Interfaces, remLinkSecMismatch=remLinkSecMismatch, locMinimumRxModulation=locMinimumRxModulation, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, modelName=modelName, remMaxRSL=remMaxRSL, productsMIBObjects=productsMIBObjects, commitTe1Settings=commitTe1Settings, perfLocal=perfLocal, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, licenseFeatures=licenseFeatures, locMinimumTxModulation=locMinimumTxModulation, productsAllObjects=productsAllObjects, te1LoopBackMode=te1LoopBackMode, locCurrentBERstr=locCurrentBERstr, productsMIB=productsMIB, licKey=licKey, trapIpaddr1=trapIpaddr1, systemConfig=systemConfig, rnLocal=rnLocal, perfRemote=perfRemote, ipAddress=ipAddress, trapIpaddrEnable4=trapIpaddrEnable4, locMaximumRxModulation=locMaximumRxModulation, snmpConfig=snmpConfig, rdkDbVer=rdkDbVer, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, trapLocRslThreshold=trapLocRslThreshold, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locMaximumTxModulation=locMaximumTxModulation, interfaceType=interfaceType, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remMaxRSLstr=remMaxRSLstr, trapLocLinkStat=trapLocLinkStat, subnetMask=subnetMask, locResetStats=locResetStats, adminPassword=adminPassword, remMinRSLstr=remMinRSLstr, locTe1Alarm=locTe1Alarm, defaultGateway=defaultGateway, locCurrentRSL=locCurrentRSL, te1NumChannels=te1NumChannels, hwId=hwId, firmwareVersion=firmwareVersion, ntpServer1IpAddr=ntpServer1IpAddr, locTe1Alarms=locTe1Alarms, te1Status=te1Status, locActiveRxModulation=locActiveRxModulation, almLocal=almLocal, trapAuth=trapAuth, trapv3Enable=trapv3Enable, trapReboot=trapReboot, radioAdmin=radioAdmin, trapIpaddr3=trapIpaddr3, sysTime=sysTime, remCurrentTempS=remCurrentTempS, remSysAlarms=remSysAlarms, userThroughput=userThroughput, remCurrentBER=remCurrentBER, locCurrentRSLstr=locCurrentRSLstr, remTe1Alarm=remTe1Alarm, locSysAlarms=locSysAlarms, ntpTimeZoneSelect=ntpTimeZoneSelect, uploadFilename=uploadFilename, ntpServer3IpAddr=ntpServer3IpAddr, locCurrentTempS=locCurrentTempS, performance=performance, locLinkSecMismatch=locLinkSecMismatch, radioReboot=radioReboot, fileManagement=fileManagement, bootVersion=bootVersion, remErrorDuration=remErrorDuration, remLinkStateV=remLinkStateV, transferStart=transferStart, alarms=alarms, remUnavailDuration=remUnavailDuration, trapIpaddrEnable3=trapIpaddrEnable3, te1Interface=te1Interface, radioConfig=radioConfig, ntp=ntp, locLinkStateH=locLinkStateH, remSampleDurationStr=remSampleDurationStr, fileTransfer=fileTransfer, t1LineCode=t1LineCode, locCurrentTemp=locCurrentTemp, transferType=transferType, remUnavailDurationStr=remUnavailDurationStr, productsMIBCompliances=productsMIBCompliances, PwType=PwType, locLinkStateV=locLinkStateV, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, remEthAlarms=remEthAlarms, trapv2cEnable=trapv2cEnable, locTe1LinkSummary=locTe1LinkSummary, trapIpaddr4=trapIpaddr4, commitSnmpSettings=commitSnmpSettings, trapLocTempStat=trapLocTempStat, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, commitSystemSettings=commitSystemSettings, locEthUtilizationWatermark=locEthUtilizationWatermark, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, ntpServer2IpAddr=ntpServer2IpAddr, tftpServerIp=tftpServerIp, locTempAlarm=locTempAlarm, trapRemAlarmStat=trapRemAlarmStat, remMinRSLtimestamp=remMinRSLtimestamp, locEthPerfInterfaces=locEthPerfInterfaces, ntpServer4IpAddr=ntpServer4IpAddr, inboundEthernetThroughput=inboundEthernetThroughput, locUnavailDurationStr=locUnavailDurationStr, productsMIBGroups=productsMIBGroups, locTe1AlarmsEntry=locTe1AlarmsEntry, t1LBO=t1LBO, aesEnable=aesEnable, commitAdminSettings=commitAdminSettings, swapFWimage=swapFWimage, remSampleDuration=remSampleDuration, remTe1AlarmsEntry=remTe1AlarmsEntry, ipAddressNetmask=ipAddressNetmask, radioMonitor=radioMonitor, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locEthUtilizationIn=locEthUtilizationIn, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, rnRemote=rnRemote, locSampleDuration=locSampleDuration, locCurrentBER=locCurrentBER, remCurrentRSLstr=remCurrentRSLstr, almRemote=almRemote, te1NumActiveChannels=te1NumActiveChannels, factoryFwFilename=factoryFwFilename, remResetStats=remResetStats, productsMIBNotifications=productsMIBNotifications, txFreqRange=txFreqRange, ipLocal=ipLocal, selectT1orE1=selectT1orE1, locTE1Alarms=locTE1Alarms, remCurrentTemp=remCurrentTemp, remTE1Alarms=remTE1Alarms, locMinRSLtimestamp=locMinRSLtimestamp, radioInfo=radioInfo, remTe1Alarms=remTe1Alarms, trapLocRslStat=trapLocRslStat, locMinRSL=locMinRSL, ntpClientEnable=ntpClientEnable, trapIpaddrEnable1=trapIpaddrEnable1, locErrorDuration=locErrorDuration, locMaxRSL=locMaxRSL, linkName=linkName, sysDate=sysDate, locEthAlarms=locEthAlarms, locActiveTxModulation=locActiveTxModulation, locSampleDurationStr=locSampleDurationStr, remTempAlarm=remTempAlarm, partNumber=partNumber, modelNumber=modelNumber, aesKey=aesKey, locUnavailDuration=locUnavailDuration, rxFreqRange=rxFreqRange, outboundEthernetThroughput=outboundEthernetThroughput, te1AIS=te1AIS, rfFreqBand=rfFreqBand, ipRemote=ipRemote, remCurrentRSL=remCurrentRSL, locMaxRSLstr=locMaxRSLstr, trapIpaddrEnable2=trapIpaddrEnable2, remLinkState=remLinkState, remMinRSL=remMinRSL)
