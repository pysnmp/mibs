...
Led4ColorT, ExaltEnableT, Te1StatusT, EthPortMode, FileTransferStartT, AuxNmsMode, NtpClientEnableT, AlarmLevelT, Te1LboT, exaltcommunications, EnableStatusT, VlanGroupT, Te1LineCodeT, AcmModulationT, TimeZoneT, Te1LoopBackModeT, EthAuxStatusT, VlanStatusT, FileTransferTypeT, EthMainStatusT = mibBuilder.importSymbols("ExaltComm", "Led4ColorT", "ExaltEnableT", "Te1StatusT", "EthPortMode", "FileTransferStartT", "AuxNmsMode", "NtpClientEnableT", "AlarmLevelT", "Te1LboT", "exaltcommunications", "EnableStatusT", "VlanGroupT", "Te1LineCodeT", "AcmModulationT", "TimeZoneT", "Te1LoopBackModeT", "EthAuxStatusT", "VlanStatusT", "FileTransferTypeT", "EthMainStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", locMinimumTxModulation=locMinimumTxModulation, locMaximumRxModulation=locMaximumRxModulation, trapIpaddrEnable4=trapIpaddrEnable4, modelNumber=modelNumber, trapv1Enable=trapv1Enable, alternateFwFilename=alternateFwFilename, locLinkStateH=locLinkStateH, te1=te1, almRemote=almRemote, locMinRSLstr=locMinRSLstr, locSampleDurationStr=locSampleDurationStr, remMaxRSLstr=remMaxRSLstr, remResetStats=remResetStats, locCurrentBERstr=locCurrentBERstr, locErrorDuration=locErrorDuration, remLinkStateV=remLinkStateV, locTempAlarm=locTempAlarm, ipLocal=ipLocal, remMinRSLtimestamp=remMinRSLtimestamp, te1Status=te1Status, remCurrentRSL=remCurrentRSL, interface=interface, locLinkSecMismatch=locLinkSecMismatch, remMinRSL=remMinRSL, remSampleDurationStr=remSampleDurationStr, perfLocal=perfLocal, locTe1Alarms=locTe1Alarms, commitAdminSettings=commitAdminSettings, remCurrentBER=remCurrentBER, rxFreqRange=rxFreqRange, ntpServer2IpAddr=ntpServer2IpAddr, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, trapIpaddr1=trapIpaddr1, licKey=licKey, radioAdmin=radioAdmin, commitNtpSettings=commitNtpSettings, locMinRSL=locMinRSL, te1NumChannels=te1NumChannels, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, trapIpaddr4=trapIpaddr4, ntpServer4IpAddr=ntpServer4IpAddr, subnetMask=subnetMask, remLinkState=remLinkState, locUnavailDuration=locUnavailDuration, remSysAlarms=remSysAlarms, productsMIBObjects=productsMIBObjects, te1LoopBackMode=te1LoopBackMode, inboundEthernetThroughput=inboundEthernetThroughput, defaultGateway=defaultGateway, te1Interface=te1Interface, remEthAlarms=remEthAlarms, remCurrentTemp=remCurrentTemp, t1LineCode=t1LineCode, rnLocal=rnLocal, adminPassword=adminPassword, locSysAlarms=locSysAlarms, remTe1Alarms=remTe1Alarms, productsAllObjects=productsAllObjects, trapIpaddrEnable3=trapIpaddrEnable3, locActiveRxModulation=locActiveRxModulation, commitSnmpSettings=commitSnmpSettings, remLinkSecMismatch=remLinkSecMismatch, locResetStats=locResetStats, radioReboot=radioReboot, locTe1LinkSummary=locTe1LinkSummary, productsMIB=productsMIB, alarms=alarms, ntp=ntp, locCurrentTempS=locCurrentTempS, fileManagement=fileManagement, remErrorDuration=remErrorDuration, te1AIS=te1AIS, aggregateUserThroughput=aggregateUserThroughput, selectT1orE1=selectT1orE1, interfaceType=interfaceType, locMinimumRxModulation=locMinimumRxModulation, locMaxRSL=locMaxRSL, remUnavailDuration=remUnavailDuration, ipAddress=ipAddress, remCurrentBERstr=remCurrentBERstr, systemConfig=systemConfig, remTe1Alarm=remTe1Alarm, locMaximumTxModulation=locMaximumTxModulation, remTe1AlarmsEntry=remTe1AlarmsEntry, locEthUtilizationOut=locEthUtilizationOut, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, commitSystemSettings=commitSystemSettings, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, firmwareVersion=firmwareVersion, transferStatus=transferStatus, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locLinkStateV=locLinkStateV, locEthUtilizationIn=locEthUtilizationIn, trapAuth=trapAuth, ntpTimeZoneSelect=ntpTimeZoneSelect, almLocal=almLocal, remTempAlarm=remTempAlarm, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, trapLocTempStat=trapLocTempStat, rdkDbVer=rdkDbVer, linkSecKey=linkSecKey, te1Interfaces=te1Interfaces, ipAddressNetmask=ipAddressNetmask, factoryFwFilename=factoryFwFilename, trapIpaddrEnable2=trapIpaddrEnable2, tftpServerIp=tftpServerIp, remTE1Alarms=remTE1Alarms, trapIpaddr3=trapIpaddr3, locCurrentRSL=locCurrentRSL, locMaxRSLstr=locMaxRSLstr, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remMinRSLstr=remMinRSLstr, transferType=transferType, locTE1Alarms=locTE1Alarms, productsMIBGroups=productsMIBGroups, trapIpaddr2=trapIpaddr2, sysDate=sysDate, transferStart=transferStart, performance=performance, hwId=hwId, trapRemAlarmStat=trapRemAlarmStat, snmpConfig=snmpConfig, locCurrentTemp=locCurrentTemp, productsMIBConformance=productsMIBConformance, locEthPerfInterfaces=locEthPerfInterfaces, productsMIBNotifications=productsMIBNotifications, radioMonitor=radioMonitor, trapReboot=trapReboot, locUnavailDurationStr=locUnavailDurationStr, remSampleDuration=remSampleDuration, sysTime=sysTime, commitTe1Settings=commitTe1Settings, t1LBO=t1LBO, remMaxRSL=remMaxRSL, trapLocAlarmStat=trapLocAlarmStat, remCurrentTempS=remCurrentTempS, ntpClientEnable=ntpClientEnable, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locTe1AlarmsEntry=locTe1AlarmsEntry, locTe1Alarm=locTe1Alarm, radioName=radioName, trapv3Enable=trapv3Enable, locLinkState=locLinkState, locCurrentRSLstr=locCurrentRSLstr, trapLocRslThreshold=trapLocRslThreshold, licenseFeatures=licenseFeatures, locActiveTxModulation=locActiveTxModulation, modelName=modelName, locEthUtilizationWatermark=locEthUtilizationWatermark, radioInfo=radioInfo, fileTransfer=fileTransfer, rfFreqBand=rfFreqBand, trapv2cEnable=trapv2cEnable, ipRemote=ipRemote, remLinkStateH=remLinkStateH, swapFWimage=swapFWimage, userThroughput=userThroughput, linkName=linkName, partNumber=partNumber, ntpServer3IpAddr=ntpServer3IpAddr, remCurrentRSLstr=remCurrentRSLstr, productsMIBCompliances=productsMIBCompliances, currentFwFilename=currentFwFilename, trapLocRslStat=trapLocRslStat, perfRemote=perfRemote, rnRemote=rnRemote, aesKey=aesKey, locEthSpeed=locEthSpeed, locMinRSLtimestamp=locMinRSLtimestamp, locSampleDuration=locSampleDuration, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, PwType=PwType, radioConfig=radioConfig, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, userPassword=userPassword, locCurrentBER=locCurrentBER, locErrorDurationStr=locErrorDurationStr, ntpServer1IpAddr=ntpServer1IpAddr, trapIpaddrEnable1=trapIpaddrEnable1, PYSNMP_MODULE_ID=productsMIB, serialNumber=serialNumber, trapLocLinkStat=trapLocLinkStat, locEthAlarms=locEthAlarms, remUnavailDurationStr=remUnavailDurationStr, remTe1LinkSummary=remTe1LinkSummary, aesEnable=aesEnable, te1NumActiveChannels=te1NumActiveChannels, txFreqRange=txFreqRange, bootVersion=bootVersion, remErrorDurationStr=remErrorDurationStr, uploadFilename=uploadFilename, outboundEthernetThroughput=outboundEthernetThroughput)
