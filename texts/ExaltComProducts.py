...
VlanStatusT, FileTransferStartT, AuxNmsMode, VlanGroupT, Te1LoopBackModeT, exaltcommunications, EnableStatusT, Te1LineCodeT, EthAuxStatusT, AlarmLevelT, EthMainStatusT, ExaltEnableT, Te1StatusT, EthPortMode, FileTransferTypeT, TimeZoneT, Te1LboT, Led4ColorT, NtpClientEnableT, AcmModulationT = mibBuilder.importSymbols("ExaltComm", "VlanStatusT", "FileTransferStartT", "AuxNmsMode", "VlanGroupT", "Te1LoopBackModeT", "exaltcommunications", "EnableStatusT", "Te1LineCodeT", "EthAuxStatusT", "AlarmLevelT", "EthMainStatusT", "ExaltEnableT", "Te1StatusT", "EthPortMode", "FileTransferTypeT", "TimeZoneT", "Te1LboT", "Led4ColorT", "NtpClientEnableT", "AcmModulationT")
...
mibBuilder.exportSymbols("ExaltComProducts", ntp=ntp, interfaceType=interfaceType, remMinRSL=remMinRSL, almRemote=almRemote, trapIpaddrEnable3=trapIpaddrEnable3, productsMIBNotifications=productsMIBNotifications, performance=performance, remTe1LinkSummary=remTe1LinkSummary, trapAuth=trapAuth, remTempAlarm=remTempAlarm, aesKey=aesKey, radioReboot=radioReboot, radioMonitor=radioMonitor, locTe1AlarmsEntry=locTe1AlarmsEntry, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, almLocal=almLocal, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, outboundEthernetThroughput=outboundEthernetThroughput, userThroughput=userThroughput, te1Interfaces=te1Interfaces, linkName=linkName, locUnavailDurationStr=locUnavailDurationStr, ipLocal=ipLocal, remSysAlarms=remSysAlarms, ntpServer4IpAddr=ntpServer4IpAddr, locEthAlarms=locEthAlarms, remLinkState=remLinkState, locTE1Alarms=locTE1Alarms, remLinkStateV=remLinkStateV, serialNumber=serialNumber, locSampleDurationStr=locSampleDurationStr, radioInfo=radioInfo, remErrorDuration=remErrorDuration, fileTransfer=fileTransfer, adminPassword=adminPassword, locEthUtilizationWatermark=locEthUtilizationWatermark, remUnavailDurationStr=remUnavailDurationStr, locMaxRSL=locMaxRSL, swapFWimage=swapFWimage, commitNtpSettings=commitNtpSettings, bootVersion=bootVersion, locLinkState=locLinkState, hwId=hwId, linkSecKey=linkSecKey, tftpServerIp=tftpServerIp, locErrorDuration=locErrorDuration, locActiveTxModulation=locActiveTxModulation, locLinkStateV=locLinkStateV, te1LoopBackMode=te1LoopBackMode, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, te1=te1, remMaxRSL=remMaxRSL, remSampleDurationStr=remSampleDurationStr, txFreqRange=txFreqRange, te1NumChannels=te1NumChannels, locCurrentTempS=locCurrentTempS, defaultGateway=defaultGateway, ntpServer1IpAddr=ntpServer1IpAddr, trapIpaddrEnable1=trapIpaddrEnable1, locMinRSLstr=locMinRSLstr, trapIpaddrEnable2=trapIpaddrEnable2, productsMIBGroups=productsMIBGroups, locCurrentTemp=locCurrentTemp, trapIpaddrEnable4=trapIpaddrEnable4, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locSampleDuration=locSampleDuration, te1Interface=te1Interface, ntpServer3IpAddr=ntpServer3IpAddr, productsMIBObjects=productsMIBObjects, sysDate=sysDate, rfFreqBand=rfFreqBand, locTempAlarm=locTempAlarm, perfRemote=perfRemote, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, trapIpaddr2=trapIpaddr2, locMinimumTxModulation=locMinimumTxModulation, remTE1Alarms=remTE1Alarms, systemConfig=systemConfig, alarms=alarms, trapLocRslStat=trapLocRslStat, te1AIS=te1AIS, te1Status=te1Status, remUnavailDuration=remUnavailDuration, inboundEthernetThroughput=inboundEthernetThroughput, rnLocal=rnLocal, ntpClientEnable=ntpClientEnable, remTe1AlarmsEntry=remTe1AlarmsEntry, remLinkSecMismatch=remLinkSecMismatch, rdkDbVer=rdkDbVer, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remCurrentRSL=remCurrentRSL, remCurrentTempS=remCurrentTempS, remResetStats=remResetStats, rxFreqRange=rxFreqRange, remMinRSLstr=remMinRSLstr, locMaximumTxModulation=locMaximumTxModulation, locMinimumRxModulation=locMinimumRxModulation, PYSNMP_MODULE_ID=productsMIB, trapLocLinkStat=trapLocLinkStat, remCurrentTemp=remCurrentTemp, radioAdmin=radioAdmin, rnRemote=rnRemote, ipAddress=ipAddress, licKey=licKey, remTe1Alarms=remTe1Alarms, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, fileManagement=fileManagement, trapReboot=trapReboot, locLinkStateH=locLinkStateH, locMinRSL=locMinRSL, commitSystemSettings=commitSystemSettings, ipAddressNetmask=ipAddressNetmask, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, partNumber=partNumber, productsMIB=productsMIB, firmwareVersion=firmwareVersion, interface=interface, locCurrentRSL=locCurrentRSL, radioName=radioName, trapIpaddr3=trapIpaddr3, locEthUtilizationOut=locEthUtilizationOut, productsMIBConformance=productsMIBConformance, subnetMask=subnetMask, trapRemAlarmStat=trapRemAlarmStat, transferStart=transferStart, selectT1orE1=selectT1orE1, userPassword=userPassword, perfLocal=perfLocal, locEthUtilizationIn=locEthUtilizationIn, modelNumber=modelNumber, locMinRSLtimestamp=locMinRSLtimestamp, uploadFilename=uploadFilename, ipRemote=ipRemote, remTe1Alarm=remTe1Alarm, locUnavailDuration=locUnavailDuration, remMinRSLtimestamp=remMinRSLtimestamp, locMaxRSLstr=locMaxRSLstr, locActiveRxModulation=locActiveRxModulation, commitSnmpSettings=commitSnmpSettings, locCurrentRSLstr=locCurrentRSLstr, ntpTimeZoneSelect=ntpTimeZoneSelect, commitAdminSettings=commitAdminSettings, locEthSpeed=locEthSpeed, currentFwFilename=currentFwFilename, trapIpaddr4=trapIpaddr4, locLinkSecMismatch=locLinkSecMismatch, commitTe1Settings=commitTe1Settings, transferType=transferType, locMaximumRxModulation=locMaximumRxModulation, remCurrentBERstr=remCurrentBERstr, locTe1Alarm=locTe1Alarm, t1LBO=t1LBO, trapv2cEnable=trapv2cEnable, remSampleDuration=remSampleDuration, factoryFwFilename=factoryFwFilename, trapIpaddr1=trapIpaddr1, aesEnable=aesEnable, t1LineCode=t1LineCode, locTe1LinkSummary=locTe1LinkSummary, locEthPerfInterfaces=locEthPerfInterfaces, locResetStats=locResetStats, locTe1Alarms=locTe1Alarms, remLinkStateH=remLinkStateH, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, snmpConfig=snmpConfig, remEthAlarms=remEthAlarms, locErrorDurationStr=locErrorDurationStr, remErrorDurationStr=remErrorDurationStr, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, remCurrentRSLstr=remCurrentRSLstr, aggregateUserThroughput=aggregateUserThroughput, trapLocTempStat=trapLocTempStat, ntpServer2IpAddr=ntpServer2IpAddr, alternateFwFilename=alternateFwFilename, licenseFeatures=licenseFeatures, locCurrentBERstr=locCurrentBERstr, locCurrentBER=locCurrentBER, PwType=PwType, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, productsMIBCompliances=productsMIBCompliances, te1NumActiveChannels=te1NumActiveChannels, remCurrentBER=remCurrentBER, sysTime=sysTime, productsAllObjects=productsAllObjects, trapLocAlarmStat=trapLocAlarmStat, trapLocRslThreshold=trapLocRslThreshold, remMaxRSLstr=remMaxRSLstr, transferStatus=transferStatus, modelName=modelName, locSysAlarms=locSysAlarms, radioConfig=radioConfig, trapv3Enable=trapv3Enable, trapv1Enable=trapv1Enable)
