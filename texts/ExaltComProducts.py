...
FileTransferTypeT, Te1StatusT, AuxNmsMode, EnableStatusT, exaltcommunications, AcmModulationT, VlanStatusT, AlarmLevelT, Te1LineCodeT, TimeZoneT, NtpClientEnableT, Led4ColorT, FileTransferStartT, VlanGroupT, EthAuxStatusT, Te1LboT, ExaltEnableT, EthMainStatusT, Te1LoopBackModeT, EthPortMode = mibBuilder.importSymbols("ExaltComm", "FileTransferTypeT", "Te1StatusT", "AuxNmsMode", "EnableStatusT", "exaltcommunications", "AcmModulationT", "VlanStatusT", "AlarmLevelT", "Te1LineCodeT", "TimeZoneT", "NtpClientEnableT", "Led4ColorT", "FileTransferStartT", "VlanGroupT", "EthAuxStatusT", "Te1LboT", "ExaltEnableT", "EthMainStatusT", "Te1LoopBackModeT", "EthPortMode")
...
mibBuilder.exportSymbols("ExaltComProducts", performance=performance, remMinRSLtimestamp=remMinRSLtimestamp, userPassword=userPassword, inboundEthernetThroughput=inboundEthernetThroughput, trapv1Enable=trapv1Enable, commitNtpSettings=commitNtpSettings, productsMIBConformance=productsMIBConformance, rnLocal=rnLocal, remErrorDuration=remErrorDuration, modelNumber=modelNumber, locEthAlarms=locEthAlarms, locMinRSLstr=locMinRSLstr, locMaxRSLstr=locMaxRSLstr, locEthSpeed=locEthSpeed, te1Interface=te1Interface, locEthUtilizationOut=locEthUtilizationOut, outboundEthernetThroughput=outboundEthernetThroughput, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, te1NumChannels=te1NumChannels, interfaceType=interfaceType, rfFreqBand=rfFreqBand, locMaximumTxModulation=locMaximumTxModulation, locLinkStateV=locLinkStateV, userThroughput=userThroughput, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, radioAdmin=radioAdmin, locEthUtilizationIn=locEthUtilizationIn, commitSystemSettings=commitSystemSettings, locSampleDuration=locSampleDuration, remTE1Alarms=remTE1Alarms, licKey=licKey, trapIpaddrEnable4=trapIpaddrEnable4, currentFwFilename=currentFwFilename, trapRemAlarmStat=trapRemAlarmStat, locCurrentTempS=locCurrentTempS, PwType=PwType, perfLocal=perfLocal, trapIpaddr1=trapIpaddr1, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, swapFWimage=swapFWimage, locLinkState=locLinkState, locCurrentRSLstr=locCurrentRSLstr, sysTime=sysTime, productsAllObjects=productsAllObjects, locMinRSL=locMinRSL, rxFreqRange=rxFreqRange, ntp=ntp, ntpTimeZoneSelect=ntpTimeZoneSelect, remMinRSLstr=remMinRSLstr, ipRemote=ipRemote, defaultGateway=defaultGateway, remResetStats=remResetStats, tftpServerIp=tftpServerIp, remSampleDuration=remSampleDuration, locEthUtilizationWatermark=locEthUtilizationWatermark, trapReboot=trapReboot, t1LBO=t1LBO, factoryFwFilename=factoryFwFilename, remCurrentBER=remCurrentBER, locTe1LinkSummary=locTe1LinkSummary, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, te1Interfaces=te1Interfaces, rnRemote=rnRemote, ntpServer4IpAddr=ntpServer4IpAddr, perfRemote=perfRemote, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remSampleDurationStr=remSampleDurationStr, remLinkState=remLinkState, remTe1Alarm=remTe1Alarm, locMinimumTxModulation=locMinimumTxModulation, linkName=linkName, locCurrentBERstr=locCurrentBERstr, locResetStats=locResetStats, radioMonitor=radioMonitor, locLinkSecMismatch=locLinkSecMismatch, trapIpaddr4=trapIpaddr4, locErrorDurationStr=locErrorDurationStr, firmwareVersion=firmwareVersion, remEthAlarms=remEthAlarms, almLocal=almLocal, locSampleDurationStr=locSampleDurationStr, trapLocTempStat=trapLocTempStat, transferType=transferType, remErrorDurationStr=remErrorDurationStr, locMinimumRxModulation=locMinimumRxModulation, txFreqRange=txFreqRange, interface=interface, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, ipAddress=ipAddress, locLinkStateH=locLinkStateH, fileManagement=fileManagement, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, trapIpaddr3=trapIpaddr3, remCurrentTemp=remCurrentTemp, remUnavailDurationStr=remUnavailDurationStr, alternateFwFilename=alternateFwFilename, locCurrentBER=locCurrentBER, productsMIBGroups=productsMIBGroups, locUnavailDuration=locUnavailDuration, locMaximumRxModulation=locMaximumRxModulation, aesKey=aesKey, remCurrentTempS=remCurrentTempS, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, te1NumActiveChannels=te1NumActiveChannels, ntpClientEnable=ntpClientEnable, ipLocal=ipLocal, transferStatus=transferStatus, locErrorDuration=locErrorDuration, trapv2cEnable=trapv2cEnable, modelName=modelName, locTE1Alarms=locTE1Alarms, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, remCurrentRSLstr=remCurrentRSLstr, productsMIBCompliances=productsMIBCompliances, fileTransfer=fileTransfer, locUnavailDurationStr=locUnavailDurationStr, remTempAlarm=remTempAlarm, locActiveRxModulation=locActiveRxModulation, te1AIS=te1AIS, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, remSysAlarms=remSysAlarms, bootVersion=bootVersion, remLinkSecMismatch=remLinkSecMismatch, transferStart=transferStart, trapLocAlarmStat=trapLocAlarmStat, ntpServer1IpAddr=ntpServer1IpAddr, locCurrentRSL=locCurrentRSL, commitTe1Settings=commitTe1Settings, linkSecKey=linkSecKey, te1=te1, ipAddressNetmask=ipAddressNetmask, almRemote=almRemote, subnetMask=subnetMask, hwId=hwId, radioName=radioName, remMaxRSL=remMaxRSL, licenseFeatures=licenseFeatures, trapIpaddrEnable2=trapIpaddrEnable2, snmpConfig=snmpConfig, te1Status=te1Status, commitSnmpSettings=commitSnmpSettings, trapv3Enable=trapv3Enable, partNumber=partNumber, uploadFilename=uploadFilename, aesEnable=aesEnable, remUnavailDuration=remUnavailDuration, locTe1AlarmsEntry=locTe1AlarmsEntry, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, trapIpaddrEnable1=trapIpaddrEnable1, trapIpaddr2=trapIpaddr2, locMinRSLtimestamp=locMinRSLtimestamp, remCurrentBERstr=remCurrentBERstr, alarms=alarms, selectT1orE1=selectT1orE1, locCurrentTemp=locCurrentTemp, systemConfig=systemConfig, remMinRSL=remMinRSL, productsMIBObjects=productsMIBObjects, commitAdminSettings=commitAdminSettings, productsMIBNotifications=productsMIBNotifications, remTe1LinkSummary=remTe1LinkSummary, remTe1Alarms=remTe1Alarms, t1LineCode=t1LineCode, aggregateUserThroughput=aggregateUserThroughput, ntpServer3IpAddr=ntpServer3IpAddr, productsMIB=productsMIB, adminPassword=adminPassword, locActiveTxModulation=locActiveTxModulation, locTe1Alarm=locTe1Alarm, ntpServer2IpAddr=ntpServer2IpAddr, trapLocRslStat=trapLocRslStat, remCurrentRSL=remCurrentRSL, remLinkStateH=remLinkStateH, radioConfig=radioConfig, remLinkStateV=remLinkStateV, rdkDbVer=rdkDbVer, radioReboot=radioReboot, remMaxRSLstr=remMaxRSLstr, trapLocLinkStat=trapLocLinkStat, remTe1AlarmsEntry=remTe1AlarmsEntry, PYSNMP_MODULE_ID=productsMIB, trapLocRslThreshold=trapLocRslThreshold, locTempAlarm=locTempAlarm, te1LoopBackMode=te1LoopBackMode, locMaxRSL=locMaxRSL, trapAuth=trapAuth, locTe1Alarms=locTe1Alarms, radioInfo=radioInfo, trapIpaddrEnable3=trapIpaddrEnable3, locSysAlarms=locSysAlarms, serialNumber=serialNumber, sysDate=sysDate, locEthPerfInterfaces=locEthPerfInterfaces)
