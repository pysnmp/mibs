...
exaltcommunications, NtpClientEnableT, AlarmLevelT, FileTransferStartT, EnableStatusT, AuxNmsMode, Led4ColorT, TimeZoneT, EthPortMode, Te1StatusT, VlanStatusT, Te1LboT, AcmModulationT, Te1LineCodeT, FileTransferTypeT, Te1LoopBackModeT, ExaltEnableT, EthMainStatusT, EthAuxStatusT, VlanGroupT = mibBuilder.importSymbols("ExaltComm", "exaltcommunications", "NtpClientEnableT", "AlarmLevelT", "FileTransferStartT", "EnableStatusT", "AuxNmsMode", "Led4ColorT", "TimeZoneT", "EthPortMode", "Te1StatusT", "VlanStatusT", "Te1LboT", "AcmModulationT", "Te1LineCodeT", "FileTransferTypeT", "Te1LoopBackModeT", "ExaltEnableT", "EthMainStatusT", "EthAuxStatusT", "VlanGroupT")
...
mibBuilder.exportSymbols("ExaltComProducts", performance=performance, remErrorDurationStr=remErrorDurationStr, userPassword=userPassword, ntp=ntp, locActiveTxModulation=locActiveTxModulation, locEthUtilizationWatermark=locEthUtilizationWatermark, linkName=linkName, te1NumChannels=te1NumChannels, productsMIBConformance=productsMIBConformance, radioAdmin=radioAdmin, almRemote=almRemote, commitNtpSettings=commitNtpSettings, locEthAlarms=locEthAlarms, remSampleDuration=remSampleDuration, fileTransfer=fileTransfer, locLinkState=locLinkState, locActiveRxModulation=locActiveRxModulation, licenseFeatures=licenseFeatures, te1=te1, rfFreqBand=rfFreqBand, inboundEthernetThroughput=inboundEthernetThroughput, locMinimumTxModulation=locMinimumTxModulation, locEthUtilizationOut=locEthUtilizationOut, trapv2cEnable=trapv2cEnable, ipLocal=ipLocal, trapv1Enable=trapv1Enable, locTe1Alarm=locTe1Alarm, trapIpaddr4=trapIpaddr4, te1LoopBackMode=te1LoopBackMode, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, radioConfig=radioConfig, remSampleDurationStr=remSampleDurationStr, factoryFwFilename=factoryFwFilename, trapIpaddrEnable1=trapIpaddrEnable1, aggregateUserThroughput=aggregateUserThroughput, te1NumActiveChannels=te1NumActiveChannels, aesKey=aesKey, ntpTimeZoneSelect=ntpTimeZoneSelect, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, remTe1LinkSummary=remTe1LinkSummary, bootVersion=bootVersion, t1LBO=t1LBO, almLocal=almLocal, productsMIBNotifications=productsMIBNotifications, locMaxRSL=locMaxRSL, rxFreqRange=rxFreqRange, locCurrentRSL=locCurrentRSL, remMinRSLstr=remMinRSLstr, locSampleDuration=locSampleDuration, locEthSpeed=locEthSpeed, perfLocal=perfLocal, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, trapLocRslThreshold=trapLocRslThreshold, remLinkSecMismatch=remLinkSecMismatch, rnLocal=rnLocal, ntpServer2IpAddr=ntpServer2IpAddr, uploadFilename=uploadFilename, modelNumber=modelNumber, locMaximumTxModulation=locMaximumTxModulation, perfRemote=perfRemote, locSampleDurationStr=locSampleDurationStr, remMaxRSL=remMaxRSL, rnRemote=rnRemote, userThroughput=userThroughput, PYSNMP_MODULE_ID=productsMIB, remEthAlarms=remEthAlarms, locCurrentTempS=locCurrentTempS, productsMIBCompliances=productsMIBCompliances, trapIpaddr1=trapIpaddr1, commitAdminSettings=commitAdminSettings, productsMIB=productsMIB, ntpServer1IpAddr=ntpServer1IpAddr, trapAuth=trapAuth, trapLocTempStat=trapLocTempStat, locMaximumRxModulation=locMaximumRxModulation, aesEnable=aesEnable, PwType=PwType, transferStart=transferStart, remTempAlarm=remTempAlarm, locTe1AlarmsEntry=locTe1AlarmsEntry, defaultGateway=defaultGateway, trapLocLinkStat=trapLocLinkStat, locLinkStateV=locLinkStateV, outboundEthernetThroughput=outboundEthernetThroughput, locResetStats=locResetStats, remCurrentTempS=remCurrentTempS, modelName=modelName, selectT1orE1=selectT1orE1, remMinRSLtimestamp=remMinRSLtimestamp, alarms=alarms, remLinkStateH=remLinkStateH, trapIpaddr2=trapIpaddr2, radioName=radioName, fileManagement=fileManagement, ipAddressNetmask=ipAddressNetmask, remTe1Alarm=remTe1Alarm, remCurrentBER=remCurrentBER, productsMIBObjects=productsMIBObjects, locErrorDuration=locErrorDuration, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, radioReboot=radioReboot, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, trapIpaddr3=trapIpaddr3, commitSnmpSettings=commitSnmpSettings, locLinkStateH=locLinkStateH, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locMinRSLstr=locMinRSLstr, remMinRSL=remMinRSL, remCurrentBERstr=remCurrentBERstr, transferStatus=transferStatus, rdkDbVer=rdkDbVer, hwId=hwId, licKey=licKey, systemConfig=systemConfig, remUnavailDuration=remUnavailDuration, locCurrentBER=locCurrentBER, firmwareVersion=firmwareVersion, trapReboot=trapReboot, locMinRSLtimestamp=locMinRSLtimestamp, commitTe1Settings=commitTe1Settings, productsAllObjects=productsAllObjects, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locUnavailDuration=locUnavailDuration, remUnavailDurationStr=remUnavailDurationStr, tftpServerIp=tftpServerIp, ntpClientEnable=ntpClientEnable, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locTe1Alarms=locTe1Alarms, te1Status=te1Status, locTe1LinkSummary=locTe1LinkSummary, radioInfo=radioInfo, sysDate=sysDate, adminPassword=adminPassword, swapFWimage=swapFWimage, trapLocAlarmStat=trapLocAlarmStat, interfaceType=interfaceType, remErrorDuration=remErrorDuration, locEthUtilizationIn=locEthUtilizationIn, commitSystemSettings=commitSystemSettings, remLinkStateV=remLinkStateV, locCurrentBERstr=locCurrentBERstr, locLinkSecMismatch=locLinkSecMismatch, serialNumber=serialNumber, locMaxRSLstr=locMaxRSLstr, locMinRSL=locMinRSL, alternateFwFilename=alternateFwFilename, locSysAlarms=locSysAlarms, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remCurrentRSL=remCurrentRSL, remTE1Alarms=remTE1Alarms, interface=interface, te1Interfaces=te1Interfaces, trapIpaddrEnable4=trapIpaddrEnable4, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, ntpServer3IpAddr=ntpServer3IpAddr, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, snmpConfig=snmpConfig, trapRemAlarmStat=trapRemAlarmStat, remTe1Alarms=remTe1Alarms, subnetMask=subnetMask, remCurrentTemp=remCurrentTemp, te1AIS=te1AIS, locUnavailDurationStr=locUnavailDurationStr, t1LineCode=t1LineCode, currentFwFilename=currentFwFilename, partNumber=partNumber, linkSecKey=linkSecKey, ipRemote=ipRemote, remSysAlarms=remSysAlarms, trapv3Enable=trapv3Enable, remLinkState=remLinkState, remResetStats=remResetStats, transferType=transferType, txFreqRange=txFreqRange, locCurrentTemp=locCurrentTemp, ntpServer4IpAddr=ntpServer4IpAddr, locErrorDurationStr=locErrorDurationStr, remTe1AlarmsEntry=remTe1AlarmsEntry, sysTime=sysTime, productsMIBGroups=productsMIBGroups, locTempAlarm=locTempAlarm, trapIpaddrEnable3=trapIpaddrEnable3, ipAddress=ipAddress, trapIpaddrEnable2=trapIpaddrEnable2, remCurrentRSLstr=remCurrentRSLstr, locCurrentRSLstr=locCurrentRSLstr, trapLocRslStat=trapLocRslStat, te1Interface=te1Interface, locTE1Alarms=locTE1Alarms, locEthPerfInterfaces=locEthPerfInterfaces, remMaxRSLstr=remMaxRSLstr, locMinimumRxModulation=locMinimumRxModulation, radioMonitor=radioMonitor)
