...
AcmModulationT, AuxNmsMode, EthMainStatusT, VlanStatusT, exaltcommunications, ExaltEnableT, Te1LineCodeT, Te1LboT, FileTransferStartT, EthAuxStatusT, Te1StatusT, Led4ColorT, EthPortMode, VlanGroupT, EnableStatusT, Te1LoopBackModeT, AlarmLevelT, NtpClientEnableT, FileTransferTypeT, TimeZoneT = mibBuilder.importSymbols("ExaltComm", "AcmModulationT", "AuxNmsMode", "EthMainStatusT", "VlanStatusT", "exaltcommunications", "ExaltEnableT", "Te1LineCodeT", "Te1LboT", "FileTransferStartT", "EthAuxStatusT", "Te1StatusT", "Led4ColorT", "EthPortMode", "VlanGroupT", "EnableStatusT", "Te1LoopBackModeT", "AlarmLevelT", "NtpClientEnableT", "FileTransferTypeT", "TimeZoneT")
...
mibBuilder.exportSymbols("ExaltComProducts", locEthUtilizationWatermark=locEthUtilizationWatermark, commitSystemSettings=commitSystemSettings, commitNtpSettings=commitNtpSettings, interfaceType=interfaceType, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, txFreqRange=txFreqRange, aesKey=aesKey, perfLocal=perfLocal, radioName=radioName, remResetStats=remResetStats, productsMIBGroups=productsMIBGroups, locTempAlarm=locTempAlarm, trapIpaddr1=trapIpaddr1, remErrorDurationStr=remErrorDurationStr, partNumber=partNumber, ipLocal=ipLocal, locSysAlarms=locSysAlarms, te1NumChannels=te1NumChannels, te1Interfaces=te1Interfaces, locUnavailDuration=locUnavailDuration, outboundEthernetThroughput=outboundEthernetThroughput, PYSNMP_MODULE_ID=productsMIB, locEthAlarms=locEthAlarms, remLinkStateV=remLinkStateV, userPassword=userPassword, locTe1Alarm=locTe1Alarm, locErrorDuration=locErrorDuration, tftpServerIp=tftpServerIp, t1LineCode=t1LineCode, ipAddressNetmask=ipAddressNetmask, remMinRSLstr=remMinRSLstr, remMinRSLtimestamp=remMinRSLtimestamp, locTe1Alarms=locTe1Alarms, locEthUtilizationIn=locEthUtilizationIn, locResetStats=locResetStats, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locTe1AlarmsEntry=locTe1AlarmsEntry, subnetMask=subnetMask, radioAdmin=radioAdmin, te1Status=te1Status, locCurrentRSLstr=locCurrentRSLstr, inboundEthernetThroughput=inboundEthernetThroughput, trapIpaddrEnable2=trapIpaddrEnable2, systemConfig=systemConfig, almRemote=almRemote, te1NumActiveChannels=te1NumActiveChannels, locMaximumTxModulation=locMaximumTxModulation, interface=interface, hwId=hwId, trapv1Enable=trapv1Enable, locLinkState=locLinkState, fileTransfer=fileTransfer, remEthAlarms=remEthAlarms, locCurrentTemp=locCurrentTemp, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, t1LBO=t1LBO, ntpTimeZoneSelect=ntpTimeZoneSelect, trapLocTempStat=trapLocTempStat, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, remCurrentBERstr=remCurrentBERstr, trapLocLinkStat=trapLocLinkStat, rnRemote=rnRemote, rdkDbVer=rdkDbVer, ntpServer3IpAddr=ntpServer3IpAddr, te1LoopBackMode=te1LoopBackMode, remLinkSecMismatch=remLinkSecMismatch, productsMIBConformance=productsMIBConformance, productsMIBCompliances=productsMIBCompliances, remLinkStateH=remLinkStateH, commitAdminSettings=commitAdminSettings, trapIpaddr4=trapIpaddr4, ntpServer4IpAddr=ntpServer4IpAddr, alternateFwFilename=alternateFwFilename, modelName=modelName, remTE1Alarms=remTE1Alarms, locActiveTxModulation=locActiveTxModulation, trapv3Enable=trapv3Enable, remSampleDurationStr=remSampleDurationStr, remMaxRSLstr=remMaxRSLstr, sysTime=sysTime, trapLocRslStat=trapLocRslStat, te1=te1, trapIpaddrEnable4=trapIpaddrEnable4, trapLocAlarmStat=trapLocAlarmStat, remTe1LinkSummary=remTe1LinkSummary, remUnavailDurationStr=remUnavailDurationStr, remTe1AlarmsEntry=remTe1AlarmsEntry, locCurrentBERstr=locCurrentBERstr, locCurrentTempS=locCurrentTempS, locTe1LinkSummary=locTe1LinkSummary, aesEnable=aesEnable, locEthUtilizationOut=locEthUtilizationOut, trapLocRslThreshold=trapLocRslThreshold, ntpClientEnable=ntpClientEnable, locTE1Alarms=locTE1Alarms, rxFreqRange=rxFreqRange, commitTe1Settings=commitTe1Settings, locSampleDuration=locSampleDuration, trapIpaddr3=trapIpaddr3, trapIpaddr2=trapIpaddr2, currentFwFilename=currentFwFilename, performance=performance, defaultGateway=defaultGateway, ntpServer2IpAddr=ntpServer2IpAddr, alarms=alarms, locErrorDurationStr=locErrorDurationStr, linkName=linkName, linkSecKey=linkSecKey, remTe1Alarm=remTe1Alarm, transferType=transferType, remMaxRSL=remMaxRSL, locMaximumRxModulation=locMaximumRxModulation, trapReboot=trapReboot, remTempAlarm=remTempAlarm, remErrorDuration=remErrorDuration, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, modelNumber=modelNumber, locLinkStateH=locLinkStateH, locActiveRxModulation=locActiveRxModulation, productsMIBNotifications=productsMIBNotifications, snmpConfig=snmpConfig, aggregateUserThroughput=aggregateUserThroughput, remCurrentRSL=remCurrentRSL, rnLocal=rnLocal, locMinRSLstr=locMinRSLstr, productsAllObjects=productsAllObjects, sysDate=sysDate, userThroughput=userThroughput, adminPassword=adminPassword, locMinRSLtimestamp=locMinRSLtimestamp, productsMIB=productsMIB, trapIpaddrEnable1=trapIpaddrEnable1, remCurrentTemp=remCurrentTemp, radioInfo=radioInfo, locLinkSecMismatch=locLinkSecMismatch, firmwareVersion=firmwareVersion, perfRemote=perfRemote, ipRemote=ipRemote, remCurrentTempS=remCurrentTempS, remSampleDuration=remSampleDuration, te1AIS=te1AIS, productsMIBObjects=productsMIBObjects, locUnavailDurationStr=locUnavailDurationStr, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locSampleDurationStr=locSampleDurationStr, locEthPerfInterfaces=locEthPerfInterfaces, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, serialNumber=serialNumber, selectT1orE1=selectT1orE1, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, almLocal=almLocal, licenseFeatures=licenseFeatures, PwType=PwType, remCurrentBER=remCurrentBER, fileManagement=fileManagement, locMinRSL=locMinRSL, locEthSpeed=locEthSpeed, locMinimumTxModulation=locMinimumTxModulation, ntp=ntp, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locLinkStateV=locLinkStateV, locCurrentBER=locCurrentBER, factoryFwFilename=factoryFwFilename, remLinkState=remLinkState, rfFreqBand=rfFreqBand, trapAuth=trapAuth, radioReboot=radioReboot, remTe1Alarms=remTe1Alarms, locCurrentRSL=locCurrentRSL, locMinimumRxModulation=locMinimumRxModulation, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, trapRemAlarmStat=trapRemAlarmStat, radioConfig=radioConfig, transferStart=transferStart, remMinRSL=remMinRSL, remSysAlarms=remSysAlarms, licKey=licKey, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, ipAddress=ipAddress, transferStatus=transferStatus, radioMonitor=radioMonitor, locMaxRSL=locMaxRSL, locMaxRSLstr=locMaxRSLstr, ntpServer1IpAddr=ntpServer1IpAddr, uploadFilename=uploadFilename, swapFWimage=swapFWimage, remUnavailDuration=remUnavailDuration, remCurrentRSLstr=remCurrentRSLstr, te1Interface=te1Interface, trapv2cEnable=trapv2cEnable, bootVersion=bootVersion, commitSnmpSettings=commitSnmpSettings, trapIpaddrEnable3=trapIpaddrEnable3)
