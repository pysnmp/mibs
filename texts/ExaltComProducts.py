...
EthPortMode, AcmModulationT, VlanGroupT, EthAuxStatusT, Te1LineCodeT, EnableStatusT, Te1StatusT, TimeZoneT, AuxNmsMode, VlanStatusT, FileTransferStartT, Te1LboT, exaltcommunications, Led4ColorT, FileTransferTypeT, AlarmLevelT, EthMainStatusT, Te1LoopBackModeT, NtpClientEnableT, ExaltEnableT = mibBuilder.importSymbols("ExaltComm", "EthPortMode", "AcmModulationT", "VlanGroupT", "EthAuxStatusT", "Te1LineCodeT", "EnableStatusT", "Te1StatusT", "TimeZoneT", "AuxNmsMode", "VlanStatusT", "FileTransferStartT", "Te1LboT", "exaltcommunications", "Led4ColorT", "FileTransferTypeT", "AlarmLevelT", "EthMainStatusT", "Te1LoopBackModeT", "NtpClientEnableT", "ExaltEnableT")
...
mibBuilder.exportSymbols("ExaltComProducts", userThroughput=userThroughput, fileManagement=fileManagement, fileTransfer=fileTransfer, uploadFilename=uploadFilename, remEthAlarms=remEthAlarms, ipAddress=ipAddress, currentFwFilename=currentFwFilename, locTe1Alarms=locTe1Alarms, radioInfo=radioInfo, defaultGateway=defaultGateway, productsMIBConformance=productsMIBConformance, rfFreqBand=rfFreqBand, ipRemote=ipRemote, te1=te1, PYSNMP_MODULE_ID=productsMIB, trapIpaddrEnable3=trapIpaddrEnable3, perfRemote=perfRemote, linkSecKey=linkSecKey, te1NumChannels=te1NumChannels, trapIpaddr3=trapIpaddr3, remMaxRSL=remMaxRSL, locTE1Alarms=locTE1Alarms, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, commitNtpSettings=commitNtpSettings, rnRemote=rnRemote, commitSnmpSettings=commitSnmpSettings, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, alarms=alarms, productsMIBNotifications=productsMIBNotifications, transferType=transferType, radioAdmin=radioAdmin, locUnavailDuration=locUnavailDuration, almLocal=almLocal, txFreqRange=txFreqRange, factoryFwFilename=factoryFwFilename, locCurrentTemp=locCurrentTemp, locMaximumTxModulation=locMaximumTxModulation, licKey=licKey, remCurrentBER=remCurrentBER, ipLocal=ipLocal, systemConfig=systemConfig, linkName=linkName, locSysAlarms=locSysAlarms, locUnavailDurationStr=locUnavailDurationStr, productsMIBCompliances=productsMIBCompliances, trapLocLinkStat=trapLocLinkStat, ntpServer3IpAddr=ntpServer3IpAddr, ntpServer1IpAddr=ntpServer1IpAddr, hwId=hwId, locMinimumRxModulation=locMinimumRxModulation, trapLocRslStat=trapLocRslStat, trapIpaddrEnable2=trapIpaddrEnable2, productsAllObjects=productsAllObjects, locCurrentRSL=locCurrentRSL, remTe1Alarm=remTe1Alarm, locLinkSecMismatch=locLinkSecMismatch, locResetStats=locResetStats, selectT1orE1=selectT1orE1, trapLocAlarmStat=trapLocAlarmStat, ntpTimeZoneSelect=ntpTimeZoneSelect, radioMonitor=radioMonitor, te1LoopBackMode=te1LoopBackMode, transferStart=transferStart, rxFreqRange=rxFreqRange, te1Status=te1Status, locTempAlarm=locTempAlarm, locEthUtilizationWatermark=locEthUtilizationWatermark, locMaximumRxModulation=locMaximumRxModulation, te1NumActiveChannels=te1NumActiveChannels, locMinRSLtimestamp=locMinRSLtimestamp, remErrorDuration=remErrorDuration, trapLocRslThreshold=trapLocRslThreshold, adminPassword=adminPassword, ntp=ntp, ntpClientEnable=ntpClientEnable, snmpConfig=snmpConfig, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, remSampleDuration=remSampleDuration, remCurrentBERstr=remCurrentBERstr, locErrorDuration=locErrorDuration, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locLinkStateH=locLinkStateH, rdkDbVer=rdkDbVer, locCurrentBERstr=locCurrentBERstr, locMinRSL=locMinRSL, locMaxRSLstr=locMaxRSLstr, radioConfig=radioConfig, tftpServerIp=tftpServerIp, remCurrentTempS=remCurrentTempS, almRemote=almRemote, remTE1Alarms=remTE1Alarms, locEthSpeed=locEthSpeed, outboundEthernetThroughput=outboundEthernetThroughput, remErrorDurationStr=remErrorDurationStr, trapIpaddrEnable4=trapIpaddrEnable4, radioReboot=radioReboot, modelNumber=modelNumber, te1Interfaces=te1Interfaces, locLinkStateV=locLinkStateV, remTempAlarm=remTempAlarm, remCurrentTemp=remCurrentTemp, remMaxRSLstr=remMaxRSLstr, remTe1Alarms=remTe1Alarms, trapLocTempStat=trapLocTempStat, ipAddressNetmask=ipAddressNetmask, trapIpaddr1=trapIpaddr1, productsMIBGroups=productsMIBGroups, locMinimumTxModulation=locMinimumTxModulation, trapIpaddrEnable1=trapIpaddrEnable1, locMaxRSL=locMaxRSL, trapv2cEnable=trapv2cEnable, productsMIB=productsMIB, performance=performance, subnetMask=subnetMask, sysDate=sysDate, rnLocal=rnLocal, locTe1AlarmsEntry=locTe1AlarmsEntry, commitTe1Settings=commitTe1Settings, inboundEthernetThroughput=inboundEthernetThroughput, remSampleDurationStr=remSampleDurationStr, ntpServer4IpAddr=ntpServer4IpAddr, locCurrentRSLstr=locCurrentRSLstr, ntpServer2IpAddr=ntpServer2IpAddr, productsMIBObjects=productsMIBObjects, remMinRSLstr=remMinRSLstr, remMinRSL=remMinRSL, t1LineCode=t1LineCode, remLinkStateV=remLinkStateV, remLinkStateH=remLinkStateH, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locSampleDuration=locSampleDuration, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locCurrentBER=locCurrentBER, te1AIS=te1AIS, locLinkState=locLinkState, locEthUtilizationOut=locEthUtilizationOut, remTe1LinkSummary=remTe1LinkSummary, trapIpaddr2=trapIpaddr2, remMinRSLtimestamp=remMinRSLtimestamp, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locSampleDurationStr=locSampleDurationStr, remSysAlarms=remSysAlarms, remLinkSecMismatch=remLinkSecMismatch, locActiveTxModulation=locActiveTxModulation, aesKey=aesKey, radioName=radioName, trapIpaddr4=trapIpaddr4, locEthAlarms=locEthAlarms, locEthPerfInterfaces=locEthPerfInterfaces, transferStatus=transferStatus, te1Interface=te1Interface, locTe1Alarm=locTe1Alarm, remCurrentRSLstr=remCurrentRSLstr, firmwareVersion=firmwareVersion, bootVersion=bootVersion, trapReboot=trapReboot, t1LBO=t1LBO, swapFWimage=swapFWimage, licenseFeatures=licenseFeatures, interfaceType=interfaceType, locTe1LinkSummary=locTe1LinkSummary, locMinRSLstr=locMinRSLstr, remUnavailDuration=remUnavailDuration, aesEnable=aesEnable, locCurrentTempS=locCurrentTempS, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, trapv3Enable=trapv3Enable, trapAuth=trapAuth, interface=interface, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, partNumber=partNumber, commitSystemSettings=commitSystemSettings, aggregateUserThroughput=aggregateUserThroughput, userPassword=userPassword, trapRemAlarmStat=trapRemAlarmStat, modelName=modelName, locEthUtilizationIn=locEthUtilizationIn, locActiveRxModulation=locActiveRxModulation, remUnavailDurationStr=remUnavailDurationStr, commitAdminSettings=commitAdminSettings, trapv1Enable=trapv1Enable, remTe1AlarmsEntry=remTe1AlarmsEntry, perfLocal=perfLocal, remResetStats=remResetStats, alternateFwFilename=alternateFwFilename, PwType=PwType, sysTime=sysTime, remLinkState=remLinkState, locErrorDurationStr=locErrorDurationStr, serialNumber=serialNumber, remCurrentRSL=remCurrentRSL)
