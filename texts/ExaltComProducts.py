...
AlarmLevelT, FileTransferStartT, EthMainStatusT, TimeZoneT, VlanStatusT, AcmModulationT, EthAuxStatusT, exaltcommunications, Te1LineCodeT, EnableStatusT, AuxNmsMode, VlanGroupT, EthPortMode, FileTransferTypeT, Led4ColorT, Te1LboT, Te1LoopBackModeT, NtpClientEnableT, Te1StatusT, ExaltEnableT = mibBuilder.importSymbols("ExaltComm", "AlarmLevelT", "FileTransferStartT", "EthMainStatusT", "TimeZoneT", "VlanStatusT", "AcmModulationT", "EthAuxStatusT", "exaltcommunications", "Te1LineCodeT", "EnableStatusT", "AuxNmsMode", "VlanGroupT", "EthPortMode", "FileTransferTypeT", "Led4ColorT", "Te1LboT", "Te1LoopBackModeT", "NtpClientEnableT", "Te1StatusT", "ExaltEnableT")
...
mibBuilder.exportSymbols("ExaltComProducts", locLinkSecMismatch=locLinkSecMismatch, userThroughput=userThroughput, sysTime=sysTime, locTempAlarm=locTempAlarm, remTe1Alarms=remTe1Alarms, locMinimumRxModulation=locMinimumRxModulation, trapv3Enable=trapv3Enable, hwId=hwId, outboundEthernetThroughput=outboundEthernetThroughput, te1Status=te1Status, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, bootVersion=bootVersion, remLinkState=remLinkState, trapRemAlarmStat=trapRemAlarmStat, commitTe1Settings=commitTe1Settings, ipAddress=ipAddress, PwType=PwType, ntp=ntp, te1LoopBackMode=te1LoopBackMode, remLinkSecMismatch=remLinkSecMismatch, locCurrentBERstr=locCurrentBERstr, subnetMask=subnetMask, inboundEthernetThroughput=inboundEthernetThroughput, locCurrentRSL=locCurrentRSL, ntpServer1IpAddr=ntpServer1IpAddr, trapLocRslThreshold=trapLocRslThreshold, locCurrentBER=locCurrentBER, linkSecKey=linkSecKey, ntpServer4IpAddr=ntpServer4IpAddr, te1AIS=te1AIS, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, almLocal=almLocal, trapLocTempStat=trapLocTempStat, remEthAlarms=remEthAlarms, locCurrentRSLstr=locCurrentRSLstr, trapLocLinkStat=trapLocLinkStat, locResetStats=locResetStats, firmwareVersion=firmwareVersion, trapIpaddr4=trapIpaddr4, PYSNMP_MODULE_ID=productsMIB, trapIpaddrEnable2=trapIpaddrEnable2, locTe1Alarms=locTe1Alarms, rdkDbVer=rdkDbVer, currentFwFilename=currentFwFilename, remCurrentBER=remCurrentBER, locLinkStateH=locLinkStateH, ipRemote=ipRemote, txFreqRange=txFreqRange, remUnavailDuration=remUnavailDuration, serialNumber=serialNumber, rxFreqRange=rxFreqRange, locTE1Alarms=locTE1Alarms, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, ntpTimeZoneSelect=ntpTimeZoneSelect, locEthPerfInterfaces=locEthPerfInterfaces, modelNumber=modelNumber, transferStatus=transferStatus, remErrorDurationStr=remErrorDurationStr, te1Interfaces=te1Interfaces, productsMIB=productsMIB, fileTransfer=fileTransfer, commitSystemSettings=commitSystemSettings, radioConfig=radioConfig, locCurrentTempS=locCurrentTempS, remSampleDurationStr=remSampleDurationStr, trapAuth=trapAuth, snmpConfig=snmpConfig, ipAddressNetmask=ipAddressNetmask, locTe1Alarm=locTe1Alarm, remMinRSL=remMinRSL, linkName=linkName, trapLocRslStat=trapLocRslStat, rfFreqBand=rfFreqBand, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remCurrentTempS=remCurrentTempS, remTe1AlarmsEntry=remTe1AlarmsEntry, systemConfig=systemConfig, locMinRSLstr=locMinRSLstr, rnLocal=rnLocal, remErrorDuration=remErrorDuration, aggregateUserThroughput=aggregateUserThroughput, trapv1Enable=trapv1Enable, alternateFwFilename=alternateFwFilename, ipLocal=ipLocal, transferType=transferType, tftpServerIp=tftpServerIp, remCurrentTemp=remCurrentTemp, remResetStats=remResetStats, alarms=alarms, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locMaximumTxModulation=locMaximumTxModulation, remCurrentRSLstr=remCurrentRSLstr, remLinkStateV=remLinkStateV, locLinkStateV=locLinkStateV, locTe1LinkSummary=locTe1LinkSummary, productsMIBGroups=productsMIBGroups, locActiveRxModulation=locActiveRxModulation, fileManagement=fileManagement, locUnavailDuration=locUnavailDuration, radioAdmin=radioAdmin, te1NumChannels=te1NumChannels, selectT1orE1=selectT1orE1, remTe1LinkSummary=remTe1LinkSummary, locTe1AlarmsEntry=locTe1AlarmsEntry, interfaceType=interfaceType, trapIpaddrEnable3=trapIpaddrEnable3, aesEnable=aesEnable, ntpServer2IpAddr=ntpServer2IpAddr, locMinRSLtimestamp=locMinRSLtimestamp, remUnavailDurationStr=remUnavailDurationStr, locMaxRSL=locMaxRSL, locEthUtilizationIn=locEthUtilizationIn, locUnavailDurationStr=locUnavailDurationStr, remTE1Alarms=remTE1Alarms, productsMIBConformance=productsMIBConformance, locMinRSL=locMinRSL, rnRemote=rnRemote, trapReboot=trapReboot, userPassword=userPassword, trapIpaddr1=trapIpaddr1, trapIpaddrEnable1=trapIpaddrEnable1, ntpServer3IpAddr=ntpServer3IpAddr, commitAdminSettings=commitAdminSettings, productsMIBNotifications=productsMIBNotifications, radioReboot=radioReboot, productsMIBObjects=productsMIBObjects, interface=interface, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, partNumber=partNumber, locSampleDurationStr=locSampleDurationStr, licenseFeatures=licenseFeatures, remMaxRSL=remMaxRSL, remSysAlarms=remSysAlarms, perfLocal=perfLocal, licKey=licKey, radioName=radioName, swapFWimage=swapFWimage, perfRemote=perfRemote, locErrorDurationStr=locErrorDurationStr, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locActiveTxModulation=locActiveTxModulation, remSampleDuration=remSampleDuration, locLinkState=locLinkState, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, remMaxRSLstr=remMaxRSLstr, remMinRSLstr=remMinRSLstr, modelName=modelName, locSampleDuration=locSampleDuration, productsMIBCompliances=productsMIBCompliances, productsAllObjects=productsAllObjects, trapIpaddr2=trapIpaddr2, remCurrentRSL=remCurrentRSL, trapLocAlarmStat=trapLocAlarmStat, t1LineCode=t1LineCode, performance=performance, locSysAlarms=locSysAlarms, almRemote=almRemote, remTempAlarm=remTempAlarm, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, radioMonitor=radioMonitor, te1Interface=te1Interface, trapIpaddrEnable4=trapIpaddrEnable4, remTe1Alarm=remTe1Alarm, sysDate=sysDate, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locMaxRSLstr=locMaxRSLstr, t1LBO=t1LBO, factoryFwFilename=factoryFwFilename, locCurrentTemp=locCurrentTemp, remMinRSLtimestamp=remMinRSLtimestamp, remLinkStateH=remLinkStateH, locEthUtilizationOut=locEthUtilizationOut, transferStart=transferStart, commitNtpSettings=commitNtpSettings, radioInfo=radioInfo, uploadFilename=uploadFilename, remCurrentBERstr=remCurrentBERstr, ntpClientEnable=ntpClientEnable, locEthAlarms=locEthAlarms, te1=te1, trapIpaddr3=trapIpaddr3, locErrorDuration=locErrorDuration, locEthUtilizationWatermark=locEthUtilizationWatermark, locEthSpeed=locEthSpeed, defaultGateway=defaultGateway, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, trapv2cEnable=trapv2cEnable, adminPassword=adminPassword, aesKey=aesKey, locMinimumTxModulation=locMinimumTxModulation, locMaximumRxModulation=locMaximumRxModulation, commitSnmpSettings=commitSnmpSettings, te1NumActiveChannels=te1NumActiveChannels)
