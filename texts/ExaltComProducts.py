...
AuxNmsMode, FileTransferTypeT, exaltcommunications, Te1StatusT, NtpClientEnableT, Te1LoopBackModeT, ExaltEnableT, Led4ColorT, Te1LboT, Te1LineCodeT, AlarmLevelT, FileTransferStartT, EthPortMode, AcmModulationT, EthAuxStatusT, VlanGroupT, EthMainStatusT, VlanStatusT, TimeZoneT, EnableStatusT = mibBuilder.importSymbols("ExaltComm", "AuxNmsMode", "FileTransferTypeT", "exaltcommunications", "Te1StatusT", "NtpClientEnableT", "Te1LoopBackModeT", "ExaltEnableT", "Led4ColorT", "Te1LboT", "Te1LineCodeT", "AlarmLevelT", "FileTransferStartT", "EthPortMode", "AcmModulationT", "EthAuxStatusT", "VlanGroupT", "EthMainStatusT", "VlanStatusT", "TimeZoneT", "EnableStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", ntpClientEnable=ntpClientEnable, remLinkStateH=remLinkStateH, outboundEthernetThroughput=outboundEthernetThroughput, trapIpaddrEnable2=trapIpaddrEnable2, trapLocRslStat=trapLocRslStat, transferType=transferType, locUnavailDuration=locUnavailDuration, locUnavailDurationStr=locUnavailDurationStr, rdkDbVer=rdkDbVer, trapv1Enable=trapv1Enable, swapFWimage=swapFWimage, locTE1Alarms=locTE1Alarms, trapv3Enable=trapv3Enable, te1Status=te1Status, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, performance=performance, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, sysTime=sysTime, transferStatus=transferStatus, locCurrentBERstr=locCurrentBERstr, te1Interface=te1Interface, remMinRSL=remMinRSL, radioReboot=radioReboot, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locEthAlarms=locEthAlarms, locResetStats=locResetStats, locErrorDurationStr=locErrorDurationStr, fileTransfer=fileTransfer, trapRemAlarmStat=trapRemAlarmStat, trapLocRslThreshold=trapLocRslThreshold, radioName=radioName, defaultGateway=defaultGateway, perfRemote=perfRemote, interfaceType=interfaceType, locEthUtilizationWatermark=locEthUtilizationWatermark, trapReboot=trapReboot, locLinkState=locLinkState, remTE1Alarms=remTE1Alarms, snmpConfig=snmpConfig, remUnavailDuration=remUnavailDuration, firmwareVersion=firmwareVersion, trapIpaddrEnable3=trapIpaddrEnable3, trapv2cEnable=trapv2cEnable, productsMIBConformance=productsMIBConformance, ntp=ntp, ntpServer2IpAddr=ntpServer2IpAddr, locSysAlarms=locSysAlarms, trapLocLinkStat=trapLocLinkStat, ipRemote=ipRemote, locEthUtilizationIn=locEthUtilizationIn, locMinRSLstr=locMinRSLstr, ntpServer3IpAddr=ntpServer3IpAddr, inboundEthernetThroughput=inboundEthernetThroughput, trapAuth=trapAuth, locLinkStateH=locLinkStateH, ipAddress=ipAddress, locCurrentTemp=locCurrentTemp, PYSNMP_MODULE_ID=productsMIB, trapIpaddrEnable1=trapIpaddrEnable1, trapLocAlarmStat=trapLocAlarmStat, linkSecKey=linkSecKey, locEthSpeed=locEthSpeed, remMaxRSLstr=remMaxRSLstr, locTe1Alarms=locTe1Alarms, remCurrentTemp=remCurrentTemp, locTe1Alarm=locTe1Alarm, perfLocal=perfLocal, remCurrentRSL=remCurrentRSL, ntpServer4IpAddr=ntpServer4IpAddr, locSampleDurationStr=locSampleDurationStr, PwType=PwType, userThroughput=userThroughput, remMinRSLstr=remMinRSLstr, te1NumChannels=te1NumChannels, trapIpaddr1=trapIpaddr1, remErrorDurationStr=remErrorDurationStr, commitSystemSettings=commitSystemSettings, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locMinRSLtimestamp=locMinRSLtimestamp, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, rnRemote=rnRemote, rxFreqRange=rxFreqRange, commitAdminSettings=commitAdminSettings, te1NumActiveChannels=te1NumActiveChannels, currentFwFilename=currentFwFilename, locTempAlarm=locTempAlarm, remLinkStateV=remLinkStateV, locEthUtilizationOut=locEthUtilizationOut, remCurrentBER=remCurrentBER, productsMIB=productsMIB, modelName=modelName, te1LoopBackMode=te1LoopBackMode, remTe1AlarmsEntry=remTe1AlarmsEntry, remSysAlarms=remSysAlarms, almLocal=almLocal, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remCurrentBERstr=remCurrentBERstr, remSampleDuration=remSampleDuration, fileManagement=fileManagement, trapIpaddrEnable4=trapIpaddrEnable4, remLinkSecMismatch=remLinkSecMismatch, remMaxRSL=remMaxRSL, locMaximumRxModulation=locMaximumRxModulation, txFreqRange=txFreqRange, remTempAlarm=remTempAlarm, linkName=linkName, ipLocal=ipLocal, locActiveRxModulation=locActiveRxModulation, remResetStats=remResetStats, radioInfo=radioInfo, locErrorDuration=locErrorDuration, rnLocal=rnLocal, locMinRSL=locMinRSL, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, remTe1LinkSummary=remTe1LinkSummary, sysDate=sysDate, ntpTimeZoneSelect=ntpTimeZoneSelect, t1LineCode=t1LineCode, uploadFilename=uploadFilename, transferStart=transferStart, locCurrentRSLstr=locCurrentRSLstr, locCurrentRSL=locCurrentRSL, adminPassword=adminPassword, productsAllObjects=productsAllObjects, serialNumber=serialNumber, remLinkState=remLinkState, radioMonitor=radioMonitor, tftpServerIp=tftpServerIp, remTe1Alarm=remTe1Alarm, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remMinRSLtimestamp=remMinRSLtimestamp, commitTe1Settings=commitTe1Settings, commitSnmpSettings=commitSnmpSettings, ntpServer1IpAddr=ntpServer1IpAddr, remEthAlarms=remEthAlarms, licKey=licKey, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, te1AIS=te1AIS, locCurrentBER=locCurrentBER, systemConfig=systemConfig, bootVersion=bootVersion, alarms=alarms, radioAdmin=radioAdmin, modelNumber=modelNumber, aesEnable=aesEnable, locTe1LinkSummary=locTe1LinkSummary, almRemote=almRemote, locTe1AlarmsEntry=locTe1AlarmsEntry, locMaxRSL=locMaxRSL, te1=te1, locEthPerfInterfaces=locEthPerfInterfaces, remTe1Alarms=remTe1Alarms, locMaxRSLstr=locMaxRSLstr, hwId=hwId, locSampleDuration=locSampleDuration, trapIpaddr4=trapIpaddr4, locLinkSecMismatch=locLinkSecMismatch, selectT1orE1=selectT1orE1, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, aggregateUserThroughput=aggregateUserThroughput, alternateFwFilename=alternateFwFilename, productsMIBObjects=productsMIBObjects, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, productsMIBCompliances=productsMIBCompliances, trapLocTempStat=trapLocTempStat, aesKey=aesKey, locLinkStateV=locLinkStateV, locMinimumRxModulation=locMinimumRxModulation, trapIpaddr3=trapIpaddr3, remErrorDuration=remErrorDuration, interface=interface, subnetMask=subnetMask, locActiveTxModulation=locActiveTxModulation, userPassword=userPassword, factoryFwFilename=factoryFwFilename, commitNtpSettings=commitNtpSettings, remCurrentRSLstr=remCurrentRSLstr, t1LBO=t1LBO, remSampleDurationStr=remSampleDurationStr, partNumber=partNumber, locMinimumTxModulation=locMinimumTxModulation, productsMIBGroups=productsMIBGroups, remUnavailDurationStr=remUnavailDurationStr, trapIpaddr2=trapIpaddr2, locMaximumTxModulation=locMaximumTxModulation, te1Interfaces=te1Interfaces, locCurrentTempS=locCurrentTempS, ipAddressNetmask=ipAddressNetmask, productsMIBNotifications=productsMIBNotifications, licenseFeatures=licenseFeatures, radioConfig=radioConfig, remCurrentTempS=remCurrentTempS, rfFreqBand=rfFreqBand)
