...
AcmModulationT, TimeZoneT, Te1LoopBackModeT, NtpClientEnableT, Te1StatusT, FileTransferTypeT, VlanStatusT, EthAuxStatusT, AuxNmsMode, VlanGroupT, AlarmLevelT, EthPortMode, Te1LboT, EnableStatusT, exaltcommunications, ExaltEnableT, Te1LineCodeT, FileTransferStartT, Led4ColorT, EthMainStatusT = mibBuilder.importSymbols("ExaltComm", "AcmModulationT", "TimeZoneT", "Te1LoopBackModeT", "NtpClientEnableT", "Te1StatusT", "FileTransferTypeT", "VlanStatusT", "EthAuxStatusT", "AuxNmsMode", "VlanGroupT", "AlarmLevelT", "EthPortMode", "Te1LboT", "EnableStatusT", "exaltcommunications", "ExaltEnableT", "Te1LineCodeT", "FileTransferStartT", "Led4ColorT", "EthMainStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", trapIpaddrEnable4=trapIpaddrEnable4, te1AIS=te1AIS, locMaxRSL=locMaxRSL, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locCurrentBER=locCurrentBER, ipLocal=ipLocal, ntpServer4IpAddr=ntpServer4IpAddr, locErrorDurationStr=locErrorDurationStr, firmwareVersion=firmwareVersion, ntpServer2IpAddr=ntpServer2IpAddr, transferStart=transferStart, remMinRSLstr=remMinRSLstr, locCurrentRSLstr=locCurrentRSLstr, commitSnmpSettings=commitSnmpSettings, commitNtpSettings=commitNtpSettings, trapLocRslStat=trapLocRslStat, te1Status=te1Status, locTempAlarm=locTempAlarm, remLinkStateH=remLinkStateH, locMaximumRxModulation=locMaximumRxModulation, remTe1Alarms=remTe1Alarms, productsMIBGroups=productsMIBGroups, locTe1Alarms=locTe1Alarms, aesKey=aesKey, remSysAlarms=remSysAlarms, locSampleDurationStr=locSampleDurationStr, locEthPerfInterfaces=locEthPerfInterfaces, locTe1Alarm=locTe1Alarm, rfFreqBand=rfFreqBand, remResetStats=remResetStats, remTe1AlarmsEntry=remTe1AlarmsEntry, locLinkStateH=locLinkStateH, productsMIBConformance=productsMIBConformance, remCurrentRSLstr=remCurrentRSLstr, licKey=licKey, rnLocal=rnLocal, subnetMask=subnetMask, trapIpaddrEnable1=trapIpaddrEnable1, rxFreqRange=rxFreqRange, fileTransfer=fileTransfer, fileManagement=fileManagement, productsMIBCompliances=productsMIBCompliances, remTe1Alarm=remTe1Alarm, trapIpaddr4=trapIpaddr4, ipAddress=ipAddress, locEthUtilizationWatermark=locEthUtilizationWatermark, linkName=linkName, almLocal=almLocal, trapIpaddr3=trapIpaddr3, locSampleDuration=locSampleDuration, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, linkSecKey=linkSecKey, locUnavailDurationStr=locUnavailDurationStr, productsMIBNotifications=productsMIBNotifications, radioConfig=radioConfig, radioName=radioName, t1LBO=t1LBO, currentFwFilename=currentFwFilename, remEthAlarms=remEthAlarms, transferType=transferType, locCurrentBERstr=locCurrentBERstr, radioReboot=radioReboot, modelNumber=modelNumber, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remCurrentRSL=remCurrentRSL, userPassword=userPassword, PwType=PwType, ntp=ntp, sysTime=sysTime, systemConfig=systemConfig, trapLocTempStat=trapLocTempStat, locLinkStateV=locLinkStateV, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, trapv1Enable=trapv1Enable, productsMIBObjects=productsMIBObjects, remLinkStateV=remLinkStateV, ntpServer1IpAddr=ntpServer1IpAddr, interfaceType=interfaceType, factoryFwFilename=factoryFwFilename, interface=interface, remMaxRSL=remMaxRSL, ntpClientEnable=ntpClientEnable, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, te1LoopBackMode=te1LoopBackMode, txFreqRange=txFreqRange, remMinRSL=remMinRSL, commitSystemSettings=commitSystemSettings, defaultGateway=defaultGateway, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locResetStats=locResetStats, adminPassword=adminPassword, ntpServer3IpAddr=ntpServer3IpAddr, rdkDbVer=rdkDbVer, remMinRSLtimestamp=remMinRSLtimestamp, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remMaxRSLstr=remMaxRSLstr, remSampleDurationStr=remSampleDurationStr, te1NumChannels=te1NumChannels, aesEnable=aesEnable, locActiveTxModulation=locActiveTxModulation, locMaxRSLstr=locMaxRSLstr, locEthSpeed=locEthSpeed, snmpConfig=snmpConfig, alarms=alarms, te1Interface=te1Interface, locCurrentRSL=locCurrentRSL, remErrorDurationStr=remErrorDurationStr, remUnavailDurationStr=remUnavailDurationStr, remCurrentTemp=remCurrentTemp, alternateFwFilename=alternateFwFilename, te1NumActiveChannels=te1NumActiveChannels, partNumber=partNumber, locLinkState=locLinkState, radioMonitor=radioMonitor, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, trapLocRslThreshold=trapLocRslThreshold, licenseFeatures=licenseFeatures, remUnavailDuration=remUnavailDuration, aggregateUserThroughput=aggregateUserThroughput, remCurrentTempS=remCurrentTempS, locTe1AlarmsEntry=locTe1AlarmsEntry, locEthUtilizationOut=locEthUtilizationOut, remCurrentBER=remCurrentBER, userThroughput=userThroughput, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, remTe1LinkSummary=remTe1LinkSummary, locTE1Alarms=locTE1Alarms, locCurrentTemp=locCurrentTemp, trapIpaddrEnable3=trapIpaddrEnable3, trapv2cEnable=trapv2cEnable, trapIpaddr1=trapIpaddr1, performance=performance, locMinRSL=locMinRSL, almRemote=almRemote, commitAdminSettings=commitAdminSettings, locMinRSLtimestamp=locMinRSLtimestamp, remLinkSecMismatch=remLinkSecMismatch, productsAllObjects=productsAllObjects, ipRemote=ipRemote, ipAddressNetmask=ipAddressNetmask, tftpServerIp=tftpServerIp, modelName=modelName, locMinimumRxModulation=locMinimumRxModulation, locEthAlarms=locEthAlarms, outboundEthernetThroughput=outboundEthernetThroughput, locUnavailDuration=locUnavailDuration, remSampleDuration=remSampleDuration, t1LineCode=t1LineCode, trapIpaddr2=trapIpaddr2, commitTe1Settings=commitTe1Settings, transferStatus=transferStatus, locErrorDuration=locErrorDuration, trapLocLinkStat=trapLocLinkStat, te1Interfaces=te1Interfaces, remTempAlarm=remTempAlarm, swapFWimage=swapFWimage, trapIpaddrEnable2=trapIpaddrEnable2, locCurrentTempS=locCurrentTempS, rnRemote=rnRemote, remTE1Alarms=remTE1Alarms, perfLocal=perfLocal, productsMIB=productsMIB, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locActiveRxModulation=locActiveRxModulation, remCurrentBERstr=remCurrentBERstr, radioInfo=radioInfo, PYSNMP_MODULE_ID=productsMIB, sysDate=sysDate, trapRemAlarmStat=trapRemAlarmStat, ntpTimeZoneSelect=ntpTimeZoneSelect, locMaximumTxModulation=locMaximumTxModulation, locSysAlarms=locSysAlarms, radioAdmin=radioAdmin, trapReboot=trapReboot, te1=te1, locMinimumTxModulation=locMinimumTxModulation, trapv3Enable=trapv3Enable, serialNumber=serialNumber, locLinkSecMismatch=locLinkSecMismatch, locTe1LinkSummary=locTe1LinkSummary, remErrorDuration=remErrorDuration, locMinRSLstr=locMinRSLstr, selectT1orE1=selectT1orE1, perfRemote=perfRemote, locEthUtilizationIn=locEthUtilizationIn, remLinkState=remLinkState, trapAuth=trapAuth, uploadFilename=uploadFilename, hwId=hwId, inboundEthernetThroughput=inboundEthernetThroughput, bootVersion=bootVersion, trapLocAlarmStat=trapLocAlarmStat)
