...
VlanStatusT, VlanGroupT, FileTransferTypeT, EthPortMode, Te1StatusT, AcmModulationT, ExaltEnableT, Te1LboT, EthAuxStatusT, AuxNmsMode, Led4ColorT, EthMainStatusT, exaltcommunications, AlarmLevelT, FileTransferStartT, Te1LineCodeT, NtpClientEnableT, TimeZoneT, EnableStatusT, Te1LoopBackModeT = mibBuilder.importSymbols("ExaltComm", "VlanStatusT", "VlanGroupT", "FileTransferTypeT", "EthPortMode", "Te1StatusT", "AcmModulationT", "ExaltEnableT", "Te1LboT", "EthAuxStatusT", "AuxNmsMode", "Led4ColorT", "EthMainStatusT", "exaltcommunications", "AlarmLevelT", "FileTransferStartT", "Te1LineCodeT", "NtpClientEnableT", "TimeZoneT", "EnableStatusT", "Te1LoopBackModeT")
...
mibBuilder.exportSymbols("ExaltComProducts", swapFWimage=swapFWimage, remLinkSecMismatch=remLinkSecMismatch, locTempAlarm=locTempAlarm, userThroughput=userThroughput, transferStart=transferStart, adminPassword=adminPassword, remTe1LinkSummary=remTe1LinkSummary, trapLocRslThreshold=trapLocRslThreshold, trapv3Enable=trapv3Enable, radioAdmin=radioAdmin, aggregateUserThroughput=aggregateUserThroughput, remEthAlarms=remEthAlarms, locCurrentTempS=locCurrentTempS, locCurrentBER=locCurrentBER, transferStatus=transferStatus, commitSystemSettings=commitSystemSettings, radioReboot=radioReboot, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, ipAddressNetmask=ipAddressNetmask, remSampleDurationStr=remSampleDurationStr, locMaximumTxModulation=locMaximumTxModulation, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, serialNumber=serialNumber, productsMIBCompliances=productsMIBCompliances, alarms=alarms, remMaxRSL=remMaxRSL, locTe1Alarm=locTe1Alarm, txFreqRange=txFreqRange, ntpTimeZoneSelect=ntpTimeZoneSelect, locLinkState=locLinkState, remTe1Alarms=remTe1Alarms, partNumber=partNumber, PYSNMP_MODULE_ID=productsMIB, remSampleDuration=remSampleDuration, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, trapIpaddr3=trapIpaddr3, locEthUtilizationWatermark=locEthUtilizationWatermark, trapIpaddrEnable1=trapIpaddrEnable1, uploadFilename=uploadFilename, locEthPerfInterfaces=locEthPerfInterfaces, remTempAlarm=remTempAlarm, locLinkStateH=locLinkStateH, trapLocRslStat=trapLocRslStat, locErrorDuration=locErrorDuration, te1Status=te1Status, locEthUtilizationOut=locEthUtilizationOut, rnRemote=rnRemote, te1AIS=te1AIS, remErrorDuration=remErrorDuration, locCurrentBERstr=locCurrentBERstr, locLinkSecMismatch=locLinkSecMismatch, trapRemAlarmStat=trapRemAlarmStat, firmwareVersion=firmwareVersion, commitSnmpSettings=commitSnmpSettings, remMinRSLtimestamp=remMinRSLtimestamp, locTe1LinkSummary=locTe1LinkSummary, ntpServer1IpAddr=ntpServer1IpAddr, productsMIBNotifications=productsMIBNotifications, rdkDbVer=rdkDbVer, locSampleDuration=locSampleDuration, rfFreqBand=rfFreqBand, PwType=PwType, ntpServer2IpAddr=ntpServer2IpAddr, radioMonitor=radioMonitor, radioConfig=radioConfig, locMinRSL=locMinRSL, remCurrentRSLstr=remCurrentRSLstr, remMinRSL=remMinRSL, trapv2cEnable=trapv2cEnable, aesEnable=aesEnable, transferType=transferType, almLocal=almLocal, ntpServer3IpAddr=ntpServer3IpAddr, remResetStats=remResetStats, almRemote=almRemote, te1=te1, remLinkState=remLinkState, sysDate=sysDate, fileManagement=fileManagement, ipRemote=ipRemote, radioName=radioName, locUnavailDuration=locUnavailDuration, locMaxRSLstr=locMaxRSLstr, locMinRSLtimestamp=locMinRSLtimestamp, locUnavailDurationStr=locUnavailDurationStr, trapLocAlarmStat=trapLocAlarmStat, remLinkStateV=remLinkStateV, te1LoopBackMode=te1LoopBackMode, productsMIBGroups=productsMIBGroups, trapLocTempStat=trapLocTempStat, te1NumActiveChannels=te1NumActiveChannels, remCurrentTemp=remCurrentTemp, locMinRSLstr=locMinRSLstr, t1LineCode=t1LineCode, commitNtpSettings=commitNtpSettings, bootVersion=bootVersion, licenseFeatures=licenseFeatures, userPassword=userPassword, perfLocal=perfLocal, productsAllObjects=productsAllObjects, licKey=licKey, remTe1Alarm=remTe1Alarm, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, outboundEthernetThroughput=outboundEthernetThroughput, ntpServer4IpAddr=ntpServer4IpAddr, linkSecKey=linkSecKey, ipAddress=ipAddress, trapIpaddrEnable2=trapIpaddrEnable2, remCurrentBER=remCurrentBER, ipLocal=ipLocal, locCurrentRSLstr=locCurrentRSLstr, remMinRSLstr=remMinRSLstr, locCurrentRSL=locCurrentRSL, remCurrentRSL=remCurrentRSL, trapv1Enable=trapv1Enable, rxFreqRange=rxFreqRange, currentFwFilename=currentFwFilename, locMaximumRxModulation=locMaximumRxModulation, trapReboot=trapReboot, modelNumber=modelNumber, t1LBO=t1LBO, locEthAlarms=locEthAlarms, locEthUtilizationIn=locEthUtilizationIn, fileTransfer=fileTransfer, commitTe1Settings=commitTe1Settings, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, remSysAlarms=remSysAlarms, defaultGateway=defaultGateway, trapIpaddrEnable4=trapIpaddrEnable4, remCurrentTempS=remCurrentTempS, sysTime=sysTime, productsMIBObjects=productsMIBObjects, rnLocal=rnLocal, ntp=ntp, te1NumChannels=te1NumChannels, alternateFwFilename=alternateFwFilename, locActiveRxModulation=locActiveRxModulation, systemConfig=systemConfig, tftpServerIp=tftpServerIp, locActiveTxModulation=locActiveTxModulation, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, locEthSpeed=locEthSpeed, trapIpaddr1=trapIpaddr1, remErrorDurationStr=remErrorDurationStr, remTe1AlarmsEntry=remTe1AlarmsEntry, locMaxRSL=locMaxRSL, aesKey=aesKey, commitAdminSettings=commitAdminSettings, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, trapIpaddr4=trapIpaddr4, interfaceType=interfaceType, hwId=hwId, performance=performance, locErrorDurationStr=locErrorDurationStr, trapIpaddr2=trapIpaddr2, locMinimumRxModulation=locMinimumRxModulation, linkName=linkName, locLinkStateV=locLinkStateV, locTE1Alarms=locTE1Alarms, remUnavailDuration=remUnavailDuration, radioInfo=radioInfo, subnetMask=subnetMask, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remMaxRSLstr=remMaxRSLstr, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, productsMIBConformance=productsMIBConformance, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locMinimumTxModulation=locMinimumTxModulation, te1Interfaces=te1Interfaces, perfRemote=perfRemote, te1Interface=te1Interface, inboundEthernetThroughput=inboundEthernetThroughput, trapLocLinkStat=trapLocLinkStat, locTe1AlarmsEntry=locTe1AlarmsEntry, selectT1orE1=selectT1orE1, trapIpaddrEnable3=trapIpaddrEnable3, locTe1Alarms=locTe1Alarms, remLinkStateH=remLinkStateH, locCurrentTemp=locCurrentTemp, locSampleDurationStr=locSampleDurationStr, remUnavailDurationStr=remUnavailDurationStr, locResetStats=locResetStats, productsMIB=productsMIB, ntpClientEnable=ntpClientEnable, factoryFwFilename=factoryFwFilename, remTE1Alarms=remTE1Alarms, snmpConfig=snmpConfig, remCurrentBERstr=remCurrentBERstr, interface=interface, modelName=modelName, locSysAlarms=locSysAlarms, trapAuth=trapAuth)
