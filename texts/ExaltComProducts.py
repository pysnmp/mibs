...
EthMainStatusT, AlarmLevelT, Led4ColorT, VlanStatusT, ExaltEnableT, EthPortMode, Te1LoopBackModeT, AcmModulationT, AuxNmsMode, EthAuxStatusT, EnableStatusT, exaltcommunications, Te1StatusT, FileTransferTypeT, VlanGroupT, Te1LboT, FileTransferStartT, Te1LineCodeT, NtpClientEnableT, TimeZoneT = mibBuilder.importSymbols("ExaltComm", "EthMainStatusT", "AlarmLevelT", "Led4ColorT", "VlanStatusT", "ExaltEnableT", "EthPortMode", "Te1LoopBackModeT", "AcmModulationT", "AuxNmsMode", "EthAuxStatusT", "EnableStatusT", "exaltcommunications", "Te1StatusT", "FileTransferTypeT", "VlanGroupT", "Te1LboT", "FileTransferStartT", "Te1LineCodeT", "NtpClientEnableT", "TimeZoneT")
...
mibBuilder.exportSymbols("ExaltComProducts", locLinkStateH=locLinkStateH, tftpServerIp=tftpServerIp, remTempAlarm=remTempAlarm, fileManagement=fileManagement, rnRemote=rnRemote, locTempAlarm=locTempAlarm, aggregateUserThroughput=aggregateUserThroughput, te1NumActiveChannels=te1NumActiveChannels, locEthUtilizationIn=locEthUtilizationIn, licenseFeatures=licenseFeatures, sysTime=sysTime, linkName=linkName, commitAdminSettings=commitAdminSettings, almRemote=almRemote, locEthSpeed=locEthSpeed, transferStatus=transferStatus, firmwareVersion=firmwareVersion, rdkDbVer=rdkDbVer, userThroughput=userThroughput, locSysAlarms=locSysAlarms, remLinkState=remLinkState, locResetStats=locResetStats, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, remResetStats=remResetStats, radioMonitor=radioMonitor, te1NumChannels=te1NumChannels, remEthAlarms=remEthAlarms, commitNtpSettings=commitNtpSettings, radioName=radioName, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, adminPassword=adminPassword, locMaxRSLstr=locMaxRSLstr, selectT1orE1=selectT1orE1, locSampleDuration=locSampleDuration, locTe1LinkSummary=locTe1LinkSummary, remCurrentRSLstr=remCurrentRSLstr, trapRemAlarmStat=trapRemAlarmStat, almLocal=almLocal, trapLocTempStat=trapLocTempStat, ipAddressNetmask=ipAddressNetmask, locTE1Alarms=locTE1Alarms, locCurrentRSLstr=locCurrentRSLstr, swapFWimage=swapFWimage, locMinimumTxModulation=locMinimumTxModulation, perfLocal=perfLocal, remUnavailDurationStr=remUnavailDurationStr, transferType=transferType, locUnavailDuration=locUnavailDuration, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, ntpServer3IpAddr=ntpServer3IpAddr, te1LoopBackMode=te1LoopBackMode, modelNumber=modelNumber, remCurrentRSL=remCurrentRSL, remErrorDuration=remErrorDuration, outboundEthernetThroughput=outboundEthernetThroughput, rnLocal=rnLocal, perfRemote=perfRemote, remMaxRSL=remMaxRSL, te1Interface=te1Interface, trapIpaddrEnable2=trapIpaddrEnable2, linkSecKey=linkSecKey, locCurrentBERstr=locCurrentBERstr, serialNumber=serialNumber, trapIpaddr3=trapIpaddr3, modelName=modelName, trapIpaddrEnable3=trapIpaddrEnable3, locMinRSLstr=locMinRSLstr, trapLocRslStat=trapLocRslStat, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, partNumber=partNumber, remUnavailDuration=remUnavailDuration, locMinRSL=locMinRSL, alarms=alarms, productsMIBNotifications=productsMIBNotifications, remMinRSL=remMinRSL, locEthPerfInterfaces=locEthPerfInterfaces, remLinkStateV=remLinkStateV, locErrorDurationStr=locErrorDurationStr, interfaceType=interfaceType, t1LineCode=t1LineCode, ntpServer4IpAddr=ntpServer4IpAddr, snmpConfig=snmpConfig, te1Status=te1Status, locErrorDuration=locErrorDuration, productsMIBGroups=productsMIBGroups, rfFreqBand=rfFreqBand, productsAllObjects=productsAllObjects, remLinkSecMismatch=remLinkSecMismatch, PwType=PwType, fileTransfer=fileTransfer, trapReboot=trapReboot, remTe1Alarms=remTe1Alarms, trapIpaddr4=trapIpaddr4, te1Interfaces=te1Interfaces, bootVersion=bootVersion, radioReboot=radioReboot, aesKey=aesKey, remSysAlarms=remSysAlarms, locMinimumRxModulation=locMinimumRxModulation, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locSampleDurationStr=locSampleDurationStr, locActiveTxModulation=locActiveTxModulation, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, trapLocAlarmStat=trapLocAlarmStat, factoryFwFilename=factoryFwFilename, t1LBO=t1LBO, remMaxRSLstr=remMaxRSLstr, trapv2cEnable=trapv2cEnable, trapLocRslThreshold=trapLocRslThreshold, locMaximumRxModulation=locMaximumRxModulation, commitSnmpSettings=commitSnmpSettings, systemConfig=systemConfig, licKey=licKey, commitTe1Settings=commitTe1Settings, trapAuth=trapAuth, locCurrentRSL=locCurrentRSL, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, remCurrentTempS=remCurrentTempS, te1=te1, locCurrentTemp=locCurrentTemp, remMinRSLtimestamp=remMinRSLtimestamp, remSampleDuration=remSampleDuration, uploadFilename=uploadFilename, remTe1LinkSummary=remTe1LinkSummary, locCurrentBER=locCurrentBER, locActiveRxModulation=locActiveRxModulation, locLinkSecMismatch=locLinkSecMismatch, defaultGateway=defaultGateway, interface=interface, locEthAlarms=locEthAlarms, ipRemote=ipRemote, trapIpaddrEnable1=trapIpaddrEnable1, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, productsMIBObjects=productsMIBObjects, remErrorDurationStr=remErrorDurationStr, alternateFwFilename=alternateFwFilename, ntpServer2IpAddr=ntpServer2IpAddr, radioConfig=radioConfig, aesEnable=aesEnable, locTe1AlarmsEntry=locTe1AlarmsEntry, productsMIBCompliances=productsMIBCompliances, sysDate=sysDate, PYSNMP_MODULE_ID=productsMIB, trapIpaddr2=trapIpaddr2, ntpServer1IpAddr=ntpServer1IpAddr, inboundEthernetThroughput=inboundEthernetThroughput, ntpClientEnable=ntpClientEnable, trapLocLinkStat=trapLocLinkStat, commitSystemSettings=commitSystemSettings, radioInfo=radioInfo, userPassword=userPassword, ipAddress=ipAddress, remCurrentBERstr=remCurrentBERstr, subnetMask=subnetMask, productsMIB=productsMIB, rxFreqRange=rxFreqRange, remSampleDurationStr=remSampleDurationStr, ntpTimeZoneSelect=ntpTimeZoneSelect, remTE1Alarms=remTE1Alarms, remCurrentTemp=remCurrentTemp, remTe1Alarm=remTe1Alarm, performance=performance, trapIpaddrEnable4=trapIpaddrEnable4, remTe1AlarmsEntry=remTe1AlarmsEntry, trapv3Enable=trapv3Enable, locEthUtilizationOut=locEthUtilizationOut, locCurrentTempS=locCurrentTempS, productsMIBConformance=productsMIBConformance, locMaxRSL=locMaxRSL, ipLocal=ipLocal, txFreqRange=txFreqRange, ntp=ntp, locTe1Alarm=locTe1Alarm, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locLinkStateV=locLinkStateV, locMinRSLtimestamp=locMinRSLtimestamp, transferStart=transferStart, remLinkStateH=remLinkStateH, locTe1Alarms=locTe1Alarms, hwId=hwId, locUnavailDurationStr=locUnavailDurationStr, locMaximumTxModulation=locMaximumTxModulation, te1AIS=te1AIS, trapv1Enable=trapv1Enable, remMinRSLstr=remMinRSLstr, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locEthUtilizationWatermark=locEthUtilizationWatermark, remCurrentBER=remCurrentBER, radioAdmin=radioAdmin, locLinkState=locLinkState, currentFwFilename=currentFwFilename, trapIpaddr1=trapIpaddr1)
