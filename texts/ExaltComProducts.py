...
Led4ColorT, EthAuxStatusT, AlarmLevelT, VlanStatusT, AuxNmsMode, AcmModulationT, ExaltEnableT, TimeZoneT, exaltcommunications, EthMainStatusT, Te1LboT, EnableStatusT, Te1LoopBackModeT, FileTransferTypeT, NtpClientEnableT, Te1LineCodeT, Te1StatusT, EthPortMode, VlanGroupT, FileTransferStartT = mibBuilder.importSymbols("ExaltComm", "Led4ColorT", "EthAuxStatusT", "AlarmLevelT", "VlanStatusT", "AuxNmsMode", "AcmModulationT", "ExaltEnableT", "TimeZoneT", "exaltcommunications", "EthMainStatusT", "Te1LboT", "EnableStatusT", "Te1LoopBackModeT", "FileTransferTypeT", "NtpClientEnableT", "Te1LineCodeT", "Te1StatusT", "EthPortMode", "VlanGroupT", "FileTransferStartT")
...
mibBuilder.exportSymbols("ExaltComProducts", te1NumChannels=te1NumChannels, remMaxRSLstr=remMaxRSLstr, transferStart=transferStart, remEthAlarms=remEthAlarms, locMaximumTxModulation=locMaximumTxModulation, locLinkState=locLinkState, fileManagement=fileManagement, tftpServerIp=tftpServerIp, hwId=hwId, interface=interface, locTe1Alarms=locTe1Alarms, remTe1LinkSummary=remTe1LinkSummary, locErrorDuration=locErrorDuration, locActiveRxModulation=locActiveRxModulation, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, trapIpaddrEnable4=trapIpaddrEnable4, remCurrentBER=remCurrentBER, firmwareVersion=firmwareVersion, radioName=radioName, ntpTimeZoneSelect=ntpTimeZoneSelect, trapReboot=trapReboot, swapFWimage=swapFWimage, remMinRSLstr=remMinRSLstr, locSampleDuration=locSampleDuration, locMinRSL=locMinRSL, remUnavailDurationStr=remUnavailDurationStr, trapIpaddr3=trapIpaddr3, locTe1AlarmsEntry=locTe1AlarmsEntry, radioReboot=radioReboot, alternateFwFilename=alternateFwFilename, productsAllObjects=productsAllObjects, locCurrentBERstr=locCurrentBERstr, locMaxRSL=locMaxRSL, t1LineCode=t1LineCode, radioAdmin=radioAdmin, locEthSpeed=locEthSpeed, inboundEthernetThroughput=inboundEthernetThroughput, trapv2cEnable=trapv2cEnable, remMaxRSL=remMaxRSL, te1LoopBackMode=te1LoopBackMode, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locMaximumRxModulation=locMaximumRxModulation, productsMIBGroups=productsMIBGroups, PYSNMP_MODULE_ID=productsMIB, outboundEthernetThroughput=outboundEthernetThroughput, te1Interfaces=te1Interfaces, remLinkSecMismatch=remLinkSecMismatch, remErrorDuration=remErrorDuration, trapLocAlarmStat=trapLocAlarmStat, ipAddressNetmask=ipAddressNetmask, snmpConfig=snmpConfig, ntpServer2IpAddr=ntpServer2IpAddr, locSampleDurationStr=locSampleDurationStr, locCurrentBER=locCurrentBER, ipAddress=ipAddress, locMinimumRxModulation=locMinimumRxModulation, locTe1Alarm=locTe1Alarm, selectT1orE1=selectT1orE1, locMinRSLtimestamp=locMinRSLtimestamp, alarms=alarms, almRemote=almRemote, locResetStats=locResetStats, remTE1Alarms=remTE1Alarms, ntpServer4IpAddr=ntpServer4IpAddr, te1AIS=te1AIS, locCurrentRSL=locCurrentRSL, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, ntp=ntp, trapIpaddrEnable1=trapIpaddrEnable1, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remUnavailDuration=remUnavailDuration, remSysAlarms=remSysAlarms, locEthAlarms=locEthAlarms, remMinRSLtimestamp=remMinRSLtimestamp, locEthPerfInterfaces=locEthPerfInterfaces, locUnavailDuration=locUnavailDuration, ntpServer3IpAddr=ntpServer3IpAddr, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, trapIpaddrEnable2=trapIpaddrEnable2, almLocal=almLocal, remCurrentBERstr=remCurrentBERstr, sysTime=sysTime, remCurrentTemp=remCurrentTemp, rdkDbVer=rdkDbVer, locCurrentRSLstr=locCurrentRSLstr, remTe1AlarmsEntry=remTe1AlarmsEntry, remTe1Alarm=remTe1Alarm, defaultGateway=defaultGateway, interfaceType=interfaceType, transferType=transferType, locTe1LinkSummary=locTe1LinkSummary, remTe1Alarms=remTe1Alarms, trapRemAlarmStat=trapRemAlarmStat, rfFreqBand=rfFreqBand, subnetMask=subnetMask, locMinRSLstr=locMinRSLstr, remSampleDuration=remSampleDuration, commitAdminSettings=commitAdminSettings, adminPassword=adminPassword, commitTe1Settings=commitTe1Settings, modelName=modelName, locMinimumTxModulation=locMinimumTxModulation, remSampleDurationStr=remSampleDurationStr, trapv3Enable=trapv3Enable, locEthUtilizationOut=locEthUtilizationOut, perfRemote=perfRemote, userThroughput=userThroughput, remCurrentRSLstr=remCurrentRSLstr, ntpClientEnable=ntpClientEnable, fileTransfer=fileTransfer, locEthUtilizationWatermark=locEthUtilizationWatermark, systemConfig=systemConfig, remResetStats=remResetStats, remLinkStateH=remLinkStateH, productsMIB=productsMIB, te1NumActiveChannels=te1NumActiveChannels, modelNumber=modelNumber, t1LBO=t1LBO, trapIpaddr1=trapIpaddr1, locTempAlarm=locTempAlarm, aggregateUserThroughput=aggregateUserThroughput, productsMIBNotifications=productsMIBNotifications, rxFreqRange=rxFreqRange, currentFwFilename=currentFwFilename, locEthUtilizationIn=locEthUtilizationIn, transferStatus=transferStatus, locCurrentTemp=locCurrentTemp, remLinkState=remLinkState, licenseFeatures=licenseFeatures, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remErrorDurationStr=remErrorDurationStr, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, trapAuth=trapAuth, sysDate=sysDate, PwType=PwType, locErrorDurationStr=locErrorDurationStr, productsMIBConformance=productsMIBConformance, productsMIBCompliances=productsMIBCompliances, ipLocal=ipLocal, serialNumber=serialNumber, partNumber=partNumber, ipRemote=ipRemote, trapIpaddr4=trapIpaddr4, radioConfig=radioConfig, trapLocLinkStat=trapLocLinkStat, locLinkSecMismatch=locLinkSecMismatch, te1=te1, userPassword=userPassword, uploadFilename=uploadFilename, trapv1Enable=trapv1Enable, radioInfo=radioInfo, locLinkStateV=locLinkStateV, locTE1Alarms=locTE1Alarms, linkName=linkName, radioMonitor=radioMonitor, locSysAlarms=locSysAlarms, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, trapIpaddrEnable3=trapIpaddrEnable3, locMaxRSLstr=locMaxRSLstr, remMinRSL=remMinRSL, aesKey=aesKey, bootVersion=bootVersion, rnLocal=rnLocal, remTempAlarm=remTempAlarm, locActiveTxModulation=locActiveTxModulation, te1Status=te1Status, remCurrentRSL=remCurrentRSL, txFreqRange=txFreqRange, remCurrentTempS=remCurrentTempS, aesEnable=aesEnable, commitSystemSettings=commitSystemSettings, locLinkStateH=locLinkStateH, remLinkStateV=remLinkStateV, trapLocTempStat=trapLocTempStat, commitSnmpSettings=commitSnmpSettings, licKey=licKey, locCurrentTempS=locCurrentTempS, te1Interface=te1Interface, trapLocRslStat=trapLocRslStat, perfLocal=perfLocal, trapIpaddr2=trapIpaddr2, performance=performance, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, factoryFwFilename=factoryFwFilename, rnRemote=rnRemote, ntpServer1IpAddr=ntpServer1IpAddr, trapLocRslThreshold=trapLocRslThreshold, productsMIBObjects=productsMIBObjects, linkSecKey=linkSecKey, commitNtpSettings=commitNtpSettings, locUnavailDurationStr=locUnavailDurationStr)
