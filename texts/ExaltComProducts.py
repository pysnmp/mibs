...
VlanGroupT, EthMainStatusT, NtpClientEnableT, AcmModulationT, Te1StatusT, Led4ColorT, TimeZoneT, Te1LoopBackModeT, EnableStatusT, Te1LineCodeT, FileTransferTypeT, EthPortMode, AuxNmsMode, AlarmLevelT, Te1LboT, exaltcommunications, FileTransferStartT, VlanStatusT, EthAuxStatusT, ExaltEnableT = mibBuilder.importSymbols("ExaltComm", "VlanGroupT", "EthMainStatusT", "NtpClientEnableT", "AcmModulationT", "Te1StatusT", "Led4ColorT", "TimeZoneT", "Te1LoopBackModeT", "EnableStatusT", "Te1LineCodeT", "FileTransferTypeT", "EthPortMode", "AuxNmsMode", "AlarmLevelT", "Te1LboT", "exaltcommunications", "FileTransferStartT", "VlanStatusT", "EthAuxStatusT", "ExaltEnableT")
...
mibBuilder.exportSymbols("ExaltComProducts", remMinRSLtimestamp=remMinRSLtimestamp, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locTe1Alarms=locTe1Alarms, locTe1Alarm=locTe1Alarm, locEthUtilizationIn=locEthUtilizationIn, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, trapIpaddr2=trapIpaddr2, locTe1AlarmsEntry=locTe1AlarmsEntry, trapIpaddr3=trapIpaddr3, remCurrentBERstr=remCurrentBERstr, outboundEthernetThroughput=outboundEthernetThroughput, bootVersion=bootVersion, ntpClientEnable=ntpClientEnable, uploadFilename=uploadFilename, remSampleDuration=remSampleDuration, transferStart=transferStart, radioAdmin=radioAdmin, remUnavailDurationStr=remUnavailDurationStr, locCurrentRSLstr=locCurrentRSLstr, rnLocal=rnLocal, locMaximumTxModulation=locMaximumTxModulation, transferType=transferType, almLocal=almLocal, remUnavailDuration=remUnavailDuration, commitAdminSettings=commitAdminSettings, locLinkSecMismatch=locLinkSecMismatch, remSampleDurationStr=remSampleDurationStr, productsMIBGroups=productsMIBGroups, modelNumber=modelNumber, locTE1Alarms=locTE1Alarms, aesEnable=aesEnable, locMaxRSL=locMaxRSL, locActiveTxModulation=locActiveTxModulation, trapAuth=trapAuth, inboundEthernetThroughput=inboundEthernetThroughput, ipAddress=ipAddress, perfRemote=perfRemote, trapLocTempStat=trapLocTempStat, radioConfig=radioConfig, productsMIBObjects=productsMIBObjects, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, ipRemote=ipRemote, trapv3Enable=trapv3Enable, te1NumActiveChannels=te1NumActiveChannels, remLinkSecMismatch=remLinkSecMismatch, factoryFwFilename=factoryFwFilename, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, rfFreqBand=rfFreqBand, snmpConfig=snmpConfig, locResetStats=locResetStats, userThroughput=userThroughput, remCurrentRSLstr=remCurrentRSLstr, remLinkStateV=remLinkStateV, locUnavailDurationStr=locUnavailDurationStr, aesKey=aesKey, remCurrentRSL=remCurrentRSL, rdkDbVer=rdkDbVer, commitTe1Settings=commitTe1Settings, locCurrentTempS=locCurrentTempS, trapIpaddr1=trapIpaddr1, radioMonitor=radioMonitor, locSampleDuration=locSampleDuration, linkSecKey=linkSecKey, ipLocal=ipLocal, firmwareVersion=firmwareVersion, remErrorDuration=remErrorDuration, performance=performance, locActiveRxModulation=locActiveRxModulation, remErrorDurationStr=remErrorDurationStr, licenseFeatures=licenseFeatures, te1Interface=te1Interface, locEthUtilizationWatermark=locEthUtilizationWatermark, trapLocRslStat=trapLocRslStat, ntpServer4IpAddr=ntpServer4IpAddr, locEthAlarms=locEthAlarms, modelName=modelName, interface=interface, remTe1Alarms=remTe1Alarms, locMaximumRxModulation=locMaximumRxModulation, productsMIBCompliances=productsMIBCompliances, trapv2cEnable=trapv2cEnable, locErrorDurationStr=locErrorDurationStr, radioReboot=radioReboot, locMinimumTxModulation=locMinimumTxModulation, trapRemAlarmStat=trapRemAlarmStat, tftpServerIp=tftpServerIp, currentFwFilename=currentFwFilename, locLinkStateV=locLinkStateV, locErrorDuration=locErrorDuration, locMinRSL=locMinRSL, te1Interfaces=te1Interfaces, remTe1AlarmsEntry=remTe1AlarmsEntry, subnetMask=subnetMask, txFreqRange=txFreqRange, sysTime=sysTime, remCurrentTemp=remCurrentTemp, trapLocRslThreshold=trapLocRslThreshold, interfaceType=interfaceType, locLinkStateH=locLinkStateH, selectT1orE1=selectT1orE1, te1NumChannels=te1NumChannels, locTempAlarm=locTempAlarm, rxFreqRange=rxFreqRange, ipAddressNetmask=ipAddressNetmask, remTE1Alarms=remTE1Alarms, sysDate=sysDate, locCurrentBER=locCurrentBER, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, t1LBO=t1LBO, remCurrentTempS=remCurrentTempS, perfLocal=perfLocal, productsAllObjects=productsAllObjects, remMaxRSLstr=remMaxRSLstr, swapFWimage=swapFWimage, remResetStats=remResetStats, locMinRSLstr=locMinRSLstr, PwType=PwType, remTe1LinkSummary=remTe1LinkSummary, locEthPerfInterfaces=locEthPerfInterfaces, locMaxRSLstr=locMaxRSLstr, locTe1LinkSummary=locTe1LinkSummary, alarms=alarms, radioInfo=radioInfo, te1AIS=te1AIS, transferStatus=transferStatus, productsMIBNotifications=productsMIBNotifications, userPassword=userPassword, trapIpaddrEnable3=trapIpaddrEnable3, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, commitSystemSettings=commitSystemSettings, remLinkState=remLinkState, fileManagement=fileManagement, locCurrentTemp=locCurrentTemp, fileTransfer=fileTransfer, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locCurrentBERstr=locCurrentBERstr, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, commitNtpSettings=commitNtpSettings, commitSnmpSettings=commitSnmpSettings, locUnavailDuration=locUnavailDuration, linkName=linkName, ntpServer2IpAddr=ntpServer2IpAddr, remMaxRSL=remMaxRSL, adminPassword=adminPassword, remTe1Alarm=remTe1Alarm, remMinRSL=remMinRSL, PYSNMP_MODULE_ID=productsMIB, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, licKey=licKey, trapv1Enable=trapv1Enable, trapIpaddrEnable2=trapIpaddrEnable2, trapReboot=trapReboot, trapLocAlarmStat=trapLocAlarmStat, defaultGateway=defaultGateway, remCurrentBER=remCurrentBER, te1=te1, trapIpaddrEnable1=trapIpaddrEnable1, remLinkStateH=remLinkStateH, aggregateUserThroughput=aggregateUserThroughput, locCurrentRSL=locCurrentRSL, locSysAlarms=locSysAlarms, serialNumber=serialNumber, alternateFwFilename=alternateFwFilename, remMinRSLstr=remMinRSLstr, productsMIB=productsMIB, trapIpaddrEnable4=trapIpaddrEnable4, t1LineCode=t1LineCode, locMinRSLtimestamp=locMinRSLtimestamp, productsMIBConformance=productsMIBConformance, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, ntpTimeZoneSelect=ntpTimeZoneSelect, remTempAlarm=remTempAlarm, systemConfig=systemConfig, locMinimumRxModulation=locMinimumRxModulation, locEthUtilizationOut=locEthUtilizationOut, trapLocLinkStat=trapLocLinkStat, rnRemote=rnRemote, trapIpaddr4=trapIpaddr4, ntpServer3IpAddr=ntpServer3IpAddr, te1Status=te1Status, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, ntpServer1IpAddr=ntpServer1IpAddr, remSysAlarms=remSysAlarms, locEthSpeed=locEthSpeed, hwId=hwId, te1LoopBackMode=te1LoopBackMode, almRemote=almRemote, locSampleDurationStr=locSampleDurationStr, radioName=radioName, partNumber=partNumber, remEthAlarms=remEthAlarms, locLinkState=locLinkState, ntp=ntp)
