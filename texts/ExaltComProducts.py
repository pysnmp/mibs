...
FileTransferTypeT, exaltcommunications, ExaltEnableT, NtpClientEnableT, EthMainStatusT, EnableStatusT, VlanGroupT, FileTransferStartT, Te1LboT, AcmModulationT, AlarmLevelT, Te1StatusT, Led4ColorT, Te1LoopBackModeT, EthAuxStatusT, TimeZoneT, Te1LineCodeT, EthPortMode, VlanStatusT, AuxNmsMode = mibBuilder.importSymbols("ExaltComm", "FileTransferTypeT", "exaltcommunications", "ExaltEnableT", "NtpClientEnableT", "EthMainStatusT", "EnableStatusT", "VlanGroupT", "FileTransferStartT", "Te1LboT", "AcmModulationT", "AlarmLevelT", "Te1StatusT", "Led4ColorT", "Te1LoopBackModeT", "EthAuxStatusT", "TimeZoneT", "Te1LineCodeT", "EthPortMode", "VlanStatusT", "AuxNmsMode")
...
mibBuilder.exportSymbols("ExaltComProducts", remSysAlarms=remSysAlarms, remMinRSLstr=remMinRSLstr, trapLocAlarmStat=trapLocAlarmStat, fileManagement=fileManagement, locTe1AlarmsEntry=locTe1AlarmsEntry, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, ntpServer3IpAddr=ntpServer3IpAddr, remLinkStateH=remLinkStateH, rdkDbVer=rdkDbVer, locTe1LinkSummary=locTe1LinkSummary, productsMIBCompliances=productsMIBCompliances, remTE1Alarms=remTE1Alarms, systemConfig=systemConfig, remMinRSL=remMinRSL, locEthUtilizationOut=locEthUtilizationOut, locResetStats=locResetStats, locErrorDurationStr=locErrorDurationStr, locSampleDuration=locSampleDuration, rnLocal=rnLocal, bootVersion=bootVersion, performance=performance, remMinRSLtimestamp=remMinRSLtimestamp, interface=interface, rfFreqBand=rfFreqBand, ntpClientEnable=ntpClientEnable, locTempAlarm=locTempAlarm, remLinkState=remLinkState, locMaximumTxModulation=locMaximumTxModulation, trapIpaddr2=trapIpaddr2, locLinkStateV=locLinkStateV, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, commitSnmpSettings=commitSnmpSettings, ntp=ntp, remResetStats=remResetStats, licenseFeatures=licenseFeatures, aesEnable=aesEnable, locMinRSLtimestamp=locMinRSLtimestamp, remErrorDuration=remErrorDuration, locLinkSecMismatch=locLinkSecMismatch, ntpServer2IpAddr=ntpServer2IpAddr, commitTe1Settings=commitTe1Settings, tftpServerIp=tftpServerIp, locCurrentTemp=locCurrentTemp, radioAdmin=radioAdmin, rxFreqRange=rxFreqRange, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locEthUtilizationWatermark=locEthUtilizationWatermark, uploadFilename=uploadFilename, locTe1Alarm=locTe1Alarm, remTempAlarm=remTempAlarm, te1NumChannels=te1NumChannels, hwId=hwId, alternateFwFilename=alternateFwFilename, trapIpaddr4=trapIpaddr4, productsMIB=productsMIB, selectT1orE1=selectT1orE1, snmpConfig=snmpConfig, alarms=alarms, remCurrentRSL=remCurrentRSL, locMaximumRxModulation=locMaximumRxModulation, perfLocal=perfLocal, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locSysAlarms=locSysAlarms, aggregateUserThroughput=aggregateUserThroughput, interfaceType=interfaceType, remLinkStateV=remLinkStateV, ntpTimeZoneSelect=ntpTimeZoneSelect, userPassword=userPassword, remTe1LinkSummary=remTe1LinkSummary, modelNumber=modelNumber, te1AIS=te1AIS, aesKey=aesKey, trapLocRslThreshold=trapLocRslThreshold, transferStart=transferStart, locTE1Alarms=locTE1Alarms, remTe1Alarm=remTe1Alarm, remUnavailDuration=remUnavailDuration, linkSecKey=linkSecKey, locTe1Alarms=locTe1Alarms, remTe1AlarmsEntry=remTe1AlarmsEntry, radioInfo=radioInfo, productsMIBObjects=productsMIBObjects, transferType=transferType, remCurrentBER=remCurrentBER, remCurrentRSLstr=remCurrentRSLstr, productsMIBGroups=productsMIBGroups, trapv3Enable=trapv3Enable, serialNumber=serialNumber, commitSystemSettings=commitSystemSettings, ntpServer1IpAddr=ntpServer1IpAddr, locMinRSL=locMinRSL, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locErrorDuration=locErrorDuration, licKey=licKey, ipLocal=ipLocal, modelName=modelName, almRemote=almRemote, remCurrentTempS=remCurrentTempS, remCurrentBERstr=remCurrentBERstr, locCurrentBER=locCurrentBER, commitNtpSettings=commitNtpSettings, trapv2cEnable=trapv2cEnable, locCurrentTempS=locCurrentTempS, locMaxRSLstr=locMaxRSLstr, locEthAlarms=locEthAlarms, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, outboundEthernetThroughput=outboundEthernetThroughput, ipAddressNetmask=ipAddressNetmask, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remMaxRSLstr=remMaxRSLstr, remSampleDuration=remSampleDuration, firmwareVersion=firmwareVersion, radioMonitor=radioMonitor, radioReboot=radioReboot, currentFwFilename=currentFwFilename, swapFWimage=swapFWimage, productsMIBNotifications=productsMIBNotifications, trapLocTempStat=trapLocTempStat, te1Status=te1Status, locMinimumRxModulation=locMinimumRxModulation, fileTransfer=fileTransfer, locEthUtilizationIn=locEthUtilizationIn, perfRemote=perfRemote, locActiveTxModulation=locActiveTxModulation, trapIpaddrEnable4=trapIpaddrEnable4, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, radioName=radioName, locActiveRxModulation=locActiveRxModulation, remMaxRSL=remMaxRSL, locEthSpeed=locEthSpeed, inboundEthernetThroughput=inboundEthernetThroughput, locMinRSLstr=locMinRSLstr, remTe1Alarms=remTe1Alarms, ntpServer4IpAddr=ntpServer4IpAddr, trapAuth=trapAuth, locSampleDurationStr=locSampleDurationStr, trapIpaddr3=trapIpaddr3, remUnavailDurationStr=remUnavailDurationStr, remErrorDurationStr=remErrorDurationStr, te1NumActiveChannels=te1NumActiveChannels, locUnavailDuration=locUnavailDuration, radioConfig=radioConfig, productsMIBConformance=productsMIBConformance, remEthAlarms=remEthAlarms, remSampleDurationStr=remSampleDurationStr, trapv1Enable=trapv1Enable, sysTime=sysTime, trapIpaddrEnable3=trapIpaddrEnable3, trapLocLinkStat=trapLocLinkStat, locMaxRSL=locMaxRSL, commitAdminSettings=commitAdminSettings, trapIpaddr1=trapIpaddr1, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, trapReboot=trapReboot, te1=te1, te1Interfaces=te1Interfaces, ipAddress=ipAddress, transferStatus=transferStatus, subnetMask=subnetMask, locCurrentRSLstr=locCurrentRSLstr, t1LBO=t1LBO, trapIpaddrEnable2=trapIpaddrEnable2, txFreqRange=txFreqRange, remCurrentTemp=remCurrentTemp, sysDate=sysDate, te1LoopBackMode=te1LoopBackMode, linkName=linkName, te1Interface=te1Interface, locMinimumTxModulation=locMinimumTxModulation, userThroughput=userThroughput, trapIpaddrEnable1=trapIpaddrEnable1, defaultGateway=defaultGateway, productsAllObjects=productsAllObjects, rnRemote=rnRemote, remLinkSecMismatch=remLinkSecMismatch, factoryFwFilename=factoryFwFilename, PYSNMP_MODULE_ID=productsMIB, PwType=PwType, almLocal=almLocal, locLinkState=locLinkState, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, t1LineCode=t1LineCode, ipRemote=ipRemote, locLinkStateH=locLinkStateH, trapRemAlarmStat=trapRemAlarmStat, locCurrentRSL=locCurrentRSL, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, trapLocRslStat=trapLocRslStat, locUnavailDurationStr=locUnavailDurationStr, adminPassword=adminPassword, locEthPerfInterfaces=locEthPerfInterfaces, locCurrentBERstr=locCurrentBERstr, partNumber=partNumber)
