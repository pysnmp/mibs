...
AcmModulationT, Te1LineCodeT, VlanStatusT, VlanGroupT, Te1LboT, exaltcommunications, EthPortMode, TimeZoneT, FileTransferStartT, EnableStatusT, FileTransferTypeT, EthAuxStatusT, AlarmLevelT, NtpClientEnableT, Te1StatusT, Led4ColorT, ExaltEnableT, EthMainStatusT, AuxNmsMode, Te1LoopBackModeT = mibBuilder.importSymbols("ExaltComm", "AcmModulationT", "Te1LineCodeT", "VlanStatusT", "VlanGroupT", "Te1LboT", "exaltcommunications", "EthPortMode", "TimeZoneT", "FileTransferStartT", "EnableStatusT", "FileTransferTypeT", "EthAuxStatusT", "AlarmLevelT", "NtpClientEnableT", "Te1StatusT", "Led4ColorT", "ExaltEnableT", "EthMainStatusT", "AuxNmsMode", "Te1LoopBackModeT")
...
mibBuilder.exportSymbols("ExaltComProducts", locTempAlarm=locTempAlarm, te1Interface=te1Interface, partNumber=partNumber, interfaceType=interfaceType, currentFwFilename=currentFwFilename, alternateFwFilename=alternateFwFilename, interface=interface, remSampleDuration=remSampleDuration, commitSystemSettings=commitSystemSettings, te1LoopBackMode=te1LoopBackMode, te1AIS=te1AIS, locMinRSLstr=locMinRSLstr, locMinRSLtimestamp=locMinRSLtimestamp, radioInfo=radioInfo, locUnavailDurationStr=locUnavailDurationStr, locActiveRxModulation=locActiveRxModulation, trapIpaddrEnable3=trapIpaddrEnable3, subnetMask=subnetMask, txFreqRange=txFreqRange, sysTime=sysTime, locErrorDuration=locErrorDuration, locTe1Alarms=locTe1Alarms, locEthPerfInterfaces=locEthPerfInterfaces, ntpClientEnable=ntpClientEnable, remCurrentRSLstr=remCurrentRSLstr, defaultGateway=defaultGateway, outboundEthernetThroughput=outboundEthernetThroughput, remResetStats=remResetStats, hwId=hwId, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, linkSecKey=linkSecKey, te1Interfaces=te1Interfaces, uploadFilename=uploadFilename, productsMIBObjects=productsMIBObjects, fileTransfer=fileTransfer, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, productsAllObjects=productsAllObjects, sysDate=sysDate, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locCurrentRSLstr=locCurrentRSLstr, radioConfig=radioConfig, swapFWimage=swapFWimage, locLinkStateH=locLinkStateH, remEthAlarms=remEthAlarms, trapLocLinkStat=trapLocLinkStat, remUnavailDuration=remUnavailDuration, locEthSpeed=locEthSpeed, factoryFwFilename=factoryFwFilename, locTe1AlarmsEntry=locTe1AlarmsEntry, remLinkStateV=remLinkStateV, trapv1Enable=trapv1Enable, rxFreqRange=rxFreqRange, productsMIBNotifications=productsMIBNotifications, ipRemote=ipRemote, te1NumActiveChannels=te1NumActiveChannels, remMinRSLtimestamp=remMinRSLtimestamp, trapv3Enable=trapv3Enable, licKey=licKey, aesKey=aesKey, locEthUtilizationOut=locEthUtilizationOut, te1=te1, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, remMaxRSL=remMaxRSL, locSampleDuration=locSampleDuration, trapLocTempStat=trapLocTempStat, productsMIBConformance=productsMIBConformance, trapIpaddr3=trapIpaddr3, locTe1LinkSummary=locTe1LinkSummary, trapLocRslThreshold=trapLocRslThreshold, performance=performance, radioAdmin=radioAdmin, locMaximumTxModulation=locMaximumTxModulation, trapIpaddr2=trapIpaddr2, locResetStats=locResetStats, transferType=transferType, remMaxRSLstr=remMaxRSLstr, locActiveTxModulation=locActiveTxModulation, t1LBO=t1LBO, locMaxRSLstr=locMaxRSLstr, remErrorDuration=remErrorDuration, almLocal=almLocal, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, radioName=radioName, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, trapIpaddrEnable1=trapIpaddrEnable1, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, remLinkSecMismatch=remLinkSecMismatch, serialNumber=serialNumber, locSampleDurationStr=locSampleDurationStr, trapv2cEnable=trapv2cEnable, remTE1Alarms=remTE1Alarms, remErrorDurationStr=remErrorDurationStr, te1Status=te1Status, modelName=modelName, modelNumber=modelNumber, commitSnmpSettings=commitSnmpSettings, locCurrentBERstr=locCurrentBERstr, locCurrentBER=locCurrentBER, commitTe1Settings=commitTe1Settings, PwType=PwType, almRemote=almRemote, trapLocRslStat=trapLocRslStat, remTe1Alarm=remTe1Alarm, aesEnable=aesEnable, trapIpaddrEnable2=trapIpaddrEnable2, transferStatus=transferStatus, userPassword=userPassword, remTe1LinkSummary=remTe1LinkSummary, tftpServerIp=tftpServerIp, radioReboot=radioReboot, systemConfig=systemConfig, locTe1Alarm=locTe1Alarm, fileManagement=fileManagement, snmpConfig=snmpConfig, locMinimumTxModulation=locMinimumTxModulation, trapRemAlarmStat=trapRemAlarmStat, commitNtpSettings=commitNtpSettings, ntpServer3IpAddr=ntpServer3IpAddr, locCurrentRSL=locCurrentRSL, adminPassword=adminPassword, locMinimumRxModulation=locMinimumRxModulation, perfLocal=perfLocal, locTE1Alarms=locTE1Alarms, remSysAlarms=remSysAlarms, trapIpaddr1=trapIpaddr1, selectT1orE1=selectT1orE1, ntpTimeZoneSelect=ntpTimeZoneSelect, locCurrentTemp=locCurrentTemp, remCurrentTemp=remCurrentTemp, ntpServer2IpAddr=ntpServer2IpAddr, te1NumChannels=te1NumChannels, remMinRSL=remMinRSL, remCurrentTempS=remCurrentTempS, rfFreqBand=rfFreqBand, alarms=alarms, inboundEthernetThroughput=inboundEthernetThroughput, rnLocal=rnLocal, locUnavailDuration=locUnavailDuration, radioMonitor=radioMonitor, ipLocal=ipLocal, commitAdminSettings=commitAdminSettings, aggregateUserThroughput=aggregateUserThroughput, locErrorDurationStr=locErrorDurationStr, remTe1AlarmsEntry=remTe1AlarmsEntry, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, firmwareVersion=firmwareVersion, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, trapLocAlarmStat=trapLocAlarmStat, locLinkState=locLinkState, productsMIBGroups=productsMIBGroups, bootVersion=bootVersion, rnRemote=rnRemote, rdkDbVer=rdkDbVer, licenseFeatures=licenseFeatures, remCurrentBERstr=remCurrentBERstr, trapReboot=trapReboot, transferStart=transferStart, locSysAlarms=locSysAlarms, locMaxRSL=locMaxRSL, productsMIB=productsMIB, locMinRSL=locMinRSL, remLinkState=remLinkState, trapIpaddrEnable4=trapIpaddrEnable4, linkName=linkName, ipAddress=ipAddress, ntpServer1IpAddr=ntpServer1IpAddr, locLinkSecMismatch=locLinkSecMismatch, locEthUtilizationIn=locEthUtilizationIn, remCurrentRSL=remCurrentRSL, productsMIBCompliances=productsMIBCompliances, PYSNMP_MODULE_ID=productsMIB, remTempAlarm=remTempAlarm, remCurrentBER=remCurrentBER, remUnavailDurationStr=remUnavailDurationStr, userThroughput=userThroughput, locLinkStateV=locLinkStateV, ntp=ntp, locMaximumRxModulation=locMaximumRxModulation, locCurrentTempS=locCurrentTempS, t1LineCode=t1LineCode, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, perfRemote=perfRemote, remMinRSLstr=remMinRSLstr, remSampleDurationStr=remSampleDurationStr, remTe1Alarms=remTe1Alarms, ipAddressNetmask=ipAddressNetmask, locEthAlarms=locEthAlarms, trapIpaddr4=trapIpaddr4, remLinkStateH=remLinkStateH, locEthUtilizationWatermark=locEthUtilizationWatermark, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, trapAuth=trapAuth, ntpServer4IpAddr=ntpServer4IpAddr)
