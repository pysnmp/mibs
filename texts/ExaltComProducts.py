...
EnableStatusT, AcmModulationT, EthMainStatusT, FileTransferStartT, Te1LoopBackModeT, VlanStatusT, AlarmLevelT, EthAuxStatusT, VlanGroupT, Led4ColorT, NtpClientEnableT, Te1LineCodeT, Te1StatusT, EthPortMode, AuxNmsMode, FileTransferTypeT, ExaltEnableT, TimeZoneT, Te1LboT, exaltcommunications = mibBuilder.importSymbols("ExaltComm", "EnableStatusT", "AcmModulationT", "EthMainStatusT", "FileTransferStartT", "Te1LoopBackModeT", "VlanStatusT", "AlarmLevelT", "EthAuxStatusT", "VlanGroupT", "Led4ColorT", "NtpClientEnableT", "Te1LineCodeT", "Te1StatusT", "EthPortMode", "AuxNmsMode", "FileTransferTypeT", "ExaltEnableT", "TimeZoneT", "Te1LboT", "exaltcommunications")
...
mibBuilder.exportSymbols("ExaltComProducts", t1LineCode=t1LineCode, interfaceType=interfaceType, remUnavailDuration=remUnavailDuration, firmwareVersion=firmwareVersion, trapv1Enable=trapv1Enable, transferStart=transferStart, userThroughput=userThroughput, alternateFwFilename=alternateFwFilename, trapRemAlarmStat=trapRemAlarmStat, ntp=ntp, currentFwFilename=currentFwFilename, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, tftpServerIp=tftpServerIp, aesKey=aesKey, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, perfRemote=perfRemote, linkName=linkName, snmpConfig=snmpConfig, PwType=PwType, userPassword=userPassword, locSysAlarms=locSysAlarms, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remUnavailDurationStr=remUnavailDurationStr, remTe1LinkSummary=remTe1LinkSummary, locMinRSLstr=locMinRSLstr, remLinkStateV=remLinkStateV, locEthUtilizationOut=locEthUtilizationOut, rxFreqRange=rxFreqRange, licKey=licKey, productsMIB=productsMIB, ntpServer1IpAddr=ntpServer1IpAddr, trapIpaddr4=trapIpaddr4, serialNumber=serialNumber, ipRemote=ipRemote, commitTe1Settings=commitTe1Settings, outboundEthernetThroughput=outboundEthernetThroughput, te1Interfaces=te1Interfaces, trapReboot=trapReboot, remEthAlarms=remEthAlarms, locLinkStateV=locLinkStateV, rdkDbVer=rdkDbVer, remErrorDurationStr=remErrorDurationStr, ipAddress=ipAddress, commitSystemSettings=commitSystemSettings, bootVersion=bootVersion, te1LoopBackMode=te1LoopBackMode, locTempAlarm=locTempAlarm, almRemote=almRemote, locTe1Alarm=locTe1Alarm, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remSampleDurationStr=remSampleDurationStr, commitAdminSettings=commitAdminSettings, t1LBO=t1LBO, remCurrentRSL=remCurrentRSL, transferType=transferType, remTe1Alarms=remTe1Alarms, locMinimumTxModulation=locMinimumTxModulation, rnLocal=rnLocal, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, ntpClientEnable=ntpClientEnable, locMinimumRxModulation=locMinimumRxModulation, locEthUtilizationIn=locEthUtilizationIn, locSampleDuration=locSampleDuration, locErrorDurationStr=locErrorDurationStr, sysDate=sysDate, locEthPerfInterfaces=locEthPerfInterfaces, perfLocal=perfLocal, adminPassword=adminPassword, remMinRSLtimestamp=remMinRSLtimestamp, aesEnable=aesEnable, radioAdmin=radioAdmin, locLinkSecMismatch=locLinkSecMismatch, alarms=alarms, trapAuth=trapAuth, ntpServer4IpAddr=ntpServer4IpAddr, modelNumber=modelNumber, locMaxRSLstr=locMaxRSLstr, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, remSysAlarms=remSysAlarms, remTe1AlarmsEntry=remTe1AlarmsEntry, transferStatus=transferStatus, trapLocRslThreshold=trapLocRslThreshold, remTempAlarm=remTempAlarm, remTE1Alarms=remTE1Alarms, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remLinkStateH=remLinkStateH, PYSNMP_MODULE_ID=productsMIB, ipAddressNetmask=ipAddressNetmask, commitSnmpSettings=commitSnmpSettings, te1AIS=te1AIS, remMinRSLstr=remMinRSLstr, ntpTimeZoneSelect=ntpTimeZoneSelect, productsAllObjects=productsAllObjects, hwId=hwId, locActiveRxModulation=locActiveRxModulation, remErrorDuration=remErrorDuration, sysTime=sysTime, remCurrentTemp=remCurrentTemp, te1=te1, swapFWimage=swapFWimage, ntpServer2IpAddr=ntpServer2IpAddr, defaultGateway=defaultGateway, remCurrentBERstr=remCurrentBERstr, remTe1Alarm=remTe1Alarm, locUnavailDurationStr=locUnavailDurationStr, productsMIBGroups=productsMIBGroups, locResetStats=locResetStats, fileTransfer=fileTransfer, te1Interface=te1Interface, remResetStats=remResetStats, remSampleDuration=remSampleDuration, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, interface=interface, locTe1LinkSummary=locTe1LinkSummary, trapv3Enable=trapv3Enable, locUnavailDuration=locUnavailDuration, locCurrentRSL=locCurrentRSL, trapIpaddrEnable1=trapIpaddrEnable1, ipLocal=ipLocal, almLocal=almLocal, systemConfig=systemConfig, remCurrentTempS=remCurrentTempS, locLinkStateH=locLinkStateH, locEthUtilizationWatermark=locEthUtilizationWatermark, ntpServer3IpAddr=ntpServer3IpAddr, trapLocLinkStat=trapLocLinkStat, locTe1AlarmsEntry=locTe1AlarmsEntry, locTe1Alarms=locTe1Alarms, locCurrentTemp=locCurrentTemp, radioConfig=radioConfig, locCurrentRSLstr=locCurrentRSLstr, inboundEthernetThroughput=inboundEthernetThroughput, trapIpaddrEnable2=trapIpaddrEnable2, trapIpaddr1=trapIpaddr1, remCurrentRSLstr=remCurrentRSLstr, selectT1orE1=selectT1orE1, trapv2cEnable=trapv2cEnable, performance=performance, partNumber=partNumber, commitNtpSettings=commitNtpSettings, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, trapLocTempStat=trapLocTempStat, factoryFwFilename=factoryFwFilename, rfFreqBand=rfFreqBand, fileManagement=fileManagement, te1NumActiveChannels=te1NumActiveChannels, locCurrentBER=locCurrentBER, trapLocRslStat=trapLocRslStat, productsMIBObjects=productsMIBObjects, subnetMask=subnetMask, productsMIBNotifications=productsMIBNotifications, trapIpaddr2=trapIpaddr2, linkSecKey=linkSecKey, locTE1Alarms=locTE1Alarms, uploadFilename=uploadFilename, locSampleDurationStr=locSampleDurationStr, locEthSpeed=locEthSpeed, txFreqRange=txFreqRange, locCurrentBERstr=locCurrentBERstr, locMaxRSL=locMaxRSL, radioReboot=radioReboot, remLinkState=remLinkState, radioMonitor=radioMonitor, locMaximumRxModulation=locMaximumRxModulation, locCurrentTempS=locCurrentTempS, trapIpaddr3=trapIpaddr3, remCurrentBER=remCurrentBER, locMinRSLtimestamp=locMinRSLtimestamp, radioInfo=radioInfo, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, licenseFeatures=licenseFeatures, locErrorDuration=locErrorDuration, productsMIBConformance=productsMIBConformance, locActiveTxModulation=locActiveTxModulation, trapIpaddrEnable3=trapIpaddrEnable3, remLinkSecMismatch=remLinkSecMismatch, remMinRSL=remMinRSL, trapIpaddrEnable4=trapIpaddrEnable4, rnRemote=rnRemote, locEthAlarms=locEthAlarms, locLinkState=locLinkState, productsMIBCompliances=productsMIBCompliances, te1NumChannels=te1NumChannels, remMaxRSLstr=remMaxRSLstr, te1Status=te1Status, remMaxRSL=remMaxRSL, modelName=modelName, aggregateUserThroughput=aggregateUserThroughput, locMaximumTxModulation=locMaximumTxModulation, radioName=radioName, locMinRSL=locMinRSL, trapLocAlarmStat=trapLocAlarmStat)
