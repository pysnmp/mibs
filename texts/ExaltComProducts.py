...
AuxNmsMode, Te1StatusT, exaltcommunications, ExaltEnableT, EnableStatusT, Te1LboT, EthPortMode, AlarmLevelT, VlanGroupT, Te1LoopBackModeT, AcmModulationT, VlanStatusT, Te1LineCodeT, FileTransferTypeT, FileTransferStartT, Led4ColorT, NtpClientEnableT, EthAuxStatusT, TimeZoneT, EthMainStatusT = mibBuilder.importSymbols("ExaltComm", "AuxNmsMode", "Te1StatusT", "exaltcommunications", "ExaltEnableT", "EnableStatusT", "Te1LboT", "EthPortMode", "AlarmLevelT", "VlanGroupT", "Te1LoopBackModeT", "AcmModulationT", "VlanStatusT", "Te1LineCodeT", "FileTransferTypeT", "FileTransferStartT", "Led4ColorT", "NtpClientEnableT", "EthAuxStatusT", "TimeZoneT", "EthMainStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", defaultGateway=defaultGateway, transferStart=transferStart, userThroughput=userThroughput, perfLocal=perfLocal, locCurrentBERstr=locCurrentBERstr, te1Interfaces=te1Interfaces, almLocal=almLocal, remCurrentRSL=remCurrentRSL, commitNtpSettings=commitNtpSettings, radioInfo=radioInfo, remEthAlarms=remEthAlarms, remUnavailDuration=remUnavailDuration, locTE1Alarms=locTE1Alarms, locUnavailDurationStr=locUnavailDurationStr, remCurrentRSLstr=remCurrentRSLstr, ipLocal=ipLocal, trapIpaddr1=trapIpaddr1, ntpServer1IpAddr=ntpServer1IpAddr, linkSecKey=linkSecKey, trapIpaddrEnable4=trapIpaddrEnable4, ntpServer4IpAddr=ntpServer4IpAddr, locMinimumTxModulation=locMinimumTxModulation, trapLocRslStat=trapLocRslStat, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, productsMIBGroups=productsMIBGroups, snmpConfig=snmpConfig, t1LBO=t1LBO, trapRemAlarmStat=trapRemAlarmStat, performance=performance, aesEnable=aesEnable, sysTime=sysTime, interface=interface, locMinRSL=locMinRSL, sysDate=sysDate, modelName=modelName, perfRemote=perfRemote, locCurrentRSL=locCurrentRSL, selectT1orE1=selectT1orE1, locErrorDurationStr=locErrorDurationStr, serialNumber=serialNumber, swapFWimage=swapFWimage, remMinRSLstr=remMinRSLstr, commitTe1Settings=commitTe1Settings, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, userPassword=userPassword, remLinkSecMismatch=remLinkSecMismatch, remCurrentTemp=remCurrentTemp, licenseFeatures=licenseFeatures, trapv2cEnable=trapv2cEnable, remSysAlarms=remSysAlarms, trapIpaddrEnable3=trapIpaddrEnable3, locActiveTxModulation=locActiveTxModulation, remLinkStateV=remLinkStateV, locMinimumRxModulation=locMinimumRxModulation, ntp=ntp, locUnavailDuration=locUnavailDuration, locLinkSecMismatch=locLinkSecMismatch, trapAuth=trapAuth, radioReboot=radioReboot, locMaximumRxModulation=locMaximumRxModulation, rdkDbVer=rdkDbVer, bootVersion=bootVersion, rnLocal=rnLocal, ntpServer3IpAddr=ntpServer3IpAddr, locCurrentTemp=locCurrentTemp, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, trapv3Enable=trapv3Enable, te1LoopBackMode=te1LoopBackMode, remErrorDurationStr=remErrorDurationStr, locEthUtilizationOut=locEthUtilizationOut, trapIpaddr4=trapIpaddr4, locCurrentRSLstr=locCurrentRSLstr, locMaxRSL=locMaxRSL, remResetStats=remResetStats, systemConfig=systemConfig, productsMIBObjects=productsMIBObjects, locResetStats=locResetStats, remSampleDurationStr=remSampleDurationStr, ntpClientEnable=ntpClientEnable, locTe1AlarmsEntry=locTe1AlarmsEntry, trapLocRslThreshold=trapLocRslThreshold, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, te1AIS=te1AIS, t1LineCode=t1LineCode, remLinkStateH=remLinkStateH, rnRemote=rnRemote, trapv1Enable=trapv1Enable, locCurrentTempS=locCurrentTempS, remUnavailDurationStr=remUnavailDurationStr, te1NumChannels=te1NumChannels, locEthUtilizationIn=locEthUtilizationIn, alarms=alarms, linkName=linkName, remTE1Alarms=remTE1Alarms, rxFreqRange=rxFreqRange, locLinkStateH=locLinkStateH, ntpTimeZoneSelect=ntpTimeZoneSelect, locLinkStateV=locLinkStateV, trapLocAlarmStat=trapLocAlarmStat, remMinRSL=remMinRSL, locLinkState=locLinkState, locSysAlarms=locSysAlarms, factoryFwFilename=factoryFwFilename, locMinRSLstr=locMinRSLstr, trapReboot=trapReboot, locErrorDuration=locErrorDuration, remMinRSLtimestamp=remMinRSLtimestamp, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, te1Status=te1Status, remTe1Alarm=remTe1Alarm, locActiveRxModulation=locActiveRxModulation, trapIpaddr2=trapIpaddr2, trapLocTempStat=trapLocTempStat, remTe1AlarmsEntry=remTe1AlarmsEntry, te1Interface=te1Interface, aesKey=aesKey, uploadFilename=uploadFilename, remCurrentTempS=remCurrentTempS, locTe1Alarm=locTe1Alarm, inboundEthernetThroughput=inboundEthernetThroughput, firmwareVersion=firmwareVersion, locSampleDurationStr=locSampleDurationStr, PYSNMP_MODULE_ID=productsMIB, productsMIBNotifications=productsMIBNotifications, modelNumber=modelNumber, productsMIBConformance=productsMIBConformance, locTe1Alarms=locTe1Alarms, radioMonitor=radioMonitor, rfFreqBand=rfFreqBand, remCurrentBERstr=remCurrentBERstr, partNumber=partNumber, ipAddress=ipAddress, alternateFwFilename=alternateFwFilename, locTe1LinkSummary=locTe1LinkSummary, almRemote=almRemote, locCurrentBER=locCurrentBER, productsAllObjects=productsAllObjects, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, locEthSpeed=locEthSpeed, hwId=hwId, productsMIB=productsMIB, interfaceType=interfaceType, subnetMask=subnetMask, fileTransfer=fileTransfer, remLinkState=remLinkState, txFreqRange=txFreqRange, locTempAlarm=locTempAlarm, adminPassword=adminPassword, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, trapIpaddr3=trapIpaddr3, te1NumActiveChannels=te1NumActiveChannels, remErrorDuration=remErrorDuration, remTe1Alarms=remTe1Alarms, locEthPerfInterfaces=locEthPerfInterfaces, licKey=licKey, remMaxRSL=remMaxRSL, ipRemote=ipRemote, currentFwFilename=currentFwFilename, commitAdminSettings=commitAdminSettings, transferStatus=transferStatus, commitSnmpSettings=commitSnmpSettings, locMaximumTxModulation=locMaximumTxModulation, radioName=radioName, locEthAlarms=locEthAlarms, radioAdmin=radioAdmin, trapLocLinkStat=trapLocLinkStat, tftpServerIp=tftpServerIp, fileManagement=fileManagement, locMinRSLtimestamp=locMinRSLtimestamp, locMaxRSLstr=locMaxRSLstr, ipAddressNetmask=ipAddressNetmask, remTempAlarm=remTempAlarm, remTe1LinkSummary=remTe1LinkSummary, ntpServer2IpAddr=ntpServer2IpAddr, trapIpaddrEnable1=trapIpaddrEnable1, remCurrentBER=remCurrentBER, remMaxRSLstr=remMaxRSLstr, remSampleDuration=remSampleDuration, trapIpaddrEnable2=trapIpaddrEnable2, commitSystemSettings=commitSystemSettings, PwType=PwType, transferType=transferType, outboundEthernetThroughput=outboundEthernetThroughput, te1=te1, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, productsMIBCompliances=productsMIBCompliances, radioConfig=radioConfig, locSampleDuration=locSampleDuration, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, aggregateUserThroughput=aggregateUserThroughput, locEthUtilizationWatermark=locEthUtilizationWatermark)
