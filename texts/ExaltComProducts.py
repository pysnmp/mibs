...
EthMainStatusT, exaltcommunications, AcmModulationT, EthAuxStatusT, ExaltEnableT, NtpClientEnableT, AlarmLevelT, FileTransferStartT, Te1LoopBackModeT, Te1LineCodeT, FileTransferTypeT, Te1LboT, Te1StatusT, VlanStatusT, TimeZoneT, EnableStatusT, Led4ColorT, AuxNmsMode, EthPortMode, VlanGroupT = mibBuilder.importSymbols("ExaltComm", "EthMainStatusT", "exaltcommunications", "AcmModulationT", "EthAuxStatusT", "ExaltEnableT", "NtpClientEnableT", "AlarmLevelT", "FileTransferStartT", "Te1LoopBackModeT", "Te1LineCodeT", "FileTransferTypeT", "Te1LboT", "Te1StatusT", "VlanStatusT", "TimeZoneT", "EnableStatusT", "Led4ColorT", "AuxNmsMode", "EthPortMode", "VlanGroupT")
...
mibBuilder.exportSymbols("ExaltComProducts", remMinRSLstr=remMinRSLstr, alternateFwFilename=alternateFwFilename, commitSnmpSettings=commitSnmpSettings, rnRemote=rnRemote, trapIpaddrEnable1=trapIpaddrEnable1, trapIpaddr3=trapIpaddr3, trapLocTempStat=trapLocTempStat, locLinkStateH=locLinkStateH, sysDate=sysDate, locTe1Alarm=locTe1Alarm, radioInfo=radioInfo, radioAdmin=radioAdmin, trapLocLinkStat=trapLocLinkStat, transferStart=transferStart, aesEnable=aesEnable, locTe1Alarms=locTe1Alarms, productsMIBNotifications=productsMIBNotifications, locTE1Alarms=locTE1Alarms, remCurrentTemp=remCurrentTemp, remErrorDuration=remErrorDuration, remUnavailDurationStr=remUnavailDurationStr, almLocal=almLocal, perfLocal=perfLocal, rfFreqBand=rfFreqBand, te1NumChannels=te1NumChannels, fileManagement=fileManagement, remUnavailDuration=remUnavailDuration, trapIpaddr4=trapIpaddr4, remLinkState=remLinkState, swapFWimage=swapFWimage, remMaxRSLstr=remMaxRSLstr, te1Interfaces=te1Interfaces, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, ntpTimeZoneSelect=ntpTimeZoneSelect, locCurrentRSL=locCurrentRSL, remSampleDurationStr=remSampleDurationStr, alarms=alarms, locCurrentTempS=locCurrentTempS, currentFwFilename=currentFwFilename, radioConfig=radioConfig, productsMIBGroups=productsMIBGroups, commitTe1Settings=commitTe1Settings, locUnavailDuration=locUnavailDuration, trapIpaddr1=trapIpaddr1, trapLocAlarmStat=trapLocAlarmStat, commitNtpSettings=commitNtpSettings, te1Interface=te1Interface, factoryFwFilename=factoryFwFilename, trapReboot=trapReboot, trapIpaddrEnable3=trapIpaddrEnable3, remTe1Alarms=remTe1Alarms, aggregateUserThroughput=aggregateUserThroughput, PwType=PwType, trapAuth=trapAuth, remTempAlarm=remTempAlarm, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, txFreqRange=txFreqRange, fileTransfer=fileTransfer, userPassword=userPassword, productsAllObjects=productsAllObjects, ntp=ntp, tftpServerIp=tftpServerIp, locUnavailDurationStr=locUnavailDurationStr, modelName=modelName, subnetMask=subnetMask, defaultGateway=defaultGateway, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locMaximumTxModulation=locMaximumTxModulation, linkName=linkName, locSampleDurationStr=locSampleDurationStr, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locTe1LinkSummary=locTe1LinkSummary, locMaxRSLstr=locMaxRSLstr, ipLocal=ipLocal, locLinkStateV=locLinkStateV, ntpServer3IpAddr=ntpServer3IpAddr, productsMIBObjects=productsMIBObjects, locErrorDuration=locErrorDuration, userThroughput=userThroughput, radioMonitor=radioMonitor, locLinkSecMismatch=locLinkSecMismatch, radioName=radioName, remMinRSLtimestamp=remMinRSLtimestamp, almRemote=almRemote, licenseFeatures=licenseFeatures, remEthAlarms=remEthAlarms, locMinRSLtimestamp=locMinRSLtimestamp, te1NumActiveChannels=te1NumActiveChannels, trapIpaddr2=trapIpaddr2, productsMIB=productsMIB, interface=interface, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, locTe1AlarmsEntry=locTe1AlarmsEntry, te1Status=te1Status, locMinimumRxModulation=locMinimumRxModulation, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, remCurrentRSLstr=remCurrentRSLstr, locActiveTxModulation=locActiveTxModulation, commitSystemSettings=commitSystemSettings, remMaxRSL=remMaxRSL, remTe1LinkSummary=remTe1LinkSummary, adminPassword=adminPassword, licKey=licKey, trapLocRslStat=trapLocRslStat, ntpClientEnable=ntpClientEnable, locMinRSL=locMinRSL, locMinRSLstr=locMinRSLstr, remLinkStateH=remLinkStateH, linkSecKey=linkSecKey, productsMIBCompliances=productsMIBCompliances, partNumber=partNumber, ipAddress=ipAddress, locTempAlarm=locTempAlarm, locLinkState=locLinkState, locEthUtilizationOut=locEthUtilizationOut, trapIpaddrEnable4=trapIpaddrEnable4, locSampleDuration=locSampleDuration, hwId=hwId, remTe1Alarm=remTe1Alarm, remCurrentTempS=remCurrentTempS, commitAdminSettings=commitAdminSettings, perfRemote=perfRemote, ipRemote=ipRemote, remMinRSL=remMinRSL, remSysAlarms=remSysAlarms, remLinkSecMismatch=remLinkSecMismatch, remSampleDuration=remSampleDuration, locMaxRSL=locMaxRSL, trapLocRslThreshold=trapLocRslThreshold, locCurrentTemp=locCurrentTemp, remCurrentBERstr=remCurrentBERstr, selectT1orE1=selectT1orE1, ntpServer1IpAddr=ntpServer1IpAddr, t1LBO=t1LBO, locCurrentBERstr=locCurrentBERstr, productsMIBConformance=productsMIBConformance, bootVersion=bootVersion, locMaximumRxModulation=locMaximumRxModulation, performance=performance, t1LineCode=t1LineCode, locEthSpeed=locEthSpeed, ipAddressNetmask=ipAddressNetmask, rdkDbVer=rdkDbVer, outboundEthernetThroughput=outboundEthernetThroughput, locEthUtilizationIn=locEthUtilizationIn, serialNumber=serialNumber, remCurrentBER=remCurrentBER, remLinkStateV=remLinkStateV, locCurrentRSLstr=locCurrentRSLstr, locEthPerfInterfaces=locEthPerfInterfaces, locMinimumTxModulation=locMinimumTxModulation, ntpServer4IpAddr=ntpServer4IpAddr, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, remCurrentRSL=remCurrentRSL, radioReboot=radioReboot, te1=te1, remTe1AlarmsEntry=remTe1AlarmsEntry, locCurrentBER=locCurrentBER, locResetStats=locResetStats, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, sysTime=sysTime, trapIpaddrEnable2=trapIpaddrEnable2, remResetStats=remResetStats, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locActiveRxModulation=locActiveRxModulation, modelNumber=modelNumber, ntpServer2IpAddr=ntpServer2IpAddr, locEthUtilizationWatermark=locEthUtilizationWatermark, rxFreqRange=rxFreqRange, trapv3Enable=trapv3Enable, transferStatus=transferStatus, trapRemAlarmStat=trapRemAlarmStat, rnLocal=rnLocal, trapv1Enable=trapv1Enable, inboundEthernetThroughput=inboundEthernetThroughput, remTE1Alarms=remTE1Alarms, locEthAlarms=locEthAlarms, aesKey=aesKey, systemConfig=systemConfig, locSysAlarms=locSysAlarms, PYSNMP_MODULE_ID=productsMIB, remErrorDurationStr=remErrorDurationStr, te1AIS=te1AIS, uploadFilename=uploadFilename, firmwareVersion=firmwareVersion, trapv2cEnable=trapv2cEnable, interfaceType=interfaceType, snmpConfig=snmpConfig, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, locErrorDurationStr=locErrorDurationStr, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, te1LoopBackMode=te1LoopBackMode, transferType=transferType)
