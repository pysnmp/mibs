...
Led4ColorT, Te1StatusT, EthMainStatusT, Te1LineCodeT, ExaltEnableT, AcmModulationT, VlanStatusT, VlanGroupT, Te1LboT, AuxNmsMode, AlarmLevelT, EthPortMode, TimeZoneT, Te1LoopBackModeT, EnableStatusT, NtpClientEnableT, EthAuxStatusT, FileTransferStartT, exaltcommunications, FileTransferTypeT = mibBuilder.importSymbols("ExaltComm", "Led4ColorT", "Te1StatusT", "EthMainStatusT", "Te1LineCodeT", "ExaltEnableT", "AcmModulationT", "VlanStatusT", "VlanGroupT", "Te1LboT", "AuxNmsMode", "AlarmLevelT", "EthPortMode", "TimeZoneT", "Te1LoopBackModeT", "EnableStatusT", "NtpClientEnableT", "EthAuxStatusT", "FileTransferStartT", "exaltcommunications", "FileTransferTypeT")
...
mibBuilder.exportSymbols("ExaltComProducts", te1LoopBackMode=te1LoopBackMode, trapIpaddr1=trapIpaddr1, remMaxRSLstr=remMaxRSLstr, ntp=ntp, firmwareVersion=firmwareVersion, remSysAlarms=remSysAlarms, remTe1AlarmsEntry=remTe1AlarmsEntry, performance=performance, t1LBO=t1LBO, currentFwFilename=currentFwFilename, radioConfig=radioConfig, trapIpaddrEnable3=trapIpaddrEnable3, te1Status=te1Status, locMinimumRxModulation=locMinimumRxModulation, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remCurrentRSLstr=remCurrentRSLstr, outboundEthernetThroughput=outboundEthernetThroughput, aesKey=aesKey, bootVersion=bootVersion, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, licKey=licKey, locMaxRSLstr=locMaxRSLstr, aggregateUserThroughput=aggregateUserThroughput, te1NumActiveChannels=te1NumActiveChannels, trapIpaddrEnable4=trapIpaddrEnable4, locLinkState=locLinkState, remLinkState=remLinkState, factoryFwFilename=factoryFwFilename, selectT1orE1=selectT1orE1, locEthUtilizationIn=locEthUtilizationIn, trapv1Enable=trapv1Enable, trapLocRslStat=trapLocRslStat, locMinRSLstr=locMinRSLstr, t1LineCode=t1LineCode, locTE1Alarms=locTE1Alarms, tftpServerIp=tftpServerIp, ntpServer1IpAddr=ntpServer1IpAddr, interfaceType=interfaceType, productsMIBGroups=productsMIBGroups, subnetMask=subnetMask, remErrorDurationStr=remErrorDurationStr, trapReboot=trapReboot, locMaximumTxModulation=locMaximumTxModulation, locCurrentTemp=locCurrentTemp, locErrorDurationStr=locErrorDurationStr, PwType=PwType, remCurrentBER=remCurrentBER, locErrorDuration=locErrorDuration, fileManagement=fileManagement, commitNtpSettings=commitNtpSettings, remMinRSLstr=remMinRSLstr, trapLocTempStat=trapLocTempStat, productsMIBConformance=productsMIBConformance, locActiveRxModulation=locActiveRxModulation, locMaxRSL=locMaxRSL, remCurrentBERstr=remCurrentBERstr, remErrorDuration=remErrorDuration, locTe1AlarmsEntry=locTe1AlarmsEntry, perfLocal=perfLocal, radioName=radioName, userPassword=userPassword, remUnavailDuration=remUnavailDuration, radioReboot=radioReboot, locCurrentRSL=locCurrentRSL, rnRemote=rnRemote, locLinkStateV=locLinkStateV, locMinRSL=locMinRSL, locMaximumRxModulation=locMaximumRxModulation, locEthUtilizationOut=locEthUtilizationOut, ipLocal=ipLocal, remResetStats=remResetStats, sysDate=sysDate, partNumber=partNumber, locUnavailDuration=locUnavailDuration, userThroughput=userThroughput, productsMIBCompliances=productsMIBCompliances, locEthPerfInterfaces=locEthPerfInterfaces, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locCurrentRSLstr=locCurrentRSLstr, swapFWimage=swapFWimage, productsAllObjects=productsAllObjects, trapIpaddrEnable2=trapIpaddrEnable2, modelNumber=modelNumber, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, almLocal=almLocal, ntpClientEnable=ntpClientEnable, remSampleDurationStr=remSampleDurationStr, locLinkSecMismatch=locLinkSecMismatch, productsMIBObjects=productsMIBObjects, remTe1Alarm=remTe1Alarm, trapAuth=trapAuth, snmpConfig=snmpConfig, transferType=transferType, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, systemConfig=systemConfig, sysTime=sysTime, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, linkName=linkName, te1Interface=te1Interface, trapv3Enable=trapv3Enable, locEthAlarms=locEthAlarms, adminPassword=adminPassword, radioInfo=radioInfo, ipAddress=ipAddress, trapIpaddr3=trapIpaddr3, ntpServer3IpAddr=ntpServer3IpAddr, commitSnmpSettings=commitSnmpSettings, serialNumber=serialNumber, commitAdminSettings=commitAdminSettings, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, remLinkSecMismatch=remLinkSecMismatch, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, PYSNMP_MODULE_ID=productsMIB, modelName=modelName, locTempAlarm=locTempAlarm, remCurrentTemp=remCurrentTemp, remUnavailDurationStr=remUnavailDurationStr, remTe1Alarms=remTe1Alarms, remCurrentTempS=remCurrentTempS, ntpTimeZoneSelect=ntpTimeZoneSelect, remTE1Alarms=remTE1Alarms, te1=te1, trapLocLinkStat=trapLocLinkStat, remTe1LinkSummary=remTe1LinkSummary, rfFreqBand=rfFreqBand, trapLocAlarmStat=trapLocAlarmStat, locSampleDuration=locSampleDuration, remLinkStateV=remLinkStateV, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, trapIpaddrEnable1=trapIpaddrEnable1, radioAdmin=radioAdmin, trapv2cEnable=trapv2cEnable, remMaxRSL=remMaxRSL, commitTe1Settings=commitTe1Settings, ntpServer2IpAddr=ntpServer2IpAddr, aesEnable=aesEnable, te1AIS=te1AIS, locResetStats=locResetStats, locEthSpeed=locEthSpeed, trapIpaddr2=trapIpaddr2, locCurrentBERstr=locCurrentBERstr, defaultGateway=defaultGateway, locTe1LinkSummary=locTe1LinkSummary, linkSecKey=linkSecKey, perfRemote=perfRemote, productsMIBNotifications=productsMIBNotifications, fileTransfer=fileTransfer, alternateFwFilename=alternateFwFilename, te1NumChannels=te1NumChannels, remEthAlarms=remEthAlarms, remMinRSL=remMinRSL, trapLocRslThreshold=trapLocRslThreshold, trapRemAlarmStat=trapRemAlarmStat, radioMonitor=radioMonitor, remSampleDuration=remSampleDuration, te1Interfaces=te1Interfaces, locCurrentTempS=locCurrentTempS, almRemote=almRemote, ntpServer4IpAddr=ntpServer4IpAddr, locMinRSLtimestamp=locMinRSLtimestamp, locCurrentBER=locCurrentBER, transferStatus=transferStatus, licenseFeatures=licenseFeatures, locLinkStateH=locLinkStateH, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, commitSystemSettings=commitSystemSettings, hwId=hwId, locSampleDurationStr=locSampleDurationStr, rnLocal=rnLocal, alarms=alarms, remTempAlarm=remTempAlarm, txFreqRange=txFreqRange, remLinkStateH=remLinkStateH, locUnavailDurationStr=locUnavailDurationStr, remMinRSLtimestamp=remMinRSLtimestamp, inboundEthernetThroughput=inboundEthernetThroughput, locTe1Alarm=locTe1Alarm, ipRemote=ipRemote, locSysAlarms=locSysAlarms, remCurrentRSL=remCurrentRSL, interface=interface, productsMIB=productsMIB, locTe1Alarms=locTe1Alarms, trapIpaddr4=trapIpaddr4, locActiveTxModulation=locActiveTxModulation, uploadFilename=uploadFilename, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, locMinimumTxModulation=locMinimumTxModulation, rxFreqRange=rxFreqRange, rdkDbVer=rdkDbVer, locEthUtilizationWatermark=locEthUtilizationWatermark, transferStart=transferStart, ipAddressNetmask=ipAddressNetmask)
