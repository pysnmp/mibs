...
VlanStatusT, Te1LboT, VlanGroupT, NtpClientEnableT, AlarmLevelT, Led4ColorT, AuxNmsMode, TimeZoneT, Te1LoopBackModeT, EthMainStatusT, EthPortMode, AcmModulationT, FileTransferTypeT, Te1StatusT, ExaltEnableT, Te1LineCodeT, EthAuxStatusT, exaltcommunications, EnableStatusT, FileTransferStartT = mibBuilder.importSymbols("ExaltComm", "VlanStatusT", "Te1LboT", "VlanGroupT", "NtpClientEnableT", "AlarmLevelT", "Led4ColorT", "AuxNmsMode", "TimeZoneT", "Te1LoopBackModeT", "EthMainStatusT", "EthPortMode", "AcmModulationT", "FileTransferTypeT", "Te1StatusT", "ExaltEnableT", "Te1LineCodeT", "EthAuxStatusT", "exaltcommunications", "EnableStatusT", "FileTransferStartT")
...
mibBuilder.exportSymbols("ExaltComProducts", locLinkStateH=locLinkStateH, locResetStats=locResetStats, te1Status=te1Status, subnetMask=subnetMask, remCurrentTempS=remCurrentTempS, licenseFeatures=licenseFeatures, rnLocal=rnLocal, transferStart=transferStart, locCurrentRSL=locCurrentRSL, fileManagement=fileManagement, radioAdmin=radioAdmin, remCurrentBERstr=remCurrentBERstr, radioMonitor=radioMonitor, trapLocRslThreshold=trapLocRslThreshold, PwType=PwType, ipLocal=ipLocal, trapIpaddr3=trapIpaddr3, performance=performance, productsAllObjects=productsAllObjects, remCurrentRSLstr=remCurrentRSLstr, remResetStats=remResetStats, remCurrentBER=remCurrentBER, locTempAlarm=locTempAlarm, radioReboot=radioReboot, locTe1LinkSummary=locTe1LinkSummary, remTempAlarm=remTempAlarm, productsMIBCompliances=productsMIBCompliances, radioName=radioName, trapLocTempStat=trapLocTempStat, radioInfo=radioInfo, alarms=alarms, locLinkStateV=locLinkStateV, remLinkSecMismatch=remLinkSecMismatch, locActiveTxModulation=locActiveTxModulation, almLocal=almLocal, trapIpaddr2=trapIpaddr2, te1NumChannels=te1NumChannels, ntpServer2IpAddr=ntpServer2IpAddr, remMinRSLstr=remMinRSLstr, modelNumber=modelNumber, ntp=ntp, aesEnable=aesEnable, rdkDbVer=rdkDbVer, te1AIS=te1AIS, locLinkState=locLinkState, commitTe1Settings=commitTe1Settings, remSampleDurationStr=remSampleDurationStr, ipRemote=ipRemote, productsMIBConformance=productsMIBConformance, ntpServer4IpAddr=ntpServer4IpAddr, swapFWimage=swapFWimage, remMinRSLtimestamp=remMinRSLtimestamp, locCurrentBER=locCurrentBER, locUnavailDuration=locUnavailDuration, remErrorDuration=remErrorDuration, locSysAlarms=locSysAlarms, interfaceType=interfaceType, locErrorDurationStr=locErrorDurationStr, locMaxRSL=locMaxRSL, ntpClientEnable=ntpClientEnable, trapv3Enable=trapv3Enable, productsMIBNotifications=productsMIBNotifications, remUnavailDurationStr=remUnavailDurationStr, factoryFwFilename=factoryFwFilename, locSampleDuration=locSampleDuration, t1LineCode=t1LineCode, locMinimumTxModulation=locMinimumTxModulation, bootVersion=bootVersion, selectT1orE1=selectT1orE1, alternateFwFilename=alternateFwFilename, trapv2cEnable=trapv2cEnable, productsMIBObjects=productsMIBObjects, rnRemote=rnRemote, remTe1AlarmsEntry=remTe1AlarmsEntry, perfRemote=perfRemote, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, trapRemAlarmStat=trapRemAlarmStat, remErrorDurationStr=remErrorDurationStr, txFreqRange=txFreqRange, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, uploadFilename=uploadFilename, trapIpaddrEnable1=trapIpaddrEnable1, trapv1Enable=trapv1Enable, remSampleDuration=remSampleDuration, locTE1Alarms=locTE1Alarms, trapIpaddr1=trapIpaddr1, locActiveRxModulation=locActiveRxModulation, radioConfig=radioConfig, defaultGateway=defaultGateway, remEthAlarms=remEthAlarms, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, ipAddress=ipAddress, locEthSpeed=locEthSpeed, locTe1Alarms=locTe1Alarms, te1Interface=te1Interface, ntpServer1IpAddr=ntpServer1IpAddr, remTE1Alarms=remTE1Alarms, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, remCurrentRSL=remCurrentRSL, te1LoopBackMode=te1LoopBackMode, perfLocal=perfLocal, interface=interface, partNumber=partNumber, t1LBO=t1LBO, locCurrentTemp=locCurrentTemp, locMaximumTxModulation=locMaximumTxModulation, remTe1LinkSummary=remTe1LinkSummary, te1=te1, locMinRSLstr=locMinRSLstr, locTe1AlarmsEntry=locTe1AlarmsEntry, currentFwFilename=currentFwFilename, locCurrentBERstr=locCurrentBERstr, locEthUtilizationOut=locEthUtilizationOut, userThroughput=userThroughput, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, aggregateUserThroughput=aggregateUserThroughput, locUnavailDurationStr=locUnavailDurationStr, trapAuth=trapAuth, remMinRSL=remMinRSL, trapLocRslStat=trapLocRslStat, locMinRSLtimestamp=locMinRSLtimestamp, remTe1Alarm=remTe1Alarm, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, locEthUtilizationWatermark=locEthUtilizationWatermark, adminPassword=adminPassword, linkSecKey=linkSecKey, locSampleDurationStr=locSampleDurationStr, locEthPerfInterfaces=locEthPerfInterfaces, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, ntpTimeZoneSelect=ntpTimeZoneSelect, serialNumber=serialNumber, locCurrentRSLstr=locCurrentRSLstr, tftpServerIp=tftpServerIp, remLinkState=remLinkState, locMinRSL=locMinRSL, trapIpaddrEnable3=trapIpaddrEnable3, locMaximumRxModulation=locMaximumRxModulation, te1Interfaces=te1Interfaces, productsMIBGroups=productsMIBGroups, commitSnmpSettings=commitSnmpSettings, locTe1Alarm=locTe1Alarm, trapIpaddrEnable2=trapIpaddrEnable2, fileTransfer=fileTransfer, remMaxRSLstr=remMaxRSLstr, trapIpaddrEnable4=trapIpaddrEnable4, PYSNMP_MODULE_ID=productsMIB, inboundEthernetThroughput=inboundEthernetThroughput, transferStatus=transferStatus, firmwareVersion=firmwareVersion, almRemote=almRemote, sysDate=sysDate, ipAddressNetmask=ipAddressNetmask, snmpConfig=snmpConfig, trapIpaddr4=trapIpaddr4, rxFreqRange=rxFreqRange, licKey=licKey, commitNtpSettings=commitNtpSettings, remLinkStateH=remLinkStateH, transferType=transferType, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, remUnavailDuration=remUnavailDuration, locMaxRSLstr=locMaxRSLstr, linkName=linkName, locMinimumRxModulation=locMinimumRxModulation, outboundEthernetThroughput=outboundEthernetThroughput, sysTime=sysTime, locCurrentTempS=locCurrentTempS, locLinkSecMismatch=locLinkSecMismatch, remTe1Alarms=remTe1Alarms, trapLocLinkStat=trapLocLinkStat, remSysAlarms=remSysAlarms, commitSystemSettings=commitSystemSettings, ntpServer3IpAddr=ntpServer3IpAddr, productsMIB=productsMIB, systemConfig=systemConfig, te1NumActiveChannels=te1NumActiveChannels, remLinkStateV=remLinkStateV, trapReboot=trapReboot, aesKey=aesKey, rfFreqBand=rfFreqBand, locErrorDuration=locErrorDuration, trapLocAlarmStat=trapLocAlarmStat, locEthUtilizationIn=locEthUtilizationIn, modelName=modelName, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, hwId=hwId, locEthAlarms=locEthAlarms, remMaxRSL=remMaxRSL, commitAdminSettings=commitAdminSettings, remCurrentTemp=remCurrentTemp, userPassword=userPassword)
