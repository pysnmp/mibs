...
FileTransferStartT, TimeZoneT, Te1LboT, EthPortMode, Te1LineCodeT, NtpClientEnableT, ExaltEnableT, EnableStatusT, AlarmLevelT, EthAuxStatusT, Te1LoopBackModeT, exaltcommunications, VlanStatusT, VlanGroupT, FileTransferTypeT, AuxNmsMode, EthMainStatusT, Led4ColorT, Te1StatusT, AcmModulationT = mibBuilder.importSymbols("ExaltComm", "FileTransferStartT", "TimeZoneT", "Te1LboT", "EthPortMode", "Te1LineCodeT", "NtpClientEnableT", "ExaltEnableT", "EnableStatusT", "AlarmLevelT", "EthAuxStatusT", "Te1LoopBackModeT", "exaltcommunications", "VlanStatusT", "VlanGroupT", "FileTransferTypeT", "AuxNmsMode", "EthMainStatusT", "Led4ColorT", "Te1StatusT", "AcmModulationT")
...
mibBuilder.exportSymbols("ExaltComProducts", outboundEthernetThroughput=outboundEthernetThroughput, locTe1Alarms=locTe1Alarms, locResetStats=locResetStats, PwType=PwType, remErrorDuration=remErrorDuration, fileTransfer=fileTransfer, commitNtpSettings=commitNtpSettings, locCurrentTemp=locCurrentTemp, productsAllObjects=productsAllObjects, remCurrentBER=remCurrentBER, ntpClientEnable=ntpClientEnable, txFreqRange=txFreqRange, locEthSpeed=locEthSpeed, ntp=ntp, remUnavailDurationStr=remUnavailDurationStr, te1Status=te1Status, remTe1Alarm=remTe1Alarm, te1LoopBackMode=te1LoopBackMode, remCurrentTempS=remCurrentTempS, remMaxRSL=remMaxRSL, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, almLocal=almLocal, locErrorDurationStr=locErrorDurationStr, locUnavailDuration=locUnavailDuration, modelName=modelName, alarms=alarms, trapLocRslStat=trapLocRslStat, trapv1Enable=trapv1Enable, trapIpaddrEnable2=trapIpaddrEnable2, t1LBO=t1LBO, remResetStats=remResetStats, bootVersion=bootVersion, productsMIB=productsMIB, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, t1LineCode=t1LineCode, locMinimumTxModulation=locMinimumTxModulation, rnRemote=rnRemote, locTempAlarm=locTempAlarm, ntpTimeZoneSelect=ntpTimeZoneSelect, productsMIBCompliances=productsMIBCompliances, locEthAlarms=locEthAlarms, locMinRSLstr=locMinRSLstr, sysDate=sysDate, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, ntpServer2IpAddr=ntpServer2IpAddr, trapIpaddrEnable1=trapIpaddrEnable1, remMinRSLstr=remMinRSLstr, remCurrentRSL=remCurrentRSL, rdkDbVer=rdkDbVer, locMinRSL=locMinRSL, productsMIBObjects=productsMIBObjects, interfaceType=interfaceType, locMaximumTxModulation=locMaximumTxModulation, ntpServer4IpAddr=ntpServer4IpAddr, PYSNMP_MODULE_ID=productsMIB, trapv2cEnable=trapv2cEnable, productsMIBNotifications=productsMIBNotifications, sysTime=sysTime, locTe1LinkSummary=locTe1LinkSummary, locLinkSecMismatch=locLinkSecMismatch, radioAdmin=radioAdmin, remLinkStateV=remLinkStateV, remTempAlarm=remTempAlarm, locActiveRxModulation=locActiveRxModulation, tftpServerIp=tftpServerIp, trapIpaddrEnable3=trapIpaddrEnable3, swapFWimage=swapFWimage, remTe1Alarms=remTe1Alarms, productsMIBConformance=productsMIBConformance, locTe1Alarm=locTe1Alarm, remLinkSecMismatch=remLinkSecMismatch, selectT1orE1=selectT1orE1, perfRemote=perfRemote, trapIpaddrEnable4=trapIpaddrEnable4, locMaxRSLstr=locMaxRSLstr, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, linkSecKey=linkSecKey, radioConfig=radioConfig, locSysAlarms=locSysAlarms, locEthUtilizationWatermark=locEthUtilizationWatermark, aesKey=aesKey, factoryFwFilename=factoryFwFilename, locTE1Alarms=locTE1Alarms, remLinkStateH=remLinkStateH, rxFreqRange=rxFreqRange, te1AIS=te1AIS, alternateFwFilename=alternateFwFilename, remMinRSL=remMinRSL, inboundEthernetThroughput=inboundEthernetThroughput, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, locCurrentRSLstr=locCurrentRSLstr, radioReboot=radioReboot, te1Interfaces=te1Interfaces, aesEnable=aesEnable, serialNumber=serialNumber, remCurrentBERstr=remCurrentBERstr, trapRemAlarmStat=trapRemAlarmStat, transferStart=transferStart, locUnavailDurationStr=locUnavailDurationStr, licenseFeatures=licenseFeatures, subnetMask=subnetMask, remErrorDurationStr=remErrorDurationStr, trapReboot=trapReboot, remTe1AlarmsEntry=remTe1AlarmsEntry, trapIpaddr4=trapIpaddr4, te1NumActiveChannels=te1NumActiveChannels, locSampleDuration=locSampleDuration, trapv3Enable=trapv3Enable, trapIpaddr1=trapIpaddr1, locEthUtilizationIn=locEthUtilizationIn, te1Interface=te1Interface, partNumber=partNumber, almRemote=almRemote, locErrorDuration=locErrorDuration, linkName=linkName, remTE1Alarms=remTE1Alarms, userPassword=userPassword, trapLocTempStat=trapLocTempStat, locCurrentTempS=locCurrentTempS, radioName=radioName, adminPassword=adminPassword, userThroughput=userThroughput, currentFwFilename=currentFwFilename, transferType=transferType, locCurrentRSL=locCurrentRSL, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, systemConfig=systemConfig, perfLocal=perfLocal, productsMIBGroups=productsMIBGroups, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, uploadFilename=uploadFilename, remEthAlarms=remEthAlarms, rfFreqBand=rfFreqBand, te1=te1, firmwareVersion=firmwareVersion, locLinkStateV=locLinkStateV, snmpConfig=snmpConfig, remSysAlarms=remSysAlarms, locMinRSLtimestamp=locMinRSLtimestamp, defaultGateway=defaultGateway, trapIpaddr2=trapIpaddr2, remMinRSLtimestamp=remMinRSLtimestamp, performance=performance, trapLocLinkStat=trapLocLinkStat, trapIpaddr3=trapIpaddr3, modelNumber=modelNumber, ntpServer1IpAddr=ntpServer1IpAddr, ntpServer3IpAddr=ntpServer3IpAddr, te1NumChannels=te1NumChannels, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, aggregateUserThroughput=aggregateUserThroughput, locMinimumRxModulation=locMinimumRxModulation, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, transferStatus=transferStatus, interface=interface, ipLocal=ipLocal, hwId=hwId, ipAddressNetmask=ipAddressNetmask, remSampleDurationStr=remSampleDurationStr, commitSnmpSettings=commitSnmpSettings, commitTe1Settings=commitTe1Settings, fileManagement=fileManagement, ipRemote=ipRemote, locCurrentBERstr=locCurrentBERstr, radioInfo=radioInfo, locSampleDurationStr=locSampleDurationStr, trapLocRslThreshold=trapLocRslThreshold, remCurrentTemp=remCurrentTemp, remSampleDuration=remSampleDuration, locEthUtilizationOut=locEthUtilizationOut, locTe1AlarmsEntry=locTe1AlarmsEntry, locMaximumRxModulation=locMaximumRxModulation, remUnavailDuration=remUnavailDuration, trapLocAlarmStat=trapLocAlarmStat, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, rnLocal=rnLocal, locCurrentBER=locCurrentBER, locLinkState=locLinkState, ipAddress=ipAddress, remLinkState=remLinkState, commitAdminSettings=commitAdminSettings, remTe1LinkSummary=remTe1LinkSummary, licKey=licKey, locEthPerfInterfaces=locEthPerfInterfaces, commitSystemSettings=commitSystemSettings, remCurrentRSLstr=remCurrentRSLstr, radioMonitor=radioMonitor, locLinkStateH=locLinkStateH, locMaxRSL=locMaxRSL, locActiveTxModulation=locActiveTxModulation, remMaxRSLstr=remMaxRSLstr, trapAuth=trapAuth)
