...
Te1LoopBackModeT, VlanStatusT, FileTransferStartT, EthPortMode, VlanGroupT, FileTransferTypeT, TimeZoneT, EthMainStatusT, exaltcommunications, AlarmLevelT, AcmModulationT, Te1LineCodeT, NtpClientEnableT, EnableStatusT, ExaltEnableT, AuxNmsMode, Te1LboT, Te1StatusT, Led4ColorT, EthAuxStatusT = mibBuilder.importSymbols("ExaltComm", "Te1LoopBackModeT", "VlanStatusT", "FileTransferStartT", "EthPortMode", "VlanGroupT", "FileTransferTypeT", "TimeZoneT", "EthMainStatusT", "exaltcommunications", "AlarmLevelT", "AcmModulationT", "Te1LineCodeT", "NtpClientEnableT", "EnableStatusT", "ExaltEnableT", "AuxNmsMode", "Te1LboT", "Te1StatusT", "Led4ColorT", "EthAuxStatusT")
...
mibBuilder.exportSymbols("ExaltComProducts", locMinRSL=locMinRSL, remMinRSLstr=remMinRSLstr, remLinkSecMismatch=remLinkSecMismatch, remErrorDuration=remErrorDuration, remCurrentBERstr=remCurrentBERstr, remTempAlarm=remTempAlarm, locTe1Alarm=locTe1Alarm, productsMIBGroups=productsMIBGroups, trapIpaddrEnable3=trapIpaddrEnable3, aesEnable=aesEnable, locUnavailDurationStr=locUnavailDurationStr, remCurrentRSL=remCurrentRSL, trapAuth=trapAuth, remLinkStateV=remLinkStateV, locMinimumRxModulation=locMinimumRxModulation, remErrorDurationStr=remErrorDurationStr, alternateFwFilename=alternateFwFilename, locEthAlarms=locEthAlarms, factoryFwFilename=factoryFwFilename, locMaximumTxModulation=locMaximumTxModulation, radioMonitor=radioMonitor, userPassword=userPassword, trapLocTempStat=trapLocTempStat, remEthAlarms=remEthAlarms, productsMIBNotifications=productsMIBNotifications, t1LBO=t1LBO, te1AIS=te1AIS, modelName=modelName, locMinRSLtimestamp=locMinRSLtimestamp, remUnavailDurationStr=remUnavailDurationStr, currentFwFilename=currentFwFilename, licenseFeatures=licenseFeatures, sysDate=sysDate, trapIpaddr3=trapIpaddr3, locMinimumTxModulation=locMinimumTxModulation, ipRemote=ipRemote, trapRemAlarmStat=trapRemAlarmStat, productsMIBConformance=productsMIBConformance, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, te1Interfaces=te1Interfaces, trapIpaddrEnable2=trapIpaddrEnable2, commitTe1Settings=commitTe1Settings, commitSystemSettings=commitSystemSettings, licKey=licKey, radioConfig=radioConfig, remCurrentBER=remCurrentBER, transferStart=transferStart, perfRemote=perfRemote, adminPassword=adminPassword, performance=performance, swapFWimage=swapFWimage, almRemote=almRemote, outboundEthernetThroughput=outboundEthernetThroughput, locLinkStateV=locLinkStateV, trapIpaddr4=trapIpaddr4, rfFreqBand=rfFreqBand, locUnavailDuration=locUnavailDuration, trapIpaddr1=trapIpaddr1, serialNumber=serialNumber, alarms=alarms, remTE1Alarms=remTE1Alarms, linkSecKey=linkSecKey, rnLocal=rnLocal, transferType=transferType, remTe1Alarms=remTe1Alarms, linkName=linkName, ntpClientEnable=ntpClientEnable, remLinkState=remLinkState, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, locMaxRSL=locMaxRSL, perfLocal=perfLocal, locMaximumRxModulation=locMaximumRxModulation, locActiveRxModulation=locActiveRxModulation, remSampleDurationStr=remSampleDurationStr, aesKey=aesKey, trapLocRslStat=trapLocRslStat, ntpServer1IpAddr=ntpServer1IpAddr, locTempAlarm=locTempAlarm, locLinkStateH=locLinkStateH, te1Interface=te1Interface, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, te1LoopBackMode=te1LoopBackMode, remSampleDuration=remSampleDuration, locResetStats=locResetStats, remCurrentTemp=remCurrentTemp, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, selectT1orE1=selectT1orE1, locEthUtilizationOut=locEthUtilizationOut, locTe1AlarmsEntry=locTe1AlarmsEntry, remMaxRSL=remMaxRSL, fileTransfer=fileTransfer, almLocal=almLocal, remCurrentTempS=remCurrentTempS, transferStatus=transferStatus, bootVersion=bootVersion, commitAdminSettings=commitAdminSettings, locLinkSecMismatch=locLinkSecMismatch, te1NumChannels=te1NumChannels, remTe1LinkSummary=remTe1LinkSummary, subnetMask=subnetMask, rxFreqRange=rxFreqRange, locEthUtilizationWatermark=locEthUtilizationWatermark, locLinkState=locLinkState, locSysAlarms=locSysAlarms, ntpTimeZoneSelect=ntpTimeZoneSelect, userThroughput=userThroughput, ntpServer3IpAddr=ntpServer3IpAddr, remResetStats=remResetStats, modelNumber=modelNumber, locSampleDurationStr=locSampleDurationStr, hwId=hwId, remTe1Alarm=remTe1Alarm, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, trapv2cEnable=trapv2cEnable, trapv3Enable=trapv3Enable, interface=interface, firmwareVersion=firmwareVersion, t1LineCode=t1LineCode, te1=te1, locCurrentBERstr=locCurrentBERstr, locEthSpeed=locEthSpeed, interfaceType=interfaceType, locTE1Alarms=locTE1Alarms, locEthPerfInterfaces=locEthPerfInterfaces, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, tftpServerIp=tftpServerIp, PYSNMP_MODULE_ID=productsMIB, remMinRSLtimestamp=remMinRSLtimestamp, locMinRSLstr=locMinRSLstr, locErrorDurationStr=locErrorDurationStr, commitNtpSettings=commitNtpSettings, PwType=PwType, trapLocRslThreshold=trapLocRslThreshold, remUnavailDuration=remUnavailDuration, ntpServer4IpAddr=ntpServer4IpAddr, ipAddressNetmask=ipAddressNetmask, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, locCurrentRSLstr=locCurrentRSLstr, locMaxRSLstr=locMaxRSLstr, trapIpaddrEnable4=trapIpaddrEnable4, radioName=radioName, locCurrentTemp=locCurrentTemp, locCurrentBER=locCurrentBER, locCurrentTempS=locCurrentTempS, fileManagement=fileManagement, trapReboot=trapReboot, locEthUtilizationIn=locEthUtilizationIn, sysTime=sysTime, remSysAlarms=remSysAlarms, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, te1NumActiveChannels=te1NumActiveChannels, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, trapv1Enable=trapv1Enable, trapIpaddrEnable1=trapIpaddrEnable1, uploadFilename=uploadFilename, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, productsMIB=productsMIB, systemConfig=systemConfig, commitSnmpSettings=commitSnmpSettings, remMinRSL=remMinRSL, productsMIBCompliances=productsMIBCompliances, radioReboot=radioReboot, productsAllObjects=productsAllObjects, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, trapLocAlarmStat=trapLocAlarmStat, productsMIBObjects=productsMIBObjects, defaultGateway=defaultGateway, locErrorDuration=locErrorDuration, rdkDbVer=rdkDbVer, txFreqRange=txFreqRange, remCurrentRSLstr=remCurrentRSLstr, ipLocal=ipLocal, locTe1Alarms=locTe1Alarms, trapLocLinkStat=trapLocLinkStat, aggregateUserThroughput=aggregateUserThroughput, locSampleDuration=locSampleDuration, rnRemote=rnRemote, radioAdmin=radioAdmin, locActiveTxModulation=locActiveTxModulation, radioInfo=radioInfo, inboundEthernetThroughput=inboundEthernetThroughput, remMaxRSLstr=remMaxRSLstr, locCurrentRSL=locCurrentRSL, ipAddress=ipAddress, partNumber=partNumber, trapIpaddr2=trapIpaddr2, ntpServer2IpAddr=ntpServer2IpAddr, locTe1LinkSummary=locTe1LinkSummary, remTe1AlarmsEntry=remTe1AlarmsEntry, remLinkStateH=remLinkStateH, snmpConfig=snmpConfig, ntp=ntp, te1Status=te1Status)
