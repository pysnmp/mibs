...
VlanGroupT, AuxNmsMode, EthMainStatusT, FileTransferTypeT, EnableStatusT, VlanStatusT, Te1LboT, exaltcommunications, EthPortMode, TimeZoneT, Te1LineCodeT, AlarmLevelT, EthAuxStatusT, ExaltEnableT, FileTransferStartT, NtpClientEnableT, Te1LoopBackModeT, Te1StatusT, AcmModulationT, Led4ColorT = mibBuilder.importSymbols("ExaltComm", "VlanGroupT", "AuxNmsMode", "EthMainStatusT", "FileTransferTypeT", "EnableStatusT", "VlanStatusT", "Te1LboT", "exaltcommunications", "EthPortMode", "TimeZoneT", "Te1LineCodeT", "AlarmLevelT", "EthAuxStatusT", "ExaltEnableT", "FileTransferStartT", "NtpClientEnableT", "Te1LoopBackModeT", "Te1StatusT", "AcmModulationT", "Led4ColorT")
...
mibBuilder.exportSymbols("ExaltComProducts", interface=interface, adminPassword=adminPassword, remLinkState=remLinkState, remMinRSL=remMinRSL, locMinRSLstr=locMinRSLstr, locMinimumTxModulation=locMinimumTxModulation, locResetStats=locResetStats, productsMIBNotifications=productsMIBNotifications, locMinRSL=locMinRSL, te1NumChannels=te1NumChannels, perfRemote=perfRemote, locUnavailDuration=locUnavailDuration, remMaxRSLstr=remMaxRSLstr, tftpServerIp=tftpServerIp, trapIpaddr4=trapIpaddr4, locLinkStateV=locLinkStateV, sysTime=sysTime, remCurrentRSL=remCurrentRSL, ntpClientEnable=ntpClientEnable, locTe1AlarmsEntry=locTe1AlarmsEntry, remEthAlarms=remEthAlarms, partNumber=partNumber, remMaxRSL=remMaxRSL, radioInfo=radioInfo, locErrorDuration=locErrorDuration, ntpTimeZoneSelect=ntpTimeZoneSelect, remTE1Alarms=remTE1Alarms, locLinkSecMismatch=locLinkSecMismatch, locActiveTxModulation=locActiveTxModulation, trapIpaddr2=trapIpaddr2, remTe1LinkSummary=remTe1LinkSummary, rxFreqRange=rxFreqRange, locTE1Alarms=locTE1Alarms, locEthPerfInterfaces=locEthPerfInterfaces, serialNumber=serialNumber, remCurrentTemp=remCurrentTemp, remUnavailDurationStr=remUnavailDurationStr, remMinRSLtimestamp=remMinRSLtimestamp, linkName=linkName, trapIpaddrEnable4=trapIpaddrEnable4, locMinRSLtimestamp=locMinRSLtimestamp, hwId=hwId, trapIpaddr3=trapIpaddr3, performance=performance, trapRemAlarmStat=trapRemAlarmStat, currentFwFilename=currentFwFilename, remTempAlarm=remTempAlarm, locCurrentBER=locCurrentBER, locLinkState=locLinkState, fileTransfer=fileTransfer, remTe1Alarms=remTe1Alarms, outboundEthernetThroughput=outboundEthernetThroughput, productsAllObjects=productsAllObjects, te1Interfaces=te1Interfaces, locTe1Alarm=locTe1Alarm, trapReboot=trapReboot, remUnavailDuration=remUnavailDuration, subnetMask=subnetMask, radioAdmin=radioAdmin, bootVersion=bootVersion, snmpConfig=snmpConfig, ntpServer3IpAddr=ntpServer3IpAddr, locTempAlarm=locTempAlarm, productsMIBGroups=productsMIBGroups, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, trapIpaddrEnable1=trapIpaddrEnable1, userPassword=userPassword, remLinkSecMismatch=remLinkSecMismatch, productsMIB=productsMIB, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, remCurrentBERstr=remCurrentBERstr, trapv3Enable=trapv3Enable, locMaxRSLstr=locMaxRSLstr, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, firmwareVersion=firmwareVersion, PwType=PwType, locCurrentBERstr=locCurrentBERstr, txFreqRange=txFreqRange, trapv1Enable=trapv1Enable, commitTe1Settings=commitTe1Settings, sysDate=sysDate, ntpServer2IpAddr=ntpServer2IpAddr, locCurrentRSL=locCurrentRSL, ntpServer4IpAddr=ntpServer4IpAddr, remTe1AlarmsEntry=remTe1AlarmsEntry, transferType=transferType, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, remSysAlarms=remSysAlarms, selectT1orE1=selectT1orE1, commitNtpSettings=commitNtpSettings, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, transferStatus=transferStatus, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, trapIpaddrEnable2=trapIpaddrEnable2, remErrorDuration=remErrorDuration, commitAdminSettings=commitAdminSettings, trapv2cEnable=trapv2cEnable, swapFWimage=swapFWimage, fileManagement=fileManagement, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, trapLocRslStat=trapLocRslStat, locErrorDurationStr=locErrorDurationStr, modelNumber=modelNumber, remMinRSLstr=remMinRSLstr, locMaximumTxModulation=locMaximumTxModulation, locMinimumRxModulation=locMinimumRxModulation, remErrorDurationStr=remErrorDurationStr, te1Status=te1Status, locLinkStateH=locLinkStateH, uploadFilename=uploadFilename, trapIpaddrEnable3=trapIpaddrEnable3, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, licKey=licKey, PYSNMP_MODULE_ID=productsMIB, commitSnmpSettings=commitSnmpSettings, locTe1Alarms=locTe1Alarms, perfLocal=perfLocal, factoryFwFilename=factoryFwFilename, trapLocRslThreshold=trapLocRslThreshold, remCurrentRSLstr=remCurrentRSLstr, rfFreqBand=rfFreqBand, commitSystemSettings=commitSystemSettings, locCurrentTemp=locCurrentTemp, inboundEthernetThroughput=inboundEthernetThroughput, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, systemConfig=systemConfig, locCurrentRSLstr=locCurrentRSLstr, locActiveRxModulation=locActiveRxModulation, remLinkStateH=remLinkStateH, locCurrentTempS=locCurrentTempS, ipLocal=ipLocal, locEthUtilizationOut=locEthUtilizationOut, te1=te1, aggregateUserThroughput=aggregateUserThroughput, ipAddress=ipAddress, productsMIBCompliances=productsMIBCompliances, remTe1Alarm=remTe1Alarm, rnRemote=rnRemote, locEthSpeed=locEthSpeed, remCurrentTempS=remCurrentTempS, locSysAlarms=locSysAlarms, te1LoopBackMode=te1LoopBackMode, t1LineCode=t1LineCode, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, defaultGateway=defaultGateway, userThroughput=userThroughput, te1NumActiveChannels=te1NumActiveChannels, remSampleDurationStr=remSampleDurationStr, t1LBO=t1LBO, alternateFwFilename=alternateFwFilename, locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, te1Interface=te1Interface, alarms=alarms, radioMonitor=radioMonitor, remResetStats=remResetStats, trapLocTempStat=trapLocTempStat, remLinkStateV=remLinkStateV, ntpServer1IpAddr=ntpServer1IpAddr, productsMIBObjects=productsMIBObjects, productsMIBConformance=productsMIBConformance, aesKey=aesKey, radioConfig=radioConfig, transferStart=transferStart, licenseFeatures=licenseFeatures, ntp=ntp, radioName=radioName, locEthAlarms=locEthAlarms, ipRemote=ipRemote, radioReboot=radioReboot, trapAuth=trapAuth, locEthUtilizationIn=locEthUtilizationIn, trapLocAlarmStat=trapLocAlarmStat, rdkDbVer=rdkDbVer, rnLocal=rnLocal, locTe1LinkSummary=locTe1LinkSummary, remCurrentBER=remCurrentBER, locSampleDurationStr=locSampleDurationStr, trapIpaddr1=trapIpaddr1, aesEnable=aesEnable, locSampleDuration=locSampleDuration, locUnavailDurationStr=locUnavailDurationStr, te1AIS=te1AIS, almLocal=almLocal, locMaximumRxModulation=locMaximumRxModulation, trapLocLinkStat=trapLocLinkStat, interfaceType=interfaceType, almRemote=almRemote, linkSecKey=linkSecKey, remSampleDuration=remSampleDuration, ipAddressNetmask=ipAddressNetmask, modelName=modelName, locMaxRSL=locMaxRSL, locEthUtilizationWatermark=locEthUtilizationWatermark)
