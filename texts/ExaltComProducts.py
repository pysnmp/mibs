...
Te1LoopBackModeT, VlanStatusT, EnableStatusT, Te1StatusT, FileTransferStartT, TimeZoneT, Te1LboT, FileTransferTypeT, VlanGroupT, EthPortMode, AuxNmsMode, EthMainStatusT, Te1LineCodeT, AlarmLevelT, exaltcommunications, EthAuxStatusT, AcmModulationT, ExaltEnableT, Led4ColorT, NtpClientEnableT = mibBuilder.importSymbols("ExaltComm", "Te1LoopBackModeT", "VlanStatusT", "EnableStatusT", "Te1StatusT", "FileTransferStartT", "TimeZoneT", "Te1LboT", "FileTransferTypeT", "VlanGroupT", "EthPortMode", "AuxNmsMode", "EthMainStatusT", "Te1LineCodeT", "AlarmLevelT", "exaltcommunications", "EthAuxStatusT", "AcmModulationT", "ExaltEnableT", "Led4ColorT", "NtpClientEnableT")
...
mibBuilder.exportSymbols("ExaltComProducts", locMinimumTxEthernetThroughput=locMinimumTxEthernetThroughput, remCurrentTempS=remCurrentTempS, remSampleDuration=remSampleDuration, radioName=radioName, productsMIBConformance=productsMIBConformance, t1LineCode=t1LineCode, remCurrentBERstr=remCurrentBERstr, modelName=modelName, serialNumber=serialNumber, commitNtpSettings=commitNtpSettings, locMaximumRxEthernetThroughput=locMaximumRxEthernetThroughput, locTe1LinkSummary=locTe1LinkSummary, locEthAlarms=locEthAlarms, snmpConfig=snmpConfig, selectT1orE1=selectT1orE1, remSysAlarms=remSysAlarms, locMaximumTxModulation=locMaximumTxModulation, trapv2cEnable=trapv2cEnable, remCurrentBER=remCurrentBER, defaultGateway=defaultGateway, trapLocRslStat=trapLocRslStat, remTempAlarm=remTempAlarm, commitAdminSettings=commitAdminSettings, locCurrentBERstr=locCurrentBERstr, locEthPerfInterfacesEntry=locEthPerfInterfacesEntry, locCurrentRSL=locCurrentRSL, fileManagement=fileManagement, transferStart=transferStart, locMaxRSL=locMaxRSL, locMinimumTxModulation=locMinimumTxModulation, locTE1Alarms=locTE1Alarms, trapRemAlarmStat=trapRemAlarmStat, uploadFilename=uploadFilename, trapLocAlarmStat=trapLocAlarmStat, trapIpaddr2=trapIpaddr2, commitSnmpSettings=commitSnmpSettings, radioMonitor=radioMonitor, locLinkState=locLinkState, commitSystemSettings=commitSystemSettings, locEthUtilizationIn=locEthUtilizationIn, te1=te1, commitTe1Settings=commitTe1Settings, modelNumber=modelNumber, hwId=hwId, productsMIBCompliances=productsMIBCompliances, firmwareVersion=firmwareVersion, locActiveTxEthernetThroughput=locActiveTxEthernetThroughput, subnetMask=subnetMask, trapLocLinkStat=trapLocLinkStat, bootVersion=bootVersion, ntpServer1IpAddr=ntpServer1IpAddr, trapIpaddr1=trapIpaddr1, outboundEthernetThroughput=outboundEthernetThroughput, remLinkStateH=remLinkStateH, locCurrentBER=locCurrentBER, trapIpaddrEnable3=trapIpaddrEnable3, locUnavailDurationStr=locUnavailDurationStr, linkName=linkName, productsMIB=productsMIB, rfFreqBand=rfFreqBand, sysTime=sysTime, locMaximumTxEthernetThroughput=locMaximumTxEthernetThroughput, remResetStats=remResetStats, ipLocal=ipLocal, perfRemote=perfRemote, aesEnable=aesEnable, aesKey=aesKey, locSysAlarms=locSysAlarms, remUnavailDuration=remUnavailDuration, locMinRSLtimestamp=locMinRSLtimestamp, transferStatus=transferStatus, rnRemote=rnRemote, locEthUtilizationWatermark=locEthUtilizationWatermark, remTe1Alarm=remTe1Alarm, ipAddress=ipAddress, locTe1Alarm=locTe1Alarm, locMinimumRxModulation=locMinimumRxModulation, ntpTimeZoneSelect=ntpTimeZoneSelect, radioInfo=radioInfo, locUnavailDuration=locUnavailDuration, remLinkSecMismatch=remLinkSecMismatch, trapLocRslThreshold=trapLocRslThreshold, t1LBO=t1LBO, remCurrentRSLstr=remCurrentRSLstr, fileTransfer=fileTransfer, systemConfig=systemConfig, ipAddressNetmask=ipAddressNetmask, te1AIS=te1AIS, remTE1Alarms=remTE1Alarms, remUnavailDurationStr=remUnavailDurationStr, locEthSpeed=locEthSpeed, remErrorDurationStr=remErrorDurationStr, aggregateUserThroughput=aggregateUserThroughput, swapFWimage=swapFWimage, remCurrentTemp=remCurrentTemp, locEthUtilizationWatermarkEnabled=locEthUtilizationWatermarkEnabled, ntpServer4IpAddr=ntpServer4IpAddr, adminPassword=adminPassword, locMinRSLstr=locMinRSLstr, inboundEthernetThroughput=inboundEthernetThroughput, remTe1Alarms=remTe1Alarms, productsMIBObjects=productsMIBObjects, trapv3Enable=trapv3Enable, remMaxRSLstr=remMaxRSLstr, ipRemote=ipRemote, ntpServer3IpAddr=ntpServer3IpAddr, partNumber=partNumber, locMaxRSLstr=locMaxRSLstr, ntp=ntp, locCurrentTempS=locCurrentTempS, remErrorDuration=remErrorDuration, locCurrentRSLstr=locCurrentRSLstr, rxFreqRange=rxFreqRange, ntpServer2IpAddr=ntpServer2IpAddr, perfLocal=perfLocal, trapReboot=trapReboot, locLinkStateV=locLinkStateV, remCurrentRSL=remCurrentRSL, trapIpaddr4=trapIpaddr4, locCurrentTemp=locCurrentTemp, currentFwFilename=currentFwFilename, remTe1LinkSummary=remTe1LinkSummary, transferType=transferType, locEthUtilizationWatermarkTrapEnabled=locEthUtilizationWatermarkTrapEnabled, locSampleDurationStr=locSampleDurationStr, remMaxRSL=remMaxRSL, locErrorDuration=locErrorDuration, interface=interface, locTe1Alarms=locTe1Alarms, radioConfig=radioConfig, remSampleDurationStr=remSampleDurationStr, locTempAlarm=locTempAlarm, performance=performance, fullDuplexEthernetThroughput=fullDuplexEthernetThroughput, radioAdmin=radioAdmin, locMaximumRxModulation=locMaximumRxModulation, locActiveTxModulation=locActiveTxModulation, trapIpaddr3=trapIpaddr3, locTe1AlarmsEntry=locTe1AlarmsEntry, remLinkStateV=remLinkStateV, trapIpaddrEnable4=trapIpaddrEnable4, te1NumActiveChannels=te1NumActiveChannels, radioReboot=radioReboot, trapIpaddrEnable1=trapIpaddrEnable1, userPassword=userPassword, factoryFwFilename=factoryFwFilename, txFreqRange=txFreqRange, linkSecKey=linkSecKey, userThroughput=userThroughput, remTe1AlarmsEntry=remTe1AlarmsEntry, locActiveRxModulation=locActiveRxModulation, alternateFwFilename=alternateFwFilename, PwType=PwType, locActiveRxEthernetThroughput=locActiveRxEthernetThroughput, te1NumChannels=te1NumChannels, remMinRSL=remMinRSL, remMinRSLstr=remMinRSLstr, interfaceType=interfaceType, almRemote=almRemote, sysDate=sysDate, locSampleDuration=locSampleDuration, locResetStats=locResetStats, te1Status=te1Status, rdkDbVer=rdkDbVer, ntpClientEnable=ntpClientEnable, rnLocal=rnLocal, te1LoopBackMode=te1LoopBackMode, locLinkSecMismatch=locLinkSecMismatch, locEthPerfInterfaces=locEthPerfInterfaces, te1Interfaces=te1Interfaces, locErrorDurationStr=locErrorDurationStr, locMinRSL=locMinRSL, trapAuth=trapAuth, licKey=licKey, locEthUtilizationWatermarkTrapDuration=locEthUtilizationWatermarkTrapDuration, PYSNMP_MODULE_ID=productsMIB, locEthUtilizationOut=locEthUtilizationOut, locMinimumRxEthernetThroughput=locMinimumRxEthernetThroughput, licenseFeatures=licenseFeatures, alarms=alarms, productsMIBGroups=productsMIBGroups, remLinkState=remLinkState, productsAllObjects=productsAllObjects, tftpServerIp=tftpServerIp, remMinRSLtimestamp=remMinRSLtimestamp, trapIpaddrEnable2=trapIpaddrEnable2, te1Interface=te1Interface, locLinkStateH=locLinkStateH, remEthAlarms=remEthAlarms, almLocal=almLocal, productsMIBNotifications=productsMIBNotifications, trapLocTempStat=trapLocTempStat, trapv1Enable=trapv1Enable)
