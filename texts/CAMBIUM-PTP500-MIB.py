...
# Produced by pysmi-1.1.3 at Sun Nov 21 01:04:33 2021
...
TimeTicks, Unsigned32, Counter32, Counter64, Gauge32, iso, Bits, IpAddress, ModuleIdentity, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "Counter32", "Counter64", "Gauge32", "iso", "Bits", "IpAddress", "ModuleIdentity", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telnetPortNumber=telnetPortNumber, sNTPSync=sNTPSync, tDDSynchronizationMode=tDDSynchronizationMode, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableEntry=sNMPTrapTableEntry, linkLoss=linkLoss, userPassword=userPassword, versionsGroup=versionsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsLoopback=telecomsLoopback, signalStrengthRatio=signalStrengthRatio, dfsTable=dfsTable, productName=productName, targetMACAddress=targetMACAddress, wirelessLinkStatus=wirelessLinkStatus, userRole=userRole, phyControlGroup=phyControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNTPLastSync=sNTPLastSync, accessMethod=accessMethod, incompatibleRegionCodes=incompatibleRegionCodes, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitFreqKHz=transmitFreqKHz, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, notificationsGroup=notificationsGroup, antennaGain=antennaGain, sMTPServerIPAddress=sMTPServerIPAddress, sNTPState=sNTPState, licenceGroup=licenceGroup, ethernetGroup=ethernetGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userName=userName, ptpCompliance=ptpCompliance, ptpTraps=ptpTraps, dfsGroup=dfsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitFreqMHz=transmitFreqMHz, hTTPPortNumber=hTTPPortNumber, telecomsInterface=telecomsInterface, resetGroup=resetGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, sntp=sntp, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatusGroup=phyStatusGroup, channelBandwidth=channelBandwidth, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkAvailability=wirelessLinkAvailability, installStatusTrap=installStatusTrap, dfsTableIndex=dfsTableIndex, ptp500=ptp500, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPSPortNumber=hTTPSPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, snmpControlGroup=snmpControlGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogControlGroup=syslogControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoMdix=dataPortAutoMdix, softwareVersion=softwareVersion, reset=reset, receiveModulationModeDetail=receiveModulationModeDetail, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelChangeTrap=channelChangeTrap, userEnabled=userEnabled, receivePower=receivePower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkSymmetry=linkSymmetry, encryption=encryption, licence=licence, regionCode=regionCode, hardwareVersion=hardwareVersion, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapVersion=sNMPTrapVersion, sNTPPollInterval=sNTPPollInterval, dfsTableNumber=dfsTableNumber, transmitChannel=transmitChannel, range=range, systemClock=systemClock, siteName=siteName, telecom=telecom, management=management, sNMPPortNumber=sNMPPortNumber, licensedCapacity=licensedCapacity, ptmp=ptmp, encryptionGroup=encryptionGroup, supplementaryGroup=supplementaryGroup, transmitDataRate=transmitDataRate, linkName=linkName, sNMPTrapTable=sNMPTrapTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, linkModeOptimisation=linkModeOptimisation, sNMPEnabledTraps=sNMPEnabledTraps, sNMPv3Enable=sNMPv3Enable, supplementary=supplementary, maximumTransmitPower=maximumTransmitPower, dfsTableEntry=dfsTableEntry, receiveChannel=receiveChannel, cambium=cambium, aAAControl=aAAControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vectorError=vectorError, latitude=latitude, pubStats=pubStats, installArmStateTrap=installArmStateTrap, pubStatsGroup=pubStatsGroup, vLANManagementPriority=vLANManagementPriority, hTTPSAccessEnabled=hTTPSAccessEnabled, daylightSaving=daylightSaving, aggregateDataRate=aggregateDataRate, receiveDataRate=receiveDataRate, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, gatewayIPAddress=gatewayIPAddress, vLANManagementVID=vLANManagementVID, ethernet=ethernet, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, userTableNumber=userTableNumber, remoteIPAddress=remoteIPAddress, bandwidthVariant=bandwidthVariant, dataPortDisabledWarning=dataPortDisabledWarning, sNMPCommunityString=sNMPCommunityString, altitude=altitude, sntpGroup=sntpGroup, receiveFreqMHz=receiveFreqMHz, groupID=groupID, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, installArmState=installArmState, transmitModulationMode=transmitModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsCableLength=telecomsCableLength, managementGroup=managementGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, byteErrorRatio=byteErrorRatio, telecomsChannelStatusTrap=telecomsChannelStatusTrap, capacityLicenseMismatch=capacityLicenseMismatch, ptpTrapPrefix=ptpTrapPrefix, systemReset=systemReset, userTableEntry=userTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, userTable=userTable, tDDControlGroup=tDDControlGroup, longitude=longitude, tFTPServerIPAddress=tFTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogStateTrap=syslogStateTrap, configurationGroup=configurationGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, frequencyVariant=frequencyVariant, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogState=syslogState, regionCodeTrap=regionCodeTrap, installStatus=installStatus, hTTPAccessEnabled=hTTPAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, dfsMeans=dfsMeans, eIRP=eIRP, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, bootVersion=bootVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, smtpGroup=smtpGroup, searchState=searchState, dfsPeaks=dfsPeaks, dataPortStatusTrap=dataPortStatusTrap, dataPortStatus=dataPortStatus, masterSlaveMode=masterSlaveMode, userTableIndex=userTableIndex, telecomsChannelStatus=telecomsChannelStatus, configuration=configuration, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerIPAddress=sNTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogClientTrap=syslogClientTrap, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptp=ptp, phyControl=phyControl, dfs=dfs, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, telecomGroup=telecomGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitPower=transmitPower, cableLoss=cableLoss, receiveModulationMode=receiveModulationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTable=vLANPriorityTable, tDDControl=tDDControl, phyStatus=phyStatus, alarms=alarms, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, smtp=smtp, sNMPTrapTableIndex=sNMPTrapTableIndex, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, iPAddress=iPAddress, versions=versions, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, timeZone=timeZone, ptpGroups=ptpGroups, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsLineCode=telecomsLineCode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, productVariant=productVariant, syslogControl=syslogControl, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogClient=syslogClient, noWirelessChannelAvailable=noWirelessChannelAvailable, encryptionAlgorithm=encryptionAlgorithm)
