...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", aAAControl=aAAControl, transmitPower=transmitPower, sNTPPollInterval=sNTPPollInterval, hTTPSPortNumber=hTTPSPortNumber, configurationGroup=configurationGroup, ptp500=ptp500, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, management=management, phyStatus=phyStatus, wirelessLinkStatus=wirelessLinkStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, antennaGain=antennaGain, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, subnetMask=subnetMask, telecomsChannelStatus=telecomsChannelStatus, ptpTrapPrefix=ptpTrapPrefix, accessMethod=accessMethod, maximumTransmitPower=maximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsGroup=dfsGroup, tFTPServerPortNumber=tFTPServerPortNumber, systemReset=systemReset, incompatibleMasterAndSlave=incompatibleMasterAndSlave, bootVersion=bootVersion, vLANPriorityTable=vLANPriorityTable, sntp=sntp, sNMPv3Enable=sNMPv3Enable, capacityLicenseMismatch=capacityLicenseMismatch, alarms=alarms, ptpGroups=ptpGroups, installArmStateTrap=installArmStateTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPEmailAlert=sMTPEmailAlert, masterSlaveMode=masterSlaveMode, configuration=configuration, managementGroup=managementGroup, resetGroup=resetGroup, supplementaryGroup=supplementaryGroup, transmitChannel=transmitChannel, sntpGroup=sntpGroup, sNMPCommunityString=sNMPCommunityString, installStatusTrap=installStatusTrap, licensedCapacity=licensedCapacity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleRegionCodes=incompatibleRegionCodes, dfsMeans=dfsMeans, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableIndex=dfsTableIndex, telnetAccessEnabled=telnetAccessEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, unitOutOfCalibration=unitOutOfCalibration, userTable=userTable, phyStatusGroup=phyStatusGroup, groupID=groupID, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installArmState=installArmState, phyControlGroup=phyControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, alarmsGroup=alarmsGroup, telecom=telecom, receiveFreqMHz=receiveFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, receivePower=receivePower, transmitFreqKHz=transmitFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDControlGroup=tDDControlGroup, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, channelChangeTrap=channelChangeTrap, sNMPTrapTable=sNMPTrapTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, siteName=siteName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, daylightSaving=daylightSaving, userTableEntry=userTableEntry, PYSNMP_MODULE_ID=cambium, sNTPState=sNTPState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, dfsTableEntry=dfsTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, userName=userName, versionsGroup=versionsGroup, cambium=cambium, userTableNumber=userTableNumber, telecomsLineCode=telecomsLineCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, linkName=linkName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpCompliance=ptpCompliance, supplementary=supplementary, userTableIndex=userTableIndex, dfsPeaks=dfsPeaks, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionAlgorithm=encryptionAlgorithm, tDDControl=tDDControl, constantPowerSpectralDensity=constantPowerSpectralDensity, searchState=searchState, userPassword=userPassword, reset=reset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpTraps=ptpTraps, userRole=userRole, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, regionCodeTrap=regionCodeTrap, tDDSynchronizationMode=tDDSynchronizationMode, receiveDataRate=receiveDataRate, hardwareVersion=hardwareVersion, telecomsInterface=telecomsInterface, receiveChannel=receiveChannel, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogStateTrap=syslogStateTrap, transmitDataRate=transmitDataRate, syslogControl=syslogControl, dataPortAutoMdix=dataPortAutoMdix, linkLoss=linkLoss, byteErrorRatio=byteErrorRatio, systemClock=systemClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aAAControlGroup=aAAControlGroup, telecomsLoopback=telecomsLoopback, vLANManagementVID=vLANManagementVID, dataPortStatus=dataPortStatus, productVariant=productVariant, syslogState=syslogState, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, linkModeOptimisation=linkModeOptimisation, remoteIPAddress=remoteIPAddress, syslogControlGroup=syslogControlGroup, frequencyVariant=frequencyVariant, vLANManagementPriority=vLANManagementPriority, licenceGroup=licenceGroup, pubStats=pubStats, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, eIRP=eIRP, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, smtp=smtp, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, telnetPortNumber=telnetPortNumber, receiveFreqKHz=receiveFreqKHz, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPAddress=iPAddress, smtpGroup=smtpGroup, tFTPServerIPAddress=tFTPServerIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, altitude=altitude, timeZone=timeZone, sMTPServerPortNumber=sMTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, longitude=longitude, receiveModulationMode=receiveModulationMode, ethernetGroup=ethernetGroup, syslogClientTrap=syslogClientTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogClient=syslogClient, phyControl=phyControl, dfsTableNumber=dfsTableNumber, range=range, softwareVersion=softwareVersion, sNTPServerPortNumber=sNTPServerPortNumber, ethernet=ethernet, linkSymmetry=linkSymmetry, sNMPPortNumber=sNMPPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licence=licence, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, regionCode=regionCode, cableLoss=cableLoss, sNTPLastSync=sNTPLastSync, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionGroup=encryptionGroup, channelBandwidth=channelBandwidth, telecomsCableLength=telecomsCableLength, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptmp=ptmp, vectorError=vectorError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, secondarySoftwareVersion=secondarySoftwareVersion, targetMACAddress=targetMACAddress, dfs=dfs, telecomGroup=telecomGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkAvailability=wirelessLinkAvailability, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitFreqMHz=transmitFreqMHz, bandwidthVariant=bandwidthVariant, hTTPPortNumber=hTTPPortNumber, sNTPSync=sNTPSync, transmitModulationMode=transmitModulationMode, signalStrengthRatio=signalStrengthRatio, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptp=ptp, pubStatsGroup=pubStatsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, productName=productName, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userEnabled=userEnabled, installStatus=installStatus, dfsTable=dfsTable)
