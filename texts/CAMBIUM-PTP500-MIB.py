...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", cambium=cambium, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, siteName=siteName, sNMPPortNumber=sNMPPortNumber, telecomsLoopback=telecomsLoopback, snmpControlGroup=snmpControlGroup, syslogStateTrap=syslogStateTrap, dfs=dfs, sntp=sntp, aAAControl=aAAControl, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmState=installArmState, sNTPSync=sNTPSync, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, encryption=encryption, subnetMask=subnetMask, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryptionGroup=encryptionGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, capacityLicenseMismatch=capacityLicenseMismatch, vLANManagementPriority=vLANManagementPriority, telnetAccessEnabled=telnetAccessEnabled, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteIPAddress=remoteIPAddress, snmpControl=snmpControl, antennaGain=antennaGain, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableNumber=userTableNumber, linkLoss=linkLoss, licensedCapacity=licensedCapacity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyStatus=phyStatus, signalStrengthRatio=signalStrengthRatio, ptpGroups=ptpGroups, configurationGroup=configurationGroup, transmitChannel=transmitChannel, alarms=alarms, telecomsInterface=telecomsInterface, frequencyVariant=frequencyVariant, latitude=latitude, smtp=smtp, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableIndex=userTableIndex, versionsGroup=versionsGroup, telecomGroup=telecomGroup, licence=licence, licenceGroup=licenceGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, userPassword=userPassword, secondarySoftwareVersion=secondarySoftwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, unitOutOfCalibration=unitOutOfCalibration, ptp=ptp, syslogControlGroup=syslogControlGroup, groupID=groupID, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptp500=ptp500, sNTPServerIPAddress=sNTPServerIPAddress, tDDControl=tDDControl, userTableEntry=userTableEntry, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPEnabledTraps=sNMPEnabledTraps, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, aggregateDataRate=aggregateDataRate, accessMethod=accessMethod, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetPortNumber=telnetPortNumber, hardwareVersion=hardwareVersion, iPAddress=iPAddress, cableLoss=cableLoss, receivePower=receivePower, alarmsGroup=alarmsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, systemClock=systemClock, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bootVersion=bootVersion, transmitFreqKHz=transmitFreqKHz, userName=userName, linkModeOptimisation=linkModeOptimisation, channelChangeTrap=channelChangeTrap, dfsTable=dfsTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsLineCode=telecomsLineCode, constantPowerSpectralDensity=constantPowerSpectralDensity, supplementary=supplementary, dfsTableNumber=dfsTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, PYSNMP_MODULE_ID=cambium, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userEnabled=userEnabled, wirelessLinkStatus=wirelessLinkStatus, hTTPAccessEnabled=hTTPAccessEnabled, searchState=searchState, smtpGroup=smtpGroup, installStatusTrap=installStatusTrap, reset=reset, supplementaryGroup=supplementaryGroup, ethernetGroup=ethernetGroup, configuration=configuration, byteErrorRatio=byteErrorRatio, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableIndex=dfsTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogClientTrap=syslogClientTrap, productVariant=productVariant, linkName=linkName, daylightSaving=daylightSaving, syslogState=syslogState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsPeaks=dfsPeaks, eIRP=eIRP, sNMPTrapVersion=sNMPTrapVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, tDDControlGroup=tDDControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPLastSync=sNTPLastSync, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEmailAlert=sMTPEmailAlert, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, syslogControl=syslogControl, targetMACAddress=targetMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, systemReset=systemReset, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, linkSymmetry=linkSymmetry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, management=management, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, ptmp=ptmp, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelStatus=telecomsChannelStatus, transmitFreqMHz=transmitFreqMHz, dfsMeans=dfsMeans, timeZone=timeZone, aAAControlGroup=aAAControlGroup, receiveFreqKHz=receiveFreqKHz, sNTPServerPortNumber=sNTPServerPortNumber, resetGroup=resetGroup, sNMPCommunityString=sNMPCommunityString, telecom=telecom, regionCodeTrap=regionCodeTrap, sNTPState=sNTPState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetFiberSupport=ethernetFiberSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortStatusTrap=dataPortStatusTrap, longitude=longitude, encryptionAlgorithm=encryptionAlgorithm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpTraps=ptpTraps, masterSlaveMode=masterSlaveMode, wirelessLinkAvailability=wirelessLinkAvailability, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, sntpGroup=sntpGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, maximumTransmitPower=maximumTransmitPower, channelBandwidth=channelBandwidth, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, versions=versions, dfsGroup=dfsGroup, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityTable=vLANPriorityTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsCableLength=telecomsCableLength, transmitDataRate=transmitDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, receiveChannel=receiveChannel, hTTPSPortNumber=hTTPSPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernet=ethernet, softwareVersion=softwareVersion, userTable=userTable, range=range, productName=productName, dataPortStatus=dataPortStatus, sMTPServerIPAddress=sMTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, notificationsGroup=notificationsGroup, vLANManagementVID=vLANManagementVID, dfsTableEntry=dfsTableEntry, phyControl=phyControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitPower=transmitPower, regionCode=regionCode, telecomsLoopbackTrap=telecomsLoopbackTrap, phyStatusGroup=phyStatusGroup, altitude=altitude, dataPortAutoMdix=dataPortAutoMdix, hTTPPortNumber=hTTPPortNumber, installStatus=installStatus, userRole=userRole, receiveModulationModeDetail=receiveModulationModeDetail, phyControlGroup=phyControlGroup, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, bandwidthVariant=bandwidthVariant, dataPortDisabledWarning=dataPortDisabledWarning, syslogClient=syslogClient, ptpCompliance=ptpCompliance)
