...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementPriority=vLANManagementPriority, ptpGroups=ptpGroups, iPAddress=iPAddress, userEnabled=userEnabled, receiveFreqKHz=receiveFreqKHz, transmitChannel=transmitChannel, linkModeOptimisation=linkModeOptimisation, versions=versions, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, configuration=configuration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, snmpControl=snmpControl, installStatus=installStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, timeZone=timeZone, dfsMeans=dfsMeans, linkSymmetry=linkSymmetry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, dfsGroup=dfsGroup, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveDataRate=receiveDataRate, phyControlGroup=phyControlGroup, telecomsCableLength=telecomsCableLength, userRole=userRole, PYSNMP_MODULE_ID=cambium, dataPortAutoMdix=dataPortAutoMdix, ptpTraps=ptpTraps, remoteIPAddress=remoteIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, pubStatsGroup=pubStatsGroup, vLANPriorityTable=vLANPriorityTable, groupID=groupID, sNTPPollInterval=sNTPPollInterval, channelBandwidth=channelBandwidth, configurationGroup=configurationGroup, hTTPPortNumber=hTTPPortNumber, tDDControl=tDDControl, transmitFreqKHz=transmitFreqKHz, channelChangeTrap=channelChangeTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTable=dfsTable, userName=userName, subnetMask=subnetMask, receivePower=receivePower, dfsTableIndex=dfsTableIndex, linkLoss=linkLoss, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemReset=systemReset, signalStrengthRatio=signalStrengthRatio, sNTPSyncTrap=sNTPSyncTrap, userTable=userTable, alarms=alarms, installArmStateTrap=installArmStateTrap, tDDSynchronizationMode=tDDSynchronizationMode, telecomsInterface=telecomsInterface, supplementaryGroup=supplementaryGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, cableLoss=cableLoss, sMTPEmailAlert=sMTPEmailAlert, smtp=smtp, regionCodeTrap=regionCodeTrap, frequencyVariant=frequencyVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, gatewayIPAddress=gatewayIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, sNTPState=sNTPState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPSync=sNTPSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, regionCode=regionCode, phyStatusGroup=phyStatusGroup, latitude=latitude, vLANPriorityTableEntry=vLANPriorityTableEntry, aAAControl=aAAControl, telecomsChannelStatus=telecomsChannelStatus, installStatusTrap=installStatusTrap, transmitFreqMHz=transmitFreqMHz, sNMPv3Enable=sNMPv3Enable, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, systemClock=systemClock, ptp=ptp, transmitModulationMode=transmitModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableNumber=sNMPTrapTableNumber, licence=licence, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomGroup=telecomGroup, vectorError=vectorError, sNMPPortNumber=sNMPPortNumber, productName=productName, dataPortDisabledWarning=dataPortDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, accessMethod=accessMethod, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bandwidthVariant=bandwidthVariant, ethernetFiberSupport=ethernetFiberSupport, dataPortStatusTrap=dataPortStatusTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLineCode=telecomsLineCode, sNTPServerPortNumber=sNTPServerPortNumber, supplementary=supplementary, phyControl=phyControl, productVariant=productVariant, ptmp=ptmp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogControlGroup=syslogControlGroup, managementGroup=managementGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControlGroup=tDDControlGroup, licensedCapacity=licensedCapacity, softwareVersion=softwareVersion, syslogClient=syslogClient, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsLoopback=telecomsLoopback, longitude=longitude, encryption=encryption, searchState=searchState, receiveChannel=receiveChannel, userTableNumber=userTableNumber, snmpControlGroup=snmpControlGroup, dfsTableEntry=dfsTableEntry, notificationsGroup=notificationsGroup, installArmState=installArmState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecom=telecom, eIRP=eIRP, sNMPCommunityString=sNMPCommunityString, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpCompliance=ptpCompliance, daylightSaving=daylightSaving, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatus=wirelessLinkStatus, management=management, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, targetMACAddress=targetMACAddress, antennaGain=antennaGain, tFTPServerIPAddress=tFTPServerIPAddress, pubStats=pubStats, transmitDataRate=transmitDataRate, smtpGroup=smtpGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryptionGroup=encryptionGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableEntry=userTableEntry, aAAControlGroup=aAAControlGroup, dataPortStatus=dataPortStatus, hTTPAccessEnabled=hTTPAccessEnabled, licenceGroup=licenceGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, ethernetGroup=ethernetGroup, hardwareVersion=hardwareVersion, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqMHz=receiveFreqMHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, byteErrorRatio=byteErrorRatio, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, sNTPLastSync=sNTPLastSync, aggregateDataRate=aggregateDataRate, secondarySoftwareVersion=secondarySoftwareVersion, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, reset=reset, altitude=altitude, sntpGroup=sntpGroup, userPassword=userPassword, ptp500=ptp500, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogClientTrap=syslogClientTrap, sntp=sntp, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTableNumber=dfsTableNumber, unitOutOfCalibration=unitOutOfCalibration, linkName=linkName, userTableIndex=userTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, siteName=siteName, syslogStateTrap=syslogStateTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfs=dfs, phyStatus=phyStatus, wirelessLinkAvailability=wirelessLinkAvailability, transmitPower=transmitPower, vLANManagementVID=vLANManagementVID, sNTPServerIPAddress=sNTPServerIPAddress, resetGroup=resetGroup, telnetPortNumber=telnetPortNumber, range=range, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsPeaks=dfsPeaks, cambium=cambium, bootVersion=bootVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTable=sNMPTrapTable, syslogState=syslogState, dataPortWirelessDownAlert=dataPortWirelessDownAlert)
