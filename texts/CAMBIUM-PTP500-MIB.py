...
# Produced by pysmi-1.1.3 at Tue Nov 30 13:47:21 2021
...
ObjectIdentity, IpAddress, enterprises, Counter32, Bits, Counter64, iso, Gauge32, MibIdentifier, TimeTicks, NotificationType, ModuleIdentity, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "enterprises", "Counter32", "Bits", "Counter64", "iso", "Gauge32", "MibIdentifier", "TimeTicks", "NotificationType", "ModuleIdentity", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", latitude=latitude, masterSlaveMode=masterSlaveMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControlGroup=phyControlGroup, userTableEntry=userTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, snmpControlGroup=snmpControlGroup, eIRP=eIRP, userPassword=userPassword, notificationsGroup=notificationsGroup, vLANManagementVID=vLANManagementVID, dataPortWirelessDownAlert=dataPortWirelessDownAlert, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerIPAddress=sMTPServerIPAddress, frequencyVariant=frequencyVariant, pubStatsGroup=pubStatsGroup, incompatibleRegionCodes=incompatibleRegionCodes, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogClientTrap=syslogClientTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, receivePower=receivePower, PYSNMP_MODULE_ID=cambium, vLANManagementPriority=vLANManagementPriority, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityString=sNMPCommunityString, reset=reset, gatewayIPAddress=gatewayIPAddress, linkLoss=linkLoss, linkModeOptimisation=linkModeOptimisation, snmpControl=snmpControl, licence=licence, tFTPServerIPAddress=tFTPServerIPAddress, management=management, smtpGroup=smtpGroup, siteName=siteName, tDDSynchronizationStatus=tDDSynchronizationStatus, supplementaryGroup=supplementaryGroup, targetMACAddress=targetMACAddress, telecomGroup=telecomGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, cableLoss=cableLoss, dfsTableIndex=dfsTableIndex, userTableIndex=userTableIndex, installArmStateTrap=installArmStateTrap, syslogStateTrap=syslogStateTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSPortNumber=hTTPSPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemClock=systemClock, vLANPriorityTableEntry=vLANPriorityTableEntry, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, hTTPPortNumber=hTTPPortNumber, managementGroup=managementGroup, sNTPSyncTrap=sNTPSyncTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsLoopback=telecomsLoopback, tDDSynchronizationMode=tDDSynchronizationMode, bandwidthVariant=bandwidthVariant, transmitFreqMHz=transmitFreqMHz, ethernetGroup=ethernetGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, range=range, sNTPServerIPAddress=sNTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitChannel=transmitChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, configurationGroup=configurationGroup, telecomsLineCode=telecomsLineCode, iPAddress=iPAddress, sNTPServerPortNumber=sNTPServerPortNumber, configuration=configuration, remoteIPAddress=remoteIPAddress, wirelessLinkStatus=wirelessLinkStatus, telecom=telecom, telnetAccessEnabled=telnetAccessEnabled, dataPortAutoMdix=dataPortAutoMdix, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, receiveDataRate=receiveDataRate, syslogClient=syslogClient, userEnabled=userEnabled, phyStatus=phyStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userTableNumber=userTableNumber, dfsGroup=dfsGroup, systemReset=systemReset, userRole=userRole, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatusTrap=dataPortStatusTrap, ptpGroups=ptpGroups, vLANPriorityTable=vLANPriorityTable, sMTPEnabledMessages=sMTPEnabledMessages, hTTPAccessEnabled=hTTPAccessEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsInterface=telecomsInterface, sNTPPollInterval=sNTPPollInterval, altitude=altitude, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, tDDControl=tDDControl, aAAControlGroup=aAAControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogControl=syslogControl, hardwareVersion=hardwareVersion, sntpGroup=sntpGroup, receiveFreqMHz=receiveFreqMHz, bootVersion=bootVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, vectorError=vectorError, sNMPTrapPortNumber=sNMPTrapPortNumber, pubStats=pubStats, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityTableNumber=vLANPriorityTableNumber, cambium=cambium, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsCableLength=telecomsCableLength, linkSymmetry=linkSymmetry, smtp=smtp, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp500=ptp500, byteErrorRatio=byteErrorRatio, productName=productName, channelBandwidth=channelBandwidth, installStatusTrap=installStatusTrap, ptp=ptp, transmitDataRate=transmitDataRate, userName=userName, sNMPv3Enable=sNMPv3Enable, transmitModulationMode=transmitModulationMode, unitOutOfCalibration=unitOutOfCalibration, antennaGain=antennaGain, sNTPState=sNTPState, licensedCapacity=licensedCapacity, regionCodeTrap=regionCodeTrap, ptpTraps=ptpTraps, alarms=alarms, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installArmState=installArmState, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyControl=phyControl, encryption=encryption, installStatus=installStatus, longitude=longitude, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsPeaks=dfsPeaks, dfsTableEntry=dfsTableEntry, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, receiveChannel=receiveChannel, sNTPLastSync=sNTPLastSync, dfs=dfs, capacityLicenseMismatch=capacityLicenseMismatch, supplementary=supplementary, sntp=sntp, telecomsChannelStatus=telecomsChannelStatus, sNMPPortNumber=sNMPPortNumber, resetGroup=resetGroup, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapVersion=sNMPTrapVersion, timeZone=timeZone, daylightSaving=daylightSaving, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelChangeTrap=channelChangeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortDisabledWarning=dataPortDisabledWarning, constantPowerSpectralDensity=constantPowerSpectralDensity, aggregateDataRate=aggregateDataRate, versionsGroup=versionsGroup, dfsTable=dfsTable, encryptionAlgorithm=encryptionAlgorithm, receiveFreqKHz=receiveFreqKHz, encryptionGroup=encryptionGroup, searchState=searchState, userTable=userTable, sNMPTrapTableEntry=sNMPTrapTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, productVariant=productVariant, phyStatusGroup=phyStatusGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpCompliance=ptpCompliance, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aAAControl=aAAControl, linkName=linkName, syslogState=syslogState, syslogControlGroup=syslogControlGroup, dfsTableNumber=dfsTableNumber, dfsMeans=dfsMeans, telnetPortNumber=telnetPortNumber, transmitFreqKHz=transmitFreqKHz, tDDControlGroup=tDDControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, regionCode=regionCode, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, licenceGroup=licenceGroup, groupID=groupID, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, subnetMask=subnetMask, versions=versions, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitPower=transmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, accessMethod=accessMethod, telecomsChannelStatusTrap=telecomsChannelStatusTrap)
