...
iso, ObjectIdentity, Integer32, Bits, NotificationType, ModuleIdentity, TimeTicks, Counter64, Gauge32, enterprises, IpAddress, Counter32, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Integer32", "Bits", "NotificationType", "ModuleIdentity", "TimeTicks", "Counter64", "Gauge32", "enterprises", "IpAddress", "Counter32", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", encryption=encryption, dfsTableEntry=dfsTableEntry, searchState=searchState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogClient=syslogClient, telecomsLoopbackTrap=telecomsLoopbackTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, daylightSaving=daylightSaving, supplementaryGroup=supplementaryGroup, productVariant=productVariant, telnetPortNumber=telnetPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, notificationsGroup=notificationsGroup, gatewayIPAddress=gatewayIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, secondarySoftwareVersion=secondarySoftwareVersion, receiveModulationMode=receiveModulationMode, ptmp=ptmp, supplementary=supplementary, frequencyVariant=frequencyVariant, sNTPSyncTrap=sNTPSyncTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, range=range, telecomsInterface=telecomsInterface, dfsPeaks=dfsPeaks, sNMPv3Enable=sNMPv3Enable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleRegionCodes=incompatibleRegionCodes, siteName=siteName, vLANPriorityTableNumber=vLANPriorityTableNumber, encryptionGroup=encryptionGroup, telecomsLoopback=telecomsLoopback, smtpGroup=smtpGroup, receivePower=receivePower, userPassword=userPassword, regionCodeTrap=regionCodeTrap, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, userName=userName, systemClock=systemClock, installArmStateTrap=installArmStateTrap, transmitFreqMHz=transmitFreqMHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maximumTransmitPower=maximumTransmitPower, userRole=userRole, sNMPCommunityString=sNMPCommunityString, sNTPSync=sNTPSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, subnetMask=subnetMask, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTable=vLANPriorityTable, eIRP=eIRP, installStatus=installStatus, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPPortNumber=hTTPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, userTable=userTable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntpGroup=sntpGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, pubStats=pubStats, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPSPortNumber=hTTPSPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, licenceGroup=licenceGroup, telecomsChannelStatus=telecomsChannelStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, resetGroup=resetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveChannel=receiveChannel, sNMPPortNumber=sNMPPortNumber, signalStrengthRatio=signalStrengthRatio, receiveFreqKHz=receiveFreqKHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANManagementPriority=vLANManagementPriority, linkLoss=linkLoss, syslogStateTrap=syslogStateTrap, syslogControl=syslogControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, latitude=latitude, syslogControlGroup=syslogControlGroup, telecom=telecom, telecomsCableLength=telecomsCableLength, versions=versions, transmitDataRate=transmitDataRate, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatusTrap=installStatusTrap, dfsMeans=dfsMeans, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDControl=tDDControl, ethernetGroup=ethernetGroup, linkSymmetry=linkSymmetry, transmitPower=transmitPower, iPAddress=iPAddress, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEmailAlert=sMTPEmailAlert, sNTPState=sNTPState, ptp=ptp, sNMPTrapTable=sNMPTrapTable, systemReset=systemReset, snmpControl=snmpControl, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, constantPowerSpectralDensity=constantPowerSpectralDensity, groupID=groupID, transmitFreqKHz=transmitFreqKHz, aAAControl=aAAControl, remoteIPAddress=remoteIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, regionCode=regionCode, dfsTableNumber=dfsTableNumber, licensedCapacity=licensedCapacity, licence=licence, PYSNMP_MODULE_ID=cambium, sMTPServerPortNumber=sMTPServerPortNumber, dfs=dfs, telecomGroup=telecomGroup, bootVersion=bootVersion, syslogState=syslogState, versionsGroup=versionsGroup, sntp=sntp, linkName=linkName, dataPortStatus=dataPortStatus, ethernet=ethernet, tDDControlGroup=tDDControlGroup, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapVersion=sNMPTrapVersion, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpTraps=ptpTraps, softwareVersion=softwareVersion, cambium=cambium, transmitChannel=transmitChannel, sNTPServerPortNumber=sNTPServerPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsGroup=dfsGroup, masterSlaveMode=masterSlaveMode, phyStatusGroup=phyStatusGroup, aAAControlGroup=aAAControlGroup, ethernetFiberSupport=ethernetFiberSupport, dfsTable=dfsTable, targetMACAddress=targetMACAddress, installArmState=installArmState, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveFreqMHz=receiveFreqMHz, ptp500=ptp500, receiveModulationModeDetail=receiveModulationModeDetail, phyControl=phyControl, channelChangeTrap=channelChangeTrap, alarms=alarms, smtp=smtp, sMTPEnabledMessages=sMTPEnabledMessages, syslogClientTrap=syslogClientTrap, cableLoss=cableLoss, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, sNTPLastSync=sNTPLastSync, sMTPServerIPAddress=sMTPServerIPAddress, vLANManagementVID=vLANManagementVID, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, longitude=longitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTableIndex=userTableIndex, aggregateDataRate=aggregateDataRate, userTableNumber=userTableNumber, phyControlGroup=phyControlGroup, managementGroup=managementGroup, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, altitude=altitude, vectorError=vectorError, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userEnabled=userEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, management=management, capacityLicenseMismatch=capacityLicenseMismatch, sNTPPollInterval=sNTPPollInterval, hardwareVersion=hardwareVersion, bandwidthVariant=bandwidthVariant, snmpControlGroup=snmpControlGroup, reset=reset, configuration=configuration, telnetAccessEnabled=telnetAccessEnabled, accessMethod=accessMethod, byteErrorRatio=byteErrorRatio, dfsTableIndex=dfsTableIndex, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsLineCode=telecomsLineCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelBandwidth=channelBandwidth, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimisation=linkModeOptimisation, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, ptpGroups=ptpGroups)
