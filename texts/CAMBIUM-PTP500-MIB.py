...
enterprises, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, NotificationType, IpAddress, Integer32, Counter64, MibIdentifier, ModuleIdentity, iso, ObjectIdentity, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "NotificationType", "IpAddress", "Integer32", "Counter64", "MibIdentifier", "ModuleIdentity", "iso", "ObjectIdentity", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogControl=syslogControl, transmitModulationMode=transmitModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vectorError=vectorError, sNMPTrapVersion=sNMPTrapVersion, management=management, systemClock=systemClock, vLANManagementPriority=vLANManagementPriority, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableIndex=userTableIndex, cableLoss=cableLoss, aAAControl=aAAControl, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryption=encryption, telecomsLineCode=telecomsLineCode, incompatibleRegionCodes=incompatibleRegionCodes, cambium=cambium, bootVersion=bootVersion, transmitFreqMHz=transmitFreqMHz, syslogControlGroup=syslogControlGroup, syslogClientTrap=syslogClientTrap, notificationsGroup=notificationsGroup, byteErrorRatio=byteErrorRatio, dfsTable=dfsTable, eIRP=eIRP, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveChannel=receiveChannel, sNTPLastSync=sNTPLastSync, telnetPortNumber=telnetPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryptionGroup=encryptionGroup, telecomsLoopback=telecomsLoopback, softwareVersion=softwareVersion, hTTPSPortNumber=hTTPSPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptmp=ptmp, regionCode=regionCode, dfsTableEntry=dfsTableEntry, alarmsGroup=alarmsGroup, ethernetGroup=ethernetGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, masterSlaveMode=masterSlaveMode, telecomsCableLength=telecomsCableLength, sMTPServerIPAddress=sMTPServerIPAddress, linkLoss=linkLoss, userTable=userTable, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, PYSNMP_MODULE_ID=cambium, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationMode=tDDSynchronizationMode, sNMPCommunityString=sNMPCommunityString, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteIPAddress=remoteIPAddress, daylightSaving=daylightSaving, reset=reset, userPassword=userPassword, userTableNumber=userTableNumber, telecom=telecom, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibration=unitOutOfCalibration, hTTPAccessEnabled=hTTPAccessEnabled, tDDControlGroup=tDDControlGroup, managementGroup=managementGroup, telecomGroup=telecomGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, subnetMask=subnetMask, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, smtpGroup=smtpGroup, dfsGroup=dfsGroup, alarms=alarms, telecomsInterface=telecomsInterface, transmitFreqKHz=transmitFreqKHz, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogStateTrap=syslogStateTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, ethernetFiberSupport=ethernetFiberSupport, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkSymmetry=linkSymmetry, installStatus=installStatus, timeZone=timeZone, sNMPPortNumber=sNMPPortNumber, targetMACAddress=targetMACAddress, aAAControlGroup=aAAControlGroup, sNMPTrapTable=sNMPTrapTable, userRole=userRole, userEnabled=userEnabled, range=range, sNMPTrapPortNumber=sNMPTrapPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, phyStatus=phyStatus, installArmStateTrap=installArmStateTrap, antennaGain=antennaGain, syslogState=syslogState, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPSync=sNTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, bandwidthVariant=bandwidthVariant, pubStats=pubStats, ptpCompliance=ptpCompliance, userTableEntry=userTableEntry, ptp500=ptp500, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, configurationGroup=configurationGroup, dfsPeaks=dfsPeaks, dataPortStatus=dataPortStatus, telnetAccessEnabled=telnetAccessEnabled, productName=productName, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState, licence=licence, aggregateDataRate=aggregateDataRate, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableNumber=dfsTableNumber, accessMethod=accessMethod, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, searchState=searchState, licensedCapacity=licensedCapacity, sNTPSyncTrap=sNTPSyncTrap, pubStatsGroup=pubStatsGroup, latitude=latitude, smtp=smtp, vLANManagementVID=vLANManagementVID, supplementary=supplementary, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemReset=systemReset, hTTPSAccessEnabled=hTTPSAccessEnabled, resetGroup=resetGroup, vLANPriorityTable=vLANPriorityTable, channelChangeTrap=channelChangeTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versions=versions, licenceGroup=licenceGroup, dfsMeans=dfsMeans, telecomsChannelStatus=telecomsChannelStatus, linkName=linkName, groupID=groupID, transmitChannel=transmitChannel, altitude=altitude, frequencyVariant=frequencyVariant, tDDControl=tDDControl, regionCodeTrap=regionCodeTrap, iPAddress=iPAddress, phyControl=phyControl, ethernet=ethernet, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPPollInterval=sNTPPollInterval, hTTPPortNumber=hTTPPortNumber, dfsTableIndex=dfsTableIndex, supplementaryGroup=supplementaryGroup, snmpControlGroup=snmpControlGroup, dfs=dfs, siteName=siteName, vLANPriorityQueueMapping=vLANPriorityQueueMapping, installStatusTrap=installStatusTrap, phyStatusGroup=phyStatusGroup, sntpGroup=sntpGroup, channelBandwidth=channelBandwidth, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptp=ptp, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPState=sNTPState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, productVariant=productVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, encryptionAlgorithm=encryptionAlgorithm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, ptpGroups=ptpGroups, transmitDataRate=transmitDataRate, receiveFreqMHz=receiveFreqMHz, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, transmitPower=transmitPower, phyControlGroup=phyControlGroup, sNMPv3Enable=sNMPv3Enable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortDisabledWarning=dataPortDisabledWarning, longitude=longitude, dataPortStatusTrap=dataPortStatusTrap, receiveFreqKHz=receiveFreqKHz, sNTPServerIPAddress=sNTPServerIPAddress, sntp=sntp, snmpControl=snmpControl, linkModeOptimisation=linkModeOptimisation, configuration=configuration, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap)
