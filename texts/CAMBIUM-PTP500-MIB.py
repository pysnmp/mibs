...
ObjectIdentity, MibIdentifier, enterprises, Integer32, Bits, Gauge32, Counter64, Unsigned32, IpAddress, Counter32, NotificationType, iso, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "enterprises", "Integer32", "Bits", "Gauge32", "Counter64", "Unsigned32", "IpAddress", "Counter32", "NotificationType", "iso", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ethernetGroup=ethernetGroup, management=management, syslogState=syslogState, smtp=smtp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, signalStrengthRatio=signalStrengthRatio, aAAControl=aAAControl, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClientTrap=syslogClientTrap, pubStatsGroup=pubStatsGroup, encryption=encryption, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productVariant=productVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsInterface=telecomsInterface, installArmState=installArmState, pubStats=pubStats, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogControlGroup=syslogControlGroup, dataPortAutoMdix=dataPortAutoMdix, sNTPServerPortNumber=sNTPServerPortNumber, smtpGroup=smtpGroup, telecomsLineCode=telecomsLineCode, telecomsLoopback=telecomsLoopback, userRole=userRole, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, subnetMask=subnetMask, ethernet=ethernet, receiveFreqMHz=receiveFreqMHz, frequencyVariant=frequencyVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, userEnabled=userEnabled, installStatus=installStatus, accessMethod=accessMethod, tFTPServerIPAddress=tFTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsMeans=dfsMeans, phyStatus=phyStatus, productName=productName, telecomsCableLength=telecomsCableLength, sMTPEmailAlert=sMTPEmailAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTableNumber=userTableNumber, dataPortStatus=dataPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, systemReset=systemReset, ethernetFiberSupport=ethernetFiberSupport, vLANManagementPriority=vLANManagementPriority, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, timeZone=timeZone, dfsTableIndex=dfsTableIndex, latitude=latitude, sMTPServerPortNumber=sMTPServerPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPEnabledTraps=sNMPEnabledTraps, linkSymmetry=linkSymmetry, telecom=telecom, targetMACAddress=targetMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licensedCapacity=licensedCapacity, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, versions=versions, supplementary=supplementary, dfs=dfs, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPv3Enable=sNMPv3Enable, dataPortDisabledWarning=dataPortDisabledWarning, linkModeOptimisation=linkModeOptimisation, cableLoss=cableLoss, iPAddress=iPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, bandwidthVariant=bandwidthVariant, sMTPServerIPAddress=sMTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPState=sNTPState, licence=licence, channelChangeTrap=channelChangeTrap, ptmp=ptmp, PYSNMP_MODULE_ID=cambium, ptpCompliance=ptpCompliance, ptp500=ptp500, incompatibleRegionCodes=incompatibleRegionCodes, transmitPower=transmitPower, sNTPSyncTrap=sNTPSyncTrap, syslogClient=syslogClient, gatewayIPAddress=gatewayIPAddress, hardwareVersion=hardwareVersion, transmitFreqKHz=transmitFreqKHz, channelBandwidth=channelBandwidth, transmitDataRate=transmitDataRate, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, versionsGroup=versionsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableIndex=userTableIndex, siteName=siteName, cambium=cambium, receiveDataRate=receiveDataRate, phyControl=phyControl, userName=userName, telnetAccessEnabled=telnetAccessEnabled, sNTPPollInterval=sNTPPollInterval, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomGroup=telecomGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPPortNumber=sNMPPortNumber, remoteIPAddress=remoteIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableEntry=dfsTableEntry, phyStatusGroup=phyStatusGroup, masterSlaveMode=masterSlaveMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerPortNumber=tFTPServerPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkStatus=wirelessLinkStatus, bootVersion=bootVersion, phyControlGroup=phyControlGroup, configurationGroup=configurationGroup, userTable=userTable, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveChannel=receiveChannel, receiveFreqKHz=receiveFreqKHz, daylightSaving=daylightSaving, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDControlGroup=tDDControlGroup, softwareVersion=softwareVersion, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, antennaGain=antennaGain, userPassword=userPassword, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, sNTPSync=sNTPSync, systemClock=systemClock, installArmStateTrap=installArmStateTrap, telnetPortNumber=telnetPortNumber, resetGroup=resetGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, managementGroup=managementGroup, hTTPSPortNumber=hTTPSPortNumber, receiveModulationMode=receiveModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, altitude=altitude, telecomsChannelStatus=telecomsChannelStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTable=sNMPTrapTable, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitFreqMHz=transmitFreqMHz, dataPortStatusTrap=dataPortStatusTrap, transmitChannel=transmitChannel, byteErrorRatio=byteErrorRatio, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secondarySoftwareVersion=secondarySoftwareVersion, syslogControl=syslogControl, tDDControl=tDDControl, dfsPeaks=dfsPeaks, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, regionCode=regionCode, aggregateDataRate=aggregateDataRate, licenceGroup=licenceGroup, encryptionAlgorithm=encryptionAlgorithm, configuration=configuration, vLANPriorityTableNumber=vLANPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkName=linkName, sNMPCommunityString=sNMPCommunityString, ptp=ptp, dfsGroup=dfsGroup, vectorError=vectorError, syslogStateTrap=syslogStateTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, searchState=searchState, linkLoss=linkLoss, dfsTableNumber=dfsTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, unitOutOfCalibration=unitOutOfCalibration, supplementaryGroup=supplementaryGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, range=range, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarms=alarms, alarmsGroup=alarmsGroup, aAAControlGroup=aAAControlGroup, ptpGroups=ptpGroups, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableEntry=userTableEntry, groupID=groupID, sntp=sntp, eIRP=eIRP, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, encryptionGroup=encryptionGroup, capacityLicenseMismatch=capacityLicenseMismatch, installStatusTrap=installStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, longitude=longitude, snmpControl=snmpControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTable=vLANPriorityTable, reset=reset, dfsTable=dfsTable, sNMPTrapTableNumber=sNMPTrapTableNumber, sntpGroup=sntpGroup)
