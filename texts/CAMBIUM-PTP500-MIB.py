...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:24:40 2021
...
NotificationType, Bits, Unsigned32, Integer32, enterprises, MibIdentifier, ObjectIdentity, iso, Counter32, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Unsigned32", "Integer32", "enterprises", "MibIdentifier", "ObjectIdentity", "iso", "Counter32", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", resetGroup=resetGroup, hardwareVersion=hardwareVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptpGroups=ptpGroups, telecomsChannelStatus=telecomsChannelStatus, linkName=linkName, management=management, vLANManagementPriority=vLANManagementPriority, productVariant=productVariant, regionCodeTrap=regionCodeTrap, userPassword=userPassword, phyStatus=phyStatus, tDDControl=tDDControl, productName=productName, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, pubStatsGroup=pubStatsGroup, encryption=encryption, daylightSaving=daylightSaving, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, bootVersion=bootVersion, remoteIPAddress=remoteIPAddress, timeZone=timeZone, frequencyVariant=frequencyVariant, secondarySoftwareVersion=secondarySoftwareVersion, vLANManagementVID=vLANManagementVID, managementGroup=managementGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, softwareVersion=softwareVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSync=sNTPSync, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTable=userTable, ptp500=ptp500, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsMeans=dfsMeans, antennaGain=antennaGain, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityTableEntry=vLANPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarmsGroup=alarmsGroup, userTableEntry=userTableEntry, dfsTableIndex=dfsTableIndex, linkLoss=linkLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, syslogClientTrap=syslogClientTrap, maximumTransmitPower=maximumTransmitPower, cambium=cambium, hTTPSPortNumber=hTTPSPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, altitude=altitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleRegionCodes=incompatibleRegionCodes, dfs=dfs, iPAddress=iPAddress, ptmp=ptmp, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogControl=syslogControl, alarms=alarms, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, channelChangeTrap=channelChangeTrap, telecomsLoopback=telecomsLoopback, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPEnabledMessages=sMTPEnabledMessages, encryptionGroup=encryptionGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, configurationGroup=configurationGroup, dfsTableNumber=dfsTableNumber, siteName=siteName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTable=sNMPTrapTable, vLANPriorityTable=vLANPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANPriorityTableIndex=vLANPriorityTableIndex, licensedCapacity=licensedCapacity, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, dfsGroup=dfsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, linkModeOptimisation=linkModeOptimisation, licence=licence, dfsTable=dfsTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitModulationMode=transmitModulationMode, ptpTraps=ptpTraps, pubStats=pubStats, longitude=longitude, installStatusTrap=installStatusTrap, telecomsInterface=telecomsInterface, phyControl=phyControl, configuration=configuration, transmitChannel=transmitChannel, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernet=ethernet, smtp=smtp, cableLoss=cableLoss, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telnetAccessEnabled=telnetAccessEnabled, receivePower=receivePower, transmitPower=transmitPower, ptp=ptp, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitFreqKHz=transmitFreqKHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, subnetMask=subnetMask, phyControlGroup=phyControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, bandwidthVariant=bandwidthVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userName=userName, ethernetGroup=ethernetGroup, telecomGroup=telecomGroup, sNTPSyncTrap=sNTPSyncTrap, dfsPeaks=dfsPeaks, supplementary=supplementary, phyStatusGroup=phyStatusGroup, userEnabled=userEnabled, syslogControlGroup=syslogControlGroup, reset=reset, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsLineCode=telecomsLineCode, accessMethod=accessMethod, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, snmpControlGroup=snmpControlGroup, latitude=latitude, groupID=groupID, systemClock=systemClock, linkSymmetry=linkSymmetry, userTableIndex=userTableIndex, unitOutOfCalibration=unitOutOfCalibration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, sNMPPortNumber=sNMPPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarning=dataPortDisabledWarning, channelBandwidth=channelBandwidth, installArmStateTrap=installArmStateTrap, receiveModulationModeDetail=receiveModulationModeDetail, receiveChannel=receiveChannel, licenceGroup=licenceGroup, receiveFreqMHz=receiveFreqMHz, syslogStateTrap=syslogStateTrap, sNTPLastSync=sNTPLastSync, notificationsGroup=notificationsGroup, receiveFreqKHz=receiveFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogState=syslogState, sntp=sntp, ethernetFiberSupport=ethernetFiberSupport, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, smtpGroup=smtpGroup, hTTPAccessEnabled=hTTPAccessEnabled, telecomsLoopbackTrap=telecomsLoopbackTrap, masterSlaveMode=masterSlaveMode, eIRP=eIRP, telnetPortNumber=telnetPortNumber, installStatus=installStatus, tDDControlGroup=tDDControlGroup, installArmState=installArmState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveModulationMode=receiveModulationMode, capacityLicenseMismatch=capacityLicenseMismatch, aggregateDataRate=aggregateDataRate, userTableNumber=userTableNumber, sNTPState=sNTPState, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPv3Enable=sNMPv3Enable, hTTPPortNumber=hTTPPortNumber, transmitFreqMHz=transmitFreqMHz, systemReset=systemReset, dfsTableEntry=dfsTableEntry, gatewayIPAddress=gatewayIPAddress, syslogClient=syslogClient, ptpCompliance=ptpCompliance, telecomsCableLength=telecomsCableLength, sNTPPollInterval=sNTPPollInterval, PYSNMP_MODULE_ID=cambium, aAAControlGroup=aAAControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, range=range, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableNumber=sNMPTrapTableNumber, sntpGroup=sntpGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vectorError=vectorError, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatus=wirelessLinkStatus, searchState=searchState, aAAControl=aAAControl, supplementaryGroup=supplementaryGroup, byteErrorRatio=byteErrorRatio, versions=versions, versionsGroup=versionsGroup, regionCode=regionCode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionAlgorithm=encryptionAlgorithm, telecom=telecom, targetMACAddress=targetMACAddress, sMTPEmailAlert=sMTPEmailAlert, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapPortNumber=sNMPTrapPortNumber, userRole=userRole)
