...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, Counter64, Counter32, iso, ObjectIdentity, enterprises, Gauge32, Bits, ModuleIdentity, IpAddress, TimeTicks, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "Counter64", "Counter32", "iso", "ObjectIdentity", "enterprises", "Gauge32", "Bits", "ModuleIdentity", "IpAddress", "TimeTicks", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", pubStats=pubStats, vLANPriorityTable=vLANPriorityTable, phyStatus=phyStatus, vectorError=vectorError, phyStatusGroup=phyStatusGroup, targetMACAddress=targetMACAddress, versions=versions, sNMPEnabledTraps=sNMPEnabledTraps, supplementary=supplementary, receiveFreqMHz=receiveFreqMHz, byteErrorRatio=byteErrorRatio, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkAvailability=wirelessLinkAvailability, userTableIndex=userTableIndex, bandwidthVariant=bandwidthVariant, dfsTableEntry=dfsTableEntry, ethernetFiberSupport=ethernetFiberSupport, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveModulationModeDetail=receiveModulationModeDetail, ptp500=ptp500, syslogClient=syslogClient, ptpTrapPrefix=ptpTrapPrefix, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, userTable=userTable, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkStatus=wirelessLinkStatus, dfs=dfs, vLANPriorityTableIndex=vLANPriorityTableIndex, installStatusTrap=installStatusTrap, timeZone=timeZone, daylightSaving=daylightSaving, syslogLocalWrappedTrap=syslogLocalWrappedTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsCableLength=telecomsCableLength, managementGroup=managementGroup, transmitModulationMode=transmitModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, sNTPState=sNTPState, snmpControl=snmpControl, productVariant=productVariant, linkName=linkName, userPassword=userPassword, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableNumber=dfsTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelBandwidth=channelBandwidth, transmitPower=transmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementaryGroup=supplementaryGroup, syslogClientTrap=syslogClientTrap, cableLoss=cableLoss, dataPortStatus=dataPortStatus, notificationsGroup=notificationsGroup, telecomsInterface=telecomsInterface, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsLineCode=telecomsLineCode, constantPowerSpectralDensity=constantPowerSpectralDensity, smtp=smtp, bootVersion=bootVersion, receiveFreqKHz=receiveFreqKHz, dfsPeaks=dfsPeaks, linkModeOptimisation=linkModeOptimisation, maximumTransmitPower=maximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqMHz=transmitFreqMHz, sMTPServerIPAddress=sMTPServerIPAddress, range=range, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, vLANPriorityTableNumber=vLANPriorityTableNumber, encryption=encryption, userEnabled=userEnabled, ethernetGroup=ethernetGroup, telecom=telecom, snmpControlGroup=snmpControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomGroup=telecomGroup, installArmState=installArmState, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveModulationMode=receiveModulationMode, resetGroup=resetGroup, telecomsChannelStatus=telecomsChannelStatus, antennaGain=antennaGain, aggregateDataRate=aggregateDataRate, cambium=cambium, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptmp=ptmp, configuration=configuration, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPPortNumber=hTTPPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, licenceGroup=licenceGroup, dfsGroup=dfsGroup, encryptionGroup=encryptionGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, telnetAccessEnabled=telnetAccessEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, configurationGroup=configurationGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, regionCode=regionCode, syslogControlGroup=syslogControlGroup, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, signalStrengthRatio=signalStrengthRatio, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userRole=userRole, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarning=dataPortDisabledWarning, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, alarmsGroup=alarmsGroup, iPAddress=iPAddress, groupID=groupID, licensedCapacity=licensedCapacity, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, aAAControlGroup=aAAControlGroup, searchState=searchState, linkLoss=linkLoss, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPv3Enable=sNMPv3Enable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortAutoMdix=dataPortAutoMdix, phyControl=phyControl, sNMPTrapTable=sNMPTrapTable, siteName=siteName, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, eIRP=eIRP, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkSymmetry=linkSymmetry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDControl=tDDControl, dfsMeans=dfsMeans, phyControlGroup=phyControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, systemReset=systemReset, receiveChannel=receiveChannel, alarms=alarms, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementPriority=vLANManagementPriority, ptpCompliance=ptpCompliance, secondarySoftwareVersion=secondarySoftwareVersion, dfsTable=dfsTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, PYSNMP_MODULE_ID=cambium, userTableEntry=userTableEntry, subnetMask=subnetMask, versionsGroup=versionsGroup, tDDControlGroup=tDDControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStatsGroup=pubStatsGroup, transmitChannel=transmitChannel, sNTPSync=sNTPSync, altitude=altitude, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveDataRate=receiveDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableNumber=userTableNumber, aAAControl=aAAControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp=ptp, sntpGroup=sntpGroup, installStatus=installStatus, smtpGroup=smtpGroup, tFTPServerPortNumber=tFTPServerPortNumber, management=management, ethernet=ethernet, telnetPortNumber=telnetPortNumber, frequencyVariant=frequencyVariant, sNTPPollInterval=sNTPPollInterval, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, softwareVersion=softwareVersion, syslogStateTrap=syslogStateTrap, regionCodeTrap=regionCodeTrap, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibration=unitOutOfCalibration, sntp=sntp, reset=reset, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPEmailAlert=sMTPEmailAlert, systemClock=systemClock, accessMethod=accessMethod, productName=productName, sNMPPortNumber=sNMPPortNumber, vLANManagementVID=vLANManagementVID, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPEnabledMessages=sMTPEnabledMessages, transmitFreqKHz=transmitFreqKHz, remoteIPAddress=remoteIPAddress, syslogControl=syslogControl, ptpGroups=ptpGroups, syslogState=syslogState, latitude=latitude, telecomsLoopback=telecomsLoopback, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelChangeTrap=channelChangeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receivePower=receivePower, hTTPSPortNumber=hTTPSPortNumber, longitude=longitude, sNTPSyncTrap=sNTPSyncTrap, licence=licence, capacityLicenseMismatch=capacityLicenseMismatch)
