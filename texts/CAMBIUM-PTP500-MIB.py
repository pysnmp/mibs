...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:12:09 2021
...
TimeTicks, Counter64, ModuleIdentity, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, iso, Counter32, Unsigned32, enterprises, IpAddress, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "ModuleIdentity", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "iso", "Counter32", "Unsigned32", "enterprises", "IpAddress", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsTableIndex=dfsTableIndex, longitude=longitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkModeOptimisation=linkModeOptimisation, snmpControl=snmpControl, frequencyVariant=frequencyVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveModulationModeDetail=receiveModulationModeDetail, productName=productName, licenceGroup=licenceGroup, ptpTrapPrefix=ptpTrapPrefix, vectorError=vectorError, hTTPPortNumber=hTTPPortNumber, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aAAControlGroup=aAAControlGroup, userName=userName, dfs=dfs, sNMPTrapVersion=sNMPTrapVersion, managementGroup=managementGroup, encryptionAlgorithm=encryptionAlgorithm, transmitDataRate=transmitDataRate, sMTPServerPortNumber=sMTPServerPortNumber, phyStatusGroup=phyStatusGroup, siteName=siteName, linkSymmetry=linkSymmetry, sNMPEnabledTraps=sNMPEnabledTraps, regionCodeTrap=regionCodeTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, alarms=alarms, reset=reset, encryptionGroup=encryptionGroup, dfsTableNumber=dfsTableNumber, telecomsLoopback=telecomsLoopback, sNMPPortNumber=sNMPPortNumber, dataPortStatusTrap=dataPortStatusTrap, ptp=ptp, ethernet=ethernet, syslogClient=syslogClient, pubStats=pubStats, configurationGroup=configurationGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, ptmp=ptmp, supplementaryGroup=supplementaryGroup, latitude=latitude, management=management, byteErrorRatio=byteErrorRatio, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsChannelStatus=telecomsChannelStatus, versionsGroup=versionsGroup, tDDControlGroup=tDDControlGroup, systemClock=systemClock, installStatus=installStatus, secondarySoftwareVersion=secondarySoftwareVersion, pubStatsGroup=pubStatsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, targetMACAddress=targetMACAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerIPAddress=sNTPServerIPAddress, daylightSaving=daylightSaving, enabledDiagnosticAlarms=enabledDiagnosticAlarms, bootVersion=bootVersion, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkStatus=wirelessLinkStatus, systemReset=systemReset, receiveModulationMode=receiveModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableNumber=userTableNumber, productVariant=productVariant, cambium=cambium, aAAControl=aAAControl, timeZone=timeZone, PYSNMP_MODULE_ID=cambium, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogStateTrap=syslogStateTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableEntry=userTableEntry, receiveFreqKHz=receiveFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, range=range, altitude=altitude, regionCode=regionCode, sNMPv3Enable=sNMPv3Enable, accessMethod=accessMethod, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableEntry=dfsTableEntry, phyControl=phyControl, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodes=incompatibleRegionCodes, userTable=userTable, installArmStateTrap=installArmStateTrap, notificationsGroup=notificationsGroup, receiveDataRate=receiveDataRate, userEnabled=userEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsMeans=dfsMeans, transmitFreqMHz=transmitFreqMHz, masterSlaveMode=masterSlaveMode, telecom=telecom, vLANPriorityQueueMapping=vLANPriorityQueueMapping, hardwareVersion=hardwareVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDControl=tDDControl, licensedCapacity=licensedCapacity, installArmState=installArmState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsInterface=telecomsInterface, sNTPSync=sNTPSync, aggregateDataRate=aggregateDataRate, smtp=smtp, snmpControlGroup=snmpControlGroup, sNTPState=sNTPState, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, installStatusTrap=installStatusTrap, gatewayIPAddress=gatewayIPAddress, maximumTransmitPower=maximumTransmitPower, constantPowerSpectralDensity=constantPowerSpectralDensity, antennaGain=antennaGain, smtpGroup=smtpGroup, sMTPEmailAlert=sMTPEmailAlert, ethernetGroup=ethernetGroup, userRole=userRole, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telnetAccessEnabled=telnetAccessEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkLoss=linkLoss, ptp500=ptp500, licence=licence, signalStrengthRatio=signalStrengthRatio, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitPower=transmitPower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableLoss=cableLoss, syslogControl=syslogControl, ptpGroups=ptpGroups, channelChangeTrap=channelChangeTrap, syslogControlGroup=syslogControlGroup, linkName=linkName, hTTPSPortNumber=hTTPSPortNumber, alarmsGroup=alarmsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, groupID=groupID, sNMPTrapPortNumber=sNMPTrapPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTable=dfsTable, vLANManagementVID=vLANManagementVID, receiveChannel=receiveChannel, dfsGroup=dfsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANPriorityTableNumber=vLANPriorityTableNumber, sntpGroup=sntpGroup, wirelessLinkAvailability=wirelessLinkAvailability, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBandwidth=channelBandwidth, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementPriority=vLANManagementPriority, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogState=syslogState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPAccessEnabled=hTTPAccessEnabled, syslogClientTrap=syslogClientTrap, sNMPTrapTable=sNMPTrapTable, dataPortAutoMdix=dataPortAutoMdix, iPAddress=iPAddress, sNMPCommunityString=sNMPCommunityString, userTableIndex=userTableIndex, configuration=configuration, phyStatus=phyStatus, resetGroup=resetGroup, transmitModulationMode=transmitModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, subnetMask=subnetMask, eIRP=eIRP, receivePower=receivePower, sntp=sntp, telnetPortNumber=telnetPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomGroup=telecomGroup, supplementary=supplementary, telecomsCableLength=telecomsCableLength, softwareVersion=softwareVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitFreqKHz=transmitFreqKHz, versions=versions, encryption=encryption, dfsPeaks=dfsPeaks, telecomsLineCode=telecomsLineCode, tFTPServerPortNumber=tFTPServerPortNumber, phyControlGroup=phyControlGroup, bandwidthVariant=bandwidthVariant, ptpCompliance=ptpCompliance, ptpTraps=ptpTraps, sNTPPollInterval=sNTPPollInterval, transmitChannel=transmitChannel, searchState=searchState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortStatus=dataPortStatus, userPassword=userPassword, capacityLicenseMismatch=capacityLicenseMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTable=vLANPriorityTable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement)
