...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:00:27 2021
...
Bits, Integer32, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, ObjectIdentity, iso, Counter64, NotificationType, Counter32, enterprises, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "ObjectIdentity", "iso", "Counter64", "NotificationType", "Counter32", "enterprises", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", iPAddress=iPAddress, ptpGroups=ptpGroups, sNTPState=sNTPState, sNTPPollInterval=sNTPPollInterval, phyStatusGroup=phyStatusGroup, daylightSaving=daylightSaving, userTableIndex=userTableIndex, linkName=linkName, frequencyVariant=frequencyVariant, installStatus=installStatus, masterSlaveMode=masterSlaveMode, groupID=groupID, telecomsLoopback=telecomsLoopback, notificationsGroup=notificationsGroup, receivePower=receivePower, aAAControlGroup=aAAControlGroup, management=management, pubStats=pubStats, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, accessMethod=accessMethod, userPassword=userPassword, channelChangeTrap=channelChangeTrap, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, searchState=searchState, regionCodeTrap=regionCodeTrap, supplementaryGroup=supplementaryGroup, installStatusTrap=installStatusTrap, eIRP=eIRP, transmitChannel=transmitChannel, cableLoss=cableLoss, telecomsChannelStatus=telecomsChannelStatus, aggregateDataRate=aggregateDataRate, syslogClientTrap=syslogClientTrap, configurationGroup=configurationGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, telnetAccessEnabled=telnetAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, syslogStateTrap=syslogStateTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveModulationMode=receiveModulationMode, ethernet=ethernet, sNMPPortNumber=sNMPPortNumber, dfs=dfs, licensedCapacity=licensedCapacity, latitude=latitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSync=sNTPSync, userTableNumber=userTableNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, snmpControlGroup=snmpControlGroup, supplementary=supplementary, snmpControl=snmpControl, hardwareVersion=hardwareVersion, phyControl=phyControl, syslogControl=syslogControl, ptpTraps=ptpTraps, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, phyControlGroup=phyControlGroup, alarms=alarms, tDDSynchronizationMode=tDDSynchronizationMode, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, managementGroup=managementGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, vectorError=vectorError, tDDControl=tDDControl, dfsTableIndex=dfsTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpCompliance=ptpCompliance, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userEnabled=userEnabled, dfsGroup=dfsGroup, regionCode=regionCode, bandwidthVariant=bandwidthVariant, dataPortDisabledWarning=dataPortDisabledWarning, userRole=userRole, dataPortStatus=dataPortStatus, bootVersion=bootVersion, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpTrapPrefix=ptpTrapPrefix, linkSymmetry=linkSymmetry, aAAControl=aAAControl, userName=userName, dfsTableEntry=dfsTableEntry, sMTPEmailAlert=sMTPEmailAlert, encryptionGroup=encryptionGroup, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, PYSNMP_MODULE_ID=cambium, longitude=longitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsMeans=dfsMeans, syslogState=syslogState, hTTPSAccessEnabled=hTTPSAccessEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, sMTPServerPortNumber=sMTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, softwareVersion=softwareVersion, receiveFreqKHz=receiveFreqKHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptmp=ptmp, telecomsInterface=telecomsInterface, receiveFreqMHz=receiveFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, systemReset=systemReset, telecom=telecom, smtp=smtp, resetGroup=resetGroup, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarmsGroup=alarmsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPv3Enable=sNMPv3Enable, ptp=ptp, syslogClient=syslogClient, sNMPTrapVersion=sNMPTrapVersion, tFTPServerIPAddress=tFTPServerIPAddress, tDDControlGroup=tDDControlGroup, maximumTransmitPower=maximumTransmitPower, telnetPortNumber=telnetPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, userTable=userTable, hTTPSPortNumber=hTTPSPortNumber, reset=reset, ethernetGroup=ethernetGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, targetMACAddress=targetMACAddress, sntpGroup=sntpGroup, licence=licence, productName=productName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitPower=transmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortAutoMdix=dataPortAutoMdix, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuration=configuration, telecomsLineCode=telecomsLineCode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPCommunityString=sNMPCommunityString, dfsTable=dfsTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveChannel=receiveChannel, userTableEntry=userTableEntry, telecomGroup=telecomGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, versionsGroup=versionsGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteIPAddress=remoteIPAddress, cambium=cambium, unitOutOfCalibration=unitOutOfCalibration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANManagementVID=vLANManagementVID, vLANPriorityTable=vLANPriorityTable, receiveDataRate=receiveDataRate, secondarySoftwareVersion=secondarySoftwareVersion, dfsPeaks=dfsPeaks, constantPowerSpectralDensity=constantPowerSpectralDensity, byteErrorRatio=byteErrorRatio, range=range, sNTPServerPortNumber=sNTPServerPortNumber, transmitModulationMode=transmitModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionAlgorithm=encryptionAlgorithm, altitude=altitude, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitFreqMHz=transmitFreqMHz, vLANPriorityTableEntry=vLANPriorityTableEntry, linkModeOptimisation=linkModeOptimisation, wirelessLinkStatus=wirelessLinkStatus, timeZone=timeZone, licenceGroup=licenceGroup, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, gatewayIPAddress=gatewayIPAddress, antennaGain=antennaGain, channelBandwidth=channelBandwidth, siteName=siteName, installArmState=installArmState, installArmStateTrap=installArmStateTrap, ptp500=ptp500, productVariant=productVariant, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkLoss=linkLoss, encryption=encryption, ethernetFiberSupport=ethernetFiberSupport, sNTPLastSync=sNTPLastSync, smtpGroup=smtpGroup, vLANManagementPriority=vLANManagementPriority)
