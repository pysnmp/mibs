...
ObjectIdentity, MibIdentifier, Counter32, Unsigned32, NotificationType, ModuleIdentity, IpAddress, Bits, iso, Counter64, Gauge32, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibIdentifier", "Counter32", "Unsigned32", "NotificationType", "ModuleIdentity", "IpAddress", "Bits", "iso", "Counter64", "Gauge32", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", gatewayIPAddress=gatewayIPAddress, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hardwareVersion=hardwareVersion, dfs=dfs, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, daylightSaving=daylightSaving, cableLoss=cableLoss, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, accessMethod=accessMethod, regionCode=regionCode, hTTPPortNumber=hTTPPortNumber, telnetAccessEnabled=telnetAccessEnabled, userTableEntry=userTableEntry, aggregateDataRate=aggregateDataRate, vLANPriorityTableNumber=vLANPriorityTableNumber, ptmp=ptmp, hTTPSPortNumber=hTTPSPortNumber, alarmsGroup=alarmsGroup, installArmStateTrap=installArmStateTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleRegionCodes=incompatibleRegionCodes, vectorError=vectorError, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, wirelessLinkStatus=wirelessLinkStatus, ptp500=ptp500, userTableNumber=userTableNumber, phyControlGroup=phyControlGroup, notificationsGroup=notificationsGroup, eIRP=eIRP, productVariant=productVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, encryptionGroup=encryptionGroup, receiveModulationMode=receiveModulationMode, sNMPCommunityString=sNMPCommunityString, iPAddress=iPAddress, telnetPortNumber=telnetPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePower=receivePower, supplementaryGroup=supplementaryGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpCompliance=ptpCompliance, sMTPEnabledMessages=sMTPEnabledMessages, receiveModulationModeDetail=receiveModulationModeDetail, channelBandwidth=channelBandwidth, receiveChannel=receiveChannel, receiveFreqMHz=receiveFreqMHz, ptpTrapPrefix=ptpTrapPrefix, systemReset=systemReset, targetMACAddress=targetMACAddress, userPassword=userPassword, syslogState=syslogState, userRole=userRole, receiveFreqKHz=receiveFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControl=phyControl, wirelessLinkAvailability=wirelessLinkAvailability, syslogClient=syslogClient, maximumTransmitPower=maximumTransmitPower, licenceGroup=licenceGroup, linkLoss=linkLoss, vLANPriorityTable=vLANPriorityTable, licensedCapacity=licensedCapacity, management=management, telecomsLineCode=telecomsLineCode, sNMPPortNumber=sNMPPortNumber, channelChangeTrap=channelChangeTrap, secondarySoftwareVersion=secondarySoftwareVersion, softwareVersion=softwareVersion, frequencyVariant=frequencyVariant, useVLANForManagementInterfaces=useVLANForManagementInterfaces, snmpControl=snmpControl, searchState=searchState, vLANManagementVID=vLANManagementVID, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPState=sNTPState, timeZone=timeZone, phyStatus=phyStatus, dfsTableEntry=dfsTableEntry, sNTPSyncTrap=sNTPSyncTrap, transmitModulationMode=transmitModulationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetFiberSupport=ethernetFiberSupport, userTable=userTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, smtpGroup=smtpGroup, masterSlaveMode=masterSlaveMode, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableNumber=dfsTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsInterface=telecomsInterface, ptpGroups=ptpGroups, vLANPriorityTableIndex=vLANPriorityTableIndex, installStatusTrap=installStatusTrap, cambium=cambium, licence=licence, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, userEnabled=userEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTableEntry=vLANPriorityTableEntry, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationMode=tDDSynchronizationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, siteName=siteName, sNTPSync=sNTPSync, linkName=linkName, regionCodeTrap=regionCodeTrap, telecomsChannelStatus=telecomsChannelStatus, sntpGroup=sntpGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, linkModeOptimisation=linkModeOptimisation, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, linkSymmetry=linkSymmetry, resetGroup=resetGroup, dfsTable=dfsTable, alarms=alarms, sNMPEnabledTraps=sNMPEnabledTraps, aAAControl=aAAControl, ethernetGroup=ethernetGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, capacityLicenseMismatch=capacityLicenseMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerPortNumber=tFTPServerPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfsPeaks=dfsPeaks, syslogControl=syslogControl, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntp=sntp, sNTPLastSync=sNTPLastSync, dataPortAutoMdix=dataPortAutoMdix, latitude=latitude, signalStrengthRatio=signalStrengthRatio, dfsMeans=dfsMeans, antennaGain=antennaGain, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, bootVersion=bootVersion, installStatus=installStatus, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, configuration=configuration, ethernet=ethernet, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, productName=productName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitFreqKHz=transmitFreqKHz, longitude=longitude, ptp=ptp, reset=reset, managementGroup=managementGroup, dfsTableIndex=dfsTableIndex, ptpTraps=ptpTraps, userName=userName, dataPortStatusTrap=dataPortStatusTrap, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitChannel=transmitChannel, bandwidthVariant=bandwidthVariant, range=range, tDDControl=tDDControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogStateTrap=syslogStateTrap, transmitPower=transmitPower, sMTPServerPortNumber=sMTPServerPortNumber, snmpControlGroup=snmpControlGroup, groupID=groupID, subnetMask=subnetMask, sNMPTrapTable=sNMPTrapTable, syslogClientTrap=syslogClientTrap, receiveDataRate=receiveDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryption=encryption, smtp=smtp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitDataRate=transmitDataRate, byteErrorRatio=byteErrorRatio, configurationGroup=configurationGroup, tDDControlGroup=tDDControlGroup, versionsGroup=versionsGroup, telecomsCableLength=telecomsCableLength, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecom=telecom, telecomsLoopback=telecomsLoopback, altitude=altitude, PYSNMP_MODULE_ID=cambium, dfsGroup=dfsGroup, installArmState=installArmState, telecomGroup=telecomGroup, aAAControlGroup=aAAControlGroup, vLANManagementPriority=vLANManagementPriority, sNTPPollInterval=sNTPPollInterval, versions=versions, phyStatusGroup=phyStatusGroup)
