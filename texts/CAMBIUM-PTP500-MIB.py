...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecom=telecom, targetMACAddress=targetMACAddress, alarmsGroup=alarmsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, smtp=smtp, transmitFreqMHz=transmitFreqMHz, PYSNMP_MODULE_ID=cambium, capacityLicenseMismatch=capacityLicenseMismatch, ptp=ptp, installArmState=installArmState, sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailable=noWirelessChannelAvailable, aAAControlGroup=aAAControlGroup, syslogControl=syslogControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogState=syslogState, encryption=encryption, softwareVersion=softwareVersion, byteErrorRatio=byteErrorRatio, dataPortStatus=dataPortStatus, tDDControlGroup=tDDControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, licenceGroup=licenceGroup, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, userName=userName, tDDControl=tDDControl, frequencyVariant=frequencyVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hTTPSPortNumber=hTTPSPortNumber, maximumTransmitPower=maximumTransmitPower, ethernetGroup=ethernetGroup, resetGroup=resetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkStatus=wirelessLinkStatus, transmitDataRate=transmitDataRate, regionCodeTrap=regionCodeTrap, installStatusTrap=installStatusTrap, sNTPSyncTrap=sNTPSyncTrap, signalStrengthRatio=signalStrengthRatio, searchState=searchState, incompatibleRegionCodes=incompatibleRegionCodes, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogControlGroup=syslogControlGroup, notificationsGroup=notificationsGroup, eIRP=eIRP, productName=productName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, gatewayIPAddress=gatewayIPAddress, daylightSaving=daylightSaving, userTable=userTable, transmitChannel=transmitChannel, longitude=longitude, tDDSynchronizationMode=tDDSynchronizationMode, phyControl=phyControl, vLANPriorityTableIndex=vLANPriorityTableIndex, alarms=alarms, configurationGroup=configurationGroup, regionCode=regionCode, receivePower=receivePower, timeZone=timeZone, userTableNumber=userTableNumber, systemClock=systemClock, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfs=dfs, pubStatsGroup=pubStatsGroup, sMTPEnabledMessages=sMTPEnabledMessages, linkName=linkName, ptpTrapPrefix=ptpTrapPrefix, telecomsLineCode=telecomsLineCode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vLANManagementVID=vLANManagementVID, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, pubStats=pubStats, tFTPServerPortNumber=tFTPServerPortNumber, encryptionGroup=encryptionGroup, productVariant=productVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, management=management, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, phyStatus=phyStatus, ptmp=ptmp, sNTPSync=sNTPSync, tDDSynchronizationStatus=tDDSynchronizationStatus, wirelessLinkAvailability=wirelessLinkAvailability, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsTableNumber=dfsTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, aggregateDataRate=aggregateDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntp=sntp, unitOutOfCalibration=unitOutOfCalibration, syslogLocalWrappedTrap=syslogLocalWrappedTrap, reset=reset, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userPassword=userPassword, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cableLoss=cableLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomGroup=telecomGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, accessMethod=accessMethod, dfsPeaks=dfsPeaks, sNMPv3Enable=sNMPv3Enable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptp500=ptp500, aAAControl=aAAControl, telecomsCableLength=telecomsCableLength, telnetAccessEnabled=telnetAccessEnabled, transmitFreqKHz=transmitFreqKHz, sMTPEmailAlert=sMTPEmailAlert, installArmStateTrap=installArmStateTrap, altitude=altitude, dfsGroup=dfsGroup, bootVersion=bootVersion, siteName=siteName, dataPortAutoMdix=dataPortAutoMdix, bandwidthVariant=bandwidthVariant, userRole=userRole, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, channelChangeTrap=channelChangeTrap, telnetPortNumber=telnetPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveModulationMode=receiveModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versionsGroup=versionsGroup, transmitModulationMode=transmitModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqMHz=receiveFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, snmpControl=snmpControl, hardwareVersion=hardwareVersion, latitude=latitude, smtpGroup=smtpGroup, iPAddress=iPAddress, sNMPTrapVersion=sNMPTrapVersion, channelBandwidth=channelBandwidth, secondarySoftwareVersion=secondarySoftwareVersion, licensedCapacity=licensedCapacity, userTableIndex=userTableIndex, installStatus=installStatus, ptpTraps=ptpTraps, encryptionAlgorithm=encryptionAlgorithm, dfsTableEntry=dfsTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, cambium=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTable=vLANPriorityTable, vectorError=vectorError, sNMPTrapIPAddress=sNMPTrapIPAddress, subnetMask=subnetMask, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsChannelStatus=telecomsChannelStatus, linkSymmetry=linkSymmetry, systemReset=systemReset, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsMeans=dfsMeans, groupID=groupID, dfsTableIndex=dfsTableIndex, range=range, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkModeOptimisation=linkModeOptimisation, syslogClientTrap=syslogClientTrap, sNMPTrapTable=sNMPTrapTable, dfsTable=dfsTable, receiveChannel=receiveChannel, licence=licence, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPAccessEnabled=hTTPAccessEnabled, telecomsInterface=telecomsInterface, linkLoss=linkLoss, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementGroup=managementGroup, sNTPServerPortNumber=sNTPServerPortNumber, masterSlaveMode=masterSlaveMode, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPState=sNTPState, hTTPSAccessEnabled=hTTPSAccessEnabled, userEnabled=userEnabled, sNTPLastSync=sNTPLastSync, receiveDataRate=receiveDataRate, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpCompliance=ptpCompliance, dataPortAutoNegotiation=dataPortAutoNegotiation, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetFiberSupport=ethernetFiberSupport, vLANPriorityQueueMapping=vLANPriorityQueueMapping, configuration=configuration, snmpControlGroup=snmpControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, supplementary=supplementary, ethernet=ethernet, telecomsLoopback=telecomsLoopback, hTTPPortNumber=hTTPPortNumber, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableIndex=sNMPTrapTableIndex, versions=versions, syslogClient=syslogClient, syslogStateTrap=syslogStateTrap, userTableEntry=userTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANManagementPriority=vLANManagementPriority, phyControlGroup=phyControlGroup, sntpGroup=sntpGroup)
