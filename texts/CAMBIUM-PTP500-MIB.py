...
Unsigned32, Gauge32, enterprises, Counter64, iso, MibIdentifier, IpAddress, NotificationType, Counter32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "enterprises", "Counter64", "iso", "MibIdentifier", "IpAddress", "NotificationType", "Counter32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Integer32", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, sMTPServerPortNumber=sMTPServerPortNumber, userTableNumber=userTableNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPLastSync=sNTPLastSync, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatusTrap=dataPortStatusTrap, installArmState=installArmState, telecomsCableLength=telecomsCableLength, sMTPServerIPAddress=sMTPServerIPAddress, receiveChannel=receiveChannel, licensedCapacity=licensedCapacity, wirelessLinkAvailability=wirelessLinkAvailability, hardwareVersion=hardwareVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, longitude=longitude, frequencyVariant=frequencyVariant, userTableIndex=userTableIndex, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitPower=transmitPower, sNTPServerIPAddress=sNTPServerIPAddress, telecomsLoopback=telecomsLoopback, linkLoss=linkLoss, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarning=dataPortDisabledWarning, userPassword=userPassword, userTableEntry=userTableEntry, encryption=encryption, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogClientTrap=syslogClientTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqMHz=transmitFreqMHz, softwareVersion=softwareVersion, sMTPEmailAlert=sMTPEmailAlert, eIRP=eIRP, tDDControlGroup=tDDControlGroup, subnetMask=subnetMask, phyStatus=phyStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, configuration=configuration, telecomGroup=telecomGroup, vLANPriorityTable=vLANPriorityTable, sNTPServerPortNumber=sNTPServerPortNumber, syslogClient=syslogClient, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogState=syslogState, licenceGroup=licenceGroup, smtpGroup=smtpGroup, groupID=groupID, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, configurationGroup=configurationGroup, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqKHz=transmitFreqKHz, resetGroup=resetGroup, dfsPeaks=dfsPeaks, syslogControl=syslogControl, altitude=altitude, management=management, syslogStateTrap=syslogStateTrap, snmpControlGroup=snmpControlGroup, bootVersion=bootVersion, tFTPServerIPAddress=tFTPServerIPAddress, supplementaryGroup=supplementaryGroup, versions=versions, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatch=linkModeOptimizationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, alarms=alarms, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, latitude=latitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTableIndex=sNMPTrapTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productVariant=productVariant, linkSymmetry=linkSymmetry, alarmsGroup=alarmsGroup, transmitChannel=transmitChannel, supplementary=supplementary, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapVersion=sNMPTrapVersion, sntp=sntp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPollInterval=sNTPPollInterval, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userRole=userRole, aAAControl=aAAControl, dfs=dfs, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telnetPortNumber=telnetPortNumber, ethernet=ethernet, encryptionAlgorithm=encryptionAlgorithm, licence=licence, ptpTraps=ptpTraps, versionsGroup=versionsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, capacityLicenseMismatch=capacityLicenseMismatch, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, daylightSaving=daylightSaving, snmpControl=snmpControl, systemReset=systemReset, aAAControlGroup=aAAControlGroup, hTTPPortNumber=hTTPPortNumber, siteName=siteName, cambium=cambium, ptp500=ptp500, reset=reset, sntpGroup=sntpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, unitOutOfCalibration=unitOutOfCalibration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLineCode=telecomsLineCode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemClock=systemClock, byteErrorRatio=byteErrorRatio, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, targetMACAddress=targetMACAddress, ptpGroups=ptpGroups, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, bandwidthVariant=bandwidthVariant, regionCodeTrap=regionCodeTrap, range=range, receivePower=receivePower, tDDSynchronizationStatus=tDDSynchronizationStatus, antennaGain=antennaGain, notificationsGroup=notificationsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTable=userTable, ptpTrapPrefix=ptpTrapPrefix, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTable=dfsTable, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimisation=linkModeOptimisation, iPAddress=iPAddress, sNMPPortNumber=sNMPPortNumber, PYSNMP_MODULE_ID=cambium, syslogControlGroup=syslogControlGroup, vLANManagementPriority=vLANManagementPriority, installStatusTrap=installStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, secondarySoftwareVersion=secondarySoftwareVersion, phyControl=phyControl, pubStatsGroup=pubStatsGroup, ptp=ptp, encryptionGroup=encryptionGroup, dfsTableNumber=dfsTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, pubStats=pubStats, receiveDataRate=receiveDataRate, constantPowerSpectralDensity=constantPowerSpectralDensity, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTableEntry=vLANPriorityTableEntry, userName=userName, dfsGroup=dfsGroup, installStatus=installStatus, vLANManagementVID=vLANManagementVID, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSync=sNTPSync, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitDataRate=transmitDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telnetAccessEnabled=telnetAccessEnabled, smtp=smtp, vectorError=vectorError, remoteIPAddress=remoteIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDControl=tDDControl, dfsTableEntry=dfsTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, noWirelessChannelAvailable=noWirelessChannelAvailable, accessMethod=accessMethod, sNMPTrapTable=sNMPTrapTable, receiveFreqMHz=receiveFreqMHz, productName=productName, timeZone=timeZone, receiveModulationMode=receiveModulationMode, phyControlGroup=phyControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, telecom=telecom, managementGroup=managementGroup, userEnabled=userEnabled, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, receiveFreqKHz=receiveFreqKHz, aggregateDataRate=aggregateDataRate, sNMPv3Enable=sNMPv3Enable, sNTPState=sNTPState)
