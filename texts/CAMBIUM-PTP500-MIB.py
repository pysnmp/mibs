...
Integer32, ModuleIdentity, Counter32, IpAddress, enterprises, Gauge32, ObjectIdentity, Counter64, MibIdentifier, Unsigned32, TimeTicks, NotificationType, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "Counter32", "IpAddress", "enterprises", "Gauge32", "ObjectIdentity", "Counter64", "MibIdentifier", "Unsigned32", "TimeTicks", "NotificationType", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", configurationGroup=configurationGroup, sntpGroup=sntpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, frequencyVariant=frequencyVariant, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, siteName=siteName, searchState=searchState, sNMPTrapIPAddress=sNMPTrapIPAddress, alarmsGroup=alarmsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, eIRP=eIRP, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatusTrap=dataPortStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPv3Enable=sNMPv3Enable, capacityLicenseMismatch=capacityLicenseMismatch, systemClock=systemClock, PYSNMP_MODULE_ID=cambium, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, accessMethod=accessMethod, sNMPTrapTable=sNMPTrapTable, tFTPServerIPAddress=tFTPServerIPAddress, encryption=encryption, telnetAccessEnabled=telnetAccessEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableEntry=dfsTableEntry, phyStatus=phyStatus, sNTPServerPortNumber=sNTPServerPortNumber, snmpControl=snmpControl, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, userTable=userTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sntp=sntp, telecomGroup=telecomGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userRole=userRole, linkSymmetry=linkSymmetry, notificationsGroup=notificationsGroup, licensedCapacity=licensedCapacity, telecomsChannelStatus=telecomsChannelStatus, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, installArmState=installArmState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpTraps=ptpTraps, sNMPEnabledTraps=sNMPEnabledTraps, syslogClientTrap=syslogClientTrap, daylightSaving=daylightSaving, groupID=groupID, configuration=configuration, syslogControlGroup=syslogControlGroup, tDDControl=tDDControl, receiveFreqKHz=receiveFreqKHz, userPassword=userPassword, ptpCompliance=ptpCompliance, altitude=altitude, tDDControlGroup=tDDControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPCommunityString=sNMPCommunityString, userTableIndex=userTableIndex, timeZone=timeZone, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, softwareVersion=softwareVersion, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpGroups=ptpGroups, ptp=ptp, bootVersion=bootVersion, cambium=cambium, dfsTableIndex=dfsTableIndex, telecomsLoopbackTrap=telecomsLoopbackTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hardwareVersion=hardwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, installStatus=installStatus, userTableEntry=userTableEntry, sNTPPollInterval=sNTPPollInterval, installStatusTrap=installStatusTrap, linkName=linkName, aAAControlGroup=aAAControlGroup, supplementary=supplementary, pubStatsGroup=pubStatsGroup, sNTPState=sNTPState, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControl=syslogControl, vLANManagementVID=vLANManagementVID, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPSync=sNTPSync, transmitPower=transmitPower, antennaGain=antennaGain, ptmp=ptmp, linkLoss=linkLoss, userTableNumber=userTableNumber, vectorError=vectorError, hTTPSPortNumber=hTTPSPortNumber, productName=productName, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, receiveDataRate=receiveDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, phyStatusGroup=phyStatusGroup, linkModeOptimisation=linkModeOptimisation, channelBandwidth=channelBandwidth, masterSlaveMode=masterSlaveMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, management=management, resetGroup=resetGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, versions=versions, reset=reset, productVariant=productVariant, receiveChannel=receiveChannel, sNTPLastSync=sNTPLastSync, iPAddress=iPAddress, dfsMeans=dfsMeans, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPPortNumber=sNMPPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, byteErrorRatio=byteErrorRatio, syslogClient=syslogClient, userName=userName, dfsTable=dfsTable, managementGroup=managementGroup, dataPortAutoMdix=dataPortAutoMdix, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemReset=systemReset, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, dfsGroup=dfsGroup, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsPeaks=dfsPeaks, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, latitude=latitude, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, regionCode=regionCode, dfs=dfs, range=range, encryptionGroup=encryptionGroup, pubStats=pubStats, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licenceGroup=licenceGroup, transmitModulationMode=transmitModulationMode, sMTPEmailAlert=sMTPEmailAlert, transmitDataRate=transmitDataRate, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aggregateDataRate=aggregateDataRate, userEnabled=userEnabled, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCodeTrap=regionCodeTrap, syslogState=syslogState, licence=licence, dataPortDisabledWarning=dataPortDisabledWarning, ethernet=ethernet, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, phyControl=phyControl, hTTPPortNumber=hTTPPortNumber, remoteIPAddress=remoteIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, targetMACAddress=targetMACAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aAAControl=aAAControl, ptp500=ptp500, smtp=smtp, phyControlGroup=phyControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, bandwidthVariant=bandwidthVariant, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, incompatibleRegionCodes=incompatibleRegionCodes, vLANPriorityTable=vLANPriorityTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerIPAddress=sNTPServerIPAddress, channelChangeTrap=channelChangeTrap, secondarySoftwareVersion=secondarySoftwareVersion, telecomsLineCode=telecomsLineCode, longitude=longitude, dfsTableNumber=dfsTableNumber, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapTableEntry=sNMPTrapTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsInterface=telecomsInterface, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetFiberSupport=ethernetFiberSupport, receiveModulationMode=receiveModulationMode, telecomsCableLength=telecomsCableLength, telecomsLoopback=telecomsLoopback, sMTPServerPortNumber=sMTPServerPortNumber, snmpControlGroup=snmpControlGroup, syslogStateTrap=syslogStateTrap, supplementaryGroup=supplementaryGroup, telecom=telecom, maximumTransmitPower=maximumTransmitPower)
