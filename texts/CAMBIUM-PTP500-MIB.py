...
MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, TimeTicks, enterprises, Counter64, Unsigned32, iso, ModuleIdentity, Counter32, IpAddress, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "TimeTicks", "enterprises", "Counter64", "Unsigned32", "iso", "ModuleIdentity", "Counter32", "IpAddress", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ethernetFiberSupport=ethernetFiberSupport, targetMACAddress=targetMACAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licenceGroup=licenceGroup, smtpGroup=smtpGroup, snmpControl=snmpControl, productVariant=productVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, groupID=groupID, vLANPriorityTable=vLANPriorityTable, userTableEntry=userTableEntry, phyControlGroup=phyControlGroup, sNTPLastSync=sNTPLastSync, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, systemReset=systemReset, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving, phyStatus=phyStatus, accessMethod=accessMethod, vLANPriorityQueueMapping=vLANPriorityQueueMapping, installStatus=installStatus, smtp=smtp, receiveFreqMHz=receiveFreqMHz, aggregateDataRate=aggregateDataRate, supplementary=supplementary, eIRP=eIRP, vectorError=vectorError, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userPassword=userPassword, transmitModulationMode=transmitModulationMode, gatewayIPAddress=gatewayIPAddress, ptpTrapPrefix=ptpTrapPrefix, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, remoteIPAddress=remoteIPAddress, receiveModulationMode=receiveModulationMode, notificationsGroup=notificationsGroup, licensedCapacity=licensedCapacity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, byteErrorRatio=byteErrorRatio, userEnabled=userEnabled, dfsTableEntry=dfsTableEntry, userRole=userRole, cambium=cambium, syslogClientTrap=syslogClientTrap, productName=productName, hardwareVersion=hardwareVersion, configuration=configuration, sMTPEmailAlert=sMTPEmailAlert, transmitPower=transmitPower, ptp=ptp, dfsTableNumber=dfsTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hTTPSPortNumber=hTTPSPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installArmState=installArmState, installStatusTrap=installStatusTrap, transmitChannel=transmitChannel, telecomsLoopback=telecomsLoopback, dfs=dfs, telecomsLoopbackTrap=telecomsLoopbackTrap, longitude=longitude, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsLineCode=telecomsLineCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, regionCodeTrap=regionCodeTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, vLANManagementVID=vLANManagementVID, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortDisabledWarning=dataPortDisabledWarning, transmitFreqMHz=transmitFreqMHz, sNTPServerPortNumber=sNTPServerPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, transmitFreqKHz=transmitFreqKHz, dfsMeans=dfsMeans, frequencyVariant=frequencyVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPollInterval=sNTPPollInterval, siteName=siteName, systemClock=systemClock, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsCableLength=telecomsCableLength, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, sNTPSyncTrap=sNTPSyncTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTable=sNMPTrapTable, hTTPSAccessEnabled=hTTPSAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, latitude=latitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPPortNumber=sNMPPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, versions=versions, encryptionGroup=encryptionGroup, sMTPEnabledMessages=sMTPEnabledMessages, range=range, aAAControl=aAAControl, alarmsGroup=alarmsGroup, transmitDataRate=transmitDataRate, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsInterface=telecomsInterface, userTable=userTable, linkName=linkName, bandwidthVariant=bandwidthVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStats=pubStats, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsChannelStatus=telecomsChannelStatus, tFTPServerIPAddress=tFTPServerIPAddress, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, ptpTraps=ptpTraps, sntpGroup=sntpGroup, versionsGroup=versionsGroup, dataPortAutoMdix=dataPortAutoMdix, syslogControlGroup=syslogControlGroup, PYSNMP_MODULE_ID=cambium, aAAControlGroup=aAAControlGroup, antennaGain=antennaGain, iPAddress=iPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomGroup=telecomGroup, sNTPSync=sNTPSync, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTable=dfsTable, wirelessLinkAvailability=wirelessLinkAvailability, receiveModulationModeDetail=receiveModulationModeDetail, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableIndex=dfsTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userName=userName, cableLoss=cableLoss, receivePower=receivePower, timeZone=timeZone, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, management=management, altitude=altitude, sNMPv3Enable=sNMPv3Enable, searchState=searchState, pubStatsGroup=pubStatsGroup, maximumTransmitPower=maximumTransmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableIndex=userTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, ethernet=ethernet, tDDControl=tDDControl, tDDControlGroup=tDDControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptmp=ptmp, regionCode=regionCode, bootVersion=bootVersion, telecom=telecom, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogClient=syslogClient, alarms=alarms, telnetPortNumber=telnetPortNumber, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, reset=reset, vLANPriorityTableEntry=vLANPriorityTableEntry, channelBandwidth=channelBandwidth, ptpCompliance=ptpCompliance, managementGroup=managementGroup, encryptionAlgorithm=encryptionAlgorithm, linkModeOptimisation=linkModeOptimisation, sNMPTrapVersion=sNMPTrapVersion, syslogState=syslogState, vLANManagementPriority=vLANManagementPriority, signalStrengthRatio=signalStrengthRatio, sNTPServerIPAddress=sNTPServerIPAddress, receiveDataRate=receiveDataRate, receiveChannel=receiveChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogControl=syslogControl, telnetAccessEnabled=telnetAccessEnabled, resetGroup=resetGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, supplementaryGroup=supplementaryGroup, linkLoss=linkLoss, dataPortStatus=dataPortStatus, channelChangeTrap=channelChangeTrap, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetGroup=ethernetGroup, sNTPState=sNTPState, sNMPCommunityString=sNMPCommunityString, phyControl=phyControl, tFTPServerPortNumber=tFTPServerPortNumber, subnetMask=subnetMask, licence=licence, syslogStateTrap=syslogStateTrap, userTableNumber=userTableNumber, wirelessLinkStatus=wirelessLinkStatus, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, configurationGroup=configurationGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsGroup=dfsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sntp=sntp, encryption=encryption, phyStatusGroup=phyStatusGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptp500=ptp500, dfsPeaks=dfsPeaks, vLANPriorityTableNumber=vLANPriorityTableNumber)
