...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableIndex=userTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, cableLoss=cableLoss, syslogClient=syslogClient, PYSNMP_MODULE_ID=cambium, accessMethod=accessMethod, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANPriorityTableNumber=vLANPriorityTableNumber, signalStrengthRatio=signalStrengthRatio, groupID=groupID, dataPortAutoNegotiation=dataPortAutoNegotiation, gatewayIPAddress=gatewayIPAddress, licenceGroup=licenceGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, encryptionGroup=encryptionGroup, aAAControlGroup=aAAControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userPassword=userPassword, smtpGroup=smtpGroup, sMTPEmailAlert=sMTPEmailAlert, daylightSaving=daylightSaving, telecomsLineCode=telecomsLineCode, versionsGroup=versionsGroup, sNMPv3Enable=sNMPv3Enable, aggregateDataRate=aggregateDataRate, snmpControl=snmpControl, ptpGroups=ptpGroups, alarmsGroup=alarmsGroup, installArmStateTrap=installArmStateTrap, ethernetGroup=ethernetGroup, phyControlGroup=phyControlGroup, telecomsCableLength=telecomsCableLength, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementary=supplementary, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementPriority=vLANManagementPriority, hTTPAccessEnabled=hTTPAccessEnabled, receiveFreqMHz=receiveFreqMHz, sNTPPollInterval=sNTPPollInterval, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, versions=versions, latitude=latitude, bootVersion=bootVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyStatus=phyStatus, syslogControlGroup=syslogControlGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernet=ethernet, configuration=configuration, telecomsLoopbackTrap=telecomsLoopbackTrap, installStatus=installStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitChannel=transmitChannel, installStatusTrap=installStatusTrap, syslogState=syslogState, sNTPSync=sNTPSync, receiveModulationMode=receiveModulationMode, receiveFreqKHz=receiveFreqKHz, transmitDataRate=transmitDataRate, licence=licence, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsPeaks=dfsPeaks, subnetMask=subnetMask, systemClock=systemClock, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptp500=ptp500, snmpControlGroup=snmpControlGroup, userRole=userRole, smtp=smtp, telnetPortNumber=telnetPortNumber, aAAControl=aAAControl, ptpTrapPrefix=ptpTrapPrefix, systemReset=systemReset, secondarySoftwareVersion=secondarySoftwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteIPAddress=remoteIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsTableNumber=dfsTableNumber, transmitPower=transmitPower, range=range, ptpTraps=ptpTraps, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, regionCodeTrap=regionCodeTrap, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, channelChangeTrap=channelChangeTrap, altitude=altitude, telecomsLoopback=telecomsLoopback, resetGroup=resetGroup, telecomsInterface=telecomsInterface, configurationGroup=configurationGroup, transmitModulationMode=transmitModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, timeZone=timeZone, sNMPCommunityString=sNMPCommunityString, phyControl=phyControl, longitude=longitude, maximumTransmitPower=maximumTransmitPower, dfs=dfs, sNMPTrapVersion=sNMPTrapVersion, tDDControl=tDDControl, ptmp=ptmp, hTTPSPortNumber=hTTPSPortNumber, ptpCompliance=ptpCompliance, syslogControl=syslogControl, receivePower=receivePower, receiveChannel=receiveChannel, userEnabled=userEnabled, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsChannelStatus=telecomsChannelStatus, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, vectorError=vectorError, telecomGroup=telecomGroup, tFTPServerIPAddress=tFTPServerIPAddress, linkSymmetry=linkSymmetry, supplementaryGroup=supplementaryGroup, alarms=alarms, frequencyVariant=frequencyVariant, sNTPServerPortNumber=sNTPServerPortNumber, notificationsGroup=notificationsGroup, wirelessLinkAvailability=wirelessLinkAvailability, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vLANManagementVID=vLANManagementVID, siteName=siteName, sntp=sntp, bandwidthVariant=bandwidthVariant, capacityLicenseMismatch=capacityLicenseMismatch, dfsTableEntry=dfsTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, encryption=encryption, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, sMTPEnabledMessages=sMTPEnabledMessages, productVariant=productVariant, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControlGroup=tDDControlGroup, userTable=userTable, dfsTableIndex=dfsTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogStateTrap=syslogStateTrap, installArmState=installArmState, masterSlaveMode=masterSlaveMode, eIRP=eIRP, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, dfsMeans=dfsMeans, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatus=dataPortStatus, syslogClientTrap=syslogClientTrap, linkName=linkName, channelBandwidth=channelBandwidth, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsGroup=dfsGroup, transmitFreqKHz=transmitFreqKHz, searchState=searchState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, reset=reset, unitOutOfCalibration=unitOutOfCalibration, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, managementGroup=managementGroup, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStats=pubStats, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPPortNumber=sNMPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userTableEntry=userTableEntry, telnetAccessEnabled=telnetAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, vLANPriorityTableEntry=vLANPriorityTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, transmitFreqMHz=transmitFreqMHz, dataPortStatusTrap=dataPortStatusTrap, sntpGroup=sntpGroup, hardwareVersion=hardwareVersion, linkLoss=linkLoss, sNTPLastSync=sNTPLastSync, ptp=ptp, management=management, vLANPriorityTableIndex=vLANPriorityTableIndex, antennaGain=antennaGain, licensedCapacity=licensedCapacity, userName=userName, sNTPState=sNTPState, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, phyStatusGroup=phyStatusGroup, softwareVersion=softwareVersion, linkModeOptimisation=linkModeOptimisation, vLANPriorityTable=vLANPriorityTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerPortNumber=tFTPServerPortNumber, telecom=telecom, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, targetMACAddress=targetMACAddress, hTTPPortNumber=hTTPPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productName=productName)
