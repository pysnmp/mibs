...
Unsigned32, ObjectIdentity, iso, NotificationType, Counter32, IpAddress, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, MibIdentifier, Integer32, Counter64, ModuleIdentity, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "iso", "NotificationType", "Counter32", "IpAddress", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "MibIdentifier", "Integer32", "Counter64", "ModuleIdentity", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitFreqMHz=transmitFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANManagementVID=vLANManagementVID, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, syslogControlGroup=syslogControlGroup, installStatus=installStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telnetPortNumber=telnetPortNumber, regionCode=regionCode, frequencyVariant=frequencyVariant, sntp=sntp, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, configurationGroup=configurationGroup, versionsGroup=versionsGroup, systemReset=systemReset, targetMACAddress=targetMACAddress, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, sNTPPollInterval=sNTPPollInterval, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licensedCapacity=licensedCapacity, dfsTableNumber=dfsTableNumber, syslogControl=syslogControl, cableLoss=cableLoss, versions=versions, linkName=linkName, syslogStateTrap=syslogStateTrap, unitOutOfCalibration=unitOutOfCalibration, sMTPEmailAlert=sMTPEmailAlert, dfsPeaks=dfsPeaks, wirelessLinkStatus=wirelessLinkStatus, reset=reset, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, sNTPSyncTrap=sNTPSyncTrap, ptp500=ptp500, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDControlGroup=tDDControlGroup, ethernetGroup=ethernetGroup, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sNTPState=sNTPState, licenceGroup=licenceGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, cambium=cambium, telecomsChannelStatus=telecomsChannelStatus, snmpControl=snmpControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, searchState=searchState, receiveDataRate=receiveDataRate, transmitFreqKHz=transmitFreqKHz, transmitDataRate=transmitDataRate, linkModeOptimizationMismatch=linkModeOptimizationMismatch, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkLoss=linkLoss, PYSNMP_MODULE_ID=cambium, altitude=altitude, telecomsCableLength=telecomsCableLength, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableNumber=userTableNumber, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, phyStatus=phyStatus, ptmp=ptmp, systemClock=systemClock, constantPowerSpectralDensity=constantPowerSpectralDensity, siteName=siteName, userTable=userTable, phyControl=phyControl, bandwidthVariant=bandwidthVariant, iPAddress=iPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfs=dfs, aAAControl=aAAControl, hardwareVersion=hardwareVersion, channelChangeTrap=channelChangeTrap, softwareVersion=softwareVersion, smtp=smtp, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, maximumTransmitPower=maximumTransmitPower, latitude=latitude, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, management=management, dataPortAutoMdix=dataPortAutoMdix, tDDSynchronizationStatus=tDDSynchronizationStatus, alarmsGroup=alarmsGroup, eIRP=eIRP, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableEntry=dfsTableEntry, productVariant=productVariant, supplementary=supplementary, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimisation=linkModeOptimisation, userPassword=userPassword, receiveModulationModeDetail=receiveModulationModeDetail, resetGroup=resetGroup, tDDControl=tDDControl, remoteIPAddress=remoteIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityTable=vLANPriorityTable, smtpGroup=smtpGroup, subnetMask=subnetMask, sNTPSync=sNTPSync, transmitModulationMode=transmitModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, installArmState=installArmState, ptpGroups=ptpGroups, channelBandwidth=channelBandwidth, userName=userName, syslogState=syslogState, longitude=longitude, phyStatusGroup=phyStatusGroup, receiveFreqMHz=receiveFreqMHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, encryptionGroup=encryptionGroup, ptpTraps=ptpTraps, aAAControlGroup=aAAControlGroup, syslogClient=syslogClient, linkSymmetry=linkSymmetry, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, timeZone=timeZone, licence=licence, range=range, tFTPServerIPAddress=tFTPServerIPAddress, dfsGroup=dfsGroup, dfsMeans=dfsMeans, antennaGain=antennaGain, vLANPriorityTableNumber=vLANPriorityTableNumber, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPPortNumber=hTTPPortNumber, dfsTable=dfsTable, vectorError=vectorError, telecomsInterface=telecomsInterface, telecomsLineCode=telecomsLineCode, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, hTTPAccessEnabled=hTTPAccessEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecom=telecom, syslogLocalWrappedTrap=syslogLocalWrappedTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableEntry=userTableEntry, ptpCompliance=ptpCompliance, receiveChannel=receiveChannel, transmitPower=transmitPower, dataPortStatusTrap=dataPortStatusTrap, ptp=ptp, bootVersion=bootVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryption=encryption, dfsTableIndex=dfsTableIndex, hTTPSPortNumber=hTTPSPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, phyControlGroup=phyControlGroup, syslogClientTrap=syslogClientTrap, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installArmStateTrap=installArmStateTrap, telecomsLoopback=telecomsLoopback, tDDSynchronizationAlarm=tDDSynchronizationAlarm, productName=productName, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installStatusTrap=installStatusTrap, regionCodeTrap=regionCodeTrap, dataPortStatus=dataPortStatus, secondarySoftwareVersion=secondarySoftwareVersion, ethernetFiberSupport=ethernetFiberSupport, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarning=dataPortDisabledWarning, managementGroup=managementGroup, sNMPTrapVersion=sNMPTrapVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, alarms=alarms, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableIndex=userTableIndex, ethernet=ethernet, telecomGroup=telecomGroup, supplementaryGroup=supplementaryGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, transmitChannel=transmitChannel, userRole=userRole, capacityLicenseMismatch=capacityLicenseMismatch, sNTPServerPortNumber=sNTPServerPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, pubStats=pubStats, masterSlaveMode=masterSlaveMode, groupID=groupID, userEnabled=userEnabled, pubStatsGroup=pubStatsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex)
