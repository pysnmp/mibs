...
Unsigned32, MibIdentifier, Bits, IpAddress, enterprises, Counter64, Gauge32, Counter32, iso, Integer32, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "Bits", "IpAddress", "enterprises", "Counter64", "Gauge32", "Counter32", "iso", "Integer32", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", targetMACAddress=targetMACAddress, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, supplementary=supplementary, sNMPTrapTable=sNMPTrapTable, hTTPAccessEnabled=hTTPAccessEnabled, regionCode=regionCode, ptp500=ptp500, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, eIRP=eIRP, receiveChannel=receiveChannel, wirelessLinkAvailability=wirelessLinkAvailability, userPassword=userPassword, receiveModulationModeDetail=receiveModulationModeDetail, ethernetFiberSupport=ethernetFiberSupport, incompatibleRegionCodes=incompatibleRegionCodes, sntp=sntp, linkLoss=linkLoss, systemReset=systemReset, vLANManagementVID=vLANManagementVID, tFTPServerIPAddress=tFTPServerIPAddress, frequencyVariant=frequencyVariant, smtp=smtp, telecomsChannelStatus=telecomsChannelStatus, sNMPPortNumber=sNMPPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPv3Enable=sNMPv3Enable, telecomGroup=telecomGroup, cambium=cambium, iPAddress=iPAddress, searchState=searchState, userTableIndex=userTableIndex, ptmp=ptmp, linkName=linkName, bandwidthVariant=bandwidthVariant, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, latitude=latitude, sNTPServerPortNumber=sNTPServerPortNumber, cableLoss=cableLoss, vLANPriorityTableNumber=vLANPriorityTableNumber, productName=productName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, configuration=configuration, productVariant=productVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, aAAControl=aAAControl, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, userTableEntry=userTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, gatewayIPAddress=gatewayIPAddress, timeZone=timeZone, maximumTransmitPower=maximumTransmitPower, management=management, versions=versions, ptpTraps=ptpTraps, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortAutoMdix=dataPortAutoMdix, licenceGroup=licenceGroup, pubStats=pubStats, ethernetGroup=ethernetGroup, vLANPriorityTable=vLANPriorityTable, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, managementGroup=managementGroup, sNTPLastSync=sNTPLastSync, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogState=syslogState, sNTPPollInterval=sNTPPollInterval, encryption=encryption, tDDControl=tDDControl, bootVersion=bootVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telnetPortNumber=telnetPortNumber, remoteIPAddress=remoteIPAddress, telecomsLoopback=telecomsLoopback, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, notificationsGroup=notificationsGroup, vLANManagementPriority=vLANManagementPriority, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapVersion=sNMPTrapVersion, telecom=telecom, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitDataRate=transmitDataRate, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableNumber=userTableNumber, PYSNMP_MODULE_ID=cambium, receiveFreqMHz=receiveFreqMHz, subnetMask=subnetMask, aAAControlGroup=aAAControlGroup, sNTPSync=sNTPSync, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, aggregateDataRate=aggregateDataRate, installStatusTrap=installStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, antennaGain=antennaGain, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, ptp=ptp, groupID=groupID, installArmState=installArmState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveModulationMode=receiveModulationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfs=dfs, versionsGroup=versionsGroup, supplementaryGroup=supplementaryGroup, dfsPeaks=dfsPeaks, snmpControlGroup=snmpControlGroup, userTable=userTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userRole=userRole, phyControl=phyControl, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, transmitChannel=transmitChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, longitude=longitude, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitFreqMHz=transmitFreqMHz, tDDControlGroup=tDDControlGroup, altitude=altitude, installArmStateTrap=installArmStateTrap, phyStatusGroup=phyStatusGroup, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userEnabled=userEnabled, siteName=siteName, receiveFreqKHz=receiveFreqKHz, dfsTableEntry=dfsTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANPriorityQueueMapping=vLANPriorityQueueMapping, channelBandwidth=channelBandwidth, transmitPower=transmitPower, byteErrorRatio=byteErrorRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, daylightSaving=daylightSaving, tFTPServerPortNumber=tFTPServerPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, syslogControl=syslogControl, userName=userName, ptpCompliance=ptpCompliance, dataPortDisabledWarning=dataPortDisabledWarning, dfsTableIndex=dfsTableIndex, installStatus=installStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licence=licence, linkSymmetry=linkSymmetry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryptionGroup=encryptionGroup, linkModeOptimisation=linkModeOptimisation, licensedCapacity=licensedCapacity, syslogStateTrap=syslogStateTrap, dfsTableNumber=dfsTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetAccessEnabled=telnetAccessEnabled, accessMethod=accessMethod, channelChangeTrap=channelChangeTrap, alarmsGroup=alarmsGroup, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, alarms=alarms, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsMeans=dfsMeans, hTTPPortNumber=hTTPPortNumber, snmpControl=snmpControl, telecomsLineCode=telecomsLineCode, telecomsInterface=telecomsInterface, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, signalStrengthRatio=signalStrengthRatio, ptpGroups=ptpGroups, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpTrapPrefix=ptpTrapPrefix, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, encryptionAlgorithm=encryptionAlgorithm, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, reset=reset, dfsGroup=dfsGroup, sNTPState=sNTPState, receiveDataRate=receiveDataRate, resetGroup=resetGroup, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, sMTPServerIPAddress=sMTPServerIPAddress, range=range, telecomsCableLength=telecomsCableLength, secondarySoftwareVersion=secondarySoftwareVersion, regionCodeTrap=regionCodeTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogClient=syslogClient, dfsTable=dfsTable, softwareVersion=softwareVersion, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, phyControlGroup=phyControlGroup, sntpGroup=sntpGroup, sNTPSyncTrap=sNTPSyncTrap, ethernet=ethernet)
