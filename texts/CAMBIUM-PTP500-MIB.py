...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:01:50 2021
...
IpAddress, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, ObjectIdentity, Integer32, Counter32, ModuleIdentity, enterprises, iso, TimeTicks, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "ObjectIdentity", "Integer32", "Counter32", "ModuleIdentity", "enterprises", "iso", "TimeTicks", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitFreqMHz=transmitFreqMHz, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, encryptionAlgorithm=encryptionAlgorithm, userTableIndex=userTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPSyncTrap=sNTPSyncTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntp=sntp, tFTPServerPortNumber=tFTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, sMTPEnabledMessages=sMTPEnabledMessages, dataPortAutoNegotiation=dataPortAutoNegotiation, userTableEntry=userTableEntry, regionCodeTrap=regionCodeTrap, encryption=encryption, vLANManagementVID=vLANManagementVID, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodes=incompatibleRegionCodes, transmitFreqKHz=transmitFreqKHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapPortNumber=sNMPTrapPortNumber, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsTableEntry=dfsTableEntry, hardwareVersion=hardwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarms=alarms, secondarySoftwareVersion=secondarySoftwareVersion, ptpGroups=ptpGroups, tDDControl=tDDControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, productVariant=productVariant, siteName=siteName, sNTPState=sNTPState, pubStatsGroup=pubStatsGroup, productName=productName, tDDControlGroup=tDDControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, eIRP=eIRP, sntpGroup=sntpGroup, linkModeOptimisation=linkModeOptimisation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aAAControl=aAAControl, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatus=wirelessLinkStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userPassword=userPassword, telecomsLoopback=telecomsLoopback, capacityLicenseMismatch=capacityLicenseMismatch, syslogControlGroup=syslogControlGroup, versions=versions, targetMACAddress=targetMACAddress, aggregateDataRate=aggregateDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogStateTrap=syslogStateTrap, channelChangeTrap=channelChangeTrap, dfs=dfs, dfsGroup=dfsGroup, phyControlGroup=phyControlGroup, syslogClient=syslogClient, encryptionGroup=encryptionGroup, receiveModulationMode=receiveModulationMode, receiveModulationModeDetail=receiveModulationModeDetail, telecomsChannelStatusTrap=telecomsChannelStatusTrap, systemReset=systemReset, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPSync=sNTPSync, timeZone=timeZone, PYSNMP_MODULE_ID=cambium, vLANManagementPriority=vLANManagementPriority, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, syslogClientTrap=syslogClientTrap, resetGroup=resetGroup, sNTPLastSync=sNTPLastSync, dfsMeans=dfsMeans, supplementary=supplementary, cableLoss=cableLoss, alarmsGroup=alarmsGroup, dataPortAutoMdix=dataPortAutoMdix, tFTPServerIPAddress=tFTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, telecomsInterface=telecomsInterface, receiveFreqMHz=receiveFreqMHz, userEnabled=userEnabled, sMTPServerIPAddress=sMTPServerIPAddress, notificationsGroup=notificationsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, gatewayIPAddress=gatewayIPAddress, searchState=searchState, phyControl=phyControl, snmpControlGroup=snmpControlGroup, versionsGroup=versionsGroup, transmitChannel=transmitChannel, dataPortStatus=dataPortStatus, altitude=altitude, linkLoss=linkLoss, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telnetPortNumber=telnetPortNumber, licenceGroup=licenceGroup, daylightSaving=daylightSaving, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, telecom=telecom, signalStrengthRatio=signalStrengthRatio, channelBandwidth=channelBandwidth, receiveDataRate=receiveDataRate, frequencyVariant=frequencyVariant, sNTPServerPortNumber=sNTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, transmitModulationMode=transmitModulationMode, sNMPv3Enable=sNMPv3Enable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, receiveFreqKHz=receiveFreqKHz, accessMethod=accessMethod, hTTPSAccessEnabled=hTTPSAccessEnabled, bandwidthVariant=bandwidthVariant, userName=userName, snmpControl=snmpControl, dataPortDisabledWarning=dataPortDisabledWarning, ethernetGroup=ethernetGroup, transmitPower=transmitPower, cambium=cambium, sNMPCommunityString=sNMPCommunityString, softwareVersion=softwareVersion, hTTPSPortNumber=hTTPSPortNumber, receivePower=receivePower, vectorError=vectorError, range=range, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPPollInterval=sNTPPollInterval, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, groupID=groupID, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, phyStatusGroup=phyStatusGroup, configurationGroup=configurationGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, smtpGroup=smtpGroup, linkName=linkName, installStatus=installStatus, licence=licence, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, management=management, phyStatus=phyStatus, ethernet=ethernet, ptp500=ptp500, remoteIPAddress=remoteIPAddress, latitude=latitude, bootVersion=bootVersion, telecomGroup=telecomGroup, telecomsCableLength=telecomsCableLength, telecomsChannelStatus=telecomsChannelStatus, receiveChannel=receiveChannel, subnetMask=subnetMask, userRole=userRole, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTable=vLANPriorityTable, supplementaryGroup=supplementaryGroup, userTableNumber=userTableNumber, dfsPeaks=dfsPeaks, iPAddress=iPAddress, userTable=userTable, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptp=ptp, hTTPAccessEnabled=hTTPAccessEnabled, antennaGain=antennaGain, dfsTableNumber=dfsTableNumber, dfsTableIndex=dfsTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, byteErrorRatio=byteErrorRatio, installArmStateTrap=installArmStateTrap, telecomsLineCode=telecomsLineCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtp=smtp, masterSlaveMode=masterSlaveMode, regionCode=regionCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTable=dfsTable, pubStats=pubStats, tDDSynchronizationMode=tDDSynchronizationMode, ptpCompliance=ptpCompliance, installArmState=installArmState, unitOutOfCalibration=unitOutOfCalibration, systemClock=systemClock, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogState=syslogState, sNMPTrapVersion=sNMPTrapVersion, hTTPPortNumber=hTTPPortNumber, sMTPEmailAlert=sMTPEmailAlert, configuration=configuration, longitude=longitude, linkSymmetry=linkSymmetry, licensedCapacity=licensedCapacity, installStatusTrap=installStatusTrap, reset=reset, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, managementGroup=managementGroup, syslogControl=syslogControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, aAAControlGroup=aAAControlGroup, ptpTraps=ptpTraps, enabledDiagnosticAlarms=enabledDiagnosticAlarms)
