...
Unsigned32, IpAddress, Bits, ModuleIdentity, Integer32, MibIdentifier, iso, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, enterprises, Counter32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Bits", "ModuleIdentity", "Integer32", "MibIdentifier", "iso", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "enterprises", "Counter32", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", phyStatus=phyStatus, sNTPSync=sNTPSync, aAAControlGroup=aAAControlGroup, hTTPSPortNumber=hTTPSPortNumber, range=range, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkStatus=wirelessLinkStatus, telecomsLoopback=telecomsLoopback, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTable=dfsTable, cableLoss=cableLoss, remoteIPAddress=remoteIPAddress, sNTPPollInterval=sNTPPollInterval, linkName=linkName, maximumTransmitPower=maximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, userRole=userRole, smtpGroup=smtpGroup, sNMPTrapVersion=sNMPTrapVersion, hardwareVersion=hardwareVersion, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsGroup=dfsGroup, licensedCapacity=licensedCapacity, transmitModulationMode=transmitModulationMode, syslogState=syslogState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEmailAlert=sMTPEmailAlert, dfs=dfs, versions=versions, management=management, sMTPServerIPAddress=sMTPServerIPAddress, targetMACAddress=targetMACAddress, gatewayIPAddress=gatewayIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsInterface=telecomsInterface, bandwidthVariant=bandwidthVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPState=sNTPState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyStatusGroup=phyStatusGroup, transmitFreqKHz=transmitFreqKHz, telecomGroup=telecomGroup, resetGroup=resetGroup, eIRP=eIRP, managementGroup=managementGroup, sntp=sntp, telecomsChannelStatus=telecomsChannelStatus, telecomsLineCode=telecomsLineCode, regionCode=regionCode, phyControlGroup=phyControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, installStatus=installStatus, transmitFreqMHz=transmitFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementVID=vLANManagementVID, sntpGroup=sntpGroup, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimisation=linkModeOptimisation, dfsTableIndex=dfsTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, transmitPower=transmitPower, searchState=searchState, syslogControl=syslogControl, subnetMask=subnetMask, channelBandwidth=channelBandwidth, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClientTrap=syslogClientTrap, snmpControl=snmpControl, telecomsChannelStatusTrap=telecomsChannelStatusTrap, capacityLicenseMismatch=capacityLicenseMismatch, configuration=configuration, sNMPTrapTable=sNMPTrapTable, userTableNumber=userTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTable=vLANPriorityTable, groupID=groupID, masterSlaveMode=masterSlaveMode, dfsPeaks=dfsPeaks, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, siteName=siteName, signalStrengthRatio=signalStrengthRatio, userTable=userTable, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerPortNumber=sMTPServerPortNumber, supplementaryGroup=supplementaryGroup, telecomsCableLength=telecomsCableLength, userPassword=userPassword, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPPortNumber=sNMPPortNumber, encryptionAlgorithm=encryptionAlgorithm, userTableEntry=userTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPAddress=iPAddress, syslogStateTrap=syslogStateTrap, transmitChannel=transmitChannel, vLANPriorityTableIndex=vLANPriorityTableIndex, softwareVersion=softwareVersion, bootVersion=bootVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, constantPowerSpectralDensity=constantPowerSpectralDensity, supplementary=supplementary, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installStatusTrap=installStatusTrap, notificationsGroup=notificationsGroup, sNTPSyncTrap=sNTPSyncTrap, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPv3Enable=sNMPv3Enable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPServerPortNumber=sNTPServerPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTableNumber=dfsTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productVariant=productVariant, ptpTraps=ptpTraps, snmpControlGroup=snmpControlGroup, receiveFreqMHz=receiveFreqMHz, unitOutOfCalibration=unitOutOfCalibration, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userName=userName, tDDControl=tDDControl, telecom=telecom, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetGroup=ethernetGroup, latitude=latitude, dataPortStatus=dataPortStatus, smtp=smtp, sNMPCommunityString=sNMPCommunityString, alarms=alarms, tDDControlGroup=tDDControlGroup, ethernet=ethernet, ptpCompliance=ptpCompliance, dataPortAutoNegotiation=dataPortAutoNegotiation, ptp500=ptp500, tFTPServerIPAddress=tFTPServerIPAddress, receivePower=receivePower, ptp=ptp, encryption=encryption, byteErrorRatio=byteErrorRatio, licence=licence, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productName=productName, userTableIndex=userTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogClient=syslogClient, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, linkSymmetry=linkSymmetry, versionsGroup=versionsGroup, channelChangeTrap=channelChangeTrap, encryptionGroup=encryptionGroup, telnetPortNumber=telnetPortNumber, altitude=altitude, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementPriority=vLANManagementPriority, ptmp=ptmp, aAAControl=aAAControl, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkLoss=linkLoss, timeZone=timeZone, longitude=longitude, dfsTableEntry=dfsTableEntry, installArmStateTrap=installArmStateTrap, daylightSaving=daylightSaving, reset=reset, accessMethod=accessMethod, cambium=cambium, antennaGain=antennaGain, phyControl=phyControl, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpGroups=ptpGroups, userEnabled=userEnabled, pubStats=pubStats, sNTPLastSync=sNTPLastSync, ethernetFiberSupport=ethernetFiberSupport, vectorError=vectorError, syslogControlGroup=syslogControlGroup, dfsMeans=dfsMeans, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, systemClock=systemClock, receiveFreqKHz=receiveFreqKHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveDataRate=receiveDataRate, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortDisabledWarning=dataPortDisabledWarning, frequencyVariant=frequencyVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, receiveChannel=receiveChannel, installArmState=installArmState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenceGroup=licenceGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry)
