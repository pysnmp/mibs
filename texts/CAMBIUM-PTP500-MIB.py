...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, installStatus=installStatus, ptp500=ptp500, syslogControlGroup=syslogControlGroup, sNMPTrapTable=sNMPTrapTable, encryptionAlgorithm=encryptionAlgorithm, transmitChannel=transmitChannel, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPSyncTrap=sNTPSyncTrap, sntpGroup=sntpGroup, dfsGroup=dfsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vectorError=vectorError, accessMethod=accessMethod, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, transmitDataRate=transmitDataRate, channelChangeTrap=channelChangeTrap, userTableEntry=userTableEntry, ptpTrapPrefix=ptpTrapPrefix, dataPortStatusTrap=dataPortStatusTrap, dfsPeaks=dfsPeaks, constantPowerSpectralDensity=constantPowerSpectralDensity, timeZone=timeZone, dfsTableEntry=dfsTableEntry, searchState=searchState, telecomGroup=telecomGroup, ptpGroups=ptpGroups, range=range, syslogState=syslogState, remoteIPAddress=remoteIPAddress, telnetPortNumber=telnetPortNumber, linkSymmetry=linkSymmetry, syslogClientTrap=syslogClientTrap, snmpControl=snmpControl, telecomsCableLength=telecomsCableLength, sNTPSync=sNTPSync, sNMPEnabledTraps=sNMPEnabledTraps, licenceGroup=licenceGroup, cambium=cambium, aAAControlGroup=aAAControlGroup, ptpCompliance=ptpCompliance, signalStrengthRatio=signalStrengthRatio, longitude=longitude, sMTPEnabledMessages=sMTPEnabledMessages, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityQueueMapping=vLANPriorityQueueMapping, configuration=configuration, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, altitude=altitude, smtp=smtp, licence=licence, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPServerPortNumber=tFTPServerPortNumber, dfsTableIndex=dfsTableIndex, dataPortAutoMdix=dataPortAutoMdix, receivePower=receivePower, transmitFreqMHz=transmitFreqMHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, hTTPSPortNumber=hTTPSPortNumber, encryptionGroup=encryptionGroup, bootVersion=bootVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, sMTPEmailAlert=sMTPEmailAlert, ptp=ptp, groupID=groupID, sNTPState=sNTPState, notificationsGroup=notificationsGroup, userName=userName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userEnabled=userEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, iPAddress=iPAddress, phyControlGroup=phyControlGroup, targetMACAddress=targetMACAddress, linkLoss=linkLoss, ptpTraps=ptpTraps, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogStateTrap=syslogStateTrap, regionCodeTrap=regionCodeTrap, pubStatsGroup=pubStatsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableNumber=dfsTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationMode=tDDSynchronizationMode, telecomsInterface=telecomsInterface, supplementary=supplementary, systemClock=systemClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernet=ethernet, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitPower=transmitPower, siteName=siteName, subnetMask=subnetMask, vLANManagementVID=vLANManagementVID, alarms=alarms, tFTPServerIPAddress=tFTPServerIPAddress, managementGroup=managementGroup, pubStats=pubStats, dfs=dfs, receiveChannel=receiveChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installArmState=installArmState, userRole=userRole, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsLineCode=telecomsLineCode, transmitModulationMode=transmitModulationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimisation=linkModeOptimisation, byteErrorRatio=byteErrorRatio, sNTPLastSync=sNTPLastSync, unitOutOfCalibration=unitOutOfCalibration, alarmsGroup=alarmsGroup, wirelessLinkAvailability=wirelessLinkAvailability, phyControl=phyControl, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, bandwidthVariant=bandwidthVariant, installStatusTrap=installStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPAccessEnabled=hTTPAccessEnabled, softwareVersion=softwareVersion, aAAControl=aAAControl, aggregateDataRate=aggregateDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryption=encryption, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveFreqMHz=receiveFreqMHz, ethernetFiberSupport=ethernetFiberSupport, systemReset=systemReset, receiveModulationModeDetail=receiveModulationModeDetail, versionsGroup=versionsGroup, syslogControl=syslogControl, sNMPPortNumber=sNMPPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, phyStatus=phyStatus, dfsMeans=dfsMeans, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatch=linkModeOptimizationMismatch, versions=versions, userPassword=userPassword, phyStatusGroup=phyStatusGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPPollInterval=sNTPPollInterval, sNMPTrapVersion=sNMPTrapVersion, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, supplementaryGroup=supplementaryGroup, sntp=sntp, userTableNumber=userTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkName=linkName, transmitFreqKHz=transmitFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, management=management, maximumTransmitPower=maximumTransmitPower, configurationGroup=configurationGroup, channelBandwidth=channelBandwidth, ptmp=ptmp, userTable=userTable, daylightSaving=daylightSaving, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, productName=productName, masterSlaveMode=masterSlaveMode, licensedCapacity=licensedCapacity, smtpGroup=smtpGroup, antennaGain=antennaGain, secondarySoftwareVersion=secondarySoftwareVersion, vLANManagementPriority=vLANManagementPriority, snmpControlGroup=snmpControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, hardwareVersion=hardwareVersion, vLANPriorityTable=vLANPriorityTable, hTTPPortNumber=hTTPPortNumber, receiveFreqKHz=receiveFreqKHz, reset=reset, dataPortStatus=dataPortStatus, wirelessLinkStatus=wirelessLinkStatus, latitude=latitude, installArmStateTrap=installArmStateTrap, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerPortNumber=sNTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsLoopback=telecomsLoopback, dfsTable=dfsTable, frequencyVariant=frequencyVariant, telecomsChannelStatus=telecomsChannelStatus, resetGroup=resetGroup, syslogClient=syslogClient, tDDControl=tDDControl, userTableIndex=userTableIndex, PYSNMP_MODULE_ID=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, eIRP=eIRP, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecom=telecom)
