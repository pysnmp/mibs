...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", wirelessLinkStatus=wirelessLinkStatus, ptpTraps=ptpTraps, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyStatus=phyStatus, dataPortStatus=dataPortStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsMeans=dfsMeans, linkName=linkName, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControl=aAAControl, sNTPServerPortNumber=sNTPServerPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkLoss=linkLoss, constantPowerSpectralDensity=constantPowerSpectralDensity, unitOutOfCalibration=unitOutOfCalibration, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, encryption=encryption, subnetMask=subnetMask, userRole=userRole, telnetAccessEnabled=telnetAccessEnabled, dfsTable=dfsTable, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userEnabled=userEnabled, syslogControlGroup=syslogControlGroup, transmitFreqKHz=transmitFreqKHz, sntpGroup=sntpGroup, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSync=sNTPSync, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, timeZone=timeZone, versions=versions, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licensedCapacity=licensedCapacity, transmitChannel=transmitChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, pubStats=pubStats, dataPortAutoMdix=dataPortAutoMdix, dataPortStatusTrap=dataPortStatusTrap, incompatibleRegionCodes=incompatibleRegionCodes, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, byteErrorRatio=byteErrorRatio, smtpGroup=smtpGroup, syslogClient=syslogClient, resetGroup=resetGroup, telecomsCableLength=telecomsCableLength, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableNumber=userTableNumber, supplementary=supplementary, capacityLicenseMismatch=capacityLicenseMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, ptpGroups=ptpGroups, sMTPEmailAlert=sMTPEmailAlert, hTTPPortNumber=hTTPPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, masterSlaveMode=masterSlaveMode, receiveFreqMHz=receiveFreqMHz, configurationGroup=configurationGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, hardwareVersion=hardwareVersion, receiveFreqKHz=receiveFreqKHz, ptp500=ptp500, telnetPortNumber=telnetPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveDataRate=receiveDataRate, signalStrengthRatio=signalStrengthRatio, ethernetGroup=ethernetGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitModulationMode=transmitModulationMode, eIRP=eIRP, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsPeaks=dfsPeaks, regionCodeTrap=regionCodeTrap, vLANManagementPriority=vLANManagementPriority, installArmState=installArmState, iPAddress=iPAddress, gatewayIPAddress=gatewayIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, daylightSaving=daylightSaving, syslogState=syslogState, systemReset=systemReset, telecomsLineCode=telecomsLineCode, range=range, latitude=latitude, sNMPTrapPortNumber=sNMPTrapPortNumber, alarms=alarms, vectorError=vectorError, telecomsLoopback=telecomsLoopback, tDDSynchronizationMode=tDDSynchronizationMode, longitude=longitude, installStatusTrap=installStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, groupID=groupID, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptmp=ptmp, vLANPriorityTableIndex=vLANPriorityTableIndex, dfs=dfs, reset=reset, cambium=cambium, dfsTableIndex=dfsTableIndex, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, altitude=altitude, sMTPServerIPAddress=sMTPServerIPAddress, dfsTableEntry=dfsTableEntry, phyStatusGroup=phyStatusGroup, aAAControlGroup=aAAControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionAlgorithm=encryptionAlgorithm, receiveModulationModeDetail=receiveModulationModeDetail, tFTPServerIPAddress=tFTPServerIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, transmitFreqMHz=transmitFreqMHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyControlGroup=phyControlGroup, snmpControl=snmpControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, phyControl=phyControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userPassword=userPassword, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPSyncTrap=sNTPSyncTrap, receiveChannel=receiveChannel, transmitDataRate=transmitDataRate, dfsGroup=dfsGroup, productVariant=productVariant, wirelessLinkAvailability=wirelessLinkAvailability, notificationsGroup=notificationsGroup, licence=licence, tDDControlGroup=tDDControlGroup, supplementaryGroup=supplementaryGroup, siteName=siteName, antennaGain=antennaGain, management=management, regionCode=regionCode, sNMPv3Enable=sNMPv3Enable, searchState=searchState, configuration=configuration, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, maximumTransmitPower=maximumTransmitPower, productName=productName, versionsGroup=versionsGroup, receivePower=receivePower, sntp=sntp, receiveModulationMode=receiveModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, tFTPServerPortNumber=tFTPServerPortNumber, smtp=smtp, channelBandwidth=channelBandwidth, installArmStateTrap=installArmStateTrap, sNTPPollInterval=sNTPPollInterval, userTable=userTable, accessMethod=accessMethod, sNMPTrapVersion=sNMPTrapVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecom=telecom, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimisation=linkModeOptimisation, telecomsChannelStatus=telecomsChannelStatus, ethernet=ethernet, encryptionGroup=encryptionGroup, targetMACAddress=targetMACAddress, frequencyVariant=frequencyVariant, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, bandwidthVariant=bandwidthVariant, managementGroup=managementGroup, transmitPower=transmitPower, sMTPServerPortNumber=sMTPServerPortNumber, userName=userName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogControl=syslogControl, vLANManagementVID=vLANManagementVID, softwareVersion=softwareVersion, sNTPLastSync=sNTPLastSync, telecomsInterface=telecomsInterface, userTableEntry=userTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installStatus=installStatus, channelChangeTrap=channelChangeTrap, sNTPState=sNTPState, hTTPSPortNumber=hTTPSPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStatsGroup=pubStatsGroup, userTableIndex=userTableIndex, syslogStateTrap=syslogStateTrap, telecomGroup=telecomGroup, sNMPTrapTable=sNMPTrapTable, ptp=ptp, tDDControl=tDDControl, ethernetFiberSupport=ethernetFiberSupport, hTTPAccessEnabled=hTTPAccessEnabled, alarmsGroup=alarmsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPPortNumber=sNMPPortNumber, syslogClientTrap=syslogClientTrap, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANPriorityTable=vLANPriorityTable, sMTPEnabledMessages=sMTPEnabledMessages)
