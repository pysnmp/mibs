...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", aAAControl=aAAControl, ptpTraps=ptpTraps, subnetMask=subnetMask, dataPortDisabledWarning=dataPortDisabledWarning, syslogState=syslogState, licenceGroup=licenceGroup, hTTPPortNumber=hTTPPortNumber, userEnabled=userEnabled, transmitFreqMHz=transmitFreqMHz, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsLoopbackTrap=telecomsLoopbackTrap, versions=versions, tDDSynchronizationMode=tDDSynchronizationMode, resetGroup=resetGroup, receiveFreqMHz=receiveFreqMHz, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, userTableNumber=userTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, dfsTableNumber=dfsTableNumber, range=range, ptmp=ptmp, supplementaryGroup=supplementaryGroup, antennaGain=antennaGain, alarms=alarms, transmitPower=transmitPower, incompatibleRegionCodes=incompatibleRegionCodes, masterSlaveMode=masterSlaveMode, transmitFreqKHz=transmitFreqKHz, targetMACAddress=targetMACAddress, ethernetFiberSupport=ethernetFiberSupport, transmitChannel=transmitChannel, softwareVersion=softwareVersion, telecom=telecom, supplementary=supplementary, groupID=groupID, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPState=sNTPState, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemClock=systemClock, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, versionsGroup=versionsGroup, userTable=userTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemReset=systemReset, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, ptpGroups=ptpGroups, sNTPServerIPAddress=sNTPServerIPAddress, aggregateDataRate=aggregateDataRate, snmpControl=snmpControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitModulationMode=transmitModulationMode, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPollInterval=sNTPPollInterval, linkLoss=linkLoss, dfsTableIndex=dfsTableIndex, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userRole=userRole, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installArmStateTrap=installArmStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, smtpGroup=smtpGroup, eIRP=eIRP, channelBandwidth=channelBandwidth, sMTPEmailAlert=sMTPEmailAlert, syslogControl=syslogControl, dfsTableEntry=dfsTableEntry, phyControl=phyControl, telecomsChannelStatusTrap=telecomsChannelStatusTrap, installStatus=installStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, siteName=siteName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsGroup=dfsGroup, longitude=longitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, installStatusTrap=installStatusTrap, sNTPLastSync=sNTPLastSync, vLANPriorityTable=vLANPriorityTable, ptpCompliance=ptpCompliance, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, regionCode=regionCode, pubStatsGroup=pubStatsGroup, licensedCapacity=licensedCapacity, latitude=latitude, hTTPAccessEnabled=hTTPAccessEnabled, notificationsGroup=notificationsGroup, dataPortAutoMdix=dataPortAutoMdix, configuration=configuration, vLANPriorityTableIndex=vLANPriorityTableIndex, installArmState=installArmState, sntpGroup=sntpGroup, dfs=dfs, bootVersion=bootVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatusTrap=dataPortStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sntp=sntp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licence=licence, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receivePower=receivePower, syslogClientTrap=syslogClientTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPServerPortNumber=sMTPServerPortNumber, transmitDataRate=transmitDataRate, pubStats=pubStats, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogControlGroup=syslogControlGroup, sNTPSync=sNTPSync, iPAddress=iPAddress, wirelessLinkStatus=wirelessLinkStatus, vLANManagementVID=vLANManagementVID, receiveModulationModeDetail=receiveModulationModeDetail, secondarySoftwareVersion=secondarySoftwareVersion, receiveChannel=receiveChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsLineCode=telecomsLineCode, tFTPServerIPAddress=tFTPServerIPAddress, vectorError=vectorError, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementGroup=managementGroup, altitude=altitude, syslogClient=syslogClient, linkSymmetry=linkSymmetry, aAAControlGroup=aAAControlGroup, telecomsLoopback=telecomsLoopback, sNMPTrapTable=sNMPTrapTable, userTableIndex=userTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDControl=tDDControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, cambium=cambium, telecomsInterface=telecomsInterface, syslogStateTrap=syslogStateTrap, channelChangeTrap=channelChangeTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, byteErrorRatio=byteErrorRatio, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, accessMethod=accessMethod, gatewayIPAddress=gatewayIPAddress, telecomsCableLength=telecomsCableLength, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, sNTPSyncTrap=sNTPSyncTrap, receiveDataRate=receiveDataRate, signalStrengthRatio=signalStrengthRatio, linkName=linkName, dfsPeaks=dfsPeaks, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsChannelStatus=telecomsChannelStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionGroup=encryptionGroup, regionCodeTrap=regionCodeTrap, productName=productName, configurationGroup=configurationGroup, userPassword=userPassword, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, reset=reset, ptpTrapPrefix=ptpTrapPrefix, hTTPSPortNumber=hTTPSPortNumber, vLANManagementPriority=vLANManagementPriority, linkModeOptimisation=linkModeOptimisation, sMTPServerIPAddress=sMTPServerIPAddress, cableLoss=cableLoss, dfsTable=dfsTable, ptp500=ptp500, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPEnabledTraps=sNMPEnabledTraps, telnetPortNumber=telnetPortNumber, daylightSaving=daylightSaving, PYSNMP_MODULE_ID=cambium, phyStatus=phyStatus, searchState=searchState, snmpControlGroup=snmpControlGroup, encryption=encryption, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, userName=userName, maximumTransmitPower=maximumTransmitPower, phyStatusGroup=phyStatusGroup, bandwidthVariant=bandwidthVariant, userTableEntry=userTableEntry, hardwareVersion=hardwareVersion, telecomGroup=telecomGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPv3Enable=sNMPv3Enable, dfsMeans=dfsMeans, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, phyControlGroup=phyControlGroup, tDDControlGroup=tDDControlGroup, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapTableNumber=sNMPTrapTableNumber)
