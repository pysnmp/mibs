...
# Produced by pysmi-1.1.3 at Tue Dec  7 16:53:14 2021
...
IpAddress, ModuleIdentity, Counter32, ObjectIdentity, Counter64, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, Integer32, enterprises, TimeTicks, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Counter32", "ObjectIdentity", "Counter64", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "Integer32", "enterprises", "TimeTicks", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapPortNumber=sNMPTrapPortNumber, linkSymmetry=linkSymmetry, channelBandwidth=channelBandwidth, supplementary=supplementary, transmitDataRate=transmitDataRate, userTable=userTable, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitPower=transmitPower, userTableNumber=userTableNumber, installStatusTrap=installStatusTrap, ptpCompliance=ptpCompliance, telecomGroup=telecomGroup, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, antennaGain=antennaGain, hardwareVersion=hardwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, versionsGroup=versionsGroup, cambium=cambium, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, telnetPortNumber=telnetPortNumber, receiveFreqMHz=receiveFreqMHz, telecomsLineCode=telecomsLineCode, range=range, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableIndex=userTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, ptmp=ptmp, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, syslogClient=syslogClient, syslogControlGroup=syslogControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, encryptionGroup=encryptionGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, systemClock=systemClock, bootVersion=bootVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableNumber=dfsTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenceGroup=licenceGroup, sMTPEmailAlert=sMTPEmailAlert, altitude=altitude, sNMPTrapIPAddress=sNMPTrapIPAddress, vectorError=vectorError, encryptionAlgorithm=encryptionAlgorithm, bandwidthVariant=bandwidthVariant, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPPortNumber=hTTPPortNumber, sNMPCommunityString=sNMPCommunityString, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsMeans=dfsMeans, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTable=sNMPTrapTable, dfsGroup=dfsGroup, telecom=telecom, ptpGroups=ptpGroups, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sMTPServerPortNumber=sMTPServerPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsCableLength=telecomsCableLength, vLANPriorityTableNumber=vLANPriorityTableNumber, smtp=smtp, sNTPServerIPAddress=sNTPServerIPAddress, reset=reset, hTTPAccessEnabled=hTTPAccessEnabled, sNTPState=sNTPState, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarmsGroup=alarmsGroup, receiveModulationModeDetail=receiveModulationModeDetail, snmpControlGroup=snmpControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptp=ptp, encryption=encryption, vLANManagementPriority=vLANManagementPriority, pubStatsGroup=pubStatsGroup, aAAControlGroup=aAAControlGroup, receivePower=receivePower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableIndex=dfsTableIndex, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, daylightSaving=daylightSaving, syslogClientTrap=syslogClientTrap, configurationGroup=configurationGroup, installArmStateTrap=installArmStateTrap, syslogState=syslogState, signalStrengthRatio=signalStrengthRatio, softwareVersion=softwareVersion, phyControl=phyControl, wirelessLinkStatus=wirelessLinkStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userPassword=userPassword, vLANPriorityTableIndex=vLANPriorityTableIndex, smtpGroup=smtpGroup, transmitFreqMHz=transmitFreqMHz, dataPortStatus=dataPortStatus, searchState=searchState, alarms=alarms, management=management, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpTraps=ptpTraps, hTTPSPortNumber=hTTPSPortNumber, vLANPriorityTable=vLANPriorityTable, transmitModulationMode=transmitModulationMode, versions=versions, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, resetGroup=resetGroup, dfsTableEntry=dfsTableEntry, installArmState=installArmState, transmitFreqKHz=transmitFreqKHz, iPAddress=iPAddress, phyStatusGroup=phyStatusGroup, gatewayIPAddress=gatewayIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPLastSync=sNTPLastSync, telecomsInterface=telecomsInterface, managementGroup=managementGroup, systemReset=systemReset, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, longitude=longitude, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, ethernetFiberSupport=ethernetFiberSupport, constantPowerSpectralDensity=constantPowerSpectralDensity, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, telecomsChannelStatus=telecomsChannelStatus, syslogStateTrap=syslogStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, phyStatus=phyStatus, sNMPv3Enable=sNMPv3Enable, accessMethod=accessMethod, userEnabled=userEnabled, dataPortAutoMdix=dataPortAutoMdix, dataPortWirelessDownAlert=dataPortWirelessDownAlert, groupID=groupID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, ptp500=ptp500, receiveModulationMode=receiveModulationMode, frequencyVariant=frequencyVariant, ethernetGroup=ethernetGroup, linkName=linkName, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDControlGroup=tDDControlGroup, telecomsLoopback=telecomsLoopback, receiveFreqKHz=receiveFreqKHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntp=sntp, supplementaryGroup=supplementaryGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortStatusTrap=dataPortStatusTrap, masterSlaveMode=masterSlaveMode, byteErrorRatio=byteErrorRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userRole=userRole, sNTPSyncTrap=sNTPSyncTrap, vLANManagementVID=vLANManagementVID, tFTPServerPortNumber=tFTPServerPortNumber, userTableEntry=userTableEntry, eIRP=eIRP, tDDControl=tDDControl, channelChangeTrap=channelChangeTrap, snmpControl=snmpControl, dfs=dfs, dataPortDisabledWarning=dataPortDisabledWarning, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, PYSNMP_MODULE_ID=cambium, notificationsGroup=notificationsGroup, regionCode=regionCode, licensedCapacity=licensedCapacity, linkModeOptimisation=linkModeOptimisation, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPollInterval=sNTPPollInterval, phyControlGroup=phyControlGroup, targetMACAddress=targetMACAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, latitude=latitude, receiveChannel=receiveChannel, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPEnabledMessages=sMTPEnabledMessages, transmitChannel=transmitChannel, regionCodeTrap=regionCodeTrap, receiveDataRate=receiveDataRate, productName=productName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsPeaks=dfsPeaks, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installStatus=installStatus, configuration=configuration, productVariant=productVariant, syslogControl=syslogControl, sNTPSync=sNTPSync, telecomsLoopbackTrap=telecomsLoopbackTrap, capacityLicenseMismatch=capacityLicenseMismatch, siteName=siteName, dfsTable=dfsTable, userName=userName, linkLoss=linkLoss, pubStats=pubStats, aAAControl=aAAControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibration=unitOutOfCalibration, subnetMask=subnetMask, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sntpGroup=sntpGroup)
