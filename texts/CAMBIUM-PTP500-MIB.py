...
Gauge32, Integer32, Counter64, enterprises, MibIdentifier, IpAddress, Counter32, ObjectIdentity, Unsigned32, iso, ModuleIdentity, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "Counter64", "enterprises", "MibIdentifier", "IpAddress", "Counter32", "ObjectIdentity", "Unsigned32", "iso", "ModuleIdentity", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userEnabled=userEnabled, iPAddress=iPAddress, remoteIPAddress=remoteIPAddress, telecom=telecom, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemReset=systemReset, dfsTable=dfsTable, vLANManagementPriority=vLANManagementPriority, targetMACAddress=targetMACAddress, latitude=latitude, linkLoss=linkLoss, longitude=longitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRate=transmitDataRate, tDDSynchronizationMode=tDDSynchronizationMode, channelChangeTrap=channelChangeTrap, syslogState=syslogState, syslogControlGroup=syslogControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementVID=vLANManagementVID, telecomGroup=telecomGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, userRole=userRole, softwareVersion=softwareVersion, userTableIndex=userTableIndex, vectorError=vectorError, sNTPState=sNTPState, syslogClient=syslogClient, sNTPServerIPAddress=sNTPServerIPAddress, userTable=userTable, dataPortAutoNegotiation=dataPortAutoNegotiation, incompatibleRegionCodes=incompatibleRegionCodes, maximumTransmitPower=maximumTransmitPower, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, telnetAccessEnabled=telnetAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityTableIndex=vLANPriorityTableIndex, productVariant=productVariant, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsGroup=dfsGroup, managementGroup=managementGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDControl=tDDControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, userName=userName, alarms=alarms, installArmStateTrap=installArmStateTrap, telecomsInterface=telecomsInterface, transmitModulationMode=transmitModulationMode, regionCodeTrap=regionCodeTrap, bootVersion=bootVersion, sntpGroup=sntpGroup, dataPortDisabledWarning=dataPortDisabledWarning, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptmp=ptmp, receiveFreqKHz=receiveFreqKHz, aggregateDataRate=aggregateDataRate, configurationGroup=configurationGroup, range=range, sntp=sntp, timeZone=timeZone, bandwidthVariant=bandwidthVariant, hardwareVersion=hardwareVersion, byteErrorRatio=byteErrorRatio, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, smtp=smtp, versions=versions, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableEntry=userTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, altitude=altitude, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, hTTPSPortNumber=hTTPSPortNumber, receiveFreqMHz=receiveFreqMHz, receiveChannel=receiveChannel, ptpTraps=ptpTraps, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatusTrap=installStatusTrap, searchState=searchState, receivePower=receivePower, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimisation=linkModeOptimisation, signalStrengthRatio=signalStrengthRatio, dfsTableIndex=dfsTableIndex, phyControl=phyControl, smtpGroup=smtpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configuration=configuration, syslogStateTrap=syslogStateTrap, ethernet=ethernet, hTTPPortNumber=hTTPPortNumber, systemClock=systemClock, tFTPServerPortNumber=tFTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, phyStatusGroup=phyStatusGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableEntry=dfsTableEntry, dfsMeans=dfsMeans, siteName=siteName, sNMPPortNumber=sNMPPortNumber, ethernetGroup=ethernetGroup, ethernetFiberSupport=ethernetFiberSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortStatusTrap=dataPortStatusTrap, ptpCompliance=ptpCompliance, licence=licence, groupID=groupID, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPEnabledMessages=sMTPEnabledMessages, userTableNumber=userTableNumber, dfs=dfs, transmitFreqMHz=transmitFreqMHz, resetGroup=resetGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapTable=sNMPTrapTable, regionCode=regionCode, secondarySoftwareVersion=secondarySoftwareVersion, reset=reset, ptp500=ptp500, receiveDataRate=receiveDataRate, cableLoss=cableLoss, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cambium=cambium, sNMPEnabledTraps=sNMPEnabledTraps, syslogControl=syslogControl, transmitFreqKHz=transmitFreqKHz, ptp=ptp, pubStats=pubStats, daylightSaving=daylightSaving, eIRP=eIRP, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoMdix=dataPortAutoMdix, licensedCapacity=licensedCapacity, dfsTableNumber=dfsTableNumber, antennaGain=antennaGain, receiveModulationModeDetail=receiveModulationModeDetail, accessMethod=accessMethod, capacityLicenseMismatch=capacityLicenseMismatch, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkSymmetry=linkSymmetry, transmitPower=transmitPower, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsPeaks=dfsPeaks, PYSNMP_MODULE_ID=cambium, phyControlGroup=phyControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortStatus=dataPortStatus, encryptionGroup=encryptionGroup, sNMPTrapVersion=sNMPTrapVersion, sNTPLastSync=sNTPLastSync, noWirelessChannelAvailable=noWirelessChannelAvailable, telnetPortNumber=telnetPortNumber, pubStatsGroup=pubStatsGroup, productName=productName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsLoopback=telecomsLoopback, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPPollInterval=sNTPPollInterval, supplementaryGroup=supplementaryGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkAvailability=wirelessLinkAvailability, encryption=encryption, userPassword=userPassword, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPSync=sNTPSync, telecomsLineCode=telecomsLineCode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, aAAControl=aAAControl, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, supplementary=supplementary, notificationsGroup=notificationsGroup, installArmState=installArmState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarmsGroup=alarmsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpGroups=ptpGroups, management=management, tDDControlGroup=tDDControlGroup, linkName=linkName, frequencyVariant=frequencyVariant, tFTPServerIPAddress=tFTPServerIPAddress, transmitChannel=transmitChannel, telecomsCableLength=telecomsCableLength, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aAAControlGroup=aAAControlGroup, wirelessLinkStatus=wirelessLinkStatus, versionsGroup=versionsGroup, licenceGroup=licenceGroup, installStatus=installStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTable=vLANPriorityTable, subnetMask=subnetMask, syslogClientTrap=syslogClientTrap, gatewayIPAddress=gatewayIPAddress)
