...
# Produced by pysmi-1.1.12 at Wed May 29 10:53:07 2024
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDSynchronizationMode=tDDSynchronizationMode, ptpTraps=ptpTraps, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licenceGroup=licenceGroup, telnetAccessEnabled=telnetAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, telecomsLoopback=telecomsLoopback, antennaGain=antennaGain, pubStatsGroup=pubStatsGroup, configuration=configuration, signalStrengthRatio=signalStrengthRatio, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, longitude=longitude, sNMPPortNumber=sNMPPortNumber, cableLoss=cableLoss, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableEntry=userTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitChannel=transmitChannel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveDataRate=receiveDataRate, ethernetGroup=ethernetGroup, ptmp=ptmp, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, range=range, hTTPPortNumber=hTTPPortNumber, telnetPortNumber=telnetPortNumber, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomGroup=telecomGroup, ptpTrapPrefix=ptpTrapPrefix, tDDControlGroup=tDDControlGroup, dfsTableNumber=dfsTableNumber, systemClock=systemClock, aAAControlGroup=aAAControlGroup, sNTPState=sNTPState, vLANManagementVID=vLANManagementVID, dfsGroup=dfsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEmailAlert=sMTPEmailAlert, receiveChannel=receiveChannel, alarms=alarms, vLANPriorityTableIndex=vLANPriorityTableIndex, productName=productName, alarmsGroup=alarmsGroup, vectorError=vectorError, sNTPLastSync=sNTPLastSync, sNTPServerIPAddress=sNTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, supplementary=supplementary, sNMPv3Enable=sNMPv3Enable, dfsTableEntry=dfsTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitPower=transmitPower, unitOutOfCalibration=unitOutOfCalibration, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tDDControl=tDDControl, subnetMask=subnetMask, bootVersion=bootVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, supplementaryGroup=supplementaryGroup, phyStatusGroup=phyStatusGroup, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPServerPortNumber=sNTPServerPortNumber, reset=reset, userPassword=userPassword, capacityLicenseMismatch=capacityLicenseMismatch, syslogState=syslogState, siteName=siteName, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, encryptionAlgorithm=encryptionAlgorithm, telecomsLoopbackTrap=telecomsLoopbackTrap, remoteIPAddress=remoteIPAddress, smtp=smtp, telecomsCableLength=telecomsCableLength, ptpGroups=ptpGroups, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitFreqMHz=transmitFreqMHz, sNTPSync=sNTPSync, linkName=linkName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installArmState=installArmState, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, altitude=altitude, snmpControl=snmpControl, sNMPTrapTableNumber=sNMPTrapTableNumber, sntp=sntp, sMTPServerPortNumber=sMTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, bandwidthVariant=bandwidthVariant, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, phyStatus=phyStatus, accessMethod=accessMethod, telecomsInterface=telecomsInterface, dataPortAutoMdix=dataPortAutoMdix, targetMACAddress=targetMACAddress, userTableNumber=userTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementGroup=managementGroup, resetGroup=resetGroup, notificationsGroup=notificationsGroup, daylightSaving=daylightSaving, syslogStateTrap=syslogStateTrap, masterSlaveMode=masterSlaveMode, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPCommunityString=sNMPCommunityString, installStatus=installStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTable=sNMPTrapTable, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, userTable=userTable, softwareVersion=softwareVersion, licence=licence, dfsTableIndex=dfsTableIndex, dfsMeans=dfsMeans, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmStateTrap=installArmStateTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, encryption=encryption, syslogControl=syslogControl, latitude=latitude, dataPortStatus=dataPortStatus, regionCodeTrap=regionCodeTrap, ptp=ptp, systemReset=systemReset, timeZone=timeZone, phyControlGroup=phyControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, versions=versions, syslogClient=syslogClient, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfs=dfs, telecom=telecom, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, linkModeOptimisation=linkModeOptimisation, receiveFreqMHz=receiveFreqMHz, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkLoss=linkLoss, iPAddress=iPAddress, aAAControl=aAAControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, channelChangeTrap=channelChangeTrap, userTableIndex=userTableIndex, ptp500=ptp500, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, licensedCapacity=licensedCapacity, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, regionCode=regionCode, vLANPriorityTable=vLANPriorityTable, vLANManagementPriority=vLANManagementPriority, transmitModulationMode=transmitModulationMode, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkStatus=wirelessLinkStatus, ethernet=ethernet, groupID=groupID, userRole=userRole, dfsTable=dfsTable, receivePower=receivePower, dfsPeaks=dfsPeaks, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsChannelStatus=telecomsChannelStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsLineCode=telecomsLineCode, gatewayIPAddress=gatewayIPAddress, byteErrorRatio=byteErrorRatio, encryptionGroup=encryptionGroup, userName=userName, installStatusTrap=installStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, frequencyVariant=frequencyVariant, linkSymmetry=linkSymmetry, configurationGroup=configurationGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBandwidth=channelBandwidth, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetFiberSupport=ethernetFiberSupport, cambium=cambium, pubStats=pubStats, sntpGroup=sntpGroup, transmitDataRate=transmitDataRate, sNTPSyncTrap=sNTPSyncTrap, phyControl=phyControl, sNMPTrapVersion=sNMPTrapVersion, eIRP=eIRP, searchState=searchState, userEnabled=userEnabled, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber)
