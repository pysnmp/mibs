...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", licence=licence, receivePower=receivePower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogClient=syslogClient, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyStatusGroup=phyStatusGroup, telecomsLineCode=telecomsLineCode, telecom=telecom, ptpTrapPrefix=ptpTrapPrefix, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userName=userName, vLANPriorityTable=vLANPriorityTable, sNMPv3Enable=sNMPv3Enable, productName=productName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, byteErrorRatio=byteErrorRatio, secondarySoftwareVersion=secondarySoftwareVersion, ptp500=ptp500, licenceGroup=licenceGroup, sNTPLastSync=sNTPLastSync, channelBandwidth=channelBandwidth, capacityLicenseMismatch=capacityLicenseMismatch, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, userEnabled=userEnabled, altitude=altitude, dfsTableEntry=dfsTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, productVariant=productVariant, configurationGroup=configurationGroup, dfsTable=dfsTable, dfsPeaks=dfsPeaks, tDDControl=tDDControl, targetMACAddress=targetMACAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpCompliance=ptpCompliance, ethernet=ethernet, tDDControlGroup=tDDControlGroup, userTableNumber=userTableNumber, userPassword=userPassword, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitModulationMode=transmitModulationMode, userTableEntry=userTableEntry, transmitChannel=transmitChannel, dataPortStatusTrap=dataPortStatusTrap, syslogStateTrap=syslogStateTrap, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTable=sNMPTrapTable, regionCodeTrap=regionCodeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, accessMethod=accessMethod, hTTPPortNumber=hTTPPortNumber, dfsMeans=dfsMeans, versionsGroup=versionsGroup, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsLoopback=telecomsLoopback, receiveModulationModeDetail=receiveModulationModeDetail, alarms=alarms, sNMPPortNumber=sNMPPortNumber, regionCode=regionCode, sNTPSync=sNTPSync, syslogState=syslogState, encryptionGroup=encryptionGroup, tFTPServerPortNumber=tFTPServerPortNumber, phyStatus=phyStatus, timeZone=timeZone, userRole=userRole, cableLoss=cableLoss, aAAControl=aAAControl, dfsGroup=dfsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, daylightSaving=daylightSaving, tDDSynchronizationMode=tDDSynchronizationMode, longitude=longitude, cambium=cambium, resetGroup=resetGroup, management=management, telecomsCableLength=telecomsCableLength, siteName=siteName, licensedCapacity=licensedCapacity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqKHz=transmitFreqKHz, sNTPServerPortNumber=sNTPServerPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, dfs=dfs, dataPortAutoMdix=dataPortAutoMdix, systemReset=systemReset, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPSAccessEnabled=hTTPSAccessEnabled, linkSymmetry=linkSymmetry, subnetMask=subnetMask, maximumTransmitPower=maximumTransmitPower, PYSNMP_MODULE_ID=cambium, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, eIRP=eIRP, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsInterface=telecomsInterface, phyControlGroup=phyControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkLoss=linkLoss, vLANPriorityQueueMapping=vLANPriorityQueueMapping, supplementaryGroup=supplementaryGroup, transmitFreqMHz=transmitFreqMHz, wirelessLinkStatus=wirelessLinkStatus, smtp=smtp, dfsTableNumber=dfsTableNumber, receiveFreqMHz=receiveFreqMHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEmailAlert=sMTPEmailAlert, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sntpGroup=sntpGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTable=userTable, snmpControl=snmpControl, sMTPEnabledMessages=sMTPEnabledMessages, receiveModulationMode=receiveModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableIndex=userTableIndex, range=range, sNMPTrapVersion=sNMPTrapVersion, telecomGroup=telecomGroup, ptp=ptp, ptpTraps=ptpTraps, versions=versions, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarmsGroup=alarmsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, sntp=sntp, receiveDataRate=receiveDataRate, dataPortStatus=dataPortStatus, pubStats=pubStats, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPServerPortNumber=sMTPServerPortNumber, notificationsGroup=notificationsGroup, installStatus=installStatus, bandwidthVariant=bandwidthVariant, incompatibleRegionCodes=incompatibleRegionCodes, ptmp=ptmp, sNTPServerIPAddress=sNTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableIndex=dfsTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, latitude=latitude, sNTPState=sNTPState, encryptionAlgorithm=encryptionAlgorithm, configuration=configuration, antennaGain=antennaGain, transmitDataRate=transmitDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vectorError=vectorError, ethernetFiberSupport=ethernetFiberSupport, linkName=linkName, managementGroup=managementGroup, linkModeOptimisation=linkModeOptimisation, channelChangeTrap=channelChangeTrap, searchState=searchState, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteMaximumTransmitPower=remoteMaximumTransmitPower, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelStatus=telecomsChannelStatus, unitOutOfCalibration=unitOutOfCalibration, masterSlaveMode=masterSlaveMode, remoteIPAddress=remoteIPAddress, installArmStateTrap=installArmStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPollInterval=sNTPPollInterval, encryption=encryption, softwareVersion=softwareVersion, bootVersion=bootVersion, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, reset=reset, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installArmState=installArmState, groupID=groupID, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, frequencyVariant=frequencyVariant, receiveChannel=receiveChannel, telnetAccessEnabled=telnetAccessEnabled, pubStatsGroup=pubStatsGroup, sNTPSyncTrap=sNTPSyncTrap, installStatusTrap=installStatusTrap, aggregateDataRate=aggregateDataRate, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogClientTrap=syslogClientTrap, telnetPortNumber=telnetPortNumber, ethernetGroup=ethernetGroup, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, signalStrengthRatio=signalStrengthRatio, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, smtpGroup=smtpGroup, vLANManagementPriority=vLANManagementPriority, syslogControl=syslogControl, transmitPower=transmitPower, syslogControlGroup=syslogControlGroup, hardwareVersion=hardwareVersion, gatewayIPAddress=gatewayIPAddress, aAAControlGroup=aAAControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, iPAddress=iPAddress, dataPortDisabledWarning=dataPortDisabledWarning, systemClock=systemClock, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPServerIPAddress=sMTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup)
