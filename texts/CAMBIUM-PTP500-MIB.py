...
Integer32, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32, ModuleIdentity, NotificationType, iso, IpAddress, Unsigned32, MibIdentifier, enterprises, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32", "ModuleIdentity", "NotificationType", "iso", "IpAddress", "Unsigned32", "MibIdentifier", "enterprises", "ObjectIdentity", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitFreqKHz=transmitFreqKHz, ptp=ptp, productName=productName, aAAControl=aAAControl, sNMPTrapTableIndex=sNMPTrapTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsInterface=telecomsInterface, incompatibleRegionCodes=incompatibleRegionCodes, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, licence=licence, reset=reset, telecomsCableLength=telecomsCableLength, userEnabled=userEnabled, tDDControlGroup=tDDControlGroup, sMTPServerIPAddress=sMTPServerIPAddress, userTableNumber=userTableNumber, telecomsLoopback=telecomsLoopback, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControlGroup=aAAControlGroup, telecomsChannelStatus=telecomsChannelStatus, cambium=cambium, telnetPortNumber=telnetPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, sntp=sntp, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANManagementVID=vLANManagementVID, linkName=linkName, dfsPeaks=dfsPeaks, subnetMask=subnetMask, systemClock=systemClock, bandwidthVariant=bandwidthVariant, management=management, ptmp=ptmp, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpGroups=ptpGroups, eIRP=eIRP, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpTraps=ptpTraps, secondarySoftwareVersion=secondarySoftwareVersion, sNMPEnabledTraps=sNMPEnabledTraps, sntpGroup=sntpGroup, encryptionGroup=encryptionGroup, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, latitude=latitude, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, unitOutOfCalibration=unitOutOfCalibration, telnetAccessEnabled=telnetAccessEnabled, softwareVersion=softwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, groupID=groupID, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarms=alarms, receiveChannel=receiveChannel, encryptionAlgorithm=encryptionAlgorithm, regionCodeTrap=regionCodeTrap, sNTPServerPortNumber=sNTPServerPortNumber, PYSNMP_MODULE_ID=cambium, sNMPTrapTable=sNMPTrapTable, searchState=searchState, userTable=userTable, maximumTransmitPower=maximumTransmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveModulationModeDetail=receiveModulationModeDetail, timeZone=timeZone, frequencyVariant=frequencyVariant, antennaGain=antennaGain, smtpGroup=smtpGroup, ptpCompliance=ptpCompliance, userName=userName, dfsTableIndex=dfsTableIndex, telecom=telecom, masterSlaveMode=masterSlaveMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, configuration=configuration, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmState=installArmState, receivePower=receivePower, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, managementGroup=managementGroup, ptp500=ptp500, channelBandwidth=channelBandwidth, configurationGroup=configurationGroup, targetMACAddress=targetMACAddress, sNTPSync=sNTPSync, installStatusTrap=installStatusTrap, sNTPState=sNTPState, syslogClientTrap=syslogClientTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, notificationsGroup=notificationsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, accessMethod=accessMethod, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsTableEntry=dfsTableEntry, ethernetGroup=ethernetGroup, telecomsLineCode=telecomsLineCode, linkLoss=linkLoss, sNMPTrapVersion=sNMPTrapVersion, bootVersion=bootVersion, licensedCapacity=licensedCapacity, vLANPriorityQueueMapping=vLANPriorityQueueMapping, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, longitude=longitude, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationMode=tDDSynchronizationMode, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aggregateDataRate=aggregateDataRate, hTTPSAccessEnabled=hTTPSAccessEnabled, snmpControl=snmpControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatus=installStatus, receiveFreqKHz=receiveFreqKHz, vectorError=vectorError, vLANPriorityTableIndex=vLANPriorityTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPAccessEnabled=hTTPAccessEnabled, ethernet=ethernet, supplementary=supplementary, sNTPServerIPAddress=sNTPServerIPAddress, channelChangeTrap=channelChangeTrap, sMTPEmailAlert=sMTPEmailAlert, linkSymmetry=linkSymmetry, sNTPPollInterval=sNTPPollInterval, dfsMeans=dfsMeans, licenceGroup=licenceGroup, regionCode=regionCode, syslogControlGroup=syslogControlGroup, sNMPv3Enable=sNMPv3Enable, dfsTableNumber=dfsTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, userRole=userRole, cableLoss=cableLoss, dataPortStatusTrap=dataPortStatusTrap, vLANManagementPriority=vLANManagementPriority, phyControl=phyControl, syslogControl=syslogControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installArmStateTrap=installArmStateTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogState=syslogState, phyControlGroup=phyControlGroup, linkModeOptimisation=linkModeOptimisation, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTableEntry=userTableEntry, transmitDataRate=transmitDataRate, ptpTrapPrefix=ptpTrapPrefix, siteName=siteName, userTableIndex=userTableIndex, sNTPSyncTrap=sNTPSyncTrap, smtp=smtp, iPAddress=iPAddress, dfsGroup=dfsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, pubStatsGroup=pubStatsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortStatus=dataPortStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, supplementaryGroup=supplementaryGroup, syslogStateTrap=syslogStateTrap, alarmsGroup=alarmsGroup, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, syslogClient=syslogClient, hTTPPortNumber=hTTPPortNumber, transmitChannel=transmitChannel, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoMdix=dataPortAutoMdix, telecomGroup=telecomGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPLastSync=sNTPLastSync, resetGroup=resetGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkStatus=wirelessLinkStatus, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, daylightSaving=daylightSaving, ethernetFiberSupport=ethernetFiberSupport, encryption=encryption, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userPassword=userPassword, tDDControl=tDDControl, signalStrengthRatio=signalStrengthRatio, capacityLicenseMismatch=capacityLicenseMismatch, productVariant=productVariant, transmitFreqMHz=transmitFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, versionsGroup=versionsGroup, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfs=dfs, range=range, remoteIPAddress=remoteIPAddress, snmpControlGroup=snmpControlGroup, dfsTable=dfsTable, altitude=altitude, phyStatusGroup=phyStatusGroup, receiveFreqMHz=receiveFreqMHz, phyStatus=phyStatus, vLANPriorityTable=vLANPriorityTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, systemReset=systemReset)
