...
# Produced by pysmi-1.1.12 at Tue Jun 18 02:32:19 2024
...
ModuleIdentity, enterprises, NotificationType, ObjectIdentity, Counter64, Counter32, MibIdentifier, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, TimeTicks, IpAddress, Gauge32, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "NotificationType", "ObjectIdentity", "Counter64", "Counter32", "MibIdentifier", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "TimeTicks", "IpAddress", "Gauge32", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ethernetFiberSupport=ethernetFiberSupport, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPEmailAlert=sMTPEmailAlert, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveFreqMHz=receiveFreqMHz, dataPortDisabledWarning=dataPortDisabledWarning, antennaGain=antennaGain, unitOutOfCalibration=unitOutOfCalibration, installArmStateTrap=installArmStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogStateTrap=syslogStateTrap, management=management, smtp=smtp, supplementary=supplementary, snmpControlGroup=snmpControlGroup, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatusGroup=phyStatusGroup, linkModeOptimisation=linkModeOptimisation, ptp=ptp, linkLoss=linkLoss, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, tDDSynchronizationMode=tDDSynchronizationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemReset=systemReset, dfsTableEntry=dfsTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, sntp=sntp, tDDControl=tDDControl, licence=licence, sNMPv3Enable=sNMPv3Enable, transmitPower=transmitPower, userPassword=userPassword, receiveModulationMode=receiveModulationMode, syslogClientTrap=syslogClientTrap, dfsPeaks=dfsPeaks, cableLoss=cableLoss, sMTPServerPortNumber=sMTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, productVariant=productVariant, linkSymmetry=linkSymmetry, aAAControlGroup=aAAControlGroup, searchState=searchState, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortAutoMdix=dataPortAutoMdix, reset=reset, enabledDiagnosticAlarms=enabledDiagnosticAlarms, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, masterSlaveMode=masterSlaveMode, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, encryption=encryption, dataPortStatusTrap=dataPortStatusTrap, timeZone=timeZone, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, regionCode=regionCode, receiveFreqKHz=receiveFreqKHz, capacityLicenseMismatch=capacityLicenseMismatch, alarms=alarms, vLANPriorityTableEntry=vLANPriorityTableEntry, phyStatus=phyStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCodeTrap=regionCodeTrap, userTable=userTable, vLANManagementVID=vLANManagementVID, ptmp=ptmp, vLANPriorityTableNumber=vLANPriorityTableNumber, licensedCapacity=licensedCapacity, sNTPServerIPAddress=sNTPServerIPAddress, telecomsLoopback=telecomsLoopback, installStatusTrap=installStatusTrap, wirelessLinkStatus=wirelessLinkStatus, sNTPLastSync=sNTPLastSync, dataPortAutoNegotiation=dataPortAutoNegotiation, configuration=configuration, alarmsGroup=alarmsGroup, transmitFreqMHz=transmitFreqMHz, telecomsCableLength=telecomsCableLength, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, eIRP=eIRP, sNMPTrapIPAddress=sNMPTrapIPAddress, daylightSaving=daylightSaving, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSync=sNTPSync, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailable=noWirelessChannelAvailable, userEnabled=userEnabled, resetGroup=resetGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, gatewayIPAddress=gatewayIPAddress, aggregateDataRate=aggregateDataRate, vLANManagementPriority=vLANManagementPriority, ptpCompliance=ptpCompliance, syslogControl=syslogControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptp500=ptp500, ethernetGroup=ethernetGroup, managementGroup=managementGroup, receiveDataRate=receiveDataRate, userName=userName, byteErrorRatio=byteErrorRatio, dfsMeans=dfsMeans, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, telnetAccessEnabled=telnetAccessEnabled, sNMPCommunityString=sNMPCommunityString, userRole=userRole, tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPollInterval=sNTPPollInterval, versionsGroup=versionsGroup, userTableNumber=userTableNumber, channelChangeTrap=channelChangeTrap, dfsGroup=dfsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogControlGroup=syslogControlGroup, siteName=siteName, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, dfs=dfs, ptpGroups=ptpGroups, supplementaryGroup=supplementaryGroup, sNMPPortNumber=sNMPPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecom=telecom, dataPortConfigurationMismatch=dataPortConfigurationMismatch, configurationGroup=configurationGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTableNumber=dfsTableNumber, altitude=altitude, receiveChannel=receiveChannel, installStatus=installStatus, incompatibleRegionCodes=incompatibleRegionCodes, telnetPortNumber=telnetPortNumber, maximumTransmitPower=maximumTransmitPower, accessMethod=accessMethod, vectorError=vectorError, phyControlGroup=phyControlGroup, tDDControlGroup=tDDControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogState=syslogState, latitude=latitude, telecomGroup=telecomGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationModeDetail=receiveModulationModeDetail, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, range=range, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, targetMACAddress=targetMACAddress, telecomsInterface=telecomsInterface, telecomsLineCode=telecomsLineCode, bootVersion=bootVersion, systemClock=systemClock, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, notificationsGroup=notificationsGroup, groupID=groupID, sNMPTrapPortNumber=sNMPTrapPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPState=sNTPState, productName=productName, dfsTableIndex=dfsTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, subnetMask=subnetMask, transmitFreqKHz=transmitFreqKHz, syslogClient=syslogClient, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receivePower=receivePower, longitude=longitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sntpGroup=sntpGroup, transmitChannel=transmitChannel, dfsTable=dfsTable, licenceGroup=licenceGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkName=linkName, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteIPAddress=remoteIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerPortNumber=sNTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, snmpControl=snmpControl, installArmState=installArmState, frequencyVariant=frequencyVariant, hTTPPortNumber=hTTPPortNumber, encryptionAlgorithm=encryptionAlgorithm, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityTable=vLANPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableEntry=userTableEntry, aAAControl=aAAControl, iPAddress=iPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bandwidthVariant=bandwidthVariant, pubStats=pubStats, cambium=cambium, telecomsChannelStatus=telecomsChannelStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControl=phyControl, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpTraps=ptpTraps, tFTPServerIPAddress=tFTPServerIPAddress, userTableIndex=userTableIndex, telecomsLoopbackTrap=telecomsLoopbackTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, PYSNMP_MODULE_ID=cambium, constantPowerSpectralDensity=constantPowerSpectralDensity)
