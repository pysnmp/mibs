...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", secondarySoftwareVersion=secondarySoftwareVersion, userTable=userTable, groupID=groupID, unitOutOfCalibration=unitOutOfCalibration, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPAddress=iPAddress, sMTPEmailAlert=sMTPEmailAlert, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationMode=tDDSynchronizationMode, userPassword=userPassword, targetMACAddress=targetMACAddress, ethernetFiberSupport=ethernetFiberSupport, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, regionCodeTrap=regionCodeTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsGroup=dfsGroup, dfsMeans=dfsMeans, syslogStateTrap=syslogStateTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, linkName=linkName, pubStatsGroup=pubStatsGroup, userTableEntry=userTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bandwidthVariant=bandwidthVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTable=dfsTable, accessMethod=accessMethod, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTable=sNMPTrapTable, regionCode=regionCode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, daylightSaving=daylightSaving, sNTPLastSync=sNTPLastSync, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, encryptionGroup=encryptionGroup, sNTPServerIPAddress=sNTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, altitude=altitude, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsTableEntry=dfsTableEntry, management=management, telnetPortNumber=telnetPortNumber, userName=userName, wirelessLinkAvailability=wirelessLinkAvailability, alarms=alarms, hTTPPortNumber=hTTPPortNumber, tDDControl=tDDControl, smtpGroup=smtpGroup, transmitDataRate=transmitDataRate, ptp=ptp, vLANManagementPriority=vLANManagementPriority, gatewayIPAddress=gatewayIPAddress, sNMPPortNumber=sNMPPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, userTableNumber=userTableNumber, softwareVersion=softwareVersion, telecomsChannelStatus=telecomsChannelStatus, productVariant=productVariant, syslogState=syslogState, antennaGain=antennaGain, byteErrorRatio=byteErrorRatio, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveModulationMode=receiveModulationMode, installArmStateTrap=installArmStateTrap, cableLoss=cableLoss, telecomsCableLength=telecomsCableLength, sNTPServerPortNumber=sNTPServerPortNumber, snmpControl=snmpControl, ethernetGroup=ethernetGroup, telecomsLineCode=telecomsLineCode, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapVersion=sNMPTrapVersion, syslogClient=syslogClient, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, userTableIndex=userTableIndex, searchState=searchState, telecomsLoopback=telecomsLoopback, dfsTableNumber=dfsTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telnetAccessEnabled=telnetAccessEnabled, syslogControlGroup=syslogControlGroup, reset=reset, telecomsLoopbackTrap=telecomsLoopbackTrap, managementGroup=managementGroup, vLANPriorityTable=vLANPriorityTable, sNMPCommunityString=sNMPCommunityString, latitude=latitude, tFTPServerIPAddress=tFTPServerIPAddress, vLANManagementVID=vLANManagementVID, phyControl=phyControl, encryption=encryption, telecomsInterface=telecomsInterface, ptpTraps=ptpTraps, configurationGroup=configurationGroup, remoteIPAddress=remoteIPAddress, linkSymmetry=linkSymmetry, smtp=smtp, dfsPeaks=dfsPeaks, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTableIndex=vLANPriorityTableIndex, ptpCompliance=ptpCompliance, notificationsGroup=notificationsGroup, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, userEnabled=userEnabled, installArmState=installArmState, pubStats=pubStats, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitPower=transmitPower, userRole=userRole, ptmp=ptmp, eIRP=eIRP, snmpControlGroup=snmpControlGroup, dfsTableIndex=dfsTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveFreqMHz=receiveFreqMHz, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, dfs=dfs, sNMPTrapTableEntry=sNMPTrapTableEntry, systemReset=systemReset, phyControlGroup=phyControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, range=range, receivePower=receivePower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegionCodes=incompatibleRegionCodes, dataPortStatus=dataPortStatus, licensedCapacity=licensedCapacity, ptpGroups=ptpGroups, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPServerPortNumber=tFTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitChannel=transmitChannel, licence=licence, bootVersion=bootVersion, siteName=siteName, installStatus=installStatus, phyStatusGroup=phyStatusGroup, systemClock=systemClock, aAAControlGroup=aAAControlGroup, aAAControl=aAAControl, capacityLicenseMismatch=capacityLicenseMismatch, linkModeOptimisation=linkModeOptimisation, sMTPServerIPAddress=sMTPServerIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, resetGroup=resetGroup, syslogControl=syslogControl, vectorError=vectorError, telecom=telecom, sNTPState=sNTPState, wirelessLinkStatus=wirelessLinkStatus, versionsGroup=versionsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityTableNumber=vLANPriorityTableNumber, licenceGroup=licenceGroup, receiveFreqKHz=receiveFreqKHz, phyStatus=phyStatus, transmitFreqKHz=transmitFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, subnetMask=subnetMask, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, productName=productName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, longitude=longitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPServerPortNumber=sMTPServerPortNumber, telecomGroup=telecomGroup, frequencyVariant=frequencyVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cambium=cambium, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, timeZone=timeZone, configuration=configuration, ptp500=ptp500, noWirelessChannelAvailable=noWirelessChannelAvailable, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPv3Enable=sNMPv3Enable, supplementary=supplementary, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sntp=sntp, sNTPSync=sNTPSync, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatusTrap=installStatusTrap, ethernet=ethernet, aggregateDataRate=aggregateDataRate, syslogClientTrap=syslogClientTrap, sNMPEnabledTraps=sNMPEnabledTraps, supplementaryGroup=supplementaryGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDControlGroup=tDDControlGroup, receiveDataRate=receiveDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, channelChangeTrap=channelChangeTrap)
