...
iso, Integer32, MibIdentifier, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, enterprises, Counter32, Counter64, TimeTicks, ObjectIdentity, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "MibIdentifier", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "enterprises", "Counter32", "Counter64", "TimeTicks", "ObjectIdentity", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, dfs=dfs, phyControl=phyControl, telecomsLineCode=telecomsLineCode, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogLocalWrappedTrap=syslogLocalWrappedTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernetFiberSupport=ethernetFiberSupport, targetMACAddress=targetMACAddress, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, transmitPower=transmitPower, snmpControl=snmpControl, dfsTableNumber=dfsTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDControlGroup=tDDControlGroup, eIRP=eIRP, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, sntp=sntp, productName=productName, bootVersion=bootVersion, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, capacityLicenseMismatch=capacityLicenseMismatch, siteName=siteName, telecomsChannelStatus=telecomsChannelStatus, sNMPTrapTable=sNMPTrapTable, telecomsCableLength=telecomsCableLength, pubStatsGroup=pubStatsGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntpGroup=sntpGroup, sNTPServerIPAddress=sNTPServerIPAddress, latitude=latitude, systemReset=systemReset, bandwidthVariant=bandwidthVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, smtp=smtp, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogControl=syslogControl, telnetPortNumber=telnetPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, alarmsGroup=alarmsGroup, transmitChannel=transmitChannel, receivePower=receivePower, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveFreqKHz=receiveFreqKHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPAddress=iPAddress, channelChangeTrap=channelChangeTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, hTTPSAccessEnabled=hTTPSAccessEnabled, linkSymmetry=linkSymmetry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, altitude=altitude, telecomGroup=telecomGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, notificationsGroup=notificationsGroup, subnetMask=subnetMask, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTable=vLANPriorityTable, dfsPeaks=dfsPeaks, maximumTransmitPower=maximumTransmitPower, telnetAccessEnabled=telnetAccessEnabled, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, byteErrorRatio=byteErrorRatio, syslogState=syslogState, syslogClientTrap=syslogClientTrap, dataPortAutoMdix=dataPortAutoMdix, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsLoopback=telecomsLoopback, encryptionGroup=encryptionGroup, daylightSaving=daylightSaving, ethernet=ethernet, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, searchState=searchState, telecomsInterface=telecomsInterface, receiveModulationMode=receiveModulationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitDataRate=transmitDataRate, userTableIndex=userTableIndex, sNMPPortNumber=sNMPPortNumber, sNMPv3Enable=sNMPv3Enable, sNTPPollInterval=sNTPPollInterval, ptpTraps=ptpTraps, ethernetGroup=ethernetGroup, unitOutOfCalibration=unitOutOfCalibration, phyStatusGroup=phyStatusGroup, dfsTableIndex=dfsTableIndex, receiveFreqMHz=receiveFreqMHz, syslogStateTrap=syslogStateTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, timeZone=timeZone, hTTPAccessEnabled=hTTPAccessEnabled, reset=reset, receiveDataRate=receiveDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortStatusTrap=dataPortStatusTrap, aAAControl=aAAControl, productVariant=productVariant, aAAControlGroup=aAAControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, incompatibleRegionCodes=incompatibleRegionCodes, vLANManagementVID=vLANManagementVID, vLANPriorityQueueMapping=vLANPriorityQueueMapping, licenceGroup=licenceGroup, aggregateDataRate=aggregateDataRate, installArmStateTrap=installArmStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, linkName=linkName, vLANPriorityTableEntry=vLANPriorityTableEntry, cambium=cambium, hardwareVersion=hardwareVersion, dfsGroup=dfsGroup, ptp=ptp, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementPriority=vLANManagementPriority, frequencyVariant=frequencyVariant, managementGroup=managementGroup, sMTPServerPortNumber=sMTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveChannel=receiveChannel, sNMPCommunityString=sNMPCommunityString, ptpGroups=ptpGroups, licence=licence, installStatusTrap=installStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDControl=tDDControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortStatus=dataPortStatus, smtpGroup=smtpGroup, configurationGroup=configurationGroup, sMTPEnabledMessages=sMTPEnabledMessages, secondarySoftwareVersion=secondarySoftwareVersion, telecom=telecom, sNMPTrapTableNumber=sNMPTrapTableNumber, accessMethod=accessMethod, linkLoss=linkLoss, remoteIPAddress=remoteIPAddress, dfsTableEntry=dfsTableEntry, hTTPPortNumber=hTTPPortNumber, sNTPSync=sNTPSync, linkModeOptimisation=linkModeOptimisation, channelBandwidth=channelBandwidth, enabledDiagnosticAlarms=enabledDiagnosticAlarms, masterSlaveMode=masterSlaveMode, ptmp=ptmp, encryptionAlgorithm=encryptionAlgorithm, sNTPState=sNTPState, userEnabled=userEnabled, transmitFreqKHz=transmitFreqKHz, userRole=userRole, dfsMeans=dfsMeans, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSPortNumber=hTTPSPortNumber, userPassword=userPassword, syslogControlGroup=syslogControlGroup, range=range, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp500=ptp500, userName=userName, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTable=userTable, alarms=alarms, longitude=longitude, supplementary=supplementary, pubStats=pubStats, phyControlGroup=phyControlGroup, phyStatus=phyStatus, versions=versions, encryption=encryption, resetGroup=resetGroup, vectorError=vectorError, dfsTable=dfsTable, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licensedCapacity=licensedCapacity, signalStrengthRatio=signalStrengthRatio, syslogClient=syslogClient, tFTPServerIPAddress=tFTPServerIPAddress, supplementaryGroup=supplementaryGroup, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaGain=antennaGain, userTableEntry=userTableEntry, groupID=groupID)
