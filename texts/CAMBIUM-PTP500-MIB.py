...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStats=pubStats, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityTable=vLANPriorityTable, sNTPLastSync=sNTPLastSync, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPollInterval=sNTPPollInterval, syslogState=syslogState, transmitDataRate=transmitDataRate, userTableIndex=userTableIndex, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, supplementary=supplementary, hTTPSPortNumber=hTTPSPortNumber, frequencyVariant=frequencyVariant, sNTPServerIPAddress=sNTPServerIPAddress, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, remoteIPAddress=remoteIPAddress, phyStatusGroup=phyStatusGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, productVariant=productVariant, phyControl=phyControl, ethernetFiberSupport=ethernetFiberSupport, telecomsLineCode=telecomsLineCode, userRole=userRole, licence=licence, supplementaryGroup=supplementaryGroup, sMTPEnabledMessages=sMTPEnabledMessages, tDDControl=tDDControl, ethernetGroup=ethernetGroup, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, managementGroup=managementGroup, receiveFreqKHz=receiveFreqKHz, syslogClient=syslogClient, phyStatus=phyStatus, linkModeOptimisation=linkModeOptimisation, bandwidthVariant=bandwidthVariant, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, PYSNMP_MODULE_ID=cambium, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, snmpControlGroup=snmpControlGroup, installArmState=installArmState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatus=installStatus, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPAccessEnabled=hTTPAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hardwareVersion=hardwareVersion, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, snmpControl=snmpControl, configuration=configuration, groupID=groupID, telecomsInterface=telecomsInterface, cableLoss=cableLoss, reset=reset, receiveModulationModeDetail=receiveModulationModeDetail, syslogStateTrap=syslogStateTrap, receiveModulationMode=receiveModulationMode, installArmStateTrap=installArmStateTrap, linkName=linkName, transmitFreqKHz=transmitFreqKHz, telecom=telecom, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomGroup=telecomGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, eIRP=eIRP, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptp500=ptp500, sNTPServerPortNumber=sNTPServerPortNumber, licensedCapacity=licensedCapacity, capacityLicenseMismatch=capacityLicenseMismatch, iPAddress=iPAddress, dataPortStatus=dataPortStatus, altitude=altitude, signalStrengthRatio=signalStrengthRatio, transmitPower=transmitPower, receiveFreqMHz=receiveFreqMHz, linkLoss=linkLoss, telecomsChannelStatus=telecomsChannelStatus, userTableNumber=userTableNumber, aAAControl=aAAControl, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, secondarySoftwareVersion=secondarySoftwareVersion, softwareVersion=softwareVersion, targetMACAddress=targetMACAddress, dfs=dfs, searchState=searchState, syslogClientTrap=syslogClientTrap, aAAControlGroup=aAAControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, versions=versions, timeZone=timeZone, vLANManagementPriority=vLANManagementPriority, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkStatus=wirelessLinkStatus, telecomsCableLength=telecomsCableLength, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPEmailAlert=sMTPEmailAlert, sNMPv3Enable=sNMPv3Enable, smtp=smtp, transmitFreqMHz=transmitFreqMHz, sNMPCommunityString=sNMPCommunityString, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortDisabledWarning=dataPortDisabledWarning, productName=productName, dfsTableEntry=dfsTableEntry, syslogControl=syslogControl, systemReset=systemReset, receiveDataRate=receiveDataRate, tDDSynchronizationMode=tDDSynchronizationMode, userTable=userTable, ethernet=ethernet, dfsTableIndex=dfsTableIndex, telecomsLoopback=telecomsLoopback, systemClock=systemClock, tDDControlGroup=tDDControlGroup, vLANManagementVID=vLANManagementVID, range=range, transmitModulationMode=transmitModulationMode, dfsTableNumber=dfsTableNumber, unitOutOfCalibration=unitOutOfCalibration, siteName=siteName, configurationGroup=configurationGroup, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, userEnabled=userEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, management=management, linkSymmetry=linkSymmetry, sNTPSync=sNTPSync, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoMdix=dataPortAutoMdix, vectorError=vectorError, dfsGroup=dfsGroup, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, sNMPTrapVersion=sNMPTrapVersion, licenceGroup=licenceGroup, pubStatsGroup=pubStatsGroup, ptpGroups=ptpGroups, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, resetGroup=resetGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, versionsGroup=versionsGroup, accessMethod=accessMethod, tFTPServerPortNumber=tFTPServerPortNumber, telnetAccessEnabled=telnetAccessEnabled, alarmsGroup=alarmsGroup, receiveChannel=receiveChannel, byteErrorRatio=byteErrorRatio, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsPeaks=dfsPeaks, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, masterSlaveMode=masterSlaveMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTable=dfsTable, notificationsGroup=notificationsGroup, gatewayIPAddress=gatewayIPAddress, sntp=sntp, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogControlGroup=syslogControlGroup, dfsMeans=dfsMeans, ptpTraps=ptpTraps, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelChangeTrap=channelChangeTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSAccessEnabled=hTTPSAccessEnabled, latitude=latitude, ptpTrapPrefix=ptpTrapPrefix, sNTPState=sNTPState, daylightSaving=daylightSaving, constantPowerSpectralDensity=constantPowerSpectralDensity, userPassword=userPassword, cambium=cambium, smtpGroup=smtpGroup, regionCodeTrap=regionCodeTrap, alarms=alarms, ptp=ptp, receivePower=receivePower, longitude=longitude, userTableEntry=userTableEntry, installStatusTrap=installStatusTrap, sntpGroup=sntpGroup, bootVersion=bootVersion, subnetMask=subnetMask, encryptionGroup=encryptionGroup, maximumTransmitPower=maximumTransmitPower, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitChannel=transmitChannel, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, encryption=encryption)
