...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, NotificationType, Counter32, IpAddress, Unsigned32, ModuleIdentity, Counter64, enterprises, Bits, Integer32, ObjectIdentity, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "NotificationType", "Counter32", "IpAddress", "Unsigned32", "ModuleIdentity", "Counter64", "enterprises", "Bits", "Integer32", "ObjectIdentity", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogClient=syslogClient, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ethernet=ethernet, dataPortStatusTrap=dataPortStatusTrap, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, linkModeOptimisation=linkModeOptimisation, daylightSaving=daylightSaving, sNMPTrapTableEntry=sNMPTrapTableEntry, systemReset=systemReset, transmitFreqKHz=transmitFreqKHz, vLANManagementPriority=vLANManagementPriority, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, linkName=linkName, syslogClientTrap=syslogClientTrap, groupID=groupID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatusTrap=installStatusTrap, sntp=sntp, antennaGain=antennaGain, versionsGroup=versionsGroup, vectorError=vectorError, sNTPServerIPAddress=sNTPServerIPAddress, aggregateDataRate=aggregateDataRate, wirelessLinkAvailability=wirelessLinkAvailability, encryptionAlgorithm=encryptionAlgorithm, dfsTableNumber=dfsTableNumber, altitude=altitude, productName=productName, targetMACAddress=targetMACAddress, eIRP=eIRP, sNMPEnabledTraps=sNMPEnabledTraps, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, accessMethod=accessMethod, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveModulationMode=receiveModulationMode, configuration=configuration, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, notificationsGroup=notificationsGroup, linkSymmetry=linkSymmetry, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userName=userName, searchState=searchState, dfsTable=dfsTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitChannel=transmitChannel, sNTPPollInterval=sNTPPollInterval, userRole=userRole, channelChangeTrap=channelChangeTrap, timeZone=timeZone, encryption=encryption, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityTableNumber=vLANPriorityTableNumber, licensedCapacity=licensedCapacity, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, productVariant=productVariant, softwareVersion=softwareVersion, dfsMeans=dfsMeans, ptpTrapPrefix=ptpTrapPrefix, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqMHz=receiveFreqMHz, vLANPriorityTable=vLANPriorityTable, supplementary=supplementary, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, resetGroup=resetGroup, syslogControl=syslogControl, receiveDataRate=receiveDataRate, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, subnetMask=subnetMask, managementGroup=managementGroup, supplementaryGroup=supplementaryGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitFreqMHz=transmitFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, maximumTransmitPower=maximumTransmitPower, phyControl=phyControl, sNTPSync=sNTPSync, cableLoss=cableLoss, vLANPriorityTableEntry=vLANPriorityTableEntry, telnetAccessEnabled=telnetAccessEnabled, regionCode=regionCode, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, telecomsLineCode=telecomsLineCode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, frequencyVariant=frequencyVariant, licence=licence, receiveFreqKHz=receiveFreqKHz, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsCableLength=telecomsCableLength, dfsTableIndex=dfsTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, regionCodeTrap=regionCodeTrap, hTTPSPortNumber=hTTPSPortNumber, transmitModulationMode=transmitModulationMode, dfsPeaks=dfsPeaks, ptp=ptp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installArmStateTrap=installArmStateTrap, sNTPSyncTrap=sNTPSyncTrap, ptp500=ptp500, snmpControlGroup=snmpControlGroup, alarmsGroup=alarmsGroup, syslogStateTrap=syslogStateTrap, ethernetGroup=ethernetGroup, receiveChannel=receiveChannel, dataPortWirelessDownAlert=dataPortWirelessDownAlert, configurationGroup=configurationGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDControlGroup=tDDControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfs=dfs, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telnetPortNumber=telnetPortNumber, hTTPPortNumber=hTTPPortNumber, telecomsLoopback=telecomsLoopback, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableEntry=userTableEntry, cambium=cambium, sNTPLastSync=sNTPLastSync, telecomsChannelStatus=telecomsChannelStatus, userTableNumber=userTableNumber, bootVersion=bootVersion, ptpTraps=ptpTraps, pubStats=pubStats, ptmp=ptmp, encryptionGroup=encryptionGroup, syslogControlGroup=syslogControlGroup, ptpCompliance=ptpCompliance, smtp=smtp, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, reset=reset, alarms=alarms, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNTPState=sNTPState, sntpGroup=sntpGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsGroup=dfsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versions=versions, tDDControl=tDDControl, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, syslogState=syslogState, userTable=userTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aAAControlGroup=aAAControlGroup, channelBandwidth=channelBandwidth, licenceGroup=licenceGroup, dataPortStatus=dataPortStatus, sNMPTrapTable=sNMPTrapTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, installArmState=installArmState, iPAddress=iPAddress, pubStatsGroup=pubStatsGroup, latitude=latitude, telecomsInterface=telecomsInterface, transmitDataRate=transmitDataRate, ptpGroups=ptpGroups, sNMPv3Enable=sNMPv3Enable, telecomGroup=telecomGroup, systemClock=systemClock, telecom=telecom, receivePower=receivePower, receiveModulationModeDetail=receiveModulationModeDetail, bandwidthVariant=bandwidthVariant, dfsTableEntry=dfsTableEntry, siteName=siteName, vLANManagementVID=vLANManagementVID, userEnabled=userEnabled, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPAccessEnabled=hTTPAccessEnabled, sNMPCommunityString=sNMPCommunityString, userPassword=userPassword, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, management=management, phyControlGroup=phyControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, capacityLicenseMismatch=capacityLicenseMismatch, sNMPPortNumber=sNMPPortNumber, linkLoss=linkLoss, userTableIndex=userTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, installStatus=installStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, transmitPower=transmitPower, vLANPriorityTableIndex=vLANPriorityTableIndex, aAAControl=aAAControl, noWirelessChannelAvailable=noWirelessChannelAvailable, masterSlaveMode=masterSlaveMode, range=range, longitude=longitude, unitOutOfCalibration=unitOutOfCalibration)
