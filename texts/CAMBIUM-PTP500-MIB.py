...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, ObjectIdentity, MibIdentifier, Counter32, NotificationType, Unsigned32, iso, Gauge32, Counter64, IpAddress, Bits, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "Counter32", "NotificationType", "Unsigned32", "iso", "Gauge32", "Counter64", "IpAddress", "Bits", "Integer32", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDSynchronizationAlarm=tDDSynchronizationAlarm, licenceGroup=licenceGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, snmpControlGroup=snmpControlGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPEmailAlert=sMTPEmailAlert, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, sNMPPortNumber=sNMPPortNumber, ptp=ptp, systemReset=systemReset, userRole=userRole, userEnabled=userEnabled, cambium=cambium, cableLoss=cableLoss, productName=productName, vLANPriorityTableNumber=vLANPriorityTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, eIRP=eIRP, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPSPortNumber=hTTPSPortNumber, bootVersion=bootVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, smtp=smtp, linkModeOptimisation=linkModeOptimisation, receiveDataRate=receiveDataRate, hTTPPortNumber=hTTPPortNumber, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStatsGroup=pubStatsGroup, transmitPower=transmitPower, vLANManagementVID=vLANManagementVID, licence=licence, longitude=longitude, timeZone=timeZone, iPAddress=iPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sntp=sntp, sNTPState=sNTPState, vLANManagementPriority=vLANManagementPriority, phyStatus=phyStatus, supplementaryGroup=supplementaryGroup, transmitFreqKHz=transmitFreqKHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelChangeTrap=channelChangeTrap, installStatusTrap=installStatusTrap, telecomGroup=telecomGroup, resetGroup=resetGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsChannelStatusTrap=telecomsChannelStatusTrap, smtpGroup=smtpGroup, ethernetGroup=ethernetGroup, supplementary=supplementary, telecomsChannelStatus=telecomsChannelStatus, sNMPv3Enable=sNMPv3Enable, masterSlaveMode=masterSlaveMode, sNMPTrapVersion=sNMPTrapVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, licensedCapacity=licensedCapacity, incompatibleMasterAndSlave=incompatibleMasterAndSlave, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogClient=syslogClient, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aAAControl=aAAControl, linkName=linkName, sMTPServerIPAddress=sMTPServerIPAddress, transmitChannel=transmitChannel, sNMPCommunityString=sNMPCommunityString, regionCodeTrap=regionCodeTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityTable=vLANPriorityTable, siteName=siteName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, dfs=dfs, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vectorError=vectorError, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, alarms=alarms, configuration=configuration, tDDControl=tDDControl, sNMPEnabledTraps=sNMPEnabledTraps, ethernet=ethernet, regionCode=regionCode, hardwareVersion=hardwareVersion, dfsGroup=dfsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, encryptionAlgorithm=encryptionAlgorithm, dfsTableIndex=dfsTableIndex, installStatus=installStatus, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, antennaGain=antennaGain, bandwidthVariant=bandwidthVariant, versions=versions, sNTPServerIPAddress=sNTPServerIPAddress, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, linkSymmetry=linkSymmetry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntpGroup=sntpGroup, aAAControlGroup=aAAControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTable=sNMPTrapTable, tDDControlGroup=tDDControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, sNTPSyncTrap=sNTPSyncTrap, userTable=userTable, syslogControl=syslogControl, phyStatusGroup=phyStatusGroup, gatewayIPAddress=gatewayIPAddress, phyControl=phyControl, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installArmState=installArmState, hTTPSAccessEnabled=hTTPSAccessEnabled, linkLoss=linkLoss, userTableIndex=userTableIndex, searchState=searchState, sNTPPollInterval=sNTPPollInterval, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsCableLength=telecomsCableLength, remoteIPAddress=remoteIPAddress, frequencyVariant=frequencyVariant, capacityLicenseMismatch=capacityLicenseMismatch, vLANPriorityTableIndex=vLANPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, ptmp=ptmp, receiveFreqKHz=receiveFreqKHz, sNTPSync=sNTPSync, softwareVersion=softwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, telecomsInterface=telecomsInterface, altitude=altitude, dataPortStatusTrap=dataPortStatusTrap, management=management, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telnetAccessEnabled=telnetAccessEnabled, byteErrorRatio=byteErrorRatio, transmitFreqMHz=transmitFreqMHz, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecom=telecom, snmpControl=snmpControl, userPassword=userPassword, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLoopback=telecomsLoopback, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTable=dfsTable, encryptionGroup=encryptionGroup, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, versionsGroup=versionsGroup, encryption=encryption, alarmsGroup=alarmsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, PYSNMP_MODULE_ID=cambium, ptpGroups=ptpGroups, vLANPriorityTableEntry=vLANPriorityTableEntry, groupID=groupID, wirelessLinkStatus=wirelessLinkStatus, telecomsLineCode=telecomsLineCode, dfsMeans=dfsMeans, aggregateDataRate=aggregateDataRate, dfsPeaks=dfsPeaks, secondarySoftwareVersion=secondarySoftwareVersion, receiveFreqMHz=receiveFreqMHz, managementGroup=managementGroup, range=range, receiveChannel=receiveChannel, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp500=ptp500, sNTPServerPortNumber=sNTPServerPortNumber, userTableNumber=userTableNumber, installArmStateTrap=installArmStateTrap, syslogStateTrap=syslogStateTrap, transmitDataRate=transmitDataRate, syslogClientTrap=syslogClientTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationMode=tDDSynchronizationMode, receiveModulationModeDetail=receiveModulationModeDetail, syslogState=syslogState, systemClock=systemClock, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPLastSync=sNTPLastSync, ptpCompliance=ptpCompliance, ethernetFiberSupport=ethernetFiberSupport, subnetMask=subnetMask, telnetPortNumber=telnetPortNumber, transmitModulationMode=transmitModulationMode, dfsTableNumber=dfsTableNumber, channelBandwidth=channelBandwidth, tFTPServerIPAddress=tFTPServerIPAddress, targetMACAddress=targetMACAddress, latitude=latitude, productVariant=productVariant, receiveModulationMode=receiveModulationMode, daylightSaving=daylightSaving, accessMethod=accessMethod, dataPortAutoMdix=dataPortAutoMdix, syslogControlGroup=syslogControlGroup, signalStrengthRatio=signalStrengthRatio, reset=reset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, pubStats=pubStats)
