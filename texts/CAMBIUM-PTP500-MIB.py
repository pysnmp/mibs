...
Integer32, enterprises, IpAddress, Counter32, Counter64, iso, Unsigned32, Gauge32, MibIdentifier, NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "IpAddress", "Counter32", "Counter64", "iso", "Unsigned32", "Gauge32", "MibIdentifier", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vectorError=vectorError, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimisation=linkModeOptimisation, wirelessLinkAvailability=wirelessLinkAvailability, range=range, targetMACAddress=targetMACAddress, cableLoss=cableLoss, receiveModulationMode=receiveModulationMode, resetGroup=resetGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPEmailAlert=sMTPEmailAlert, pubStats=pubStats, userTableNumber=userTableNumber, dfsMeans=dfsMeans, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, searchState=searchState, timeZone=timeZone, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkStatus=wirelessLinkStatus, ptpGroups=ptpGroups, vLANPriorityQueueMapping=vLANPriorityQueueMapping, transmitPower=transmitPower, ethernetGroup=ethernetGroup, telecomGroup=telecomGroup, systemClock=systemClock, ptp=ptp, daylightSaving=daylightSaving, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, smtpGroup=smtpGroup, bootVersion=bootVersion, sNTPServerIPAddress=sNTPServerIPAddress, telecomsLoopback=telecomsLoopback, sMTPServerPortNumber=sMTPServerPortNumber, supplementaryGroup=supplementaryGroup, dfsTable=dfsTable, antennaGain=antennaGain, reset=reset, aAAControl=aAAControl, telecomsLineCode=telecomsLineCode, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveDataRate=receiveDataRate, encryption=encryption, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, ethernet=ethernet, ptpTraps=ptpTraps, tDDControl=tDDControl, dfsPeaks=dfsPeaks, telecomsChannelStatus=telecomsChannelStatus, frequencyVariant=frequencyVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsInterface=telecomsInterface, syslogStateTrap=syslogStateTrap, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userEnabled=userEnabled, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licence=licence, masterSlaveMode=masterSlaveMode, tFTPServerPortNumber=tFTPServerPortNumber, regionCode=regionCode, hTTPAccessEnabled=hTTPAccessEnabled, phyStatusGroup=phyStatusGroup, softwareVersion=softwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptp500=ptp500, sNMPTrapVersion=sNMPTrapVersion, userName=userName, telecomsLoopbackTrap=telecomsLoopbackTrap, encryptionAlgorithm=encryptionAlgorithm, dataPortStatus=dataPortStatus, altitude=altitude, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitChannel=transmitChannel, hardwareVersion=hardwareVersion, configurationGroup=configurationGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBandwidth=channelBandwidth, maximumTransmitPower=maximumTransmitPower, vLANPriorityTableEntry=vLANPriorityTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfs=dfs, userTable=userTable, dfsGroup=dfsGroup, userPassword=userPassword, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitFreqMHz=transmitFreqMHz, versionsGroup=versionsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, siteName=siteName, userTableEntry=userTableEntry, alarmsGroup=alarmsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, managementGroup=managementGroup, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableIndex=dfsTableIndex, sNMPv3Enable=sNMPv3Enable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, longitude=longitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, byteErrorRatio=byteErrorRatio, syslogLocalWrappedTrap=syslogLocalWrappedTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPSync=sNTPSync, sntpGroup=sntpGroup, telnetAccessEnabled=telnetAccessEnabled, regionCodeTrap=regionCodeTrap, encryptionGroup=encryptionGroup, subnetMask=subnetMask, pubStatsGroup=pubStatsGroup, remoteIPAddress=remoteIPAddress, sNMPCommunityString=sNMPCommunityString, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementVID=vLANManagementVID, transmitDataRate=transmitDataRate, linkName=linkName, alarms=alarms, syslogState=syslogState, userTableIndex=userTableIndex, ptmp=ptmp, systemReset=systemReset, noWirelessChannelAvailable=noWirelessChannelAvailable, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, licensedCapacity=licensedCapacity, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sntp=sntp, phyControl=phyControl, capacityLicenseMismatch=capacityLicenseMismatch, linkLoss=linkLoss, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, dfsTableNumber=dfsTableNumber, installStatus=installStatus, phyStatus=phyStatus, groupID=groupID, syslogClientTrap=syslogClientTrap, accessMethod=accessMethod, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsCableLength=telecomsCableLength, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, licenceGroup=licenceGroup, sMTPServerIPAddress=sMTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPPollInterval=sNTPPollInterval, transmitModulationMode=transmitModulationMode, installStatusTrap=installStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTable=sNMPTrapTable, bandwidthVariant=bandwidthVariant, receiveFreqMHz=receiveFreqMHz, phyControlGroup=phyControlGroup, ethernetFiberSupport=ethernetFiberSupport, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPSyncTrap=sNTPSyncTrap, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, dataPortAutoMdix=dataPortAutoMdix, productName=productName, ptpCompliance=ptpCompliance, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogClient=syslogClient, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, supplementary=supplementary, sMTPEnabledMessages=sMTPEnabledMessages, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTableEntry=dfsTableEntry, gatewayIPAddress=gatewayIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTableIndex=vLANPriorityTableIndex, telnetPortNumber=telnetPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, cambium=cambium, management=management, channelChangeTrap=channelChangeTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecom=telecom, smtp=smtp, latitude=latitude, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPState=sNTPState, tDDControlGroup=tDDControlGroup, productVariant=productVariant, installArmStateTrap=installArmStateTrap, iPAddress=iPAddress, versions=versions, userRole=userRole, syslogControlGroup=syslogControlGroup, installArmState=installArmState, hTTPPortNumber=hTTPPortNumber, vLANManagementPriority=vLANManagementPriority, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, receivePower=receivePower, vLANPriorityTable=vLANPriorityTable, eIRP=eIRP, syslogControl=syslogControl, sNTPLastSync=sNTPLastSync)
