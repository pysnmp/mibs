...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", pubStatsGroup=pubStatsGroup, telnetAccessEnabled=telnetAccessEnabled, sNMPv3Enable=sNMPv3Enable, encryptionAlgorithm=encryptionAlgorithm, transmitFreqMHz=transmitFreqMHz, sNTPServerPortNumber=sNTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp500=ptp500, dfs=dfs, sNMPTrapVersion=sNMPTrapVersion, hTTPAccessEnabled=hTTPAccessEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPState=sNTPState, linkSymmetry=linkSymmetry, installArmState=installArmState, syslogState=syslogState, dataPortAutoMdix=dataPortAutoMdix, telecom=telecom, dfsPeaks=dfsPeaks, reset=reset, ptpGroups=ptpGroups, hTTPPortNumber=hTTPPortNumber, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkAvailability=wirelessLinkAvailability, pubStats=pubStats, subnetMask=subnetMask, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTableNumber=userTableNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, smtp=smtp, telecomsCableLength=telecomsCableLength, linkName=linkName, syslogClient=syslogClient, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsInterface=telecomsInterface, regionCode=regionCode, ethernetFiberSupport=ethernetFiberSupport, sMTPEnabledMessages=sMTPEnabledMessages, transmitFreqKHz=transmitFreqKHz, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogClientTrap=syslogClientTrap, versions=versions, aAAControl=aAAControl, frequencyVariant=frequencyVariant, linkLoss=linkLoss, vLANManagementVID=vLANManagementVID, transmitPower=transmitPower, range=range, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, daylightSaving=daylightSaving, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, sNTPSync=sNTPSync, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, channelChangeTrap=channelChangeTrap, syslogStateTrap=syslogStateTrap, encryptionGroup=encryptionGroup, byteErrorRatio=byteErrorRatio, aAAControlGroup=aAAControlGroup, userName=userName, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsChannelStatus=telecomsChannelStatus, phyControlGroup=phyControlGroup, configurationGroup=configurationGroup, productVariant=productVariant, ptpCompliance=ptpCompliance, syslogControl=syslogControl, alarmsGroup=alarmsGroup, siteName=siteName, secondarySoftwareVersion=secondarySoftwareVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationMode=tDDSynchronizationMode, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, transmitChannel=transmitChannel, constantPowerSpectralDensity=constantPowerSpectralDensity, antennaGain=antennaGain, dfsTableIndex=dfsTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, userRole=userRole, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpTraps=ptpTraps, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, dfsTableEntry=dfsTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqKHz=receiveFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, maximumTransmitPower=maximumTransmitPower, unitOutOfCalibration=unitOutOfCalibration, telecomsLineCode=telecomsLineCode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTableNumber=dfsTableNumber, userTable=userTable, licence=licence, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userEnabled=userEnabled, sMTPServerIPAddress=sMTPServerIPAddress, cableLoss=cableLoss, latitude=latitude, tFTPServerIPAddress=tFTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installArmStateTrap=installArmStateTrap, userPassword=userPassword, telecomsLoopback=telecomsLoopback, sMTPEmailAlert=sMTPEmailAlert, installStatusTrap=installStatusTrap, sNMPCommunityString=sNMPCommunityString, remoteIPAddress=remoteIPAddress, management=management, licensedCapacity=licensedCapacity, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetGroup=ethernetGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogControlGroup=syslogControlGroup, groupID=groupID, receiveModulationMode=receiveModulationMode, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomGroup=telecomGroup, sntp=sntp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, managementGroup=managementGroup, notificationsGroup=notificationsGroup, sNTPPollInterval=sNTPPollInterval, telnetPortNumber=telnetPortNumber, cambium=cambium, eIRP=eIRP, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, tDDControl=tDDControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTable=dfsTable, dfsMeans=dfsMeans, masterSlaveMode=masterSlaveMode, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationAlarm=tDDSynchronizationAlarm, resetGroup=resetGroup, bandwidthVariant=bandwidthVariant, phyStatus=phyStatus, supplementary=supplementary, productName=productName, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, tDDControlGroup=tDDControlGroup, vLANManagementPriority=vLANManagementPriority, receiveFreqMHz=receiveFreqMHz, transmitDataRate=transmitDataRate, regionCodeTrap=regionCodeTrap, dfsGroup=dfsGroup, ptpTrapPrefix=ptpTrapPrefix, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, gatewayIPAddress=gatewayIPAddress, configuration=configuration, longitude=longitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, hardwareVersion=hardwareVersion, searchState=searchState, PYSNMP_MODULE_ID=cambium, vLANPriorityTableNumber=vLANPriorityTableNumber, ptmp=ptmp, licenceGroup=licenceGroup, aggregateDataRate=aggregateDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarms=alarms, softwareVersion=softwareVersion, sNMPTrapTable=sNMPTrapTable, userTableEntry=userTableEntry, linkModeOptimisation=linkModeOptimisation, snmpControl=snmpControl, targetMACAddress=targetMACAddress, versionsGroup=versionsGroup, vectorError=vectorError, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernet=ethernet, accessMethod=accessMethod, incompatibleRegionCodes=incompatibleRegionCodes, sNMPEnabledTraps=sNMPEnabledTraps, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, capacityLicenseMismatch=capacityLicenseMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, systemClock=systemClock, altitude=altitude, sntpGroup=sntpGroup, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitModulationMode=transmitModulationMode, userTableIndex=userTableIndex, sNTPLastSync=sNTPLastSync, timeZone=timeZone, ptp=ptp, supplementaryGroup=supplementaryGroup, iPAddress=iPAddress, tFTPServerPortNumber=tFTPServerPortNumber, vLANPriorityTable=vLANPriorityTable, installStatus=installStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyStatusGroup=phyStatusGroup, channelBandwidth=channelBandwidth, encryption=encryption, sMTPServerPortNumber=sMTPServerPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveDataRate=receiveDataRate, systemReset=systemReset)
