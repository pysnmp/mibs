...
# Produced by pysmi-1.1.3 at Mon Nov 22 12:30:44 2021
...
Counter64, TimeTicks, ModuleIdentity, Integer32, NotificationType, Gauge32, ObjectIdentity, MibIdentifier, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Unsigned32, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "ModuleIdentity", "Integer32", "NotificationType", "Gauge32", "ObjectIdentity", "MibIdentifier", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Unsigned32", "Bits", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", aAAControl=aAAControl, sntp=sntp, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableLoss=cableLoss, siteName=siteName, ptpGroups=ptpGroups, notificationsGroup=notificationsGroup, installArmStateTrap=installArmStateTrap, licensedCapacity=licensedCapacity, sNMPTrapTableNumber=sNMPTrapTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, configurationGroup=configurationGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfs=dfs, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, supplementaryGroup=supplementaryGroup, telecomsCableLength=telecomsCableLength, longitude=longitude, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortStatus=dataPortStatus, receiveModulationModeDetail=receiveModulationModeDetail, transmitModulationMode=transmitModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecom=telecom, enabledDiagnosticAlarms=enabledDiagnosticAlarms, daylightSaving=daylightSaving, wirelessLinkAvailability=wirelessLinkAvailability, versions=versions, phyStatus=phyStatus, dfsGroup=dfsGroup, receivePower=receivePower, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hTTPSPortNumber=hTTPSPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerPortNumber=sMTPServerPortNumber, alarms=alarms, licenceGroup=licenceGroup, incompatibleRegionCodes=incompatibleRegionCodes, sNTPServerIPAddress=sNTPServerIPAddress, userName=userName, syslogState=syslogState, dfsMeans=dfsMeans, masterSlaveMode=masterSlaveMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bandwidthVariant=bandwidthVariant, transmitChannel=transmitChannel, cambium=cambium, alarmsGroup=alarmsGroup, receiveFreqMHz=receiveFreqMHz, syslogControl=syslogControl, management=management, signalStrengthRatio=signalStrengthRatio, softwareVersion=softwareVersion, tDDControlGroup=tDDControlGroup, syslogClient=syslogClient, userTableIndex=userTableIndex, groupID=groupID, unitOutOfCalibration=unitOutOfCalibration, channelChangeTrap=channelChangeTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, eIRP=eIRP, dataPortAutoMdix=dataPortAutoMdix, receiveChannel=receiveChannel, telecomsLoopbackTrap=telecomsLoopbackTrap, userTable=userTable, dataPortDisabledWarning=dataPortDisabledWarning, ethernetGroup=ethernetGroup, productName=productName, vLANPriorityTableNumber=vLANPriorityTableNumber, remoteIPAddress=remoteIPAddress, syslogControlGroup=syslogControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTableNumber=dfsTableNumber, pubStatsGroup=pubStatsGroup, accessMethod=accessMethod, userTableEntry=userTableEntry, pubStats=pubStats, ptpTraps=ptpTraps, tDDSynchronizationAlarm=tDDSynchronizationAlarm, snmpControlGroup=snmpControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpCompliance=ptpCompliance, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsInterface=telecomsInterface, latitude=latitude, maximumTransmitPower=maximumTransmitPower, reset=reset, dfsTable=dfsTable, phyControlGroup=phyControlGroup, ptpTrapPrefix=ptpTrapPrefix, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, linkLoss=linkLoss, hardwareVersion=hardwareVersion, installArmState=installArmState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bootVersion=bootVersion, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPState=sNTPState, sNMPTrapVersion=sNMPTrapVersion, systemClock=systemClock, linkSymmetry=linkSymmetry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveFreqKHz=receiveFreqKHz, sNTPSyncTrap=sNTPSyncTrap, encryptionAlgorithm=encryptionAlgorithm, encryptionGroup=encryptionGroup, wirelessLinkStatus=wirelessLinkStatus, timeZone=timeZone, resetGroup=resetGroup, telnetAccessEnabled=telnetAccessEnabled, sNTPServerPortNumber=sNTPServerPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsChannelStatus=telecomsChannelStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, telecomGroup=telecomGroup, sNMPv3Enable=sNMPv3Enable, sNMPPortNumber=sNMPPortNumber, vLANManagementPriority=vLANManagementPriority, dataPortConfigurationMismatch=dataPortConfigurationMismatch, regionCodeTrap=regionCodeTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogStateTrap=syslogStateTrap, linkName=linkName, vectorError=vectorError, configuration=configuration, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, snmpControl=snmpControl, tDDSynchronizationStatus=tDDSynchronizationStatus, hTTPAccessEnabled=hTTPAccessEnabled, systemReset=systemReset, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, phyControl=phyControl, aggregateDataRate=aggregateDataRate, dataPortStatusTrap=dataPortStatusTrap, vLANPriorityTable=vLANPriorityTable, dfsTableEntry=dfsTableEntry, sNTPPollInterval=sNTPPollInterval, noWirelessChannelAvailable=noWirelessChannelAvailable, licence=licence, dfsPeaks=dfsPeaks, installStatus=installStatus, ethernet=ethernet, telecomsLoopback=telecomsLoopback, managementGroup=managementGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitDataRate=transmitDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPServerIPAddress=sMTPServerIPAddress, iPAddress=iPAddress, range=range, transmitFreqKHz=transmitFreqKHz, aAAControlGroup=aAAControlGroup, transmitFreqMHz=transmitFreqMHz, sntpGroup=sntpGroup, userTableNumber=userTableNumber, supplementary=supplementary, transmitPower=transmitPower, ptp=ptp, dfsTableIndex=dfsTableIndex, regionCode=regionCode, PYSNMP_MODULE_ID=cambium, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installStatusTrap=installStatusTrap, encryption=encryption, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPEnabledTraps=sNMPEnabledTraps, ptp500=ptp500, smtpGroup=smtpGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptmp=ptmp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtp=smtp, hTTPPortNumber=hTTPPortNumber, userEnabled=userEnabled, telnetPortNumber=telnetPortNumber, frequencyVariant=frequencyVariant, searchState=searchState, telecomsLineCode=telecomsLineCode, versionsGroup=versionsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, altitude=altitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANPriorityTableIndex=vLANPriorityTableIndex, subnetMask=subnetMask, channelBandwidth=channelBandwidth, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDControl=tDDControl, linkModeOptimisation=linkModeOptimisation, phyStatusGroup=phyStatusGroup, sMTPEmailAlert=sMTPEmailAlert, receiveDataRate=receiveDataRate, gatewayIPAddress=gatewayIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, userPassword=userPassword, userRole=userRole, sNTPSync=sNTPSync, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationMode=tDDSynchronizationMode, vLANManagementVID=vLANManagementVID, antennaGain=antennaGain, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry)
