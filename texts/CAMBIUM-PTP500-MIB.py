...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", notificationsGroup=notificationsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, bandwidthVariant=bandwidthVariant, frequencyVariant=frequencyVariant, channelChangeTrap=channelChangeTrap, hTTPPortNumber=hTTPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPPortNumber=sNMPPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, snmpControl=snmpControl, encryptionGroup=encryptionGroup, syslogStateTrap=syslogStateTrap, systemReset=systemReset, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, reset=reset, receiveFreqMHz=receiveFreqMHz, vectorError=vectorError, installStatus=installStatus, ptmp=ptmp, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, accessMethod=accessMethod, pubStats=pubStats, dfsTableNumber=dfsTableNumber, range=range, hTTPSAccessEnabled=hTTPSAccessEnabled, aggregateDataRate=aggregateDataRate, receiveModulationMode=receiveModulationMode, hTTPSPortNumber=hTTPSPortNumber, signalStrengthRatio=signalStrengthRatio, userPassword=userPassword, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, sNTPLastSync=sNTPLastSync, syslogClient=syslogClient, tDDControlGroup=tDDControlGroup, sntp=sntp, receiveFreqKHz=receiveFreqKHz, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPollInterval=sNTPPollInterval, userEnabled=userEnabled, userTableEntry=userTableEntry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPSyncTrap=sNTPSyncTrap, PYSNMP_MODULE_ID=cambium, siteName=siteName, licensedCapacity=licensedCapacity, telnetPortNumber=telnetPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, maximumTransmitPower=maximumTransmitPower, hTTPAccessEnabled=hTTPAccessEnabled, transmitDataRate=transmitDataRate, telecom=telecom, linkLoss=linkLoss, dataPortStatus=dataPortStatus, ethernet=ethernet, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, managementGroup=managementGroup, receiveModulationModeDetail=receiveModulationModeDetail, transmitPower=transmitPower, dataPortAutoMdix=dataPortAutoMdix, regionCode=regionCode, syslogState=syslogState, supplementaryGroup=supplementaryGroup, systemClock=systemClock, installArmState=installArmState, tDDControl=tDDControl, tFTPServerPortNumber=tFTPServerPortNumber, iPAddress=iPAddress, sNTPServerPortNumber=sNTPServerPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configuration=configuration, phyStatusGroup=phyStatusGroup, transmitFreqMHz=transmitFreqMHz, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlGroup=phyControlGroup, ptpCompliance=ptpCompliance, softwareVersion=softwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp500=ptp500, sMTPServerIPAddress=sMTPServerIPAddress, productVariant=productVariant, resetGroup=resetGroup, vLANPriorityTable=vLANPriorityTable, groupID=groupID, receiveDataRate=receiveDataRate, userRole=userRole, configurationGroup=configurationGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTable=dfsTable, cableLoss=cableLoss, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, searchState=searchState, phyControl=phyControl, regionCodeTrap=regionCodeTrap, ethernetGroup=ethernetGroup, alarms=alarms, sNTPState=sNTPState, daylightSaving=daylightSaving, userTableIndex=userTableIndex, transmitModulationMode=transmitModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEmailAlert=sMTPEmailAlert, dfsTableIndex=dfsTableIndex, snmpControlGroup=snmpControlGroup, telnetAccessEnabled=telnetAccessEnabled, telecomGroup=telecomGroup, incompatibleRegionCodes=incompatibleRegionCodes, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, management=management, vLANManagementVID=vLANManagementVID, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetFiberSupport=ethernetFiberSupport, telecomsLineCode=telecomsLineCode, sNTPServerIPAddress=sNTPServerIPAddress, altitude=altitude, syslogClientTrap=syslogClientTrap, bootVersion=bootVersion, syslogControlGroup=syslogControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, supplementary=supplementary, smtp=smtp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receivePower=receivePower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableEntry=dfsTableEntry, sNMPTrapTable=sNMPTrapTable, telecomsInterface=telecomsInterface, encryption=encryption, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, cambium=cambium, byteErrorRatio=byteErrorRatio, remoteIPAddress=remoteIPAddress, dfsPeaks=dfsPeaks, useVLANForManagementInterfaces=useVLANForManagementInterfaces, gatewayIPAddress=gatewayIPAddress, targetMACAddress=targetMACAddress, dfs=dfs, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, installArmStateTrap=installArmStateTrap, linkModeOptimisation=linkModeOptimisation, telecomsLoopback=telecomsLoopback, tDDSynchronizationStatus=tDDSynchronizationStatus, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licence=licence, sNMPEnabledTraps=sNMPEnabledTraps, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatch=capacityLicenseMismatch, sNMPv3Enable=sNMPv3Enable, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortStatusTrap=dataPortStatusTrap, ptpTraps=ptpTraps, versionsGroup=versionsGroup, receiveChannel=receiveChannel, latitude=latitude, vLANManagementPriority=vLANManagementPriority, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitFreqKHz=transmitFreqKHz, antennaGain=antennaGain, telecomsChannelStatus=telecomsChannelStatus, masterSlaveMode=masterSlaveMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkAvailability=wirelessLinkAvailability, channelBandwidth=channelBandwidth, versions=versions, constantPowerSpectralDensity=constantPowerSpectralDensity, installStatusTrap=installStatusTrap, sNMPCommunityString=sNMPCommunityString, userTable=userTable, licenceGroup=licenceGroup, subnetMask=subnetMask, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkName=linkName, vLANPriorityTableIndex=vLANPriorityTableIndex, ptp=ptp, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, ptpGroups=ptpGroups, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, eIRP=eIRP, userName=userName, telecomsCableLength=telecomsCableLength, sntpGroup=sntpGroup, syslogControl=syslogControl, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControlGroup=aAAControlGroup, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, aAAControl=aAAControl, dfsMeans=dfsMeans, sNTPSync=sNTPSync, userTableNumber=userTableNumber, dfsGroup=dfsGroup)
