...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDControlGroup=tDDControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerIPAddress=tFTPServerIPAddress, groupID=groupID, dataPortDisabledWarning=dataPortDisabledWarning, sNMPPortNumber=sNMPPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, syslogState=syslogState, antennaGain=antennaGain, bootVersion=bootVersion, sNMPTrapTable=sNMPTrapTable, hTTPPortNumber=hTTPPortNumber, versions=versions, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aggregateDataRate=aggregateDataRate, sNTPSyncTrap=sNTPSyncTrap, reset=reset, bandwidthVariant=bandwidthVariant, installArmState=installArmState, transmitFreqMHz=transmitFreqMHz, receivePower=receivePower, snmpControl=snmpControl, syslogControlGroup=syslogControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableNumber=userTableNumber, PYSNMP_MODULE_ID=cambium, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, iPAddress=iPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortAutoMdix=dataPortAutoMdix, snmpControlGroup=snmpControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, range=range, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, telecomsCableLength=telecomsCableLength, userRole=userRole, systemClock=systemClock, sntpGroup=sntpGroup, configurationGroup=configurationGroup, sMTPEmailAlert=sMTPEmailAlert, telecomsLineCode=telecomsLineCode, masterSlaveMode=masterSlaveMode, receiveDataRate=receiveDataRate, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, telnetPortNumber=telnetPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, searchState=searchState, userTableIndex=userTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANManagementVID=vLANManagementVID, tDDControl=tDDControl, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPServerPortNumber=sNTPServerPortNumber, telecom=telecom, encryptionGroup=encryptionGroup, unitOutOfCalibration=unitOutOfCalibration, secondarySoftwareVersion=secondarySoftwareVersion, sNMPv3Enable=sNMPv3Enable, alarms=alarms, phyStatusGroup=phyStatusGroup, transmitPower=transmitPower, cableLoss=cableLoss, pubStats=pubStats, longitude=longitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitModulationMode=transmitModulationMode, vLANPriorityTable=vLANPriorityTable, dfsTableIndex=dfsTableIndex, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPollInterval=sNTPPollInterval, syslogClient=syslogClient, telecomGroup=telecomGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vectorError=vectorError, ptp500=ptp500, daylightSaving=daylightSaving, softwareVersion=softwareVersion, licence=licence, remoteIPAddress=remoteIPAddress, resetGroup=resetGroup, licensedCapacity=licensedCapacity, linkName=linkName, altitude=altitude, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, versionsGroup=versionsGroup, wirelessLinkStatus=wirelessLinkStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, dfs=dfs, userPassword=userPassword, pubStatsGroup=pubStatsGroup, supplementaryGroup=supplementaryGroup, productName=productName, receiveFreqMHz=receiveFreqMHz, installStatusTrap=installStatusTrap, hTTPSPortNumber=hTTPSPortNumber, dfsTableNumber=dfsTableNumber, timeZone=timeZone, vLANManagementPriority=vLANManagementPriority, channelBandwidth=channelBandwidth, eIRP=eIRP, hTTPSAccessEnabled=hTTPSAccessEnabled, userTable=userTable, installArmStateTrap=installArmStateTrap, userEnabled=userEnabled, receiveChannel=receiveChannel, userTableEntry=userTableEntry, telecomsChannelStatusTrap=telecomsChannelStatusTrap, channelChangeTrap=channelChangeTrap, supplementary=supplementary, managementGroup=managementGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpGroups=ptpGroups, linkLoss=linkLoss, sNMPCommunityString=sNMPCommunityString, dfsMeans=dfsMeans, regionCodeTrap=regionCodeTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, ptp=ptp, maximumTransmitPower=maximumTransmitPower, ethernetFiberSupport=ethernetFiberSupport, incompatibleRegionCodes=incompatibleRegionCodes, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hardwareVersion=hardwareVersion, telecomsChannelStatus=telecomsChannelStatus, aAAControl=aAAControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, dfsTable=dfsTable, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsInterface=telecomsInterface, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemReset=systemReset, tDDSynchronizationMode=tDDSynchronizationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqKHz=transmitFreqKHz, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, encryption=encryption, encryptionAlgorithm=encryptionAlgorithm, frequencyVariant=frequencyVariant, productVariant=productVariant, phyStatus=phyStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimisation=linkModeOptimisation, sNTPState=sNTPState, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogStateTrap=syslogStateTrap, cambium=cambium, telnetAccessEnabled=telnetAccessEnabled, dfsGroup=dfsGroup, latitude=latitude, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitChannel=transmitChannel, ptpCompliance=ptpCompliance, sNMPTrapTableEntry=sNMPTrapTableEntry, smtp=smtp, sNTPSync=sNTPSync, licenceGroup=licenceGroup, linkSymmetry=linkSymmetry, sntp=sntp, syslogControl=syslogControl, byteErrorRatio=byteErrorRatio, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsPeaks=dfsPeaks, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userName=userName, telecomsLoopback=telecomsLoopback, sNTPLastSync=sNTPLastSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptmp=ptmp, hTTPAccessEnabled=hTTPAccessEnabled, accessMethod=accessMethod, phyControl=phyControl, aAAControlGroup=aAAControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkAvailability=wirelessLinkAvailability, dataPortStatusTrap=dataPortStatusTrap, notificationsGroup=notificationsGroup, regionCode=regionCode, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitDataRate=transmitDataRate, siteName=siteName, dfsTableEntry=dfsTableEntry)
