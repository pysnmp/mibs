...
NotificationType, Counter32, Integer32, IpAddress, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, Bits, Unsigned32, iso, Counter64, enterprises, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Integer32", "IpAddress", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "Bits", "Unsigned32", "iso", "Counter64", "enterprises", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitPower=transmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveFreqKHz=receiveFreqKHz, management=management, bootVersion=bootVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, userPassword=userPassword, ptpCompliance=ptpCompliance, syslogControl=syslogControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsTableNumber=dfsTableNumber, bandwidthVariant=bandwidthVariant, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, sNMPv3Enable=sNMPv3Enable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerPortNumber=sNTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, hTTPPortNumber=hTTPPortNumber, systemClock=systemClock, siteName=siteName, transmitFreqKHz=transmitFreqKHz, notificationsGroup=notificationsGroup, vLANManagementVID=vLANManagementVID, targetMACAddress=targetMACAddress, receiveDataRate=receiveDataRate, wirelessLinkAvailability=wirelessLinkAvailability, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, encryptionGroup=encryptionGroup, syslogControlGroup=syslogControlGroup, remoteIPAddress=remoteIPAddress, phyStatusGroup=phyStatusGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogStateTrap=syslogStateTrap, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aAAControl=aAAControl, installStatus=installStatus, unitOutOfCalibration=unitOutOfCalibration, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpTraps=ptpTraps, telnetPortNumber=telnetPortNumber, sMTPEmailAlert=sMTPEmailAlert, installArmState=installArmState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogState=syslogState, eIRP=eIRP, userTable=userTable, tFTPServerPortNumber=tFTPServerPortNumber, dfsPeaks=dfsPeaks, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, altitude=altitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryption=encryption, productName=productName, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, resetGroup=resetGroup, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, linkModeOptimisation=linkModeOptimisation, sNTPLastSync=sNTPLastSync, transmitDataRate=transmitDataRate, userName=userName, telecomsInterface=telecomsInterface, userTableEntry=userTableEntry, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveChannel=receiveChannel, dataPortStatus=dataPortStatus, linkSymmetry=linkSymmetry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelChangeTrap=channelChangeTrap, dataPortDisabledWarning=dataPortDisabledWarning, phyControlGroup=phyControlGroup, snmpControl=snmpControl, telecomsLoopbackTrap=telecomsLoopbackTrap, supplementaryGroup=supplementaryGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarms=alarms, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPSyncTrap=sNTPSyncTrap, dfsTableEntry=dfsTableEntry, telecomsLineCode=telecomsLineCode, aAAControlGroup=aAAControlGroup, ptp500=ptp500, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogClient=syslogClient, telecomGroup=telecomGroup, dfsTable=dfsTable, transmitModulationMode=transmitModulationMode, telecomsCableLength=telecomsCableLength, latitude=latitude, dfs=dfs, linkLoss=linkLoss, searchState=searchState, configuration=configuration, licence=licence, PYSNMP_MODULE_ID=cambium, range=range, sMTPServerIPAddress=sMTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPPollInterval=sNTPPollInterval, ptpTrapPrefix=ptpTrapPrefix, tDDSynchronizationMode=tDDSynchronizationMode, softwareVersion=softwareVersion, accessMethod=accessMethod, dataPortAutoMdix=dataPortAutoMdix, installStatusTrap=installStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, installArmStateTrap=installArmStateTrap, ethernetGroup=ethernetGroup, wirelessLinkStatus=wirelessLinkStatus, licenceGroup=licenceGroup, transmitFreqMHz=transmitFreqMHz, regionCodeTrap=regionCodeTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableIndex=userTableIndex, smtp=smtp, subnetMask=subnetMask, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPServerIPAddress=sNTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaGain=antennaGain, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsGroup=dfsGroup, sNTPState=sNTPState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPPortNumber=sNMPPortNumber, alarmsGroup=alarmsGroup, versions=versions, telecomsLoopback=telecomsLoopback, pubStatsGroup=pubStatsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, configurationGroup=configurationGroup, transmitChannel=transmitChannel, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityLicenseMismatch=capacityLicenseMismatch, sNMPCommunityString=sNMPCommunityString, receiveModulationMode=receiveModulationMode, ethernet=ethernet, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelBandwidth=channelBandwidth, regionCode=regionCode, ptp=ptp, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationModeDetail=receiveModulationModeDetail, cableLoss=cableLoss, dataPortConfigurationMismatch=dataPortConfigurationMismatch, pubStats=pubStats, longitude=longitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemReset=systemReset, sNMPTrapVersion=sNMPTrapVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortWirelessDownAlert=dataPortWirelessDownAlert, timeZone=timeZone, dataPortStatusTrap=dataPortStatusTrap, userEnabled=userEnabled, signalStrengthRatio=signalStrengthRatio, versionsGroup=versionsGroup, cambium=cambium, tDDControl=tDDControl, masterSlaveMode=masterSlaveMode, sntp=sntp, vLANPriorityTable=vLANPriorityTable, iPAddress=iPAddress, linkName=linkName, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, receivePower=receivePower, supplementary=supplementary, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, phyStatus=phyStatus, smtpGroup=smtpGroup, vectorError=vectorError, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, phyControl=phyControl, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, groupID=groupID, daylightSaving=daylightSaving, userRole=userRole, telecom=telecom, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userTableNumber=userTableNumber, telecomsChannelStatus=telecomsChannelStatus, sntpGroup=sntpGroup, dfsMeans=dfsMeans, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSync=sNTPSync, tDDControlGroup=tDDControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, licensedCapacity=licensedCapacity, ethernetFiberSupport=ethernetFiberSupport, vLANManagementPriority=vLANManagementPriority, frequencyVariant=frequencyVariant, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogClientTrap=syslogClientTrap, sMTPServerPortNumber=sMTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, ptmp=ptmp, reset=reset)
