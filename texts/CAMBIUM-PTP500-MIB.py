...
# Produced by pysmi-1.1.3 at Wed Dec  1 14:50:53 2021
...
Bits, IpAddress, MibIdentifier, Counter64, TimeTicks, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, ObjectIdentity, Integer32, iso, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "MibIdentifier", "Counter64", "TimeTicks", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Integer32", "iso", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsPeaks=dfsPeaks, userTableIndex=userTableIndex, encryptionAlgorithm=encryptionAlgorithm, encryptionGroup=encryptionGroup, incompatibleRegionCodes=incompatibleRegionCodes, dfsMeans=dfsMeans, hTTPSPortNumber=hTTPSPortNumber, aAAControl=aAAControl, ptmp=ptmp, userEnabled=userEnabled, masterSlaveMode=masterSlaveMode, userPassword=userPassword, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, hTTPPortNumber=hTTPPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkAvailability=wirelessLinkAvailability, siteName=siteName, sNMPCommunityString=sNMPCommunityString, reset=reset, antennaGain=antennaGain, frequencyVariant=frequencyVariant, installStatus=installStatus, sNMPEnabledTraps=sNMPEnabledTraps, userTableEntry=userTableEntry, notificationsGroup=notificationsGroup, dataPortDisabledWarning=dataPortDisabledWarning, timeZone=timeZone, noWirelessChannelAvailable=noWirelessChannelAvailable, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPServerPortNumber=sMTPServerPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPState=sNTPState, telecomsChannelStatusTrap=telecomsChannelStatusTrap, unitOutOfCalibration=unitOutOfCalibration, dfsGroup=dfsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, aggregateDataRate=aggregateDataRate, userTable=userTable, PYSNMP_MODULE_ID=cambium, ptpTraps=ptpTraps, receiveFreqKHz=receiveFreqKHz, latitude=latitude, syslogControlGroup=syslogControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, hardwareVersion=hardwareVersion, tDDControl=tDDControl, syslogClient=syslogClient, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANPriorityTable=vLANPriorityTable, daylightSaving=daylightSaving, sNMPTrapTableNumber=sNMPTrapTableNumber, eIRP=eIRP, pubStats=pubStats, aAAControlGroup=aAAControlGroup, receiveFreqMHz=receiveFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfs=dfs, phyStatusGroup=phyStatusGroup, tDDControlGroup=tDDControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, userName=userName, transmitFreqMHz=transmitFreqMHz, linkModeOptimisation=linkModeOptimisation, syslogControl=syslogControl, sNMPTrapTable=sNMPTrapTable, channelBandwidth=channelBandwidth, vLANPriorityTableNumber=vLANPriorityTableNumber, channelChangeTrap=channelChangeTrap, remoteIPAddress=remoteIPAddress, telecomsCableLength=telecomsCableLength, sMTPSourceEmailAddress=sMTPSourceEmailAddress, cambium=cambium, range=range, syslogStateTrap=syslogStateTrap, dfsTableEntry=dfsTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNTPSyncTrap=sNTPSyncTrap, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, gatewayIPAddress=gatewayIPAddress, altitude=altitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, snmpControl=snmpControl, accessMethod=accessMethod, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationAlarm=tDDSynchronizationAlarm, supplementary=supplementary, ptpTrapPrefix=ptpTrapPrefix, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLoopback=telecomsLoopback, smtpGroup=smtpGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, versions=versions, telecom=telecom, iPAddress=iPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPPollInterval=sNTPPollInterval, sntpGroup=sntpGroup, tFTPServerPortNumber=tFTPServerPortNumber, configurationGroup=configurationGroup, receiveDataRate=receiveDataRate, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, phyControl=phyControl, licensedCapacity=licensedCapacity, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, encryption=encryption, cableLoss=cableLoss, configuration=configuration, telecomGroup=telecomGroup, ptpGroups=ptpGroups, subnetMask=subnetMask, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationMode=tDDSynchronizationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userRole=userRole, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLineCode=telecomsLineCode, supplementaryGroup=supplementaryGroup, management=management, transmitChannel=transmitChannel, sNTPLastSync=sNTPLastSync, ethernet=ethernet, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, installArmState=installArmState, hTTPSAccessEnabled=hTTPSAccessEnabled, telnetPortNumber=telnetPortNumber, linkLoss=linkLoss, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTable=dfsTable, linkName=linkName, telnetAccessEnabled=telnetAccessEnabled, ptpCompliance=ptpCompliance, managementGroup=managementGroup, ptp500=ptp500, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPPortNumber=sNMPPortNumber, systemClock=systemClock, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, licence=licence, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPAccessEnabled=hTTPAccessEnabled, phyControlGroup=phyControlGroup, versionsGroup=versionsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsLoopbackTrap=telecomsLoopbackTrap, regionCodeTrap=regionCodeTrap, softwareVersion=softwareVersion, syslogState=syslogState, dfsTableIndex=dfsTableIndex, searchState=searchState, regionCode=regionCode, smtp=smtp, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, maximumTransmitPower=maximumTransmitPower, ptp=ptp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogClientTrap=syslogClientTrap, targetMACAddress=targetMACAddress, vLANManagementVID=vLANManagementVID, productVariant=productVariant, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, productName=productName, vLANManagementPriority=vLANManagementPriority, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelStatus=telecomsChannelStatus, vectorError=vectorError, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, systemReset=systemReset, userTableNumber=userTableNumber, phyStatus=phyStatus, dataPortAutoMdix=dataPortAutoMdix, sNMPv3Enable=sNMPv3Enable, dataPortStatusTrap=dataPortStatusTrap, transmitFreqKHz=transmitFreqKHz, pubStatsGroup=pubStatsGroup, linkSymmetry=linkSymmetry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsInterface=telecomsInterface, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installStatusTrap=installStatusTrap, licenceGroup=licenceGroup, installArmStateTrap=installArmStateTrap, dfsTableNumber=dfsTableNumber, alarmsGroup=alarmsGroup, ethernetGroup=ethernetGroup, groupID=groupID, sntp=sntp, snmpControlGroup=snmpControlGroup, bandwidthVariant=bandwidthVariant, transmitPower=transmitPower, receiveChannel=receiveChannel, byteErrorRatio=byteErrorRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, resetGroup=resetGroup, sNTPSync=sNTPSync)
