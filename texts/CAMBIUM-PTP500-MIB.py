...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitDataRate=transmitDataRate, dfsMeans=dfsMeans, ptp=ptp, syslogControl=syslogControl, systemClock=systemClock, signalStrengthRatio=signalStrengthRatio, hTTPSPortNumber=hTTPSPortNumber, userTableNumber=userTableNumber, userTableIndex=userTableIndex, sntp=sntp, sntpGroup=sntpGroup, sNMPEnabledTraps=sNMPEnabledTraps, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapVersion=sNMPTrapVersion, configuration=configuration, accessMethod=accessMethod, receiveFreqMHz=receiveFreqMHz, timeZone=timeZone, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, maximumTransmitPower=maximumTransmitPower, vectorError=vectorError, capacityLicenseMismatch=capacityLicenseMismatch, ethernetFiberSupport=ethernetFiberSupport, syslogControlGroup=syslogControlGroup, range=range, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitChannel=transmitChannel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControl=snmpControl, phyStatusGroup=phyStatusGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, unitOutOfCalibration=unitOutOfCalibration, secondarySoftwareVersion=secondarySoftwareVersion, telecomsInterface=telecomsInterface, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, dfsTableNumber=dfsTableNumber, snmpControlGroup=snmpControlGroup, syslogState=syslogState, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortDisabledWarning=dataPortDisabledWarning, receiveModulationMode=receiveModulationMode, cambium=cambium, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, userRole=userRole, userPassword=userPassword, managementGroup=managementGroup, phyControl=phyControl, versions=versions, telecomsChannelStatus=telecomsChannelStatus, installArmState=installArmState, receivePower=receivePower, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, PYSNMP_MODULE_ID=cambium, ptmp=ptmp, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegionCodes=incompatibleRegionCodes, vLANPriorityTableNumber=vLANPriorityTableNumber, systemReset=systemReset, sNTPPollInterval=sNTPPollInterval, frequencyVariant=frequencyVariant, transmitPower=transmitPower, ethernetGroup=ethernetGroup, telecomsCableLength=telecomsCableLength, productVariant=productVariant, licenceGroup=licenceGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpGroups=ptpGroups, receiveModulationModeDetail=receiveModulationModeDetail, receiveChannel=receiveChannel, dfs=dfs, supplementaryGroup=supplementaryGroup, hTTPAccessEnabled=hTTPAccessEnabled, licensedCapacity=licensedCapacity, transmitModulationMode=transmitModulationMode, dfsTableIndex=dfsTableIndex, transmitFreqKHz=transmitFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, iPAddress=iPAddress, eIRP=eIRP, channelBandwidth=channelBandwidth, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userEnabled=userEnabled, hardwareVersion=hardwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, phyStatus=phyStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsTable=dfsTable, linkSymmetry=linkSymmetry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, linkName=linkName, encryptionGroup=encryptionGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernet=ethernet, dfsGroup=dfsGroup, sNMPPortNumber=sNMPPortNumber, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTableEntry=userTableEntry, installStatus=installStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productName=productName, daylightSaving=daylightSaving, syslogStateTrap=syslogStateTrap, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, sNMPCommunityString=sNMPCommunityString, cableLoss=cableLoss, reset=reset, tFTPServerPortNumber=tFTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, latitude=latitude, regionCode=regionCode, sNTPSync=sNTPSync, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, resetGroup=resetGroup, vLANManagementVID=vLANManagementVID, licence=licence, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, vLANPriorityTable=vLANPriorityTable, alarms=alarms, ptpTraps=ptpTraps, subnetMask=subnetMask, receiveFreqKHz=receiveFreqKHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsLineCode=telecomsLineCode, sNMPTrapIPAddress=sNMPTrapIPAddress, smtp=smtp, antennaGain=antennaGain, telecomsLoopback=telecomsLoopback, receiveDataRate=receiveDataRate, longitude=longitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, channelChangeTrap=channelChangeTrap, configurationGroup=configurationGroup, transmitFreqMHz=transmitFreqMHz, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, encryption=encryption, groupID=groupID, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userName=userName, dfsTableEntry=dfsTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aAAControl=aAAControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, installStatusTrap=installStatusTrap, dataPortStatus=dataPortStatus, sNTPState=sNTPState, altitude=altitude, pubStatsGroup=pubStatsGroup, hTTPPortNumber=hTTPPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimisation=linkModeOptimisation, vLANManagementPriority=vLANManagementPriority, sNTPSyncTrap=sNTPSyncTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, ptp500=ptp500, sMTPEnabledMessages=sMTPEnabledMessages, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarmsGroup=alarmsGroup, telnetAccessEnabled=telnetAccessEnabled, linkLoss=linkLoss, tDDControl=tDDControl, sMTPServerPortNumber=sMTPServerPortNumber, remoteIPAddress=remoteIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, supplementary=supplementary, bootVersion=bootVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telnetPortNumber=telnetPortNumber, masterSlaveMode=masterSlaveMode, dfsPeaks=dfsPeaks, encryptionAlgorithm=encryptionAlgorithm, sNMPv3Enable=sNMPv3Enable, tFTPServerIPAddress=tFTPServerIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, syslogClient=syslogClient, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecom=telecom, ptpTrapPrefix=ptpTrapPrefix, smtpGroup=smtpGroup, telecomGroup=telecomGroup, dataPortAutoMdix=dataPortAutoMdix, userTable=userTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogClientTrap=syslogClientTrap, bandwidthVariant=bandwidthVariant, byteErrorRatio=byteErrorRatio, softwareVersion=softwareVersion, siteName=siteName, installArmStateTrap=installArmStateTrap, phyControlGroup=phyControlGroup)
