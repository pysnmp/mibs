...
MibIdentifier, iso, Unsigned32, Bits, TimeTicks, Counter32, Integer32, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, ObjectIdentity, Gauge32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Unsigned32", "Bits", "TimeTicks", "Counter32", "Integer32", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "ObjectIdentity", "Gauge32", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsMeans=dfsMeans, alarms=alarms, hTTPSPortNumber=hTTPSPortNumber, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibration=unitOutOfCalibration, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTableNumber=userTableNumber, ptp=ptp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControl=phyControl, telnetPortNumber=telnetPortNumber, eIRP=eIRP, dataPortAutoMdix=dataPortAutoMdix, dfsTableNumber=dfsTableNumber, phyStatusGroup=phyStatusGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, capacityLicenseMismatch=capacityLicenseMismatch, sNMPPortNumber=sNMPPortNumber, snmpControlGroup=snmpControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, linkSymmetry=linkSymmetry, sMTPServerPortNumber=sMTPServerPortNumber, smtp=smtp, supplementaryGroup=supplementaryGroup, versions=versions, installStatus=installStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPServerPortNumber=sNTPServerPortNumber, regionCode=regionCode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogControl=syslogControl, ptmp=ptmp, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, telecomsLineCode=telecomsLineCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitFreqKHz=transmitFreqKHz, sNTPState=sNTPState, userPassword=userPassword, licensedCapacity=licensedCapacity, syslogClient=syslogClient, sntpGroup=sntpGroup, syslogClientTrap=syslogClientTrap, groupID=groupID, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveChannel=receiveChannel, frequencyVariant=frequencyVariant, ptpTrapPrefix=ptpTrapPrefix, sMTPServerIPAddress=sMTPServerIPAddress, configuration=configuration, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsLoopback=telecomsLoopback, syslogState=syslogState, sNTPSyncTrap=sNTPSyncTrap, encryption=encryption, sNMPCommunityString=sNMPCommunityString, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, bootVersion=bootVersion, transmitChannel=transmitChannel, snmpControl=snmpControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, gatewayIPAddress=gatewayIPAddress, aAAControl=aAAControl, installStatusTrap=installStatusTrap, sntp=sntp, telecomsInterface=telecomsInterface, supplementary=supplementary, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpCompliance=ptpCompliance, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemReset=systemReset, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, encryptionGroup=encryptionGroup, telecomGroup=telecomGroup, cableLoss=cableLoss, siteName=siteName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, maximumTransmitPower=maximumTransmitPower, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, accessMethod=accessMethod, ethernetFiberSupport=ethernetFiberSupport, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPLastSync=sNTPLastSync, telecomsChannelStatus=telecomsChannelStatus, userTable=userTable, dataPortDisabledWarning=dataPortDisabledWarning, hTTPSAccessEnabled=hTTPSAccessEnabled, range=range, sNMPTrapTableNumber=sNMPTrapTableNumber, timeZone=timeZone, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogControlGroup=syslogControlGroup, managementGroup=managementGroup, dfsTable=dfsTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTableEntry=dfsTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableIndex=userTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, PYSNMP_MODULE_ID=cambium, signalStrengthRatio=signalStrengthRatio, dfsTableIndex=dfsTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cambium=cambium, iPAddress=iPAddress, incompatibleRegionCodes=incompatibleRegionCodes, searchState=searchState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteIPAddress=remoteIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, licence=licence, vLANPriorityTableEntry=vLANPriorityTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPEmailAlert=sMTPEmailAlert, userRole=userRole, dfsPeaks=dfsPeaks, telnetAccessEnabled=telnetAccessEnabled, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, bandwidthVariant=bandwidthVariant, versionsGroup=versionsGroup, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, userName=userName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aggregateDataRate=aggregateDataRate, daylightSaving=daylightSaving, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitModulationMode=transmitModulationMode, byteErrorRatio=byteErrorRatio, ethernetGroup=ethernetGroup, vLANPriorityTable=vLANPriorityTable, subnetMask=subnetMask, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, ptpGroups=ptpGroups, encryptionAlgorithm=encryptionAlgorithm, transmitDataRate=transmitDataRate, ptp500=ptp500, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPServerIPAddress=sNTPServerIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANManagementVID=vLANManagementVID, tFTPServerIPAddress=tFTPServerIPAddress, aAAControlGroup=aAAControlGroup, targetMACAddress=targetMACAddress, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStatsGroup=pubStatsGroup, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqMHz=receiveFreqMHz, altitude=altitude, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsCableLength=telecomsCableLength, vLANManagementPriority=vLANManagementPriority, syslogStateTrap=syslogStateTrap, receiveFreqKHz=receiveFreqKHz, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, linkName=linkName, userEnabled=userEnabled, sNTPSync=sNTPSync, dfsGroup=dfsGroup, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDControl=tDDControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, sNTPPollInterval=sNTPPollInterval, latitude=latitude, userTableEntry=userTableEntry, productVariant=productVariant, dfs=dfs, productName=productName, noWirelessChannelAvailable=noWirelessChannelAvailable, channelChangeTrap=channelChangeTrap, phyStatus=phyStatus, resetGroup=resetGroup, transmitPower=transmitPower, antennaGain=antennaGain, receiveDataRate=receiveDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regionCodeTrap=regionCodeTrap, installArmState=installArmState, ptpTraps=ptpTraps, dataPortStatusTrap=dataPortStatusTrap, notificationsGroup=notificationsGroup, receivePower=receivePower, ethernet=ethernet, linkModeOptimisation=linkModeOptimisation, hTTPAccessEnabled=hTTPAccessEnabled, telecomsLoopbackTrap=telecomsLoopbackTrap, licenceGroup=licenceGroup, dataPortStatus=dataPortStatus, wirelessLinkAvailability=wirelessLinkAvailability, hardwareVersion=hardwareVersion, systemClock=systemClock, phyControlGroup=phyControlGroup, longitude=longitude, vectorError=vectorError)
