...
Integer32, Counter32, Gauge32, Unsigned32, enterprises, iso, Bits, MibIdentifier, ObjectIdentity, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Gauge32", "Unsigned32", "enterprises", "iso", "Bits", "MibIdentifier", "ObjectIdentity", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, sNTPState=sNTPState, syslogClient=syslogClient, telecom=telecom, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installStatus=installStatus, dfs=dfs, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControlGroup=tDDControlGroup, snmpControlGroup=snmpControlGroup, userPassword=userPassword, userTableNumber=userTableNumber, linkSymmetry=linkSymmetry, phyStatusGroup=phyStatusGroup, linkName=linkName, managementGroup=managementGroup, syslogClientTrap=syslogClientTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, vLANPriorityTableNumber=vLANPriorityTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLoopbackTrap=telecomsLoopbackTrap, alarmsGroup=alarmsGroup, PYSNMP_MODULE_ID=cambium, altitude=altitude, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licence=licence, phyControlGroup=phyControlGroup, sNTPPollInterval=sNTPPollInterval, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTable=vLANPriorityTable, productName=productName, sNTPServerIPAddress=sNTPServerIPAddress, syslogState=syslogState, supplementary=supplementary, linkModeOptimisation=linkModeOptimisation, vectorError=vectorError, signalStrengthRatio=signalStrengthRatio, configuration=configuration, groupID=groupID, sNTPLastSync=sNTPLastSync, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqKHz=receiveFreqKHz, unitOutOfCalibration=unitOutOfCalibration, aAAControl=aAAControl, configurationGroup=configurationGroup, dfsTableNumber=dfsTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoMdix=dataPortAutoMdix, pubStatsGroup=pubStatsGroup, sNMPPortNumber=sNMPPortNumber, syslogControlGroup=syslogControlGroup, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, frequencyVariant=frequencyVariant, sMTPEmailAlert=sMTPEmailAlert, supplementaryGroup=supplementaryGroup, receivePower=receivePower, capacityLicenseMismatch=capacityLicenseMismatch, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aggregateDataRate=aggregateDataRate, eIRP=eIRP, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, daylightSaving=daylightSaving, userTable=userTable, ethernetFiberSupport=ethernetFiberSupport, regionCode=regionCode, telnetAccessEnabled=telnetAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, accessMethod=accessMethod, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsInterface=telecomsInterface, receiveFreqMHz=receiveFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, sntp=sntp, channelChangeTrap=channelChangeTrap, versionsGroup=versionsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableIndex=userTableIndex, receiveChannel=receiveChannel, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, hardwareVersion=hardwareVersion, masterSlaveMode=masterSlaveMode, encryption=encryption, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsTableIndex=dfsTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptpGroups=ptpGroups, bandwidthVariant=bandwidthVariant, telecomsLineCode=telecomsLineCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitChannel=transmitChannel, vLANManagementPriority=vLANManagementPriority, smtp=smtp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsCableLength=telecomsCableLength, dfsPeaks=dfsPeaks, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, timeZone=timeZone, receiveModulationMode=receiveModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPCommunityString=sNMPCommunityString, latitude=latitude, remoteIPAddress=remoteIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, secondarySoftwareVersion=secondarySoftwareVersion, sNMPv3Enable=sNMPv3Enable, transmitPower=transmitPower, subnetMask=subnetMask, transmitFreqMHz=transmitFreqMHz, userEnabled=userEnabled, hTTPSPortNumber=hTTPSPortNumber, telecomsLoopback=telecomsLoopback, tDDControl=tDDControl, ptmp=ptmp, telecomGroup=telecomGroup, channelBandwidth=channelBandwidth, syslogStateTrap=syslogStateTrap, licensedCapacity=licensedCapacity, ptp500=ptp500, dfsTable=dfsTable, alarms=alarms, range=range, sNTPSync=sNTPSync, receiveDataRate=receiveDataRate, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogControl=syslogControl, sMTPServerIPAddress=sMTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatus=wirelessLinkStatus, licenceGroup=licenceGroup, aAAControlGroup=aAAControlGroup, systemClock=systemClock, wirelessLinkAvailability=wirelessLinkAvailability, sntpGroup=sntpGroup, cableLoss=cableLoss, phyControl=phyControl, maximumTransmitPower=maximumTransmitPower, userRole=userRole, userName=userName, constantPowerSpectralDensity=constantPowerSpectralDensity, antennaGain=antennaGain, ptp=ptp, sMTPServerPortNumber=sMTPServerPortNumber, softwareVersion=softwareVersion, cambium=cambium, dfsTableEntry=dfsTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, reset=reset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, bootVersion=bootVersion, searchState=searchState, transmitDataRate=transmitDataRate, encryptionGroup=encryptionGroup, ptpTrapPrefix=ptpTrapPrefix, ethernetGroup=ethernetGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodes=incompatibleRegionCodes, iPAddress=iPAddress, sNMPTrapTable=sNMPTrapTable, dataPortDisabledWarning=dataPortDisabledWarning, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerPortNumber=sNTPServerPortNumber, dfsGroup=dfsGroup, ethernet=ethernet, installArmState=installArmState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkLoss=linkLoss, userTableEntry=userTableEntry, siteName=siteName, hTTPAccessEnabled=hTTPAccessEnabled, longitude=longitude, transmitModulationMode=transmitModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsMeans=dfsMeans, encryptionAlgorithm=encryptionAlgorithm, hTTPPortNumber=hTTPPortNumber, regionCodeTrap=regionCodeTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANManagementVID=vLANManagementVID, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPSyncTrap=sNTPSyncTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsChannelStatus=telecomsChannelStatus, systemReset=systemReset, notificationsGroup=notificationsGroup, telnetPortNumber=telnetPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStats=pubStats, resetGroup=resetGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, byteErrorRatio=byteErrorRatio, versions=versions, targetMACAddress=targetMACAddress, installStatusTrap=installStatusTrap, installArmStateTrap=installArmStateTrap, snmpControl=snmpControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText)
