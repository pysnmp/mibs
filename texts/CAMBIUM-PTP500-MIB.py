...
iso, IpAddress, Integer32, enterprises, Counter32, ObjectIdentity, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, TimeTicks, ModuleIdentity, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "IpAddress", "Integer32", "enterprises", "Counter32", "ObjectIdentity", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installArmState=installArmState, sntp=sntp, timeZone=timeZone, ptpTraps=ptpTraps, configuration=configuration, dfsTableEntry=dfsTableEntry, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, licensedCapacity=licensedCapacity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsLoopback=telecomsLoopback, sNTPState=sNTPState, dfsTableIndex=dfsTableIndex, transmitFreqKHz=transmitFreqKHz, smtpGroup=smtpGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPSPortNumber=hTTPSPortNumber, telecomsInterface=telecomsInterface, installStatus=installStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, groupID=groupID, telnetAccessEnabled=telnetAccessEnabled, gatewayIPAddress=gatewayIPAddress, userPassword=userPassword, altitude=altitude, linkModeOptimisation=linkModeOptimisation, managementGroup=managementGroup, regionCodeTrap=regionCodeTrap, linkName=linkName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogState=syslogState, smtp=smtp, vLANPriorityTableEntry=vLANPriorityTableEntry, productVariant=productVariant, tFTPServerPortNumber=tFTPServerPortNumber, searchState=searchState, sNMPPortNumber=sNMPPortNumber, syslogStateTrap=syslogStateTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, receiveChannel=receiveChannel, versionsGroup=versionsGroup, vLANManagementVID=vLANManagementVID, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsChannelStatus=telecomsChannelStatus, phyStatus=phyStatus, installArmStateTrap=installArmStateTrap, dataPortStatusTrap=dataPortStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptp500=ptp500, receiveFreqKHz=receiveFreqKHz, encryptionAlgorithm=encryptionAlgorithm, supplementary=supplementary, antennaGain=antennaGain, ptpCompliance=ptpCompliance, sNMPTrapPortNumber=sNMPTrapPortNumber, channelChangeTrap=channelChangeTrap, hardwareVersion=hardwareVersion, telecomGroup=telecomGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableIndex=userTableIndex, receiveDataRate=receiveDataRate, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, aAAControl=aAAControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableNumber=dfsTableNumber, productName=productName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControl=snmpControl, pubStats=pubStats, receiveModulationMode=receiveModulationMode, ethernet=ethernet, wirelessLinkAvailability=wirelessLinkAvailability, ethernetGroup=ethernetGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, frequencyVariant=frequencyVariant, telecomsCableLength=telecomsCableLength, wirelessLinkStatus=wirelessLinkStatus, systemReset=systemReset, licenceGroup=licenceGroup, bootVersion=bootVersion, dataPortAutoMdix=dataPortAutoMdix, encryption=encryption, hTTPSAccessEnabled=hTTPSAccessEnabled, systemClock=systemClock, latitude=latitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, reset=reset, userTableEntry=userTableEntry, alarms=alarms, tDDSynchronizationStatus=tDDSynchronizationStatus, userName=userName, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, userRole=userRole, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPv3Enable=sNMPv3Enable, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibration=unitOutOfCalibration, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBandwidth=channelBandwidth, supplementaryGroup=supplementaryGroup, aAAControlGroup=aAAControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, syslogClientTrap=syslogClientTrap, phyControlGroup=phyControlGroup, cableLoss=cableLoss, maximumTransmitPower=maximumTransmitPower, snmpControlGroup=snmpControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyStatusGroup=phyStatusGroup, syslogControlGroup=syslogControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerPortNumber=sNTPServerPortNumber, userEnabled=userEnabled, aggregateDataRate=aggregateDataRate, sNTPSync=sNTPSync, notificationsGroup=notificationsGroup, targetMACAddress=targetMACAddress, dfsGroup=dfsGroup, encryptionGroup=encryptionGroup, phyControl=phyControl, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, sNMPEnabledTraps=sNMPEnabledTraps, dfsPeaks=dfsPeaks, tDDControl=tDDControl, masterSlaveMode=masterSlaveMode, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, versions=versions, telnetPortNumber=telnetPortNumber, telecom=telecom, eIRP=eIRP, tFTPServerIPAddress=tFTPServerIPAddress, range=range, hTTPAccessEnabled=hTTPAccessEnabled, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPServerPortNumber=sMTPServerPortNumber, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, byteErrorRatio=byteErrorRatio, longitude=longitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitModulationMode=transmitModulationMode, sNTPPollInterval=sNTPPollInterval, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, vectorError=vectorError, resetGroup=resetGroup, bandwidthVariant=bandwidthVariant, iPAddress=iPAddress, accessMethod=accessMethod, transmitPower=transmitPower, ptp=ptp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsLineCode=telecomsLineCode, signalStrengthRatio=signalStrengthRatio, linkLoss=linkLoss, subnetMask=subnetMask, syslogClient=syslogClient, sNMPTrapTableEntry=sNMPTrapTableEntry, pubStatsGroup=pubStatsGroup, dfs=dfs, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, management=management, daylightSaving=daylightSaving, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityTable=vLANPriorityTable, linkSymmetry=linkSymmetry, receiveModulationModeDetail=receiveModulationModeDetail, sNTPSyncTrap=sNTPSyncTrap, remoteIPAddress=remoteIPAddress, syslogControl=syslogControl, sNMPTrapVersion=sNMPTrapVersion, installStatusTrap=installStatusTrap, ptmp=ptmp, capacityLicenseMismatch=capacityLicenseMismatch, vLANManagementPriority=vLANManagementPriority, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, dfsMeans=dfsMeans, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, sntpGroup=sntpGroup, receiveFreqMHz=receiveFreqMHz, tDDControlGroup=tDDControlGroup, transmitDataRate=transmitDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTable=sNMPTrapTable, configurationGroup=configurationGroup, userTable=userTable, userTableNumber=userTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPEnabledMessages=sMTPEnabledMessages, licence=licence)
