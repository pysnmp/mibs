...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:30:10 2021
...
IpAddress, Counter64, Unsigned32, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, Bits, ObjectIdentity, Counter32, MibIdentifier, Integer32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Unsigned32", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "Bits", "ObjectIdentity", "Counter32", "MibIdentifier", "Integer32", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortWirelessDownAlert=dataPortWirelessDownAlert, timeZone=timeZone, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, notificationsGroup=notificationsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemClock=systemClock, sNMPv3Enable=sNMPv3Enable, ptpGroups=ptpGroups, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTable=sNMPTrapTable, phyStatusGroup=phyStatusGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPPollInterval=sNTPPollInterval, versions=versions, dfs=dfs, wirelessLinkAvailability=wirelessLinkAvailability, groupID=groupID, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, management=management, vLANManagementPriority=vLANManagementPriority, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitChannel=transmitChannel, channelBandwidth=channelBandwidth, antennaGain=antennaGain, dfsTableEntry=dfsTableEntry, accessMethod=accessMethod, phyControlGroup=phyControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receivePower=receivePower, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, configuration=configuration, sNMPEnabledTraps=sNMPEnabledTraps, userEnabled=userEnabled, channelChangeTrap=channelChangeTrap, masterSlaveMode=masterSlaveMode, dataPortAutoNegotiation=dataPortAutoNegotiation, regionCodeTrap=regionCodeTrap, subnetMask=subnetMask, softwareVersion=softwareVersion, installArmState=installArmState, latitude=latitude, sNTPState=sNTPState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPPortNumber=sNMPPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, vLANManagementVID=vLANManagementVID, unitOutOfCalibration=unitOutOfCalibration, licensedCapacity=licensedCapacity, tDDControl=tDDControl, telecomsCableLength=telecomsCableLength, telnetAccessEnabled=telnetAccessEnabled, userTableIndex=userTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, longitude=longitude, sNMPTrapTableEntry=sNMPTrapTableEntry, bandwidthVariant=bandwidthVariant, snmpControl=snmpControl, dfsTableNumber=dfsTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, iPAddress=iPAddress, telecomsLineCode=telecomsLineCode, phyControl=phyControl, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControlGroup=aAAControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, transmitDataRate=transmitDataRate, managementGroup=managementGroup, systemReset=systemReset, daylightSaving=daylightSaving, pubStatsGroup=pubStatsGroup, sMTPServerIPAddress=sMTPServerIPAddress, installStatus=installStatus, telecom=telecom, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogState=syslogState, syslogStateTrap=syslogStateTrap, receiveModulationModeDetail=receiveModulationModeDetail, productName=productName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogClientTrap=syslogClientTrap, frequencyVariant=frequencyVariant, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControl=syslogControl, pubStats=pubStats, userName=userName, vLANPriorityTableNumber=vLANPriorityTableNumber, cambium=cambium, supplementary=supplementary, receiveFreqKHz=receiveFreqKHz, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimisation=linkModeOptimisation, searchState=searchState, telnetPortNumber=telnetPortNumber, smtp=smtp, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPEmailAlert=sMTPEmailAlert, tDDControlGroup=tDDControlGroup, maximumTransmitPower=maximumTransmitPower, syslogControlGroup=syslogControlGroup, ptp500=ptp500, constantPowerSpectralDensity=constantPowerSpectralDensity, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptmp=ptmp, dfsTableIndex=dfsTableIndex, siteName=siteName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, regionCode=regionCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryptionGroup=encryptionGroup, dfsMeans=dfsMeans, ethernetGroup=ethernetGroup, encryption=encryption, hTTPPortNumber=hTTPPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionAlgorithm=encryptionAlgorithm, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationMode=tDDSynchronizationMode, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, altitude=altitude, syslogClient=syslogClient, telecomsInterface=telecomsInterface, installStatusTrap=installStatusTrap, remoteIPAddress=remoteIPAddress, bootVersion=bootVersion, receiveChannel=receiveChannel, licenceGroup=licenceGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTableIndex=vLANPriorityTableIndex, ptp=ptp, targetMACAddress=targetMACAddress, transmitFreqMHz=transmitFreqMHz, range=range, gatewayIPAddress=gatewayIPAddress, userRole=userRole, smtpGroup=smtpGroup, configurationGroup=configurationGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsGroup=dfsGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsTable=dfsTable, cableLoss=cableLoss, byteErrorRatio=byteErrorRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, alarmsGroup=alarmsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, versionsGroup=versionsGroup, linkSymmetry=linkSymmetry, userTableNumber=userTableNumber, transmitFreqKHz=transmitFreqKHz, linkName=linkName, transmitModulationMode=transmitModulationMode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hTTPSPortNumber=hTTPSPortNumber, linkLoss=linkLoss, sNTPServerIPAddress=sNTPServerIPAddress, snmpControlGroup=snmpControlGroup, dfsPeaks=dfsPeaks, incompatibleRegionCodes=incompatibleRegionCodes, productVariant=productVariant, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aAAControl=aAAControl, PYSNMP_MODULE_ID=cambium, ethernetFiberSupport=ethernetFiberSupport, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, sntp=sntp, telecomsLoopback=telecomsLoopback, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANPriorityTable=vLANPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSync=sNTPSync, receiveDataRate=receiveDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatus=dataPortStatus, ptpTraps=ptpTraps, signalStrengthRatio=signalStrengthRatio, telecomsChannelStatus=telecomsChannelStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, eIRP=eIRP, sNMPCommunityString=sNMPCommunityString, userTableEntry=userTableEntry, userPassword=userPassword, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, receiveModulationMode=receiveModulationMode, supplementaryGroup=supplementaryGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarning=dataPortDisabledWarning, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, resetGroup=resetGroup, telecomGroup=telecomGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, licence=licence, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vectorError=vectorError, sNMPTrapPortNumber=sNMPTrapPortNumber, userTable=userTable, alarms=alarms, ptpCompliance=ptpCompliance, capacityLicenseMismatch=capacityLicenseMismatch, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, reset=reset)
