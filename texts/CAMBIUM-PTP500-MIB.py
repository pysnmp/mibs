...
Gauge32, iso, enterprises, Bits, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, TimeTicks, Counter32, Unsigned32, ObjectIdentity, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "enterprises", "Bits", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "TimeTicks", "Counter32", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", latitude=latitude, syslogControlGroup=syslogControlGroup, sNTPLastSync=sNTPLastSync, userName=userName, encryptionGroup=encryptionGroup, longitude=longitude, licensedCapacity=licensedCapacity, syslogState=syslogState, ptp=ptp, configuration=configuration, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetMACAddress=targetMACAddress, tDDSynchronizationMode=tDDSynchronizationMode, sNTPSync=sNTPSync, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControlGroup=aAAControlGroup, hTTPSPortNumber=hTTPSPortNumber, channelChangeTrap=channelChangeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, supplementary=supplementary, sMTPServerPortNumber=sMTPServerPortNumber, sntp=sntp, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPEmailAlert=sMTPEmailAlert, versions=versions, telecomsLineCode=telecomsLineCode, installStatusTrap=installStatusTrap, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, snmpControl=snmpControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableEntry=dfsTableEntry, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, tDDControl=tDDControl, channelBandwidth=channelBandwidth, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, vLANPriorityTable=vLANPriorityTable, receiveModulationMode=receiveModulationMode, transmitFreqKHz=transmitFreqKHz, bandwidthVariant=bandwidthVariant, masterSlaveMode=masterSlaveMode, phyStatus=phyStatus, receiveFreqKHz=receiveFreqKHz, notificationsGroup=notificationsGroup, dataPortAutoMdix=dataPortAutoMdix, syslogStateTrap=syslogStateTrap, sNMPTrapTable=sNMPTrapTable, tFTPServerIPAddress=tFTPServerIPAddress, bootVersion=bootVersion, snmpControlGroup=snmpControlGroup, userTable=userTable, telecomsChannelStatusTrap=telecomsChannelStatusTrap, aAAControl=aAAControl, transmitDataRate=transmitDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPEnabledMessages=sMTPEnabledMessages, transmitModulationMode=transmitModulationMode, wirelessLinkStatus=wirelessLinkStatus, dataPortDisabledWarning=dataPortDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, PYSNMP_MODULE_ID=cambium, syslogClientTrap=syslogClientTrap, vLANManagementVID=vLANManagementVID, vLANManagementPriority=vLANManagementPriority, systemReset=systemReset, transmitFreqMHz=transmitFreqMHz, smtp=smtp, telecomsLoopback=telecomsLoopback, siteName=siteName, management=management, telecom=telecom, dataPortStatus=dataPortStatus, unitOutOfCalibration=unitOutOfCalibration, ptpTraps=ptpTraps, telecomsChannelStatus=telecomsChannelStatus, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityQueueMapping=vLANPriorityQueueMapping, byteErrorRatio=byteErrorRatio, vectorError=vectorError, linkModeOptimisation=linkModeOptimisation, receivePower=receivePower, hTTPSAccessEnabled=hTTPSAccessEnabled, installArmState=installArmState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenceGroup=licenceGroup, dfsTable=dfsTable, cableLoss=cableLoss, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, reset=reset, alarmsGroup=alarmsGroup, hTTPAccessEnabled=hTTPAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarms=alarms, userPassword=userPassword, dataPortAutoNegotiation=dataPortAutoNegotiation, encryption=encryption, transmitPower=transmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, smtpGroup=smtpGroup, telnetPortNumber=telnetPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetGroup=ethernetGroup, supplementaryGroup=supplementaryGroup, eIRP=eIRP, transmitChannel=transmitChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsMeans=dfsMeans, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapVersion=sNMPTrapVersion, sNMPPortNumber=sNMPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, daylightSaving=daylightSaving, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, configurationGroup=configurationGroup, subnetMask=subnetMask, sMTPSourceEmailAddress=sMTPSourceEmailAddress, iPAddress=iPAddress, remoteIPAddress=remoteIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, syslogClient=syslogClient, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPPollInterval=sNTPPollInterval, userEnabled=userEnabled, phyControlGroup=phyControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableNumber=userTableNumber, sNMPv3Enable=sNMPv3Enable, incompatibleRegionCodes=incompatibleRegionCodes, range=range, installArmStateTrap=installArmStateTrap, accessMethod=accessMethod, groupID=groupID, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerPortNumber=sNTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsPeaks=dfsPeaks, antennaGain=antennaGain, pubStats=pubStats, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsGroup=dfsGroup, softwareVersion=softwareVersion, encryptionAlgorithm=encryptionAlgorithm, timeZone=timeZone, signalStrengthRatio=signalStrengthRatio, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userRole=userRole, sNTPSyncTrap=sNTPSyncTrap, productName=productName, telnetAccessEnabled=telnetAccessEnabled, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, phyControl=phyControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpGroups=ptpGroups, ptpCompliance=ptpCompliance, userTableEntry=userTableEntry, receiveFreqMHz=receiveFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsTableNumber=dfsTableNumber, telecomsCableLength=telecomsCableLength, vLANPriorityTableEntry=vLANPriorityTableEntry, regionCodeTrap=regionCodeTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, gatewayIPAddress=gatewayIPAddress, hTTPPortNumber=hTTPPortNumber, ptp500=ptp500, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPState=sNTPState, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogControl=syslogControl, linkSymmetry=linkSymmetry, userTableIndex=userTableIndex, sntpGroup=sntpGroup, receiveChannel=receiveChannel, hardwareVersion=hardwareVersion, installStatus=installStatus, searchState=searchState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsInterface=telecomsInterface, tDDSynchronizationAlarm=tDDSynchronizationAlarm, resetGroup=resetGroup, sNTPServerIPAddress=sNTPServerIPAddress, altitude=altitude, aggregateDataRate=aggregateDataRate, ptmp=ptmp, tDDControlGroup=tDDControlGroup, frequencyVariant=frequencyVariant, cambium=cambium, regionCode=regionCode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, licence=licence, phyStatusGroup=phyStatusGroup, dfsTableIndex=dfsTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomGroup=telecomGroup, receiveModulationModeDetail=receiveModulationModeDetail, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfs=dfs, linkLoss=linkLoss)
