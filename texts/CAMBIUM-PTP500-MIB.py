...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANManagementPriority=vLANManagementPriority, bootVersion=bootVersion, dfs=dfs, linkLoss=linkLoss, tFTPServerIPAddress=tFTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionAlgorithm=encryptionAlgorithm, licenceGroup=licenceGroup, sntp=sntp, ptpTraps=ptpTraps, sntpGroup=sntpGroup, telecomsLoopback=telecomsLoopback, receiveFreqMHz=receiveFreqMHz, sMTPEmailAlert=sMTPEmailAlert, userTableIndex=userTableIndex, targetMACAddress=targetMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userPassword=userPassword, smtpGroup=smtpGroup, versions=versions, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapPortNumber=sNMPTrapPortNumber, encryptionGroup=encryptionGroup, userTable=userTable, sNTPSync=sNTPSync, sNTPSyncTrap=sNTPSyncTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, userName=userName, tDDControlGroup=tDDControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetGroup=ethernetGroup, linkSymmetry=linkSymmetry, range=range, hTTPSPortNumber=hTTPSPortNumber, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, syslogControl=syslogControl, managementGroup=managementGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, latitude=latitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receivePower=receivePower, alarmsGroup=alarmsGroup, receiveDataRate=receiveDataRate, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANPriorityTable=vLANPriorityTable, timeZone=timeZone, sNTPState=sNTPState, resetGroup=resetGroup, tDDSynchronizationMode=tDDSynchronizationMode, ptp500=ptp500, versionsGroup=versionsGroup, syslogControlGroup=syslogControlGroup, ptpCompliance=ptpCompliance, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStatsGroup=pubStatsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, secondarySoftwareVersion=secondarySoftwareVersion, transmitChannel=transmitChannel, channelChangeTrap=channelChangeTrap, ptpTrapPrefix=ptpTrapPrefix, dfsGroup=dfsGroup, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitOutOfCalibration=unitOutOfCalibration, hTTPAccessEnabled=hTTPAccessEnabled, groupID=groupID, productName=productName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomGroup=telecomGroup, phyStatus=phyStatus, userTableEntry=userTableEntry, altitude=altitude, receiveModulationModeDetail=receiveModulationModeDetail, snmpControlGroup=snmpControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteIPAddress=remoteIPAddress, telecom=telecom, syslogClientTrap=syslogClientTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, gatewayIPAddress=gatewayIPAddress, installArmState=installArmState, sMTPServerIPAddress=sMTPServerIPAddress, syslogState=syslogState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, installArmStateTrap=installArmStateTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerIPAddress=sNTPServerIPAddress, ptmp=ptmp, configurationGroup=configurationGroup, wirelessLinkAvailability=wirelessLinkAvailability, sNMPEnabledTraps=sNMPEnabledTraps, snmpControl=snmpControl, pubStats=pubStats, dfsTable=dfsTable, sNMPPortNumber=sNMPPortNumber, ptpGroups=ptpGroups, eIRP=eIRP, dfsTableIndex=dfsTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, daylightSaving=daylightSaving, supplementary=supplementary, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installStatus=installStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarms=alarms, regionCode=regionCode, transmitDataRate=transmitDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, encryption=encryption, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, siteName=siteName, configuration=configuration, userTableNumber=userTableNumber, phyControl=phyControl, dataPortStatus=dataPortStatus, receiveChannel=receiveChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, cambium=cambium, dfsTableEntry=dfsTableEntry, subnetMask=subnetMask, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitModulationMode=transmitModulationMode, syslogClient=syslogClient, ptp=ptp, supplementaryGroup=supplementaryGroup, transmitFreqKHz=transmitFreqKHz, systemClock=systemClock, telecomsInterface=telecomsInterface, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, sNMPTrapVersion=sNMPTrapVersion, antennaGain=antennaGain, telnetPortNumber=telnetPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, aAAControl=aAAControl, cableLoss=cableLoss, PYSNMP_MODULE_ID=cambium, wirelessLinkStatus=wirelessLinkStatus, phyStatusGroup=phyStatusGroup, ethernet=ethernet, accessMethod=accessMethod, dataPortAutoNegotiation=dataPortAutoNegotiation, softwareVersion=softwareVersion, dataPortDisabledWarning=dataPortDisabledWarning, reset=reset, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsLoopbackTrap=telecomsLoopbackTrap, installStatusTrap=installStatusTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsLineCode=telecomsLineCode, frequencyVariant=frequencyVariant, phyControlGroup=phyControlGroup, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, notificationsGroup=notificationsGroup, capacityLicenseMismatch=capacityLicenseMismatch, searchState=searchState, regionCodeTrap=regionCodeTrap, telecomsCableLength=telecomsCableLength, sMTPSourceEmailAddress=sMTPSourceEmailAddress, licensedCapacity=licensedCapacity, smtp=smtp, systemReset=systemReset, telecomsChannelStatus=telecomsChannelStatus, tFTPServerPortNumber=tFTPServerPortNumber, linkModeOptimisation=linkModeOptimisation, iPAddress=iPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsTableNumber=dfsTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANManagementVID=vLANManagementVID, dataPortStatusTrap=dataPortStatusTrap, hTTPPortNumber=hTTPPortNumber, dataPortAutoMdix=dataPortAutoMdix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPCommunityString=sNMPCommunityString, incompatibleRegionCodes=incompatibleRegionCodes, byteErrorRatio=byteErrorRatio, sNTPLastSync=sNTPLastSync, management=management, aAAControlGroup=aAAControlGroup, longitude=longitude, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveModulationMode=receiveModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, licence=licence, sNMPTrapTable=sNMPTrapTable, transmitFreqMHz=transmitFreqMHz, dfsMeans=dfsMeans, vectorError=vectorError, transmitPower=transmitPower, tDDControl=tDDControl, productVariant=productVariant, linkName=linkName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bandwidthVariant=bandwidthVariant, hardwareVersion=hardwareVersion, userRole=userRole, receiveFreqKHz=receiveFreqKHz, dfsPeaks=dfsPeaks)
