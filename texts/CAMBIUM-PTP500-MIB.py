...
MibIdentifier, ObjectIdentity, NotificationType, Counter32, Unsigned32, iso, TimeTicks, Counter64, enterprises, ModuleIdentity, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "NotificationType", "Counter32", "Unsigned32", "iso", "TimeTicks", "Counter64", "enterprises", "ModuleIdentity", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userTable=userTable, wirelessLinkAvailability=wirelessLinkAvailability, dataPortStatusTrap=dataPortStatusTrap, installArmStateTrap=installArmStateTrap, dfsMeans=dfsMeans, siteName=siteName, receiveModulationModeDetail=receiveModulationModeDetail, receiveChannel=receiveChannel, channelBandwidth=channelBandwidth, bootVersion=bootVersion, byteErrorRatio=byteErrorRatio, subnetMask=subnetMask, groupID=groupID, ethernet=ethernet, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, PYSNMP_MODULE_ID=cambium, wirelessLinkStatus=wirelessLinkStatus, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenceGroup=licenceGroup, linkLoss=linkLoss, incompatibleRegionCodes=incompatibleRegionCodes, licence=licence, telecomsLoopback=telecomsLoopback, channelChangeTrap=channelChangeTrap, encryption=encryption, installArmState=installArmState, ptpGroups=ptpGroups, sNMPTrapPortNumber=sNMPTrapPortNumber, searchState=searchState, sMTPServerPortNumber=sMTPServerPortNumber, telecomsLineCode=telecomsLineCode, antennaGain=antennaGain, sNTPState=sNTPState, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsInterface=telecomsInterface, signalStrengthRatio=signalStrengthRatio, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vectorError=vectorError, transmitFreqMHz=transmitFreqMHz, aAAControl=aAAControl, maximumTransmitPower=maximumTransmitPower, capacityLicenseMismatch=capacityLicenseMismatch, vLANManagementVID=vLANManagementVID, dfs=dfs, configuration=configuration, installStatus=installStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDControl=tDDControl, dfsTable=dfsTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationMode=tDDSynchronizationMode, transmitFreqKHz=transmitFreqKHz, masterSlaveMode=masterSlaveMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryptionAlgorithm=encryptionAlgorithm, transmitPower=transmitPower, sNTPSyncTrap=sNTPSyncTrap, snmpControl=snmpControl, smtpGroup=smtpGroup, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPCommunityString=sNMPCommunityString, sNTPServerIPAddress=sNTPServerIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, syslogClient=syslogClient, configurationGroup=configurationGroup, aggregateDataRate=aggregateDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlGroup=phyControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomGroup=telecomGroup, secondarySoftwareVersion=secondarySoftwareVersion, productVariant=productVariant, targetMACAddress=targetMACAddress, ptmp=ptmp, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptp=ptp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sntpGroup=sntpGroup, sMTPEmailAlert=sMTPEmailAlert, phyStatus=phyStatus, snmpControlGroup=snmpControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsPeaks=dfsPeaks, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, receivePower=receivePower, sNMPv3Enable=sNMPv3Enable, timeZone=timeZone, phyStatusGroup=phyStatusGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, management=management, ptpCompliance=ptpCompliance, sNMPTrapTable=sNMPTrapTable, hTTPAccessEnabled=hTTPAccessEnabled, supplementaryGroup=supplementaryGroup, userRole=userRole, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitModulationMode=transmitModulationMode, vLANPriorityTable=vLANPriorityTable, ptpTrapPrefix=ptpTrapPrefix, userTableNumber=userTableNumber, longitude=longitude, productName=productName, systemReset=systemReset, altitude=altitude, userTableEntry=userTableEntry, sNMPTrapVersion=sNMPTrapVersion, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPEnabledTraps=sNMPEnabledTraps, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitDataRate=transmitDataRate, softwareVersion=softwareVersion, unitOutOfCalibration=unitOutOfCalibration, syslogState=syslogState, telnetAccessEnabled=telnetAccessEnabled, linkSymmetry=linkSymmetry, telecomsCableLength=telecomsCableLength, sNTPLastSync=sNTPLastSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, userTableIndex=userTableIndex, userName=userName, managementGroup=managementGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPPollInterval=sNTPPollInterval, cambium=cambium, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, pubStats=pubStats, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, resetGroup=resetGroup, daylightSaving=daylightSaving, versions=versions, telnetPortNumber=telnetPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, reset=reset, licensedCapacity=licensedCapacity, dfsTableIndex=dfsTableIndex, cableLoss=cableLoss, userPassword=userPassword, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveDataRate=receiveDataRate, pubStatsGroup=pubStatsGroup, range=range, sNTPSync=sNTPSync, ptp500=ptp500, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installStatusTrap=installStatusTrap, phyControl=phyControl, ethernetFiberSupport=ethernetFiberSupport, frequencyVariant=frequencyVariant, dataPortDisabledWarning=dataPortDisabledWarning, hardwareVersion=hardwareVersion, receiveFreqKHz=receiveFreqKHz, dfsTableNumber=dfsTableNumber, latitude=latitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoMdix=dataPortAutoMdix, alarmsGroup=alarmsGroup, tDDControlGroup=tDDControlGroup, dfsTableEntry=dfsTableEntry, telecomsLoopbackTrap=telecomsLoopbackTrap, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, sntp=sntp, telecom=telecom, iPAddress=iPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, versionsGroup=versionsGroup, bandwidthVariant=bandwidthVariant, telecomsChannelStatus=telecomsChannelStatus, transmitChannel=transmitChannel, systemClock=systemClock, userEnabled=userEnabled, hTTPSPortNumber=hTTPSPortNumber, supplementary=supplementary, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, eIRP=eIRP, syslogStateTrap=syslogStateTrap, smtp=smtp, ptpTraps=ptpTraps, linkName=linkName, syslogControl=syslogControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteIPAddress=remoteIPAddress, notificationsGroup=notificationsGroup, dfsGroup=dfsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, regionCode=regionCode, aAAControlGroup=aAAControlGroup, gatewayIPAddress=gatewayIPAddress, encryptionGroup=encryptionGroup, sNMPPortNumber=sNMPPortNumber, accessMethod=accessMethod)
