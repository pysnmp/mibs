...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEnabledMessages=sMTPEnabledMessages, sNMPEnabledTraps=sNMPEnabledTraps, phyControl=phyControl, smtp=smtp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTable=sNMPTrapTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installArmState=installArmState, hTTPPortNumber=hTTPPortNumber, softwareVersion=softwareVersion, dfsTable=dfsTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntpGroup=sntpGroup, supplementaryGroup=supplementaryGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkLoss=linkLoss, telecomsLineCode=telecomsLineCode, dfs=dfs, licence=licence, dfsGroup=dfsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsCableLength=telecomsCableLength, userEnabled=userEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapPortNumber=sNMPTrapPortNumber, smtpGroup=smtpGroup, versionsGroup=versionsGroup, linkSymmetry=linkSymmetry, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, telnetPortNumber=telnetPortNumber, ptp=ptp, sNTPSync=sNTPSync, alarms=alarms, resetGroup=resetGroup, dfsMeans=dfsMeans, telecomGroup=telecomGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, sNMPCommunityString=sNMPCommunityString, maximumTransmitPower=maximumTransmitPower, linkModeOptimisation=linkModeOptimisation, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitFreqMHz=transmitFreqMHz, userTable=userTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortStatusTrap=dataPortStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementGroup=managementGroup, hardwareVersion=hardwareVersion, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, userRole=userRole, dataPortAutoMdix=dataPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, channelBandwidth=channelBandwidth, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableNumber=dfsTableNumber, phyControlGroup=phyControlGroup, ptpCompliance=ptpCompliance, sNMPTrapTableIndex=sNMPTrapTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTrapPrefix=ptpTrapPrefix, alarmsGroup=alarmsGroup, groupID=groupID, configuration=configuration, dfsTableIndex=dfsTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, installStatusTrap=installStatusTrap, telnetAccessEnabled=telnetAccessEnabled, userName=userName, timeZone=timeZone, channelChangeTrap=channelChangeTrap, iPAddress=iPAddress, latitude=latitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ethernetFiberSupport=ethernetFiberSupport, sntp=sntp, masterSlaveMode=masterSlaveMode, supplementary=supplementary, transmitFreqKHz=transmitFreqKHz, notificationsGroup=notificationsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPState=sNTPState, versions=versions, aAAControlGroup=aAAControlGroup, longitude=longitude, syslogState=syslogState, productName=productName, snmpControl=snmpControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkStatus=wirelessLinkStatus, secondarySoftwareVersion=secondarySoftwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogControlGroup=syslogControlGroup, phyStatus=phyStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityQueueMapping=vLANPriorityQueueMapping, bootVersion=bootVersion, transmitDataRate=transmitDataRate, syslogStateTrap=syslogStateTrap, ethernet=ethernet, systemReset=systemReset, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licensedCapacity=licensedCapacity, daylightSaving=daylightSaving, encryption=encryption, sMTPEmailAlert=sMTPEmailAlert, encryptionGroup=encryptionGroup, systemClock=systemClock, telecomsChannelStatus=telecomsChannelStatus, userPassword=userPassword, tDDControl=tDDControl, receiveChannel=receiveChannel, telecomsLoopback=telecomsLoopback, vectorError=vectorError, remoteIPAddress=remoteIPAddress, subnetMask=subnetMask, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, linkName=linkName, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveModulationModeDetail=receiveModulationModeDetail, installArmStateTrap=installArmStateTrap, bandwidthVariant=bandwidthVariant, hTTPSPortNumber=hTTPSPortNumber, pubStats=pubStats, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, ptp500=ptp500, sNTPLastSync=sNTPLastSync, ptpTraps=ptpTraps, receiveFreqMHz=receiveFreqMHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecom=telecom, ethernetGroup=ethernetGroup, tDDControlGroup=tDDControlGroup, management=management, eIRP=eIRP, frequencyVariant=frequencyVariant, byteErrorRatio=byteErrorRatio, sNTPServerPortNumber=sNTPServerPortNumber, userTableIndex=userTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsPeaks=dfsPeaks, regionCodeTrap=regionCodeTrap, aAAControl=aAAControl, syslogClient=syslogClient, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatus=installStatus, gatewayIPAddress=gatewayIPAddress, aggregateDataRate=aggregateDataRate, siteName=siteName, accessMethod=accessMethod, targetMACAddress=targetMACAddress, hTTPAccessEnabled=hTTPAccessEnabled, cableLoss=cableLoss, tFTPServerIPAddress=tFTPServerIPAddress, transmitPower=transmitPower, configurationGroup=configurationGroup, unitOutOfCalibration=unitOutOfCalibration, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, dfsTableEntry=dfsTableEntry, encryptionAlgorithm=encryptionAlgorithm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarning=dataPortDisabledWarning, ptpGroups=ptpGroups, range=range, transmitModulationMode=transmitModulationMode, productVariant=productVariant, syslogControl=syslogControl, receiveFreqKHz=receiveFreqKHz, capacityLicenseMismatch=capacityLicenseMismatch, regionCode=regionCode, telecomsInterface=telecomsInterface, pubStatsGroup=pubStatsGroup, altitude=altitude, enabledDiagnosticAlarms=enabledDiagnosticAlarms, cambium=cambium, tDDSynchronizationStatus=tDDSynchronizationStatus, signalStrengthRatio=signalStrengthRatio, ptmp=ptmp, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementPriority=vLANManagementPriority, phyStatusGroup=phyStatusGroup, userTableEntry=userTableEntry, antennaGain=antennaGain, sNMPv3Enable=sNMPv3Enable, PYSNMP_MODULE_ID=cambium, tDDSynchronizationMode=tDDSynchronizationMode, syslogClientTrap=syslogClientTrap, reset=reset, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTable=vLANPriorityTable, vLANManagementVID=vLANManagementVID, hTTPSAccessEnabled=hTTPSAccessEnabled, searchState=searchState)
