...
Gauge32, ObjectIdentity, Counter64, IpAddress, Counter32, TimeTicks, Unsigned32, enterprises, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ModuleIdentity, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Counter64", "IpAddress", "Counter32", "TimeTicks", "Unsigned32", "enterprises", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ModuleIdentity", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, aggregateDataRate=aggregateDataRate, altitude=altitude, ptmp=ptmp, sNTPPollInterval=sNTPPollInterval, receiveModulationMode=receiveModulationMode, transmitChannel=transmitChannel, userTableNumber=userTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, userEnabled=userEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveDataRate=receiveDataRate, syslogControlGroup=syslogControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licensedCapacity=licensedCapacity, installArmState=installArmState, sNMPPortNumber=sNMPPortNumber, ptpTrapPrefix=ptpTrapPrefix, telecomGroup=telecomGroup, dfsMeans=dfsMeans, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, supplementaryGroup=supplementaryGroup, managementGroup=managementGroup, dfsPeaks=dfsPeaks, dataPortDisabledWarning=dataPortDisabledWarning, aAAControl=aAAControl, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapVersion=sNMPTrapVersion, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, sNTPSync=sNTPSync, systemReset=systemReset, longitude=longitude, configurationGroup=configurationGroup, phyStatus=phyStatus, transmitFreqMHz=transmitFreqMHz, vLANManagementPriority=vLANManagementPriority, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licenceGroup=licenceGroup, ethernetGroup=ethernetGroup, sNTPServerPortNumber=sNTPServerPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, snmpControlGroup=snmpControlGroup, dfsTableNumber=dfsTableNumber, capacityLicenseMismatch=capacityLicenseMismatch, supplementary=supplementary, eIRP=eIRP, latitude=latitude, reset=reset, subnetMask=subnetMask, transmitDataRate=transmitDataRate, userPassword=userPassword, vectorError=vectorError, userTableEntry=userTableEntry, sNTPState=sNTPState, tDDControl=tDDControl, receivePower=receivePower, dfsTableIndex=dfsTableIndex, ptpCompliance=ptpCompliance, linkLoss=linkLoss, vLANPriorityTableNumber=vLANPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, groupID=groupID, installArmStateTrap=installArmStateTrap, receiveFreqMHz=receiveFreqMHz, syslogStateTrap=syslogStateTrap, hTTPSPortNumber=hTTPSPortNumber, cambium=cambium, ethernetFiberSupport=ethernetFiberSupport, dataPortAutoMdix=dataPortAutoMdix, pubStatsGroup=pubStatsGroup, sNTPSyncTrap=sNTPSyncTrap, phyControl=phyControl, sNMPv3Enable=sNMPv3Enable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, masterSlaveMode=masterSlaveMode, dataPortStatus=dataPortStatus, versions=versions, hardwareVersion=hardwareVersion, telecom=telecom, sNMPTrapTable=sNMPTrapTable, sntpGroup=sntpGroup, configuration=configuration, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, alarmsGroup=alarmsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, alarms=alarms, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telnetAccessEnabled=telnetAccessEnabled, telecomsLoopbackTrap=telecomsLoopbackTrap, maximumTransmitPower=maximumTransmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogState=syslogState, pubStats=pubStats, regionCodeTrap=regionCodeTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqKHz=receiveFreqKHz, licence=licence, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, enabledDiagnosticAlarms=enabledDiagnosticAlarms, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, snmpControl=snmpControl, userName=userName, syslogControl=syslogControl, management=management, telecomsCableLength=telecomsCableLength, linkModeOptimisation=linkModeOptimisation, byteErrorRatio=byteErrorRatio, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsChannelStatus=telecomsChannelStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, resetGroup=resetGroup, dfsGroup=dfsGroup, incompatibleRegionCodes=incompatibleRegionCodes, phyStatusGroup=phyStatusGroup, accessMethod=accessMethod, telecomsLineCode=telecomsLineCode, productVariant=productVariant, range=range, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfs=dfs, sNTPLastSync=sNTPLastSync, searchState=searchState, cableLoss=cableLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteIPAddress=remoteIPAddress, ptpGroups=ptpGroups, telecomsInterface=telecomsInterface, telecomsLoopback=telecomsLoopback, bandwidthVariant=bandwidthVariant, PYSNMP_MODULE_ID=cambium, constantPowerSpectralDensity=constantPowerSpectralDensity, iPAddress=iPAddress, softwareVersion=softwareVersion, encryptionAlgorithm=encryptionAlgorithm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, installStatusTrap=installStatusTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, siteName=siteName, phyControlGroup=phyControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, secondarySoftwareVersion=secondarySoftwareVersion, sntp=sntp, syslogClient=syslogClient, wirelessLinkStatus=wirelessLinkStatus, receiveModulationModeDetail=receiveModulationModeDetail, systemClock=systemClock, installStatus=installStatus, smtpGroup=smtpGroup, receiveChannel=receiveChannel, ptp=ptp, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkAvailability=wirelessLinkAvailability, smtp=smtp, regionCode=regionCode, tFTPServerIPAddress=tFTPServerIPAddress, bootVersion=bootVersion, notificationsGroup=notificationsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTableIndex=userTableIndex, linkSymmetry=linkSymmetry, dataPortStatusTrap=dataPortStatusTrap, antennaGain=antennaGain, tFTPServerPortNumber=tFTPServerPortNumber, telnetPortNumber=telnetPortNumber, encryption=encryption, sMTPEnabledMessages=sMTPEnabledMessages, signalStrengthRatio=signalStrengthRatio, aAAControlGroup=aAAControlGroup, timeZone=timeZone, syslogClientTrap=syslogClientTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTable=dfsTable, userTable=userTable, transmitFreqKHz=transmitFreqKHz, versionsGroup=versionsGroup, linkName=linkName, channelBandwidth=channelBandwidth, vLANManagementVID=vLANManagementVID, channelChangeTrap=channelChangeTrap, targetMACAddress=targetMACAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ethernet=ethernet, frequencyVariant=frequencyVariant, daylightSaving=daylightSaving, dfsTableEntry=dfsTableEntry, ptpTraps=ptpTraps, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptp500=ptp500, gatewayIPAddress=gatewayIPAddress, vLANPriorityTable=vLANPriorityTable)
