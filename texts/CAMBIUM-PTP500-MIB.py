...
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, iso, Bits, Gauge32, MibIdentifier, Counter32, Counter64, ModuleIdentity, NotificationType, IpAddress, TimeTicks, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "iso", "Bits", "Gauge32", "MibIdentifier", "Counter32", "Counter64", "ModuleIdentity", "NotificationType", "IpAddress", "TimeTicks", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogState=syslogState, vLANPriorityTable=vLANPriorityTable, syslogControl=syslogControl, accessMethod=accessMethod, tDDControlGroup=tDDControlGroup, ptmp=ptmp, dataPortDisabledWarning=dataPortDisabledWarning, snmpControlGroup=snmpControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, remoteIPAddress=remoteIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionGroup=encryptionGroup, aggregateDataRate=aggregateDataRate, groupID=groupID, userName=userName, daylightSaving=daylightSaving, productName=productName, sNMPCommunityString=sNMPCommunityString, userTableNumber=userTableNumber, sntp=sntp, receivePower=receivePower, cableLoss=cableLoss, smtp=smtp, siteName=siteName, linkModeOptimisation=linkModeOptimisation, receiveChannel=receiveChannel, range=range, iPAddress=iPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveDataRate=receiveDataRate, regionCode=regionCode, wirelessLinkAvailability=wirelessLinkAvailability, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, licenceGroup=licenceGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogClientTrap=syslogClientTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, vLANPriorityTableIndex=vLANPriorityTableIndex, configuration=configuration, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, antennaGain=antennaGain, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkName=linkName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, frequencyVariant=frequencyVariant, receiveModulationMode=receiveModulationMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, management=management, telecomsCableLength=telecomsCableLength, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsGroup=dfsGroup, altitude=altitude, subnetMask=subnetMask, transmitFreqKHz=transmitFreqKHz, tFTPServerIPAddress=tFTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsLoopback=telecomsLoopback, pubStatsGroup=pubStatsGroup, dfsMeans=dfsMeans, receiveFreqKHz=receiveFreqKHz, signalStrengthRatio=signalStrengthRatio, systemReset=systemReset, phyControlGroup=phyControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitPower=transmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsPeaks=dfsPeaks, sNTPServerIPAddress=sNTPServerIPAddress, sNTPLastSync=sNTPLastSync, sNTPPollInterval=sNTPPollInterval, smtpGroup=smtpGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, installStatusTrap=installStatusTrap, licensedCapacity=licensedCapacity, tFTPServerPortNumber=tFTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, timeZone=timeZone, dataPortStatus=dataPortStatus, versions=versions, alarms=alarms, sNMPTrapTable=sNMPTrapTable, vLANManagementVID=vLANManagementVID, sMTPEnabledMessages=sMTPEnabledMessages, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTraps=ptpTraps, ptp=ptp, cambium=cambium, vLANPriorityTableEntry=vLANPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, installArmState=installArmState, tDDControl=tDDControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, gatewayIPAddress=gatewayIPAddress, linkLoss=linkLoss, hardwareVersion=hardwareVersion, bootVersion=bootVersion, supplementary=supplementary, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableEntry=userTableEntry, byteErrorRatio=byteErrorRatio, sMTPEmailAlert=sMTPEmailAlert, eIRP=eIRP, notificationsGroup=notificationsGroup, licence=licence, hTTPAccessEnabled=hTTPAccessEnabled, telecomsChannelStatus=telecomsChannelStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, channelBandwidth=channelBandwidth, transmitChannel=transmitChannel, capacityLicenseMismatch=capacityLicenseMismatch, encryption=encryption, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, searchState=searchState, dfsTableEntry=dfsTableEntry, telecomsInterface=telecomsInterface, regionCodeTrap=regionCodeTrap, userEnabled=userEnabled, transmitModulationMode=transmitModulationMode, dfs=dfs, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkSymmetry=linkSymmetry, pubStats=pubStats, alarmsGroup=alarmsGroup, syslogStateTrap=syslogStateTrap, ptp500=ptp500, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aAAControlGroup=aAAControlGroup, longitude=longitude, ethernet=ethernet, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPState=sNTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, sNMPPortNumber=sNMPPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, productVariant=productVariant, userTableIndex=userTableIndex, sNMPTrapVersion=sNMPTrapVersion, ptpCompliance=ptpCompliance, supplementaryGroup=supplementaryGroup, phyControl=phyControl, encryptionAlgorithm=encryptionAlgorithm, sNTPSyncTrap=sNTPSyncTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, latitude=latitude, dfsTableNumber=dfsTableNumber, bandwidthVariant=bandwidthVariant, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vectorError=vectorError, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userRole=userRole, userPassword=userPassword, aAAControl=aAAControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, transmitFreqMHz=transmitFreqMHz, userTable=userTable, sNTPSync=sNTPSync, dfsTableIndex=dfsTableIndex, dataPortAutoMdix=dataPortAutoMdix, ptpTrapPrefix=ptpTrapPrefix, sntpGroup=sntpGroup, masterSlaveMode=masterSlaveMode, tDDSynchronizationMode=tDDSynchronizationMode, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telnetPortNumber=telnetPortNumber, resetGroup=resetGroup, sNMPv3Enable=sNMPv3Enable, versionsGroup=versionsGroup, reset=reset, configurationGroup=configurationGroup, ethernetFiberSupport=ethernetFiberSupport, telecomGroup=telecomGroup, softwareVersion=softwareVersion, ethernetGroup=ethernetGroup, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, incompatibleRegionCodes=incompatibleRegionCodes, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyStatus=phyStatus, managementGroup=managementGroup, installStatus=installStatus, syslogControlGroup=syslogControlGroup, PYSNMP_MODULE_ID=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, targetMACAddress=targetMACAddress, receiveFreqMHz=receiveFreqMHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installArmStateTrap=installArmStateTrap, hTTPPortNumber=hTTPPortNumber, telecomsLineCode=telecomsLineCode, syslogClient=syslogClient, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelChangeTrap=channelChangeTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, telecom=telecom)
