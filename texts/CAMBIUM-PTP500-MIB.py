...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapTable=sNMPTrapTable, wirelessLinkAvailability=wirelessLinkAvailability, dfsTable=dfsTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, userEnabled=userEnabled, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, transmitModulationMode=transmitModulationMode, ptpTrapPrefix=ptpTrapPrefix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarms=alarms, syslogState=syslogState, configuration=configuration, ptpGroups=ptpGroups, vLANManagementPriority=vLANManagementPriority, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityTable=vLANPriorityTable, smtp=smtp, supplementary=supplementary, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, dfs=dfs, sNMPTrapIPAddress=sNMPTrapIPAddress, reset=reset, searchState=searchState, dataPortAutoMdix=dataPortAutoMdix, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTableNumber=userTableNumber, dfsPeaks=dfsPeaks, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, eIRP=eIRP, dataPortStatus=dataPortStatus, PYSNMP_MODULE_ID=cambium, dfsTableIndex=dfsTableIndex, userTable=userTable, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, wirelessLinkStatus=wirelessLinkStatus, telecomGroup=telecomGroup, aggregateDataRate=aggregateDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANPriorityTableIndex=vLANPriorityTableIndex, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitFreqMHz=transmitFreqMHz, syslogStateTrap=syslogStateTrap, sNMPEnabledTraps=sNMPEnabledTraps, dfsTableEntry=dfsTableEntry, configurationGroup=configurationGroup, cambium=cambium, telecomsInterface=telecomsInterface, sNMPPortNumber=sNMPPortNumber, licensedCapacity=licensedCapacity, sntpGroup=sntpGroup, receiveFreqKHz=receiveFreqKHz, ptp500=ptp500, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userPassword=userPassword, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableIndex=userTableIndex, telnetPortNumber=telnetPortNumber, licence=licence, vLANPriorityQueueMapping=vLANPriorityQueueMapping, transmitChannel=transmitChannel, receiveChannel=receiveChannel, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productVariant=productVariant, cableLoss=cableLoss, transmitPower=transmitPower, dataPortAutoNegotiation=dataPortAutoNegotiation, systemReset=systemReset, phyControl=phyControl, managementGroup=managementGroup, installArmState=installArmState, regionCode=regionCode, sNTPLastSync=sNTPLastSync, vLANManagementVID=vLANManagementVID, telnetAccessEnabled=telnetAccessEnabled, tFTPServerPortNumber=tFTPServerPortNumber, licenceGroup=licenceGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, altitude=altitude, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, vectorError=vectorError, dfsMeans=dfsMeans, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetFiberSupport=ethernetFiberSupport, encryptionAlgorithm=encryptionAlgorithm, targetMACAddress=targetMACAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, productName=productName, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsLineCode=telecomsLineCode, linkName=linkName, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, systemClock=systemClock, tDDControlGroup=tDDControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, regionCodeTrap=regionCodeTrap, smtpGroup=smtpGroup, snmpControlGroup=snmpControlGroup, hTTPPortNumber=hTTPPortNumber, sNTPSync=sNTPSync, ethernetGroup=ethernetGroup, telecom=telecom, sNTPSyncTrap=sNTPSyncTrap, daylightSaving=daylightSaving, tFTPServerIPAddress=tFTPServerIPAddress, aAAControlGroup=aAAControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, secondarySoftwareVersion=secondarySoftwareVersion, subnetMask=subnetMask, frequencyVariant=frequencyVariant, antennaGain=antennaGain, transmitFreqKHz=transmitFreqKHz, receiveDataRate=receiveDataRate, longitude=longitude, tDDControl=tDDControl, alarmsGroup=alarmsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveModulationMode=receiveModulationMode, telecomsLoopback=telecomsLoopback, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, ptpCompliance=ptpCompliance, latitude=latitude, groupID=groupID, range=range, channelBandwidth=channelBandwidth, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogClient=syslogClient, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptp=ptp, pubStats=pubStats, ptpTraps=ptpTraps, linkSymmetry=linkSymmetry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPEmailAlert=sMTPEmailAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyStatus=phyStatus, unitOutOfCalibration=unitOutOfCalibration, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveFreqMHz=receiveFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, snmpControl=snmpControl, linkLoss=linkLoss, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, installStatus=installStatus, installStatusTrap=installStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, telecomsCableLength=telecomsCableLength, sNTPState=sNTPState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitDataRate=transmitDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, siteName=siteName, management=management, capacityLicenseMismatch=capacityLicenseMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hardwareVersion=hardwareVersion, encryption=encryption, notificationsGroup=notificationsGroup, remoteIPAddress=remoteIPAddress, supplementaryGroup=supplementaryGroup, userRole=userRole, iPAddress=iPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatio=byteErrorRatio, syslogControlGroup=syslogControlGroup, sntp=sntp, signalStrengthRatio=signalStrengthRatio, pubStatsGroup=pubStatsGroup, bootVersion=bootVersion, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, versions=versions, encryptionGroup=encryptionGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, linkModeOptimisation=linkModeOptimisation, gatewayIPAddress=gatewayIPAddress, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerPortNumber=sNTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, aAAControl=aAAControl, sNTPPollInterval=sNTPPollInterval, constantPowerSpectralDensity=constantPowerSpectralDensity, accessMethod=accessMethod, sNMPv3Enable=sNMPv3Enable, dfsGroup=dfsGroup, bandwidthVariant=bandwidthVariant, sNMPCommunityString=sNMPCommunityString, userName=userName, resetGroup=resetGroup, timeZone=timeZone, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableNumber=dfsTableNumber, userTableEntry=userTableEntry)
