...
# Produced by pysmi-1.1.3 at Sun Nov 28 17:04:00 2021
...
NotificationType, Bits, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, MibIdentifier, ObjectIdentity, iso, TimeTicks, Gauge32, ModuleIdentity, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "MibIdentifier", "ObjectIdentity", "iso", "TimeTicks", "Gauge32", "ModuleIdentity", "enterprises", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsTable=dfsTable, sNMPEnabledTraps=sNMPEnabledTraps, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerIPAddress=tFTPServerIPAddress, tDDControl=tDDControl, ptp=ptp, receivePower=receivePower, antennaGain=antennaGain, sNTPServerIPAddress=sNTPServerIPAddress, ptmp=ptmp, vLANManagementPriority=vLANManagementPriority, subnetMask=subnetMask, installArmState=installArmState, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, userTable=userTable, softwareVersion=softwareVersion, dfsGroup=dfsGroup, transmitDataRate=transmitDataRate, regionCodeTrap=regionCodeTrap, dataPortStatusTrap=dataPortStatusTrap, licenceGroup=licenceGroup, encryptionGroup=encryptionGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPSPortNumber=hTTPSPortNumber, licence=licence, systemClock=systemClock, daylightSaving=daylightSaving, receiveChannel=receiveChannel, notificationsGroup=notificationsGroup, sNMPTrapTable=sNMPTrapTable, telecomsLoopbackTrap=telecomsLoopbackTrap, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTableNumber=dfsTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, enabledDiagnosticAlarms=enabledDiagnosticAlarms, byteErrorRatio=byteErrorRatio, dfsTableIndex=dfsTableIndex, ethernetGroup=ethernetGroup, phyStatus=phyStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, versions=versions, installStatusTrap=installStatusTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortAutoMdix=dataPortAutoMdix, accessMethod=accessMethod, alarmsGroup=alarmsGroup, snmpControl=snmpControl, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, latitude=latitude, reset=reset, ethernet=ethernet, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, syslogControlGroup=syslogControlGroup, dataPortStatus=dataPortStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkSymmetry=linkSymmetry, incompatibleRegionCodes=incompatibleRegionCodes, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANPriorityTable=vLANPriorityTable, productName=productName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, PYSNMP_MODULE_ID=cambium, installStatus=installStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableIndex=userTableIndex, sNMPPortNumber=sNMPPortNumber, transmitModulationMode=transmitModulationMode, remoteIPAddress=remoteIPAddress, supplementary=supplementary, hTTPAccessEnabled=hTTPAccessEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maximumTransmitPower=maximumTransmitPower, iPAddress=iPAddress, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTableEntry=dfsTableEntry, aAAControlGroup=aAAControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkStatus=wirelessLinkStatus, dfsMeans=dfsMeans, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlGroup=phyControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveDataRate=receiveDataRate, productVariant=productVariant, userEnabled=userEnabled, vLANManagementVID=vLANManagementVID, ptpTraps=ptpTraps, wirelessLinkAvailability=wirelessLinkAvailability, telecomGroup=telecomGroup, encryption=encryption, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, alarms=alarms, tFTPServerPortNumber=tFTPServerPortNumber, ptpCompliance=ptpCompliance, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptp500=ptp500, sMTPServerPortNumber=sMTPServerPortNumber, sntpGroup=sntpGroup, transmitPower=transmitPower, constantPowerSpectralDensity=constantPowerSpectralDensity, systemReset=systemReset, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationMode=tDDSynchronizationMode, configurationGroup=configurationGroup, resetGroup=resetGroup, installArmStateTrap=installArmStateTrap, aAAControl=aAAControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveFreqKHz=receiveFreqKHz, masterSlaveMode=masterSlaveMode, smtpGroup=smtpGroup, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelStatus=telecomsChannelStatus, targetMACAddress=targetMACAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, searchState=searchState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPLastSync=sNTPLastSync, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, capacityLicenseMismatch=capacityLicenseMismatch, ptpTrapPrefix=ptpTrapPrefix, channelChangeTrap=channelChangeTrap, syslogControl=syslogControl, telecom=telecom, pubStatsGroup=pubStatsGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, phyControl=phyControl, userName=userName, gatewayIPAddress=gatewayIPAddress, linkLoss=linkLoss, vectorError=vectorError, telecomsLoopback=telecomsLoopback, longitude=longitude, telecomsCableLength=telecomsCableLength, configuration=configuration, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hardwareVersion=hardwareVersion, userPassword=userPassword, bootVersion=bootVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, signalStrengthRatio=signalStrengthRatio, groupID=groupID, syslogClient=syslogClient, eIRP=eIRP, transmitChannel=transmitChannel, telecomsLineCode=telecomsLineCode, phyStatusGroup=phyStatusGroup, tDDControlGroup=tDDControlGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPEmailAlert=sMTPEmailAlert, sMTPEnabledMessages=sMTPEnabledMessages, sntp=sntp, cambium=cambium, sNTPServerPortNumber=sNTPServerPortNumber, sNTPState=sNTPState, cableLoss=cableLoss, regionCode=regionCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfs=dfs, userTableNumber=userTableNumber, pubStats=pubStats, siteName=siteName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsPeaks=dfsPeaks, sNMPCommunityString=sNMPCommunityString, syslogState=syslogState, hTTPPortNumber=hTTPPortNumber, range=range, tDDSynchronizationStatus=tDDSynchronizationStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, managementGroup=managementGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpGroups=ptpGroups, linkName=linkName, licensedCapacity=licensedCapacity, altitude=altitude, syslogStateTrap=syslogStateTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqMHz=receiveFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, timeZone=timeZone, snmpControlGroup=snmpControlGroup, sNTPPollInterval=sNTPPollInterval, sNTPSync=sNTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortDisabledWarning=dataPortDisabledWarning, telnetPortNumber=telnetPortNumber, syslogClientTrap=syslogClientTrap, supplementaryGroup=supplementaryGroup, encryptionAlgorithm=encryptionAlgorithm, userRole=userRole, vLANPriorityQueueMapping=vLANPriorityQueueMapping, linkModeOptimisation=linkModeOptimisation, vLANPriorityTableEntry=vLANPriorityTableEntry, telnetAccessEnabled=telnetAccessEnabled, sNMPv3Enable=sNMPv3Enable, userTableEntry=userTableEntry, ethernetFiberSupport=ethernetFiberSupport, telecomsInterface=telecomsInterface)
