...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:12:10 2022
...
Bits, iso, Counter64, MibIdentifier, Integer32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Unsigned32, enterprises, ModuleIdentity, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "iso", "Counter64", "MibIdentifier", "Integer32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Unsigned32", "enterprises", "ModuleIdentity", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPSyncTrap=sNTPSyncTrap, channelBandwidth=channelBandwidth, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, antennaGain=antennaGain, syslogClientTrap=syslogClientTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortStatus=dataPortStatus, bandwidthVariant=bandwidthVariant, linkSymmetry=linkSymmetry, userTable=userTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telnetAccessEnabled=telnetAccessEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, management=management, telnetPortNumber=telnetPortNumber, byteErrorRatio=byteErrorRatio, iPAddress=iPAddress, range=range, userTableIndex=userTableIndex, syslogState=syslogState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveChannel=receiveChannel, productVariant=productVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, installStatus=installStatus, signalStrengthRatio=signalStrengthRatio, hTTPPortNumber=hTTPPortNumber, dfsTable=dfsTable, sNMPPortNumber=sNMPPortNumber, tDDControl=tDDControl, remoteIPAddress=remoteIPAddress, frequencyVariant=frequencyVariant, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsTableEntry=dfsTableEntry, ptp500=ptp500, dfsTableIndex=dfsTableIndex, telecomsLoopback=telecomsLoopback, sNMPv3Enable=sNMPv3Enable, transmitFreqMHz=transmitFreqMHz, syslogControlGroup=syslogControlGroup, licenceGroup=licenceGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, userPassword=userPassword, softwareVersion=softwareVersion, aAAControlGroup=aAAControlGroup, telecomsInterface=telecomsInterface, configurationGroup=configurationGroup, resetGroup=resetGroup, gatewayIPAddress=gatewayIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, cableLoss=cableLoss, smtpGroup=smtpGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, configuration=configuration, productName=productName, supplementary=supplementary, capacityLicenseMismatch=capacityLicenseMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, cambium=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfs=dfs, phyControlGroup=phyControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPServerIPAddress=sMTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, sNTPState=sNTPState, telecomsLineCode=telecomsLineCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimisation=linkModeOptimisation, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogStateTrap=syslogStateTrap, sNTPServerPortNumber=sNTPServerPortNumber, timeZone=timeZone, installArmStateTrap=installArmStateTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortStatusTrap=dataPortStatusTrap, subnetMask=subnetMask, siteName=siteName, alarmsGroup=alarmsGroup, receiveFreqKHz=receiveFreqKHz, userEnabled=userEnabled, hardwareVersion=hardwareVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, longitude=longitude, maximumTransmitPower=maximumTransmitPower, userTableNumber=userTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomGroup=telecomGroup, alarms=alarms, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsCableLength=telecomsCableLength, sNTPSync=sNTPSync, regionCodeTrap=regionCodeTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryptionAlgorithm=encryptionAlgorithm, supplementaryGroup=supplementaryGroup, ethernetFiberSupport=ethernetFiberSupport, phyControl=phyControl, receiveFreqMHz=receiveFreqMHz, linkLoss=linkLoss, vLANManagementVID=vLANManagementVID, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANManagementPriority=vLANManagementPriority, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, ptmp=ptmp, accessMethod=accessMethod, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, versions=versions, ethernetGroup=ethernetGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsPeaks=dfsPeaks, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPLastSync=sNTPLastSync, syslogClient=syslogClient, smtp=smtp, aggregateDataRate=aggregateDataRate, sMTPEmailAlert=sMTPEmailAlert, transmitFreqKHz=transmitFreqKHz, linkName=linkName, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitDataRate=transmitDataRate, incompatibleRegionCodes=incompatibleRegionCodes, snmpControl=snmpControl, versionsGroup=versionsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPPollInterval=sNTPPollInterval, sntp=sntp, phyStatus=phyStatus, syslogControl=syslogControl, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyStatusGroup=phyStatusGroup, PYSNMP_MODULE_ID=cambium, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, aAAControl=aAAControl, telecomsChannelStatus=telecomsChannelStatus, ptp=ptp, searchState=searchState, receiveDataRate=receiveDataRate, dfsTableNumber=dfsTableNumber, ethernet=ethernet, notificationsGroup=notificationsGroup, wirelessLinkStatus=wirelessLinkStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installStatusTrap=installStatusTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, bootVersion=bootVersion, licence=licence, vLANPriorityTableEntry=vLANPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANPriorityTable=vLANPriorityTable, unitOutOfCalibration=unitOutOfCalibration, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, encryption=encryption, tDDSynchronizationMode=tDDSynchronizationMode, managementGroup=managementGroup, dfsMeans=dfsMeans, userName=userName, systemClock=systemClock, sntpGroup=sntpGroup, userRole=userRole, sNMPTrapTable=sNMPTrapTable, vectorError=vectorError, ptpGroups=ptpGroups, ptpTraps=ptpTraps, channelChangeTrap=channelChangeTrap, receivePower=receivePower, latitude=latitude, reset=reset, ptpCompliance=ptpCompliance, licensedCapacity=licensedCapacity, telecom=telecom, dfsGroup=dfsGroup, dataPortAutoMdix=dataPortAutoMdix, receiveModulationMode=receiveModulationMode, groupID=groupID, pubStats=pubStats, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, encryptionGroup=encryptionGroup, tFTPServerIPAddress=tFTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, daylightSaving=daylightSaving, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, regionCode=regionCode, transmitPower=transmitPower, snmpControlGroup=snmpControlGroup, installArmState=installArmState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkAvailability=wirelessLinkAvailability, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerPortNumber=sMTPServerPortNumber, eIRP=eIRP, altitude=altitude, targetMACAddress=targetMACAddress, transmitModulationMode=transmitModulationMode, transmitChannel=transmitChannel, sNMPTrapVersion=sNMPTrapVersion, ptpTrapPrefix=ptpTrapPrefix, hTTPAccessEnabled=hTTPAccessEnabled, tDDControlGroup=tDDControlGroup, userTableEntry=userTableEntry, pubStatsGroup=pubStatsGroup, tFTPServerPortNumber=tFTPServerPortNumber, systemReset=systemReset, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityString=sNMPCommunityString, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, masterSlaveMode=masterSlaveMode)
