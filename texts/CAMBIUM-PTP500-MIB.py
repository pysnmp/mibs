...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkLoss=linkLoss, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, bandwidthVariant=bandwidthVariant, telecomsLoopbackTrap=telecomsLoopbackTrap, accessMethod=accessMethod, daylightSaving=daylightSaving, reset=reset, linkName=linkName, phyStatusGroup=phyStatusGroup, latitude=latitude, ethernetGroup=ethernetGroup, telecomsCableLength=telecomsCableLength, managementGroup=managementGroup, versionsGroup=versionsGroup, syslogClient=syslogClient, syslogStateTrap=syslogStateTrap, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsInterface=telecomsInterface, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bootVersion=bootVersion, tDDControlGroup=tDDControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPState=sNTPState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, byteErrorRatio=byteErrorRatio, sNTPLastSync=sNTPLastSync, encryptionAlgorithm=encryptionAlgorithm, snmpControl=snmpControl, vLANManagementVID=vLANManagementVID, userTable=userTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, supplementary=supplementary, incompatibleRegionCodes=incompatibleRegionCodes, smtp=smtp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, versions=versions, smtpGroup=smtpGroup, tDDControl=tDDControl, productName=productName, receiveModulationModeDetail=receiveModulationModeDetail, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp500=ptp500, syslogControl=syslogControl, transmitDataRate=transmitDataRate, userTableNumber=userTableNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, groupID=groupID, alarms=alarms, phyControl=phyControl, sNMPPortNumber=sNMPPortNumber, dfsTableEntry=dfsTableEntry, configuration=configuration, ethernetFiberSupport=ethernetFiberSupport, userName=userName, syslogState=syslogState, hTTPPortNumber=hTTPPortNumber, sntp=sntp, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, channelChangeTrap=channelChangeTrap, receiveDataRate=receiveDataRate, dfs=dfs, aAAControl=aAAControl, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, notificationsGroup=notificationsGroup, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANPriorityTable=vLANPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPServerPortNumber=sNTPServerPortNumber, channelBandwidth=channelBandwidth, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableIndex=dfsTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkSymmetry=linkSymmetry, syslogClientTrap=syslogClientTrap, hardwareVersion=hardwareVersion, cambium=cambium, receiveFreqMHz=receiveFreqMHz, masterSlaveMode=masterSlaveMode, dfsMeans=dfsMeans, sMTPEnabledMessages=sMTPEnabledMessages, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatus=phyStatus, remoteIPAddress=remoteIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, encryptionGroup=encryptionGroup, tFTPServerPortNumber=tFTPServerPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPPollInterval=sNTPPollInterval, hTTPSAccessEnabled=hTTPSAccessEnabled, PYSNMP_MODULE_ID=cambium, aAAControlGroup=aAAControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, antennaGain=antennaGain, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptmp=ptmp, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, systemReset=systemReset, longitude=longitude, regionCode=regionCode, ptpTraps=ptpTraps, systemClock=systemClock, transmitChannel=transmitChannel, telecomGroup=telecomGroup, sNMPTrapTable=sNMPTrapTable, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, telecomsLoopback=telecomsLoopback, transmitModulationMode=transmitModulationMode, aggregateDataRate=aggregateDataRate, installArmState=installArmState, userRole=userRole, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licence=licence, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableLoss=cableLoss, syslogLocalWrappedTrap=syslogLocalWrappedTrap, timeZone=timeZone, snmpControlGroup=snmpControlGroup, sNMPv3Enable=sNMPv3Enable, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userEnabled=userEnabled, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, installStatusTrap=installStatusTrap, ptp=ptp, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, encryption=encryption, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibration=unitOutOfCalibration, transmitFreqMHz=transmitFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, targetMACAddress=targetMACAddress, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installArmStateTrap=installArmStateTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, softwareVersion=softwareVersion, syslogControlGroup=syslogControlGroup, iPAddress=iPAddress, installStatus=installStatus, siteName=siteName, transmitPower=transmitPower, productVariant=productVariant, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfsPeaks=dfsPeaks, maximumTransmitPower=maximumTransmitPower, wirelessLinkAvailability=wirelessLinkAvailability, receiveChannel=receiveChannel, telecomsChannelStatus=telecomsChannelStatus, licenceGroup=licenceGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, frequencyVariant=frequencyVariant, receivePower=receivePower, dfsGroup=dfsGroup, vectorError=vectorError, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernet=ethernet, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, searchState=searchState, userTableEntry=userTableEntry, sNMPCommunityString=sNMPCommunityString, sNTPSyncTrap=sNTPSyncTrap, configurationGroup=configurationGroup, tDDSynchronizationMode=tDDSynchronizationMode, ptpTrapPrefix=ptpTrapPrefix, sNTPSync=sNTPSync, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityTableNumber=vLANPriorityTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userPassword=userPassword, telecomsLineCode=telecomsLineCode, dfsTableNumber=dfsTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableIndex=userTableIndex, supplementaryGroup=supplementaryGroup, eIRP=eIRP, altitude=altitude, phyControlGroup=phyControlGroup, pubStats=pubStats, linkModeOptimisation=linkModeOptimisation, receiveFreqKHz=receiveFreqKHz, sntpGroup=sntpGroup, capacityLicenseMismatch=capacityLicenseMismatch, telnetPortNumber=telnetPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveModulationMode=receiveModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpGroups=ptpGroups, constantPowerSpectralDensity=constantPowerSpectralDensity, management=management, resetGroup=resetGroup, range=range, telecom=telecom, transmitFreqKHz=transmitFreqKHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
