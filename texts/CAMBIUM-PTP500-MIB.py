...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPEnabledTraps=sNMPEnabledTraps, byteErrorRatio=byteErrorRatio, syslogClientTrap=syslogClientTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp500=ptp500, receivePower=receivePower, daylightSaving=daylightSaving, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPPortNumber=hTTPPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, capacityLicenseMismatch=capacityLicenseMismatch, phyStatusGroup=phyStatusGroup, notificationsGroup=notificationsGroup, tFTPServerPortNumber=tFTPServerPortNumber, aAAControlGroup=aAAControlGroup, supplementaryGroup=supplementaryGroup, dataPortDisabledWarning=dataPortDisabledWarning, licence=licence, transmitFreqMHz=transmitFreqMHz, dfsGroup=dfsGroup, telecomGroup=telecomGroup, installStatus=installStatus, sNMPTrapTable=sNMPTrapTable, vectorError=vectorError, installArmStateTrap=installArmStateTrap, telecomsInterface=telecomsInterface, dataPortAutoMdix=dataPortAutoMdix, searchState=searchState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userTableEntry=userTableEntry, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsMeans=dfsMeans, vLANManagementPriority=vLANManagementPriority, groupID=groupID, hTTPAccessEnabled=hTTPAccessEnabled, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, userEnabled=userEnabled, transmitChannel=transmitChannel, tDDControl=tDDControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkLoss=linkLoss, sMTPEnabledMessages=sMTPEnabledMessages, ethernetFiberSupport=ethernetFiberSupport, regionCodeTrap=regionCodeTrap, encryptionAlgorithm=encryptionAlgorithm, unitOutOfCalibration=unitOutOfCalibration, dfsTableIndex=dfsTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTraps=ptpTraps, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, installStatusTrap=installStatusTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, pubStats=pubStats, alarms=alarms, sNTPSync=sNTPSync, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsChannelStatus=telecomsChannelStatus, sMTPEmailAlert=sMTPEmailAlert, altitude=altitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licensedCapacity=licensedCapacity, telnetPortNumber=telnetPortNumber, ptpCompliance=ptpCompliance, phyControlGroup=phyControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, aggregateDataRate=aggregateDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogClient=syslogClient, dfsTableNumber=dfsTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsCableLength=telecomsCableLength, hardwareVersion=hardwareVersion, smtp=smtp, configurationGroup=configurationGroup, ptpGroups=ptpGroups, dataPortStatusTrap=dataPortStatusTrap, linkName=linkName, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernet=ethernet, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveFreqKHz=receiveFreqKHz, userName=userName, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationMode=receiveModulationMode, aAAControl=aAAControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, channelChangeTrap=channelChangeTrap, bandwidthVariant=bandwidthVariant, remoteIPAddress=remoteIPAddress, pubStatsGroup=pubStatsGroup, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, encryption=encryption, productName=productName, vLANManagementVID=vLANManagementVID, dfsTableEntry=dfsTableEntry, hTTPSPortNumber=hTTPSPortNumber, sNTPSyncTrap=sNTPSyncTrap, sNTPLastSync=sNTPLastSync, linkSymmetry=linkSymmetry, productVariant=productVariant, receiveModulationModeDetail=receiveModulationModeDetail, configuration=configuration, phyStatus=phyStatus, iPAddress=iPAddress, syslogControlGroup=syslogControlGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkModeOptimisation=linkModeOptimisation, phyControl=phyControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityQueueMapping=vLANPriorityQueueMapping, gatewayIPAddress=gatewayIPAddress, management=management, userTable=userTable, transmitPower=transmitPower, userTableNumber=userTableNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, versionsGroup=versionsGroup, telecomsLoopback=telecomsLoopback, dfsTable=dfsTable, dataPortStatus=dataPortStatus, tFTPServerIPAddress=tFTPServerIPAddress, installArmState=installArmState, ptmp=ptmp, versions=versions, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, masterSlaveMode=masterSlaveMode, wirelessLinkStatus=wirelessLinkStatus, userTableIndex=userTableIndex, syslogState=syslogState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sntpGroup=sntpGroup, receiveChannel=receiveChannel, dfs=dfs, sNMPTrapTableIndex=sNMPTrapTableIndex, userRole=userRole, resetGroup=resetGroup, sNTPServerPortNumber=sNTPServerPortNumber, licenceGroup=licenceGroup, channelBandwidth=channelBandwidth, sNMPTrapVersion=sNMPTrapVersion, telnetAccessEnabled=telnetAccessEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqKHz=transmitFreqKHz, systemClock=systemClock, alarmsGroup=alarmsGroup, signalStrengthRatio=signalStrengthRatio, syslogStateTrap=syslogStateTrap, bootVersion=bootVersion, longitude=longitude, timeZone=timeZone, systemReset=systemReset, sNMPTrapTableEntry=sNMPTrapTableEntry, managementGroup=managementGroup, cableLoss=cableLoss, secondarySoftwareVersion=secondarySoftwareVersion, sntp=sntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, subnetMask=subnetMask, supplementary=supplementary, dataPortConfigurationMismatch=dataPortConfigurationMismatch, maximumTransmitPower=maximumTransmitPower, telecom=telecom, transmitDataRate=transmitDataRate, cambium=cambium, tDDControlGroup=tDDControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, range=range, sNMPCommunityString=sNMPCommunityString, siteName=siteName, latitude=latitude, frequencyVariant=frequencyVariant, smtpGroup=smtpGroup, dfsPeaks=dfsPeaks, sMTPServerIPAddress=sMTPServerIPAddress, syslogControl=syslogControl, vLANPriorityTable=vLANPriorityTable, transmitModulationMode=transmitModulationMode, softwareVersion=softwareVersion, antennaGain=antennaGain, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPv3Enable=sNMPv3Enable, sNMPPortNumber=sNMPPortNumber, regionCode=regionCode, sNTPServerIPAddress=sNTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, encryptionGroup=encryptionGroup, telecomsLineCode=telecomsLineCode, receiveFreqMHz=receiveFreqMHz, sNTPState=sNTPState, ptp=ptp, remoteMaximumTransmitPower=remoteMaximumTransmitPower, snmpControl=snmpControl, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, reset=reset, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveDataRate=receiveDataRate, tDDSynchronizationMode=tDDSynchronizationMode, ethernetGroup=ethernetGroup, targetMACAddress=targetMACAddress, PYSNMP_MODULE_ID=cambium, eIRP=eIRP, userPassword=userPassword)
