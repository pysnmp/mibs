...
# Produced by pysmi-1.1.8 at Fri Jan  7 15:55:17 2022
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sntp=sntp, phyStatusGroup=phyStatusGroup, longitude=longitude, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsInterface=telecomsInterface, licence=licence, syslogClient=syslogClient, versionsGroup=versionsGroup, receivePower=receivePower, userRole=userRole, ptpGroups=ptpGroups, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecom=telecom, channelChangeTrap=channelChangeTrap, gatewayIPAddress=gatewayIPAddress, ethernetGroup=ethernetGroup, ptpCompliance=ptpCompliance, ptp=ptp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSyncTrap=sNTPSyncTrap, receiveDataRate=receiveDataRate, sMTPServerPortNumber=sMTPServerPortNumber, sNTPState=sNTPState, phyControlGroup=phyControlGroup, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, snmpControlGroup=snmpControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, phyControl=phyControl, phyStatus=phyStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, systemReset=systemReset, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitChannel=transmitChannel, syslogStateTrap=syslogStateTrap, ethernetFiberSupport=ethernetFiberSupport, remoteIPAddress=remoteIPAddress, notificationsGroup=notificationsGroup, masterSlaveMode=masterSlaveMode, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsPeaks=dfsPeaks, hTTPSPortNumber=hTTPSPortNumber, transmitModulationMode=transmitModulationMode, userEnabled=userEnabled, aAAControl=aAAControl, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveFreqMHz=receiveFreqMHz, groupID=groupID, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, reset=reset, accessMethod=accessMethod, dfsGroup=dfsGroup, linkName=linkName, iPAddress=iPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableNumber=userTableNumber, syslogControlGroup=syslogControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, byteErrorRatio=byteErrorRatio, versions=versions, tDDControlGroup=tDDControlGroup, sNMPv3Enable=sNMPv3Enable, antennaGain=antennaGain, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPPortNumber=hTTPPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, licensedCapacity=licensedCapacity, telecomsLineCode=telecomsLineCode, licenceGroup=licenceGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimisation=linkModeOptimisation, transmitDataRate=transmitDataRate, tDDControl=tDDControl, tFTPServerPortNumber=tFTPServerPortNumber, sNTPLastSync=sNTPLastSync, frequencyVariant=frequencyVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, systemClock=systemClock, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, smtpGroup=smtpGroup, hardwareVersion=hardwareVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aggregateDataRate=aggregateDataRate, userPassword=userPassword, latitude=latitude, bandwidthVariant=bandwidthVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptmp=ptmp, syslogLocalWrappedTrap=syslogLocalWrappedTrap, eIRP=eIRP, sMTPSourceEmailAddress=sMTPSourceEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus, channelBandwidth=channelBandwidth, searchState=searchState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogState=syslogState, vectorError=vectorError, incompatibleRegionCodes=incompatibleRegionCodes, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkSymmetry=linkSymmetry, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, receiveModulationMode=receiveModulationMode, telecomsCableLength=telecomsCableLength, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortAutoMdix=dataPortAutoMdix, smtp=smtp, management=management, sMTPServerIPAddress=sMTPServerIPAddress, supplementary=supplementary, vLANManagementVID=vLANManagementVID, transmitPower=transmitPower, transmitFreqMHz=transmitFreqMHz, sMTPEmailAlert=sMTPEmailAlert, signalStrengthRatio=signalStrengthRatio, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, installArmState=installArmState, installStatus=installStatus, cambium=cambium, daylightSaving=daylightSaving, productName=productName, syslogControl=syslogControl, bootVersion=bootVersion, secondarySoftwareVersion=secondarySoftwareVersion, telecomsChannelStatus=telecomsChannelStatus, syslogClientTrap=syslogClientTrap, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTraps=ptpTraps, alarms=alarms, transmitFreqKHz=transmitFreqKHz, ptp500=ptp500, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, managementGroup=managementGroup, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsLoopback=telecomsLoopback, userName=userName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableNumber=dfsTableNumber, dfs=dfs, vLANManagementPriority=vLANManagementPriority, productVariant=productVariant, unitOutOfCalibration=unitOutOfCalibration, enabledDiagnosticAlarms=enabledDiagnosticAlarms, configuration=configuration, vLANPriorityTableIndex=vLANPriorityTableIndex, telnetPortNumber=telnetPortNumber, installStatusTrap=installStatusTrap, aAAControlGroup=aAAControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, vLANPriorityTableNumber=vLANPriorityTableNumber, softwareVersion=softwareVersion, altitude=altitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControl=snmpControl, userTableEntry=userTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, userTable=userTable, regionCode=regionCode, userTableIndex=userTableIndex, sNTPSync=sNTPSync, sNMPCommunityString=sNMPCommunityString, receiveFreqKHz=receiveFreqKHz, dfsTableEntry=dfsTableEntry, resetGroup=resetGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sntpGroup=sntpGroup, dfsTable=dfsTable, pubStats=pubStats, dfsMeans=dfsMeans, sNMPTrapVersion=sNMPTrapVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installArmStateTrap=installArmStateTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, subnetMask=subnetMask, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, maximumTransmitPower=maximumTransmitPower, cableLoss=cableLoss, ethernet=ethernet, vLANPriorityTable=vLANPriorityTable, ptpTrapPrefix=ptpTrapPrefix, receiveChannel=receiveChannel, encryption=encryption, dataPortStatus=dataPortStatus, dataPortStatusTrap=dataPortStatusTrap, pubStatsGroup=pubStatsGroup, sNTPPollInterval=sNTPPollInterval, wirelessLinkAvailability=wirelessLinkAvailability, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomGroup=telecomGroup, supplementaryGroup=supplementaryGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortConfigurationMismatch=dataPortConfigurationMismatch, targetMACAddress=targetMACAddress, timeZone=timeZone, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, range=range, telnetAccessEnabled=telnetAccessEnabled, capacityLicenseMismatch=capacityLicenseMismatch, dataPortDisabledWarning=dataPortDisabledWarning, constantPowerSpectralDensity=constantPowerSpectralDensity, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsTableIndex=dfsTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, encryptionGroup=encryptionGroup, alarmsGroup=alarmsGroup, siteName=siteName)
