...
ObjectIdentity, Unsigned32, TimeTicks, Counter64, NotificationType, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, MibIdentifier, IpAddress, Bits, iso, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "TimeTicks", "Counter64", "NotificationType", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "MibIdentifier", "IpAddress", "Bits", "iso", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPSPortNumber=hTTPSPortNumber, range=range, PYSNMP_MODULE_ID=cambium, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuration=configuration, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernet=ethernet, sNTPPollInterval=sNTPPollInterval, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPSyncTrap=sNTPSyncTrap, aggregateDataRate=aggregateDataRate, syslogState=syslogState, ptpTraps=ptpTraps, sntp=sntp, sNMPEnabledTraps=sNMPEnabledTraps, telecomGroup=telecomGroup, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPPortNumber=hTTPPortNumber, supplementaryGroup=supplementaryGroup, aAAControlGroup=aAAControlGroup, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, userPassword=userPassword, licensedCapacity=licensedCapacity, ptp500=ptp500, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, cableLoss=cableLoss, smtpGroup=smtpGroup, installStatusTrap=installStatusTrap, encryption=encryption, transmitPower=transmitPower, vLANManagementVID=vLANManagementVID, alarms=alarms, syslogControlGroup=syslogControlGroup, subnetMask=subnetMask, ptp=ptp, smtp=smtp, ptpGroups=ptpGroups, dfsPeaks=dfsPeaks, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsLineCode=telecomsLineCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installArmState=installArmState, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, telnetAccessEnabled=telnetAccessEnabled, syslogControl=syslogControl, telecomsCableLength=telecomsCableLength, telnetPortNumber=telnetPortNumber, transmitFreqMHz=transmitFreqMHz, versionsGroup=versionsGroup, channelChangeTrap=channelChangeTrap, signalStrengthRatio=signalStrengthRatio, receiveFreqKHz=receiveFreqKHz, dfsTableIndex=dfsTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, ptmp=ptmp, sNMPv3Enable=sNMPv3Enable, maximumTransmitPower=maximumTransmitPower, vLANPriorityTableEntry=vLANPriorityTableEntry, versions=versions, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableNumber=userTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, management=management, syslogClient=syslogClient, sMTPEmailAlert=sMTPEmailAlert, snmpControl=snmpControl, timeZone=timeZone, dfsTable=dfsTable, phyStatusGroup=phyStatusGroup, alarmsGroup=alarmsGroup, dataPortStatus=dataPortStatus, userTableIndex=userTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userRole=userRole, phyControl=phyControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitDataRate=transmitDataRate, transmitModulationMode=transmitModulationMode, receivePower=receivePower, notificationsGroup=notificationsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveChannel=receiveChannel, targetMACAddress=targetMACAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, searchState=searchState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sntpGroup=sntpGroup, productVariant=productVariant, frequencyVariant=frequencyVariant, resetGroup=resetGroup, dataPortStatusTrap=dataPortStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hardwareVersion=hardwareVersion, syslogClientTrap=syslogClientTrap, capacityLicenseMismatch=capacityLicenseMismatch, phyStatus=phyStatus, byteErrorRatio=byteErrorRatio, dfsTableNumber=dfsTableNumber, dataPortDisabledWarning=dataPortDisabledWarning, iPAddress=iPAddress, tDDControlGroup=tDDControlGroup, transmitChannel=transmitChannel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, cambium=cambium, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetFiberSupport=ethernetFiberSupport, userEnabled=userEnabled, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, reset=reset, installArmStateTrap=installArmStateTrap, longitude=longitude, phyControlGroup=phyControlGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, antennaGain=antennaGain, userTable=userTable, telecomsInterface=telecomsInterface, remoteIPAddress=remoteIPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, accessMethod=accessMethod, transmitFreqKHz=transmitFreqKHz, dfs=dfs, telecomsLoopbackTrap=telecomsLoopbackTrap, daylightSaving=daylightSaving, licence=licence, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, receiveDataRate=receiveDataRate, productName=productName, ptpCompliance=ptpCompliance, linkName=linkName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, sNMPPortNumber=sNMPPortNumber, vLANManagementPriority=vLANManagementPriority, incompatibleRegionCodes=incompatibleRegionCodes, supplementary=supplementary, vLANPriorityTableNumber=vLANPriorityTableNumber, linkModeOptimisation=linkModeOptimisation, bootVersion=bootVersion, pubStats=pubStats, bandwidthVariant=bandwidthVariant, receiveModulationModeDetail=receiveModulationModeDetail, receiveModulationMode=receiveModulationMode, regionCode=regionCode, telecomsChannelStatus=telecomsChannelStatus, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapVersion=sNMPTrapVersion, userName=userName, latitude=latitude, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, telecom=telecom, aAAControl=aAAControl, secondarySoftwareVersion=secondarySoftwareVersion, licenceGroup=licenceGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, eIRP=eIRP, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, siteName=siteName, telecomsLoopback=telecomsLoopback, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, channelBandwidth=channelBandwidth, syslogStateTrap=syslogStateTrap, altitude=altitude, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerPortNumber=sNTPServerPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernetGroup=ethernetGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDControl=tDDControl, installStatus=installStatus, groupID=groupID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryptionGroup=encryptionGroup, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqMHz=receiveFreqMHz, sNTPState=sNTPState, dfsGroup=dfsGroup, wirelessLinkAvailability=wirelessLinkAvailability, systemReset=systemReset, vLANPriorityTable=vLANPriorityTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, managementGroup=managementGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, configurationGroup=configurationGroup, sNTPSync=sNTPSync, vectorError=vectorError)
