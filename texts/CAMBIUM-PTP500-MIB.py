...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPSyncTrap=sNTPSyncTrap, subnetMask=subnetMask, configurationGroup=configurationGroup, dfsMeans=dfsMeans, licence=licence, syslogClientTrap=syslogClientTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionGroup=encryptionGroup, receiveDataRate=receiveDataRate, sMTPEmailAlert=sMTPEmailAlert, byteErrorRatio=byteErrorRatio, receiveModulationMode=receiveModulationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, ethernetFiberSupport=ethernetFiberSupport, sNTPState=sNTPState, configuration=configuration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, installArmStateTrap=installArmStateTrap, vLANManagementVID=vLANManagementVID, userTable=userTable, resetGroup=resetGroup, alarmsGroup=alarmsGroup, userPassword=userPassword, hTTPAccessEnabled=hTTPAccessEnabled, pubStats=pubStats, linkModeOptimisation=linkModeOptimisation, channelChangeTrap=channelChangeTrap, transmitModulationMode=transmitModulationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, encryptionAlgorithm=encryptionAlgorithm, receivePower=receivePower, antennaGain=antennaGain, userRole=userRole, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtpGroup=smtpGroup, transmitDataRate=transmitDataRate, tDDControl=tDDControl, softwareVersion=softwareVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installStatusTrap=installStatusTrap, telecomsInterface=telecomsInterface, systemClock=systemClock, encryption=encryption, licensedCapacity=licensedCapacity, supplementary=supplementary, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptmp=ptmp, eIRP=eIRP, range=range, bootVersion=bootVersion, dfsTable=dfsTable, linkSymmetry=linkSymmetry, receiveChannel=receiveChannel, telecom=telecom, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sntpGroup=sntpGroup, ptp500=ptp500, telecomGroup=telecomGroup, syslogControlGroup=syslogControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, groupID=groupID, linkLoss=linkLoss, receiveFreqKHz=receiveFreqKHz, syslogStateTrap=syslogStateTrap, smtp=smtp, receiveFreqMHz=receiveFreqMHz, phyStatus=phyStatus, phyControlGroup=phyControlGroup, sNMPTrapVersion=sNMPTrapVersion, dfsGroup=dfsGroup, sNTPSync=sNTPSync, aAAControlGroup=aAAControlGroup, gatewayIPAddress=gatewayIPAddress, dataPortAutoMdix=dataPortAutoMdix, bandwidthVariant=bandwidthVariant, aAAControl=aAAControl, sNMPTrapTableEntry=sNMPTrapTableEntry, versions=versions, tDDControlGroup=tDDControlGroup, vLANPriorityTable=vLANPriorityTable, accessMethod=accessMethod, transmitChannel=transmitChannel, userTableNumber=userTableNumber, channelBandwidth=channelBandwidth, frequencyVariant=frequencyVariant, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, maximumTransmitPower=maximumTransmitPower, targetMACAddress=targetMACAddress, cambium=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, daylightSaving=daylightSaving, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, ptp=ptp, dfsTableEntry=dfsTableEntry, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPAddress=iPAddress, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetPortNumber=telnetPortNumber, sNMPPortNumber=sNMPPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, hTTPSPortNumber=hTTPSPortNumber, userEnabled=userEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogClient=syslogClient, dataPortStatusTrap=dataPortStatusTrap, sNTPPollInterval=sNTPPollInterval, ethernet=ethernet, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyControl=phyControl, sNTPServerPortNumber=sNTPServerPortNumber, cableLoss=cableLoss, regionCode=regionCode, vectorError=vectorError, systemReset=systemReset, userName=userName, productVariant=productVariant, phyStatusGroup=phyStatusGroup, telecomsCableLength=telecomsCableLength, constantPowerSpectralDensity=constantPowerSpectralDensity, siteName=siteName, telecomsLoopback=telecomsLoopback, userTableEntry=userTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installStatus=installStatus, reset=reset, longitude=longitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkAvailability=wirelessLinkAvailability, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sntp=sntp, snmpControl=snmpControl, dfsPeaks=dfsPeaks, latitude=latitude, sMTPServerPortNumber=sMTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, masterSlaveMode=masterSlaveMode, searchState=searchState, hardwareVersion=hardwareVersion, wirelessLinkStatus=wirelessLinkStatus, ptpCompliance=ptpCompliance, hTTPPortNumber=hTTPPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarning=dataPortDisabledWarning, telecomsLineCode=telecomsLineCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitPower=transmitPower, secondarySoftwareVersion=secondarySoftwareVersion, pubStatsGroup=pubStatsGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqMHz=transmitFreqMHz, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, telecomsChannelStatus=telecomsChannelStatus, dfsTableIndex=dfsTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTable=sNMPTrapTable, ptpGroups=ptpGroups, userTableIndex=userTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, managementGroup=managementGroup, PYSNMP_MODULE_ID=cambium, ethernetGroup=ethernetGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTraps=ptpTraps, linkName=linkName, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, versionsGroup=versionsGroup, snmpControlGroup=snmpControlGroup, dfsTableNumber=dfsTableNumber, installArmState=installArmState, unitOutOfCalibration=unitOutOfCalibration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortStatus=dataPortStatus, dfs=dfs, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogControl=syslogControl, alarms=alarms, incompatibleRegionCodes=incompatibleRegionCodes, altitude=altitude, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, management=management, sNMPv3Enable=sNMPv3Enable, syslogState=syslogState, licenceGroup=licenceGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteIPAddress=remoteIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, notificationsGroup=notificationsGroup, capacityLicenseMismatch=capacityLicenseMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch)
