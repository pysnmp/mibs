...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptp500=ptp500, reset=reset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, tDDControl=tDDControl, telecomsLoopback=telecomsLoopback, linkSymmetry=linkSymmetry, range=range, smtp=smtp, targetMACAddress=targetMACAddress, sNMPTrapVersion=sNMPTrapVersion, transmitModulationMode=transmitModulationMode, transmitPower=transmitPower, receiveFreqMHz=receiveFreqMHz, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsLoopbackTrap=telecomsLoopbackTrap, snmpControl=snmpControl, phyControl=phyControl, sMTPServerIPAddress=sMTPServerIPAddress, groupID=groupID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableNumber=userTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, cambium=cambium, telecomsLineCode=telecomsLineCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, versionsGroup=versionsGroup, phyControlGroup=phyControlGroup, cableLoss=cableLoss, receiveDataRate=receiveDataRate, notificationsGroup=notificationsGroup, regionCode=regionCode, aAAControlGroup=aAAControlGroup, transmitFreqMHz=transmitFreqMHz, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodes=incompatibleRegionCodes, productVariant=productVariant, timeZone=timeZone, alarms=alarms, accessMethod=accessMethod, resetGroup=resetGroup, bootVersion=bootVersion, altitude=altitude, supplementaryGroup=supplementaryGroup, installStatusTrap=installStatusTrap, linkLoss=linkLoss, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegotiation=dataPortAutoNegotiation, licence=licence, dfsMeans=dfsMeans, sNMPTrapTable=sNMPTrapTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationStatus=tDDSynchronizationStatus, userPassword=userPassword, channelChangeTrap=channelChangeTrap, secondarySoftwareVersion=secondarySoftwareVersion, userRole=userRole, signalStrengthRatio=signalStrengthRatio, sNTPLastSync=sNTPLastSync, management=management, syslogClient=syslogClient, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ethernetFiberSupport=ethernetFiberSupport, userTable=userTable, siteName=siteName, telecom=telecom, hTTPPortNumber=hTTPPortNumber, telnetPortNumber=telnetPortNumber, productName=productName, telecomsChannelStatus=telecomsChannelStatus, tDDControlGroup=tDDControlGroup, masterSlaveMode=masterSlaveMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSyncTrap=sNTPSyncTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, bandwidthVariant=bandwidthVariant, licenceGroup=licenceGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, snmpControlGroup=snmpControlGroup, regionCodeTrap=regionCodeTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, capacityLicenseMismatch=capacityLicenseMismatch, sntpGroup=sntpGroup, systemReset=systemReset, latitude=latitude, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userName=userName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userTableIndex=userTableIndex, dfsTableEntry=dfsTableEntry, managementGroup=managementGroup, ethernet=ethernet, userEnabled=userEnabled, syslogStateTrap=syslogStateTrap, sNTPState=sNTPState, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, vLANManagementVID=vLANManagementVID, installArmState=installArmState, dfsTableNumber=dfsTableNumber, systemClock=systemClock, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStatsGroup=pubStatsGroup, dataPortDisabledWarning=dataPortDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installStatus=installStatus, linkModeOptimisation=linkModeOptimisation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPv3Enable=sNMPv3Enable, telecomGroup=telecomGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANPriorityTable=vLANPriorityTable, dfsTable=dfsTable, receiveChannel=receiveChannel, receiveFreqKHz=receiveFreqKHz, transmitChannel=transmitChannel, linkName=linkName, ethernetGroup=ethernetGroup, syslogControlGroup=syslogControlGroup, subnetMask=subnetMask, smtpGroup=smtpGroup, eIRP=eIRP, telecomsInterface=telecomsInterface, telecomsCableLength=telecomsCableLength, wirelessLinkStatus=wirelessLinkStatus, vectorError=vectorError, sNTPServerPortNumber=sNTPServerPortNumber, byteErrorRatio=byteErrorRatio, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installArmStateTrap=installArmStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, channelBandwidth=channelBandwidth, dfs=dfs, supplementary=supplementary, PYSNMP_MODULE_ID=cambium, aAAControl=aAAControl, configurationGroup=configurationGroup, receivePower=receivePower, dfsPeaks=dfsPeaks, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogState=syslogState, tFTPServerIPAddress=tFTPServerIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, alarmsGroup=alarmsGroup, sNTPSync=sNTPSync, sNTPPollInterval=sNTPPollInterval, enabledDiagnosticAlarms=enabledDiagnosticAlarms, daylightSaving=daylightSaving, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, telnetAccessEnabled=telnetAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, encryptionGroup=encryptionGroup, sNMPCommunityString=sNMPCommunityString, encryption=encryption, encryptionAlgorithm=encryptionAlgorithm, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp=ptp, longitude=longitude, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpGroups=ptpGroups, sntp=sntp, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveModulationMode=receiveModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPEnabledTraps=sNMPEnabledTraps, maximumTransmitPower=maximumTransmitPower, hardwareVersion=hardwareVersion, userTableEntry=userTableEntry, configuration=configuration, gatewayIPAddress=gatewayIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, constantPowerSpectralDensity=constantPowerSpectralDensity, iPAddress=iPAddress, sMTPEmailAlert=sMTPEmailAlert, dfsGroup=dfsGroup, vLANManagementPriority=vLANManagementPriority, sNMPPortNumber=sNMPPortNumber, versions=versions, syslogControl=syslogControl, phyStatusGroup=phyStatusGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, syslogClientTrap=syslogClientTrap, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpTraps=ptpTraps, searchState=searchState, transmitFreqKHz=transmitFreqKHz, frequencyVariant=frequencyVariant, unitOutOfCalibration=unitOutOfCalibration, ptpCompliance=ptpCompliance, phyStatus=phyStatus, licensedCapacity=licensedCapacity)
