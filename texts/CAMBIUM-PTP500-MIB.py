...
TimeTicks, NotificationType, Unsigned32, IpAddress, Integer32, enterprises, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Bits, ModuleIdentity, ObjectIdentity, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Unsigned32", "IpAddress", "Integer32", "enterprises", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Bits", "ModuleIdentity", "ObjectIdentity", "iso", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userTableNumber=userTableNumber, sNMPPortNumber=sNMPPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, configuration=configuration, configurationGroup=configurationGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsLoopback=telecomsLoopback, telecomsLoopbackTrap=telecomsLoopbackTrap, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStatsGroup=pubStatsGroup, searchState=searchState, systemReset=systemReset, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetGroup=ethernetGroup, siteName=siteName, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, licence=licence, range=range, receiveModulationMode=receiveModulationMode, ethernet=ethernet, versionsGroup=versionsGroup, telecomGroup=telecomGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userPassword=userPassword, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpTrapPrefix=ptpTrapPrefix, notificationsGroup=notificationsGroup, resetGroup=resetGroup, phyStatusGroup=phyStatusGroup, ptpGroups=ptpGroups, pubStats=pubStats, telecomsInterface=telecomsInterface, channelBandwidth=channelBandwidth, syslogControlGroup=syslogControlGroup, dfsTableNumber=dfsTableNumber, transmitDataRate=transmitDataRate, userEnabled=userEnabled, management=management, iPAddress=iPAddress, accessMethod=accessMethod, ptpTraps=ptpTraps, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveFreqMHz=receiveFreqMHz, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, smtp=smtp, hTTPPortNumber=hTTPPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, aAAControlGroup=aAAControlGroup, encryptionAlgorithm=encryptionAlgorithm, dataPortStatusTrap=dataPortStatusTrap, hTTPSPortNumber=hTTPSPortNumber, dfsTableEntry=dfsTableEntry, sMTPEmailAlert=sMTPEmailAlert, dfsTable=dfsTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqKHz=receiveFreqKHz, ptpCompliance=ptpCompliance, sNTPLastSync=sNTPLastSync, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitModulationMode=transmitModulationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsGroup=dfsGroup, sNMPTrapTable=sNMPTrapTable, sNMPEnabledTraps=sNMPEnabledTraps, tDDControlGroup=tDDControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, linkLoss=linkLoss, vLANPriorityTableEntry=vLANPriorityTableEntry, capacityLicenseMismatch=capacityLicenseMismatch, sMTPServerIPAddress=sMTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, licenceGroup=licenceGroup, byteErrorRatio=byteErrorRatio, linkModeOptimisation=linkModeOptimisation, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortStatus=dataPortStatus, telecomsCableLength=telecomsCableLength, secondarySoftwareVersion=secondarySoftwareVersion, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlave=incompatibleMasterAndSlave, longitude=longitude, alarmsGroup=alarmsGroup, latitude=latitude, phyControl=phyControl, sNTPSync=sNTPSync, signalStrengthRatio=signalStrengthRatio, dfsTableIndex=dfsTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bandwidthVariant=bandwidthVariant, receivePower=receivePower, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hardwareVersion=hardwareVersion, productName=productName, tDDControl=tDDControl, versions=versions, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPState=sNTPState, timeZone=timeZone, aggregateDataRate=aggregateDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsMeans=dfsMeans, userTableEntry=userTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogClientTrap=syslogClientTrap, linkSymmetry=linkSymmetry, reset=reset, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vectorError=vectorError, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerPortNumber=sNTPServerPortNumber, subnetMask=subnetMask, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptp500=ptp500, vLANPriorityTable=vLANPriorityTable, snmpControl=snmpControl, regionCodeTrap=regionCodeTrap, eIRP=eIRP, syslogStateTrap=syslogStateTrap, receiveDataRate=receiveDataRate, supplementaryGroup=supplementaryGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogControl=syslogControl, managementGroup=managementGroup, sntp=sntp, phyControlGroup=phyControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telnetAccessEnabled=telnetAccessEnabled, transmitFreqKHz=transmitFreqKHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, installStatusTrap=installStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarms=alarms, encryption=encryption, licensedCapacity=licensedCapacity, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, groupID=groupID, vLANManagementVID=vLANManagementVID, telecom=telecom, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableIndex=userTableIndex, ptp=ptp, targetMACAddress=targetMACAddress, channelChangeTrap=channelChangeTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, regionCode=regionCode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, smtpGroup=smtpGroup, dfsPeaks=dfsPeaks, vLANManagementPriority=vLANManagementPriority, constantPowerSpectralDensity=constantPowerSpectralDensity, PYSNMP_MODULE_ID=cambium, hTTPAccessEnabled=hTTPAccessEnabled, antennaGain=antennaGain, vLANPriorityQueueMapping=vLANPriorityQueueMapping, installArmStateTrap=installArmStateTrap, telecomsLineCode=telecomsLineCode, altitude=altitude, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryptionGroup=encryptionGroup, syslogClient=syslogClient, installStatus=installStatus, cambium=cambium, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkName=linkName, productVariant=productVariant, sNTPPollInterval=sNTPPollInterval, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, masterSlaveMode=masterSlaveMode, telecomsChannelStatus=telecomsChannelStatus, receiveModulationModeDetail=receiveModulationModeDetail, sntpGroup=sntpGroup, transmitChannel=transmitChannel, tDDSynchronizationMode=tDDSynchronizationMode, maximumTransmitPower=maximumTransmitPower, sNTPSyncTrap=sNTPSyncTrap, cableLoss=cableLoss, supplementary=supplementary, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapVersion=sNMPTrapVersion, remoteIPAddress=remoteIPAddress, userRole=userRole, ethernetFiberSupport=ethernetFiberSupport, systemClock=systemClock, aAAControl=aAAControl, syslogState=syslogState, dataPortDisabledWarning=dataPortDisabledWarning, frequencyVariant=frequencyVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, transmitPower=transmitPower, ptmp=ptmp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPv3Enable=sNMPv3Enable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, daylightSaving=daylightSaving, userTable=userTable, snmpControlGroup=snmpControlGroup, userName=userName, dfs=dfs, receiveChannel=receiveChannel, installArmState=installArmState)
