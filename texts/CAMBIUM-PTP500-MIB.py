...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRate=transmitDataRate, receiveFreqMHz=receiveFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, regionCode=regionCode, telecomsInterface=telecomsInterface, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPEnabledMessages=sMTPEnabledMessages, dfsGroup=dfsGroup, sMTPServerIPAddress=sMTPServerIPAddress, softwareVersion=softwareVersion, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userEnabled=userEnabled, installStatus=installStatus, transmitPower=transmitPower, unitOutOfCalibration=unitOutOfCalibration, vLANManagementVID=vLANManagementVID, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, userPassword=userPassword, channelBandwidth=channelBandwidth, linkLoss=linkLoss, timeZone=timeZone, sNMPEnabledTraps=sNMPEnabledTraps, installStatusTrap=installStatusTrap, dfsMeans=dfsMeans, phyStatusGroup=phyStatusGroup, encryptionAlgorithm=encryptionAlgorithm, aggregateDataRate=aggregateDataRate, byteErrorRatio=byteErrorRatio, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, phyControlGroup=phyControlGroup, telecomsLineCode=telecomsLineCode, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPPollInterval=sNTPPollInterval, sntp=sntp, range=range, userTableEntry=userTableEntry, dataPortStatusTrap=dataPortStatusTrap, systemReset=systemReset, hTTPAccessEnabled=hTTPAccessEnabled, userRole=userRole, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, siteName=siteName, ptpTraps=ptpTraps, channelChangeTrap=channelChangeTrap, versions=versions, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, pubStats=pubStats, sNTPServerIPAddress=sNTPServerIPAddress, sNTPState=sNTPState, latitude=latitude, hTTPSPortNumber=hTTPSPortNumber, remoteIPAddress=remoteIPAddress, regionCodeTrap=regionCodeTrap, capacityLicenseMismatch=capacityLicenseMismatch, transmitModulationMode=transmitModulationMode, smtpGroup=smtpGroup, bandwidthVariant=bandwidthVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogClientTrap=syslogClientTrap, vLANPriorityTable=vLANPriorityTable, sNMPv3Enable=sNMPv3Enable, installArmStateTrap=installArmStateTrap, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, targetMACAddress=targetMACAddress, tFTPServerIPAddress=tFTPServerIPAddress, syslogStateTrap=syslogStateTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp500=ptp500, userName=userName, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsTableEntry=dfsTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomGroup=telecomGroup, ethernetGroup=ethernetGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, supplementary=supplementary, telecomsChannelStatus=telecomsChannelStatus, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, tDDControl=tDDControl, signalStrengthRatio=signalStrengthRatio, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationMode=tDDSynchronizationMode, subnetMask=subnetMask, productName=productName, phyStatus=phyStatus, phyControl=phyControl, vLANManagementPriority=vLANManagementPriority, telnetPortNumber=telnetPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsPeaks=dfsPeaks, transmitFreqKHz=transmitFreqKHz, smtp=smtp, vectorError=vectorError, receiveChannel=receiveChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, ptmp=ptmp, licence=licence, longitude=longitude, altitude=altitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortStatus=dataPortStatus, tFTPServerPortNumber=tFTPServerPortNumber, licensedCapacity=licensedCapacity, frequencyVariant=frequencyVariant, userTableNumber=userTableNumber, ptpCompliance=ptpCompliance, wirelessLinkStatus=wirelessLinkStatus, supplementaryGroup=supplementaryGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, sNMPTrapTable=sNMPTrapTable, resetGroup=resetGroup, masterSlaveMode=masterSlaveMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, maximumTransmitPower=maximumTransmitPower, ethernet=ethernet, dfs=dfs, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptp=ptp, linkSymmetry=linkSymmetry, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClient=syslogClient, ethernetFiberSupport=ethernetFiberSupport, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, cambium=cambium, managementGroup=managementGroup, searchState=searchState, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPLastSync=sNTPLastSync, receivePower=receivePower, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, groupID=groupID, encryptionGroup=encryptionGroup, licenceGroup=licenceGroup, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versionsGroup=versionsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secondarySoftwareVersion=secondarySoftwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveFreqKHz=receiveFreqKHz, telecom=telecom, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableIndex=userTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPPortNumber=hTTPPortNumber, syslogState=syslogState, alarms=alarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userTable=userTable, accessMethod=accessMethod, management=management, ptpGroups=ptpGroups, ptpTrapPrefix=ptpTrapPrefix, snmpControlGroup=snmpControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPPortNumber=sNMPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, notificationsGroup=notificationsGroup, iPAddress=iPAddress, sNMPCommunityString=sNMPCommunityString, aAAControl=aAAControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableNumber=sNMPTrapTableNumber, antennaGain=antennaGain, syslogControlGroup=syslogControlGroup, syslogControl=syslogControl, transmitFreqMHz=transmitFreqMHz, receiveDataRate=receiveDataRate, dfsTableNumber=dfsTableNumber, sNTPSync=sNTPSync, installArmState=installArmState, incompatibleRegionCodes=incompatibleRegionCodes, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsLoopback=telecomsLoopback, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityTableEntry=vLANPriorityTableEntry, linkName=linkName, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, linkModeOptimisation=linkModeOptimisation, dfsTable=dfsTable, dfsTableIndex=dfsTableIndex, transmitChannel=transmitChannel, configuration=configuration, reset=reset, telecomsCableLength=telecomsCableLength, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hardwareVersion=hardwareVersion, eIRP=eIRP)
