...
ObjectIdentity, iso, Counter64, NotificationType, Unsigned32, ModuleIdentity, IpAddress, Counter32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Counter64", "NotificationType", "Unsigned32", "ModuleIdentity", "IpAddress", "Counter32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Bits", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receivePower=receivePower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPServerIPAddress=sMTPServerIPAddress, telecomsInterface=telecomsInterface, dfsGroup=dfsGroup, telecom=telecom, sntpGroup=sntpGroup, encryptionGroup=encryptionGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControl=snmpControl, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityQueueMapping=vLANPriorityQueueMapping, antennaGain=antennaGain, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryption=encryption, telecomsCableLength=telecomsCableLength, cambium=cambium, transmitFreqKHz=transmitFreqKHz, vLANPriorityTableEntry=vLANPriorityTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPCommunityString=sNMPCommunityString, dfsTable=dfsTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANManagementPriority=vLANManagementPriority, dfs=dfs, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, iPAddress=iPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, userRole=userRole, linkLoss=linkLoss, vLANPriorityTableIndex=vLANPriorityTableIndex, userTable=userTable, tDDSynchronizationMode=tDDSynchronizationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitFreqMHz=transmitFreqMHz, dfsTableEntry=dfsTableEntry, alarmsGroup=alarmsGroup, encryptionAlgorithm=encryptionAlgorithm, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, managementGroup=managementGroup, sNTPServerPortNumber=sNTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleRegionCodes=incompatibleRegionCodes, smtpGroup=smtpGroup, capacityLicenseMismatch=capacityLicenseMismatch, tFTPServerIPAddress=tFTPServerIPAddress, ptmp=ptmp, timeZone=timeZone, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, daylightSaving=daylightSaving, aggregateDataRate=aggregateDataRate, dfsTableIndex=dfsTableIndex, installArmStateTrap=installArmStateTrap, dataPortStatusTrap=dataPortStatusTrap, sMTPEmailAlert=sMTPEmailAlert, phyControl=phyControl, licenceGroup=licenceGroup, tFTPServerPortNumber=tFTPServerPortNumber, searchState=searchState, bandwidthVariant=bandwidthVariant, hTTPPortNumber=hTTPPortNumber, telecomsChannelStatus=telecomsChannelStatus, linkModeOptimisation=linkModeOptimisation, syslogClientTrap=syslogClientTrap, bootVersion=bootVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userName=userName, versionsGroup=versionsGroup, installStatusTrap=installStatusTrap, regionCodeTrap=regionCodeTrap, frequencyVariant=frequencyVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp500=ptp500, transmitChannel=transmitChannel, byteErrorRatio=byteErrorRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkName=linkName, telecomsLineCode=telecomsLineCode, receiveDataRate=receiveDataRate, vLANPriorityTable=vLANPriorityTable, telecomsLoopback=telecomsLoopback, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, telnetPortNumber=telnetPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, signalStrengthRatio=signalStrengthRatio, groupID=groupID, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, channelBandwidth=channelBandwidth, targetMACAddress=targetMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, secondarySoftwareVersion=secondarySoftwareVersion, ptp=ptp, notificationsGroup=notificationsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, siteName=siteName, unitOutOfCalibration=unitOutOfCalibration, transmitDataRate=transmitDataRate, sNMPv3Enable=sNMPv3Enable, sNTPPollInterval=sNTPPollInterval, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, regionCode=regionCode, pubStats=pubStats, receiveModulationMode=receiveModulationMode, vectorError=vectorError, aAAControlGroup=aAAControlGroup, remoteIPAddress=remoteIPAddress, eIRP=eIRP, vLANPriorityTableNumber=vLANPriorityTableNumber, installStatus=installStatus, wirelessLinkStatus=wirelessLinkStatus, telnetAccessEnabled=telnetAccessEnabled, dfsMeans=dfsMeans, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, longitude=longitude, gatewayIPAddress=gatewayIPAddress, syslogControl=syslogControl, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTable=sNMPTrapTable, sntp=sntp, ptpCompliance=ptpCompliance, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationModeDetail=receiveModulationModeDetail, syslogState=syslogState, smtp=smtp, range=range, pubStatsGroup=pubStatsGroup, userTableIndex=userTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetGroup=ethernetGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPEnabledTraps=sNMPEnabledTraps, alarms=alarms, noWirelessChannelAvailable=noWirelessChannelAvailable, userEnabled=userEnabled, phyStatus=phyStatus, receiveFreqMHz=receiveFreqMHz, sNTPSync=sNTPSync, telecomsChannelStatusTrap=telecomsChannelStatusTrap, subnetMask=subnetMask, phyControlGroup=phyControlGroup, dataPortStatus=dataPortStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, systemReset=systemReset, sNTPSyncTrap=sNTPSyncTrap, ptpTraps=ptpTraps, licensedCapacity=licensedCapacity, supplementary=supplementary, dfsPeaks=dfsPeaks, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, sNTPState=sNTPState, accessMethod=accessMethod, tDDControl=tDDControl, sNMPTrapVersion=sNMPTrapVersion, maximumTransmitPower=maximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomGroup=telecomGroup, productName=productName, management=management, licence=licence, cableLoss=cableLoss, userPassword=userPassword, latitude=latitude, receiveFreqKHz=receiveFreqKHz, sMTPServerPortNumber=sMTPServerPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, productVariant=productVariant, configuration=configuration, resetGroup=resetGroup, dfsTableNumber=dfsTableNumber, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, aAAControl=aAAControl, transmitPower=transmitPower, sNMPPortNumber=sNMPPortNumber, hardwareVersion=hardwareVersion, altitude=altitude, sNTPLastSync=sNTPLastSync, syslogControlGroup=syslogControlGroup, syslogStateTrap=syslogStateTrap, ethernetFiberSupport=ethernetFiberSupport, softwareVersion=softwareVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveChannel=receiveChannel, systemClock=systemClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userTableEntry=userTableEntry, installArmState=installArmState, versions=versions, useVLANForManagementInterfaces=useVLANForManagementInterfaces, configurationGroup=configurationGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableNumber=userTableNumber, syslogClient=syslogClient, channelChangeTrap=channelChangeTrap, tDDControlGroup=tDDControlGroup, masterSlaveMode=masterSlaveMode, reset=reset, ethernet=ethernet)
