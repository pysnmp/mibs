...
enterprises, IpAddress, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, iso, MibIdentifier, Gauge32, TimeTicks, NotificationType, Integer32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "iso", "MibIdentifier", "Gauge32", "TimeTicks", "NotificationType", "Integer32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", accessMethod=accessMethod, ptp500=ptp500, sNTPLastSync=sNTPLastSync, searchState=searchState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveFreqMHz=receiveFreqMHz, dfsTableNumber=dfsTableNumber, ptpGroups=ptpGroups, management=management, syslogClientTrap=syslogClientTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, longitude=longitude, tDDControlGroup=tDDControlGroup, sNTPSync=sNTPSync, aAAControlGroup=aAAControlGroup, ptpTrapPrefix=ptpTrapPrefix, sNTPState=sNTPState, hardwareVersion=hardwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, byteErrorRatio=byteErrorRatio, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryption=encryption, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, bandwidthVariant=bandwidthVariant, alarmsGroup=alarmsGroup, syslogClient=syslogClient, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, phyStatus=phyStatus, telecom=telecom, dataPortStatusTrap=dataPortStatusTrap, telnetAccessEnabled=telnetAccessEnabled, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, dfsPeaks=dfsPeaks, linkSymmetry=linkSymmetry, licensedCapacity=licensedCapacity, sNTPPollInterval=sNTPPollInterval, PYSNMP_MODULE_ID=cambium, altitude=altitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleRegionCodes=incompatibleRegionCodes, vLANManagementVID=vLANManagementVID, unitOutOfCalibration=unitOutOfCalibration, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableIndex=dfsTableIndex, telecomsLoopbackTrap=telecomsLoopbackTrap, userPassword=userPassword, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, supplementary=supplementary, constantPowerSpectralDensity=constantPowerSpectralDensity, userRole=userRole, hTTPSPortNumber=hTTPSPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installStatusTrap=installStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, daylightSaving=daylightSaving, pubStats=pubStats, linkName=linkName, tDDControl=tDDControl, subnetMask=subnetMask, managementGroup=managementGroup, smtpGroup=smtpGroup, supplementaryGroup=supplementaryGroup, masterSlaveMode=masterSlaveMode, phyControlGroup=phyControlGroup, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, versions=versions, dfsTableEntry=dfsTableEntry, antennaGain=antennaGain, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqKHz=transmitFreqKHz, receiveModulationModeDetail=receiveModulationModeDetail, installArmState=installArmState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, regionCode=regionCode, aAAControl=aAAControl, smtp=smtp, userTableEntry=userTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveDataRate=receiveDataRate, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptp=ptp, linkLoss=linkLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secondarySoftwareVersion=secondarySoftwareVersion, configuration=configuration, dataPortAutoMdix=dataPortAutoMdix, signalStrengthRatio=signalStrengthRatio, eIRP=eIRP, userTableIndex=userTableIndex, sNTPSyncTrap=sNTPSyncTrap, hTTPPortNumber=hTTPPortNumber, telecomsLineCode=telecomsLineCode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANPriorityTable=vLANPriorityTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqMHz=transmitFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, range=range, vLANPriorityTableNumber=vLANPriorityTableNumber, softwareVersion=softwareVersion, telecomsInterface=telecomsInterface, receiveChannel=receiveChannel, transmitPower=transmitPower, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPPortNumber=sNMPPortNumber, phyControl=phyControl, telecomsLoopback=telecomsLoopback, sNMPEnabledTraps=sNMPEnabledTraps, userName=userName, targetMACAddress=targetMACAddress, ethernet=ethernet, gatewayIPAddress=gatewayIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitDataRate=transmitDataRate, channelChangeTrap=channelChangeTrap, regionCodeTrap=regionCodeTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vectorError=vectorError, ptmp=ptmp, vLANManagementPriority=vLANManagementPriority, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableLoss=cableLoss, dfsGroup=dfsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPServerPortNumber=tFTPServerPortNumber, ethernetGroup=ethernetGroup, sntpGroup=sntpGroup, sNMPTrapVersion=sNMPTrapVersion, userTable=userTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetPortNumber=telnetPortNumber, encryptionGroup=encryptionGroup, versionsGroup=versionsGroup, installArmStateTrap=installArmStateTrap, receivePower=receivePower, dfs=dfs, tFTPServerIPAddress=tFTPServerIPAddress, systemClock=systemClock, syslogState=syslogState, snmpControlGroup=snmpControlGroup, capacityLicenseMismatch=capacityLicenseMismatch, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sntp=sntp, phyStatusGroup=phyStatusGroup, pubStatsGroup=pubStatsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licence=licence, syslogControl=syslogControl, ptpCompliance=ptpCompliance, groupID=groupID, licenceGroup=licenceGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsMeans=dfsMeans, siteName=siteName, encryptionAlgorithm=encryptionAlgorithm, sNMPCommunityString=sNMPCommunityString, sNMPv3Enable=sNMPv3Enable, sNMPTrapTable=sNMPTrapTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, timeZone=timeZone, sNMPTrapTableEntry=sNMPTrapTableEntry, userEnabled=userEnabled, resetGroup=resetGroup, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, remoteIPAddress=remoteIPAddress, frequencyVariant=frequencyVariant, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPAddress=iPAddress, ptpTraps=ptpTraps, userTableNumber=userTableNumber, telecomGroup=telecomGroup, telecomsCableLength=telecomsCableLength, dfsTable=dfsTable, receiveFreqKHz=receiveFreqKHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelBandwidth=channelBandwidth, ethernetFiberSupport=ethernetFiberSupport, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, systemReset=systemReset, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, snmpControl=snmpControl, latitude=latitude, productVariant=productVariant, cambium=cambium, alarms=alarms, sNTPServerPortNumber=sNTPServerPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitChannel=transmitChannel, tDDSynchronizationMode=tDDSynchronizationMode, installStatus=installStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, reset=reset, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkStatus=wirelessLinkStatus, dataPortDisabledWarning=dataPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsChannelStatus=telecomsChannelStatus, syslogControlGroup=syslogControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, linkModeOptimisation=linkModeOptimisation, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortStatus=dataPortStatus, syslogStateTrap=syslogStateTrap, sNMPTrapTableNumber=sNMPTrapTableNumber)
