...
Counter64, NotificationType, ModuleIdentity, Counter32, Integer32, iso, IpAddress, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, Bits, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "ModuleIdentity", "Counter32", "Integer32", "iso", "IpAddress", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "Bits", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sMTPServerPortNumber=sMTPServerPortNumber, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, productVariant=productVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installArmStateTrap=installArmStateTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, eIRP=eIRP, supplementaryGroup=supplementaryGroup, hTTPPortNumber=hTTPPortNumber, latitude=latitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, masterSlaveMode=masterSlaveMode, telecom=telecom, sNTPState=sNTPState, userTableIndex=userTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableNumber=dfsTableNumber, ptp=ptp, vLANManagementPriority=vLANManagementPriority, telecomsCableLength=telecomsCableLength, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimisation=linkModeOptimisation, vLANManagementVID=vLANManagementVID, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, encryption=encryption, sNTPLastSync=sNTPLastSync, receiveModulationModeDetail=receiveModulationModeDetail, dataPortAutoNegotiation=dataPortAutoNegotiation, bandwidthVariant=bandwidthVariant, userPassword=userPassword, transmitDataRate=transmitDataRate, sNTPPollInterval=sNTPPollInterval, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTableNumber=userTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPAddress=iPAddress, alarmsGroup=alarmsGroup, userTable=userTable, phyStatus=phyStatus, regionCode=regionCode, sNTPSyncTrap=sNTPSyncTrap, dfsGroup=dfsGroup, accessMethod=accessMethod, syslogStateTrap=syslogStateTrap, transmitChannel=transmitChannel, cableLoss=cableLoss, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, userEnabled=userEnabled, ptpGroups=ptpGroups, receiveFreqMHz=receiveFreqMHz, versions=versions, syslogControl=syslogControl, dataPortStatus=dataPortStatus, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, dataPortDisabledWarning=dataPortDisabledWarning, sntp=sntp, snmpControl=snmpControl, sNMPCommunityString=sNMPCommunityString, userTableEntry=userTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, phyControl=phyControl, wirelessLinkAvailability=wirelessLinkAvailability, channelBandwidth=channelBandwidth, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationMode=tDDSynchronizationMode, altitude=altitude, PYSNMP_MODULE_ID=cambium, dataPortAutoMdix=dataPortAutoMdix, dfsPeaks=dfsPeaks, telecomsInterface=telecomsInterface, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitPower=transmitPower, systemReset=systemReset, sNTPServerIPAddress=sNTPServerIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPSAccessEnabled=hTTPSAccessEnabled, snmpControlGroup=snmpControlGroup, range=range, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, resetGroup=resetGroup, remoteIPAddress=remoteIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitFreqMHz=transmitFreqMHz, daylightSaving=daylightSaving, sNMPv3Enable=sNMPv3Enable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptp500=ptp500, vectorError=vectorError, receiveChannel=receiveChannel, systemClock=systemClock, productName=productName, sMTPServerIPAddress=sMTPServerIPAddress, syslogControlGroup=syslogControlGroup, syslogClientTrap=syslogClientTrap, transmitFreqKHz=transmitFreqKHz, sNMPTrapIPAddress=sNMPTrapIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, userName=userName, configurationGroup=configurationGroup, licenceGroup=licenceGroup, phyControlGroup=phyControlGroup, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableEntry=dfsTableEntry, installStatus=installStatus, linkLoss=linkLoss, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, aAAControlGroup=aAAControlGroup, telnetAccessEnabled=telnetAccessEnabled, syslogState=syslogState, syslogClient=syslogClient, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, antennaGain=antennaGain, ptpTraps=ptpTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatusGroup=phyStatusGroup, dfsTable=dfsTable, dfsTableIndex=dfsTableIndex, hTTPSPortNumber=hTTPSPortNumber, groupID=groupID, receiveDataRate=receiveDataRate, longitude=longitude, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDControlGroup=tDDControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, managementGroup=managementGroup, telecomGroup=telecomGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityTable=vLANPriorityTable, dfsMeans=dfsMeans, telecomsLineCode=telecomsLineCode, receiveModulationMode=receiveModulationMode, installStatusTrap=installStatusTrap, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNTPSync=sNTPSync, tDDControl=tDDControl, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, regionCodeTrap=regionCodeTrap, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, smtp=smtp, reset=reset, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTable=sNMPTrapTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, encryptionGroup=encryptionGroup, ethernet=ethernet, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsLoopback=telecomsLoopback, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersion=softwareVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configuration=configuration, alarms=alarms, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetGroup=ethernetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqKHz=receiveFreqKHz, searchState=searchState, telnetPortNumber=telnetPortNumber, supplementary=supplementary, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, licensedCapacity=licensedCapacity, ptpCompliance=ptpCompliance, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, vLANPriorityTableEntry=vLANPriorityTableEntry, targetMACAddress=targetMACAddress, hardwareVersion=hardwareVersion, channelChangeTrap=channelChangeTrap, sNMPPortNumber=sNMPPortNumber, cambium=cambium, pubStatsGroup=pubStatsGroup, incompatibleRegionCodes=incompatibleRegionCodes, pubStats=pubStats, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aAAControl=aAAControl, encryptionAlgorithm=encryptionAlgorithm, frequencyVariant=frequencyVariant, sMTPEmailAlert=sMTPEmailAlert, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelStatus=telecomsChannelStatus, linkSymmetry=linkSymmetry, versionsGroup=versionsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, subnetMask=subnetMask, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfs=dfs, capacityLicenseMismatch=capacityLicenseMismatch, byteErrorRatio=byteErrorRatio, receivePower=receivePower, notificationsGroup=notificationsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, sntpGroup=sntpGroup, siteName=siteName, sNMPTrapVersion=sNMPTrapVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkName=linkName, aggregateDataRate=aggregateDataRate)
