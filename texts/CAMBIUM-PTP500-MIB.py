...
ObjectIdentity, IpAddress, Counter64, Gauge32, Counter32, iso, Unsigned32, enterprises, Bits, TimeTicks, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Counter64", "Gauge32", "Counter32", "iso", "Unsigned32", "enterprises", "Bits", "TimeTicks", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", smtp=smtp, sMTPEmailAlert=sMTPEmailAlert, dataPortDisabledWarning=dataPortDisabledWarning, eIRP=eIRP, telecomsLoopback=telecomsLoopback, linkLoss=linkLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userRole=userRole, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomGroup=telecomGroup, dfsTableNumber=dfsTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsInterface=telecomsInterface, gatewayIPAddress=gatewayIPAddress, installStatus=installStatus, vectorError=vectorError, bootVersion=bootVersion, ptpGroups=ptpGroups, capacityLicenseMismatch=capacityLicenseMismatch, phyStatus=phyStatus, telecomsCableLength=telecomsCableLength, management=management, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unitOutOfCalibration=unitOutOfCalibration, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, sNTPServerPortNumber=sNTPServerPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkModeOptimizationMismatch=linkModeOptimizationMismatch, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, alarms=alarms, tDDControlGroup=tDDControlGroup, wirelessLinkStatus=wirelessLinkStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkName=linkName, longitude=longitude, secondarySoftwareVersion=secondarySoftwareVersion, transmitFreqMHz=transmitFreqMHz, productName=productName, versions=versions, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, iPAddress=iPAddress, hTTPAccessEnabled=hTTPAccessEnabled, vLANPriorityTable=vLANPriorityTable, dfsPeaks=dfsPeaks, ethernetFiberSupport=ethernetFiberSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, hardwareVersion=hardwareVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableIndex=dfsTableIndex, installArmState=installArmState, sNMPTrapTable=sNMPTrapTable, supplementaryGroup=supplementaryGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, latitude=latitude, licensedCapacity=licensedCapacity, ptpTraps=ptpTraps, dfsGroup=dfsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licence=licence, vLANManagementPriority=vLANManagementPriority, incompatibleRegionCodes=incompatibleRegionCodes, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveDataRate=receiveDataRate, range=range, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, channelChangeTrap=channelChangeTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, sNTPState=sNTPState, receiveModulationModeDetail=receiveModulationModeDetail, ptmp=ptmp, userName=userName, aAAControlGroup=aAAControlGroup, telecom=telecom, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userPassword=userPassword, timeZone=timeZone, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDControl=tDDControl, sNMPTrapTableNumber=sNMPTrapTableNumber, frequencyVariant=frequencyVariant, receiveFreqMHz=receiveFreqMHz, syslogStateTrap=syslogStateTrap, supplementary=supplementary, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, dfsTableEntry=dfsTableEntry, ptpCompliance=ptpCompliance, transmitFreqKHz=transmitFreqKHz, ethernetGroup=ethernetGroup, userEnabled=userEnabled, ptp500=ptp500, softwareVersion=softwareVersion, dfs=dfs, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableLoss=cableLoss, syslogState=syslogState, encryptionGroup=encryptionGroup, signalStrengthRatio=signalStrengthRatio, dataPortAutoMdix=dataPortAutoMdix, ptpTrapPrefix=ptpTrapPrefix, aAAControl=aAAControl, sntpGroup=sntpGroup, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, masterSlaveMode=masterSlaveMode, ethernet=ethernet, vLANPriorityTableNumber=vLANPriorityTableNumber, antennaGain=antennaGain, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableIndex=userTableIndex, snmpControlGroup=snmpControlGroup, daylightSaving=daylightSaving, noWirelessChannelAvailable=noWirelessChannelAvailable, alarmsGroup=alarmsGroup, wirelessLinkAvailability=wirelessLinkAvailability, hTTPPortNumber=hTTPPortNumber, syslogControlGroup=syslogControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, encryption=encryption, subnetMask=subnetMask, resetGroup=resetGroup, pubStatsGroup=pubStatsGroup, channelBandwidth=channelBandwidth, receivePower=receivePower, phyControl=phyControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntp=sntp, snmpControl=snmpControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productVariant=productVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPSyncTrap=sNTPSyncTrap, hTTPSPortNumber=hTTPSPortNumber, ptp=ptp, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, transmitChannel=transmitChannel, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteIPAddress=remoteIPAddress, syslogClientTrap=syslogClientTrap, sNTPSync=sNTPSync, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, transmitPower=transmitPower, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPLastSync=sNTPLastSync, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, PYSNMP_MODULE_ID=cambium, smtpGroup=smtpGroup, userTableNumber=userTableNumber, transmitModulationMode=transmitModulationMode, dataPortStatusTrap=dataPortStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, systemClock=systemClock, accessMethod=accessMethod, cambium=cambium, constantPowerSpectralDensity=constantPowerSpectralDensity, searchState=searchState, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsMeans=dfsMeans, bandwidthVariant=bandwidthVariant, configuration=configuration, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmStateTrap=installArmStateTrap, regionCodeTrap=regionCodeTrap, groupID=groupID, dataPortStatus=dataPortStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telnetPortNumber=telnetPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, encryptionAlgorithm=encryptionAlgorithm, siteName=siteName, linkSymmetry=linkSymmetry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPv3Enable=sNMPv3Enable, telecomsLineCode=telecomsLineCode, licenceGroup=licenceGroup, installStatusTrap=installStatusTrap, managementGroup=managementGroup, maximumTransmitPower=maximumTransmitPower, pubStats=pubStats, syslogControl=syslogControl, versionsGroup=versionsGroup, notificationsGroup=notificationsGroup, syslogClient=syslogClient, regionCode=regionCode, sNMPCommunityString=sNMPCommunityString, telecomsChannelStatus=telecomsChannelStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqKHz=receiveFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, tFTPServerPortNumber=tFTPServerPortNumber, reset=reset, userTable=userTable, altitude=altitude, byteErrorRatio=byteErrorRatio, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimisation=linkModeOptimisation)
