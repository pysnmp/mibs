...
Unsigned32, Integer32, enterprises, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Gauge32, NotificationType, Counter64, ModuleIdentity, TimeTicks, ObjectIdentity, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "enterprises", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Gauge32", "NotificationType", "Counter64", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userTableNumber=userTableNumber, latitude=latitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, supplementary=supplementary, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userEnabled=userEnabled, phyStatusGroup=phyStatusGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitFreqKHz=transmitFreqKHz, telecomGroup=telecomGroup, eIRP=eIRP, signalStrengthRatio=signalStrengthRatio, syslogControl=syslogControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsGroup=dfsGroup, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoMdix=dataPortAutoMdix, dfsTableNumber=dfsTableNumber, configuration=configuration, dataPortDisabledWarning=dataPortDisabledWarning, tDDControl=tDDControl, sNTPState=sNTPState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPLastSync=sNTPLastSync, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecom=telecom, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, regionCode=regionCode, encryptionAlgorithm=encryptionAlgorithm, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpTraps=ptpTraps, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, sNTPSyncTrap=sNTPSyncTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpCompliance=ptpCompliance, hTTPPortNumber=hTTPPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, telnetPortNumber=telnetPortNumber, telecomsLoopback=telecomsLoopback, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, unitOutOfCalibration=unitOutOfCalibration, sntp=sntp, alarmsGroup=alarmsGroup, userName=userName, telnetAccessEnabled=telnetAccessEnabled, timeZone=timeZone, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, productVariant=productVariant, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemClock=systemClock, linkSymmetry=linkSymmetry, sNMPCommunityString=sNMPCommunityString, alarms=alarms, ptp=ptp, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, telecomsChannelStatus=telecomsChannelStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userPassword=userPassword, aAAControl=aAAControl, pubStats=pubStats, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogClientTrap=syslogClientTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, vLANManagementVID=vLANManagementVID, sNMPTrapTable=sNMPTrapTable, receiveFreqKHz=receiveFreqKHz, transmitChannel=transmitChannel, ptpGroups=ptpGroups, phyControlGroup=phyControlGroup, userRole=userRole, linkModeOptimisation=linkModeOptimisation, channelBandwidth=channelBandwidth, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, range=range, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, vLANManagementPriority=vLANManagementPriority, antennaGain=antennaGain, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableIndex=dfsTableIndex, userTableIndex=userTableIndex, vectorError=vectorError, hTTPSPortNumber=hTTPSPortNumber, dataPortStatusTrap=dataPortStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, licensedCapacity=licensedCapacity, encryption=encryption, groupID=groupID, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPv3Enable=sNMPv3Enable, managementGroup=managementGroup, management=management, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationMode=tDDSynchronizationMode, syslogState=syslogState, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, receivePower=receivePower, licence=licence, receiveModulationModeDetail=receiveModulationModeDetail, installStatusTrap=installStatusTrap, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTable=userTable, subnetMask=subnetMask, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveModulationMode=receiveModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, smtpGroup=smtpGroup, sNTPServerIPAddress=sNTPServerIPAddress, snmpControl=snmpControl, hTTPAccessEnabled=hTTPAccessEnabled, cableLoss=cableLoss, frequencyVariant=frequencyVariant, reset=reset, transmitPower=transmitPower, sNTPSync=sNTPSync, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, targetMACAddress=targetMACAddress, siteName=siteName, telecomsInterface=telecomsInterface, dfsTableEntry=dfsTableEntry, dfsPeaks=dfsPeaks, sNMPTrapIPAddress=sNMPTrapIPAddress, hardwareVersion=hardwareVersion, linkName=linkName, versions=versions, iPAddress=iPAddress, altitude=altitude, notificationsGroup=notificationsGroup, remoteIPAddress=remoteIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installArmStateTrap=installArmStateTrap, ethernetGroup=ethernetGroup, linkLoss=linkLoss, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtp=smtp, PYSNMP_MODULE_ID=cambium, phyStatus=phyStatus, vLANPriorityTable=vLANPriorityTable, vLANPriorityTableIndex=vLANPriorityTableIndex, daylightSaving=daylightSaving, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPPortNumber=sNMPPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControlGroup=tDDControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveFreqMHz=receiveFreqMHz, byteErrorRatio=byteErrorRatio, encryptionGroup=encryptionGroup, supplementaryGroup=supplementaryGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bootVersion=bootVersion, ethernet=ethernet, sMTPEmailAlert=sMTPEmailAlert, resetGroup=resetGroup, dfs=dfs, licenceGroup=licenceGroup, telecomsLineCode=telecomsLineCode, longitude=longitude, tFTPServerPortNumber=tFTPServerPortNumber, phyControl=phyControl, userTableEntry=userTableEntry, telecomsCableLength=telecomsCableLength, gatewayIPAddress=gatewayIPAddress, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, installStatus=installStatus, syslogControlGroup=syslogControlGroup, receiveChannel=receiveChannel, searchState=searchState, dfsMeans=dfsMeans, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoNegotiation=dataPortAutoNegotiation, regionCodeTrap=regionCodeTrap, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationAlarm=tDDSynchronizationAlarm, masterSlaveMode=masterSlaveMode, installArmState=installArmState, versionsGroup=versionsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ethernetFiberSupport=ethernetFiberSupport, secondarySoftwareVersion=secondarySoftwareVersion, sntpGroup=sntpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogClient=syslogClient, productName=productName, ptp500=ptp500, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, dataPortStatus=dataPortStatus, dfsTable=dfsTable, aAAControlGroup=aAAControlGroup, channelChangeTrap=channelChangeTrap)
