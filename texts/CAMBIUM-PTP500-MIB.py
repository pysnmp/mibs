...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", searchState=searchState, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, hardwareVersion=hardwareVersion, dfsTable=dfsTable, dfs=dfs, daylightSaving=daylightSaving, configurationGroup=configurationGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkStatus=wirelessLinkStatus, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTable=sNMPTrapTable, pubStats=pubStats, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userEnabled=userEnabled, linkModeOptimisation=linkModeOptimisation, versions=versions, dfsTableEntry=dfsTableEntry, linkLoss=linkLoss, dataPortStatusTrap=dataPortStatusTrap, ethernetGroup=ethernetGroup, receivePower=receivePower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDControlGroup=tDDControlGroup, licensedCapacity=licensedCapacity, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementPriority=vLANManagementPriority, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitModulationMode=transmitModulationMode, userTableEntry=userTableEntry, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPv3Enable=sNMPv3Enable, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp500=ptp500, ptpTraps=ptpTraps, userRole=userRole, unitOutOfCalibration=unitOutOfCalibration, signalStrengthRatio=signalStrengthRatio, reset=reset, longitude=longitude, useVLANForManagementInterfaces=useVLANForManagementInterfaces, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPLastSync=sNTPLastSync, sNTPSyncTrap=sNTPSyncTrap, telecomsCableLength=telecomsCableLength, dataPortAutoMdix=dataPortAutoMdix, cableLoss=cableLoss, transmitDataRate=transmitDataRate, ptpGroups=ptpGroups, maximumTransmitPower=maximumTransmitPower, smtp=smtp, ptmp=ptmp, latitude=latitude, phyStatusGroup=phyStatusGroup, encryptionAlgorithm=encryptionAlgorithm, tFTPServerPortNumber=tFTPServerPortNumber, dfsTableNumber=dfsTableNumber, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installArmStateTrap=installArmStateTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkName=linkName, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControlGroup=aAAControlGroup, channelChangeTrap=channelChangeTrap, telecomsInterface=telecomsInterface, vLANPriorityTableEntry=vLANPriorityTableEntry, remoteIPAddress=remoteIPAddress, regionCode=regionCode, hTTPSPortNumber=hTTPSPortNumber, siteName=siteName, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControl=snmpControl, sMTPServerPortNumber=sMTPServerPortNumber, targetMACAddress=targetMACAddress, telecomGroup=telecomGroup, telecomsChannelStatus=telecomsChannelStatus, vectorError=vectorError, antennaGain=antennaGain, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatus=dataPortStatus, configuration=configuration, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hTTPSAccessEnabled=hTTPSAccessEnabled, userTable=userTable, vLANManagementVID=vLANManagementVID, receiveChannel=receiveChannel, bootVersion=bootVersion, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, telnetAccessEnabled=telnetAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitChannel=transmitChannel, telecom=telecom, smtpGroup=smtpGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityQueueMapping=vLANPriorityQueueMapping, range=range, productVariant=productVariant, eIRP=eIRP, vLANPriorityTable=vLANPriorityTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versionsGroup=versionsGroup, tDDControl=tDDControl, capacityLicenseMismatch=capacityLicenseMismatch, hTTPPortNumber=hTTPPortNumber, regionCodeTrap=regionCodeTrap, aAAControl=aAAControl, groupID=groupID, systemClock=systemClock, installArmState=installArmState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveFreqMHz=receiveFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, notificationsGroup=notificationsGroup, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqKHz=receiveFreqKHz, ptpTrapPrefix=ptpTrapPrefix, ptp=ptp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableIndex=dfsTableIndex, ethernet=ethernet, productName=productName, receiveDataRate=receiveDataRate, userTableNumber=userTableNumber, syslogState=syslogState, dfsMeans=dfsMeans, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licenceGroup=licenceGroup, sNMPPortNumber=sNMPPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogControlGroup=syslogControlGroup, sNTPSync=sNTPSync, syslogClient=syslogClient, syslogClientTrap=syslogClientTrap, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapVersion=sNMPTrapVersion, telecomsLineCode=telecomsLineCode, dataPortDisabledWarning=dataPortDisabledWarning, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqKHz=transmitFreqKHz, installStatusTrap=installStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubStatsGroup=pubStatsGroup, byteErrorRatio=byteErrorRatio, alarms=alarms, frequencyVariant=frequencyVariant, accessMethod=accessMethod, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryption=encryption, bandwidthVariant=bandwidthVariant, sNTPPollInterval=sNTPPollInterval, dfsPeaks=dfsPeaks, sMTPEnabledMessages=sMTPEnabledMessages, encryptionGroup=encryptionGroup, installStatus=installStatus, alarmsGroup=alarmsGroup, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licence=licence, phyControlGroup=phyControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPState=sNTPState, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, telnetPortNumber=telnetPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, timeZone=timeZone, dfsGroup=dfsGroup, iPAddress=iPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemReset=systemReset, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsLoopback=telecomsLoopback, ptpCompliance=ptpCompliance, syslogControl=syslogControl, userPassword=userPassword, management=management, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPCommunityString=sNMPCommunityString, syslogStateTrap=syslogStateTrap, cambium=cambium, linkSymmetry=linkSymmetry, phyStatus=phyStatus, managementGroup=managementGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernetFiberSupport=ethernetFiberSupport, sntpGroup=sntpGroup, sntp=sntp, sNTPServerPortNumber=sNTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, linkModeOptimizationMismatch=linkModeOptimizationMismatch, supplementary=supplementary, supplementaryGroup=supplementaryGroup, transmitPower=transmitPower, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, altitude=altitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userName=userName, resetGroup=resetGroup, softwareVersion=softwareVersion, channelBandwidth=channelBandwidth)
