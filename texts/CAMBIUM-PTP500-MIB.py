...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTableNumber=vLANPriorityTableNumber, userPassword=userPassword, transmitPower=transmitPower, pubStatsGroup=pubStatsGroup, installArmStateTrap=installArmStateTrap, ptpGroups=ptpGroups, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, ptpTraps=ptpTraps, ethernet=ethernet, telecom=telecom, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, cableLoss=cableLoss, dfsGroup=dfsGroup, sMTPServerPortNumber=sMTPServerPortNumber, antennaGain=antennaGain, constantPowerSpectralDensity=constantPowerSpectralDensity, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANManagementPriority=vLANManagementPriority, receiveFreqMHz=receiveFreqMHz, sMTPEmailAlert=sMTPEmailAlert, receivePower=receivePower, encryption=encryption, iPAddress=iPAddress, phyControl=phyControl, unitOutOfCalibration=unitOutOfCalibration, encryptionGroup=encryptionGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomGroup=telecomGroup, receiveDataRate=receiveDataRate, productVariant=productVariant, subnetMask=subnetMask, supplementaryGroup=supplementaryGroup, alarms=alarms, dfsTableIndex=dfsTableIndex, syslogStateTrap=syslogStateTrap, linkLoss=linkLoss, vectorError=vectorError, licenceGroup=licenceGroup, sntpGroup=sntpGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userTableNumber=userTableNumber, softwareVersion=softwareVersion, targetMACAddress=targetMACAddress, userTableIndex=userTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, userTable=userTable, phyStatus=phyStatus, productName=productName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsLineCode=telecomsLineCode, aAAControlGroup=aAAControlGroup, installStatus=installStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControl=aAAControl, accessMethod=accessMethod, telnetPortNumber=telnetPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, versionsGroup=versionsGroup, phyStatusGroup=phyStatusGroup, dfsTableNumber=dfsTableNumber, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsInterface=telecomsInterface, installStatusTrap=installStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPServerIPAddress=sMTPServerIPAddress, eIRP=eIRP, sNMPTrapTableEntry=sNMPTrapTableEntry, smtp=smtp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, channelBandwidth=channelBandwidth, sNTPState=sNTPState, byteErrorRatio=byteErrorRatio, aggregateDataRate=aggregateDataRate, telnetAccessEnabled=telnetAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatusTrap=dataPortStatusTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPCommunityString=sNMPCommunityString, tDDControl=tDDControl, PYSNMP_MODULE_ID=cambium, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, ptp=ptp, systemReset=systemReset, notificationsGroup=notificationsGroup, ptp500=ptp500, transmitFreqKHz=transmitFreqKHz, regionCodeTrap=regionCodeTrap, ethernetGroup=ethernetGroup, regionCode=regionCode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, gatewayIPAddress=gatewayIPAddress, sntp=sntp, dfsPeaks=dfsPeaks, dfsMeans=dfsMeans, transmitFreqMHz=transmitFreqMHz, syslogControlGroup=syslogControlGroup, telecomsCableLength=telecomsCableLength, telecomsChannelStatus=telecomsChannelStatus, receiveChannel=receiveChannel, ptmp=ptmp, sNTPPollInterval=sNTPPollInterval, altitude=altitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, remoteIPAddress=remoteIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, supplementary=supplementary, snmpControlGroup=snmpControlGroup, configurationGroup=configurationGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, range=range, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarmsGroup=alarmsGroup, timeZone=timeZone, dfs=dfs, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, configuration=configuration, vLANManagementVID=vLANManagementVID, phyControlGroup=phyControlGroup, syslogClient=syslogClient, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationMode=tDDSynchronizationMode, receiveModulationMode=receiveModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpCompliance=ptpCompliance, vLANPriorityTable=vLANPriorityTable, masterSlaveMode=masterSlaveMode, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, userName=userName, userTableEntry=userTableEntry, dataPortStatus=dataPortStatus, syslogControl=syslogControl, transmitChannel=transmitChannel, daylightSaving=daylightSaving, resetGroup=resetGroup, managementGroup=managementGroup, incompatibleRegionCodes=incompatibleRegionCodes, longitude=longitude, hTTPAccessEnabled=hTTPAccessEnabled, dataPortDisabledWarning=dataPortDisabledWarning, latitude=latitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, versions=versions, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTable=sNMPTrapTable, receiveModulationModeDetail=receiveModulationModeDetail, cambium=cambium, management=management, bandwidthVariant=bandwidthVariant, dfsTable=dfsTable, receiveFreqKHz=receiveFreqKHz, encryptionAlgorithm=encryptionAlgorithm, channelChangeTrap=channelChangeTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, systemClock=systemClock, tDDControlGroup=tDDControlGroup, groupID=groupID, sNMPPortNumber=sNMPPortNumber, hTTPSPortNumber=hTTPSPortNumber, syslogState=syslogState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, reset=reset, telecomsLoopback=telecomsLoopback, tFTPServerIPAddress=tFTPServerIPAddress, sNMPv3Enable=sNMPv3Enable, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPSync=sNTPSync, userEnabled=userEnabled, linkModeOptimisation=linkModeOptimisation, tFTPServerPortNumber=tFTPServerPortNumber, hardwareVersion=hardwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, hTTPPortNumber=hTTPPortNumber, linkSymmetry=linkSymmetry, sNMPEnabledTraps=sNMPEnabledTraps, userRole=userRole, smtpGroup=smtpGroup, sNTPLastSync=sNTPLastSync, licensedCapacity=licensedCapacity, sNMPTrapPortNumber=sNMPTrapPortNumber, frequencyVariant=frequencyVariant, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licence=licence, sNMPTrapVersion=sNMPTrapVersion, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, searchState=searchState, installArmState=installArmState, dataPortAutoMdix=dataPortAutoMdix)
