...
# Produced by pysmi-1.1.3 at Sun Nov 21 00:36:21 2021
...
Gauge32, Bits, Unsigned32, Counter64, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress, enterprises, MibIdentifier, Integer32, ModuleIdentity, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Bits", "Unsigned32", "Counter64", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress", "enterprises", "MibIdentifier", "Integer32", "ModuleIdentity", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveFreqMHz=receiveFreqMHz, alarms=alarms, aAAControlGroup=aAAControlGroup, userTableNumber=userTableNumber, telecomsInterface=telecomsInterface, ptpTraps=ptpTraps, encryption=encryption, tDDControlGroup=tDDControlGroup, systemReset=systemReset, installStatusTrap=installStatusTrap, eIRP=eIRP, groupID=groupID, vectorError=vectorError, hardwareVersion=hardwareVersion, snmpControl=snmpControl, vLANPriorityTable=vLANPriorityTable, regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, bootVersion=bootVersion, receiveChannel=receiveChannel, dfsTableIndex=dfsTableIndex, sNMPv3Enable=sNMPv3Enable, pubStats=pubStats, linkModeOptimisation=linkModeOptimisation, sMTPServerPortNumber=sMTPServerPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cableLoss=cableLoss, userTableEntry=userTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitDataRate=transmitDataRate, byteErrorRatio=byteErrorRatio, resetGroup=resetGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, aAAControl=aAAControl, ptp=ptp, dfsTableEntry=dfsTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, licence=licence, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortAutoMdix=dataPortAutoMdix, syslogControl=syslogControl, licenceGroup=licenceGroup, syslogState=syslogState, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, siteName=siteName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, PYSNMP_MODULE_ID=cambium, receiveDataRate=receiveDataRate, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementaryGroup=supplementaryGroup, dfsMeans=dfsMeans, telecomsLineCode=telecomsLineCode, smtp=smtp, sNMPEnabledTraps=sNMPEnabledTraps, aggregateDataRate=aggregateDataRate, longitude=longitude, tDDSynchronizationMode=tDDSynchronizationMode, syslogStateTrap=syslogStateTrap, tDDControl=tDDControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, reset=reset, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, management=management, channelBandwidth=channelBandwidth, systemClock=systemClock, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPLastSync=sNTPLastSync, dfs=dfs, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, targetMACAddress=targetMACAddress, searchState=searchState, secondarySoftwareVersion=secondarySoftwareVersion, encryptionAlgorithm=encryptionAlgorithm, transmitPower=transmitPower, linkName=linkName, userTable=userTable, remoteIPAddress=remoteIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, dfsTableNumber=dfsTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityString=sNMPCommunityString, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, gatewayIPAddress=gatewayIPAddress, phyControl=phyControl, incompatibleRegionCodes=incompatibleRegionCodes, telecomGroup=telecomGroup, dataPortStatus=dataPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPAddress=iPAddress, receiveFreqKHz=receiveFreqKHz, ptpTrapPrefix=ptpTrapPrefix, transmitModulationMode=transmitModulationMode, vLANPriorityTableNumber=vLANPriorityTableNumber, supplementary=supplementary, sNTPServerIPAddress=sNTPServerIPAddress, encryptionGroup=encryptionGroup, sntp=sntp, accessMethod=accessMethod, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelStatus=telecomsChannelStatus, range=range, telnetAccessEnabled=telnetAccessEnabled, transmitChannel=transmitChannel, userRole=userRole, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPPortNumber=sNMPPortNumber, versionsGroup=versionsGroup, pubStatsGroup=pubStatsGroup, productName=productName, dataPortDisabledWarning=dataPortDisabledWarning, antennaGain=antennaGain, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogClient=syslogClient, transmitFreqKHz=transmitFreqKHz, userEnabled=userEnabled, sMTPEmailAlert=sMTPEmailAlert, hTTPSPortNumber=hTTPSPortNumber, telnetPortNumber=telnetPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, sntpGroup=sntpGroup, receivePower=receivePower, vLANManagementPriority=vLANManagementPriority, ethernetGroup=ethernetGroup, unitOutOfCalibration=unitOutOfCalibration, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTableEntry=sNMPTrapTableEntry, telecom=telecom, vLANManagementVID=vLANManagementVID, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsPeaks=dfsPeaks, configuration=configuration, ethernet=ethernet, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetFiberSupport=ethernetFiberSupport, signalStrengthRatio=signalStrengthRatio, dataPortConfigurationMismatch=dataPortConfigurationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkSymmetry=linkSymmetry, linkLoss=linkLoss, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTable=sNMPTrapTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarmsGroup=alarmsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptp500=ptp500, cambium=cambium, sNTPState=sNTPState, ptmp=ptmp, versions=versions, smtpGroup=smtpGroup, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelChangeTrap=channelChangeTrap, dataPortStatusTrap=dataPortStatusTrap, daylightSaving=daylightSaving, notificationsGroup=notificationsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, frequencyVariant=frequencyVariant, sNTPSync=sNTPSync, userTableIndex=userTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, installArmStateTrap=installArmStateTrap, sNTPPollInterval=sNTPPollInterval, managementGroup=managementGroup, hTTPPortNumber=hTTPPortNumber, dfsGroup=dfsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapVersion=sNMPTrapVersion, timeZone=timeZone, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installArmState=installArmState, maximumTransmitPower=maximumTransmitPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installStatus=installStatus, transmitFreqMHz=transmitFreqMHz, syslogClientTrap=syslogClientTrap, phyControlGroup=phyControlGroup, syslogControlGroup=syslogControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, subnetMask=subnetMask, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapPortNumber=sNMPTrapPortNumber, snmpControlGroup=snmpControlGroup, bandwidthVariant=bandwidthVariant, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, altitude=altitude, ptpCompliance=ptpCompliance, licensedCapacity=licensedCapacity, phyStatus=phyStatus, phyStatusGroup=phyStatusGroup, dfsTable=dfsTable, ptpGroups=ptpGroups, telecomsCableLength=telecomsCableLength, userName=userName, softwareVersion=softwareVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPAccessEnabled=hTTPAccessEnabled, userPassword=userPassword, latitude=latitude, telecomsLoopback=telecomsLoopback)
