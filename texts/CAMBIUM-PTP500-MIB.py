...
Gauge32, enterprises, ModuleIdentity, Bits, NotificationType, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Unsigned32, iso, IpAddress, MibIdentifier, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "ModuleIdentity", "Bits", "NotificationType", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Unsigned32", "iso", "IpAddress", "MibIdentifier", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPSPortNumber=hTTPSPortNumber, targetMACAddress=targetMACAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimisation=linkModeOptimisation, telnetPortNumber=telnetPortNumber, dfsTableEntry=dfsTableEntry, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatus=dataPortStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControlGroup=phyControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, receiveDataRate=receiveDataRate, userTableEntry=userTableEntry, ptpTrapPrefix=ptpTrapPrefix, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, managementGroup=managementGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, hardwareVersion=hardwareVersion, dfs=dfs, dataPortDisabledWarning=dataPortDisabledWarning, aAAControl=aAAControl, sNMPv3Enable=sNMPv3Enable, pubStatsGroup=pubStatsGroup, channelChangeTrap=channelChangeTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPPollInterval=sNTPPollInterval, transmitDataRate=transmitDataRate, reset=reset, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp500=ptp500, transmitModulationMode=transmitModulationMode, siteName=siteName, vLANPriorityTableNumber=vLANPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, groupID=groupID, licensedCapacity=licensedCapacity, hTTPPortNumber=hTTPPortNumber, sntpGroup=sntpGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, userTableIndex=userTableIndex, searchState=searchState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, range=range, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtp=smtp, sMTPEmailAlert=sMTPEmailAlert, installArmState=installArmState, resetGroup=resetGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableIndex=dfsTableIndex, antennaGain=antennaGain, pubStats=pubStats, ethernetGroup=ethernetGroup, installStatus=installStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, userTable=userTable, sNTPServerPortNumber=sNTPServerPortNumber, regionCodeTrap=regionCodeTrap, installStatusTrap=installStatusTrap, accessMethod=accessMethod, ethernet=ethernet, encryption=encryption, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsInterface=telecomsInterface, dfsMeans=dfsMeans, transmitPower=transmitPower, syslogState=syslogState, versions=versions, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkName=linkName, sntp=sntp, altitude=altitude, installArmStateTrap=installArmStateTrap, ptpTraps=ptpTraps, softwareVersion=softwareVersion, systemClock=systemClock, ptp=ptp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtpGroup=smtpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, transmitChannel=transmitChannel, ethernetFiberSupport=ethernetFiberSupport, productName=productName, subnetMask=subnetMask, sNTPSync=sNTPSync, aggregateDataRate=aggregateDataRate, telecomsChannelStatus=telecomsChannelStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, byteErrorRatio=byteErrorRatio, regionCode=regionCode, userTableNumber=userTableNumber, tDDControlGroup=tDDControlGroup, unitOutOfCalibration=unitOutOfCalibration, dfsGroup=dfsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, secondarySoftwareVersion=secondarySoftwareVersion, licenceGroup=licenceGroup, vLANManagementVID=vLANManagementVID, eIRP=eIRP, PYSNMP_MODULE_ID=cambium, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsPeaks=dfsPeaks, ptmp=ptmp, syslogStateTrap=syslogStateTrap, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, frequencyVariant=frequencyVariant, licence=licence, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleRegionCodes=incompatibleRegionCodes, receivePower=receivePower, alarms=alarms, telecom=telecom, vectorError=vectorError, vLANPriorityTable=vLANPriorityTable, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving, wirelessLinkAvailability=wirelessLinkAvailability, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPEnabledMessages=sMTPEnabledMessages, longitude=longitude, syslogControl=syslogControl, encryptionGroup=encryptionGroup, systemReset=systemReset, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogClient=syslogClient, hTTPSAccessEnabled=hTTPSAccessEnabled, userEnabled=userEnabled, capacityLicenseMismatch=capacityLicenseMismatch, userPassword=userPassword, phyStatus=phyStatus, supplementary=supplementary, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, linkLoss=linkLoss, receiveFreqKHz=receiveFreqKHz, maximumTransmitPower=maximumTransmitPower, dfsTable=dfsTable, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, timeZone=timeZone, ptpCompliance=ptpCompliance, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogControlGroup=syslogControlGroup, bootVersion=bootVersion, syslogClientTrap=syslogClientTrap, userName=userName, snmpControl=snmpControl, signalStrengthRatio=signalStrengthRatio, management=management, tDDControl=tDDControl, userRole=userRole, bandwidthVariant=bandwidthVariant, sNTPState=sNTPState, transmitFreqMHz=transmitFreqMHz, ptpGroups=ptpGroups, sNMPTrapPortNumber=sNMPTrapPortNumber, encryptionAlgorithm=encryptionAlgorithm, cambium=cambium, telecomsLineCode=telecomsLineCode, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPSyncTrap=sNTPSyncTrap, productVariant=productVariant, dfsTableNumber=dfsTableNumber, sNMPCommunityString=sNMPCommunityString, configuration=configuration, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerPortNumber=tFTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, cableLoss=cableLoss, configurationGroup=configurationGroup, sNMPTrapVersion=sNMPTrapVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqMHz=receiveFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, telnetAccessEnabled=telnetAccessEnabled, sNMPPortNumber=sNMPPortNumber, telecomsCableLength=telecomsCableLength, telecomGroup=telecomGroup, telecomsLoopback=telecomsLoopback, constantPowerSpectralDensity=constantPowerSpectralDensity, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, gatewayIPAddress=gatewayIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortStatusTrap=dataPortStatusTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkSymmetry=linkSymmetry, aAAControlGroup=aAAControlGroup, iPAddress=iPAddress, notificationsGroup=notificationsGroup, sNMPTrapTable=sNMPTrapTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControl=phyControl, latitude=latitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, remoteIPAddress=remoteIPAddress, sNTPServerIPAddress=sNTPServerIPAddress)
