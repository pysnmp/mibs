...
iso, ModuleIdentity, NotificationType, enterprises, ObjectIdentity, Counter64, Bits, Unsigned32, MibIdentifier, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "NotificationType", "enterprises", "ObjectIdentity", "Counter64", "Bits", "Unsigned32", "MibIdentifier", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitPower=transmitPower, tDDControl=tDDControl, versions=versions, licence=licence, useVLANForManagementInterfaces=useVLANForManagementInterfaces, PYSNMP_MODULE_ID=cambium, sNMPPortNumber=sNMPPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableNumber=userTableNumber, hTTPPortNumber=hTTPPortNumber, aAAControl=aAAControl, management=management, gatewayIPAddress=gatewayIPAddress, telecomsChannelStatus=telecomsChannelStatus, receivePower=receivePower, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPPollInterval=sNTPPollInterval, userRole=userRole, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomGroup=telecomGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, alarms=alarms, sNMPCommunityString=sNMPCommunityString, licenceGroup=licenceGroup, sNMPTrapVersion=sNMPTrapVersion, systemReset=systemReset, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortAutoMdix=dataPortAutoMdix, sMTPServerPortNumber=sMTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, antennaGain=antennaGain, receiveChannel=receiveChannel, sNTPState=sNTPState, sNTPServerIPAddress=sNTPServerIPAddress, byteErrorRatio=byteErrorRatio, linkLoss=linkLoss, encryption=encryption, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, resetGroup=resetGroup, userName=userName, receiveModulationMode=receiveModulationMode, signalStrengthRatio=signalStrengthRatio, sntp=sntp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsPeaks=dfsPeaks, aggregateDataRate=aggregateDataRate, frequencyVariant=frequencyVariant, timeZone=timeZone, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsCableLength=telecomsCableLength, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPv3Enable=sNMPv3Enable, pubStatsGroup=pubStatsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, altitude=altitude, licensedCapacity=licensedCapacity, tDDControlGroup=tDDControlGroup, dfsTableIndex=dfsTableIndex, channelBandwidth=channelBandwidth, installStatusTrap=installStatusTrap, telecomsLineCode=telecomsLineCode, installArmState=installArmState, notificationsGroup=notificationsGroup, cambium=cambium, supplementary=supplementary, productVariant=productVariant, receiveFreqMHz=receiveFreqMHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitFreqMHz=transmitFreqMHz, syslogControlGroup=syslogControlGroup, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp500=ptp500, eIRP=eIRP, systemClock=systemClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogState=syslogState, dataPortDisabledWarning=dataPortDisabledWarning, iPAddress=iPAddress, tFTPServerIPAddress=tFTPServerIPAddress, transmitChannel=transmitChannel, targetMACAddress=targetMACAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetPortNumber=telnetPortNumber, aAAControlGroup=aAAControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerIPAddress=sMTPServerIPAddress, snmpControl=snmpControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableNumber=dfsTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, siteName=siteName, hTTPSPortNumber=hTTPSPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, longitude=longitude, remoteIPAddress=remoteIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, supplementaryGroup=supplementaryGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, latitude=latitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControlGroup=phyControlGroup, userTableIndex=userTableIndex, range=range, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsMeans=dfsMeans, ptmp=ptmp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bootVersion=bootVersion, syslogStateTrap=syslogStateTrap, reset=reset, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, bandwidthVariant=bandwidthVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsGroup=dfsGroup, versionsGroup=versionsGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptp=ptp, subnetMask=subnetMask, dfs=dfs, phyControl=phyControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, softwareVersion=softwareVersion, syslogClient=syslogClient, syslogClientTrap=syslogClientTrap, smtpGroup=smtpGroup, incompatibleRegionCodes=incompatibleRegionCodes, telecomsInterface=telecomsInterface, encryptionGroup=encryptionGroup, dfsTable=dfsTable, channelChangeTrap=channelChangeTrap, maximumTransmitPower=maximumTransmitPower, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, userPassword=userPassword, installArmStateTrap=installArmStateTrap, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTable=userTable, sMTPEnabledMessages=sMTPEnabledMessages, linkName=linkName, regionCode=regionCode, noWirelessChannelAvailable=noWirelessChannelAvailable, smtp=smtp, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveDataRate=receiveDataRate, masterSlaveMode=masterSlaveMode, ethernet=ethernet, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, daylightSaving=daylightSaving, vLANManagementVID=vLANManagementVID, snmpControlGroup=snmpControlGroup, sNTPSync=sNTPSync, syslogControl=syslogControl, phyStatusGroup=phyStatusGroup, regionCodeTrap=regionCodeTrap, vLANManagementPriority=vLANManagementPriority, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, configurationGroup=configurationGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, userEnabled=userEnabled, transmitDataRate=transmitDataRate, alarmsGroup=alarmsGroup, linkModeOptimisation=linkModeOptimisation, unitOutOfCalibration=unitOutOfCalibration, phyStatus=phyStatus, hardwareVersion=hardwareVersion, vectorError=vectorError, telecom=telecom, capacityLicenseMismatch=capacityLicenseMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, groupID=groupID, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetGroup=ethernetGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, sMTPEmailAlert=sMTPEmailAlert, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatus=wirelessLinkStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsLoopback=telecomsLoopback, accessMethod=accessMethod, ptpCompliance=ptpCompliance, installStatus=installStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpTraps=ptpTraps, sNTPSyncTrap=sNTPSyncTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationMode=tDDSynchronizationMode, hTTPAccessEnabled=hTTPAccessEnabled, vLANPriorityTableEntry=vLANPriorityTableEntry, searchState=searchState, transmitModulationMode=transmitModulationMode, vLANPriorityTable=vLANPriorityTable, managementGroup=managementGroup, configuration=configuration, telnetAccessEnabled=telnetAccessEnabled, sntpGroup=sntpGroup, ptpGroups=ptpGroups, productName=productName, linkSymmetry=linkSymmetry)
