...
Integer32, IpAddress, Bits, Counter64, ObjectIdentity, TimeTicks, NotificationType, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Gauge32, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "Bits", "Counter64", "ObjectIdentity", "TimeTicks", "NotificationType", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Gauge32", "enterprises", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", targetMACAddress=targetMACAddress, sntp=sntp, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitFreqKHz=transmitFreqKHz, licenceGroup=licenceGroup, ptpTrapPrefix=ptpTrapPrefix, pubStats=pubStats, installStatus=installStatus, transmitDataRate=transmitDataRate, userPassword=userPassword, sNMPEnabledTraps=sNMPEnabledTraps, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, installArmStateTrap=installArmStateTrap, receiveModulationMode=receiveModulationMode, configuration=configuration, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hardwareVersion=hardwareVersion, bootVersion=bootVersion, ptmp=ptmp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userRole=userRole, hTTPSAccessEnabled=hTTPSAccessEnabled, sntpGroup=sntpGroup, snmpControl=snmpControl, dfsTableEntry=dfsTableEntry, installStatusTrap=installStatusTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogClientTrap=syslogClientTrap, latitude=latitude, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDControlGroup=tDDControlGroup, regionCode=regionCode, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetGroup=ethernetGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, remoteIPAddress=remoteIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, hTTPSPortNumber=hTTPSPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, configurationGroup=configurationGroup, userTable=userTable, supplementaryGroup=supplementaryGroup, subnetMask=subnetMask, syslogLocalWrappedTrap=syslogLocalWrappedTrap, groupID=groupID, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp=ptp, linkName=linkName, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationMode=tDDSynchronizationMode, byteErrorRatio=byteErrorRatio, alarmsGroup=alarmsGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, timeZone=timeZone, productVariant=productVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installArmState=installArmState, ptpTraps=ptpTraps, hTTPPortNumber=hTTPPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, antennaGain=antennaGain, sNMPCommunityString=sNMPCommunityString, ethernet=ethernet, dfsPeaks=dfsPeaks, range=range, channelBandwidth=channelBandwidth, supplementary=supplementary, smtp=smtp, ptpCompliance=ptpCompliance, transmitModulationMode=transmitModulationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, telnetPortNumber=telnetPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, linkModeOptimisation=linkModeOptimisation, userTableEntry=userTableEntry, searchState=searchState, receiveFreqKHz=receiveFreqKHz, receiveModulationModeDetail=receiveModulationModeDetail, vLANPriorityTable=vLANPriorityTable, userName=userName, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecom=telecom, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsInterface=telecomsInterface, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, resetGroup=resetGroup, telecomsChannelStatus=telecomsChannelStatus, licence=licence, capacityLicenseMismatch=capacityLicenseMismatch, sMTPServerIPAddress=sMTPServerIPAddress, dataPortStatus=dataPortStatus, frequencyVariant=frequencyVariant, vLANPriorityTableNumber=vLANPriorityTableNumber, dfs=dfs, receiveChannel=receiveChannel, transmitChannel=transmitChannel, longitude=longitude, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, snmpControlGroup=snmpControlGroup, sNTPSync=sNTPSync, alarms=alarms, iPAddress=iPAddress, PYSNMP_MODULE_ID=cambium, encryptionGroup=encryptionGroup, sNMPTrapTable=sNMPTrapTable, notificationsGroup=notificationsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, phyControlGroup=phyControlGroup, vectorError=vectorError, licensedCapacity=licensedCapacity, encryptionAlgorithm=encryptionAlgorithm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTable=dfsTable, sNTPPollInterval=sNTPPollInterval, receiveFreqMHz=receiveFreqMHz, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableIndex=userTableIndex, pubStatsGroup=pubStatsGroup, systemClock=systemClock, dfsTableNumber=dfsTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, ptp500=ptp500, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userTableNumber=userTableNumber, tDDControl=tDDControl, dfsGroup=dfsGroup, productName=productName, wirelessLinkAvailability=wirelessLinkAvailability, altitude=altitude, maximumTransmitPower=maximumTransmitPower, telecomsLoopback=telecomsLoopback, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogControl=syslogControl, gatewayIPAddress=gatewayIPAddress, linkSymmetry=linkSymmetry, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userEnabled=userEnabled, dfsMeans=dfsMeans, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyStatus=phyStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aggregateDataRate=aggregateDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPv3Enable=sNMPv3Enable, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, daylightSaving=daylightSaving, receiveDataRate=receiveDataRate, sNTPLastSync=sNTPLastSync, syslogClient=syslogClient, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEnabledMessages=sMTPEnabledMessages, accessMethod=accessMethod, eIRP=eIRP, sNTPState=sNTPState, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, regionCodeTrap=regionCodeTrap, sNMPTrapVersion=sNMPTrapVersion, vLANPriorityTableIndex=vLANPriorityTableIndex, channelChangeTrap=channelChangeTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, dataPortStatusTrap=dataPortStatusTrap, cableLoss=cableLoss, signalStrengthRatio=signalStrengthRatio, receivePower=receivePower, unitOutOfCalibration=unitOutOfCalibration, dfsTableIndex=dfsTableIndex, reset=reset, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpGroups=ptpGroups, telecomsLineCode=telecomsLineCode, bandwidthVariant=bandwidthVariant, versions=versions, versionsGroup=versionsGroup, systemReset=systemReset, softwareVersion=softwareVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControlGroup=aAAControlGroup, masterSlaveMode=masterSlaveMode, syslogControlGroup=syslogControlGroup, sNMPPortNumber=sNMPPortNumber, management=management, vLANManagementPriority=vLANManagementPriority, managementGroup=managementGroup, syslogStateTrap=syslogStateTrap, telecomsCableLength=telecomsCableLength, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogState=syslogState, telecomGroup=telecomGroup, hTTPAccessEnabled=hTTPAccessEnabled, phyStatusGroup=phyStatusGroup, aAAControl=aAAControl, sNMPTrapPortNumber=sNMPTrapPortNumber, encryption=encryption)
