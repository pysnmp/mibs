...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", phyStatus=phyStatus, timeZone=timeZone, dataPortStatus=dataPortStatus, aggregateDataRate=aggregateDataRate, accessMethod=accessMethod, telnetPortNumber=telnetPortNumber, receiveModulationMode=receiveModulationMode, telecomsChannelStatus=telecomsChannelStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmState=installArmState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsCableLength=telecomsCableLength, ethernet=ethernet, sNMPTrapVersion=sNMPTrapVersion, telecomGroup=telecomGroup, transmitPower=transmitPower, productName=productName, transmitFreqKHz=transmitFreqKHz, masterSlaveMode=masterSlaveMode, sMTPServerPortNumber=sMTPServerPortNumber, regionCodeTrap=regionCodeTrap, dfs=dfs, vLANManagementPriority=vLANManagementPriority, receiveChannel=receiveChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, smtpGroup=smtpGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatusTrap=dataPortStatusTrap, sntpGroup=sntpGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, resetGroup=resetGroup, sNTPServerIPAddress=sNTPServerIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, configuration=configuration, linkSymmetry=linkSymmetry, userName=userName, sNTPPollInterval=sNTPPollInterval, dfsTable=dfsTable, telecomsLineCode=telecomsLineCode, hardwareVersion=hardwareVersion, installStatus=installStatus, encryptionAlgorithm=encryptionAlgorithm, searchState=searchState, hTTPSAccessEnabled=hTTPSAccessEnabled, constantPowerSpectralDensity=constantPowerSpectralDensity, latitude=latitude, ptpCompliance=ptpCompliance, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, sNTPLastSync=sNTPLastSync, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityQueueMapping=vLANPriorityQueueMapping, versions=versions, ptp=ptp, remoteMaximumTransmitPower=remoteMaximumTransmitPower, PYSNMP_MODULE_ID=cambium, siteName=siteName, hTTPAccessEnabled=hTTPAccessEnabled, userPassword=userPassword, hTTPPortNumber=hTTPPortNumber, sNMPCommunityString=sNMPCommunityString, daylightSaving=daylightSaving, supplementary=supplementary, linkName=linkName, bandwidthVariant=bandwidthVariant, transmitChannel=transmitChannel, linkModeOptimisation=linkModeOptimisation, syslogState=syslogState, tFTPServerIPAddress=tFTPServerIPAddress, managementGroup=managementGroup, groupID=groupID, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aAAControl=aAAControl, ethernetFiberSupport=ethernetFiberSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, targetMACAddress=targetMACAddress, sNMPEnabledTraps=sNMPEnabledTraps, reset=reset, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogClient=syslogClient, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANPriorityTableIndex=vLANPriorityTableIndex, receivePower=receivePower, telecomsInterface=telecomsInterface, ptpTrapPrefix=ptpTrapPrefix, bootVersion=bootVersion, telnetAccessEnabled=telnetAccessEnabled, userEnabled=userEnabled, dfsMeans=dfsMeans, capacityLicenseMismatch=capacityLicenseMismatch, sNTPSync=sNTPSync, userRole=userRole, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userTableNumber=userTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sntp=sntp, phyControl=phyControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, subnetMask=subnetMask, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, softwareVersion=softwareVersion, encryption=encryption, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPServerPortNumber=sNTPServerPortNumber, pubStats=pubStats, sMTPEmailAlert=sMTPEmailAlert, ptmp=ptmp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCode=regionCode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, incompatibleRegionCodes=incompatibleRegionCodes, channelChangeTrap=channelChangeTrap, dfsGroup=dfsGroup, aAAControlGroup=aAAControlGroup, systemClock=systemClock, syslogControl=syslogControl, systemReset=systemReset, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecom=telecom, tDDControl=tDDControl, vectorError=vectorError, phyControlGroup=phyControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, eIRP=eIRP, cableLoss=cableLoss, sNTPState=sNTPState, installStatusTrap=installStatusTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, telecomsLoopback=telecomsLoopback, receiveFreqMHz=receiveFreqMHz, syslogClientTrap=syslogClientTrap, vLANManagementVID=vLANManagementVID, tDDControlGroup=tDDControlGroup, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortAutoMdix=dataPortAutoMdix, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPAddress=iPAddress, transmitDataRate=transmitDataRate, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, sNMPPortNumber=sNMPPortNumber, sNTPSyncTrap=sNTPSyncTrap, receiveFreqKHz=receiveFreqKHz, smtp=smtp, userTableIndex=userTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, antennaGain=antennaGain, snmpControl=snmpControl, syslogControlGroup=syslogControlGroup, licence=licence, dataPortConfigurationMismatch=dataPortConfigurationMismatch, longitude=longitude, versionsGroup=versionsGroup, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, ptp500=ptp500, snmpControlGroup=snmpControlGroup, altitude=altitude, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTable=vLANPriorityTable, vLANPriorityTableEntry=vLANPriorityTableEntry, encryptionGroup=encryptionGroup, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTableEntry=dfsTableEntry, alarmsGroup=alarmsGroup, ptpGroups=ptpGroups, receiveDataRate=receiveDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, dfsPeaks=dfsPeaks, dataPortDisabledWarning=dataPortDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, cambium=cambium, management=management, phyStatusGroup=phyStatusGroup, syslogStateTrap=syslogStateTrap, userTable=userTable, linkLoss=linkLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTable=sNMPTrapTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, unitOutOfCalibration=unitOutOfCalibration, maximumTransmitPower=maximumTransmitPower, productVariant=productVariant, tDDSynchronizationMode=tDDSynchronizationMode, ethernetGroup=ethernetGroup, supplementaryGroup=supplementaryGroup, range=range, dfsTableNumber=dfsTableNumber, alarms=alarms, pubStatsGroup=pubStatsGroup, configurationGroup=configurationGroup, frequencyVariant=frequencyVariant, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup)
