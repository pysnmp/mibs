...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:20:53 2021
...
NotificationType, ModuleIdentity, ObjectIdentity, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, Counter64, IpAddress, Counter32, MibIdentifier, Bits, enterprises, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "Counter64", "IpAddress", "Counter32", "MibIdentifier", "Bits", "enterprises", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptp500=ptp500, range=range, telecomsChannelStatusTrap=telecomsChannelStatusTrap, latitude=latitude, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleMasterAndSlave=incompatibleMasterAndSlave, searchState=searchState, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsChannelStatus=telecomsChannelStatus, vectorError=vectorError, hardwareVersion=hardwareVersion, targetMACAddress=targetMACAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, productVariant=productVariant, systemReset=systemReset, cambium=cambium, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableEntry=dfsTableEntry, vLANManagementPriority=vLANManagementPriority, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sntp=sntp, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogControlGroup=syslogControlGroup, alarmsGroup=alarmsGroup, productName=productName, unitOutOfCalibration=unitOutOfCalibration, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, configuration=configuration, aAAControl=aAAControl, syslogState=syslogState, dataPortStatus=dataPortStatus, regionCodeTrap=regionCodeTrap, byteErrorRatio=byteErrorRatio, tDDControlGroup=tDDControlGroup, cableLoss=cableLoss, altitude=altitude, installArmStateTrap=installArmStateTrap, alarms=alarms, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, supplementary=supplementary, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkStatus=wirelessLinkStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, accessMethod=accessMethod, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsLoopbackTrap=telecomsLoopbackTrap, iPAddress=iPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapVersion=sNMPTrapVersion, telecomsInterface=telecomsInterface, sNMPTrapTableIndex=sNMPTrapTableIndex, masterSlaveMode=masterSlaveMode, supplementaryGroup=supplementaryGroup, installArmState=installArmState, frequencyVariant=frequencyVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimisation=linkModeOptimisation, syslogControl=syslogControl, gatewayIPAddress=gatewayIPAddress, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpCompliance=ptpCompliance, receiveModulationModeDetail=receiveModulationModeDetail, syslogStateTrap=syslogStateTrap, managementGroup=managementGroup, installStatusTrap=installStatusTrap, licence=licence, regionCode=regionCode, linkSymmetry=linkSymmetry, snmpControl=snmpControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveModulationMode=receiveModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, linkName=linkName, receiveFreqKHz=receiveFreqKHz, sNTPSync=sNTPSync, encryptionAlgorithm=encryptionAlgorithm, hTTPPortNumber=hTTPPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, antennaGain=antennaGain, dfsTable=dfsTable, sNTPPollInterval=sNTPPollInterval, sMTPServerIPAddress=sMTPServerIPAddress, telnetPortNumber=telnetPortNumber, siteName=siteName, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, userRole=userRole, ethernetFiberSupport=ethernetFiberSupport, remoteIPAddress=remoteIPAddress, userTableNumber=userTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, smtp=smtp, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, management=management, sNTPState=sNTPState, configurationGroup=configurationGroup, transmitModulationMode=transmitModulationMode, phyStatus=phyStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyControl=phyControl, dfsGroup=dfsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, licensedCapacity=licensedCapacity, receiveFreqMHz=receiveFreqMHz, telecom=telecom, sNMPv3Enable=sNMPv3Enable, transmitDataRate=transmitDataRate, tDDControl=tDDControl, sMTPEnabledMessages=sMTPEnabledMessages, sntpGroup=sntpGroup, sNMPCommunityString=sNMPCommunityString, snmpControlGroup=snmpControlGroup, bandwidthVariant=bandwidthVariant, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTable=sNMPTrapTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodes=incompatibleRegionCodes, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitPower=transmitPower, aggregateDataRate=aggregateDataRate, syslogClient=syslogClient, transmitFreqKHz=transmitFreqKHz, longitude=longitude, vLANManagementVID=vLANManagementVID, channelBandwidth=channelBandwidth, signalStrengthRatio=signalStrengthRatio, phyControlGroup=phyControlGroup, timeZone=timeZone, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelChangeTrap=channelChangeTrap, daylightSaving=daylightSaving, installStatus=installStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, reset=reset, receiveChannel=receiveChannel, notificationsGroup=notificationsGroup, tDDSynchronizationMode=tDDSynchronizationMode, receivePower=receivePower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenceGroup=licenceGroup, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANPriorityTableEntry=vLANPriorityTableEntry, versionsGroup=versionsGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, softwareVersion=softwareVersion, groupID=groupID, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, encryption=encryption, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableNumber=dfsTableNumber, receiveDataRate=receiveDataRate, userPassword=userPassword, userTableEntry=userTableEntry, dataPortStatusTrap=dataPortStatusTrap, dfsMeans=dfsMeans, ptmp=ptmp, bootVersion=bootVersion, wirelessLinkAvailability=wirelessLinkAvailability, sNTPLastSync=sNTPLastSync, eIRP=eIRP, ptpTraps=ptpTraps, sMTPEmailAlert=sMTPEmailAlert, ptp=ptp, subnetMask=subnetMask, versions=versions, userEnabled=userEnabled, ptpTrapPrefix=ptpTrapPrefix, linkLoss=linkLoss, tDDSynchronizationAlarm=tDDSynchronizationAlarm, systemClock=systemClock, secondarySoftwareVersion=secondarySoftwareVersion, ethernet=ethernet, smtpGroup=smtpGroup, pubStats=pubStats, telecomsCableLength=telecomsCableLength, telecomGroup=telecomGroup, transmitChannel=transmitChannel, userTableIndex=userTableIndex, maximumTransmitPower=maximumTransmitPower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryptionGroup=encryptionGroup, hTTPAccessEnabled=hTTPAccessEnabled, dataPortDisabledWarning=dataPortDisabledWarning, dfsTableIndex=dfsTableIndex, tFTPServerPortNumber=tFTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANPriorityTable=vLANPriorityTable, pubStatsGroup=pubStatsGroup, telnetAccessEnabled=telnetAccessEnabled, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, aAAControlGroup=aAAControlGroup, userTable=userTable, syslogClientTrap=syslogClientTrap, userName=userName, dfs=dfs, telecomsLoopback=telecomsLoopback, telecomsLineCode=telecomsLineCode, phyStatusGroup=phyStatusGroup, resetGroup=resetGroup, sNMPEnabledTraps=sNMPEnabledTraps, PYSNMP_MODULE_ID=cambium, dfsPeaks=dfsPeaks)
