...
ObjectIdentity, IpAddress, Bits, Integer32, iso, Counter32, ModuleIdentity, Counter64, Unsigned32, TimeTicks, Gauge32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Bits", "Integer32", "iso", "Counter32", "ModuleIdentity", "Counter64", "Unsigned32", "TimeTicks", "Gauge32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortAutoMdix=dataPortAutoMdix, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogControlGroup=syslogControlGroup, linkLoss=linkLoss, transmitFreqKHz=transmitFreqKHz, pubStatsGroup=pubStatsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveModulationMode=receiveModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, regionCode=regionCode, receiveModulationModeDetail=receiveModulationModeDetail, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, userTableEntry=userTableEntry, hTTPSPortNumber=hTTPSPortNumber, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, configurationGroup=configurationGroup, targetMACAddress=targetMACAddress, timeZone=timeZone, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityTableNumber=vLANPriorityTableNumber, byteErrorRatio=byteErrorRatio, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimisation=linkModeOptimisation, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsLoopback=telecomsLoopback, telecomsLoopbackTrap=telecomsLoopbackTrap, PYSNMP_MODULE_ID=cambium, vLANManagementVID=vLANManagementVID, licenceGroup=licenceGroup, phyControlGroup=phyControlGroup, bootVersion=bootVersion, snmpControl=snmpControl, ptpCompliance=ptpCompliance, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, versions=versions, softwareVersion=softwareVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANPriorityTableIndex=vLANPriorityTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTable=sNMPTrapTable, range=range, telnetPortNumber=telnetPortNumber, userTableIndex=userTableIndex, latitude=latitude, telecomsCableLength=telecomsCableLength, sNTPServerPortNumber=sNTPServerPortNumber, syslogControl=syslogControl, channelBandwidth=channelBandwidth, configuration=configuration, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortStatus=dataPortStatus, phyControl=phyControl, antennaGain=antennaGain, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, cableLoss=cableLoss, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkName=linkName, supplementary=supplementary, transmitChannel=transmitChannel, managementGroup=managementGroup, ptp=ptp, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptpGroups=ptpGroups, sNTPState=sNTPState, sMTPServerIPAddress=sMTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, wirelessLinkStatus=wirelessLinkStatus, regionCodeTrap=regionCodeTrap, installArmState=installArmState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, management=management, userPassword=userPassword, ethernetFiberSupport=ethernetFiberSupport, dfsPeaks=dfsPeaks, alarmsGroup=alarmsGroup, receiveFreqMHz=receiveFreqMHz, sNTPSync=sNTPSync, dataPortStatusTrap=dataPortStatusTrap, licensedCapacity=licensedCapacity, receivePower=receivePower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, capacityLicenseMismatch=capacityLicenseMismatch, userTable=userTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vectorError=vectorError, sntpGroup=sntpGroup, aggregateDataRate=aggregateDataRate, vLANPriorityTable=vLANPriorityTable, telecomsInterface=telecomsInterface, ptpTraps=ptpTraps, searchState=searchState, userTableNumber=userTableNumber, dfsTableEntry=dfsTableEntry, resetGroup=resetGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtpGroup=smtpGroup, encryptionGroup=encryptionGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sntp=sntp, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, syslogClient=syslogClient, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userName=userName, syslogStateTrap=syslogStateTrap, dfsTable=dfsTable, groupID=groupID, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPv3Enable=sNMPv3Enable, systemReset=systemReset, masterSlaveMode=masterSlaveMode, incompatibleRegionCodes=incompatibleRegionCodes, versionsGroup=versionsGroup, userEnabled=userEnabled, ptmp=ptmp, dfsTableIndex=dfsTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, unitOutOfCalibration=unitOutOfCalibration, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTrapPrefix=ptpTrapPrefix, receiveFreqKHz=receiveFreqKHz, ethernetGroup=ethernetGroup, dfsMeans=dfsMeans, bandwidthVariant=bandwidthVariant, ptp500=ptp500, alarms=alarms, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerPortNumber=sMTPServerPortNumber, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, encryption=encryption, dfsGroup=dfsGroup, subnetMask=subnetMask, signalStrengthRatio=signalStrengthRatio, productVariant=productVariant, telecomGroup=telecomGroup, daylightSaving=daylightSaving, altitude=altitude, vLANPriorityTableEntry=vLANPriorityTableEntry, linkSymmetry=linkSymmetry, wirelessLinkAvailability=wirelessLinkAvailability, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecom=telecom, telecomsLineCode=telecomsLineCode, sNMPTrapVersion=sNMPTrapVersion, longitude=longitude, aAAControl=aAAControl, iPAddress=iPAddress, telecomsChannelStatus=telecomsChannelStatus, productName=productName, gatewayIPAddress=gatewayIPAddress, accessMethod=accessMethod, systemClock=systemClock, tDDControl=tDDControl, receiveDataRate=receiveDataRate, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitDataRate=transmitDataRate, aAAControlGroup=aAAControlGroup, userRole=userRole, remoteIPAddress=remoteIPAddress, transmitPower=transmitPower, eIRP=eIRP, snmpControlGroup=snmpControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogState=syslogState, siteName=siteName, installStatusTrap=installStatusTrap, reset=reset, notificationsGroup=notificationsGroup, sNMPCommunityString=sNMPCommunityString, syslogClientTrap=syslogClientTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hardwareVersion=hardwareVersion, supplementaryGroup=supplementaryGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, smtp=smtp, tDDControlGroup=tDDControlGroup, sNTPPollInterval=sNTPPollInterval, licence=licence, sNTPSyncTrap=sNTPSyncTrap, dfs=dfs, installArmStateTrap=installArmStateTrap, cambium=cambium, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveChannel=receiveChannel, sNTPLastSync=sNTPLastSync, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, ethernet=ethernet)
