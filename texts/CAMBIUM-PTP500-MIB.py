...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, TimeTicks, iso, IpAddress, NotificationType, ModuleIdentity, Bits, MibIdentifier, Integer32, Gauge32, enterprises, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "TimeTicks", "iso", "IpAddress", "NotificationType", "ModuleIdentity", "Bits", "MibIdentifier", "Integer32", "Gauge32", "enterprises", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDControlGroup=tDDControlGroup, telecomsLineCode=telecomsLineCode, receiveModulationModeDetail=receiveModulationModeDetail, installStatus=installStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveModulationMode=receiveModulationMode, sNMPTrapTable=sNMPTrapTable, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogClient=syslogClient, productName=productName, receiveFreqMHz=receiveFreqMHz, searchState=searchState, altitude=altitude, sNTPServerIPAddress=sNTPServerIPAddress, installStatusTrap=installStatusTrap, phyStatus=phyStatus, management=management, encryptionAlgorithm=encryptionAlgorithm, userTableNumber=userTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, configuration=configuration, iPAddress=iPAddress, phyControl=phyControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteIPAddress=remoteIPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, encryption=encryption, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqMHz=transmitFreqMHz, bandwidthVariant=bandwidthVariant, groupID=groupID, hardwareVersion=hardwareVersion, ethernetGroup=ethernetGroup, ptmp=ptmp, ptp500=ptp500, sNTPServerPortNumber=sNTPServerPortNumber, ethernet=ethernet, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogControlGroup=syslogControlGroup, dfsTableEntry=dfsTableEntry, maximumTransmitPower=maximumTransmitPower, supplementary=supplementary, transmitDataRate=transmitDataRate, phyStatusGroup=phyStatusGroup, sNTPLastSync=sNTPLastSync, syslogClientTrap=syslogClientTrap, userEnabled=userEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPState=sNTPState, dfsTableNumber=dfsTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, daylightSaving=daylightSaving, receiveDataRate=receiveDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTraps=ptpTraps, userRole=userRole, userTable=userTable, systemClock=systemClock, ptp=ptp, hTTPSAccessEnabled=hTTPSAccessEnabled, range=range, versionsGroup=versionsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configurationGroup=configurationGroup, masterSlaveMode=masterSlaveMode, licence=licence, userTableIndex=userTableIndex, telecomsChannelStatus=telecomsChannelStatus, ptpGroups=ptpGroups, syslogState=syslogState, licensedCapacity=licensedCapacity, notificationsGroup=notificationsGroup, dataPortStatusTrap=dataPortStatusTrap, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, gatewayIPAddress=gatewayIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntpGroup=sntpGroup, frequencyVariant=frequencyVariant, sMTPEnabledMessages=sMTPEnabledMessages, sNTPPollInterval=sNTPPollInterval, userPassword=userPassword, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, transmitFreqKHz=transmitFreqKHz, byteErrorRatio=byteErrorRatio, snmpControl=snmpControl, sNMPTrapIPAddress=sNMPTrapIPAddress, PYSNMP_MODULE_ID=cambium, snmpControlGroup=snmpControlGroup, sNTPSync=sNTPSync, transmitModulationMode=transmitModulationMode, capacityLicenseMismatch=capacityLicenseMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsPeaks=dfsPeaks, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveFreqKHz=receiveFreqKHz, softwareVersion=softwareVersion, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aAAControl=aAAControl, dataPortStatus=dataPortStatus, dataPortDisabledWarning=dataPortDisabledWarning, syslogControl=syslogControl, regionCode=regionCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityTable=vLANPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, receiveChannel=receiveChannel, managementGroup=managementGroup, dfsTable=dfsTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTableIndex=dfsTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsMeans=dfsMeans, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPv3Enable=sNMPv3Enable, sMTPServerPortNumber=sMTPServerPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, latitude=latitude, linkModeOptimisation=linkModeOptimisation, regionCodeTrap=regionCodeTrap, dfsGroup=dfsGroup, linkSymmetry=linkSymmetry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegotiation=dataPortAutoNegotiation, systemReset=systemReset, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsCableLength=telecomsCableLength, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ethernetFiberSupport=ethernetFiberSupport, cableLoss=cableLoss, unitOutOfCalibration=unitOutOfCalibration, aggregateDataRate=aggregateDataRate, sNTPSyncTrap=sNTPSyncTrap, eIRP=eIRP, transmitChannel=transmitChannel, subnetMask=subnetMask, pubStats=pubStats, targetMACAddress=targetMACAddress, antennaGain=antennaGain, hTTPPortNumber=hTTPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, smtpGroup=smtpGroup, reset=reset, phyControlGroup=phyControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomGroup=telecomGroup, signalStrengthRatio=signalStrengthRatio, linkName=linkName, telecomsLoopback=telecomsLoopback, telecom=telecom, supplementaryGroup=supplementaryGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, channelBandwidth=channelBandwidth, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, accessMethod=accessMethod, vectorError=vectorError, ptpCompliance=ptpCompliance, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitPower=transmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapVersion=sNMPTrapVersion, userTableEntry=userTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, dfs=dfs, timeZone=timeZone, installArmStateTrap=installArmStateTrap, syslogStateTrap=syslogStateTrap, receivePower=receivePower, versions=versions, encryptionGroup=encryptionGroup, vLANManagementVID=vLANManagementVID, tDDControl=tDDControl, vLANPriorityTableEntry=vLANPriorityTableEntry, channelChangeTrap=channelChangeTrap, telecomsInterface=telecomsInterface, sMTPServerIPAddress=sMTPServerIPAddress, bootVersion=bootVersion, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailable=noWirelessChannelAvailable, alarms=alarms, longitude=longitude, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEmailAlert=sMTPEmailAlert, telecomsLoopbackTrap=telecomsLoopbackTrap, cambium=cambium, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, alarmsGroup=alarmsGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANManagementPriority=vLANManagementPriority, userName=userName, licenceGroup=licenceGroup, resetGroup=resetGroup, linkLoss=linkLoss, siteName=siteName, productVariant=productVariant, telnetPortNumber=telnetPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, aAAControlGroup=aAAControlGroup)
