...
# Produced by pysmi-1.1.8 at Thu Jan  6 19:20:32 2022
...
ModuleIdentity, NotificationType, ObjectIdentity, enterprises, IpAddress, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, TimeTicks, Gauge32, Unsigned32, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "ObjectIdentity", "enterprises", "IpAddress", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "TimeTicks", "Gauge32", "Unsigned32", "Bits", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", antennaGain=antennaGain, userTableIndex=userTableIndex, configuration=configuration, systemClock=systemClock, transmitFreqMHz=transmitFreqMHz, userRole=userRole, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userEnabled=userEnabled, productVariant=productVariant, ethernetGroup=ethernetGroup, receiveChannel=receiveChannel, sNTPLastSync=sNTPLastSync, masterSlaveMode=masterSlaveMode, ptp500=ptp500, telnetAccessEnabled=telnetAccessEnabled, phyStatus=phyStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfs=dfs, encryptionGroup=encryptionGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, longitude=longitude, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDControlGroup=tDDControlGroup, userPassword=userPassword, latitude=latitude, telecomsInterface=telecomsInterface, dataPortStatusTrap=dataPortStatusTrap, licence=licence, syslogStateTrap=syslogStateTrap, smtp=smtp, dfsTableIndex=dfsTableIndex, installStatus=installStatus, tFTPServerPortNumber=tFTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, ethernet=ethernet, hardwareVersion=hardwareVersion, licensedCapacity=licensedCapacity, altitude=altitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPAccessEnabled=hTTPAccessEnabled, subnetMask=subnetMask, syslogControl=syslogControl, sNMPv3Enable=sNMPv3Enable, systemReset=systemReset, ptpGroups=ptpGroups, daylightSaving=daylightSaving, maximumTransmitPower=maximumTransmitPower, dataPortStatus=dataPortStatus, licenceGroup=licenceGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomGroup=telecomGroup, remoteIPAddress=remoteIPAddress, sntp=sntp, channelBandwidth=channelBandwidth, linkName=linkName, sNTPSyncTrap=sNTPSyncTrap, softwareVersion=softwareVersion, unitOutOfCalibration=unitOutOfCalibration, accessMethod=accessMethod, ptpTrapPrefix=ptpTrapPrefix, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatusGroup=phyStatusGroup, installStatusTrap=installStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, management=management, pubStats=pubStats, sNTPServerPortNumber=sNTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationStatus=tDDSynchronizationStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveDataRate=receiveDataRate, telecomsChannelStatusTrap=telecomsChannelStatusTrap, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapVersion=sNMPTrapVersion, dfsGroup=dfsGroup, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapTable=sNMPTrapTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userTableNumber=userTableNumber, linkModeOptimisation=linkModeOptimisation, linkSymmetry=linkSymmetry, tFTPServerIPAddress=tFTPServerIPAddress, range=range, reset=reset, vLANPriorityTableEntry=vLANPriorityTableEntry, eIRP=eIRP, PYSNMP_MODULE_ID=cambium, sNMPEnabledTraps=sNMPEnabledTraps, syslogState=syslogState, searchState=searchState, bandwidthVariant=bandwidthVariant, aAAControl=aAAControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpCompliance=ptpCompliance, telecom=telecom, userTable=userTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, supplementary=supplementary, phyControl=phyControl, sNTPState=sNTPState, supplementaryGroup=supplementaryGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, encryption=encryption, managementGroup=managementGroup, snmpControl=snmpControl, cableLoss=cableLoss, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveModulationMode=receiveModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyControlGroup=phyControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, alarms=alarms, resetGroup=resetGroup, telecomsCableLength=telecomsCableLength, sNTPServerIPAddress=sNTPServerIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortDisabledWarning=dataPortDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkAvailability=wirelessLinkAvailability, telecomsLoopbackTrap=telecomsLoopbackTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogClient=syslogClient, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementVID=vLANManagementVID, userTableEntry=userTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installArmStateTrap=installArmStateTrap, configurationGroup=configurationGroup, sNTPSync=sNTPSync, secondarySoftwareVersion=secondarySoftwareVersion, byteErrorRatio=byteErrorRatio, targetMACAddress=targetMACAddress, receiveFreqKHz=receiveFreqKHz, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, groupID=groupID, cambium=cambium, pubStatsGroup=pubStatsGroup, aggregateDataRate=aggregateDataRate, aAAControlGroup=aAAControlGroup, timeZone=timeZone, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptp=ptp, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteMaximumTransmitPower=remoteMaximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, transmitChannel=transmitChannel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoMdix=dataPortAutoMdix, ptmp=ptmp, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpTraps=ptpTraps, dfsTableNumber=dfsTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, linkLoss=linkLoss, telnetPortNumber=telnetPortNumber, alarmsGroup=alarmsGroup, syslogControlGroup=syslogControlGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsMeans=dfsMeans, versions=versions, siteName=siteName, capacityLicenseMismatch=capacityLicenseMismatch, sNMPPortNumber=sNMPPortNumber, dfsPeaks=dfsPeaks, transmitDataRate=transmitDataRate, dfsTableEntry=dfsTableEntry, receivePower=receivePower, userName=userName, notificationsGroup=notificationsGroup, encryptionAlgorithm=encryptionAlgorithm, smtpGroup=smtpGroup, productName=productName, transmitPower=transmitPower, sNMPCommunityString=sNMPCommunityString, sMTPEmailAlert=sMTPEmailAlert, vLANManagementPriority=vLANManagementPriority, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sntpGroup=sntpGroup, iPAddress=iPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogClientTrap=syslogClientTrap, bootVersion=bootVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsLoopback=telecomsLoopback, vectorError=vectorError, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installArmState=installArmState, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelStatus=telecomsChannelStatus, dfsTable=dfsTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveFreqMHz=receiveFreqMHz, tDDControl=tDDControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANPriorityTable=vLANPriorityTable, regionCode=regionCode, frequencyVariant=frequencyVariant, channelChangeTrap=channelChangeTrap, versionsGroup=versionsGroup, sNTPPollInterval=sNTPPollInterval, telecomsLineCode=telecomsLineCode, wirelessLinkStatus=wirelessLinkStatus)
