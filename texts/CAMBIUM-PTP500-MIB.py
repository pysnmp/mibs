...
# Produced by pysmi-1.1.3 at Wed Dec  8 21:18:37 2021
...
Unsigned32, ModuleIdentity, Counter64, NotificationType, Gauge32, ObjectIdentity, TimeTicks, enterprises, IpAddress, Integer32, iso, Bits, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "Counter64", "NotificationType", "Gauge32", "ObjectIdentity", "TimeTicks", "enterprises", "IpAddress", "Integer32", "iso", "Bits", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsTableIndex=dfsTableIndex, vLANPriorityTable=vLANPriorityTable, longitude=longitude, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, masterSlaveMode=masterSlaveMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPServerPortNumber=sMTPServerPortNumber, versions=versions, alarms=alarms, reset=reset, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsMeans=dfsMeans, dataPortStatus=dataPortStatus, transmitFreqMHz=transmitFreqMHz, licenceGroup=licenceGroup, ethernet=ethernet, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsInterface=telecomsInterface, receiveFreqMHz=receiveFreqMHz, dataPortDisabledWarning=dataPortDisabledWarning, licence=licence, dfsTable=dfsTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveDataRate=receiveDataRate, receiveChannel=receiveChannel, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPAccessEnabled=hTTPAccessEnabled, searchState=searchState, userRole=userRole, sNMPEnabledTraps=sNMPEnabledTraps, alarmsGroup=alarmsGroup, supplementary=supplementary, wirelessLinkAvailability=wirelessLinkAvailability, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpTraps=ptpTraps, userTableNumber=userTableNumber, targetMACAddress=targetMACAddress, sMTPEnabledMessages=sMTPEnabledMessages, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsPeaks=dfsPeaks, telnetAccessEnabled=telnetAccessEnabled, phyStatus=phyStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomGroup=telecomGroup, tFTPServerPortNumber=tFTPServerPortNumber, sntp=sntp, linkSymmetry=linkSymmetry, management=management, dataPortAutoNegotiation=dataPortAutoNegotiation, installStatusTrap=installStatusTrap, productName=productName, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableEntry=userTableEntry, eIRP=eIRP, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpGroups=ptpGroups, incompatibleMasterAndSlave=incompatibleMasterAndSlave, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogStateTrap=syslogStateTrap, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSync=sNTPSync, subnetMask=subnetMask, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, remoteMaximumTransmitPower=remoteMaximumTransmitPower, aggregateDataRate=aggregateDataRate, syslogState=syslogState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hTTPPortNumber=hTTPPortNumber, aAAControlGroup=aAAControlGroup, systemClock=systemClock, channelChangeTrap=channelChangeTrap, ethernetGroup=ethernetGroup, receiveFreqKHz=receiveFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecom=telecom, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, sNTPLastSync=sNTPLastSync, encryptionGroup=encryptionGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, siteName=siteName, capacityLicenseMismatch=capacityLicenseMismatch, transmitChannel=transmitChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, smtpGroup=smtpGroup, altitude=altitude, dfsTableEntry=dfsTableEntry, softwareVersion=softwareVersion, licensedCapacity=licensedCapacity, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryptionAlgorithm=encryptionAlgorithm, tDDControlGroup=tDDControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, frequencyVariant=frequencyVariant, sMTPServerIPAddress=sMTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, userTableIndex=userTableIndex, ptp500=ptp500, hardwareVersion=hardwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsChannelStatus=telecomsChannelStatus, cambium=cambium, productVariant=productVariant, dfsGroup=dfsGroup, range=range, sNTPState=sNTPState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, latitude=latitude, encryption=encryption, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPv3Enable=sNMPv3Enable, vLANPriorityTableNumber=vLANPriorityTableNumber, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortAutoMdix=dataPortAutoMdix, sNTPServerIPAddress=sNTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimisation=linkModeOptimisation, userTable=userTable, sNMPTrapIPAddress=sNMPTrapIPAddress, sntpGroup=sntpGroup, supplementaryGroup=supplementaryGroup, receiveModulationMode=receiveModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStats=pubStats, vLANManagementPriority=vLANManagementPriority, groupID=groupID, ptpCompliance=ptpCompliance, smtp=smtp, vLANManagementVID=vLANManagementVID, bandwidthVariant=bandwidthVariant, telecomsLineCode=telecomsLineCode, vectorError=vectorError, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControlGroup=phyControlGroup, bootVersion=bootVersion, userEnabled=userEnabled, tDDControl=tDDControl, userName=userName, cableLoss=cableLoss, snmpControl=snmpControl, versionsGroup=versionsGroup, sNTPPollInterval=sNTPPollInterval, ptp=ptp, configurationGroup=configurationGroup, syslogControlGroup=syslogControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, hTTPSPortNumber=hTTPSPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, notificationsGroup=notificationsGroup, sNMPTrapTable=sNMPTrapTable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, resetGroup=resetGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkName=linkName, phyStatusGroup=phyStatusGroup, sNMPTrapVersion=sNMPTrapVersion, syslogControl=syslogControl, remoteIPAddress=remoteIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, daylightSaving=daylightSaving, byteErrorRatio=byteErrorRatio, installArmStateTrap=installArmStateTrap, sNTPSyncTrap=sNTPSyncTrap, channelBandwidth=channelBandwidth, dfs=dfs, maximumTransmitPower=maximumTransmitPower, ptpTrapPrefix=ptpTrapPrefix, dfsTableNumber=dfsTableNumber, linkLoss=linkLoss, systemReset=systemReset, regionCodeTrap=regionCodeTrap, ptmp=ptmp, gatewayIPAddress=gatewayIPAddress, signalStrengthRatio=signalStrengthRatio, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telnetPortNumber=telnetPortNumber, installStatus=installStatus, syslogClientTrap=syslogClientTrap, syslogClient=syslogClient, ethernetFiberSupport=ethernetFiberSupport, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, configuration=configuration, phyControl=phyControl, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationMode=tDDSynchronizationMode, iPAddress=iPAddress, installArmState=installArmState, userPassword=userPassword, telecomsLoopback=telecomsLoopback, aAAControl=aAAControl, timeZone=timeZone, telecomsCableLength=telecomsCableLength, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitModulationMode=transmitModulationMode, sMTPEmailAlert=sMTPEmailAlert, receivePower=receivePower, antennaGain=antennaGain, pubStatsGroup=pubStatsGroup)
