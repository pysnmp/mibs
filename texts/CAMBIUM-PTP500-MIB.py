...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", systemReset=systemReset, transmitPower=transmitPower, telecom=telecom, aggregateDataRate=aggregateDataRate, receiveFreqKHz=receiveFreqKHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsCableLength=telecomsCableLength, management=management, cableLoss=cableLoss, transmitDataRate=transmitDataRate, dataPortStatus=dataPortStatus, altitude=altitude, userTableIndex=userTableIndex, telnetAccessEnabled=telnetAccessEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, cambium=cambium, dataPortStatusTrap=dataPortStatusTrap, eIRP=eIRP, signalStrengthRatio=signalStrengthRatio, transmitChannel=transmitChannel, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, telecomsLoopbackTrap=telecomsLoopbackTrap, ptp=ptp, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, ptp500=ptp500, sNTPServerPortNumber=sNTPServerPortNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tDDControl=tDDControl, dfsTableIndex=dfsTableIndex, installArmState=installArmState, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogStateTrap=syslogStateTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkStatus=wirelessLinkStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telnetPortNumber=telnetPortNumber, hTTPPortNumber=hTTPPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogControl=syslogControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, configurationGroup=configurationGroup, resetGroup=resetGroup, sNMPEnabledTraps=sNMPEnabledTraps, targetMACAddress=targetMACAddress, syslogClient=syslogClient, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, latitude=latitude, hTTPSPortNumber=hTTPSPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPPollInterval=sNTPPollInterval, telecomGroup=telecomGroup, unitOutOfCalibration=unitOutOfCalibration, userRole=userRole, dataPortWirelessDownAlert=dataPortWirelessDownAlert, capacityLicenseMismatch=capacityLicenseMismatch, syslogClientTrap=syslogClientTrap, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatus=phyStatus, userName=userName, notificationsGroup=notificationsGroup, tDDControlGroup=tDDControlGroup, linkModeOptimisation=linkModeOptimisation, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitFreqKHz=transmitFreqKHz, phyControl=phyControl, systemClock=systemClock, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNMPv3Enable=sNMPv3Enable, transmitModulationMode=transmitModulationMode, maximumTransmitPower=maximumTransmitPower, sNTPState=sNTPState, syslogControlGroup=syslogControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, accessMethod=accessMethod, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsPeaks=dfsPeaks, receiveModulationModeDetail=receiveModulationModeDetail, tDDSynchronizationMode=tDDSynchronizationMode, remoteIPAddress=remoteIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntp=sntp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpGroups=ptpGroups, linkSymmetry=linkSymmetry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerIPAddress=sNTPServerIPAddress, aAAControlGroup=aAAControlGroup, phyControlGroup=phyControlGroup, frequencyVariant=frequencyVariant, vLANPriorityTableNumber=vLANPriorityTableNumber, byteErrorRatio=byteErrorRatio, syslogState=syslogState, ethernetGroup=ethernetGroup, channelChangeTrap=channelChangeTrap, userTableEntry=userTableEntry, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, softwareVersion=softwareVersion, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licenceGroup=licenceGroup, dataPortAutoMdix=dataPortAutoMdix, smtp=smtp, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapVersion=sNMPTrapVersion, receiveModulationMode=receiveModulationMode, dfsTableEntry=dfsTableEntry, ptpTraps=ptpTraps, antennaGain=antennaGain, phyStatusGroup=phyStatusGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleRegionCodes=incompatibleRegionCodes, masterSlaveMode=masterSlaveMode, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, linkLoss=linkLoss, productVariant=productVariant, licensedCapacity=licensedCapacity, siteName=siteName, aAAControl=aAAControl, installStatus=installStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, bootVersion=bootVersion, installStatusTrap=installStatusTrap, pubStats=pubStats, dfsTableNumber=dfsTableNumber, telecomsLineCode=telecomsLineCode, regionCodeTrap=regionCodeTrap, ethernetFiberSupport=ethernetFiberSupport, encryption=encryption, telecomsInterface=telecomsInterface, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityTable=vLANPriorityTable, versions=versions, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, reset=reset, managementGroup=managementGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveFreqMHz=receiveFreqMHz, ptpCompliance=ptpCompliance, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, versionsGroup=versionsGroup, userEnabled=userEnabled, ethernet=ethernet, range=range, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryptionGroup=encryptionGroup, groupID=groupID, regionCode=regionCode, vectorError=vectorError, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, searchState=searchState, timeZone=timeZone, daylightSaving=daylightSaving, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userPassword=userPassword, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsMeans=dfsMeans, subnetMask=subnetMask, supplementaryGroup=supplementaryGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitFreqMHz=transmitFreqMHz, dfsTable=dfsTable, bandwidthVariant=bandwidthVariant, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsGroup=dfsGroup, PYSNMP_MODULE_ID=cambium, longitude=longitude, snmpControl=snmpControl, receiveChannel=receiveChannel, sNTPSyncTrap=sNTPSyncTrap, alarmsGroup=alarmsGroup, telecomsChannelStatus=telecomsChannelStatus, licence=licence, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANManagementPriority=vLANManagementPriority, hardwareVersion=hardwareVersion, sNTPSync=sNTPSync, linkName=linkName, telecomsLoopback=telecomsLoopback, configuration=configuration, iPAddress=iPAddress, productName=productName, dfs=dfs, smtpGroup=smtpGroup, userTable=userTable, userTableNumber=userTableNumber, sNTPLastSync=sNTPLastSync, alarms=alarms, sNMPTrapTable=sNMPTrapTable, channelBandwidth=channelBandwidth)
