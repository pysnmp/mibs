...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:57:54 2021
...
Counter64, MibIdentifier, iso, ModuleIdentity, TimeTicks, ObjectIdentity, enterprises, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Unsigned32, IpAddress, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "iso", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "enterprises", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Unsigned32", "IpAddress", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsTable=dfsTable, phyStatus=phyStatus, linkName=linkName, ptp=ptp, encryptionGroup=encryptionGroup, eIRP=eIRP, vLANPriorityTable=vLANPriorityTable, alarms=alarms, installStatus=installStatus, accessMethod=accessMethod, sMTPServerIPAddress=sMTPServerIPAddress, bandwidthVariant=bandwidthVariant, managementGroup=managementGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, telnetAccessEnabled=telnetAccessEnabled, linkLoss=linkLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsTableNumber=dfsTableNumber, dataPortAutoMdix=dataPortAutoMdix, sNTPServerIPAddress=sNTPServerIPAddress, syslogControl=syslogControl, hTTPSPortNumber=hTTPSPortNumber, aAAControl=aAAControl, dataPortStatus=dataPortStatus, notificationsGroup=notificationsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aAAControlGroup=aAAControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapTable=sNMPTrapTable, hardwareVersion=hardwareVersion, tDDControlGroup=tDDControlGroup, supplementary=supplementary, telecomsLineCode=telecomsLineCode, userRole=userRole, phyControlGroup=phyControlGroup, sNMPv3Enable=sNMPv3Enable, pubStats=pubStats, remoteMaximumTransmitPower=remoteMaximumTransmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsLoopback=telecomsLoopback, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableIndex=userTableIndex, syslogState=syslogState, dataPortStatusTrap=dataPortStatusTrap, sNTPPollInterval=sNTPPollInterval, tDDSynchronizationAlarm=tDDSynchronizationAlarm, pubStatsGroup=pubStatsGroup, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTableIndex=dfsTableIndex, signalStrengthRatio=signalStrengthRatio, receiveModulationMode=receiveModulationMode, dfsGroup=dfsGroup, telecomsInterface=telecomsInterface, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptpTraps=ptpTraps, userTableNumber=userTableNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANManagementPriority=vLANManagementPriority, vLANPriorityTableIndex=vLANPriorityTableIndex, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, hTTPAccessEnabled=hTTPAccessEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, smtpGroup=smtpGroup, vLANManagementVID=vLANManagementVID, timeZone=timeZone, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userEnabled=userEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsMeans=dfsMeans, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, productVariant=productVariant, licenceGroup=licenceGroup, telecomGroup=telecomGroup, vectorError=vectorError, vLANPriorityTableEntry=vLANPriorityTableEntry, cableLoss=cableLoss, subnetMask=subnetMask, smtp=smtp, configuration=configuration, transmitFreqMHz=transmitFreqMHz, wirelessLinkAvailability=wirelessLinkAvailability, sNMPPortNumber=sNMPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, longitude=longitude, licence=licence, receiveDataRate=receiveDataRate, encryptionAlgorithm=encryptionAlgorithm, tFTPServerIPAddress=tFTPServerIPAddress, telecomsCableLength=telecomsCableLength, productName=productName, aggregateDataRate=aggregateDataRate, syslogControlGroup=syslogControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, maximumTransmitPower=maximumTransmitPower, masterSlaveMode=masterSlaveMode, systemClock=systemClock, userTableEntry=userTableEntry, versions=versions, groupID=groupID, hTTPPortNumber=hTTPPortNumber, daylightSaving=daylightSaving, userTable=userTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versionsGroup=versionsGroup, dfsTableEntry=dfsTableEntry, sNMPTrapTableEntry=sNMPTrapTableEntry, installStatusTrap=installStatusTrap, ptpCompliance=ptpCompliance, ethernetFiberSupport=ethernetFiberSupport, secondarySoftwareVersion=secondarySoftwareVersion, channelBandwidth=channelBandwidth, sNMPTrapIPAddress=sNMPTrapIPAddress, receivePower=receivePower, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveFreqMHz=receiveFreqMHz, byteErrorRatio=byteErrorRatio, reset=reset, sNTPSync=sNTPSync, ethernetGroup=ethernetGroup, altitude=altitude, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, snmpControl=snmpControl, ptpGroups=ptpGroups, iPAddress=iPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userName=userName, dataPortDisabledWarning=dataPortDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, encryption=encryption, tFTPServerPortNumber=tFTPServerPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkStatus=wirelessLinkStatus, sNTPSyncTrap=sNTPSyncTrap, receiveChannel=receiveChannel, incompatibleRegionCodes=incompatibleRegionCodes, alarmsGroup=alarmsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptmp=ptmp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, range=range, transmitChannel=transmitChannel, sNMPCommunityString=sNMPCommunityString, telnetPortNumber=telnetPortNumber, transmitDataRate=transmitDataRate, telecom=telecom, linkSymmetry=linkSymmetry, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpTrapPrefix=ptpTrapPrefix, snmpControlGroup=snmpControlGroup, dfsPeaks=dfsPeaks, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimisation=linkModeOptimisation, sMTPEnabledMessages=sMTPEnabledMessages, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, sntp=sntp, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableNumber=sNMPTrapTableNumber, latitude=latitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, antennaGain=antennaGain, channelChangeTrap=channelChangeTrap, transmitModulationMode=transmitModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, management=management, phyStatusGroup=phyStatusGroup, siteName=siteName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, PYSNMP_MODULE_ID=cambium, searchState=searchState, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userPassword=userPassword, targetMACAddress=targetMACAddress, dfs=dfs, capacityLicenseMismatch=capacityLicenseMismatch, installArmState=installArmState, regionCodeTrap=regionCodeTrap, transmitFreqKHz=transmitFreqKHz, cambium=cambium, ethernet=ethernet, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDControl=tDDControl, supplementaryGroup=supplementaryGroup, softwareVersion=softwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapVersion=sNMPTrapVersion, systemReset=systemReset, installArmStateTrap=installArmStateTrap, phyControl=phyControl, syslogClient=syslogClient, bootVersion=bootVersion, sntpGroup=sntpGroup, ptp500=ptp500, resetGroup=resetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licensedCapacity=licensedCapacity, sNTPState=sNTPState, receiveFreqKHz=receiveFreqKHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteIPAddress=remoteIPAddress, telecomsChannelStatus=telecomsChannelStatus, configurationGroup=configurationGroup)
