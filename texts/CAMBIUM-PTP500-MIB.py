...
ObjectIdentity, Integer32, NotificationType, Counter32, Counter64, Bits, MibIdentifier, ModuleIdentity, iso, enterprises, TimeTicks, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "NotificationType", "Counter32", "Counter64", "Bits", "MibIdentifier", "ModuleIdentity", "iso", "enterprises", "TimeTicks", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", resetGroup=resetGroup, telecomsInterface=telecomsInterface, hTTPSPortNumber=hTTPSPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, versionsGroup=versionsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetFiberSupport=ethernetFiberSupport, searchState=searchState, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANManagementPriority=vLANManagementPriority, sMTPServerPortNumber=sMTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, longitude=longitude, receiveFreqMHz=receiveFreqMHz, dfsMeans=dfsMeans, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTable=dfsTable, sNTPPollInterval=sNTPPollInterval, ethernetGroup=ethernetGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitModulationMode=transmitModulationMode, telecomsLineCode=telecomsLineCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, productName=productName, configurationGroup=configurationGroup, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, hardwareVersion=hardwareVersion, accessMethod=accessMethod, userTable=userTable, productVariant=productVariant, telecomGroup=telecomGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsTableEntry=dfsTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, daylightSaving=daylightSaving, smtp=smtp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogControlGroup=syslogControlGroup, frequencyVariant=frequencyVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, reset=reset, sNTPLastSync=sNTPLastSync, dataPortDisabledWarning=dataPortDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, siteName=siteName, sntp=sntp, tDDControlGroup=tDDControlGroup, unitOutOfCalibration=unitOutOfCalibration, ptpTrapPrefix=ptpTrapPrefix, transmitPower=transmitPower, latitude=latitude, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userEnabled=userEnabled, transmitFreqKHz=transmitFreqKHz, installArmStateTrap=installArmStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, dfs=dfs, tDDControl=tDDControl, ptpGroups=ptpGroups, gatewayIPAddress=gatewayIPAddress, range=range, maximumTransmitPower=maximumTransmitPower, ethernet=ethernet, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerIPAddress=tFTPServerIPAddress, management=management, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userName=userName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogClient=syslogClient, versions=versions, cambium=cambium, phyControlGroup=phyControlGroup, syslogControl=syslogControl, receivePower=receivePower, userRole=userRole, ptpCompliance=ptpCompliance, linkModeOptimisation=linkModeOptimisation, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, aggregateDataRate=aggregateDataRate, telecom=telecom, alarms=alarms, supplementary=supplementary, cableLoss=cableLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogState=syslogState, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, systemReset=systemReset, vLANPriorityTableIndex=vLANPriorityTableIndex, iPAddress=iPAddress, installArmState=installArmState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSyncTrap=sNTPSyncTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveChannel=receiveChannel, antennaGain=antennaGain, dataPortStatusTrap=dataPortStatusTrap, dfsTableNumber=dfsTableNumber, eIRP=eIRP, supplementaryGroup=supplementaryGroup, installStatus=installStatus, groupID=groupID, wirelessLinkAvailability=wirelessLinkAvailability, sNMPv3Enable=sNMPv3Enable, dfsPeaks=dfsPeaks, managementGroup=managementGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, snmpControlGroup=snmpControlGroup, ptp500=ptp500, sntpGroup=sntpGroup, snmpControl=snmpControl, pubStats=pubStats, phyStatusGroup=phyStatusGroup, telnetPortNumber=telnetPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptmp=ptmp, telecomsCableLength=telecomsCableLength, capacityLicenseMismatch=capacityLicenseMismatch, userPassword=userPassword, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPPortNumber=sNMPPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteIPAddress=remoteIPAddress, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPServerIPAddress=sNTPServerIPAddress, bandwidthVariant=bandwidthVariant, sNTPSync=sNTPSync, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableIndex=userTableIndex, pubStatsGroup=pubStatsGroup, linkLoss=linkLoss, licensedCapacity=licensedCapacity, configuration=configuration, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEmailAlert=sMTPEmailAlert, smtpGroup=smtpGroup, receiveModulationModeDetail=receiveModulationModeDetail, regionCode=regionCode, sMTPServerIPAddress=sMTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTable=vLANPriorityTable, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, altitude=altitude, sNTPState=sNTPState, phyControl=phyControl, channelBandwidth=channelBandwidth, sNMPTrapVersion=sNMPTrapVersion, targetMACAddress=targetMACAddress, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyStatus=phyStatus, userTableNumber=userTableNumber, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, notificationsGroup=notificationsGroup, byteErrorRatio=byteErrorRatio, licence=licence, dfsTableIndex=dfsTableIndex, dfsGroup=dfsGroup, dataPortAutoMdix=dataPortAutoMdix, transmitFreqMHz=transmitFreqMHz, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, bootVersion=bootVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPCommunityString=sNMPCommunityString, timeZone=timeZone, transmitChannel=transmitChannel, receiveDataRate=receiveDataRate, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, installStatusTrap=installStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogStateTrap=syslogStateTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, subnetMask=subnetMask, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsLoopback=telecomsLoopback, receiveModulationMode=receiveModulationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, PYSNMP_MODULE_ID=cambium, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkName=linkName, ptp=ptp, ptpTraps=ptpTraps, encryptionGroup=encryptionGroup, sNMPTrapTable=sNMPTrapTable, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, aAAControl=aAAControl, regionCodeTrap=regionCodeTrap, hTTPPortNumber=hTTPPortNumber, userTableEntry=userTableEntry, encryption=encryption, masterSlaveMode=masterSlaveMode, dataPortStatus=dataPortStatus, secondarySoftwareVersion=secondarySoftwareVersion, vectorError=vectorError, linkSymmetry=linkSymmetry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogClientTrap=syslogClientTrap)
