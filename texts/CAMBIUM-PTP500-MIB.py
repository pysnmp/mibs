...
Unsigned32, ObjectIdentity, Bits, MibIdentifier, Integer32, Counter64, TimeTicks, IpAddress, Gauge32, Counter32, enterprises, NotificationType, ModuleIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ObjectIdentity", "Bits", "MibIdentifier", "Integer32", "Counter64", "TimeTicks", "IpAddress", "Gauge32", "Counter32", "enterprises", "NotificationType", "ModuleIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", groupID=groupID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, altitude=altitude, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, encryptionAlgorithm=encryptionAlgorithm, sNMPv3Enable=sNMPv3Enable, frequencyVariant=frequencyVariant, linkName=linkName, daylightSaving=daylightSaving, userTableEntry=userTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aAAControl=aAAControl, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, eIRP=eIRP, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsPeaks=dfsPeaks, transmitFreqKHz=transmitFreqKHz, encryption=encryption, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfs=dfs, systemReset=systemReset, tDDControlGroup=tDDControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, receiveModulationMode=receiveModulationMode, ethernet=ethernet, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licensedCapacity=licensedCapacity, dataPortStatusTrap=dataPortStatusTrap, dfsGroup=dfsGroup, tFTPServerPortNumber=tFTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, notificationsGroup=notificationsGroup, iPAddress=iPAddress, installStatus=installStatus, regionCode=regionCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, channelBandwidth=channelBandwidth, telecomsLineCode=telecomsLineCode, supplementaryGroup=supplementaryGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetPortNumber=telnetPortNumber, alarmsGroup=alarmsGroup, receiveModulationModeDetail=receiveModulationModeDetail, sNTPState=sNTPState, channelChangeTrap=channelChangeTrap, userEnabled=userEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, ptpCompliance=ptpCompliance, dfsTable=dfsTable, dfsTableIndex=dfsTableIndex, installArmStateTrap=installArmStateTrap, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hardwareVersion=hardwareVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, ptpTraps=ptpTraps, cambium=cambium, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, range=range, linkModeOptimisation=linkModeOptimisation, ethernetGroup=ethernetGroup, management=management, smtp=smtp, dfsTableEntry=dfsTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControlGroup=phyControlGroup, userName=userName, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, receiveDataRate=receiveDataRate, hTTPPortNumber=hTTPPortNumber, dfsTableNumber=dfsTableNumber, userRole=userRole, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productVariant=productVariant, versions=versions, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableEntry=sNMPTrapTableEntry, telnetAccessEnabled=telnetAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveFreqMHz=receiveFreqMHz, wirelessLinkAvailability=wirelessLinkAvailability, reset=reset, transmitFreqMHz=transmitFreqMHz, userTableIndex=userTableIndex, systemClock=systemClock, longitude=longitude, sntpGroup=sntpGroup, dataPortAutoMdix=dataPortAutoMdix, constantPowerSpectralDensity=constantPowerSpectralDensity, productName=productName, accessMethod=accessMethod, sNMPPortNumber=sNMPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configuration=configuration, telecom=telecom, telecomGroup=telecomGroup, maximumTransmitPower=maximumTransmitPower, ptpGroups=ptpGroups, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, gatewayIPAddress=gatewayIPAddress, transmitPower=transmitPower, targetMACAddress=targetMACAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitChannel=transmitChannel, licence=licence, cableLoss=cableLoss, licenceGroup=licenceGroup, sNMPTrapTable=sNMPTrapTable, sNTPLastSync=sNTPLastSync, latitude=latitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSync=sNTPSync, syslogControl=syslogControl, encryptionGroup=encryptionGroup, wirelessLinkStatus=wirelessLinkStatus, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, ptp500=ptp500, ptmp=ptmp, phyStatusGroup=phyStatusGroup, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, sntp=sntp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, secondarySoftwareVersion=secondarySoftwareVersion, phyStatus=phyStatus, hTTPAccessEnabled=hTTPAccessEnabled, searchState=searchState, userTable=userTable, transmitDataRate=transmitDataRate, syslogControlGroup=syslogControlGroup, userPassword=userPassword, syslogStateTrap=syslogStateTrap, dataPortStatus=dataPortStatus, dfsMeans=dfsMeans, telecomsLoopback=telecomsLoopback, ethernetFiberSupport=ethernetFiberSupport, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANPriorityTable=vLANPriorityTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkLoss=linkLoss, capacityLicenseMismatch=capacityLicenseMismatch, sMTPEnabledMessages=sMTPEnabledMessages, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatusTrap=installStatusTrap, siteName=siteName, telecomsInterface=telecomsInterface, hTTPSPortNumber=hTTPSPortNumber, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, receiveChannel=receiveChannel, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, supplementary=supplementary, subnetMask=subnetMask, telecomsChannelStatus=telecomsChannelStatus, incompatibleRegionCodes=incompatibleRegionCodes, dataPortConfigurationMismatch=dataPortConfigurationMismatch, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, vectorError=vectorError, receiveFreqKHz=receiveFreqKHz, sNTPPollInterval=sNTPPollInterval, snmpControl=snmpControl, sNTPServerPortNumber=sNTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDControl=tDDControl, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configurationGroup=configurationGroup, syslogState=syslogState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStats=pubStats, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, ptp=ptp, phyControl=phyControl, softwareVersion=softwareVersion, syslogClientTrap=syslogClientTrap, userTableNumber=userTableNumber, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, linkSymmetry=linkSymmetry, bootVersion=bootVersion, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsCableLength=telecomsCableLength, vLANManagementPriority=vLANManagementPriority, masterSlaveMode=masterSlaveMode, regionCodeTrap=regionCodeTrap, bandwidthVariant=bandwidthVariant, resetGroup=resetGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, syslogClient=syslogClient, snmpControlGroup=snmpControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, alarms=alarms, installArmState=installArmState, managementGroup=managementGroup, aAAControlGroup=aAAControlGroup)
