...
NotificationType, Counter32, Bits, TimeTicks, enterprises, Unsigned32, ModuleIdentity, Gauge32, Integer32, IpAddress, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Bits", "TimeTicks", "enterprises", "Unsigned32", "ModuleIdentity", "Gauge32", "Integer32", "IpAddress", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", longitude=longitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarms=alarms, phyControlGroup=phyControlGroup, dfsGroup=dfsGroup, userRole=userRole, ethernetFiberSupport=ethernetFiberSupport, userName=userName, installArmState=installArmState, secondarySoftwareVersion=secondarySoftwareVersion, vLANManagementVID=vLANManagementVID, enabledDiagnosticAlarms=enabledDiagnosticAlarms, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogControlGroup=syslogControlGroup, linkModeOptimisation=linkModeOptimisation, timeZone=timeZone, receiveFreqKHz=receiveFreqKHz, installStatusTrap=installStatusTrap, encryptionAlgorithm=encryptionAlgorithm, dataPortStatus=dataPortStatus, userTableNumber=userTableNumber, regionCode=regionCode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, channelBandwidth=channelBandwidth, masterSlaveMode=masterSlaveMode, userTable=userTable, configurationGroup=configurationGroup, iPAddress=iPAddress, snmpControlGroup=snmpControlGroup, sNMPPortNumber=sNMPPortNumber, ptp=ptp, dataPortAutoNegotiation=dataPortAutoNegotiation, supplementaryGroup=supplementaryGroup, resetGroup=resetGroup, sNTPSync=sNTPSync, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, hardwareVersion=hardwareVersion, antennaGain=antennaGain, channelChangeTrap=channelChangeTrap, installStatus=installStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitPower=transmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productVariant=productVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpCompliance=ptpCompliance, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsPeaks=dfsPeaks, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vectorError=vectorError, sMTPServerPortNumber=sMTPServerPortNumber, cableLoss=cableLoss, sMTPEnabledMessages=sMTPEnabledMessages, userEnabled=userEnabled, frequencyVariant=frequencyVariant, systemClock=systemClock, sNMPTrapTableNumber=sNMPTrapTableNumber, cambium=cambium, phyStatusGroup=phyStatusGroup, remoteIPAddress=remoteIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPEmailAlert=sMTPEmailAlert, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, sMTPServerIPAddress=sMTPServerIPAddress, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, phyControl=phyControl, vLANPriorityTableIndex=vLANPriorityTableIndex, snmpControl=snmpControl, siteName=siteName, versionsGroup=versionsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, reset=reset, telecomGroup=telecomGroup, tDDControlGroup=tDDControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClientTrap=syslogClientTrap, userTableIndex=userTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, sntpGroup=sntpGroup, hTTPPortNumber=hTTPPortNumber, eIRP=eIRP, smtpGroup=smtpGroup, telnetPortNumber=telnetPortNumber, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, range=range, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfs=dfs, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitChannel=transmitChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, ptpGroups=ptpGroups, unitOutOfCalibration=unitOutOfCalibration, smtp=smtp, telecomsCableLength=telecomsCableLength, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, management=management, hTTPAccessEnabled=hTTPAccessEnabled, linkName=linkName, versions=versions, installArmStateTrap=installArmStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkSymmetry=linkSymmetry, ptmp=ptmp, telecomsChannelStatus=telecomsChannelStatus, licenceGroup=licenceGroup, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, encryption=encryption, syslogState=syslogState, transmitModulationMode=transmitModulationMode, configuration=configuration, sNMPTrapIPAddress=sNMPTrapIPAddress, systemReset=systemReset, byteErrorRatio=byteErrorRatio, altitude=altitude, syslogControl=syslogControl, ptp500=ptp500, sNMPTrapTableEntry=sNMPTrapTableEntry, licensedCapacity=licensedCapacity, aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, productName=productName, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControlGroup=aAAControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortDisabledWarning=dataPortDisabledWarning, receivePower=receivePower, syslogClient=syslogClient, gatewayIPAddress=gatewayIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, subnetMask=subnetMask, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsInterface=telecomsInterface, targetMACAddress=targetMACAddress, receiveDataRate=receiveDataRate, latitude=latitude, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPState=sNTPState, regionCodeTrap=regionCodeTrap, telecomsLineCode=telecomsLineCode, encryptionGroup=encryptionGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLoopback=telecomsLoopback, sNTPServerIPAddress=sNTPServerIPAddress, notificationsGroup=notificationsGroup, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveFreqMHz=receiveFreqMHz, vLANPriorityTable=vLANPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bandwidthVariant=bandwidthVariant, receiveChannel=receiveChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, bootVersion=bootVersion, pubStatsGroup=pubStatsGroup, groupID=groupID, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPv3Enable=sNMPv3Enable, userTableEntry=userTableEntry, sNMPCommunityString=sNMPCommunityString, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPLastSync=sNTPLastSync, searchState=searchState, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntp=sntp, receiveModulationModeDetail=receiveModulationModeDetail, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableEntry=dfsTableEntry, syslogStateTrap=syslogStateTrap, dfsMeans=dfsMeans, tDDControl=tDDControl, ethernetGroup=ethernetGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, licence=licence, transmitDataRate=transmitDataRate, ethernet=ethernet, sNTPPollInterval=sNTPPollInterval, maximumTransmitPower=maximumTransmitPower, linkLoss=linkLoss, userPassword=userPassword, dataPortAutoMdix=dataPortAutoMdix, pubStats=pubStats, accessMethod=accessMethod, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, supplementary=supplementary, wirelessLinkStatus=wirelessLinkStatus, dfsTable=dfsTable, tFTPServerIPAddress=tFTPServerIPAddress, transmitFreqMHz=transmitFreqMHz, daylightSaving=daylightSaving, transmitFreqKHz=transmitFreqKHz, sNTPSyncTrap=sNTPSyncTrap, telecom=telecom, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, aggregateDataRate=aggregateDataRate)
