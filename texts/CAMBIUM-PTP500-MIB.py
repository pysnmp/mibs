...
enterprises, NotificationType, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, iso, Counter32, TimeTicks, Counter64, Unsigned32, IpAddress, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "NotificationType", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "iso", "Counter32", "TimeTicks", "Counter64", "Unsigned32", "IpAddress", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installStatusTrap=installStatusTrap, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, systemReset=systemReset, sNMPTrapTableEntry=sNMPTrapTableEntry, userRole=userRole, tFTPServerIPAddress=tFTPServerIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementPriority=vLANManagementPriority, receiveFreqKHz=receiveFreqKHz, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPCommunityString=sNMPCommunityString, productName=productName, sntpGroup=sntpGroup, sMTPServerIPAddress=sMTPServerIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelStatusTrap=telecomsChannelStatusTrap, phyControl=phyControl, daylightSaving=daylightSaving, ptpGroups=ptpGroups, ethernetGroup=ethernetGroup, smtpGroup=smtpGroup, linkName=linkName, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, telnetPortNumber=telnetPortNumber, ptmp=ptmp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyStatus=phyStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPv3Enable=sNMPv3Enable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, altitude=altitude, userTableEntry=userTableEntry, dataPortAutoMdix=dataPortAutoMdix, syslogControlGroup=syslogControlGroup, transmitPower=transmitPower, telecomsCableLength=telecomsCableLength, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionGroup=encryptionGroup, vLANManagementVID=vLANManagementVID, userTableIndex=userTableIndex, dfsPeaks=dfsPeaks, configurationGroup=configurationGroup, tDDControl=tDDControl, userTableNumber=userTableNumber, telecomsChannelStatus=telecomsChannelStatus, range=range, linkModeOptimisation=linkModeOptimisation, snmpControlGroup=snmpControlGroup, receiveFreqMHz=receiveFreqMHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationStatus=tDDSynchronizationStatus, alarms=alarms, dataPortDisabledWarning=dataPortDisabledWarning, telecomsInterface=telecomsInterface, cambium=cambium, sNTPPollInterval=sNTPPollInterval, tDDSynchronizationMode=tDDSynchronizationMode, channelChangeTrap=channelChangeTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, vLANPriorityTableIndex=vLANPriorityTableIndex, sNTPSyncTrap=sNTPSyncTrap, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsGroup=dfsGroup, vectorError=vectorError, phyStatusGroup=phyStatusGroup, latitude=latitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licence=licence, sMTPEmailAlert=sMTPEmailAlert, linkLoss=linkLoss, versions=versions, targetMACAddress=targetMACAddress, siteName=siteName, vLANPriorityTable=vLANPriorityTable, bandwidthVariant=bandwidthVariant, byteErrorRatio=byteErrorRatio, wirelessLinkAvailability=wirelessLinkAvailability, syslogClient=syslogClient, sNMPPortNumber=sNMPPortNumber, remoteIPAddress=remoteIPAddress, reset=reset, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkSymmetry=linkSymmetry, supplementaryGroup=supplementaryGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, longitude=longitude, ethernet=ethernet, maximumTransmitPower=maximumTransmitPower, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, snmpControl=snmpControl, telnetAccessEnabled=telnetAccessEnabled, aAAControl=aAAControl, transmitFreqKHz=transmitFreqKHz, sNMPTrapPortNumber=sNMPTrapPortNumber, userTable=userTable, ptpCompliance=ptpCompliance, aAAControlGroup=aAAControlGroup, receiveDataRate=receiveDataRate, userEnabled=userEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveChannel=receiveChannel, sNTPLastSync=sNTPLastSync, secondarySoftwareVersion=secondarySoftwareVersion, ptpTrapPrefix=ptpTrapPrefix, installStatus=installStatus, phyControlGroup=phyControlGroup, ethernetFiberSupport=ethernetFiberSupport, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, encryption=encryption, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, managementGroup=managementGroup, wirelessLinkStatus=wirelessLinkStatus, dfsMeans=dfsMeans, eIRP=eIRP, searchState=searchState, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, smtp=smtp, cableLoss=cableLoss, remoteMaximumTransmitPower=remoteMaximumTransmitPower, configuration=configuration, userName=userName, syslogState=syslogState, management=management, hTTPSPortNumber=hTTPSPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableNumber=dfsTableNumber, regionCode=regionCode, tFTPServerPortNumber=tFTPServerPortNumber, sNTPSync=sNTPSync, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPPortNumber=hTTPPortNumber, notificationsGroup=notificationsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, channelBandwidth=channelBandwidth, gatewayIPAddress=gatewayIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, productVariant=productVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomGroup=telecomGroup, sNTPServerPortNumber=sNTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sntp=sntp, transmitChannel=transmitChannel, installArmState=installArmState, licensedCapacity=licensedCapacity, ptp=ptp, sNMPTrapTable=sNMPTrapTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPState=sNTPState, syslogStateTrap=syslogStateTrap, syslogClientTrap=syslogClientTrap, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, pubStats=pubStats, accessMethod=accessMethod, receivePower=receivePower, subnetMask=subnetMask, telecom=telecom, systemClock=systemClock, timeZone=timeZone, ptpTraps=ptpTraps, versionsGroup=versionsGroup, tDDControlGroup=tDDControlGroup, groupID=groupID, unitOutOfCalibration=unitOutOfCalibration, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitDataRate=transmitDataRate, vLANPriorityTableNumber=vLANPriorityTableNumber, licenceGroup=licenceGroup, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userPassword=userPassword, regionCodeTrap=regionCodeTrap, hardwareVersion=hardwareVersion, supplementary=supplementary, pubStatsGroup=pubStatsGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, ptp500=ptp500, telecomsLoopback=telecomsLoopback, PYSNMP_MODULE_ID=cambium, capacityLicenseMismatch=capacityLicenseMismatch, installArmStateTrap=installArmStateTrap, telecomsLineCode=telecomsLineCode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bootVersion=bootVersion, sNMPTrapVersion=sNMPTrapVersion, resetGroup=resetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPEnabledTraps=sNMPEnabledTraps, dfs=dfs, dfsTable=dfsTable, encryptionAlgorithm=encryptionAlgorithm, sMTPServerPortNumber=sMTPServerPortNumber, iPAddress=iPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqMHz=transmitFreqMHz, dfsTableIndex=dfsTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, frequencyVariant=frequencyVariant)
