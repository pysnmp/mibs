...
# Produced by pysmi-1.1.3 at Sat Nov 20 17:15:58 2021
...
TimeTicks, iso, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, ObjectIdentity, Counter64, Bits, Integer32, NotificationType, Unsigned32, IpAddress, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "ObjectIdentity", "Counter64", "Bits", "Integer32", "NotificationType", "Unsigned32", "IpAddress", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", licensedCapacity=licensedCapacity, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aAAControlGroup=aAAControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, managementGroup=managementGroup, vLANManagementPriority=vLANManagementPriority, dataPortStatus=dataPortStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomGroup=telecomGroup, accessMethod=accessMethod, systemReset=systemReset, hTTPPortNumber=hTTPPortNumber, ptpGroups=ptpGroups, remoteIPAddress=remoteIPAddress, sNMPPortNumber=sNMPPortNumber, sMTPEmailAlert=sMTPEmailAlert, syslogState=syslogState, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationMode=receiveModulationMode, ptmp=ptmp, aggregateDataRate=aggregateDataRate, pubStats=pubStats, ethernet=ethernet, regionCode=regionCode, sntpGroup=sntpGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, reset=reset, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitPower=transmitPower, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkName=linkName, userName=userName, bandwidthVariant=bandwidthVariant, receiveFreqKHz=receiveFreqKHz, dfsPeaks=dfsPeaks, dataPortWirelessDownAlert=dataPortWirelessDownAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkSymmetry=linkSymmetry, userEnabled=userEnabled, encryptionGroup=encryptionGroup, sNTPState=sNTPState, userRole=userRole, systemClock=systemClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortDisabledWarning=dataPortDisabledWarning, dfs=dfs, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitChannel=transmitChannel, installStatusTrap=installStatusTrap, userTableEntry=userTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableNumber=userTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, alarmsGroup=alarmsGroup, vLANPriorityTable=vLANPriorityTable, dfsTable=dfsTable, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimizationMismatch=linkModeOptimizationMismatch, frequencyVariant=frequencyVariant, subnetMask=subnetMask, sNMPCommunityString=sNMPCommunityString, targetMACAddress=targetMACAddress, linkModeOptimisation=linkModeOptimisation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, groupID=groupID, tFTPServerIPAddress=tFTPServerIPAddress, dfsGroup=dfsGroup, licence=licence, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogStateTrap=syslogStateTrap, tDDControlGroup=tDDControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, productVariant=productVariant, ptpTraps=ptpTraps, encryption=encryption, configuration=configuration, encryptionAlgorithm=encryptionAlgorithm, installArmStateTrap=installArmStateTrap, receivePower=receivePower, dfsMeans=dfsMeans, daylightSaving=daylightSaving, range=range, phyStatusGroup=phyStatusGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, softwareVersion=softwareVersion, telecom=telecom, tDDSynchronizationMode=tDDSynchronizationMode, ptp=ptp, ptp500=ptp500, supplementaryGroup=supplementaryGroup, notificationsGroup=notificationsGroup, hardwareVersion=hardwareVersion, licenceGroup=licenceGroup, versions=versions, sMTPServerPortNumber=sMTPServerPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsInterface=telecomsInterface, altitude=altitude, channelBandwidth=channelBandwidth, hTTPAccessEnabled=hTTPAccessEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, eIRP=eIRP, sNTPLastSync=sNTPLastSync, telecomsLoopback=telecomsLoopback, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installStatus=installStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableNumber=dfsTableNumber, unitOutOfCalibration=unitOutOfCalibration, sntp=sntp, tDDControl=tDDControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogControl=syslogControl, telecomsLineCode=telecomsLineCode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, signalStrengthRatio=signalStrengthRatio, dfsTableEntry=dfsTableEntry, sNTPPollInterval=sNTPPollInterval, latitude=latitude, snmpControlGroup=snmpControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, supplementary=supplementary, telecomsChannelStatusTrap=telecomsChannelStatusTrap, management=management, transmitFreqKHz=transmitFreqKHz, receiveChannel=receiveChannel, receiveDataRate=receiveDataRate, hTTPSAccessEnabled=hTTPSAccessEnabled, userTableIndex=userTableIndex, linkLoss=linkLoss, timeZone=timeZone, sMTPServerIPAddress=sMTPServerIPAddress, smtpGroup=smtpGroup, masterSlaveMode=masterSlaveMode, syslogClient=syslogClient, cambium=cambium, incompatibleRegionCodes=incompatibleRegionCodes, gatewayIPAddress=gatewayIPAddress, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, versionsGroup=versionsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPv3Enable=sNMPv3Enable, aAAControl=aAAControl, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatus=phyStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsCableLength=telecomsCableLength, configurationGroup=configurationGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, alarms=alarms, telnetPortNumber=telnetPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerPortNumber=sNTPServerPortNumber, transmitModulationMode=transmitModulationMode, sNTPSync=sNTPSync, maximumTransmitPower=maximumTransmitPower, hTTPSPortNumber=hTTPSPortNumber, syslogControlGroup=syslogControlGroup, transmitFreqMHz=transmitFreqMHz, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vectorError=vectorError, userPassword=userPassword, telnetAccessEnabled=telnetAccessEnabled, transmitDataRate=transmitDataRate, syslogClientTrap=syslogClientTrap, ptpTrapPrefix=ptpTrapPrefix, userTable=userTable, secondarySoftwareVersion=secondarySoftwareVersion, telecomsChannelStatus=telecomsChannelStatus, dataPortStatusTrap=dataPortStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, cableLoss=cableLoss, receiveFreqMHz=receiveFreqMHz, bootVersion=bootVersion, receiveModulationModeDetail=receiveModulationModeDetail, phyControl=phyControl, searchState=searchState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, antennaGain=antennaGain, PYSNMP_MODULE_ID=cambium, vLANManagementVID=vLANManagementVID, iPAddress=iPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPSyncTrap=sNTPSyncTrap, resetGroup=resetGroup, productName=productName, capacityLicenseMismatch=capacityLicenseMismatch, pubStatsGroup=pubStatsGroup, smtp=smtp, channelChangeTrap=channelChangeTrap, installArmState=installArmState, longitude=longitude, dataPortAutoNegotiation=dataPortAutoNegotiation, siteName=siteName, byteErrorRatio=byteErrorRatio, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapVersion=sNMPTrapVersion, ptpCompliance=ptpCompliance, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, ethernetGroup=ethernetGroup, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl)
