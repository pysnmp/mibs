...
NotificationType, Unsigned32, Gauge32, MibIdentifier, Integer32, Counter32, Counter64, enterprises, Bits, TimeTicks, IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "Gauge32", "MibIdentifier", "Integer32", "Counter32", "Counter64", "enterprises", "Bits", "TimeTicks", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", resetGroup=resetGroup, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqKHz=receiveFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, productName=productName, userTableIndex=userTableIndex, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, reset=reset, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsInterface=telecomsInterface, sntp=sntp, tDDControl=tDDControl, dataPortStatus=dataPortStatus, sNMPv3Enable=sNMPv3Enable, vLANPriorityTableIndex=vLANPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimisation=linkModeOptimisation, installArmState=installArmState, transmitChannel=transmitChannel, aAAControlGroup=aAAControlGroup, ethernet=ethernet, sNMPEnabledTraps=sNMPEnabledTraps, sNTPState=sNTPState, installStatusTrap=installStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp=ptp, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarning=dataPortDisabledWarning, userName=userName, transmitFreqKHz=transmitFreqKHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitModulationMode=transmitModulationMode, smtp=smtp, management=management, sNTPSync=sNTPSync, accessMethod=accessMethod, ethernetGroup=ethernetGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bandwidthVariant=bandwidthVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, range=range, telecomsLoopback=telecomsLoopback, receiveFreqMHz=receiveFreqMHz, hardwareVersion=hardwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityLicenseMismatch=capacityLicenseMismatch, sNMPPortNumber=sNMPPortNumber, vLANManagementPriority=vLANManagementPriority, installStatus=installStatus, sMTPEmailAlert=sMTPEmailAlert, remoteIPAddress=remoteIPAddress, dataPortAutoMdix=dataPortAutoMdix, transmitFreqMHz=transmitFreqMHz, sNTPLastSync=sNTPLastSync, telnetPortNumber=telnetPortNumber, supplementaryGroup=supplementaryGroup, regionCode=regionCode, hTTPPortNumber=hTTPPortNumber, licensedCapacity=licensedCapacity, systemReset=systemReset, telnetAccessEnabled=telnetAccessEnabled, sntpGroup=sntpGroup, vectorError=vectorError, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPAddress=iPAddress, dfs=dfs, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userRole=userRole, vLANPriorityTable=vLANPriorityTable, snmpControlGroup=snmpControlGroup, telecomsLineCode=telecomsLineCode, linkSymmetry=linkSymmetry, configuration=configuration, sMTPServerPortNumber=sMTPServerPortNumber, supplementary=supplementary, PYSNMP_MODULE_ID=cambium, frequencyVariant=frequencyVariant, sNTPServerIPAddress=sNTPServerIPAddress, timeZone=timeZone, masterSlaveMode=masterSlaveMode, userEnabled=userEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkName=linkName, notificationsGroup=notificationsGroup, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsCableLength=telecomsCableLength, vLANPriorityTableEntry=vLANPriorityTableEntry, dfsTableIndex=dfsTableIndex, byteErrorRatio=byteErrorRatio, altitude=altitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, pubStatsGroup=pubStatsGroup, encryption=encryption, syslogStateTrap=syslogStateTrap, hTTPSPortNumber=hTTPSPortNumber, latitude=latitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTable=dfsTable, antennaGain=antennaGain, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, softwareVersion=softwareVersion, ptmp=ptmp, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerIPAddress=tFTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, smtpGroup=smtpGroup, eIRP=eIRP, syslogControlGroup=syslogControlGroup, syslogClientTrap=syslogClientTrap, sNMPTrapVersion=sNMPTrapVersion, constantPowerSpectralDensity=constantPowerSpectralDensity, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, unitOutOfCalibration=unitOutOfCalibration, receiveChannel=receiveChannel, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, snmpControl=snmpControl, aAAControl=aAAControl, pubStats=pubStats, syslogControl=syslogControl, sNMPTrapTable=sNMPTrapTable, hTTPSAccessEnabled=hTTPSAccessEnabled, phyControlGroup=phyControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, phyControl=phyControl, installArmStateTrap=installArmStateTrap, licenceGroup=licenceGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aggregateDataRate=aggregateDataRate, receiveModulationModeDetail=receiveModulationModeDetail, receiveModulationMode=receiveModulationMode, dfsTableEntry=dfsTableEntry, channelBandwidth=channelBandwidth, sNMPTrapTableNumber=sNMPTrapTableNumber, managementGroup=managementGroup, userPassword=userPassword, ptpTraps=ptpTraps, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsMeans=dfsMeans, dataPortConfigurationMismatch=dataPortConfigurationMismatch, versions=versions, versionsGroup=versionsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpCompliance=ptpCompliance, hTTPAccessEnabled=hTTPAccessEnabled, telecom=telecom, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, phyStatus=phyStatus, sMTPServerIPAddress=sMTPServerIPAddress, userTableNumber=userTableNumber, encryptionGroup=encryptionGroup, ptp500=ptp500, bootVersion=bootVersion, cableLoss=cableLoss, wirelessLinkAvailability=wirelessLinkAvailability, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, alarms=alarms, licence=licence, telecomGroup=telecomGroup, userTable=userTable, dataPortAutoNegotiation=dataPortAutoNegotiation, signalStrengthRatio=signalStrengthRatio, dfsGroup=dfsGroup, tFTPServerPortNumber=tFTPServerPortNumber, channelChangeTrap=channelChangeTrap, tDDControlGroup=tDDControlGroup, cambium=cambium, telecomsChannelStatus=telecomsChannelStatus, linkLoss=linkLoss, syslogClient=syslogClient, useVLANForManagementInterfaces=useVLANForManagementInterfaces, systemClock=systemClock, regionCodeTrap=regionCodeTrap, sNMPCommunityString=sNMPCommunityString, searchState=searchState, ptpTrapPrefix=ptpTrapPrefix, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, encryptionAlgorithm=encryptionAlgorithm, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableNumber=dfsTableNumber, siteName=siteName, ptpGroups=ptpGroups, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, subnetMask=subnetMask, phyStatusGroup=phyStatusGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogState=syslogState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receivePower=receivePower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerPortNumber=sNTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveDataRate=receiveDataRate, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsPeaks=dfsPeaks, longitude=longitude, targetMACAddress=targetMACAddress, transmitDataRate=transmitDataRate, groupID=groupID)
