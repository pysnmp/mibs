...
Unsigned32, IpAddress, Bits, Counter64, Counter32, NotificationType, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ModuleIdentity, Integer32, MibIdentifier, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Bits", "Counter64", "Counter32", "NotificationType", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ModuleIdentity", "Integer32", "MibIdentifier", "Gauge32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, constantPowerSpectralDensity=constantPowerSpectralDensity, linkLoss=linkLoss, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableEntry=sNMPTrapTableEntry, encryptionAlgorithm=encryptionAlgorithm, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPTrapTable=sNMPTrapTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receivePower=receivePower, ptmp=ptmp, regionCode=regionCode, cambium=cambium, hTTPAccessEnabled=hTTPAccessEnabled, resetGroup=resetGroup, groupID=groupID, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogStateTrap=syslogStateTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, siteName=siteName, vectorError=vectorError, encryption=encryption, receiveDataRate=receiveDataRate, ethernet=ethernet, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, targetMACAddress=targetMACAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userPassword=userPassword, dfs=dfs, licensedCapacity=licensedCapacity, tFTPServerIPAddress=tFTPServerIPAddress, accessMethod=accessMethod, telecomsLineCode=telecomsLineCode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPPollInterval=sNTPPollInterval, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStatsGroup=pubStatsGroup, telecomGroup=telecomGroup, sNMPPortNumber=sNMPPortNumber, phyStatusGroup=phyStatusGroup, dfsTableEntry=dfsTableEntry, receiveFreqMHz=receiveFreqMHz, userRole=userRole, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, softwareVersion=softwareVersion, PYSNMP_MODULE_ID=cambium, telecomsInterface=telecomsInterface, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userEnabled=userEnabled, capacityLicenseMismatch=capacityLicenseMismatch, dataPortAutoMdix=dataPortAutoMdix, sNTPLastSync=sNTPLastSync, licenceGroup=licenceGroup, receiveFreqKHz=receiveFreqKHz, productVariant=productVariant, smtp=smtp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogClient=syslogClient, dataPortStatusTrap=dataPortStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licence=licence, management=management, configuration=configuration, sNTPSync=sNTPSync, wirelessLinkStatus=wirelessLinkStatus, phyStatus=phyStatus, receiveModulationModeDetail=receiveModulationModeDetail, aAAControl=aAAControl, dfsTable=dfsTable, userTableEntry=userTableEntry, userTable=userTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sntpGroup=sntpGroup, transmitChannel=transmitChannel, ptp=ptp, systemReset=systemReset, transmitDataRate=transmitDataRate, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, syslogControl=syslogControl, vLANManagementVID=vLANManagementVID, vLANPriorityTableNumber=vLANPriorityTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installArmStateTrap=installArmStateTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStats=pubStats, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaGain=antennaGain, incompatibleRegionCodes=incompatibleRegionCodes, byteErrorRatio=byteErrorRatio, telecomsCableLength=telecomsCableLength, encryptionGroup=encryptionGroup, vLANPriorityTable=vLANPriorityTable, longitude=longitude, sNMPCommunityString=sNMPCommunityString, bandwidthVariant=bandwidthVariant, bootVersion=bootVersion, dataPortDisabledWarning=dataPortDisabledWarning, userTableIndex=userTableIndex, ethernetFiberSupport=ethernetFiberSupport, transmitFreqKHz=transmitFreqKHz, iPAddress=iPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ethernetGroup=ethernetGroup, reset=reset, sNMPTrapPortNumber=sNMPTrapPortNumber, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, signalStrengthRatio=signalStrengthRatio, productName=productName, dfsTableNumber=dfsTableNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, smtpGroup=smtpGroup, telnetPortNumber=telnetPortNumber, receiveChannel=receiveChannel, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, sNMPTrapVersion=sNMPTrapVersion, hTTPSPortNumber=hTTPSPortNumber, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, unitOutOfCalibration=unitOutOfCalibration, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPv3Enable=sNMPv3Enable, masterSlaveMode=masterSlaveMode, linkSymmetry=linkSymmetry, vLANManagementPriority=vLANManagementPriority, supplementaryGroup=supplementaryGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpCompliance=ptpCompliance, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, range=range, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, dataPortAutoNegotiation=dataPortAutoNegotiation, linkModeOptimisation=linkModeOptimisation, dfsGroup=dfsGroup, dfsPeaks=dfsPeaks, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, frequencyVariant=frequencyVariant, sNTPServerIPAddress=sNTPServerIPAddress, altitude=altitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, subnetMask=subnetMask, linkName=linkName, aAAControlGroup=aAAControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, installStatus=installStatus, syslogControlGroup=syslogControlGroup, cableLoss=cableLoss, syslogClientTrap=syslogClientTrap, notificationsGroup=notificationsGroup, installStatusTrap=installStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPPortNumber=hTTPPortNumber, eIRP=eIRP, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsLoopback=telecomsLoopback, wirelessLinkAvailability=wirelessLinkAvailability, telnetAccessEnabled=telnetAccessEnabled, channelBandwidth=channelBandwidth, configurationGroup=configurationGroup, installArmState=installArmState, alarms=alarms, ptp500=ptp500, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, snmpControl=snmpControl, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogState=syslogState, searchState=searchState, aggregateDataRate=aggregateDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, supplementary=supplementary, userName=userName, dfsMeans=dfsMeans, sMTPEmailAlert=sMTPEmailAlert, secondarySoftwareVersion=secondarySoftwareVersion, transmitFreqMHz=transmitFreqMHz, regionCodeTrap=regionCodeTrap, versions=versions, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, sMTPServerPortNumber=sMTPServerPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, latitude=latitude, alarmsGroup=alarmsGroup, tDDControlGroup=tDDControlGroup, phyControl=phyControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPState=sNTPState, tDDControl=tDDControl, ptpTraps=ptpTraps, ptpGroups=ptpGroups, dataPortStatus=dataPortStatus, timeZone=timeZone, transmitModulationMode=transmitModulationMode, telecom=telecom, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpTrapPrefix=ptpTrapPrefix, managementGroup=managementGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableNumber=userTableNumber, telecomsChannelStatus=telecomsChannelStatus)
