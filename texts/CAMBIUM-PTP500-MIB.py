...
# Produced by pysmi-1.1.3 at Wed Dec  8 18:56:14 2021
...
Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, Integer32, ObjectIdentity, NotificationType, MibIdentifier, Unsigned32, ModuleIdentity, IpAddress, TimeTicks, iso, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "Integer32", "ObjectIdentity", "NotificationType", "MibIdentifier", "Unsigned32", "ModuleIdentity", "IpAddress", "TimeTicks", "iso", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPServerPortNumber=tFTPServerPortNumber, sNTPState=sNTPState, syslogClientTrap=syslogClientTrap, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveModulationModeDetail=receiveModulationModeDetail, configuration=configuration, tDDSynchronizationMode=tDDSynchronizationMode, sNMPCommunityString=sNMPCommunityString, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licensedCapacity=licensedCapacity, telecomsInterface=telecomsInterface, telnetAccessEnabled=telnetAccessEnabled, vectorError=vectorError, timeZone=timeZone, syslogClient=syslogClient, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionGroup=encryptionGroup, masterSlaveMode=masterSlaveMode, channelChangeTrap=channelChangeTrap, ptmp=ptmp, searchState=searchState, telecom=telecom, accessMethod=accessMethod, bandwidthVariant=bandwidthVariant, groupID=groupID, vLANManagementVID=vLANManagementVID, sNTPServerPortNumber=sNTPServerPortNumber, versionsGroup=versionsGroup, sNMPTrapVersion=sNMPTrapVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitPower=transmitPower, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsMeans=dfsMeans, vLANPriorityQueueMapping=vLANPriorityQueueMapping, channelBandwidth=channelBandwidth, management=management, userTableIndex=userTableIndex, dataPortAutoMdix=dataPortAutoMdix, resetGroup=resetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyControlGroup=phyControlGroup, supplementary=supplementary, installArmStateTrap=installArmStateTrap, ethernetGroup=ethernetGroup, userPassword=userPassword, dataPortConfigurationMismatch=dataPortConfigurationMismatch, smtpGroup=smtpGroup, dfsTable=dfsTable, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteIPAddress=remoteIPAddress, sNTPSyncTrap=sNTPSyncTrap, transmitFreqKHz=transmitFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkStatus=wirelessLinkStatus, userTableEntry=userTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLineCode=telecomsLineCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortStatus=dataPortStatus, aAAControl=aAAControl, managementGroup=managementGroup, vLANManagementPriority=vLANManagementPriority, receivePower=receivePower, longitude=longitude, ptpTrapPrefix=ptpTrapPrefix, sMTPServerPortNumber=sMTPServerPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerIPAddress=sNTPServerIPAddress, installStatusTrap=installStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, antennaGain=antennaGain, telecomsLoopbackTrap=telecomsLoopbackTrap, range=range, transmitModulationMode=transmitModulationMode, siteName=siteName, licence=licence, sntp=sntp, hTTPAccessEnabled=hTTPAccessEnabled, hTTPPortNumber=hTTPPortNumber, userTableNumber=userTableNumber, cambium=cambium, installStatus=installStatus, iPAddress=iPAddress, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapPortNumber=sNMPTrapPortNumber, phyStatus=phyStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, supplementaryGroup=supplementaryGroup, telecomsCableLength=telecomsCableLength, cableLoss=cableLoss, receiveFreqKHz=receiveFreqKHz, frequencyVariant=frequencyVariant, encryptionAlgorithm=encryptionAlgorithm, ethernet=ethernet, vLANPriorityTableIndex=vLANPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, maximumTransmitPower=maximumTransmitPower, ptp500=ptp500, ptpCompliance=ptpCompliance, unitOutOfCalibration=unitOutOfCalibration, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, encryption=encryption, pubStatsGroup=pubStatsGroup, productName=productName, hTTPSPortNumber=hTTPSPortNumber, systemClock=systemClock, altitude=altitude, smtp=smtp, telecomGroup=telecomGroup, sntpGroup=sntpGroup, productVariant=productVariant, dfsPeaks=dfsPeaks, syslogState=syslogState, constantPowerSpectralDensity=constantPowerSpectralDensity, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPServerIPAddress=tFTPServerIPAddress, regionCode=regionCode, telecomsLoopback=telecomsLoopback, sNMPTrapIPAddress=sNMPTrapIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, receiveModulationMode=receiveModulationMode, transmitChannel=transmitChannel, receiveFreqMHz=receiveFreqMHz, userName=userName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licenceGroup=licenceGroup, aggregateDataRate=aggregateDataRate, byteErrorRatio=byteErrorRatio, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, reset=reset, daylightSaving=daylightSaving, ethernetFiberSupport=ethernetFiberSupport, sMTPServerIPAddress=sMTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, systemReset=systemReset, latitude=latitude, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDControl=tDDControl, snmpControlGroup=snmpControlGroup, receiveChannel=receiveChannel, installArmState=installArmState, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationStatus=tDDSynchronizationStatus, aAAControlGroup=aAAControlGroup, syslogControl=syslogControl, dfsTableNumber=dfsTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkName=linkName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDControlGroup=tDDControlGroup, telecomsChannelStatus=telecomsChannelStatus, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, sNTPSync=sNTPSync, sNMPTrapTable=sNMPTrapTable, dfsGroup=dfsGroup, userRole=userRole, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPPortNumber=sNMPPortNumber, transmitDataRate=transmitDataRate, dfs=dfs, eIRP=eIRP, versions=versions, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogStateTrap=syslogStateTrap, subnetMask=subnetMask, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANPriorityTable=vLANPriorityTable, notificationsGroup=notificationsGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveDataRate=receiveDataRate, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, sMTPEmailAlert=sMTPEmailAlert, alarmsGroup=alarmsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, dfsTableIndex=dfsTableIndex, phyStatusGroup=phyStatusGroup, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, linkSymmetry=linkSymmetry, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, configurationGroup=configurationGroup, dfsTableEntry=dfsTableEntry, bootVersion=bootVersion, vLANPriorityTableEntry=vLANPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptp=ptp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userEnabled=userEnabled, alarms=alarms, targetMACAddress=targetMACAddress, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, softwareVersion=softwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpGroups=ptpGroups, phyControl=phyControl, userTable=userTable, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPPollInterval=sNTPPollInterval, linkLoss=linkLoss, syslogControlGroup=syslogControlGroup, pubStats=pubStats, sMTPEnabledMessages=sMTPEnabledMessages)
