...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityString=sNMPCommunityString, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveFreqMHz=receiveFreqMHz, tDDControl=tDDControl, timeZone=timeZone, channelBandwidth=channelBandwidth, channelChangeTrap=channelChangeTrap, userTable=userTable, telecomsChannelStatus=telecomsChannelStatus, telecomsCableLength=telecomsCableLength, receiveModulationMode=receiveModulationMode, management=management, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, userName=userName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPPollInterval=sNTPPollInterval, linkName=linkName, linkLoss=linkLoss, searchState=searchState, capacityLicenseMismatch=capacityLicenseMismatch, alarms=alarms, smtpGroup=smtpGroup, sntp=sntp, sNMPTrapPortNumber=sNMPTrapPortNumber, notificationsGroup=notificationsGroup, sNTPServerIPAddress=sNTPServerIPAddress, supplementaryGroup=supplementaryGroup, secondarySoftwareVersion=secondarySoftwareVersion, dfsGroup=dfsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, unitOutOfCalibration=unitOutOfCalibration, configurationGroup=configurationGroup, pubStatsGroup=pubStatsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, encryption=encryption, phyStatus=phyStatus, cableLoss=cableLoss, ethernet=ethernet, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tFTPServerIPAddress=tFTPServerIPAddress, dfsTableEntry=dfsTableEntry, receiveFreqKHz=receiveFreqKHz, ptpTrapPrefix=ptpTrapPrefix, sNMPv3Enable=sNMPv3Enable, range=range, configuration=configuration, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, tDDControlGroup=tDDControlGroup, dfsPeaks=dfsPeaks, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkAvailability=wirelessLinkAvailability, hTTPPortNumber=hTTPPortNumber, userTableEntry=userTableEntry, licenceGroup=licenceGroup, cambium=cambium, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, userPassword=userPassword, accessMethod=accessMethod, managementGroup=managementGroup, altitude=altitude, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptmp=ptmp, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpGroups=ptpGroups, latitude=latitude, regionCodeTrap=regionCodeTrap, dfs=dfs, syslogStateTrap=syslogStateTrap, transmitPower=transmitPower, productName=productName, hardwareVersion=hardwareVersion, syslogControl=syslogControl, transmitFreqKHz=transmitFreqKHz, encryptionGroup=encryptionGroup, telecomGroup=telecomGroup, phyStatusGroup=phyStatusGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, userRole=userRole, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, antennaGain=antennaGain, telecomsInterface=telecomsInterface, sNMPTrapTableNumber=sNMPTrapTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, licensedCapacity=licensedCapacity, syslogClient=syslogClient, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemReset=systemReset, phyControl=phyControl, groupID=groupID, dataPortDisabledWarning=dataPortDisabledWarning, iPAddress=iPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, aggregateDataRate=aggregateDataRate, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPServerPortNumber=sNTPServerPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, masterSlaveMode=masterSlaveMode, transmitFreqMHz=transmitFreqMHz, dfsMeans=dfsMeans, byteErrorRatio=byteErrorRatio, sNTPSync=sNTPSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, subnetMask=subnetMask, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveChannel=receiveChannel, ptpTraps=ptpTraps, dfsTable=dfsTable, aAAControl=aAAControl, dfsTableNumber=dfsTableNumber, regionCode=regionCode, syslogControlGroup=syslogControlGroup, installStatus=installStatus, resetGroup=resetGroup, receiveModulationModeDetail=receiveModulationModeDetail, PYSNMP_MODULE_ID=cambium, phyControlGroup=phyControlGroup, dataPortStatus=dataPortStatus, encryptionAlgorithm=encryptionAlgorithm, sMTPServerIPAddress=sMTPServerIPAddress, transmitChannel=transmitChannel, ptpCompliance=ptpCompliance, versionsGroup=versionsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, frequencyVariant=frequencyVariant, longitude=longitude, sNTPState=sNTPState, snmpControlGroup=snmpControlGroup, receiveDataRate=receiveDataRate, licence=licence, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPEnabledTraps=sNMPEnabledTraps, smtp=smtp, syslogClientTrap=syslogClientTrap, telnetPortNumber=telnetPortNumber, telecomsLoopback=telecomsLoopback, ptp=ptp, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPPortNumber=sNMPPortNumber, vLANPriorityTable=vLANPriorityTable, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vectorError=vectorError, linkModeOptimisation=linkModeOptimisation, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, ptp500=ptp500, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANPriorityTableNumber=vLANPriorityTableNumber, productVariant=productVariant, userTableNumber=userTableNumber, vLANManagementPriority=vLANManagementPriority, userTableIndex=userTableIndex, telnetAccessEnabled=telnetAccessEnabled, daylightSaving=daylightSaving, sMTPEmailAlert=sMTPEmailAlert, bootVersion=bootVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, gatewayIPAddress=gatewayIPAddress, supplementary=supplementary, userEnabled=userEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, bandwidthVariant=bandwidthVariant, receivePower=receivePower, versions=versions, linkSymmetry=linkSymmetry, targetMACAddress=targetMACAddress, telecomsLineCode=telecomsLineCode, sNMPTrapVersion=sNMPTrapVersion, reset=reset, sntpGroup=sntpGroup, ethernetFiberSupport=ethernetFiberSupport, pubStats=pubStats, remoteIPAddress=remoteIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, signalStrengthRatio=signalStrengthRatio, ethernetGroup=ethernetGroup, dfsTableIndex=dfsTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, siteName=siteName, installArmStateTrap=installArmStateTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapTable=sNMPTrapTable, hTTPAccessEnabled=hTTPAccessEnabled, syslogState=syslogState, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, sNTPLastSync=sNTPLastSync, installStatusTrap=installStatusTrap, telecom=telecom, aAAControlGroup=aAAControlGroup, snmpControl=snmpControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert)
