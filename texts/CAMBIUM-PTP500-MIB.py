...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hardwareVersion=hardwareVersion, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCode=regionCode, telnetPortNumber=telnetPortNumber, dfsPeaks=dfsPeaks, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, cambium=cambium, telecomGroup=telecomGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControlGroup=aAAControlGroup, byteErrorRatio=byteErrorRatio, syslogState=syslogState, telecomsCableLength=telecomsCableLength, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPAccessEnabled=hTTPAccessEnabled, linkModeOptimisation=linkModeOptimisation, syslogClientTrap=syslogClientTrap, supplementary=supplementary, encryptionAlgorithm=encryptionAlgorithm, userPassword=userPassword, searchState=searchState, sNTPServerIPAddress=sNTPServerIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, telecom=telecom, syslogStateTrap=syslogStateTrap, management=management, remoteMaximumTransmitPower=remoteMaximumTransmitPower, versionsGroup=versionsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetGroup=ethernetGroup, ptpCompliance=ptpCompliance, userEnabled=userEnabled, vLANPriorityTableEntry=vLANPriorityTableEntry, productVariant=productVariant, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryption=encryption, hTTPSAccessEnabled=hTTPSAccessEnabled, userTableNumber=userTableNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelBandwidth=channelBandwidth, groupID=groupID, licensedCapacity=licensedCapacity, sNTPServerPortNumber=sNTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, userTableIndex=userTableIndex, smtp=smtp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userName=userName, supplementaryGroup=supplementaryGroup, ptpTrapPrefix=ptpTrapPrefix, receiveChannel=receiveChannel, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControl=aAAControl, dfsTable=dfsTable, transmitFreqMHz=transmitFreqMHz, masterSlaveMode=masterSlaveMode, sMTPServerIPAddress=sMTPServerIPAddress, phyStatus=phyStatus, telecomsLoopback=telecomsLoopback, sNMPCommunityString=sNMPCommunityString, sNMPTrapVersion=sNMPTrapVersion, syslogClient=syslogClient, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, configuration=configuration, ptmp=ptmp, tDDControlGroup=tDDControlGroup, sNTPPollInterval=sNTPPollInterval, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationMode=tDDSynchronizationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPAddress=iPAddress, notificationsGroup=notificationsGroup, tDDControl=tDDControl, linkName=linkName, frequencyVariant=frequencyVariant, linkLoss=linkLoss, pubStats=pubStats, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp=ptp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStatsGroup=pubStatsGroup, softwareVersion=softwareVersion, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, telecomsChannelStatus=telecomsChannelStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, range=range, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpGroups=ptpGroups, ethernet=ethernet, syslogControlGroup=syslogControlGroup, linkSymmetry=linkSymmetry, capacityLicenseMismatch=capacityLicenseMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, licenceGroup=licenceGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTable=userTable, subnetMask=subnetMask, siteName=siteName, transmitFreqKHz=transmitFreqKHz, phyControlGroup=phyControlGroup, antennaGain=antennaGain, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCodeTrap=regionCodeTrap, licence=licence, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, channelChangeTrap=channelChangeTrap, productName=productName, receiveFreqKHz=receiveFreqKHz, accessMethod=accessMethod, telnetAccessEnabled=telnetAccessEnabled, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPSyncTrap=sNTPSyncTrap, sNTPLastSync=sNTPLastSync, dfsGroup=dfsGroup, installArmState=installArmState, vLANManagementPriority=vLANManagementPriority, daylightSaving=daylightSaving, systemClock=systemClock, altitude=altitude, sMTPEnabledMessages=sMTPEnabledMessages, latitude=latitude, alarms=alarms, installStatusTrap=installStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveModulationMode=receiveModulationMode, sntpGroup=sntpGroup, encryptionGroup=encryptionGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANPriorityTable=vLANPriorityTable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsLineCode=telecomsLineCode, dfsTableIndex=dfsTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, transmitChannel=transmitChannel, vectorError=vectorError, reset=reset, longitude=longitude, systemReset=systemReset, receiveFreqMHz=receiveFreqMHz, syslogControl=syslogControl, remoteIPAddress=remoteIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, unitOutOfCalibration=unitOutOfCalibration, timeZone=timeZone, tDDSynchronizationAlarm=tDDSynchronizationAlarm, cableLoss=cableLoss, maximumTransmitPower=maximumTransmitPower, dfs=dfs, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsMeans=dfsMeans, tFTPServerPortNumber=tFTPServerPortNumber, vLANManagementVID=vLANManagementVID, alarmsGroup=alarmsGroup, configurationGroup=configurationGroup, bandwidthVariant=bandwidthVariant, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoMdix=dataPortAutoMdix, dfsTableNumber=dfsTableNumber, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receivePower=receivePower, sntp=sntp, sNTPState=sNTPState, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortDisabledWarning=dataPortDisabledWarning, smtpGroup=smtpGroup, dataPortStatus=dataPortStatus, telecomsInterface=telecomsInterface, vLANPriorityTableIndex=vLANPriorityTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, resetGroup=resetGroup, ptpTraps=ptpTraps, wirelessLinkAvailability=wirelessLinkAvailability, installStatus=installStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp500=ptp500, phyControl=phyControl, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, noWirelessChannelAvailable=noWirelessChannelAvailable, gatewayIPAddress=gatewayIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmStateTrap=installArmStateTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userRole=userRole, transmitPower=transmitPower, wirelessLinkStatus=wirelessLinkStatus, ethernetFiberSupport=ethernetFiberSupport, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, dfsTableEntry=dfsTableEntry, bootVersion=bootVersion, eIRP=eIRP, versions=versions)
