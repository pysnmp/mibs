...
# Produced by pysmi-1.1.8 at Thu Jan 13 23:38:05 2022
...
ModuleIdentity, IpAddress, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64, MibIdentifier, Gauge32, Unsigned32, iso, Counter32, Bits, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64", "MibIdentifier", "Gauge32", "Unsigned32", "iso", "Counter32", "Bits", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogClientTrap=syslogClientTrap, syslogControl=syslogControl, management=management, vLANPriorityTableEntry=vLANPriorityTableEntry, ptpGroups=ptpGroups, constantPowerSpectralDensity=constantPowerSpectralDensity, userPassword=userPassword, iPAddress=iPAddress, installStatus=installStatus, searchState=searchState, sNMPTrapTableNumber=sNMPTrapTableNumber, dfs=dfs, sMTPServerPortNumber=sMTPServerPortNumber, alarmsGroup=alarmsGroup, linkLoss=linkLoss, bandwidthVariant=bandwidthVariant, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANPriorityTable=vLANPriorityTable, userTable=userTable, systemReset=systemReset, dfsTableNumber=dfsTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, longitude=longitude, telecomGroup=telecomGroup, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, reset=reset, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, licenceGroup=licenceGroup, configuration=configuration, productName=productName, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, subnetMask=subnetMask, antennaGain=antennaGain, hTTPAccessEnabled=hTTPAccessEnabled, userTableIndex=userTableIndex, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitDataRate=transmitDataRate, targetMACAddress=targetMACAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemClock=systemClock, eIRP=eIRP, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPv3Enable=sNMPv3Enable, cableLoss=cableLoss, bootVersion=bootVersion, groupID=groupID, linkSymmetry=linkSymmetry, altitude=altitude, wirelessLinkAvailability=wirelessLinkAvailability, range=range, userTableEntry=userTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, cambium=cambium, timeZone=timeZone, ptmp=ptmp, transmitFreqKHz=transmitFreqKHz, byteErrorRatio=byteErrorRatio, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, linkName=linkName, telecom=telecom, pubStats=pubStats, syslogStateTrap=syslogStateTrap, pubStatsGroup=pubStatsGroup, receiveFreqMHz=receiveFreqMHz, telnetPortNumber=telnetPortNumber, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, receiveFreqKHz=receiveFreqKHz, sNMPTrapTable=sNMPTrapTable, sNMPCommunityString=sNMPCommunityString, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPState=sNTPState, syslogState=syslogState, transmitPower=transmitPower, phyControl=phyControl, ptp500=ptp500, sNMPPortNumber=sNMPPortNumber, productVariant=productVariant, installArmState=installArmState, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapIPAddress=sNMPTrapIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userRole=userRole, ptpCompliance=ptpCompliance, smtp=smtp, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, configurationGroup=configurationGroup, telecomsLoopback=telecomsLoopback, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, supplementary=supplementary, aAAControl=aAAControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, signalStrengthRatio=signalStrengthRatio, accessMethod=accessMethod, sNMPTrapVersion=sNMPTrapVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, versions=versions, userEnabled=userEnabled, phyStatusGroup=phyStatusGroup, dataPortAutoMdix=dataPortAutoMdix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetFiberSupport=ethernetFiberSupport, capacityLicenseMismatch=capacityLicenseMismatch, hTTPPortNumber=hTTPPortNumber, sNTPPollInterval=sNTPPollInterval, latitude=latitude, dataPortDisabledWarning=dataPortDisabledWarning, encryption=encryption, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControlGroup=tDDControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsGroup=dfsGroup, regionCode=regionCode, sNTPServerIPAddress=sNTPServerIPAddress, dataPortStatus=dataPortStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControlGroup=aAAControlGroup, ptpTrapPrefix=ptpTrapPrefix, supplementaryGroup=supplementaryGroup, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDSynchronizationMode=tDDSynchronizationMode, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, softwareVersion=softwareVersion, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPEmailAlert=sMTPEmailAlert, ethernetGroup=ethernetGroup, sNTPLastSync=sNTPLastSync, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBandwidth=channelBandwidth, tFTPServerPortNumber=tFTPServerPortNumber, phyStatus=phyStatus, installStatusTrap=installStatusTrap, managementGroup=managementGroup, siteName=siteName, sntpGroup=sntpGroup, masterSlaveMode=masterSlaveMode, notificationsGroup=notificationsGroup, sMTPEnabledMessages=sMTPEnabledMessages, dfsTableEntry=dfsTableEntry, vLANManagementVID=vLANManagementVID, dfsPeaks=dfsPeaks, sNTPSyncTrap=sNTPSyncTrap, ptpTraps=ptpTraps, telnetAccessEnabled=telnetAccessEnabled, syslogClient=syslogClient, alarms=alarms, licence=licence, smtpGroup=smtpGroup, dfsTableIndex=dfsTableIndex, daylightSaving=daylightSaving, dfsMeans=dfsMeans, licensedCapacity=licensedCapacity, snmpControl=snmpControl, telecomsLineCode=telecomsLineCode, maximumTransmitPower=maximumTransmitPower, channelChangeTrap=channelChangeTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitModulationMode=transmitModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitChannel=transmitChannel, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, incompatibleRegionCodes=incompatibleRegionCodes, sNMPEnabledTraps=sNMPEnabledTraps, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryptionGroup=encryptionGroup, resetGroup=resetGroup, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPServerIPAddress=sMTPServerIPAddress, telecomsInterface=telecomsInterface, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, telecomsCableLength=telecomsCableLength, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControlGroup=syslogControlGroup, regionCodeTrap=regionCodeTrap, versionsGroup=versionsGroup, userTableNumber=userTableNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveChannel=receiveChannel, frequencyVariant=frequencyVariant, receivePower=receivePower, vectorError=vectorError, ptp=ptp, userName=userName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyControlGroup=phyControlGroup, linkModeOptimisation=linkModeOptimisation, sNTPSync=sNTPSync, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDControl=tDDControl, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, dfsTable=dfsTable)
