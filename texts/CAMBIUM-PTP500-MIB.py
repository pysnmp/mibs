...
enterprises, TimeTicks, Gauge32, NotificationType, Counter64, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Unsigned32, ModuleIdentity, Integer32, iso, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "TimeTicks", "Gauge32", "NotificationType", "Counter64", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Integer32", "iso", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installStatus=installStatus, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPv3Enable=sNMPv3Enable, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp=ptp, iPAddress=iPAddress, managementGroup=managementGroup, groupID=groupID, userPassword=userPassword, siteName=siteName, telecom=telecom, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogClientTrap=syslogClientTrap, notificationsGroup=notificationsGroup, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsLoopback=telecomsLoopback, licence=licence, linkName=linkName, sNTPSync=sNTPSync, versions=versions, dataPortConfigurationMismatch=dataPortConfigurationMismatch, daylightSaving=daylightSaving, phyStatus=phyStatus, userTableIndex=userTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, supplementaryGroup=supplementaryGroup, hardwareVersion=hardwareVersion, telecomsChannelStatus=telecomsChannelStatus, linkSymmetry=linkSymmetry, constantPowerSpectralDensity=constantPowerSpectralDensity, signalStrengthRatio=signalStrengthRatio, ptmp=ptmp, receivePower=receivePower, longitude=longitude, sNTPServerPortNumber=sNTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, dfsTable=dfsTable, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSyncTrap=sNTPSyncTrap, userTableEntry=userTableEntry, licensedCapacity=licensedCapacity, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aAAControl=aAAControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernet=ethernet, frequencyVariant=frequencyVariant, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, maximumTransmitPower=maximumTransmitPower, transmitFreqKHz=transmitFreqKHz, userName=userName, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configuration=configuration, latitude=latitude, management=management, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, encryptionGroup=encryptionGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, eIRP=eIRP, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableNumber=dfsTableNumber, syslogState=syslogState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryption=encryption, userTable=userTable, ptpTrapPrefix=ptpTrapPrefix, vLANManagementPriority=vLANManagementPriority, hTTPSPortNumber=hTTPSPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsChannelStatusTrap=telecomsChannelStatusTrap, accessMethod=accessMethod, configurationGroup=configurationGroup, timeZone=timeZone, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, wirelessLinkStatus=wirelessLinkStatus, ptpGroups=ptpGroups, tDDControl=tDDControl, dataPortAutoMdix=dataPortAutoMdix, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, subnetMask=subnetMask, userTableNumber=userTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, PYSNMP_MODULE_ID=cambium, systemReset=systemReset, phyControl=phyControl, supplementary=supplementary, vLANManagementVID=vLANManagementVID, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPServerIPAddress=tFTPServerIPAddress, transmitPower=transmitPower, hTTPPortNumber=hTTPPortNumber, syslogClient=syslogClient, telecomsLineCode=telecomsLineCode, softwareVersion=softwareVersion, dfsMeans=dfsMeans, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, channelChangeTrap=channelChangeTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, gatewayIPAddress=gatewayIPAddress, vLANPriorityTable=vLANPriorityTable, cableLoss=cableLoss, range=range, installArmStateTrap=installArmStateTrap, sMTPServerPortNumber=sMTPServerPortNumber, syslogControlGroup=syslogControlGroup, alarms=alarms, transmitChannel=transmitChannel, capacityLicenseMismatch=capacityLicenseMismatch, wirelessLinkAvailability=wirelessLinkAvailability, syslogControl=syslogControl, sMTPEmailAlert=sMTPEmailAlert, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulationModeDetail=receiveModulationModeDetail, vectorError=vectorError, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, snmpControlGroup=snmpControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDControlGroup=tDDControlGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpCompliance=ptpCompliance, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bandwidthVariant=bandwidthVariant, linkLoss=linkLoss, ptp500=ptp500, dfsTableIndex=dfsTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPState=sNTPState, searchState=searchState, syslogStateTrap=syslogStateTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, masterSlaveMode=masterSlaveMode, versionsGroup=versionsGroup, antennaGain=antennaGain, sNTPPollInterval=sNTPPollInterval, productVariant=productVariant, dfsGroup=dfsGroup, userEnabled=userEnabled, installArmState=installArmState, sNTPLastSync=sNTPLastSync, receiveDataRate=receiveDataRate, phyStatusGroup=phyStatusGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, targetMACAddress=targetMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, userRole=userRole, receiveChannel=receiveChannel, systemClock=systemClock, telecomsCableLength=telecomsCableLength, dfs=dfs, dfsPeaks=dfsPeaks, ptpTraps=ptpTraps, telecomsInterface=telecomsInterface, receiveModulationMode=receiveModulationMode, regionCodeTrap=regionCodeTrap, sntp=sntp, receiveFreqKHz=receiveFreqKHz, sntpGroup=sntpGroup, secondarySoftwareVersion=secondarySoftwareVersion, licenceGroup=licenceGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerIPAddress=sNTPServerIPAddress, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, smtp=smtp, telecomGroup=telecomGroup, dataPortStatus=dataPortStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, regionCode=regionCode, aAAControlGroup=aAAControlGroup, dfsTableEntry=dfsTableEntry, productName=productName, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, telnetPortNumber=telnetPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, snmpControl=snmpControl, telnetAccessEnabled=telnetAccessEnabled, smtpGroup=smtpGroup, cambium=cambium, remoteIPAddress=remoteIPAddress, byteErrorRatio=byteErrorRatio, installStatusTrap=installStatusTrap, altitude=altitude, phyControlGroup=phyControlGroup, reset=reset, resetGroup=resetGroup, pubStatsGroup=pubStatsGroup, ethernetFiberSupport=ethernetFiberSupport, unitOutOfCalibration=unitOutOfCalibration, pubStats=pubStats)
