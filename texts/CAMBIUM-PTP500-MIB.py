...
Integer32, Counter32, IpAddress, Bits, ObjectIdentity, Gauge32, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, enterprises, iso, Counter64, Unsigned32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "IpAddress", "Bits", "ObjectIdentity", "Gauge32", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "enterprises", "iso", "Counter64", "Unsigned32", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkModeOptimizationMismatch=linkModeOptimizationMismatch, alarmsGroup=alarmsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitChannel=transmitChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, snmpControl=snmpControl, dfs=dfs, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configurationGroup=configurationGroup, channelChangeTrap=channelChangeTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryption=encryption, cambium=cambium, productVariant=productVariant, encryptionGroup=encryptionGroup, configuration=configuration, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, latitude=latitude, ethernetFiberSupport=ethernetFiberSupport, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, longitude=longitude, siteName=siteName, remoteIPAddress=remoteIPAddress, smtp=smtp, hTTPSAccessEnabled=hTTPSAccessEnabled, telecom=telecom, PYSNMP_MODULE_ID=cambium, ptpTraps=ptpTraps, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licensedCapacity=licensedCapacity, linkModeOptimisation=linkModeOptimisation, userTable=userTable, snmpControlGroup=snmpControlGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogClientTrap=syslogClientTrap, linkName=linkName, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, smtpGroup=smtpGroup, installStatus=installStatus, dataPortAutoMdix=dataPortAutoMdix, userTableNumber=userTableNumber, telecomsInterface=telecomsInterface, sNTPSync=sNTPSync, ptpCompliance=ptpCompliance, telnetAccessEnabled=telnetAccessEnabled, bootVersion=bootVersion, sMTPEnabledMessages=sMTPEnabledMessages, userEnabled=userEnabled, telecomsCableLength=telecomsCableLength, regionCode=regionCode, managementGroup=managementGroup, userPassword=userPassword, systemReset=systemReset, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTableNumber=vLANPriorityTableNumber, targetMACAddress=targetMACAddress, hTTPPortNumber=hTTPPortNumber, sNMPPortNumber=sNMPPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, notificationsGroup=notificationsGroup, vLANManagementPriority=vLANManagementPriority, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkSymmetry=linkSymmetry, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerPortNumber=sNTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPServerIPAddress=sNTPServerIPAddress, syslogControl=syslogControl, vLANPriorityTable=vLANPriorityTable, sNTPLastSync=sNTPLastSync, telecomsChannelStatusTrap=telecomsChannelStatusTrap, range=range, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsLoopbackTrap=telecomsLoopbackTrap, aAAControl=aAAControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernet=ethernet, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, searchState=searchState, receiveDataRate=receiveDataRate, supplementary=supplementary, dfsTable=dfsTable, receiveModulationModeDetail=receiveModulationModeDetail, telecomsChannelStatus=telecomsChannelStatus, aAAControlGroup=aAAControlGroup, receiveFreqMHz=receiveFreqMHz, pubStatsGroup=pubStatsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortDisabledWarning=dataPortDisabledWarning, sntp=sntp, dfsTableIndex=dfsTableIndex, syslogControlGroup=syslogControlGroup, reset=reset, linkLoss=linkLoss, gatewayIPAddress=gatewayIPAddress, accessMethod=accessMethod, wirelessLinkAvailability=wirelessLinkAvailability, pubStats=pubStats, userName=userName, userTableIndex=userTableIndex, dfsTableNumber=dfsTableNumber, hTTPSPortNumber=hTTPSPortNumber, ptp500=ptp500, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortStatusTrap=dataPortStatusTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpTrapPrefix=ptpTrapPrefix, transmitPower=transmitPower, syslogStateTrap=syslogStateTrap, tDDControlGroup=tDDControlGroup, ptmp=ptmp, channelBandwidth=channelBandwidth, receivePower=receivePower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPollInterval=sNTPPollInterval, userTableEntry=userTableEntry, sNMPv3Enable=sNMPv3Enable, iPAddress=iPAddress, masterSlaveMode=masterSlaveMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapVersion=sNMPTrapVersion, dataPortStatus=dataPortStatus, dfsTableEntry=dfsTableEntry, installArmState=installArmState, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveModulationMode=receiveModulationMode, regionCodeTrap=regionCodeTrap, telecomsLoopback=telecomsLoopback, eIRP=eIRP, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, subnetMask=subnetMask, hTTPAccessEnabled=hTTPAccessEnabled, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userRole=userRole, altitude=altitude, softwareVersion=softwareVersion, daylightSaving=daylightSaving, ptp=ptp, vectorError=vectorError, alarms=alarms, sntpGroup=sntpGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmStateTrap=installArmStateTrap, dfsMeans=dfsMeans, telnetPortNumber=telnetPortNumber, dfsGroup=dfsGroup, sMTPServerPortNumber=sMTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, versionsGroup=versionsGroup, management=management, groupID=groupID, noWirelessChannelAvailable=noWirelessChannelAvailable, unitOutOfCalibration=unitOutOfCalibration, sNTPState=sNTPState, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapTable=sNMPTrapTable, incompatibleRegionCodes=incompatibleRegionCodes, transmitFreqKHz=transmitFreqKHz, transmitFreqMHz=transmitFreqMHz, phyStatus=phyStatus, signalStrengthRatio=signalStrengthRatio, antennaGain=antennaGain, timeZone=timeZone, byteErrorRatio=byteErrorRatio, resetGroup=resetGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, phyStatusGroup=phyStatusGroup, transmitModulationMode=transmitModulationMode, bandwidthVariant=bandwidthVariant, installStatusTrap=installStatusTrap, vLANManagementVID=vLANManagementVID, sNMPTrapTableEntry=sNMPTrapTableEntry, systemClock=systemClock, ethernetGroup=ethernetGroup, telecomsLineCode=telecomsLineCode, dfsPeaks=dfsPeaks, receiveChannel=receiveChannel, supplementaryGroup=supplementaryGroup, licenceGroup=licenceGroup, cableLoss=cableLoss, sNMPEnabledTraps=sNMPEnabledTraps, tFTPServerIPAddress=tFTPServerIPAddress, productName=productName, licence=licence, versions=versions, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, capacityLicenseMismatch=capacityLicenseMismatch, receiveFreqKHz=receiveFreqKHz, secondarySoftwareVersion=secondarySoftwareVersion, phyControl=phyControl, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogState=syslogState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyControlGroup=phyControlGroup, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, telecomGroup=telecomGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, syslogClient=syslogClient, tDDControl=tDDControl)
