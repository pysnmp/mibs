...
iso, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Counter64, ObjectIdentity, NotificationType, MibIdentifier, Integer32, Gauge32, ModuleIdentity, Unsigned32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Counter64", "ObjectIdentity", "NotificationType", "MibIdentifier", "Integer32", "Gauge32", "ModuleIdentity", "Unsigned32", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", configurationGroup=configurationGroup, iPAddress=iPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, syslogClient=syslogClient, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortAutoMdix=dataPortAutoMdix, signalStrengthRatio=signalStrengthRatio, noWirelessChannelAvailable=noWirelessChannelAvailable, alarms=alarms, smtpGroup=smtpGroup, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, latitude=latitude, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, tDDControlGroup=tDDControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, sntp=sntp, vLANManagementVID=vLANManagementVID, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPv3Enable=sNMPv3Enable, wirelessLinkAvailability=wirelessLinkAvailability, dfsGroup=dfsGroup, snmpControl=snmpControl, dataPortStatus=dataPortStatus, installStatusTrap=installStatusTrap, maximumTransmitPower=maximumTransmitPower, range=range, dfsTable=dfsTable, antennaGain=antennaGain, cableLoss=cableLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, softwareVersion=softwareVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkName=linkName, ptpCompliance=ptpCompliance, altitude=altitude, cambium=cambium, dfsTableNumber=dfsTableNumber, targetMACAddress=targetMACAddress, managementGroup=managementGroup, dataPortStatusTrap=dataPortStatusTrap, receiveDataRate=receiveDataRate, syslogState=syslogState, sMTPEnabledMessages=sMTPEnabledMessages, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, timeZone=timeZone, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDControl=tDDControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionGroup=encryptionGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, gatewayIPAddress=gatewayIPAddress, ptmp=ptmp, syslogControlGroup=syslogControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, sMTPServerPortNumber=sMTPServerPortNumber, dfsTableIndex=dfsTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkSymmetry=linkSymmetry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpTraps=ptpTraps, siteName=siteName, telnetPortNumber=telnetPortNumber, sNTPLastSync=sNTPLastSync, telecom=telecom, sNTPServerPortNumber=sNTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, channelBandwidth=channelBandwidth, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, transmitFreqMHz=transmitFreqMHz, regionCodeTrap=regionCodeTrap, dfsTableEntry=dfsTableEntry, transmitDataRate=transmitDataRate, supplementaryGroup=supplementaryGroup, ptpTrapPrefix=ptpTrapPrefix, ptp=ptp, ptp500=ptp500, ethernet=ethernet, aAAControl=aAAControl, licensedCapacity=licensedCapacity, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatus=installStatus, receiveChannel=receiveChannel, dataPortDisabledWarning=dataPortDisabledWarning, aAAControlGroup=aAAControlGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, remoteIPAddress=remoteIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, notificationsGroup=notificationsGroup, telecomsInterface=telecomsInterface, longitude=longitude, telecomsLoopback=telecomsLoopback, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveModulationMode=receiveModulationMode, encryptionAlgorithm=encryptionAlgorithm, versions=versions, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimisation=linkModeOptimisation, sntpGroup=sntpGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPEnabledTraps=sNMPEnabledTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitPower=transmitPower, sNMPTrapTable=sNMPTrapTable, sMTPServerIPAddress=sMTPServerIPAddress, dfsPeaks=dfsPeaks, sMTPEmailAlert=sMTPEmailAlert, syslogStateTrap=syslogStateTrap, userTableNumber=userTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, phyControlGroup=phyControlGroup, receivePower=receivePower, masterSlaveMode=masterSlaveMode, telecomsCableLength=telecomsCableLength, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, smtp=smtp, licenceGroup=licenceGroup, frequencyVariant=frequencyVariant, vectorError=vectorError, userEnabled=userEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, channelChangeTrap=channelChangeTrap, productName=productName, eIRP=eIRP, tFTPServerIPAddress=tFTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup, configuration=configuration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsChannelStatus=telecomsChannelStatus, encryption=encryption, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortConfigurationMismatch=dataPortConfigurationMismatch, useVLANForManagementInterfaces=useVLANForManagementInterfaces, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, groupID=groupID, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, reset=reset, receiveFreqMHz=receiveFreqMHz, userName=userName, vLANPriorityTableIndex=vLANPriorityTableIndex, regionCode=regionCode, installArmState=installArmState, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsLineCode=telecomsLineCode, hTTPAccessEnabled=hTTPAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, systemClock=systemClock, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpGroups=ptpGroups, versionsGroup=versionsGroup, aggregateDataRate=aggregateDataRate, bandwidthVariant=bandwidthVariant, userPassword=userPassword, linkLoss=linkLoss, userTableEntry=userTableEntry, pubStatsGroup=pubStatsGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, productVariant=productVariant, tDDSynchronizationMode=tDDSynchronizationMode, supplementary=supplementary, systemReset=systemReset, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hardwareVersion=hardwareVersion, vLANManagementPriority=vLANManagementPriority, userRole=userRole, syslogControl=syslogControl, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPState=sNTPState, snmpControlGroup=snmpControlGroup, searchState=searchState, wirelessLinkStatus=wirelessLinkStatus, sNMPCommunityString=sNMPCommunityString, byteErrorRatio=byteErrorRatio, licence=licence, resetGroup=resetGroup, secondarySoftwareVersion=secondarySoftwareVersion, phyControl=phyControl, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPSyncTrap=sNTPSyncTrap, tFTPServerPortNumber=tFTPServerPortNumber, daylightSaving=daylightSaving, telecomGroup=telecomGroup, dfsMeans=dfsMeans, hTTPPortNumber=hTTPPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, sNMPPortNumber=sNMPPortNumber, syslogClientTrap=syslogClientTrap, receiveFreqKHz=receiveFreqKHz, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitModulationMode=transmitModulationMode, userTable=userTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetGroup=ethernetGroup, dfs=dfs, management=management, userTableIndex=userTableIndex, vLANPriorityTable=vLANPriorityTable, incompatibleRegionCodes=incompatibleRegionCodes, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPSync=sNTPSync, pubStats=pubStats, sNMPTrapTableNumber=sNMPTrapTableNumber, accessMethod=accessMethod, installArmStateTrap=installArmStateTrap)
