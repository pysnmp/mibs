...
iso, Gauge32, IpAddress, Unsigned32, Bits, MibIdentifier, NotificationType, TimeTicks, Integer32, ObjectIdentity, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "IpAddress", "Unsigned32", "Bits", "MibIdentifier", "NotificationType", "TimeTicks", "Integer32", "ObjectIdentity", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userEnabled=userEnabled, softwareVersion=softwareVersion, wirelessLinkStatus=wirelessLinkStatus, licensedCapacity=licensedCapacity, sNMPv3Enable=sNMPv3Enable, sNMPCommunityString=sNMPCommunityString, sNMPTrapTable=sNMPTrapTable, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, cableLoss=cableLoss, dfsMeans=dfsMeans, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, regionCode=regionCode, receiveFreqKHz=receiveFreqKHz, frequencyVariant=frequencyVariant, hTTPSPortNumber=hTTPSPortNumber, linkSymmetry=linkSymmetry, sNTPLastSync=sNTPLastSync, encryptionAlgorithm=encryptionAlgorithm, linkName=linkName, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPSyncTrap=sNTPSyncTrap, linkLoss=linkLoss, ethernet=ethernet, pubStats=pubStats, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqMHz=transmitFreqMHz, transmitDataRate=transmitDataRate, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, supplementary=supplementary, vLANManagementVID=vLANManagementVID, phyStatus=phyStatus, installStatus=installStatus, telecomsInterface=telecomsInterface, sNTPServerIPAddress=sNTPServerIPAddress, alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, byteErrorRatio=byteErrorRatio, ptmp=ptmp, latitude=latitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, productVariant=productVariant, alarms=alarms, dfs=dfs, accessMethod=accessMethod, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, iPAddress=iPAddress, phyControlGroup=phyControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPPortNumber=sNMPPortNumber, bandwidthVariant=bandwidthVariant, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortStatus=dataPortStatus, dataPortStatusTrap=dataPortStatusTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationMode=tDDSynchronizationMode, smtp=smtp, ptp500=ptp500, sNTPPollInterval=sNTPPollInterval, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, timeZone=timeZone, vLANPriorityTableNumber=vLANPriorityTableNumber, sntpGroup=sntpGroup, telecomsChannelStatus=telecomsChannelStatus, tFTPServerPortNumber=tFTPServerPortNumber, receiveChannel=receiveChannel, telecomsChannelStatusTrap=telecomsChannelStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomGroup=telecomGroup, dfsGroup=dfsGroup, tDDControl=tDDControl, supplementaryGroup=supplementaryGroup, telecomsCableLength=telecomsCableLength, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsLoopback=telecomsLoopback, wirelessLinkAvailability=wirelessLinkAvailability, telnetAccessEnabled=telnetAccessEnabled, snmpControl=snmpControl, dataPortAutoMdix=dataPortAutoMdix, gatewayIPAddress=gatewayIPAddress, telecomsLineCode=telecomsLineCode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, groupID=groupID, pubStatsGroup=pubStatsGroup, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, signalStrengthRatio=signalStrengthRatio, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableIndex=userTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, daylightSaving=daylightSaving, channelChangeTrap=channelChangeTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, secondarySoftwareVersion=secondarySoftwareVersion, vLANPriorityTable=vLANPriorityTable, eIRP=eIRP, tFTPServerIPAddress=tFTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenceGroup=licenceGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogClientTrap=syslogClientTrap, reset=reset, userTableNumber=userTableNumber, configurationGroup=configurationGroup, vectorError=vectorError, ptpTraps=ptpTraps, aAAControl=aAAControl, vLANPriorityTableIndex=vLANPriorityTableIndex, altitude=altitude, vLANManagementPriority=vLANManagementPriority, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptpCompliance=ptpCompliance, phyControl=phyControl, dfsTableIndex=dfsTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, syslogClient=syslogClient, telnetPortNumber=telnetPortNumber, targetMACAddress=targetMACAddress, syslogControlGroup=syslogControlGroup, linkModeOptimisation=linkModeOptimisation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, userRole=userRole, longitude=longitude, sNMPEnabledTraps=sNMPEnabledTraps, receiveFreqMHz=receiveFreqMHz, phyStatusGroup=phyStatusGroup, dfsTableNumber=dfsTableNumber, management=management, sMTPEnabledMessages=sMTPEnabledMessages, telecom=telecom, systemClock=systemClock, ptpGroups=ptpGroups, userPassword=userPassword, siteName=siteName, versions=versions, PYSNMP_MODULE_ID=cambium, vLANPriorityQueueMapping=vLANPriorityQueueMapping, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapVersion=sNMPTrapVersion, versionsGroup=versionsGroup, userTableEntry=userTableEntry, ptp=ptp, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerPortNumber=sMTPServerPortNumber, dfsTable=dfsTable, dfsPeaks=dfsPeaks, snmpControlGroup=snmpControlGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, range=range, bootVersion=bootVersion, userName=userName, subnetMask=subnetMask, configuration=configuration, receiveModulationMode=receiveModulationMode, cambium=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, installStatusTrap=installStatusTrap, regionCodeTrap=regionCodeTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, managementGroup=managementGroup, dfsTableEntry=dfsTableEntry, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, productName=productName, encryptionGroup=encryptionGroup, syslogState=syslogState, resetGroup=resetGroup, transmitChannel=transmitChannel, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapIPAddress=sNMPTrapIPAddress, smtpGroup=smtpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogControl=syslogControl, ethernetGroup=ethernetGroup, systemReset=systemReset, receivePower=receivePower, searchState=searchState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveDataRate=receiveDataRate, sNTPState=sNTPState, sntp=sntp, encryption=encryption, sNTPSync=sNTPSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ethernetFiberSupport=ethernetFiberSupport, channelBandwidth=channelBandwidth, transmitFreqKHz=transmitFreqKHz, licence=licence, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPServerIPAddress=sMTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, antennaGain=antennaGain, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibration=unitOutOfCalibration, syslogStateTrap=syslogStateTrap, tDDControlGroup=tDDControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortDisabledWarning=dataPortDisabledWarning, userTable=userTable)
