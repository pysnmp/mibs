...
# Produced by pysmi-1.1.3 at Tue Dec  7 17:23:51 2021
...
Bits, TimeTicks, ModuleIdentity, iso, Gauge32, Integer32, enterprises, Counter32, NotificationType, IpAddress, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "ModuleIdentity", "iso", "Gauge32", "Integer32", "enterprises", "Counter32", "NotificationType", "IpAddress", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userRole=userRole, transmitPower=transmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDControl=tDDControl, linkLoss=linkLoss, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPCommunityString=sNMPCommunityString, sMTPEmailAlert=sMTPEmailAlert, hTTPAccessEnabled=hTTPAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCode=regionCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkName=linkName, userTableNumber=userTableNumber, sNTPSync=sNTPSync, vLANPriorityTableEntry=vLANPriorityTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPv3Enable=sNMPv3Enable, aAAControl=aAAControl, byteErrorRatio=byteErrorRatio, alarms=alarms, cambium=cambium, configurationGroup=configurationGroup, linkSymmetry=linkSymmetry, sNMPTrapIPAddress=sNMPTrapIPAddress, encryptionGroup=encryptionGroup, receiveFreqKHz=receiveFreqKHz, frequencyVariant=frequencyVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemReset=systemReset, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, altitude=altitude, supplementary=supplementary, sNMPTrapTable=sNMPTrapTable, bootVersion=bootVersion, telecomsCableLength=telecomsCableLength, pubStatsGroup=pubStatsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, longitude=longitude, syslogControlGroup=syslogControlGroup, userPassword=userPassword, incompatibleMasterAndSlave=incompatibleMasterAndSlave, smtpGroup=smtpGroup, channelChangeTrap=channelChangeTrap, phyStatus=phyStatus, daylightSaving=daylightSaving, sMTPServerPortNumber=sMTPServerPortNumber, ptpTraps=ptpTraps, telecom=telecom, latitude=latitude, installStatus=installStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPPortNumber=hTTPPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSyncTrap=sNTPSyncTrap, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveDataRate=receiveDataRate, cableLoss=cableLoss, eIRP=eIRP, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortStatusTrap=dataPortStatusTrap, licensedCapacity=licensedCapacity, siteName=siteName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPAddress=iPAddress, dfsGroup=dfsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkStatus=wirelessLinkStatus, smtp=smtp, dataPortAutoMdix=dataPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, configuration=configuration, remoteIPAddress=remoteIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, licence=licence, telecomsLineCode=telecomsLineCode, hTTPSPortNumber=hTTPSPortNumber, vectorError=vectorError, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableNumber=dfsTableNumber, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp=ptp, systemClock=systemClock, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegionCodes=incompatibleRegionCodes, aAAControlGroup=aAAControlGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aggregateDataRate=aggregateDataRate, dfsTableIndex=dfsTableIndex, dfsPeaks=dfsPeaks, phyControlGroup=phyControlGroup, pubStats=pubStats, linkModeOptimisation=linkModeOptimisation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, targetMACAddress=targetMACAddress, capacityLicenseMismatch=capacityLicenseMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmStateTrap=installArmStateTrap, management=management, telnetPortNumber=telnetPortNumber, userTable=userTable, syslogClient=syslogClient, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryption=encryption, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpCompliance=ptpCompliance, searchState=searchState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDControlGroup=tDDControlGroup, userEnabled=userEnabled, syslogStateTrap=syslogStateTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, phyControl=phyControl, sMTPEnabledMessages=sMTPEnabledMessages, tDDSynchronizationAlarm=tDDSynchronizationAlarm, gatewayIPAddress=gatewayIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, range=range, userTableEntry=userTableEntry, bandwidthVariant=bandwidthVariant, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogControl=syslogControl, masterSlaveMode=masterSlaveMode, transmitChannel=transmitChannel, antennaGain=antennaGain, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetGroup=ethernetGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsMeans=dfsMeans, sMTPServerIPAddress=sMTPServerIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, regionCodeTrap=regionCodeTrap, PYSNMP_MODULE_ID=cambium, installStatusTrap=installStatusTrap, dfsTable=dfsTable, receiveFreqMHz=receiveFreqMHz, telecomsLoopback=telecomsLoopback, signalStrengthRatio=signalStrengthRatio, dataPortConfigurationMismatch=dataPortConfigurationMismatch, groupID=groupID, hardwareVersion=hardwareVersion, unitOutOfCalibration=unitOutOfCalibration, sNTPPollInterval=sNTPPollInterval, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, productName=productName, accessMethod=accessMethod, userTableIndex=userTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, snmpControlGroup=snmpControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpGroups=ptpGroups, ptpTrapPrefix=ptpTrapPrefix, syslogState=syslogState, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTableEntry=dfsTableEntry, vLANManagementVID=vLANManagementVID, vLANManagementPriority=vLANManagementPriority, dataPortStatus=dataPortStatus, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, telecomsChannelStatus=telecomsChannelStatus, sNMPTrapVersion=sNMPTrapVersion, userName=userName, maximumTransmitPower=maximumTransmitPower, transmitModulationMode=transmitModulationMode, syslogClientTrap=syslogClientTrap, subnetMask=subnetMask, alarmsGroup=alarmsGroup, secondarySoftwareVersion=secondarySoftwareVersion, notificationsGroup=notificationsGroup, dfs=dfs, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, snmpControl=snmpControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receivePower=receivePower, resetGroup=resetGroup, receiveChannel=receiveChannel, vLANPriorityTableNumber=vLANPriorityTableNumber, ethernet=ethernet, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, reset=reset, phyStatusGroup=phyStatusGroup, telecomsInterface=telecomsInterface, sNTPState=sNTPState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANPriorityTable=vLANPriorityTable, managementGroup=managementGroup, ptp500=ptp500, dataPortAutoNegotiation=dataPortAutoNegotiation, versionsGroup=versionsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, softwareVersion=softwareVersion, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqMHz=transmitFreqMHz, sntpGroup=sntpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, sNTPLastSync=sNTPLastSync, telecomGroup=telecomGroup, sntp=sntp, timeZone=timeZone, installArmState=installArmState, licenceGroup=licenceGroup, channelBandwidth=channelBandwidth, ptmp=ptmp)
