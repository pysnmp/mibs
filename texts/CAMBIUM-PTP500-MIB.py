...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installArmState=installArmState, receiveChannel=receiveChannel, ptmp=ptmp, pubStatsGroup=pubStatsGroup, aAAControl=aAAControl, sntpGroup=sntpGroup, subnetMask=subnetMask, productVariant=productVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableLoss=cableLoss, frequencyVariant=frequencyVariant, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, ethernet=ethernet, userTableNumber=userTableNumber, transmitChannel=transmitChannel, hardwareVersion=hardwareVersion, encryption=encryption, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANPriorityTable=vLANPriorityTable, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerPortNumber=tFTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, versionsGroup=versionsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userEnabled=userEnabled, licensedCapacity=licensedCapacity, sMTPServerIPAddress=sMTPServerIPAddress, phyStatusGroup=phyStatusGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitModulationMode=transmitModulationMode, dfsTable=dfsTable, groupID=groupID, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTableEntry=vLANPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableNumber=dfsTableNumber, eIRP=eIRP, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteIPAddress=remoteIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, installStatus=installStatus, syslogClientTrap=syslogClientTrap, transmitPower=transmitPower, cambium=cambium, dfsMeans=dfsMeans, userRole=userRole, dataPortDisabledWarning=dataPortDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, targetMACAddress=targetMACAddress, PYSNMP_MODULE_ID=cambium, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatusTrap=dataPortStatusTrap, hTTPSPortNumber=hTTPSPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkSymmetry=linkSymmetry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDControl=tDDControl, userTableEntry=userTableEntry, ptpTrapPrefix=ptpTrapPrefix, configuration=configuration, searchState=searchState, sNTPServerPortNumber=sNTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, bootVersion=bootVersion, dfsTableEntry=dfsTableEntry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitFreqMHz=transmitFreqMHz, aAAControlGroup=aAAControlGroup, licenceGroup=licenceGroup, supplementaryGroup=supplementaryGroup, sNTPServerIPAddress=sNTPServerIPAddress, phyStatus=phyStatus, phyControlGroup=phyControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, syslogStateTrap=syslogStateTrap, userName=userName, telecomsCableLength=telecomsCableLength, softwareVersion=softwareVersion, sNTPPollInterval=sNTPPollInterval, resetGroup=resetGroup, sntp=sntp, regionCodeTrap=regionCodeTrap, installStatusTrap=installStatusTrap, notificationsGroup=notificationsGroup, dfs=dfs, signalStrengthRatio=signalStrengthRatio, capacityLicenseMismatch=capacityLicenseMismatch, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoMdix=dataPortAutoMdix, antennaGain=antennaGain, unitOutOfCalibration=unitOutOfCalibration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, snmpControlGroup=snmpControlGroup, encryptionAlgorithm=encryptionAlgorithm, telecomsChannelStatusTrap=telecomsChannelStatusTrap, maximumTransmitPower=maximumTransmitPower, transmitFreqKHz=transmitFreqKHz, dataPortStatus=dataPortStatus, iPAddress=iPAddress, smtp=smtp, pubStats=pubStats, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, masterSlaveMode=masterSlaveMode, vectorError=vectorError, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDControlGroup=tDDControlGroup, telecomsLineCode=telecomsLineCode, telnetPortNumber=telnetPortNumber, longitude=longitude, smtpGroup=smtpGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemClock=systemClock, telnetAccessEnabled=telnetAccessEnabled, encryptionGroup=encryptionGroup, alarmsGroup=alarmsGroup, accessMethod=accessMethod, altitude=altitude, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveFreqKHz=receiveFreqKHz, telecomsLoopback=telecomsLoopback, bandwidthVariant=bandwidthVariant, timeZone=timeZone, syslogState=syslogState, sNMPCommunityString=sNMPCommunityString, sNTPSync=sNTPSync, ptpGroups=ptpGroups, hTTPPortNumber=hTTPPortNumber, ptp500=ptp500, receiveDataRate=receiveDataRate, sNTPState=sNTPState, snmpControl=snmpControl, transmitDataRate=transmitDataRate, ptpTraps=ptpTraps, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, incompatibleRegionCodes=incompatibleRegionCodes, telecom=telecom, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPEmailAlert=sMTPEmailAlert, syslogClient=syslogClient, managementGroup=managementGroup, productName=productName, sNMPTrapTable=sNMPTrapTable, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPSyncTrap=sNTPSyncTrap, ptpCompliance=ptpCompliance, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveModulationMode=receiveModulationMode, linkModeOptimisation=linkModeOptimisation, telecomGroup=telecomGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, byteErrorRatio=byteErrorRatio, channelBandwidth=channelBandwidth, receiveFreqMHz=receiveFreqMHz, syslogControlGroup=syslogControlGroup, ptp=ptp, reset=reset, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receivePower=receivePower, userPassword=userPassword, daylightSaving=daylightSaving, syslogControl=syslogControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPPortNumber=sNMPPortNumber, latitude=latitude, dataPortAutoNegotiation=dataPortAutoNegotiation, gatewayIPAddress=gatewayIPAddress, alarms=alarms, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkLoss=linkLoss, dfsPeaks=dfsPeaks, enabledDiagnosticAlarms=enabledDiagnosticAlarms, noWirelessChannelAvailable=noWirelessChannelAvailable, systemReset=systemReset, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPv3Enable=sNMPv3Enable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licence=licence, vLANPriorityTableIndex=vLANPriorityTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPLastSync=sNTPLastSync, phyControl=phyControl, range=range, siteName=siteName, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableIndex=dfsTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, telecomsInterface=telecomsInterface, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, supplementary=supplementary, userTable=userTable, dfsGroup=dfsGroup, tFTPServerIPAddress=tFTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userTableIndex=userTableIndex, management=management, ethernetGroup=ethernetGroup, sNMPTrapVersion=sNMPTrapVersion, linkName=linkName, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCode=regionCode, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsChannelStatus=telecomsChannelStatus, configurationGroup=configurationGroup, ethernetFiberSupport=ethernetFiberSupport, sNMPEnabledTraps=sNMPEnabledTraps)
