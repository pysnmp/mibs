...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptpGroups=ptpGroups, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTable=userTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableEntry=dfsTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPEmailAlert=sMTPEmailAlert, dataPortStatusTrap=dataPortStatusTrap, sNTPSync=sNTPSync, ptp=ptp, smtp=smtp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerIPAddress=tFTPServerIPAddress, range=range, vLANManagementVID=vLANManagementVID, ptp500=ptp500, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, regionCode=regionCode, vectorError=vectorError, receiveChannel=receiveChannel, installStatusTrap=installStatusTrap, telecomsLoopback=telecomsLoopback, management=management, sMTPServerIPAddress=sMTPServerIPAddress, receivePower=receivePower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStatsGroup=pubStatsGroup, transmitDataRate=transmitDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPEnabledTraps=sNMPEnabledTraps, phyControl=phyControl, phyStatus=phyStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPLastSync=sNTPLastSync, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDControlGroup=tDDControlGroup, masterSlaveMode=masterSlaveMode, maximumTransmitPower=maximumTransmitPower, telecomsInterface=telecomsInterface, transmitPower=transmitPower, phyControlGroup=phyControlGroup, configuration=configuration, ethernetGroup=ethernetGroup, snmpControlGroup=snmpControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, siteName=siteName, sNMPTrapTable=sNMPTrapTable, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, altitude=altitude, encryption=encryption, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomGroup=telecomGroup, cambium=cambium, telecomsLoopbackTrap=telecomsLoopbackTrap, subnetMask=subnetMask, sMTPServerPortNumber=sMTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNTPPollInterval=sNTPPollInterval, userName=userName, productName=productName, ethernetFiberSupport=ethernetFiberSupport, tFTPServerPortNumber=tFTPServerPortNumber, receiveDataRate=receiveDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPState=sNTPState, wirelessLinkStatus=wirelessLinkStatus, notificationsGroup=notificationsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, aAAControl=aAAControl, sNTPServerIPAddress=sNTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, userTableEntry=userTableEntry, dfsTable=dfsTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkAvailability=wirelessLinkAvailability, vLANPriorityTableIndex=vLANPriorityTableIndex, sntpGroup=sntpGroup, alarmsGroup=alarmsGroup, linkName=linkName, userPassword=userPassword, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, antennaGain=antennaGain, groupID=groupID, telecomsLineCode=telecomsLineCode, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernet=ethernet, supplementary=supplementary, targetMACAddress=targetMACAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, cableLoss=cableLoss, transmitFreqMHz=transmitFreqMHz, softwareVersion=softwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, channelChangeTrap=channelChangeTrap, telnetAccessEnabled=telnetAccessEnabled, hTTPAccessEnabled=hTTPAccessEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPSPortNumber=hTTPSPortNumber, dataPortAutoMdix=dataPortAutoMdix, incompatibleRegionCodes=incompatibleRegionCodes, dataPortStatus=dataPortStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogState=syslogState, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelStatus=telecomsChannelStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, reset=reset, syslogControl=syslogControl, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableIndex=userTableIndex, linkLoss=linkLoss, licence=licence, encryptionGroup=encryptionGroup, syslogClient=syslogClient, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogControlGroup=syslogControlGroup, vLANPriorityTable=vLANPriorityTable, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, ptpCompliance=ptpCompliance, sNTPServerPortNumber=sNTPServerPortNumber, dfsGroup=dfsGroup, hardwareVersion=hardwareVersion, telecom=telecom, dfsTableIndex=dfsTableIndex, versionsGroup=versionsGroup, telnetPortNumber=telnetPortNumber, systemClock=systemClock, receiveModulationMode=receiveModulationMode, timeZone=timeZone, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableNumber=userTableNumber, unitOutOfCalibration=unitOutOfCalibration, sMTPEnabledMessages=sMTPEnabledMessages, licensedCapacity=licensedCapacity, bootVersion=bootVersion, accessMethod=accessMethod, PYSNMP_MODULE_ID=cambium, syslogClientTrap=syslogClientTrap, alarms=alarms, sntp=sntp, dfs=dfs, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, supplementaryGroup=supplementaryGroup, tDDControl=tDDControl, systemReset=systemReset, dfsMeans=dfsMeans, sNMPPortNumber=sNMPPortNumber, daylightSaving=daylightSaving, receiveFreqMHz=receiveFreqMHz, searchState=searchState, vLANManagementPriority=vLANManagementPriority, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, channelBandwidth=channelBandwidth, aAAControlGroup=aAAControlGroup, longitude=longitude, sNMPTrapVersion=sNMPTrapVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDSynchronizationMode=tDDSynchronizationMode, transmitModulationMode=transmitModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, versions=versions, dataPortDisabledWarning=dataPortDisabledWarning, capacityLicenseMismatch=capacityLicenseMismatch, pubStats=pubStats, managementGroup=managementGroup, resetGroup=resetGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitFreqKHz=transmitFreqKHz, eIRP=eIRP, regionCodeTrap=regionCodeTrap, productVariant=productVariant, receiveFreqKHz=receiveFreqKHz, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, installStatus=installStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPCommunityString=sNMPCommunityString, linkSymmetry=linkSymmetry, byteErrorRatio=byteErrorRatio, sNTPSyncTrap=sNTPSyncTrap, dfsPeaks=dfsPeaks, licenceGroup=licenceGroup, bandwidthVariant=bandwidthVariant, signalStrengthRatio=signalStrengthRatio, transmitChannel=transmitChannel, syslogStateTrap=syslogStateTrap, smtpGroup=smtpGroup, configurationGroup=configurationGroup, snmpControl=snmpControl, frequencyVariant=frequencyVariant, sNMPv3Enable=sNMPv3Enable, phyStatusGroup=phyStatusGroup, dfsTableNumber=dfsTableNumber, installArmState=installArmState, userEnabled=userEnabled, latitude=latitude, telecomsCableLength=telecomsCableLength, iPAddress=iPAddress, installArmStateTrap=installArmStateTrap)
