...
MibIdentifier, TimeTicks, NotificationType, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, enterprises, ModuleIdentity, IpAddress, Counter64, Gauge32, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "NotificationType", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "enterprises", "ModuleIdentity", "IpAddress", "Counter64", "Gauge32", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptp500=ptp500, phyControl=phyControl, sMTPEnabledMessages=sMTPEnabledMessages, dfsPeaks=dfsPeaks, syslogStateTrap=syslogStateTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortStatus=dataPortStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, dfsMeans=dfsMeans, bootVersion=bootVersion, installStatus=installStatus, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleRegionCodes=incompatibleRegionCodes, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANManagementVID=vLANManagementVID, linkLoss=linkLoss, dataPortAutoMdix=dataPortAutoMdix, dataPortStatusTrap=dataPortStatusTrap, eIRP=eIRP, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, userPassword=userPassword, syslogState=syslogState, dfsTable=dfsTable, groupID=groupID, sNTPServerIPAddress=sNTPServerIPAddress, telecomsInterface=telecomsInterface, alarmsGroup=alarmsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPLastSync=sNTPLastSync, receiveDataRate=receiveDataRate, ptpTrapPrefix=ptpTrapPrefix, masterSlaveMode=masterSlaveMode, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableNumber=dfsTableNumber, hTTPSPortNumber=hTTPSPortNumber, pubStats=pubStats, supplementaryGroup=supplementaryGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogControl=syslogControl, transmitFreqMHz=transmitFreqMHz, dfsGroup=dfsGroup, sntp=sntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelChangeTrap=channelChangeTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, phyControlGroup=phyControlGroup, userTableEntry=userTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, licensedCapacity=licensedCapacity, channelBandwidth=channelBandwidth, receivePower=receivePower, systemClock=systemClock, receiveModulationMode=receiveModulationMode, cableLoss=cableLoss, receiveChannel=receiveChannel, telecomsChannelStatusTrap=telecomsChannelStatusTrap, smtp=smtp, telecom=telecom, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, maximumTransmitPower=maximumTransmitPower, sNTPPollInterval=sNTPPollInterval, cambium=cambium, ethernetGroup=ethernetGroup, userRole=userRole, telecomsCableLength=telecomsCableLength, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPCommunityString=sNMPCommunityString, management=management, linkModeOptimisation=linkModeOptimisation, userTableIndex=userTableIndex, transmitDataRate=transmitDataRate, encryption=encryption, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, siteName=siteName, encryptionAlgorithm=encryptionAlgorithm, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, signalStrengthRatio=signalStrengthRatio, transmitChannel=transmitChannel, antennaGain=antennaGain, versionsGroup=versionsGroup, sntpGroup=sntpGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, licence=licence, alarms=alarms, tDDSynchronizationMode=tDDSynchronizationMode, snmpControl=snmpControl, aAAControlGroup=aAAControlGroup, sNMPv3Enable=sNMPv3Enable, aAAControl=aAAControl, telecomsChannelStatus=telecomsChannelStatus, phyStatus=phyStatus, syslogControlGroup=syslogControlGroup, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableEntry=dfsTableEntry, iPAddress=iPAddress, altitude=altitude, resetGroup=resetGroup, tFTPServerPortNumber=tFTPServerPortNumber, snmpControlGroup=snmpControlGroup, sMTPEmailAlert=sMTPEmailAlert, managementGroup=managementGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetFiberSupport=ethernetFiberSupport, encryptionGroup=encryptionGroup, telnetPortNumber=telnetPortNumber, receiveFreqMHz=receiveFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveFreqKHz=receiveFreqKHz, telecomsLineCode=telecomsLineCode, syslogClientTrap=syslogClientTrap, transmitFreqKHz=transmitFreqKHz, sNTPSync=sNTPSync, versions=versions, frequencyVariant=frequencyVariant, bandwidthVariant=bandwidthVariant, hTTPPortNumber=hTTPPortNumber, linkSymmetry=linkSymmetry, accessMethod=accessMethod, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, sNMPTrapTable=sNMPTrapTable, systemReset=systemReset, tFTPServerIPAddress=tFTPServerIPAddress, supplementary=supplementary, pubStatsGroup=pubStatsGroup, subnetMask=subnetMask, vLANManagementPriority=vLANManagementPriority, sNMPEnabledTraps=sNMPEnabledTraps, capacityLicenseMismatch=capacityLicenseMismatch, configuration=configuration, ptpTraps=ptpTraps, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDControl=tDDControl, regionCodeTrap=regionCodeTrap, configurationGroup=configurationGroup, vLANPriorityTable=vLANPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptmp=ptmp, longitude=longitude, linkName=linkName, PYSNMP_MODULE_ID=cambium, dfs=dfs, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installStatusTrap=installStatusTrap, latitude=latitude, installArmStateTrap=installArmStateTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, notificationsGroup=notificationsGroup, transmitPower=transmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTableIndex=dfsTableIndex, ptpCompliance=ptpCompliance, daylightSaving=daylightSaving, remoteIPAddress=remoteIPAddress, userTable=userTable, licenceGroup=licenceGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableNumber=userTableNumber, timeZone=timeZone, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, targetMACAddress=targetMACAddress, userEnabled=userEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomGroup=telecomGroup, tDDControlGroup=tDDControlGroup, telnetAccessEnabled=telnetAccessEnabled, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptp=ptp, regionCode=regionCode, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapVersion=sNMPTrapVersion, productVariant=productVariant, gatewayIPAddress=gatewayIPAddress, userName=userName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, searchState=searchState, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productName=productName, sNTPState=sNTPState, ethernet=ethernet, syslogClient=syslogClient, range=range, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyStatusGroup=phyStatusGroup, receiveModulationModeDetail=receiveModulationModeDetail, vLANPriorityTableEntry=vLANPriorityTableEntry, secondarySoftwareVersion=secondarySoftwareVersion, telecomsLoopback=telecomsLoopback, ptpGroups=ptpGroups, reset=reset, sNMPPortNumber=sNMPPortNumber)
