...
# Produced by pysmi-1.1.3 at Wed Dec  1 16:27:58 2021
...
IpAddress, TimeTicks, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Counter64, Integer32, ObjectIdentity, NotificationType, Gauge32, MibIdentifier, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Counter64", "Integer32", "ObjectIdentity", "NotificationType", "Gauge32", "MibIdentifier", "Bits", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", cableLoss=cableLoss, longitude=longitude, transmitPower=transmitPower, userRole=userRole, linkLoss=linkLoss, tDDControl=tDDControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortConfigurationMismatch=dataPortConfigurationMismatch, resetGroup=resetGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, alarms=alarms, sntp=sntp, telnetPortNumber=telnetPortNumber, dfsTableEntry=dfsTableEntry, capacityLicenseMismatch=capacityLicenseMismatch, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsChannelStatus=telecomsChannelStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqMHz=receiveFreqMHz, ethernet=ethernet, ptp500=ptp500, userPassword=userPassword, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installArmState=installArmState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClient=syslogClient, linkName=linkName, transmitFreqMHz=transmitFreqMHz, remoteIPAddress=remoteIPAddress, transmitDataRate=transmitDataRate, iPAddress=iPAddress, tDDSynchronizationMode=tDDSynchronizationMode, telecomsLineCode=telecomsLineCode, sNMPTrapTable=sNMPTrapTable, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapPortNumber=sNMPTrapPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, configurationGroup=configurationGroup, dfsTable=dfsTable, ptmp=ptmp, dfsMeans=dfsMeans, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveDataRate=receiveDataRate, transmitModulationMode=transmitModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vectorError=vectorError, telecomsLoopback=telecomsLoopback, hTTPPortNumber=hTTPPortNumber, userEnabled=userEnabled, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpCompliance=ptpCompliance, dfs=dfs, phyStatus=phyStatus, latitude=latitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, systemReset=systemReset, wirelessLinkAvailability=wirelessLinkAvailability, channelChangeTrap=channelChangeTrap, snmpControlGroup=snmpControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, eIRP=eIRP, sNMPPortNumber=sNMPPortNumber, gatewayIPAddress=gatewayIPAddress, installStatusTrap=installStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sntpGroup=sntpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControlGroup=aAAControlGroup, tDDControlGroup=tDDControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, vLANManagementPriority=vLANManagementPriority, licensedCapacity=licensedCapacity, noWirelessChannelAvailable=noWirelessChannelAvailable, encryptionGroup=encryptionGroup, sMTPEnabledMessages=sMTPEnabledMessages, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuration=configuration, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, siteName=siteName, cambium=cambium, snmpControl=snmpControl, secondarySoftwareVersion=secondarySoftwareVersion, vLANPriorityTableEntry=vLANPriorityTableEntry, daylightSaving=daylightSaving, maximumTransmitPower=maximumTransmitPower, incompatibleRegionCodes=incompatibleRegionCodes, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, managementGroup=managementGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, unitOutOfCalibration=unitOutOfCalibration, supplementaryGroup=supplementaryGroup, dfsPeaks=dfsPeaks, management=management, alarmsGroup=alarmsGroup, byteErrorRatio=byteErrorRatio, PYSNMP_MODULE_ID=cambium, userTableEntry=userTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, phyStatusGroup=phyStatusGroup, receiveFreqKHz=receiveFreqKHz, groupID=groupID, tFTPServerPortNumber=tFTPServerPortNumber, reset=reset, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telnetAccessEnabled=telnetAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, timeZone=timeZone, aggregateDataRate=aggregateDataRate, telecomGroup=telecomGroup, sNTPSyncTrap=sNTPSyncTrap, installStatus=installStatus, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCodeTrap=regionCodeTrap, accessMethod=accessMethod, systemClock=systemClock, dfsGroup=dfsGroup, productVariant=productVariant, userTableNumber=userTableNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableIndex=userTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, range=range, hardwareVersion=hardwareVersion, syslogState=syslogState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClientTrap=syslogClientTrap, syslogStateTrap=syslogStateTrap, userName=userName, encryption=encryption, syslogControlGroup=syslogControlGroup, pubStats=pubStats, ethernetGroup=ethernetGroup, bandwidthVariant=bandwidthVariant, tFTPServerIPAddress=tFTPServerIPAddress, sNTPSync=sNTPSync, wirelessLinkStatus=wirelessLinkStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPLastSync=sNTPLastSync, subnetMask=subnetMask, syslogControl=syslogControl, telecomsCableLength=telecomsCableLength, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptp=ptp, regionCode=regionCode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptpTraps=ptpTraps, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productName=productName, vLANPriorityTableNumber=vLANPriorityTableNumber, phyControl=phyControl, licenceGroup=licenceGroup, targetMACAddress=targetMACAddress, dataPortAutoMdix=dataPortAutoMdix, telecomsInterface=telecomsInterface, searchState=searchState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, smtp=smtp, pubStatsGroup=pubStatsGroup, receivePower=receivePower, telecom=telecom, sNTPState=sNTPState, vLANManagementVID=vLANManagementVID, signalStrengthRatio=signalStrengthRatio, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableNumber=dfsTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, frequencyVariant=frequencyVariant, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDSynchronizationStatus=tDDSynchronizationStatus, softwareVersion=softwareVersion, encryptionAlgorithm=encryptionAlgorithm, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimisation=linkModeOptimisation, phyControlGroup=phyControlGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, supplementary=supplementary, dataPortStatus=dataPortStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANPriorityQueueMapping=vLANPriorityQueueMapping, licence=licence, ptpTrapPrefix=ptpTrapPrefix, userTable=userTable, aAAControl=aAAControl, vLANPriorityTable=vLANPriorityTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, transmitChannel=transmitChannel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPEmailAlert=sMTPEmailAlert, bootVersion=bootVersion, channelBandwidth=channelBandwidth, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapVersion=sNMPTrapVersion, versions=versions, versionsGroup=versionsGroup, linkSymmetry=linkSymmetry, altitude=altitude, notificationsGroup=notificationsGroup, transmitFreqKHz=transmitFreqKHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveModulationMode=receiveModulationMode, ptpGroups=ptpGroups, receiveChannel=receiveChannel)
