...
NotificationType, Integer32, enterprises, MibIdentifier, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Unsigned32, Bits, ModuleIdentity, Counter32, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "enterprises", "MibIdentifier", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Unsigned32", "Bits", "ModuleIdentity", "Counter32", "Counter64", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkSymmetry=linkSymmetry, userName=userName, accessMethod=accessMethod, sNMPTrapTableEntry=sNMPTrapTableEntry, encryptionAlgorithm=encryptionAlgorithm, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, systemReset=systemReset, signalStrengthRatio=signalStrengthRatio, telecomsLoopback=telecomsLoopback, channelChangeTrap=channelChangeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortStatus=dataPortStatus, aAAControl=aAAControl, notificationsGroup=notificationsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installStatus=installStatus, receivePower=receivePower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, PYSNMP_MODULE_ID=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, telecom=telecom, productName=productName, ptpTraps=ptpTraps, receiveModulationModeDetail=receiveModulationModeDetail, syslogControlGroup=syslogControlGroup, alarmsGroup=alarmsGroup, dfsTable=dfsTable, installArmState=installArmState, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, resetGroup=resetGroup, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configuration=configuration, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, licence=licence, sNMPv3Enable=sNMPv3Enable, supplementary=supplementary, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, aggregateDataRate=aggregateDataRate, vLANPriorityTable=vLANPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsPeaks=dfsPeaks, wirelessLinkStatus=wirelessLinkStatus, encryption=encryption, receiveFreqKHz=receiveFreqKHz, bandwidthVariant=bandwidthVariant, versions=versions, softwareVersion=softwareVersion, sNMPTrapVersion=sNMPTrapVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSyncTrap=sNTPSyncTrap, licenceGroup=licenceGroup, hardwareVersion=hardwareVersion, phyControl=phyControl, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, syslogState=syslogState, pubStatsGroup=pubStatsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsInterface=telecomsInterface, range=range, hTTPPortNumber=hTTPPortNumber, dfs=dfs, syslogControl=syslogControl, groupID=groupID, transmitDataRate=transmitDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPServerIPAddress=tFTPServerIPAddress, managementGroup=managementGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licensedCapacity=licensedCapacity, remoteIPAddress=remoteIPAddress, vectorError=vectorError, snmpControlGroup=snmpControlGroup, subnetMask=subnetMask, sntp=sntp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEmailAlert=sMTPEmailAlert, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, productVariant=productVariant, vLANManagementPriority=vLANManagementPriority, smtpGroup=smtpGroup, userRole=userRole, userTable=userTable, searchState=searchState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitPower=transmitPower, vLANManagementVID=vLANManagementVID, ptpTrapPrefix=ptpTrapPrefix, alarms=alarms, ptp500=ptp500, sNTPState=sNTPState, syslogClient=syslogClient, transmitFreqKHz=transmitFreqKHz, timeZone=timeZone, receiveDataRate=receiveDataRate, ptp=ptp, smtp=smtp, cambium=cambium, regionCode=regionCode, receiveFreqMHz=receiveFreqMHz, gatewayIPAddress=gatewayIPAddress, userEnabled=userEnabled, daylightSaving=daylightSaving, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDControl=tDDControl, telecomsCableLength=telecomsCableLength, receiveChannel=receiveChannel, targetMACAddress=targetMACAddress, altitude=altitude, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsGroup=dfsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, frequencyVariant=frequencyVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, telecomsLineCode=telecomsLineCode, sNTPPollInterval=sNTPPollInterval, supplementaryGroup=supplementaryGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, aAAControlGroup=aAAControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, linkModeOptimisation=linkModeOptimisation, userTableIndex=userTableIndex, sNMPCommunityString=sNMPCommunityString, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, systemClock=systemClock, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetGroup=ethernetGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortAutoMdix=dataPortAutoMdix, regionCodeTrap=regionCodeTrap, ethernet=ethernet, ethernetFiberSupport=ethernetFiberSupport, hTTPAccessEnabled=hTTPAccessEnabled, linkLoss=linkLoss, channelBandwidth=channelBandwidth, userPassword=userPassword, syslogStateTrap=syslogStateTrap, encryptionGroup=encryptionGroup, dfsTableIndex=dfsTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telnetPortNumber=telnetPortNumber, dfsMeans=dfsMeans, telecomsChannelStatus=telecomsChannelStatus, unitOutOfCalibration=unitOutOfCalibration, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPLastSync=sNTPLastSync, dfsTableNumber=dfsTableNumber, ptmp=ptmp, masterSlaveMode=masterSlaveMode, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, installArmStateTrap=installArmStateTrap, tFTPServerPortNumber=tFTPServerPortNumber, sNTPSync=sNTPSync, siteName=siteName, incompatibleRegionCodes=incompatibleRegionCodes, secondarySoftwareVersion=secondarySoftwareVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNMPPortNumber=sNMPPortNumber, transmitChannel=transmitChannel, syslogClientTrap=syslogClientTrap, transmitFreqMHz=transmitFreqMHz, tDDControlGroup=tDDControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, sntpGroup=sntpGroup, dataPortStatusTrap=dataPortStatusTrap, receiveModulationMode=receiveModulationMode, bootVersion=bootVersion, userTableNumber=userTableNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telnetAccessEnabled=telnetAccessEnabled, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomGroup=telecomGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, management=management, ptpGroups=ptpGroups, longitude=longitude, sNMPEnabledTraps=sNMPEnabledTraps, phyStatusGroup=phyStatusGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPAddress=iPAddress, snmpControl=snmpControl, cableLoss=cableLoss, linkName=linkName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, reset=reset, latitude=latitude, installStatusTrap=installStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versionsGroup=versionsGroup)
