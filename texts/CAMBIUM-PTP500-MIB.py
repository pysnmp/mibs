...
IpAddress, enterprises, Counter32, Unsigned32, MibIdentifier, ModuleIdentity, Counter64, ObjectIdentity, Integer32, iso, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "Counter32", "Unsigned32", "MibIdentifier", "ModuleIdentity", "Counter64", "ObjectIdentity", "Integer32", "iso", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPLastSync=sNTPLastSync, softwareVersion=softwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, productName=productName, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTable=sNMPTrapTable, antennaGain=antennaGain, ptpCompliance=ptpCompliance, versionsGroup=versionsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveChannel=receiveChannel, dfsTableEntry=dfsTableEntry, transmitFreqKHz=transmitFreqKHz, receiveFreqKHz=receiveFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkStatus=wirelessLinkStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, bootVersion=bootVersion, siteName=siteName, syslogState=syslogState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControl=phyControl, vLANPriorityTable=vLANPriorityTable, ptpTrapPrefix=ptpTrapPrefix, telecomGroup=telecomGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqMHz=transmitFreqMHz, dataPortAutoNegotiation=dataPortAutoNegotiation, dfs=dfs, byteErrorRatio=byteErrorRatio, masterSlaveMode=masterSlaveMode, sNMPEnabledTraps=sNMPEnabledTraps, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControl=aAAControl, dataPortStatus=dataPortStatus, dfsTableIndex=dfsTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, snmpControl=snmpControl, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, management=management, userTableEntry=userTableEntry, gatewayIPAddress=gatewayIPAddress, ethernetGroup=ethernetGroup, userRole=userRole, hTTPAccessEnabled=hTTPAccessEnabled, eIRP=eIRP, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsInterface=telecomsInterface, hTTPPortNumber=hTTPPortNumber, sNTPSync=sNTPSync, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveDataRate=receiveDataRate, iPAddress=iPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulationMode=receiveModulationMode, syslogClientTrap=syslogClientTrap, targetMACAddress=targetMACAddress, vLANManagementVID=vLANManagementVID, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, receiveFreqMHz=receiveFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, daylightSaving=daylightSaving, ethernet=ethernet, timeZone=timeZone, incompatibleRegionCodes=incompatibleRegionCodes, aggregateDataRate=aggregateDataRate, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapVersion=sNMPTrapVersion, regionCode=regionCode, ptp500=ptp500, encryption=encryption, channelChangeTrap=channelChangeTrap, configurationGroup=configurationGroup, dataPortAutoMdix=dataPortAutoMdix, encryptionAlgorithm=encryptionAlgorithm, ptp=ptp, syslogStateTrap=syslogStateTrap, smtpGroup=smtpGroup, dataPortStatusTrap=dataPortStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableNumber=dfsTableNumber, installStatus=installStatus, sntp=sntp, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unitOutOfCalibration=unitOutOfCalibration, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vLANManagementPriority=vLANManagementPriority, sNTPServerPortNumber=sNTPServerPortNumber, syslogControlGroup=syslogControlGroup, telecomsCableLength=telecomsCableLength, linkSymmetry=linkSymmetry, vLANPriorityQueueMapping=vLANPriorityQueueMapping, encryptionGroup=encryptionGroup, remoteIPAddress=remoteIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, groupID=groupID, ptmp=ptmp, regionCodeTrap=regionCodeTrap, userEnabled=userEnabled, signalStrengthRatio=signalStrengthRatio, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPSPortNumber=hTTPSPortNumber, altitude=altitude, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, supplementary=supplementary, dfsTable=dfsTable, sMTPEnabledMessages=sMTPEnabledMessages, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licence=licence, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, pubStats=pubStats, phyStatus=phyStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, alarms=alarms, phyControlGroup=phyControlGroup, systemClock=systemClock, tDDControl=tDDControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userPassword=userPassword, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsLoopback=telecomsLoopback, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPv3Enable=sNMPv3Enable, supplementaryGroup=supplementaryGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, resetGroup=resetGroup, ptpTraps=ptpTraps, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelBandwidth=channelBandwidth, maximumTransmitPower=maximumTransmitPower, userName=userName, linkModeOptimisation=linkModeOptimisation, telecom=telecom, sNMPCommunityString=sNMPCommunityString, sNMPPortNumber=sNMPPortNumber, syslogClient=syslogClient, transmitChannel=transmitChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStatsGroup=pubStatsGroup, reset=reset, ptpGroups=ptpGroups, range=range, licensedCapacity=licensedCapacity, sNTPSyncTrap=sNTPSyncTrap, productVariant=productVariant, dfsMeans=dfsMeans, receivePower=receivePower, userTable=userTable, systemReset=systemReset, tDDControlGroup=tDDControlGroup, accessMethod=accessMethod, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsLineCode=telecomsLineCode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsChannelStatus=telecomsChannelStatus, telnetPortNumber=telnetPortNumber, sNTPState=sNTPState, aAAControlGroup=aAAControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, managementGroup=managementGroup, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installArmState=installArmState, syslogControl=syslogControl, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPPollInterval=sNTPPollInterval, transmitDataRate=transmitDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableNumber=userTableNumber, snmpControlGroup=snmpControlGroup, userTableIndex=userTableIndex, linkName=linkName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cableLoss=cableLoss, hardwareVersion=hardwareVersion, latitude=latitude, configuration=configuration, phyStatusGroup=phyStatusGroup, dfsGroup=dfsGroup, notificationsGroup=notificationsGroup, installStatusTrap=installStatusTrap, bandwidthVariant=bandwidthVariant, searchState=searchState, subnetMask=subnetMask, frequencyVariant=frequencyVariant, sntpGroup=sntpGroup, dataPortDisabledWarning=dataPortDisabledWarning, cambium=cambium, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vectorError=vectorError, dfsPeaks=dfsPeaks, sMTPServerIPAddress=sMTPServerIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled)
