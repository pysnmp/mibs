...
# Produced by pysmi-1.1.3 at Wed Dec  8 17:45:21 2021
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Counter32, enterprises, ObjectIdentity, NotificationType, ModuleIdentity, Integer32, iso, Counter64, Bits, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Counter32", "enterprises", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Integer32", "iso", "Counter64", "Bits", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userTableNumber=userTableNumber, snmpControl=snmpControl, latitude=latitude, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, reset=reset, installStatus=installStatus, phyStatus=phyStatus, capacityLicenseMismatch=capacityLicenseMismatch, receiveFreqKHz=receiveFreqKHz, bandwidthVariant=bandwidthVariant, tDDSynchronizationStatus=tDDSynchronizationStatus, signalStrengthRatio=signalStrengthRatio, dataPortDisabledWarning=dataPortDisabledWarning, vLANManagementPriority=vLANManagementPriority, tFTPServerPortNumber=tFTPServerPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, PYSNMP_MODULE_ID=cambium, systemReset=systemReset, sNMPTrapTableIndex=sNMPTrapTableIndex, receivePower=receivePower, sntp=sntp, softwareVersion=softwareVersion, aAAControl=aAAControl, userName=userName, sNTPPollInterval=sNTPPollInterval, telecomsChannelStatusTrap=telecomsChannelStatusTrap, iPAddress=iPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogStateTrap=syslogStateTrap, pubStatsGroup=pubStatsGroup, byteErrorRatio=byteErrorRatio, dfsGroup=dfsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, aggregateDataRate=aggregateDataRate, channelBandwidth=channelBandwidth, hTTPPortNumber=hTTPPortNumber, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTable=userTable, telnetPortNumber=telnetPortNumber, syslogClientTrap=syslogClientTrap, notificationsGroup=notificationsGroup, managementGroup=managementGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpTraps=ptpTraps, hTTPSAccessEnabled=hTTPSAccessEnabled, regionCode=regionCode, ethernetGroup=ethernetGroup, phyStatusGroup=phyStatusGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimisation=linkModeOptimisation, regionCodeTrap=regionCodeTrap, dfsTableIndex=dfsTableIndex, maximumTransmitPower=maximumTransmitPower, installArmStateTrap=installArmStateTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installArmState=installArmState, siteName=siteName, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerPortNumber=sMTPServerPortNumber, telecomGroup=telecomGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, pubStats=pubStats, alarmsGroup=alarmsGroup, secondarySoftwareVersion=secondarySoftwareVersion, dataPortStatusTrap=dataPortStatusTrap, licence=licence, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogControlGroup=syslogControlGroup, telecomsCableLength=telecomsCableLength, dfsTable=dfsTable, alarms=alarms, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsPeaks=dfsPeaks, ptp500=ptp500, syslogControl=syslogControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, supplementaryGroup=supplementaryGroup, smtpGroup=smtpGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDSynchronizationMode=tDDSynchronizationMode, licenceGroup=licenceGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpGroups=ptpGroups, hTTPAccessEnabled=hTTPAccessEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aAAControlGroup=aAAControlGroup, daylightSaving=daylightSaving, versionsGroup=versionsGroup, range=range, dfsMeans=dfsMeans, management=management, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, timeZone=timeZone, frequencyVariant=frequencyVariant, installStatusTrap=installStatusTrap, sNMPTrapTable=sNMPTrapTable, syslogState=syslogState, dfsTableNumber=dfsTableNumber, configurationGroup=configurationGroup, receiveModulationMode=receiveModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPPortNumber=sNMPPortNumber, phyControlGroup=phyControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, subnetMask=subnetMask, dataPortStatus=dataPortStatus, receiveChannel=receiveChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, receiveDataRate=receiveDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerPortNumber=sNTPServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bootVersion=bootVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANPriorityTable=vLANPriorityTable, hardwareVersion=hardwareVersion, transmitFreqMHz=transmitFreqMHz, wirelessLinkAvailability=wirelessLinkAvailability, useVLANForManagementInterfaces=useVLANForManagementInterfaces, cableLoss=cableLoss, snmpControlGroup=snmpControlGroup, telecom=telecom, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, systemClock=systemClock, userRole=userRole, versions=versions, dfsTableEntry=dfsTableEntry, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPv3Enable=sNMPv3Enable, tDDControlGroup=tDDControlGroup, ptpCompliance=ptpCompliance, ethernet=ethernet, telecomsInterface=telecomsInterface, telecomsLoopbackTrap=telecomsLoopbackTrap, userTableIndex=userTableIndex, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, licensedCapacity=licensedCapacity, targetMACAddress=targetMACAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfs=dfs, ethernetFiberSupport=ethernetFiberSupport, receiveModulationModeDetail=receiveModulationModeDetail, linkSymmetry=linkSymmetry, linkLoss=linkLoss, cambium=cambium, sNTPState=sNTPState, sNMPCommunityString=sNMPCommunityString, userPassword=userPassword, masterSlaveMode=masterSlaveMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogClient=syslogClient, userEnabled=userEnabled, phyControl=phyControl, vLANPriorityTableIndex=vLANPriorityTableIndex, resetGroup=resetGroup, productName=productName, ptmp=ptmp, sNTPSyncTrap=sNTPSyncTrap, supplementary=supplementary, groupID=groupID, telecomsChannelStatus=telecomsChannelStatus, sMTPServerIPAddress=sMTPServerIPAddress, smtp=smtp, searchState=searchState, encryptionGroup=encryptionGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, hTTPSPortNumber=hTTPSPortNumber, telecomsLoopback=telecomsLoopback, productVariant=productVariant, ptp=ptp, configuration=configuration, altitude=altitude, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, longitude=longitude, sNTPSync=sNTPSync, sntpGroup=sntpGroup, encryption=encryption, channelChangeTrap=channelChangeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, accessMethod=accessMethod, vectorError=vectorError, transmitModulationMode=transmitModulationMode, userTableEntry=userTableEntry, telecomsLineCode=telecomsLineCode, sNMPTrapVersion=sNMPTrapVersion, sMTPEnabledMessages=sMTPEnabledMessages, vLANManagementVID=vLANManagementVID, antennaGain=antennaGain, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodes=incompatibleRegionCodes, transmitChannel=transmitChannel, eIRP=eIRP, transmitDataRate=transmitDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortAutoNegotiation=dataPortAutoNegotiation, transmitPower=transmitPower, transmitFreqKHz=transmitFreqKHz, tDDControl=tDDControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, gatewayIPAddress=gatewayIPAddress, encryptionAlgorithm=encryptionAlgorithm, ptpTrapPrefix=ptpTrapPrefix, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
