...
iso, TimeTicks, Counter64, Integer32, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, enterprises, ObjectIdentity, Unsigned32, Bits, Counter32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Counter64", "Integer32", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "enterprises", "ObjectIdentity", "Unsigned32", "Bits", "Counter32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", management=management, sMTPServerIPAddress=sMTPServerIPAddress, telecomsInterface=telecomsInterface, vLANPriorityTableNumber=vLANPriorityTableNumber, targetMACAddress=targetMACAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, resetGroup=resetGroup, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, ethernetFiberSupport=ethernetFiberSupport, sNMPv3Enable=sNMPv3Enable, aggregateDataRate=aggregateDataRate, installStatus=installStatus, bandwidthVariant=bandwidthVariant, sMTPEmailAlert=sMTPEmailAlert, sNMPPortNumber=sNMPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, telecomsLoopbackTrap=telecomsLoopbackTrap, telecom=telecom, pubStats=pubStats, cableLoss=cableLoss, groupID=groupID, sNTPSync=sNTPSync, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPServerIPAddress=sNTPServerIPAddress, userTableEntry=userTableEntry, installArmStateTrap=installArmStateTrap, dfsMeans=dfsMeans, vectorError=vectorError, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatusTrap=dataPortStatusTrap, syslogClient=syslogClient, dataPortWirelessDownAlert=dataPortWirelessDownAlert, configurationGroup=configurationGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortStatus=dataPortStatus, encryptionAlgorithm=encryptionAlgorithm, smtp=smtp, masterSlaveMode=masterSlaveMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, antennaGain=antennaGain, frequencyVariant=frequencyVariant, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ethernet=ethernet, dataPortDisabledWarning=dataPortDisabledWarning, configuration=configuration, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, unitOutOfCalibration=unitOutOfCalibration, licenceGroup=licenceGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, hardwareVersion=hardwareVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userPassword=userPassword, telnetPortNumber=telnetPortNumber, sNMPCommunityString=sNMPCommunityString, sNTPLastSync=sNTPLastSync, phyControlGroup=phyControlGroup, dfsTableNumber=dfsTableNumber, secondarySoftwareVersion=secondarySoftwareVersion, byteErrorRatio=byteErrorRatio, signalStrengthRatio=signalStrengthRatio, regionCode=regionCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userTable=userTable, range=range, syslogStateTrap=syslogStateTrap, licence=licence, userName=userName, telecomsCableLength=telecomsCableLength, snmpControl=snmpControl, userTableIndex=userTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, receivePower=receivePower, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, wirelessLinkAvailability=wirelessLinkAvailability, syslogControl=syslogControl, channelChangeTrap=channelChangeTrap, linkModeOptimisation=linkModeOptimisation, sMTPEnabledMessages=sMTPEnabledMessages, dfs=dfs, iPAddress=iPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, supplementary=supplementary, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqKHz=transmitFreqKHz, sMTPServerPortNumber=sMTPServerPortNumber, transmitPower=transmitPower, tDDSynchronizationMode=tDDSynchronizationMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerPortNumber=tFTPServerPortNumber, encryption=encryption, systemClock=systemClock, dfsTable=dfsTable, supplementaryGroup=supplementaryGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, regionCodeTrap=regionCodeTrap, sntpGroup=sntpGroup, vLANPriorityTable=vLANPriorityTable, dfsTableEntry=dfsTableEntry, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, telecomsLineCode=telecomsLineCode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, ptpGroups=ptpGroups, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpCompliance=ptpCompliance, syslogControlGroup=syslogControlGroup, linkLoss=linkLoss, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleRegionCodes=incompatibleRegionCodes, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, aAAControl=aAAControl, ethernetGroup=ethernetGroup, receiveModulationMode=receiveModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, systemReset=systemReset, managementGroup=managementGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, pubStatsGroup=pubStatsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogState=syslogState, dfsPeaks=dfsPeaks, receiveFreqKHz=receiveFreqKHz, vLANManagementVID=vLANManagementVID, receiveModulationModeDetail=receiveModulationModeDetail, receiveDataRate=receiveDataRate, dfsGroup=dfsGroup, versionsGroup=versionsGroup, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, syslogClientTrap=syslogClientTrap, gatewayIPAddress=gatewayIPAddress, transmitChannel=transmitChannel, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userEnabled=userEnabled, snmpControlGroup=snmpControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, alarmsGroup=alarmsGroup, channelBandwidth=channelBandwidth, capacityLicenseMismatch=capacityLicenseMismatch, subnetMask=subnetMask, installStatusTrap=installStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsLoopback=telecomsLoopback, telecomGroup=telecomGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, telnetAccessEnabled=telnetAccessEnabled, aAAControlGroup=aAAControlGroup, phyControl=phyControl, licensedCapacity=licensedCapacity, transmitDataRate=transmitDataRate, notificationsGroup=notificationsGroup, installArmState=installArmState, hTTPPortNumber=hTTPPortNumber, versions=versions, receiveFreqMHz=receiveFreqMHz, ptpTraps=ptpTraps, userRole=userRole, hTTPSPortNumber=hTTPSPortNumber, userTableNumber=userTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkStatus=wirelessLinkStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqMHz=transmitFreqMHz, linkName=linkName, productName=productName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sntp=sntp, cambium=cambium, tFTPServerIPAddress=tFTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, daylightSaving=daylightSaving, sNMPEnabledTraps=sNMPEnabledTraps, tDDControl=tDDControl, accessMethod=accessMethod, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableIndex=dfsTableIndex, ptp=ptp, siteName=siteName, remoteIPAddress=remoteIPAddress, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtpGroup=smtpGroup, alarms=alarms, longitude=longitude, transmitModulationMode=transmitModulationMode, productVariant=productVariant, ptmp=ptmp, telecomsChannelStatus=telecomsChannelStatus, altitude=altitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, sNTPState=sNTPState, ptp500=ptp500, bootVersion=bootVersion, latitude=latitude, receiveChannel=receiveChannel, maximumTransmitPower=maximumTransmitPower, sNMPTrapTable=sNMPTrapTable, hTTPSAccessEnabled=hTTPSAccessEnabled, softwareVersion=softwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap)
