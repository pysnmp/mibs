...
MibIdentifier, Unsigned32, enterprises, TimeTicks, ModuleIdentity, IpAddress, Bits, Integer32, Counter64, Counter32, NotificationType, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "enterprises", "TimeTicks", "ModuleIdentity", "IpAddress", "Bits", "Integer32", "Counter64", "Counter32", "NotificationType", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", bandwidthVariant=bandwidthVariant, eIRP=eIRP, hTTPAccessEnabled=hTTPAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableEntry=userTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receivePower=receivePower, ethernetGroup=ethernetGroup, encryptionGroup=encryptionGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, targetMACAddress=targetMACAddress, smtpGroup=smtpGroup, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, management=management, dataPortAutoMdix=dataPortAutoMdix, sNTPPollInterval=sNTPPollInterval, dfsTable=dfsTable, capacityLicenseMismatch=capacityLicenseMismatch, syslogControlGroup=syslogControlGroup, userName=userName, transmitFreqMHz=transmitFreqMHz, snmpControl=snmpControl, antennaGain=antennaGain, incompatibleRegionCodes=incompatibleRegionCodes, installArmState=installArmState, receiveFreqKHz=receiveFreqKHz, productVariant=productVariant, groupID=groupID, systemReset=systemReset, transmitChannel=transmitChannel, iPAddress=iPAddress, sNMPv3Enable=sNMPv3Enable, sNMPEnabledTraps=sNMPEnabledTraps, configuration=configuration, channelChangeTrap=channelChangeTrap, timeZone=timeZone, ptp500=ptp500, pubStats=pubStats, gatewayIPAddress=gatewayIPAddress, searchState=searchState, productName=productName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPPortNumber=hTTPPortNumber, telecomsInterface=telecomsInterface, dataPortStatus=dataPortStatus, syslogStateTrap=syslogStateTrap, ptpCompliance=ptpCompliance, userTableNumber=userTableNumber, channelBandwidth=channelBandwidth, ethernetFiberSupport=ethernetFiberSupport, regionCodeTrap=regionCodeTrap, bootVersion=bootVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkAvailability=wirelessLinkAvailability, daylightSaving=daylightSaving, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, frequencyVariant=frequencyVariant, tFTPServerIPAddress=tFTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSync=sNTPSync, ethernet=ethernet, aAAControl=aAAControl, masterSlaveMode=masterSlaveMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkName=linkName, telecomsCableLength=telecomsCableLength, licence=licence, linkSymmetry=linkSymmetry, transmitFreqKHz=transmitFreqKHz, supplementary=supplementary, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vectorError=vectorError, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableNumber=dfsTableNumber, regionCode=regionCode, reset=reset, tDDControl=tDDControl, latitude=latitude, dfsMeans=dfsMeans, dfsPeaks=dfsPeaks, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpGroups=ptpGroups, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDControlGroup=tDDControlGroup, linkLoss=linkLoss, dfsGroup=dfsGroup, dfs=dfs, notificationsGroup=notificationsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptmp=ptmp, dfsTableIndex=dfsTableIndex, resetGroup=resetGroup, transmitDataRate=transmitDataRate, vLANManagementVID=vLANManagementVID, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPSPortNumber=hTTPSPortNumber, smtp=smtp, pubStatsGroup=pubStatsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, accessMethod=accessMethod, versionsGroup=versionsGroup, transmitPower=transmitPower, vLANPriorityTable=vLANPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, telecom=telecom, subnetMask=subnetMask, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPLastSync=sNTPLastSync, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, phyControl=phyControl, userEnabled=userEnabled, wirelessLinkStatus=wirelessLinkStatus, managementGroup=managementGroup, unitOutOfCalibration=unitOutOfCalibration, userTableIndex=userTableIndex, siteName=siteName, linkModeOptimisation=linkModeOptimisation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, altitude=altitude, phyControlGroup=phyControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogState=syslogState, userTable=userTable, userRole=userRole, alarmsGroup=alarmsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatio=byteErrorRatio, cableLoss=cableLoss, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, alarms=alarms, aAAControlGroup=aAAControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptp=ptp, sNTPServerIPAddress=sNTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, installStatus=installStatus, licenceGroup=licenceGroup, dataPortDisabledWarning=dataPortDisabledWarning, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, softwareVersion=softwareVersion, installArmStateTrap=installArmStateTrap, phyStatus=phyStatus, tFTPServerPortNumber=tFTPServerPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, sMTPEmailAlert=sMTPEmailAlert, sNTPSyncTrap=sNTPSyncTrap, snmpControlGroup=snmpControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapTable=sNMPTrapTable, sntp=sntp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licensedCapacity=licensedCapacity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerPortNumber=sNTPServerPortNumber, userPassword=userPassword, sNTPState=sNTPState, systemClock=systemClock, syslogControl=syslogControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsLoopback=telecomsLoopback, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPServerPortNumber=sMTPServerPortNumber, phyStatusGroup=phyStatusGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cambium=cambium, receiveDataRate=receiveDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sntpGroup=sntpGroup, transmitModulationMode=transmitModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptpTraps=ptpTraps, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomGroup=telecomGroup, versions=versions, vLANManagementPriority=vLANManagementPriority, telnetPortNumber=telnetPortNumber, aggregateDataRate=aggregateDataRate, maximumTransmitPower=maximumTransmitPower, dfsTableEntry=dfsTableEntry, range=range, signalStrengthRatio=signalStrengthRatio, encryption=encryption, receiveModulationModeDetail=receiveModulationModeDetail, installStatusTrap=installStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, PYSNMP_MODULE_ID=cambium, telecomsLineCode=telecomsLineCode, remoteIPAddress=remoteIPAddress, supplementaryGroup=supplementaryGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, longitude=longitude, telecomsLoopbackTrap=telecomsLoopbackTrap, configurationGroup=configurationGroup, syslogClient=syslogClient, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveModulationMode=receiveModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, ptpTrapPrefix=ptpTrapPrefix, receiveChannel=receiveChannel, syslogClientTrap=syslogClientTrap)
