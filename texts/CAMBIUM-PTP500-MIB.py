...
ModuleIdentity, NotificationType, iso, Gauge32, enterprises, TimeTicks, Bits, MibIdentifier, IpAddress, ObjectIdentity, Counter32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "iso", "Gauge32", "enterprises", "TimeTicks", "Bits", "MibIdentifier", "IpAddress", "ObjectIdentity", "Counter32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, softwareVersion=softwareVersion, syslogStateTrap=syslogStateTrap, linkLoss=linkLoss, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, dfsGroup=dfsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTable=sNMPTrapTable, siteName=siteName, configurationGroup=configurationGroup, targetMACAddress=targetMACAddress, linkModeOptimisation=linkModeOptimisation, managementGroup=managementGroup, tDDControlGroup=tDDControlGroup, licence=licence, sntp=sntp, sMTPServerPortNumber=sMTPServerPortNumber, telnetPortNumber=telnetPortNumber, reset=reset, encryption=encryption, hardwareVersion=hardwareVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, licensedCapacity=licensedCapacity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkAvailability=wirelessLinkAvailability, ethernetGroup=ethernetGroup, telecomsLineCode=telecomsLineCode, aggregateDataRate=aggregateDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapIPAddress=sNMPTrapIPAddress, latitude=latitude, phyStatusGroup=phyStatusGroup, ethernetFiberSupport=ethernetFiberSupport, smtpGroup=smtpGroup, groupID=groupID, sNMPCommunityString=sNMPCommunityString, wirelessLinkStatus=wirelessLinkStatus, supplementary=supplementary, sMTPSourceEmailAddress=sMTPSourceEmailAddress, antennaGain=antennaGain, hTTPAccessEnabled=hTTPAccessEnabled, telecom=telecom, sNMPPortNumber=sNMPPortNumber, vectorError=vectorError, snmpControl=snmpControl, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfsMeans=dfsMeans, dfsTableIndex=dfsTableIndex, transmitPower=transmitPower, cableLoss=cableLoss, productName=productName, transmitDataRate=transmitDataRate, snmpControlGroup=snmpControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTable=userTable, syslogControl=syslogControl, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqMHz=transmitFreqMHz, alarms=alarms, byteErrorRatio=byteErrorRatio, regionCodeTrap=regionCodeTrap, installStatusTrap=installStatusTrap, masterSlaveMode=masterSlaveMode, capacityLicenseMismatch=capacityLicenseMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogControlGroup=syslogControlGroup, telnetAccessEnabled=telnetAccessEnabled, configuration=configuration, tDDSynchronizationStatus=tDDSynchronizationStatus, daylightSaving=daylightSaving, installStatus=installStatus, regionCode=regionCode, receivePower=receivePower, phyStatus=phyStatus, sntpGroup=sntpGroup, ptp=ptp, eIRP=eIRP, hTTPPortNumber=hTTPPortNumber, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibration=unitOutOfCalibration, ptmp=ptmp, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelStatus=telecomsChannelStatus, sNTPSyncTrap=sNTPSyncTrap, dataPortStatus=dataPortStatus, userName=userName, userEnabled=userEnabled, phyControl=phyControl, sMTPEnabledMessages=sMTPEnabledMessages, productVariant=productVariant, receiveChannel=receiveChannel, versions=versions, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPState=sNTPState, installArmStateTrap=installArmStateTrap, versionsGroup=versionsGroup, maximumTransmitPower=maximumTransmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTableIndex=userTableIndex, ptp500=ptp500, ethernet=ethernet, dfsTableEntry=dfsTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, cambium=cambium, management=management, ptpCompliance=ptpCompliance, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, licenceGroup=licenceGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsCableLength=telecomsCableLength, phyControlGroup=phyControlGroup, timeZone=timeZone, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSync=sNTPSync, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTableIndex=vLANPriorityTableIndex, signalStrengthRatio=signalStrengthRatio, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, smtp=smtp, tDDControl=tDDControl, dfsPeaks=dfsPeaks, channelBandwidth=channelBandwidth, sNMPv3Enable=sNMPv3Enable, sNTPLastSync=sNTPLastSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, installArmState=installArmState, subnetMask=subnetMask, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfs=dfs, pubStats=pubStats, receiveFreqKHz=receiveFreqKHz, vLANPriorityTableEntry=vLANPriorityTableEntry, systemReset=systemReset, incompatibleRegionCodes=incompatibleRegionCodes, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, sNTPPollInterval=sNTPPollInterval, accessMethod=accessMethod, dataPortStatusTrap=dataPortStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, syslogClient=syslogClient, remoteIPAddress=remoteIPAddress, syslogState=syslogState, sNMPTrapVersion=sNMPTrapVersion, aAAControl=aAAControl, secondarySoftwareVersion=secondarySoftwareVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, longitude=longitude, transmitFreqKHz=transmitFreqKHz, ptpGroups=ptpGroups, userRole=userRole, notificationsGroup=notificationsGroup, encryptionGroup=encryptionGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsInterface=telecomsInterface, sMTPEmailAlert=sMTPEmailAlert, resetGroup=resetGroup, userPassword=userPassword, pubStatsGroup=pubStatsGroup, telecomsLoopback=telecomsLoopback, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomGroup=telecomGroup, frequencyVariant=frequencyVariant, syslogClientTrap=syslogClientTrap, bandwidthVariant=bandwidthVariant, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTableNumber=userTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPSPortNumber=hTTPSPortNumber, receiveModulationMode=receiveModulationMode, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkSymmetry=linkSymmetry, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, range=range, encryptionAlgorithm=encryptionAlgorithm, PYSNMP_MODULE_ID=cambium, alarmsGroup=alarmsGroup, userTableEntry=userTableEntry, supplementaryGroup=supplementaryGroup, aAAControlGroup=aAAControlGroup, receiveDataRate=receiveDataRate, searchState=searchState, altitude=altitude, vLANPriorityTable=vLANPriorityTable, dfsTable=dfsTable, dataPortDisabledWarning=dataPortDisabledWarning, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkName=linkName, tFTPServerIPAddress=tFTPServerIPAddress, receiveFreqMHz=receiveFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitModulationMode=transmitModulationMode, systemClock=systemClock)
