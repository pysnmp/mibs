...
NotificationType, ModuleIdentity, Counter32, MibIdentifier, Bits, Gauge32, TimeTicks, Unsigned32, ObjectIdentity, Counter64, enterprises, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Counter32", "MibIdentifier", "Bits", "Gauge32", "TimeTicks", "Unsigned32", "ObjectIdentity", "Counter64", "enterprises", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfs=dfs, vLANPriorityTableNumber=vLANPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, aggregateDataRate=aggregateDataRate, sNMPv3Enable=sNMPv3Enable, systemReset=systemReset, dfsTableIndex=dfsTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, sNTPSyncTrap=sNTPSyncTrap, dfsMeans=dfsMeans, sntp=sntp, aAAControlGroup=aAAControlGroup, bandwidthVariant=bandwidthVariant, syslogState=syslogState, transmitPower=transmitPower, hardwareVersion=hardwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, regionCode=regionCode, ptpCompliance=ptpCompliance, telecomsLoopback=telecomsLoopback, daylightSaving=daylightSaving, pubStats=pubStats, alarmsGroup=alarmsGroup, encryption=encryption, telecomGroup=telecomGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, iPAddress=iPAddress, incompatibleRegionCodes=incompatibleRegionCodes, installArmState=installArmState, vLANManagementVID=vLANManagementVID, sMTPEmailAlert=sMTPEmailAlert, syslogClientTrap=syslogClientTrap, pubStatsGroup=pubStatsGroup, transmitFreqMHz=transmitFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortStatus=dataPortStatus, regionCodeTrap=regionCodeTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, licence=licence, sMTPServerIPAddress=sMTPServerIPAddress, sNMPPortNumber=sNMPPortNumber, ptpGroups=ptpGroups, tFTPServerIPAddress=tFTPServerIPAddress, syslogControl=syslogControl, encryptionGroup=encryptionGroup, notificationsGroup=notificationsGroup, configuration=configuration, receivePower=receivePower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installArmStateTrap=installArmStateTrap, installStatus=installStatus, dfsTableNumber=dfsTableNumber, ptpTraps=ptpTraps, tFTPServerPortNumber=tFTPServerPortNumber, eIRP=eIRP, licenceGroup=licenceGroup, versions=versions, dfsGroup=dfsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, longitude=longitude, installStatusTrap=installStatusTrap, ptp=ptp, hTTPSAccessEnabled=hTTPSAccessEnabled, linkLoss=linkLoss, transmitFreqKHz=transmitFreqKHz, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sntpGroup=sntpGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveFreqKHz=receiveFreqKHz, groupID=groupID, accessMethod=accessMethod, receiveChannel=receiveChannel, userName=userName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, altitude=altitude, productName=productName, sNMPTrapTable=sNMPTrapTable, PYSNMP_MODULE_ID=cambium, phyStatusGroup=phyStatusGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPLastSync=sNTPLastSync, userEnabled=userEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, siteName=siteName, telnetPortNumber=telnetPortNumber, timeZone=timeZone, telecomsInterface=telecomsInterface, management=management, latitude=latitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, smtpGroup=smtpGroup, alarms=alarms, cambium=cambium, linkSymmetry=linkSymmetry, versionsGroup=versionsGroup, sNMPCommunityString=sNMPCommunityString, dfsPeaks=dfsPeaks, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, ptmp=ptmp, noWirelessChannelAvailable=noWirelessChannelAvailable, bootVersion=bootVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitChannel=transmitChannel, dfsTableEntry=dfsTableEntry, channelChangeTrap=channelChangeTrap, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableIndex=userTableIndex, subnetMask=subnetMask, syslogStateTrap=syslogStateTrap, vLANPriorityTable=vLANPriorityTable, unitOutOfCalibration=unitOutOfCalibration, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyControl=phyControl, configurationGroup=configurationGroup, dfsTable=dfsTable, cableLoss=cableLoss, linkModeOptimisation=linkModeOptimisation, sNTPSync=sNTPSync, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogClient=syslogClient, managementGroup=managementGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vectorError=vectorError, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecom=telecom, sMTPEnabledMessages=sMTPEnabledMessages, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableNumber=userTableNumber, userPassword=userPassword, userTableEntry=userTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkName=linkName, telecomsCableLength=telecomsCableLength, ptp500=ptp500, ethernetGroup=ethernetGroup, hTTPAccessEnabled=hTTPAccessEnabled, dataPortDisabledWarning=dataPortDisabledWarning, userTable=userTable, encryptionAlgorithm=encryptionAlgorithm, byteErrorRatio=byteErrorRatio, telecomsChannelStatus=telecomsChannelStatus, sNTPState=sNTPState, masterSlaveMode=masterSlaveMode, wirelessLinkStatus=wirelessLinkStatus, aAAControl=aAAControl, searchState=searchState, constantPowerSpectralDensity=constantPowerSpectralDensity, phyControlGroup=phyControlGroup, receiveModulationMode=receiveModulationMode, transmitModulationMode=transmitModulationMode, licensedCapacity=licensedCapacity, sNMPTrapVersion=sNMPTrapVersion, smtp=smtp, tDDControl=tDDControl, frequencyVariant=frequencyVariant, telnetAccessEnabled=telnetAccessEnabled, reset=reset, antennaGain=antennaGain, receiveFreqMHz=receiveFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPServerPortNumber=sNTPServerPortNumber, remoteIPAddress=remoteIPAddress, hTTPPortNumber=hTTPPortNumber, resetGroup=resetGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, targetMACAddress=targetMACAddress, supplementary=supplementary, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, supplementaryGroup=supplementaryGroup, telecomsLineCode=telecomsLineCode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userRole=userRole, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, secondarySoftwareVersion=secondarySoftwareVersion, syslogControlGroup=syslogControlGroup, softwareVersion=softwareVersion, tDDControlGroup=tDDControlGroup, systemClock=systemClock, capacityLicenseMismatch=capacityLicenseMismatch, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANManagementPriority=vLANManagementPriority, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, ethernet=ethernet, phyStatus=phyStatus, channelBandwidth=channelBandwidth, hTTPSPortNumber=hTTPSPortNumber, range=range, receiveDataRate=receiveDataRate, sNTPPollInterval=sNTPPollInterval)
