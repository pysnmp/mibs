...
MibIdentifier, ModuleIdentity, NotificationType, Integer32, enterprises, iso, Counter64, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Counter32, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "NotificationType", "Integer32", "enterprises", "iso", "Counter64", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Counter32", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", licenceGroup=licenceGroup, channelBandwidth=channelBandwidth, sNMPTrapIPAddress=sNMPTrapIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimisation=linkModeOptimisation, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, siteName=siteName, sNTPSyncTrap=sNTPSyncTrap, accessMethod=accessMethod, vLANManagementPriority=vLANManagementPriority, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, frequencyVariant=frequencyVariant, PYSNMP_MODULE_ID=cambium, sNMPPortNumber=sNMPPortNumber, eIRP=eIRP, sNTPLastSync=sNTPLastSync, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, transmitDataRate=transmitDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vectorError=vectorError, pubStats=pubStats, configurationGroup=configurationGroup, ptpGroups=ptpGroups, sNMPv3Enable=sNMPv3Enable, cambium=cambium, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveDataRate=receiveDataRate, masterSlaveMode=masterSlaveMode, softwareVersion=softwareVersion, receiveChannel=receiveChannel, tDDControl=tDDControl, ptpTraps=ptpTraps, range=range, systemClock=systemClock, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sntpGroup=sntpGroup, hTTPSPortNumber=hTTPSPortNumber, dataPortStatus=dataPortStatus, installArmState=installArmState, timeZone=timeZone, syslogClientTrap=syslogClientTrap, encryptionGroup=encryptionGroup, userRole=userRole, smtpGroup=smtpGroup, userTableNumber=userTableNumber, ptp=ptp, notificationsGroup=notificationsGroup, targetMACAddress=targetMACAddress, sNTPServerPortNumber=sNTPServerPortNumber, pubStatsGroup=pubStatsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, licensedCapacity=licensedCapacity, dfs=dfs, transmitFreqKHz=transmitFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableEntry=dfsTableEntry, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, linkModeOptimizationMismatch=linkModeOptimizationMismatch, gatewayIPAddress=gatewayIPAddress, sMTPEmailAlert=sMTPEmailAlert, telnetPortNumber=telnetPortNumber, sNTPState=sNTPState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkLoss=linkLoss, alarms=alarms, channelChangeTrap=channelChangeTrap, encryptionAlgorithm=encryptionAlgorithm, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkSymmetry=linkSymmetry, telecomsLoopback=telecomsLoopback, tFTPServerPortNumber=tFTPServerPortNumber, management=management, licence=licence, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogClient=syslogClient, syslogState=syslogState, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANPriorityTable=vLANPriorityTable, supplementary=supplementary, transmitPower=transmitPower, incompatibleRegionCodes=incompatibleRegionCodes, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, receivePower=receivePower, versions=versions, userTableEntry=userTableEntry, bootVersion=bootVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, phyControlGroup=phyControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, wirelessLinkAvailability=wirelessLinkAvailability, ptp500=ptp500, resetGroup=resetGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatusTrap=installStatusTrap, phyStatusGroup=phyStatusGroup, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsPeaks=dfsPeaks, snmpControl=snmpControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveFreqMHz=receiveFreqMHz, telecomsChannelStatus=telecomsChannelStatus, sNMPEnabledTraps=sNMPEnabledTraps, iPAddress=iPAddress, altitude=altitude, hTTPPortNumber=hTTPPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyStatus=phyStatus, tDDControlGroup=tDDControlGroup, phyControl=phyControl, syslogStateTrap=syslogStateTrap, dfsGroup=dfsGroup, sNTPServerIPAddress=sNTPServerIPAddress, sNTPSync=sNTPSync, regionCode=regionCode, transmitChannel=transmitChannel, installStatus=installStatus, sNMPTrapTable=sNMPTrapTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userPassword=userPassword, receiveFreqKHz=receiveFreqKHz, versionsGroup=versionsGroup, bandwidthVariant=bandwidthVariant, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortStatusTrap=dataPortStatusTrap, groupID=groupID, syslogControl=syslogControl, subnetMask=subnetMask, vLANManagementVID=vLANManagementVID, syslogControlGroup=syslogControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsLineCode=telecomsLineCode, supplementaryGroup=supplementaryGroup, productVariant=productVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANPriorityQueueMapping=vLANPriorityQueueMapping, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, sNMPTrapTableNumber=sNMPTrapTableNumber, configuration=configuration, userTableIndex=userTableIndex, latitude=latitude, dataPortDisabledWarning=dataPortDisabledWarning, reset=reset, receiveModulationModeDetail=receiveModulationModeDetail, vLANPriorityTableNumber=vLANPriorityTableNumber, encryption=encryption, tDDSynchronizationMode=tDDSynchronizationMode, maximumTransmitPower=maximumTransmitPower, dfsTable=dfsTable, dfsMeans=dfsMeans, ptmp=ptmp, userTable=userTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, searchState=searchState, regionCodeTrap=regionCodeTrap, sMTPServerIPAddress=sMTPServerIPAddress, userName=userName, dfsTableIndex=dfsTableIndex, telnetAccessEnabled=telnetAccessEnabled, hTTPAccessEnabled=hTTPAccessEnabled, ethernet=ethernet, dataPortAutoMdix=dataPortAutoMdix, transmitModulationMode=transmitModulationMode, daylightSaving=daylightSaving, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecom=telecom, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsCableLength=telecomsCableLength, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPCommunityString=sNMPCommunityString, telecomsInterface=telecomsInterface, byteErrorRatio=byteErrorRatio, snmpControlGroup=snmpControlGroup, userEnabled=userEnabled, sntp=sntp, installArmStateTrap=installArmStateTrap, cableLoss=cableLoss, ethernetGroup=ethernetGroup, linkName=linkName, productName=productName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptpCompliance=ptpCompliance, telecomGroup=telecomGroup, remoteIPAddress=remoteIPAddress, systemReset=systemReset, aAAControlGroup=aAAControlGroup, aAAControl=aAAControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapVersion=sNMPTrapVersion, managementGroup=managementGroup, alarmsGroup=alarmsGroup, smtp=smtp, ethernetFiberSupport=ethernetFiberSupport, aggregateDataRate=aggregateDataRate, dfsTableNumber=dfsTableNumber)
