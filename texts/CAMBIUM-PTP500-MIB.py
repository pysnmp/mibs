...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsTableIndex=dfsTableIndex, bootVersion=bootVersion, licenceGroup=licenceGroup, latitude=latitude, regionCode=regionCode, syslogStateTrap=syslogStateTrap, encryptionGroup=encryptionGroup, groupID=groupID, dfsGroup=dfsGroup, syslogControlGroup=syslogControlGroup, transmitModulationMode=transmitModulationMode, cambium=cambium, altitude=altitude, syslogControl=syslogControl, vLANPriorityTable=vLANPriorityTable, channelChangeTrap=channelChangeTrap, ptmp=ptmp, dfsTableEntry=dfsTableEntry, hTTPSPortNumber=hTTPSPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableNumber=dfsTableNumber, telecomsLineCode=telecomsLineCode, tDDControl=tDDControl, masterSlaveMode=masterSlaveMode, encryption=encryption, dfsTable=dfsTable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, aggregateDataRate=aggregateDataRate, bandwidthVariant=bandwidthVariant, sntpGroup=sntpGroup, syslogClientTrap=syslogClientTrap, ethernet=ethernet, vLANPriorityQueueMapping=vLANPriorityQueueMapping, snmpControlGroup=snmpControlGroup, telecomsInterface=telecomsInterface, sNTPLastSync=sNTPLastSync, userPassword=userPassword, linkName=linkName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, capacityLicenseMismatch=capacityLicenseMismatch, sNTPPollInterval=sNTPPollInterval, remoteIPAddress=remoteIPAddress, userName=userName, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmState=installArmState, telnetAccessEnabled=telnetAccessEnabled, hTTPPortNumber=hTTPPortNumber, receiveDataRate=receiveDataRate, cableLoss=cableLoss, versions=versions, installArmStateTrap=installArmStateTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installStatus=installStatus, ptp500=ptp500, tDDSynchronizationMode=tDDSynchronizationMode, userRole=userRole, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, ptpTraps=ptpTraps, receiveChannel=receiveChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configurationGroup=configurationGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, reset=reset, dfs=dfs, sntp=sntp, userTableIndex=userTableIndex, daylightSaving=daylightSaving, dataPortStatus=dataPortStatus, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, transmitChannel=transmitChannel, targetMACAddress=targetMACAddress, sNTPSyncTrap=sNTPSyncTrap, vectorError=vectorError, configuration=configuration, sMTPEnabledMessages=sMTPEnabledMessages, supplementaryGroup=supplementaryGroup, maximumTransmitPower=maximumTransmitPower, telecomsChannelStatus=telecomsChannelStatus, productVariant=productVariant, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetGroup=ethernetGroup, dfsPeaks=dfsPeaks, systemClock=systemClock, secondarySoftwareVersion=secondarySoftwareVersion, systemReset=systemReset, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, phyStatusGroup=phyStatusGroup, gatewayIPAddress=gatewayIPAddress, receivePower=receivePower, signalStrengthRatio=signalStrengthRatio, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPState=sNTPState, aAAControlGroup=aAAControlGroup, antennaGain=antennaGain, channelBandwidth=channelBandwidth, telecomsLoopback=telecomsLoopback, telnetPortNumber=telnetPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, telecomGroup=telecomGroup, sNMPTrapTable=sNMPTrapTable, syslogState=syslogState, sMTPEmailAlert=sMTPEmailAlert, smtpGroup=smtpGroup, installStatusTrap=installStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, management=management, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityTableIndex=vLANPriorityTableIndex, phyControl=phyControl, vLANManagementVID=vLANManagementVID, sNMPv3Enable=sNMPv3Enable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userEnabled=userEnabled, receiveFreqKHz=receiveFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, frequencyVariant=frequencyVariant, sNMPTrapVersion=sNMPTrapVersion, ethernetFiberSupport=ethernetFiberSupport, licence=licence, searchState=searchState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, pubStats=pubStats, transmitPower=transmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, range=range, softwareVersion=softwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTable=userTable, siteName=siteName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productName=productName, linkLoss=linkLoss, eIRP=eIRP, receiveFreqMHz=receiveFreqMHz, vLANManagementPriority=vLANManagementPriority, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, aAAControl=aAAControl, managementGroup=managementGroup, syslogClient=syslogClient, timeZone=timeZone, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDControlGroup=tDDControlGroup, ptpCompliance=ptpCompliance, snmpControl=snmpControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableNumber=userTableNumber, linkSymmetry=linkSymmetry, unitOutOfCalibration=unitOutOfCalibration, longitude=longitude, sNTPSync=sNTPSync, supplementary=supplementary, phyStatus=phyStatus, resetGroup=resetGroup, hardwareVersion=hardwareVersion, ptp=ptp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, notificationsGroup=notificationsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, regionCodeTrap=regionCodeTrap, phyControlGroup=phyControlGroup, encryptionAlgorithm=encryptionAlgorithm, ptpGroups=ptpGroups, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, versionsGroup=versionsGroup, alarms=alarms, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecom=telecom, sMTPServerPortNumber=sMTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitFreqMHz=transmitFreqMHz, sNMPEnabledTraps=sNMPEnabledTraps, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, subnetMask=subnetMask, telecomsCableLength=telecomsCableLength, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userTableEntry=userTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPServerPortNumber=sNTPServerPortNumber, pubStatsGroup=pubStatsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsMeans=dfsMeans, wirelessLinkStatus=wirelessLinkStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, iPAddress=iPAddress, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkAvailability=wirelessLinkAvailability, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, smtp=smtp, byteErrorRatio=byteErrorRatio, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, licensedCapacity=licensedCapacity, hTTPSAccessEnabled=hTTPSAccessEnabled, accessMethod=accessMethod, PYSNMP_MODULE_ID=cambium)
