...
# Produced by pysmi-1.1.3 at Wed Dec  1 17:33:35 2021
...
ModuleIdentity, Bits, Counter32, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, enterprises, Counter64, iso, NotificationType, TimeTicks, Gauge32, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter32", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "enterprises", "Counter64", "iso", "NotificationType", "TimeTicks", "Gauge32", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortStatusTrap=dataPortStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityTableIndex=vLANPriorityTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemClock=systemClock, management=management, channelBandwidth=channelBandwidth, dataPortAutoMdix=dataPortAutoMdix, licenceGroup=licenceGroup, hardwareVersion=hardwareVersion, wirelessLinkStatus=wirelessLinkStatus, cableLoss=cableLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStats=pubStats, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerIPAddress=sNTPServerIPAddress, managementGroup=managementGroup, linkName=linkName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, eIRP=eIRP, telecomsLoopback=telecomsLoopback, unitOutOfCalibration=unitOutOfCalibration, vectorError=vectorError, sNMPPortNumber=sNMPPortNumber, bandwidthVariant=bandwidthVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitChannel=transmitChannel, tDDControl=tDDControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, smtp=smtp, sMTPEnabledMessages=sMTPEnabledMessages, installArmState=installArmState, daylightSaving=daylightSaving, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productName=productName, PYSNMP_MODULE_ID=cambium, aAAControl=aAAControl, sMTPServerIPAddress=sMTPServerIPAddress, syslogClientTrap=syslogClientTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, ptpCompliance=ptpCompliance, groupID=groupID, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPPollInterval=sNTPPollInterval, receivePower=receivePower, vLANPriorityQueueMapping=vLANPriorityQueueMapping, encryptionAlgorithm=encryptionAlgorithm, telecom=telecom, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, frequencyVariant=frequencyVariant, alarms=alarms, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortConfigurationMismatch=dataPortConfigurationMismatch, phyControlGroup=phyControlGroup, dfsMeans=dfsMeans, systemReset=systemReset, dfsPeaks=dfsPeaks, vLANManagementVID=vLANManagementVID, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableIndex=userTableIndex, ptmp=ptmp, remoteIPAddress=remoteIPAddress, latitude=latitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, gatewayIPAddress=gatewayIPAddress, cambium=cambium, iPAddress=iPAddress, regionCode=regionCode, licensedCapacity=licensedCapacity, sMTPEmailAlert=sMTPEmailAlert, userPassword=userPassword, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTable=dfsTable, aggregateDataRate=aggregateDataRate, sNTPSyncTrap=sNTPSyncTrap, alarmsGroup=alarmsGroup, hTTPSPortNumber=hTTPSPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomGroup=telecomGroup, installArmStateTrap=installArmStateTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapVersion=sNMPTrapVersion, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, ptpGroups=ptpGroups, syslogClient=syslogClient, dfsGroup=dfsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernet=ethernet, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetGroup=ethernetGroup, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimisation=linkModeOptimisation, encryptionGroup=encryptionGroup, phyControl=phyControl, syslogControl=syslogControl, sNTPLastSync=sNTPLastSync, bootVersion=bootVersion, searchState=searchState, userTableNumber=userTableNumber, regionCodeTrap=regionCodeTrap, snmpControlGroup=snmpControlGroup, accessMethod=accessMethod, sntpGroup=sntpGroup, telecomsLineCode=telecomsLineCode, sMTPServerPortNumber=sMTPServerPortNumber, timeZone=timeZone, syslogStateTrap=syslogStateTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogControlGroup=syslogControlGroup, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, hTTPPortNumber=hTTPPortNumber, softwareVersion=softwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetAccessEnabled=telnetAccessEnabled, transmitModulationMode=transmitModulationMode, installStatus=installStatus, dataPortStatus=dataPortStatus, versions=versions, antennaGain=antennaGain, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTableNumber=dfsTableNumber, linkSymmetry=linkSymmetry, ptpTraps=ptpTraps, sNMPTrapIPAddress=sNMPTrapIPAddress, userEnabled=userEnabled, telecomsCableLength=telecomsCableLength, subnetMask=subnetMask, smtpGroup=smtpGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, supplementaryGroup=supplementaryGroup, ptp=ptp, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleRegionCodes=incompatibleRegionCodes, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, userRole=userRole, siteName=siteName, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveFreqKHz=receiveFreqKHz, altitude=altitude, ptp500=ptp500, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsInterface=telecomsInterface, licence=licence, transmitDataRate=transmitDataRate, transmitFreqKHz=transmitFreqKHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPAccessEnabled=hTTPAccessEnabled, userTableEntry=userTableEntry, notificationsGroup=notificationsGroup, sNTPSync=sNTPSync, tDDControlGroup=tDDControlGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installStatusTrap=installStatusTrap, dfs=dfs, signalStrengthRatio=signalStrengthRatio, transmitPower=transmitPower, telnetPortNumber=telnetPortNumber, linkLoss=linkLoss, pubStatsGroup=pubStatsGroup, receiveChannel=receiveChannel, range=range, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetFiberSupport=ethernetFiberSupport, aAAControlGroup=aAAControlGroup, vLANManagementPriority=vLANManagementPriority, reset=reset, telecomsChannelStatus=telecomsChannelStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTableEntry=dfsTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableIndex=dfsTableIndex, longitude=longitude, userName=userName, productVariant=productVariant, resetGroup=resetGroup, configuration=configuration, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPv3Enable=sNMPv3Enable, syslogState=syslogState, capacityLicenseMismatch=capacityLicenseMismatch, sNTPState=sNTPState, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, configurationGroup=configurationGroup, dataPortDisabledWarning=dataPortDisabledWarning, receiveDataRate=receiveDataRate, phyStatusGroup=phyStatusGroup, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, targetMACAddress=targetMACAddress, sNMPCommunityString=sNMPCommunityString, vLANPriorityTable=vLANPriorityTable, encryption=encryption, userTable=userTable, wirelessLinkAvailability=wirelessLinkAvailability, byteErrorRatio=byteErrorRatio, versionsGroup=versionsGroup, maximumTransmitPower=maximumTransmitPower, supplementary=supplementary, receiveFreqMHz=receiveFreqMHz, phyStatus=phyStatus)
