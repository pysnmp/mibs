...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, IpAddress, enterprises, NotificationType, Counter64, iso, Integer32, ModuleIdentity, Bits, Unsigned32, TimeTicks, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "IpAddress", "enterprises", "NotificationType", "Counter64", "iso", "Integer32", "ModuleIdentity", "Bits", "Unsigned32", "TimeTicks", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userEnabled=userEnabled, userTableNumber=userTableNumber, maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, iPAddress=iPAddress, telecomsLoopback=telecomsLoopback, snmpControlGroup=snmpControlGroup, encryption=encryption, regionCode=regionCode, tDDControlGroup=tDDControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityTableNumber=vLANPriorityTableNumber, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sntp=sntp, frequencyVariant=frequencyVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEmailAlert=sMTPEmailAlert, transmitPower=transmitPower, linkModeOptimizationMismatch=linkModeOptimizationMismatch, timeZone=timeZone, sNTPSyncTrap=sNTPSyncTrap, gatewayIPAddress=gatewayIPAddress, telecomsCableLength=telecomsCableLength, subnetMask=subnetMask, telecomsLineCode=telecomsLineCode, alarmsGroup=alarmsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, ptmp=ptmp, sNTPServerIPAddress=sNTPServerIPAddress, longitude=longitude, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitFreqKHz=transmitFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenceGroup=licenceGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, systemClock=systemClock, ptp=ptp, linkSymmetry=linkSymmetry, dfsTableEntry=dfsTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, aggregateDataRate=aggregateDataRate, dfsGroup=dfsGroup, aAAControlGroup=aAAControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, linkLoss=linkLoss, ptpCompliance=ptpCompliance, eIRP=eIRP, installArmStateTrap=installArmStateTrap, linkName=linkName, constantPowerSpectralDensity=constantPowerSpectralDensity, systemReset=systemReset, userRole=userRole, regionCodeTrap=regionCodeTrap, productVariant=productVariant, channelChangeTrap=channelChangeTrap, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControlGroup=syslogControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, configuration=configuration, sNTPServerPortNumber=sNTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, antennaGain=antennaGain, hTTPSPortNumber=hTTPSPortNumber, sNTPState=sNTPState, remoteIPAddress=remoteIPAddress, syslogState=syslogState, management=management, notificationsGroup=notificationsGroup, vLANManagementPriority=vLANManagementPriority, userPassword=userPassword, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpTrapPrefix=ptpTrapPrefix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogClientTrap=syslogClientTrap, sNTPPollInterval=sNTPPollInterval, dfs=dfs, ptpGroups=ptpGroups, searchState=searchState, bandwidthVariant=bandwidthVariant, receiveFreqMHz=receiveFreqMHz, smtp=smtp, sNMPCommunityString=sNMPCommunityString, telecomsInterface=telecomsInterface, alarms=alarms, licensedCapacity=licensedCapacity, dataPortStatusTrap=dataPortStatusTrap, dfsTableIndex=dfsTableIndex, receiveModulationModeDetail=receiveModulationModeDetail, softwareVersion=softwareVersion, encryptionGroup=encryptionGroup, ethernetGroup=ethernetGroup, dfsTable=dfsTable, userTableEntry=userTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, accessMethod=accessMethod, telecomGroup=telecomGroup, dataPortStatus=dataPortStatus, reset=reset, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerPortNumber=sMTPServerPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, productName=productName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, altitude=altitude, cambium=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPSync=sNTPSync, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, pubStatsGroup=pubStatsGroup, targetMACAddress=targetMACAddress, supplementary=supplementary, resetGroup=resetGroup, sntpGroup=sntpGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogControl=syslogControl, sNMPTrapTable=sNMPTrapTable, installStatusTrap=installStatusTrap, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptp500=ptp500, unitOutOfCalibration=unitOutOfCalibration, dfsMeans=dfsMeans, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ethernetFiberSupport=ethernetFiberSupport, userTable=userTable, cableLoss=cableLoss, linkModeOptimisation=linkModeOptimisation, syslogStateTrap=syslogStateTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, groupID=groupID, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, phyControlGroup=phyControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqKHz=receiveFreqKHz, receiveDataRate=receiveDataRate, syslogClient=syslogClient, receiveModulationMode=receiveModulationMode, telecom=telecom, managementGroup=managementGroup, phyStatus=phyStatus, dfsTableNumber=dfsTableNumber, versionsGroup=versionsGroup, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, telnetAccessEnabled=telnetAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, encryptionAlgorithm=encryptionAlgorithm, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitModulationMode=transmitModulationMode, ethernet=ethernet, transmitChannel=transmitChannel, vLANPriorityTable=vLANPriorityTable, secondarySoftwareVersion=secondarySoftwareVersion, configurationGroup=configurationGroup, daylightSaving=daylightSaving, range=range, smtpGroup=smtpGroup, latitude=latitude, supplementaryGroup=supplementaryGroup, channelBandwidth=channelBandwidth, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatusGroup=phyStatusGroup, telnetPortNumber=telnetPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, sNTPLastSync=sNTPLastSync, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelStatus=telecomsChannelStatus, installArmState=installArmState, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, pubStats=pubStats, installStatus=installStatus, sNMPTrapVersion=sNMPTrapVersion, byteErrorRatio=byteErrorRatio, versions=versions, transmitFreqMHz=transmitFreqMHz, snmpControl=snmpControl, tDDControl=tDDControl, ptpTraps=ptpTraps, bootVersion=bootVersion, dfsPeaks=dfsPeaks, licence=licence, hTTPAccessEnabled=hTTPAccessEnabled, vectorError=vectorError, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveChannel=receiveChannel, aAAControl=aAAControl, siteName=siteName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, userTableIndex=userTableIndex, sNMPTrapTableIndex=sNMPTrapTableIndex)
