...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTable=vLANPriorityTable, dataPortDisabledWarning=dataPortDisabledWarning, receivePower=receivePower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfs=dfs, ptp500=ptp500, timeZone=timeZone, licenceGroup=licenceGroup, userEnabled=userEnabled, management=management, sNTPPollInterval=sNTPPollInterval, smtp=smtp, telnetPortNumber=telnetPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sntp=sntp, targetMACAddress=targetMACAddress, vLANManagementPriority=vLANManagementPriority, sNMPEnabledTraps=sNMPEnabledTraps, tDDControlGroup=tDDControlGroup, transmitFreqKHz=transmitFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkSymmetry=linkSymmetry, managementGroup=managementGroup, phyControl=phyControl, sNMPTrapVersion=sNMPTrapVersion, aggregateDataRate=aggregateDataRate, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitModulationMode=transmitModulationMode, phyControlGroup=phyControlGroup, hTTPSPortNumber=hTTPSPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, tDDControl=tDDControl, encryptionGroup=encryptionGroup, daylightSaving=daylightSaving, userName=userName, searchState=searchState, ptpTraps=ptpTraps, telecomsInterface=telecomsInterface, sNTPServerIPAddress=sNTPServerIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarms=alarms, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveModulationModeDetail=receiveModulationModeDetail, linkLoss=linkLoss, dataPortConfigurationMismatch=dataPortConfigurationMismatch, snmpControlGroup=snmpControlGroup, altitude=altitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaGain=antennaGain, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSync=sNTPSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTable=dfsTable, tFTPServerPortNumber=tFTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, cableLoss=cableLoss, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpCompliance=ptpCompliance, configuration=configuration, PYSNMP_MODULE_ID=cambium, bandwidthVariant=bandwidthVariant, ethernetFiberSupport=ethernetFiberSupport, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPState=sNTPState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptmp=ptmp, vLANPriorityTableIndex=vLANPriorityTableIndex, subnetMask=subnetMask, productVariant=productVariant, tDDSynchronizationStatus=tDDSynchronizationStatus, groupID=groupID, userTableIndex=userTableIndex, syslogState=syslogState, channelBandwidth=channelBandwidth, hTTPPortNumber=hTTPPortNumber, masterSlaveMode=masterSlaveMode, userTable=userTable, vLANManagementVID=vLANManagementVID, licensedCapacity=licensedCapacity, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, sntpGroup=sntpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, cambium=cambium, range=range, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsChannelStatus=telecomsChannelStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, siteName=siteName, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, latitude=latitude, vLANPriorityTableEntry=vLANPriorityTableEntry, hardwareVersion=hardwareVersion, ptp=ptp, softwareVersion=softwareVersion, receiveFreqMHz=receiveFreqMHz, telecomsLoopback=telecomsLoopback, bootVersion=bootVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, systemClock=systemClock, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, longitude=longitude, encryption=encryption, installStatus=installStatus, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPSyncTrap=sNTPSyncTrap, smtpGroup=smtpGroup, dfsGroup=dfsGroup, aAAControlGroup=aAAControlGroup, sNMPTrapTable=sNMPTrapTable, regionCodeTrap=regionCodeTrap, maximumTransmitPower=maximumTransmitPower, alarmsGroup=alarmsGroup, ethernet=ethernet, wirelessLinkStatus=wirelessLinkStatus, dfsPeaks=dfsPeaks, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, phyStatus=phyStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemReset=systemReset, frequencyVariant=frequencyVariant, sMTPServerPortNumber=sMTPServerPortNumber, transmitChannel=transmitChannel, telecomsChannelStatusTrap=telecomsChannelStatusTrap, eIRP=eIRP, resetGroup=resetGroup, dataPortStatusTrap=dataPortStatusTrap, userTableEntry=userTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsLoopbackTrap=telecomsLoopbackTrap, ethernetGroup=ethernetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerPortNumber=sNTPServerPortNumber, receiveChannel=receiveChannel, versionsGroup=versionsGroup, linkName=linkName, userTableNumber=userTableNumber, iPAddress=iPAddress, hTTPAccessEnabled=hTTPAccessEnabled, supplementaryGroup=supplementaryGroup, transmitPower=transmitPower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsTableIndex=dfsTableIndex, licence=licence, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityString=sNMPCommunityString, accessMethod=accessMethod, installStatusTrap=installStatusTrap, syslogControlGroup=syslogControlGroup, aAAControl=aAAControl, syslogClient=syslogClient, productName=productName, tDDSynchronizationMode=tDDSynchronizationMode, vectorError=vectorError, linkModeOptimisation=linkModeOptimisation, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, versions=versions, snmpControl=snmpControl, configurationGroup=configurationGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmStateTrap=installArmStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, signalStrengthRatio=signalStrengthRatio, capacityLicenseMismatch=capacityLicenseMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementary=supplementary, vLANPriorityQueueMapping=vLANPriorityQueueMapping, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, channelChangeTrap=channelChangeTrap, regionCode=regionCode, notificationsGroup=notificationsGroup, encryptionAlgorithm=encryptionAlgorithm, telnetAccessEnabled=telnetAccessEnabled, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userPassword=userPassword, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogClientTrap=syslogClientTrap, syslogControl=syslogControl, phyStatusGroup=phyStatusGroup, ptpGroups=ptpGroups, remoteIPAddress=remoteIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableNumber=dfsTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveFreqKHz=receiveFreqKHz, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsCableLength=telecomsCableLength, transmitDataRate=transmitDataRate, telecomGroup=telecomGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, userRole=userRole, telecom=telecom, dfsTableEntry=dfsTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, secondarySoftwareVersion=secondarySoftwareVersion, reset=reset, syslogStateTrap=syslogStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsLineCode=telecomsLineCode)
