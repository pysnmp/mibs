...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:21:09 2021
...
TimeTicks, Counter64, Gauge32, Unsigned32, enterprises, MibIdentifier, NotificationType, Counter32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Bits, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter64", "Gauge32", "Unsigned32", "enterprises", "MibIdentifier", "NotificationType", "Counter32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Bits", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTableNumber=userTableNumber, installArmStateTrap=installArmStateTrap, snmpControl=snmpControl, userEnabled=userEnabled, sntpGroup=sntpGroup, alarms=alarms, maximumTransmitPower=maximumTransmitPower, vLANManagementPriority=vLANManagementPriority, userTableIndex=userTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecom=telecom, sMTPSourceEmailAddress=sMTPSourceEmailAddress, regionCode=regionCode, softwareVersion=softwareVersion, byteErrorRatio=byteErrorRatio, alarmsGroup=alarmsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receivePower=receivePower, sNTPSync=sNTPSync, syslogStateTrap=syslogStateTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortAutoNegotiation=dataPortAutoNegotiation, accessMethod=accessMethod, channelBandwidth=channelBandwidth, receiveModulationModeDetail=receiveModulationModeDetail, phyStatusGroup=phyStatusGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveChannel=receiveChannel, configuration=configuration, ptp500=ptp500, masterSlaveMode=masterSlaveMode, ptp=ptp, configurationGroup=configurationGroup, linkName=linkName, smtp=smtp, telecomsLineCode=telecomsLineCode, receiveFreqMHz=receiveFreqMHz, licensedCapacity=licensedCapacity, telecomGroup=telecomGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licence=licence, vectorError=vectorError, aAAControlGroup=aAAControlGroup, tDDControlGroup=tDDControlGroup, dfsTableIndex=dfsTableIndex, encryptionAlgorithm=encryptionAlgorithm, linkSymmetry=linkSymmetry, range=range, channelChangeTrap=channelChangeTrap, vLANPriorityTable=vLANPriorityTable, dfsMeans=dfsMeans, syslogControlGroup=syslogControlGroup, phyStatus=phyStatus, linkModeOptimisation=linkModeOptimisation, groupID=groupID, tDDControl=tDDControl, notificationsGroup=notificationsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANManagementVID=vLANManagementVID, linkLoss=linkLoss, hTTPSPortNumber=hTTPSPortNumber, syslogControl=syslogControl, sNTPServerIPAddress=sNTPServerIPAddress, supplementary=supplementary, sMTPEnabledMessages=sMTPEnabledMessages, PYSNMP_MODULE_ID=cambium, versions=versions, transmitFreqMHz=transmitFreqMHz, systemReset=systemReset, hTTPSAccessEnabled=hTTPSAccessEnabled, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, reset=reset, resetGroup=resetGroup, syslogState=syslogState, wirelessLinkStatus=wirelessLinkStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTable=dfsTable, wirelessLinkAvailability=wirelessLinkAvailability, encryptionGroup=encryptionGroup, syslogClient=syslogClient, syslogClientTrap=syslogClientTrap, ptpTrapPrefix=ptpTrapPrefix, dfsTableEntry=dfsTableEntry, iPAddress=iPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsGroup=dfsGroup, installArmState=installArmState, telnetPortNumber=telnetPortNumber, ptpGroups=ptpGroups, versionsGroup=versionsGroup, receiveFreqKHz=receiveFreqKHz, transmitChannel=transmitChannel, managementGroup=managementGroup, sNMPTrapTable=sNMPTrapTable, daylightSaving=daylightSaving, ethernet=ethernet, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, aAAControl=aAAControl, userRole=userRole, longitude=longitude, receiveDataRate=receiveDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyControlGroup=phyControlGroup, transmitDataRate=transmitDataRate, sNTPState=sNTPState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, timeZone=timeZone, sNMPTrapVersion=sNMPTrapVersion, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, productVariant=productVariant, transmitFreqKHz=transmitFreqKHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfs=dfs, telecomsCableLength=telecomsCableLength, phyControl=phyControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, pubStatsGroup=pubStatsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, productName=productName, sMTPEmailAlert=sMTPEmailAlert, supplementaryGroup=supplementaryGroup, tDDSynchronizationMode=tDDSynchronizationMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableEntry=userTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPCommunityString=sNMPCommunityString, latitude=latitude, ptpCompliance=ptpCompliance, targetMACAddress=targetMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleRegionCodes=incompatibleRegionCodes, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, capacityLicenseMismatch=capacityLicenseMismatch, userPassword=userPassword, telecomsLoopbackTrap=telecomsLoopbackTrap, altitude=altitude, eIRP=eIRP, snmpControlGroup=snmpControlGroup, cableLoss=cableLoss, hTTPPortNumber=hTTPPortNumber, ptpTraps=ptpTraps, signalStrengthRatio=signalStrengthRatio, noWirelessChannelAvailable=noWirelessChannelAvailable, userTable=userTable, ptmp=ptmp, dfsTableNumber=dfsTableNumber, sntp=sntp, hardwareVersion=hardwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveModulationMode=receiveModulationMode, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, bootVersion=bootVersion, sNTPLastSync=sNTPLastSync, remoteIPAddress=remoteIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernetFiberSupport=ethernetFiberSupport, licenceGroup=licenceGroup, dfsPeaks=dfsPeaks, installStatus=installStatus, userName=userName, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatus=dataPortStatus, bandwidthVariant=bandwidthVariant, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, pubStats=pubStats, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, searchState=searchState, cambium=cambium, transmitPower=transmitPower, encryption=encryption, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsLoopback=telecomsLoopback, ethernetGroup=ethernetGroup, dataPortStatusTrap=dataPortStatusTrap, installStatusTrap=installStatusTrap, sNTPSyncTrap=sNTPSyncTrap, systemClock=systemClock, siteName=siteName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, subnetMask=subnetMask, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsInterface=telecomsInterface, dataPortAutoMdix=dataPortAutoMdix, tFTPServerPortNumber=tFTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitModulationMode=transmitModulationMode, regionCodeTrap=regionCodeTrap, management=management, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, frequencyVariant=frequencyVariant, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, unitOutOfCalibration=unitOutOfCalibration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, antennaGain=antennaGain, tDDSynchronizationStatus=tDDSynchronizationStatus)
