...
# Produced by pysmi-1.1.3 at Sat Nov 20 16:49:32 2021
...
Integer32, Unsigned32, Counter32, IpAddress, iso, enterprises, TimeTicks, Counter64, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, ModuleIdentity, NotificationType, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter32", "IpAddress", "iso", "enterprises", "TimeTicks", "Counter64", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "ModuleIdentity", "NotificationType", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkLoss=linkLoss, versions=versions, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControl=syslogControl, userEnabled=userEnabled, syslogStateTrap=syslogStateTrap, incompatibleRegionCodes=incompatibleRegionCodes, longitude=longitude, sNMPTrapVersion=sNMPTrapVersion, phyControlGroup=phyControlGroup, productName=productName, subnetMask=subnetMask, linkModeOptimisation=linkModeOptimisation, dfsTableIndex=dfsTableIndex, telecomsCableLength=telecomsCableLength, telecomsInterface=telecomsInterface, transmitDataRate=transmitDataRate, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpGroups=ptpGroups, smtpGroup=smtpGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveDataRate=receiveDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStats=pubStats, installStatus=installStatus, versionsGroup=versionsGroup, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEmailAlert=sMTPEmailAlert, pubStatsGroup=pubStatsGroup, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqKHz=receiveFreqKHz, groupID=groupID, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, secondarySoftwareVersion=secondarySoftwareVersion, dfsTable=dfsTable, userPassword=userPassword, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANPriorityTable=vLANPriorityTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryption=encryption, productVariant=productVariant, installStatusTrap=installStatusTrap, hTTPPortNumber=hTTPPortNumber, alarms=alarms, regionCodeTrap=regionCodeTrap, systemClock=systemClock, timeZone=timeZone, hardwareVersion=hardwareVersion, telecomsLineCode=telecomsLineCode, licence=licence, alarmsGroup=alarmsGroup, sNTPServerIPAddress=sNTPServerIPAddress, telecomsLoopback=telecomsLoopback, systemReset=systemReset, supplementaryGroup=supplementaryGroup, configuration=configuration, bootVersion=bootVersion, regionCode=regionCode, linkSymmetry=linkSymmetry, vLANPriorityTableEntry=vLANPriorityTableEntry, phyStatusGroup=phyStatusGroup, signalStrengthRatio=signalStrengthRatio, dfsMeans=dfsMeans, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableNumber=userTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, softwareVersion=softwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, userName=userName, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, wirelessLinkStatus=wirelessLinkStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPCommunityString=sNMPCommunityString, siteName=siteName, receivePower=receivePower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bandwidthVariant=bandwidthVariant, dfsGroup=dfsGroup, ethernet=ethernet, syslogClient=syslogClient, antennaGain=antennaGain, aAAControl=aAAControl, sntp=sntp, tDDSynchronizationStatus=tDDSynchronizationStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, range=range, sNMPPortNumber=sNMPPortNumber, encryptionGroup=encryptionGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelChangeTrap=channelChangeTrap, supplementary=supplementary, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, userTable=userTable, dfsTableNumber=dfsTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, targetMACAddress=targetMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPServerPortNumber=sNTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, sNTPState=sNTPState, ptpTrapPrefix=ptpTrapPrefix, dfsTableEntry=dfsTableEntry, ethernetFiberSupport=ethernetFiberSupport, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetGroup=ethernetGroup, vLANManagementVID=vLANManagementVID, frequencyVariant=frequencyVariant, dfs=dfs, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkName=linkName, receiveChannel=receiveChannel, transmitFreqMHz=transmitFreqMHz, syslogClientTrap=syslogClientTrap, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, snmpControl=snmpControl, iPAddress=iPAddress, ptp500=ptp500, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveModulationMode=receiveModulationMode, ptpCompliance=ptpCompliance, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, dataPortDisabledWarning=dataPortDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, remoteIPAddress=remoteIPAddress, snmpControlGroup=snmpControlGroup, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogControlGroup=syslogControlGroup, transmitModulationMode=transmitModulationMode, ptmp=ptmp, capacityLicenseMismatch=capacityLicenseMismatch, aAAControlGroup=aAAControlGroup, ptp=ptp, notificationsGroup=notificationsGroup, receiveFreqMHz=receiveFreqMHz, aggregateDataRate=aggregateDataRate, userTableIndex=userTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, phyControl=phyControl, telecomGroup=telecomGroup, phyStatus=phyStatus, vLANManagementPriority=vLANManagementPriority, sNMPTrapTable=sNMPTrapTable, sNTPSync=sNTPSync, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, reset=reset, dataPortAutoMdix=dataPortAutoMdix, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, transmitChannel=transmitChannel, searchState=searchState, sNTPPollInterval=sNTPPollInterval, dataPortStatus=dataPortStatus, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, smtp=smtp, dataPortConfigurationMismatch=dataPortConfigurationMismatch, gatewayIPAddress=gatewayIPAddress, tDDControl=tDDControl, ptpTraps=ptpTraps, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, management=management, tFTPServerPortNumber=tFTPServerPortNumber, licensedCapacity=licensedCapacity, cambium=cambium, transmitPower=transmitPower, accessMethod=accessMethod, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, eIRP=eIRP, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalWrappedTrap=syslogLocalWrappedTrap, installArmState=installArmState, userTableEntry=userTableEntry, daylightSaving=daylightSaving, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telnetPortNumber=telnetPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkAvailability=wirelessLinkAvailability, syslogState=syslogState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPServerPortNumber=sMTPServerPortNumber, installArmStateTrap=installArmStateTrap, vectorError=vectorError, hTTPAccessEnabled=hTTPAccessEnabled, userRole=userRole, telecom=telecom, maximumTransmitPower=maximumTransmitPower, licenceGroup=licenceGroup, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, configurationGroup=configurationGroup, altitude=altitude, telnetAccessEnabled=telnetAccessEnabled, sntpGroup=sntpGroup, managementGroup=managementGroup, sNTPLastSync=sNTPLastSync, resetGroup=resetGroup, latitude=latitude, byteErrorRatio=byteErrorRatio, dfsPeaks=dfsPeaks, tFTPServerIPAddress=tFTPServerIPAddress, tDDControlGroup=tDDControlGroup)
