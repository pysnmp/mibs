...
NotificationType, Integer32, ModuleIdentity, Counter32, iso, Bits, ObjectIdentity, IpAddress, TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ModuleIdentity", "Counter32", "iso", "Bits", "ObjectIdentity", "IpAddress", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", managementGroup=managementGroup, dfsTableEntry=dfsTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPPortNumber=hTTPPortNumber, sNTPPollInterval=sNTPPollInterval, licenceGroup=licenceGroup, accessMethod=accessMethod, ethernetFiberSupport=ethernetFiberSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsMeans=dfsMeans, receiveFreqKHz=receiveFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, byteErrorRatio=byteErrorRatio, sNMPTrapIPAddress=sNMPTrapIPAddress, regionCode=regionCode, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPAccessEnabled=hTTPAccessEnabled, pubStatsGroup=pubStatsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, altitude=altitude, hTTPSPortNumber=hTTPSPortNumber, ptmp=ptmp, linkLoss=linkLoss, constantPowerSpectralDensity=constantPowerSpectralDensity, PYSNMP_MODULE_ID=cambium, userRole=userRole, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryptionGroup=encryptionGroup, systemReset=systemReset, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogClientTrap=syslogClientTrap, encryption=encryption, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapVersion=sNMPTrapVersion, tDDControl=tDDControl, gatewayIPAddress=gatewayIPAddress, remoteIPAddress=remoteIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, ethernet=ethernet, sNMPv3Enable=sNMPv3Enable, hTTPSAccessEnabled=hTTPSAccessEnabled, longitude=longitude, siteName=siteName, antennaGain=antennaGain, cambium=cambium, searchState=searchState, daylightSaving=daylightSaving, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsLineCode=telecomsLineCode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, phyStatus=phyStatus, installStatusTrap=installStatusTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveFreqMHz=receiveFreqMHz, sNTPState=sNTPState, supplementary=supplementary, phyStatusGroup=phyStatusGroup, bandwidthVariant=bandwidthVariant, transmitModulationMode=transmitModulationMode, userTableIndex=userTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyControl=phyControl, sNMPEnabledTraps=sNMPEnabledTraps, channelChangeTrap=channelChangeTrap, syslogClient=syslogClient, sMTPServerPortNumber=sMTPServerPortNumber, telecomsChannelStatus=telecomsChannelStatus, telecomsLoopback=telecomsLoopback, transmitPower=transmitPower, receiveChannel=receiveChannel, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, telecomsCableLength=telecomsCableLength, aAAControl=aAAControl, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPCommunityString=sNMPCommunityString, ptp=ptp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sntp=sntp, versions=versions, timeZone=timeZone, supplementaryGroup=supplementaryGroup, capacityLicenseMismatch=capacityLicenseMismatch, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatus=dataPortStatus, vLANPriorityTable=vLANPriorityTable, vLANManagementPriority=vLANManagementPriority, pubStats=pubStats, transmitDataRate=transmitDataRate, licensedCapacity=licensedCapacity, tFTPServerPortNumber=tFTPServerPortNumber, dfsTableNumber=dfsTableNumber, userPassword=userPassword, configuration=configuration, reset=reset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPServerIPAddress=sNTPServerIPAddress, signalStrengthRatio=signalStrengthRatio, ptpTrapPrefix=ptpTrapPrefix, sNMPPortNumber=sNMPPortNumber, dfsPeaks=dfsPeaks, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, targetMACAddress=targetMACAddress, eIRP=eIRP, range=range, licence=licence, telnetPortNumber=telnetPortNumber, syslogStateTrap=syslogStateTrap, phyControlGroup=phyControlGroup, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, installArmState=installArmState, alarmsGroup=alarmsGroup, dataPortAutoMdix=dataPortAutoMdix, receiveModulationModeDetail=receiveModulationModeDetail, userTableEntry=userTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitFreqMHz=transmitFreqMHz, installStatus=installStatus, frequencyVariant=frequencyVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveModulationMode=receiveModulationMode, resetGroup=resetGroup, ptp500=ptp500, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkStatus=wirelessLinkStatus, maximumTransmitPower=maximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, userName=userName, channelBandwidth=channelBandwidth, telecomGroup=telecomGroup, syslogControl=syslogControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productName=productName, receiveDataRate=receiveDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsGroup=dfsGroup, ptpCompliance=ptpCompliance, installArmStateTrap=installArmStateTrap, smtpGroup=smtpGroup, aggregateDataRate=aggregateDataRate, snmpControl=snmpControl, userEnabled=userEnabled, latitude=latitude, dfsTableIndex=dfsTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, encryptionAlgorithm=encryptionAlgorithm, dfs=dfs, linkModeOptimisation=linkModeOptimisation, sNTPSync=sNTPSync, syslogControlGroup=syslogControlGroup, ptpGroups=ptpGroups, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecom=telecom, transmitChannel=transmitChannel, cableLoss=cableLoss, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receivePower=receivePower, bootVersion=bootVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, incompatibleRegionCodes=incompatibleRegionCodes, hardwareVersion=hardwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, alarms=alarms, groupID=groupID, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetGroup=ethernetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, smtp=smtp, ptpTraps=ptpTraps, iPAddress=iPAddress, snmpControlGroup=snmpControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibration=unitOutOfCalibration, dataPortDisabledWarning=dataPortDisabledWarning, vectorError=vectorError, linkName=linkName, sNTPLastSync=sNTPLastSync, versionsGroup=versionsGroup, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, configurationGroup=configurationGroup, telnetAccessEnabled=telnetAccessEnabled, aAAControlGroup=aAAControlGroup, sNTPSyncTrap=sNTPSyncTrap, systemClock=systemClock, notificationsGroup=notificationsGroup, transmitFreqKHz=transmitFreqKHz, telecomsInterface=telecomsInterface, softwareVersion=softwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, linkSymmetry=linkSymmetry, userTable=userTable, syslogState=syslogState, userTableNumber=userTableNumber, regionCodeTrap=regionCodeTrap, management=management, subnetMask=subnetMask, sntpGroup=sntpGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDControlGroup=tDDControlGroup, dfsTable=dfsTable)
