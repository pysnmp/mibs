...
MibIdentifier, TimeTicks, Integer32, Bits, Gauge32, enterprises, iso, IpAddress, Unsigned32, ObjectIdentity, Counter64, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "TimeTicks", "Integer32", "Bits", "Gauge32", "enterprises", "iso", "IpAddress", "Unsigned32", "ObjectIdentity", "Counter64", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPPortNumber=hTTPPortNumber, maximumTransmitPower=maximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, aAAControlGroup=aAAControlGroup, transmitFreqKHz=transmitFreqKHz, receiveModulationModeDetail=receiveModulationModeDetail, dfsGroup=dfsGroup, userTableIndex=userTableIndex, sNTPLastSync=sNTPLastSync, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleRegionCodes=incompatibleRegionCodes, hardwareVersion=hardwareVersion, telnetAccessEnabled=telnetAccessEnabled, userName=userName, transmitModulationMode=transmitModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, antennaGain=antennaGain, vectorError=vectorError, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, signalStrengthRatio=signalStrengthRatio, gatewayIPAddress=gatewayIPAddress, sNMPv3Enable=sNMPv3Enable, bootVersion=bootVersion, altitude=altitude, telecomsLoopback=telecomsLoopback, vLANManagementPriority=vLANManagementPriority, unitOutOfCalibration=unitOutOfCalibration, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTable=sNMPTrapTable, sMTPServerPortNumber=sMTPServerPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, ethernetFiberSupport=ethernetFiberSupport, versions=versions, transmitDataRate=transmitDataRate, ethernetGroup=ethernetGroup, syslogControl=syslogControl, linkName=linkName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, encryptionGroup=encryptionGroup, telnetPortNumber=telnetPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receivePower=receivePower, dfsPeaks=dfsPeaks, productName=productName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, cambium=cambium, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLineCode=telecomsLineCode, dfs=dfs, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernet=ethernet, snmpControlGroup=snmpControlGroup, remoteIPAddress=remoteIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, userPassword=userPassword, vLANManagementVID=vLANManagementVID, tFTPServerPortNumber=tFTPServerPortNumber, sntp=sntp, dfsMeans=dfsMeans, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, pubStats=pubStats, syslogStateTrap=syslogStateTrap, phyStatus=phyStatus, installStatus=installStatus, linkLoss=linkLoss, receiveFreqKHz=receiveFreqKHz, wirelessLinkAvailability=wirelessLinkAvailability, groupID=groupID, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogClient=syslogClient, phyControl=phyControl, sNTPServerPortNumber=sNTPServerPortNumber, iPAddress=iPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, supplementary=supplementary, sNTPServerIPAddress=sNTPServerIPAddress, smtp=smtp, hTTPAccessEnabled=hTTPAccessEnabled, configurationGroup=configurationGroup, syslogControlGroup=syslogControlGroup, aAAControl=aAAControl, subnetMask=subnetMask, dataPortAutoMdix=dataPortAutoMdix, receiveChannel=receiveChannel, receiveDataRate=receiveDataRate, pubStatsGroup=pubStatsGroup, secondarySoftwareVersion=secondarySoftwareVersion, searchState=searchState, ptpTrapPrefix=ptpTrapPrefix, dfsTable=dfsTable, timeZone=timeZone, daylightSaving=daylightSaving, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, installStatusTrap=installStatusTrap, snmpControl=snmpControl, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, sNMPCommunityString=sNMPCommunityString, encryptionAlgorithm=encryptionAlgorithm, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, alarmsGroup=alarmsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveModulationMode=receiveModulationMode, encryption=encryption, transmitChannel=transmitChannel, sNTPState=sNTPState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, regionCode=regionCode, managementGroup=managementGroup, ptp500=ptp500, syslogLocalWrappedTrap=syslogLocalWrappedTrap, softwareVersion=softwareVersion, hTTPSPortNumber=hTTPSPortNumber, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementaryGroup=supplementaryGroup, sNTPSyncTrap=sNTPSyncTrap, systemClock=systemClock, cableLoss=cableLoss, receiveFreqMHz=receiveFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitPower=transmitPower, telecomGroup=telecomGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyStatusGroup=phyStatusGroup, frequencyVariant=frequencyVariant, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogState=syslogState, tDDControlGroup=tDDControlGroup, channelBandwidth=channelBandwidth, tDDSynchronizationAlarm=tDDSynchronizationAlarm, systemReset=systemReset, telecomsLoopbackTrap=telecomsLoopbackTrap, phyControlGroup=phyControlGroup, eIRP=eIRP, bandwidthVariant=bandwidthVariant, licence=licence, tDDControl=tDDControl, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsInterface=telecomsInterface, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitFreqMHz=transmitFreqMHz, telecomsChannelStatus=telecomsChannelStatus, linkSymmetry=linkSymmetry, notificationsGroup=notificationsGroup, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, dfsTableNumber=dfsTableNumber, dfsTableIndex=dfsTableIndex, linkModeOptimisation=linkModeOptimisation, channelChangeTrap=channelChangeTrap, userTableEntry=userTableEntry, installArmStateTrap=installArmStateTrap, licenceGroup=licenceGroup, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, userEnabled=userEnabled, sNMPPortNumber=sNMPPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, accessMethod=accessMethod, syslogClientTrap=syslogClientTrap, dataPortStatus=dataPortStatus, reset=reset, alarms=alarms, siteName=siteName, telecomsCableLength=telecomsCableLength, productVariant=productVariant, sNTPPollInterval=sNTPPollInterval, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTableNumber=userTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, range=range, capacityLicenseMismatch=capacityLicenseMismatch, aggregateDataRate=aggregateDataRate, management=management, ptpGroups=ptpGroups, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, targetMACAddress=targetMACAddress, masterSlaveMode=masterSlaveMode, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapIPAddress=sNMPTrapIPAddress, ptp=ptp, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptmp=ptmp, userTable=userTable, ptpCompliance=ptpCompliance, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, resetGroup=resetGroup, vLANPriorityTable=vLANPriorityTable, sntpGroup=sntpGroup, licensedCapacity=licensedCapacity, sMTPEnabledMessages=sMTPEnabledMessages, longitude=longitude, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, sNTPSync=sNTPSync, dfsTableEntry=dfsTableEntry, byteErrorRatio=byteErrorRatio, userRole=userRole, configuration=configuration, latitude=latitude)
