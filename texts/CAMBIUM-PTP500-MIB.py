...
# Produced by pysmi-1.1.8 at Fri Jan  7 16:54:38 2022
...
ModuleIdentity, IpAddress, Bits, Gauge32, Unsigned32, Integer32, iso, ObjectIdentity, MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, TimeTicks, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Bits", "Gauge32", "Unsigned32", "Integer32", "iso", "ObjectIdentity", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "TimeTicks", "Counter64", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", remoteIPAddress=remoteIPAddress, pubStatsGroup=pubStatsGroup, snmpControlGroup=snmpControlGroup, bootVersion=bootVersion, dataPortStatus=dataPortStatus, telnetAccessEnabled=telnetAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortAutoMdix=dataPortAutoMdix, ptp=ptp, installArmState=installArmState, vectorError=vectorError, dfs=dfs, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPLastSync=sNTPLastSync, smtp=smtp, transmitPower=transmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, encryptionAlgorithm=encryptionAlgorithm, userTableNumber=userTableNumber, latitude=latitude, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPState=sNTPState, licence=licence, encryptionGroup=encryptionGroup, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, capacityLicenseMismatch=capacityLicenseMismatch, productVariant=productVariant, ethernet=ethernet, licenceGroup=licenceGroup, dfsTableIndex=dfsTableIndex, managementGroup=managementGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versionsGroup=versionsGroup, receiveDataRate=receiveDataRate, softwareVersion=softwareVersion, frequencyVariant=frequencyVariant, bandwidthVariant=bandwidthVariant, vLANManagementVID=vLANManagementVID, dfsTable=dfsTable, sNMPTrapTableEntry=sNMPTrapTableEntry, installArmStateTrap=installArmStateTrap, configuration=configuration, sNTPServerPortNumber=sNTPServerPortNumber, aggregateDataRate=aggregateDataRate, alarmsGroup=alarmsGroup, sMTPServerPortNumber=sMTPServerPortNumber, receiveChannel=receiveChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, hTTPPortNumber=hTTPPortNumber, groupID=groupID, ptpTraps=ptpTraps, searchState=searchState, phyStatusGroup=phyStatusGroup, userEnabled=userEnabled, channelChangeTrap=channelChangeTrap, dataPortDisabledWarning=dataPortDisabledWarning, aAAControl=aAAControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, snmpControl=snmpControl, syslogStateTrap=syslogStateTrap, sNMPPortNumber=sNMPPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, subnetMask=subnetMask, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, daylightSaving=daylightSaving, dfsPeaks=dfsPeaks, signalStrengthRatio=signalStrengthRatio, sNMPv3Enable=sNMPv3Enable, cambium=cambium, tFTPServerPortNumber=tFTPServerPortNumber, ptp500=ptp500, sNTPSyncTrap=sNTPSyncTrap, receiveFreqKHz=receiveFreqKHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkName=linkName, installStatus=installStatus, sMTPEmailAlert=sMTPEmailAlert, cableLoss=cableLoss, sntpGroup=sntpGroup, telnetPortNumber=telnetPortNumber, eIRP=eIRP, regionCodeTrap=regionCodeTrap, tDDControlGroup=tDDControlGroup, antennaGain=antennaGain, sMTPServerIPAddress=sMTPServerIPAddress, unitOutOfCalibration=unitOutOfCalibration, sntp=sntp, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveFreqMHz=receiveFreqMHz, dfsTableNumber=dfsTableNumber, linkLoss=linkLoss, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTable=userTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, masterSlaveMode=masterSlaveMode, aAAControlGroup=aAAControlGroup, iPAddress=iPAddress, vLANPriorityTable=vLANPriorityTable, incompatibleRegionCodes=incompatibleRegionCodes, versions=versions, sNMPTrapVersion=sNMPTrapVersion, licensedCapacity=licensedCapacity, tFTPServerIPAddress=tFTPServerIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemReset=systemReset, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogControl=syslogControl, supplementary=supplementary, telecomGroup=telecomGroup, tDDControl=tDDControl, hTTPAccessEnabled=hTTPAccessEnabled, ptmp=ptmp, noWirelessChannelAvailable=noWirelessChannelAvailable, siteName=siteName, tDDSynchronizationMode=tDDSynchronizationMode, sNTPPollInterval=sNTPPollInterval, linkSymmetry=linkSymmetry, dfsTableEntry=dfsTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, systemClock=systemClock, dfsGroup=dfsGroup, transmitModulationMode=transmitModulationMode, receiveModulationMode=receiveModulationMode, userPassword=userPassword, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTableIndex=userTableIndex, configurationGroup=configurationGroup, timeZone=timeZone, receiveModulationModeDetail=receiveModulationModeDetail, byteErrorRatio=byteErrorRatio, telecomsLineCode=telecomsLineCode, longitude=longitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, installStatusTrap=installStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementaryGroup=supplementaryGroup, transmitChannel=transmitChannel, sMTPEnabledMessages=sMTPEnabledMessages, sNTPSync=sNTPSync, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, pubStats=pubStats, management=management, hardwareVersion=hardwareVersion, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimisation=linkModeOptimisation, userName=userName, syslogState=syslogState, telecomsCableLength=telecomsCableLength, sNMPEnabledTraps=sNMPEnabledTraps, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, telecomsInterface=telecomsInterface, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpCompliance=ptpCompliance, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, accessMethod=accessMethod, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogClient=syslogClient, dfsMeans=dfsMeans, hTTPSPortNumber=hTTPSPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogClientTrap=syslogClientTrap, phyControlGroup=phyControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapTable=sNMPTrapTable, wirelessLinkStatus=wirelessLinkStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, alarms=alarms, vLANPriorityQueueMapping=vLANPriorityQueueMapping, phyStatus=phyStatus, reset=reset, phyControl=phyControl, secondarySoftwareVersion=secondarySoftwareVersion, ethernetFiberSupport=ethernetFiberSupport, userTableEntry=userTableEntry, gatewayIPAddress=gatewayIPAddress, userRole=userRole, PYSNMP_MODULE_ID=cambium, ptpGroups=ptpGroups, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, altitude=altitude, telecom=telecom, telecomsLoopback=telecomsLoopback, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPServerIPAddress=sNTPServerIPAddress, resetGroup=resetGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsChannelStatus=telecomsChannelStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitFreqMHz=transmitFreqMHz, encryption=encryption, smtpGroup=smtpGroup, targetMACAddress=targetMACAddress, transmitDataRate=transmitDataRate, vLANManagementPriority=vLANManagementPriority, syslogControlGroup=syslogControlGroup, maximumTransmitPower=maximumTransmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regionCode=regionCode, range=range, ptpTrapPrefix=ptpTrapPrefix, sNMPCommunityString=sNMPCommunityString, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, productName=productName)
