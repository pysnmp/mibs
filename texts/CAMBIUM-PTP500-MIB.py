...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter32, Unsigned32, TimeTicks, NotificationType, Integer32, Gauge32, ObjectIdentity, Counter64, MibIdentifier, ModuleIdentity, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter32", "Unsigned32", "TimeTicks", "NotificationType", "Integer32", "Gauge32", "ObjectIdentity", "Counter64", "MibIdentifier", "ModuleIdentity", "Bits", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userTableNumber=userTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, targetMACAddress=targetMACAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telnetPortNumber=telnetPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapVersion=sNMPTrapVersion, phyStatus=phyStatus, sNMPCommunityString=sNMPCommunityString, dfsTableEntry=dfsTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, masterSlaveMode=masterSlaveMode, userName=userName, sNTPServerIPAddress=sNTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, maximumTransmitPower=maximumTransmitPower, sNTPPollInterval=sNTPPollInterval, timeZone=timeZone, ethernetGroup=ethernetGroup, PYSNMP_MODULE_ID=cambium, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hTTPPortNumber=hTTPPortNumber, receiveDataRate=receiveDataRate, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, regionCodeTrap=regionCodeTrap, vLANManagementVID=vLANManagementVID, wirelessLinkStatus=wirelessLinkStatus, licence=licence, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitDataRate=transmitDataRate, userRole=userRole, altitude=altitude, alarmsGroup=alarmsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogControl=syslogControl, cambium=cambium, notificationsGroup=notificationsGroup, signalStrengthRatio=signalStrengthRatio, dataPortDisabledWarning=dataPortDisabledWarning, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, siteName=siteName, range=range, vLANPriorityTableEntry=vLANPriorityTableEntry, channelBandwidth=channelBandwidth, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersion=softwareVersion, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, frequencyVariant=frequencyVariant, telecomsCableLength=telecomsCableLength, installStatusTrap=installStatusTrap, ethernetFiberSupport=ethernetFiberSupport, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, userEnabled=userEnabled, iPAddress=iPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveChannel=receiveChannel, userTableEntry=userTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, supplementaryGroup=supplementaryGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, aAAControlGroup=aAAControlGroup, dataPortStatus=dataPortStatus, hTTPAccessEnabled=hTTPAccessEnabled, gatewayIPAddress=gatewayIPAddress, dataPortStatusTrap=dataPortStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptpCompliance=ptpCompliance, latitude=latitude, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsLineCode=telecomsLineCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, snmpControl=snmpControl, dfsTableNumber=dfsTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemClock=systemClock, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionAlgorithm=encryptionAlgorithm, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installStatus=installStatus, accessMethod=accessMethod, telecom=telecom, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userPassword=userPassword, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptmp=ptmp, receiveFreqKHz=receiveFreqKHz, managementGroup=managementGroup, hTTPSPortNumber=hTTPSPortNumber, ptpGroups=ptpGroups, bandwidthVariant=bandwidthVariant, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, configuration=configuration, management=management, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtp=smtp, cableLoss=cableLoss, alarms=alarms, syslogClient=syslogClient, productVariant=productVariant, sNTPState=sNTPState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControl=aAAControl, systemReset=systemReset, syslogState=syslogState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptpTraps=ptpTraps, dfsTable=dfsTable, unitOutOfCalibration=unitOutOfCalibration, userTableIndex=userTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimisation=linkModeOptimisation, telecomsLoopback=telecomsLoopback, productName=productName, wirelessLinkAvailability=wirelessLinkAvailability, reset=reset, receiveFreqMHz=receiveFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, versions=versions, longitude=longitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePower=receivePower, sMTPEnabledMessages=sMTPEnabledMessages, sNMPv3Enable=sNMPv3Enable, dfs=dfs, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, eIRP=eIRP, installArmState=installArmState, dataPortAutoMdix=dataPortAutoMdix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, daylightSaving=daylightSaving, smtpGroup=smtpGroup, dfsPeaks=dfsPeaks, pubStatsGroup=pubStatsGroup, vLANPriorityTable=vLANPriorityTable, incompatibleRegionCodes=incompatibleRegionCodes, pubStats=pubStats, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetAccessEnabled=telnetAccessEnabled, linkLoss=linkLoss, ptp500=ptp500, sntpGroup=sntpGroup, receiveModulationMode=receiveModulationMode, telecomsInterface=telecomsInterface, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licenceGroup=licenceGroup, userTable=userTable, transmitModulationMode=transmitModulationMode, syslogControlGroup=syslogControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementPriority=vLANManagementPriority, sNMPTrapTable=sNMPTrapTable, syslogClientTrap=syslogClientTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, groupID=groupID, ptp=ptp, sNMPEnabledTraps=sNMPEnabledTraps, dfsMeans=dfsMeans, dfsGroup=dfsGroup, encryptionGroup=encryptionGroup, transmitFreqMHz=transmitFreqMHz, versionsGroup=versionsGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, regionCode=regionCode, tDDControl=tDDControl, transmitPower=transmitPower, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, encryption=encryption, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, aggregateDataRate=aggregateDataRate, transmitChannel=transmitChannel, snmpControlGroup=snmpControlGroup, bootVersion=bootVersion, licensedCapacity=licensedCapacity, searchState=searchState, sntp=sntp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogStateTrap=syslogStateTrap, vectorError=vectorError, sNMPTrapPortNumber=sNMPTrapPortNumber, configurationGroup=configurationGroup, telecomGroup=telecomGroup, linkSymmetry=linkSymmetry, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, installArmStateTrap=installArmStateTrap, sNTPSyncTrap=sNTPSyncTrap, supplementary=supplementary, tDDControlGroup=tDDControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControl=phyControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, transmitFreqKHz=transmitFreqKHz, dfsTableIndex=dfsTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaGain=antennaGain, constantPowerSpectralDensity=constantPowerSpectralDensity, hardwareVersion=hardwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsChannelStatus=telecomsChannelStatus, phyControlGroup=phyControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, linkName=linkName, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, resetGroup=resetGroup, sNMPPortNumber=sNMPPortNumber, byteErrorRatio=byteErrorRatio, channelChangeTrap=channelChangeTrap, ethernet=ethernet)
