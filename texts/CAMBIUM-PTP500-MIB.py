...
Counter64, Integer32, Gauge32, IpAddress, ObjectIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, ModuleIdentity, TimeTicks, Counter32, Bits, MibIdentifier, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "Gauge32", "IpAddress", "ObjectIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "ModuleIdentity", "TimeTicks", "Counter32", "Bits", "MibIdentifier", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ethernet=ethernet, accessMethod=accessMethod, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userRole=userRole, groupID=groupID, linkName=linkName, sNMPPortNumber=sNMPPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, management=management, unitOutOfCalibration=unitOutOfCalibration, sntpGroup=sntpGroup, ptpCompliance=ptpCompliance, dfsMeans=dfsMeans, targetMACAddress=targetMACAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpGroups=ptpGroups, vLANPriorityTable=vLANPriorityTable, versionsGroup=versionsGroup, userTableEntry=userTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTable=sNMPTrapTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkSymmetry=linkSymmetry, ptp500=ptp500, ptp=ptp, sNTPServerPortNumber=sNTPServerPortNumber, masterSlaveMode=masterSlaveMode, installStatusTrap=installStatusTrap, sNMPv3Enable=sNMPv3Enable, systemReset=systemReset, regionCode=regionCode, bandwidthVariant=bandwidthVariant, signalStrengthRatio=signalStrengthRatio, encryptionAlgorithm=encryptionAlgorithm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPState=sNTPState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPSync=sNTPSync, alarmsGroup=alarmsGroup, syslogState=syslogState, linkModeOptimisation=linkModeOptimisation, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, phyStatusGroup=phyStatusGroup, capacityLicenseMismatch=capacityLicenseMismatch, eIRP=eIRP, vLANManagementVID=vLANManagementVID, supplementary=supplementary, sMTPSourceEmailAddress=sMTPSourceEmailAddress, gatewayIPAddress=gatewayIPAddress, byteErrorRatio=byteErrorRatio, hTTPPortNumber=hTTPPortNumber, userTableNumber=userTableNumber, sNMPTrapVersion=sNMPTrapVersion, bootVersion=bootVersion, cableLoss=cableLoss, licence=licence, syslogControl=syslogControl, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, vectorError=vectorError, notificationsGroup=notificationsGroup, range=range, productVariant=productVariant, supplementaryGroup=supplementaryGroup, userName=userName, transmitChannel=transmitChannel, sNMPEnabledTraps=sNMPEnabledTraps, syslogStateTrap=syslogStateTrap, sNTPServerIPAddress=sNTPServerIPAddress, transmitFreqKHz=transmitFreqKHz, daylightSaving=daylightSaving, telecomGroup=telecomGroup, aggregateDataRate=aggregateDataRate, receiveFreqKHz=receiveFreqKHz, receiveModulationModeDetail=receiveModulationModeDetail, dataPortStatus=dataPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, alarms=alarms, PYSNMP_MODULE_ID=cambium, dfsTable=dfsTable, phyStatus=phyStatus, iPAddress=iPAddress, transmitPower=transmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsGroup=dfsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, secondarySoftwareVersion=secondarySoftwareVersion, ptpTrapPrefix=ptpTrapPrefix, snmpControl=snmpControl, dataPortAutoMdix=dataPortAutoMdix, telecom=telecom, maximumTransmitPower=maximumTransmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogClient=syslogClient, installArmStateTrap=installArmStateTrap, dfsPeaks=dfsPeaks, hTTPSAccessEnabled=hTTPSAccessEnabled, hTTPAccessEnabled=hTTPAccessEnabled, sNMPCommunityString=sNMPCommunityString, antennaGain=antennaGain, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyControl=phyControl, installArmState=installArmState, resetGroup=resetGroup, sNTPPollInterval=sNTPPollInterval, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveDataRate=receiveDataRate, siteName=siteName, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDControl=tDDControl, frequencyVariant=frequencyVariant, searchState=searchState, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarning=dataPortDisabledWarning, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkAvailability=wirelessLinkAvailability, vLANPriorityTableNumber=vLANPriorityTableNumber, managementGroup=managementGroup, userPassword=userPassword, ptmp=ptmp, vLANManagementPriority=vLANManagementPriority, receivePower=receivePower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installStatus=installStatus, smtpGroup=smtpGroup, ethernetGroup=ethernetGroup, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, sMTPEmailAlert=sMTPEmailAlert, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortStatusTrap=dataPortStatusTrap, dfsTableEntry=dfsTableEntry, regionCodeTrap=regionCodeTrap, receiveChannel=receiveChannel, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsLoopback=telecomsLoopback, channelChangeTrap=channelChangeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitFreqMHz=transmitFreqMHz, userEnabled=userEnabled, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, subnetMask=subnetMask, dfs=dfs, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkStatus=wirelessLinkStatus, tDDControlGroup=tDDControlGroup, hardwareVersion=hardwareVersion, snmpControlGroup=snmpControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userTableIndex=userTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, systemClock=systemClock, linkLoss=linkLoss, licensedCapacity=licensedCapacity, telecomsChannelStatus=telecomsChannelStatus, transmitModulationMode=transmitModulationMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, longitude=longitude, receiveModulationMode=receiveModulationMode, pubStatsGroup=pubStatsGroup, userTable=userTable, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, dfsTableNumber=dfsTableNumber, channelBandwidth=channelBandwidth, ethernetFiberSupport=ethernetFiberSupport, incompatibleRegionCodes=incompatibleRegionCodes, sntp=sntp, telecomsCableLength=telecomsCableLength, telnetPortNumber=telnetPortNumber, cambium=cambium, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogControlGroup=syslogControlGroup, telecomsInterface=telecomsInterface, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStats=pubStats, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, reset=reset, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, configuration=configuration, smtp=smtp, softwareVersion=softwareVersion, altitude=altitude, telnetAccessEnabled=telnetAccessEnabled, phyControlGroup=phyControlGroup, productName=productName, telecomsLoopbackTrap=telecomsLoopbackTrap, versions=versions, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, latitude=latitude, sNTPSyncTrap=sNTPSyncTrap, licenceGroup=licenceGroup, telecomsLineCode=telecomsLineCode, aAAControlGroup=aAAControlGroup, timeZone=timeZone, syslogClientTrap=syslogClientTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, encryption=encryption, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapIPAddress=sNMPTrapIPAddress, aAAControl=aAAControl, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionGroup=encryptionGroup, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitDataRate=transmitDataRate, configurationGroup=configurationGroup, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, receiveFreqMHz=receiveFreqMHz, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress)
