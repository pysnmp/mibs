...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", regionCode=regionCode, installStatus=installStatus, masterSlaveMode=masterSlaveMode, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationMode=tDDSynchronizationMode, userPassword=userPassword, ethernetGroup=ethernetGroup, managementGroup=managementGroup, userName=userName, snmpControl=snmpControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, altitude=altitude, telecomsLoopback=telecomsLoopback, receiveDataRate=receiveDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp500=ptp500, unitOutOfCalibration=unitOutOfCalibration, ptp=ptp, hTTPPortNumber=hTTPPortNumber, productVariant=productVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodes=incompatibleRegionCodes, linkName=linkName, targetMACAddress=targetMACAddress, range=range, subnetMask=subnetMask, productName=productName, linkSymmetry=linkSymmetry, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, userTableEntry=userTableEntry, frequencyVariant=frequencyVariant, installArmState=installArmState, wirelessLinkAvailability=wirelessLinkAvailability, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSPortNumber=hTTPSPortNumber, dataPortStatusTrap=dataPortStatusTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTableIndex=userTableIndex, pubStatsGroup=pubStatsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, sntpGroup=sntpGroup, cambium=cambium, sNMPPortNumber=sNMPPortNumber, installStatusTrap=installStatusTrap, configuration=configuration, versionsGroup=versionsGroup, dfsPeaks=dfsPeaks, tDDControl=tDDControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatus=dataPortStatus, alarmsGroup=alarmsGroup, sNMPv3Enable=sNMPv3Enable, linkLoss=linkLoss, userTable=userTable, searchState=searchState, sNMPTrapVersion=sNMPTrapVersion, telecom=telecom, snmpControlGroup=snmpControlGroup, gatewayIPAddress=gatewayIPAddress, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, dfsTable=dfsTable, sNTPServerPortNumber=sNTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitDataRate=transmitDataRate, resetGroup=resetGroup, dfs=dfs, telecomsInterface=telecomsInterface, daylightSaving=daylightSaving, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bootVersion=bootVersion, syslogControlGroup=syslogControlGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPEnabledTraps=sNMPEnabledTraps, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, phyControl=phyControl, ptpTrapPrefix=ptpTrapPrefix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTable=sNMPTrapTable, telnetPortNumber=telnetPortNumber, sNTPPollInterval=sNTPPollInterval, receivePower=receivePower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, supplementaryGroup=supplementaryGroup, cableLoss=cableLoss, aAAControl=aAAControl, ptpGroups=ptpGroups, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, longitude=longitude, userEnabled=userEnabled, syslogState=syslogState, vLANPriorityTable=vLANPriorityTable, antennaGain=antennaGain, smtpGroup=smtpGroup, reset=reset, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, hardwareVersion=hardwareVersion, channelChangeTrap=channelChangeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, alarms=alarms, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, userTableNumber=userTableNumber, dfsTableNumber=dfsTableNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntp=sntp, phyStatusGroup=phyStatusGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitFreqMHz=transmitFreqMHz, capacityLicenseMismatch=capacityLicenseMismatch, installArmStateTrap=installArmStateTrap, wirelessLinkStatus=wirelessLinkStatus, licence=licence, ethernet=ethernet, sNTPLastSync=sNTPLastSync, telecomsLineCode=telecomsLineCode, ptpTraps=ptpTraps, ethernetFiberSupport=ethernetFiberSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogStateTrap=syslogStateTrap, sMTPEmailAlert=sMTPEmailAlert, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, softwareVersion=softwareVersion, configurationGroup=configurationGroup, vLANManagementPriority=vLANManagementPriority, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPSync=sNTPSync, telecomGroup=telecomGroup, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPState=sNTPState, userRole=userRole, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, encryptionGroup=encryptionGroup, dfsGroup=dfsGroup, licenceGroup=licenceGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpCompliance=ptpCompliance, dfsTableEntry=dfsTableEntry, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptmp=ptmp, accessMethod=accessMethod, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, hTTPAccessEnabled=hTTPAccessEnabled, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsMeans=dfsMeans, tDDSynchronizationStatus=tDDSynchronizationStatus, byteErrorRatio=byteErrorRatio, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsCableLength=telecomsCableLength, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimisation=linkModeOptimisation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveChannel=receiveChannel, groupID=groupID, eIRP=eIRP, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControlGroup=phyControlGroup, syslogClient=syslogClient, iPAddress=iPAddress, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerIPAddress=sNTPServerIPAddress, licensedCapacity=licensedCapacity, sNMPCommunityString=sNMPCommunityString, encryption=encryption, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoMdix=dataPortAutoMdix, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDControlGroup=tDDControlGroup, systemClock=systemClock, management=management, timeZone=timeZone, receiveFreqMHz=receiveFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, bandwidthVariant=bandwidthVariant, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, sNTPSyncTrap=sNTPSyncTrap, syslogControl=syslogControl, aAAControlGroup=aAAControlGroup, siteName=siteName, vLANManagementVID=vLANManagementVID, sNMPTrapPortNumber=sNMPTrapPortNumber, aggregateDataRate=aggregateDataRate, regionCodeTrap=regionCodeTrap, encryptionAlgorithm=encryptionAlgorithm, telnetAccessEnabled=telnetAccessEnabled, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitChannel=transmitChannel, versions=versions, enabledDiagnosticAlarms=enabledDiagnosticAlarms, supplementary=supplementary, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, latitude=latitude, syslogClientTrap=syslogClientTrap, smtp=smtp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemReset=systemReset, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, remoteIPAddress=remoteIPAddress, dfsTableIndex=dfsTableIndex, transmitPower=transmitPower)
