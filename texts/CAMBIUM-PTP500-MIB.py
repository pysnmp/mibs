...
Integer32, ModuleIdentity, ObjectIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, Counter64, IpAddress, enterprises, iso, MibIdentifier, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "ObjectIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "Counter64", "IpAddress", "enterprises", "iso", "MibIdentifier", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", alarms=alarms, byteErrorRatio=byteErrorRatio, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, configurationGroup=configurationGroup, sNMPv3Enable=sNMPv3Enable, altitude=altitude, installArmState=installArmState, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, ethernetGroup=ethernetGroup, notificationsGroup=notificationsGroup, PYSNMP_MODULE_ID=cambium, sNMPCommunityString=sNMPCommunityString, transmitModulationMode=transmitModulationMode, phyStatusGroup=phyStatusGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, range=range, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, snmpControl=snmpControl, channelBandwidth=channelBandwidth, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPEnabledTraps=sNMPEnabledTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, longitude=longitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableNumber=userTableNumber, wirelessLinkAvailability=wirelessLinkAvailability, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapIPAddress=sNMPTrapIPAddress, hTTPSPortNumber=hTTPSPortNumber, aAAControl=aAAControl, transmitPower=transmitPower, sNTPSync=sNTPSync, encryptionGroup=encryptionGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClient=syslogClient, dfsGroup=dfsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, configuration=configuration, syslogControl=syslogControl, transmitFreqMHz=transmitFreqMHz, dataPortAutoMdix=dataPortAutoMdix, softwareVersion=softwareVersion, regionCode=regionCode, dfsTableEntry=dfsTableEntry, telecomGroup=telecomGroup, telecomsInterface=telecomsInterface, dfsPeaks=dfsPeaks, sntpGroup=sntpGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableEntry=sNMPTrapTableEntry, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, accessMethod=accessMethod, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptmp=ptmp, latitude=latitude, telnetAccessEnabled=telnetAccessEnabled, dfsTable=dfsTable, unitOutOfCalibration=unitOutOfCalibration, hTTPSAccessEnabled=hTTPSAccessEnabled, capacityLicenseMismatch=capacityLicenseMismatch, versionsGroup=versionsGroup, receiveModulationMode=receiveModulationMode, daylightSaving=daylightSaving, userTableIndex=userTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, gatewayIPAddress=gatewayIPAddress, ptpCompliance=ptpCompliance, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, userEnabled=userEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, targetMACAddress=targetMACAddress, bandwidthVariant=bandwidthVariant, linkLoss=linkLoss, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, snmpControlGroup=snmpControlGroup, timeZone=timeZone, sNMPPortNumber=sNMPPortNumber, tDDControlGroup=tDDControlGroup, hTTPPortNumber=hTTPPortNumber, receiveFreqMHz=receiveFreqMHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, iPAddress=iPAddress, systemClock=systemClock, vLANPriorityQueueMapping=vLANPriorityQueueMapping, frequencyVariant=frequencyVariant, ptp=ptp, bootVersion=bootVersion, sntp=sntp, ptpTraps=ptpTraps, vLANManagementPriority=vLANManagementPriority, licence=licence, managementGroup=managementGroup, remoteIPAddress=remoteIPAddress, sMTPEmailAlert=sMTPEmailAlert, sNTPServerPortNumber=sNTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, licenceGroup=licenceGroup, channelChangeTrap=channelChangeTrap, userName=userName, supplementary=supplementary, tDDControl=tDDControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userPassword=userPassword, dataPortStatusTrap=dataPortStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vectorError=vectorError, userTableEntry=userTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPState=sNTPState, telecomsCableLength=telecomsCableLength, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPAccessEnabled=hTTPAccessEnabled, vLANManagementVID=vLANManagementVID, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, regionCodeTrap=regionCodeTrap, ethernet=ethernet, syslogControlGroup=syslogControlGroup, supplementaryGroup=supplementaryGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkName=linkName, dfsTableIndex=dfsTableIndex, cableLoss=cableLoss, eIRP=eIRP, ptp500=ptp500, groupID=groupID, siteName=siteName, dfsMeans=dfsMeans, aAAControlGroup=aAAControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, subnetMask=subnetMask, installStatus=installStatus, alarmsGroup=alarmsGroup, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, pubStatsGroup=pubStatsGroup, sNTPPollInterval=sNTPPollInterval, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemReset=systemReset, receiveFreqKHz=receiveFreqKHz, userRole=userRole, sMTPServerIPAddress=sMTPServerIPAddress, installArmStateTrap=installArmStateTrap, tFTPServerIPAddress=tFTPServerIPAddress, encryptionAlgorithm=encryptionAlgorithm, transmitDataRate=transmitDataRate, incompatibleRegionCodes=incompatibleRegionCodes, secondarySoftwareVersion=secondarySoftwareVersion, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableNumber=sNMPTrapTableNumber, searchState=searchState, pubStats=pubStats, ptpGroups=ptpGroups, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, licensedCapacity=licensedCapacity, productName=productName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityTable=vLANPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, linkSymmetry=linkSymmetry, userTable=userTable, dataPortAutoNegotiation=dataPortAutoNegotiation, telnetPortNumber=telnetPortNumber, reset=reset, installStatusTrap=installStatusTrap, smtp=smtp, encryption=encryption, syslogState=syslogState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsTableNumber=dfsTableNumber, versions=versions, phyControl=phyControl, sNTPServerIPAddress=sNTPServerIPAddress, transmitFreqKHz=transmitFreqKHz, sNTPLastSync=sNTPLastSync, resetGroup=resetGroup, phyControlGroup=phyControlGroup, syslogStateTrap=syslogStateTrap, signalStrengthRatio=signalStrengthRatio, telecomsLineCode=telecomsLineCode, hardwareVersion=hardwareVersion, telecom=telecom, sNTPSyncTrap=sNTPSyncTrap, management=management, receiveChannel=receiveChannel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatus=phyStatus, maximumTransmitPower=maximumTransmitPower, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationStatus=tDDSynchronizationStatus, dfs=dfs, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsLoopback=telecomsLoopback, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receivePower=receivePower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, cambium=cambium, sNMPTrapVersion=sNMPTrapVersion, productVariant=productVariant, dataPortStatus=dataPortStatus)
