...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, MibIdentifier, Counter64, Integer32, enterprises, NotificationType, IpAddress, ModuleIdentity, Counter32, Bits, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "MibIdentifier", "Counter64", "Integer32", "enterprises", "NotificationType", "IpAddress", "ModuleIdentity", "Counter32", "Bits", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapTable=sNMPTrapTable, resetGroup=resetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsMeans=dfsMeans, linkModeOptimizationMismatch=linkModeOptimizationMismatch, regionCode=regionCode, sNMPTrapIPAddress=sNMPTrapIPAddress, telnetPortNumber=telnetPortNumber, userPassword=userPassword, receiveFreqMHz=receiveFreqMHz, sMTPServerPortNumber=sMTPServerPortNumber, byteErrorRatio=byteErrorRatio, constantPowerSpectralDensity=constantPowerSpectralDensity, ptp=ptp, bandwidthVariant=bandwidthVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimisation=linkModeOptimisation, transmitChannel=transmitChannel, installStatus=installStatus, ptpTrapPrefix=ptpTrapPrefix, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, dfs=dfs, telecomsLoopbackTrap=telecomsLoopbackTrap, aggregateDataRate=aggregateDataRate, receiveFreqKHz=receiveFreqKHz, transmitFreqKHz=transmitFreqKHz, vLANPriorityTable=vLANPriorityTable, managementGroup=managementGroup, smtpGroup=smtpGroup, reset=reset, supplementaryGroup=supplementaryGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, dataPortStatus=dataPortStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, phyStatus=phyStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, aAAControlGroup=aAAControlGroup, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsChannelStatus=telecomsChannelStatus, systemReset=systemReset, transmitPower=transmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, smtp=smtp, tDDControlGroup=tDDControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, capacityLicenseMismatch=capacityLicenseMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitFreqMHz=transmitFreqMHz, daylightSaving=daylightSaving, transmitDataRate=transmitDataRate, signalStrengthRatio=signalStrengthRatio, hTTPPortNumber=hTTPPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveModulationModeDetail=receiveModulationModeDetail, cambium=cambium, vLANManagementVID=vLANManagementVID, bootVersion=bootVersion, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogState=syslogState, phyStatusGroup=phyStatusGroup, productVariant=productVariant, telecomGroup=telecomGroup, telecom=telecom, productName=productName, dataPortAutoNegotiation=dataPortAutoNegotiation, snmpControlGroup=snmpControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, sNTPState=sNTPState, sNTPPollInterval=sNTPPollInterval, sNTPLastSync=sNTPLastSync, cableLoss=cableLoss, vLANManagementPriority=vLANManagementPriority, userEnabled=userEnabled, sMTPEmailAlert=sMTPEmailAlert, subnetMask=subnetMask, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hardwareVersion=hardwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortStatusTrap=dataPortStatusTrap, sNMPPortNumber=sNMPPortNumber, telecomsLoopback=telecomsLoopback, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, iPAddress=iPAddress, sntp=sntp, sNTPSyncTrap=sNTPSyncTrap, targetMACAddress=targetMACAddress, altitude=altitude, ptp500=ptp500, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsInterface=telecomsInterface, sNMPv3Enable=sNMPv3Enable, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, receiveChannel=receiveChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, latitude=latitude, masterSlaveMode=masterSlaveMode, sntpGroup=sntpGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableNumber=vLANPriorityTableNumber, syslogControl=syslogControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userTableIndex=userTableIndex, accessMethod=accessMethod, phyControlGroup=phyControlGroup, frequencyVariant=frequencyVariant, hTTPSPortNumber=hTTPSPortNumber, encryptionGroup=encryptionGroup, aAAControl=aAAControl, sNTPServerIPAddress=sNTPServerIPAddress, ptpGroups=ptpGroups, longitude=longitude, incompatibleRegionCodes=incompatibleRegionCodes, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ethernet=ethernet, sNMPTrapTableNumber=sNMPTrapTableNumber, alarms=alarms, configuration=configuration, sNTPSync=sNTPSync, installStatusTrap=installStatusTrap, vectorError=vectorError, tDDControl=tDDControl, maximumTransmitPower=maximumTransmitPower, eIRP=eIRP, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, snmpControl=snmpControl, channelBandwidth=channelBandwidth, dfsPeaks=dfsPeaks, supplementary=supplementary, dfsTableEntry=dfsTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, userTableEntry=userTableEntry, pubStatsGroup=pubStatsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogStateTrap=syslogStateTrap, licensedCapacity=licensedCapacity, timeZone=timeZone, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licenceGroup=licenceGroup, hTTPAccessEnabled=hTTPAccessEnabled, licence=licence, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, softwareVersion=softwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, range=range, dataPortConfigurationMismatch=dataPortConfigurationMismatch, management=management, encryptionAlgorithm=encryptionAlgorithm, dataPortAutoMdix=dataPortAutoMdix, linkSymmetry=linkSymmetry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, regionCodeTrap=regionCodeTrap, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, groupID=groupID, channelChangeTrap=channelChangeTrap, ptmp=ptmp, ethernetFiberSupport=ethernetFiberSupport, receiveModulationMode=receiveModulationMode, telecomsLineCode=telecomsLineCode, wirelessLinkAvailability=wirelessLinkAvailability, vLANPriorityTableEntry=vLANPriorityTableEntry, alarmsGroup=alarmsGroup, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTraps=ptpTraps, systemClock=systemClock, dfsGroup=dfsGroup, versionsGroup=versionsGroup, linkName=linkName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userRole=userRole, installArmState=installArmState, siteName=siteName, telecomsCableLength=telecomsCableLength, syslogClient=syslogClient, sNMPTrapPortNumber=sNMPTrapPortNumber, userName=userName, syslogControlGroup=syslogControlGroup, telnetAccessEnabled=telnetAccessEnabled, notificationsGroup=notificationsGroup, antennaGain=antennaGain, sNMPCommunityString=sNMPCommunityString, tFTPServerPortNumber=tFTPServerPortNumber, encryption=encryption, userTable=userTable, ptpCompliance=ptpCompliance, pubStats=pubStats, versions=versions, sNTPServerPortNumber=sNTPServerPortNumber, userTableNumber=userTableNumber, installArmStateTrap=installArmStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, gatewayIPAddress=gatewayIPAddress, dfsTableNumber=dfsTableNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControl=phyControl)
