...
enterprises, IpAddress, Integer32, MibIdentifier, ObjectIdentity, ModuleIdentity, TimeTicks, Bits, Counter32, Unsigned32, Counter64, Gauge32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "IpAddress", "Integer32", "MibIdentifier", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "Bits", "Counter32", "Unsigned32", "Counter64", "Gauge32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", phyStatus=phyStatus, bootVersion=bootVersion, phyStatusGroup=phyStatusGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, signalStrengthRatio=signalStrengthRatio, telecomsInterface=telecomsInterface, tDDSynchronizationMode=tDDSynchronizationMode, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, useVLANForManagementInterfaces=useVLANForManagementInterfaces, snmpControl=snmpControl, targetMACAddress=targetMACAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, productName=productName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, productVariant=productVariant, installArmState=installArmState, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ptp=ptp, receiveChannel=receiveChannel, sNTPState=sNTPState, licence=licence, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPPortNumber=sNMPPortNumber, telnetPortNumber=telnetPortNumber, receiveFreqKHz=receiveFreqKHz, encryptionGroup=encryptionGroup, installStatusTrap=installStatusTrap, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogStateTrap=syslogStateTrap, sNTPLastSync=sNTPLastSync, antennaGain=antennaGain, userRole=userRole, tFTPServerPortNumber=tFTPServerPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoNegotiation=dataPortAutoNegotiation, telecom=telecom, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPSyncTrap=sNTPSyncTrap, hardwareVersion=hardwareVersion, ethernetGroup=ethernetGroup, incompatibleRegionCodes=incompatibleRegionCodes, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sntpGroup=sntpGroup, licensedCapacity=licensedCapacity, supplementaryGroup=supplementaryGroup, dfsTableNumber=dfsTableNumber, userTableNumber=userTableNumber, dfsTableEntry=dfsTableEntry, reset=reset, installStatus=installStatus, latitude=latitude, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLineCode=telecomsLineCode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, altitude=altitude, ptpTrapPrefix=ptpTrapPrefix, bandwidthVariant=bandwidthVariant, secondarySoftwareVersion=secondarySoftwareVersion, transmitFreqKHz=transmitFreqKHz, versionsGroup=versionsGroup, userName=userName, dfs=dfs, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsGroup=dfsGroup, sNTPServerPortNumber=sNTPServerPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryption=encryption, sNMPEnabledTraps=sNMPEnabledTraps, ptpCompliance=ptpCompliance, sNMPTrapTableNumber=sNMPTrapTableNumber, pubStats=pubStats, linkModeOptimisation=linkModeOptimisation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitChannel=transmitChannel, syslogControl=syslogControl, hTTPAccessEnabled=hTTPAccessEnabled, tDDControlGroup=tDDControlGroup, ptp500=ptp500, remoteIPAddress=remoteIPAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveDataRate=receiveDataRate, vectorError=vectorError, transmitDataRate=transmitDataRate, dataPortDisabledWarning=dataPortDisabledWarning, siteName=siteName, regionCode=regionCode, dfsTableIndex=dfsTableIndex, installArmStateTrap=installArmStateTrap, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userEnabled=userEnabled, vLANPriorityTable=vLANPriorityTable, sNTPSync=sNTPSync, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPEmailAlert=sMTPEmailAlert, vLANManagementVID=vLANManagementVID, dfsPeaks=dfsPeaks, tDDControl=tDDControl, hTTPSPortNumber=hTTPSPortNumber, alarmsGroup=alarmsGroup, systemClock=systemClock, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTable=sNMPTrapTable, userTableEntry=userTableEntry, versions=versions, cambium=cambium, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licenceGroup=licenceGroup, transmitPower=transmitPower, syslogState=syslogState, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyControlGroup=phyControlGroup, byteErrorRatio=byteErrorRatio, channelChangeTrap=channelChangeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, configuration=configuration, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableIndex=userTableIndex, telecomsCableLength=telecomsCableLength, dataPortStatusTrap=dataPortStatusTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogClientTrap=syslogClientTrap, userPassword=userPassword, ethernetFiberSupport=ethernetFiberSupport, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receivePower=receivePower, resetGroup=resetGroup, vLANManagementPriority=vLANManagementPriority, wirelessLinkAvailability=wirelessLinkAvailability, PYSNMP_MODULE_ID=cambium, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpGroups=ptpGroups, softwareVersion=softwareVersion, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, smtpGroup=smtpGroup, wirelessLinkStatus=wirelessLinkStatus, managementGroup=managementGroup, groupID=groupID, telecomGroup=telecomGroup, ptmp=ptmp, tDDSynchronizationStatus=tDDSynchronizationStatus, longitude=longitude, vLANPriorityQueueMapping=vLANPriorityQueueMapping, management=management, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, capacityLicenseMismatch=capacityLicenseMismatch, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, telnetAccessEnabled=telnetAccessEnabled, dfsTable=dfsTable, masterSlaveMode=masterSlaveMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapVersion=sNMPTrapVersion, receiveModulationMode=receiveModulationMode, phyControl=phyControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortStatus=dataPortStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPv3Enable=sNMPv3Enable, snmpControlGroup=snmpControlGroup, linkSymmetry=linkSymmetry, searchState=searchState, accessMethod=accessMethod, receiveFreqMHz=receiveFreqMHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControlGroup=aAAControlGroup, sntp=sntp, daylightSaving=daylightSaving, linkName=linkName, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, aAAControl=aAAControl, frequencyVariant=frequencyVariant, userTable=userTable, ptpTraps=ptpTraps, sNMPTrapPortNumber=sNMPTrapPortNumber, notificationsGroup=notificationsGroup, eIRP=eIRP, tFTPServerIPAddress=tFTPServerIPAddress, telecomsChannelStatus=telecomsChannelStatus, aggregateDataRate=aggregateDataRate, regionCodeTrap=regionCodeTrap, subnetMask=subnetMask, pubStatsGroup=pubStatsGroup, iPAddress=iPAddress, maximumTransmitPower=maximumTransmitPower, unitOutOfCalibration=unitOutOfCalibration, alarms=alarms, range=range, syslogControlGroup=syslogControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortAutoMdix=dataPortAutoMdix, supplementary=supplementary, dfsMeans=dfsMeans, hTTPPortNumber=hTTPPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, channelBandwidth=channelBandwidth, syslogClient=syslogClient, sMTPServerIPAddress=sMTPServerIPAddress, timeZone=timeZone, sMTPServerPortNumber=sMTPServerPortNumber, telecomsLoopback=telecomsLoopback, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, smtp=smtp)
