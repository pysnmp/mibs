...
enterprises, ModuleIdentity, TimeTicks, MibIdentifier, NotificationType, Integer32, Counter64, IpAddress, ObjectIdentity, Counter32, Unsigned32, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "ModuleIdentity", "TimeTicks", "MibIdentifier", "NotificationType", "Integer32", "Counter64", "IpAddress", "ObjectIdentity", "Counter32", "Unsigned32", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, receivePower=receivePower, receiveFreqMHz=receiveFreqMHz, supplementaryGroup=supplementaryGroup, snmpControl=snmpControl, dfsTableEntry=dfsTableEntry, productVariant=productVariant, softwareVersion=softwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, syslogState=syslogState, channelBandwidth=channelBandwidth, vLANPriorityTableIndex=vLANPriorityTableIndex, encryptionGroup=encryptionGroup, alarms=alarms, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStatsGroup=pubStatsGroup, subnetMask=subnetMask, configuration=configuration, syslogClient=syslogClient, ptpTrapPrefix=ptpTrapPrefix, aggregateDataRate=aggregateDataRate, bandwidthVariant=bandwidthVariant, ptpCompliance=ptpCompliance, dfsTableIndex=dfsTableIndex, range=range, receiveModulationMode=receiveModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, userTableNumber=userTableNumber, sNMPTrapTable=sNMPTrapTable, versionsGroup=versionsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEnabledMessages=sMTPEnabledMessages, sNMPCommunityString=sNMPCommunityString, sNMPTrapTableNumber=sNMPTrapTableNumber, aAAControl=aAAControl, ethernetGroup=ethernetGroup, hTTPAccessEnabled=hTTPAccessEnabled, telecomsCableLength=telecomsCableLength, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, regionCode=regionCode, transmitDataRate=transmitDataRate, dfsMeans=dfsMeans, remoteIPAddress=remoteIPAddress, linkName=linkName, installStatus=installStatus, frequencyVariant=frequencyVariant, dataPortDisabledWarning=dataPortDisabledWarning, encryptionAlgorithm=encryptionAlgorithm, installArmStateTrap=installArmStateTrap, unitOutOfCalibration=unitOutOfCalibration, capacityLicenseMismatch=capacityLicenseMismatch, managementGroup=managementGroup, telecomsChannelStatus=telecomsChannelStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementary=supplementary, telecomGroup=telecomGroup, syslogClientTrap=syslogClientTrap, longitude=longitude, versions=versions, hardwareVersion=hardwareVersion, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityQueueMapping=vLANPriorityQueueMapping, targetMACAddress=targetMACAddress, pubStats=pubStats, tFTPServerPortNumber=tFTPServerPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, ptp=ptp, management=management, timeZone=timeZone, byteErrorRatio=byteErrorRatio, ptpGroups=ptpGroups, tDDControlGroup=tDDControlGroup, configurationGroup=configurationGroup, iPAddress=iPAddress, vLANManagementVID=vLANManagementVID, cambium=cambium, aAAControlGroup=aAAControlGroup, telecomsLineCode=telecomsLineCode, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimisation=linkModeOptimisation, daylightSaving=daylightSaving, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationMode=tDDSynchronizationMode, sNTPPollInterval=sNTPPollInterval, userPassword=userPassword, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptp500=ptp500, groupID=groupID, receiveChannel=receiveChannel, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPEmailAlert=sMTPEmailAlert, resetGroup=resetGroup, productName=productName, signalStrengthRatio=signalStrengthRatio, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, searchState=searchState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveDataRate=receiveDataRate, sNMPPortNumber=sNMPPortNumber, altitude=altitude, masterSlaveMode=masterSlaveMode, systemClock=systemClock, sNTPSyncTrap=sNTPSyncTrap, userTableEntry=userTableEntry, phyControl=phyControl, channelChangeTrap=channelChangeTrap, ethernetFiberSupport=ethernetFiberSupport, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, licensedCapacity=licensedCapacity, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licenceGroup=licenceGroup, vLANManagementPriority=vLANManagementPriority, hTTPSPortNumber=hTTPSPortNumber, sNTPState=sNTPState, userName=userName, licence=licence, transmitChannel=transmitChannel, telecom=telecom, sntpGroup=sntpGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogStateTrap=syslogStateTrap, tDDControl=tDDControl, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPPortNumber=hTTPPortNumber, dfsTable=dfsTable, sntp=sntp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsPeaks=dfsPeaks, receiveModulationModeDetail=receiveModulationModeDetail, vectorError=vectorError, reset=reset, phyControlGroup=phyControlGroup, siteName=siteName, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, transmitFreqKHz=transmitFreqKHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetPortNumber=telnetPortNumber, gatewayIPAddress=gatewayIPAddress, linkSymmetry=linkSymmetry, installStatusTrap=installStatusTrap, sNTPLastSync=sNTPLastSync, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, maximumTransmitPower=maximumTransmitPower, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userRole=userRole, sMTPServerIPAddress=sMTPServerIPAddress, antennaGain=antennaGain, encryption=encryption, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogControl=syslogControl, regionCodeTrap=regionCodeTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, accessMethod=accessMethod, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, notificationsGroup=notificationsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, smtp=smtp, cableLoss=cableLoss, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitModulationMode=transmitModulationMode, receiveFreqKHz=receiveFreqKHz, ethernet=ethernet, linkLoss=linkLoss, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANPriorityTable=vLANPriorityTable, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemReset=systemReset, dfsTableNumber=dfsTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, alarmsGroup=alarmsGroup, phyStatus=phyStatus, sNMPv3Enable=sNMPv3Enable, userEnabled=userEnabled, syslogControlGroup=syslogControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, sNTPSync=sNTPSync, dfsGroup=dfsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userTable=userTable, noWirelessChannelAvailable=noWirelessChannelAvailable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, eIRP=eIRP, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyStatusGroup=phyStatusGroup, userTableIndex=userTableIndex, snmpControlGroup=snmpControlGroup, transmitPower=transmitPower, smtpGroup=smtpGroup, dfs=dfs, bootVersion=bootVersion, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, ptmp=ptmp, telecomsLoopback=telecomsLoopback, latitude=latitude, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqMHz=transmitFreqMHz)
