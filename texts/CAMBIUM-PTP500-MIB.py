...
ModuleIdentity, Counter64, Counter32, Gauge32, ObjectIdentity, iso, NotificationType, Bits, TimeTicks, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "Counter32", "Gauge32", "ObjectIdentity", "iso", "NotificationType", "Bits", "TimeTicks", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", eIRP=eIRP, sNMPTrapTable=sNMPTrapTable, management=management, installStatusTrap=installStatusTrap, supplementaryGroup=supplementaryGroup, installArmStateTrap=installArmStateTrap, secondarySoftwareVersion=secondarySoftwareVersion, sntp=sntp, sNTPSyncTrap=sNTPSyncTrap, dfsTableEntry=dfsTableEntry, hardwareVersion=hardwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licence=licence, ptp=ptp, remoteIPAddress=remoteIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogStateTrap=syslogStateTrap, transmitPower=transmitPower, telecomsChannelStatus=telecomsChannelStatus, transmitModulationMode=transmitModulationMode, smtp=smtp, supplementary=supplementary, aAAControl=aAAControl, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimisation=linkModeOptimisation, masterSlaveMode=masterSlaveMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpGroups=ptpGroups, receiveModulationMode=receiveModulationMode, searchState=searchState, userRole=userRole, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userEnabled=userEnabled, wirelessLinkStatus=wirelessLinkStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, pubStats=pubStats, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsLineCode=telecomsLineCode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControlGroup=phyControlGroup, dfsPeaks=dfsPeaks, transmitChannel=transmitChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aggregateDataRate=aggregateDataRate, timeZone=timeZone, sMTPServerIPAddress=sMTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveChannel=receiveChannel, dataPortDisabledWarning=dataPortDisabledWarning, regionCodeTrap=regionCodeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userTableNumber=userTableNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, altitude=altitude, systemReset=systemReset, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANManagementVID=vLANManagementVID, sNMPPortNumber=sNMPPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userName=userName, userTable=userTable, cableLoss=cableLoss, pubStatsGroup=pubStatsGroup, dataPortStatus=dataPortStatus, syslogControl=syslogControl, byteErrorRatio=byteErrorRatio, telecomsCableLength=telecomsCableLength, sNMPTrapPortNumber=sNMPTrapPortNumber, gatewayIPAddress=gatewayIPAddress, telnetPortNumber=telnetPortNumber, telecomGroup=telecomGroup, receiveModulationModeDetail=receiveModulationModeDetail, userTableIndex=userTableIndex, telecomsLoopback=telecomsLoopback, iPAddress=iPAddress, ethernetFiberSupport=ethernetFiberSupport, ethernetGroup=ethernetGroup, bandwidthVariant=bandwidthVariant, tFTPServerPortNumber=tFTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, range=range, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, receiveFreqMHz=receiveFreqMHz, accessMethod=accessMethod, telnetAccessEnabled=telnetAccessEnabled, reset=reset, linkLoss=linkLoss, encryption=encryption, userPassword=userPassword, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptp500=ptp500, alarms=alarms, ptpCompliance=ptpCompliance, antennaGain=antennaGain, linkName=linkName, telecomsInterface=telecomsInterface, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPCommunityString=sNMPCommunityString, bootVersion=bootVersion, transmitFreqMHz=transmitFreqMHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, aAAControlGroup=aAAControlGroup, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, dataPortAutoMdix=dataPortAutoMdix, channelBandwidth=channelBandwidth, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDControlGroup=tDDControlGroup, daylightSaving=daylightSaving, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogClient=syslogClient, configuration=configuration, noWirelessChannelAvailable=noWirelessChannelAvailable, phyStatus=phyStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPEnabledTraps=sNMPEnabledTraps, enabledDiagnosticAlarms=enabledDiagnosticAlarms, frequencyVariant=frequencyVariant, sNTPState=sNTPState, encryptionGroup=encryptionGroup, sNTPPollInterval=sNTPPollInterval, latitude=latitude, capacityLicenseMismatch=capacityLicenseMismatch, syslogState=syslogState, versionsGroup=versionsGroup, hTTPPortNumber=hTTPPortNumber, dfsTableNumber=dfsTableNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleRegionCodes=incompatibleRegionCodes, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, maximumTransmitPower=maximumTransmitPower, receiveFreqKHz=receiveFreqKHz, groupID=groupID, telecomsLoopbackTrap=telecomsLoopbackTrap, softwareVersion=softwareVersion, ptpTrapPrefix=ptpTrapPrefix, phyStatusGroup=phyStatusGroup, vectorError=vectorError, incompatibleMasterAndSlave=incompatibleMasterAndSlave, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, dfs=dfs, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogClientTrap=syslogClientTrap, dfsGroup=dfsGroup, resetGroup=resetGroup, syslogControlGroup=syslogControlGroup, userTableEntry=userTableEntry, licensedCapacity=licensedCapacity, unitOutOfCalibration=unitOutOfCalibration, installArmState=installArmState, longitude=longitude, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, encryptionAlgorithm=encryptionAlgorithm, snmpControl=snmpControl, sNTPSync=sNTPSync, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, configurationGroup=configurationGroup, wirelessLinkAvailability=wirelessLinkAvailability, constantPowerSpectralDensity=constantPowerSpectralDensity, sntpGroup=sntpGroup, systemClock=systemClock, siteName=siteName, sMTPEmailAlert=sMTPEmailAlert, hTTPSPortNumber=hTTPSPortNumber, receiveDataRate=receiveDataRate, cambium=cambium, sNTPServerIPAddress=sNTPServerIPAddress, installStatus=installStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPLastSync=sNTPLastSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsMeans=dfsMeans, telecom=telecom, channelChangeTrap=channelChangeTrap, productName=productName, phyControl=phyControl, sNMPTrapTableEntry=sNMPTrapTableEntry, notificationsGroup=notificationsGroup, dfsTable=dfsTable, subnetMask=subnetMask, targetMACAddress=targetMACAddress, productVariant=productVariant, ptpTraps=ptpTraps, licenceGroup=licenceGroup, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, PYSNMP_MODULE_ID=cambium, sNMPv3Enable=sNMPv3Enable, linkSymmetry=linkSymmetry, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControl=tDDControl, vLANPriorityTable=vLANPriorityTable, hTTPAccessEnabled=hTTPAccessEnabled, regionCode=regionCode, dfsTableIndex=dfsTableIndex, dataPortStatusTrap=dataPortStatusTrap, ptmp=ptmp, versions=versions)
