...
# Produced by pysmi-1.1.3 at Tue Dec  7 14:16:15 2021
...
Counter64, ObjectIdentity, Gauge32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, iso, IpAddress, Unsigned32, TimeTicks, Bits, MibIdentifier, ModuleIdentity, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Gauge32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "iso", "IpAddress", "Unsigned32", "TimeTicks", "Bits", "MibIdentifier", "ModuleIdentity", "Integer32", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPPortNumber=hTTPPortNumber, syslogClient=syslogClient, snmpControl=snmpControl, licence=licence, managementGroup=managementGroup, transmitFreqMHz=transmitFreqMHz, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTableEntry=dfsTableEntry, range=range, encryptionAlgorithm=encryptionAlgorithm, gatewayIPAddress=gatewayIPAddress, regionCode=regionCode, eIRP=eIRP, accessMethod=accessMethod, snmpControlGroup=snmpControlGroup, productVariant=productVariant, tDDControl=tDDControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpCompliance=ptpCompliance, targetMACAddress=targetMACAddress, encryptionGroup=encryptionGroup, cambium=cambium, phyStatusGroup=phyStatusGroup, telecomsLoopback=telecomsLoopback, dataPortAutoNegotiation=dataPortAutoNegotiation, supplementary=supplementary, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomGroup=telecomGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogState=syslogState, sNTPState=sNTPState, aAAControl=aAAControl, wirelessLinkAvailability=wirelessLinkAvailability, channelChangeTrap=channelChangeTrap, installArmState=installArmState, ptpTraps=ptpTraps, versions=versions, syslogControl=syslogControl, ethernetFiberSupport=ethernetFiberSupport, licensedCapacity=licensedCapacity, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogClientTrap=syslogClientTrap, subnetMask=subnetMask, transmitModulationMode=transmitModulationMode, transmitPower=transmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsTableNumber=dfsTableNumber, userTableNumber=userTableNumber, remoteIPAddress=remoteIPAddress, dfs=dfs, regionCodeTrap=regionCodeTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPv3Enable=sNMPv3Enable, encryption=encryption, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANManagementPriority=vLANManagementPriority, alarms=alarms, configurationGroup=configurationGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPServerIPAddress=tFTPServerIPAddress, management=management, userTableEntry=userTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSync=sNTPSync, supplementaryGroup=supplementaryGroup, receivePower=receivePower, siteName=siteName, vLANPriorityTableIndex=vLANPriorityTableIndex, installStatus=installStatus, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveFreqMHz=receiveFreqMHz, resetGroup=resetGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installStatusTrap=installStatusTrap, bootVersion=bootVersion, aggregateDataRate=aggregateDataRate, iPAddress=iPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, versionsGroup=versionsGroup, vLANManagementVID=vLANManagementVID, vLANPriorityQueueMapping=vLANPriorityQueueMapping, noWirelessChannelAvailable=noWirelessChannelAvailable, timeZone=timeZone, sMTPServerIPAddress=sMTPServerIPAddress, cableLoss=cableLoss, linkSymmetry=linkSymmetry, capacityLicenseMismatch=capacityLicenseMismatch, telecom=telecom, notificationsGroup=notificationsGroup, channelBandwidth=channelBandwidth, telnetAccessEnabled=telnetAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, linkName=linkName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSAccessEnabled=hTTPSAccessEnabled, sntpGroup=sntpGroup, wirelessLinkStatus=wirelessLinkStatus, systemReset=systemReset, userEnabled=userEnabled, productName=productName, altitude=altitude, telecomsLineCode=telecomsLineCode, sMTPServerPortNumber=sMTPServerPortNumber, masterSlaveMode=masterSlaveMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapVersion=sNMPTrapVersion, constantPowerSpectralDensity=constantPowerSpectralDensity, linkLoss=linkLoss, dataPortStatus=dataPortStatus, byteErrorRatio=byteErrorRatio, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptp=ptp, receiveChannel=receiveChannel, syslogStateTrap=syslogStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStats=pubStats, tDDSynchronizationMode=tDDSynchronizationMode, installArmStateTrap=installArmStateTrap, signalStrengthRatio=signalStrengthRatio, userPassword=userPassword, dataPortStatusTrap=dataPortStatusTrap, longitude=longitude, ethernetGroup=ethernetGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelStatus=telecomsChannelStatus, receiveModulationMode=receiveModulationMode, PYSNMP_MODULE_ID=cambium, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptpGroups=ptpGroups, telecomsChannelStatusTrap=telecomsChannelStatusTrap, daylightSaving=daylightSaving, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenceGroup=licenceGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, smtpGroup=smtpGroup, configuration=configuration, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, latitude=latitude, dfsPeaks=dfsPeaks, smtp=smtp, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, telnetPortNumber=telnetPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntp=sntp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapIPAddress=sNMPTrapIPAddress, maximumTransmitPower=maximumTransmitPower, sNTPSyncTrap=sNTPSyncTrap, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, frequencyVariant=frequencyVariant, userTable=userTable, antennaGain=antennaGain, telecomsInterface=telecomsInterface, receiveDataRate=receiveDataRate, ptp500=ptp500, tDDSynchronizationAlarm=tDDSynchronizationAlarm, reset=reset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptmp=ptmp, userRole=userRole, groupID=groupID, telecomsCableLength=telecomsCableLength, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimisation=linkModeOptimisation, pubStatsGroup=pubStatsGroup, incompatibleRegionCodes=incompatibleRegionCodes, phyControlGroup=phyControlGroup, transmitDataRate=transmitDataRate, searchState=searchState, phyControl=phyControl, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortAutoMdix=dataPortAutoMdix, dfsGroup=dfsGroup, sNTPServerIPAddress=sNTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, softwareVersion=softwareVersion, alarmsGroup=alarmsGroup, dfsTableIndex=dfsTableIndex, bandwidthVariant=bandwidthVariant, syslogControlGroup=syslogControlGroup, phyStatus=phyStatus, tDDControlGroup=tDDControlGroup, vLANPriorityTable=vLANPriorityTable, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, aAAControlGroup=aAAControlGroup, ethernet=ethernet, dfsTable=dfsTable, sNMPEnabledTraps=sNMPEnabledTraps, userTableIndex=userTableIndex, userName=userName, systemClock=systemClock, sNTPPollInterval=sNTPPollInterval, receiveModulationModeDetail=receiveModulationModeDetail, sNMPPortNumber=sNMPPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPServerPortNumber=sNTPServerPortNumber, dfsMeans=dfsMeans)
