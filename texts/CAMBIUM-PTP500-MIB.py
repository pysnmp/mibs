...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userEnabled=userEnabled, configuration=configuration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, supplementaryGroup=supplementaryGroup, linkName=linkName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimisation=linkModeOptimisation, phyStatusGroup=phyStatusGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, userTableIndex=userTableIndex, sMTPEmailAlert=sMTPEmailAlert, sNMPv3Enable=sNMPv3Enable, subnetMask=subnetMask, iPAddress=iPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, targetMACAddress=targetMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, wirelessLinkStatus=wirelessLinkStatus, latitude=latitude, receiveDataRate=receiveDataRate, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTable=userTable, siteName=siteName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveFreqMHz=receiveFreqMHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, masterSlaveMode=masterSlaveMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqMHz=transmitFreqMHz, licence=licence, sNTPPollInterval=sNTPPollInterval, userPassword=userPassword, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versions=versions, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, cableLoss=cableLoss, tDDControl=tDDControl, sMTPServerIPAddress=sMTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, sNTPServerIPAddress=sNTPServerIPAddress, pubStatsGroup=pubStatsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sntp=sntp, range=range, ethernetFiberSupport=ethernetFiberSupport, vectorError=vectorError, hardwareVersion=hardwareVersion, installArmState=installArmState, transmitChannel=transmitChannel, sNMPPortNumber=sNMPPortNumber, daylightSaving=daylightSaving, telecomsInterface=telecomsInterface, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, snmpControlGroup=snmpControlGroup, eIRP=eIRP, searchState=searchState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableNumber=dfsTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogClientTrap=syslogClientTrap, tDDSynchronizationMode=tDDSynchronizationMode, byteErrorRatio=byteErrorRatio, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortStatus=dataPortStatus, tDDControlGroup=tDDControlGroup, sNMPTrapVersion=sNMPTrapVersion, remoteIPAddress=remoteIPAddress, telecomsCableLength=telecomsCableLength, signalStrengthRatio=signalStrengthRatio, vLANManagementPriority=vLANManagementPriority, sNTPLastSync=sNTPLastSync, telecomsLineCode=telecomsLineCode, capacityLicenseMismatch=capacityLicenseMismatch, timeZone=timeZone, transmitDataRate=transmitDataRate, dfsMeans=dfsMeans, syslogState=syslogState, ptpTraps=ptpTraps, frequencyVariant=frequencyVariant, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalWrappedTrap=syslogLocalWrappedTrap, accessMethod=accessMethod, supplementary=supplementary, notificationsGroup=notificationsGroup, dfsTableEntry=dfsTableEntry, regionCodeTrap=regionCodeTrap, syslogControl=syslogControl, noWirelessChannelAvailable=noWirelessChannelAvailable, sntpGroup=sntpGroup, sNTPServerPortNumber=sNTPServerPortNumber, alarmsGroup=alarmsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomGroup=telecomGroup, managementGroup=managementGroup, smtp=smtp, encryption=encryption, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licensedCapacity=licensedCapacity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, groupID=groupID, receiveChannel=receiveChannel, phyControlGroup=phyControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, productVariant=productVariant, aAAControlGroup=aAAControlGroup, dfsTableIndex=dfsTableIndex, vLANManagementVID=vLANManagementVID, sMTPServerPortNumber=sMTPServerPortNumber, phyControl=phyControl, versionsGroup=versionsGroup, bootVersion=bootVersion, userRole=userRole, altitude=altitude, ethernetGroup=ethernetGroup, syslogControlGroup=syslogControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEnabledMessages=sMTPEnabledMessages, channelBandwidth=channelBandwidth, syslogStateTrap=syslogStateTrap, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, encryptionGroup=encryptionGroup, sNMPCommunityString=sNMPCommunityString, dfsTable=dfsTable, wirelessLinkAvailability=wirelessLinkAvailability, vLANPriorityTableNumber=vLANPriorityTableNumber, longitude=longitude, sNMPTrapTableNumber=sNMPTrapTableNumber, channelChangeTrap=channelChangeTrap, ptp=ptp, dfsGroup=dfsGroup, ptpGroups=ptpGroups, ethernet=ethernet, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitPower=transmitPower, telecomsChannelStatus=telecomsChannelStatus, hTTPAccessEnabled=hTTPAccessEnabled, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsPeaks=dfsPeaks, ptmp=ptmp, dfs=dfs, receiveFreqKHz=receiveFreqKHz, dataPortStatusTrap=dataPortStatusTrap, userTableNumber=userTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, bandwidthVariant=bandwidthVariant, installStatusTrap=installStatusTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortAutoMdix=dataPortAutoMdix, transmitFreqKHz=transmitFreqKHz, installArmStateTrap=installArmStateTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, resetGroup=resetGroup, systemReset=systemReset, aAAControl=aAAControl, ptp500=ptp500, licenceGroup=licenceGroup, telecomsLoopback=telecomsLoopback, sNTPSyncTrap=sNTPSyncTrap, regionCode=regionCode, hTTPPortNumber=hTTPPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, telnetPortNumber=telnetPortNumber, hTTPSPortNumber=hTTPSPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, alarms=alarms, smtpGroup=smtpGroup, userTableEntry=userTableEntry, installStatus=installStatus, telnetAccessEnabled=telnetAccessEnabled, linkSymmetry=linkSymmetry, management=management, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, snmpControl=snmpControl, telecom=telecom, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, reset=reset, vLANPriorityTable=vLANPriorityTable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, userName=userName, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpCompliance=ptpCompliance, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, sNTPSync=sNTPSync, configurationGroup=configurationGroup, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, maximumTransmitPower=maximumTransmitPower, softwareVersion=softwareVersion, sNMPTrapTable=sNMPTrapTable, sNTPState=sNTPState, syslogClient=syslogClient, aggregateDataRate=aggregateDataRate, pubStats=pubStats, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibration=unitOutOfCalibration, phyStatus=phyStatus)
