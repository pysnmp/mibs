...
# Produced by pysmi-1.1.8 at Thu Jan  6 20:04:34 2022
...
IpAddress, Integer32, ModuleIdentity, Counter32, Counter64, MibIdentifier, TimeTicks, ObjectIdentity, Bits, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, NotificationType, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Integer32", "ModuleIdentity", "Counter32", "Counter64", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Bits", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "NotificationType", "iso", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortStatusTrap=dataPortStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsLineCode=telecomsLineCode, installArmState=installArmState, PYSNMP_MODULE_ID=cambium, installArmStateTrap=installArmStateTrap, telecomGroup=telecomGroup, eIRP=eIRP, syslogStateTrap=syslogStateTrap, wirelessLinkStatus=wirelessLinkStatus, sNMPv3Enable=sNMPv3Enable, pubStatsGroup=pubStatsGroup, antennaGain=antennaGain, supplementaryGroup=supplementaryGroup, dfsTableEntry=dfsTableEntry, ptp500=ptp500, telecomsChannelStatus=telecomsChannelStatus, gatewayIPAddress=gatewayIPAddress, dfs=dfs, versionsGroup=versionsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPEmailAlert=sMTPEmailAlert, phyStatusGroup=phyStatusGroup, vLANManagementPriority=vLANManagementPriority, receiveDataRate=receiveDataRate, aggregateDataRate=aggregateDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptp=ptp, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqKHz=transmitFreqKHz, phyStatus=phyStatus, secondarySoftwareVersion=secondarySoftwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapIPAddress=sNMPTrapIPAddress, byteErrorRatio=byteErrorRatio, receivePower=receivePower, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, licensedCapacity=licensedCapacity, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveFreqKHz=receiveFreqKHz, aAAControlGroup=aAAControlGroup, ptpTraps=ptpTraps, alarmsGroup=alarmsGroup, sNTPServerIPAddress=sNTPServerIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, productName=productName, sntpGroup=sntpGroup, dfsTable=dfsTable, userPassword=userPassword, noWirelessChannelAvailable=noWirelessChannelAvailable, configuration=configuration, dfsGroup=dfsGroup, userTableNumber=userTableNumber, dataPortStatus=dataPortStatus, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, wirelessLinkAvailability=wirelessLinkAvailability, userRole=userRole, userEnabled=userEnabled, sMTPServerPortNumber=sMTPServerPortNumber, snmpControl=snmpControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityTableNumber=vLANPriorityTableNumber, userTable=userTable, telecomsInterface=telecomsInterface, smtpGroup=smtpGroup, syslogControl=syslogControl, maximumTransmitPower=maximumTransmitPower, transmitPower=transmitPower, altitude=altitude, sMTPEnabledMessages=sMTPEnabledMessages, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitDataRate=transmitDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telnetPortNumber=telnetPortNumber, phyControl=phyControl, longitude=longitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, pubStats=pubStats, masterSlaveMode=masterSlaveMode, sNMPTrapTableIndex=sNMPTrapTableIndex, productVariant=productVariant, receiveModulationModeDetail=receiveModulationModeDetail, vLANPriorityTable=vLANPriorityTable, linkName=linkName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, notificationsGroup=notificationsGroup, syslogClientTrap=syslogClientTrap, searchState=searchState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPPollInterval=sNTPPollInterval, userTableIndex=userTableIndex, vectorError=vectorError, dfsMeans=dfsMeans, incompatibleMasterAndSlave=incompatibleMasterAndSlave, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDControl=tDDControl, remoteIPAddress=remoteIPAddress, smtp=smtp, subnetMask=subnetMask, linkLoss=linkLoss, ethernet=ethernet, regionCode=regionCode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPSync=sNTPSync, sNMPCommunityString=sNMPCommunityString, iPAddress=iPAddress, cableLoss=cableLoss, licenceGroup=licenceGroup, dfsTableNumber=dfsTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoMdix=dataPortAutoMdix, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telecomsLoopback=telecomsLoopback, hTTPSAccessEnabled=hTTPSAccessEnabled, versions=versions, targetMACAddress=targetMACAddress, range=range, timeZone=timeZone, management=management, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPPortNumber=sNMPPortNumber, regionCodeTrap=regionCodeTrap, transmitFreqMHz=transmitFreqMHz, encryptionGroup=encryptionGroup, systemReset=systemReset, tDDSynchronizationMode=tDDSynchronizationMode, linkSymmetry=linkSymmetry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, resetGroup=resetGroup, channelChangeTrap=channelChangeTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hardwareVersion=hardwareVersion, dataPortDisabledWarning=dataPortDisabledWarning, syslogState=syslogState, siteName=siteName, receiveModulationMode=receiveModulationMode, latitude=latitude, ptmp=ptmp, installStatusTrap=installStatusTrap, phyControlGroup=phyControlGroup, softwareVersion=softwareVersion, managementGroup=managementGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitModulationMode=transmitModulationMode, frequencyVariant=frequencyVariant, receiveFreqMHz=receiveFreqMHz, userName=userName, aAAControl=aAAControl, channelBandwidth=channelBandwidth, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpCompliance=ptpCompliance, dfsPeaks=dfsPeaks, linkModeOptimisation=linkModeOptimisation, capacityLicenseMismatch=capacityLicenseMismatch, signalStrengthRatio=signalStrengthRatio, hTTPSPortNumber=hTTPSPortNumber, installStatus=installStatus, sNTPLastSync=sNTPLastSync, alarms=alarms, sNTPSyncTrap=sNTPSyncTrap, configurationGroup=configurationGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, encryption=encryption, reset=reset, telecom=telecom, supplementary=supplementary, hTTPPortNumber=hTTPPortNumber, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerIPAddress=tFTPServerIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bootVersion=bootVersion, daylightSaving=daylightSaving, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPServerPortNumber=sNTPServerPortNumber, snmpControlGroup=snmpControlGroup, transmitChannel=transmitChannel, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodes=incompatibleRegionCodes, ethernetGroup=ethernetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogClient=syslogClient, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANPriorityQueueMapping=vLANPriorityQueueMapping, accessMethod=accessMethod, encryptionAlgorithm=encryptionAlgorithm, vLANManagementVID=vLANManagementVID, syslogControlGroup=syslogControlGroup, groupID=groupID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telnetAccessEnabled=telnetAccessEnabled, ptpGroups=ptpGroups, receiveChannel=receiveChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsCableLength=telecomsCableLength, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, cambium=cambium, licence=licence, sntp=sntp, sNMPEnabledTraps=sNMPEnabledTraps, tDDControlGroup=tDDControlGroup, sNTPState=sNTPState, dfsTableIndex=dfsTableIndex, bandwidthVariant=bandwidthVariant)
