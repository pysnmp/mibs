...
# Produced by pysmi-1.1.3 at Wed Dec  8 21:23:49 2021
...
NotificationType, Gauge32, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, TimeTicks, iso, Counter32, enterprises, Counter64, Unsigned32, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "TimeTicks", "iso", "Counter32", "enterprises", "Counter64", "Unsigned32", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, snmpControl=snmpControl, sMTPEnabledMessages=sMTPEnabledMessages, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, versions=versions, syslogClientTrap=syslogClientTrap, encryptionGroup=encryptionGroup, siteName=siteName, dfsTable=dfsTable, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, tDDControlGroup=tDDControlGroup, ptpTrapPrefix=ptpTrapPrefix, receiveFreqMHz=receiveFreqMHz, vectorError=vectorError, ptpTraps=ptpTraps, syslogControlGroup=syslogControlGroup, sNMPTrapTable=sNMPTrapTable, syslogStateTrap=syslogStateTrap, encryptionAlgorithm=encryptionAlgorithm, sNMPCommunityString=sNMPCommunityString, tDDControl=tDDControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPEmailAlert=sMTPEmailAlert, installStatusTrap=installStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTableIndex=dfsTableIndex, receiveChannel=receiveChannel, hardwareVersion=hardwareVersion, dfsGroup=dfsGroup, phyControlGroup=phyControlGroup, linkModeOptimisation=linkModeOptimisation, ethernetFiberSupport=ethernetFiberSupport, ptp=ptp, tFTPServerIPAddress=tFTPServerIPAddress, receivePower=receivePower, ethernet=ethernet, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptmp=ptmp, resetGroup=resetGroup, alarmsGroup=alarmsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, linkLoss=linkLoss, dataPortDisabledWarning=dataPortDisabledWarning, ptpCompliance=ptpCompliance, syslogLocalWrappedTrap=syslogLocalWrappedTrap, snmpControlGroup=snmpControlGroup, installStatus=installStatus, sNTPServerPortNumber=sNTPServerPortNumber, installArmStateTrap=installArmStateTrap, syslogClient=syslogClient, ptpGroups=ptpGroups, dfsTableNumber=dfsTableNumber, sNMPv3Enable=sNMPv3Enable, receiveModulationMode=receiveModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitFreqMHz=transmitFreqMHz, notificationsGroup=notificationsGroup, telecomsCableLength=telecomsCableLength, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableEntry=dfsTableEntry, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, maximumTransmitPower=maximumTransmitPower, hTTPSPortNumber=hTTPSPortNumber, dfsMeans=dfsMeans, sNMPPortNumber=sNMPPortNumber, configurationGroup=configurationGroup, sNTPSyncTrap=sNTPSyncTrap, phyControl=phyControl, smtp=smtp, sntp=sntp, sMTPServerIPAddress=sMTPServerIPAddress, groupID=groupID, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, frequencyVariant=frequencyVariant, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, searchState=searchState, sntpGroup=sntpGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, hTTPPortNumber=hTTPPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, secondarySoftwareVersion=secondarySoftwareVersion, masterSlaveMode=masterSlaveMode, vLANPriorityTableNumber=vLANPriorityTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, managementGroup=managementGroup, antennaGain=antennaGain, sNTPPollInterval=sNTPPollInterval, vLANPriorityTable=vLANPriorityTable, management=management, pubStats=pubStats, incompatibleRegionCodes=incompatibleRegionCodes, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelStatus=telecomsChannelStatus, reset=reset, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, accessMethod=accessMethod, altitude=altitude, versionsGroup=versionsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkSymmetry=linkSymmetry, sNTPState=sNTPState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, PYSNMP_MODULE_ID=cambium, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyStatus=phyStatus, dataPortAutoMdix=dataPortAutoMdix, regionCode=regionCode, transmitChannel=transmitChannel, phyStatusGroup=phyStatusGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogState=syslogState, supplementary=supplementary, unitOutOfCalibration=unitOutOfCalibration, telecom=telecom, iPAddress=iPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, eIRP=eIRP, signalStrengthRatio=signalStrengthRatio, telecomsInterface=telecomsInterface, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsLoopbackTrap=telecomsLoopbackTrap, regionCodeTrap=regionCodeTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, gatewayIPAddress=gatewayIPAddress, licenceGroup=licenceGroup, transmitDataRate=transmitDataRate, transmitPower=transmitPower, encryption=encryption, telnetAccessEnabled=telnetAccessEnabled, sNTPLastSync=sNTPLastSync, sMTPServerPortNumber=sMTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, latitude=latitude, byteErrorRatio=byteErrorRatio, longitude=longitude, aAAControlGroup=aAAControlGroup, subnetMask=subnetMask, dfsPeaks=dfsPeaks, sNTPServerIPAddress=sNTPServerIPAddress, bootVersion=bootVersion, vLANPriorityQueueMapping=vLANPriorityQueueMapping, alarms=alarms, telecomsLineCode=telecomsLineCode, installArmState=installArmState, userTableIndex=userTableIndex, userPassword=userPassword, sNMPEnabledTraps=sNMPEnabledTraps, transmitModulationMode=transmitModulationMode, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, licence=licence, telecomsLoopback=telecomsLoopback, targetMACAddress=targetMACAddress, userTable=userTable, tFTPServerPortNumber=tFTPServerPortNumber, cambium=cambium, timeZone=timeZone, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortStatus=dataPortStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, productName=productName, telecomGroup=telecomGroup, aggregateDataRate=aggregateDataRate, ptp500=ptp500, receiveModulationModeDetail=receiveModulationModeDetail, remoteIPAddress=remoteIPAddress, sNMPTrapVersion=sNMPTrapVersion, systemReset=systemReset, supplementaryGroup=supplementaryGroup, userName=userName, receiveFreqKHz=receiveFreqKHz, dfs=dfs, daylightSaving=daylightSaving, systemClock=systemClock, wirelessLinkAvailability=wirelessLinkAvailability, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, cableLoss=cableLoss, ethernetGroup=ethernetGroup, vLANManagementVID=vLANManagementVID, bandwidthVariant=bandwidthVariant, pubStatsGroup=pubStatsGroup, aAAControl=aAAControl, userTableNumber=userTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationMode=tDDSynchronizationMode, userRole=userRole, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, sNTPSync=sNTPSync, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userEnabled=userEnabled, wirelessLinkStatus=wirelessLinkStatus, syslogControl=syslogControl, linkName=linkName, telnetPortNumber=telnetPortNumber, channelBandwidth=channelBandwidth, configuration=configuration, range=range)
