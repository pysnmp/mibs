...
# Produced by pysmi-1.1.3 at Wed Dec  8 20:46:34 2021
...
Counter32, enterprises, Gauge32, IpAddress, ModuleIdentity, ObjectIdentity, MibIdentifier, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, NotificationType, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "Gauge32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "MibIdentifier", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "NotificationType", "Bits", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsChannelStatus=telecomsChannelStatus, syslogStateTrap=syslogStateTrap, signalStrengthRatio=signalStrengthRatio, aAAControlGroup=aAAControlGroup, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortAutoMdix=dataPortAutoMdix, frequencyVariant=frequencyVariant, sMTPEnabledMessages=sMTPEnabledMessages, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortStatusTrap=dataPortStatusTrap, telnetAccessEnabled=telnetAccessEnabled, dfsMeans=dfsMeans, productName=productName, searchState=searchState, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, versions=versions, dfsTableEntry=dfsTableEntry, telecom=telecom, phyControlGroup=phyControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, longitude=longitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsCableLength=telecomsCableLength, phyStatus=phyStatus, remoteIPAddress=remoteIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTable=sNMPTrapTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPServerIPAddress=tFTPServerIPAddress, timeZone=timeZone, telecomsLineCode=telecomsLineCode, sNMPTrapVersion=sNMPTrapVersion, sntpGroup=sntpGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, siteName=siteName, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, cambium=cambium, tDDControl=tDDControl, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyStatusGroup=phyStatusGroup, accessMethod=accessMethod, syslogState=syslogState, userTableEntry=userTableEntry, linkName=linkName, userEnabled=userEnabled, notificationsGroup=notificationsGroup, ptpTrapPrefix=ptpTrapPrefix, hTTPSPortNumber=hTTPSPortNumber, userTableIndex=userTableIndex, linkSymmetry=linkSymmetry, telecomsLoopback=telecomsLoopback, sNMPTrapTableNumber=sNMPTrapTableNumber, altitude=altitude, licenceGroup=licenceGroup, tFTPServerPortNumber=tFTPServerPortNumber, syslogControl=syslogControl, bootVersion=bootVersion, transmitChannel=transmitChannel, gatewayIPAddress=gatewayIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkStatus=wirelessLinkStatus, productVariant=productVariant, aAAControl=aAAControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, encryption=encryption, sNMPPortNumber=sNMPPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPAddress=iPAddress, userTable=userTable, tDDSynchronizationStatus=tDDSynchronizationStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, antennaGain=antennaGain, ethernetFiberSupport=ethernetFiberSupport, receiveChannel=receiveChannel, useVLANForManagementInterfaces=useVLANForManagementInterfaces, supplementary=supplementary, daylightSaving=daylightSaving, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDControlGroup=tDDControlGroup, snmpControl=snmpControl, dfsGroup=dfsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableLoss=cableLoss, telecomsInterface=telecomsInterface, telnetPortNumber=telnetPortNumber, dfsTable=dfsTable, supplementaryGroup=supplementaryGroup, syslogClientTrap=syslogClientTrap, vLANManagementPriority=vLANManagementPriority, range=range, sMTPEmailAlert=sMTPEmailAlert, ptpCompliance=ptpCompliance, telecomsLoopbackTrap=telecomsLoopbackTrap, managementGroup=managementGroup, sntp=sntp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsChannelStatusTrap=telecomsChannelStatusTrap, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, secondarySoftwareVersion=secondarySoftwareVersion, groupID=groupID, management=management, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPCommunityString=sNMPCommunityString, versionsGroup=versionsGroup, receiveFreqKHz=receiveFreqKHz, transmitFreqMHz=transmitFreqMHz, reset=reset, sNTPServerPortNumber=sNTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpGroups=ptpGroups, softwareVersion=softwareVersion, linkModeOptimisation=linkModeOptimisation, systemClock=systemClock, pubStatsGroup=pubStatsGroup, resetGroup=resetGroup, receivePower=receivePower, dfs=dfs, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, ptp=ptp, sNTPSyncTrap=sNTPSyncTrap, transmitDataRate=transmitDataRate, transmitPower=transmitPower, ethernetGroup=ethernetGroup, vectorError=vectorError, regionCode=regionCode, alarmsGroup=alarmsGroup, ethernet=ethernet, dfsPeaks=dfsPeaks, sNTPSync=sNTPSync, eIRP=eIRP, snmpControlGroup=snmpControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogControlGroup=syslogControlGroup, vLANPriorityTable=vLANPriorityTable, sNTPPollInterval=sNTPPollInterval, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, byteErrorRatio=byteErrorRatio, systemReset=systemReset, bandwidthVariant=bandwidthVariant, dataPortStatus=dataPortStatus, transmitModulationMode=transmitModulationMode, unitOutOfCalibration=unitOutOfCalibration, sNMPEnabledTraps=sNMPEnabledTraps, smtp=smtp, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsTableNumber=dfsTableNumber, hardwareVersion=hardwareVersion, sNTPLastSync=sNTPLastSync, channelChangeTrap=channelChangeTrap, userTableNumber=userTableNumber, installArmStateTrap=installArmStateTrap, phyControl=phyControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, PYSNMP_MODULE_ID=cambium, syslogClient=syslogClient, licence=licence, installArmState=installArmState, licensedCapacity=licensedCapacity, configurationGroup=configurationGroup, linkLoss=linkLoss, aggregateDataRate=aggregateDataRate, masterSlaveMode=masterSlaveMode, ptpTraps=ptpTraps, dataPortDisabledWarning=dataPortDisabledWarning, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANManagementVID=vLANManagementVID, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPv3Enable=sNMPv3Enable, alarms=alarms, configuration=configuration, channelBandwidth=channelBandwidth, installStatusTrap=installStatusTrap, pubStats=pubStats, telecomGroup=telecomGroup, subnetMask=subnetMask, ptmp=ptmp, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installStatus=installStatus, sMTPServerIPAddress=sMTPServerIPAddress, userPassword=userPassword, userRole=userRole, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPServerPortNumber=sMTPServerPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, regionCodeTrap=regionCodeTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveModulationModeDetail=receiveModulationModeDetail, maximumTransmitPower=maximumTransmitPower, sNTPServerIPAddress=sNTPServerIPAddress, transmitFreqKHz=transmitFreqKHz, targetMACAddress=targetMACAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableIndex=dfsTableIndex, vLANPriorityTableEntry=vLANPriorityTableEntry, userName=userName, latitude=latitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryptionGroup=encryptionGroup, ptp500=ptp500, smtpGroup=smtpGroup, sNTPState=sNTPState, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapTableIndex=sNMPTrapTableIndex)
