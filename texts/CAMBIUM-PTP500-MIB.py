...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userTable=userTable, transmitFreqKHz=transmitFreqKHz, alarms=alarms, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, ptpCompliance=ptpCompliance, dataPortStatus=dataPortStatus, altitude=altitude, smtp=smtp, sntp=sntp, ptpTrapPrefix=ptpTrapPrefix, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPPortNumber=sNMPPortNumber, installStatus=installStatus, snmpControlGroup=snmpControlGroup, sNTPSync=sNTPSync, vLANPriorityTableNumber=vLANPriorityTableNumber, userPassword=userPassword, userEnabled=userEnabled, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogControlGroup=syslogControlGroup, systemClock=systemClock, iPAddress=iPAddress, transmitPower=transmitPower, hardwareVersion=hardwareVersion, latitude=latitude, sNMPTrapTable=sNMPTrapTable, cableLoss=cableLoss, licenceGroup=licenceGroup, linkModeOptimisation=linkModeOptimisation, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userName=userName, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveChannel=receiveChannel, receiveModulationModeDetail=receiveModulationModeDetail, sNTPPollInterval=sNTPPollInterval, ethernet=ethernet, tDDControl=tDDControl, vLANPriorityTable=vLANPriorityTable, sNTPState=sNTPState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, sNMPTrapIPAddress=sNMPTrapIPAddress, channelChangeTrap=channelChangeTrap, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, phyControl=phyControl, encryption=encryption, capacityLicenseMismatch=capacityLicenseMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomGroup=telecomGroup, productVariant=productVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, groupID=groupID, softwareVersion=softwareVersion, syslogControl=syslogControl, transmitFreqMHz=transmitFreqMHz, encryptionAlgorithm=encryptionAlgorithm, hTTPPortNumber=hTTPPortNumber, telnetAccessEnabled=telnetAccessEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsMeans=dfsMeans, longitude=longitude, supplementaryGroup=supplementaryGroup, telecomsChannelStatus=telecomsChannelStatus, subnetMask=subnetMask, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, range=range, dfsTableIndex=dfsTableIndex, targetMACAddress=targetMACAddress, snmpControl=snmpControl, managementGroup=managementGroup, dfsPeaks=dfsPeaks, sNMPv3Enable=sNMPv3Enable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, maximumTransmitPower=maximumTransmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, PYSNMP_MODULE_ID=cambium, installArmStateTrap=installArmStateTrap, reset=reset, regionCode=regionCode, sMTPEmailAlert=sMTPEmailAlert, vectorError=vectorError, installArmState=installArmState, tDDSynchronizationStatus=tDDSynchronizationStatus, resetGroup=resetGroup, tDDControlGroup=tDDControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, searchState=searchState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkSymmetry=linkSymmetry, configuration=configuration, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStatsGroup=pubStatsGroup, sNMPCommunityString=sNMPCommunityString, channelBandwidth=channelBandwidth, telecomsLineCode=telecomsLineCode, tFTPServerPortNumber=tFTPServerPortNumber, telnetPortNumber=telnetPortNumber, aAAControlGroup=aAAControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleRegionCodes=incompatibleRegionCodes, vLANManagementPriority=vLANManagementPriority, receivePower=receivePower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receiveModulationMode=receiveModulationMode, dfsGroup=dfsGroup, signalStrengthRatio=signalStrengthRatio, smtpGroup=smtpGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, frequencyVariant=frequencyVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapVersion=sNMPTrapVersion, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, timeZone=timeZone, sNMPTrapPortNumber=sNMPTrapPortNumber, bootVersion=bootVersion, bandwidthVariant=bandwidthVariant, sntpGroup=sntpGroup, telecomsLoopback=telecomsLoopback, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernetFiberSupport=ethernetFiberSupport, systemReset=systemReset, telecom=telecom, unitOutOfCalibration=unitOutOfCalibration, notificationsGroup=notificationsGroup, dfsTableNumber=dfsTableNumber, daylightSaving=daylightSaving, alarmsGroup=alarmsGroup, phyStatus=phyStatus, dataPortDisabledWarning=dataPortDisabledWarning, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCodeTrap=regionCodeTrap, installStatusTrap=installStatusTrap, dfs=dfs, aAAControl=aAAControl, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, cambium=cambium, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, versionsGroup=versionsGroup, tDDSynchronizationMode=tDDSynchronizationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, aggregateDataRate=aggregateDataRate, telecomsCableLength=telecomsCableLength, receiveFreqKHz=receiveFreqKHz, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licence=licence, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteMaximumTransmitPower=remoteMaximumTransmitPower, masterSlaveMode=masterSlaveMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveDataRate=receiveDataRate, sNTPServerIPAddress=sNTPServerIPAddress, productName=productName, telecomsInterface=telecomsInterface, ptmp=ptmp, sNTPServerPortNumber=sNTPServerPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, linkLoss=linkLoss, supplementary=supplementary, dfsTable=dfsTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPEnabledTraps=sNMPEnabledTraps, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClient=syslogClient, receiveFreqMHz=receiveFreqMHz, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogStateTrap=syslogStateTrap, ethernetGroup=ethernetGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatusGroup=phyStatusGroup, dfsTableEntry=dfsTableEntry, siteName=siteName, hTTPSPortNumber=hTTPSPortNumber, syslogState=syslogState, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitChannel=transmitChannel, eIRP=eIRP, userTableEntry=userTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoMdix=dataPortAutoMdix, ptp=ptp, ptp500=ptp500, syslogClientTrap=syslogClientTrap, remoteIPAddress=remoteIPAddress, wirelessLinkStatus=wirelessLinkStatus, byteErrorRatio=byteErrorRatio, userTableIndex=userTableIndex, dataPortWirelessDownAlert=dataPortWirelessDownAlert, configurationGroup=configurationGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, userTableNumber=userTableNumber, ptpGroups=ptpGroups, phyControlGroup=phyControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, management=management, encryptionGroup=encryptionGroup, versions=versions, vLANManagementVID=vLANManagementVID, userRole=userRole, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, ptpTraps=ptpTraps, sNTPSyncTrap=sNTPSyncTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, accessMethod=accessMethod)
