...
IpAddress, enterprises, Counter32, Integer32, MibIdentifier, Unsigned32, iso, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Bits, TimeTicks, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "enterprises", "Counter32", "Integer32", "MibIdentifier", "Unsigned32", "iso", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Bits", "TimeTicks", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortStatusTrap=dataPortStatusTrap, transmitFreqMHz=transmitFreqMHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPSync=sNTPSync, targetMACAddress=targetMACAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, byteErrorRatio=byteErrorRatio, transmitPower=transmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptmp=ptmp, masterSlaveMode=masterSlaveMode, vLANPriorityTable=vLANPriorityTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTableIndex=dfsTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsLoopback=telecomsLoopback, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsCableLength=telecomsCableLength, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsLineCode=telecomsLineCode, bandwidthVariant=bandwidthVariant, syslogClient=syslogClient, productVariant=productVariant, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCode=regionCode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTable=dfsTable, phyControl=phyControl, ptpGroups=ptpGroups, resetGroup=resetGroup, sNTPPollInterval=sNTPPollInterval, accessMethod=accessMethod, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableNumber=dfsTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveFreqMHz=receiveFreqMHz, aggregateDataRate=aggregateDataRate, transmitModulationMode=transmitModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, ethernet=ethernet, softwareVersion=softwareVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleRegionCodes=incompatibleRegionCodes, pubStats=pubStats, linkName=linkName, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibration=unitOutOfCalibration, syslogClientTrap=syslogClientTrap, ptp=ptp, tDDControl=tDDControl, snmpControl=snmpControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarmsGroup=alarmsGroup, telnetPortNumber=telnetPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, management=management, subnetMask=subnetMask, supplementaryGroup=supplementaryGroup, siteName=siteName, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, signalStrengthRatio=signalStrengthRatio, userTableEntry=userTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, userTable=userTable, groupID=groupID, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, gatewayIPAddress=gatewayIPAddress, configuration=configuration, altitude=altitude, systemReset=systemReset, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPCommunityString=sNMPCommunityString, userRole=userRole, sNMPPortNumber=sNMPPortNumber, dfsMeans=dfsMeans, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licence=licence, receiveChannel=receiveChannel, ptpTraps=ptpTraps, linkModeOptimizationMismatch=linkModeOptimizationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapVersion=sNMPTrapVersion, telecomsInterface=telecomsInterface, notificationsGroup=notificationsGroup, configurationGroup=configurationGroup, licenceGroup=licenceGroup, installArmState=installArmState, frequencyVariant=frequencyVariant, channelBandwidth=channelBandwidth, capacityLicenseMismatch=capacityLicenseMismatch, timeZone=timeZone, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortDisabledWarning=dataPortDisabledWarning, dfsGroup=dfsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, bootVersion=bootVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfs=dfs, encryptionAlgorithm=encryptionAlgorithm, receiveDataRate=receiveDataRate, vLANManagementVID=vLANManagementVID, hTTPSPortNumber=hTTPSPortNumber, encryptionGroup=encryptionGroup, telecomsChannelStatus=telecomsChannelStatus, syslogControl=syslogControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hTTPAccessEnabled=hTTPAccessEnabled, userTableNumber=userTableNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimisation=linkModeOptimisation, userPassword=userPassword, ptpCompliance=ptpCompliance, installStatus=installStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelChangeTrap=channelChangeTrap, pubStatsGroup=pubStatsGroup, smtp=smtp, sMTPServerIPAddress=sMTPServerIPAddress, userEnabled=userEnabled, range=range, sNTPSyncTrap=sNTPSyncTrap, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, receiveFreqKHz=receiveFreqKHz, sMTPEmailAlert=sMTPEmailAlert, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, aAAControl=aAAControl, reset=reset, dfsTableEntry=dfsTableEntry, iPAddress=iPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveModulationModeDetail=receiveModulationModeDetail, installArmStateTrap=installArmStateTrap, productName=productName, vectorError=vectorError, phyStatusGroup=phyStatusGroup, phyControlGroup=phyControlGroup, telecom=telecom, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPLastSync=sNTPLastSync, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, remoteIPAddress=remoteIPAddress, linkSymmetry=linkSymmetry, latitude=latitude, sntp=sntp, sNTPState=sNTPState, supplementary=supplementary, linkLoss=linkLoss, vLANManagementPriority=vLANManagementPriority, tFTPServerPortNumber=tFTPServerPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitDataRate=transmitDataRate, snmpControlGroup=snmpControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomGroup=telecomGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsPeaks=dfsPeaks, maximumTransmitPower=maximumTransmitPower, vLANPriorityTableIndex=vLANPriorityTableIndex, userTableIndex=userTableIndex, eIRP=eIRP, searchState=searchState, wirelessLinkStatus=wirelessLinkStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, cableLoss=cableLoss, antennaGain=antennaGain, transmitChannel=transmitChannel, telecomsLoopbackTrap=telecomsLoopbackTrap, longitude=longitude, phyStatus=phyStatus, aAAControlGroup=aAAControlGroup, transmitFreqKHz=transmitFreqKHz, sNMPTrapTable=sNMPTrapTable, tDDControlGroup=tDDControlGroup, versions=versions, systemClock=systemClock, hardwareVersion=hardwareVersion, cambium=cambium, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, sntpGroup=sntpGroup, regionCodeTrap=regionCodeTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, PYSNMP_MODULE_ID=cambium, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userName=userName, encryption=encryption, syslogState=syslogState, sNMPv3Enable=sNMPv3Enable, licensedCapacity=licensedCapacity, installStatusTrap=installStatusTrap, syslogStateTrap=syslogStateTrap, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailable=noWirelessChannelAvailable, daylightSaving=daylightSaving, receivePower=receivePower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telnetAccessEnabled=telnetAccessEnabled, ptp500=ptp500, alarms=alarms, versionsGroup=versionsGroup, ethernetFiberSupport=ethernetFiberSupport)
