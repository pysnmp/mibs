...
Unsigned32, iso, enterprises, Bits, IpAddress, Integer32, TimeTicks, MibIdentifier, NotificationType, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "enterprises", "Bits", "IpAddress", "Integer32", "TimeTicks", "MibIdentifier", "NotificationType", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ethernet=ethernet, gatewayIPAddress=gatewayIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, daylightSaving=daylightSaving, vLANManagementVID=vLANManagementVID, capacityLicenseMismatch=capacityLicenseMismatch, receiveModulationModeDetail=receiveModulationModeDetail, snmpControl=snmpControl, receiveFreqMHz=receiveFreqMHz, hTTPAccessEnabled=hTTPAccessEnabled, timeZone=timeZone, cableLoss=cableLoss, siteName=siteName, management=management, ptpTraps=ptpTraps, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPAddress=iPAddress, userTable=userTable, tDDSynchronizationStatus=tDDSynchronizationStatus, ptp500=ptp500, receivePower=receivePower, encryption=encryption, tDDSynchronizationAlarm=tDDSynchronizationAlarm, syslogControl=syslogControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsCableLength=telecomsCableLength, telnetAccessEnabled=telnetAccessEnabled, installArmStateTrap=installArmStateTrap, configuration=configuration, phyStatusGroup=phyStatusGroup, telecomsLoopback=telecomsLoopback, regionCodeTrap=regionCodeTrap, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkName=linkName, sntpGroup=sntpGroup, dfsMeans=dfsMeans, telecomsChannelStatus=telecomsChannelStatus, telnetPortNumber=telnetPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPPollInterval=sNTPPollInterval, dfsGroup=dfsGroup, syslogControlGroup=syslogControlGroup, reset=reset, telecom=telecom, licensedCapacity=licensedCapacity, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitOutOfCalibration=unitOutOfCalibration, eIRP=eIRP, dfsTableIndex=dfsTableIndex, transmitFreqKHz=transmitFreqKHz, userTableEntry=userTableEntry, encryptionAlgorithm=encryptionAlgorithm, transmitPower=transmitPower, aAAControl=aAAControl, transmitChannel=transmitChannel, dfsTableNumber=dfsTableNumber, linkModeOptimisation=linkModeOptimisation, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, receiveDataRate=receiveDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sntp=sntp, transmitFreqMHz=transmitFreqMHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productName=productName, userTableNumber=userTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, byteErrorRatio=byteErrorRatio, notificationsGroup=notificationsGroup, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, syslogClient=syslogClient, sNTPSyncTrap=sNTPSyncTrap, ptpCompliance=ptpCompliance, resetGroup=resetGroup, alarmsGroup=alarmsGroup, hardwareVersion=hardwareVersion, sNMPPortNumber=sNMPPortNumber, alarms=alarms, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkSymmetry=linkSymmetry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPv3Enable=sNMPv3Enable, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState, dfs=dfs, installStatusTrap=installStatusTrap, smtp=smtp, dataPortStatus=dataPortStatus, dataPortAutoMdix=dataPortAutoMdix, latitude=latitude, channelBandwidth=channelBandwidth, snmpControlGroup=snmpControlGroup, bootVersion=bootVersion, ethernetGroup=ethernetGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationGroup=configurationGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, vectorError=vectorError, receiveModulationMode=receiveModulationMode, sMTPEmailAlert=sMTPEmailAlert, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyControl=phyControl, vLANPriorityTable=vLANPriorityTable, dataPortStatusTrap=dataPortStatusTrap, telecomsLineCode=telecomsLineCode, tFTPServerPortNumber=tFTPServerPortNumber, userName=userName, productVariant=productVariant, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, antennaGain=antennaGain, syslogStateTrap=syslogStateTrap, dfsTableEntry=dfsTableEntry, dfsTable=dfsTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogState=syslogState, regionCode=regionCode, tFTPServerIPAddress=tFTPServerIPAddress, versions=versions, telecomsChannelStatusTrap=telecomsChannelStatusTrap, supplementary=supplementary, sNMPTrapIPAddress=sNMPTrapIPAddress, userRole=userRole, searchState=searchState, targetMACAddress=targetMACAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPLastSync=sNTPLastSync, sMTPServerPortNumber=sMTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogClientTrap=syslogClientTrap, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsInterface=telecomsInterface, tDDSynchronizationMode=tDDSynchronizationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, altitude=altitude, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, signalStrengthRatio=signalStrengthRatio, sNTPServerPortNumber=sNTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleRegionCodes=incompatibleRegionCodes, tDDControlGroup=tDDControlGroup, vLANManagementPriority=vLANManagementPriority, userEnabled=userEnabled, telecomGroup=telecomGroup, remoteIPAddress=remoteIPAddress, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, ptmp=ptmp, sNMPEnabledTraps=sNMPEnabledTraps, aAAControlGroup=aAAControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, systemReset=systemReset, ptp=ptp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSPortNumber=hTTPSPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, PYSNMP_MODULE_ID=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, licence=licence, dataPortDisabledWarning=dataPortDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, frequencyVariant=frequencyVariant, versionsGroup=versionsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPSync=sNTPSync, systemClock=systemClock, userPassword=userPassword, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, subnetMask=subnetMask, aggregateDataRate=aggregateDataRate, licenceGroup=licenceGroup, accessMethod=accessMethod, softwareVersion=softwareVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, pubStatsGroup=pubStatsGroup, range=range, receiveChannel=receiveChannel, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, groupID=groupID, ethernetFiberSupport=ethernetFiberSupport, longitude=longitude, sMTPEnabledMessages=sMTPEnabledMessages, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, dfsPeaks=dfsPeaks, sNTPState=sNTPState, channelChangeTrap=channelChangeTrap, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, supplementaryGroup=supplementaryGroup, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, cambium=cambium, tDDControl=tDDControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitDataRate=transmitDataRate, encryptionGroup=encryptionGroup, wirelessLinkStatus=wirelessLinkStatus, managementGroup=managementGroup, bandwidthVariant=bandwidthVariant, ptpGroups=ptpGroups, userTableIndex=userTableIndex, installStatus=installStatus, sNTPServerIPAddress=sNTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
