...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, ModuleIdentity, Bits, Counter64, enterprises, iso, Counter32, Integer32, NotificationType, Gauge32, IpAddress, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Bits", "Counter64", "enterprises", "iso", "Counter32", "Integer32", "NotificationType", "Gauge32", "IpAddress", "Unsigned32", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", management=management, latitude=latitude, transmitChannel=transmitChannel, dataPortStatus=dataPortStatus, receiveFreqMHz=receiveFreqMHz, range=range, sNTPSyncTrap=sNTPSyncTrap, dataPortDisabledWarning=dataPortDisabledWarning, dfsTableNumber=dfsTableNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptmp=ptmp, smtpGroup=smtpGroup, dfsTableIndex=dfsTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, installStatusTrap=installStatusTrap, sNMPv3Enable=sNMPv3Enable, versionsGroup=versionsGroup, telecomsInterface=telecomsInterface, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, cambium=cambium, accessMethod=accessMethod, vLANPriorityTable=vLANPriorityTable, sMTPServerPortNumber=sMTPServerPortNumber, pubStats=pubStats, receiveModulationMode=receiveModulationMode, pubStatsGroup=pubStatsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsPeaks=dfsPeaks, sNMPTrapVersion=sNMPTrapVersion, ptpTraps=ptpTraps, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productVariant=productVariant, bootVersion=bootVersion, phyControlGroup=phyControlGroup, vectorError=vectorError, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aAAControlGroup=aAAControlGroup, configurationGroup=configurationGroup, sNTPState=sNTPState, frequencyVariant=frequencyVariant, telnetAccessEnabled=telnetAccessEnabled, syslogClientTrap=syslogClientTrap, longitude=longitude, syslogControl=syslogControl, phyStatus=phyStatus, versions=versions, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sntp=sntp, maximumTransmitPower=maximumTransmitPower, ethernetFiberSupport=ethernetFiberSupport, receivePower=receivePower, telecom=telecom, sNTPServerIPAddress=sNTPServerIPAddress, telecomsCableLength=telecomsCableLength, supplementary=supplementary, snmpControlGroup=snmpControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, encryptionGroup=encryptionGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, iPAddress=iPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelChangeTrap=channelChangeTrap, dfsGroup=dfsGroup, smtp=smtp, regionCode=regionCode, notificationsGroup=notificationsGroup, transmitFreqKHz=transmitFreqKHz, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp500=ptp500, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitModulationMode=transmitModulationMode, searchState=searchState, groupID=groupID, tDDControl=tDDControl, ptpCompliance=ptpCompliance, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installArmStateTrap=installArmStateTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortAutoMdix=dataPortAutoMdix, bandwidthVariant=bandwidthVariant, tFTPServerPortNumber=tFTPServerPortNumber, receiveChannel=receiveChannel, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, tDDControlGroup=tDDControlGroup, cableLoss=cableLoss, channelBandwidth=channelBandwidth, vLANPriorityTableEntry=vLANPriorityTableEntry, capacityLicenseMismatch=capacityLicenseMismatch, sNMPEnabledTraps=sNMPEnabledTraps, altitude=altitude, hTTPSPortNumber=hTTPSPortNumber, eIRP=eIRP, sNTPSync=sNTPSync, userTableEntry=userTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteIPAddress=remoteIPAddress, syslogState=syslogState, ptpTrapPrefix=ptpTrapPrefix, phyStatusGroup=phyStatusGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, managementGroup=managementGroup, sNTPPollInterval=sNTPPollInterval, dfs=dfs, telecomsChannelStatus=telecomsChannelStatus, tFTPServerIPAddress=tFTPServerIPAddress, masterSlaveMode=masterSlaveMode, alarms=alarms, telecomsLoopback=telecomsLoopback, ethernetGroup=ethernetGroup, aAAControl=aAAControl, alarmsGroup=alarmsGroup, hTTPPortNumber=hTTPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userEnabled=userEnabled, transmitDataRate=transmitDataRate, telecomsLineCode=telecomsLineCode, sMTPServerIPAddress=sMTPServerIPAddress, productName=productName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANPriorityTableNumber=vLANPriorityTableNumber, linkSymmetry=linkSymmetry, antennaGain=antennaGain, daylightSaving=daylightSaving, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userTableNumber=userTableNumber, licensedCapacity=licensedCapacity, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkModeOptimisation=linkModeOptimisation, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationStatus=tDDSynchronizationStatus, PYSNMP_MODULE_ID=cambium, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpGroups=ptpGroups, sNMPCommunityString=sNMPCommunityString, dfsMeans=dfsMeans, hTTPAccessEnabled=hTTPAccessEnabled, userPassword=userPassword, userName=userName, regionCodeTrap=regionCodeTrap, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, timeZone=timeZone, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortStatusTrap=dataPortStatusTrap, dfsTable=dfsTable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTable=userTable, userTableIndex=userTableIndex, syslogStateTrap=syslogStateTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkName=linkName, wirelessLinkStatus=wirelessLinkStatus, targetMACAddress=targetMACAddress, transmitPower=transmitPower, configuration=configuration, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userRole=userRole, syslogClient=syslogClient, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANManagementVID=vLANManagementVID, encryption=encryption, hardwareVersion=hardwareVersion, syslogControlGroup=syslogControlGroup, snmpControl=snmpControl, siteName=siteName, installArmState=installArmState, sNMPPortNumber=sNMPPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, reset=reset, sntpGroup=sntpGroup, receiveFreqKHz=receiveFreqKHz, supplementaryGroup=supplementaryGroup, phyControl=phyControl, licence=licence, licenceGroup=licenceGroup, resetGroup=resetGroup, dfsTableEntry=dfsTableEntry, telnetPortNumber=telnetPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, byteErrorRatio=byteErrorRatio, gatewayIPAddress=gatewayIPAddress, ethernet=ethernet, subnetMask=subnetMask, telecomGroup=telecomGroup, systemReset=systemReset, dataPortAutoNegotiation=dataPortAutoNegotiation, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installStatus=installStatus, sNTPServerPortNumber=sNTPServerPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANManagementPriority=vLANManagementPriority)
