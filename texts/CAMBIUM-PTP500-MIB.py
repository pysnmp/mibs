...
Unsigned32, Counter64, iso, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, TimeTicks, Counter32, Integer32, enterprises, IpAddress, Gauge32, ObjectIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "iso", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "TimeTicks", "Counter32", "Integer32", "enterprises", "IpAddress", "Gauge32", "ObjectIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDSynchronizationAlarm=tDDSynchronizationAlarm, constantPowerSpectralDensity=constantPowerSpectralDensity, channelBandwidth=channelBandwidth, ptpTraps=ptpTraps, dfsTable=dfsTable, tFTPServerPortNumber=tFTPServerPortNumber, userTableIndex=userTableIndex, ethernet=ethernet, encryption=encryption, syslogControl=syslogControl, accessMethod=accessMethod, linkName=linkName, syslogControlGroup=syslogControlGroup, ethernetFiberSupport=ethernetFiberSupport, supplementary=supplementary, tDDControl=tDDControl, sNTPSyncTrap=sNTPSyncTrap, dfs=dfs, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, telecomGroup=telecomGroup, phyControl=phyControl, tDDControlGroup=tDDControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableIndex=dfsTableIndex, subnetMask=subnetMask, searchState=searchState, transmitChannel=transmitChannel, telecomsInterface=telecomsInterface, sNMPv3Enable=sNMPv3Enable, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, dfsGroup=dfsGroup, maximumTransmitPower=maximumTransmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, timeZone=timeZone, receiveFreqMHz=receiveFreqMHz, telecomsLoopbackTrap=telecomsLoopbackTrap, telecom=telecom, vLANPriorityTableEntry=vLANPriorityTableEntry, regionCodeTrap=regionCodeTrap, sMTPServerPortNumber=sMTPServerPortNumber, linkSymmetry=linkSymmetry, transmitFreqKHz=transmitFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, wirelessLinkStatus=wirelessLinkStatus, transmitFreqMHz=transmitFreqMHz, userRole=userRole, pubStats=pubStats, alarms=alarms, installStatus=installStatus, receivePower=receivePower, sNMPTrapIPAddress=sNMPTrapIPAddress, snmpControlGroup=snmpControlGroup, ethernetGroup=ethernetGroup, aAAControl=aAAControl, capacityLicenseMismatch=capacityLicenseMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPServerIPAddress=tFTPServerIPAddress, telnetPortNumber=telnetPortNumber, sNTPLastSync=sNTPLastSync, dataPortStatusTrap=dataPortStatusTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, management=management, iPAddress=iPAddress, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, notificationsGroup=notificationsGroup, versions=versions, unitOutOfCalibration=unitOutOfCalibration, productName=productName, vLANPriorityTable=vLANPriorityTable, siteName=siteName, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, receiveChannel=receiveChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, smtpGroup=smtpGroup, range=range, altitude=altitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityQueueMapping=vLANPriorityQueueMapping, longitude=longitude, receiveFreqKHz=receiveFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitPower=transmitPower, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPPollInterval=sNTPPollInterval, encryptionAlgorithm=encryptionAlgorithm, dfsTableNumber=dfsTableNumber, alarmsGroup=alarmsGroup, frequencyVariant=frequencyVariant, installStatusTrap=installStatusTrap, cambium=cambium, aAAControlGroup=aAAControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortDisabledWarning=dataPortDisabledWarning, dfsPeaks=dfsPeaks, incompatibleRegionCodes=incompatibleRegionCodes, phyControlGroup=phyControlGroup, transmitModulationMode=transmitModulationMode, sntp=sntp, sNMPEnabledTraps=sNMPEnabledTraps, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptpGroups=ptpGroups, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, signalStrengthRatio=signalStrengthRatio, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, cableLoss=cableLoss, licensedCapacity=licensedCapacity, vLANPriorityTableNumber=vLANPriorityTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, bootVersion=bootVersion, groupID=groupID, dfsTableEntry=dfsTableEntry, channelChangeTrap=channelChangeTrap, managementGroup=managementGroup, sMTPEnabledMessages=sMTPEnabledMessages, userTableEntry=userTableEntry, userTableNumber=userTableNumber, ptpTrapPrefix=ptpTrapPrefix, syslogClientTrap=syslogClientTrap, systemReset=systemReset, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEmailAlert=sMTPEmailAlert, userTable=userTable, telecomsCableLength=telecomsCableLength, masterSlaveMode=masterSlaveMode, receiveModulationMode=receiveModulationMode, daylightSaving=daylightSaving, aggregateDataRate=aggregateDataRate, telecomsLineCode=telecomsLineCode, sNMPPortNumber=sNMPPortNumber, vectorError=vectorError, sNMPTrapTable=sNMPTrapTable, ptp500=ptp500, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userPassword=userPassword, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtp=smtp, sNTPState=sNTPState, syslogState=syslogState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, supplementaryGroup=supplementaryGroup, targetMACAddress=targetMACAddress, linkLoss=linkLoss, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telnetAccessEnabled=telnetAccessEnabled, antennaGain=antennaGain, phyStatus=phyStatus, sNMPCommunityString=sNMPCommunityString, linkModeOptimisation=linkModeOptimisation, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSync=sNTPSync, resetGroup=resetGroup, receiveModulationModeDetail=receiveModulationModeDetail, pubStatsGroup=pubStatsGroup, hTTPPortNumber=hTTPPortNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptmp=ptmp, userEnabled=userEnabled, eIRP=eIRP, configuration=configuration, userName=userName, installArmState=installArmState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveDataRate=receiveDataRate, ptp=ptp, dfsMeans=dfsMeans, hTTPAccessEnabled=hTTPAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, syslogClient=syslogClient, ptpCompliance=ptpCompliance, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsLoopback=telecomsLoopback, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, syslogStateTrap=syslogStateTrap, softwareVersion=softwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortStatus=dataPortStatus, byteErrorRatio=byteErrorRatio, encryptionGroup=encryptionGroup, sNMPTrapVersion=sNMPTrapVersion, gatewayIPAddress=gatewayIPAddress, configurationGroup=configurationGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sntpGroup=sntpGroup, versionsGroup=versionsGroup, hTTPSPortNumber=hTTPSPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortAutoMdix=dataPortAutoMdix, productVariant=productVariant, latitude=latitude, reset=reset, licence=licence, dataPortAutoNegotiation=dataPortAutoNegotiation, licenceGroup=licenceGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDSynchronizationMode=tDDSynchronizationMode, wirelessLinkAvailability=wirelessLinkAvailability, snmpControl=snmpControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelStatus=telecomsChannelStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, bandwidthVariant=bandwidthVariant)
