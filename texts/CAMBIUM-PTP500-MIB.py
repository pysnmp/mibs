...
NotificationType, Counter32, TimeTicks, Gauge32, Unsigned32, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, MibIdentifier, Integer32, enterprises, Bits, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "TimeTicks", "Gauge32", "Unsigned32", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "MibIdentifier", "Integer32", "enterprises", "Bits", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerPortNumber=sNTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, syslogStateTrap=syslogStateTrap, aAAControl=aAAControl, telecomsCableLength=telecomsCableLength, subnetMask=subnetMask, vLANPriorityTableIndex=vLANPriorityTableIndex, masterSlaveMode=masterSlaveMode, receivePower=receivePower, wirelessLinkStatus=wirelessLinkStatus, siteName=siteName, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkSymmetry=linkSymmetry, encryptionAlgorithm=encryptionAlgorithm, encryption=encryption, dfsTableNumber=dfsTableNumber, configuration=configuration, unitOutOfCalibration=unitOutOfCalibration, ptmp=ptmp, searchState=searchState, licensedCapacity=licensedCapacity, dataPortStatus=dataPortStatus, bandwidthVariant=bandwidthVariant, userName=userName, channelBandwidth=channelBandwidth, receiveFreqKHz=receiveFreqKHz, channelChangeTrap=channelChangeTrap, accessMethod=accessMethod, versionsGroup=versionsGroup, timeZone=timeZone, transmitDataRate=transmitDataRate, secondarySoftwareVersion=secondarySoftwareVersion, frequencyVariant=frequencyVariant, incompatibleRegionCodes=incompatibleRegionCodes, pubStatsGroup=pubStatsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, alarms=alarms, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, altitude=altitude, vLANPriorityTable=vLANPriorityTable, userTable=userTable, linkName=linkName, telecomsChannelStatusTrap=telecomsChannelStatusTrap, smtp=smtp, hTTPAccessEnabled=hTTPAccessEnabled, sNMPPortNumber=sNMPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecom=telecom, receiveModulationModeDetail=receiveModulationModeDetail, hTTPPortNumber=hTTPPortNumber, transmitFreqMHz=transmitFreqMHz, receiveModulationMode=receiveModulationMode, licence=licence, systemClock=systemClock, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup, productVariant=productVariant, vLANPriorityTableEntry=vLANPriorityTableEntry, ethernet=ethernet, ethernetFiberSupport=ethernetFiberSupport, syslogClientTrap=syslogClientTrap, sMTPEmailAlert=sMTPEmailAlert, range=range, ethernetGroup=ethernetGroup, phyStatusGroup=phyStatusGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, snmpControlGroup=snmpControlGroup, daylightSaving=daylightSaving, sMTPServerPortNumber=sMTPServerPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPPollInterval=sNTPPollInterval, telecomsLoopback=telecomsLoopback, antennaGain=antennaGain, receiveDataRate=receiveDataRate, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPv3Enable=sNMPv3Enable, remoteIPAddress=remoteIPAddress, vLANManagementPriority=vLANManagementPriority, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationStatus=tDDSynchronizationStatus, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsPeaks=dfsPeaks, vectorError=vectorError, linkLoss=linkLoss, eIRP=eIRP, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, productName=productName, telnetAccessEnabled=telnetAccessEnabled, telecomsInterface=telecomsInterface, regionCode=regionCode, transmitChannel=transmitChannel, phyControlGroup=phyControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPAddress=iPAddress, sNTPSyncTrap=sNTPSyncTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, receiveFreqMHz=receiveFreqMHz, sNTPLastSync=sNTPLastSync, PYSNMP_MODULE_ID=cambium, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtpGroup=smtpGroup, longitude=longitude, transmitFreqKHz=transmitFreqKHz, tDDControlGroup=tDDControlGroup, management=management, syslogControl=syslogControl, userTableEntry=userTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, userPassword=userPassword, ptpCompliance=ptpCompliance, installStatusTrap=installStatusTrap, cambium=cambium, versions=versions, phyControl=phyControl, signalStrengthRatio=signalStrengthRatio, dfsGroup=dfsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userRole=userRole, targetMACAddress=targetMACAddress, resetGroup=resetGroup, installStatus=installStatus, telecomGroup=telecomGroup, supplementaryGroup=supplementaryGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntpGroup=sntpGroup, aAAControlGroup=aAAControlGroup, linkModeOptimisation=linkModeOptimisation, receiveChannel=receiveChannel, telecomsChannelStatus=telecomsChannelStatus, ptpGroups=ptpGroups, dfsTableIndex=dfsTableIndex, dfs=dfs, regionCodeTrap=regionCodeTrap, transmitModulationMode=transmitModulationMode, userEnabled=userEnabled, sMTPServerIPAddress=sMTPServerIPAddress, sNTPSync=sNTPSync, byteErrorRatio=byteErrorRatio, tFTPServerIPAddress=tFTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, configurationGroup=configurationGroup, tDDControl=tDDControl, transmitPower=transmitPower, snmpControl=snmpControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sntp=sntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, supplementary=supplementary, ptpTrapPrefix=ptpTrapPrefix, latitude=latitude, installArmState=installArmState, syslogState=syslogState, aggregateDataRate=aggregateDataRate, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsLineCode=telecomsLineCode, dataPortDisabledWarning=dataPortDisabledWarning, dfsTable=dfsTable, syslogControlGroup=syslogControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableEntry=dfsTableEntry, dfsMeans=dfsMeans, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPSPortNumber=hTTPSPortNumber, sNMPCommunityString=sNMPCommunityString, ptp500=ptp500, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTable=sNMPTrapTable, phyStatus=phyStatus, userTableNumber=userTableNumber, telnetPortNumber=telnetPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANManagementVID=vLANManagementVID, capacityLicenseMismatch=capacityLicenseMismatch, gatewayIPAddress=gatewayIPAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableIndex=userTableIndex, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTraps=ptpTraps, sNTPState=sNTPState, wirelessLinkAvailability=wirelessLinkAvailability, tFTPServerPortNumber=tFTPServerPortNumber, reset=reset, syslogClient=syslogClient, managementGroup=managementGroup, encryptionGroup=encryptionGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp=ptp, sNTPServerIPAddress=sNTPServerIPAddress, alarmsGroup=alarmsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoNegotiation=dataPortAutoNegotiation, systemReset=systemReset, maximumTransmitPower=maximumTransmitPower, bootVersion=bootVersion, groupID=groupID)
