...
Unsigned32, IpAddress, Integer32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, ObjectIdentity, ModuleIdentity, Counter64, MibIdentifier, iso, Bits, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Integer32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Counter64", "MibIdentifier", "iso", "Bits", "TimeTicks", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogClient=syslogClient, secondarySoftwareVersion=secondarySoftwareVersion, PYSNMP_MODULE_ID=cambium, timeZone=timeZone, altitude=altitude, ethernet=ethernet, userTable=userTable, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, latitude=latitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogClientTrap=syslogClientTrap, linkModeOptimisation=linkModeOptimisation, ptpTrapPrefix=ptpTrapPrefix, management=management, incompatibleRegionCodes=incompatibleRegionCodes, userPassword=userPassword, range=range, sMTPEmailAlert=sMTPEmailAlert, sMTPEnabledMessages=sMTPEnabledMessages, telecomsCableLength=telecomsCableLength, transmitDataRate=transmitDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, maximumTransmitPower=maximumTransmitPower, telnetPortNumber=telnetPortNumber, licensedCapacity=licensedCapacity, telecomsChannelStatus=telecomsChannelStatus, daylightSaving=daylightSaving, phyControl=phyControl, targetMACAddress=targetMACAddress, channelChangeTrap=channelChangeTrap, aggregateDataRate=aggregateDataRate, bandwidthVariant=bandwidthVariant, productName=productName, dfsTableEntry=dfsTableEntry, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPServerIPAddress=sMTPServerIPAddress, phyControlGroup=phyControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, installStatus=installStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, vectorError=vectorError, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPPollInterval=sNTPPollInterval, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, phyStatusGroup=phyStatusGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveChannel=receiveChannel, alarmsGroup=alarmsGroup, phyStatus=phyStatus, sNTPLastSync=sNTPLastSync, receiveFreqKHz=receiveFreqKHz, receiveDataRate=receiveDataRate, telecomGroup=telecomGroup, managementGroup=managementGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtp=smtp, accessMethod=accessMethod, notificationsGroup=notificationsGroup, userTableNumber=userTableNumber, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, ptpCompliance=ptpCompliance, encryption=encryption, systemClock=systemClock, wirelessLinkAvailability=wirelessLinkAvailability, aAAControlGroup=aAAControlGroup, supplementaryGroup=supplementaryGroup, encryptionAlgorithm=encryptionAlgorithm, dfsMeans=dfsMeans, tFTPServerPortNumber=tFTPServerPortNumber, dfsTable=dfsTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortStatus=dataPortStatus, ethernetGroup=ethernetGroup, sNTPSyncTrap=sNTPSyncTrap, ptpTraps=ptpTraps, userTableEntry=userTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, reset=reset, productVariant=productVariant, telecomsChannelStatusTrap=telecomsChannelStatusTrap, iPAddress=iPAddress, tDDControlGroup=tDDControlGroup, resetGroup=resetGroup, syslogControlGroup=syslogControlGroup, supplementary=supplementary, ptpGroups=ptpGroups, transmitModulationMode=transmitModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, frequencyVariant=frequencyVariant, bootVersion=bootVersion, groupID=groupID, antennaGain=antennaGain, eIRP=eIRP, ptp=ptp, versions=versions, dataPortAutoNegotiation=dataPortAutoNegotiation, userName=userName, telecomsLoopbackTrap=telecomsLoopbackTrap, licence=licence, telecomsLineCode=telecomsLineCode, ptp500=ptp500, sNMPv3Enable=sNMPv3Enable, sntp=sntp, transmitPower=transmitPower, receiveModulationMode=receiveModulationMode, sNMPCommunityString=sNMPCommunityString, syslogState=syslogState, signalStrengthRatio=signalStrengthRatio, systemReset=systemReset, sNMPTrapTableNumber=sNMPTrapTableNumber, smtpGroup=smtpGroup, sNMPPortNumber=sNMPPortNumber, telecomsInterface=telecomsInterface, hardwareVersion=hardwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, cableLoss=cableLoss, encryptionGroup=encryptionGroup, pubStats=pubStats, constantPowerSpectralDensity=constantPowerSpectralDensity, remoteIPAddress=remoteIPAddress, installArmState=installArmState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsTableIndex=dfsTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableIndex=userTableIndex, linkSymmetry=linkSymmetry, longitude=longitude, pubStatsGroup=pubStatsGroup, tFTPServerIPAddress=tFTPServerIPAddress, installStatusTrap=installStatusTrap, installArmStateTrap=installArmStateTrap, dfs=dfs, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, regionCode=regionCode, telnetAccessEnabled=telnetAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecom=telecom, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, transmitFreqKHz=transmitFreqKHz, syslogStateTrap=syslogStateTrap, configurationGroup=configurationGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPSPortNumber=hTTPSPortNumber, syslogControl=syslogControl, unitOutOfCalibration=unitOutOfCalibration, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receivePower=receivePower, transmitChannel=transmitChannel, ptmp=ptmp, receiveFreqMHz=receiveFreqMHz, dataPortStatusTrap=dataPortStatusTrap, regionCodeTrap=regionCodeTrap, licenceGroup=licenceGroup, siteName=siteName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, snmpControlGroup=snmpControlGroup, sNTPSync=sNTPSync, sNMPEnabledTraps=sNMPEnabledTraps, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANManagementVID=vLANManagementVID, hTTPAccessEnabled=hTTPAccessEnabled, vLANPriorityTableEntry=vLANPriorityTableEntry, channelBandwidth=channelBandwidth, tDDSynchronizationStatus=tDDSynchronizationStatus, linkName=linkName, vLANPriorityTable=vLANPriorityTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapVersion=sNMPTrapVersion, versionsGroup=versionsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, byteErrorRatio=byteErrorRatio, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDControl=tDDControl, vLANPriorityTableNumber=vLANPriorityTableNumber, snmpControl=snmpControl, dfsTableNumber=dfsTableNumber, telecomsLoopback=telecomsLoopback, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, subnetMask=subnetMask, alarms=alarms, softwareVersion=softwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsGroup=dfsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, searchState=searchState, vLANPriorityQueueMapping=vLANPriorityQueueMapping, configuration=configuration, userRole=userRole, sntpGroup=sntpGroup, dataPortAutoMdix=dataPortAutoMdix, userEnabled=userEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPState=sNTPState, masterSlaveMode=masterSlaveMode, hTTPPortNumber=hTTPPortNumber, linkLoss=linkLoss, vLANManagementPriority=vLANManagementPriority, dfsPeaks=dfsPeaks, capacityLicenseMismatch=capacityLicenseMismatch, aAAControl=aAAControl)
