...
Bits, ModuleIdentity, NotificationType, Counter32, TimeTicks, Unsigned32, MibIdentifier, IpAddress, enterprises, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "NotificationType", "Counter32", "TimeTicks", "Unsigned32", "MibIdentifier", "IpAddress", "enterprises", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", frequencyVariant=frequencyVariant, managementGroup=managementGroup, cableLoss=cableLoss, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailable=noWirelessChannelAvailable, sntp=sntp, sNTPSyncTrap=sNTPSyncTrap, snmpControl=snmpControl, userName=userName, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveFreqMHz=receiveFreqMHz, vLANPriorityTableNumber=vLANPriorityTableNumber, sMTPServerIPAddress=sMTPServerIPAddress, versionsGroup=versionsGroup, dfsGroup=dfsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsPeaks=dfsPeaks, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptp=ptp, sNTPSync=sNTPSync, encryptionGroup=encryptionGroup, byteErrorRatio=byteErrorRatio, dataPortAutoMdix=dataPortAutoMdix, transmitChannel=transmitChannel, ethernet=ethernet, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, management=management, userTableIndex=userTableIndex, sNMPTrapVersion=sNMPTrapVersion, accessMethod=accessMethod, receiveChannel=receiveChannel, telecom=telecom, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, hTTPPortNumber=hTTPPortNumber, maximumTransmitPower=maximumTransmitPower, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, encryption=encryption, dfsTableEntry=dfsTableEntry, channelChangeTrap=channelChangeTrap, pubStatsGroup=pubStatsGroup, transmitFreqKHz=transmitFreqKHz, vectorError=vectorError, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANPriorityTable=vLANPriorityTable, latitude=latitude, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, capacityLicenseMismatch=capacityLicenseMismatch, cambium=cambium, antennaGain=antennaGain, ethernetGroup=ethernetGroup, pubStats=pubStats, ptpTrapPrefix=ptpTrapPrefix, bootVersion=bootVersion, syslogState=syslogState, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANPriorityTableIndex=vLANPriorityTableIndex, regionCodeTrap=regionCodeTrap, smtp=smtp, ethernetFiberSupport=ethernetFiberSupport, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, dfs=dfs, siteName=siteName, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomGroup=telecomGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, productVariant=productVariant, sNTPServerPortNumber=sNTPServerPortNumber, timeZone=timeZone, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPState=sNTPState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, masterSlaveMode=masterSlaveMode, resetGroup=resetGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, range=range, aAAControl=aAAControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, wirelessLinkAvailability=wirelessLinkAvailability, telecomsInterface=telecomsInterface, hTTPSAccessEnabled=hTTPSAccessEnabled, linkName=linkName, userEnabled=userEnabled, systemClock=systemClock, versions=versions, receivePower=receivePower, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarning=dataPortDisabledWarning, userPassword=userPassword, sNMPEnabledTraps=sNMPEnabledTraps, ptpGroups=ptpGroups, licence=licence, hardwareVersion=hardwareVersion, sNMPCommunityString=sNMPCommunityString, linkModeOptimisation=linkModeOptimisation, gatewayIPAddress=gatewayIPAddress, ptmp=ptmp, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPEmailAlert=sMTPEmailAlert, userRole=userRole, aAAControlGroup=aAAControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapTable=sNMPTrapTable, supplementaryGroup=supplementaryGroup, signalStrengthRatio=signalStrengthRatio, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTableNumber=dfsTableNumber, configuration=configuration, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPEnabledMessages=sMTPEnabledMessages, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenceGroup=licenceGroup, alarms=alarms, dataPortStatusTrap=dataPortStatusTrap, softwareVersion=softwareVersion, linkSymmetry=linkSymmetry, ptpCompliance=ptpCompliance, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, secondarySoftwareVersion=secondarySoftwareVersion, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortStatus=dataPortStatus, configurationGroup=configurationGroup, receiveModulationMode=receiveModulationMode, aggregateDataRate=aggregateDataRate, receiveModulationModeDetail=receiveModulationModeDetail, PYSNMP_MODULE_ID=cambium, bandwidthVariant=bandwidthVariant, sNMPv3Enable=sNMPv3Enable, installStatus=installStatus, hTTPAccessEnabled=hTTPAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyStatus=phyStatus, tDDControl=tDDControl, installArmStateTrap=installArmStateTrap, vLANManagementPriority=vLANManagementPriority, altitude=altitude, telecomsCableLength=telecomsCableLength, telecomsChannelStatus=telecomsChannelStatus, eIRP=eIRP, productName=productName, iPAddress=iPAddress, telecomsLoopback=telecomsLoopback, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogStateTrap=syslogStateTrap, syslogControl=syslogControl, searchState=searchState, telecomsLineCode=telecomsLineCode, regionCode=regionCode, sNTPLastSync=sNTPLastSync, notificationsGroup=notificationsGroup, subnetMask=subnetMask, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, linkLoss=linkLoss, phyStatusGroup=phyStatusGroup, sNMPPortNumber=sNMPPortNumber, longitude=longitude, sNTPServerIPAddress=sNTPServerIPAddress, transmitFreqMHz=transmitFreqMHz, ptp500=ptp500, telnetAccessEnabled=telnetAccessEnabled, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, daylightSaving=daylightSaving, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerPortNumber=tFTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, phyControl=phyControl, groupID=groupID, supplementary=supplementary, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTable=userTable, phyControlGroup=phyControlGroup, telnetPortNumber=telnetPortNumber, receiveFreqKHz=receiveFreqKHz, sNTPPollInterval=sNTPPollInterval, syslogClient=syslogClient, tDDControlGroup=tDDControlGroup, smtpGroup=smtpGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteIPAddress=remoteIPAddress, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, sntpGroup=sntpGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogClientTrap=syslogClientTrap, userTableNumber=userTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitPower=transmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alarmsGroup=alarmsGroup, dfsTable=dfsTable, dfsMeans=dfsMeans, installArmState=installArmState, syslogControlGroup=syslogControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installStatusTrap=installStatusTrap, dfsTableIndex=dfsTableIndex)
