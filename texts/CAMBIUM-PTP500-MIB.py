...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryptionGroup=encryptionGroup, userTable=userTable, dfsPeaks=dfsPeaks, sNMPTrapTableNumber=sNMPTrapTableNumber, capacityLicenseMismatch=capacityLicenseMismatch, sMTPEnabledMessages=sMTPEnabledMessages, unitOutOfCalibration=unitOutOfCalibration, transmitFreqKHz=transmitFreqKHz, altitude=altitude, sNTPLastSync=sNTPLastSync, installArmStateTrap=installArmStateTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, aAAControl=aAAControl, ethernet=ethernet, regionCode=regionCode, ptpTraps=ptpTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogState=syslogState, transmitModulationMode=transmitModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecom=telecom, aggregateDataRate=aggregateDataRate, tDDControl=tDDControl, telecomsChannelStatus=telecomsChannelStatus, receiveFreqMHz=receiveFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsLoopbackTrap=telecomsLoopbackTrap, regionCodeTrap=regionCodeTrap, dfsTableIndex=dfsTableIndex, phyControl=phyControl, dfsMeans=dfsMeans, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, userName=userName, sNTPServerPortNumber=sNTPServerPortNumber, dfsGroup=dfsGroup, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aAAControlGroup=aAAControlGroup, telecomsCableLength=telecomsCableLength, supplementaryGroup=supplementaryGroup, transmitPower=transmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemReset=systemReset, ptpCompliance=ptpCompliance, resetGroup=resetGroup, siteName=siteName, ptpTrapPrefix=ptpTrapPrefix, encryption=encryption, dfsTable=dfsTable, snmpControl=snmpControl, hTTPAccessEnabled=hTTPAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, hTTPSPortNumber=hTTPSPortNumber, byteErrorRatio=byteErrorRatio, licence=licence, transmitDataRate=transmitDataRate, syslogControlGroup=syslogControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsTableEntry=dfsTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDControlGroup=tDDControlGroup, hTTPPortNumber=hTTPPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, vLANPriorityTableIndex=vLANPriorityTableIndex, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerPortNumber=tFTPServerPortNumber, eIRP=eIRP, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsLineCode=telecomsLineCode, syslogStateTrap=syslogStateTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkSymmetry=linkSymmetry, searchState=searchState, sNTPServerIPAddress=sNTPServerIPAddress, licensedCapacity=licensedCapacity, transmitFreqMHz=transmitFreqMHz, timeZone=timeZone, telecomsLoopback=telecomsLoopback, versions=versions, management=management, antennaGain=antennaGain, cableLoss=cableLoss, encryptionAlgorithm=encryptionAlgorithm, ethernetGroup=ethernetGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installStatusTrap=installStatusTrap, userRole=userRole, ptmp=ptmp, bandwidthVariant=bandwidthVariant, iPAddress=iPAddress, phyStatus=phyStatus, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityTable=vLANPriorityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemClock=systemClock, frequencyVariant=frequencyVariant, configurationGroup=configurationGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetMACAddress=targetMACAddress, sNMPPortNumber=sNMPPortNumber, vLANManagementVID=vLANManagementVID, subnetMask=subnetMask, hardwareVersion=hardwareVersion, remoteIPAddress=remoteIPAddress, dfs=dfs, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, smtp=smtp, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClient=syslogClient, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, productVariant=productVariant, maximumTransmitPower=maximumTransmitPower, sntpGroup=sntpGroup, userTableEntry=userTableEntry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, channelChangeTrap=channelChangeTrap, configuration=configuration, gatewayIPAddress=gatewayIPAddress, telnetAccessEnabled=telnetAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, accessMethod=accessMethod, dfsTableNumber=dfsTableNumber, phyStatusGroup=phyStatusGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, sNTPState=sNTPState, sNMPTrapVersion=sNMPTrapVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkName=linkName, receiveFreqKHz=receiveFreqKHz, transmitChannel=transmitChannel, dataPortStatus=dataPortStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPEnabledTraps=sNMPEnabledTraps, dataPortWirelessDownAlert=dataPortWirelessDownAlert, snmpControlGroup=snmpControlGroup, range=range, latitude=latitude, licenceGroup=licenceGroup, productName=productName, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortStatusTrap=dataPortStatusTrap, ptpGroups=ptpGroups, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, longitude=longitude, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, daylightSaving=daylightSaving, pubStatsGroup=pubStatsGroup, supplementary=supplementary, sNTPPollInterval=sNTPPollInterval, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodes=incompatibleRegionCodes, notificationsGroup=notificationsGroup, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableIndex=userTableIndex, sMTPEmailAlert=sMTPEmailAlert, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, alarmsGroup=alarmsGroup, ptp=ptp, reset=reset, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogClientTrap=syslogClientTrap, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsChannelStatusTrap=telecomsChannelStatusTrap, installStatus=installStatus, syslogControl=syslogControl, userTableNumber=userTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, receiveModulationModeDetail=receiveModulationModeDetail, sNMPv3Enable=sNMPv3Enable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, cambium=cambium, sntp=sntp, alarms=alarms, sNTPSync=sNTPSync, linkLoss=linkLoss, userPassword=userPassword, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveDataRate=receiveDataRate, vLANManagementPriority=vLANManagementPriority, vectorError=vectorError, sNTPSyncTrap=sNTPSyncTrap, PYSNMP_MODULE_ID=cambium, groupID=groupID, telecomsInterface=telecomsInterface, signalStrengthRatio=signalStrengthRatio, sNMPTrapTable=sNMPTrapTable, userEnabled=userEnabled, versionsGroup=versionsGroup, managementGroup=managementGroup, phyControlGroup=phyControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, bootVersion=bootVersion, receiveChannel=receiveChannel, wirelessLinkAvailability=wirelessLinkAvailability, smtpGroup=smtpGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, ptp500=ptp500, telecomGroup=telecomGroup, pubStats=pubStats, tDDSynchronizationStatus=tDDSynchronizationStatus, channelBandwidth=channelBandwidth)
