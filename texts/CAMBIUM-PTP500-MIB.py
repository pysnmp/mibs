...
# ASN.1 source file:///home/runner/work/mibs/mibs/src/vendor/cambium/300/CAMBIUM-PTP500-MIB
# Produced by pysmi-1.1.8 at Thu Jan 13 22:45:55 2022
...
ModuleIdentity, enterprises, Unsigned32, ObjectIdentity, NotificationType, IpAddress, iso, MibIdentifier, Bits, Counter32, Counter64, TimeTicks, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "Unsigned32", "ObjectIdentity", "NotificationType", "IpAddress", "iso", "MibIdentifier", "Bits", "Counter32", "Counter64", "TimeTicks", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", phyControlGroup=phyControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, syslogState=syslogState, pubStats=pubStats, supplementary=supplementary, dataPortStatus=dataPortStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, ptpTraps=ptpTraps, constantPowerSpectralDensity=constantPowerSpectralDensity, linkName=linkName, vLANPriorityTableNumber=vLANPriorityTableNumber, aggregateDataRate=aggregateDataRate, cambium=cambium, receiveFreqMHz=receiveFreqMHz, receiveModulationMode=receiveModulationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, hTTPSPortNumber=hTTPSPortNumber, dfsMeans=dfsMeans, transmitFreqKHz=transmitFreqKHz, snmpControlGroup=snmpControlGroup, transmitPower=transmitPower, productVariant=productVariant, sNTPLastSync=sNTPLastSync, receiveModulationModeDetail=receiveModulationModeDetail, timeZone=timeZone, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPPollInterval=sNTPPollInterval, encryptionGroup=encryptionGroup, smtp=smtp, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPState=sNTPState, aAAControl=aAAControl, dfsTableIndex=dfsTableIndex, vLANManagementPriority=vLANManagementPriority, remoteIPAddress=remoteIPAddress, syslogControlGroup=syslogControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, licenceGroup=licenceGroup, hTTPPortNumber=hTTPPortNumber, reset=reset, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, ethernetGroup=ethernetGroup, sntpGroup=sntpGroup, versions=versions, cableLoss=cableLoss, management=management, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPSAccessEnabled=hTTPSAccessEnabled, phyControl=phyControl, dataPortDisabledWarning=dataPortDisabledWarning, supplementaryGroup=supplementaryGroup, maximumTransmitPower=maximumTransmitPower, targetMACAddress=targetMACAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, latitude=latitude, dataPortWirelessDownAlert=dataPortWirelessDownAlert, resetGroup=resetGroup, regionCode=regionCode, sNMPv3Enable=sNMPv3Enable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogControl=syslogControl, ptpGroups=ptpGroups, dfsTableEntry=dfsTableEntry, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityTable=vLANPriorityTable, systemClock=systemClock, subnetMask=subnetMask, vLANManagementVID=vLANManagementVID, sMTPServerPortNumber=sMTPServerPortNumber, installStatusTrap=installStatusTrap, dfsPeaks=dfsPeaks, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelStatusTrap=telecomsChannelStatusTrap, hardwareVersion=hardwareVersion, sMTPEmailAlert=sMTPEmailAlert, telecom=telecom, range=range, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDControl=tDDControl, searchState=searchState, frequencyVariant=frequencyVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, regionCodeTrap=regionCodeTrap, wirelessLinkStatus=wirelessLinkStatus, tFTPServerIPAddress=tFTPServerIPAddress, installArmStateTrap=installArmStateTrap, snmpControl=snmpControl, sNTPSyncTrap=sNTPSyncTrap, syslogStateTrap=syslogStateTrap, vectorError=vectorError, licence=licence, telecomGroup=telecomGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPPortNumber=sNMPPortNumber, ptmp=ptmp, iPAddress=iPAddress, sNTPSync=sNTPSync, secondarySoftwareVersion=secondarySoftwareVersion, alarms=alarms, masterSlaveMode=masterSlaveMode, linkLoss=linkLoss, bandwidthVariant=bandwidthVariant, userTable=userTable, transmitFreqMHz=transmitFreqMHz, telecomsLoopback=telecomsLoopback, telecomsCableLength=telecomsCableLength, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTableEntry=userTableEntry, telecomsInterface=telecomsInterface, ptp=ptp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitChannel=transmitChannel, telnetPortNumber=telnetPortNumber, linkSymmetry=linkSymmetry, noWirelessChannelAvailable=noWirelessChannelAvailable, wirelessLinkAvailability=wirelessLinkAvailability, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, smtpGroup=smtpGroup, dfsGroup=dfsGroup, hTTPAccessEnabled=hTTPAccessEnabled, capacityLicenseMismatch=capacityLicenseMismatch, daylightSaving=daylightSaving, transmitDataRate=transmitDataRate, userTableNumber=userTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveDataRate=receiveDataRate, byteErrorRatio=byteErrorRatio, phyStatusGroup=phyStatusGroup, dfsTableNumber=dfsTableNumber, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibration=unitOutOfCalibration, dfs=dfs, productName=productName, sNMPCommunityString=sNMPCommunityString, altitude=altitude, softwareVersion=softwareVersion, enabledDiagnosticAlarms=enabledDiagnosticAlarms, phyStatus=phyStatus, installStatus=installStatus, syslogClientTrap=syslogClientTrap, sNTPServerPortNumber=sNTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsLineCode=telecomsLineCode, ptp500=ptp500, gatewayIPAddress=gatewayIPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, configuration=configuration, linkModeOptimisation=linkModeOptimisation, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitModulationMode=transmitModulationMode, userEnabled=userEnabled, dfsTable=dfsTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userPassword=userPassword, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, licensedCapacity=licensedCapacity, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userRole=userRole, sntp=sntp, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, siteName=siteName, systemReset=systemReset, tFTPServerPortNumber=tFTPServerPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpCompliance=ptpCompliance, signalStrengthRatio=signalStrengthRatio, encryption=encryption, managementGroup=managementGroup, sNMPTrapVersion=sNMPTrapVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableIndex=userTableIndex, receiveChannel=receiveChannel, PYSNMP_MODULE_ID=cambium, dataPortAutoMdix=dataPortAutoMdix, ethernet=ethernet, groupID=groupID, telnetAccessEnabled=telnetAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, eIRP=eIRP, sMTPEnabledMessages=sMTPEnabledMessages, configurationGroup=configurationGroup, longitude=longitude, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ethernetFiberSupport=ethernetFiberSupport, sNTPServerIPAddress=sNTPServerIPAddress, versionsGroup=versionsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, channelBandwidth=channelBandwidth, syslogClient=syslogClient, dataPortConfigurationMismatch=dataPortConfigurationMismatch, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alarmsGroup=alarmsGroup, receivePower=receivePower, tDDControlGroup=tDDControlGroup, installArmState=installArmState, receiveFreqKHz=receiveFreqKHz, sNMPTrapIPAddress=sNMPTrapIPAddress)
