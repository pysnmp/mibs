...
Counter64, ModuleIdentity, Integer32, ObjectIdentity, Bits, Counter32, Unsigned32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, IpAddress, iso, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "Integer32", "ObjectIdentity", "Bits", "Counter32", "Unsigned32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "IpAddress", "iso", "NotificationType", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogClient=syslogClient, timeZone=timeZone, pubStats=pubStats, smtp=smtp, phyControlGroup=phyControlGroup, receiveChannel=receiveChannel, transmitFreqKHz=transmitFreqKHz, receiveDataRate=receiveDataRate, receiveFreqKHz=receiveFreqKHz, userPassword=userPassword, configuration=configuration, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPv3Enable=sNMPv3Enable, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, receivePower=receivePower, sNMPTrapTable=sNMPTrapTable, receiveFreqMHz=receiveFreqMHz, supplementary=supplementary, channelBandwidth=channelBandwidth, wirelessLinkAvailability=wirelessLinkAvailability, altitude=altitude, resetGroup=resetGroup, dfsPeaks=dfsPeaks, reset=reset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPServerPortNumber=sMTPServerPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configurationGroup=configurationGroup, dataPortStatusTrap=dataPortStatusTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, smtpGroup=smtpGroup, phyStatus=phyStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, licensedCapacity=licensedCapacity, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPServerPortNumber=sNTPServerPortNumber, dfsGroup=dfsGroup, transmitFreqMHz=transmitFreqMHz, sNTPLastSync=sNTPLastSync, tDDControl=tDDControl, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogControl=syslogControl, wirelessLinkStatus=wirelessLinkStatus, cambium=cambium, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, masterSlaveMode=masterSlaveMode, transmitPower=transmitPower, ptp500=ptp500, unitOutOfCalibration=unitOutOfCalibration, receiveModulationModeDetail=receiveModulationModeDetail, phyStatusGroup=phyStatusGroup, productName=productName, installArmState=installArmState, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPSyncTrap=sNTPSyncTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfs=dfs, PYSNMP_MODULE_ID=cambium, telecomsCableLength=telecomsCableLength, searchState=searchState, antennaGain=antennaGain, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptp=ptp, bandwidthVariant=bandwidthVariant, encryption=encryption, frequencyVariant=frequencyVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitChannel=transmitChannel, userTable=userTable, telnetAccessEnabled=telnetAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, vectorError=vectorError, telecomGroup=telecomGroup, byteErrorRatio=byteErrorRatio, versionsGroup=versionsGroup, ptmp=ptmp, ethernetFiberSupport=ethernetFiberSupport, groupID=groupID, linkLoss=linkLoss, transmitModulationMode=transmitModulationMode, installStatusTrap=installStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogClientTrap=syslogClientTrap, alarms=alarms, alarmsGroup=alarmsGroup, pubStatsGroup=pubStatsGroup, sNTPState=sNTPState, userEnabled=userEnabled, sNMPTrapVersion=sNMPTrapVersion, userTableNumber=userTableNumber, ptpCompliance=ptpCompliance, syslogState=syslogState, dfsMeans=dfsMeans, sntpGroup=sntpGroup, sMTPEmailAlert=sMTPEmailAlert, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANManagementPriority=vLANManagementPriority, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelStatus=telecomsChannelStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productVariant=productVariant, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPPortNumber=hTTPPortNumber, encryptionAlgorithm=encryptionAlgorithm, sNTPSync=sNTPSync, maximumTransmitPower=maximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, capacityLicenseMismatch=capacityLicenseMismatch, receiveModulationMode=receiveModulationMode, userRole=userRole, vLANPriorityQueueMapping=vLANPriorityQueueMapping, remoteIPAddress=remoteIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, secondarySoftwareVersion=secondarySoftwareVersion, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, snmpControl=snmpControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogControlGroup=syslogControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, gatewayIPAddress=gatewayIPAddress, aAAControl=aAAControl, managementGroup=managementGroup, bootVersion=bootVersion, phyControl=phyControl, telecomsLoopback=telecomsLoopback, dataPortStatus=dataPortStatus, management=management, dfsTable=dfsTable, dfsTableIndex=dfsTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkName=linkName, vLANPriorityTable=vLANPriorityTable, ethernetGroup=ethernetGroup, siteName=siteName, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsChannelStatusTrap=telecomsChannelStatusTrap, installArmStateTrap=installArmStateTrap, dfsTableEntry=dfsTableEntry, supplementaryGroup=supplementaryGroup, sNMPPortNumber=sNMPPortNumber, sNMPCommunityString=sNMPCommunityString, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, snmpControlGroup=snmpControlGroup, ptpGroups=ptpGroups, telnetPortNumber=telnetPortNumber, dfsTableNumber=dfsTableNumber, licence=licence, ethernet=ethernet, accessMethod=accessMethod, tDDControlGroup=tDDControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, regionCode=regionCode, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimisation=linkModeOptimisation, telecom=telecom, vLANPriorityTableIndex=vLANPriorityTableIndex, linkSymmetry=linkSymmetry, sntp=sntp, range=range, daylightSaving=daylightSaving, systemClock=systemClock, licenceGroup=licenceGroup, transmitDataRate=transmitDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, systemReset=systemReset, cableLoss=cableLoss, incompatibleRegionCodes=incompatibleRegionCodes, sNTPPollInterval=sNTPPollInterval, notificationsGroup=notificationsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, subnetMask=subnetMask, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, versions=versions, iPAddress=iPAddress, syslogStateTrap=syslogStateTrap, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, longitude=longitude, latitude=latitude, installStatus=installStatus, dataPortDisabledWarning=dataPortDisabledWarning, userName=userName, vLANPriorityTableNumber=vLANPriorityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableIndex=userTableIndex, channelChangeTrap=channelChangeTrap, dataPortAutoMdix=dataPortAutoMdix, telecomsLineCode=telecomsLineCode, eIRP=eIRP, aggregateDataRate=aggregateDataRate, telecomsInterface=telecomsInterface, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionGroup=encryptionGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, aAAControlGroup=aAAControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, softwareVersion=softwareVersion, sNMPEnabledTraps=sNMPEnabledTraps)
