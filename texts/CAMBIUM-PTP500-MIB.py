...
Integer32, Unsigned32, Counter64, TimeTicks, IpAddress, ModuleIdentity, enterprises, Bits, ObjectIdentity, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter64", "TimeTicks", "IpAddress", "ModuleIdentity", "enterprises", "Bits", "ObjectIdentity", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsPeaks=dfsPeaks, dfsTableNumber=dfsTableNumber, antennaGain=antennaGain, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsInterface=telecomsInterface, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, range=range, ptmp=ptmp, userTableIndex=userTableIndex, transmitDataRate=transmitDataRate, configuration=configuration, alarmsGroup=alarmsGroup, licensedCapacity=licensedCapacity, regionCode=regionCode, notificationsGroup=notificationsGroup, maximumTransmitPower=maximumTransmitPower, dfsTableIndex=dfsTableIndex, licenceGroup=licenceGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogStateTrap=syslogStateTrap, telnetAccessEnabled=telnetAccessEnabled, managementGroup=managementGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyStatus=phyStatus, tDDControl=tDDControl, resetGroup=resetGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, siteName=siteName, signalStrengthRatio=signalStrengthRatio, daylightSaving=daylightSaving, subnetMask=subnetMask, sNTPServerIPAddress=sNTPServerIPAddress, hTTPPortNumber=hTTPPortNumber, ptpCompliance=ptpCompliance, supplementary=supplementary, softwareVersion=softwareVersion, phyControl=phyControl, targetMACAddress=targetMACAddress, receiveFreqMHz=receiveFreqMHz, timeZone=timeZone, aAAControl=aAAControl, installStatusTrap=installStatusTrap, telecomsChannelStatus=telecomsChannelStatus, telecomGroup=telecomGroup, incompatibleRegionCodes=incompatibleRegionCodes, PYSNMP_MODULE_ID=cambium, vLANManagementPriority=vLANManagementPriority, encryption=encryption, phyControlGroup=phyControlGroup, sNTPState=sNTPState, searchState=searchState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPLastSync=sNTPLastSync, ethernetGroup=ethernetGroup, transmitFreqMHz=transmitFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTableEntry=vLANPriorityTableEntry, installArmState=installArmState, sNMPTrapTableEntry=sNMPTrapTableEntry, snmpControlGroup=snmpControlGroup, sNMPv3Enable=sNMPv3Enable, pubStats=pubStats, linkSymmetry=linkSymmetry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkModeOptimisation=linkModeOptimisation, phyStatusGroup=phyStatusGroup, dfsTable=dfsTable, sNTPSync=sNTPSync, encryptionGroup=encryptionGroup, hardwareVersion=hardwareVersion, userEnabled=userEnabled, receiveModulationMode=receiveModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, installArmStateTrap=installArmStateTrap, cableLoss=cableLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, hTTPSAccessEnabled=hTTPSAccessEnabled, vectorError=vectorError, versions=versions, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsMeans=dfsMeans, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bootVersion=bootVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, dataPortDisabledWarning=dataPortDisabledWarning, telecom=telecom, dfsTableEntry=dfsTableEntry, sMTPServerPortNumber=sMTPServerPortNumber, linkName=linkName, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveChannel=receiveChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPPortNumber=sNMPPortNumber, syslogClientTrap=syslogClientTrap, syslogControl=syslogControl, ethernetFiberSupport=ethernetFiberSupport, regionCodeTrap=regionCodeTrap, dfsGroup=dfsGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, receiveFreqKHz=receiveFreqKHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, capacityLicenseMismatch=capacityLicenseMismatch, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationStatus=tDDSynchronizationStatus, ptp=ptp, syslogLocalWrappedTrap=syslogLocalWrappedTrap, encryptionAlgorithm=encryptionAlgorithm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installStatus=installStatus, remoteIPAddress=remoteIPAddress, transmitPower=transmitPower, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANPriorityTable=vLANPriorityTable, telecomsCableLength=telecomsCableLength, productVariant=productVariant, sNTPServerPortNumber=sNTPServerPortNumber, licence=licence, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, linkLoss=linkLoss, configurationGroup=configurationGroup, telecomsLineCode=telecomsLineCode, tFTPServerIPAddress=tFTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, userTableNumber=userTableNumber, transmitChannel=transmitChannel, vLANPriorityTableNumber=vLANPriorityTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, receiveModulationModeDetail=receiveModulationModeDetail, userPassword=userPassword, accessMethod=accessMethod, dataPortAutoMdix=dataPortAutoMdix, vLANManagementVID=vLANManagementVID, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, cambium=cambium, userTableEntry=userTableEntry, alarms=alarms, tFTPServerPortNumber=tFTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userRole=userRole, wirelessLinkAvailability=wirelessLinkAvailability, snmpControl=snmpControl, groupID=groupID, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, supplementaryGroup=supplementaryGroup, versionsGroup=versionsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, longitude=longitude, iPAddress=iPAddress, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp500=ptp500, tDDSynchronizationMode=tDDSynchronizationMode, syslogClient=syslogClient, noWirelessChannelAvailable=noWirelessChannelAvailable, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, altitude=altitude, sNMPTrapPortNumber=sNMPTrapPortNumber, smtp=smtp, reset=reset, channelBandwidth=channelBandwidth, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPollInterval=sNTPPollInterval, eIRP=eIRP, systemReset=systemReset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapVersion=sNMPTrapVersion, sntpGroup=sntpGroup, receiveDataRate=receiveDataRate, sntp=sntp, frequencyVariant=frequencyVariant, unitOutOfCalibration=unitOutOfCalibration, masterSlaveMode=masterSlaveMode, systemClock=systemClock, telnetPortNumber=telnetPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDControlGroup=tDDControlGroup, aAAControlGroup=aAAControlGroup, syslogState=syslogState, smtpGroup=smtpGroup, hTTPSPortNumber=hTTPSPortNumber, ptpGroups=ptpGroups, telecomsLoopbackTrap=telecomsLoopbackTrap, productName=productName, dataPortStatus=dataPortStatus, telecomsLoopback=telecomsLoopback, latitude=latitude, sNTPSyncTrap=sNTPSyncTrap, ethernet=ethernet, ptpTraps=ptpTraps, sNMPTrapTable=sNMPTrapTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userTable=userTable, dfs=dfs, byteErrorRatio=byteErrorRatio, userName=userName, sNMPCommunityString=sNMPCommunityString, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelChangeTrap=channelChangeTrap, wirelessLinkStatus=wirelessLinkStatus, bandwidthVariant=bandwidthVariant, transmitFreqKHz=transmitFreqKHz, syslogControlGroup=syslogControlGroup)
