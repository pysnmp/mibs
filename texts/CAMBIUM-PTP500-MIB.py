...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsMeans=dfsMeans, sNMPEnabledTraps=sNMPEnabledTraps, telecom=telecom, ptp500=ptp500, dfsTableNumber=dfsTableNumber, sNMPTrapTable=sNMPTrapTable, accessMethod=accessMethod, dataPortConfigurationMismatch=dataPortConfigurationMismatch, aAAControlGroup=aAAControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, bandwidthVariant=bandwidthVariant, transmitChannel=transmitChannel, ptp=ptp, telecomsLoopbackTrap=telecomsLoopbackTrap, pubStats=pubStats, pubStatsGroup=pubStatsGroup, productVariant=productVariant, linkLoss=linkLoss, userEnabled=userEnabled, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntp=sntp, managementGroup=managementGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, versionsGroup=versionsGroup, cambium=cambium, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, frequencyVariant=frequencyVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, siteName=siteName, sNMPTrapTableIndex=sNMPTrapTableIndex, notificationsGroup=notificationsGroup, softwareVersion=softwareVersion, productName=productName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPPortNumber=hTTPPortNumber, userName=userName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, installStatusTrap=installStatusTrap, dataPortAutoMdix=dataPortAutoMdix, hardwareVersion=hardwareVersion, telecomsCableLength=telecomsCableLength, sNMPTrapPortNumber=sNMPTrapPortNumber, userTable=userTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, telecomsChannelStatus=telecomsChannelStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, aggregateDataRate=aggregateDataRate, telnetPortNumber=telnetPortNumber, dfsTableEntry=dfsTableEntry, transmitFreqMHz=transmitFreqMHz, transmitPower=transmitPower, tDDControl=tDDControl, reset=reset, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkSymmetry=linkSymmetry, installStatus=installStatus, linkName=linkName, capacityLicenseMismatch=capacityLicenseMismatch, sMTPEnabledMessages=sMTPEnabledMessages, ptmp=ptmp, vectorError=vectorError, bootVersion=bootVersion, sNTPState=sNTPState, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, sNTPSync=sNTPSync, dfsGroup=dfsGroup, antennaGain=antennaGain, useVLANForManagementInterfaces=useVLANForManagementInterfaces, longitude=longitude, configuration=configuration, dfsTableIndex=dfsTableIndex, groupID=groupID, sNTPSyncTrap=sNTPSyncTrap, alarmsGroup=alarmsGroup, supplementaryGroup=supplementaryGroup, telecomsLoopback=telecomsLoopback, channelChangeTrap=channelChangeTrap, PYSNMP_MODULE_ID=cambium, transmitFreqKHz=transmitFreqKHz, syslogClient=syslogClient, ethernet=ethernet, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, receiveChannel=receiveChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, iPAddress=iPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtpGroup=smtpGroup, regionCodeTrap=regionCodeTrap, encryptionAlgorithm=encryptionAlgorithm, subnetMask=subnetMask, incompatibleMasterAndSlave=incompatibleMasterAndSlave, snmpControl=snmpControl, encryptionGroup=encryptionGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, noWirelessChannelAvailable=noWirelessChannelAvailable, snmpControlGroup=snmpControlGroup, syslogControl=syslogControl, sNMPTrapTableNumber=sNMPTrapTableNumber, licensedCapacity=licensedCapacity, userPassword=userPassword, vLANPriorityQueueMapping=vLANPriorityQueueMapping, phyStatusGroup=phyStatusGroup, telecomsLineCode=telecomsLineCode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, remoteIPAddress=remoteIPAddress, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, telecomGroup=telecomGroup, daylightSaving=daylightSaving, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licence=licence, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmStateTrap=installArmStateTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, installArmState=installArmState, hTTPSPortNumber=hTTPSPortNumber, targetMACAddress=targetMACAddress, sNMPTrapVersion=sNMPTrapVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDControlGroup=tDDControlGroup, receiveModulationModeDetail=receiveModulationModeDetail, configurationGroup=configurationGroup, ptpTrapPrefix=ptpTrapPrefix, transmitDataRate=transmitDataRate, signalStrengthRatio=signalStrengthRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, receiveFreqKHz=receiveFreqKHz, userRole=userRole, smtp=smtp, sNTPPollInterval=sNTPPollInterval, syslogLocalWrappedTrap=syslogLocalWrappedTrap, masterSlaveMode=masterSlaveMode, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogStateTrap=syslogStateTrap, receiveFreqMHz=receiveFreqMHz, wirelessLinkStatus=wirelessLinkStatus, altitude=altitude, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatus=dataPortStatus, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telnetAccessEnabled=telnetAccessEnabled, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfs=dfs, syslogState=syslogState, ptpGroups=ptpGroups, supplementary=supplementary, cableLoss=cableLoss, dfsPeaks=dfsPeaks, alarms=alarms, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsInterface=telecomsInterface, receivePower=receivePower, maximumTransmitPower=maximumTransmitPower, userTableIndex=userTableIndex, searchState=searchState, management=management, vLANManagementVID=vLANManagementVID, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, sntpGroup=sntpGroup, channelBandwidth=channelBandwidth, vLANPriorityTableIndex=vLANPriorityTableIndex, ptpTraps=ptpTraps, regionCode=regionCode, ethernetGroup=ethernetGroup, versions=versions, syslogControlGroup=syslogControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortStatusTrap=dataPortStatusTrap, vLANPriorityTable=vLANPriorityTable, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, transmitModulationMode=transmitModulationMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ethernetFiberSupport=ethernetFiberSupport, gatewayIPAddress=gatewayIPAddress, systemClock=systemClock, userTableNumber=userTableNumber, vLANManagementPriority=vLANManagementPriority, phyControlGroup=phyControlGroup, sMTPServerIPAddress=sMTPServerIPAddress, systemReset=systemReset, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClientTrap=syslogClientTrap, dataPortDisabledWarning=dataPortDisabledWarning, phyControl=phyControl, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, latitude=latitude, resetGroup=resetGroup, sMTPEmailAlert=sMTPEmailAlert, secondarySoftwareVersion=secondarySoftwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, licenceGroup=licenceGroup, phyStatus=phyStatus, sMTPServerPortNumber=sMTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, timeZone=timeZone, eIRP=eIRP, receiveModulationMode=receiveModulationMode, encryption=encryption, range=range, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aAAControl=aAAControl, linkModeOptimisation=linkModeOptimisation, sNTPServerIPAddress=sNTPServerIPAddress)
