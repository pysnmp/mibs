...
Integer32, ObjectIdentity, enterprises, TimeTicks, NotificationType, Bits, iso, Counter32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, MibIdentifier, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ObjectIdentity", "enterprises", "TimeTicks", "NotificationType", "Bits", "iso", "Counter32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "MibIdentifier", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsInterface=telecomsInterface, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelBandwidth=channelBandwidth, tDDSynchronizationStatus=tDDSynchronizationStatus, resetGroup=resetGroup, sNTPState=sNTPState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, masterSlaveMode=masterSlaveMode, phyControlGroup=phyControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsMeans=dfsMeans, accessMethod=accessMethod, latitude=latitude, transmitFreqKHz=transmitFreqKHz, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitPower=transmitPower, timeZone=timeZone, targetMACAddress=targetMACAddress, dfsTableEntry=dfsTableEntry, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, receiveFreqMHz=receiveFreqMHz, ptp=ptp, hTTPSPortNumber=hTTPSPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogStateTrap=syslogStateTrap, bootVersion=bootVersion, pubStatsGroup=pubStatsGroup, groupID=groupID, regionCodeTrap=regionCodeTrap, productVariant=productVariant, licence=licence, sNTPLastSync=sNTPLastSync, daylightSaving=daylightSaving, telecomsLoopbackTrap=telecomsLoopbackTrap, linkSymmetry=linkSymmetry, transmitChannel=transmitChannel, eIRP=eIRP, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableNumber=userTableNumber, syslogClient=syslogClient, userPassword=userPassword, phyStatusGroup=phyStatusGroup, tFTPServerPortNumber=tFTPServerPortNumber, tDDControl=tDDControl, ptpGroups=ptpGroups, wirelessLinkStatus=wirelessLinkStatus, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, installStatus=installStatus, ptpTraps=ptpTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telnetPortNumber=telnetPortNumber, installArmState=installArmState, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, frequencyVariant=frequencyVariant, dataPortAutoMdix=dataPortAutoMdix, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyControl=phyControl, userName=userName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimisation=linkModeOptimisation, longitude=longitude, syslogControlGroup=syslogControlGroup, smtp=smtp, capacityLicenseMismatch=capacityLicenseMismatch, syslogClientTrap=syslogClientTrap, userRole=userRole, maximumTransmitPower=maximumTransmitPower, noWirelessChannelAvailable=noWirelessChannelAvailable, userEnabled=userEnabled, productName=productName, sNMPTrapTableNumber=sNMPTrapTableNumber, supplementary=supplementary, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDControlGroup=tDDControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPSyncTrap=sNTPSyncTrap, cableLoss=cableLoss, dfsTableIndex=dfsTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, management=management, installArmStateTrap=installArmStateTrap, sMTPEmailAlert=sMTPEmailAlert, transmitModulationMode=transmitModulationMode, telecomsLineCode=telecomsLineCode, ptmp=ptmp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegionCodes=incompatibleRegionCodes, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, userTableEntry=userTableEntry, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versionsGroup=versionsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, byteErrorRatio=byteErrorRatio, useVLANForManagementInterfaces=useVLANForManagementInterfaces, phyStatus=phyStatus, sntpGroup=sntpGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControlGroup=aAAControlGroup, supplementaryGroup=supplementaryGroup, searchState=searchState, userTable=userTable, managementGroup=managementGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licenceGroup=licenceGroup, telecomsCableLength=telecomsCableLength, sNTPServerPortNumber=sNTPServerPortNumber, configuration=configuration, vLANManagementVID=vLANManagementVID, licensedCapacity=licensedCapacity, PYSNMP_MODULE_ID=cambium, sntp=sntp, ptpCompliance=ptpCompliance, antennaGain=antennaGain, sNTPSync=sNTPSync, vectorError=vectorError, encryption=encryption, dfsTableNumber=dfsTableNumber, sMTPServerPortNumber=sMTPServerPortNumber, subnetMask=subnetMask, notificationsGroup=notificationsGroup, dataPortDisabledWarning=dataPortDisabledWarning, dataPortStatus=dataPortStatus, altitude=altitude, syslogControl=syslogControl, vLANPriorityTable=vLANPriorityTable, wirelessLinkAvailability=wirelessLinkAvailability, userTableIndex=userTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomGroup=telecomGroup, alarmsGroup=alarmsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, installStatusTrap=installStatusTrap, ethernetFiberSupport=ethernetFiberSupport, sNMPv3Enable=sNMPv3Enable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteIPAddress=remoteIPAddress, linkLoss=linkLoss, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryptionAlgorithm=encryptionAlgorithm, encryptionGroup=encryptionGroup, receiveModulationMode=receiveModulationMode, siteName=siteName, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitFreqMHz=transmitFreqMHz, snmpControl=snmpControl, dataPortStatusTrap=dataPortStatusTrap, ethernetGroup=ethernetGroup, signalStrengthRatio=signalStrengthRatio, cambium=cambium, vLANPriorityTableEntry=vLANPriorityTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveChannel=receiveChannel, sNMPPortNumber=sNMPPortNumber, telecomsLoopback=telecomsLoopback, ptpTrapPrefix=ptpTrapPrefix, syslogState=syslogState, systemClock=systemClock, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, versions=versions, gatewayIPAddress=gatewayIPAddress, iPAddress=iPAddress, telecom=telecom, linkName=linkName, pubStats=pubStats, receivePower=receivePower, sNMPCommunityString=sNMPCommunityString, dfsGroup=dfsGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, aAAControl=aAAControl, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPPollInterval=sNTPPollInterval, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsPeaks=dfsPeaks, aggregateDataRate=aggregateDataRate, configurationGroup=configurationGroup, dfsTable=dfsTable, sMTPServerIPAddress=sMTPServerIPAddress, telecomsChannelStatus=telecomsChannelStatus, receiveDataRate=receiveDataRate, snmpControlGroup=snmpControlGroup, range=range, vLANPriorityQueueMapping=vLANPriorityQueueMapping, unitOutOfCalibration=unitOutOfCalibration, softwareVersion=softwareVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, secondarySoftwareVersion=secondarySoftwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtpGroup=smtpGroup, channelChangeTrap=channelChangeTrap, hTTPAccessEnabled=hTTPAccessEnabled, transmitDataRate=transmitDataRate, receiveModulationModeDetail=receiveModulationModeDetail, vLANPriorityTableNumber=vLANPriorityTableNumber, hardwareVersion=hardwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTable=sNMPTrapTable, reset=reset, bandwidthVariant=bandwidthVariant, dfs=dfs, alarms=alarms, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemReset=systemReset, hTTPPortNumber=hTTPPortNumber, ptp500=ptp500)
