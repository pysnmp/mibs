...
ModuleIdentity, Bits, Counter32, TimeTicks, Counter64, NotificationType, enterprises, ObjectIdentity, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter32", "TimeTicks", "Counter64", "NotificationType", "enterprises", "ObjectIdentity", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsLoopbackTrap=telecomsLoopbackTrap, phyStatusGroup=phyStatusGroup, telecomsCableLength=telecomsCableLength, phyControl=phyControl, dfsMeans=dfsMeans, incompatibleRegionCodes=incompatibleRegionCodes, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmState=installArmState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, groupID=groupID, licence=licence, managementGroup=managementGroup, userPassword=userPassword, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, range=range, telecomGroup=telecomGroup, versionsGroup=versionsGroup, transmitFreqMHz=transmitFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptp500=ptp500, userTable=userTable, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDControlGroup=tDDControlGroup, signalStrengthRatio=signalStrengthRatio, vLANManagementPriority=vLANManagementPriority, telecomsInterface=telecomsInterface, ptp=ptp, sntp=sntp, iPAddress=iPAddress, tFTPServerPortNumber=tFTPServerPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hardwareVersion=hardwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, ethernetGroup=ethernetGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, bandwidthVariant=bandwidthVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPv3Enable=sNMPv3Enable, siteName=siteName, vLANManagementVID=vLANManagementVID, PYSNMP_MODULE_ID=cambium, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, installStatus=installStatus, userEnabled=userEnabled, hTTPAccessEnabled=hTTPAccessEnabled, ptpCompliance=ptpCompliance, syslogStateTrap=syslogStateTrap, ptpGroups=ptpGroups, receiveModulationModeDetail=receiveModulationModeDetail, targetMACAddress=targetMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsLoopback=telecomsLoopback, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userName=userName, linkLoss=linkLoss, ptmp=ptmp, aggregateDataRate=aggregateDataRate, vLANPriorityTable=vLANPriorityTable, snmpControlGroup=snmpControlGroup, cambium=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTable=sNMPTrapTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpTrapPrefix=ptpTrapPrefix, linkModeOptimisation=linkModeOptimisation, dataPortAutoMdix=dataPortAutoMdix, dfs=dfs, accessMethod=accessMethod, receiveFreqKHz=receiveFreqKHz, dataPortAutoNegotiation=dataPortAutoNegotiation, constantPowerSpectralDensity=constantPowerSpectralDensity, gatewayIPAddress=gatewayIPAddress, tDDControl=tDDControl, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogClientTrap=syslogClientTrap, encryptionGroup=encryptionGroup, remoteIPAddress=remoteIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, licensedCapacity=licensedCapacity, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsChannelStatus=telecomsChannelStatus, pubStats=pubStats, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, eIRP=eIRP, hTTPSPortNumber=hTTPSPortNumber, daylightSaving=daylightSaving, secondarySoftwareVersion=secondarySoftwareVersion, telecom=telecom, phyStatus=phyStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, frequencyVariant=frequencyVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPState=sNTPState, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, transmitFreqKHz=transmitFreqKHz, userTableNumber=userTableNumber, sNTPSync=sNTPSync, cableLoss=cableLoss, vectorError=vectorError, timeZone=timeZone, encryption=encryption, systemReset=systemReset, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTableNumber=dfsTableNumber, ethernetFiberSupport=ethernetFiberSupport, dataPortDisabledWarning=dataPortDisabledWarning, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, reset=reset, receiveDataRate=receiveDataRate, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveChannel=receiveChannel, sMTPServerPortNumber=sMTPServerPortNumber, dfsTableEntry=dfsTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPCommunityString=sNMPCommunityString, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitModulationMode=transmitModulationMode, bootVersion=bootVersion, syslogControl=syslogControl, dfsPeaks=dfsPeaks, telnetPortNumber=telnetPortNumber, aAAControl=aAAControl, dfsGroup=dfsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsTable=dfsTable, encryptionAlgorithm=encryptionAlgorithm, altitude=altitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitPower=transmitPower, dataPortStatusTrap=dataPortStatusTrap, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, channelBandwidth=channelBandwidth, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, management=management, linkName=linkName, sntpGroup=sntpGroup, sNMPTrapVersion=sNMPTrapVersion, installArmStateTrap=installArmStateTrap, maximumTransmitPower=maximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, regionCode=regionCode, searchState=searchState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementary=supplementary, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsTableIndex=dfsTableIndex, smtp=smtp, snmpControl=snmpControl, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, productName=productName, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, byteErrorRatio=byteErrorRatio, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, ptpTraps=ptpTraps, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configurationGroup=configurationGroup, alarms=alarms, masterSlaveMode=masterSlaveMode, sMTPEmailAlert=sMTPEmailAlert, supplementaryGroup=supplementaryGroup, notificationsGroup=notificationsGroup, userRole=userRole, systemClock=systemClock, sNMPPortNumber=sNMPPortNumber, transmitDataRate=transmitDataRate, versions=versions, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receivePower=receivePower, syslogClient=syslogClient, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsLineCode=telecomsLineCode, ethernet=ethernet, configuration=configuration, linkSymmetry=linkSymmetry, wirelessLinkStatus=wirelessLinkStatus, syslogState=syslogState, latitude=latitude, sNTPSyncTrap=sNTPSyncTrap, sNMPEnabledTraps=sNMPEnabledTraps, antennaGain=antennaGain, aAAControlGroup=aAAControlGroup, channelChangeTrap=channelChangeTrap, syslogControlGroup=syslogControlGroup, resetGroup=resetGroup, userTableIndex=userTableIndex, subnetMask=subnetMask, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarmsGroup=alarmsGroup, receiveFreqMHz=receiveFreqMHz, installStatusTrap=installStatusTrap, regionCodeTrap=regionCodeTrap, softwareVersion=softwareVersion, dataPortStatus=dataPortStatus, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licenceGroup=licenceGroup, longitude=longitude, sNTPServerPortNumber=sNTPServerPortNumber, transmitChannel=transmitChannel)
