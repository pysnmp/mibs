...
# Produced by pysmi-1.1.3 at Sat Nov 20 22:32:19 2021
...
Integer32, Counter32, Counter64, TimeTicks, Bits, ModuleIdentity, iso, MibIdentifier, Gauge32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Counter64", "TimeTicks", "Bits", "ModuleIdentity", "iso", "MibIdentifier", "Gauge32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapTableEntry=sNMPTrapTableEntry, searchState=searchState, bootVersion=bootVersion, vLANManagementVID=vLANManagementVID, linkName=linkName, telecomsChannelStatus=telecomsChannelStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, antennaGain=antennaGain, subnetMask=subnetMask, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsLineCode=telecomsLineCode, vLANPriorityTableNumber=vLANPriorityTableNumber, management=management, telnetPortNumber=telnetPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, hTTPSPortNumber=hTTPSPortNumber, linkSymmetry=linkSymmetry, vectorError=vectorError, sNMPTrapTableIndex=sNMPTrapTableIndex, reset=reset, dfsTable=dfsTable, transmitFreqMHz=transmitFreqMHz, configurationGroup=configurationGroup, telecom=telecom, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptmp=ptmp, smtp=smtp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, masterSlaveMode=masterSlaveMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogClient=syslogClient, telnetAccessEnabled=telnetAccessEnabled, byteErrorRatio=byteErrorRatio, hTTPPortNumber=hTTPPortNumber, frequencyVariant=frequencyVariant, receivePower=receivePower, phyStatus=phyStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableNumber=userTableNumber, telecomsInterface=telecomsInterface, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPLastSync=sNTPLastSync, encryptionGroup=encryptionGroup, sntpGroup=sntpGroup, linkLoss=linkLoss, tFTPServerIPAddress=tFTPServerIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, transmitPower=transmitPower, daylightSaving=daylightSaving, tDDSynchronizationMode=tDDSynchronizationMode, alarms=alarms, licensedCapacity=licensedCapacity, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableEntry=dfsTableEntry, versionsGroup=versionsGroup, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkStatus=wirelessLinkStatus, sMTPEnabledMessages=sMTPEnabledMessages, hardwareVersion=hardwareVersion, altitude=altitude, alarmsGroup=alarmsGroup, supplementary=supplementary, syslogStateTrap=syslogStateTrap, transmitModulationMode=transmitModulationMode, softwareVersion=softwareVersion, installStatusTrap=installStatusTrap, installArmState=installArmState, ptpTrapPrefix=ptpTrapPrefix, sntp=sntp, dfs=dfs, resetGroup=resetGroup, aAAControl=aAAControl, sNMPv3Enable=sNMPv3Enable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userEnabled=userEnabled, supplementaryGroup=supplementaryGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpCompliance=ptpCompliance, sNTPSyncTrap=sNTPSyncTrap, managementGroup=managementGroup, cableLoss=cableLoss, sNTPServerIPAddress=sNTPServerIPAddress, userTableIndex=userTableIndex, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, gatewayIPAddress=gatewayIPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, pubStatsGroup=pubStatsGroup, sNTPPollInterval=sNTPPollInterval, eIRP=eIRP, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsCableLength=telecomsCableLength, maximumTransmitPower=maximumTransmitPower, receiveDataRate=receiveDataRate, phyStatusGroup=phyStatusGroup, longitude=longitude, latitude=latitude, phyControl=phyControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, snmpControlGroup=snmpControlGroup, productVariant=productVariant, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapPortNumber=sNMPTrapPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDControlGroup=tDDControlGroup, ethernetFiberSupport=ethernetFiberSupport, bandwidthVariant=bandwidthVariant, phyControlGroup=phyControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, channelBandwidth=channelBandwidth, vLANPriorityTable=vLANPriorityTable, telecomsLoopback=telecomsLoopback, installStatus=installStatus, dataPortDisabledWarning=dataPortDisabledWarning, sNMPPortNumber=sNMPPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPTrapTable=sNMPTrapTable, versions=versions, ptpGroups=ptpGroups, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitChannel=transmitChannel, licenceGroup=licenceGroup, tFTPServerPortNumber=tFTPServerPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, sNTPState=sNTPState, accessMethod=accessMethod, channelChangeTrap=channelChangeTrap, PYSNMP_MODULE_ID=cambium, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqKHz=transmitFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPSync=sNTPSync, noWirelessChannelAvailable=noWirelessChannelAvailable, vLANPriorityTableIndex=vLANPriorityTableIndex, aAAControlGroup=aAAControlGroup, ethernet=ethernet, notificationsGroup=notificationsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemReset=systemReset, userName=userName, tDDControl=tDDControl, configuration=configuration, timeZone=timeZone, receiveModulationMode=receiveModulationMode, siteName=siteName, dfsMeans=dfsMeans, encryptionAlgorithm=encryptionAlgorithm, secondarySoftwareVersion=secondarySoftwareVersion, sMTPEmailAlert=sMTPEmailAlert, userTable=userTable, syslogLocalWrappedTrap=syslogLocalWrappedTrap, unitOutOfCalibration=unitOutOfCalibration, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsTableIndex=dfsTableIndex, signalStrengthRatio=signalStrengthRatio, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveFreqMHz=receiveFreqMHz, receiveFreqKHz=receiveFreqKHz, dataPortAutoMdix=dataPortAutoMdix, smtpGroup=smtpGroup, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControl=syslogControl, capacityLicenseMismatch=capacityLicenseMismatch, remoteIPAddress=remoteIPAddress, telecomGroup=telecomGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, cambium=cambium, snmpControl=snmpControl, ethernetGroup=ethernetGroup, syslogState=syslogState, syslogClientTrap=syslogClientTrap, targetMACAddress=targetMACAddress, sNTPServerPortNumber=sNTPServerPortNumber, dataPortStatusTrap=dataPortStatusTrap, groupID=groupID, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPCommunityString=sNMPCommunityString, ptpTraps=ptpTraps, dfsPeaks=dfsPeaks, range=range, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licence=licence, sNMPTrapVersion=sNMPTrapVersion, pubStats=pubStats, encryption=encryption, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPServerIPAddress=sMTPServerIPAddress, userRole=userRole, regionCodeTrap=regionCodeTrap, regionCode=regionCode, vLANManagementPriority=vLANManagementPriority, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptp=ptp, userPassword=userPassword, iPAddress=iPAddress, systemClock=systemClock, userTableEntry=userTableEntry, receiveChannel=receiveChannel, dataPortAutoNegotiation=dataPortAutoNegotiation, productName=productName, dataPortStatus=dataPortStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogControlGroup=syslogControlGroup, transmitDataRate=transmitDataRate, dfsGroup=dfsGroup, ptp500=ptp500)
