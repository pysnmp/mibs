...
Counter32, ObjectIdentity, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Bits, Gauge32, NotificationType, Integer32, Counter64, Unsigned32, ModuleIdentity, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Bits", "Gauge32", "NotificationType", "Integer32", "Counter64", "Unsigned32", "ModuleIdentity", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitChannel=transmitChannel, secondarySoftwareVersion=secondarySoftwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortStatus=dataPortStatus, sNTPServerPortNumber=sNTPServerPortNumber, phyStatus=phyStatus, telecomsLineCode=telecomsLineCode, transmitPower=transmitPower, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortStatusTrap=dataPortStatusTrap, ptpTrapPrefix=ptpTrapPrefix, sNMPPortNumber=sNMPPortNumber, channelChangeTrap=channelChangeTrap, regionCode=regionCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDControl=tDDControl, remoteIPAddress=remoteIPAddress, linkModeOptimisation=linkModeOptimisation, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, daylightSaving=daylightSaving, userRole=userRole, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aAAControl=aAAControl, ethernetGroup=ethernetGroup, userTableIndex=userTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, productVariant=productVariant, sNTPSync=sNTPSync, versionsGroup=versionsGroup, tDDControlGroup=tDDControlGroup, signalStrengthRatio=signalStrengthRatio, sMTPServerPortNumber=sMTPServerPortNumber, supplementary=supplementary, PYSNMP_MODULE_ID=cambium, latitude=latitude, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPServerIPAddress=sMTPServerIPAddress, userTable=userTable, sMTPEnabledMessages=sMTPEnabledMessages, cambium=cambium, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, versions=versions, sNMPTrapVersion=sNMPTrapVersion, hTTPAccessEnabled=hTTPAccessEnabled, notificationsGroup=notificationsGroup, regionCodeTrap=regionCodeTrap, bandwidthVariant=bandwidthVariant, telecomsCableLength=telecomsCableLength, linkSymmetry=linkSymmetry, tFTPServerPortNumber=tFTPServerPortNumber, syslogClient=syslogClient, transmitDataRate=transmitDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, noWirelessChannelAvailable=noWirelessChannelAvailable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, searchState=searchState, telecomsLoopbackTrap=telecomsLoopbackTrap, telnetPortNumber=telnetPortNumber, masterSlaveMode=masterSlaveMode, vLANManagementPriority=vLANManagementPriority, syslogControl=syslogControl, userTableNumber=userTableNumber, receivePower=receivePower, receiveFreqMHz=receiveFreqMHz, smtpGroup=smtpGroup, dfsTableEntry=dfsTableEntry, sNTPPollInterval=sNTPPollInterval, subnetMask=subnetMask, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsPeaks=dfsPeaks, sNMPTrapTable=sNMPTrapTable, dataPortAutoMdix=dataPortAutoMdix, encryption=encryption, supplementaryGroup=supplementaryGroup, phyControlGroup=phyControlGroup, cableLoss=cableLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkLoss=linkLoss, vLANPriorityTable=vLANPriorityTable, vectorError=vectorError, sNMPv3Enable=sNMPv3Enable, receiveChannel=receiveChannel, transmitFreqMHz=transmitFreqMHz, transmitFreqKHz=transmitFreqKHz, vLANPriorityTableNumber=vLANPriorityTableNumber, siteName=siteName, targetMACAddress=targetMACAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, resetGroup=resetGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, licenceGroup=licenceGroup, dfsMeans=dfsMeans, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, userName=userName, altitude=altitude, ptmp=ptmp, syslogControlGroup=syslogControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bootVersion=bootVersion, ptpCompliance=ptpCompliance, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernet=ethernet, aggregateDataRate=aggregateDataRate, dataPortDisabledWarning=dataPortDisabledWarning, ptpTraps=ptpTraps, telecomsChannelStatus=telecomsChannelStatus, receiveModulationModeDetail=receiveModulationModeDetail, hTTPSPortNumber=hTTPSPortNumber, configuration=configuration, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecom=telecom, longitude=longitude, userTableEntry=userTableEntry, frequencyVariant=frequencyVariant, sntp=sntp, channelBandwidth=channelBandwidth, telecomsInterface=telecomsInterface, iPAddress=iPAddress, unitOutOfCalibration=unitOutOfCalibration, ptp500=ptp500, sMTPEmailAlert=sMTPEmailAlert, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogState=syslogState, accessMethod=accessMethod, tDDSynchronizationAlarm=tDDSynchronizationAlarm, groupID=groupID, receiveModulationMode=receiveModulationMode, sNMPTrapPortNumber=sNMPTrapPortNumber, telecomsLoopback=telecomsLoopback, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licence=licence, hardwareVersion=hardwareVersion, snmpControl=snmpControl, systemClock=systemClock, byteErrorRatio=byteErrorRatio, gatewayIPAddress=gatewayIPAddress, timeZone=timeZone, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, snmpControlGroup=snmpControlGroup, tFTPServerIPAddress=tFTPServerIPAddress, incompatibleRegionCodes=incompatibleRegionCodes, reset=reset, managementGroup=managementGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, installStatus=installStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, telnetAccessEnabled=telnetAccessEnabled, alarmsGroup=alarmsGroup, wirelessLinkAvailability=wirelessLinkAvailability, capacityLicenseMismatch=capacityLicenseMismatch, systemReset=systemReset, configurationGroup=configurationGroup, ptpGroups=ptpGroups, softwareVersion=softwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapIPAddress=sNMPTrapIPAddress, range=range, eIRP=eIRP, sNTPLastSync=sNTPLastSync, wirelessLinkStatus=wirelessLinkStatus, aAAControlGroup=aAAControlGroup, licensedCapacity=licensedCapacity, pubStatsGroup=pubStatsGroup, linkName=linkName, receiveFreqKHz=receiveFreqKHz, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTable=dfsTable, sNMPTrapTableIndex=sNMPTrapTableIndex, installStatusTrap=installStatusTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, smtp=smtp, alarms=alarms, dfsTableNumber=dfsTableNumber, installArmStateTrap=installArmStateTrap, productName=productName, installArmState=installArmState, encryptionAlgorithm=encryptionAlgorithm, antennaGain=antennaGain, phyControl=phyControl, sNTPState=sNTPState, userPassword=userPassword, sNMPCommunityString=sNMPCommunityString, dfs=dfs, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, pubStats=pubStats, dfsGroup=dfsGroup, maximumTransmitPower=maximumTransmitPower, management=management, vLANManagementVID=vLANManagementVID, tDDSynchronizationMode=tDDSynchronizationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptp=ptp, telecomGroup=telecomGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTableIndex=dfsTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogStateTrap=syslogStateTrap, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveDataRate=receiveDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, encryptionGroup=encryptionGroup, phyStatusGroup=phyStatusGroup, syslogClientTrap=syslogClientTrap)
