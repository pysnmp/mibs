...
# Produced by pysmi-1.1.3 at Sun Nov 28 19:51:28 2021
...
NotificationType, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, enterprises, Gauge32, TimeTicks, ObjectIdentity, Integer32, ModuleIdentity, IpAddress, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "enterprises", "Gauge32", "TimeTicks", "ObjectIdentity", "Integer32", "ModuleIdentity", "IpAddress", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", timeZone=timeZone, systemReset=systemReset, altitude=altitude, aAAControl=aAAControl, ptpGroups=ptpGroups, smtp=smtp, eIRP=eIRP, vLANPriorityTableEntry=vLANPriorityTableEntry, regionCodeTrap=regionCodeTrap, sNTPServerPortNumber=sNTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, phyControlGroup=phyControlGroup, receivePower=receivePower, sNMPTrapTable=sNMPTrapTable, phyStatusGroup=phyStatusGroup, receiveChannel=receiveChannel, dataPortAutoMdix=dataPortAutoMdix, dfsTableEntry=dfsTableEntry, hTTPSPortNumber=hTTPSPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, frequencyVariant=frequencyVariant, cableLoss=cableLoss, enabledDiagnosticAlarms=enabledDiagnosticAlarms, incompatibleRegionCodes=incompatibleRegionCodes, dfsPeaks=dfsPeaks, longitude=longitude, ptpTraps=ptpTraps, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerIPAddress=tFTPServerIPAddress, transmitFreqKHz=transmitFreqKHz, telecomsLineCode=telecomsLineCode, hardwareVersion=hardwareVersion, management=management, unitOutOfCalibration=unitOutOfCalibration, subnetMask=subnetMask, telecom=telecom, pubStatsGroup=pubStatsGroup, range=range, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortStatus=dataPortStatus, sNTPServerIPAddress=sNTPServerIPAddress, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, maximumTransmitPower=maximumTransmitPower, softwareVersion=softwareVersion, installArmState=installArmState, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarms=alarms, tDDControlGroup=tDDControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licence=licence, syslogControlGroup=syslogControlGroup, smtpGroup=smtpGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, iPAddress=iPAddress, versionsGroup=versionsGroup, productVariant=productVariant, licenceGroup=licenceGroup, telecomsLoopback=telecomsLoopback, remoteIPAddress=remoteIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationMode=tDDSynchronizationMode, sNTPState=sNTPState, dfsMeans=dfsMeans, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimisation=linkModeOptimisation, vLANPriorityTable=vLANPriorityTable, accessMethod=accessMethod, vLANManagementPriority=vLANManagementPriority, sNMPEnabledTraps=sNMPEnabledTraps, encryptionGroup=encryptionGroup, vectorError=vectorError, wirelessLinkAvailability=wirelessLinkAvailability, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, daylightSaving=daylightSaving, ptp500=ptp500, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licensedCapacity=licensedCapacity, managementGroup=managementGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, channelChangeTrap=channelChangeTrap, userName=userName, channelBandwidth=channelBandwidth, dataPortDisabledWarning=dataPortDisabledWarning, userTableEntry=userTableEntry, sNTPPollInterval=sNTPPollInterval, cambium=cambium, phyControl=phyControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPPortNumber=sNMPPortNumber, ptpCompliance=ptpCompliance, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetGroup=ethernetGroup, supplementaryGroup=supplementaryGroup, regionCode=regionCode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitModulationMode=transmitModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, byteErrorRatio=byteErrorRatio, latitude=latitude, PYSNMP_MODULE_ID=cambium, transmitPower=transmitPower, ptmp=ptmp, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, capacityLicenseMismatch=capacityLicenseMismatch, installStatusTrap=installStatusTrap, sNMPCommunityString=sNMPCommunityString, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableNumber=dfsTableNumber, userTable=userTable, telecomsCableLength=telecomsCableLength, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableNumber=userTableNumber, receiveModulationMode=receiveModulationMode, productName=productName, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, aAAControlGroup=aAAControlGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapVersion=sNMPTrapVersion, configurationGroup=configurationGroup, transmitChannel=transmitChannel, systemClock=systemClock, installArmStateTrap=installArmStateTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versions=versions, reset=reset, syslogState=syslogState, secondarySoftwareVersion=secondarySoftwareVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSyncTrap=sNTPSyncTrap, syslogControl=syslogControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, targetMACAddress=targetMACAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, userRole=userRole, receiveModulationModeDetail=receiveModulationModeDetail, antennaGain=antennaGain, syslogLocalWrappedTrap=syslogLocalWrappedTrap, snmpControlGroup=snmpControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogClient=syslogClient, notificationsGroup=notificationsGroup, encryption=encryption, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsGroup=dfsGroup, telecomsInterface=telecomsInterface, tDDControl=tDDControl, sNMPv3Enable=sNMPv3Enable, ptp=ptp, receiveFreqKHz=receiveFreqKHz, userEnabled=userEnabled, telecomGroup=telecomGroup, syslogStateTrap=syslogStateTrap, siteName=siteName, vLANPriorityQueueMapping=vLANPriorityQueueMapping, signalStrengthRatio=signalStrengthRatio, dataPortStatusTrap=dataPortStatusTrap, sntpGroup=sntpGroup, receiveFreqMHz=receiveFreqMHz, linkName=linkName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableIndex=userTableIndex, bootVersion=bootVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqMHz=transmitFreqMHz, aggregateDataRate=aggregateDataRate, sMTPEnabledMessages=sMTPEnabledMessages, dfs=dfs, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, telnetAccessEnabled=telnetAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, phyStatus=phyStatus, snmpControl=snmpControl, linkSymmetry=linkSymmetry, sNTPSync=sNTPSync, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsTable=dfsTable, userPassword=userPassword, alarmsGroup=alarmsGroup, transmitDataRate=transmitDataRate, vLANManagementVID=vLANManagementVID, groupID=groupID, ethernet=ethernet, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, pubStats=pubStats, wirelessLinkStatus=wirelessLinkStatus, configuration=configuration, hTTPAccessEnabled=hTTPAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, bandwidthVariant=bandwidthVariant, resetGroup=resetGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPLastSync=sNTPLastSync, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkLoss=linkLoss, receiveDataRate=receiveDataRate, telnetPortNumber=telnetPortNumber, sntp=sntp, sMTPServerPortNumber=sMTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, searchState=searchState, masterSlaveMode=masterSlaveMode, supplementary=supplementary)
