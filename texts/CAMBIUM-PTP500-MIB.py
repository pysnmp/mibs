...
# ASN.1 source file:///home/runner/work/mibs/mibs/src/vendor/cambium/500/CAMBIUM-PTP500-MIB
# Produced by pysmi-1.1.3 at Tue Nov 30 02:25:52 2021
...
Counter32, MibIdentifier, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, IpAddress, Unsigned32, NotificationType, Gauge32, enterprises, Bits, ModuleIdentity, iso, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "IpAddress", "Unsigned32", "NotificationType", "Gauge32", "enterprises", "Bits", "ModuleIdentity", "iso", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", snmpControlGroup=snmpControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, productVariant=productVariant, latitude=latitude, dfsTableIndex=dfsTableIndex, ptp=ptp, dataPortAutoMdix=dataPortAutoMdix, linkLoss=linkLoss, transmitFreqMHz=transmitFreqMHz, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryption=encryption, vLANPriorityTable=vLANPriorityTable, linkName=linkName, dataPortDisabledWarning=dataPortDisabledWarning, productName=productName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, range=range, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortStatusTrap=dataPortStatusTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDControlGroup=tDDControlGroup, maximumTransmitPower=maximumTransmitPower, ethernetFiberSupport=ethernetFiberSupport, resetGroup=resetGroup, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveDataRate=receiveDataRate, sNTPServerIPAddress=sNTPServerIPAddress, linkModeOptimisation=linkModeOptimisation, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPCommunityString=sNMPCommunityString, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogClientTrap=syslogClientTrap, vectorError=vectorError, sNMPTrapTableIndex=sNMPTrapTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, phyStatus=phyStatus, wirelessLinkStatus=wirelessLinkStatus, timeZone=timeZone, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userPassword=userPassword, ptp500=ptp500, sntp=sntp, vLANManagementVID=vLANManagementVID, transmitDataRate=transmitDataRate, sNMPEnabledTraps=sNMPEnabledTraps, supplementary=supplementary, dfsTableNumber=dfsTableNumber, telecomsLoopback=telecomsLoopback, PYSNMP_MODULE_ID=cambium, subnetMask=subnetMask, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleRegionCodes=incompatibleRegionCodes, wirelessLinkAvailability=wirelessLinkAvailability, sNTPLastSync=sNTPLastSync, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionGroup=encryptionGroup, ethernet=ethernet, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, alarmsGroup=alarmsGroup, configuration=configuration, phyStatusGroup=phyStatusGroup, userTableIndex=userTableIndex, telecomsInterface=telecomsInterface, dfs=dfs, bandwidthVariant=bandwidthVariant, signalStrengthRatio=signalStrengthRatio, vLANPriorityQueueMapping=vLANPriorityQueueMapping, linkSymmetry=linkSymmetry, systemReset=systemReset, regionCode=regionCode, byteErrorRatio=byteErrorRatio, iPAddress=iPAddress, receiveModulationMode=receiveModulationMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapPortNumber=sNMPTrapPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, vLANManagementPriority=vLANManagementPriority, sNTPSync=sNTPSync, installStatus=installStatus, cableLoss=cableLoss, userEnabled=userEnabled, dfsTableEntry=dfsTableEntry, reset=reset, ptmp=ptmp, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPSPortNumber=hTTPSPortNumber, versions=versions, smtpGroup=smtpGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, cambium=cambium, licensedCapacity=licensedCapacity, transmitModulationMode=transmitModulationMode, syslogState=syslogState, receiveChannel=receiveChannel, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versionsGroup=versionsGroup, sNMPv3Enable=sNMPv3Enable, telnetPortNumber=telnetPortNumber, gatewayIPAddress=gatewayIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, ptpGroups=ptpGroups, ptpTraps=ptpTraps, aAAControl=aAAControl, daylightSaving=daylightSaving, management=management, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControl=phyControl, sMTPServerIPAddress=sMTPServerIPAddress, snmpControl=snmpControl, antennaGain=antennaGain, searchState=searchState, telecomGroup=telecomGroup, sNTPServerPortNumber=sNTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPState=sNTPState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, pubStats=pubStats, channelBandwidth=channelBandwidth, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sntpGroup=sntpGroup, transmitFreqKHz=transmitFreqKHz, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userRole=userRole, userTableNumber=userTableNumber, targetMACAddress=targetMACAddress, dataPortStatus=dataPortStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userName=userName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogClient=syslogClient, longitude=longitude, userTableEntry=userTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitChannel=transmitChannel, userTable=userTable, receiveFreqKHz=receiveFreqKHz, installStatusTrap=installStatusTrap, notificationsGroup=notificationsGroup, sMTPEmailAlert=sMTPEmailAlert, phyControlGroup=phyControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANPriorityTableIndex=vLANPriorityTableIndex, channelChangeTrap=channelChangeTrap, configurationGroup=configurationGroup, bootVersion=bootVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationMode=tDDSynchronizationMode, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControl=syslogControl, altitude=altitude, sNTPPollInterval=sNTPPollInterval, dfsMeans=dfsMeans, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPEnabledMessages=sMTPEnabledMessages, smtp=smtp, managementGroup=managementGroup, dfsPeaks=dfsPeaks, dfsGroup=dfsGroup, sNMPPortNumber=sNMPPortNumber, softwareVersion=softwareVersion, hTTPAccessEnabled=hTTPAccessEnabled, regionCodeTrap=regionCodeTrap, tDDControl=tDDControl, siteName=siteName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licenceGroup=licenceGroup, hTTPPortNumber=hTTPPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, dfsTable=dfsTable, tFTPServerPortNumber=tFTPServerPortNumber, installArmStateTrap=installArmStateTrap, pubStatsGroup=pubStatsGroup, telecomsLineCode=telecomsLineCode, receiveFreqMHz=receiveFreqMHz, ethernetGroup=ethernetGroup, receivePower=receivePower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsCableLength=telecomsCableLength, telecomsChannelStatus=telecomsChannelStatus, encryptionAlgorithm=encryptionAlgorithm, telecom=telecom, syslogControlGroup=syslogControlGroup, sNMPTrapTable=sNMPTrapTable, installArmState=installArmState, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hardwareVersion=hardwareVersion, sNMPTrapVersion=sNMPTrapVersion, syslogStateTrap=syslogStateTrap, ptpTrapPrefix=ptpTrapPrefix, frequencyVariant=frequencyVariant, masterSlaveMode=masterSlaveMode, aAAControlGroup=aAAControlGroup, supplementaryGroup=supplementaryGroup, eIRP=eIRP, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, groupID=groupID, vLANPriorityTableEntry=vLANPriorityTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aggregateDataRate=aggregateDataRate, licence=licence, alarms=alarms, accessMethod=accessMethod, transmitPower=transmitPower, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock)
