...
Bits, TimeTicks, Counter64, Unsigned32, ModuleIdentity, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, enterprises, NotificationType, Integer32, ObjectIdentity, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Counter64", "Unsigned32", "ModuleIdentity", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "enterprises", "NotificationType", "Integer32", "ObjectIdentity", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telnetAccessEnabled=telnetAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productVariant=productVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, sNTPSyncTrap=sNTPSyncTrap, receiveFreqMHz=receiveFreqMHz, syslogControlGroup=syslogControlGroup, byteErrorRatio=byteErrorRatio, userTableNumber=userTableNumber, systemReset=systemReset, receiveFreqKHz=receiveFreqKHz, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, management=management, syslogControl=syslogControl, linkLoss=linkLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, configuration=configuration, incompatibleRegionCodes=incompatibleRegionCodes, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, installStatus=installStatus, configurationGroup=configurationGroup, daylightSaving=daylightSaving, tFTPServerPortNumber=tFTPServerPortNumber, userPassword=userPassword, groupID=groupID, tDDSynchronizationAlarm=tDDSynchronizationAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveDataRate=receiveDataRate, ptmp=ptmp, sntp=sntp, sNTPSync=sNTPSync, sNTPLastSync=sNTPLastSync, latitude=latitude, siteName=siteName, licensedCapacity=licensedCapacity, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDControl=tDDControl, antennaGain=antennaGain, phyControl=phyControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sMTPEnabledMessages=sMTPEnabledMessages, dfs=dfs, frequencyVariant=frequencyVariant, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortAutoNegotiation=dataPortAutoNegotiation, receivePower=receivePower, licenceGroup=licenceGroup, ptpCompliance=ptpCompliance, installArmStateTrap=installArmStateTrap, syslogState=syslogState, sNMPPortNumber=sNMPPortNumber, regionCodeTrap=regionCodeTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPv3Enable=sNMPv3Enable, hTTPPortNumber=hTTPPortNumber, bandwidthVariant=bandwidthVariant, ethernetFiberSupport=ethernetFiberSupport, ptp=ptp, sNMPCommunityString=sNMPCommunityString, tDDControlGroup=tDDControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, dfsPeaks=dfsPeaks, dataPortDisabledWarning=dataPortDisabledWarning, capacityLicenseMismatch=capacityLicenseMismatch, userTableIndex=userTableIndex, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitChannel=transmitChannel, cableLoss=cableLoss, bootVersion=bootVersion, reset=reset, accessMethod=accessMethod, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, altitude=altitude, transmitFreqMHz=transmitFreqMHz, telnetPortNumber=telnetPortNumber, smtpGroup=smtpGroup, telecomGroup=telecomGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, softwareVersion=softwareVersion, timeZone=timeZone, maximumTransmitPower=maximumTransmitPower, userEnabled=userEnabled, syslogStateTrap=syslogStateTrap, receiveModulationMode=receiveModulationMode, transmitDataRate=transmitDataRate, userName=userName, aAAControl=aAAControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, encryptionGroup=encryptionGroup, sMTPServerPortNumber=sMTPServerPortNumber, dfsTable=dfsTable, channelChangeTrap=channelChangeTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsTableEntry=dfsTableEntry, snmpControl=snmpControl, installStatusTrap=installStatusTrap, pubStats=pubStats, vectorError=vectorError, sNTPServerPortNumber=sNTPServerPortNumber, productName=productName, userTable=userTable, secondarySoftwareVersion=secondarySoftwareVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, masterSlaveMode=masterSlaveMode, linkModeOptimisation=linkModeOptimisation, linkModeOptimizationMismatch=linkModeOptimizationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, phyControlGroup=phyControlGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkSymmetry=linkSymmetry, transmitPower=transmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licence=licence, subnetMask=subnetMask, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapPortNumber=sNMPTrapPortNumber, alarms=alarms, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationMode=tDDSynchronizationMode, ethernet=ethernet, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPSPortNumber=hTTPSPortNumber, versionsGroup=versionsGroup, sMTPEmailAlert=sMTPEmailAlert, ptpGroups=ptpGroups, phyStatus=phyStatus, dfsTableNumber=dfsTableNumber, ptp500=ptp500, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitFreqKHz=transmitFreqKHz, sNMPTrapIPAddress=sNMPTrapIPAddress, encryption=encryption, alarmsGroup=alarmsGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableEntry=userTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, eIRP=eIRP, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCode=regionCode, wirelessLinkStatus=wirelessLinkStatus, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, searchState=searchState, aAAControlGroup=aAAControlGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStatsGroup=pubStatsGroup, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsInterface=telecomsInterface, targetMACAddress=targetMACAddress, phyStatusGroup=phyStatusGroup, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClient=syslogClient, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, iPAddress=iPAddress, hTTPSAccessEnabled=hTTPSAccessEnabled, longitude=longitude, cambium=cambium, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementVID=vLANManagementVID, sNTPServerIPAddress=sNTPServerIPAddress, PYSNMP_MODULE_ID=cambium, sNTPPollInterval=sNTPPollInterval, vLANPriorityTable=vLANPriorityTable, range=range, supplementary=supplementary, channelBandwidth=channelBandwidth, linkName=linkName, ptpTraps=ptpTraps, gatewayIPAddress=gatewayIPAddress, transmitModulationMode=transmitModulationMode, receiveModulationModeDetail=receiveModulationModeDetail, versions=versions, tFTPServerIPAddress=tFTPServerIPAddress, sntpGroup=sntpGroup, smtp=smtp, managementGroup=managementGroup, installArmState=installArmState, resetGroup=resetGroup, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, systemClock=systemClock, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, notificationsGroup=notificationsGroup, syslogClientTrap=syslogClientTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsLineCode=telecomsLineCode, telecomsCableLength=telecomsCableLength, hTTPAccessEnabled=hTTPAccessEnabled, dfsTableIndex=dfsTableIndex, userRole=userRole, ptpTrapPrefix=ptpTrapPrefix, vLANManagementPriority=vLANManagementPriority, unitOutOfCalibration=unitOutOfCalibration, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsGroup=dfsGroup, sNTPState=sNTPState, telecom=telecom, ethernetGroup=ethernetGroup, wirelessLinkAvailability=wirelessLinkAvailability, remoteIPAddress=remoteIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, supplementaryGroup=supplementaryGroup, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapTable=sNMPTrapTable, snmpControlGroup=snmpControlGroup, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsLoopback=telecomsLoopback)
