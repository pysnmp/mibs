...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPAddress=iPAddress, userRole=userRole, constantPowerSpectralDensity=constantPowerSpectralDensity, pubStatsGroup=pubStatsGroup, syslogClient=syslogClient, ptpGroups=ptpGroups, notificationsGroup=notificationsGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitFreqKHz=transmitFreqKHz, dfsTable=dfsTable, aAAControl=aAAControl, telecomsLoopback=telecomsLoopback, dataPortAutoMdix=dataPortAutoMdix, daylightSaving=daylightSaving, longitude=longitude, bandwidthVariant=bandwidthVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp500=ptp500, tFTPServerIPAddress=tFTPServerIPAddress, linkLoss=linkLoss, userName=userName, telecomsCableLength=telecomsCableLength, userTableNumber=userTableNumber, cambium=cambium, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogState=syslogState, sNTPSyncTrap=sNTPSyncTrap, sMTPServerPortNumber=sMTPServerPortNumber, syslogControl=syslogControl, unitOutOfCalibration=unitOutOfCalibration, telecomsInterface=telecomsInterface, incompatibleRegionCodes=incompatibleRegionCodes, sMTPSourceEmailAddress=sMTPSourceEmailAddress, resetGroup=resetGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarms=alarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, installArmStateTrap=installArmStateTrap, vLANManagementPriority=vLANManagementPriority, receiveModulationMode=receiveModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, masterSlaveMode=masterSlaveMode, receiveFreqKHz=receiveFreqKHz, sNMPPortNumber=sNMPPortNumber, gatewayIPAddress=gatewayIPAddress, supplementary=supplementary, ethernet=ethernet, telecomGroup=telecomGroup, siteName=siteName, alarmsGroup=alarmsGroup, sNMPTrapVersion=sNMPTrapVersion, telecom=telecom, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, phyControlGroup=phyControlGroup, dfsGroup=dfsGroup, productName=productName, accessMethod=accessMethod, dfsTableIndex=dfsTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANManagementVID=vLANManagementVID, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userTable=userTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, smtpGroup=smtpGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, systemClock=systemClock, vLANPriorityTableNumber=vLANPriorityTableNumber, dfs=dfs, hardwareVersion=hardwareVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, byteErrorRatio=byteErrorRatio, receiveChannel=receiveChannel, versionsGroup=versionsGroup, regionCode=regionCode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitPower=transmitPower, dfsMeans=dfsMeans, remoteIPAddress=remoteIPAddress, sNMPEnabledTraps=sNMPEnabledTraps, subnetMask=subnetMask, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, eIRP=eIRP, altitude=altitude, sntp=sntp, vectorError=vectorError, cableLoss=cableLoss, licensedCapacity=licensedCapacity, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, systemReset=systemReset, sNMPv3Enable=sNMPv3Enable, sNTPState=sNTPState, softwareVersion=softwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStats=pubStats, receiveDataRate=receiveDataRate, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPTrapTable=sNMPTrapTable, snmpControl=snmpControl, receiveModulationModeDetail=receiveModulationModeDetail, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimisation=linkModeOptimisation, dfsTableNumber=dfsTableNumber, transmitChannel=transmitChannel, vLANPriorityTable=vLANPriorityTable, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, linkSymmetry=linkSymmetry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, smtp=smtp, antennaGain=antennaGain, channelBandwidth=channelBandwidth, userPassword=userPassword, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsChannelStatus=telecomsChannelStatus, linkName=linkName, licenceGroup=licenceGroup, frequencyVariant=frequencyVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryption=encryption, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPSync=sNTPSync, syslogStateTrap=syslogStateTrap, configurationGroup=configurationGroup, PYSNMP_MODULE_ID=cambium, telecomsLineCode=telecomsLineCode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortDisabledWarning=dataPortDisabledWarning, receivePower=receivePower, sNTPLastSync=sNTPLastSync, maximumTransmitPower=maximumTransmitPower, sNMPCommunityString=sNMPCommunityString, installArmState=installArmState, transmitModulationMode=transmitModulationMode, management=management, snmpControlGroup=snmpControlGroup, groupID=groupID, tFTPServerPortNumber=tFTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, tDDControl=tDDControl, sntpGroup=sntpGroup, ptmp=ptmp, ptpCompliance=ptpCompliance, phyControl=phyControl, targetMACAddress=targetMACAddress, productVariant=productVariant, installStatusTrap=installStatusTrap, userEnabled=userEnabled, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkStatus=wirelessLinkStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortStatus=dataPortStatus, range=range, encryptionGroup=encryptionGroup, ptp=ptp, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableEntry=dfsTableEntry, dataPortStatusTrap=dataPortStatusTrap, supplementaryGroup=supplementaryGroup, licence=licence, phyStatusGroup=phyStatusGroup, latitude=latitude, userTableEntry=userTableEntry, installStatus=installStatus, sNTPPollInterval=sNTPPollInterval, syslogClientTrap=syslogClientTrap, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, phyStatus=phyStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsLoopbackTrap=telecomsLoopbackTrap, regionCodeTrap=regionCodeTrap, ethernetGroup=ethernetGroup, sMTPEnabledMessages=sMTPEnabledMessages, aAAControlGroup=aAAControlGroup, sMTPEmailAlert=sMTPEmailAlert, syslogControlGroup=syslogControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, searchState=searchState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, configuration=configuration, hTTPSPortNumber=hTTPSPortNumber, transmitFreqMHz=transmitFreqMHz, ptpTraps=ptpTraps, wirelessLinkAvailability=wirelessLinkAvailability, enabledDiagnosticAlarms=enabledDiagnosticAlarms, userTableIndex=userTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, hTTPAccessEnabled=hTTPAccessEnabled, bootVersion=bootVersion, capacityLicenseMismatch=capacityLicenseMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, signalStrengthRatio=signalStrengthRatio, dfsPeaks=dfsPeaks, reset=reset, telnetPortNumber=telnetPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDControlGroup=tDDControlGroup, managementGroup=managementGroup, timeZone=timeZone, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap)
