...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", regionCode=regionCode, vLANPriorityTableEntry=vLANPriorityTableEntry, installArmState=installArmState, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPLastSync=sNTPLastSync, transmitChannel=transmitChannel, ptmp=ptmp, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerIPAddress=sMTPServerIPAddress, management=management, ptpGroups=ptpGroups, snmpControl=snmpControl, userTableEntry=userTableEntry, dataPortStatusTrap=dataPortStatusTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitPower=transmitPower, hTTPSPortNumber=hTTPSPortNumber, userTableIndex=userTableIndex, syslogStateTrap=syslogStateTrap, sNTPSyncTrap=sNTPSyncTrap, vLANManagementVID=vLANManagementVID, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveDataRate=receiveDataRate, dfsMeans=dfsMeans, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telnetAccessEnabled=telnetAccessEnabled, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANPriorityTable=vLANPriorityTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, smtpGroup=smtpGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, sntp=sntp, receivePower=receivePower, dataPortAutoMdix=dataPortAutoMdix, telecomsCableLength=telecomsCableLength, softwareVersion=softwareVersion, syslogClient=syslogClient, ethernet=ethernet, dfsTableEntry=dfsTableEntry, wirelessLinkAvailability=wirelessLinkAvailability, byteErrorRatio=byteErrorRatio, daylightSaving=daylightSaving, antennaGain=antennaGain, supplementary=supplementary, tFTPServerIPAddress=tFTPServerIPAddress, groupID=groupID, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableIndex=dfsTableIndex, ptpCompliance=ptpCompliance, hTTPAccessEnabled=hTTPAccessEnabled, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANManagementPriority=vLANManagementPriority, sNTPState=sNTPState, PYSNMP_MODULE_ID=cambium, ptp500=ptp500, receiveModulationMode=receiveModulationMode, siteName=siteName, sNMPTrapPortNumber=sNMPTrapPortNumber, systemReset=systemReset, dfsTable=dfsTable, latitude=latitude, linkSymmetry=linkSymmetry, tDDControlGroup=tDDControlGroup, channelChangeTrap=channelChangeTrap, dfsTableNumber=dfsTableNumber, syslogControl=syslogControl, telecomsLoopback=telecomsLoopback, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, resetGroup=resetGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, telnetPortNumber=telnetPortNumber, reset=reset, sNTPServerIPAddress=sNTPServerIPAddress, targetMACAddress=targetMACAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, incompatibleRegionCodes=incompatibleRegionCodes, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogClientTrap=syslogClientTrap, maximumTransmitPower=maximumTransmitPower, ethernetGroup=ethernetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogControlGroup=syslogControlGroup, licensedCapacity=licensedCapacity, receiveChannel=receiveChannel, subnetMask=subnetMask, altitude=altitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, phyControlGroup=phyControlGroup, productVariant=productVariant, transmitDataRate=transmitDataRate, licenceGroup=licenceGroup, versions=versions, smtp=smtp, phyStatusGroup=phyStatusGroup, secondarySoftwareVersion=secondarySoftwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installArmStateTrap=installArmStateTrap, aAAControl=aAAControl, configurationGroup=configurationGroup, hardwareVersion=hardwareVersion, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptpTraps=ptpTraps, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, userPassword=userPassword, sNTPPollInterval=sNTPPollInterval, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControl=tDDControl, receiveModulationModeDetail=receiveModulationModeDetail, userRole=userRole, linkLoss=linkLoss, vectorError=vectorError, transmitFreqKHz=transmitFreqKHz, sNMPEnabledTraps=sNMPEnabledTraps, bootVersion=bootVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsChannelStatus=telecomsChannelStatus, receiveFreqKHz=receiveFreqKHz, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerPortNumber=tFTPServerPortNumber, dfsGroup=dfsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, signalStrengthRatio=signalStrengthRatio, wirelessLinkStatus=wirelessLinkStatus, sMTPEmailAlert=sMTPEmailAlert, ptpTrapPrefix=ptpTrapPrefix, ptp=ptp, transmitModulationMode=transmitModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfs=dfs, sNMPTrapVersion=sNMPTrapVersion, encryptionGroup=encryptionGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, telecomsInterface=telecomsInterface, sNTPServerPortNumber=sNTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimisation=linkModeOptimisation, sNMPTrapTableIndex=sNMPTrapTableIndex, licence=licence, aggregateDataRate=aggregateDataRate, installStatusTrap=installStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, systemClock=systemClock, sNTPSync=sNTPSync, constantPowerSpectralDensity=constantPowerSpectralDensity, encryption=encryption, regionCodeTrap=regionCodeTrap, phyStatus=phyStatus, cambium=cambium, supplementaryGroup=supplementaryGroup, telecomGroup=telecomGroup, sNMPPortNumber=sNMPPortNumber, channelBandwidth=channelBandwidth, dataPortAutoNegotiation=dataPortAutoNegotiation, eIRP=eIRP, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, userName=userName, phyControl=phyControl, capacityLicenseMismatch=capacityLicenseMismatch, dfsPeaks=dfsPeaks, productName=productName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsLineCode=telecomsLineCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, encryptionAlgorithm=encryptionAlgorithm, masterSlaveMode=masterSlaveMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installStatus=installStatus, sNMPv3Enable=sNMPv3Enable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPCommunityString=sNMPCommunityString, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTable=sNMPTrapTable, snmpControlGroup=snmpControlGroup, timeZone=timeZone, pubStats=pubStats, linkName=linkName, configuration=configuration, iPAddress=iPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, longitude=longitude, receiveFreqMHz=receiveFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDSynchronizationAlarm=tDDSynchronizationAlarm, searchState=searchState, frequencyVariant=frequencyVariant, aAAControlGroup=aAAControlGroup, userTable=userTable, cableLoss=cableLoss, userTableNumber=userTableNumber, bandwidthVariant=bandwidthVariant, range=range, managementGroup=managementGroup, unitOutOfCalibration=unitOutOfCalibration, gatewayIPAddress=gatewayIPAddress, accessMethod=accessMethod, alarms=alarms, syslogState=syslogState, sntpGroup=sntpGroup, telecom=telecom, dataPortStatus=dataPortStatus, remoteIPAddress=remoteIPAddress)
