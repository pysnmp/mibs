...
# Produced by pysmi-1.1.3 at Tue Nov 30 02:59:29 2021
...
ObjectIdentity, Unsigned32, enterprises, Integer32, Counter64, Bits, TimeTicks, Counter32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, ModuleIdentity, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "enterprises", "Integer32", "Counter64", "Bits", "TimeTicks", "Counter32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "ModuleIdentity", "Gauge32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapTableEntry=sNMPTrapTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, snmpControlGroup=snmpControlGroup, ethernet=ethernet, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemReset=systemReset, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerPortNumber=sMTPServerPortNumber, hTTPSPortNumber=hTTPSPortNumber, smtp=smtp, sNMPTrapTableIndex=sNMPTrapTableIndex, timeZone=timeZone, receiveDataRate=receiveDataRate, telecom=telecom, sNMPTrapVersion=sNMPTrapVersion, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, groupID=groupID, hTTPAccessEnabled=hTTPAccessEnabled, licence=licence, transmitFreqMHz=transmitFreqMHz, userTableIndex=userTableIndex, telecomsLoopback=telecomsLoopback, userTable=userTable, encryptionGroup=encryptionGroup, subnetMask=subnetMask, installStatus=installStatus, receiveModulationMode=receiveModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortStatus=dataPortStatus, gatewayIPAddress=gatewayIPAddress, alarmsGroup=alarmsGroup, pubStatsGroup=pubStatsGroup, versions=versions, dfsTableIndex=dfsTableIndex, telecomsLineCode=telecomsLineCode, sNTPLastSync=sNTPLastSync, encryption=encryption, phyStatus=phyStatus, sntp=sntp, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationMode=tDDSynchronizationMode, syslogControl=syslogControl, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, latitude=latitude, ptp500=ptp500, ptpTrapPrefix=ptpTrapPrefix, configurationGroup=configurationGroup, regionCodeTrap=regionCodeTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, siteName=siteName, resetGroup=resetGroup, licensedCapacity=licensedCapacity, telnetPortNumber=telnetPortNumber, dfsMeans=dfsMeans, ptpTraps=ptpTraps, hardwareVersion=hardwareVersion, encryptionAlgorithm=encryptionAlgorithm, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkStatus=wirelessLinkStatus, dfsGroup=dfsGroup, installArmState=installArmState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, targetMACAddress=targetMACAddress, productName=productName, sNMPv3Enable=sNMPv3Enable, versionsGroup=versionsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, bootVersion=bootVersion, sNTPPollInterval=sNTPPollInterval, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDControl=tDDControl, sNTPSync=sNTPSync, PYSNMP_MODULE_ID=cambium, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, installStatusTrap=installStatusTrap, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkAvailability=wirelessLinkAvailability, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ethernetGroup=ethernetGroup, altitude=altitude, phyStatusGroup=phyStatusGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, supplementaryGroup=supplementaryGroup, receiveFreqKHz=receiveFreqKHz, telnetAccessEnabled=telnetAccessEnabled, configuration=configuration, telecomsInterface=telecomsInterface, frequencyVariant=frequencyVariant, remoteIPAddress=remoteIPAddress, management=management, sNTPServerIPAddress=sNTPServerIPAddress, transmitChannel=transmitChannel, range=range, installArmStateTrap=installArmStateTrap, unitOutOfCalibration=unitOutOfCalibration, regionCode=regionCode, aAAControlGroup=aAAControlGroup, iPAddress=iPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, cableLoss=cableLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANPriorityTableNumber=vLANPriorityTableNumber, systemClock=systemClock, accessMethod=accessMethod, dfsTableEntry=dfsTableEntry, pubStats=pubStats, userPassword=userPassword, vLANManagementPriority=vLANManagementPriority, sntpGroup=sntpGroup, dataPortDisabledWarning=dataPortDisabledWarning, userTableNumber=userTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitFreqKHz=transmitFreqKHz, userTableEntry=userTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatusTrap=dataPortStatusTrap, transmitModulationMode=transmitModulationMode, sNMPCommunityString=sNMPCommunityString, aggregateDataRate=aggregateDataRate, phyControl=phyControl, receivePower=receivePower, licenceGroup=licenceGroup, vectorError=vectorError, syslogState=syslogState, tDDControlGroup=tDDControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, masterSlaveMode=masterSlaveMode, smtpGroup=smtpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sMTPEnabledMessages=sMTPEnabledMessages, userRole=userRole, syslogControlGroup=syslogControlGroup, dfs=dfs, dfsTableNumber=dfsTableNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogClientTrap=syslogClientTrap, ptpGroups=ptpGroups, telecomGroup=telecomGroup, searchState=searchState, linkSymmetry=linkSymmetry, linkModeOptimisation=linkModeOptimisation, receiveChannel=receiveChannel, sNTPSyncTrap=sNTPSyncTrap, telecomsCableLength=telecomsCableLength, syslogClient=syslogClient, linkName=linkName, vLANManagementVID=vLANManagementVID, bandwidthVariant=bandwidthVariant, linkLoss=linkLoss, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userEnabled=userEnabled, eIRP=eIRP, receiveFreqMHz=receiveFreqMHz, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapIPAddress=sNMPTrapIPAddress, ptmp=ptmp, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatch=dataPortConfigurationMismatch, signalStrengthRatio=signalStrengthRatio, antennaGain=antennaGain, channelChangeTrap=channelChangeTrap, syslogStateTrap=syslogStateTrap, ptp=ptp, sNMPTrapTable=sNMPTrapTable, managementGroup=managementGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userName=userName, telecomsChannelStatus=telecomsChannelStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsPeaks=dfsPeaks, dataPortAutoNegotiation=dataPortAutoNegotiation, reset=reset, maximumTransmitPower=maximumTransmitPower, supplementary=supplementary, constantPowerSpectralDensity=constantPowerSpectralDensity, softwareVersion=softwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitPower=transmitPower, dfsTable=dfsTable, phyControlGroup=phyControlGroup, cambium=cambium, ptpCompliance=ptpCompliance, sNMPTrapPortNumber=sNMPTrapPortNumber, aAAControl=aAAControl, longitude=longitude, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, secondarySoftwareVersion=secondarySoftwareVersion, snmpControl=snmpControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitDataRate=transmitDataRate, vLANPriorityTable=vLANPriorityTable, sNTPServerPortNumber=sNTPServerPortNumber, productVariant=productVariant, byteErrorRatio=byteErrorRatio, alarms=alarms, sNTPState=sNTPState, tFTPServerIPAddress=tFTPServerIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, channelBandwidth=channelBandwidth, sMTPEmailAlert=sMTPEmailAlert, daylightSaving=daylightSaving)
