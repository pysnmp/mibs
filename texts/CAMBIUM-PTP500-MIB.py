...
ModuleIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, Bits, Gauge32, iso, IpAddress, NotificationType, enterprises, MibIdentifier, TimeTicks, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "Bits", "Gauge32", "iso", "IpAddress", "NotificationType", "enterprises", "MibIdentifier", "TimeTicks", "Counter32", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vectorError=vectorError, telecomGroup=telecomGroup, ptpGroups=ptpGroups, bootVersion=bootVersion, hardwareVersion=hardwareVersion, telnetAccessEnabled=telnetAccessEnabled, phyControlGroup=phyControlGroup, supplementary=supplementary, sNMPPortNumber=sNMPPortNumber, syslogControl=syslogControl, productVariant=productVariant, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, syslogLocalWrappedTrap=syslogLocalWrappedTrap, management=management, receivePower=receivePower, userPassword=userPassword, altitude=altitude, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortStatusTrap=dataPortStatusTrap, transmitFreqMHz=transmitFreqMHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveChannel=receiveChannel, telnetPortNumber=telnetPortNumber, regionCodeTrap=regionCodeTrap, dfsGroup=dfsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aAAControl=aAAControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, bandwidthVariant=bandwidthVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, installArmStateTrap=installArmStateTrap, hTTPAccessEnabled=hTTPAccessEnabled, telecom=telecom, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, syslogState=syslogState, userTableEntry=userTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsLineCode=telecomsLineCode, sNMPEnabledTraps=sNMPEnabledTraps, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtpGroup=smtpGroup, tDDControlGroup=tDDControlGroup, snmpControlGroup=snmpControlGroup, vLANManagementPriority=vLANManagementPriority, systemReset=systemReset, dfsMeans=dfsMeans, dataPortStatus=dataPortStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionGroup=encryptionGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveFreqKHz=receiveFreqKHz, productName=productName, managementGroup=managementGroup, licensedCapacity=licensedCapacity, transmitFreqKHz=transmitFreqKHz, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPEnabledMessages=sMTPEnabledMessages, userRole=userRole, configuration=configuration, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelBandwidth=channelBandwidth, configurationGroup=configurationGroup, snmpControl=snmpControl, wirelessLinkAvailability=wirelessLinkAvailability, versions=versions, ethernetFiberSupport=ethernetFiberSupport, timeZone=timeZone, sNTPServerPortNumber=sNTPServerPortNumber, longitude=longitude, ptpCompliance=ptpCompliance, linkName=linkName, subnetMask=subnetMask, linkLoss=linkLoss, telecomsLoopback=telecomsLoopback, installArmState=installArmState, transmitChannel=transmitChannel, latitude=latitude, versionsGroup=versionsGroup, cableLoss=cableLoss, dfsTable=dfsTable, vLANManagementVID=vLANManagementVID, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPEmailAlert=sMTPEmailAlert, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, groupID=groupID, daylightSaving=daylightSaving, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogClientTrap=syslogClientTrap, linkSymmetry=linkSymmetry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSPortNumber=hTTPSPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, hTTPPortNumber=hTTPPortNumber, frequencyVariant=frequencyVariant, unitOutOfCalibration=unitOutOfCalibration, capacityLicenseMismatch=capacityLicenseMismatch, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntpGroup=sntpGroup, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, resetGroup=resetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelStatus=telecomsChannelStatus, signalStrengthRatio=signalStrengthRatio, licenceGroup=licenceGroup, systemClock=systemClock, dataPortDisabledWarning=dataPortDisabledWarning, transmitPower=transmitPower, syslogControlGroup=syslogControlGroup, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, eIRP=eIRP, byteErrorRatio=byteErrorRatio, dfsTableIndex=dfsTableIndex, antennaGain=antennaGain, dfsPeaks=dfsPeaks, dataPortAutoMdix=dataPortAutoMdix, syslogClient=syslogClient, aggregateDataRate=aggregateDataRate, aAAControlGroup=aAAControlGroup, notificationsGroup=notificationsGroup, telecomsInterface=telecomsInterface, sNTPSyncTrap=sNTPSyncTrap, receiveModulationMode=receiveModulationMode, phyStatusGroup=phyStatusGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableIndex=userTableIndex, userName=userName, tDDControl=tDDControl, cambium=cambium, dataPortConfigurationMismatch=dataPortConfigurationMismatch, siteName=siteName, installStatus=installStatus, phyStatus=phyStatus, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntp=sntp, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkStatus=wirelessLinkStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveDataRate=receiveDataRate, maximumTransmitPower=maximumTransmitPower, ptp=ptp, PYSNMP_MODULE_ID=cambium, vLANPriorityTable=vLANPriorityTable, receiveModulationModeDetail=receiveModulationModeDetail, sNMPv3Enable=sNMPv3Enable, sNTPState=sNTPState, installStatusTrap=installStatusTrap, userTableNumber=userTableNumber, licence=licence, sNTPSync=sNTPSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANPriorityTableNumber=vLANPriorityTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapTable=sNMPTrapTable, secondarySoftwareVersion=secondarySoftwareVersion, sMTPServerIPAddress=sMTPServerIPAddress, ethernet=ethernet, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerIPAddress=tFTPServerIPAddress, ptpTrapPrefix=ptpTrapPrefix, range=range, syslogStateTrap=syslogStateTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, userEnabled=userEnabled, sNTPPollInterval=sNTPPollInterval, alarmsGroup=alarmsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, masterSlaveMode=masterSlaveMode, sNTPServerIPAddress=sNTPServerIPAddress, dfs=dfs, pubStatsGroup=pubStatsGroup, receiveFreqMHz=receiveFreqMHz, dfsTableNumber=dfsTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, iPAddress=iPAddress, regionCode=regionCode, telecomsCableLength=telecomsCableLength, ptp500=ptp500, linkModeOptimizationMismatch=linkModeOptimizationMismatch, alarms=alarms, ethernetGroup=ethernetGroup, supplementaryGroup=supplementaryGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPLastSync=sNTPLastSync, targetMACAddress=targetMACAddress, sNMPCommunityString=sNMPCommunityString, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, smtp=smtp, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, searchState=searchState, ptpTraps=ptpTraps, accessMethod=accessMethod, vLANPriorityTableEntry=vLANPriorityTableEntry, phyControl=phyControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryption=encryption, channelChangeTrap=channelChangeTrap, userTable=userTable, reset=reset, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodes=incompatibleRegionCodes, encryptionAlgorithm=encryptionAlgorithm)
