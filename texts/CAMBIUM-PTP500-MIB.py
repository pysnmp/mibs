...
# Produced by pysmi-1.1.11 at Wed Apr  3 14:48:38 2024
...
IpAddress, TimeTicks, enterprises, Unsigned32, Integer32, NotificationType, Counter64, MibIdentifier, Bits, Counter32, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "TimeTicks", "enterprises", "Unsigned32", "Integer32", "NotificationType", "Counter64", "MibIdentifier", "Bits", "Counter32", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", unitOutOfCalibration=unitOutOfCalibration, tDDControlGroup=tDDControlGroup, linkName=linkName, vLANManagementVID=vLANManagementVID, telecomsLineCode=telecomsLineCode, supplementary=supplementary, sNMPTrapTable=sNMPTrapTable, cableLoss=cableLoss, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, installStatus=installStatus, notificationsGroup=notificationsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsPeaks=dfsPeaks, transmitFreqMHz=transmitFreqMHz, sNMPTrapTableIndex=sNMPTrapTableIndex, receivePower=receivePower, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telecomsLoopback=telecomsLoopback, bandwidthVariant=bandwidthVariant, tDDControl=tDDControl, installArmStateTrap=installArmStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortDisabledWarning=dataPortDisabledWarning, transmitChannel=transmitChannel, versions=versions, syslogState=syslogState, telnetAccessEnabled=telnetAccessEnabled, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSyncTrap=sNTPSyncTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptmp=ptmp, dfsTableIndex=dfsTableIndex, sMTPEnabledMessages=sMTPEnabledMessages, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, range=range, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, eIRP=eIRP, systemClock=systemClock, sntpGroup=sntpGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, userRole=userRole, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsTableEntry=dfsTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, regionCode=regionCode, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userTableIndex=userTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkAvailability=wirelessLinkAvailability, transmitDataRate=transmitDataRate, configurationGroup=configurationGroup, byteErrorRatio=byteErrorRatio, wirelessLinkStatus=wirelessLinkStatus, installArmState=installArmState, regionCodeTrap=regionCodeTrap, alarms=alarms, capacityLicenseMismatch=capacityLicenseMismatch, channelChangeTrap=channelChangeTrap, reset=reset, sMTPEmailAlert=sMTPEmailAlert, transmitPower=transmitPower, ethernetGroup=ethernetGroup, timeZone=timeZone, syslogClient=syslogClient, phyControlGroup=phyControlGroup, licence=licence, sNTPSync=sNTPSync, antennaGain=antennaGain, sNTPState=sNTPState, snmpControlGroup=snmpControlGroup, systemReset=systemReset, telecomsChannelStatus=telecomsChannelStatus, telecomsInterface=telecomsInterface, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteIPAddress=remoteIPAddress, PYSNMP_MODULE_ID=cambium, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, signalStrengthRatio=signalStrengthRatio, sNMPTrapVersion=sNMPTrapVersion, userTableNumber=userTableNumber, dfs=dfs, supplementaryGroup=supplementaryGroup, softwareVersion=softwareVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimisation=linkModeOptimisation, dfsMeans=dfsMeans, tFTPServerPortNumber=tFTPServerPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, vLANManagementPriority=vLANManagementPriority, sMTPServerPortNumber=sMTPServerPortNumber, userPassword=userPassword, accessMethod=accessMethod, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogClientTrap=syslogClientTrap, sNTPLastSync=sNTPLastSync, dfsTable=dfsTable, pubStatsGroup=pubStatsGroup, sNMPv3Enable=sNMPv3Enable, licensedCapacity=licensedCapacity, cambium=cambium, resetGroup=resetGroup, snmpControl=snmpControl, dataPortAutoMdix=dataPortAutoMdix, syslogControl=syslogControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsGroup=dfsGroup, sNMPCommunityString=sNMPCommunityString, aggregateDataRate=aggregateDataRate, vectorError=vectorError, hTTPSPortNumber=hTTPSPortNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControlGroup=aAAControlGroup, userEnabled=userEnabled, altitude=altitude, sNMPTrapTableEntry=sNMPTrapTableEntry, masterSlaveMode=masterSlaveMode, ptp500=ptp500, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityQueueMapping=vLANPriorityQueueMapping, phyControl=phyControl, targetMACAddress=targetMACAddress, siteName=siteName, managementGroup=managementGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userTable=userTable, receiveChannel=receiveChannel, sNTPServerPortNumber=sNTPServerPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, secondarySoftwareVersion=secondarySoftwareVersion, linkSymmetry=linkSymmetry, incompatibleRegionCodes=incompatibleRegionCodes, userName=userName, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, searchState=searchState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveModulationModeDetail=receiveModulationModeDetail, phyStatus=phyStatus, ptpCompliance=ptpCompliance, aAAControl=aAAControl, encryptionGroup=encryptionGroup, receiveFreqMHz=receiveFreqMHz, sNMPTrapPortNumber=sNMPTrapPortNumber, transmitModulationMode=transmitModulationMode, daylightSaving=daylightSaving, bootVersion=bootVersion, sNMPPortNumber=sNMPPortNumber, pubStats=pubStats, latitude=latitude, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsCableLength=telecomsCableLength, vLANPriorityTable=vLANPriorityTable, sMTPServerIPAddress=sMTPServerIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sntp=sntp, gatewayIPAddress=gatewayIPAddress, sNTPPollInterval=sNTPPollInterval, smtp=smtp, ethernet=ethernet, tFTPServerIPAddress=tFTPServerIPAddress, ptpGroups=ptpGroups, subnetMask=subnetMask, telecomGroup=telecomGroup, telecom=telecom, phyStatusGroup=phyStatusGroup, versionsGroup=versionsGroup, receiveModulationMode=receiveModulationMode, installStatusTrap=installStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, hardwareVersion=hardwareVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, ptpTraps=ptpTraps, ptp=ptp, syslogControlGroup=syslogControlGroup, configuration=configuration, maximumTransmitPower=maximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtpGroup=smtpGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, productName=productName, telnetPortNumber=telnetPortNumber, dfsTableNumber=dfsTableNumber, syslogStateTrap=syslogStateTrap, userTableEntry=userTableEntry, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, groupID=groupID, hTTPPortNumber=hTTPPortNumber, longitude=longitude, licenceGroup=licenceGroup, alarmsGroup=alarmsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPEnabledTraps=sNMPEnabledTraps, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkLoss=linkLoss, syslogLocalWrappedTrap=syslogLocalWrappedTrap, management=management, encryption=encryption, iPAddress=iPAddress, ethernetFiberSupport=ethernetFiberSupport, frequencyVariant=frequencyVariant, useVLANForManagementInterfaces=useVLANForManagementInterfaces)
