...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTraps=ptpTraps, useVLANForManagementInterfaces=useVLANForManagementInterfaces, managementGroup=managementGroup, transmitFreqKHz=transmitFreqKHz, ethernet=ethernet, masterSlaveMode=masterSlaveMode, configuration=configuration, maximumTransmitPower=maximumTransmitPower, sNMPPortNumber=sNMPPortNumber, pubStats=pubStats, vLANPriorityTable=vLANPriorityTable, phyControl=phyControl, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpTrapPrefix=ptpTrapPrefix, dfsPeaks=dfsPeaks, licenceGroup=licenceGroup, cambium=cambium, sNMPTrapPortNumber=sNMPTrapPortNumber, targetMACAddress=targetMACAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecom=telecom, alarms=alarms, syslogControl=syslogControl, phyControlGroup=phyControlGroup, encryptionGroup=encryptionGroup, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsMeans=dfsMeans, capacityLicenseMismatch=capacityLicenseMismatch, encryption=encryption, receiveChannel=receiveChannel, receiveFreqKHz=receiveFreqKHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsTableNumber=dfsTableNumber, siteName=siteName, bootVersion=bootVersion, incompatibleMasterAndSlave=incompatibleMasterAndSlave, snmpControlGroup=snmpControlGroup, antennaGain=antennaGain, ptpCompliance=ptpCompliance, groupID=groupID, dataPortAutoMdix=dataPortAutoMdix, cableLoss=cableLoss, receivePower=receivePower, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkAvailability=wirelessLinkAvailability, secondarySoftwareVersion=secondarySoftwareVersion, installArmState=installArmState, telnetAccessEnabled=telnetAccessEnabled, telecomsLoopback=telecomsLoopback, vLANPriorityTableNumber=vLANPriorityTableNumber, phyStatus=phyStatus, telecomsInterface=telecomsInterface, productVariant=productVariant, bandwidthVariant=bandwidthVariant, installArmStateTrap=installArmStateTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPCommunityString=sNMPCommunityString, wirelessLinkStatus=wirelessLinkStatus, dfsTableIndex=dfsTableIndex, tDDSynchronizationMode=tDDSynchronizationMode, sNTPSyncTrap=sNTPSyncTrap, sMTPServerPortNumber=sMTPServerPortNumber, frequencyVariant=frequencyVariant, linkLoss=linkLoss, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNTPLastSync=sNTPLastSync, sNMPTrapTableIndex=sNMPTrapTableIndex, telnetPortNumber=telnetPortNumber, syslogControlGroup=syslogControlGroup, versionsGroup=versionsGroup, transmitDataRate=transmitDataRate, hTTPSPortNumber=hTTPSPortNumber, reset=reset, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPEmailAlert=sMTPEmailAlert, userEnabled=userEnabled, installStatus=installStatus, userRole=userRole, linkName=linkName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveModulationModeDetail=receiveModulationModeDetail, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPSourceEmailAddress=sMTPSourceEmailAddress, smtpGroup=smtpGroup, iPAddress=iPAddress, tDDControlGroup=tDDControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, configurationGroup=configurationGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqMHz=transmitFreqMHz, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, userTableEntry=userTableEntry, dfsTable=dfsTable, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTableIndex=vLANPriorityTableIndex, versions=versions, dataPortDisabledWarning=dataPortDisabledWarning, transmitChannel=transmitChannel, ethernetGroup=ethernetGroup, sNTPState=sNTPState, systemReset=systemReset, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, licensedCapacity=licensedCapacity, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, daylightSaving=daylightSaving, vectorError=vectorError, hTTPAccessEnabled=hTTPAccessEnabled, timeZone=timeZone, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveDataRate=receiveDataRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, subnetMask=subnetMask, dfsGroup=dfsGroup, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControl=aAAControl, telecomGroup=telecomGroup, sNMPTrapTable=sNMPTrapTable, linkModeOptimisation=linkModeOptimisation, dfs=dfs, phyStatusGroup=phyStatusGroup, syslogClientTrap=syslogClientTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementVID=vLANManagementVID, sMTPServerIPAddress=sMTPServerIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userName=userName, userPassword=userPassword, sNTPPollInterval=sNTPPollInterval, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPServerPortNumber=tFTPServerPortNumber, sntp=sntp, vLANManagementPriority=vLANManagementPriority, encryptionAlgorithm=encryptionAlgorithm, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapVersion=sNMPTrapVersion, supplementary=supplementary, syslogStateTrap=syslogStateTrap, dfsTableEntry=dfsTableEntry, management=management, licence=licence, signalStrengthRatio=signalStrengthRatio, syslogState=syslogState, altitude=altitude, telecomsLoopbackTrap=telecomsLoopbackTrap, softwareVersion=softwareVersion, ptpGroups=ptpGroups, syslogClient=syslogClient, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hardwareVersion=hardwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtp=smtp, systemClock=systemClock, remoteIPAddress=remoteIPAddress, receiveFreqMHz=receiveFreqMHz, transmitModulationMode=transmitModulationMode, ethernetFiberSupport=ethernetFiberSupport, productName=productName, sntpGroup=sntpGroup, hTTPPortNumber=hTTPPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, pubStatsGroup=pubStatsGroup, notificationsGroup=notificationsGroup, tDDControl=tDDControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableNumber=sNMPTrapTableNumber, resetGroup=resetGroup, ptp500=ptp500, ptp=ptp, userTableNumber=userTableNumber, ptmp=ptmp, sNTPSync=sNTPSync, eIRP=eIRP, latitude=latitude, installStatusTrap=installStatusTrap, dataPortStatus=dataPortStatus, byteErrorRatio=byteErrorRatio, range=range, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsChannelStatus=telecomsChannelStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTable=userTable, regionCode=regionCode, alarmsGroup=alarmsGroup, telecomsLineCode=telecomsLineCode, channelChangeTrap=channelChangeTrap, sMTPEnabledMessages=sMTPEnabledMessages, regionCodeTrap=regionCodeTrap, accessMethod=accessMethod, supplementaryGroup=supplementaryGroup, linkSymmetry=linkSymmetry, snmpControl=snmpControl, transmitPower=transmitPower, receiveModulationMode=receiveModulationMode, aAAControlGroup=aAAControlGroup, channelBandwidth=channelBandwidth, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, searchState=searchState, longitude=longitude, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableIndex=userTableIndex)
