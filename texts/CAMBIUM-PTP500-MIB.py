...
ObjectIdentity, IpAddress, Unsigned32, Counter32, Bits, MibIdentifier, Gauge32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, enterprises, TimeTicks, Integer32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Unsigned32", "Counter32", "Bits", "MibIdentifier", "Gauge32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "enterprises", "TimeTicks", "Integer32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, channelBandwidth=channelBandwidth, telnetAccessEnabled=telnetAccessEnabled, linkSymmetry=linkSymmetry, iPAddress=iPAddress, capacityLicenseMismatch=capacityLicenseMismatch, tDDControl=tDDControl, dfsTableNumber=dfsTableNumber, installStatus=installStatus, linkModeOptimisation=linkModeOptimisation, dataPortAutoMdix=dataPortAutoMdix, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPServerPortNumber=tFTPServerPortNumber, userRole=userRole, telecomsLoopback=telecomsLoopback, tDDSynchronizationMode=tDDSynchronizationMode, pubStatsGroup=pubStatsGroup, smtpGroup=smtpGroup, userTableIndex=userTableIndex, longitude=longitude, sMTPServerPortNumber=sMTPServerPortNumber, phyControl=phyControl, sMTPSourceEmailAddress=sMTPSourceEmailAddress, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationAlarm=tDDSynchronizationAlarm, encryptionAlgorithm=encryptionAlgorithm, ethernet=ethernet, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, antennaGain=antennaGain, bootVersion=bootVersion, tDDControlGroup=tDDControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, configurationGroup=configurationGroup, hTTPSPortNumber=hTTPSPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, hTTPAccessEnabled=hTTPAccessEnabled, systemClock=systemClock, managementGroup=managementGroup, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogState=syslogState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, latitude=latitude, sNMPTrapTableNumber=sNMPTrapTableNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, groupID=groupID, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPv3Enable=sNMPv3Enable, userTableEntry=userTableEntry, productVariant=productVariant, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitFreqKHz=transmitFreqKHz, vLANManagementPriority=vLANManagementPriority, ethernetFiberSupport=ethernetFiberSupport, tFTPServerIPAddress=tFTPServerIPAddress, receiveFreqKHz=receiveFreqKHz, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, configuration=configuration, telecom=telecom, telnetPortNumber=telnetPortNumber, notificationsGroup=notificationsGroup, installArmState=installArmState, aAAControl=aAAControl, searchState=searchState, phyStatusGroup=phyStatusGroup, ptpTrapPrefix=ptpTrapPrefix, tDDSynchronizationStatus=tDDSynchronizationStatus, subnetMask=subnetMask, userEnabled=userEnabled, vLANPriorityTable=vLANPriorityTable, receiveFreqMHz=receiveFreqMHz, linkName=linkName, transmitModulationMode=transmitModulationMode, sNTPSyncTrap=sNTPSyncTrap, aAAControlGroup=aAAControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, range=range, regionCodeTrap=regionCodeTrap, encryption=encryption, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTable=sNMPTrapTable, management=management, useVLANForManagementInterfaces=useVLANForManagementInterfaces, timeZone=timeZone, ptpGroups=ptpGroups, altitude=altitude, vLANManagementVID=vLANManagementVID, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomGroup=telecomGroup, userName=userName, dfs=dfs, installStatusTrap=installStatusTrap, licenceGroup=licenceGroup, receivePower=receivePower, signalStrengthRatio=signalStrengthRatio, alarmsGroup=alarmsGroup, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, licence=licence, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ptmp=ptmp, sNMPPortNumber=sNMPPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, dfsTable=dfsTable, frequencyVariant=frequencyVariant, receiveChannel=receiveChannel, sntp=sntp, regionCode=regionCode, telecomsLineCode=telecomsLineCode, sNMPEnabledTraps=sNMPEnabledTraps, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, systemReset=systemReset, dataPortDisabledWarning=dataPortDisabledWarning, vectorError=vectorError, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodes=incompatibleRegionCodes, syslogControl=syslogControl, bandwidthVariant=bandwidthVariant, linkLoss=linkLoss, smtp=smtp, transmitFreqMHz=transmitFreqMHz, hardwareVersion=hardwareVersion, ethernetGroup=ethernetGroup, resetGroup=resetGroup, productName=productName, syslogControlGroup=syslogControlGroup, cableLoss=cableLoss, phyControlGroup=phyControlGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPSync=sNTPSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, daylightSaving=daylightSaving, byteErrorRatio=byteErrorRatio, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpTraps=ptpTraps, dataPortWirelessDownAlert=dataPortWirelessDownAlert, versionsGroup=versionsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableNumber=userTableNumber, pubStats=pubStats, transmitDataRate=transmitDataRate, syslogClientTrap=syslogClientTrap, snmpControlGroup=snmpControlGroup, sNTPPollInterval=sNTPPollInterval, targetMACAddress=targetMACAddress, versions=versions, gatewayIPAddress=gatewayIPAddress, dataPortStatusTrap=dataPortStatusTrap, supplementary=supplementary, phyStatus=phyStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, snmpControl=snmpControl, telecomsChannelStatusTrap=telecomsChannelStatusTrap, siteName=siteName, syslogStateTrap=syslogStateTrap, accessMethod=accessMethod, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, softwareVersion=softwareVersion, maximumTransmitPower=maximumTransmitPower, telecomsInterface=telecomsInterface, telecomsCableLength=telecomsCableLength, dfsPeaks=dfsPeaks, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userPassword=userPassword, dfsGroup=dfsGroup, eIRP=eIRP, sNTPLastSync=sNTPLastSync, syslogClient=syslogClient, dfsTableEntry=dfsTableEntry, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsMeans=dfsMeans, transmitPower=transmitPower, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementaryGroup=supplementaryGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, alarms=alarms, sNTPState=sNTPState, sntpGroup=sntpGroup, encryptionGroup=encryptionGroup, userTable=userTable, ptp500=ptp500, licensedCapacity=licensedCapacity, noWirelessChannelAvailable=noWirelessChannelAvailable, reset=reset, masterSlaveMode=masterSlaveMode, sNTPServerIPAddress=sNTPServerIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, cambium=cambium, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveDataRate=receiveDataRate, installArmStateTrap=installArmStateTrap, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkAvailability=wirelessLinkAvailability, transmitChannel=transmitChannel, remoteIPAddress=remoteIPAddress, dfsTableIndex=dfsTableIndex, telecomsChannelStatus=telecomsChannelStatus, ptpCompliance=ptpCompliance, dataPortStatus=dataPortStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, channelChangeTrap=channelChangeTrap, sNMPCommunityString=sNMPCommunityString, sNMPTrapIPAddress=sNMPTrapIPAddress)
