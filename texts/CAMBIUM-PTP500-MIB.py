...
iso, TimeTicks, ObjectIdentity, Integer32, enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, IpAddress, ModuleIdentity, Unsigned32, Gauge32, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "ObjectIdentity", "Integer32", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "IpAddress", "ModuleIdentity", "Unsigned32", "Gauge32", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptmp=ptmp, vLANPriorityTableNumber=vLANPriorityTableNumber, productName=productName, sNMPv3Enable=sNMPv3Enable, userRole=userRole, linkLoss=linkLoss, ethernetGroup=ethernetGroup, regionCodeTrap=regionCodeTrap, longitude=longitude, sntp=sntp, vLANPriorityTableEntry=vLANPriorityTableEntry, maximumTransmitPower=maximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPSPortNumber=hTTPSPortNumber, notificationsGroup=notificationsGroup, aggregateDataRate=aggregateDataRate, syslogClientTrap=syslogClientTrap, subnetMask=subnetMask, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vLANManagementVID=vLANManagementVID, dfs=dfs, constantPowerSpectralDensity=constantPowerSpectralDensity, frequencyVariant=frequencyVariant, dataPortDisabledWarning=dataPortDisabledWarning, syslogClient=syslogClient, systemClock=systemClock, enabledDiagnosticAlarms=enabledDiagnosticAlarms, bootVersion=bootVersion, userTableIndex=userTableIndex, PYSNMP_MODULE_ID=cambium, supplementaryGroup=supplementaryGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogStateTrap=syslogStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cableLoss=cableLoss, phyControl=phyControl, range=range, snmpControl=snmpControl, receiveModulationMode=receiveModulationMode, sNMPPortNumber=sNMPPortNumber, ptp500=ptp500, secondarySoftwareVersion=secondarySoftwareVersion, smtp=smtp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableNumber=userTableNumber, linkModeOptimisation=linkModeOptimisation, hTTPPortNumber=hTTPPortNumber, transmitFreqKHz=transmitFreqKHz, configuration=configuration, tDDControlGroup=tDDControlGroup, receivePower=receivePower, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPEnabledMessages=sMTPEnabledMessages, telnetAccessEnabled=telnetAccessEnabled, ptpTrapPrefix=ptpTrapPrefix, aAAControlGroup=aAAControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, hardwareVersion=hardwareVersion, phyControlGroup=phyControlGroup, linkName=linkName, productVariant=productVariant, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryptionAlgorithm=encryptionAlgorithm, transmitFreqMHz=transmitFreqMHz, sNMPTrapVersion=sNMPTrapVersion, receiveChannel=receiveChannel, incompatibleRegionCodes=incompatibleRegionCodes, telecomsCableLength=telecomsCableLength, sNMPTrapTableIndex=sNMPTrapTableIndex, ptp=ptp, sNTPState=sNTPState, vLANPriorityTable=vLANPriorityTable, searchState=searchState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoMdix=dataPortAutoMdix, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, targetMACAddress=targetMACAddress, latitude=latitude, management=management, telecom=telecom, pubStatsGroup=pubStatsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, regionCode=regionCode, ptpGroups=ptpGroups, userTable=userTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableIndex=dfsTableIndex, encryption=encryption, telecomsLineCode=telecomsLineCode, altitude=altitude, snmpControlGroup=snmpControlGroup, telecomsChannelStatus=telecomsChannelStatus, ethernetFiberSupport=ethernetFiberSupport, userEnabled=userEnabled, versionsGroup=versionsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userName=userName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionGroup=encryptionGroup, sNTPLastSync=sNTPLastSync, alarms=alarms, licenceGroup=licenceGroup, dfsPeaks=dfsPeaks, wirelessLinkAvailability=wirelessLinkAvailability, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, telecomGroup=telecomGroup, dfsTableNumber=dfsTableNumber, installArmState=installArmState, installStatus=installStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkSymmetry=linkSymmetry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableEntry=dfsTableEntry, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRate=receiveDataRate, telecomsInterface=telecomsInterface, tDDControl=tDDControl, dfsTable=dfsTable, sNMPTrapTable=sNMPTrapTable, masterSlaveMode=masterSlaveMode, byteErrorRatio=byteErrorRatio, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, siteName=siteName, daylightSaving=daylightSaving, accessMethod=accessMethod, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemReset=systemReset, sNMPCommunityString=sNMPCommunityString, hTTPAccessEnabled=hTTPAccessEnabled, sNMPEnabledTraps=sNMPEnabledTraps, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, dfsMeans=dfsMeans, resetGroup=resetGroup, dfsGroup=dfsGroup, capacityLicenseMismatch=capacityLicenseMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, eIRP=eIRP, remoteIPAddress=remoteIPAddress, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, iPAddress=iPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogState=syslogState, supplementary=supplementary, sNTPSyncTrap=sNTPSyncTrap, vLANManagementPriority=vLANManagementPriority, sMTPServerPortNumber=sMTPServerPortNumber, alarmsGroup=alarmsGroup, ptpTraps=ptpTraps, installArmStateTrap=installArmStateTrap, reset=reset, managementGroup=managementGroup, groupID=groupID, signalStrengthRatio=signalStrengthRatio, bandwidthVariant=bandwidthVariant, userTableEntry=userTableEntry, sNTPSync=sNTPSync, channelBandwidth=channelBandwidth, transmitPower=transmitPower, receiveFreqKHz=receiveFreqKHz, vLANPriorityQueueMapping=vLANPriorityQueueMapping, installStatusTrap=installStatusTrap, phyStatusGroup=phyStatusGroup, phyStatus=phyStatus, aAAControl=aAAControl, sNTPPollInterval=sNTPPollInterval, sNTPServerIPAddress=sNTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sMTPEmailAlert=sMTPEmailAlert, cambium=cambium, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, softwareVersion=softwareVersion, tDDSynchronizationMode=tDDSynchronizationMode, transmitChannel=transmitChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versions=versions, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitDataRate=transmitDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, ptpCompliance=ptpCompliance, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, telecomsLoopbackTrap=telecomsLoopbackTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licence=licence, telnetPortNumber=telnetPortNumber, receiveFreqMHz=receiveFreqMHz, gatewayIPAddress=gatewayIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licensedCapacity=licensedCapacity, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, sMTPServerIPAddress=sMTPServerIPAddress, channelChangeTrap=channelChangeTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, userPassword=userPassword, wirelessLinkStatus=wirelessLinkStatus, configurationGroup=configurationGroup, telecomsLoopback=telecomsLoopback, linkModeOptimizationMismatch=linkModeOptimizationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, sntpGroup=sntpGroup, syslogControl=syslogControl, ethernet=ethernet, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegotiation=dataPortAutoNegotiation)
