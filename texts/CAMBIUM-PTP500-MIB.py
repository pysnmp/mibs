...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANPriorityQueueMapping=vLANPriorityQueueMapping, configurationGroup=configurationGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitChannel=transmitChannel, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkAvailability=wirelessLinkAvailability, altitude=altitude, aAAControl=aAAControl, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, timeZone=timeZone, telecomsLineCode=telecomsLineCode, installArmState=installArmState, cambium=cambium, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, regionCode=regionCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkName=linkName, pubStats=pubStats, sNTPLastSync=sNTPLastSync, wirelessLinkStatus=wirelessLinkStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPSync=sNTPSync, linkSymmetry=linkSymmetry, tDDSynchronizationMode=tDDSynchronizationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPAccessEnabled=hTTPAccessEnabled, licenceGroup=licenceGroup, syslogControlGroup=syslogControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, signalStrengthRatio=signalStrengthRatio, transmitFreqKHz=transmitFreqKHz, bootVersion=bootVersion, hardwareVersion=hardwareVersion, productVariant=productVariant, searchState=searchState, ptmp=ptmp, receiveDataRate=receiveDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, installStatus=installStatus, versions=versions, userTableIndex=userTableIndex, dfsTableEntry=dfsTableEntry, accessMethod=accessMethod, telecomsChannelStatus=telecomsChannelStatus, tFTPServerIPAddress=tFTPServerIPAddress, installArmStateTrap=installArmStateTrap, frequencyVariant=frequencyVariant, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, gatewayIPAddress=gatewayIPAddress, transmitDataRate=transmitDataRate, configuration=configuration, ptp500=ptp500, softwareVersion=softwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, longitude=longitude, sNMPTrapPortNumber=sNMPTrapPortNumber, latitude=latitude, range=range, telecomsLoopback=telecomsLoopback, userTable=userTable, telecom=telecom, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogControl=syslogControl, bandwidthVariant=bandwidthVariant, licence=licence, aAAControlGroup=aAAControlGroup, userRole=userRole, dfsTable=dfsTable, productName=productName, systemClock=systemClock, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogStateTrap=syslogStateTrap, receivePower=receivePower, sNMPTrapVersion=sNMPTrapVersion, ptpGroups=ptpGroups, vLANManagementPriority=vLANManagementPriority, supplementaryGroup=supplementaryGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tDDSynchronizationStatus=tDDSynchronizationStatus, versionsGroup=versionsGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsPeaks=dfsPeaks, snmpControl=snmpControl, cableLoss=cableLoss, sNTPPollInterval=sNTPPollInterval, maximumTransmitPower=maximumTransmitPower, phyStatus=phyStatus, ptpTraps=ptpTraps, userEnabled=userEnabled, encryptionAlgorithm=encryptionAlgorithm, smtpGroup=smtpGroup, incompatibleRegionCodes=incompatibleRegionCodes, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sntpGroup=sntpGroup, aggregateDataRate=aggregateDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, PYSNMP_MODULE_ID=cambium, phyControlGroup=phyControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, regionCodeTrap=regionCodeTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogState=syslogState, sNMPCommunityString=sNMPCommunityString, dataPortStatusTrap=dataPortStatusTrap, userTableEntry=userTableEntry, receiveFreqKHz=receiveFreqKHz, daylightSaving=daylightSaving, alarms=alarms, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityTable=vLANPriorityTable, dataPortDisabledWarning=dataPortDisabledWarning, managementGroup=managementGroup, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPSyncTrap=sNTPSyncTrap, ptpTrapPrefix=ptpTrapPrefix, antennaGain=antennaGain, iPAddress=iPAddress, tFTPServerPortNumber=tFTPServerPortNumber, transmitModulationMode=transmitModulationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, smtp=smtp, sntp=sntp, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveModulationModeDetail=receiveModulationModeDetail, telnetAccessEnabled=telnetAccessEnabled, constantPowerSpectralDensity=constantPowerSpectralDensity, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveFreqMHz=receiveFreqMHz, eIRP=eIRP, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hTTPPortNumber=hTTPPortNumber, phyControl=phyControl, supplementary=supplementary, vectorError=vectorError, telecomsInterface=telecomsInterface, licensedCapacity=licensedCapacity, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, encryption=encryption, ethernet=ethernet, sMTPEmailAlert=sMTPEmailAlert, syslogClientTrap=syslogClientTrap, subnetMask=subnetMask, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleMasterAndSlave=incompatibleMasterAndSlave, notificationsGroup=notificationsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, vLANPriorityTableIndex=vLANPriorityTableIndex, ethernetFiberSupport=ethernetFiberSupport, linkModeOptimisation=linkModeOptimisation, phyStatusGroup=phyStatusGroup, sMTPServerIPAddress=sMTPServerIPAddress, dfs=dfs, telecomsCableLength=telecomsCableLength, installStatusTrap=installStatusTrap, syslogClient=syslogClient, dfsMeans=dfsMeans, linkLoss=linkLoss, receiveModulationMode=receiveModulationMode, masterSlaveMode=masterSlaveMode, sNMPv3Enable=sNMPv3Enable, resetGroup=resetGroup, transmitPower=transmitPower, tDDControlGroup=tDDControlGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, snmpControlGroup=snmpControlGroup, tDDControl=tDDControl, dfsTableNumber=dfsTableNumber, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveChannel=receiveChannel, capacityLicenseMismatch=capacityLicenseMismatch, sNTPState=sNTPState, ethernetGroup=ethernetGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, groupID=groupID, channelChangeTrap=channelChangeTrap, userPassword=userPassword, reset=reset, telecomGroup=telecomGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelBandwidth=channelBandwidth, ptp=ptp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableEntry=vLANPriorityTableEntry, alarmsGroup=alarmsGroup, siteName=siteName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, secondarySoftwareVersion=secondarySoftwareVersion, userName=userName, remoteIPAddress=remoteIPAddress, systemReset=systemReset, targetMACAddress=targetMACAddress, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, dfsGroup=dfsGroup, pubStatsGroup=pubStatsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telnetPortNumber=telnetPortNumber, vLANManagementVID=vLANManagementVID, dfsTableIndex=dfsTableIndex, encryptionGroup=encryptionGroup)
