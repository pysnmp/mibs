...
Counter64, Unsigned32, enterprises, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Gauge32, NotificationType, iso, ObjectIdentity, ModuleIdentity, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "enterprises", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Gauge32", "NotificationType", "iso", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", ptpCompliance=ptpCompliance, dataPortDisabledWarning=dataPortDisabledWarning, hTTPPortNumber=hTTPPortNumber, dfsMeans=dfsMeans, sMTPEmailAlert=sMTPEmailAlert, sNTPServerPortNumber=sNTPServerPortNumber, sNTPState=sNTPState, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, ptp500=ptp500, dfsTableNumber=dfsTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, licenceGroup=licenceGroup, snmpControl=snmpControl, vLANManagementPriority=vLANManagementPriority, phyStatusGroup=phyStatusGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitModulationMode=transmitModulationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vectorError=vectorError, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, versions=versions, tDDControlGroup=tDDControlGroup, receiveFreqMHz=receiveFreqMHz, sNTPLastSync=sNTPLastSync, constantPowerSpectralDensity=constantPowerSpectralDensity, capacityLicenseMismatch=capacityLicenseMismatch, ptpGroups=ptpGroups, pubStatsGroup=pubStatsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControlGroup=aAAControlGroup, configuration=configuration, reset=reset, vLANManagementVID=vLANManagementVID, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleRegionCodes=incompatibleRegionCodes, channelChangeTrap=channelChangeTrap, telecomsLoopback=telecomsLoopback, targetMACAddress=targetMACAddress, remoteIPAddress=remoteIPAddress, dfsTable=dfsTable, managementGroup=managementGroup, encryptionGroup=encryptionGroup, sNMPv3Enable=sNMPv3Enable, signalStrengthRatio=signalStrengthRatio, useVLANForManagementInterfaces=useVLANForManagementInterfaces, subnetMask=subnetMask, systemReset=systemReset, channelBandwidth=channelBandwidth, userTableEntry=userTableEntry, ptmp=ptmp, supplementary=supplementary, sNMPTrapTable=sNMPTrapTable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsGroup=dfsGroup, management=management, aAAControl=aAAControl, versionsGroup=versionsGroup, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bootVersion=bootVersion, linkLoss=linkLoss, daylightSaving=daylightSaving, receiveModulationMode=receiveModulationMode, transmitDataRate=transmitDataRate, regionCode=regionCode, syslogClient=syslogClient, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dfsTableEntry=dfsTableEntry, tDDControl=tDDControl, phyControlGroup=phyControlGroup, syslogControl=syslogControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkName=linkName, ptp=ptp, searchState=searchState, hardwareVersion=hardwareVersion, telnetPortNumber=telnetPortNumber, linkSymmetry=linkSymmetry, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogClientTrap=syslogClientTrap, sNTPSync=sNTPSync, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, regionCodeTrap=regionCodeTrap, vLANPriorityTable=vLANPriorityTable, installArmStateTrap=installArmStateTrap, timeZone=timeZone, dfsPeaks=dfsPeaks, userTableNumber=userTableNumber, telecom=telecom, userTable=userTable, ptpTraps=ptpTraps, licensedCapacity=licensedCapacity, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityString=sNMPCommunityString, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, receiveChannel=receiveChannel, sntpGroup=sntpGroup, antennaGain=antennaGain, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, frequencyVariant=frequencyVariant, ethernet=ethernet, tFTPServerPortNumber=tFTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, licence=licence, sNMPTrapTableNumber=sNMPTrapTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, longitude=longitude, ptpTrapPrefix=ptpTrapPrefix, latitude=latitude, configurationGroup=configurationGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ethernetGroup=ethernetGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, gatewayIPAddress=gatewayIPAddress, userPassword=userPassword, transmitFreqMHz=transmitFreqMHz, supplementaryGroup=supplementaryGroup, phyStatus=phyStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, smtpGroup=smtpGroup, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPPortNumber=sNMPPortNumber, installStatusTrap=installStatusTrap, tDDSynchronizationMode=tDDSynchronizationMode, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalWrappedTrap=syslogLocalWrappedTrap, PYSNMP_MODULE_ID=cambium, encryption=encryption, productVariant=productVariant, bandwidthVariant=bandwidthVariant, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableIndex=userTableIndex, userName=userName, snmpControlGroup=snmpControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetAccessEnabled=telnetAccessEnabled, sNTPSyncTrap=sNTPSyncTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsLineCode=telecomsLineCode, encryptionAlgorithm=encryptionAlgorithm, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogStateTrap=syslogStateTrap, productName=productName, ethernetFiberSupport=ethernetFiberSupport, receivePower=receivePower, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomGroup=telecomGroup, linkModeOptimisation=linkModeOptimisation, hTTPSPortNumber=hTTPSPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkAvailability=wirelessLinkAvailability, eIRP=eIRP, userRole=userRole, unitOutOfCalibration=unitOutOfCalibration, aggregateDataRate=aggregateDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, alarms=alarms, wirelessLinkStatus=wirelessLinkStatus, altitude=altitude, noWirelessChannelAvailable=noWirelessChannelAvailable, userEnabled=userEnabled, accessMethod=accessMethod, transmitChannel=transmitChannel, telecomsLoopbackTrap=telecomsLoopbackTrap, telecomsInterface=telecomsInterface, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqKHz=transmitFreqKHz, notificationsGroup=notificationsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortStatus=dataPortStatus, transmitPower=transmitPower, receiveFreqKHz=receiveFreqKHz, siteName=siteName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, smtp=smtp, iPAddress=iPAddress, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRate=receiveDataRate, linkModeOptimizationMismatch=linkModeOptimizationMismatch, masterSlaveMode=masterSlaveMode, sntp=sntp, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoMdix=dataPortAutoMdix, systemClock=systemClock, telecomsCableLength=telecomsCableLength, installStatus=installStatus, syslogControlGroup=syslogControlGroup, sNTPPollInterval=sNTPPollInterval, phyControl=phyControl, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, byteErrorRatio=byteErrorRatio, dfsTableIndex=dfsTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfs=dfs, pubStats=pubStats, cambium=cambium, range=range, maximumTransmitPower=maximumTransmitPower, resetGroup=resetGroup, groupID=groupID, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, syslogState=syslogState, vLANPriorityTableIndex=vLANPriorityTableIndex)
