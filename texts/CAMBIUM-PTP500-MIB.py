...
IpAddress, Gauge32, Unsigned32, TimeTicks, iso, Counter64, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, ModuleIdentity, Integer32, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "Unsigned32", "TimeTicks", "iso", "Counter64", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Integer32", "enterprises", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogClientTrap=syslogClientTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkSymmetry=linkSymmetry, telecomsLoopback=telecomsLoopback, unitOutOfCalibration=unitOutOfCalibration, tDDControlGroup=tDDControlGroup, encryptionGroup=encryptionGroup, ptp500=ptp500, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsGroup=dfsGroup, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, regionCodeTrap=regionCodeTrap, resetGroup=resetGroup, sNTPServerIPAddress=sNTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogStateTrap=syslogStateTrap, syslogControlGroup=syslogControlGroup, linkModeOptimisation=linkModeOptimisation, dfsTableNumber=dfsTableNumber, supplementaryGroup=supplementaryGroup, receiveModulationModeDetail=receiveModulationModeDetail, syslogClient=syslogClient, dataPortStatusTrap=dataPortStatusTrap, installStatusTrap=installStatusTrap, management=management, aAAControl=aAAControl, sNMPCommunityString=sNMPCommunityString, snmpControl=snmpControl, sMTPServerPortNumber=sMTPServerPortNumber, receiveModulationMode=receiveModulationMode, range=range, phyControl=phyControl, ptpGroups=ptpGroups, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, eIRP=eIRP, wirelessLinkAvailability=wirelessLinkAvailability, systemReset=systemReset, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsTableEntry=dfsTableEntry, snmpControlGroup=snmpControlGroup, vectorError=vectorError, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptp=ptp, transmitDataRate=transmitDataRate, dfsTableIndex=dfsTableIndex, userTableIndex=userTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, latitude=latitude, phyStatus=phyStatus, vLANPriorityTable=vLANPriorityTable, configurationGroup=configurationGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitPower=transmitPower, cambium=cambium, remoteIPAddress=remoteIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tDDControl=tDDControl, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, telnetPortNumber=telnetPortNumber, sNTPState=sNTPState, tDDSynchronizationMode=tDDSynchronizationMode, userRole=userRole, frequencyVariant=frequencyVariant, managementGroup=managementGroup, aggregateDataRate=aggregateDataRate, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveDataRate=receiveDataRate, sNMPPortNumber=sNMPPortNumber, userPassword=userPassword, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomGroup=telecomGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, versions=versions, pubStatsGroup=pubStatsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, timeZone=timeZone, syslogState=syslogState, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfs=dfs, alarmsGroup=alarmsGroup, telecom=telecom, installArmState=installArmState, encryption=encryption, longitude=longitude, userEnabled=userEnabled, vLANManagementVID=vLANManagementVID, PYSNMP_MODULE_ID=cambium, productVariant=productVariant, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, telecomsLoopbackTrap=telecomsLoopbackTrap, regionCode=regionCode, telecomsInterface=telecomsInterface, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hTTPPortNumber=hTTPPortNumber, ethernet=ethernet, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqKHz=transmitFreqKHz, vLANPriorityTableIndex=vLANPriorityTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, sNMPEnabledTraps=sNMPEnabledTraps, systemClock=systemClock, sMTPServerIPAddress=sMTPServerIPAddress, vLANManagementPriority=vLANManagementPriority, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPv3Enable=sNMPv3Enable, sNMPTrapVersion=sNMPTrapVersion, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, transmitFreqMHz=transmitFreqMHz, licensedCapacity=licensedCapacity, telecomsChannelStatus=telecomsChannelStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatus=dataPortStatus, syslogControl=syslogControl, ptpTrapPrefix=ptpTrapPrefix, cableLoss=cableLoss, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortDisabledWarning=dataPortDisabledWarning, smtp=smtp, installArmStateTrap=installArmStateTrap, userTable=userTable, dfsMeans=dfsMeans, ptmp=ptmp, targetMACAddress=targetMACAddress, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, byteErrorRatio=byteErrorRatio, sNTPLastSync=sNTPLastSync, secondarySoftwareVersion=secondarySoftwareVersion, antennaGain=antennaGain, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, alarms=alarms, supplementary=supplementary, ptpCompliance=ptpCompliance, dfsTable=dfsTable, daylightSaving=daylightSaving, linkName=linkName, transmitChannel=transmitChannel, dataPortAutoMdix=dataPortAutoMdix, installStatus=installStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, groupID=groupID, userTableEntry=userTableEntry, signalStrengthRatio=signalStrengthRatio, configuration=configuration, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionAlgorithm=encryptionAlgorithm, userName=userName, sNTPSync=sNTPSync, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, siteName=siteName, aAAControlGroup=aAAControlGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, licence=licence, phyControlGroup=phyControlGroup, ethernetFiberSupport=ethernetFiberSupport, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, sMTPEmailAlert=sMTPEmailAlert, hardwareVersion=hardwareVersion, sntp=sntp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, channelBandwidth=channelBandwidth, sNTPServerPortNumber=sNTPServerPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyStatusGroup=phyStatusGroup, channelChangeTrap=channelChangeTrap, hTTPSPortNumber=hTTPSPortNumber, telecomsCableLength=telecomsCableLength, receiveChannel=receiveChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receivePower=receivePower, sNTPPollInterval=sNTPPollInterval, maximumTransmitPower=maximumTransmitPower, productName=productName, smtpGroup=smtpGroup, subnetMask=subnetMask, accessMethod=accessMethod, telecomsLineCode=telecomsLineCode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, versionsGroup=versionsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ethernetGroup=ethernetGroup, licenceGroup=licenceGroup, userTableNumber=userTableNumber, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsPeaks=dfsPeaks, noWirelessChannelAvailable=noWirelessChannelAvailable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveFreqMHz=receiveFreqMHz, softwareVersion=softwareVersion, notificationsGroup=notificationsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, altitude=altitude, iPAddress=iPAddress, linkLoss=linkLoss, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntpGroup=sntpGroup)
