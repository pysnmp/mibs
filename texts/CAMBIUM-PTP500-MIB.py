...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", versions=versions, softwareVersion=softwareVersion, vLANManagementVID=vLANManagementVID, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dfsTableEntry=dfsTableEntry, hTTPPortNumber=hTTPPortNumber, frequencyVariant=frequencyVariant, receiveChannel=receiveChannel, sNMPTrapTableNumber=sNMPTrapTableNumber, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpGroups=ptpGroups, sNMPv3Enable=sNMPv3Enable, sMTPEnabledMessages=sMTPEnabledMessages, accessMethod=accessMethod, bootVersion=bootVersion, transmitModulationMode=transmitModulationMode, dataPortStatusTrap=dataPortStatusTrap, dfsTable=dfsTable, sMTPServerPortNumber=sMTPServerPortNumber, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableEntry=userTableEntry, syslogClientTrap=syslogClientTrap, linkLoss=linkLoss, sNTPLastSync=sNTPLastSync, maximumTransmitPower=maximumTransmitPower, iPAddress=iPAddress, receiveFreqKHz=receiveFreqKHz, installArmState=installArmState, vLANPriorityTable=vLANPriorityTable, latitude=latitude, snmpControlGroup=snmpControlGroup, sntpGroup=sntpGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyControl=phyControl, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegionCodes=incompatibleRegionCodes, telnetPortNumber=telnetPortNumber, altitude=altitude, dfsTableIndex=dfsTableIndex, sNTPState=sNTPState, receivePower=receivePower, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpTraps=ptpTraps, syslogControlGroup=syslogControlGroup, supplementaryGroup=supplementaryGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogState=syslogState, PYSNMP_MODULE_ID=cambium, receiveModulationMode=receiveModulationMode, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, daylightSaving=daylightSaving, useVLANForManagementInterfaces=useVLANForManagementInterfaces, alarms=alarms, wirelessLinkStatus=wirelessLinkStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup, siteName=siteName, searchState=searchState, sNTPServerPortNumber=sNTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, smtpGroup=smtpGroup, telecomsInterface=telecomsInterface, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsGroup=dfsGroup, ethernetGroup=ethernetGroup, targetMACAddress=targetMACAddress, capacityLicenseMismatch=capacityLicenseMismatch, unitOutOfCalibration=unitOutOfCalibration, licence=licence, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkSymmetry=linkSymmetry, installStatus=installStatus, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapPortNumber=sNMPTrapPortNumber, bandwidthVariant=bandwidthVariant, ptpCompliance=ptpCompliance, management=management, dfsPeaks=dfsPeaks, sNTPPollInterval=sNTPPollInterval, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, linkModeOptimisation=linkModeOptimisation, ptpTrapPrefix=ptpTrapPrefix, dfs=dfs, configuration=configuration, productName=productName, constantPowerSpectralDensity=constantPowerSpectralDensity, wirelessLinkAvailability=wirelessLinkAvailability, hTTPSPortNumber=hTTPSPortNumber, vLANManagementPriority=vLANManagementPriority, groupID=groupID, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableNumber=userTableNumber, tFTPServerPortNumber=tFTPServerPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, masterSlaveMode=masterSlaveMode, sMTPServerIPAddress=sMTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDControl=tDDControl, receiveDataRate=receiveDataRate, subnetMask=subnetMask, telecomsCableLength=telecomsCableLength, userEnabled=userEnabled, versionsGroup=versionsGroup, encryption=encryption, encryptionGroup=encryptionGroup, signalStrengthRatio=signalStrengthRatio, secondarySoftwareVersion=secondarySoftwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPAccessEnabled=hTTPAccessEnabled, byteErrorRatio=byteErrorRatio, systemClock=systemClock, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, range=range, linkName=linkName, sNMPCommunityString=sNMPCommunityString, installArmStateTrap=installArmStateTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntp=sntp, productVariant=productVariant, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableNumber=dfsTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsChannelStatus=telecomsChannelStatus, telecomGroup=telecomGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTable=userTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapIPAddress=sNMPTrapIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userName=userName, installStatusTrap=installStatusTrap, dataPortStatus=dataPortStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, vectorError=vectorError, systemReset=systemReset, ptp=ptp, dfsMeans=dfsMeans, cambium=cambium, channelBandwidth=channelBandwidth, syslogStateTrap=syslogStateTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userPassword=userPassword, notificationsGroup=notificationsGroup, regionCode=regionCode, transmitFreqKHz=transmitFreqKHz, ptmp=ptmp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecom=telecom, syslogControl=syslogControl, managementGroup=managementGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogClient=syslogClient, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoMdix=dataPortAutoMdix, longitude=longitude, channelChangeTrap=channelChangeTrap, transmitPower=transmitPower, ethernet=ethernet, hTTPSAccessEnabled=hTTPSAccessEnabled, pubStatsGroup=pubStatsGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogLocalWrappedTrap=syslogLocalWrappedTrap, supplementary=supplementary, resetGroup=resetGroup, transmitFreqMHz=transmitFreqMHz, licenceGroup=licenceGroup, sNMPTrapTable=sNMPTrapTable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, aggregateDataRate=aggregateDataRate, sNMPTrapTableIndex=sNMPTrapTableIndex, snmpControl=snmpControl, cableLoss=cableLoss, eIRP=eIRP, configurationGroup=configurationGroup, userTableIndex=userTableIndex, transmitDataRate=transmitDataRate, remoteIPAddress=remoteIPAddress, phyStatus=phyStatus, userRole=userRole, hardwareVersion=hardwareVersion, gatewayIPAddress=gatewayIPAddress, antennaGain=antennaGain, sNMPTrapVersion=sNMPTrapVersion, aAAControl=aAAControl, telecomsLoopbackTrap=telecomsLoopbackTrap, ptp500=ptp500, tDDControlGroup=tDDControlGroup, transmitChannel=transmitChannel, reset=reset, telecomsLineCode=telecomsLineCode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortDisabledWarning=dataPortDisabledWarning, aAAControlGroup=aAAControlGroup, telecomsLoopback=telecomsLoopback, licensedCapacity=licensedCapacity, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, phyStatusGroup=phyStatusGroup, phyControlGroup=phyControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, telecomsChannelStatusTrap=telecomsChannelStatusTrap)
