...
NotificationType, enterprises, TimeTicks, Bits, ObjectIdentity, Unsigned32, iso, IpAddress, MibIdentifier, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "enterprises", "TimeTicks", "Bits", "ObjectIdentity", "Unsigned32", "iso", "IpAddress", "MibIdentifier", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", cambium=cambium, channelBandwidth=channelBandwidth, syslogClient=syslogClient, dfsGroup=dfsGroup, userEnabled=userEnabled, tFTPServerIPAddress=tFTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, linkLoss=linkLoss, dfsTableEntry=dfsTableEntry, phyControl=phyControl, sNMPTrapTableIndex=sNMPTrapTableIndex, regionCode=regionCode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveModulationModeDetail=receiveModulationModeDetail, snmpControl=snmpControl, ethernet=ethernet, incompatibleRegionCodes=incompatibleRegionCodes, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPPortNumber=sNMPPortNumber, supplementaryGroup=supplementaryGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogState=syslogState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, configurationGroup=configurationGroup, supplementary=supplementary, smtpGroup=smtpGroup, dataPortDisabledWarning=dataPortDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, sMTPServerIPAddress=sMTPServerIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptpGroups=ptpGroups, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, userName=userName, telecomGroup=telecomGroup, dataPortStatus=dataPortStatus, tDDSynchronizationMode=tDDSynchronizationMode, systemReset=systemReset, syslogClientTrap=syslogClientTrap, versionsGroup=versionsGroup, ptp500=ptp500, softwareVersion=softwareVersion, productName=productName, telecomsInterface=telecomsInterface, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapVersion=sNMPTrapVersion, hTTPAccessEnabled=hTTPAccessEnabled, installArmStateTrap=installArmStateTrap, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, vLANPriorityTableIndex=vLANPriorityTableIndex, eIRP=eIRP, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTableIndex=dfsTableIndex, secondarySoftwareVersion=secondarySoftwareVersion, regionCodeTrap=regionCodeTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, phyStatusGroup=phyStatusGroup, telecomsLineCode=telecomsLineCode, tDDControl=tDDControl, dfsMeans=dfsMeans, maximumTransmitPower=maximumTransmitPower, ethernetFiberSupport=ethernetFiberSupport, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogStateTrap=syslogStateTrap, sntpGroup=sntpGroup, siteName=siteName, transmitFreqMHz=transmitFreqMHz, hardwareVersion=hardwareVersion, licenceGroup=licenceGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpCompliance=ptpCompliance, productVariant=productVariant, userPassword=userPassword, vectorError=vectorError, receiveModulationMode=receiveModulationMode, capacityLicenseMismatch=capacityLicenseMismatch, sNTPServerIPAddress=sNTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, licensedCapacity=licensedCapacity, longitude=longitude, notificationsGroup=notificationsGroup, userTableEntry=userTableEntry, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, ptmp=ptmp, bootVersion=bootVersion, frequencyVariant=frequencyVariant, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, ethernetGroup=ethernetGroup, telecomsCableLength=telecomsCableLength, bandwidthVariant=bandwidthVariant, groupID=groupID, dfsPeaks=dfsPeaks, dfsTable=dfsTable, sNTPSyncTrap=sNTPSyncTrap, versions=versions, alarms=alarms, resetGroup=resetGroup, linkModeOptimisation=linkModeOptimisation, searchState=searchState, encryptionGroup=encryptionGroup, userTableNumber=userTableNumber, dfs=dfs, masterSlaveMode=masterSlaveMode, aggregateDataRate=aggregateDataRate, range=range, userRole=userRole, snmpControlGroup=snmpControlGroup, PYSNMP_MODULE_ID=cambium, targetMACAddress=targetMACAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPv3Enable=sNMPv3Enable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTable=userTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, subnetMask=subnetMask, tDDSynchronizationAlarm=tDDSynchronizationAlarm, aAAControl=aAAControl, alarmsGroup=alarmsGroup, timeZone=timeZone, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDControlGroup=tDDControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, aAAControlGroup=aAAControlGroup, userTableIndex=userTableIndex, transmitChannel=transmitChannel, tDDSynchronizationStatus=tDDSynchronizationStatus, encryptionAlgorithm=encryptionAlgorithm, receiveFreqKHz=receiveFreqKHz, ptpTrapPrefix=ptpTrapPrefix, gatewayIPAddress=gatewayIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANPriorityTable=vLANPriorityTable, linkSymmetry=linkSymmetry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, configuration=configuration, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyControlGroup=phyControlGroup, byteErrorRatio=byteErrorRatio, smtp=smtp, sntp=sntp, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPEnabledTraps=sNMPEnabledTraps, daylightSaving=daylightSaving, installArmState=installArmState, transmitDataRate=transmitDataRate, telnetAccessEnabled=telnetAccessEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, pubStatsGroup=pubStatsGroup, telnetPortNumber=telnetPortNumber, transmitModulationMode=transmitModulationMode, licence=licence, dfsTableNumber=dfsTableNumber, altitude=altitude, managementGroup=managementGroup, wirelessLinkStatus=wirelessLinkStatus, reset=reset, telecomsLoopback=telecomsLoopback, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementVID=vLANManagementVID, iPAddress=iPAddress, management=management, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, channelChangeTrap=channelChangeTrap, sNMPTrapTable=sNMPTrapTable, installStatus=installStatus, telecomsChannelStatus=telecomsChannelStatus, hTTPSPortNumber=hTTPSPortNumber, ptpTraps=ptpTraps, receivePower=receivePower, cableLoss=cableLoss, encryption=encryption, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPSourceEmailAddress=sMTPSourceEmailAddress, latitude=latitude, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, constantPowerSpectralDensity=constantPowerSpectralDensity, receiveFreqMHz=receiveFreqMHz, signalStrengthRatio=signalStrengthRatio, vLANManagementPriority=vLANManagementPriority, sNTPServerPortNumber=sNTPServerPortNumber, telecom=telecom, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitFreqKHz=transmitFreqKHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPEnabledMessages=sMTPEnabledMessages, wirelessLinkAvailability=wirelessLinkAvailability, accessMethod=accessMethod, installStatusTrap=installStatusTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveChannel=receiveChannel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, syslogControlGroup=syslogControlGroup, linkName=linkName, antennaGain=antennaGain, sNTPState=sNTPState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, systemClock=systemClock, hTTPPortNumber=hTTPPortNumber, sNTPSync=sNTPSync, syslogControl=syslogControl, sNTPLastSync=sNTPLastSync)
