...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, altitude=altitude, transmitFreqKHz=transmitFreqKHz, unitOutOfCalibration=unitOutOfCalibration, receiveChannel=receiveChannel, phyControl=phyControl, configuration=configuration, systemReset=systemReset, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapTableEntry=sNMPTrapTableEntry, regionCode=regionCode, hTTPAccessEnabled=hTTPAccessEnabled, phyControlGroup=phyControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationMode=tDDSynchronizationMode, dfsTableEntry=dfsTableEntry, licensedCapacity=licensedCapacity, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsCableLength=telecomsCableLength, dataPortDisabledWarning=dataPortDisabledWarning, userRole=userRole, managementGroup=managementGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptpCompliance=ptpCompliance, telecomsChannelStatus=telecomsChannelStatus, masterSlaveMode=masterSlaveMode, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPollInterval=sNTPPollInterval, groupID=groupID, vectorError=vectorError, installArmState=installArmState, wirelessLinkStatus=wirelessLinkStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitDataRate=transmitDataRate, sNMPTrapPortNumber=sNMPTrapPortNumber, installStatus=installStatus, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, userTableEntry=userTableEntry, targetMACAddress=targetMACAddress, telecomsInterface=telecomsInterface, aAAControl=aAAControl, noWirelessChannelAvailable=noWirelessChannelAvailable, telecom=telecom, telnetPortNumber=telnetPortNumber, sNTPSync=sNTPSync, vLANPriorityTableIndex=vLANPriorityTableIndex, snmpControlGroup=snmpControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPServerPortNumber=tFTPServerPortNumber, management=management, versionsGroup=versionsGroup, softwareVersion=softwareVersion, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptp500=ptp500, telnetAccessEnabled=telnetAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, telecomsLoopbackTrap=telecomsLoopbackTrap, pubStats=pubStats, bandwidthVariant=bandwidthVariant, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableNumber=dfsTableNumber, hTTPPortNumber=hTTPPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, iPAddress=iPAddress, dfsGroup=dfsGroup, subnetMask=subnetMask, syslogControl=syslogControl, receiveFreqKHz=receiveFreqKHz, capacityLicenseMismatch=capacityLicenseMismatch, smtpGroup=smtpGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productName=productName, receiveModulationMode=receiveModulationMode, cambium=cambium, hTTPSPortNumber=hTTPSPortNumber, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, vLANManagementPriority=vLANManagementPriority, siteName=siteName, transmitPower=transmitPower, syslogState=syslogState, accessMethod=accessMethod, longitude=longitude, telecomsLoopback=telecomsLoopback, productVariant=productVariant, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, gatewayIPAddress=gatewayIPAddress, syslogStateTrap=syslogStateTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANManagementVID=vLANManagementVID, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetFiberSupport=ethernetFiberSupport, remoteIPAddress=remoteIPAddress, sNMPTrapTable=sNMPTrapTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, notificationsGroup=notificationsGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userEnabled=userEnabled, PYSNMP_MODULE_ID=cambium, regionCodeTrap=regionCodeTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDControl=tDDControl, tDDControlGroup=tDDControlGroup, linkModeOptimisation=linkModeOptimisation, timeZone=timeZone, dfsPeaks=dfsPeaks, antennaGain=antennaGain, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogClient=syslogClient, vLANPriorityTableEntry=vLANPriorityTableEntry, syslogControlGroup=syslogControlGroup, userTableIndex=userTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userName=userName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, eIRP=eIRP, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, channelChangeTrap=channelChangeTrap, searchState=searchState, sMTPEnabledMessages=sMTPEnabledMessages, dfsTable=dfsTable, bootVersion=bootVersion, channelBandwidth=channelBandwidth, dfs=dfs, aAAControlGroup=aAAControlGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, licence=licence, dfsMeans=dfsMeans, sNTPState=sNTPState, versions=versions, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, sNMPPortNumber=sNMPPortNumber, resetGroup=resetGroup, sNMPCommunityString=sNMPCommunityString, latitude=latitude, configurationGroup=configurationGroup, sNTPServerIPAddress=sNTPServerIPAddress, transmitChannel=transmitChannel, syslogClientTrap=syslogClientTrap, linkLoss=linkLoss, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptp=ptp, dataPortStatus=dataPortStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, sntpGroup=sntpGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, encryptionGroup=encryptionGroup, smtp=smtp, frequencyVariant=frequencyVariant, dataPortStatusTrap=dataPortStatusTrap, userTable=userTable, encryption=encryption, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installArmStateTrap=installArmStateTrap, receivePower=receivePower, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableNumber=userTableNumber, supplementaryGroup=supplementaryGroup, aggregateDataRate=aggregateDataRate, userPassword=userPassword, snmpControl=snmpControl, pubStatsGroup=pubStatsGroup, linkSymmetry=linkSymmetry, licenceGroup=licenceGroup, alarmsGroup=alarmsGroup, reset=reset, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityTable=vLANPriorityTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomGroup=telecomGroup, sNMPv3Enable=sNMPv3Enable, sNTPSyncTrap=sNTPSyncTrap, sMTPServerPortNumber=sMTPServerPortNumber, hardwareVersion=hardwareVersion, cableLoss=cableLoss, ethernet=ethernet, linkName=linkName, incompatibleRegionCodes=incompatibleRegionCodes, receiveDataRate=receiveDataRate, sNMPTrapVersion=sNMPTrapVersion, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPLastSync=sNTPLastSync, ptmp=ptmp, supplementary=supplementary, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveFreqMHz=receiveFreqMHz, range=range, signalStrengthRatio=signalStrengthRatio, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLineCode=telecomsLineCode, ptpTraps=ptpTraps, maximumTransmitPower=maximumTransmitPower, sNTPServerPortNumber=sNTPServerPortNumber, dfsTableIndex=dfsTableIndex, alarms=alarms, secondarySoftwareVersion=secondarySoftwareVersion, transmitFreqMHz=transmitFreqMHz, sntp=sntp, daylightSaving=daylightSaving, phyStatus=phyStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, installStatusTrap=installStatusTrap)
