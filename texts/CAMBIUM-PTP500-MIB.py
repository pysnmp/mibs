...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", hTTPPortNumber=hTTPPortNumber, signalStrengthRatio=signalStrengthRatio, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, sNMPCommunityString=sNMPCommunityString, hTTPSAccessEnabled=hTTPSAccessEnabled, userRole=userRole, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sntp=sntp, regionCodeTrap=regionCodeTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, softwareVersion=softwareVersion, phyControlGroup=phyControlGroup, groupID=groupID, wirelessLinkStatus=wirelessLinkStatus, aggregateDataRate=aggregateDataRate, tDDControlGroup=tDDControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, accessMethod=accessMethod, byteErrorRatio=byteErrorRatio, secondarySoftwareVersion=secondarySoftwareVersion, telecomGroup=telecomGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveFreqMHz=receiveFreqMHz, userTableNumber=userTableNumber, receiveModulationModeDetail=receiveModulationModeDetail, telecom=telecom, phyControl=phyControl, telnetPortNumber=telnetPortNumber, receiveFreqKHz=receiveFreqKHz, systemReset=systemReset, syslogClientTrap=syslogClientTrap, ptpTraps=ptpTraps, sMTPEmailAlert=sMTPEmailAlert, reset=reset, PYSNMP_MODULE_ID=cambium, frequencyVariant=frequencyVariant, transmitModulationMode=transmitModulationMode, sNMPTrapVersion=sNMPTrapVersion, aAAControlGroup=aAAControlGroup, gatewayIPAddress=gatewayIPAddress, telecomsCableLength=telecomsCableLength, vLANPriorityTableIndex=vLANPriorityTableIndex, ptp500=ptp500, timeZone=timeZone, encryptionAlgorithm=encryptionAlgorithm, subnetMask=subnetMask, dfsMeans=dfsMeans, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, versionsGroup=versionsGroup, range=range, aAAControl=aAAControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsLineCode=telecomsLineCode, sMTPEnabledMessages=sMTPEnabledMessages, licensedCapacity=licensedCapacity, telnetAccessEnabled=telnetAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, ptmp=ptmp, supplementary=supplementary, sntpGroup=sntpGroup, managementGroup=managementGroup, ethernetFiberSupport=ethernetFiberSupport, hTTPSPortNumber=hTTPSPortNumber, userTable=userTable, userEnabled=userEnabled, channelChangeTrap=channelChangeTrap, installStatus=installStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, licenceGroup=licenceGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, installStatusTrap=installStatusTrap, antennaGain=antennaGain, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, vLANManagementVID=vLANManagementVID, alarmsGroup=alarmsGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, management=management, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, alarms=alarms, vLANPriorityTableNumber=vLANPriorityTableNumber, ptp=ptp, snmpControl=snmpControl, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPServerPortNumber=tFTPServerPortNumber, longitude=longitude, remoteMaximumTransmitPower=remoteMaximumTransmitPower, cableLoss=cableLoss, ethernetGroup=ethernetGroup, tFTPServerIPAddress=tFTPServerIPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableEntry=userTableEntry, dfsTableEntry=dfsTableEntry, sNTPPollInterval=sNTPPollInterval, sNTPSync=sNTPSync, notificationsGroup=notificationsGroup, configuration=configuration, syslogState=syslogState, tDDControl=tDDControl, dataPortStatusTrap=dataPortStatusTrap, userName=userName, vLANManagementPriority=vLANManagementPriority, snmpControlGroup=snmpControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, targetMACAddress=targetMACAddress, transmitPower=transmitPower, maximumTransmitPower=maximumTransmitPower, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapTableIndex=sNMPTrapTableIndex, productName=productName, regionCode=regionCode, linkLoss=linkLoss, dfsTable=dfsTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, altitude=altitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkAvailability=wirelessLinkAvailability, capacityLicenseMismatch=capacityLicenseMismatch, telecomsLoopback=telecomsLoopback, productVariant=productVariant, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapTable=sNMPTrapTable, linkName=linkName, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogStateTrap=syslogStateTrap, transmitChannel=transmitChannel, siteName=siteName, ptpCompliance=ptpCompliance, licence=licence, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, installArmStateTrap=installArmStateTrap, eIRP=eIRP, versions=versions, resetGroup=resetGroup, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPSyncTrap=sNTPSyncTrap, dfsPeaks=dfsPeaks, vLANPriorityTable=vLANPriorityTable, smtpGroup=smtpGroup, ethernet=ethernet, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, searchState=searchState, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpGroups=ptpGroups, transmitFreqKHz=transmitFreqKHz, receivePower=receivePower, sNMPv3Enable=sNMPv3Enable, installArmState=installArmState, tDDSynchronizationMode=tDDSynchronizationMode, linkSymmetry=linkSymmetry, userPassword=userPassword, smtp=smtp, supplementaryGroup=supplementaryGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfs=dfs, transmitFreqMHz=transmitFreqMHz, bootVersion=bootVersion, userTableIndex=userTableIndex, transmitDataRate=transmitDataRate, pubStatsGroup=pubStatsGroup, masterSlaveMode=masterSlaveMode, vectorError=vectorError, sMTPSourceEmailAddress=sMTPSourceEmailAddress, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, bandwidthVariant=bandwidthVariant, incompatibleRegionCodes=incompatibleRegionCodes, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsInterface=telecomsInterface, sNTPServerPortNumber=sNTPServerPortNumber, dfsTableNumber=dfsTableNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogClient=syslogClient, cambium=cambium, phyStatus=phyStatus, syslogControl=syslogControl, vLANPriorityTableEntry=vLANPriorityTableEntry, remoteIPAddress=remoteIPAddress, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, hardwareVersion=hardwareVersion, iPAddress=iPAddress, daylightSaving=daylightSaving, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPPortNumber=sNMPPortNumber, systemClock=systemClock, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsChannelStatus=telecomsChannelStatus, dfsGroup=dfsGroup, dfsTableIndex=dfsTableIndex, hTTPAccessEnabled=hTTPAccessEnabled, phyStatusGroup=phyStatusGroup, receiveDataRate=receiveDataRate, receiveModulationMode=receiveModulationMode, dataPortStatus=dataPortStatus, linkModeOptimisation=linkModeOptimisation, encryption=encryption, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPState=sNTPState, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionGroup=encryptionGroup, configurationGroup=configurationGroup, latitude=latitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
