...
# Produced by pysmi-1.1.3 at Sun Nov 28 16:32:57 2021
...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Integer32, ObjectIdentity, Counter32, NotificationType, Gauge32, MibIdentifier, Bits, enterprises, TimeTicks, iso, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Integer32", "ObjectIdentity", "Counter32", "NotificationType", "Gauge32", "MibIdentifier", "Bits", "enterprises", "TimeTicks", "iso", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, timeZone=timeZone, syslogControlGroup=syslogControlGroup, dfsGroup=dfsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, wirelessLinkStatus=wirelessLinkStatus, dfsTableNumber=dfsTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, linkSymmetry=linkSymmetry, ptp=ptp, reset=reset, aAAControlGroup=aAAControlGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, ptmp=ptmp, tFTPServerIPAddress=tFTPServerIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, telecomsInterface=telecomsInterface, latitude=latitude, installArmStateTrap=installArmStateTrap, hardwareVersion=hardwareVersion, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapTable=sNMPTrapTable, dfsTable=dfsTable, dataPortAutoNegotiation=dataPortAutoNegotiation, signalStrengthRatio=signalStrengthRatio, installStatus=installStatus, receiveFreqMHz=receiveFreqMHz, transmitFreqKHz=transmitFreqKHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveDataRate=receiveDataRate, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortStatusTrap=dataPortStatusTrap, receiveModulationModeDetail=receiveModulationModeDetail, tDDControl=tDDControl, sNMPv3Enable=sNMPv3Enable, wirelessLinkAvailability=wirelessLinkAvailability, telnetPortNumber=telnetPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, supplementary=supplementary, ptp500=ptp500, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, bootVersion=bootVersion, altitude=altitude, syslogClientTrap=syslogClientTrap, configuration=configuration, sNMPTrapVersion=sNMPTrapVersion, constantPowerSpectralDensity=constantPowerSpectralDensity, cableLoss=cableLoss, softwareVersion=softwareVersion, incompatibleRegionCodes=incompatibleRegionCodes, dfsMeans=dfsMeans, telnetAccessEnabled=telnetAccessEnabled, systemReset=systemReset, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsCableLength=telecomsCableLength, userRole=userRole, snmpControlGroup=snmpControlGroup, longitude=longitude, syslogClient=syslogClient, pubStats=pubStats, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, encryptionGroup=encryptionGroup, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, management=management, telecomGroup=telecomGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, supplementaryGroup=supplementaryGroup, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, systemClock=systemClock, dataPortWirelessDownAlert=dataPortWirelessDownAlert, resetGroup=resetGroup, aggregateDataRate=aggregateDataRate, gatewayIPAddress=gatewayIPAddress, remoteIPAddress=remoteIPAddress, dfsPeaks=dfsPeaks, dfsTableIndex=dfsTableIndex, installArmState=installArmState, sNMPCommunityString=sNMPCommunityString, alarms=alarms, userTableIndex=userTableIndex, ethernetFiberSupport=ethernetFiberSupport, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, productName=productName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, subnetMask=subnetMask, targetMACAddress=targetMACAddress, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyStatusGroup=phyStatusGroup, cambium=cambium, sntp=sntp, ptpTraps=ptpTraps, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitModulationMode=transmitModulationMode, masterSlaveMode=masterSlaveMode, daylightSaving=daylightSaving, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licensedCapacity=licensedCapacity, vectorError=vectorError, hTTPAccessEnabled=hTTPAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, range=range, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRate=transmitDataRate, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLoopback=telecomsLoopback, alarmsGroup=alarmsGroup, ptpCompliance=ptpCompliance, sMTPServerIPAddress=sMTPServerIPAddress, pubStatsGroup=pubStatsGroup, tDDSynchronizationMode=tDDSynchronizationMode, iPAddress=iPAddress, sMTPEmailAlert=sMTPEmailAlert, sNTPLastSync=sNTPLastSync, vLANManagementVID=vLANManagementVID, telecom=telecom, byteErrorRatio=byteErrorRatio, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPPollInterval=sNTPPollInterval, syslogStateTrap=syslogStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, hTTPPortNumber=hTTPPortNumber, searchState=searchState, userTableNumber=userTableNumber, antennaGain=antennaGain, managementGroup=managementGroup, phyStatus=phyStatus, dataPortDisabledWarning=dataPortDisabledWarning, ethernet=ethernet, sNTPSync=sNTPSync, vLANManagementPriority=vLANManagementPriority, licence=licence, transmitChannel=transmitChannel, smtp=smtp, eIRP=eIRP, transmitPower=transmitPower, linkLoss=linkLoss, receiveModulationMode=receiveModulationMode, accessMethod=accessMethod, smtpGroup=smtpGroup, sMTPServerPortNumber=sMTPServerPortNumber, userName=userName, linkModeOptimisation=linkModeOptimisation, sNMPPortNumber=sNMPPortNumber, receivePower=receivePower, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, configurationGroup=configurationGroup, aAAControl=aAAControl, encryptionAlgorithm=encryptionAlgorithm, notificationsGroup=notificationsGroup, sNTPServerIPAddress=sNTPServerIPAddress, userEnabled=userEnabled, phyControlGroup=phyControlGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTable=userTable, installStatusTrap=installStatusTrap, telecomsLineCode=telecomsLineCode, licenceGroup=licenceGroup, groupID=groupID, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, receiveFreqKHz=receiveFreqKHz, vLANPriorityTable=vLANPriorityTable, syslogControl=syslogControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, frequencyVariant=frequencyVariant, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfs=dfs, transmitFreqMHz=transmitFreqMHz, ptpGroups=ptpGroups, versionsGroup=versionsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, siteName=siteName, phyControl=phyControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userTableEntry=userTableEntry, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPState=sNTPState, tDDControlGroup=tDDControlGroup, regionCodeTrap=regionCodeTrap, bandwidthVariant=bandwidthVariant, capacityLicenseMismatch=capacityLicenseMismatch, linkName=linkName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userPassword=userPassword, PYSNMP_MODULE_ID=cambium, sMTPEnabledMessages=sMTPEnabledMessages, versions=versions, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, regionCode=regionCode, encryption=encryption, remoteMaximumTransmitPower=remoteMaximumTransmitPower, useVLANForManagementInterfaces=useVLANForManagementInterfaces, snmpControl=snmpControl, channelBandwidth=channelBandwidth, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ethernetGroup=ethernetGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsChannelStatus=telecomsChannelStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveChannel=receiveChannel, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogState=syslogState, productVariant=productVariant, vLANPriorityQueueMapping=vLANPriorityQueueMapping, maximumTransmitPower=maximumTransmitPower, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText)
