...
# Produced by pysmi-1.1.3 at Mon Nov 22 19:56:36 2021
...
ObjectIdentity, iso, Integer32, NotificationType, ModuleIdentity, Bits, TimeTicks, Counter32, Gauge32, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Integer32", "NotificationType", "ModuleIdentity", "Bits", "TimeTicks", "Counter32", "Gauge32", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installArmState=installArmState, smtp=smtp, managementGroup=managementGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, versionsGroup=versionsGroup, userEnabled=userEnabled, pubStatsGroup=pubStatsGroup, receiveFreqMHz=receiveFreqMHz, receiveChannel=receiveChannel, dataPortStatusTrap=dataPortStatusTrap, ptp500=ptp500, hTTPPortNumber=hTTPPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNTPServerIPAddress=sNTPServerIPAddress, transmitChannel=transmitChannel, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cableLoss=cableLoss, dfsTableEntry=dfsTableEntry, targetMACAddress=targetMACAddress, tDDControl=tDDControl, linkSymmetry=linkSymmetry, encryption=encryption, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPv3Enable=sNMPv3Enable, receiveModulationMode=receiveModulationMode, sNMPTrapVersion=sNMPTrapVersion, linkLoss=linkLoss, installStatus=installStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, regionCodeTrap=regionCodeTrap, syslogState=syslogState, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveDataRate=receiveDataRate, aggregateDataRate=aggregateDataRate, dataPortStatus=dataPortStatus, dfsTableNumber=dfsTableNumber, aAAControlGroup=aAAControlGroup, sNMPPortNumber=sNMPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryptionGroup=encryptionGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANManagementPriority=vLANManagementPriority, smtpGroup=smtpGroup, searchState=searchState, sMTPEmailAlert=sMTPEmailAlert, ptpCompliance=ptpCompliance, wirelessLinkStatus=wirelessLinkStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitFreqMHz=transmitFreqMHz, sNTPLastSync=sNTPLastSync, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPAddress=iPAddress, licenceGroup=licenceGroup, telecomsCableLength=telecomsCableLength, telecomsChannelStatus=telecomsChannelStatus, ethernetFiberSupport=ethernetFiberSupport, tFTPServerIPAddress=tFTPServerIPAddress, telecom=telecom, vectorError=vectorError, channelChangeTrap=channelChangeTrap, dfs=dfs, sNTPSync=sNTPSync, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licensedCapacity=licensedCapacity, snmpControlGroup=snmpControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfsTableIndex=dfsTableIndex, maximumTransmitPower=maximumTransmitPower, daylightSaving=daylightSaving, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkAvailability=wirelessLinkAvailability, sNMPCommunityString=sNMPCommunityString, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, groupID=groupID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleRegionCodes=incompatibleRegionCodes, vLANManagementVID=vLANManagementVID, linkModeOptimisation=linkModeOptimisation, alarmsGroup=alarmsGroup, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, systemClock=systemClock, signalStrengthRatio=signalStrengthRatio, longitude=longitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, management=management, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPEnabledTraps=sNMPEnabledTraps, transmitPower=transmitPower, telecomGroup=telecomGroup, transmitDataRate=transmitDataRate, versions=versions, hTTPAccessEnabled=hTTPAccessEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, eIRP=eIRP, dataPortAutoMdix=dataPortAutoMdix, timeZone=timeZone, sNTPServerPortNumber=sNTPServerPortNumber, channelBandwidth=channelBandwidth, softwareVersion=softwareVersion, telecomsLoopback=telecomsLoopback, hardwareVersion=hardwareVersion, vLANPriorityTable=vLANPriorityTable, supplementaryGroup=supplementaryGroup, bandwidthVariant=bandwidthVariant, notificationsGroup=notificationsGroup, userName=userName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyControl=phyControl, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licence=licence, phyStatus=phyStatus, receivePower=receivePower, telnetAccessEnabled=telnetAccessEnabled, aAAControl=aAAControl, syslogStateTrap=syslogStateTrap, supplementary=supplementary, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarms=alarms, encryptionAlgorithm=encryptionAlgorithm, unitOutOfCalibration=unitOutOfCalibration, sMTPServerPortNumber=sMTPServerPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, subnetMask=subnetMask, syslogControl=syslogControl, dfsMeans=dfsMeans, frequencyVariant=frequencyVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, range=range, userRole=userRole, syslogClient=syslogClient, antennaGain=antennaGain, transmitModulationMode=transmitModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, siteName=siteName, userTableNumber=userTableNumber, transmitFreqKHz=transmitFreqKHz, reset=reset, userPassword=userPassword, installStatusTrap=installStatusTrap, tDDControlGroup=tDDControlGroup, sNTPPollInterval=sNTPPollInterval, sNMPTrapTable=sNMPTrapTable, systemReset=systemReset, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, pubStats=pubStats, accessMethod=accessMethod, constantPowerSpectralDensity=constantPowerSpectralDensity, altitude=altitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, productName=productName, telecomsInterface=telecomsInterface, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, capacityLicenseMismatch=capacityLicenseMismatch, userTableIndex=userTableIndex, userTableEntry=userTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, productVariant=productVariant, remoteIPAddress=remoteIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, masterSlaveMode=masterSlaveMode, ptpGroups=ptpGroups, dataPortWirelessDownAlert=dataPortWirelessDownAlert, latitude=latitude, phyControlGroup=phyControlGroup, byteErrorRatio=byteErrorRatio, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsPeaks=dfsPeaks, configuration=configuration, configurationGroup=configurationGroup, linkName=linkName, userTable=userTable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cambium=cambium, phyStatusGroup=phyStatusGroup, ptmp=ptmp, ptpTraps=ptpTraps, dfsGroup=dfsGroup, dfsTable=dfsTable, bootVersion=bootVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPState=sNTPState, secondarySoftwareVersion=secondarySoftwareVersion, syslogClientTrap=syslogClientTrap, sMTPServerIPAddress=sMTPServerIPAddress, ethernet=ethernet, resetGroup=resetGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, snmpControl=snmpControl, telecomsLineCode=telecomsLineCode, installArmStateTrap=installArmStateTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqKHz=receiveFreqKHz, ptp=ptp, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogControlGroup=syslogControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveModulationModeDetail=receiveModulationModeDetail, telnetPortNumber=telnetPortNumber, sntp=sntp, sntpGroup=sntpGroup)
