...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, IpAddress, Integer32, Counter64, TimeTicks, Gauge32, ObjectIdentity, Counter32, MibIdentifier, Bits, Unsigned32, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "IpAddress", "Integer32", "Counter64", "TimeTicks", "Gauge32", "ObjectIdentity", "Counter32", "MibIdentifier", "Bits", "Unsigned32", "iso", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ethernetGroup=ethernetGroup, installArmState=installArmState, dfsTable=dfsTable, vLANManagementVID=vLANManagementVID, receivePower=receivePower, transmitModulationMode=transmitModulationMode, reset=reset, siteName=siteName, userName=userName, snmpControlGroup=snmpControlGroup, userRole=userRole, systemReset=systemReset, userPassword=userPassword, ethernetFiberSupport=ethernetFiberSupport, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configuration=configuration, userTableNumber=userTableNumber, range=range, supplementaryGroup=supplementaryGroup, supplementary=supplementary, sNMPTrapTableEntry=sNMPTrapTableEntry, altitude=altitude, dataPortAutoMdix=dataPortAutoMdix, telecom=telecom, noWirelessChannelAvailable=noWirelessChannelAvailable, installStatusTrap=installStatusTrap, configurationGroup=configurationGroup, sNMPv3Enable=sNMPv3Enable, linkSymmetry=linkSymmetry, receiveFreqKHz=receiveFreqKHz, smtpGroup=smtpGroup, dfsTableNumber=dfsTableNumber, frequencyVariant=frequencyVariant, alarmsGroup=alarmsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPState=sNTPState, userEnabled=userEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPSAccessEnabled=hTTPSAccessEnabled, aggregateDataRate=aggregateDataRate, sMTPServerIPAddress=sMTPServerIPAddress, syslogControlGroup=syslogControlGroup, syslogClient=syslogClient, dfsTableEntry=dfsTableEntry, telecomsChannelStatus=telecomsChannelStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkName=linkName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableEntry=userTableEntry, phyControl=phyControl, phyStatus=phyStatus, accessMethod=accessMethod, pubStatsGroup=pubStatsGroup, ptpTrapPrefix=ptpTrapPrefix, telecomsLineCode=telecomsLineCode, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatus=installStatus, dfsPeaks=dfsPeaks, dfsGroup=dfsGroup, telecomsLoopback=telecomsLoopback, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, aAAControlGroup=aAAControlGroup, encryptionGroup=encryptionGroup, hardwareVersion=hardwareVersion, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, antennaGain=antennaGain, syslogStateTrap=syslogStateTrap, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetAccessEnabled=telnetAccessEnabled, dataPortStatusTrap=dataPortStatusTrap, productVariant=productVariant, telnetPortNumber=telnetPortNumber, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bandwidthVariant=bandwidthVariant, telecomsCableLength=telecomsCableLength, sMTPServerPortNumber=sMTPServerPortNumber, transmitFreqKHz=transmitFreqKHz, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, syslogClientTrap=syslogClientTrap, sMTPEnabledMessages=sMTPEnabledMessages, sNTPServerPortNumber=sNTPServerPortNumber, searchState=searchState, byteErrorRatio=byteErrorRatio, syslogControl=syslogControl, phyControlGroup=phyControlGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatusGroup=phyStatusGroup, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStats=pubStats, receiveModulationMode=receiveModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, cableLoss=cableLoss, ptmp=ptmp, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, snmpControl=snmpControl, tDDControl=tDDControl, dataPortStatus=dataPortStatus, wirelessLinkStatus=wirelessLinkStatus, ethernet=ethernet, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptpGroups=ptpGroups, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionAlgorithm=encryptionAlgorithm, latitude=latitude, sNMPTrapTable=sNMPTrapTable, daylightSaving=daylightSaving, sNTPLastSync=sNTPLastSync, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, gatewayIPAddress=gatewayIPAddress, tDDControlGroup=tDDControlGroup, versions=versions, dataPortConfigurationMismatch=dataPortConfigurationMismatch, bootVersion=bootVersion, licenceGroup=licenceGroup, userTable=userTable, notificationsGroup=notificationsGroup, ptpTraps=ptpTraps, dataPortDisabledWarning=dataPortDisabledWarning, subnetMask=subnetMask, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNTPSync=sNTPSync, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitChannel=transmitChannel, ptp=ptp, transmitFreqMHz=transmitFreqMHz, dataPortAutoNegotiation=dataPortAutoNegotiation, resetGroup=resetGroup, vectorError=vectorError, systemClock=systemClock, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableIndex=userTableIndex, sNTPServerIPAddress=sNTPServerIPAddress, installArmStateTrap=installArmStateTrap, unitOutOfCalibration=unitOutOfCalibration, longitude=longitude, versionsGroup=versionsGroup, dfs=dfs, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPPortNumber=sNMPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsMeans=dfsMeans, receiveModulationModeDetail=receiveModulationModeDetail, sNMPEnabledTraps=sNMPEnabledTraps, licence=licence, iPAddress=iPAddress, channelBandwidth=channelBandwidth, alarms=alarms, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, hTTPPortNumber=hTTPPortNumber, sntpGroup=sntpGroup, sntp=sntp, aAAControl=aAAControl, sNMPTrapTableIndex=sNMPTrapTableIndex, regionCodeTrap=regionCodeTrap, smtp=smtp, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, incompatibleRegionCodes=incompatibleRegionCodes, secondarySoftwareVersion=secondarySoftwareVersion, remoteIPAddress=remoteIPAddress, telecomsInterface=telecomsInterface, incompatibleMasterAndSlave=incompatibleMasterAndSlave, productName=productName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomGroup=telecomGroup, tFTPServerPortNumber=tFTPServerPortNumber, groupID=groupID, licensedCapacity=licensedCapacity, sNTPPollInterval=sNTPPollInterval, linkLoss=linkLoss, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, receiveChannel=receiveChannel, managementGroup=managementGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptp500=ptp500, ptpCompliance=ptpCompliance, sMTPSourceEmailAddress=sMTPSourceEmailAddress, management=management, transmitPower=transmitPower, vLANPriorityTable=vLANPriorityTable, linkModeOptimisation=linkModeOptimisation, transmitDataRate=transmitDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveDataRate=receiveDataRate, dfsTableIndex=dfsTableIndex, sMTPEmailAlert=sMTPEmailAlert, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPCommunityString=sNMPCommunityString, cambium=cambium, targetMACAddress=targetMACAddress, receiveFreqMHz=receiveFreqMHz, syslogState=syslogState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, regionCode=regionCode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, capacityLicenseMismatch=capacityLicenseMismatch, encryption=encryption)
