...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, antennaGain=antennaGain, transmitFreqMHz=transmitFreqMHz, configurationGroup=configurationGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsPeaks=dfsPeaks, wirelessLinkStatus=wirelessLinkStatus, notificationsGroup=notificationsGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, bandwidthVariant=bandwidthVariant, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, telecomsChannelStatusTrap=telecomsChannelStatusTrap, pubStatsGroup=pubStatsGroup, vectorError=vectorError, versions=versions, versionsGroup=versionsGroup, tFTPServerIPAddress=tFTPServerIPAddress, syslogState=syslogState, productVariant=productVariant, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitFreqKHz=transmitFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPEnabledTraps=sNMPEnabledTraps, licensedCapacity=licensedCapacity, management=management, telecom=telecom, aAAControl=aAAControl, noWirelessChannelAvailable=noWirelessChannelAvailable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANManagementVID=vLANManagementVID, receivePower=receivePower, aggregateDataRate=aggregateDataRate, linkModeOptimisation=linkModeOptimisation, sNMPTrapTableEntry=sNMPTrapTableEntry, phyControl=phyControl, cableLoss=cableLoss, userPassword=userPassword, frequencyVariant=frequencyVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNTPPollInterval=sNTPPollInterval, masterSlaveMode=masterSlaveMode, unitOutOfCalibration=unitOutOfCalibration, productName=productName, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernetFiberSupport=ethernetFiberSupport, tDDControl=tDDControl, sMTPServerIPAddress=sMTPServerIPAddress, systemReset=systemReset, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, ptpCompliance=ptpCompliance, installArmState=installArmState, channelChangeTrap=channelChangeTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, groupID=groupID, searchState=searchState, ptpTraps=ptpTraps, transmitDataRate=transmitDataRate, telnetAccessEnabled=telnetAccessEnabled, sMTPEnabledMessages=sMTPEnabledMessages, syslogClientTrap=syslogClientTrap, ptmp=ptmp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, linkSymmetry=linkSymmetry, softwareVersion=softwareVersion, latitude=latitude, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, accessMethod=accessMethod, userTable=userTable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, altitude=altitude, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkName=linkName, dfs=dfs, encryptionAlgorithm=encryptionAlgorithm, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyControlGroup=phyControlGroup, sNTPLastSync=sNTPLastSync, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionGroup=encryptionGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveFreqKHz=receiveFreqKHz, phyStatus=phyStatus, tDDSynchronizationMode=tDDSynchronizationMode, userTableIndex=userTableIndex, signalStrengthRatio=signalStrengthRatio, hTTPAccessEnabled=hTTPAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, sntp=sntp, capacityLicenseMismatch=capacityLicenseMismatch, dfsGroup=dfsGroup, range=range, iPAddress=iPAddress, subnetMask=subnetMask, sNTPServerIPAddress=sNTPServerIPAddress, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, dfsTable=dfsTable, daylightSaving=daylightSaving, userName=userName, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogStateTrap=syslogStateTrap, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, hTTPSAccessEnabled=hTTPSAccessEnabled, linkLoss=linkLoss, transmitPower=transmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, supplementaryGroup=supplementaryGroup, sNTPSyncTrap=sNTPSyncTrap, bootVersion=bootVersion, vLANPriorityTableEntry=vLANPriorityTableEntry, userRole=userRole, dataPortDisabledWarning=dataPortDisabledWarning, configuration=configuration, secondarySoftwareVersion=secondarySoftwareVersion, vLANPriorityTable=vLANPriorityTable, telecomsLoopbackTrap=telecomsLoopbackTrap, smtp=smtp, telecomsCableLength=telecomsCableLength, ptpGroups=ptpGroups, smtpGroup=smtpGroup, receiveFreqMHz=receiveFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemClock=systemClock, reset=reset, installStatus=installStatus, tFTPServerPortNumber=tFTPServerPortNumber, siteName=siteName, transmitChannel=transmitChannel, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLineCode=telecomsLineCode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cambium=cambium, timeZone=timeZone, telecomGroup=telecomGroup, snmpControl=snmpControl, telnetPortNumber=telnetPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, dataPortStatus=dataPortStatus, telecomsLoopback=telecomsLoopback, managementGroup=managementGroup, vLANManagementPriority=vLANManagementPriority, ethernetGroup=ethernetGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPCommunityString=sNMPCommunityString, ethernet=ethernet, syslogClient=syslogClient, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, remoteMaximumTransmitPower=remoteMaximumTransmitPower, regionCode=regionCode, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, resetGroup=resetGroup, sNMPTrapVersion=sNMPTrapVersion, telecomsChannelStatus=telecomsChannelStatus, sNTPSync=sNTPSync, channelBandwidth=channelBandwidth, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp500=ptp500, tDDControlGroup=tDDControlGroup, receiveModulationMode=receiveModulationMode, gatewayIPAddress=gatewayIPAddress, hardwareVersion=hardwareVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, eIRP=eIRP, longitude=longitude, dfsTableNumber=dfsTableNumber, syslogControl=syslogControl, supplementary=supplementary, telecomsInterface=telecomsInterface, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControlGroup=syslogControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, alarms=alarms, hTTPPortNumber=hTTPPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryption=encryption, dfsTableIndex=dfsTableIndex, sNTPState=sNTPState, byteErrorRatio=byteErrorRatio, dataPortStatusTrap=dataPortStatusTrap, installStatusTrap=installStatusTrap, hTTPSPortNumber=hTTPSPortNumber, dfsMeans=dfsMeans, sNMPTrapTable=sNMPTrapTable, pubStats=pubStats, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, PYSNMP_MODULE_ID=cambium, userTableNumber=userTableNumber, ptp=ptp, alarmsGroup=alarmsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userEnabled=userEnabled, sNMPPortNumber=sNMPPortNumber, targetMACAddress=targetMACAddress, dataPortAutoMdix=dataPortAutoMdix, receiveChannel=receiveChannel, licence=licence, remoteIPAddress=remoteIPAddress, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, sNMPv3Enable=sNMPv3Enable, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aAAControlGroup=aAAControlGroup)
