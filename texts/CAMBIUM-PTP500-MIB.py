...
# Produced by pysmi-1.1.3 at Sun Nov 28 20:36:02 2021
...
Integer32, iso, Bits, Gauge32, ObjectIdentity, IpAddress, enterprises, MibIdentifier, TimeTicks, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Bits", "Gauge32", "ObjectIdentity", "IpAddress", "enterprises", "MibIdentifier", "TimeTicks", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sMTPServerPortNumber=sMTPServerPortNumber, sntp=sntp, dfs=dfs, sMTPEnabledMessages=sMTPEnabledMessages, versions=versions, snmpControlGroup=snmpControlGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortDisabledWarning=dataPortDisabledWarning, alarms=alarms, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityTableIndex=vLANPriorityTableIndex, telnetPortNumber=telnetPortNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerIPAddress=sNTPServerIPAddress, softwareVersion=softwareVersion, sNMPv3Enable=sNMPv3Enable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtp=smtp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptp=ptp, PYSNMP_MODULE_ID=cambium, tDDSynchronizationStatus=tDDSynchronizationStatus, longitude=longitude, searchState=searchState, sMTPEmailAlert=sMTPEmailAlert, receiveChannel=receiveChannel, altitude=altitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapVersion=sNMPTrapVersion, reset=reset, dataPortAutoMdix=dataPortAutoMdix, constantPowerSpectralDensity=constantPowerSpectralDensity, telecom=telecom, noWirelessChannelAvailable=noWirelessChannelAvailable, userName=userName, eIRP=eIRP, dataPortStatus=dataPortStatus, userTable=userTable, syslogControlGroup=syslogControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, sNMPEnabledTraps=sNMPEnabledTraps, ptpCompliance=ptpCompliance, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerIPAddress=sMTPServerIPAddress, regionCode=regionCode, phyStatus=phyStatus, sNMPTrapTableEntry=sNMPTrapTableEntry, installStatus=installStatus, installArmState=installArmState, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDControlGroup=tDDControlGroup, telecomsInterface=telecomsInterface, transmitDataRate=transmitDataRate, receiveModulationMode=receiveModulationMode, siteName=siteName, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, vLANManagementPriority=vLANManagementPriority, sNMPPortNumber=sNMPPortNumber, dfsMeans=dfsMeans, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSync=sNTPSync, receiveDataRate=receiveDataRate, aAAControl=aAAControl, pubStatsGroup=pubStatsGroup, timeZone=timeZone, userTableNumber=userTableNumber, resetGroup=resetGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemClock=systemClock, accessMethod=accessMethod, antennaGain=antennaGain, enabledDiagnosticAlarms=enabledDiagnosticAlarms, snmpControl=snmpControl, wirelessLinkStatus=wirelessLinkStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, linkLoss=linkLoss, systemReset=systemReset, receiveModulationModeDetail=receiveModulationModeDetail, syslogStateTrap=syslogStateTrap, tDDControl=tDDControl, sntpGroup=sntpGroup, ethernet=ethernet, dataPortConfigurationMismatch=dataPortConfigurationMismatch, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPPortNumber=hTTPPortNumber, telecomsCableLength=telecomsCableLength, cambium=cambium, daylightSaving=daylightSaving, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licensedCapacity=licensedCapacity, subnetMask=subnetMask, receivePower=receivePower, aggregateDataRate=aggregateDataRate, dataPortStatusTrap=dataPortStatusTrap, receiveFreqMHz=receiveFreqMHz, dfsTableIndex=dfsTableIndex, linkSymmetry=linkSymmetry, installArmStateTrap=installArmStateTrap, alarmsGroup=alarmsGroup, hardwareVersion=hardwareVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, smtpGroup=smtpGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, signalStrengthRatio=signalStrengthRatio, frequencyVariant=frequencyVariant, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenceGroup=licenceGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, maximumTransmitPower=maximumTransmitPower, sNTPPollInterval=sNTPPollInterval, vLANPriorityTable=vLANPriorityTable, telecomsLineCode=telecomsLineCode, ptpTraps=ptpTraps, linkModeOptimisation=linkModeOptimisation, userRole=userRole, transmitFreqKHz=transmitFreqKHz, userPassword=userPassword, userTableEntry=userTableEntry, linkName=linkName, transmitChannel=transmitChannel, bandwidthVariant=bandwidthVariant, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTable=sNMPTrapTable, tDDSynchronizationAlarm=tDDSynchronizationAlarm, vectorError=vectorError, sNTPState=sNTPState, encryption=encryption, managementGroup=managementGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteIPAddress=remoteIPAddress, versionsGroup=versionsGroup, transmitPower=transmitPower, sNTPSyncTrap=sNTPSyncTrap, tDDSynchronizationMode=tDDSynchronizationMode, hTTPAccessEnabled=hTTPAccessEnabled, dfsTableNumber=dfsTableNumber, transmitModulationMode=transmitModulationMode, latitude=latitude, ptp500=ptp500, configurationGroup=configurationGroup, groupID=groupID, range=range, supplementary=supplementary, telecomsChannelStatus=telecomsChannelStatus, incompatibleRegionCodes=incompatibleRegionCodes, bootVersion=bootVersion, installStatusTrap=installStatusTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, supplementaryGroup=supplementaryGroup, sNMPCommunityString=sNMPCommunityString, dataPortAutoNegotiation=dataPortAutoNegotiation, regionCodeTrap=regionCodeTrap, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telnetAccessEnabled=telnetAccessEnabled, syslogControl=syslogControl, phyStatusGroup=phyStatusGroup, secondarySoftwareVersion=secondarySoftwareVersion, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogClient=syslogClient, channelBandwidth=channelBandwidth, dfsPeaks=dfsPeaks, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, iPAddress=iPAddress, configuration=configuration, ptmp=ptmp, userTableIndex=userTableIndex, encryptionAlgorithm=encryptionAlgorithm, management=management, transmitFreqMHz=transmitFreqMHz, userEnabled=userEnabled, ptpGroups=ptpGroups, pubStats=pubStats, sNTPServerPortNumber=sNTPServerPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, cableLoss=cableLoss, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogState=syslogState, sNMPTrapTableIndex=sNMPTrapTableIndex, syslogLocalWrappedTrap=syslogLocalWrappedTrap, receiveFreqKHz=receiveFreqKHz, dfsGroup=dfsGroup, telecomsLoopback=telecomsLoopback, licence=licence, sNTPLastSync=sNTPLastSync, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyControlGroup=phyControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsTableEntry=dfsTableEntry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, channelChangeTrap=channelChangeTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ethernetGroup=ethernetGroup, productVariant=productVariant, notificationsGroup=notificationsGroup, masterSlaveMode=masterSlaveMode, phyControl=phyControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatch=capacityLicenseMismatch, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTableNumber=vLANPriorityTableNumber, hTTPSPortNumber=hTTPSPortNumber, productName=productName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, byteErrorRatio=byteErrorRatio, dfsTable=dfsTable, telecomGroup=telecomGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, targetMACAddress=targetMACAddress)
