...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Counter32, Unsigned32, MibIdentifier, Integer32, TimeTicks, Gauge32, iso, ObjectIdentity, ModuleIdentity, Bits, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Counter32", "Unsigned32", "MibIdentifier", "Integer32", "TimeTicks", "Gauge32", "iso", "ObjectIdentity", "ModuleIdentity", "Bits", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", versions=versions, hTTPSAccessEnabled=hTTPSAccessEnabled, phyStatusGroup=phyStatusGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, capacityLicenseMismatch=capacityLicenseMismatch, phyStatus=phyStatus, userTableIndex=userTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, hTTPSPortNumber=hTTPSPortNumber, ptpTrapPrefix=ptpTrapPrefix, receiveModulationMode=receiveModulationMode, receiveFreqKHz=receiveFreqKHz, pubStatsGroup=pubStatsGroup, daylightSaving=daylightSaving, latitude=latitude, supplementary=supplementary, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTable=dfsTable, transmitPower=transmitPower, iPAddress=iPAddress, sNMPTrapVersion=sNMPTrapVersion, receiveDataRate=receiveDataRate, sNTPLastSync=sNTPLastSync, configuration=configuration, telecomsInterface=telecomsInterface, aAAControl=aAAControl, tDDControlGroup=tDDControlGroup, management=management, sNMPTrapTableIndex=sNMPTrapTableIndex, ethernetGroup=ethernetGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, installStatus=installStatus, transmitFreqKHz=transmitFreqKHz, vLANPriorityTable=vLANPriorityTable, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogControlGroup=syslogControlGroup, vLANManagementPriority=vLANManagementPriority, gatewayIPAddress=gatewayIPAddress, versionsGroup=versionsGroup, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsChannelStatus=telecomsChannelStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receivePower=receivePower, sNTPServerPortNumber=sNTPServerPortNumber, targetMACAddress=targetMACAddress, wirelessLinkAvailability=wirelessLinkAvailability, tDDControl=tDDControl, ptp500=ptp500, phyControlGroup=phyControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, userRole=userRole, softwareVersion=softwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteIPAddress=remoteIPAddress, vLANPriorityTableNumber=vLANPriorityTableNumber, phyControl=phyControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, telecomGroup=telecomGroup, telecomsLoopback=telecomsLoopback, sntp=sntp, managementGroup=managementGroup, antennaGain=antennaGain, channelChangeTrap=channelChangeTrap, ptpCompliance=ptpCompliance, dfsPeaks=dfsPeaks, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPSyncTrap=sNTPSyncTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, productName=productName, userName=userName, ptpGroups=ptpGroups, dfsMeans=dfsMeans, licenceGroup=licenceGroup, signalStrengthRatio=signalStrengthRatio, linkLoss=linkLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, PYSNMP_MODULE_ID=cambium, linkSymmetry=linkSymmetry, range=range, systemReset=systemReset, vectorError=vectorError, searchState=searchState, bootVersion=bootVersion, alarms=alarms, supplementaryGroup=supplementaryGroup, groupID=groupID, telecomsLineCode=telecomsLineCode, telecomsCableLength=telecomsCableLength, tDDSynchronizationStatus=tDDSynchronizationStatus, encryptionAlgorithm=encryptionAlgorithm, telecomsChannelStatusTrap=telecomsChannelStatusTrap, aAAControlGroup=aAAControlGroup, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPv3Enable=sNMPv3Enable, installArmStateTrap=installArmStateTrap, vLANManagementVID=vLANManagementVID, receiveModulationModeDetail=receiveModulationModeDetail, sNMPCommunityString=sNMPCommunityString, telnetPortNumber=telnetPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, frequencyVariant=frequencyVariant, configurationGroup=configurationGroup, dfs=dfs, receiveChannel=receiveChannel, transmitModulationMode=transmitModulationMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, snmpControlGroup=snmpControlGroup, hTTPPortNumber=hTTPPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userTableEntry=userTableEntry, pubStats=pubStats, dfsGroup=dfsGroup, cableLoss=cableLoss, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPollInterval=sNTPPollInterval, userEnabled=userEnabled, sNMPTrapTable=sNMPTrapTable, ptpTraps=ptpTraps, installArmState=installArmState, transmitFreqMHz=transmitFreqMHz, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPSync=sNTPSync, telnetAccessEnabled=telnetAccessEnabled, sNTPState=sNTPState, syslogClient=syslogClient, telecom=telecom, ptmp=ptmp, tFTPServerPortNumber=tFTPServerPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, transmitChannel=transmitChannel, systemClock=systemClock, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortStatusTrap=dataPortStatusTrap, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailable=noWirelessChannelAvailable, encryption=encryption, encryptionGroup=encryptionGroup, linkModeOptimisation=linkModeOptimisation, ethernet=ethernet, smtp=smtp, syslogControl=syslogControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsTableNumber=dfsTableNumber, notificationsGroup=notificationsGroup, productVariant=productVariant, secondarySoftwareVersion=secondarySoftwareVersion, accessMethod=accessMethod, cambium=cambium, telecomsLoopbackTrap=telecomsLoopbackTrap, userTableNumber=userTableNumber, syslogClientTrap=syslogClientTrap, linkName=linkName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, resetGroup=resetGroup, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, subnetMask=subnetMask, hTTPAccessEnabled=hTTPAccessEnabled, syslogStateTrap=syslogStateTrap, dfsTableEntry=dfsTableEntry, maximumTransmitPower=maximumTransmitPower, hardwareVersion=hardwareVersion, eIRP=eIRP, siteName=siteName, transmitDataRate=transmitDataRate, snmpControl=snmpControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, byteErrorRatio=byteErrorRatio, incompatibleRegionCodes=incompatibleRegionCodes, masterSlaveMode=masterSlaveMode, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlave=incompatibleMasterAndSlave, aggregateDataRate=aggregateDataRate, userTable=userTable, bandwidthVariant=bandwidthVariant, unitOutOfCalibration=unitOutOfCalibration, syslogState=syslogState, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelBandwidth=channelBandwidth, sNTPServerIPAddress=sNTPServerIPAddress, longitude=longitude, installStatusTrap=installStatusTrap, dataPortAutoMdix=dataPortAutoMdix, userPassword=userPassword, licence=licence, regionCodeTrap=regionCodeTrap, dfsTableIndex=dfsTableIndex, ptp=ptp, reset=reset, sNMPPortNumber=sNMPPortNumber, receiveFreqMHz=receiveFreqMHz, regionCode=regionCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, timeZone=timeZone, altitude=altitude, sntpGroup=sntpGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licensedCapacity=licensedCapacity)
