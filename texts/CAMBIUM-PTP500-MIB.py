...
# Produced by pysmi-1.1.3 at Thu Dec  9 14:54:46 2021
...
MibIdentifier, Integer32, ObjectIdentity, Bits, enterprises, Unsigned32, Counter32, NotificationType, iso, TimeTicks, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "ObjectIdentity", "Bits", "enterprises", "Unsigned32", "Counter32", "NotificationType", "iso", "TimeTicks", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", snmpControlGroup=snmpControlGroup, sNTPSyncTrap=sNTPSyncTrap, daylightSaving=daylightSaving, regionCodeTrap=regionCodeTrap, dataPortDisabledWarning=dataPortDisabledWarning, sNTPServerPortNumber=sNTPServerPortNumber, iPAddress=iPAddress, incompatibleRegionCodes=incompatibleRegionCodes, ptmp=ptmp, tFTPServerIPAddress=tFTPServerIPAddress, channelChangeTrap=channelChangeTrap, hTTPAccessEnabled=hTTPAccessEnabled, userEnabled=userEnabled, userRole=userRole, telnetPortNumber=telnetPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPSync=sNTPSync, ptpTraps=ptpTraps, telecomsInterface=telecomsInterface, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, accessMethod=accessMethod, aggregateDataRate=aggregateDataRate, aAAControlGroup=aAAControlGroup, dfsPeaks=dfsPeaks, userTable=userTable, hTTPPortNumber=hTTPPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementary=supplementary, linkName=linkName, receiveModulationMode=receiveModulationMode, sntpGroup=sntpGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitModulationMode=transmitModulationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, systemReset=systemReset, versionsGroup=versionsGroup, sNTPLastSync=sNTPLastSync, syslogControlGroup=syslogControlGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, resetGroup=resetGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogControl=syslogControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, antennaGain=antennaGain, ptpCompliance=ptpCompliance, sNMPTrapVersion=sNMPTrapVersion, userName=userName, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, bootVersion=bootVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, bandwidthVariant=bandwidthVariant, phyStatus=phyStatus, sNTPServerIPAddress=sNTPServerIPAddress, byteErrorRatio=byteErrorRatio, sntp=sntp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, receiveFreqKHz=receiveFreqKHz, sNMPEnabledTraps=sNMPEnabledTraps, syslogClientTrap=syslogClientTrap, linkLoss=linkLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitDataRate=transmitDataRate, sNMPCommunityString=sNMPCommunityString, timeZone=timeZone, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptpGroups=ptpGroups, maximumTransmitPower=maximumTransmitPower, telnetAccessEnabled=telnetAccessEnabled, longitude=longitude, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dataPortStatusTrap=dataPortStatusTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, eIRP=eIRP, phyControlGroup=phyControlGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, encryption=encryption, configuration=configuration, dfs=dfs, subnetMask=subnetMask, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableNumber=sNMPTrapTableNumber, licensedCapacity=licensedCapacity, ptp=ptp, ethernetFiberSupport=ethernetFiberSupport, noWirelessChannelAvailable=noWirelessChannelAvailable, siteName=siteName, dfsTableIndex=dfsTableIndex, vectorError=vectorError, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, wirelessLinkStatus=wirelessLinkStatus, gatewayIPAddress=gatewayIPAddress, cableLoss=cableLoss, regionCode=regionCode, dfsTable=dfsTable, installArmState=installArmState, transmitChannel=transmitChannel, PYSNMP_MODULE_ID=cambium, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsTableNumber=dfsTableNumber, smtp=smtp, hTTPSPortNumber=hTTPSPortNumber, syslogStateTrap=syslogStateTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, secondarySoftwareVersion=secondarySoftwareVersion, ethernetGroup=ethernetGroup, groupID=groupID, linkSymmetry=linkSymmetry, pubStatsGroup=pubStatsGroup, masterSlaveMode=masterSlaveMode, tDDSynchronizationMode=tDDSynchronizationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsChannelStatus=telecomsChannelStatus, ptp500=ptp500, syslogState=syslogState, userPassword=userPassword, versions=versions, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, notificationsGroup=notificationsGroup, vLANManagementPriority=vLANManagementPriority, dataPortAutoMdix=dataPortAutoMdix, smtpGroup=smtpGroup, syslogClient=syslogClient, ptpTrapPrefix=ptpTrapPrefix, phyStatusGroup=phyStatusGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, management=management, sMTPServerIPAddress=sMTPServerIPAddress, systemClock=systemClock, dfsGroup=dfsGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, userTableIndex=userTableIndex, dfsMeans=dfsMeans, range=range, phyControl=phyControl, sNTPState=sNTPState, telecomsCableLength=telecomsCableLength, softwareVersion=softwareVersion, latitude=latitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licenceGroup=licenceGroup, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPServerPortNumber=tFTPServerPortNumber, targetMACAddress=targetMACAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, aAAControl=aAAControl, sNMPv3Enable=sNMPv3Enable, dfsTableEntry=dfsTableEntry, licence=licence, telecomsChannelStatusTrap=telecomsChannelStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, configurationGroup=configurationGroup, hardwareVersion=hardwareVersion, receiveChannel=receiveChannel, searchState=searchState, linkModeOptimisation=linkModeOptimisation, installStatusTrap=installStatusTrap, sNMPTrapTable=sNMPTrapTable, sNMPPortNumber=sNMPPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANManagementVID=vLANManagementVID, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernet=ethernet, receiveModulationModeDetail=receiveModulationModeDetail, encryptionAlgorithm=encryptionAlgorithm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receivePower=receivePower, receiveDataRate=receiveDataRate, productName=productName, reset=reset, altitude=altitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telecomsLineCode=telecomsLineCode, wirelessLinkAvailability=wirelessLinkAvailability, tDDControl=tDDControl, sMTPEnabledMessages=sMTPEnabledMessages, transmitFreqKHz=transmitFreqKHz, dataPortStatus=dataPortStatus, telecomGroup=telecomGroup, alarms=alarms, alarmsGroup=alarmsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecom=telecom, vLANPriorityTable=vLANPriorityTable, encryptionGroup=encryptionGroup, unitOutOfCalibration=unitOutOfCalibration, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmStateTrap=installArmStateTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsLoopback=telecomsLoopback, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANPriorityTableNumber=vLANPriorityTableNumber, managementGroup=managementGroup, productVariant=productVariant, transmitPower=transmitPower, userTableNumber=userTableNumber, channelBandwidth=channelBandwidth, userTableEntry=userTableEntry, capacityLicenseMismatch=capacityLicenseMismatch, remoteIPAddress=remoteIPAddress, cambium=cambium, sNTPPollInterval=sNTPPollInterval, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, snmpControl=snmpControl, signalStrengthRatio=signalStrengthRatio, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementaryGroup=supplementaryGroup, installStatus=installStatus, tDDControlGroup=tDDControlGroup)
