...
# Produced by pysmi-1.1.8 at Tue Jan 11 20:27:59 2022
...
MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, Gauge32, NotificationType, Unsigned32, TimeTicks, Integer32, enterprises, IpAddress, Counter32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "Gauge32", "NotificationType", "Unsigned32", "TimeTicks", "Integer32", "enterprises", "IpAddress", "Counter32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", managementGroup=managementGroup, tDDControl=tDDControl, subnetMask=subnetMask, ptpCompliance=ptpCompliance, sNMPPortNumber=sNMPPortNumber, byteErrorRatio=byteErrorRatio, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licence=licence, sMTPEnabledMessages=sMTPEnabledMessages, ptp=ptp, sNMPTrapTableNumber=sNMPTrapTableNumber, configurationGroup=configurationGroup, productName=productName, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, ethernet=ethernet, phyStatus=phyStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, phyControl=phyControl, vLANManagementVID=vLANManagementVID, dataPortStatus=dataPortStatus, userTableNumber=userTableNumber, aAAControl=aAAControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, notificationsGroup=notificationsGroup, alarms=alarms, telnetAccessEnabled=telnetAccessEnabled, userTableEntry=userTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableLoss=cableLoss, regionCodeTrap=regionCodeTrap, receiveModulationMode=receiveModulationMode, ptpGroups=ptpGroups, dfsGroup=dfsGroup, receiveModulationModeDetail=receiveModulationModeDetail, vectorError=vectorError, groupID=groupID, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, telnetPortNumber=telnetPortNumber, installStatusTrap=installStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitPower=transmitPower, searchState=searchState, remoteIPAddress=remoteIPAddress, userEnabled=userEnabled, configuration=configuration, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryption=encryption, systemClock=systemClock, sNMPCommunityString=sNMPCommunityString, syslogClient=syslogClient, vLANPriorityQueueMapping=vLANPriorityQueueMapping, reset=reset, antennaGain=antennaGain, management=management, tDDSynchronizationMode=tDDSynchronizationMode, sNTPSync=sNTPSync, capacityLicenseMismatch=capacityLicenseMismatch, dfsTableIndex=dfsTableIndex, syslogState=syslogState, incompatibleMasterAndSlave=incompatibleMasterAndSlave, resetGroup=resetGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, aggregateDataRate=aggregateDataRate, transmitModulationMode=transmitModulationMode, transmitDataRate=transmitDataRate, vLANPriorityTableEntry=vLANPriorityTableEntry, snmpControlGroup=snmpControlGroup, aAAControlGroup=aAAControlGroup, installArmStateTrap=installArmStateTrap, supplementary=supplementary, ptp500=ptp500, maximumTransmitPower=maximumTransmitPower, cambium=cambium, syslogControlGroup=syslogControlGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoMdix=dataPortAutoMdix, productVariant=productVariant, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveDataRate=receiveDataRate, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, linkLoss=linkLoss, syslogStateTrap=syslogStateTrap, sNTPSyncTrap=sNTPSyncTrap, latitude=latitude, linkModeOptimisation=linkModeOptimisation, dfsPeaks=dfsPeaks, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, dfsTable=dfsTable, masterSlaveMode=masterSlaveMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, smtpGroup=smtpGroup, sntpGroup=sntpGroup, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, sntp=sntp, telecomGroup=telecomGroup, sMTPServerPortNumber=sMTPServerPortNumber, encryptionGroup=encryptionGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkStatus=wirelessLinkStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, timeZone=timeZone, ptpTrapPrefix=ptpTrapPrefix, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapVersion=sNMPTrapVersion, vLANPriorityTable=vLANPriorityTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bandwidthVariant=bandwidthVariant, dfsTableEntry=dfsTableEntry, channelBandwidth=channelBandwidth, unitOutOfCalibration=unitOutOfCalibration, noWirelessChannelAvailable=noWirelessChannelAvailable, systemReset=systemReset, phyStatusGroup=phyStatusGroup, siteName=siteName, installStatus=installStatus, userRole=userRole, telecomsLoopbackTrap=telecomsLoopbackTrap, syslogControl=syslogControl, versions=versions, range=range, daylightSaving=daylightSaving, wirelessLinkAvailability=wirelessLinkAvailability, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, ptmp=ptmp, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, hTTPPortNumber=hTTPPortNumber, ptpTraps=ptpTraps, telecomsCableLength=telecomsCableLength, signalStrengthRatio=signalStrengthRatio, sNMPv3Enable=sNMPv3Enable, receiveFreqKHz=receiveFreqKHz, telecom=telecom, targetMACAddress=targetMACAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogClientTrap=syslogClientTrap, receiveChannel=receiveChannel, accessMethod=accessMethod, pubStats=pubStats, smtp=smtp, installArmState=installArmState, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userPassword=userPassword, linkName=linkName, sNMPTrapTable=sNMPTrapTable, ethernetFiberSupport=ethernetFiberSupport, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, tFTPServerIPAddress=tFTPServerIPAddress, telecomsInterface=telecomsInterface, secondarySoftwareVersion=secondarySoftwareVersion, channelChangeTrap=channelChangeTrap, transmitFreqKHz=transmitFreqKHz, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPState=sNTPState, regionCode=regionCode, constantPowerSpectralDensity=constantPowerSpectralDensity, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDControlGroup=tDDControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, supplementaryGroup=supplementaryGroup, userTable=userTable, ethernetGroup=ethernetGroup, sNTPServerIPAddress=sNTPServerIPAddress, licensedCapacity=licensedCapacity, encryptionAlgorithm=encryptionAlgorithm, longitude=longitude, sNMPEnabledTraps=sNMPEnabledTraps, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, altitude=altitude, dataPortStatusTrap=dataPortStatusTrap, vLANManagementPriority=vLANManagementPriority, iPAddress=iPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, hTTPSPortNumber=hTTPSPortNumber, sNTPLastSync=sNTPLastSync, versionsGroup=versionsGroup, transmitChannel=transmitChannel, userTableIndex=userTableIndex, alarmsGroup=alarmsGroup, userName=userName, telecomsLineCode=telecomsLineCode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, bootVersion=bootVersion, snmpControl=snmpControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLoopback=telecomsLoopback, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telecomsChannelStatus=telecomsChannelStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsMeans=dfsMeans, PYSNMP_MODULE_ID=cambium, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, dfsTableNumber=dfsTableNumber, licenceGroup=licenceGroup, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfs=dfs, pubStatsGroup=pubStatsGroup, eIRP=eIRP)
