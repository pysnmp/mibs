...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userRole=userRole, antennaGain=antennaGain, alarms=alarms, ethernetGroup=ethernetGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelStatusTrap=telecomsChannelStatusTrap, wirelessLinkAvailability=wirelessLinkAvailability, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomGroup=telecomGroup, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, resetGroup=resetGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogControl=syslogControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkSymmetry=linkSymmetry, receiveDataRate=receiveDataRate, frequencyVariant=frequencyVariant, receiveModulationModeDetail=receiveModulationModeDetail, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSyncTrap=sNTPSyncTrap, syslogClientTrap=syslogClientTrap, longitude=longitude, transmitModulationMode=transmitModulationMode, channelChangeTrap=channelChangeTrap, ptpTrapPrefix=ptpTrapPrefix, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetPortNumber=telnetPortNumber, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aAAControl=aAAControl, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkStatus=wirelessLinkStatus, syslogClient=syslogClient, dataPortStatus=dataPortStatus, supplementaryGroup=supplementaryGroup, altitude=altitude, sntpGroup=sntpGroup, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, maximumTransmitPower=maximumTransmitPower, vLANPriorityTableIndex=vLANPriorityTableIndex, ethernet=ethernet, telecomsLoopbackTrap=telecomsLoopbackTrap, ptp=ptp, reset=reset, incompatibleRegionCodes=incompatibleRegionCodes, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vectorError=vectorError, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, encryption=encryption, tDDControl=tDDControl, softwareVersion=softwareVersion, channelBandwidth=channelBandwidth, searchState=searchState, sNMPPortNumber=sNMPPortNumber, notificationsGroup=notificationsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, range=range, sNMPTrapTableEntry=sNMPTrapTableEntry, userTableNumber=userTableNumber, hTTPSPortNumber=hTTPSPortNumber, ptmp=ptmp, snmpControl=snmpControl, licensedCapacity=licensedCapacity, userEnabled=userEnabled, licenceGroup=licenceGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, groupID=groupID, sNTPServerIPAddress=sNTPServerIPAddress, cambium=cambium, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsPeaks=dfsPeaks, receiveFreqMHz=receiveFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, aggregateDataRate=aggregateDataRate, transmitDataRate=transmitDataRate, smtpGroup=smtpGroup, capacityLicenseMismatch=capacityLicenseMismatch, dfsTableIndex=dfsTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sntp=sntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortDisabledWarning=dataPortDisabledWarning, managementGroup=managementGroup, subnetMask=subnetMask, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPLastSync=sNTPLastSync, telnetAccessEnabled=telnetAccessEnabled, telecomsLoopback=telecomsLoopback, encryptionAlgorithm=encryptionAlgorithm, syslogControlGroup=syslogControlGroup, sMTPEnabledMessages=sMTPEnabledMessages, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, byteErrorRatio=byteErrorRatio, smtp=smtp, regionCode=regionCode, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, receiveFreqKHz=receiveFreqKHz, gatewayIPAddress=gatewayIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userPassword=userPassword, productName=productName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, supplementary=supplementary, dfsGroup=dfsGroup, management=management, versions=versions, transmitFreqKHz=transmitFreqKHz, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapPortNumber=sNMPTrapPortNumber, accessMethod=accessMethod, hTTPAccessEnabled=hTTPAccessEnabled, latitude=latitude, systemReset=systemReset, signalStrengthRatio=signalStrengthRatio, PYSNMP_MODULE_ID=cambium, cableLoss=cableLoss, dfsTable=dfsTable, timeZone=timeZone, sNMPCommunityString=sNMPCommunityString, userTableEntry=userTableEntry, vLANManagementPriority=vLANManagementPriority, receiveChannel=receiveChannel, userTableIndex=userTableIndex, masterSlaveMode=masterSlaveMode, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogState=syslogState, telecomsCableLength=telecomsCableLength, sNTPState=sNTPState, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, hardwareVersion=hardwareVersion, userName=userName, receivePower=receivePower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bootVersion=bootVersion, installArmStateTrap=installArmStateTrap, phyControlGroup=phyControlGroup, installStatusTrap=installStatusTrap, configuration=configuration, systemClock=systemClock, tDDSynchronizationStatus=tDDSynchronizationStatus, regionCodeTrap=regionCodeTrap, dfs=dfs, sNTPSync=sNTPSync, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetFiberSupport=ethernetFiberSupport, aAAControlGroup=aAAControlGroup, vLANManagementVID=vLANManagementVID, configurationGroup=configurationGroup, pubStats=pubStats, alarmsGroup=alarmsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPAddress=iPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versionsGroup=versionsGroup, sNTPPollInterval=sNTPPollInterval, vLANPriorityTableEntry=vLANPriorityTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, daylightSaving=daylightSaving, targetMACAddress=targetMACAddress, ptp500=ptp500, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsMeans=dfsMeans, snmpControlGroup=snmpControlGroup, linkLoss=linkLoss, sMTPServerIPAddress=sMTPServerIPAddress, siteName=siteName, licence=licence, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, installArmState=installArmState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, phyControl=phyControl, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, pubStatsGroup=pubStatsGroup, sNMPEnabledTraps=sNMPEnabledTraps, phyStatus=phyStatus, sNMPTrapVersion=sNMPTrapVersion, vLANPriorityTable=vLANPriorityTable, productVariant=productVariant, transmitChannel=transmitChannel, receiveModulationMode=receiveModulationMode, telecomsInterface=telecomsInterface, telecomsChannelStatus=telecomsChannelStatus, dfsTableNumber=dfsTableNumber, transmitFreqMHz=transmitFreqMHz, userTable=userTable, linkModeOptimisation=linkModeOptimisation, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPServerPortNumber=sMTPServerPortNumber, ptpGroups=ptpGroups, eIRP=eIRP, telecomsLineCode=telecomsLineCode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecom=telecom, ptpTraps=ptpTraps, transmitPower=transmitPower, installStatus=installStatus, unitOutOfCalibration=unitOutOfCalibration, sNTPServerPortNumber=sNTPServerPortNumber, syslogStateTrap=syslogStateTrap, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable)
