...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPEnabledTraps=sNMPEnabledTraps, installStatus=installStatus, ptmp=ptmp, sNMPCommunityString=sNMPCommunityString, configurationGroup=configurationGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, hardwareVersion=hardwareVersion, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, phyStatusGroup=phyStatusGroup, antennaGain=antennaGain, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableLoss=cableLoss, dataPortStatusTrap=dataPortStatusTrap, maximumTransmitPower=maximumTransmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsTableEntry=dfsTableEntry, masterSlaveMode=masterSlaveMode, receiveDataRate=receiveDataRate, resetGroup=resetGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsCableLength=telecomsCableLength, channelBandwidth=channelBandwidth, receiveFreqMHz=receiveFreqMHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aAAControl=aAAControl, timeZone=timeZone, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkName=linkName, sNMPv3Enable=sNMPv3Enable, syslogControlGroup=syslogControlGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkStatus=wirelessLinkStatus, signalStrengthRatio=signalStrengthRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitModulationMode=transmitModulationMode, vLANPriorityTable=vLANPriorityTable, sNMPPortNumber=sNMPPortNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPServerIPAddress=tFTPServerIPAddress, range=range, sNTPPollInterval=sNTPPollInterval, telecomGroup=telecomGroup, syslogControl=syslogControl, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapIPAddress=sNMPTrapIPAddress, phyStatus=phyStatus, versionsGroup=versionsGroup, tDDControlGroup=tDDControlGroup, altitude=altitude, linkSymmetry=linkSymmetry, dfsTable=dfsTable, userName=userName, syslogClientTrap=syslogClientTrap, subnetMask=subnetMask, dfsTableNumber=dfsTableNumber, sNTPSync=sNTPSync, productName=productName, tDDSynchronizationMode=tDDSynchronizationMode, phyControl=phyControl, dataPortStatus=dataPortStatus, hTTPPortNumber=hTTPPortNumber, syslogState=syslogState, reset=reset, userTableIndex=userTableIndex, dfsMeans=dfsMeans, regionCodeTrap=regionCodeTrap, receiveModulationModeDetail=receiveModulationModeDetail, transmitDataRate=transmitDataRate, telecomsLineCode=telecomsLineCode, snmpControl=snmpControl, pubStats=pubStats, sMTPEnabledMessages=sMTPEnabledMessages, regionCode=regionCode, ethernet=ethernet, productVariant=productVariant, searchState=searchState, notificationsGroup=notificationsGroup, phyControlGroup=phyControlGroup, installArmStateTrap=installArmStateTrap, versions=versions, ethernetFiberSupport=ethernetFiberSupport, userTableNumber=userTableNumber, alarms=alarms, vLANManagementVID=vLANManagementVID, telecomsLoopbackTrap=telecomsLoopbackTrap, ptpGroups=ptpGroups, telecom=telecom, dfs=dfs, transmitPower=transmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp500=ptp500, bootVersion=bootVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, sNMPTrapTable=sNMPTrapTable, smtpGroup=smtpGroup, secondarySoftwareVersion=secondarySoftwareVersion, longitude=longitude, PYSNMP_MODULE_ID=cambium, ptp=ptp, encryptionGroup=encryptionGroup, dfsGroup=dfsGroup, hTTPSPortNumber=hTTPSPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telnetAccessEnabled=telnetAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, receiveModulationMode=receiveModulationMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sntpGroup=sntpGroup, receiveFreqKHz=receiveFreqKHz, syslogClient=syslogClient, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licensedCapacity=licensedCapacity, management=management, cambium=cambium, systemReset=systemReset, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, siteName=siteName, sMTPEmailAlert=sMTPEmailAlert, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelChangeTrap=channelChangeTrap, sMTPServerIPAddress=sMTPServerIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, vLANPriorityTableNumber=vLANPriorityTableNumber, vectorError=vectorError, daylightSaving=daylightSaving, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableIndex=dfsTableIndex, wirelessLinkAvailability=wirelessLinkAvailability, sMTPServerPortNumber=sMTPServerPortNumber, encryption=encryption, gatewayIPAddress=gatewayIPAddress, userRole=userRole, transmitChannel=transmitChannel, sNTPServerPortNumber=sNTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, receivePower=receivePower, telecomsInterface=telecomsInterface, transmitFreqMHz=transmitFreqMHz, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, capacityLicenseMismatch=capacityLicenseMismatch, snmpControlGroup=snmpControlGroup, receiveChannel=receiveChannel, userPassword=userPassword, useVLANForManagementInterfaces=useVLANForManagementInterfaces, accessMethod=accessMethod, latitude=latitude, supplementaryGroup=supplementaryGroup, dfsPeaks=dfsPeaks, telecomsLoopback=telecomsLoopback, iPAddress=iPAddress, bandwidthVariant=bandwidthVariant, sNTPServerIPAddress=sNTPServerIPAddress, sntp=sntp, alarmsGroup=alarmsGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTraps=ptpTraps, sNTPSyncTrap=sNTPSyncTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, installStatusTrap=installStatusTrap, userTableEntry=userTableEntry, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkLoss=linkLoss, aAAControlGroup=aAAControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, linkModeOptimizationMismatch=linkModeOptimizationMismatch, smtp=smtp, sNTPLastSync=sNTPLastSync, constantPowerSpectralDensity=constantPowerSpectralDensity, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANManagementPriority=vLANManagementPriority, aggregateDataRate=aggregateDataRate, pubStatsGroup=pubStatsGroup, managementGroup=managementGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, byteErrorRatio=byteErrorRatio, configuration=configuration, systemClock=systemClock, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPAccessEnabled=hTTPAccessEnabled, softwareVersion=softwareVersion, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, remoteIPAddress=remoteIPAddress, groupID=groupID, telnetPortNumber=telnetPortNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, ptpCompliance=ptpCompliance, linkModeOptimisation=linkModeOptimisation, eIRP=eIRP, licence=licence, userTable=userTable, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernetGroup=ethernetGroup, licenceGroup=licenceGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitFreqKHz=transmitFreqKHz, telecomsChannelStatus=telecomsChannelStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDControl=tDDControl, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTableIndex=vLANPriorityTableIndex, incompatibleRegionCodes=incompatibleRegionCodes, targetMACAddress=targetMACAddress, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userEnabled=userEnabled, frequencyVariant=frequencyVariant, installArmState=installArmState, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortAutoMdix=dataPortAutoMdix, sNTPState=sNTPState, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap)
