...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", constantPowerSpectralDensity=constantPowerSpectralDensity, productVariant=productVariant, telecomsChannelStatus=telecomsChannelStatus, sNTPState=sNTPState, siteName=siteName, phyControl=phyControl, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementary=supplementary, resetGroup=resetGroup, regionCode=regionCode, sNTPLastSync=sNTPLastSync, iPAddress=iPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, antennaGain=antennaGain, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, aAAControl=aAAControl, frequencyVariant=frequencyVariant, sNMPEnabledTraps=sNMPEnabledTraps, userTable=userTable, bandwidthVariant=bandwidthVariant, ptpGroups=ptpGroups, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveFreqKHz=receiveFreqKHz, longitude=longitude, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, subnetMask=subnetMask, telecom=telecom, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, receivePower=receivePower, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, masterSlaveMode=masterSlaveMode, gatewayIPAddress=gatewayIPAddress, notificationsGroup=notificationsGroup, tDDControlGroup=tDDControlGroup, telnetPortNumber=telnetPortNumber, searchState=searchState, snmpControlGroup=snmpControlGroup, licenceGroup=licenceGroup, sNMPv3Enable=sNMPv3Enable, dfsGroup=dfsGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, capacityLicenseMismatch=capacityLicenseMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogState=syslogState, dataPortAutoNegotiation=dataPortAutoNegotiation, channelBandwidth=channelBandwidth, systemClock=systemClock, eIRP=eIRP, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPPollInterval=sNTPPollInterval, timeZone=timeZone, hTTPAccessEnabled=hTTPAccessEnabled, transmitChannel=transmitChannel, wirelessLinkAvailability=wirelessLinkAvailability, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStatsGroup=pubStatsGroup, syslogClientTrap=syslogClientTrap, alarms=alarms, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoMdix=dataPortAutoMdix, versions=versions, softwareVersion=softwareVersion, sNTPSyncTrap=sNTPSyncTrap, sNMPTrapVersion=sNMPTrapVersion, latitude=latitude, targetMACAddress=targetMACAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptpTrapPrefix=ptpTrapPrefix, bootVersion=bootVersion, wirelessLinkStatus=wirelessLinkStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTable=dfsTable, configurationGroup=configurationGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, hardwareVersion=hardwareVersion, cableLoss=cableLoss, smtpGroup=smtpGroup, licensedCapacity=licensedCapacity, tDDControl=tDDControl, PYSNMP_MODULE_ID=cambium, dfsPeaks=dfsPeaks, secondarySoftwareVersion=secondarySoftwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, channelChangeTrap=channelChangeTrap, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userPassword=userPassword, sNTPSync=sNTPSync, receiveFreqMHz=receiveFreqMHz, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, installArmState=installArmState, ethernetFiberSupport=ethernetFiberSupport, signalStrengthRatio=signalStrengthRatio, userTableNumber=userTableNumber, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, daylightSaving=daylightSaving, ethernet=ethernet, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsTableNumber=dfsTableNumber, aAAControlGroup=aAAControlGroup, syslogStateTrap=syslogStateTrap, transmitDataRate=transmitDataRate, linkName=linkName, useVLANForManagementInterfaces=useVLANForManagementInterfaces, pubStats=pubStats, vectorError=vectorError, vLANPriorityTable=vLANPriorityTable, userName=userName, installStatusTrap=installStatusTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, smtp=smtp, vLANManagementVID=vLANManagementVID, supplementaryGroup=supplementaryGroup, ethernetGroup=ethernetGroup, linkSymmetry=linkSymmetry, dfsTableIndex=dfsTableIndex, phyControlGroup=phyControlGroup, receiveChannel=receiveChannel, regionCodeTrap=regionCodeTrap, sNMPPortNumber=sNMPPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, receiveDataRate=receiveDataRate, ptpCompliance=ptpCompliance, snmpControl=snmpControl, systemReset=systemReset, tDDSynchronizationStatus=tDDSynchronizationStatus, telnetAccessEnabled=telnetAccessEnabled, phyStatusGroup=phyStatusGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, maximumTransmitPower=maximumTransmitPower, groupID=groupID, management=management, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, byteErrorRatio=byteErrorRatio, syslogControlGroup=syslogControlGroup, licence=licence, syslogControl=syslogControl, ptp=ptp, telecomsLineCode=telecomsLineCode, userTableIndex=userTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNMPTrapTableEntry=sNMPTrapTableEntry, configuration=configuration, ptp500=ptp500, ptpTraps=ptpTraps, linkModeOptimisation=linkModeOptimisation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userEnabled=userEnabled, encryptionGroup=encryptionGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, accessMethod=accessMethod, encryption=encryption, transmitModulationMode=transmitModulationMode, telecomsInterface=telecomsInterface, range=range, aggregateDataRate=aggregateDataRate, sNMPTrapTable=sNMPTrapTable, linkLoss=linkLoss, cambium=cambium, telecomGroup=telecomGroup, installArmStateTrap=installArmStateTrap, telecomsLoopback=telecomsLoopback, dataPortStatus=dataPortStatus, altitude=altitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, reset=reset, sntp=sntp, hTTPPortNumber=hTTPPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, versionsGroup=versionsGroup, dataPortDisabledWarning=dataPortDisabledWarning, transmitFreqKHz=transmitFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, transmitFreqMHz=transmitFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup, vLANManagementPriority=vLANManagementPriority, dfs=dfs, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sntpGroup=sntpGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsCableLength=telecomsCableLength, productName=productName, encryptionAlgorithm=encryptionAlgorithm, tFTPServerPortNumber=tFTPServerPortNumber, receiveModulationMode=receiveModulationMode, dataPortStatusTrap=dataPortStatusTrap, managementGroup=managementGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPServerPortNumber=sMTPServerPortNumber, phyStatus=phyStatus, dfsMeans=dfsMeans, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitPower=transmitPower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userRole=userRole, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPEmailAlert=sMTPEmailAlert, ptmp=ptmp, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogClient=syslogClient)
