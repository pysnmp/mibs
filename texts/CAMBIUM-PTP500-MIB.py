...
Unsigned32, ModuleIdentity, enterprises, Bits, ObjectIdentity, IpAddress, Integer32, Counter32, iso, MibIdentifier, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "ModuleIdentity", "enterprises", "Bits", "ObjectIdentity", "IpAddress", "Integer32", "Counter32", "iso", "MibIdentifier", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", transmitFreqMHz=transmitFreqMHz, management=management, ptp=ptp, frequencyVariant=frequencyVariant, licence=licence, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, notificationsGroup=notificationsGroup, searchState=searchState, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogStateTrap=syslogStateTrap, ethernetGroup=ethernetGroup, hTTPSPortNumber=hTTPSPortNumber, phyControlGroup=phyControlGroup, telnetAccessEnabled=telnetAccessEnabled, hardwareVersion=hardwareVersion, transmitDataRate=transmitDataRate, versions=versions, telecomGroup=telecomGroup, licensedCapacity=licensedCapacity, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimisation=linkModeOptimisation, maximumTransmitPower=maximumTransmitPower, linkName=linkName, managementGroup=managementGroup, range=range, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPSyncTrap=sNTPSyncTrap, transmitPower=transmitPower, linkLoss=linkLoss, ptpCompliance=ptpCompliance, sMTPEnabledMessages=sMTPEnabledMessages, receiveDataRate=receiveDataRate, dataPortAutoMdix=dataPortAutoMdix, vLANManagementVID=vLANManagementVID, installStatus=installStatus, sNTPState=sNTPState, noWirelessChannelAvailable=noWirelessChannelAvailable, longitude=longitude, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementary=supplementary, ethernetFiberSupport=ethernetFiberSupport, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveChannel=receiveChannel, transmitChannel=transmitChannel, pubStatsGroup=pubStatsGroup, sMTPEmailAlert=sMTPEmailAlert, productVariant=productVariant, bandwidthVariant=bandwidthVariant, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtp=smtp, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, unitOutOfCalibration=unitOutOfCalibration, channelChangeTrap=channelChangeTrap, ptpGroups=ptpGroups, dfsPeaks=dfsPeaks, phyStatus=phyStatus, antennaGain=antennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogControlGroup=syslogControlGroup, telecomsChannelStatus=telecomsChannelStatus, vectorError=vectorError, userPassword=userPassword, groupID=groupID, dfsTableIndex=dfsTableIndex, encryptionAlgorithm=encryptionAlgorithm, ptpTrapPrefix=ptpTrapPrefix, remoteIPAddress=remoteIPAddress, targetMACAddress=targetMACAddress, tFTPServerPortNumber=tFTPServerPortNumber, userName=userName, receivePower=receivePower, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfs=dfs, cambium=cambium, phyStatusGroup=phyStatusGroup, smtpGroup=smtpGroup, PYSNMP_MODULE_ID=cambium, reset=reset, aAAControlGroup=aAAControlGroup, productName=productName, transmitFreqKHz=transmitFreqKHz, resetGroup=resetGroup, wirelessLinkStatus=wirelessLinkStatus, dfsMeans=dfsMeans, gatewayIPAddress=gatewayIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, cableLoss=cableLoss, telecomsLoopbackTrap=telecomsLoopbackTrap, userRole=userRole, systemClock=systemClock, userTableEntry=userTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, dfsTableNumber=dfsTableNumber, sNTPSync=sNTPSync, hTTPAccessEnabled=hTTPAccessEnabled, ethernet=ethernet, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableNumber=userTableNumber, subnetMask=subnetMask, sNTPServerPortNumber=sNTPServerPortNumber, wirelessLinkAvailability=wirelessLinkAvailability, tDDControl=tDDControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDSynchronizationMode=tDDSynchronizationMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, eIRP=eIRP, installArmStateTrap=installArmStateTrap, sntp=sntp, supplementaryGroup=supplementaryGroup, aAAControl=aAAControl, siteName=siteName, sMTPServerPortNumber=sMTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, regionCodeTrap=regionCodeTrap, sNTPLastSync=sNTPLastSync, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, pubStats=pubStats, alarms=alarms, vLANPriorityTableEntry=vLANPriorityTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, accessMethod=accessMethod, snmpControl=snmpControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, latitude=latitude, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableIndex=userTableIndex, daylightSaving=daylightSaving, dataPortDisabledWarning=dataPortDisabledWarning, telecomsInterface=telecomsInterface, syslogClientTrap=syslogClientTrap, incompatibleRegionCodes=incompatibleRegionCodes, iPAddress=iPAddress, regionCode=regionCode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, systemReset=systemReset, userTable=userTable, channelBandwidth=channelBandwidth, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortStatus=dataPortStatus, sNMPEnabledTraps=sNMPEnabledTraps, telecomsLoopback=telecomsLoopback, altitude=altitude, ptmp=ptmp, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogState=syslogState, ptp500=ptp500, tDDSynchronizationStatus=tDDSynchronizationStatus, configuration=configuration, dfsGroup=dfsGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, versionsGroup=versionsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, byteErrorRatio=byteErrorRatio, licenceGroup=licenceGroup, ptpTraps=ptpTraps, linkSymmetry=linkSymmetry, vLANPriorityTableIndex=vLANPriorityTableIndex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, installArmState=installArmState, telecomsCableLength=telecomsCableLength, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecom=telecom, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogControl=syslogControl, userEnabled=userEnabled, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, configurationGroup=configurationGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, phyControl=phyControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, hTTPPortNumber=hTTPPortNumber, timeZone=timeZone, sNMPTrapVersion=sNMPTrapVersion, secondarySoftwareVersion=secondarySoftwareVersion, signalStrengthRatio=signalStrengthRatio, receiveFreqMHz=receiveFreqMHz, sNMPCommunityString=sNMPCommunityString, encryptionGroup=encryptionGroup, bootVersion=bootVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, receiveFreqKHz=receiveFreqKHz, tDDControlGroup=tDDControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, telnetPortNumber=telnetPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, telecomsLineCode=telecomsLineCode, dfsTable=dfsTable, masterSlaveMode=masterSlaveMode, snmpControlGroup=snmpControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANPriorityTable=vLANPriorityTable, sNMPPortNumber=sNMPPortNumber, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPServerIPAddress=sMTPServerIPAddress, encryption=encryption, syslogClient=syslogClient, tFTPServerIPAddress=tFTPServerIPAddress, sNMPv3Enable=sNMPv3Enable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, installStatusTrap=installStatusTrap, transmitModulationMode=transmitModulationMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade)
