...
Bits, TimeTicks, Counter64, MibIdentifier, Counter32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Unsigned32, ModuleIdentity, Integer32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Counter64", "MibIdentifier", "Counter32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "Integer32", "enterprises", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpCompliance=ptpCompliance, userName=userName, sMTPEnabledMessages=sMTPEnabledMessages, ethernetFiberSupport=ethernetFiberSupport, phyStatus=phyStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogControlGroup=syslogControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveModulationMode=receiveModulationMode, eIRP=eIRP, groupID=groupID, userTableEntry=userTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPEnabledTraps=sNMPEnabledTraps, userTableIndex=userTableIndex, notificationsGroup=notificationsGroup, ethernetGroup=ethernetGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitPower=transmitPower, longitude=longitude, altitude=altitude, ptpGroups=ptpGroups, snmpControlGroup=snmpControlGroup, dataPortAutoMdix=dataPortAutoMdix, phyControl=phyControl, ethernet=ethernet, vLANPriorityTableIndex=vLANPriorityTableIndex, reset=reset, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogState=syslogState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, smtp=smtp, dfsMeans=dfsMeans, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableNumber=dfsTableNumber, maximumTransmitPower=maximumTransmitPower, ptpTraps=ptpTraps, sNTPSync=sNTPSync, encryptionAlgorithm=encryptionAlgorithm, syslogStateTrap=syslogStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, siteName=siteName, accessMethod=accessMethod, managementGroup=managementGroup, receiveFreqMHz=receiveFreqMHz, dfsTableIndex=dfsTableIndex, productName=productName, telecomsInterface=telecomsInterface, telecomsLoopback=telecomsLoopback, regionCodeTrap=regionCodeTrap, secondarySoftwareVersion=secondarySoftwareVersion, receiveFreqKHz=receiveFreqKHz, cambium=cambium, dataPortStatusTrap=dataPortStatusTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionGroup=encryptionGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, cableLoss=cableLoss, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, tDDControl=tDDControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkStatus=wirelessLinkStatus, userPassword=userPassword, ptp=ptp, telecomsChannelStatusTrap=telecomsChannelStatusTrap, signalStrengthRatio=signalStrengthRatio, management=management, sNMPPortNumber=sNMPPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, installStatus=installStatus, regionCode=regionCode, range=range, aAAControl=aAAControl, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTable=sNMPTrapTable, licence=licence, supplementary=supplementary, dfsTableEntry=dfsTableEntry, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, pubStatsGroup=pubStatsGroup, frequencyVariant=frequencyVariant, hardwareVersion=hardwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTableEntry=sNMPTrapTableEntry, licensedCapacity=licensedCapacity, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemClock=systemClock, vLANPriorityTable=vLANPriorityTable, telecom=telecom, sNTPServerPortNumber=sNTPServerPortNumber, sntpGroup=sntpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, targetMACAddress=targetMACAddress, wirelessLinkAvailability=wirelessLinkAvailability, receiveChannel=receiveChannel, vLANPriorityTableEntry=vLANPriorityTableEntry, incompatibleRegionCodes=incompatibleRegionCodes, syslogClientTrap=syslogClientTrap, alarmsGroup=alarmsGroup, encryption=encryption, gatewayIPAddress=gatewayIPAddress, daylightSaving=daylightSaving, sNTPServerIPAddress=sNTPServerIPAddress, sNTPLastSync=sNTPLastSync, linkLoss=linkLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, alarms=alarms, licenceGroup=licenceGroup, sMTPServerIPAddress=sMTPServerIPAddress, receivePower=receivePower, ptmp=ptmp, versions=versions, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPPortNumber=hTTPPortNumber, snmpControl=snmpControl, phyStatusGroup=phyStatusGroup, searchState=searchState, linkName=linkName, sNTPPollInterval=sNTPPollInterval, timeZone=timeZone, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, productVariant=productVariant, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPSyncTrap=sNTPSyncTrap, bandwidthVariant=bandwidthVariant, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsLineCode=telecomsLineCode, channelChangeTrap=channelChangeTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogClient=syslogClient, userTable=userTable, userEnabled=userEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp500=ptp500, linkModeOptimisation=linkModeOptimisation, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapTableNumber=sNMPTrapTableNumber, sntp=sntp, transmitModulationMode=transmitModulationMode, userTableNumber=userTableNumber, telecomGroup=telecomGroup, sNMPCommunityString=sNMPCommunityString, versionsGroup=versionsGroup, receiveModulationModeDetail=receiveModulationModeDetail, dfsPeaks=dfsPeaks, dfsTable=dfsTable, telnetPortNumber=telnetPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, configuration=configuration, configurationGroup=configurationGroup, userRole=userRole, phyControlGroup=phyControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, hTTPSPortNumber=hTTPSPortNumber, PYSNMP_MODULE_ID=cambium, bootVersion=bootVersion, syslogControl=syslogControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, iPAddress=iPAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, latitude=latitude, supplementaryGroup=supplementaryGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsCableLength=telecomsCableLength, tFTPServerPortNumber=tFTPServerPortNumber, vectorError=vectorError, systemReset=systemReset, telecomsChannelStatus=telecomsChannelStatus, aAAControlGroup=aAAControlGroup, transmitChannel=transmitChannel, sNTPState=sNTPState, transmitFreqMHz=transmitFreqMHz, ptpTrapPrefix=ptpTrapPrefix, byteErrorRatio=byteErrorRatio, transmitFreqKHz=transmitFreqKHz, capacityLicenseMismatch=capacityLicenseMismatch, installArmStateTrap=installArmStateTrap, channelBandwidth=channelBandwidth, remoteMaximumTransmitPower=remoteMaximumTransmitPower, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapIPAddress=sNMPTrapIPAddress, sNMPv3Enable=sNMPv3Enable, dataPortStatus=dataPortStatus, sNMPTrapVersion=sNMPTrapVersion, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsGroup=dfsGroup, installStatusTrap=installStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, masterSlaveMode=masterSlaveMode, resetGroup=resetGroup, tDDControlGroup=tDDControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, tDDSynchronizationMode=tDDSynchronizationMode, smtpGroup=smtpGroup, dfs=dfs, remoteIPAddress=remoteIPAddress, antennaGain=antennaGain, vLANManagementPriority=vLANManagementPriority, installArmState=installArmState)
