...
Bits, Integer32, IpAddress, ModuleIdentity, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Unsigned32, MibIdentifier, ObjectIdentity, TimeTicks, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "IpAddress", "ModuleIdentity", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Unsigned32", "MibIdentifier", "ObjectIdentity", "TimeTicks", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userRole=userRole, ethernetGroup=ethernetGroup, transmitPower=transmitPower, sNMPTrapTableIndex=sNMPTrapTableIndex, signalStrengthRatio=signalStrengthRatio, channelChangeTrap=channelChangeTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, PYSNMP_MODULE_ID=cambium, receiveModulationModeDetail=receiveModulationModeDetail, linkName=linkName, userTableIndex=userTableIndex, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, linkSymmetry=linkSymmetry, sMTPEmailAlert=sMTPEmailAlert, sMTPEnabledMessages=sMTPEnabledMessages, transmitChannel=transmitChannel, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryption=encryption, softwareVersion=softwareVersion, productVariant=productVariant, sntp=sntp, smtp=smtp, telnetPortNumber=telnetPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, ptp500=ptp500, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsGroup=dfsGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, notificationsGroup=notificationsGroup, dfsTableIndex=dfsTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsInterface=telecomsInterface, telecomGroup=telecomGroup, sNTPSyncTrap=sNTPSyncTrap, installStatus=installStatus, hTTPSPortNumber=hTTPSPortNumber, licence=licence, syslogControlGroup=syslogControlGroup, sNMPTrapTable=sNMPTrapTable, ethernetFiberSupport=ethernetFiberSupport, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANManagementVID=vLANManagementVID, vLANPriorityTableEntry=vLANPriorityTableEntry, telecom=telecom, supplementary=supplementary, dfs=dfs, productName=productName, installStatusTrap=installStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, secondarySoftwareVersion=secondarySoftwareVersion, versionsGroup=versionsGroup, ptpTraps=ptpTraps, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, sntpGroup=sntpGroup, pubStats=pubStats, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPServerIPAddress=tFTPServerIPAddress, pubStatsGroup=pubStatsGroup, wirelessLinkAvailability=wirelessLinkAvailability, capacityLicenseMismatch=capacityLicenseMismatch, aAAControl=aAAControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPState=sNTPState, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, configurationGroup=configurationGroup, tFTPServerPortNumber=tFTPServerPortNumber, userTableEntry=userTableEntry, transmitFreqMHz=transmitFreqMHz, channelBandwidth=channelBandwidth, dfsTable=dfsTable, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, userPassword=userPassword, remoteMaximumTransmitPower=remoteMaximumTransmitPower, remoteIPAddress=remoteIPAddress, resetGroup=resetGroup, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, bootVersion=bootVersion, dataPortAutoMdix=dataPortAutoMdix, dataPortStatus=dataPortStatus, management=management, alarms=alarms, incompatibleRegionCodes=incompatibleRegionCodes, latitude=latitude, linkLoss=linkLoss, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetAccessEnabled=telnetAccessEnabled, eIRP=eIRP, receiveFreqKHz=receiveFreqKHz, ptpGroups=ptpGroups, antennaGain=antennaGain, dfsTableEntry=dfsTableEntry, sNMPv3Enable=sNMPv3Enable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControl=syslogControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControlGroup=aAAControlGroup, bandwidthVariant=bandwidthVariant, encryptionAlgorithm=encryptionAlgorithm, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableNumber=userTableNumber, longitude=longitude, sNMPTrapPortNumber=sNMPTrapPortNumber, subnetMask=subnetMask, altitude=altitude, iPAddress=iPAddress, userEnabled=userEnabled, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogClientTrap=syslogClientTrap, sNTPServerPortNumber=sNTPServerPortNumber, installArmState=installArmState, syslogStateTrap=syslogStateTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementaryGroup=supplementaryGroup, configuration=configuration, tDDControlGroup=tDDControlGroup, targetMACAddress=targetMACAddress, systemReset=systemReset, userTable=userTable, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, tDDControl=tDDControl, sMTPServerIPAddress=sMTPServerIPAddress, userName=userName, phyControlGroup=phyControlGroup, installArmStateTrap=installArmStateTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, timeZone=timeZone, dataPortConfigurationMismatch=dataPortConfigurationMismatch, phyStatusGroup=phyStatusGroup, vLANPriorityTable=vLANPriorityTable, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, dataPortStatusTrap=dataPortStatusTrap, linkModeOptimisation=linkModeOptimisation, vectorError=vectorError, ethernet=ethernet, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, frequencyVariant=frequencyVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch, smtpGroup=smtpGroup, receiveChannel=receiveChannel, reset=reset, syslogClient=syslogClient, ptpCompliance=ptpCompliance, ptp=ptp, cambium=cambium, transmitModulationMode=transmitModulationMode, systemClock=systemClock, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapVersion=sNMPTrapVersion, managementGroup=managementGroup, sNMPEnabledTraps=sNMPEnabledTraps, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyControl=phyControl, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, aggregateDataRate=aggregateDataRate, versions=versions, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsLoopback=telecomsLoopback, receiveFreqMHz=receiveFreqMHz, hardwareVersion=hardwareVersion, dfsTableNumber=dfsTableNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, encryptionGroup=encryptionGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, alarmsGroup=alarmsGroup, byteErrorRatio=byteErrorRatio, sNTPPollInterval=sNTPPollInterval, tDDSynchronizationMode=tDDSynchronizationMode, telecomsCableLength=telecomsCableLength, sNTPServerIPAddress=sNTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, accessMethod=accessMethod, daylightSaving=daylightSaving, telecomsLineCode=telecomsLineCode, hTTPAccessEnabled=hTTPAccessEnabled, cableLoss=cableLoss, siteName=siteName, groupID=groupID, hTTPPortNumber=hTTPPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receivePower=receivePower, ptmp=ptmp, dfsMeans=dfsMeans, sNTPSync=sNTPSync, snmpControl=snmpControl, hTTPSAccessEnabled=hTTPSAccessEnabled, phyStatus=phyStatus, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licensedCapacity=licensedCapacity, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, licenceGroup=licenceGroup, snmpControlGroup=snmpControlGroup, syslogState=syslogState, sNTPLastSync=sNTPLastSync, sNMPCommunityString=sNMPCommunityString, dfsPeaks=dfsPeaks)
