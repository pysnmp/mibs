...
# Produced by pysmi-1.1.8 at Fri Jan  7 00:10:06 2022
...
iso, ModuleIdentity, Unsigned32, IpAddress, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, Counter32, Counter64, Bits, Integer32, NotificationType, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "Unsigned32", "IpAddress", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "Counter32", "Counter64", "Bits", "Integer32", "NotificationType", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogControl=syslogControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installArmState=installArmState, configurationGroup=configurationGroup, versionsGroup=versionsGroup, sMTPServerPortNumber=sMTPServerPortNumber, ptmp=ptmp, linkModeOptimizationMismatch=linkModeOptimizationMismatch, management=management, ptp500=ptp500, hTTPPortNumber=hTTPPortNumber, tDDControl=tDDControl, sNMPCommunityString=sNMPCommunityString, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telnetAccessEnabled=telnetAccessEnabled, snmpControl=snmpControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControlGroup=syslogControlGroup, userTable=userTable, antennaGain=antennaGain, daylightSaving=daylightSaving, frequencyVariant=frequencyVariant, tDDControlGroup=tDDControlGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, supplementary=supplementary, receiveModulationModeDetail=receiveModulationModeDetail, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, pubStats=pubStats, userTableEntry=userTableEntry, snmpControlGroup=snmpControlGroup, installStatusTrap=installStatusTrap, byteErrorRatio=byteErrorRatio, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, cambium=cambium, productVariant=productVariant, productName=productName, ethernetFiberSupport=ethernetFiberSupport, dfs=dfs, dfsTableEntry=dfsTableEntry, range=range, incompatibleRegionCodes=incompatibleRegionCodes, userEnabled=userEnabled, PYSNMP_MODULE_ID=cambium, wirelessLinkStatus=wirelessLinkStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, phyStatusGroup=phyStatusGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANManagementPriority=vLANManagementPriority, timeZone=timeZone, linkModeOptimisation=linkModeOptimisation, signalStrengthRatio=signalStrengthRatio, constantPowerSpectralDensity=constantPowerSpectralDensity, longitude=longitude, receiveChannel=receiveChannel, tFTPServerPortNumber=tFTPServerPortNumber, userName=userName, dfsPeaks=dfsPeaks, sNTPServerIPAddress=sNTPServerIPAddress, vLANManagementVID=vLANManagementVID, secondarySoftwareVersion=secondarySoftwareVersion, regionCode=regionCode, dfsTableNumber=dfsTableNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, eIRP=eIRP, ptpCompliance=ptpCompliance, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTrapPrefix=ptpTrapPrefix, dfsGroup=dfsGroup, telecomsCableLength=telecomsCableLength, vLANPriorityTableNumber=vLANPriorityTableNumber, bootVersion=bootVersion, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPSyncTrap=sNTPSyncTrap, supplementaryGroup=supplementaryGroup, masterSlaveMode=masterSlaveMode, ptpGroups=ptpGroups, encryptionAlgorithm=encryptionAlgorithm, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, syslogStateTrap=syslogStateTrap, linkLoss=linkLoss, userTableIndex=userTableIndex, aggregateDataRate=aggregateDataRate, telecomsLoopbackTrap=telecomsLoopbackTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitChannel=transmitChannel, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, tDDSynchronizationStatus=tDDSynchronizationStatus, channelChangeTrap=channelChangeTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, managementGroup=managementGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, licensedCapacity=licensedCapacity, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernetGroup=ethernetGroup, targetMACAddress=targetMACAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, hardwareVersion=hardwareVersion, dfsMeans=dfsMeans, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitFreqMHz=transmitFreqMHz, userPassword=userPassword, vectorError=vectorError, wirelessLinkAvailability=wirelessLinkAvailability, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, systemClock=systemClock, dfsTableIndex=dfsTableIndex, remoteIPAddress=remoteIPAddress, cableLoss=cableLoss, encryptionGroup=encryptionGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPSPortNumber=hTTPSPortNumber, transmitPower=transmitPower, licence=licence, userRole=userRole, altitude=altitude, iPAddress=iPAddress, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, smtpGroup=smtpGroup, sNMPTrapVersion=sNMPTrapVersion, dataPortStatus=dataPortStatus, sNTPSync=sNTPSync, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, phyStatus=phyStatus, ethernet=ethernet, encryption=encryption, dataPortAutoMdix=dataPortAutoMdix, enabledDiagnosticAlarms=enabledDiagnosticAlarms, useVLANForManagementInterfaces=useVLANForManagementInterfaces, transmitFreqKHz=transmitFreqKHz, linkSymmetry=linkSymmetry, systemReset=systemReset, siteName=siteName, capacityLicenseMismatch=capacityLicenseMismatch, vLANPriorityTable=vLANPriorityTable, transmitModulationMode=transmitModulationMode, gatewayIPAddress=gatewayIPAddress, hTTPAccessEnabled=hTTPAccessEnabled, syslogClient=syslogClient, subnetMask=subnetMask, regionCodeTrap=regionCodeTrap, reset=reset, pubStatsGroup=pubStatsGroup, resetGroup=resetGroup, aAAControlGroup=aAAControlGroup, bandwidthVariant=bandwidthVariant, installStatus=installStatus, maximumTransmitPower=maximumTransmitPower, alarms=alarms, tDDSynchronizationMode=tDDSynchronizationMode, phyControlGroup=phyControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsInterface=telecomsInterface, accessMethod=accessMethod, sNMPv3Enable=sNMPv3Enable, versions=versions, receiveModulationMode=receiveModulationMode, telecomsLineCode=telecomsLineCode, telecomsChannelStatus=telecomsChannelStatus, receiveFreqKHz=receiveFreqKHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptp=ptp, telecomGroup=telecomGroup, softwareVersion=softwareVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveFreqMHz=receiveFreqMHz, dataPortStatusTrap=dataPortStatusTrap, syslogClientTrap=syslogClientTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, unitOutOfCalibration=unitOutOfCalibration, dfsTable=dfsTable, installArmStateTrap=installArmStateTrap, userTableNumber=userTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, groupID=groupID, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRate=transmitDataRate, sNMPPortNumber=sNMPPortNumber, syslogState=syslogState, telecom=telecom, linkName=linkName, latitude=latitude, notificationsGroup=notificationsGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPPollInterval=sNTPPollInterval, licenceGroup=licenceGroup, sNTPServerPortNumber=sNTPServerPortNumber, smtp=smtp, sntp=sntp, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableNumber=sNMPTrapTableNumber, sntpGroup=sntpGroup, telnetPortNumber=telnetPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPState=sNTPState, vLANPriorityTableEntry=vLANPriorityTableEntry, alarmsGroup=alarmsGroup, phyControl=phyControl, channelBandwidth=channelBandwidth, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, telecomsLoopback=telecomsLoopback, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, aAAControl=aAAControl, configuration=configuration, receiveDataRate=receiveDataRate, sNTPLastSync=sNTPLastSync, sNMPTrapTableIndex=sNMPTrapTableIndex, receivePower=receivePower, hTTPSAccessEnabled=hTTPSAccessEnabled, dataPortDisabledWarning=dataPortDisabledWarning)
