...
Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, ObjectIdentity, Counter64, Integer32, iso, TimeTicks, Gauge32, NotificationType, Counter32, enterprises, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "ObjectIdentity", "Counter64", "Integer32", "iso", "TimeTicks", "Gauge32", "NotificationType", "Counter32", "enterprises", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, syslogControlGroup=syslogControlGroup, configuration=configuration, notificationsGroup=notificationsGroup, receivePower=receivePower, versionsGroup=versionsGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptmp=ptmp, snmpControlGroup=snmpControlGroup, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, ptp=ptp, smtpGroup=smtpGroup, iPAddress=iPAddress, installStatus=installStatus, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoMdix=dataPortAutoMdix, transmitModulationMode=transmitModulationMode, systemReset=systemReset, regionCodeTrap=regionCodeTrap, sNMPTrapTable=sNMPTrapTable, vLANPriorityTable=vLANPriorityTable, vLANPriorityTableIndex=vLANPriorityTableIndex, encryption=encryption, snmpControl=snmpControl, ptpTraps=ptpTraps, userPassword=userPassword, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, altitude=altitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, searchState=searchState, transmitChannel=transmitChannel, receiveChannel=receiveChannel, productName=productName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerPortNumber=sMTPServerPortNumber, dfsPeaks=dfsPeaks, phyStatusGroup=phyStatusGroup, transmitPower=transmitPower, pubStats=pubStats, bootVersion=bootVersion, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsLineCode=telecomsLineCode, syslogClientTrap=syslogClientTrap, targetMACAddress=targetMACAddress, subnetMask=subnetMask, tDDControlGroup=tDDControlGroup, range=range, capacityLicenseMismatch=capacityLicenseMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, userTableIndex=userTableIndex, reset=reset, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, management=management, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDControl=tDDControl, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableLoss=cableLoss, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkSymmetry=linkSymmetry, pubStatsGroup=pubStatsGroup, phyControlGroup=phyControlGroup, phyStatus=phyStatus, groupID=groupID, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkModeOptimisation=linkModeOptimisation, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, dfs=dfs, constantPowerSpectralDensity=constantPowerSpectralDensity, ptpGroups=ptpGroups, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkLoss=linkLoss, timeZone=timeZone, softwareVersion=softwareVersion, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogControl=syslogControl, syslogState=syslogState, incompatibleRegionCodes=incompatibleRegionCodes, eIRP=eIRP, telecomsCableLength=telecomsCableLength, telecomsChannelStatus=telecomsChannelStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveModulationModeDetail=receiveModulationModeDetail, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, sntp=sntp, dfsMeans=dfsMeans, siteName=siteName, wirelessLinkAvailability=wirelessLinkAvailability, sNTPSync=sNTPSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licence=licence, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTableEntry=dfsTableEntry, transmitFreqKHz=transmitFreqKHz, encryptionAlgorithm=encryptionAlgorithm, gatewayIPAddress=gatewayIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dfsGroup=dfsGroup, dataPortStatus=dataPortStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPLastSync=sNTPLastSync, transmitDataRate=transmitDataRate, ptpCompliance=ptpCompliance, wirelessLinkStatus=wirelessLinkStatus, userRole=userRole, userTable=userTable, aggregateDataRate=aggregateDataRate, dataPortStatusTrap=dataPortStatusTrap, sNTPState=sNTPState, sNTPServerPortNumber=sNTPServerPortNumber, PYSNMP_MODULE_ID=cambium, licensedCapacity=licensedCapacity, regionCode=regionCode, unitOutOfCalibration=unitOutOfCalibration, hTTPPortNumber=hTTPPortNumber, alarmsGroup=alarmsGroup, userEnabled=userEnabled, tFTPServerPortNumber=tFTPServerPortNumber, vLANManagementPriority=vLANManagementPriority, sNMPTrapVersion=sNMPTrapVersion, sNMPEnabledTraps=sNMPEnabledTraps, frequencyVariant=frequencyVariant, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPSyncTrap=sNTPSyncTrap, receiveModulationMode=receiveModulationMode, hTTPAccessEnabled=hTTPAccessEnabled, userTableNumber=userTableNumber, telecom=telecom, phyControl=phyControl, managementGroup=managementGroup, tFTPServerIPAddress=tFTPServerIPAddress, signalStrengthRatio=signalStrengthRatio, hardwareVersion=hardwareVersion, alarms=alarms, channelChangeTrap=channelChangeTrap, dfsTableIndex=dfsTableIndex, latitude=latitude, daylightSaving=daylightSaving, vLANPriorityQueueMapping=vLANPriorityQueueMapping, aAAControlGroup=aAAControlGroup, tDDSynchronizationMode=tDDSynchronizationMode, secondarySoftwareVersion=secondarySoftwareVersion, receiveFreqMHz=receiveFreqMHz, smtp=smtp, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernet=ethernet, dfsTableNumber=dfsTableNumber, syslogStateTrap=syslogStateTrap, vLANManagementVID=vLANManagementVID, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ethernetGroup=ethernetGroup, telecomsInterface=telecomsInterface, ptp500=ptp500, sNMPCommunityString=sNMPCommunityString, receiveDataRate=receiveDataRate, masterSlaveMode=masterSlaveMode, resetGroup=resetGroup, sntpGroup=sntpGroup, sNTPPollInterval=sNTPPollInterval, telecomsLoopbackTrap=telecomsLoopbackTrap, installArmState=installArmState, antennaGain=antennaGain, userName=userName, vectorError=vectorError, sNTPServerIPAddress=sNTPServerIPAddress, telecomGroup=telecomGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControl=aAAControl, versions=versions, receiveFreqKHz=receiveFreqKHz, telnetPortNumber=telnetPortNumber, userTableEntry=userTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, systemClock=systemClock, linkName=linkName, transmitFreqMHz=transmitFreqMHz, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, remoteIPAddress=remoteIPAddress, telecomsLoopback=telecomsLoopback, hTTPSPortNumber=hTTPSPortNumber, installStatusTrap=installStatusTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, supplementary=supplementary, licenceGroup=licenceGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, cambium=cambium, sMTPServerIPAddress=sMTPServerIPAddress, installArmStateTrap=installArmStateTrap, longitude=longitude, bandwidthVariant=bandwidthVariant, channelBandwidth=channelBandwidth, maximumTransmitPower=maximumTransmitPower, encryptionGroup=encryptionGroup, telnetAccessEnabled=telnetAccessEnabled, configurationGroup=configurationGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpTrapPrefix=ptpTrapPrefix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPPortNumber=sNMPPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogClient=syslogClient, dfsTable=dfsTable, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
