...
enterprises, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, ModuleIdentity, Bits, Integer32, ObjectIdentity, TimeTicks, Gauge32, Unsigned32, Counter64, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "ModuleIdentity", "Bits", "Integer32", "ObjectIdentity", "TimeTicks", "Gauge32", "Unsigned32", "Counter64", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", aggregateDataRate=aggregateDataRate, groupID=groupID, vLANPriorityQueueMapping=vLANPriorityQueueMapping, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, phyStatusGroup=phyStatusGroup, telnetPortNumber=telnetPortNumber, siteName=siteName, transmitDataRate=transmitDataRate, targetMACAddress=targetMACAddress, userTableEntry=userTableEntry, snmpControl=snmpControl, systemReset=systemReset, remoteIPAddress=remoteIPAddress, antennaGain=antennaGain, sNMPTrapTableNumber=sNMPTrapTableNumber, hardwareVersion=hardwareVersion, ptpGroups=ptpGroups, phyControlGroup=phyControlGroup, wirelessLinkStatus=wirelessLinkStatus, sntpGroup=sntpGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogClientTrap=syslogClientTrap, vLANPriorityTable=vLANPriorityTable, subnetMask=subnetMask, management=management, dfsTableEntry=dfsTableEntry, dfsTableNumber=dfsTableNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPServerPortNumber=sMTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, encryptionAlgorithm=encryptionAlgorithm, versionsGroup=versionsGroup, ptp500=ptp500, incompatibleRegionCodes=incompatibleRegionCodes, userRole=userRole, pubStats=pubStats, tDDControl=tDDControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortDisabledWarning=dataPortDisabledWarning, sNTPState=sNTPState, range=range, receiveDataRate=receiveDataRate, telecomsLoopbackTrap=telecomsLoopbackTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTable=dfsTable, PYSNMP_MODULE_ID=cambium, telecomsChannelStatus=telecomsChannelStatus, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, managementGroup=managementGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPServerPortNumber=sNTPServerPortNumber, receivePower=receivePower, userEnabled=userEnabled, telecomsLoopback=telecomsLoopback, encryptionGroup=encryptionGroup, cambium=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTable=sNMPTrapTable, sNTPSyncTrap=sNTPSyncTrap, alarms=alarms, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, bootVersion=bootVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitFreqMHz=transmitFreqMHz, syslogStateTrap=syslogStateTrap, linkName=linkName, transmitFreqKHz=transmitFreqKHz, smtp=smtp, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANPriorityTableNumber=vLANPriorityTableNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, byteErrorRatio=byteErrorRatio, receiveModulationModeDetail=receiveModulationModeDetail, productName=productName, userTableIndex=userTableIndex, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPv3Enable=sNMPv3Enable, dfsPeaks=dfsPeaks, tDDControlGroup=tDDControlGroup, transmitModulationMode=transmitModulationMode, snmpControlGroup=snmpControlGroup, aAAControlGroup=aAAControlGroup, iPAddress=iPAddress, gatewayIPAddress=gatewayIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, alarmsGroup=alarmsGroup, bandwidthVariant=bandwidthVariant, telecomsCableLength=telecomsCableLength, transmitChannel=transmitChannel, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationMode=tDDSynchronizationMode, resetGroup=resetGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapPortNumber=sNMPTrapPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPollInterval=sNTPPollInterval, userPassword=userPassword, sNTPSync=sNTPSync, pubStatsGroup=pubStatsGroup, sNMPPortNumber=sNMPPortNumber, hTTPPortNumber=hTTPPortNumber, installStatusTrap=installStatusTrap, accessMethod=accessMethod, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sMTPEnabledMessages=sMTPEnabledMessages, searchState=searchState, maximumTransmitPower=maximumTransmitPower, signalStrengthRatio=signalStrengthRatio, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, syslogState=syslogState, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, sMTPEmailAlert=sMTPEmailAlert, configurationGroup=configurationGroup, syslogControl=syslogControl, reset=reset, sNTPServerIPAddress=sNTPServerIPAddress, telecomsLineCode=telecomsLineCode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableIndex=dfsTableIndex, sNMPCommunityString=sNMPCommunityString, aAAControl=aAAControl, telecomsChannelStatusTrap=telecomsChannelStatusTrap, eIRP=eIRP, ethernetGroup=ethernetGroup, hTTPSPortNumber=hTTPSPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryption=encryption, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, licenceGroup=licenceGroup, phyControl=phyControl, licence=licence, regionCode=regionCode, dfs=dfs, installArmState=installArmState, hTTPAccessEnabled=hTTPAccessEnabled, systemClock=systemClock, latitude=latitude, ethernet=ethernet, ptpCompliance=ptpCompliance, installStatus=installStatus, longitude=longitude, userTable=userTable, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveChannel=receiveChannel, smtpGroup=smtpGroup, vLANManagementVID=vLANManagementVID, sNMPTrapIPAddress=sNMPTrapIPAddress, secondarySoftwareVersion=secondarySoftwareVersion, cableLoss=cableLoss, userName=userName, userTableNumber=userTableNumber, telecom=telecom, altitude=altitude, transmitPower=transmitPower, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomGroup=telecomGroup, vLANManagementPriority=vLANManagementPriority, licensedCapacity=licensedCapacity, linkSymmetry=linkSymmetry, receiveFreqMHz=receiveFreqMHz, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsGroup=dfsGroup, dfsMeans=dfsMeans, daylightSaving=daylightSaving, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, syslogClient=syslogClient, ethernetFiberSupport=ethernetFiberSupport, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPServerPortNumber=tFTPServerPortNumber, sNTPLastSync=sNTPLastSync, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptmp=ptmp, phyStatus=phyStatus, frequencyVariant=frequencyVariant, wirelessLinkAvailability=wirelessLinkAvailability, configuration=configuration, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, supplementary=supplementary, channelChangeTrap=channelChangeTrap, productVariant=productVariant, channelBandwidth=channelBandwidth, telecomsInterface=telecomsInterface, receiveFreqKHz=receiveFreqKHz, telnetAccessEnabled=telnetAccessEnabled, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveModulationMode=receiveModulationMode, notificationsGroup=notificationsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, versions=versions, regionCodeTrap=regionCodeTrap, sntp=sntp, vectorError=vectorError, timeZone=timeZone, syslogControlGroup=syslogControlGroup, unitOutOfCalibration=unitOutOfCalibration, supplementaryGroup=supplementaryGroup, ptp=ptp, linkLoss=linkLoss, ptpTrapPrefix=ptpTrapPrefix)
