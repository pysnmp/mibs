...
enterprises, Unsigned32, ModuleIdentity, MibIdentifier, Counter32, TimeTicks, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, iso, ObjectIdentity, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Unsigned32", "ModuleIdentity", "MibIdentifier", "Counter32", "TimeTicks", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "iso", "ObjectIdentity", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", wirelessLinkStatus=wirelessLinkStatus, ptp500=ptp500, syslogControl=syslogControl, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, syslogStateTrap=syslogStateTrap, dfsMeans=dfsMeans, ethernetFiberSupport=ethernetFiberSupport, ptmp=ptmp, installArmState=installArmState, wirelessLinkAvailability=wirelessLinkAvailability, daylightSaving=daylightSaving, vectorError=vectorError, PYSNMP_MODULE_ID=cambium, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userPassword=userPassword, ptpTrapPrefix=ptpTrapPrefix, dfsPeaks=dfsPeaks, sNMPTrapVersion=sNMPTrapVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNTPSyncTrap=sNTPSyncTrap, telecomsLoopback=telecomsLoopback, systemClock=systemClock, tFTPServerIPAddress=tFTPServerIPAddress, altitude=altitude, siteName=siteName, smtp=smtp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableIndex=dfsTableIndex, linkName=linkName, versions=versions, vLANPriorityQueueMapping=vLANPriorityQueueMapping, transmitFreqKHz=transmitFreqKHz, receiveModulationModeDetail=receiveModulationModeDetail, userTableEntry=userTableEntry, configurationGroup=configurationGroup, sNTPState=sNTPState, syslogClient=syslogClient, cableLoss=cableLoss, sntp=sntp, dfsGroup=dfsGroup, dataPortStatus=dataPortStatus, dfs=dfs, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitModulationMode=transmitModulationMode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, receiveDataRate=receiveDataRate, targetMACAddress=targetMACAddress, installStatus=installStatus, installStatusTrap=installStatusTrap, sNTPServerIPAddress=sNTPServerIPAddress, searchState=searchState, sNTPLastSync=sNTPLastSync, pubStats=pubStats, maximumTransmitPower=maximumTransmitPower, userName=userName, sNMPTrapIPAddress=sNMPTrapIPAddress, encryption=encryption, ptpGroups=ptpGroups, sNMPv3Enable=sNMPv3Enable, latitude=latitude, licensedCapacity=licensedCapacity, unitOutOfCalibration=unitOutOfCalibration, linkModeOptimisation=linkModeOptimisation, sMTPServerPortNumber=sMTPServerPortNumber, resetGroup=resetGroup, receivePower=receivePower, licenceGroup=licenceGroup, syslogState=syslogState, tDDControl=tDDControl, supplementaryGroup=supplementaryGroup, remoteIPAddress=remoteIPAddress, supplementary=supplementary, alarmsGroup=alarmsGroup, dfsTableEntry=dfsTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, aggregateDataRate=aggregateDataRate, dataPortStatusTrap=dataPortStatusTrap, vLANPriorityTable=vLANPriorityTable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, subnetMask=subnetMask, sNMPEnabledTraps=sNMPEnabledTraps, dataPortDisabledWarning=dataPortDisabledWarning, dataPortAutoNegotiation=dataPortAutoNegotiation, remoteMaximumTransmitPower=remoteMaximumTransmitPower, ptpCompliance=ptpCompliance, eIRP=eIRP, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sntpGroup=sntpGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, frequencyVariant=frequencyVariant, bootVersion=bootVersion, versionsGroup=versionsGroup, transmitPower=transmitPower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, longitude=longitude, constantPowerSpectralDensity=constantPowerSpectralDensity, linkSymmetry=linkSymmetry, snmpControl=snmpControl, groupID=groupID, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaGain=antennaGain, sNMPTrapTableEntry=sNMPTrapTableEntry, userRole=userRole, hTTPSPortNumber=hTTPSPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, reset=reset, userTableNumber=userTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, userTableIndex=userTableIndex, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANManagementVID=vLANManagementVID, hTTPPortNumber=hTTPPortNumber, phyStatusGroup=phyStatusGroup, tFTPServerPortNumber=tFTPServerPortNumber, syslogControlGroup=syslogControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, vLANManagementPriority=vLANManagementPriority, telecomsChannelStatus=telecomsChannelStatus, tDDSynchronizationMode=tDDSynchronizationMode, regionCodeTrap=regionCodeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, ethernetGroup=ethernetGroup, ptp=ptp, telecomsInterface=telecomsInterface, cambium=cambium, syslogClientTrap=syslogClientTrap, sNMPTrapTable=sNMPTrapTable, telecomsCableLength=telecomsCableLength, transmitFreqMHz=transmitFreqMHz, sNMPCommunityString=sNMPCommunityString, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTable=dfsTable, secondarySoftwareVersion=secondarySoftwareVersion, phyControlGroup=phyControlGroup, telecomsLineCode=telecomsLineCode, accessMethod=accessMethod, masterSlaveMode=masterSlaveMode, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveFreqMHz=receiveFreqMHz, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, management=management, softwareVersion=softwareVersion, phyControl=phyControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, regionCode=regionCode, encryptionAlgorithm=encryptionAlgorithm, tDDControlGroup=tDDControlGroup, smtpGroup=smtpGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, aAAControl=aAAControl, hTTPAccessEnabled=hTTPAccessEnabled, configuration=configuration, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, installArmStateTrap=installArmStateTrap, sMTPEnabledMessages=sMTPEnabledMessages, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, bandwidthVariant=bandwidthVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemReset=systemReset, pubStatsGroup=pubStatsGroup, timeZone=timeZone, telecomGroup=telecomGroup, telecom=telecom, notificationsGroup=notificationsGroup, userTable=userTable, iPAddress=iPAddress, receiveChannel=receiveChannel, range=range, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ethernet=ethernet, ptpTraps=ptpTraps, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, telnetAccessEnabled=telnetAccessEnabled, licence=licence, byteErrorRatio=byteErrorRatio, managementGroup=managementGroup, hardwareVersion=hardwareVersion, phyStatus=phyStatus, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, productName=productName, telnetPortNumber=telnetPortNumber, sNTPSync=sNTPSync, encryptionGroup=encryptionGroup, dfsTableNumber=dfsTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortAutoMdix=dataPortAutoMdix, signalStrengthRatio=signalStrengthRatio, transmitChannel=transmitChannel, aAAControlGroup=aAAControlGroup, sMTPEmailAlert=sMTPEmailAlert, userEnabled=userEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPPortNumber=sNMPPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, productVariant=productVariant, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, alarms=alarms, snmpControlGroup=snmpControlGroup, linkLoss=linkLoss, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveFreqKHz=receiveFreqKHz)
