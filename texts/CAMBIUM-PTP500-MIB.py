...
Counter64, NotificationType, enterprises, ObjectIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, MibIdentifier, iso, Bits, ModuleIdentity, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "enterprises", "ObjectIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "MibIdentifier", "iso", "Bits", "ModuleIdentity", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPServerIPAddress=sNTPServerIPAddress, userPassword=userPassword, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licence=licence, iPAddress=iPAddress, telnetPortNumber=telnetPortNumber, receiveModulationMode=receiveModulationMode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapVersion=sNMPTrapVersion, snmpControlGroup=snmpControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, managementGroup=managementGroup, userEnabled=userEnabled, syslogControl=syslogControl, vLANPriorityTable=vLANPriorityTable, tFTPServerIPAddress=tFTPServerIPAddress, aAAControlGroup=aAAControlGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPPollInterval=sNTPPollInterval, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, licenceGroup=licenceGroup, wirelessLinkAvailability=wirelessLinkAvailability, byteErrorRatio=byteErrorRatio, receiveChannel=receiveChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, notificationsGroup=notificationsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDControl=tDDControl, dfsTableIndex=dfsTableIndex, range=range, dataPortStatus=dataPortStatus, sNTPState=sNTPState, encryptionAlgorithm=encryptionAlgorithm, phyStatusGroup=phyStatusGroup, syslogClientTrap=syslogClientTrap, dfsMeans=dfsMeans, ptmp=ptmp, installStatusTrap=installStatusTrap, pubStatsGroup=pubStatsGroup, eIRP=eIRP, sMTPEnabledMessages=sMTPEnabledMessages, ptpTrapPrefix=ptpTrapPrefix, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementPriority=vLANManagementPriority, ptp=ptp, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPv3Enable=sNMPv3Enable, cableLoss=cableLoss, userRole=userRole, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, bandwidthVariant=bandwidthVariant, aAAControl=aAAControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, installArmState=installArmState, transmitFreqMHz=transmitFreqMHz, vLANManagementVID=vLANManagementVID, ethernet=ethernet, sNMPPortNumber=sNMPPortNumber, receiveDataRate=receiveDataRate, alarmsGroup=alarmsGroup, incompatibleRegionCodes=incompatibleRegionCodes, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptpGroups=ptpGroups, telnetAccessEnabled=telnetAccessEnabled, dfsTable=dfsTable, altitude=altitude, transmitModulationMode=transmitModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, longitude=longitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, phyControl=phyControl, receiveFreqMHz=receiveFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, userTableIndex=userTableIndex, syslogClient=syslogClient, sNTPServerPortNumber=sNTPServerPortNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitChannel=transmitChannel, installArmStateTrap=installArmStateTrap, sMTPServerPortNumber=sMTPServerPortNumber, sMTPEmailAlert=sMTPEmailAlert, ptpCompliance=ptpCompliance, groupID=groupID, regionCodeTrap=regionCodeTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, telecomsChannelStatus=telecomsChannelStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versionsGroup=versionsGroup, transmitFreqKHz=transmitFreqKHz, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, timeZone=timeZone, ptp500=ptp500, sNTPLastSync=sNTPLastSync, linkSymmetry=linkSymmetry, supplementary=supplementary, encryptionGroup=encryptionGroup, remoteIPAddress=remoteIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, userTable=userTable, gatewayIPAddress=gatewayIPAddress, hTTPSPortNumber=hTTPSPortNumber, masterSlaveMode=masterSlaveMode, wirelessLinkStatus=wirelessLinkStatus, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, vectorError=vectorError, snmpControl=snmpControl, telecomGroup=telecomGroup, telecomsLineCode=telecomsLineCode, accessMethod=accessMethod, dfsGroup=dfsGroup, subnetMask=subnetMask, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationMode=tDDSynchronizationMode, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, management=management, productName=productName, sNTPSync=sNTPSync, PYSNMP_MODULE_ID=cambium, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, configurationGroup=configurationGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, antennaGain=antennaGain, aggregateDataRate=aggregateDataRate, signalStrengthRatio=signalStrengthRatio, userTableNumber=userTableNumber, resetGroup=resetGroup, ethernetGroup=ethernetGroup, phyStatus=phyStatus, userTableEntry=userTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, systemReset=systemReset, telecomsInterface=telecomsInterface, enabledDiagnosticAlarms=enabledDiagnosticAlarms, smtp=smtp, encryption=encryption, hTTPAccessEnabled=hTTPAccessEnabled, sntp=sntp, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogControlGroup=syslogControlGroup, transmitDataRate=transmitDataRate, userName=userName, smtpGroup=smtpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANPriorityQueueMapping=vLANPriorityQueueMapping, receiveFreqKHz=receiveFreqKHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, versions=versions, syslogState=syslogState, supplementaryGroup=supplementaryGroup, dfsTableEntry=dfsTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, configuration=configuration, sNMPCommunityString=sNMPCommunityString, phyControlGroup=phyControlGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPSyncTrap=sNTPSyncTrap, cambium=cambium, receivePower=receivePower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANPriorityTableIndex=vLANPriorityTableIndex, hTTPPortNumber=hTTPPortNumber, channelBandwidth=channelBandwidth, licensedCapacity=licensedCapacity, telecom=telecom, dfsPeaks=dfsPeaks, channelChangeTrap=channelChangeTrap, softwareVersion=softwareVersion, regionCode=regionCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, reset=reset, ptpTraps=ptpTraps, transmitPower=transmitPower, dfsTableNumber=dfsTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomsCableLength=telecomsCableLength, siteName=siteName, ethernetFiberSupport=ethernetFiberSupport, searchState=searchState, daylightSaving=daylightSaving, sNMPTrapTable=sNMPTrapTable, linkModeOptimisation=linkModeOptimisation, capacityLicenseMismatch=capacityLicenseMismatch, sntpGroup=sntpGroup, maximumTransmitPower=maximumTransmitPower, linkName=linkName, installStatus=installStatus, latitude=latitude, dataPortWirelessDownAlert=dataPortWirelessDownAlert, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, remoteMaximumTransmitPower=remoteMaximumTransmitPower, productVariant=productVariant, alarms=alarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfs=dfs, targetMACAddress=targetMACAddress, tDDControlGroup=tDDControlGroup, tFTPServerPortNumber=tFTPServerPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsLoopback=telecomsLoopback, hardwareVersion=hardwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkLoss=linkLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoMdix=dataPortAutoMdix, pubStats=pubStats)
