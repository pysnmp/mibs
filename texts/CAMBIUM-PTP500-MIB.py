...
Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Gauge32, TimeTicks, enterprises, Bits, MibIdentifier, IpAddress, iso, NotificationType, ObjectIdentity, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Gauge32", "TimeTicks", "enterprises", "Bits", "MibIdentifier", "IpAddress", "iso", "NotificationType", "ObjectIdentity", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveModulationModeDetail=receiveModulationModeDetail, reset=reset, installStatusTrap=installStatusTrap, telecomsCableLength=telecomsCableLength, phyControlGroup=phyControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsTableNumber=dfsTableNumber, capacityLicenseMismatch=capacityLicenseMismatch, receivePower=receivePower, sMTPServerPortNumber=sMTPServerPortNumber, vectorError=vectorError, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, installArmStateTrap=installArmStateTrap, sntp=sntp, sNMPTrapTable=sNMPTrapTable, telecomsLineCode=telecomsLineCode, linkName=linkName, snmpControl=snmpControl, sNMPCommunityString=sNMPCommunityString, sNTPState=sNTPState, softwareVersion=softwareVersion, sNTPServerIPAddress=sNTPServerIPAddress, configurationGroup=configurationGroup, licenceGroup=licenceGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBandwidth=channelBandwidth, linkSymmetry=linkSymmetry, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, hTTPAccessEnabled=hTTPAccessEnabled, syslogClientTrap=syslogClientTrap, dataPortDisabledWarning=dataPortDisabledWarning, accessMethod=accessMethod, useVLANForManagementInterfaces=useVLANForManagementInterfaces, iPAddress=iPAddress, systemReset=systemReset, ptmp=ptmp, versions=versions, syslogControlGroup=syslogControlGroup, syslogState=syslogState, aAAControl=aAAControl, phyStatusGroup=phyStatusGroup, syslogStateTrap=syslogStateTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, notificationsGroup=notificationsGroup, siteName=siteName, hardwareVersion=hardwareVersion, dataPortStatusTrap=dataPortStatusTrap, phyControl=phyControl, snmpControlGroup=snmpControlGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userEnabled=userEnabled, sNMPv3Enable=sNMPv3Enable, wirelessLinkStatus=wirelessLinkStatus, dataPortAutoMdix=dataPortAutoMdix, telecomsLoopbackTrap=telecomsLoopbackTrap, configuration=configuration, bandwidthVariant=bandwidthVariant, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveFreqMHz=receiveFreqMHz, receiveFreqKHz=receiveFreqKHz, management=management, wirelessLinkAvailability=wirelessLinkAvailability, userPassword=userPassword, aggregateDataRate=aggregateDataRate, ethernetFiberSupport=ethernetFiberSupport, altitude=altitude, vLANManagementPriority=vLANManagementPriority, groupID=groupID, supplementary=supplementary, vLANManagementVID=vLANManagementVID, smtp=smtp, sNTPPollInterval=sNTPPollInterval, userTableIndex=userTableIndex, sNTPLastSync=sNTPLastSync, maximumTransmitPower=maximumTransmitPower, gatewayIPAddress=gatewayIPAddress, productVariant=productVariant, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tDDControl=tDDControl, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, sNTPSync=sNTPSync, pubStats=pubStats, alarms=alarms, telecomsChannelStatus=telecomsChannelStatus, ptpGroups=ptpGroups, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerPortNumber=sNTPServerPortNumber, dfsTableIndex=dfsTableIndex, dfsMeans=dfsMeans, transmitFreqMHz=transmitFreqMHz, ethernetGroup=ethernetGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, encryptionAlgorithm=encryptionAlgorithm, transmitPower=transmitPower, linkModeOptimisation=linkModeOptimisation, pubStatsGroup=pubStatsGroup, productName=productName, range=range, sNMPEnabledTraps=sNMPEnabledTraps, supplementaryGroup=supplementaryGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyStatus=phyStatus, resetGroup=resetGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telnetAccessEnabled=telnetAccessEnabled, daylightSaving=daylightSaving, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, regionCode=regionCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, systemClock=systemClock, alarmsGroup=alarmsGroup, receiveModulationMode=receiveModulationMode, ptpCompliance=ptpCompliance, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPPortNumber=hTTPPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, antennaGain=antennaGain, subnetMask=subnetMask, tDDSynchronizationMode=tDDSynchronizationMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, frequencyVariant=frequencyVariant, searchState=searchState, userTableEntry=userTableEntry, sNMPTrapVersion=sNMPTrapVersion, transmitChannel=transmitChannel, sMTPEnabledMessages=sMTPEnabledMessages, remoteIPAddress=remoteIPAddress, sNMPPortNumber=sNMPPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveChannel=receiveChannel, managementGroup=managementGroup, telecom=telecom, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, signalStrengthRatio=signalStrengthRatio, secondarySoftwareVersion=secondarySoftwareVersion, bootVersion=bootVersion, eIRP=eIRP, dfs=dfs, telnetPortNumber=telnetPortNumber, ptpTraps=ptpTraps, channelChangeTrap=channelChangeTrap, ethernet=ethernet, dataPortStatus=dataPortStatus, transmitFreqKHz=transmitFreqKHz, cableLoss=cableLoss, telecomsLoopback=telecomsLoopback, sMTPSourceEmailAddress=sMTPSourceEmailAddress, incompatibleRegionCodes=incompatibleRegionCodes, PYSNMP_MODULE_ID=cambium, vLANPriorityTableNumber=vLANPriorityTableNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPSyncTrap=sNTPSyncTrap, masterSlaveMode=masterSlaveMode, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpTrapPrefix=ptpTrapPrefix, telecomsInterface=telecomsInterface, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableNumber=userTableNumber, byteErrorRatio=byteErrorRatio, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licensedCapacity=licensedCapacity, regionCodeTrap=regionCodeTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, userRole=userRole, noWirelessChannelAvailable=noWirelessChannelAvailable, ptp500=ptp500, longitude=longitude, dfsPeaks=dfsPeaks, versionsGroup=versionsGroup, dfsGroup=dfsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTable=dfsTable, sntpGroup=sntpGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, latitude=latitude, hTTPSAccessEnabled=hTTPSAccessEnabled, encryptionGroup=encryptionGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogControl=syslogControl, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmState=installArmState, syslogClient=syslogClient, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userName=userName, tDDControlGroup=tDDControlGroup, unitOutOfCalibration=unitOutOfCalibration, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, encryption=encryption, transmitModulationMode=transmitModulationMode, timeZone=timeZone, receiveDataRate=receiveDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, targetMACAddress=targetMACAddress, cambium=cambium, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, licence=licence, aAAControlGroup=aAAControlGroup, dfsTableEntry=dfsTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, linkLoss=linkLoss, ptp=ptp, installStatus=installStatus, transmitDataRate=transmitDataRate, smtpGroup=smtpGroup, vLANPriorityTable=vLANPriorityTable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTable=userTable, telecomGroup=telecomGroup)
