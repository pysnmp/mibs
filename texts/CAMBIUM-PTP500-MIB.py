...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANManagementPriority=vLANManagementPriority, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, encryption=encryption, syslogClient=syslogClient, smtpGroup=smtpGroup, hTTPSPortNumber=hTTPSPortNumber, dfsTableEntry=dfsTableEntry, transmitModulationMode=transmitModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, managementGroup=managementGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, hTTPAccessEnabled=hTTPAccessEnabled, dataPortStatus=dataPortStatus, signalStrengthRatio=signalStrengthRatio, supplementaryGroup=supplementaryGroup, telecomsLineCode=telecomsLineCode, sMTPEnabledMessages=sMTPEnabledMessages, transmitFreqMHz=transmitFreqMHz, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userRole=userRole, userTableEntry=userTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, syslogStateTrap=syslogStateTrap, productVariant=productVariant, pubStatsGroup=pubStatsGroup, sNMPTrapVersion=sNMPTrapVersion, tDDControl=tDDControl, transmitChannel=transmitChannel, linkSymmetry=linkSymmetry, versionsGroup=versionsGroup, phyControlGroup=phyControlGroup, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapTableNumber=sNMPTrapTableNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userTableNumber=userTableNumber, dfsPeaks=dfsPeaks, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, enabledDiagnosticAlarms=enabledDiagnosticAlarms, resetGroup=resetGroup, siteName=siteName, supplementary=supplementary, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANPriorityTableNumber=vLANPriorityTableNumber, productName=productName, sNTPLastSync=sNTPLastSync, channelChangeTrap=channelChangeTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userName=userName, installArmStateTrap=installArmStateTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, masterSlaveMode=masterSlaveMode, unitOutOfCalibration=unitOutOfCalibration, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installStatus=installStatus, licensedCapacity=licensedCapacity, incompatibleRegionCodes=incompatibleRegionCodes, daylightSaving=daylightSaving, linkModeOptimisation=linkModeOptimisation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, aAAControlGroup=aAAControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsCableLength=telecomsCableLength, maximumTransmitPower=maximumTransmitPower, telnetAccessEnabled=telnetAccessEnabled, vectorError=vectorError, sNMPCommunityString=sNMPCommunityString, ptpTrapPrefix=ptpTrapPrefix, smtp=smtp, linkLoss=linkLoss, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, altitude=altitude, ethernetFiberSupport=ethernetFiberSupport, dfsMeans=dfsMeans, hardwareVersion=hardwareVersion, ptpGroups=ptpGroups, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptp=ptp, searchState=searchState, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, phyStatusGroup=phyStatusGroup, telecomsLoopback=telecomsLoopback, sNTPServerIPAddress=sNTPServerIPAddress, tDDControlGroup=tDDControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, licenceGroup=licenceGroup, snmpControl=snmpControl, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, tDDSynchronizationStatus=tDDSynchronizationStatus, ptmp=ptmp, encryptionGroup=encryptionGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, configurationGroup=configurationGroup, sNMPTrapTable=sNMPTrapTable, sNMPTrapTableIndex=sNMPTrapTableIndex, phyControl=phyControl, sNMPTrapPortNumber=sNMPTrapPortNumber, byteErrorRatio=byteErrorRatio, bootVersion=bootVersion, sNMPPortNumber=sNMPPortNumber, regionCode=regionCode, timeZone=timeZone, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, configuration=configuration, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernet=ethernet, aAAControl=aAAControl, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, linkName=linkName, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerPortNumber=sNTPServerPortNumber, syslogClientTrap=syslogClientTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableNumber=dfsTableNumber, cableLoss=cableLoss, frequencyVariant=frequencyVariant, hTTPPortNumber=hTTPPortNumber, dfs=dfs, syslogState=syslogState, regionCodeTrap=regionCodeTrap, dfsGroup=dfsGroup, sNTPState=sNTPState, wirelessLinkStatus=wirelessLinkStatus, encryptionAlgorithm=encryptionAlgorithm, bandwidthVariant=bandwidthVariant, phyStatus=phyStatus, sMTPEmailAlert=sMTPEmailAlert, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitDataRate=transmitDataRate, systemClock=systemClock, ptpTraps=ptpTraps, PYSNMP_MODULE_ID=cambium, range=range, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPSync=sNTPSync, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, alarmsGroup=alarmsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userEnabled=userEnabled, telecomsChannelStatus=telecomsChannelStatus, antennaGain=antennaGain, ptp500=ptp500, reset=reset, receiveFreqKHz=receiveFreqKHz, snmpControlGroup=snmpControlGroup, versions=versions, userTableIndex=userTableIndex, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, subnetMask=subnetMask, sNMPv3Enable=sNMPv3Enable, telecomGroup=telecomGroup, transmitFreqKHz=transmitFreqKHz, systemReset=systemReset, dataPortAutoMdix=dataPortAutoMdix, accessMethod=accessMethod, pubStats=pubStats, telecomsInterface=telecomsInterface, longitude=longitude, targetMACAddress=targetMACAddress, dfsTableIndex=dfsTableIndex, tFTPServerIPAddress=tFTPServerIPAddress, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sntp=sntp, management=management, ptpCompliance=ptpCompliance, eIRP=eIRP, userPassword=userPassword, transmitPower=transmitPower, receiveChannel=receiveChannel, sNTPSyncTrap=sNTPSyncTrap, cambium=cambium, dataPortStatusTrap=dataPortStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPPollInterval=sNTPPollInterval, vLANPriorityTable=vLANPriorityTable, licence=licence, installStatusTrap=installStatusTrap, remoteIPAddress=remoteIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, channelBandwidth=channelBandwidth, receiveModulationMode=receiveModulationMode, latitude=latitude, groupID=groupID, dfsTable=dfsTable, telnetPortNumber=telnetPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, receivePower=receivePower, notificationsGroup=notificationsGroup, syslogControl=syslogControl, syslogControlGroup=syslogControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userTable=userTable, installArmState=installArmState, softwareVersion=softwareVersion, receiveDataRate=receiveDataRate, iPAddress=iPAddress, ethernetGroup=ethernetGroup, sNMPEnabledTraps=sNMPEnabledTraps, hTTPSAccessEnabled=hTTPSAccessEnabled, alarms=alarms, gatewayIPAddress=gatewayIPAddress, sntpGroup=sntpGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry)
