...
Bits, ObjectIdentity, Counter32, Counter64, iso, IpAddress, Gauge32, enterprises, TimeTicks, MibIdentifier, Integer32, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "Counter32", "Counter64", "iso", "IpAddress", "Gauge32", "enterprises", "TimeTicks", "MibIdentifier", "Integer32", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", encryption=encryption, aggregateDataRate=aggregateDataRate, smtpGroup=smtpGroup, syslogControlGroup=syslogControlGroup, userName=userName, vLANManagementVID=vLANManagementVID, telecomsLoopbackTrap=telecomsLoopbackTrap, ethernet=ethernet, ptmp=ptmp, ethernetFiberSupport=ethernetFiberSupport, installArmState=installArmState, dfs=dfs, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, systemClock=systemClock, dfsTableEntry=dfsTableEntry, syslogClientTrap=syslogClientTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableNumber=userTableNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, ptp=ptp, configuration=configuration, transmitModulationMode=transmitModulationMode, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailable=noWirelessChannelAvailable, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableIndex=dfsTableIndex, licensedCapacity=licensedCapacity, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licenceGroup=licenceGroup, capacityLicenseMismatch=capacityLicenseMismatch, syslogControl=syslogControl, userPassword=userPassword, telecomsLineCode=telecomsLineCode, hTTPAccessEnabled=hTTPAccessEnabled, sNTPLastSync=sNTPLastSync, maximumTransmitPower=maximumTransmitPower, latitude=latitude, licence=licence, sNTPState=sNTPState, tDDControlGroup=tDDControlGroup, siteName=siteName, sNMPEnabledTraps=sNMPEnabledTraps, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userTableIndex=userTableIndex, transmitPower=transmitPower, syslogLocalWrappedTrap=syslogLocalWrappedTrap, productVariant=productVariant, telecom=telecom, phyStatus=phyStatus, snmpControlGroup=snmpControlGroup, timeZone=timeZone, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogStateTrap=syslogStateTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitFreqKHz=transmitFreqKHz, sntp=sntp, dfsGroup=dfsGroup, telecomGroup=telecomGroup, aAAControlGroup=aAAControlGroup, encryptionGroup=encryptionGroup, cableLoss=cableLoss, remoteIPAddress=remoteIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, vLANPriorityTable=vLANPriorityTable, bootVersion=bootVersion, sNMPTrapVersion=sNMPTrapVersion, altitude=altitude, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telnetAccessEnabled=telnetAccessEnabled, linkName=linkName, dataPortStatusTrap=dataPortStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, channelBandwidth=channelBandwidth, sNMPCommunityString=sNMPCommunityString, incompatibleMasterAndSlave=incompatibleMasterAndSlave, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernetGroup=ethernetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsTable=dfsTable, telecomsCableLength=telecomsCableLength, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp500=ptp500, alarmsGroup=alarmsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, byteErrorRatio=byteErrorRatio, linkModeOptimisation=linkModeOptimisation, configurationGroup=configurationGroup, hTTPSPortNumber=hTTPSPortNumber, userTableEntry=userTableEntry, supplementary=supplementary, ptpGroups=ptpGroups, sMTPEmailAlert=sMTPEmailAlert, tDDControl=tDDControl, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, sNTPPollInterval=sNTPPollInterval, dataPortStatus=dataPortStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, productName=productName, dfsTableNumber=dfsTableNumber, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelStatus=telecomsChannelStatus, incompatibleRegionCodes=incompatibleRegionCodes, accessMethod=accessMethod, pubStats=pubStats, eIRP=eIRP, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerIPAddress=sMTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, alarms=alarms, bandwidthVariant=bandwidthVariant, versions=versions, sNMPTrapIPAddress=sNMPTrapIPAddress, ptpTraps=ptpTraps, ptpCompliance=ptpCompliance, transmitChannel=transmitChannel, sntpGroup=sntpGroup, phyControlGroup=phyControlGroup, dfsPeaks=dfsPeaks, sNMPv3Enable=sNMPv3Enable, managementGroup=managementGroup, userRole=userRole, longitude=longitude, management=management, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPSync=sNTPSync, receiveChannel=receiveChannel, pubStatsGroup=pubStatsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControl=aAAControl, hTTPSAccessEnabled=hTTPSAccessEnabled, searchState=searchState, syslogState=syslogState, signalStrengthRatio=signalStrengthRatio, enabledDiagnosticAlarms=enabledDiagnosticAlarms, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapTable=sNMPTrapTable, transmitFreqMHz=transmitFreqMHz, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versionsGroup=versionsGroup, frequencyVariant=frequencyVariant, sMTPServerPortNumber=sMTPServerPortNumber, daylightSaving=daylightSaving, sNTPSyncTrap=sNTPSyncTrap, dataPortAutoMdix=dataPortAutoMdix, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsInterface=telecomsInterface, reset=reset, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatusGroup=phyStatusGroup, wirelessLinkAvailability=wirelessLinkAvailability, telnetPortNumber=telnetPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPPortNumber=sNMPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, iPAddress=iPAddress, smtp=smtp, secondarySoftwareVersion=secondarySoftwareVersion, range=range, tFTPServerPortNumber=tFTPServerPortNumber, receiveFreqMHz=receiveFreqMHz, userEnabled=userEnabled, telecomsLoopback=telecomsLoopback, sNMPTrapTableEntry=sNMPTrapTableEntry, masterSlaveMode=masterSlaveMode, softwareVersion=softwareVersion, encryptionAlgorithm=encryptionAlgorithm, subnetMask=subnetMask, tDDSynchronizationAlarm=tDDSynchronizationAlarm, PYSNMP_MODULE_ID=cambium, cambium=cambium, regionCode=regionCode, installArmStateTrap=installArmStateTrap, groupID=groupID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, installStatusTrap=installStatusTrap, phyControl=phyControl, antennaGain=antennaGain, systemReset=systemReset, supplementaryGroup=supplementaryGroup, wirelessLinkStatus=wirelessLinkStatus, snmpControl=snmpControl, hTTPPortNumber=hTTPPortNumber, transmitDataRate=transmitDataRate, syslogClient=syslogClient, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNTPServerPortNumber=sNTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, receiveModulationMode=receiveModulationMode, targetMACAddress=targetMACAddress, resetGroup=resetGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vectorError=vectorError, receiveDataRate=receiveDataRate, dataPortDisabledWarning=dataPortDisabledWarning, ptpTrapPrefix=ptpTrapPrefix, installStatus=installStatus, linkSymmetry=linkSymmetry, dfsMeans=dfsMeans, tFTPServerIPAddress=tFTPServerIPAddress, notificationsGroup=notificationsGroup, receivePower=receivePower, hardwareVersion=hardwareVersion, linkLoss=linkLoss, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, channelChangeTrap=channelChangeTrap, userTable=userTable)
