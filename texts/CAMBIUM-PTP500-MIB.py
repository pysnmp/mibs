...
Gauge32, MibIdentifier, iso, IpAddress, Counter64, Unsigned32, TimeTicks, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, ModuleIdentity, Bits, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "iso", "IpAddress", "Counter64", "Unsigned32", "TimeTicks", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "ModuleIdentity", "Bits", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", licensedCapacity=licensedCapacity, syslogControl=syslogControl, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regionCodeTrap=regionCodeTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsCableLength=telecomsCableLength, userTableIndex=userTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDControl=tDDControl, dfsMeans=dfsMeans, aAAControl=aAAControl, telecomGroup=telecomGroup, latitude=latitude, syslogControlGroup=syslogControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, snmpControlGroup=snmpControlGroup, receiveFreqMHz=receiveFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licence=licence, installStatus=installStatus, phyStatus=phyStatus, versions=versions, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPCommunityString=sNMPCommunityString, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, hardwareVersion=hardwareVersion, wirelessLinkAvailability=wirelessLinkAvailability, dfs=dfs, transmitPower=transmitPower, userEnabled=userEnabled, systemReset=systemReset, tDDControlGroup=tDDControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPSyncTrap=sNTPSyncTrap, telecomsChannelStatus=telecomsChannelStatus, ethernetFiberSupport=ethernetFiberSupport, aggregateDataRate=aggregateDataRate, userTableEntry=userTableEntry, iPAddress=iPAddress, capacityLicenseMismatch=capacityLicenseMismatch, pubStatsGroup=pubStatsGroup, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, unitOutOfCalibration=unitOutOfCalibration, reset=reset, phyControlGroup=phyControlGroup, sNTPServerIPAddress=sNTPServerIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, productVariant=productVariant, userTable=userTable, hTTPAccessEnabled=hTTPAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoMdix=dataPortAutoMdix, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANPriorityTable=vLANPriorityTable, syslogClientTrap=syslogClientTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveDataRate=receiveDataRate, phyControl=phyControl, resetGroup=resetGroup, bootVersion=bootVersion, encryptionGroup=encryptionGroup, telnetPortNumber=telnetPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, ethernet=ethernet, configuration=configuration, gatewayIPAddress=gatewayIPAddress, linkName=linkName, siteName=siteName, telecomsInterface=telecomsInterface, searchState=searchState, sMTPServerIPAddress=sMTPServerIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sntp=sntp, tFTPServerPortNumber=tFTPServerPortNumber, constantPowerSpectralDensity=constantPowerSpectralDensity, PYSNMP_MODULE_ID=cambium, regionCode=regionCode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, notificationsGroup=notificationsGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, supplementary=supplementary, dataPortDisabledWarning=dataPortDisabledWarning, management=management, syslogStateTrap=syslogStateTrap, daylightSaving=daylightSaving, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsPeaks=dfsPeaks, range=range, transmitDataRate=transmitDataRate, dataPortStatusTrap=dataPortStatusTrap, configurationGroup=configurationGroup, cambium=cambium, wirelessLinkStatus=wirelessLinkStatus, installArmStateTrap=installArmStateTrap, longitude=longitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, supplementaryGroup=supplementaryGroup, sNTPSync=sNTPSync, productName=productName, receivePower=receivePower, receiveChannel=receiveChannel, licenceGroup=licenceGroup, frequencyVariant=frequencyVariant, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitFreqKHz=transmitFreqKHz, sNMPv3Enable=sNMPv3Enable, vLANManagementPriority=vLANManagementPriority, telecomsLoopback=telecomsLoopback, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, systemClock=systemClock, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installArmState=installArmState, linkSymmetry=linkSymmetry, vectorError=vectorError, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsTableIndex=dfsTableIndex, userName=userName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ethernetGroup=ethernetGroup, managementGroup=managementGroup, versionsGroup=versionsGroup, secondarySoftwareVersion=secondarySoftwareVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTraps=ptpTraps, dfsTableEntry=dfsTableEntry, ptp500=ptp500, telnetAccessEnabled=telnetAccessEnabled, ptp=ptp, receiveFreqKHz=receiveFreqKHz, smtpGroup=smtpGroup, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortStatus=dataPortStatus, aAAControlGroup=aAAControlGroup, linkLoss=linkLoss, channelChangeTrap=channelChangeTrap, incompatibleRegionCodes=incompatibleRegionCodes, cableLoss=cableLoss, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, timeZone=timeZone, tDDSynchronizationMode=tDDSynchronizationMode, telecom=telecom, receiveModulationModeDetail=receiveModulationModeDetail, ptpTrapPrefix=ptpTrapPrefix, altitude=altitude, sNMPTrapTableEntry=sNMPTrapTableEntry, hTTPSPortNumber=hTTPSPortNumber, userPassword=userPassword, targetMACAddress=targetMACAddress, remoteIPAddress=remoteIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, sNMPEnabledTraps=sNMPEnabledTraps, masterSlaveMode=masterSlaveMode, vLANPriorityTableNumber=vLANPriorityTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, transmitFreqMHz=transmitFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPEmailAlert=sMTPEmailAlert, groupID=groupID, syslogState=syslogState, receiveModulationMode=receiveModulationMode, eIRP=eIRP, ptpGroups=ptpGroups, sMTPServerPortNumber=sMTPServerPortNumber, sNTPLastSync=sNTPLastSync, sNTPState=sNTPState, alarmsGroup=alarmsGroup, dfsTableNumber=dfsTableNumber, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, sNMPTrapVersion=sNMPTrapVersion, encryptionAlgorithm=encryptionAlgorithm, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, pubStats=pubStats, sntpGroup=sntpGroup, phyStatusGroup=phyStatusGroup, dfsTable=dfsTable, encryption=encryption, hTTPPortNumber=hTTPPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkModeOptimisation=linkModeOptimisation, ptpCompliance=ptpCompliance, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPPollInterval=sNTPPollInterval, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitModulationMode=transmitModulationMode, smtp=smtp, maximumTransmitPower=maximumTransmitPower, installStatusTrap=installStatusTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogClient=syslogClient, userRole=userRole, subnetMask=subnetMask, alarms=alarms, dataPortAutoNegotiation=dataPortAutoNegotiation, bandwidthVariant=bandwidthVariant, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTable=sNMPTrapTable, byteErrorRatio=byteErrorRatio, vLANManagementVID=vLANManagementVID, dfsGroup=dfsGroup, telecomsLineCode=telecomsLineCode, transmitChannel=transmitChannel, ptmp=ptmp)
