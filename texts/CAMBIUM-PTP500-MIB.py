...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userTableEntry=userTableEntry, snmpControl=snmpControl, PYSNMP_MODULE_ID=cambium, ethernetGroup=ethernetGroup, installStatus=installStatus, ptp=ptp, regionCode=regionCode, dataPortAutoMdix=dataPortAutoMdix, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqKHz=transmitFreqKHz, sNMPv3Enable=sNMPv3Enable, encryptionAlgorithm=encryptionAlgorithm, telecomsLoopback=telecomsLoopback, userTableNumber=userTableNumber, dfs=dfs, userRole=userRole, telecomsLoopbackTrap=telecomsLoopbackTrap, masterSlaveMode=masterSlaveMode, telecomsChannelStatus=telecomsChannelStatus, sNTPServerPortNumber=sNTPServerPortNumber, unitOutOfCalibration=unitOutOfCalibration, tDDControl=tDDControl, dfsTableEntry=dfsTableEntry, ethernet=ethernet, sMTPEnabledMessages=sMTPEnabledMessages, bootVersion=bootVersion, ptp500=ptp500, transmitChannel=transmitChannel, syslogState=syslogState, installArmStateTrap=installArmStateTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveFreqKHz=receiveFreqKHz, sntp=sntp, sNMPTrapPortNumber=sNMPTrapPortNumber, frequencyVariant=frequencyVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telnetPortNumber=telnetPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPPortNumber=sNMPPortNumber, linkName=linkName, productVariant=productVariant, dfsGroup=dfsGroup, syslogClientTrap=syslogClientTrap, userTable=userTable, reset=reset, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, encryptionGroup=encryptionGroup, groupID=groupID, licensedCapacity=licensedCapacity, configurationGroup=configurationGroup, transmitFreqMHz=transmitFreqMHz, ptmp=ptmp, versionsGroup=versionsGroup, capacityLicenseMismatch=capacityLicenseMismatch, sMTPServerIPAddress=sMTPServerIPAddress, altitude=altitude, sNTPPollInterval=sNTPPollInterval, dataPortStatusTrap=dataPortStatusTrap, dfsTable=dfsTable, byteErrorRatio=byteErrorRatio, aAAControl=aAAControl, installStatusTrap=installStatusTrap, systemReset=systemReset, sntpGroup=sntpGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, userEnabled=userEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, licence=licence, receivePower=receivePower, softwareVersion=softwareVersion, snmpControlGroup=snmpControlGroup, latitude=latitude, iPAddress=iPAddress, hTTPAccessEnabled=hTTPAccessEnabled, wirelessLinkAvailability=wirelessLinkAvailability, linkSymmetry=linkSymmetry, wirelessLinkStatus=wirelessLinkStatus, vLANManagementVID=vLANManagementVID, dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, receiveDataRate=receiveDataRate, vLANPriorityTable=vLANPriorityTable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vLANManagementPriority=vLANManagementPriority, vLANPriorityQueueMapping=vLANPriorityQueueMapping, management=management, phyStatusGroup=phyStatusGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, subnetMask=subnetMask, receiveChannel=receiveChannel, sMTPServerPortNumber=sMTPServerPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPState=sNTPState, longitude=longitude, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, timeZone=timeZone, resetGroup=resetGroup, versions=versions, telecom=telecom, userPassword=userPassword, constantPowerSpectralDensity=constantPowerSpectralDensity, licenceGroup=licenceGroup, sMTPEmailAlert=sMTPEmailAlert, linkModeOptimisation=linkModeOptimisation, syslogClient=syslogClient, userName=userName, cambium=cambium, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, range=range, dataPortDisabledWarning=dataPortDisabledWarning, userTableIndex=userTableIndex, ptpGroups=ptpGroups, supplementaryGroup=supplementaryGroup, syslogControl=syslogControl, sNMPTrapTableNumber=sNMPTrapTableNumber, telecomGroup=telecomGroup, sNMPEnabledTraps=sNMPEnabledTraps, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, antennaGain=antennaGain, regionCodeTrap=regionCodeTrap, sNTPServerIPAddress=sNTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, signalStrengthRatio=signalStrengthRatio, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkLoss=linkLoss, sNMPTrapTable=sNMPTrapTable, receiveModulationModeDetail=receiveModulationModeDetail, pubStatsGroup=pubStatsGroup, incompatibleRegionCodes=incompatibleRegionCodes, tDDControlGroup=tDDControlGroup, phyStatus=phyStatus, daylightSaving=daylightSaving, sNMPCommunityString=sNMPCommunityString, sNTPSync=sNTPSync, useVLANForManagementInterfaces=useVLANForManagementInterfaces, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hTTPPortNumber=hTTPPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, systemClock=systemClock, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTableNumber=dfsTableNumber, dfsTableIndex=dfsTableIndex, transmitPower=transmitPower, ptpTraps=ptpTraps, dfsMeans=dfsMeans, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, eIRP=eIRP, bandwidthVariant=bandwidthVariant, configuration=configuration, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telnetAccessEnabled=telnetAccessEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, accessMethod=accessMethod, telecomsInterface=telecomsInterface, tDDSynchronizationMode=tDDSynchronizationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsLineCode=telecomsLineCode, telecomsCableLength=telecomsCableLength, dfsPeaks=dfsPeaks, smtp=smtp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, encryption=encryption, syslogControlGroup=syslogControlGroup, installArmState=installArmState, receiveModulationMode=receiveModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, secondarySoftwareVersion=secondarySoftwareVersion, syslogStateTrap=syslogStateTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, cableLoss=cableLoss, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapTableEntry=sNMPTrapTableEntry, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hardwareVersion=hardwareVersion, phyControlGroup=phyControlGroup, smtpGroup=smtpGroup, receiveFreqMHz=receiveFreqMHz, gatewayIPAddress=gatewayIPAddress, aAAControlGroup=aAAControlGroup, targetMACAddress=targetMACAddress, linkModeOptimizationMismatch=linkModeOptimizationMismatch, notificationsGroup=notificationsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelChangeTrap=channelChangeTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, alarms=alarms, ethernetFiberSupport=ethernetFiberSupport, alarmsGroup=alarmsGroup, sNMPTrapVersion=sNMPTrapVersion, remoteIPAddress=remoteIPAddress, aggregateDataRate=aggregateDataRate, productName=productName, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, siteName=siteName, managementGroup=managementGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, supplementary=supplementary, tFTPServerPortNumber=tFTPServerPortNumber, pubStats=pubStats, sNTPLastSync=sNTPLastSync, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyControl=phyControl, ptpTrapPrefix=ptpTrapPrefix, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vectorError=vectorError)
