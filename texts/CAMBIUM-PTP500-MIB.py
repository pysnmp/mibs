...
TimeTicks, NotificationType, ObjectIdentity, ModuleIdentity, Bits, Counter64, Unsigned32, IpAddress, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Counter32, enterprises, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Bits", "Counter64", "Unsigned32", "IpAddress", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Counter32", "enterprises", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsLoopback=telecomsLoopback, transmitFreqKHz=transmitFreqKHz, sNTPState=sNTPState, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, licence=licence, receiveFreqKHz=receiveFreqKHz, installStatusTrap=installStatusTrap, syslogControl=syslogControl, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveChannel=receiveChannel, dfsGroup=dfsGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, receivePower=receivePower, sNMPTrapTableEntry=sNMPTrapTableEntry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, smtpGroup=smtpGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, syslogState=syslogState, receiveModulationMode=receiveModulationMode, userName=userName, unitOutOfCalibration=unitOutOfCalibration, channelBandwidth=channelBandwidth, sMTPServerIPAddress=sMTPServerIPAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPEmailAlert=sMTPEmailAlert, configuration=configuration, productName=productName, groupID=groupID, encryptionAlgorithm=encryptionAlgorithm, siteName=siteName, ptp500=ptp500, timeZone=timeZone, dataPortStatus=dataPortStatus, targetMACAddress=targetMACAddress, tFTPServerIPAddress=tFTPServerIPAddress, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNTPSync=sNTPSync, management=management, supplementary=supplementary, syslogClientTrap=syslogClientTrap, supplementaryGroup=supplementaryGroup, hTTPAccessEnabled=hTTPAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, transmitDataRate=transmitDataRate, dfsTable=dfsTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNMPTrapVersion=sNMPTrapVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, daylightSaving=daylightSaving, bootVersion=bootVersion, hTTPSPortNumber=hTTPSPortNumber, longitude=longitude, sNMPPortNumber=sNMPPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPv3Enable=sNMPv3Enable, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, systemReset=systemReset, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cambium=cambium, userTableIndex=userTableIndex, installArmState=installArmState, reset=reset, sNTPServerIPAddress=sNTPServerIPAddress, channelChangeTrap=channelChangeTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpTraps=ptpTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANPriorityTable=vLANPriorityTable, receiveDataRate=receiveDataRate, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveModulationModeDetail=receiveModulationModeDetail, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationStatus=tDDSynchronizationStatus, accessMethod=accessMethod, aAAControlGroup=aAAControlGroup, syslogControlGroup=syslogControlGroup, wirelessLinkStatus=wirelessLinkStatus, linkName=linkName, vLANPriorityTableNumber=vLANPriorityTableNumber, softwareVersion=softwareVersion, telnetPortNumber=telnetPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, vLANPriorityTableEntry=vLANPriorityTableEntry, frequencyVariant=frequencyVariant, dataPortAutoNegotiation=dataPortAutoNegotiation, maximumTransmitPower=maximumTransmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, encryptionGroup=encryptionGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapIPAddress=sNMPTrapIPAddress, bandwidthVariant=bandwidthVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, aAAControl=aAAControl, dfs=dfs, dfsTableEntry=dfsTableEntry, transmitPower=transmitPower, secondarySoftwareVersion=secondarySoftwareVersion, vLANPriorityQueueMapping=vLANPriorityQueueMapping, eIRP=eIRP, userRole=userRole, sNMPCommunityString=sNMPCommunityString, iPAddress=iPAddress, licenceGroup=licenceGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, range=range, latitude=latitude, userTableNumber=userTableNumber, snmpControl=snmpControl, telecom=telecom, alarmsGroup=alarmsGroup, syslogStateTrap=syslogStateTrap, configurationGroup=configurationGroup, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationMode=tDDSynchronizationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, userTableEntry=userTableEntry, ethernetFiberSupport=ethernetFiberSupport, byteErrorRatio=byteErrorRatio, vectorError=vectorError, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, alarms=alarms, linkLoss=linkLoss, regionCodeTrap=regionCodeTrap, telecomsLineCode=telecomsLineCode, notificationsGroup=notificationsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoMdix=dataPortAutoMdix, aggregateDataRate=aggregateDataRate, resetGroup=resetGroup, managementGroup=managementGroup, installArmStateTrap=installArmStateTrap, telecomsInterface=telecomsInterface, sNMPTrapTableIndex=sNMPTrapTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tDDControlGroup=tDDControlGroup, encryption=encryption, linkModeOptimisation=linkModeOptimisation, dfsPeaks=dfsPeaks, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licensedCapacity=licensedCapacity, linkSymmetry=linkSymmetry, versionsGroup=versionsGroup, cableLoss=cableLoss, hardwareVersion=hardwareVersion, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDControl=tDDControl, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, regionCode=regionCode, hTTPPortNumber=hTTPPortNumber, sntpGroup=sntpGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControlGroup=phyControlGroup, productVariant=productVariant, signalStrengthRatio=signalStrengthRatio, searchState=searchState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPPollInterval=sNTPPollInterval, dataPortWirelessDownAlert=dataPortWirelessDownAlert, transmitModulationMode=transmitModulationMode, altitude=altitude, pubStats=pubStats, phyControl=phyControl, syslogClient=syslogClient, vLANPriorityTableIndex=vLANPriorityTableIndex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ethernetGroup=ethernetGroup, systemClock=systemClock, userEnabled=userEnabled, dataPortDisabledWarning=dataPortDisabledWarning, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, ethernet=ethernet, versions=versions, PYSNMP_MODULE_ID=cambium, telnetAccessEnabled=telnetAccessEnabled, transmitFreqMHz=transmitFreqMHz, sMTPEnabledMessages=sMTPEnabledMessages, telecomsLoopbackTrap=telecomsLoopbackTrap, userTable=userTable, snmpControlGroup=snmpControlGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNTPLastSync=sNTPLastSync, remoteIPAddress=remoteIPAddress, userPassword=userPassword, dfsTableIndex=dfsTableIndex, installStatus=installStatus, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, ptmp=ptmp, sNTPSyncTrap=sNTPSyncTrap, vLANManagementPriority=vLANManagementPriority, dataPortStatusTrap=dataPortStatusTrap, telecomGroup=telecomGroup, telecomsCableLength=telecomsCableLength, receiveFreqMHz=receiveFreqMHz, sntp=sntp, ptp=ptp, vLANManagementVID=vLANManagementVID, ptpTrapPrefix=ptpTrapPrefix, telecomsChannelStatus=telecomsChannelStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPServerPortNumber=tFTPServerPortNumber, ptpGroups=ptpGroups, dfsMeans=dfsMeans, sNMPTrapTableNumber=sNMPTrapTableNumber, gatewayIPAddress=gatewayIPAddress, transmitChannel=transmitChannel, phyStatusGroup=phyStatusGroup, subnetMask=subnetMask, phyStatus=phyStatus)
