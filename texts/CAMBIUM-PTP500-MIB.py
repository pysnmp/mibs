...
ModuleIdentity, TimeTicks, iso, Bits, Integer32, Counter64, NotificationType, Unsigned32, IpAddress, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "iso", "Bits", "Integer32", "Counter64", "NotificationType", "Unsigned32", "IpAddress", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "MibIdentifier")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, smtp=smtp, encryption=encryption, alarmsGroup=alarmsGroup, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, snmpControl=snmpControl, tFTPServerIPAddress=tFTPServerIPAddress, range=range, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableNumber=dfsTableNumber, sNMPPortNumber=sNMPPortNumber, dfsGroup=dfsGroup, management=management, groupID=groupID, telecomsChannelStatus=telecomsChannelStatus, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatusTrap=dataPortStatusTrap, userTable=userTable, receivePower=receivePower, siteName=siteName, incompatibleRegionCodes=incompatibleRegionCodes, receiveFreqKHz=receiveFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPState=sNTPState, linkSymmetry=linkSymmetry, encryptionAlgorithm=encryptionAlgorithm, productName=productName, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tFTPServerPortNumber=tFTPServerPortNumber, bootVersion=bootVersion, linkName=linkName, licence=licence, phyControl=phyControl, hardwareVersion=hardwareVersion, licensedCapacity=licensedCapacity, wirelessLinkStatus=wirelessLinkStatus, ptp=ptp, syslogControlGroup=syslogControlGroup, managementGroup=managementGroup, ptp500=ptp500, dataPortStatus=dataPortStatus, supplementary=supplementary, unitOutOfCalibration=unitOutOfCalibration, subnetMask=subnetMask, dataPortAutoMdix=dataPortAutoMdix, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableNumber=userTableNumber, sNTPLastSync=sNTPLastSync, PYSNMP_MODULE_ID=cambium, aAAControlGroup=aAAControlGroup, ethernet=ethernet, timeZone=timeZone, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarning=dataPortDisabledWarning, phyStatusGroup=phyStatusGroup, channelBandwidth=channelBandwidth, bandwidthVariant=bandwidthVariant, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, useVLANForManagementInterfaces=useVLANForManagementInterfaces, productVariant=productVariant, ptpGroups=ptpGroups, ptpTrapPrefix=ptpTrapPrefix, regionCode=regionCode, transmitFreqMHz=transmitFreqMHz, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsMeans=dfsMeans, dfsPeaks=dfsPeaks, installArmState=installArmState, licenceGroup=licenceGroup, sNTPServerPortNumber=sNTPServerPortNumber, cableLoss=cableLoss, snmpControlGroup=snmpControlGroup, ptpTraps=ptpTraps, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPTrapVersion=sNMPTrapVersion, cambium=cambium, configuration=configuration, ethernetFiberSupport=ethernetFiberSupport, installArmStateTrap=installArmStateTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, targetMACAddress=targetMACAddress, syslogControl=syslogControl, transmitPower=transmitPower, antennaGain=antennaGain, sNTPServerIPAddress=sNTPServerIPAddress, aggregateDataRate=aggregateDataRate, dfs=dfs, sMTPServerPortNumber=sMTPServerPortNumber, telecomsCableLength=telecomsCableLength, sNTPPollInterval=sNTPPollInterval, masterSlaveMode=masterSlaveMode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPCommunityString=sNMPCommunityString, versionsGroup=versionsGroup, userTableEntry=userTableEntry, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, softwareVersion=softwareVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveFreqMHz=receiveFreqMHz, userEnabled=userEnabled, receiveChannel=receiveChannel, smtpGroup=smtpGroup, sntp=sntp, tDDControlGroup=tDDControlGroup, remoteIPAddress=remoteIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPServerIPAddress=sMTPServerIPAddress, sNTPSyncTrap=sNTPSyncTrap, transmitDataRate=transmitDataRate, eIRP=eIRP, sNMPTrapTableEntry=sNMPTrapTableEntry, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, notificationsGroup=notificationsGroup, telnetPortNumber=telnetPortNumber, phyControlGroup=phyControlGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, maximumTransmitPower=maximumTransmitPower, enabledDiagnosticAlarms=enabledDiagnosticAlarms, reset=reset, regionCodeTrap=regionCodeTrap, ethernetGroup=ethernetGroup, transmitModulationMode=transmitModulationMode, telecomsInterface=telecomsInterface, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANPriorityTableIndex=vLANPriorityTableIndex, resetGroup=resetGroup, telnetAccessEnabled=telnetAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsLineCode=telecomsLineCode, signalStrengthRatio=signalStrengthRatio, ptmp=ptmp, configurationGroup=configurationGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, frequencyVariant=frequencyVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, dfsTableEntry=dfsTableEntry, longitude=longitude, telecom=telecom, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTable=sNMPTrapTable, transmitChannel=transmitChannel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vectorError=vectorError, receiveModulationModeDetail=receiveModulationModeDetail, versions=versions, dataPortAutoNegotiation=dataPortAutoNegotiation, latitude=latitude, telecomsLoopback=telecomsLoopback, userName=userName, wirelessLinkAvailability=wirelessLinkAvailability, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPSPortNumber=hTTPSPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, altitude=altitude, capacityLicenseMismatch=capacityLicenseMismatch, syslogClientTrap=syslogClientTrap, secondarySoftwareVersion=secondarySoftwareVersion, syslogClient=syslogClient, pubStats=pubStats, syslogStateTrap=syslogStateTrap, installStatus=installStatus, sNMPv3Enable=sNMPv3Enable, linkModeOptimizationMismatch=linkModeOptimizationMismatch, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, daylightSaving=daylightSaving, iPAddress=iPAddress, alarms=alarms, hTTPPortNumber=hTTPPortNumber, transmitFreqKHz=transmitFreqKHz, linkModeOptimisation=linkModeOptimisation, userPassword=userPassword, installStatusTrap=installStatusTrap, encryptionGroup=encryptionGroup, searchState=searchState, linkLoss=linkLoss, sntpGroup=sntpGroup, vLANManagementVID=vLANManagementVID, syslogState=syslogState, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTable=vLANPriorityTable, channelChangeTrap=channelChangeTrap, dfsTable=dfsTable, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userRole=userRole, userTableIndex=userTableIndex, tDDControl=tDDControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, aAAControl=aAAControl, supplementaryGroup=supplementaryGroup, receiveModulationMode=receiveModulationMode, sNTPSync=sNTPSync, tDDSynchronizationMode=tDDSynchronizationMode, telecomGroup=telecomGroup, dfsTableIndex=dfsTableIndex, noWirelessChannelAvailable=noWirelessChannelAvailable, receiveDataRate=receiveDataRate, ptpCompliance=ptpCompliance, vLANPriorityTableEntry=vLANPriorityTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, accessMethod=accessMethod, sMTPEmailAlert=sMTPEmailAlert, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemClock=systemClock, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemReset=systemReset)
