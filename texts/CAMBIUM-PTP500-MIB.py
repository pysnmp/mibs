...
# Produced by pysmi-1.1.0 at Tue Nov 16 12:08:21 2021
...
ObjectIdentity, Bits, TimeTicks, Counter32, Gauge32, Unsigned32, enterprises, Counter64, Integer32, IpAddress, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Bits", "TimeTicks", "Counter32", "Gauge32", "Unsigned32", "enterprises", "Counter64", "Integer32", "IpAddress", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, receiveFreqKHz=receiveFreqKHz, latitude=latitude, tFTPServerIPAddress=tFTPServerIPAddress, byteErrorRatio=byteErrorRatio, versions=versions, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, resetGroup=resetGroup, managementGroup=managementGroup, systemClock=systemClock, sNMPTrapVersion=sNMPTrapVersion, userTable=userTable, dataPortConfigurationMismatch=dataPortConfigurationMismatch, alarms=alarms, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, smtp=smtp, linkModeOptimisation=linkModeOptimisation, receiveDataRate=receiveDataRate, targetMACAddress=targetMACAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkSymmetry=linkSymmetry, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, aAAControlGroup=aAAControlGroup, encryption=encryption, tDDControlGroup=tDDControlGroup, dfsTable=dfsTable, userTableIndex=userTableIndex, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogStateTrap=syslogStateTrap, installArmState=installArmState, ptpTraps=ptpTraps, siteName=siteName, ptmp=ptmp, notificationsGroup=notificationsGroup, hTTPSPortNumber=hTTPSPortNumber, syslogState=syslogState, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptpCompliance=ptpCompliance, hTTPAccessEnabled=hTTPAccessEnabled, sMTPEmailAlert=sMTPEmailAlert, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDSynchronizationStatus=tDDSynchronizationStatus, supplementaryGroup=supplementaryGroup, ptpTrapPrefix=ptpTrapPrefix, wirelessLinkAvailability=wirelessLinkAvailability, transmitFreqKHz=transmitFreqKHz, antennaGain=antennaGain, bandwidthVariant=bandwidthVariant, wirelessLinkStatus=wirelessLinkStatus, syslogClientTrap=syslogClientTrap, dataPortStatus=dataPortStatus, sNTPPollInterval=sNTPPollInterval, sMTPSourceEmailAddress=sMTPSourceEmailAddress, eIRP=eIRP, smtpGroup=smtpGroup, snmpControl=snmpControl, sntpGroup=sntpGroup, telecomsLineCode=telecomsLineCode, ptpGroups=ptpGroups, sNTPSyncTrap=sNTPSyncTrap, userTableEntry=userTableEntry, encryptionGroup=encryptionGroup, ptp500=ptp500, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNMPv3Enable=sNMPv3Enable, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPEnabledMessages=sMTPEnabledMessages, PYSNMP_MODULE_ID=cambium, ethernetGroup=ethernetGroup, signalStrengthRatio=signalStrengthRatio, secondarySoftwareVersion=secondarySoftwareVersion, groupID=groupID, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPPortNumber=sNMPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, dfsGroup=dfsGroup, subnetMask=subnetMask, linkModeOptimizationMismatch=linkModeOptimizationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPServerIPAddress=sNTPServerIPAddress, dfsPeaks=dfsPeaks, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsMeans=dfsMeans, snmpControlGroup=snmpControlGroup, bootVersion=bootVersion, tDDControl=tDDControl, pubStatsGroup=pubStatsGroup, installArmStateTrap=installArmStateTrap, unitOutOfCalibration=unitOutOfCalibration, vectorError=vectorError, management=management, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortStatusTrap=dataPortStatusTrap, aggregateDataRate=aggregateDataRate, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsChannelStatus=telecomsChannelStatus, telecomsLoopback=telecomsLoopback, regionCodeTrap=regionCodeTrap, masterSlaveMode=masterSlaveMode, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, reset=reset, licence=licence, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, configurationGroup=configurationGroup, phyStatus=phyStatus, phyStatusGroup=phyStatusGroup, supplementary=supplementary, syslogControl=syslogControl, transmitChannel=transmitChannel, transmitFreqMHz=transmitFreqMHz, sNTPSync=sNTPSync, telnetAccessEnabled=telnetAccessEnabled, searchState=searchState, aAAControl=aAAControl, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, transmitModulationMode=transmitModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, configuration=configuration, sNMPTrapTable=sNMPTrapTable, transmitPower=transmitPower, encryptionAlgorithm=encryptionAlgorithm, userEnabled=userEnabled, vLANPriorityQueueMapping=vLANPriorityQueueMapping, constantPowerSpectralDensity=constantPowerSpectralDensity, ethernet=ethernet, capacityLicenseMismatch=capacityLicenseMismatch, syslogClient=syslogClient, dfsTableNumber=dfsTableNumber, syslogControlGroup=syslogControlGroup, altitude=altitude, telecomsInterface=telecomsInterface, receiveFreqMHz=receiveFreqMHz, sNMPCommunityString=sNMPCommunityString, channelBandwidth=channelBandwidth, receiveChannel=receiveChannel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableEntry=dfsTableEntry, vLANPriorityTable=vLANPriorityTable, installStatus=installStatus, tFTPServerPortNumber=tFTPServerPortNumber, dfs=dfs, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, longitude=longitude, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, frequencyVariant=frequencyVariant, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, productName=productName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, systemReset=systemReset, sNTPState=sNTPState, iPAddress=iPAddress, hardwareVersion=hardwareVersion, ethernetFiberSupport=ethernetFiberSupport, channelChangeTrap=channelChangeTrap, range=range, phyControlGroup=phyControlGroup, phyControl=phyControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userPassword=userPassword, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANManagementVID=vLANManagementVID, installStatusTrap=installStatusTrap, regionCode=regionCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, alarmsGroup=alarmsGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntp=sntp, dfsTableIndex=dfsTableIndex, accessMethod=accessMethod, incompatibleMasterAndSlave=incompatibleMasterAndSlave, licensedCapacity=licensedCapacity, sNTPServerPortNumber=sNTPServerPortNumber, productVariant=productVariant, tDDSynchronizationMode=tDDSynchronizationMode, transmitDataRate=transmitDataRate, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versionsGroup=versionsGroup, licenceGroup=licenceGroup, telecom=telecom, linkLoss=linkLoss, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, ptp=ptp, sNMPTrapPortNumber=sNMPTrapPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, userTableNumber=userTableNumber, softwareVersion=softwareVersion, userRole=userRole, hTTPPortNumber=hTTPPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, telecomsCableLength=telecomsCableLength, receiveModulationMode=receiveModulationMode, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, cableLoss=cableLoss, dataPortAutoMdix=dataPortAutoMdix, linkName=linkName, vLANManagementPriority=vLANManagementPriority, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telnetPortNumber=telnetPortNumber, sNTPLastSync=sNTPLastSync, maximumTransmitPower=maximumTransmitPower, daylightSaving=daylightSaving, gatewayIPAddress=gatewayIPAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, timeZone=timeZone, telecomGroup=telecomGroup, cambium=cambium, telecomsChannelStatusTrap=telecomsChannelStatusTrap, remoteIPAddress=remoteIPAddress, userName=userName)
