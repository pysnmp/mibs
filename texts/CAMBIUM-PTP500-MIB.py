...
# Produced by pysmi-1.1.3 at Thu Dec  9 15:31:12 2021
...
enterprises, Bits, Unsigned32, NotificationType, Integer32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, Counter32, Gauge32, ModuleIdentity, iso, TimeTicks, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Bits", "Unsigned32", "NotificationType", "Integer32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "Counter32", "Gauge32", "ModuleIdentity", "iso", "TimeTicks", "ObjectIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", PYSNMP_MODULE_ID=cambium, telecomsInterface=telecomsInterface, telecomGroup=telecomGroup, wirelessLinkAvailability=wirelessLinkAvailability, remoteIPAddress=remoteIPAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitFreqMHz=transmitFreqMHz, ptp500=ptp500, phyStatus=phyStatus, dataPortStatus=dataPortStatus, linkLoss=linkLoss, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, unitOutOfCalibration=unitOutOfCalibration, cambium=cambium, telnetPortNumber=telnetPortNumber, hTTPPortNumber=hTTPPortNumber, phyStatusGroup=phyStatusGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, daylightSaving=daylightSaving, sNMPPortNumber=sNMPPortNumber, timeZone=timeZone, syslogClient=syslogClient, vectorError=vectorError, ethernetGroup=ethernetGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPSPortNumber=hTTPSPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sntp=sntp, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTable=dfsTable, userTableEntry=userTableEntry, userRole=userRole, configurationGroup=configurationGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsGroup=dfsGroup, vLANManagementVID=vLANManagementVID, ptpGroups=ptpGroups, phyControl=phyControl, ptmp=ptmp, vLANPriorityTableNumber=vLANPriorityTableNumber, userTableNumber=userTableNumber, transmitDataRate=transmitDataRate, telecom=telecom, configuration=configuration, userTableIndex=userTableIndex, linkSymmetry=linkSymmetry, sMTPSourceEmailAddress=sMTPSourceEmailAddress, bootVersion=bootVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, cableLoss=cableLoss, channelBandwidth=channelBandwidth, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapTableEntry=sNMPTrapTableEntry, byteErrorRatio=byteErrorRatio, transmitFreqKHz=transmitFreqKHz, sMTPEnabledMessages=sMTPEnabledMessages, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPEmailAlert=sMTPEmailAlert, syslogStateTrap=syslogStateTrap, productVariant=productVariant, accessMethod=accessMethod, range=range, dfs=dfs, signalStrengthRatio=signalStrengthRatio, managementGroup=managementGroup, reset=reset, tDDControl=tDDControl, encryptionAlgorithm=encryptionAlgorithm, encryption=encryption, syslogControl=syslogControl, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, snmpControl=snmpControl, enabledDiagnosticAlarms=enabledDiagnosticAlarms, notificationsGroup=notificationsGroup, sNTPSync=sNTPSync, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tDDSynchronizationMode=tDDSynchronizationMode, longitude=longitude, altitude=altitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, smtp=smtp, telecomsLineCode=telecomsLineCode, ptpCompliance=ptpCompliance, wirelessLinkStatus=wirelessLinkStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, pubStats=pubStats, alarmsGroup=alarmsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, ethernet=ethernet, linkModeOptimizationMismatch=linkModeOptimizationMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, licence=licence, smtpGroup=smtpGroup, telecomsCableLength=telecomsCableLength, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPv3Enable=sNMPv3Enable, hardwareVersion=hardwareVersion, dataPortAutoMdix=dataPortAutoMdix, secondarySoftwareVersion=secondarySoftwareVersion, pubStatsGroup=pubStatsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, channelChangeTrap=channelChangeTrap, sNTPState=sNTPState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licensedCapacity=licensedCapacity, dfsMeans=dfsMeans, tDDControlGroup=tDDControlGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, vLANPriorityTableIndex=vLANPriorityTableIndex, vLANPriorityTableEntry=vLANPriorityTableEntry, phyControlGroup=phyControlGroup, iPAddress=iPAddress, incompatibleRegionCodes=incompatibleRegionCodes, telecomsChannelStatusTrap=telecomsChannelStatusTrap, systemClock=systemClock, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, frequencyVariant=frequencyVariant, receiveChannel=receiveChannel, transmitPower=transmitPower, sNTPServerPortNumber=sNTPServerPortNumber, management=management, sNTPLastSync=sNTPLastSync, subnetMask=subnetMask, regionCodeTrap=regionCodeTrap, telnetAccessEnabled=telnetAccessEnabled, latitude=latitude, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, siteName=siteName, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sntpGroup=sntpGroup, vLANPriorityTable=vLANPriorityTable, telecomsLoopback=telecomsLoopback, syslogControlGroup=syslogControlGroup, regionCode=regionCode, sNTPServerIPAddress=sNTPServerIPAddress, resetGroup=resetGroup, productName=productName, supplementaryGroup=supplementaryGroup, tFTPServerIPAddress=tFTPServerIPAddress, targetMACAddress=targetMACAddress, supplementary=supplementary, vLANManagementPriority=vLANManagementPriority, snmpControlGroup=snmpControlGroup, telecomsChannelStatus=telecomsChannelStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsTableNumber=dfsTableNumber, encryptionGroup=encryptionGroup, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatusTrap=dataPortStatusTrap, groupID=groupID, tFTPServerPortNumber=tFTPServerPortNumber, dfsTableIndex=dfsTableIndex, sNMPCommunityString=sNMPCommunityString, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, eIRP=eIRP, bandwidthVariant=bandwidthVariant, userEnabled=userEnabled, installArmState=installArmState, syslogClientTrap=syslogClientTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dfsPeaks=dfsPeaks, sNMPTrapTableIndex=sNMPTrapTableIndex, versions=versions, aAAControl=aAAControl, versionsGroup=versionsGroup, dfsTableEntry=dfsTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, systemReset=systemReset, maximumTransmitPower=maximumTransmitPower, gatewayIPAddress=gatewayIPAddress, ethernetFiberSupport=ethernetFiberSupport, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, searchState=searchState, userName=userName, licenceGroup=licenceGroup, receiveModulationModeDetail=receiveModulationModeDetail, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPPollInterval=sNTPPollInterval, capacityLicenseMismatch=capacityLicenseMismatch, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortDisabledWarning=dataPortDisabledWarning, syslogState=syslogState, antennaGain=antennaGain, userTable=userTable, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, hTTPAccessEnabled=hTTPAccessEnabled, linkModeOptimisation=linkModeOptimisation, sNMPTrapTable=sNMPTrapTable, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationAlarm=tDDSynchronizationAlarm, receiveFreqMHz=receiveFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitChannel=transmitChannel, linkName=linkName, sNTPSyncTrap=sNTPSyncTrap, receivePower=receivePower, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerIPAddress=sMTPServerIPAddress, softwareVersion=softwareVersion, alarms=alarms, installStatus=installStatus, ptp=ptp, aAAControlGroup=aAAControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, installStatusTrap=installStatusTrap, transmitModulationMode=transmitModulationMode, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, receiveFreqKHz=receiveFreqKHz, userPassword=userPassword)
