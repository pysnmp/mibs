...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsTable=dfsTable, ethernetFiberSupport=ethernetFiberSupport, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receivePower=receivePower, hTTPSPortNumber=hTTPSPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, receiveModulationModeDetail=receiveModulationModeDetail, altitude=altitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, softwareVersion=softwareVersion, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogControl=syslogControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitChannel=transmitChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPState=sNTPState, wirelessLinkStatus=wirelessLinkStatus, sNTPPollInterval=sNTPPollInterval, supplementary=supplementary, dfsPeaks=dfsPeaks, alarmsGroup=alarmsGroup, remoteIPAddress=remoteIPAddress, syslogState=syslogState, siteName=siteName, phyStatus=phyStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, notificationsGroup=notificationsGroup, gatewayIPAddress=gatewayIPAddress, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licensedCapacity=licensedCapacity, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, antennaGain=antennaGain, transmitModulationMode=transmitModulationMode, latitude=latitude, userTableNumber=userTableNumber, dataPortStatusTrap=dataPortStatusTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPServerPortNumber=sNTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, alarms=alarms, configurationGroup=configurationGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, versionsGroup=versionsGroup, incompatibleRegionCodes=incompatibleRegionCodes, ptpGroups=ptpGroups, telecomsChannelStatus=telecomsChannelStatus, phyControl=phyControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, installStatus=installStatus, receiveFreqMHz=receiveFreqMHz, sMTPSourceEmailAddress=sMTPSourceEmailAddress, versions=versions, ethernetGroup=ethernetGroup, regionCode=regionCode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cableLoss=cableLoss, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ptp=ptp, userRole=userRole, receiveModulationMode=receiveModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, snmpControl=snmpControl, tDDControl=tDDControl, systemReset=systemReset, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptpTrapPrefix=ptpTrapPrefix, transmitPower=transmitPower, dataPortDisabledWarning=dataPortDisabledWarning, telecomsLineCode=telecomsLineCode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aggregateDataRate=aggregateDataRate, encryptionAlgorithm=encryptionAlgorithm, channelChangeTrap=channelChangeTrap, vectorError=vectorError, supplementaryGroup=supplementaryGroup, dfs=dfs, sNMPTrapTableNumber=sNMPTrapTableNumber, userTableIndex=userTableIndex, sNMPTrapVersion=sNMPTrapVersion, tDDControlGroup=tDDControlGroup, snmpControlGroup=snmpControlGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptp500=ptp500, licenceGroup=licenceGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkAvailability=wirelessLinkAvailability, encryption=encryption, channelBandwidth=channelBandwidth, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitFreqKHz=transmitFreqKHz, dataPortStatus=dataPortStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyControlGroup=phyControlGroup, dataPortAutoMdix=dataPortAutoMdix, syslogClient=syslogClient, noWirelessChannelAvailable=noWirelessChannelAvailable, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpTraps=ptpTraps, configuration=configuration, pubStatsGroup=pubStatsGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernet=ethernet, telecomsLoopback=telecomsLoopback, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, telecomsCableLength=telecomsCableLength, userTable=userTable, ptmp=ptmp, installStatusTrap=installStatusTrap, syslogStateTrap=syslogStateTrap, productVariant=productVariant, vLANPriorityTable=vLANPriorityTable, installArmState=installArmState, ptpCompliance=ptpCompliance, telecomsInterface=telecomsInterface, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPServerIPAddress=sMTPServerIPAddress, targetMACAddress=targetMACAddress, searchState=searchState, secondarySoftwareVersion=secondarySoftwareVersion, dfsTableIndex=dfsTableIndex, longitude=longitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, groupID=groupID, bootVersion=bootVersion, vLANManagementVID=vLANManagementVID, sNTPSync=sNTPSync, range=range, iPAddress=iPAddress, sntp=sntp, tFTPServerIPAddress=tFTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsTableEntry=dfsTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, timeZone=timeZone, userName=userName, userEnabled=userEnabled, installArmStateTrap=installArmStateTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveFreqKHz=receiveFreqKHz, transmitDataRate=transmitDataRate, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, frequencyVariant=frequencyVariant, telecom=telecom, sNMPTrapPortNumber=sNMPTrapPortNumber, systemClock=systemClock, daylightSaving=daylightSaving, resetGroup=resetGroup, aAAControlGroup=aAAControlGroup, sNMPCommunityString=sNMPCommunityString, aAAControl=aAAControl, sNMPEnabledTraps=sNMPEnabledTraps, maximumTransmitPower=maximumTransmitPower, hTTPSAccessEnabled=hTTPSAccessEnabled, linkModeOptimisation=linkModeOptimisation, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sMTPServerPortNumber=sMTPServerPortNumber, linkName=linkName, eIRP=eIRP, sNTPLastSync=sNTPLastSync, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPSyncTrap=sNTPSyncTrap, signalStrengthRatio=signalStrengthRatio, phyStatusGroup=phyStatusGroup, byteErrorRatio=byteErrorRatio, userPassword=userPassword, subnetMask=subnetMask, capacityLicenseMismatch=capacityLicenseMismatch, PYSNMP_MODULE_ID=cambium, licence=licence, productName=productName, hardwareVersion=hardwareVersion, syslogControlGroup=syslogControlGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, masterSlaveMode=masterSlaveMode, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibration=unitOutOfCalibration, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, tDDSynchronizationMode=tDDSynchronizationMode, cambium=cambium, vLANPriorityTableEntry=vLANPriorityTableEntry, linkLoss=linkLoss, linkSymmetry=linkSymmetry, dfsMeans=dfsMeans, receiveChannel=receiveChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, reset=reset, sNMPTrapTable=sNMPTrapTable, tFTPServerPortNumber=tFTPServerPortNumber, managementGroup=managementGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsGroup=dfsGroup, hTTPAccessEnabled=hTTPAccessEnabled, telnetPortNumber=telnetPortNumber, accessMethod=accessMethod, receiveDataRate=receiveDataRate, sntpGroup=sntpGroup, encryptionGroup=encryptionGroup, bandwidthVariant=bandwidthVariant, userTableEntry=userTableEntry, regionCodeTrap=regionCodeTrap, telecomGroup=telecomGroup, smtp=smtp, vLANPriorityTableNumber=vLANPriorityTableNumber, dfsTableNumber=dfsTableNumber, telnetAccessEnabled=telnetAccessEnabled, sNMPPortNumber=sNMPPortNumber, smtpGroup=smtpGroup)
