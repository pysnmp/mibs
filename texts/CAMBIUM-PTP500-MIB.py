...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPPortNumber=sNMPPortNumber, sNTPPollInterval=sNTPPollInterval, ptmp=ptmp, telecomsChannelStatusTrap=telecomsChannelStatusTrap, vLANManagementPriority=vLANManagementPriority, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, management=management, ptpCompliance=ptpCompliance, phyControlGroup=phyControlGroup, cableLoss=cableLoss, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sMTPServerIPAddress=sMTPServerIPAddress, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, pubStats=pubStats, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPLastSync=sNTPLastSync, incompatibleRegionCodes=incompatibleRegionCodes, hardwareVersion=hardwareVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, ptp500=ptp500, aAAControl=aAAControl, remoteIPAddress=remoteIPAddress, syslogStateTrap=syslogStateTrap, sMTPEnabledMessages=sMTPEnabledMessages, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, supplementary=supplementary, telecomsLoopback=telecomsLoopback, sNMPEnabledTraps=sNMPEnabledTraps, linkModeOptimisation=linkModeOptimisation, sNMPTrapTable=sNMPTrapTable, capacityLicenseMismatch=capacityLicenseMismatch, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, latitude=latitude, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableIndex=dfsTableIndex, telecomsInterface=telecomsInterface, receiveModulationModeDetail=receiveModulationModeDetail, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, linkName=linkName, sNMPCommunityString=sNMPCommunityString, userTableNumber=userTableNumber, transmitPower=transmitPower, userName=userName, userRole=userRole, versionsGroup=versionsGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPPortNumber=hTTPPortNumber, telecomsChannelStatus=telecomsChannelStatus, sNTPSyncTrap=sNTPSyncTrap, reset=reset, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementVID=vLANManagementVID, altitude=altitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortStatus=dataPortStatus, hTTPAccessEnabled=hTTPAccessEnabled, daylightSaving=daylightSaving, receivePower=receivePower, receiveModulationMode=receiveModulationMode, syslogControlGroup=syslogControlGroup, sNMPv3Enable=sNMPv3Enable, dfs=dfs, telnetPortNumber=telnetPortNumber, sntpGroup=sntpGroup, aggregateDataRate=aggregateDataRate, linkLoss=linkLoss, receiveChannel=receiveChannel, dfsTableNumber=dfsTableNumber, phyStatusGroup=phyStatusGroup, iPAddress=iPAddress, subnetMask=subnetMask, syslogControl=syslogControl, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, installStatus=installStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, telnetAccessEnabled=telnetAccessEnabled, receiveDataRate=receiveDataRate, linkModeOptimizationMismatch=linkModeOptimizationMismatch, timeZone=timeZone, secondarySoftwareVersion=secondarySoftwareVersion, ethernet=ethernet, supplementaryGroup=supplementaryGroup, sNTPSync=sNTPSync, sntp=sntp, maximumTransmitPower=maximumTransmitPower, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsCableLength=telecomsCableLength, dfsTable=dfsTable, gatewayIPAddress=gatewayIPAddress, dfsTableEntry=dfsTableEntry, regionCode=regionCode, managementGroup=managementGroup, bandwidthVariant=bandwidthVariant, receiveFreqMHz=receiveFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomsLineCode=telecomsLineCode, alarms=alarms, licensedCapacity=licensedCapacity, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomGroup=telecomGroup, aAAControlGroup=aAAControlGroup, transmitChannel=transmitChannel, dataPortAutoMdix=dataPortAutoMdix, searchState=searchState, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibration=unitOutOfCalibration, tDDControlGroup=tDDControlGroup, sMTPServerPortNumber=sMTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, smtp=smtp, ethernetFiberSupport=ethernetFiberSupport, channelChangeTrap=channelChangeTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, targetMACAddress=targetMACAddress, tFTPServerIPAddress=tFTPServerIPAddress, productVariant=productVariant, wirelessLinkAvailability=wirelessLinkAvailability, encryptionGroup=encryptionGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPServerPortNumber=tFTPServerPortNumber, transmitModulationMode=transmitModulationMode, ptpTrapPrefix=ptpTrapPrefix, versions=versions, channelBandwidth=channelBandwidth, syslogState=syslogState, range=range, bootVersion=bootVersion, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableEntry=userTableEntry, sNMPTrapVersion=sNMPTrapVersion, longitude=longitude, linkSymmetry=linkSymmetry, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, siteName=siteName, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANPriorityTable=vLANPriorityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, hTTPSPortNumber=hTTPSPortNumber, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, notificationsGroup=notificationsGroup, snmpControlGroup=snmpControlGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, systemReset=systemReset, productName=productName, alarmsGroup=alarmsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControl=phyControl, syslogClient=syslogClient, dataPortConfigurationMismatch=dataPortConfigurationMismatch, byteErrorRatio=byteErrorRatio, masterSlaveMode=masterSlaveMode, installArmStateTrap=installArmStateTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, smtpGroup=smtpGroup, phyStatus=phyStatus, syslogClientTrap=syslogClientTrap, transmitFreqMHz=transmitFreqMHz, userEnabled=userEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, licence=licence, wirelessLinkStatus=wirelessLinkStatus, transmitDataRate=transmitDataRate, sNTPServerIPAddress=sNTPServerIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, encryption=encryption, dfsMeans=dfsMeans, signalStrengthRatio=signalStrengthRatio, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortStatusTrap=dataPortStatusTrap, sNTPState=sNTPState, licenceGroup=licenceGroup, tDDControl=tDDControl, pubStatsGroup=pubStatsGroup, sNTPServerPortNumber=sNTPServerPortNumber, frequencyVariant=frequencyVariant, ptp=ptp, vLANPriorityTableEntry=vLANPriorityTableEntry, ptpGroups=ptpGroups, configurationGroup=configurationGroup, regionCodeTrap=regionCodeTrap, cambium=cambium, resetGroup=resetGroup, antennaGain=antennaGain, installArmState=installArmState, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveFreqKHz=receiveFreqKHz, vLANPriorityQueueMapping=vLANPriorityQueueMapping, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, telecom=telecom, vectorError=vectorError, dfsGroup=dfsGroup, configuration=configuration, accessMethod=accessMethod, hTTPSAccessEnabled=hTTPSAccessEnabled, userTableIndex=userTableIndex, userPassword=userPassword, groupID=groupID, ethernetGroup=ethernetGroup, userTable=userTable, softwareVersion=softwareVersion, systemClock=systemClock, ptpTraps=ptpTraps, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, snmpControl=snmpControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapTableIndex=sNMPTrapTableIndex, eIRP=eIRP, transmitFreqKHz=transmitFreqKHz, dfsPeaks=dfsPeaks, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, installStatusTrap=installStatusTrap)
