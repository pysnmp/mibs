...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsLineCode=telecomsLineCode, dataPortAutoNegotiation=dataPortAutoNegotiation, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsGroup=dfsGroup, syslogState=syslogState, productVariant=productVariant, licensedCapacity=licensedCapacity, remoteIPAddress=remoteIPAddress, transmitFreqKHz=transmitFreqKHz, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsLoopback=telecomsLoopback, telecomsCableLength=telecomsCableLength, userRole=userRole, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPPortNumber=sNMPPortNumber, sntp=sntp, transmitFreqMHz=transmitFreqMHz, versions=versions, snmpControl=snmpControl, hTTPAccessEnabled=hTTPAccessEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPPortNumber=hTTPPortNumber, vLANPriorityTable=vLANPriorityTable, transmitPower=transmitPower, userPassword=userPassword, accessMethod=accessMethod, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, configuration=configuration, masterSlaveMode=masterSlaveMode, sNTPPollInterval=sNTPPollInterval, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveFreqKHz=receiveFreqKHz, syslogClient=syslogClient, syslogControl=syslogControl, tDDControlGroup=tDDControlGroup, subnetMask=subnetMask, channelChangeTrap=channelChangeTrap, transmitModulationMode=transmitModulationMode, ptpTraps=ptpTraps, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsTableIndex=dfsTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, resetGroup=resetGroup, iPAddress=iPAddress, hTTPSPortNumber=hTTPSPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, supplementary=supplementary, userTableIndex=userTableIndex, management=management, pubStatsGroup=pubStatsGroup, receiveChannel=receiveChannel, timeZone=timeZone, sMTPSourceEmailAddress=sMTPSourceEmailAddress, aAAControlGroup=aAAControlGroup, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPEnabledTraps=sNMPEnabledTraps, sNTPState=sNTPState, telnetPortNumber=telnetPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, sNTPServerPortNumber=sNTPServerPortNumber, ethernet=ethernet, sNMPCommunityString=sNMPCommunityString, targetMACAddress=targetMACAddress, softwareVersion=softwareVersion, ptp=ptp, sMTPEnabledMessages=sMTPEnabledMessages, transmitDataRate=transmitDataRate, ptpCompliance=ptpCompliance, smtpGroup=smtpGroup, ptpGroups=ptpGroups, latitude=latitude, incompatibleRegionCodes=incompatibleRegionCodes, vLANManagementVID=vLANManagementVID, longitude=longitude, ptpTrapPrefix=ptpTrapPrefix, vLANManagementPriority=vLANManagementPriority, sMTPEmailAlert=sMTPEmailAlert, linkModeOptimisation=linkModeOptimisation, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sntpGroup=sntpGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, linkName=linkName, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, vectorError=vectorError, userName=userName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTable=dfsTable, telecomGroup=telecomGroup, managementGroup=managementGroup, dfsPeaks=dfsPeaks, encryptionGroup=encryptionGroup, daylightSaving=daylightSaving, regionCodeTrap=regionCodeTrap, notificationsGroup=notificationsGroup, phyStatusGroup=phyStatusGroup, linkLoss=linkLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogClientTrap=syslogClientTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, capacityLicenseMismatch=capacityLicenseMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortAutoMdix=dataPortAutoMdix, sNMPv3Enable=sNMPv3Enable, userEnabled=userEnabled, snmpControlGroup=snmpControlGroup, phyStatus=phyStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTable=sNMPTrapTable, receiveModulationMode=receiveModulationMode, telecomsLoopbackTrap=telecomsLoopbackTrap, cableLoss=cableLoss, alarms=alarms, pubStats=pubStats, dataPortStatus=dataPortStatus, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkAvailability=wirelessLinkAvailability, cambium=cambium, tDDSynchronizationAlarm=tDDSynchronizationAlarm, secondarySoftwareVersion=secondarySoftwareVersion, dataPortDisabledWarning=dataPortDisabledWarning, groupID=groupID, regionCode=regionCode, systemClock=systemClock, telecomsChannelStatusTrap=telecomsChannelStatusTrap, bandwidthVariant=bandwidthVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsChannelStatus=telecomsChannelStatus, receiveFreqMHz=receiveFreqMHz, syslogLocalWrappedTrap=syslogLocalWrappedTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, PYSNMP_MODULE_ID=cambium, smtp=smtp, frequencyVariant=frequencyVariant, syslogStateTrap=syslogStateTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPServerIPAddress=sMTPServerIPAddress, telnetAccessEnabled=telnetAccessEnabled, dfs=dfs, sNTPSyncTrap=sNTPSyncTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receivePower=receivePower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, searchState=searchState, range=range, configurationGroup=configurationGroup, sMTPServerPortNumber=sMTPServerPortNumber, ptp500=ptp500, dataPortStatusTrap=dataPortStatusTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, versionsGroup=versionsGroup, maximumTransmitPower=maximumTransmitPower, reset=reset, phyControl=phyControl, systemReset=systemReset, userTableNumber=userTableNumber, receiveDataRate=receiveDataRate, vLANPriorityQueueMapping=vLANPriorityQueueMapping, aAAControl=aAAControl, ethernetGroup=ethernetGroup, sNTPLastSync=sNTPLastSync, tDDControl=tDDControl, installArmState=installArmState, dfsTableNumber=dfsTableNumber, userTable=userTable, sNMPTrapVersion=sNMPTrapVersion, transmitChannel=transmitChannel, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, antennaGain=antennaGain, unitOutOfCalibration=unitOutOfCalibration, sNTPServerIPAddress=sNTPServerIPAddress, vLANPriorityTableEntry=vLANPriorityTableEntry, aggregateDataRate=aggregateDataRate, telecomsInterface=telecomsInterface, tDDSynchronizationStatus=tDDSynchronizationStatus, phyControlGroup=phyControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, bootVersion=bootVersion, installArmStateTrap=installArmStateTrap, ptmp=ptmp, syslogControlGroup=syslogControlGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tFTPServerPortNumber=tFTPServerPortNumber, altitude=altitude, alarmsGroup=alarmsGroup, installStatusTrap=installStatusTrap, hardwareVersion=hardwareVersion, dfsTableEntry=dfsTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, licence=licence, telecom=telecom, dfsMeans=dfsMeans, linkSymmetry=linkSymmetry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, productName=productName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableEntry=userTableEntry, channelBandwidth=channelBandwidth, siteName=siteName, installStatus=installStatus, byteErrorRatio=byteErrorRatio, supplementaryGroup=supplementaryGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationMode=tDDSynchronizationMode, signalStrengthRatio=signalStrengthRatio, tFTPServerIPAddress=tFTPServerIPAddress, eIRP=eIRP, encryption=encryption, sNTPSync=sNTPSync, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, wirelessLinkStatus=wirelessLinkStatus, licenceGroup=licenceGroup)
