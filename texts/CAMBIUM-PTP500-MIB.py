...
# Produced by pysmi-1.1.10 at Fri Oct 27 12:06:17 2023
...
Integer32, enterprises, TimeTicks, ObjectIdentity, ModuleIdentity, Counter64, NotificationType, iso, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, MibIdentifier, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "enterprises", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "Counter64", "NotificationType", "iso", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "MibIdentifier", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installArmState=installArmState, sNTPServerIPAddress=sNTPServerIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsTable=dfsTable, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sntpGroup=sntpGroup, receiveModulationMode=receiveModulationMode, sNMPv3Enable=sNMPv3Enable, sNTPPollInterval=sNTPPollInterval, notificationsGroup=notificationsGroup, productVariant=productVariant, gatewayIPAddress=gatewayIPAddress, sNTPState=sNTPState, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, receiveFreqKHz=receiveFreqKHz, vLANPriorityTableIndex=vLANPriorityTableIndex, supplementary=supplementary, smtpGroup=smtpGroup, syslogClientTrap=syslogClientTrap, ptpTrapPrefix=ptpTrapPrefix, range=range, telecomsLineCode=telecomsLineCode, vLANPriorityTable=vLANPriorityTable, linkSymmetry=linkSymmetry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, configuration=configuration, daylightSaving=daylightSaving, transmitDataRate=transmitDataRate, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsChannelStatus=telecomsChannelStatus, aAAControl=aAAControl, smtp=smtp, aAAControlGroup=aAAControlGroup, ptpGroups=ptpGroups, sNMPTrapTable=sNMPTrapTable, linkName=linkName, dataPortWirelessDownAlert=dataPortWirelessDownAlert, constantPowerSpectralDensity=constantPowerSpectralDensity, siteName=siteName, hTTPAccessEnabled=hTTPAccessEnabled, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableIndex=sNMPTrapTableIndex, antennaGain=antennaGain, syslogClient=syslogClient, linkModeOptimizationMismatch=linkModeOptimizationMismatch, ptpCompliance=ptpCompliance, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANPriorityQueueMapping=vLANPriorityQueueMapping, incompatibleRegionCodes=incompatibleRegionCodes, sNMPEnabledTraps=sNMPEnabledTraps, tDDSynchronizationMode=tDDSynchronizationMode, tFTPServerPortNumber=tFTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSPortNumber=hTTPSPortNumber, installArmStateTrap=installArmStateTrap, hardwareVersion=hardwareVersion, reset=reset, configurationGroup=configurationGroup, eIRP=eIRP, sMTPSourceEmailAddress=sMTPSourceEmailAddress, channelChangeTrap=channelChangeTrap, ethernetFiberSupport=ethernetFiberSupport, syslogControlGroup=syslogControlGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, groupID=groupID, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userTable=userTable, supplementaryGroup=supplementaryGroup, transmitPower=transmitPower, phyStatus=phyStatus, telecomsCableLength=telecomsCableLength, timeZone=timeZone, enabledDiagnosticAlarms=enabledDiagnosticAlarms, encryption=encryption, linkModeOptimisation=linkModeOptimisation, phyStatusGroup=phyStatusGroup, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableNumber=sNMPTrapTableNumber, management=management, encryptionGroup=encryptionGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsPeaks=dfsPeaks, userPassword=userPassword, ptpTraps=ptpTraps, sNTPLastSync=sNTPLastSync, installStatusTrap=installStatusTrap, telecomsLoopback=telecomsLoopback, licensedCapacity=licensedCapacity, dfsTableNumber=dfsTableNumber, dfsMeans=dfsMeans, versionsGroup=versionsGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfs=dfs, PYSNMP_MODULE_ID=cambium, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, frequencyVariant=frequencyVariant, cableLoss=cableLoss, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, maximumTransmitPower=maximumTransmitPower, transmitFreqMHz=transmitFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, bandwidthVariant=bandwidthVariant, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, productName=productName, sNMPTrapVersion=sNMPTrapVersion, vLANPriorityTableEntry=vLANPriorityTableEntry, cambium=cambium, ptmp=ptmp, syslogStateTrap=syslogStateTrap, ethernet=ethernet, hTTPPortNumber=hTTPPortNumber, masterSlaveMode=masterSlaveMode, vLANManagementVID=vLANManagementVID, versions=versions, sNTPSyncTrap=sNTPSyncTrap, systemClock=systemClock, dataPortStatusTrap=dataPortStatusTrap, alarmsGroup=alarmsGroup, resetGroup=resetGroup, softwareVersion=softwareVersion, sntp=sntp, dataPortAutoMdix=dataPortAutoMdix, telecom=telecom, managementGroup=managementGroup, regionCode=regionCode, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receiveChannel=receiveChannel, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelBandwidth=channelBandwidth, sNTPSync=sNTPSync, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomGroup=telecomGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitModulationMode=transmitModulationMode, sNMPPortNumber=sNMPPortNumber, userRole=userRole, syslogState=syslogState, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, targetMACAddress=targetMACAddress, bootVersion=bootVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, installStatus=installStatus, sNMPTrapPortNumber=sNMPTrapPortNumber, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqKHz=transmitFreqKHz, linkLoss=linkLoss, secondarySoftwareVersion=secondarySoftwareVersion, unitOutOfCalibration=unitOutOfCalibration, telnetPortNumber=telnetPortNumber, receiveDataRate=receiveDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, ethernetGroup=ethernetGroup, longitude=longitude, userTableNumber=userTableNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPEmailAlert=sMTPEmailAlert, telecomsInterface=telecomsInterface, receivePower=receivePower, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, wirelessLinkAvailability=wirelessLinkAvailability, userTableIndex=userTableIndex, licence=licence, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, alarms=alarms, sNTPServerPortNumber=sNTPServerPortNumber, tDDControlGroup=tDDControlGroup, dfsTableEntry=dfsTableEntry, vLANManagementPriority=vLANManagementPriority, userTableEntry=userTableEntry, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, snmpControl=snmpControl, altitude=altitude, snmpControlGroup=snmpControlGroup, userName=userName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, phyControl=phyControl, vectorError=vectorError, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDControl=tDDControl, accessMethod=accessMethod, signalStrengthRatio=signalStrengthRatio, wirelessLinkStatus=wirelessLinkStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, encryptionAlgorithm=encryptionAlgorithm, pubStats=pubStats, ptp500=ptp500, ptp=ptp, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatus=dataPortStatus, pubStatsGroup=pubStatsGroup, regionCodeTrap=regionCodeTrap, userEnabled=userEnabled, telecomsChannelStatusTrap=telecomsChannelStatusTrap, byteErrorRatio=byteErrorRatio, hTTPSAccessEnabled=hTTPSAccessEnabled, systemReset=systemReset, dfsTableIndex=dfsTableIndex, searchState=searchState, remoteIPAddress=remoteIPAddress, latitude=latitude, iPAddress=iPAddress, phyControlGroup=phyControlGroup, aggregateDataRate=aggregateDataRate, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPEnabledMessages=sMTPEnabledMessages, syslogControl=syslogControl, dfsGroup=dfsGroup, transmitChannel=transmitChannel, dataPortDisabledWarning=dataPortDisabledWarning, licenceGroup=licenceGroup)
