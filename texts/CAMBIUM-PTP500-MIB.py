...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, iso, Counter32, Gauge32, Unsigned32, TimeTicks, enterprises, ObjectIdentity, MibIdentifier, Integer32, IpAddress, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "iso", "Counter32", "Gauge32", "Unsigned32", "TimeTicks", "enterprises", "ObjectIdentity", "MibIdentifier", "Integer32", "IpAddress", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, maximumTransmitPower=maximumTransmitPower, managementGroup=managementGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, vLANManagementPriority=vLANManagementPriority, vLANPriorityTable=vLANPriorityTable, dfsTable=dfsTable, sNTPState=sNTPState, sNTPServerIPAddress=sNTPServerIPAddress, productName=productName, sNTPLastSync=sNTPLastSync, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configurationGroup=configurationGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, encryptionAlgorithm=encryptionAlgorithm, dataPortStatusTrap=dataPortStatusTrap, subnetMask=subnetMask, linkModeOptimizationMismatch=linkModeOptimizationMismatch, licensedCapacity=licensedCapacity, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ptp500=ptp500, sNMPPortNumber=sNMPPortNumber, regionCodeTrap=regionCodeTrap, sNTPPollInterval=sNTPPollInterval, sNTPSyncTrap=sNTPSyncTrap, ethernetFiberSupport=ethernetFiberSupport, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, receiveModulationModeDetail=receiveModulationModeDetail, bootVersion=bootVersion, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, softwareVersion=softwareVersion, sMTPEnabledMessages=sMTPEnabledMessages, hTTPPortNumber=hTTPPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemReset=systemReset, smtp=smtp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPAccessEnabled=hTTPAccessEnabled, ptpCompliance=ptpCompliance, linkName=linkName, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, siteName=siteName, phyStatusGroup=phyStatusGroup, unitOutOfCalibration=unitOutOfCalibration, sMTPEmailAlert=sMTPEmailAlert, channelBandwidth=channelBandwidth, wirelessLinkAvailability=wirelessLinkAvailability, cambium=cambium, pubStats=pubStats, hTTPSAccessEnabled=hTTPSAccessEnabled, sMTPSourceEmailAddress=sMTPSourceEmailAddress, masterSlaveMode=masterSlaveMode, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, linkModeOptimisation=linkModeOptimisation, sntpGroup=sntpGroup, sMTPServerIPAddress=sMTPServerIPAddress, snmpControlGroup=snmpControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogControlGroup=syslogControlGroup, sNMPTrapTable=sNMPTrapTable, supplementaryGroup=supplementaryGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, userTable=userTable, tDDControlGroup=tDDControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, encryption=encryption, dataPortStatus=dataPortStatus, telecomsLoopback=telecomsLoopback, licenceGroup=licenceGroup, dfsPeaks=dfsPeaks, configuration=configuration, sntp=sntp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, gatewayIPAddress=gatewayIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, ethernetGroup=ethernetGroup, range=range, licence=licence, supplementary=supplementary, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveModulationMode=receiveModulationMode, sNMPTrapIPAddress=sNMPTrapIPAddress, systemClock=systemClock, sNMPv3Enable=sNMPv3Enable, sMTPServerPortNumber=sMTPServerPortNumber, aggregateDataRate=aggregateDataRate, dfsTableEntry=dfsTableEntry, telecomsCableLength=telecomsCableLength, transmitDataRate=transmitDataRate, syslogClient=syslogClient, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsTableNumber=dfsTableNumber, telecomsChannelStatusTrap=telecomsChannelStatusTrap, snmpControl=snmpControl, hardwareVersion=hardwareVersion, secondarySoftwareVersion=secondarySoftwareVersion, installStatusTrap=installStatusTrap, ethernet=ethernet, sNMPCommunityString=sNMPCommunityString, telecomsLoopbackTrap=telecomsLoopbackTrap, bandwidthVariant=bandwidthVariant, ptpGroups=ptpGroups, vLANManagementVID=vLANManagementVID, linkSymmetry=linkSymmetry, telecom=telecom, daylightSaving=daylightSaving, versions=versions, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationAlarm=tDDSynchronizationAlarm, channelChangeTrap=channelChangeTrap, incompatibleRegionCodes=incompatibleRegionCodes, phyControlGroup=phyControlGroup, sNTPServerPortNumber=sNTPServerPortNumber, receiveDataRate=receiveDataRate, pubStatsGroup=pubStatsGroup, telecomsLineCode=telecomsLineCode, productVariant=productVariant, ptmp=ptmp, timeZone=timeZone, dataPortConfigurationMismatch=dataPortConfigurationMismatch, aAAControlGroup=aAAControlGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, longitude=longitude, notificationsGroup=notificationsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitFreqMHz=transmitFreqMHz, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatus=wirelessLinkStatus, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userEnabled=userEnabled, resetGroup=resetGroup, syslogStateTrap=syslogStateTrap, syslogClientTrap=syslogClientTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmState=installArmState, eIRP=eIRP, accessMethod=accessMethod, encryptionGroup=encryptionGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hTTPSPortNumber=hTTPSPortNumber, phyControl=phyControl, tDDControl=tDDControl, telecomGroup=telecomGroup, dataPortAutoMdix=dataPortAutoMdix, targetMACAddress=targetMACAddress, PYSNMP_MODULE_ID=cambium, userTableIndex=userTableIndex, userPassword=userPassword, tFTPServerIPAddress=tFTPServerIPAddress, alarmsGroup=alarmsGroup, versionsGroup=versionsGroup, sNMPTrapVersion=sNMPTrapVersion, remoteIPAddress=remoteIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, aAAControl=aAAControl, smtpGroup=smtpGroup, phyStatus=phyStatus, ptpTraps=ptpTraps, transmitModulationMode=transmitModulationMode, tDDSynchronizationStatus=tDDSynchronizationStatus, userName=userName, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, alarms=alarms, tFTPServerPortNumber=tFTPServerPortNumber, dfs=dfs, signalStrengthRatio=signalStrengthRatio, latitude=latitude, altitude=altitude, telnetPortNumber=telnetPortNumber, ptpTrapPrefix=ptpTrapPrefix, vLANPriorityTableIndex=vLANPriorityTableIndex, receivePower=receivePower, installStatus=installStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, vectorError=vectorError, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, searchState=searchState, userTableNumber=userTableNumber, tDDSynchronizationMode=tDDSynchronizationMode, receiveFreqKHz=receiveFreqKHz, linkLoss=linkLoss, userTableEntry=userTableEntry, telecomsChannelStatus=telecomsChannelStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitChannel=transmitChannel, userRole=userRole, management=management, syslogState=syslogState, syslogControl=syslogControl, dfsMeans=dfsMeans, receiveChannel=receiveChannel, sNTPSync=sNTPSync, iPAddress=iPAddress, capacityLicenseMismatch=capacityLicenseMismatch, groupID=groupID, cableLoss=cableLoss, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsGroup=dfsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitPower=transmitPower, installArmStateTrap=installArmStateTrap, dfsTableIndex=dfsTableIndex, ptp=ptp, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, regionCode=regionCode, byteErrorRatio=byteErrorRatio, reset=reset, antennaGain=antennaGain, telnetAccessEnabled=telnetAccessEnabled, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap)
