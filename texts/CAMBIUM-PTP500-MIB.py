...
# Produced by pysmi-1.1.3 at Sun Nov 21 13:48:34 2021
...
ObjectIdentity, ModuleIdentity, iso, Counter32, Integer32, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, TimeTicks, MibIdentifier, Bits, NotificationType, IpAddress, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "iso", "Counter32", "Integer32", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "TimeTicks", "MibIdentifier", "Bits", "NotificationType", "IpAddress", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", aAAControl=aAAControl, ptpTraps=ptpTraps, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTableEntry=dfsTableEntry, telecomsLoopbackTrap=telecomsLoopbackTrap, PYSNMP_MODULE_ID=cambium, gatewayIPAddress=gatewayIPAddress, management=management, phyControl=phyControl, systemReset=systemReset, userTable=userTable, sNMPTrapTableNumber=sNMPTrapTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, transmitChannel=transmitChannel, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPServerIPAddress=tFTPServerIPAddress, sNTPLastSync=sNTPLastSync, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sMTPEnabledMessages=sMTPEnabledMessages, subnetMask=subnetMask, telecomsChannelStatus=telecomsChannelStatus, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, transmitFreqKHz=transmitFreqKHz, incompatibleRegionCodes=incompatibleRegionCodes, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, supplementaryGroup=supplementaryGroup, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapTable=sNMPTrapTable, cambium=cambium, licence=licence, syslogControl=syslogControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, linkLoss=linkLoss, tDDSynchronizationStatus=tDDSynchronizationStatus, sMTPEmailAlert=sMTPEmailAlert, unitOutOfCalibration=unitOutOfCalibration, phyStatusGroup=phyStatusGroup, userTableEntry=userTableEntry, channelBandwidth=channelBandwidth, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPPortNumber=hTTPPortNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, systemClock=systemClock, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsGroup=dfsGroup, vLANManagementVID=vLANManagementVID, sNTPSyncTrap=sNTPSyncTrap, alarmsGroup=alarmsGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, smtp=smtp, snmpControlGroup=snmpControlGroup, licensedCapacity=licensedCapacity, masterSlaveMode=masterSlaveMode, telecomsInterface=telecomsInterface, syslogState=syslogState, supplementary=supplementary, resetGroup=resetGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, transmitDataRate=transmitDataRate, wirelessLinkAvailability=wirelessLinkAvailability, linkSymmetry=linkSymmetry, range=range, versions=versions, sNTPSync=sNTPSync, vLANPriorityTable=vLANPriorityTable, userPassword=userPassword, signalStrengthRatio=signalStrengthRatio, remoteMaximumTransmitPower=remoteMaximumTransmitPower, telecomsCableLength=telecomsCableLength, installArmState=installArmState, cableLoss=cableLoss, accessMethod=accessMethod, groupID=groupID, tFTPServerPortNumber=tFTPServerPortNumber, ptpGroups=ptpGroups, receiveFreqMHz=receiveFreqMHz, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortAutoMdix=dataPortAutoMdix, noWirelessChannelAvailable=noWirelessChannelAvailable, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomGroup=telecomGroup, configurationGroup=configurationGroup, latitude=latitude, vLANManagementPriority=vLANManagementPriority, vLANPriorityTableIndex=vLANPriorityTableIndex, channelChangeTrap=channelChangeTrap, transmitModulationMode=transmitModulationMode, syslogControlGroup=syslogControlGroup, installArmStateTrap=installArmStateTrap, userRole=userRole, telecomsLineCode=telecomsLineCode, sntpGroup=sntpGroup, longitude=longitude, telnetPortNumber=telnetPortNumber, sNMPTrapVersion=sNMPTrapVersion, syslogClient=syslogClient, sNTPState=sNTPState, softwareVersion=softwareVersion, ethernet=ethernet, smtpGroup=smtpGroup, versionsGroup=versionsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyControlGroup=phyControlGroup, receivePower=receivePower, tDDControlGroup=tDDControlGroup, dfsPeaks=dfsPeaks, pubStats=pubStats, daylightSaving=daylightSaving, encryption=encryption, transmitFreqMHz=transmitFreqMHz, aAAControlGroup=aAAControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveChannel=receiveChannel, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, productName=productName, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTableNumber=dfsTableNumber, maximumTransmitPower=maximumTransmitPower, bandwidthVariant=bandwidthVariant, sNMPTrapIPAddress=sNMPTrapIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, encryptionAlgorithm=encryptionAlgorithm, userEnabled=userEnabled, tDDControl=tDDControl, sNTPServerIPAddress=sNTPServerIPAddress, installStatus=installStatus, regionCodeTrap=regionCodeTrap, dfsMeans=dfsMeans, phyStatus=phyStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vectorError=vectorError, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStatsGroup=pubStatsGroup, dfsTable=dfsTable, sNTPPollInterval=sNTPPollInterval, encryptionGroup=encryptionGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPCommunityString=sNMPCommunityString, userTableIndex=userTableIndex, dfs=dfs, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, useVLANForManagementInterfaces=useVLANForManagementInterfaces, altitude=altitude, installStatusTrap=installStatusTrap, sntp=sntp, telecomsLoopback=telecomsLoopback, siteName=siteName, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqKHz=receiveFreqKHz, notificationsGroup=notificationsGroup, productVariant=productVariant, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, capacityLicenseMismatch=capacityLicenseMismatch, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableNumber=userTableNumber, hardwareVersion=hardwareVersion, reset=reset, receiveModulationMode=receiveModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptp500=ptp500, vLANPriorityTableEntry=vLANPriorityTableEntry, configuration=configuration, ptp=ptp, dataPortStatus=dataPortStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userName=userName, iPAddress=iPAddress, antennaGain=antennaGain, sNMPv3Enable=sNMPv3Enable, sNMPPortNumber=sNMPPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, frequencyVariant=frequencyVariant, ptmp=ptmp, syslogStateTrap=syslogStateTrap, managementGroup=managementGroup, syslogClientTrap=syslogClientTrap, eIRP=eIRP, linkModeOptimizationMismatch=linkModeOptimizationMismatch, regionCode=regionCode, targetMACAddress=targetMACAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTableIndex=dfsTableIndex, ethernetFiberSupport=ethernetFiberSupport, remoteIPAddress=remoteIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetGroup=ethernetGroup, aggregateDataRate=aggregateDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telnetAccessEnabled=telnetAccessEnabled, linkModeOptimisation=linkModeOptimisation, ptpTrapPrefix=ptpTrapPrefix, searchState=searchState, linkName=linkName, dataPortDisabledWarning=dataPortDisabledWarning, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dataPortStatusTrap=dataPortStatusTrap, byteErrorRatio=byteErrorRatio, dataPortWirelessDownAlert=dataPortWirelessDownAlert, alarms=alarms, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licenceGroup=licenceGroup, transmitPower=transmitPower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPEnabledTraps=sNMPEnabledTraps, telecom=telecom, tDDSynchronizationMode=tDDSynchronizationMode, timeZone=timeZone)
