...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sMTPEmailAlert=sMTPEmailAlert, receiveModulationMode=receiveModulationMode, secondarySoftwareVersion=secondarySoftwareVersion, syslogControl=syslogControl, frequencyVariant=frequencyVariant, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, cambium=cambium, dfsTable=dfsTable, sNTPSync=sNTPSync, receiveModulationModeDetail=receiveModulationModeDetail, sMTPServerIPAddress=sMTPServerIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, ptpCompliance=ptpCompliance, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPAccessEnabled=hTTPAccessEnabled, latitude=latitude, vLANPriorityTableNumber=vLANPriorityTableNumber, userTable=userTable, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsTableNumber=dfsTableNumber, antennaGain=antennaGain, longitude=longitude, sNMPTrapTable=sNMPTrapTable, dfsTableEntry=dfsTableEntry, daylightSaving=daylightSaving, dfs=dfs, regionCodeTrap=regionCodeTrap, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPPollInterval=sNTPPollInterval, phyStatus=phyStatus, ptpGroups=ptpGroups, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkName=linkName, ptmp=ptmp, pubStatsGroup=pubStatsGroup, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, gatewayIPAddress=gatewayIPAddress, searchState=searchState, configurationGroup=configurationGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, sNTPLastSync=sNTPLastSync, hardwareVersion=hardwareVersion, receiveChannel=receiveChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, remoteIPAddress=remoteIPAddress, softwareVersion=softwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsLoopbackTrap=telecomsLoopbackTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, range=range, iPAddress=iPAddress, licensedCapacity=licensedCapacity, dataPortConfigurationMismatch=dataPortConfigurationMismatch, licence=licence, telecomGroup=telecomGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptp500=ptp500, ptp=ptp, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, signalStrengthRatio=signalStrengthRatio, managementGroup=managementGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, receiveDataRate=receiveDataRate, sNTPServerPortNumber=sNTPServerPortNumber, sNMPv3Enable=sNMPv3Enable, telnetPortNumber=telnetPortNumber, dfsPeaks=dfsPeaks, altitude=altitude, dataPortWirelessDownAlert=dataPortWirelessDownAlert, notificationsGroup=notificationsGroup, telecomsLineCode=telecomsLineCode, groupID=groupID, bandwidthVariant=bandwidthVariant, transmitFreqKHz=transmitFreqKHz, wirelessLinkAvailability=wirelessLinkAvailability, phyStatusGroup=phyStatusGroup, transmitChannel=transmitChannel, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, syslogControlGroup=syslogControlGroup, configuration=configuration, encryptionAlgorithm=encryptionAlgorithm, userTableNumber=userTableNumber, userTableIndex=userTableIndex, alarmsGroup=alarmsGroup, siteName=siteName, receivePower=receivePower, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, smtpGroup=smtpGroup, sNTPState=sNTPState, syslogStateTrap=syslogStateTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDControl=tDDControl, snmpControlGroup=snmpControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sMTPEnabledMessages=sMTPEnabledMessages, dataPortStatus=dataPortStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControl=aAAControl, productName=productName, supplementary=supplementary, phyControl=phyControl, telecomsInterface=telecomsInterface, telecomsChannelStatus=telecomsChannelStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, accessMethod=accessMethod, tDDSynchronizationMode=tDDSynchronizationMode, sNMPPortNumber=sNMPPortNumber, linkModeOptimisation=linkModeOptimisation, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sntpGroup=sntpGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, linkSymmetry=linkSymmetry, dfsTableIndex=dfsTableIndex, hTTPPortNumber=hTTPPortNumber, alarms=alarms, installStatusTrap=installStatusTrap, userRole=userRole, sNTPServerIPAddress=sNTPServerIPAddress, ethernet=ethernet, useVLANForManagementInterfaces=useVLANForManagementInterfaces, dataPortDisabledWarning=dataPortDisabledWarning, telecomsLoopback=telecomsLoopback, byteErrorRatio=byteErrorRatio, telnetAccessEnabled=telnetAccessEnabled, transmitFreqMHz=transmitFreqMHz, ethernetGroup=ethernetGroup, unitOutOfCalibration=unitOutOfCalibration, bootVersion=bootVersion, sntp=sntp, sMTPSourceEmailAddress=sMTPSourceEmailAddress, reset=reset, eIRP=eIRP, sNTPSyncTrap=sNTPSyncTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogClient=syslogClient, transmitPower=transmitPower, snmpControl=snmpControl, vLANManagementVID=vLANManagementVID, productVariant=productVariant, installArmState=installArmState, ptpTraps=ptpTraps, encryptionGroup=encryptionGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, PYSNMP_MODULE_ID=cambium, aggregateDataRate=aggregateDataRate, userPassword=userPassword, cableLoss=cableLoss, dfsMeans=dfsMeans, installStatus=installStatus, timeZone=timeZone, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitModulationMode=transmitModulationMode, versionsGroup=versionsGroup, userTableEntry=userTableEntry, licenceGroup=licenceGroup, wirelessLinkStatus=wirelessLinkStatus, capacityLicenseMismatch=capacityLicenseMismatch, hTTPSPortNumber=hTTPSPortNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, dfsGroup=dfsGroup, smtp=smtp, sMTPServerPortNumber=sMTPServerPortNumber, regionCode=regionCode, sNMPCommunityString=sNMPCommunityString, transmitDataRate=transmitDataRate, aAAControlGroup=aAAControlGroup, syslogClientTrap=syslogClientTrap, telecom=telecom, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapTableNumber=sNMPTrapTableNumber, userEnabled=userEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, ptpTrapPrefix=ptpTrapPrefix, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, channelBandwidth=channelBandwidth, tDDControlGroup=tDDControlGroup, syslogState=syslogState, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, incompatibleRegionCodes=incompatibleRegionCodes, pubStats=pubStats, userName=userName, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsCableLength=telecomsCableLength, versions=versions, encryption=encryption, maximumTransmitPower=maximumTransmitPower, resetGroup=resetGroup, systemClock=systemClock, receiveFreqMHz=receiveFreqMHz, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, vLANManagementPriority=vLANManagementPriority, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, masterSlaveMode=masterSlaveMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, phyControlGroup=phyControlGroup, vLANPriorityTable=vLANPriorityTable, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, targetMACAddress=targetMACAddress, channelChangeTrap=channelChangeTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, supplementaryGroup=supplementaryGroup, sNMPTrapVersion=sNMPTrapVersion, systemReset=systemReset, vectorError=vectorError, management=management, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkLoss=linkLoss, receiveFreqKHz=receiveFreqKHz, subnetMask=subnetMask, installArmStateTrap=installArmStateTrap)
