...
enterprises, Gauge32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Unsigned32, iso, IpAddress, NotificationType, Bits, Counter64, ModuleIdentity, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "Gauge32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Unsigned32", "iso", "IpAddress", "NotificationType", "Bits", "Counter64", "ModuleIdentity", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, PYSNMP_MODULE_ID=cambium, enabledDiagnosticAlarms=enabledDiagnosticAlarms, resetGroup=resetGroup, transmitFreqKHz=transmitFreqKHz, tFTPServerPortNumber=tFTPServerPortNumber, userRole=userRole, dfsPeaks=dfsPeaks, antennaGain=antennaGain, productName=productName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkName=linkName, sNMPEnabledTraps=sNMPEnabledTraps, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveDataRate=receiveDataRate, sNMPv3Enable=sNMPv3Enable, sNMPTrapIPAddress=sNMPTrapIPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfsTable=dfsTable, incompatibleRegionCodes=incompatibleRegionCodes, vLANManagementVID=vLANManagementVID, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, vLANManagementPriority=vLANManagementPriority, telecomsChannelStatus=telecomsChannelStatus, dfsGroup=dfsGroup, pubStats=pubStats, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPSyncTrap=sNTPSyncTrap, vectorError=vectorError, alarms=alarms, sntp=sntp, maximumTransmitPower=maximumTransmitPower, linkModeOptimisation=linkModeOptimisation, sNTPPollInterval=sNTPPollInterval, snmpControl=snmpControl, channelBandwidth=channelBandwidth, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpTrapPrefix=ptpTrapPrefix, installArmStateTrap=installArmStateTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licence=licence, linkLoss=linkLoss, installStatusTrap=installStatusTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, longitude=longitude, receiveFreqMHz=receiveFreqMHz, telecomsLoopbackTrap=telecomsLoopbackTrap, phyControlGroup=phyControlGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, wirelessLinkStatus=wirelessLinkStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfs=dfs, syslogStateTrap=syslogStateTrap, altitude=altitude, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTableEntry=sNMPTrapTableEntry, notificationsGroup=notificationsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, hardwareVersion=hardwareVersion, sMTPServerPortNumber=sMTPServerPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, byteErrorRatio=byteErrorRatio, dataPortAutoNegotiation=dataPortAutoNegotiation, sNTPSync=sNTPSync, wirelessLinkAvailability=wirelessLinkAvailability, dataPortStatusTrap=dataPortStatusTrap, searchState=searchState, sNTPServerPortNumber=sNTPServerPortNumber, ptp=ptp, accessMethod=accessMethod, encryptionAlgorithm=encryptionAlgorithm, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, alarmsGroup=alarmsGroup, smtpGroup=smtpGroup, sNMPTrapTable=sNMPTrapTable, transmitChannel=transmitChannel, linkModeOptimizationMismatch=linkModeOptimizationMismatch, transmitDataRate=transmitDataRate, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapTableNumber=sNMPTrapTableNumber, installArmState=installArmState, unitOutOfCalibration=unitOutOfCalibration, transmitFreqMHz=transmitFreqMHz, bandwidthVariant=bandwidthVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDControlGroup=tDDControlGroup, configuration=configuration, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telnetAccessEnabled=telnetAccessEnabled, vLANPriorityTableNumber=vLANPriorityTableNumber, sntpGroup=sntpGroup, supplementary=supplementary, cableLoss=cableLoss, hTTPPortNumber=hTTPPortNumber, linkSymmetry=linkSymmetry, signalStrengthRatio=signalStrengthRatio, syslogClientTrap=syslogClientTrap, ptpTraps=ptpTraps, constantPowerSpectralDensity=constantPowerSpectralDensity, reset=reset, capacityLicenseMismatch=capacityLicenseMismatch, masterSlaveMode=masterSlaveMode, dataPortDisabledWarning=dataPortDisabledWarning, sNMPCommunityString=sNMPCommunityString, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsTableEntry=dfsTableEntry, dataPortAutoMdix=dataPortAutoMdix, telecomsLineCode=telecomsLineCode, systemClock=systemClock, dfsTableNumber=dfsTableNumber, receiveModulationMode=receiveModulationMode, channelChangeTrap=channelChangeTrap, sNTPState=sNTPState, phyControl=phyControl, userEnabled=userEnabled, snmpControlGroup=snmpControlGroup, ethernet=ethernet, ptmp=ptmp, dfsMeans=dfsMeans, gatewayIPAddress=gatewayIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, syslogControlGroup=syslogControlGroup, versions=versions, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, secondarySoftwareVersion=secondarySoftwareVersion, userPassword=userPassword, ptpGroups=ptpGroups, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityTable=vLANPriorityTable, hTTPSPortNumber=hTTPSPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, regionCode=regionCode, ethernetGroup=ethernetGroup, management=management, sNTPServerIPAddress=sNTPServerIPAddress, regionCodeTrap=regionCodeTrap, systemReset=systemReset, daylightSaving=daylightSaving, licenceGroup=licenceGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, hTTPAccessEnabled=hTTPAccessEnabled, range=range, ptpCompliance=ptpCompliance, phyStatusGroup=phyStatusGroup, receiveChannel=receiveChannel, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, timeZone=timeZone, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, pubStatsGroup=pubStatsGroup, aAAControlGroup=aAAControlGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, groupID=groupID, telecom=telecom, useVLANForManagementInterfaces=useVLANForManagementInterfaces, remoteIPAddress=remoteIPAddress, siteName=siteName, smtp=smtp, supplementaryGroup=supplementaryGroup, configurationGroup=configurationGroup, userTableIndex=userTableIndex, syslogState=syslogState, sNTPLastSync=sNTPLastSync, encryptionGroup=encryptionGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, encryption=encryption, latitude=latitude, tDDSynchronizationStatus=tDDSynchronizationStatus, bootVersion=bootVersion, ptp500=ptp500, dataPortStatus=dataPortStatus, transmitModulationMode=transmitModulationMode, versionsGroup=versionsGroup, sNMPPortNumber=sNMPPortNumber, aggregateDataRate=aggregateDataRate, userName=userName, telecomGroup=telecomGroup, syslogClient=syslogClient, ethernetFiberSupport=ethernetFiberSupport, userTableNumber=userTableNumber, productVariant=productVariant, iPAddress=iPAddress, managementGroup=managementGroup, subnetMask=subnetMask, dfsTableIndex=dfsTableIndex, telecomsInterface=telecomsInterface, installStatus=installStatus, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, frequencyVariant=frequencyVariant, telecomsLoopback=telecomsLoopback, telecomsCableLength=telecomsCableLength, licensedCapacity=licensedCapacity, eIRP=eIRP, cambium=cambium, aAAControl=aAAControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetPortNumber=telnetPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, sMTPServerIPAddress=sMTPServerIPAddress, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogControl=syslogControl, sNMPTrapVersion=sNMPTrapVersion, softwareVersion=softwareVersion, userTableEntry=userTableEntry, userTable=userTable, tFTPServerIPAddress=tFTPServerIPAddress, sMTPEmailAlert=sMTPEmailAlert, targetMACAddress=targetMACAddress, tDDControl=tDDControl, receivePower=receivePower, transmitPower=transmitPower, receiveFreqKHz=receiveFreqKHz)
