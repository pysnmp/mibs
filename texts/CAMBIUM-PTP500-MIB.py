...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, enterprises, Bits, Counter32, iso, Unsigned32, Gauge32, ObjectIdentity, Integer32, ModuleIdentity, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "enterprises", "Bits", "Counter32", "iso", "Unsigned32", "Gauge32", "ObjectIdentity", "Integer32", "ModuleIdentity", "MibIdentifier", "NotificationType")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", userTableNumber=userTableNumber, receiveChannel=receiveChannel, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, transmitChannel=transmitChannel, ptpTraps=ptpTraps, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPv3Enable=sNMPv3Enable, remoteIPAddress=remoteIPAddress, smtp=smtp, channelChangeTrap=channelChangeTrap, sNTPPollInterval=sNTPPollInterval, syslogControl=syslogControl, vLANManagementVID=vLANManagementVID, sNTPLastSync=sNTPLastSync, ethernetGroup=ethernetGroup, maximumTransmitPower=maximumTransmitPower, receiveModulationMode=receiveModulationMode, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitPower=transmitPower, iPAddress=iPAddress, secondarySoftwareVersion=secondarySoftwareVersion, receivePower=receivePower, sNTPServerPortNumber=sNTPServerPortNumber, accessMethod=accessMethod, supplementary=supplementary, ptpTrapPrefix=ptpTrapPrefix, dataPortStatus=dataPortStatus, bandwidthVariant=bandwidthVariant, sNMPCommunityString=sNMPCommunityString, latitude=latitude, phyStatus=phyStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, productName=productName, hTTPSPortNumber=hTTPSPortNumber, sNTPState=sNTPState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, licenceGroup=licenceGroup, tFTPServerPortNumber=tFTPServerPortNumber, ethernet=ethernet, ptpGroups=ptpGroups, linkSymmetry=linkSymmetry, receiveModulationModeDetail=receiveModulationModeDetail, syslogControlGroup=syslogControlGroup, dfsTableNumber=dfsTableNumber, userRole=userRole, versions=versions, syslogClient=syslogClient, dataPortWirelessDownAlert=dataPortWirelessDownAlert, bootVersion=bootVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitDataRate=transmitDataRate, encryptionAlgorithm=encryptionAlgorithm, PYSNMP_MODULE_ID=cambium, sMTPServerPortNumber=sMTPServerPortNumber, telecomsLoopback=telecomsLoopback, wirelessLinkStatus=wirelessLinkStatus, telnetAccessEnabled=telnetAccessEnabled, userEnabled=userEnabled, pubStats=pubStats, dataPortDisabledWarning=dataPortDisabledWarning, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sntp=sntp, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsMeans=dfsMeans, sNMPPortNumber=sNMPPortNumber, alarmsGroup=alarmsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationMode=tDDSynchronizationMode, configurationGroup=configurationGroup, dfsTable=dfsTable, dfsTableIndex=dfsTableIndex, subnetMask=subnetMask, vLANPriorityTableIndex=vLANPriorityTableIndex, userPassword=userPassword, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsInterface=telecomsInterface, sNMPEnabledTraps=sNMPEnabledTraps, linkLoss=linkLoss, linkModeOptimizationMismatch=linkModeOptimizationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, hTTPAccessEnabled=hTTPAccessEnabled, userName=userName, noWirelessChannelAvailable=noWirelessChannelAvailable, groupID=groupID, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, gatewayIPAddress=gatewayIPAddress, licensedCapacity=licensedCapacity, transmitModulationMode=transmitModulationMode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogClientTrap=syslogClientTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, pubStatsGroup=pubStatsGroup, dfsPeaks=dfsPeaks, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, snmpControlGroup=snmpControlGroup, wirelessLinkAvailability=wirelessLinkAvailability, hardwareVersion=hardwareVersion, licence=licence, dfsTableEntry=dfsTableEntry, cableLoss=cableLoss, encryption=encryption, phyControlGroup=phyControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsChannelStatusTrap=telecomsChannelStatusTrap, systemClock=systemClock, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsLineCode=telecomsLineCode, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, unitOutOfCalibration=unitOutOfCalibration, sNTPSyncTrap=sNTPSyncTrap, hTTPPortNumber=hTTPPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, linkModeOptimisation=linkModeOptimisation, alarms=alarms, telecomGroup=telecomGroup, encryptionGroup=encryptionGroup, range=range, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, ptmp=ptmp, transmitFreqMHz=transmitFreqMHz, telecomsChannelStatus=telecomsChannelStatus, userTableIndex=userTableIndex, ptpCompliance=ptpCompliance, phyControl=phyControl, telecom=telecom, configuration=configuration, siteName=siteName, regionCode=regionCode, sNMPTrapPortNumber=sNMPTrapPortNumber, daylightSaving=daylightSaving, supplementaryGroup=supplementaryGroup, aAAControl=aAAControl, searchState=searchState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, systemReset=systemReset, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDControl=tDDControl, receiveFreqMHz=receiveFreqMHz, vectorError=vectorError, sntpGroup=sntpGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dfs=dfs, sMTPEmailAlert=sMTPEmailAlert, cambium=cambium, reset=reset, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installArmStateTrap=installArmStateTrap, smtpGroup=smtpGroup, timeZone=timeZone, sNMPTrapVersion=sNMPTrapVersion, altitude=altitude, phyStatusGroup=phyStatusGroup, management=management, tDDSynchronizationAlarm=tDDSynchronizationAlarm, regionCodeTrap=regionCodeTrap, versionsGroup=versionsGroup, ptp500=ptp500, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogState=syslogState, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPEnabledMessages=sMTPEnabledMessages, installStatus=installStatus, snmpControl=snmpControl, ethernetFiberSupport=ethernetFiberSupport, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTableEntry=userTableEntry, antennaGain=antennaGain, vLANPriorityTable=vLANPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANManagementPriority=vLANManagementPriority, telecomsCableLength=telecomsCableLength, productVariant=productVariant, byteErrorRatio=byteErrorRatio, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, eIRP=eIRP, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogStateTrap=syslogStateTrap, sNTPServerIPAddress=sNTPServerIPAddress, resetGroup=resetGroup, sNMPTrapTable=sNMPTrapTable, userTable=userTable, dataPortAutoMdix=dataPortAutoMdix, telnetPortNumber=telnetPortNumber, ptp=ptp, receiveDataRate=receiveDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, receiveFreqKHz=receiveFreqKHz, channelBandwidth=channelBandwidth, installArmState=installArmState, softwareVersion=softwareVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, aAAControlGroup=aAAControlGroup, longitude=longitude, incompatibleRegionCodes=incompatibleRegionCodes, managementGroup=managementGroup, dfsGroup=dfsGroup, targetMACAddress=targetMACAddress, capacityLicenseMismatch=capacityLicenseMismatch, signalStrengthRatio=signalStrengthRatio, linkName=linkName, frequencyVariant=frequencyVariant, sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, tDDControlGroup=tDDControlGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPSync=sNTPSync, installStatusTrap=installStatusTrap)
