...
ModuleIdentity, enterprises, TimeTicks, Unsigned32, Bits, Gauge32, iso, Counter32, Counter64, MibIdentifier, ObjectIdentity, IpAddress, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "TimeTicks", "Unsigned32", "Bits", "Gauge32", "iso", "Counter32", "Counter64", "MibIdentifier", "ObjectIdentity", "IpAddress", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vLANManagementVID=vLANManagementVID, ptp500=ptp500, channelBandwidth=channelBandwidth, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, aAAControlGroup=aAAControlGroup, dfsTable=dfsTable, resetGroup=resetGroup, phyStatus=phyStatus, syslogState=syslogState, versionsGroup=versionsGroup, antennaGain=antennaGain, ethernetGroup=ethernetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, userTable=userTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitDataRate=transmitDataRate, telecom=telecom, tFTPServerIPAddress=tFTPServerIPAddress, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkSymmetry=linkSymmetry, masterSlaveMode=masterSlaveMode, dfsPeaks=dfsPeaks, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, sntpGroup=sntpGroup, hardwareVersion=hardwareVersion, encryptionGroup=encryptionGroup, ptpCompliance=ptpCompliance, pubStatsGroup=pubStatsGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, maximumTransmitPower=maximumTransmitPower, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, supplementaryGroup=supplementaryGroup, vLANManagementPriority=vLANManagementPriority, telecomGroup=telecomGroup, phyControl=phyControl, systemClock=systemClock, latitude=latitude, licensedCapacity=licensedCapacity, tDDControlGroup=tDDControlGroup, wirelessLinkStatus=wirelessLinkStatus, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, regionCode=regionCode, alarms=alarms, userName=userName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, configuration=configuration, aAAControl=aAAControl, dfsTableEntry=dfsTableEntry, dataPortStatusTrap=dataPortStatusTrap, tDDControl=tDDControl, longitude=longitude, licenceGroup=licenceGroup, userTableEntry=userTableEntry, subnetMask=subnetMask, telnetAccessEnabled=telnetAccessEnabled, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sMTPEnabledMessages=sMTPEnabledMessages, pubStats=pubStats, dataPortWirelessDownAlert=dataPortWirelessDownAlert, smtp=smtp, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPPollInterval=sNTPPollInterval, sNTPLastSync=sNTPLastSync, installArmState=installArmState, phyControlGroup=phyControlGroup, frequencyVariant=frequencyVariant, hTTPSPortNumber=hTTPSPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, managementGroup=managementGroup, dfsTableNumber=dfsTableNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, userTableNumber=userTableNumber, cambium=cambium, transmitModulationMode=transmitModulationMode, receiveFreqKHz=receiveFreqKHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, signalStrengthRatio=signalStrengthRatio, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sNMPTrapVersion=sNMPTrapVersion, encryptionAlgorithm=encryptionAlgorithm, telecomsLoopback=telecomsLoopback, linkLoss=linkLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, dfs=dfs, dfsMeans=dfsMeans, dataPortConfigurationMismatch=dataPortConfigurationMismatch, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sntp=sntp, sNTPSyncTrap=sNTPSyncTrap, bandwidthVariant=bandwidthVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, licence=licence, userPassword=userPassword, installStatusTrap=installStatusTrap, syslogClientTrap=syslogClientTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPSync=sNTPSync, userTableIndex=userTableIndex, syslogStateTrap=syslogStateTrap, reset=reset, eIRP=eIRP, daylightSaving=daylightSaving, productName=productName, vLANPriorityTableEntry=vLANPriorityTableEntry, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPCommunityString=sNMPCommunityString, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPPortNumber=hTTPPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, accessMethod=accessMethod, dataPortStatus=dataPortStatus, snmpControlGroup=snmpControlGroup, supplementary=supplementary, telecomsLineCode=telecomsLineCode, receiveDataRate=receiveDataRate, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkAvailability=wirelessLinkAvailability, range=range, unitOutOfCalibration=unitOutOfCalibration, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, aggregateDataRate=aggregateDataRate, channelChangeTrap=channelChangeTrap, dataPortAutoMdix=dataPortAutoMdix, groupID=groupID, syslogClient=syslogClient, installArmStateTrap=installArmStateTrap, receiveChannel=receiveChannel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpTraps=ptpTraps, snmpControl=snmpControl, PYSNMP_MODULE_ID=cambium, tDDSynchronizationMode=tDDSynchronizationMode, encryption=encryption, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, syslogControl=syslogControl, systemReset=systemReset, sNMPPortNumber=sNMPPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, syslogControlGroup=syslogControlGroup, vLANPriorityTable=vLANPriorityTable, sNMPv3Enable=sNMPv3Enable, sNTPServerPortNumber=sNTPServerPortNumber, sNTPState=sNTPState, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, sNMPEnabledTraps=sNMPEnabledTraps, secondarySoftwareVersion=secondarySoftwareVersion, ptpTrapPrefix=ptpTrapPrefix, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versions=versions, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, productVariant=productVariant, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkModeOptimisation=linkModeOptimisation, dfsTableIndex=dfsTableIndex, telnetPortNumber=telnetPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelStatus=telecomsChannelStatus, transmitFreqKHz=transmitFreqKHz, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitChannel=transmitChannel, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegionCodes=incompatibleRegionCodes, iPAddress=iPAddress, receiveModulationMode=receiveModulationMode, installStatus=installStatus, searchState=searchState, receiveFreqMHz=receiveFreqMHz, byteErrorRatio=byteErrorRatio, configurationGroup=configurationGroup, bootVersion=bootVersion, smtpGroup=smtpGroup, telecomsInterface=telecomsInterface, receivePower=receivePower, regionCodeTrap=regionCodeTrap, phyStatusGroup=phyStatusGroup, sMTPServerIPAddress=sMTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANPriorityTableIndex=vLANPriorityTableIndex, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, ethernet=ethernet, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsGroup=dfsGroup, targetMACAddress=targetMACAddress, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, ptpGroups=ptpGroups, capacityLicenseMismatch=capacityLicenseMismatch, siteName=siteName, dataPortDisabledWarning=dataPortDisabledWarning, vectorError=vectorError, notificationsGroup=notificationsGroup, transmitFreqMHz=transmitFreqMHz, softwareVersion=softwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, cableLoss=cableLoss, hTTPAccessEnabled=hTTPAccessEnabled, alarmsGroup=alarmsGroup, management=management, linkName=linkName, transmitPower=transmitPower, remoteIPAddress=remoteIPAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, altitude=altitude, userRole=userRole, gatewayIPAddress=gatewayIPAddress, ptp=ptp, sNMPTrapTable=sNMPTrapTable, telecomsCableLength=telecomsCableLength)
