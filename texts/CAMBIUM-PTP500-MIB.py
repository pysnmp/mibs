...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", bandwidthVariant=bandwidthVariant, versionsGroup=versionsGroup, managementGroup=managementGroup, receiveChannel=receiveChannel, transmitPower=transmitPower, installStatus=installStatus, altitude=altitude, configuration=configuration, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, latitude=latitude, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, groupID=groupID, vLANManagementPriority=vLANManagementPriority, incompatibleMasterAndSlave=incompatibleMasterAndSlave, installStatusTrap=installStatusTrap, masterSlaveMode=masterSlaveMode, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, sMTPServerPortNumber=sMTPServerPortNumber, management=management, phyControl=phyControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogState=syslogState, ptp500=ptp500, vectorError=vectorError, syslogControl=syslogControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsPeaks=dfsPeaks, capacityLicenseMismatch=capacityLicenseMismatch, pubStats=pubStats, syslogControlGroup=syslogControlGroup, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPPortNumber=hTTPPortNumber, ptpGroups=ptpGroups, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, reset=reset, sMTPEnabledMessages=sMTPEnabledMessages, dfsMeans=dfsMeans, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitFreqKHz=transmitFreqKHz, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, systemClock=systemClock, userRole=userRole, remoteIPAddress=remoteIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNTPSyncTrap=sNTPSyncTrap, linkName=linkName, tFTPServerPortNumber=tFTPServerPortNumber, targetMACAddress=targetMACAddress, installArmState=installArmState, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, vLANManagementVID=vLANManagementVID, dfsTable=dfsTable, licence=licence, vLANPriorityTableIndex=vLANPriorityTableIndex, receiveModulationMode=receiveModulationMode, ethernetFiberSupport=ethernetFiberSupport, telecomsCableLength=telecomsCableLength, userPassword=userPassword, signalStrengthRatio=signalStrengthRatio, vLANPriorityTable=vLANPriorityTable, tDDControl=tDDControl, smtpGroup=smtpGroup, subnetMask=subnetMask, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernetGroup=ethernetGroup, sNMPCommunityString=sNMPCommunityString, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodes=incompatibleRegionCodes, sNMPEnabledTraps=sNMPEnabledTraps, iPAddress=iPAddress, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versions=versions, configurationGroup=configurationGroup, sNTPSync=sNTPSync, telecomsChannelStatus=telecomsChannelStatus, sNMPTrapTable=sNMPTrapTable, regionCode=regionCode, transmitFreqMHz=transmitFreqMHz, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTable=userTable, softwareVersion=softwareVersion, syslogStateTrap=syslogStateTrap, dfsTableIndex=dfsTableIndex, sNTPLastSync=sNTPLastSync, dataPortStatus=dataPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtp=smtp, sNMPv3Enable=sNMPv3Enable, receiveDataRate=receiveDataRate, cambium=cambium, bootVersion=bootVersion, ethernet=ethernet, phyControlGroup=phyControlGroup, siteName=siteName, installArmStateTrap=installArmStateTrap, telecomsLoopback=telecomsLoopback, licenceGroup=licenceGroup, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, alarms=alarms, wirelessLinkAvailability=wirelessLinkAvailability, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, antennaGain=antennaGain, dfs=dfs, sNMPPortNumber=sNMPPortNumber, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPEmailAlert=sMTPEmailAlert, sntp=sntp, receiveFreqKHz=receiveFreqKHz, userEnabled=userEnabled, sntpGroup=sntpGroup, dfsTableEntry=dfsTableEntry, telnetPortNumber=telnetPortNumber, unitOutOfCalibration=unitOutOfCalibration, encryption=encryption, telecom=telecom, receiveFreqMHz=receiveFreqMHz, userTableEntry=userTableEntry, dataPortAutoNegotiation=dataPortAutoNegotiation, channelChangeTrap=channelChangeTrap, hTTPSPortNumber=hTTPSPortNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapIPAddress=sNMPTrapIPAddress, sNTPPollInterval=sNTPPollInterval, timeZone=timeZone, dfsGroup=dfsGroup, dataPortAutoMdix=dataPortAutoMdix, systemReset=systemReset, vLANPriorityTableNumber=vLANPriorityTableNumber, hardwareVersion=hardwareVersion, secondarySoftwareVersion=secondarySoftwareVersion, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortStatusTrap=dataPortStatusTrap, syslogClientTrap=syslogClientTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, remoteMaximumTransmitPower=remoteMaximumTransmitPower, phyStatus=phyStatus, tDDControlGroup=tDDControlGroup, longitude=longitude, productVariant=productVariant, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, aAAControlGroup=aAAControlGroup, phyStatusGroup=phyStatusGroup, snmpControlGroup=snmpControlGroup, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, gatewayIPAddress=gatewayIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, sNTPState=sNTPState, userTableIndex=userTableIndex, linkSymmetry=linkSymmetry, ptpTraps=ptpTraps, ptpCompliance=ptpCompliance, dfsTableNumber=dfsTableNumber, accessMethod=accessMethod, byteErrorRatio=byteErrorRatio, sNMPTrapTableNumber=sNMPTrapTableNumber, regionCodeTrap=regionCodeTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userName=userName, wirelessLinkStatus=wirelessLinkStatus, ptp=ptp, notificationsGroup=notificationsGroup, userTableNumber=userTableNumber, syslogClient=syslogClient, sMTPServerIPAddress=sMTPServerIPAddress, encryptionAlgorithm=encryptionAlgorithm, pubStatsGroup=pubStatsGroup, eIRP=eIRP, sNTPServerIPAddress=sNTPServerIPAddress, telecomsLineCode=telecomsLineCode, aAAControl=aAAControl, alarmsGroup=alarmsGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, linkModeOptimisation=linkModeOptimisation, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licensedCapacity=licensedCapacity, range=range, tDDSynchronizationStatus=tDDSynchronizationStatus, frequencyVariant=frequencyVariant, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, channelBandwidth=channelBandwidth, productName=productName, sNTPServerPortNumber=sNTPServerPortNumber, resetGroup=resetGroup, encryptionGroup=encryptionGroup, hTTPAccessEnabled=hTTPAccessEnabled, supplementaryGroup=supplementaryGroup, cableLoss=cableLoss, snmpControl=snmpControl, transmitModulationMode=transmitModulationMode, telecomGroup=telecomGroup, tFTPServerIPAddress=tFTPServerIPAddress, aggregateDataRate=aggregateDataRate, telecomsInterface=telecomsInterface, supplementary=supplementary, daylightSaving=daylightSaving, receiveModulationModeDetail=receiveModulationModeDetail, PYSNMP_MODULE_ID=cambium, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ptmp=ptmp, receivePower=receivePower, ptpTrapPrefix=ptpTrapPrefix, linkLoss=linkLoss, vLANPriorityTableEntry=vLANPriorityTableEntry)
