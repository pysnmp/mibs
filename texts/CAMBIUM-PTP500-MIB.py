...
Unsigned32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, TimeTicks, Gauge32, ObjectIdentity, enterprises, ModuleIdentity, iso, Bits, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "TimeTicks", "Gauge32", "ObjectIdentity", "enterprises", "ModuleIdentity", "iso", "Bits", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, systemReset=systemReset, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, sNTPServerIPAddress=sNTPServerIPAddress, maximumTransmitPower=maximumTransmitPower, dataPortWirelessDownAlert=dataPortWirelessDownAlert, frequencyVariant=frequencyVariant, vectorError=vectorError, snmpControl=snmpControl, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, regionCodeTrap=regionCodeTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryption=encryption, noWirelessChannelAvailable=noWirelessChannelAvailable, pubStats=pubStats, productName=productName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, versionsGroup=versionsGroup, userEnabled=userEnabled, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimisation=linkModeOptimisation, dfsTable=dfsTable, unitOutOfCalibration=unitOutOfCalibration, licence=licence, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveFreqKHz=receiveFreqKHz, dfsTableNumber=dfsTableNumber, sNMPTrapVersion=sNMPTrapVersion, telecomsLoopbackTrap=telecomsLoopbackTrap, installStatusTrap=installStatusTrap, aAAControlGroup=aAAControlGroup, altitude=altitude, gatewayIPAddress=gatewayIPAddress, eIRP=eIRP, hardwareVersion=hardwareVersion, latitude=latitude, sNMPv3Enable=sNMPv3Enable, configurationGroup=configurationGroup, dfsTableEntry=dfsTableEntry, notificationsGroup=notificationsGroup, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, hTTPSAccessEnabled=hTTPSAccessEnabled, ptpTraps=ptpTraps, linkLoss=linkLoss, siteName=siteName, ptp500=ptp500, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, sNMPPortNumber=sNMPPortNumber, searchState=searchState, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, signalStrengthRatio=signalStrengthRatio, encryptionGroup=encryptionGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, regionCode=regionCode, smtpGroup=smtpGroup, sntp=sntp, daylightSaving=daylightSaving, tDDSynchronizationStatus=tDDSynchronizationStatus, alarmsGroup=alarmsGroup, userPassword=userPassword, telecomsInterface=telecomsInterface, tDDSynchronizationAlarm=tDDSynchronizationAlarm, transmitDataRate=transmitDataRate, targetMACAddress=targetMACAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, accessMethod=accessMethod, telecomsChannelStatus=telecomsChannelStatus, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, configuration=configuration, telecomsCableLength=telecomsCableLength, sNTPSyncTrap=sNTPSyncTrap, aggregateDataRate=aggregateDataRate, userRole=userRole, userTable=userTable, productVariant=productVariant, wirelessLinkStatus=wirelessLinkStatus, sNMPTrapTable=sNMPTrapTable, cambium=cambium, incompatibleMasterAndSlave=incompatibleMasterAndSlave, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, installStatus=installStatus, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatch=capacityLicenseMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hTTPPortNumber=hTTPPortNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch, iPAddress=iPAddress, syslogClientTrap=syslogClientTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsMeans=dfsMeans, timeZone=timeZone, management=management, telecomGroup=telecomGroup, antennaGain=antennaGain, encryptionAlgorithm=encryptionAlgorithm, receiveChannel=receiveChannel, ptpGroups=ptpGroups, phyStatusGroup=phyStatusGroup, dataPortDisabledWarning=dataPortDisabledWarning, dfsPeaks=dfsPeaks, syslogControlGroup=syslogControlGroup, ptpTrapPrefix=ptpTrapPrefix, syslogClient=syslogClient, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDControl=tDDControl, sNTPServerPortNumber=sNTPServerPortNumber, userName=userName, snmpControlGroup=snmpControlGroup, vLANManagementVID=vLANManagementVID, userTableNumber=userTableNumber, resetGroup=resetGroup, phyControl=phyControl, installArmState=installArmState, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, bandwidthVariant=bandwidthVariant, transmitPower=transmitPower, transmitModulationMode=transmitModulationMode, telecomsLineCode=telecomsLineCode, telnetPortNumber=telnetPortNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, systemClock=systemClock, ethernet=ethernet, vLANPriorityTableEntry=vLANPriorityTableEntry, dfs=dfs, receiveFreqMHz=receiveFreqMHz, dataPortStatus=dataPortStatus, useVLANForManagementInterfaces=useVLANForManagementInterfaces, tFTPServerPortNumber=tFTPServerPortNumber, range=range, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableEntry=userTableEntry, longitude=longitude, managementGroup=managementGroup, linkSymmetry=linkSymmetry, telnetAccessEnabled=telnetAccessEnabled, dfsTableIndex=dfsTableIndex, syslogState=syslogState, PYSNMP_MODULE_ID=cambium, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitFreqKHz=transmitFreqKHz, softwareVersion=softwareVersion, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, syslogControl=syslogControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegionCodes=incompatibleRegionCodes, receiveDataRate=receiveDataRate, licensedCapacity=licensedCapacity, hTTPAccessEnabled=hTTPAccessEnabled, byteErrorRatio=byteErrorRatio, secondarySoftwareVersion=secondarySoftwareVersion, sNTPState=sNTPState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortStatusTrap=dataPortStatusTrap, ethernetFiberSupport=ethernetFiberSupport, groupID=groupID, dfsGroup=dfsGroup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDControlGroup=tDDControlGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortAutoNegotiation=dataPortAutoNegotiation, licenceGroup=licenceGroup, sNTPLastSync=sNTPLastSync, smtp=smtp, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, supplementary=supplementary, subnetMask=subnetMask, installArmStateTrap=installArmStateTrap, supplementaryGroup=supplementaryGroup, telecom=telecom, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, receivePower=receivePower, ptpCompliance=ptpCompliance, transmitFreqMHz=transmitFreqMHz, receiveModulationModeDetail=receiveModulationModeDetail, phyStatus=phyStatus, dataPortAutoMdix=dataPortAutoMdix, masterSlaveMode=masterSlaveMode, sMTPServerIPAddress=sMTPServerIPAddress, sntpGroup=sntpGroup, pubStatsGroup=pubStatsGroup, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkAvailability=wirelessLinkAvailability, telecomsLoopback=telecomsLoopback, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userTableIndex=userTableIndex, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, channelBandwidth=channelBandwidth, aAAControl=aAAControl, vLANPriorityTableIndex=vLANPriorityTableIndex, phyControlGroup=phyControlGroup, versions=versions, ethernetGroup=ethernetGroup, linkName=linkName, ptmp=ptmp, reset=reset, vLANPriorityTable=vLANPriorityTable, tDDSynchronizationMode=tDDSynchronizationMode, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogStateTrap=syslogStateTrap, vLANManagementPriority=vLANManagementPriority, ptp=ptp, cableLoss=cableLoss, sNTPSync=sNTPSync, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveModulationMode=receiveModulationMode, sNMPCommunityString=sNMPCommunityString, alarms=alarms, bootVersion=bootVersion)
