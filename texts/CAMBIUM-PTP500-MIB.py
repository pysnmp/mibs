...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPCommunityString=sNMPCommunityString, ptmp=ptmp, notificationsGroup=notificationsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ptp500=ptp500, tDDControlGroup=tDDControlGroup, encryption=encryption, tDDSynchronizationMode=tDDSynchronizationMode, dataPortAutoMdix=dataPortAutoMdix, hardwareVersion=hardwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, searchState=searchState, bandwidthVariant=bandwidthVariant, configuration=configuration, sNTPServerIPAddress=sNTPServerIPAddress, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibration=unitOutOfCalibration, supplementaryGroup=supplementaryGroup, sNMPPortNumber=sNMPPortNumber, installStatusTrap=installStatusTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsLoopback=telecomsLoopback, timeZone=timeZone, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, channelBandwidth=channelBandwidth, dfs=dfs, reset=reset, sNMPTrapTableEntry=sNMPTrapTableEntry, regionCode=regionCode, syslogClientTrap=syslogClientTrap, aAAControlGroup=aAAControlGroup, receiveFreqMHz=receiveFreqMHz, syslogStateTrap=syslogStateTrap, accessMethod=accessMethod, telecomsLineCode=telecomsLineCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, softwareVersion=softwareVersion, range=range, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, receiveModulationMode=receiveModulationMode, telecomsLoopbackTrap=telecomsLoopbackTrap, phyControlGroup=phyControlGroup, ptp=ptp, userName=userName, regionCodeTrap=regionCodeTrap, telecom=telecom, tFTPServerIPAddress=tFTPServerIPAddress, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, systemClock=systemClock, snmpControlGroup=snmpControlGroup, ethernet=ethernet, vLANPriorityTable=vLANPriorityTable, antennaGain=antennaGain, secondarySoftwareVersion=secondarySoftwareVersion, sntp=sntp, syslogControl=syslogControl, dfsTableEntry=dfsTableEntry, targetMACAddress=targetMACAddress, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelStatus=telecomsChannelStatus, snmpControl=snmpControl, tDDControl=tDDControl, productVariant=productVariant, dfsTableIndex=dfsTableIndex, hTTPPortNumber=hTTPPortNumber, eIRP=eIRP, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatusGroup=phyStatusGroup, linkSymmetry=linkSymmetry, hTTPSPortNumber=hTTPSPortNumber, transmitChannel=transmitChannel, syslogState=syslogState, vectorError=vectorError, dataPortStatusTrap=dataPortStatusTrap, dataPortDisabledWarning=dataPortDisabledWarning, sntpGroup=sntpGroup, sNTPLastSync=sNTPLastSync, aggregateDataRate=aggregateDataRate, sNMPTrapVersion=sNMPTrapVersion, byteErrorRatio=byteErrorRatio, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsPeaks=dfsPeaks, siteName=siteName, vLANPriorityQueueMapping=vLANPriorityQueueMapping, licence=licence, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userRole=userRole, userPassword=userPassword, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleRegionCodes=incompatibleRegionCodes, encryptionAlgorithm=encryptionAlgorithm, altitude=altitude, ptpCompliance=ptpCompliance, transmitDataRate=transmitDataRate, sNMPTrapIPAddress=sNMPTrapIPAddress, receiveDataRate=receiveDataRate, management=management, tFTPServerPortNumber=tFTPServerPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, frequencyVariant=frequencyVariant, installStatus=installStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sNTPSyncTrap=sNTPSyncTrap, sMTPEmailAlert=sMTPEmailAlert, latitude=latitude, transmitFreqKHz=transmitFreqKHz, linkName=linkName, PYSNMP_MODULE_ID=cambium, ethernetGroup=ethernetGroup, vLANManagementPriority=vLANManagementPriority, receiveChannel=receiveChannel, userTableIndex=userTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sMTPServerPortNumber=sMTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, telnetAccessEnabled=telnetAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, pubStats=pubStats, transmitFreqMHz=transmitFreqMHz, sNTPSync=sNTPSync, linkLoss=linkLoss, ptpGroups=ptpGroups, installArmState=installArmState, receivePower=receivePower, longitude=longitude, remoteIPAddress=remoteIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, productName=productName, hTTPSAccessEnabled=hTTPSAccessEnabled, transmitModulationMode=transmitModulationMode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, masterSlaveMode=masterSlaveMode, cableLoss=cableLoss, groupID=groupID, telecomsCableLength=telecomsCableLength, sNTPServerPortNumber=sNTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, channelChangeTrap=channelChangeTrap, vLANManagementVID=vLANManagementVID, supplementary=supplementary, telecomGroup=telecomGroup, versions=versions, alarms=alarms, linkModeOptimisation=linkModeOptimisation, systemReset=systemReset, versionsGroup=versionsGroup, aAAControl=aAAControl, encryptionGroup=encryptionGroup, ptpTraps=ptpTraps, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, cambium=cambium, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsGroup=dfsGroup, sMTPServerIPAddress=sMTPServerIPAddress, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtp=smtp, sNMPTrapTableIndex=sNMPTrapTableIndex, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ethernetFiberSupport=ethernetFiberSupport, telecomsInterface=telecomsInterface, tDDSynchronizationStatus=tDDSynchronizationStatus, licenceGroup=licenceGroup, subnetMask=subnetMask, phyStatus=phyStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogClient=syslogClient, pubStatsGroup=pubStatsGroup, daylightSaving=daylightSaving, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, transmitPower=transmitPower, phyControl=phyControl, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, signalStrengthRatio=signalStrengthRatio, userTableNumber=userTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, configurationGroup=configurationGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userEnabled=userEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPEnabledMessages=sMTPEnabledMessages, installArmStateTrap=installArmStateTrap, dataPortStatus=dataPortStatus, sNTPState=sNTPState, ptpTrapPrefix=ptpTrapPrefix, managementGroup=managementGroup, dfsTable=dfsTable, dfsMeans=dfsMeans, smtpGroup=smtpGroup, capacityLicenseMismatch=capacityLicenseMismatch, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkAvailability=wirelessLinkAvailability, userTable=userTable, hTTPAccessEnabled=hTTPAccessEnabled, alarmsGroup=alarmsGroup, resetGroup=resetGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, vLANPriorityTableIndex=vLANPriorityTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, maximumTransmitPower=maximumTransmitPower, syslogControlGroup=syslogControlGroup, receiveFreqKHz=receiveFreqKHz, userTableEntry=userTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, iPAddress=iPAddress, licensedCapacity=licensedCapacity, telnetPortNumber=telnetPortNumber, sNMPTrapTable=sNMPTrapTable, sNMPEnabledTraps=sNMPEnabledTraps, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortConfigurationMismatch=dataPortConfigurationMismatch)
