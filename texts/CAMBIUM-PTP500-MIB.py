...
MibIdentifier, Bits, Counter64, NotificationType, Gauge32, Integer32, IpAddress, ModuleIdentity, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Counter64", "NotificationType", "Gauge32", "Integer32", "IpAddress", "ModuleIdentity", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "Counter32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tDDSynchronizationMode=tDDSynchronizationMode, accessMethod=accessMethod, dataPortStatus=dataPortStatus, ptp=ptp, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, managementGroup=managementGroup, sNTPServerIPAddress=sNTPServerIPAddress, resetGroup=resetGroup, linkSymmetry=linkSymmetry, userTableNumber=userTableNumber, latitude=latitude, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPTrapPortNumber=sNMPTrapPortNumber, softwareVersion=softwareVersion, dataPortStatusTrap=dataPortStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sntpGroup=sntpGroup, transmitPower=transmitPower, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, altitude=altitude, telecomsLoopback=telecomsLoopback, hTTPPortNumber=hTTPPortNumber, systemClock=systemClock, tDDSynchronizationAlarm=tDDSynchronizationAlarm, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, snmpControl=snmpControl, groupID=groupID, installArmStateTrap=installArmStateTrap, masterSlaveMode=masterSlaveMode, syslogClientTrap=syslogClientTrap, phyControl=phyControl, iPAddress=iPAddress, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, pubStatsGroup=pubStatsGroup, siteName=siteName, smtpGroup=smtpGroup, capacityLicenseMismatch=capacityLicenseMismatch, regionCodeTrap=regionCodeTrap, dfsPeaks=dfsPeaks, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, licensedCapacity=licensedCapacity, sntp=sntp, telecomsLineCode=telecomsLineCode, ptp500=ptp500, receivePower=receivePower, telecom=telecom, linkName=linkName, ptpGroups=ptpGroups, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, alarms=alarms, range=range, sNMPTrapIPAddress=sNMPTrapIPAddress, encryption=encryption, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ptpTrapPrefix=ptpTrapPrefix, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, tFTPServerPortNumber=tFTPServerPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, encryptionGroup=encryptionGroup, dfsTableEntry=dfsTableEntry, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ethernetGroup=ethernetGroup, syslogClient=syslogClient, supplementary=supplementary, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementPriority=vLANManagementPriority, userEnabled=userEnabled, notificationsGroup=notificationsGroup, maximumTransmitPower=maximumTransmitPower, alarmsGroup=alarmsGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, ptpTraps=ptpTraps, wirelessLinkStatus=wirelessLinkStatus, transmitFreqKHz=transmitFreqKHz, dataPortConfigurationMismatch=dataPortConfigurationMismatch, userTableIndex=userTableIndex, aAAControlGroup=aAAControlGroup, unitOutOfCalibration=unitOutOfCalibration, wirelessLinkAvailability=wirelessLinkAvailability, telecomGroup=telecomGroup, tDDControl=tDDControl, dfs=dfs, ptpCompliance=ptpCompliance, regionCode=regionCode, sNMPTrapTable=sNMPTrapTable, dataPortDisabledWarning=dataPortDisabledWarning, cambium=cambium, encryptionAlgorithm=encryptionAlgorithm, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPEmailAlert=sMTPEmailAlert, sMTPServerPortNumber=sMTPServerPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, sMTPServerIPAddress=sMTPServerIPAddress, receiveModulationMode=receiveModulationMode, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPTrapVersion=sNMPTrapVersion, sNTPState=sNTPState, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telnetAccessEnabled=telnetAccessEnabled, tDDControlGroup=tDDControlGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, sNMPv3Enable=sNMPv3Enable, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPPortNumber=sNMPPortNumber, timeZone=timeZone, telecomsCableLength=telecomsCableLength, channelChangeTrap=channelChangeTrap, telecomsInterface=telecomsInterface, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versionsGroup=versionsGroup, cableLoss=cableLoss, userRole=userRole, phyStatusGroup=phyStatusGroup, hardwareVersion=hardwareVersion, vectorError=vectorError, daylightSaving=daylightSaving, syslogControlGroup=syslogControlGroup, installStatusTrap=installStatusTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, phyControlGroup=phyControlGroup, longitude=longitude, dfsTableIndex=dfsTableIndex, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, reset=reset, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, productName=productName, telecomsChannelStatus=telecomsChannelStatus, vLANManagementVID=vLANManagementVID, sNTPPollInterval=sNTPPollInterval, sNTPLastSync=sNTPLastSync, gatewayIPAddress=gatewayIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, eIRP=eIRP, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationModeDetail=receiveModulationModeDetail, userTableEntry=userTableEntry, aggregateDataRate=aggregateDataRate, dfsTable=dfsTable, linkModeOptimisation=linkModeOptimisation, ethernet=ethernet, sNMPTrapTableNumber=sNMPTrapTableNumber, phyStatus=phyStatus, telecomsChannelStatusTrap=telecomsChannelStatusTrap, searchState=searchState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, systemReset=systemReset, transmitDataRate=transmitDataRate, dfsTableNumber=dfsTableNumber, sNMPEnabledTraps=sNMPEnabledTraps, licence=licence, incompatibleRegionCodes=incompatibleRegionCodes, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogControl=syslogControl, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, signalStrengthRatio=signalStrengthRatio, sNTPServerPortNumber=sNTPServerPortNumber, versions=versions, configurationGroup=configurationGroup, productVariant=productVariant, antennaGain=antennaGain, syslogState=syslogState, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortAutoMdix=dataPortAutoMdix, installArmState=installArmState, supplementaryGroup=supplementaryGroup, telnetPortNumber=telnetPortNumber, frequencyVariant=frequencyVariant, sNMPCommunityString=sNMPCommunityString, enabledDiagnosticAlarms=enabledDiagnosticAlarms, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userPassword=userPassword, linkLoss=linkLoss, syslogStateTrap=syslogStateTrap, channelBandwidth=channelBandwidth, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsMeans=dfsMeans, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsGroup=dfsGroup, installStatus=installStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bootVersion=bootVersion, hTTPSPortNumber=hTTPSPortNumber, pubStats=pubStats, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, aAAControl=aAAControl, bandwidthVariant=bandwidthVariant, subnetMask=subnetMask, transmitChannel=transmitChannel, incompatibleMasterAndSlave=incompatibleMasterAndSlave, receiveFreqKHz=receiveFreqKHz, userName=userName, targetMACAddress=targetMACAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ethernetFiberSupport=ethernetFiberSupport, sNTPSync=sNTPSync, smtp=smtp, sNTPSyncTrap=sNTPSyncTrap, configuration=configuration, licenceGroup=licenceGroup, tFTPServerIPAddress=tFTPServerIPAddress, transmitFreqMHz=transmitFreqMHz, byteErrorRatio=byteErrorRatio, userTable=userTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, receiveFreqMHz=receiveFreqMHz, receiveDataRate=receiveDataRate, vLANPriorityTable=vLANPriorityTable, ptmp=ptmp, receiveChannel=receiveChannel)
