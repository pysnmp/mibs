...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", productName=productName, versions=versions, sNMPTrapTableEntry=sNMPTrapTableEntry, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, timeZone=timeZone, vLANPriorityTableNumber=vLANPriorityTableNumber, encryptionAlgorithm=encryptionAlgorithm, phyStatus=phyStatus, dfsTableNumber=dfsTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, sNTPServerIPAddress=sNTPServerIPAddress, configuration=configuration, installStatus=installStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, snmpControlGroup=snmpControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, hTTPSAccessEnabled=hTTPSAccessEnabled, gatewayIPAddress=gatewayIPAddress, vLANManagementVID=vLANManagementVID, antennaGain=antennaGain, receiveModulationModeDetail=receiveModulationModeDetail, resetGroup=resetGroup, pubStatsGroup=pubStatsGroup, altitude=altitude, aAAControl=aAAControl, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, phyStatusGroup=phyStatusGroup, userRole=userRole, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, ptp=ptp, longitude=longitude, versionsGroup=versionsGroup, pubStats=pubStats, linkModeOptimisation=linkModeOptimisation, transmitFreqMHz=transmitFreqMHz, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, tDDSynchronizationAlarm=tDDSynchronizationAlarm, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, cambium=cambium, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomGroup=telecomGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, latitude=latitude, syslogStateTrap=syslogStateTrap, sMTPEmailAlert=sMTPEmailAlert, groupID=groupID, configurationGroup=configurationGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receiveDataRate=receiveDataRate, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogClientTrap=syslogClientTrap, telecom=telecom, channelBandwidth=channelBandwidth, dataPortDisabledWarning=dataPortDisabledWarning, tFTPServerPortNumber=tFTPServerPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, useVLANForManagementInterfaces=useVLANForManagementInterfaces, smtp=smtp, dfsTableIndex=dfsTableIndex, alarmsGroup=alarmsGroup, sMTPServerIPAddress=sMTPServerIPAddress, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, iPAddress=iPAddress, frequencyVariant=frequencyVariant, telecomsLoopback=telecomsLoopback, dataPortAutoNegotiation=dataPortAutoNegotiation, syslogControl=syslogControl, dfsMeans=dfsMeans, sMTPEnabledMessages=sMTPEnabledMessages, aggregateDataRate=aggregateDataRate, ptmp=ptmp, siteName=siteName, telnetAccessEnabled=telnetAccessEnabled, unitOutOfCalibration=unitOutOfCalibration, linkSymmetry=linkSymmetry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, secondarySoftwareVersion=secondarySoftwareVersion, bootVersion=bootVersion, userTableIndex=userTableIndex, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ethernetGroup=ethernetGroup, subnetMask=subnetMask, eIRP=eIRP, aAAControlGroup=aAAControlGroup, transmitPower=transmitPower, PYSNMP_MODULE_ID=cambium, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsGroup=dfsGroup, sNMPCommunityString=sNMPCommunityString, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitFreqKHz=transmitFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPServerIPAddress=tFTPServerIPAddress, vLANManagementPriority=vLANManagementPriority, hTTPAccessEnabled=hTTPAccessEnabled, notificationsGroup=notificationsGroup, snmpControl=snmpControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsChannelStatus=telecomsChannelStatus, byteErrorRatio=byteErrorRatio, sNMPv3Enable=sNMPv3Enable, sNMPTrapTableIndex=sNMPTrapTableIndex, installArmState=installArmState, ethernet=ethernet, cableLoss=cableLoss, productVariant=productVariant, receiveChannel=receiveChannel, syslogState=syslogState, receiveModulationMode=receiveModulationMode, alarms=alarms, reset=reset, incompatibleRegionCodes=incompatibleRegionCodes, userEnabled=userEnabled, hardwareVersion=hardwareVersion, tDDControlGroup=tDDControlGroup, smtpGroup=smtpGroup, hTTPSPortNumber=hTTPSPortNumber, sMTPServerPortNumber=sMTPServerPortNumber, sNTPState=sNTPState, syslogClient=syslogClient, sNMPTrapTable=sNMPTrapTable, remoteIPAddress=remoteIPAddress, telnetPortNumber=telnetPortNumber, tDDSynchronizationStatus=tDDSynchronizationStatus, userTableNumber=userTableNumber, phyControl=phyControl, regionCode=regionCode, dataPortStatusTrap=dataPortStatusTrap, maximumTransmitPower=maximumTransmitPower, channelChangeTrap=channelChangeTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licence=licence, ptpTrapPrefix=ptpTrapPrefix, licensedCapacity=licensedCapacity, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, signalStrengthRatio=signalStrengthRatio, ptpCompliance=ptpCompliance, masterSlaveMode=masterSlaveMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPLastSync=sNTPLastSync, userTableEntry=userTableEntry, installArmStateTrap=installArmStateTrap, supplementaryGroup=supplementaryGroup, userName=userName, sNMPTrapVersion=sNMPTrapVersion, supplementary=supplementary, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsLoopbackTrap=telecomsLoopbackTrap, regionCodeTrap=regionCodeTrap, targetMACAddress=targetMACAddress, sNTPSync=sNTPSync, ptp500=ptp500, searchState=searchState, transmitChannel=transmitChannel, wirelessLinkStatus=wirelessLinkStatus, sNTPServerPortNumber=sNTPServerPortNumber, transmitDataRate=transmitDataRate, tDDControl=tDDControl, ptpGroups=ptpGroups, softwareVersion=softwareVersion, sNTPSyncTrap=sNTPSyncTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, tDDSynchronizationMode=tDDSynchronizationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dfs=dfs, sntp=sntp, daylightSaving=daylightSaving, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomsCableLength=telecomsCableLength, encryption=encryption, vectorError=vectorError, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPPortNumber=sNMPPortNumber, accessMethod=accessMethod, licenceGroup=licenceGroup, linkLoss=linkLoss, transmitModulationMode=transmitModulationMode, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveFreqMHz=receiveFreqMHz, vLANPriorityTable=vLANPriorityTable, management=management, sNMPTrapPortNumber=sNMPTrapPortNumber, dfsTable=dfsTable, userTable=userTable, managementGroup=managementGroup, dfsPeaks=dfsPeaks, ptpTraps=ptpTraps, bandwidthVariant=bandwidthVariant, range=range, sntpGroup=sntpGroup, sNTPPollInterval=sNTPPollInterval, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ethernetFiberSupport=ethernetFiberSupport, encryptionGroup=encryptionGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installStatusTrap=installStatusTrap, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, linkName=linkName, systemReset=systemReset, hTTPPortNumber=hTTPPortNumber, userPassword=userPassword, phyControlGroup=phyControlGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receivePower=receivePower, dfsTableEntry=dfsTableEntry, syslogControlGroup=syslogControlGroup, telecomsLineCode=telecomsLineCode)
