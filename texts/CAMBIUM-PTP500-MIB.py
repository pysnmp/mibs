...
# Produced by pysmi-1.1.3 at Sun Nov 28 15:00:33 2021
...
Unsigned32, IpAddress, Gauge32, ModuleIdentity, Bits, Counter32, MibIdentifier, Counter64, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, ObjectIdentity, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Gauge32", "ModuleIdentity", "Bits", "Counter32", "MibIdentifier", "Counter64", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "ObjectIdentity", "iso", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installStatus=installStatus, byteErrorRatio=byteErrorRatio, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, hardwareVersion=hardwareVersion, vLANPriorityTable=vLANPriorityTable, siteName=siteName, telecomsLineCode=telecomsLineCode, dfsTableIndex=dfsTableIndex, altitude=altitude, dfsTable=dfsTable, productVariant=productVariant, userPassword=userPassword, hTTPSPortNumber=hTTPSPortNumber, syslogControl=syslogControl, dfs=dfs, channelChangeTrap=channelChangeTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, userTableIndex=userTableIndex, linkSymmetry=linkSymmetry, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ethernet=ethernet, sNMPCommunityString=sNMPCommunityString, sNTPSync=sNTPSync, ptpTrapPrefix=ptpTrapPrefix, transmitFreqKHz=transmitFreqKHz, phyControl=phyControl, installArmStateTrap=installArmStateTrap, syslogStateTrap=syslogStateTrap, dfsMeans=dfsMeans, telecomsInterface=telecomsInterface, productName=productName, hTTPSAccessEnabled=hTTPSAccessEnabled, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, resetGroup=resetGroup, cambium=cambium, ptpGroups=ptpGroups, configurationGroup=configurationGroup, vLANManagementPriority=vLANManagementPriority, sNTPPollInterval=sNTPPollInterval, sNMPTrapPortNumber=sNMPTrapPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatch=linkModeOptimizationMismatch, iPAddress=iPAddress, searchState=searchState, dfsGroup=dfsGroup, tFTPServerIPAddress=tFTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, maximumTransmitPower=maximumTransmitPower, sNMPTrapVersion=sNMPTrapVersion, sntpGroup=sntpGroup, receiveFreqKHz=receiveFreqKHz, receiveFreqMHz=receiveFreqMHz, sNMPTrapTableEntry=sNMPTrapTableEntry, vectorError=vectorError, licence=licence, dataPortDisabledWarning=dataPortDisabledWarning, licenceGroup=licenceGroup, snmpControl=snmpControl, sNMPTrapTableNumber=sNMPTrapTableNumber, capacityLicenseMismatch=capacityLicenseMismatch, reset=reset, noWirelessChannelAvailable=noWirelessChannelAvailable, aAAControlGroup=aAAControlGroup, installArmState=installArmState, sNMPPortNumber=sNMPPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, vLANManagementVID=vLANManagementVID, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, linkName=linkName, systemReset=systemReset, ptpTraps=ptpTraps, vLANPriorityTableIndex=vLANPriorityTableIndex, transmitFreqMHz=transmitFreqMHz, vLANPriorityTableNumber=vLANPriorityTableNumber, bootVersion=bootVersion, sNTPLastSync=sNTPLastSync, userTable=userTable, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, incompatibleRegionCodes=incompatibleRegionCodes, userTableNumber=userTableNumber, daylightSaving=daylightSaving, dataPortConfigurationMismatch=dataPortConfigurationMismatch, hTTPAccessEnabled=hTTPAccessEnabled, receivePower=receivePower, tDDSynchronizationMode=tDDSynchronizationMode, sNTPSyncTrap=sNTPSyncTrap, dfsTableNumber=dfsTableNumber, management=management, syslogControlGroup=syslogControlGroup, antennaGain=antennaGain, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptmp=ptmp, channelBandwidth=channelBandwidth, groupID=groupID, syslogClientTrap=syslogClientTrap, accessMethod=accessMethod, alarmsGroup=alarmsGroup, targetMACAddress=targetMACAddress, receiveChannel=receiveChannel, transmitModulationMode=transmitModulationMode, telecom=telecom, sNTPServerPortNumber=sNTPServerPortNumber, latitude=latitude, pubStatsGroup=pubStatsGroup, phyStatus=phyStatus, dfsTableEntry=dfsTableEntry, softwareVersion=softwareVersion, userTableEntry=userTableEntry, userRole=userRole, enabledDiagnosticAlarms=enabledDiagnosticAlarms, notificationsGroup=notificationsGroup, supplementary=supplementary, sMTPServerPortNumber=sMTPServerPortNumber, transmitChannel=transmitChannel, telecomGroup=telecomGroup, telnetAccessEnabled=telnetAccessEnabled, useVLANForManagementInterfaces=useVLANForManagementInterfaces, constantPowerSpectralDensity=constantPowerSpectralDensity, regionCodeTrap=regionCodeTrap, tFTPServerPortNumber=tFTPServerPortNumber, userEnabled=userEnabled, encryptionGroup=encryptionGroup, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveModulationMode=receiveModulationMode, dataPortAutoMdix=dataPortAutoMdix, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLoopbackTrap=telecomsLoopbackTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPState=sNTPState, userName=userName, sMTPEmailAlert=sMTPEmailAlert, dfsPeaks=dfsPeaks, hTTPPortNumber=hTTPPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, versionsGroup=versionsGroup, frequencyVariant=frequencyVariant, configuration=configuration, range=range, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, sNMPTrapTable=sNMPTrapTable, sNTPServerIPAddress=sNTPServerIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, phyStatusGroup=phyStatusGroup, systemClock=systemClock, versions=versions, receiveDataRate=receiveDataRate, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryptionAlgorithm=encryptionAlgorithm, subnetMask=subnetMask, linkLoss=linkLoss, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tDDControlGroup=tDDControlGroup, aggregateDataRate=aggregateDataRate, sNMPEnabledTraps=sNMPEnabledTraps, longitude=longitude, masterSlaveMode=masterSlaveMode, sMTPSourceEmailAddress=sMTPSourceEmailAddress, timeZone=timeZone, smtpGroup=smtpGroup, gatewayIPAddress=gatewayIPAddress, transmitDataRate=transmitDataRate, dataPortStatus=dataPortStatus, incompatibleMasterAndSlave=incompatibleMasterAndSlave, supplementaryGroup=supplementaryGroup, signalStrengthRatio=signalStrengthRatio, syslogClient=syslogClient, dataPortStatusTrap=dataPortStatusTrap, phyControlGroup=phyControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsCableLength=telecomsCableLength, cableLoss=cableLoss, telecomsLoopback=telecomsLoopback, sNMPTrapIPAddress=sNMPTrapIPAddress, pubStats=pubStats, tDDControl=tDDControl, smtp=smtp, ethernetGroup=ethernetGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sntp=sntp, managementGroup=managementGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sMTPServerIPAddress=sMTPServerIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPv3Enable=sNMPv3Enable, snmpControlGroup=snmpControlGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPTrapTableIndex=sNMPTrapTableIndex, installStatusTrap=installStatusTrap, transmitPower=transmitPower, ptp500=ptp500, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimisation=linkModeOptimisation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, eIRP=eIRP, ptp=ptp, ptpCompliance=ptpCompliance, ethernetFiberSupport=ethernetFiberSupport, wirelessLinkStatus=wirelessLinkStatus, telnetPortNumber=telnetPortNumber, licensedCapacity=licensedCapacity, telecomsChannelStatus=telecomsChannelStatus, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, alarms=alarms, unitOutOfCalibration=unitOutOfCalibration, encryption=encryption, vLANPriorityTableEntry=vLANPriorityTableEntry, aAAControl=aAAControl, bandwidthVariant=bandwidthVariant, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, regionCode=regionCode, wirelessLinkAvailability=wirelessLinkAvailability, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogState=syslogState)
