...
ModuleIdentity, NotificationType, IpAddress, Integer32, enterprises, iso, ObjectIdentity, Unsigned32, MibIdentifier, Counter32, Counter64, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "NotificationType", "IpAddress", "Integer32", "enterprises", "iso", "ObjectIdentity", "Unsigned32", "MibIdentifier", "Counter32", "Counter64", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, encryptionGroup=encryptionGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogClientTrap=syslogClientTrap, syslogControlGroup=syslogControlGroup, smtp=smtp, timeZone=timeZone, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, accessMethod=accessMethod, syslogStateTrap=syslogStateTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, byteErrorRatio=byteErrorRatio, cableLoss=cableLoss, telecomsChannelStatus=telecomsChannelStatus, channelBandwidth=channelBandwidth, incompatibleMasterAndSlave=incompatibleMasterAndSlave, userPassword=userPassword, aAAControlGroup=aAAControlGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, phyControl=phyControl, versionsGroup=versionsGroup, groupID=groupID, sMTPEnabledMessages=sMTPEnabledMessages, ethernetGroup=ethernetGroup, userTableIndex=userTableIndex, transmitFreqKHz=transmitFreqKHz, range=range, encryptionAlgorithm=encryptionAlgorithm, sNMPCommunityString=sNMPCommunityString, dataPortStatus=dataPortStatus, regionCodeTrap=regionCodeTrap, sNTPSyncTrap=sNTPSyncTrap, systemReset=systemReset, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogState=syslogState, sNTPSync=sNTPSync, licenceGroup=licenceGroup, installStatusTrap=installStatusTrap, sNTPServerPortNumber=sNTPServerPortNumber, dataPortDisabledWarning=dataPortDisabledWarning, managementGroup=managementGroup, licensedCapacity=licensedCapacity, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sNTPServerIPAddress=sNTPServerIPAddress, userEnabled=userEnabled, hardwareVersion=hardwareVersion, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfs=dfs, tDDControlGroup=tDDControlGroup, ptp=ptp, management=management, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, signalStrengthRatio=signalStrengthRatio, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, bootVersion=bootVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLoopbackTrap=telecomsLoopbackTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveModulationMode=receiveModulationMode, encryption=encryption, receivePower=receivePower, dfsMeans=dfsMeans, sMTPServerPortNumber=sMTPServerPortNumber, installStatus=installStatus, dfsTable=dfsTable, pubStats=pubStats, transmitModulationMode=transmitModulationMode, sNMPTrapTableIndex=sNMPTrapTableIndex, alarms=alarms, sNTPLastSync=sNTPLastSync, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, incompatibleRegionCodes=incompatibleRegionCodes, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsChannelStatusTrap=telecomsChannelStatusTrap, ptpGroups=ptpGroups, sntp=sntp, installArmState=installArmState, useVLANForManagementInterfaces=useVLANForManagementInterfaces, resetGroup=resetGroup, dfsTableNumber=dfsTableNumber, telecomsLineCode=telecomsLineCode, tDDControl=tDDControl, sNMPv3Enable=sNMPv3Enable, ethernetFiberSupport=ethernetFiberSupport, dataPortStatusTrap=dataPortStatusTrap, sNMPTrapTableEntry=sNMPTrapTableEntry, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkLoss=linkLoss, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsGroup=dfsGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, constantPowerSpectralDensity=constantPowerSpectralDensity, linkName=linkName, telecomsLoopback=telecomsLoopback, ptp500=ptp500, softwareVersion=softwareVersion, smtpGroup=smtpGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, phyStatus=phyStatus, noWirelessChannelAvailable=noWirelessChannelAvailable, masterSlaveMode=masterSlaveMode, PYSNMP_MODULE_ID=cambium, remoteIPAddress=remoteIPAddress, userRole=userRole, altitude=altitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptpCompliance=ptpCompliance, sMTPServerIPAddress=sMTPServerIPAddress, aggregateDataRate=aggregateDataRate, syslogClient=syslogClient, alarmsGroup=alarmsGroup, telecomsCableLength=telecomsCableLength, linkModeOptimizationMismatch=linkModeOptimizationMismatch, eIRP=eIRP, transmitFreqMHz=transmitFreqMHz, vectorError=vectorError, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveFreqKHz=receiveFreqKHz, licence=licence, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANPriorityTableIndex=vLANPriorityTableIndex, productName=productName, longitude=longitude, frequencyVariant=frequencyVariant, subnetMask=subnetMask, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, aAAControl=aAAControl, sMTPEmailAlert=sMTPEmailAlert, systemClock=systemClock, dataPortAutoNegotiation=dataPortAutoNegotiation, installArmStateTrap=installArmStateTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, snmpControlGroup=snmpControlGroup, vLANManagementPriority=vLANManagementPriority, supplementaryGroup=supplementaryGroup, sntpGroup=sntpGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, gatewayIPAddress=gatewayIPAddress, tFTPServerIPAddress=tFTPServerIPAddress, transmitDataRate=transmitDataRate, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, tDDSynchronizationMode=tDDSynchronizationMode, ptpTraps=ptpTraps, latitude=latitude, telecomsInterface=telecomsInterface, tFTPServerPortNumber=tFTPServerPortNumber, ptpTrapPrefix=ptpTrapPrefix, dfsTableEntry=dfsTableEntry, receiveFreqMHz=receiveFreqMHz, sNMPPortNumber=sNMPPortNumber, sNTPState=sNTPState, phyControlGroup=phyControlGroup, dfsTableIndex=dfsTableIndex, vLANPriorityTable=vLANPriorityTable, ethernet=ethernet, syslogControl=syslogControl, dataPortAutoMdix=dataPortAutoMdix, regionCode=regionCode, reset=reset, configuration=configuration, unitOutOfCalibration=unitOutOfCalibration, userTableNumber=userTableNumber, snmpControl=snmpControl, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitChannel=transmitChannel, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPAddress=iPAddress, notificationsGroup=notificationsGroup, secondarySoftwareVersion=secondarySoftwareVersion, cambium=cambium, daylightSaving=daylightSaving, telecom=telecom, sNTPPollInterval=sNTPPollInterval, telnetPortNumber=telnetPortNumber, configurationGroup=configurationGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, phyStatusGroup=phyStatusGroup, receiveChannel=receiveChannel, pubStatsGroup=pubStatsGroup, userTableEntry=userTableEntry, sNMPTrapVersion=sNMPTrapVersion, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, linkModeOptimisation=linkModeOptimisation, vLANManagementVID=vLANManagementVID, targetMACAddress=targetMACAddress, transmitPower=transmitPower, hTTPAccessEnabled=hTTPAccessEnabled, supplementary=supplementary, wirelessLinkAvailability=wirelessLinkAvailability, searchState=searchState, userTable=userTable, userName=userName, receiveDataRate=receiveDataRate, antennaGain=antennaGain, receiveModulationModeDetail=receiveModulationModeDetail, channelChangeTrap=channelChangeTrap, linkSymmetry=linkSymmetry, sNMPEnabledTraps=sNMPEnabledTraps, telecomGroup=telecomGroup, siteName=siteName, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, productVariant=productVariant, hTTPSPortNumber=hTTPSPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, maximumTransmitPower=maximumTransmitPower, dfsPeaks=dfsPeaks, bandwidthVariant=bandwidthVariant, ptmp=ptmp, versions=versions, hTTPPortNumber=hTTPPortNumber)
