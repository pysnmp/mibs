...
Unsigned32, iso, TimeTicks, NotificationType, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, ObjectIdentity, MibIdentifier, enterprises, Gauge32, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "TimeTicks", "NotificationType", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "ObjectIdentity", "MibIdentifier", "enterprises", "Gauge32", "ModuleIdentity", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPTrapIPAddress=sNMPTrapIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, syslogClientTrap=syslogClientTrap, ptpCompliance=ptpCompliance, phyStatus=phyStatus, siteName=siteName, subnetMask=subnetMask, alarmsGroup=alarmsGroup, aAAControlGroup=aAAControlGroup, hTTPPortNumber=hTTPPortNumber, vLANManagementVID=vLANManagementVID, channelBandwidth=channelBandwidth, sNTPServerIPAddress=sNTPServerIPAddress, userName=userName, hardwareVersion=hardwareVersion, phyStatusGroup=phyStatusGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, licensedCapacity=licensedCapacity, userRole=userRole, altitude=altitude, sNTPServerPortNumber=sNTPServerPortNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntp=sntp, sMTPServerIPAddress=sMTPServerIPAddress, versionsGroup=versionsGroup, PYSNMP_MODULE_ID=cambium, licence=licence, searchState=searchState, telecomsLoopbackTrap=telecomsLoopbackTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStats=pubStats, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, transmitPower=transmitPower, sNTPSync=sNTPSync, alarms=alarms, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkSymmetry=linkSymmetry, receiveChannel=receiveChannel, userTableEntry=userTableEntry, tDDControl=tDDControl, gatewayIPAddress=gatewayIPAddress, antennaGain=antennaGain, ethernetFiberSupport=ethernetFiberSupport, timeZone=timeZone, hTTPSPortNumber=hTTPSPortNumber, syslogControl=syslogControl, telnetPortNumber=telnetPortNumber, ethernet=ethernet, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userTableIndex=userTableIndex, snmpControlGroup=snmpControlGroup, dfsTableNumber=dfsTableNumber, linkModeOptimisation=linkModeOptimisation, phyControl=phyControl, vLANPriorityQueueMapping=vLANPriorityQueueMapping, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, supplementary=supplementary, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, receiveFreqKHz=receiveFreqKHz, vLANPriorityTable=vLANPriorityTable, telecomsLoopback=telecomsLoopback, pubStatsGroup=pubStatsGroup, managementGroup=managementGroup, syslogState=syslogState, tFTPServerIPAddress=tFTPServerIPAddress, regionCode=regionCode, maximumTransmitPower=maximumTransmitPower, sNTPPollInterval=sNTPPollInterval, systemReset=systemReset, configuration=configuration, encryption=encryption, latitude=latitude, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, ptp=ptp, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkLoss=linkLoss, smtp=smtp, sNMPTrapVersion=sNMPTrapVersion, dataPortStatus=dataPortStatus, softwareVersion=softwareVersion, cambium=cambium, userTableNumber=userTableNumber, receiveDataRate=receiveDataRate, systemClock=systemClock, receiveFreqMHz=receiveFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPLastSync=sNTPLastSync, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, telecomsLineCode=telecomsLineCode, dataPortAutoMdix=dataPortAutoMdix, telecomsChannelStatusTrap=telecomsChannelStatusTrap, management=management, daylightSaving=daylightSaving, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortDisabledWarning=dataPortDisabledWarning, configurationGroup=configurationGroup, telecomsCableLength=telecomsCableLength, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vectorError=vectorError, sMTPEnabledMessages=sMTPEnabledMessages, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptpTrapPrefix=ptpTrapPrefix, transmitChannel=transmitChannel, transmitFreqKHz=transmitFreqKHz, hTTPAccessEnabled=hTTPAccessEnabled, channelChangeTrap=channelChangeTrap, reset=reset, signalStrengthRatio=signalStrengthRatio, sMTPEmailAlert=sMTPEmailAlert, notificationsGroup=notificationsGroup, ptpGroups=ptpGroups, sNTPSyncTrap=sNTPSyncTrap, bandwidthVariant=bandwidthVariant, telecomsInterface=telecomsInterface, receiveModulationMode=receiveModulationMode, sMTPServerPortNumber=sMTPServerPortNumber, encryptionAlgorithm=encryptionAlgorithm, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTable=sNMPTrapTable, userTable=userTable, encryptionGroup=encryptionGroup, dfsTableIndex=dfsTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, installStatusTrap=installStatusTrap, range=range, sNMPv3Enable=sNMPv3Enable, wirelessLinkAvailability=wirelessLinkAvailability, tDDControlGroup=tDDControlGroup, ptmp=ptmp, telecomGroup=telecomGroup, sNTPState=sNTPState, aggregateDataRate=aggregateDataRate, dfsGroup=dfsGroup, wirelessLinkStatus=wirelessLinkStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, telecom=telecom, sNMPPortNumber=sNMPPortNumber, remoteIPAddress=remoteIPAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, supplementaryGroup=supplementaryGroup, targetMACAddress=targetMACAddress, telecomsChannelStatus=telecomsChannelStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, transmitFreqMHz=transmitFreqMHz, installArmStateTrap=installArmStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitDataRate=transmitDataRate, vLANManagementPriority=vLANManagementPriority, capacityLicenseMismatch=capacityLicenseMismatch, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsTableEntry=dfsTableEntry, dfsMeans=dfsMeans, incompatibleRegionCodes=incompatibleRegionCodes, noWirelessChannelAvailable=noWirelessChannelAvailable, sNMPTrapTableNumber=sNMPTrapTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, frequencyVariant=frequencyVariant, userEnabled=userEnabled, installStatus=installStatus, dfsPeaks=dfsPeaks, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, bootVersion=bootVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, resetGroup=resetGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, vLANPriorityTableNumber=vLANPriorityTableNumber, linkName=linkName, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tFTPServerPortNumber=tFTPServerPortNumber, regionCodeTrap=regionCodeTrap, eIRP=eIRP, sNMPCommunityString=sNMPCommunityString, ptp500=ptp500, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, masterSlaveMode=masterSlaveMode, secondarySoftwareVersion=secondarySoftwareVersion, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsTable=dfsTable, syslogClient=syslogClient, transmitModulationMode=transmitModulationMode, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dataPortStatusTrap=dataPortStatusTrap, iPAddress=iPAddress, receivePower=receivePower, snmpControl=snmpControl, smtpGroup=smtpGroup, receiveModulationModeDetail=receiveModulationModeDetail, syslogStateTrap=syslogStateTrap, dfs=dfs, productVariant=productVariant, ethernetGroup=ethernetGroup, cableLoss=cableLoss, accessMethod=accessMethod, telnetAccessEnabled=telnetAccessEnabled, phyControlGroup=phyControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, longitude=longitude, aAAControl=aAAControl, groupID=groupID, licenceGroup=licenceGroup, syslogControlGroup=syslogControlGroup, byteErrorRatio=byteErrorRatio, userPassword=userPassword, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptpTraps=ptpTraps, productName=productName, sntpGroup=sntpGroup, tDDSynchronizationMode=tDDSynchronizationMode, installArmState=installArmState)
