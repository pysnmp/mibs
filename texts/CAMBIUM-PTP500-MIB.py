...
Gauge32, NotificationType, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, enterprises, Counter32, ModuleIdentity, TimeTicks, MibIdentifier, Bits, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "NotificationType", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "enterprises", "Counter32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "Bits", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNTPPollInterval=sNTPPollInterval, managementGroup=managementGroup, encryption=encryption, telecomsChannelStatus=telecomsChannelStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, unitOutOfCalibration=unitOutOfCalibration, cambium=cambium, syslogControl=syslogControl, transmitFreqMHz=transmitFreqMHz, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkAvailability=wirelessLinkAvailability, userName=userName, remoteIPAddress=remoteIPAddress, dataPortDisabledWarning=dataPortDisabledWarning, dataPortAutoMdix=dataPortAutoMdix, userRole=userRole, telecomGroup=telecomGroup, vectorError=vectorError, ptpTrapPrefix=ptpTrapPrefix, syslogClient=syslogClient, userTableEntry=userTableEntry, receiveModulationModeDetail=receiveModulationModeDetail, regionCodeTrap=regionCodeTrap, pubStatsGroup=pubStatsGroup, ptp500=ptp500, dfs=dfs, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveDataRate=receiveDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomsLoopback=telecomsLoopback, sNMPTrapVersion=sNMPTrapVersion, linkLoss=linkLoss, tDDSynchronizationStatus=tDDSynchronizationStatus, longitude=longitude, smtp=smtp, hTTPPortNumber=hTTPPortNumber, dfsTableNumber=dfsTableNumber, telecomsCableLength=telecomsCableLength, sMTPServerPortNumber=sMTPServerPortNumber, tDDControl=tDDControl, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, userEnabled=userEnabled, resetGroup=resetGroup, supplementaryGroup=supplementaryGroup, daylightSaving=daylightSaving, channelChangeTrap=channelChangeTrap, sNTPSyncTrap=sNTPSyncTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANPriorityTableNumber=vLANPriorityTableNumber, pubStats=pubStats, systemClock=systemClock, ptpCompliance=ptpCompliance, altitude=altitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANManagementPriority=vLANManagementPriority, installArmStateTrap=installArmStateTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, transmitDataRate=transmitDataRate, signalStrengthRatio=signalStrengthRatio, incompatibleMasterAndSlave=incompatibleMasterAndSlave, remoteMaximumTransmitPower=remoteMaximumTransmitPower, incompatibleRegionCodes=incompatibleRegionCodes, aAAControl=aAAControl, receivePower=receivePower, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPState=sNTPState, antennaGain=antennaGain, dfsMeans=dfsMeans, bandwidthVariant=bandwidthVariant, dataPortStatusTrap=dataPortStatusTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptpTraps=ptpTraps, dataPortStatus=dataPortStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sntp=sntp, alarmsGroup=alarmsGroup, licenceGroup=licenceGroup, dfsTableIndex=dfsTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, ethernetFiberSupport=ethernetFiberSupport, phyStatusGroup=phyStatusGroup, byteErrorRatio=byteErrorRatio, useVLANForManagementInterfaces=useVLANForManagementInterfaces, eIRP=eIRP, linkName=linkName, dataPortConfigurationMismatch=dataPortConfigurationMismatch, snmpControl=snmpControl, capacityLicenseMismatch=capacityLicenseMismatch, dataPortAutoNegotiation=dataPortAutoNegotiation, maximumTransmitPower=maximumTransmitPower, sNTPSync=sNTPSync, licence=licence, syslogStateTrap=syslogStateTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, configuration=configuration, constantPowerSpectralDensity=constantPowerSpectralDensity, userTableNumber=userTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPCommunityString=sNMPCommunityString, phyControlGroup=phyControlGroup, aggregateDataRate=aggregateDataRate, installStatusTrap=installStatusTrap, range=range, receiveModulationMode=receiveModulationMode, versionsGroup=versionsGroup, sntpGroup=sntpGroup, ethernetGroup=ethernetGroup, siteName=siteName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, reset=reset, phyControl=phyControl, userTableIndex=userTableIndex, tDDControlGroup=tDDControlGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, subnetMask=subnetMask, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, telecomsLineCode=telecomsLineCode, linkModeOptimisation=linkModeOptimisation, vLANManagementVID=vLANManagementVID, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNTPServerIPAddress=sNTPServerIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitFreqKHz=transmitFreqKHz, dfsTableEntry=dfsTableEntry, telnetPortNumber=telnetPortNumber, searchState=searchState, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogClientTrap=syslogClientTrap, userPassword=userPassword, encryptionGroup=encryptionGroup, tDDSynchronizationMode=tDDSynchronizationMode, phyStatus=phyStatus, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPLastSync=sNTPLastSync, aAAControlGroup=aAAControlGroup, regionCode=regionCode, sMTPEmailAlert=sMTPEmailAlert, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, smtpGroup=smtpGroup, channelBandwidth=channelBandwidth, tFTPServerPortNumber=tFTPServerPortNumber, alarms=alarms, transmitPower=transmitPower, sNMPTrapIPAddress=sNMPTrapIPAddress, PYSNMP_MODULE_ID=cambium, frequencyVariant=frequencyVariant, dfsPeaks=dfsPeaks, sNMPPortNumber=sNMPPortNumber, wirelessLinkStatus=wirelessLinkStatus, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPServerIPAddress=sMTPServerIPAddress, userTable=userTable, groupID=groupID, sNMPEnabledTraps=sNMPEnabledTraps, syslogState=syslogState, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ethernet=ethernet, sNMPTrapTable=sNMPTrapTable, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, tFTPServerIPAddress=tFTPServerIPAddress, telecomsInterface=telecomsInterface, vLANPriorityTable=vLANPriorityTable, licensedCapacity=licensedCapacity, linkSymmetry=linkSymmetry, management=management, enabledDiagnosticAlarms=enabledDiagnosticAlarms, timeZone=timeZone, encryptionAlgorithm=encryptionAlgorithm, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sMTPEnabledMessages=sMTPEnabledMessages, telnetAccessEnabled=telnetAccessEnabled, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, snmpControlGroup=snmpControlGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, installStatus=installStatus, bootVersion=bootVersion, transmitModulationMode=transmitModulationMode, ptp=ptp, productVariant=productVariant, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTable=dfsTable, iPAddress=iPAddress, secondarySoftwareVersion=secondarySoftwareVersion, syslogLocalWrappedTrap=syslogLocalWrappedTrap, configurationGroup=configurationGroup, sNMPv3Enable=sNMPv3Enable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, supplementary=supplementary, dfsGroup=dfsGroup, receiveFreqMHz=receiveFreqMHz, systemReset=systemReset, softwareVersion=softwareVersion, hardwareVersion=hardwareVersion, accessMethod=accessMethod, latitude=latitude, installArmState=installArmState, notificationsGroup=notificationsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, transmitChannel=transmitChannel, gatewayIPAddress=gatewayIPAddress, masterSlaveMode=masterSlaveMode, ptmp=ptmp, ptpGroups=ptpGroups, receiveFreqKHz=receiveFreqKHz, productName=productName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, hTTPAccessEnabled=hTTPAccessEnabled, syslogControlGroup=syslogControlGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, targetMACAddress=targetMACAddress, cableLoss=cableLoss, hTTPSPortNumber=hTTPSPortNumber, receiveChannel=receiveChannel, versions=versions, telecom=telecom)
