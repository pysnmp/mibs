...
Counter64, Integer32, enterprises, TimeTicks, ModuleIdentity, MibIdentifier, Gauge32, NotificationType, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "enterprises", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Gauge32", "NotificationType", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", alarmsGroup=alarmsGroup, ptpTrapPrefix=ptpTrapPrefix, encryptionGroup=encryptionGroup, transmitModulationMode=transmitModulationMode, receiveModulationModeDetail=receiveModulationModeDetail, cableLoss=cableLoss, bandwidthVariant=bandwidthVariant, smtp=smtp, linkLoss=linkLoss, dfsPeaks=dfsPeaks, softwareVersion=softwareVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telecomsLoopbackTrap=telecomsLoopbackTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, telecomsInterface=telecomsInterface, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerIPAddress=sNTPServerIPAddress, smtpGroup=smtpGroup, dataPortWirelessDownAlert=dataPortWirelessDownAlert, encryption=encryption, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveModulationMode=receiveModulationMode, syslogState=syslogState, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receivePower=receivePower, linkModeOptimisation=linkModeOptimisation, incompatibleRegionCodes=incompatibleRegionCodes, remoteMaximumTransmitPower=remoteMaximumTransmitPower, channelChangeTrap=channelChangeTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPState=sNTPState, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsTable=dfsTable, telecomGroup=telecomGroup, transmitPower=transmitPower, hTTPSPortNumber=hTTPSPortNumber, ethernetFiberSupport=ethernetFiberSupport, ptpTraps=ptpTraps, dfsTableNumber=dfsTableNumber, encryptionAlgorithm=encryptionAlgorithm, useVLANForManagementInterfaces=useVLANForManagementInterfaces, syslogControlGroup=syslogControlGroup, transmitChannel=transmitChannel, signalStrengthRatio=signalStrengthRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, dataPortStatusTrap=dataPortStatusTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licence=licence, dfsMeans=dfsMeans, sNTPSync=sNTPSync, telnetPortNumber=telnetPortNumber, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, gatewayIPAddress=gatewayIPAddress, sntpGroup=sntpGroup, tDDControlGroup=tDDControlGroup, productVariant=productVariant, ethernetGroup=ethernetGroup, installArmState=installArmState, vectorError=vectorError, masterSlaveMode=masterSlaveMode, userTable=userTable, sNMPTrapTableEntry=sNMPTrapTableEntry, range=range, sNMPv3Enable=sNMPv3Enable, sMTPEnabledMessages=sMTPEnabledMessages, linkName=linkName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, maximumTransmitPower=maximumTransmitPower, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, antennaGain=antennaGain, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, userTableEntry=userTableEntry, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogControl=syslogControl, vLANPriorityTableNumber=vLANPriorityTableNumber, reset=reset, latitude=latitude, linkSymmetry=linkSymmetry, ethernet=ethernet, byteErrorRatio=byteErrorRatio, subnetMask=subnetMask, syslogClient=syslogClient, ptp500=ptp500, sntp=sntp, telecomsCableLength=telecomsCableLength, installStatusTrap=installStatusTrap, sMTPServerPortNumber=sMTPServerPortNumber, userTableIndex=userTableIndex, telecomsChannelStatus=telecomsChannelStatus, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlave=incompatibleMasterAndSlave, telecomsChannelStatusTrap=telecomsChannelStatusTrap, accessMethod=accessMethod, userRole=userRole, dfsTableIndex=dfsTableIndex, snmpControl=snmpControl, sNTPLastSync=sNTPLastSync, wirelessLinkAvailability=wirelessLinkAvailability, wirelessLinkStatus=wirelessLinkStatus, sNTPPollInterval=sNTPPollInterval, receiveFreqKHz=receiveFreqKHz, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tFTPServerPortNumber=tFTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecom=telecom, phyControl=phyControl, telecomsLoopback=telecomsLoopback, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, unitOutOfCalibration=unitOutOfCalibration, dfs=dfs, dfsTableEntry=dfsTableEntry, channelBandwidth=channelBandwidth, siteName=siteName, systemReset=systemReset, enabledDiagnosticAlarms=enabledDiagnosticAlarms, configurationGroup=configurationGroup, ptp=ptp, phyControlGroup=phyControlGroup, userName=userName, altitude=altitude, sNTPSyncTrap=sNTPSyncTrap, syslogClientTrap=syslogClientTrap, versionsGroup=versionsGroup, ptpCompliance=ptpCompliance, receiveFreqMHz=receiveFreqMHz, cambium=cambium, longitude=longitude, ptpGroups=ptpGroups, telecomsLineCode=telecomsLineCode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, secondarySoftwareVersion=secondarySoftwareVersion, tDDControl=tDDControl, vLANPriorityTableEntry=vLANPriorityTableEntry, userEnabled=userEnabled, receiveChannel=receiveChannel, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, supplementary=supplementary, eIRP=eIRP, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortStatus=dataPortStatus, syslogStateTrap=syslogStateTrap, tFTPServerIPAddress=tFTPServerIPAddress, installStatus=installStatus, PYSNMP_MODULE_ID=cambium, dataPortAutoMdix=dataPortAutoMdix, capacityLicenseMismatch=capacityLicenseMismatch, aAAControl=aAAControl, configuration=configuration, ptmp=ptmp, regionCode=regionCode, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productName=productName, daylightSaving=daylightSaving, aAAControlGroup=aAAControlGroup, hTTPAccessEnabled=hTTPAccessEnabled, phyStatus=phyStatus, iPAddress=iPAddress, vLANManagementVID=vLANManagementVID, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, userTableNumber=userTableNumber, sNMPTrapTable=sNMPTrapTable, systemClock=systemClock, supplementaryGroup=supplementaryGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, pubStats=pubStats, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityTable=vLANPriorityTable, frequencyVariant=frequencyVariant, userPassword=userPassword, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, notificationsGroup=notificationsGroup, snmpControlGroup=snmpControlGroup, hTTPPortNumber=hTTPPortNumber, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, regionCodeTrap=regionCodeTrap, targetMACAddress=targetMACAddress, dataPortDisabledWarning=dataPortDisabledWarning, installArmStateTrap=installArmStateTrap, licensedCapacity=licensedCapacity, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitFreqMHz=transmitFreqMHz, pubStatsGroup=pubStatsGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, transmitFreqKHz=transmitFreqKHz, sMTPServerIPAddress=sMTPServerIPAddress, sNTPServerPortNumber=sNTPServerPortNumber, resetGroup=resetGroup, phyStatusGroup=phyStatusGroup, versions=versions, management=management, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, searchState=searchState, sNMPCommunityString=sNMPCommunityString, hardwareVersion=hardwareVersion, receiveDataRate=receiveDataRate, dfsGroup=dfsGroup, licenceGroup=licenceGroup, remoteIPAddress=remoteIPAddress, transmitDataRate=transmitDataRate, timeZone=timeZone, bootVersion=bootVersion, alarms=alarms, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, groupID=groupID, vLANManagementPriority=vLANManagementPriority, managementGroup=managementGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, telnetAccessEnabled=telnetAccessEnabled)
