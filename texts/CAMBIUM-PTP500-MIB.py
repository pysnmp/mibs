...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, iso, enterprises, TimeTicks, IpAddress, Gauge32, ObjectIdentity, Counter64, ModuleIdentity, Bits, NotificationType, Counter32, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "iso", "enterprises", "TimeTicks", "IpAddress", "Gauge32", "ObjectIdentity", "Counter64", "ModuleIdentity", "Bits", "NotificationType", "Counter32", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", telecomsLoopbackTrap=telecomsLoopbackTrap, accessMethod=accessMethod, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDControlGroup=tDDControlGroup, ptpGroups=ptpGroups, channelBandwidth=channelBandwidth, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sMTPEnabledMessages=sMTPEnabledMessages, ptpCompliance=ptpCompliance, dfsTableEntry=dfsTableEntry, dfsTableIndex=dfsTableIndex, versions=versions, wirelessLinkStatus=wirelessLinkStatus, licensedCapacity=licensedCapacity, installArmState=installArmState, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTable=vLANPriorityTable, syslogClientTrap=syslogClientTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, userTableNumber=userTableNumber, ptp500=ptp500, vectorError=vectorError, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, hTTPAccessEnabled=hTTPAccessEnabled, phyControlGroup=phyControlGroup, systemClock=systemClock, daylightSaving=daylightSaving, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerPortNumber=sNTPServerPortNumber, sNMPCommunityString=sNMPCommunityString, userName=userName, receiveModulationMode=receiveModulationMode, sNMPTrapTableEntry=sNMPTrapTableEntry, aAAControlGroup=aAAControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, installStatus=installStatus, dfs=dfs, receiveFreqMHz=receiveFreqMHz, phyControl=phyControl, transmitModulationMode=transmitModulationMode, latitude=latitude, managementGroup=managementGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, transmitFreqMHz=transmitFreqMHz, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, eIRP=eIRP, phyStatusGroup=phyStatusGroup, signalStrengthRatio=signalStrengthRatio, alarms=alarms, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitChannel=transmitChannel, management=management, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, telecomsLoopback=telecomsLoopback, dataPortStatusTrap=dataPortStatusTrap, maximumTransmitPower=maximumTransmitPower, linkModeOptimisation=linkModeOptimisation, antennaGain=antennaGain, userTableIndex=userTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, bootVersion=bootVersion, dfsGroup=dfsGroup, transmitFreqKHz=transmitFreqKHz, encryption=encryption, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, vLANManagementPriority=vLANManagementPriority, sMTPServerPortNumber=sMTPServerPortNumber, siteName=siteName, vLANPriorityTableNumber=vLANPriorityTableNumber, iPAddress=iPAddress, reset=reset, snmpControlGroup=snmpControlGroup, altitude=altitude, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dfsMeans=dfsMeans, sNMPTrapTableIndex=sNMPTrapTableIndex, longitude=longitude, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityTableIndex=vLANPriorityTableIndex, userTableEntry=userTableEntry, sNTPState=sNTPState, receiveDataRate=receiveDataRate, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelStatus=telecomsChannelStatus, gatewayIPAddress=gatewayIPAddress, sNTPPollInterval=sNTPPollInterval, receiveModulationModeDetail=receiveModulationModeDetail, noWirelessChannelAvailable=noWirelessChannelAvailable, notificationsGroup=notificationsGroup, telecom=telecom, dataPortAutoMdix=dataPortAutoMdix, telecomsLineCode=telecomsLineCode, capacityLicenseMismatch=capacityLicenseMismatch, syslogState=syslogState, syslogStateTrap=syslogStateTrap, ethernetFiberSupport=ethernetFiberSupport, sntpGroup=sntpGroup, receiveChannel=receiveChannel, transmitPower=transmitPower, sNMPTrapTable=sNMPTrapTable, dfsTableNumber=dfsTableNumber, smtp=smtp, telecomsCableLength=telecomsCableLength, sNTPLastSync=sNTPLastSync, byteErrorRatio=byteErrorRatio, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, hardwareVersion=hardwareVersion, sNMPPortNumber=sNMPPortNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, targetMACAddress=targetMACAddress, syslogControl=syslogControl, configuration=configuration, telnetPortNumber=telnetPortNumber, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPv3Enable=sNMPv3Enable, snmpControl=snmpControl, productVariant=productVariant, receiveFreqKHz=receiveFreqKHz, vLANManagementVID=vLANManagementVID, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, sNTPServerIPAddress=sNTPServerIPAddress, dfsPeaks=dfsPeaks, masterSlaveMode=masterSlaveMode, linkLoss=linkLoss, syslogControlGroup=syslogControlGroup, hTTPPortNumber=hTTPPortNumber, sNTPSyncTrap=sNTPSyncTrap, searchState=searchState, range=range, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, configurationGroup=configurationGroup, linkSymmetry=linkSymmetry, cambium=cambium, alarmsGroup=alarmsGroup, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, telecomGroup=telecomGroup, userRole=userRole, phyStatus=phyStatus, smtpGroup=smtpGroup, sNMPTrapVersion=sNMPTrapVersion, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installStatusTrap=installStatusTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, ptpTraps=ptpTraps, encryptionGroup=encryptionGroup, sNTPSync=sNTPSync, sntp=sntp, groupID=groupID, ethernet=ethernet, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, PYSNMP_MODULE_ID=cambium, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sMTPServerIPAddress=sMTPServerIPAddress, telecomsInterface=telecomsInterface, channelChangeTrap=channelChangeTrap, subnetMask=subnetMask, hTTPSAccessEnabled=hTTPSAccessEnabled, ethernetGroup=ethernetGroup, versionsGroup=versionsGroup, sNMPTrapPortNumber=sNMPTrapPortNumber, productName=productName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, systemReset=systemReset, regionCode=regionCode, secondarySoftwareVersion=secondarySoftwareVersion, userEnabled=userEnabled, regionCodeTrap=regionCodeTrap, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unitOutOfCalibration=unitOutOfCalibration, syslogLocalWrappedTrap=syslogLocalWrappedTrap, supplementary=supplementary, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPEnabledTraps=sNMPEnabledTraps, tDDSynchronizationMode=tDDSynchronizationMode, userPassword=userPassword, licence=licence, linkName=linkName, sNMPTrapIPAddress=sNMPTrapIPAddress, cableLoss=cableLoss, ptmp=ptmp, aAAControl=aAAControl, tFTPServerIPAddress=tFTPServerIPAddress, softwareVersion=softwareVersion, syslogClient=syslogClient, incompatibleRegionCodes=incompatibleRegionCodes, dataPortStatus=dataPortStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, telnetAccessEnabled=telnetAccessEnabled, installArmStateTrap=installArmStateTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, frequencyVariant=frequencyVariant, tDDControl=tDDControl, vLANPriorityTableEntry=vLANPriorityTableEntry, ptpTrapPrefix=ptpTrapPrefix, supplementaryGroup=supplementaryGroup, licenceGroup=licenceGroup, dfsTable=dfsTable, sMTPEmailAlert=sMTPEmailAlert, resetGroup=resetGroup, receivePower=receivePower, timeZone=timeZone, sNMPTrapTableNumber=sNMPTrapTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortWirelessDownAlert=dataPortWirelessDownAlert, userTable=userTable, ptp=ptp, pubStatsGroup=pubStatsGroup, bandwidthVariant=bandwidthVariant, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, pubStats=pubStats)
