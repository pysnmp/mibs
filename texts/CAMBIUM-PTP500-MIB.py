...
# Produced by pysmi-1.1.8 at Tue Jan 11 21:13:12 2022
...
Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Gauge32, iso, IpAddress, TimeTicks, MibIdentifier, Counter32, Counter64, NotificationType, ObjectIdentity, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Gauge32", "iso", "IpAddress", "TimeTicks", "MibIdentifier", "Counter32", "Counter64", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Bits")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vectorError=vectorError, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPEnabledMessages=sMTPEnabledMessages, channelBandwidth=channelBandwidth, encryptionAlgorithm=encryptionAlgorithm, sMTPEmailAlert=sMTPEmailAlert, ethernet=ethernet, phyStatusGroup=phyStatusGroup, systemClock=systemClock, tDDSynchronizationStatus=tDDSynchronizationStatus, snmpControl=snmpControl, tDDSynchronizationAlarm=tDDSynchronizationAlarm, hTTPSPortNumber=hTTPSPortNumber, telecom=telecom, vLANManagementVID=vLANManagementVID, altitude=altitude, channelChangeTrap=channelChangeTrap, transmitChannel=transmitChannel, sNTPSyncTrap=sNTPSyncTrap, phyStatus=phyStatus, telecomsCableLength=telecomsCableLength, ptpTraps=ptpTraps, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, snmpControlGroup=snmpControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, daylightSaving=daylightSaving, subnetMask=subnetMask, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPPortNumber=hTTPPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, productVariant=productVariant, accessMethod=accessMethod, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, masterSlaveMode=masterSlaveMode, longitude=longitude, smtp=smtp, antennaGain=antennaGain, groupID=groupID, remoteIPAddress=remoteIPAddress, dataPortAutoNegotiation=dataPortAutoNegotiation, dfsMeans=dfsMeans, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANManagementPriority=vLANManagementPriority, sNMPTrapVersion=sNMPTrapVersion, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogStateTrap=syslogStateTrap, ptpTrapPrefix=ptpTrapPrefix, userName=userName, sNMPTrapTableNumber=sNMPTrapTableNumber, sNTPPollInterval=sNTPPollInterval, userPassword=userPassword, targetMACAddress=targetMACAddress, sNMPTrapPortNumber=sNMPTrapPortNumber, ptmp=ptmp, sNMPEnabledTraps=sNMPEnabledTraps, receiveModulationMode=receiveModulationMode, maximumTransmitPower=maximumTransmitPower, reset=reset, ethernetFiberSupport=ethernetFiberSupport, sNMPv3Enable=sNMPv3Enable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetGroup=ethernetGroup, vLANPriorityTable=vLANPriorityTable, searchState=searchState, dfs=dfs, dfsGroup=dfsGroup, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, telecomsInterface=telecomsInterface, transmitPower=transmitPower, pubStatsGroup=pubStatsGroup, receiveChannel=receiveChannel, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, latitude=latitude, sMTPSourceEmailAddress=sMTPSourceEmailAddress, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitDataRate=transmitDataRate, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bootVersion=bootVersion, tFTPServerIPAddress=tFTPServerIPAddress, tFTPServerPortNumber=tFTPServerPortNumber, userTableIndex=userTableIndex, dataPortDisabledWarning=dataPortDisabledWarning, ptp500=ptp500, resetGroup=resetGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, management=management, encryptionGroup=encryptionGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, telnetPortNumber=telnetPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, versions=versions, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, tDDControl=tDDControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, userRole=userRole, gatewayIPAddress=gatewayIPAddress, softwareVersion=softwareVersion, aggregateDataRate=aggregateDataRate, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveFreqMHz=receiveFreqMHz, userTable=userTable, dfsTableEntry=dfsTableEntry, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkAvailability=wirelessLinkAvailability, sNTPServerIPAddress=sNTPServerIPAddress, linkName=linkName, linkLoss=linkLoss, sNTPLastSync=sNTPLastSync, sNMPPortNumber=sNMPPortNumber, capacityLicenseMismatch=capacityLicenseMismatch, telecomsChannelStatus=telecomsChannelStatus, eIRP=eIRP, telecomsChannelStatusTrap=telecomsChannelStatusTrap, timeZone=timeZone, configuration=configuration, range=range, versionsGroup=versionsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitModulationMode=transmitModulationMode, smtpGroup=smtpGroup, installStatus=installStatus, secondarySoftwareVersion=secondarySoftwareVersion, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsTable=dfsTable, iPAddress=iPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogState=syslogState, dataPortStatus=dataPortStatus, productName=productName, pubStats=pubStats, sNMPCommunityString=sNMPCommunityString, sNTPSync=sNTPSync, sntpGroup=sntpGroup, supplementary=supplementary, sNTPServerPortNumber=sNTPServerPortNumber, hardwareVersion=hardwareVersion, remoteMaximumTransmitPower=remoteMaximumTransmitPower, managementGroup=managementGroup, PYSNMP_MODULE_ID=cambium, frequencyVariant=frequencyVariant, userTableEntry=userTableEntry, linkModeOptimisation=linkModeOptimisation, cambium=cambium, supplementaryGroup=supplementaryGroup, sNTPState=sNTPState, telecomsLoopbackTrap=telecomsLoopbackTrap, regionCodeTrap=regionCodeTrap, incompatibleRegionCodes=incompatibleRegionCodes, sNMPTrapTableEntry=sNMPTrapTableEntry, tDDSynchronizationMode=tDDSynchronizationMode, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, syslogControl=syslogControl, useVLANForManagementInterfaces=useVLANForManagementInterfaces, siteName=siteName, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, alarmsGroup=alarmsGroup, ptp=ptp, tDDControlGroup=tDDControlGroup, licensedCapacity=licensedCapacity, phyControl=phyControl, transmitFreqMHz=transmitFreqMHz, hTTPSAccessEnabled=hTTPSAccessEnabled, wirelessLinkStatus=wirelessLinkStatus, dfsPeaks=dfsPeaks, syslogControlGroup=syslogControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, userTableNumber=userTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitFreqKHz=transmitFreqKHz, telnetAccessEnabled=telnetAccessEnabled, receiveDataRate=receiveDataRate, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, configurationGroup=configurationGroup, aAAControlGroup=aAAControlGroup, receivePower=receivePower, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTable=sNMPTrapTable, notificationsGroup=notificationsGroup, installArmStateTrap=installArmStateTrap, systemReset=systemReset, installStatusTrap=installStatusTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licence=licence, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, telecomsLineCode=telecomsLineCode, dataPortConfigurationMismatch=dataPortConfigurationMismatch, receiveModulationModeDetail=receiveModulationModeDetail, regionCode=regionCode, encryption=encryption, sMTPServerPortNumber=sMTPServerPortNumber, byteErrorRatio=byteErrorRatio, cableLoss=cableLoss, receiveFreqKHz=receiveFreqKHz, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibration=unitOutOfCalibration, phyControlGroup=phyControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, licenceGroup=licenceGroup, hTTPAccessEnabled=hTTPAccessEnabled, linkSymmetry=linkSymmetry, vLANPriorityTableEntry=vLANPriorityTableEntry, bandwidthVariant=bandwidthVariant, installArmState=installArmState, sntp=sntp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, signalStrengthRatio=signalStrengthRatio, ptpCompliance=ptpCompliance, ptpGroups=ptpGroups, dfsTableNumber=dfsTableNumber, telecomsLoopback=telecomsLoopback, userEnabled=userEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, dfsTableIndex=dfsTableIndex, telecomGroup=telecomGroup, syslogClient=syslogClient, aAAControl=aAAControl, dataPortStatusTrap=dataPortStatusTrap, syslogClientTrap=syslogClientTrap)
