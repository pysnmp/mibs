...
# Produced by pysmi-1.1.3 at Sun Nov 28 14:22:35 2021
...
iso, Bits, TimeTicks, Counter32, Unsigned32, MibIdentifier, ObjectIdentity, IpAddress, enterprises, Integer32, Gauge32, ModuleIdentity, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "TimeTicks", "Counter32", "Unsigned32", "MibIdentifier", "ObjectIdentity", "IpAddress", "enterprises", "Integer32", "Gauge32", "ModuleIdentity", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogControlGroup=syslogControlGroup, regionCode=regionCode, transmitChannel=transmitChannel, aAAControl=aAAControl, receiveChannel=receiveChannel, systemReset=systemReset, pubStats=pubStats, dfsPeaks=dfsPeaks, remoteIPAddress=remoteIPAddress, productName=productName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogState=syslogState, dfsTableIndex=dfsTableIndex, altitude=altitude, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortAutoMdix=dataPortAutoMdix, regionCodeTrap=regionCodeTrap, sMTPEmailAlert=sMTPEmailAlert, accessMethod=accessMethod, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, bootVersion=bootVersion, smtp=smtp, linkModeOptimisation=linkModeOptimisation, ptpCompliance=ptpCompliance, notificationsGroup=notificationsGroup, phyStatus=phyStatus, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, sNTPSyncTrap=sNTPSyncTrap, transmitPower=transmitPower, maximumTransmitPower=maximumTransmitPower, sNMPv3Enable=sNMPv3Enable, userTableEntry=userTableEntry, sNMPEnabledTraps=sNMPEnabledTraps, subnetMask=subnetMask, userPassword=userPassword, transmitFreqKHz=transmitFreqKHz, versionsGroup=versionsGroup, softwareVersion=softwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, latitude=latitude, vLANManagementVID=vLANManagementVID, noWirelessChannelAvailable=noWirelessChannelAvailable, telecom=telecom, tDDControlGroup=tDDControlGroup, masterSlaveMode=masterSlaveMode, userTableIndex=userTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecomsLoopback=telecomsLoopback, telecomsChannelStatus=telecomsChannelStatus, hTTPAccessEnabled=hTTPAccessEnabled, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPPortNumber=sNMPPortNumber, dfsTable=dfsTable, sNTPPollInterval=sNTPPollInterval, smtpGroup=smtpGroup, linkSymmetry=linkSymmetry, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPCommunityString=sNMPCommunityString, timeZone=timeZone, searchState=searchState, vectorError=vectorError, dataPortConfigurationMismatch=dataPortConfigurationMismatch, tDDControl=tDDControl, telecomsLineCode=telecomsLineCode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, licence=licence, supplementary=supplementary, resetGroup=resetGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementPriority=vLANManagementPriority, groupID=groupID, receivePower=receivePower, unitOutOfCalibration=unitOutOfCalibration, systemClock=systemClock, phyControlGroup=phyControlGroup, userTable=userTable, telecomsChannelStatusTrap=telecomsChannelStatusTrap, sNMPTrapTable=sNMPTrapTable, bandwidthVariant=bandwidthVariant, PYSNMP_MODULE_ID=cambium, enabledDiagnosticAlarms=enabledDiagnosticAlarms, eIRP=eIRP, receiveModulationModeDetail=receiveModulationModeDetail, sNTPState=sNTPState, snmpControlGroup=snmpControlGroup, channelBandwidth=channelBandwidth, range=range, ptpTraps=ptpTraps, vLANPriorityTable=vLANPriorityTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, licensedCapacity=licensedCapacity, sNMPTrapVersion=sNMPTrapVersion, cableLoss=cableLoss, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodes=incompatibleRegionCodes, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNTPServerPortNumber=sNTPServerPortNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, transmitDataRate=transmitDataRate, syslogClient=syslogClient, siteName=siteName, ethernetFiberSupport=ethernetFiberSupport, receiveModulationMode=receiveModulationMode, ptmp=ptmp, ptpTrapPrefix=ptpTrapPrefix, linkName=linkName, phyStatusGroup=phyStatusGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, byteErrorRatio=byteErrorRatio, telnetAccessEnabled=telnetAccessEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, channelChangeTrap=channelChangeTrap, iPAddress=iPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, targetMACAddress=targetMACAddress, phyControl=phyControl, dataPortWirelessDownAlert=dataPortWirelessDownAlert, management=management, sMTPEnabledMessages=sMTPEnabledMessages, managementGroup=managementGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitModulationMode=transmitModulationMode, dfs=dfs, productVariant=productVariant, gatewayIPAddress=gatewayIPAddress, hTTPSPortNumber=hTTPSPortNumber, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, transmitFreqMHz=transmitFreqMHz, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, reset=reset, encryption=encryption, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPServerPortNumber=tFTPServerPortNumber, installArmStateTrap=installArmStateTrap, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, telecomsLoopbackTrap=telecomsLoopbackTrap, snmpControl=snmpControl, frequencyVariant=frequencyVariant, aAAControlGroup=aAAControlGroup, secondarySoftwareVersion=secondarySoftwareVersion, installStatus=installStatus, sMTPServerIPAddress=sMTPServerIPAddress, userTableNumber=userTableNumber, licenceGroup=licenceGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, receiveFreqMHz=receiveFreqMHz, alarmsGroup=alarmsGroup, hardwareVersion=hardwareVersion, configuration=configuration, wirelessLinkAvailability=wirelessLinkAvailability, hTTPPortNumber=hTTPPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogControl=syslogControl, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sntp=sntp, alarms=alarms, ptpGroups=ptpGroups, vLANPriorityTableNumber=vLANPriorityTableNumber, cambium=cambium, syslogStateTrap=syslogStateTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telnetPortNumber=telnetPortNumber, sNTPLastSync=sNTPLastSync, dataPortDisabledWarning=dataPortDisabledWarning, installStatusTrap=installStatusTrap, dfsTableNumber=dfsTableNumber, wirelessLinkStatus=wirelessLinkStatus, capacityLicenseMismatch=capacityLicenseMismatch, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, longitude=longitude, dfsTableEntry=dfsTableEntry, telecomsCableLength=telecomsCableLength, versions=versions, pubStatsGroup=pubStatsGroup, daylightSaving=daylightSaving, ptp500=ptp500, userEnabled=userEnabled, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tFTPServerIPAddress=tFTPServerIPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, ethernet=ethernet, telecomGroup=telecomGroup, linkLoss=linkLoss, signalStrengthRatio=signalStrengthRatio, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmState=installArmState, sMTPServerPortNumber=sMTPServerPortNumber, syslogClientTrap=syslogClientTrap, encryptionGroup=encryptionGroup, antennaGain=antennaGain, dfsGroup=dfsGroup, receiveDataRate=receiveDataRate, aggregateDataRate=aggregateDataRate, sNMPTrapTableNumber=sNMPTrapTableNumber, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationMode=tDDSynchronizationMode, dfsMeans=dfsMeans, ethernetGroup=ethernetGroup, ptp=ptp, sNMPTrapTableEntry=sNMPTrapTableEntry, userName=userName, sNTPSync=sNTPSync, configurationGroup=configurationGroup, sntpGroup=sntpGroup, userRole=userRole, receiveFreqKHz=receiveFreqKHz, supplementaryGroup=supplementaryGroup, dataPortStatus=dataPortStatus, sMTPSourceEmailAddress=sMTPSourceEmailAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup)
