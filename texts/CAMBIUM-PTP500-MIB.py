...
# Produced by pysmi-1.1.8 at Fri Jan  7 17:35:41 2022
...
Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Bits, Counter64, Counter32, ObjectIdentity, Unsigned32, MibIdentifier, TimeTicks, enterprises, Gauge32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Bits", "Counter64", "Counter32", "ObjectIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "enterprises", "Gauge32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", smtp=smtp, transmitFreqKHz=transmitFreqKHz, ptpCompliance=ptpCompliance, phyControlGroup=phyControlGroup, cableLoss=cableLoss, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, remoteMaximumTransmitPower=remoteMaximumTransmitPower, siteName=siteName, softwareVersion=softwareVersion, sNMPTrapTableEntry=sNMPTrapTableEntry, syslogLocalWrappedTrap=syslogLocalWrappedTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dfsMeans=dfsMeans, sMTPEnabledMessages=sMTPEnabledMessages, transmitChannel=transmitChannel, receiveFreqKHz=receiveFreqKHz, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, targetMACAddress=targetMACAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapTableIndex=sNMPTrapTableIndex, linkModeOptimisation=linkModeOptimisation, linkSymmetry=linkSymmetry, telecomGroup=telecomGroup, telecom=telecom, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNTPPollInterval=sNTPPollInterval, encryption=encryption, sNMPTrapTableNumber=sNMPTrapTableNumber, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dataPortAutoMdix=dataPortAutoMdix, ptpGroups=ptpGroups, ptpTraps=ptpTraps, sNMPTrapTable=sNMPTrapTable, hTTPAccessEnabled=hTTPAccessEnabled, telnetPortNumber=telnetPortNumber, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPSync=sNTPSync, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfs=dfs, receiveFreqMHz=receiveFreqMHz, transmitPower=transmitPower, versionsGroup=versionsGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ethernet=ethernet, sNTPLastSync=sNTPLastSync, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, capacityLicenseMismatch=capacityLicenseMismatch, versions=versions, pubStatsGroup=pubStatsGroup, accessMethod=accessMethod, syslogControlGroup=syslogControlGroup, vLANManagementVID=vLANManagementVID, systemReset=systemReset, telecomsCableLength=telecomsCableLength, productVariant=productVariant, ptp500=ptp500, range=range, antennaGain=antennaGain, masterSlaveMode=masterSlaveMode, telnetAccessEnabled=telnetAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, managementGroup=managementGroup, tDDControlGroup=tDDControlGroup, remoteIPAddress=remoteIPAddress, smtpGroup=smtpGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptmp=ptmp, configurationGroup=configurationGroup, telecomsLoopback=telecomsLoopback, transmitFreqMHz=transmitFreqMHz, wirelessLinkStatus=wirelessLinkStatus, ethernetGroup=ethernetGroup, dfsTableNumber=dfsTableNumber, transmitDataRate=transmitDataRate, licensedCapacity=licensedCapacity, userRole=userRole, sNMPv3Enable=sNMPv3Enable, sNTPState=sNTPState, notificationsGroup=notificationsGroup, dataPortStatus=dataPortStatus, hTTPPortNumber=hTTPPortNumber, phyControl=phyControl, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, gatewayIPAddress=gatewayIPAddress, linkName=linkName, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, telecomsInterface=telecomsInterface, sNMPEnabledTraps=sNMPEnabledTraps, sNTPSyncTrap=sNTPSyncTrap, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, subnetMask=subnetMask, productName=productName, syslogState=syslogState, sntpGroup=sntpGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, encryptionAlgorithm=encryptionAlgorithm, supplementaryGroup=supplementaryGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, phyStatusGroup=phyStatusGroup, encryptionGroup=encryptionGroup, hTTPSPortNumber=hTTPSPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, snmpControl=snmpControl, unitOutOfCalibration=unitOutOfCalibration, aAAControl=aAAControl, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dfsGroup=dfsGroup, dfsTableEntry=dfsTableEntry, eIRP=eIRP, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNTPServerPortNumber=sNTPServerPortNumber, licenceGroup=licenceGroup, sNMPCommunityString=sNMPCommunityString, wirelessLinkAvailability=wirelessLinkAvailability, aggregateDataRate=aggregateDataRate, dataPortDisabledWarning=dataPortDisabledWarning, hardwareVersion=hardwareVersion, PYSNMP_MODULE_ID=cambium, userEnabled=userEnabled, telecomsChannelStatusTrap=telecomsChannelStatusTrap, management=management, ptp=ptp, telecomsChannelStatus=telecomsChannelStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogClientTrap=syslogClientTrap, supplementary=supplementary, noWirelessChannelAvailable=noWirelessChannelAvailable, sntp=sntp, channelChangeTrap=channelChangeTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, receiveModulationMode=receiveModulationMode, vLANPriorityQueueMapping=vLANPriorityQueueMapping, pubStats=pubStats, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, frequencyVariant=frequencyVariant, licence=licence, dataPortAutoNegotiation=dataPortAutoNegotiation, vLANManagementPriority=vLANManagementPriority, vLANPriorityTableIndex=vLANPriorityTableIndex, channelBandwidth=channelBandwidth, installArmStateTrap=installArmStateTrap, userTableIndex=userTableIndex, reset=reset, cambium=cambium, aAAControlGroup=aAAControlGroup, syslogControl=syslogControl, dfsPeaks=dfsPeaks, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, ethernetFiberSupport=ethernetFiberSupport, sNMPPortNumber=sNMPPortNumber, phyStatus=phyStatus, bandwidthVariant=bandwidthVariant, incompatibleRegionCodes=incompatibleRegionCodes, groupID=groupID, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, longitude=longitude, receiveDataRate=receiveDataRate, altitude=altitude, tFTPServerIPAddress=tFTPServerIPAddress, dataPortStatusTrap=dataPortStatusTrap, telecomsLineCode=telecomsLineCode, tDDSynchronizationMode=tDDSynchronizationMode, secondarySoftwareVersion=secondarySoftwareVersion, dfsTable=dfsTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTable=userTable, configuration=configuration, alarmsGroup=alarmsGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, syslogClient=syslogClient, userTableEntry=userTableEntry, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, resetGroup=resetGroup, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, linkLoss=linkLoss, sMTPServerPortNumber=sMTPServerPortNumber, installStatusTrap=installStatusTrap, regionCodeTrap=regionCodeTrap, alarms=alarms, searchState=searchState, userPassword=userPassword, dfsTableIndex=dfsTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, syslogStateTrap=syslogStateTrap, daylightSaving=daylightSaving, latitude=latitude, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, systemClock=systemClock, ptpTrapPrefix=ptpTrapPrefix, installArmState=installArmState, sMTPServerIPAddress=sMTPServerIPAddress, regionCode=regionCode, sMTPEmailAlert=sMTPEmailAlert, receiveModulationModeDetail=receiveModulationModeDetail, vectorError=vectorError, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPTrapVersion=sNMPTrapVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, receivePower=receivePower, userTableNumber=userTableNumber, receiveChannel=receiveChannel, iPAddress=iPAddress, snmpControlGroup=snmpControlGroup, transmitModulationMode=transmitModulationMode, signalStrengthRatio=signalStrengthRatio, userName=userName, bootVersion=bootVersion, timeZone=timeZone, telecomsLoopbackTrap=telecomsLoopbackTrap, vLANPriorityTable=vLANPriorityTable, installStatus=installStatus, tDDControl=tDDControl)
