...
ModuleIdentity, IpAddress, MibIdentifier, Integer32, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Unsigned32, Counter64, enterprises, Gauge32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "MibIdentifier", "Integer32", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Unsigned32", "Counter64", "enterprises", "Gauge32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortStatusTrap=dataPortStatusTrap, smtp=smtp, tFTPServerPortNumber=tFTPServerPortNumber, dfsGroup=dfsGroup, encryptionAlgorithm=encryptionAlgorithm, dfsTable=dfsTable, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, versions=versions, sNMPPortNumber=sNMPPortNumber, supplementary=supplementary, tFTPServerIPAddress=tFTPServerIPAddress, transmitPower=transmitPower, aggregateDataRate=aggregateDataRate, vLANPriorityTableNumber=vLANPriorityTableNumber, hTTPAccessEnabled=hTTPAccessEnabled, sNTPState=sNTPState, regionCode=regionCode, vLANPriorityTableEntry=vLANPriorityTableEntry, encryption=encryption, hTTPSPortNumber=hTTPSPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntpGroup=sntpGroup, receiveModulationModeDetail=receiveModulationModeDetail, receiveDataRate=receiveDataRate, userTableEntry=userTableEntry, dfs=dfs, siteName=siteName, sntp=sntp, dfsPeaks=dfsPeaks, productName=productName, sMTPEmailAlert=sMTPEmailAlert, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, installStatusTrap=installStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsLoopbackTrap=telecomsLoopbackTrap, longitude=longitude, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, userTable=userTable, aAAControlGroup=aAAControlGroup, encryptionGroup=encryptionGroup, transmitChannel=transmitChannel, telecomsLineCode=telecomsLineCode, syslogClient=syslogClient, cambium=cambium, receiveChannel=receiveChannel, altitude=altitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, pubStats=pubStats, telecomsCableLength=telecomsCableLength, licensedCapacity=licensedCapacity, syslogStateTrap=syslogStateTrap, configuration=configuration, reset=reset, resetGroup=resetGroup, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsInterface=telecomsInterface, vectorError=vectorError, ptpTrapPrefix=ptpTrapPrefix, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, management=management, signalStrengthRatio=signalStrengthRatio, wirelessLinkAvailability=wirelessLinkAvailability, constantPowerSpectralDensity=constantPowerSpectralDensity, snmpControl=snmpControl, linkLoss=linkLoss, snmpControlGroup=snmpControlGroup, sNMPTrapTableIndex=sNMPTrapTableIndex, vLANPriorityTable=vLANPriorityTable, sNMPTrapTableEntry=sNMPTrapTableEntry, timeZone=timeZone, installStatus=installStatus, ethernetGroup=ethernetGroup, transmitModulationMode=transmitModulationMode, syslogLocalWrappedTrap=syslogLocalWrappedTrap, bandwidthVariant=bandwidthVariant, telnetPortNumber=telnetPortNumber, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogState=syslogState, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, receiveFreqMHz=receiveFreqMHz, receiveFreqKHz=receiveFreqKHz, dataPortStatus=dataPortStatus, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPv3Enable=sNMPv3Enable, alarmsGroup=alarmsGroup, systemReset=systemReset, linkSymmetry=linkSymmetry, searchState=searchState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, syslogControlGroup=syslogControlGroup, sNMPCommunityString=sNMPCommunityString, sNTPServerIPAddress=sNTPServerIPAddress, receivePower=receivePower, userEnabled=userEnabled, incompatibleMasterAndSlave=incompatibleMasterAndSlave, regionCodeTrap=regionCodeTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, userTableNumber=userTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortAutoMdix=dataPortAutoMdix, telecom=telecom, sNTPPollInterval=sNTPPollInterval, notificationsGroup=notificationsGroup, aAAControl=aAAControl, range=range, dfsTableNumber=dfsTableNumber, sMTPEnabledMessages=sMTPEnabledMessages, userTableIndex=userTableIndex, ethernet=ethernet, alarms=alarms, telecomGroup=telecomGroup, telecomsLoopback=telecomsLoopback, ptp=ptp, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, accessMethod=accessMethod, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, maximumTransmitPower=maximumTransmitPower, sNMPEnabledTraps=sNMPEnabledTraps, frequencyVariant=frequencyVariant, userPassword=userPassword, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, eIRP=eIRP, remoteIPAddress=remoteIPAddress, supplementaryGroup=supplementaryGroup, ethernetFiberSupport=ethernetFiberSupport, tDDSynchronizationAlarm=tDDSynchronizationAlarm, smtpGroup=smtpGroup, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, vLANPriorityQueueMapping=vLANPriorityQueueMapping, bootVersion=bootVersion, syslogControl=syslogControl, ptpTraps=ptpTraps, sNTPServerPortNumber=sNTPServerPortNumber, antennaGain=antennaGain, subnetMask=subnetMask, ptpGroups=ptpGroups, sNTPLastSync=sNTPLastSync, hTTPPortNumber=hTTPPortNumber, linkModeOptimisation=linkModeOptimisation, hardwareVersion=hardwareVersion, linkName=linkName, ptmp=ptmp, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, PYSNMP_MODULE_ID=cambium, channelChangeTrap=channelChangeTrap, systemClock=systemClock, tDDSynchronizationStatus=tDDSynchronizationStatus, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, dfsTableEntry=dfsTableEntry, userName=userName, targetMACAddress=targetMACAddress, cableLoss=cableLoss, sNTPSyncTrap=sNTPSyncTrap, phyControlGroup=phyControlGroup, phyStatus=phyStatus, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, configurationGroup=configurationGroup, ptp500=ptp500, phyStatusGroup=phyStatusGroup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, noWirelessChannelAvailable=noWirelessChannelAvailable, transmitFreqMHz=transmitFreqMHz, latitude=latitude, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, iPAddress=iPAddress, channelBandwidth=channelBandwidth, vLANManagementPriority=vLANManagementPriority, telnetAccessEnabled=telnetAccessEnabled, sMTPServerPortNumber=sMTPServerPortNumber, versionsGroup=versionsGroup, sMTPServerIPAddress=sMTPServerIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, groupID=groupID, vLANManagementVID=vLANManagementVID, tDDSynchronizationMode=tDDSynchronizationMode, installArmStateTrap=installArmStateTrap, dfsTableIndex=dfsTableIndex, sNMPTrapVersion=sNMPTrapVersion, transmitDataRate=transmitDataRate, sNTPSync=sNTPSync, linkModeOptimizationMismatch=linkModeOptimizationMismatch, userRole=userRole, receiveModulationMode=receiveModulationMode, softwareVersion=softwareVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, tDDControl=tDDControl, byteErrorRatio=byteErrorRatio, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, secondarySoftwareVersion=secondarySoftwareVersion, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, licence=licence, dataPortDisabledWarning=dataPortDisabledWarning, sNMPTrapPortNumber=sNMPTrapPortNumber, masterSlaveMode=masterSlaveMode, transmitFreqKHz=transmitFreqKHz, phyControl=phyControl, wirelessLinkStatus=wirelessLinkStatus, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, telecomsChannelStatus=telecomsChannelStatus, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productVariant=productVariant, dataPortConfigurationMismatch=dataPortConfigurationMismatch, sNMPTrapTable=sNMPTrapTable, installArmState=installArmState, syslogClientTrap=syslogClientTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, daylightSaving=daylightSaving, dfsMeans=dfsMeans, tDDControlGroup=tDDControlGroup, licenceGroup=licenceGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, ptpCompliance=ptpCompliance, hTTPSAccessEnabled=hTTPSAccessEnabled, incompatibleRegionCodes=incompatibleRegionCodes, unitOutOfCalibration=unitOutOfCalibration, managementGroup=managementGroup)
