...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", accessMethod=accessMethod, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, hTTPPortNumber=hTTPPortNumber, signalStrengthRatio=signalStrengthRatio, telecom=telecom, syslogStateTrap=syslogStateTrap, alarmsGroup=alarmsGroup, sMTPServerPortNumber=sMTPServerPortNumber, syslogClientTrap=syslogClientTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLineCode=telecomsLineCode, ethernetGroup=ethernetGroup, telnetAccessEnabled=telnetAccessEnabled, bootVersion=bootVersion, userRole=userRole, hTTPAccessEnabled=hTTPAccessEnabled, sntpGroup=sntpGroup, configurationGroup=configurationGroup, dfsTableEntry=dfsTableEntry, masterSlaveMode=masterSlaveMode, tFTPServerIPAddress=tFTPServerIPAddress, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sNMPTrapTableIndex=sNMPTrapTableIndex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPSAccessEnabled=hTTPSAccessEnabled, maximumTransmitPower=maximumTransmitPower, longitude=longitude, dataPortStatus=dataPortStatus, receiveModulationMode=receiveModulationMode, receiveDataRate=receiveDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortStatusTrap=dataPortStatusTrap, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityTableIndex=vLANPriorityTableIndex, telecomsInterface=telecomsInterface, incompatibleMasterAndSlave=incompatibleMasterAndSlave, syslogControl=syslogControl, telecomsLoopbackTrap=telecomsLoopbackTrap, aAAControl=aAAControl, linkName=linkName, systemReset=systemReset, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sNMPTrapIPAddress=sNMPTrapIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, reset=reset, vLANPriorityTableEntry=vLANPriorityTableEntry, sNTPServerIPAddress=sNTPServerIPAddress, sNTPSync=sNTPSync, sMTPServerIPAddress=sMTPServerIPAddress, alarms=alarms, versions=versions, vLANManagementVID=vLANManagementVID, hardwareVersion=hardwareVersion, ptpGroups=ptpGroups, unitOutOfCalibration=unitOutOfCalibration, ptmp=ptmp, smtpGroup=smtpGroup, dfsTableIndex=dfsTableIndex, sNMPv3Enable=sNMPv3Enable, supplementary=supplementary, range=range, supplementaryGroup=supplementaryGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, syslogControlGroup=syslogControlGroup, capacityLicenseMismatch=capacityLicenseMismatch, wirelessLinkStatus=wirelessLinkStatus, regionCodeTrap=regionCodeTrap, phyControlGroup=phyControlGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, byteErrorRatio=byteErrorRatio, tDDControl=tDDControl, ptpCompliance=ptpCompliance, PYSNMP_MODULE_ID=cambium, linkLoss=linkLoss, userTableIndex=userTableIndex, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNTPServerPortNumber=sNTPServerPortNumber, pubStats=pubStats, aAAControlGroup=aAAControlGroup, ethernet=ethernet, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitDataRate=transmitDataRate, userEnabled=userEnabled, installArmState=installArmState, userName=userName, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dataPortDisabledWarning=dataPortDisabledWarning, syslogClient=syslogClient, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, installArmStateTrap=installArmStateTrap, notificationsGroup=notificationsGroup, licenceGroup=licenceGroup, eIRP=eIRP, useVLANForManagementInterfaces=useVLANForManagementInterfaces, regionCode=regionCode, antennaGain=antennaGain, licensedCapacity=licensedCapacity, phyControl=phyControl, userTable=userTable, productVariant=productVariant, vLANPriorityTableNumber=vLANPriorityTableNumber, pubStatsGroup=pubStatsGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, userTableEntry=userTableEntry, linkModeOptimisation=linkModeOptimisation, softwareVersion=softwareVersion, sNMPTrapTable=sNMPTrapTable, subnetMask=subnetMask, vLANPriorityTable=vLANPriorityTable, transmitPower=transmitPower, tDDSynchronizationStatus=tDDSynchronizationStatus, dfsPeaks=dfsPeaks, bandwidthVariant=bandwidthVariant, daylightSaving=daylightSaving, phyStatusGroup=phyStatusGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, transmitFreqKHz=transmitFreqKHz, receiveFreqMHz=receiveFreqMHz, dataPortAutoMdix=dataPortAutoMdix, ptp=ptp, management=management, timeZone=timeZone, targetMACAddress=targetMACAddress, dfsMeans=dfsMeans, phyStatus=phyStatus, transmitModulationMode=transmitModulationMode, tDDSynchronizationAlarm=tDDSynchronizationAlarm, remoteIPAddress=remoteIPAddress, sntp=sntp, receiveChannel=receiveChannel, dfsGroup=dfsGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapTableEntry=sNMPTrapTableEntry, remoteMaximumTransmitPower=remoteMaximumTransmitPower, latitude=latitude, productName=productName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPLastSync=sNTPLastSync, gatewayIPAddress=gatewayIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, telecomsCableLength=telecomsCableLength, telecomsChannelStatus=telecomsChannelStatus, ptpTraps=ptpTraps, transmitChannel=transmitChannel, telecomGroup=telecomGroup, versionsGroup=versionsGroup, smtp=smtp, incompatibleRegionCodes=incompatibleRegionCodes, sNTPState=sNTPState, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapPortNumber=sNMPTrapPortNumber, ethernetFiberSupport=ethernetFiberSupport, dfs=dfs, vectorError=vectorError, searchState=searchState, sNMPPortNumber=sNMPPortNumber, userTableNumber=userTableNumber, syslogState=syslogState, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementPriority=vLANManagementPriority, sNMPTrapTableNumber=sNMPTrapTableNumber, userPassword=userPassword, licence=licence, sNTPSyncTrap=sNTPSyncTrap, ptpTrapPrefix=ptpTrapPrefix, sNMPEnabledTraps=sNMPEnabledTraps, telecomsChannelStatusTrap=telecomsChannelStatusTrap, resetGroup=resetGroup, aggregateDataRate=aggregateDataRate, receiveModulationModeDetail=receiveModulationModeDetail, sNMPCommunityString=sNMPCommunityString, cambium=cambium, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, encryption=encryption, installStatus=installStatus, iPAddress=iPAddress, groupID=groupID, hTTPSPortNumber=hTTPSPortNumber, receivePower=receivePower, snmpControlGroup=snmpControlGroup, snmpControl=snmpControl, telnetPortNumber=telnetPortNumber, cableLoss=cableLoss, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dfsTableNumber=dfsTableNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, tDDSynchronizationMode=tDDSynchronizationMode, managementGroup=managementGroup, sNTPPollInterval=sNTPPollInterval, altitude=altitude, telecomsLoopback=telecomsLoopback, encryptionGroup=encryptionGroup, channelBandwidth=channelBandwidth, receiveFreqKHz=receiveFreqKHz, ptp500=ptp500, sMTPEmailAlert=sMTPEmailAlert, encryptionAlgorithm=encryptionAlgorithm, systemClock=systemClock, frequencyVariant=frequencyVariant, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, linkSymmetry=linkSymmetry, configuration=configuration, siteName=siteName, installStatusTrap=installStatusTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, transmitFreqMHz=transmitFreqMHz, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTable=dfsTable, sMTPEnabledMessages=sMTPEnabledMessages, linkModeOptimizationMismatch=linkModeOptimizationMismatch, tDDControlGroup=tDDControlGroup, channelChangeTrap=channelChangeTrap, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPSourceEmailAddress=sMTPSourceEmailAddress)
