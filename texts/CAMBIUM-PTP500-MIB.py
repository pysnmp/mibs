...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, pubStats=pubStats, sNMPTrapTable=sNMPTrapTable, tDDControlGroup=tDDControlGroup, dataPortAutoMdix=dataPortAutoMdix, sNMPTrapTableNumber=sNMPTrapTableNumber, enabledDiagnosticAlarms=enabledDiagnosticAlarms, notificationsGroup=notificationsGroup, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveModulationMode=receiveModulationMode, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, capacityLicenseMismatch=capacityLicenseMismatch, licenceGroup=licenceGroup, sntpGroup=sntpGroup, dfsTableNumber=dfsTableNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vectorError=vectorError, transmitModulationMode=transmitModulationMode, groupID=groupID, tDDSynchronizationStatus=tDDSynchronizationStatus, maximumTransmitPower=maximumTransmitPower, dataPortConfigurationMismatch=dataPortConfigurationMismatch, installStatusTrap=installStatusTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, telecomsCableLength=telecomsCableLength, unitOutOfCalibration=unitOutOfCalibration, gatewayIPAddress=gatewayIPAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, installArmStateTrap=installArmStateTrap, sntp=sntp, channelBandwidth=channelBandwidth, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, ptpGroups=ptpGroups, managementGroup=managementGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, transmitFreqMHz=transmitFreqMHz, accessMethod=accessMethod, syslogStateTrap=syslogStateTrap, dfs=dfs, systemReset=systemReset, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, pubStatsGroup=pubStatsGroup, ptpTraps=ptpTraps, userEnabled=userEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkModeOptimisation=linkModeOptimisation, licence=licence, sNTPSync=sNTPSync, dataPortDisabledWarning=dataPortDisabledWarning, altitude=altitude, hTTPSPortNumber=hTTPSPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, daylightSaving=daylightSaving, linkSymmetry=linkSymmetry, syslogClientTrap=syslogClientTrap, incompatibleRegionCodes=incompatibleRegionCodes, signalStrengthRatio=signalStrengthRatio, receiveFreqMHz=receiveFreqMHz, masterSlaveMode=masterSlaveMode, syslogClient=syslogClient, snmpControlGroup=snmpControlGroup, telecomsLoopback=telecomsLoopback, sNTPServerIPAddress=sNTPServerIPAddress, telecom=telecom, vLANPriorityTable=vLANPriorityTable, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dfsMeans=dfsMeans, transmitFreqKHz=transmitFreqKHz, cambium=cambium, aggregateDataRate=aggregateDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, receivePower=receivePower, userTableEntry=userTableEntry, versions=versions, dfsTableIndex=dfsTableIndex, userTableIndex=userTableIndex, linkLoss=linkLoss, syslogControlGroup=syslogControlGroup, phyControl=phyControl, alarmsGroup=alarmsGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTable=userTable, aAAControl=aAAControl, sNMPTrapVersion=sNMPTrapVersion, ptmp=ptmp, productName=productName, channelChangeTrap=channelChangeTrap, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPState=sNTPState, phyStatusGroup=phyStatusGroup, installArmState=installArmState, sMTPServerIPAddress=sMTPServerIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, installStatus=installStatus, dfsTableEntry=dfsTableEntry, sNTPSyncTrap=sNTPSyncTrap, ptp=ptp, sNTPLastSync=sNTPLastSync, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sNMPEnabledTraps=sNMPEnabledTraps, sNTPPollInterval=sNTPPollInterval, softwareVersion=softwareVersion, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, longitude=longitude, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationMode=tDDSynchronizationMode, phyControlGroup=phyControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, wirelessLinkStatus=wirelessLinkStatus, alarms=alarms, tFTPServerIPAddress=tFTPServerIPAddress, sMTPServerPortNumber=sMTPServerPortNumber, telnetPortNumber=telnetPortNumber, encryption=encryption, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, hardwareVersion=hardwareVersion, transmitDataRate=transmitDataRate, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, encryptionAlgorithm=encryptionAlgorithm, bandwidthVariant=bandwidthVariant, syslogState=syslogState, userPassword=userPassword, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, byteErrorRatio=byteErrorRatio, receiveFreqKHz=receiveFreqKHz, reset=reset, encryptionGroup=encryptionGroup, supplementary=supplementary, sNMPTrapTableEntry=sNMPTrapTableEntry, phyStatus=phyStatus, range=range, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernetFiberSupport=ethernetFiberSupport, dataPortAutoNegotiation=dataPortAutoNegotiation, productVariant=productVariant, telecomsLineCode=telecomsLineCode, regionCode=regionCode, ethernet=ethernet, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkName=linkName, snmpControl=snmpControl, sNMPTrapTableIndex=sNMPTrapTableIndex, ptpCompliance=ptpCompliance, timeZone=timeZone, supplementaryGroup=supplementaryGroup, userRole=userRole, versionsGroup=versionsGroup, PYSNMP_MODULE_ID=cambium, dataPortStatus=dataPortStatus, syslogControl=syslogControl, latitude=latitude, bootVersion=bootVersion, siteName=siteName, userTableNumber=userTableNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, smtp=smtp, ptpTrapPrefix=ptpTrapPrefix, sNTPServerPortNumber=sNTPServerPortNumber, sMTPEnabledMessages=sMTPEnabledMessages, remoteIPAddress=remoteIPAddress, licensedCapacity=licensedCapacity, sNMPTrapIPAddress=sNMPTrapIPAddress, iPAddress=iPAddress, sNMPCommunityString=sNMPCommunityString, telecomsInterface=telecomsInterface, cableLoss=cableLoss, telnetAccessEnabled=telnetAccessEnabled, eIRP=eIRP, vLANPriorityTableIndex=vLANPriorityTableIndex, configuration=configuration, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPPortNumber=sNMPPortNumber, secondarySoftwareVersion=secondarySoftwareVersion, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsChannelStatus=telecomsChannelStatus, configurationGroup=configurationGroup, wirelessLinkAvailability=wirelessLinkAvailability, tDDControl=tDDControl, dfsTable=dfsTable, tFTPServerPortNumber=tFTPServerPortNumber, dfsGroup=dfsGroup, vLANManagementVID=vLANManagementVID, antennaGain=antennaGain, dataPortWirelessDownAlert=dataPortWirelessDownAlert, vLANManagementPriority=vLANManagementPriority, receiveDataRate=receiveDataRate, dataPortStatusTrap=dataPortStatusTrap, transmitPower=transmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, regionCodeTrap=regionCodeTrap, searchState=searchState, userName=userName, resetGroup=resetGroup, aAAControlGroup=aAAControlGroup, smtpGroup=smtpGroup, sNMPv3Enable=sNMPv3Enable, receiveModulationModeDetail=receiveModulationModeDetail, hTTPAccessEnabled=hTTPAccessEnabled, management=management, transmitChannel=transmitChannel, systemClock=systemClock, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, vLANPriorityTableEntry=vLANPriorityTableEntry, subnetMask=subnetMask, targetMACAddress=targetMACAddress, telecomGroup=telecomGroup, ptp500=ptp500, hTTPPortNumber=hTTPPortNumber, receiveChannel=receiveChannel, dfsPeaks=dfsPeaks, telecomsLoopbackTrap=telecomsLoopbackTrap, ethernetGroup=ethernetGroup, frequencyVariant=frequencyVariant, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap)
