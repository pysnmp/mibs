...
# Produced by pysmi-1.1.0 at Fri Nov 19 15:15:30 2021
...
Integer32, iso, Bits, Counter64, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ObjectIdentity, ModuleIdentity, Gauge32, Unsigned32, MibIdentifier, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Bits", "Counter64", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Unsigned32", "MibIdentifier", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sNMPTrapTableIndex=sNMPTrapTableIndex, userRole=userRole, sNTPSync=sNTPSync, vLANManagementPriority=vLANManagementPriority, aggregateDataRate=aggregateDataRate, subnetMask=subnetMask, snmpControlGroup=snmpControlGroup, targetMACAddress=targetMACAddress, dfsGroup=dfsGroup, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, userPassword=userPassword, syslogClientTrap=syslogClientTrap, wirelessLinkStatus=wirelessLinkStatus, dfsTableIndex=dfsTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, installStatus=installStatus, notificationsGroup=notificationsGroup, vectorError=vectorError, accessMethod=accessMethod, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, snmpControl=snmpControl, incompatibleRegionCodes=incompatibleRegionCodes, dataPortAutoNegotiation=dataPortAutoNegotiation, systemReset=systemReset, hTTPAccessEnabled=hTTPAccessEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, transmitPower=transmitPower, aAAControl=aAAControl, linkModeOptimizationMismatch=linkModeOptimizationMismatch, searchState=searchState, userName=userName, sNMPTrapIPAddress=sNMPTrapIPAddress, transmitFreqKHz=transmitFreqKHz, remoteIPAddress=remoteIPAddress, hTTPSPortNumber=hTTPSPortNumber, hardwareVersion=hardwareVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, userEnabled=userEnabled, userTableEntry=userTableEntry, resetGroup=resetGroup, range=range, dfsTableNumber=dfsTableNumber, regionCode=regionCode, receiveChannel=receiveChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, smtp=smtp, telecomsChannelStatus=telecomsChannelStatus, receiveFreqMHz=receiveFreqMHz, longitude=longitude, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, syslogState=syslogState, transmitDataRate=transmitDataRate, receiveModulationModeDetail=receiveModulationModeDetail, sMTPEmailAlert=sMTPEmailAlert, sNTPServerIPAddress=sNTPServerIPAddress, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityTable=vLANPriorityTable, ptmp=ptmp, unitOutOfCalibration=unitOutOfCalibration, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, licensedCapacity=licensedCapacity, tDDControl=tDDControl, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, frequencyVariant=frequencyVariant, antennaGain=antennaGain, softwareVersion=softwareVersion, aAAControlGroup=aAAControlGroup, masterSlaveMode=masterSlaveMode, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyControl=phyControl, configurationGroup=configurationGroup, ptpTraps=ptpTraps, encryptionAlgorithm=encryptionAlgorithm, cambium=cambium, vLANPriorityTableIndex=vLANPriorityTableIndex, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, tDDSynchronizationStatus=tDDSynchronizationStatus, tDDSynchronizationAlarm=tDDSynchronizationAlarm, versions=versions, altitude=altitude, hTTPPortNumber=hTTPPortNumber, sNMPTrapVersion=sNMPTrapVersion, regionCodeTrap=regionCodeTrap, ptpGroups=ptpGroups, telecomsCableLength=telecomsCableLength, licence=licence, transmitChannel=transmitChannel, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPState=sNTPState, tFTPServerIPAddress=tFTPServerIPAddress, syslogControl=syslogControl, tFTPServerPortNumber=tFTPServerPortNumber, receivePower=receivePower, ptpCompliance=ptpCompliance, installArmStateTrap=installArmStateTrap, gatewayIPAddress=gatewayIPAddress, iPAddress=iPAddress, ethernetFiberSupport=ethernetFiberSupport, managementGroup=managementGroup, linkLoss=linkLoss, systemClock=systemClock, sntpGroup=sntpGroup, productName=productName, telnetPortNumber=telnetPortNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, installArmState=installArmState, sMTPEnabledMessages=sMTPEnabledMessages, telecomsInterface=telecomsInterface, dataPortAutoMdix=dataPortAutoMdix, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPLastSync=sNTPLastSync, ethernet=ethernet, byteErrorRatio=byteErrorRatio, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, management=management, dfsTable=dfsTable, pubStatsGroup=pubStatsGroup, telecomsLoopback=telecomsLoopback, linkModeOptimisation=linkModeOptimisation, userTableNumber=userTableNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, maximumTransmitPower=maximumTransmitPower, userTableIndex=userTableIndex, ptp500=ptp500, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, dataPortStatusTrap=dataPortStatusTrap, cableLoss=cableLoss, transmitFreqMHz=transmitFreqMHz, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTableNumber=sNMPTrapTableNumber, alarms=alarms, timeZone=timeZone, licenceGroup=licenceGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, userTable=userTable, sntp=sntp, wirelessLinkAvailability=wirelessLinkAvailability, smtpGroup=smtpGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, eIRP=eIRP, dfs=dfs, vLANPriorityQueueMapping=vLANPriorityQueueMapping, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, versionsGroup=versionsGroup, bandwidthVariant=bandwidthVariant, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, installStatusTrap=installStatusTrap, syslogClient=syslogClient, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, tDDControlGroup=tDDControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNTPSyncTrap=sNTPSyncTrap, groupID=groupID, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dfsMeans=dfsMeans, sNTPServerPortNumber=sNTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, telecomsChannelStatusTrap=telecomsChannelStatusTrap, supplementaryGroup=supplementaryGroup, pubStats=pubStats, phyControlGroup=phyControlGroup, telecomsLineCode=telecomsLineCode, encryption=encryption, dataPortStatus=dataPortStatus, sNMPCommunityString=sNMPCommunityString, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, reset=reset, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, supplementary=supplementary, latitude=latitude, linkName=linkName, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, telecom=telecom, siteName=siteName, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetGroup=ethernetGroup, dfsPeaks=dfsPeaks, channelChangeTrap=channelChangeTrap, alarmsGroup=alarmsGroup, phyStatus=phyStatus, sNMPTrapTable=sNMPTrapTable, vLANManagementVID=vLANManagementVID, dataPortDisabledWarning=dataPortDisabledWarning, PYSNMP_MODULE_ID=cambium, channelBandwidth=channelBandwidth, telecomGroup=telecomGroup, sNMPv3Enable=sNMPv3Enable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, daylightSaving=daylightSaving, dfsTableEntry=dfsTableEntry, encryptionGroup=encryptionGroup, capacityLicenseMismatch=capacityLicenseMismatch, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkSymmetry=linkSymmetry, receiveFreqKHz=receiveFreqKHz, ptp=ptp, bootVersion=bootVersion, receiveModulationMode=receiveModulationMode, configuration=configuration, ptpTrapPrefix=ptpTrapPrefix, syslogControlGroup=syslogControlGroup, syslogStateTrap=syslogStateTrap, transmitModulationMode=transmitModulationMode, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, signalStrengthRatio=signalStrengthRatio, secondarySoftwareVersion=secondarySoftwareVersion, productVariant=productVariant, sMTPServerIPAddress=sMTPServerIPAddress, phyStatusGroup=phyStatusGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber)
