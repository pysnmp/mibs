...
Integer32, ModuleIdentity, ObjectIdentity, enterprises, iso, Counter64, Gauge32, Bits, Unsigned32, NotificationType, MibIdentifier, Counter32, IpAddress, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "ObjectIdentity", "enterprises", "iso", "Counter64", "Gauge32", "Bits", "Unsigned32", "NotificationType", "MibIdentifier", "Counter32", "IpAddress", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", sntp=sntp, regionCodeTrap=regionCodeTrap, management=management, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, cambium=cambium, productVariant=productVariant, telnetAccessEnabled=telnetAccessEnabled, enabledDiagnosticAlarms=enabledDiagnosticAlarms, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, dataPortStatusTrap=dataPortStatusTrap, targetMACAddress=targetMACAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, versionsGroup=versionsGroup, supplementary=supplementary, telecomsLoopback=telecomsLoopback, smtpGroup=smtpGroup, userTableNumber=userTableNumber, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, latitude=latitude, vLANPriorityTable=vLANPriorityTable, remoteIPAddress=remoteIPAddress, licence=licence, receiveModulationModeDetail=receiveModulationModeDetail, telecomsLineCode=telecomsLineCode, useVLANForManagementInterfaces=useVLANForManagementInterfaces, installStatusTrap=installStatusTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, wirelessLinkAvailability=wirelessLinkAvailability, sntpGroup=sntpGroup, longitude=longitude, phyStatusGroup=phyStatusGroup, phyControlGroup=phyControlGroup, sNTPSync=sNTPSync, linkModeOptimisation=linkModeOptimisation, gatewayIPAddress=gatewayIPAddress, pubStatsGroup=pubStatsGroup, timeZone=timeZone, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, configuration=configuration, tDDSynchronizationMode=tDDSynchronizationMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkLoss=linkLoss, accessMethod=accessMethod, hTTPPortNumber=hTTPPortNumber, cableLoss=cableLoss, transmitPower=transmitPower, unitOutOfCalibration=unitOutOfCalibration, encryptionAlgorithm=encryptionAlgorithm, receiveModulationMode=receiveModulationMode, tFTPServerPortNumber=tFTPServerPortNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANManagementPriority=vLANManagementPriority, hTTPSPortNumber=hTTPSPortNumber, transmitChannel=transmitChannel, sMTPSourceEmailAddress=sMTPSourceEmailAddress, constantPowerSpectralDensity=constantPowerSpectralDensity, channelBandwidth=channelBandwidth, transmitModulationMode=transmitModulationMode, licensedCapacity=licensedCapacity, eIRP=eIRP, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, sNTPPollInterval=sNTPPollInterval, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, dfsTableEntry=dfsTableEntry, userTableEntry=userTableEntry, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userName=userName, alarmsGroup=alarmsGroup, sNTPSyncTrap=sNTPSyncTrap, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, hardwareVersion=hardwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, softwareVersion=softwareVersion, vLANPriorityTableEntry=vLANPriorityTableEntry, reset=reset, pubStats=pubStats, resetGroup=resetGroup, sNTPState=sNTPState, daylightSaving=daylightSaving, managementGroup=managementGroup, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, sMTPServerPortNumber=sMTPServerPortNumber, ptp500=ptp500, dataPortStatus=dataPortStatus, syslogClient=syslogClient, installStatus=installStatus, ethernetGroup=ethernetGroup, sNMPCommunityString=sNMPCommunityString, siteName=siteName, telecomsLoopbackTrap=telecomsLoopbackTrap, phyStatus=phyStatus, sMTPEnabledMessages=sMTPEnabledMessages, sNMPPortNumber=sNMPPortNumber, systemReset=systemReset, ptp=ptp, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpGroups=ptpGroups, supplementaryGroup=supplementaryGroup, iPAddress=iPAddress, linkName=linkName, vLANPriorityQueueMapping=vLANPriorityQueueMapping, vLANManagementVID=vLANManagementVID, searchState=searchState, smtp=smtp, sNTPServerIPAddress=sNTPServerIPAddress, transmitDataRate=transmitDataRate, syslogState=syslogState, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, maximumTransmitPower=maximumTransmitPower, syslogClientTrap=syslogClientTrap, channelChangeTrap=channelChangeTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, subnetMask=subnetMask, transmitFreqKHz=transmitFreqKHz, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userRole=userRole, sNMPTrapTableNumber=sNMPTrapTableNumber, receiveFreqKHz=receiveFreqKHz, aggregateDataRate=aggregateDataRate, configurationGroup=configurationGroup, dfsTableIndex=dfsTableIndex, sNMPEnabledTraps=sNMPEnabledTraps, receiveDataRate=receiveDataRate, wirelessLinkStatus=wirelessLinkStatus, userTableIndex=userTableIndex, telnetPortNumber=telnetPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, dfsGroup=dfsGroup, encryptionGroup=encryptionGroup, notificationsGroup=notificationsGroup, installArmStateTrap=installArmStateTrap, versions=versions, bandwidthVariant=bandwidthVariant, ptpCompliance=ptpCompliance, byteErrorRatio=byteErrorRatio, dfsTableNumber=dfsTableNumber, dfsMeans=dfsMeans, telecom=telecom, ptpTrapPrefix=ptpTrapPrefix, sNMPTrapPortNumber=sNMPTrapPortNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, altitude=altitude, encryption=encryption, dfsTable=dfsTable, sNMPv3Enable=sNMPv3Enable, ethernet=ethernet, sNMPTrapTableEntry=sNMPTrapTableEntry, vLANPriorityTableIndex=vLANPriorityTableIndex, tDDControlGroup=tDDControlGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dataPortDisabledWarning=dataPortDisabledWarning, sMTPEmailAlert=sMTPEmailAlert, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ptmp=ptmp, snmpControlGroup=snmpControlGroup, userTable=userTable, signalStrengthRatio=signalStrengthRatio, regionCode=regionCode, incompatibleRegionCodes=incompatibleRegionCodes, masterSlaveMode=masterSlaveMode, userEnabled=userEnabled, receivePower=receivePower, sMTPServerIPAddress=sMTPServerIPAddress, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, antennaGain=antennaGain, telecomsInterface=telecomsInterface, hTTPAccessEnabled=hTTPAccessEnabled, userPassword=userPassword, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, receiveChannel=receiveChannel, ptpTraps=ptpTraps, aAAControlGroup=aAAControlGroup, licenceGroup=licenceGroup, telecomGroup=telecomGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkSymmetry=linkSymmetry, range=range, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, systemClock=systemClock, frequencyVariant=frequencyVariant, tDDControl=tDDControl, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, capacityLicenseMismatch=capacityLicenseMismatch, telecomsCableLength=telecomsCableLength, sNTPLastSync=sNTPLastSync, hTTPSAccessEnabled=hTTPSAccessEnabled, vLANPriorityTableNumber=vLANPriorityTableNumber, ethernetFiberSupport=ethernetFiberSupport, phyControl=phyControl, sNMPTrapTable=sNMPTrapTable, installArmState=installArmState, transmitFreqMHz=transmitFreqMHz, incompatibleMasterAndSlave=incompatibleMasterAndSlave, snmpControl=snmpControl, sNMPTrapVersion=sNMPTrapVersion, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, syslogStateTrap=syslogStateTrap, dataPortAutoMdix=dataPortAutoMdix, tFTPServerIPAddress=tFTPServerIPAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, aAAControl=aAAControl, dataPortConfigurationMismatch=dataPortConfigurationMismatch, productName=productName, vectorError=vectorError, secondarySoftwareVersion=secondarySoftwareVersion, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelStatus=telecomsChannelStatus, syslogControl=syslogControl, groupID=groupID, syslogControlGroup=syslogControlGroup, PYSNMP_MODULE_ID=cambium, linkModeOptimizationMismatch=linkModeOptimizationMismatch, bootVersion=bootVersion, dfsPeaks=dfsPeaks, dfs=dfs, receiveFreqMHz=receiveFreqMHz, alarms=alarms)
