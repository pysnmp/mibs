...
# Produced by pysmi-1.1.3 at Sun Nov 28 13:51:38 2021
...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, enterprises, Counter64, Counter32, Bits, ObjectIdentity, TimeTicks, ModuleIdentity, MibIdentifier, Gauge32, NotificationType, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "enterprises", "Counter64", "Counter32", "Bits", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "MibIdentifier", "Gauge32", "NotificationType", "Integer32", "iso")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", masterSlaveMode=masterSlaveMode, sMTPServerPortNumber=sMTPServerPortNumber, dfsGroup=dfsGroup, linkModeOptimisation=linkModeOptimisation, daylightSaving=daylightSaving, telecomsCableLength=telecomsCableLength, sNTPServerPortNumber=sNTPServerPortNumber, licenceGroup=licenceGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, configurationGroup=configurationGroup, sNMPTrapVersion=sNMPTrapVersion, wirelessLinkAvailability=wirelessLinkAvailability, userTableIndex=userTableIndex, sNMPTrapTableNumber=sNMPTrapTableNumber, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, wirelessLinkStatus=wirelessLinkStatus, searchState=searchState, dfsMeans=dfsMeans, reset=reset, licensedCapacity=licensedCapacity, dfsTableEntry=dfsTableEntry, resetGroup=resetGroup, accessMethod=accessMethod, telecomGroup=telecomGroup, receiveDataRate=receiveDataRate, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, eIRP=eIRP, syslogClientTrap=syslogClientTrap, sNTPServerIPAddress=sNTPServerIPAddress, bootVersion=bootVersion, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, pubStats=pubStats, capacityLicenseMismatch=capacityLicenseMismatch, vLANPriorityTableIndex=vLANPriorityTableIndex, bandwidthVariant=bandwidthVariant, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsPeaks=dfsPeaks, sNTPLastSync=sNTPLastSync, encryptionAlgorithm=encryptionAlgorithm, managementGroup=managementGroup, sNMPPortNumber=sNMPPortNumber, channelBandwidth=channelBandwidth, targetMACAddress=targetMACAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, pubStatsGroup=pubStatsGroup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTableNumber=dfsTableNumber, linkName=linkName, versions=versions, smtpGroup=smtpGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, telecomsInterface=telecomsInterface, telnetAccessEnabled=telnetAccessEnabled, syslogState=syslogState, syslogStateTrap=syslogStateTrap, productName=productName, byteErrorRatio=byteErrorRatio, encryptionGroup=encryptionGroup, transmitFreqMHz=transmitFreqMHz, ptp=ptp, sNTPState=sNTPState, PYSNMP_MODULE_ID=cambium, dataPortDisabledWarning=dataPortDisabledWarning, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hardwareVersion=hardwareVersion, aAAControl=aAAControl, sNMPTrapTable=sNMPTrapTable, regionCodeTrap=regionCodeTrap, sMTPServerIPAddress=sMTPServerIPAddress, receiveFreqKHz=receiveFreqKHz, sNMPv3Enable=sNMPv3Enable, dfs=dfs, hTTPSPortNumber=hTTPSPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tFTPServerPortNumber=tFTPServerPortNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userPassword=userPassword, range=range, linkLoss=linkLoss, notificationsGroup=notificationsGroup, antennaGain=antennaGain, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsLoopback=telecomsLoopback, cableLoss=cableLoss, phyStatus=phyStatus, regionCode=regionCode, latitude=latitude, receiveFreqMHz=receiveFreqMHz, dfsTableIndex=dfsTableIndex, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, systemClock=systemClock, secondarySoftwareVersion=secondarySoftwareVersion, receiveModulationModeDetail=receiveModulationModeDetail, vLANManagementPriority=vLANManagementPriority, phyControlGroup=phyControlGroup, userRole=userRole, telecom=telecom, hTTPAccessEnabled=hTTPAccessEnabled, sntp=sntp, tDDSynchronizationMode=tDDSynchronizationMode, syslogControl=syslogControl, vLANPriorityTable=vLANPriorityTable, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetGroup=ethernetGroup, userTable=userTable, versionsGroup=versionsGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, dataPortConfigurationMismatch=dataPortConfigurationMismatch, groupID=groupID, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, receiveModulationMode=receiveModulationMode, channelChangeTrap=channelChangeTrap, vLANManagementVID=vLANManagementVID, linkSymmetry=linkSymmetry, supplementary=supplementary, softwareVersion=softwareVersion, receivePower=receivePower, telecomsChannelStatus=telecomsChannelStatus, transmitFreqKHz=transmitFreqKHz, sNMPTrapIPAddress=sNMPTrapIPAddress, installArmStateTrap=installArmStateTrap, telecomsLineCode=telecomsLineCode, maximumTransmitPower=maximumTransmitPower, sNMPTrapTableEntry=sNMPTrapTableEntry, telecomsLoopbackTrap=telecomsLoopbackTrap, alarms=alarms, phyControl=phyControl, cambium=cambium, remoteIPAddress=remoteIPAddress, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, noWirelessChannelAvailable=noWirelessChannelAvailable, dataPortAutoMdix=dataPortAutoMdix, ptpGroups=ptpGroups, vLANPriorityTableNumber=vLANPriorityTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, ethernet=ethernet, ptmp=ptmp, vLANPriorityQueueMapping=vLANPriorityQueueMapping, snmpControlGroup=snmpControlGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, transmitChannel=transmitChannel, userTableEntry=userTableEntry, frequencyVariant=frequencyVariant, sNTPSyncTrap=sNTPSyncTrap, sNTPPollInterval=sNTPPollInterval, sNMPTrapPortNumber=sNMPTrapPortNumber, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, hTTPPortNumber=hTTPPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, supplementaryGroup=supplementaryGroup, syslogControlGroup=syslogControlGroup, ptp500=ptp500, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodes=incompatibleRegionCodes, phyStatusGroup=phyStatusGroup, installStatus=installStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installStatusTrap=installStatusTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tDDControlGroup=tDDControlGroup, gatewayIPAddress=gatewayIPAddress, sMTPEmailAlert=sMTPEmailAlert, management=management, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPCommunityString=sNMPCommunityString, ethernetFiberSupport=ethernetFiberSupport, telnetPortNumber=telnetPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPSync=sNTPSync, configuration=configuration, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortStatus=dataPortStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, ptpTrapPrefix=ptpTrapPrefix, transmitDataRate=transmitDataRate, aggregateDataRate=aggregateDataRate, userTableNumber=userTableNumber, siteName=siteName, aAAControlGroup=aAAControlGroup, iPAddress=iPAddress, userName=userName, ptpTraps=ptpTraps, sNMPEnabledTraps=sNMPEnabledTraps, installArmState=installArmState, transmitModulationMode=transmitModulationMode, timeZone=timeZone, tDDControl=tDDControl, dfsTable=dfsTable, productVariant=productVariant, alarmsGroup=alarmsGroup, licence=licence, transmitPower=transmitPower, altitude=altitude, snmpControl=snmpControl, systemReset=systemReset, subnetMask=subnetMask, remoteMaximumTransmitPower=remoteMaximumTransmitPower, tFTPServerIPAddress=tFTPServerIPAddress, longitude=longitude, signalStrengthRatio=signalStrengthRatio, syslogClient=syslogClient, dataPortStatusTrap=dataPortStatusTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, sMTPEnabledMessages=sMTPEnabledMessages, smtp=smtp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, receiveChannel=receiveChannel, vectorError=vectorError, sntpGroup=sntpGroup, userEnabled=userEnabled, encryption=encryption, unitOutOfCalibration=unitOutOfCalibration, ptpCompliance=ptpCompliance, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap)
