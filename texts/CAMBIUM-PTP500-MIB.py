...
# Produced by pysmi-1.1.10 at Fri Nov 10 10:31:00 2023
...
iso, Integer32, ObjectIdentity, Counter32, Counter64, enterprises, NotificationType, Bits, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Integer32", "ObjectIdentity", "Counter32", "Counter64", "enterprises", "NotificationType", "Bits", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", phyStatusGroup=phyStatusGroup, cambium=cambium, unitOutOfCalibration=unitOutOfCalibration, accessMethod=accessMethod, sNMPTrapTableNumber=sNMPTrapTableNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, groupID=groupID, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNTPLastSync=sNTPLastSync, ethernet=ethernet, vLANManagementVID=vLANManagementVID, hardwareVersion=hardwareVersion, telecomsInterface=telecomsInterface, wirelessLinkAvailability=wirelessLinkAvailability, sNMPTrapTableIndex=sNMPTrapTableIndex, regionCodeTrap=regionCodeTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, vLANPriorityTable=vLANPriorityTable, configurationGroup=configurationGroup, dfsTableNumber=dfsTableNumber, tDDSynchronizationAlarm=tDDSynchronizationAlarm, constantPowerSpectralDensity=constantPowerSpectralDensity, pubStatsGroup=pubStatsGroup, userRole=userRole, encryption=encryption, smtp=smtp, sNTPServerIPAddress=sNTPServerIPAddress, alarmsGroup=alarmsGroup, linkSymmetry=linkSymmetry, configuration=configuration, tFTPServerPortNumber=tFTPServerPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, receivePower=receivePower, searchState=searchState, encryptionAlgorithm=encryptionAlgorithm, vLANPriorityTableEntry=vLANPriorityTableEntry, snmpControl=snmpControl, hTTPSPortNumber=hTTPSPortNumber, latitude=latitude, receiveModulationMode=receiveModulationMode, softwareVersion=softwareVersion, receiveChannel=receiveChannel, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, vLANPriorityTableIndex=vLANPriorityTableIndex, ptpTrapPrefix=ptpTrapPrefix, dfsMeans=dfsMeans, ptp=ptp, ptpCompliance=ptpCompliance, iPAddress=iPAddress, wirelessLinkStatus=wirelessLinkStatus, aAAControlGroup=aAAControlGroup, installArmStateTrap=installArmStateTrap, telnetPortNumber=telnetPortNumber, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, productName=productName, dfs=dfs, productVariant=productVariant, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogState=syslogState, pubStats=pubStats, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, phyStatus=phyStatus, subnetMask=subnetMask, vLANManagementPriority=vLANManagementPriority, noWirelessChannelAvailable=noWirelessChannelAvailable, enabledDiagnosticAlarms=enabledDiagnosticAlarms, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, targetMACAddress=targetMACAddress, frequencyVariant=frequencyVariant, sNTPSyncTrap=sNTPSyncTrap, notificationsGroup=notificationsGroup, eIRP=eIRP, userEnabled=userEnabled, hTTPAccessEnabled=hTTPAccessEnabled, transmitFreqMHz=transmitFreqMHz, telnetAccessEnabled=telnetAccessEnabled, dfsTableEntry=dfsTableEntry, dfsTableIndex=dfsTableIndex, dfsPeaks=dfsPeaks, sMTPServerPortNumber=sMTPServerPortNumber, gatewayIPAddress=gatewayIPAddress, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, smtpGroup=smtpGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, linkModeOptimizationMismatch=linkModeOptimizationMismatch, linkName=linkName, syslogClientTrap=syslogClientTrap, supplementary=supplementary, supplementaryGroup=supplementaryGroup, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPSync=sNTPSync, sMTPEmailAlert=sMTPEmailAlert, transmitPower=transmitPower, sNMPTrapVersion=sNMPTrapVersion, alarms=alarms, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, dfsTable=dfsTable, managementGroup=managementGroup, receiveFreqMHz=receiveFreqMHz, secondarySoftwareVersion=secondarySoftwareVersion, telecomGroup=telecomGroup, userPassword=userPassword, remoteIPAddress=remoteIPAddress, transmitChannel=transmitChannel, hTTPPortNumber=hTTPPortNumber, aggregateDataRate=aggregateDataRate, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitFreqKHz=transmitFreqKHz, syslogControlGroup=syslogControlGroup, tDDControl=tDDControl, channelBandwidth=channelBandwidth, siteName=siteName, capacityLicenseMismatch=capacityLicenseMismatch, reset=reset, vectorError=vectorError, aAAControl=aAAControl, byteErrorRatio=byteErrorRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, versionsGroup=versionsGroup, sNMPPortNumber=sNMPPortNumber, userTable=userTable, sNTPState=sNTPState, altitude=altitude, userTableIndex=userTableIndex, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPEnabledMessages=sMTPEnabledMessages, ethernetFiberSupport=ethernetFiberSupport, licenceGroup=licenceGroup, cableLoss=cableLoss, sNMPTrapTableEntry=sNMPTrapTableEntry, receiveFreqKHz=receiveFreqKHz, telecom=telecom, dataPortAutoMdix=dataPortAutoMdix, longitude=longitude, telecomsLoopbackTrap=telecomsLoopbackTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapPortNumber=sNMPTrapPortNumber, useVLANForManagementInterfaces=useVLANForManagementInterfaces, versions=versions, linkLoss=linkLoss, encryptionGroup=encryptionGroup, sNMPTrapTable=sNMPTrapTable, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, dataPortConfigurationMismatch=dataPortConfigurationMismatch, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsChannelStatusTrap=telecomsChannelStatusTrap, installArmState=installArmState, tDDSynchronizationMode=tDDSynchronizationMode, tDDControlGroup=tDDControlGroup, dataPortStatus=dataPortStatus, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, systemClock=systemClock, linkModeOptimisation=linkModeOptimisation, sMTPServerIPAddress=sMTPServerIPAddress, sNMPCommunityString=sNMPCommunityString, bandwidthVariant=bandwidthVariant, dfsGroup=dfsGroup, dataPortStatusTrap=dataPortStatusTrap, maximumTransmitPower=maximumTransmitPower, ethernetGroup=ethernetGroup, receiveModulationModeDetail=receiveModulationModeDetail, antennaGain=antennaGain, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, phyControl=phyControl, transmitModulationMode=transmitModulationMode, syslogStateTrap=syslogStateTrap, ptmp=ptmp, phyControlGroup=phyControlGroup, incompatibleRegionCodes=incompatibleRegionCodes, snmpControlGroup=snmpControlGroup, receiveDataRate=receiveDataRate, syslogControl=syslogControl, dataPortDisabledWarning=dataPortDisabledWarning, installStatusTrap=installStatusTrap, syslogClient=syslogClient, sNTPServerPortNumber=sNTPServerPortNumber, sNMPTrapIPAddress=sNMPTrapIPAddress, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, telecomsCableLength=telecomsCableLength, tFTPServerIPAddress=tFTPServerIPAddress, ptp500=ptp500, resetGroup=resetGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, bootVersion=bootVersion, telecomsChannelStatus=telecomsChannelStatus, timeZone=timeZone, ptpTraps=ptpTraps, systemReset=systemReset, sNMPEnabledTraps=sNMPEnabledTraps, userTableNumber=userTableNumber, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPv3Enable=sNMPv3Enable, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sntpGroup=sntpGroup, licence=licence, ptpGroups=ptpGroups, licensedCapacity=licensedCapacity, masterSlaveMode=masterSlaveMode, sNTPPollInterval=sNTPPollInterval, telecomsLineCode=telecomsLineCode, transmitDataRate=transmitDataRate, installStatus=installStatus, userName=userName, daylightSaving=daylightSaving, signalStrengthRatio=signalStrengthRatio, PYSNMP_MODULE_ID=cambium, sntp=sntp, management=management, telecomsLoopback=telecomsLoopback, range=range, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, userTableEntry=userTableEntry, regionCode=regionCode, channelChangeTrap=channelChangeTrap)
