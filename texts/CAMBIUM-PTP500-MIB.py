...
ModuleIdentity, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, IpAddress, TimeTicks, ObjectIdentity, Bits, Counter64, iso, Gauge32, Unsigned32, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "IpAddress", "TimeTicks", "ObjectIdentity", "Bits", "Counter64", "iso", "Gauge32", "Unsigned32", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", supplementaryGroup=supplementaryGroup, sNMPv3Enable=sNMPv3Enable, sntp=sntp, pubStats=pubStats, vLANPriorityTableIndex=vLANPriorityTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, telecomsChannelStatus=telecomsChannelStatus, tDDSynchronizationStatus=tDDSynchronizationStatus, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dataPortDisabledWarning=dataPortDisabledWarning, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, transmitFreqMHz=transmitFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, ptpCompliance=ptpCompliance, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, managementGroup=managementGroup, vLANManagementVID=vLANManagementVID, hardwareVersion=hardwareVersion, wirelessLinkStatus=wirelessLinkStatus, userTableNumber=userTableNumber, maximumTransmitPower=maximumTransmitPower, transmitDataRate=transmitDataRate, unitOutOfCalibration=unitOutOfCalibration, searchState=searchState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsCableLength=telecomsCableLength, sNTPServerPortNumber=sNTPServerPortNumber, installStatusTrap=installStatusTrap, encryptionGroup=encryptionGroup, sNMPCommunityString=sNMPCommunityString, telnetPortNumber=telnetPortNumber, versions=versions, phyControl=phyControl, ptpGroups=ptpGroups, snmpControl=snmpControl, subnetMask=subnetMask, cambium=cambium, eIRP=eIRP, linkName=linkName, range=range, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sMTPServerIPAddress=sMTPServerIPAddress, cableLoss=cableLoss, receiveModulationMode=receiveModulationMode, supplementary=supplementary, sMTPServerPortNumber=sMTPServerPortNumber, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNTPLastSync=sNTPLastSync, dataPortStatusTrap=dataPortStatusTrap, syslogStateTrap=syslogStateTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, ethernetGroup=ethernetGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ptp=ptp, telecomsChannelStatusTrap=telecomsChannelStatusTrap, gatewayIPAddress=gatewayIPAddress, licensedCapacity=licensedCapacity, ptpTraps=ptpTraps, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, tDDSynchronizationMode=tDDSynchronizationMode, management=management, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, alarms=alarms, vLANManagementPriority=vLANManagementPriority, sNMPTrapPortNumber=sNMPTrapPortNumber, installArmState=installArmState, receiveFreqMHz=receiveFreqMHz, vLANPriorityTable=vLANPriorityTable, alarmsGroup=alarmsGroup, userTableEntry=userTableEntry, daylightSaving=daylightSaving, encryptionAlgorithm=encryptionAlgorithm, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, configuration=configuration, channelChangeTrap=channelChangeTrap, aAAControlGroup=aAAControlGroup, tDDControl=tDDControl, sNTPState=sNTPState, incompatibleRegionCodes=incompatibleRegionCodes, productVariant=productVariant, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, transmitPower=transmitPower, sNMPEnabledTraps=sNMPEnabledTraps, dfs=dfs, phyStatusGroup=phyStatusGroup, sntpGroup=sntpGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, linkLoss=linkLoss, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, userName=userName, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableEntry=sNMPTrapTableEntry, aggregateDataRate=aggregateDataRate, userEnabled=userEnabled, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, receiveChannel=receiveChannel, telecom=telecom, telecomsLoopback=telecomsLoopback, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, linkSymmetry=linkSymmetry, sNTPSync=sNTPSync, aAAControl=aAAControl, dfsTableNumber=dfsTableNumber, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsGroup=dfsGroup, dataPortStatus=dataPortStatus, channelBandwidth=channelBandwidth, snmpControlGroup=snmpControlGroup, dataPortAutoMdix=dataPortAutoMdix, hTTPAccessEnabled=hTTPAccessEnabled, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, PYSNMP_MODULE_ID=cambium, hTTPSPortNumber=hTTPSPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tFTPServerPortNumber=tFTPServerPortNumber, antennaGain=antennaGain, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, licence=licence, dfsPeaks=dfsPeaks, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTable=sNMPTrapTable, sNTPSyncTrap=sNTPSyncTrap, bandwidthVariant=bandwidthVariant, reset=reset, ptmp=ptmp, groupID=groupID, smtp=smtp, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, versionsGroup=versionsGroup, incompatibleMasterAndSlave=incompatibleMasterAndSlave, configurationGroup=configurationGroup, sNMPTrapVersion=sNMPTrapVersion, telecomsInterface=telecomsInterface, latitude=latitude, encryption=encryption, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, remoteMaximumTransmitPower=remoteMaximumTransmitPower, receiveFreqKHz=receiveFreqKHz, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogControlGroup=syslogControlGroup, tDDControlGroup=tDDControlGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, systemReset=systemReset, wirelessLinkAvailability=wirelessLinkAvailability, licenceGroup=licenceGroup, vectorError=vectorError, siteName=siteName, ptpTrapPrefix=ptpTrapPrefix, secondarySoftwareVersion=secondarySoftwareVersion, dfsTableEntry=dfsTableEntry, ptp500=ptp500, telecomsLoopbackTrap=telecomsLoopbackTrap, transmitFreqKHz=transmitFreqKHz, syslogClient=syslogClient, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsLineCode=telecomsLineCode, userTableIndex=userTableIndex, phyControlGroup=phyControlGroup, vLANPriorityQueueMapping=vLANPriorityQueueMapping, byteErrorRatio=byteErrorRatio, receivePower=receivePower, noWirelessChannelAvailable=noWirelessChannelAvailable, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, transmitModulationMode=transmitModulationMode, receiveDataRate=receiveDataRate, syslogClientTrap=syslogClientTrap, softwareVersion=softwareVersion, userPassword=userPassword, sMTPEnabledMessages=sMTPEnabledMessages, hTTPPortNumber=hTTPPortNumber, productName=productName, ethernet=ethernet, accessMethod=accessMethod, receiveModulationModeDetail=receiveModulationModeDetail, linkModeOptimisation=linkModeOptimisation, transmitChannel=transmitChannel, installArmStateTrap=installArmStateTrap, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogState=syslogState, notificationsGroup=notificationsGroup, ethernetFiberSupport=ethernetFiberSupport, vLANPriorityTableEntry=vLANPriorityTableEntry, bootVersion=bootVersion, longitude=longitude, userTable=userTable, dfsTable=dfsTable, regionCode=regionCode, sNTPServerIPAddress=sNTPServerIPAddress, telecomGroup=telecomGroup, dfsTableIndex=dfsTableIndex, resetGroup=resetGroup, timeZone=timeZone, iPAddress=iPAddress, dfsMeans=dfsMeans, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPPollInterval=sNTPPollInterval, sMTPEmailAlert=sMTPEmailAlert, tFTPServerIPAddress=tFTPServerIPAddress, userRole=userRole, systemClock=systemClock, syslogControl=syslogControl, sNMPPortNumber=sNMPPortNumber, altitude=altitude, regionCodeTrap=regionCodeTrap, smtpGroup=smtpGroup, remoteIPAddress=remoteIPAddress, frequencyVariant=frequencyVariant, sNMPTrapTableIndex=sNMPTrapTableIndex, targetMACAddress=targetMACAddress, phyStatus=phyStatus, signalStrengthRatio=signalStrengthRatio, telnetAccessEnabled=telnetAccessEnabled, pubStatsGroup=pubStatsGroup, installStatus=installStatus, masterSlaveMode=masterSlaveMode)
