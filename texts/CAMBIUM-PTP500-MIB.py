...
IpAddress, Gauge32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, Integer32, NotificationType, enterprises, Counter32, Unsigned32, MibIdentifier, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Gauge32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "Integer32", "NotificationType", "enterprises", "Counter32", "Unsigned32", "MibIdentifier", "iso", "ModuleIdentity")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", installStatusTrap=installStatusTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, vLANManagementPriority=vLANManagementPriority, vLANPriorityTableIndex=vLANPriorityTableIndex, pubStats=pubStats, receiveFreqKHz=receiveFreqKHz, accessMethod=accessMethod, alarmsGroup=alarmsGroup, sNTPSync=sNTPSync, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, regionCodeTrap=regionCodeTrap, PYSNMP_MODULE_ID=cambium, transmitFreqKHz=transmitFreqKHz, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, aggregateDataRate=aggregateDataRate, telecomsInterface=telecomsInterface, productName=productName, linkModeOptimisation=linkModeOptimisation, licensedCapacity=licensedCapacity, capacityLicenseMismatch=capacityLicenseMismatch, sNMPCommunityString=sNMPCommunityString, ptp=ptp, sNMPTrapTable=sNMPTrapTable, sMTPServerPortNumber=sMTPServerPortNumber, hTTPPortNumber=hTTPPortNumber, transmitModulationMode=transmitModulationMode, channelBandwidth=channelBandwidth, receiveChannel=receiveChannel, receiveModulationMode=receiveModulationMode, sNTPServerPortNumber=sNTPServerPortNumber, dfsPeaks=dfsPeaks, userTableNumber=userTableNumber, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpGroups=ptpGroups, regionCode=regionCode, sMTPEnabledMessages=sMTPEnabledMessages, management=management, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityTable=vLANPriorityTable, remoteMaximumTransmitPower=remoteMaximumTransmitPower, userTableEntry=userTableEntry, systemClock=systemClock, telecomsLoopbackTrap=telecomsLoopbackTrap, configurationGroup=configurationGroup, aAAControlGroup=aAAControlGroup, ptpTrapPrefix=ptpTrapPrefix, transmitFreqMHz=transmitFreqMHz, sNMPTrapIPAddress=sNMPTrapIPAddress, telecomsCableLength=telecomsCableLength, tDDControl=tDDControl, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, iPAddress=iPAddress, syslogStateTrap=syslogStateTrap, supplementary=supplementary, vLANPriorityQueueMapping=vLANPriorityQueueMapping, telecomsLoopback=telecomsLoopback, dfsTable=dfsTable, sNMPEnabledTraps=sNMPEnabledTraps, wirelessLinkStatus=wirelessLinkStatus, vLANPriorityTableNumber=vLANPriorityTableNumber, dataPortStatusTrap=dataPortStatusTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableNumber=dfsTableNumber, sNTPPollInterval=sNTPPollInterval, remoteIPAddress=remoteIPAddress, syslogClientTrap=syslogClientTrap, systemReset=systemReset, ethernetGroup=ethernetGroup, tFTPServerPortNumber=tFTPServerPortNumber, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, ptp500=ptp500, receiveModulationModeDetail=receiveModulationModeDetail, sNTPSyncTrap=sNTPSyncTrap, phyControlGroup=phyControlGroup, softwareVersion=softwareVersion, dataPortAutoMdix=dataPortAutoMdix, wirelessLinkAvailability=wirelessLinkAvailability, cableLoss=cableLoss, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPv3Enable=sNMPv3Enable, hTTPAccessEnabled=hTTPAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, dfsTableIndex=dfsTableIndex, ethernetFiberSupport=ethernetFiberSupport, sNMPTrapPortNumber=sNMPTrapPortNumber, ptpCompliance=ptpCompliance, siteName=siteName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, daylightSaving=daylightSaving, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecom=telecom, latitude=latitude, sNMPPortNumber=sNMPPortNumber, vLANManagementVID=vLANManagementVID, bootVersion=bootVersion, useVLANForManagementInterfaces=useVLANForManagementInterfaces, userTableIndex=userTableIndex, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, cambium=cambium, linkSymmetry=linkSymmetry, phyStatus=phyStatus, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, timeZone=timeZone, dataPortStatus=dataPortStatus, telecomGroup=telecomGroup, receiveFreqMHz=receiveFreqMHz, eIRP=eIRP, subnetMask=subnetMask, userRole=userRole, dataPortAutoNegotiation=dataPortAutoNegotiation, enabledDiagnosticAlarms=enabledDiagnosticAlarms, syslogControl=syslogControl, groupID=groupID, userEnabled=userEnabled, searchState=searchState, tFTPServerIPAddress=tFTPServerIPAddress, syslogControlGroup=syslogControlGroup, dfs=dfs, sNTPServerIPAddress=sNTPServerIPAddress, linkLoss=linkLoss, incompatibleMasterAndSlave=incompatibleMasterAndSlave, resetGroup=resetGroup, alarms=alarms, longitude=longitude, linkModeOptimizationMismatch=linkModeOptimizationMismatch, installArmState=installArmState, range=range, userName=userName, hTTPSAccessEnabled=hTTPSAccessEnabled, ptmp=ptmp, sntpGroup=sntpGroup, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, encryption=encryption, telecomsChannelStatus=telecomsChannelStatus, phyControl=phyControl, versionsGroup=versionsGroup, bandwidthVariant=bandwidthVariant, snmpControlGroup=snmpControlGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapVersion=sNMPTrapVersion, managementGroup=managementGroup, gatewayIPAddress=gatewayIPAddress, dfsGroup=dfsGroup, dfsTableEntry=dfsTableEntry, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDControlGroup=tDDControlGroup, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, notificationsGroup=notificationsGroup, masterSlaveMode=masterSlaveMode, vectorError=vectorError, channelChangeTrap=channelChangeTrap, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, maximumTransmitPower=maximumTransmitPower, signalStrengthRatio=signalStrengthRatio, snmpControl=snmpControl, hardwareVersion=hardwareVersion, sMTPSourceEmailAddress=sMTPSourceEmailAddress, ethernet=ethernet, altitude=altitude, installStatus=installStatus, licence=licence, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, installArmStateTrap=installArmStateTrap, reset=reset, smtp=smtp, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, licenceGroup=licenceGroup, sNTPLastSync=sNTPLastSync, ptpTraps=ptpTraps, transmitPower=transmitPower, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, targetMACAddress=targetMACAddress, noWirelessChannelAvailable=noWirelessChannelAvailable, configuration=configuration, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, transmitDataRate=transmitDataRate, telnetPortNumber=telnetPortNumber, encryptionGroup=encryptionGroup, userPassword=userPassword, dfsMeans=dfsMeans, pubStatsGroup=pubStatsGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, telnetAccessEnabled=telnetAccessEnabled, sMTPServerIPAddress=sMTPServerIPAddress, sNTPState=sNTPState, productVariant=productVariant, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sntp=sntp, linkName=linkName, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, secondarySoftwareVersion=secondarySoftwareVersion, smtpGroup=smtpGroup, antennaGain=antennaGain, userTable=userTable, tDDSynchronizationStatus=tDDSynchronizationStatus, syslogClient=syslogClient, dataPortDisabledWarning=dataPortDisabledWarning, transmitChannel=transmitChannel, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, telecomsLineCode=telecomsLineCode, phyStatusGroup=phyStatusGroup, receivePower=receivePower, incompatibleRegionCodes=incompatibleRegionCodes, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, receiveDataRate=receiveDataRate, sMTPEmailAlert=sMTPEmailAlert, supplementaryGroup=supplementaryGroup, tDDSynchronizationMode=tDDSynchronizationMode, frequencyVariant=frequencyVariant, syslogState=syslogState, tDDSynchronizationAlarm=tDDSynchronizationAlarm, byteErrorRatio=byteErrorRatio, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, versions=versions, sNMPTrapTableIndex=sNMPTrapTableIndex, aAAControl=aAAControl, hTTPSPortNumber=hTTPSPortNumber)
