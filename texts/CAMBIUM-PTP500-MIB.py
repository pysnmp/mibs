...
NotificationType, Integer32, enterprises, TimeTicks, Gauge32, iso, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, MibIdentifier, ModuleIdentity, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "enterprises", "TimeTicks", "Gauge32", "iso", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Counter32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", linkName=linkName, receiveModulationModeDetail=receiveModulationModeDetail, ptpCompliance=ptpCompliance, snmpControlGroup=snmpControlGroup, wirelessLinkStatus=wirelessLinkStatus, tFTPServerPortNumber=tFTPServerPortNumber, sNMPPortNumber=sNMPPortNumber, timeZone=timeZone, telecomsChannelStatus=telecomsChannelStatus, phyStatusGroup=phyStatusGroup, managementGroup=managementGroup, telecomsCableLength=telecomsCableLength, configuration=configuration, vectorError=vectorError, range=range, ptpGroups=ptpGroups, sNMPv3Enable=sNMPv3Enable, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, transmitDataRate=transmitDataRate, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, constantPowerSpectralDensity=constantPowerSpectralDensity, linkSymmetry=linkSymmetry, vLANPriorityQueueMapping=vLANPriorityQueueMapping, systemClock=systemClock, phyControlGroup=phyControlGroup, latitude=latitude, receiveModulationMode=receiveModulationMode, capacityLicenseMismatch=capacityLicenseMismatch, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sNMPTrapPortNumber=sNMPTrapPortNumber, sNTPServerPortNumber=sNTPServerPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dataPortStatusTrap=dataPortStatusTrap, receivePower=receivePower, systemReset=systemReset, transmitChannel=transmitChannel, dfsMeans=dfsMeans, telecomsLoopbackTrap=telecomsLoopbackTrap, bandwidthVariant=bandwidthVariant, userPassword=userPassword, licence=licence, gatewayIPAddress=gatewayIPAddress, channelBandwidth=channelBandwidth, telecomsLoopback=telecomsLoopback, tFTPServerIPAddress=tFTPServerIPAddress, sNMPTrapVersion=sNMPTrapVersion, licenceGroup=licenceGroup, telecomsChannelStatusTrap=telecomsChannelStatusTrap, dfs=dfs, configurationGroup=configurationGroup, telecomGroup=telecomGroup, vLANPriorityTable=vLANPriorityTable, reset=reset, maximumTransmitPower=maximumTransmitPower, supplementary=supplementary, cableLoss=cableLoss, hTTPAccessEnabled=hTTPAccessEnabled, siteName=siteName, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, remoteIPAddress=remoteIPAddress, dfsTableEntry=dfsTableEntry, ethernetGroup=ethernetGroup, antennaGain=antennaGain, searchState=searchState, longitude=longitude, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, vLANPriorityTableIndex=vLANPriorityTableIndex, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, alarmsGroup=alarmsGroup, encryptionAlgorithm=encryptionAlgorithm, tDDControl=tDDControl, regionCode=regionCode, userTableEntry=userTableEntry, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, installStatusTrap=installStatusTrap, transmitFreqMHz=transmitFreqMHz, accessMethod=accessMethod, syslogControl=syslogControl, secondarySoftwareVersion=secondarySoftwareVersion, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, encryption=encryption, frequencyVariant=frequencyVariant, installStatus=installStatus, userEnabled=userEnabled, aAAControlGroup=aAAControlGroup, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, linkModeOptimisation=linkModeOptimisation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, phyStatus=phyStatus, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTableIndex=sNMPTrapTableIndex, targetMACAddress=targetMACAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, resetGroup=resetGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, vLANPriorityTableNumber=vLANPriorityTableNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, hardwareVersion=hardwareVersion, versions=versions, tDDControlGroup=tDDControlGroup, receiveFreqMHz=receiveFreqMHz, tDDSynchronizationMode=tDDSynchronizationMode, vLANPriorityTableEntry=vLANPriorityTableEntry, transmitPower=transmitPower, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, dfsTable=dfsTable, userTable=userTable, userName=userName, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, useVLANForManagementInterfaces=useVLANForManagementInterfaces, vLANManagementPriority=vLANManagementPriority, telecomsInterface=telecomsInterface, sNMPTrapTableNumber=sNMPTrapTableNumber, syslogClientTrap=syslogClientTrap, dfsGroup=dfsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, sntpGroup=sntpGroup, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitFreqKHz=transmitFreqKHz, dfsPeaks=dfsPeaks, eIRP=eIRP, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortStatus=dataPortStatus, telecomsLineCode=telecomsLineCode, dfsTableNumber=dfsTableNumber, receiveChannel=receiveChannel, sNTPSync=sNTPSync, sNTPState=sNTPState, hTTPPortNumber=hTTPPortNumber, receiveFreqKHz=receiveFreqKHz, syslogState=syslogState, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNTPLastSync=sNTPLastSync, management=management, installArmState=installArmState, sMTPEnabledMessages=sMTPEnabledMessages, transmitModulationMode=transmitModulationMode, sNTPSyncTrap=sNTPSyncTrap, userRole=userRole, sntp=sntp, linkLoss=linkLoss, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, hTTPSPortNumber=hTTPSPortNumber, ethernetFiberSupport=ethernetFiberSupport, PYSNMP_MODULE_ID=cambium, byteErrorRatio=byteErrorRatio, ptmp=ptmp, dataPortWirelessDownAlert=dataPortWirelessDownAlert, ethernet=ethernet, masterSlaveMode=masterSlaveMode, altitude=altitude, versionsGroup=versionsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTable=sNMPTrapTable, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, dataPortDisabledWarning=dataPortDisabledWarning, telecom=telecom, notificationsGroup=notificationsGroup, unitOutOfCalibration=unitOutOfCalibration, alarms=alarms, dfsTableIndex=dfsTableIndex, ptpTrapPrefix=ptpTrapPrefix, telnetAccessEnabled=telnetAccessEnabled, subnetMask=subnetMask, regionCodeTrap=regionCodeTrap, sNMPTrapIPAddress=sNMPTrapIPAddress, cambium=cambium, syslogStateTrap=syslogStateTrap, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, encryptionGroup=encryptionGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aAAControl=aAAControl, bootVersion=bootVersion, smtpGroup=smtpGroup, pubStats=pubStats, sNTPPollInterval=sNTPPollInterval, phyControl=phyControl, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementVID=vLANManagementVID, productName=productName, installArmStateTrap=installArmStateTrap, aggregateDataRate=aggregateDataRate, channelChangeTrap=channelChangeTrap, sNMPEnabledTraps=sNMPEnabledTraps, softwareVersion=softwareVersion, daylightSaving=daylightSaving, userTableNumber=userTableNumber, signalStrengthRatio=signalStrengthRatio, ptp500=ptp500, snmpControl=snmpControl, receiveDataRate=receiveDataRate, sNMPCommunityString=sNMPCommunityString, sMTPEmailAlert=sMTPEmailAlert, dataPortAutoMdix=dataPortAutoMdix, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, iPAddress=iPAddress, supplementaryGroup=supplementaryGroup, sMTPServerPortNumber=sMTPServerPortNumber, syslogControlGroup=syslogControlGroup, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPTrapTableEntry=sNMPTrapTableEntry, telnetPortNumber=telnetPortNumber, groupID=groupID, hTTPSAccessEnabled=hTTPSAccessEnabled, sNTPServerIPAddress=sNTPServerIPAddress, sMTPServerIPAddress=sMTPServerIPAddress, pubStatsGroup=pubStatsGroup, userTableIndex=userTableIndex, licensedCapacity=licensedCapacity, ptp=ptp, productVariant=productVariant, smtp=smtp, ptpTraps=ptpTraps, syslogClient=syslogClient, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText)
