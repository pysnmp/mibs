...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", vectorError=vectorError, management=management, encryptionGroup=encryptionGroup, tDDControlGroup=tDDControlGroup, notificationsGroup=notificationsGroup, sNMPTrapVersion=sNMPTrapVersion, dfsTable=dfsTable, targetMACAddress=targetMACAddress, PYSNMP_MODULE_ID=cambium, userPassword=userPassword, installStatusTrap=installStatusTrap, incompatibleRegionCodes=incompatibleRegionCodes, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, syslogControlGroup=syslogControlGroup, vLANPriorityTable=vLANPriorityTable, telecomsChannelStatus=telecomsChannelStatus, phyStatus=phyStatus, telecomGroup=telecomGroup, userEnabled=userEnabled, ethernetFiberSupport=ethernetFiberSupport, userTableIndex=userTableIndex, latitude=latitude, remoteMaximumTransmitPower=remoteMaximumTransmitPower, linkModeOptimisation=linkModeOptimisation, receivePower=receivePower, tDDSynchronizationAlarm=tDDSynchronizationAlarm, maximumTransmitPower=maximumTransmitPower, secondarySoftwareVersion=secondarySoftwareVersion, sntpGroup=sntpGroup, cableLoss=cableLoss, timeZone=timeZone, syslogState=syslogState, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, ptpGroups=ptpGroups, constantPowerSpectralDensity=constantPowerSpectralDensity, signalStrengthRatio=signalStrengthRatio, telecom=telecom, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, ptmp=ptmp, groupID=groupID, configuration=configuration, syslogControl=syslogControl, sNTPServerIPAddress=sNTPServerIPAddress, telecomsInterface=telecomsInterface, sNMPTrapTableIndex=sNMPTrapTableIndex, siteName=siteName, range=range, ethernetGroup=ethernetGroup, telecomsLoopbackTrap=telecomsLoopbackTrap, tDDSynchronizationStatus=tDDSynchronizationStatus, receiveChannel=receiveChannel, productName=productName, sNTPLastSync=sNTPLastSync, telnetPortNumber=telnetPortNumber, transmitFreqKHz=transmitFreqKHz, sNMPTrapTableEntry=sNMPTrapTableEntry, dfsTableIndex=dfsTableIndex, bandwidthVariant=bandwidthVariant, systemClock=systemClock, telecomsChannelStatusTrap=telecomsChannelStatusTrap, receiveModulationMode=receiveModulationMode, dfsPeaks=dfsPeaks, versionsGroup=versionsGroup, regionCode=regionCode, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, pubStats=pubStats, tDDControl=tDDControl, userTableNumber=userTableNumber, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, noWirelessChannelAvailable=noWirelessChannelAvailable, productVariant=productVariant, vLANPriorityTableNumber=vLANPriorityTableNumber, unitOutOfCalibration=unitOutOfCalibration, vLANPriorityQueueMapping=vLANPriorityQueueMapping, pubStatsGroup=pubStatsGroup, managementGroup=managementGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNTPPollInterval=sNTPPollInterval, smtpGroup=smtpGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, sNMPTrapTableNumber=sNMPTrapTableNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, userName=userName, snmpControl=snmpControl, byteErrorRatio=byteErrorRatio, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, channelBandwidth=channelBandwidth, receiveModulationModeDetail=receiveModulationModeDetail, incompatibleMasterAndSlave=incompatibleMasterAndSlave, phyStatusGroup=phyStatusGroup, ptpCompliance=ptpCompliance, smtp=smtp, tFTPServerPortNumber=tFTPServerPortNumber, ptp=ptp, licence=licence, telecomsLineCode=telecomsLineCode, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitModulationMode=transmitModulationMode, ethernet=ethernet, sNTPSync=sNTPSync, dfs=dfs, versions=versions, linkSymmetry=linkSymmetry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sMTPEmailAlert=sMTPEmailAlert, altitude=altitude, tDDSynchronizationMode=tDDSynchronizationMode, userTableEntry=userTableEntry, hTTPPortNumber=hTTPPortNumber, syslogLocalWrappedTrap=syslogLocalWrappedTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tFTPServerIPAddress=tFTPServerIPAddress, syslogClientTrap=syslogClientTrap, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, dfsGroup=dfsGroup, vLANManagementVID=vLANManagementVID, accessMethod=accessMethod, syslogClient=syslogClient, sMTPServerIPAddress=sMTPServerIPAddress, transmitDataRate=transmitDataRate, phyControlGroup=phyControlGroup, supplementaryGroup=supplementaryGroup, daylightSaving=daylightSaving, sNMPTrapPortNumber=sNMPTrapPortNumber, frequencyVariant=frequencyVariant, sntp=sntp, wirelessLinkStatus=wirelessLinkStatus, telecomsLoopback=telecomsLoopback, sNMPEnabledTraps=sNMPEnabledTraps, hTTPAccessEnabled=hTTPAccessEnabled, receiveFreqMHz=receiveFreqMHz, encryption=encryption, eIRP=eIRP, resetGroup=resetGroup, transmitFreqMHz=transmitFreqMHz, receiveFreqKHz=receiveFreqKHz, linkModeOptimizationMismatch=linkModeOptimizationMismatch, aggregateDataRate=aggregateDataRate, aAAControlGroup=aAAControlGroup, transmitChannel=transmitChannel, sNMPTrapIPAddress=sNMPTrapIPAddress, bootVersion=bootVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licensedCapacity=licensedCapacity, dataPortDisabledWarning=dataPortDisabledWarning, antennaGain=antennaGain, telnetAccessEnabled=telnetAccessEnabled, syslogStateTrap=syslogStateTrap, licenceGroup=licenceGroup, dfsTableNumber=dfsTableNumber, dfsMeans=dfsMeans, channelChangeTrap=channelChangeTrap, sNMPPortNumber=sNMPPortNumber, searchState=searchState, sNTPState=sNTPState, dfsTableEntry=dfsTableEntry, ptpTraps=ptpTraps, encryptionAlgorithm=encryptionAlgorithm, iPAddress=iPAddress, remoteIPAddress=remoteIPAddress, cambium=cambium, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPv3Enable=sNMPv3Enable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, sNTPServerPortNumber=sNTPServerPortNumber, hardwareVersion=hardwareVersion, linkName=linkName, dataPortStatus=dataPortStatus, masterSlaveMode=masterSlaveMode, reset=reset, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, ptp500=ptp500, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, transmitPower=transmitPower, sMTPEnabledMessages=sMTPEnabledMessages, sNMPTrapTable=sNMPTrapTable, gatewayIPAddress=gatewayIPAddress, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, alarmsGroup=alarmsGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, regionCodeTrap=regionCodeTrap, installArmStateTrap=installArmStateTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, phyControl=phyControl, subnetMask=subnetMask, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, capacityLicenseMismatch=capacityLicenseMismatch, dataPortStatusTrap=dataPortStatusTrap, installArmState=installArmState, configurationGroup=configurationGroup, wirelessLinkAvailability=wirelessLinkAvailability, linkLoss=linkLoss, sNTPSyncTrap=sNTPSyncTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, receiveDataRate=receiveDataRate, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sNMPCommunityString=sNMPCommunityString, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, longitude=longitude, supplementary=supplementary, vLANManagementPriority=vLANManagementPriority, dataPortWirelessDownAlert=dataPortWirelessDownAlert, telecomsCableLength=telecomsCableLength, snmpControlGroup=snmpControlGroup, installStatus=installStatus, hTTPSPortNumber=hTTPSPortNumber, hTTPSAccessEnabled=hTTPSAccessEnabled, userRole=userRole, aAAControl=aAAControl, userTable=userTable, ptpTrapPrefix=ptpTrapPrefix, dataPortAutoMdix=dataPortAutoMdix, useVLANForManagementInterfaces=useVLANForManagementInterfaces, systemReset=systemReset, softwareVersion=softwareVersion, alarms=alarms, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, sMTPServerPortNumber=sMTPServerPortNumber)
