...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, enterprises, iso, TimeTicks, ModuleIdentity, NotificationType, Bits, Counter32, Gauge32, Unsigned32, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "enterprises", "iso", "TimeTicks", "ModuleIdentity", "NotificationType", "Bits", "Counter32", "Gauge32", "Unsigned32", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dfsPeaks=dfsPeaks, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, userRole=userRole, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, resetGroup=resetGroup, ethernetFiberSupport=ethernetFiberSupport, syslogControl=syslogControl, range=range, syslogClient=syslogClient, syslogStateTrap=syslogStateTrap, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, sNMPTrapTableNumber=sNMPTrapTableNumber, ptpTrapPrefix=ptpTrapPrefix, aAAControlGroup=aAAControlGroup, unitOutOfCalibration=unitOutOfCalibration, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tDDControl=tDDControl, sntp=sntp, subnetMask=subnetMask, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, syslogState=syslogState, linkLoss=linkLoss, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, vLANPriorityTableEntry=vLANPriorityTableEntry, cambium=cambium, telecomsCableLength=telecomsCableLength, capacityLicenseMismatch=capacityLicenseMismatch, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sMTPEmailAlert=sMTPEmailAlert, sMTPServerIPAddress=sMTPServerIPAddress, linkName=linkName, sMTPEnabledMessages=sMTPEnabledMessages, dfs=dfs, telecomsLoopback=telecomsLoopback, supplementaryGroup=supplementaryGroup, hTTPAccessEnabled=hTTPAccessEnabled, dataPortConfigurationMismatch=dataPortConfigurationMismatch, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, transmitFreqKHz=transmitFreqKHz, telecomsLoopbackTrap=telecomsLoopbackTrap, snmpControlGroup=snmpControlGroup, licensedCapacity=licensedCapacity, sNMPTrapPortNumber=sNMPTrapPortNumber, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsLineCode=telecomsLineCode, sNTPSync=sNTPSync, alarms=alarms, telecomsInterface=telecomsInterface, hardwareVersion=hardwareVersion, smtpGroup=smtpGroup, sNTPServerIPAddress=sNTPServerIPAddress, userEnabled=userEnabled, sMTPServerPortNumber=sMTPServerPortNumber, channelBandwidth=channelBandwidth, installArmState=installArmState, configurationGroup=configurationGroup, transmitFreqMHz=transmitFreqMHz, useVLANForManagementInterfaces=useVLANForManagementInterfaces, sNMPTrapIPAddress=sNMPTrapIPAddress, vLANPriorityTable=vLANPriorityTable, transmitModulationMode=transmitModulationMode, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecom=telecom, productVariant=productVariant, hTTPPortNumber=hTTPPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, hTTPSPortNumber=hTTPSPortNumber, telecomsChannelStatus=telecomsChannelStatus, targetMACAddress=targetMACAddress, sNTPLastSync=sNTPLastSync, smtp=smtp, ptpCompliance=ptpCompliance, installStatus=installStatus, userTable=userTable, accessMethod=accessMethod, groupID=groupID, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPPollInterval=sNTPPollInterval, sNMPEnabledTraps=sNMPEnabledTraps, userTableNumber=userTableNumber, dfsTable=dfsTable, phyStatusGroup=phyStatusGroup, sNMPTrapVersion=sNMPTrapVersion, transmitPower=transmitPower, ptp500=ptp500, dfsMeans=dfsMeans, remoteIPAddress=remoteIPAddress, installStatusTrap=installStatusTrap, telnetPortNumber=telnetPortNumber, snmpControl=snmpControl, secondarySoftwareVersion=secondarySoftwareVersion, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, altitude=altitude, gatewayIPAddress=gatewayIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, sNMPPortNumber=sNMPPortNumber, userName=userName, cableLoss=cableLoss, tFTPServerPortNumber=tFTPServerPortNumber, alarmsGroup=alarmsGroup, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPCommunityString=sNMPCommunityString, encryption=encryption, userPassword=userPassword, telnetAccessEnabled=telnetAccessEnabled, encryptionAlgorithm=encryptionAlgorithm, incompatibleMasterAndSlave=incompatibleMasterAndSlave, ptmp=ptmp, regionCodeTrap=regionCodeTrap, ethernetGroup=ethernetGroup, phyControlGroup=phyControlGroup, configuration=configuration, pubStats=pubStats, dataPortAutoMdix=dataPortAutoMdix, ptpGroups=ptpGroups, latitude=latitude, receiveModulationMode=receiveModulationMode, systemReset=systemReset, siteName=siteName, dfsTableIndex=dfsTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, management=management, ethernet=ethernet, dataPortDisabledWarning=dataPortDisabledWarning, aAAControl=aAAControl, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, sntpGroup=sntpGroup, supplementary=supplementary, receivePower=receivePower, wirelessLinkAvailability=wirelessLinkAvailability, systemClock=systemClock, tDDControlGroup=tDDControlGroup, syslogControlGroup=syslogControlGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, receiveFreqMHz=receiveFreqMHz, managementGroup=managementGroup, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dataPortAutoNegotiation=dataPortAutoNegotiation, antennaGain=antennaGain, licence=licence, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, phyControl=phyControl, softwareVersion=softwareVersion, byteErrorRatio=byteErrorRatio, userTableIndex=userTableIndex, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, syslogLocalWrappedTrap=syslogLocalWrappedTrap, maximumTransmitPower=maximumTransmitPower, searchState=searchState, ptpTraps=ptpTraps, vLANManagementPriority=vLANManagementPriority, transmitChannel=transmitChannel, channelChangeTrap=channelChangeTrap, signalStrengthRatio=signalStrengthRatio, dataPortStatus=dataPortStatus, versions=versions, tDDSynchronizationStatus=tDDSynchronizationStatus, productName=productName, sNMPTrapTable=sNMPTrapTable, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, receiveDataRate=receiveDataRate, sNTPServerPortNumber=sNTPServerPortNumber, installArmStateTrap=installArmStateTrap, receiveChannel=receiveChannel, receiveFreqKHz=receiveFreqKHz, regionCode=regionCode, aggregateDataRate=aggregateDataRate, PYSNMP_MODULE_ID=cambium, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, linkSymmetry=linkSymmetry, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, licenceGroup=licenceGroup, tDDSynchronizationAlarm=tDDSynchronizationAlarm, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, iPAddress=iPAddress, ptp=ptp, dfsTableNumber=dfsTableNumber, sNMPv3Enable=sNMPv3Enable, frequencyVariant=frequencyVariant, reset=reset, encryptionGroup=encryptionGroup, phyStatus=phyStatus, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sMTPSourceEmailAddress=sMTPSourceEmailAddress, tFTPServerIPAddress=tFTPServerIPAddress, daylightSaving=daylightSaving, dataPortStatusTrap=dataPortStatusTrap, dfsTableEntry=dfsTableEntry, eIRP=eIRP, linkModeOptimisation=linkModeOptimisation, tDDSynchronizationMode=tDDSynchronizationMode, syslogClientTrap=syslogClientTrap, userTableEntry=userTableEntry, vectorError=vectorError, notificationsGroup=notificationsGroup, timeZone=timeZone, bootVersion=bootVersion, sNTPSyncTrap=sNTPSyncTrap, receiveModulationModeDetail=receiveModulationModeDetail, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkStatus=wirelessLinkStatus, dfsGroup=dfsGroup, bandwidthVariant=bandwidthVariant, incompatibleRegionCodes=incompatibleRegionCodes, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, sNMPTrapTableEntry=sNMPTrapTableEntry, sNTPState=sNTPState, pubStatsGroup=pubStatsGroup, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementVID=vLANManagementVID, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, transmitDataRate=transmitDataRate, constantPowerSpectralDensity=constantPowerSpectralDensity, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, masterSlaveMode=masterSlaveMode, dataPortWirelessDownAlert=dataPortWirelessDownAlert, versionsGroup=versionsGroup, telecomGroup=telecomGroup, longitude=longitude, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles)
