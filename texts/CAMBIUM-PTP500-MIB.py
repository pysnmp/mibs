...
ModuleIdentity, Integer32, IpAddress, Counter64, Gauge32, ObjectIdentity, MibIdentifier, iso, enterprises, NotificationType, Bits, TimeTicks, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "IpAddress", "Counter64", "Gauge32", "ObjectIdentity", "MibIdentifier", "iso", "enterprises", "NotificationType", "Bits", "TimeTicks", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", syslogClientTrap=syslogClientTrap, sNTPLastSync=sNTPLastSync, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPCommunityString=sNMPCommunityString, smtpGroup=smtpGroup, daylightSaving=daylightSaving, transmitDataRate=transmitDataRate, snmpControl=snmpControl, aggregateDataRate=aggregateDataRate, dfsTableNumber=dfsTableNumber, softwareVersion=softwareVersion, ethernetGroup=ethernetGroup, sMTPEnabledMessages=sMTPEnabledMessages, systemClock=systemClock, syslogClient=syslogClient, useVLANForManagementInterfaces=useVLANForManagementInterfaces, frequencyVariant=frequencyVariant, gatewayIPAddress=gatewayIPAddress, incompatibleMasterAndSlave=incompatibleMasterAndSlave, sNMPTrapTableIndex=sNMPTrapTableIndex, telecomsChannelStatus=telecomsChannelStatus, groupID=groupID, tFTPServerIPAddress=tFTPServerIPAddress, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNMPEnabledTraps=sNMPEnabledTraps, dataPortStatus=dataPortStatus, configuration=configuration, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, bootVersion=bootVersion, bandwidthVariant=bandwidthVariant, vLANManagementVID=vLANManagementVID, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userEnabled=userEnabled, iPAddress=iPAddress, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, managementGroup=managementGroup, linkName=linkName, receiveFreqKHz=receiveFreqKHz, phyStatus=phyStatus, encryption=encryption, dataPortConfigurationMismatch=dataPortConfigurationMismatch, linkModeOptimisation=linkModeOptimisation, accessMethod=accessMethod, phyControl=phyControl, aAAControlGroup=aAAControlGroup, transmitFreqMHz=transmitFreqMHz, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, searchState=searchState, userTableNumber=userTableNumber, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, tDDControl=tDDControl, telnetPortNumber=telnetPortNumber, encryptionAlgorithm=encryptionAlgorithm, tDDSynchronizationStatus=tDDSynchronizationStatus, ptpCompliance=ptpCompliance, hTTPSPortNumber=hTTPSPortNumber, syslogStateTrap=syslogStateTrap, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, management=management, sNMPTrapTableEntry=sNMPTrapTableEntry, linkSymmetry=linkSymmetry, vLANPriorityTable=vLANPriorityTable, receiveModulationModeDetail=receiveModulationModeDetail, targetMACAddress=targetMACAddress, wirelessLinkStatus=wirelessLinkStatus, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, regionCode=regionCode, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, dfsTableIndex=dfsTableIndex, telecomsLoopback=telecomsLoopback, smtp=smtp, dfsPeaks=dfsPeaks, syslogControlGroup=syslogControlGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, receiveChannel=receiveChannel, dataPortDisabledWarning=dataPortDisabledWarning, vLANPriorityTableNumber=vLANPriorityTableNumber, sNMPTrapTableNumber=sNMPTrapTableNumber, altitude=altitude, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sntp=sntp, remoteIPAddress=remoteIPAddress, telnetAccessEnabled=telnetAccessEnabled, sNMPTrapIPAddress=sNMPTrapIPAddress, ethernet=ethernet, pubStatsGroup=pubStatsGroup, sNMPTrapTable=sNMPTrapTable, antennaGain=antennaGain, dataPortStatusTrap=dataPortStatusTrap, transmitFreqKHz=transmitFreqKHz, ptpTraps=ptpTraps, dfsGroup=dfsGroup, channelChangeTrap=channelChangeTrap, sntpGroup=sntpGroup, userRole=userRole, masterSlaveMode=masterSlaveMode, supplementaryGroup=supplementaryGroup, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, enabledDiagnosticAlarms=enabledDiagnosticAlarms, telecomsLoopbackTrap=telecomsLoopbackTrap, telecomsLineCode=telecomsLineCode, sNTPPollInterval=sNTPPollInterval, aAAControl=aAAControl, alarms=alarms, pubStats=pubStats, transmitModulationMode=transmitModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, versions=versions, productName=productName, dfsMeans=dfsMeans, sMTPEmailAlert=sMTPEmailAlert, range=range, userPassword=userPassword, productVariant=productVariant, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, sNMPPortNumber=sNMPPortNumber, hTTPAccessEnabled=hTTPAccessEnabled, maximumTransmitPower=maximumTransmitPower, installArmState=installArmState, installStatusTrap=installStatusTrap, dfsTableEntry=dfsTableEntry, ptpGroups=ptpGroups, sMTPSourceEmailAddress=sMTPSourceEmailAddress, snmpControlGroup=snmpControlGroup, transmitChannel=transmitChannel, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, sMTPServerIPAddress=sMTPServerIPAddress, userTableEntry=userTableEntry, vLANPriorityTableEntry=vLANPriorityTableEntry, telecomsInterface=telecomsInterface, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, incompatibleRegionCodes=incompatibleRegionCodes, sNTPSync=sNTPSync, installArmStateTrap=installArmStateTrap, regionCodeTrap=regionCodeTrap, eIRP=eIRP, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, tDDControlGroup=tDDControlGroup, channelBandwidth=channelBandwidth, phyStatusGroup=phyStatusGroup, alarmsGroup=alarmsGroup, syslogLocalWrappedTrap=syslogLocalWrappedTrap, transmitPower=transmitPower, syslogControl=syslogControl, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, reset=reset, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, constantPowerSpectralDensity=constantPowerSpectralDensity, userTable=userTable, capacityLicenseMismatch=capacityLicenseMismatch, tFTPServerPortNumber=tFTPServerPortNumber, longitude=longitude, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, syslogState=syslogState, sNTPServerIPAddress=sNTPServerIPAddress, telecomsChannelStatusTrap=telecomsChannelStatusTrap, telecomsCableLength=telecomsCableLength, ptp=ptp, receiveFreqMHz=receiveFreqMHz, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptp500=ptp500, userTableIndex=userTableIndex, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, siteName=siteName, ptmp=ptmp, dataPortAutoNegotiation=dataPortAutoNegotiation, timeZone=timeZone, configurationGroup=configurationGroup, systemReset=systemReset, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, cambium=cambium, versionsGroup=versionsGroup, sNTPSyncTrap=sNTPSyncTrap, telecomGroup=telecomGroup, sNMPv3Enable=sNMPv3Enable, PYSNMP_MODULE_ID=cambium, vLANPriorityTableIndex=vLANPriorityTableIndex, telecom=telecom, vLANPriorityQueueMapping=vLANPriorityQueueMapping, sNMPTrapVersion=sNMPTrapVersion, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, tDDSynchronizationMode=tDDSynchronizationMode, sNTPServerPortNumber=sNTPServerPortNumber, noWirelessChannelAvailable=noWirelessChannelAvailable, encryptionGroup=encryptionGroup, subnetMask=subnetMask, ptpTrapPrefix=ptpTrapPrefix, notificationsGroup=notificationsGroup, ethernetFiberSupport=ethernetFiberSupport, unitOutOfCalibration=unitOutOfCalibration, vLANManagementPriority=vLANManagementPriority, byteErrorRatio=byteErrorRatio, cableLoss=cableLoss, dataPortWirelessDownAlert=dataPortWirelessDownAlert, hTTPPortNumber=hTTPPortNumber, linkLoss=linkLoss, sNTPState=sNTPState, remoteMaximumTransmitPower=remoteMaximumTransmitPower, sMTPServerPortNumber=sMTPServerPortNumber, receiveDataRate=receiveDataRate, hTTPSAccessEnabled=hTTPSAccessEnabled, sNMPTrapPortNumber=sNMPTrapPortNumber, phyControlGroup=phyControlGroup, dataPortAutoMdix=dataPortAutoMdix, licence=licence, licensedCapacity=licensedCapacity, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTable=dfsTable, signalStrengthRatio=signalStrengthRatio, vectorError=vectorError, secondarySoftwareVersion=secondarySoftwareVersion, supplementary=supplementary, linkModeOptimizationMismatch=linkModeOptimizationMismatch, hardwareVersion=hardwareVersion, dfs=dfs, resetGroup=resetGroup, installStatus=installStatus, userName=userName, latitude=latitude, receiveModulationMode=receiveModulationMode, licenceGroup=licenceGroup, receivePower=receivePower)
