...
# Produced by pysmi-1.1.8 at Wed Feb  2 17:53:15 2022
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", useVLANForManagementInterfaces=useVLANForManagementInterfaces, telecomsChannelStatusTrap=telecomsChannelStatusTrap, managementGroup=managementGroup, vLANPriorityTableIndex=vLANPriorityTableIndex, dataPortAutoNegotiation=dataPortAutoNegotiation, telecomsChannelStatus=telecomsChannelStatus, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, sntpGroup=sntpGroup, dataPortConfigurationMismatch=dataPortConfigurationMismatch, cableLoss=cableLoss, userTableNumber=userTableNumber, sNTPSyncTrap=sNTPSyncTrap, vLANPriorityTable=vLANPriorityTable, sNMPTrapTableNumber=sNMPTrapTableNumber, transmitDataRate=transmitDataRate, maximumTransmitPower=maximumTransmitPower, pubStatsGroup=pubStatsGroup, softwareVersion=softwareVersion, masterSlaveMode=masterSlaveMode, productName=productName, linkLoss=linkLoss, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPServerIPAddress=tFTPServerIPAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sNTPServerIPAddress=sNTPServerIPAddress, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, receiveChannel=receiveChannel, sNMPTrapPortNumber=sNMPTrapPortNumber, sMTPSourceEmailAddress=sMTPSourceEmailAddress, linkModeOptimisation=linkModeOptimisation, channelChangeTrap=channelChangeTrap, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDSynchronizationMode=tDDSynchronizationMode, userRole=userRole, aAAControl=aAAControl, gatewayIPAddress=gatewayIPAddress, dataPortStatus=dataPortStatus, sNMPTrapIPAddress=sNMPTrapIPAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, longitude=longitude, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, dfsTable=dfsTable, hTTPAccessEnabled=hTTPAccessEnabled, dataPortWirelessDownAlert=dataPortWirelessDownAlert, licence=licence, timeZone=timeZone, ethernetGroup=ethernetGroup, alarmsGroup=alarmsGroup, cambium=cambium, smtp=smtp, subnetMask=subnetMask, aggregateDataRate=aggregateDataRate, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, encryption=encryption, sNMPTrapTableEntry=sNMPTrapTableEntry, eIRP=eIRP, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, syslogLocalWrappedTrap=syslogLocalWrappedTrap, targetMACAddress=targetMACAddress, sNTPServerPortNumber=sNTPServerPortNumber, alarms=alarms, supplementaryGroup=supplementaryGroup, groupID=groupID, installStatus=installStatus, ptp=ptp, syslogState=syslogState, sNMPCommunityString=sNMPCommunityString, encryptionAlgorithm=encryptionAlgorithm, ethernet=ethernet, supplementary=supplementary, telecomGroup=telecomGroup, vLANPriorityTableEntry=vLANPriorityTableEntry, receiveModulationMode=receiveModulationMode, wirelessLinkAvailability=wirelessLinkAvailability, vLANManagementPriority=vLANManagementPriority, dfsMeans=dfsMeans, pubStats=pubStats, regionCodeTrap=regionCodeTrap, transmitFreqMHz=transmitFreqMHz, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, sNMPTrapTable=sNMPTrapTable, receiveModulationModeDetail=receiveModulationModeDetail, dataPortDisabledWarning=dataPortDisabledWarning, daylightSaving=daylightSaving, configuration=configuration, notificationsGroup=notificationsGroup, sMTPEmailAlert=sMTPEmailAlert, systemClock=systemClock, siteName=siteName, signalStrengthRatio=signalStrengthRatio, phyControlGroup=phyControlGroup, userPassword=userPassword, ethernetFiberSupport=ethernetFiberSupport, phyStatus=phyStatus, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, remoteIPAddress=remoteIPAddress, transmitFreqKHz=transmitFreqKHz, constantPowerSpectralDensity=constantPowerSpectralDensity, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, userTableIndex=userTableIndex, encryptionGroup=encryptionGroup, ptpTrapPrefix=ptpTrapPrefix, installStatusTrap=installStatusTrap, unitOutOfCalibration=unitOutOfCalibration, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNMPv3Enable=sNMPv3Enable, vLANPriorityTableNumber=vLANPriorityTableNumber, telnetAccessEnabled=telnetAccessEnabled, searchState=searchState, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, tDDControlGroup=tDDControlGroup, sNMPEnabledTraps=sNMPEnabledTraps, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, management=management, linkSymmetry=linkSymmetry, tDDControl=tDDControl, syslogControlGroup=syslogControlGroup, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, ptp500=ptp500, frequencyVariant=frequencyVariant, sNTPPollInterval=sNTPPollInterval, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, hTTPPortNumber=hTTPPortNumber, smtpGroup=smtpGroup, installArmStateTrap=installArmStateTrap, aAAControlGroup=aAAControlGroup, dfs=dfs, transmitModulationMode=transmitModulationMode, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkModeOptimizationMismatch=linkModeOptimizationMismatch, sntp=sntp, telecom=telecom, phyControl=phyControl, channelBandwidth=channelBandwidth, telecomsLoopback=telecomsLoopback, phyStatusGroup=phyStatusGroup, vectorError=vectorError, receivePower=receivePower, hTTPSAccessEnabled=hTTPSAccessEnabled, tDDSynchronizationAlarm=tDDSynchronizationAlarm, noWirelessChannelAvailable=noWirelessChannelAvailable, ptpGroups=ptpGroups, hTTPSPortNumber=hTTPSPortNumber, latitude=latitude, ptmp=ptmp, sNMPTrapVersion=sNMPTrapVersion, transmitPower=transmitPower, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, accessMethod=accessMethod, range=range, dfsTableEntry=dfsTableEntry, configurationGroup=configurationGroup, bootVersion=bootVersion, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, ptpCompliance=ptpCompliance, dataPortAutoMdix=dataPortAutoMdix, userEnabled=userEnabled, byteErrorRatio=byteErrorRatio, sNTPSync=sNTPSync, licenceGroup=licenceGroup, linkName=linkName, telecomsCableLength=telecomsCableLength, systemReset=systemReset, secondarySoftwareVersion=secondarySoftwareVersion, dataPortStatusTrap=dataPortStatusTrap, telnetPortNumber=telnetPortNumber, regionCode=regionCode, resetGroup=resetGroup, ptpTraps=ptpTraps, tFTPServerPortNumber=tFTPServerPortNumber, hardwareVersion=hardwareVersion, versions=versions, receiveFreqKHz=receiveFreqKHz, syslogControl=syslogControl, sMTPServerPortNumber=sMTPServerPortNumber, dfsGroup=dfsGroup, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, userTableEntry=userTableEntry, telecomsLineCode=telecomsLineCode, receiveFreqMHz=receiveFreqMHz, userTable=userTable, versionsGroup=versionsGroup, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, capacityLicenseMismatch=capacityLicenseMismatch, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, receiveDataRate=receiveDataRate, productVariant=productVariant, PYSNMP_MODULE_ID=cambium, sNMPPortNumber=sNMPPortNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, userName=userName, incompatibleRegionCodes=incompatibleRegionCodes, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, snmpControl=snmpControl, dfsTableIndex=dfsTableIndex, sNTPState=sNTPState, iPAddress=iPAddress, bandwidthVariant=bandwidthVariant, licensedCapacity=licensedCapacity, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, reset=reset, syslogClientTrap=syslogClientTrap, telecomsInterface=telecomsInterface, sNTPLastSync=sNTPLastSync, syslogStateTrap=syslogStateTrap, snmpControlGroup=snmpControlGroup, tDDSynchronizationStatus=tDDSynchronizationStatus, vLANManagementVID=vLANManagementVID, antennaGain=antennaGain, dfsPeaks=dfsPeaks, altitude=altitude, syslogClient=syslogClient, wirelessLinkStatus=wirelessLinkStatus, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, telecomsLoopbackTrap=telecomsLoopbackTrap, installArmState=installArmState, enabledDiagnosticAlarms=enabledDiagnosticAlarms, sMTPServerIPAddress=sMTPServerIPAddress, sMTPEnabledMessages=sMTPEnabledMessages, transmitChannel=transmitChannel)
