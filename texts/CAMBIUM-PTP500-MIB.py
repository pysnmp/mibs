...
# Produced by pysmi-1.1.0 at Fri Nov 19 14:49:34 2021
...
ModuleIdentity, Counter32, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, NotificationType, iso, Unsigned32, ObjectIdentity, MibIdentifier, Integer32, TimeTicks, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "NotificationType", "iso", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Integer32", "TimeTicks", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", reset=reset, timeZone=timeZone, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, vLANPriorityTableIndex=vLANPriorityTableIndex, syslogClientTrap=syslogClientTrap, pubStats=pubStats, incompatibleMasterAndSlave=incompatibleMasterAndSlave, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, linkSymmetry=linkSymmetry, sMTPServerIPAddress=sMTPServerIPAddress, sNTPSyncTrap=sNTPSyncTrap, incompatibleRegionCodes=incompatibleRegionCodes, vLANPriorityQueueMapping=vLANPriorityQueueMapping, masterSlaveMode=masterSlaveMode, telecomsChannelStatusTrap=telecomsChannelStatusTrap, siteName=siteName, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, transmitFreqKHz=transmitFreqKHz, secondarySoftwareVersion=secondarySoftwareVersion, gatewayIPAddress=gatewayIPAddress, longitude=longitude, ethernet=ethernet, range=range, wirelessLinkStatus=wirelessLinkStatus, syslogStateTrap=syslogStateTrap, ptp=ptp, tDDSynchronizationAlarm=tDDSynchronizationAlarm, sNTPLastSync=sNTPLastSync, sNMPTrapTableNumber=sNMPTrapTableNumber, dfsTable=dfsTable, groupID=groupID, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, managementGroup=managementGroup, signalStrengthRatio=signalStrengthRatio, userEnabled=userEnabled, snmpControl=snmpControl, vectorError=vectorError, dfsPeaks=dfsPeaks, systemReset=systemReset, userTableIndex=userTableIndex, userRole=userRole, ethernetGroup=ethernetGroup, syslogControl=syslogControl, maximumTransmitPower=maximumTransmitPower, versions=versions, PYSNMP_MODULE_ID=cambium, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, sNMPTrapTableEntry=sNMPTrapTableEntry, smtp=smtp, ptpTraps=ptpTraps, receivePower=receivePower, encryptionAlgorithm=encryptionAlgorithm, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, pubStatsGroup=pubStatsGroup, userTable=userTable, hTTPSPortNumber=hTTPSPortNumber, sNTPState=sNTPState, sntp=sntp, tDDControlGroup=tDDControlGroup, bandwidthVariant=bandwidthVariant, telecomsLoopback=telecomsLoopback, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, vLANPriorityTableEntry=vLANPriorityTableEntry, telecom=telecom, telecomsCableLength=telecomsCableLength, alarmsGroup=alarmsGroup, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, sNTPSync=sNTPSync, eIRP=eIRP, dfsTableEntry=dfsTableEntry, dataPortStatus=dataPortStatus, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, frequencyVariant=frequencyVariant, transmitDataRate=transmitDataRate, resetGroup=resetGroup, aggregateDataRate=aggregateDataRate, regionCode=regionCode, sMTPEmailAlert=sMTPEmailAlert, phyControl=phyControl, searchState=searchState, dataPortStatusTrap=dataPortStatusTrap, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, cambium=cambium, ptmp=ptmp, licence=licence, alarms=alarms, tFTPServerIPAddress=tFTPServerIPAddress, transmitFreqMHz=transmitFreqMHz, capacityLicenseMismatch=capacityLicenseMismatch, byteErrorRatio=byteErrorRatio, sNMPTrapVersion=sNMPTrapVersion, transmitModulationMode=transmitModulationMode, linkLoss=linkLoss, subnetMask=subnetMask, enabledDiagnosticAlarms=enabledDiagnosticAlarms, dfsTableIndex=dfsTableIndex, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, syslogClient=syslogClient, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, productName=productName, telecomsLineCode=telecomsLineCode, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, accessMethod=accessMethod, noWirelessChannelAvailable=noWirelessChannelAvailable, sNTPPollInterval=sNTPPollInterval, daylightSaving=daylightSaving, tFTPServerPortNumber=tFTPServerPortNumber, dataPortAutoNegotiation=dataPortAutoNegotiation, ethernetFiberSupport=ethernetFiberSupport, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, regionCodeTrap=regionCodeTrap, smtpGroup=smtpGroup, wirelessLinkAvailability=wirelessLinkAvailability, sNMPv3Enable=sNMPv3Enable, sntpGroup=sntpGroup, sNMPPortNumber=sNMPPortNumber, tDDSynchronizationMode=tDDSynchronizationMode, phyControlGroup=phyControlGroup, useVLANForManagementInterfaces=useVLANForManagementInterfaces, hTTPAccessEnabled=hTTPAccessEnabled, transmitPower=transmitPower, phyStatusGroup=phyStatusGroup, receiveFreqKHz=receiveFreqKHz, dataPortDisabledWarning=dataPortDisabledWarning, aAAControl=aAAControl, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveModulationModeDetail=receiveModulationModeDetail, hardwareVersion=hardwareVersion, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, licensedCapacity=licensedCapacity, softwareVersion=softwareVersion, remoteIPAddress=remoteIPAddress, syslogLocalWrappedTrap=syslogLocalWrappedTrap, userPassword=userPassword, channelBandwidth=channelBandwidth, telecomsLoopbackTrap=telecomsLoopbackTrap, sNTPServerPortNumber=sNTPServerPortNumber, encryptionGroup=encryptionGroup, altitude=altitude, ptp500=ptp500, vLANPriorityTableNumber=vLANPriorityTableNumber, targetMACAddress=targetMACAddress, transmitChannel=transmitChannel, sNMPTrapTableIndex=sNMPTrapTableIndex, tDDControl=tDDControl, cableLoss=cableLoss, installStatusTrap=installStatusTrap, hTTPPortNumber=hTTPPortNumber, telecomsChannelStatus=telecomsChannelStatus, dfsGroup=dfsGroup, syslogControlGroup=syslogControlGroup, telnetAccessEnabled=telnetAccessEnabled, vLANManagementVID=vLANManagementVID, configurationGroup=configurationGroup, telnetPortNumber=telnetPortNumber, aAAControlGroup=aAAControlGroup, ptpGroups=ptpGroups, installStatus=installStatus, remoteMaximumTransmitPower=remoteMaximumTransmitPower, installArmState=installArmState, linkModeOptimizationMismatch=linkModeOptimizationMismatch, dfsMeans=dfsMeans, dataPortAutoMdix=dataPortAutoMdix, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, vLANPriorityTable=vLANPriorityTable, receiveDataRate=receiveDataRate, phyStatus=phyStatus, hTTPSAccessEnabled=hTTPSAccessEnabled, supplementaryGroup=supplementaryGroup, installArmStateTrap=installArmStateTrap, receiveChannel=receiveChannel, receiveFreqMHz=receiveFreqMHz, syslogState=syslogState, sMTPEnabledMessages=sMTPEnabledMessages, supplementary=supplementary, tDDSynchronizationStatus=tDDSynchronizationStatus, management=management, linkModeOptimisation=linkModeOptimisation, sNMPTrapIPAddress=sNMPTrapIPAddress, versionsGroup=versionsGroup, sNMPEnabledTraps=sNMPEnabledTraps, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, licenceGroup=licenceGroup, notificationsGroup=notificationsGroup, bootVersion=bootVersion, dfs=dfs, ptpCompliance=ptpCompliance, userTableNumber=userTableNumber, vLANManagementPriority=vLANManagementPriority, dataPortConfigurationMismatch=dataPortConfigurationMismatch, latitude=latitude, encryption=encryption, ptpTrapPrefix=ptpTrapPrefix, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, sMTPServerPortNumber=sMTPServerPortNumber, dfsTableNumber=dfsTableNumber, sNMPCommunityString=sNMPCommunityString, sMTPSourceEmailAddress=sMTPSourceEmailAddress, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, telecomGroup=telecomGroup, userName=userName, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, productVariant=productVariant, receiveModulationMode=receiveModulationMode, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, sNTPServerIPAddress=sNTPServerIPAddress, unitOutOfCalibration=unitOutOfCalibration, snmpControlGroup=snmpControlGroup, userTableEntry=userTableEntry, iPAddress=iPAddress, channelChangeTrap=channelChangeTrap, sNMPTrapTable=sNMPTrapTable, antennaGain=antennaGain, telecomsInterface=telecomsInterface, systemClock=systemClock, linkName=linkName, configuration=configuration)
