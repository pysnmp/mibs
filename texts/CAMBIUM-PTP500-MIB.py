...
Counter64, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Counter32, MibIdentifier, iso, enterprises, ModuleIdentity, TimeTicks, NotificationType, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Counter32", "MibIdentifier", "iso", "enterprises", "ModuleIdentity", "TimeTicks", "NotificationType", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", receiveChannel=receiveChannel, hardwareVersion=hardwareVersion, aggregateDataRate=aggregateDataRate, byteErrorRatio=byteErrorRatio, sNMPTrapTableIndex=sNMPTrapTableIndex, altitude=altitude, searchState=searchState, sntp=sntp, linkModeOptimisation=linkModeOptimisation, secondarySoftwareVersion=secondarySoftwareVersion, syslogStateTrap=syslogStateTrap, phyStatusGroup=phyStatusGroup, supplementaryGroup=supplementaryGroup, dataPortAutoMdix=dataPortAutoMdix, sNMPv3Enable=sNMPv3Enable, latitude=latitude, snmpControlGroup=snmpControlGroup, dfsTableIndex=dfsTableIndex, ptmp=ptmp, maximumTransmitPower=maximumTransmitPower, tDDControlGroup=tDDControlGroup, siteName=siteName, groupID=groupID, sMTPServerIPAddress=sMTPServerIPAddress, hTTPSPortNumber=hTTPSPortNumber, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, daylightSaving=daylightSaving, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, licence=licence, transmitPower=transmitPower, gatewayIPAddress=gatewayIPAddress, userTableEntry=userTableEntry, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, dfsTableEntry=dfsTableEntry, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, versions=versions, dfsPeaks=dfsPeaks, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, accessMethod=accessMethod, telecomsInterface=telecomsInterface, dataPortStatusTrap=dataPortStatusTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, linkSymmetry=linkSymmetry, phyControl=phyControl, remoteIPAddress=remoteIPAddress, licenceGroup=licenceGroup, productName=productName, dfsGroup=dfsGroup, aAAControlGroup=aAAControlGroup, dataPortAutoNegotiation=dataPortAutoNegotiation, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, transmitDataRate=transmitDataRate, dataPortStatus=dataPortStatus, encryptionAlgorithm=encryptionAlgorithm, remoteMaximumTransmitPower=remoteMaximumTransmitPower, vLANManagementPriority=vLANManagementPriority, timeZone=timeZone, encryption=encryption, sNTPServerPortNumber=sNTPServerPortNumber, installArmStateTrap=installArmStateTrap, dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, PYSNMP_MODULE_ID=cambium, sNTPServerIPAddress=sNTPServerIPAddress, range=range, vLANPriorityQueueMapping=vLANPriorityQueueMapping, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, userTableIndex=userTableIndex, transmitFreqMHz=transmitFreqMHz, sNTPPollInterval=sNTPPollInterval, productVariant=productVariant, userTable=userTable, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hTTPSAccessEnabled=hTTPSAccessEnabled, syslogLocalWrappedTrap=syslogLocalWrappedTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, vLANPriorityTableNumber=vLANPriorityTableNumber, systemClock=systemClock, sMTPEnabledMessages=sMTPEnabledMessages, telecom=telecom, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, vLANPriorityTable=vLANPriorityTable, useVLANForManagementInterfaces=useVLANForManagementInterfaces, capacityLicenseMismatch=capacityLicenseMismatch, smtpGroup=smtpGroup, noWirelessChannelAvailable=noWirelessChannelAvailable, constantPowerSpectralDensity=constantPowerSpectralDensity, hTTPPortNumber=hTTPPortNumber, incompatibleRegionCodes=incompatibleRegionCodes, tDDSynchronizationStatus=tDDSynchronizationStatus, dfs=dfs, tDDSynchronizationAlarm=tDDSynchronizationAlarm, bootVersion=bootVersion, userPassword=userPassword, management=management, alarmsGroup=alarmsGroup, receiveDataRate=receiveDataRate, iPAddress=iPAddress, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, syslogControlGroup=syslogControlGroup, dfsTableNumber=dfsTableNumber, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, sMTPServerPortNumber=sMTPServerPortNumber, vLANPriorityTableIndex=vLANPriorityTableIndex, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, receiveModulationModeDetail=receiveModulationModeDetail, licensedCapacity=licensedCapacity, telecomsChannelStatus=telecomsChannelStatus, userName=userName, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, telecomsCableLength=telecomsCableLength, sntpGroup=sntpGroup, sNMPCommunityString=sNMPCommunityString, telecomsLineCode=telecomsLineCode, dataPortDisabledWarning=dataPortDisabledWarning, telecomsLoopback=telecomsLoopback, sMTPEmailAlert=sMTPEmailAlert, sNMPPortNumber=sNMPPortNumber, sNTPLastSync=sNTPLastSync, dfsTable=dfsTable, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, encryptionGroup=encryptionGroup, tDDControl=tDDControl, regionCode=regionCode, tDDSynchronizationMode=tDDSynchronizationMode, bandwidthVariant=bandwidthVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, ptp500=ptp500, channelBandwidth=channelBandwidth, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, dfsMeans=dfsMeans, ethernet=ethernet, configuration=configuration, alarms=alarms, receivePower=receivePower, phyStatus=phyStatus, phyControlGroup=phyControlGroup, cableLoss=cableLoss, receiveFreqKHz=receiveFreqKHz, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, sNTPSyncTrap=sNTPSyncTrap, dataPortWirelessDownAlert=dataPortWirelessDownAlert, linkName=linkName, userTableNumber=userTableNumber, pubStats=pubStats, telnetPortNumber=telnetPortNumber, vectorError=vectorError, linkLoss=linkLoss, syslogControl=syslogControl, resetGroup=resetGroup, targetMACAddress=targetMACAddress, installArmState=installArmState, softwareVersion=softwareVersion, ptp=ptp, cambium=cambium, ethernetGroup=ethernetGroup, receiveFreqMHz=receiveFreqMHz, transmitChannel=transmitChannel, sNTPState=sNTPState, systemReset=systemReset, dataPortConfigurationMismatch=dataPortConfigurationMismatch, unitOutOfCalibration=unitOutOfCalibration, sNMPTrapTableEntry=sNMPTrapTableEntry, tFTPServerPortNumber=tFTPServerPortNumber, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, pubStatsGroup=pubStatsGroup, userEnabled=userEnabled, transmitFreqKHz=transmitFreqKHz, hTTPAccessEnabled=hTTPAccessEnabled, channelChangeTrap=channelChangeTrap, frequencyVariant=frequencyVariant, userRole=userRole, wirelessLinkStatus=wirelessLinkStatus, masterSlaveMode=masterSlaveMode, ptpGroups=ptpGroups, sNMPTrapIPAddress=sNMPTrapIPAddress, signalStrengthRatio=signalStrengthRatio, versionsGroup=versionsGroup, linkModeOptimizationMismatch=linkModeOptimizationMismatch, syslogClient=syslogClient, reset=reset, installStatus=installStatus, eIRP=eIRP, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, telecomGroup=telecomGroup, syslogClientTrap=syslogClientTrap, supplementary=supplementary, vLANManagementVID=vLANManagementVID, smtp=smtp, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, sNMPTrapVersion=sNMPTrapVersion, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTable=sNMPTrapTable, antennaGain=antennaGain, subnetMask=subnetMask, longitude=longitude, syslogState=syslogState, sNTPSync=sNTPSync, transmitModulationMode=transmitModulationMode, notificationsGroup=notificationsGroup, receiveModulationMode=receiveModulationMode, regionCodeTrap=regionCodeTrap, telnetAccessEnabled=telnetAccessEnabled, configurationGroup=configurationGroup, ethernetFiberSupport=ethernetFiberSupport, telecomsLoopbackTrap=telecomsLoopbackTrap, tFTPServerIPAddress=tFTPServerIPAddress, managementGroup=managementGroup, sMTPSourceEmailAddress=sMTPSourceEmailAddress, sNMPEnabledTraps=sNMPEnabledTraps, ptpTraps=ptpTraps, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, ptpTrapPrefix=ptpTrapPrefix, aAAControl=aAAControl, vLANPriorityTableEntry=vLANPriorityTableEntry, ptpCompliance=ptpCompliance, snmpControl=snmpControl, installStatusTrap=installStatusTrap)
