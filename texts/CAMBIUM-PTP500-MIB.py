...
mibBuilder.exportSymbols("CAMBIUM-PTP500-MIB", dataPortSpeedAndDuplex=dataPortSpeedAndDuplex, softwareVersion=softwareVersion, pubStats=pubStats, unitOutOfCalibration=unitOutOfCalibration, aggregateDataRate=aggregateDataRate, telnetAccessEnabled=telnetAccessEnabled, transmitDataRate=transmitDataRate, aAAControlGroup=aAAControlGroup, linkModeOptimizationMismatchTrap=linkModeOptimizationMismatchTrap, latitude=latitude, userTableEntry=userTableEntry, dfsGroup=dfsGroup, tFTPStartSoftwareUpgrade=tFTPStartSoftwareUpgrade, userEnabled=userEnabled, sMTPEmailAlert=sMTPEmailAlert, ptpTraps=ptpTraps, vLANPriorityTableEntry=vLANPriorityTableEntry, channelChangeTrap=channelChangeTrap, incompatibleMasterAndSlave=incompatibleMasterAndSlave, hTTPAccessEnabled=hTTPAccessEnabled, subnetMask=subnetMask, telecomsLineCode=telecomsLineCode, telecom=telecom, tDDSynchronizationStatus=tDDSynchronizationStatus, incompatibleMasterAndSlaveTrap=incompatibleMasterAndSlaveTrap, telecomGroup=telecomGroup, byteErrorRatio=byteErrorRatio, tFTPSoftwareUpgradeStatusAdditionalText=tFTPSoftwareUpgradeStatusAdditionalText, reset=reset, phyStatusGroup=phyStatusGroup, telecomsLoopback=telecomsLoopback, productVariant=productVariant, sNTPSync=sNTPSync, dataPortAutoNegotiation=dataPortAutoNegotiation, aAAControl=aAAControl, longitude=longitude, sNTPLastSync=sNTPLastSync, iPAddress=iPAddress, groupID=groupID, ptpGroups=ptpGroups, configurationGroup=configurationGroup, installArmState=installArmState, sMTPEnabledMessages=sMTPEnabledMessages, sMTPServerPortNumber=sMTPServerPortNumber, sNTPPollInterval=sNTPPollInterval, sNMPv3Enable=sNMPv3Enable, systemReset=systemReset, supplementary=supplementary, dataPortDisabledWarningTrap=dataPortDisabledWarningTrap, linkModeOptimizationMismatch=linkModeOptimizationMismatch, telnetPortNumber=telnetPortNumber, sntp=sntp, systemClock=systemClock, tDDControl=tDDControl, phyControlGroup=phyControlGroup, sNMPTrapTableEntry=sNMPTrapTableEntry, ptp=ptp, timeZone=timeZone, bootVersion=bootVersion, hTTPSAccessEnabled=hTTPSAccessEnabled, installArmStateTrap=installArmStateTrap, tDDSynchronizationAlarm=tDDSynchronizationAlarm, ethernetGroup=ethernetGroup, userTable=userTable, dataPortWirelessDownAlert=dataPortWirelessDownAlert, tDDSynchronizationMode=tDDSynchronizationMode, regionCode=regionCode, sNMPPortNumber=sNMPPortNumber, sMTPServerIPAddress=sMTPServerIPAddress, vLANPriorityQueueMapping=vLANPriorityQueueMapping, syslogLocalWrappedTrap=syslogLocalWrappedTrap, vLANManagementVID=vLANManagementVID, hTTPPortNumber=hTTPPortNumber, ptmp=ptmp, linkModeOptimisation=linkModeOptimisation, dataPortAutoNegAdvertisement=dataPortAutoNegAdvertisement, smtp=smtp, versionsGroup=versionsGroup, cableLoss=cableLoss, sMTPSourceEmailAddress=sMTPSourceEmailAddress, remoteMaximumTransmitPower=remoteMaximumTransmitPower, dataPortDisabledWarning=dataPortDisabledWarning, linkName=linkName, tFTPSoftwareUpgradeFileName=tFTPSoftwareUpgradeFileName, unitOutOfCalibrationTrap=unitOutOfCalibrationTrap, installStatus=installStatus, antennaGain=antennaGain, useVLANForManagementInterfaces=useVLANForManagementInterfaces, noWirelessChannelAvailable=noWirelessChannelAvailable, ethernetFiberSupport=ethernetFiberSupport, dfsTableNumber=dfsTableNumber, tFTPSoftwareUpgradeStatusText=tFTPSoftwareUpgradeStatusText, wirelessLinkStatus=wirelessLinkStatus, searchState=searchState, sNTPSyncTrap=sNTPSyncTrap, tFTPSoftwareUpgradeStatus=tFTPSoftwareUpgradeStatus, receiveModulationMode=receiveModulationMode, alarms=alarms, sNTPServerIPAddress=sNTPServerIPAddress, dataPortConfigurationMismatch=dataPortConfigurationMismatch, dfsTableIndex=dfsTableIndex, supplementaryGroup=supplementaryGroup, transmitFreqKHz=transmitFreqKHz, dfsNineNinePointNinePercentiles=dfsNineNinePointNinePercentiles, syslogLocalNearlyFullTrap=syslogLocalNearlyFullTrap, dataPortConfigurationMismatchTrap=dataPortConfigurationMismatchTrap, daylightSaving=daylightSaving, snmpControl=snmpControl, noWirelessChannelAvailableTrap=noWirelessChannelAvailableTrap, vLANPriorityTable=vLANPriorityTable, snmpControlGroup=snmpControlGroup, sNTPState=sNTPState, altitude=altitude, userConfiguredMaxModulationMode=userConfiguredMaxModulationMode, phyControl=phyControl, encryption=encryption, sNMPTrapIPAddress=sNMPTrapIPAddress, hTTPSPortNumber=hTTPSPortNumber, sNMPTrapTable=sNMPTrapTable, syslogState=syslogState, management=management, channelBandwidth=channelBandwidth, cambium=cambium, masterSlaveMode=masterSlaveMode, dfsTable=dfsTable, alarmsGroup=alarmsGroup, dfs=dfs, dfsMeans=dfsMeans, notificationsGroup=notificationsGroup, vLANManagementPriority=vLANManagementPriority, sNTPServerPortNumber=sNTPServerPortNumber, userTableNumber=userTableNumber, sNMPSendAllTrapsAtStartup=sNMPSendAllTrapsAtStartup, telecomsInterface=telecomsInterface, tFTPServerIPAddress=tFTPServerIPAddress, capacityLicenseMismatchTrap=capacityLicenseMismatchTrap, ptpCompliance=ptpCompliance, incompatibleRegionCodes=incompatibleRegionCodes, pubStatsGroup=pubStatsGroup, linkLoss=linkLoss, regionCodeTrap=regionCodeTrap, sNMPTrapPortNumber=sNMPTrapPortNumber, receiveChannel=receiveChannel, sNMPCommunityString=sNMPCommunityString, telecomsLoopbackTrap=telecomsLoopbackTrap, versions=versions, siteName=siteName, sNMPEnabledTraps=sNMPEnabledTraps, incompatibleRegionCodesTrap=incompatibleRegionCodesTrap, telecomsChannelStatus=telecomsChannelStatus, resetGroup=resetGroup, vLANPriorityTableNumber=vLANPriorityTableNumber, transmitChannel=transmitChannel, receiveModulationModeDetail=receiveModulationModeDetail, linkSymmetry=linkSymmetry, syslogControl=syslogControl, userPassword=userPassword, sMTPDestinationEmailAddress=sMTPDestinationEmailAddress, wirelessLinkAvailability=wirelessLinkAvailability, secondarySoftwareVersion=secondarySoftwareVersion, ethernet=ethernet, frequencyVariant=frequencyVariant, eIRP=eIRP, productName=productName, tFTPServerPortNumber=tFTPServerPortNumber, sNMPTrapVersion=sNMPTrapVersion, userRole=userRole, wirelessLinkDisabledWarning=wirelessLinkDisabledWarning, range=range, phyStatus=phyStatus, installStatusTrap=installStatusTrap, licence=licence, receivePower=receivePower, receiveFreqMHz=receiveFreqMHz, transmitPower=transmitPower, dfsPeaks=dfsPeaks, dataPortStatusTrap=dataPortStatusTrap, smtpGroup=smtpGroup, transmitModulationMode=transmitModulationMode, bandwidthVariant=bandwidthVariant, enabledDiagnosticAlarms=enabledDiagnosticAlarms, licensedCapacity=licensedCapacity, accessMethod=accessMethod, licenceGroup=licenceGroup, signalStrengthRatio=signalStrengthRatio, ptpTrapPrefix=ptpTrapPrefix, syslogClientTrap=syslogClientTrap, telecomsChannelStatusTrap=telecomsChannelStatusTrap, tDDSynchronizationAlarmTrap=tDDSynchronizationAlarmTrap, transmitFreqMHz=transmitFreqMHz, vectorError=vectorError, syslogClient=syslogClient, targetMACAddress=targetMACAddress, encryptionAlgorithm=encryptionAlgorithm, receiveFreqKHz=receiveFreqKHz, sntpGroup=sntpGroup, sNMPTrapTableNumber=sNMPTrapTableNumber, sNMPTrapTableIndex=sNMPTrapTableIndex, wirelessLinkDisabledWarningTrap=wirelessLinkDisabledWarningTrap, gatewayIPAddress=gatewayIPAddress, capacityLicenseMismatch=capacityLicenseMismatch, PYSNMP_MODULE_ID=cambium, hardwareVersion=hardwareVersion, receiveDataRate=receiveDataRate, ptp500=ptp500, userTableIndex=userTableIndex, userName=userName, telecomsCableLength=telecomsCableLength, dfsTableEntry=dfsTableEntry, syslogControlGroup=syslogControlGroup, dataPortStatus=dataPortStatus, dataPortAutoMdix=dataPortAutoMdix, remoteIPAddress=remoteIPAddress, vLANPriorityTableIndex=vLANPriorityTableIndex, encryptionGroup=encryptionGroup, constantPowerSpectralDensity=constantPowerSpectralDensity, tDDControlGroup=tDDControlGroup, configuration=configuration, dfsImpulsiveInterferenceTrap=dfsImpulsiveInterferenceTrap, maximumTransmitPower=maximumTransmitPower, syslogStateTrap=syslogStateTrap, managementGroup=managementGroup)
