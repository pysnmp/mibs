...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfEvents=ospfIfEvents, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfRestartExitReason=ospfRestartExitReason, ospfExtLsdbType=ospfExtLsdbType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, Status=Status, ospfRestartInterval=ospfRestartInterval, ospfTOSSupport=ospfTOSSupport, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVersionNumber=ospfVersionNumber, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbLsid=ospfLsdbLsid, ospfStubStatus=ospfStubStatus, BigMetric=BigMetric, ospfLsdbType=ospfLsdbType, ospfVirtIfGroup2=ospfVirtIfGroup2, Metric=Metric, ospfRestartAge=ospfRestartAge, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, PYSNMP_MODULE_ID=ospf, ospfIfMetricTable=ospfIfMetricTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRxNewLsas=ospfRxNewLsas, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfStubAreaId=ospfStubAreaId, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, TOSType=TOSType, ospfNbrPriority=ospfNbrPriority, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfNbrRtrId=ospfNbrRtrId, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfInterArea=ospfInterArea, ospfRestartSupport=ospfRestartSupport, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfHostTable=ospfHostTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfMetricEntry=ospfIfMetricEntry, ospfExternalType1=ospfExternalType1, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaLsaCount=ospfAreaLsaCount, DesignatedRouterPriority=DesignatedRouterPriority, ospfRestartStatus=ospfRestartStatus, ospfLsdbAge=ospfLsdbAge, ospfIfType=ospfIfType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrEvents=ospfNbrEvents, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaSummary=ospfAreaSummary, ospfHostTOS=ospfHostTOS, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfAdminStat=ospfIfAdminStat, ospfBasicGroup=ospfBasicGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfStubAreaGroup=ospfStubAreaGroup, ospfLsdbSequence=ospfLsdbSequence, ospfHostMetric=ospfHostMetric, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospf=ospf, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfEntry=ospfIfEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, RouterID=RouterID, ospfNbrTable=ospfNbrTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfHostGroup2=ospfHostGroup2, ospfNbrState=ospfNbrState, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfNbrGroup2=ospfNbrGroup2, ospfLocalLsdbType=ospfLocalLsdbType, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfHostGroup=ospfHostGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfMetricStatus=ospfIfMetricStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbGroup=ospfLsdbGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfMetricTOS=ospfIfMetricTOS, ospfBasicGroup2=ospfBasicGroup2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaAggregateMask=ospfAreaAggregateMask, UpToMaxAge=UpToMaxAge, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfGroups=ospfGroups, ospfCompliances=ospfCompliances, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfGroup=ospfIfGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfAdminStat=ospfAdminStat, ospfDemandExtensions=ospfDemandExtensions, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaStatus=ospfAreaStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsaCount=ospfAsLsaCount, ospfIfAuthType=ospfIfAuthType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfAuthKey=ospfIfAuthKey, ospfAreaGroup=ospfAreaGroup, ospfIfGroup2=ospfIfGroup2, ospfAuthType=ospfAuthType, ospfIntraArea=ospfIntraArea, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfCompliance=ospfCompliance, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfState=ospfIfState, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfRouterId=ospfRouterId, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfStubMetric=ospfStubMetric, ospfIfRtrPriority=ospfIfRtrPriority, ospfHostAreaID=ospfHostAreaID, ospfIfStatus=ospfIfStatus, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsLsdbType=ospfAsLsdbType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfCompliance2=ospfCompliance2, ospfAsLsdbLsid=ospfAsLsdbLsid, AreaID=AreaID, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostEntry=ospfHostEntry, ospfIfRetransInterval=ospfIfRetransInterval, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfStubTOS=ospfStubTOS, ospfVirtIfState=ospfVirtIfState, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfImportAsExtern=ospfImportAsExtern, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfIfPollInterval=ospfIfPollInterval, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfDemand=ospfIfDemand, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLsdbEntry=ospfLsdbEntry, ospfNbrEntry=ospfNbrEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfTable=ospfIfTable, ospfStubAreaTable=ospfStubAreaTable, ospfStubMetricType=ospfStubMetricType, ospfHostIpAddress=ospfHostIpAddress, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsdbTable=ospfAsLsdbTable, HelloRange=HelloRange, ospfRouteGroup=ospfRouteGroup, ospfIfLsaCount=ospfIfLsaCount, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaId=ospfAreaId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfAreaId=ospfIfAreaId, ospfExternLsaCount=ospfExternLsaCount, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsLsdbGroup=ospfAsLsdbGroup, PositiveInteger=PositiveInteger, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaRangeTable=ospfAreaRangeTable, ospfAddressLessIf=ospfAddressLessIf, ospfAreaTable=ospfAreaTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrOptions=ospfNbrOptions, ospfExternalType2=ospfExternalType2, ospfConformance=ospfConformance, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents)
mibBuilder.exportSymbols("OSPF-MIB", ospfHostStatus=ospfHostStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfIpAddress=ospfIfIpAddress)
