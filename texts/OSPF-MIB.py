...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfEvents=ospfIfEvents, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfConformance=ospfConformance, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbrEvents=ospfNbrEvents, ospfLsdbSequence=ospfLsdbSequence, ospfRestartAge=ospfRestartAge, ospfAddressLessIf=ospfAddressLessIf, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaGroup2=ospfAreaGroup2, ospfRxNewLsas=ospfRxNewLsas, ospfIfGroup2=ospfIfGroup2, ospfHostGroup=ospfHostGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfImportAsExtern=ospfImportAsExtern, ospfHostAreaID=ospfHostAreaID, ospfNbrGroup=ospfNbrGroup, ospfAreaStatus=ospfAreaStatus, ospfLsdbAge=ospfLsdbAge, ospfNbrRtrId=ospfNbrRtrId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, HelloRange=HelloRange, ospfIfIpAddress=ospfIfIpAddress, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfEntry=ospfIfEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfDemandExtensions=ospfDemandExtensions, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubMetricType=ospfStubMetricType, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLsdbRouterId=ospfLsdbRouterId, ospfVersionNumber=ospfVersionNumber, ospfAsLsdbType=ospfAsLsdbType, ospfIfLsaCount=ospfIfLsaCount, ospfGroups=ospfGroups, ospfRestartSupport=ospfRestartSupport, UpToMaxAge=UpToMaxAge, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExtLsdbSequence=ospfExtLsdbSequence, TOSType=TOSType, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostStatus=ospfHostStatus, BigMetric=BigMetric, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfCompliance2=ospfCompliance2, ospfLsdbGroup=ospfLsdbGroup, ospfLsdbLsid=ospfLsdbLsid, ospfNbrTable=ospfNbrTable, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfHostMetric=ospfHostMetric, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfTransitDelay=ospfIfTransitDelay, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfMetricTOS=ospfIfMetricTOS, ospfLsdbTable=ospfLsdbTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospf=ospf, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAuthType=ospfAuthType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLsdbEntry=ospfLsdbEntry, ospfIfPollInterval=ospfIfPollInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfRouterId=ospfRouterId, ospfHostIpAddress=ospfHostIpAddress, ospfIfAdminStat=ospfIfAdminStat, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLsdbType=ospfLsdbType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsLsaCount=ospfAsLsaCount, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfHostGroup2=ospfHostGroup2, ospfBasicGroup=ospfBasicGroup, ospfInterArea=ospfInterArea, ospfSpfRuns=ospfSpfRuns, ospfRouteGroup=ospfRouteGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfHostTOS=ospfHostTOS, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, PYSNMP_MODULE_ID=ospf, ospfCompliance=ospfCompliance, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfHostTable=ospfHostTable, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfStubMetric=ospfStubMetric, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfState=ospfIfState, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfAuthKey=ospfIfAuthKey, ospfAdminStat=ospfAdminStat, Status=Status, ospfStubTOS=ospfStubTOS, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrPriority=ospfNbrPriority, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricTable=ospfIfMetricTable, ospfIfDemand=ospfIfDemand, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaGroup=ospfAreaGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaId=ospfAreaId, ospfHostEntry=ospfHostEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfAuthType=ospfIfAuthType, ospfCompliances=ospfCompliances, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrOptions=ospfNbrOptions, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbType=ospfLocalLsdbType, Metric=Metric, ospfRestartInterval=ospfRestartInterval, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfType=ospfIfType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, RouterID=RouterID, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExternalType2=ospfExternalType2, ospfExternLsaCount=ospfExternLsaCount, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfTable=ospfIfTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfTOSSupport=ospfTOSSupport, OspfAuthenticationType=OspfAuthenticationType, ospfExternalType1=ospfExternalType1, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbSequence=ospfLocalLsdbSequence, AreaID=AreaID, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrState=ospfNbrState, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaSummary=ospfAreaSummary, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAsLsdbTable=ospfAsLsdbTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfStubAreaGroup=ospfStubAreaGroup, ospfStubAreaId=ospfStubAreaId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfStubStatus=ospfStubStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaTable=ospfAreaTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfBasicGroup2=ospfBasicGroup2, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfStatus=ospfIfStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfExtLsdbType=ospfExtLsdbType, ospfIfRetransInterval=ospfIfRetransInterval, PositiveInteger=PositiveInteger, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfMetricValue=ospfIfMetricValue, ospfIfAreaId=ospfIfAreaId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtIfTable=ospfVirtIfTable, ospfNbrGroup2=ospfNbrGroup2, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrState=ospfVirtNbrState)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrEntry=ospfNbrEntry, ospfIfGroup=ospfIfGroup)
