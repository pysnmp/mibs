...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfStubStatus=ospfStubStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfCompliances=ospfCompliances, ospfInterArea=ospfInterArea, ospfAreaGroup2=ospfAreaGroup2, ospfHostGroup2=ospfHostGroup2, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostTOS=ospfHostTOS, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbType=ospfLsdbType, ospfNbrRtrId=ospfNbrRtrId, ospfRestartSupport=ospfRestartSupport, ospfIfMulticastForwarding=ospfIfMulticastForwarding, UpToMaxAge=UpToMaxAge, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfMetricTOS=ospfIfMetricTOS, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfCompliance2=ospfCompliance2, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaTable=ospfAreaTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostEntry=ospfHostEntry, ospfAsLsaCount=ospfAsLsaCount, Metric=Metric, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfExtLsdbType=ospfExtLsdbType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfExtLsdbTable=ospfExtLsdbTable, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, Status=Status, ospfImportAsExtern=ospfImportAsExtern, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfMetricTable=ospfIfMetricTable, ospfBasicGroup2=ospfBasicGroup2, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfConformance=ospfConformance, ospfSpfRuns=ospfSpfRuns, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbAge=ospfLsdbAge, ospfLsdbEntry=ospfLsdbEntry, ospfStubRouterSupport=ospfStubRouterSupport, ospfDemandExtensions=ospfDemandExtensions, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfGeneralGroup=ospfGeneralGroup, ospfNbrState=ospfNbrState, ospfIfAdminStat=ospfIfAdminStat, ospfIfDemand=ospfIfDemand, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfGroup=ospfIfGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrOptions=ospfNbrOptions, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbGroup=ospfExtLsdbGroup, ospf=ospf, ospfLocalLsdbType=ospfLocalLsdbType, ospfStubTOS=ospfStubTOS, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfEntry=ospfIfEntry, ospfHostIpAddress=ospfHostIpAddress, ospfIfIpAddress=ospfIfIpAddress, ospfIfState=ospfIfState, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAdminStat=ospfAdminStat, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, AreaID=AreaID, ospfVirtIfStatus=ospfVirtIfStatus, ospfCompliance=ospfCompliance, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubMetric=ospfStubMetric, ospfHostTable=ospfHostTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLsdbGroup=ospfLsdbGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaStatus=ospfAreaStatus, ospfNbrTable=ospfNbrTable, ospfRestartExitReason=ospfRestartExitReason, ospfAddressLessIf=ospfAddressLessIf, ospfIfMetricValue=ospfIfMetricValue, ospfAuthType=ospfAuthType, ospfRouterId=ospfRouterId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, BigMetric=BigMetric, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfTransitDelay=ospfIfTransitDelay, ospfHostGroup=ospfHostGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfRestartInterval=ospfRestartInterval, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfTOSSupport=ospfTOSSupport, ospfIfAuthType=ospfIfAuthType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfGroup=ospfVirtIfGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfState=ospfVirtIfState, ospfAsLsdbLsid=ospfAsLsdbLsid, TOSType=TOSType, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaGroup=ospfAreaGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubAreaTable=ospfStubAreaTable, ospfGroups=ospfGroups, RouterID=RouterID, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrEntry=ospfNbrEntry, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfLsaCount=ospfIfLsaCount, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfGroup2=ospfIfGroup2, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaId=ospfAreaId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfStatus=ospfIfStatus, ospfIfAuthKey=ospfIfAuthKey, ospfRestartAge=ospfRestartAge, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfNbrEvents=ospfNbrEvents, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfTable=ospfIfTable, ospfComplianceObsolete=ospfComplianceObsolete, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubMetricType=ospfStubMetricType, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfEvents=ospfIfEvents, ospfLsdbTable=ospfLsdbTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRxNewLsas=ospfRxNewLsas, ospfStubAreaId=ospfStubAreaId, ospfIfRetransInterval=ospfIfRetransInterval, ospfHostAreaID=ospfHostAreaID, ospfIfPollInterval=ospfIfPollInterval, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfAreaId=ospfIfAreaId, ospfNbrGroup2=ospfNbrGroup2, ospfNbrGroup=ospfNbrGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, PYSNMP_MODULE_ID=ospf, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, OspfAuthenticationType=OspfAuthenticationType, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfHostMetric=ospfHostMetric, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaSummary=ospfAreaSummary, ospfVirtNbrState=ospfVirtNbrState, ospfRouteGroup=ospfRouteGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostStatus=ospfHostStatus, HelloRange=HelloRange, ospfExternLsaCount=ospfExternLsaCount, ospfMulticastExtensions=ospfMulticastExtensions, ospfAsBdrRtrCount=ospfAsBdrRtrCount)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfType=ospfIfType, ospfAreaAggregateMask=ospfAreaAggregateMask, PositiveInteger=PositiveInteger)
