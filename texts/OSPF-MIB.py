...
mibBuilder.exportSymbols("OSPF-MIB", ospfBasicGroup=ospfBasicGroup, ospfGroups=ospfGroups, ospfIfState=ospfIfState, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostTable=ospfHostTable, ospfRestartSupport=ospfRestartSupport, ospfHostMetric=ospfHostMetric, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfStubRouterSupport=ospfStubRouterSupport, PYSNMP_MODULE_ID=ospf, ospfNbrPriority=ospfNbrPriority, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaGroup2=ospfAreaGroup2, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbGroup=ospfLsdbGroup, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfGroup=ospfIfGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIntraArea=ospfIntraArea, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfAdminStat=ospfIfAdminStat, ospfRouterId=ospfRouterId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfEntry=ospfIfEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfRxNewLsas=ospfRxNewLsas, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfGeneralGroup=ospfGeneralGroup, ospfHostEntry=ospfHostEntry, Metric=Metric, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfAreaId=ospfIfAreaId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, PositiveInteger=PositiveInteger, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbTable=ospfExtLsdbTable, Status=Status, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfInterArea=ospfInterArea, ospfDemandExtensions=ospfDemandExtensions, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfMetricTable=ospfIfMetricTable, ospfStubMetricType=ospfStubMetricType, ospfIfTable=ospfIfTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfGroup2=ospfIfGroup2, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfEntry=ospfVirtIfEntry, ospfExtLsdbType=ospfExtLsdbType, ospfAddressLessIf=ospfAddressLessIf, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfHostStatus=ospfHostStatus, OspfAuthenticationType=OspfAuthenticationType, ospfExternalType2=ospfExternalType2, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaSummary=ospfAreaSummary, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrRtrId=ospfNbrRtrId, ospfStubAreaGroup=ospfStubAreaGroup, ospfBasicGroup2=ospfBasicGroup2, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubTOS=ospfStubTOS, ospfLsdbAreaId=ospfLsdbAreaId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbAge=ospfLsdbAge, ospfNbrOptions=ospfNbrOptions, ospfVersionNumber=ospfVersionNumber, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfDemand=ospfIfDemand, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfRestartExitReason=ospfRestartExitReason, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaTable=ospfAreaTable, ospfVirtIfStatus=ospfVirtIfStatus, ospfCompliance2=ospfCompliance2, ospfIfAuthType=ospfIfAuthType, ospfAuthType=ospfAuthType, ospfVirtNbrState=ospfVirtNbrState, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfTOSSupport=ospfTOSSupport, ospfLsdbLsid=ospfLsdbLsid, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaId=ospfAreaId, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfStubAreaId=ospfStubAreaId, ospfHostGroup=ospfHostGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaRangeEffect=ospfAreaRangeEffect, ospf=ospf, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLsdbTable=ospfLsdbTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, AreaID=AreaID, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbrTable=ospfNbrTable, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfHostTOS=ospfHostTOS, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrArea=ospfVirtNbrArea, ospfExternalType1=ospfExternalType1, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfHostIpAddress=ospfHostIpAddress, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfMetricValue=ospfIfMetricValue, ospfStubMetric=ospfStubMetric, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaGroup=ospfAreaGroup, ospfVirtIfState=ospfVirtIfState, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLsdbType=ospfLsdbType, ospfLsdbRouterId=ospfLsdbRouterId, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfStatus=ospfIfStatus, TOSType=TOSType, ospfIfType=ospfIfType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfCompliances=ospfCompliances, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaEntry=ospfAreaEntry, BigMetric=BigMetric, ospfStubAreaTable=ospfStubAreaTable, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrGroup2=ospfNbrGroup2, ospfRestartInterval=ospfRestartInterval, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbrIpAddr=ospfNbrIpAddr, ospfAdminStat=ospfAdminStat, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfIpAddress=ospfIfIpAddress, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfTransitDelay=ospfIfTransitDelay, UpToMaxAge=UpToMaxAge, ospfComplianceObsolete=ospfComplianceObsolete, ospfHostGroup2=ospfHostGroup2, RouterID=RouterID, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfPollInterval=ospfIfPollInterval, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfMetricStatus=ospfIfMetricStatus, HelloRange=HelloRange, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfConformance=ospfConformance, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfRestartAge=ospfRestartAge, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrState=ospfNbrState, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfCompliance=ospfCompliance, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfImportAsExtern=ospfImportAsExtern, ospfSpfRuns=ospfSpfRuns, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaStatus=ospfAreaStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfAuthKey=ospfIfAuthKey)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrEvents=ospfVirtNbrEvents)
