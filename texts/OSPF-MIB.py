...
mibBuilder.exportSymbols("OSPF-MIB", ospfHostIpAddress=ospfHostIpAddress, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbAge=ospfLsdbAge, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfCompliances=ospfCompliances, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfStatus=ospfVirtIfStatus, ospfRestartAge=ospfRestartAge, ospfStubMetricType=ospfStubMetricType, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfSpfRuns=ospfSpfRuns, ospfIfTransitDelay=ospfIfTransitDelay, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfBasicGroup2=ospfBasicGroup2, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrGroup=ospfNbrGroup, ospfRestartStatus=ospfRestartStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLocalLsdbType=ospfLocalLsdbType, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfTable=ospfIfTable, ospfStubStatus=ospfStubStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfInterArea=ospfInterArea, ospfRxNewLsas=ospfRxNewLsas, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfGroup2=ospfIfGroup2, TOSType=TOSType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIntraArea=ospfIntraArea, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaLsaCountTable=ospfAreaLsaCountTable, AreaID=AreaID, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaSummary=ospfAreaSummary, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfCompliance2=ospfCompliance2, ospfIfMetricStatus=ospfIfMetricStatus, ospfStubMetric=ospfStubMetric, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, RouterID=RouterID, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfCompliance=ospfCompliance, ospfIfEvents=ospfIfEvents, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, PYSNMP_MODULE_ID=ospf, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfRestartInterval=ospfRestartInterval, ospfHostGroup=ospfHostGroup, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, Metric=Metric, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfImportAsExtern=ospfImportAsExtern, PositiveInteger=PositiveInteger, ospfVersionNumber=ospfVersionNumber, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfStubAreaGroup=ospfStubAreaGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfHostTable=ospfHostTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbType=ospfLsdbType, ospfIfEntry=ospfIfEntry, ospfIfDemand=ospfIfDemand, ospfConformance=ospfConformance, ospfNbrGroup2=ospfNbrGroup2, Status=Status, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLsdbSequence=ospfLsdbSequence, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfAuthType=ospfIfAuthType, ospfHostAreaID=ospfHostAreaID, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfStubAreaTable=ospfStubAreaTable, ospfHostEntry=ospfHostEntry, ospfAsLsaCount=ospfAsLsaCount, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAuthType=ospfAuthType, ospfNbrEntry=ospfNbrEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaGroup=ospfAreaGroup, ospfDemandExtensions=ospfDemandExtensions, ospfHostGroup2=ospfHostGroup2, ospfTOSSupport=ospfTOSSupport, ospfAreaRangeMask=ospfAreaRangeMask, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfRouteGroup=ospfRouteGroup, ospfNbrEvents=ospfNbrEvents, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfNbrState=ospfNbrState, ospfObsoleteGroup=ospfObsoleteGroup, UpToMaxAge=UpToMaxAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbType=ospfExtLsdbType, ospfNbrPriority=ospfNbrPriority, ospfIfMetricTable=ospfIfMetricTable, ospfHostMetric=ospfHostMetric, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfHostTOS=ospfHostTOS, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostStatus=ospfHostStatus, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfLsaCount=ospfIfLsaCount, BigMetric=BigMetric, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfExternalType2=ospfExternalType2, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfStubTOS=ospfStubTOS, ospfLsdbLsid=ospfLsdbLsid, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfAdminStat=ospfIfAdminStat, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfRouterId=ospfRouterId, ospfStubRouterSupport=ospfStubRouterSupport, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfType=ospfIfType, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaGroup2=ospfAreaGroup2, ospfAreaStatus=ospfAreaStatus, ospfAreaRangeGroup=ospfAreaRangeGroup, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfAreaId=ospfIfAreaId, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbGroup=ospfLsdbGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAdminStat=ospfAdminStat, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfStatus=ospfIfStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrTable=ospfNbrTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfStubAreaId=ospfStubAreaId, ospfIfState=ospfIfState, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaId=ospfAreaId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfRestartSupport=ospfRestartSupport, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtIfState=ospfVirtIfState, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrOptions=ospfNbrOptions, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospf=ospf, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfAuthKey=ospfIfAuthKey, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfGroups=ospfGroups, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbSequence=ospfLocalLsdbSequence, HelloRange=HelloRange, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfMetricIpAddress=ospfIfMetricIpAddress)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaTable=ospfAreaTable, ospfLsdbTable=ospfLsdbTable, ospfExitOverflowInterval=ospfExitOverflowInterval)
