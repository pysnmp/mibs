...
mibBuilder.exportSymbols("OSPF-MIB", ospfStubAreaEntry=ospfStubAreaEntry, ospfIfGroup2=ospfIfGroup2, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfHostTOS=ospfHostTOS, ospfHostMetric=ospfHostMetric, ospfIfMetricValue=ospfIfMetricValue, ospfExtLsdbTable=ospfExtLsdbTable, ospfStubTOS=ospfStubTOS, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, BigMetric=BigMetric, ospfDemandExtensions=ospfDemandExtensions, ospfHostGroup2=ospfHostGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVersionNumber=ospfVersionNumber, ospfRouteGroup=ospfRouteGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfState=ospfVirtIfState, ospfGroups=ospfGroups, ospfAreaGroup=ospfAreaGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfStubMetricType=ospfStubMetricType, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbAge=ospfAsLsdbAge, ospfBasicGroup=ospfBasicGroup, ospfStubMetric=ospfStubMetric, ospfHostIpAddress=ospfHostIpAddress, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfGroup=ospfIfGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, Status=Status, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfMetricTable=ospfIfMetricTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, RouterID=RouterID, ospfHostTable=ospfHostTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfState=ospfIfState, ospfTOSSupport=ospfTOSSupport, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbType=ospfLsdbType, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfTable=ospfIfTable, ospfGeneralGroup=ospfGeneralGroup, ospfRestartSupport=ospfRestartSupport, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsLsdbType=ospfAsLsdbType, ospfIfEvents=ospfIfEvents, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrPriority=ospfNbrPriority, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospf=ospf, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfMulticastExtensions=ospfMulticastExtensions, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAddressLessIf=ospfAddressLessIf, ospfLsdbEntry=ospfLsdbEntry, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfMetricEntry=ospfIfMetricEntry, ospfLsdbSequence=ospfLsdbSequence, ospfLsdbGroup=ospfLsdbGroup, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfRestartExitReason=ospfRestartExitReason, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfRetransInterval=ospfIfRetransInterval, TOSType=TOSType, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrEvents=ospfNbrEvents, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrTable=ospfNbrTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfDemand=ospfIfDemand, ospfNbrOptions=ospfNbrOptions, ospfRestartAge=ospfRestartAge, PositiveInteger=PositiveInteger, HelloRange=HelloRange, ospfIfLsaCount=ospfIfLsaCount, ospfIfAreaId=ospfIfAreaId, Metric=Metric, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfInterArea=ospfInterArea, ospfExtLsdbType=ospfExtLsdbType, ospfRestartInterval=ospfRestartInterval, ospfConformance=ospfConformance, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostGroup=ospfHostGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfStubStatus=ospfStubStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrGroup=ospfNbrGroup, ospfAuthType=ospfAuthType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIntraArea=ospfIntraArea, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAdminStat=ospfAdminStat, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfType=ospfIfType, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaId=ospfAreaId, ospfRxNewLsas=ospfRxNewLsas, ospfImportAsExtern=ospfImportAsExtern, AreaID=AreaID, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfCompliance2=ospfCompliance2, ospfExternLsaCount=ospfExternLsaCount, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaSummary=ospfAreaSummary, ospfNbrIpAddr=ospfNbrIpAddr, ospfAsLsdbGroup=ospfAsLsdbGroup, UpToMaxAge=UpToMaxAge, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfCompliances=ospfCompliances, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaEntry=ospfAreaEntry, ospfHostEntry=ospfHostEntry, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfAuthKey=ospfIfAuthKey, ospfRouterId=ospfRouterId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrEntry=ospfNbrEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLsdbTable=ospfLsdbTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfStatus=ospfIfStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, OspfAuthenticationType=OspfAuthenticationType, ospfAreaStatus=ospfAreaStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfCompliance=ospfCompliance, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfAdminStat=ospfIfAdminStat, ospfExternalType2=ospfExternalType2, ospfExternalType1=ospfExternalType1, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfReferenceBandwidth=ospfReferenceBandwidth, PYSNMP_MODULE_ID=ospf, ospfRestartStatus=ospfRestartStatus, ospfHostStatus=ospfHostStatus, ospfIfIpAddress=ospfIfIpAddress, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfSpfRuns=ospfSpfRuns, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfBasicGroup2=ospfBasicGroup2, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfEntry=ospfIfEntry, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfHostAreaID=ospfHostAreaID, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaGroup2=ospfAreaGroup2, ospfNbrState=ospfNbrState, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaTable=ospfAreaTable, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfAuthType=ospfIfAuthType, ospfStubAreaId=ospfStubAreaId, ospfAreaRangeMask=ospfAreaRangeMask, ospfExtLsdbLsid=ospfExtLsdbLsid)
