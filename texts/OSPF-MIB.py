...
mibBuilder.exportSymbols("OSPF-MIB", ospfHostTable=ospfHostTable, ospfVirtNbrState=ospfVirtNbrState, ospfIfGroup2=ospfIfGroup2, ospfLsdbLsid=ospfLsdbLsid, ospfGroups=ospfGroups, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, TOSType=TOSType, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaSummary=ospfAreaSummary, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfStubMetricType=ospfStubMetricType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfEntry=ospfIfEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrOptions=ospfNbrOptions, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostTOS=ospfHostTOS, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaTable=ospfAreaTable, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrState=ospfNbrState, ospfRestartExitReason=ospfRestartExitReason, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbAge=ospfExtLsdbAge, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfHostEntry=ospfHostEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, HelloRange=HelloRange, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIntraArea=ospfIntraArea, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfImportAsExtern=ospfImportAsExtern, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostMetric=ospfHostMetric, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, RouterID=RouterID, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfCompliances=ospfCompliances, ospfHostGroup=ospfHostGroup, PositiveInteger=PositiveInteger, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbTable=ospfExtLsdbTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrTable=ospfNbrTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfConformance=ospfConformance, ospfExternLsaCount=ospfExternLsaCount, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLsdbEntry=ospfLsdbEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaLsaCount=ospfAreaLsaCount, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrEvents=ospfNbrEvents, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfAuthType=ospfIfAuthType, ospfHostAreaID=ospfHostAreaID, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfRestartSupport=ospfRestartSupport, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfIpAddress=ospfIfIpAddress, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfEvents=ospfIfEvents, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfTransitDelay=ospfIfTransitDelay, BigMetric=BigMetric, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfStubTOS=ospfStubTOS, ospfIfAreaId=ospfIfAreaId, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfHostIpAddress=ospfHostIpAddress, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVersionNumber=ospfVersionNumber, ospfAsLsaCount=ospfAsLsaCount, ospfAreaEntry=ospfAreaEntry, ospfIfPollInterval=ospfIfPollInterval, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfState=ospfIfState, ospfAsLsdbRouterId=ospfAsLsdbRouterId, DesignatedRouterPriority=DesignatedRouterPriority, ospfRouterId=ospfRouterId, ospfIfMetricEntry=ospfIfMetricEntry, ospfCompliance=ospfCompliance, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLsdbGroup=ospfLsdbGroup, ospfRxNewLsas=ospfRxNewLsas, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfMetricTable=ospfIfMetricTable, ospfStubMetric=ospfStubMetric, ospfTOSSupport=ospfTOSSupport, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfHostStatus=ospfHostStatus, ospfNbrIpAddr=ospfNbrIpAddr, ospfDemandExtensions=ospfDemandExtensions, ospfRestartAge=ospfRestartAge, Status=Status, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfTable=ospfVirtIfTable, ospfNbrEntry=ospfNbrEntry, ospfAreaStatus=ospfAreaStatus, ospfLocalLsdbTable=ospfLocalLsdbTable, UpToMaxAge=UpToMaxAge, ospfIfAdminStat=ospfIfAdminStat, ospfInterArea=ospfInterArea, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubAreaGroup=ospfStubAreaGroup, ospfAsLsdbType=ospfAsLsdbType, ospfLsdbSequence=ospfLsdbSequence, AreaID=AreaID, Metric=Metric, ospf=ospf, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfRestartStatus=ospfRestartStatus, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfMetricGroup=ospfIfMetricGroup, ospfLsdbType=ospfLsdbType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaGroup=ospfAreaGroup, ospfIfTable=ospfIfTable, ospfNbrPriority=ospfNbrPriority, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfCompliance2=ospfCompliance2, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfLsaCount=ospfIfLsaCount, ospfAreaId=ospfAreaId, ospfIfType=ospfIfType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAuthType=ospfAuthType, ospfNbrRtrId=ospfNbrRtrId, ospfStubAreaTable=ospfStubAreaTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfState=ospfVirtIfState, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrTable=ospfVirtNbrTable, ospfExternalType2=ospfExternalType2, ospfIfGroup=ospfIfGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAdminStat=ospfAdminStat, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfBasicGroup2=ospfBasicGroup2, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfRestartInterval=ospfRestartInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubStatus=ospfStubStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfExtLsdbType=ospfExtLsdbType, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLsdbAge=ospfLsdbAge, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrGroup=ospfNbrGroup, ospfLsdbTable=ospfLsdbTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfRFC1583Compatibility=ospfRFC1583Compatibility, OspfAuthenticationType=OspfAuthenticationType, ospfExternalType1=ospfExternalType1, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsdbTable=ospfAsLsdbTable, PYSNMP_MODULE_ID=ospf, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfDemand=ospfIfDemand, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfStatus=ospfIfStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress)
