...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAdminStat=ospfAdminStat, ospfHostGroup2=ospfHostGroup2, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfTOSSupport=ospfTOSSupport, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfHostStatus=ospfHostStatus, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostMetric=ospfHostMetric, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfRestartExitReason=ospfRestartExitReason, ospfNbrGroup2=ospfNbrGroup2, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfPollInterval=ospfIfPollInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaTable=ospfAreaTable, ospfInterArea=ospfInterArea, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfState=ospfIfState, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, Status=Status, ospfIfEntry=ospfIfEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfEvents=ospfIfEvents, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfCompliance=ospfCompliance, ospfLocalLsdbType=ospfLocalLsdbType, PYSNMP_MODULE_ID=ospf, UpToMaxAge=UpToMaxAge, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfTable=ospfIfTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbType=ospfAsLsdbType, ospfSpfRuns=ospfSpfRuns, Metric=Metric, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, OspfAuthenticationType=OspfAuthenticationType, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbAge=ospfLsdbAge, ospfBasicGroup2=ospfBasicGroup2, ospfExternalType2=ospfExternalType2, ospfStubStatus=ospfStubStatus, AreaID=AreaID, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfStubTOS=ospfStubTOS, ospfHostEntry=ospfHostEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfVersionNumber=ospfVersionNumber, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfGroups=ospfGroups, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, BigMetric=BigMetric, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLsdbGroup=ospfLsdbGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbEntry=ospfLsdbEntry, ospfIfType=ospfIfType, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfBasicGroup=ospfBasicGroup, HelloRange=HelloRange, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExternalType1=ospfExternalType1, ospfVirtIfState=ospfVirtIfState, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIntraArea=ospfIntraArea, ospfHostTOS=ospfHostTOS, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfMulticastExtensions=ospfMulticastExtensions, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfStatus=ospfIfStatus, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrPriority=ospfNbrPriority, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAuthType=ospfAuthType, ospfAreaSummary=ospfAreaSummary, ospfImportAsExtern=ospfImportAsExtern, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfRouteGroup=ospfRouteGroup, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrArea=ospfVirtNbrArea, ospfHostTable=ospfHostTable, ospfHostIpAddress=ospfHostIpAddress, ospfHostAreaID=ospfHostAreaID, ospfNbrEvents=ospfNbrEvents, ospfLsdbType=ospfLsdbType, ospfExternLsaCount=ospfExternLsaCount, ospfAreaRangeNet=ospfAreaRangeNet, ospfAddressLessIf=ospfAddressLessIf, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubAreaTable=ospfStubAreaTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricStatus=ospfIfMetricStatus, ospfHostGroup=ospfHostGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRestartInterval=ospfRestartInterval, ospfNbrState=ospfNbrState, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfRouterId=ospfRouterId, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrGroup=ospfNbrGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfMetricValue=ospfIfMetricValue, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrRtrId=ospfNbrRtrId, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, TOSType=TOSType, ospfLsdbSequence=ospfLsdbSequence, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfRestartAge=ospfRestartAge, ospfIfTransitDelay=ospfIfTransitDelay, ospfStubMetric=ospfStubMetric, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAsLsaCount=ospfAsLsaCount, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtIfAreaId=ospfVirtIfAreaId, ospf=ospf, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfRestartSupport=ospfRestartSupport, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfAreaId=ospfIfAreaId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, RouterID=RouterID, ospfIfGroup=ospfIfGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfGroup2=ospfIfGroup2, ospfCompliances=ospfCompliances, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaStatus=ospfAreaStatus, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfGeneralGroup=ospfGeneralGroup, ospfLsdbTable=ospfLsdbTable, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfConformance=ospfConformance, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfCompliance2=ospfCompliance2, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfRetransInterval=ospfIfRetransInterval, PositiveInteger=PositiveInteger, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrOptions=ospfNbrOptions, ospfObsoleteGroup=ospfObsoleteGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtNbrState=ospfVirtNbrState, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbType=ospfExtLsdbType, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLsdbLsid=ospfLsdbLsid, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfDemand=ospfIfDemand, ospfIfIpAddress=ospfIfIpAddress, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaGroup=ospfAreaGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrTable=ospfNbrTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaEntry=ospfAreaEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaId=ospfAreaId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfStubAreaId=ospfStubAreaId)
