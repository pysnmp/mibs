...
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbType=ospfAsLsdbType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfMetricEntry=ospfIfMetricEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfBasicGroup2=ospfBasicGroup2, ospfIfAuthType=ospfIfAuthType, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbType=ospfExtLsdbType, ospfIfStatus=ospfIfStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLsdbSequence=ospfLsdbSequence, ospfHostEntry=ospfHostEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAddressLessIf=ospfAddressLessIf, ospfIntraArea=ospfIntraArea, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfCompliance=ospfCompliance, ospfDemandExtensions=ospfDemandExtensions, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospf=ospf, ospfIfMetricStatus=ospfIfMetricStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, RouterID=RouterID, ospfLsdbAge=ospfLsdbAge, ospfNbrPriority=ospfNbrPriority, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrTable=ospfNbrTable, ospfAreaGroup=ospfAreaGroup, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtNbrState=ospfVirtNbrState, ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricTOS=ospfIfMetricTOS, ospfInterArea=ospfInterArea, ospfExternalType2=ospfExternalType2, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLsdbType=ospfLsdbType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, AreaID=AreaID, ospfIfTable=ospfIfTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfAreaId=ospfIfAreaId, ospfVersionNumber=ospfVersionNumber, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfSpfRuns=ospfSpfRuns, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfComplianceObsolete=ospfComplianceObsolete, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbRouterId=ospfLsdbRouterId, HelloRange=HelloRange, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAuthType=ospfAuthType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, PYSNMP_MODULE_ID=ospf, ospfRFC1583Compatibility=ospfRFC1583Compatibility, TOSType=TOSType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfBasicGroup=ospfBasicGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfStubStatus=ospfStubStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfHelloInterval=ospfIfHelloInterval, Metric=Metric, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfGroups=ospfGroups, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfIpAddress=ospfIfIpAddress, ospfHostTOS=ospfHostTOS, ospfImportAsExtern=ospfImportAsExtern, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbLsid=ospfLsdbLsid, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfCompliances=ospfCompliances, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfPollInterval=ospfIfPollInterval, ospfLsdbGroup=ospfLsdbGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfStubMetricType=ospfStubMetricType, ospfHostAreaID=ospfHostAreaID, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrOptions=ospfNbrOptions, ospfConformance=ospfConformance, ospfAdminStat=ospfAdminStat, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubMetric=ospfStubMetric, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtIfEntry=ospfVirtIfEntry, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaStatus=ospfAreaStatus, PositiveInteger=PositiveInteger, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaRangeMask=ospfAreaRangeMask, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrEntry=ospfNbrEntry, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrGroup=ospfNbrGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfAuthKey=ospfIfAuthKey, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfGeneralGroup=ospfGeneralGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfAdminStat=ospfIfAdminStat, ospfRxNewLsas=ospfRxNewLsas, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfTOSSupport=ospfTOSSupport, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, OspfAuthenticationType=OspfAuthenticationType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfGroup=ospfIfGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfRestartInterval=ospfRestartInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubAreaTable=ospfStubAreaTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfState=ospfIfState, ospfExternLsaCount=ospfExternLsaCount, ospfAreaRangeNet=ospfAreaRangeNet, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfEntry=ospfIfEntry, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfStatus=ospfVirtIfStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfHostIpAddress=ospfHostIpAddress, ospfNbrRtrId=ospfNbrRtrId, ospfHostGroup=ospfHostGroup, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfHostGroup2=ospfHostGroup2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfGroup2=ospfIfGroup2, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaTable=ospfAreaTable, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfAuthType=ospfVirtIfAuthType, BigMetric=BigMetric, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfHostMetric=ospfHostMetric, ospfIfDemand=ospfIfDemand, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfCompliance2=ospfCompliance2, ospfRouterId=ospfRouterId, Status=Status, ospfAreaId=ospfAreaId, ospfHostTable=ospfHostTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfHostStatus=ospfHostStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, UpToMaxAge=UpToMaxAge, ospfAreaSummary=ospfAreaSummary, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfMetricValue=ospfIfMetricValue, ospfAreaGroup2=ospfAreaGroup2, ospfAreaEntry=ospfAreaEntry, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrState=ospfNbrState, ospfIfEvents=ospfIfEvents, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubTOS=ospfStubTOS, ospfIfType=ospfIfType, ospfIfMetricTable=ospfIfMetricTable, ospfRestartAge=ospfRestartAge, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsBdrRtrCount=ospfAsBdrRtrCount)
mibBuilder.exportSymbols("OSPF-MIB", ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRestartSupport=ospfRestartSupport, DesignatedRouterPriority=DesignatedRouterPriority)
