...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfRestartAge=ospfRestartAge, ospfAdminStat=ospfAdminStat, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExternLsaCount=ospfExternLsaCount, ospfCompliances=ospfCompliances, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLsdbType=ospfLsdbType, ospfNbrGroup=ospfNbrGroup, Metric=Metric, ospf=ospf, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfCompliance=ospfCompliance, ospfVirtIfAreaId=ospfVirtIfAreaId, OspfAuthenticationType=OspfAuthenticationType, ospfNbrEntry=ospfNbrEntry, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, PYSNMP_MODULE_ID=ospf, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRxNewLsas=ospfRxNewLsas, ospfVersionNumber=ospfVersionNumber, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsdbTable=ospfAsLsdbTable, ospfInterArea=ospfInterArea, ospfIfGroup=ospfIfGroup, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAuthType=ospfAuthType, ospfHostMetric=ospfHostMetric, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfDemand=ospfIfDemand, ospfIfRetransInterval=ospfIfRetransInterval, ospfExtLsdbType=ospfExtLsdbType, ospfAreaEntry=ospfAreaEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfBasicGroup2=ospfBasicGroup2, ospfStubTOS=ospfStubTOS, ospfIfType=ospfIfType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfExternalType1=ospfExternalType1, ospfHostGroup2=ospfHostGroup2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfGroups=ospfGroups, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfStatus=ospfIfStatus, HelloRange=HelloRange, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfEvents=ospfIfEvents, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaSummary=ospfAreaSummary, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfCompliance2=ospfCompliance2, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaGroup=ospfAreaGroup, PositiveInteger=PositiveInteger, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfState=ospfIfState, ospfIfAuthType=ospfIfAuthType, ospfLsdbLsid=ospfLsdbLsid, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfIpAddress=ospfIfIpAddress, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExtLsdbEntry=ospfExtLsdbEntry, Status=Status, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLsdbAge=ospfLsdbAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrTable=ospfNbrTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfState=ospfVirtIfState, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfGroup2=ospfIfGroup2, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfHostTable=ospfHostTable, ospfNbrOptions=ospfNbrOptions, ospfAsLsdbType=ospfAsLsdbType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricValue=ospfIfMetricValue, ospfRestartSupport=ospfRestartSupport, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfStubMetricType=ospfStubMetricType, ospfLsdbTable=ospfLsdbTable, ospfLsdbChecksum=ospfLsdbChecksum, ospfRestartExitReason=ospfRestartExitReason, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfImportAsExtern=ospfImportAsExtern, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfStubAreaEntry=ospfStubAreaEntry, ospfStubAreaId=ospfStubAreaId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfEntry=ospfIfEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExternalType2=ospfExternalType2, ospfTOSSupport=ospfTOSSupport, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostEntry=ospfHostEntry, ospfStubMetric=ospfStubMetric, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, UpToMaxAge=UpToMaxAge, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfRouteGroup=ospfRouteGroup, AreaID=AreaID, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfEvents=ospfVirtIfEvents, TOSType=TOSType, RouterID=RouterID, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrEvents=ospfNbrEvents, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfRestartInterval=ospfRestartInterval, ospfHostStatus=ospfHostStatus, ospfIfAreaId=ospfIfAreaId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfConformance=ospfConformance, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfMetricEntry=ospfIfMetricEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaRangeStatus=ospfAreaRangeStatus, BigMetric=BigMetric, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtIfTable=ospfVirtIfTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfTable=ospfIfTable, ospfAreaGroup2=ospfAreaGroup2, ospfAsLsaCount=ospfAsLsaCount, ospfHostIpAddress=ospfHostIpAddress, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbrRtrId=ospfNbrRtrId, ospfAreaStatus=ospfAreaStatus, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfDemandExtensions=ospfDemandExtensions, ospfHostGroup=ospfHostGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfGeneralGroup=ospfGeneralGroup, ospfIfMetricTable=ospfIfMetricTable, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfGroup=ospfVirtIfGroup, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRouterId=ospfRouterId, ospfNbrState=ospfNbrState, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrGroup2=ospfNbrGroup2, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfComplianceObsolete=ospfComplianceObsolete, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfStubStatus=ospfStubStatus, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfTransitDelay=ospfIfTransitDelay, ospfIntraArea=ospfIntraArea, ospfStubAreaTable=ospfStubAreaTable, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfLsaCount=ospfIfLsaCount, ospfIfMetricTOS=ospfIfMetricTOS, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfNbrPriority=ospfNbrPriority, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaId=ospfAreaId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrState=ospfVirtNbrState)
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaTable=ospfAreaTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfDesignatedRouter=ospfIfDesignatedRouter)
