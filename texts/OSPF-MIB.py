...
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsaCount=ospfAsLsaCount, ospfHostStatus=ospfHostStatus, ospfIfEvents=ospfIfEvents, Metric=Metric, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfGroups=ospfGroups, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaId=ospfAreaId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfRestartExitReason=ospfRestartExitReason, ospfStubAreaGroup=ospfStubAreaGroup, ospfCompliances=ospfCompliances, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfTransitDelay=ospfIfTransitDelay, ospfHostGroup=ospfHostGroup, HelloRange=HelloRange, AreaID=AreaID, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubAreaTable=ospfStubAreaTable, RouterID=RouterID, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, BigMetric=BigMetric, ospfHostMetric=ospfHostMetric, ospfIfMetricEntry=ospfIfMetricEntry, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfBasicGroup=ospfBasicGroup, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricTable=ospfIfMetricTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaEntry=ospfAreaEntry, TOSType=TOSType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaStatus=ospfAreaStatus, ospfVirtIfState=ospfVirtIfState, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrPriority=ospfNbrPriority, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfImportAsExtern=ospfImportAsExtern, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrEvents=ospfNbrEvents, ospfStubMetric=ospfStubMetric, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfAuthKey=ospfIfAuthKey, ospfGeneralGroup=ospfGeneralGroup, ospfAreaSummary=ospfAreaSummary, ospfIfMetricGroup=ospfIfMetricGroup, UpToMaxAge=UpToMaxAge, ospfExternalType2=ospfExternalType2, ospfRestartStatus=ospfRestartStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfAuthType=ospfAuthType, ospfLsdbSequence=ospfLsdbSequence, ospfIfIpAddress=ospfIfIpAddress, ospfAddressLessIf=ospfAddressLessIf, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfGroup=ospfIfGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfTOSSupport=ospfTOSSupport, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLsdbRouterId=ospfLsdbRouterId, ospfStubMetricType=ospfStubMetricType, ospfLsdbEntry=ospfLsdbEntry, ospfHostIpAddress=ospfHostIpAddress, ospfLocalLsdbTable=ospfLocalLsdbTable, PositiveInteger=PositiveInteger, ospf=ospf, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbType=ospfExtLsdbType, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrGroup2=ospfNbrGroup2, ospfConformance=ospfConformance, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrState=ospfVirtNbrState, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfRouterId=ospfRouterId, ospfLsdbTable=ospfLsdbTable, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfRestartAge=ospfRestartAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfRestartInterval=ospfRestartInterval, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrTable=ospfNbrTable, Status=Status, ospfHostTOS=ospfHostTOS, ospfNbrGroup=ospfNbrGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtIfEntry=ospfVirtIfEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubAreaEntry=ospfStubAreaEntry, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbAge=ospfAsLsdbAge, ospfComplianceObsolete=ospfComplianceObsolete, ospfHostGroup2=ospfHostGroup2, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfDemandExtensions=ospfDemandExtensions, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfTable=ospfIfTable, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtIfEvents=ospfVirtIfEvents, ospfCompliance=ospfCompliance, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfDemand=ospfIfDemand, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfLsaCount=ospfIfLsaCount, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfEntry=ospfIfEntry, ospfCompliance2=ospfCompliance2, ospfLsdbLsid=ospfLsdbLsid, ospfIfState=ospfIfState, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfBasicGroup2=ospfBasicGroup2, ospfIfStatus=ospfIfStatus, ospfNbrState=ospfNbrState, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfGroup=ospfVirtIfGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLsdbAge=ospfLsdbAge, ospfStubAreaId=ospfStubAreaId, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExternLsaCount=ospfExternLsaCount, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrOptions=ospfNbrOptions, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIntraArea=ospfIntraArea, ospfInterArea=ospfInterArea, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfHostEntry=ospfHostEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbType=ospfLsdbType, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbAreaId=ospfLsdbAreaId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfRestartSupport=ospfRestartSupport, ospfAdminStat=ospfAdminStat, ospfLocalLsdbType=ospfLocalLsdbType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostTable=ospfHostTable, ospfHostAreaID=ospfHostAreaID, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfAuthType=ospfIfAuthType, ospfAreaTable=ospfAreaTable, ospfNbrEntry=ospfNbrEntry, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaGroup=ospfAreaGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVersionNumber=ospfVersionNumber, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfGroup2=ospfIfGroup2, ospfIfMetricIpAddress=ospfIfMetricIpAddress, PYSNMP_MODULE_ID=ospf, ospfRxNewLsas=ospfRxNewLsas, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubTOS=ospfStubTOS, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, DesignatedRouterPriority=DesignatedRouterPriority, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfStubStatus=ospfStubStatus, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLocalLsdbLsid=ospfLocalLsdbLsid)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfType=ospfIfType)
