...
mibBuilder.exportSymbols("OSPF-MIB", AreaID=AreaID, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, DesignatedRouterPriority=DesignatedRouterPriority, ospfRouterId=ospfRouterId, ospfExtLsdbSequence=ospfExtLsdbSequence, HelloRange=HelloRange, ospfAsLsdbType=ospfAsLsdbType, ospfCompliance2=ospfCompliance2, ospfIfState=ospfIfState, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbEntry=ospfLsdbEntry, ospfStubAreaTable=ospfStubAreaTable, ospfDemandExtensions=ospfDemandExtensions, ospfAreaGroup=ospfAreaGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaTable=ospfAreaTable, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAddressLessIf=ospfAddressLessIf, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfBasicGroup2=ospfBasicGroup2, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaId=ospfAreaId, ospfLsdbSequence=ospfLsdbSequence, ospfExtLsdbType=ospfExtLsdbType, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfHostMetric=ospfHostMetric, ospfHostGroup2=ospfHostGroup2, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfRetransInterval=ospfIfRetransInterval, OspfAuthenticationType=OspfAuthenticationType, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfRestartExitReason=ospfRestartExitReason, BigMetric=BigMetric, ospf=ospf, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAsLsaCount=ospfAsLsaCount, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaSummary=ospfAreaSummary, ospfGeneralGroup=ospfGeneralGroup, ospfHostAreaID=ospfHostAreaID, ospfBasicGroup=ospfBasicGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbAge=ospfLsdbAge, ospfIfType=ospfIfType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubAreaId=ospfStubAreaId, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfIpAddress=ospfIfIpAddress, ospfSpfRuns=ospfSpfRuns, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbType=ospfLocalLsdbType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExternalType2=ospfExternalType2, ospfNbrPriority=ospfNbrPriority, ospfInterArea=ospfInterArea, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfTOSSupport=ospfTOSSupport, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAdminStat=ospfAdminStat, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfMulticastExtensions=ospfMulticastExtensions, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfImportAsExtern=ospfImportAsExtern, ospfIfLsaCount=ospfIfLsaCount, ospfIfMetricValue=ospfIfMetricValue, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfCompliance=ospfCompliance, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaRangeNet=ospfAreaRangeNet, TOSType=TOSType, ospfHostEntry=ospfHostEntry, ospfVirtNbrState=ospfVirtNbrState, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfStatus=ospfIfStatus, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfComplianceObsolete=ospfComplianceObsolete, ospfStubTOS=ospfStubTOS, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubMetric=ospfStubMetric, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfAdminStat=ospfIfAdminStat, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfAuthType=ospfIfAuthType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, Status=Status, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfGroups=ospfGroups, PositiveInteger=PositiveInteger, UpToMaxAge=UpToMaxAge, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIntraArea=ospfIntraArea, ospfExternalType1=ospfExternalType1, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbrState=ospfNbrState, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfStubAreaGroup=ospfStubAreaGroup, ospfLsdbGroup=ospfLsdbGroup, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfGroup2=ospfIfGroup2, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfRestartStatus=ospfRestartStatus, ospfVirtIfStatus=ospfVirtIfStatus, RouterID=RouterID, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfPollInterval=ospfIfPollInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRxNewLsas=ospfRxNewLsas, ospfHostStatus=ospfHostStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostGroup=ospfHostGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaStatus=ospfAreaStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfNbrEntry=ospfNbrEntry, ospfIfAreaId=ospfIfAreaId, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfMetricTOS=ospfIfMetricTOS, ospfConformance=ospfConformance, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfEntry=ospfIfEntry, ospfNbrEvents=ospfNbrEvents, ospfHostTOS=ospfHostTOS, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrGroup=ospfNbrGroup, ospfRestartAge=ospfRestartAge, ospfIfMetricTable=ospfIfMetricTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfGroup=ospfIfGroup, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfCompliances=ospfCompliances, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubMetricType=ospfStubMetricType, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaEntry=ospfAreaEntry, PYSNMP_MODULE_ID=ospf, ospfRestartInterval=ospfRestartInterval, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbType=ospfLsdbType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExtLsdbAge=ospfExtLsdbAge, Metric=Metric, ospfNbrTable=ospfNbrTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfStubStatus=ospfStubStatus, ospfLsdbTable=ospfLsdbTable, ospfVirtIfState=ospfVirtIfState, ospfIfTable=ospfIfTable, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostTable=ospfHostTable, ospfIfEvents=ospfIfEvents, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLsdbLsid=ospfLsdbLsid, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaGroup2=ospfAreaGroup2, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAuthType=ospfAuthType, ospfNbrGroup2=ospfNbrGroup2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLsdbRouterId=ospfLsdbRouterId, ospfVersionNumber=ospfVersionNumber, ospfHostIpAddress=ospfHostIpAddress, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfDemand=ospfIfDemand, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrOptions=ospfNbrOptions, ospfHostCfgAreaID=ospfHostCfgAreaID)
