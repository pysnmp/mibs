...
mibBuilder.exportSymbols("OSPF-MIB", ospfExternalType1=ospfExternalType1, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfHostEntry=ospfHostEntry, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfMetricTable=ospfIfMetricTable, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrState=ospfNbrState, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfRestartAge=ospfRestartAge, ospfVirtIfState=ospfVirtIfState, ospfIfMetricValue=ospfIfMetricValue, HelloRange=HelloRange, ospfExternLsaCount=ospfExternLsaCount, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsaCount=ospfAsLsaCount, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfEntry=ospfIfEntry, ospfIfType=ospfIfType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfCompliances=ospfCompliances, ospfCompliance2=ospfCompliance2, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfStatus=ospfIfStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfDemand=ospfIfDemand, ospfVirtIfNeighbor=ospfVirtIfNeighbor, RouterID=RouterID, ospfRestartStatus=ospfRestartStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLsdbTable=ospfLsdbTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRestartExitReason=ospfRestartExitReason, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, UpToMaxAge=UpToMaxAge, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfBasicGroup2=ospfBasicGroup2, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaStatus=ospfAreaStatus, ospfIfState=ospfIfState, TOSType=TOSType, ospfLsdbType=ospfLsdbType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfGroup2=ospfIfGroup2, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLsdbChecksum=ospfLsdbChecksum, ospfComplianceObsolete=ospfComplianceObsolete, ospfStubMetricType=ospfStubMetricType, ospfVirtIfStatus=ospfVirtIfStatus, PYSNMP_MODULE_ID=ospf, ospfRouterId=ospfRouterId, ospfRouteGroup=ospfRouteGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfRestartSupport=ospfRestartSupport, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfStubAreaGroup=ospfStubAreaGroup, ospfAdminStat=ospfAdminStat, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaId=ospfAreaId, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsdbType=ospfAsLsdbType, ospfNbrGroup2=ospfNbrGroup2, ospfHostTOS=ospfHostTOS, BigMetric=BigMetric, ospfIfAdminStat=ospfIfAdminStat, ospfIfAuthType=ospfIfAuthType, ospfNbrGroup=ospfNbrGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrTable=ospfVirtNbrTable, ospfStubMetric=ospfStubMetric, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExtLsdbType=ospfExtLsdbType, ospfDemandExtensions=ospfDemandExtensions, Status=Status, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLsdbSequence=ospfLsdbSequence, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfHostMetric=ospfHostMetric, ospfAreaGroup=ospfAreaGroup, ospfIfEvents=ospfIfEvents, ospfVirtIfTable=ospfVirtIfTable, ospfConformance=ospfConformance, ospfIfMetricStatus=ospfIfMetricStatus, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIntraArea=ospfIntraArea, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfTable=ospfIfTable, ospfRxNewLsas=ospfRxNewLsas, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfBasicGroup=ospfBasicGroup, ospfLsdbAge=ospfLsdbAge, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrEvents=ospfNbrEvents, ospfVersionNumber=ospfVersionNumber, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfStubStatus=ospfStubStatus, ospfLsdbEntry=ospfLsdbEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostTable=ospfHostTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaGroup2=ospfAreaGroup2, ospfNbrEntry=ospfNbrEntry, ospfNbrOptions=ospfNbrOptions, ospfHostGroup=ospfHostGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostGroup2=ospfHostGroup2, ospfAreaTable=ospfAreaTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrIpAddr=ospfNbrIpAddr, ospfSpfRuns=ospfSpfRuns, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaRangeGroup=ospfAreaRangeGroup, AreaID=AreaID, ospfIfAuthKey=ospfIfAuthKey, ospfLsdbRouterId=ospfLsdbRouterId, ospfLsdbGroup=ospfLsdbGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExternalType2=ospfExternalType2, ospfImportAsExtern=ospfImportAsExtern, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAuthType=ospfAuthType, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaSummary=ospfAreaSummary, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfTOSSupport=ospfTOSSupport, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAsLsaCksumSum=ospfAsLsaCksumSum, OspfAuthenticationType=OspfAuthenticationType, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrState=ospfVirtNbrState, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfRestartInterval=ospfRestartInterval, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfStubTOS=ospfStubTOS, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospf=ospf, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostIpAddress=ospfHostIpAddress, ospfIfAreaId=ospfIfAreaId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfGroups=ospfGroups, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLsdbLsid=ospfLsdbLsid, ospfNbrTable=ospfNbrTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfGroup=ospfIfGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostStatus=ospfHostStatus, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfIpAddress=ospfIfIpAddress, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfMetricTOS=ospfIfMetricTOS, ospfCompliance=ospfCompliance, ospfStubAreaId=ospfStubAreaId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfInterArea=ospfInterArea, ospfExtLsdbAge=ospfExtLsdbAge, PositiveInteger=PositiveInteger, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfGeneralGroup=ospfGeneralGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAddressLessIf=ospfAddressLessIf, Metric=Metric)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrPriority=ospfNbrPriority)
