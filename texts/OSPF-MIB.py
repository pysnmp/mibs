...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsdbType=ospfAsLsdbType, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrEntry=ospfNbrEntry, ospfLsdbType=ospfLsdbType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAuthType=ospfAuthType, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtNbrState=ospfVirtNbrState, HelloRange=HelloRange, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfGroup=ospfVirtIfGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, UpToMaxAge=UpToMaxAge, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, Status=Status, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbTable=ospfLsdbTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfHostTable=ospfHostTable, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfMetricTOS=ospfIfMetricTOS, ospfCompliance2=ospfCompliance2, ospfBasicGroup2=ospfBasicGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfHostTOS=ospfHostTOS, ospfRestartInterval=ospfRestartInterval, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfRouterId=ospfRouterId, ospfVersionNumber=ospfVersionNumber, ospfAdminStat=ospfAdminStat, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospf=ospf, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbrGroup=ospfNbrGroup, ospfIfEntry=ospfIfEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaEntry=ospfAreaEntry, PositiveInteger=PositiveInteger, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfBasicGroup=ospfBasicGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfHostStatus=ospfHostStatus, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAddressLessIf=ospfAddressLessIf, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfTable=ospfVirtIfTable, ospfNbrState=ospfNbrState, ospfSpfRuns=ospfSpfRuns, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfGroups=ospfGroups, ospfIfHelloInterval=ospfIfHelloInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostGroup=ospfHostGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfMulticastExtensions=ospfMulticastExtensions, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaRangeTable=ospfAreaRangeTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfStatus=ospfIfStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfDemand=ospfIfDemand, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaSummary=ospfAreaSummary, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfRestartStatus=ospfRestartStatus, ospfAreaTable=ospfAreaTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfTable=ospfIfTable, ospfIfAreaId=ospfIfAreaId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, AreaID=AreaID, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfGroup2=ospfIfGroup2, ospfTOSSupport=ospfTOSSupport, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfRestartSupport=ospfRestartSupport, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubStatus=ospfStubStatus, ospfNbrRtrId=ospfNbrRtrId, ospfConformance=ospfConformance, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIntraArea=ospfIntraArea, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaGroup=ospfAreaGroup, ospfHostMetric=ospfHostMetric, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostIpAddress=ospfHostIpAddress, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfStubTOS=ospfStubTOS, ospfHostEntry=ospfHostEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbType=ospfExtLsdbType, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfMetricStatus=ospfIfMetricStatus, ospfLsdbAge=ospfLsdbAge, ospfRestartAge=ospfRestartAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostAreaID=ospfHostAreaID, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfMetricValue=ospfIfMetricValue, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfIpAddress=ospfIfIpAddress, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfAuthKey=ospfIfAuthKey, Metric=Metric, ospfRxNewLsas=ospfRxNewLsas, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfStubMetricType=ospfStubMetricType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfHostGroup2=ospfHostGroup2, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrPriority=ospfNbrPriority, ospfAreaId=ospfAreaId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrGroup2=ospfNbrGroup2, ospfCompliance=ospfCompliance, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfCompliances=ospfCompliances, ospfIfGroup=ospfIfGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrTable=ospfNbrTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrOptions=ospfNbrOptions, ospfAsLsdbAge=ospfAsLsdbAge, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfPollInterval=ospfIfPollInterval, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfInterArea=ospfInterArea, ospfVirtIfLsaCount=ospfVirtIfLsaCount, BigMetric=BigMetric, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfStatus=ospfVirtIfStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, RouterID=RouterID, ospfIfAuthType=ospfIfAuthType, ospfIfMetricTable=ospfIfMetricTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfState=ospfVirtIfState, ospfAreaStatus=ospfAreaStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, TOSType=TOSType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfState=ospfIfState, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfDemandExtensions=ospfDemandExtensions, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfStubMetric=ospfStubMetric, ospfExternLsaCount=ospfExternLsaCount, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfType=ospfIfType, PYSNMP_MODULE_ID=ospf, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaRangeEffect=ospfAreaRangeEffect)
mibBuilder.exportSymbols("OSPF-MIB", ospfStubAreaId=ospfStubAreaId, ospfLsdbLsid=ospfLsdbLsid, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaLsaCount=ospfAreaLsaCount)
