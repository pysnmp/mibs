...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrRtrId=ospfVirtNbrRtrId, PositiveInteger=PositiveInteger, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfState=ospfIfState, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExternalType2=ospfExternalType2, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaStatus=ospfAreaStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaGroup=ospfAreaGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrTable=ospfNbrTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAdminStat=ospfAdminStat, ospfHostIpAddress=ospfHostIpAddress, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrState=ospfNbrState, ospfInterArea=ospfInterArea, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAsLsaCount=ospfAsLsaCount, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfMulticastExtensions=ospfMulticastExtensions, ospfLsdbGroup=ospfLsdbGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfLocalLsdbType=ospfLocalLsdbType, ospfRestartAge=ospfRestartAge, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, PYSNMP_MODULE_ID=ospf, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAuthType=ospfAuthType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfRestartSupport=ospfRestartSupport, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfSpfRuns=ospfSpfRuns, ospfIfAuthKey=ospfIfAuthKey, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfLsaCount=ospfIfLsaCount, ospfAsLsdbType=ospfAsLsdbType, ospfIfEntry=ospfIfEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfImportAsExtern=ospfImportAsExtern, ospfCompliances=ospfCompliances, ospfIfMetricTable=ospfIfMetricTable, ospf=ospf, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfBasicGroup2=ospfBasicGroup2, ospfStubMetric=ospfStubMetric, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfHostEntry=ospfHostEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostGroup=ospfHostGroup, ospfRestartExitReason=ospfRestartExitReason, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfAdminStat=ospfIfAdminStat, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfIpAddress=ospfIfIpAddress, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfEvents=ospfIfEvents, ospfCompliance=ospfCompliance, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfStubStatus=ospfStubStatus, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfHostGroup2=ospfHostGroup2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfHostAreaID=ospfHostAreaID, ospfExtLsdbType=ospfExtLsdbType, ospfStubAreaGroup=ospfStubAreaGroup, RouterID=RouterID, ospfCompliance2=ospfCompliance2, ospfRouterId=ospfRouterId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfAreaId=ospfIfAreaId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricValue=ospfIfMetricValue, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfMetricGroup=ospfIfMetricGroup, ospfLsdbLsid=ospfLsdbLsid, UpToMaxAge=UpToMaxAge, ospfNbrEvents=ospfNbrEvents, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVersionNumber=ospfVersionNumber, ospfLsdbType=ospfLsdbType, ospfRestartInterval=ospfRestartInterval, ospfNbrGroup=ospfNbrGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfStubAreaTable=ospfStubAreaTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfGroups=ospfGroups, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAddressLessIf=ospfAddressLessIf, ospfIfHelloInterval=ospfIfHelloInterval, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfStubAreaId=ospfStubAreaId, ospfAreaEntry=ospfAreaEntry, ospfHostStatus=ospfHostStatus, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaTable=ospfAreaTable, ospfIfStatus=ospfIfStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfTOSSupport=ospfTOSSupport, ospfAreaRangeTable=ospfAreaRangeTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsdbRouterId=ospfAsLsdbRouterId, BigMetric=BigMetric, ospfExternalType1=ospfExternalType1, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfMetricStatus=ospfIfMetricStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfStubRouterSupport=ospfStubRouterSupport, TOSType=TOSType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrOptions=ospfNbrOptions, ospfIntraArea=ospfIntraArea, ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfRetransInterval=ospfIfRetransInterval, ospfObsoleteGroup=ospfObsoleteGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfHostTable=ospfHostTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, Metric=Metric, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfHostMetric=ospfHostMetric, ospfIfAuthType=ospfIfAuthType, ospfNbrPriority=ospfNbrPriority, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfTable=ospfVirtIfTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfPollInterval=ospfIfPollInterval, ospfLsdbTable=ospfLsdbTable, ospfRouteGroup=ospfRouteGroup, ospfConformance=ospfConformance, ospfStubMetricType=ospfStubMetricType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfGroup=ospfIfGroup, ospfStubTOS=ospfStubTOS, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfStatus=ospfVirtIfStatus, AreaID=AreaID, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, OspfAuthenticationType=OspfAuthenticationType, Status=Status, ospfIfGroup2=ospfIfGroup2, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaSummary=ospfAreaSummary, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfDemand=ospfIfDemand, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfRxNewLsas=ospfRxNewLsas, ospfAreaLsaCountTable=ospfAreaLsaCountTable, HelloRange=HelloRange, ospfLsdbAge=ospfLsdbAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaId=ospfAreaId, ospfIfType=ospfIfType, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostTOS=ospfHostTOS)
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfTable=ospfIfTable, ospfIfRtrPriority=ospfIfRtrPriority)
