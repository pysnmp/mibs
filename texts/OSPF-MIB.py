...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfCompliance=ospfCompliance, ospfStubTOS=ospfStubTOS, ospfRestartInterval=ospfRestartInterval, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExternalType2=ospfExternalType2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfStubStatus=ospfStubStatus, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricEntry=ospfIfMetricEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrOptions=ospfNbrOptions, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfConformance=ospfConformance, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbSequence=ospfLsdbSequence, ospfAddressLessIf=ospfAddressLessIf, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfHostStatus=ospfHostStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, Metric=Metric, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfSpfRuns=ospfSpfRuns, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfReferenceBandwidth=ospfReferenceBandwidth, AreaID=AreaID, ospfStubAreaId=ospfStubAreaId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfMetricStatus=ospfIfMetricStatus, ospfRxNewLsas=ospfRxNewLsas, ospfIfGroup=ospfIfGroup, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaRangeMask=ospfAreaRangeMask, ospfRestartAge=ospfRestartAge, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfInterArea=ospfInterArea, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfCompliances=ospfCompliances, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfEvents=ospfIfEvents, ospfVirtIfTable=ospfVirtIfTable, ospfNbrGroup2=ospfNbrGroup2, ospfIfMetricValue=ospfIfMetricValue, Status=Status, ospfLsdbType=ospfLsdbType, ospfNbrPriority=ospfNbrPriority, ospfGroups=ospfGroups, ospfStubMetric=ospfStubMetric, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAuthType=ospfAuthType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaGroup=ospfAreaGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrState=ospfVirtNbrState, ospfExternLsaCount=ospfExternLsaCount, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfRouterId=ospfRouterId, ospfIfAdminStat=ospfIfAdminStat, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfState=ospfVirtIfState, ospfIfTable=ospfIfTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaStatus=ospfAreaStatus, ospfIfDemand=ospfIfDemand, ospf=ospf, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricTable=ospfIfMetricTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLsdbGroup=ospfLsdbGroup, ospfHostAreaID=ospfHostAreaID, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLsdbLsid=ospfLsdbLsid, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubMetricType=ospfStubMetricType, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfHostGroup2=ospfHostGroup2, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfGroup2=ospfIfGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostMetric=ospfHostMetric, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaId=ospfAreaId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, HelloRange=HelloRange, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, BigMetric=BigMetric, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbAreaId=ospfLsdbAreaId, RouterID=RouterID, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVersionNumber=ospfVersionNumber, ospfHostTOS=ospfHostTOS, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaGroup2=ospfAreaGroup2, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfType=ospfIfType, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, PositiveInteger=PositiveInteger, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, PYSNMP_MODULE_ID=ospf, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfIpAddress=ospfIfIpAddress, ospfAreaEntry=ospfAreaEntry, ospfGeneralGroup=ospfGeneralGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfEntry=ospfIfEntry, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfAsLsdbTable=ospfAsLsdbTable, ospfHostTable=ospfHostTable, ospfLsdbTable=ospfLsdbTable, ospfAreaTable=ospfAreaTable, ospfIfStatus=ospfIfStatus, ospfAsLsaCount=ospfAsLsaCount, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrTable=ospfNbrTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfCompliance2=ospfCompliance2, ospfBasicGroup2=ospfBasicGroup2, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAsLsdbRouterId=ospfAsLsdbRouterId, TOSType=TOSType, ospfExtLsdbType=ospfExtLsdbType, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfRestartExitReason=ospfRestartExitReason, ospfRestartStatus=ospfRestartStatus, ospfObsoleteGroup=ospfObsoleteGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrState=ospfNbrState, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfStubAreaEntry=ospfStubAreaEntry, ospfRouteGroup=ospfRouteGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbLimit=ospfExtLsdbLimit, UpToMaxAge=UpToMaxAge, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtIfGroup=ospfVirtIfGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrEvents=ospfNbrEvents, ospfAreaSummary=ospfAreaSummary, ospfHostIpAddress=ospfHostIpAddress, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbAge=ospfLsdbAge, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfState=ospfIfState, ospfAdminStat=ospfAdminStat, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfHostGroup=ospfHostGroup, ospfIfAuthType=ospfIfAuthType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrEntry=ospfNbrEntry, ospfExternalType1=ospfExternalType1, ospfHostEntry=ospfHostEntry, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfNbrGroup=ospfNbrGroup, ospfAreaRangeNet=ospfAreaRangeNet)
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbAge=ospfExtLsdbAge, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrRtrId=ospfNbrRtrId, ospfRFC1583Compatibility=ospfRFC1583Compatibility)
