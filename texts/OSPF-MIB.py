...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfDemandExtensions=ospfDemandExtensions, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfState=ospfVirtIfState, ospfRestartStatus=ospfRestartStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrTable=ospfNbrTable, ospfLsdbChecksum=ospfLsdbChecksum, ospfBasicGroup=ospfBasicGroup, ospfVirtIfTable=ospfVirtIfTable, ospfHostMetric=ospfHostMetric, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfGroup=ospfIfGroup, ospfNbrGroup=ospfNbrGroup, Metric=Metric, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrState=ospfVirtNbrState, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAsLsaCount=ospfAsLsaCount, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfGeneralGroup=ospfGeneralGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaRangeTable=ospfAreaRangeTable, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, PYSNMP_MODULE_ID=ospf, ospfLsdbTable=ospfLsdbTable, ospfAuthType=ospfAuthType, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfAreaId=ospfIfAreaId, ospfRxNewLsas=ospfRxNewLsas, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfTOSSupport=ospfTOSSupport, ospfHostTable=ospfHostTable, ospfStubMetric=ospfStubMetric, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfInterArea=ospfInterArea, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfDemand=ospfIfDemand, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbType=ospfExtLsdbType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfObsoleteGroup=ospfObsoleteGroup, TOSType=TOSType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaTable=ospfAreaTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfNbrPriority=ospfNbrPriority, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfHostAreaID=ospfHostAreaID, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRouteGroup=ospfRouteGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfMetricValue=ospfIfMetricValue, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaId=ospfAreaId, ospfGroups=ospfGroups, ospfSpfRuns=ospfSpfRuns, ospfConformance=ospfConformance, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbLsid=ospfLsdbLsid, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubTOS=ospfStubTOS, ospfIfEvents=ospfIfEvents, AreaID=AreaID, ospfLsdbType=ospfLsdbType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfImportAsExtern=ospfImportAsExtern, ospfCompliance2=ospfCompliance2, ospfHostGroup2=ospfHostGroup2, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospf=ospf, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaSummary=ospfAreaSummary, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfMetricEntry=ospfIfMetricEntry, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfIpAddress=ospfIfIpAddress, PositiveInteger=PositiveInteger, ospfIfType=ospfIfType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfLsaCount=ospfIfLsaCount, ospfNbrEntry=ospfNbrEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfStubAreaId=ospfStubAreaId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfRestartAge=ospfRestartAge, ospfRestartInterval=ospfRestartInterval, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLsdbGroup=ospfLsdbGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostTOS=ospfHostTOS, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAdminStat=ospfAdminStat, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfStatus=ospfIfStatus, ospfLsdbAge=ospfLsdbAge, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfAuthKey=ospfIfAuthKey, ospfIfGroup2=ospfIfGroup2, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrGroup2=ospfNbrGroup2, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIntraArea=ospfIntraArea, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfState=ospfIfState, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfExternalType2=ospfExternalType2, ospfCompliances=ospfCompliances, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfComplianceObsolete=ospfComplianceObsolete, ospfExternalType1=ospfExternalType1, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfStubAreaTable=ospfStubAreaTable, ospfIfTable=ospfIfTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfRouterId=ospfRouterId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaGroup=ospfAreaGroup, ospfRestartSupport=ospfRestartSupport, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfCompliance=ospfCompliance, ospfHostEntry=ospfHostEntry, ospfIfPollInterval=ospfIfPollInterval, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostStatus=ospfHostStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, HelloRange=HelloRange, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfEntry=ospfIfEntry, ospfAsLsdbType=ospfAsLsdbType, ospfAreaLsaCount=ospfAreaLsaCount, OspfAuthenticationType=OspfAuthenticationType, UpToMaxAge=UpToMaxAge, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbType=ospfLocalLsdbType, ospfHostGroup=ospfHostGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaEntry=ospfAreaEntry, ospfHostIpAddress=ospfHostIpAddress, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrState=ospfNbrState, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, Status=Status, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaStatus=ospfAreaStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVersionNumber=ospfVersionNumber, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfStubMetricType=ospfStubMetricType, ospfIfAuthType=ospfIfAuthType, ospfNbrOptions=ospfNbrOptions, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfStubAreaGroup=ospfStubAreaGroup, ospfBasicGroup2=ospfBasicGroup2, RouterID=RouterID, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbGroup=ospfLocalLsdbGroup, BigMetric=BigMetric)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbLsid=ospfAsLsdbLsid)
