...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaId=ospfAreaId, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfState=ospfVirtIfState, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfGroups=ospfGroups, ospfAreaGroup2=ospfAreaGroup2, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfHostTable=ospfHostTable, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfRestartInterval=ospfRestartInterval, ospfNbrGroup2=ospfNbrGroup2, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbType=ospfLsdbType, ospfDemandExtensions=ospfDemandExtensions, ospfIfStatus=ospfIfStatus, ospfNbrRtrId=ospfNbrRtrId, ospfAsLsdbType=ospfAsLsdbType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfMulticastExtensions=ospfMulticastExtensions, ospfCompliance2=ospfCompliance2, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrPriority=ospfNbrPriority, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfRxNewLsas=ospfRxNewLsas, ospfIntraArea=ospfIntraArea, ospfIfTable=ospfIfTable, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostEntry=ospfHostEntry, ospfLsdbSequence=ospfLsdbSequence, RouterID=RouterID, ospfHostMetric=ospfHostMetric, ospfRouteGroup=ospfRouteGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAdminStat=ospfAdminStat, HelloRange=HelloRange, ospfLsdbLsid=ospfLsdbLsid, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLsdbGroup=ospfLsdbGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, TOSType=TOSType, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfMetricValue=ospfIfMetricValue, ospfRestartAge=ospfRestartAge, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfEntry=ospfVirtIfEntry, ospfAuthType=ospfAuthType, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAsLsdbTable=ospfAsLsdbTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfLsaCount=ospfIfLsaCount, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaSummary=ospfAreaSummary, ospfHostIpAddress=ospfHostIpAddress, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrTable=ospfNbrTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbGroup=ospfLocalLsdbGroup, UpToMaxAge=UpToMaxAge, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfRouterId=ospfRouterId, ospfIfDemand=ospfIfDemand, ospfStubAreaTable=ospfStubAreaTable, ospfAreaEntry=ospfAreaEntry, Status=Status, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrEntry=ospfNbrEntry, ospfIfType=ospfIfType, ospfLsdbTable=ospfLsdbTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfStubAreaId=ospfStubAreaId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrEvents=ospfNbrEvents, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfStubMetric=ospfStubMetric, ospfRestartStatus=ospfRestartStatus, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfComplianceObsolete=ospfComplianceObsolete, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfHostGroup=ospfHostGroup, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, Metric=Metric, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbSequence=ospfExtLsdbSequence, PositiveInteger=PositiveInteger, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfMetricTOS=ospfIfMetricTOS, ospfExternalType2=ospfExternalType2, ospfAreaGroup=ospfAreaGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMetricTable=ospfIfMetricTable, ospfCompliances=ospfCompliances, ospfGeneralGroup=ospfGeneralGroup, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtNbrState=ospfVirtNbrState, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaTable=ospfAreaTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, BigMetric=BigMetric, ospfObsoleteGroup=ospfObsoleteGroup, ospfInterArea=ospfInterArea, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfHostStatus=ospfHostStatus, ospfIfGroup2=ospfIfGroup2, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfGroup=ospfVirtIfGroup, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfStubMetricType=ospfStubMetricType, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfImportAsExtern=ospfImportAsExtern, ospfAddressLessIf=ospfAddressLessIf, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfEntry=ospfIfEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfConformance=ospfConformance, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfExtLsdbType=ospfExtLsdbType, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubAreaEntry=ospfStubAreaEntry, OspfAuthenticationType=OspfAuthenticationType, ospfStubStatus=ospfStubStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfGroup=ospfIfGroup, ospfHostTOS=ospfHostTOS, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospf=ospf, ospfIfAdminStat=ospfIfAdminStat, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfTOSSupport=ospfTOSSupport, AreaID=AreaID, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaStatus=ospfAreaStatus, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfState=ospfIfState, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRestartSupport=ospfRestartSupport, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVersionNumber=ospfVersionNumber, ospfCompliance=ospfCompliance, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfTable=ospfVirtIfTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrGroup=ospfNbrGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfExternalType1=ospfExternalType1, ospfStubTOS=ospfStubTOS, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfAuthType=ospfIfAuthType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRestartExitReason=ospfRestartExitReason, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfBasicGroup2=ospfBasicGroup2, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfSpfRuns=ospfSpfRuns, PYSNMP_MODULE_ID=ospf, ospfIfEvents=ospfIfEvents)
