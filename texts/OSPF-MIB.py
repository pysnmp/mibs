...
mibBuilder.exportSymbols("OSPF-MIB", ospfRestartAge=ospfRestartAge, ospfRouterId=ospfRouterId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfMetricValue=ospfIfMetricValue, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfGroup=ospfIfGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfRestartExitReason=ospfRestartExitReason, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfAuthKey=ospfIfAuthKey, ospfAddressLessIf=ospfAddressLessIf, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfAdminStat=ospfIfAdminStat, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfState=ospfIfState, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfCompliances=ospfCompliances, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaGroup=ospfAreaGroup, ospfAreaEntry=ospfAreaEntry, ospfStubTOS=ospfStubTOS, ospfRestartInterval=ospfRestartInterval, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospf=ospf, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExternalType1=ospfExternalType1, PositiveInteger=PositiveInteger, ospfGeneralGroup=ospfGeneralGroup, ospfIfDemand=ospfIfDemand, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfConformance=ospfConformance, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfTable=ospfVirtIfTable, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfAuthType=ospfIfAuthType, ospfAreaTable=ospfAreaTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrEntry=ospfNbrEntry, ospfNbrTable=ospfNbrTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateEffect=ospfAreaAggregateEffect, Status=Status, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfPollInterval=ospfIfPollInterval, ospfLsdbGroup=ospfLsdbGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfHostGroup=ospfHostGroup, ospfHostStatus=ospfHostStatus, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfState=ospfVirtIfState, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfType=ospfIfType, ospfNbrGroup=ospfNbrGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrState=ospfNbrState, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMetricStatus=ospfIfMetricStatus, ospfIntraArea=ospfIntraArea, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfCompliance=ospfCompliance, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostMetric=ospfHostMetric, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfEvents=ospfVirtIfEvents, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaRangeMask=ospfAreaRangeMask, ospfStubMetricType=ospfStubMetricType, ospfIfStatus=ospfIfStatus, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfBasicGroup=ospfBasicGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLsdbAge=ospfLsdbAge, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRouteGroup=ospfRouteGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfHelloInterval=ospfIfHelloInterval, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfImportAsExtern=ospfImportAsExtern, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfStubMetric=ospfStubMetric, ospfSpfRuns=ospfSpfRuns, ospfAreaRangeNet=ospfAreaRangeNet, ospfBasicGroup2=ospfBasicGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, RouterID=RouterID, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfMetricTable=ospfIfMetricTable, UpToMaxAge=UpToMaxAge, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricEntry=ospfIfMetricEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAuthType=ospfAuthType, ospfRestartSupport=ospfRestartSupport, ospfIfRetransInterval=ospfIfRetransInterval, ospfVersionNumber=ospfVersionNumber, ospfExtLsdbType=ospfExtLsdbType, ospfAreaStatus=ospfAreaStatus, HelloRange=HelloRange, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfCompliance2=ospfCompliance2, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrState=ospfVirtNbrState, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, PYSNMP_MODULE_ID=ospf, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, BigMetric=BigMetric, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfHostTOS=ospfHostTOS, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfLsdbType=ospfLsdbType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrTable=ospfVirtNbrTable, ospfGroups=ospfGroups, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfTable=ospfIfTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfRxNewLsas=ospfRxNewLsas, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfGroup2=ospfIfGroup2, ospfInterArea=ospfInterArea, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfLsaCount=ospfIfLsaCount, ospfHostAreaID=ospfHostAreaID, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfEntry=ospfIfEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfDemandExtensions=ospfDemandExtensions, ospfAreaSummary=ospfAreaSummary, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, TOSType=TOSType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfHostIpAddress=ospfHostIpAddress, ospfIfEvents=ospfIfEvents, ospfIfIpAddress=ospfIfIpAddress, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubAreaId=ospfStubAreaId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfTOSSupport=ospfTOSSupport, ospfNbrEvents=ospfNbrEvents, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaId=ospfAreaId, ospfIfAreaId=ospfIfAreaId, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrGroup2=ospfNbrGroup2, ospfHostGroup2=ospfHostGroup2, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostTable=ospfHostTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfReferenceBandwidth=ospfReferenceBandwidth, AreaID=AreaID, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrArea=ospfVirtNbrArea, Metric=Metric, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLsdbTable=ospfLsdbTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbEntry=ospfLsdbEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAdminStat=ospfAdminStat)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfStubStatus=ospfStubStatus, ospfAreaRangeTable=ospfAreaRangeTable)
