...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfAuthType=ospfIfAuthType, ospfHostTable=ospfHostTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaRangeTable=ospfAreaRangeTable, ospfStubAreaTable=ospfStubAreaTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfDemand=ospfIfDemand, ospfHostAreaID=ospfHostAreaID, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfOriginateNewLsas=ospfOriginateNewLsas, UpToMaxAge=UpToMaxAge, ospfInterArea=ospfInterArea, ospfLsdbLsid=ospfLsdbLsid, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, OspfAuthenticationType=OspfAuthenticationType, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaLsaCount=ospfAreaLsaCount, ospfStubAreaId=ospfStubAreaId, ospfBasicGroup=ospfBasicGroup, ospfNbrGroup=ospfNbrGroup, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfGroups=ospfGroups, ospfHostTOS=ospfHostTOS, ospfSpfRuns=ospfSpfRuns, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAuthType=ospfAuthType, ospfIntraArea=ospfIntraArea, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfStubMetric=ospfStubMetric, ospfIfStatus=ospfIfStatus, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfHostIpAddress=ospfHostIpAddress, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfGeneralGroup=ospfGeneralGroup, ospfConformance=ospfConformance, ospfHostStatus=ospfHostStatus, ospfNbrPriority=ospfNbrPriority, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfCompliance2=ospfCompliance2, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfMetricTOS=ospfIfMetricTOS, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfGroup=ospfVirtIfGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostMetric=ospfHostMetric, ospfIfMulticastForwarding=ospfIfMulticastForwarding, RouterID=RouterID, ospfIfAdminStat=ospfIfAdminStat, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfAreaId=ospfIfAreaId, ospfRestartAge=ospfRestartAge, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfPollInterval=ospfIfPollInterval, ospfNbrGroup2=ospfNbrGroup2, ospfIfTable=ospfIfTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExternalType2=ospfExternalType2, ospfAsLsdbAge=ospfAsLsdbAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfIpAddress=ospfIfIpAddress, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricStatus=ospfIfMetricStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, Status=Status, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVersionNumber=ospfVersionNumber, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfMetricTable=ospfIfMetricTable, ospfIfState=ospfIfState, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfBasicGroup2=ospfBasicGroup2, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfDemandExtensions=ospfDemandExtensions, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfStatus=ospfVirtIfStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLsdbType=ospfLsdbType, ospfImportAsExtern=ospfImportAsExtern, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfTable=ospfVirtIfTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfTOSSupport=ospfTOSSupport, ospfIfAuthKey=ospfIfAuthKey, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfExternalType1=ospfExternalType1, ospfRestartSupport=ospfRestartSupport, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfGroup=ospfIfGroup, ospfRxNewLsas=ospfRxNewLsas, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, TOSType=TOSType, ospfRouterId=ospfRouterId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfGroup2=ospfIfGroup2, AreaID=AreaID, ospfIfEvents=ospfIfEvents, ospfCompliance=ospfCompliance, ospfRestartInterval=ospfRestartInterval, ospfNbrTable=ospfNbrTable, ospfAreaStatus=ospfAreaStatus, ospfNbrOptions=ospfNbrOptions, ospfAddressLessIf=ospfAddressLessIf, ospfStubTOS=ospfStubTOS, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaId=ospfAreaId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfState=ospfVirtIfState, ospfComplianceObsolete=ospfComplianceObsolete, ospfCompliances=ospfCompliances, Metric=Metric, ospfAreaGroup2=ospfAreaGroup2, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaEntry=ospfAreaEntry, ospfIfMetricValue=ospfIfMetricValue, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, HelloRange=HelloRange, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospf=ospf, ospfVirtIfEvents=ospfVirtIfEvents, ospfHostGroup2=ospfHostGroup2, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaTable=ospfAreaTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubAreaEntry=ospfStubAreaEntry, ospfStubMetricType=ospfStubMetricType, ospfNbrState=ospfNbrState, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfEntry=ospfIfEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfType=ospfIfType, ospfStubStatus=ospfStubStatus, ospfHostEntry=ospfHostEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfLsaCount=ospfIfLsaCount, ospfAdminStat=ospfAdminStat, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrState=ospfVirtNbrState, ospfNbrEvents=ospfNbrEvents, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRestartStatus=ospfRestartStatus, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaSummary=ospfAreaSummary, ospfHostGroup=ospfHostGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrRtrId=ospfNbrRtrId, BigMetric=BigMetric, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbGroup=ospfLsdbGroup, ospfLsdbAge=ospfLsdbAge, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfHelloInterval=ospfIfHelloInterval, PYSNMP_MODULE_ID=ospf, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, PositiveInteger=PositiveInteger, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExternLsaCount=ospfExternLsaCount, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId)
mibBuilder.exportSymbols("OSPF-MIB", ospfRouteGroup=ospfRouteGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbGroup=ospfAsLsdbGroup)
