...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfStatus=ospfIfStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfHelloInterval=ospfIfHelloInterval, ospfRestartAge=ospfRestartAge, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrState=ospfNbrState, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLsdbGroup=ospfLsdbGroup, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfStubMetric=ospfStubMetric, ospfSpfRuns=ospfSpfRuns, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, BigMetric=BigMetric, PYSNMP_MODULE_ID=ospf, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostTable=ospfHostTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfCompliances=ospfCompliances, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubAreaId=ospfStubAreaId, ospfVersionNumber=ospfVersionNumber, ospfLsdbEntry=ospfLsdbEntry, AreaID=AreaID, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfHostGroup=ospfHostGroup, ospfIfEvents=ospfIfEvents, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExternalType2=ospfExternalType2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfState=ospfVirtIfState, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfTable=ospfIfTable, ospfIfAuthKey=ospfIfAuthKey, ospfAsLsdbTable=ospfAsLsdbTable, ospfRouteGroup=ospfRouteGroup, ospfStubTOS=ospfStubTOS, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaStatus=ospfAreaStatus, ospfIfMetricValue=ospfIfMetricValue, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbType=ospfExtLsdbType, ospfNbrOptions=ospfNbrOptions, ospfHostEntry=ospfHostEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfConformance=ospfConformance, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrEvents=ospfNbrEvents, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfImportAsExtern=ospfImportAsExtern, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, RouterID=RouterID, PositiveInteger=PositiveInteger, ospfLsdbRouterId=ospfLsdbRouterId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIntraArea=ospfIntraArea, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaRangeGroup=ospfAreaRangeGroup, TOSType=TOSType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfGeneralGroup=ospfGeneralGroup, ospfLsdbType=ospfLsdbType, Metric=Metric, ospfLsdbSequence=ospfLsdbSequence, ospfCompliance2=ospfCompliance2, ospfRestartSupport=ospfRestartSupport, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfIpAddress=ospfIfIpAddress, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfCompliance=ospfCompliance, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfStubAreaGroup=ospfStubAreaGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, Status=Status, ospfExternalType1=ospfExternalType1, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrGroup2=ospfNbrGroup2, ospfAuthType=ospfAuthType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfStubAreaTable=ospfStubAreaTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfAdminStat=ospfIfAdminStat, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostTOS=ospfHostTOS, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfStubMetricType=ospfStubMetricType, ospfIfRetransInterval=ospfIfRetransInterval, ospfExtLsdbTable=ospfExtLsdbTable, OspfAuthenticationType=OspfAuthenticationType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostAreaID=ospfHostAreaID, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaSummary=ospfAreaSummary, ospf=ospf, ospfIfGroup2=ospfIfGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRestartInterval=ospfRestartInterval, ospfNbrTable=ospfNbrTable, ospfHostGroup2=ospfHostGroup2, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrEntry=ospfNbrEntry, ospfIfEntry=ospfIfEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrState=ospfVirtNbrState, ospfAsLsaCount=ospfAsLsaCount, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrPriority=ospfNbrPriority, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfGroups=ospfGroups, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostIpAddress=ospfHostIpAddress, UpToMaxAge=UpToMaxAge, ospfRouterId=ospfRouterId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRestartStatus=ospfRestartStatus, ospfHostStatus=ospfHostStatus, ospfInterArea=ospfInterArea, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfMetricTable=ospfIfMetricTable, ospfHostMetric=ospfHostMetric, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfStubStatus=ospfStubStatus, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfType=ospfIfType, ospfBasicGroup2=ospfBasicGroup2, ospfAreaId=ospfAreaId, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrGroup=ospfNbrGroup, ospfIfState=ospfIfState, ospfRestartExitReason=ospfRestartExitReason, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfAuthType=ospfIfAuthType, ospfAreaTable=ospfAreaTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfLsdbTable=ospfLsdbTable, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfRxNewLsas=ospfRxNewLsas, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaEntry=ospfAreaEntry, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExtLsdbAge=ospfExtLsdbAge, HelloRange=HelloRange, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfDemandExtensions=ospfDemandExtensions, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAdminStat=ospfAdminStat, ospfLsdbAge=ospfLsdbAge, ospfAsLsdbType=ospfAsLsdbType, ospfAreaGroup=ospfAreaGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaGroup2=ospfAreaGroup2, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfDemand=ospfIfDemand)
