...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrIpAddr=ospfNbrIpAddr, ospfSpfRuns=ospfSpfRuns, ospfNbrEntry=ospfNbrEntry, ospfLsdbType=ospfLsdbType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLsdbGroup=ospfLsdbGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfHostEntry=ospfHostEntry, PYSNMP_MODULE_ID=ospf, ospfIfMetricEntry=ospfIfMetricEntry, ospfStubAreaTable=ospfStubAreaTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbEntry=ospfLsdbEntry, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfImportAsExtern=ospfImportAsExtern, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfGroups=ospfGroups, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfStatus=ospfIfStatus, ospfAsLsaCount=ospfAsLsaCount, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRouterId=ospfRouterId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfGroup=ospfIfGroup, ospfHostMetric=ospfHostMetric, Status=Status, ospfTOSSupport=ospfTOSSupport, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaRangeStatus=ospfAreaRangeStatus, PositiveInteger=PositiveInteger, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrState=ospfNbrState, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrPriority=ospfNbrPriority, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfLsaCount=ospfIfLsaCount, ospfStubStatus=ospfStubStatus, ospfGeneralGroup=ospfGeneralGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfType=ospfIfType, TOSType=TOSType, ospfIfTransitDelay=ospfIfTransitDelay, ospfConformance=ospfConformance, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostAreaID=ospfHostAreaID, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMetricValue=ospfIfMetricValue, RouterID=RouterID, ospfInterArea=ospfInterArea, ospfNbrEvents=ospfNbrEvents, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostTable=ospfHostTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrGroup2=ospfNbrGroup2, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExtLsdbType=ospfExtLsdbType, ospfRestartExitReason=ospfRestartExitReason, OspfAuthenticationType=OspfAuthenticationType, ospfStubMetricType=ospfStubMetricType, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExternLsaCount=ospfExternLsaCount, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfIpAddress=ospfIfIpAddress, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostTOS=ospfHostTOS, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfCompliance2=ospfCompliance2, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaStatus=ospfAreaStatus, ospfVirtNbrState=ospfVirtNbrState, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfRestartAge=ospfRestartAge, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAsLsdbType=ospfAsLsdbType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfRxNewLsas=ospfRxNewLsas, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbSequence=ospfLsdbSequence, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfCompliances=ospfCompliances, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaRangeTable=ospfAreaRangeTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfState=ospfVirtIfState, ospfRestartSupport=ospfRestartSupport, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaGroup=ospfAreaGroup, ospfAreaTable=ospfAreaTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfBasicGroup2=ospfBasicGroup2, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfStubAreaId=ospfStubAreaId, AreaID=AreaID, ospfHostGroup2=ospfHostGroup2, ospfVersionNumber=ospfVersionNumber, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfState=ospfIfState, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLsdbRouterId=ospfLsdbRouterId, BigMetric=BigMetric, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfBasicGroup=ospfBasicGroup, ospfStubTOS=ospfStubTOS, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubMetric=ospfStubMetric, ospfHostIpAddress=ospfHostIpAddress, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfEvents=ospfIfEvents, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaSummary=ospfAreaSummary, ospfNbrTable=ospfNbrTable, ospfAreaId=ospfAreaId, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfEntry=ospfIfEntry, ospfIfDemand=ospfIfDemand, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfCompliance=ospfCompliance, ospfAuthType=ospfAuthType, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExternalType2=ospfExternalType2, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfGroup2=ospfIfGroup2, ospfHostStatus=ospfHostStatus, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfRestartStatus=ospfRestartStatus, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbTable=ospfLocalLsdbTable, Metric=Metric, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAdminStat=ospfAdminStat, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospf=ospf, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbAge=ospfLsdbAge, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfMulticastExtensions=ospfMulticastExtensions, ospfDemandExtensions=ospfDemandExtensions, ospfLocalLsdbSequence=ospfLocalLsdbSequence, HelloRange=HelloRange, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLsdbTable=ospfLsdbTable, ospfRestartInterval=ospfRestartInterval, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfTable=ospfVirtIfTable, ospfAreaGroup2=ospfAreaGroup2, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfMetricTable=ospfIfMetricTable, ospfHostGroup=ospfHostGroup, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfTable=ospfIfTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfAdminStat=ospfIfAdminStat, ospfASBdrRtrStatus=ospfASBdrRtrStatus, UpToMaxAge=UpToMaxAge, ospfNbrOptions=ospfNbrOptions, ospfRouteGroup=ospfRouteGroup, ospfExternalType1=ospfExternalType1, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIntraArea=ospfIntraArea, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtIfGroup=ospfVirtIfGroup, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMetricGroup=ospfIfMetricGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfPollInterval=ospfIfPollInterval, ospfLsdbLsid=ospfLsdbLsid)
