...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbAge=ospfExtLsdbAge, ospfRestartInterval=ospfRestartInterval, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfStatus=ospfIfStatus, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrEntry=ospfNbrEntry, ospfIfIpAddress=ospfIfIpAddress, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, RouterID=RouterID, AreaID=AreaID, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrRtrId=ospfNbrRtrId, ospfExternalType1=ospfExternalType1, ospfIfAuthType=ospfIfAuthType, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtIfTable=ospfVirtIfTable, ospfCompliance2=ospfCompliance2, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubAreaEntry=ospfStubAreaEntry, ospfStubMetric=ospfStubMetric, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostAreaID=ospfHostAreaID, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrTable=ospfNbrTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAsLsdbTable=ospfAsLsdbTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaSummary=ospfAreaSummary, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfImportAsExtern=ospfImportAsExtern, ospfAreaRangeNet=ospfAreaRangeNet, ospfLsdbGroup=ospfLsdbGroup, ospfIntraArea=ospfIntraArea, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, TOSType=TOSType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfTable=ospfIfTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfDemand=ospfIfDemand, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfNbrGroup=ospfNbrGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfAuthKey=ospfIfAuthKey, ospfBasicGroup2=ospfBasicGroup2, ospfRouterId=ospfRouterId, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostTOS=ospfHostTOS, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, Status=Status, ospfIfMetricTOS=ospfIfMetricTOS, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbTable=ospfLsdbTable, ospfHostGroup2=ospfHostGroup2, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaRangeEntry=ospfAreaRangeEntry, ospf=ospf, ospfVirtNbrState=ospfVirtNbrState, ospfLsdbAge=ospfLsdbAge, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostGroup=ospfHostGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsaCount=ospfAsLsaCount, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfIfRetransInterval=ospfIfRetransInterval, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostIpAddress=ospfHostIpAddress, ospfComplianceObsolete=ospfComplianceObsolete, HelloRange=HelloRange, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtIfState=ospfVirtIfState, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, BigMetric=BigMetric, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfRestartExitReason=ospfRestartExitReason, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfRestartStatus=ospfRestartStatus, ospfIfGroup=ospfIfGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfSpfRuns=ospfSpfRuns, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfHostEntry=ospfHostEntry, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfEntry=ospfIfEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbType=ospfLocalLsdbType, UpToMaxAge=UpToMaxAge, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaRangeMask=ospfAreaRangeMask, ospfStubTOS=ospfStubTOS, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbSequence=ospfLocalLsdbSequence, Metric=Metric, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfTOSSupport=ospfTOSSupport, ospfNbrState=ospfNbrState, ospfLsdbType=ospfLsdbType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaEntry=ospfAreaEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrEvents=ospfNbrEvents, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostMetric=ospfHostMetric, PositiveInteger=PositiveInteger, ospfStubAreaId=ospfStubAreaId, ospfStubStatus=ospfStubStatus, ospfIfEvents=ospfIfEvents, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExternalType2=ospfExternalType2, ospfCompliances=ospfCompliances, ospfNbrPriority=ospfNbrPriority, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfCompliance=ospfCompliance, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRxNewLsas=ospfRxNewLsas, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfGroup2=ospfIfGroup2, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostTable=ospfHostTable, PYSNMP_MODULE_ID=ospf, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfPollInterval=ospfIfPollInterval, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfRestartAge=ospfRestartAge, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaGroup=ospfAreaGroup, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbLsid=ospfLsdbLsid, ospfIfState=ospfIfState, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfGroups=ospfGroups, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaTable=ospfAreaTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbType=ospfExtLsdbType, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaStatus=ospfAreaStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfStubRouterSupport=ospfStubRouterSupport, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLsdbRouterId=ospfLsdbRouterId, OspfAuthenticationType=OspfAuthenticationType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfInterArea=ospfInterArea, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfType=ospfIfType, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostStatus=ospfHostStatus, ospfIfAreaId=ospfIfAreaId, ospfAuthType=ospfAuthType, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfRestartSupport=ospfRestartSupport, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubMetricType=ospfStubMetricType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfConformance=ospfConformance, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVersionNumber=ospfVersionNumber, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbRouterId=ospfAsLsdbRouterId, DesignatedRouterPriority=DesignatedRouterPriority, ospfBasicGroup=ospfBasicGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbAge=ospfAsLsdbAge, ospfAdminStat=ospfAdminStat, ospfIfAdminStat=ospfIfAdminStat, ospfAreaId=ospfAreaId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLsdbAreaId=ospfLsdbAreaId, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfGroup2=ospfVirtIfGroup2)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfTransitDelay=ospfIfTransitDelay, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect)
