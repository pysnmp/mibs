...
mibBuilder.exportSymbols("OSPF-MIB", ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaGroup=ospfAreaGroup, ospfRestartStatus=ospfRestartStatus, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfHostGroup2=ospfHostGroup2, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfHostEntry=ospfHostEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfRestartExitReason=ospfRestartExitReason, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLsdbAreaId=ospfLsdbAreaId, Status=Status, ospfNbrOptions=ospfNbrOptions, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfBasicGroup2=ospfBasicGroup2, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostMetric=ospfHostMetric, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbChecksum=ospfLsdbChecksum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLsdbType=ospfLsdbType, ospfIfGroup=ospfIfGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfInterArea=ospfInterArea, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfTransitDelay=ospfIfTransitDelay, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrEntry=ospfNbrEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, RouterID=RouterID, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAsLsdbAge=ospfAsLsdbAge, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfBasicGroup=ospfBasicGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfStubMetricType=ospfStubMetricType, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfCompliance=ospfCompliance, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVersionNumber=ospfVersionNumber, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfRouteGroup=ospfRouteGroup, ospfCompliance2=ospfCompliance2, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfAuthKey=ospfIfAuthKey, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfTable=ospfIfTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfIpAddress=ospfIfIpAddress, ospfLocalLsdbAge=ospfLocalLsdbAge, UpToMaxAge=UpToMaxAge, ospfHostTOS=ospfHostTOS, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfMetricTable=ospfIfMetricTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfLsdbEntry=ospfLsdbEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfEntry=ospfIfEntry, ospfCompliances=ospfCompliances, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfTOSSupport=ospfTOSSupport, ospfIfDemand=ospfIfDemand, ospfIfState=ospfIfState, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRestartInterval=ospfRestartInterval, ospfAsLsaCount=ospfAsLsaCount, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExtLsdbType=ospfExtLsdbType, ospfHostTable=ospfHostTable, TOSType=TOSType, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfExternLsaCount=ospfExternLsaCount, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIntraArea=ospfIntraArea, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfNbrTable=ospfNbrTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfGroups=ospfGroups, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaSummary=ospfAreaSummary, ospfIfType=ospfIfType, ospfAsLsdbType=ospfAsLsdbType, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, BigMetric=BigMetric, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbLsid=ospfLsdbLsid, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaStatus=ospfAreaStatus, ospfIfGroup2=ospfIfGroup2, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrPriority=ospfNbrPriority, ospfLsdbAge=ospfLsdbAge, ospfAreaId=ospfAreaId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaRangeEntry=ospfAreaRangeEntry, PYSNMP_MODULE_ID=ospf, ospfStubStatus=ospfStubStatus, ospfStubTOS=ospfStubTOS, ospfHostGroup=ospfHostGroup, ospfNbrGroup2=ospfNbrGroup2, ospfExternalType2=ospfExternalType2, ospfAuthType=ospfAuthType, ospfAdminStat=ospfAdminStat, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, OspfAuthenticationType=OspfAuthenticationType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, AreaID=AreaID, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrState=ospfNbrState, ospfHostStatus=ospfHostStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfStatus=ospfIfStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfAdminStat=ospfIfAdminStat, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaEntry=ospfAreaEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfMetricValue=ospfIfMetricValue, ospfAreaAggregateTable=ospfAreaAggregateTable, HelloRange=HelloRange, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfConformance=ospfConformance, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostIpAddress=ospfHostIpAddress, ospfLsdbTable=ospfLsdbTable, ospfAreaGroup2=ospfAreaGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfRetransInterval=ospfIfRetransInterval, ospfRestartSupport=ospfRestartSupport, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, PositiveInteger=PositiveInteger, ospfRouterId=ospfRouterId, ospfIfEvents=ospfIfEvents, ospfAddressLessIf=ospfAddressLessIf, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaRangeTable=ospfAreaRangeTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfRxNewLsas=ospfRxNewLsas, ospfAreaTable=ospfAreaTable, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospf=ospf, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfStubMetric=ospfStubMetric, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfRestartAge=ospfRestartAge, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfAreaId=ospfIfAreaId, ospfIfMetricStatus=ospfIfMetricStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbSequence=ospfLsdbSequence, ospfStubAreaTable=ospfStubAreaTable, Metric=Metric, ospfIfLsaCount=ospfIfLsaCount)
