...
mibBuilder.exportSymbols("OSPF-MIB", ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbType=ospfExtLsdbType, ospfAdminStat=ospfAdminStat, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaStatus=ospfAreaStatus, ospfStubAreaGroup=ospfStubAreaGroup, ospfRestartExitReason=ospfRestartExitReason, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVersionNumber=ospfVersionNumber, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExternalType2=ospfExternalType2, ospfNbrPriority=ospfNbrPriority, ospfHostGroup=ospfHostGroup, ospfIfLsaCount=ospfIfLsaCount, ospfAreaGroup2=ospfAreaGroup2, ospfHostEntry=ospfHostEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaEntry=ospfAreaEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfAuthType=ospfIfAuthType, ospfIfAreaId=ospfIfAreaId, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfStubTOS=ospfStubTOS, ospfSpfRuns=ospfSpfRuns, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfEntry=ospfIfEntry, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaGroup=ospfAreaGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostMetric=ospfHostMetric, ospfIfMetricStatus=ospfIfMetricStatus, ospfLsdbSequence=ospfLsdbSequence, ospfHostAreaID=ospfHostAreaID, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfRestartInterval=ospfRestartInterval, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfBasicGroup2=ospfBasicGroup2, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfRouterId=ospfRouterId, BigMetric=BigMetric, Metric=Metric, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLsdbLsid=ospfLsdbLsid, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfGeneralGroup=ospfGeneralGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbAge=ospfAsLsdbAge, ospfTOSSupport=ospfTOSSupport, ospfStubMetricType=ospfStubMetricType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfMetricValue=ospfIfMetricValue, ospfIfType=ospfIfType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfStubMetric=ospfStubMetric, ospfIfEvents=ospfIfEvents, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfStubStatus=ospfStubStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfRestartSupport=ospfRestartSupport, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrEvents=ospfNbrEvents, ospfRestartAge=ospfRestartAge, ospfInterArea=ospfInterArea, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfCompliances=ospfCompliances, ospfBasicGroup=ospfBasicGroup, ospfRestartStatus=ospfRestartStatus, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbGroup=ospfLsdbGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAsLsdbType=ospfAsLsdbType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfTable=ospfVirtIfTable, ospfGroups=ospfGroups, ospfNbrGroup2=ospfNbrGroup2, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrGroup=ospfNbrGroup, ospfNbrTable=ospfNbrTable, ospfIfIpAddress=ospfIfIpAddress, ospfIfState=ospfIfState, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfCompliance2=ospfCompliance2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfTable=ospfIfTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAuthType=ospfAuthType, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfRetransInterval=ospfIfRetransInterval, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfHostTable=ospfHostTable, ospfAddressLessIf=ospfAddressLessIf, ospfIfAdminStat=ospfIfAdminStat, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaId=ospfAreaId, ospfLsdbEntry=ospfLsdbEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfRxNewLsas=ospfRxNewLsas, ospfAreaTable=ospfAreaTable, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfCompliance=ospfCompliance, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfMetricGroup=ospfIfMetricGroup, ospfHostIpAddress=ospfHostIpAddress, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfHostGroup2=ospfHostGroup2, ospfLsdbType=ospfLsdbType, ospf=ospf, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, Status=Status, ospfIfAuthKey=ospfIfAuthKey, RouterID=RouterID, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, HelloRange=HelloRange, TOSType=TOSType, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrState=ospfNbrState, OspfAuthenticationType=OspfAuthenticationType, AreaID=AreaID, UpToMaxAge=UpToMaxAge, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfRtrPriority=ospfIfRtrPriority, PYSNMP_MODULE_ID=ospf, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAsLsaCount=ospfAsLsaCount, ospfMulticastExtensions=ospfMulticastExtensions, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbTable=ospfAsLsdbTable, ospfStubAreaId=ospfStubAreaId, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIntraArea=ospfIntraArea, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfComplianceObsolete=ospfComplianceObsolete, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfHostTOS=ospfHostTOS, ospfExternalType1=ospfExternalType1, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfDemand=ospfIfDemand, ospfNbrOptions=ospfNbrOptions, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, PositiveInteger=PositiveInteger, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfHostStatus=ospfHostStatus, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaRangeMask=ospfAreaRangeMask, ospfImportAsExtern=ospfImportAsExtern, ospfStubAreaTable=ospfStubAreaTable, ospfConformance=ospfConformance, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExtLsdbSequence=ospfExtLsdbSequence, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfGroup2=ospfIfGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaSummary=ospfAreaSummary, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfGroup=ospfIfGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfPollInterval=ospfIfPollInterval)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfStatus=ospfIfStatus, ospfIfMetricTable=ospfIfMetricTable, ospfExtLsdbLimit=ospfExtLsdbLimit)
