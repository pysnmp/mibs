...
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbAge=ospfExtLsdbAge, ospfRestartStatus=ospfRestartStatus, ospfStubMetric=ospfStubMetric, ospfExtLsdbEntry=ospfExtLsdbEntry, PositiveInteger=PositiveInteger, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrGroup=ospfNbrGroup, RouterID=RouterID, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaSummary=ospfAreaSummary, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfTOSSupport=ospfTOSSupport, ospfRestartAge=ospfRestartAge, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIntraArea=ospfIntraArea, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfHostTable=ospfHostTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubTOS=ospfStubTOS, ospfComplianceObsolete=ospfComplianceObsolete, BigMetric=BigMetric, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfEvents=ospfIfEvents, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExternalType1=ospfExternalType1, ospfLsdbRouterId=ospfLsdbRouterId, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfEntry=ospfIfEntry, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, PYSNMP_MODULE_ID=ospf, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfAuthKey=ospfIfAuthKey, ospfLsdbType=ospfLsdbType, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfGroups=ospfGroups, ospfHostIpAddress=ospfHostIpAddress, ospfNbrRtrId=ospfNbrRtrId, ospfImportAsExtern=ospfImportAsExtern, ospfIfAdminStat=ospfIfAdminStat, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfLsaCount=ospfIfLsaCount, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostGroup2=ospfHostGroup2, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubStatus=ospfStubStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfDemandExtensions=ospfDemandExtensions, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExtLsdbType=ospfExtLsdbType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfType=ospfIfType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostGroup=ospfHostGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfCompliances=ospfCompliances, ospfIfStatus=ospfIfStatus, ospfStubAreaGroup=ospfStubAreaGroup, ospfExternalType2=ospfExternalType2, ospfVirtIfState=ospfVirtIfState, ospfCompliance=ospfCompliance, ospfLsdbAreaId=ospfLsdbAreaId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfState=ospfIfState, ospfRestartSupport=ospfRestartSupport, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaId=ospfAreaId, ospfIfMetricValue=ospfIfMetricValue, ospfIfAuthType=ospfIfAuthType, ospfNbrGroup2=ospfNbrGroup2, AreaID=AreaID, ospfHostStatus=ospfHostStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfRestartInterval=ospfRestartInterval, ospfRouterId=ospfRouterId, ospfAreaEntry=ospfAreaEntry, ospfIfGroup2=ospfIfGroup2, ospfNbrPriority=ospfNbrPriority, HelloRange=HelloRange, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfConformance=ospfConformance, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfHostEntry=ospfHostEntry, OspfAuthenticationType=OspfAuthenticationType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfBasicGroup=ospfBasicGroup, ospfAdminStat=ospfAdminStat, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfCompliance2=ospfCompliance2, ospfIfGroup=ospfIfGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfRetransInterval=ospfIfRetransInterval, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLsdbTable=ospfLsdbTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrEntry=ospfNbrEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAddressLessIf=ospfAddressLessIf, TOSType=TOSType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRouteGroup=ospfRouteGroup, ospfHostAreaID=ospfHostAreaID, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfNbrIpAddr=ospfNbrIpAddr, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaStatus=ospfAreaStatus, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbGroup=ospfLsdbGroup, ospfVirtIfTable=ospfVirtIfTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrState=ospfNbrState, ospf=ospf, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfMetricTable=ospfIfMetricTable, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfTable=ospfIfTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfMulticastExtensions=ospfMulticastExtensions, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrTable=ospfNbrTable, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfDemand=ospfIfDemand, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, UpToMaxAge=UpToMaxAge, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVersionNumber=ospfVersionNumber, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, Metric=Metric, ospfLsdbSequence=ospfLsdbSequence, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfHostMetric=ospfHostMetric, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRxNewLsas=ospfRxNewLsas, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaGroup=ospfAreaGroup, ospfIfAreaId=ospfIfAreaId, Status=Status, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfInterArea=ospfInterArea, ospfAsLsaCount=ospfAsLsaCount, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaTable=ospfAreaTable, ospfLsdbAge=ospfLsdbAge, ospfAsLsdbType=ospfAsLsdbType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAuthType=ospfAuthType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrState=ospfVirtNbrState, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostTOS=ospfHostTOS, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfStubMetricType=ospfStubMetricType, ospfExternLsaCount=ospfExternLsaCount, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrOptions=ospfNbrOptions, ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbLsid=ospfLsdbLsid, ospfIfIpAddress=ospfIfIpAddress)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfMetricIpAddress=ospfIfMetricIpAddress)
