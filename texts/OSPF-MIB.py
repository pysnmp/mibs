...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfLsaCount=ospfIfLsaCount, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfConformance=ospfConformance, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfStubAreaTable=ospfStubAreaTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfGroups=ospfGroups, ospfVirtIfState=ospfVirtIfState, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfNbrGroup2=ospfNbrGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfCompliance2=ospfCompliance2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaId=ospfAreaId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVersionNumber=ospfVersionNumber, ospfRestartExitReason=ospfRestartExitReason, UpToMaxAge=UpToMaxAge, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfHostTOS=ospfHostTOS, ospfIfAuthType=ospfIfAuthType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostEntry=ospfHostEntry, ospfRFC1583Compatibility=ospfRFC1583Compatibility, PYSNMP_MODULE_ID=ospf, ospfCompliance=ospfCompliance, Metric=Metric, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfEntry=ospfVirtIfEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, TOSType=TOSType, ospfIfMetricTable=ospfIfMetricTable, ospfNbrPriority=ospfNbrPriority, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, BigMetric=BigMetric, ospfIfIpAddress=ospfIfIpAddress, ospfHostTable=ospfHostTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfHostStatus=ospfHostStatus, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRouterId=ospfRouterId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfTable=ospfIfTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfGroup=ospfIfGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaStatus=ospfAreaStatus, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfSpfRuns=ospfSpfRuns, ospfAsLsdbType=ospfAsLsdbType, ospfTOSSupport=ospfTOSSupport, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfType=ospfIfType, ospfExternalType2=ospfExternalType2, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostGroup=ospfHostGroup, PositiveInteger=PositiveInteger, ospfHostMetric=ospfHostMetric, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaGroup=ospfAreaGroup, ospfNbrRtrId=ospfNbrRtrId, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRestartStatus=ospfRestartStatus, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrState=ospfNbrState, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, RouterID=RouterID, ospfNbrOptions=ospfNbrOptions, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfRestartInterval=ospfRestartInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfExternLsaCount=ospfExternLsaCount, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfRtrPriority=ospfIfRtrPriority, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLsdbGroup=ospfLsdbGroup, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfGroup2=ospfIfGroup2, ospfAreaEntry=ospfAreaEntry, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaGroup2=ospfAreaGroup2, ospfHostGroup2=ospfHostGroup2, ospfAddressLessIf=ospfAddressLessIf, ospfBasicGroup2=ospfBasicGroup2, ospfAreaRangeMask=ospfAreaRangeMask, HelloRange=HelloRange, ospfRxNewLsas=ospfRxNewLsas, ospfInterArea=ospfInterArea, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfCompliances=ospfCompliances, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfStubTOS=ospfStubTOS, ospfNbrEvents=ospfNbrEvents, ospfStubAreaEntry=ospfStubAreaEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbAge=ospfExtLsdbAge, ospf=ospf, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLsdbType=ospfLsdbType, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfDemand=ospfIfDemand, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfRouteGroup=ospfRouteGroup, ospfStubAreaId=ospfStubAreaId, ospfStubAreaGroup=ospfStubAreaGroup, ospfBasicGroup=ospfBasicGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExternalType1=ospfExternalType1, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubMetricType=ospfStubMetricType, ospfLsdbChecksum=ospfLsdbChecksum, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfDemandExtensions=ospfDemandExtensions, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfState=ospfIfState, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfHostIpAddress=ospfHostIpAddress, ospfLsdbSequence=ospfLsdbSequence, ospfRestartSupport=ospfRestartSupport, ospfExtLsdbType=ospfExtLsdbType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLsdbEntry=ospfLsdbEntry, ospfAreaSummary=ospfAreaSummary, ospfLsdbTable=ospfLsdbTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrState=ospfVirtNbrState, ospfStubMetric=ospfStubMetric, ospfIfEntry=ospfIfEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfEvents=ospfIfEvents, ospfLocalLsdbSequence=ospfLocalLsdbSequence, Status=Status, ospfNbrTable=ospfNbrTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfStatus=ospfIfStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsLsaCount=ospfAsLsaCount, ospfAuthType=ospfAuthType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfRestartAge=ospfRestartAge, AreaID=AreaID, ospfAreaTable=ospfAreaTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfAreaId=ospfIfAreaId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfLsdbLsid=ospfLsdbLsid, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfGeneralGroup=ospfGeneralGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrIpAddr=ospfNbrIpAddr, OspfAuthenticationType=OspfAuthenticationType, ospfAdminStat=ospfAdminStat, ospfStubStatus=ospfStubStatus)
