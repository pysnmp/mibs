...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrOptions=ospfNbrOptions, ospfCompliance2=ospfCompliance2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfState=ospfIfState, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAsLsdbAge=ospfAsLsdbAge, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfAuthKey=ospfIfAuthKey, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfMetricGroup=ospfIfMetricGroup, ospfImportAsExtern=ospfImportAsExtern, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaRangeTable=ospfAreaRangeTable, Status=Status, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaStatus=ospfAreaStatus, ospfNbrRtrId=ospfNbrRtrId, ospfHostEntry=ospfHostEntry, ospfLsdbType=ospfLsdbType, ospfStubAreaEntry=ospfStubAreaEntry, ospfExtLsdbType=ospfExtLsdbType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfHostMetric=ospfHostMetric, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaId=ospfAreaId, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbAge=ospfExtLsdbAge, ospfTOSSupport=ospfTOSSupport, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIntraArea=ospfIntraArea, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfDemand=ospfIfDemand, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbGroup=ospfLsdbGroup, ospfAreaTable=ospfAreaTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrEvents=ospfNbrEvents, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrGroup2=ospfNbrGroup2, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbSequence=ospfLsdbSequence, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAuthType=ospfAuthType, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfRestartSupport=ospfRestartSupport, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartExitReason=ospfRestartExitReason, ospfIfGroup2=ospfIfGroup2, ospfCompliance=ospfCompliance, ospfRestartAge=ospfRestartAge, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfMetricTable=ospfIfMetricTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVersionNumber=ospfVersionNumber, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfState=ospfVirtIfState, ospfGroups=ospfGroups, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfRouterId=ospfRouterId, ospfRxNewLsas=ospfRxNewLsas, ospfVirtIfTable=ospfVirtIfTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfCompliances=ospfCompliances, ospfSpfRuns=ospfSpfRuns, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfInterArea=ospfInterArea, PositiveInteger=PositiveInteger, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaSummary=ospfAreaSummary, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrState=ospfNbrState, ospfVirtNbrState=ospfVirtNbrState, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfTable=ospfIfTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExternalType2=ospfExternalType2, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfGroup=ospfIfGroup, ospfIfAdminStat=ospfIfAdminStat, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostTable=ospfHostTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfStubTOS=ospfStubTOS, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfBasicGroup2=ospfBasicGroup2, ospfIfAuthType=ospfIfAuthType, ospfStubStatus=ospfStubStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfComplianceObsolete=ospfComplianceObsolete, RouterID=RouterID, AreaID=AreaID, ospfAsLsaCount=ospfAsLsaCount, ospfAdminStat=ospfAdminStat, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, BigMetric=BigMetric, ospfNbrGroup=ospfNbrGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfHostGroup2=ospfHostGroup2, ospfAddressLessIf=ospfAddressLessIf, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLsdbChecksum=ospfLsdbChecksum, ospfRestartInterval=ospfRestartInterval, ospfNbrPriority=ospfNbrPriority, ospfExternalType1=ospfExternalType1, ospfIfPollInterval=ospfIfPollInterval, ospfAreaEntry=ospfAreaEntry, ospfIfIpAddress=ospfIfIpAddress, ospfDemandExtensions=ospfDemandExtensions, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfEntry=ospfIfEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfStubMetricType=ospfStubMetricType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfEvents=ospfIfEvents, ospfExternLsaCount=ospfExternLsaCount, ospfStubAreaId=ospfStubAreaId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrEntry=ospfNbrEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLsdbLsid=ospfLsdbLsid, ospfHostAreaID=ospfHostAreaID, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfBasicGroup=ospfBasicGroup, ospfHostGroup=ospfHostGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaGroup2=ospfAreaGroup2, UpToMaxAge=UpToMaxAge, ospfExtLsdbLimit=ospfExtLsdbLimit, Metric=Metric, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLsdbTable=ospfLsdbTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrTable=ospfNbrTable, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfStatus=ospfIfStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricStatus=ospfIfMetricStatus, HelloRange=HelloRange, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbSequence=ospfAsLsdbSequence, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostTOS=ospfHostTOS, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubMetric=ospfStubMetric, ospfAsLsdbEntry=ospfAsLsdbEntry, TOSType=TOSType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfGeneralGroup=ospfGeneralGroup, ospfHostIpAddress=ospfHostIpAddress, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfConformance=ospfConformance, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfMetricTOS=ospfIfMetricTOS, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfHostStatus=ospfHostStatus, ospfVirtIfGroup=ospfVirtIfGroup, OspfAuthenticationType=OspfAuthenticationType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfAreaId=ospfIfAreaId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfType=ospfIfType, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospf=ospf, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbEntry=ospfLsdbEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfRouteGroup=ospfRouteGroup, PYSNMP_MODULE_ID=ospf, ospfLsdbAreaId=ospfLsdbAreaId, ospfRestartStatus=ospfRestartStatus)
