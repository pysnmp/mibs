...
mibBuilder.exportSymbols("OSPF-MIB", ospfIntraArea=ospfIntraArea, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfAdminStat=ospfIfAdminStat, ospfAreaId=ospfAreaId, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfAuthType=ospfIfAuthType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfHostTOS=ospfHostTOS, ospfInterArea=ospfInterArea, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMetricStatus=ospfIfMetricStatus, PYSNMP_MODULE_ID=ospf, ospfIfState=ospfIfState, ospfLsdbAdvertisement=ospfLsdbAdvertisement, Metric=Metric, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaStatus=ospfAreaStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrOptions=ospfVirtNbrOptions, DesignatedRouterPriority=DesignatedRouterPriority, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAuthType=ospfAuthType, ospfNbrGroup=ospfNbrGroup, ospfLsdbGroup=ospfLsdbGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, TOSType=TOSType, ospfNbrEvents=ospfNbrEvents, ospfIfAuthKey=ospfIfAuthKey, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, BigMetric=BigMetric, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, HelloRange=HelloRange, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfRetransInterval=ospfIfRetransInterval, ospfSpfRuns=ospfSpfRuns, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaGroup=ospfAreaGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfDemandExtensions=ospfDemandExtensions, ospfIfEntry=ospfIfEntry, ospfHostMetric=ospfHostMetric, ospfStubAreaGroup=ospfStubAreaGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfDemand=ospfIfDemand, ospfRestartStatus=ospfRestartStatus, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbAge=ospfLocalLsdbAge, ospf=ospf, ospfRouteGroup=ospfRouteGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, UpToMaxAge=UpToMaxAge, ospfStubAreaId=ospfStubAreaId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfCompliance2=ospfCompliance2, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbTable=ospfLsdbTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRxNewLsas=ospfRxNewLsas, ospfExternalType2=ospfExternalType2, AreaID=AreaID, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubAreaTable=ospfStubAreaTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfLsdbType=ospfLsdbType, ospfCompliance=ospfCompliance, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrOptions=ospfNbrOptions, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExternalType1=ospfExternalType1, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsaCount=ospfAsLsaCount, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrGroup2=ospfNbrGroup2, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaSummary=ospfAreaSummary, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfStubTOS=ospfStubTOS, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfTable=ospfIfTable, ospfTOSSupport=ospfTOSSupport, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfHostAreaID=ospfHostAreaID, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfStatus=ospfVirtIfStatus, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVersionNumber=ospfVersionNumber, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfGroup2=ospfIfGroup2, ospfStubStatus=ospfStubStatus, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrArea=ospfVirtNbrArea, ospfGeneralGroup=ospfGeneralGroup, ospfIfPollInterval=ospfIfPollInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfGroups=ospfGroups, ospfHostGroup2=ospfHostGroup2, ospfStubMetricType=ospfStubMetricType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfState=ospfVirtIfState, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrState=ospfVirtNbrState, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaTable=ospfAreaTable, ospfNbrState=ospfNbrState, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfEvents=ospfIfEvents, ospfNbrRtrId=ospfNbrRtrId, ospfAdminStat=ospfAdminStat, ospfIfType=ospfIfType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeAreaId=ospfAreaRangeAreaId, RouterID=RouterID, ospfCompliances=ospfCompliances, ospfIfGroup=ospfIfGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfMetricTOS=ospfIfMetricTOS, ospfLsdbEntry=ospfLsdbEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, OspfAuthenticationType=OspfAuthenticationType, ospfIfAreaId=ospfIfAreaId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfHostStatus=ospfHostStatus, ospfRestartInterval=ospfRestartInterval, ospfVirtIfTable=ospfVirtIfTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfConformance=ospfConformance, ospfRestartSupport=ospfRestartSupport, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfBasicGroup2=ospfBasicGroup2, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExternLsaCount=ospfExternLsaCount, ospfHostTable=ospfHostTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfHostEntry=ospfHostEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, Status=Status, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfRouterId=ospfRouterId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostIpAddress=ospfHostIpAddress, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfStatus=ospfIfStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsLsdbType=ospfAsLsdbType, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfIpAddress=ospfIfIpAddress, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfStubMetric=ospfStubMetric, ospfRestartAge=ospfRestartAge, ospfAsLsdbTable=ospfAsLsdbTable, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfHostGroup=ospfHostGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfAreaId=ospfVirtIfAreaId)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbAge=ospfLsdbAge, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfLsaCount=ospfIfLsaCount, PositiveInteger=PositiveInteger)
