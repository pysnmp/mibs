...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbrEvents=ospfNbrEvents, ospfDemandExtensions=ospfDemandExtensions, ospfIfIpAddress=ospfIfIpAddress, ospfNbrGroup=ospfNbrGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, UpToMaxAge=UpToMaxAge, ospfRestartInterval=ospfRestartInterval, ospfLsdbRouterId=ospfLsdbRouterId, ospfAddressLessIf=ospfAddressLessIf, ospfAuthType=ospfAuthType, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfHostAreaID=ospfHostAreaID, ospfConformance=ospfConformance, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfEvents=ospfVirtIfEvents, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaLsaCount=ospfAreaLsaCount, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, PYSNMP_MODULE_ID=ospf, ospfHostTOS=ospfHostTOS, ospfIfAuthKey=ospfIfAuthKey, ospfExtLsdbAge=ospfExtLsdbAge, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospf=ospf, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbLsid=ospfLsdbLsid, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrState=ospfNbrState, ospfHostIpAddress=ospfHostIpAddress, ospfBasicGroup=ospfBasicGroup, ospfAreaGroup2=ospfAreaGroup2, ospfIfAdminStat=ospfIfAdminStat, ospfIfAuthType=ospfIfAuthType, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaGroup=ospfAreaGroup, ospfIfState=ospfIfState, ospfIfTable=ospfIfTable, ospfLsdbAge=ospfLsdbAge, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubStatus=ospfStubStatus, ospfAreaId=ospfAreaId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfTransitDelay=ospfIfTransitDelay, ospfAdminStat=ospfAdminStat, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfStubMetric=ospfStubMetric, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIntraArea=ospfIntraArea, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfExternLsaCount=ospfExternLsaCount, ospfVersionNumber=ospfVersionNumber, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfAreaId=ospfIfAreaId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrRtrId=ospfNbrRtrId, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfRestartAge=ospfRestartAge, ospfIfRetransInterval=ospfIfRetransInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsaCount=ospfAsLsaCount, ospfExitOverflowInterval=ospfExitOverflowInterval, BigMetric=BigMetric, ospfVirtNbrState=ospfVirtNbrState, ospfExternalType2=ospfExternalType2, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfStubTOS=ospfStubTOS, ospfNbrOptions=ospfNbrOptions, Metric=Metric, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfCompliance2=ospfCompliance2, ospfRestartSupport=ospfRestartSupport, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfRouterId=ospfRouterId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfHostMetric=ospfHostMetric, ospfIfDemand=ospfIfDemand, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbTable=ospfLsdbTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostGroup=ospfHostGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfGeneralGroup=ospfGeneralGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfHostGroup2=ospfHostGroup2, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfRxNewLsas=ospfRxNewLsas, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfStatus=ospfIfStatus, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfRestartStatus=ospfRestartStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostTable=ospfHostTable, ospfHostEntry=ospfHostEntry, ospfNbrEntry=ospfNbrEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfExtLsdbType=ospfExtLsdbType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrArea=ospfVirtNbrArea, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfType=ospfIfType, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostStatus=ospfHostStatus, ospfNbrGroup2=ospfNbrGroup2, ospfAreaEntry=ospfAreaEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, RouterID=RouterID, ospfAsLsdbTable=ospfAsLsdbTable, OspfAuthenticationType=OspfAuthenticationType, ospfIfLsaCount=ospfIfLsaCount, ospfStubAreaTable=ospfStubAreaTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfMetricValue=ospfIfMetricValue, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfMetricEntry=ospfIfMetricEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfBasicGroup2=ospfBasicGroup2, ospfNbrPriority=ospfNbrPriority, ospfImportAsExtern=ospfImportAsExtern, ospfIfPollInterval=ospfIfPollInterval, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, TOSType=TOSType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfStubMetricType=ospfStubMetricType, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaTable=ospfAreaTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaRangeAreaId=ospfAreaRangeAreaId, PositiveInteger=PositiveInteger, ospfIfGroup2=ospfIfGroup2, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfMetricTable=ospfIfMetricTable, ospfIfEvents=ospfIfEvents, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRestartExitReason=ospfRestartExitReason, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, HelloRange=HelloRange, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfState=ospfVirtIfState, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLsdbGroup=ospfLsdbGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLsdbAreaId=ospfLsdbAreaId, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, AreaID=AreaID, ospfExternalType1=ospfExternalType1, ospfStubAreaEntry=ospfStubAreaEntry, ospfGroups=ospfGroups, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfStubAreaId=ospfStubAreaId, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbTable=ospfExtLsdbTable, ospfCompliance=ospfCompliance, Status=Status, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbType=ospfLsdbType, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaSummary=ospfAreaSummary, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfCompliances=ospfCompliances, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaStatus=ospfAreaStatus, ospfLsdbEntry=ospfLsdbEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateNet=ospfAreaAggregateNet)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfEntry=ospfIfEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType)
