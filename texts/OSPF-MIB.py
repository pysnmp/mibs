...
mibBuilder.exportSymbols("OSPF-MIB", Status=Status, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, TOSType=TOSType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExtLsdbTable=ospfExtLsdbTable, ospfCompliance2=ospfCompliance2, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, PositiveInteger=PositiveInteger, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfGroup=ospfVirtIfGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAsLsdbType=ospfAsLsdbType, ospfLsdbRouterId=ospfLsdbRouterId, ospfRestartSupport=ospfRestartSupport, ospfExternLsaCount=ospfExternLsaCount, ospfHostTOS=ospfHostTOS, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfState=ospfIfState, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfDemand=ospfIfDemand, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfGroup2=ospfIfGroup2, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfStubAreaTable=ospfStubAreaTable, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfRxNewLsas=ospfRxNewLsas, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, PYSNMP_MODULE_ID=ospf, RouterID=RouterID, ospfNbrTable=ospfNbrTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaId=ospfAreaId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfHelloInterval=ospfIfHelloInterval, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfEntry=ospfIfEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfMetricValue=ospfIfMetricValue, ospfNbrEntry=ospfNbrEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfTOSSupport=ospfTOSSupport, ospfImportAsExtern=ospfImportAsExtern, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfStatus=ospfIfStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfTable=ospfVirtIfTable, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLsdbType=ospfLsdbType, ospfLsdbGroup=ospfLsdbGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfType=ospfIfType, ospfRestartInterval=ospfRestartInterval, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfRestartStatus=ospfRestartStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfSpfRuns=ospfSpfRuns, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfState=ospfVirtIfState, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaLsaCountTable=ospfAreaLsaCountTable, BigMetric=BigMetric, ospfIfAuthType=ospfIfAuthType, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbAge=ospfLsdbAge, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrArea=ospfVirtNbrArea, Metric=Metric, ospfAreaEntry=ospfAreaEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrEvents=ospfNbrEvents, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsaCount=ospfAsLsaCount, ospfAsLsdbGroup=ospfAsLsdbGroup, ospf=ospf, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbTable=ospfLsdbTable, ospfNbrGroup=ospfNbrGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostStatus=ospfHostStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsaCksumSum=ospfAsLsaCksumSum, DesignatedRouterPriority=DesignatedRouterPriority, ospfAdminStat=ospfAdminStat, ospfLsdbSequence=ospfLsdbSequence, ospfIfTable=ospfIfTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfHostGroup2=ospfHostGroup2, ospfHostGroup=ospfHostGroup, ospfAreaSummary=ospfAreaSummary, ospfStubStatus=ospfStubStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfNbrState=ospfNbrState, ospfStubTOS=ospfStubTOS, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfRestartAge=ospfRestartAge, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExtLsdbAge=ospfExtLsdbAge, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfLsaCksumSum=ospfIfLsaCksumSum, HelloRange=HelloRange, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrState=ospfVirtNbrState, ospfAreaRangeMask=ospfAreaRangeMask, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVersionNumber=ospfVersionNumber, UpToMaxAge=UpToMaxAge, ospfIfEvents=ospfIfEvents, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLsdbEntry=ospfLsdbEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaTable=ospfAreaTable, ospfAreaStatus=ospfAreaStatus, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfConformance=ospfConformance, ospfDemandExtensions=ospfDemandExtensions, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfNbrPriority=ospfNbrPriority, ospfCompliances=ospfCompliances, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfGroups=ospfGroups, ospfIntraArea=ospfIntraArea, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfIpAddress=ospfIfIpAddress, ospfInterArea=ospfInterArea, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrOptions=ospfNbrOptions, ospfGeneralGroup=ospfGeneralGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAuthType=ospfAuthType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfTransitDelay=ospfIfTransitDelay, ospfLsdbLsid=ospfLsdbLsid, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfEvents=ospfVirtIfEvents, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaGroup=ospfAreaGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfAreaId=ospfIfAreaId, ospfIfGroup=ospfIfGroup, ospfRouteGroup=ospfRouteGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfCompliance=ospfCompliance, ospfStubAreaId=ospfStubAreaId, ospfHostEntry=ospfHostEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaGroup2=ospfAreaGroup2, ospfHostMetric=ospfHostMetric, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfRouterId=ospfRouterId, ospfStubMetric=ospfStubMetric, ospfNbrGroup2=ospfNbrGroup2, ospfExtLsdbEntry=ospfExtLsdbEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfExternalType1=ospfExternalType1, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostTable=ospfHostTable, AreaID=AreaID)
