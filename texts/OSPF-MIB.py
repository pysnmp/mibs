...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrState=ospfNbrState, ospfStubAreaTable=ospfStubAreaTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfHostGroup=ospfHostGroup, ospfAreaId=ospfAreaId, ospfAreaEntry=ospfAreaEntry, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrTable=ospfVirtNbrTable, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfTable=ospfVirtIfTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbSequence=ospfLsdbSequence, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfRestartStatus=ospfRestartStatus, ospfIfLsaCount=ospfIfLsaCount, ospfIfType=ospfIfType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrRtrId=ospfNbrRtrId, ospfIfHelloInterval=ospfIfHelloInterval, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExternalType1=ospfExternalType1, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfCompliance2=ospfCompliance2, ospfExtLsdbAge=ospfExtLsdbAge, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfStubMetricType=ospfStubMetricType, ospfIfDemand=ospfIfDemand, ospfBasicGroup=ospfBasicGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfMulticastExtensions=ospfMulticastExtensions, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfRxNewLsas=ospfRxNewLsas, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricStatus=ospfIfMetricStatus, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfInterArea=ospfInterArea, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrOptions=ospfNbrOptions, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfEvents=ospfVirtIfEvents, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfRouterId=ospfRouterId, ospfAuthType=ospfAuthType, AreaID=AreaID, ospfTOSSupport=ospfTOSSupport, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRouteGroup=ospfRouteGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfAdminStat=ospfIfAdminStat, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfGroup=ospfVirtIfGroup, BigMetric=BigMetric, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfStubTOS=ospfStubTOS, ospfStubAreaEntry=ospfStubAreaEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfHostGroup2=ospfHostGroup2, PositiveInteger=PositiveInteger, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfEvents=ospfIfEvents, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricTable=ospfIfMetricTable, ospfLsdbType=ospfLsdbType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfTable=ospfIfTable, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfStatus=ospfIfStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrPriority=ospfNbrPriority, ospfAsLsdbType=ospfAsLsdbType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAdminStat=ospfAdminStat, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrEntry=ospfNbrEntry, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExternalType2=ospfExternalType2, ospfSpfRuns=ospfSpfRuns, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfDemandExtensions=ospfDemandExtensions, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaSummary=ospfAreaSummary, ospfNbrEvents=ospfNbrEvents, Status=Status, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfHostMetric=ospfHostMetric, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfMetricValue=ospfIfMetricValue, ospfCompliance=ospfCompliance, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfTransitDelay=ospfIfTransitDelay, TOSType=TOSType, ospfExtLsdbType=ospfExtLsdbType, ospfIfAreaId=ospfIfAreaId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLsdbAge=ospfLsdbAge, ospfIfEntry=ospfIfEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfRestartAge=ospfRestartAge, ospfIfMetricEntry=ospfIfMetricEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaTable=ospfAreaTable, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfHostIpAddress=ospfHostIpAddress, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubMetric=ospfStubMetric, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostEntry=ospfHostEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfMetricGroup=ospfIfMetricGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfPollInterval=ospfIfPollInterval, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfCompliances=ospfCompliances, ospfAreaGroup2=ospfAreaGroup2, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospf=ospf, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbGroup=ospfLsdbGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubStatus=ospfStubStatus, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfState=ospfIfState, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfGroups=ospfGroups, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLsdbEntry=ospfLsdbEntry, ospfBasicGroup2=ospfBasicGroup2, RouterID=RouterID, ospfHostStatus=ospfHostStatus, ospfIfGroup=ospfIfGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, PYSNMP_MODULE_ID=ospf, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrGroup=ospfNbrGroup, ospfIfGroup2=ospfIfGroup2, HelloRange=HelloRange, ospfConformance=ospfConformance, ospfHostTOS=ospfHostTOS, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaStatus=ospfAreaStatus, ospfAreaRangeNet=ospfAreaRangeNet, ospfIntraArea=ospfIntraArea, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLsdbTable=ospfLsdbTable, ospfIfIpAddress=ospfIfIpAddress, ospfNbrGroup2=ospfNbrGroup2, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaGroup=ospfAreaGroup, ospfVersionNumber=ospfVersionNumber, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfHostTable=ospfHostTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfImportAsExtern=ospfImportAsExtern, ospfStubAreaId=ospfStubAreaId, ospfIfAuthKey=ospfIfAuthKey, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfRestartSupport=ospfRestartSupport, ospfLocalLsdbLsid=ospfLocalLsdbLsid, OspfAuthenticationType=OspfAuthenticationType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAsLsdbEntry=ospfAsLsdbEntry, Metric=Metric, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaRangeTable=ospfAreaRangeTable, UpToMaxAge=UpToMaxAge)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostAreaID=ospfHostAreaID, ospfVirtIfState=ospfVirtIfState)
