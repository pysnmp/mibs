...
mibBuilder.exportSymbols("OSPF-MIB", ospfHostStatus=ospfHostStatus, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfRouterId=ospfRouterId, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaTable=ospfAreaTable, ospfIfDemand=ospfIfDemand, ospfVirtIfState=ospfVirtIfState, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbTable=ospfExtLsdbTable, ospfInterArea=ospfInterArea, BigMetric=BigMetric, ospfStubAreaId=ospfStubAreaId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfHostTable=ospfHostTable, ospfStubMetricType=ospfStubMetricType, RouterID=RouterID, ospfStubMetric=ospfStubMetric, ospfLsdbAge=ospfLsdbAge, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLsdbLsid=ospfLsdbLsid, ospfIfGroup=ospfIfGroup, ospfNbrPriority=ospfNbrPriority, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfState=ospfIfState, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfStubAreaGroup=ospfStubAreaGroup, PositiveInteger=PositiveInteger, ospfExtLsdbAge=ospfExtLsdbAge, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, PYSNMP_MODULE_ID=ospf, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfLsaCount=ospfIfLsaCount, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExtLsdbType=ospfExtLsdbType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfGroup=ospfVirtIfGroup, ospfTOSSupport=ospfTOSSupport, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfHostTOS=ospfHostTOS, ospfHostGroup=ospfHostGroup, ospfAreaStatus=ospfAreaStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaGroup2=ospfAreaGroup2, UpToMaxAge=UpToMaxAge, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfTable=ospfIfTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrState=ospfVirtNbrState, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrEvents=ospfNbrEvents, ospfConformance=ospfConformance, ospfBasicGroup2=ospfBasicGroup2, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaRangeNet=ospfAreaRangeNet, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfHostMetric=ospfHostMetric, ospfIfAuthKey=ospfIfAuthKey, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfCompliance2=ospfCompliance2, ospfVirtIfTable=ospfVirtIfTable, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospf=ospf, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVersionNumber=ospfVersionNumber, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfDemandExtensions=ospfDemandExtensions, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, Status=Status, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfEvents=ospfIfEvents, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfEntry=ospfIfEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubTOS=ospfStubTOS, ospfNbrRtrId=ospfNbrRtrId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfMulticastExtensions=ospfMulticastExtensions, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfAreaId=ospfIfAreaId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfRestartInterval=ospfRestartInterval, ospfIfGroup2=ospfIfGroup2, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfBasicGroup=ospfBasicGroup, ospfLsdbType=ospfLsdbType, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfRouteGroup=ospfRouteGroup, ospfNbrGroup2=ospfNbrGroup2, ospfIfAdminStat=ospfIfAdminStat, ospfAsLsdbType=ospfAsLsdbType, TOSType=TOSType, ospfIfIpAddress=ospfIfIpAddress, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAdminStat=ospfAdminStat, ospfVirtIfEntry=ospfVirtIfEntry, OspfAuthenticationType=OspfAuthenticationType, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostAreaID=ospfHostAreaID, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, HelloRange=HelloRange, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfGeneralGroup=ospfGeneralGroup, ospfGroups=ospfGroups, ospfLsdbAreaId=ospfLsdbAreaId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLsdbEntry=ospfLsdbEntry, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMetricTable=ospfIfMetricTable, ospfExternLsaCount=ospfExternLsaCount, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExternalType2=ospfExternalType2, ospfIfAuthType=ospfIfAuthType, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateEffect=ospfAreaAggregateEffect, AreaID=AreaID, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLsdbTable=ospfLsdbTable, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfCompliances=ospfCompliances, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaEntry=ospfAreaEntry, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfRestartSupport=ospfRestartSupport, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIntraArea=ospfIntraArea, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaId=ospfAreaId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfRestartAge=ospfRestartAge, ospfAreaSummary=ospfAreaSummary, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfSpfRuns=ospfSpfRuns, ospfNbrOptions=ospfNbrOptions, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLsdbGroup=ospfLsdbGroup, ospfNbrTable=ospfNbrTable, ospfIfStatus=ospfIfStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbAge=ospfAsLsdbAge, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbrState=ospfNbrState, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfCompliance=ospfCompliance, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubStatus=ospfStubStatus, ospfAsLsaCount=ospfAsLsaCount, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfHostEntry=ospfHostEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbrGroup=ospfNbrGroup, ospfRestartStatus=ospfRestartStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAuthType=ospfAuthType, ospfAsLsdbTable=ospfAsLsdbTable, Metric=Metric, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfType=ospfIfType, ospfExternalType1=ospfExternalType1, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType)
