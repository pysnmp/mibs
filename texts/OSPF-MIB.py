...
mibBuilder.exportSymbols("OSPF-MIB", ospfRestartInterval=ospfRestartInterval, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfState=ospfIfState, ospfCompliance=ospfCompliance, UpToMaxAge=UpToMaxAge, ospfTOSSupport=ospfTOSSupport, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfGroup2=ospfIfGroup2, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfRetransInterval=ospfIfRetransInterval, ospfConformance=ospfConformance, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfDemand=ospfIfDemand, ospfHostMetric=ospfHostMetric, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfStubStatus=ospfStubStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, PYSNMP_MODULE_ID=ospf, ospfIfAreaId=ospfIfAreaId, ospfExternLsaCount=ospfExternLsaCount, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfExtLsdbTable=ospfExtLsdbTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRouterId=ospfRouterId, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLsdbLsid=ospfLsdbLsid, ospfAreaGroup=ospfAreaGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, Metric=Metric, ospf=ospf, ospfAdminStat=ospfAdminStat, ospfIfStatus=ospfIfStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostIpAddress=ospfHostIpAddress, ospfIfAuthKey=ospfIfAuthKey, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfTable=ospfIfTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAuthType=ospfAuthType, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbEntry=ospfLsdbEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsaCount=ospfAsLsaCount, ospfLsdbType=ospfLsdbType, ospfLsdbAge=ospfLsdbAge, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, PositiveInteger=PositiveInteger, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaEntry=ospfAreaEntry, ospfAsLsdbType=ospfAsLsdbType, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaGroup2=ospfAreaGroup2, AreaID=AreaID, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfBasicGroup2=ospfBasicGroup2, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfCompliances=ospfCompliances, ospfIfAdminStat=ospfIfAdminStat, ospfRxNewLsas=ospfRxNewLsas, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrEvents=ospfNbrEvents, ospfLsdbGroup=ospfLsdbGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfNbrEntry=ospfNbrEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfInterArea=ospfInterArea, ospfAreaStatus=ospfAreaStatus, ospfExternalType2=ospfExternalType2, DesignatedRouterPriority=DesignatedRouterPriority, ospfSpfRuns=ospfSpfRuns, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLsdbRouterId=ospfLsdbRouterId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfStubMetric=ospfStubMetric, ospfLsdbSequence=ospfLsdbSequence, ospfHostTOS=ospfHostTOS, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbTable=ospfLsdbTable, RouterID=RouterID, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrState=ospfVirtNbrState, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfStubTOS=ospfStubTOS, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaTable=ospfAreaTable, ospfHostEntry=ospfHostEntry, ospfRestartAge=ospfRestartAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfPollInterval=ospfIfPollInterval, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfIpAddress=ospfIfIpAddress, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfGroup=ospfIfGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfHostStatus=ospfHostStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLsdbAdvertisement=ospfLsdbAdvertisement, TOSType=TOSType, ospfStubMetricType=ospfStubMetricType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfMulticastExtensions=ospfMulticastExtensions, BigMetric=BigMetric, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfStubAreaEntry=ospfStubAreaEntry, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfGroups=ospfGroups, OspfAuthenticationType=OspfAuthenticationType, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfBasicGroup=ospfBasicGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaId=ospfAreaId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfState=ospfVirtIfState, ospfIfMetricValue=ospfIfMetricValue, ospfAddressLessIf=ospfAddressLessIf, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfLsaCount=ospfIfLsaCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVersionNumber=ospfVersionNumber, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfMetricGroup=ospfIfMetricGroup, ospfImportAsExtern=ospfImportAsExtern, ospfIfMetricStatus=ospfIfMetricStatus, HelloRange=HelloRange, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfEntry=ospfIfEntry, ospfIfMetricTable=ospfIfMetricTable, ospfIfType=ospfIfType, ospfIntraArea=ospfIntraArea, ospfHostTable=ospfHostTable, ospfAreaSummary=ospfAreaSummary, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrTable=ospfNbrTable, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfEvents=ospfIfEvents, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfHostGroup2=ospfHostGroup2, ospfHostGroup=ospfHostGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfCompliance2=ospfCompliance2, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfStubAreaId=ospfStubAreaId, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExternalType1=ospfExternalType1, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrOptions=ospfNbrOptions, ospfRouteGroup=ospfRouteGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, Status=Status, ospfNbrState=ospfNbrState, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement)
