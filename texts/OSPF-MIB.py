...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfLsaCount=ospfIfLsaCount, PYSNMP_MODULE_ID=ospf, RouterID=RouterID, ospfStubAreaEntry=ospfStubAreaEntry, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfSpfRuns=ospfSpfRuns, ospfAreaGroup2=ospfAreaGroup2, ospfExtLsdbType=ospfExtLsdbType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfRouteGroup=ospfRouteGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfRestartAge=ospfRestartAge, ospfIntraArea=ospfIntraArea, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfHostEntry=ospfHostEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfConformance=ospfConformance, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrEntry=ospfNbrEntry, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfHostIpAddress=ospfHostIpAddress, ospfGroups=ospfGroups, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, AreaID=AreaID, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfCompliance=ospfCompliance, ospfHostTable=ospfHostTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, Metric=Metric, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, UpToMaxAge=UpToMaxAge, ospfStubStatus=ospfStubStatus, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfBasicGroup=ospfBasicGroup, ospfHostTOS=ospfHostTOS, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLsdbEntry=ospfLsdbEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubMetric=ospfStubMetric, HelloRange=HelloRange, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfEntry=ospfIfEntry, ospfIfType=ospfIfType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfTOSSupport=ospfTOSSupport, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubAreaTable=ospfStubAreaTable, ospfRestartSupport=ospfRestartSupport, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbSequence=ospfLsdbSequence, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubTOS=ospfStubTOS, ospfIfState=ospfIfState, ospfVirtNbrState=ospfVirtNbrState, ospfHostMetric=ospfHostMetric, ospfInterArea=ospfInterArea, ospfAsLsdbType=ospfAsLsdbType, ospfExternalType1=ospfExternalType1, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfAuthKey=ospfIfAuthKey, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfRestartStatus=ospfRestartStatus, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfStatus=ospfIfStatus, ospfAuthType=ospfAuthType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbrEvents=ospfNbrEvents, ospfImportAsExtern=ospfImportAsExtern, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtIfState=ospfVirtIfState, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfHostGroup2=ospfHostGroup2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrPriority=ospfNbrPriority, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfPollInterval=ospfIfPollInterval, ospfNbrRtrId=ospfNbrRtrId, ospfNbrTable=ospfNbrTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfCompliances=ospfCompliances, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfAreaId=ospfIfAreaId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLsdbLsid=ospfLsdbLsid, ospfAreaRangeGroup=ospfAreaRangeGroup, PositiveInteger=PositiveInteger, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaRangeTable=ospfAreaRangeTable, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfGeneralGroup=ospfGeneralGroup, TOSType=TOSType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfRouterId=ospfRouterId, ospfExternLsaCount=ospfExternLsaCount, ospfAreaRangeNet=ospfAreaRangeNet, BigMetric=BigMetric, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfEvents=ospfIfEvents, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfLsdbAge=ospfLsdbAge, ospfExternalType2=ospfExternalType2, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfMetricTable=ospfIfMetricTable, ospfLsdbType=ospfLsdbType, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfHostGroup=ospfHostGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfRxNewLsas=ospfRxNewLsas, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaGroup=ospfAreaGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaEntry=ospfAreaEntry, ospfIfGroup=ospfIfGroup, ospfCompliance2=ospfCompliance2, ospfVersionNumber=ospfVersionNumber, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfStatus=ospfVirtIfStatus, ospfHostAreaID=ospfHostAreaID, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrState=ospfNbrState, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbTable=ospfAsLsdbTable, ospfRestartInterval=ospfRestartInterval, ospfNbrOptions=ospfNbrOptions, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, Status=Status, ospfIfTable=ospfIfTable, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfDemandExtensions=ospfDemandExtensions, ospf=ospf, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfGroup2=ospfIfGroup2, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaSummary=ospfAreaSummary, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrGroup=ospfNbrGroup, ospfRestartExitReason=ospfRestartExitReason, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaStatus=ospfAreaStatus, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfAdminStat=ospfIfAdminStat, ospfBasicGroup2=ospfBasicGroup2, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostStatus=ospfHostStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfDemand=ospfIfDemand, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfAuthType=ospfIfAuthType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLsdbTable=ospfLsdbTable, ospfAreaId=ospfAreaId, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfIpAddress=ospfIfIpAddress, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfTable=ospfVirtIfTable, ospfAreaTable=ospfAreaTable, ospfAdminStat=ospfAdminStat, ospfAreaLsaCount=ospfAreaLsaCount)
