...
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbAge=ospfLsdbAge, ospfNbrPriority=ospfNbrPriority, ospfAreaTable=ospfAreaTable, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, Metric=Metric, ospfAuthType=ospfAuthType, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfTOSSupport=ospfTOSSupport, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaSummary=ospfAreaSummary, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfDemand=ospfIfDemand, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfExtLsdbAge=ospfExtLsdbAge, ospfHostTable=ospfHostTable, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVersionNumber=ospfVersionNumber, ospfIfState=ospfIfState, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostAreaID=ospfHostAreaID, ospfSpfRuns=ospfSpfRuns, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfStubAreaGroup=ospfStubAreaGroup, ospfCompliance2=ospfCompliance2, ospfAreaGroup2=ospfAreaGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfEvents=ospfIfEvents, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfGeneralGroup=ospfGeneralGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfStubStatus=ospfStubStatus, ospfLsdbSequence=ospfLsdbSequence, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRestartAge=ospfRestartAge, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubAreaId=ospfStubAreaId, OspfAuthenticationType=OspfAuthenticationType, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrState=ospfNbrState, AreaID=AreaID, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfPollInterval=ospfIfPollInterval, ospfCompliance=ospfCompliance, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, Status=Status, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfIpAddress=ospfIfIpAddress, ospfIfMetricValue=ospfIfMetricValue, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMetricGroup=ospfIfMetricGroup, ospfImportAsExtern=ospfImportAsExtern, ospfAsLsaCount=ospfAsLsaCount, ospfStubMetricType=ospfStubMetricType, ospfLsdbEntry=ospfLsdbEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfStubMetric=ospfStubMetric, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfHostEntry=ospfHostEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfHostGroup=ospfHostGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrOptions=ospfNbrOptions, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExternalType2=ospfExternalType2, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfRestartStatus=ospfRestartStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrEntry=ospfNbrEntry, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfTable=ospfVirtIfTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfAddressLessIf=ospfAddressLessIf, ospfConformance=ospfConformance, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfHostTOS=ospfHostTOS, ospf=ospf, ospfRouteGroup=ospfRouteGroup, ospfRouterId=ospfRouterId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, RouterID=RouterID, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaRangeGroup=ospfAreaRangeGroup, PositiveInteger=PositiveInteger, ospfVirtIfAreaId=ospfVirtIfAreaId, HelloRange=HelloRange, ospfExternLsaCount=ospfExternLsaCount, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfState=ospfVirtIfState, ospfInterArea=ospfInterArea, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaGroup=ospfAreaGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaEntry=ospfAreaEntry, ospfCompliances=ospfCompliances, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfRestartInterval=ospfRestartInterval, ospfNbrRtrId=ospfNbrRtrId, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAdminStat=ospfAdminStat, ospfLsdbGroup=ospfLsdbGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIntraArea=ospfIntraArea, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfAuthKey=ospfIfAuthKey, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExternalType1=ospfExternalType1, ospfIfAuthType=ospfIfAuthType, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubTOS=ospfStubTOS, ospfLsdbTable=ospfLsdbTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfGroup2=ospfIfGroup2, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostGroup2=ospfHostGroup2, UpToMaxAge=UpToMaxAge, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfTable=ospfIfTable, ospfExtLsdbType=ospfExtLsdbType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateStatus=ospfAreaAggregateStatus, PYSNMP_MODULE_ID=ospf, ospfIfGroup=ospfIfGroup, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfRestartSupport=ospfRestartSupport, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbType=ospfAsLsdbType, ospfHostStatus=ospfHostStatus, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfType=ospfIfType, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaStatus=ospfAreaStatus, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfEntry=ospfIfEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, TOSType=TOSType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfAdminStat=ospfIfAdminStat, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfStatus=ospfIfStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfBasicGroup=ospfBasicGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaId=ospfAreaId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbType=ospfLsdbType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfHostMetric=ospfHostMetric, ospfBasicGroup2=ospfBasicGroup2, BigMetric=BigMetric, ospfLsdbLsid=ospfLsdbLsid, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfGroups=ospfGroups, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfAreaId=ospfIfAreaId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrTable=ospfNbrTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfMulticastExtensions=ospfMulticastExtensions, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfMetricTable=ospfIfMetricTable, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfAuthType=ospfVirtIfAuthType)
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrGroup=ospfNbrGroup, ospfRxNewLsas=ospfRxNewLsas, ospfLocalLsdbType=ospfLocalLsdbType, ospfDiscontinuityTime=ospfDiscontinuityTime)
