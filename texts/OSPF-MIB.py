...
mibBuilder.exportSymbols("OSPF-MIB", ospfConformance=ospfConformance, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfHostGroup2=ospfHostGroup2, ospfNbrTable=ospfNbrTable, ospfHostAreaID=ospfHostAreaID, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaGroup=ospfAreaGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaId=ospfAreaId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLsdbLsid=ospfLsdbLsid, Metric=Metric, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaSummary=ospfAreaSummary, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfEntry=ospfIfEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbAge=ospfLsdbAge, ospfIfStatus=ospfIfStatus, ospfVersionNumber=ospfVersionNumber, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfAuthType=ospfIfAuthType, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubAreaTable=ospfStubAreaTable, ospfIfDemand=ospfIfDemand, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAdminStat=ospfAdminStat, ospfStubMetricType=ospfStubMetricType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExtLsdbType=ospfExtLsdbType, ospfAreaTable=ospfAreaTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, RouterID=RouterID, ospfIfIpAddress=ospfIfIpAddress, ospfReferenceBandwidth=ospfReferenceBandwidth, BigMetric=BigMetric, ospfComplianceObsolete=ospfComplianceObsolete, TOSType=TOSType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsaCount=ospfAsLsaCount, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrState=ospfNbrState, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrGroup2=ospfNbrGroup2, ospfIfPollInterval=ospfIfPollInterval, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostTable=ospfHostTable, ospfStubMetric=ospfStubMetric, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfHostGroup=ospfHostGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrEvents=ospfNbrEvents, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAsLsdbTable=ospfAsLsdbTable, ospfExternLsaCount=ospfExternLsaCount, ospfCompliance2=ospfCompliance2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfHostEntry=ospfHostEntry, ospfStubTOS=ospfStubTOS, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfRestartSupport=ospfRestartSupport, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsdbType=ospfAsLsdbType, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostTOS=ospfHostTOS, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtNbrState=ospfVirtNbrState, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfAreaId=ospfIfAreaId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfHostMetric=ospfHostMetric, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfGroup2=ospfIfGroup2, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIntraArea=ospfIntraArea, ospfNbrOptions=ospfNbrOptions, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfTransitDelay=ospfIfTransitDelay, ospfLsdbTable=ospfLsdbTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfStubAreaId=ospfStubAreaId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfTable=ospfVirtIfTable, ospfGroups=ospfGroups, ospfLsdbAdvertisement=ospfLsdbAdvertisement, OspfAuthenticationType=OspfAuthenticationType, ospfSpfRuns=ospfSpfRuns, ospfCompliance=ospfCompliance, ospfIfGroup=ospfIfGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfRestartInterval=ospfRestartInterval, ospfIfAuthKey=ospfIfAuthKey, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfImportAsExtern=ospfImportAsExtern, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, AreaID=AreaID, ospfRxNewLsas=ospfRxNewLsas, DesignatedRouterPriority=DesignatedRouterPriority, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbTable=ospfExtLsdbTable, PositiveInteger=PositiveInteger, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrRtrId=ospfNbrRtrId, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfBasicGroup=ospfBasicGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, HelloRange=HelloRange, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, Status=Status, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfRestartStatus=ospfRestartStatus, ospfIfTable=ospfIfTable, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrEntry=ospfNbrEntry, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubStatus=ospfStubStatus, ospfLsdbType=ospfLsdbType, ospfInterArea=ospfInterArea, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfState=ospfIfState, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfMetricTable=ospfIfMetricTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfDemandExtensions=ospfDemandExtensions, ospfIfEvents=ospfIfEvents, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAuthType=ospfAuthType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaEntry=ospfAreaEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfLsdbGroup=ospfLsdbGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfNbrPriority=ospfNbrPriority, ospfLsdbEntry=ospfLsdbEntry, ospfHostIpAddress=ospfHostIpAddress, ospfExternalType2=ospfExternalType2, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfLsaCount=ospfIfLsaCount, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaStatus=ospfAreaStatus, ospfRouterId=ospfRouterId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfHostStatus=ospfHostStatus, ospfRestartAge=ospfRestartAge, ospfVirtIfState=ospfVirtIfState, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfRestartExitReason=ospfRestartExitReason, PYSNMP_MODULE_ID=ospf, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExternalType1=ospfExternalType1, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfGeneralGroup=ospfGeneralGroup, ospfIfType=ospfIfType, ospfTOSSupport=ospfTOSSupport, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfMetricValue=ospfIfMetricValue, ospfRouteGroup=ospfRouteGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfCompliances=ospfCompliances, ospfBasicGroup2=ospfBasicGroup2, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf)
mibBuilder.exportSymbols("OSPF-MIB", ospf=ospf, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, UpToMaxAge=UpToMaxAge)
