...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfStubTOS=ospfStubTOS, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfStatus=ospfVirtIfStatus, ospfAdminStat=ospfAdminStat, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfState=ospfIfState, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfBasicGroup2=ospfBasicGroup2, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfEvents=ospfIfEvents, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLsdbSequence=ospfLsdbSequence, ospfHostEntry=ospfHostEntry, ospfLsdbEntry=ospfLsdbEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospf=ospf, ospfIfAdminStat=ospfIfAdminStat, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaId=ospfAreaId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, HelloRange=HelloRange, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaGroup=ospfAreaGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaTable=ospfAreaTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfHostStatus=ospfHostStatus, Metric=Metric, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfMetricTable=ospfIfMetricTable, ospfAsLsdbType=ospfAsLsdbType, ospfNbrEvents=ospfNbrEvents, ospfAreaGroup2=ospfAreaGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLsdbGroup=ospfLsdbGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRouterId=ospfRouterId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtNbrArea=ospfVirtNbrArea, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfGroup=ospfIfGroup, ospfIfAuthType=ospfIfAuthType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfHelloInterval=ospfIfHelloInterval, UpToMaxAge=UpToMaxAge, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaSummary=ospfAreaSummary, ospfIfMetricValue=ospfIfMetricValue, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfRestartAge=ospfRestartAge, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfStubMetricType=ospfStubMetricType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfIpAddress=ospfIfIpAddress, ospfHostTable=ospfHostTable, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsdbGroup=ospfAsLsdbGroup, Status=Status, OspfAuthenticationType=OspfAuthenticationType, ospfRestartStatus=ospfRestartStatus, TOSType=TOSType, ospfVersionNumber=ospfVersionNumber, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRouteGroup=ospfRouteGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRxNewLsas=ospfRxNewLsas, ospfBasicGroup=ospfBasicGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrIpAddr=ospfNbrIpAddr, BigMetric=BigMetric, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrState=ospfVirtNbrState, ospfIfAreaId=ospfIfAreaId, ospfVirtIfState=ospfVirtIfState, ospfConformance=ospfConformance, ospfAreaRangeTable=ospfAreaRangeTable, RouterID=RouterID, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAuthType=ospfAuthType, ospfAreaEntry=ospfAreaEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfTransitDelay=ospfIfTransitDelay, ospfLsdbType=ospfLsdbType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfMetricTOS=ospfIfMetricTOS, ospfExternalType1=ospfExternalType1, ospfNbrRtrId=ospfNbrRtrId, ospfTOSSupport=ospfTOSSupport, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfPollInterval=ospfIfPollInterval, ospfStubAreaGroup=ospfStubAreaGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, PositiveInteger=PositiveInteger, ospfExtLsdbTable=ospfExtLsdbTable, ospfStubMetric=ospfStubMetric, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfExtLsdbType=ospfExtLsdbType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfGroups=ospfGroups, ospfIfTable=ospfIfTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfImportAsExtern=ospfImportAsExtern, ospfNbrGroup=ospfNbrGroup, ospfCompliances=ospfCompliances, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaStatus=ospfAreaStatus, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfCompliance2=ospfCompliance2, ospfIfGroup2=ospfIfGroup2, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, AreaID=AreaID, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfAuthKey=ospfIfAuthKey, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfHostGroup=ospfHostGroup, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsaCount=ospfAsLsaCount, PYSNMP_MODULE_ID=ospf, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfHostAreaID=ospfHostAreaID, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfHostIpAddress=ospfHostIpAddress, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfDemandExtensions=ospfDemandExtensions, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfType=ospfIfType, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExternalType2=ospfExternalType2, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfRestartSupport=ospfRestartSupport, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostMetric=ospfHostMetric, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubStatus=ospfStubStatus, ospfGeneralGroup=ospfGeneralGroup, ospfIfDemand=ospfIfDemand, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrPriority=ospfNbrPriority, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLsdbLsid=ospfLsdbLsid, ospfIntraArea=ospfIntraArea, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaRangeMask=ospfAreaRangeMask, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostGroup2=ospfHostGroup2, ospfIfStatus=ospfIfStatus, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrGroup2=ospfNbrGroup2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLsdbAge=ospfLsdbAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfEntry=ospfIfEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExtLsdbAge=ospfExtLsdbAge, ospfInterArea=ospfInterArea, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfTable=ospfVirtIfTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbTable=ospfLsdbTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrOptions=ospfNbrOptions, ospfCompliance=ospfCompliance)
