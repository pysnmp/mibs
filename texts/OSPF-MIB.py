...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfHostTable=ospfHostTable, ospfIfPollInterval=ospfIfPollInterval, ospfIfDemand=ospfIfDemand, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostStatus=ospfHostStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfHostEntry=ospfHostEntry, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfStatus=ospfVirtIfStatus, ospfExternalType2=ospfExternalType2, ospfLsdbRouterId=ospfLsdbRouterId, ospfRestartInterval=ospfRestartInterval, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaEntry=ospfAreaEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbType=ospfExtLsdbType, ospfCompliance2=ospfCompliance2, ospfDemandExtensions=ospfDemandExtensions, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaStatus=ospfAreaStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfStubAreaTable=ospfStubAreaTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubMetricType=ospfStubMetricType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsaCount=ospfAsLsaCount, ospfObsoleteGroup=ospfObsoleteGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfRouteGroup=ospfRouteGroup, ospfAuthType=ospfAuthType, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfHostGroup=ospfHostGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLsdbType=ospfLsdbType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrGroup=ospfNbrGroup, ospfHostIpAddress=ospfHostIpAddress, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, Metric=Metric, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubStatus=ospfStubStatus, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfInterArea=ospfInterArea, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfGroup=ospfIfGroup, TOSType=TOSType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfType=ospfIfType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, HelloRange=HelloRange, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfHostMetric=ospfHostMetric, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfEvents=ospfIfEvents, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfHostGroup2=ospfHostGroup2, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfRestartExitReason=ospfRestartExitReason, ospfAdminStat=ospfAdminStat, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfMetricStatus=ospfIfMetricStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeStatus=ospfAreaRangeStatus, OspfAuthenticationType=OspfAuthenticationType, ospfIfAuthType=ospfIfAuthType, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfSpfRuns=ospfSpfRuns, ospfBasicGroup2=ospfBasicGroup2, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfTable=ospfIfTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfRouterId=ospfRouterId, ospfLsdbLsid=ospfLsdbLsid, ospfLsdbEntry=ospfLsdbEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospf=ospf, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfGroup2=ospfIfGroup2, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrEvents=ospfNbrEvents, AreaID=AreaID, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfState=ospfIfState, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaGroup2=ospfAreaGroup2, ospfLsdbAge=ospfLsdbAge, ospfRestartSupport=ospfRestartSupport, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaSummary=ospfAreaSummary, ospfIfAdminStat=ospfIfAdminStat, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMetricTable=ospfIfMetricTable, ospfStubAreaId=ospfStubAreaId, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostTOS=ospfHostTOS, ospfIntraArea=ospfIntraArea, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, PYSNMP_MODULE_ID=ospf, BigMetric=BigMetric, ospfRestartStatus=ospfRestartStatus, PositiveInteger=PositiveInteger, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfRxNewLsas=ospfRxNewLsas, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrOptions=ospfNbrOptions, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrEntry=ospfNbrEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfLsaCount=ospfIfLsaCount, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfCompliances=ospfCompliances, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfNbrTable=ospfNbrTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfImportAsExtern=ospfImportAsExtern, RouterID=RouterID, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbTable=ospfLsdbTable, ospfExternalType1=ospfExternalType1, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfCompliance=ospfCompliance, ospfExternLsaCount=ospfExternLsaCount, ospfIfMetricTOS=ospfIfMetricTOS, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfStubMetric=ospfStubMetric, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfTOSSupport=ospfTOSSupport, ospfBasicGroup=ospfBasicGroup, ospfGroups=ospfGroups, ospfVirtIfState=ospfVirtIfState, Status=Status, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfConformance=ospfConformance, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfTable=ospfVirtIfTable, ospfHostAreaID=ospfHostAreaID, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfEntry=ospfIfEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfMetricGroup=ospfIfMetricGroup, UpToMaxAge=UpToMaxAge, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaTable=ospfAreaTable, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaId=ospfAreaId, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrState=ospfVirtNbrState, ospfNbrRtrId=ospfNbrRtrId, ospfRestartAge=ospfRestartAge, ospfNbrIpAddr=ospfNbrIpAddr, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfStatus=ospfIfStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfStubTOS=ospfStubTOS, ospfIfMetricEntry=ospfIfMetricEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfHelloInterval=ospfIfHelloInterval, ospfLsdbSequence=ospfLsdbSequence, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement)
