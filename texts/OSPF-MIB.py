...
mibBuilder.exportSymbols("OSPF-MIB", ospfVersionNumber=ospfVersionNumber, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrState=ospfNbrState, ospfAreaRangeMask=ospfAreaRangeMask, ospfCompliance2=ospfCompliance2, ospfCompliances=ospfCompliances, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfStubTOS=ospfStubTOS, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLsdbLsid=ospfLsdbLsid, ospfHostStatus=ospfHostStatus, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLsdbEntry=ospfLsdbEntry, ospfIntraArea=ospfIntraArea, ospfLsdbAreaId=ospfLsdbAreaId, ospfDemandExtensions=ospfDemandExtensions, UpToMaxAge=UpToMaxAge, ospfIfLsaCount=ospfIfLsaCount, ospfIfAuthType=ospfIfAuthType, ospfExternalType1=ospfExternalType1, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfGeneralGroup=ospfGeneralGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, AreaID=AreaID, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostEntry=ospfHostEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, PYSNMP_MODULE_ID=ospf, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfRtrPriority=ospfIfRtrPriority, ospf=ospf, ospfRestartInterval=ospfRestartInterval, RouterID=RouterID, ospfImportAsExtern=ospfImportAsExtern, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfStatus=ospfIfStatus, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaSummary=ospfAreaSummary, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfBasicGroup=ospfBasicGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsaCount=ospfAsLsaCount, ospfStubStatus=ospfStubStatus, ospfIfAdminStat=ospfIfAdminStat, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbSequence=ospfLsdbSequence, HelloRange=HelloRange, PositiveInteger=PositiveInteger, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfType=ospfIfType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfTable=ospfIfTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfHostAreaID=ospfHostAreaID, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrRtrId=ospfNbrRtrId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfConformance=ospfConformance, ospfRestartAge=ospfRestartAge, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, Metric=Metric, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfMetricTable=ospfIfMetricTable, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsdbType=ospfAsLsdbType, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfRestartExitReason=ospfRestartExitReason, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfStatus=ospfVirtIfStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfRestartStatus=ospfRestartStatus, ospfNbrTable=ospfNbrTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfMetricEntry=ospfIfMetricEntry, ospfExternLsaCount=ospfExternLsaCount, ospfHostIpAddress=ospfHostIpAddress, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfState=ospfIfState, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubMetric=ospfStubMetric, ospfNbrEntry=ospfNbrEntry, ospfTOSSupport=ospfTOSSupport, ospfLsdbAge=ospfLsdbAge, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrOptions=ospfVirtNbrOptions, TOSType=TOSType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrGroup2=ospfNbrGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfRestartSupport=ospfRestartSupport, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaId=ospfAreaId, ospfRouteGroup=ospfRouteGroup, ospfAdminStat=ospfAdminStat, ospfAreaEntry=ospfAreaEntry, ospfStubAreaTable=ospfStubAreaTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAuthType=ospfAuthType, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfSpfRuns=ospfSpfRuns, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbType=ospfExtLsdbType, ospfLsdbTable=ospfLsdbTable, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfHostGroup=ospfHostGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfStubAreaId=ospfStubAreaId, ospfVirtIfEvents=ospfVirtIfEvents, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrPriority=ospfNbrPriority, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRxNewLsas=ospfRxNewLsas, ospfHostTable=ospfHostTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfAuthKey=ospfIfAuthKey, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfHostTOS=ospfHostTOS, ospfLsdbGroup=ospfLsdbGroup, ospfInterArea=ospfInterArea, Status=Status, ospfHostMetric=ospfHostMetric, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfEntry=ospfIfEntry, ospfIfMetricValue=ospfIfMetricValue, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaStatus=ospfAreaStatus, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAddressLessIf=ospfAddressLessIf, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfStubMetricType=ospfStubMetricType, ospfMulticastExtensions=ospfMulticastExtensions, ospfLsdbType=ospfLsdbType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfComplianceObsolete=ospfComplianceObsolete, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfHostGroup2=ospfHostGroup2, ospfAreaTable=ospfAreaTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfExternalType2=ospfExternalType2, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, BigMetric=BigMetric, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfGroup2=ospfIfGroup2, ospfAreaLsaCount=ospfAreaLsaCount, OspfAuthenticationType=OspfAuthenticationType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfDemand=ospfIfDemand, ospfIfEvents=ospfIfEvents, ospfVirtIfTable=ospfVirtIfTable, ospfIfIpAddress=ospfIfIpAddress, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfGroups=ospfGroups, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaGroup=ospfAreaGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrArea=ospfVirtNbrArea, ospfCompliance=ospfCompliance, ospfIfGroup=ospfIfGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfRouterId=ospfRouterId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfLocalLsdbTable=ospfLocalLsdbTable)
