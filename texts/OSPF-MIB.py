...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubAreaEntry=ospfStubAreaEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfExternalType1=ospfExternalType1, ospfIfDemand=ospfIfDemand, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfConformance=ospfConformance, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubStatus=ospfStubStatus, ospfHostTable=ospfHostTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubTOS=ospfStubTOS, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrPriority=ospfNbrPriority, ospfIfTable=ospfIfTable, ospfIfStatus=ospfIfStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaSummary=ospfAreaSummary, ospfLsdbTable=ospfLsdbTable, ospfAreaTable=ospfAreaTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfGroup2=ospfIfGroup2, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbSequence=ospfLsdbSequence, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfLsaCount=ospfIfLsaCount, ospfAreaStatus=ospfAreaStatus, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, PYSNMP_MODULE_ID=ospf, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfRFC1583Compatibility=ospfRFC1583Compatibility, AreaID=AreaID, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfBasicGroup2=ospfBasicGroup2, ospfHostGroup=ospfHostGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfPollInterval=ospfIfPollInterval, ospfCompliance=ospfCompliance, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbGroup=ospfLsdbGroup, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbChecksum=ospfLsdbChecksum, ospfCompliance2=ospfCompliance2, HelloRange=HelloRange, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbType=ospfAsLsdbType, ospfNbrRtrId=ospfNbrRtrId, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRestartSupport=ospfRestartSupport, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfStubMetricType=ospfStubMetricType, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfStubAreaTable=ospfStubAreaTable, ospfIfEntry=ospfIfEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, UpToMaxAge=UpToMaxAge, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfExternalType2=ospfExternalType2, ospfIfAreaId=ospfIfAreaId, ospfHostAreaID=ospfHostAreaID, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfGroups=ospfGroups, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfDemandExtensions=ospfDemandExtensions, ospfAdminStat=ospfAdminStat, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrGroup2=ospfNbrGroup2, ospfIfMetricTOS=ospfIfMetricTOS, ospfExternLsaCount=ospfExternLsaCount, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfStubAreaId=ospfStubAreaId, ospfIfState=ospfIfState, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, PositiveInteger=PositiveInteger, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfBasicGroup=ospfBasicGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, TOSType=TOSType, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfTable=ospfVirtIfTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfRestartStatus=ospfRestartStatus, Status=Status, ospfNbrOptions=ospfNbrOptions, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfImportAsExtern=ospfImportAsExtern, ospfTOSSupport=ospfTOSSupport, ospfVirtIfState=ospfVirtIfState, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfMetricEntry=ospfIfMetricEntry, ospfHostEntry=ospfHostEntry, ospfRouterId=ospfRouterId, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaGroup=ospfAreaGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRxNewLsas=ospfRxNewLsas, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospf=ospf, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricValue=ospfIfMetricValue, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfMetricStatus=ospfIfMetricStatus, ospfLsdbType=ospfLsdbType, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaEntry=ospfAreaEntry, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbAge=ospfExtLsdbAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfAuthType=ospfIfAuthType, OspfAuthenticationType=OspfAuthenticationType, BigMetric=BigMetric, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostStatus=ospfHostStatus, ospfInterArea=ospfInterArea, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfRouteGroup=ospfRouteGroup, ospfStubRouterSupport=ospfStubRouterSupport, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrTable=ospfNbrTable, ospfIntraArea=ospfIntraArea, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaId=ospfAreaId, ospfHostTOS=ospfHostTOS, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfIpAddress=ospfIfIpAddress, ospfNbrEvents=ospfNbrEvents, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubMetric=ospfStubMetric, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfHostGroup2=ospfHostGroup2, Metric=Metric, RouterID=RouterID, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfEvents=ospfIfEvents, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfType=ospfIfType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostMetric=ospfHostMetric, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfGroup=ospfIfGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAuthType=ospfAuthType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAddressLessIf=ospfAddressLessIf, ospfExtLsdbTable=ospfExtLsdbTable, ospfCompliances=ospfCompliances, ospfSpfRuns=ospfSpfRuns, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfGroup=ospfVirtIfGroup, ospfRestartAge=ospfRestartAge, ospfNbrGroup=ospfNbrGroup, ospfExtLsdbType=ospfExtLsdbType, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId)
mibBuilder.exportSymbols("OSPF-MIB", ospfRestartExitReason=ospfRestartExitReason, ospfNbrState=ospfNbrState, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLsdbAge=ospfLsdbAge)
