...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfEntry=ospfVirtIfEntry, ospfTOSSupport=ospfTOSSupport, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRxNewLsas=ospfRxNewLsas, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostGroup2=ospfHostGroup2, ospfLsdbTable=ospfLsdbTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaGroup=ospfAreaGroup, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfAuthKey=ospfIfAuthKey, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfStubMetric=ospfStubMetric, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubMetricType=ospfStubMetricType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaSummary=ospfAreaSummary, ospfExternalType2=ospfExternalType2, UpToMaxAge=UpToMaxAge, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfLsaCount=ospfIfLsaCount, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfAreaId=ospfIfAreaId, ospfIntraArea=ospfIntraArea, ospfRestartStatus=ospfRestartStatus, ospfIfMetricValue=ospfIfMetricValue, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAuthType=ospfAuthType, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfStubAreaGroup=ospfStubAreaGroup, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfAuthType=ospfIfAuthType, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostStatus=ospfHostStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfNbrOptions=ospfNbrOptions, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLsdbGroup=ospfLsdbGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, AreaID=AreaID, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaGroup2=ospfAreaGroup2, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfAdminStat=ospfIfAdminStat, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfHostMetric=ospfHostMetric, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbrEntry=ospfNbrEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, PYSNMP_MODULE_ID=ospf, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaEntry=ospfAreaEntry, ospfIfIpAddress=ospfIfIpAddress, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfMetricTOS=ospfIfMetricTOS, TOSType=TOSType, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfDemandExtensions=ospfDemandExtensions, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaTable=ospfAreaTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfCompliance=ospfCompliance, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfRestartAge=ospfRestartAge, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfGroup=ospfIfGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfRouterId=ospfRouterId, ospfAreaStatus=ospfAreaStatus, ospfIfType=ospfIfType, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrState=ospfVirtNbrState, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostTable=ospfHostTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbType=ospfLsdbType, ospfIfStatus=ospfIfStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAddressLessIf=ospfAddressLessIf, ospfLsdbRouterId=ospfLsdbRouterId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfBasicGroup=ospfBasicGroup, ospfHostGroup=ospfHostGroup, ospfExternalType1=ospfExternalType1, BigMetric=BigMetric, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfGeneralGroup=ospfGeneralGroup, ospfInterArea=ospfInterArea, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfExternLsaCount=ospfExternLsaCount, ospfRouteGroup=ospfRouteGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfConformance=ospfConformance, ospfSpfRuns=ospfSpfRuns, DesignatedRouterPriority=DesignatedRouterPriority, ospfImportAsExtern=ospfImportAsExtern, ospfVirtNbrGroup=ospfVirtNbrGroup, RouterID=RouterID, HelloRange=HelloRange, ospfGroups=ospfGroups, ospfNbrIpAddr=ospfNbrIpAddr, ospfLsdbEntry=ospfLsdbEntry, ospfVersionNumber=ospfVersionNumber, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfHelloInterval=ospfIfHelloInterval, OspfAuthenticationType=OspfAuthenticationType, ospfCompliance2=ospfCompliance2, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAdminStat=ospfAdminStat, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfDemand=ospfIfDemand, ospf=ospf, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfHostEntry=ospfHostEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfComplianceObsolete=ospfComplianceObsolete, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrTable=ospfNbrTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfState=ospfIfState, ospfVirtIfEvents=ospfVirtIfEvents, Metric=Metric, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubAreaId=ospfStubAreaId, ospfNbrGroup=ospfNbrGroup, ospfExtLsdbType=ospfExtLsdbType, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbLsid=ospfLsdbLsid, ospfNbrGroup2=ospfNbrGroup2, ospfNbrEvents=ospfNbrEvents, ospfVirtIfTable=ospfVirtIfTable, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfStatus=ospfVirtIfStatus, ospfStubStatus=ospfStubStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfPollInterval=ospfIfPollInterval, ospfIfEntry=ospfIfEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfMulticastExtensions=ospfMulticastExtensions, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfStubTOS=ospfStubTOS, ospfRestartExitReason=ospfRestartExitReason, ospfHostIpAddress=ospfHostIpAddress, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, PositiveInteger=PositiveInteger, ospfIfTable=ospfIfTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrTable=ospfVirtNbrTable, ospfCompliances=ospfCompliances, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfEvents=ospfIfEvents, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfRestartInterval=ospfRestartInterval, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAsLsaCount=ospfAsLsaCount, ospfStubRouterSupport=ospfStubRouterSupport, ospfLsdbAge=ospfLsdbAge, ospfRestartSupport=ospfRestartSupport, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfHostAreaID=ospfHostAreaID, ospfNbrPriority=ospfNbrPriority)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfGroup2=ospfIfGroup2, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaId=ospfAreaId, Status=Status)
