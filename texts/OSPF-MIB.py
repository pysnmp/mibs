...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfInterArea=ospfInterArea, ospfRestartInterval=ospfRestartInterval, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLsdbGroup=ospfLsdbGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrEntry=ospfNbrEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, TOSType=TOSType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsdbAge=ospfAsLsdbAge, ospfTOSSupport=ospfTOSSupport, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtIfTable=ospfVirtIfTable, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaStatus=ospfAreaStatus, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbAge=ospfExtLsdbAge, ospfConformance=ospfConformance, ospfIfEvents=ospfIfEvents, ospfIfType=ospfIfType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLsdbAreaId=ospfLsdbAreaId, ospfRestartAge=ospfRestartAge, ospfIfTable=ospfIfTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAuthType=ospfAuthType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbEntry=ospfAsLsdbEntry, OspfAuthenticationType=OspfAuthenticationType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfStatus=ospfIfStatus, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbType=ospfLsdbType, ospfLocalLsdbAge=ospfLocalLsdbAge, PYSNMP_MODULE_ID=ospf, ospfLsdbSequence=ospfLsdbSequence, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubMetric=ospfStubMetric, ospfIfMetricEntry=ospfIfMetricEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrTable=ospfNbrTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfHostTOS=ospfHostTOS, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostEntry=ospfHostEntry, ospfNbrGroup=ospfNbrGroup, ospfRestartStatus=ospfRestartStatus, ospfCompliance2=ospfCompliance2, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfAreaId=ospfIfAreaId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrRtrId=ospfNbrRtrId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfGroup2=ospfIfGroup2, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfStubAreaId=ospfStubAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfStubTOS=ospfStubTOS, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbRouterId=ospfLsdbRouterId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfRestartExitReason=ospfRestartExitReason, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrOptions=ospfNbrOptions, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAddressLessIf=ospfAddressLessIf, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaSummary=ospfAreaSummary, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrPriority=ospfNbrPriority, ospfExternalType2=ospfExternalType2, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfRouteGroup=ospfRouteGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfExternalType1=ospfExternalType1, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfDemandExtensions=ospfDemandExtensions, ospfStubMetricType=ospfStubMetricType, ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfAuthKey=ospfIfAuthKey, ospfBasicGroup2=ospfBasicGroup2, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfHostGroup=ospfHostGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaEntry=ospfAreaEntry, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfBasicGroup=ospfBasicGroup, ospfIfDemand=ospfIfDemand, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfHostMetric=ospfHostMetric, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, HelloRange=HelloRange, ospfLsdbEntry=ospfLsdbEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfHostGroup2=ospfHostGroup2, ospfIfEntry=ospfIfEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaId=ospfAreaId, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrTable=ospfVirtNbrTable, ospfIntraArea=ospfIntraArea, ospfIfAuthType=ospfIfAuthType, ospfGroups=ospfGroups, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAdminStat=ospfAdminStat, ospfStubAreaEntry=ospfStubAreaEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfCompliances=ospfCompliances, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLsdbLsid=ospfLsdbLsid, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLocalLsdbType=ospfLocalLsdbType, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfExternLsaCount=ospfExternLsaCount, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfGroup=ospfIfGroup, ospfVersionNumber=ospfVersionNumber, ospfHostTable=ospfHostTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostAreaID=ospfHostAreaID, ospfNbrEvents=ospfNbrEvents, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfIpAddress=ospfIfIpAddress, BigMetric=BigMetric, AreaID=AreaID, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfTransitDelay=ospfIfTransitDelay, Metric=Metric, ospfSpfRuns=ospfSpfRuns, ospfRouterId=ospfRouterId, ospfIfPollInterval=ospfIfPollInterval, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbAge=ospfLsdbAge, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrArea=ospfVirtNbrArea, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfStubStatus=ospfStubStatus, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfState=ospfIfState, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAsLsaCount=ospfAsLsaCount, RouterID=RouterID, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsLsdbType=ospfAsLsdbType, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, UpToMaxAge=UpToMaxAge, ospfVirtIfEntry=ospfVirtIfEntry, ospfCompliance=ospfCompliance, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfRetransInterval=ospfIfRetransInterval, ospf=ospf, ospfRestartSupport=ospfRestartSupport, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfAdminStat=ospfIfAdminStat, ospfAreaGroup=ospfAreaGroup, ospfRxNewLsas=ospfRxNewLsas, PositiveInteger=PositiveInteger, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaTable=ospfAreaTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCount=ospfAreaLsaCount, Status=Status)
mibBuilder.exportSymbols("OSPF-MIB", ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfHelloInterval=ospfIfHelloInterval, ospfImportAsExtern=ospfImportAsExtern, ospfHostStatus=ospfHostStatus)
