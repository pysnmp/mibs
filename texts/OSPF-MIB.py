...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfAuthType=ospfIfAuthType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfRestartStatus=ospfRestartStatus, ospfNbrEvents=ospfNbrEvents, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfStatus=ospfIfStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, PYSNMP_MODULE_ID=ospf, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfHostTable=ospfHostTable, ospfIfPollInterval=ospfIfPollInterval, ospfRestartInterval=ospfRestartInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfIntraArea=ospfIntraArea, ospfIfMetricValue=ospfIfMetricValue, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaLsaCount=ospfAreaLsaCount, ospfRestartExitReason=ospfRestartExitReason, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfState=ospfIfState, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfCompliance=ospfCompliance, ospfAreaStatus=ospfAreaStatus, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrState=ospfNbrState, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfHostGroup2=ospfHostGroup2, ospfVirtIfState=ospfVirtIfState, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbTable=ospfAsLsdbTable, ospfInterArea=ospfInterArea, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaRangeEntry=ospfAreaRangeEntry, DesignatedRouterPriority=DesignatedRouterPriority, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtIfTable=ospfVirtIfTable, ospfAreaGroup=ospfAreaGroup, ospfHostMetric=ospfHostMetric, ospfIfEvents=ospfIfEvents, ospfExtLsdbType=ospfExtLsdbType, ospfAreaId=ospfAreaId, ospfTOSSupport=ospfTOSSupport, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfIpAddress=ospfIfIpAddress, RouterID=RouterID, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostIpAddress=ospfHostIpAddress, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrIpAddr=ospfNbrIpAddr, ospfRouteGroup=ospfRouteGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAuthType=ospfAuthType, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfRxNewLsas=ospfRxNewLsas, ospfStubRouterSupport=ospfStubRouterSupport, ospfLsdbAreaId=ospfLsdbAreaId, ospfAsLsdbAge=ospfAsLsdbAge, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfAdminStat=ospfIfAdminStat, ospfLsdbAge=ospfLsdbAge, ospfIfEntry=ospfIfEntry, ospfGroups=ospfGroups, ospfIfGroup=ospfIfGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubTOS=ospfStubTOS, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfCompliance2=ospfCompliance2, ospfIfMetricGroup=ospfIfMetricGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfBasicGroup=ospfBasicGroup, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfMetricEntry=ospfIfMetricEntry, Metric=Metric, ospfSpfRuns=ospfSpfRuns, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfLsaCount=ospfIfLsaCount, ospfHostTOS=ospfHostTOS, ospfIfMetricTable=ospfIfMetricTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfHostCfgAreaID=ospfHostCfgAreaID, BigMetric=BigMetric, Status=Status, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRestartAge=ospfRestartAge, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbGroup=ospfLsdbGroup, ospfAreaSummary=ospfAreaSummary, ospfExternalType1=ospfExternalType1, ospfNbrOptions=ospfNbrOptions, ospfIfTable=ospfIfTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospf=ospf, ospfRouterId=ospfRouterId, ospfIfDemand=ospfIfDemand, ospfStubMetric=ospfStubMetric, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrTable=ospfNbrTable, ospfExternalType2=ospfExternalType2, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfRestartSupport=ospfRestartSupport, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfHostEntry=ospfHostEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, OspfAuthenticationType=OspfAuthenticationType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAdminStat=ospfAdminStat, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfEntry=ospfVirtIfEntry, ospfStubAreaId=ospfStubAreaId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfImportAsExtern=ospfImportAsExtern, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfHostAreaID=ospfHostAreaID, ospfStubMetricType=ospfStubMetricType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, HelloRange=HelloRange, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfStatus=ospfVirtIfStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLsdbRouterId=ospfLsdbRouterId, ospfAsLsaCount=ospfAsLsaCount, ospfExtLsdbTable=ospfExtLsdbTable, ospfVersionNumber=ospfVersionNumber, PositiveInteger=PositiveInteger, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExternLsaCount=ospfExternLsaCount, ospfLsdbLsid=ospfLsdbLsid, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAddressLessIf=ospfAddressLessIf, ospfLsdbTable=ospfLsdbTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaTable=ospfAreaTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfHostStatus=ospfHostStatus, ospfCompliances=ospfCompliances, ospfLsdbChecksum=ospfLsdbChecksum, UpToMaxAge=UpToMaxAge, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfHostGroup=ospfHostGroup, ospfNbrPriority=ospfNbrPriority, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaGroup2=ospfAreaGroup2, TOSType=TOSType, ospfLsdbType=ospfLsdbType, ospfIfMetricStatus=ospfIfMetricStatus, ospfConformance=ospfConformance, ospfDemandExtensions=ospfDemandExtensions, ospfIfType=ospfIfType, ospfNbrGroup=ospfNbrGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfBasicGroup2=ospfBasicGroup2, ospfExtLsdbAge=ospfExtLsdbAge, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, AreaID=AreaID, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfGroup2=ospfIfGroup2, ospfIfAreaId=ospfIfAreaId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubAreaTable=ospfStubAreaTable, ospfAsLsdbType=ospfAsLsdbType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrEntry=ospfNbrEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtNbrRtrId=ospfVirtNbrRtrId)
