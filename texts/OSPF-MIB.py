...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfAdminStat=ospfIfAdminStat, ospfRestartAge=ospfRestartAge, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfHostMetric=ospfHostMetric, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfExtLsdbType=ospfExtLsdbType, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrTable=ospfNbrTable, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, PositiveInteger=PositiveInteger, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfEntry=ospfIfEntry, ospfHostEntry=ospfHostEntry, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfTable=ospfIfTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrArea=ospfVirtNbrArea, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaGroup2=ospfAreaGroup2, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfHostIpAddress=ospfHostIpAddress, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfStatus=ospfIfStatus, ospfAreaRangeTable=ospfAreaRangeTable, BigMetric=BigMetric, ospfNbrOptions=ospfNbrOptions, ospfStubTOS=ospfStubTOS, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfGroup2=ospfIfGroup2, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfCompliances=ospfCompliances, ospfRestartSupport=ospfRestartSupport, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfStubAreaId=ospfStubAreaId, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaId=ospfAreaId, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfTOSSupport=ospfTOSSupport, ospfIfMulticastForwarding=ospfIfMulticastForwarding, AreaID=AreaID, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbTable=ospfLsdbTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfState=ospfVirtIfState, ospfNbrRtrId=ospfNbrRtrId, ospfIfPollInterval=ospfIfPollInterval, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfConformance=ospfConformance, PYSNMP_MODULE_ID=ospf, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrPriority=ospfNbrPriority, ospfAuthType=ospfAuthType, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfStubMetric=ospfStubMetric, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLsdbAge=ospfLsdbAge, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfMetricTOS=ospfIfMetricTOS, TOSType=TOSType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfMetricGroup=ospfIfMetricGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfMetricValue=ospfIfMetricValue, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfBasicGroup2=ospfBasicGroup2, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostGroup=ospfHostGroup, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExternalType1=ospfExternalType1, ospfLocalLsdbType=ospfLocalLsdbType, ospfLsdbSequence=ospfLsdbSequence, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfStubMetricType=ospfStubMetricType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsaCount=ospfAsLsaCount, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfTable=ospfVirtIfTable, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfRestartInterval=ospfRestartInterval, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfAuthKey=ospfIfAuthKey, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaTable=ospfAreaTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrEntry=ospfNbrEntry, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrGroup2=ospfNbrGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRxNewLsas=ospfRxNewLsas, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostTOS=ospfHostTOS, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaSummary=ospfAreaSummary, ospfVersionNumber=ospfVersionNumber, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfRouterId=ospfRouterId, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfGeneralGroup=ospfGeneralGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfMetricTable=ospfIfMetricTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrGroup=ospfNbrGroup, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfGroups=ospfGroups, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfStubAreaEntry=ospfStubAreaEntry, ospfAddressLessIf=ospfAddressLessIf, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospf=ospf, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfAreaId=ospfIfAreaId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtNbrState=ospfVirtNbrState, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaEntry=ospfAreaEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRestartExitReason=ospfRestartExitReason, ospfDemandExtensions=ospfDemandExtensions, Metric=Metric, ospfAreaAggregateStatus=ospfAreaAggregateStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfCompliance2=ospfCompliance2, ospfNbrIpAddr=ospfNbrIpAddr, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaStatus=ospfAreaStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExternLsaCount=ospfExternLsaCount, ospfIfType=ospfIfType, UpToMaxAge=UpToMaxAge, ospfCompliance=ospfCompliance, ospfBasicGroup=ospfBasicGroup, ospfSpfRuns=ospfSpfRuns, ospfAdminStat=ospfAdminStat, ospfStubAreaGroup=ospfStubAreaGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeNet=ospfAreaRangeNet, ospfHostTable=ospfHostTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRouteGroup=ospfRouteGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfStatus=ospfVirtIfStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, Status=Status, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIntraArea=ospfIntraArea, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAsLsdbLsid=ospfAsLsdbLsid, HelloRange=HelloRange, ospfIfState=ospfIfState, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfHostStatus=ospfHostStatus, OspfAuthenticationType=OspfAuthenticationType, ospfHostGroup2=ospfHostGroup2, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfEvents=ospfIfEvents, ospfIfDemand=ospfIfDemand, ospfInterArea=ospfInterArea, ospfIfGroup=ospfIfGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfObsoleteGroup=ospfObsoleteGroup, ospfHostAreaID=ospfHostAreaID, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, RouterID=RouterID, ospfLsdbType=ospfLsdbType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfEntry=ospfVirtIfEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfStubStatus=ospfStubStatus, ospfReferenceBandwidth=ospfReferenceBandwidth)
