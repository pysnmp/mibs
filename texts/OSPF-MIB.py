...
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricStatus=ospfIfMetricStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfGeneralGroup=ospfGeneralGroup, ospfAreaStatus=ospfAreaStatus, ospfStubStatus=ospfStubStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfInterArea=ospfInterArea, ospfVersionNumber=ospfVersionNumber, ospfCompliance=ospfCompliance, ospfIfGroup2=ospfIfGroup2, ospfNbrGroup2=ospfNbrGroup2, ospfAreaId=ospfAreaId, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrPriority=ospfNbrPriority, ospfIfState=ospfIfState, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfConformance=ospfConformance, ospfVirtNbrOptions=ospfVirtNbrOptions, BigMetric=BigMetric, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfImportAsExtern=ospfImportAsExtern, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfMetricValue=ospfIfMetricValue, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfHostTable=ospfHostTable, ospfVirtIfTable=ospfVirtIfTable, ospfNbrState=ospfNbrState, ospfIfEntry=ospfIfEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, UpToMaxAge=UpToMaxAge, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLsdbEntry=ospfLsdbEntry, ospfAreaTable=ospfAreaTable, ospfAddressLessIf=ospfAddressLessIf, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, HelloRange=HelloRange, ospfIfAuthType=ospfIfAuthType, ospfAreaSummary=ospfAreaSummary, ospfExternalType1=ospfExternalType1, ospfLsdbTable=ospfLsdbTable, ospfIfMetricTOS=ospfIfMetricTOS, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfRxNewLsas=ospfRxNewLsas, ospfNbrTable=ospfNbrTable, ospfIfPollInterval=ospfIfPollInterval, TOSType=TOSType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaRangeNet=ospfAreaRangeNet, ospfRestartStatus=ospfRestartStatus, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLsdbType=ospfLsdbType, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfIpAddress=ospfIfIpAddress, PositiveInteger=PositiveInteger, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfEvents=ospfIfEvents, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfGroup=ospfIfGroup, ospfRestartAge=ospfRestartAge, ospfVirtIfState=ospfVirtIfState, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAuthType=ospfAuthType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfRestartInterval=ospfRestartInterval, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfStubTOS=ospfStubTOS, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfRestartSupport=ospfRestartSupport, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrOptions=ospfNbrOptions, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfTOSSupport=ospfTOSSupport, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, Status=Status, ospfHostTOS=ospfHostTOS, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfDemand=ospfIfDemand, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAdminStat=ospfAdminStat, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfStatus=ospfIfStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospf=ospf, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfAreaId=ospfIfAreaId, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExternalType2=ospfExternalType2, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfMetricEntry=ospfIfMetricEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfType=ospfIfType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfStubMetricType=ospfStubMetricType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfLsaCount=ospfIfLsaCount, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfStubAreaId=ospfStubAreaId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbSequence=ospfLsdbSequence, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAsLsaCount=ospfAsLsaCount, ospfCompliance2=ospfCompliance2, ospfLsdbLsid=ospfLsdbLsid, Metric=Metric, PYSNMP_MODULE_ID=ospf, ospfHostStatus=ospfHostStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, AreaID=AreaID, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfBasicGroup2=ospfBasicGroup2, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExtLsdbType=ospfExtLsdbType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostGroup2=ospfHostGroup2, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfHostIpAddress=ospfHostIpAddress, ospfNbrEvents=ospfNbrEvents, ospfIntraArea=ospfIntraArea, ospfRouterId=ospfRouterId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfGroups=ospfGroups, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfStubMetric=ospfStubMetric, ospfAreaGroup=ospfAreaGroup, ospfIfAuthKey=ospfIfAuthKey, ospfExternLsaCount=ospfExternLsaCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbGroup=ospfLsdbGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrState=ospfVirtNbrState, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfMetricTable=ospfIfMetricTable, ospfAreaGroup2=ospfAreaGroup2, ospfAreaEntry=ospfAreaEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfBasicGroup=ospfBasicGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfTable=ospfIfTable, ospfLsdbAge=ospfLsdbAge, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrEntry=ospfNbrEntry, OspfAuthenticationType=OspfAuthenticationType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrGroup=ospfNbrGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostMetric=ospfHostMetric, RouterID=RouterID, ospfAreaRangeTable=ospfAreaRangeTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfAdminStat=ospfIfAdminStat, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbTable=ospfAsLsdbTable, ospfHostGroup=ospfHostGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfHostEntry=ospfHostEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType)
mibBuilder.exportSymbols("OSPF-MIB", ospfCompliances=ospfCompliances, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfSpfRuns=ospfSpfRuns, ospfNbrRtrId=ospfNbrRtrId)
