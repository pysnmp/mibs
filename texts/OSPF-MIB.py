...
mibBuilder.exportSymbols("OSPF-MIB", PYSNMP_MODULE_ID=ospf, ospfLsdbAge=ospfLsdbAge, ospfIfMetricValue=ospfIfMetricValue, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfAuthKey=ospfIfAuthKey, ospfRouteGroup=ospfRouteGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfCompliance2=ospfCompliance2, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbEntry=ospfLsdbEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, Status=Status, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfState=ospfVirtIfState, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaStatus=ospfAreaStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfStubMetricType=ospfStubMetricType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfRtrPriority=ospfIfRtrPriority, ospfRestartStatus=ospfRestartStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfMetricGroup=ospfIfMetricGroup, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaTable=ospfAreaTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaEntry=ospfAreaEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfStubAreaTable=ospfStubAreaTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfRestartAge=ospfRestartAge, ospfGeneralGroup=ospfGeneralGroup, ospfLsdbGroup=ospfLsdbGroup, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfHostGroup2=ospfHostGroup2, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIntraArea=ospfIntraArea, ospfBasicGroup2=ospfBasicGroup2, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfType=ospfIfType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRouterId=ospfRouterId, ospfIfState=ospfIfState, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaRangeTable=ospfAreaRangeTable, Metric=Metric, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfImportAsExtern=ospfImportAsExtern, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaId=ospfAreaId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfExtLsdbType=ospfExtLsdbType, ospfIfIpAddress=ospfIfIpAddress, ospfHostStatus=ospfHostStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfTOSSupport=ospfTOSSupport, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaGroup=ospfAreaGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrGroup=ospfNbrGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfAuthType=ospfIfAuthType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfNbrTable=ospfNbrTable, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfGroup=ospfVirtIfGroup, RouterID=RouterID, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, HelloRange=HelloRange, ospfNbrEvents=ospfNbrEvents, ospfBasicGroup=ospfBasicGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAddressLessIf=ospfAddressLessIf, ospfExternLsaCount=ospfExternLsaCount, ospfIfAreaId=ospfIfAreaId, ospfRestartInterval=ospfRestartInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfStubAreaId=ospfStubAreaId, ospfIfAdminStat=ospfIfAdminStat, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfConformance=ospfConformance, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfInterArea=ospfInterArea, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfDemand=ospfIfDemand, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbType=ospfLocalLsdbType, ospfLsdbTable=ospfLsdbTable, ospfIfEntry=ospfIfEntry, ospfStubTOS=ospfStubTOS, ospfNbrState=ospfNbrState, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrEntry=ospfNbrEntry, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLsdbLsid=ospfLsdbLsid, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostMetric=ospfHostMetric, ospfSpfRuns=ospfSpfRuns, ospfAsLsdbType=ospfAsLsdbType, AreaID=AreaID, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfHostEntry=ospfHostEntry, ospfNbrRtrId=ospfNbrRtrId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostGroup=ospfHostGroup, ospfRxNewLsas=ospfRxNewLsas, ospfHostTable=ospfHostTable, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostTOS=ospfHostTOS, ospfIfTable=ospfIfTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExtLsdbTable=ospfExtLsdbTable, ospfDemandExtensions=ospfDemandExtensions, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExternalType1=ospfExternalType1, ospfExternalType2=ospfExternalType2, ospfGroups=ospfGroups, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrGroup2=ospfNbrGroup2, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfGroup=ospfIfGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLsdbType=ospfLsdbType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfStubStatus=ospfStubStatus, ospfHostIpAddress=ospfHostIpAddress, TOSType=TOSType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAdminStat=ospfAdminStat, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfCompliance=ospfCompliance, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrPriority=ospfNbrPriority, ospfAsLsaCount=ospfAsLsaCount, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbAreaId=ospfLsdbAreaId, ospf=ospf, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, BigMetric=BigMetric, PositiveInteger=PositiveInteger, ospfStubAreaEntry=ospfStubAreaEntry, ospfStubMetric=ospfStubMetric, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfEvents=ospfIfEvents, ospfAreaGroup2=ospfAreaGroup2, ospfAreaSummary=ospfAreaSummary, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAuthType=ospfAuthType, ospfNbrOptions=ospfNbrOptions, UpToMaxAge=UpToMaxAge, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbSequence=ospfLsdbSequence, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfRestartExitReason=ospfRestartExitReason, ospfRestartSupport=ospfRestartSupport, ospfCompliances=ospfCompliances, ospfIfStatus=ospfIfStatus, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrState=ospfVirtNbrState)
mibBuilder.exportSymbols("OSPF-MIB", ospfVersionNumber=ospfVersionNumber, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfGroup2=ospfIfGroup2, ospfAreaAggregateNet=ospfAreaAggregateNet)
