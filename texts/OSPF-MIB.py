...
mibBuilder.exportSymbols("OSPF-MIB", ospfRestartAge=ospfRestartAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrState=ospfNbrState, ospfGroups=ospfGroups, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfRestartSupport=ospfRestartSupport, ospfIfAuthKey=ospfIfAuthKey, ospfAreaTable=ospfAreaTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfLsaCount=ospfIfLsaCount, ospfNbrEvents=ospfNbrEvents, ospfExternalType1=ospfExternalType1, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbType=ospfExtLsdbType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfStubAreaId=ospfStubAreaId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIntraArea=ospfIntraArea, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfGroup=ospfIfGroup, ospfLocalLsdbType=ospfLocalLsdbType, RouterID=RouterID, ospfCompliance=ospfCompliance, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaSummary=ospfAreaSummary, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExternLsaCount=ospfExternLsaCount, ospfHostMetric=ospfHostMetric, ospfLsdbTable=ospfLsdbTable, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRouteGroup=ospfRouteGroup, ospfStubMetric=ospfStubMetric, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfGeneralGroup=ospfGeneralGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfRestartStatus=ospfRestartStatus, ospfIfType=ospfIfType, ospfAreaId=ospfAreaId, ospfAsLsdbType=ospfAsLsdbType, ospfIfEvents=ospfIfEvents, ospfLsdbLsid=ospfLsdbLsid, ospfObsoleteGroup=ospfObsoleteGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfImportAsExtern=ospfImportAsExtern, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostEntry=ospfHostEntry, ospfIfGroup2=ospfIfGroup2, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfStubAreaTable=ospfStubAreaTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExternalType2=ospfExternalType2, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAuthType=ospfAuthType, ospfLsdbType=ospfLsdbType, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrEntry=ospfNbrEntry, ospfIfEntry=ospfIfEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfRouterId=ospfRouterId, ospfVirtNbrTable=ospfVirtNbrTable, ospfLsdbAge=ospfLsdbAge, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfBasicGroup2=ospfBasicGroup2, ospfIfIpAddress=ospfIfIpAddress, ospfAddressLessIf=ospfAddressLessIf, ospfIfAuthType=ospfIfAuthType, Metric=Metric, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVersionNumber=ospfVersionNumber, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfMetricTable=ospfIfMetricTable, BigMetric=BigMetric, UpToMaxAge=UpToMaxAge, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospf=ospf, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbChecksum=ospfLsdbChecksum, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfAdminStat=ospfIfAdminStat, ospfIfMetricValue=ospfIfMetricValue, ospfAreaGroup2=ospfAreaGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRxNewLsas=ospfRxNewLsas, ospfIfTable=ospfIfTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfCompliance2=ospfCompliance2, ospfHostStatus=ospfHostStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfStatus=ospfIfStatus, ospfNbrOptions=ospfNbrOptions, ospfNbrTable=ospfNbrTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrGroup2=ospfNbrGroup2, AreaID=AreaID, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfHelloInterval=ospfIfHelloInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAdminStat=ospfAdminStat, ospfIfTransitDelay=ospfIfTransitDelay, ospfConformance=ospfConformance, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, PositiveInteger=PositiveInteger, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaStatus=ospfAreaStatus, ospfRestartInterval=ospfRestartInterval, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfStubStatus=ospfStubStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfMulticastExtensions=ospfMulticastExtensions, ospfAsLsaCount=ospfAsLsaCount, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLsdbGroup=ospfLsdbGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrGroup=ospfNbrGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbGroup=ospfLocalLsdbGroup, OspfAuthenticationType=OspfAuthenticationType, TOSType=TOSType, ospfHostTable=ospfHostTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostGroup=ospfHostGroup, ospfDemandExtensions=ospfDemandExtensions, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfMetricStatus=ospfIfMetricStatus, HelloRange=HelloRange, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfDemand=ospfIfDemand, Status=Status, ospfHostTOS=ospfHostTOS, ospfBasicGroup=ospfBasicGroup, ospfCompliances=ospfCompliances, PYSNMP_MODULE_ID=ospf, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfAreaId=ospfIfAreaId, ospfIfState=ospfIfState, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfPollInterval=ospfIfPollInterval, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfStubTOS=ospfStubTOS, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfHostGroup2=ospfHostGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrPriority=ospfNbrPriority, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfTable=ospfVirtIfTable, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfInterArea=ospfInterArea, ospfAreaRangeTable=ospfAreaRangeTable, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrEntry=ospfVirtNbrEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfTOSSupport=ospfTOSSupport, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents)
