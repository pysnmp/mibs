...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubStatus=ospfStubStatus, ospfBasicGroup=ospfBasicGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrState=ospfVirtNbrState, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfHostStatus=ospfHostStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfState=ospfIfState, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrTable=ospfNbrTable, ospfSpfRuns=ospfSpfRuns, ospfAreaRangeNet=ospfAreaRangeNet, ospfCompliance=ospfCompliance, ospfExtLsdbType=ospfExtLsdbType, ospfIfMetricValue=ospfIfMetricValue, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfStatus=ospfIfStatus, ospfRestartAge=ospfRestartAge, ospfTOSSupport=ospfTOSSupport, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbSequence=ospfExtLsdbSequence, Status=Status, ospfAuthType=ospfAuthType, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfHostTable=ospfHostTable, ospfImportAsExtern=ospfImportAsExtern, ospfIfAdminStat=ospfIfAdminStat, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbGroup=ospfAsLsdbGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubMetric=ospfStubMetric, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfGroup2=ospfIfGroup2, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfHostGroup2=ospfHostGroup2, ospfStubAreaGroup=ospfStubAreaGroup, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, TOSType=TOSType, ospfAreaId=ospfAreaId, ospfHostAreaID=ospfHostAreaID, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfType=ospfIfType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubAreaTable=ospfStubAreaTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrPriority=ospfNbrPriority, ospfAreaGroup=ospfAreaGroup, ospfStubAreaId=ospfStubAreaId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfRouterId=ospfRouterId, ospfVirtIfTable=ospfVirtIfTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfEntry=ospfIfEntry, ospfDemandExtensions=ospfDemandExtensions, ospfIfGroup=ospfIfGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, UpToMaxAge=UpToMaxAge, ospfIfLsaCount=ospfIfLsaCount, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIntraArea=ospfIntraArea, ospfIfDemand=ospfIfDemand, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfNbrRtrId=ospfNbrRtrId, ospfLsdbTable=ospfLsdbTable, ospfIfMetricTable=ospfIfMetricTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfAuthType=ospfIfAuthType, ospfLsdbGroup=ospfLsdbGroup, AreaID=AreaID, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospf=ospf, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaSummary=ospfAreaSummary, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExternLsaCount=ospfExternLsaCount, OspfAuthenticationType=OspfAuthenticationType, ospfRestartSupport=ospfRestartSupport, ospfNbrGroup=ospfNbrGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, BigMetric=BigMetric, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfTable=ospfIfTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLsdbAge=ospfLsdbAge, PositiveInteger=PositiveInteger, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfInterArea=ospfInterArea, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfMetricEntry=ospfIfMetricEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrArea=ospfVirtNbrArea, ospfBasicGroup2=ospfBasicGroup2, ospfRxNewLsas=ospfRxNewLsas, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfGroup=ospfVirtIfGroup, ospfConformance=ospfConformance, ospfNbrEvents=ospfNbrEvents, ospfAreaTable=ospfAreaTable, HelloRange=HelloRange, ospfHostTOS=ospfHostTOS, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfIpAddress=ospfIfIpAddress, ospfNbrGroup2=ospfNbrGroup2, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfGroups=ospfGroups, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfExtLsdbAge=ospfExtLsdbAge, ospfAdminStat=ospfAdminStat, ospfStubMetricType=ospfStubMetricType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaLsaCount=ospfAreaLsaCount, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaStatus=ospfAreaStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, PYSNMP_MODULE_ID=ospf, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfTransitDelay=ospfIfTransitDelay, ospfAddressLessIf=ospfAddressLessIf, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfStubTOS=ospfStubTOS, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfCompliance2=ospfCompliance2, Metric=Metric, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfRestartExitReason=ospfRestartExitReason, ospfVersionNumber=ospfVersionNumber, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfCompliances=ospfCompliances, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsdbTable=ospfAsLsdbTable, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfNbrState=ospfNbrState, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExternalType1=ospfExternalType1, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsaCount=ospfAsLsaCount, ospfLsdbAreaId=ospfLsdbAreaId, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfEntry=ospfVirtIfEntry, RouterID=RouterID, ospfHostGroup=ospfHostGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfEvents=ospfIfEvents, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaEntry=ospfAreaEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfMetricStatus=ospfIfMetricStatus, ospfExternalType2=ospfExternalType2, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLsdbType=ospfLsdbType, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfRestartInterval=ospfRestartInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfAreaId=ospfIfAreaId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfHostMetric=ospfHostMetric, ospfAreaAggregateEffect=ospfAreaAggregateEffect)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtNbrGroup=ospfVirtNbrGroup)
