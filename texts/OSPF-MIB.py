...
mibBuilder.exportSymbols("OSPF-MIB", ospfHostGroup=ospfHostGroup, ospfIfDemand=ospfIfDemand, ospfVirtNbrState=ospfVirtNbrState, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtIfAreaId=ospfVirtIfAreaId, RouterID=RouterID, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfHostGroup2=ospfHostGroup2, ospfNbrEntry=ospfNbrEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLsdbRouterId=ospfLsdbRouterId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubAreaEntry=ospfStubAreaEntry, ospfConformance=ospfConformance, ospfExternalType2=ospfExternalType2, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfGroups=ospfGroups, ospfIfAdminStat=ospfIfAdminStat, UpToMaxAge=UpToMaxAge, ospfNbrGroup=ospfNbrGroup, ospfCompliances=ospfCompliances, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAuthType=ospfAuthType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubAreaGroup=ospfStubAreaGroup, ospfVersionNumber=ospfVersionNumber, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfHostEntry=ospfHostEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfState=ospfVirtIfState, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfRestartInterval=ospfRestartInterval, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubAreaId=ospfStubAreaId, ospfExternalType1=ospfExternalType1, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsLsdbTable=ospfAsLsdbTable, ospfImportAsExtern=ospfImportAsExtern, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrPriority=ospfNbrPriority, ospfIfTable=ospfIfTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbAge=ospfLocalLsdbAge, OspfAuthenticationType=OspfAuthenticationType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfHostIpAddress=ospfHostIpAddress, ospfAdminStat=ospfAdminStat, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrIpAddr=ospfNbrIpAddr, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaTable=ospfAreaTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfHostMetric=ospfHostMetric, ospfIntraArea=ospfIntraArea, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbTable=ospfLsdbTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfGroup2=ospfIfGroup2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfAreaId=ospfIfAreaId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, PositiveInteger=PositiveInteger, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfMetricTable=ospfIfMetricTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfSpfRuns=ospfSpfRuns, BigMetric=BigMetric, ospfRestartSupport=ospfRestartSupport, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaGroup=ospfAreaGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLsdbAge=ospfLsdbAge, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospf=ospf, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricEntry=ospfIfMetricEntry, ospfStubStatus=ospfStubStatus, HelloRange=HelloRange, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRouterId=ospfRouterId, PYSNMP_MODULE_ID=ospf, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsdbType=ospfAsLsdbType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrEvents=ospfNbrEvents, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrGroup2=ospfVirtNbrGroup2, Metric=Metric, ospfLsdbLsid=ospfLsdbLsid, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaId=ospfAreaId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfType=ospfIfType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfStubMetric=ospfStubMetric, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbEntry=ospfLsdbEntry, ospfRestartStatus=ospfRestartStatus, ospfLsdbType=ospfLsdbType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaStatus=ospfAreaStatus, ospfStubAreaTable=ospfStubAreaTable, ospfHostStatus=ospfHostStatus, ospfIfStatus=ospfIfStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaEntry=ospfAreaEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrOptions=ospfNbrOptions, ospfNbrGroup2=ospfNbrGroup2, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfHostTOS=ospfHostTOS, ospfNbrTable=ospfNbrTable, ospfIfPollInterval=ospfIfPollInterval, ospfIfMetricValue=ospfIfMetricValue, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsaCount=ospfAsLsaCount, ospfRestartExitReason=ospfRestartExitReason, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, AreaID=AreaID, ospfIfIpAddress=ospfIfIpAddress, ospfIfEntry=ospfIfEntry, ospfAreaSummary=ospfAreaSummary, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfGroup=ospfIfGroup, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfRestartAge=ospfRestartAge, ospfRouteGroup=ospfRouteGroup, TOSType=TOSType, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfCompliance2=ospfCompliance2, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRxNewLsas=ospfRxNewLsas, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubMetricType=ospfStubMetricType, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfDemandExtensions=ospfDemandExtensions, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfEvents=ospfIfEvents, ospfStubTOS=ospfStubTOS, ospfIfState=ospfIfState, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfHostAreaID=ospfHostAreaID, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLsdbAreaId=ospfLsdbAreaId, ospfCompliance=ospfCompliance, ospfIfAuthType=ospfIfAuthType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExtLsdbType=ospfExtLsdbType, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbGroup=ospfLsdbGroup, ospfBasicGroup2=ospfBasicGroup2, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, Status=Status, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount)
mibBuilder.exportSymbols("OSPF-MIB", ospfTOSSupport=ospfTOSSupport, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfHostTable=ospfHostTable)
