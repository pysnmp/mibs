...
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfIpAddress=ospfIfIpAddress, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfMetricTable=ospfIfMetricTable, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbGroup=ospfLsdbGroup, ospfIfLsaCount=ospfIfLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfEntry=ospfIfEntry, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfCompliance=ospfCompliance, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfHostTOS=ospfHostTOS, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfStubAreaEntry=ospfStubAreaEntry, ospf=ospf, ospfAreaId=ospfAreaId, ospfSpfRuns=ospfSpfRuns, Metric=Metric, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfType=ospfIfType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsaCount=ospfAsLsaCount, ospfExternLsaCount=ospfExternLsaCount, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaGroup2=ospfAreaGroup2, ospfLsdbChecksum=ospfLsdbChecksum, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfRxNewLsas=ospfRxNewLsas, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLsdbLsid=ospfLsdbLsid, ospfAreaTable=ospfAreaTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbType=ospfLocalLsdbType, AreaID=AreaID, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExternalType1=ospfExternalType1, ospfAreaEntry=ospfAreaEntry, ospfHostIpAddress=ospfHostIpAddress, ospfIfState=ospfIfState, ospfNbrState=ospfNbrState, DesignatedRouterPriority=DesignatedRouterPriority, ospfAddressLessIf=ospfAddressLessIf, ospfIntraArea=ospfIntraArea, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLocalLsdbGroup=ospfLocalLsdbGroup, RouterID=RouterID, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubTOS=ospfStubTOS, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfStubMetricType=ospfStubMetricType, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostGroup=ospfHostGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, UpToMaxAge=UpToMaxAge, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfRestartInterval=ospfRestartInterval, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrGroup=ospfNbrGroup, ospfHostGroup2=ospfHostGroup2, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfCompliance2=ospfCompliance2, ospfExtLsdbType=ospfExtLsdbType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAdminStat=ospfAdminStat, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtIfState=ospfVirtIfState, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubAreaId=ospfStubAreaId, HelloRange=HelloRange, ospfRestartAge=ospfRestartAge, PYSNMP_MODULE_ID=ospf, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfImportAsExtern=ospfImportAsExtern, ospfHostMetric=ospfHostMetric, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrState=ospfVirtNbrState, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLsdbTable=ospfLsdbTable, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfTOSSupport=ospfTOSSupport, ospfLsdbType=ospfLsdbType, ospfRestartSupport=ospfRestartSupport, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrEntry=ospfNbrEntry, OspfAuthenticationType=OspfAuthenticationType, ospfIfDemand=ospfIfDemand, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfHostStatus=ospfHostStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfStubStatus=ospfStubStatus, ospfIfStatus=ospfIfStatus, ospfIfAreaId=ospfIfAreaId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfGroup2=ospfIfGroup2, ospfNbrTable=ospfNbrTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAuthType=ospfAuthType, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbAge=ospfLsdbAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfConformance=ospfConformance, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfEvents=ospfIfEvents, ospfIfMetricEntry=ospfIfMetricEntry, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaSummary=ospfAreaSummary, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricValue=ospfIfMetricValue, TOSType=TOSType, ospfRestartStatus=ospfRestartStatus, ospfInterArea=ospfInterArea, ospfAreaStatus=ospfAreaStatus, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfHostEntry=ospfHostEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRouterId=ospfRouterId, ospfRouteGroup=ospfRouteGroup, ospfIfAuthType=ospfIfAuthType, ospfVirtIfStatus=ospfVirtIfStatus, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbSequence=ospfLsdbSequence, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfCompliances=ospfCompliances, ospfIfAuthKey=ospfIfAuthKey, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeNet=ospfAreaRangeNet, ospfHostAreaID=ospfHostAreaID, ospfGroups=ospfGroups, ospfNbrGroup2=ospfNbrGroup2, ospfStubAreaGroup=ospfStubAreaGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfAdminStat=ospfIfAdminStat, PositiveInteger=PositiveInteger, ospfVersionNumber=ospfVersionNumber, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubMetric=ospfStubMetric, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostTable=ospfHostTable, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbRouterId=ospfAsLsdbRouterId, BigMetric=BigMetric, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfTable=ospfVirtIfTable, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbTable=ospfExtLsdbTable, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, Status=Status, ospfNbrRtrId=ospfNbrRtrId, ospfNbrEvents=ospfNbrEvents, ospfExternalType2=ospfExternalType2, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfTable=ospfIfTable, ospfGeneralGroup=ospfGeneralGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfStubAreaTable=ospfStubAreaTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbAge=ospfExtLsdbAge)
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter)
