...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfDemand=ospfIfDemand, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaEntry=ospfAreaEntry, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, BigMetric=BigMetric, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfRetransInterval=ospfIfRetransInterval, ospfConformance=ospfConformance, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfLsaCount=ospfIfLsaCount, ospfRestartInterval=ospfRestartInterval, ospfIfEntry=ospfIfEntry, ospfStubMetricType=ospfStubMetricType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrGroup=ospfNbrGroup, ospfAreaGroup2=ospfAreaGroup2, ospfCompliance=ospfCompliance, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfRestartStatus=ospfRestartStatus, ospfTOSSupport=ospfTOSSupport, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfAreaId=ospfIfAreaId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfEvents=ospfIfEvents, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfStubAreaId=ospfStubAreaId, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExternalType2=ospfExternalType2, ospfIntraArea=ospfIntraArea, ospfNbrRtrId=ospfNbrRtrId, ospfStubStatus=ospfStubStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfCompliances=ospfCompliances, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, Status=Status, ospfHostTable=ospfHostTable, ospfBasicGroup=ospfBasicGroup, ospfHostStatus=ospfHostStatus, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfState=ospfIfState, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfSpfRuns=ospfSpfRuns, ospfExternalType1=ospfExternalType1, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExtLsdbType=ospfExtLsdbType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfGeneralGroup=ospfGeneralGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfMetricValue=ospfIfMetricValue, ospfIfMetricEntry=ospfIfMetricEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostEntry=ospfHostEntry, ospf=ospf, ospfAsLsaCount=ospfAsLsaCount, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfRestartSupport=ospfRestartSupport, ospfHostMetric=ospfHostMetric, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfTable=ospfVirtIfTable, ospfRestartExitReason=ospfRestartExitReason, ospfAreaTable=ospfAreaTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrGroup2=ospfNbrGroup2, ospfStubTOS=ospfStubTOS, ospfHostIpAddress=ospfHostIpAddress, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubAreaTable=ospfStubAreaTable, ospfIfAdminStat=ospfIfAdminStat, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaStatus=ospfAreaStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfGroup=ospfIfGroup, ospfImportAsExtern=ospfImportAsExtern, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrState=ospfVirtNbrState, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrTable=ospfNbrTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrState=ospfNbrState, TOSType=TOSType, ospfAuthType=ospfAuthType, ospfRxNewLsas=ospfRxNewLsas, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostGroup=ospfHostGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAsLsdbType=ospfAsLsdbType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaId=ospfAreaId, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfGroups=ospfGroups, ospfRestartAge=ospfRestartAge, ospfAreaLsaCount=ospfAreaLsaCount, AreaID=AreaID, ospfLsdbTable=ospfLsdbTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfHostAreaID=ospfHostAreaID, ospfVirtIfState=ospfVirtIfState, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLsdbAreaId=ospfLsdbAreaId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfStatus=ospfIfStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfDemandExtensions=ospfDemandExtensions, HelloRange=HelloRange, ospfAreaLsaCountTable=ospfAreaLsaCountTable, OspfAuthenticationType=OspfAuthenticationType, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostGroup2=ospfHostGroup2, ospfVirtIfGroup=ospfVirtIfGroup, RouterID=RouterID, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaRangeMask=ospfAreaRangeMask, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfComplianceObsolete=ospfComplianceObsolete, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfStubMetric=ospfStubMetric, ospfLsdbGroup=ospfLsdbGroup, PositiveInteger=PositiveInteger, ospfRouterId=ospfRouterId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfStatus=ospfVirtIfStatus, ospfBasicGroup2=ospfBasicGroup2, UpToMaxAge=UpToMaxAge, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfRouteGroup=ospfRouteGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, PYSNMP_MODULE_ID=ospf, ospfIfIpAddress=ospfIfIpAddress, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbType=ospfLsdbType, ospfNbrIpAddr=ospfNbrIpAddr, ospfInterArea=ospfInterArea, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrArea=ospfVirtNbrArea, ospfStubAreaGroup=ospfStubAreaGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaSummary=ospfAreaSummary, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAdminStat=ospfAdminStat, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbSequence=ospfLsdbSequence, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, Metric=Metric, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbEntry=ospfLsdbEntry, ospfIfType=ospfIfType, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbAge=ospfLsdbAge, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfMetricTable=ospfIfMetricTable, ospfIfGroup2=ospfIfGroup2, ospfIfTable=ospfIfTable, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfCompliance2=ospfCompliance2, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrOptions=ospfNbrOptions, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVersionNumber=ospfVersionNumber, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExitOverflowInterval=ospfExitOverflowInterval)
