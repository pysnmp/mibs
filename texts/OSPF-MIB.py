...
mibBuilder.exportSymbols("OSPF-MIB", ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfMetricTable=ospfIfMetricTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfIpAddress=ospfIfIpAddress, ospfExternalType1=ospfExternalType1, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrState=ospfVirtNbrState, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfBasicGroup=ospfBasicGroup, ospfNbrEvents=ospfNbrEvents, ospfTOSSupport=ospfTOSSupport, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaTable=ospfAreaTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIntraArea=ospfIntraArea, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrEntry=ospfNbrEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAuthType=ospfAuthType, ospfAreaSummary=ospfAreaSummary, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbrGroup=ospfNbrGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfGroup2=ospfIfGroup2, ospfVersionNumber=ospfVersionNumber, ospfHostIpAddress=ospfHostIpAddress, ospfRouteGroup=ospfRouteGroup, Status=Status, ospfStubStatus=ospfStubStatus, ospfExternalType2=ospfExternalType2, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbTable=ospfAsLsdbTable, TOSType=TOSType, ospfVirtIfEntry=ospfVirtIfEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfEvents=ospfIfEvents, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfAuthType=ospfIfAuthType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfAdminStat=ospfIfAdminStat, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfRestartStatus=ospfRestartStatus, ospfAreaStatus=ospfAreaStatus, OspfAuthenticationType=OspfAuthenticationType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfEntry=ospfIfEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfRestartInterval=ospfRestartInterval, RouterID=RouterID, ospfAreaRangeNet=ospfAreaRangeNet, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfDemandExtensions=ospfDemandExtensions, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfGroup=ospfIfGroup, ospfCompliance=ospfCompliance, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfCompliances=ospfCompliances, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfRtrPriority=ospfIfRtrPriority, ospfConformance=ospfConformance, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostTOS=ospfHostTOS, ospfReferenceBandwidth=ospfReferenceBandwidth, BigMetric=BigMetric, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbType=ospfLsdbType, ospfRestartSupport=ospfRestartSupport, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfGroups=ospfGroups, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbRouterId=ospfLsdbRouterId, ospfHostAreaID=ospfHostAreaID, ospfAreaId=ospfAreaId, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrRtrId=ospfNbrRtrId, ospfIfTable=ospfIfTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, PositiveInteger=PositiveInteger, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfRxNewLsas=ospfRxNewLsas, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExtLsdbType=ospfExtLsdbType, ospf=ospf, ospfLocalLsdbType=ospfLocalLsdbType, PYSNMP_MODULE_ID=ospf, ospfAreaGroup2=ospfAreaGroup2, ospfHostStatus=ospfHostStatus, ospfIfAuthKey=ospfIfAuthKey, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfLsaCount=ospfIfLsaCount, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLsdbTable=ospfLsdbTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfTable=ospfVirtIfTable, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfMetricValue=ospfIfMetricValue, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrOptions=ospfNbrOptions, ospfBasicGroup2=ospfBasicGroup2, ospfHostGroup=ospfHostGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfRouterId=ospfRouterId, UpToMaxAge=UpToMaxAge, ospfAddressLessIf=ospfAddressLessIf, ospfStubAreaId=ospfStubAreaId, ospfStubMetric=ospfStubMetric, ospfInterArea=ospfInterArea, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfObsoleteGroup=ospfObsoleteGroup, ospfAdminStat=ospfAdminStat, ospfHostMetric=ospfHostMetric, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRestartAge=ospfRestartAge, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfState=ospfVirtIfState, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsLsaCount=ospfAsLsaCount, ospfStubAreaTable=ospfStubAreaTable, ospfIfAreaId=ospfIfAreaId, ospfIfType=ospfIfType, ospfIfStatus=ospfIfStatus, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbGroup=ospfLsdbGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, AreaID=AreaID, ospfNbrState=ospfNbrState, ospfLsdbAge=ospfLsdbAge, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfSpfRuns=ospfSpfRuns, ospfStubTOS=ospfStubTOS, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaGroup=ospfAreaGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrTable=ospfNbrTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfState=ospfIfState, ospfHostTable=ospfHostTable, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfMulticastExtensions=ospfMulticastExtensions, Metric=Metric, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrIpAddr=ospfNbrIpAddr, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbLsid=ospfLsdbLsid, ospfStubAreaEntry=ospfStubAreaEntry, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfCompliance2=ospfCompliance2, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsdbAge=ospfAsLsdbAge, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfRestartExitReason=ospfRestartExitReason, HelloRange=HelloRange, ospfIfDemand=ospfIfDemand, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfStubMetricType=ospfStubMetricType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLsdbSequence=ospfLsdbSequence, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaRangeEffect=ospfAreaRangeEffect)
