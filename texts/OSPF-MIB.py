...
mibBuilder.exportSymbols("OSPF-MIB", DesignatedRouterPriority=DesignatedRouterPriority, OspfAuthenticationType=OspfAuthenticationType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfStubAreaTable=ospfStubAreaTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, TOSType=TOSType, ospfNbrPriority=ospfNbrPriority, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExternalType1=ospfExternalType1, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfConformance=ospfConformance, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRestartAge=ospfRestartAge, ospfIfAuthKey=ospfIfAuthKey, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, Metric=Metric, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLsdbRouterId=ospfLsdbRouterId, ospfRestartInterval=ospfRestartInterval, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExternalType2=ospfExternalType2, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLsdbChecksum=ospfLsdbChecksum, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfSpfRuns=ospfSpfRuns, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfTransitDelay=ospfIfTransitDelay, PYSNMP_MODULE_ID=ospf, ospfRestartSupport=ospfRestartSupport, ospfStubStatus=ospfStubStatus, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateTable=ospfAreaAggregateTable, Status=Status, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfNbrTable=ospfNbrTable, ospfVirtNbrState=ospfVirtNbrState, ospfInterArea=ospfInterArea, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfCompliance=ospfCompliance, ospfIfMetricGroup=ospfIfMetricGroup, ospfImportAsExtern=ospfImportAsExtern, ospfRestartStatus=ospfRestartStatus, ospfAreaEntry=ospfAreaEntry, BigMetric=BigMetric, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospf=ospf, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfHostStatus=ospfHostStatus, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbType=ospfAsLsdbType, ospfAreaRangeTable=ospfAreaRangeTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaTable=ospfAreaTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostEntry=ospfHostEntry, ospfVersionNumber=ospfVersionNumber, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIntraArea=ospfIntraArea, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfGroup=ospfIfGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfStubTOS=ospfStubTOS, ospfIfEntry=ospfIfEntry, ospfTOSSupport=ospfTOSSupport, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrOptions=ospfNbrOptions, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLocalLsdbType=ospfLocalLsdbType, ospfRestartExitReason=ospfRestartExitReason, UpToMaxAge=UpToMaxAge, ospfStubMetric=ospfStubMetric, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfRouterId=ospfRouterId, PositiveInteger=PositiveInteger, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfHostAreaID=ospfHostAreaID, AreaID=AreaID, ospfAreaSummary=ospfAreaSummary, ospfAreaId=ospfAreaId, ospfHostTOS=ospfHostTOS, ospfIfGroup2=ospfIfGroup2, ospfIfState=ospfIfState, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExtLsdbTable=ospfExtLsdbTable, ospfBasicGroup2=ospfBasicGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfIpAddress=ospfIfIpAddress, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfRouteGroup=ospfRouteGroup, ospfHostGroup=ospfHostGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfType=ospfIfType, ospfStubAreaId=ospfStubAreaId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfBasicGroup=ospfBasicGroup, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfDemand=ospfIfDemand, ospfIfMetricValue=ospfIfMetricValue, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfDemandExtensions=ospfDemandExtensions, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfStatus=ospfVirtIfStatus, ospfCompliances=ospfCompliances, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfAreaId=ospfIfAreaId, RouterID=RouterID, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbSequence=ospfLocalLsdbSequence, HelloRange=HelloRange, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfHostTable=ospfHostTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfCompliance2=ospfCompliance2, ospfNbrGroup2=ospfNbrGroup2, ospfNbrState=ospfNbrState, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrEvents=ospfNbrEvents, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfStubMetricType=ospfStubMetricType, ospfStubRouterSupport=ospfStubRouterSupport, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfGeneralGroup=ospfGeneralGroup, ospfAreaStatus=ospfAreaStatus, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrEntry=ospfNbrEntry, ospfNbrGroup=ospfNbrGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaGroup2=ospfAreaGroup2, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfGroups=ospfGroups, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfStatus=ospfIfStatus, ospfAddressLessIf=ospfAddressLessIf, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAdminStat=ospfAdminStat, ospfExtLsdbType=ospfExtLsdbType, ospfRxNewLsas=ospfRxNewLsas, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfStubAreaGroup=ospfStubAreaGroup, ospfLsdbGroup=ospfLsdbGroup, ospfLsdbSequence=ospfLsdbSequence, ospfExternLsaCount=ospfExternLsaCount, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfTable=ospfIfTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaGroup=ospfAreaGroup, ospfAuthType=ospfAuthType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfHostGroup2=ospfHostGroup2, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbEntry=ospfLsdbEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLsdbTable=ospfLsdbTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfPollInterval=ospfIfPollInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbType=ospfLsdbType, ospfHostIpAddress=ospfHostIpAddress)
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostMetric=ospfHostMetric)
