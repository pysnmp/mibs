...
mibBuilder.exportSymbols("OSPF-MIB", ospfInterArea=ospfInterArea, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbAge=ospfLsdbAge, ospfVirtIfGroup=ospfVirtIfGroup, ospfBasicGroup2=ospfBasicGroup2, ospfExtLsdbTable=ospfExtLsdbTable, ospfRestartInterval=ospfRestartInterval, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospf=ospf, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrOptions=ospfNbrOptions, ospfHostGroup=ospfHostGroup, ospfLsdbSequence=ospfLsdbSequence, ospfAdminStat=ospfAdminStat, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfMetricValue=ospfIfMetricValue, ospfIfTransitDelay=ospfIfTransitDelay, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLsdbAreaId=ospfLsdbAreaId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbSequence=ospfLocalLsdbSequence, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaRangeTable=ospfAreaRangeTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLocalLsdbType=ospfLocalLsdbType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfHostStatus=ospfHostStatus, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRxNewLsas=ospfRxNewLsas, OspfAuthenticationType=OspfAuthenticationType, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfDemand=ospfIfDemand, ospfLsdbChecksum=ospfLsdbChecksum, ospfVersionNumber=ospfVersionNumber, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfExternLsaCount=ospfExternLsaCount, ospfRouterId=ospfRouterId, ospfAreaEntry=ospfAreaEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfState=ospfVirtIfState, ospfAreaSummary=ospfAreaSummary, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfStubAreaTable=ospfStubAreaTable, ospfStubStatus=ospfStubStatus, ospfIfStatus=ospfIfStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaLsaCount=ospfAreaLsaCount, ospfRestartStatus=ospfRestartStatus, ospfRouteGroup=ospfRouteGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaStatus=ospfAreaStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfMetricGroup=ospfIfMetricGroup, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfAreaId=ospfIfAreaId, ospfIfAdminStat=ospfIfAdminStat, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfAuthKey=ospfIfAuthKey, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfCompliance=ospfCompliance, PYSNMP_MODULE_ID=ospf, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfHostTable=ospfHostTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaGroup=ospfAreaGroup, ospfLsdbGroup=ospfLsdbGroup, Status=Status, ospfIfRetransInterval=ospfIfRetransInterval, ospfGroups=ospfGroups, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, PositiveInteger=PositiveInteger, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsLsdbType=ospfAsLsdbType, ospfImportAsExtern=ospfImportAsExtern, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLsdbType=ospfLsdbType, ospfExtLsdbAge=ospfExtLsdbAge, ospfExternalType2=ospfExternalType2, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAuthType=ospfAuthType, ospfVirtNbrTable=ospfVirtNbrTable, BigMetric=BigMetric, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostGroup2=ospfHostGroup2, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAddressLessIf=ospfAddressLessIf, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfStubAreaId=ospfStubAreaId, ospfNbrEntry=ospfNbrEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostMetric=ospfHostMetric, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbrRtrId=ospfNbrRtrId, ospfNbrEvents=ospfNbrEvents, TOSType=TOSType, ospfAreaId=ospfAreaId, ospfHostAreaID=ospfHostAreaID, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubAreaEntry=ospfStubAreaEntry, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLsdbEntry=ospfLsdbEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrPriority=ospfNbrPriority, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfGeneralGroup=ospfGeneralGroup, ospfStubMetricType=ospfStubMetricType, ospfIfIpAddress=ospfIfIpAddress, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfGroup2=ospfIfGroup2, ospfIfState=ospfIfState, ospfExternalType1=ospfExternalType1, UpToMaxAge=UpToMaxAge, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrGroup2=ospfNbrGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfHostTOS=ospfHostTOS, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIntraArea=ospfIntraArea, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfDemandExtensions=ospfDemandExtensions, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfCompliance2=ospfCompliance2, ospfHostEntry=ospfHostEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfCompliances=ospfCompliances, ospfStubRouterSupport=ospfStubRouterSupport, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfTable=ospfVirtIfTable, ospfIfTable=ospfIfTable, ospfTOSSupport=ospfTOSSupport, Metric=Metric, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfBasicGroup=ospfBasicGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfGroup=ospfIfGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, AreaID=AreaID, ospfIfEvents=ospfIfEvents, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfStubTOS=ospfStubTOS, RouterID=RouterID, ospfAreaTable=ospfAreaTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfComplianceObsolete=ospfComplianceObsolete, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfRestartAge=ospfRestartAge, ospfIfPollInterval=ospfIfPollInterval, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfConformance=ospfConformance, ospfIfLsaCount=ospfIfLsaCount, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrState=ospfNbrState, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfStubMetric=ospfStubMetric, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfType=ospfIfType, ospfIfEntry=ospfIfEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, HelloRange=HelloRange, ospfExtLsdbType=ospfExtLsdbType, ospfRestartSupport=ospfRestartSupport, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateEffect=ospfAreaAggregateEffect)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf)
