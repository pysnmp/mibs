...
mibBuilder.exportSymbols("OSPF-MIB", ospfStubAreaTable=ospfStubAreaTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfHostAreaID=ospfHostAreaID, ospf=ospf, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfDemandExtensions=ospfDemandExtensions, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfRouterId=ospfRouterId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfHostTable=ospfHostTable, ospfHostTOS=ospfHostTOS, ospfHostIpAddress=ospfHostIpAddress, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfGroup2=ospfIfGroup2, ospfStubTOS=ospfStubTOS, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsaCount=ospfAsLsaCount, ospfConformance=ospfConformance, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfHostEntry=ospfHostEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbEntry=ospfLocalLsdbEntry, Status=Status, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIntraArea=ospfIntraArea, ospfIfTable=ospfIfTable, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfMetricTable=ospfIfMetricTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfBasicGroup2=ospfBasicGroup2, ospfIfMetricValue=ospfIfMetricValue, ospfTOSSupport=ospfTOSSupport, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfNbrIpAddr=ospfNbrIpAddr, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfRetransInterval=ospfIfRetransInterval, ospfLocalLsdbType=ospfLocalLsdbType, ospfStubRouterSupport=ospfStubRouterSupport, UpToMaxAge=UpToMaxAge, PositiveInteger=PositiveInteger, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfTransitDelay=ospfIfTransitDelay, ospfInterArea=ospfInterArea, ospfVirtNbrRtrId=ospfVirtNbrRtrId, BigMetric=BigMetric, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAddressLessIf=ospfAddressLessIf, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLsdbEntry=ospfLsdbEntry, ospfRestartAge=ospfRestartAge, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaId=ospfAreaId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfExtLsdbType=ospfExtLsdbType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAsLsdbType=ospfAsLsdbType, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLsdbLsid=ospfLsdbLsid, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfPollInterval=ospfIfPollInterval, ospfAreaEntry=ospfAreaEntry, ospfIfEntry=ospfIfEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfNbrGroup2=ospfNbrGroup2, ospfImportAsExtern=ospfImportAsExtern, ospfNbrState=ospfNbrState, ospfRestartSupport=ospfRestartSupport, ospfVirtIfState=ospfVirtIfState, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfSpfRuns=ospfSpfRuns, ospfIfAuthKey=ospfIfAuthKey, ospfIfType=ospfIfType, ospfExtLsdbTable=ospfExtLsdbTable, ospfHostGroup=ospfHostGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfState=ospfIfState, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfMetricGroup=ospfIfMetricGroup, OspfAuthenticationType=OspfAuthenticationType, ospfStubAreaGroup=ospfStubAreaGroup, ospfRestartInterval=ospfRestartInterval, ospfCompliance=ospfCompliance, ospfLsdbAge=ospfLsdbAge, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfStatus=ospfIfStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfCompliance2=ospfCompliance2, ospfBasicGroup=ospfBasicGroup, ospfIfAuthType=ospfIfAuthType, ospfAreaSummary=ospfAreaSummary, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfGroup=ospfIfGroup, ospfHostMetric=ospfHostMetric, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfCompliances=ospfCompliances, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubAreaId=ospfStubAreaId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, TOSType=TOSType, ospfNbrTable=ospfNbrTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfHostStatus=ospfHostStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrPriority=ospfNbrPriority, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, PYSNMP_MODULE_ID=ospf, ospfIfLsaCount=ospfIfLsaCount, ospfStubMetric=ospfStubMetric, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfMetricTOS=ospfIfMetricTOS, ospfRestartStatus=ospfRestartStatus, ospfLsdbSequence=ospfLsdbSequence, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrArea=ospfVirtNbrArea, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLsdbRouterId=ospfLsdbRouterId, RouterID=RouterID, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfDemand=ospfIfDemand, ospfLsdbType=ospfLsdbType, ospfIfEvents=ospfIfEvents, ospfAuthType=ospfAuthType, ospfExternalType1=ospfExternalType1, ospfHostGroup2=ospfHostGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, AreaID=AreaID, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVersionNumber=ospfVersionNumber, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaStatus=ospfAreaStatus, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfStubMetricType=ospfStubMetricType, ospfExtLsdbLsid=ospfExtLsdbLsid, DesignatedRouterPriority=DesignatedRouterPriority, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAdminStat=ospfAdminStat, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbGroup=ospfLsdbGroup, ospfGeneralGroup=ospfGeneralGroup, ospfStubStatus=ospfStubStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfAdminStat=ospfIfAdminStat, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfAreaId=ospfIfAreaId, ospfGroups=ospfGroups, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, Metric=Metric, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrOptions=ospfNbrOptions, ospfExternLsaCount=ospfExternLsaCount, HelloRange=HelloRange, ospfVirtIfTable=ospfVirtIfTable, ospfNbrEvents=ospfNbrEvents)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaTable=ospfAreaTable)
