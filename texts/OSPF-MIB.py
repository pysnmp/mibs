...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubStatus=ospfStubStatus, ospfVirtIfGroup=ospfVirtIfGroup, Status=Status, ospfIfDemand=ospfIfDemand, AreaID=AreaID, ospfNbrState=ospfNbrState, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, PositiveInteger=PositiveInteger, ospfExternLsaCount=ospfExternLsaCount, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfHostMetric=ospfHostMetric, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAsLsdbType=ospfAsLsdbType, ospfNbrTable=ospfNbrTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfConformance=ospfConformance, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaRangeNet=ospfAreaRangeNet, HelloRange=HelloRange, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfCompliances=ospfCompliances, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfAuthType=ospfIfAuthType, ospfObsoleteGroup=ospfObsoleteGroup, ospf=ospf, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, TOSType=TOSType, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfState=ospfVirtIfState, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfStatus=ospfIfStatus, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfGroups=ospfGroups, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaId=ospfAreaId, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostStatus=ospfHostStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfBasicGroup=ospfBasicGroup, ospfIfTable=ospfIfTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrGroup=ospfNbrGroup, ospfCompliance2=ospfCompliance2, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAdminStat=ospfAdminStat, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfAuthKey=ospfIfAuthKey, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaStatus=ospfAreaStatus, BigMetric=BigMetric, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfRestartSupport=ospfRestartSupport, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExternalType1=ospfExternalType1, ospfExtLsdbType=ospfExtLsdbType, ospfLocalLsdbType=ospfLocalLsdbType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfComplianceObsolete=ospfComplianceObsolete, ospfMulticastExtensions=ospfMulticastExtensions, ospfRxNewLsas=ospfRxNewLsas, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaSummary=ospfAreaSummary, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrOptions=ospfNbrOptions, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVersionNumber=ospfVersionNumber, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfCompliance=ospfCompliance, ospfLsdbLsid=ospfLsdbLsid, ospfRestartAge=ospfRestartAge, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtIfTable=ospfVirtIfTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfHostTOS=ospfHostTOS, ospfIfEntry=ospfIfEntry, ospfSpfRuns=ospfSpfRuns, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, RouterID=RouterID, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrState=ospfVirtNbrState, PYSNMP_MODULE_ID=ospf, ospfLsdbTable=ospfLsdbTable, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbAreaId=ospfLsdbAreaId, OspfAuthenticationType=OspfAuthenticationType, ospfHostEntry=ospfHostEntry, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaGroup2=ospfAreaGroup2, ospfRestartInterval=ospfRestartInterval, ospfTOSSupport=ospfTOSSupport, ospfIfEvents=ospfIfEvents, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfStubAreaTable=ospfStubAreaTable, ospfStubTOS=ospfStubTOS, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfAdminStat=ospfIfAdminStat, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfRouteGroup=ospfRouteGroup, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfGroup2=ospfIfGroup2, ospfIfType=ospfIfType, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaTable=ospfAreaTable, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfAuthType=ospfVirtIfAuthType, Metric=Metric, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfState=ospfIfState, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfStubMetricType=ospfStubMetricType, ospfNbrEntry=ospfNbrEntry, ospfIfLsaCount=ospfIfLsaCount, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfMetricTable=ospfIfMetricTable, ospfIntraArea=ospfIntraArea, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfBasicGroup2=ospfBasicGroup2, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfStubMetric=ospfStubMetric, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostGroup=ospfHostGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrRtrId=ospfNbrRtrId, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfHostAreaID=ospfHostAreaID, ospfIfMetricTOS=ospfIfMetricTOS, ospfHostIpAddress=ospfHostIpAddress, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, UpToMaxAge=UpToMaxAge, ospfRestartExitReason=ospfRestartExitReason, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbGroup=ospfLsdbGroup, ospfHostTable=ospfHostTable, ospfNbrGroup2=ospfNbrGroup2, ospfAuthType=ospfAuthType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostGroup2=ospfHostGroup2, ospfAreaEntry=ospfAreaEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfInterArea=ospfInterArea, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLsdbAge=ospfLsdbAge, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfRouterId=ospfRouterId, ospfAsLsaCount=ospfAsLsaCount, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfImportAsExtern=ospfImportAsExtern, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLsdbType=ospfLsdbType, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExternalType2=ospfExternalType2, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfGroup=ospfIfGroup, ospfIfMetricValue=ospfIfMetricValue, ospfGeneralGroup=ospfGeneralGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfMulticastForwarding=ospfIfMulticastForwarding)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbRouterId=ospfLsdbRouterId, ospfRestartStatus=ospfRestartStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfExtLsdbLimit=ospfExtLsdbLimit)
