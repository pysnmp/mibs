...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, HelloRange=HelloRange, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostTOS=ospfHostTOS, ospfAreaSummary=ospfAreaSummary, ospfNbrEntry=ospfNbrEntry, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfTOSSupport=ospfTOSSupport, ospfStubAreaTable=ospfStubAreaTable, ospfIfEntry=ospfIfEntry, ospfStubMetricType=ospfStubMetricType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfState=ospfVirtIfState, ospfAreaId=ospfAreaId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExternLsaCount=ospfExternLsaCount, ospfHostIpAddress=ospfHostIpAddress, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfEvents=ospfIfEvents, ospfNbrOptions=ospfNbrOptions, ospfBasicGroup2=ospfBasicGroup2, ospfIfIpAddress=ospfIfIpAddress, ospfIfLsaCount=ospfIfLsaCount, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeNet=ospfAreaRangeNet, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfState=ospfIfState, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfHostAreaID=ospfHostAreaID, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfStubTOS=ospfStubTOS, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaGroup2=ospfAreaGroup2, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaEntry=ospfAreaEntry, ospfSpfRuns=ospfSpfRuns, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubMetric=ospfStubMetric, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrTable=ospfNbrTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfGroup2=ospfIfGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfRetransInterval=ospfIfRetransInterval, ospfConformance=ospfConformance, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrEvents=ospfNbrEvents, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, Metric=Metric, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfRxNewLsas=ospfRxNewLsas, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfAreaId=ospfIfAreaId, ospfIfMetricTable=ospfIfMetricTable, ospfStubAreaGroup=ospfStubAreaGroup, ospfHostTable=ospfHostTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubAreaId=ospfStubAreaId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfAuthType=ospfAuthType, ospfDemandExtensions=ospfDemandExtensions, ospfCompliances=ospfCompliances, ospfCompliance=ospfCompliance, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfStatus=ospfIfStatus, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfNbrPriority=ospfNbrPriority, ospfRestartInterval=ospfRestartInterval, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfAdminStat=ospfIfAdminStat, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExternalType2=ospfExternalType2, ospfStubRouterSupport=ospfStubRouterSupport, ospfLsdbLsid=ospfLsdbLsid, ospfMulticastExtensions=ospfMulticastExtensions, ospfRestartAge=ospfRestartAge, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfStatus=ospfVirtIfStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtNbrRtrId=ospfVirtNbrRtrId, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfAuthType=ospfIfAuthType, ospfNbrRtrId=ospfNbrRtrId, TOSType=TOSType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaGroup=ospfAreaGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLsdbTable=ospfLsdbTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExternalType1=ospfExternalType1, ospfImportAsExtern=ospfImportAsExtern, RouterID=RouterID, BigMetric=BigMetric, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfAdminStat=ospfAdminStat, UpToMaxAge=UpToMaxAge, ospfVirtIfTable=ospfVirtIfTable, PositiveInteger=PositiveInteger, ospfRestartSupport=ospfRestartSupport, ospfIntraArea=ospfIntraArea, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbAge=ospfLsdbAge, ospf=ospf, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfStubStatus=ospfStubStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVersionNumber=ospfVersionNumber, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfCompliance2=ospfCompliance2, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfGroup=ospfIfGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, Status=Status, ospfIfType=ospfIfType, ospfRestartStatus=ospfRestartStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaStatus=ospfAreaStatus, ospfIfHelloInterval=ospfIfHelloInterval, ospfLsdbType=ospfLsdbType, ospfIfTable=ospfIfTable, PYSNMP_MODULE_ID=ospf, ospfInterArea=ospfInterArea, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostMetric=ospfHostMetric, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfGroups=ospfGroups, ospfBasicGroup=ospfBasicGroup, ospfLsdbEntry=ospfLsdbEntry, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaTable=ospfAreaTable, ospfGeneralGroup=ospfGeneralGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbTable=ospfExtLsdbTable, AreaID=AreaID, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeMask=ospfAreaRangeMask, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfPollInterval=ospfIfPollInterval, ospfNbrState=ospfNbrState, ospfHostGroup=ospfHostGroup, ospfAsLsaCount=ospfAsLsaCount, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrState=ospfVirtNbrState, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfDemand=ospfIfDemand, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrGroup=ospfNbrGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfExtLsdbLimit=ospfExtLsdbLimit)
mibBuilder.exportSymbols("OSPF-MIB", ospfHostStatus=ospfHostStatus, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfOriginateNewLsas=ospfOriginateNewLsas)
