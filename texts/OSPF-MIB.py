...
mibBuilder.exportSymbols("OSPF-MIB", ospfRestartSupport=ospfRestartSupport, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfType=ospfIfType, ospfExtLsdbAge=ospfExtLsdbAge, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExtLsdbType=ospfExtLsdbType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExternalType1=ospfExternalType1, PositiveInteger=PositiveInteger, ospfStubAreaTable=ospfStubAreaTable, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrArea=ospfVirtNbrArea, ospfNbrEvents=ospfNbrEvents, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrGroup2=ospfNbrGroup2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfHostIpAddress=ospfHostIpAddress, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfState=ospfVirtIfState, ospfRouterId=ospfRouterId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaGroup=ospfAreaGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, Metric=Metric, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfInterArea=ospfInterArea, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfStubAreaEntry=ospfStubAreaEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaId=ospfAreaId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostMetric=ospfHostMetric, ospfAreaStatus=ospfAreaStatus, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLsdbType=ospfLsdbType, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfImportAsExtern=ospfImportAsExtern, ospfHostStatus=ospfHostStatus, ospfTOSSupport=ospfTOSSupport, ospfAsLsdbType=ospfAsLsdbType, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfGroup2=ospfVirtIfGroup2, PYSNMP_MODULE_ID=ospf, ospfAreaEntry=ospfAreaEntry, ospfExtLsdbTable=ospfExtLsdbTable, UpToMaxAge=UpToMaxAge, ospfStubMetricType=ospfStubMetricType, ospfIfAuthType=ospfIfAuthType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrPriority=ospfNbrPriority, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExternalType2=ospfExternalType2, ospfNbrGroup=ospfNbrGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrTable=ospfNbrTable, ospfNbrState=ospfNbrState, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfStubStatus=ospfStubStatus, ospfIfAreaId=ospfIfAreaId, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfRetransInterval=ospfIfRetransInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIntraArea=ospfIntraArea, ospfIfMetricValue=ospfIfMetricValue, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAdminStat=ospfAdminStat, ospfVirtNbrState=ospfVirtNbrState, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfDemand=ospfIfDemand, TOSType=TOSType, ospfIfGroup2=ospfIfGroup2, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfCompliance=ospfCompliance, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfRestartInterval=ospfRestartInterval, ospfLsdbTable=ospfLsdbTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfRxNewLsas=ospfRxNewLsas, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, OspfAuthenticationType=OspfAuthenticationType, ospfIfRtrPriority=ospfIfRtrPriority, ospfCompliance2=ospfCompliance2, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfAdminStat=ospfIfAdminStat, ospfCompliances=ospfCompliances, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfHostGroup2=ospfHostGroup2, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubAreaGroup=ospfStubAreaGroup, ospfExternLsaCount=ospfExternLsaCount, ospfStubMetric=ospfStubMetric, ospfIfTable=ospfIfTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbGroup=ospfLsdbGroup, ospfHostGroup=ospfHostGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLsdbSequence=ospfLsdbSequence, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsaCount=ospfAsLsaCount, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfRouteGroup=ospfRouteGroup, ospfIfEvents=ospfIfEvents, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLsdbAge=ospfLsdbAge, ospfIfStatus=ospfIfStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfGeneralGroup=ospfGeneralGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostTOS=ospfHostTOS, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaGroup2=ospfAreaGroup2, ospfBasicGroup2=ospfBasicGroup2, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaTable=ospfAreaTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfStubAreaId=ospfStubAreaId, ospfIfGroup=ospfIfGroup, ospfRestartStatus=ospfRestartStatus, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfEntry=ospfIfEntry, ospfAreaSummary=ospfAreaSummary, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfBasicGroup=ospfBasicGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfPollInterval=ospfIfPollInterval, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrEntry=ospfNbrEntry, AreaID=AreaID, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfConformance=ospfConformance, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAddressLessIf=ospfAddressLessIf, BigMetric=BigMetric, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfTable=ospfVirtIfTable, ospf=ospf, ospfDemandExtensions=ospfDemandExtensions, ospfHostEntry=ospfHostEntry, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfEvents=ospfVirtIfEvents, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaRangeNet=ospfAreaRangeNet, ospfGroups=ospfGroups, ospfIfLsaCount=ospfIfLsaCount, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfState=ospfIfState, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfRestartAge=ospfRestartAge, ospfSpfRuns=ospfSpfRuns, ospfIfMetricGroup=ospfIfMetricGroup, ospfAuthType=ospfAuthType, RouterID=RouterID, Status=Status, ospfHostAreaID=ospfHostAreaID, ospfIfIpAddress=ospfIfIpAddress, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfStubTOS=ospfStubTOS, HelloRange=HelloRange, ospfNbrIpAddr=ospfNbrIpAddr)
mibBuilder.exportSymbols("OSPF-MIB", ospfVersionNumber=ospfVersionNumber, ospfHostTable=ospfHostTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaAggregateTable=ospfAreaAggregateTable)
