...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfNbrGroup2=ospfNbrGroup2, ospfIfMetricTable=ospfIfMetricTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbChecksum=ospfLsdbChecksum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubTOS=ospfStubTOS, ospfNbrPriority=ospfNbrPriority, PYSNMP_MODULE_ID=ospf, ospfVirtIfAuthKey=ospfVirtIfAuthKey, UpToMaxAge=UpToMaxAge, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, OspfAuthenticationType=OspfAuthenticationType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbRouterId=ospfLsdbRouterId, ospfRestartStatus=ospfRestartStatus, ospfComplianceObsolete=ospfComplianceObsolete, RouterID=RouterID, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfSpfRuns=ospfSpfRuns, ospfAreaStatus=ospfAreaStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubMetric=ospfStubMetric, ospfLocalLsdbType=ospfLocalLsdbType, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrArea=ospfVirtNbrArea, ospfGroups=ospfGroups, ospfIfDemand=ospfIfDemand, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfState=ospfVirtIfState, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfStubStatus=ospfStubStatus, ospfIfState=ospfIfState, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfConformance=ospfConformance, ospfIfMetricEntry=ospfIfMetricEntry, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaId=ospfAreaId, ospfStubAreaId=ospfStubAreaId, ospfIfEntry=ospfIfEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExternalType2=ospfExternalType2, ospfLsdbType=ospfLsdbType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, Metric=Metric, ospfRestartInterval=ospfRestartInterval, ospf=ospf, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfCompliance2=ospfCompliance2, ospfIfRetransInterval=ospfIfRetransInterval, TOSType=TOSType, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfAuthKey=ospfIfAuthKey, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfHostAreaID=ospfHostAreaID, ospfIntraArea=ospfIntraArea, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbType=ospfAsLsdbType, ospfExtLsdbType=ospfExtLsdbType, ospfNbrEvents=ospfNbrEvents, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfIpAddress=ospfIfIpAddress, ospfIfAuthType=ospfIfAuthType, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrOptions=ospfNbrOptions, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfStatus=ospfVirtIfStatus, ospfVersionNumber=ospfVersionNumber, ospfIfEvents=ospfIfEvents, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfImportAsExtern=ospfImportAsExtern, ospfIfMetricValue=ospfIfMetricValue, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAdminStat=ospfAdminStat, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLsdbLsid=ospfLsdbLsid, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfType=ospfIfType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, AreaID=AreaID, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfAdminStat=ospfIfAdminStat, ospfIfLsaCount=ospfIfLsaCount, ospfIfStatus=ospfIfStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostStatus=ospfHostStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaTable=ospfAreaTable, ospfRestartAge=ospfRestartAge, ospfNbrGroup=ospfNbrGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsdbTable=ospfAsLsdbTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfBasicGroup2=ospfBasicGroup2, ospfExternLsaCount=ospfExternLsaCount, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaSummary=ospfAreaSummary, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaGroup=ospfAreaGroup, ospfAreaEntry=ospfAreaEntry, ospfHostMetric=ospfHostMetric, ospfNbrTable=ospfNbrTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfGroup=ospfIfGroup, ospfExternalType1=ospfExternalType1, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfTable=ospfIfTable, BigMetric=BigMetric, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfRouterId=ospfRouterId, ospfCompliance=ospfCompliance, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostGroup2=ospfHostGroup2, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtIfTable=ospfVirtIfTable, ospfLsdbSequence=ospfLsdbSequence, ospfTOSSupport=ospfTOSSupport, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfInterArea=ospfInterArea, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRouteGroup=ospfRouteGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbGroup=ospfLsdbGroup, ospfStubAreaTable=ospfStubAreaTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, DesignatedRouterPriority=DesignatedRouterPriority, ospfDemandExtensions=ospfDemandExtensions, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbEntry=ospfLsdbEntry, ospfHostEntry=ospfHostEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfCompliances=ospfCompliances, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrState=ospfNbrState, ospfAreaAggregateStatus=ospfAreaAggregateStatus, HelloRange=HelloRange, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubAreaGroup=ospfStubAreaGroup, ospfAuthType=ospfAuthType, ospfLsdbTable=ospfLsdbTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRxNewLsas=ospfRxNewLsas, ospfBasicGroup=ospfBasicGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostGroup=ospfHostGroup, ospfIfGroup2=ospfIfGroup2, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfRestartSupport=ospfRestartSupport, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrState=ospfVirtNbrState, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfHostIpAddress=ospfHostIpAddress, PositiveInteger=PositiveInteger, ospfLsdbAge=ospfLsdbAge, Status=Status, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfHostTOS=ospfHostTOS, ospfHostTable=ospfHostTable, ospfAreaGroup2=ospfAreaGroup2)
mibBuilder.exportSymbols("OSPF-MIB", ospfStubMetricType=ospfStubMetricType, ospfIfAreaId=ospfIfAreaId, ospfNbrEntry=ospfNbrEntry, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum)
