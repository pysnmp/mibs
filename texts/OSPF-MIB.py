...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLsdbEntry=ospfLsdbEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostEntry=ospfHostEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrPriority=ospfNbrPriority, ospfNbrEvents=ospfNbrEvents, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfTable=ospfIfTable, TOSType=TOSType, ospfLsdbChecksum=ospfLsdbChecksum, ospfStubAreaTable=ospfStubAreaTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, RouterID=RouterID, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVersionNumber=ospfVersionNumber, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfRouterId=ospfRouterId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfRxNewLsas=ospfRxNewLsas, ospfExternalType2=ospfExternalType2, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaRangeNet=ospfAreaRangeNet, ospfIntraArea=ospfIntraArea, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfDemand=ospfIfDemand, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfMetricValue=ospfIfMetricValue, ospfAreaGroup=ospfAreaGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAuthType=ospfAuthType, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaTable=ospfAreaTable, ospfAdminStat=ospfAdminStat, ospfHostAreaID=ospfHostAreaID, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfMetricTOS=ospfIfMetricTOS, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLsdbGroup=ospfLsdbGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfType=ospfIfType, ospfHostIpAddress=ospfHostIpAddress, ospfIfIpAddress=ospfIfIpAddress, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsdbLsid=ospfAsLsdbLsid, PYSNMP_MODULE_ID=ospf, ospfRestartSupport=ospfRestartSupport, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfGroups=ospfGroups, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfStatus=ospfIfStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateEffect=ospfAreaAggregateEffect, PositiveInteger=PositiveInteger, ospfDemandExtensions=ospfDemandExtensions, ospfImportAsExtern=ospfImportAsExtern, ospfStubStatus=ospfStubStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrTable=ospfNbrTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbAreaId=ospfLsdbAreaId, ospfStubTOS=ospfStubTOS, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfTable=ospfVirtIfTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaId=ospfAreaId, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfEntry=ospfVirtIfEntry, ospfRouteGroup=ospfRouteGroup, ospfLsdbType=ospfLsdbType, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAddressLessIf=ospfAddressLessIf, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfGeneralGroup=ospfGeneralGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaRangeEntry=ospfAreaRangeEntry, AreaID=AreaID, ospfHostMetric=ospfHostMetric, ospfLsdbRouterId=ospfLsdbRouterId, ospfHostGroup=ospfHostGroup, ospfHostTable=ospfHostTable, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfState=ospfVirtIfState, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfHostGroup2=ospfHostGroup2, ospfStubMetric=ospfStubMetric, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfMulticastExtensions=ospfMulticastExtensions, ospfAsLsaCount=ospfAsLsaCount, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaEntry=ospfAreaEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfBasicGroup2=ospfBasicGroup2, ospfRestartInterval=ospfRestartInterval, ospfExternLsaCount=ospfExternLsaCount, ospfNbrOptions=ospfNbrOptions, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfAuthKey=ospfIfAuthKey, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfRestartStatus=ospfRestartStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfInterArea=ospfInterArea, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubAreaEntry=ospfStubAreaEntry, ospfExternalType1=ospfExternalType1, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfGroup=ospfIfGroup, ospfStubMetricType=ospfStubMetricType, HelloRange=HelloRange, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfAuthType=ospfVirtIfAuthType, Metric=Metric, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrState=ospfNbrState, ospfConformance=ospfConformance, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrGroup=ospfNbrGroup, ospfHostStatus=ospfHostStatus, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbType=ospfAsLsdbType, ospfCompliances=ospfCompliances, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfGroup2=ospfIfGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaSummary=ospfAreaSummary, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfMetricTable=ospfIfMetricTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAsLsaCksumSum=ospfAsLsaCksumSum, Status=Status, ospfHostTOS=ospfHostTOS, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfEvents=ospfIfEvents, ospfLsdbLsid=ospfLsdbLsid, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfRestartAge=ospfRestartAge, ospfLsdbTable=ospfLsdbTable, ospfCompliance2=ospfCompliance2, ospfIfState=ospfIfState, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, BigMetric=BigMetric, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfEntry=ospfIfEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtNbrState=ospfVirtNbrState, ospfStubAreaId=ospfStubAreaId, OspfAuthenticationType=OspfAuthenticationType, ospfCompliance=ospfCompliance, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrRtrId=ospfNbrRtrId, ospfAreaStatus=ospfAreaStatus, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfTOSSupport=ospfTOSSupport, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfSpfRuns=ospfSpfRuns, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospf=ospf, ospfExtLsdbAge=ospfExtLsdbAge, ospfNbrIpAddr=ospfNbrIpAddr, UpToMaxAge=UpToMaxAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExtLsdbType=ospfExtLsdbType, ospfIfMetricStatus=ospfIfMetricStatus)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbSequence=ospfLsdbSequence, DesignatedRouterPriority=DesignatedRouterPriority, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag)
