...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVersionNumber=ospfVersionNumber, ospfIfTable=ospfIfTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfLsaCksumSum=ospfIfLsaCksumSum, TOSType=TOSType, ospfStubTOS=ospfStubTOS, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRouteGroup=ospfRouteGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfTable=ospfVirtIfTable, HelloRange=HelloRange, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAddressLessIf=ospfAddressLessIf, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfHostTable=ospfHostTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIntraArea=ospfIntraArea, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtIfNeighbor=ospfVirtIfNeighbor, RouterID=RouterID, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfGroup=ospfIfGroup, ospfNbrPriority=ospfNbrPriority, UpToMaxAge=UpToMaxAge, ospf=ospf, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrOptions=ospfNbrOptions, ospfVirtIfState=ospfVirtIfState, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrState=ospfNbrState, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrArea=ospfVirtNbrArea, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfRestartSupport=ospfRestartSupport, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfGeneralGroup=ospfGeneralGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLsdbEntry=ospfLsdbEntry, ospfExternalType2=ospfExternalType2, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfDemand=ospfIfDemand, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfBasicGroup2=ospfBasicGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbGroup=ospfLsdbGroup, ospfIfAreaId=ospfIfAreaId, ospfAdminStat=ospfAdminStat, ospfNbrRtrId=ospfNbrRtrId, ospfHostStatus=ospfHostStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfHostIpAddress=ospfHostIpAddress, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbType=ospfExtLsdbType, ospfSpfRuns=ospfSpfRuns, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfRetransInterval=ospfIfRetransInterval, ospfAuthType=ospfAuthType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfStubMetric=ospfStubMetric, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRouterId=ospfRouterId, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaEntry=ospfAreaEntry, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbLsid=ospfLsdbLsid, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfNbrGroup2=ospfNbrGroup2, ospfRxNewLsas=ospfRxNewLsas, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLsdbAdvertisement=ospfLsdbAdvertisement, PositiveInteger=PositiveInteger, ospfGroups=ospfGroups, ospfNbrGroup=ospfNbrGroup, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfInterArea=ospfInterArea, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubAreaTable=ospfStubAreaTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfMetricEntry=ospfIfMetricEntry, AreaID=AreaID, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaId=ospfAreaId, ospfIfStatus=ospfIfStatus, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfType=ospfIfType, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfAuthKey=ospfIfAuthKey, ospfBasicGroup=ospfBasicGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfHostGroup=ospfHostGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfCompliance=ospfCompliance, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostMetric=ospfHostMetric, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsaCount=ospfAsLsaCount, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostTOS=ospfHostTOS, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaSummary=ospfAreaSummary, ospfMulticastExtensions=ospfMulticastExtensions, ospfDemandExtensions=ospfDemandExtensions, ospfRestartAge=ospfRestartAge, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfMetricGroup=ospfIfMetricGroup, ospfHostGroup2=ospfHostGroup2, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfIpAddress=ospfIfIpAddress, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfExternLsaCount=ospfExternLsaCount, ospfNbrEntry=ospfNbrEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaTable=ospfAreaTable, ospfCompliance2=ospfCompliance2, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfPollInterval=ospfIfPollInterval, Status=Status, ospfLocalLsdbType=ospfLocalLsdbType, ospfStubAreaId=ospfStubAreaId, ospfAreaStatus=ospfAreaStatus, ospfRestartInterval=ospfRestartInterval, ospfHostEntry=ospfHostEntry, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubStatus=ospfStubStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaRangeTable=ospfAreaRangeTable, PYSNMP_MODULE_ID=ospf, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartStatus=ospfRestartStatus, ospfExternalType1=ospfExternalType1, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAsBdrRtrCount=ospfAsBdrRtrCount, OspfAuthenticationType=OspfAuthenticationType, ospfLsdbType=ospfLsdbType, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaRangeEntry=ospfAreaRangeEntry, BigMetric=BigMetric, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfAuthType=ospfIfAuthType, ospfNbrTable=ospfNbrTable, ospfVirtNbrState=ospfVirtNbrState, ospfLsdbTable=ospfLsdbTable, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfEntry=ospfIfEntry, ospfIfAdminStat=ospfIfAdminStat, ospfIfState=ospfIfState, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfCompliances=ospfCompliances, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfGroup2=ospfIfGroup2, Metric=Metric, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfEvents=ospfIfEvents, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfMetricValue=ospfIfMetricValue)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfTOSSupport=ospfTOSSupport, ospfLsdbAge=ospfLsdbAge, ospfConformance=ospfConformance)
