...
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLsdbLsid=ospfLsdbLsid, ospfHostEntry=ospfHostEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfCompliance2=ospfCompliance2, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaTable=ospfAreaTable, DesignatedRouterPriority=DesignatedRouterPriority, Metric=Metric, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaLsaCount=ospfAreaLsaCount, ospfStubMetric=ospfStubMetric, ospfConformance=ospfConformance, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfGroup=ospfIfGroup, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubStatus=ospfStubStatus, ospfBasicGroup2=ospfBasicGroup2, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfAuthType=ospfIfAuthType, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, Status=Status, ospfNbrState=ospfNbrState, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrTable=ospfNbrTable, ospfIntraArea=ospfIntraArea, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfImportAsExtern=ospfImportAsExtern, ospfIfType=ospfIfType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfBasicGroup=ospfBasicGroup, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfInterArea=ospfInterArea, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfDemandExtensions=ospfDemandExtensions, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaStatus=ospfAreaStatus, ospfIfState=ospfIfState, ospf=ospf, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, HelloRange=HelloRange, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfAreaId=ospfIfAreaId, PYSNMP_MODULE_ID=ospf, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVersionNumber=ospfVersionNumber, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaId=ospfAreaId, ospfLsdbAge=ospfLsdbAge, ospfRouteGroup=ospfRouteGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfTOSSupport=ospfTOSSupport, ospfLsdbGroup=ospfLsdbGroup, ospfRouterId=ospfRouterId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfIpAddress=ospfIfIpAddress, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLsdbRouterId=ospfLsdbRouterId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLsdbType=ospfLsdbType, ospfAreaAggregateStatus=ospfAreaAggregateStatus, RouterID=RouterID, ospfGeneralGroup=ospfGeneralGroup, ospfRxNewLsas=ospfRxNewLsas, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubAreaId=ospfStubAreaId, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaSummary=ospfAreaSummary, ospfRestartStatus=ospfRestartStatus, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfGroup2=ospfIfGroup2, ospfRestartInterval=ospfRestartInterval, ospfCompliance=ospfCompliance, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfExternalType2=ospfExternalType2, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbType=ospfLocalLsdbType, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostIpAddress=ospfHostIpAddress, ospfRestartSupport=ospfRestartSupport, ospfNbrPriority=ospfNbrPriority, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfHostGroup=ospfHostGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfHostTable=ospfHostTable, ospfLsdbEntry=ospfLsdbEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfAdminStat=ospfAdminStat, PositiveInteger=PositiveInteger, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaGroup=ospfAreaGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbAge=ospfAsLsdbAge, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfStubTOS=ospfStubTOS, ospfIfRetransInterval=ospfIfRetransInterval, TOSType=TOSType, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfExternLsaCount=ospfExternLsaCount, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfHostTOS=ospfHostTOS, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrState=ospfVirtNbrState, ospfRFC1583Compatibility=ospfRFC1583Compatibility, BigMetric=BigMetric, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricEntry=ospfIfMetricEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfHostMetric=ospfHostMetric, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrIpAddr=ospfNbrIpAddr, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, UpToMaxAge=UpToMaxAge, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfEvents=ospfIfEvents, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfGroups=ospfGroups, ospfRestartAge=ospfRestartAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrEvents=ospfNbrEvents, ospfExternalType1=ospfExternalType1, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfStatus=ospfIfStatus, ospfNbrGroup2=ospfNbrGroup2, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfAuthKey=ospfIfAuthKey, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrOptions=ospfNbrOptions, ospfComplianceObsolete=ospfComplianceObsolete, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfCompliances=ospfCompliances, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostStatus=ospfHostStatus, ospfIfMetricTable=ospfIfMetricTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfDemand=ospfIfDemand, ospfIfRtrPriority=ospfIfRtrPriority, AreaID=AreaID, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfTable=ospfIfTable, ospfAuthType=ospfAuthType, ospfNbrEntry=ospfNbrEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbType=ospfExtLsdbType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfExtLsdbTable=ospfExtLsdbTable)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbTable=ospfLsdbTable, ospfIfEntry=ospfIfEntry)
