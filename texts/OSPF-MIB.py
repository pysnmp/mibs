...
mibBuilder.exportSymbols("OSPF-MIB", ospfRouterId=ospfRouterId, ospfIfMetricTable=ospfIfMetricTable, ospfNbrRtrId=ospfNbrRtrId, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfCompliances=ospfCompliances, ospfIfEvents=ospfIfEvents, ospfRestartStatus=ospfRestartStatus, TOSType=TOSType, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfMetricValue=ospfIfMetricValue, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfRestartExitReason=ospfRestartExitReason, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfAreaId=ospfIfAreaId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExtLsdbSequence=ospfExtLsdbSequence, BigMetric=BigMetric, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfBasicGroup=ospfBasicGroup, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubTOS=ospfStubTOS, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfHostStatus=ospfHostStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfGeneralGroup=ospfGeneralGroup, PYSNMP_MODULE_ID=ospf, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbTable=ospfExtLsdbTable, ospfAsLsdbType=ospfAsLsdbType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfGroup2=ospfIfGroup2, ospfIfType=ospfIfType, ospfExtLsdbType=ospfExtLsdbType, ospfLsdbGroup=ospfLsdbGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAddressLessIf=ospfAddressLessIf, ospfCompliance=ospfCompliance, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrEvents=ospfNbrEvents, ospfInterArea=ospfInterArea, ospfHostMetric=ospfHostMetric, ospfAuthType=ospfAuthType, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbEntry=ospfLocalLsdbEntry, HelloRange=HelloRange, ospfGroups=ospfGroups, ospfStubMetricType=ospfStubMetricType, ospfIfStatus=ospfIfStatus, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfExternalType2=ospfExternalType2, ospfNbrIpAddr=ospfNbrIpAddr, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrGroup=ospfNbrGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfHostAreaID=ospfHostAreaID, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostIpAddress=ospfHostIpAddress, ospfLsdbAge=ospfLsdbAge, ospfStubAreaTable=ospfStubAreaTable, ospfHostTOS=ospfHostTOS, ospfAreaRangeMask=ospfAreaRangeMask, ospfCompliance2=ospfCompliance2, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfGroup=ospfVirtIfGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfExternLsaCount=ospfExternLsaCount, ospfLsdbTable=ospfLsdbTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaSummary=ospfAreaSummary, ospfIfAuthKey=ospfIfAuthKey, ospfAreaTable=ospfAreaTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfRestartAge=ospfRestartAge, UpToMaxAge=UpToMaxAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbChecksum=ospfLsdbChecksum, ospfOriginateNewLsas=ospfOriginateNewLsas, Metric=Metric, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLsdbLsid=ospfLsdbLsid, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLsdbType=ospfLsdbType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfStubStatus=ospfStubStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAdminStat=ospfAdminStat, ospfTOSSupport=ospfTOSSupport, ospfVersionNumber=ospfVersionNumber, RouterID=RouterID, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfStubMetric=ospfStubMetric, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospf=ospf, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfDemand=ospfIfDemand, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfHostGroup=ospfHostGroup, ospfNbrGroup2=ospfNbrGroup2, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostCfgAreaID=ospfHostCfgAreaID, Status=Status, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrEntry=ospfNbrEntry, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaRangeNet=ospfAreaRangeNet, ospfBasicGroup2=ospfBasicGroup2, ospfRestartInterval=ospfRestartInterval, ospfAreaEntry=ospfAreaEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfState=ospfVirtIfState, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, AreaID=AreaID, ospfAsLsaCount=ospfAsLsaCount, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfState=ospfIfState, ospfAreaGroup=ospfAreaGroup, ospfIfMetricTOS=ospfIfMetricTOS, PositiveInteger=PositiveInteger, ospfConformance=ospfConformance, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfRetransInterval=ospfIfRetransInterval, ospfIntraArea=ospfIntraArea, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrPriority=ospfNbrPriority, ospfAsLsdbAge=ospfAsLsdbAge, OspfAuthenticationType=OspfAuthenticationType, ospfIfTable=ospfIfTable, ospfHostTable=ospfHostTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfGroup=ospfIfGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExternalType1=ospfExternalType1, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfAuthType=ospfIfAuthType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfImportAsExtern=ospfImportAsExtern, ospfHostEntry=ospfHostEntry, ospfNbrTable=ospfNbrTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfRxNewLsas=ospfRxNewLsas, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubAreaId=ospfStubAreaId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaStatus=ospfAreaStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtNbrState=ospfVirtNbrState, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaId=ospfAreaId, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrState=ospfNbrState, ospfIfEntry=ospfIfEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfRestartSupport=ospfRestartSupport, ospfNbrOptions=ospfNbrOptions, ospfStubAreaEntry=ospfStubAreaEntry)
