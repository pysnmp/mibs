...
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbLsid=ospfLsdbLsid, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfCompliance2=ospfCompliance2, ospfBasicGroup2=ospfBasicGroup2, ospfLsdbType=ospfLsdbType, ospfBasicGroup=ospfBasicGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfTOSSupport=ospfTOSSupport, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfStubAreaTable=ospfStubAreaTable, ospfHostTOS=ospfHostTOS, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVersionNumber=ospfVersionNumber, ospfIfState=ospfIfState, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaEntry=ospfAreaEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfHostAreaID=ospfHostAreaID, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfRetransInterval=ospfIfRetransInterval, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfGroups=ospfGroups, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfStatus=ospfIfStatus, ospfIfDemand=ospfIfDemand, ospfIfAuthType=ospfIfAuthType, ospfRouterId=ospfRouterId, ospfAreaStatus=ospfAreaStatus, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAdminStat=ospfAdminStat, ospf=ospf, ospfIfEntry=ospfIfEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfNbrEvents=ospfNbrEvents, PYSNMP_MODULE_ID=ospf, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaId=ospfAreaId, ospfIfAreaId=ospfIfAreaId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfLsaCount=ospfIfLsaCount, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostEntry=ospfHostEntry, ospfIfAuthKey=ospfIfAuthKey, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfTable=ospfIfTable, ospfIfMetricValue=ospfIfMetricValue, ospfAreaGroup=ospfAreaGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaSummary=ospfAreaSummary, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfStubMetricType=ospfStubMetricType, ospfLsdbGroup=ospfLsdbGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfCompliances=ospfCompliances, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfType=ospfIfType, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrEntry=ospfNbrEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfRestartAge=ospfRestartAge, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaTable=ospfAreaTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostMetric=ospfHostMetric, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrState=ospfNbrState, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbType=ospfLocalLsdbType, RouterID=RouterID, ospfStubStatus=ospfStubStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaAggregateTable=ospfAreaAggregateTable, PositiveInteger=PositiveInteger, Metric=Metric, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExternalType2=ospfExternalType2, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfDemandExtensions=ospfDemandExtensions, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubMetric=ospfStubMetric, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, BigMetric=BigMetric, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfExtLsdbType=ospfExtLsdbType, ospfHostStatus=ospfHostStatus, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRestartStatus=ospfRestartStatus, ospfStubAreaId=ospfStubAreaId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfRestartInterval=ospfRestartInterval, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, AreaID=AreaID, ospfRestartSupport=ospfRestartSupport, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfHostTable=ospfHostTable, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfMetricTOS=ospfIfMetricTOS, ospfRouteGroup=ospfRouteGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbEntry=ospfLsdbEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAuthType=ospfAuthType, ospfConformance=ospfConformance, ospfVirtNbrEntry=ospfVirtNbrEntry, UpToMaxAge=UpToMaxAge, ospfCompliance=ospfCompliance, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaRangeNet=ospfAreaRangeNet, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostIpAddress=ospfHostIpAddress, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfIpAddress=ospfIfIpAddress, ospfLsdbSequence=ospfLsdbSequence, ospfSpfRuns=ospfSpfRuns, ospfIfMetricTable=ospfIfMetricTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLsdbChecksum=ospfLsdbChecksum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, Status=Status, ospfNbrTable=ospfNbrTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrState=ospfVirtNbrState, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsLsdbType=ospfAsLsdbType, ospfExternLsaCount=ospfExternLsaCount, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfGroup2=ospfIfGroup2, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubTOS=ospfStubTOS, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfHostGroup=ospfHostGroup, ospfExternalType1=ospfExternalType1, ospfIfGroup=ospfIfGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrPriority=ospfNbrPriority, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfHostGroup2=ospfHostGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, TOSType=TOSType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIntraArea=ospfIntraArea, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbAge=ospfLsdbAge, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaAggregateEffect=ospfAreaAggregateEffect, HelloRange=HelloRange, ospfAddressLessIf=ospfAddressLessIf, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfState=ospfVirtIfState, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsaCount=ospfAsLsaCount, ospfIfEvents=ospfIfEvents, ospfAsLsdbGroup=ospfAsLsdbGroup)
