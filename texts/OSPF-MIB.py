...
mibBuilder.exportSymbols("OSPF-MIB", ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtNbrState=ospfVirtNbrState, ospfLsdbType=ospfLsdbType, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfDemand=ospfIfDemand, ospfGeneralGroup=ospfGeneralGroup, ospfNbrEntry=ospfNbrEntry, ospfHostTable=ospfHostTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrRtrId=ospfNbrRtrId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfStubStatus=ospfStubStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfMulticastExtensions=ospfMulticastExtensions, ospfNbrEvents=ospfNbrEvents, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfConformance=ospfConformance, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrTable=ospfVirtNbrTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfTable=ospfIfTable, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfState=ospfIfState, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfRestartSupport=ospfRestartSupport, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLsdbSequence=ospfLsdbSequence, ospfHostTOS=ospfHostTOS, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfAuthKey=ospfIfAuthKey, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAddressLessIf=ospfAddressLessIf, ospfNbrGroup2=ospfNbrGroup2, RouterID=RouterID, ospfLocalLsdbType=ospfLocalLsdbType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfEntry=ospfIfEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfGroups=ospfGroups, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaGroup=ospfAreaGroup, UpToMaxAge=UpToMaxAge, ospfRestartStatus=ospfRestartStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfHostGroup2=ospfHostGroup2, ospfExternLsaCount=ospfExternLsaCount, Metric=Metric, ospfIfTransitDelay=ospfIfTransitDelay, ospfRxNewLsas=ospfRxNewLsas, ospfVirtIfStatus=ospfVirtIfStatus, ospfInterArea=ospfInterArea, ospfHostEntry=ospfHostEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfTable=ospfVirtIfTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaTable=ospfAreaTable, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfStubMetric=ospfStubMetric, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfRestartAge=ospfRestartAge, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, BigMetric=BigMetric, ospfIfEvents=ospfIfEvents, ospfRestartInterval=ospfRestartInterval, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfBasicGroup=ospfBasicGroup, ospfHostStatus=ospfHostStatus, ospfAsLsaCount=ospfAsLsaCount, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaSummary=ospfAreaSummary, ospfVersionNumber=ospfVersionNumber, ospfCompliances=ospfCompliances, PositiveInteger=PositiveInteger, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfType=ospfIfType, ospfTOSSupport=ospfTOSSupport, OspfAuthenticationType=OspfAuthenticationType, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfAreaId=ospfIfAreaId, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfRouteGroup=ospfRouteGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfCompliance2=ospfCompliance2, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfStubAreaTable=ospfStubAreaTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfAsLsdbType=ospfAsLsdbType, Status=Status, TOSType=TOSType, ospfIntraArea=ospfIntraArea, ospfAreaAggregateNet=ospfAreaAggregateNet, DesignatedRouterPriority=DesignatedRouterPriority, ospfLsdbChecksum=ospfLsdbChecksum, ospfLsdbTable=ospfLsdbTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfStatus=ospfIfStatus, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrState=ospfNbrState, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfImportAsExtern=ospfImportAsExtern, ospfIfAdminStat=ospfIfAdminStat, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfRestartExitReason=ospfRestartExitReason, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExternalType1=ospfExternalType1, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, AreaID=AreaID, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaEntry=ospfAreaEntry, ospfAreaId=ospfAreaId, ospfExtLsdbType=ospfExtLsdbType, ospfAreaStatus=ospfAreaStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrTable=ospfNbrTable, ospfNbrOptions=ospfNbrOptions, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfIpAddress=ospfIfIpAddress, ospfIfMetricStatus=ospfIfMetricStatus, ospfLsdbAge=ospfLsdbAge, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfHelloInterval=ospfIfHelloInterval, ospfCompliance=ospfCompliance, ospfLsdbGroup=ospfLsdbGroup, ospfIfPollInterval=ospfIfPollInterval, ospfStubTOS=ospfStubTOS, ospfAdminStat=ospfAdminStat, ospfHostGroup=ospfHostGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfHostMetric=ospfHostMetric, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfMetricTable=ospfIfMetricTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubMetricType=ospfStubMetricType, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfHostIpAddress=ospfHostIpAddress, ospfAuthType=ospfAuthType, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfLsaCount=ospfIfLsaCount, HelloRange=HelloRange, ospfSpfRuns=ospfSpfRuns, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfRouterId=ospfRouterId, ospfBasicGroup2=ospfBasicGroup2, PYSNMP_MODULE_ID=ospf, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbLsid=ospfLsdbLsid, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfGroup2=ospfIfGroup2, ospfExternalType2=ospfExternalType2, ospf=ospf, ospfExtLsdbGroup=ospfExtLsdbGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrGroup=ospfNbrGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement)
