...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfStubTOS=ospfStubTOS, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrArea=ospfVirtNbrArea, ospfConformance=ospfConformance, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfDemand=ospfIfDemand, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfRetransInterval=ospfIfRetransInterval, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfAuthType=ospfVirtIfAuthType, OspfAuthenticationType=OspfAuthenticationType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubAreaGroup=ospfStubAreaGroup, PositiveInteger=PositiveInteger, ospfAsLsdbType=ospfAsLsdbType, ospfNbrEntry=ospfNbrEntry, ospfSpfRuns=ospfSpfRuns, ospfMulticastExtensions=ospfMulticastExtensions, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, UpToMaxAge=UpToMaxAge, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfExternalType2=ospfExternalType2, ospfIfEntry=ospfIfEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfGroup2=ospfIfGroup2, ospfVirtIfEvents=ospfVirtIfEvents, AreaID=AreaID, PYSNMP_MODULE_ID=ospf, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfRestartInterval=ospfRestartInterval, ospfCompliance=ospfCompliance, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbType=ospfExtLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfBasicGroup=ospfBasicGroup, ospfIfMetricTable=ospfIfMetricTable, ospfStubStatus=ospfStubStatus, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfLsaCount=ospfIfLsaCount, ospfBasicGroup2=ospfBasicGroup2, ospfNbrGroup2=ospfNbrGroup2, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaStatus=ospfAreaStatus, ospfIfTable=ospfIfTable, ospfNbrOptions=ospfNbrOptions, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfRouteGroup=ospfRouteGroup, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRxNewLsas=ospfRxNewLsas, ospfAuthType=ospfAuthType, ospfStubAreaTable=ospfStubAreaTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaTable=ospfAreaTable, ospfAreaSummary=ospfAreaSummary, ospf=ospf, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfAuthKey=ospfIfAuthKey, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostStatus=ospfHostStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, BigMetric=BigMetric, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfPollInterval=ospfIfPollInterval, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfAuthType=ospfIfAuthType, ospfAreaRangeNet=ospfAreaRangeNet, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfAreaId=ospfIfAreaId, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfRtrPriority=ospfIfRtrPriority, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfCompliances=ospfCompliances, ospfLsdbGroup=ospfLsdbGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfGeneralGroup=ospfGeneralGroup, ospfStubMetric=ospfStubMetric, ospfVirtIfState=ospfVirtIfState, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, Status=Status, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbType=ospfLsdbType, ospfIfType=ospfIfType, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfHelloInterval=ospfIfHelloInterval, ospfRestartSupport=ospfRestartSupport, ospfExternLsaCount=ospfExternLsaCount, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfState=ospfIfState, ospfVirtNbrRtrId=ospfVirtNbrRtrId, RouterID=RouterID, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbLsid=ospfLsdbLsid, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAdminStat=ospfAdminStat, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrGroup=ospfNbrGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfCompliance2=ospfCompliance2, ospfNbrState=ospfNbrState, ospfAreaId=ospfAreaId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostGroup=ospfHostGroup, Metric=Metric, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfStatus=ospfIfStatus, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfHostEntry=ospfHostEntry, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLsdbTable=ospfLsdbTable, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfEntry=ospfVirtIfEntry, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfRouterId=ospfRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaEntry=ospfAreaEntry, ospfRestartStatus=ospfRestartStatus, ospfAreaGroup=ospfAreaGroup, ospfHostTable=ospfHostTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfHostGroup2=ospfHostGroup2, ospfAsLsdbTable=ospfAsLsdbTable, ospfRestartAge=ospfRestartAge, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVersionNumber=ospfVersionNumber, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbAge=ospfLsdbAge, ospfNbrPriority=ospfNbrPriority, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaGroup2=ospfAreaGroup2, ospfLsdbEntry=ospfLsdbEntry, HelloRange=HelloRange, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfImportAsExtern=ospfImportAsExtern, ospfAddressLessIf=ospfAddressLessIf, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfGroups=ospfGroups, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfIpAddress=ospfIfIpAddress, ospfExternalType1=ospfExternalType1, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfHostAreaID=ospfHostAreaID, ospfNbrTable=ospfNbrTable, ospfVirtNbrState=ospfVirtNbrState, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfHostTOS=ospfHostTOS, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfInterArea=ospfInterArea, ospfHostMetric=ospfHostMetric, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfTOSSupport=ospfTOSSupport, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, TOSType=TOSType, ospfLocalLsdbType=ospfLocalLsdbType, ospfStubMetricType=ospfStubMetricType, ospfLsdbSequence=ospfLsdbSequence, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsLsaCount=ospfAsLsaCount, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfGroup=ospfIfGroup, ospfStubAreaId=ospfStubAreaId)
