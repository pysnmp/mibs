...
mibBuilder.exportSymbols("OSPF-MIB", ospfInterArea=ospfInterArea, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVersionNumber=ospfVersionNumber, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfState=ospfIfState, ospfIfMetricTOS=ospfIfMetricTOS, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, AreaID=AreaID, ospfStubTOS=ospfStubTOS, ospfTOSSupport=ospfTOSSupport, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfStubAreaId=ospfStubAreaId, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrTable=ospfNbrTable, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfRouteGroup=ospfRouteGroup, BigMetric=BigMetric, ospfVirtNbrState=ospfVirtNbrState, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfStubMetric=ospfStubMetric, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLsdbGroup=ospfLsdbGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfMetricEntry=ospfIfMetricEntry, ospfExtLsdbType=ospfExtLsdbType, ospfAdminStat=ospfAdminStat, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostTOS=ospfHostTOS, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfHostMetric=ospfHostMetric, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfSpfRuns=ospfSpfRuns, PYSNMP_MODULE_ID=ospf, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrState=ospfNbrState, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubStatus=ospfStubStatus, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfRetransInterval=ospfIfRetransInterval, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrRtrId=ospfNbrRtrId, ospfHostTable=ospfHostTable, ospfIfEntry=ospfIfEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfStatus=ospfVirtIfStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfExternalType1=ospfExternalType1, ospfAreaId=ospfAreaId, ospfRxNewLsas=ospfRxNewLsas, RouterID=RouterID, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaGroup=ospfAreaGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfStubMetricType=ospfStubMetricType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfState=ospfVirtIfState, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrEntry=ospfNbrEntry, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfLsaCount=ospfIfLsaCount, ospf=ospf, ospfNbrGroup=ospfNbrGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtIfGroup=ospfVirtIfGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfExternalType2=ospfExternalType2, ospfGeneralGroup=ospfGeneralGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfAdminStat=ospfIfAdminStat, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfTable=ospfIfTable, ospfExternLsaCount=ospfExternLsaCount, ospfHostStatus=ospfHostStatus, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfDemandExtensions=ospfDemandExtensions, ospfCompliances=ospfCompliances, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostIpAddress=ospfHostIpAddress, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfAreaId=ospfIfAreaId, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfGroups=ospfGroups, ospfCompliance=ospfCompliance, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostGroup=ospfHostGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrGroup2=ospfNbrGroup2, ospfConformance=ospfConformance, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, PositiveInteger=PositiveInteger, ospfRestartAge=ospfRestartAge, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExtLsdbChecksum=ospfExtLsdbChecksum, Metric=Metric, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaStatus=ospfAreaStatus, ospfIfType=ospfIfType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfCompliance2=ospfCompliance2, ospfIntraArea=ospfIntraArea, ospfStubAreaEntry=ospfStubAreaEntry, ospfRestartSupport=ospfRestartSupport, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRouterId=ospfRouterId, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfDemand=ospfIfDemand, ospfIfStatus=ospfIfStatus, ospfNbrPriority=ospfNbrPriority, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbTable=ospfLsdbTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaTable=ospfAreaTable, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, TOSType=TOSType, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfGroup=ospfIfGroup, ospfBasicGroup2=ospfBasicGroup2, ospfAreaEntry=ospfAreaEntry, ospfLsdbLsid=ospfLsdbLsid, ospfNbrIpAddr=ospfNbrIpAddr, UpToMaxAge=UpToMaxAge, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbType=ospfLsdbType, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfStubAreaTable=ospfStubAreaTable, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfAuthType=ospfIfAuthType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfEvents=ospfIfEvents, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfImportAsExtern=ospfImportAsExtern, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfRestartInterval=ospfRestartInterval, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsaCount=ospfAsLsaCount, ospfLsdbAge=ospfLsdbAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfPollInterval=ospfIfPollInterval, ospfAuthType=ospfAuthType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfMetricValue=ospfIfMetricValue, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfIfAuthKey=ospfIfAuthKey, HelloRange=HelloRange, ospfAsLsdbAge=ospfAsLsdbAge, ospfRestartStatus=ospfRestartStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfGroup2=ospfIfGroup2, ospfIfTransitDelay=ospfIfTransitDelay, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaSummary=ospfAreaSummary, ospfHostAreaID=ospfHostAreaID, Status=Status, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrEvents=ospfNbrEvents, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLsdbEntry=ospfLsdbEntry, ospfHostEntry=ospfHostEntry, ospfAreaGroup2=ospfAreaGroup2, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfHostGroup2=ospfHostGroup2, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaRangeTable=ospfAreaRangeTable, ospfBasicGroup=ospfBasicGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId)
