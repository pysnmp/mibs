...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfBasicGroup=ospfBasicGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfTOSSupport=ospfTOSSupport, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaTable=ospfAreaTable, ospfDemandExtensions=ospfDemandExtensions, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfRestartAge=ospfRestartAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfEntry=ospfIfEntry, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLsdbEntry=ospfLsdbEntry, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfMetricValue=ospfIfMetricValue, ospfNbrPriority=ospfNbrPriority, ospfAreaLsaCount=ospfAreaLsaCount, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrRtrId=ospfNbrRtrId, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartStatus=ospfRestartStatus, ospfAreaGroup=ospfAreaGroup, ospfStubMetric=ospfStubMetric, ospfNbrEvents=ospfNbrEvents, ospfStubMetricType=ospfStubMetricType, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfIpAddress=ospfIfIpAddress, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostStatus=ospfHostStatus, ospfIfMetricTable=ospfIfMetricTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaId=ospfAreaId, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAddressLessIf=ospfAddressLessIf, ospfGroups=ospfGroups, ospfVirtIfTable=ospfVirtIfTable, ospfIfLsaCount=ospfIfLsaCount, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfConformance=ospfConformance, BigMetric=BigMetric, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfHostGroup2=ospfHostGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExternalType2=ospfExternalType2, ospfIfState=ospfIfState, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAdminStat=ospfAdminStat, PYSNMP_MODULE_ID=ospf, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrTable=ospfNbrTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostGroup=ospfHostGroup, ospfBasicGroup2=ospfBasicGroup2, DesignatedRouterPriority=DesignatedRouterPriority, ospfLsdbRouterId=ospfLsdbRouterId, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfDemand=ospfIfDemand, ospfInterArea=ospfInterArea, ospfAreaRangeGroup=ospfAreaRangeGroup, Metric=Metric, ospfNbrState=ospfNbrState, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfAdminStat=ospfIfAdminStat, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfSpfRuns=ospfSpfRuns, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsLsdbAge=ospfAsLsdbAge, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbLsid=ospfLsdbLsid, ospfIfAreaId=ospfIfAreaId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExternalType1=ospfExternalType1, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfType=ospfIfType, ospfLsdbGroup=ospfLsdbGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrGroup2=ospfNbrGroup2, ospfHostTable=ospfHostTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfIntraArea=ospfIntraArea, ospfAsLsaCount=ospfAsLsaCount, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaSummary=ospfAreaSummary, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaEntry=ospfAreaEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLsdbAge=ospfLsdbAge, ospfAreaStatus=ospfAreaStatus, ospfCompliances=ospfCompliances, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfRestartExitReason=ospfRestartExitReason, ospfStubTOS=ospfStubTOS, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfExternLsaCount=ospfExternLsaCount, ospfHostAreaID=ospfHostAreaID, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrState=ospfVirtNbrState, ospfIfMetricStatus=ospfIfMetricStatus, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfGeneralGroup=ospfGeneralGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfRestartInterval=ospfRestartInterval, ospfImportAsExtern=ospfImportAsExtern, ospfAuthType=ospfAuthType, ospfStubAreaTable=ospfStubAreaTable, ospfIfAuthKey=ospfIfAuthKey, ospfRestartSupport=ospfRestartSupport, ospfIfTable=ospfIfTable, ospfVirtIfState=ospfVirtIfState, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrEntry=ospfNbrEntry, HelloRange=HelloRange, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfGroup=ospfIfGroup, ospfIfStatus=ospfIfStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfEvents=ospfIfEvents, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfStubRouterSupport=ospfStubRouterSupport, UpToMaxAge=UpToMaxAge, ospfRxNewLsas=ospfRxNewLsas, ospfStubStatus=ospfStubStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospf=ospf, ospfHostEntry=ospfHostEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfGroup2=ospfIfGroup2, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRouterId=ospfRouterId, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, Status=Status, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLsdbType=ospfLsdbType, TOSType=TOSType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfCompliance=ospfCompliance, AreaID=AreaID, ospfExtLsdbType=ospfExtLsdbType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, OspfAuthenticationType=OspfAuthenticationType, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtNbrArea=ospfVirtNbrArea, RouterID=RouterID, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, PositiveInteger=PositiveInteger, ospfLsdbTable=ospfLsdbTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfCompliance2=ospfCompliance2, ospfExtLsdbAge=ospfExtLsdbAge, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostTOS=ospfHostTOS, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVersionNumber=ospfVersionNumber, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLsdbSequence=ospfLsdbSequence, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfMulticastExtensions=ospfMulticastExtensions, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfHostMetric=ospfHostMetric, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbLsid=ospfLocalLsdbLsid)
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfAuthType=ospfIfAuthType)
