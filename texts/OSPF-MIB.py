...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfNeighbor=ospfVirtIfNeighbor, Metric=Metric, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaRangeMask=ospfAreaRangeMask, RouterID=RouterID, ospfStubAreaId=ospfStubAreaId, ospfNbrGroup=ospfNbrGroup, ospfExternalType2=ospfExternalType2, PositiveInteger=PositiveInteger, ospfDemandExtensions=ospfDemandExtensions, ospfVersionNumber=ospfVersionNumber, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfRestartSupport=ospfRestartSupport, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubMetricType=ospfStubMetricType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAdminStat=ospfAdminStat, ospfIfStatus=ospfIfStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRestartAge=ospfRestartAge, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrOptions=ospfNbrOptions, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfRestartInterval=ospfRestartInterval, ospfIfRetransInterval=ospfIfRetransInterval, PYSNMP_MODULE_ID=ospf, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLsdbAge=ospfLsdbAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfAreaId=ospfIfAreaId, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRxNewLsas=ospfRxNewLsas, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfRouterId=ospfRouterId, ospfAsLsaCount=ospfAsLsaCount, ospfExternalType1=ospfExternalType1, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostTable=ospfHostTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExternLsaCount=ospfExternLsaCount, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfConformance=ospfConformance, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaSummary=ospfAreaSummary, ospfIfAuthKey=ospfIfAuthKey, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfStubStatus=ospfStubStatus, ospfTOSSupport=ospfTOSSupport, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtIfTable=ospfVirtIfTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrRtrId=ospfNbrRtrId, ospfBasicGroup=ospfBasicGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaStatus=ospfAreaStatus, ospfLsdbTable=ospfLsdbTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfGroups=ospfGroups, ospfHostTOS=ospfHostTOS, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfInterArea=ospfInterArea, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaTable=ospfAreaTable, HelloRange=HelloRange, ospfAuthType=ospfAuthType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIntraArea=ospfIntraArea, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfLsaCount=ospfIfLsaCount, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostGroup2=ospfHostGroup2, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfHostEntry=ospfHostEntry, BigMetric=BigMetric, ospfVirtIfState=ospfVirtIfState, OspfAuthenticationType=OspfAuthenticationType, AreaID=AreaID, ospfRestartStatus=ospfRestartStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAddressLessIf=ospfAddressLessIf, ospfAreaId=ospfAreaId, UpToMaxAge=UpToMaxAge, ospfLsdbType=ospfLsdbType, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfImportAsExtern=ospfImportAsExtern, ospfIfGroup2=ospfIfGroup2, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfAuthType=ospfIfAuthType, ospfVirtIfEntry=ospfVirtIfEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfStubTOS=ospfStubTOS, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostAreaID=ospfHostAreaID, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfBasicGroup2=ospfBasicGroup2, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfEvents=ospfIfEvents, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfRestartExitReason=ospfRestartExitReason, ospfIfAdminStat=ospfIfAdminStat, ospfNbrEvents=ospfNbrEvents, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfCompliances=ospfCompliances, TOSType=TOSType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrTable=ospfNbrTable, ospfLsdbGroup=ospfLsdbGroup, ospfHostStatus=ospfHostStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfEntry=ospfIfEntry, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfType=ospfIfType, ospfHostGroup=ospfHostGroup, ospf=ospf, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrState=ospfNbrState, ospfCompliance2=ospfCompliance2, ospfHostMetric=ospfHostMetric, ospfNbrPriority=ospfNbrPriority, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrGroup2=ospfVirtNbrGroup2, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfSpfRuns=ospfSpfRuns, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaEntry=ospfAreaEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, Status=Status, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfMetricTOS=ospfIfMetricTOS, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrTable=ospfVirtNbrTable, ospfRouteGroup=ospfRouteGroup, ospfIfGroup=ospfIfGroup, ospfHostIpAddress=ospfHostIpAddress, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfStubMetric=ospfStubMetric, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfTable=ospfIfTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLsdbLsid=ospfLsdbLsid, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfDemand=ospfIfDemand, ospfIfState=ospfIfState, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbType=ospfAsLsdbType, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaGroup=ospfAreaGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfEvents=ospfVirtIfEvents, ospfStubAreaTable=ospfStubAreaTable, ospfCompliance=ospfCompliance, ospfExtLsdbType=ospfExtLsdbType)
