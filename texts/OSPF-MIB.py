...
mibBuilder.exportSymbols("OSPF-MIB", ospfHostStatus=ospfHostStatus, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfPollInterval=ospfIfPollInterval, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubMetric=ospfStubMetric, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExternLsaCount=ospfExternLsaCount, ospfIfGroup=ospfIfGroup, ospfRouteGroup=ospfRouteGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostGroup2=ospfHostGroup2, ospfCompliances=ospfCompliances, ospfStubAreaId=ospfStubAreaId, ospfRestartInterval=ospfRestartInterval, ospfRouterId=ospfRouterId, ospfAdminStat=ospfAdminStat, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfGroup=ospfVirtIfGroup, ospfImportAsExtern=ospfImportAsExtern, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrState=ospfNbrState, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, HelloRange=HelloRange, ospfAreaLsaCount=ospfAreaLsaCount, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLsdbEntry=ospfLsdbEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaId=ospfAreaId, ospfIfEntry=ospfIfEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLsdbTable=ospfLsdbTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfLsaCount=ospfIfLsaCount, ospfAreaSummary=ospfAreaSummary, Status=Status, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfType=ospfIfType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfMetricTable=ospfIfMetricTable, ospfRestartStatus=ospfRestartStatus, ospfAsLsaCount=ospfAsLsaCount, ospf=ospf, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrTable=ospfNbrTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfEvents=ospfIfEvents, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfStatus=ospfIfStatus, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostTOS=ospfHostTOS, ospfLsdbGroup=ospfLsdbGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfEvents=ospfVirtIfEvents, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfMetricValue=ospfIfMetricValue, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfAdminStat=ospfIfAdminStat, ospfGeneralGroup=ospfGeneralGroup, ospfRestartSupport=ospfRestartSupport, ospfAreaRangeNet=ospfAreaRangeNet, ospfHostAreaID=ospfHostAreaID, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfTable=ospfIfTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfStubTOS=ospfStubTOS, ospfInterArea=ospfInterArea, ospfHostGroup=ospfHostGroup, AreaID=AreaID, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaStatus=ospfAreaStatus, ospfObsoleteGroup=ospfObsoleteGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, UpToMaxAge=UpToMaxAge, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfCompliance=ospfCompliance, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfHostTable=ospfHostTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAddressLessIf=ospfAddressLessIf, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaTable=ospfAreaTable, ospfIfAuthType=ospfIfAuthType, ospfNbrGroup2=ospfNbrGroup2, ospfConformance=ospfConformance, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, BigMetric=BigMetric, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, RouterID=RouterID, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfRestartAge=ospfRestartAge, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfCompliance2=ospfCompliance2, ospfGroups=ospfGroups, OspfAuthenticationType=OspfAuthenticationType, ospfHostMetric=ospfHostMetric, ospfVirtIfState=ospfVirtIfState, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrOptions=ospfNbrOptions, PYSNMP_MODULE_ID=ospf, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbLsid=ospfLsdbLsid, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrState=ospfVirtNbrState, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrEvents=ospfNbrEvents, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLsdbAge=ospfLsdbAge, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLocalLsdbType=ospfLocalLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfBasicGroup2=ospfBasicGroup2, ospfHostEntry=ospfHostEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLsdbAreaId=ospfLsdbAreaId, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrEntry=ospfNbrEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfGroup2=ospfIfGroup2, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfTOSSupport=ospfTOSSupport, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfDemandExtensions=ospfDemandExtensions, PositiveInteger=PositiveInteger, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubAreaTable=ospfStubAreaTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAsLsdbType=ospfAsLsdbType, ospfExternalType1=ospfExternalType1, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, Metric=Metric, TOSType=TOSType, ospfMulticastExtensions=ospfMulticastExtensions, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAuthType=ospfAuthType, ospfStubMetricType=ospfStubMetricType, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrGroup=ospfNbrGroup, ospfIfState=ospfIfState, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaGroup=ospfAreaGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIntraArea=ospfIntraArea, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRxNewLsas=ospfRxNewLsas, ospfAreaGroup2=ospfAreaGroup2, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLsdbType=ospfLsdbType, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfDemand=ospfIfDemand, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVersionNumber=ospfVersionNumber, ospfStubStatus=ospfStubStatus, ospfNbmaNbrStatus=ospfNbmaNbrStatus)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval)
