...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrTable=ospfNbrTable, ospfIfIpAddress=ospfIfIpAddress, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, RouterID=RouterID, ospfHostEntry=ospfHostEntry, ospfVirtIfTable=ospfVirtIfTable, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospf=ospf, ospfIfPollInterval=ospfIfPollInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, BigMetric=BigMetric, ospfVersionNumber=ospfVersionNumber, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfMetricEntry=ospfIfMetricEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfStubMetric=ospfStubMetric, ospfHostIpAddress=ospfHostIpAddress, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbSequence=ospfLsdbSequence, ospfIfRtrPriority=ospfIfRtrPriority, ospfRestartSupport=ospfRestartSupport, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrState=ospfVirtNbrState, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfStubMetricType=ospfStubMetricType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfInterArea=ospfInterArea, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostMetric=ospfHostMetric, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfMetricValue=ospfIfMetricValue, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfEntry=ospfIfEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfStubAreaGroup=ospfStubAreaGroup, ospfRestartStatus=ospfRestartStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfGroups=ospfGroups, ospfCompliance=ospfCompliance, ospfNbrRtrId=ospfNbrRtrId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfStatus=ospfIfStatus, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrArea=ospfVirtNbrArea, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfState=ospfVirtIfState, ospfAreaTable=ospfAreaTable, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfState=ospfIfState, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfDemand=ospfIfDemand, ospfAreaGroup=ospfAreaGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExternLsaCount=ospfExternLsaCount, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfMetricTable=ospfIfMetricTable, ospfStubStatus=ospfStubStatus, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateNet=ospfAreaAggregateNet, TOSType=TOSType, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfDemandExtensions=ospfDemandExtensions, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfTransitDelay=ospfIfTransitDelay, ospfConformance=ospfConformance, ospfBasicGroup=ospfBasicGroup, ospfRxNewLsas=ospfRxNewLsas, ospfRestartExitReason=ospfRestartExitReason, ospfStubAreaTable=ospfStubAreaTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaStatus=ospfAreaStatus, ospfLsdbType=ospfLsdbType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, HelloRange=HelloRange, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfDiscontinuityTime=ospfDiscontinuityTime, OspfAuthenticationType=OspfAuthenticationType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfRestartAge=ospfRestartAge, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfHostTOS=ospfHostTOS, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrState=ospfNbrState, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfAdminStat=ospfIfAdminStat, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfStubAreaId=ospfStubAreaId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAsLsdbType=ospfAsLsdbType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrEntry=ospfNbrEntry, ospfIfGroup2=ospfIfGroup2, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfStubTOS=ospfStubTOS, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaId=ospfAreaId, ospfRouterId=ospfRouterId, ospfIfHelloInterval=ospfIfHelloInterval, ospfSpfRuns=ospfSpfRuns, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfEvents=ospfIfEvents, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfImportAsExtern=ospfImportAsExtern, ospfHostStatus=ospfHostStatus, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfRestartInterval=ospfRestartInterval, ospfCompliance2=ospfCompliance2, ospfLsdbAreaId=ospfLsdbAreaId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, AreaID=AreaID, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfEvents=ospfVirtIfEvents, Status=Status, ospfAreaEntry=ospfAreaEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrEvents=ospfNbrEvents, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbTable=ospfAsLsdbTable, ospfIntraArea=ospfIntraArea, ospfAreaSummary=ospfAreaSummary, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, PYSNMP_MODULE_ID=ospf, ospfLocalLsdbType=ospfLocalLsdbType, ospfExternalType2=ospfExternalType2, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrIpAddr=ospfNbrIpAddr, ospfRFC1583Compatibility=ospfRFC1583Compatibility, UpToMaxAge=UpToMaxAge, ospfLsdbAge=ospfLsdbAge, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfAreaId=ospfIfAreaId, ospfIfAuthType=ospfIfAuthType, Metric=Metric, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfAuthKey=ospfIfAuthKey, ospfGeneralGroup=ospfGeneralGroup, PositiveInteger=PositiveInteger, ospfIfType=ospfIfType, ospfCompliances=ospfCompliances, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfRouteGroup=ospfRouteGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLsdbTable=ospfLsdbTable, ospfBasicGroup2=ospfBasicGroup2, ospfLsdbGroup=ospfLsdbGroup, ospfNbrGroup=ospfNbrGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrGroup2=ospfNbrGroup2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAddressLessIf=ospfAddressLessIf, ospfIfGroup=ospfIfGroup, ospfAuthType=ospfAuthType, ospfHostTable=ospfHostTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAdminStat=ospfAdminStat, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfTable=ospfIfTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostGroup=ospfHostGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLsdbRouterId=ospfLsdbRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricStatus=ospfIfMetricStatus, ospfExternalType1=ospfExternalType1, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum)
