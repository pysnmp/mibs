...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfAdminStat=ospfIfAdminStat, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfImportAsExtern=ospfImportAsExtern, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfState=ospfIfState, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfHostGroup=ospfHostGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbType=ospfLsdbType, ospfAreaTable=ospfAreaTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, HelloRange=HelloRange, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAuthType=ospfAuthType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaSummary=ospfAreaSummary, ospfVirtIfTable=ospfVirtIfTable, ospfStubMetric=ospfStubMetric, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaStatus=ospfAreaStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfConformance=ospfConformance, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubStatus=ospfStubStatus, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfHostMetric=ospfHostMetric, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfStubTOS=ospfStubTOS, ospfExternalType2=ospfExternalType2, ospfBasicGroup2=ospfBasicGroup2, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrOptions=ospfNbrOptions, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfGroup=ospfVirtIfGroup, ospfAddressLessIf=ospfAddressLessIf, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, OspfAuthenticationType=OspfAuthenticationType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExternLsaCount=ospfExternLsaCount, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfGroup2=ospfIfGroup2, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbType=ospfAsLsdbType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfTable=ospfIfTable, Status=Status, ospfAdminStat=ospfAdminStat, ospfTOSSupport=ospfTOSSupport, ospfAreaId=ospfAreaId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfEvents=ospfIfEvents, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfComplianceObsolete=ospfComplianceObsolete, AreaID=AreaID, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRxNewLsas=ospfRxNewLsas, ospfIfAreaId=ospfIfAreaId, ospfDemandExtensions=ospfDemandExtensions, ospfIfAuthKey=ospfIfAuthKey, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfStatus=ospfIfStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrState=ospfNbrState, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfGroup=ospfIfGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospf=ospf, ospfVirtNbrState=ospfVirtNbrState, DesignatedRouterPriority=DesignatedRouterPriority, PYSNMP_MODULE_ID=ospf, ospfLsdbChecksum=ospfLsdbChecksum, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfNbrGroup2=ospfNbrGroup2, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfExtLsdbTable=ospfExtLsdbTable, ospfHostGroup2=ospfHostGroup2, ospfStubAreaId=ospfStubAreaId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExtLsdbType=ospfExtLsdbType, ospfIfIpAddress=ospfIfIpAddress, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfAuthType=ospfIfAuthType, ospfInterArea=ospfInterArea, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfHostTOS=ospfHostTOS, ospfIfType=ospfIfType, ospfIfPollInterval=ospfIfPollInterval, ospfNbrRtrId=ospfNbrRtrId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfDemand=ospfIfDemand, TOSType=TOSType, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLsdbAge=ospfLsdbAge, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfHostAreaID=ospfHostAreaID, ospfNbrEvents=ospfNbrEvents, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrPriority=ospfNbrPriority, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRestartInterval=ospfRestartInterval, ospfRestartAge=ospfRestartAge, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsdbAge=ospfAsLsdbAge, ospfRestartExitReason=ospfRestartExitReason, ospfAreaGroup2=ospfAreaGroup2, ospfVersionNumber=ospfVersionNumber, ospfIfHelloInterval=ospfIfHelloInterval, ospfStubMetricType=ospfStubMetricType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfState=ospfVirtIfState, ospfSpfRuns=ospfSpfRuns, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, PositiveInteger=PositiveInteger, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbEntry=ospfLsdbEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrEntry=ospfNbrEntry, Metric=Metric, BigMetric=BigMetric, ospfLocalLsdbType=ospfLocalLsdbType, ospfExternalType1=ospfExternalType1, ospfGroups=ospfGroups, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfRestartSupport=ospfRestartSupport, ospfHostTable=ospfHostTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfCompliance2=ospfCompliance2, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfRouteGroup=ospfRouteGroup, ospfIfEntry=ospfIfEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfNbrGroup=ospfNbrGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfCompliances=ospfCompliances, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfBasicGroup=ospfBasicGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfMetricTable=ospfIfMetricTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfHostEntry=ospfHostEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfHostIpAddress=ospfHostIpAddress, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfHostStatus=ospfHostStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfCompliance=ospfCompliance, ospfExternLsaCksumSum=ospfExternLsaCksumSum, RouterID=RouterID, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbAreaId=ospfLsdbAreaId, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaEntry=ospfAreaEntry, ospfIfMetricValue=ospfIfMetricValue, ospfIfMetricTOS=ospfIfMetricTOS, ospfLsdbGroup=ospfLsdbGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, UpToMaxAge=UpToMaxAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfGroup2=ospfVirtIfGroup2)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIntraArea=ospfIntraArea, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbTable=ospfLsdbTable)
