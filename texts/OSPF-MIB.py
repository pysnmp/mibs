...
mibBuilder.exportSymbols("OSPF-MIB", ospfStubAreaTable=ospfStubAreaTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfRestartInterval=ospfRestartInterval, ospfIfType=ospfIfType, ospfBasicGroup=ospfBasicGroup, TOSType=TOSType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostAreaID=ospfHostAreaID, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrGroup2=ospfVirtNbrGroup2, PYSNMP_MODULE_ID=ospf, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbType=ospfLsdbType, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfAuthKey=ospfIfAuthKey, ospfStubMetric=ospfStubMetric, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfState=ospfIfState, PositiveInteger=PositiveInteger, BigMetric=BigMetric, ospfAreaTable=ospfAreaTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbAreaId=ospfLsdbAreaId, ospfExtLsdbType=ospfExtLsdbType, ospfExternalType2=ospfExternalType2, ospfAreaStatus=ospfAreaStatus, ospfIfAdminStat=ospfIfAdminStat, ospfImportAsExtern=ospfImportAsExtern, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfBasicGroup2=ospfBasicGroup2, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfAreaId=ospfIfAreaId, ospfAsLsaCount=ospfAsLsaCount, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfCompliances=ospfCompliances, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaGroup=ospfAreaGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostTable=ospfHostTable, ospfVersionNumber=ospfVersionNumber, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExternalType1=ospfExternalType1, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfIpAddress=ospfIfIpAddress, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, UpToMaxAge=UpToMaxAge, ospfNbrEntry=ospfNbrEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfTOSSupport=ospfTOSSupport, ospfNbrRtrId=ospfNbrRtrId, ospf=ospf, ospfExternLsaCount=ospfExternLsaCount, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfCompliance=ospfCompliance, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfGroup=ospfIfGroup, Metric=Metric, ospfIfRetransInterval=ospfIfRetransInterval, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfRestartExitReason=ospfRestartExitReason, ospfIfMetricTable=ospfIfMetricTable, ospfNbrEvents=ospfNbrEvents, ospfHostStatus=ospfHostStatus, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsLsdbAge=ospfAsLsdbAge, ospfIntraArea=ospfIntraArea, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, AreaID=AreaID, ospfStubMetricType=ospfStubMetricType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostGroup=ospfHostGroup, ospfAsLsdbType=ospfAsLsdbType, ospfAreaGroup2=ospfAreaGroup2, ospfAdminStat=ospfAdminStat, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfAuthType=ospfIfAuthType, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaEntry=ospfAreaEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, HelloRange=HelloRange, ospfRouterId=ospfRouterId, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrState=ospfNbrState, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRouteGroup=ospfRouteGroup, ospfStubAreaId=ospfStubAreaId, ospfLsdbTable=ospfLsdbTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrArea=ospfVirtNbrArea, ospfHostTOS=ospfHostTOS, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfHostEntry=ospfHostEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfInterArea=ospfInterArea, ospfGeneralGroup=ospfGeneralGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfTable=ospfIfTable, ospfNbrTable=ospfNbrTable, ospfVirtIfState=ospfVirtIfState, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfReferenceBandwidth=ospfReferenceBandwidth, RouterID=RouterID, ospfDemandExtensions=ospfDemandExtensions, ospfStubStatus=ospfStubStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfCompliance2=ospfCompliance2, ospfAuthType=ospfAuthType, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaId=ospfAreaId, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtIfTable=ospfVirtIfTable, ospfAreaSummary=ospfAreaSummary, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfStatus=ospfIfStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfStubTOS=ospfStubTOS, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbGroup=ospfLsdbGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfSpfRuns=ospfSpfRuns, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfRestartSupport=ospfRestartSupport, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfDemand=ospfIfDemand, ospfLsdbAge=ospfLsdbAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfMetricGroup=ospfIfMetricGroup, ospfRestartAge=ospfRestartAge, ospfHostGroup2=ospfHostGroup2, ospfNbrGroup=ospfNbrGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfGroup2=ospfIfGroup2, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfConformance=ospfConformance, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfEntry=ospfIfEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrGroup2=ospfNbrGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, Status=Status, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfHostMetric=ospfHostMetric, ospfVirtIfGroup=ospfVirtIfGroup, ospfRestartStatus=ospfRestartStatus, ospfHostIpAddress=ospfHostIpAddress, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAddressLessIf=ospfAddressLessIf, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfEvents=ospfIfEvents, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbEntry=ospfLsdbEntry, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbEntry=ospfLocalLsdbEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfGroups=ospfGroups, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrState=ospfVirtNbrState, ospfHostCfgAreaID=ospfHostCfgAreaID)
