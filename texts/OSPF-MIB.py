...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfStatus=ospfIfStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfMulticastExtensions=ospfMulticastExtensions, ospfLsdbTable=ospfLsdbTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubMetricType=ospfStubMetricType, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfAuthKey=ospfIfAuthKey, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfState=ospfIfState, ospfStubAreaId=ospfStubAreaId, ospfNbrEvents=ospfNbrEvents, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfTable=ospfVirtIfTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfCompliance2=ospfCompliance2, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLsdbGroup=ospfLsdbGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfHostEntry=ospfHostEntry, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrGroup=ospfNbrGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfGroup=ospfVirtIfGroup, ospfBasicGroup2=ospfBasicGroup2, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfRestartSupport=ospfRestartSupport, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostAreaID=ospfHostAreaID, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfGroups=ospfGroups, ospfRestartAge=ospfRestartAge, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfInterArea=ospfInterArea, OspfAuthenticationType=OspfAuthenticationType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubAreaGroup=ospfStubAreaGroup, ospfRestartStatus=ospfRestartStatus, ospfIfTable=ospfIfTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfCompliance=ospfCompliance, PositiveInteger=PositiveInteger, ospf=ospf, ospfTOSSupport=ospfTOSSupport, ospfNbrIpAddr=ospfNbrIpAddr, ospfAsLsdbTable=ospfAsLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrTable=ospfNbrTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfStubAreaEntry=ospfStubAreaEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIntraArea=ospfIntraArea, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRouterId=ospfRouterId, ospfLsdbRouterId=ospfLsdbRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaSummary=ospfAreaSummary, ospfIfMetricTOS=ospfIfMetricTOS, ospfExternLsaCount=ospfExternLsaCount, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLocalLsdbEntry=ospfLocalLsdbEntry, RouterID=RouterID, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRouteGroup=ospfRouteGroup, ospfNbrGroup2=ospfNbrGroup2, ospfAdminStat=ospfAdminStat, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbType=ospfExtLsdbType, ospfAreaStatus=ospfAreaStatus, ospfAsLsdbGroup=ospfAsLsdbGroup, UpToMaxAge=UpToMaxAge, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLsdbType=ospfLsdbType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRxNewLsas=ospfRxNewLsas, ospfImportAsExtern=ospfImportAsExtern, ospfNbrOptions=ospfNbrOptions, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrEntry=ospfNbrEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfStubAreaTable=ospfStubAreaTable, TOSType=TOSType, ospfHostIpAddress=ospfHostIpAddress, ospfVersionNumber=ospfVersionNumber, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubMetric=ospfStubMetric, ospfCompliances=ospfCompliances, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAddressLessIf=ospfAddressLessIf, ospfExtLsdbTable=ospfExtLsdbTable, ospfRestartInterval=ospfRestartInterval, ospfExternalType2=ospfExternalType2, ospfHostGroup2=ospfHostGroup2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, Metric=Metric, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfStubStatus=ospfStubStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, PYSNMP_MODULE_ID=ospf, ospfHostGroup=ospfHostGroup, ospfAreaTable=ospfAreaTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfHostStatus=ospfHostStatus, ospfIfDemand=ospfIfDemand, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, AreaID=AreaID, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbEntry=ospfLsdbEntry, ospfBasicGroup=ospfBasicGroup, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubTOS=ospfStubTOS, ospfIfAreaId=ospfIfAreaId, ospfHostTOS=ospfHostTOS, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, Status=Status, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAuthType=ospfAuthType, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfExternalType1=ospfExternalType1, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaGroup=ospfAreaGroup, ospfNbrPriority=ospfNbrPriority, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfHostMetric=ospfHostMetric, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaId=ospfAreaId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfNbrState=ospfNbrState, ospfVirtNbrState=ospfVirtNbrState, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfComplianceObsolete=ospfComplianceObsolete, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfEvents=ospfIfEvents, ospfIfGroup2=ospfIfGroup2, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostTable=ospfHostTable, ospfIfEntry=ospfIfEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrRtrId=ospfNbrRtrId, ospfIfIpAddress=ospfIfIpAddress, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfMetricStatus=ospfIfMetricStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAsLsaCount=ospfAsLsaCount, ospfGeneralGroup=ospfGeneralGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfMetricEntry=ospfIfMetricEntry, HelloRange=HelloRange, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfAuthType=ospfIfAuthType, BigMetric=BigMetric, ospfAreaGroup2=ospfAreaGroup2, ospfIfLsaCount=ospfIfLsaCount, ospfIfType=ospfIfType, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfConformance=ospfConformance, ospfAsLsdbType=ospfAsLsdbType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, DesignatedRouterPriority=DesignatedRouterPriority, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaEntry=ospfAreaEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfMetricTable=ospfIfMetricTable)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfGroup=ospfIfGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId)
