...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaId=ospfAreaId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfBasicGroup2=ospfBasicGroup2, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLsdbLsid=ospfLsdbLsid, DesignatedRouterPriority=DesignatedRouterPriority, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfHostMetric=ospfHostMetric, ospfNbrState=ospfNbrState, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLsdbEntry=ospfLsdbEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, Status=Status, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfHostGroup2=ospfHostGroup2, ospfRestartExitReason=ospfRestartExitReason, ospfBasicGroup=ospfBasicGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtNbrState=ospfVirtNbrState, ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfRxNewLsas=ospfRxNewLsas, ospfInterArea=ospfInterArea, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfStubMetricType=ospfStubMetricType, ospfStubStatus=ospfStubStatus, ospfRestartStatus=ospfRestartStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfGroup=ospfIfGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostGroup=ospfHostGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaEntry=ospfAreaEntry, ospfIfAreaId=ospfIfAreaId, ospfIfEntry=ospfIfEntry, UpToMaxAge=UpToMaxAge, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExternalType1=ospfExternalType1, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaLsaCount=ospfAreaLsaCount, PositiveInteger=PositiveInteger, ospfHostTOS=ospfHostTOS, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfRouterId=ospfRouterId, ospfIfLsaCount=ospfIfLsaCount, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExternalType2=ospfExternalType2, ospfIfEvents=ospfIfEvents, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostAreaID=ospfHostAreaID, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfLsaCksumSum=ospfIfLsaCksumSum, RouterID=RouterID, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfGeneralGroup=ospfGeneralGroup, ospfLsdbTable=ospfLsdbTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrOptions=ospfNbrOptions, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfStubTOS=ospfStubTOS, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRestartInterval=ospfRestartInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfTOSSupport=ospfTOSSupport, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfGroups=ospfGroups, ospfAreaSummary=ospfAreaSummary, ospfVirtIfGroup=ospfVirtIfGroup, ospfExternLsaCount=ospfExternLsaCount, ospfLsdbAge=ospfLsdbAge, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfStubRouterSupport=ospfStubRouterSupport, ospfSpfRuns=ospfSpfRuns, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfVersionNumber=ospfVersionNumber, ospfHostIpAddress=ospfHostIpAddress, ospfRestartSupport=ospfRestartSupport, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrGroup=ospfNbrGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfImportAsExtern=ospfImportAsExtern, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, AreaID=AreaID, ospf=ospf, ospfAreaStatus=ospfAreaStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfDemand=ospfIfDemand, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfCompliance=ospfCompliance, ospfHostTable=ospfHostTable, ospfAuthType=ospfAuthType, ospfAddressLessIf=ospfAddressLessIf, ospfIfTable=ospfIfTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrEvents=ospfNbrEvents, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLsdbGroup=ospfLsdbGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, Metric=Metric, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLsdbRouterId=ospfLsdbRouterId, TOSType=TOSType, ospfHostStatus=ospfHostStatus, ospfIfStatus=ospfIfStatus, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfMetricValue=ospfIfMetricValue, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaTable=ospfAreaTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, HelloRange=HelloRange, ospfAreaRangeMask=ospfAreaRangeMask, ospfAdminStat=ospfAdminStat, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfCompliance2=ospfCompliance2, ospfNbrPriority=ospfNbrPriority, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfCompliances=ospfCompliances, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfType=ospfIfType, ospfIfMetricEntry=ospfIfMetricEntry, BigMetric=BigMetric, ospfLsdbType=ospfLsdbType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfIpAddress=ospfIfIpAddress, ospfNbrTable=ospfNbrTable, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfConformance=ospfConformance, ospfRestartAge=ospfRestartAge, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfState=ospfIfState, ospfIfRetransInterval=ospfIfRetransInterval, ospfIntraArea=ospfIntraArea, OspfAuthenticationType=OspfAuthenticationType, ospfHostEntry=ospfHostEntry, ospfIfPollInterval=ospfIfPollInterval, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsaCount=ospfAsLsaCount, PYSNMP_MODULE_ID=ospf, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrRtrId=ospfNbrRtrId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfGroup2=ospfIfGroup2, ospfDemandExtensions=ospfDemandExtensions, ospfIfAuthType=ospfIfAuthType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfAdminStat=ospfIfAdminStat, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfTable=ospfVirtIfTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfNbrIpAddr=ospfNbrIpAddr, ospfStubMetric=ospfStubMetric, ospfIfMulticastForwarding=ospfIfMulticastForwarding)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbrEntry=ospfNbrEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrGroup2=ospfNbrGroup2)
