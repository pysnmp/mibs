...
mibBuilder.exportSymbols("OSPF-MIB", ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLsdbAge=ospfLsdbAge, ospfIfLsaCount=ospfIfLsaCount, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaStatus=ospfAreaStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfCompliance2=ospfCompliance2, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfMulticastExtensions=ospfMulticastExtensions, ospfCompliance=ospfCompliance, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaTable=ospfAreaTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, PYSNMP_MODULE_ID=ospf, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfExternLsaCount=ospfExternLsaCount, ospfCompliances=ospfCompliances, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfStubMetric=ospfStubMetric, TOSType=TOSType, ospfHostTable=ospfHostTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfStatus=ospfIfStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfRouteGroup=ospfRouteGroup, ospfRouterId=ospfRouterId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfTOSSupport=ospfTOSSupport, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaSummary=ospfAreaSummary, ospfAreaAggregateNet=ospfAreaAggregateNet, OspfAuthenticationType=OspfAuthenticationType, ospfGeneralGroup=ospfGeneralGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfBasicGroup=ospfBasicGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, Status=Status, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfType=ospfIfType, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrTable=ospfNbrTable, ospfLsdbChecksum=ospfLsdbChecksum, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfExternalType1=ospfExternalType1, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfEntry=ospfIfEntry, ospfHostStatus=ospfHostStatus, ospfIntraArea=ospfIntraArea, ospfVirtIfState=ospfVirtIfState, ospfLsdbRouterId=ospfLsdbRouterId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfHostEntry=ospfHostEntry, ospfSpfRuns=ospfSpfRuns, HelloRange=HelloRange, ospfAdminStat=ospfAdminStat, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfImportAsExtern=ospfImportAsExtern, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbrGroup=ospfNbrGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfAsLsaCount=ospfAsLsaCount, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, RouterID=RouterID, ospfIfEvents=ospfIfEvents, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfMetricTable=ospfIfMetricTable, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfAreaId=ospfIfAreaId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaId=ospfAreaId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostGroup2=ospfHostGroup2, ospfHostAreaID=ospfHostAreaID, ospfGroups=ospfGroups, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExternalType2=ospfExternalType2, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbType=ospfExtLsdbType, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaGroup=ospfAreaGroup, ospfIfGroup=ospfIfGroup, ospfAuthType=ospfAuthType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbGroup=ospfLsdbGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfStubAreaTable=ospfStubAreaTable, ospfIfAuthType=ospfIfAuthType, ospfRestartSupport=ospfRestartSupport, ospfAsLsdbType=ospfAsLsdbType, ospfExtLsdbAge=ospfExtLsdbAge, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfInterArea=ospfInterArea, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfConformance=ospfConformance, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfGroup2=ospfIfGroup2, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfRxNewLsas=ospfRxNewLsas, ospf=ospf, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrGroup2=ospfNbrGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfStubMetricType=ospfStubMetricType, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVersionNumber=ospfVersionNumber, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, BigMetric=BigMetric, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbLsid=ospfExtLsdbLsid, UpToMaxAge=UpToMaxAge, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfRestartAge=ospfRestartAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostMetric=ospfHostMetric, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfState=ospfIfState, ospfVirtNbrState=ospfVirtNbrState, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfAdminStat=ospfIfAdminStat, ospfIfPollInterval=ospfIfPollInterval, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfTable=ospfVirtIfTable, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfAuthKey=ospfIfAuthKey, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfHostGroup=ospfHostGroup, ospfNbrState=ospfNbrState, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfStubStatus=ospfStubStatus, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfHostTOS=ospfHostTOS, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfDemandExtensions=ospfDemandExtensions, ospfAreaLsaCount=ospfAreaLsaCount, ospfHostIpAddress=ospfHostIpAddress, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubTOS=ospfStubTOS, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLsdbAreaId=ospfLsdbAreaId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbEntry=ospfLsdbEntry, ospfBasicGroup2=ospfBasicGroup2, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAsLsdbTable=ospfAsLsdbTable, Metric=Metric, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricGroup=ospfIfMetricGroup, ospfRestartInterval=ospfRestartInterval, ospfIfDemand=ospfIfDemand, ospfLsdbTable=ospfLsdbTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfTable=ospfIfTable, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbChecksum=ospfExtLsdbChecksum, PositiveInteger=PositiveInteger, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, AreaID=AreaID, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLsdbType=ospfLsdbType, ospfVirtIfLsaCount=ospfVirtIfLsaCount)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbLsid=ospfLsdbLsid)
