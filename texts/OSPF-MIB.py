...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfStatus=ospfVirtIfStatus, Status=Status, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrState=ospfVirtNbrState, ospfIfGroup=ospfIfGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbAge=ospfLsdbAge, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfHostAreaID=ospfHostAreaID, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, PYSNMP_MODULE_ID=ospf, ospfStubAreaTable=ospfStubAreaTable, ospfStubAreaId=ospfStubAreaId, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfAdminStat=ospfIfAdminStat, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, TOSType=TOSType, ospfStubTOS=ospfStubTOS, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, UpToMaxAge=UpToMaxAge, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaStatus=ospfAreaStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfObsoleteGroup=ospfObsoleteGroup, ospfInterArea=ospfInterArea, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfAuthKey=ospfIfAuthKey, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbAge=ospfAsLsdbAge, ospfIntraArea=ospfIntraArea, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfHostEntry=ospfHostEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfGeneralGroup=ospfGeneralGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaTable=ospfAreaTable, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfTable=ospfIfTable, ospfIfEvents=ospfIfEvents, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRouterId=ospfRouterId, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrOptions=ospfNbrOptions, ospfRxNewLsas=ospfRxNewLsas, ospfAreaGroup2=ospfAreaGroup2, ospfStubMetricType=ospfStubMetricType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, OspfAuthenticationType=OspfAuthenticationType, ospfStubMetric=ospfStubMetric, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfConformance=ospfConformance, ospfAddressLessIf=ospfAddressLessIf, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfGroup2=ospfIfGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfHostGroup=ospfHostGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfBasicGroup2=ospfBasicGroup2, ospfRestartStatus=ospfRestartStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfRetransInterval=ospfIfRetransInterval, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaSummary=ospfAreaSummary, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaGroup=ospfAreaGroup, ospfHostStatus=ospfHostStatus, ospfVersionNumber=ospfVersionNumber, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfAuthType=ospfIfAuthType, ospfAuthType=ospfAuthType, ospf=ospf, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLsdbType=ospfLsdbType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrEntry=ospfNbrEntry, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfState=ospfVirtIfState, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrArea=ospfVirtNbrArea, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfPollInterval=ospfIfPollInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbTable=ospfLsdbTable, ospfIfDemand=ospfIfDemand, AreaID=AreaID, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfGroups=ospfGroups, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLsdbLsid=ospfLsdbLsid, ospfCompliances=ospfCompliances, ospfNbrState=ospfNbrState, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfMetricTOS=ospfIfMetricTOS, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsaCount=ospfAsLsaCount, ospfHostMetric=ospfHostMetric, ospfIfEntry=ospfIfEntry, ospfStubStatus=ospfStubStatus, ospfAreaEntry=ospfAreaEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAdminStat=ospfAdminStat, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsdbType=ospfAsLsdbType, ospfNbrPriority=ospfNbrPriority, ospfIfIpAddress=ospfIfIpAddress, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrTable=ospfNbrTable, ospfExtLsdbType=ospfExtLsdbType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfRestartSupport=ospfRestartSupport, ospfSpfRuns=ospfSpfRuns, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfHostTOS=ospfHostTOS, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfDemandExtensions=ospfDemandExtensions, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaId=ospfAreaId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, PositiveInteger=PositiveInteger, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrGroup=ospfNbrGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfState=ospfIfState, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfExternalType2=ospfExternalType2, ospfOriginateNewLsas=ospfOriginateNewLsas, BigMetric=BigMetric, Metric=Metric, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, HelloRange=HelloRange, ospfNbrGroup2=ospfNbrGroup2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfStatus=ospfIfStatus, ospfIfAreaId=ospfIfAreaId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfExternalType1=ospfExternalType1, ospfCompliance=ospfCompliance, ospfRestartInterval=ospfRestartInterval, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfLsaCount=ospfIfLsaCount, ospfIfMetricTable=ospfIfMetricTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfType=ospfIfType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfRestartAge=ospfRestartAge, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfTOSSupport=ospfTOSSupport, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostTable=ospfHostTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, RouterID=RouterID, ospfLocalLsdbLsid=ospfLocalLsdbLsid)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricEntry=ospfIfMetricEntry, ospfCompliance2=ospfCompliance2, ospfLocalLsdbType=ospfLocalLsdbType)
