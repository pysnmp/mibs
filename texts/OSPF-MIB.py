...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfHostTable=ospfHostTable, ospfRxNewLsas=ospfRxNewLsas, ospfStubMetricType=ospfStubMetricType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, AreaID=AreaID, ospfNbrTable=ospfNbrTable, ospfIfEvents=ospfIfEvents, ospfAreaLsaCount=ospfAreaLsaCount, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfStatus=ospfIfStatus, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfState=ospfIfState, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaTable=ospfAreaTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLsdbLsid=ospfLsdbLsid, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfAuthKey=ospfIfAuthKey, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfBasicGroup2=ospfBasicGroup2, ospfHostCfgAreaID=ospfHostCfgAreaID, OspfAuthenticationType=OspfAuthenticationType, ospfIfEntry=ospfIfEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfConformance=ospfConformance, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfSpfRuns=ospfSpfRuns, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfStubAreaId=ospfStubAreaId, ospfAreaGroup=ospfAreaGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfStubMetric=ospfStubMetric, ospfCompliance=ospfCompliance, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfBasicGroup=ospfBasicGroup, ospfRouterId=ospfRouterId, ospfIfAuthType=ospfIfAuthType, ospfIfMetricTOS=ospfIfMetricTOS, ospfRestartAge=ospfRestartAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfDemandExtensions=ospfDemandExtensions, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbRouterId=ospfLsdbRouterId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfExtLsdbType=ospfExtLsdbType, ospfNbrGroup2=ospfNbrGroup2, ospfHostStatus=ospfHostStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfHostTOS=ospfHostTOS, ospfExtLsdbTable=ospfExtLsdbTable, UpToMaxAge=UpToMaxAge, ospfAreaEntry=ospfAreaEntry, ospfAreaId=ospfAreaId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, Metric=Metric, ospfNbrState=ospfNbrState, ospfInterArea=ospfInterArea, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaSummary=ospfAreaSummary, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfDemand=ospfIfDemand, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfMetricValue=ospfIfMetricValue, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfStubAreaTable=ospfStubAreaTable, ospfExternalType2=ospfExternalType2, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfHostEntry=ospfHostEntry, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfHostGroup=ospfHostGroup, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfRestartStatus=ospfRestartStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbType=ospfAsLsdbType, ospfExternalType1=ospfExternalType1, HelloRange=HelloRange, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfLsaCount=ospfIfLsaCount, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfCompliances=ospfCompliances, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfStubStatus=ospfStubStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbChecksum=ospfLsdbChecksum, ospfExtLsdbAge=ospfExtLsdbAge, ospfNbrPriority=ospfNbrPriority, ospfAsLsdbAge=ospfAsLsdbAge, ospfStubRouterSupport=ospfStubRouterSupport, ospfRestartInterval=ospfRestartInterval, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVersionNumber=ospfVersionNumber, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfHostMetric=ospfHostMetric, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfState=ospfVirtIfState, ospfIntraArea=ospfIntraArea, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfGroup=ospfVirtIfGroup, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfIpAddress=ospfIfIpAddress, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsaCount=ospfAsLsaCount, ospfHostAreaID=ospfHostAreaID, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfType=ospfIfType, ospfIfMetricTable=ospfIfMetricTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaStatus=ospfAreaStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMetricGroup=ospfIfMetricGroup, ospfHostIpAddress=ospfHostIpAddress, ospfNbrGroup=ospfNbrGroup, ospfIfAreaId=ospfIfAreaId, ospfAsLsdbGroup=ospfAsLsdbGroup, BigMetric=BigMetric, ospfLsdbSequence=ospfLsdbSequence, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfTOSSupport=ospfTOSSupport, ospfLsdbType=ospfLsdbType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrOptions=ospfNbrOptions, ospfNbrRtrId=ospfNbrRtrId, ospf=ospf, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrEvents=ospfNbrEvents, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfTable=ospfIfTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfHostGroup2=ospfHostGroup2, ospfIfRetransInterval=ospfIfRetransInterval, PositiveInteger=PositiveInteger, ospfIfHelloInterval=ospfIfHelloInterval, ospfLsdbEntry=ospfLsdbEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfGroup=ospfIfGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaRangeMask=ospfAreaRangeMask, ospfRouteGroup=ospfRouteGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfGroups=ospfGroups, PYSNMP_MODULE_ID=ospf, ospfAdminStat=ospfAdminStat, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrArea=ospfVirtNbrArea, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfStatus=ospfVirtIfStatus, ospfLsdbTable=ospfLsdbTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfCompliance2=ospfCompliance2, ospfAuthType=ospfAuthType, Status=Status, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfStubTOS=ospfStubTOS, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbAge=ospfLsdbAge, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, TOSType=TOSType, ospfAddressLessIf=ospfAddressLessIf, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrState=ospfVirtNbrState)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfRestartSupport=ospfRestartSupport, RouterID=RouterID, ospfIfGroup2=ospfIfGroup2)
