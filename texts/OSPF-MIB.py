...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrGroup2=ospfNbrGroup2, ospfLsdbAge=ospfLsdbAge, ospfImportAsExtern=ospfImportAsExtern, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrIpAddr=ospfNbrIpAddr, ospfLsdbType=ospfLsdbType, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsaCount=ospfAsLsaCount, HelloRange=HelloRange, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfType=ospfIfType, ospfIfGroup=ospfIfGroup, ospfNbrPriority=ospfNbrPriority, UpToMaxAge=UpToMaxAge, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubMetricType=ospfStubMetricType, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaId=ospfAreaId, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrEvents=ospfNbrEvents, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfAuthKey=ospfIfAuthKey, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAuthType=ospfAuthType, ospfNbrGroup=ospfNbrGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, Status=Status, ospfRxNewLsas=ospfRxNewLsas, ospfVersionNumber=ospfVersionNumber, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrEntry=ospfNbrEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfRestartStatus=ospfRestartStatus, ospfStubStatus=ospfStubStatus, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbType=ospfAsLsdbType, Metric=Metric, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLocalLsdbGroup=ospfLocalLsdbGroup, PYSNMP_MODULE_ID=ospf, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, OspfAuthenticationType=OspfAuthenticationType, ospfHostAreaID=ospfHostAreaID, ospfExternalType1=ospfExternalType1, ospfCompliance=ospfCompliance, ospfObsoleteGroup=ospfObsoleteGroup, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfMetricTable=ospfIfMetricTable, ospfAreaTable=ospfAreaTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbType=ospfExtLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfAuthType=ospfIfAuthType, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfComplianceObsolete=ospfComplianceObsolete, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfGroup2=ospfIfGroup2, ospfNbrOptions=ospfNbrOptions, ospfCompliance2=ospfCompliance2, ospfIntraArea=ospfIntraArea, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaSummary=ospfAreaSummary, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbAreaId=ospfLsdbAreaId, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfRestartAge=ospfRestartAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfState=ospfIfState, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfSpfRuns=ospfSpfRuns, ospfIfLsaCount=ospfIfLsaCount, ospfIfHelloInterval=ospfIfHelloInterval, ospfStubAreaEntry=ospfStubAreaEntry, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRestartExitReason=ospfRestartExitReason, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaRangeMask=ospfAreaRangeMask, ospfAdminStat=ospfAdminStat, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfHostTable=ospfHostTable, ospfIfDemand=ospfIfDemand, ospfCompliances=ospfCompliances, ospfExternLsaCount=ospfExternLsaCount, ospfAreaRangeNet=ospfAreaRangeNet, ospfStubAreaTable=ospfStubAreaTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfStatus=ospfIfStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrRtrId=ospfNbrRtrId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfEntry=ospfIfEntry, ospfNbrState=ospfNbrState, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAddressLessIf=ospfAddressLessIf, ospfGroups=ospfGroups, ospfExtLsdbLsid=ospfExtLsdbLsid, AreaID=AreaID, TOSType=TOSType, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfAdminStat=ospfIfAdminStat, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfStubMetric=ospfStubMetric, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfBasicGroup=ospfBasicGroup, ospfLsdbGroup=ospfLsdbGroup, ospfLsdbTable=ospfLsdbTable, ospfAreaGroup=ospfAreaGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfInterArea=ospfInterArea, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfRestartInterval=ospfRestartInterval, ospfIfTable=ospfIfTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, PositiveInteger=PositiveInteger, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfNbrTable=ospfNbrTable, ospfExternalType2=ospfExternalType2, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfEvents=ospfIfEvents, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfHostGroup=ospfHostGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostStatus=ospfHostStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfRouteGroup=ospfRouteGroup, ospfIfIpAddress=ospfIfIpAddress, ospfConformance=ospfConformance, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, BigMetric=BigMetric, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLsdbSequence=ospfLsdbSequence, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfTOSSupport=ospfTOSSupport, ospfAreaEntry=ospfAreaEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, RouterID=RouterID, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostGroup2=ospfHostGroup2, ospfAreaStatus=ospfAreaStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfAreaId=ospfIfAreaId, ospf=ospf, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfStubTOS=ospfStubTOS, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrTable=ospfVirtNbrTable, ospfStubAreaId=ospfStubAreaId, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfHostTOS=ospfHostTOS, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfHostMetric=ospfHostMetric, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfMetricValue=ospfIfMetricValue, ospfLsdbLsid=ospfLsdbLsid, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLsdbEntry=ospfLsdbEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfState=ospfVirtIfState, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking)
