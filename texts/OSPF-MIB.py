...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfGroup2=ospfIfGroup2, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAdminStat=ospfAdminStat, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfEvents=ospfIfEvents, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfAuthKey=ospfIfAuthKey, ospfExternalType2=ospfExternalType2, ospfCompliance2=ospfCompliance2, ospfIfGroup=ospfIfGroup, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLocalLsdbType=ospfLocalLsdbType, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrEvents=ospfNbrEvents, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMetricStatus=ospfIfMetricStatus, PositiveInteger=PositiveInteger, ospfAreaSummary=ospfAreaSummary, ospfIfDemand=ospfIfDemand, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfHostGroup2=ospfHostGroup2, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfImportAsExtern=ospfImportAsExtern, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaRangeNet=ospfAreaRangeNet, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfHostAreaID=ospfHostAreaID, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrArea=ospfVirtNbrArea, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfMetricValue=ospfIfMetricValue, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbRouterId=ospfLsdbRouterId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospf=ospf, ospfRouterId=ospfRouterId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfTOSSupport=ospfTOSSupport, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAsLsdbType=ospfAsLsdbType, ospfNbrGroup2=ospfNbrGroup2, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubMetricType=ospfStubMetricType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaRangeTable=ospfAreaRangeTable, TOSType=TOSType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfBasicGroup=ospfBasicGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtIfState=ospfVirtIfState, ospfIfMetricTable=ospfIfMetricTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfTransitDelay=ospfIfTransitDelay, RouterID=RouterID, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVersionNumber=ospfVersionNumber, ospfLsdbAge=ospfLsdbAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrState=ospfNbrState, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfAdminStat=ospfIfAdminStat, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfPollInterval=ospfIfPollInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfRetransInterval=ospfIfRetransInterval, ospfIntraArea=ospfIntraArea, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaId=ospfAreaId, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrEntry=ospfNbrEntry, ospfInterArea=ospfInterArea, PYSNMP_MODULE_ID=ospf, ospfAreaEntry=ospfAreaEntry, ospfIfStatus=ospfIfStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfTable=ospfIfTable, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, BigMetric=BigMetric, ospfHostGroup=ospfHostGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfState=ospfIfState, ospfStubAreaTable=ospfStubAreaTable, ospfHostTOS=ospfHostTOS, ospfCompliance=ospfCompliance, ospfSpfRuns=ospfSpfRuns, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, Metric=Metric, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfEntry=ospfIfEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, HelloRange=HelloRange, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, AreaID=AreaID, ospfAsLsaCount=ospfAsLsaCount, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfConformance=ospfConformance, ospfIfAuthType=ospfIfAuthType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExternLsaCount=ospfExternLsaCount, ospfStubTOS=ospfStubTOS, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfBasicGroup2=ospfBasicGroup2, ospfLsdbTable=ospfLsdbTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfNbrTable=ospfNbrTable, ospfAreaStatus=ospfAreaStatus, ospfLsdbGroup=ospfLsdbGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfType=ospfIfType, ospfIfIpAddress=ospfIfIpAddress, ospfHostEntry=ospfHostEntry, ospfCompliances=ospfCompliances, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbType=ospfExtLsdbType, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtNbrState=ospfVirtNbrState, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostMetric=ospfHostMetric, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfEntry=ospfVirtIfEntry, ospfAddressLessIf=ospfAddressLessIf, ospfHostIpAddress=ospfHostIpAddress, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbType=ospfLsdbType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfGroups=ospfGroups, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbLsid=ospfLsdbLsid, ospfAreaTable=ospfAreaTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaGroup=ospfAreaGroup, ospfStubStatus=ospfStubStatus, ospfNbrOptions=ospfNbrOptions, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrGroup=ospfNbrGroup, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaLsaCount=ospfAreaLsaCount, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfHostTable=ospfHostTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRestartAge=ospfRestartAge, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostStatus=ospfHostStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, Status=Status, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfIfAreaId=ospfIfAreaId, DesignatedRouterPriority=DesignatedRouterPriority, UpToMaxAge=UpToMaxAge, ospfAsLsaCksumSum=ospfAsLsaCksumSum, OspfAuthenticationType=OspfAuthenticationType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfGeneralGroup=ospfGeneralGroup, ospfRestartSupport=ospfRestartSupport, ospfStubAreaId=ospfStubAreaId, ospfObsoleteGroup=ospfObsoleteGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfLsaCount=ospfIfLsaCount, ospfStubMetric=ospfStubMetric, ospfRestartInterval=ospfRestartInterval, ospfAuthType=ospfAuthType, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfDemandExtensions=ospfDemandExtensions, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole)
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExternalType1=ospfExternalType1, ospfAsLsdbLsid=ospfAsLsdbLsid)
