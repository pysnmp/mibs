...
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbLimit=ospfExtLsdbLimit, DesignatedRouterPriority=DesignatedRouterPriority, ospfVersionNumber=ospfVersionNumber, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExternLsaCount=ospfExternLsaCount, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, UpToMaxAge=UpToMaxAge, ospfIfType=ospfIfType, ospfIfStatus=ospfIfStatus, ospfStubAreaTable=ospfStubAreaTable, ospfCompliance2=ospfCompliance2, ospfNbrEvents=ospfNbrEvents, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAsLsaCount=ospfAsLsaCount, ospfHostStatus=ospfHostStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospfHostMetric=ospfHostMetric, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrTable=ospfNbrTable, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfAreaId=ospfIfAreaId, ospfLsdbLsid=ospfLsdbLsid, ospfLsdbAge=ospfLsdbAge, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrRtrId=ospfNbrRtrId, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAddressLessIf=ospfAddressLessIf, ospfNbrState=ospfNbrState, ospfBasicGroup=ospfBasicGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, PositiveInteger=PositiveInteger, ospfIfIpAddress=ospfIfIpAddress, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfGroup2=ospfIfGroup2, HelloRange=HelloRange, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, Metric=Metric, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfGeneralGroup=ospfGeneralGroup, ospfRestartExitReason=ospfRestartExitReason, ospfStubStatus=ospfStubStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfMetricTable=ospfIfMetricTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, AreaID=AreaID, ospfRouterId=ospfRouterId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfExtLsdbTable=ospfExtLsdbTable, ospfRouteGroup=ospfRouteGroup, ospfExternalType1=ospfExternalType1, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospf=ospf, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfState=ospfIfState, RouterID=RouterID, ospfNbrOptions=ospfNbrOptions, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrIpAddr=ospfNbrIpAddr, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfGroup=ospfIfGroup, ospfAdminStat=ospfAdminStat, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfHostGroup=ospfHostGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtIfTable=ospfVirtIfTable, ospfCompliance=ospfCompliance, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfEvents=ospfVirtIfEvents, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfAuthKey=ospfIfAuthKey, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubMetric=ospfStubMetric, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfGroups=ospfGroups, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbGroup=ospfLsdbGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfExtLsdbType=ospfExtLsdbType, ospfExternalType2=ospfExternalType2, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostEntry=ospfHostEntry, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfHostIpAddress=ospfHostIpAddress, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfHostTable=ospfHostTable, ospfDemandExtensions=ospfDemandExtensions, ospfAsLsdbChecksum=ospfAsLsdbChecksum, OspfAuthenticationType=OspfAuthenticationType, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaTable=ospfAreaTable, ospfAuthType=ospfAuthType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfStubTOS=ospfStubTOS, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfHostAreaID=ospfHostAreaID, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfTable=ospfIfTable, ospfRestartInterval=ospfRestartInterval, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIntraArea=ospfIntraArea, ospfRxNewLsas=ospfRxNewLsas, ospfRestartStatus=ospfRestartStatus, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtIfState=ospfVirtIfState, ospfLocalLsdbType=ospfLocalLsdbType, ospfInterArea=ospfInterArea, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, BigMetric=BigMetric, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfAuthType=ospfIfAuthType, ospfStubMetricType=ospfStubMetricType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfRestartSupport=ospfRestartSupport, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbAdvertisement=ospfLsdbAdvertisement, Status=Status, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfDemand=ospfIfDemand, ospfAreaStatus=ospfAreaStatus, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaGroup=ospfAreaGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfNbrGroup2=ospfNbrGroup2, ospfImportAsExtern=ospfImportAsExtern, TOSType=TOSType, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLsdbTable=ospfLsdbTable, ospfNbrPriority=ospfNbrPriority, PYSNMP_MODULE_ID=ospf, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfStubAreaId=ospfStubAreaId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfRestartAge=ospfRestartAge, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAsLsdbTable=ospfAsLsdbTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaSummary=ospfAreaSummary, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfMetricValue=ospfIfMetricValue, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaEntry=ospfAreaEntry, ospfHostTOS=ospfHostTOS, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaGroup2=ospfAreaGroup2, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLsdbType=ospfLsdbType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrEntry=ospfNbrEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbType=ospfAsLsdbType, ospfBasicGroup2=ospfBasicGroup2, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfConformance=ospfConformance, ospfAreaId=ospfAreaId, ospfSpfRuns=ospfSpfRuns, ospfCompliances=ospfCompliances, ospfTOSSupport=ospfTOSSupport, ospfHostGroup2=ospfHostGroup2, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAsLsdbRouterId=ospfAsLsdbRouterId)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfEntry=ospfIfEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaLsaCount=ospfAreaLsaCount)
