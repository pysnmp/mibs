...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostGroup2=ospfHostGroup2, ospfSpfRuns=ospfSpfRuns, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, UpToMaxAge=UpToMaxAge, ospfRestartAge=ospfRestartAge, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaStatus=ospfAreaStatus, ospfIfStatus=ospfIfStatus, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfInterArea=ospfInterArea, BigMetric=BigMetric, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfRestartInterval=ospfRestartInterval, ospfObsoleteGroup=ospfObsoleteGroup, ospfConformance=ospfConformance, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubAreaTable=ospfStubAreaTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrOptions=ospfNbrOptions, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfMetricTable=ospfIfMetricTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfCompliance2=ospfCompliance2, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, AreaID=AreaID, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfReferenceBandwidth=ospfReferenceBandwidth, Metric=Metric, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostEntry=ospfHostEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfState=ospfIfState, ospfRestartSupport=ospfRestartSupport, ospfAreaId=ospfAreaId, ospfIfEntry=ospfIfEntry, ospfAddressLessIf=ospfAddressLessIf, ospfHostTOS=ospfHostTOS, ospfAuthType=ospfAuthType, ospfExtLsdbTable=ospfExtLsdbTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfTOSSupport=ospfTOSSupport, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfTable=ospfIfTable, ospfAreaGroup=ospfAreaGroup, ospfIntraArea=ospfIntraArea, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfGroup=ospfVirtIfGroup, ospfRouterId=ospfRouterId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubStatus=ospfStubStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLsdbTable=ospfLsdbTable, ospfStubTOS=ospfStubTOS, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfIpAddress=ospfIfIpAddress, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfStubMetricType=ospfStubMetricType, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVersionNumber=ospfVersionNumber, ospfExtLsdbLsid=ospfExtLsdbLsid, PositiveInteger=PositiveInteger, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, Status=Status, ospfExternalType2=ospfExternalType2, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtNbrState=ospfVirtNbrState, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrEntry=ospfNbrEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfImportAsExtern=ospfImportAsExtern, HelloRange=HelloRange, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfPollInterval=ospfIfPollInterval, ospfHostMetric=ospfHostMetric, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostGroup=ospfHostGroup, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, PYSNMP_MODULE_ID=ospf, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrTable=ospfVirtNbrTable, ospfHostAreaID=ospfHostAreaID, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrGroup2=ospfNbrGroup2, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExternalType1=ospfExternalType1, ospfLsdbChecksum=ospfLsdbChecksum, ospfCompliances=ospfCompliances, ospfNbrRtrId=ospfNbrRtrId, ospfAreaEntry=ospfAreaEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfRouteGroup=ospfRouteGroup, ospfIfDemand=ospfIfDemand, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostStatus=ospfHostStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, TOSType=TOSType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaTable=ospfAreaTable, ospfIfType=ospfIfType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfMetricValue=ospfIfMetricValue, OspfAuthenticationType=OspfAuthenticationType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfCompliance=ospfCompliance, ospfAreaRangeTable=ospfAreaRangeTable, ospfGroups=ospfGroups, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostTable=ospfHostTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbAge=ospfLsdbAge, ospfIfAreaId=ospfIfAreaId, ospfBasicGroup2=ospfBasicGroup2, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrState=ospfNbrState, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfHostIpAddress=ospfHostIpAddress, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAdminStat=ospfAdminStat, ospfExternLsaCount=ospfExternLsaCount, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfStubMetric=ospfStubMetric, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfStatus=ospfVirtIfStatus, ospfAsLsdbAge=ospfAsLsdbAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfGroup=ospfIfGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaSummary=ospfAreaSummary, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrGroup=ospfNbrGroup, ospfIfAuthKey=ospfIfAuthKey, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLsdbEntry=ospfLsdbEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrTable=ospfNbrTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrPriority=ospfNbrPriority, ospf=ospf, ospfVirtIfState=ospfVirtIfState, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfAuthType=ospfIfAuthType, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfStubAreaId=ospfStubAreaId, ospfAsLsdbType=ospfAsLsdbType, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbGroup=ospfLsdbGroup, ospfIfGroup2=ospfIfGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaGroup2=ospfAreaGroup2, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfTransitDelay=ospfIfTransitDelay, ospfRxNewLsas=ospfRxNewLsas, ospfIfMetricEntry=ospfIfMetricEntry, ospfRestartExitReason=ospfRestartExitReason, ospfStubAreaGroup=ospfStubAreaGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaRangeNet=ospfAreaRangeNet, ospfBasicGroup=ospfBasicGroup, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLsdbType=ospfLsdbType, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfAuthType=ospfVirtIfAuthType)
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbAge=ospfExtLsdbAge, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, RouterID=RouterID, ospfVirtIfLsaCount=ospfVirtIfLsaCount)
