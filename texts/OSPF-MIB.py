...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeEntry=ospfAreaRangeEntry, ospfBasicGroup2=ospfBasicGroup2, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfAuthKey=ospfIfAuthKey, ospfTOSSupport=ospfTOSSupport, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfRouteGroup=ospfRouteGroup, ospfStubAreaId=ospfStubAreaId, ospfAuthType=ospfAuthType, ospfVersionNumber=ospfVersionNumber, ospfIfRetransInterval=ospfIfRetransInterval, ospfExternalType2=ospfExternalType2, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeMask=ospfAreaRangeMask, Status=Status, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrRtrId=ospfNbrRtrId, ospfStubStatus=ospfStubStatus, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfAuthKey=ospfVirtIfAuthKey, RouterID=RouterID, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaSummary=ospfAreaSummary, ospfHostGroup2=ospfHostGroup2, ospfHostIpAddress=ospfHostIpAddress, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAdminStat=ospfAdminStat, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubMetricType=ospfStubMetricType, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAddressLessIf=ospfAddressLessIf, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, HelloRange=HelloRange, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrGroup=ospfNbrGroup, ospfStubAreaTable=ospfStubAreaTable, ospfGroups=ospfGroups, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrState=ospfNbrState, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIntraArea=ospfIntraArea, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfSpfRuns=ospfSpfRuns, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfMetricEntry=ospfIfMetricEntry, ospf=ospf, ospfRxNewLsas=ospfRxNewLsas, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubRouterSupport=ospfStubRouterSupport, ospfLsdbEntry=ospfLsdbEntry, ospfHostGroup=ospfHostGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfHostAreaID=ospfHostAreaID, ospfVirtIfState=ospfVirtIfState, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaGroup2=ospfAreaGroup2, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, OspfAuthenticationType=OspfAuthenticationType, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRestartInterval=ospfRestartInterval, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfIpAddress=ospfIfIpAddress, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLsdbAge=ospfLsdbAge, ospfNbrTable=ospfNbrTable, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfStubAreaEntry=ospfStubAreaEntry, BigMetric=BigMetric, ospfRestartStatus=ospfRestartStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfGroup=ospfVirtIfGroup, ospfRestartSupport=ospfRestartSupport, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfDemand=ospfIfDemand, ospfAreaTable=ospfAreaTable, ospfGeneralGroup=ospfGeneralGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfRouterId=ospfRouterId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfMetricGroup=ospfIfMetricGroup, ospfLsdbType=ospfLsdbType, ospfIfAdminStat=ospfIfAdminStat, ospfCompliance2=ospfCompliance2, ospfIfLsaCount=ospfIfLsaCount, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, AreaID=AreaID, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfHostMetric=ospfHostMetric, ospfConformance=ospfConformance, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfExtLsdbTable=ospfExtLsdbTable, UpToMaxAge=UpToMaxAge, ospfAreaRangeTable=ospfAreaRangeTable, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfEntry=ospfIfEntry, ospfIfAreaId=ospfIfAreaId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostStatus=ospfHostStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfBasicGroup=ospfBasicGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfType=ospfIfType, ospfExternalType1=ospfExternalType1, TOSType=TOSType, ospfHostTOS=ospfHostTOS, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfMetricTable=ospfIfMetricTable, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrEntry=ospfNbrEntry, ospfIfAuthType=ospfIfAuthType, ospfAreaEntry=ospfAreaEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbLsid=ospfLsdbLsid, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfState=ospfIfState, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfStatus=ospfIfStatus, ospfIfEvents=ospfIfEvents, ospfIfTable=ospfIfTable, ospfAreaId=ospfAreaId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfGroup2=ospfIfGroup2, ospfAsLsaCount=ospfAsLsaCount, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfCompliance=ospfCompliance, ospfNbrPriority=ospfNbrPriority, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfHostEntry=ospfHostEntry, ospfAsLsdbAge=ospfAsLsdbAge, ospfCompliances=ospfCompliances, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfMetricValue=ospfIfMetricValue, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfInterArea=ospfInterArea, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbGroup=ospfLsdbGroup, ospfNbrGroup2=ospfNbrGroup2, ospfAreaAggregateNet=ospfAreaAggregateNet, PYSNMP_MODULE_ID=ospf, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostTable=ospfHostTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbType=ospfExtLsdbType, ospfDemandExtensions=ospfDemandExtensions, Metric=Metric, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrState=ospfVirtNbrState, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, PositiveInteger=PositiveInteger, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfNbrEvents=ospfNbrEvents, ospfIfPollInterval=ospfIfPollInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaStatus=ospfAreaStatus, ospfStubTOS=ospfStubTOS, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRestartAge=ospfRestartAge, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubMetric=ospfStubMetric, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfMulticastExtensions=ospfMulticastExtensions, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaGroup=ospfAreaGroup, ospfObsoleteGroup=ospfObsoleteGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeNet=ospfAreaRangeNet, ospfLsdbTable=ospfLsdbTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfGroup=ospfIfGroup)
