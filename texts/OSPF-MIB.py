...
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbLsid=ospfAsLsdbLsid, TOSType=TOSType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfAuthKey=ospfIfAuthKey, ospf=ospf, ospfNbrIpAddr=ospfNbrIpAddr, ospfLsdbTable=ospfLsdbTable, ospfIfAreaId=ospfIfAreaId, ospfNbrTable=ospfNbrTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAuthType=ospfAuthType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfHostGroup2=ospfHostGroup2, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaEntry=ospfAreaEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfCompliances=ospfCompliances, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaId=ospfAreaId, ospfStubMetric=ospfStubMetric, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfGroups=ospfGroups, ospfIfEvents=ospfIfEvents, ospfAreaRangeGroup=ospfAreaRangeGroup, Status=Status, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfGroup=ospfIfGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbGroup=ospfLsdbGroup, ospfIfMetricTable=ospfIfMetricTable, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfDemand=ospfIfDemand, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrEntry=ospfNbrEntry, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfGroup2=ospfIfGroup2, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfRestartSupport=ospfRestartSupport, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsLsdbType=ospfAsLsdbType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAsLsdbAge=ospfAsLsdbAge, ospfTOSSupport=ospfTOSSupport, ospfStubMetricType=ospfStubMetricType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, PYSNMP_MODULE_ID=ospf, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfHostEntry=ospfHostEntry, ospfIfAuthType=ospfIfAuthType, ospfNbrGroup2=ospfNbrGroup2, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMetricValue=ospfIfMetricValue, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLocalLsdbSequence=ospfLocalLsdbSequence, HelloRange=HelloRange, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsaCount=ospfAsLsaCount, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfBasicGroup2=ospfBasicGroup2, ospfNbrPriority=ospfNbrPriority, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfEntry=ospfIfEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLsdbAge=ospfLsdbAge, ospfInterArea=ospfInterArea, ospfDemandExtensions=ospfDemandExtensions, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfTable=ospfIfTable, ospfIfLsaCount=ospfIfLsaCount, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfRxNewLsas=ospfRxNewLsas, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfTable=ospfVirtIfTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfState=ospfIfState, ospfLsdbRouterId=ospfLsdbRouterId, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaRangeNet=ospfAreaRangeNet, AreaID=AreaID, ospfLsdbAreaId=ospfLsdbAreaId, ospfRestartExitReason=ospfRestartExitReason, ospfOriginateNewLsas=ospfOriginateNewLsas, RouterID=RouterID, ospfObsoleteGroup=ospfObsoleteGroup, UpToMaxAge=UpToMaxAge, ospfHostTOS=ospfHostTOS, ospfExtLsdbType=ospfExtLsdbType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrOptions=ospfNbrOptions, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAdminStat=ospfAdminStat, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaTable=ospfAreaTable, ospfIfType=ospfIfType, ospfIfStatus=ospfIfStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbLsid=ospfLsdbLsid, ospfAddressLessIf=ospfAddressLessIf, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfHostIpAddress=ospfHostIpAddress, ospfExternLsaCount=ospfExternLsaCount, ospfSpfRuns=ospfSpfRuns, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfState=ospfVirtIfState, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrEvents=ospfNbrEvents, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostGroup=ospfHostGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaGroup2=ospfAreaGroup2, ospfAreaStatus=ospfAreaStatus, ospfConformance=ospfConformance, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfRestartAge=ospfRestartAge, ospfHostStatus=ospfHostStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfRestartStatus=ospfRestartStatus, OspfAuthenticationType=OspfAuthenticationType, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, PositiveInteger=PositiveInteger, ospfRouteGroup=ospfRouteGroup, ospfImportAsExtern=ospfImportAsExtern, ospfCompliance2=ospfCompliance2, ospfComplianceObsolete=ospfComplianceObsolete, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubAreaTable=ospfStubAreaTable, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfCompliance=ospfCompliance, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfPollInterval=ospfIfPollInterval, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrArea=ospfVirtNbrArea, ospfRestartInterval=ospfRestartInterval, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfStubStatus=ospfStubStatus, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfHostAreaID=ospfHostAreaID, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrState=ospfVirtNbrState, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLsdbSequence=ospfLsdbSequence, ospfAreaSummary=ospfAreaSummary, ospfRouterId=ospfRouterId, ospfVirtIfGroup=ospfVirtIfGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfBasicGroup=ospfBasicGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostMetric=ospfHostMetric, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVersionNumber=ospfVersionNumber, ospfLsdbType=ospfLsdbType, ospfIntraArea=ospfIntraArea, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExternalType2=ospfExternalType2, ospfHostTable=ospfHostTable, ospfStubTOS=ospfStubTOS, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaRangeTable=ospfAreaRangeTable, ospfExternalType1=ospfExternalType1, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbChecksum=ospfLsdbChecksum, ospfReferenceBandwidth=ospfReferenceBandwidth, BigMetric=BigMetric, ospfLsdbEntry=ospfLsdbEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrState=ospfNbrState, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfStubAreaEntry=ospfStubAreaEntry, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrGroup=ospfNbrGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaGroup=ospfAreaGroup, Metric=Metric)
