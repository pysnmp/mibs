...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrEvents=ospfNbrEvents, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfAuthType=ospfIfAuthType, ospfIfState=ospfIfState, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfConformance=ospfConformance, ospfNbrState=ospfNbrState, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaSummary=ospfAreaSummary, ospfHostTable=ospfHostTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfGroup2=ospfIfGroup2, ospfRestartAge=ospfRestartAge, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLsdbChecksum=ospfLsdbChecksum, ospfExtLsdbType=ospfExtLsdbType, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfTable=ospfVirtIfTable, ospfNbrTable=ospfNbrTable, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubTOS=ospfStubTOS, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfStatus=ospfVirtIfStatus, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfBasicGroup=ospfBasicGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, PYSNMP_MODULE_ID=ospf, ospfAreaGroup2=ospfAreaGroup2, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, PositiveInteger=PositiveInteger, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbEntry=ospfLsdbEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaRangeMask=ospfAreaRangeMask, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, Status=Status, ospfExternalType1=ospfExternalType1, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfCompliance=ospfCompliance, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfState=ospfVirtIfState, ospfGeneralGroup=ospfGeneralGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrRtrId=ospfNbrRtrId, ospfAreaRangeNet=ospfAreaRangeNet, ospfIntraArea=ospfIntraArea, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfHostGroup2=ospfHostGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostAreaID=ospfHostAreaID, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfNbrOptions=ospfNbrOptions, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaLsaCount=ospfAreaLsaCount, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubAreaTable=ospfStubAreaTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfRxNewLsas=ospfRxNewLsas, ospfIfGroup=ospfIfGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricStatus=ospfIfMetricStatus, ospfTOSSupport=ospfTOSSupport, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostGroup=ospfHostGroup, ospfIfDemand=ospfIfDemand, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, AreaID=AreaID, ospfLocalLsdbTable=ospfLocalLsdbTable, BigMetric=BigMetric, ospfRouterId=ospfRouterId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaGroup=ospfAreaGroup, ospfRestartSupport=ospfRestartSupport, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfEntry=ospfIfEntry, ospfVirtNbrState=ospfVirtNbrState, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostMetric=ospfHostMetric, ospfGroups=ospfGroups, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbAge=ospfLsdbAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfImportAsExtern=ospfImportAsExtern, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfHostEntry=ospfHostEntry, ospfAreaId=ospfAreaId, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfAreaId=ospfIfAreaId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, HelloRange=HelloRange, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRouteGroup=ospfRouteGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfBasicGroup2=ospfBasicGroup2, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfEvents=ospfIfEvents, ospfIfAdminStat=ospfIfAdminStat, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfEvents=ospfVirtIfEvents, ospf=ospf, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, UpToMaxAge=UpToMaxAge, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAdminStat=ospfAdminStat, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfRestartInterval=ospfRestartInterval, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaStatus=ospfAreaStatus, ospfVersionNumber=ospfVersionNumber, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAsLsaCount=ospfAsLsaCount, ospfCompliance2=ospfCompliance2, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrIpAddr=ospfNbrIpAddr, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExternalType2=ospfExternalType2, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfHostStatus=ospfHostStatus, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfHostIpAddress=ospfHostIpAddress, RouterID=RouterID, ospfStubMetric=ospfStubMetric, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfStatus=ospfIfStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfPollInterval=ospfIfPollInterval, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfHostTOS=ospfHostTOS, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfStubMetricType=ospfStubMetricType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAuthType=ospfAuthType, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfMetricTable=ospfIfMetricTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLsdbLsid=ospfLsdbLsid, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaEntry=ospfAreaEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbType=ospfLsdbType, ospfCompliances=ospfCompliances, ospfExtLsdbGroup=ospfExtLsdbGroup, TOSType=TOSType, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfObsoleteGroup=ospfObsoleteGroup, ospfAddressLessIf=ospfAddressLessIf, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfType=ospfIfType, ospfIfTable=ospfIfTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, Metric=Metric, ospfStubStatus=ospfStubStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaTable=ospfAreaTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLsdbGroup=ospfLsdbGroup, ospfNbrGroup=ospfNbrGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfInterArea=ospfInterArea)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubAreaId=ospfStubAreaId, ospfExternLsaCount=ospfExternLsaCount, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter)
