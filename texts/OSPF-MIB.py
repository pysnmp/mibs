...
mibBuilder.exportSymbols("OSPF-MIB", ospfRxNewLsas=ospfRxNewLsas, ospfHostMetric=ospfHostMetric, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaStatus=ospfAreaStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, Status=Status, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaTable=ospfAreaTable, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfRestartInterval=ospfRestartInterval, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfType=ospfIfType, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostTOS=ospfHostTOS, BigMetric=BigMetric, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLsdbType=ospfLsdbType, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfEntry=ospfIfEntry, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfStubMetricType=ospfStubMetricType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfState=ospfVirtIfState, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfHostIpAddress=ospfHostIpAddress, ospfCompliances=ospfCompliances, ospfVirtIfEntry=ospfVirtIfEntry, HelloRange=HelloRange, ospfExtLsdbTable=ospfExtLsdbTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfHostEntry=ospfHostEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfCompliance2=ospfCompliance2, ospfIfAuthType=ospfIfAuthType, RouterID=RouterID, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfStatus=ospfIfStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExtLsdbAge=ospfExtLsdbAge, ospfStubAreaTable=ospfStubAreaTable, ospfIfGroup=ospfIfGroup, ospfIntraArea=ospfIntraArea, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrGroup=ospfNbrGroup, ospfIfTable=ospfIfTable, ospfAreaGroup=ospfAreaGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfTable=ospfVirtIfTable, ospfNbrState=ospfNbrState, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbAge=ospfLsdbAge, ospfExternLsaCount=ospfExternLsaCount, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfExtLsdbType=ospfExtLsdbType, ospfAsLsdbAge=ospfAsLsdbAge, ospfConformance=ospfConformance, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfDemandExtensions=ospfDemandExtensions, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfGroup2=ospfIfGroup2, ospfRouteGroup=ospfRouteGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfNbrIpAddr=ospfNbrIpAddr, ospfSpfRuns=ospfSpfRuns, ospfExternalType1=ospfExternalType1, ospfStubMetric=ospfStubMetric, ospf=ospf, ospfRouterId=ospfRouterId, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfState=ospfIfState, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfHostStatus=ospfHostStatus, ospfNbrOptions=ospfNbrOptions, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaGroup2=ospfAreaGroup2, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, OspfAuthenticationType=OspfAuthenticationType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfAdminStat=ospfIfAdminStat, ospfStubTOS=ospfStubTOS, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfLsaCount=ospfIfLsaCount, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAdminStat=ospfAdminStat, ospfAreaSummary=ospfAreaSummary, ospfInterArea=ospfInterArea, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfCompliance=ospfCompliance, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, TOSType=TOSType, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfPollInterval=ospfIfPollInterval, UpToMaxAge=UpToMaxAge, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfNbrPriority=ospfNbrPriority, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfObsoleteGroup=ospfObsoleteGroup, ospfAuthType=ospfAuthType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfStubAreaId=ospfStubAreaId, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfStubStatus=ospfStubStatus, ospfRestartAge=ospfRestartAge, ospfAreaId=ospfAreaId, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfGroups=ospfGroups, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVersionNumber=ospfVersionNumber, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfHostGroup2=ospfHostGroup2, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfAreaId=ospfIfAreaId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfBasicGroup2=ospfBasicGroup2, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfDemand=ospfIfDemand, ospfIfMetricValue=ospfIfMetricValue, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfEvents=ospfIfEvents, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaRangeTable=ospfAreaRangeTable, ospfBasicGroup=ospfBasicGroup, ospfHostGroup=ospfHostGroup, PositiveInteger=PositiveInteger, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfRestartSupport=ospfRestartSupport, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfAuthKey=ospfIfAuthKey, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrEntry=ospfNbrEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricTOS=ospfIfMetricTOS, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfLsdbLsid=ospfLsdbLsid, ospfLsdbChecksum=ospfLsdbChecksum, ospfExternalType2=ospfExternalType2, AreaID=AreaID, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfIpAddress=ospfIfIpAddress, ospfAreaEntry=ospfAreaEntry, ospfGeneralGroup=ospfGeneralGroup, Metric=Metric, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, PYSNMP_MODULE_ID=ospf, ospfRestartStatus=ospfRestartStatus, ospfImportAsExtern=ospfImportAsExtern, ospfNbrTable=ospfNbrTable, ospfTOSSupport=ospfTOSSupport, ospfAsLsaCount=ospfAsLsaCount, ospfAddressLessIf=ospfAddressLessIf, ospfHostTable=ospfHostTable)
mibBuilder.exportSymbols("OSPF-MIB", ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry)
