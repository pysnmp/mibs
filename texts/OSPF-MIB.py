...
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfAreaId=ospfIfAreaId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, Status=Status, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfMetricTOS=ospfIfMetricTOS, ospfLsdbAreaId=ospfLsdbAreaId, ospfAsLsdbType=ospfAsLsdbType, ospfBasicGroup=ospfBasicGroup, ospfNbrPriority=ospfNbrPriority, ospfHostIpAddress=ospfHostIpAddress, ospfIfGroup2=ospfIfGroup2, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubMetric=ospfStubMetric, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrGroup2=ospfNbrGroup2, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLsdbRouterId=ospfLsdbRouterId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaLsaCountTable=ospfAreaLsaCountTable, Metric=Metric, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAuthType=ospfAuthType, ospfRouteGroup=ospfRouteGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostAreaID=ospfHostAreaID, ospfTOSSupport=ospfTOSSupport, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfEvents=ospfIfEvents, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfBasicGroup2=ospfBasicGroup2, ospfAreaGroup2=ospfAreaGroup2, ospfStubAreaGroup=ospfStubAreaGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfTable=ospfIfTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfHostMetric=ospfHostMetric, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfCompliances=ospfCompliances, ospfStubAreaId=ospfStubAreaId, ospfRestartExitReason=ospfRestartExitReason, ospfExternLsaCount=ospfExternLsaCount, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfCompliance2=ospfCompliance2, OspfAuthenticationType=OspfAuthenticationType, ospfGeneralGroup=ospfGeneralGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfStatus=ospfIfStatus, ospfRestartInterval=ospfRestartInterval, ospfStubMetricType=ospfStubMetricType, BigMetric=BigMetric, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaStatus=ospfAreaStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfRestartAge=ospfRestartAge, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbLsid=ospfLsdbLsid, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfHelloInterval=ospfIfHelloInterval, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfInterArea=ospfInterArea, ospfExternalType1=ospfExternalType1, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfRxNewLsas=ospfRxNewLsas, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExternalType2=ospfExternalType2, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfSpfRuns=ospfSpfRuns, ospfGroups=ospfGroups, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExtLsdbType=ospfExtLsdbType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfAuthType=ospfIfAuthType, RouterID=RouterID, ospfVersionNumber=ospfVersionNumber, ospfAsLsaCount=ospfAsLsaCount, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfObsoleteGroup=ospfObsoleteGroup, PYSNMP_MODULE_ID=ospf, ospfAreaSummary=ospfAreaSummary, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrTable=ospfNbrTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfEntry=ospfIfEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrOptions=ospfNbrOptions, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaId=ospfAreaId, ospfIfMetricValue=ospfIfMetricValue, ospfIfAuthKey=ospfIfAuthKey, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrEntry=ospfNbrEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLsdbAge=ospfLsdbAge, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfLsaCount=ospfIfLsaCount, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfTable=ospfVirtIfTable, ospfCompliance=ospfCompliance, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfIpAddress=ospfIfIpAddress, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfType=ospfIfType, ospfHostTOS=ospfHostTOS, ospfVirtIfStatus=ospfVirtIfStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtIfLsaCount=ospfVirtIfLsaCount, HelloRange=HelloRange, ospfNbrEvents=ospfNbrEvents, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLsdbGroup=ospfLsdbGroup, ospfAreaTable=ospfAreaTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaGroup=ospfAreaGroup, ospfNbrGroup=ospfNbrGroup, ospfHostGroup2=ospfHostGroup2, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfStubStatus=ospfStubStatus, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfRestartSupport=ospfRestartSupport, AreaID=AreaID, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, UpToMaxAge=UpToMaxAge, ospfLsdbType=ospfLsdbType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfConformance=ospfConformance, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfGroup2=ospfVirtIfGroup2, PositiveInteger=PositiveInteger, TOSType=TOSType, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfPollInterval=ospfIfPollInterval, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrState=ospfVirtNbrState, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfImportAsExtern=ospfImportAsExtern, ospfNbrState=ospfNbrState, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfGroup=ospfIfGroup, ospfIfState=ospfIfState, ospfHostStatus=ospfHostStatus, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubRouterSupport=ospfStubRouterSupport, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAsLsdbTable=ospfAsLsdbTable, ospf=ospf, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfMulticastExtensions=ospfMulticastExtensions, ospfLsdbTable=ospfLsdbTable, ospfAdminStat=ospfAdminStat, ospfHostTable=ospfHostTable, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbEntry=ospfLsdbEntry, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfDemand=ospfIfDemand, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfHostGroup=ospfHostGroup, ospfStubTOS=ospfStubTOS, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIntraArea=ospfIntraArea)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMetricTable=ospfIfMetricTable, ospfRouterId=ospfRouterId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfRestartStatus=ospfRestartStatus)
