...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfState=ospfVirtIfState, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfNbrRtrId=ospfNbrRtrId, ospfIfRetransInterval=ospfIfRetransInterval, Metric=Metric, ospfAsLsaCount=ospfAsLsaCount, HelloRange=HelloRange, PositiveInteger=PositiveInteger, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfAdminStat=ospfIfAdminStat, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrState=ospfVirtNbrState, ospfNbrEvents=ospfNbrEvents, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfStatus=ospfIfStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfAreaId=ospfIfAreaId, ospfNbrGroup=ospfNbrGroup, ospfRestartInterval=ospfRestartInterval, ospfAdminStat=ospfAdminStat, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfStubAreaEntry=ospfStubAreaEntry, BigMetric=BigMetric, ospfVirtNbrArea=ospfVirtNbrArea, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfHostGroup=ospfHostGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfBasicGroup2=ospfBasicGroup2, ospfNbrGroup2=ospfNbrGroup2, ospfRxNewLsas=ospfRxNewLsas, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLsdbAreaId=ospfLsdbAreaId, ospfGeneralGroup=ospfGeneralGroup, ospfAddressLessIf=ospfAddressLessIf, ospfTOSSupport=ospfTOSSupport, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfDemandExtensions=ospfDemandExtensions, ospfIfTable=ospfIfTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfCompliances=ospfCompliances, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExternalType2=ospfExternalType2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrTable=ospfNbrTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaEntry=ospfAreaEntry, ospfLsdbType=ospfLsdbType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfExtLsdbType=ospfExtLsdbType, ospfVersionNumber=ospfVersionNumber, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfLsaCount=ospfIfLsaCount, ospfExtLsdbLsid=ospfExtLsdbLsid, OspfAuthenticationType=OspfAuthenticationType, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfHostTOS=ospfHostTOS, ospfAsBdrRtrCount=ospfAsBdrRtrCount, PYSNMP_MODULE_ID=ospf, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfRouterId=ospfRouterId, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfHostAreaID=ospfHostAreaID, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLsdbSequence=ospfLsdbSequence, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfStatus=ospfVirtIfStatus, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaGroup=ospfAreaGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLsdbLsid=ospfLsdbLsid, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfStubStatus=ospfStubStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfIpAddress=ospfIfIpAddress, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostStatus=ospfHostStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIntraArea=ospfIntraArea, AreaID=AreaID, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMetricTable=ospfIfMetricTable, ospfHostMetric=ospfHostMetric, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaId=ospfAreaId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfRouteGroup=ospfRouteGroup, ospfLsdbGroup=ospfLsdbGroup, ospfRestartExitReason=ospfRestartExitReason, ospfSpfRuns=ospfSpfRuns, ospfLsdbAge=ospfLsdbAge, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubMetric=ospfStubMetric, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfCompliance2=ospfCompliance2, ospfIfAuthKey=ospfIfAuthKey, ospfNbrState=ospfNbrState, ospfStubAreaGroup=ospfStubAreaGroup, UpToMaxAge=UpToMaxAge, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostGroup2=ospfHostGroup2, ospfStubTOS=ospfStubTOS, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, Status=Status, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfStubAreaTable=ospfStubAreaTable, ospfIfMetricValue=ospfIfMetricValue, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfEntry=ospfIfEntry, ospfStubAreaId=ospfStubAreaId, ospfAuthType=ospfAuthType, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfType=ospfIfType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaSummary=ospfAreaSummary, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, RouterID=RouterID, ospfRestartAge=ospfRestartAge, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfTable=ospfVirtIfTable, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospf=ospf, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfConformance=ospfConformance, ospfCompliance=ospfCompliance, ospfRestartStatus=ospfRestartStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfGroup2=ospfIfGroup2, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbType=ospfLocalLsdbType, ospfBasicGroup=ospfBasicGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfHostTable=ospfHostTable, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLsdbEntry=ospfLsdbEntry, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfGroup=ospfIfGroup, ospfAreaTable=ospfAreaTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaGroup2=ospfAreaGroup2, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaStatus=ospfAreaStatus, ospfStubMetricType=ospfStubMetricType, ospfHostIpAddress=ospfHostIpAddress, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfInterArea=ospfInterArea, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfDemand=ospfIfDemand, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfExternLsaCount=ospfExternLsaCount, ospfGroups=ospfGroups, ospfRestartSupport=ospfRestartSupport, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfState=ospfIfState, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrOptions=ospfNbrOptions, TOSType=TOSType, ospfImportAsExtern=ospfImportAsExtern)
