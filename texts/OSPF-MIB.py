...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubStatus=ospfStubStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfMetricTOS=ospfIfMetricTOS, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfGroup2=ospfIfGroup2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfStatus=ospfIfStatus, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbType=ospfLsdbType, ospfAsLsdbType=ospfAsLsdbType, ospfHostTable=ospfHostTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfGeneralGroup=ospfGeneralGroup, ospfIfMetricTable=ospfIfMetricTable, ospfCompliance=ospfCompliance, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfRetransInterval=ospfIfRetransInterval, PYSNMP_MODULE_ID=ospf, ospfNbrTable=ospfNbrTable, ospfAreaId=ospfAreaId, ospfIfState=ospfIfState, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfPollInterval=ospfIfPollInterval, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfCompliances=ospfCompliances, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfAreaId=ospfIfAreaId, ospfInterArea=ospfInterArea, ospfHostGroup2=ospfHostGroup2, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfStubMetric=ospfStubMetric, ospfLsdbChecksum=ospfLsdbChecksum, ospfStubMetricType=ospfStubMetricType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfTable=ospfVirtIfTable, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfBasicGroup=ospfBasicGroup, ospfLsdbGroup=ospfLsdbGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostTOS=ospfHostTOS, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfImportAsExtern=ospfImportAsExtern, RouterID=RouterID, ospfNbrIpAddr=ospfNbrIpAddr, AreaID=AreaID, ospfLsdbRouterId=ospfLsdbRouterId, ospfRouterId=ospfRouterId, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfRestartSupport=ospfRestartSupport, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrOptions=ospfNbrOptions, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsdbAge=ospfAsLsdbAge, Metric=Metric, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfHostGroup=ospfHostGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfMetricEntry=ospfIfMetricEntry, PositiveInteger=PositiveInteger, ospfRestartAge=ospfRestartAge, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfAdminStat=ospfIfAdminStat, ospfRxNewLsas=ospfRxNewLsas, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAdminStat=ospfAdminStat, ospfLsdbAge=ospfLsdbAge, Status=Status, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfRestartInterval=ospfRestartInterval, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaStatus=ospfAreaStatus, ospfNbrEvents=ospfNbrEvents, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrGroup=ospfNbrGroup, ospfRestartStatus=ospfRestartStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaTable=ospfAreaTable, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfMetricValue=ospfIfMetricValue, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfEvents=ospfIfEvents, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfState=ospfVirtIfState, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfEntry=ospfIfEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfAuthType=ospfIfAuthType, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfHostMetric=ospfHostMetric, ospfCompliance2=ospfCompliance2, ospfGroups=ospfGroups, UpToMaxAge=UpToMaxAge, ospfAreaSummary=ospfAreaSummary, ospfHostEntry=ospfHostEntry, ospfStubTOS=ospfStubTOS, ospfIfType=ospfIfType, OspfAuthenticationType=OspfAuthenticationType, ospfIfGroup=ospfIfGroup, ospf=ospf, ospfTOSSupport=ospfTOSSupport, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaGroup=ospfAreaGroup, TOSType=TOSType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, HelloRange=HelloRange, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLsdbTable=ospfLsdbTable, ospfIfLsaCount=ospfIfLsaCount, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfTable=ospfIfTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIntraArea=ospfIntraArea, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaLsaCount=ospfAreaLsaCount, ospfAddressLessIf=ospfAddressLessIf, ospfAreaGroup2=ospfAreaGroup2, ospfHostStatus=ospfHostStatus, ospfNbrState=ospfNbrState, ospfHostIpAddress=ospfHostIpAddress, ospfAreaEntry=ospfAreaEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbAge=ospfExtLsdbAge, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfBasicGroup2=ospfBasicGroup2, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbType=ospfExtLsdbType, ospfAuthType=ospfAuthType, ospfIfDemand=ospfIfDemand, ospfSpfRuns=ospfSpfRuns, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVersionNumber=ospfVersionNumber, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfAuthKey=ospfIfAuthKey, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsaCount=ospfAsLsaCount, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, BigMetric=BigMetric, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaRangeNet=ospfAreaRangeNet, ospfExternalType2=ospfExternalType2, ospfConformance=ospfConformance, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfIpAddress=ospfIfIpAddress, ospfMulticastExtensions=ospfMulticastExtensions, ospfLocalLsdbType=ospfLocalLsdbType)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbLsid=ospfLsdbLsid, ospfAreaRangeStatus=ospfAreaRangeStatus)
