...
mibBuilder.exportSymbols("OSPF-MIB", ospfHostIpAddress=ospfHostIpAddress, ospfNbrEvents=ospfNbrEvents, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfMetricTable=ospfIfMetricTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfTransitDelay=ospfIfTransitDelay, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaEntry=ospfAreaEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospf=ospf, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaId=ospfAreaId, TOSType=TOSType, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrTable=ospfNbrTable, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfAreaId=ospfVirtIfAreaId, PositiveInteger=PositiveInteger, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtNbrState=ospfVirtNbrState, ospfExternalType2=ospfExternalType2, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfHelloInterval=ospfIfHelloInterval, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeEffect=ospfAreaRangeEffect, RouterID=RouterID, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbType=ospfAsLsdbType, ospfStubMetric=ospfStubMetric, ospfLsdbTable=ospfLsdbTable, ospfIfDemand=ospfIfDemand, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAddressLessIf=ospfAddressLessIf, ospfNbrPriority=ospfNbrPriority, ospfHostGroup=ospfHostGroup, ospfIfAuthType=ospfIfAuthType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaRangeNet=ospfAreaRangeNet, Metric=Metric, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRestartSupport=ospfRestartSupport, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfEntry=ospfIfEntry, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfIpAddress=ospfIfIpAddress, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfConformance=ospfConformance, ospfBasicGroup=ospfBasicGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExternLsaCount=ospfExternLsaCount, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfRouteGroup=ospfRouteGroup, UpToMaxAge=UpToMaxAge, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAuthType=ospfAuthType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLsdbEntry=ospfLsdbEntry, BigMetric=BigMetric, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfStubAreaTable=ospfStubAreaTable, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbLsid=ospfLsdbLsid, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostTOS=ospfHostTOS, ospfExtLsdbType=ospfExtLsdbType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAdminStat=ospfAdminStat, ospfDemandExtensions=ospfDemandExtensions, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfMetricValue=ospfIfMetricValue, ospfAreaSummary=ospfAreaSummary, ospfRestartInterval=ospfRestartInterval, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfCompliance=ospfCompliance, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfInterArea=ospfInterArea, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfRxNewLsas=ospfRxNewLsas, ospfExitOverflowInterval=ospfExitOverflowInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfLsdbAge=ospfLsdbAge, ospfIfAdminStat=ospfIfAdminStat, ospfIfEvents=ospfIfEvents, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfHostTable=ospfHostTable, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfStubTOS=ospfStubTOS, ospfLsdbChecksum=ospfLsdbChecksum, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLsdbSequence=ospfLsdbSequence, ospfIntraArea=ospfIntraArea, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfCompliance2=ospfCompliance2, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfObsoleteGroup=ospfObsoleteGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfCompliances=ospfCompliances, HelloRange=HelloRange, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfHostMetric=ospfHostMetric, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostEntry=ospfHostEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfAreaId=ospfIfAreaId, ospfIfStatus=ospfIfStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfTable=ospfIfTable, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfMulticastExtensions=ospfMulticastExtensions, ospfNbrRtrId=ospfNbrRtrId, ospfAsLsaCount=ospfAsLsaCount, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrOptions=ospfNbrOptions, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfMetricTOS=ospfIfMetricTOS, AreaID=AreaID, ospfAreaTable=ospfAreaTable, ospfGroups=ospfGroups, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfType=ospfIfType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaGroup=ospfAreaGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfAuthKey=ospfIfAuthKey, ospfIfGroup=ospfIfGroup, Status=Status, ospfRestartExitReason=ospfRestartExitReason, ospfStubRouterSupport=ospfStubRouterSupport, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbGroup=ospfLsdbGroup, ospfIfState=ospfIfState, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfRestartAge=ospfRestartAge, ospfExtLsdbTable=ospfExtLsdbTable, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfGroup2=ospfIfGroup2, ospfAreaGroup2=ospfAreaGroup2, OspfAuthenticationType=OspfAuthenticationType, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExternalType1=ospfExternalType1, ospfAreaStatus=ospfAreaStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfStubMetricType=ospfStubMetricType, PYSNMP_MODULE_ID=ospf, ospfStubStatus=ospfStubStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfPollInterval=ospfIfPollInterval, ospfHostAreaID=ospfHostAreaID, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrState=ospfNbrState, ospfHostStatus=ospfHostStatus, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostGroup2=ospfHostGroup2, ospfSpfRuns=ospfSpfRuns, ospfRouterId=ospfRouterId)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbType=ospfLsdbType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfState=ospfVirtIfState)
