...
mibBuilder.exportSymbols("OSPF-MIB", ospfIntraArea=ospfIntraArea, ospfIfAdminStat=ospfIfAdminStat, ospfLsdbAge=ospfLsdbAge, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfRestartStatus=ospfRestartStatus, ospfNbrTable=ospfNbrTable, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAuthType=ospfAuthType, ospfNbrIpAddr=ospfNbrIpAddr, ospfLsdbEntry=ospfLsdbEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLsdbSequence=ospfLsdbSequence, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfAreaId=ospfIfAreaId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLocalLsdbTable=ospfLocalLsdbTable, Metric=Metric, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfExternalType1=ospfExternalType1, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfStubAreaGroup=ospfStubAreaGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfCompliance=ospfCompliance, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfGroup2=ospfIfGroup2, ospfIfEntry=ospfIfEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfTOSSupport=ospfTOSSupport, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVersionNumber=ospfVersionNumber, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfStubTOS=ospfStubTOS, ospfLsdbChecksum=ospfLsdbChecksum, ospfConformance=ospfConformance, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfStubMetricType=ospfStubMetricType, ospfHostEntry=ospfHostEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfComplianceObsolete=ospfComplianceObsolete, ospfGeneralGroup=ospfGeneralGroup, AreaID=AreaID, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaEntry=ospfAreaEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAddressLessIf=ospfAddressLessIf, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfStubAreaTable=ospfStubAreaTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, OspfAuthenticationType=OspfAuthenticationType, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsdbTable=ospfAsLsdbTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfRestartAge=ospfRestartAge, ospfNbrEntry=ospfNbrEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfStatus=ospfIfStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfNbrEvents=ospfNbrEvents, ospfIfMetricTOS=ospfIfMetricTOS, UpToMaxAge=UpToMaxAge, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrRtrId=ospfNbrRtrId, ospfIfEvents=ospfIfEvents, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfHostTable=ospfHostTable, ospfIfMetricValue=ospfIfMetricValue, ospfIfGroup=ospfIfGroup, ospfVirtIfState=ospfVirtIfState, ospfAdminStat=ospfAdminStat, ospfVirtNbrArea=ospfVirtNbrArea, TOSType=TOSType, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfTable=ospfVirtIfTable, ospfRestartInterval=ospfRestartInterval, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostTOS=ospfHostTOS, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfNbrState=ospfNbrState, ospfAreaLsaCount=ospfAreaLsaCount, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfStubAreaId=ospfStubAreaId, PositiveInteger=PositiveInteger, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfStubStatus=ospfStubStatus, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfPollInterval=ospfIfPollInterval, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfState=ospfIfState, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaRangeEffect=ospfAreaRangeEffect, BigMetric=BigMetric, ospfNbrGroup2=ospfNbrGroup2, ospfAreaGroup=ospfAreaGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfExternalType2=ospfExternalType2, ospfAreaStatus=ospfAreaStatus, Status=Status, ospfIfLsaCount=ospfIfLsaCount, ospfIfMetricEntry=ospfIfMetricEntry, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfRouteGroup=ospfRouteGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostGroup2=ospfHostGroup2, ospfAreaTable=ospfAreaTable, ospfIfTable=ospfIfTable, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfType=ospfIfType, ospfHostMetric=ospfHostMetric, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfHostStatus=ospfHostStatus, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLsdbGroup=ospfLsdbGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfLsdbType=ospfLsdbType, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaGroup2=ospfAreaGroup2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospf=ospf, ospfIfTransitDelay=ospfIfTransitDelay, RouterID=RouterID, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfCompliances=ospfCompliances, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfImportAsExtern=ospfImportAsExtern, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfAuthType=ospfIfAuthType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfGroups=ospfGroups, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrPriority=ospfNbrPriority, ospfRxNewLsas=ospfRxNewLsas, ospfDemandExtensions=ospfDemandExtensions, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfStubMetric=ospfStubMetric, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfCompliance2=ospfCompliance2, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaSummary=ospfAreaSummary, ospfIfIpAddress=ospfIfIpAddress, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostGroup=ospfHostGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaRangeTable=ospfAreaRangeTable, ospfBasicGroup=ospfBasicGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfSpfRuns=ospfSpfRuns, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaId=ospfAreaId, PYSNMP_MODULE_ID=ospf, ospfStubRouterSupport=ospfStubRouterSupport, ospfInterArea=ospfInterArea, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExtLsdbGroup=ospfExtLsdbGroup, HelloRange=HelloRange, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfHostAreaID=ospfHostAreaID, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrGroup=ospfNbrGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfBasicGroup2=ospfBasicGroup2, ospfIfDemand=ospfIfDemand, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfRestartSupport=ospfRestartSupport)
mibBuilder.exportSymbols("OSPF-MIB", ospfExternLsaCount=ospfExternLsaCount, ospfExtLsdbAge=ospfExtLsdbAge, ospfHostIpAddress=ospfHostIpAddress, ospfVirtNbrState=ospfVirtNbrState)
