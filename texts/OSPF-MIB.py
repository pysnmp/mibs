...
mibBuilder.exportSymbols("OSPF-MIB", ospfExternLsaCount=ospfExternLsaCount, TOSType=TOSType, ospfRxNewLsas=ospfRxNewLsas, ospfStubAreaEntry=ospfStubAreaEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsaCount=ospfAsLsaCount, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIntraArea=ospfIntraArea, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfBasicGroup=ospfBasicGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfStubTOS=ospfStubTOS, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfTable=ospfIfTable, ospfRestartStatus=ospfRestartStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfStubAreaId=ospfStubAreaId, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbRouterId=ospfLsdbRouterId, ospfExternalType1=ospfExternalType1, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfTransitDelay=ospfIfTransitDelay, ospfHostTable=ospfHostTable, ospfGroups=ospfGroups, RouterID=RouterID, ospfExternalType2=ospfExternalType2, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaStatus=ospfAreaStatus, ospfIfType=ospfIfType, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfCompliances=ospfCompliances, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaSummary=ospfAreaSummary, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaGroup=ospfAreaGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfHostMetric=ospfHostMetric, ospfConformance=ospfConformance, ospf=ospf, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfHostIpAddress=ospfHostIpAddress, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, Status=Status, ospfNbrEntry=ospfNbrEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfImportAsExtern=ospfImportAsExtern, ospfTOSSupport=ospfTOSSupport, ospfLsdbType=ospfLsdbType, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, HelloRange=HelloRange, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbType=ospfLocalLsdbType, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfRestartAge=ospfRestartAge, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfState=ospfVirtIfState, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostGroup2=ospfHostGroup2, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaLsaCount=ospfAreaLsaCount, ospfRestartInterval=ospfRestartInterval, ospfAreaEntry=ospfAreaEntry, ospfNbrGroup2=ospfNbrGroup2, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfNbrOptions=ospfNbrOptions, ospfIfDemand=ospfIfDemand, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrState=ospfVirtNbrState, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfHostStatus=ospfHostStatus, ospfNbrState=ospfNbrState, ospfStubMetricType=ospfStubMetricType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrEvents=ospfNbrEvents, ospfIfMetricValue=ospfIfMetricValue, ospfRouteGroup=ospfRouteGroup, ospfLsdbTable=ospfLsdbTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, PYSNMP_MODULE_ID=ospf, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaTable=ospfAreaTable, ospfIfEvents=ospfIfEvents, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfCompliance=ospfCompliance, ospfIfAreaId=ospfIfAreaId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfDemandExtensions=ospfDemandExtensions, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVersionNumber=ospfVersionNumber, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfCompliance2=ospfCompliance2, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrTable=ospfNbrTable, Metric=Metric, BigMetric=BigMetric, ospfExtLsdbTable=ospfExtLsdbTable, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfGroup2=ospfIfGroup2, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAddressLessIf=ospfAddressLessIf, ospfIfIpAddress=ospfIfIpAddress, ospfAdminStat=ospfAdminStat, ospfSpfRuns=ospfSpfRuns, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfBasicGroup2=ospfBasicGroup2, ospfLsdbAge=ospfLsdbAge, ospfLsdbEntry=ospfLsdbEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfPollInterval=ospfIfPollInterval, ospfIfStatus=ospfIfStatus, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfStubStatus=ospfStubStatus, ospfIfState=ospfIfState, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfEntry=ospfIfEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfGroup=ospfIfGroup, ospfHostAreaID=ospfHostAreaID, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbChecksum=ospfLsdbChecksum, OspfAuthenticationType=OspfAuthenticationType, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfAdminStat=ospfIfAdminStat, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfHostGroup=ospfHostGroup, AreaID=AreaID, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAsLsdbTable=ospfAsLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfAuthType=ospfAuthType, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfStubAreaTable=ospfStubAreaTable, PositiveInteger=PositiveInteger, ospfHostTOS=ospfHostTOS, ospfRouterId=ospfRouterId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfMetricTable=ospfIfMetricTable, ospfInterArea=ospfInterArea, UpToMaxAge=UpToMaxAge, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfMulticastExtensions=ospfMulticastExtensions, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrGroup=ospfNbrGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaId=ospfAreaId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrRtrId=ospfNbrRtrId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostEntry=ospfHostEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfStubAreaGroup=ospfStubAreaGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubMetric=ospfStubMetric, ospfRestartSupport=ospfRestartSupport)
