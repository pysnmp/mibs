...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLsdbEntry=ospfLsdbEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbType=ospfLsdbType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaTable=ospfAreaTable, ospfRestartStatus=ospfRestartStatus, ospfExtLsdbTable=ospfExtLsdbTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExternalType1=ospfExternalType1, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfEntry=ospfIfEntry, ospfAdminStat=ospfAdminStat, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfHostEntry=ospfHostEntry, ospfIfPollInterval=ospfIfPollInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfMetricGroup=ospfIfMetricGroup, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, TOSType=TOSType, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrEvents=ospfNbrEvents, ospfNbrRtrId=ospfNbrRtrId, ospfLsdbTable=ospfLsdbTable, UpToMaxAge=UpToMaxAge, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfBasicGroup2=ospfBasicGroup2, ospfRestartAge=ospfRestartAge, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfAreaId=ospfIfAreaId, ospfDemandExtensions=ospfDemandExtensions, ospfExternLsaCount=ospfExternLsaCount, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRestartExitReason=ospfRestartExitReason, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfStubTOS=ospfStubTOS, ospfAreaSummary=ospfAreaSummary, ospfStubMetric=ospfStubMetric, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfGroup2=ospfIfGroup2, ospfHostTOS=ospfHostTOS, ospfIfState=ospfIfState, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfNbrEntry=ospfNbrEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfType=ospfIfType, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaId=ospfAreaId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLsdbAreaId=ospfLsdbAreaId, ospfAsLsaCount=ospfAsLsaCount, ospfCompliance=ospfCompliance, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaEntry=ospfAreaEntry, ospfAuthType=ospfAuthType, ospfStubAreaGroup=ospfStubAreaGroup, ospfBasicGroup=ospfBasicGroup, ospfTOSSupport=ospfTOSSupport, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfAdminStat=ospfIfAdminStat, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfCompliances=ospfCompliances, ospfAreaGroup=ospfAreaGroup, PYSNMP_MODULE_ID=ospf, ospfIfGroup=ospfIfGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfStatus=ospfIfStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfIpAddress=ospfIfIpAddress, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaStatus=ospfAreaStatus, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfAuthType=ospfIfAuthType, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfRxNewLsas=ospfRxNewLsas, ospfExternalType2=ospfExternalType2, ospfNbrGroup=ospfNbrGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfState=ospfVirtIfState, ospfIfDemand=ospfIfDemand, ospfHostStatus=ospfHostStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRestartInterval=ospfRestartInterval, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbType=ospfAsLsdbType, OspfAuthenticationType=OspfAuthenticationType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfGeneralGroup=ospfGeneralGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostGroup=ospfHostGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrTable=ospfNbrTable, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLocalLsdbType=ospfLocalLsdbType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeMask=ospfAreaRangeMask, ospfStubAreaTable=ospfStubAreaTable, ospfStubMetricType=ospfStubMetricType, ospfNbrState=ospfNbrState, ospfHostGroup2=ospfHostGroup2, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRouteGroup=ospfRouteGroup, ospfHostIpAddress=ospfHostIpAddress, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, PositiveInteger=PositiveInteger, ospfRouterId=ospfRouterId, ospfNbrOptions=ospfNbrOptions, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfLsaCount=ospfIfLsaCount, ospfVirtNbrArea=ospfVirtNbrArea, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, BigMetric=BigMetric, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrGroup2=ospfNbrGroup2, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostTable=ospfHostTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, AreaID=AreaID, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfImportAsExtern=ospfImportAsExtern, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAsLsdbTable=ospfAsLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIntraArea=ospfIntraArea, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfHostAreaID=ospfHostAreaID, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfConformance=ospfConformance, ospfAreaGroup2=ospfAreaGroup2, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospf=ospf, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfMetricEntry=ospfIfMetricEntry, Metric=Metric, ospfAddressLessIf=ospfAddressLessIf, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrEntry=ospfVirtNbrEntry, Status=Status, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfRestartSupport=ospfRestartSupport, ospfHostMetric=ospfHostMetric, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfStatus=ospfVirtIfStatus, HelloRange=HelloRange, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, RouterID=RouterID, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVersionNumber=ospfVersionNumber, ospfGroups=ospfGroups, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLsdbChecksum=ospfLsdbChecksum, ospfInterArea=ospfInterArea, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfStubStatus=ospfStubStatus, ospfCompliance2=ospfCompliance2, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLsdbLsid=ospfLsdbLsid, ospfIfTable=ospfIfTable, ospfVirtNbrState=ospfVirtNbrState, ospfIfTransitDelay=ospfIfTransitDelay)
mibBuilder.exportSymbols("OSPF-MIB", ospfObsoleteGroup=ospfObsoleteGroup, ospfIfEvents=ospfIfEvents, ospfLsdbAge=ospfLsdbAge, ospfVirtIfEntry=ospfVirtIfEntry)
