...
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbEntry=ospfLsdbEntry, UpToMaxAge=UpToMaxAge, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospf=ospf, ospfIfMetricGroup=ospfIfMetricGroup, ospfHostAreaID=ospfHostAreaID, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfDemand=ospfIfDemand, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfAuthKey=ospfIfAuthKey, ospfStubAreaEntry=ospfStubAreaEntry, BigMetric=BigMetric, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfAuthType=ospfIfAuthType, ospfVirtIfStatus=ospfVirtIfStatus, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfStatus=ospfIfStatus, ospfLsdbAge=ospfLsdbAge, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRestartAge=ospfRestartAge, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfStubTOS=ospfStubTOS, ospfIfMetricValue=ospfIfMetricValue, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfAdminStat=ospfIfAdminStat, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfState=ospfIfState, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfEntry=ospfIfEntry, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAddressLessIf=ospfAddressLessIf, ospfBasicGroup=ospfBasicGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbTable=ospfAsLsdbTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrState=ospfVirtNbrState, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaRangeTable=ospfAreaRangeTable, ospfAuthType=ospfAuthType, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLsdbType=ospfLsdbType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfRouterId=ospfRouterId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, TOSType=TOSType, ospfNbrRtrId=ospfNbrRtrId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubAreaTable=ospfStubAreaTable, ospfAsLsdbType=ospfAsLsdbType, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, Status=Status, ospfHostIpAddress=ospfHostIpAddress, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, HelloRange=HelloRange, ospfAreaTable=ospfAreaTable, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaStatus=ospfAreaStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfStubRouterSupport=ospfStubRouterSupport, ospfLsdbChecksum=ospfLsdbChecksum, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfLsaCount=ospfIfLsaCount, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfRestartExitReason=ospfRestartExitReason, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaGroup2=ospfAreaGroup2, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfInterArea=ospfInterArea, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostGroup=ospfHostGroup, ospfIntraArea=ospfIntraArea, ospfRestartSupport=ospfRestartSupport, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfAreaId=ospfIfAreaId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExternalType2=ospfExternalType2, ospfAdminStat=ospfAdminStat, ospfLocalLsdbType=ospfLocalLsdbType, ospfRestartInterval=ospfRestartInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfEvents=ospfIfEvents, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfRouteGroup=ospfRouteGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfHostTOS=ospfHostTOS, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsaCount=ospfAsLsaCount, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, AreaID=AreaID, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLsdbTable=ospfLsdbTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfGroup2=ospfIfGroup2, ospfExtLsdbAge=ospfExtLsdbAge, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfRestartStatus=ospfRestartStatus, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfHostMetric=ospfHostMetric, ospfNbrGroup2=ospfNbrGroup2, PositiveInteger=PositiveInteger, OspfAuthenticationType=OspfAuthenticationType, Metric=Metric, DesignatedRouterPriority=DesignatedRouterPriority, ospfVersionNumber=ospfVersionNumber, PYSNMP_MODULE_ID=ospf, ospfTOSSupport=ospfTOSSupport, ospfAreaEntry=ospfAreaEntry, ospfStubMetric=ospfStubMetric, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfCompliances=ospfCompliances, ospfNbrTable=ospfNbrTable, ospfNbrOptions=ospfNbrOptions, ospfCompliance=ospfCompliance, ospfCompliance2=ospfCompliance2, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfMetricTable=ospfIfMetricTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfSpfRuns=ospfSpfRuns, RouterID=RouterID, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfTable=ospfIfTable, ospfLsdbSequence=ospfLsdbSequence, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfGroups=ospfGroups, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfStubStatus=ospfStubStatus, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbType=ospfExtLsdbType, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfTable=ospfVirtIfTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrPriority=ospfNbrPriority, ospfGeneralGroup=ospfGeneralGroup, ospfHostEntry=ospfHostEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfType=ospfIfType, ospfStubMetricType=ospfStubMetricType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfStubAreaId=ospfStubAreaId, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaId=ospfAreaId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExternalType1=ospfExternalType1, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLsdbLsid=ospfLsdbLsid, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfState=ospfVirtIfState, ospfIfMetricEntry=ospfIfMetricEntry, ospfRxNewLsas=ospfRxNewLsas, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtIfEvents=ospfVirtIfEvents, ospfBasicGroup2=ospfBasicGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaSummary=ospfAreaSummary, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostGroup2=ospfHostGroup2, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfHostStatus=ospfHostStatus, ospfLsdbGroup=ospfLsdbGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfConformance=ospfConformance, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfTransitDelay=ospfIfTransitDelay)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrArea=ospfVirtNbrArea, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfHostTable=ospfHostTable)
