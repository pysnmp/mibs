...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaTable=ospfAreaTable, ospfLsdbRouterId=ospfLsdbRouterId, ospfSpfRuns=ospfSpfRuns, ospfLsdbGroup=ospfLsdbGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfHostGroup2=ospfHostGroup2, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfGroup=ospfIfGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfRxNewLsas=ospfRxNewLsas, BigMetric=BigMetric, ospfNbrGroup2=ospfNbrGroup2, RouterID=RouterID, HelloRange=HelloRange, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExternalType1=ospfExternalType1, ospfIfEntry=ospfIfEntry, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAuthType=ospfAuthType, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfAuthKey=ospfIfAuthKey, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRestartInterval=ospfRestartInterval, ospfVirtIfState=ospfVirtIfState, ospfNbrRtrId=ospfNbrRtrId, ospfIfAdminStat=ospfIfAdminStat, ospfStubAreaId=ospfStubAreaId, ospfStubAreaEntry=ospfStubAreaEntry, ospfStubTOS=ospfStubTOS, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaId=ospfAreaId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, AreaID=AreaID, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfGeneralGroup=ospfGeneralGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaGroup=ospfAreaGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfRouterId=ospfRouterId, ospfLsdbSequence=ospfLsdbSequence, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfAreaId=ospfIfAreaId, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfDemand=ospfIfDemand, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostGroup=ospfHostGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIntraArea=ospfIntraArea, ospfAddressLessIf=ospfAddressLessIf, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfRestartAge=ospfRestartAge, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfRestartSupport=ospfRestartSupport, ospfNbrEntry=ospfNbrEntry, ospfIfMetricTable=ospfIfMetricTable, ospfConformance=ospfConformance, ospfIfStatus=ospfIfStatus, ospfIfPollInterval=ospfIfPollInterval, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrState=ospfNbrState, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLsdbTable=ospfLsdbTable, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfOriginateNewLsas=ospfOriginateNewLsas, Status=Status, ospfRestartStatus=ospfRestartStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfRetransInterval=ospfIfRetransInterval, ospfExternalType2=ospfExternalType2, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, Metric=Metric, ospfAreaStatus=ospfAreaStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbType=ospfAsLsdbType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrOptions=ospfNbrOptions, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfState=ospfIfState, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaSummary=ospfAreaSummary, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostAreaID=ospfHostAreaID, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfAuthType=ospfIfAuthType, PositiveInteger=PositiveInteger, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbEntry=ospfLsdbEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfRouteGroup=ospfRouteGroup, ospfIfEvents=ospfIfEvents, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfRestartExitReason=ospfRestartExitReason, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, TOSType=TOSType, ospfStubAreaTable=ospfStubAreaTable, ospfNbrPriority=ospfNbrPriority, ospfIfType=ospfIfType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostIpAddress=ospfHostIpAddress, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaGroup2=ospfAreaGroup2, ospfIfGroup2=ospfIfGroup2, ospf=ospf, PYSNMP_MODULE_ID=ospf, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfTable=ospfIfTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfHostStatus=ospfHostStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfBasicGroup2=ospfBasicGroup2, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfMetricGroup=ospfIfMetricGroup, ospfHostEntry=ospfHostEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLsdbType=ospfLsdbType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfExternLsaCount=ospfExternLsaCount, ospfHostTable=ospfHostTable, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfIpAddress=ospfIfIpAddress, ospfLsdbLsid=ospfLsdbLsid, ospfStubMetric=ospfStubMetric, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrEvents=ospfNbrEvents, ospfAsLsaCount=ospfAsLsaCount, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrTable=ospfNbrTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfImportAsExtern=ospfImportAsExtern, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfLsaCount=ospfIfLsaCount, ospfAreaRangeStatus=ospfAreaRangeStatus, UpToMaxAge=UpToMaxAge, ospfTOSSupport=ospfTOSSupport, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfEvents=ospfVirtIfEvents, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrState=ospfVirtNbrState, ospfIfMetricStatus=ospfIfMetricStatus, ospfStubStatus=ospfStubStatus, ospfNbrGroup=ospfNbrGroup, ospfStubMetricType=ospfStubMetricType, ospfAdminStat=ospfAdminStat, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfCompliances=ospfCompliances, ospfCompliance=ospfCompliance, ospfHostTOS=ospfHostTOS, ospfBasicGroup=ospfBasicGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbChecksum=ospfAsLsdbChecksum, OspfAuthenticationType=OspfAuthenticationType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfHostMetric=ospfHostMetric, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfGroups=ospfGroups, ospfCompliance2=ospfCompliance2, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExtLsdbTable=ospfExtLsdbTable, ospfInterArea=ospfInterArea, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfDemandExtensions=ospfDemandExtensions, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbRouterId=ospfAsLsdbRouterId)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfMetricValue=ospfIfMetricValue, ospfNbmaNbrStatus=ospfNbmaNbrStatus)
