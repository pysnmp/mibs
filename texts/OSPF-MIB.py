...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfStubMetricType=ospfStubMetricType, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrState=ospfVirtNbrState, ospfAreaGroup2=ospfAreaGroup2, ospfStubAreaId=ospfStubAreaId, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRxNewLsas=ospfRxNewLsas, ospfStubAreaTable=ospfStubAreaTable, ospfIntraArea=ospfIntraArea, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfType=ospfIfType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospf=ospf, ospfAreaRangeMask=ospfAreaRangeMask, ospfRestartAge=ospfRestartAge, ospfAreaTable=ospfAreaTable, ospfNbrEvents=ospfNbrEvents, ospfHostTable=ospfHostTable, ospfNbrGroup2=ospfNbrGroup2, ospfHostGroup2=ospfHostGroup2, ospfRestartExitReason=ospfRestartExitReason, ospfIfEvents=ospfIfEvents, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfEvents=ospfVirtIfEvents, ospfGeneralGroup=ospfGeneralGroup, ospfStubTOS=ospfStubTOS, ospfIfAuthType=ospfIfAuthType, ospfLsdbEntry=ospfLsdbEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsaCount=ospfAsLsaCount, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaGroup=ospfAreaGroup, ospfIfTable=ospfIfTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsLsdbType=ospfAsLsdbType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfRetransInterval=ospfIfRetransInterval, ospfExternalType2=ospfExternalType2, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrOptions=ospfNbrOptions, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfCompliance=ospfCompliance, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsdbChecksum=ospfAsLsdbChecksum, PYSNMP_MODULE_ID=ospf, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfRtrPriority=ospfIfRtrPriority, ospfRestartInterval=ospfRestartInterval, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfIpAddress=ospfIfIpAddress, ospfInterArea=ospfInterArea, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbType=ospfExtLsdbType, ospfVirtIfAuthType=ospfVirtIfAuthType, BigMetric=BigMetric, ospfAreaStatus=ospfAreaStatus, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfHostTOS=ospfHostTOS, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfGroups=ospfGroups, ospfStubAreaGroup=ospfStubAreaGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, PositiveInteger=PositiveInteger, ospfStubMetric=ospfStubMetric, ospfIfPollInterval=ospfIfPollInterval, Status=Status, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfAuthKey=ospfIfAuthKey, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubStatus=ospfStubStatus, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrTable=ospfNbrTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfState=ospfIfState, ospfRestartSupport=ospfRestartSupport, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostEntry=ospfHostEntry, ospfIfMetricTable=ospfIfMetricTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfDemand=ospfIfDemand, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLsdbType=ospfLsdbType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfCompliances=ospfCompliances, ospfLsdbGroup=ospfLsdbGroup, ospfHostStatus=ospfHostStatus, ospfVirtIfState=ospfVirtIfState, HelloRange=HelloRange, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLsdbLsid=ospfLsdbLsid, ospfIfStatus=ospfIfStatus, ospfNbrState=ospfNbrState, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, TOSType=TOSType, ospfIfAdminStat=ospfIfAdminStat, ospfObsoleteGroup=ospfObsoleteGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfExternalType1=ospfExternalType1, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostMetric=ospfHostMetric, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfAdminStat=ospfAdminStat, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfHostAreaID=ospfHostAreaID, ospfAreaId=ospfAreaId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfHelloInterval=ospfIfHelloInterval, UpToMaxAge=UpToMaxAge, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExternLsaCount=ospfExternLsaCount, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfEntry=ospfIfEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfHostGroup=ospfHostGroup, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfGroup=ospfVirtIfGroup, ospfVersionNumber=ospfVersionNumber, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfBasicGroup=ospfBasicGroup, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbAge=ospfLsdbAge, ospfBasicGroup2=ospfBasicGroup2, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricValue=ospfIfMetricValue, AreaID=AreaID, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfSpfRuns=ospfSpfRuns, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfGroup2=ospfIfGroup2, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbTable=ospfLsdbTable, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrArea=ospfVirtNbrArea, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfTOSSupport=ospfTOSSupport, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, Metric=Metric, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaSummary=ospfAreaSummary, ospfConformance=ospfConformance, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfMetricIpAddress=ospfIfMetricIpAddress, RouterID=RouterID, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAddressLessIf=ospfAddressLessIf, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfCompliance2=ospfCompliance2, ospfIfGroup=ospfIfGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAuthType=ospfAuthType, ospfIfAreaId=ospfIfAreaId, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLsdbRouterId=ospfLsdbRouterId, ospfReferenceBandwidth=ospfReferenceBandwidth)
mibBuilder.exportSymbols("OSPF-MIB", ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaEntry=ospfAreaEntry, ospfNbrEntry=ospfNbrEntry)
