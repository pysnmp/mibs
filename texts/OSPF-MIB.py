...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfHostGroup2=ospfHostGroup2, ospfRestartAge=ospfRestartAge, ospfExternalType1=ospfExternalType1, ospfHostIpAddress=ospfHostIpAddress, ospfIfMetricTable=ospfIfMetricTable, PositiveInteger=PositiveInteger, ospfStubStatus=ospfStubStatus, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, OspfAuthenticationType=OspfAuthenticationType, BigMetric=BigMetric, ospfObsoleteGroup=ospfObsoleteGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLsdbLsid=ospfLsdbLsid, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfConformance=ospfConformance, ospfAreaId=ospfAreaId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfNbrTable=ospfNbrTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostStatus=ospfHostStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfGroups=ospfGroups, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrIpAddr=ospfNbrIpAddr, ospfLsdbType=ospfLsdbType, ospfNbrOptions=ospfNbrOptions, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfRestartSupport=ospfRestartSupport, ospfIfMetricGroup=ospfIfMetricGroup, ospfGeneralGroup=ospfGeneralGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIntraArea=ospfIntraArea, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVersionNumber=ospfVersionNumber, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfImportAsExtern=ospfImportAsExtern, ospfIfEntry=ospfIfEntry, ospfAreaEntry=ospfAreaEntry, HelloRange=HelloRange, ospfVirtNbrArea=ospfVirtNbrArea, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaSummary=ospfAreaSummary, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfEvents=ospfIfEvents, ospfHostMetric=ospfHostMetric, ospfAuthType=ospfAuthType, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfBasicGroup2=ospfBasicGroup2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfNbrEvents=ospfNbrEvents, ospfHostAreaID=ospfHostAreaID, ospfRestartExitReason=ospfRestartExitReason, ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsdbTable=ospfAsLsdbTable, PYSNMP_MODULE_ID=ospf, ospfCompliance=ospfCompliance, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubAreaGroup=ospfStubAreaGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrState=ospfNbrState, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfAdminStat=ospfIfAdminStat, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfStatus=ospfIfStatus, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfExtLsdbAge=ospfExtLsdbAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfState=ospfIfState, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLsdbSequence=ospfLsdbSequence, ospfHostTable=ospfHostTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfLsdbGroup=ospfLsdbGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrGroup=ospfNbrGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, RouterID=RouterID, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaStatus=ospfAreaStatus, ospfRxNewLsas=ospfRxNewLsas, ospfRestartStatus=ospfRestartStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfGroup=ospfIfGroup, ospf=ospf, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfHostGroup=ospfHostGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLsdbRouterId=ospfLsdbRouterId, ospfLsdbAreaId=ospfLsdbAreaId, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsLsaCount=ospfAsLsaCount, ospfStubAreaId=ospfStubAreaId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfIpAddress=ospfIfIpAddress, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, Metric=Metric, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrTable=ospfVirtNbrTable, ospfRestartInterval=ospfRestartInterval, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostEntry=ospfHostEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfState=ospfVirtIfState, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, UpToMaxAge=UpToMaxAge, ospfAreaLsaCountTable=ospfAreaLsaCountTable, Status=Status, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricValue=ospfIfMetricValue, ospfCompliance2=ospfCompliance2, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaTable=ospfAreaTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfRouterId=ospfRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricEntry=ospfIfMetricEntry, ospfStubTOS=ospfStubTOS, ospfLsdbTable=ospfLsdbTable, ospfHostTOS=ospfHostTOS, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfGroup2=ospfIfGroup2, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfTable=ospfIfTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfTransitDelay=ospfIfTransitDelay, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaGroup=ospfAreaGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLsdbAge=ospfLsdbAge, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfLsaCount=ospfIfLsaCount, ospfExternLsaCount=ospfExternLsaCount, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrGroup2=ospfNbrGroup2, AreaID=AreaID, ospfStubMetric=ospfStubMetric, ospfStubAreaEntry=ospfStubAreaEntry, ospfExternalType2=ospfExternalType2, ospfInterArea=ospfInterArea, ospfNbrPriority=ospfNbrPriority, ospfCompliances=ospfCompliances, ospfVirtNbrGroup2=ospfVirtNbrGroup2, TOSType=TOSType, ospfIfType=ospfIfType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfPollInterval=ospfIfPollInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrEntry=ospfNbrEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfDemand=ospfIfDemand, ospfRouteGroup=ospfRouteGroup, ospfAdminStat=ospfAdminStat, ospfIfAreaId=ospfIfAreaId)
