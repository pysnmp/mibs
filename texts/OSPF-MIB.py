...
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbGroup=ospfLsdbGroup, HelloRange=HelloRange, ospfLsdbType=ospfLsdbType, ospfVirtNbrState=ospfVirtNbrState, ospfIfMetricTOS=ospfIfMetricTOS, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbAge=ospfLsdbAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubTOS=ospfStubTOS, ospfAreaRangeNet=ospfAreaRangeNet, ospfRestartStatus=ospfRestartStatus, ospfLsdbLsid=ospfLsdbLsid, ospfIfTransitDelay=ospfIfTransitDelay, ospfRouteGroup=ospfRouteGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfBasicGroup=ospfBasicGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVersionNumber=ospfVersionNumber, ospfStubAreaEntry=ospfStubAreaEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbrGroup=ospfNbrGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfMetricValue=ospfIfMetricValue, ospfStubAreaId=ospfStubAreaId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricTable=ospfIfMetricTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaId=ospfAreaId, ospfIfPollInterval=ospfIfPollInterval, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfGroups=ospfGroups, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfMetricStatus=ospfIfMetricStatus, ospfCompliances=ospfCompliances, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfImportAsExtern=ospfImportAsExtern, ospfAreaLsaCount=ospfAreaLsaCount, ospfExternalType1=ospfExternalType1, ospfIfEntry=ospfIfEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaStatus=ospfAreaStatus, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAsLsdbChecksum=ospfAsLsdbChecksum, TOSType=TOSType, ospfIfMulticastForwarding=ospfIfMulticastForwarding, PYSNMP_MODULE_ID=ospf, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaSummary=ospfAreaSummary, ospfLocalLsdbLsid=ospfLocalLsdbLsid, UpToMaxAge=UpToMaxAge, ospfVirtIfEvents=ospfVirtIfEvents, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaRangeMask=ospfAreaRangeMask, RouterID=RouterID, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaTable=ospfAreaTable, ospfNbrGroup2=ospfNbrGroup2, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsaCount=ospfAsLsaCount, ospfIfAuthKey=ospfIfAuthKey, ospfAdminStat=ospfAdminStat, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfStubMetricType=ospfStubMetricType, ospfSpfRuns=ospfSpfRuns, ospfGeneralGroup=ospfGeneralGroup, ospfRestartExitReason=ospfRestartExitReason, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaGroup=ospfAreaGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfConformance=ospfConformance, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfHostTable=ospfHostTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfDemandExtensions=ospfDemandExtensions, ospfNbrTable=ospfNbrTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfEntry=ospfVirtIfEntry, ospfCompliance=ospfCompliance, ospfExternLsaCount=ospfExternLsaCount, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAuthType=ospfAuthType, ospfIfAreaId=ospfIfAreaId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfTOSSupport=ospfTOSSupport, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfRestartInterval=ospfRestartInterval, ospfStubAreaTable=ospfStubAreaTable, ospfIfStatus=ospfIfStatus, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfState=ospfIfState, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfGroup=ospfIfGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrEntry=ospfNbrEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfStubMetric=ospfStubMetric, ospfIfGroup2=ospfIfGroup2, ospfHostEntry=ospfHostEntry, ospfIfAuthType=ospfIfAuthType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfAdminStat=ospfIfAdminStat, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostAreaID=ospfHostAreaID, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbTable=ospfLsdbTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostGroup2=ospfHostGroup2, ospfIfTable=ospfIfTable, OspfAuthenticationType=OspfAuthenticationType, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfInterArea=ospfInterArea, Status=Status, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrPriority=ospfNbrPriority, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfEvents=ospfIfEvents, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbRouterId=ospfLsdbRouterId, ospf=ospf, ospfNbrState=ospfNbrState, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfDemand=ospfIfDemand, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaGroup2=ospfAreaGroup2, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfHostStatus=ospfHostStatus, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrEvents=ospfNbrEvents, Metric=Metric, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, PositiveInteger=PositiveInteger, ospfHostGroup=ospfHostGroup, ospfIntraArea=ospfIntraArea, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, BigMetric=BigMetric, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfBasicGroup2=ospfBasicGroup2, AreaID=AreaID, ospfStubStatus=ospfStubStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExtLsdbType=ospfExtLsdbType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfType=ospfIfType, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfRestartSupport=ospfRestartSupport, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfRxNewLsas=ospfRxNewLsas, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfRtrPriority=ospfIfRtrPriority, DesignatedRouterPriority=DesignatedRouterPriority, ospfCompliance2=ospfCompliance2, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfRestartAge=ospfRestartAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrOptions=ospfNbrOptions, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfHostTOS=ospfHostTOS, ospfAreaRangeTable=ospfAreaRangeTable)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbType=ospfAsLsdbType, ospfHostMetric=ospfHostMetric, ospfExternalType2=ospfExternalType2, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement)
