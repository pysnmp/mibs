...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeGroup=ospfAreaRangeGroup, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfHostEntry=ospfHostEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfAddressLessIf=ospfAddressLessIf, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubMetricType=ospfStubMetricType, ospfAreaLsaCount=ospfAreaLsaCount, ospfStubTOS=ospfStubTOS, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfCompliance2=ospfCompliance2, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfAdminStat=ospfAdminStat, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAsLsdbTable=ospfAsLsdbTable, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfMetricStatus=ospfIfMetricStatus, ospfHostStatus=ospfHostStatus, ospfLsdbAreaId=ospfLsdbAreaId, ospfStubAreaEntry=ospfStubAreaEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, Metric=Metric, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLsdbGroup=ospfLsdbGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrPriority=ospfNbrPriority, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfPollInterval=ospfIfPollInterval, ospfIntraArea=ospfIntraArea, ospfAsLsaCount=ospfAsLsaCount, ospfIfType=ospfIfType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfMetricTable=ospfIfMetricTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsdbAge=ospfAsLsdbAge, ospfAuthType=ospfAuthType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfEvents=ospfIfEvents, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfHostAreaID=ospfHostAreaID, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricValue=ospfIfMetricValue, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfIpAddress=ospfIfIpAddress, ospfHostIpAddress=ospfHostIpAddress, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubAreaId=ospfStubAreaId, ospfHostGroup2=ospfHostGroup2, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRxNewLsas=ospfRxNewLsas, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrState=ospfNbrState, ospfNbrEvents=ospfNbrEvents, HelloRange=HelloRange, ospfAreaSummary=ospfAreaSummary, ospfLsdbType=ospfLsdbType, RouterID=RouterID, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaRangeMask=ospfAreaRangeMask, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfSpfRuns=ospfSpfRuns, ospfNbrTable=ospfNbrTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfRestartStatus=ospfRestartStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfRouterId=ospfRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfIfAuthType=ospfIfAuthType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExternLsaCount=ospfExternLsaCount, PositiveInteger=PositiveInteger, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostTable=ospfHostTable, ospfAreaGroup=ospfAreaGroup, ospfRestartSupport=ospfRestartSupport, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrOptions=ospfNbrOptions, ospfHostMetric=ospfHostMetric, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfEntry=ospfIfEntry, BigMetric=BigMetric, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfAuthKey=ospfIfAuthKey, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfGroup2=ospfIfGroup2, ospfCompliances=ospfCompliances, ospfIfGroup=ospfIfGroup, ospfIfState=ospfIfState, ospfNbrGroup=ospfNbrGroup, ospfConformance=ospfConformance, ospfCompliance=ospfCompliance, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfBasicGroup2=ospfBasicGroup2, Status=Status, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLsdbLsid=ospfLsdbLsid, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVersionNumber=ospfVersionNumber, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLsdbAge=ospfLsdbAge, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaStatus=ospfAreaStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfInterArea=ospfInterArea, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfTable=ospfIfTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfRestartInterval=ospfRestartInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfTOSSupport=ospfTOSSupport, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfLsaCount=ospfIfLsaCount, ospfHostGroup=ospfHostGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrState=ospfVirtNbrState, ospfStubStatus=ospfStubStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfStubMetric=ospfStubMetric, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfDemand=ospfIfDemand, AreaID=AreaID, PYSNMP_MODULE_ID=ospf, ospfAreaTable=ospfAreaTable, ospfLsdbSequence=ospfLsdbSequence, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLsdbTable=ospfLsdbTable, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbType=ospfExtLsdbType, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfGroups=ospfGroups, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrGroup2=ospfVirtNbrGroup2, OspfAuthenticationType=OspfAuthenticationType, ospfExternalType2=ospfExternalType2, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfHostTOS=ospfHostTOS, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLsdbRouterId=ospfLsdbRouterId, ospfExitOverflowInterval=ospfExitOverflowInterval, TOSType=TOSType, ospfObsoleteGroup=ospfObsoleteGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfRestartAge=ospfRestartAge, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, UpToMaxAge=UpToMaxAge, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospf=ospf, ospfAreaId=ospfAreaId, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfStubAreaGroup=ospfStubAreaGroup, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExternalType1=ospfExternalType1, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrEntry=ospfNbrEntry, ospfIfStatus=ospfIfStatus, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrEntry=ospfVirtNbrEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbSequence=ospfExtLsdbSequence, ospfGeneralGroup=ospfGeneralGroup, ospfNbrGroup2=ospfNbrGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus)
