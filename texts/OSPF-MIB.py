...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfGroup2=ospfVirtIfGroup2, ospfHostAreaID=ospfHostAreaID, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, TOSType=TOSType, ospfIfLsaCount=ospfIfLsaCount, ospfNbrEntry=ospfNbrEntry, ospfNbrPriority=ospfNbrPriority, ospfStubAreaId=ospfStubAreaId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubAreaTable=ospfStubAreaTable, ospfStubMetricType=ospfStubMetricType, ospfRestartAge=ospfRestartAge, ospfAsLsaCksumSum=ospfAsLsaCksumSum, HelloRange=HelloRange, ospfAuthType=ospfAuthType, ospfRouterId=ospfRouterId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfStubStatus=ospfStubStatus, ospfNbrGroup=ospfNbrGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfHostStatus=ospfHostStatus, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfMetricValue=ospfIfMetricValue, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbEntry=ospfExtLsdbEntry, BigMetric=BigMetric, ospfDemandExtensions=ospfDemandExtensions, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfRestartSupport=ospfRestartSupport, ospfAsLsdbTable=ospfAsLsdbTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfPollInterval=ospfIfPollInterval, ospfHostIpAddress=ospfHostIpAddress, ospfObsoleteGroup=ospfObsoleteGroup, ospfVersionNumber=ospfVersionNumber, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, AreaID=AreaID, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfAuthType=ospfIfAuthType, PYSNMP_MODULE_ID=ospf, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfConformance=ospfConformance, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfInterArea=ospfInterArea, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfTable=ospfIfTable, Metric=Metric, ospfAreaRangeMask=ospfAreaRangeMask, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospf=ospf, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfState=ospfVirtIfState, UpToMaxAge=UpToMaxAge, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfExtLsdbType=ospfExtLsdbType, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfType=ospfIfType, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaEntry=ospfAreaEntry, ospfRestartInterval=ospfRestartInterval, ospfIfMetricTable=ospfIfMetricTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrGroup2=ospfNbrGroup2, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExternalType2=ospfExternalType2, ospfAddressLessIf=ospfAddressLessIf, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfCompliance=ospfCompliance, ospfTOSSupport=ospfTOSSupport, ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbType=ospfAsLsdbType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfImportAsExtern=ospfImportAsExtern, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfAdminStat=ospfIfAdminStat, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, Status=Status, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfBasicGroup=ospfBasicGroup, ospfIfStatus=ospfIfStatus, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLsdbType=ospfLsdbType, ospfIfState=ospfIfState, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfRestartStatus=ospfRestartStatus, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfStubAreaGroup=ospfStubAreaGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubTOS=ospfStubTOS, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfTable=ospfVirtIfTable, ospfIfDemand=ospfIfDemand, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaTable=ospfAreaTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaGroup=ospfAreaGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfHostEntry=ospfHostEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaId=ospfAreaId, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbGroup=ospfLsdbGroup, PositiveInteger=PositiveInteger, ospfStubMetric=ospfStubMetric, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAsLsaCount=ospfAsLsaCount, ospfGroups=ospfGroups, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLsdbSequence=ospfLsdbSequence, ospfCompliances=ospfCompliances, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfAreaId=ospfIfAreaId, ospfLsdbLsid=ospfLsdbLsid, ospfIfEvents=ospfIfEvents, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfHostMetric=ospfHostMetric, ospfAreaStatus=ospfAreaStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfEntry=ospfIfEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfSpfRuns=ospfSpfRuns, ospfHostTOS=ospfHostTOS, ospfRxNewLsas=ospfRxNewLsas, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfCompliance2=ospfCompliance2, ospfIfIpAddress=ospfIfIpAddress, ospfLsdbAge=ospfLsdbAge, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfHostTable=ospfHostTable, ospfIfMetricTOS=ospfIfMetricTOS, ospfExternLsaCount=ospfExternLsaCount, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrTable=ospfNbrTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrState=ospfVirtNbrState, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfHostGroup=ospfHostGroup, ospfNbrState=ospfNbrState, ospfGeneralGroup=ospfGeneralGroup, ospfAreaSummary=ospfAreaSummary, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfComplianceObsolete=ospfComplianceObsolete, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, OspfAuthenticationType=OspfAuthenticationType, ospfExtLsdbTable=ospfExtLsdbTable, ospfIntraArea=ospfIntraArea, ospfAdminStat=ospfAdminStat, ospfIfGroup=ospfIfGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfBasicGroup2=ospfBasicGroup2, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostGroup2=ospfHostGroup2, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfGroup2=ospfIfGroup2, ospfNbrOptions=ospfNbrOptions, RouterID=RouterID, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbType=ospfLocalLsdbType)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExternalType1=ospfExternalType1, ospfVirtIfGroup=ospfVirtIfGroup)
