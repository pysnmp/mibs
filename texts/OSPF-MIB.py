...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostEntry=ospfHostEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostIpAddress=ospfHostIpAddress, ospfIfIpAddress=ospfIfIpAddress, ospfIfEvents=ospfIfEvents, ospfAreaEntry=ospfAreaEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaSummary=ospfAreaSummary, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrEntry=ospfNbrEntry, ospfBasicGroup=ospfBasicGroup, PositiveInteger=PositiveInteger, ospf=ospf, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfMetricTOS=ospfIfMetricTOS, BigMetric=BigMetric, ospfAreaAggregateTable=ospfAreaAggregateTable, OspfAuthenticationType=OspfAuthenticationType, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaGroup=ospfAreaGroup, ospfAdminStat=ospfAdminStat, ospfExtLsdbType=ospfExtLsdbType, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfType=ospfIfType, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfTable=ospfVirtIfTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbEntry=ospfLsdbEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfStubRouterSupport=ospfStubRouterSupport, ospfHostStatus=ospfHostStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfTOSSupport=ospfTOSSupport, ospfAreaId=ospfAreaId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfAuthKey=ospfIfAuthKey, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfCompliance2=ospfCompliance2, HelloRange=HelloRange, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfHostTOS=ospfHostTOS, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbrEvents=ospfNbrEvents, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrState=ospfNbrState, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfCompliances=ospfCompliances, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbType=ospfLsdbType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, TOSType=TOSType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfAreaId=ospfIfAreaId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfSpfRuns=ospfSpfRuns, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrState=ospfVirtNbrState, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfNbrRtrId=ospfNbrRtrId, ospfNbrGroup=ospfNbrGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRestartStatus=ospfRestartStatus, ospfStubTOS=ospfStubTOS, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfRestartSupport=ospfRestartSupport, ospfHostGroup=ospfHostGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfInterArea=ospfInterArea, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExternLsaCount=ospfExternLsaCount, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfTransitDelay=ospfIfTransitDelay, ospfLsdbGroup=ospfLsdbGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfGroups=ospfGroups, ospfIfGroup2=ospfIfGroup2, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrPriority=ospfNbrPriority, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubMetric=ospfStubMetric, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaTable=ospfAreaTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfState=ospfIfState, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, Metric=Metric, ospfIfDemand=ospfIfDemand, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfState=ospfVirtIfState, ospfAreaGroup2=ospfAreaGroup2, ospfVersionNumber=ospfVersionNumber, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrGroup2=ospfNbrGroup2, ospfIntraArea=ospfIntraArea, ospfIfStatus=ospfIfStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbRouterId=ospfLsdbRouterId, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfAuthType=ospfIfAuthType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfEntry=ospfIfEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfConformance=ospfConformance, ospfIfGroup=ospfIfGroup, ospfRestartAge=ospfRestartAge, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfHostMetric=ospfHostMetric, ospfIfTable=ospfIfTable, RouterID=RouterID, ospfNbrOptions=ospfNbrOptions, ospfImportAsExtern=ospfImportAsExtern, ospfAreaStatus=ospfAreaStatus, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLsdbSequence=ospfLsdbSequence, ospfAsLsaCount=ospfAsLsaCount, ospfNbrTable=ospfNbrTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfCompliance=ospfCompliance, ospfVirtNbrArea=ospfVirtNbrArea, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfLsaCksumSum=ospfIfLsaCksumSum, UpToMaxAge=UpToMaxAge, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRxNewLsas=ospfRxNewLsas, ospfExternalType2=ospfExternalType2, PYSNMP_MODULE_ID=ospf, AreaID=AreaID, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbTable=ospfExtLsdbTable, ospfHostTable=ospfHostTable, ospfLsdbLsid=ospfLsdbLsid, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubMetricType=ospfStubMetricType, ospfHostGroup2=ospfHostGroup2, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLsdbChecksum=ospfLsdbChecksum, ospfStubAreaGroup=ospfStubAreaGroup, ospfStubAreaTable=ospfStubAreaTable, ospfIfAdminStat=ospfIfAdminStat, Status=Status, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfEvents=ospfVirtIfEvents, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfComplianceObsolete=ospfComplianceObsolete, ospfRouterId=ospfRouterId, ospfAuthType=ospfAuthType, ospfRFC1583Compatibility=ospfRFC1583Compatibility)
mibBuilder.exportSymbols("OSPF-MIB", ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfStubStatus=ospfStubStatus, ospfIfMetricStatus=ospfIfMetricStatus)
