...
mibBuilder.exportSymbols("OSPF-MIB", ospfInterArea=ospfInterArea, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostIpAddress=ospfHostIpAddress, ospfStubTOS=ospfStubTOS, ospfAddressLessIf=ospfAddressLessIf, ospfExternalType1=ospfExternalType1, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfImportAsExtern=ospfImportAsExtern, ospfIfMetricTOS=ospfIfMetricTOS, HelloRange=HelloRange, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbTable=ospfLsdbTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfHostGroup2=ospfHostGroup2, ospfIfAdminStat=ospfIfAdminStat, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfCompliance2=ospfCompliance2, ospfIfTable=ospfIfTable, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfRxNewLsas=ospfRxNewLsas, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfState=ospfIfState, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVersionNumber=ospfVersionNumber, ospfIfEntry=ospfIfEntry, ospfVirtIfState=ospfVirtIfState, ospfCompliances=ospfCompliances, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaGroup=ospfAreaGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaRangeEntry=ospfAreaRangeEntry, PositiveInteger=PositiveInteger, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAdminStat=ospfAdminStat, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrOptions=ospfNbrOptions, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrPriority=ospfNbrPriority, Status=Status, ospfExternLsaCount=ospfExternLsaCount, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLocalLsdbType=ospfLocalLsdbType, ospfRestartStatus=ospfRestartStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfMetricStatus=ospfIfMetricStatus, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfAuthType=ospfIfAuthType, ospfLsdbEntry=ospfLsdbEntry, AreaID=AreaID, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfEvents=ospfIfEvents, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAsLsdbTable=ospfAsLsdbTable, ospfHostStatus=ospfHostStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfIpAddress=ospfIfIpAddress, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfBasicGroup2=ospfBasicGroup2, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfLsaCount=ospfIfLsaCount, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIntraArea=ospfIntraArea, ospfStubMetricType=ospfStubMetricType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfHostEntry=ospfHostEntry, ospfRouterId=ospfRouterId, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostMetric=ospfHostMetric, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaSummary=ospfAreaSummary, ospfAreaTable=ospfAreaTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubAreaId=ospfStubAreaId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfAuthKey=ospfIfAuthKey, ospfIfDemand=ospfIfDemand, ospfDemandExtensions=ospfDemandExtensions, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbAreaId=ospfLsdbAreaId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfGroup=ospfIfGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrEvents=ospfNbrEvents, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeNet=ospfAreaRangeNet, UpToMaxAge=UpToMaxAge, RouterID=RouterID, ospfStubAreaTable=ospfStubAreaTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfRestartAge=ospfRestartAge, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfType=ospfIfType, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAuthType=ospfAuthType, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, TOSType=TOSType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaId=ospfAreaId, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsaCount=ospfAsLsaCount, ospfHostTOS=ospfHostTOS, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, OspfAuthenticationType=OspfAuthenticationType, ospfLsdbType=ospfLsdbType, ospfLsdbLsid=ospfLsdbLsid, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfNeighbor=ospfVirtIfNeighbor, Metric=Metric, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaStatus=ospfAreaStatus, ospfNbrRtrId=ospfNbrRtrId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfMulticastExtensions=ospfMulticastExtensions, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfBasicGroup=ospfBasicGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfStatus=ospfIfStatus, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostTable=ospfHostTable, ospfExtLsdbType=ospfExtLsdbType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfRestartInterval=ospfRestartInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfCompliance=ospfCompliance, ospfNbrState=ospfNbrState, ospfNbrGroup2=ospfNbrGroup2, ospfRestartExitReason=ospfRestartExitReason, ospfExternalType2=ospfExternalType2, ospfNbrIpAddr=ospfNbrIpAddr, ospfStubMetric=ospfStubMetric, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfEvents=ospfVirtIfEvents, PYSNMP_MODULE_ID=ospf, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfGroup2=ospfIfGroup2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfTOSSupport=ospfTOSSupport, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfRestartSupport=ospfRestartSupport, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfMetricGroup=ospfIfMetricGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfHostGroup=ospfHostGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfAreaId=ospfIfAreaId, ospfConformance=ospfConformance, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfGroups=ospfGroups, ospfNbrGroup=ospfNbrGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrTable=ospfNbrTable)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfTable=ospfVirtIfTable, ospfIfMetricTable=ospfIfMetricTable, BigMetric=BigMetric, ospf=ospf)
