...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfRestartSupport=ospfRestartSupport, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfGeneralGroup=ospfGeneralGroup, ospfSpfRuns=ospfSpfRuns, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfConformance=ospfConformance, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExternalType1=ospfExternalType1, ospfIfRetransInterval=ospfIfRetransInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfStubRouterSupport=ospfStubRouterSupport, ospfCompliance2=ospfCompliance2, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, UpToMaxAge=UpToMaxAge, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfRxNewLsas=ospfRxNewLsas, Metric=Metric, ospfRestartInterval=ospfRestartInterval, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfComplianceObsolete=ospfComplianceObsolete, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostMetric=ospfHostMetric, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaStatus=ospfAreaStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfType=ospfIfType, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAdminStat=ospfAdminStat, ospfAreaEntry=ospfAreaEntry, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfStubStatus=ospfStubStatus, ospfExtLsdbTable=ospfExtLsdbTable, ospfRestartAge=ospfRestartAge, ospfAreaGroup=ospfAreaGroup, ospfHostGroup2=ospfHostGroup2, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubMetric=ospfStubMetric, ospfHostTable=ospfHostTable, ospfIfState=ospfIfState, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrGroup2=ospfVirtNbrGroup2, RouterID=RouterID, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubMetricType=ospfStubMetricType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfStubTOS=ospfStubTOS, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaSummary=ospfAreaSummary, ospfIfDemand=ospfIfDemand, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfDemandExtensions=ospfDemandExtensions, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaTable=ospfAreaTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfBasicGroup2=ospfBasicGroup2, ospfExitOverflowInterval=ospfExitOverflowInterval, OspfAuthenticationType=OspfAuthenticationType, ospfIntraArea=ospfIntraArea, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfGroup2=ospfIfGroup2, ospfIfAdminStat=ospfIfAdminStat, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfIpAddress=ospfIfIpAddress, ospfIfLsaCount=ospfIfLsaCount, ospfHostTOS=ospfHostTOS, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfExternalType2=ospfExternalType2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfMetricTable=ospfIfMetricTable, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, PositiveInteger=PositiveInteger, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostEntry=ospfHostEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospf=ospf, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, TOSType=TOSType, ospfVersionNumber=ospfVersionNumber, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaAggregateNet=ospfAreaAggregateNet, Status=Status, ospfBasicGroup=ospfBasicGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrGroup=ospfNbrGroup, ospfIfEvents=ospfIfEvents, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtIfStatus=ospfVirtIfStatus, ospfAddressLessIf=ospfAddressLessIf, ospfIfGroup=ospfIfGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, HelloRange=HelloRange, BigMetric=BigMetric, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfTable=ospfIfTable, ospfInterArea=ospfInterArea, ospfIfEntry=ospfIfEntry, ospfCompliance=ospfCompliance, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaId=ospfAreaId, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfState=ospfVirtIfState, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRouterId=ospfRouterId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfAuthKey=ospfIfAuthKey, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrTable=ospfNbrTable, ospfNbrGroup2=ospfNbrGroup2, ospfIfAreaId=ospfIfAreaId, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaGroup2=ospfAreaGroup2, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfRouteGroup=ospfRouteGroup, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfCompliances=ospfCompliances, ospfNbrEvents=ospfNbrEvents, ospfIfStatus=ospfIfStatus, ospfRestartExitReason=ospfRestartExitReason, ospfMulticastExtensions=ospfMulticastExtensions, ospfNbrRtrId=ospfNbrRtrId, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrState=ospfNbrState, ospfLsdbType=ospfLsdbType, ospfNbrEntry=ospfNbrEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, PYSNMP_MODULE_ID=ospf, ospfLsdbGroup=ospfLsdbGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrOptions=ospfNbrOptions, ospfAsLsdbTable=ospfAsLsdbTable, ospfAuthType=ospfAuthType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLsdbLsid=ospfLsdbLsid, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbType=ospfLocalLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostStatus=ospfHostStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfPollInterval=ospfIfPollInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfLsdbRouterId=ospfLsdbRouterId, AreaID=AreaID, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfStubAreaId=ospfStubAreaId, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsaCount=ospfAsLsaCount, ospfLsdbTable=ospfLsdbTable, ospfVirtIfTable=ospfVirtIfTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfHostAreaID=ospfHostAreaID, ospfStubAreaTable=ospfStubAreaTable, ospfTOSSupport=ospfTOSSupport, ospfLsdbAge=ospfLsdbAge, ospfImportAsExtern=ospfImportAsExtern, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfAuthType=ospfIfAuthType, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfHostGroup=ospfHostGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExtLsdbType=ospfExtLsdbType, ospfGroups=ospfGroups)
