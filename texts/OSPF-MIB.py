...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrEntry=ospfNbrEntry, BigMetric=BigMetric, ospfDiscontinuityTime=ospfDiscontinuityTime, AreaID=AreaID, ospfIfType=ospfIfType, ospfNbrRtrId=ospfNbrRtrId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfHostIpAddress=ospfHostIpAddress, ospfStubStatus=ospfStubStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfHostStatus=ospfHostStatus, ospfCompliance2=ospfCompliance2, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLsdbLsid=ospfLsdbLsid, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfPollInterval=ospfIfPollInterval, ospfIfAdminStat=ospfIfAdminStat, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfTable=ospfVirtIfTable, Status=Status, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfStubAreaEntry=ospfStubAreaEntry, PositiveInteger=PositiveInteger, ospfRxNewLsas=ospfRxNewLsas, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfMetricTOS=ospfIfMetricTOS, HelloRange=HelloRange, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbEntry=ospfLsdbEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfStubMetric=ospfStubMetric, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfGroup=ospfIfGroup, ospfBasicGroup=ospfBasicGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrEvents=ospfNbrEvents, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfState=ospfVirtIfState, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaGroup=ospfAreaGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAuthType=ospfAuthType, ospfBasicGroup2=ospfBasicGroup2, Metric=Metric, ospfStubTOS=ospfStubTOS, ospfIfMetricValue=ospfIfMetricValue, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfConformance=ospfConformance, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfEvents=ospfIfEvents, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfState=ospfIfState, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, DesignatedRouterPriority=DesignatedRouterPriority, RouterID=RouterID, ospfLsdbSequence=ospfLsdbSequence, ospfHostMetric=ospfHostMetric, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfStubMetricType=ospfStubMetricType, OspfAuthenticationType=OspfAuthenticationType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAddressLessIf=ospfAddressLessIf, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaId=ospfAreaId, ospfVersionNumber=ospfVersionNumber, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfExternalType1=ospfExternalType1, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfRouterId=ospfRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfEntry=ospfIfEntry, ospfIntraArea=ospfIntraArea, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfRestartStatus=ospfRestartStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrGroup2=ospfNbrGroup2, TOSType=TOSType, ospfRestartAge=ospfRestartAge, ospfAreaStatus=ospfAreaStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrTable=ospfNbrTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostTable=ospfHostTable, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaTable=ospfAreaTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfAuthType=ospfIfAuthType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrGroup=ospfNbrGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfCompliance=ospfCompliance, ospfIfIpAddress=ospfIfIpAddress, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbAge=ospfLsdbAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLsdbGroup=ospfLsdbGroup, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAdminStat=ospfAdminStat, ospfIfStatus=ospfIfStatus, ospfNbrState=ospfNbrState, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCount=ospfAreaLsaCount, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfGroups=ospfGroups, ospfAreaSummary=ospfAreaSummary, UpToMaxAge=UpToMaxAge, ospfIfRetransInterval=ospfIfRetransInterval, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfCompliances=ospfCompliances, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfTable=ospfIfTable, ospfHostGroup=ospfHostGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostGroup2=ospfHostGroup2, ospfLsdbType=ospfLsdbType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfStubAreaTable=ospfStubAreaTable, ospfAreaEntry=ospfAreaEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfRestartInterval=ospfRestartInterval, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaRangeNet=ospfAreaRangeNet, ospfDemandExtensions=ospfDemandExtensions, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrState=ospfVirtNbrState, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfTOSSupport=ospfTOSSupport, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfGroup2=ospfIfGroup2, ospfHostEntry=ospfHostEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfRouteGroup=ospfRouteGroup, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrIpAddr=ospfNbrIpAddr, ospfRestartSupport=ospfRestartSupport, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfMetricTable=ospfIfMetricTable, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbType=ospfExtLsdbType, PYSNMP_MODULE_ID=ospf, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospf=ospf, ospfSpfRuns=ospfSpfRuns, ospfInterArea=ospfInterArea, ospfExternalType2=ospfExternalType2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfAreaId=ospfIfAreaId, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfRestartExitReason=ospfRestartExitReason, ospfStubAreaId=ospfStubAreaId, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbAge=ospfAsLsdbAge)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfDemand=ospfIfDemand, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaAggregateMask=ospfAreaAggregateMask)
