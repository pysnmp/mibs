...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExtLsdbType=ospfExtLsdbType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfMetricTable=ospfIfMetricTable, ospfNbrState=ospfNbrState, ospfNbrIpAddr=ospfNbrIpAddr, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfRouterId=ospfRouterId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfRestartStatus=ospfRestartStatus, ospfIfEvents=ospfIfEvents, ospfComplianceObsolete=ospfComplianceObsolete, ospfBasicGroup2=ospfBasicGroup2, ospfAreaEntry=ospfAreaEntry, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfPollInterval=ospfIfPollInterval, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfEntry=ospfVirtIfEntry, ospfStubAreaTable=ospfStubAreaTable, BigMetric=BigMetric, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, HelloRange=HelloRange, ospfRestartInterval=ospfRestartInterval, ospfStubMetric=ospfStubMetric, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfHostTable=ospfHostTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubAreaEntry=ospfStubAreaEntry, PositiveInteger=PositiveInteger, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfState=ospfIfState, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfAuthKey=ospfIfAuthKey, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfGroups=ospfGroups, ospfIntraArea=ospfIntraArea, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfRxNewLsas=ospfRxNewLsas, ospfNbrGroup=ospfNbrGroup, ospfAreaSummary=ospfAreaSummary, ospfDemandExtensions=ospfDemandExtensions, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfRestartSupport=ospfRestartSupport, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfType=ospfIfType, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfCompliances=ospfCompliances, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRouteGroup=ospfRouteGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfHelloInterval=ospfIfHelloInterval, ospf=ospf, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbTable=ospfLsdbTable, ospfBasicGroup=ospfBasicGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfHostEntry=ospfHostEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbGroup=ospfLsdbGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfDemand=ospfIfDemand, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaTable=ospfAreaTable, ospfAsLsdbType=ospfAsLsdbType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAuthType=ospfAuthType, ospfAdminStat=ospfAdminStat, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfHostStatus=ospfHostStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaGroup2=ospfAreaGroup2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrPriority=ospfNbrPriority, ospfTOSSupport=ospfTOSSupport, ospfIfMetricTOS=ospfIfMetricTOS, ospfStubTOS=ospfStubTOS, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaId=ospfAreaId, ospfLsdbLsid=ospfLsdbLsid, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfTransitDelay=ospfIfTransitDelay, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrGroup2=ospfNbrGroup2, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrRtrId=ospfNbrRtrId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfImportAsExtern=ospfImportAsExtern, ospfAddressLessIf=ospfAddressLessIf, ospfIfLsaCount=ospfIfLsaCount, ospfStubMetricType=ospfStubMetricType, ospfNbrOptions=ospfNbrOptions, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfTable=ospfIfTable, ospfIfAreaId=ospfIfAreaId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, UpToMaxAge=UpToMaxAge, ospfIfGroup2=ospfIfGroup2, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfHostMetric=ospfHostMetric, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrState=ospfVirtNbrState, ospfIfStatus=ospfIfStatus, ospfIfIpAddress=ospfIfIpAddress, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsaCount=ospfAsLsaCount, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfHostGroup=ospfHostGroup, ospfNbrTable=ospfNbrTable, ospfConformance=ospfConformance, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfCompliance=ospfCompliance, ospfGeneralGroup=ospfGeneralGroup, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, Status=Status, ospfStubAreaId=ospfStubAreaId, ospfVirtIfState=ospfVirtIfState, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbAreaId=ospfLsdbAreaId, AreaID=AreaID, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, OspfAuthenticationType=OspfAuthenticationType, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExtLsdbTable=ospfExtLsdbTable, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfEntry=ospfIfEntry, ospfIfAuthType=ospfIfAuthType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVersionNumber=ospfVersionNumber, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaStatus=ospfAreaStatus, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfExternLsaCount=ospfExternLsaCount, ospfExternalType1=ospfExternalType1, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostIpAddress=ospfHostIpAddress, ospfRestartAge=ospfRestartAge, ospfLocalLsdbType=ospfLocalLsdbType, ospfObsoleteGroup=ospfObsoleteGroup, ospfHostAreaID=ospfHostAreaID, ospfLsdbType=ospfLsdbType, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrEvents=ospfNbrEvents, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfStubStatus=ospfStubStatus, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfHostGroup2=ospfHostGroup2, ospfLsdbAge=ospfLsdbAge, ospfIfGroup=ospfIfGroup, PYSNMP_MODULE_ID=ospf, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, Metric=Metric, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrEntry=ospfNbrEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostTOS=ospfHostTOS, ospfInterArea=ospfInterArea, ospfVirtIfAuthType=ospfVirtIfAuthType, TOSType=TOSType, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfCompliance2=ospfCompliance2, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbEntry=ospfLsdbEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrEvents=ospfVirtNbrEvents)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, RouterID=RouterID)
