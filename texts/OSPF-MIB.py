...
mibBuilder.exportSymbols("OSPF-MIB", ospfStubTOS=ospfStubTOS, ospfAreaSummary=ospfAreaSummary, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbAge=ospfExtLsdbAge, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricStatus=ospfIfMetricStatus, ospfStubMetric=ospfStubMetric, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrGroup=ospfNbrGroup, ospfLsdbAge=ospfLsdbAge, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostGroup=ospfHostGroup, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbType=ospfLocalLsdbType, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfDemand=ospfIfDemand, ospfExternLsaCount=ospfExternLsaCount, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfAreaId=ospfIfAreaId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostMetric=ospfHostMetric, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrEvents=ospfNbrEvents, ospfIfRtrPriority=ospfIfRtrPriority, ospfGroups=ospfGroups, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfHostIpAddress=ospfHostIpAddress, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfState=ospfVirtIfState, ospfNbrOptions=ospfNbrOptions, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfHostAreaID=ospfHostAreaID, ospfStubStatus=ospfStubStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbType=ospfExtLsdbType, ospfObsoleteGroup=ospfObsoleteGroup, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, Status=Status, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaRangeStatus=ospfAreaRangeStatus, PositiveInteger=PositiveInteger, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrIpAddr=ospfNbrIpAddr, ospfExternalType2=ospfExternalType2, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfEvents=ospfIfEvents, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfEntry=ospfIfEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLsdbEntry=ospfLsdbEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, TOSType=TOSType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, OspfAuthenticationType=OspfAuthenticationType, ospfRestartAge=ospfRestartAge, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaRangeNet=ospfAreaRangeNet, PYSNMP_MODULE_ID=ospf, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfBasicGroup=ospfBasicGroup, ospfNbrTable=ospfNbrTable, ospfIfAuthKey=ospfIfAuthKey, ospfTOSSupport=ospfTOSSupport, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbGroup=ospfLsdbGroup, ospfHostTOS=ospfHostTOS, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaStatus=ospfAreaStatus, ospfRestartExitReason=ospfRestartExitReason, ospfIfStatus=ospfIfStatus, ospfRestartStatus=ospfRestartStatus, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaRangeMask=ospfAreaRangeMask, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfImportAsExtern=ospfImportAsExtern, ospfIfIpAddress=ospfIfIpAddress, ospfAreaEntry=ospfAreaEntry, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfCompliance=ospfCompliance, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfType=ospfIfType, ospfIfMetricValue=ospfIfMetricValue, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAuthType=ospfAuthType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfRestartInterval=ospfRestartInterval, ospfRxNewLsas=ospfRxNewLsas, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAdminStat=ospfAdminStat, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfDemandExtensions=ospfDemandExtensions, ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfHostTable=ospfHostTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfTable=ospfIfTable, ospfVirtIfTable=ospfVirtIfTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfStatus=ospfVirtIfStatus, ospfHostGroup2=ospfHostGroup2, ospfConformance=ospfConformance, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfMulticastExtensions=ospfMulticastExtensions, AreaID=AreaID, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrState=ospfNbrState, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, BigMetric=BigMetric, HelloRange=HelloRange, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfMetricTable=ospfIfMetricTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsLsdbType=ospfAsLsdbType, ospfIfPollInterval=ospfIfPollInterval, ospfStubAreaTable=ospfStubAreaTable, ospfIfAuthType=ospfIfAuthType, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaTable=ospfAreaTable, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostStatus=ospfHostStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfAdminStat=ospfIfAdminStat, ospfIntraArea=ospfIntraArea, ospfCompliances=ospfCompliances, ospfSpfRuns=ospfSpfRuns, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfGeneralGroup=ospfGeneralGroup, Metric=Metric, UpToMaxAge=UpToMaxAge, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrGroup2=ospfNbrGroup2, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVersionNumber=ospfVersionNumber, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfCompliance2=ospfCompliance2, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfComplianceObsolete=ospfComplianceObsolete, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaGroup=ospfAreaGroup, RouterID=RouterID, ospfStubMetricType=ospfStubMetricType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLsdbLsid=ospfLsdbLsid, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfLsaCount=ospfIfLsaCount, ospfLsdbTable=ospfLsdbTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfHostEntry=ospfHostEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfRouterId=ospfRouterId, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricGroup=ospfIfMetricGroup, ospfInterArea=ospfInterArea, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfState=ospfIfState, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfGroup2=ospfIfGroup2, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfStubAreaGroup=ospfStubAreaGroup, ospfAsLsaCount=ospfAsLsaCount, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospf=ospf, ospfLsdbAreaId=ospfLsdbAreaId, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaId=ospfAreaId, ospfVirtIfEntry=ospfVirtIfEntry, ospfStubAreaId=ospfStubAreaId, ospfVirtIfEvents=ospfVirtIfEvents, ospfExternalType1=ospfExternalType1, ospfLsdbType=ospfLsdbType, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfHelloInterval=ospfIfHelloInterval)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMetricEntry=ospfIfMetricEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtNbrTable=ospfVirtNbrTable)
