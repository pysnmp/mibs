...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfRxNewLsas=ospfRxNewLsas, ospfNbrState=ospfNbrState, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfIntraArea=ospfIntraArea, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, UpToMaxAge=UpToMaxAge, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfRouteGroup=ospfRouteGroup, ospfRouterId=ospfRouterId, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfGroups=ospfGroups, ospfNbrRtrId=ospfNbrRtrId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaSummary=ospfAreaSummary, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfDemandExtensions=ospfDemandExtensions, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfStubStatus=ospfStubStatus, ospfLsdbLsid=ospfLsdbLsid, ospfRestartStatus=ospfRestartStatus, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfImportAsExtern=ospfImportAsExtern, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrGroup2=ospfNbrGroup2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfMetricTable=ospfIfMetricTable, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAuthType=ospfAuthType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfGroup2=ospfIfGroup2, ospfIfIpAddress=ospfIfIpAddress, ospfIfMetricEntry=ospfIfMetricEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubTOS=ospfStubTOS, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfConformance=ospfConformance, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospf=ospf, ospfIfType=ospfIfType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfMetricValue=ospfIfMetricValue, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbTable=ospfLsdbTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrPriority=ospfNbrPriority, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfInterArea=ospfInterArea, ospfIfEntry=ospfIfEntry, ospfExternLsaCount=ospfExternLsaCount, ospfNbrEvents=ospfNbrEvents, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbrEntry=ospfNbrEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbAge=ospfLsdbAge, ospfHostAreaID=ospfHostAreaID, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrIpAddr=ospfNbrIpAddr, ospfCompliance=ospfCompliance, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfStatus=ospfVirtIfStatus, ospfAddressLessIf=ospfAddressLessIf, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfAuthKey=ospfIfAuthKey, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAdminStat=ospfAdminStat, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaAggregateEntry=ospfAreaAggregateEntry, Status=Status, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfRestartInterval=ospfRestartInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfCompliance2=ospfCompliance2, ospfLsdbGroup=ospfLsdbGroup, AreaID=AreaID, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfExtLsdbType=ospfExtLsdbType, ospfIfLsaCount=ospfIfLsaCount, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbType=ospfLsdbType, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaStatus=ospfAreaStatus, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfStubMetricType=ospfStubMetricType, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfSpfRuns=ospfSpfRuns, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostGroup=ospfHostGroup, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRestartExitReason=ospfRestartExitReason, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLsdbSequence=ospfLsdbSequence, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExtLsdbAge=ospfExtLsdbAge, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfGroup=ospfIfGroup, ospfAreaGroup2=ospfAreaGroup2, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfState=ospfIfState, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfStubMetric=ospfStubMetric, ospfIfStatus=ospfIfStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfHostMetric=ospfHostMetric, TOSType=TOSType, ospfVirtIfGroup=ospfVirtIfGroup, ospfBasicGroup2=ospfBasicGroup2, BigMetric=BigMetric, PositiveInteger=PositiveInteger, HelloRange=HelloRange, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfState=ospfVirtIfState, PYSNMP_MODULE_ID=ospf, ospfHostTOS=ospfHostTOS, ospfNbrTable=ospfNbrTable, ospfVirtNbrTable=ospfVirtNbrTable, ospfExternalType2=ospfExternalType2, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfLsaCount=ospfVirtIfLsaCount, Metric=Metric, ospfIfTable=ospfIfTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsaCount=ospfAsLsaCount, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbChecksum=ospfLsdbChecksum, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfHostEntry=ospfHostEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfExternalType1=ospfExternalType1, ospfIfPollInterval=ospfIfPollInterval, ospfRestartSupport=ospfRestartSupport, ospfIfMetricTOS=ospfIfMetricTOS, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrState=ospfVirtNbrState, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfHostGroup2=ospfHostGroup2, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaTable=ospfAreaTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfStubAreaId=ospfStubAreaId, ospfIfEvents=ospfIfEvents, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfAreaId=ospfIfAreaId, ospfHostIpAddress=ospfHostIpAddress, RouterID=RouterID, ospfAreaId=ospfAreaId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfCompliances=ospfCompliances, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLsdbRouterId=ospfLsdbRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfBasicGroup=ospfBasicGroup, ospfAreaGroup=ospfAreaGroup, ospfVersionNumber=ospfVersionNumber, ospfRestartAge=ospfRestartAge, ospfHostStatus=ospfHostStatus, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfTable=ospfVirtIfTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrOptions=ospfNbrOptions, ospfHostTable=ospfHostTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaEntry=ospfAreaEntry)
mibBuilder.exportSymbols("OSPF-MIB", DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfAuthType=ospfIfAuthType, ospfIfDemand=ospfIfDemand)
