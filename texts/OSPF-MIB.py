...
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbEntry=ospfLsdbEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfImportAsExtern=ospfImportAsExtern, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrEntry=ospfNbrEntry, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostTOS=ospfHostTOS, PYSNMP_MODULE_ID=ospf, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, UpToMaxAge=UpToMaxAge, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIntraArea=ospfIntraArea, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRestartStatus=ospfRestartStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRxNewLsas=ospfRxNewLsas, Metric=Metric, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLsdbAge=ospfLsdbAge, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, AreaID=AreaID, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfGroup=ospfIfGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaGroup2=ospfAreaGroup2, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfCompliance2=ospfCompliance2, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfRestartSupport=ospfRestartSupport, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrPriority=ospfNbrPriority, ospfAreaStatus=ospfAreaStatus, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAdminStat=ospfAdminStat, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfConformance=ospfConformance, ospfVirtIfEvents=ospfVirtIfEvents, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLsdbLsid=ospfLsdbLsid, ospfIfStatus=ospfIfStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfDemand=ospfIfDemand, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbTable=ospfAsLsdbTable, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtNbrGroup2=ospfVirtNbrGroup2, HelloRange=HelloRange, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrState=ospfVirtNbrState, ospfHostEntry=ospfHostEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfStubStatus=ospfStubStatus, BigMetric=BigMetric, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfGeneralGroup=ospfGeneralGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfIpAddress=ospfIfIpAddress, ospfStubTOS=ospfStubTOS, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfRestartInterval=ospfRestartInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfPollInterval=ospfIfPollInterval, ospfCompliance=ospfCompliance, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfTable=ospfIfTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLsdbGroup=ospfLsdbGroup, RouterID=RouterID, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfDemandExtensions=ospfDemandExtensions, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfState=ospfVirtIfState, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, Status=Status, ospfHostTable=ospfHostTable, ospfIfAreaId=ospfIfAreaId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtIfTable=ospfVirtIfTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfRestartAge=ospfRestartAge, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfHostGroup=ospfHostGroup, ospfAddressLessIf=ospfAddressLessIf, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrGroup2=ospfNbrGroup2, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfState=ospfIfState, PositiveInteger=PositiveInteger, ospfIfLsaCount=ospfIfLsaCount, ospfHostAreaID=ospfHostAreaID, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaEntry=ospfAreaEntry, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbTable=ospfLsdbTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLsdbRouterId=ospfLsdbRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrTable=ospfNbrTable, ospfLsdbType=ospfLsdbType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsaCount=ospfAsLsaCount, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfCompliances=ospfCompliances, ospfIfGroup2=ospfIfGroup2, ospfSpfRuns=ospfSpfRuns, ospfLsdbAreaId=ospfLsdbAreaId, ospfGroups=ospfGroups, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExternLsaCount=ospfExternLsaCount, ospfIfRtrPriority=ospfIfRtrPriority, ospfVersionNumber=ospfVersionNumber, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, OspfAuthenticationType=OspfAuthenticationType, ospfIfEntry=ospfIfEntry, ospfIfType=ospfIfType, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaTable=ospfAreaTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfComplianceObsolete=ospfComplianceObsolete, ospfStubAreaId=ospfStubAreaId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfGroup=ospfVirtIfGroup, ospfHostStatus=ospfHostStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfHostIpAddress=ospfHostIpAddress, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExternalType2=ospfExternalType2, ospfIfAuthType=ospfIfAuthType, ospf=ospf, ospfStubMetric=ospfStubMetric, ospfHostGroup2=ospfHostGroup2, ospfIfEvents=ospfIfEvents, ospfAuthType=ospfAuthType, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfInterArea=ospfInterArea, ospfAreaGroup=ospfAreaGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfBasicGroup=ospfBasicGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRouterId=ospfRouterId, ospfAreaSummary=ospfAreaSummary, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, TOSType=TOSType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaId=ospfAreaId, ospfHostMetric=ospfHostMetric, ospfNbrState=ospfNbrState)
mibBuilder.exportSymbols("OSPF-MIB", ospfBasicGroup2=ospfBasicGroup2, ospfIfAdminStat=ospfIfAdminStat, ospfNbrEvents=ospfNbrEvents, ospfExternalType1=ospfExternalType1)
