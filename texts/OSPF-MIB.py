...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfGroup=ospfIfGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostAreaID=ospfHostAreaID, ospfAuthType=ospfAuthType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, TOSType=TOSType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrTable=ospfVirtNbrTable, UpToMaxAge=UpToMaxAge, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfNbrGroup=ospfNbrGroup, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLsdbChecksum=ospfLsdbChecksum, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaTable=ospfAreaTable, ospfAreaId=ospfAreaId, ospfIfAuthKey=ospfIfAuthKey, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfMetricTable=ospfIfMetricTable, ospfStubMetric=ospfStubMetric, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubAreaTable=ospfStubAreaTable, ospfIfAreaId=ospfIfAreaId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, Metric=Metric, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfNbrPriority=ospfNbrPriority, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfGroup2=ospfIfGroup2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfMetricGroup=ospfIfMetricGroup, OspfAuthenticationType=OspfAuthenticationType, BigMetric=BigMetric, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRxNewLsas=ospfRxNewLsas, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfStubMetricType=ospfStubMetricType, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLsdbRouterId=ospfLsdbRouterId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfTable=ospfIfTable, ospfAreaEntry=ospfAreaEntry, ospfRouterId=ospfRouterId, ospfNbrRtrId=ospfNbrRtrId, ospfNbrEvents=ospfNbrEvents, ospfRestartSupport=ospfRestartSupport, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostGroup=ospfHostGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbEntry=ospfLsdbEntry, ospfExternLsaCount=ospfExternLsaCount, ospfIfDemand=ospfIfDemand, ospfVirtNbrState=ospfVirtNbrState, ospfCompliance2=ospfCompliance2, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfRestartInterval=ospfRestartInterval, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfState=ospfIfState, Status=Status, ospfAreaSummary=ospfAreaSummary, ospfHostEntry=ospfHostEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfRestartStatus=ospfRestartStatus, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrTable=ospfNbrTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaRangeGroup=ospfAreaRangeGroup, RouterID=RouterID, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIntraArea=ospfIntraArea, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, AreaID=AreaID, ospfVirtIfState=ospfVirtIfState, ospfHostGroup2=ospfHostGroup2, ospfNbrEntry=ospfNbrEntry, HelloRange=HelloRange, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfBasicGroup2=ospfBasicGroup2, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfCompliance=ospfCompliance, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfMulticastExtensions=ospfMulticastExtensions, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospf=ospf, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbType=ospfLsdbType, ospfAsLsdbType=ospfAsLsdbType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLocalLsdbType=ospfLocalLsdbType, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfObsoleteGroup=ospfObsoleteGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsaCount=ospfAsLsaCount, ospfStubStatus=ospfStubStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfMetricValue=ospfIfMetricValue, ospfConformance=ospfConformance, ospfIfRtrPriority=ospfIfRtrPriority, ospfGroups=ospfGroups, ospfBasicGroup=ospfBasicGroup, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfStatus=ospfIfStatus, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostMetric=ospfHostMetric, ospfIfEntry=ospfIfEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaStatus=ospfAreaStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfGeneralGroup=ospfGeneralGroup, ospfStubAreaId=ospfStubAreaId, ospfLsdbGroup=ospfLsdbGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfStubTOS=ospfStubTOS, ospfLsdbTable=ospfLsdbTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfRouteGroup=ospfRouteGroup, ospfAreaRangeTable=ospfAreaRangeTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostStatus=ospfHostStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfTransitDelay=ospfIfTransitDelay, ospfAddressLessIf=ospfAddressLessIf, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrState=ospfNbrState, ospfAsLsdbAge=ospfAsLsdbAge, ospfExternalType1=ospfExternalType1, ospfVersionNumber=ospfVersionNumber, ospfHostTOS=ospfHostTOS, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateNet=ospfAreaAggregateNet, PYSNMP_MODULE_ID=ospf, ospfLsdbLsid=ospfLsdbLsid, ospfStubAreaGroup=ospfStubAreaGroup, ospfCompliances=ospfCompliances, ospfVirtIfGroup=ospfVirtIfGroup, ospfExternalType2=ospfExternalType2, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfTable=ospfVirtIfTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRestartAge=ospfRestartAge, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfAdminStat=ospfIfAdminStat, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfPollInterval=ospfIfPollInterval, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfEvents=ospfIfEvents, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, PositiveInteger=PositiveInteger, ospfIfType=ospfIfType, ospfNbrGroup2=ospfNbrGroup2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAdminStat=ospfAdminStat, ospfHostTable=ospfHostTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaGroup=ospfAreaGroup, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfDemandExtensions=ospfDemandExtensions, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfMetricEntry=ospfIfMetricEntry, ospfImportAsExtern=ospfImportAsExtern, ospfAreaGroup2=ospfAreaGroup2, ospfTOSSupport=ospfTOSSupport)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbAge=ospfLsdbAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfSpfRuns=ospfSpfRuns)
