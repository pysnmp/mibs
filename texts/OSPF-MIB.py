...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaTable=ospfAreaTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaRangeNet=ospfAreaRangeNet, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfEvents=ospfIfEvents, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaEntry=ospfAreaEntry, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, PYSNMP_MODULE_ID=ospf, ospfLsdbAge=ospfLsdbAge, ospfVersionNumber=ospfVersionNumber, ospfAreaStatus=ospfAreaStatus, ospfSpfRuns=ospfSpfRuns, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, UpToMaxAge=UpToMaxAge, ospfIfDemand=ospfIfDemand, ospfExternalType1=ospfExternalType1, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbrRtrId=ospfNbrRtrId, ospfImportAsExtern=ospfImportAsExtern, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfGroup2=ospfIfGroup2, ospfHostIpAddress=ospfHostIpAddress, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbAge=ospfExtLsdbAge, ospfCompliance2=ospfCompliance2, ospfRestartSupport=ospfRestartSupport, ospfBasicGroup=ospfBasicGroup, Status=Status, ospfLocalLsdbType=ospfLocalLsdbType, OspfAuthenticationType=OspfAuthenticationType, ospfDemandExtensions=ospfDemandExtensions, ospfHostTable=ospfHostTable, ospfRestartStatus=ospfRestartStatus, ospfRouterId=ospfRouterId, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAddressLessIf=ospfAddressLessIf, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfAuthKey=ospfIfAuthKey, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfState=ospfVirtIfState, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaAggregateStatus=ospfAreaAggregateStatus, TOSType=TOSType, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospf=ospf, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfState=ospfIfState, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfExternalType2=ospfExternalType2, ospfIfStatus=ospfIfStatus, ospfHostGroup=ospfHostGroup, ospfIfType=ospfIfType, ospfIfGroup=ospfIfGroup, ospfVirtNbrState=ospfVirtNbrState, ospfLsdbTable=ospfLsdbTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfTable=ospfVirtIfTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfGroup=ospfVirtIfGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfStubAreaGroup=ospfStubAreaGroup, ospfAdminStat=ospfAdminStat, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfMetricValue=ospfIfMetricValue, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMetricTOS=ospfIfMetricTOS, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfHostEntry=ospfHostEntry, ospfStubStatus=ospfStubStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfMetricGroup=ospfIfMetricGroup, ospfConformance=ospfConformance, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLsdbEntry=ospfLsdbEntry, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExtLsdbSequence=ospfExtLsdbSequence, PositiveInteger=PositiveInteger, ospfTOSSupport=ospfTOSSupport, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfHostGroup2=ospfHostGroup2, ospfNbrOptions=ospfNbrOptions, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbSequence=ospfLocalLsdbSequence, HelloRange=HelloRange, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfNbrGroup2=ospfNbrGroup2, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfExternLsaCount=ospfExternLsaCount, ospfAreaSummary=ospfAreaSummary, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfHostAreaID=ospfHostAreaID, ospfRouteGroup=ospfRouteGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfAsLsdbType=ospfAsLsdbType, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfBasicGroup2=ospfBasicGroup2, ospfStubTOS=ospfStubTOS, ospfVirtIfStatus=ospfVirtIfStatus, ospfRestartInterval=ospfRestartInterval, ospfGeneralGroup=ospfGeneralGroup, ospfNbrEntry=ospfNbrEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaGroup2=ospfAreaGroup2, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaGroup=ospfAreaGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfHostTOS=ospfHostTOS, ospfAreaLsaCount=ospfAreaLsaCount, ospfStubMetric=ospfStubMetric, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfHostStatus=ospfHostStatus, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIntraArea=ospfIntraArea, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaRangeTable=ospfAreaRangeTable, Metric=Metric, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRestartExitReason=ospfRestartExitReason, ospfIfEntry=ospfIfEntry, ospfNbrEvents=ospfNbrEvents, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAsLsaCount=ospfAsLsaCount, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaId=ospfAreaId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbLsid=ospfLsdbLsid, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfTable=ospfIfTable, ospfStubMetricType=ospfStubMetricType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrGroup=ospfNbrGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfLsaCount=ospfIfLsaCount, ospfCompliance=ospfCompliance, ospfLsdbType=ospfLsdbType, ospfMulticastExtensions=ospfMulticastExtensions, AreaID=AreaID, ospfHostMetric=ospfHostMetric, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbAge=ospfLocalLsdbAge, BigMetric=BigMetric, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfMetricTable=ospfIfMetricTable, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfAreaId=ospfIfAreaId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfRxNewLsas=ospfRxNewLsas, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfStubAreaTable=ospfStubAreaTable, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfCompliances=ospfCompliances, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAuthType=ospfAuthType, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfGroups=ospfGroups, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, RouterID=RouterID, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfRestartAge=ospfRestartAge, ospfVirtNbrOptions=ospfVirtNbrOptions)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfIpAddress=ospfIfIpAddress, ospfIfAuthType=ospfIfAuthType)
