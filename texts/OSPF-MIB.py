...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtIfGroup=ospfVirtIfGroup, TOSType=TOSType, ospfNbrEvents=ospfNbrEvents, ospfIfEntry=ospfIfEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubTOS=ospfStubTOS, ospfDemandExtensions=ospfDemandExtensions, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfExtLsdbType=ospfExtLsdbType, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfType=ospfIfType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbTable=ospfLsdbTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, HelloRange=HelloRange, ospfAdminStat=ospfAdminStat, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaStatus=ospfAreaStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaGroup2=ospfAreaGroup2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfCompliance2=ospfCompliance2, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfHostGroup2=ospfHostGroup2, AreaID=AreaID, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfStubMetricType=ospfStubMetricType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfRxNewLsas=ospfRxNewLsas, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfDemand=ospfIfDemand, ospfVirtNbrState=ospfVirtNbrState, ospfNbrOptions=ospfNbrOptions, PYSNMP_MODULE_ID=ospf, ospfIfAreaId=ospfIfAreaId, ospfNbrEntry=ospfNbrEntry, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfImportAsExtern=ospfImportAsExtern, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, Status=Status, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfConformance=ospfConformance, ospfIfMetricValue=ospfIfMetricValue, ospfLsdbType=ospfLsdbType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfMetricTable=ospfIfMetricTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubMetric=ospfStubMetric, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaGroup=ospfAreaGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfAdminStat=ospfIfAdminStat, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbType=ospfAsLsdbType, ospfNbrGroup2=ospfNbrGroup2, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfGroups=ospfGroups, ospfCompliances=ospfCompliances, PositiveInteger=PositiveInteger, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfRestartAge=ospfRestartAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfExternLsaCount=ospfExternLsaCount, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfRestartSupport=ospfRestartSupport, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfHostAreaID=ospfHostAreaID, ospfHostIpAddress=ospfHostIpAddress, ospfBasicGroup2=ospfBasicGroup2, BigMetric=BigMetric, ospfStubAreaTable=ospfStubAreaTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAuthType=ospfAuthType, ospfRestartInterval=ospfRestartInterval, ospfSpfRuns=ospfSpfRuns, ospfAddressLessIf=ospfAddressLessIf, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrPriority=ospfNbrPriority, ospfIfIpAddress=ospfIfIpAddress, ospfIntraArea=ospfIntraArea, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfTOSSupport=ospfTOSSupport, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrTable=ospfNbrTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtIfTable=ospfVirtIfTable, ospfVersionNumber=ospfVersionNumber, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaRangeMask=ospfAreaRangeMask, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfComplianceObsolete=ospfComplianceObsolete, ospfHostGroup=ospfHostGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, DesignatedRouterPriority=DesignatedRouterPriority, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbAge=ospfLsdbAge, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbAge=ospfLocalLsdbAge, Metric=Metric, ospfLsdbLsid=ospfLsdbLsid, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExternalType2=ospfExternalType2, ospf=ospf, ospfAreaEntry=ospfAreaEntry, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfNeighbor=ospfVirtIfNeighbor, OspfAuthenticationType=OspfAuthenticationType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfHostStatus=ospfHostStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostMetric=ospfHostMetric, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaTable=ospfAreaTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubAreaId=ospfStubAreaId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrTable=ospfVirtNbrTable, ospfHostEntry=ospfHostEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, RouterID=RouterID, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfStatus=ospfIfStatus, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfExternalType1=ospfExternalType1, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfCompliance=ospfCompliance, ospfHostTOS=ospfHostTOS, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfRouteGroup=ospfRouteGroup, ospfNbrGroup=ospfNbrGroup, UpToMaxAge=UpToMaxAge, ospfStubStatus=ospfStubStatus, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrState=ospfNbrState, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfMetricEntry=ospfIfMetricEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfEntry=ospfVirtIfEntry, ospfRestartStatus=ospfRestartStatus, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaId=ospfAreaId, ospfGeneralGroup=ospfGeneralGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfTable=ospfIfTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfGroup=ospfIfGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfInterArea=ospfInterArea, ospfLsdbRouterId=ospfLsdbRouterId, ospfStubRouterSupport=ospfStubRouterSupport, ospfHostTable=ospfHostTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfEvents=ospfIfEvents, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrIpAddr=ospfNbrIpAddr, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfState=ospfIfState, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfLsaCount=ospfIfLsaCount, ospfAreaSummary=ospfAreaSummary)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfGroup2=ospfIfGroup2, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum)
