...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfGroup=ospfVirtIfGroup, ospfRestartStatus=ospfRestartStatus, ospfComplianceObsolete=ospfComplianceObsolete, AreaID=AreaID, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubAreaId=ospfStubAreaId, ospfAreaId=ospfAreaId, ospfExternalType1=ospfExternalType1, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostAreaID=ospfHostAreaID, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, PositiveInteger=PositiveInteger, BigMetric=BigMetric, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostEntry=ospfHostEntry, ospfIfLsaCount=ospfIfLsaCount, ospfTOSSupport=ospfTOSSupport, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAddressLessIf=ospfAddressLessIf, ospfNbrTable=ospfNbrTable, ospfRestartAge=ospfRestartAge, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, TOSType=TOSType, ospfIfRetransInterval=ospfIfRetransInterval, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfBasicGroup=ospfBasicGroup, ospfLsdbLsid=ospfLsdbLsid, ospfIfTable=ospfIfTable, ospfAsLsdbType=ospfAsLsdbType, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubTOS=ospfStubTOS, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrEvents=ospfNbrEvents, ospfIfState=ospfIfState, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLsdbSequence=ospfLsdbSequence, ospfVersionNumber=ospfVersionNumber, ospfStubMetric=ospfStubMetric, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfMetricTable=ospfIfMetricTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfStatus=ospfIfStatus, ospfLsdbAge=ospfLsdbAge, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaGroup=ospfAreaGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRxNewLsas=ospfRxNewLsas, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaStatus=ospfAreaStatus, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbrGroup=ospfNbrGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfIpAddress=ospfIfIpAddress, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrArea=ospfVirtNbrArea, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfType=ospfIfType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrState=ospfNbrState, ospfNbrOptions=ospfNbrOptions, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfEvents=ospfVirtIfEvents, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfMulticastExtensions=ospfMulticastExtensions, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfStubAreaTable=ospfStubAreaTable, HelloRange=HelloRange, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfStubStatus=ospfStubStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostTable=ospfHostTable, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAuthType=ospfAuthType, ospfRestartSupport=ospfRestartSupport, ospfImportAsExtern=ospfImportAsExtern, ospfIfTransitDelay=ospfIfTransitDelay, ospfIntraArea=ospfIntraArea, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCount=ospfAreaLsaCount, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfHostMetric=ospfHostMetric, ospfLsdbGroup=ospfLsdbGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfCompliances=ospfCompliances, ospfInterArea=ospfInterArea, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfDemandExtensions=ospfDemandExtensions, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrState=ospfVirtNbrState, ospfNbrGroup2=ospfNbrGroup2, ospfStubMetricType=ospfStubMetricType, ospfIfDemand=ospfIfDemand, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfAdminStat=ospfIfAdminStat, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfRouteGroup=ospfRouteGroup, ospfAreaSummary=ospfAreaSummary, ospfHostCfgAreaID=ospfHostCfgAreaID, Metric=Metric, ospfIfEvents=ospfIfEvents, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfTable=ospfVirtIfTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfStubAreaEntry=ospfStubAreaEntry, ospfCompliance=ospfCompliance, ospfAreaRangeEntry=ospfAreaRangeEntry, UpToMaxAge=UpToMaxAge, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfAreaId=ospfIfAreaId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfRestartInterval=ospfRestartInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostGroup=ospfHostGroup, ospfExtLsdbType=ospfExtLsdbType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfExternalType2=ospfExternalType2, ospfRouterId=ospfRouterId, ospfIfGroup2=ospfIfGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAdminStat=ospfAdminStat, ospfAreaAggregateEntry=ospfAreaAggregateEntry, OspfAuthenticationType=OspfAuthenticationType, ospfIfAuthType=ospfIfAuthType, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfNbrEntry=ospfNbrEntry, RouterID=RouterID, ospfVirtIfState=ospfVirtIfState, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfBasicGroup2=ospfBasicGroup2, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfGroup=ospfIfGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaTable=ospfAreaTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfHostGroup2=ospfHostGroup2, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfEntry=ospfIfEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfHostTOS=ospfHostTOS, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfConformance=ospfConformance, ospfAreaRangeMask=ospfAreaRangeMask, PYSNMP_MODULE_ID=ospf, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfGroups=ospfGroups, DesignatedRouterPriority=DesignatedRouterPriority, ospf=ospf, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfGeneralGroup=ospfGeneralGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, Status=Status, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsdbAge=ospfAsLsdbAge, ospfHostStatus=ospfHostStatus, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsaCount=ospfAsLsaCount, ospfLsdbType=ospfLsdbType)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfCompliance2=ospfCompliance2, ospfIfPollInterval=ospfIfPollInterval, ospfAreaLsaCountTable=ospfAreaLsaCountTable)
