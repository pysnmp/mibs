...
mibBuilder.exportSymbols("OSPF-MIB", ospfRestartExitReason=ospfRestartExitReason, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfHostIpAddress=ospfHostIpAddress, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaEntry=ospfAreaEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostStatus=ospfHostStatus, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfEntry=ospfIfEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLsdbTable=ospfLsdbTable, ospfLsdbChecksum=ospfLsdbChecksum, ospfImportAsExtern=ospfImportAsExtern, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfTable=ospfIfTable, ospfIntraArea=ospfIntraArea, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAddressLessIf=ospfAddressLessIf, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, AreaID=AreaID, ospfNbrPriority=ospfNbrPriority, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospf=ospf, ospfRestartAge=ospfRestartAge, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricValue=ospfIfMetricValue, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfRestartStatus=ospfRestartStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfState=ospfIfState, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfLsaCount=ospfIfLsaCount, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrGroup=ospfNbrGroup, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaGroup2=ospfAreaGroup2, ospfStubTOS=ospfStubTOS, Status=Status, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubMetricType=ospfStubMetricType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRouteGroup=ospfRouteGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfRouterId=ospfRouterId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostEntry=ospfHostEntry, RouterID=RouterID, ospfAsLsdbType=ospfAsLsdbType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrEvents=ospfVirtNbrEvents, BigMetric=BigMetric, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbSequence=ospfLsdbSequence, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrRtrId=ospfNbrRtrId, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfGeneralGroup=ospfGeneralGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRestartInterval=ospfRestartInterval, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfCompliance=ospfCompliance, ospfObsoleteGroup=ospfObsoleteGroup, ospfCompliances=ospfCompliances, ospfBasicGroup=ospfBasicGroup, ospfIfStatus=ospfIfStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfGroup2=ospfIfGroup2, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrGroup2=ospfNbrGroup2, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrEntry=ospfNbrEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExternalType2=ospfExternalType2, ospfHostMetric=ospfHostMetric, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExternalType1=ospfExternalType1, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaSummary=ospfAreaSummary, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaId=ospfAreaId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfDemand=ospfIfDemand, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrArea=ospfVirtNbrArea, ospfExternLsaCount=ospfExternLsaCount, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaTable=ospfAreaTable, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, UpToMaxAge=UpToMaxAge, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, PositiveInteger=PositiveInteger, ospfStubMetric=ospfStubMetric, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfState=ospfVirtIfState, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfHostTOS=ospfHostTOS, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfGroups=ospfGroups, ospfAreaStatus=ospfAreaStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfTOSSupport=ospfTOSSupport, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfGroup=ospfIfGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAuthType=ospfAuthType, ospfIfEvents=ospfIfEvents, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, PYSNMP_MODULE_ID=ospf, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbAge=ospfLsdbAge, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaRangeMask=ospfAreaRangeMask, ospfCompliance2=ospfCompliance2, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubStatus=ospfStubStatus, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfAuthKey=ospfIfAuthKey, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfConformance=ospfConformance, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfIpAddress=ospfIfIpAddress, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfAdminStat=ospfIfAdminStat, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrIpAddr=ospfNbrIpAddr, ospfAdminStat=ospfAdminStat, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfStubAreaId=ospfStubAreaId, ospfIfHelloInterval=ospfIfHelloInterval, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfMetricTable=ospfIfMetricTable, ospfHostGroup=ospfHostGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrTable=ospfNbrTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfHostTable=ospfHostTable, ospfHostGroup2=ospfHostGroup2, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, OspfAuthenticationType=OspfAuthenticationType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, HelloRange=HelloRange, ospfNbrOptions=ospfNbrOptions, ospfIfAreaId=ospfIfAreaId, ospfLsdbType=ospfLsdbType, ospfRxNewLsas=ospfRxNewLsas, ospfSpfRuns=ospfSpfRuns, TOSType=TOSType, ospfIfType=ospfIfType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVersionNumber=ospfVersionNumber, ospfHostAreaID=ospfHostAreaID, ospfInterArea=ospfInterArea, Metric=Metric, ospfExtLsdbAge=ospfExtLsdbAge, ospfDemandExtensions=ospfDemandExtensions)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbLsid=ospfLsdbLsid, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed)
