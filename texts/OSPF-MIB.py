...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExternLsaCount=ospfExternLsaCount, ospfNbrState=ospfNbrState, AreaID=AreaID, ospfHostTOS=ospfHostTOS, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaGroup2=ospfAreaGroup2, UpToMaxAge=UpToMaxAge, ospfRxNewLsas=ospfRxNewLsas, ospfVirtIfEntry=ospfVirtIfEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAuthType=ospfAuthType, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaEntry=ospfAreaEntry, ospfLsdbSequence=ospfLsdbSequence, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfHostGroup=ospfHostGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfHostGroup2=ospfHostGroup2, ospfIfLsaCount=ospfIfLsaCount, ospf=ospf, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfStubTOS=ospfStubTOS, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAdminStat=ospfAdminStat, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfEvents=ospfIfEvents, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbrPriority=ospfNbrPriority, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostEntry=ospfHostEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfState=ospfIfState, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfGroup2=ospfIfGroup2, ospfTOSSupport=ospfTOSSupport, ospfLsdbGroup=ospfLsdbGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfHostTable=ospfHostTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfCompliance2=ospfCompliance2, ospfCompliances=ospfCompliances, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsdbType=ospfAsLsdbType, ospfVirtIfGroup=ospfVirtIfGroup, ospfConformance=ospfConformance, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLsdbType=ospfLsdbType, ospfIfDemand=ospfIfDemand, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfRestartInterval=ospfRestartInterval, ospfRestartExitReason=ospfRestartExitReason, ospfStubMetricType=ospfStubMetricType, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaGroup=ospfAreaGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfIpAddress=ospfIfIpAddress, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaTable=ospfAreaTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfGroup=ospfIfGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, Metric=Metric, ospfRestartAge=ospfRestartAge, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrGroup=ospfNbrGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, OspfAuthenticationType=OspfAuthenticationType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfStubAreaTable=ospfStubAreaTable, ospfVersionNumber=ospfVersionNumber, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfAuthKey=ospfIfAuthKey, ospfStubAreaGroup=ospfStubAreaGroup, Status=Status, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfState=ospfVirtIfState, ospfSpfRuns=ospfSpfRuns, ospfNbrIpAddr=ospfNbrIpAddr, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfGeneralGroup=ospfGeneralGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaSummary=ospfAreaSummary, ospfNbrOptions=ospfNbrOptions, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfType=ospfIfType, ospfLsdbAge=ospfLsdbAge, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrArea=ospfVirtNbrArea, DesignatedRouterPriority=DesignatedRouterPriority, ospfBasicGroup=ospfBasicGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrEntry=ospfNbrEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfCompliance=ospfCompliance, ospfHostStatus=ospfHostStatus, ospfImportAsExtern=ospfImportAsExtern, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaId=ospfAreaId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfNbrTable=ospfNbrTable, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfTable=ospfIfTable, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsaCount=ospfAsLsaCount, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfBasicGroup2=ospfBasicGroup2, ospfGroups=ospfGroups, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfHostMetric=ospfHostMetric, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaRangeAreaId=ospfAreaRangeAreaId, PositiveInteger=PositiveInteger, ospfRestartStatus=ospfRestartStatus, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrState=ospfVirtNbrState, ospfDemandExtensions=ospfDemandExtensions, ospfStubAreaId=ospfStubAreaId, ospfIfAdminStat=ospfIfAdminStat, ospfIntraArea=ospfIntraArea, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfStatus=ospfIfStatus, ospfExtLsdbType=ospfExtLsdbType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, BigMetric=BigMetric, RouterID=RouterID, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaStatus=ospfAreaStatus, ospfIfEntry=ospfIfEntry, ospfIfAreaId=ospfIfAreaId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRouterId=ospfRouterId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfComplianceObsolete=ospfComplianceObsolete, ospfStubStatus=ospfStubStatus, ospfLsdbEntry=ospfLsdbEntry, HelloRange=HelloRange, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfStubMetric=ospfStubMetric, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfRouteGroup=ospfRouteGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfHostAreaID=ospfHostAreaID, ospfLsdbChecksum=ospfLsdbChecksum, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfMetricValue=ospfIfMetricValue, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfExternalType1=ospfExternalType1, ospfLsdbLsid=ospfLsdbLsid, ospfAddressLessIf=ospfAddressLessIf, ospfRestartSupport=ospfRestartSupport, ospfIfMetricEntry=ospfIfMetricEntry, PYSNMP_MODULE_ID=ospf, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, TOSType=TOSType)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbAreaId=ospfLsdbAreaId, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbTable=ospfLsdbTable, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval)
