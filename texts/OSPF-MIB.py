...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfState=ospfIfState, HelloRange=HelloRange, ospfHostMetric=ospfHostMetric, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, BigMetric=BigMetric, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaEntry=ospfAreaEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfStubTOS=ospfStubTOS, PositiveInteger=PositiveInteger, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExtLsdbType=ospfExtLsdbType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfAdminStat=ospfAdminStat, ospfVersionNumber=ospfVersionNumber, ospfRestartAge=ospfRestartAge, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfEvents=ospfIfEvents, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfBasicGroup=ospfBasicGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAuthType=ospfAuthType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfBasicGroup2=ospfBasicGroup2, ospfLsdbAge=ospfLsdbAge, ospfExternalType2=ospfExternalType2, ospfIfTable=ospfIfTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRxNewLsas=ospfRxNewLsas, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfHostGroup=ospfHostGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfStatus=ospfIfStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLsdbEntry=ospfLsdbEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLsdbTable=ospfLsdbTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrEntry=ospfNbrEntry, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaTable=ospfAreaTable, ospfIntraArea=ospfIntraArea, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfType=ospfIfType, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCountTable=ospfAreaLsaCountTable, DesignatedRouterPriority=DesignatedRouterPriority, PYSNMP_MODULE_ID=ospf, ospfIfAuthKey=ospfIfAuthKey, ospfNbrState=ospfNbrState, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfHostStatus=ospfHostStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, Status=Status, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbType=ospfAsLsdbType, ospfRestartStatus=ospfRestartStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfGroups=ospfGroups, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfState=ospfVirtIfState, ospfHostAreaID=ospfHostAreaID, ospfIfEntry=ospfIfEntry, ospf=ospf, ospfIfHelloInterval=ospfIfHelloInterval, ospfCompliances=ospfCompliances, ospfAsLsaCount=ospfAsLsaCount, ospfAddressLessIf=ospfAddressLessIf, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfNbrGroup2=ospfNbrGroup2, ospfHostGroup2=ospfHostGroup2, ospfTOSSupport=ospfTOSSupport, ospfGeneralGroup=ospfGeneralGroup, ospfIfIpAddress=ospfIfIpAddress, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfAdminStat=ospfIfAdminStat, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaGroup=ospfAreaGroup, ospfIfGroup=ospfIfGroup, ospfImportAsExtern=ospfImportAsExtern, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrTable=ospfNbrTable, ospfExternalType1=ospfExternalType1, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaSummary=ospfAreaSummary, ospfStubAreaId=ospfStubAreaId, ospfVirtIfTable=ospfVirtIfTable, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfDemand=ospfIfDemand, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, Metric=Metric, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfCompliance2=ospfCompliance2, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLsdbLsid=ospfLsdbLsid, TOSType=TOSType, ospfAreaStatus=ospfAreaStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrEvents=ospfNbrEvents, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExtLsdbTable=ospfExtLsdbTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostTable=ospfHostTable, ospfIfAreaId=ospfIfAreaId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfMetricValue=ospfIfMetricValue, ospfSpfRuns=ospfSpfRuns, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfNbrOptions=ospfNbrOptions, ospfCompliance=ospfCompliance, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfPollInterval=ospfIfPollInterval, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaId=ospfAreaId, ospfStubRouterSupport=ospfStubRouterSupport, OspfAuthenticationType=OspfAuthenticationType, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrGroup=ospfNbrGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrRtrId=ospfNbrRtrId, ospfHostEntry=ospfHostEntry, UpToMaxAge=UpToMaxAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRestartInterval=ospfRestartInterval, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubMetricType=ospfStubMetricType, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfGroup2=ospfIfGroup2, ospfRouterId=ospfRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRouteGroup=ospfRouteGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostIpAddress=ospfHostIpAddress, ospfLsdbType=ospfLsdbType, ospfStubStatus=ospfStubStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsdbAge=ospfAsLsdbAge, ospfHostTOS=ospfHostTOS, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrState=ospfVirtNbrState, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfNbrPriority=ospfNbrPriority, ospfExternLsaCount=ospfExternLsaCount, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfConformance=ospfConformance, ospfStubAreaTable=ospfStubAreaTable, RouterID=RouterID, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubMetric=ospfStubMetric, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfDemandExtensions=ospfDemandExtensions, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, AreaID=AreaID, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLsdbSequence=ospfLsdbSequence)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaGroup2=ospfAreaGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus)
