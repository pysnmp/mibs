...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaSummary=ospfAreaSummary, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfState=ospfVirtIfState, ospfHostGroup=ospfHostGroup, ospfAreaTable=ospfAreaTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfEntry=ospfIfEntry, ospfLsdbLsid=ospfLsdbLsid, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRxNewLsas=ospfRxNewLsas, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfBasicGroup=ospfBasicGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfDemandExtensions=ospfDemandExtensions, ospfHostGroup2=ospfHostGroup2, ospfIfGroup2=ospfIfGroup2, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAsLsaCount=ospfAsLsaCount, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfType=ospfIfType, ospfCompliances=ospfCompliances, ospfAddressLessIf=ospfAddressLessIf, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfGroup=ospfIfGroup, ospfStubStatus=ospfStubStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfRouteGroup=ospfRouteGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfLsaCount=ospfIfLsaCount, ospfNbrState=ospfNbrState, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfCompliance2=ospfCompliance2, ospfGeneralGroup=ospfGeneralGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrState=ospfVirtNbrState, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfBasicGroup2=ospfBasicGroup2, ospfIfState=ospfIfState, ospfVirtNbrRtrId=ospfVirtNbrRtrId, OspfAuthenticationType=OspfAuthenticationType, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfStatus=ospfIfStatus, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfStubTOS=ospfStubTOS, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartSupport=ospfRestartSupport, ospfLsdbAge=ospfLsdbAge, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbAdvertisement=ospfLsdbAdvertisement, UpToMaxAge=UpToMaxAge, ospfExternalType1=ospfExternalType1, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbTable=ospfLsdbTable, PositiveInteger=PositiveInteger, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfConformance=ospfConformance, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAdminStat=ospfAdminStat, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfInterArea=ospfInterArea, ospfRestartAge=ospfRestartAge, ospfHostEntry=ospfHostEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbEntry=ospfLsdbEntry, ospfHostTable=ospfHostTable, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfRouterId=ospfRouterId, ospfNbrPriority=ospfNbrPriority, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfAuthType=ospfIfAuthType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, AreaID=AreaID, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubMetricType=ospfStubMetricType, ospfAreaId=ospfAreaId, ospfStubAreaId=ospfStubAreaId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrEvents=ospfNbrEvents, ospfGroups=ospfGroups, HelloRange=HelloRange, TOSType=TOSType, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfEvents=ospfIfEvents, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaGroup=ospfAreaGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfRestartInterval=ospfRestartInterval, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExternalType2=ospfExternalType2, BigMetric=BigMetric, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfIpAddress=ospfIfIpAddress, ospfRestartExitReason=ospfRestartExitReason, ospf=ospf, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfMetricEntry=ospfIfMetricEntry, ospfObsoleteGroup=ospfObsoleteGroup, RouterID=RouterID, ospfNbrOptions=ospfNbrOptions, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfPollInterval=ospfIfPollInterval, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfCompliance=ospfCompliance, ospfAuthType=ospfAuthType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostMetric=ospfHostMetric, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfNbrTable=ospfNbrTable, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, Metric=Metric, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfTable=ospfIfTable, ospfAreaEntry=ospfAreaEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfDemand=ospfIfDemand, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubMetric=ospfStubMetric, ospfHostStatus=ospfHostStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVersionNumber=ospfVersionNumber, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaStatus=ospfAreaStatus, ospfLsdbType=ospfLsdbType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsdbType=ospfAsLsdbType, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostIpAddress=ospfHostIpAddress, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrGroup=ospfNbrGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, Status=Status, PYSNMP_MODULE_ID=ospf, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfHostAreaID=ospfHostAreaID, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsLsdbAge=ospfAsLsdbAge, ospfExternLsaCount=ospfExternLsaCount, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaRangeEntry=ospfAreaRangeEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfTable=ospfVirtIfTable, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExtLsdbChecksum=ospfExtLsdbChecksum)
