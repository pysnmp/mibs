...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfGroup2=ospfIfGroup2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, AreaID=AreaID, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfImportAsExtern=ospfImportAsExtern, ospfIfIpAddress=ospfIfIpAddress, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfRestartInterval=ospfRestartInterval, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfStubStatus=ospfStubStatus, ospfHostIpAddress=ospfHostIpAddress, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, Metric=Metric, ospfIfAreaId=ospfIfAreaId, ospfHostStatus=ospfHostStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostGroup2=ospfHostGroup2, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrEntry=ospfNbrEntry, ospf=ospf, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaStatus=ospfAreaStatus, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfLsdbSequence=ospfLsdbSequence, ospfLsdbTable=ospfLsdbTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExternalType2=ospfExternalType2, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAdminStat=ospfAdminStat, ospfIfAuthKey=ospfIfAuthKey, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaTable=ospfAreaTable, ospfGroups=ospfGroups, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfDemandExtensions=ospfDemandExtensions, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfMetricValue=ospfIfMetricValue, ospfRestartAge=ospfRestartAge, HelloRange=HelloRange, TOSType=TOSType, ospfRestartExitReason=ospfRestartExitReason, ospfVirtNbrTable=ospfVirtNbrTable, ospfHostEntry=ospfHostEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfType=ospfIfType, ospfLsdbEntry=ospfLsdbEntry, ospfNbrEvents=ospfNbrEvents, BigMetric=BigMetric, PYSNMP_MODULE_ID=ospf, ospfTOSSupport=ospfTOSSupport, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfCompliance2=ospfCompliance2, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrOptions=ospfNbrOptions, Status=Status, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfTransitDelay=ospfIfTransitDelay, ospfAsLsaCount=ospfAsLsaCount, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfStubAreaTable=ospfStubAreaTable, ospfStubTOS=ospfStubTOS, ospfAreaGroup=ospfAreaGroup, ospfIfState=ospfIfState, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfDemand=ospfIfDemand, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfTable=ospfVirtIfTable, ospfCompliance=ospfCompliance, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfConformance=ospfConformance, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfState=ospfVirtIfState, ospfIfAdminStat=ospfIfAdminStat, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExtLsdbType=ospfExtLsdbType, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAuthType=ospfAuthType, ospfIfStatus=ospfIfStatus, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfStubAreaEntry=ospfStubAreaEntry, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfStubMetricType=ospfStubMetricType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfHostMetric=ospfHostMetric, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfGroup=ospfVirtIfGroup, ospfCompliances=ospfCompliances, ospfBasicGroup=ospfBasicGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, PositiveInteger=PositiveInteger, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubMetric=ospfStubMetric, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfBasicGroup2=ospfBasicGroup2, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, DesignatedRouterPriority=DesignatedRouterPriority, ospfMulticastExtensions=ospfMulticastExtensions, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, UpToMaxAge=UpToMaxAge, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrState=ospfVirtNbrState, ospfNbrState=ospfNbrState, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaEntry=ospfAreaEntry, ospfIfGroup=ospfIfGroup, ospfNbrGroup2=ospfNbrGroup2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaGroup2=ospfAreaGroup2, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbGroup=ospfLsdbGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfRouterId=ospfRouterId, ospfSpfRuns=ospfSpfRuns, ospfLsdbType=ospfLsdbType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfRouteGroup=ospfRouteGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrGroup=ospfNbrGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaRangeTable=ospfAreaRangeTable, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfRxNewLsas=ospfRxNewLsas, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsdbTable=ospfAsLsdbTable, ospfRestartStatus=ospfRestartStatus, ospfIntraArea=ospfIntraArea, ospfLsdbLsid=ospfLsdbLsid, ospfHostTOS=ospfHostTOS, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfAuthType=ospfIfAuthType, ospfStubAreaId=ospfStubAreaId, ospfAreaSummary=ospfAreaSummary, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfRestartSupport=ospfRestartSupport, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfEntry=ospfIfEntry, ospfNbrRtrId=ospfNbrRtrId, ospfExternalType1=ospfExternalType1, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbAge=ospfLsdbAge, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostTable=ospfHostTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaId=ospfAreaId, ospfIfTable=ospfIfTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfInterArea=ospfInterArea, OspfAuthenticationType=OspfAuthenticationType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, RouterID=RouterID, ospfHostAreaID=ospfHostAreaID, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExtLsdbGroup=ospfExtLsdbGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMetricTable=ospfIfMetricTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfHostGroup=ospfHostGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility)
