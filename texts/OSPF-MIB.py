...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfLsaCount=ospfIfLsaCount, ospfStubMetric=ospfStubMetric, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfStubMetricType=ospfStubMetricType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfCompliance=ospfCompliance, ospfRestartSupport=ospfRestartSupport, ospfExternLsaCount=ospfExternLsaCount, ospfSpfRuns=ospfSpfRuns, ospfIfEntry=ospfIfEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtIfEntry=ospfVirtIfEntry, ospfAdminStat=ospfAdminStat, ospfLsdbChecksum=ospfLsdbChecksum, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfHelloInterval=ospfIfHelloInterval, ospfLsdbRouterId=ospfLsdbRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricValue=ospfIfMetricValue, ospfNbrEvents=ospfNbrEvents, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfBasicGroup=ospfBasicGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsaCount=ospfAsLsaCount, OspfAuthenticationType=OspfAuthenticationType, ospfIfMetricTable=ospfIfMetricTable, ospfLsdbLsid=ospfLsdbLsid, ospfCompliance2=ospfCompliance2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIntraArea=ospfIntraArea, ospfNbrOptions=ospfNbrOptions, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbAreaId=ospfLsdbAreaId, RouterID=RouterID, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrEvents=ospfVirtNbrEvents, AreaID=AreaID, ospfInterArea=ospfInterArea, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbTable=ospfLocalLsdbTable, PositiveInteger=PositiveInteger, ospfIfPollInterval=ospfIfPollInterval, ospfHostMetric=ospfHostMetric, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfStatus=ospfIfStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfAuthKey=ospfIfAuthKey, ospf=ospf, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfType=ospfIfType, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrPriority=ospfNbrPriority, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, Metric=Metric, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVersionNumber=ospfVersionNumber, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAddressLessIf=ospfAddressLessIf, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaEntry=ospfAreaEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfStubStatus=ospfStubStatus, ospfAsLsdbType=ospfAsLsdbType, ospfHostTable=ospfHostTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRestartInterval=ospfRestartInterval, ospfIfGroup=ospfIfGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, BigMetric=BigMetric, ospfNbrState=ospfNbrState, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfDemandExtensions=ospfDemandExtensions, ospfIfState=ospfIfState, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLsdbAge=ospfLsdbAge, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrIpAddr=ospfNbrIpAddr, ospfHostEntry=ospfHostEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfTable=ospfVirtIfTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfGroups=ospfGroups, ospfHostGroup=ospfHostGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfHostGroup2=ospfHostGroup2, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfRestartStatus=ospfRestartStatus, ospfIfDemand=ospfIfDemand, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfTOSSupport=ospfTOSSupport, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaStatus=ospfAreaStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfRestartExitReason=ospfRestartExitReason, TOSType=TOSType, ospfHostAreaID=ospfHostAreaID, ospfExtLsdbType=ospfExtLsdbType, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, Status=Status, ospfStubAreaTable=ospfStubAreaTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfRouteGroup=ospfRouteGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrTable=ospfNbrTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfExternalType1=ospfExternalType1, ospfExternalType2=ospfExternalType2, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaGroup=ospfAreaGroup, ospfAreaSummary=ospfAreaSummary, ospfAreaRangeNet=ospfAreaRangeNet, UpToMaxAge=UpToMaxAge, ospfIfAuthType=ospfIfAuthType, ospfIfMetricEntry=ospfIfMetricEntry, PYSNMP_MODULE_ID=ospf, ospfAuthType=ospfAuthType, ospfRouterId=ospfRouterId, ospfIfTable=ospfIfTable, ospfRestartAge=ospfRestartAge, HelloRange=HelloRange, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLsdbSequence=ospfLsdbSequence, ospfNbrGroup2=ospfNbrGroup2, ospfConformance=ospfConformance, ospfStubAreaId=ospfStubAreaId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaGroup2=ospfAreaGroup2, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfGroup=ospfVirtIfGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfRxNewLsas=ospfRxNewLsas, ospfIfAreaId=ospfIfAreaId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfEvents=ospfVirtIfEvents, ospfBasicGroup2=ospfBasicGroup2, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrGroup=ospfNbrGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfIpAddress=ospfIfIpAddress, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfGeneralGroup=ospfGeneralGroup, ospfIfGroup2=ospfIfGroup2, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLsdbTable=ospfLsdbTable, ospfLsdbGroup=ospfLsdbGroup, ospfHostIpAddress=ospfHostIpAddress, ospfAreaId=ospfAreaId, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfAdminStat=ospfIfAdminStat, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrRtrId=ospfNbrRtrId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfState=ospfVirtIfState, ospfLsdbType=ospfLsdbType, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfStubTOS=ospfStubTOS, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaTable=ospfAreaTable)
mibBuilder.exportSymbols("OSPF-MIB", ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfHostStatus=ospfHostStatus, ospfCompliances=ospfCompliances)
