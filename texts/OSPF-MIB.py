...
mibBuilder.exportSymbols("OSPF-MIB", Metric=Metric, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrGroup2=ospfNbrGroup2, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, PYSNMP_MODULE_ID=ospf, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfRestartExitReason=ospfRestartExitReason, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrState=ospfNbrState, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfState=ospfIfState, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfExternalType2=ospfExternalType2, ospfSpfRuns=ospfSpfRuns, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfCompliances=ospfCompliances, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfAreaId=ospfIfAreaId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExternalType1=ospfExternalType1, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfAuthType=ospfIfAuthType, ospfHostStatus=ospfHostStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrTable=ospfVirtNbrTable, ospfRxNewLsas=ospfRxNewLsas, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfState=ospfVirtIfState, ospfLsdbChecksum=ospfLsdbChecksum, ospfInterArea=ospfInterArea, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfGroup2=ospfIfGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartInterval=ospfRestartInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaGroup=ospfAreaGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaLsaCount=ospfAreaLsaCount, ospfCompliance2=ospfCompliance2, UpToMaxAge=UpToMaxAge, ospfDemandExtensions=ospfDemandExtensions, ospfIfAuthKey=ospfIfAuthKey, ospfIfEntry=ospfIfEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfDemand=ospfIfDemand, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfGroup=ospfIfGroup, PositiveInteger=PositiveInteger, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfStatus=ospfVirtIfStatus, ospfAsLsdbAge=ospfAsLsdbAge, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfHostGroup2=ospfHostGroup2, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfStatus=ospfIfStatus, ospfAuthType=ospfAuthType, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbAge=ospfLocalLsdbAge, TOSType=TOSType, ospfBasicGroup=ospfBasicGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaGroup2=ospfAreaGroup2, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfCompliance=ospfCompliance, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfStubAreaEntry=ospfStubAreaEntry, ospf=ospf, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLsdbType=ospfLsdbType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfStubAreaTable=ospfStubAreaTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfRouterId=ospfRouterId, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, BigMetric=BigMetric, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAsLsaCount=ospfAsLsaCount, ospfGeneralGroup=ospfGeneralGroup, ospfAreaSummary=ospfAreaSummary, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfRetransInterval=ospfIfRetransInterval, ospfConformance=ospfConformance, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaEntry=ospfAreaEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfBasicGroup2=ospfBasicGroup2, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbAreaId=ospfLsdbAreaId, Status=Status, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfTransitDelay=ospfIfTransitDelay, ospfLsdbGroup=ospfLsdbGroup, ospfStubAreaId=ospfStubAreaId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrGroup=ospfNbrGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfMetricTable=ospfIfMetricTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfMulticastExtensions=ospfMulticastExtensions, ospfTOSSupport=ospfTOSSupport, ospfNbrEntry=ospfNbrEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsdbType=ospfAsLsdbType, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbSequence=ospfLsdbSequence, ospfLsdbAge=ospfLsdbAge, ospfAdminStat=ospfAdminStat, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbEntry=ospfLsdbEntry, ospfHostTable=ospfHostTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfEvents=ospfIfEvents, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfGroups=ospfGroups, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfType=ospfIfType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaTable=ospfAreaTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubTOS=ospfStubTOS, ospfVersionNumber=ospfVersionNumber, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfRouteGroup=ospfRouteGroup, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfHostMetric=ospfHostMetric, ospfIfIpAddress=ospfIfIpAddress, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaId=ospfAreaId, ospfStubStatus=ospfStubStatus, ospfVirtIfTable=ospfVirtIfTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfAdminStat=ospfIfAdminStat, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRestartAge=ospfRestartAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfIntraArea=ospfIntraArea, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfRestartStatus=ospfRestartStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubMetric=ospfStubMetric, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrRtrId=ospfNbrRtrId, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfStubMetricType=ospfStubMetricType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbTable=ospfExtLsdbTable, ospfAsLsdbTable=ospfAsLsdbTable, RouterID=RouterID, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostGroup=ospfHostGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostIpAddress=ospfHostIpAddress, ospfNbrTable=ospfNbrTable, ospfNbrPriority=ospfNbrPriority, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAddressLessIf=ospfAddressLessIf, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfHostEntry=ospfHostEntry, HelloRange=HelloRange, ospfImportAsExtern=ospfImportAsExtern, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfTable=ospfIfTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, AreaID=AreaID, ospfAsLsdbSequence=ospfAsLsdbSequence)
mibBuilder.exportSymbols("OSPF-MIB", ospfHostTOS=ospfHostTOS, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaStatus=ospfAreaStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus)
