...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeMask=ospfAreaRangeMask, ospfHostEntry=ospfHostEntry, ospfIntraArea=ospfIntraArea, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfHostIpAddress=ospfHostIpAddress, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfCompliance=ospfCompliance, ospfAsLsdbType=ospfAsLsdbType, ospfExternalType2=ospfExternalType2, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfNbrGroup=ospfNbrGroup, PYSNMP_MODULE_ID=ospf, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospf=ospf, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRestartAge=ospfRestartAge, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfHostTOS=ospfHostTOS, ospfIfAuthType=ospfIfAuthType, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfCompliances=ospfCompliances, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfInterArea=ospfInterArea, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrRtrId=ospfNbrRtrId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaId=ospfAreaId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLsdbType=ospfLsdbType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostStatus=ospfHostStatus, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrState=ospfNbrState, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfState=ospfVirtIfState, ospfIfStatus=ospfIfStatus, ospfAdminStat=ospfAdminStat, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfGroup=ospfIfGroup, ospfHostGroup=ospfHostGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfTOSSupport=ospfTOSSupport, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfRxNewLsas=ospfRxNewLsas, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfGroups=ospfGroups, OspfAuthenticationType=OspfAuthenticationType, ospfIfState=ospfIfState, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaStatus=ospfAreaStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrOptions=ospfNbrOptions, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfCompliance2=ospfCompliance2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfBasicGroup=ospfBasicGroup, HelloRange=HelloRange, ospfSpfRuns=ospfSpfRuns, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVersionNumber=ospfVersionNumber, ospfStubAreaTable=ospfStubAreaTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfMetricGroup=ospfIfMetricGroup, UpToMaxAge=UpToMaxAge, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubMetric=ospfStubMetric, BigMetric=BigMetric, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfAuthKey=ospfIfAuthKey, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfType=ospfIfType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfRouterId=ospfRouterId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfHelloInterval=ospfIfHelloInterval, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrPriority=ospfNbrPriority, ospfIfIpAddress=ospfIfIpAddress, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, TOSType=TOSType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfGeneralGroup=ospfGeneralGroup, ospfIfEvents=ospfIfEvents, ospfIfLsaCount=ospfIfLsaCount, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrArea=ospfVirtNbrArea, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfRestartInterval=ospfRestartInterval, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfEntry=ospfIfEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaSummary=ospfAreaSummary, ospfIfPollInterval=ospfIfPollInterval, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, Metric=Metric, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrTable=ospfNbrTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfGroup2=ospfIfGroup2, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaEntry=ospfAreaEntry, ospfImportAsExtern=ospfImportAsExtern, ospfLsdbRouterId=ospfLsdbRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfMetricValue=ospfIfMetricValue, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfStubAreaId=ospfStubAreaId, ospfExternLsaCount=ospfExternLsaCount, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfDemand=ospfIfDemand, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRestartStatus=ospfRestartStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrGroup2=ospfNbrGroup2, ospfIfTable=ospfIfTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfConformance=ospfConformance, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLsdbEntry=ospfLsdbEntry, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfStubMetricType=ospfStubMetricType, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrEvents=ospfNbrEvents, ospfAreaRangeTable=ospfAreaRangeTable, ospfBasicGroup2=ospfBasicGroup2, ospfNbrEntry=ospfNbrEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsLsaCount=ospfAsLsaCount, ospfHostAreaID=ospfHostAreaID, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfMulticastExtensions=ospfMulticastExtensions, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExternalType1=ospfExternalType1, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsdbTable=ospfAsLsdbTable, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostMetric=ospfHostMetric, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaGroup=ospfAreaGroup, AreaID=AreaID, PositiveInteger=PositiveInteger, ospfIfMetricTable=ospfIfMetricTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfStubTOS=ospfStubTOS, ospfRestartSupport=ospfRestartSupport, ospfLsdbAge=ospfLsdbAge, ospfAuthType=ospfAuthType, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAddressLessIf=ospfAddressLessIf, ospfAreaTable=ospfAreaTable, ospfStubStatus=ospfStubStatus, ospfHostTable=ospfHostTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, Status=Status, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfRestartExitReason=ospfRestartExitReason, RouterID=RouterID)
