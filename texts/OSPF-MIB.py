...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfHostGroup2=ospfHostGroup2, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, BigMetric=BigMetric, ospfComplianceObsolete=ospfComplianceObsolete, RouterID=RouterID, PositiveInteger=PositiveInteger, ospfAreaSummary=ospfAreaSummary, ospfIfAuthType=ospfIfAuthType, ospfIfPollInterval=ospfIfPollInterval, ospfRouteGroup=ospfRouteGroup, ospfAreaTable=ospfAreaTable, ospfBasicGroup=ospfBasicGroup, ospfHostMetric=ospfHostMetric, ospfStubMetricType=ospfStubMetricType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostTOS=ospfHostTOS, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfObsoleteGroup=ospfObsoleteGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfState=ospfIfState, HelloRange=HelloRange, ospfInterArea=ospfInterArea, Metric=Metric, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfType=ospfIfType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfStubStatus=ospfStubStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsaCount=ospfAsLsaCount, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfRestartAge=ospfRestartAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbAge=ospfLsdbAge, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfGroup=ospfIfGroup, ospfVirtNbrState=ospfVirtNbrState, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExtLsdbType=ospfExtLsdbType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrEntry=ospfNbrEntry, ospfStubMetric=ospfStubMetric, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfImportAsExtern=ospfImportAsExtern, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfBasicGroup2=ospfBasicGroup2, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaGroup2=ospfAreaGroup2, ospfVersionNumber=ospfVersionNumber, Status=Status, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospf=ospf, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, DesignatedRouterPriority=DesignatedRouterPriority, TOSType=TOSType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLsdbLsid=ospfLsdbLsid, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfCompliances=ospfCompliances, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbRouterId=ospfLsdbRouterId, ospfExtLsdbAge=ospfExtLsdbAge, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfHostStatus=ospfHostStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfConformance=ospfConformance, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaLsaCount=ospfAreaLsaCount, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfMetricTable=ospfIfMetricTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfGroup=ospfVirtIfGroup, ospfGeneralGroup=ospfGeneralGroup, ospfIfTable=ospfIfTable, ospfIntraArea=ospfIntraArea, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfDemandExtensions=ospfDemandExtensions, ospfAddressLessIf=ospfAddressLessIf, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrTable=ospfNbrTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubAreaId=ospfStubAreaId, ospfLsdbType=ospfLsdbType, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLsdbSequence=ospfLsdbSequence, ospfIfTransitDelay=ospfIfTransitDelay, ospfAuthType=ospfAuthType, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfStatus=ospfIfStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, OspfAuthenticationType=OspfAuthenticationType, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbTable=ospfLsdbTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfEntry=ospfVirtIfEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExternalType2=ospfExternalType2, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfGroups=ospfGroups, ospfIfDemand=ospfIfDemand, ospfExternLsaCount=ospfExternLsaCount, ospfNbrGroup=ospfNbrGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfEntry=ospfIfEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostGroup=ospfHostGroup, ospfIfAdminStat=ospfIfAdminStat, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaStatus=ospfAreaStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaId=ospfAreaId, ospfRouterId=ospfRouterId, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfState=ospfVirtIfState, ospfIfMetricValue=ospfIfMetricValue, ospfAreaGroup=ospfAreaGroup, UpToMaxAge=UpToMaxAge, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAdminStat=ospfAdminStat, AreaID=AreaID, ospfIfMetricEntry=ospfIfMetricEntry, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfHostAreaID=ospfHostAreaID, ospfCompliance2=ospfCompliance2, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbEntry=ospfLsdbEntry, ospfTOSSupport=ospfTOSSupport, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfAreaId=ospfIfAreaId, ospfHostTable=ospfHostTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbChecksum=ospfExtLsdbChecksum, PYSNMP_MODULE_ID=ospf, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrState=ospfNbrState, ospfIfIpAddress=ospfIfIpAddress, ospfAreaEntry=ospfAreaEntry, ospfRestartExitReason=ospfRestartExitReason, ospfIfEvents=ospfIfEvents, ospfAsLsdbAge=ospfAsLsdbAge, ospfCompliance=ospfCompliance, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrRtrId=ospfNbrRtrId, ospfLsdbGroup=ospfLsdbGroup, ospfIfGroup2=ospfIfGroup2, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrPriority=ospfNbrPriority, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfHostEntry=ospfHostEntry, ospfExternalType1=ospfExternalType1, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRestartSupport=ospfRestartSupport)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubTOS=ospfStubTOS, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfSpfRuns=ospfSpfRuns)
