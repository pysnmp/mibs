...
mibBuilder.exportSymbols("OSPF-MIB", ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateEntry=ospfAreaAggregateEntry, RouterID=RouterID, ospfLsdbAge=ospfLsdbAge, ospfNbrGroup2=ospfNbrGroup2, ospfIfEvents=ospfIfEvents, ospfBasicGroup2=ospfBasicGroup2, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeNet=ospfAreaRangeNet, ospfAsLsdbTable=ospfAsLsdbTable, ospfHostEntry=ospfHostEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostTOS=ospfHostTOS, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, BigMetric=BigMetric, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfType=ospfIfType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaStatus=ospfAreaStatus, ospfMulticastExtensions=ospfMulticastExtensions, ospfCompliance2=ospfCompliance2, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbAdvertisement=ospfLsdbAdvertisement, PYSNMP_MODULE_ID=ospf, ospfVirtIfTable=ospfVirtIfTable, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaEntry=ospfAreaEntry, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbTable=ospfLsdbTable, Status=Status, ospfVersionNumber=ospfVersionNumber, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfHostGroup=ospfHostGroup, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricTOS=ospfIfMetricTOS, ospfAsLsdbType=ospfAsLsdbType, ospfTOSSupport=ospfTOSSupport, TOSType=TOSType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfGroup=ospfVirtIfGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaId=ospfAreaId, ospfGeneralGroup=ospfGeneralGroup, ospfSpfRuns=ospfSpfRuns, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExtLsdbType=ospfExtLsdbType, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaTable=ospfAreaTable, ospfVirtIfState=ospfVirtIfState, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExitOverflowInterval=ospfExitOverflowInterval, AreaID=AreaID, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfImportAsExtern=ospfImportAsExtern, ospfStubAreaTable=ospfStubAreaTable, ospfHostTable=ospfHostTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfAreaId=ospfIfAreaId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfDemandExtensions=ospfDemandExtensions, ospfNbrGroup=ospfNbrGroup, ospf=ospf, ospfRestartAge=ospfRestartAge, ospfNbrIpAddr=ospfNbrIpAddr, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfHostMetric=ospfHostMetric, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfBasicGroup=ospfBasicGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfMetricValue=ospfIfMetricValue, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaLsaCount=ospfAreaLsaCount, ospfGroups=ospfGroups, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrOptions=ospfNbrOptions, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfEntry=ospfIfEntry, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfLsdbType=ospfLsdbType, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfDemand=ospfIfDemand, ospfAuthType=ospfAuthType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfRxNewLsas=ospfRxNewLsas, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, Metric=Metric, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbType=ospfLocalLsdbType, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrTable=ospfNbrTable, ospfIfStatus=ospfIfStatus, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRestartInterval=ospfRestartInterval, OspfAuthenticationType=OspfAuthenticationType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubMetric=ospfStubMetric, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfConformance=ospfConformance, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfHostIpAddress=ospfHostIpAddress, ospfIfGroup2=ospfIfGroup2, ospfAreaGroup2=ospfAreaGroup2, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbGroup=ospfLsdbGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfIpAddress=ospfIfIpAddress, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfLsaCount=ospfIfLsaCount, ospfVirtNbrTable=ospfVirtNbrTable, ospfExternalType1=ospfExternalType1, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfCompliance=ospfCompliance, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfStubAreaEntry=ospfStubAreaEntry, ospfStubMetricType=ospfStubMetricType, PositiveInteger=PositiveInteger, ospfIfAuthKey=ospfIfAuthKey, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrEvents=ospfNbrEvents, ospfIfPollInterval=ospfIfPollInterval, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrPriority=ospfNbrPriority, ospfIfTable=ospfIfTable, ospfStubTOS=ospfStubTOS, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaSummary=ospfAreaSummary, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, UpToMaxAge=UpToMaxAge, ospfLsdbLsid=ospfLsdbLsid, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrState=ospfNbrState, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAdminStat=ospfAdminStat, ospfLsdbAreaId=ospfLsdbAreaId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfHostStatus=ospfHostStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRouterId=ospfRouterId, HelloRange=HelloRange, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfGroup=ospfIfGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubStatus=ospfStubStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfInterArea=ospfInterArea, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfCompliances=ospfCompliances, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfRestartExitReason=ospfRestartExitReason, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfRestartSupport=ospfRestartSupport, ospfExternLsaCount=ospfExternLsaCount, ospfRestartStatus=ospfRestartStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfState=ospfIfState, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrArea=ospfVirtNbrArea)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfHostGroup2=ospfHostGroup2, ospfIfMetricStatus=ospfIfMetricStatus)
