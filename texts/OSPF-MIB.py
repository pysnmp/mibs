...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExitOverflowInterval=ospfExitOverflowInterval, BigMetric=BigMetric, Status=Status, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfHostAreaID=ospfHostAreaID, ospfLsdbAreaId=ospfLsdbAreaId, AreaID=AreaID, ospfAuthType=ospfAuthType, ospfNbrGroup=ospfNbrGroup, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfHelloInterval=ospfIfHelloInterval, ospfHostTable=ospfHostTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfBasicGroup2=ospfBasicGroup2, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbAge=ospfExtLsdbAge, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaSummary=ospfAreaSummary, ospfGeneralGroup=ospfGeneralGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExternalType1=ospfExternalType1, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfStubTOS=ospfStubTOS, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAdminStat=ospfAdminStat, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfTable=ospfIfTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfTable=ospfVirtIfTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, HelloRange=HelloRange, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLsdbLsid=ospfLsdbLsid, ospfStubAreaId=ospfStubAreaId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfStubMetric=ospfStubMetric, ospfCompliance=ospfCompliance, ospfNbrTable=ospfNbrTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, PYSNMP_MODULE_ID=ospf, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfState=ospfVirtIfState, ospfLsdbSequence=ospfLsdbSequence, ospfNbrGroup2=ospfNbrGroup2, Metric=Metric, ospfTOSSupport=ospfTOSSupport, ospfRFC1583Compatibility=ospfRFC1583Compatibility, UpToMaxAge=UpToMaxAge, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfGroup=ospfIfGroup, ospfExternalType2=ospfExternalType2, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrPriority=ospfNbrPriority, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaStatus=ospfAreaStatus, ospfRxNewLsas=ospfRxNewLsas, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaGroup=ospfAreaGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaTable=ospfAreaTable, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfInterArea=ospfInterArea, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfMetricGroup=ospfIfMetricGroup, ospfImportAsExtern=ospfImportAsExtern, ospfAsLsdbAge=ospfAsLsdbAge, ospfRestartInterval=ospfRestartInterval, ospfIfType=ospfIfType, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfHostMetric=ospfHostMetric, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsaCount=ospfAsLsaCount, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfState=ospfIfState, ospfHostIpAddress=ospfHostIpAddress, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfLsdbType=ospfLsdbType, ospfIfDemand=ospfIfDemand, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfStubAreaTable=ospfStubAreaTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfRouterId=ospfRouterId, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfRouteGroup=ospfRouteGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrEvents=ospfNbrEvents, PositiveInteger=PositiveInteger, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrState=ospfNbrState, ospfRestartAge=ospfRestartAge, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfAuthKey=ospfIfAuthKey, DesignatedRouterPriority=DesignatedRouterPriority, ospfCompliance2=ospfCompliance2, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostTOS=ospfHostTOS, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLsdbGroup=ospfLsdbGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfIntraArea=ospfIntraArea, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfRetransInterval=ospfIfRetransInterval, ospfLsdbAge=ospfLsdbAge, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfCompliances=ospfCompliances, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaId=ospfAreaId, ospfHostEntry=ospfHostEntry, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfGroups=ospfGroups, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfDemandExtensions=ospfDemandExtensions, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbrIpAddr=ospfNbrIpAddr, ospfRestartSupport=ospfRestartSupport, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrEntry=ospfNbrEntry, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaEntry=ospfAreaEntry, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfHostGroup=ospfHostGroup, ospfHostGroup2=ospfHostGroup2, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLsdbTable=ospfLsdbTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfPollInterval=ospfIfPollInterval, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfEntry=ospfIfEntry, ospfIfGroup2=ospfIfGroup2, ospfIfEvents=ospfIfEvents, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMetricStatus=ospfIfMetricStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, TOSType=TOSType, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfStatus=ospfIfStatus, ospf=ospf, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfHostStatus=ospfHostStatus, ospfExternLsaCount=ospfExternLsaCount, ospfStubStatus=ospfStubStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartStatus=ospfRestartStatus, ospfIfMetricTable=ospfIfMetricTable, RouterID=RouterID, ospfConformance=ospfConformance, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfAdminStat=ospfIfAdminStat)
mibBuilder.exportSymbols("OSPF-MIB", ospfVersionNumber=ospfVersionNumber, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed)
