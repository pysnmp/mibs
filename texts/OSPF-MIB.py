...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbType=ospfLocalLsdbType, ospfGroups=ospfGroups, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, UpToMaxAge=UpToMaxAge, ospfAdminStat=ospfAdminStat, ospfNbrState=ospfNbrState, ospfExternLsaCount=ospfExternLsaCount, ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfStubStatus=ospfStubStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfHostEntry=ospfHostEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfAdminStat=ospfIfAdminStat, ospfDemandExtensions=ospfDemandExtensions, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfCompliance=ospfCompliance, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsLsaCount=ospfAsLsaCount, ospfNbrGroup2=ospfNbrGroup2, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaTable=ospfAreaTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfConformance=ospfConformance, PositiveInteger=PositiveInteger, ospfVersionNumber=ospfVersionNumber, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfGroup=ospfVirtIfGroup, Metric=Metric, ospfIfIpAddress=ospfIfIpAddress, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRxNewLsas=ospfRxNewLsas, ospfVirtIfState=ospfVirtIfState, ospfLsdbLsid=ospfLsdbLsid, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfHostAreaID=ospfHostAreaID, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, HelloRange=HelloRange, ospfCompliance2=ospfCompliance2, ospfIfState=ospfIfState, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaSummary=ospfAreaSummary, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfHostTOS=ospfHostTOS, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaRangeTable=ospfAreaRangeTable, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaId=ospfAreaId, ospfInterArea=ospfInterArea, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIntraArea=ospfIntraArea, ospfIfGroup2=ospfIfGroup2, ospfAreaStatus=ospfAreaStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaGroup2=ospfAreaGroup2, ospfNbrIpAddr=ospfNbrIpAddr, ospfOriginateNewLsas=ospfOriginateNewLsas, TOSType=TOSType, ospfLsdbAge=ospfLsdbAge, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubAreaTable=ospfStubAreaTable, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfRetransInterval=ospfIfRetransInterval, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaEntry=ospfAreaEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLsdbGroup=ospfLsdbGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfGroup=ospfIfGroup, ospfHostMetric=ospfHostMetric, ospf=ospf, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, AreaID=AreaID, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfMetricEntry=ospfIfMetricEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrGroup=ospfNbrGroup, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfImportAsExtern=ospfImportAsExtern, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaGroup=ospfAreaGroup, PYSNMP_MODULE_ID=ospf, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbSequence=ospfLsdbSequence, ospfRestartAge=ospfRestartAge, Status=Status, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAddressLessIf=ospfAddressLessIf, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfDemand=ospfIfDemand, ospfNbrTable=ospfNbrTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfHostTable=ospfHostTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfType=ospfIfType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfRestartSupport=ospfRestartSupport, ospfIfTable=ospfIfTable, ospfBasicGroup=ospfBasicGroup, BigMetric=BigMetric, ospfIfPollInterval=ospfIfPollInterval, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostGroup2=ospfHostGroup2, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfStubRouterSupport=ospfStubRouterSupport, ospfLsdbTable=ospfLsdbTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfSpfRuns=ospfSpfRuns, ospfIfMetricValue=ospfIfMetricValue, ospfComplianceObsolete=ospfComplianceObsolete, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsdbTable=ospfAsLsdbTable, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfHostIpAddress=ospfHostIpAddress, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbType=ospfExtLsdbType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExternalType2=ospfExternalType2, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, RouterID=RouterID, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfEvents=ospfIfEvents, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfMulticastExtensions=ospfMulticastExtensions, ospfObsoleteGroup=ospfObsoleteGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfAuthType=ospfAuthType, ospfNbrOptions=ospfNbrOptions, ospfNbrRtrId=ospfNbrRtrId, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfStubMetric=ospfStubMetric, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLsdbType=ospfLsdbType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfRouterId=ospfRouterId, ospfRestartExitReason=ospfRestartExitReason, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfCompliances=ospfCompliances, ospfHostGroup=ospfHostGroup, ospfNbrPriority=ospfNbrPriority, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfStatus=ospfIfStatus, ospfStubMetricType=ospfStubMetricType, ospfIfAuthKey=ospfIfAuthKey, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrEvents=ospfNbrEvents, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfRouteGroup=ospfRouteGroup, ospfExternalType1=ospfExternalType1, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfBasicGroup2=ospfBasicGroup2, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfRestartInterval=ospfRestartInterval, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfAreaId=ospfIfAreaId, ospfStubTOS=ospfStubTOS)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbType=ospfAsLsdbType, ospfHostStatus=ospfHostStatus, ospfIfEntry=ospfIfEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId)
