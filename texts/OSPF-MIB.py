...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrState=ospfVirtNbrState, DesignatedRouterPriority=DesignatedRouterPriority, ospfAuthType=ospfAuthType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfType=ospfIfType, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfEntry=ospfIfEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfTOSSupport=ospfTOSSupport, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfStubTOS=ospfStubTOS, ospfHostTOS=ospfHostTOS, ospfAreaGroup2=ospfAreaGroup2, PositiveInteger=PositiveInteger, ospfDemandExtensions=ospfDemandExtensions, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaSummary=ospfAreaSummary, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, OspfAuthenticationType=OspfAuthenticationType, ospfHostGroup2=ospfHostGroup2, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, UpToMaxAge=UpToMaxAge, ospfAreaTable=ospfAreaTable, ospfHostMetric=ospfHostMetric, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfAuthType=ospfIfAuthType, ospfNbrOptions=ospfNbrOptions, ospfIfState=ospfIfState, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostIpAddress=ospfHostIpAddress, ospfIfGroup=ospfIfGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLsdbEntry=ospfLsdbEntry, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfHostTable=ospfHostTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrGroup2=ospfNbrGroup2, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfBasicGroup=ospfBasicGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfNbrEntry=ospfNbrEntry, Status=Status, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrPriority=ospfNbrPriority, ospfHostEntry=ospfHostEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubAreaId=ospfStubAreaId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbAge=ospfLsdbAge, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbAge=ospfExtLsdbAge, ospfCompliance2=ospfCompliance2, ospfIfMetricTable=ospfIfMetricTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaEntry=ospfAreaEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfRestartInterval=ospfRestartInterval, ospfLsdbTable=ospfLsdbTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaGroup=ospfAreaGroup, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, HelloRange=HelloRange, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLsdbLsid=ospfLsdbLsid, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, TOSType=TOSType, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfDesignatedRouter=ospfIfDesignatedRouter, RouterID=RouterID, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfRestartExitReason=ospfRestartExitReason, ospfExternalType1=ospfExternalType1, ospfLsdbType=ospfLsdbType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfHostGroup=ospfHostGroup, PYSNMP_MODULE_ID=ospf, ospfIfEvents=ospfIfEvents, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExtLsdbTable=ospfExtLsdbTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfStatus=ospfVirtIfStatus, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaId=ospfAreaId, ospfIfGroup2=ospfIfGroup2, ospfStubStatus=ospfStubStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLsdbChecksum=ospfLsdbChecksum, ospfCompliances=ospfCompliances, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfTable=ospfIfTable, ospf=ospf, ospfStubMetric=ospfStubMetric, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLsdbRouterId=ospfLsdbRouterId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeNet=ospfAreaRangeNet, ospfComplianceObsolete=ospfComplianceObsolete, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfTransitDelay=ospfIfTransitDelay, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaStatus=ospfAreaStatus, ospfStubMetricType=ospfStubMetricType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbLsid=ospfLocalLsdbLsid, Metric=Metric, ospfNbrGroup=ospfNbrGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaAggregateMask=ospfAreaAggregateMask, BigMetric=BigMetric, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfStubAreaTable=ospfStubAreaTable, ospfSpfRuns=ospfSpfRuns, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfState=ospfVirtIfState, ospfStubRouterSupport=ospfStubRouterSupport, ospfHostStatus=ospfHostStatus, AreaID=AreaID, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfBasicGroup2=ospfBasicGroup2, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfGroups=ospfGroups, ospfRxNewLsas=ospfRxNewLsas, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrState=ospfNbrState, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfRouteGroup=ospfRouteGroup, ospfIfStatus=ospfIfStatus, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfConformance=ospfConformance, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIntraArea=ospfIntraArea, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfInterArea=ospfInterArea, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAdminStat=ospfAdminStat, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfExternalType2=ospfExternalType2, ospfImportAsExtern=ospfImportAsExtern, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfRestartStatus=ospfRestartStatus, ospfIfDemand=ospfIfDemand, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExternLsaCount=ospfExternLsaCount, ospfAddressLessIf=ospfAddressLessIf, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExtLsdbType=ospfExtLsdbType, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfTable=ospfVirtIfTable, ospfStubAreaGroup=ospfStubAreaGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfRestartAge=ospfRestartAge, ospfHostAreaID=ospfHostAreaID, ospfIfAreaId=ospfIfAreaId, ospfNbrTable=ospfNbrTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeGroup=ospfAreaRangeGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrRtrId=ospfNbrRtrId, ospfCompliance=ospfCompliance)
