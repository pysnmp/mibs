...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfMulticastExtensions=ospfMulticastExtensions, OspfAuthenticationType=OspfAuthenticationType, ospfTOSSupport=ospfTOSSupport, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfRestartInterval=ospfRestartInterval, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrPriority=ospfNbrPriority, ospfLsdbTable=ospfLsdbTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfCompliances=ospfCompliances, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfHostGroup=ospfHostGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, TOSType=TOSType, Status=Status, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExternLsaCount=ospfExternLsaCount, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfMetricGroup=ospfIfMetricGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaGroup=ospfAreaGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfCompliance2=ospfCompliance2, ospfNbmaNbrStatus=ospfNbmaNbrStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfReferenceBandwidth=ospfReferenceBandwidth, ospf=ospf, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbLsid=ospfLsdbLsid, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbGroup=ospfLsdbGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaGroup2=ospfAreaGroup2, ospfAreaSummary=ospfAreaSummary, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfTransitDelay=ospfIfTransitDelay, ospfAsLsaCount=ospfAsLsaCount, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbrRtrId=ospfNbrRtrId, ospfSpfRuns=ospfSpfRuns, ospfAdminStat=ospfAdminStat, ospfRestartStatus=ospfRestartStatus, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostEntry=ospfHostEntry, ospfHostStatus=ospfHostStatus, ospfIfAreaId=ospfIfAreaId, ospfIfAuthKey=ospfIfAuthKey, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfStubAreaGroup=ospfStubAreaGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfRestartExitReason=ospfRestartExitReason, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfDemand=ospfIfDemand, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfState=ospfVirtIfState, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfConformance=ospfConformance, ospfVersionNumber=ospfVersionNumber, RouterID=RouterID, ospfHostMetric=ospfHostMetric, ospfRouterId=ospfRouterId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfStatus=ospfVirtIfStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbRouterId=ospfLsdbRouterId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaRangeTable=ospfAreaRangeTable, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaId=ospfAreaId, ospfIfGroup=ospfIfGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfHostGroup2=ospfHostGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartSupport=ospfRestartSupport, ospfHostTOS=ospfHostTOS, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIntraArea=ospfIntraArea, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfStatus=ospfIfStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfHelloInterval=ospfIfHelloInterval, UpToMaxAge=UpToMaxAge, BigMetric=BigMetric, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRouteGroup=ospfRouteGroup, ospfIfEvents=ospfIfEvents, ospfHostIpAddress=ospfHostIpAddress, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubMetricType=ospfStubMetricType, ospfIfState=ospfIfState, AreaID=AreaID, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbType=ospfExtLsdbType, ospfBasicGroup2=ospfBasicGroup2, ospfStubTOS=ospfStubTOS, ospfBasicGroup=ospfBasicGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbAge=ospfExtLsdbAge, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, PYSNMP_MODULE_ID=ospf, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaAggregateEntry=ospfAreaAggregateEntry, Metric=Metric, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfEntry=ospfIfEntry, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, HelloRange=HelloRange, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfLsaCount=ospfIfLsaCount, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbTable=ospfAsLsdbTable, ospfInterArea=ospfInterArea, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAuthType=ospfAuthType, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaTable=ospfAreaTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfAsLsdbRouterId=ospfAsLsdbRouterId, PositiveInteger=PositiveInteger, ospfIfRtrPriority=ospfIfRtrPriority, ospfHostAreaID=ospfHostAreaID, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfLsdbAge=ospfLsdbAge, ospfDemandExtensions=ospfDemandExtensions, ospfNbrOptions=ospfNbrOptions, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaStatus=ospfAreaStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrEntry=ospfNbrEntry, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfGroup2=ospfIfGroup2, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrTable=ospfNbrTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfGroups=ospfGroups, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfCompliance=ospfCompliance, ospfIfAdminStat=ospfIfAdminStat, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfGeneralGroup=ospfGeneralGroup, ospfExternalType1=ospfExternalType1, ospfStubAreaId=ospfStubAreaId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfEntry=ospfVirtIfEntry, ospfExternalType2=ospfExternalType2, ospfStubMetric=ospfStubMetric, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfAuthType=ospfIfAuthType, ospfIfTable=ospfIfTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfType=ospfIfType, ospfRestartAge=ospfRestartAge, ospfIfMetricEntry=ospfIfMetricEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbType=ospfLsdbType, ospfRxNewLsas=ospfRxNewLsas, ospfIfIpAddress=ospfIfIpAddress, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrGroup=ospfNbrGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfStubAreaTable=ospfStubAreaTable, ospfHostTable=ospfHostTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor)
