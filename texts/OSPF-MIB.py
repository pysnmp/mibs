...
mibBuilder.exportSymbols("OSPF-MIB", PositiveInteger=PositiveInteger, ospfIfDemand=ospfIfDemand, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLsdbAge=ospfLsdbAge, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaStatus=ospfAreaStatus, ospfNbrGroup=ospfNbrGroup, ospfConformance=ospfConformance, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfRouteGroup=ospfRouteGroup, ospfTOSSupport=ospfTOSSupport, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfBasicGroup=ospfBasicGroup, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbSequence=ospfLsdbSequence, ospfIfEvents=ospfIfEvents, ospfIfLsaCount=ospfIfLsaCount, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, Status=Status, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, OspfAuthenticationType=OspfAuthenticationType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaEntry=ospfAreaEntry, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfBasicGroup2=ospfBasicGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrEntry=ospfNbrEntry, ospfHostAreaID=ospfHostAreaID, ospfExtLsdbType=ospfExtLsdbType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfNbrTable=ospfNbrTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfRestartAge=ospfRestartAge, ospfStubTOS=ospfStubTOS, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAdminStat=ospfAdminStat, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostEntry=ospfHostEntry, ospfLsdbTable=ospfLsdbTable, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAsLsdbType=ospfAsLsdbType, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfHostGroup2=ospfHostGroup2, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, RouterID=RouterID, ospfAuthType=ospfAuthType, ospfHostIpAddress=ospfHostIpAddress, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfType=ospfIfType, ospfNbrState=ospfNbrState, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfHostTable=ospfHostTable, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfAdminStat=ospfIfAdminStat, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostTOS=ospfHostTOS, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbGroup=ospfLsdbGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbLsid=ospfExtLsdbLsid, ospf=ospf, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfTable=ospfIfTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, PYSNMP_MODULE_ID=ospf, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLocalLsdbGroup=ospfLocalLsdbGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaRangeTable=ospfAreaRangeTable, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricValue=ospfIfMetricValue, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfRouterId=ospfRouterId, ospfVirtNbrTable=ospfVirtNbrTable, ospfRestartStatus=ospfRestartStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrArea=ospfVirtNbrArea, ospfStubStatus=ospfStubStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIntraArea=ospfIntraArea, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubMetric=ospfStubMetric, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrGroup2=ospfNbrGroup2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfRestartSupport=ospfRestartSupport, ospfSpfRuns=ospfSpfRuns, ospfIfAuthType=ospfIfAuthType, ospfAreaTable=ospfAreaTable, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfHostMetric=ospfHostMetric, ospfIfRetransInterval=ospfIfRetransInterval, ospfCompliance=ospfCompliance, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfImportAsExtern=ospfImportAsExtern, ospfIfState=ospfIfState, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfTransitDelay=ospfIfTransitDelay, ospfComplianceObsolete=ospfComplianceObsolete, ospfHostStatus=ospfHostStatus, ospfExternLsaCount=ospfExternLsaCount, ospfAreaRangeEntry=ospfAreaRangeEntry, Metric=Metric, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, AreaID=AreaID, ospfCompliance2=ospfCompliance2, ospfExternalType2=ospfExternalType2, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsaCount=ospfAsLsaCount, ospfAddressLessIf=ospfAddressLessIf, ospfHostGroup=ospfHostGroup, UpToMaxAge=UpToMaxAge, ospfRestartExitReason=ospfRestartExitReason, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfAreaId=ospfIfAreaId, ospfNbrRtrId=ospfNbrRtrId, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfPollInterval=ospfIfPollInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, HelloRange=HelloRange, ospfIfEntry=ospfIfEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLsdbLsid=ospfLsdbLsid, BigMetric=BigMetric, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRxNewLsas=ospfRxNewLsas, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfGeneralGroup=ospfGeneralGroup, ospfInterArea=ospfInterArea, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfStubAreaEntry=ospfStubAreaEntry, ospfLsdbType=ospfLsdbType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfObsoleteGroup=ospfObsoleteGroup, ospfDemandExtensions=ospfDemandExtensions, ospfExternalType1=ospfExternalType1, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaSummary=ospfAreaSummary, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfGroup2=ospfIfGroup2, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfStubAreaId=ospfStubAreaId, ospfAsLsdbTable=ospfAsLsdbTable, ospfCompliances=ospfCompliances, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfGroups=ospfGroups, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaId=ospfAreaId, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaRangeNet=ospfAreaRangeNet, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfStatus=ospfIfStatus, ospfIfIpAddress=ospfIfIpAddress, ospfRestartInterval=ospfRestartInterval, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfState=ospfVirtIfState, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubMetricType=ospfStubMetricType, TOSType=TOSType)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrState=ospfVirtNbrState)
