...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfStubMetric=ospfStubMetric, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfCompliance2=ospfCompliance2, ospfNbrEvents=ospfNbrEvents, Metric=Metric, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrState=ospfVirtNbrState, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbAge=ospfLsdbAge, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfAdminStat=ospfIfAdminStat, ospfHostIpAddress=ospfHostIpAddress, HelloRange=HelloRange, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrRtrId=ospfNbrRtrId, ospfLsdbSequence=ospfLsdbSequence, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfRestartAge=ospfRestartAge, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExternLsaCount=ospfExternLsaCount, ospfAreaEntry=ospfAreaEntry, ospfLsdbEntry=ospfLsdbEntry, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfEvents=ospfIfEvents, BigMetric=BigMetric, ospfAreaSummary=ospfAreaSummary, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfHostAreaID=ospfHostAreaID, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, PYSNMP_MODULE_ID=ospf, ospfIfEntry=ospfIfEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfRtrPriority=ospfIfRtrPriority, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLsdbLsid=ospfLsdbLsid, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAddressLessIf=ospfAddressLessIf, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfStubAreaId=ospfStubAreaId, ospfNbrTable=ospfNbrTable, ospfRestartSupport=ospfRestartSupport, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfMetricGroup=ospfIfMetricGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLsdbRouterId=ospfLsdbRouterId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfGeneralGroup=ospfGeneralGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfAuthKey=ospfIfAuthKey, ospfHostGroup=ospfHostGroup, ospfHostEntry=ospfHostEntry, ospfHostStatus=ospfHostStatus, ospfNbrGroup2=ospfNbrGroup2, ospfCompliance=ospfCompliance, ospfStubMetricType=ospfStubMetricType, ospf=ospf, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfState=ospfVirtIfState, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfRestartExitReason=ospfRestartExitReason, ospfRouterId=ospfRouterId, ospfAreaId=ospfAreaId, ospfConformance=ospfConformance, Status=Status, ospfHostMetric=ospfHostMetric, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAuthType=ospfAuthType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfGroups=ospfGroups, ospfAreaStatus=ospfAreaStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfType=ospfIfType, PositiveInteger=PositiveInteger, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsaCount=ospfAsLsaCount, ospfIfAreaId=ospfIfAreaId, ospfNbrGroup=ospfNbrGroup, UpToMaxAge=UpToMaxAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrState=ospfNbrState, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbTable=ospfLsdbTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaTable=ospfAreaTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfGroup=ospfIfGroup, ospfStubStatus=ospfStubStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfMetricTOS=ospfIfMetricTOS, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAdminStat=ospfAdminStat, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfExtLsdbType=ospfExtLsdbType, ospfNbrOptions=ospfNbrOptions, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExternalType2=ospfExternalType2, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfStubAreaTable=ospfStubAreaTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfInterArea=ospfInterArea, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfStubTOS=ospfStubTOS, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfTable=ospfIfTable, ospfIfGroup2=ospfIfGroup2, ospfHostTOS=ospfHostTOS, ospfAreaRangeNet=ospfAreaRangeNet, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfState=ospfIfState, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIntraArea=ospfIntraArea, ospfNbrPriority=ospfNbrPriority, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfDemandExtensions=ospfDemandExtensions, ospfRouteGroup=ospfRouteGroup, ospfIfStatus=ospfIfStatus, ospfBasicGroup2=ospfBasicGroup2, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfMetricTable=ospfIfMetricTable, ospfIfMetricValue=ospfIfMetricValue, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfImportAsExtern=ospfImportAsExtern, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfCompliances=ospfCompliances, ospfIfHelloInterval=ospfIfHelloInterval, ospfRxNewLsas=ospfRxNewLsas, TOSType=TOSType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfTransitDelay=ospfIfTransitDelay, ospfLsdbType=ospfLsdbType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfNbrEntry=ospfNbrEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfRFC1583Compatibility=ospfRFC1583Compatibility, RouterID=RouterID, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfSpfRuns=ospfSpfRuns, ospfAreaGroup=ospfAreaGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfPollInterval=ospfIfPollInterval, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsdbType=ospfAsLsdbType, AreaID=AreaID, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfBasicGroup=ospfBasicGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbGroup=ospfLsdbGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfIpAddress=ospfIfIpAddress, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfHostGroup2=ospfHostGroup2, ospfRestartInterval=ospfRestartInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfDemand=ospfIfDemand, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, OspfAuthenticationType=OspfAuthenticationType, ospfHostTable=ospfHostTable, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement)
mibBuilder.exportSymbols("OSPF-MIB", ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaRangeMask=ospfAreaRangeMask)
