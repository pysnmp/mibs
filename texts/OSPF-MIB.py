...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfTable=ospfIfTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, RouterID=RouterID, ospfAreaGroup=ospfAreaGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfRestartInterval=ospfRestartInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLsdbType=ospfLsdbType, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospf=ospf, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVersionNumber=ospfVersionNumber, ospfStubMetricType=ospfStubMetricType, ospfNbrPriority=ospfNbrPriority, ospfExternalType2=ospfExternalType2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsdbAge=ospfAsLsdbAge, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfGroup=ospfVirtIfGroup, BigMetric=BigMetric, ospfLsdbLsid=ospfLsdbLsid, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrGroup2=ospfNbrGroup2, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsdbTable=ospfAsLsdbTable, ospfTOSSupport=ospfTOSSupport, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfState=ospfVirtIfState, ospfConformance=ospfConformance, ospfCompliances=ospfCompliances, Status=Status, ospfBasicGroup2=ospfBasicGroup2, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfMetricTable=ospfIfMetricTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostMetric=ospfHostMetric, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfCompliance=ospfCompliance, ospfExternalType1=ospfExternalType1, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaRangeNet=ospfAreaRangeNet, ospfInterArea=ospfInterArea, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfLsaCount=ospfIfLsaCount, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaTable=ospfAreaTable, ospfStubTOS=ospfStubTOS, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfEvents=ospfIfEvents, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostEntry=ospfHostEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfStubAreaTable=ospfStubAreaTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfHostTable=ospfHostTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLsdbAreaId=ospfLsdbAreaId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLsdbGroup=ospfLsdbGroup, ospfIfAuthType=ospfIfAuthType, ospfStubStatus=ospfStubStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubAreaId=ospfStubAreaId, ospfLsdbAge=ospfLsdbAge, ospfStubMetric=ospfStubMetric, ospfIfAuthKey=ospfIfAuthKey, ospfAreaSummary=ospfAreaSummary, ospfRouteGroup=ospfRouteGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostAreaID=ospfHostAreaID, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfDemand=ospfIfDemand, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrState=ospfNbrState, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAuthType=ospfAuthType, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfHostGroup=ospfHostGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfAreaId=ospfIfAreaId, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfRxNewLsas=ospfRxNewLsas, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaEntry=ospfAreaEntry, ospfIfEntry=ospfIfEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfGroups=ospfGroups, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaStatus=ospfAreaStatus, ospfAdminStat=ospfAdminStat, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAsBdrRtrCount=ospfAsBdrRtrCount, HelloRange=HelloRange, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfNbrGroup=ospfNbrGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExternLsaCount=ospfExternLsaCount, ospfRestartSupport=ospfRestartSupport, ospfIfGroup2=ospfIfGroup2, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfPollInterval=ospfIfPollInterval, ospfHostGroup2=ospfHostGroup2, ospfLsdbChecksum=ospfLsdbChecksum, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfAdminStat=ospfIfAdminStat, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfState=ospfIfState, ospfAsLsdbType=ospfAsLsdbType, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrEvents=ospfNbrEvents, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaLsaCount=ospfAreaLsaCount, AreaID=AreaID, ospfLsdbTable=ospfLsdbTable, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfSpfRuns=ospfSpfRuns, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrState=ospfVirtNbrState, ospfCompliance2=ospfCompliance2, ospfNbrRtrId=ospfNbrRtrId, ospfHostTOS=ospfHostTOS, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfGroup=ospfIfGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfAuthType=ospfVirtIfAuthType, TOSType=TOSType, ospfAddressLessIf=ospfAddressLessIf, ospfAsLsaCount=ospfAsLsaCount, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrEvents=ospfVirtNbrEvents, DesignatedRouterPriority=DesignatedRouterPriority, ospfGeneralGroup=ospfGeneralGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, Metric=Metric, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostStatus=ospfHostStatus, ospfExtLsdbType=ospfExtLsdbType, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfRtrPriority=ospfIfRtrPriority, ospfRestartAge=ospfRestartAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIntraArea=ospfIntraArea, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfComplianceObsolete=ospfComplianceObsolete, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfType=ospfIfType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfIpAddress=ospfIfIpAddress, ospfHostIpAddress=ospfHostIpAddress, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfDemandExtensions=ospfDemandExtensions, ospfRestartExitReason=ospfRestartExitReason, ospfAreaId=ospfAreaId, PositiveInteger=PositiveInteger, ospfReferenceBandwidth=ospfReferenceBandwidth, PYSNMP_MODULE_ID=ospf, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLsdbSequence=ospfLsdbSequence, ospfIfStatus=ospfIfStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, UpToMaxAge=UpToMaxAge, ospfRestartStatus=ospfRestartStatus)
