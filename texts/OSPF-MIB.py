...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrOptions=ospfNbrOptions, ospfExternalType1=ospfExternalType1, ospfIfMetricValue=ospfIfMetricValue, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaEntry=ospfAreaEntry, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfObsoleteGroup=ospfObsoleteGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAdminStat=ospfAdminStat, ospfStubMetric=ospfStubMetric, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfAuthKey=ospfIfAuthKey, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRestartInterval=ospfRestartInterval, ospfHostAreaID=ospfHostAreaID, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbType=ospfExtLsdbType, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaSummary=ospfAreaSummary, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLsdbAdvertisement=ospfLsdbAdvertisement, Metric=Metric, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfState=ospfVirtIfState, ospfStubTOS=ospfStubTOS, ospfVirtIfEvents=ospfVirtIfEvents, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfHostEntry=ospfHostEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbrTable=ospfNbrTable, ospfIfTable=ospfIfTable, ospfHostTable=ospfHostTable, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaId=ospfAreaId, ospfLsdbType=ospfLsdbType, ospfStubStatus=ospfStubStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtNbrGroup2=ospfVirtNbrGroup2, HelloRange=HelloRange, ospfIfMetricStatus=ospfIfMetricStatus, ospfRestartStatus=ospfRestartStatus, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrArea=ospfVirtNbrArea, ospfRestartSupport=ospfRestartSupport, ospfLsdbEntry=ospfLsdbEntry, ospfAddressLessIf=ospfAddressLessIf, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfHostStatus=ospfHostStatus, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExternalType2=ospfExternalType2, ospfVirtIfAreaId=ospfVirtIfAreaId, RouterID=RouterID, ospfAreaGroup2=ospfAreaGroup2, ospfNbrGroup=ospfNbrGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCountTable=ospfAreaLsaCountTable, TOSType=TOSType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfStubAreaTable=ospfStubAreaTable, ospfIfGroup=ospfIfGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIntraArea=ospfIntraArea, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrEntry=ospfNbrEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, PYSNMP_MODULE_ID=ospf, ospfLsdbAreaId=ospfLsdbAreaId, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfComplianceObsolete=ospfComplianceObsolete, ospfExternLsaCount=ospfExternLsaCount, ospf=ospf, ospfHostTOS=ospfHostTOS, ospfLsdbTable=ospfLsdbTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExtLsdbTable=ospfExtLsdbTable, ospfSpfRuns=ospfSpfRuns, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfAreaId=ospfIfAreaId, ospfVirtNbrEvents=ospfVirtNbrEvents, AreaID=AreaID, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfMetricTOS=ospfIfMetricTOS, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaGroup=ospfAreaGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrGroup2=ospfNbrGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfGroups=ospfGroups, PositiveInteger=PositiveInteger, ospfRestartExitReason=ospfRestartExitReason, ospfIfStatus=ospfIfStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfRouterId=ospfRouterId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfHostIpAddress=ospfHostIpAddress, ospfIfType=ospfIfType, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfStatus=ospfVirtIfStatus, ospfStubAreaId=ospfStubAreaId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrEvents=ospfNbrEvents, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrPriority=ospfNbrPriority, UpToMaxAge=UpToMaxAge, ospfRestartAge=ospfRestartAge, ospfHostMetric=ospfHostMetric, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfRxNewLsas=ospfRxNewLsas, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfLsaCount=ospfIfLsaCount, BigMetric=BigMetric, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLsdbAge=ospfLsdbAge, ospfHostGroup2=ospfHostGroup2, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbAge=ospfExtLsdbAge, ospfImportAsExtern=ospfImportAsExtern, ospfLsdbRouterId=ospfLsdbRouterId, ospfStubAreaGroup=ospfStubAreaGroup, ospfAuthType=ospfAuthType, ospfMulticastExtensions=ospfMulticastExtensions, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsaCount=ospfAsLsaCount, OspfAuthenticationType=OspfAuthenticationType, ospfDemandExtensions=ospfDemandExtensions, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfCompliances=ospfCompliances, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfDemand=ospfIfDemand, ospfAreaStatus=ospfAreaStatus, ospfHostGroup=ospfHostGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfNbrState=ospfNbrState, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLsdbLsid=ospfLsdbLsid, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfPollInterval=ospfIfPollInterval, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfEvents=ospfIfEvents, ospfCompliance=ospfCompliance, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfBasicGroup=ospfBasicGroup, ospfTOSSupport=ospfTOSSupport, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfConformance=ospfConformance, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfMetricTable=ospfIfMetricTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfInterArea=ospfInterArea, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfRouteGroup=ospfRouteGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLocalLsdbSequence=ospfLocalLsdbSequence, Status=Status, ospfAreaTable=ospfAreaTable, ospfIfGroup2=ospfIfGroup2, ospfStubMetricType=ospfStubMetricType, ospfIfAdminStat=ospfIfAdminStat, ospfIfState=ospfIfState, ospfIfMetricEntry=ospfIfMetricEntry, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfEntry=ospfIfEntry, ospfVirtNbrState=ospfVirtNbrState, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfCompliance2=ospfCompliance2, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2)
mibBuilder.exportSymbols("OSPF-MIB", ospfVersionNumber=ospfVersionNumber, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaRangeEffect=ospfAreaRangeEffect)
