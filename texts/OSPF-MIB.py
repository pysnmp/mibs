...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfRetransInterval=ospfIfRetransInterval, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfHelloInterval=ospfIfHelloInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfTable=ospfIfTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLsdbRouterId=ospfLsdbRouterId, ospfLocalLsdbType=ospfLocalLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAdminStat=ospfAdminStat, AreaID=AreaID, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricTable=ospfIfMetricTable, ospfIfMetricValue=ospfIfMetricValue, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrOptions=ospfNbrOptions, ospfRestartExitReason=ospfRestartExitReason, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaSummary=ospfAreaSummary, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfBasicGroup2=ospfBasicGroup2, ospfMulticastExtensions=ospfMulticastExtensions, ospfRestartStatus=ospfRestartStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubTOS=ospfStubTOS, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, PositiveInteger=PositiveInteger, ospfHostStatus=ospfHostStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfAuthType=ospfIfAuthType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaTable=ospfAreaTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExternalType2=ospfExternalType2, ospfRxNewLsas=ospfRxNewLsas, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbrState=ospfNbrState, ospfLsdbLsid=ospfLsdbLsid, ospfIfType=ospfIfType, ospf=ospf, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAsLsdbAge=ospfAsLsdbAge, ospfHostTOS=ospfHostTOS, ospfHostAreaID=ospfHostAreaID, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfAdminStat=ospfIfAdminStat, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfAuthKey=ospfIfAuthKey, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtNbrArea=ospfVirtNbrArea, ospfSpfRuns=ospfSpfRuns, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfStubMetric=ospfStubMetric, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaGroup2=ospfAreaGroup2, ospfRestartAge=ospfRestartAge, ospfLsdbTable=ospfLsdbTable, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfTable=ospfVirtIfTable, ospfIfGroup2=ospfIfGroup2, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfExtLsdbType=ospfExtLsdbType, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaRangeEffect=ospfAreaRangeEffect, UpToMaxAge=UpToMaxAge, OspfAuthenticationType=OspfAuthenticationType, ospfNbrPriority=ospfNbrPriority, ospfIfMetricTOS=ospfIfMetricTOS, Status=Status, ospfIfRtrPriority=ospfIfRtrPriority, ospfExternalType1=ospfExternalType1, ospfRestartSupport=ospfRestartSupport, ospfIfStatus=ospfIfStatus, ospfImportAsExtern=ospfImportAsExtern, ospfIfState=ospfIfState, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLsdbAge=ospfLsdbAge, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfGroup=ospfIfGroup, BigMetric=BigMetric, ospfVirtNbrState=ospfVirtNbrState, ospfRouteGroup=ospfRouteGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostEntry=ospfHostEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaStatus=ospfAreaStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsLsdbType=ospfAsLsdbType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLsdbAreaId=ospfLsdbAreaId, RouterID=RouterID, ospfCompliance=ospfCompliance, ospfAreaGroup=ospfAreaGroup, ospfNbrGroup2=ospfNbrGroup2, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfState=ospfVirtIfState, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaRangeNet=ospfAreaRangeNet, ospfAsLsdbTable=ospfAsLsdbTable, ospfLsdbType=ospfLsdbType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLsdbChecksum=ospfLsdbChecksum, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfRestartInterval=ospfRestartInterval, HelloRange=HelloRange, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfEvents=ospfIfEvents, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrEvents=ospfNbrEvents, ospfIfEntry=ospfIfEntry, ospfIfDemand=ospfIfDemand, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIntraArea=ospfIntraArea, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfIpAddress=ospfIfIpAddress, ospfDemandExtensions=ospfDemandExtensions, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfAreaId=ospfIfAreaId, ospfStubAreaTable=ospfStubAreaTable, ospfStubStatus=ospfStubStatus, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaRangeTable=ospfAreaRangeTable, ospfExternLsaCount=ospfExternLsaCount, ospfAreaId=ospfAreaId, ospfInterArea=ospfInterArea, ospfTOSSupport=ospfTOSSupport, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbrEntry=ospfNbrEntry, ospfGroups=ospfGroups, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrGroup=ospfNbrGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfNbrIpAddr=ospfNbrIpAddr, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, TOSType=TOSType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfStubMetricType=ospfStubMetricType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfCompliances=ospfCompliances, ospfBasicGroup=ospfBasicGroup, ospfHostTable=ospfHostTable, ospfGeneralGroup=ospfGeneralGroup, ospfRouterId=ospfRouterId, ospfAuthType=ospfAuthType, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfEvents=ospfVirtIfEvents, ospfHostGroup=ospfHostGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfLsaCount=ospfIfLsaCount, PYSNMP_MODULE_ID=ospf, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaLsaCount=ospfAreaLsaCount, ospfHostMetric=ospfHostMetric, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVersionNumber=ospfVersionNumber, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, Metric=Metric, ospfCompliance2=ospfCompliance2, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfNbrTable=ospfNbrTable)
mibBuilder.exportSymbols("OSPF-MIB", ospfStubAreaId=ospfStubAreaId, ospfVirtIfGroup=ospfVirtIfGroup, ospfConformance=ospfConformance, ospfLsdbGroup=ospfLsdbGroup)
