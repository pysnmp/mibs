...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaId=ospfAreaId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLsdbType=ospfLsdbType, ospfDemandExtensions=ospfDemandExtensions, ospfNbrEntry=ospfNbrEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrRtrId=ospfNbrRtrId, ospfHostEntry=ospfHostEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfTOSSupport=ospfTOSSupport, ospfIfState=ospfIfState, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfHostMetric=ospfHostMetric, ospfAsLsdbType=ospfAsLsdbType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrTable=ospfNbrTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostStatus=ospfHostStatus, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaGroup2=ospfAreaGroup2, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaSummary=ospfAreaSummary, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfGroup=ospfIfGroup, ospfBasicGroup2=ospfBasicGroup2, ospfIfMetricStatus=ospfIfMetricStatus, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfStubAreaId=ospfStubAreaId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLsdbTable=ospfLsdbTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostIpAddress=ospfHostIpAddress, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfCompliance2=ospfCompliance2, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaRangeNet=ospfAreaRangeNet, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRestartSupport=ospfRestartSupport, ospfStubTOS=ospfStubTOS, ospfIfMetricValue=ospfIfMetricValue, ospfAreaTable=ospfAreaTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfRetransInterval=ospfIfRetransInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfTable=ospfVirtIfTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfState=ospfVirtIfState, ospfLsdbGroup=ospfLsdbGroup, PositiveInteger=PositiveInteger, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfGroup2=ospfIfGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfGeneralGroup=ospfGeneralGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfMetricTable=ospfIfMetricTable, ospfRouteGroup=ospfRouteGroup, ospfIfEvents=ospfIfEvents, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIntraArea=ospfIntraArea, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfRouterId=ospfRouterId, ospfRestartInterval=ospfRestartInterval, ospfAsLsaCount=ospfAsLsaCount, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfDemand=ospfIfDemand, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfCompliances=ospfCompliances, ospfGroups=ospfGroups, ospfExternalType1=ospfExternalType1, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfStatus=ospfIfStatus, ospfExternalType2=ospfExternalType2, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrState=ospfVirtNbrState, ospfIfLsaCksumSum=ospfIfLsaCksumSum, BigMetric=BigMetric, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfIpAddress=ospfIfIpAddress, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfConformance=ospfConformance, ospfLsdbLsid=ospfLsdbLsid, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfInterArea=ospfInterArea, Status=Status, HelloRange=HelloRange, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfOriginateNewLsas=ospfOriginateNewLsas, TOSType=TOSType, ospfStubMetric=ospfStubMetric, ospfIfPollInterval=ospfIfPollInterval, ospfIfAuthType=ospfIfAuthType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfMetricTOS=ospfIfMetricTOS, RouterID=RouterID, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfTable=ospfIfTable, ospfAreaEntry=ospfAreaEntry, ospfHostGroup=ospfHostGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAuthType=ospfAuthType, PYSNMP_MODULE_ID=ospf, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfMetricGroup=ospfIfMetricGroup, ospfRestartExitReason=ospfRestartExitReason, ospfHostGroup2=ospfHostGroup2, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbAge=ospfLsdbAge, ospfIfType=ospfIfType, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbChecksum=ospfLsdbChecksum, ospfStubAreaTable=ospfStubAreaTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbSequence=ospfLsdbSequence, Metric=Metric, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrGroup=ospfNbrGroup, ospfNbrGroup2=ospfNbrGroup2, ospfAsLsdbAge=ospfAsLsdbAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfHelloInterval=ospfIfHelloInterval, ospfAdminStat=ospfAdminStat, ospfStubStatus=ospfStubStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfExtLsdbType=ospfExtLsdbType, ospfAreaGroup=ospfAreaGroup, AreaID=AreaID, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricEntry=ospfIfMetricEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfStubMetricType=ospfStubMetricType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfHostTOS=ospfHostTOS, ospf=ospf, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, UpToMaxAge=UpToMaxAge, ospfIfAuthKey=ospfIfAuthKey, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrOptions=ospfNbrOptions, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaStatus=ospfAreaStatus, ospfImportAsExtern=ospfImportAsExtern, ospfHostTable=ospfHostTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrState=ospfNbrState, ospfRestartAge=ospfRestartAge, ospfLsdbAreaId=ospfLsdbAreaId, ospfSpfRuns=ospfSpfRuns, ospfCompliance=ospfCompliance, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfAreaId=ospfIfAreaId, ospfHostAreaID=ospfHostAreaID, ospfNbrPriority=ospfNbrPriority, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfRestartStatus=ospfRestartStatus, ospfIfEntry=ospfIfEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbType=ospfLocalLsdbType)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfBasicGroup=ospfBasicGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable)
