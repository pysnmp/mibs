...
mibBuilder.exportSymbols("OSPF-MIB", ospfCompliance2=ospfCompliance2, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfLsaCount=ospfIfLsaCount, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubMetricType=ospfStubMetricType, ospfIfPollInterval=ospfIfPollInterval, ospfNbrOptions=ospfNbrOptions, ospfExternLsaCount=ospfExternLsaCount, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVersionNumber=ospfVersionNumber, BigMetric=BigMetric, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfRestartAge=ospfRestartAge, ospfIfIpAddress=ospfIfIpAddress, ospfGroups=ospfGroups, ospfRestartInterval=ospfRestartInterval, ospfHostTable=ospfHostTable, ospfStubAreaGroup=ospfStubAreaGroup, Metric=Metric, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfRetransInterval=ospfIfRetransInterval, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfEvents=ospfVirtIfEvents, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrState=ospfNbrState, ospfCompliance=ospfCompliance, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfTable=ospfVirtIfTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfHostTOS=ospfHostTOS, ospfAreaEntry=ospfAreaEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfHostIpAddress=ospfHostIpAddress, ospfStubMetric=ospfStubMetric, ospfTOSSupport=ospfTOSSupport, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsaCount=ospfAsLsaCount, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAuthType=ospfAuthType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbrGroup=ospfNbrGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubTOS=ospfStubTOS, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfConformance=ospfConformance, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaSummary=ospfAreaSummary, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfStatus=ospfVirtIfStatus, ospfStubStatus=ospfStubStatus, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfInterArea=ospfInterArea, ospfHostGroup=ospfHostGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, PYSNMP_MODULE_ID=ospf, ospfAdminStat=ospfAdminStat, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfExtLsdbGroup=ospfExtLsdbGroup, ospf=ospf, ospfIfEvents=ospfIfEvents, ospfIfAreaId=ospfIfAreaId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfType=ospfIfType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfHostAreaID=ospfHostAreaID, ospfRouterId=ospfRouterId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaId=ospfAreaId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLsdbAge=ospfLsdbAge, ospfAreaGroup=ospfAreaGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfAdminStat=ospfIfAdminStat, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfMetricValue=ospfIfMetricValue, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfSpfRuns=ospfSpfRuns, ospfRestartSupport=ospfRestartSupport, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLsdbType=ospfLsdbType, ospfCompliances=ospfCompliances, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaGroup2=ospfAreaGroup2, ospfAsLsdbType=ospfAsLsdbType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfDemandExtensions=ospfDemandExtensions, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbAge=ospfAsLsdbAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfGroup=ospfIfGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrGroup2=ospfNbrGroup2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfState=ospfIfState, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrTable=ospfNbrTable, ospfAddressLessIf=ospfAddressLessIf, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfStatus=ospfIfStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, AreaID=AreaID, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfBasicGroup2=ospfBasicGroup2, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrState=ospfVirtNbrState, ospfRestartExitReason=ospfRestartExitReason, ospfIfMetricStatus=ospfIfMetricStatus, ospfIntraArea=ospfIntraArea, ospfRxNewLsas=ospfRxNewLsas, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfExternalType1=ospfExternalType1, ospfRouteGroup=ospfRouteGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrEntry=ospfNbrEntry, ospfExternalType2=ospfExternalType2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfEntry=ospfIfEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaStatus=ospfAreaStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfHelloInterval=ospfIfHelloInterval, PositiveInteger=PositiveInteger, ospfHostMetric=ospfHostMetric, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfImportAsExtern=ospfImportAsExtern, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostEntry=ospfHostEntry, ospfStubAreaId=ospfStubAreaId, ospfVirtIfState=ospfVirtIfState, ospfHostStatus=ospfHostStatus, ospfRestartStatus=ospfRestartStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfExtLsdbTable=ospfExtLsdbTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbType=ospfLocalLsdbType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtIfAuthKey=ospfVirtIfAuthKey, HelloRange=HelloRange, ospfAreaTable=ospfAreaTable, ospfIfDemand=ospfIfDemand, Status=Status, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfGroup2=ospfIfGroup2, RouterID=RouterID, ospfGeneralGroup=ospfGeneralGroup, ospfStubAreaTable=ospfStubAreaTable, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLsdbTable=ospfLsdbTable, ospfIfAuthType=ospfIfAuthType, ospfIfTable=ospfIfTable, ospfHostGroup2=ospfHostGroup2, TOSType=TOSType, ospfIfAuthKey=ospfIfAuthKey, ospfBasicGroup=ospfBasicGroup, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, UpToMaxAge=UpToMaxAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId)
mibBuilder.exportSymbols("OSPF-MIB", ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrOptions=ospfVirtNbrOptions)
