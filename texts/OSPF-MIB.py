...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfType=ospfIfType, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbLsid=ospfLsdbLsid, ospfIfEntry=ospfIfEntry, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrGroup2=ospfNbrGroup2, ospfExternalType2=ospfExternalType2, ospfInterArea=ospfInterArea, ospfAsLsdbAge=ospfAsLsdbAge, ospfRestartAge=ospfRestartAge, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfAdminStat=ospfIfAdminStat, Metric=Metric, ospfIfRetransInterval=ospfIfRetransInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfCompliance2=ospfCompliance2, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfComplianceObsolete=ospfComplianceObsolete, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfGeneralGroup=ospfGeneralGroup, ospfAuthType=ospfAuthType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfNbrEvents=ospfNbrEvents, ospfAsLsdbType=ospfAsLsdbType, ospfCompliances=ospfCompliances, ospfIntraArea=ospfIntraArea, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrEntry=ospfNbrEntry, ospfVirtIfTable=ospfVirtIfTable, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfGroup=ospfIfGroup, ospfHostGroup2=ospfHostGroup2, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfHostMetric=ospfHostMetric, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrGroup=ospfNbrGroup, ospfHostIpAddress=ospfHostIpAddress, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAddressLessIf=ospfAddressLessIf, ospfStubStatus=ospfStubStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbAge=ospfLsdbAge, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaGroup2=ospfAreaGroup2, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLsdbEntry=ospfLsdbEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubAreaGroup=ospfStubAreaGroup, ospfRestartInterval=ospfRestartInterval, ospfExternLsaCount=ospfExternLsaCount, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfState=ospfVirtIfState, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLsdbType=ospfLsdbType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, OspfAuthenticationType=OspfAuthenticationType, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfBasicGroup2=ospfBasicGroup2, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubMetricType=ospfStubMetricType, ospfIfTable=ospfIfTable, ospfVirtNbrState=ospfVirtNbrState, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfEntry=ospfVirtIfEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfSpfRuns=ospfSpfRuns, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfAuthKey=ospfIfAuthKey, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfAreaId=ospfIfAreaId, ospfAreaGroup=ospfAreaGroup, ospfConformance=ospfConformance, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostTOS=ospfHostTOS, ospfAdminStat=ospfAdminStat, ospfIfMetricTOS=ospfIfMetricTOS, ospfStubAreaTable=ospfStubAreaTable, ospfIfMetricValue=ospfIfMetricValue, ospfHostEntry=ospfHostEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrState=ospfNbrState, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfRouterId=ospfRouterId, ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsaCount=ospfAsLsaCount, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExtLsdbTable=ospfExtLsdbTable, ospfGroups=ospfGroups, ospfNbrPriority=ospfNbrPriority, ospfImportAsExtern=ospfImportAsExtern, ospfRestartStatus=ospfRestartStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaStatus=ospfAreaStatus, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaTable=ospfAreaTable, ospfLsdbTable=ospfLsdbTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfHostTable=ospfHostTable, ospfNbrOptions=ospfNbrOptions, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfStubMetric=ospfStubMetric, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfCompliance=ospfCompliance, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfHelloInterval=ospfIfHelloInterval, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfAuthType=ospfIfAuthType, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfState=ospfIfState, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfPollInterval=ospfIfPollInterval, ospfLsdbAreaId=ospfLsdbAreaId, ospfExternalType1=ospfExternalType1, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfHostGroup=ospfHostGroup, Status=Status, ospfTOSSupport=ospfTOSSupport, ospfStubTOS=ospfStubTOS, UpToMaxAge=UpToMaxAge, ospfRxNewLsas=ospfRxNewLsas, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubAreaId=ospfStubAreaId, PositiveInteger=PositiveInteger, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, RouterID=RouterID, ospfLocalLsdbSequence=ospfLocalLsdbSequence, HelloRange=HelloRange, ospfAreaEntry=ospfAreaEntry, ospfIfEvents=ospfIfEvents, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, TOSType=TOSType, ospfRouteGroup=ospfRouteGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfGroup2=ospfIfGroup2, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, BigMetric=BigMetric, ospfIfIpAddress=ospfIfIpAddress, ospfIfDemand=ospfIfDemand, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfBasicGroup=ospfBasicGroup, AreaID=AreaID, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfStatus=ospfIfStatus, PYSNMP_MODULE_ID=ospf, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaId=ospfAreaId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLsdbSequence=ospfLsdbSequence, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospf=ospf, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfHostStatus=ospfHostStatus, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVersionNumber=ospfVersionNumber, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbGroup=ospfLsdbGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaSummary=ospfAreaSummary, ospfAsLsdbRouterId=ospfAsLsdbRouterId)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostAreaID=ospfHostAreaID, ospfNbrTable=ospfNbrTable)
