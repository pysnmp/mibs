...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrPriority=ospfNbrPriority, ospfAreaStatus=ospfAreaStatus, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsdbType=ospfAsLsdbType, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfState=ospfVirtIfState, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrRtrId=ospfNbrRtrId, ospfGroups=ospfGroups, ospfStubAreaId=ospfStubAreaId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfRouterId=ospfRouterId, ospfIntraArea=ospfIntraArea, ospfAreaGroup2=ospfAreaGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfRouteGroup=ospfRouteGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfLsaCount=ospfIfLsaCount, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrEvents=ospfNbrEvents, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrGroup2=ospfNbrGroup2, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbGroup=ospfLsdbGroup, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbType=ospfExtLsdbType, ospfHostGroup2=ospfHostGroup2, ospfIfStatus=ospfIfStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbType=ospfLsdbType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfGroup2=ospfIfGroup2, Metric=Metric, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaEntry=ospfAreaEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfHostMetric=ospfHostMetric, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfEntry=ospfVirtIfEntry, PYSNMP_MODULE_ID=ospf, ospfVirtNbrArea=ospfVirtNbrArea, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfState=ospfIfState, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfCompliance=ospfCompliance, OspfAuthenticationType=OspfAuthenticationType, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrState=ospfVirtNbrState, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfMetricTable=ospfIfMetricTable, ospfExtLsdbTable=ospfExtLsdbTable, HelloRange=HelloRange, ospfVersionNumber=ospfVersionNumber, ospfStubMetricType=ospfStubMetricType, ospfConformance=ospfConformance, ospfIfMetricStatus=ospfIfMetricStatus, ospfRestartInterval=ospfRestartInterval, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfTable=ospfVirtIfTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfRestartSupport=ospfRestartSupport, ospfAdminStat=ospfAdminStat, ospfStubAreaTable=ospfStubAreaTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubTOS=ospfStubTOS, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLsdbChecksum=ospfLsdbChecksum, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfRestartStatus=ospfRestartStatus, ospf=ospf, ospfRestartAge=ospfRestartAge, ospfAsLsaCount=ospfAsLsaCount, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfEvents=ospfIfEvents, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfCompliance2=ospfCompliance2, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfHostAreaID=ospfHostAreaID, ospfGeneralGroup=ospfGeneralGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfEntry=ospfIfEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfTable=ospfIfTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbAge=ospfLsdbAge, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostGroup=ospfHostGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfAuthKey=ospfIfAuthKey, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfHostTable=ospfHostTable, ospfHostEntry=ospfHostEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrTable=ospfNbrTable, ospfBasicGroup2=ospfBasicGroup2, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfType=ospfIfType, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaTable=ospfAreaTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExternalType2=ospfExternalType2, ospfAsLsdbRouterId=ospfAsLsdbRouterId, BigMetric=BigMetric, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAuthType=ospfAuthType, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfBasicGroup=ospfBasicGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfLsaCount=ospfVirtIfLsaCount, AreaID=AreaID, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrGroup=ospfNbrGroup, ospfLsdbEntry=ospfLsdbEntry, ospfIfDemand=ospfIfDemand, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfPollInterval=ospfIfPollInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfAuthType=ospfIfAuthType, ospfNbrOptions=ospfNbrOptions, ospfLsdbTable=ospfLsdbTable, ospfHostStatus=ospfHostStatus, ospfCompliances=ospfCompliances, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfDemandExtensions=ospfDemandExtensions, ospfIfIpAddress=ospfIfIpAddress, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfGroup=ospfIfGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfAdminStat=ospfIfAdminStat, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostTOS=ospfHostTOS, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfStubMetric=ospfStubMetric, ospfAreaLsaCount=ospfAreaLsaCount, ospfInterArea=ospfInterArea, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, RouterID=RouterID, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrTable=ospfVirtNbrTable, TOSType=TOSType, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaId=ospfAreaId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRFC1583Compatibility=ospfRFC1583Compatibility, UpToMaxAge=UpToMaxAge, ospfExternalType1=ospfExternalType1, ospfAreaAggregateMask=ospfAreaAggregateMask, PositiveInteger=PositiveInteger, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfStubStatus=ospfStubStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbType=ospfLocalLsdbType, Status=Status, ospfRxNewLsas=ospfRxNewLsas, ospfIfMetricGroup=ospfIfMetricGroup, ospfTOSSupport=ospfTOSSupport, ospfAddressLessIf=ospfAddressLessIf, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaSummary=ospfAreaSummary, ospfSpfRuns=ospfSpfRuns, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfStatus=ospfVirtIfStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaGroup=ospfAreaGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRestartExitReason=ospfRestartExitReason, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbAreaId=ospfLsdbAreaId)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbLsid=ospfLsdbLsid, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval)
