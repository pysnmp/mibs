...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfTable=ospfIfTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbEntry=ospfExtLsdbEntry, PositiveInteger=PositiveInteger, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaStatus=ospfAreaStatus, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, HelloRange=HelloRange, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRestartAge=ospfRestartAge, ospfNbrGroup=ospfNbrGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbEntry=ospfAsLsdbEntry, Status=Status, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfAdminStat=ospfIfAdminStat, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfBasicGroup=ospfBasicGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfStatus=ospfIfStatus, ospfMulticastExtensions=ospfMulticastExtensions, ospfVersionNumber=ospfVersionNumber, ospfIfEvents=ospfIfEvents, ospfLsdbLsid=ospfLsdbLsid, ospfInterArea=ospfInterArea, ospfAreaEntry=ospfAreaEntry, ospfStubMetric=ospfStubMetric, ospfVirtIfAreaId=ospfVirtIfAreaId, Metric=Metric, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrTable=ospfNbrTable, ospfLsdbType=ospfLsdbType, ospfRestartStatus=ospfRestartStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, AreaID=AreaID, ospfExtLsdbTable=ospfExtLsdbTable, ospfExternLsaCount=ospfExternLsaCount, ospfBasicGroup2=ospfBasicGroup2, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, TOSType=TOSType, ospfIfType=ospfIfType, ospfAreaGroup2=ospfAreaGroup2, ospfStubRouterSupport=ospfStubRouterSupport, ospfCompliance=ospfCompliance, ospfHostGroup2=ospfHostGroup2, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfHostGroup=ospfHostGroup, ospfIfPollInterval=ospfIfPollInterval, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsaCount=ospfAsLsaCount, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfStubAreaTable=ospfStubAreaTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaId=ospfAreaId, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfMetricTable=ospfIfMetricTable, ospfNbrEvents=ospfNbrEvents, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfHostTable=ospfHostTable, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfGroup2=ospfIfGroup2, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfRestartSupport=ospfRestartSupport, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfDemand=ospfIfDemand, ospfTOSSupport=ospfTOSSupport, ospfAreaGroup=ospfAreaGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfCompliance2=ospfCompliance2, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, OspfAuthenticationType=OspfAuthenticationType, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostAreaID=ospfHostAreaID, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbTable=ospfLsdbTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfAuthType=ospfAuthType, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfExtLsdbGroup=ospfExtLsdbGroup, RouterID=RouterID, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfRetransInterval=ospfIfRetransInterval, ospfHostStatus=ospfHostStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfConformance=ospfConformance, ospfExtLsdbType=ospfExtLsdbType, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfRestartInterval=ospfRestartInterval, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaRangeNet=ospfAreaRangeNet, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, PYSNMP_MODULE_ID=ospf, ospfIfMetricValue=ospfIfMetricValue, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrOptions=ospfNbrOptions, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubAreaId=ospfStubAreaId, ospfVirtIfEntry=ospfVirtIfEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubStatus=ospfStubStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfHostMetric=ospfHostMetric, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfGroups=ospfGroups, ospfIfGroup=ospfIfGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfEntry=ospfIfEntry, ospfRouterId=ospfRouterId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospf=ospf, ospfNbrState=ospfNbrState, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaTable=ospfAreaTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfRouteGroup=ospfRouteGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtIfStatus=ospfVirtIfStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbAge=ospfLsdbAge, ospfVirtIfEvents=ospfVirtIfEvents, ospfRxNewLsas=ospfRxNewLsas, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfImportAsExtern=ospfImportAsExtern, ospfAsLsdbType=ospfAsLsdbType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrState=ospfVirtNbrState, UpToMaxAge=UpToMaxAge, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfAuthType=ospfIfAuthType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbGroup=ospfLsdbGroup, ospfVirtIfState=ospfVirtIfState, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIntraArea=ospfIntraArea, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAddressLessIf=ospfAddressLessIf, ospfAdminStat=ospfAdminStat, ospfIfAreaId=ospfIfAreaId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfHostTOS=ospfHostTOS, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrPriority=ospfNbrPriority, ospfIfLsaCount=ospfIfLsaCount, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExternalType1=ospfExternalType1, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubTOS=ospfStubTOS, ospfNbrEntry=ospfNbrEntry, ospfLsdbEntry=ospfLsdbEntry, ospfCompliances=ospfCompliances, BigMetric=BigMetric, ospfHostIpAddress=ospfHostIpAddress, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubMetricType=ospfStubMetricType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaSummary=ospfAreaSummary, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfState=ospfIfState, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfStubAreaGroup=ospfStubAreaGroup, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtIfTable=ospfVirtIfTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole)
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExternalType2=ospfExternalType2)
