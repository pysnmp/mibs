...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExtLsdbAge=ospfExtLsdbAge, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, AreaID=AreaID, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIntraArea=ospfIntraArea, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfInterArea=ospfInterArea, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfGroup=ospfIfGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfMetricGroup=ospfIfMetricGroup, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfAdminStat=ospfIfAdminStat, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExternLsaCount=ospfExternLsaCount, ospfHostTable=ospfHostTable, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrGroup=ospfNbrGroup, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, Status=Status, ospfHostGroup=ospfHostGroup, ospfRestartSupport=ospfRestartSupport, ospfIfGroup2=ospfIfGroup2, ospfAsLsaCount=ospfAsLsaCount, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrState=ospfVirtNbrState, ospfIfEntry=ospfIfEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfGeneralGroup=ospfGeneralGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrIpAddr=ospfNbrIpAddr, ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfEvents=ospfIfEvents, ospfVirtIfState=ospfVirtIfState, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfAreaId=ospfIfAreaId, ospfHostEntry=ospfHostEntry, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfDemandExtensions=ospfDemandExtensions, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfTOSSupport=ospfTOSSupport, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbLsid=ospfLsdbLsid, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospf=ospf, ospfLocalLsdbGroup=ospfLocalLsdbGroup, UpToMaxAge=UpToMaxAge, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaTable=ospfAreaTable, ospfRestartInterval=ospfRestartInterval, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfState=ospfIfState, ospfNbrState=ospfNbrState, ospfStubStatus=ospfStubStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAdminStat=ospfAdminStat, ospfStubAreaTable=ospfStubAreaTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfExtLsdbType=ospfExtLsdbType, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrRtrId=ospfNbrRtrId, ospfLsdbGroup=ospfLsdbGroup, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfStubTOS=ospfStubTOS, ospfHostStatus=ospfHostStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, PositiveInteger=PositiveInteger, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfBasicGroup2=ospfBasicGroup2, ospfNbrTable=ospfNbrTable, ospfAreaEntry=ospfAreaEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfCompliance2=ospfCompliance2, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfGroups=ospfGroups, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfRouterId=ospfRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, Metric=Metric, ospfVersionNumber=ospfVersionNumber, ospfConformance=ospfConformance, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfTable=ospfIfTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostIpAddress=ospfHostIpAddress, ospfIfAuthKey=ospfIfAuthKey, ospfIfAuthType=ospfIfAuthType, ospfIfMetricTable=ospfIfMetricTable, ospfIfMetricValue=ospfIfMetricValue, ospfIfStatus=ospfIfStatus, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfHostMetric=ospfHostMetric, ospfHostTOS=ospfHostTOS, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfPollInterval=ospfIfPollInterval, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaGroup2=ospfAreaGroup2, RouterID=RouterID, ospfAuthType=ospfAuthType, ospfIfDemand=ospfIfDemand, ospfVirtIfStatus=ospfVirtIfStatus, ospfBasicGroup=ospfBasicGroup, ospfIfType=ospfIfType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsdbTable=ospfAsLsdbTable, ospfStubMetric=ospfStubMetric, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrPriority=ospfNbrPriority, ospfCompliances=ospfCompliances, ospfCompliance=ospfCompliance, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaStatus=ospfAreaStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfImportAsExtern=ospfImportAsExtern, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExternalType1=ospfExternalType1, DesignatedRouterPriority=DesignatedRouterPriority, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrGroup2=ospfNbrGroup2, ospfHostAreaID=ospfHostAreaID, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfNbrEntry=ospfNbrEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbType=ospfLocalLsdbType, HelloRange=HelloRange, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfRxNewLsas=ospfRxNewLsas, ospfRestartStatus=ospfRestartStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbAge=ospfLsdbAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, TOSType=TOSType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfRestartAge=ospfRestartAge, ospfExternalType2=ospfExternalType2, ospfAreaId=ospfAreaId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubMetricType=ospfStubMetricType, PYSNMP_MODULE_ID=ospf, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbChecksum=ospfLsdbChecksum, ospfLsdbSequence=ospfLsdbSequence, ospfAddressLessIf=ospfAddressLessIf, ospfAreaSummary=ospfAreaSummary, ospfAreaGroup=ospfAreaGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, BigMetric=BigMetric, ospfAreaRangeEntry=ospfAreaRangeEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeNet=ospfAreaRangeNet, ospfLsdbRouterId=ospfLsdbRouterId, ospfLsdbType=ospfLsdbType, ospfExtLsdbEntry=ospfExtLsdbEntry)
