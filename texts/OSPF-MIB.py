...
mibBuilder.exportSymbols("OSPF-MIB", ospfSpfRuns=ospfSpfRuns, ospfIfPollInterval=ospfIfPollInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrArea=ospfVirtNbrArea, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfEntry=ospfIfEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, AreaID=AreaID, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfRouterId=ospfRouterId, ospfIfAuthKey=ospfIfAuthKey, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfAreaId=ospfIfAreaId, ospfNbrRtrId=ospfNbrRtrId, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbEntry=ospfLsdbEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAddressLessIf=ospfAddressLessIf, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, RouterID=RouterID, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAsLsdbType=ospfAsLsdbType, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfStubAreaTable=ospfStubAreaTable, ospfNbrEntry=ospfNbrEntry, BigMetric=BigMetric, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfExtLsdbType=ospfExtLsdbType, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfHostGroup2=ospfHostGroup2, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfStubMetricType=ospfStubMetricType, ospfCompliances=ospfCompliances, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfGroup2=ospfIfGroup2, ospfIfLsaCount=ospfIfLsaCount, ospfIfMetricValue=ospfIfMetricValue, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbTable=ospfExtLsdbTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrGroup2=ospfNbrGroup2, ospfAreaSummary=ospfAreaSummary, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfInterArea=ospfInterArea, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfHostMetric=ospfHostMetric, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrGroup=ospfNbrGroup, ospfImportAsExtern=ospfImportAsExtern, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfState=ospfVirtIfState, ospfExternalType1=ospfExternalType1, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfIpAddress=ospfIfIpAddress, ospfRestartSupport=ospfRestartSupport, ospfAuthType=ospfAuthType, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubStatus=ospfStubStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrState=ospfNbrState, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaId=ospfAreaId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfCompliance2=ospfCompliance2, ospfIntraArea=ospfIntraArea, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfMetricStatus=ospfIfMetricStatus, ospfGroups=ospfGroups, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRouteGroup=ospfRouteGroup, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLsdbGroup=ospfLsdbGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfHostStatus=ospfHostStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, UpToMaxAge=UpToMaxAge, ospfBasicGroup2=ospfBasicGroup2, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, TOSType=TOSType, ospfAreaEntry=ospfAreaEntry, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaStatus=ospfAreaStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsaCount=ospfAsLsaCount, ospfIfTable=ospfIfTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaGroup=ospfAreaGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfAuthType=ospfIfAuthType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfCompliance=ospfCompliance, ospfNbrOptions=ospfNbrOptions, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAdminStat=ospfAdminStat, ospfAreaTable=ospfAreaTable, PositiveInteger=PositiveInteger, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaRangeEffect=ospfAreaRangeEffect, Metric=Metric, ospfBasicGroup=ospfBasicGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLsdbType=ospfLsdbType, ospfStubRouterSupport=ospfStubRouterSupport, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAsLsdbTable=ospfAsLsdbTable, ospfRestartStatus=ospfRestartStatus, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfTable=ospfVirtIfTable, ospfRestartExitReason=ospfRestartExitReason, ospfHostGroup=ospfHostGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfGroup=ospfIfGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfExternalType2=ospfExternalType2, ospfStubTOS=ospfStubTOS, ospfNbrIpAddr=ospfNbrIpAddr, ospfHostIpAddress=ospfHostIpAddress, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbAge=ospfLsdbAge, ospfIfType=ospfIfType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubMetric=ospfStubMetric, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfVersionNumber=ospfVersionNumber, ospfIfState=ospfIfState, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfRestartInterval=ospfRestartInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospf=ospf, ospfDemandExtensions=ospfDemandExtensions, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfConformance=ospfConformance, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrState=ospfVirtNbrState, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfStatus=ospfIfStatus, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostEntry=ospfHostEntry, PYSNMP_MODULE_ID=ospf, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaRangeStatus=ospfAreaRangeStatus, OspfAuthenticationType=OspfAuthenticationType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfDemand=ospfIfDemand, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfTOSSupport=ospfTOSSupport, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfHostTOS=ospfHostTOS, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartAge=ospfRestartAge, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, HelloRange=HelloRange, ospfExternLsaCksumSum=ospfExternLsaCksumSum, Status=Status, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfEvents=ospfIfEvents)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLsdbLsid=ospfLsdbLsid, ospfHostTable=ospfHostTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2)
