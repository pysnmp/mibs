...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfState=ospfVirtIfState, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRouteGroup=ospfRouteGroup, ospfAddressLessIf=ospfAddressLessIf, ospfNbrGroup2=ospfNbrGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfConformance=ospfConformance, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaSummary=ospfAreaSummary, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbAge=ospfAsLsdbAge, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfCompliances=ospfCompliances, ospfIfEvents=ospfIfEvents, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLsdbSequence=ospfLsdbSequence, ospfLsdbType=ospfLsdbType, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfTOSSupport=ospfTOSSupport, ospfVirtIfEvents=ospfVirtIfEvents, Status=Status, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfGroups=ospfGroups, ospfNbrTable=ospfNbrTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfHostMetric=ospfHostMetric, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfStubStatus=ospfStubStatus, ospfStubMetricType=ospfStubMetricType, ospfIfTable=ospfIfTable, ospfHostAreaID=ospfHostAreaID, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfMetricValue=ospfIfMetricValue, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrRtrId=ospfNbrRtrId, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAsLsdbSequence=ospfAsLsdbSequence, TOSType=TOSType, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaGroup2=ospfAreaGroup2, ospf=ospf, ospfCompliance2=ospfCompliance2, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRestartInterval=ospfRestartInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfStubAreaId=ospfStubAreaId, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrEvents=ospfNbrEvents, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExternalType1=ospfExternalType1, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfDemandExtensions=ospfDemandExtensions, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaEntry=ospfAreaEntry, ospfBasicGroup2=ospfBasicGroup2, ospfRestartSupport=ospfRestartSupport, ospfHostGroup2=ospfHostGroup2, ospfIfEntry=ospfIfEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, HelloRange=HelloRange, ospfHostTOS=ospfHostTOS, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfIpAddress=ospfIfIpAddress, ospfIfAuthKey=ospfIfAuthKey, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfHostIpAddress=ospfHostIpAddress, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfGroup=ospfIfGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLocalLsdbGroup=ospfLocalLsdbGroup, DesignatedRouterPriority=DesignatedRouterPriority, PYSNMP_MODULE_ID=ospf, Metric=Metric, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRestartStatus=ospfRestartStatus, ospfAreaStatus=ospfAreaStatus, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaGroup=ospfAreaGroup, RouterID=RouterID, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLsdbAge=ospfLsdbAge, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaId=ospfAreaId, ospfIfAreaId=ospfIfAreaId, ospfAreaTable=ospfAreaTable, ospfIfGroup2=ospfIfGroup2, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfAuthType=ospfIfAuthType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfImportAsExtern=ospfImportAsExtern, ospfRestartAge=ospfRestartAge, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrGroup=ospfNbrGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, AreaID=AreaID, BigMetric=BigMetric, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfHostStatus=ospfHostStatus, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsaCount=ospfAsLsaCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, PositiveInteger=PositiveInteger, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfLsaCount=ospfIfLsaCount, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAdminStat=ospfAdminStat, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaLsaCount=ospfAreaLsaCount, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfTable=ospfVirtIfTable, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostTable=ospfHostTable, ospfAsLsdbType=ospfAsLsdbType, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfExternalType2=ospfExternalType2, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMetricGroup=ospfIfMetricGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfRxNewLsas=ospfRxNewLsas, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrState=ospfNbrState, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfHelloInterval=ospfIfHelloInterval, OspfAuthenticationType=OspfAuthenticationType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfStatus=ospfIfStatus, ospfIfType=ospfIfType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfHostEntry=ospfHostEntry, ospfAuthType=ospfAuthType, ospfLsdbTable=ospfLsdbTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfDemand=ospfIfDemand, ospfNbrEntry=ospfNbrEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfBasicGroup=ospfBasicGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrPriority=ospfNbrPriority, ospfGeneralGroup=ospfGeneralGroup, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLsdbGroup=ospfLsdbGroup, ospfInterArea=ospfInterArea, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfStubMetric=ospfStubMetric, ospfCompliance=ospfCompliance, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfExternLsaCount=ospfExternLsaCount, ospfRouterId=ospfRouterId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbEntry=ospfLsdbEntry, ospfIfState=ospfIfState, ospfHostGroup=ospfHostGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfStubTOS=ospfStubTOS, UpToMaxAge=UpToMaxAge)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIntraArea=ospfIntraArea, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfMetricStatus=ospfIfMetricStatus)
