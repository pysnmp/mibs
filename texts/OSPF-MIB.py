...
mibBuilder.exportSymbols("OSPF-MIB", ospfCompliances=ospfCompliances, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfAuthType=ospfIfAuthType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrTable=ospfNbrTable, ospfIfAuthKey=ospfIfAuthKey, ospfIfAreaId=ospfIfAreaId, ospfVirtIfState=ospfVirtIfState, ospfAreaRangeStatus=ospfAreaRangeStatus, UpToMaxAge=UpToMaxAge, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVersionNumber=ospfVersionNumber, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfMulticastExtensions=ospfMulticastExtensions, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfMetricValue=ospfIfMetricValue, ospfRestartInterval=ospfRestartInterval, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaId=ospfAreaId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaGroup=ospfAreaGroup, ospfExternalType1=ospfExternalType1, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfRestartExitReason=ospfRestartExitReason, ospfConformance=ospfConformance, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfEvents=ospfIfEvents, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfRestartStatus=ospfRestartStatus, TOSType=TOSType, ospfNbrGroup=ospfNbrGroup, ospfHostAreaID=ospfHostAreaID, ospfIfMetricGroup=ospfIfMetricGroup, ospfHostGroup=ospfHostGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfLsdbTable=ospfLsdbTable, ospfStubMetricType=ospfStubMetricType, ospfRestartSupport=ospfRestartSupport, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfType=ospfIfType, ospfIfStatus=ospfIfStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfBasicGroup=ospfBasicGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfState=ospfIfState, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbType=ospfAsLsdbType, ospfIntraArea=ospfIntraArea, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaAggregateEntry=ospfAreaAggregateEntry, PositiveInteger=PositiveInteger, PYSNMP_MODULE_ID=ospf, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfObsoleteGroup=ospfObsoleteGroup, ospfBasicGroup2=ospfBasicGroup2, ospfLsdbLsid=ospfLsdbLsid, RouterID=RouterID, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, OspfAuthenticationType=OspfAuthenticationType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrRtrId=ospfNbrRtrId, ospfNbrOptions=ospfNbrOptions, ospfRouterId=ospfRouterId, ospfStubAreaTable=ospfStubAreaTable, ospfStubTOS=ospfStubTOS, ospfNbrIpAddr=ospfNbrIpAddr, Status=Status, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfExternalType2=ospfExternalType2, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubStatus=ospfStubStatus, ospfRouteGroup=ospfRouteGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, AreaID=AreaID, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfMetricTable=ospfIfMetricTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAddressLessIf=ospfAddressLessIf, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbType=ospfLsdbType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfGroups=ospfGroups, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrState=ospfNbrState, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAuthType=ospfAuthType, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsaCount=ospfAsLsaCount, ospfIfEntry=ospfIfEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaTable=ospfAreaTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfHostTable=ospfHostTable, ospfInterArea=ospfInterArea, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfMetricEntry=ospfIfMetricEntry, ospfGeneralGroup=ospfGeneralGroup, ospfStubAreaId=ospfStubAreaId, ospfLsdbAge=ospfLsdbAge, ospfRestartAge=ospfRestartAge, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfImportAsExtern=ospfImportAsExtern, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrEntry=ospfNbrEntry, ospfIfDemand=ospfIfDemand, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfHostIpAddress=ospfHostIpAddress, ospfSpfRuns=ospfSpfRuns, ospfAdminStat=ospfAdminStat, ospfIfIpAddress=ospfIfIpAddress, ospfStubMetric=ospfStubMetric, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostGroup2=ospfHostGroup2, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaEntry=ospfAreaEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrGroup2=ospfNbrGroup2, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaStatus=ospfAreaStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfHostTOS=ospfHostTOS, Metric=Metric, ospfCompliance2=ospfCompliance2, ospfLsdbChecksum=ospfLsdbChecksum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfDemandExtensions=ospfDemandExtensions, ospfVirtNbrState=ospfVirtNbrState, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospf=ospf, ospfAreaSummary=ospfAreaSummary, ospfLsdbGroup=ospfLsdbGroup, ospfIfGroup=ospfIfGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfGroup2=ospfIfGroup2, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfHostMetric=ospfHostMetric, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfTable=ospfIfTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfCompliance=ospfCompliance, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfAdminStat=ospfIfAdminStat, BigMetric=BigMetric, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfLsaCount=ospfIfLsaCount, HelloRange=HelloRange, ospfHostStatus=ospfHostStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubAreaGroup=ospfStubAreaGroup, ospfTOSSupport=ospfTOSSupport)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbAge=ospfAsLsdbAge, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbType=ospfExtLsdbType, ospfNbrEvents=ospfNbrEvents)
