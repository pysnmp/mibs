...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfEntry=ospfIfEntry, ospfAsLsdbTable=ospfAsLsdbTable, HelloRange=HelloRange, ospfLsdbAge=ospfLsdbAge, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfStubRouterSupport=ospfStubRouterSupport, Status=Status, ospfIfDemand=ospfIfDemand, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLsdbRouterId=ospfLsdbRouterId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAsLsaCount=ospfAsLsaCount, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrArea=ospfVirtNbrArea, ospfHostStatus=ospfHostStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAdminStat=ospfAdminStat, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfHostMetric=ospfHostMetric, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubAreaTable=ospfStubAreaTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfTable=ospfIfTable, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExternalType1=ospfExternalType1, ospfNbrState=ospfNbrState, ospfStubAreaGroup=ospfStubAreaGroup, ospfCompliances=ospfCompliances, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLsdbTable=ospfLsdbTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfRouteGroup=ospfRouteGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrEvents=ospfNbrEvents, AreaID=AreaID, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaGroup=ospfAreaGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVersionNumber=ospfVersionNumber, ospfHostIpAddress=ospfHostIpAddress, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, RouterID=RouterID, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfInterArea=ospfInterArea, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfRestartStatus=ospfRestartStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, PYSNMP_MODULE_ID=ospf, ospfAreaId=ospfAreaId, ospfAreaRangeNet=ospfAreaRangeNet, ospfMulticastExtensions=ospfMulticastExtensions, ospfExtLsdbType=ospfExtLsdbType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfRestartInterval=ospfRestartInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfTable=ospfVirtIfTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfConformance=ospfConformance, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfState=ospfVirtIfState, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, PositiveInteger=PositiveInteger, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfBasicGroup=ospfBasicGroup, ospfGroups=ospfGroups, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbAge=ospfAsLsdbAge, ospfStubTOS=ospfStubTOS, BigMetric=BigMetric, ospfIfAreaId=ospfIfAreaId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfEvents=ospfIfEvents, ospfIfGroup2=ospfIfGroup2, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfStatus=ospfVirtIfStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfStubMetric=ospfStubMetric, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfGroup=ospfIfGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaGroup2=ospfAreaGroup2, ospfTOSSupport=ospfTOSSupport, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfHostGroup=ospfHostGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfHostEntry=ospfHostEntry, ospfHostAreaID=ospfHostAreaID, ospfStubMetricType=ospfStubMetricType, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfImportAsExtern=ospfImportAsExtern, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfPollInterval=ospfIfPollInterval, ospfIfAdminStat=ospfIfAdminStat, ospfAreaRangeTable=ospfAreaRangeTable, TOSType=TOSType, ospfCompliance2=ospfCompliance2, ospfAuthType=ospfAuthType, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfRtrPriority=ospfIfRtrPriority, ospfLsdbType=ospfLsdbType, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLsdbLsid=ospfLsdbLsid, ospfDemandExtensions=ospfDemandExtensions, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfAuthKey=ospfIfAuthKey, ospfLsdbGroup=ospfLsdbGroup, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfAuthType=ospfIfAuthType, UpToMaxAge=UpToMaxAge, ospfNbrEntry=ospfNbrEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfSpfRuns=ospfSpfRuns, OspfAuthenticationType=OspfAuthenticationType, ospfNbrOptions=ospfNbrOptions, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLsdbAreaId=ospfLsdbAreaId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrTable=ospfNbrTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaTable=ospfAreaTable, ospfIfStatus=ospfIfStatus, ospfAreaStatus=ospfAreaStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfMetricValue=ospfIfMetricValue, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaEntry=ospfAreaEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLsdbSequence=ospfLsdbSequence, ospfHostTable=ospfHostTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfStubStatus=ospfStubStatus, ospfAddressLessIf=ospfAddressLessIf, ospfAreaRangeStatus=ospfAreaRangeStatus, Metric=Metric, ospfAreaSummary=ospfAreaSummary, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostTOS=ospfHostTOS, ospfIfType=ospfIfType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfCompliance=ospfCompliance, ospf=ospf, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfBasicGroup2=ospfBasicGroup2, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrState=ospfVirtNbrState, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfLsaCount=ospfIfLsaCount, ospfHostGroup2=ospfHostGroup2, ospfRestartAge=ospfRestartAge, ospfNbrGroup=ospfNbrGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfRestartExitReason=ospfRestartExitReason, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfState=ospfIfState, ospfRouterId=ospfRouterId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExternalType2=ospfExternalType2, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum)
mibBuilder.exportSymbols("OSPF-MIB", ospfRxNewLsas=ospfRxNewLsas, ospfIntraArea=ospfIntraArea, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen)
