...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfGroup=ospfIfGroup, ospfHostStatus=ospfHostStatus, ospfIfMetricValue=ospfIfMetricValue, OspfAuthenticationType=OspfAuthenticationType, Status=Status, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfSpfRuns=ospfSpfRuns, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfStubAreaGroup=ospfStubAreaGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, Metric=Metric, ospfRestartAge=ospfRestartAge, ospfCompliance=ospfCompliance, ospfAreaGroup=ospfAreaGroup, ospfIfAuthKey=ospfIfAuthKey, ospfHostEntry=ospfHostEntry, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLsdbSequence=ospfLsdbSequence, ospfRestartSupport=ospfRestartSupport, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaStatus=ospfAreaStatus, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfBasicGroup2=ospfBasicGroup2, ospfRestartExitReason=ospfRestartExitReason, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfAreaId=ospfIfAreaId, ospfRestartStatus=ospfRestartStatus, ospfStubAreaTable=ospfStubAreaTable, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfStubMetric=ospfStubMetric, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, AreaID=AreaID, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIntraArea=ospfIntraArea, ospfCompliances=ospfCompliances, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrTable=ospfNbrTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAsLsaCount=ospfAsLsaCount, ospfLsdbGroup=ospfLsdbGroup, ospfRouterId=ospfRouterId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfGroup2=ospfIfGroup2, ospfGeneralGroup=ospfGeneralGroup, ospfAreaSummary=ospfAreaSummary, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfLsaCount=ospfIfLsaCount, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostGroup2=ospfHostGroup2, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfRxNewLsas=ospfRxNewLsas, ospfIfIpAddress=ospfIfIpAddress, ospfIfRtrPriority=ospfIfRtrPriority, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrEvents=ospfNbrEvents, ospfIfState=ospfIfState, ospfVirtIfState=ospfVirtIfState, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfHelloInterval=ospfIfHelloInterval, ospfVersionNumber=ospfVersionNumber, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubTOS=ospfStubTOS, ospfHostIpAddress=ospfHostIpAddress, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfEntry=ospfIfEntry, ospfExternalType1=ospfExternalType1, ospfHostTOS=ospfHostTOS, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfDemand=ospfIfDemand, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaRangeNet=ospfAreaRangeNet, PYSNMP_MODULE_ID=ospf, ospfNbrPriority=ospfNbrPriority, ospfHostTable=ospfHostTable, ospfIfTable=ospfIfTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfGroups=ospfGroups, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfHostMetric=ospfHostMetric, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfType=ospfIfType, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfConformance=ospfConformance, ospfIfMetricEntry=ospfIfMetricEntry, ospfLsdbEntry=ospfLsdbEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, RouterID=RouterID, ospfNbrEntry=ospfNbrEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, PositiveInteger=PositiveInteger, ospfAuthType=ospfAuthType, ospfIfMetricTOS=ospfIfMetricTOS, ospfTOSSupport=ospfTOSSupport, ospfHostAreaID=ospfHostAreaID, TOSType=TOSType, ospfCompliance2=ospfCompliance2, ospfStubAreaId=ospfStubAreaId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLsdbType=ospfLsdbType, ospfExtLsdbTable=ospfExtLsdbTable, ospfInterArea=ospfInterArea, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, BigMetric=BigMetric, ospfExternLsaCount=ospfExternLsaCount, ospfLsdbRouterId=ospfLsdbRouterId, HelloRange=HelloRange, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLsdbLsid=ospfLsdbLsid, ospfIfEvents=ospfIfEvents, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtNbrState=ospfVirtNbrState, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfAdminStat=ospfIfAdminStat, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricTable=ospfIfMetricTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrOptions=ospfNbrOptions, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaGroup2=ospfAreaGroup2, ospfHostGroup=ospfHostGroup, ospfStubStatus=ospfStubStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfRouteGroup=ospfRouteGroup, ospfNbrState=ospfNbrState, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrTable=ospfVirtNbrTable, ospf=ospf, ospfBasicGroup=ospfBasicGroup, ospfAdminStat=ospfAdminStat, ospfExternalType2=ospfExternalType2, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbAge=ospfLsdbAge, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfStubMetricType=ospfStubMetricType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaRangeMask=ospfAreaRangeMask, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, UpToMaxAge=UpToMaxAge, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfEntry=ospfVirtIfEntry, ospfAddressLessIf=ospfAddressLessIf, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbType=ospfExtLsdbType, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaTable=ospfAreaTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfImportAsExtern=ospfImportAsExtern, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaId=ospfAreaId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrGroup=ospfNbrGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfStatus=ospfIfStatus, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLsdbChecksum=ospfLsdbChecksum)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrEntry=ospfVirtNbrEntry)
