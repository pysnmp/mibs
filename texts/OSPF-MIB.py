...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeTable=ospfAreaRangeTable, ospfIntraArea=ospfIntraArea, ospfRestartInterval=ospfRestartInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbTable=ospfLsdbTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrState=ospfNbrState, ospfStubAreaId=ospfStubAreaId, ospfIfGroup=ospfIfGroup, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfStubMetric=ospfStubMetric, ospfIfLsaCount=ospfIfLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateEffect=ospfAreaAggregateEffect, Metric=Metric, BigMetric=BigMetric, ospfHostAreaID=ospfHostAreaID, ospfRestartAge=ospfRestartAge, ospfHostIpAddress=ospfHostIpAddress, ospfBasicGroup=ospfBasicGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, PYSNMP_MODULE_ID=ospf, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaEntry=ospfAreaEntry, ospfNbrPriority=ospfNbrPriority, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfExternalType2=ospfExternalType2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbAge=ospfLsdbAge, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfHostEntry=ospfHostEntry, ospfHostGroup=ospfHostGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfStubAreaGroup=ospfStubAreaGroup, ospfSpfRuns=ospfSpfRuns, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsaCount=ospfAsLsaCount, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, UpToMaxAge=UpToMaxAge, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfImportAsExtern=ospfImportAsExtern, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfIpAddress=ospfIfIpAddress, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfHostStatus=ospfHostStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfHostTable=ospfHostTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubStatus=ospfStubStatus, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospf=ospf, ospfMulticastExtensions=ospfMulticastExtensions, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfTOSSupport=ospfTOSSupport, ospfIfRtrPriority=ospfIfRtrPriority, ospfAddressLessIf=ospfAddressLessIf, ospfExternLsaCount=ospfExternLsaCount, ospfIfType=ospfIfType, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaGroup=ospfAreaGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaStatus=ospfAreaStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfTransitDelay=ospfIfTransitDelay, ospfHostTOS=ospfHostTOS, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfGroup=ospfVirtIfGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaTable=ospfAreaTable, ospfIfPollInterval=ospfIfPollInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartSupport=ospfRestartSupport, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfDemand=ospfIfDemand, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbType=ospfAsLsdbType, ospfIfTable=ospfIfTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfGroup2=ospfIfGroup2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfEvents=ospfIfEvents, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrGroup2=ospfNbrGroup2, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfDemandExtensions=ospfDemandExtensions, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbChecksum=ospfLsdbChecksum, ospfCompliance2=ospfCompliance2, ospfIfMetricStatus=ospfIfMetricStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrGroup=ospfNbrGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbTable=ospfExtLsdbTable, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfRouteGroup=ospfRouteGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, Status=Status, ospfVirtNbrState=ospfVirtNbrState, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfGroups=ospfGroups, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfHostGroup2=ospfHostGroup2, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLsdbLsid=ospfLsdbLsid, RouterID=RouterID, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfStatus=ospfIfStatus, ospfIfAreaId=ospfIfAreaId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfAdminStat=ospfIfAdminStat, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbEntry=ospfLsdbEntry, ospfIfState=ospfIfState, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAuthType=ospfAuthType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbEntry=ospfExtLsdbEntry, TOSType=TOSType, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaGroup2=ospfAreaGroup2, ospfStubTOS=ospfStubTOS, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrRtrId=ospfNbrRtrId, ospfCompliance=ospfCompliance, ospfStubMetricType=ospfStubMetricType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaSummary=ospfAreaSummary, ospfCompliances=ospfCompliances, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfComplianceObsolete=ospfComplianceObsolete, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfStubAreaTable=ospfStubAreaTable, ospfNbrTable=ospfNbrTable, ospfRestartStatus=ospfRestartStatus, ospfLsdbGroup=ospfLsdbGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfExternalType1=ospfExternalType1, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostMetric=ospfHostMetric, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfAuthType=ospfIfAuthType, ospfIfAuthKey=ospfIfAuthKey, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAdminStat=ospfAdminStat, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaId=ospfAreaId, HelloRange=HelloRange, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbRouterId=ospfLsdbRouterId, ospfNbrEntry=ospfNbrEntry, PositiveInteger=PositiveInteger, ospfConformance=ospfConformance, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfDiscontinuityTime=ospfDiscontinuityTime, OspfAuthenticationType=OspfAuthenticationType, AreaID=AreaID, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfEntry=ospfIfEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbType=ospfExtLsdbType, ospfNbrEvents=ospfNbrEvents, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus)
mibBuilder.exportSymbols("OSPF-MIB", ospfRouterId=ospfRouterId, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricValue=ospfIfMetricValue, ospfLsdbType=ospfLsdbType)
