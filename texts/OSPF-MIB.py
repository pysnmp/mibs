...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfHostMetric=ospfHostMetric, ospfSpfRuns=ospfSpfRuns, ospfIfIpAddress=ospfIfIpAddress, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, PositiveInteger=PositiveInteger, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfBasicGroup=ospfBasicGroup, ospfLsdbAge=ospfLsdbAge, ospfInterArea=ospfInterArea, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaRangeStatus=ospfAreaRangeStatus, AreaID=AreaID, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostGroup=ospfHostGroup, ospfAreaStatus=ospfAreaStatus, ospfNbrPriority=ospfNbrPriority, ospfAreaId=ospfAreaId, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfHostTable=ospfHostTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfTransitDelay=ospfIfTransitDelay, ospfLsdbTable=ospfLsdbTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfBasicGroup2=ospfBasicGroup2, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfStubStatus=ospfStubStatus, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfAuthType=ospfIfAuthType, ospfAreaGroup=ospfAreaGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfRestartStatus=ospfRestartStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostTOS=ospfHostTOS, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbAdvertisement=ospfLsdbAdvertisement, OspfAuthenticationType=OspfAuthenticationType, ospfCompliances=ospfCompliances, ospfLsdbEntry=ospfLsdbEntry, Status=Status, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLsdbGroup=ospfLsdbGroup, ospfRestartSupport=ospfRestartSupport, ospfIfAuthKey=ospfIfAuthKey, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrRtrId=ospfNbrRtrId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrState=ospfVirtNbrState, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaGroup2=ospfAreaGroup2, ospfIfType=ospfIfType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfTable=ospfVirtIfTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfPollInterval=ospfIfPollInterval, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaTable=ospfAreaTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, PYSNMP_MODULE_ID=ospf, ospfExtLsdbGroup=ospfExtLsdbGroup, TOSType=TOSType, ospfNbrTable=ospfNbrTable, ospfIfStatus=ospfIfStatus, ospfIntraArea=ospfIntraArea, ospfIfTable=ospfIfTable, ospfRestartInterval=ospfRestartInterval, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfRestartAge=ospfRestartAge, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfStubAreaTable=ospfStubAreaTable, ospfExternalType2=ospfExternalType2, ospfNbrEntry=ospfNbrEntry, RouterID=RouterID, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfNbrEvents=ospfNbrEvents, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfMetricTable=ospfIfMetricTable, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfState=ospfVirtIfState, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAdminStat=ospfAdminStat, Metric=Metric, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfState=ospfIfState, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfDemand=ospfIfDemand, ospfNbrGroup=ospfNbrGroup, ospfIfAdminStat=ospfIfAdminStat, ospfObsoleteGroup=ospfObsoleteGroup, ospfTOSSupport=ospfTOSSupport, BigMetric=BigMetric, ospfIfMetricStatus=ospfIfMetricStatus, ospfStubAreaId=ospfStubAreaId, ospfNbrState=ospfNbrState, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfEntry=ospfIfEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostGroup2=ospfHostGroup2, ospfHostStatus=ospfHostStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfGroup=ospfVirtIfGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLsdbType=ospfLsdbType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsaCount=ospfAsLsaCount, ospfRouterId=ospfRouterId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrGroup2=ospfNbrGroup2, ospfVersionNumber=ospfVersionNumber, ospfLsdbAreaId=ospfLsdbAreaId, ospfStubMetric=ospfStubMetric, ospfExternalType1=ospfExternalType1, ospfStubMetricType=ospfStubMetricType, ospf=ospf, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfRxNewLsas=ospfRxNewLsas, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAddressLessIf=ospfAddressLessIf, ospfConformance=ospfConformance, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfStubTOS=ospfStubTOS, ospfLsdbLsid=ospfLsdbLsid, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfHostEntry=ospfHostEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaSummary=ospfAreaSummary, HelloRange=HelloRange, ospfLsdbRouterId=ospfLsdbRouterId, ospfGroups=ospfGroups, ospfIfEvents=ospfIfEvents, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfMetricTOS=ospfIfMetricTOS, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLsdbSequence=ospfLsdbSequence, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfMetricValue=ospfIfMetricValue, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfGroup2=ospfIfGroup2, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, UpToMaxAge=UpToMaxAge, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAuthType=ospfAuthType, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfCompliance2=ospfCompliance2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaEntry=ospfAreaEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbAge=ospfAsLsdbAge, ospfCompliance=ospfCompliance, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExternLsaCount=ospfExternLsaCount)
