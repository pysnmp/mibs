...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbAge=ospfLocalLsdbAge, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostMetric=ospfHostMetric, ospfBasicGroup=ospfBasicGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrEvents=ospfNbrEvents, ospfStubAreaTable=ospfStubAreaTable, ospfConformance=ospfConformance, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLsdbEntry=ospfLsdbEntry, Metric=Metric, OspfAuthenticationType=OspfAuthenticationType, ospfLsdbType=ospfLsdbType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAdminStat=ospfAdminStat, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrTable=ospfNbrTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfRetransInterval=ospfIfRetransInterval, ospfExternalType2=ospfExternalType2, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfHostAreaID=ospfHostAreaID, BigMetric=BigMetric, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, RouterID=RouterID, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfEntry=ospfIfEntry, ospfIfType=ospfIfType, ospfBasicGroup2=ospfBasicGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, UpToMaxAge=UpToMaxAge, ospfIfTransitDelay=ospfIfTransitDelay, PositiveInteger=PositiveInteger, ospfImportAsExtern=ospfImportAsExtern, ospfIfLsaCount=ospfIfLsaCount, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfExternalType1=ospfExternalType1, ospfRouteGroup=ospfRouteGroup, ospfHostGroup2=ospfHostGroup2, ospfNbrGroup=ospfNbrGroup, ospfRestartAge=ospfRestartAge, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaId=ospfAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIntraArea=ospfIntraArea, ospfStubMetricType=ospfStubMetricType, HelloRange=HelloRange, ospfIfHelloInterval=ospfIfHelloInterval, ospfRestartInterval=ospfRestartInterval, ospfGeneralGroup=ospfGeneralGroup, ospfIfAuthType=ospfIfAuthType, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostStatus=ospfHostStatus, ospfVirtIfState=ospfVirtIfState, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAddressLessIf=ospfAddressLessIf, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfAreaId=ospfIfAreaId, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaStatus=ospfAreaStatus, ospfAreaSummary=ospfAreaSummary, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfStubStatus=ospfStubStatus, ospfIfIpAddress=ospfIfIpAddress, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLsdbAreaId=ospfLsdbAreaId, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfMetricTable=ospfIfMetricTable, ospfHostGroup=ospfHostGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, TOSType=TOSType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfTable=ospfIfTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAuthType=ospfAuthType, ospfLsdbGroup=ospfLsdbGroup, ospfStubTOS=ospfStubTOS, ospfVersionNumber=ospfVersionNumber, AreaID=AreaID, ospfSpfRuns=ospfSpfRuns, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfGroups=ospfGroups, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLsdbLsid=ospfLsdbLsid, ospfHostTOS=ospfHostTOS, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfCompliance2=ospfCompliance2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfAdminStat=ospfIfAdminStat, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAsLsaCount=ospfAsLsaCount, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrGroup2=ospfNbrGroup2, ospfIfGroup=ospfIfGroup, ospf=ospf, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfTable=ospfVirtIfTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaTable=ospfAreaTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubMetric=ospfStubMetric, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbAge=ospfLsdbAge, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfAsLsdbType=ospfAsLsdbType, ospfRxNewLsas=ospfRxNewLsas, ospfRestartSupport=ospfRestartSupport, ospfStubAreaId=ospfStubAreaId, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAsLsdbTable=ospfAsLsdbTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrState=ospfNbrState, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLsdbSequence=ospfLsdbSequence, PYSNMP_MODULE_ID=ospf, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfTOSSupport=ospfTOSSupport, ospfHostTable=ospfHostTable, ospfHostEntry=ospfHostEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfGroup2=ospfIfGroup2, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfAuthKey=ospfIfAuthKey, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfRestartStatus=ospfRestartStatus, ospfIfStatus=ospfIfStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfNbrEntry=ospfNbrEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExternLsaCount=ospfExternLsaCount, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricValue=ospfIfMetricValue, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfDemand=ospfIfDemand, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfDemandExtensions=ospfDemandExtensions, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaGroup2=ospfAreaGroup2, ospfCompliance=ospfCompliance, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfNbrRtrId=ospfNbrRtrId, ospfNbrPriority=ospfNbrPriority, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfMetricTOS=ospfIfMetricTOS, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfEvents=ospfIfEvents, ospfHostIpAddress=ospfHostIpAddress, ospfAreaEntry=ospfAreaEntry, ospfIfState=ospfIfState, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfCompliances=ospfCompliances, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, Status=Status, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaRangeMask=ospfAreaRangeMask, ospfInterArea=ospfInterArea, ospfLsdbTable=ospfLsdbTable)
