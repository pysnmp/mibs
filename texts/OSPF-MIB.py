...
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfGroup=ospfIfGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfRestartAge=ospfRestartAge, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbAdvertisement=ospfLsdbAdvertisement, HelloRange=HelloRange, ospfHostEntry=ospfHostEntry, ospfAreaStatus=ospfAreaStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfSpfRuns=ospfSpfRuns, ospfExternLsaCount=ospfExternLsaCount, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbChecksum=ospfLsdbChecksum, ospfRxNewLsas=ospfRxNewLsas, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospf=ospf, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVersionNumber=ospfVersionNumber, ospfIfEntry=ospfIfEntry, ospfBasicGroup=ospfBasicGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfTable=ospfVirtIfTable, ospfHostTable=ospfHostTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfGroups=ospfGroups, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIntraArea=ospfIntraArea, ospfExternalType1=ospfExternalType1, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRouterId=ospfRouterId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrOptions=ospfNbrOptions, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrState=ospfNbrState, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaGroup2=ospfAreaGroup2, ospfIfDemand=ospfIfDemand, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsaCount=ospfAsLsaCount, ospfHostTOS=ospfHostTOS, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubAreaTable=ospfStubAreaTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfStubMetric=ospfStubMetric, ospfCompliances=ospfCompliances, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostStatus=ospfHostStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfDemandExtensions=ospfDemandExtensions, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaSummary=ospfAreaSummary, ospfIfIpAddress=ospfIfIpAddress, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartExitReason=ospfRestartExitReason, ospfAreaId=ospfAreaId, ospfIfAuthKey=ospfIfAuthKey, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrEntry=ospfNbrEntry, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfGeneralGroup=ospfGeneralGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLsdbAge=ospfLsdbAge, ospfHostGroup=ospfHostGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfTable=ospfIfTable, ospfIfLsaCount=ospfIfLsaCount, ospfIfMetricStatus=ospfIfMetricStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfMetricValue=ospfIfMetricValue, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfCompliance2=ospfCompliance2, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbType=ospfExtLsdbType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfConformance=ospfConformance, AreaID=AreaID, ospfNbrEvents=ospfNbrEvents, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfCompliance=ospfCompliance, ospfIfGroup2=ospfIfGroup2, ospfNbrIpAddr=ospfNbrIpAddr, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbType=ospfAsLsdbType, ospfLsdbGroup=ospfLsdbGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrPriority=ospfNbrPriority, Status=Status, ospfAreaTable=ospfAreaTable, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfRestartInterval=ospfRestartInterval, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfEvents=ospfVirtIfEvents, Metric=Metric, ospfAdminStat=ospfAdminStat, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLsdbTable=ospfLsdbTable, ospfInterArea=ospfInterArea, ospfAreaAggregateTable=ospfAreaAggregateTable, BigMetric=BigMetric, ospfHostMetric=ospfHostMetric, ospfLsdbLsid=ospfLsdbLsid, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfStubStatus=ospfStubStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeEffect=ospfAreaRangeEffect, RouterID=RouterID, PYSNMP_MODULE_ID=ospf, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfAdminStat=ospfIfAdminStat, ospfNbrRtrId=ospfNbrRtrId, ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLsdbEntry=ospfLsdbEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfStubMetricType=ospfStubMetricType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, TOSType=TOSType, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtIfState=ospfVirtIfState, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfEntry=ospfVirtIfEntry, ospfStubAreaId=ospfStubAreaId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfMetricTable=ospfIfMetricTable, ospfHostGroup2=ospfHostGroup2, ospfNbrTable=ospfNbrTable, ospfAreaLsaCount=ospfAreaLsaCount, DesignatedRouterPriority=DesignatedRouterPriority, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLsdbType=ospfLsdbType, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfImportAsExtern=ospfImportAsExtern, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfTOSSupport=ospfTOSSupport, ospfAuthType=ospfAuthType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfState=ospfIfState, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfNbrGroup=ospfNbrGroup, ospfNbrGroup2=ospfNbrGroup2, ospfRestartSupport=ospfRestartSupport, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubTOS=ospfStubTOS, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrRtrId=ospfVirtNbrRtrId, PositiveInteger=PositiveInteger, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfType=ospfIfType, ospfIfEvents=ospfIfEvents, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfAreaId=ospfIfAreaId, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, UpToMaxAge=UpToMaxAge, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag)
mibBuilder.exportSymbols("OSPF-MIB", OspfAuthenticationType=OspfAuthenticationType, ospfBasicGroup2=ospfBasicGroup2, ospfIfPollInterval=ospfIfPollInterval, ospfIfStatus=ospfIfStatus)
