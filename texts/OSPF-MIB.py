...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfMetricValue=ospfIfMetricValue, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfMetricTable=ospfIfMetricTable, ospfAreaEntry=ospfAreaEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaStatus=ospfAreaStatus, ospfLsdbSequence=ospfLsdbSequence, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfGroup=ospfIfGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaTable=ospfAreaTable, ospfRestartSupport=ospfRestartSupport, TOSType=TOSType, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, PositiveInteger=PositiveInteger, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfDemandExtensions=ospfDemandExtensions, ospfAreaSummary=ospfAreaSummary, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVersionNumber=ospfVersionNumber, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfTOSSupport=ospfTOSSupport, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbType=ospfExtLsdbType, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostMetric=ospfHostMetric, ospfRestartAge=ospfRestartAge, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfRestartStatus=ospfRestartStatus, ospfAdminStat=ospfAdminStat, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfStatus=ospfVirtIfStatus, ospfStubMetricType=ospfStubMetricType, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfAdminStat=ospfIfAdminStat, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfGroup2=ospfIfGroup2, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrEvents=ospfNbrEvents, ospfRouteGroup=ospfRouteGroup, ospfBasicGroup=ospfBasicGroup, ospf=ospf, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbTable=ospfLsdbTable, ospfLsdbChecksum=ospfLsdbChecksum, ospfIntraArea=ospfIntraArea, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfSpfRuns=ospfSpfRuns, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfStubAreaId=ospfStubAreaId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, RouterID=RouterID, ospfNbrGroup=ospfNbrGroup, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfGroups=ospfGroups, BigMetric=BigMetric, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfHostAreaID=ospfHostAreaID, ospfIfAuthType=ospfIfAuthType, ospfHostTable=ospfHostTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, AreaID=AreaID, ospfIfMetricTOS=ospfIfMetricTOS, ospfConformance=ospfConformance, ospfAsLsdbTable=ospfAsLsdbTable, Status=Status, ospfHostGroup=ospfHostGroup, ospfExternalType1=ospfExternalType1, ospfNbrGroup2=ospfNbrGroup2, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbGroup=ospfLsdbGroup, PYSNMP_MODULE_ID=ospf, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaLsaCount=ospfAreaLsaCount, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfCompliance=ospfCompliance, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaId=ospfAreaId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrState=ospfNbrState, ospfHostGroup2=ospfHostGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfDemand=ospfIfDemand, ospfStubTOS=ospfStubTOS, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostStatus=ospfHostStatus, ospfCompliances=ospfCompliances, ospfAreaGroup2=ospfAreaGroup2, ospfRestartExitReason=ospfRestartExitReason, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfInterArea=ospfInterArea, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfState=ospfIfState, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfStatus=ospfIfStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfHostIpAddress=ospfHostIpAddress, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfHostTOS=ospfHostTOS, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrOptions=ospfNbrOptions, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAuthType=ospfAuthType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfTable=ospfIfTable, ospfIfAuthKey=ospfIfAuthKey, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrEntry=ospfNbrEntry, ospfAddressLessIf=ospfAddressLessIf, ospfCompliance2=ospfCompliance2, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfState=ospfVirtIfState, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartInterval=ospfRestartInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLsdbLsid=ospfLsdbLsid, HelloRange=HelloRange, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfLsaCount=ospfIfLsaCount, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrEvents=ospfVirtNbrEvents, UpToMaxAge=UpToMaxAge, ospfBasicGroup2=ospfBasicGroup2, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostEntry=ospfHostEntry, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfType=ospfIfType, ospfLsdbType=ospfLsdbType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLsdbAge=ospfLsdbAge, ospfStubMetric=ospfStubMetric, ospfRouterId=ospfRouterId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, OspfAuthenticationType=OspfAuthenticationType, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, Metric=Metric, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfPollInterval=ospfIfPollInterval, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsaCount=ospfAsLsaCount, ospfStubStatus=ospfStubStatus, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfGeneralGroup=ospfGeneralGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfEntry=ospfIfEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbEntry=ospfLsdbEntry, ospfNbrTable=ospfNbrTable, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbType=ospfAsLsdbType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfImportAsExtern=ospfImportAsExtern, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrState=ospfVirtNbrState)
mibBuilder.exportSymbols("OSPF-MIB", ospfComplianceObsolete=ospfComplianceObsolete, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence)
