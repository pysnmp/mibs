...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfTransitDelay=ospfIfTransitDelay, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLsdbType=ospfLsdbType, ospfLsdbGroup=ospfLsdbGroup, ospfConformance=ospfConformance, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrEntry=ospfNbrEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, TOSType=TOSType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfEvents=ospfIfEvents, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfCompliances=ospfCompliances, ospfTOSSupport=ospfTOSSupport, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIntraArea=ospfIntraArea, ospfIfMetricTable=ospfIfMetricTable, ospfIfRetransInterval=ospfIfRetransInterval, Status=Status, ospfAsLsdbTable=ospfAsLsdbTable, ospfVersionNumber=ospfVersionNumber, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExternalType2=ospfExternalType2, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubMetricType=ospfStubMetricType, ospfBasicGroup2=ospfBasicGroup2, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, HelloRange=HelloRange, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfRestartAge=ospfRestartAge, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, UpToMaxAge=UpToMaxAge, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAddressLessIf=ospfAddressLessIf, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfRouteGroup=ospfRouteGroup, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrState=ospfVirtNbrState, ospfAreaId=ospfAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRestartInterval=ospfRestartInterval, ospfAreaLsaCount=ospfAreaLsaCount, ospfHostMetric=ospfHostMetric, ospfRestartStatus=ospfRestartStatus, ospfIfAuthKey=ospfIfAuthKey, ospfHostEntry=ospfHostEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfHostGroup=ospfHostGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfHostGroup2=ospfHostGroup2, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfStatus=ospfIfStatus, ospfAsLsdbAge=ospfAsLsdbAge, ospfRouterId=ospfRouterId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbAge=ospfLsdbAge, ospfNbrState=ospfNbrState, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbRouterId=ospfAsLsdbRouterId, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfEntry=ospfVirtIfEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaTable=ospfAreaTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfTable=ospfVirtIfTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrGroup2=ospfNbrGroup2, ospfExtLsdbType=ospfExtLsdbType, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfCompliance2=ospfCompliance2, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfState=ospfVirtIfState, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfGeneralGroup=ospfGeneralGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrRtrId=ospfNbrRtrId, ospfNbrEvents=ospfNbrEvents, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLsdbEntry=ospfLsdbEntry, PYSNMP_MODULE_ID=ospf, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAuthType=ospfAuthType, ospfIfRtrPriority=ospfIfRtrPriority, ospfRestartSupport=ospfRestartSupport, ospfVirtIfAuthType=ospfVirtIfAuthType, ospf=ospf, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfSpfRuns=ospfSpfRuns, ospfLsdbTable=ospfLsdbTable, ospfIfAuthType=ospfIfAuthType, ospfLsdbLsid=ospfLsdbLsid, ospfIfAreaId=ospfIfAreaId, ospfIfDemand=ospfIfDemand, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfEntry=ospfIfEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaSummary=ospfAreaSummary, ospfIfType=ospfIfType, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfHostTable=ospfHostTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaStatus=ospfAreaStatus, ospfAreaEntry=ospfAreaEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrArea=ospfVirtNbrArea, ospfDemandExtensions=ospfDemandExtensions, ospfIfIpAddress=ospfIfIpAddress, ospfExternalType1=ospfExternalType1, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfState=ospfIfState, ospfIfGroup2=ospfIfGroup2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, AreaID=AreaID, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLsdbAreaId=ospfLsdbAreaId, ospfGroups=ospfGroups, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbType=ospfAsLsdbType, PositiveInteger=PositiveInteger, ospfCompliance=ospfCompliance, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfStubAreaId=ospfStubAreaId, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrOptions=ospfNbrOptions, ospfIfMetricEntry=ospfIfMetricEntry, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaGroup2=ospfAreaGroup2, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, Metric=Metric, ospfStubTOS=ospfStubTOS, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfMetricTOS=ospfIfMetricTOS, RouterID=RouterID, ospfIfMetricStatus=ospfIfMetricStatus, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaGroup=ospfAreaGroup, ospfIfTable=ospfIfTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAdminStat=ospfAdminStat, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfStubStatus=ospfStubStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtNbrTable=ospfVirtNbrTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrGroup=ospfNbrGroup, ospfHostStatus=ospfHostStatus, ospfHostAreaID=ospfHostAreaID, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostTOS=ospfHostTOS, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfGroup=ospfIfGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExternLsaCount=ospfExternLsaCount, ospfNbrTable=ospfNbrTable, ospfAsLsdbGroup=ospfAsLsdbGroup, BigMetric=BigMetric)
mibBuilder.exportSymbols("OSPF-MIB", ospfStubMetric=ospfStubMetric, ospfIfHelloInterval=ospfIfHelloInterval, OspfAuthenticationType=OspfAuthenticationType, ospfIfLsaCount=ospfIfLsaCount)
