...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExternLsaCount=ospfExternLsaCount, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfGroup=ospfIfGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfTable=ospfIfTable, ospf=ospf, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfRouterId=ospfRouterId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrRtrId=ospfNbrRtrId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfCompliance2=ospfCompliance2, ospfSpfRuns=ospfSpfRuns, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfEntry=ospfIfEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfStubMetric=ospfStubMetric, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubAreaId=ospfStubAreaId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaStatus=ospfAreaStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, TOSType=TOSType, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfExternalType1=ospfExternalType1, ospfAreaGroup2=ospfAreaGroup2, HelloRange=HelloRange, ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfTable=ospfVirtIfTable, ospfStubStatus=ospfStubStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbType=ospfLocalLsdbType, ospfLsdbType=ospfLsdbType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfStatus=ospfIfStatus, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaId=ospfAreaId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, AreaID=AreaID, ospfLsdbChecksum=ospfLsdbChecksum, ospfExternalType2=ospfExternalType2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfIpAddress=ospfIfIpAddress, ospfAsLsdbAge=ospfAsLsdbAge, OspfAuthenticationType=OspfAuthenticationType, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostEntry=ospfHostEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfInterArea=ospfInterArea, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbSequence=ospfAsLsdbSequence, PositiveInteger=PositiveInteger, ospfIfAreaId=ospfIfAreaId, ospfNbrTable=ospfNbrTable, ospfRestartSupport=ospfRestartSupport, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAddressLessIf=ospfAddressLessIf, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVersionNumber=ospfVersionNumber, ospfIfEvents=ospfIfEvents, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfDemand=ospfIfDemand, ospfIfType=ospfIfType, ospfIfState=ospfIfState, ospfStubAreaGroup=ospfStubAreaGroup, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeNet=ospfAreaRangeNet, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfHostStatus=ospfHostStatus, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrOptions=ospfNbrOptions, ospfStubMetricType=ospfStubMetricType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, UpToMaxAge=UpToMaxAge, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostGroup=ospfHostGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostTable=ospfHostTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfBasicGroup2=ospfBasicGroup2, ospfNbrState=ospfNbrState, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfMetricTOS=ospfIfMetricTOS, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfGeneralGroup=ospfGeneralGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, RouterID=RouterID, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfPollInterval=ospfIfPollInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfHostIpAddress=ospfHostIpAddress, ospfIfLsaCount=ospfIfLsaCount, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrArea=ospfVirtNbrArea, ospfRestartAge=ospfRestartAge, ospfLsdbGroup=ospfLsdbGroup, ospfDemandExtensions=ospfDemandExtensions, ospfIfAuthKey=ospfIfAuthKey, ospfCompliance=ospfCompliance, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubTOS=ospfStubTOS, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostGroup2=ospfHostGroup2, ospfTOSSupport=ospfTOSSupport, ospfHostMetric=ospfHostMetric, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAuthType=ospfAuthType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfGroups=ospfGroups, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLsdbTable=ospfLsdbTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfRestartExitReason=ospfRestartExitReason, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfNbrEvents=ospfNbrEvents, ospfIntraArea=ospfIntraArea, ospfCompliances=ospfCompliances, ospfAdminStat=ospfAdminStat, Status=Status, ospfHostAreaID=ospfHostAreaID, ospfIfGroup2=ospfIfGroup2, ospfHostTOS=ospfHostTOS, ospfAsLsaCount=ospfAsLsaCount, ospfLsdbAge=ospfLsdbAge, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaEntry=ospfAreaEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfRestartInterval=ospfRestartInterval, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsdbTable=ospfAsLsdbTable, BigMetric=BigMetric, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaSummary=ospfAreaSummary, ospfLsdbEntry=ospfLsdbEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfMetricTable=ospfIfMetricTable, ospfAreaTable=ospfAreaTable, ospfImportAsExtern=ospfImportAsExtern, ospfIfMetricValue=ospfIfMetricValue, ospfNbrEntry=ospfNbrEntry, ospfNbrPriority=ospfNbrPriority, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfConformance=ospfConformance, Metric=Metric, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfBasicGroup=ospfBasicGroup, ospfRxNewLsas=ospfRxNewLsas, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfLocalLsdbGroup=ospfLocalLsdbGroup, PYSNMP_MODULE_ID=ospf, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaRangeEntry=ospfAreaRangeEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaGroup=ospfAreaGroup, ospfVirtIfEntry=ospfVirtIfEntry)
