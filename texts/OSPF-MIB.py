...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, BigMetric=BigMetric, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfAdminStat=ospfIfAdminStat, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfCompliances=ospfCompliances, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, UpToMaxAge=UpToMaxAge, ospfRouterId=ospfRouterId, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaSummary=ospfAreaSummary, ospfExtLsdbType=ospfExtLsdbType, ospfSpfRuns=ospfSpfRuns, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfStatus=ospfIfStatus, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfBasicGroup2=ospfBasicGroup2, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfNbrGroup2=ospfNbrGroup2, ospfExternalType1=ospfExternalType1, ospfLsdbEntry=ospfLsdbEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubTOS=ospfStubTOS, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfGroups=ospfGroups, ospfIfLsaCount=ospfIfLsaCount, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfMetricValue=ospfIfMetricValue, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrPriority=ospfNbrPriority, ospfIfDemand=ospfIfDemand, ospfVirtNbrArea=ospfVirtNbrArea, ospfNbrEvents=ospfNbrEvents, ospfIntraArea=ospfIntraArea, ospfLsdbAreaId=ospfLsdbAreaId, PositiveInteger=PositiveInteger, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrTable=ospfVirtNbrTable, OspfAuthenticationType=OspfAuthenticationType, ospfGeneralGroup=ospfGeneralGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfConformance=ospfConformance, ospfBasicGroup=ospfBasicGroup, ospfIfGroup2=ospfIfGroup2, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLsdbGroup=ospfLsdbGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrState=ospfVirtNbrState, TOSType=TOSType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfRxNewLsas=ospfRxNewLsas, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaTable=ospfAreaTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaRangeNet=ospfAreaRangeNet, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfEntry=ospfIfEntry, ospfHostMetric=ospfHostMetric, ospfVirtNbrGroup=ospfVirtNbrGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfLsdbTable=ospfLsdbTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfInterArea=ospfInterArea, ospfAsLsdbType=ospfAsLsdbType, ospfLsdbRouterId=ospfLsdbRouterId, AreaID=AreaID, ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfTOSSupport=ospfTOSSupport, ospfAreaRangeMask=ospfAreaRangeMask, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfHostGroup2=ospfHostGroup2, ospfLsdbType=ospfLsdbType, ospfAdminStat=ospfAdminStat, ospfAuthType=ospfAuthType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubRouterSupport=ospfStubRouterSupport, ospfLsdbAge=ospfLsdbAge, ospfVirtIfState=ospfVirtIfState, ospfIfType=ospfIfType, ospfIfTable=ospfIfTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrRtrId=ospfNbrRtrId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaEntry=ospfAreaEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostGroup=ospfHostGroup, RouterID=RouterID, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfStubMetricType=ospfStubMetricType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaId=ospfAreaId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfState=ospfIfState, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRestartAge=ospfRestartAge, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, HelloRange=HelloRange, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, Metric=Metric, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsLsdbSequence=ospfAsLsdbSequence, ospf=ospf, ospfDemandExtensions=ospfDemandExtensions, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfEvents=ospfIfEvents, ospfAsLsaCount=ospfAsLsaCount, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfImportAsExtern=ospfImportAsExtern, ospfExternalType2=ospfExternalType2, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostTable=ospfHostTable, PYSNMP_MODULE_ID=ospf, ospfAreaGroup2=ospfAreaGroup2, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfCompliance2=ospfCompliance2, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfHostTOS=ospfHostTOS, ospfNbrState=ospfNbrState, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfAreaId=ospfIfAreaId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLsdbLsid=ospfLsdbLsid, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfStubAreaId=ospfStubAreaId, Status=Status, ospfIfMetricTable=ospfIfMetricTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfCompliance=ospfCompliance, ospfRestartSupport=ospfRestartSupport, ospfStubMetric=ospfStubMetric, ospfExtLsdbTable=ospfExtLsdbTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfHostStatus=ospfHostStatus, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfExternLsaCount=ospfExternLsaCount, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfStubStatus=ospfStubStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfHostIpAddress=ospfHostIpAddress, ospfIfIpAddress=ospfIfIpAddress, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfAuthType=ospfIfAuthType, ospfRestartExitReason=ospfRestartExitReason, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrOptions=ospfNbrOptions, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfHostEntry=ospfHostEntry, ospfAreaStatus=ospfAreaStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfRestartInterval=ospfRestartInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricEntry=ospfIfMetricEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfVersionNumber=ospfVersionNumber, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable)
