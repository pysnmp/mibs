...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfGroup2=ospfIfGroup2, ospfNbrOptions=ospfNbrOptions, ospfAreaGroup2=ospfAreaGroup2, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfTable=ospfIfTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrGroup2=ospfNbrGroup2, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrGroup2=ospfVirtNbrGroup2, RouterID=RouterID, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfAuthType=ospfIfAuthType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubMetric=ospfStubMetric, ospfInterArea=ospfInterArea, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfGroup=ospfIfGroup, ospfHostGroup2=ospfHostGroup2, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfIpAddress=ospfIfIpAddress, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfStatus=ospfVirtIfStatus, ospfLsdbGroup=ospfLsdbGroup, ospfTOSSupport=ospfTOSSupport, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExternalType1=ospfExternalType1, Status=Status, ospfAdminStat=ospfAdminStat, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfRestartStatus=ospfRestartStatus, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfExtLsdbType=ospfExtLsdbType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfGroups=ospfGroups, PositiveInteger=PositiveInteger, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaTable=ospfAreaTable, ospfLsdbSequence=ospfLsdbSequence, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, Metric=Metric, BigMetric=BigMetric, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfMetricValue=ospfIfMetricValue, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, HelloRange=HelloRange, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaEntry=ospfAreaEntry, ospfIfLsaCount=ospfIfLsaCount, ospfStubAreaTable=ospfStubAreaTable, ospfBasicGroup2=ospfBasicGroup2, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrTable=ospfNbrTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfStatus=ospfIfStatus, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfRestartInterval=ospfRestartInterval, ospfExternLsaCount=ospfExternLsaCount, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExternalType2=ospfExternalType2, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfHostTable=ospfHostTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfStubRouterSupport=ospfStubRouterSupport, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospf=ospf, ospfHostIpAddress=ospfHostIpAddress, DesignatedRouterPriority=DesignatedRouterPriority, ospfRouteGroup=ospfRouteGroup, ospfLsdbLsid=ospfLsdbLsid, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartExitReason=ospfRestartExitReason, ospfHostEntry=ospfHostEntry, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfGeneralGroup=ospfGeneralGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfState=ospfIfState, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, TOSType=TOSType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaStatus=ospfAreaStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfHostStatus=ospfHostStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaGroup=ospfAreaGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfSpfRuns=ospfSpfRuns, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbType=ospfLsdbType, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrRtrId=ospfNbrRtrId, ospfRxNewLsas=ospfRxNewLsas, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfState=ospfVirtIfState, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfHostGroup=ospfHostGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfCompliances=ospfCompliances, AreaID=AreaID, ospfNbrPriority=ospfNbrPriority, ospfCompliance2=ospfCompliance2, ospfIfRetransInterval=ospfIfRetransInterval, ospfStubStatus=ospfStubStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbTable=ospfExtLsdbTable, ospfConformance=ospfConformance, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostTOS=ospfHostTOS, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfCompliance=ospfCompliance, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfDemand=ospfIfDemand, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsBdrRtrCount=ospfAsBdrRtrCount, OspfAuthenticationType=OspfAuthenticationType, ospfHostMetric=ospfHostMetric, ospfComplianceObsolete=ospfComplianceObsolete, ospfIntraArea=ospfIntraArea, ospfStubTOS=ospfStubTOS, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfMetricEntry=ospfIfMetricEntry, ospfStubMetricType=ospfStubMetricType, ospfAreaId=ospfAreaId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfEntry=ospfIfEntry, ospfAreaRangeTable=ospfAreaRangeTable, PYSNMP_MODULE_ID=ospf, ospfNbrIpAddr=ospfNbrIpAddr, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrEvents=ospfNbrEvents, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaSummary=ospfAreaSummary, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, UpToMaxAge=UpToMaxAge, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfStubAreaGroup=ospfStubAreaGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVersionNumber=ospfVersionNumber, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfMetricGroup=ospfIfMetricGroup, ospfAddressLessIf=ospfAddressLessIf, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfBasicGroup=ospfBasicGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfHelloInterval=ospfIfHelloInterval, ospfLsdbAge=ospfLsdbAge, ospfIfPollInterval=ospfIfPollInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfType=ospfIfType, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAuthType=ospfAuthType, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfRestartAge=ospfRestartAge, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrState=ospfNbrState, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrEntry=ospfNbrEntry, ospfAsLsdbType=ospfAsLsdbType, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbEntry=ospfLsdbEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfRouterId=ospfRouterId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaRangeEntry=ospfAreaRangeEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfTable=ospfVirtIfTable, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbLsid=ospfExtLsdbLsid)
