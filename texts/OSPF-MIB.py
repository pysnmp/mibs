...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, OspfAuthenticationType=OspfAuthenticationType, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostStatus=ospfHostStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrRtrId=ospfNbrRtrId, ospfIfAuthKey=ospfIfAuthKey, ospfExtLsdbType=ospfExtLsdbType, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLsdbAdvertisement=ospfLsdbAdvertisement, RouterID=RouterID, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfHostGroup2=ospfHostGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfStubMetricType=ospfStubMetricType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, Status=Status, ospfHostMetric=ospfHostMetric, PositiveInteger=PositiveInteger, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfHostTable=ospfHostTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfDemandExtensions=ospfDemandExtensions, ospfConformance=ospfConformance, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfDemand=ospfIfDemand, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaTable=ospfAreaTable, ospfVirtNbrState=ospfVirtNbrState, ospfAreaGroup=ospfAreaGroup, ospfRestartStatus=ospfRestartStatus, ospfNbrPriority=ospfNbrPriority, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfPollInterval=ospfIfPollInterval, ospfIfGroup2=ospfIfGroup2, TOSType=TOSType, ospfHostAreaID=ospfHostAreaID, ospfInterArea=ospfInterArea, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfState=ospfVirtIfState, ospfIfLsaCount=ospfIfLsaCount, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfHostTOS=ospfHostTOS, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrTable=ospfNbrTable, ospfVirtIfGroup2=ospfVirtIfGroup2, ospf=ospf, ospfLsdbEntry=ospfLsdbEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfBasicGroup=ospfBasicGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrEvents=ospfNbrEvents, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLsdbChecksum=ospfLsdbChecksum, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfState=ospfIfState, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbAge=ospfAsLsdbAge, ospfVersionNumber=ospfVersionNumber, ospfRestartAge=ospfRestartAge, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrGroup=ospfVirtNbrGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfStubTOS=ospfStubTOS, ospfRouterId=ospfRouterId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfCompliance2=ospfCompliance2, ospfNbrGroup2=ospfNbrGroup2, ospfExternalType2=ospfExternalType2, PYSNMP_MODULE_ID=ospf, ospfIfMetricStatus=ospfIfMetricStatus, ospfRestartSupport=ospfRestartSupport, ospfIfAreaId=ospfIfAreaId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLocalLsdbType=ospfLocalLsdbType, ospfLsdbRouterId=ospfLsdbRouterId, AreaID=AreaID, ospfHostIpAddress=ospfHostIpAddress, ospfIfEntry=ospfIfEntry, ospfAreaStatus=ospfAreaStatus, ospfIfIpAddress=ospfIfIpAddress, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfExternLsaCount=ospfExternLsaCount, ospfIfTable=ospfIfTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfStubStatus=ospfStubStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMetricGroup=ospfIfMetricGroup, ospfExternalType1=ospfExternalType1, ospfAdminStat=ospfAdminStat, ospfHostGroup=ospfHostGroup, ospfIfStatus=ospfIfStatus, ospfRestartInterval=ospfRestartInterval, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, BigMetric=BigMetric, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfStubRouterSupport=ospfStubRouterSupport, ospfAuthType=ospfAuthType, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbType=ospfAsLsdbType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfTOSSupport=ospfTOSSupport, HelloRange=HelloRange, ospfNbrState=ospfNbrState, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbType=ospfLsdbType, ospfNbrOptions=ospfNbrOptions, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfGroups=ospfGroups, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLsdbAge=ospfLsdbAge, ospfIntraArea=ospfIntraArea, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbTable=ospfExtLsdbTable, ospfCompliance=ospfCompliance, ospfNbrGroup=ospfNbrGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaRangeMask=ospfAreaRangeMask, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaId=ospfAreaId, Metric=Metric, UpToMaxAge=UpToMaxAge, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfEvents=ospfIfEvents, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfAdminStat=ospfIfAdminStat, ospfAreaSummary=ospfAreaSummary, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubAreaTable=ospfStubAreaTable, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfMetricTOS=ospfIfMetricTOS, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfGeneralGroup=ospfGeneralGroup, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfType=ospfIfType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbTable=ospfLsdbTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostEntry=ospfHostEntry, ospfCompliances=ospfCompliances, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfGroup=ospfIfGroup, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfMulticastExtensions=ospfMulticastExtensions, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaGroup2=ospfAreaGroup2, ospfBasicGroup2=ospfBasicGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubMetric=ospfStubMetric, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfAuthType=ospfIfAuthType, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfAreaId=ospfVirtIfAreaId)
