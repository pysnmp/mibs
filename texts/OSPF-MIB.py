...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaGroup=ospfAreaGroup, ospfHostTable=ospfHostTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfHostGroup2=ospfHostGroup2, ospfIfState=ospfIfState, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfHostStatus=ospfHostStatus, ospfIfMetricEntry=ospfIfMetricEntry, AreaID=AreaID, ospfAreaEntry=ospfAreaEntry, ospfRestartSupport=ospfRestartSupport, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbLsid=ospfLsdbLsid, ospfStubAreaId=ospfStubAreaId, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbType=ospfLsdbType, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, TOSType=TOSType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrGroup2=ospfNbrGroup2, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfAdminStat=ospfIfAdminStat, PYSNMP_MODULE_ID=ospf, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfRestartInterval=ospfRestartInterval, ospfAreaTable=ospfAreaTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfGroup=ospfIfGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostEntry=ospfHostEntry, ospfStubMetric=ospfStubMetric, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostMetric=ospfHostMetric, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfRestartExitReason=ospfRestartExitReason, ospfVersionNumber=ospfVersionNumber, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfConformance=ospfConformance, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfRxNewLsas=ospfRxNewLsas, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfGeneralGroup=ospfGeneralGroup, ospfIfType=ospfIfType, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAsLsdbType=ospfAsLsdbType, ospfIfTable=ospfIfTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaSummary=ospfAreaSummary, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfMetricValue=ospfIfMetricValue, ospfAsLsaCount=ospfAsLsaCount, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAddressLessIf=ospfAddressLessIf, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrRtrId=ospfNbrRtrId, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbGroup=ospfLsdbGroup, ospfStubTOS=ospfStubTOS, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfTOSSupport=ospfTOSSupport, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, Metric=Metric, ospfAdminStat=ospfAdminStat, ospfNbrEntry=ospfNbrEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfBasicGroup=ospfBasicGroup, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfCompliance2=ospfCompliance2, ospfLsdbTable=ospfLsdbTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfGroup=ospfVirtIfGroup, ospfHostAreaID=ospfHostAreaID, ospfIntraArea=ospfIntraArea, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLsdbSequence=ospfLsdbSequence, ospfStubAreaTable=ospfStubAreaTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaStatus=ospfAreaStatus, ospfExternalType1=ospfExternalType1, ospfIfEvents=ospfIfEvents, ospfRestartStatus=ospfRestartStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaId=ospfAreaId, ospfIfStatus=ospfIfStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfAuthType=ospfVirtIfAuthType, RouterID=RouterID, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfEntry=ospfIfEntry, ospfInterArea=ospfInterArea, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfDemand=ospfIfDemand, ospfNbrState=ospfNbrState, HelloRange=HelloRange, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfRouterId=ospfRouterId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLsdbEntry=ospfLsdbEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, PositiveInteger=PositiveInteger, ospfDemandExtensions=ospfDemandExtensions, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbrTable=ospfNbrTable, ospfIfMetricTable=ospfIfMetricTable, ospfIfAuthKey=ospfIfAuthKey, ospfSpfRuns=ospfSpfRuns, ospfLsdbAge=ospfLsdbAge, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfIpAddress=ospfIfIpAddress, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrOptions=ospfNbrOptions, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExtLsdbType=ospfExtLsdbType, ospfGroups=ospfGroups, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfPollInterval=ospfIfPollInterval, ospfStubStatus=ospfStubStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfAreaId=ospfIfAreaId, ospfCompliances=ospfCompliances, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrPriority=ospfNbrPriority, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfStubMetricType=ospfStubMetricType, ospfImportAsExtern=ospfImportAsExtern, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfState=ospfVirtIfState, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLsdbRouterId=ospfLsdbRouterId, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfMetricGroup=ospfIfMetricGroup, ospfBasicGroup2=ospfBasicGroup2, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfComplianceObsolete=ospfComplianceObsolete, ospfExternLsaCount=ospfExternLsaCount, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfRestartAge=ospfRestartAge, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfCompliance=ospfCompliance, ospfHostGroup=ospfHostGroup, ospfIfGroup2=ospfIfGroup2, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostIpAddress=ospfHostIpAddress, UpToMaxAge=UpToMaxAge, BigMetric=BigMetric, ospfExtLsdbAge=ospfExtLsdbAge, ospf=ospf, ospfVirtIfTable=ospfVirtIfTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbRouterId=ospfExtLsdbRouterId)
mibBuilder.exportSymbols("OSPF-MIB", ospfAuthType=ospfAuthType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, Status=Status, ospfReferenceBandwidth=ospfReferenceBandwidth)
