...
mibBuilder.exportSymbols("OSPF-MIB", ospfImportAsExtern=ospfImportAsExtern, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExternLsaCount=ospfExternLsaCount, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLsdbAge=ospfLsdbAge, ospfIfAdminStat=ospfIfAdminStat, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubAreaTable=ospfStubAreaTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfInterArea=ospfInterArea, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfRestartAge=ospfRestartAge, ospfBasicGroup=ospfBasicGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaEntry=ospfAreaEntry, ospfIfGroup=ospfIfGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLsdbTable=ospfLsdbTable, ospfHostMetric=ospfHostMetric, ospfObsoleteGroup=ospfObsoleteGroup, ospf=ospf, ospfIfAuthType=ospfIfAuthType, ospfAsLsdbAge=ospfAsLsdbAge, OspfAuthenticationType=OspfAuthenticationType, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLsdbEntry=ospfLsdbEntry, ospfIfType=ospfIfType, ospfAdminStat=ospfAdminStat, ospfRouteGroup=ospfRouteGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfHostGroup=ospfHostGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfHostStatus=ospfHostStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfTable=ospfIfTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAsLsaCount=ospfAsLsaCount, ospfRxNewLsas=ospfRxNewLsas, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaLsaCount=ospfAreaLsaCount, PYSNMP_MODULE_ID=ospf, ospfExtLsdbAge=ospfExtLsdbAge, ospfExternalType1=ospfExternalType1, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExternalType2=ospfExternalType2, ospfGroups=ospfGroups, ospfHostTable=ospfHostTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfBasicGroup2=ospfBasicGroup2, ospfVersionNumber=ospfVersionNumber, ospfHostIpAddress=ospfHostIpAddress, TOSType=TOSType, ospfIfDemand=ospfIfDemand, ospfAsLsdbTable=ospfAsLsdbTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfHostTOS=ospfHostTOS, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, HelloRange=HelloRange, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfCompliance2=ospfCompliance2, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfGroup2=ospfIfGroup2, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrGroup=ospfNbrGroup, ospfIfState=ospfIfState, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfStatus=ospfIfStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbSequence=ospfLsdbSequence, ospfNbrIpAddr=ospfNbrIpAddr, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrEntry=ospfNbrEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfConformance=ospfConformance, ospfNbrState=ospfNbrState, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtNbrTable=ospfVirtNbrTable, ospfLsdbGroup=ospfLsdbGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaRangeGroup=ospfAreaRangeGroup, RouterID=RouterID, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfEntry=ospfIfEntry, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfDemandExtensions=ospfDemandExtensions, ospfIfMetricValue=ospfIfMetricValue, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfCompliances=ospfCompliances, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLsdbType=ospfLsdbType, ospfMulticastExtensions=ospfMulticastExtensions, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfRestartInterval=ospfRestartInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, BigMetric=BigMetric, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfEntry=ospfVirtIfEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrEvents=ospfNbrEvents, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfStubMetric=ospfStubMetric, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLocalLsdbAge=ospfLocalLsdbAge, Status=Status, ospfIfIpAddress=ospfIfIpAddress, ospfTOSSupport=ospfTOSSupport, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaGroup2=ospfAreaGroup2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfState=ospfVirtIfState, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfExtLsdbType=ospfExtLsdbType, ospfAreaSummary=ospfAreaSummary, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfMetricTOS=ospfIfMetricTOS, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaStatus=ospfAreaStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrTable=ospfNbrTable, ospfIntraArea=ospfIntraArea, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbrRtrId=ospfNbrRtrId, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAddressLessIf=ospfAddressLessIf, ospfAuthType=ospfAuthType, ospfAreaRangeNet=ospfAreaRangeNet, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfAuthKey=ospfIfAuthKey, ospfAreaTable=ospfAreaTable, Metric=Metric, ospfStubTOS=ospfStubTOS, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfStubMetricType=ospfStubMetricType, ospfAreaId=ospfAreaId, ospfGeneralGroup=ospfGeneralGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfCompliance=ospfCompliance, ospfHostAreaID=ospfHostAreaID, ospfNbrPriority=ospfNbrPriority, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfRouterId=ospfRouterId, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfTable=ospfVirtIfTable, ospfAreaAggregateMask=ospfAreaAggregateMask, UpToMaxAge=UpToMaxAge, ospfRestartStatus=ospfRestartStatus, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfPollInterval=ospfIfPollInterval, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, AreaID=AreaID, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateGroup=ospfAreaAggregateGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubRouterSupport=ospfStubRouterSupport, ospfSpfRuns=ospfSpfRuns, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfEvents=ospfIfEvents, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, PositiveInteger=PositiveInteger, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaGroup=ospfAreaGroup, ospfNbrGroup2=ospfNbrGroup2, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbLsid=ospfLsdbLsid)
mibBuilder.exportSymbols("OSPF-MIB", ospfHostEntry=ospfHostEntry, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfAreaId=ospfIfAreaId)
