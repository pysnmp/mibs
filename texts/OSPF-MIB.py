...
mibBuilder.exportSymbols("OSPF-MIB", ospfMulticastExtensions=ospfMulticastExtensions, ospfNbrOptions=ospfNbrOptions, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAuthType=ospfAuthType, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVersionNumber=ospfVersionNumber, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfRouteGroup=ospfRouteGroup, ospfLsdbTable=ospfLsdbTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfConformance=ospfConformance, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfGroups=ospfGroups, ospfBasicGroup=ospfBasicGroup, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfHostTOS=ospfHostTOS, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfHostStatus=ospfHostStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfAreaId=ospfIfAreaId, ospfImportAsExtern=ospfImportAsExtern, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtNbrState=ospfVirtNbrState, Status=Status, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrPriority=ospfNbrPriority, ospfExternalType2=ospfExternalType2, ospfDemandExtensions=ospfDemandExtensions, ospfVirtNbrTable=ospfVirtNbrTable, UpToMaxAge=UpToMaxAge, ospfHostIpAddress=ospfHostIpAddress, ospfBasicGroup2=ospfBasicGroup2, ospfIfEvents=ospfIfEvents, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfMetricTOS=ospfIfMetricTOS, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfNbrGroup=ospfNbrGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLsdbType=ospfLsdbType, ospfIfMetricTable=ospfIfMetricTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfHostEntry=ospfHostEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfCompliance=ospfCompliance, ospfLsdbGroup=ospfLsdbGroup, ospfTOSSupport=ospfTOSSupport, ospfRestartInterval=ospfRestartInterval, ospfStubMetricType=ospfStubMetricType, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfEntry=ospfIfEntry, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, HelloRange=HelloRange, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfCompliances=ospfCompliances, ospfAsLsaCount=ospfAsLsaCount, ospfIfLsaCount=ospfIfLsaCount, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfDemand=ospfIfDemand, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfGroup=ospfIfGroup, ospfNbrGroup2=ospfNbrGroup2, ospfAreaSummary=ospfAreaSummary, ospfIfAdminStat=ospfIfAdminStat, ospfLsdbAge=ospfLsdbAge, ospfNbrEvents=ospfNbrEvents, ospfObsoleteGroup=ospfObsoleteGroup, ospfHostGroup=ospfHostGroup, ospfSpfRuns=ospfSpfRuns, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaGroup2=ospfAreaGroup2, ospfNbrTable=ospfNbrTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, AreaID=AreaID, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfInterArea=ospfInterArea, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfPollInterval=ospfIfPollInterval, ospfIfGroup2=ospfIfGroup2, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubAreaTable=ospfStubAreaTable, RouterID=RouterID, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfStubTOS=ospfStubTOS, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfStubMetric=ospfStubMetric, ospfHostAreaID=ospfHostAreaID, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubAreaId=ospfStubAreaId, ospfIntraArea=ospfIntraArea, ospfHostGroup2=ospfHostGroup2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRestartAge=ospfRestartAge, TOSType=TOSType, ospfExtLsdbType=ospfExtLsdbType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrState=ospfNbrState, ospfExtLsdbLimit=ospfExtLsdbLimit, DesignatedRouterPriority=DesignatedRouterPriority, PositiveInteger=PositiveInteger, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, PYSNMP_MODULE_ID=ospf, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfHostMetric=ospfHostMetric, ospfVirtIfState=ospfVirtIfState, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfStatus=ospfVirtIfStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, BigMetric=BigMetric, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfRouterId=ospfRouterId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfMetricGroup=ospfIfMetricGroup, ospfRestartExitReason=ospfRestartExitReason, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfStatus=ospfIfStatus, ospfRxNewLsas=ospfRxNewLsas, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaStatus=ospfAreaStatus, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaRangeNet=ospfAreaRangeNet, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAddressLessIf=ospfAddressLessIf, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfTable=ospfIfTable, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostTable=ospfHostTable, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubStatus=ospfStubStatus, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfExternalType1=ospfExternalType1, ospfIfState=ospfIfState, ospfCompliance2=ospfCompliance2, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, Metric=Metric, ospfVirtIfEvents=ospfVirtIfEvents, ospf=ospf, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfRestartStatus=ospfRestartStatus, ospfNbrRtrId=ospfNbrRtrId, ospfIfMetricValue=ospfIfMetricValue, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbAge=ospfAsLsdbAge, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaEntry=ospfAreaEntry, ospfAreaId=ospfAreaId, ospfAreaGroup=ospfAreaGroup, ospfIfType=ospfIfType, ospfAsLsdbType=ospfAsLsdbType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaTable=ospfAreaTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbAreaId=ospfLsdbAreaId, ospfLsdbEntry=ospfLsdbEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAdminStat=ospfAdminStat, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbRouterId=ospfLsdbRouterId)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfExtLsdbAge=ospfExtLsdbAge)
