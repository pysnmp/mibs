...
mibBuilder.exportSymbols("OSPF-MIB", PYSNMP_MODULE_ID=ospf, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLsdbLsid=ospfLsdbLsid, ospfIfGroup=ospfIfGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaStatus=ospfAreaStatus, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfState=ospfIfState, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrState=ospfVirtNbrState, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbRouterId=ospfLsdbRouterId, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfPollInterval=ospfIfPollInterval, ospfIfMetricTOS=ospfIfMetricTOS, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfInterArea=ospfInterArea, ospfStubMetricType=ospfStubMetricType, ospfAreaGroup2=ospfAreaGroup2, ospfRestartSupport=ospfRestartSupport, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfDemand=ospfIfDemand, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbEntry=ospfLsdbEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, HelloRange=HelloRange, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubTOS=ospfStubTOS, ospfIfIpAddress=ospfIfIpAddress, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfSpfRuns=ospfSpfRuns, ospfRestartAge=ospfRestartAge, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrTable=ospfVirtNbrTable, ospfHostStatus=ospfHostStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExternalType1=ospfExternalType1, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfEvents=ospfIfEvents, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfImportAsExtern=ospfImportAsExtern, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfStubStatus=ospfStubStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostIpAddress=ospfHostIpAddress, ospfIfAreaId=ospfIfAreaId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaSummary=ospfAreaSummary, ospfIfType=ospfIfType, ospfExtLsdbType=ospfExtLsdbType, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExternLsaCount=ospfExternLsaCount, ospfExternalType2=ospfExternalType2, ospfCompliance2=ospfCompliance2, ospfAdminStat=ospfAdminStat, ospfAreaId=ospfAreaId, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfAdminStat=ospfIfAdminStat, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrGroup=ospfNbrGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfHostTOS=ospfHostTOS, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfHostAreaID=ospfHostAreaID, ospfIfAuthKey=ospfIfAuthKey, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAsLsdbAge=ospfAsLsdbAge, ospfCompliances=ospfCompliances, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaTable=ospfAreaTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfConformance=ospfConformance, ospfNbrGroup2=ospfNbrGroup2, TOSType=TOSType, Status=Status, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfGroup2=ospfIfGroup2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfStatus=ospfVirtIfStatus, ospfRxNewLsas=ospfRxNewLsas, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfStubAreaId=ospfStubAreaId, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAsLsaCount=ospfAsLsaCount, ospfHostTable=ospfHostTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbTable=ospfLsdbTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfRestartInterval=ospfRestartInterval, ospfIntraArea=ospfIntraArea, ospfVersionNumber=ospfVersionNumber, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfEntry=ospfIfEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExtLsdbEntry=ospfExtLsdbEntry, PositiveInteger=PositiveInteger, UpToMaxAge=UpToMaxAge, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfHostMetric=ospfHostMetric, ospfIfTable=ospfIfTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaGroup=ospfAreaGroup, ospfCompliance=ospfCompliance, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfStatus=ospfIfStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAuthType=ospfAuthType, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfDemandExtensions=ospfDemandExtensions, ospfLsdbType=ospfLsdbType, ospfHostEntry=ospfHostEntry, ospfStubAreaTable=ospfStubAreaTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAddressLessIf=ospfAddressLessIf, ospfNbrOptions=ospfNbrOptions, ospfStubMetric=ospfStubMetric, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbrState=ospfNbrState, OspfAuthenticationType=OspfAuthenticationType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, RouterID=RouterID, AreaID=AreaID, ospfVirtIfState=ospfVirtIfState, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfGeneralGroup=ospfGeneralGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfHostGroup=ospfHostGroup, BigMetric=BigMetric, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospf=ospf, ospfRouteGroup=ospfRouteGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfTable=ospfVirtIfTable, ospfIfMetricValue=ospfIfMetricValue, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfBasicGroup2=ospfBasicGroup2, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfLsaCount=ospfIfLsaCount, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfMetricTable=ospfIfMetricTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfRouterId=ospfRouterId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrTable=ospfNbrTable, ospfBasicGroup=ospfBasicGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfGroups=ospfGroups, Metric=Metric, ospfNbrEvents=ospfNbrEvents, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfAuthType=ospfIfAuthType, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfRestartStatus=ospfRestartStatus, ospfLsdbGroup=ospfLsdbGroup, ospfAsLsdbType=ospfAsLsdbType, ospfHostGroup2=ospfHostGroup2, ospfAreaEntry=ospfAreaEntry, ospfNbrPriority=ospfNbrPriority, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbAge=ospfLsdbAge, ospfLsdbSequence=ospfLsdbSequence, ospfNbrRtrId=ospfNbrRtrId)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum)
