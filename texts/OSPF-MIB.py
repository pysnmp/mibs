...
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbAge=ospfAsLsdbAge, ospfHostGroup=ospfHostGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfGroup2=ospfIfGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExtLsdbLimit=ospfExtLsdbLimit, RouterID=RouterID, HelloRange=HelloRange, ospfNbrEntry=ospfNbrEntry, ospfHostAreaID=ospfHostAreaID, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfBasicGroup=ospfBasicGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrOptions=ospfNbrOptions, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfNbrIpAddr=ospfNbrIpAddr, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfState=ospfIfState, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfExternLsaCount=ospfExternLsaCount, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfRxNewLsas=ospfRxNewLsas, ospfIfMetricValue=ospfIfMetricValue, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfGeneralGroup=ospfGeneralGroup, ospfIntraArea=ospfIntraArea, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaEntry=ospfAreaEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfDemandExtensions=ospfDemandExtensions, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfImportAsExtern=ospfImportAsExtern, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaGroup2=ospfAreaGroup2, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMetricStatus=ospfIfMetricStatus, PositiveInteger=PositiveInteger, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, Status=Status, ospfRouteGroup=ospfRouteGroup, UpToMaxAge=UpToMaxAge, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExternalType1=ospfExternalType1, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfHostStatus=ospfHostStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfCompliance=ospfCompliance, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubRouterSupport=ospfStubRouterSupport, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfStubAreaEntry=ospfStubAreaEntry, TOSType=TOSType, ospfHostTable=ospfHostTable, ospfVirtIfStatus=ospfVirtIfStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLsdbTable=ospfLsdbTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostGroup2=ospfHostGroup2, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubMetric=ospfStubMetric, ospfRestartAge=ospfRestartAge, ospfAddressLessIf=ospfAddressLessIf, ospfExternalType2=ospfExternalType2, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfConformance=ospfConformance, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLsdbEntry=ospfLsdbEntry, ospfAdminStat=ospfAdminStat, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeNet=ospfAreaRangeNet, ospfCompliance2=ospfCompliance2, ospfIfPollInterval=ospfIfPollInterval, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfEntry=ospfIfEntry, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaRangeTable=ospfAreaRangeTable, ospfStubStatus=ospfStubStatus, ospfCompliances=ospfCompliances, ospfIfLsaCount=ospfIfLsaCount, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubMetricType=ospfStubMetricType, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfRouterId=ospfRouterId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfType=ospfIfType, ospfIfDemand=ospfIfDemand, Metric=Metric, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrRtrId=ospfNbrRtrId, ospfIfAuthKey=ospfIfAuthKey, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfStatus=ospfIfStatus, ospfNbrState=ospfNbrState, ospfAreaTable=ospfAreaTable, ospfGroups=ospfGroups, ospfHostMetric=ospfHostMetric, ospfAreaId=ospfAreaId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfIpAddress=ospfIfIpAddress, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbTable=ospfExtLsdbTable, ospfRestartSupport=ospfRestartSupport, ospfAsLsdbType=ospfAsLsdbType, ospfAreaSummary=ospfAreaSummary, ospfLsdbLsid=ospfLsdbLsid, ospfIfMetricTable=ospfIfMetricTable, AreaID=AreaID, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbType=ospfExtLsdbType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfStubAreaId=ospfStubAreaId, ospfIfAdminStat=ospfIfAdminStat, ospfSpfRuns=ospfSpfRuns, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrPriority=ospfNbrPriority, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLsdbRouterId=ospfLsdbRouterId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfTOSSupport=ospfTOSSupport, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfInterArea=ospfInterArea, ospfIfMetricEntry=ospfIfMetricEntry, OspfAuthenticationType=OspfAuthenticationType, ospfAreaRangeEffect=ospfAreaRangeEffect, PYSNMP_MODULE_ID=ospf, ospfRestartStatus=ospfRestartStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostTOS=ospfHostTOS, ospf=ospf, BigMetric=BigMetric, ospfVirtIfTable=ospfVirtIfTable, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfRestartInterval=ospfRestartInterval, ospfNbrTable=ospfNbrTable, ospfAuthType=ospfAuthType, ospfVersionNumber=ospfVersionNumber, ospfAreaStatus=ospfAreaStatus, ospfIfTable=ospfIfTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrGroup=ospfNbrGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfState=ospfVirtIfState, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfAreaId=ospfIfAreaId, ospfNbrGroup2=ospfNbrGroup2, ospfStubTOS=ospfStubTOS, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRestartExitReason=ospfRestartExitReason, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLsdbType=ospfLsdbType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostEntry=ospfHostEntry, ospfIfGroup=ospfIfGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbAreaId=ospfLsdbAreaId, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLsdbAge=ospfLsdbAge, ospfAsLsaCksumSum=ospfAsLsaCksumSum)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId)
