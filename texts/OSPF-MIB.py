...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, RouterID=RouterID, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfState=ospfVirtIfState, ospfExternalType1=ospfExternalType1, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfHostTOS=ospfHostTOS, ospfCompliance2=ospfCompliance2, ospfStubAreaEntry=ospfStubAreaEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubAreaId=ospfStubAreaId, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrGroup=ospfNbrGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrIpAddr=ospfNbrIpAddr, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLsdbLsid=ospfLsdbLsid, ospfHostStatus=ospfHostStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfEntry=ospfVirtIfEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfGroup=ospfIfGroup, ospfIfRtrPriority=ospfIfRtrPriority, PositiveInteger=PositiveInteger, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLsdbGroup=ospfLsdbGroup, ospfExtLsdbType=ospfExtLsdbType, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfAuthKey=ospfIfAuthKey, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfHostEntry=ospfHostEntry, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfGroup2=ospfIfGroup2, ospfNbrGroup2=ospfNbrGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaTable=ospfAreaTable, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfImportAsExtern=ospfImportAsExtern, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, Status=Status, ospfRestartAge=ospfRestartAge, ospfLsdbChecksum=ospfLsdbChecksum, Metric=Metric, ospfAsLsaCount=ospfAsLsaCount, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbType=ospfLsdbType, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfStubMetric=ospfStubMetric, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfStubMetricType=ospfStubMetricType, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfState=ospfIfState, ospfIfIpAddress=ospfIfIpAddress, ospfRouterId=ospfRouterId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrOptions=ospfNbrOptions, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfCompliance=ospfCompliance, HelloRange=HelloRange, ospf=ospf, ospfStubStatus=ospfStubStatus, ospfLsdbAge=ospfLsdbAge, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfMetricGroup=ospfIfMetricGroup, OspfAuthenticationType=OspfAuthenticationType, ospfIfAreaId=ospfIfAreaId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfGeneralGroup=ospfGeneralGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfConformance=ospfConformance, ospfSpfRuns=ospfSpfRuns, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAddressLessIf=ospfAddressLessIf, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, PYSNMP_MODULE_ID=ospf, ospfIfDemand=ospfIfDemand, ospfIfAuthType=ospfIfAuthType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrEvents=ospfNbrEvents, ospfGroups=ospfGroups, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIntraArea=ospfIntraArea, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfInterArea=ospfInterArea, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrState=ospfVirtNbrState, ospfAreaStatus=ospfAreaStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, BigMetric=BigMetric, ospfAuthType=ospfAuthType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostMetric=ospfHostMetric, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfStubRouterSupport=ospfStubRouterSupport, ospfCompliances=ospfCompliances, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMetricTable=ospfIfMetricTable, AreaID=AreaID, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaGroup2=ospfAreaGroup2, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaId=ospfAreaId, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaGroup=ospfAreaGroup, ospfRestartInterval=ospfRestartInterval, ospfNbrTable=ospfNbrTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfNbrRtrId=ospfNbrRtrId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfComplianceObsolete=ospfComplianceObsolete, ospfTOSSupport=ospfTOSSupport, ospfAreaRangeMask=ospfAreaRangeMask, ospfAdminStat=ospfAdminStat, ospfIfStatus=ospfIfStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaSummary=ospfAreaSummary, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfEvents=ospfIfEvents, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrState=ospfNbrState, ospfVirtNbrArea=ospfVirtNbrArea, ospfRxNewLsas=ospfRxNewLsas, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfHostTable=ospfHostTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLsdbEntry=ospfLsdbEntry, UpToMaxAge=UpToMaxAge, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfStubAreaTable=ospfStubAreaTable, ospfIfType=ospfIfType, ospfVersionNumber=ospfVersionNumber, ospfNbrPriority=ospfNbrPriority, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfTable=ospfIfTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostAreaID=ospfHostAreaID, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfEntry=ospfIfEntry, ospfNbrEntry=ospfNbrEntry, ospfVirtIfGroup=ospfVirtIfGroup, ospfBasicGroup2=ospfBasicGroup2, ospfBasicGroup=ospfBasicGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfLsaCount=ospfIfLsaCount, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubTOS=ospfStubTOS, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartSupport=ospfRestartSupport, ospfExternalType2=ospfExternalType2, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLsdbTable=ospfLsdbTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfHostGroup=ospfHostGroup, TOSType=TOSType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2)
mibBuilder.exportSymbols("OSPF-MIB", ospfRestartStatus=ospfRestartStatus, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfTable=ospfVirtIfTable)
