...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfTable=ospfIfTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, PositiveInteger=PositiveInteger, ospfLsdbSequence=ospfLsdbSequence, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaEntry=ospfAreaEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExternLsaCount=ospfExternLsaCount, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfBasicGroup=ospfBasicGroup, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfDemand=ospfIfDemand, ospfAsBdrRtrCount=ospfAsBdrRtrCount, BigMetric=BigMetric, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLsdbChecksum=ospfLsdbChecksum, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfIpAddress=ospfIfIpAddress, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExtLsdbType=ospfExtLsdbType, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfAuthType=ospfIfAuthType, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostGroup2=ospfHostGroup2, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfStatus=ospfIfStatus, ospfNbrEntry=ospfNbrEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfStubTOS=ospfStubTOS, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfBasicGroup2=ospfBasicGroup2, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfDemandExtensions=ospfDemandExtensions, ospfHostMetric=ospfHostMetric, ospfAddressLessIf=ospfAddressLessIf, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLsdbEntry=ospfLsdbEntry, ospfNbrOptions=ospfNbrOptions, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaGroup=ospfAreaGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrRtrId=ospfNbrRtrId, ospfVersionNumber=ospfVersionNumber, ospfRxNewLsas=ospfRxNewLsas, ospfHostAreaID=ospfHostAreaID, OspfAuthenticationType=OspfAuthenticationType, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaStatus=ospfAreaStatus, ospfNbrState=ospfNbrState, ospfStubAreaGroup=ospfStubAreaGroup, ospfRestartSupport=ospfRestartSupport, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfNbrGroup2=ospfNbrGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, RouterID=RouterID, ospfStubAreaTable=ospfStubAreaTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfMetricValue=ospfIfMetricValue, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsdbAge=ospfAsLsdbAge, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaId=ospfAreaId, ospfIfType=ospfIfType, ospfHostEntry=ospfHostEntry, ospfHostTable=ospfHostTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCount=ospfAreaLsaCount, PYSNMP_MODULE_ID=ospf, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfCompliances=ospfCompliances, TOSType=TOSType, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfEntry=ospfIfEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAuthType=ospfAuthType, ospfStubMetric=ospfStubMetric, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfHelloInterval=ospfIfHelloInterval, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfConformance=ospfConformance, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaGroup2=ospfAreaGroup2, ospfInterArea=ospfInterArea, ospfIfGroup2=ospfIfGroup2, HelloRange=HelloRange, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbTable=ospfLsdbTable, ospfAsLsaCount=ospfAsLsaCount, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExternalType2=ospfExternalType2, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfGroups=ospfGroups, ospfLocalLsdbGroup=ospfLocalLsdbGroup, AreaID=AreaID, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfStatus=ospfVirtIfStatus, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaSummary=ospfAreaSummary, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRestartStatus=ospfRestartStatus, ospfCompliance=ospfCompliance, ospfLsdbAge=ospfLsdbAge, ospfNbrPriority=ospfNbrPriority, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbType=ospfAsLsdbType, ospfStubAreaId=ospfStubAreaId, ospfHostTOS=ospfHostTOS, Status=Status, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfHostStatus=ospfHostStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfStubStatus=ospfStubStatus, ospfIfAuthKey=ospfIfAuthKey, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfRouteGroup=ospfRouteGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfPollInterval=ospfIfPollInterval, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrGroup=ospfNbrGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbLsid=ospfLsdbLsid, ospfIfLsaCount=ospfIfLsaCount, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAdminStat=ospfAdminStat, Metric=Metric, UpToMaxAge=UpToMaxAge, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfCompliance2=ospfCompliance2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfHostIpAddress=ospfHostIpAddress, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfImportAsExtern=ospfImportAsExtern, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfTOSSupport=ospfTOSSupport, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfHostGroup=ospfHostGroup, ospfGeneralGroup=ospfGeneralGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfEvents=ospfIfEvents, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrEvents=ospfNbrEvents, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbType=ospfLocalLsdbType, ospfLsdbType=ospfLsdbType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfState=ospfIfState, ospfVirtNbrTable=ospfVirtNbrTable, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfRouterId=ospfRouterId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfStubMetricType=ospfStubMetricType, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfRestartExitReason=ospfRestartExitReason, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfSpfRuns=ospfSpfRuns, ospfNbrTable=ospfNbrTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfAreaId=ospfIfAreaId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRestartAge=ospfRestartAge, ospfAreaTable=ospfAreaTable, ospfVirtIfTable=ospfVirtIfTable, ospfIfGroup=ospfIfGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospf=ospf, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrGroup=ospfVirtNbrGroup)
