...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfDemand=ospfIfDemand, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfState=ospfIfState, OspfAuthenticationType=OspfAuthenticationType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfNbrState=ospfNbrState, ospfCompliance=ospfCompliance, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfRouteGroup=ospfRouteGroup, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfMetricValue=ospfIfMetricValue, ospfRestartAge=ospfRestartAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrRtrId=ospfNbrRtrId, ospfNbrOptions=ospfNbrOptions, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfGroup=ospfIfGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfAreaId=ospfIfAreaId, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrPriority=ospfNbrPriority, ospfIfIpAddress=ospfIfIpAddress, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfImportAsExtern=ospfImportAsExtern, ospfAreaRangeNet=ospfAreaRangeNet, BigMetric=BigMetric, ospfNbrTable=ospfNbrTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAdminStat=ospfAdminStat, ospfIfType=ospfIfType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbType=ospfExtLsdbType, ospfVirtIfStatus=ospfVirtIfStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaTable=ospfAreaTable, UpToMaxAge=UpToMaxAge, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfTable=ospfVirtIfTable, ospfLsdbSequence=ospfLsdbSequence, ospfLsdbGroup=ospfLsdbGroup, ospfNbrGroup=ospfNbrGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfCompliances=ospfCompliances, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, TOSType=TOSType, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrTable=ospfVirtNbrTable, ospfLsdbEntry=ospfLsdbEntry, ospfTOSSupport=ospfTOSSupport, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaEntry=ospfAreaEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfStatus=ospfIfStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfExternalType2=ospfExternalType2, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubMetric=ospfStubMetric, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfGroup2=ospfIfGroup2, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbTable=ospfLsdbTable, ospfLsdbLsid=ospfLsdbLsid, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtNbrState=ospfVirtNbrState, ospfMulticastExtensions=ospfMulticastExtensions, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLsdbType=ospfLsdbType, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfLsaCount=ospfIfLsaCount, ospfHostIpAddress=ospfHostIpAddress, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLsdbAge=ospfLsdbAge, ospfVersionNumber=ospfVersionNumber, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfTable=ospfIfTable, ospfIfAuthKey=ospfIfAuthKey, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, PYSNMP_MODULE_ID=ospf, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLsdbRouterId=ospfLsdbRouterId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaStatus=ospfAreaStatus, ospfHostTOS=ospfHostTOS, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostEntry=ospfHostEntry, ospfAreaId=ospfAreaId, ospfGeneralGroup=ospfGeneralGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfEntry=ospfIfEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfBasicGroup2=ospfBasicGroup2, ospfIfMetricTable=ospfIfMetricTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaRangeTable=ospfAreaRangeTable, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubAreaGroup=ospfStubAreaGroup, ospfRouterId=ospfRouterId, ospfStubMetricType=ospfStubMetricType, ospfGroups=ospfGroups, ospfStubAreaId=ospfStubAreaId, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfBasicGroup=ospfBasicGroup, ospfHostTable=ospfHostTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAuthType=ospfAuthType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfInterArea=ospfInterArea, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfAdminStat=ospfIfAdminStat, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfState=ospfVirtIfState, ospfExternalType1=ospfExternalType1, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaGroup=ospfAreaGroup, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfHostAreaID=ospfHostAreaID, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfRestartStatus=ospfRestartStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfExtLsdbAge=ospfExtLsdbAge, ospfNbrEntry=ospfNbrEntry, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, HelloRange=HelloRange, ospfAsLsaCount=ospfAsLsaCount, ospfAreaSummary=ospfAreaSummary, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIntraArea=ospfIntraArea, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfSpfRuns=ospfSpfRuns, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospf=ospf, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbEntry=ospfAsLsdbEntry, Metric=Metric, ospfIfMetricEntry=ospfIfMetricEntry, ospfHostMetric=ospfHostMetric, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAsLsaCksumSum=ospfAsLsaCksumSum, PositiveInteger=PositiveInteger, AreaID=AreaID, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfCompliance2=ospfCompliance2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfConformance=ospfConformance, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, Status=Status, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAddressLessIf=ospfAddressLessIf, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrIpAddr=ospfNbrIpAddr, ospfAsLsdbTable=ospfAsLsdbTable, ospfStubTOS=ospfStubTOS, ospfNbrGroup2=ospfNbrGroup2, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfAuthType=ospfIfAuthType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfRestartInterval=ospfRestartInterval, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfHostGroup=ospfHostGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfRestartSupport=ospfRestartSupport)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrOptions=ospfVirtNbrOptions, RouterID=RouterID, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostStatus=ospfHostStatus)
