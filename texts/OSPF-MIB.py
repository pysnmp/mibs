...
mibBuilder.exportSymbols("OSPF-MIB", ospfOriginateNewLsas=ospfOriginateNewLsas, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLsdbEntry=ospfLsdbEntry, ospfIfAdminStat=ospfIfAdminStat, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaTable=ospfAreaTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaGroup2=ospfAreaGroup2, ospfAuthType=ospfAuthType, ospfRouteGroup=ospfRouteGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrEntry=ospfNbrEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfAreaId=ospfIfAreaId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfTable=ospfIfTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfLsaCount=ospfVirtIfLsaCount, PYSNMP_MODULE_ID=ospf, TOSType=TOSType, ospfLsdbType=ospfLsdbType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRestartExitReason=ospfRestartExitReason, PositiveInteger=PositiveInteger, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfHostStatus=ospfHostStatus, ospfStubTOS=ospfStubTOS, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfGroup2=ospfIfGroup2, Metric=Metric, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrEvents=ospfNbrEvents, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfStubStatus=ospfStubStatus, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfIpAddress=ospfIfIpAddress, UpToMaxAge=UpToMaxAge, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfRestartAge=ospfRestartAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIntraArea=ospfIntraArea, AreaID=AreaID, ospfIfDemand=ospfIfDemand, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostEntry=ospfHostEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfAuthType=ospfIfAuthType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbTable=ospfLsdbTable, ospfStubMetricType=ospfStubMetricType, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfMetricValue=ospfIfMetricValue, ospfComplianceObsolete=ospfComplianceObsolete, ospfMulticastExtensions=ospfMulticastExtensions, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbTable=ospfAsLsdbTable, ospfConformance=ospfConformance, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfRestartStatus=ospfRestartStatus, ospfLsdbAge=ospfLsdbAge, ospfIfLsaCount=ospfIfLsaCount, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfCompliance=ospfCompliance, ospfVirtIfStatus=ospfVirtIfStatus, ospfTOSSupport=ospfTOSSupport, ospfRxNewLsas=ospfRxNewLsas, ospfCompliance2=ospfCompliance2, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, BigMetric=BigMetric, Status=Status, ospfBasicGroup=ospfBasicGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfMetricTOS=ospfIfMetricTOS, HelloRange=HelloRange, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfExtLsdbType=ospfExtLsdbType, ospfVirtIfState=ospfVirtIfState, ospfGroups=ospfGroups, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfNbrState=ospfNbrState, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfGroup=ospfIfGroup, ospfHostTable=ospfHostTable, ospfAreaGroup=ospfAreaGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfRestartSupport=ospfRestartSupport, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, DesignatedRouterPriority=DesignatedRouterPriority, RouterID=RouterID, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrGroup=ospfNbrGroup, ospfHostAreaID=ospfHostAreaID, ospfHostGroup=ospfHostGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfEntry=ospfIfEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfLsdbLsid=ospfLsdbLsid, ospfIfPollInterval=ospfIfPollInterval, ospfHostMetric=ospfHostMetric, ospfIfType=ospfIfType, ospfNbrGroup2=ospfNbrGroup2, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfBasicGroup2=ospfBasicGroup2, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostIpAddress=ospfHostIpAddress, ospfNbrTable=ospfNbrTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfState=ospfIfState, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsaCount=ospfAsLsaCount, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfEvents=ospfIfEvents, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLsdbGroup=ospfLsdbGroup, ospfStubMetric=ospfStubMetric, ospfIfMetricTable=ospfIfMetricTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaId=ospfAreaId, ospfStubAreaEntry=ospfStubAreaEntry, ospfCompliances=ospfCompliances, ospfAddressLessIf=ospfAddressLessIf, ospfAreaSummary=ospfAreaSummary, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAdminStat=ospfAdminStat, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtNbrTable=ospfVirtNbrTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfSpfRuns=ospfSpfRuns, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExternalType1=ospfExternalType1, ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExternLsaCount=ospfExternLsaCount, ospfNbrOptions=ospfNbrOptions, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfRestartInterval=ospfRestartInterval, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostTOS=ospfHostTOS, ospfAreaEntry=ospfAreaEntry, ospfAreaStatus=ospfAreaStatus, OspfAuthenticationType=OspfAuthenticationType, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfGroup=ospfVirtIfGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfStubRouterSupport=ospfStubRouterSupport, ospfLsdbAreaId=ospfLsdbAreaId, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrRtrId=ospfNbrRtrId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVersionNumber=ospfVersionNumber, ospfLsdbSequence=ospfLsdbSequence, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfTransitDelay=ospfIfTransitDelay, ospfInterArea=ospfInterArea, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfStatus=ospfIfStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospf=ospf)
mibBuilder.exportSymbols("OSPF-MIB", ospfStubAreaTable=ospfStubAreaTable, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfHelloInterval=ospfIfHelloInterval, ospfRouterId=ospfRouterId)
