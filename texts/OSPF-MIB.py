...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrEntry=ospfNbrEntry, ospfNbrOptions=ospfNbrOptions, ospfStubAreaGroup=ospfStubAreaGroup, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfSpfRuns=ospfSpfRuns, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbEntry=ospfExtLsdbEntry, OspfAuthenticationType=OspfAuthenticationType, ospfDemandExtensions=ospfDemandExtensions, ospfLsdbEntry=ospfLsdbEntry, RouterID=RouterID, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostTOS=ospfHostTOS, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfMetricStatus=ospfIfMetricStatus, ospfImportAsExtern=ospfImportAsExtern, ospfExternalType2=ospfExternalType2, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfTable=ospfVirtIfTable, ospfIfAreaId=ospfIfAreaId, ospfCompliance=ospfCompliance, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaGroup2=ospfAreaGroup2, BigMetric=BigMetric, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfRestartSupport=ospfRestartSupport, ospfIfTransitDelay=ospfIfTransitDelay, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfInterArea=ospfInterArea, ospfNbrTable=ospfNbrTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExternalType1=ospfExternalType1, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLsdbAge=ospfLsdbAge, PYSNMP_MODULE_ID=ospf, ospfAreaSummary=ospfAreaSummary, ospfLsdbTable=ospfLsdbTable, ospfAddressLessIf=ospfAddressLessIf, ospfCompliances=ospfCompliances, ospfHostMetric=ospfHostMetric, Metric=Metric, ospfAreaStatus=ospfAreaStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfAuthType=ospfAuthType, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfTable=ospfIfTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfType=ospfIfType, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfBasicGroup2=ospfBasicGroup2, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaAggregateMask=ospfAreaAggregateMask, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfGroup2=ospfIfGroup2, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfStubAreaId=ospfStubAreaId, ospfNbrPriority=ospfNbrPriority, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrState=ospfNbrState, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfState=ospfIfState, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfHostIpAddress=ospfHostIpAddress, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfBasicGroup=ospfBasicGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIntraArea=ospfIntraArea, ospfNbrIpAddr=ospfNbrIpAddr, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLsdbLsid=ospfLsdbLsid, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfHostGroup=ospfHostGroup, ospfIfEntry=ospfIfEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfMetricTable=ospfIfMetricTable, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfStatus=ospfIfStatus, TOSType=TOSType, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfTOSSupport=ospfTOSSupport, ospfNbrEvents=ospfNbrEvents, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaGroup=ospfAreaGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfHostTable=ospfHostTable, ospfRestartAge=ospfRestartAge, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfCompliance2=ospfCompliance2, ospfNbrGroup=ospfNbrGroup, ospfVirtIfState=ospfVirtIfState, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfGroup2=ospfVirtIfGroup2, PositiveInteger=PositiveInteger, ospfAreaTable=ospfAreaTable, ospfHostStatus=ospfHostStatus, ospfStubStatus=ospfStubStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfMetricValue=ospfIfMetricValue, ospfExitOverflowInterval=ospfExitOverflowInterval, ospf=ospf, ospfLsdbType=ospfLsdbType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfConformance=ospfConformance, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfStubAreaTable=ospfStubAreaTable, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrGroup2=ospfNbrGroup2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostEntry=ospfHostEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfGroups=ospfGroups, ospfAreaEntry=ospfAreaEntry, AreaID=AreaID, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubMetric=ospfStubMetric, ospfIfDemand=ospfIfDemand, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, HelloRange=HelloRange, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfRouteGroup=ospfRouteGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVersionNumber=ospfVersionNumber, ospfStubTOS=ospfStubTOS, ospfIfAuthType=ospfIfAuthType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfGeneralGroup=ospfGeneralGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaId=ospfAreaId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfAdminStat=ospfIfAdminStat, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfGroup=ospfIfGroup, ospfStubMetricType=ospfStubMetricType, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostGroup2=ospfHostGroup2, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, UpToMaxAge=UpToMaxAge, Status=Status, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfRestartInterval=ospfRestartInterval, ospfRestartStatus=ospfRestartStatus, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAsLsaCount=ospfAsLsaCount, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfEvents=ospfIfEvents, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfRtrPriority=ospfIfRtrPriority, ospfAdminStat=ospfAdminStat, ospfStubRouterSupport=ospfStubRouterSupport)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbAge=ospfAsLsdbAge, ospfRxNewLsas=ospfRxNewLsas, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed)
