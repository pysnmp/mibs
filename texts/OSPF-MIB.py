...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfTable=ospfVirtIfTable, ospfAreaStatus=ospfAreaStatus, ospfHostAreaID=ospfHostAreaID, Status=Status, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExternalType1=ospfExternalType1, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfType=ospfIfType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaGroup=ospfAreaGroup, Metric=Metric, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAdminStat=ospfAdminStat, ospfNbrTable=ospfNbrTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfRestartAge=ospfRestartAge, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfGeneralGroup=ospfGeneralGroup, ospf=ospf, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfRxNewLsas=ospfRxNewLsas, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIntraArea=ospfIntraArea, ospfHostIpAddress=ospfHostIpAddress, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaSummary=ospfAreaSummary, ospfRouterId=ospfRouterId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVersionNumber=ospfVersionNumber, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, RouterID=RouterID, ospfExtLsdbTable=ospfExtLsdbTable, HelloRange=HelloRange, ospfImportAsExtern=ospfImportAsExtern, ospfIfAuthType=ospfIfAuthType, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfLsaCksumSum=ospfIfLsaCksumSum, TOSType=TOSType, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubMetricType=ospfStubMetricType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbAge=ospfLsdbAge, UpToMaxAge=UpToMaxAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaId=ospfAreaId, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfState=ospfVirtIfState, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLsdbType=ospfLsdbType, ospfHostTOS=ospfHostTOS, ospfAuthType=ospfAuthType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubAreaEntry=ospfStubAreaEntry, ospfBasicGroup=ospfBasicGroup, ospfBasicGroup2=ospfBasicGroup2, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfDemand=ospfIfDemand, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfAdminStat=ospfIfAdminStat, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsdbGroup=ospfAsLsdbGroup, PositiveInteger=PositiveInteger, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLsdbTable=ospfLsdbTable, PYSNMP_MODULE_ID=ospf, ospfIfLsaCount=ospfIfLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfDemandExtensions=ospfDemandExtensions, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLsdbRouterId=ospfLsdbRouterId, ospfHostTable=ospfHostTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostMetric=ospfHostMetric, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExtLsdbAge=ospfExtLsdbAge, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfComplianceObsolete=ospfComplianceObsolete, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfConformance=ospfConformance, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAsLsdbType=ospfAsLsdbType, ospfAreaTable=ospfAreaTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubMetric=ospfStubMetric, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrGroup=ospfNbrGroup, ospfNbrGroup2=ospfNbrGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfCompliance2=ospfCompliance2, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbType=ospfExtLsdbType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfStatus=ospfIfStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, OspfAuthenticationType=OspfAuthenticationType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfRestartSupport=ospfRestartSupport, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubAreaTable=ospfStubAreaTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfIpAddress=ospfIfIpAddress, ospfIfTable=ospfIfTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfCompliance=ospfCompliance, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrEvents=ospfNbrEvents, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrState=ospfNbrState, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLsdbLsid=ospfLsdbLsid, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrArea=ospfVirtNbrArea, ospfStubTOS=ospfStubTOS, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfCompliances=ospfCompliances, ospfIfPollInterval=ospfIfPollInterval, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrState=ospfVirtNbrState, ospfTOSSupport=ospfTOSSupport, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbGroup=ospfLsdbGroup, ospfGroups=ospfGroups, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubStatus=ospfStubStatus, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrPriority=ospfNbrPriority, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfGroup2=ospfIfGroup2, BigMetric=BigMetric, ospfLsdbAreaId=ospfLsdbAreaId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfHostGroup=ospfHostGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbEntry=ospfLsdbEntry, ospfAddressLessIf=ospfAddressLessIf, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricValue=ospfIfMetricValue, ospfIfEntry=ospfIfEntry, ospfIfAreaId=ospfIfAreaId, AreaID=AreaID, ospfExternalType2=ospfExternalType2, ospfHostGroup2=ospfHostGroup2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbrEntry=ospfNbrEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsaCount=ospfAsLsaCount, ospfHostStatus=ospfHostStatus, ospfRestartExitReason=ospfRestartExitReason, ospfIfMetricTable=ospfIfMetricTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfState=ospfIfState, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfEvents=ospfIfEvents, ospfIfGroup=ospfIfGroup, ospfHostEntry=ospfHostEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrIpAddr=ospfNbrIpAddr)
