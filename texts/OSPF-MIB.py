...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateNet=ospfAreaAggregateNet, ospfImportAsExtern=ospfImportAsExtern, ospfExitOverflowInterval=ospfExitOverflowInterval, UpToMaxAge=UpToMaxAge, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfConformance=ospfConformance, ospfStubMetricType=ospfStubMetricType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAsLsdbGroup=ospfAsLsdbGroup, RouterID=RouterID, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLsdbRouterId=ospfLsdbRouterId, ospfNbrState=ospfNbrState, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfStubAreaTable=ospfStubAreaTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLsdbTable=ospfLsdbTable, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfTable=ospfVirtIfTable, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfDemandExtensions=ospfDemandExtensions, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfInterArea=ospfInterArea, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfMetricEntry=ospfIfMetricEntry, ospfIntraArea=ospfIntraArea, ospfBasicGroup2=ospfBasicGroup2, ospf=ospf, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubStatus=ospfStubStatus, ospfRestartStatus=ospfRestartStatus, PYSNMP_MODULE_ID=ospf, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrEntry=ospfNbrEntry, ospfIfEvents=ospfIfEvents, ospfLsdbChecksum=ospfLsdbChecksum, ospfExternalType1=ospfExternalType1, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExtLsdbEntry=ospfExtLsdbEntry, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaId=ospfAreaId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubTOS=ospfStubTOS, ospfIfTable=ospfIfTable, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVersionNumber=ospfVersionNumber, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfState=ospfVirtIfState, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRxNewLsas=ospfRxNewLsas, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLsdbType=ospfLsdbType, ospfGroups=ospfGroups, TOSType=TOSType, ospfVirtIfEvents=ospfVirtIfEvents, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfMetricGroup=ospfIfMetricGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfRestartSupport=ospfRestartSupport, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExternalType2=ospfExternalType2, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaTable=ospfAreaTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLsdbGroup=ospfLsdbGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaStatus=ospfAreaStatus, ospfHostTOS=ospfHostTOS, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLsdbEntry=ospfLsdbEntry, ospfAreaEntry=ospfAreaEntry, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfBasicGroup=ospfBasicGroup, ospfIfMetricTable=ospfIfMetricTable, ospfCompliance2=ospfCompliance2, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaGroup2=ospfAreaGroup2, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfHostTable=ospfHostTable, ospfVirtIfStatus=ospfVirtIfStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfAuthType=ospfIfAuthType, ospfAsLsaCount=ospfAsLsaCount, ospfIfGroup=ospfIfGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfEntry=ospfIfEntry, ospfLocalLsdbAge=ospfLocalLsdbAge, HelloRange=HelloRange, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfHostGroup=ospfHostGroup, ospfIfStatus=ospfIfStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbLsid=ospfLsdbLsid, ospfAreaGroup=ospfAreaGroup, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfMetricValue=ospfIfMetricValue, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrGroup2=ospfNbrGroup2, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfExternLsaCount=ospfExternLsaCount, ospfRestartAge=ospfRestartAge, ospfStubMetric=ospfStubMetric, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExtLsdbTable=ospfExtLsdbTable, ospfHostGroup2=ospfHostGroup2, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, Metric=Metric, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAddressLessIf=ospfAddressLessIf, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, Status=Status, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfState=ospfIfState, ospfAreaRangeStatus=ospfAreaRangeStatus, AreaID=AreaID, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfCompliances=ospfCompliances, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAdminStat=ospfAdminStat, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfGroup2=ospfIfGroup2, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaLsaCount=ospfAreaLsaCount, ospfRouterId=ospfRouterId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfAreaId=ospfIfAreaId, ospfGeneralGroup=ospfGeneralGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaRangeMask=ospfAreaRangeMask, OspfAuthenticationType=OspfAuthenticationType, ospfCompliance=ospfCompliance, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbType=ospfExtLsdbType, ospfIfLsaCount=ospfIfLsaCount, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubRouterSupport=ospfStubRouterSupport, ospfHostIpAddress=ospfHostIpAddress, ospfAreaSummary=ospfAreaSummary, ospfRestartExitReason=ospfRestartExitReason, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbType=ospfLocalLsdbType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrEvents=ospfNbrEvents, ospfAuthType=ospfAuthType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrGroup=ospfNbrGroup, ospfNbrTable=ospfNbrTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLsdbAge=ospfLsdbAge, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfTOSSupport=ospfTOSSupport, ospfHostStatus=ospfHostStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfDemand=ospfIfDemand, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfRestartInterval=ospfRestartInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfStubAreaGroup=ospfStubAreaGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, PositiveInteger=PositiveInteger, ospfHostAreaID=ospfHostAreaID)
mibBuilder.exportSymbols("OSPF-MIB", ospfHostMetric=ospfHostMetric, ospfIfPollInterval=ospfIfPollInterval, BigMetric=BigMetric, ospfIfType=ospfIfType)
