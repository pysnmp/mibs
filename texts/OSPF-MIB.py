...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateMask=ospfAreaAggregateMask, ospfMulticastExtensions=ospfMulticastExtensions, ospfLsdbAge=ospfLsdbAge, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfAuthKey=ospfIfAuthKey, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfExtLsdbType=ospfExtLsdbType, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfTransitDelay=ospfIfTransitDelay, ospfGroups=ospfGroups, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfTable=ospfVirtIfTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfGeneralGroup=ospfGeneralGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfDemandExtensions=ospfDemandExtensions, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfGroup2=ospfIfGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfHostTable=ospfHostTable, ospfNbrGroup2=ospfNbrGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbAreaId=ospfLsdbAreaId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbrTable=ospfNbrTable, ospfRxNewLsas=ospfRxNewLsas, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfInterArea=ospfInterArea, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrEvents=ospfNbrEvents, ospfComplianceObsolete=ospfComplianceObsolete, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfTable=ospfIfTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubTOS=ospfStubTOS, DesignatedRouterPriority=DesignatedRouterPriority, ospfAdminStat=ospfAdminStat, ospfAreaGroup=ospfAreaGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsdbAge=ospfAsLsdbAge, OspfAuthenticationType=OspfAuthenticationType, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfCompliance2=ospfCompliance2, ospfHostGroup=ospfHostGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfState=ospfVirtIfState, ospfVersionNumber=ospfVersionNumber, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfStubAreaTable=ospfStubAreaTable, ospfCompliances=ospfCompliances, ospfLsdbEntry=ospfLsdbEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfDemand=ospfIfDemand, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfTOSSupport=ospfTOSSupport, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfMetricStatus=ospfIfMetricStatus, ospfCompliance=ospfCompliance, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospf=ospf, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLsdbSequence=ospfLsdbSequence, ospfIfEvents=ospfIfEvents, ospfRestartInterval=ospfRestartInterval, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaGroup2=ospfAreaGroup2, ospfRestartAge=ospfRestartAge, ospfSpfRuns=ospfSpfRuns, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, AreaID=AreaID, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfConformance=ospfConformance, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostTOS=ospfHostTOS, Metric=Metric, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfStubAreaId=ospfStubAreaId, ospfAuthType=ospfAuthType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfExternalType2=ospfExternalType2, ospfVirtNbrEvents=ospfVirtNbrEvents, HelloRange=HelloRange, ospfBasicGroup2=ospfBasicGroup2, ospfRestartStatus=ospfRestartStatus, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfRetransInterval=ospfIfRetransInterval, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfStubStatus=ospfStubStatus, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, PositiveInteger=PositiveInteger, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaTable=ospfAreaTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfIpAddress=ospfIfIpAddress, ospfIfStatus=ospfIfStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIntraArea=ospfIntraArea, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbSequence=ospfExtLsdbSequence, UpToMaxAge=UpToMaxAge, ospfNbrGroup=ospfNbrGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrState=ospfNbrState, ospfHostMetric=ospfHostMetric, ospfIfMetricTOS=ospfIfMetricTOS, ospfAddressLessIf=ospfAddressLessIf, ospfNbrOptions=ospfNbrOptions, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrRtrId=ospfNbrRtrId, ospfStubMetricType=ospfStubMetricType, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostGroup2=ospfHostGroup2, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfBasicGroup=ospfBasicGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaId=ospfAreaId, ospfAreaAggregateTable=ospfAreaAggregateTable, TOSType=TOSType, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubMetric=ospfStubMetric, ospfIfType=ospfIfType, ospfIfEntry=ospfIfEntry, ospfIfAdminStat=ospfIfAdminStat, ospfExternalType1=ospfExternalType1, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaStatus=ospfAreaStatus, ospfLsdbType=ospfLsdbType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLsdbLsid=ospfLsdbLsid, ospfHostStatus=ospfHostStatus, ospfIfGroup=ospfIfGroup, ospfImportAsExtern=ospfImportAsExtern, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaEntry=ospfAreaEntry, ospfHostIpAddress=ospfHostIpAddress, ospfIfState=ospfIfState, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrPriority=ospfNbrPriority, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostEntry=ospfHostEntry, ospfLsdbGroup=ospfLsdbGroup, RouterID=RouterID, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLsdbTable=ospfLsdbTable, Status=Status, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfRestartSupport=ospfRestartSupport, ospfRouteGroup=ospfRouteGroup, PYSNMP_MODULE_ID=ospf, ospfRouterId=ospfRouterId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaSummary=ospfAreaSummary)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfAreaId=ospfIfAreaId, ospfVirtNbrState=ospfVirtNbrState, BigMetric=BigMetric, ospfHostAreaID=ospfHostAreaID)
