...
mibBuilder.exportSymbols("OSPF-MIB", ospfAdminStat=ospfAdminStat, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostGroup2=ospfHostGroup2, ospfAreaEntry=ospfAreaEntry, ospfRestartInterval=ospfRestartInterval, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfAdminStat=ospfIfAdminStat, ospfExternLsaCount=ospfExternLsaCount, ospfStubTOS=ospfStubTOS, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfAuthKey=ospfIfAuthKey, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostTable=ospfHostTable, ospfIfState=ospfIfState, ospfVirtIfEvents=ospfVirtIfEvents, ospfCompliance=ospfCompliance, ospfAreaRangeMask=ospfAreaRangeMask, ospfLsdbAreaId=ospfLsdbAreaId, ospfLsdbAge=ospfLsdbAge, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfState=ospfVirtIfState, AreaID=AreaID, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfType=ospfIfType, ospfIfLsaCount=ospfIfLsaCount, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfCompliances=ospfCompliances, ospfHostGroup=ospfHostGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAddressLessIf=ospfAddressLessIf, HelloRange=HelloRange, PositiveInteger=PositiveInteger, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, Metric=Metric, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLsdbType=ospfLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfIfMetricValue=ospfIfMetricValue, ospfLsdbSequence=ospfLsdbSequence, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, Status=Status, ospfRestartSupport=ospfRestartSupport, ospfIfMetricEntry=ospfIfMetricEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbLsid=ospfLsdbLsid, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfHostAreaID=ospfHostAreaID, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfHostMetric=ospfHostMetric, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfPollInterval=ospfIfPollInterval, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospf=ospf, ospfRxNewLsas=ospfRxNewLsas, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrState=ospfNbrState, ospfLsdbChecksum=ospfLsdbChecksum, RouterID=RouterID, ospfNbrGroup2=ospfNbrGroup2, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfConformance=ospfConformance, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbrOptions=ospfNbrOptions, PYSNMP_MODULE_ID=ospf, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExternalType1=ospfExternalType1, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaTable=ospfAreaTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrGroup=ospfNbrGroup, ospfAreaStatus=ospfAreaStatus, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfRestartExitReason=ospfRestartExitReason, ospfIfDemand=ospfIfDemand, ospfAsLsdbType=ospfAsLsdbType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaGroup2=ospfAreaGroup2, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfMetricTable=ospfIfMetricTable, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrTable=ospfNbrTable, ospfBasicGroup2=ospfBasicGroup2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfStubMetricType=ospfStubMetricType, ospfExtLsdbType=ospfExtLsdbType, ospfTOSSupport=ospfTOSSupport, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, OspfAuthenticationType=OspfAuthenticationType, ospfRestartStatus=ospfRestartStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfEntry=ospfIfEntry, ospfIfEvents=ospfIfEvents, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfRouteGroup=ospfRouteGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfGroup2=ospfIfGroup2, ospfDemandExtensions=ospfDemandExtensions, ospfAreaId=ospfAreaId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfCompliance2=ospfCompliance2, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsaCount=ospfAsLsaCount, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostTOS=ospfHostTOS, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrPriority=ospfNbrPriority, ospfLsdbGroup=ospfLsdbGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfStubAreaTable=ospfStubAreaTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfStubAreaId=ospfStubAreaId, ospfLsdbTable=ospfLsdbTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrState=ospfVirtNbrState, ospfIfAuthType=ospfIfAuthType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfStubStatus=ospfStubStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfMetricStatus=ospfIfMetricStatus, ospfGroups=ospfGroups, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfGroup=ospfIfGroup, ospfGeneralGroup=ospfGeneralGroup, BigMetric=BigMetric, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfRestartAge=ospfRestartAge, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExtLsdbRouterId=ospfExtLsdbRouterId, UpToMaxAge=UpToMaxAge, TOSType=TOSType, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfRouterId=ospfRouterId, ospfAreaSummary=ospfAreaSummary, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfAreaId=ospfIfAreaId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfStubMetric=ospfStubMetric, ospfHostStatus=ospfHostStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospfInterArea=ospfInterArea, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAuthType=ospfAuthType, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfTable=ospfIfTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfIpAddress=ospfIfIpAddress, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbTable=ospfAsLsdbTable, ospfHostEntry=ospfHostEntry, ospfIntraArea=ospfIntraArea, ospfIfStatus=ospfIfStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrEntry=ospfNbrEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVersionNumber=ospfVersionNumber, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExternalType2=ospfExternalType2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExitOverflowInterval=ospfExitOverflowInterval)
mibBuilder.exportSymbols("OSPF-MIB", ospfImportAsExtern=ospfImportAsExtern, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbEntry=ospfLsdbEntry)
