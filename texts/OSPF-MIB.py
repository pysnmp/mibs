...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfAuthKey=ospfIfAuthKey, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfBasicGroup2=ospfBasicGroup2, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtIfGroup=ospfVirtIfGroup, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsaCount=ospfAsLsaCount, PositiveInteger=PositiveInteger, ospfRouterId=ospfRouterId, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfStatus=ospfIfStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, HelloRange=HelloRange, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaStatus=ospfAreaStatus, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtNbrState=ospfVirtNbrState, ospfAreaEntry=ospfAreaEntry, ospfSpfRuns=ospfSpfRuns, ospfLsdbTable=ospfLsdbTable, ospfHostIpAddress=ospfHostIpAddress, ospfAreaGroup2=ospfAreaGroup2, ospfNbrGroup2=ospfNbrGroup2, ospfStubAreaId=ospfStubAreaId, ospfImportAsExtern=ospfImportAsExtern, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospf=ospf, ospfLsdbLsid=ospfLsdbLsid, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbType=ospfLocalLsdbType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaLsaCountTable=ospfAreaLsaCountTable, UpToMaxAge=UpToMaxAge, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfDemandExtensions=ospfDemandExtensions, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfStubMetric=ospfStubMetric, ospfHostTOS=ospfHostTOS, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExternalType2=ospfExternalType2, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfRestartStatus=ospfRestartStatus, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfHostStatus=ospfHostStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfMetricValue=ospfIfMetricValue, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbmaNbrStatus=ospfNbmaNbrStatus, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtIfGroup2=ospfVirtIfGroup2, Metric=Metric, ospfNbrEntry=ospfNbrEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfHostMetric=ospfHostMetric, ospfCompliance2=ospfCompliance2, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfRestartInterval=ospfRestartInterval, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfMetricEntry=ospfIfMetricEntry, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAsLsdbTable=ospfAsLsdbTable, ospfGeneralGroup=ospfGeneralGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfAdminStat=ospfIfAdminStat, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIntraArea=ospfIntraArea, ospfExternalType1=ospfExternalType1, ospfComplianceObsolete=ospfComplianceObsolete, ospfHostAreaID=ospfHostAreaID, ospfIfIpAddress=ospfIfIpAddress, ospfStubAreaTable=ospfStubAreaTable, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, DesignatedRouterPriority=DesignatedRouterPriority, ospfMulticastExtensions=ospfMulticastExtensions, ospfLsdbType=ospfLsdbType, ospfLsdbAge=ospfLsdbAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfMulticastForwarding=ospfIfMulticastForwarding, PYSNMP_MODULE_ID=ospf, ospfBasicGroup=ospfBasicGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfAddressLessIf=ospfAddressLessIf, ospfIfAuthType=ospfIfAuthType, ospfAreaTable=ospfAreaTable, ospfStubStatus=ospfStubStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaAggregateNet=ospfAreaAggregateNet, TOSType=TOSType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfRestartSupport=ospfRestartSupport, ospfIfDemand=ospfIfDemand, ospfRxNewLsas=ospfRxNewLsas, ospfHostTable=ospfHostTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrGroup=ospfNbrGroup, ospfConformance=ospfConformance, Status=Status, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfEvents=ospfIfEvents, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAdminStat=ospfAdminStat, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfStubTOS=ospfStubTOS, ospfAuthType=ospfAuthType, ospfLsdbGroup=ospfLsdbGroup, ospfRestartAge=ospfRestartAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfHostGroup2=ospfHostGroup2, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfLsaCount=ospfIfLsaCount, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbType=ospfExtLsdbType, ospfCompliances=ospfCompliances, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfCompliance=ospfCompliance, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVersionNumber=ospfVersionNumber, ospfNbrOptions=ospfNbrOptions, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfState=ospfVirtIfState, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLsdbSequence=ospfLsdbSequence, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsdbGroup=ospfAsLsdbGroup, AreaID=AreaID, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, BigMetric=BigMetric, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrTable=ospfNbrTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricTable=ospfIfMetricTable, ospfIfTable=ospfIfTable, ospfAreaSummary=ospfAreaSummary, ospfStubMetricType=ospfStubMetricType, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrRtrId=ospfNbrRtrId, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfInterArea=ospfInterArea, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfType=ospfIfType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfTable=ospfVirtIfTable, ospfIfGroup=ospfIfGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaId=ospfAreaId, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrEvents=ospfNbrEvents, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfHostGroup=ospfHostGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrState=ospfNbrState, RouterID=RouterID, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfGroup2=ospfIfGroup2, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbEntry=ospfLsdbEntry, ospfIfEntry=ospfIfEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfState=ospfIfState, ospfExternLsaCount=ospfExternLsaCount, ospfHostEntry=ospfHostEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrPriority=ospfNbrPriority)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfGroups=ospfGroups)
