...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMetricTOS=ospfIfMetricTOS, ospfLsdbTable=ospfLsdbTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfPollInterval=ospfIfPollInterval, ospf=ospf, ospfExtLsdbType=ospfExtLsdbType, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaEntry=ospfAreaEntry, ospfHostIpAddress=ospfHostIpAddress, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, HelloRange=HelloRange, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfStubAreaTable=ospfStubAreaTable, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfTOSSupport=ospfTOSSupport, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfImportAsExtern=ospfImportAsExtern, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfTable=ospfIfTable, RouterID=RouterID, ospfAdminStat=ospfAdminStat, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfState=ospfVirtIfState, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfGroups=ospfGroups, ospfBasicGroup=ospfBasicGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAddressLessIf=ospfAddressLessIf, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsaCount=ospfAsLsaCount, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfTable=ospfVirtIfTable, ospfBasicGroup2=ospfBasicGroup2, ospfAreaGroup=ospfAreaGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaRangeTable=ospfAreaRangeTable, ospfInterArea=ospfInterArea, ospfIfGroup=ospfIfGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfType=ospfIfType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfHostMetric=ospfHostMetric, ospfRestartExitReason=ospfRestartExitReason, ospfExternLsaCount=ospfExternLsaCount, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfHostTable=ospfHostTable, ospfRouterId=ospfRouterId, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, UpToMaxAge=UpToMaxAge, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfGroup2=ospfIfGroup2, ospfRestartInterval=ospfRestartInterval, ospfIfLsaCount=ospfIfLsaCount, ospfHostGroup=ospfHostGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, OspfAuthenticationType=OspfAuthenticationType, ospfRestartStatus=ospfRestartStatus, ospfIfIpAddress=ospfIfIpAddress, ospfGeneralGroup=ospfGeneralGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLsdbAreaId=ospfLsdbAreaId, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfEntry=ospfIfEntry, ospfCompliances=ospfCompliances, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrOptions=ospfNbrOptions, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrTable=ospfNbrTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExternalType2=ospfExternalType2, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostStatus=ospfHostStatus, ospfRouteGroup=ospfRouteGroup, ospfHostAreaID=ospfHostAreaID, ospfLsdbLsid=ospfLsdbLsid, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAsLsdbLsid=ospfAsLsdbLsid, PositiveInteger=PositiveInteger, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbLsid=ospfExtLsdbLsid, PYSNMP_MODULE_ID=ospf, ospfVersionNumber=ospfVersionNumber, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfRxNewLsas=ospfRxNewLsas, TOSType=TOSType, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubMetricType=ospfStubMetricType, ospfAreaId=ospfAreaId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfStatus=ospfIfStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaSummary=ospfAreaSummary, ospfIfMetricTable=ospfIfMetricTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfRestartSupport=ospfRestartSupport, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostTOS=ospfHostTOS, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrState=ospfNbrState, ospfHostEntry=ospfHostEntry, ospfVirtIfEvents=ospfVirtIfEvents, Metric=Metric, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAuthType=ospfAuthType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrState=ospfVirtNbrState, ospfConformance=ospfConformance, Status=Status, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLsdbAge=ospfLsdbAge, ospfStubRouterSupport=ospfStubRouterSupport, ospfRestartAge=ospfRestartAge, ospfIfAuthType=ospfIfAuthType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbType=ospfAsLsdbType, AreaID=AreaID, ospfAreaTable=ospfAreaTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfMetricValue=ospfIfMetricValue, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrEntry=ospfNbrEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfRetransInterval=ospfIfRetransInterval, ospfStubStatus=ospfStubStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostGroup2=ospfHostGroup2, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfCompliance=ospfCompliance, ospfLsdbType=ospfLsdbType, ospfStubMetric=ospfStubMetric, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfStubAreaId=ospfStubAreaId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfDemand=ospfIfDemand, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaStatus=ospfAreaStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfMulticastExtensions=ospfMulticastExtensions, ospfCompliance2=ospfCompliance2, ospfIfState=ospfIfState, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrGroup2=ospfNbrGroup2, ospfIfAreaId=ospfIfAreaId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfAdminStat=ospfIfAdminStat, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrGroup=ospfNbrGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfExternalType1=ospfExternalType1, ospfIntraArea=ospfIntraArea)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMetricStatus=ospfIfMetricStatus, BigMetric=BigMetric, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfStubTOS=ospfStubTOS)
