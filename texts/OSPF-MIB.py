...
mibBuilder.exportSymbols("OSPF-MIB", ospfHostAreaID=ospfHostAreaID, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfPollInterval=ospfIfPollInterval, ospfNbrGroup2=ospfNbrGroup2, ospfHostEntry=ospfHostEntry, ospfNbrTable=ospfNbrTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostTable=ospfHostTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfAdminStat=ospfIfAdminStat, Metric=Metric, TOSType=TOSType, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfRxNewLsas=ospfRxNewLsas, ospfInterArea=ospfInterArea, ospfHostTOS=ospfHostTOS, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, BigMetric=BigMetric, ospfIfStatus=ospfIfStatus, HelloRange=HelloRange, PYSNMP_MODULE_ID=ospf, ospfStubAreaId=ospfStubAreaId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfAreaId=ospfIfAreaId, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaEntry=ospfAreaEntry, ospfExtLsdbType=ospfExtLsdbType, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfBasicGroup=ospfBasicGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfAuthType=ospfIfAuthType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaTable=ospfAreaTable, ospfExternalType1=ospfExternalType1, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfHostStatus=ospfHostStatus, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospf=ospf, ospfIfTable=ospfIfTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfMetricTOS=ospfIfMetricTOS, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtNbrGroup=ospfVirtNbrGroup, OspfAuthenticationType=OspfAuthenticationType, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRestartSupport=ospfRestartSupport, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbGroup=ospfLsdbGroup, ospfExtLsdbAge=ospfExtLsdbAge, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfGroup=ospfIfGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbAge=ospfAsLsdbAge, ospfCompliance2=ospfCompliance2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfTOSSupport=ospfTOSSupport, ospfLsdbType=ospfLsdbType, ospfHostMetric=ospfHostMetric, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfEntry=ospfIfEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIntraArea=ospfIntraArea, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfRouteGroup=ospfRouteGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfDemand=ospfIfDemand, ospfAreaAggregateMask=ospfAreaAggregateMask, PositiveInteger=PositiveInteger, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfType=ospfIfType, ospfBasicGroup2=ospfBasicGroup2, ospfAreaId=ospfAreaId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrOptions=ospfNbrOptions, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLsdbTable=ospfLsdbTable, ospfHostGroup2=ospfHostGroup2, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaSummary=ospfAreaSummary, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAdminStat=ospfAdminStat, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubMetricType=ospfStubMetricType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrGroup=ospfNbrGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAuthType=ospfAuthType, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsdbType=ospfAsLsdbType, ospfStubAreaTable=ospfStubAreaTable, ospfRestartAge=ospfRestartAge, ospfStubTOS=ospfStubTOS, ospfImportAsExtern=ospfImportAsExtern, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfRetransInterval=ospfIfRetransInterval, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrState=ospfNbrState, ospfAreaAggregateTable=ospfAreaAggregateTable, Status=Status, ospfStubAreaEntry=ospfStubAreaEntry, ospfAddressLessIf=ospfAddressLessIf, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfRouterId=ospfRouterId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfGroup2=ospfIfGroup2, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfDemandExtensions=ospfDemandExtensions, ospfExternLsaCount=ospfExternLsaCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVersionNumber=ospfVersionNumber, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbLsid=ospfLsdbLsid, ospfMulticastExtensions=ospfMulticastExtensions, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaGroup=ospfAreaGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrEntry=ospfNbrEntry, ospfConformance=ospfConformance, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfState=ospfIfState, ospfCompliances=ospfCompliances, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfEvents=ospfIfEvents, ospfRestartStatus=ospfRestartStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricGroup=ospfIfMetricGroup, ospfLsdbSequence=ospfLsdbSequence, ospfSpfRuns=ospfSpfRuns, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfCompliance=ospfCompliance, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAsLsaCount=ospfAsLsaCount, ospfHostIpAddress=ospfHostIpAddress, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrState=ospfVirtNbrState, ospfAreaStatus=ospfAreaStatus, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricTable=ospfIfMetricTable, ospfIfMetricValue=ospfIfMetricValue, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, AreaID=AreaID, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfHostGroup=ospfHostGroup, ospfRestartExitReason=ospfRestartExitReason, ospfAreaGroup2=ospfAreaGroup2, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfStubStatus=ospfStubStatus, ospfExternalType2=ospfExternalType2, UpToMaxAge=UpToMaxAge, ospfComplianceObsolete=ospfComplianceObsolete, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfGroups=ospfGroups, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfRestartInterval=ospfRestartInterval, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfStubMetric=ospfStubMetric, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfIpAddress=ospfIfIpAddress, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrEvents=ospfNbrEvents, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfState=ospfVirtIfState, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfEvents=ospfVirtIfEvents, RouterID=RouterID, ospfNbrPriority=ospfNbrPriority, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfStatus=ospfVirtIfStatus, ospfStubAreaGroup=ospfStubAreaGroup)
