...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaTable=ospfAreaTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfGroups=ospfGroups, HelloRange=HelloRange, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfType=ospfIfType, ospfAreaSummary=ospfAreaSummary, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfBasicGroup2=ospfBasicGroup2, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfTOSSupport=ospfTOSSupport, ospfVirtIfEvents=ospfVirtIfEvents, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRestartSupport=ospfRestartSupport, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsdbType=ospfAsLsdbType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubStatus=ospfStubStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaAggregateGroup=ospfAreaAggregateGroup, PositiveInteger=PositiveInteger, ospfIfRtrPriority=ospfIfRtrPriority, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfIpAddress=ospfIfIpAddress, ospfCompliance=ospfCompliance, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubAreaTable=ospfStubAreaTable, ospfInterArea=ospfInterArea, ospfLsdbSequence=ospfLsdbSequence, ospfExternalType1=ospfExternalType1, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExternalType2=ospfExternalType2, ospfHostTable=ospfHostTable, ospfNbrState=ospfNbrState, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfState=ospfIfState, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrEvents=ospfNbrEvents, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfRetransInterval=ospfIfRetransInterval, ospfIntraArea=ospfIntraArea, Status=Status, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaStatus=ospfAreaStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfRestartAge=ospfRestartAge, ospfIfEntry=ospfIfEntry, ospfHostGroup=ospfHostGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLsdbAge=ospfLsdbAge, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfHostEntry=ospfHostEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfStubMetric=ospfStubMetric, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrGroup=ospfNbrGroup, ospfAdminStat=ospfAdminStat, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfMetricValue=ospfIfMetricValue, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAsLsaCount=ospfAsLsaCount, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfDemandExtensions=ospfDemandExtensions, ospfLsdbEntry=ospfLsdbEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfHostGroup2=ospfHostGroup2, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaEntry=ospfAreaEntry, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfRestartStatus=ospfRestartStatus, ospfIfAreaId=ospfIfAreaId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfLsaCount=ospfIfLsaCount, ospfExtLsdbType=ospfExtLsdbType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, BigMetric=BigMetric, ospfStubTOS=ospfStubTOS, ospfVirtIfEntry=ospfVirtIfEntry, Metric=Metric, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfHostStatus=ospfHostStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExternLsaCount=ospfExternLsaCount, ospfRouterId=ospfRouterId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLsdbType=ospfLsdbType, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfCompliance2=ospfCompliance2, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfDemand=ospfIfDemand, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfEvents=ospfIfEvents, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfStatus=ospfIfStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, TOSType=TOSType, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfRxNewLsas=ospfRxNewLsas, ospfIfAdminStat=ospfIfAdminStat, ospfNbrOptions=ospfNbrOptions, ospfNbrEntry=ospfNbrEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAddressLessIf=ospfAddressLessIf, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfGroup2=ospfIfGroup2, OspfAuthenticationType=OspfAuthenticationType, ospfIfTable=ospfIfTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLsdbTable=ospfLsdbTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaGroup2=ospfAreaGroup2, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfHostMetric=ospfHostMetric, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, UpToMaxAge=UpToMaxAge, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfCompliances=ospfCompliances, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrPriority=ospfNbrPriority, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfTransitDelay=ospfIfTransitDelay, AreaID=AreaID, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrTable=ospfNbrTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfTable=ospfVirtIfTable, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfGroup=ospfIfGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfHostIpAddress=ospfHostIpAddress, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartInterval=ospfRestartInterval, ospfAuthType=ospfAuthType, ospfStubMetricType=ospfStubMetricType, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, PYSNMP_MODULE_ID=ospf, ospf=ospf, ospfStubAreaId=ospfStubAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, RouterID=RouterID, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfSpfRuns=ospfSpfRuns, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbType=ospfLocalLsdbType, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaId=ospfAreaId, ospfConformance=ospfConformance, ospfLsdbLsid=ospfLsdbLsid, ospfIfAuthType=ospfIfAuthType, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfState=ospfVirtIfState, ospfNbmaNbrStatus=ospfNbmaNbrStatus)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfHostCfgAreaID=ospfHostCfgAreaID)
