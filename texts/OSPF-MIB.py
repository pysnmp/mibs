...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubAreaGroup=ospfStubAreaGroup, ospfHostStatus=ospfHostStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfStubMetric=ospfStubMetric, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfInterArea=ospfInterArea, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbEntry=ospfExtLsdbEntry, RouterID=RouterID, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, Status=Status, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrPriority=ospfNbrPriority, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, PositiveInteger=PositiveInteger, AreaID=AreaID, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaRangeNet=ospfAreaRangeNet, ospfImportAsExtern=ospfImportAsExtern, ospfHostTable=ospfHostTable, ospfIfPollInterval=ospfIfPollInterval, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfConformance=ospfConformance, ospfGroups=ospfGroups, ospfAreaGroup=ospfAreaGroup, ospfNbrGroup2=ospfNbrGroup2, ospfRestartSupport=ospfRestartSupport, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaTable=ospfAreaTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfStubTOS=ospfStubTOS, ospfNbrRtrId=ospfNbrRtrId, UpToMaxAge=UpToMaxAge, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbTable=ospfAsLsdbTable, TOSType=TOSType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaRangeStatus=ospfAreaRangeStatus, BigMetric=BigMetric, ospfIfGroup=ospfIfGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubStatus=ospfStubStatus, ospfNbrEvents=ospfNbrEvents, ospfIfMetricStatus=ospfIfMetricStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfAuthType=ospfIfAuthType, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfMetricValue=ospfIfMetricValue, ospfIfEntry=ospfIfEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfTransitDelay=ospfIfTransitDelay, ospfExternalType2=ospfExternalType2, HelloRange=HelloRange, ospfLsdbAreaId=ospfLsdbAreaId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfBasicGroup=ospfBasicGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfRouterId=ospfRouterId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRestartInterval=ospfRestartInterval, ospfIfState=ospfIfState, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaAggregateEntry=ospfAreaAggregateEntry, PYSNMP_MODULE_ID=ospf, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfBasicGroup2=ospfBasicGroup2, ospfAreaStatus=ospfAreaStatus, ospfNbrEntry=ospfNbrEntry, ospfLsdbSequence=ospfLsdbSequence, ospfAreaEntry=ospfAreaEntry, ospfIntraArea=ospfIntraArea, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfRestartAge=ospfRestartAge, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrState=ospfNbrState, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfEvents=ospfIfEvents, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsdbSequence=ospfAsLsdbSequence, ospf=ospf, ospfIfDemand=ospfIfDemand, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVersionNumber=ospfVersionNumber, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubAreaTable=ospfStubAreaTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfStubAreaId=ospfStubAreaId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaSummary=ospfAreaSummary, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfTOSSupport=ospfTOSSupport, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbTable=ospfLsdbTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfHostEntry=ospfHostEntry, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaRangeTable=ospfAreaRangeTable, ospfRestartExitReason=ospfRestartExitReason, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbrGroup=ospfNbrGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAsLsaCount=ospfAsLsaCount, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrState=ospfVirtNbrState, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfTable=ospfVirtIfTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLsdbLsid=ospfLsdbLsid, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfHelloInterval=ospfIfHelloInterval, Metric=Metric, ospfStubAreaEntry=ospfStubAreaEntry, ospfLsdbType=ospfLsdbType, ospfExtLsdbTable=ospfExtLsdbTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbType=ospfAsLsdbType, ospfCompliances=ospfCompliances, ospfAddressLessIf=ospfAddressLessIf, ospfDemandExtensions=ospfDemandExtensions, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExternalType1=ospfExternalType1, OspfAuthenticationType=OspfAuthenticationType, ospfLsdbAge=ospfLsdbAge, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfExtLsdbType=ospfExtLsdbType, ospfAuthType=ospfAuthType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrTable=ospfNbrTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrOptions=ospfNbrOptions, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfHostAreaID=ospfHostAreaID, ospfAdminStat=ospfAdminStat, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfCompliance=ospfCompliance, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfAdminStat=ospfIfAdminStat, ospfSpfRuns=ospfSpfRuns, ospfHostGroup2=ospfHostGroup2, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfType=ospfIfType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfState=ospfVirtIfState, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfCompliance2=ospfCompliance2, ospfRestartStatus=ospfRestartStatus, ospfHostMetric=ospfHostMetric, ospfIfStatus=ospfIfStatus, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaId=ospfAreaId, ospfRouteGroup=ospfRouteGroup, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostGroup=ospfHostGroup, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfGeneralGroup=ospfGeneralGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfTable=ospfIfTable)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostTOS=ospfHostTOS, ospfIfGroup2=ospfIfGroup2)
