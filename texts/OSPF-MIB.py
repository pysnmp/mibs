...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaSummary=ospfAreaSummary, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaGroup=ospfAreaGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospf=ospf, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfGeneralGroup=ospfGeneralGroup, ospfIfMetricValue=ospfIfMetricValue, ospfRxNewLsas=ospfRxNewLsas, ospfTOSSupport=ospfTOSSupport, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExternLsaCount=ospfExternLsaCount, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfAdminStat=ospfIfAdminStat, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLsdbType=ospfLsdbType, ospfCompliance=ospfCompliance, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfGroups=ospfGroups, RouterID=RouterID, ospfStubMetric=ospfStubMetric, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrOptions=ospfNbrOptions, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfHostIpAddress=ospfHostIpAddress, ospfIfStatus=ospfIfStatus, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrState=ospfVirtNbrState, TOSType=TOSType, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfCompliances=ospfCompliances, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrGroup2=ospfNbrGroup2, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubTOS=ospfStubTOS, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostMetric=ospfHostMetric, ospfNbrGroup=ospfNbrGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, HelloRange=HelloRange, ospfVirtNbrTable=ospfVirtNbrTable, ospfStubAreaGroup=ospfStubAreaGroup, ospfRouteGroup=ospfRouteGroup, ospfStubStatus=ospfStubStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfState=ospfVirtIfState, ospfHostTable=ospfHostTable, AreaID=AreaID, ospfAddressLessIf=ospfAddressLessIf, ospfAreaRangeMask=ospfAreaRangeMask, ospfConformance=ospfConformance, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfNbrEvents=ospfNbrEvents, ospfAuthType=ospfAuthType, ospfAreaStatus=ospfAreaStatus, ospfVirtIfStatus=ospfVirtIfStatus, PositiveInteger=PositiveInteger, ospfSpfRuns=ospfSpfRuns, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfDemand=ospfIfDemand, ospfIfGroup=ospfIfGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrPriority=ospfNbrPriority, ospfLsdbGroup=ospfLsdbGroup, ospfLsdbAge=ospfLsdbAge, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfHostGroup=ospfHostGroup, ospfIfEvents=ospfIfEvents, ospfRestartSupport=ospfRestartSupport, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, Metric=Metric, ospfIfState=ospfIfState, ospfAsLsdbType=ospfAsLsdbType, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRestartInterval=ospfRestartInterval, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfLsdbRouterId=ospfLsdbRouterId, ospfAdminStat=ospfAdminStat, ospfRouterId=ospfRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfGroup2=ospfIfGroup2, ospfRestartAge=ospfRestartAge, PYSNMP_MODULE_ID=ospf, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubMetricType=ospfStubMetricType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfLsaCount=ospfIfLsaCount, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfDemandExtensions=ospfDemandExtensions, ospfHostAreaID=ospfHostAreaID, ospfIfTable=ospfIfTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfStubAreaEntry=ospfStubAreaEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, OspfAuthenticationType=OspfAuthenticationType, ospfAreaId=ospfAreaId, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbEntry=ospfLsdbEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbSequence=ospfLsdbSequence, ospfCompliance2=ospfCompliance2, ospfVirtIfAuthType=ospfVirtIfAuthType, UpToMaxAge=UpToMaxAge, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrRtrId=ospfNbrRtrId, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtIfTable=ospfVirtIfTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfAuthType=ospfIfAuthType, ospfAreaRangeNet=ospfAreaRangeNet, ospfHostTOS=ospfHostTOS, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrEntry=ospfVirtNbrEntry, Status=Status, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfType=ospfIfType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrState=ospfNbrState, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfNbrTable=ospfNbrTable, ospfNbrEntry=ospfNbrEntry, ospfLsdbTable=ospfLsdbTable, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfIpAddress=ospfIfIpAddress, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfHelloInterval=ospfIfHelloInterval, ospfHostGroup2=ospfHostGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaGroup2=ospfAreaGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, BigMetric=BigMetric, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfObsoleteGroup=ospfObsoleteGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubAreaId=ospfStubAreaId, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIntraArea=ospfIntraArea, ospfExternalType2=ospfExternalType2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVersionNumber=ospfVersionNumber, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfHostEntry=ospfHostEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfEntry=ospfIfEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaTable=ospfAreaTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsdbTable=ospfAsLsdbTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfHostStatus=ospfHostStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfExternalType1=ospfExternalType1, ospfStubAreaTable=ospfStubAreaTable, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMetricTable=ospfIfMetricTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfBasicGroup2=ospfBasicGroup2)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfImportAsExtern=ospfImportAsExtern, ospfIfMulticastForwarding=ospfIfMulticastForwarding)
