...
mibBuilder.exportSymbols("OSPF-MIB", DesignatedRouterPriority=DesignatedRouterPriority, ospfIfState=ospfIfState, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrGroup=ospfNbrGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostEntry=ospfHostEntry, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfRestartInterval=ospfRestartInterval, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaGroup=ospfAreaGroup, ospfExternalType2=ospfExternalType2, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAddressLessIf=ospfAddressLessIf, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubMetricType=ospfStubMetricType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfHostIpAddress=ospfHostIpAddress, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbType=ospfAsLsdbType, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfRouterId=ospfRouterId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfDemandExtensions=ospfDemandExtensions, ospfMulticastExtensions=ospfMulticastExtensions, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaEntry=ospfAreaEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, Metric=Metric, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, PositiveInteger=PositiveInteger, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfCompliance2=ospfCompliance2, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfStatus=ospfIfStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfRouteGroup=ospfRouteGroup, ospfGroups=ospfGroups, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfTOSSupport=ospfTOSSupport, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLsdbLsid=ospfLsdbLsid, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, HelloRange=HelloRange, ospfLsdbAge=ospfLsdbAge, UpToMaxAge=UpToMaxAge, ospfAreaSummary=ospfAreaSummary, ospfStubAreaTable=ospfStubAreaTable, OspfAuthenticationType=OspfAuthenticationType, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfImportAsExtern=ospfImportAsExtern, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfAreaId=ospfIfAreaId, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLsdbSequence=ospfLsdbSequence, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfMetricTable=ospfIfMetricTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAuthType=ospfAuthType, ospfGeneralGroup=ospfGeneralGroup, ospfIfLsaCount=ospfIfLsaCount, AreaID=AreaID, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaRangeNet=ospfAreaRangeNet, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAdminStat=ospfAdminStat, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaId=ospfAreaId, PYSNMP_MODULE_ID=ospf, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfMetricTOS=ospfIfMetricTOS, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfDemand=ospfIfDemand, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbType=ospfLsdbType, ospfHostGroup=ospfHostGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrGroup2=ospfNbrGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMetricValue=ospfIfMetricValue, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfRestartSupport=ospfRestartSupport, ospfExtLsdbType=ospfExtLsdbType, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubTOS=ospfStubTOS, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLsdbChecksum=ospfLsdbChecksum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfMetricGroup=ospfIfMetricGroup, ospfExternLsaCount=ospfExternLsaCount, ospfIfAuthType=ospfIfAuthType, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaRangeTable=ospfAreaRangeTable, ospfCompliances=ospfCompliances, ospfInterArea=ospfInterArea, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrRtrId=ospfNbrRtrId, ospfIfGroup2=ospfIfGroup2, ospfIfType=ospfIfType, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, TOSType=TOSType, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrTable=ospfNbrTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfEvents=ospfIfEvents, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfAuthKey=ospfIfAuthKey, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfStubStatus=ospfStubStatus, ospfHostTable=ospfHostTable, ospfAreaStatus=ospfAreaStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfTable=ospfVirtIfTable, ospfCompliance=ospfCompliance, ospfNbrState=ospfNbrState, ospfNbrEntry=ospfNbrEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostTOS=ospfHostTOS, ospfExtLsdbTable=ospfExtLsdbTable, ospfVersionNumber=ospfVersionNumber, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfBasicGroup=ospfBasicGroup, ospfHostGroup2=ospfHostGroup2, ospf=ospf, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrArea=ospfVirtNbrArea, ospfStubAreaEntry=ospfStubAreaEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfAdminStat=ospfIfAdminStat, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfStubAreaId=ospfStubAreaId, ospfStubMetric=ospfStubMetric, ospfVirtIfState=ospfVirtIfState, ospfRestartAge=ospfRestartAge, ospfAsLsaCount=ospfAsLsaCount, ospfIfPollInterval=ospfIfPollInterval, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLsdbAreaId=ospfLsdbAreaId, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfHostStatus=ospfHostStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLsdbGroup=ospfLsdbGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfRtrPriority=ospfIfRtrPriority, ospfConformance=ospfConformance, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbTable=ospfLsdbTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfEntry=ospfIfEntry, ospfStubRouterSupport=ospfStubRouterSupport, ospfSpfRuns=ospfSpfRuns, Status=Status, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfBasicGroup2=ospfBasicGroup2, ospfNbrOptions=ospfNbrOptions, ospfRxNewLsas=ospfRxNewLsas, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfRestartStatus=ospfRestartStatus, RouterID=RouterID, ospfIfGroup=ospfIfGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, BigMetric=BigMetric, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfTable=ospfIfTable, ospfNbrPriority=ospfNbrPriority, ospfAreaTable=ospfAreaTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfHostMetric=ospfHostMetric)
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrEvents=ospfNbrEvents)
