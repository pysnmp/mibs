...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAddressLessIf=ospfAddressLessIf, ospfIfRetransInterval=ospfIfRetransInterval, Status=Status, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfBasicGroup2=ospfBasicGroup2, ospfRxNewLsas=ospfRxNewLsas, ospfRestartSupport=ospfRestartSupport, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaRangeNet=ospfAreaRangeNet, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbType=ospfLocalLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrGroup2=ospfNbrGroup2, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaId=ospfAreaId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrEntry=ospfVirtNbrEntry, TOSType=TOSType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfAuthKey=ospfIfAuthKey, ospfBasicGroup=ospfBasicGroup, ospfAdminStat=ospfAdminStat, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, PositiveInteger=PositiveInteger, ospfIfGroup2=ospfIfGroup2, ospfAuthType=ospfAuthType, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaTable=ospfAreaTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfStubAreaTable=ospfStubAreaTable, ospfHostEntry=ospfHostEntry, ospfVirtIfTable=ospfVirtIfTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLocalLsdbLsid=ospfLocalLsdbLsid, HelloRange=HelloRange, ospfIfStatus=ospfIfStatus, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospf=ospf, ospfAreaStatus=ospfAreaStatus, UpToMaxAge=UpToMaxAge, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfGroups=ospfGroups, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrState=ospfVirtNbrState, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrEntry=ospfNbrEntry, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfGroup=ospfIfGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbGroup=ospfLocalLsdbGroup, PYSNMP_MODULE_ID=ospf, ospfNbrTable=ospfNbrTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfMetricTOS=ospfIfMetricTOS, ospfHostMetric=ospfHostMetric, ospfRestartAge=ospfRestartAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfDemand=ospfIfDemand, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfStubAreaId=ospfStubAreaId, ospfLsdbLsid=ospfLsdbLsid, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVersionNumber=ospfVersionNumber, ospfLsdbType=ospfLsdbType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfState=ospfIfState, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaSummary=ospfAreaSummary, ospfIfIpAddress=ospfIfIpAddress, ospfHostTable=ospfHostTable, ospfIfAreaId=ospfIfAreaId, RouterID=RouterID, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfRouterId=ospfRouterId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsLsdbType=ospfAsLsdbType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfNbrPriority=ospfNbrPriority, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubStatus=ospfStubStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrGroup=ospfNbrGroup, ospfIfType=ospfIfType, ospfExternLsaCount=ospfExternLsaCount, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfStubMetricType=ospfStubMetricType, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfDemandExtensions=ospfDemandExtensions, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfRestartStatus=ospfRestartStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaGroup=ospfAreaGroup, ospfCompliances=ospfCompliances, ospfHostGroup2=ospfHostGroup2, ospfImportAsExtern=ospfImportAsExtern, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrTable=ospfVirtNbrTable, AreaID=AreaID, ospfIfTable=ospfIfTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfPollInterval=ospfIfPollInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLsdbAge=ospfLsdbAge, ospfIfEvents=ospfIfEvents, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, Metric=Metric, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubTOS=ospfStubTOS, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbType=ospfExtLsdbType, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfHostTOS=ospfHostTOS, ospfIfEntry=ospfIfEntry, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbrOptions=ospfNbrOptions, ospfCompliance2=ospfCompliance2, ospfRouteGroup=ospfRouteGroup, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfStubAreaEntry=ospfStubAreaEntry, ospfLsdbTable=ospfLsdbTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrArea=ospfVirtNbrArea, BigMetric=BigMetric, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrEvents=ospfNbrEvents, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfObsoleteGroup=ospfObsoleteGroup, ospfExternalType2=ospfExternalType2, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbAge=ospfAsLsdbAge, ospfHostStatus=ospfHostStatus, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfConformance=ospfConformance, ospfInterArea=ospfInterArea, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfCompliance=ospfCompliance, ospfAsLsaCount=ospfAsLsaCount, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfHostGroup=ospfHostGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfTOSSupport=ospfTOSSupport, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostAreaID=ospfHostAreaID, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfExternalType1=ospfExternalType1, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, OspfAuthenticationType=OspfAuthenticationType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfStubMetric=ospfStubMetric, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfAreaId=ospfVirtIfAreaId)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfSpfRuns=ospfSpfRuns)
