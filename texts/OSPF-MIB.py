...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfRestartExitReason=ospfRestartExitReason, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfAuthKey=ospfIfAuthKey, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfState=ospfVirtIfState, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfTable=ospfIfTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfExternalType2=ospfExternalType2, ospfStubStatus=ospfStubStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, HelloRange=HelloRange, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfMetricTOS=ospfIfMetricTOS, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostIpAddress=ospfHostIpAddress, ospfStubMetricType=ospfStubMetricType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfInterArea=ospfInterArea, ospfIfAdminStat=ospfIfAdminStat, ospfLsdbChecksum=ospfLsdbChecksum, ospfImportAsExtern=ospfImportAsExtern, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExternalType1=ospfExternalType1, ospfAreaStatus=ospfAreaStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrGroup2=ospfNbrGroup2, ospfRouteGroup=ospfRouteGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfHostGroup2=ospfHostGroup2, ospfVirtIfLsaCount=ospfVirtIfLsaCount, PYSNMP_MODULE_ID=ospf, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAdminStat=ospfAdminStat, ospfIfAuthType=ospfIfAuthType, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostStatus=ospfHostStatus, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbEntry=ospfLocalLsdbEntry, BigMetric=BigMetric, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLsdbAdvertisement=ospfLsdbAdvertisement, PositiveInteger=PositiveInteger, ospfExtLsdbSequence=ospfExtLsdbSequence, ospf=ospf, ospfNbrRtrId=ospfNbrRtrId, ospfIfState=ospfIfState, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, OspfAuthenticationType=OspfAuthenticationType, ospfLsdbLsid=ospfLsdbLsid, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAsLsdbTable=ospfAsLsdbTable, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrOptions=ospfNbrOptions, ospfHostGroup=ospfHostGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfGeneralGroup=ospfGeneralGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfDemandExtensions=ospfDemandExtensions, ospfAreaTable=ospfAreaTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, Metric=Metric, ospfVirtIfStatus=ospfVirtIfStatus, ospfStubAreaGroup=ospfStubAreaGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateStatus=ospfAreaAggregateStatus, Status=Status, ospfLsdbTable=ospfLsdbTable, ospfGroups=ospfGroups, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfRtrPriority=ospfIfRtrPriority, ospfCompliance=ospfCompliance, AreaID=AreaID, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfHostMetric=ospfHostMetric, ospfConformance=ospfConformance, ospfRestartStatus=ospfRestartStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfAreaId=ospfIfAreaId, ospfHostEntry=ospfHostEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfRouterId=ospfRouterId, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAddressLessIf=ospfAddressLessIf, ospfCompliances=ospfCompliances, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfBasicGroup=ospfBasicGroup, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLsdbAge=ospfLsdbAge, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfStubMetric=ospfStubMetric, ospfHostAreaID=ospfHostAreaID, ospfNbrState=ospfNbrState, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfType=ospfIfType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsLsdbType=ospfAsLsdbType, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfEntry=ospfIfEntry, ospfCompliance2=ospfCompliance2, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaSummary=ospfAreaSummary, ospfAuthType=ospfAuthType, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMetricTable=ospfIfMetricTable, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExternLsaCount=ospfExternLsaCount, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfNbrEvents=ospfNbrEvents, ospfStubTOS=ospfStubTOS, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbType=ospfLsdbType, ospfIfEvents=ospfIfEvents, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrTable=ospfNbrTable, ospfIfGroup2=ospfIfGroup2, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfDemand=ospfIfDemand, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfRestartAge=ospfRestartAge, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfTOSSupport=ospfTOSSupport, ospfNbrEntry=ospfNbrEntry, ospfRestartInterval=ospfRestartInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLsdbGroup=ospfLsdbGroup, UpToMaxAge=UpToMaxAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostTable=ospfHostTable, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfBasicGroup2=ospfBasicGroup2, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaGroup2=ospfAreaGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, TOSType=TOSType, ospfAreaId=ospfAreaId, ospfNbrPriority=ospfNbrPriority, ospfIfPollInterval=ospfIfPollInterval, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAsLsaCount=ospfAsLsaCount, ospfObsoleteGroup=ospfObsoleteGroup, ospfHostTOS=ospfHostTOS, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfTable=ospfVirtIfTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVersionNumber=ospfVersionNumber, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricValue=ospfIfMetricValue, ospfAreaEntry=ospfAreaEntry, ospfIfStatus=ospfIfStatus, ospfRxNewLsas=ospfRxNewLsas, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbType=ospfExtLsdbType, ospfIfGroup=ospfIfGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtIfEvents=ospfVirtIfEvents)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrGroup=ospfNbrGroup, RouterID=RouterID, ospfExtLsdbGroup=ospfExtLsdbGroup)
