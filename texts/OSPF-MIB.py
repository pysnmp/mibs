...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, PositiveInteger=PositiveInteger, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfIfTable=ospfIfTable, ospfVirtNbrState=ospfVirtNbrState, ospfVirtIfGroup=ospfVirtIfGroup, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfSpfRuns=ospfSpfRuns, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaTable=ospfAreaTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfState=ospfVirtIfState, ospfAdminStat=ospfAdminStat, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfGroup=ospfIfGroup, ospfIfMetricValue=ospfIfMetricValue, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfConformance=ospfConformance, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, Metric=Metric, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRestartAge=ospfRestartAge, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfCompliance2=ospfCompliance2, ospfAuthType=ospfAuthType, ospfAreaSummary=ospfAreaSummary, ospfVirtIfTable=ospfVirtIfTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfNbrEvents=ospfNbrEvents, ospfStubAreaId=ospfStubAreaId, AreaID=AreaID, ospfVirtNbrTable=ospfVirtNbrTable, ospfGroups=ospfGroups, ospfBasicGroup=ospfBasicGroup, ospfAreaGroup=ospfAreaGroup, ospfLsdbSequence=ospfLsdbSequence, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrGroup=ospfNbrGroup, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrIpAddr=ospfNbrIpAddr, OspfAuthenticationType=OspfAuthenticationType, ospfRestartStatus=ospfRestartStatus, ospfIfState=ospfIfState, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfTOSSupport=ospfTOSSupport, ospfHostAreaID=ospfHostAreaID, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfRestartSupport=ospfRestartSupport, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfEntry=ospfIfEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLsdbAge=ospfLsdbAge, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfGroup2=ospfIfGroup2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfHostGroup2=ospfHostGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaId=ospfAreaId, ospfAreaStatus=ospfAreaStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, BigMetric=BigMetric, ospfIfDemand=ospfIfDemand, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfExtLsdbGroup=ospfExtLsdbGroup, DesignatedRouterPriority=DesignatedRouterPriority, Status=Status, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrOptions=ospfNbrOptions, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, UpToMaxAge=UpToMaxAge, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubMetricType=ospfStubMetricType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExternalType1=ospfExternalType1, ospfRxNewLsas=ospfRxNewLsas, ospfIfAdminStat=ospfIfAdminStat, ospfVirtNbrArea=ospfVirtNbrArea, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIntraArea=ospfIntraArea, TOSType=TOSType, ospfHostTable=ospfHostTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubTOS=ospfStubTOS, ospfIfAreaId=ospfIfAreaId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfExternalType2=ospfExternalType2, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfNbrGroup2=ospfNbrGroup2, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfMetricTable=ospfIfMetricTable, ospfDemandExtensions=ospfDemandExtensions, ospfIfStatus=ospfIfStatus, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLsdbEntry=ospfLsdbEntry, ospf=ospf, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbTable=ospfLsdbTable, ospfExternLsaCount=ospfExternLsaCount, ospfIfMetricStatus=ospfIfMetricStatus, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfCompliances=ospfCompliances, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfAuthKey=ospfIfAuthKey, ospfAreaGroup2=ospfAreaGroup2, RouterID=RouterID, ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfHostEntry=ospfHostEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfRestartInterval=ospfRestartInterval, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfStatus=ospfVirtIfStatus, PYSNMP_MODULE_ID=ospf, ospfStubStatus=ospfStubStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaEntry=ospfAreaEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfBasicGroup2=ospfBasicGroup2, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMetricGroup=ospfIfMetricGroup, ospfInterArea=ospfInterArea, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLsdbType=ospfLsdbType, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfVersionNumber=ospfVersionNumber, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostStatus=ospfHostStatus, ospfLocalLsdbType=ospfLocalLsdbType, HelloRange=HelloRange, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfExtLsdbType=ospfExtLsdbType, ospfIfType=ospfIfType, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAddressLessIf=ospfAddressLessIf, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfIpAddress=ospfIfIpAddress, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfCompliance=ospfCompliance, ospfAreaRangeTable=ospfAreaRangeTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostTOS=ospfHostTOS, ospfHostMetric=ospfHostMetric, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrState=ospfNbrState, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfGeneralGroup=ospfGeneralGroup, ospfStubMetric=ospfStubMetric, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfHostGroup=ospfHostGroup, ospfLsdbLsid=ospfLsdbLsid, ospfIfAuthType=ospfIfAuthType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfHostIpAddress=ospfHostIpAddress, ospfRouteGroup=ospfRouteGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfEvents=ospfIfEvents)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfRetransInterval=ospfIfRetransInterval, ospfLsdbAreaId=ospfLsdbAreaId, ospfRouterId=ospfRouterId, ospfNbrTable=ospfNbrTable)
