...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrOptions=ospfVirtNbrOptions, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfNbrEntry=ospfNbrEntry, ospfImportAsExtern=ospfImportAsExtern, UpToMaxAge=UpToMaxAge, ospfVersionNumber=ospfVersionNumber, ospfExternLsaCount=ospfExternLsaCount, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfHostGroup=ospfHostGroup, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbRouterId=ospfLsdbRouterId, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbEntry=ospfLsdbEntry, ospfRestartStatus=ospfRestartStatus, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfStubMetricType=ospfStubMetricType, ospfInterArea=ospfInterArea, ospfLsdbLsid=ospfLsdbLsid, ospfBasicGroup=ospfBasicGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbTable=ospfExtLsdbTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfExternalType1=ospfExternalType1, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricValue=ospfIfMetricValue, ospfIfEvents=ospfIfEvents, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaStatus=ospfAreaStatus, ospfExtLsdbType=ospfExtLsdbType, ospf=ospf, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, HelloRange=HelloRange, ospfAreaEntry=ospfAreaEntry, ospfIfType=ospfIfType, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrEvents=ospfNbrEvents, ospfIfDemand=ospfIfDemand, ospfCompliances=ospfCompliances, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, AreaID=AreaID, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaRangeNet=ospfAreaRangeNet, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfStubAreaTable=ospfStubAreaTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfHostGroup2=ospfHostGroup2, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMetricTable=ospfIfMetricTable, ospfAuthType=ospfAuthType, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaTable=ospfAreaTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfIpAddress=ospfIfIpAddress, ospfDemandExtensions=ospfDemandExtensions, ospfIfState=ospfIfState, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrRtrId=ospfNbrRtrId, ospfAsLsaCount=ospfAsLsaCount, ospfStubMetric=ospfStubMetric, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfCompliance2=ospfCompliance2, ospfAreaSummary=ospfAreaSummary, ospfHostEntry=ospfHostEntry, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRouterId=ospfRouterId, ospfAddressLessIf=ospfAddressLessIf, ospfNbrState=ospfNbrState, PositiveInteger=PositiveInteger, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfHostMetric=ospfHostMetric, ospfHostTable=ospfHostTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfTransitDelay=ospfIfTransitDelay, ospfIntraArea=ospfIntraArea, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfGroup2=ospfIfGroup2, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfHostIpAddress=ospfHostIpAddress, ospfAdminStat=ospfAdminStat, ospfHostAreaID=ospfHostAreaID, ospfIfLsaCksumSum=ospfIfLsaCksumSum, Metric=Metric, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfMetricTOS=ospfIfMetricTOS, ospfHostStatus=ospfHostStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtIfStatus=ospfVirtIfStatus, PYSNMP_MODULE_ID=ospf, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfLsdbAge=ospfLsdbAge, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrTable=ospfNbrTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtIfState=ospfVirtIfState, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExternalType2=ospfExternalType2, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrPriority=ospfNbrPriority, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfHostTOS=ospfHostTOS, ospfIfTable=ospfIfTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartSupport=ospfRestartSupport, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfAuthKey=ospfIfAuthKey, ospfAreaGroup2=ospfAreaGroup2, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeMask=ospfAreaRangeMask, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbChecksum=ospfLsdbChecksum, ospfGroups=ospfGroups, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrGroup=ospfNbrGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfStatus=ospfIfStatus, TOSType=TOSType, ospfSpfRuns=ospfSpfRuns, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfEntry=ospfIfEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLsdbGroup=ospfLsdbGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, RouterID=RouterID, BigMetric=BigMetric, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfGeneralGroup=ospfGeneralGroup, ospfRouteGroup=ospfRouteGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, OspfAuthenticationType=OspfAuthenticationType, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLsdbAdvertisement=ospfLsdbAdvertisement, Status=Status, ospfTOSSupport=ospfTOSSupport, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfAuthType=ospfIfAuthType, ospfLsdbType=ospfLsdbType, ospfNbrGroup2=ospfNbrGroup2, ospfStubAreaId=ospfStubAreaId, ospfLsdbTable=ospfLsdbTable, ospfAreaId=ospfAreaId, ospfIfLsaCount=ospfIfLsaCount, ospfBasicGroup2=ospfBasicGroup2, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfAdminStat=ospfIfAdminStat, ospfAsLsdbType=ospfAsLsdbType, ospfRxNewLsas=ospfRxNewLsas, ospfVirtIfTable=ospfVirtIfTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfStubStatus=ospfStubStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRestartInterval=ospfRestartInterval, ospfCompliance=ospfCompliance, ospfIfGroup=ospfIfGroup, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaGroup=ospfAreaGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfMetricStatus=ospfIfMetricStatus, ospfConformance=ospfConformance, ospfIfAreaId=ospfIfAreaId, ospfStubTOS=ospfStubTOS, ospfLsdbAreaId=ospfLsdbAreaId)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfMulticastExtensions=ospfMulticastExtensions, ospfRestartAge=ospfRestartAge, ospfVirtNbrEvents=ospfVirtNbrEvents)
