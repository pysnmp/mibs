...
mibBuilder.exportSymbols("OSPF-MIB", ospfDemandExtensions=ospfDemandExtensions, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfIpAddress=ospfIfIpAddress, ospfHostGroup=ospfHostGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbType=ospfLsdbType, ospfAsLsdbType=ospfAsLsdbType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLsdbLsid=ospfLsdbLsid, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfRouteGroup=ospfRouteGroup, ospfIfStatus=ospfIfStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfHostGroup2=ospfHostGroup2, ospfVirtIfEvents=ospfVirtIfEvents, ospfBasicGroup2=ospfBasicGroup2, ospfAreaAggregateTable=ospfAreaAggregateTable, RouterID=RouterID, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfType=ospfIfType, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaId=ospfAreaId, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfRestartSupport=ospfRestartSupport, ospfAreaRangeMask=ospfAreaRangeMask, ospfCompliance2=ospfCompliance2, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaLsaCount=ospfAreaLsaCount, ospfCompliance=ospfCompliance, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLsdbSequence=ospfLsdbSequence, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfImportAsExtern=ospfImportAsExtern, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbAge=ospfAsLsdbAge, ospfRestartExitReason=ospfRestartExitReason, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrPriority=ospfNbrPriority, ospfIfMetricValue=ospfIfMetricValue, ospfGroups=ospfGroups, ospfAreaSummary=ospfAreaSummary, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLsdbGroup=ospfLsdbGroup, ospfAreaStatus=ospfAreaStatus, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfTable=ospfIfTable, ospfIfAuthKey=ospfIfAuthKey, ospfNbrRtrId=ospfNbrRtrId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRestartAge=ospfRestartAge, ospfHostStatus=ospfHostStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAddressLessIf=ospfAddressLessIf, ospfStubMetric=ospfStubMetric, ospfCompliances=ospfCompliances, ospfNbrState=ospfNbrState, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfTransitDelay=ospfIfTransitDelay, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrGroup=ospfNbrGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLocalLsdbLsid=ospfLocalLsdbLsid, AreaID=AreaID, ospfIfAreaId=ospfIfAreaId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfStubMetricType=ospfStubMetricType, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVersionNumber=ospfVersionNumber, ospfLsdbTable=ospfLsdbTable, ospfIfPollInterval=ospfIfPollInterval, PositiveInteger=PositiveInteger, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfObsoleteGroup=ospfObsoleteGroup, ospfHostTable=ospfHostTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfConformance=ospfConformance, ospfBasicGroup=ospfBasicGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIntraArea=ospfIntraArea, ospfAreaRangeTable=ospfAreaRangeTable, TOSType=TOSType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostIpAddress=ospfHostIpAddress, ospfRestartStatus=ospfRestartStatus, ospfAreaEntry=ospfAreaEntry, ospfHostEntry=ospfHostEntry, PYSNMP_MODULE_ID=ospf, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfRouterId=ospfRouterId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExternalType2=ospfExternalType2, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfAuthType=ospfIfAuthType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLsdbEntry=ospfLsdbEntry, ospfIfLsaCount=ospfIfLsaCount, ospfIfDemand=ospfIfDemand, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAdminStat=ospfAdminStat, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrEvents=ospfNbrEvents, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubStatus=ospfStubStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, Metric=Metric, ospfLsdbAge=ospfLsdbAge, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, UpToMaxAge=UpToMaxAge, ospfVirtIfState=ospfVirtIfState, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfSpfRuns=ospfSpfRuns, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfHostMetric=ospfHostMetric, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfStubAreaId=ospfStubAreaId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfEntry=ospfIfEntry, ospfAreaGroup2=ospfAreaGroup2, HelloRange=HelloRange, BigMetric=BigMetric, ospfNbrTable=ospfNbrTable, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfState=ospfIfState, ospfVirtNbrArea=ospfVirtNbrArea, ospfNbrOptions=ospfNbrOptions, ospfAreaTable=ospfAreaTable, ospfRestartInterval=ospfRestartInterval, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfTOSSupport=ospfTOSSupport, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfHostTOS=ospfHostTOS, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfStubTOS=ospfStubTOS, ospfNbrEntry=ospfNbrEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, Status=Status, ospf=ospf, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfAdminStat=ospfIfAdminStat, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfGroup2=ospfIfGroup2, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfEvents=ospfIfEvents, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfMetricTable=ospfIfMetricTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExternLsaCount=ospfExternLsaCount, ospfHostAreaID=ospfHostAreaID, ospfAuthType=ospfAuthType, ospfAsLsaCount=ospfAsLsaCount)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfGroup=ospfIfGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfExternalType1=ospfExternalType1)
