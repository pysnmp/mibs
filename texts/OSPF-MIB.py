...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfRouterId=ospfRouterId, ospfRestartAge=ospfRestartAge, ospfVirtNbrTable=ospfVirtNbrTable, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfInterArea=ospfInterArea, ospfLsdbAge=ospfLsdbAge, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfPollInterval=ospfIfPollInterval, ospfConformance=ospfConformance, TOSType=TOSType, ospfVirtIfState=ospfVirtIfState, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfAreaId=ospfIfAreaId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfHostGroup=ospfHostGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfGroup2=ospfIfGroup2, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfState=ospfIfState, ospfCompliances=ospfCompliances, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostGroup2=ospfHostGroup2, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfMulticastExtensions=ospfMulticastExtensions, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostTable=ospfHostTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVersionNumber=ospfVersionNumber, ospfLsdbLsid=ospfLsdbLsid, ospfIfMetricTable=ospfIfMetricTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfHostStatus=ospfHostStatus, ospfHostTOS=ospfHostTOS, ospfHostAreaID=ospfHostAreaID, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfHostIpAddress=ospfHostIpAddress, ospfStubTOS=ospfStubTOS, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaId=ospfAreaId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaGroup2=ospfAreaGroup2, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfType=ospfIfType, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfGeneralGroup=ospfGeneralGroup, ospfImportAsExtern=ospfImportAsExtern, ospfNbrGroup2=ospfNbrGroup2, OspfAuthenticationType=OspfAuthenticationType, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, Metric=Metric, ospfVirtIfStatus=ospfVirtIfStatus, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfNbrEntry=ospfNbrEntry, ospfIfGroup=ospfIfGroup, ospfSpfRuns=ospfSpfRuns, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaRangeMask=ospfAreaRangeMask, BigMetric=BigMetric, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExtLsdbType=ospfExtLsdbType, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExternalType1=ospfExternalType1, ospfLsdbEntry=ospfLsdbEntry, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfDemandExtensions=ospfDemandExtensions, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, RouterID=RouterID, ospfLsdbTable=ospfLsdbTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartStatus=ospfRestartStatus, ospfAreaSummary=ospfAreaSummary, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfEntry=ospfIfEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaStatus=ospfAreaStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospf=ospf, PYSNMP_MODULE_ID=ospf, ospfIfLsaCount=ospfIfLsaCount, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrTable=ospfNbrTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaTable=ospfAreaTable, ospfAreaEntry=ospfAreaEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExternalType2=ospfExternalType2, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfIpAddress=ospfIfIpAddress, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubStatus=ospfStubStatus, ospfStubAreaTable=ospfStubAreaTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIntraArea=ospfIntraArea, ospfIfStatus=ospfIfStatus, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbSequence=ospfLsdbSequence, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostEntry=ospfHostEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfEvents=ospfIfEvents, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfStubMetricType=ospfStubMetricType, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, UpToMaxAge=UpToMaxAge, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, AreaID=AreaID, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfRestartInterval=ospfRestartInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfCompliance=ospfCompliance, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfBasicGroup=ospfBasicGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfComplianceObsolete=ospfComplianceObsolete, ospfExternLsaCount=ospfExternLsaCount, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfTable=ospfIfTable, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfStubMetric=ospfStubMetric, ospfHostMetric=ospfHostMetric, ospfNbrState=ospfNbrState, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrGroup=ospfNbrGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLsdbType=ospfLsdbType, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAuthType=ospfAuthType, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfGroups=ospfGroups, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAdminStat=ospfAdminStat, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaRangeNet=ospfAreaRangeNet, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRouteGroup=ospfRouteGroup, Status=Status, ospfNbrPriority=ospfNbrPriority, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, PositiveInteger=PositiveInteger, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfRestartExitReason=ospfRestartExitReason, ospfStubAreaEntry=ospfStubAreaEntry, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsLsdbType=ospfAsLsdbType, ospfBasicGroup2=ospfBasicGroup2, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaGroup=ospfAreaGroup, ospfIfAdminStat=ospfIfAdminStat, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsaCount=ospfAsLsaCount, ospfStubAreaId=ospfStubAreaId, ospfCompliance2=ospfCompliance2, HelloRange=HelloRange, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaRangeAreaId=ospfAreaRangeAreaId)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfDemand=ospfIfDemand, ospfRestartSupport=ospfRestartSupport)
