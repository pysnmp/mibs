...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfCompliance=ospfCompliance, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfExternalType1=ospfExternalType1, DesignatedRouterPriority=DesignatedRouterPriority, ospfRestartStatus=ospfRestartStatus, ospfIfAuthType=ospfIfAuthType, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfTable=ospfIfTable, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLsdbType=ospfLsdbType, ospfBasicGroup=ospfBasicGroup, ospfVirtIfTable=ospfVirtIfTable, ospfStubMetricType=ospfStubMetricType, ospfTOSSupport=ospfTOSSupport, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfPollInterval=ospfIfPollInterval, ospfNbrTable=ospfNbrTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfHostTOS=ospfHostTOS, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRouteGroup=ospfRouteGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostMetric=ospfHostMetric, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, BigMetric=BigMetric, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfGroup=ospfIfGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfMetricTable=ospfIfMetricTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfCompliance2=ospfCompliance2, ospfIfEvents=ospfIfEvents, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfLsaCount=ospfIfLsaCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospf=ospf, ospfHostAreaID=ospfHostAreaID, PositiveInteger=PositiveInteger, ospfIfAreaId=ospfIfAreaId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfHostTable=ospfHostTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfState=ospfIfState, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfLsdbRouterId=ospfLsdbRouterId, ospfStubAreaId=ospfStubAreaId, ospfSpfRuns=ospfSpfRuns, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaLsaCount=ospfAreaLsaCount, ospfStubStatus=ospfStubStatus, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfRestartInterval=ospfRestartInterval, ospfIfIpAddress=ospfIfIpAddress, ospfGroups=ospfGroups, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricTOS=ospfIfMetricTOS, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, AreaID=AreaID, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrGroup=ospfNbrGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfHostGroup2=ospfHostGroup2, ospfNbrState=ospfNbrState, ospfVirtNbrState=ospfVirtNbrState, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfStubMetric=ospfStubMetric, ospfMulticastExtensions=ospfMulticastExtensions, RouterID=RouterID, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfBasicGroup2=ospfBasicGroup2, ospfAreaSummary=ospfAreaSummary, ospfNbrIpAddr=ospfNbrIpAddr, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfConformance=ospfConformance, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVersionNumber=ospfVersionNumber, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaAggregateTable=ospfAreaAggregateTable, HelloRange=HelloRange, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExtLsdbType=ospfExtLsdbType, TOSType=TOSType, ospfIfHelloInterval=ospfIfHelloInterval, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAuthType=ospfAuthType, ospfHostGroup=ospfHostGroup, ospfLsdbTable=ospfLsdbTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfMetricValue=ospfIfMetricValue, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfHostIpAddress=ospfHostIpAddress, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfState=ospfVirtIfState, ospfAreaStatus=ospfAreaStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfGroup2=ospfIfGroup2, OspfAuthenticationType=OspfAuthenticationType, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaGroup=ospfAreaGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfCompliances=ospfCompliances, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAsLsaCount=ospfAsLsaCount, ospfAdminStat=ospfAdminStat, ospfRestartAge=ospfRestartAge, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrPriority=ospfNbrPriority, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, Metric=Metric, ospfAsLsdbType=ospfAsLsdbType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, UpToMaxAge=UpToMaxAge, ospfStubTOS=ospfStubTOS, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaId=ospfAreaId, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, Status=Status, ospfIfEntry=ospfIfEntry, ospfImportAsExtern=ospfImportAsExtern, ospfIfDemand=ospfIfDemand, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfTransitDelay=ospfIfTransitDelay, ospfLsdbAreaId=ospfLsdbAreaId, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfRouterId=ospfRouterId, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfGroup=ospfVirtIfGroup, ospfGeneralGroup=ospfGeneralGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfRestartSupport=ospfRestartSupport, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostStatus=ospfHostStatus, ospfIfAdminStat=ospfIfAdminStat, ospfLsdbGroup=ospfLsdbGroup, ospfLsdbLsid=ospfLsdbLsid, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaTable=ospfAreaTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfType=ospfIfType, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfExternLsaCount=ospfExternLsaCount, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLsdbAge=ospfLsdbAge, ospfHostEntry=ospfHostEntry, PYSNMP_MODULE_ID=ospf, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfStatus=ospfIfStatus, ospfRxNewLsas=ospfRxNewLsas, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExtLsdbAge=ospfExtLsdbAge, ospfNbrGroup2=ospfNbrGroup2, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfRestartExitReason=ospfRestartExitReason, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfStubAreaTable=ospfStubAreaTable, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfDemandExtensions=ospfDemandExtensions, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrOptions=ospfNbrOptions, ospfExternalType2=ospfExternalType2, ospfIntraArea=ospfIntraArea)
