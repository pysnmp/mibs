...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrGroup=ospfNbrGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubMetric=ospfStubMetric, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfAuthKey=ospfIfAuthKey, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospf=ospf, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfEvents=ospfVirtIfEvents, ospfRestartAge=ospfRestartAge, ospfAreaTable=ospfAreaTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfType=ospfIfType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfHelloInterval=ospfIfHelloInterval, ospfHostGroup=ospfHostGroup, ospfAreaEntry=ospfAreaEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, Metric=Metric, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrRtrId=ospfNbrRtrId, ospfExternalType2=ospfExternalType2, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfIpAddress=ospfIfIpAddress, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaGroup=ospfAreaGroup, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, PYSNMP_MODULE_ID=ospf, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfAuthType=ospfIfAuthType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, PositiveInteger=PositiveInteger, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfLsaCount=ospfIfLsaCount, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfStatus=ospfIfStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfSpfRuns=ospfSpfRuns, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfImportAsExtern=ospfImportAsExtern, ospfVersionNumber=ospfVersionNumber, ospfLsdbSequence=ospfLsdbSequence, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfHostTOS=ospfHostTOS, ospfIfMetricTOS=ospfIfMetricTOS, RouterID=RouterID, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfStubTOS=ospfStubTOS, ospfGroups=ospfGroups, BigMetric=BigMetric, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfNbrEvents=ospfNbrEvents, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaId=ospfAreaId, ospfVirtNbrGroup=ospfVirtNbrGroup, HelloRange=HelloRange, ospfLsdbAreaId=ospfLsdbAreaId, ospfInterArea=ospfInterArea, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, TOSType=TOSType, ospfAddressLessIf=ospfAddressLessIf, ospfIntraArea=ospfIntraArea, ospfVirtIfStatus=ospfVirtIfStatus, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfState=ospfIfState, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrEntry=ospfNbrEntry, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricValue=ospfIfMetricValue, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfGroup2=ospfIfGroup2, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrState=ospfVirtNbrState, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfBasicGroup2=ospfBasicGroup2, ospfHostStatus=ospfHostStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfEvents=ospfIfEvents, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubAreaEntry=ospfStubAreaEntry, ospfRestartStatus=ospfRestartStatus, ospfStubStatus=ospfStubStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfCompliances=ospfCompliances, ospfStubAreaId=ospfStubAreaId, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfEntry=ospfIfEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfStubMetricType=ospfStubMetricType, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrPriority=ospfNbrPriority, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMetricTable=ospfIfMetricTable, ospfNbrGroup2=ospfNbrGroup2, ospfHostTable=ospfHostTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLsdbType=ospfLsdbType, ospfIfPollInterval=ospfIfPollInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbAge=ospfLsdbAge, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, UpToMaxAge=UpToMaxAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfHostAreaID=ospfHostAreaID, ospfCompliance2=ospfCompliance2, ospfLsdbGroup=ospfLsdbGroup, ospfAreaSummary=ospfAreaSummary, ospfExternalType1=ospfExternalType1, ospfIfGroup=ospfIfGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, Status=Status, ospfLsdbLsid=ospfLsdbLsid, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfStubAreaTable=ospfStubAreaTable, ospfIfAdminStat=ospfIfAdminStat, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfBasicGroup=ospfBasicGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfTOSSupport=ospfTOSSupport, ospfHostEntry=ospfHostEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrOptions=ospfNbrOptions, ospfDemandExtensions=ospfDemandExtensions, ospfRouterId=ospfRouterId, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAuthType=ospfAuthType, ospfIfAreaId=ospfIfAreaId, ospfCompliance=ospfCompliance, ospfHostMetric=ospfHostMetric, ospfIfMetricGroup=ospfIfMetricGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAdminStat=ospfAdminStat, ospfLsdbTable=ospfLsdbTable, ospfIfDemand=ospfIfDemand, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfRestartSupport=ospfRestartSupport, ospfAreaStatus=ospfAreaStatus, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfConformance=ospfConformance, ospfExternLsaCount=ospfExternLsaCount, ospfIfTable=ospfIfTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId)
mibBuilder.exportSymbols("OSPF-MIB", OspfAuthenticationType=OspfAuthenticationType, AreaID=AreaID, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfNbrIpAddr=ospfNbrIpAddr)
