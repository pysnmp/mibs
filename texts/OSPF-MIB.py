...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfDemand=ospfIfDemand, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfTable=ospfIfTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaId=ospfAreaId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfRouterId=ospfRouterId, ospfStubAreaGroup=ospfStubAreaGroup, ospfRestartAge=ospfRestartAge, ospfSpfRuns=ospfSpfRuns, ospfIfPollInterval=ospfIfPollInterval, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfHostEntry=ospfHostEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfStubMetricType=ospfStubMetricType, ospfAuthType=ospfAuthType, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfBasicGroup=ospfBasicGroup, TOSType=TOSType, ospfBasicGroup2=ospfBasicGroup2, ospfVirtIfState=ospfVirtIfState, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaRangeEntry=ospfAreaRangeEntry, BigMetric=BigMetric, ospfExternalType1=ospfExternalType1, ospfIfStatus=ospfIfStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfType=ospfIfType, ospfCompliance2=ospfCompliance2, ospfConformance=ospfConformance, ospfNbrEntry=ospfNbrEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfGeneralGroup=ospfGeneralGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfInterArea=ospfInterArea, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsaCount=ospfAsLsaCount, ospfRestartExitReason=ospfRestartExitReason, ospfIfEntry=ospfIfEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, PYSNMP_MODULE_ID=ospf, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfRxNewLsas=ospfRxNewLsas, ospfIntraArea=ospfIntraArea, ospfIfEvents=ospfIfEvents, RouterID=RouterID, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaGroup=ospfAreaGroup, ospfHostMetric=ospfHostMetric, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfStatus=ospfVirtIfStatus, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrTable=ospfNbrTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfGroups=ospfGroups, ospfLsdbAdvertisement=ospfLsdbAdvertisement, PositiveInteger=PositiveInteger, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, HelloRange=HelloRange, ospfAreaLsaCount=ospfAreaLsaCount, ospfStubRouterSupport=ospfStubRouterSupport, ospfHostTable=ospfHostTable, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbType=ospfLocalLsdbType, ospfRestartSupport=ospfRestartSupport, ospfIfAuthType=ospfIfAuthType, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLsdbGroup=ospfLsdbGroup, ospfStubTOS=ospfStubTOS, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLsdbEntry=ospfLsdbEntry, ospfIfHelloInterval=ospfIfHelloInterval, ospfAddressLessIf=ospfAddressLessIf, ospfCompliance=ospfCompliance, ospfStubAreaId=ospfStubAreaId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfMetricTable=ospfIfMetricTable, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfAdminStat=ospfIfAdminStat, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaTable=ospfAreaTable, ospfStubStatus=ospfStubStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaEntry=ospfAreaEntry, ospfHostAreaID=ospfHostAreaID, ospfExternalType2=ospfExternalType2, ospfHostGroup=ospfHostGroup, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbTable=ospfLsdbTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLsdbType=ospfLsdbType, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbSequence=ospfLsdbSequence, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfGroup=ospfIfGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbrGroup=ospfNbrGroup, ospfAdminStat=ospfAdminStat, ospfLocalLsdbGroup=ospfLocalLsdbGroup, Status=Status, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfGroup2=ospfIfGroup2, ospfVirtIfTable=ospfVirtIfTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostStatus=ospfHostStatus, ospfStubAreaTable=ospfStubAreaTable, ospfNbrGroup2=ospfNbrGroup2, ospfHostIpAddress=ospfHostIpAddress, ospfAreaRangeGroup=ospfAreaRangeGroup, UpToMaxAge=UpToMaxAge, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfTOSSupport=ospfTOSSupport, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfImportAsExtern=ospfImportAsExtern, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfRouteGroup=ospfRouteGroup, ospfRestartInterval=ospfRestartInterval, ospfIfMetricValue=ospfIfMetricValue, ospfAreaStatus=ospfAreaStatus, ospfExternLsaCount=ospfExternLsaCount, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfState=ospfIfState, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfIfRtrPriority=ospfIfRtrPriority, ospfAsLsdbType=ospfAsLsdbType, ospfHostTOS=ospfHostTOS, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaSummary=ospfAreaSummary, ospfLsdbLsid=ospfLsdbLsid, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLsdbAge=ospfLsdbAge, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVersionNumber=ospfVersionNumber, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrEntry=ospfVirtNbrEntry, Metric=Metric, ospfComplianceObsolete=ospfComplianceObsolete, ospfHostGroup2=ospfHostGroup2, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfStubMetric=ospfStubMetric, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfDemandExtensions=ospfDemandExtensions, ospfNbrState=ospfNbrState, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrOptions=ospfNbrOptions, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfLsaCount=ospfIfLsaCount, ospfCompliances=ospfCompliances, AreaID=AreaID, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospf=ospf, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfAuthKey=ospfIfAuthKey, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfRestartStatus=ospfRestartStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtIfGroup=ospfVirtIfGroup, ospfDiscontinuityTime=ospfDiscontinuityTime)
