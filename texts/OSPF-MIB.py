...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrEntry=ospfNbrEntry, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubStatus=ospfStubStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfType=ospfIfType, ospfHostStatus=ospfHostStatus, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfRetransInterval=ospfIfRetransInterval, ospfLsdbTable=ospfLsdbTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostGroup=ospfHostGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfTable=ospfVirtIfTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfBasicGroup=ospfBasicGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrArea=ospfVirtNbrArea, ospfHostGroup2=ospfHostGroup2, ospfIfEntry=ospfIfEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfPollInterval=ospfIfPollInterval, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbType=ospfLsdbType, ospfLsdbAge=ospfLsdbAge, ospfHostEntry=ospfHostEntry, ospfAreaSummary=ospfAreaSummary, ospfLsdbSequence=ospfLsdbSequence, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfComplianceObsolete=ospfComplianceObsolete, ospfCompliance=ospfCompliance, ospf=ospf, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaId=ospfAreaId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsdbType=ospfAsLsdbType, ospfHostMetric=ospfHostMetric, ospfVirtNbrEntry=ospfVirtNbrEntry, BigMetric=BigMetric, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfStubMetricType=ospfStubMetricType, ospfNbrEvents=ospfNbrEvents, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRxNewLsas=ospfRxNewLsas, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRouterId=ospfRouterId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfState=ospfIfState, ospfVirtIfStatus=ospfVirtIfStatus, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfAreaId=ospfIfAreaId, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfHostIpAddress=ospfHostIpAddress, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfHostTable=ospfHostTable, ospfNbrGroup2=ospfNbrGroup2, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfState=ospfVirtIfState, ospfRestartAge=ospfRestartAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfCompliance2=ospfCompliance2, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaGroup=ospfAreaGroup, ospfNbrOptions=ospfNbrOptions, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLsdbLsid=ospfLsdbLsid, ospfExternalType2=ospfExternalType2, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, PYSNMP_MODULE_ID=ospf, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfMulticastForwarding=ospfIfMulticastForwarding, PositiveInteger=PositiveInteger, ospfAsLsaCount=ospfAsLsaCount, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfHostTOS=ospfHostTOS, ospfExtLsdbType=ospfExtLsdbType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAddressLessIf=ospfAddressLessIf, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfNbrPriority=ospfNbrPriority, ospfAdminStat=ospfAdminStat, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfGroup=ospfIfGroup, ospfIfTable=ospfIfTable, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, UpToMaxAge=UpToMaxAge, ospfNbrTable=ospfNbrTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbrGroup=ospfNbrGroup, ospfRestartStatus=ospfRestartStatus, ospfAreaTable=ospfAreaTable, ospfIfIpAddress=ospfIfIpAddress, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfHostAreaID=ospfHostAreaID, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, TOSType=TOSType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfInterArea=ospfInterArea, ospfStubTOS=ospfStubTOS, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRestartInterval=ospfRestartInterval, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfRestartSupport=ospfRestartSupport, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, HelloRange=HelloRange, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfMetricTable=ospfIfMetricTable, ospfIfMetricValue=ospfIfMetricValue, ospfExternalType1=ospfExternalType1, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrState=ospfNbrState, ospfObsoleteGroup=ospfObsoleteGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrState=ospfVirtNbrState, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfAuthKey=ospfIfAuthKey, OspfAuthenticationType=OspfAuthenticationType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, RouterID=RouterID, ospfVirtIfEvents=ospfVirtIfEvents, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfConformance=ospfConformance, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfBasicGroup2=ospfBasicGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaGroup2=ospfAreaGroup2, DesignatedRouterPriority=DesignatedRouterPriority, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbChecksum=ospfLsdbChecksum, ospfIntraArea=ospfIntraArea, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfCompliances=ospfCompliances, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfGroups=ospfGroups, ospfAuthType=ospfAuthType, ospfImportAsExtern=ospfImportAsExtern, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfRestartExitReason=ospfRestartExitReason, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaStatus=ospfAreaStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, AreaID=AreaID, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbGroup=ospfLsdbGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, Status=Status, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfStatus=ospfIfStatus, ospfAreaEntry=ospfAreaEntry, ospfStubAreaId=ospfStubAreaId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfGroup2=ospfIfGroup2, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfAdminStat=ospfIfAdminStat, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExternLsaCount=ospfExternLsaCount, ospfStubMetric=ospfStubMetric, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfDemand=ospfIfDemand, Metric=Metric, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfNbrIpAddr=ospfNbrIpAddr, ospfLsdbRouterId=ospfLsdbRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfEvents=ospfIfEvents)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrRtrId=ospfVirtNbrRtrId)
