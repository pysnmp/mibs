...
mibBuilder.exportSymbols("OSPF-MIB", ospfTOSSupport=ospfTOSSupport, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospf=ospf, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfCompliances=ospfCompliances, ospfRestartSupport=ospfRestartSupport, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfNbrGroup=ospfNbrGroup, ospfIfAuthType=ospfIfAuthType, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrArea=ospfVirtNbrArea, ospfStubAreaEntry=ospfStubAreaEntry, ospfExtLsdbType=ospfExtLsdbType, ospfLsdbAge=ospfLsdbAge, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLsdbSequence=ospfLsdbSequence, ospfIfEntry=ospfIfEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfBasicGroup2=ospfBasicGroup2, ospfStubAreaTable=ospfStubAreaTable, ospfIfState=ospfIfState, ospfBasicGroup=ospfBasicGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfStubTOS=ospfStubTOS, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfHostStatus=ospfHostStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfExtLsdbAge=ospfExtLsdbAge, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfIpAddress=ospfIfIpAddress, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostMetric=ospfHostMetric, ospfNbrEvents=ospfNbrEvents, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaStatus=ospfAreaStatus, ospfLsdbTable=ospfLsdbTable, ospfRestartExitReason=ospfRestartExitReason, ospfStubAreaId=ospfStubAreaId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfGroups=ospfGroups, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartAge=ospfRestartAge, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCount=ospfAreaLsaCount, ospfHostTOS=ospfHostTOS, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaGroup=ospfAreaGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfHostIpAddress=ospfHostIpAddress, ospfAreaEntry=ospfAreaEntry, ospfIfMetricStatus=ospfIfMetricStatus, PositiveInteger=PositiveInteger, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfState=ospfVirtIfState, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrEntry=ospfNbrEntry, HelloRange=HelloRange, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrState=ospfNbrState, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, AreaID=AreaID, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfEvents=ospfIfEvents, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfAuthKey=ospfIfAuthKey, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfTable=ospfIfTable, ospfVirtNbrState=ospfVirtNbrState, ospfLsdbEntry=ospfLsdbEntry, ospfCompliance2=ospfCompliance2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExternLsaCount=ospfExternLsaCount, ospfIfGroup=ospfIfGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfHostTable=ospfHostTable, ospfIfGroup2=ospfIfGroup2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfType=ospfIfType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfHostGroup2=ospfHostGroup2, ospfNbrTable=ospfNbrTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfAreaId=ospfIfAreaId, RouterID=RouterID, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRestartInterval=ospfRestartInterval, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfLsaCount=ospfIfLsaCount, ospfAreaSummary=ospfAreaSummary, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaId=ospfAreaId, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaGroup2=ospfAreaGroup2, Metric=Metric, ospfVirtIfTable=ospfVirtIfTable, ospfIntraArea=ospfIntraArea, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfRouteGroup=ospfRouteGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVersionNumber=ospfVersionNumber, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfEntry=ospfVirtIfEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfGeneralGroup=ospfGeneralGroup, ospfIfStatus=ospfIfStatus, ospfIfMetricValue=ospfIfMetricValue, ospfAuthType=ospfAuthType, ospfDemandExtensions=ospfDemandExtensions, ospfLsdbRouterId=ospfLsdbRouterId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaRangeMask=ospfAreaRangeMask, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrPriority=ospfNbrPriority, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExternalType2=ospfExternalType2, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfMetricTable=ospfIfMetricTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfStubMetric=ospfStubMetric, ospfExternalType1=ospfExternalType1, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaTable=ospfAreaTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAdminStat=ospfAdminStat, OspfAuthenticationType=OspfAuthenticationType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrEntry=ospfVirtNbrEntry, PYSNMP_MODULE_ID=ospf, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfStatus=ospfVirtIfStatus, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbType=ospfAsLsdbType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostAreaID=ospfHostAreaID, ospfHostEntry=ospfHostEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfDemand=ospfIfDemand, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfGroup=ospfVirtIfGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfImportAsExtern=ospfImportAsExtern, ospfIfPollInterval=ospfIfPollInterval, ospfRouterId=ospfRouterId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfLsdbLsid=ospfLsdbLsid, UpToMaxAge=UpToMaxAge, ospfLsdbGroup=ospfLsdbGroup, ospfHostGroup=ospfHostGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfInterArea=ospfInterArea, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLsdbType=ospfLsdbType, ospfAreaRangeTable=ospfAreaRangeTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfAdminStat=ospfIfAdminStat, ospfCompliance=ospfCompliance, ospfAreaAggregateMask=ospfAreaAggregateMask, Status=Status, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrGroup2=ospfNbrGroup2, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfAuthKey=ospfVirtIfAuthKey, TOSType=TOSType, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeEffect=ospfAreaRangeEffect, BigMetric=BigMetric, ospfSpfRuns=ospfSpfRuns, ospfStubStatus=ospfStubStatus, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfRxNewLsas=ospfRxNewLsas, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfConformance=ospfConformance)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfStubMetricType=ospfStubMetricType, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable)
