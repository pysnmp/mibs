...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfEntry=ospfIfEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbTable=ospfLsdbTable, ospfIfDemand=ospfIfDemand, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfStubMetricType=ospfStubMetricType, ospfVersionNumber=ospfVersionNumber, ospfAreaId=ospfAreaId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfState=ospfVirtIfState, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfComplianceObsolete=ospfComplianceObsolete, ospfBasicGroup=ospfBasicGroup, ospfHostMetric=ospfHostMetric, ospfIfStatus=ospfIfStatus, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaTable=ospfAreaTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, AreaID=AreaID, ospfAuthType=ospfAuthType, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAddressLessIf=ospfAddressLessIf, ospfIfPollInterval=ospfIfPollInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfRestartStatus=ospfRestartStatus, ospfRouteGroup=ospfRouteGroup, ospfRestartAge=ospfRestartAge, ospfAreaGroup=ospfAreaGroup, ospfSpfRuns=ospfSpfRuns, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExternalType1=ospfExternalType1, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrGroup2=ospfNbrGroup2, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfGroup=ospfVirtIfGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfLsdbGroup=ospfLsdbGroup, ospfRestartExitReason=ospfRestartExitReason, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfConformance=ospfConformance, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAdminStat=ospfAdminStat, ospfIfAdminStat=ospfIfAdminStat, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLocalLsdbType=ospfLocalLsdbType, OspfAuthenticationType=OspfAuthenticationType, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrEntry=ospfNbrEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostAreaID=ospfHostAreaID, ospfCompliances=ospfCompliances, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExternLsaCount=ospfExternLsaCount, ospfLsdbEntry=ospfLsdbEntry, ospfAreaStatus=ospfAreaStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfNbrGroup=ospfNbrGroup, UpToMaxAge=UpToMaxAge, ospfNbrTable=ospfNbrTable, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExternalType2=ospfExternalType2, ospfIfState=ospfIfState, ospfIfGroup=ospfIfGroup, ospfIfEvents=ospfIfEvents, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfCompliance=ospfCompliance, RouterID=RouterID, ospfIfTable=ospfIfTable, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfStubAreaId=ospfStubAreaId, ospfAreaSummary=ospfAreaSummary, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfStubAreaTable=ospfStubAreaTable, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfNbrPriority=ospfNbrPriority, ospfIfAuthKey=ospfIfAuthKey, ospfIfLsaCount=ospfIfLsaCount, ospfAsLsdbTable=ospfAsLsdbTable, Metric=Metric, TOSType=TOSType, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsaCount=ospfAsLsaCount, ospfHostIpAddress=ospfHostIpAddress, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfRouterId=ospfRouterId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfBasicGroup2=ospfBasicGroup2, ospfAreaRangeMask=ospfAreaRangeMask, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateEffect=ospfAreaAggregateEffect, BigMetric=BigMetric, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfNbrState=ospfNbrState, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, PositiveInteger=PositiveInteger, ospfIfMetricValue=ospfIfMetricValue, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLsdbLsid=ospfLsdbLsid, ospfIfGroup2=ospfIfGroup2, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, PYSNMP_MODULE_ID=ospf, ospfNbrOptions=ospfNbrOptions, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfCompliance2=ospfCompliance2, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfRestartInterval=ospfRestartInterval, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, HelloRange=HelloRange, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfAreaId=ospfIfAreaId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaRangeNet=ospfAreaRangeNet, ospf=ospf, ospfInterArea=ospfInterArea, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtNbrState=ospfVirtNbrState, ospfHostGroup=ospfHostGroup, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbAge=ospfAsLsdbAge, ospfHostTOS=ospfHostTOS, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaGroup2=ospfAreaGroup2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrEvents=ospfNbrEvents, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostGroup2=ospfHostGroup2, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLsdbType=ospfLsdbType, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostStatus=ospfHostStatus, ospfLsdbSequence=ospfLsdbSequence, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfExtLsdbType=ospfExtLsdbType, ospfHostEntry=ospfHostEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubTOS=ospfStubTOS, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIntraArea=ospfIntraArea, ospfGroups=ospfGroups, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostTable=ospfHostTable, ospfIfAuthType=ospfIfAuthType, ospfVirtIfStatus=ospfVirtIfStatus, Status=Status, ospfIfIpAddress=ospfIfIpAddress, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfType=ospfIfType, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfGroup2=ospfVirtIfGroup2, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsdbType=ospfAsLsdbType, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubMetric=ospfStubMetric, ospfLsdbAge=ospfLsdbAge, ospfRestartSupport=ospfRestartSupport, ospfIfMetricTable=ospfIfMetricTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfImportAsExtern=ospfImportAsExtern)
mibBuilder.exportSymbols("OSPF-MIB", ospfRxNewLsas=ospfRxNewLsas, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState)
