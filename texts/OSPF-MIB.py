...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrEvents=ospfNbrEvents, ospfNbrRtrId=ospfNbrRtrId, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfHostAreaID=ospfHostAreaID, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubAreaEntry=ospfStubAreaEntry, ospfBasicGroup2=ospfBasicGroup2, ospfHostEntry=ospfHostEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfHostTOS=ospfHostTOS, ospfHostTable=ospfHostTable, AreaID=AreaID, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfGroups=ospfGroups, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfAuthType=ospfIfAuthType, ospfRestartAge=ospfRestartAge, ospfCompliance=ospfCompliance, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubMetric=ospfStubMetric, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAdminStat=ospfAdminStat, ospfLsdbEntry=ospfLsdbEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, RouterID=RouterID, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, Status=Status, ospfIntraArea=ospfIntraArea, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfHostGroup2=ospfHostGroup2, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExternalType1=ospfExternalType1, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfHostGroup=ospfHostGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfCompliances=ospfCompliances, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbType=ospfLocalLsdbType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaLsaCount=ospfAreaLsaCount, ospfHostStatus=ospfHostStatus, ospfStubStatus=ospfStubStatus, ospfIfPollInterval=ospfIfPollInterval, ospfRestartInterval=ospfRestartInterval, ospfAreaTable=ospfAreaTable, ospfIfEvents=ospfIfEvents, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLsdbGroup=ospfLsdbGroup, ospfNbrState=ospfNbrState, ospfIfTable=ospfIfTable, ospfIfIpAddress=ospfIfIpAddress, ospfHostIpAddress=ospfHostIpAddress, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfStubAreaTable=ospfStubAreaTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfConformance=ospfConformance, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrTable=ospfNbrTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfEntry=ospfIfEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, BigMetric=BigMetric, ospfLsdbType=ospfLsdbType, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfGroup2=ospfIfGroup2, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfInterArea=ospfInterArea, ospfCompliance2=ospfCompliance2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfRouteGroup=ospfRouteGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbTable=ospfLsdbTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaRangeMask=ospfAreaRangeMask, UpToMaxAge=UpToMaxAge, ospfStubMetricType=ospfStubMetricType, ospfIfDemand=ospfIfDemand, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfAdminStat=ospfIfAdminStat, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubTOS=ospfStubTOS, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrEntry=ospfNbrEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfHostMetric=ospfHostMetric, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, TOSType=TOSType, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtIfState=ospfVirtIfState, ospfAreaEntry=ospfAreaEntry, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVersionNumber=ospfVersionNumber, PYSNMP_MODULE_ID=ospf, ospfExternLsaCount=ospfExternLsaCount, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfDemandExtensions=ospfDemandExtensions, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrGroup2=ospfNbrGroup2, Metric=Metric, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaId=ospfAreaId, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfTable=ospfVirtIfTable, ospfIfStatus=ospfIfStatus, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfAuthKey=ospfIfAuthKey, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbAge=ospfLsdbAge, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbLsid=ospfLsdbLsid, ospfNbrGroup=ospfNbrGroup, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfState=ospfIfState, ospfAuthType=ospfAuthType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAsLsdbAge=ospfAsLsdbAge, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfType=ospfIfType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfGroup=ospfIfGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfGeneralGroup=ospfGeneralGroup, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaSummary=ospfAreaSummary, ospfExternalType2=ospfExternalType2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, PositiveInteger=PositiveInteger, ospfNbrOptions=ospfNbrOptions, ospfRestartSupport=ospfRestartSupport, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbType=ospfAsLsdbType, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsdbLsid=ospfAsLsdbLsid, ospf=ospf, ospfObsoleteGroup=ospfObsoleteGroup, ospfBasicGroup=ospfBasicGroup, ospfRouterId=ospfRouterId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaStatus=ospfAreaStatus, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricTable=ospfIfMetricTable, HelloRange=HelloRange, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaGroup=ospfAreaGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup)
