...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeGroup=ospfAreaRangeGroup, ospfStubMetricType=ospfStubMetricType, ospfHostGroup2=ospfHostGroup2, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfObsoleteGroup=ospfObsoleteGroup, OspfAuthenticationType=OspfAuthenticationType, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, PYSNMP_MODULE_ID=ospf, ospfAreaSummary=ospfAreaSummary, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfHostGroup=ospfHostGroup, ospfBasicGroup=ospfBasicGroup, ospfIfMetricStatus=ospfIfMetricStatus, ospfStubMetric=ospfStubMetric, ospfIfGroup2=ospfIfGroup2, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfPollInterval=ospfIfPollInterval, ospfStubTOS=ospfStubTOS, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospf=ospf, ospfStubAreaGroup=ospfStubAreaGroup, ospfLsdbType=ospfLsdbType, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsaCount=ospfAsLsaCount, ospfExtLsdbType=ospfExtLsdbType, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfAreaId=ospfIfAreaId, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfGroup=ospfIfGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrGroup=ospfNbrGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAuthType=ospfAuthType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfState=ospfIfState, ospfIfEntry=ospfIfEntry, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfRestartSupport=ospfRestartSupport, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfStubAreaId=ospfStubAreaId, ospfIfStatus=ospfIfStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfGroups=ospfGroups, ospfCompliances=ospfCompliances, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, BigMetric=BigMetric, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfCompliance=ospfCompliance, ospfIfAdminStat=ospfIfAdminStat, ospfIfTransitDelay=ospfIfTransitDelay, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfHostStatus=ospfHostStatus, ospfRestartAge=ospfRestartAge, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfMetricTable=ospfIfMetricTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfImportAsExtern=ospfImportAsExtern, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfComplianceObsolete=ospfComplianceObsolete, Status=Status, ospfHostEntry=ospfHostEntry, UpToMaxAge=UpToMaxAge, AreaID=AreaID, ospfAddressLessIf=ospfAddressLessIf, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, Metric=Metric, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfHostTable=ospfHostTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbEntry=ospfLsdbEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExternLsaCount=ospfExternLsaCount, TOSType=TOSType, ospfVirtNbrTable=ospfVirtNbrTable, ospfInterArea=ospfInterArea, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfState=ospfVirtIfState, ospfRxNewLsas=ospfRxNewLsas, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaTable=ospfAreaTable, ospfLsdbTable=ospfLsdbTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, HelloRange=HelloRange, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfHostIpAddress=ospfHostIpAddress, ospfNbrEvents=ospfNbrEvents, ospfLsdbLsid=ospfLsdbLsid, ospfAreaEntry=ospfAreaEntry, ospfIntraArea=ospfIntraArea, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsLsdbTable=ospfAsLsdbTable, ospfConformance=ospfConformance, ospfNbrEntry=ospfNbrEntry, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfType=ospfIfType, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAsLsdbType=ospfAsLsdbType, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfMetricValue=ospfIfMetricValue, ospfAreaGroup=ospfAreaGroup, ospfAreaRangeTable=ospfAreaRangeTable, ospfTOSSupport=ospfTOSSupport, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, DesignatedRouterPriority=DesignatedRouterPriority, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfLsaCount=ospfIfLsaCount, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrState=ospfVirtNbrState, ospfHostMetric=ospfHostMetric, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfEvents=ospfIfEvents, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbGroup=ospfLsdbGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfRestartInterval=ospfRestartInterval, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrPriority=ospfNbrPriority, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrRtrId=ospfNbrRtrId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfAuthKey=ospfIfAuthKey, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaGroup2=ospfAreaGroup2, ospfDemandExtensions=ospfDemandExtensions, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfAuthType=ospfIfAuthType, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfSpfRuns=ospfSpfRuns, ospfAreaRangeNet=ospfAreaRangeNet, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrState=ospfNbrState, ospfCompliance2=ospfCompliance2, ospfStubStatus=ospfStubStatus, ospfBasicGroup2=ospfBasicGroup2, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, RouterID=RouterID, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfTable=ospfIfTable, ospfNbrTable=ospfNbrTable, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfHostTOS=ospfHostTOS, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaId=ospfAreaId, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaStatus=ospfAreaStatus, ospfIfDemand=ospfIfDemand, PositiveInteger=PositiveInteger, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLsdbChecksum=ospfLsdbChecksum, ospfVersionNumber=ospfVersionNumber, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfExternalType2=ospfExternalType2, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrOptions=ospfNbrOptions, ospfAdminStat=ospfAdminStat, ospfRouterId=ospfRouterId, ospfGeneralGroup=ospfGeneralGroup, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtNbrArea=ospfVirtNbrArea, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbAge=ospfExtLsdbAge, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostAreaID=ospfHostAreaID)
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfRestartStatus=ospfRestartStatus, ospfExternalType1=ospfExternalType1)
