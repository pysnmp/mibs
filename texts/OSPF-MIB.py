...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeMask=ospfAreaRangeMask, ospfIfState=ospfIfState, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfMetricStatus=ospfIfMetricStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfStubStatus=ospfStubStatus, ospfNbrPriority=ospfNbrPriority, OspfAuthenticationType=OspfAuthenticationType, Status=Status, ospfRouteGroup=ospfRouteGroup, ospfGroups=ospfGroups, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfExternalType1=ospfExternalType1, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtIfTable=ospfVirtIfTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaRangeTable=ospfAreaRangeTable, AreaID=AreaID, ospfStubAreaTable=ospfStubAreaTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsaCount=ospfAsLsaCount, ospfIfMetricTOS=ospfIfMetricTOS, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfCompliance2=ospfCompliance2, ospfNbrEntry=ospfNbrEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaGroup=ospfAreaGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfObsoleteGroup=ospfObsoleteGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostIpAddress=ospfHostIpAddress, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfAuthType=ospfIfAuthType, ospfAsLsdbType=ospfAsLsdbType, ospfNbrEvents=ospfNbrEvents, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaStatus=ospfAreaStatus, ospfIfPollInterval=ospfIfPollInterval, PYSNMP_MODULE_ID=ospf, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfInterArea=ospfInterArea, ospfHostGroup=ospfHostGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfBasicGroup2=ospfBasicGroup2, ospfAdminStat=ospfAdminStat, ospfStubMetric=ospfStubMetric, ospfVersionNumber=ospfVersionNumber, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaAggregateMask=ospfAreaAggregateMask, HelloRange=HelloRange, BigMetric=BigMetric, ospfLsdbChecksum=ospfLsdbChecksum, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, DesignatedRouterPriority=DesignatedRouterPriority, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfStatus=ospfIfStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfRestartInterval=ospfRestartInterval, ospfStubMetricType=ospfStubMetricType, ospfRestartSupport=ospfRestartSupport, ospfIfDemand=ospfIfDemand, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfMetricTable=ospfIfMetricTable, ospfIfAreaId=ospfIfAreaId, ospfLsdbRouterId=ospfLsdbRouterId, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRxNewLsas=ospfRxNewLsas, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfGroup2=ospfIfGroup2, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfCompliance=ospfCompliance, ospfLsdbSequence=ospfLsdbSequence, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospf=ospf, ospfLsdbAge=ospfLsdbAge, ospfAreaId=ospfAreaId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsdbTable=ospfAsLsdbTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrState=ospfVirtNbrState, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfHostTOS=ospfHostTOS, ospfRestartAge=ospfRestartAge, ospfDemandExtensions=ospfDemandExtensions, ospfIfIpAddress=ospfIfIpAddress, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfEntry=ospfIfEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfSpfRuns=ospfSpfRuns, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbChecksum=ospfExtLsdbChecksum, Metric=Metric, ospfHostEntry=ospfHostEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfTable=ospfIfTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLsdbTable=ospfLsdbTable, ospfHostTable=ospfHostTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLsdbLsid=ospfLsdbLsid, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubTOS=ospfStubTOS, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfCompliances=ospfCompliances, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaSummary=ospfAreaSummary, ospfNbrIpAddr=ospfNbrIpAddr, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAsLsdbGroup=ospfAsLsdbGroup, RouterID=RouterID, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfRestartExitReason=ospfRestartExitReason, ospfAddressLessIf=ospfAddressLessIf, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrGroup2=ospfNbrGroup2, ospfAreaTable=ospfAreaTable, ospfNbrState=ospfNbrState, PositiveInteger=PositiveInteger, ospfBasicGroup=ospfBasicGroup, ospfIfGroup=ospfIfGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, TOSType=TOSType, ospfRouterId=ospfRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfEvents=ospfIfEvents, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfMetricEntry=ospfIfMetricEntry, ospfConformance=ospfConformance, ospfHostStatus=ospfHostStatus, ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrTable=ospfNbrTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAuthType=ospfAuthType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfImportAsExtern=ospfImportAsExtern, ospfNbrGroup=ospfNbrGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLsdbType=ospfLsdbType, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbrRtrId=ospfNbrRtrId, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfType=ospfIfType, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostAreaID=ospfHostAreaID, ospfIntraArea=ospfIntraArea, ospfExternLsaCount=ospfExternLsaCount, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfHostGroup2=ospfHostGroup2, ospfStubRouterSupport=ospfStubRouterSupport, ospfComplianceObsolete=ospfComplianceObsolete, ospfGeneralGroup=ospfGeneralGroup, ospfLsdbAdvertisement=ospfLsdbAdvertisement, UpToMaxAge=UpToMaxAge, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaEntry=ospfAreaEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement)
mibBuilder.exportSymbols("OSPF-MIB", ospfHostMetric=ospfHostMetric, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExternalType2=ospfExternalType2, ospfLsdbEntry=ospfLsdbEntry)
