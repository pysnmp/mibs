...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfAuthKey=ospfIfAuthKey, ospfLsdbLsid=ospfLsdbLsid, ospfLsdbType=ospfLsdbType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfGroup=ospfVirtIfGroup, PositiveInteger=PositiveInteger, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfConformance=ospfConformance, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfExternalType2=ospfExternalType2, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIfEvents=ospfIfEvents, ospfCompliance=ospfCompliance, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubAreaId=ospfStubAreaId, Metric=Metric, ospfIfAdminStat=ospfIfAdminStat, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLsdbGroup=ospfLsdbGroup, ospfNbrState=ospfNbrState, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAdminStat=ospfAdminStat, ospfNbrOptions=ospfNbrOptions, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfNbrRtrId=ospfNbrRtrId, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospf=ospf, ospfNbrTable=ospfNbrTable, ospfVirtIfState=ospfVirtIfState, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfAuthType=ospfIfAuthType, ospfBasicGroup=ospfBasicGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfBasicGroup2=ospfBasicGroup2, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfHostEntry=ospfHostEntry, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfStubTOS=ospfStubTOS, ospfDemandExtensions=ospfDemandExtensions, ospfRestartStatus=ospfRestartStatus, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfPollInterval=ospfIfPollInterval, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaId=ospfAreaId, ospfIfMetricValue=ospfIfMetricValue, ospfLsdbTable=ospfLsdbTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfAsLsdbGroup=ospfAsLsdbGroup, Status=Status, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrEvents=ospfNbrEvents, BigMetric=BigMetric, ospfIntraArea=ospfIntraArea, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfType=ospfIfType, ospfRxNewLsas=ospfRxNewLsas, ospfAuthType=ospfAuthType, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaSummary=ospfAreaSummary, ospfIfEntry=ospfIfEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfHostGroup2=ospfHostGroup2, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfSpfRuns=ospfSpfRuns, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartSupport=ospfRestartSupport, ospfLsdbAge=ospfLsdbAge, ospfRestartAge=ospfRestartAge, HelloRange=HelloRange, ospfIfIpAddress=ospfIfIpAddress, ospfIfDemand=ospfIfDemand, OspfAuthenticationType=OspfAuthenticationType, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfTOSSupport=ospfTOSSupport, ospfVirtIfStatus=ospfVirtIfStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExternalType1=ospfExternalType1, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfHostGroup=ospfHostGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfCompliance2=ospfCompliance2, PYSNMP_MODULE_ID=ospf, ospfAreaTable=ospfAreaTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfInterArea=ospfInterArea, ospfImportAsExtern=ospfImportAsExtern, ospfRestartInterval=ospfRestartInterval, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaRangeNet=ospfAreaRangeNet, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfTable=ospfVirtIfTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsdbAge=ospfAsLsdbAge, ospfCompliances=ospfCompliances, ospfAddressLessIf=ospfAddressLessIf, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfStubMetricType=ospfStubMetricType, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfState=ospfIfState, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfStubMetric=ospfStubMetric, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAsLsaCount=ospfAsLsaCount, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfGroup2=ospfIfGroup2, AreaID=AreaID, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostStatus=ospfHostStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfGroup=ospfIfGroup, ospfRouterId=ospfRouterId, ospfHostMetric=ospfHostMetric, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfRestartExitReason=ospfRestartExitReason, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaGroup=ospfAreaGroup, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostIpAddress=ospfHostIpAddress, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExtLsdbType=ospfExtLsdbType, ospfAreaStatus=ospfAreaStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, TOSType=TOSType, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaGroup2=ospfAreaGroup2, ospfVersionNumber=ospfVersionNumber, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfGeneralGroup=ospfGeneralGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfStatus=ospfIfStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfGroups=ospfGroups, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostTable=ospfHostTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLsdbChecksum=ospfLsdbChecksum, ospfAsLsdbType=ospfAsLsdbType, UpToMaxAge=UpToMaxAge, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfLsdbEntry=ospfLsdbEntry, ospfNbrGroup=ospfNbrGroup, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostAreaID=ospfHostAreaID, ospfStubStatus=ospfStubStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfTable=ospfIfTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, RouterID=RouterID, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfStubAreaTable=ospfStubAreaTable, ospfRouteGroup=ospfRouteGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole)
mibBuilder.exportSymbols("OSPF-MIB", ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbAge=ospfExtLsdbAge)
