...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCount=ospfAreaLsaCount, ospfAsLsdbType=ospfAsLsdbType, ospfHostTOS=ospfHostTOS, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfHostGroup2=ospfHostGroup2, ospfIfGroup=ospfIfGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaSummary=ospfAreaSummary, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfIpAddress=ospfIfIpAddress, ospfNbrRtrId=ospfNbrRtrId, ospfExternalType2=ospfExternalType2, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbrGroup2=ospfNbrGroup2, ospfConformance=ospfConformance, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExtLsdbEntry=ospfExtLsdbEntry, RouterID=RouterID, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAsLsaCksumSum=ospfAsLsaCksumSum, UpToMaxAge=UpToMaxAge, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfBasicGroup2=ospfBasicGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaId=ospfAreaId, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfState=ospfVirtIfState, ospfNbrEvents=ospfNbrEvents, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfEntry=ospfIfEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfEvents=ospfIfEvents, ospfDemandExtensions=ospfDemandExtensions, ospfHostAreaID=ospfHostAreaID, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaRangeEffect=ospfAreaRangeEffect, Metric=Metric, ospfIfRetransInterval=ospfIfRetransInterval, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, Status=Status, ospfMulticastExtensions=ospfMulticastExtensions, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfRestartSupport=ospfRestartSupport, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLsdbAreaId=ospfLsdbAreaId, ospfAuthType=ospfAuthType, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrTable=ospfNbrTable, ospfIfLsaCount=ospfIfLsaCount, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaRangeNet=ospfAreaRangeNet, ospfStubAreaTable=ospfStubAreaTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLsdbType=ospfLsdbType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaGroup=ospfAreaGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfGroup2=ospfIfGroup2, ospfIfType=ospfIfType, ospfCompliance=ospfCompliance, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaEntry=ospfAreaEntry, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfIfPollInterval=ospfIfPollInterval, ospfIfAreaId=ospfIfAreaId, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrEntry=ospfNbrEntry, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVersionNumber=ospfVersionNumber, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfHostGroup=ospfHostGroup, ospfHostStatus=ospfHostStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfStubMetric=ospfStubMetric, ospfRestartStatus=ospfRestartStatus, ospfHostMetric=ospfHostMetric, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExtLsdbAge=ospfExtLsdbAge, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubStatus=ospfStubStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfComplianceObsolete=ospfComplianceObsolete, ospfBasicGroup=ospfBasicGroup, OspfAuthenticationType=OspfAuthenticationType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrState=ospfNbrState, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbLsid=ospfLsdbLsid, ospfGroups=ospfGroups, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAdminStat=ospfAdminStat, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfTOSSupport=ospfTOSSupport, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaStatus=ospfAreaStatus, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, AreaID=AreaID, ospfStubTOS=ospfStubTOS, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfRouterId=ospfRouterId, BigMetric=BigMetric, ospfNbrPriority=ospfNbrPriority, ospfNbrGroup=ospfNbrGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfTable=ospfVirtIfTable, ospfStubMetricType=ospfStubMetricType, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfTable=ospfIfTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaTable=ospfAreaTable, ospfIfAdminStat=ospfIfAdminStat, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLocalLsdbTable=ospfLocalLsdbTable, PYSNMP_MODULE_ID=ospf, ospfIfState=ospfIfState, ospfRxNewLsas=ospfRxNewLsas, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfCompliances=ospfCompliances, ospfExtLsdbType=ospfExtLsdbType, ospfLsdbEntry=ospfLsdbEntry, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfRouteGroup=ospfRouteGroup, ospfAsLsaCount=ospfAsLsaCount, ospfExternalType1=ospfExternalType1, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfHostTable=ospfHostTable, ospfCompliance2=ospfCompliance2, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRestartAge=ospfRestartAge, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfAuthType=ospfIfAuthType, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbSequence=ospfAsLsdbSequence, HelloRange=HelloRange, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIntraArea=ospfIntraArea, ospfAddressLessIf=ospfAddressLessIf, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfObsoleteGroup=ospfObsoleteGroup, ospfHostIpAddress=ospfHostIpAddress, ospfAreaRangeMask=ospfAreaRangeMask, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfGroup2=ospfVirtIfGroup2, PositiveInteger=PositiveInteger, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbAge=ospfLsdbAge, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfExternLsaCount=ospfExternLsaCount, ospfLsdbTable=ospfLsdbTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfRestartInterval=ospfRestartInterval, ospfImportAsExtern=ospfImportAsExtern, ospfIfDemand=ospfIfDemand, ospfRestartExitReason=ospfRestartExitReason, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, TOSType=TOSType, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfSpfRuns=ospfSpfRuns, ospfIfStatus=ospfIfStatus, ospfAreaGroup2=ospfAreaGroup2, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrEntry=ospfVirtNbrEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospf=ospf, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount)
