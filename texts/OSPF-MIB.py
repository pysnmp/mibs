...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfIpAddress=ospfIfIpAddress, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaAggregateNet=ospfAreaAggregateNet, RouterID=RouterID, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfRtrPriority=ospfIfRtrPriority, AreaID=AreaID, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfHostMetric=ospfHostMetric, ospfIfAuthKey=ospfIfAuthKey, ospfIfGroup2=ospfIfGroup2, ospfAreaSummary=ospfAreaSummary, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfStubMetric=ospfStubMetric, ospfNbrRtrId=ospfNbrRtrId, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfRestartStatus=ospfRestartStatus, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfState=ospfVirtIfState, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfState=ospfIfState, ospfIfGroup=ospfIfGroup, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, TOSType=TOSType, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostAreaID=ospfHostAreaID, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfCompliance2=ospfCompliance2, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfEvents=ospfIfEvents, ospfLsdbAge=ospfLsdbAge, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, BigMetric=BigMetric, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfHostIpAddress=ospfHostIpAddress, ospfIfAreaId=ospfIfAreaId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbType=ospfExtLsdbType, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfGroups=ospfGroups, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAsLsdbType=ospfAsLsdbType, ospfAdminStat=ospfAdminStat, ospfObsoleteGroup=ospfObsoleteGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfSpfRuns=ospfSpfRuns, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfGeneralGroup=ospfGeneralGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfStubMetricType=ospfStubMetricType, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfPollInterval=ospfIfPollInterval, ospfBasicGroup2=ospfBasicGroup2, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfHostTable=ospfHostTable, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrGroup2=ospfNbrGroup2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrState=ospfVirtNbrState, ospfImportAsExtern=ospfImportAsExtern, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrGroup=ospfNbrGroup, ospfHostTOS=ospfHostTOS, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfCompliances=ospfCompliances, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, PYSNMP_MODULE_ID=ospf, Metric=Metric, ospfIfEntry=ospfIfEntry, ospfNbrTable=ospfNbrTable, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfRouteGroup=ospfRouteGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfTable=ospfIfTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfExternalType1=ospfExternalType1, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaStatus=ospfAreaStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbrOptions=ospfNbrOptions, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrPriority=ospfNbrPriority, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaRangeMask=ospfAreaRangeMask, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbEntry=ospfLsdbEntry, ospfStubTOS=ospfStubTOS, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfDemandExtensions=ospfDemandExtensions, ospfIfMetricGroup=ospfIfMetricGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfDemand=ospfIfDemand, ospfVirtNbrTable=ospfVirtNbrTable, OspfAuthenticationType=OspfAuthenticationType, ospfTOSSupport=ospfTOSSupport, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubAreaTable=ospfStubAreaTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfInterArea=ospfInterArea, ospfRouterId=ospfRouterId, Status=Status, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrEntry=ospfNbrEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfConformance=ospfConformance, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfCompliance=ospfCompliance, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfHostEntry=ospfHostEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbTable=ospfLsdbTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsaCount=ospfAsLsaCount, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExternalType2=ospfExternalType2, UpToMaxAge=UpToMaxAge, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRestartExitReason=ospfRestartExitReason, ospfHostGroup2=ospfHostGroup2, PositiveInteger=PositiveInteger, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfStubAreaId=ospfStubAreaId, ospfIfType=ospfIfType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRxNewLsas=ospfRxNewLsas, ospfAreaGroup2=ospfAreaGroup2, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfRestartSupport=ospfRestartSupport, ospfIfMetricTable=ospfIfMetricTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfRestartInterval=ospfRestartInterval, HelloRange=HelloRange, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaId=ospfAreaId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfExtLsdbTable=ospfExtLsdbTable, ospfLsdbType=ospfLsdbType, ospfIfMetricEntry=ospfIfMetricEntry, ospfHostGroup=ospfHostGroup, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfHostStatus=ospfHostStatus, ospfLsdbSequence=ospfLsdbSequence, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVersionNumber=ospfVersionNumber, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfStatus=ospfIfStatus, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExternLsaCount=ospfExternLsaCount, ospf=ospf, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfRestartAge=ospfRestartAge, ospfStubStatus=ospfStubStatus, ospfAuthType=ospfAuthType, ospfNbrState=ospfNbrState, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfBasicGroup=ospfBasicGroup, ospfIfAuthType=ospfIfAuthType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaGroup=ospfAreaGroup, ospfAreaTable=ospfAreaTable, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaEntry=ospfAreaEntry, ospfIfLsaCount=ospfIfLsaCount)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrGroup2=ospfVirtNbrGroup2)
