...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaTable=ospfAreaTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, PYSNMP_MODULE_ID=ospf, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfEvents=ospfIfEvents, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrTable=ospfVirtNbrTable, ospfAdminStat=ospfAdminStat, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfCompliance=ospfCompliance, ospfBasicGroup=ospfBasicGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostGroup2=ospfHostGroup2, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfGroup2=ospfIfGroup2, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, BigMetric=BigMetric, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrOptions=ospfNbrOptions, ospfIfAuthType=ospfIfAuthType, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfHostEntry=ospfHostEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfRestartInterval=ospfRestartInterval, ospfIfIpAddress=ospfIfIpAddress, ospfAreaId=ospfAreaId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExternalType2=ospfExternalType2, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfNbrEvents=ospfNbrEvents, ospfIfMetricGroup=ospfIfMetricGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaGroup=ospfAreaGroup, ospfIntraArea=ospfIntraArea, ospfStubTOS=ospfStubTOS, ospfIfAuthKey=ospfIfAuthKey, ospfHostGroup=ospfHostGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaStatus=ospfAreaStatus, Status=Status, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaSummary=ospfAreaSummary, ospf=ospf, ospfNbrState=ospfNbrState, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfConformance=ospfConformance, ospfAddressLessIf=ospfAddressLessIf, ospfLsdbGroup=ospfLsdbGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfHostAreaID=ospfHostAreaID, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfRouterId=ospfRouterId, ospfGroups=ospfGroups, ospfRxNewLsas=ospfRxNewLsas, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, Metric=Metric, ospfIfDemand=ospfIfDemand, ospfVirtNbrState=ospfVirtNbrState, ospfStubAreaTable=ospfStubAreaTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbType=ospfExtLsdbType, ospfAsLsdbTable=ospfAsLsdbTable, ospfAuthType=ospfAuthType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfHostTOS=ospfHostTOS, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, AreaID=AreaID, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfGroup=ospfIfGroup, ospfStubStatus=ospfStubStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubAreaGroup=ospfStubAreaGroup, HelloRange=HelloRange, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfSpfRuns=ospfSpfRuns, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfRtrPriority=ospfIfRtrPriority, PositiveInteger=PositiveInteger, ospfRouteGroup=ospfRouteGroup, ospfIfStatus=ospfIfStatus, ospfRestartExitReason=ospfRestartExitReason, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExternLsaCount=ospfExternLsaCount, ospfRestartAge=ospfRestartAge, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfPollInterval=ospfIfPollInterval, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfCompliances=ospfCompliances, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfMetricTable=ospfIfMetricTable, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfAdminStat=ospfIfAdminStat, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfLsdbTable=ospfLsdbTable, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrGroup=ospfNbrGroup, ospfIfTable=ospfIfTable, ospfVirtIfState=ospfVirtIfState, ospfAsLsdbType=ospfAsLsdbType, ospfGeneralGroup=ospfGeneralGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfComplianceObsolete=ospfComplianceObsolete, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfNbrGroup2=ospfNbrGroup2, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaEntry=ospfAreaEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrTable=ospfNbrTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVersionNumber=ospfVersionNumber, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfRestartStatus=ospfRestartStatus, ospfIfMetricEntry=ospfIfMetricEntry, ospfHostMetric=ospfHostMetric, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbrIpAddr=ospfNbrIpAddr, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, OspfAuthenticationType=OspfAuthenticationType, ospfIfEntry=ospfIfEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfStubMetric=ospfStubMetric, ospfIfState=ospfIfState, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLsdbAreaId=ospfLsdbAreaId, ospfHostStatus=ospfHostStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLsdbLsid=ospfLsdbLsid, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfType=ospfIfType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsaCount=ospfAsLsaCount, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfBasicGroup2=ospfBasicGroup2, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, RouterID=RouterID, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostIpAddress=ospfHostIpAddress, ospfNbrEntry=ospfNbrEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubMetricType=ospfStubMetricType, ospfVirtIfEvents=ospfVirtIfEvents, UpToMaxAge=UpToMaxAge, ospfNbrRtrId=ospfNbrRtrId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfCompliance2=ospfCompliance2, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfAreaId=ospfIfAreaId, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostTable=ospfHostTable, ospfTOSSupport=ospfTOSSupport, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfInterArea=ospfInterArea, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfDemandExtensions=ospfDemandExtensions, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfStubAreaId=ospfStubAreaId, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, TOSType=TOSType, ospfRestartSupport=ospfRestartSupport, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExternalType1=ospfExternalType1)
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrPriority=ospfNbrPriority, ospfLsdbType=ospfLsdbType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLsdbAge=ospfLsdbAge)
