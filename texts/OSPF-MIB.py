...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrState=ospfVirtNbrState, ospfGroups=ospfGroups, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfStubMetric=ospfStubMetric, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, OspfAuthenticationType=OspfAuthenticationType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfHostTable=ospfHostTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIntraArea=ospfIntraArea, Status=Status, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfRouterId=ospfRouterId, ospfRestartSupport=ospfRestartSupport, ospfIfGroup2=ospfIfGroup2, ospfStubAreaTable=ospfStubAreaTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfAdminStat=ospfIfAdminStat, ospfNbrState=ospfNbrState, ospfCompliance2=ospfCompliance2, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsdbTable=ospfAsLsdbTable, UpToMaxAge=UpToMaxAge, ospfIfHelloInterval=ospfIfHelloInterval, ospfVersionNumber=ospfVersionNumber, Metric=Metric, ospfIfTransitDelay=ospfIfTransitDelay, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfStatus=ospfVirtIfStatus, ospfHostStatus=ospfHostStatus, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfRxNewLsas=ospfRxNewLsas, ospfLsdbGroup=ospfLsdbGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfHostGroup2=ospfHostGroup2, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfGroup=ospfIfGroup, ospfRestartStatus=ospfRestartStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfMetricStatus=ospfIfMetricStatus, AreaID=AreaID, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfBasicGroup=ospfBasicGroup, ospfAuthType=ospfAuthType, ospfStubTOS=ospfStubTOS, ospfStubAreaId=ospfStubAreaId, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfImportAsExtern=ospfImportAsExtern, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfRestartInterval=ospfRestartInterval, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAddressLessIf=ospfAddressLessIf, ospfStubRouterSupport=ospfStubRouterSupport, ospfHostMetric=ospfHostMetric, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExternalType1=ospfExternalType1, ospfNbrGroup=ospfNbrGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfGeneralGroup=ospfGeneralGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrGroup2=ospfNbrGroup2, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfHostGroup=ospfHostGroup, ospfStubMetricType=ospfStubMetricType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfCompliances=ospfCompliances, ospfIfMetricValue=ospfIfMetricValue, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfNbrTable=ospfNbrTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAdminStat=ospfAdminStat, ospfIfPollInterval=ospfIfPollInterval, ospfRouteGroup=ospfRouteGroup, ospfIfAuthType=ospfIfAuthType, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfState=ospfIfState, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrOptions=ospfVirtNbrOptions, HelloRange=HelloRange, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaGroup=ospfAreaGroup, ospfNbrEntry=ospfNbrEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfSpfRuns=ospfSpfRuns, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfMetricGroup=ospfIfMetricGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbTable=ospfLsdbTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfObsoleteGroup=ospfObsoleteGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfGroup=ospfVirtIfGroup, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfStatus=ospfIfStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, RouterID=RouterID, ospfHostEntry=ospfHostEntry, ospfConformance=ospfConformance, ospfIfAreaId=ospfIfAreaId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfRestartAge=ospfRestartAge, ospfAreaStatus=ospfAreaStatus, ospfAsLsaCksumSum=ospfAsLsaCksumSum, BigMetric=BigMetric, ospfAreaSummary=ospfAreaSummary, ospfLsdbLsid=ospfLsdbLsid, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrTable=ospfVirtNbrTable, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfDemandExtensions=ospfDemandExtensions, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAsLsaCount=ospfAsLsaCount, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostTOS=ospfHostTOS, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfTOSSupport=ospfTOSSupport, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfRestartExitReason=ospfRestartExitReason, ospfStubStatus=ospfStubStatus, ospfIfLsaCount=ospfIfLsaCount, ospfReferenceBandwidth=ospfReferenceBandwidth, TOSType=TOSType, ospfCompliance=ospfCompliance, ospfExternLsaCount=ospfExternLsaCount, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaTable=ospfAreaTable, ospf=ospf, PositiveInteger=PositiveInteger, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfInterArea=ospfInterArea, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLsdbSequence=ospfLsdbSequence, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaGroup2=ospfAreaGroup2, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricTable=ospfIfMetricTable, ospfIfType=ospfIfType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIfTable=ospfIfTable, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbAge=ospfLsdbAge, ospfLsdbType=ospfLsdbType, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfAuthKey=ospfIfAuthKey, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfBasicGroup2=ospfBasicGroup2, ospfIfDemand=ospfIfDemand, PYSNMP_MODULE_ID=ospf)
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfEntry=ospfIfEntry, ospfAreaId=ospfAreaId)
