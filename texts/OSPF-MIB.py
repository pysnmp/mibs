...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfEntry=ospfIfEntry, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtIfGroup=ospfVirtIfGroup, ospfExternalType2=ospfExternalType2, ospfBasicGroup2=ospfBasicGroup2, ospfHostTable=ospfHostTable, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfRestartSupport=ospfRestartSupport, ospfVirtIfState=ospfVirtIfState, ospfAdminStat=ospfAdminStat, ospfHostTOS=ospfHostTOS, ospfLsdbAreaId=ospfLsdbAreaId, ospfStubMetricType=ospfStubMetricType, ospfAsLsaCount=ospfAsLsaCount, ospfBasicGroup=ospfBasicGroup, ospfCompliance2=ospfCompliance2, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLsdbLsid=ospfLsdbLsid, ospfAuthType=ospfAuthType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, UpToMaxAge=UpToMaxAge, ospfLsdbType=ospfLsdbType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLocalLsdbAge=ospfLocalLsdbAge, HelloRange=HelloRange, ospfAreaGroup=ospfAreaGroup, ospfIfMetricValue=ospfIfMetricValue, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAddressLessIf=ospfAddressLessIf, ospfIfDemand=ospfIfDemand, ospfExternalType1=ospfExternalType1, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, OspfAuthenticationType=OspfAuthenticationType, ospfGroups=ospfGroups, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtIfTable=ospfVirtIfTable, ospfHostGroup2=ospfHostGroup2, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfAuthType=ospfVirtIfAuthType, Metric=Metric, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaTable=ospfAreaTable, ospfHostIpAddress=ospfHostIpAddress, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfStubMetric=ospfStubMetric, ospfIfMetricStatus=ospfIfMetricStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbLsid=ospfLocalLsdbLsid, BigMetric=BigMetric, ospfNbrState=ospfNbrState, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfStubAreaTable=ospfStubAreaTable, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaId=ospfAreaId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostGroup=ospfHostGroup, ospfNbrPriority=ospfNbrPriority, ospfMulticastExtensions=ospfMulticastExtensions, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLsdbGroup=ospfLsdbGroup, ospfStubAreaId=ospfStubAreaId, ospfVersionNumber=ospfVersionNumber, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbSequence=ospfLsdbSequence, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfConformance=ospfConformance, ospf=ospf, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaEntry=ospfAreaEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfAuthType=ospfIfAuthType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfGroup=ospfIfGroup, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfPollInterval=ospfIfPollInterval, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfTransitDelay=ospfIfTransitDelay, ospfInterArea=ospfInterArea, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, Status=Status, ospfRestartInterval=ospfRestartInterval, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfAreaId=ospfIfAreaId, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfGroup2=ospfIfGroup2, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubAreaGroup=ospfStubAreaGroup, PYSNMP_MODULE_ID=ospf, ospfVirtIfEvents=ospfVirtIfEvents, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostAreaID=ospfHostAreaID, ospfNbrGroup=ospfNbrGroup, ospfNbrGroup2=ospfNbrGroup2, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfRouterId=ospfRouterId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfTOSSupport=ospfTOSSupport, ospfIfTable=ospfIfTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, TOSType=TOSType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaStatus=ospfAreaStatus, AreaID=AreaID, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfType=ospfIfType, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbType=ospfExtLsdbType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfAuthKey=ospfVirtIfAuthKey, RouterID=RouterID, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfLsdbAge=ospfLsdbAge, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfHostMetric=ospfHostMetric, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfMetricTable=ospfIfMetricTable, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaSummary=ospfAreaSummary, ospfSpfRuns=ospfSpfRuns, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfEvents=ospfIfEvents, ospfHostCfgAreaID=ospfHostCfgAreaID, PositiveInteger=PositiveInteger, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLocalLsdbType=ospfLocalLsdbType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrState=ospfVirtNbrState, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfCompliance=ospfCompliance, ospfRxNewLsas=ospfRxNewLsas, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfMetricTOS=ospfIfMetricTOS, ospfRouteGroup=ospfRouteGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfDemandExtensions=ospfDemandExtensions, ospfRestartStatus=ospfRestartStatus, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostEntry=ospfHostEntry, ospfHostStatus=ospfHostStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfNbrOptions=ospfNbrOptions, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsdbAge=ospfAsLsdbAge, ospfStubTOS=ospfStubTOS, ospfNbrTable=ospfNbrTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaRangeNet=ospfAreaRangeNet, ospfObsoleteGroup=ospfObsoleteGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfIpAddress=ospfIfIpAddress, ospfIfStatus=ospfIfStatus, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrEntry=ospfNbrEntry, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbType=ospfAsLsdbType, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfState=ospfIfState, ospfRestartExitReason=ospfRestartExitReason, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrEvents=ospfNbrEvents, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIntraArea=ospfIntraArea, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, DesignatedRouterPriority=DesignatedRouterPriority, ospfCompliances=ospfCompliances)
mibBuilder.exportSymbols("OSPF-MIB", ospfRestartAge=ospfRestartAge, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport)
