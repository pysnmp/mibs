...
mibBuilder.exportSymbols("OSPF-MIB", ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfGroups=ospfGroups, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLsdbAreaId=ospfLsdbAreaId, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfStatus=ospfIfStatus, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaSummary=ospfAreaSummary, ospfIfGroup2=ospfIfGroup2, ospfAsLsdbType=ospfAsLsdbType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, TOSType=TOSType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfHostStatus=ospfHostStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, AreaID=AreaID, ospfSpfRuns=ospfSpfRuns, HelloRange=HelloRange, ospfHostMetric=ospfHostMetric, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfInterArea=ospfInterArea, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbType=ospfLsdbType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, OspfAuthenticationType=OspfAuthenticationType, BigMetric=BigMetric, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, RouterID=RouterID, ospfStubStatus=ospfStubStatus, ospfIfAdminStat=ospfIfAdminStat, ospfAreaStatus=ospfAreaStatus, ospfAuthType=ospfAuthType, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLocalLsdbType=ospfLocalLsdbType, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaGroup=ospfAreaGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfCompliance2=ospfCompliance2, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExitOverflowInterval=ospfExitOverflowInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfLsdbAge=ospfLsdbAge, ospfNbrTable=ospfNbrTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfEvents=ospfIfEvents, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfDemand=ospfIfDemand, ospfAreaTable=ospfAreaTable, ospfIfIpAddress=ospfIfIpAddress, ospfNbrOptions=ospfNbrOptions, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrGroup2=ospfVirtNbrGroup2, Status=Status, ospfNbrPriority=ospfNbrPriority, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfType=ospfIfType, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExternalType1=ospfExternalType1, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrEvents=ospfNbrEvents, ospfComplianceObsolete=ospfComplianceObsolete, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfGroup=ospfIfGroup, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfDemandExtensions=ospfDemandExtensions, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtIfState=ospfVirtIfState, PYSNMP_MODULE_ID=ospf, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfBasicGroup=ospfBasicGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfStubMetricType=ospfStubMetricType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfHostGroup=ospfHostGroup, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospf=ospf, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfGeneralGroup=ospfGeneralGroup, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfHostTOS=ospfHostTOS, ospfLsdbSequence=ospfLsdbSequence, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsaCount=ospfAsLsaCount, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfRestartSupport=ospfRestartSupport, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfCompliances=ospfCompliances, ospfRestartAge=ospfRestartAge, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbrState=ospfNbrState, ospfExternalType2=ospfExternalType2, ospfIfAreaId=ospfIfAreaId, ospfBasicGroup2=ospfBasicGroup2, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfHelloInterval=ospfIfHelloInterval, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfRouterId=ospfRouterId, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfHostAreaID=ospfHostAreaID, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfPollInterval=ospfIfPollInterval, ospfRxNewLsas=ospfRxNewLsas, ospfIfTable=ospfIfTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfRestartStatus=ospfRestartStatus, ospfImportAsExtern=ospfImportAsExtern, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrEntry=ospfNbrEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfStubAreaId=ospfStubAreaId, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostIpAddress=ospfHostIpAddress, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfAuthType=ospfIfAuthType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfTOSSupport=ospfTOSSupport, ospfIfState=ospfIfState, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrIpAddr=ospfNbrIpAddr, ospfLsdbEntry=ospfLsdbEntry, ospfStubTOS=ospfStubTOS, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfMetricGroup=ospfIfMetricGroup, ospfExternLsaCount=ospfExternLsaCount, ospfCompliance=ospfCompliance, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfHostEntry=ospfHostEntry, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfEntry=ospfIfEntry, ospfIfLsaCount=ospfIfLsaCount, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrGroup2=ospfNbrGroup2, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMetricTable=ospfIfMetricTable, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfMetricStatus=ospfIfMetricStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfStubMetric=ospfStubMetric, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostGroup2=ospfHostGroup2, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, UpToMaxAge=UpToMaxAge, ospfAdminStat=ospfAdminStat, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfVersionNumber=ospfVersionNumber, Metric=Metric, ospfVirtIfEvents=ospfVirtIfEvents, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaId=ospfAreaId, ospfIntraArea=ospfIntraArea, ospfLsdbTable=ospfLsdbTable, ospfHostTable=ospfHostTable, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrGroup=ospfNbrGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, PositiveInteger=PositiveInteger, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfRestartInterval=ospfRestartInterval)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfConformance=ospfConformance, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExternLsaCksumSum=ospfExternLsaCksumSum)
