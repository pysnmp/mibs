...
mibBuilder.exportSymbols("OSPF-MIB", ospfVersionNumber=ospfVersionNumber, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfGroups=ospfGroups, ospfStubMetricType=ospfStubMetricType, ospfImportAsExtern=ospfImportAsExtern, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAdminStat=ospfAdminStat, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrEntry=ospfNbrEntry, ospfSpfRuns=ospfSpfRuns, ospfHostIpAddress=ospfHostIpAddress, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfGroup2=ospfIfGroup2, ospfHostGroup=ospfHostGroup, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfDemand=ospfIfDemand, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfNbrState=ospfNbrState, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAuthType=ospfAuthType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfPollInterval=ospfIfPollInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfMetricTOS=ospfIfMetricTOS, BigMetric=BigMetric, ospfStubAreaTable=ospfStubAreaTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfRouteGroup=ospfRouteGroup, ospfAddressLessIf=ospfAddressLessIf, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaTable=ospfAreaTable, ospfExternalType2=ospfExternalType2, ospfStubStatus=ospfStubStatus, ospfRestartInterval=ospfRestartInterval, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfState=ospfVirtIfState, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRestartStatus=ospfRestartStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrIpAddr=ospfNbrIpAddr, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricStatus=ospfIfMetricStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIntraArea=ospfIntraArea, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfGroup=ospfVirtIfGroup, ospfCompliance=ospfCompliance, ospfNbrGroup=ospfNbrGroup, Metric=Metric, ospfExternalType1=ospfExternalType1, ospfHostTOS=ospfHostTOS, Status=Status, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfAuthType=ospfIfAuthType, ospfLsdbLsid=ospfLsdbLsid, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfAreaId=ospfIfAreaId, ospfIfMetricTable=ospfIfMetricTable, ospfConformance=ospfConformance, ospfLsdbRouterId=ospfLsdbRouterId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfHostMetric=ospfHostMetric, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfEntry=ospfIfEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfGeneralGroup=ospfGeneralGroup, ospfLsdbType=ospfLsdbType, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfInterArea=ospfInterArea, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfCompliance2=ospfCompliance2, ospfIfEvents=ospfIfEvents, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbGroup=ospfLsdbGroup, HelloRange=HelloRange, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, OspfAuthenticationType=OspfAuthenticationType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLsdbTable=ospfLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfStatus=ospfIfStatus, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfType=ospfIfType, ospfStubMetric=ospfStubMetric, ospfBasicGroup=ospfBasicGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfHostGroup2=ospfHostGroup2, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaStatus=ospfAreaStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRestartSupport=ospfRestartSupport, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostEntry=ospfHostEntry, ospfHostAreaID=ospfHostAreaID, ospfIfTable=ospfIfTable, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbRouterId=ospfExtLsdbRouterId, TOSType=TOSType, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, AreaID=AreaID, RouterID=RouterID, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfHelloInterval=ospfIfHelloInterval, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfGroup=ospfIfGroup, ospfIfAuthKey=ospfIfAuthKey, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfBasicGroup2=ospfBasicGroup2, ospfAreaEntry=ospfAreaEntry, ospfStubAreaId=ospfStubAreaId, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaGroup=ospfAreaGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAsLsaCount=ospfAsLsaCount, ospfAsLsdbAge=ospfAsLsdbAge, ospfRxNewLsas=ospfRxNewLsas, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubTOS=ospfStubTOS, PositiveInteger=PositiveInteger, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtIfEntry=ospfVirtIfEntry, ospfCompliances=ospfCompliances, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfIfRetransInterval=ospfIfRetransInterval, ospfRouterId=ospfRouterId, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrOptions=ospfNbrOptions, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaSummary=ospfAreaSummary, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfTOSSupport=ospfTOSSupport, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrRtrId=ospfNbrRtrId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbrPriority=ospfNbrPriority, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLsdbAge=ospfLsdbAge, ospf=ospf, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfState=ospfIfState, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostTable=ospfHostTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbType=ospfAsLsdbType, ospfRestartAge=ospfRestartAge, UpToMaxAge=UpToMaxAge, ospfHostStatus=ospfHostStatus, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrGroup2=ospfNbrGroup2, ospfNbrEvents=ospfNbrEvents, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbType=ospfExtLsdbType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfDesignatedRouter=ospfIfDesignatedRouter, PYSNMP_MODULE_ID=ospf, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaId=ospfAreaId, ospfVirtIfTable=ospfVirtIfTable, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaRangeTable=ospfAreaRangeTable, ospfNbrTable=ospfNbrTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsLsdbSequence=ospfAsLsdbSequence)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbAreaId=ospfLsdbAreaId, ospfIfIpAddress=ospfIfIpAddress, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLocalLsdbAge=ospfLocalLsdbAge)
