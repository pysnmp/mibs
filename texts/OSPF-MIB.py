...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfAuthType=ospfVirtIfAuthType, ospfRestartStatus=ospfRestartStatus, ospfHostMetric=ospfHostMetric, ospfVirtIfEvents=ospfVirtIfEvents, UpToMaxAge=UpToMaxAge, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLsdbSequence=ospfLsdbSequence, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfLsdbAge=ospfLsdbAge, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfAdminStat=ospfIfAdminStat, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfDemandExtensions=ospfDemandExtensions, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbType=ospfAsLsdbType, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRouteGroup=ospfRouteGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, TOSType=TOSType, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrOptions=ospfNbrOptions, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, AreaID=AreaID, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfAreaId=ospfIfAreaId, ospfAreaId=ospfAreaId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfEntry=ospfIfEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfStubTOS=ospfStubTOS, ospfCompliance=ospfCompliance, ospfVirtIfEntry=ospfVirtIfEntry, ospfVersionNumber=ospfVersionNumber, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaTable=ospfAreaTable, ospfIfPollInterval=ospfIfPollInterval, ospfStubStatus=ospfStubStatus, ospfCompliance2=ospfCompliance2, ospfIfType=ospfIfType, ospfVirtIfTable=ospfVirtIfTable, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfHostAreaID=ospfHostAreaID, ospfIfStatus=ospfIfStatus, ospfRestartSupport=ospfRestartSupport, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaSummary=ospfAreaSummary, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrEvents=ospfNbrEvents, ospfRxNewLsas=ospfRxNewLsas, ospfIfIpAddress=ospfIfIpAddress, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfHostGroup2=ospfHostGroup2, ospfHostTOS=ospfHostTOS, ospfObsoleteGroup=ospfObsoleteGroup, ospfTOSSupport=ospfTOSSupport, ospfIfTable=ospfIfTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfHostIpAddress=ospfHostIpAddress, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaGroup2=ospfAreaGroup2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrIpAddr=ospfNbrIpAddr, ospfLsdbGroup=ospfLsdbGroup, ospfAreaStatus=ospfAreaStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfInterArea=ospfInterArea, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfExtLsdbType=ospfExtLsdbType, ospfHostEntry=ospfHostEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaGroup=ospfAreaGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfRestartInterval=ospfRestartInterval, ospfIfHelloInterval=ospfIfHelloInterval, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostTable=ospfHostTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostStatus=ospfHostStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbType=ospfLsdbType, ospfLocalLsdbType=ospfLocalLsdbType, ospfGeneralGroup=ospfGeneralGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrEntry=ospfNbrEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfAuthType=ospfIfAuthType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrPriority=ospfNbrPriority, ospfExternalType2=ospfExternalType2, PYSNMP_MODULE_ID=ospf, ospfIfRetransInterval=ospfIfRetransInterval, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfNbrGroup=ospfNbrGroup, ospfAuthType=ospfAuthType, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, Status=Status, ospfRouterId=ospfRouterId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrState=ospfNbrState, ospfBasicGroup=ospfBasicGroup, ospfIfMetricTable=ospfIfMetricTable, ospfIfState=ospfIfState, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIntraArea=ospfIntraArea, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfEvents=ospfIfEvents, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAddressLessIf=ospfAddressLessIf, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbTable=ospfLsdbTable, OspfAuthenticationType=OspfAuthenticationType, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubMetricType=ospfStubMetricType, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfMetricValue=ospfIfMetricValue, ospfLsdbLsid=ospfLsdbLsid, ospfAdminStat=ospfAdminStat, ospfRestartExitReason=ospfRestartExitReason, BigMetric=BigMetric, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubAreaId=ospfStubAreaId, Metric=Metric, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfRestartAge=ospfRestartAge, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfHostGroup=ospfHostGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, RouterID=RouterID, ospfSpfRuns=ospfSpfRuns, ospf=ospf, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfGroups=ospfGroups, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaEntry=ospfAreaEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfAuthKey=ospfIfAuthKey, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfStubMetric=ospfStubMetric, ospfCompliances=ospfCompliances, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfConformance=ospfConformance, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExternalType1=ospfExternalType1, ospfStubAreaTable=ospfStubAreaTable, ospfIfGroup=ospfIfGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfDemand=ospfIfDemand, ospfImportAsExtern=ospfImportAsExtern, ospfBasicGroup2=ospfBasicGroup2, HelloRange=HelloRange, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfGroup2=ospfIfGroup2, PositiveInteger=PositiveInteger, ospfExternLsaCount=ospfExternLsaCount, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfNbrTable=ospfNbrTable)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaRangeTable=ospfAreaRangeTable)
