...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaTable=ospfAreaTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAsLsdbTable=ospfAsLsdbTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfRtrPriority=ospfIfRtrPriority, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfDemand=ospfIfDemand, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfRouterId=ospfRouterId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfEntry=ospfIfEntry, ospfNbrEntry=ospfNbrEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfExternalType1=ospfExternalType1, ospfIfMetricGroup=ospfIfMetricGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfComplianceObsolete=ospfComplianceObsolete, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrArea=ospfVirtNbrArea, RouterID=RouterID, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrGroup=ospfNbrGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, UpToMaxAge=UpToMaxAge, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfAuthKey=ospfIfAuthKey, HelloRange=HelloRange, ospfHostGroup2=ospfHostGroup2, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfMetricTable=ospfIfMetricTable, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaGroup2=ospfAreaGroup2, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLsdbEntry=ospfLsdbEntry, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfState=ospfVirtIfState, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfVersionNumber=ospfVersionNumber, ospfLsdbType=ospfLsdbType, Metric=Metric, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfRouteGroup=ospfRouteGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbGroup=ospfLsdbGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAsLsaCount=ospfAsLsaCount, ospfIfState=ospfIfState, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostGroup=ospfHostGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, TOSType=TOSType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfTOSSupport=ospfTOSSupport, ospfAuthType=ospfAuthType, Status=Status, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbAge=ospfLsdbAge, ospfLsdbLsid=ospfLsdbLsid, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospf=ospf, PositiveInteger=PositiveInteger, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtNbrTable=ospfVirtNbrTable, ospfExternalType2=ospfExternalType2, ospfAreaSummary=ospfAreaSummary, ospfLsdbChecksum=ospfLsdbChecksum, BigMetric=BigMetric, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaId=ospfAreaId, ospfStubMetricType=ospfStubMetricType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfGroup2=ospfIfGroup2, ospfRxNewLsas=ospfRxNewLsas, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExtLsdbType=ospfExtLsdbType, AreaID=AreaID, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfCompliances=ospfCompliances, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaStatus=ospfAreaStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfRestartSupport=ospfRestartSupport, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrState=ospfVirtNbrState, ospfIfAdminStat=ospfIfAdminStat, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, OspfAuthenticationType=OspfAuthenticationType, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfEntry=ospfVirtIfEntry, ospfStubStatus=ospfStubStatus, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfType=ospfIfType, ospfCompliance=ospfCompliance, ospfGroups=ospfGroups, ospfNbrTable=ospfNbrTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricEntry=ospfIfMetricEntry, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfHostTable=ospfHostTable, ospfInterArea=ospfInterArea, ospfCompliance2=ospfCompliance2, PYSNMP_MODULE_ID=ospf, ospfRestartAge=ospfRestartAge, ospfHostTOS=ospfHostTOS, ospfHostEntry=ospfHostEntry, ospfStubAreaId=ospfStubAreaId, ospfIfIpAddress=ospfIfIpAddress, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfGroup=ospfVirtIfGroup, ospfHostStatus=ospfHostStatus, ospfIfStatus=ospfIfStatus, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaEntry=ospfAreaEntry, ospfIfPollInterval=ospfIfPollInterval, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrEvents=ospfNbrEvents, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfLsaCount=ospfIfLsaCount, ospfIfGroup=ospfIfGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfTable=ospfIfTable, ospfStubTOS=ospfStubTOS, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfStubAreaTable=ospfStubAreaTable, ospfRestartStatus=ospfRestartStatus, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubMetric=ospfStubMetric, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrState=ospfNbrState, ospfIntraArea=ospfIntraArea, ospfAsLsdbType=ospfAsLsdbType, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfAuthType=ospfIfAuthType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfBasicGroup=ospfBasicGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfSpfRuns=ospfSpfRuns, ospfIfAreaId=ospfIfAreaId, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAdminStat=ospfAdminStat, ospfLsdbTable=ospfLsdbTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfStubAreaGroup=ospfStubAreaGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfConformance=ospfConformance, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaGroup=ospfAreaGroup, ospfHostIpAddress=ospfHostIpAddress, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfHostAreaID=ospfHostAreaID, ospfRestartInterval=ospfRestartInterval, ospfBasicGroup2=ospfBasicGroup2)
mibBuilder.exportSymbols("OSPF-MIB", ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfEvents=ospfIfEvents, ospfHostMetric=ospfHostMetric)
