...
mibBuilder.exportSymbols("OSPF-MIB", ospfOriginateNewLsas=ospfOriginateNewLsas, HelloRange=HelloRange, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrGroup2=ospfNbrGroup2, ospfIfAuthKey=ospfIfAuthKey, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfDemandExtensions=ospfDemandExtensions, RouterID=RouterID, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, UpToMaxAge=UpToMaxAge, ospfVirtIfTable=ospfVirtIfTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaStatus=ospfAreaStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRestartExitReason=ospfRestartExitReason, ospfGeneralGroup=ospfGeneralGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, TOSType=TOSType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfEvents=ospfIfEvents, ospfIfType=ospfIfType, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaId=ospfAreaId, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLsdbTable=ospfLsdbTable, ospfNbrPriority=ospfNbrPriority, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfStubAreaEntry=ospfStubAreaEntry, ospfBasicGroup2=ospfBasicGroup2, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbAreaId=ospfLsdbAreaId, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaGroup=ospfAreaGroup, ospfLsdbType=ospfLsdbType, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfConformance=ospfConformance, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfLsdbGroup=ospfLsdbGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfStatus=ospfIfStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbRouterId=ospfAsLsdbRouterId, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfPollInterval=ospfIfPollInterval, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfStubMetric=ospfStubMetric, ospfRestartSupport=ospfRestartSupport, ospfStubAreaId=ospfStubAreaId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfRestartStatus=ospfRestartStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRestartInterval=ospfRestartInterval, ospfIfState=ospfIfState, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricTable=ospfIfMetricTable, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfMetricEntry=ospfIfMetricEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLsdbSequence=ospfLsdbSequence, ospfSpfRuns=ospfSpfRuns, ospfNbrEvents=ospfNbrEvents, ospfLsdbEntry=ospfLsdbEntry, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfDemand=ospfIfDemand, ospfNbrTable=ospfNbrTable, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaGroup2=ospfAreaGroup2, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAdminStat=ospfAdminStat, ospfIfAreaId=ospfIfAreaId, ospfCompliance2=ospfCompliance2, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAuthType=ospfAuthType, PYSNMP_MODULE_ID=ospf, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostAreaID=ospfHostAreaID, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaTable=ospfAreaTable, ospfVirtIfState=ospfVirtIfState, ospfNbrGroup=ospfNbrGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfEntry=ospfIfEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLsdbChecksum=ospfLsdbChecksum, ospf=ospf, ospfAsLsaCount=ospfAsLsaCount, ospfIfGroup=ospfIfGroup, BigMetric=BigMetric, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtIfGroup=ospfVirtIfGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaEntry=ospfAreaEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfMetricValue=ospfIfMetricValue, ospfStubAreaGroup=ospfStubAreaGroup, ospfLocalLsdbSequence=ospfLocalLsdbSequence, Status=Status, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfLsdbAge=ospfLsdbAge, ospfExternalType1=ospfExternalType1, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfLsaCount=ospfIfLsaCount, ospfNbrEntry=ospfNbrEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfTransitDelay=ospfIfTransitDelay, ospfHostIpAddress=ospfHostIpAddress, ospfNbrOptions=ospfNbrOptions, ospfIntraArea=ospfIntraArea, ospfAsLsdbLsid=ospfAsLsdbLsid, Metric=Metric, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfRestartAge=ospfRestartAge, OspfAuthenticationType=OspfAuthenticationType, ospfInterArea=ospfInterArea, ospfCompliances=ospfCompliances, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfAdminStat=ospfIfAdminStat, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfGroup2=ospfIfGroup2, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfGroups=ospfGroups, ospfHostMetric=ospfHostMetric, ospfExtLsdbTable=ospfExtLsdbTable, ospfRouterId=ospfRouterId, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfHostGroup=ospfHostGroup, ospfIfIpAddress=ospfIfIpAddress, ospfVersionNumber=ospfVersionNumber, ospfHostTOS=ospfHostTOS, ospfStubMetricType=ospfStubMetricType, ospfHostStatus=ospfHostStatus, ospfHostGroup2=ospfHostGroup2, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubAreaTable=ospfStubAreaTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfLsdbLsid=ospfLsdbLsid, ospfRouteGroup=ospfRouteGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfStubTOS=ospfStubTOS, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfTable=ospfIfTable, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfTOSSupport=ospfTOSSupport, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfBasicGroup=ospfBasicGroup, ospfHostEntry=ospfHostEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAddressLessIf=ospfAddressLessIf, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAsLsdbType=ospfAsLsdbType, ospfStubStatus=ospfStubStatus, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfHostTable=ospfHostTable, ospfRxNewLsas=ospfRxNewLsas, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfCompliance=ospfCompliance, AreaID=AreaID, ospfExternLsaCount=ospfExternLsaCount, PositiveInteger=PositiveInteger, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrState=ospfNbrState, ospfVirtIfEvents=ospfVirtIfEvents)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaSummary=ospfAreaSummary, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfImportAsExtern=ospfImportAsExtern)
