...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrGroup=ospfNbrGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaStatus=ospfAreaStatus, ospfAuthType=ospfAuthType, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfImportAsExtern=ospfImportAsExtern, ospfAsLsdbAge=ospfAsLsdbAge, ospfStubMetricType=ospfStubMetricType, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfExtLsdbType=ospfExtLsdbType, UpToMaxAge=UpToMaxAge, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfState=ospfIfState, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExternalType2=ospfExternalType2, ospfStubMetric=ospfStubMetric, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaRangeTable=ospfAreaRangeTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrPriority=ospfNbrPriority, ospfNbrIpAddr=ospfNbrIpAddr, ospfExtLsdbTable=ospfExtLsdbTable, HelloRange=HelloRange, ospfNbrState=ospfNbrState, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaTable=ospfAreaTable, ospfAdminStat=ospfAdminStat, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfIntraArea=ospfIntraArea, ospfAreaGroup=ospfAreaGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, AreaID=AreaID, ospfBasicGroup2=ospfBasicGroup2, ospfAreaGroup2=ospfAreaGroup2, ospfVersionNumber=ospfVersionNumber, ospfIfMetricValue=ospfIfMetricValue, ospfNbrRtrId=ospfNbrRtrId, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfCompliances=ospfCompliances, ospfAsLsdbGroup=ospfAsLsdbGroup, RouterID=RouterID, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfType=ospfIfType, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfAuthType=ospfIfAuthType, ospfRouterId=ospfRouterId, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubAreaTable=ospfStubAreaTable, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfHostGroup=ospfHostGroup, ospfRestartStatus=ospfRestartStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrEvents=ospfNbrEvents, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfRxNewLsas=ospfRxNewLsas, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLsdbType=ospfLsdbType, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfEvents=ospfIfEvents, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbLsid=ospfLsdbLsid, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfAdminStat=ospfIfAdminStat, BigMetric=BigMetric, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfExternalType1=ospfExternalType1, ospfAddressLessIf=ospfAddressLessIf, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfTable=ospfVirtIfTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfConformance=ospfConformance, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfHostMetric=ospfHostMetric, ospfRestartExitReason=ospfRestartExitReason, ospfIfTransitDelay=ospfIfTransitDelay, ospfGroups=ospfGroups, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeNet=ospfAreaRangeNet, Status=Status, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfEntry=ospfIfEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfIfRtrPriority=ospfIfRtrPriority, ospfLsdbGroup=ospfLsdbGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbAge=ospfExtLsdbAge, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfRestartInterval=ospfRestartInterval, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfTOSSupport=ospfTOSSupport, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfStubAreaId=ospfStubAreaId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfStubTOS=ospfStubTOS, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfHostGroup2=ospfHostGroup2, ospfInterArea=ospfInterArea, ospfNbrTable=ospfNbrTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaSummary=ospfAreaSummary, ospfRouteGroup=ospfRouteGroup, ospfBasicGroup=ospfBasicGroup, PYSNMP_MODULE_ID=ospf, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfCompliance=ospfCompliance, ospfLsdbAge=ospfLsdbAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbTable=ospfLsdbTable, ospfSpfRuns=ospfSpfRuns, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfStatus=ospfIfStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfAuthKey=ospfIfAuthKey, ospfIfGroup2=ospfIfGroup2, ospfIfDesignatedRouter=ospfIfDesignatedRouter, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospf=ospf, ospfRestartSupport=ospfRestartSupport, ospfDemandExtensions=ospfDemandExtensions, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfStubStatus=ospfStubStatus, ospfHostAreaID=ospfHostAreaID, ospfIfAreaId=ospfIfAreaId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLsdbSequence=ospfLsdbSequence, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, TOSType=TOSType, ospfIfRetransInterval=ospfIfRetransInterval, ospfHostTOS=ospfHostTOS, ospfIfLsaCount=ospfIfLsaCount, ospfAreaId=ospfAreaId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfGeneralGroup=ospfGeneralGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfMetricTable=ospfIfMetricTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfHostEntry=ospfHostEntry, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostIpAddress=ospfHostIpAddress, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfTable=ospfIfTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrGroup2=ospfNbrGroup2, Metric=Metric, ospfHostStatus=ospfHostStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfCompliance2=ospfCompliance2, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsaCount=ospfAsLsaCount, ospfIfIpAddress=ospfIfIpAddress, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfState=ospfVirtIfState, ospfIfDemand=ospfIfDemand, PositiveInteger=PositiveInteger, ospfLsdbChecksum=ospfLsdbChecksum, ospfRestartAge=ospfRestartAge, ospfHostTable=ospfHostTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement)
