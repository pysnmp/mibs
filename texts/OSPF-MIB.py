...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRestartStatus=ospfRestartStatus, ospfHostStatus=ospfHostStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAuthType=ospfAuthType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrEntry=ospfNbrEntry, Status=Status, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfRestartExitReason=ospfRestartExitReason, ospfExtLsdbType=ospfExtLsdbType, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfAuthType=ospfIfAuthType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaLsaCount=ospfAreaLsaCount, ospfVersionNumber=ospfVersionNumber, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfTOSSupport=ospfTOSSupport, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrGroup=ospfNbrGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfState=ospfIfState, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfGroup2=ospfIfGroup2, ospfIfTable=ospfIfTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLsdbAge=ospfLsdbAge, ospfIfAreaId=ospfIfAreaId, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaEntry=ospfAreaEntry, ospfIfAdminStat=ospfIfAdminStat, ospfAreaStatus=ospfAreaStatus, ospfIfIpAddress=ospfIfIpAddress, BigMetric=BigMetric, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfAuthKey=ospfIfAuthKey, ospfNbrOptions=ospfNbrOptions, ospfRouteGroup=ospfRouteGroup, ospfExternalType1=ospfExternalType1, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfType=ospfIfType, ospfAreaSummary=ospfAreaSummary, OspfAuthenticationType=OspfAuthenticationType, ospfRestartInterval=ospfRestartInterval, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrTable=ospfNbrTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfState=ospfVirtIfState, ospfNbrPriority=ospfNbrPriority, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaId=ospfAreaId, ospfCompliance2=ospfCompliance2, ospfHostTable=ospfHostTable, ospfImportAsExtern=ospfImportAsExtern, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfCompliances=ospfCompliances, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfRestartSupport=ospfRestartSupport, UpToMaxAge=UpToMaxAge, ospfDemandExtensions=ospfDemandExtensions, ospfNbrState=ospfNbrState, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAsLsdbType=ospfAsLsdbType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfBasicGroup2=ospfBasicGroup2, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfMetricTOS=ospfIfMetricTOS, ospfLsdbLsid=ospfLsdbLsid, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrState=ospfVirtNbrState, ospfIfGroup=ospfIfGroup, ospfLsdbSequence=ospfLsdbSequence, ospfAdminStat=ospfAdminStat, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfHostTOS=ospfHostTOS, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, HelloRange=HelloRange, ospfAddressLessIf=ospfAddressLessIf, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfStubMetricType=ospfStubMetricType, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfInterArea=ospfInterArea, ospfIfLsaCount=ospfIfLsaCount, ospfRestartAge=ospfRestartAge, ospfBasicGroup=ospfBasicGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfStatus=ospfIfStatus, ospfLocalLsdbType=ospfLocalLsdbType, ospfExtLsdbAge=ospfExtLsdbAge, Metric=Metric, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfMetricTable=ospfIfMetricTable, ospfAreaGroup=ospfAreaGroup, RouterID=RouterID, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfEntry=ospfIfEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfHostAreaID=ospfHostAreaID, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaRangeTable=ospfAreaRangeTable, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospf=ospf, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaTable=ospfAreaTable, ospfHostMetric=ospfHostMetric, ospfStubAreaId=ospfStubAreaId, ospfIfEvents=ospfIfEvents, ospfAreaGroup2=ospfAreaGroup2, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfPollInterval=ospfIfPollInterval, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtIfStatus=ospfVirtIfStatus, ospfCompliance=ospfCompliance, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfRouterId=ospfRouterId, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtIfTable=ospfVirtIfTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfHostGroup2=ospfHostGroup2, ospfHostEntry=ospfHostEntry, ospfHostIpAddress=ospfHostIpAddress, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbrIpAddr=ospfNbrIpAddr, ospfRxNewLsas=ospfRxNewLsas, ospfStubMetric=ospfStubMetric, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrGroup=ospfVirtNbrGroup, PYSNMP_MODULE_ID=ospf, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfDemand=ospfIfDemand, ospfNbmaNbrStatus=ospfNbmaNbrStatus, PositiveInteger=PositiveInteger, ospfStubAreaGroup=ospfStubAreaGroup, TOSType=TOSType, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfLsdbType=ospfLsdbType, ospfSpfRuns=ospfSpfRuns, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfConformance=ospfConformance, ospfStubTOS=ospfStubTOS, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLsdbEntry=ospfLsdbEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrEvents=ospfNbrEvents, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfLsdbGroup=ospfLsdbGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsaCount=ospfAsLsaCount, ospfStubStatus=ospfStubStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfGroups=ospfGroups, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIntraArea=ospfIntraArea, ospfNbrGroup2=ospfNbrGroup2, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, AreaID=AreaID, ospfMulticastExtensions=ospfMulticastExtensions, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLsdbTable=ospfLsdbTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfStubAreaTable=ospfStubAreaTable, ospfHostGroup=ospfHostGroup)
