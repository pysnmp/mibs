...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, PositiveInteger=PositiveInteger, ospfVirtIfGroup=ospfVirtIfGroup, AreaID=AreaID, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaEntry=ospfAreaEntry, ospfRouterId=ospfRouterId, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfGroups=ospfGroups, ospfAuthType=ospfAuthType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfHostTOS=ospfHostTOS, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfMulticastExtensions=ospfMulticastExtensions, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfHostGroup2=ospfHostGroup2, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrIpAddr=ospfNbrIpAddr, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfHelloInterval=ospfIfHelloInterval, ospfSpfRuns=ospfSpfRuns, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfHostIpAddress=ospfHostIpAddress, Metric=Metric, BigMetric=BigMetric, ospfStubAreaId=ospfStubAreaId, ospfRestartSupport=ospfRestartSupport, ospfLsdbType=ospfLsdbType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaTable=ospfAreaTable, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrRtrId=ospfNbrRtrId, ospfStubStatus=ospfStubStatus, ospfIfMetricTable=ospfIfMetricTable, ospfExternalType2=ospfExternalType2, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfRetransInterval=ospfIfRetransInterval, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfMetricGroup=ospfIfMetricGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVersionNumber=ospfVersionNumber, ospfExternLsaCount=ospfExternLsaCount, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfStatus=ospfIfStatus, ospfLsdbGroup=ospfLsdbGroup, ospfBasicGroup2=ospfBasicGroup2, PYSNMP_MODULE_ID=ospf, UpToMaxAge=UpToMaxAge, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfGroup2=ospfIfGroup2, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaStatus=ospfAreaStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtIfEntry=ospfVirtIfEntry, ospfRouteGroup=ospfRouteGroup, ospfLsdbTable=ospfLsdbTable, ospfLsdbEntry=ospfLsdbEntry, ospfStubMetric=ospfStubMetric, ospfRestartStatus=ospfRestartStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfGeneralGroup=ospfGeneralGroup, ospfDemandExtensions=ospfDemandExtensions, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLsdbAge=ospfLsdbAge, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfMetricTOS=ospfIfMetricTOS, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, OspfAuthenticationType=OspfAuthenticationType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfCompliance2=ospfCompliance2, ospfIfEvents=ospfIfEvents, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospf=ospf, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfTable=ospfVirtIfTable, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbSequence=ospfLsdbSequence, ospfIfGroup=ospfIfGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfInterArea=ospfInterArea, ospfIfAreaId=ospfIfAreaId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfPollInterval=ospfIfPollInterval, HelloRange=HelloRange, ospfAsLsdbAge=ospfAsLsdbAge, ospfRestartInterval=ospfRestartInterval, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtIfState=ospfVirtIfState, ospfObsoleteGroup=ospfObsoleteGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfAdminStat=ospfAdminStat, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfState=ospfIfState, ospfHostAreaID=ospfHostAreaID, ospfStubMetricType=ospfStubMetricType, ospfCompliance=ospfCompliance, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRxNewLsas=ospfRxNewLsas, ospfAddressLessIf=ospfAddressLessIf, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaSummary=ospfAreaSummary, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostGroup=ospfHostGroup, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeTable=ospfAreaRangeTable, ospfLsdbLsid=ospfLsdbLsid, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfLsaCksumSum=ospfIfLsaCksumSum, DesignatedRouterPriority=DesignatedRouterPriority, ospfTOSSupport=ospfTOSSupport, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbType=ospfAsLsdbType, ospfExternalType1=ospfExternalType1, ospfRestartExitReason=ospfRestartExitReason, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrState=ospfNbrState, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaLsaCount=ospfAreaLsaCount, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfStubTOS=ospfStubTOS, ospfIfDemand=ospfIfDemand, ospfConformance=ospfConformance, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfNbrPriority=ospfNbrPriority, ospfRestartAge=ospfRestartAge, ospfIfIpAddress=ospfIfIpAddress, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfHostStatus=ospfHostStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospfExtLsdbAge=ospfExtLsdbAge, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfAuthType=ospfIfAuthType, ospfNbrTable=ospfNbrTable, ospfExtLsdbType=ospfExtLsdbType, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfType=ospfIfType, ospfIntraArea=ospfIntraArea, ospfAreaId=ospfAreaId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfTable=ospfIfTable, RouterID=RouterID, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, TOSType=TOSType, ospfAreaRangeMask=ospfAreaRangeMask, ospfHostEntry=ospfHostEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrState=ospfVirtNbrState, ospfHostMetric=ospfHostMetric, Status=Status, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrEvents=ospfNbrEvents, ospfIfAdminStat=ospfIfAdminStat, ospfNbrEntry=ospfNbrEntry, ospfHostTable=ospfHostTable, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaGroup=ospfAreaGroup, ospfIfEntry=ospfIfEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfCompliances=ospfCompliances, ospfBasicGroup=ospfBasicGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsaCksumSum=ospfAsLsaCksumSum)
