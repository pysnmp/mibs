...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfState=ospfVirtIfState, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfPollInterval=ospfIfPollInterval, ospfAreaGroup2=ospfAreaGroup2, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, Status=Status, ospfAreaSummary=ospfAreaSummary, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfReferenceBandwidth=ospfReferenceBandwidth, Metric=Metric, OspfAuthenticationType=OspfAuthenticationType, ospfHostStatus=ospfHostStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfGroups=ospfGroups, ospfStubAreaTable=ospfStubAreaTable, ospfHostTable=ospfHostTable, ospfVirtNbrState=ospfVirtNbrState, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExtLsdbAge=ospfExtLsdbAge, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfRestartExitReason=ospfRestartExitReason, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrOptions=ospfNbrOptions, ospfIfType=ospfIfType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfRestartStatus=ospfRestartStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLsdbTable=ospfLsdbTable, ospfConformance=ospfConformance, UpToMaxAge=UpToMaxAge, ospfDemandExtensions=ospfDemandExtensions, ospfExternalType1=ospfExternalType1, ospfRestartInterval=ospfRestartInterval, ospfBasicGroup=ospfBasicGroup, ospfNbrTable=ospfNbrTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLsdbChecksum=ospfLsdbChecksum, ospfSpfRuns=ospfSpfRuns, ospfNbrEntry=ospfNbrEntry, PYSNMP_MODULE_ID=ospf, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExternLsaCount=ospfExternLsaCount, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateNet=ospfAreaAggregateNet, DesignatedRouterPriority=DesignatedRouterPriority, ospfBasicGroup2=ospfBasicGroup2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbTable=ospfAsLsdbTable, ospfHostEntry=ospfHostEntry, ospfAreaId=ospfAreaId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, TOSType=TOSType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubRouterSupport=ospfStubRouterSupport, ospfAuthType=ospfAuthType, ospfIfAdminStat=ospfIfAdminStat, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfInterArea=ospfInterArea, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLsdbSequence=ospfLsdbSequence, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfHostGroup=ospfHostGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfStubMetricType=ospfStubMetricType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfEntry=ospfIfEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLsdbAreaId=ospfLsdbAreaId, PositiveInteger=PositiveInteger, ospfCompliance2=ospfCompliance2, ospfImportAsExtern=ospfImportAsExtern, ospfHostGroup2=ospfHostGroup2, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfHostAreaID=ospfHostAreaID, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfStatus=ospfIfStatus, ospfIfEvents=ospfIfEvents, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfMetricValue=ospfIfMetricValue, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfMetricTable=ospfIfMetricTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrState=ospfNbrState, ospfRouteGroup=ospfRouteGroup, ospfNbrGroup=ospfNbrGroup, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaGroup=ospfAreaGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfHostMetric=ospfHostMetric, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfTable=ospfVirtIfTable, ospfAdminStat=ospfAdminStat, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfRetransInterval=ospfIfRetransInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfHelloInterval=ospfIfHelloInterval, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, RouterID=RouterID, ospfLsdbType=ospfLsdbType, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIntraArea=ospfIntraArea, ospfRestartSupport=ospfRestartSupport, ospfIfGroup=ospfIfGroup, ospf=ospf, ospfLsdbGroup=ospfLsdbGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfMetricGroup=ospfIfMetricGroup, ospfRouterId=ospfRouterId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaStatus=ospfAreaStatus, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfCompliances=ospfCompliances, BigMetric=BigMetric, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfGroup2=ospfIfGroup2, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrPriority=ospfNbrPriority, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfExternalType2=ospfExternalType2, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfExtLsdbType=ospfExtLsdbType, ospfAreaTable=ospfAreaTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLsdbAge=ospfLsdbAge, ospfIfAuthKey=ospfIfAuthKey, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfTransitDelay=ospfIfTransitDelay, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, AreaID=AreaID, ospfLsdbLsid=ospfLsdbLsid, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, HelloRange=HelloRange, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVersionNumber=ospfVersionNumber, ospfStubTOS=ospfStubTOS, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbType=ospfLocalLsdbType, ospfGeneralGroup=ospfGeneralGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfTOSSupport=ospfTOSSupport, ospfHostIpAddress=ospfHostIpAddress, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfStubStatus=ospfStubStatus, ospfStubAreaGroup=ospfStubAreaGroup, ospfAsLsdbType=ospfAsLsdbType, ospfNbrGroup2=ospfNbrGroup2, ospfIfRtrPriority=ospfIfRtrPriority, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfDemand=ospfIfDemand, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfAuthType=ospfIfAuthType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLsdbEntry=ospfLsdbEntry, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfEntry=ospfVirtIfEntry, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfTable=ospfIfTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfStubAreaId=ospfStubAreaId, ospfIfState=ospfIfState, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfStubMetric=ospfStubMetric, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfAreaId=ospfIfAreaId, ospfRestartAge=ospfRestartAge, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfCompliance=ospfCompliance)
mibBuilder.exportSymbols("OSPF-MIB", ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement)
