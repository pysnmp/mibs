...
mibBuilder.exportSymbols("OSPF-MIB", ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfHostGroup=ospfHostGroup, ospfIfAdminStat=ospfIfAdminStat, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrState=ospfVirtNbrState, RouterID=RouterID, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbSequence=ospfLsdbSequence, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfStubAreaTable=ospfStubAreaTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfIfMetricValue=ospfIfMetricValue, ospfHostTOS=ospfHostTOS, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfRestartStatus=ospfRestartStatus, ospfIfStatus=ospfIfStatus, ospf=ospf, ospfIfLsaCount=ospfIfLsaCount, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfEntry=ospfIfEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfStubStatus=ospfStubStatus, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaGroup2=ospfAreaGroup2, ospfInterArea=ospfInterArea, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfBasicGroup=ospfBasicGroup, ospfVirtIfState=ospfVirtIfState, ospfIfIpAddress=ospfIfIpAddress, ospfAreaId=ospfAreaId, ospfVirtIfTable=ospfVirtIfTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostStatus=ospfHostStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbGroup=ospfLsdbGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAdminStat=ospfAdminStat, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfType=ospfIfType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, PositiveInteger=PositiveInteger, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfMulticastExtensions=ospfMulticastExtensions, AreaID=AreaID, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfImportAsExtern=ospfImportAsExtern, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfHostGroup2=ospfHostGroup2, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfEvents=ospfIfEvents, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbEntry=ospfLsdbEntry, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbGroup=ospfLocalLsdbGroup, OspfAuthenticationType=OspfAuthenticationType, ospfStubRouterSupport=ospfStubRouterSupport, ospfConformance=ospfConformance, Metric=Metric, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbAge=ospfLsdbAge, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaStatus=ospfAreaStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfGeneralGroup=ospfGeneralGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbTable=ospfAsLsdbTable, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfHostEntry=ospfHostEntry, ospfHostIpAddress=ospfHostIpAddress, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrRtrId=ospfNbrRtrId, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLsdbType=ospfLsdbType, ospfIfAuthType=ospfIfAuthType, ospfAreaTable=ospfAreaTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbAge=ospfAsLsdbAge, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfBasicGroup2=ospfBasicGroup2, Status=Status, HelloRange=HelloRange, ospfStubAreaId=ospfStubAreaId, ospfNbrIpAddr=ospfNbrIpAddr, ospfExternalType1=ospfExternalType1, ospfRestartExitReason=ospfRestartExitReason, ospfIfGroup=ospfIfGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfStatus=ospfVirtIfStatus, TOSType=TOSType, ospfStubAreaEntry=ospfStubAreaEntry, ospfSpfRuns=ospfSpfRuns, ospfGroups=ospfGroups, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfDemandExtensions=ospfDemandExtensions, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfTransitDelay=ospfIfTransitDelay, ospfCompliances=ospfCompliances, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrGroup=ospfNbrGroup, ospfIfMetricTable=ospfIfMetricTable, ospfNbrOptions=ospfNbrOptions, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfStubAreaGroup=ospfStubAreaGroup, ospfVersionNumber=ospfVersionNumber, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubTOS=ospfStubTOS, ospfIntraArea=ospfIntraArea, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfHostTable=ospfHostTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsaCount=ospfAsLsaCount, ospfRouteGroup=ospfRouteGroup, ospfHostAreaID=ospfHostAreaID, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfCompliance2=ospfCompliance2, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrPriority=ospfNbrPriority, BigMetric=BigMetric, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, UpToMaxAge=UpToMaxAge, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfRxNewLsas=ospfRxNewLsas, ospfAsLsdbType=ospfAsLsdbType, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfMetricStatus=ospfIfMetricStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfCompliance=ospfCompliance, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLsdbTable=ospfLsdbTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfExternalType2=ospfExternalType2, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfState=ospfIfState, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRestartAge=ospfRestartAge, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaGroup=ospfAreaGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfHostMetric=ospfHostMetric, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfAuthKey=ospfIfAuthKey, ospfRouterId=ospfRouterId, ospfAreaRangeTable=ospfAreaRangeTable, PYSNMP_MODULE_ID=ospf, ospfAuthType=ospfAuthType, ospfNbrTable=ospfNbrTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfGroup2=ospfIfGroup2, ospfAreaSummary=ospfAreaSummary, ospfIfAreaId=ospfIfAreaId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfStubMetricType=ospfStubMetricType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrGroup2=ospfNbrGroup2, ospfTOSSupport=ospfTOSSupport, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfTable=ospfIfTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfNbrState=ospfNbrState, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfDemand=ospfIfDemand, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfGroup=ospfVirtIfGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfStubMetric=ospfStubMetric, ospfComplianceObsolete=ospfComplianceObsolete)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfPollInterval=ospfIfPollInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbLsid=ospfLsdbLsid, ospfRestartSupport=ospfRestartSupport)
