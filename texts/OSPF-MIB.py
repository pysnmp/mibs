...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfStubMetric=ospfStubMetric, ospfStubTOS=ospfStubTOS, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfStubAreaTable=ospfStubAreaTable, ospfIfTable=ospfIfTable, ospfAreaGroup2=ospfAreaGroup2, ospfLsdbTable=ospfLsdbTable, ospfAreaTable=ospfAreaTable, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfStubStatus=ospfStubStatus, ospfRestartAge=ospfRestartAge, ospfNbrTable=ospfNbrTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfBasicGroup2=ospfBasicGroup2, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfRetransInterval=ospfIfRetransInterval, ospfHostGroup=ospfHostGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateEntry=ospfAreaAggregateEntry, TOSType=TOSType, ospfAreaLsaCountTable=ospfAreaLsaCountTable, Status=Status, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfGroup2=ospfIfGroup2, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfBasicGroup=ospfBasicGroup, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfRxNewLsas=ospfRxNewLsas, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbType=ospfAsLsdbType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrPriority=ospfNbrPriority, ospfAreaStatus=ospfAreaStatus, ospfStubMetricType=ospfStubMetricType, ospfIfMetricValue=ospfIfMetricValue, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfNbrGroup2=ospfNbrGroup2, ospfRouterId=ospfRouterId, ospfIfAreaId=ospfIfAreaId, ospfRestartSupport=ospfRestartSupport, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtNbrArea=ospfVirtNbrArea, ospf=ospf, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfTable=ospfVirtIfTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIntraArea=ospfIntraArea, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfStubAreaGroup=ospfStubAreaGroup, AreaID=AreaID, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfPollInterval=ospfIfPollInterval, ospfIfDemand=ospfIfDemand, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtIfEntry=ospfVirtIfEntry, OspfAuthenticationType=OspfAuthenticationType, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfState=ospfVirtIfState, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfMetricStatus=ospfIfMetricStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfType=ospfIfType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfState=ospfIfState, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfStatus=ospfIfStatus, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfSpfRuns=ospfSpfRuns, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfGroups=ospfGroups, ospfStubAreaId=ospfStubAreaId, ospfAdminStat=ospfAdminStat, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfAuthKey=ospfIfAuthKey, ospfHostIpAddress=ospfHostIpAddress, ospfCompliance=ospfCompliance, ospfAreaEntry=ospfAreaEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfGeneralGroup=ospfGeneralGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfObsoleteGroup=ospfObsoleteGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfExtLsdbType=ospfExtLsdbType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfHostTOS=ospfHostTOS, ospfAreaId=ospfAreaId, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaRangeTable=ospfAreaRangeTable, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaSummary=ospfAreaSummary, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaRangeNet=ospfAreaRangeNet, ospfHostEntry=ospfHostEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrState=ospfVirtNbrState, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, UpToMaxAge=UpToMaxAge, ospfAsLsdbTable=ospfAsLsdbTable, ospfImportAsExtern=ospfImportAsExtern, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfCompliance2=ospfCompliance2, ospfIfGroup=ospfIfGroup, ospfIfEntry=ospfIfEntry, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLsdbType=ospfLsdbType, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfDemandExtensions=ospfDemandExtensions, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaLsaCount=ospfAreaLsaCount, Metric=Metric, ospfExternLsaCount=ospfExternLsaCount, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfInterArea=ospfInterArea, ospfAddressLessIf=ospfAddressLessIf, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrEvents=ospfVirtNbrEvents, RouterID=RouterID, ospfAreaRangeMask=ospfAreaRangeMask, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbLsid=ospfLsdbLsid, ospfExtLsdbAge=ospfExtLsdbAge, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfConformance=ospfConformance, ospfLsdbAge=ospfLsdbAge, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbGroup=ospfLsdbGroup, ospfVersionNumber=ospfVersionNumber, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, PYSNMP_MODULE_ID=ospf, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfAsLsaCount=ospfAsLsaCount, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfIpAddress=ospfIfIpAddress, ospfIfRtrPriority=ospfIfRtrPriority, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfNbrEvents=ospfNbrEvents, PositiveInteger=PositiveInteger, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrRtrId=ospfNbrRtrId, ospfIfAuthType=ospfIfAuthType, ospfTOSSupport=ospfTOSSupport, BigMetric=BigMetric, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfAdminStat=ospfIfAdminStat, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfMetricGroup=ospfIfMetricGroup, ospfHostStatus=ospfHostStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExternalType1=ospfExternalType1, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrOptions=ospfNbrOptions, ospfCompliances=ospfCompliances, ospfHostMetric=ospfHostMetric, ospfAuthType=ospfAuthType, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLsdbSequence=ospfLsdbSequence, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfNbrState=ospfNbrState, ospfStubRouterSupport=ospfStubRouterSupport, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, HelloRange=HelloRange, ospfNbrEntry=ospfNbrEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfEvents=ospfIfEvents, ospfHostTable=ospfHostTable)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfLsaCount=ospfIfLsaCount, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaGroup=ospfAreaGroup, ospfAreaRangeStatus=ospfAreaRangeStatus)
