...
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbAge=ospfLsdbAge, RouterID=RouterID, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfCompliance2=ospfCompliance2, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfCompliances=ospfCompliances, ospfNbrGroup2=ospfNbrGroup2, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricGroup=ospfIfMetricGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAuthType=ospfAuthType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, UpToMaxAge=UpToMaxAge, ospfStubAreaGroup=ospfStubAreaGroup, Metric=Metric, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfStatus=ospfIfStatus, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfMetricValue=ospfIfMetricValue, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLsdbGroup=ospfLsdbGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbType=ospfLocalLsdbType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfNbrIpAddr=ospfNbrIpAddr, ospfHostIpAddress=ospfHostIpAddress, ospfHostGroup=ospfHostGroup, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfLsaCount=ospfIfLsaCount, ospfExtLsdbType=ospfExtLsdbType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, PYSNMP_MODULE_ID=ospf, ospfExternalType1=ospfExternalType1, ospfLsdbEntry=ospfLsdbEntry, ospfStubMetricType=ospfStubMetricType, ospfHostAreaID=ospfHostAreaID, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, PositiveInteger=PositiveInteger, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfDemand=ospfIfDemand, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfTOSSupport=ospfTOSSupport, ospfCompliance=ospfCompliance, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfAreaId=ospfIfAreaId, Status=Status, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrPriority=ospfNbrPriority, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbTable=ospfLsdbTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfType=ospfIfType, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfStubMetric=ospfStubMetric, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfGroups=ospfGroups, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfHostGroup2=ospfHostGroup2, ospfNbrTable=ospfNbrTable, ospfLsdbType=ospfLsdbType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfStubTOS=ospfStubTOS, ospf=ospf, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrEntry=ospfNbrEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfRestartExitReason=ospfRestartExitReason, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfImportAsExtern=ospfImportAsExtern, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIntraArea=ospfIntraArea, ospfAreaGroup=ospfAreaGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbAge=ospfAsLsdbAge, BigMetric=BigMetric, ospfRestartAge=ospfRestartAge, ospfVirtIfEvents=ospfVirtIfEvents, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVersionNumber=ospfVersionNumber, ospfAreaSummary=ospfAreaSummary, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLsdbLsid=ospfLsdbLsid, ospfIfAdminStat=ospfIfAdminStat, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfExternLsaCount=ospfExternLsaCount, ospfRestartSupport=ospfRestartSupport, ospfNbrState=ospfNbrState, AreaID=AreaID, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfStubAreaTable=ospfStubAreaTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfGroup2=ospfIfGroup2, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfLsaCksumSum=ospfIfLsaCksumSum, TOSType=TOSType, ospfExternalType2=ospfExternalType2, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaId=ospfAreaId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaRangeTable=ospfAreaRangeTable, ospfRouteGroup=ospfRouteGroup, OspfAuthenticationType=OspfAuthenticationType, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrTable=ospfVirtNbrTable, ospfDemandExtensions=ospfDemandExtensions, ospfAsLsaCount=ospfAsLsaCount, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostEntry=ospfHostEntry, ospfHostStatus=ospfHostStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfConformance=ospfConformance, ospfVirtIfState=ospfVirtIfState, ospfStubAreaEntry=ospfStubAreaEntry, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfTransitDelay=ospfIfTransitDelay, ospfAreaTable=ospfAreaTable, ospfIfAuthType=ospfIfAuthType, ospfVirtIfTable=ospfVirtIfTable, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostTOS=ospfHostTOS, ospfNbrGroup=ospfNbrGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricTOS=ospfIfMetricTOS, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaStatus=ospfAreaStatus, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubAreaId=ospfStubAreaId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfGroup=ospfIfGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfPollInterval=ospfIfPollInterval, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfRouterId=ospfRouterId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfStubStatus=ospfStubStatus, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfBasicGroup=ospfBasicGroup, ospfIfState=ospfIfState, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfTable=ospfIfTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfExtLsdbAge=ospfExtLsdbAge, ospfSpfRuns=ospfSpfRuns, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfInterArea=ospfInterArea, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfRxNewLsas=ospfRxNewLsas, ospfIfMetricTable=ospfIfMetricTable, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaEntry=ospfAreaEntry, ospfGeneralGroup=ospfGeneralGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaLsaCount=ospfAreaLsaCount, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfDesignatedRouter=ospfIfDesignatedRouter, HelloRange=HelloRange, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAddressLessIf=ospfAddressLessIf, ospfAsLsdbType=ospfAsLsdbType, ospfAdminStat=ospfAdminStat, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfEvents=ospfIfEvents, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfBasicGroup2=ospfBasicGroup2, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfEntry=ospfIfEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfHostMetric=ospfHostMetric, ospfAreaGroup2=ospfAreaGroup2, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus)
mibBuilder.exportSymbols("OSPF-MIB", ospfHostTable=ospfHostTable, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfOriginateNewLsas=ospfOriginateNewLsas)
