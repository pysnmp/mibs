...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLsdbSequence=ospfLsdbSequence, ospfHostEntry=ospfHostEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAdminStat=ospfAdminStat, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfBasicGroup2=ospfBasicGroup2, ospfNbrEntry=ospfNbrEntry, ospfStubAreaTable=ospfStubAreaTable, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRouterId=ospfRouterId, ospfHostTOS=ospfHostTOS, ospfExternalType1=ospfExternalType1, PositiveInteger=PositiveInteger, ospfAuthType=ospfAuthType, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrState=ospfNbrState, HelloRange=HelloRange, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfStatus=ospfVirtIfStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfCompliance2=ospfCompliance2, ospfStubTOS=ospfStubTOS, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfAuthType=ospfIfAuthType, ospfSpfRuns=ospfSpfRuns, ospfDemandExtensions=ospfDemandExtensions, ospfIntraArea=ospfIntraArea, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfNbrGroup2=ospfNbrGroup2, ospfLsdbTable=ospfLsdbTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaEntry=ospfAreaEntry, ospfStubRouterSupport=ospfStubRouterSupport, ospfAddressLessIf=ospfAddressLessIf, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfTable=ospfIfTable, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfBasicGroup=ospfBasicGroup, ospfIfPollInterval=ospfIfPollInterval, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfMulticastExtensions=ospfMulticastExtensions, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAsLsdbAge=ospfAsLsdbAge, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfDemand=ospfIfDemand, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaSummary=ospfAreaSummary, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, RouterID=RouterID, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaId=ospfAreaId, ospfStubMetric=ospfStubMetric, ospfHostMetric=ospfHostMetric, ospfIfMetricEntry=ospfIfMetricEntry, ospfExtLsdbType=ospfExtLsdbType, PYSNMP_MODULE_ID=ospf, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfCompliances=ospfCompliances, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaGroup2=ospfAreaGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfLsdbEntry=ospfLsdbEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRestartExitReason=ospfRestartExitReason, ospfLsdbAge=ospfLsdbAge, ospfAsLsdbType=ospfAsLsdbType, ospfNbrOptions=ospfNbrOptions, Status=Status, ospfRestartAge=ospfRestartAge, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtIfEvents=ospfVirtIfEvents, ospfRestartSupport=ospfRestartSupport, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtNbrRtrId=ospfVirtNbrRtrId, AreaID=AreaID, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfTable=ospfVirtIfTable, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaTable=ospfAreaTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, TOSType=TOSType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrRtrId=ospfNbrRtrId, ospfStubMetricType=ospfStubMetricType, ospfTOSSupport=ospfTOSSupport, ospfIfEvents=ospfIfEvents, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfHostStatus=ospfHostStatus, ospfIfIpAddress=ospfIfIpAddress, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaGroup=ospfAreaGroup, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfMetricTable=ospfIfMetricTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLsdbGroup=ospfLsdbGroup, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfExternalType2=ospfExternalType2, ospfStubAreaId=ospfStubAreaId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfIfLsaCount=ospfIfLsaCount, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbType=ospfLocalLsdbType, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfStubStatus=ospfStubStatus, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfState=ospfVirtIfState, ospfIfState=ospfIfState, ospfLsdbChecksum=ospfLsdbChecksum, ospfIfStatus=ospfIfStatus, ospfIfRetransInterval=ospfIfRetransInterval, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfHostTable=ospfHostTable, BigMetric=BigMetric, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospf=ospf, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfHostIpAddress=ospfHostIpAddress, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfImportAsExtern=ospfImportAsExtern, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfInterArea=ospfInterArea, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfIfAreaId=ospfIfAreaId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfMetricTOS=ospfIfMetricTOS, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfHostAreaID=ospfHostAreaID, ospfNbrGroup=ospfNbrGroup, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRestartStatus=ospfRestartStatus, ospfGroups=ospfGroups, Metric=Metric, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAsLsaCount=ospfAsLsaCount, ospfConformance=ospfConformance, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfEntry=ospfIfEntry, ospfLsdbType=ospfLsdbType, ospfLsdbLsid=ospfLsdbLsid, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbrIpAddr=ospfNbrIpAddr, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfRouteGroup=ospfRouteGroup, UpToMaxAge=UpToMaxAge, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfRxNewLsas=ospfRxNewLsas, ospfCompliance=ospfCompliance, ospfNbrTable=ospfNbrTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfMetricValue=ospfIfMetricValue, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfIfAdminStat=ospfIfAdminStat, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfGroup2=ospfIfGroup2, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaStatus=ospfAreaStatus, ospfIfHelloInterval=ospfIfHelloInterval, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfGroup=ospfIfGroup, OspfAuthenticationType=OspfAuthenticationType, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfRestartInterval=ospfRestartInterval, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostGroup=ospfHostGroup)
mibBuilder.exportSymbols("OSPF-MIB", ospfVersionNumber=ospfVersionNumber, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfType=ospfIfType, ospfExternLsaCount=ospfExternLsaCount)
