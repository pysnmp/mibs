...
mibBuilder.exportSymbols("OSPF-MIB", ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, PositiveInteger=PositiveInteger, ospfStubAreaId=ospfStubAreaId, ospfNbrEvents=ospfNbrEvents, UpToMaxAge=UpToMaxAge, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfCompliance2=ospfCompliance2, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfIfGroup=ospfIfGroup, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, PYSNMP_MODULE_ID=ospf, ospfIntraArea=ospfIntraArea, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfHostCfgAreaID=ospfHostCfgAreaID, Status=Status, ospfExtLsdbType=ospfExtLsdbType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfIfPollInterval=ospfIfPollInterval, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVersionNumber=ospfVersionNumber, ospfIfAuthType=ospfIfAuthType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbAge=ospfLsdbAge, ospfIfMetricValue=ospfIfMetricValue, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfHostTable=ospfHostTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrState=ospfNbrState, ospfRouteGroup=ospfRouteGroup, ospfGroups=ospfGroups, ospfTOSSupport=ospfTOSSupport, ospfObsoleteGroup=ospfObsoleteGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartExitReason=ospfRestartExitReason, ospfBasicGroup=ospfBasicGroup, ospfAreaGroup2=ospfAreaGroup2, TOSType=TOSType, HelloRange=HelloRange, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfBasicGroup2=ospfBasicGroup2, ospfRestartInterval=ospfRestartInterval, ospfConformance=ospfConformance, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, Metric=Metric, ospfCompliance=ospfCompliance, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaStatus=ospfAreaStatus, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrTable=ospfVirtNbrTable, ospfRouterId=ospfRouterId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMetricGroup=ospfIfMetricGroup, BigMetric=BigMetric, ospf=ospf, ospfNbrPriority=ospfNbrPriority, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfSpfRuns=ospfSpfRuns, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfState=ospfIfState, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfRestartAge=ospfRestartAge, ospfLocalLsdbType=ospfLocalLsdbType, ospfLsdbType=ospfLsdbType, ospfIfStatus=ospfIfStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfHostStatus=ospfHostStatus, ospfIfAuthKey=ospfIfAuthKey, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLsdbAreaId=ospfLsdbAreaId, ospfRestartStatus=ospfRestartStatus, ospfNbrOptions=ospfNbrOptions, ospfStubAreaGroup=ospfStubAreaGroup, ospfHostTOS=ospfHostTOS, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubAreaTable=ospfStubAreaTable, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAsLsdbTable=ospfAsLsdbTable, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbSequence=ospfLsdbSequence, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAddressLessIf=ospfAddressLessIf, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostMetric=ospfHostMetric, ospfIfDemand=ospfIfDemand, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfMetricTable=ospfIfMetricTable, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfNbrRtrId=ospfNbrRtrId, ospfAreaRangeTable=ospfAreaRangeTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfNbrGroup=ospfNbrGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfStubTOS=ospfStubTOS, ospfExternalType1=ospfExternalType1, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbEntry=ospfLsdbEntry, ospfLsdbGroup=ospfLsdbGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, AreaID=AreaID, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrGroup2=ospfNbrGroup2, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfImportAsExtern=ospfImportAsExtern, ospfAreaTable=ospfAreaTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfCompliances=ospfCompliances, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaGroup=ospfAreaGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaSummary=ospfAreaSummary, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAdminStat=ospfAdminStat, ospfIfLsaCount=ospfIfLsaCount, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostGroup=ospfHostGroup, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLsdbTable=ospfLsdbTable, ospfHostGroup2=ospfHostGroup2, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostEntry=ospfHostEntry, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfState=ospfVirtIfState, ospfNbrTable=ospfNbrTable, ospfAreaId=ospfAreaId, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLsdbLsid=ospfLsdbLsid, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAsLsdbType=ospfAsLsdbType, ospfHostIpAddress=ospfHostIpAddress, ospfInterArea=ospfInterArea, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfIpAddress=ospfIfIpAddress, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubMetricType=ospfStubMetricType, ospfVirtNbrArea=ospfVirtNbrArea, ospfVirtIfEntry=ospfVirtIfEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfAdminStat=ospfIfAdminStat, ospfRxNewLsas=ospfRxNewLsas, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfLsdbChecksum=ospfLsdbChecksum, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfGroup2=ospfIfGroup2, ospfStubStatus=ospfStubStatus, ospfIfTable=ospfIfTable, ospfIfAreaId=ospfIfAreaId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaEntry=ospfAreaEntry, ospfStubMetric=ospfStubMetric, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfEntry=ospfIfEntry, RouterID=RouterID, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfDemandExtensions=ospfDemandExtensions, ospfLsdbRouterId=ospfLsdbRouterId, ospfAsLsaCount=ospfAsLsaCount, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtIfGroup=ospfVirtIfGroup, ospfAuthType=ospfAuthType, ospfExternalType2=ospfExternalType2, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfType=ospfIfType, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason)
mibBuilder.exportSymbols("OSPF-MIB", ospfStubRouterSupport=ospfStubRouterSupport, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtIfTable=ospfVirtIfTable)
