...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfAreaId=ospfIfAreaId, ospfAdminStat=ospfAdminStat, ospfVirtIfEvents=ospfVirtIfEvents, ospfGeneralGroup=ospfGeneralGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrGroup2=ospfNbrGroup2, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfStatus=ospfIfStatus, ospfDemandExtensions=ospfDemandExtensions, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfBasicGroup2=ospfBasicGroup2, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfGroup2=ospfIfGroup2, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfTable=ospfIfTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfHostMetric=ospfHostMetric, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfPollInterval=ospfIfPollInterval, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfIfType=ospfIfType, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtIfState=ospfVirtIfState, ospfExternalType2=ospfExternalType2, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfDemand=ospfIfDemand, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostGroup2=ospfHostGroup2, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaGroup2=ospfAreaGroup2, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostAreaID=ospfHostAreaID, ospfAreaId=ospfAreaId, ospfHostIpAddress=ospfHostIpAddress, ospfTOSSupport=ospfTOSSupport, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfLsdbAge=ospfLsdbAge, ospfRouterId=ospfRouterId, ospfLsdbAreaId=ospfLsdbAreaId, PositiveInteger=PositiveInteger, ospfExtLsdbAge=ospfExtLsdbAge, ospfConformance=ospfConformance, ospfLsdbLsid=ospfLsdbLsid, ospfNbmaNbrStatus=ospfNbmaNbrStatus, BigMetric=BigMetric, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRouteGroup=ospfRouteGroup, ospfNbrState=ospfNbrState, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfEntry=ospfIfEntry, ospfHostTOS=ospfHostTOS, ospfVersionNumber=ospfVersionNumber, ospfAreaRangeMask=ospfAreaRangeMask, ospfNbrEvents=ospfNbrEvents, ospfExtLsdbType=ospfExtLsdbType, ospfIfMetricTable=ospfIfMetricTable, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfCompliance2=ospfCompliance2, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfStubAreaId=ospfStubAreaId, ospfRestartExitReason=ospfRestartExitReason, PYSNMP_MODULE_ID=ospf, ospfLsdbChecksum=ospfLsdbChecksum, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaSummary=ospfAreaSummary, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAuthType=ospfAuthType, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfIfAuthType=ospfIfAuthType, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfHostTable=ospfHostTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbTable=ospfLsdbTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExternLsaCount=ospfExternLsaCount, Status=Status, ospfMulticastExtensions=ospfMulticastExtensions, ospfLsdbGroup=ospfLsdbGroup, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfCompliances=ospfCompliances, UpToMaxAge=UpToMaxAge, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfAdminStat=ospfIfAdminStat, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfStubMetric=ospfStubMetric, ospfStubRouterSupport=ospfStubRouterSupport, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAddressLessIf=ospfAddressLessIf, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, OspfAuthenticationType=OspfAuthenticationType, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfIpAddress=ospfIfIpAddress, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfNbrOptions=ospfNbrOptions, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfRestartAge=ospfRestartAge, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfNbrPriority=ospfNbrPriority, ospfNbrIpAddr=ospfNbrIpAddr, ospfBasicGroup=ospfBasicGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrEntry=ospfNbrEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfLsdbType=ospfLsdbType, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrGroup=ospfNbrGroup, ospfRxNewLsas=ospfRxNewLsas, ospfExternalType1=ospfExternalType1, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrTable=ospfNbrTable, TOSType=TOSType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfStubAreaTable=ospfStubAreaTable, ospfStubAreaEntry=ospfStubAreaEntry, ospfGroups=ospfGroups, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfRestartInterval=ospfRestartInterval, ospfHostEntry=ospfHostEntry, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaRangeNet=ospfAreaRangeNet, ospfStubMetricType=ospfStubMetricType, ospfAreaStatus=ospfAreaStatus, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfSpfRuns=ospfSpfRuns, ospfLsdbSequence=ospfLsdbSequence, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaTable=ospfAreaTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaGroup=ospfAreaGroup, ospfIfEvents=ospfIfEvents, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLsdbEntry=ospfLsdbEntry, ospfImportAsExtern=ospfImportAsExtern, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfInterArea=ospfInterArea, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, Metric=Metric, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfHostGroup=ospfHostGroup, ospfIfGroup=ospfIfGroup, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfState=ospfIfState, ospfIfLsaCount=ospfIfLsaCount, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfStubStatus=ospfStubStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfStubAreaGroup=ospfStubAreaGroup, ospf=ospf, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrState=ospfVirtNbrState, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfRestartSupport=ospfRestartSupport, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateEntry=ospfAreaAggregateEntry, AreaID=AreaID, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIntraArea=ospfIntraArea, ospfCompliance=ospfCompliance, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, RouterID=RouterID, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaEntry=ospfAreaEntry, HelloRange=HelloRange, ospfAsLsaCount=ospfAsLsaCount, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfStubTOS=ospfStubTOS, ospfRestartStatus=ospfRestartStatus, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfHostStatus=ospfHostStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfMetricTOS=ospfIfMetricTOS)
