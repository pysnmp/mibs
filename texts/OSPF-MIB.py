...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, Status=Status, ospfAsLsaCount=ospfAsLsaCount, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrArea=ospfVirtNbrArea, ospfExternLsaCount=ospfExternLsaCount, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfNbrEntry=ospfNbrEntry, ospfAuthType=ospfAuthType, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtNbrTable=ospfVirtNbrTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfCompliances=ospfCompliances, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, HelloRange=HelloRange, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrOptions=ospfVirtNbrOptions, Metric=Metric, BigMetric=BigMetric, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfNbrTable=ospfNbrTable, ospfIfMetricEntry=ospfIfMetricEntry, ospfHostTOS=ospfHostTOS, ospfNbrEvents=ospfNbrEvents, ospfVersionNumber=ospfVersionNumber, ospfLsdbAge=ospfLsdbAge, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfTable=ospfIfTable, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfDemand=ospfIfDemand, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfStubStatus=ospfStubStatus, ospfVirtIfTable=ospfVirtIfTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaGroup=ospfAreaGroup, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfRouterId=ospfRouterId, AreaID=AreaID, ospfStubTOS=ospfStubTOS, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfDemandExtensions=ospfDemandExtensions, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfSpfRuns=ospfSpfRuns, RouterID=RouterID, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAddressLessIf=ospfAddressLessIf, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExternalType2=ospfExternalType2, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaLsaCount=ospfAreaLsaCount, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfLsaCount=ospfIfLsaCount, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfBasicGroup2=ospfBasicGroup2, ospfRestartStatus=ospfRestartStatus, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaEntry=ospfAreaEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrPriority=ospfNbrPriority, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaTable=ospfAreaTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfRestartInterval=ospfRestartInterval, ospfImportAsExtern=ospfImportAsExtern, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfStatus=ospfIfStatus, ospfExtLsdbType=ospfExtLsdbType, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfGeneralGroup=ospfGeneralGroup, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, TOSType=TOSType, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfPollInterval=ospfIfPollInterval, ospfHostStatus=ospfHostStatus, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfIfState=ospfIfState, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfNbrGroup2=ospfNbrGroup2, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsdbAge=ospfAsLsdbAge, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfAuthType=ospfIfAuthType, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrState=ospfVirtNbrState, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfLsdbTable=ospfLsdbTable, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfAuthKey=ospfIfAuthKey, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbType=ospfAsLsdbType, ospfStubRouterSupport=ospfStubRouterSupport, ospfHostMetric=ospfHostMetric, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfRestartExitReason=ospfRestartExitReason, ospfNbrOptions=ospfNbrOptions, ospfIntraArea=ospfIntraArea, ospfHostIpAddress=ospfHostIpAddress, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaStatus=ospfAreaStatus, ospfLsdbEntry=ospfLsdbEntry, ospfCompliance2=ospfCompliance2, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaId=ospfAreaId, DesignatedRouterPriority=DesignatedRouterPriority, ospfHostEntry=ospfHostEntry, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrState=ospfNbrState, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLocalLsdbType=ospfLocalLsdbType, ospfStubMetricType=ospfStubMetricType, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfHostTable=ospfHostTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLsdbGroup=ospfLsdbGroup, ospfLsdbType=ospfLsdbType, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfState=ospfVirtIfState, ospfRestartSupport=ospfRestartSupport, ospfVirtIfAreaId=ospfVirtIfAreaId, ospf=ospf, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostAreaID=ospfHostAreaID, ospfLsdbSequence=ospfLsdbSequence, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfMulticastForwarding=ospfIfMulticastForwarding, UpToMaxAge=UpToMaxAge, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfMetricTable=ospfIfMetricTable, ospfIfMetricValue=ospfIfMetricValue, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfMulticastExtensions=ospfMulticastExtensions, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfGroup=ospfIfGroup, ospfStubMetric=ospfStubMetric, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfAreaId=ospfIfAreaId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfConformance=ospfConformance, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfExternalType1=ospfExternalType1, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfMetricIpAddress=ospfIfMetricIpAddress, PYSNMP_MODULE_ID=ospf, ospfRestartAge=ospfRestartAge, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLsdbLsid=ospfLsdbLsid, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfTOSSupport=ospfTOSSupport, ospfCompliance=ospfCompliance, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaSummary=ospfAreaSummary, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLocalLsdbSequence=ospfLocalLsdbSequence, PositiveInteger=PositiveInteger, ospfLsdbChecksum=ospfLsdbChecksum, ospfRouteGroup=ospfRouteGroup, ospfIfGroup2=ospfIfGroup2, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfEvents=ospfIfEvents, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostGroup=ospfHostGroup, ospfStubAreaId=ospfStubAreaId, ospfIfHelloInterval=ospfIfHelloInterval, ospfAsLsdbTable=ospfAsLsdbTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfStubAreaTable=ospfStubAreaTable, ospfIfEntry=ospfIfEntry, ospfIfAdminStat=ospfIfAdminStat, ospfIfType=ospfIfType, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfEntry=ospfVirtIfEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfBasicGroup=ospfBasicGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, OspfAuthenticationType=OspfAuthenticationType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfNbrGroup=ospfNbrGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen)
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfInterArea=ospfInterArea, ospfGroups=ospfGroups, ospfAdminStat=ospfAdminStat)
