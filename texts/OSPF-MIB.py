...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMetricStatus=ospfIfMetricStatus, ospfIfHelloInterval=ospfIfHelloInterval, ospfSpfRuns=ospfSpfRuns, ospfIfGroup=ospfIfGroup, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfHostEntry=ospfHostEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, TOSType=TOSType, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfNbrOptions=ospfNbrOptions, ospfHostMetric=ospfHostMetric, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfLsdbAge=ospfLsdbAge, ospfNbrEntry=ospfNbrEntry, ospfAsLsaCount=ospfAsLsaCount, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaGroup=ospfAreaGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfBasicGroup2=ospfBasicGroup2, ospfHostStatus=ospfHostStatus, ospfStubMetric=ospfStubMetric, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfTable=ospfIfTable, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAuthType=ospfAuthType, ospfStubMetricType=ospfStubMetricType, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbType=ospfExtLsdbType, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfLsdbEntry=ospfLsdbEntry, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfNbrTable=ospfNbrTable, ospfIfIpAddress=ospfIfIpAddress, ospfStubStatus=ospfStubStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaEntry=ospfAreaEntry, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfAreaId=ospfIfAreaId, ospfHostIpAddress=ospfHostIpAddress, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfEvents=ospfIfEvents, ospfLsdbType=ospfLsdbType, ospfStubAreaTable=ospfStubAreaTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfRestartInterval=ospfRestartInterval, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLsdbTable=ospfLsdbTable, ospfIfState=ospfIfState, ospfExternalType1=ospfExternalType1, ospfIfType=ospfIfType, ospfIfLsaCount=ospfIfLsaCount, ospfIfTransitDelay=ospfIfTransitDelay, ospfNbrPriority=ospfNbrPriority, ospfExternalType2=ospfExternalType2, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfConformance=ospfConformance, ospfExtLsdbTable=ospfExtLsdbTable, ospfCompliances=ospfCompliances, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrEntry=ospfVirtNbrEntry, PositiveInteger=PositiveInteger, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLsdbRouterId=ospfLsdbRouterId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaId=ospfAreaId, ospfHostTable=ospfHostTable, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfImportAsExtern=ospfImportAsExtern, ospfHostGroup2=ospfHostGroup2, ospfGeneralGroup=ospfGeneralGroup, ospfObsoleteGroup=ospfObsoleteGroup, OspfAuthenticationType=OspfAuthenticationType, ospfDemandExtensions=ospfDemandExtensions, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, HelloRange=HelloRange, ospfAddressLessIf=ospfAddressLessIf, Status=Status, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfPollInterval=ospfIfPollInterval, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfStatus=ospfVirtIfStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfRestartAge=ospfRestartAge, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtIfEvents=ospfVirtIfEvents, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfIntraArea=ospfIntraArea, ospfInterArea=ospfInterArea, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfExternLsaCount=ospfExternLsaCount, ospfNbrState=ospfNbrState, ospfHostGroup=ospfHostGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfStatus=ospfIfStatus, ospfLsdbSequence=ospfLsdbSequence, ospfNbrGroup2=ospfNbrGroup2, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfLsdbLsid=ospfLsdbLsid, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfBasicGroup=ospfBasicGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrState=ospfVirtNbrState, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAsLsdbType=ospfAsLsdbType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrGroup=ospfNbrGroup, ospfAreaTable=ospfAreaTable, ospfIfAdminStat=ospfIfAdminStat, ospfNbrRtrId=ospfNbrRtrId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfCompliance=ospfCompliance, ospfTOSSupport=ospfTOSSupport, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaRangeTable=ospfAreaRangeTable, ospfGroups=ospfGroups, ospf=ospf, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfGroup2=ospfIfGroup2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAsLsdbRouterId=ospfAsLsdbRouterId, RouterID=RouterID, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaStatus=ospfAreaStatus, ospfRestartExitReason=ospfRestartExitReason, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfStubTOS=ospfStubTOS, BigMetric=BigMetric, AreaID=AreaID, ospfMulticastExtensions=ospfMulticastExtensions, ospfRxNewLsas=ospfRxNewLsas, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfEntry=ospfIfEntry, ospfAreaSummary=ospfAreaSummary, ospfIfAuthType=ospfIfAuthType, ospfIfRetransInterval=ospfIfRetransInterval, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfRestartStatus=ospfRestartStatus, ospfHostTOS=ospfHostTOS, ospfRestartSupport=ospfRestartSupport, ospfAdminStat=ospfAdminStat, PYSNMP_MODULE_ID=ospf, UpToMaxAge=UpToMaxAge, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfStubAreaId=ospfStubAreaId, ospfCompliance2=ospfCompliance2, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfIfMetricValue=ospfIfMetricValue, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrEvents=ospfNbrEvents, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfAuthKey=ospfIfAuthKey, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLocalLsdbGroup=ospfLocalLsdbGroup, Metric=Metric, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfDemand=ospfIfDemand, ospfLsdbGroup=ospfLsdbGroup, ospfRouterId=ospfRouterId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVersionNumber=ospfVersionNumber)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval)
