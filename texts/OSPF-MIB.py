...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaSummary=ospfAreaSummary, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaStatus=ospfAreaStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtIfStatus=ospfVirtIfStatus, ospfRestartExitReason=ospfRestartExitReason, ospfIfAreaId=ospfIfAreaId, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAreaRangeNet=ospfAreaRangeNet, PositiveInteger=PositiveInteger, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfRtrPriority=ospfIfRtrPriority, HelloRange=HelloRange, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, UpToMaxAge=UpToMaxAge, ospfDemandExtensions=ospfDemandExtensions, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtNbrState=ospfVirtNbrState, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, Status=Status, ospfLsdbEntry=ospfLsdbEntry, ospfAreaId=ospfAreaId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfCompliances=ospfCompliances, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfBasicGroup=ospfBasicGroup, ospfNbrOptions=ospfNbrOptions, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubAreaId=ospfStubAreaId, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfHostGroup2=ospfHostGroup2, ospfStubTOS=ospfStubTOS, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfStubAreaTable=ospfStubAreaTable, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfType=ospfIfType, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubRouterSupport=ospfStubRouterSupport, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfIfIpAddress=ospfIfIpAddress, ospfIfState=ospfIfState, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfGroup2=ospfVirtIfGroup2, TOSType=TOSType, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbType=ospfLocalLsdbType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, Metric=Metric, ospfVirtNbrArea=ospfVirtNbrArea, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfMetricTOS=ospfIfMetricTOS, ospfCompliance=ospfCompliance, ospfTOSSupport=ospfTOSSupport, ospfLsdbAge=ospfLsdbAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbGroup=ospfLsdbGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfImportAsExtern=ospfImportAsExtern, ospfIfStatus=ospfIfStatus, ospfIfAuthType=ospfIfAuthType, ospfIfMetricEntry=ospfIfMetricEntry, ospfGroups=ospfGroups, ospfVirtIfGroup=ospfVirtIfGroup, ospfExtLsdbType=ospfExtLsdbType, ospfNbrRtrId=ospfNbrRtrId, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfStubAreaGroup=ospfStubAreaGroup, ospfNbrPriority=ospfNbrPriority, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaRangeTable=ospfAreaRangeTable, ospfHostMetric=ospfHostMetric, ospfHostAreaID=ospfHostAreaID, ospfBasicGroup2=ospfBasicGroup2, OspfAuthenticationType=OspfAuthenticationType, RouterID=RouterID, ospfExternalType2=ospfExternalType2, ospfRestartInterval=ospfRestartInterval, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsdbType=ospfAsLsdbType, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAuthType=ospfAuthType, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfGeneralGroup=ospfGeneralGroup, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrGroup2=ospfNbrGroup2, ospf=ospf, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIntraArea=ospfIntraArea, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfRxNewLsas=ospfRxNewLsas, ospfRouterId=ospfRouterId, BigMetric=BigMetric, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfConformance=ospfConformance, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfEvents=ospfIfEvents, ospfIfMetricTable=ospfIfMetricTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfObsoleteGroup=ospfObsoleteGroup, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfSpfRuns=ospfSpfRuns, ospfIfPollInterval=ospfIfPollInterval, ospfLsdbType=ospfLsdbType, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricValue=ospfIfMetricValue, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaTable=ospfAreaTable, ospfStubStatus=ospfStubStatus, ospfIfAuthKey=ospfIfAuthKey, ospfRestartAge=ospfRestartAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAsLsaCount=ospfAsLsaCount, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVersionNumber=ospfVersionNumber, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfNbrState=ospfNbrState, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfLsaCount=ospfIfLsaCount, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExternalType1=ospfExternalType1, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfEntry=ospfIfEntry, ospfNbrEntry=ospfNbrEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExternLsaCount=ospfExternLsaCount, PYSNMP_MODULE_ID=ospf, ospfIfMetricStatus=ospfIfMetricStatus, ospfAreaGroup=ospfAreaGroup, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrTable=ospfNbrTable, ospfHostGroup=ospfHostGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfGroup=ospfIfGroup, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaEntry=ospfAreaEntry, ospfNbrEvents=ospfNbrEvents, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfRestartSupport=ospfRestartSupport, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfGroup2=ospfIfGroup2, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaGroup2=ospfAreaGroup2, ospfLsdbLsid=ospfLsdbLsid, ospfNbrIpAddr=ospfNbrIpAddr, AreaID=AreaID, ospfHostTOS=ospfHostTOS, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfInterArea=ospfInterArea, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfDemand=ospfIfDemand, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfStubMetric=ospfStubMetric, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfTable=ospfIfTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfCompliance2=ospfCompliance2, ospfStubMetricType=ospfStubMetricType, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfEntry=ospfVirtIfEntry, ospfLsdbTable=ospfLsdbTable, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLsdbChecksum=ospfLsdbChecksum, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfHostTable=ospfHostTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfHostStatus=ospfHostStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtIfState=ospfVirtIfState, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrGroup=ospfNbrGroup, ospfAdminStat=ospfAdminStat, ospfHostEntry=ospfHostEntry, ospfIfTransitDelay=ospfIfTransitDelay, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAddressLessIf=ospfAddressLessIf, ospfIfAdminStat=ospfIfAdminStat)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfHostIpAddress=ospfHostIpAddress, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex)
