...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfRtrPriority=ospfIfRtrPriority, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfDemand=ospfIfDemand, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfGroup=ospfIfGroup, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfStubMetricType=ospfStubMetricType, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, PositiveInteger=PositiveInteger, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLsdbGroup=ospfLsdbGroup, ospfIntraArea=ospfIntraArea, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfCompliance2=ospfCompliance2, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfRestartSupport=ospfRestartSupport, ospfAreaStatus=ospfAreaStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrIpAddr=ospfNbrIpAddr, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfObsoleteGroup=ospfObsoleteGroup, ospfVersionNumber=ospfVersionNumber, ospfBasicGroup=ospfBasicGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfIfType=ospfIfType, TOSType=TOSType, ospfAdminStat=ospfAdminStat, ospfExternLsaCount=ospfExternLsaCount, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfTransitDelay=ospfIfTransitDelay, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfIfStatus=ospfIfStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsdbType=ospfAsLsdbType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfSpfRuns=ospfSpfRuns, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfBasicGroup2=ospfBasicGroup2, ospfIfGroup2=ospfIfGroup2, ospfStubMetric=ospfStubMetric, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfNbrGroup2=ospfNbrGroup2, ospfStubStatus=ospfStubStatus, ospfIfAreaId=ospfIfAreaId, ospfLsdbAge=ospfLsdbAge, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfNbrGroup=ospfNbrGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfHostGroup=ospfHostGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfLsaCount=ospfIfLsaCount, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExtLsdbType=ospfExtLsdbType, ospfIfMetricTOS=ospfIfMetricTOS, AreaID=AreaID, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfRouterId=ospfRouterId, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaRangeTable=ospfAreaRangeTable, PYSNMP_MODULE_ID=ospf, ospfIfTable=ospfIfTable, ospfAreaSummary=ospfAreaSummary, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExternalType1=ospfExternalType1, ospfIfMetricValue=ospfIfMetricValue, ospfIfIpAddress=ospfIfIpAddress, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLsdbSequence=ospfLsdbSequence, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfMetricStatus=ospfIfMetricStatus, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfStubAreaId=ospfStubAreaId, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfStubTOS=ospfStubTOS, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaGroup=ospfAreaGroup, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfHostStatus=ospfHostStatus, ospfHostEntry=ospfHostEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfTOSSupport=ospfTOSSupport, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtNbrRtrId=ospfVirtNbrRtrId, BigMetric=BigMetric, ospfNbrState=ospfNbrState, ospfAuthType=ospfAuthType, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfConformance=ospfConformance, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfGeneralGroup=ospfGeneralGroup, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, DesignatedRouterPriority=DesignatedRouterPriority, ospfNbrEvents=ospfNbrEvents, RouterID=RouterID, ospfVirtNbrArea=ospfVirtNbrArea, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfImportAsExtern=ospfImportAsExtern, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbAreaId=ospfLsdbAreaId, ospfRestartExitReason=ospfRestartExitReason, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaLsaCount=ospfAreaLsaCount, ospfHostTOS=ospfHostTOS, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfLsdbEntry=ospfLsdbEntry, ospfAreaRangeMask=ospfAreaRangeMask, ospfAddressLessIf=ospfAddressLessIf, HelloRange=HelloRange, ospfHostIpAddress=ospfHostIpAddress, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfEntry=ospfVirtIfEntry, ospfDemandExtensions=ospfDemandExtensions, ospfVirtIfTable=ospfVirtIfTable, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfIfHelloInterval=ospfIfHelloInterval, ospfRestartAge=ospfRestartAge, ospfAsLsaCount=ospfAsLsaCount, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, Status=Status, ospfHostGroup2=ospfHostGroup2, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLsdbRouterId=ospfLsdbRouterId, ospfRestartInterval=ospfRestartInterval, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfRestartStatus=ospfRestartStatus, ospfAreaTable=ospfAreaTable, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfHostTable=ospfHostTable, ospfStubAreaTable=ospfStubAreaTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfExternalType2=ospfExternalType2, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbTable=ospfLocalLsdbTable, UpToMaxAge=UpToMaxAge, ospfIfEvents=ospfIfEvents, ospfInterArea=ospfInterArea, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfStubAreaEntry=ospfStubAreaEntry, ospfRxNewLsas=ospfRxNewLsas, ospfIfAuthKey=ospfIfAuthKey, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospf=ospf, ospfLsdbLsid=ospfLsdbLsid, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrTable=ospfNbrTable, ospfIfEntry=ospfIfEntry, ospfHostMetric=ospfHostMetric, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaId=ospfAreaId, ospfVirtIfState=ospfVirtIfState, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfGroups=ospfGroups, ospfLsdbTable=ospfLsdbTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtIfEvents=ospfVirtIfEvents, ospfCompliances=ospfCompliances, ospfIfPollInterval=ospfIfPollInterval, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfMetricTable=ospfIfMetricTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaGroup2=ospfAreaGroup2, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfCompliance=ospfCompliance, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, OspfAuthenticationType=OspfAuthenticationType, ospfIfState=ospfIfState, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfRetransInterval=ospfIfRetransInterval, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfNbrEntry=ospfNbrEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfNbrPriority=ospfNbrPriority)
mibBuilder.exportSymbols("OSPF-MIB", ospfRouteGroup=ospfRouteGroup, Metric=Metric, ospfVirtNbrTable=ospfVirtNbrTable, ospfLsdbType=ospfLsdbType)
