...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAuthType=ospfAuthType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExtLsdbTable=ospfExtLsdbTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfHostGroup2=ospfHostGroup2, ospfAreaRangeTable=ospfAreaRangeTable, ospfStubMetric=ospfStubMetric, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfAreaEntry=ospfAreaEntry, ospfVirtNbrState=ospfVirtNbrState, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfCompliance=ospfCompliance, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfGroups=ospfGroups, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfState=ospfVirtIfState, ospfIfIpAddress=ospfIfIpAddress, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfConformance=ospfConformance, ospfLsdbChecksum=ospfLsdbChecksum, BigMetric=BigMetric, ospfNbrIpAddr=ospfNbrIpAddr, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfMetricGroup=ospfIfMetricGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAdminStat=ospfAdminStat, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfState=ospfIfState, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfMetricValue=ospfIfMetricValue, ospfStubAreaTable=ospfStubAreaTable, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfPollInterval=ospfIfPollInterval, ospfRestartInterval=ospfRestartInterval, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfHostTOS=ospfHostTOS, HelloRange=HelloRange, ospfIfAdminStat=ospfIfAdminStat, Metric=Metric, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAddressLessIf=ospfAddressLessIf, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfRestartAge=ospfRestartAge, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, OspfAuthenticationType=OspfAuthenticationType, ospfInterArea=ospfInterArea, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfStatus=ospfIfStatus, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfAreaGroup2=ospfAreaGroup2, ospfIfMetricTable=ospfIfMetricTable, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaStatus=ospfAreaStatus, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrState=ospfNbrState, ospfDemandExtensions=ospfDemandExtensions, ospfNbrPriority=ospfNbrPriority, ospfNbrOptions=ospfNbrOptions, ospfNbrEvents=ospfNbrEvents, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfLocalLsdbEntry=ospfLocalLsdbEntry, PYSNMP_MODULE_ID=ospf, ospfHostMetric=ospfHostMetric, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfAuthKey=ospfIfAuthKey, ospfVersionNumber=ospfVersionNumber, ospfAreaId=ospfAreaId, ospfLsdbAreaId=ospfLsdbAreaId, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaTable=ospfAreaTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfSpfRuns=ospfSpfRuns, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfMulticastExtensions=ospfMulticastExtensions, ospfStubMetricType=ospfStubMetricType, ospfAsLsaCount=ospfAsLsaCount, ospfRouterId=ospfRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfLsdbEntry=ospfLsdbEntry, ospfIfEntry=ospfIfEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExternalType1=ospfExternalType1, ospfAsLsdbType=ospfAsLsdbType, AreaID=AreaID, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfExtLsdbLimit=ospfExtLsdbLimit, PositiveInteger=PositiveInteger, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfRestartStatus=ospfRestartStatus, ospfAreaRangeMask=ospfAreaRangeMask, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, Status=Status, ospfRestartSupport=ospfRestartSupport, ospfLsdbLsid=ospfLsdbLsid, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLsdbSequence=ospfLsdbSequence, RouterID=RouterID, ospfIfType=ospfIfType, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfTOSSupport=ospfTOSSupport, ospfIfRtrPriority=ospfIfRtrPriority, ospf=ospf, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfComplianceObsolete=ospfComplianceObsolete, ospfStubAreaGroup=ospfStubAreaGroup, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRouteGroup=ospfRouteGroup, ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrTable=ospfNbrTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfCompliance2=ospfCompliance2, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfHostAreaID=ospfHostAreaID, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubStatus=ospfStubStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLsdbGroup=ospfLsdbGroup, ospfIntraArea=ospfIntraArea, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfExtLsdbType=ospfExtLsdbType, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfHostStatus=ospfHostStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfIfDemand=ospfIfDemand, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfHostGroup=ospfHostGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, UpToMaxAge=UpToMaxAge, ospfHostTable=ospfHostTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfIfAreaId=ospfIfAreaId, ospfAreaGroup=ospfAreaGroup, ospfExternalType2=ospfExternalType2, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfEvents=ospfIfEvents, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfCompliances=ospfCompliances, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfStubTOS=ospfStubTOS, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfTable=ospfVirtIfTable, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfBasicGroup2=ospfBasicGroup2, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaSummary=ospfAreaSummary, ospfRestartExitReason=ospfRestartExitReason, ospfNbrGroup2=ospfNbrGroup2, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfHostIpAddress=ospfHostIpAddress, ospfIfTable=ospfIfTable, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfHostEntry=ospfHostEntry, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfGroup2=ospfIfGroup2, ospfIfAuthType=ospfIfAuthType, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfGeneralGroup=ospfGeneralGroup, ospfAsLsdbTable=ospfAsLsdbTable, ospfLsdbTable=ospfLsdbTable, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfIfGroup=ospfIfGroup, ospfLsdbType=ospfLsdbType, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfVirtIfEvents=ospfVirtIfEvents, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, TOSType=TOSType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrRtrId=ospfNbrRtrId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfNbrGroup=ospfNbrGroup, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfLsdbAge=ospfLsdbAge, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfStatus=ospfVirtIfStatus, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfIfMetricTOS=ospfIfMetricTOS, ospfExternLsaCount=ospfExternLsaCount, ospfNbrEntry=ospfNbrEntry, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrTable=ospfVirtNbrTable, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateMask=ospfAreaAggregateMask)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfTransitDelay=ospfIfTransitDelay, ospfLocalLsdbTable=ospfLocalLsdbTable)
