...
mibBuilder.exportSymbols("OSPF-MIB", ospf=ospf, ospfLsdbAreaId=ospfLsdbAreaId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtNbrTable=ospfVirtNbrTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfAuthType=ospfIfAuthType, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfHostGroup2=ospfHostGroup2, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaTable=ospfAreaTable, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfStubAreaId=ospfStubAreaId, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfSpfRuns=ospfSpfRuns, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrGroup=ospfNbrGroup, ospfIfAuthKey=ospfIfAuthKey, ospfHostMetric=ospfHostMetric, ospfRouterId=ospfRouterId, ospfGeneralGroup=ospfGeneralGroup, ospfIfMetricValue=ospfIfMetricValue, ospfStubTOS=ospfStubTOS, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfGroups=ospfGroups, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfCompliance2=ospfCompliance2, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfGroup2=ospfIfGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfExternalType1=ospfExternalType1, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfBasicGroup2=ospfBasicGroup2, ospfIfAreaId=ospfIfAreaId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfHostIpAddress=ospfHostIpAddress, ospfCompliance=ospfCompliance, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfBasicGroup=ospfBasicGroup, ospfAreaEntry=ospfAreaEntry, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfLsdbEntry=ospfLsdbEntry, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaRangeTable=ospfAreaRangeTable, ospfStubMetricType=ospfStubMetricType, ospfLsdbChecksum=ospfLsdbChecksum, ospfHostEntry=ospfHostEntry, ospfStubStatus=ospfStubStatus, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrState=ospfNbrState, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfComplianceObsolete=ospfComplianceObsolete, ospfRestartInterval=ospfRestartInterval, ospfIfAdminStat=ospfIfAdminStat, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAsLsdbTable=ospfAsLsdbTable, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfInterArea=ospfInterArea, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfTable=ospfIfTable, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsaCount=ospfAsLsaCount, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbType=ospfLsdbType, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, UpToMaxAge=UpToMaxAge, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfNbrGroup2=ospfNbrGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfLsaCount=ospfIfLsaCount, ospfAreaGroup=ospfAreaGroup, ospfDemandExtensions=ospfDemandExtensions, ospfIfEvents=ospfIfEvents, ospfCompliances=ospfCompliances, ospfIfDemand=ospfIfDemand, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostStatus=ospfHostStatus, ospfRestartAge=ospfRestartAge, ospfIfRtrPriority=ospfIfRtrPriority, ospfConformance=ospfConformance, ospfExtLsdbTable=ospfExtLsdbTable, OspfAuthenticationType=OspfAuthenticationType, ospfVirtIfStatus=ospfVirtIfStatus, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfHostGroup=ospfHostGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAsLsdbSequence=ospfAsLsdbSequence, HelloRange=HelloRange, ospfLsdbGroup=ospfLsdbGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfRouteGroup=ospfRouteGroup, ospfTOSSupport=ospfTOSSupport, ospfIfGroup=ospfIfGroup, ospfIfMetricTable=ospfIfMetricTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaGroup2=ospfAreaGroup2, BigMetric=BigMetric, ospfRestartExitReason=ospfRestartExitReason, ospfNbrIpAddr=ospfNbrIpAddr, ospfIfEntry=ospfIfEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAuthType=ospfAuthType, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfState=ospfIfState, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfType=ospfIfType, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, Metric=Metric, ospfStubMetric=ospfStubMetric, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrTable=ospfNbrTable, Status=Status, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAsLsdbType=ospfAsLsdbType, ospfRxNewLsas=ospfRxNewLsas, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfHostTOS=ospfHostTOS, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbmaNbrStatus=ospfNbmaNbrStatus, DesignatedRouterPriority=DesignatedRouterPriority, ospfAddressLessIf=ospfAddressLessIf, ospfVersionNumber=ospfVersionNumber, TOSType=TOSType, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfRestartStatus=ospfRestartStatus, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAdminStat=ospfAdminStat, ospfLsdbAge=ospfLsdbAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfRestartSupport=ospfRestartSupport, ospfAsLsaCksumSum=ospfAsLsaCksumSum, AreaID=AreaID, RouterID=RouterID, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfObsoleteGroup=ospfObsoleteGroup, PositiveInteger=PositiveInteger, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfNbrPriority=ospfNbrPriority, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaId=ospfAreaId, ospfIfPollInterval=ospfIfPollInterval, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLsdbLsid=ospfLsdbLsid, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaSummary=ospfAreaSummary, ospfStubAreaTable=ospfStubAreaTable, ospfIfMetricTOS=ospfIfMetricTOS, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfStatus=ospfIfStatus, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfExternalType2=ospfExternalType2, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrEntry=ospfNbrEntry, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfIfTransitDelay=ospfIfTransitDelay, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbrEvents=ospfNbrEvents, ospfAreaStatus=ospfAreaStatus, ospfVirtNbrArea=ospfVirtNbrArea, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfMetricEntry=ospfIfMetricEntry, ospfLsdbRouterId=ospfLsdbRouterId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfExternLsaCount=ospfExternLsaCount, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLsdbTable=ospfLsdbTable, ospfLsdbSequence=ospfLsdbSequence, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrOptions=ospfNbrOptions, PYSNMP_MODULE_ID=ospf, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfHostAreaID=ospfHostAreaID, ospfVirtIfState=ospfVirtIfState, ospfIntraArea=ospfIntraArea, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfHostTable=ospfHostTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry)
mibBuilder.exportSymbols("OSPF-MIB", ospfExitOverflowInterval=ospfExitOverflowInterval, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtNbrGroup=ospfVirtNbrGroup)
