...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfStubAreaGroup=ospfStubAreaGroup, ospfLsdbTable=ospfLsdbTable, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfExternLsaCount=ospfExternLsaCount, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostTable=ospfHostTable, ospfIfIpAddress=ospfIfIpAddress, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfEntry=ospfIfEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfRestartStatus=ospfRestartStatus, ospfIfEvents=ospfIfEvents, ospfIfStatus=ospfIfStatus, ospfExtLsdbType=ospfExtLsdbType, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfRxNewLsas=ospfRxNewLsas, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfIfAreaId=ospfIfAreaId, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfAreaGroup2=ospfAreaGroup2, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfRetransInterval=ospfIfRetransInterval, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfInterArea=ospfInterArea, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, UpToMaxAge=UpToMaxAge, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfNbrEntry=ospfNbrEntry, ospfAddressLessIf=ospfAddressLessIf, ospfAreaGroup=ospfAreaGroup, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfAuthType=ospfIfAuthType, ospfDemandExtensions=ospfDemandExtensions, ospfVirtNbrState=ospfVirtNbrState, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExtLsdbChecksum=ospfExtLsdbChecksum, PYSNMP_MODULE_ID=ospf, ospfHostTOS=ospfHostTOS, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrTable=ospfNbrTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfIfState=ospfIfState, ospfLocalLsdbType=ospfLocalLsdbType, ospfIfLsaCount=ospfIfLsaCount, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, BigMetric=BigMetric, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaRangeAreaId=ospfAreaRangeAreaId, TOSType=TOSType, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfVersionNumber=ospfVersionNumber, ospfTOSSupport=ospfTOSSupport, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfLsdbLsid=ospfLsdbLsid, ospfNbrEvents=ospfNbrEvents, Status=Status, ospfIfMetricValue=ospfIfMetricValue, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaRangeNet=ospfAreaRangeNet, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfHostGroup=ospfHostGroup, ospfNbrGroup2=ospfNbrGroup2, ospfRouterId=ospfRouterId, ospfLsdbChecksum=ospfLsdbChecksum, AreaID=AreaID, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfBasicGroup2=ospfBasicGroup2, ospfIfAuthKey=ospfIfAuthKey, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfExternalType2=ospfExternalType2, ospfAsLsdbAge=ospfAsLsdbAge, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtIfState=ospfVirtIfState, ospfNbrOptions=ospfNbrOptions, ospfAreaTable=ospfAreaTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfCompliance2=ospfCompliance2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfHostGroup2=ospfHostGroup2, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfCompliance=ospfCompliance, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfType=ospfIfType, RouterID=RouterID, ospfHostMetric=ospfHostMetric, ospfHostStatus=ospfHostStatus, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfTable=ospfIfTable, ospfIntraArea=ospfIntraArea, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfStubMetricType=ospfStubMetricType, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, PositiveInteger=PositiveInteger, ospfComplianceObsolete=ospfComplianceObsolete, ospf=ospf, ospfAreaEntry=ospfAreaEntry, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaSummary=ospfAreaSummary, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfCompliances=ospfCompliances, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfMetricTable=ospfIfMetricTable, ospfAdminStat=ospfAdminStat, ospfNbrPriority=ospfNbrPriority, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfGroup=ospfIfGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfStubStatus=ospfStubStatus, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfGeneralGroup=ospfGeneralGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfHostEntry=ospfHostEntry, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfStatus=ospfVirtIfStatus, ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLsdbGroup=ospfLsdbGroup, ospfAreaStatus=ospfAreaStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrGroup=ospfNbrGroup, ospfAuthType=ospfAuthType, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfRestartAge=ospfRestartAge, ospfHostAreaID=ospfHostAreaID, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfEvents=ospfVirtIfEvents, ospfSpfRuns=ospfSpfRuns, ospfIfPollInterval=ospfIfPollInterval, ospfGroups=ospfGroups, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsLsaCount=ospfAsLsaCount, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfDemand=ospfIfDemand, ospfLsdbAge=ospfLsdbAge, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfMetricStatus=ospfIfMetricStatus, HelloRange=HelloRange, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, OspfAuthenticationType=OspfAuthenticationType, ospfVirtNbrArea=ospfVirtNbrArea, Metric=Metric, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfRestartExitReason=ospfRestartExitReason, ospfStubMetric=ospfStubMetric, ospfConformance=ospfConformance, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbType=ospfAsLsdbType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfImportAsExtern=ospfImportAsExtern, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfRestartSupport=ospfRestartSupport, ospfLsdbSequence=ospfLsdbSequence, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfStubAreaTable=ospfStubAreaTable, ospfIfAdminStat=ospfIfAdminStat, ospfNbrRtrId=ospfNbrRtrId, ospfAreaId=ospfAreaId, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbType=ospfLsdbType, ospfExternalType1=ospfExternalType1, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfHostIpAddress=ospfHostIpAddress, ospfNbrState=ospfNbrState, ospfStubTOS=ospfStubTOS, ospfRouteGroup=ospfRouteGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfBasicGroup=ospfBasicGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfGroup2=ospfIfGroup2, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfLocalLsdbSequence=ospfLocalLsdbSequence)
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLsdbAreaId=ospfLsdbAreaId, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfObsoleteGroup=ospfObsoleteGroup)
