...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrPriority=ospfNbrPriority, HelloRange=HelloRange, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfAuthType=ospfIfAuthType, ospfIfStatus=ospfIfStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfGroup=ospfIfGroup, ospfNbrGroup=ospfNbrGroup, ospfNbrGroup2=ospfNbrGroup2, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostGroup2=ospfHostGroup2, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfType=ospfIfType, ospfIfAdminStat=ospfIfAdminStat, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfEntry=ospfIfEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfStubAreaId=ospfStubAreaId, ospfLsdbAreaId=ospfLsdbAreaId, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, UpToMaxAge=UpToMaxAge, ospfAdminStat=ospfAdminStat, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfNbrTable=ospfNbrTable, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfVirtIfEntry=ospfVirtIfEntry, ospfAreaRangeTable=ospfAreaRangeTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfRestartStatus=ospfRestartStatus, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, PositiveInteger=PositiveInteger, ospfLsdbTable=ospfLsdbTable, ospfObsoleteGroup=ospfObsoleteGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaAggregateGroup=ospfAreaAggregateGroup, Metric=Metric, RouterID=RouterID, ospfIfMetricTOS=ospfIfMetricTOS, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaSummary=ospfAreaSummary, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfRouteGroup=ospfRouteGroup, ospfDemandExtensions=ospfDemandExtensions, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfIfMetricTable=ospfIfMetricTable, ospfIfEvents=ospfIfEvents, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, OspfAuthenticationType=OspfAuthenticationType, ospfIntraArea=ospfIntraArea, PYSNMP_MODULE_ID=ospf, ospfLsdbGroup=ospfLsdbGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfStubTOS=ospfStubTOS, ospfLsdbLsid=ospfLsdbLsid, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfTOSSupport=ospfTOSSupport, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfLsdbEntry=ospfLsdbEntry, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfCompliance=ospfCompliance, ospfVirtIfGroup=ospfVirtIfGroup, ospfLsdbRouterId=ospfLsdbRouterId, ospfHostMetric=ospfHostMetric, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfRestartExitReason=ospfRestartExitReason, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubAreaTable=ospfStubAreaTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfCompliances=ospfCompliances, ospfIfRtrPriority=ospfIfRtrPriority, ospfNbrState=ospfNbrState, ospfAuthType=ospfAuthType, ospfNbrEntry=ospfNbrEntry, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfNbrOptions=ospfNbrOptions, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAddressLessIf=ospfAddressLessIf, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfConformance=ospfConformance, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfStubMetricType=ospfStubMetricType, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfRestartAge=ospfRestartAge, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfHostStatus=ospfHostStatus, ospfIfLsaCount=ospfIfLsaCount, ospfAsLsdbType=ospfAsLsdbType, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaGroup=ospfAreaGroup, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, BigMetric=BigMetric, ospfExternLsaCount=ospfExternLsaCount, ospfVersionNumber=ospfVersionNumber, ospfImportAsExtern=ospfImportAsExtern, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLsdbType=ospfLsdbType, ospfLsdbAge=ospfLsdbAge, ospfRestartInterval=ospfRestartInterval, ospfExtLsdbAge=ospfExtLsdbAge, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfRouterId=ospfRouterId, ospfHostTOS=ospfHostTOS, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrState=ospfVirtNbrState, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, Status=Status, ospfCompliance2=ospfCompliance2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfNbrEvents=ospfNbrEvents, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExtLsdbType=ospfExtLsdbType, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfGeneralGroup=ospfGeneralGroup, ospfAreaEntry=ospfAreaEntry, ospfIfDemand=ospfIfDemand, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfStubAreaGroup=ospfStubAreaGroup, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, DesignatedRouterPriority=DesignatedRouterPriority, ospfStubStatus=ospfStubStatus, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfAreaTable=ospfAreaTable, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricStatus=ospfIfMetricStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExternalType2=ospfExternalType2, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfIfAreaId=ospfIfAreaId, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricGroup=ospfIfMetricGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostIpAddress=ospfHostIpAddress, ospfIfPollInterval=ospfIfPollInterval, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfRxNewLsas=ospfRxNewLsas, ospfAreaStatus=ospfAreaStatus, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfIfTable=ospfIfTable, ospfAreaGroup2=ospfAreaGroup2, ospfIfHelloInterval=ospfIfHelloInterval, ospfAreaId=ospfAreaId, ospfGroups=ospfGroups, ospfBasicGroup2=ospfBasicGroup2, ospfBasicGroup=ospfBasicGroup, ospfHostGroup=ospfHostGroup, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfGroup2=ospfIfGroup2, ospfVirtIfState=ospfVirtIfState, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfSpfRuns=ospfSpfRuns, ospfHostAreaID=ospfHostAreaID, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfLsdbChecksum=ospfLsdbChecksum, ospfStubMetric=ospfStubMetric, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfRestartSupport=ospfRestartSupport, ospfHostEntry=ospfHostEntry, ospf=ospf, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfExternalType1=ospfExternalType1, AreaID=AreaID, ospfIfState=ospfIfState, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaLsaCount=ospfAreaLsaCount, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrRtrId=ospfNbrRtrId, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAsLsaCount=ospfAsLsaCount, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, TOSType=TOSType, ospfLocalLsdbType=ospfLocalLsdbType, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtNbrOptions=ospfVirtNbrOptions)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfHostTable=ospfHostTable, ospfIfIpAddress=ospfIfIpAddress, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed)
