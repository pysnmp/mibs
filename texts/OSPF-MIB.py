...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfVersionNumber=ospfVersionNumber, ospfRestartExitReason=ospfRestartExitReason, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExternalType1=ospfExternalType1, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfAuthType=ospfVirtIfAuthType, TOSType=TOSType, ospfDemandExtensions=ospfDemandExtensions, ospfIfStatus=ospfIfStatus, ospfIfLsaCount=ospfIfLsaCount, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfGroups=ospfGroups, ospfAreaEntry=ospfAreaEntry, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfIfMetricGroup=ospfIfMetricGroup, ospfStubAreaId=ospfStubAreaId, ospfRouterId=ospfRouterId, ospfAreaId=ospfAreaId, ospfBasicGroup=ospfBasicGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfNbrGroup=ospfNbrGroup, ospfHostIpAddress=ospfHostIpAddress, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbAge=ospfLsdbAge, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, AreaID=AreaID, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfConformance=ospfConformance, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExtLsdbType=ospfExtLsdbType, ospfIfType=ospfIfType, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfIfMetricTOS=ospfIfMetricTOS, BigMetric=BigMetric, ospfIfAreaId=ospfIfAreaId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaRangeTable=ospfAreaRangeTable, UpToMaxAge=UpToMaxAge, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfNbrEntry=ospfNbrEntry, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsdbAge=ospfAsLsdbAge, ospfExternLsaCount=ospfExternLsaCount, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRestartStatus=ospfRestartStatus, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfNbrOptions=ospfNbrOptions, ospfIfMetricStatus=ospfIfMetricStatus, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfIfDemand=ospfIfDemand, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfGroup=ospfIfGroup, ospfIfMetricEntry=ospfIfMetricEntry, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfTOSSupport=ospfTOSSupport, ospfNbrGroup2=ospfNbrGroup2, PositiveInteger=PositiveInteger, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfHostGroup=ospfHostGroup, ospfAsLsaCount=ospfAsLsaCount, ospfIfIpAddress=ospfIfIpAddress, ospfIfGroup2=ospfIfGroup2, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfLsdbLsid=ospfLsdbLsid, ospfImportAsExtern=ospfImportAsExtern, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfEvents=ospfIfEvents, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfHostAreaID=ospfHostAreaID, ospfBasicGroup2=ospfBasicGroup2, ospfIfMetricTable=ospfIfMetricTable, ospfLsdbEntry=ospfLsdbEntry, ospfRestartAge=ospfRestartAge, ospfRouteGroup=ospfRouteGroup, ospfNbrRtrId=ospfNbrRtrId, ospfAreaRangeMask=ospfAreaRangeMask, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfAreaRangeNet=ospfAreaRangeNet, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLsdbSequence=ospfLsdbSequence, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfLocalLsdbTable=ospfLocalLsdbTable, Metric=Metric, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRestartInterval=ospfRestartInterval, ospfVirtNbrState=ospfVirtNbrState, ospfAreaStatus=ospfAreaStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfNbrIpAddr=ospfNbrIpAddr, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAuthType=ospfAuthType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfNbrState=ospfNbrState, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfExtLsdbGroup=ospfExtLsdbGroup, HelloRange=HelloRange, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAdminStat=ospfAdminStat, ospfHostTable=ospfHostTable, ospfAreaLsaCount=ospfAreaLsaCount, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfMetricValue=ospfIfMetricValue, ospfIfTable=ospfIfTable, ospfIfAdminStat=ospfIfAdminStat, ospfNbrPriority=ospfNbrPriority, ospfAddressLessIf=ospfAddressLessIf, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfExternalType2=ospfExternalType2, ospfVirtIfGroup=ospfVirtIfGroup, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfStubAreaEntry=ospfStubAreaEntry, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfStubMetricType=ospfStubMetricType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfNbrEvents=ospfNbrEvents, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfState=ospfIfState, ospfGeneralGroup=ospfGeneralGroup, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtNbrGroup2=ospfVirtNbrGroup2, OspfAuthenticationType=OspfAuthenticationType, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfStubStatus=ospfStubStatus, ospfIfPollInterval=ospfIfPollInterval, ospfIfAuthType=ospfIfAuthType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfCompliances=ospfCompliances, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfNbrTable=ospfNbrTable, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfInterArea=ospfInterArea, ospfCompliance=ospfCompliance, ospfHostGroup2=ospfHostGroup2, ospfLsdbAreaId=ospfLsdbAreaId, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, RouterID=RouterID, ospfIntraArea=ospfIntraArea, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfStubAreaTable=ospfStubAreaTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfCompliance2=ospfCompliance2, ospfAreaGroup2=ospfAreaGroup2, ospfHostMetric=ospfHostMetric, ospfVirtIfEntry=ospfVirtIfEntry, ospfExitOverflowInterval=ospfExitOverflowInterval, ospf=ospf, ospfAreaSummary=ospfAreaSummary, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfStubRouterSupport=ospfStubRouterSupport, ospfRxNewLsas=ospfRxNewLsas, ospfRestartSupport=ospfRestartSupport, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfLsdbTable=ospfLsdbTable, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfEvents=ospfVirtIfEvents, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfAsLsdbTable=ospfAsLsdbTable, ospfHostTOS=ospfHostTOS, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfHostStatus=ospfHostStatus, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaTable=ospfAreaTable, ospfStubTOS=ospfStubTOS, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, Status=Status, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbType=ospfAsLsdbType, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLsdbGroup=ospfLsdbGroup, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostEntry=ospfHostEntry, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfStubMetric=ospfStubMetric, ospfSpfRuns=ospfSpfRuns, ospfLsdbType=ospfLsdbType, ospfIfEntry=ospfIfEntry, PYSNMP_MODULE_ID=ospf, ospfAreaGroup=ospfAreaGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfTransitDelay=ospfIfTransitDelay, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr)
mibBuilder.exportSymbols("OSPF-MIB", ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum)
