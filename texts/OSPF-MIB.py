...
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrState=ospfNbrState, ospfExternalType2=ospfExternalType2, ospfImportAsExtern=ospfImportAsExtern, ospfAreaLsaCount=ospfAreaLsaCount, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfRouteGroup=ospfRouteGroup, ospfAreaTable=ospfAreaTable, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, TOSType=TOSType, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfCompliance2=ospfCompliance2, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfTOSSupport=ospfTOSSupport, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfAuthKey=ospfIfAuthKey, ospfCompliance=ospfCompliance, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfType=ospfIfType, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfTransitDelay=ospfIfTransitDelay, ospfInterArea=ospfInterArea, ospfIfGroup2=ospfIfGroup2, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfRestartInterval=ospfRestartInterval, ospfIfAuthType=ospfIfAuthType, PYSNMP_MODULE_ID=ospf, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaSummary=ospfAreaSummary, ospfHostAreaID=ospfHostAreaID, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfNbrTable=ospfNbrTable, ospfHostStatus=ospfHostStatus, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfEntry=ospfIfEntry, ospfIfGroup=ospfIfGroup, ospfIfPollInterval=ospfIfPollInterval, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfStubAreaId=ospfStubAreaId, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfAdminStat=ospfIfAdminStat, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLsdbRouterId=ospfLsdbRouterId, ospfAdminStat=ospfAdminStat, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfEvents=ospfIfEvents, ospfNbrIpAddr=ospfNbrIpAddr, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfCompliances=ospfCompliances, ospfAreaRangeTable=ospfAreaRangeTable, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfVirtIfState=ospfVirtIfState, AreaID=AreaID, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfLsdbGroup=ospfLsdbGroup, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfComplianceObsolete=ospfComplianceObsolete, ospfAsLsdbAge=ospfAsLsdbAge, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrPriority=ospfNbrPriority, ospfAreaGroup=ospfAreaGroup, ospfAreaGroup2=ospfAreaGroup2, ospfStubMetricType=ospfStubMetricType, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfAreaId=ospfIfAreaId, ospfStubAreaTable=ospfStubAreaTable, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, BigMetric=BigMetric, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfState=ospfIfState, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbAge=ospfLocalLsdbAge, Status=Status, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfEntry=ospfVirtIfEntry, ospfRestartExitReason=ospfRestartExitReason, ospfIfMetricStatus=ospfIfMetricStatus, ospf=ospf, ospfConformance=ospfConformance, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfAreaRangeNet=ospfAreaRangeNet, ospfAsLsdbTable=ospfAsLsdbTable, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAsLsaCount=ospfAsLsaCount, ospfExternLsaCount=ospfExternLsaCount, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtNbrArea=ospfVirtNbrArea, ospfHostTable=ospfHostTable, ospfAreaRangeMask=ospfAreaRangeMask, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfBasicGroup2=ospfBasicGroup2, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtNbrState=ospfVirtNbrState, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfMetricValue=ospfIfMetricValue, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfRestartStatus=ospfRestartStatus, Metric=Metric, ospfAddressLessIf=ospfAddressLessIf, OspfAuthenticationType=OspfAuthenticationType, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrRtrId=ospfNbrRtrId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfIfIpAddress=ospfIfIpAddress, ospfHostMetric=ospfHostMetric, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAuthType=ospfAuthType, ospfNbrOptions=ospfNbrOptions, ospfRouterId=ospfRouterId, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbTable=ospfLsdbTable, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfStubRouterSupport=ospfStubRouterSupport, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVersionNumber=ospfVersionNumber, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfStubMetric=ospfStubMetric, ospfNbrEntry=ospfNbrEntry, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfExtLsdbType=ospfExtLsdbType, ospfRestartAge=ospfRestartAge, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfAreaAggregateEntry=ospfAreaAggregateEntry, UpToMaxAge=UpToMaxAge, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfEvents=ospfVirtIfEvents, ospfStubAreaEntry=ospfStubAreaEntry, ospfHostIpAddress=ospfHostIpAddress, ospfLsdbAdvertisement=ospfLsdbAdvertisement, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfStatus=ospfIfStatus, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfStubStatus=ospfStubStatus, ospfVirtNbrTable=ospfVirtNbrTable, ospfRxNewLsas=ospfRxNewLsas, ospfHostGroup=ospfHostGroup, RouterID=RouterID, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfDemandExtensions=ospfDemandExtensions, ospfAreaLsaCountTable=ospfAreaLsaCountTable, PositiveInteger=PositiveInteger, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbLsid=ospfLsdbLsid, ospfObsoleteGroup=ospfObsoleteGroup, ospfRestartSupport=ospfRestartSupport, ospfLsdbAge=ospfLsdbAge, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfGroups=ospfGroups, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfNbrGroup=ospfNbrGroup, ospfHostGroup2=ospfHostGroup2, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaStatus=ospfAreaStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfIntraArea=ospfIntraArea, ospfGeneralGroup=ospfGeneralGroup, ospfAreaEntry=ospfAreaEntry, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfNbrEvents=ospfNbrEvents, ospfVirtIfTable=ospfVirtIfTable, ospfAreaId=ospfAreaId, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubTOS=ospfStubTOS, ospfLsdbSequence=ospfLsdbSequence, ospfExternLsaCksumSum=ospfExternLsaCksumSum, HelloRange=HelloRange, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfStatus=ospfVirtIfStatus, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLsdbEntry=ospfLsdbEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfNbrGroup2=ospfNbrGroup2, ospfSpfRuns=ospfSpfRuns, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtIfGroup=ospfVirtIfGroup, ospfIfTable=ospfIfTable, ospfBasicGroup=ospfBasicGroup, ospfIfDemand=ospfIfDemand, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfExternalType1=ospfExternalType1, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLsdbType=ospfLsdbType, ospfHostTOS=ospfHostTOS, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfDiscontinuityTime=ospfDiscontinuityTime)
mibBuilder.exportSymbols("OSPF-MIB", ospfLsdbAreaId=ospfLsdbAreaId, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfHostEntry=ospfHostEntry, ospfIfMetricGroup=ospfIfMetricGroup)
