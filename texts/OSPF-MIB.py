...
mibBuilder.exportSymbols("OSPF-MIB", ospfRouterId=ospfRouterId, ospfRestartSupport=ospfRestartSupport, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfNbrOptions=ospfNbrOptions, ospfSpfRuns=ospfSpfRuns, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfStubMetric=ospfStubMetric, ospfLsdbSequence=ospfLsdbSequence, ospfIfMetricValue=ospfIfMetricValue, ospfNbrIpAddr=ospfNbrIpAddr, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfRxNewLsas=ospfRxNewLsas, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfRFC1583Compatibility=ospfRFC1583Compatibility, HelloRange=HelloRange, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfHostTable=ospfHostTable, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfNbrRtrId=ospfNbrRtrId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfStubTOS=ospfStubTOS, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfInterArea=ospfInterArea, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfIfAuthType=ospfIfAuthType, ospfStubAreaId=ospfStubAreaId, ospfIfState=ospfIfState, ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfAsLsdbType=ospfAsLsdbType, ospfAreaGroup=ospfAreaGroup, ospfNbrGroup2=ospfNbrGroup2, ospfHostGroup2=ospfHostGroup2, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExternLsaCount=ospfExternLsaCount, ospfIfAdminStat=ospfIfAdminStat, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfStubRouterSupport=ospfStubRouterSupport, ospfExternalType1=ospfExternalType1, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfHostTOS=ospfHostTOS, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfVirtIfState=ospfVirtIfState, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfCompliance=ospfCompliance, ospfLsdbEntry=ospfLsdbEntry, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfAreaLsaCount=ospfAreaLsaCount, ospfRouteGroup=ospfRouteGroup, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfNbrEntry=ospfNbrEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospf=ospf, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtNbrState=ospfVirtNbrState, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbTable=ospfLsdbTable, ospfCompliances=ospfCompliances, ospfIfEvents=ospfIfEvents, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfObsoleteGroup=ospfObsoleteGroup, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfIntraArea=ospfIntraArea, ospfExtLsdbAge=ospfExtLsdbAge, ospfAsLsdbTable=ospfAsLsdbTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrTable=ospfNbrTable, ospfExtLsdbType=ospfExtLsdbType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfHostEntry=ospfHostEntry, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfHostIpAddress=ospfHostIpAddress, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfHostMetric=ospfHostMetric, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfRestartStatus=ospfRestartStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfHostStatus=ospfHostStatus, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaId=ospfAreaId, ospfStubStatus=ospfStubStatus, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, TOSType=TOSType, ospfLsdbGroup=ospfLsdbGroup, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaRangeMask=ospfAreaRangeMask, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfLocalLsdbAge=ospfLocalLsdbAge, Metric=Metric, ospfIfPollInterval=ospfIfPollInterval, ospfExtLsdbTable=ospfExtLsdbTable, ospfAsLsdbSequence=ospfAsLsdbSequence, AreaID=AreaID, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfGeneralGroup=ospfGeneralGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfImportAsExtern=ospfImportAsExtern, ospfLsdbLsid=ospfLsdbLsid, ospfBasicGroup=ospfBasicGroup, Status=Status, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfDemand=ospfIfDemand, ospfAsLsdbAge=ospfAsLsdbAge, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfEvents=ospfVirtIfEvents, ospfTOSSupport=ospfTOSSupport, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfType=ospfIfType, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaRangeTable=ospfAreaRangeTable, ospfStubMetricType=ospfStubMetricType, ospfRestartInterval=ospfRestartInterval, ospfIfAreaId=ospfIfAreaId, ospfIfLsaCount=ospfIfLsaCount, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAreaEntry=ospfAreaEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfIfTable=ospfIfTable, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfStatus=ospfIfStatus, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfNbrEvents=ospfNbrEvents, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLsdbAge=ospfLsdbAge, ospfLsdbRouterId=ospfLsdbRouterId, ospfLsdbChecksum=ospfLsdbChecksum, PYSNMP_MODULE_ID=ospf, ospfAddressLessIf=ospfAddressLessIf, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfIfGroup=ospfIfGroup, ospfNbrGroup=ospfNbrGroup, ospfAreaSummary=ospfAreaSummary, UpToMaxAge=UpToMaxAge, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, OspfAuthenticationType=OspfAuthenticationType, ospfConformance=ospfConformance, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfAreaGroup2=ospfAreaGroup2, ospfLsdbType=ospfLsdbType, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, RouterID=RouterID, ospfDemandExtensions=ospfDemandExtensions, ospfAreaTable=ospfAreaTable, ospfAsLsaCount=ospfAsLsaCount, PositiveInteger=PositiveInteger, ospfRestartExitReason=ospfRestartExitReason, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfIfMetricTable=ospfIfMetricTable, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfMetricStatus=ospfIfMetricStatus, ospfVirtIfTable=ospfVirtIfTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfCompliance2=ospfCompliance2, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostGroup=ospfHostGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrState=ospfNbrState, ospfRestartAge=ospfRestartAge, ospfIfEntry=ospfIfEntry, ospfVirtNbrArea=ospfVirtNbrArea, BigMetric=BigMetric, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaStatus=ospfAreaStatus, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfHostAreaID=ospfHostAreaID, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtIfStatus=ospfVirtIfStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAdminStat=ospfAdminStat, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfGroups=ospfGroups, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfLocalLsdbType=ospfLocalLsdbType, ospfAuthType=ospfAuthType, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfComplianceObsolete=ospfComplianceObsolete, ospfBasicGroup2=ospfBasicGroup2, ospfExternalType2=ospfExternalType2, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVersionNumber=ospfVersionNumber, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfStubAreaTable=ospfStubAreaTable, ospfIfGroup2=ospfIfGroup2)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfNbrPriority=ospfNbrPriority)
