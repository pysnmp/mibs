...
mibBuilder.exportSymbols("OSPF-MIB", ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtIfTable=ospfVirtIfTable, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfGeneralGroup=ospfGeneralGroup, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtNbrArea=ospfVirtNbrArea, ospfInterArea=ospfInterArea, ospfAreaLsaCount=ospfAreaLsaCount, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfExtLsdbType=ospfExtLsdbType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, HelloRange=HelloRange, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrEvents=ospfNbrEvents, ospfStubMetric=ospfStubMetric, ospfLsdbLsid=ospfLsdbLsid, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVersionNumber=ospfVersionNumber, ospfSpfRuns=ospfSpfRuns, ospfHostStatus=ospfHostStatus, ospfIfEntry=ospfIfEntry, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfHostEntry=ospfHostEntry, ospfMulticastExtensions=ospfMulticastExtensions, DesignatedRouterPriority=DesignatedRouterPriority, ospfIfDemand=ospfIfDemand, ospfNbrGroup2=ospfNbrGroup2, ospfExtLsdbRouterId=ospfExtLsdbRouterId, Metric=Metric, ospfComplianceObsolete=ospfComplianceObsolete, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbType=ospfLocalLsdbType, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfAdminStat=ospfAdminStat, ospfHostAreaID=ospfHostAreaID, Status=Status, ospfIfMetricEntry=ospfIfMetricEntry, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfVirtIfStatus=ospfVirtIfStatus, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfStubAreaId=ospfStubAreaId, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfStubAreaTable=ospfStubAreaTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfIfHelloInterval=ospfIfHelloInterval, ospfRestartExitReason=ospfRestartExitReason, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfNbrIpAddr=ospfNbrIpAddr, ospfNbrOptions=ospfNbrOptions, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, BigMetric=BigMetric, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfLsdbAge=ospfLsdbAge, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaAggregateEffect=ospfAreaAggregateEffect, TOSType=TOSType, ospfDemandExtensions=ospfDemandExtensions, ospfLsdbType=ospfLsdbType, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfLsdbGroup=ospfLsdbGroup, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, OspfAuthenticationType=OspfAuthenticationType, ospfImportAsExtern=ospfImportAsExtern, ospfStubAreaEntry=ospfStubAreaEntry, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIntraArea=ospfIntraArea, ospfStubTOS=ospfStubTOS, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfNbrTable=ospfNbrTable, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAsLsdbType=ospfAsLsdbType, ospfRxNewLsas=ospfRxNewLsas, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfGroup2=ospfIfGroup2, ospfExtLsdbTable=ospfExtLsdbTable, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfRestartStatus=ospfRestartStatus, ospfNbrPriority=ospfNbrPriority, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfStubStatus=ospfStubStatus, ospf=ospf, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfBasicGroup=ospfBasicGroup, ospfHostGroup=ospfHostGroup, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfCompliances=ospfCompliances, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfAreaRangeNet=ospfAreaRangeNet, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfRestartAge=ospfRestartAge, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfEvents=ospfIfEvents, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfAreaSummary=ospfAreaSummary, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtIfState=ospfVirtIfState, ospfIfTable=ospfIfTable, ospfIfRetransInterval=ospfIfRetransInterval, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfRouteGroup=ospfRouteGroup, ospfCompliance=ospfCompliance, ospfVirtNbrState=ospfVirtNbrState, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaGroup=ospfAreaGroup, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfNbrRtrId=ospfNbrRtrId, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLsdbTable=ospfLsdbTable, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAddressLessIf=ospfAddressLessIf, RouterID=RouterID, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfStatus=ospfIfStatus, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfIfMetricTable=ospfIfMetricTable, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfConformance=ospfConformance, ospfCompliance2=ospfCompliance2, ospfTOSSupport=ospfTOSSupport, UpToMaxAge=UpToMaxAge, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfExternalType2=ospfExternalType2, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfStubMetricType=ospfStubMetricType, ospfIfType=ospfIfType, ospfIfState=ospfIfState, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfLsdbSequence=ospfLsdbSequence, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfVirtIfEntry=ospfVirtIfEntry, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfIfMetricGroup=ospfIfMetricGroup, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfHostTOS=ospfHostTOS, ospfNbrEntry=ospfNbrEntry, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfIfAuthKey=ospfIfAuthKey, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfAuthType=ospfIfAuthType, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfRouterId=ospfRouterId, ospfRestartInterval=ospfRestartInterval, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfAsLsdbAge=ospfAsLsdbAge, ospfAreaGroup2=ospfAreaGroup2, ospfIfAdminStat=ospfIfAdminStat, ospfIfMetricStatus=ospfIfMetricStatus, ospfExtLsdbAge=ospfExtLsdbAge, AreaID=AreaID, ospfAreaAggregateGroup=ospfAreaAggregateGroup, PositiveInteger=PositiveInteger, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfAreaId=ospfAreaId, ospfNbrState=ospfNbrState, ospfAuthType=ospfAuthType, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfAsLsdbTable=ospfAsLsdbTable, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAreaStatus=ospfAreaStatus, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfExternalType1=ospfExternalType1, ospfLsdbEntry=ospfLsdbEntry, ospfIfLsaCount=ospfIfLsaCount, ospfIfTransitDelay=ospfIfTransitDelay, ospfAsLsaCount=ospfAsLsaCount, ospfHostGroup2=ospfHostGroup2, ospfIfAreaId=ospfIfAreaId, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfPollInterval=ospfIfPollInterval, ospfHostTable=ospfHostTable, ospfExternLsaCount=ospfExternLsaCount, ospfAreaTable=ospfAreaTable, ospfNbrGroup=ospfNbrGroup, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfRestartSupport=ospfRestartSupport, ospfIfMetricTOS=ospfIfMetricTOS, ospfIfMetricValue=ospfIfMetricValue, ospfGroups=ospfGroups, ospfBasicGroup2=ospfBasicGroup2, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfGroup=ospfIfGroup, ospfIfIpAddress=ospfIfIpAddress, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfLsdbRouterId=ospfLsdbRouterId, PYSNMP_MODULE_ID=ospf, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfLsdbAreaId=ospfLsdbAreaId)
mibBuilder.exportSymbols("OSPF-MIB", ospfHostIpAddress=ospfHostIpAddress, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaEntry=ospfAreaEntry, ospfHostMetric=ospfHostMetric)
