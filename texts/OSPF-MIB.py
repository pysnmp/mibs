...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfRestartStatus=ospfRestartStatus, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAsLsaCount=ospfAsLsaCount, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfStubAreaEntry=ospfStubAreaEntry, ospfIfPollInterval=ospfIfPollInterval, ospf=ospf, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfVirtIfState=ospfVirtIfState, ospfIfGroup=ospfIfGroup, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfCompliance=ospfCompliance, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtIfEntry=ospfVirtIfEntry, ospfNbrIpAddr=ospfNbrIpAddr, ospfAsLsdbTable=ospfAsLsdbTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfRxNewLsas=ospfRxNewLsas, ospfVirtNbrTable=ospfVirtNbrTable, ospfAreaRangeNet=ospfAreaRangeNet, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfAreaId=ospfAreaId, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfExternalType2=ospfExternalType2, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfGroups=ospfGroups, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfExtLsdbAge=ospfExtLsdbAge, ospfVirtNbrArea=ospfVirtNbrArea, ospfIfTransitDelay=ospfIfTransitDelay, TOSType=TOSType, ospfHostTable=ospfHostTable, ospfExtLsdbTable=ospfExtLsdbTable, ospfStubAreaTable=ospfStubAreaTable, PYSNMP_MODULE_ID=ospf, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfTable=ospfIfTable, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaLsaCount=ospfAreaLsaCount, ospfNbrEvents=ospfNbrEvents, ospfIfHelloInterval=ospfIfHelloInterval, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfTOSSupport=ospfTOSSupport, OspfAuthenticationType=OspfAuthenticationType, ospfDemandExtensions=ospfDemandExtensions, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfStubMetricType=ospfStubMetricType, Status=Status, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfLsdbAge=ospfLsdbAge, ospfIfMetricTOS=ospfIfMetricTOS, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, AreaID=AreaID, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfBasicGroup=ospfBasicGroup, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfHostTOS=ospfHostTOS, ospfAreaSummary=ospfAreaSummary, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfAreaStatus=ospfAreaStatus, ospfLocalLsdbType=ospfLocalLsdbType, ospfCompliance2=ospfCompliance2, ospfLsdbRouterId=ospfLsdbRouterId, ospfIfType=ospfIfType, ospfStubStatus=ospfStubStatus, ospfLsdbTable=ospfLsdbTable, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfInterArea=ospfInterArea, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtNbrState=ospfVirtNbrState, ospfExternLsaCount=ospfExternLsaCount, ospfIntraArea=ospfIntraArea, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfRetransInterval=ospfIfRetransInterval, ospfHostEntry=ospfHostEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfHostGroup=ospfHostGroup, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrGroup2=ospfNbrGroup2, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfStatus=ospfIfStatus, ospfAddressLessIf=ospfAddressLessIf, ospfNbrEntry=ospfNbrEntry, PositiveInteger=PositiveInteger, ospfRestartExitReason=ospfRestartExitReason, ospfObsoleteGroup=ospfObsoleteGroup, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfLsdbSequence=ospfLsdbSequence, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAuthType=ospfAuthType, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfIfGroup2=ospfIfGroup2, ospfStubAreaId=ospfStubAreaId, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaGroup=ospfAreaGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfCompliances=ospfCompliances, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfLsdbChecksum=ospfLsdbChecksum, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfRestartAge=ospfRestartAge, ospfNbrPriority=ospfNbrPriority, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfEvents=ospfVirtIfEvents, ospfNbrState=ospfNbrState, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfBasicGroup2=ospfBasicGroup2, ospfAsLsdbAge=ospfAsLsdbAge, ospfIfLsaCount=ospfIfLsaCount, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAreaGroup2=ospfAreaGroup2, ospfIfEntry=ospfIfEntry, ospfAreaRangeTable=ospfAreaRangeTable, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfHostMetric=ospfHostMetric, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfMetricEntry=ospfIfMetricEntry, ospfLsdbType=ospfLsdbType, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfStubRouterSupport=ospfStubRouterSupport, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfRestartInterval=ospfRestartInterval, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfAreaTable=ospfAreaTable, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfRestartSupport=ospfRestartSupport, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfLsdbLsid=ospfLsdbLsid, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfIfAdminStat=ospfIfAdminStat, ospfIfEvents=ospfIfEvents, ospfAsLsdbType=ospfAsLsdbType, ospfConformance=ospfConformance, ospfHostGroup2=ospfHostGroup2, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfIfMetricValue=ospfIfMetricValue, ospfVirtNbrRtrId=ospfVirtNbrRtrId, RouterID=RouterID, ospfRouterId=ospfRouterId, ospfNbrTable=ospfNbrTable, ospfIfAuthKey=ospfIfAuthKey, ospfIfMetricGroup=ospfIfMetricGroup, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfImportAsExtern=ospfImportAsExtern, BigMetric=BigMetric, ospfNbmaNbrStatus=ospfNbmaNbrStatus, Metric=Metric, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfGeneralGroup=ospfGeneralGroup, ospfAdminStat=ospfAdminStat, ospfHostStatus=ospfHostStatus, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfHostIpAddress=ospfHostIpAddress, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfExternalType1=ospfExternalType1, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExtLsdbType=ospfExtLsdbType, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfAreaEntry=ospfAreaEntry, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfStubTOS=ospfStubTOS, ospfIfDemand=ospfIfDemand, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfGroup=ospfVirtIfGroup, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfIfAuthType=ospfIfAuthType, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfMetricStatus=ospfIfMetricStatus, UpToMaxAge=UpToMaxAge, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfIfIpAddress=ospfIfIpAddress, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfRouteGroup=ospfRouteGroup, ospfIfState=ospfIfState, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfNbrRtrId=ospfNbrRtrId, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaAggregateMask=ospfAreaAggregateMask, DesignatedRouterPriority=DesignatedRouterPriority, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfLsdbGroup=ospfLsdbGroup, ospfStubMetric=ospfStubMetric, ospfVersionNumber=ospfVersionNumber, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfStubAreaGroup=ospfStubAreaGroup, ospfMulticastExtensions=ospfMulticastExtensions, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, HelloRange=HelloRange, ospfIfRtrPriority=ospfIfRtrPriority, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrGroup=ospfNbrGroup, ospfNbrOptions=ospfNbrOptions, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfIfAreaId=ospfIfAreaId)
mibBuilder.exportSymbols("OSPF-MIB", ospfHostAreaID=ospfHostAreaID, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfLsdbEntry=ospfLsdbEntry, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval)
