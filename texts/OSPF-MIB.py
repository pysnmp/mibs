...
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAsLsdbType=ospfAsLsdbType, ospfLsdbChecksum=ospfLsdbChecksum, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfMulticastExtensions=ospfMulticastExtensions, ospfNbrEntry=ospfNbrEntry, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfIfAuthKey=ospfIfAuthKey, ospfExtLsdbType=ospfExtLsdbType, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaRangeTable=ospfAreaRangeTable, ospfRestartSupport=ospfRestartSupport, ospfVirtNbrTable=ospfVirtNbrTable, ospfLsdbLsid=ospfLsdbLsid, ospfIfEntry=ospfIfEntry, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, PositiveInteger=PositiveInteger, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubAreaId=ospfStubAreaId, ospfVirtIfState=ospfVirtIfState, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfIfAuthType=ospfIfAuthType, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfStatus=ospfVirtIfStatus, ospfAreaSummary=ospfAreaSummary, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfAdminStat=ospfAdminStat, ospfLsdbAreaId=ospfLsdbAreaId, ospfCompliances=ospfCompliances, ospfAsBdrRtrCount=ospfAsBdrRtrCount, DesignatedRouterPriority=DesignatedRouterPriority, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfExtLsdbGroup=ospfExtLsdbGroup, RouterID=RouterID, UpToMaxAge=UpToMaxAge, ospfStubAreaGroup=ospfStubAreaGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfBasicGroup2=ospfBasicGroup2, ospfLsdbAge=ospfLsdbAge, ospfIfRetransInterval=ospfIfRetransInterval, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfIfTransitDelay=ospfIfTransitDelay, ospfExternalType2=ospfExternalType2, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfRestartStatus=ospfRestartStatus, ospfRouteGroup=ospfRouteGroup, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVersionNumber=ospfVersionNumber, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfStubMetric=ospfStubMetric, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfHostGroup2=ospfHostGroup2, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfExternLsaCount=ospfExternLsaCount, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfNbrOptions=ospfNbrOptions, ospfTOSSupport=ospfTOSSupport, ospfIfType=ospfIfType, ospfStubAreaEntry=ospfStubAreaEntry, ospfComplianceObsolete=ospfComplianceObsolete, ospfVirtIfGroup=ospfVirtIfGroup, ospfHostEntry=ospfHostEntry, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfImportAsExtern=ospfImportAsExtern, ospfAreaId=ospfAreaId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfStubAreaTable=ospfStubAreaTable, ospfHostAreaID=ospfHostAreaID, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfAreaStatus=ospfAreaStatus, HelloRange=HelloRange, ospfGeneralGroup=ospfGeneralGroup, ospfSpfRuns=ospfSpfRuns, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfRestartExitReason=ospfRestartExitReason, ospfAuthType=ospfAuthType, ospfVirtIfTable=ospfVirtIfTable, ospfExtLsdbAge=ospfExtLsdbAge, Metric=Metric, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaRangeMask=ospfAreaRangeMask, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfObsoleteGroup=ospfObsoleteGroup, ospfHostStatus=ospfHostStatus, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfCompliance=ospfCompliance, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfAsLsaCount=ospfAsLsaCount, ospfStubMetricType=ospfStubMetricType, ospf=ospf, OspfAuthenticationType=OspfAuthenticationType, ospfStubStatus=ospfStubStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfGroups=ospfGroups, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfAsLsdbTable=ospfAsLsdbTable, ospfNbrEvents=ospfNbrEvents, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfHostTable=ospfHostTable, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfRestartInterval=ospfRestartInterval, ospfIfMetricValue=ospfIfMetricValue, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfVirtNbrState=ospfVirtNbrState, ospfAreaGroup=ospfAreaGroup, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfLsdbSequence=ospfLsdbSequence, ospfExternalType1=ospfExternalType1, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfNbrTable=ospfNbrTable, BigMetric=BigMetric, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfRouterId=ospfRouterId, ospfIfHelloInterval=ospfIfHelloInterval, ospfIfEvents=ospfIfEvents, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfAreaLsaCount=ospfAreaLsaCount, ospfExtLsdbTable=ospfExtLsdbTable, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfStubTOS=ospfStubTOS, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, PYSNMP_MODULE_ID=ospf, ospfVirtIfEvents=ospfVirtIfEvents, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfIfAdminStat=ospfIfAdminStat, TOSType=TOSType, ospfVirtIfEntry=ospfVirtIfEntry, ospfHostIpAddress=ospfHostIpAddress, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfHostMetric=ospfHostMetric, ospfIfState=ospfIfState, ospfNbrGroup2=ospfNbrGroup2, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfAreaGroup2=ospfAreaGroup2, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfIfStatus=ospfIfStatus, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfLocalLsdbTable=ospfLocalLsdbTable, Status=Status, ospfLsdbTable=ospfLsdbTable, ospfLsdbEntry=ospfLsdbEntry, ospfStubRouterSupport=ospfStubRouterSupport, ospfNbrIpAddr=ospfNbrIpAddr, ospfVirtNbrArea=ospfVirtNbrArea, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfRxNewLsas=ospfRxNewLsas, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfIfMetricTOS=ospfIfMetricTOS, ospfAsLsdbAge=ospfAsLsdbAge, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfGroup=ospfIfGroup, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfDemand=ospfIfDemand, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrGroup=ospfNbrGroup, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfIntraArea=ospfIntraArea, ospfRestartAge=ospfRestartAge, ospfLsdbType=ospfLsdbType, ospfIfAreaId=ospfIfAreaId, ospfNbrPriority=ospfNbrPriority, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfAreaTable=ospfAreaTable, ospfNbrState=ospfNbrState, ospfCompliance2=ospfCompliance2, ospfConformance=ospfConformance, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfGroup2=ospfIfGroup2, ospfLsdbRouterId=ospfLsdbRouterId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfNbrRtrId=ospfNbrRtrId, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfLsdbGroup=ospfLsdbGroup, ospfExtLsdbChecksum=ospfExtLsdbChecksum, AreaID=AreaID, ospfAreaEntry=ospfAreaEntry, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfBasicGroup=ospfBasicGroup, ospfAreaRangeNet=ospfAreaRangeNet, ospfHostGroup=ospfHostGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfIfMetricEntry=ospfIfMetricEntry, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfIfTable=ospfIfTable, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfInterArea=ospfInterArea, ospfAddressLessIf=ospfAddressLessIf, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfIfPollInterval=ospfIfPollInterval, ospfHostTOS=ospfHostTOS, ospfVirtNbrRtrId=ospfVirtNbrRtrId)
mibBuilder.exportSymbols("OSPF-MIB", ospfIfLsaCount=ospfIfLsaCount, ospfDemandExtensions=ospfDemandExtensions, ospfIfIpAddress=ospfIfIpAddress, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents)
