...
mibBuilder.exportSymbols("OSPF-MIB", ospfIfMetricEntry=ospfIfMetricEntry, ospfVirtNbrOptions=ospfVirtNbrOptions, AreaID=AreaID, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfAsLsdbAge=ospfAsLsdbAge, UpToMaxAge=UpToMaxAge, ospf=ospf, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfVirtNbrEvents=ospfVirtNbrEvents, HelloRange=HelloRange, ospfAreaSummary=ospfAreaSummary, ospfNbrRtrId=ospfNbrRtrId, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaGroup=ospfAreaGroup, ospfIfAdminStat=ospfIfAdminStat, ospfIfStatus=ospfIfStatus, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfExtLsdbAge=ospfExtLsdbAge, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtIfGroup=ospfVirtIfGroup, ospfAreaGroup2=ospfAreaGroup2, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfIfLsaCount=ospfIfLsaCount, ospfStubAreaEntry=ospfStubAreaEntry, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfRestartStatus=ospfRestartStatus, ospfLocalLsdbType=ospfLocalLsdbType, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfComplianceObsolete=ospfComplianceObsolete, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfRestartInterval=ospfRestartInterval, ospfStubMetricType=ospfStubMetricType, ospfAreaRangeGroup=ospfAreaRangeGroup, ospfRxNewLsas=ospfRxNewLsas, ospfAreaStatus=ospfAreaStatus, ospfIfIpAddress=ospfIfIpAddress, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfAreaRangeTable=ospfAreaRangeTable, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfNbrIpAddr=ospfNbrIpAddr, ospfHostTOS=ospfHostTOS, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfHostGroup2=ospfHostGroup2, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfAreaAggregateMask=ospfAreaAggregateMask, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAsLsdbTable=ospfAsLsdbTable, ospfRestartExitReason=ospfRestartExitReason, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfIfPollInterval=ospfIfPollInterval, ospfStubAreaTable=ospfStubAreaTable, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfMulticastExtensions=ospfMulticastExtensions, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfBasicGroup=ospfBasicGroup, ospfIfLsaCksumSum=ospfIfLsaCksumSum, ospfRouteGroup=ospfRouteGroup, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAsLsaCount=ospfAsLsaCount, ospfIfDemand=ospfIfDemand, ospfRestartAge=ospfRestartAge, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfIfMetricStatus=ospfIfMetricStatus, ospfLsdbType=ospfLsdbType, ospfTOSSupport=ospfTOSSupport, DesignatedRouterPriority=DesignatedRouterPriority, ospfLsdbLsid=ospfLsdbLsid, ospfIfTable=ospfIfTable, OspfAuthenticationType=OspfAuthenticationType, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfAuthType=ospfAuthType, ospfAreaLsaCount=ospfAreaLsaCount, PositiveInteger=PositiveInteger, ospfExtLsdbType=ospfExtLsdbType, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfExternalType1=ospfExternalType1, ospfExtLsdbTable=ospfExtLsdbTable, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfVersionNumber=ospfVersionNumber, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfConformance=ospfConformance, ospfHostEntry=ospfHostEntry, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRouterId=ospfRouterId, ospfLsdbGroup=ospfLsdbGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfInterArea=ospfInterArea, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfNbrEntry=ospfNbrEntry, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfHostTable=ospfHostTable, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfIfGroup=ospfIfGroup, ospfStubAreaId=ospfStubAreaId, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfIfState=ospfIfState, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfHostAreaID=ospfHostAreaID, ospfIfAuthKey=ospfIfAuthKey, ospfVirtIfEntry=ospfVirtIfEntry, ospfVirtIfTable=ospfVirtIfTable, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfRestartSupport=ospfRestartSupport, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfVirtIfEvents=ospfVirtIfEvents, ospfAdminStat=ospfAdminStat, ospfStubStatus=ospfStubStatus, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfExternalType2=ospfExternalType2, ospfVirtIfStatus=ospfVirtIfStatus, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfEvents=ospfIfEvents, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLsdbEntry=ospfLsdbEntry, ospfIfRtrPriority=ospfIfRtrPriority, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfIfMetricTOS=ospfIfMetricTOS, ospfNbrGroup=ospfNbrGroup, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfLsdbSequence=ospfLsdbSequence, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfLsdbRouterId=ospfLsdbRouterId, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfLsdbChecksum=ospfLsdbChecksum, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfIfMetricValue=ospfIfMetricValue, ospfAsLsdbType=ospfAsLsdbType, ospfStubAreaGroup=ospfStubAreaGroup, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, Status=Status, ospfIfMetricTable=ospfIfMetricTable, ospfAreaTable=ospfAreaTable, ospfStubRouterSupport=ospfStubRouterSupport, ospfIfAuthType=ospfIfAuthType, ospfObsoleteGroup=ospfObsoleteGroup, ospfIfTransitDelay=ospfIfTransitDelay, ospfIntraArea=ospfIntraArea, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfAreaId=ospfIfAreaId, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbrGroup2=ospfNbrGroup2, BigMetric=BigMetric, ospfNbrOptions=ospfNbrOptions, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfAreaEntry=ospfAreaEntry, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfImportAsExtern=ospfImportAsExtern, ospfLsdbTable=ospfLsdbTable, ospfHostGroup=ospfHostGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfNbrTable=ospfNbrTable, ospfLsdbAreaId=ospfLsdbAreaId, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfVirtIfState=ospfVirtIfState, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAreaId=ospfAreaId, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfStubTOS=ospfStubTOS, ospfVirtNbrState=ospfVirtNbrState, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfCompliances=ospfCompliances, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfGroups=ospfGroups, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfBasicGroup2=ospfBasicGroup2, ospfAddressLessIf=ospfAddressLessIf, ospfIfRetransInterval=ospfIfRetransInterval, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfNbrState=ospfNbrState, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfHostStatus=ospfHostStatus, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfCompliance=ospfCompliance, ospfIfMetricGroup=ospfIfMetricGroup, ospfIfGroup2=ospfIfGroup2, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfNbrPriority=ospfNbrPriority, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfNbrEvents=ospfNbrEvents, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfHostMetric=ospfHostMetric, PYSNMP_MODULE_ID=ospf, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfExtLsdbEntry=ospfExtLsdbEntry, Metric=Metric, ospfIfType=ospfIfType, ospfDemandExtensions=ospfDemandExtensions, ospfStubMetric=ospfStubMetric, ospfExternLsaCount=ospfExternLsaCount, ospfHostIpAddress=ospfHostIpAddress, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfCompliance2=ospfCompliance2, ospfSpfRuns=ospfSpfRuns, ospfGeneralGroup=ospfGeneralGroup, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLsdbAge=ospfLsdbAge, TOSType=TOSType, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfIfHelloInterval=ospfIfHelloInterval, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaAggregateNet=ospfAreaAggregateNet)
mibBuilder.exportSymbols("OSPF-MIB", ospfVirtNbrArea=ospfVirtNbrArea, RouterID=RouterID, ospfASBdrRtrStatus=ospfASBdrRtrStatus, ospfIfEntry=ospfIfEntry)
