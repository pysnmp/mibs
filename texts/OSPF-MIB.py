...
mibBuilder.exportSymbols("OSPF-MIB", ospfAreaId=ospfAreaId, ospfVirtIfGroup2=ospfVirtIfGroup2, ospfDemandExtensions=ospfDemandExtensions, ospfLsdbAdvertisement=ospfLsdbAdvertisement, ospfAreaAggregateEffect=ospfAreaAggregateEffect, ospfAreaLsaCountLsaType=ospfAreaLsaCountLsaType, ospfVirtIfStatus=ospfVirtIfStatus, ospfLocalLsdbTable=ospfLocalLsdbTable, ospfLocalLsdbSequence=ospfLocalLsdbSequence, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, ospfComplianceObsolete=ospfComplianceObsolete, ospfIfLsaCount=ospfIfLsaCount, ospfVirtIfRetransInterval=ospfVirtIfRetransInterval, ospfBasicGroup2=ospfBasicGroup2, AreaID=AreaID, ospfLsdbType=ospfLsdbType, ospfVirtLocalLsdbLsid=ospfVirtLocalLsdbLsid, ospfVirtIfAuthType=ospfVirtIfAuthType, ospfVirtLocalLsdbType=ospfVirtLocalLsdbType, ospfHostMetric=ospfHostMetric, ospfIfDesignatedRouter=ospfIfDesignatedRouter, ospfExtLsdbLimit=ospfExtLsdbLimit, ospfNbrGroup=ospfNbrGroup, ospfAreaNssaTranslatorState=ospfAreaNssaTranslatorState, ospfVirtIfNeighbor=ospfVirtIfNeighbor, ospfStubAreaGroup=ospfStubAreaGroup, ospfExtLsdbAdvertisement=ospfExtLsdbAdvertisement, ospfVirtIfRtrDeadInterval=ospfVirtIfRtrDeadInterval, ospfAreaAggregateStatus=ospfAreaAggregateStatus, ospfAdminStat=ospfAdminStat, ospfAsLsaCount=ospfAsLsaCount, ospfIfEntry=ospfIfEntry, ospfAreaSummary=ospfAreaSummary, ospfAddressLessIf=ospfAddressLessIf, ospfIfEvents=ospfIfEvents, ospfAreaEntry=ospfAreaEntry, ospfVirtIfTable=ospfVirtIfTable, ospfVirtIfAuthKey=ospfVirtIfAuthKey, ospfNbrRestartHelperStatus=ospfNbrRestartHelperStatus, ospfAreaAggregateEntry=ospfAreaAggregateEntry, ospfAreaLsaCountEntry=ospfAreaLsaCountEntry, ospfAreaRangeNet=ospfAreaRangeNet, ospfVirtIfAreaId=ospfVirtIfAreaId, ospfStubAreaTable=ospfStubAreaTable, ospfIfRtrPriority=ospfIfRtrPriority, ospfAreaAggregateLsdbType=ospfAreaAggregateLsdbType, ospfLocalLsdbEntry=ospfLocalLsdbEntry, ospfCompliance2=ospfCompliance2, ospfNbrRtrId=ospfNbrRtrId, ospfIfTransitDelay=ospfIfTransitDelay, RouterID=RouterID, ospfIfAuthKey=ospfIfAuthKey, ospfAreaAggregateAreaID=ospfAreaAggregateAreaID, ospfLsdbTable=ospfLsdbTable, ospfAreaLsaCountGroup=ospfAreaLsaCountGroup, DesignatedRouterPriority=DesignatedRouterPriority, ospfVirtNbrEntry=ospfVirtNbrEntry, ospfVirtIfLsaCksumSum=ospfVirtIfLsaCksumSum, ospfIfMetricValue=ospfIfMetricValue, ospfIfPollInterval=ospfIfPollInterval, ospfLocalLsdbAdvertisement=ospfLocalLsdbAdvertisement, ospfStubMetric=ospfStubMetric, ospfAreaAggregateMask=ospfAreaAggregateMask, TOSType=TOSType, OspfAuthenticationType=OspfAuthenticationType, ospfNbrOptions=ospfNbrOptions, ospfAsLsdbEntry=ospfAsLsdbEntry, ospfVirtLocalLsdbNeighbor=ospfVirtLocalLsdbNeighbor, ospfVirtIfState=ospfVirtIfState, ospfIfGroup=ospfIfGroup, ospfAsLsaCksumSum=ospfAsLsaCksumSum, ospfExternalType1=ospfExternalType1, ospfNbrEntry=ospfNbrEntry, ospfAsLsdbGroup=ospfAsLsdbGroup, ospfExitOverflowInterval=ospfExitOverflowInterval, ospfExtLsdbTable=ospfExtLsdbTable, ospfLocalLsdbRouterId=ospfLocalLsdbRouterId, ospfExternalType2=ospfExternalType2, ospfAsLsdbSequence=ospfAsLsdbSequence, ospfAreaTable=ospfAreaTable, ospfIfStatus=ospfIfStatus, ospfMulticastExtensions=ospfMulticastExtensions, ospfHostGroup=ospfHostGroup, ospfAsBdrRtrCount=ospfAsBdrRtrCount, ospfIfMulticastForwarding=ospfIfMulticastForwarding, ospfLocalLsdbType=ospfLocalLsdbType, ospfAreaLsaCountAreaId=ospfAreaLsaCountAreaId, ospfVirtNbrGroup=ospfVirtNbrGroup, ospfHostAreaID=ospfHostAreaID, ospfExternLsaCksumSum=ospfExternLsaCksumSum, ospfIfMetricAddressLessIf=ospfIfMetricAddressLessIf, ospfCompliance=ospfCompliance, ospfAsLsdbRouterId=ospfAsLsdbRouterId, ospfVirtNbrState=ospfVirtNbrState, ospfNbrRestartHelperAge=ospfNbrRestartHelperAge, ospfAsLsdbAdvertisement=ospfAsLsdbAdvertisement, ospfVirtIfLsaCount=ospfVirtIfLsaCount, ospfAreaNssaTranslatorRole=ospfAreaNssaTranslatorRole, ospfIfMetricStatus=ospfIfMetricStatus, ospfNbrHelloSuppressed=ospfNbrHelloSuppressed, ospfDiscontinuityTime=ospfDiscontinuityTime, ospfGroups=ospfGroups, ospfVirtIfGroup=ospfVirtIfGroup, ospfNbrEvents=ospfNbrEvents, ospfVirtNbrIpAddr=ospfVirtNbrIpAddr, ospfIfAdminStat=ospfIfAdminStat, ospfVirtNbrRestartHelperStatus=ospfVirtNbrRestartHelperStatus, ospfVirtLocalLsdbRouterId=ospfVirtLocalLsdbRouterId, ospfAreaBdrRtrStatus=ospfAreaBdrRtrStatus, ospfRFC1583Compatibility=ospfRFC1583Compatibility, ospfAreaRangeAreaId=ospfAreaRangeAreaId, ospfVirtLocalLsdbAge=ospfVirtLocalLsdbAge, ospfAreaRangeTable=ospfAreaRangeTable, ospfVirtNbrOptions=ospfVirtNbrOptions, ospfLsdbSequence=ospfLsdbSequence, ospfAsLsdbType=ospfAsLsdbType, ospfInterArea=ospfInterArea, ospfIfRetransInterval=ospfIfRetransInterval, ospfHostIpAddress=ospfHostIpAddress, ospfRestartAge=ospfRestartAge, ospfNbrGroup2=ospfNbrGroup2, ospfLocalLsdbLsid=ospfLocalLsdbLsid, ospfNbrLsRetransQLen=ospfNbrLsRetransQLen, ospfAreaNssaTranslatorEvents=ospfAreaNssaTranslatorEvents, ospfAreaNssaTranslatorStabilityInterval=ospfAreaNssaTranslatorStabilityInterval, ospfVirtNbrTable=ospfVirtNbrTable, ospfNbmaNbrStatus=ospfNbmaNbrStatus, ospfLocalLsdbAge=ospfLocalLsdbAge, ospfConformance=ospfConformance, ospfIfMetricIpAddress=ospfIfMetricIpAddress, ospfIfIpAddress=ospfIfIpAddress, ospfHostCfgAreaID=ospfHostCfgAreaID, ospfExtLsdbRouterId=ospfExtLsdbRouterId, ospfStubTOS=ospfStubTOS, ospfHostTOS=ospfHostTOS, ospfReferenceBandwidth=ospfReferenceBandwidth, ospfLocalLsdbIpAddress=ospfLocalLsdbIpAddress, ospfVirtLocalLsdbTable=ospfVirtLocalLsdbTable, ospfAreaLsaCountNumber=ospfAreaLsaCountNumber, ospfVirtNbrGroup2=ospfVirtNbrGroup2, ospfAreaLsaCount=ospfAreaLsaCount, ospfLsdbAge=ospfLsdbAge, ospfVirtIfTransitDelay=ospfVirtIfTransitDelay, ospfNbmaNbrPermanence=ospfNbmaNbrPermanence, Status=Status, ospfVersionNumber=ospfVersionNumber, ospfExtLsdbType=ospfExtLsdbType, ospfVirtNbrRtrId=ospfVirtNbrRtrId, ospfLsdbGroup=ospfLsdbGroup, ospfLsdbLsid=ospfLsdbLsid, ospfHostStatus=ospfHostStatus, ospfLsdbEntry=ospfLsdbEntry, ospfVirtNbrEvents=ospfVirtNbrEvents, ospfVirtLocalLsdbTransitArea=ospfVirtLocalLsdbTransitArea, ospfAreaGroup2=ospfAreaGroup2, ospfAreaGroup=ospfAreaGroup, ospfAreaRangeMask=ospfAreaRangeMask, ospfIfDesignatedRouterId=ospfIfDesignatedRouterId, ospfLsdbRouterId=ospfLsdbRouterId, ospfAreaRangeEntry=ospfAreaRangeEntry, ospfAreaAggregateTable=ospfAreaAggregateTable, ospfAreaAggregateExtRouteTag=ospfAreaAggregateExtRouteTag, ospfAreaLsaCountTable=ospfAreaLsaCountTable, ospfLocalLsdbAddressLessIf=ospfLocalLsdbAddressLessIf, ospfVirtIfHelloInterval=ospfVirtIfHelloInterval, ospfRouteGroup=ospfRouteGroup, ospfAreaBdrRtrCount=ospfAreaBdrRtrCount, ospfAsLsdbLsid=ospfAsLsdbLsid, ospfExtLsdbChecksum=ospfExtLsdbChecksum, ospfAreaAggregateGroup2=ospfAreaAggregateGroup2, ospfRestartStrictLsaChecking=ospfRestartStrictLsaChecking, ospfIfHelloInterval=ospfIfHelloInterval, ospfVirtNbrArea=ospfVirtNbrArea, ospfHostEntry=ospfHostEntry, ospfExtLsdbSequence=ospfExtLsdbSequence, ospfStubAreaId=ospfStubAreaId, ospfIfState=ospfIfState, ospfNbrAddressLessIndex=ospfNbrAddressLessIndex, ospfGeneralGroup=ospfGeneralGroup, ospfIfMetricTable=ospfIfMetricTable, ospfVirtNbrRestartHelperExitReason=ospfVirtNbrRestartHelperExitReason, ospfRestartStatus=ospfRestartStatus, ospfAreaAggregateNet=ospfAreaAggregateNet, ospfNbrIpAddr=ospfNbrIpAddr, ospf=ospf, ospfVirtNbrHelloSuppressed=ospfVirtNbrHelloSuppressed, ospfLocalLsdbChecksum=ospfLocalLsdbChecksum, ospfASBdrRtrStatus=ospfASBdrRtrStatus, UpToMaxAge=UpToMaxAge, ospfVirtLocalLsdbEntry=ospfVirtLocalLsdbEntry, ospfLocalLsdbGroup=ospfLocalLsdbGroup, ospfIfType=ospfIfType, ospfHostGroup2=ospfHostGroup2, Metric=Metric, ospfExtLsdbEntry=ospfExtLsdbEntry, ospfVirtLocalLsdbChecksum=ospfVirtLocalLsdbChecksum, ospfVirtLocalLsdbAdvertisement=ospfVirtLocalLsdbAdvertisement, ospfRestartSupport=ospfRestartSupport, ospfSpfRuns=ospfSpfRuns, ospfHostTable=ospfHostTable, ospfIfBackupDesignatedRouterId=ospfIfBackupDesignatedRouterId, ospfCompliances=ospfCompliances, ospfStubRouterSupport=ospfStubRouterSupport, ospfVirtIfEvents=ospfVirtIfEvents, ospfIfAreaId=ospfIfAreaId, ospfOpaqueLsaSupport=ospfOpaqueLsaSupport, ospfNbrState=ospfNbrState, ospfRestartInterval=ospfRestartInterval, ospfStubAreaEntry=ospfStubAreaEntry, ospfExtLsdbGroup=ospfExtLsdbGroup, ospfVirtLocalLsdbGroup=ospfVirtLocalLsdbGroup, ospfIfMetricTOS=ospfIfMetricTOS, ospfStubMetricType=ospfStubMetricType, ospfIfGroup2=ospfIfGroup2, ospfIfMetricGroup=ospfIfMetricGroup, ospfRouterId=ospfRouterId, ospfAsLsdbAge=ospfAsLsdbAge, ospfExtLsdbAge=ospfExtLsdbAge, ospfIntraArea=ospfIntraArea, ospfObsoleteGroup=ospfObsoleteGroup, ospfLsdbChecksum=ospfLsdbChecksum, ospfAreaStatus=ospfAreaStatus, ospfNbrRestartHelperExitReason=ospfNbrRestartHelperExitReason, ospfIfBackupDesignatedRouter=ospfIfBackupDesignatedRouter, ospfAsLsdbTable=ospfAsLsdbTable, ospfStubStatus=ospfStubStatus, ospfIfRtrDeadInterval=ospfIfRtrDeadInterval, ospfVirtIfEntry=ospfVirtIfEntry, HelloRange=HelloRange, ospfVirtLocalLsdbSequence=ospfVirtLocalLsdbSequence, ospfRxNewLsas=ospfRxNewLsas, ospfAuthType=ospfAuthType, BigMetric=BigMetric, ospfTOSSupport=ospfTOSSupport, ospfIfTable=ospfIfTable, PYSNMP_MODULE_ID=ospf, ospfNbrTable=ospfNbrTable, ospfExtLsdbLsid=ospfExtLsdbLsid, ospfVirtNbrRestartHelperAge=ospfVirtNbrRestartHelperAge, ospfExternLsaCount=ospfExternLsaCount, ospfIfDemand=ospfIfDemand, ospfAreaRangeGroup=ospfAreaRangeGroup, PositiveInteger=PositiveInteger, ospfImportAsExtern=ospfImportAsExtern, ospfAreaRangeEffect=ospfAreaRangeEffect, ospfRestartExitReason=ospfRestartExitReason, ospfOriginateNewLsas=ospfOriginateNewLsas, ospfAreaAggregateGroup=ospfAreaAggregateGroup, ospfLsdbAreaId=ospfLsdbAreaId, ospfIfAuthType=ospfIfAuthType, ospfBasicGroup=ospfBasicGroup, ospfAreaLsaCksumSum=ospfAreaLsaCksumSum, ospfAsLsdbChecksum=ospfAsLsdbChecksum, ospfIfLsaCksumSum=ospfIfLsaCksumSum)
mibBuilder.exportSymbols("OSPF-MIB", ospfNbrPriority=ospfNbrPriority, ospfIfMetricEntry=ospfIfMetricEntry, ospfAreaRangeStatus=ospfAreaRangeStatus, ospfVirtNbrLsRetransQLen=ospfVirtNbrLsRetransQLen)
