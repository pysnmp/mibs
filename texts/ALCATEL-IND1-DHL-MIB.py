...
# ASN.1 source ALCATEL-IND1-DHL-MIB
# Source digest sha256:ea1c45b32388bd76badc974e06ca85d74b58511a18e715269ec3a43472b2ef24
...
alcatelIND1DHLMIB.setRevisions(('2019-11-27 00:00',))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: alcatelIND1DHLMIB.setRevisionsDescriptions(('Updated the latest contact and Copyright information for ALE USA Inc.',))
if mibBuilder.loadTexts: alcatelIND1DHLMIB.setLastUpdated('2019-11-27 00:00')
if mibBuilder.loadTexts: alcatelIND1DHLMIB.setOrganization('ALE USA Inc.')
if mibBuilder.loadTexts: alcatelIND1DHLMIB.setContactInfo('Please consult with Customer Service to ensure the most appropriate\n          version of this document is used with the products in question:\n\n                          ALE USA Inc. Enterprise\n                            26801 West Agoura Road\n                         Agoura Hills, CA  91301-5122\n                           United States Of America\n\n         Telephone:          +1 800 995 2696\n\n         Electronic Mail:    ebg_global_supportcenter@al-enterprise.com\n         World Wide Web:     https://www.al-enterprise.com')
...
alaDHLSessionTable = MibTable((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 1, 1), ).setMaxAccess("notaccessible")
...
alaDHLSessionEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 1, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "ALCATEL-IND1-DHL-MIB", "alaDHLSessionIndex"))
...
alaDHLSessionIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 1, 1, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 1000))).setMaxAccess("notaccessible")
...
alaDHLSessionPreemptionTime = MibTableColumn((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 1, 1, 1, 5), Integer32().subtype(subtypeSpec=ValueRangeConstraint(10, 600)).clone(30)).setUnits('seconds').setMaxAccess("readcreate")
...
alaDHLLinksTable = MibTable((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 2, 1), ).setMaxAccess("notaccessible")
...
alaDHLLinksEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 2, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "ALCATEL-IND1-DHL-MIB", "alaDHLSessionIndex"), (0, "ALCATEL-IND1-DHL-MIB", "alaDHLLinkslinkA"), (0, "ALCATEL-IND1-DHL-MIB", "alaDHLLinkslinkB"))
...
alaDHLLinkslinkA = MibTableColumn((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 2, 1, 1, 1), InterfaceIndex()).setMaxAccess("notaccessible")
...
alaDHLLinkslinkB = MibTableColumn((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 2, 1, 1, 2), InterfaceIndex()).setMaxAccess("notaccessible")
...
alaDHLVpaTable = MibTable((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 3, 1), ).setMaxAccess("notaccessible")
...
alaDHLVpaEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 3, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "ALCATEL-IND1-DHL-MIB", "alaDHLSessionIndex"), (0, "ALCATEL-IND1-DHL-MIB", "alaDHLVpalink"), (0, "ALCATEL-IND1-DHL-MIB", "alaDHLVpaVlan"))
...
alaDHLVpalink = MibTableColumn((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 3, 1, 1, 1), InterfaceIndex()).setMaxAccess("notaccessible")
...
alaDHLVpaVlan = MibTableColumn((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 3, 1, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 4094))).setMaxAccess("notaccessible")
...
alaDHLVlanMapTable = MibTable((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 4, 1), ).setMaxAccess("notaccessible")
...
alaDHLVlanMapEntry = MibTableRow((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 4, 1, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "ALCATEL-IND1-DHL-MIB", "alaDHLSessionIndex"), (0, "ALCATEL-IND1-DHL-MIB", "alaDHLVlanMapVlanStart"), (0, "ALCATEL-IND1-DHL-MIB", "alaDHLVlanMapVlanEnd"))
...
alaDHLVlanMapVlanStart = MibTableColumn((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 4, 1, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 4094))).setMaxAccess("notaccessible")
...
alaDHLVlanMapVlanEnd = MibTableColumn((1, 3, 6, 1, 4, 1, 6486, 801, 1, 2, 1, 65, 1, 1, 4, 1, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 4094))).setMaxAccess("notaccessible")
...
mibBuilder.exportSymbols("ALCATEL-IND1-DHL-MIB", PYSNMP_MODULE_ID=alcatelIND1DHLMIB, alaDHLLinksConfig=alaDHLLinksConfig, alaDHLLinksEntry=alaDHLLinksEntry, alaDHLLinksGroup=alaDHLLinksGroup, alaDHLLinksRowStatus=alaDHLLinksRowStatus, alaDHLLinksTable=alaDHLLinksTable, alaDHLLinkslinkA=alaDHLLinkslinkA, alaDHLLinkslinkAOperStatus=alaDHLLinkslinkAOperStatus, alaDHLLinkslinkB=alaDHLLinkslinkB, alaDHLLinkslinkBOperStatus=alaDHLLinkslinkBOperStatus, alaDHLNotificationGroup=alaDHLNotificationGroup, alaDHLNotificationObjectGroup=alaDHLNotificationObjectGroup, alaDHLPortFrom=alaDHLPortFrom, alaDHLPortTo=alaDHLPortTo, alaDHLSessionActiveMacFlushing=alaDHLSessionActiveMacFlushing, alaDHLSessionAdminMacFlushing=alaDHLSessionAdminMacFlushing, alaDHLSessionAdminStatus=alaDHLSessionAdminStatus, alaDHLSessionConfig=alaDHLSessionConfig, alaDHLSessionDescr=alaDHLSessionDescr, alaDHLSessionEntry=alaDHLSessionEntry, alaDHLSessionGroup=alaDHLSessionGroup, alaDHLSessionID=alaDHLSessionID, alaDHLSessionIndex=alaDHLSessionIndex, alaDHLSessionOperStatus=alaDHLSessionOperStatus, alaDHLSessionPreemptionTime=alaDHLSessionPreemptionTime, alaDHLSessionRowStatus=alaDHLSessionRowStatus, alaDHLSessionTable=alaDHLSessionTable, alaDHLTrapsObj=alaDHLTrapsObj, alaDHLVlanMap=alaDHLVlanMap, alaDHLVlanMapEntry=alaDHLVlanMapEntry, alaDHLVlanMapGroup=alaDHLVlanMapGroup, alaDHLVlanMapRowStatus=alaDHLVlanMapRowStatus, alaDHLVlanMapTable=alaDHLVlanMapTable, alaDHLVlanMapVlanEnd=alaDHLVlanMapVlanEnd, alaDHLVlanMapVlanStart=alaDHLVlanMapVlanStart, alaDHLVlanMoveReason=alaDHLVlanMoveReason, alaDHLVlanMoveTrap=alaDHLVlanMoveTrap, alaDHLVpa=alaDHLVpa, alaDHLVpaActiveLink=alaDHLVpaActiveLink, alaDHLVpaEntry=alaDHLVpaEntry, alaDHLVpaGroup=alaDHLVpaGroup, alaDHLVpaTable=alaDHLVpaTable, alaDHLVpaVlan=alaDHLVpaVlan, alaDHLVpaVlanType=alaDHLVpaVlanType, alaDHLVpalink=alaDHLVpalink, alcatelIND1DHLMIB=alcatelIND1DHLMIB, alcatelIND1DHLMIBCompliance=alcatelIND1DHLMIBCompliance, alcatelIND1DHLMIBCompliances=alcatelIND1DHLMIBCompliances, alcatelIND1DHLMIBConformance=alcatelIND1DHLMIBConformance, alcatelIND1DHLMIBGroups=alcatelIND1DHLMIBGroups, alcatelIND1DHLMIBNotifications=alcatelIND1DHLMIBNotifications, alcatelIND1DHLMIBObjects=alcatelIND1DHLMIBObjects)
