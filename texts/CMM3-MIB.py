...
mibBuilder.exportSymbols("CMM3-MIB", defaultGateway=defaultGateway, linkSpeed=linkSpeed, cmmIIIMibModule=cmmIIIMibModule, txCollisions=txCollisions, rxUnicastPkts=rxUnicastPkts, port8Config=port8Config, gpsSatellitesVisible=gpsSatellitesVisible, txOctets=txOctets, snmpTrap4=snmpTrap4, portMirrorEnable=portMirrorEnable, port5Uplink=port5Uplink, gpsHeight=gpsHeight, port7VlanConf=port7VlanConf, rxFragments=rxFragments, gpsLongitude=gpsLongitude, cmmEventLog=cmmEventLog, gpsRestartCount=gpsRestartCount, cmmSwitchMirrorSrcPortsTable=cmmSwitchMirrorSrcPortsTable, port4PwrReset=port4PwrReset, displayOnlyAccess=displayOnlyAccess, txFrameInDisc=txFrameInDisc, port2PowerCtr=port2PowerCtr, snmpTrap9=snmpTrap9, gpsTime=gpsTime, port8Description=port8Description, snmpTrap7=snmpTrap7, pkts1024to1522Octets=pkts1024to1522Octets, rxSymbolErrors=rxSymbolErrors, port7PwrReset=port7PwrReset, port4PowerCtr=port4PowerCtr, gpsLatitude=gpsLatitude, port6Management=port6Management, powerStatus=powerStatus, portNumber=portNumber, vlanTagId=vlanTagId, port8Uplink=port8Uplink, port6VlanConf=port6VlanConf, snmpTrap10=snmpTrap10, snmpAccessSubnet5=snmpAccessSubnet5, port8Management=port8Management, port8PwrReset=port8PwrReset, vlanTagEnable=vlanTagEnable, sessionTimeout=sessionTimeout, userPswd=userPswd, port6Description=port6Description, snmpTrap8=snmpTrap8, port5Config=port5Config, gpsDate=gpsDate, rxUndersizePkts=rxUndersizePkts, snmpAccessSubnet7=snmpAccessSubnet7, rxExcessSizeDisc=rxExcessSizeDisc, pkts128to255Octets=pkts128to255Octets, port2VlanConf=port2VlanConf, snmpAccessSubnet4=snmpAccessSubnet4, snmpAccessSubnet9=snmpAccessSubnet9, cmmSwitch=cmmSwitch, macAddress=macAddress, snmpTrap6=snmpTrap6, pkts256to511Octets=pkts256to511Octets, upTime=upTime, syncStatus=syncStatus, rxFCSErrors=rxFCSErrors, port8PowerCtr=port8PowerCtr, lan1Ip=lan1Ip, port4Uplink=port4Uplink, txSingleCollision=txSingleCollision, port4Config=port4Config, cmmConfigGroup=cmmConfigGroup, mirSrcRxEnable=mirSrcRxEnable, snmpAccessSubnet2=snmpAccessSubnet2, allowedIPAccess2=allowedIPAccess2, systemTime=systemTime, snmpTrap3=snmpTrap3, fullAccessStatus=fullAccessStatus, port1PwrReset=port1PwrReset, txUnicastPkts=txUnicastPkts, allowedIPAccess1=allowedIPAccess1, cmmControls=cmmControls, displayOnlyStatus=displayOnlyStatus, port1Config=port1Config, port3Config=port3Config, ntpLog=ntpLog, rxPausePkts=rxPausePkts, cmmSwitchTable=cmmSwitchTable, port7Config=port7Config, port1PowerCtr=port1PowerCtr, userLoginName=userLoginName, pldVersion=pldVersion, mirSrcTxEnable=mirSrcTxEnable, port3Description=port3Description, duplexStatus=duplexStatus, cmmSwitchMirrorSrcPortsEntry=cmmSwitchMirrorSrcPortsEntry, rebootIfRequired=rebootIfRequired, snmpAccessSubnet10=snmpAccessSubnet10, port6PwrReset=port6PwrReset, snmpAccessSubnet6=snmpAccessSubnet6, lan1SubnetMask=lan1SubnetMask, verifyGPSChecksum=verifyGPSChecksum, port6Uplink=port6Uplink, cmmSwitchEntry=cmmSwitchEntry, snmpReadOnly=snmpReadOnly, cmmConfig=cmmConfig, port3VlanConf=port3VlanConf, rxJabbers=rxJabbers, snmpAccessSubnet=snmpAccessSubnet, accessLevel=accessLevel, port5Management=port5Management, port2Uplink=port2Uplink, port3PwrReset=port3PwrReset, latitude=latitude, port3Management=port3Management, cmmUserTableGroup=cmmUserTableGroup, port7Description=port7Description, pkts64Octets=pkts64Octets, snmpTrap1=snmpTrap1, txBroadcastPkts=txBroadcastPkts, port1Management=port1Management, height=height, cmmUserEntry=cmmUserEntry, cmmGps=cmmGps, rxSAChanges=rxSAChanges, rxOversizePkts=rxOversizePkts, port8VlanConf=port8VlanConf, satellitesVisible=satellitesVisible, longitude=longitude, gpsTrackingMode=gpsTrackingMode, gpsSatellitesTracked=gpsSatellitesTracked, txDeferredTransmit=txDeferredTransmit, port5PowerCtr=port5PowerCtr, uplinkStatus=uplinkStatus, managementStatus=managementStatus, trackingMode=trackingMode, cmmSwitchGroup=cmmSwitchGroup, port5Description=port5Description, gpsTimingPulse=gpsTimingPulse, port2Description=port2Description, snmpCommunityString=snmpCommunityString, txMulticastPkts=txMulticastPkts, mirSrcPortNumber=mirSrcPortNumber, cmmGPSGroup=cmmGPSGroup, gpsReceiverInfo=gpsReceiverInfo, rxAlignmentErrors=rxAlignmentErrors, port3PowerCtr=port3PowerCtr, snmpTrap2=snmpTrap2, port1Description=port1Description, port3Uplink=port3Uplink, port2PwrReset=port2PwrReset, allowedIPAccess3=allowedIPAccess3, rxGoodOctets=rxGoodOctets, cmmStatusGroup=cmmStatusGroup, fullAccess=fullAccess, portIndex=portIndex, txMultipleCollision=txMultipleCollision, reboot=reboot, port7Management=port7Management, txDropPkts=txDropPkts, port6PowerCtr=port6PowerCtr, port5PwrReset=port5PwrReset, gpsReInitCount=gpsReInitCount, txLateCollision=txLateCollision, cmmPortTable=cmmPortTable, snmpTrap5=snmpTrap5, snmpAccessSubnet8=snmpAccessSubnet8, port4Management=port4Management, ipAccessFilterEnable=ipAccessFilterEnable, entryIndex=entryIndex, port7PowerCtr=port7PowerCtr, clearEventLog=clearEventLog, eventLog=eventLog, mirrorCapturePort=mirrorCapturePort, pkts512to1023Octets=pkts512to1023Octets, port1VlanConf=port1VlanConf, port1Uplink=port1Uplink, pkts65to127Octets=pkts65to127Octets, snmpAccessSubnet3=snmpAccessSubnet3, gpsInvalidMsg=gpsInvalidMsg, siteInfoViewable=siteInfoViewable, deviceType=deviceType, linkStatus=linkStatus, rxMulticastPkts=rxMulticastPkts, txExcessiveCollision=txExcessiveCollision, port6Config=port6Config, PYSNMP_MODULE_ID=cmmIIIMibModule, txPausePkts=txPausePkts, port7Uplink=port7Uplink, cmmUserTable=cmmUserTable, port4Description=port4Description, port2Config=port2Config, port2Management=port2Management, cmmGroups=cmmGroups, cmmStatus=cmmStatus, rxDropPkts=rxDropPkts, rxOctets=rxOctets, webAutoUpdate=webAutoUpdate, port5VlanConf=port5VlanConf, cmm3SnmpGPSSyncTrapEnable=cmm3SnmpGPSSyncTrapEnable, rxBroadcastPkts=rxBroadcastPkts, softwareVersion=softwareVersion, satellitesTracked=satellitesTracked, gpsAntennaConnection=gpsAntennaConnection, port4VlanConf=port4VlanConf, cmmPortEntry=cmmPortEntry)
