...
mibBuilder.exportSymbols("PRVT-BIST-MIB", fanTestResult=fanTestResult, cpuTestType=cpuTestType, cpuTestResult=cpuTestResult, uartExistTestResult=uartExistTestResult, bistCrossbarExistence=bistCrossbarExistence, nvramTestTable=nvramTestTable, bistUPS=bistUPS, portsTestTable=portsTestTable, ramTestResult=ramTestResult, prvtBISTMib=prvtBISTMib, onboardPowerTestTable=onboardPowerTestTable, bistFan=bistFan, prvtBISTNotifications=prvtBISTNotifications, portTest=portTest, bistStatus=bistStatus, bistSelfTestExecute=bistSelfTestExecute, bistCPU=bistCPU, powerSupplyTestResult=powerSupplyTestResult, bistUPSTest=bistUPSTest, prvtBISTConformance=prvtBISTConformance, bistRAM=bistRAM, ramTestType=ramTestType, PYSNMP_MODULE_ID=prvtBISTMib, cPUTestEntry=cPUTestEntry, nvramTestType=nvramTestType, fanTestEntry=fanTestEntry, bistSelfTestExecuteStatus=bistSelfTestExecuteStatus, ramTestEntry=ramTestEntry, cPUTestTable=cPUTestTable, ramTestTable=ramTestTable, uartExistTestTable=uartExistTestTable, onboardPowerTestResult=onboardPowerTestResult, powerSupplyTestTable=powerSupplyTestTable, onboardPowerTestType=onboardPowerTestType, bistUART=bistUART, onboardPowerTestEntry=onboardPowerTestEntry, fanIndex=fanIndex, bistPowerSupply=bistPowerSupply, nvramTestEntry=nvramTestEntry, bistResult=bistResult, bistSwitchCore=bistSwitchCore, prvtBISTObjects=prvtBISTObjects, bistNVRAM=bistNVRAM, powerSupplyTestEntry=powerSupplyTestEntry, powerSupplyIndex=powerSupplyIndex, uartIndex=uartIndex, bistConfig=bistConfig, bistOnboardPower=bistOnboardPower, uartExistTestEntry=uartExistTestEntry, bistTemperatureTest=bistTemperatureTest, TestResult=TestResult, bistPorts=bistPorts, nvramTestResult=nvramTestResult, portsTestEntry=portsTestEntry, bistTemperature=bistTemperature, fanTestTable=fanTestTable)
