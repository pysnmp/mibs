...
mibBuilder.exportSymbols("PRVT-BIST-MIB", powerSupplyIndex=powerSupplyIndex, portsTestTable=portsTestTable, bistTemperatureTest=bistTemperatureTest, portTest=portTest, powerSupplyTestResult=powerSupplyTestResult, uartExistTestTable=uartExistTestTable, powerSupplyTestEntry=powerSupplyTestEntry, bistNVRAM=bistNVRAM, bistUPSTest=bistUPSTest, ramTestEntry=ramTestEntry, uartIndex=uartIndex, bistOnboardPower=bistOnboardPower, bistSwitchCore=bistSwitchCore, nvramTestType=nvramTestType, onboardPowerTestEntry=onboardPowerTestEntry, uartExistTestResult=uartExistTestResult, nvramTestTable=nvramTestTable, cPUTestEntry=cPUTestEntry, ramTestTable=ramTestTable, ramTestType=ramTestType, bistCrossbarExistence=bistCrossbarExistence, bistCPU=bistCPU, TestResult=TestResult, bistUPS=bistUPS, cpuTestType=cpuTestType, cpuTestResult=cpuTestResult, prvtBISTConformance=prvtBISTConformance, prvtBISTNotifications=prvtBISTNotifications, cPUTestTable=cPUTestTable, fanTestEntry=fanTestEntry, bistFan=bistFan, fanTestTable=fanTestTable, ramTestResult=ramTestResult, bistSelfTestExecute=bistSelfTestExecute, bistSelfTestExecuteStatus=bistSelfTestExecuteStatus, fanIndex=fanIndex, bistConfig=bistConfig, bistUART=bistUART, onboardPowerTestResult=onboardPowerTestResult, portsTestEntry=portsTestEntry, bistResult=bistResult, bistRAM=bistRAM, nvramTestEntry=nvramTestEntry, fanTestResult=fanTestResult, nvramTestResult=nvramTestResult, prvtBISTMib=prvtBISTMib, PYSNMP_MODULE_ID=prvtBISTMib, powerSupplyTestTable=powerSupplyTestTable, uartExistTestEntry=uartExistTestEntry, onboardPowerTestType=onboardPowerTestType, onboardPowerTestTable=onboardPowerTestTable, bistTemperature=bistTemperature, bistPowerSupply=bistPowerSupply, prvtBISTObjects=prvtBISTObjects, bistPorts=bistPorts, bistStatus=bistStatus)
