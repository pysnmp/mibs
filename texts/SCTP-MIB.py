...
mibBuilder.exportSymbols("SCTP-MIB", sctpOutSCTPPacks=sctpOutSCTPPacks, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpAborteds=sctpAborteds, sctpMaxInitRetr=sctpMaxInitRetr, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpRtoMax=sctpRtoMax, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpInCtrlChunks=sctpInCtrlChunks, sctpObjects=sctpObjects, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpInverseGroup=sctpInverseGroup, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpAssocInStreams=sctpAssocInStreams, sctpParams=sctpParams, sctpAssocT1expireds=sctpAssocT1expireds, sctpShutdowns=sctpShutdowns, sctpStatsGroup=sctpStatsGroup, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpMibConformance=sctpMibConformance, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpOutOfBlues=sctpOutOfBlues, sctpInSCTPPacks=sctpInSCTPPacks, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpCurrEstab=sctpCurrEstab, sctpActiveEstabs=sctpActiveEstabs, sctpAssocStartTime=sctpAssocStartTime, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpAssocT2expireds=sctpAssocT2expireds, sctpAssocRemPort=sctpAssocRemPort, sctpAssocEntry=sctpAssocEntry, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpChecksumErrors=sctpChecksumErrors, sctpAssocId=sctpAssocId, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpAssocRemHostName=sctpAssocRemHostName, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpMaxAssocs=sctpMaxAssocs, sctpOutOrderChunks=sctpOutOrderChunks, sctpInOrderChunks=sctpInOrderChunks, sctpAssocState=sctpAssocState, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpAssocOutStreams=sctpAssocOutStreams, sctpMIB=sctpMIB, sctpInUnorderChunks=sctpInUnorderChunks, sctpRtoInitial=sctpRtoInitial, sctpStats=sctpStats, sctpValCookieLife=sctpValCookieLife, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpMibCompliance=sctpMibCompliance, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpMibGroups=sctpMibGroups, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpAssocLocalPort=sctpAssocLocalPort, sctpMibCompliances=sctpMibCompliances, sctpAssocRemAddr=sctpAssocRemAddr, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, PYSNMP_MODULE_ID=sctpMIB, sctpAssocTable=sctpAssocTable, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpPassiveEstabs=sctpPassiveEstabs, sctpRtoMin=sctpRtoMin)
