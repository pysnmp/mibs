...
mibBuilder.exportSymbols("SCTP-MIB", sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpAssocOutStreams=sctpAssocOutStreams, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpInSCTPPacks=sctpInSCTPPacks, sctpInCtrlChunks=sctpInCtrlChunks, sctpActiveEstabs=sctpActiveEstabs, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpRtoInitial=sctpRtoInitial, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpOutOfBlues=sctpOutOfBlues, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpMibConformance=sctpMibConformance, sctpChecksumErrors=sctpChecksumErrors, sctpPassiveEstabs=sctpPassiveEstabs, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpAssocInStreams=sctpAssocInStreams, sctpMIB=sctpMIB, sctpAborteds=sctpAborteds, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpAssocLocalPort=sctpAssocLocalPort, sctpMibGroups=sctpMibGroups, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, PYSNMP_MODULE_ID=sctpMIB, sctpAssocRemPort=sctpAssocRemPort, sctpStatsGroup=sctpStatsGroup, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpRtoMin=sctpRtoMin, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpAssocEntry=sctpAssocEntry, sctpAssocRemHostName=sctpAssocRemHostName, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpAssocT2expireds=sctpAssocT2expireds, sctpInverseGroup=sctpInverseGroup, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpMibCompliances=sctpMibCompliances, sctpAssocTable=sctpAssocTable, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpInOrderChunks=sctpInOrderChunks, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpAssocT1expireds=sctpAssocT1expireds, sctpAssocState=sctpAssocState, sctpInUnorderChunks=sctpInUnorderChunks, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpValCookieLife=sctpValCookieLife, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpParams=sctpParams, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpAssocRemAddr=sctpAssocRemAddr, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpRtoMax=sctpRtoMax, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpCurrEstab=sctpCurrEstab, sctpAssocStartTime=sctpAssocStartTime, sctpMaxAssocs=sctpMaxAssocs, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpMibCompliance=sctpMibCompliance, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpMaxInitRetr=sctpMaxInitRetr, sctpAssocId=sctpAssocId, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpObjects=sctpObjects, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpShutdowns=sctpShutdowns, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpOutOrderChunks=sctpOutOrderChunks, sctpStats=sctpStats, sctpLayerParamsGroup=sctpLayerParamsGroup)
