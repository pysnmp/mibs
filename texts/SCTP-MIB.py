...
mibBuilder.exportSymbols("SCTP-MIB", sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpAssocStartTime=sctpAssocStartTime, sctpRtoInitial=sctpRtoInitial, sctpAssocRemAddr=sctpAssocRemAddr, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpInOrderChunks=sctpInOrderChunks, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpRtoMax=sctpRtoMax, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpMaxInitRetr=sctpMaxInitRetr, sctpActiveEstabs=sctpActiveEstabs, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpInCtrlChunks=sctpInCtrlChunks, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpMibCompliances=sctpMibCompliances, sctpObjects=sctpObjects, sctpValCookieLife=sctpValCookieLife, sctpOutOfBlues=sctpOutOfBlues, sctpInSCTPPacks=sctpInSCTPPacks, sctpStats=sctpStats, sctpAssocState=sctpAssocState, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpAborteds=sctpAborteds, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpAssocRemPort=sctpAssocRemPort, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpAssocT1expireds=sctpAssocT1expireds, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpMibGroups=sctpMibGroups, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpAssocEntry=sctpAssocEntry, sctpMIB=sctpMIB, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpInUnorderChunks=sctpInUnorderChunks, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpAssocInStreams=sctpAssocInStreams, sctpMaxAssocs=sctpMaxAssocs, sctpShutdowns=sctpShutdowns, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpAssocOutStreams=sctpAssocOutStreams, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpPassiveEstabs=sctpPassiveEstabs, sctpRtoMin=sctpRtoMin, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpAssocLocalPort=sctpAssocLocalPort, PYSNMP_MODULE_ID=sctpMIB, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpMibConformance=sctpMibConformance, sctpAssocT2expireds=sctpAssocT2expireds, sctpAssocTable=sctpAssocTable, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpParams=sctpParams, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpAssocRemHostName=sctpAssocRemHostName, sctpChecksumErrors=sctpChecksumErrors, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpInverseGroup=sctpInverseGroup, sctpCurrEstab=sctpCurrEstab, sctpMibCompliance=sctpMibCompliance, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpAssocId=sctpAssocId, sctpStatsGroup=sctpStatsGroup, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpOutOrderChunks=sctpOutOrderChunks, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable)
