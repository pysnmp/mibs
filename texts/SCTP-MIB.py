...
mibBuilder.exportSymbols("SCTP-MIB", sctpRtoAlgorithm=sctpRtoAlgorithm, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpParams=sctpParams, sctpOutOrderChunks=sctpOutOrderChunks, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpRtoInitial=sctpRtoInitial, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpAssocOutStreams=sctpAssocOutStreams, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpRtoMin=sctpRtoMin, sctpShutdowns=sctpShutdowns, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, PYSNMP_MODULE_ID=sctpMIB, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpMibConformance=sctpMibConformance, sctpAborteds=sctpAborteds, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, sctpObjects=sctpObjects, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpAssocEntry=sctpAssocEntry, sctpInSCTPPacks=sctpInSCTPPacks, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpAssocRemHostName=sctpAssocRemHostName, sctpAssocRemAddr=sctpAssocRemAddr, sctpAssocId=sctpAssocId, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpMaxInitRetr=sctpMaxInitRetr, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpMibGroups=sctpMibGroups, sctpActiveEstabs=sctpActiveEstabs, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpMibCompliance=sctpMibCompliance, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpInOrderChunks=sctpInOrderChunks, sctpValCookieLife=sctpValCookieLife, sctpAssocState=sctpAssocState, sctpCurrEstab=sctpCurrEstab, sctpMIB=sctpMIB, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpAssocTable=sctpAssocTable, sctpAssocT1expireds=sctpAssocT1expireds, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpAssocT2expireds=sctpAssocT2expireds, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpInverseGroup=sctpInverseGroup, sctpInCtrlChunks=sctpInCtrlChunks, sctpInUnorderChunks=sctpInUnorderChunks, sctpStatsGroup=sctpStatsGroup, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpMibCompliances=sctpMibCompliances, sctpAssocRemPort=sctpAssocRemPort, sctpMaxAssocs=sctpMaxAssocs, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpOutOfBlues=sctpOutOfBlues, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpAssocStartTime=sctpAssocStartTime, sctpChecksumErrors=sctpChecksumErrors, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpAssocLocalPort=sctpAssocLocalPort, sctpPassiveEstabs=sctpPassiveEstabs, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpRtoMax=sctpRtoMax, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpAssocInStreams=sctpAssocInStreams, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpStats=sctpStats)
