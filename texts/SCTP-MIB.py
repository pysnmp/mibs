...
mibBuilder.exportSymbols("SCTP-MIB", sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpAssocRemAddr=sctpAssocRemAddr, sctpMibGroups=sctpMibGroups, sctpMaxInitRetr=sctpMaxInitRetr, sctpInUnorderChunks=sctpInUnorderChunks, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpAssocRemPort=sctpAssocRemPort, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpObjects=sctpObjects, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpMibCompliance=sctpMibCompliance, sctpAssocEntry=sctpAssocEntry, sctpRtoMin=sctpRtoMin, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpValCookieLife=sctpValCookieLife, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpAssocInStreams=sctpAssocInStreams, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpRtoMax=sctpRtoMax, sctpPassiveEstabs=sctpPassiveEstabs, sctpInverseGroup=sctpInverseGroup, PYSNMP_MODULE_ID=sctpMIB, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpShutdowns=sctpShutdowns, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpInOrderChunks=sctpInOrderChunks, sctpAborteds=sctpAborteds, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpAssocId=sctpAssocId, sctpAssocLocalPort=sctpAssocLocalPort, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpOutOrderChunks=sctpOutOrderChunks, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpAssocOutStreams=sctpAssocOutStreams, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpRtoInitial=sctpRtoInitial, sctpInSCTPPacks=sctpInSCTPPacks, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpAssocT2expireds=sctpAssocT2expireds, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpAssocState=sctpAssocState, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpMIB=sctpMIB, sctpMibCompliances=sctpMibCompliances, sctpMaxAssocs=sctpMaxAssocs, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpAssocRemHostName=sctpAssocRemHostName, sctpStatsGroup=sctpStatsGroup, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpChecksumErrors=sctpChecksumErrors, sctpAssocTable=sctpAssocTable, sctpParams=sctpParams, sctpInCtrlChunks=sctpInCtrlChunks, sctpAssocT1expireds=sctpAssocT1expireds, sctpActiveEstabs=sctpActiveEstabs, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpAssocStartTime=sctpAssocStartTime, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpOutOfBlues=sctpOutOfBlues, sctpMibConformance=sctpMibConformance, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpCurrEstab=sctpCurrEstab, sctpStats=sctpStats)
