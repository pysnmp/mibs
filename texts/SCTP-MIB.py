...
mibBuilder.exportSymbols("SCTP-MIB", sctpAssocRemHostName=sctpAssocRemHostName, sctpAssocEntry=sctpAssocEntry, sctpChecksumErrors=sctpChecksumErrors, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, PYSNMP_MODULE_ID=sctpMIB, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpParams=sctpParams, sctpValCookieLife=sctpValCookieLife, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpMibCompliances=sctpMibCompliances, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpAssocInStreams=sctpAssocInStreams, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpMibCompliance=sctpMibCompliance, sctpObjects=sctpObjects, sctpActiveEstabs=sctpActiveEstabs, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpAssocId=sctpAssocId, sctpAssocOutStreams=sctpAssocOutStreams, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpOutOfBlues=sctpOutOfBlues, sctpInCtrlChunks=sctpInCtrlChunks, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpCurrEstab=sctpCurrEstab, sctpShutdowns=sctpShutdowns, sctpRtoMax=sctpRtoMax, sctpMibGroups=sctpMibGroups, sctpInUnorderChunks=sctpInUnorderChunks, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpMibConformance=sctpMibConformance, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpPassiveEstabs=sctpPassiveEstabs, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpAssocTable=sctpAssocTable, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpInSCTPPacks=sctpInSCTPPacks, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpMaxAssocs=sctpMaxAssocs, sctpAssocLocalPort=sctpAssocLocalPort, sctpAssocT2expireds=sctpAssocT2expireds, sctpOutOrderChunks=sctpOutOrderChunks, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpAssocT1expireds=sctpAssocT1expireds, sctpRtoMin=sctpRtoMin, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpAborteds=sctpAborteds, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpMIB=sctpMIB, sctpRtoInitial=sctpRtoInitial, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpAssocRemAddr=sctpAssocRemAddr, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpInOrderChunks=sctpInOrderChunks, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpAssocStartTime=sctpAssocStartTime, sctpAssocState=sctpAssocState, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpStats=sctpStats, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpInverseGroup=sctpInverseGroup, sctpStatsGroup=sctpStatsGroup, sctpAssocRemPort=sctpAssocRemPort, sctpMaxInitRetr=sctpMaxInitRetr)
