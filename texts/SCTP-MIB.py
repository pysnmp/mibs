...
mibBuilder.exportSymbols("SCTP-MIB", sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpActiveEstabs=sctpActiveEstabs, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpChecksumErrors=sctpChecksumErrors, sctpInCtrlChunks=sctpInCtrlChunks, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpAssocState=sctpAssocState, sctpAssocInStreams=sctpAssocInStreams, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpAssocStartTime=sctpAssocStartTime, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpInSCTPPacks=sctpInSCTPPacks, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpInOrderChunks=sctpInOrderChunks, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpStats=sctpStats, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpMIB=sctpMIB, sctpMibCompliance=sctpMibCompliance, sctpMaxAssocs=sctpMaxAssocs, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpPassiveEstabs=sctpPassiveEstabs, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpShutdowns=sctpShutdowns, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpParams=sctpParams, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpAssocRemHostName=sctpAssocRemHostName, sctpMibConformance=sctpMibConformance, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpMaxInitRetr=sctpMaxInitRetr, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpAborteds=sctpAborteds, sctpAssocOutStreams=sctpAssocOutStreams, sctpObjects=sctpObjects, sctpAssocT2expireds=sctpAssocT2expireds, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpAssocT1expireds=sctpAssocT1expireds, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpCurrEstab=sctpCurrEstab, sctpValCookieLife=sctpValCookieLife, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpRtoInitial=sctpRtoInitial, sctpStatsGroup=sctpStatsGroup, sctpAssocRemAddr=sctpAssocRemAddr, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpMibCompliances=sctpMibCompliances, sctpOutOrderChunks=sctpOutOrderChunks, sctpRtoMax=sctpRtoMax, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpInUnorderChunks=sctpInUnorderChunks, sctpAssocEntry=sctpAssocEntry, sctpOutOfBlues=sctpOutOfBlues, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpAssocTable=sctpAssocTable, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpAssocRemPort=sctpAssocRemPort, sctpInverseGroup=sctpInverseGroup, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpRtoMin=sctpRtoMin, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpAssocLocalPort=sctpAssocLocalPort, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, PYSNMP_MODULE_ID=sctpMIB, sctpAssocId=sctpAssocId, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpMibGroups=sctpMibGroups, sctpOutCtrlChunks=sctpOutCtrlChunks)
