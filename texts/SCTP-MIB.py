...
mibBuilder.exportSymbols("SCTP-MIB", sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpAssocRemHostName=sctpAssocRemHostName, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpInUnorderChunks=sctpInUnorderChunks, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpInCtrlChunks=sctpInCtrlChunks, sctpParams=sctpParams, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpAssocTable=sctpAssocTable, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpAssocEntry=sctpAssocEntry, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpOutOrderChunks=sctpOutOrderChunks, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpRtoMin=sctpRtoMin, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpAssocState=sctpAssocState, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpAssocT1expireds=sctpAssocT1expireds, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpMIB=sctpMIB, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpAssocOutStreams=sctpAssocOutStreams, sctpMibGroups=sctpMibGroups, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpObjects=sctpObjects, sctpInverseGroup=sctpInverseGroup, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpAssocId=sctpAssocId, sctpAssocT2expireds=sctpAssocT2expireds, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpInSCTPPacks=sctpInSCTPPacks, sctpAssocStartTime=sctpAssocStartTime, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpMaxInitRetr=sctpMaxInitRetr, sctpOutOfBlues=sctpOutOfBlues, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpAssocRemAddr=sctpAssocRemAddr, sctpAssocLocalPort=sctpAssocLocalPort, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpChecksumErrors=sctpChecksumErrors, sctpAborteds=sctpAborteds, sctpAssocInStreams=sctpAssocInStreams, sctpMibCompliance=sctpMibCompliance, sctpMibConformance=sctpMibConformance, sctpStatsGroup=sctpStatsGroup, sctpRtoInitial=sctpRtoInitial, sctpMibCompliances=sctpMibCompliances, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpValCookieLife=sctpValCookieLife, sctpRtoMax=sctpRtoMax, sctpMaxAssocs=sctpMaxAssocs, sctpCurrEstab=sctpCurrEstab, sctpShutdowns=sctpShutdowns, sctpActiveEstabs=sctpActiveEstabs, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, sctpPassiveEstabs=sctpPassiveEstabs, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpStats=sctpStats, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpInOrderChunks=sctpInOrderChunks, sctpAssocRemPort=sctpAssocRemPort, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, PYSNMP_MODULE_ID=sctpMIB)
