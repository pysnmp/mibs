...
mibBuilder.exportSymbols("SCTP-MIB", sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpParams=sctpParams, sctpMibCompliances=sctpMibCompliances, sctpStatsGroup=sctpStatsGroup, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpMibConformance=sctpMibConformance, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpAssocInStreams=sctpAssocInStreams, sctpAssocState=sctpAssocState, sctpAssocRemHostName=sctpAssocRemHostName, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, sctpCurrEstab=sctpCurrEstab, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpObjects=sctpObjects, sctpAborteds=sctpAborteds, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpMaxInitRetr=sctpMaxInitRetr, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpAssocRemPort=sctpAssocRemPort, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpMaxAssocs=sctpMaxAssocs, sctpRtoMax=sctpRtoMax, sctpAssocId=sctpAssocId, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpInUnorderChunks=sctpInUnorderChunks, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpInverseGroup=sctpInverseGroup, sctpStats=sctpStats, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpOutOrderChunks=sctpOutOrderChunks, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpValCookieLife=sctpValCookieLife, sctpInOrderChunks=sctpInOrderChunks, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpMibGroups=sctpMibGroups, sctpOutOfBlues=sctpOutOfBlues, sctpAssocOutStreams=sctpAssocOutStreams, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpAssocT2expireds=sctpAssocT2expireds, sctpPassiveEstabs=sctpPassiveEstabs, sctpMIB=sctpMIB, sctpShutdowns=sctpShutdowns, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, PYSNMP_MODULE_ID=sctpMIB, sctpMibCompliance=sctpMibCompliance, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpAssocTable=sctpAssocTable, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpRtoInitial=sctpRtoInitial, sctpActiveEstabs=sctpActiveEstabs, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpInSCTPPacks=sctpInSCTPPacks, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpAssocRemAddr=sctpAssocRemAddr, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpInCtrlChunks=sctpInCtrlChunks, sctpAssocEntry=sctpAssocEntry, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpRtoMin=sctpRtoMin, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpAssocStartTime=sctpAssocStartTime, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpAssocT1expireds=sctpAssocT1expireds, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpAssocLocalPort=sctpAssocLocalPort, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpChecksumErrors=sctpChecksumErrors, sctpLookupLocalPortTable=sctpLookupLocalPortTable)
