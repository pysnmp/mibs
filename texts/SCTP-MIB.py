...
mibBuilder.exportSymbols("SCTP-MIB", sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpObjects=sctpObjects, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpChecksumErrors=sctpChecksumErrors, sctpAssocOutStreams=sctpAssocOutStreams, sctpMibConformance=sctpMibConformance, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpAssocInStreams=sctpAssocInStreams, sctpMibGroups=sctpMibGroups, sctpAssocLocalPort=sctpAssocLocalPort, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpAssocId=sctpAssocId, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpOutOfBlues=sctpOutOfBlues, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpParams=sctpParams, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpAssocStartTime=sctpAssocStartTime, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpInSCTPPacks=sctpInSCTPPacks, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpAssocState=sctpAssocState, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpMibCompliance=sctpMibCompliance, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpAssocT1expireds=sctpAssocT1expireds, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpMIB=sctpMIB, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpOutOrderChunks=sctpOutOrderChunks, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpAssocRemPort=sctpAssocRemPort, sctpShutdowns=sctpShutdowns, sctpStats=sctpStats, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpInCtrlChunks=sctpInCtrlChunks, sctpRtoInitial=sctpRtoInitial, sctpInUnorderChunks=sctpInUnorderChunks, sctpStatsGroup=sctpStatsGroup, sctpAssocEntry=sctpAssocEntry, sctpRtoMin=sctpRtoMin, sctpAborteds=sctpAborteds, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpAssocRemAddr=sctpAssocRemAddr, sctpCurrEstab=sctpCurrEstab, PYSNMP_MODULE_ID=sctpMIB, sctpActiveEstabs=sctpActiveEstabs, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpMibCompliances=sctpMibCompliances, sctpRtoMax=sctpRtoMax, sctpInOrderChunks=sctpInOrderChunks, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpInverseGroup=sctpInverseGroup, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, sctpAssocT2expireds=sctpAssocT2expireds, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpValCookieLife=sctpValCookieLife, sctpAssocRemHostName=sctpAssocRemHostName, sctpMaxInitRetr=sctpMaxInitRetr, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpAssocTable=sctpAssocTable, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpMaxAssocs=sctpMaxAssocs, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpPassiveEstabs=sctpPassiveEstabs)
