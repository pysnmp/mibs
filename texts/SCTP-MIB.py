...
mibBuilder.exportSymbols("SCTP-MIB", sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpAssocTable=sctpAssocTable, sctpAborteds=sctpAborteds, sctpAssocRemPort=sctpAssocRemPort, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpAssocRemHostName=sctpAssocRemHostName, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpMibConformance=sctpMibConformance, sctpMIB=sctpMIB, sctpAssocRemAddr=sctpAssocRemAddr, sctpMaxInitRetr=sctpMaxInitRetr, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpShutdowns=sctpShutdowns, sctpAssocLocalPort=sctpAssocLocalPort, sctpRtoInitial=sctpRtoInitial, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpValCookieLife=sctpValCookieLife, sctpActiveEstabs=sctpActiveEstabs, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpInverseGroup=sctpInverseGroup, sctpInSCTPPacks=sctpInSCTPPacks, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, PYSNMP_MODULE_ID=sctpMIB, sctpObjects=sctpObjects, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpMibGroups=sctpMibGroups, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpMibCompliance=sctpMibCompliance, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpParams=sctpParams, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpMibCompliances=sctpMibCompliances, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpStatsGroup=sctpStatsGroup, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpAssocState=sctpAssocState, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpInOrderChunks=sctpInOrderChunks, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpAssocOutStreams=sctpAssocOutStreams, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpCurrEstab=sctpCurrEstab, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpMaxAssocs=sctpMaxAssocs, sctpOutOfBlues=sctpOutOfBlues, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpOutOrderChunks=sctpOutOrderChunks, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpAssocId=sctpAssocId, sctpPassiveEstabs=sctpPassiveEstabs, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpAssocStartTime=sctpAssocStartTime, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpRtoMin=sctpRtoMin, sctpInCtrlChunks=sctpInCtrlChunks, sctpInUnorderChunks=sctpInUnorderChunks, sctpRtoMax=sctpRtoMax, sctpAssocT1expireds=sctpAssocT1expireds, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpChecksumErrors=sctpChecksumErrors, sctpAssocInStreams=sctpAssocInStreams, sctpAssocT2expireds=sctpAssocT2expireds, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpStats=sctpStats, sctpAssocEntry=sctpAssocEntry, sctpAssocRemAddrTable=sctpAssocRemAddrTable)
