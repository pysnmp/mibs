...
mibBuilder.exportSymbols("SCTP-MIB", sctpLookupRemPortTable=sctpLookupRemPortTable, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpOutOrderChunks=sctpOutOrderChunks, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpStatsGroup=sctpStatsGroup, sctpAssocT2expireds=sctpAssocT2expireds, sctpInOrderChunks=sctpInOrderChunks, sctpValCookieLife=sctpValCookieLife, sctpAssocRemPort=sctpAssocRemPort, sctpAssocId=sctpAssocId, sctpAssocTable=sctpAssocTable, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpAborteds=sctpAborteds, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpOutOfBlues=sctpOutOfBlues, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpPassiveEstabs=sctpPassiveEstabs, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpAssocLocalPort=sctpAssocLocalPort, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpInSCTPPacks=sctpInSCTPPacks, sctpParams=sctpParams, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpLookupLocalPortTable=sctpLookupLocalPortTable, sctpRtoMax=sctpRtoMax, sctpAssocRemHostName=sctpAssocRemHostName, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpMibCompliance=sctpMibCompliance, sctpMaxAssocs=sctpMaxAssocs, sctpShutdowns=sctpShutdowns, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpMIB=sctpMIB, sctpRtoMin=sctpRtoMin, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpActiveEstabs=sctpActiveEstabs, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, PYSNMP_MODULE_ID=sctpMIB, sctpMaxInitRetr=sctpMaxInitRetr, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpAssocOutStreams=sctpAssocOutStreams, sctpAssocStartTime=sctpAssocStartTime, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpAssocInStreams=sctpAssocInStreams, sctpCurrEstab=sctpCurrEstab, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpMibConformance=sctpMibConformance, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpInCtrlChunks=sctpInCtrlChunks, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpAssocRemAddr=sctpAssocRemAddr, sctpChecksumErrors=sctpChecksumErrors, sctpStats=sctpStats, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpMibGroups=sctpMibGroups, sctpAssocEntry=sctpAssocEntry, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpInUnorderChunks=sctpInUnorderChunks, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpInverseGroup=sctpInverseGroup, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpAssocT1expireds=sctpAssocT1expireds, sctpAssocState=sctpAssocState, sctpMibCompliances=sctpMibCompliances, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpRtoInitial=sctpRtoInitial, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpObjects=sctpObjects)
