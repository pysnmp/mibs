...
mibBuilder.exportSymbols("SCTP-MIB", sctpValCookieLife=sctpValCookieLife, sctpActiveEstabs=sctpActiveEstabs, sctpRtoMax=sctpRtoMax, sctpRtoAlgorithm=sctpRtoAlgorithm, sctpAssocRemAddrTable=sctpAssocRemAddrTable, sctpAssocT1expireds=sctpAssocT1expireds, PYSNMP_MODULE_ID=sctpMIB, sctpAssocRemAddrRTO=sctpAssocRemAddrRTO, sctpAssocLocalAddrStartTime=sctpAssocLocalAddrStartTime, sctpOutSCTPPacks=sctpOutSCTPPacks, sctpLookupRemHostNameEntry=sctpLookupRemHostNameEntry, sctpAssocState=sctpAssocState, sctpLookupRemPortEntry=sctpLookupRemPortEntry, sctpInverseGroup=sctpInverseGroup, sctpCurrEstab=sctpCurrEstab, sctpLookupLocalPortEntry=sctpLookupLocalPortEntry, sctpReasmUsrMsgs=sctpReasmUsrMsgs, sctpLayerParamsGroup=sctpLayerParamsGroup, sctpAssocRemPrimAddr=sctpAssocRemPrimAddr, sctpMIB=sctpMIB, sctpAssocMaxRetr=sctpAssocMaxRetr, sctpLookupRemPrimIPAddrEntry=sctpLookupRemPrimIPAddrEntry, sctpAssocRtxChunks=sctpAssocRtxChunks, sctpAssocId=sctpAssocId, sctpAssocRemAddr=sctpAssocRemAddr, sctpAssocLocalAddrType=sctpAssocLocalAddrType, sctpRtoMin=sctpRtoMin, sctpAssocRemAddrEntry=sctpAssocRemAddrEntry, sctpMibGroups=sctpMibGroups, sctpMaxAssocs=sctpMaxAssocs, sctpLookupRemIPAddrStartTime=sctpLookupRemIPAddrStartTime, sctpMaxInitRetr=sctpMaxInitRetr, sctpAborteds=sctpAborteds, sctpAssocLocalPort=sctpAssocLocalPort, sctpParams=sctpParams, sctpInUnorderChunks=sctpInUnorderChunks, sctpOutCtrlChunks=sctpOutCtrlChunks, sctpAssocOutStreams=sctpAssocOutStreams, sctpLookupRemPortStartTime=sctpLookupRemPortStartTime, sctpAssocT2expireds=sctpAssocT2expireds, sctpAssocEntry=sctpAssocEntry, sctpAssocInStreams=sctpAssocInStreams, sctpAssocRemHostName=sctpAssocRemHostName, sctpAssocRemAddrActive=sctpAssocRemAddrActive, sctpLookupRemPortTable=sctpLookupRemPortTable, sctpAssocRemAddrRtx=sctpAssocRemAddrRtx, sctpAssocTable=sctpAssocTable, sctpAssocLocalAddr=sctpAssocLocalAddr, sctpLookupRemHostNameStartTime=sctpLookupRemHostNameStartTime, sctpDiscontinuityTime=sctpDiscontinuityTime, sctpAssocStartTime=sctpAssocStartTime, sctpLookupLocalPortStartTime=sctpLookupLocalPortStartTime, sctpAssocRemPort=sctpAssocRemPort, sctpInOrderChunks=sctpInOrderChunks, sctpPassiveEstabs=sctpPassiveEstabs, sctpStats=sctpStats, sctpMibCompliance=sctpMibCompliance, sctpInSCTPPacks=sctpInSCTPPacks, sctpChecksumErrors=sctpChecksumErrors, sctpAssocHeartBeatInterval=sctpAssocHeartBeatInterval, sctpPerAssocParamsGroup=sctpPerAssocParamsGroup, sctpLookupRemPrimIPAddrStartTime=sctpLookupRemPrimIPAddrStartTime, sctpObjects=sctpObjects, sctpOutUnorderChunks=sctpOutUnorderChunks, sctpMibCompliances=sctpMibCompliances, sctpAssocDiscontinuityTime=sctpAssocDiscontinuityTime, sctpInCtrlChunks=sctpInCtrlChunks, sctpPerAssocStatsGroup=sctpPerAssocStatsGroup, sctpAssocRemPrimAddrType=sctpAssocRemPrimAddrType, sctpLookupRemPrimIPAddrTable=sctpLookupRemPrimIPAddrTable, sctpAssocRemAddrHBActive=sctpAssocRemAddrHBActive, sctpRtoInitial=sctpRtoInitial, sctpOutOrderChunks=sctpOutOrderChunks, sctpOutOfBlues=sctpOutOfBlues, sctpLookupRemHostNameTable=sctpLookupRemHostNameTable, sctpAssocRemAddrStartTime=sctpAssocRemAddrStartTime, sctpAssocPrimProcess=sctpAssocPrimProcess, sctpShutdowns=sctpShutdowns, sctpAssocRemAddrMaxPathRtx=sctpAssocRemAddrMaxPathRtx, sctpAssocLocalAddrTable=sctpAssocLocalAddrTable, sctpFragUsrMsgs=sctpFragUsrMsgs, sctpMibConformance=sctpMibConformance, sctpAssocLocalAddrEntry=sctpAssocLocalAddrEntry, sctpStatsGroup=sctpStatsGroup, sctpAssocRemAddrType=sctpAssocRemAddrType, sctpLookupRemIPAddrTable=sctpLookupRemIPAddrTable, sctpLookupRemIPAddrEntry=sctpLookupRemIPAddrEntry, sctpLookupLocalPortTable=sctpLookupLocalPortTable)
