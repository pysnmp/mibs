...
# ASN.1 source CISCOSB-EEE-MIB
# Source digest sha256:b8abebbf29732a52ba03bf7a289c09749607ee69c132ab1cb3b28b6f57966304
...
if mibBuilder.loadTexts: rlEee.setContactInfo('Postal: 170 West Tasman Drive\n        San Jose , CA 95134-1706\n        USA\n\n        \n        Website:  Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
rlEeePortTable = MibTable((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 149, 2), ).setMaxAccess("notaccessible")
...
rlEeePortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 149, 2, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
if mibBuilder.loadTexts: rlEeePortSupported.setDescription('Bit map that indicates whether EEE supported on the phy of the ifindex per speed\n         0 - speed 10m; 1 - 100m; 2 - 1g; 3 - 10g; 4 - 2.5g; 5 - 5g')
...
if mibBuilder.loadTexts: rlEeePortOperStatus.setDescription('Indicates whether EEE active on ifindex - ifoper is up,\n                                                   rlEeePortSupported BIT is on in current port speed\n                                                   rlEeePortLldpRemoteStatus is true,\n                                                   rlEeeEnable is true,\n                                                   rlEeePortAdminStatus is true')
rlEeePortLldpTable = MibTable((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 149, 3), ).setMaxAccess("notaccessible")
...
rlEeePortLldpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 149, 3, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
if mibBuilder.loadTexts: rlEeePortLldpOperStatus.setDescription('Indicates whether EEE LLDP active on ifindex - rlEeePortLldpAdminStatus is true\n                                                        lldpPortConfigAdminStatus is txAndRx,\n                                                        rlLldpEnabled is true,\n                                                        recieve a synch lldp packet')
rlEeePortLldpLocalTable = MibTable((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 149, 4), ).setMaxAccess("notaccessible")
...
rlEeePortLldpLocalEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 149, 4, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
if mibBuilder.loadTexts: rlEeePortLldpLocalTxEcho.setDescription("Indicates the remote system's Transmit Tw_sys_tx that was used by the local system\n         to compute the Tw_sys_tx that it wants to request from the remote system, in micro-seconds")
...
if mibBuilder.loadTexts: rlEeePortLldpLocalRx.setDescription('Indicates the value of Tw_sys_tx that the local system requests from the remote system,\n         in micro-seconds')
...
if mibBuilder.loadTexts: rlEeePortLldpLocalRxEcho.setDescription('Indicates the remote system Receive Tw_sys_tx that was used by the local system\n         to compute the Tw_sys_tx that it can support, in micro-seconds')
rlEeePortLldpRemoteTable = MibTable((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 149, 5), ).setMaxAccess("notaccessible")
...
rlEeePortLldpRemoteEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 149, 5, 1), ).setMaxAccess("notaccessible").setIndexNames((0, "IF-MIB", "ifIndex"))
...
if mibBuilder.loadTexts: rlEeePortLldpRemoteRx.setDescription('Indicates the value of Tw_sys_tx that the remote system requests from the local system,\n         in micro-seconds')
