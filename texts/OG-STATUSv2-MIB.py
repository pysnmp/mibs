...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortEntry=ogSerialPortEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletTable=ogRpcOutletTable, ogEmdIndex=ogEmdIndex, ogWifiApTable=ogWifiApTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckIndex=ogCheckIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdEnabled=ogEmdEnabled, ogUpsTemperature=ogUpsTemperature, ogAlarmName=ogAlarmName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostPingNotification=ogHostPingNotification, ogWebUserName=ogWebUserName, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialUserTable=ogSerialUserTable, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemRegistered=ogCellModemRegistered, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioState=ogEmdDioState, ogRpcTable=ogRpcTable, ogEmdDioName=ogEmdDioName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemIndex=ogCellModemIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcType=ogRpcType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortStopBits=ogSerialPortStopBits, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostIndex=ogHostIndex, ogCellModemIMSI=ogCellModemIMSI, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarm=ogAlarm, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogFirmwareVersion=ogFirmwareVersion, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApFrequency=ogWifiApFrequency, ogUpsOutputPower=ogUpsOutputPower, ogHostServiceTable=ogHostServiceTable, ogCellModemTable=ogCellModemTable, ogRpcCounter=ogRpcCounter, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemCounter=ogCellModemCounter, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemVendor=ogCellModemVendor, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsEntry=ogUpsEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckType=ogCheckType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemConnected=ogCellModemConnected, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserEntry=ogWebUserEntry, ogCheckName=ogCheckName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserSourcePort=ogWebUserSourcePort, ogWebUserIndex=ogWebUserIndex, ogCellDataNotification=ogCellDataNotification, ogWifiClientApMac=ogWifiClientApMac, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceNotification=ogHostServiceNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostIpV6Address=ogHostIpV6Address, ogAlarmType=ogAlarmType, ogCheckTable=ogCheckTable, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioType=ogEmdDioType, ogWifiClientIndex=ogWifiClientIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdEntry=ogEmdEntry, ogSerialUserName=ogSerialUserName, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortTable=ogSerialPortTable, ogWifiApSsid=ogWifiApSsid, ogRpcEntry=ogRpcEntry, ogSerialNumber=ogSerialNumber, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletName=ogRpcOutletName, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsNotification=ogUpsNotification, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientEssid=ogWifiClientEssid, ogAlarmUser=ogAlarmUser, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserNotification=ogHostUserNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsState=ogUpsState, ogWifiApEnabled=ogWifiApEnabled, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServiceType=ogHostServiceType, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientInterface=ogWifiClientInterface, PYSNMP_MODULE_ID=ogStatus2, ogCustomNotification=ogCustomNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcName=ogRpcName, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcConnectType=ogRpcConnectType, ogSerialPortIndex=ogSerialPortIndex, ogCellModemApn=ogCellModemApn, ogEmdDioDirection=ogEmdDioDirection, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostUserName=ogHostUserName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioCounter=ogEmdDioCounter, ogHostServicePort=ogHostServicePort, ogEmdTable=ogEmdTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApClientTable=ogWifiApClientTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsHumidity=ogUpsHumidity, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserEntry=ogHostUserEntry, ogEmdDescription=ogEmdDescription, ogPowerSupplyName=ogPowerSupplyName, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserTable=ogHostUserTable, ogHostTable=ogHostTable, ogWifiApIndex=ogWifiApIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostIpV4Address=ogHostIpV4Address, ogUpsLogEnabled=ogUpsLogEnabled, ogNetInterfaceState=ogNetInterfaceState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortParity=ogSerialPortParity, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcInputNotification=ogRpcInputNotification, ogUpsTable=ogUpsTable, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserTable=ogWebUserTable, ogHostUserStartTime=ogHostUserStartTime, ogHostServiceHost=ogHostServiceHost, ogWifiApClientAp=ogWifiApClientAp, ogUpsConnectType=ogUpsConnectType, ogUpsInputNotification=ogUpsInputNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemModel=ogCellModemModel, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceIndex=ogHostServiceIndex, ogAlarmEventId=ogAlarmEventId, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioTable=ogEmdDioTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemTemperature=ogCellModemTemperature, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortDTR=ogSerialPortDTR, ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckDeviceName=ogCheckDeviceName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostUserHost=ogHostUserHost, ogHostName=ogHostName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmState=ogAlarmState, ogUpsCounter=ogUpsCounter, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmLogTable=ogAlarmLogTable, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemNetwork=ogCellModemNetwork)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletLoad=ogRpcOutletLoad, ogUpsName=ogUpsName, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortDCD=ogSerialPortDCD, ogEmdConnectType=ogEmdConnectType, ogEmdDioEmd=ogEmdDioEmd, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcIndex=ogRpcIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckEntry=ogCheckEntry, ogWifiApCounter=ogWifiApCounter, ogSerialPortDSR=ogSerialPortDSR, ogWifiApInterface=ogWifiApInterface, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdHumidityTable=ogEmdHumidityTable, ogCellTowerNotification=ogCellTowerNotification, ogCellModemTower=ogCellModemTower, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcDescription=ogRpcDescription, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogMibNotifications=ogMibNotifications, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientMac=ogWifiApClientMac, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortMode=ogSerialPortMode, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmCheck=ogAlarmCheck, ogHostUserIndex=ogHostUserIndex, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientTable=ogWifiClientTable, ogHostEntry=ogHostEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSystem=ogSystem, ogSerialUserPort=ogSerialUserPort, ogUpsIndex=ogUpsIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServiceCounter=ogHostServiceCounter, ogEmdName=ogEmdName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmSummary=ogAlarmSummary, ogRpcOutletIndex=ogRpcOutletIndex, ogStatus2Compliance=ogStatus2Compliance, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmInstance=ogAlarmInstance, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialUserLabel=ogSerialUserLabel, ogUpsType=ogUpsType, ogHostUserAddress=ogHostUserAddress, ogStatus2=ogStatus2, ogUpsDescription=ogUpsDescription, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientRssi=ogWifiApClientRssi, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmTime=ogAlarmTime, ogRpcOutletState=ogRpcOutletState)
