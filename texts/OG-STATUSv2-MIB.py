...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsConnectType=ogUpsConnectType, ogCheckIndex=ogCheckIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceCounter=ogHostServiceCounter, ogWebUserTable=ogWebUserTable, ogFirmwareVersion=ogFirmwareVersion, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientBitRate=ogWifiClientBitRate, ogHostIndex=ogHostIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsBatteryState=ogUpsBatteryState, ogCellModemModel=ogCellModemModel, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserIndex=ogSerialUserIndex, ogHostUserAddress=ogHostUserAddress, ogAlarmUser=ogAlarmUser, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceType=ogHostServiceType, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmType=ogAlarmType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostUserIndex=ogHostUserIndex, ogSerialPortParity=ogSerialPortParity, ogEmdIndex=ogEmdIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmEventId=ogAlarmEventId, ogRpcOutputNotification=ogRpcOutputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmName=ogAlarmName, ogSerialUserName=ogSerialUserName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialNumber=ogSerialNumber, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModemApn=ogCellModemApn, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserEntry=ogSerialUserEntry, ogWifiApIndex=ogWifiApIndex, ogRpcEntry=ogRpcEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostName=ogHostName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogMibNotifications=ogMibNotifications, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioName=ogEmdDioName, ogUpsTemperature=ogUpsTemperature, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdDioTable=ogEmdDioTable, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostUserStartTime=ogHostUserStartTime, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcName=ogRpcName, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckTriggerActions=ogCheckTriggerActions, ogCellTowerNotification=ogCellTowerNotification, ogCellModemConnected=ogCellModemConnected, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserIndex=ogWebUserIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortDCD=ogSerialPortDCD, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientEssid=ogWifiClientEssid, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioEmd=ogEmdDioEmd, ogEmdEnabled=ogEmdEnabled, ogCellModemIndex=ogCellModemIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortDTR=ogSerialPortDTR, ogHostUserTable=ogHostUserTable, ogHostUserHost=ogHostUserHost, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdName=ogEmdName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSystem=ogSystem, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostUserName=ogHostUserName, ogCheckType=ogCheckType, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceTable=ogHostServiceTable, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientCounter=ogWifiClientCounter, ogHostUserEntry=ogHostUserEntry, ogCellMessageNotification=ogCellMessageNotification, ogEmdDescription=ogEmdDescription, ogStatus2Compliances=ogStatus2Compliances, ogCellModemEntry=ogCellModemEntry, ogCheckEntry=ogCheckEntry, ogEmdEntry=ogEmdEntry, ogUpsEntry=ogUpsEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogStatus2Compliance=ogStatus2Compliance, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletName=ogRpcOutletName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialUserPort=ogSerialUserPort, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcIndex=ogRpcIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmInstance=ogAlarmInstance, ogCellModemCounter=ogCellModemCounter, ogWifiApInterface=ogWifiApInterface, ogSerialPortTable=ogSerialPortTable, ogWebUserName=ogWebUserName, ogHostUserHostName=ogHostUserHostName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientInterface=ogWifiClientInterface, ogUpsCounter=ogUpsCounter, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellApnNotification=ogCellApnNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogHostServiceNotification=ogHostServiceNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioCounter=ogEmdDioCounter, PYSNMP_MODULE_ID=ogStatus2, ogStatus2Groups=ogStatus2Groups, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortEntry=ogSerialPortEntry, ogEmdTable=ogEmdTable, ogWifiApEntry=ogWifiApEntry, ogCellModemEnabled=ogCellModemEnabled, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmName=ogCurrentAlarmName, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioType=ogEmdDioType, ogWebUserStartTime=ogWebUserStartTime, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortMode=ogSerialPortMode, ogUpsNotification=ogUpsNotification, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemNetwork=ogCellModemNetwork, ogNetInterfaceName=ogNetInterfaceName, ogCheckTable=ogCheckTable, ogWifiApFrequency=ogWifiApFrequency, ogUpsDescription=ogUpsDescription, ogWifiApTable=ogWifiApTable, ogRpcOutletTable=ogRpcOutletTable, ogRpcCounter=ogRpcCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortCTS=ogSerialPortCTS, ogAlarmTime=ogAlarmTime, ogPowerSupplyName=ogPowerSupplyName, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellSignalNotification=ogCellSignalNotification, ogHostServicePort=ogHostServicePort, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmLogTable=ogAlarmLogTable, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmState=ogAlarmState, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcDescription=ogRpcDescription, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarm=ogAlarm, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsIndex=ogUpsIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcTable=ogRpcTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsName=ogUpsName, ogWebUserNotification=ogWebUserNotification, ogCheckName=ogCheckName, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemTable=ogCellModemTable, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientMode=ogWifiClientMode, ogEmdHumidityName=ogEmdHumidityName, ogHostServiceStatus=ogHostServiceStatus, ogCellModem3gRssi=ogCellModem3gRssi, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletState=ogRpcOutletState, ogNetInterfaceType=ogNetInterfaceType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioDescription=ogEmdDioDescription, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemVendor=ogCellModemVendor, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApIeeeMode=ogWifiApIeeeMode)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientTable=ogWifiApClientTable, ogRpcType=ogRpcType, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostServiceEntry=ogHostServiceEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostPingNotification=ogHostPingNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortRTS=ogSerialPortRTS, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemIMSI=ogCellModemIMSI, ogUpsType=ogUpsType, ogHostEntry=ogHostEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientEntry=ogWifiApClientEntry, ogCustomNotification=ogCustomNotification, ogWebUserEntry=ogWebUserEntry, ogRpcInputNotification=ogRpcInputNotification, ogStatus2=ogStatus2, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsTable=ogUpsTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmCheck=ogAlarmCheck, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsState=ogUpsState, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcConnectType=ogRpcConnectType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioState=ogEmdDioState, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientMac=ogWifiApClientMac, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApEnabled=ogWifiApEnabled, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckDeviceName=ogCheckDeviceName, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdLogEnabled=ogEmdLogEnabled, ogHostTable=ogHostTable, ogCellModemTower=ogCellModemTower, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialUserTable=ogSerialUserTable, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmSummary=ogAlarmSummary, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmSummary=ogCurrentAlarmSummary)
