...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdEnabled=ogEmdEnabled, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortTable=ogSerialPortTable, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsInputCurrent=ogUpsInputCurrent, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortEntry=ogSerialPortEntry, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApFrequency=ogWifiApFrequency, ogHostUserEntry=ogHostUserEntry, ogWifiApTable=ogWifiApTable, ogCheckName=ogCheckName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsTemperature=ogUpsTemperature, ogUpsCounter=ogUpsCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcCounter=ogRpcCounter, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioDirection=ogEmdDioDirection, ogCheckEntry=ogCheckEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsTable=ogUpsTable, ogCustomNotification=ogCustomNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientMode=ogWifiClientMode, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmState=ogAlarmState, ogEmdDioDescription=ogEmdDioDescription, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceStatus=ogHostServiceStatus, ogEmdTable=ogEmdTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcIndex=ogRpcIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientTable=ogWifiClientTable, ogUpsConnectType=ogUpsConnectType, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsHumidity=ogUpsHumidity, ogWebUserEntry=ogWebUserEntry, ogCellModemIMSI=ogCellModemIMSI, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryState=ogUpsBatteryState, ogHostUserHost=ogHostUserHost, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemTemperature=ogCellModemTemperature, ogCellModemVendor=ogCellModemVendor, ogWifiApIndex=ogWifiApIndex, ogSerialPortParity=ogSerialPortParity, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputFrequency=ogUpsInputFrequency, ogWebUserStartTime=ogWebUserStartTime, ogEmdLogEnabled=ogEmdLogEnabled, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceHost=ogHostServiceHost, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortRTS=ogSerialPortRTS, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckIndex=ogCheckIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdIndex=ogEmdIndex, ogAlarmCheck=ogAlarmCheck, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogMibNotifications=ogMibNotifications, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCliUserSessionNotification=ogCliUserSessionNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortSpeed=ogSerialPortSpeed, ogHostIpV4Address=ogHostIpV4Address, ogAlarmTime=ogAlarmTime, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdEntry=ogEmdEntry, ogHostPingNotification=ogHostPingNotification, ogStatus2Compliances=ogStatus2Compliances, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioState=ogEmdDioState, ogWebUserTable=ogWebUserTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemTable=ogCellModemTable, ogCellModemIndex=ogCellModemIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdConnectType=ogEmdConnectType, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialUserLabel=ogSerialUserLabel, ogEmdName=ogEmdName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcDescription=ogRpcDescription, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemModel=ogCellModemModel, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSystem=ogSystem, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputLoad=ogUpsOutputLoad, ogFirmwareVersion=ogFirmwareVersion, PYSNMP_MODULE_ID=ogStatus2, ogCellModemTower=ogCellModemTower, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsIndex=ogUpsIndex, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletName=ogRpcOutletName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsEntry=ogUpsEntry, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmSummary=ogAlarmSummary, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientMac=ogWifiApClientMac, ogWifiApInterface=ogWifiApInterface, ogWifiApEntry=ogWifiApEntry, ogEmdDioType=ogEmdDioType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioName=ogEmdDioName, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmName=ogCurrentAlarmName, ogHostUserIndex=ogHostUserIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellDataNotification=ogCellDataNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckType=ogCheckType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserName=ogHostUserName, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientCounter=ogWifiClientCounter, ogSerialUserName=ogSerialUserName, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortDSR=ogSerialPortDSR, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcType=ogRpcType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDescription=ogEmdDescription, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmName=ogAlarmName, ogStatus2Groups=ogStatus2Groups, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceTable=ogHostServiceTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortLabel=ogSerialPortLabel, ogHostServiceType=ogHostServiceType, ogRpcOutletState=ogRpcOutletState, ogCellModemEnabled=ogCellModemEnabled, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialUserPort=ogSerialUserPort, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmLogIndex=ogAlarmLogIndex, ogHostEntry=ogHostEntry, ogCellModemRegistered=ogCellModemRegistered, ogCellModemEntry=ogCellModemEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcInputNotification=ogRpcInputNotification, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApEnabled=ogWifiApEnabled, ogHostUserNotification=ogHostUserNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsState=ogUpsState, ogHostTable=ogHostTable, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmPreviousValue=ogAlarmPreviousValue, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortIndex=ogSerialPortIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServicePort=ogHostServicePort, ogRpcTable=ogRpcTable, ogAlarmDevice=ogAlarmDevice, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialNumber=ogSerialNumber, ogAlarm=ogAlarm, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsType=ogUpsType, ogStatus2=ogStatus2, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientApMac=ogWifiClientApMac, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioTable=ogEmdDioTable, ogHostUserTable=ogHostUserTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioEntry=ogEmdDioEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckTable=ogCheckTable, ogEmdDioEmd=ogEmdDioEmd, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellTowerNotification=ogCellTowerNotification, ogWebUserName=ogWebUserName, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsNotification=ogUpsNotification, ogCellModemNetwork=ogCellModemNetwork, ogUpsName=ogUpsName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemConnected=ogCellModemConnected, ogRpcName=ogRpcName, ogWebUserIndex=ogWebUserIndex, ogSerialPortMode=ogSerialPortMode, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostName=ogHostName, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmType=ogAlarmType, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmUser=ogAlarmUser, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcEntry=ogRpcEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityName=ogEmdHumidityName, ogRpcInputVoltage=ogRpcInputVoltage, ogCellApnNotification=ogCellApnNotification, ogAlarmInstance=ogAlarmInstance, ogUpsDescription=ogUpsDescription, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostIndex=ogHostIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsInputNotification=ogUpsInputNotification, ogHostServiceEntry=ogHostServiceEntry, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemApn=ogCellModemApn, ogWifiApSsid=ogWifiApSsid, ogWebUserNotification=ogWebUserNotification, ogHostUserAddress=ogHostUserAddress, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmIndex=ogCurrentAlarmIndex)
