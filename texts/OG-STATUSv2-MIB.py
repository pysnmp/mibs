...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceState=ogNetInterfaceState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmState=ogAlarmState, PYSNMP_MODULE_ID=ogStatus2, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioName=ogEmdDioName, ogUpsBatteryState=ogUpsBatteryState, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcCounter=ogRpcCounter, ogHostUserAddress=ogHostUserAddress, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientEssid=ogWifiClientEssid, ogCheckIndex=ogCheckIndex, ogCheckName=ogCheckName, ogSerialUserStartTime=ogSerialUserStartTime, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostEntry=ogHostEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcOutletName=ogRpcOutletName, ogUpsDescription=ogUpsDescription, ogHostServiceHost=ogHostServiceHost, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioDescription=ogEmdDioDescription, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsCounter=ogUpsCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemModel=ogCellModemModel, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserName=ogWebUserName, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckResetTimeout=ogCheckResetTimeout, ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemIMSI=ogCellModemIMSI, ogHostUserEntry=ogHostUserEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckEntry=ogCheckEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletLoad=ogRpcOutletLoad, ogCustomNotification=ogCustomNotification, ogCellModemTower=ogCellModemTower, ogAlarm=ogAlarm, ogEmdDioEmd=ogEmdDioEmd, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioCounter=ogEmdDioCounter, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioIndex=ogEmdDioIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckTable=ogCheckTable, ogWebUserEntry=ogWebUserEntry, ogEmdDioType=ogEmdDioType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserIndex=ogWebUserIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcIndex=ogRpcIndex, ogAlarmEventId=ogAlarmEventId, ogHostServiceCounter=ogHostServiceCounter, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmInstance=ogAlarmInstance, ogRpcEntry=ogRpcEntry, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortParity=ogSerialPortParity, ogAlarmLogTable=ogAlarmLogTable, ogRpcConnectType=ogRpcConnectType, ogEmdDioDirection=ogEmdDioDirection, ogWifiApEnabled=ogWifiApEnabled, ogUpsHumidity=ogUpsHumidity, ogRpcOutletRpc=ogRpcOutletRpc, ogHostServicePort=ogHostServicePort, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortDSR=ogSerialPortDSR, ogUpsTable=ogUpsTable, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckType=ogCheckType, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmUser=ogAlarmUser, ogEmdEntry=ogEmdEntry, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientMode=ogWifiClientMode, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcTable=ogRpcTable, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApTable=ogWifiApTable, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientMac=ogWifiApClientMac, ogEmdConnectType=ogEmdConnectType, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdDioTable=ogEmdDioTable, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemCounter=ogCellModemCounter, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmDevice=ogAlarmDevice, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialUserLabel=ogSerialUserLabel, ogUpsInputFrequency=ogUpsInputFrequency, ogStatus2Groups=ogStatus2Groups, ogCellModemApn=ogCellModemApn, ogHostUserNotification=ogHostUserNotification, ogCellModemRegistered=ogCellModemRegistered, ogSerialSignalNotification=ogSerialSignalNotification, ogSystem=ogSystem, ogSerialUserTable=ogSerialUserTable, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemConnected=ogCellModemConnected, ogUpsName=ogUpsName, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcName=ogRpcName, ogEmdDioState=ogEmdDioState, ogHostTable=ogHostTable, ogRpcOutletEntry=ogRpcOutletEntry, ogMibNotifications=ogMibNotifications, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApEntry=ogWifiApEntry, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemNetwork=ogCellModemNetwork, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdIndex=ogEmdIndex, ogEmdDioNotification=ogEmdDioNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsType=ogUpsType, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletTable=ogRpcOutletTable, ogFirmwareVersion=ogFirmwareVersion, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceNotification=ogHostServiceNotification, ogHostUserName=ogHostUserName, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsNotification=ogUpsNotification, ogEmdDescription=ogEmdDescription, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsState=ogUpsState, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialUserNotification=ogSerialUserNotification, ogStatus2=ogStatus2, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceStatus=ogHostServiceStatus, ogSerialUserEntry=ogSerialUserEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTable=ogEmdTable, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellDataNotification=ogCellDataNotification, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceTable=ogHostServiceTable, ogSerialUserPort=ogSerialUserPort, ogSerialNumber=ogSerialNumber, ogUpsEntry=ogUpsEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogHostServiceType=ogHostServiceType, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcType=ogRpcType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserHostName=ogHostUserHostName, ogAlarmTime=ogAlarmTime, ogUpsTemperature=ogUpsTemperature, ogRpcInputNotification=ogRpcInputNotification, ogAlarmCheck=ogAlarmCheck, ogWifiClientApMac=ogWifiClientApMac, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostName=ogHostName, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsIndex=ogUpsIndex, ogSerialPortIndex=ogSerialPortIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceType=ogNetInterfaceType, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApCounter=ogWifiApCounter, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRssi=ogWifiClientRssi, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletNotification=ogRpcOutletNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletState=ogRpcOutletState, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdEnabled=ogEmdEnabled, ogUpsConnectType=ogUpsConnectType, ogRpcOutletTotal=ogRpcOutletTotal, ogCellMessageNotification=ogCellMessageNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmState=ogCurrentAlarmState, ogHostUserHost=ogHostUserHost, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortRTS=ogSerialPortRTS, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckDeviceName=ogCheckDeviceName, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemTable=ogCellModemTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureName=ogEmdTemperatureName, ogStatus2Compliances=ogStatus2Compliances, ogHostServiceIndex=ogHostServiceIndex, ogSerialUserIndex=ogSerialUserIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserTable=ogHostUserTable, ogRpcDescription=ogRpcDescription, ogAlarmType=ogAlarmType, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientTable=ogWifiApClientTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmName=ogAlarmName, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmSummary=ogAlarmSummary, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortDTR=ogSerialPortDTR, ogHostIndex=ogHostIndex, ogWebUserNotification=ogWebUserNotification, ogWifiApIndex=ogWifiApIndex, ogWifiClientIndex=ogWifiClientIndex, ogEmdName=ogEmdName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialUserName=ogSerialUserName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemIndex=ogCellModemIndex)
