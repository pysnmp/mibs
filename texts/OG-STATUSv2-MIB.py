...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmTime=ogAlarmTime, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceNotification=ogHostServiceNotification, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioType=ogEmdDioType, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceName=ogCheckDeviceName, ogRpcInputVoltage=ogRpcInputVoltage, ogNetInterfaceState=ogNetInterfaceState, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostIpV4Address=ogHostIpV4Address, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserName=ogWebUserName, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSystem=ogSystem, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserEntry=ogHostUserEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApTable=ogWifiApTable, ogUpsType=ogUpsType, ogEmdDioEmd=ogEmdDioEmd, ogCheckType=ogCheckType, ogEmdIndex=ogEmdIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWebUserIndex=ogWebUserIndex, ogHostUserHost=ogHostUserHost, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientEntry=ogWifiClientEntry, ogHostUserName=ogHostUserName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsHumidity=ogUpsHumidity, ogSerialPatternNotification=ogSerialPatternNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioCounter=ogEmdDioCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcIndex=ogRpcIndex, ogAlarmUser=ogAlarmUser, ogHostServiceCounter=ogHostServiceCounter, ogAlarmName=ogAlarmName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialUserName=ogSerialUserName, ogAlarmType=ogAlarmType, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortLabel=ogSerialPortLabel, ogWifiApIndex=ogWifiApIndex, ogAlarmLogTable=ogAlarmLogTable, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputNotification=ogUpsInputNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialUserTable=ogSerialUserTable, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsEntry=ogUpsEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortStopBits=ogSerialPortStopBits, ogHostTable=ogHostTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioState=ogEmdDioState, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortIndex=ogSerialPortIndex, ogCellModemEntry=ogCellModemEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemCounter=ogCellModemCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientEntry=ogWifiApClientEntry, PYSNMP_MODULE_ID=ogStatus2, ogEmdEntry=ogEmdEntry, ogStatus2Groups=ogStatus2Groups, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceType=ogHostServiceType, ogHostEntry=ogHostEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceStatus=ogHostServiceStatus, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemEnabled=ogCellModemEnabled, ogEmdName=ogEmdName, ogSerialUserLabel=ogSerialUserLabel, ogWifiApEnabled=ogWifiApEnabled, ogWifiApInterface=ogWifiApInterface, ogNetInterfaceName=ogNetInterfaceName, ogAlarmDevice=ogAlarmDevice, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortTable=ogSerialPortTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcTable=ogRpcTable, ogWebUserEntry=ogWebUserEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdEnabled=ogEmdEnabled, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemApn=ogCellModemApn, ogCheckIndex=ogCheckIndex, ogRpcName=ogRpcName, ogUpsState=ogUpsState, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortRTS=ogSerialPortRTS, ogHostPingNotification=ogHostPingNotification, ogStatus2=ogStatus2, ogNetInterfaceType=ogNetInterfaceType, ogCheckResetTimeout=ogCheckResetTimeout, ogCellTowerNotification=ogCellTowerNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostIndex=ogHostIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioDescription=ogEmdDioDescription, ogUpsNotification=ogUpsNotification, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellApnNotification=ogCellApnNotification, ogEmdDioIndex=ogEmdDioIndex, ogCellModemTower=ogCellModemTower, ogSerialUserPort=ogSerialUserPort, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemIMSI=ogCellModemIMSI, ogAlarmSummary=ogAlarmSummary, ogSerialNumber=ogSerialNumber, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcCounter=ogRpcCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioName=ogEmdDioName, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckTable=ogCheckTable, ogHostServicePort=ogHostServicePort, ogRpcEntry=ogRpcEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortParity=ogSerialPortParity, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemVendor=ogCellModemVendor, ogAlarmEventId=ogAlarmEventId, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostName=ogHostName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmState=ogAlarmState, ogCheckEntry=ogCheckEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientMode=ogWifiClientMode, ogWebUserStartTime=ogWebUserStartTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserAddress=ogHostUserAddress, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialUserEntry=ogSerialUserEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortDSR=ogSerialPortDSR, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemTable=ogCellModemTable, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckTriggerActions=ogCheckTriggerActions, ogStatus2Compliance=ogStatus2Compliance, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioDirection=ogEmdDioDirection, ogUpsCounter=ogUpsCounter, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellDataNotification=ogCellDataNotification, ogWifiApTxPower=ogWifiApTxPower, ogHostUserNotification=ogHostUserNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcInputFrequency=ogRpcInputFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientApMac=ogWifiClientApMac, ogMibNotifications=ogMibNotifications, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryNotification=ogUpsBatteryNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsTable=ogUpsTable, ogWifiApSsid=ogWifiApSsid, ogAlarm=ogAlarm, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsConnectType=ogUpsConnectType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsIndex=ogUpsIndex, ogCellModemConnected=ogCellModemConnected, ogAlarmCheck=ogAlarmCheck, ogCustomNotification=ogCustomNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogHostUserIndex=ogHostUserIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApClientAp=ogWifiApClientAp)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmInstance=ogAlarmInstance, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemRegistered=ogCellModemRegistered, ogHostServiceTable=ogHostServiceTable, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioEntry=ogEmdDioEntry, ogEmdDescription=ogEmdDescription, ogSerialUserNotification=ogSerialUserNotification, ogCellModemModel=ogCellModemModel, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserStartTime=ogHostUserStartTime, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsTemperature=ogUpsTemperature, ogWifiApEntry=ogWifiApEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWebUserTable=ogWebUserTable, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcDescription=ogRpcDescription, ogCheckName=ogCheckName, ogSerialPortMode=ogSerialPortMode, ogUpsName=ogUpsName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsBatteryState=ogUpsBatteryState, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcType=ogRpcType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogFirmwareVersion=ogFirmwareVersion, ogUpsDescription=ogUpsDescription, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletName=ogRpcOutletName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdTable=ogEmdTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostUserTable=ogHostUserTable, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientTable=ogWifiClientTable, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceHost=ogHostServiceHost, ogWifiClientEssid=ogWifiClientEssid)
