...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletFrequency=ogRpcOutletFrequency, ogPowerSupplyName=ogPowerSupplyName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdEntry=ogEmdEntry, ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemTable=ogCellModemTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsLogEnabled=ogUpsLogEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsDescription=ogUpsDescription, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemIMSI=ogCellModemIMSI, ogRpcConnectType=ogRpcConnectType, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceRef=ogCheckDeviceRef, ogStatus2=ogStatus2, ogAlarm=ogAlarm, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemTower=ogCellModemTower, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSystem=ogSystem, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApInterface=ogWifiApInterface, ogSerialPortParity=ogSerialPortParity, ogSerialPortCTS=ogSerialPortCTS, ogCellModemEnabled=ogCellModemEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellModemIndex=ogCellModemIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioState=ogEmdDioState, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmTime=ogAlarmTime, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogNetInterfaceState=ogNetInterfaceState, ogCellModemModel=ogCellModemModel, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApTxPower=ogWifiApTxPower, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioEmd=ogEmdDioEmd, ogWebUserNotification=ogWebUserNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogHostEntry=ogHostEntry, ogRpcName=ogRpcName, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemTemperature=ogCellModemTemperature, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletName=ogRpcOutletName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientEssid=ogWifiClientEssid, ogStatus2Groups=ogStatus2Groups, ogUpsCounter=ogUpsCounter, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortTable=ogSerialPortTable, ogHostServiceNotification=ogHostServiceNotification, ogEmdIndex=ogEmdIndex, ogUpsIndex=ogUpsIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcDescription=ogRpcDescription, ogCheckType=ogCheckType, ogCellModemConnected=ogCellModemConnected, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcType=ogRpcType, ogRpcEntry=ogRpcEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostServiceIndex=ogHostServiceIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmUser=ogAlarmUser, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsType=ogUpsType, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortDCD=ogSerialPortDCD, ogEmdName=ogEmdName, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserPort=ogSerialUserPort, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApCounter=ogWifiApCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostServicePort=ogHostServicePort, ogWifiApSsid=ogWifiApSsid, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmLogTable=ogAlarmLogTable, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApEntry=ogWifiApEntry, ogUpsTable=ogUpsTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsEntry=ogUpsEntry, ogHostUserIndex=ogHostUserIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientRssi=ogWifiClientRssi, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortDSR=ogSerialPortDSR, ogHostUserTable=ogHostUserTable, ogAlarmName=ogAlarmName, ogRpcCounter=ogRpcCounter, ogCellModemEntry=ogCellModemEntry, ogEmdDioDirection=ogEmdDioDirection, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientAp=ogWifiApClientAp, ogRpcIndex=ogRpcIndex, ogHostUserName=ogHostUserName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientCounter=ogWifiClientCounter, ogAlarmCheck=ogAlarmCheck, ogCellModemNetwork=ogCellModemNetwork, ogHostUserHost=ogHostUserHost, ogHostUserHostName=ogHostUserHostName, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientIndex=ogWifiClientIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialUserEntry=ogSerialUserEntry, ogUpsName=ogUpsName, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostServiceTable=ogHostServiceTable, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryState=ogUpsBatteryState, ogCheckIndex=ogCheckIndex, ogRpcOutletTable=ogRpcOutletTable, ogWebUserName=ogWebUserName, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemApn=ogCellModemApn, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmState=ogAlarmState, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioTable=ogEmdDioTable, ogWifiApClientMac=ogWifiApClientMac, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogHostIndex=ogHostIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmType=ogAlarmType, ogHostServiceEntry=ogHostServiceEntry, ogWifiApIndex=ogWifiApIndex, ogHostPingNotification=ogHostPingNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialUserNotification=ogSerialUserNotification, ogCheckName=ogCheckName, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServiceStatus=ogHostServiceStatus, ogCellModemCounter=ogCellModemCounter, ogHostServiceType=ogHostServiceType, ogWifiApTable=ogWifiApTable, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsHumidity=ogUpsHumidity, ogHostUserEntry=ogHostUserEntry, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckTable=ogCheckTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostName=ogHostName, ogEmdConnectType=ogEmdConnectType, ogRpcTable=ogRpcTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogFirmwareVersion=ogFirmwareVersion, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceName=ogNetInterfaceName, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletState=ogRpcOutletState, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialNumber=ogSerialNumber, ogCustomNotification=ogCustomNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostUserNotification=ogHostUserNotification, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientMode=ogWifiClientMode, ogCheckResolveActions=ogCheckResolveActions, ogAlarmInstance=ogAlarmInstance, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientTable=ogWifiClientTable, ogWifiApEnabled=ogWifiApEnabled, ogEmdDescription=ogEmdDescription, ogStatus2Conformance=ogStatus2Conformance, ogCellModemVendor=ogCellModemVendor, ogWebUserEntry=ogWebUserEntry, ogEmdDioType=ogEmdDioType, ogSerialPortDTR=ogSerialPortDTR, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellDataNotification=ogCellDataNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogMibNotifications=ogMibNotifications, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserTable=ogWebUserTable, ogHostUserStartTime=ogHostUserStartTime, ogHostUserAddress=ogHostUserAddress, ogEmdDioEntry=ogEmdDioEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDioIndex=ogEmdDioIndex, ogCheckEntry=ogCheckEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioName=ogEmdDioName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostServiceHost=ogHostServiceHost, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsTemperature=ogUpsTemperature, ogSerialPortMode=ogSerialPortMode, ogHostTable=ogHostTable, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemRegistered=ogCellModemRegistered, ogUpsConnectType=ogUpsConnectType, ogStatus2Compliances=ogStatus2Compliances, ogCellApnNotification=ogCellApnNotification, ogWebUserIndex=ogWebUserIndex, ogSerialUserName=ogSerialUserName, ogUpsState=ogUpsState, ogRpcInputNotification=ogRpcInputNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogHostIpV4Address=ogHostIpV4Address, ogEmdTable=ogEmdTable, ogUpsNotification=ogUpsNotification, ogEmdEnabled=ogEmdEnabled, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon)
