...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcInputCurrent=ogRpcInputCurrent, ogWebUserName=ogWebUserName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcConnectType=ogRpcConnectType, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApTxPower=ogWifiApTxPower, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientCounter=ogWifiClientCounter, ogCheckIndex=ogCheckIndex, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemEntry=ogCellModemEntry, ogUpsTemperature=ogUpsTemperature, ogUpsBatteryState=ogUpsBatteryState, ogCellModemConnected=ogCellModemConnected, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserName=ogHostUserName, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceIndex=ogHostServiceIndex, ogUpsCounter=ogUpsCounter, ogHostUserStartTime=ogHostUserStartTime, ogHostIpV6Address=ogHostIpV6Address, ogSerialUserLabel=ogSerialUserLabel, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputPower=ogUpsOutputPower, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogStatus2Compliance=ogStatus2Compliance, ogRpcName=ogRpcName, ogEmdConnectType=ogEmdConnectType, ogEmdDioNotification=ogEmdDioNotification, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsEntry=ogUpsEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyName=ogPowerSupplyName, ogCheckEntry=ogCheckEntry, ogEmdDescription=ogEmdDescription, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemApn=ogCellModemApn, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserEntry=ogSerialUserEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserTable=ogSerialUserTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsConnectType=ogUpsConnectType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckType=ogCheckType, ogHostName=ogHostName, ogWebUserNotification=ogWebUserNotification, ogSerialPortCTS=ogSerialPortCTS, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcIndex=ogRpcIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioCounter=ogEmdDioCounter, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortDTR=ogSerialPortDTR, ogStatus2Groups=ogStatus2Groups, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortTable=ogSerialPortTable, ogWebUserIndex=ogWebUserIndex, ogWifiApIndex=ogWifiApIndex, ogUpsIndex=ogUpsIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmType=ogAlarmType, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialNumber=ogSerialNumber, ogHostServiceType=ogHostServiceType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortEntry=ogSerialPortEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletName=ogRpcOutletName, ogEmdName=ogEmdName, ogEmdEntry=ogEmdEntry, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioEntry=ogEmdDioEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsName=ogUpsName, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioType=ogEmdDioType, ogWifiApEntry=ogWifiApEntry, ogEmdDioDescription=ogEmdDioDescription, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsTable=ogUpsTable, ogRpcOutletState=ogRpcOutletState, ogCellModemCounter=ogCellModemCounter, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmInstance=ogAlarmInstance, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostUserHost=ogHostUserHost, ogCellApnNotification=ogCellApnNotification, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApCounter=ogWifiApCounter, ogWebUserStartTime=ogWebUserStartTime, ogCellModemIndex=ogCellModemIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientMode=ogWifiClientMode, ogRpcDescription=ogRpcDescription, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientIndex=ogWifiClientIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogCellNetworkNotification=ogCellNetworkNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApFrequency=ogWifiApFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientAp=ogWifiApClientAp, ogAlarmEventId=ogAlarmEventId, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmState=ogAlarmState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostTable=ogHostTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceCounter=ogHostServiceCounter, ogAlarmCheck=ogAlarmCheck, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemTower=ogCellModemTower, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCustomNotification=ogCustomNotification, ogEmdDioIndex=ogEmdDioIndex, ogHostUserEntry=ogHostUserEntry, ogWifiApInterface=ogWifiApInterface, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostServicePort=ogHostServicePort, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserNotification=ogHostUserNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarm=ogAlarm, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckTable=ogCheckTable, ogHostIpV4Address=ogHostIpV4Address, ogCellDataNotification=ogCellDataNotification, ogCellMessageNotification=ogCellMessageNotification, ogMibNotifications=ogMibNotifications, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortParity=ogSerialPortParity, ogRpcEntry=ogRpcEntry, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletTable=ogRpcOutletTable, ogWifiApTable=ogWifiApTable, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemIMSI=ogCellModemIMSI, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortLabel=ogSerialPortLabel, ogWifiApEnabled=ogWifiApEnabled, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckResolveActions=ogCheckResolveActions, ogAlarmUser=ogAlarmUser, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellTowerNotification=ogCellTowerNotification, ogUpsDescription=ogUpsDescription, ogEmdTable=ogEmdTable, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemVendor=ogCellModemVendor, ogEmdTemperatureValue=ogEmdTemperatureValue, ogStatus2Compliances=ogStatus2Compliances, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsType=ogUpsType, ogEmdDioState=ogEmdDioState, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsNotification=ogUpsNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmDevice=ogAlarmDevice, ogCellModemModel=ogCellModemModel, ogSerialUserPort=ogSerialUserPort, ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceStatus=ogHostServiceStatus, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortLogLevel=ogSerialPortLogLevel, ogNetInterfaceState=ogNetInterfaceState, ogCheckName=ogCheckName, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortMode=ogSerialPortMode, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityName=ogEmdHumidityName, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioName=ogEmdDioName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientApMac=ogWifiClientApMac, ogRpcMaxTemperature=ogRpcMaxTemperature)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortDSR=ogSerialPortDSR, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmTime=ogAlarmTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApSsid=ogWifiApSsid, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserIndex=ogHostUserIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogFirmwareVersion=ogFirmwareVersion, ogEmdIndex=ogEmdIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostIndex=ogHostIndex, ogSerialUserName=ogSerialUserName, ogRpcCounter=ogRpcCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsState=ogUpsState, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarmName=ogAlarmName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostEntry=ogHostEntry, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmCheck=ogCurrentAlarmCheck, PYSNMP_MODULE_ID=ogStatus2, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceEntry=ogHostServiceEntry, ogRpcTable=ogRpcTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemTable=ogCellModemTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserTable=ogHostUserTable, ogRpcType=ogRpcType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogStatus2=ogStatus2, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdTemperatureName=ogEmdTemperatureName, ogHostServiceTable=ogHostServiceTable, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioTable=ogEmdDioTable, ogSystem=ogSystem, ogEmdEnabled=ogEmdEnabled, ogHostPingNotification=ogHostPingNotification, ogHostServiceHost=ogHostServiceHost, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWebUserEntry=ogWebUserEntry, ogAlarmSummary=ogAlarmSummary, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors)
