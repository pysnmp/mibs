...
Integer32, Counter64, Unsigned32, Bits, ModuleIdentity, iso, ObjectIdentity, NotificationType, Counter32, Gauge32, IpAddress, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "Unsigned32", "Bits", "ModuleIdentity", "iso", "ObjectIdentity", "NotificationType", "Counter32", "Gauge32", "IpAddress", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdTable=ogEmdTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsNotification=ogUpsNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortLabel=ogSerialPortLabel, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryState=ogUpsBatteryState, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioTable=ogEmdDioTable, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityEntry=ogEmdHumidityEntry, ogNetInterfaceName=ogNetInterfaceName, ogAlarmLogTable=ogAlarmLogTable, ogUpsHumidity=ogUpsHumidity, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApEntry=ogWifiApEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientMode=ogWifiClientMode, ogAlarmEventId=ogAlarmEventId, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdName=ogEmdName, ogWifiClientTable=ogWifiClientTable, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostName=ogHostName, ogSerialPortDSR=ogSerialPortDSR, ogHostUserTable=ogHostUserTable, ogCheckDeviceName=ogCheckDeviceName, ogEmdDescription=ogEmdDescription, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcEntry=ogRpcEntry, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientApMac=ogWifiClientApMac, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortParity=ogSerialPortParity, ogRpcOutletNotification=ogRpcOutletNotification, ogCellDataNotification=ogCellDataNotification, ogWebUserTable=ogWebUserTable, ogHostServicePort=ogHostServicePort, ogRpcName=ogRpcName, ogCellModemTemperature=ogCellModemTemperature, ogAlarmType=ogAlarmType, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemConnected=ogCellModemConnected, ogCellTowerNotification=ogCellTowerNotification, ogHostIpV6Address=ogHostIpV6Address, ogCheckName=ogCheckName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostUserNotification=ogHostUserNotification, ogCellModemApn=ogCellModemApn, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsName=ogUpsName, ogAlarmTime=ogAlarmTime, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserPort=ogSerialUserPort, ogHostUserAddress=ogHostUserAddress, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcIndex=ogRpcIndex, ogWifiApTable=ogWifiApTable, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemVendor=ogCellModemVendor, ogCellApnNotification=ogCellApnNotification, ogCheckEntry=ogCheckEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApCounter=ogWifiApCounter, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostEntry=ogHostEntry, ogUpsDescription=ogUpsDescription, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientEntry=ogWifiApClientEntry, ogHostIndex=ogHostIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceStatus=ogHostServiceStatus, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserIndex=ogWebUserIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioCounter=ogEmdDioCounter, ogWebUserName=ogWebUserName, ogAlarmUser=ogAlarmUser, ogNetInterfaceNotification=ogNetInterfaceNotification, ogMibNotifications=ogMibNotifications, ogCellModemEntry=ogCellModemEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialUserName=ogSerialUserName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApFrequency=ogWifiApFrequency, ogWifiApInterface=ogWifiApInterface, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletName=ogRpcOutletName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApIndex=ogWifiApIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputNotification=ogUpsInputNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioName=ogEmdDioName, ogEmdEntry=ogEmdEntry, ogEmdIndex=ogEmdIndex, ogWebUserEntry=ogWebUserEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioIndex=ogEmdDioIndex, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortRTS=ogSerialPortRTS, ogCellModemModel=ogCellModemModel, ogUpsTable=ogUpsTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogStatus2=ogStatus2, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortDCD=ogSerialPortDCD, ogWebUserNotification=ogWebUserNotification, ogEmdDioNotification=ogEmdDioNotification, ogUpsIndex=ogUpsIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmState=ogCurrentAlarmState, PYSNMP_MODULE_ID=ogStatus2, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogStatus2Compliances=ogStatus2Compliances, ogHostServiceTable=ogHostServiceTable, ogUpsType=ogUpsType, ogHostUserIndex=ogHostUserIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientCounter=ogWifiClientCounter, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputPower=ogUpsOutputPower, ogCellModemCounter=ogCellModemCounter, ogSerialPortMode=ogSerialPortMode, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortTable=ogSerialPortTable, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcCounter=ogRpcCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcTable=ogRpcTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserName=ogHostUserName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserEntry=ogHostUserEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarm=ogAlarm, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientEntry=ogWifiClientEntry, ogPowerSupplyName=ogPowerSupplyName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckIndex=ogCheckIndex, ogCellMessageNotification=ogCellMessageNotification, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserTable=ogSerialUserTable, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdConnectType=ogEmdConnectType, ogCellModem4gRssi=ogCellModem4gRssi, ogWebUserStartTime=ogWebUserStartTime, ogCellModemIndex=ogCellModemIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioType=ogEmdDioType, ogAlarmCheck=ogAlarmCheck, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientAp=ogWifiApClientAp, ogHostPingNotification=ogHostPingNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsTemperature=ogUpsTemperature, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialNumber=ogSerialNumber, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortDTR=ogSerialPortDTR, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceIndex=ogHostServiceIndex, ogWifiApSsid=ogWifiApSsid, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletState=ogRpcOutletState, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostServiceCounter=ogHostServiceCounter, ogEmdTemperatureTable=ogEmdTemperatureTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcConnectType=ogRpcConnectType, ogCustomNotification=ogCustomNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioInputTotal=ogEmdDioInputTotal, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcType=ogRpcType, ogStatus2Conformance=ogStatus2Conformance, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcDescription=ogRpcDescription, ogHostUserStartTime=ogHostUserStartTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsCounter=ogUpsCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserNotification=ogSerialUserNotification, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortEntry=ogSerialPortEntry, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSystem=ogSystem, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortCTS=ogSerialPortCTS, ogCellModemTower=ogCellModemTower, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckType=ogCheckType, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemTable=ogCellModemTable, ogAlarmSummary=ogAlarmSummary, ogWifiApAuthNotification=ogWifiApAuthNotification, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmName=ogAlarmName, ogEmdDioState=ogEmdDioState, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsState=ogUpsState, ogHostServiceType=ogHostServiceType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioDescription=ogEmdDioDescription, ogCheckTable=ogCheckTable, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceHost=ogHostServiceHost, ogUpsEntry=ogUpsEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmLogEntry=ogAlarmLogEntry, ogHostTable=ogHostTable, ogHostUserHost=ogHostUserHost, ogEmdEnabled=ogEmdEnabled, ogNetInterfaceType=ogNetInterfaceType, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientEssid=ogWifiClientEssid, ogAlarmState=ogAlarmState)
