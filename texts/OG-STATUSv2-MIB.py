...
Bits, MibIdentifier, Counter64, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, IpAddress, ObjectIdentity, Counter32, Unsigned32, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "Counter64", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "IpAddress", "ObjectIdentity", "Counter32", "Unsigned32", "NotificationType", "ModuleIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmName=ogAlarmName, ogRpcIndex=ogRpcIndex, ogSerialPortDTR=ogSerialPortDTR, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServiceType=ogHostServiceType, ogStatus2Conformance=ogStatus2Conformance, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApEntry=ogWifiApEntry, ogUpsIndex=ogUpsIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletTable=ogRpcOutletTable, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserName=ogHostUserName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientTable=ogWifiApClientTable, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserTable=ogHostUserTable, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioName=ogEmdDioName, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemApn=ogCellModemApn, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdEntry=ogEmdEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientInterface=ogWifiClientInterface, ogAlarmEventId=ogAlarmEventId, ogEmdDioTable=ogEmdDioTable, ogSerialPortMode=ogSerialPortMode, ogUpsCounter=ogUpsCounter, ogCellSignalNotification=ogCellSignalNotification, ogHostUserHostName=ogHostUserHostName, ogHostUserNotification=ogHostUserNotification, ogCellMessageNotification=ogCellMessageNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemModel=ogCellModemModel, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioIndex=ogEmdDioIndex, ogAlarmCheck=ogAlarmCheck, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcDescription=ogRpcDescription, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostEntry=ogHostEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientIndex=ogWifiClientIndex, ogCellModemCounter=ogCellModemCounter, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletEntry=ogRpcOutletEntry, ogNetInterfaceState=ogNetInterfaceState, ogUpsName=ogUpsName, ogWifiClientFrequency=ogWifiClientFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserTable=ogWebUserTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialUserPort=ogSerialUserPort, ogAlarmInstance=ogAlarmInstance, ogAlarmType=ogAlarmType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityName=ogEmdHumidityName, ogEmdName=ogEmdName, ogRpcOutletName=ogRpcOutletName, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcTable=ogRpcTable, ogWifiApCounter=ogWifiApCounter, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogStatus2Groups=ogStatus2Groups, ogEmdIndex=ogEmdIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmLogTable=ogAlarmLogTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWebUserNotification=ogWebUserNotification, ogCustomNotification=ogCustomNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmTime=ogAlarmTime, ogRpcCounter=ogRpcCounter, ogStatus2=ogStatus2, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceType=ogNetInterfaceType, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcName=ogRpcName, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckTable=ogCheckTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWebUserStartTime=ogWebUserStartTime, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogCellDataNotification=ogCellDataNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsInputVoltage=ogUpsInputVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDescription=ogEmdDescription, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSystem=ogSystem, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsBatteryState=ogUpsBatteryState, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsNotification=ogUpsNotification, ogRpcOutletState=ogRpcOutletState, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsTemperature=ogUpsTemperature, ogHostServicePort=ogHostServicePort, ogWifiApClientIndex=ogWifiApClientIndex, ogHostUserIndex=ogHostUserIndex, ogAlarmSummary=ogAlarmSummary, ogEmdDioNotification=ogEmdDioNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmDevice=ogAlarmDevice, ogRpcInputNotification=ogRpcInputNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceCounter=ogHostServiceCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckEntry=ogCheckEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsConnectType=ogUpsConnectType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApSsid=ogWifiApSsid, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientRssi=ogWifiClientRssi, ogCellModemNetwork=ogCellModemNetwork, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientMode=ogWifiClientMode, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioState=ogEmdDioState, ogSerialPortTable=ogSerialPortTable, ogWifiApTable=ogWifiApTable, ogHostServiceHost=ogHostServiceHost, ogCellModemConnected=ogCellModemConnected, ogCellModemIndex=ogCellModemIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortEntry=ogSerialPortEntry, ogCheckIndex=ogCheckIndex, ogEmdDioEntry=ogEmdDioEntry, ogCheckName=ogCheckName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostTable=ogHostTable, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmUser=ogAlarmUser, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarm=ogAlarm, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcConnectType=ogRpcConnectType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialNumber=ogSerialNumber, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemRegistered=ogCellModemRegistered, ogWifiApInterface=ogWifiApInterface, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostIndex=ogHostIndex, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientEssid=ogWifiClientEssid, ogUpsType=ogUpsType, ogCellModemVendor=ogCellModemVendor, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemEnabled=ogCellModemEnabled, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioType=ogEmdDioType, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientApMac=ogWifiClientApMac, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcEntry=ogRpcEntry, ogEmdConnectType=ogEmdConnectType, ogCheckType=ogCheckType, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientTable=ogWifiClientTable, ogEmdDioDescription=ogEmdDioDescription, ogSerialUserTable=ogSerialUserTable, ogSerialPortParity=ogSerialPortParity, ogHostUserHost=ogHostUserHost, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientEntry=ogWifiClientEntry, ogSerialUserEntry=ogSerialUserEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApIndex=ogWifiApIndex, ogStatus2Compliances=ogStatus2Compliances, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellTowerNotification=ogCellTowerNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsLogEnabled=ogUpsLogEnabled, ogRpcType=ogRpcType, ogAlarmState=ogAlarmState, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsEntry=ogUpsEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortIndex=ogSerialPortIndex, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdEnabled=ogEmdEnabled, ogEmdTable=ogEmdTable, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialUserName=ogSerialUserName, ogUpsTable=ogUpsTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemTower=ogCellModemTower, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogPowerSupplyName=ogPowerSupplyName, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceEntry=ogHostServiceEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWebUserSourcePort=ogWebUserSourcePort, ogMibNotifications=ogMibNotifications, ogSerialPortRTS=ogSerialPortRTS, ogHostServiceTable=ogHostServiceTable, ogUpsDescription=ogUpsDescription, ogUpsOutputPower=ogUpsOutputPower, ogHostName=ogHostName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceTable=ogNetInterfaceTable, ogCellApnNotification=ogCellApnNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsHumidity=ogUpsHumidity, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientMac=ogWifiApClientMac, ogSerialUserNotification=ogSerialUserNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemTable=ogCellModemTable, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostPingNotification=ogHostPingNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckResolveActions=ogCheckResolveActions, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostUserStartTime=ogHostUserStartTime, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserEntry=ogHostUserEntry, ogUpsState=ogUpsState, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWebUserName=ogWebUserName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry)
