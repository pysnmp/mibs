...
TimeTicks, MibIdentifier, iso, Counter32, Unsigned32, Counter64, Gauge32, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, NotificationType, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibIdentifier", "iso", "Counter32", "Unsigned32", "Counter64", "Gauge32", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "NotificationType", "ModuleIdentity", "Integer32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApTxPower=ogWifiApTxPower, ogHostServicePort=ogHostServicePort, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioDescription=ogEmdDioDescription, ogCellModemIndex=ogCellModemIndex, ogCustomNotification=ogCustomNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityName=ogEmdHumidityName, ogEmdIndex=ogEmdIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmState=ogAlarmState, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialUserLabel=ogSerialUserLabel, ogEmdEnabled=ogEmdEnabled, ogStatus2Compliances=ogStatus2Compliances, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcIndex=ogRpcIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDescription=ogEmdDescription, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmDevice=ogAlarmDevice, ogUpsOutputPower=ogUpsOutputPower, ogWifiApTable=ogWifiApTable, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmInstance=ogAlarmInstance, ogWifiApFrequency=ogWifiApFrequency, ogRpcTable=ogRpcTable, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemEntry=ogCellModemEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdConnectType=ogEmdConnectType, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioDirection=ogEmdDioDirection, ogCellApnNotification=ogCellApnNotification, ogUpsName=ogUpsName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioName=ogEmdDioName, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemModel=ogCellModemModel, ogCellSignalNotification=ogCellSignalNotification, ogEmdTable=ogEmdTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmTime=ogAlarmTime, ogNetInterfaceState=ogNetInterfaceState, ogHostUserIndex=ogHostUserIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogHostUserStartTime=ogHostUserStartTime, ogSerialUserPort=ogSerialUserPort, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioType=ogEmdDioType, ogWifiClientInterface=ogWifiClientInterface, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsCounter=ogUpsCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApEnabled=ogWifiApEnabled, ogEmdEntry=ogEmdEntry, ogUpsState=ogUpsState, ogUpsType=ogUpsType, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceType=ogHostServiceType, ogHostUserHostName=ogHostUserHostName, ogSerialPortSpeed=ogSerialPortSpeed, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialUserEntry=ogSerialUserEntry, ogHostIndex=ogHostIndex, ogWebUserTable=ogWebUserTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmType=ogAlarmType, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortEntry=ogSerialPortEntry, ogCellModemApn=ogCellModemApn, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceEntry=ogHostServiceEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortDCD=ogSerialPortDCD, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDioEmd=ogEmdDioEmd, ogCellModemVendor=ogCellModemVendor, ogSerialPortDSR=ogSerialPortDSR, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckTable=ogCheckTable, ogHostIpV4Address=ogHostIpV4Address, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletState=ogRpcOutletState, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioTable=ogEmdDioTable, ogRpcInputNotification=ogRpcInputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioCounter=ogEmdDioCounter, ogCheckResolveActions=ogCheckResolveActions, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApEntry=ogWifiApEntry, ogCellModemNetwork=ogCellModemNetwork, ogWebUserIndex=ogWebUserIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserNotification=ogSerialUserNotification, ogCellModemConnected=ogCellModemConnected, ogCellModemTower=ogCellModemTower, ogHostPingNotification=ogHostPingNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostUserTable=ogHostUserTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarm=ogAlarm, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyName=ogPowerSupplyName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApSsid=ogWifiApSsid, ogHostServiceCounter=ogHostServiceCounter, ogWebUserEntry=ogWebUserEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortCTS=ogSerialPortCTS, ogUpsEntry=ogUpsEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientTable=ogWifiApClientTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletName=ogRpcOutletName, ogCheckIndex=ogCheckIndex, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientCounter=ogWifiClientCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletEntry=ogRpcOutletEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletRpc=ogRpcOutletRpc, ogStatus2=ogStatus2, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostUserEntry=ogHostUserEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmName=ogAlarmName, ogSerialPortIndex=ogSerialPortIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmUser=ogAlarmUser, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostName=ogHostName, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsConnectType=ogUpsConnectType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckType=ogCheckType, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckName=ogCheckName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemCounter=ogCellModemCounter, ogHostUserName=ogHostUserName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWebUserNotification=ogWebUserNotification, ogStatus2Compliance=ogStatus2Compliance, ogUpsTable=ogUpsTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserTable=ogSerialUserTable, ogCellModemRegistered=ogCellModemRegistered, ogHostTable=ogHostTable, ogWebUserName=ogWebUserName, ogEmdName=ogEmdName, ogHostUserHost=ogHostUserHost, ogUpsIndex=ogUpsIndex, ogUpsHumidity=ogUpsHumidity, ogStatus2Groups=ogStatus2Groups, ogNetInterfaceType=ogNetInterfaceType, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsDescription=ogUpsDescription, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortMode=ogSerialPortMode, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostEntry=ogHostEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserName=ogSerialUserName, PYSNMP_MODULE_ID=ogStatus2, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceIndex=ogHostServiceIndex, ogRpcCounter=ogRpcCounter, ogMibNotifications=ogMibNotifications, ogUpsOutputLoad=ogUpsOutputLoad, ogFirmwareVersion=ogFirmwareVersion, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApInterface=ogWifiApInterface, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellTowerNotification=ogCellTowerNotification, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortTable=ogSerialPortTable, ogRpcType=ogRpcType, ogCheckTriggerActions=ogCheckTriggerActions, ogSystem=ogSystem, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApIndex=ogWifiApIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortParity=ogSerialPortParity, ogCellModemTable=ogCellModemTable, ogHostServiceNotification=ogHostServiceNotification, ogCheckEntry=ogCheckEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsTemperature=ogUpsTemperature, ogCellModemSessionTime=ogCellModemSessionTime, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceTable=ogHostServiceTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmSummary=ogAlarmSummary, ogSerialNumber=ogSerialNumber, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortDTR=ogSerialPortDTR, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApCounter=ogWifiApCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcName=ogRpcName, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientMode=ogWifiClientMode, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcDescription=ogRpcDescription, ogUpsNotification=ogUpsNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioState=ogEmdDioState, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmEventId=ogAlarmEventId, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemEnabled=ogCellModemEnabled, ogRpcEntry=ogRpcEntry, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWebUserStartTime=ogWebUserStartTime, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientApMac=ogWifiClientApMac)
