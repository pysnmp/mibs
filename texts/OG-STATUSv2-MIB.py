...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarm=ogAlarm, ogWebUserIndex=ogWebUserIndex, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApSsid=ogWifiApSsid, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServiceIndex=ogHostServiceIndex, ogHostServiceType=ogHostServiceType, ogAlarmTime=ogAlarmTime, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostIndex=ogHostIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmDevice=ogAlarmDevice, ogHostUserHostName=ogHostUserHostName, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientMode=ogWifiClientMode, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityName=ogEmdHumidityName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortTable=ogSerialPortTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogStatus2=ogStatus2, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutletTable=ogRpcOutletTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletState=ogRpcOutletState, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmSummary=ogAlarmSummary, ogCellModemNetwork=ogCellModemNetwork, ogHostIpV4Address=ogHostIpV4Address, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientRssi=ogWifiClientRssi, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialNumber=ogSerialNumber, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortDTR=ogSerialPortDTR, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcIndex=ogRpcIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsDescription=ogUpsDescription, ogCellModemEntry=ogCellModemEntry, ogCellModemConnected=ogCellModemConnected, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcName=ogRpcName, ogEmdIndex=ogEmdIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckIndex=ogCheckIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcTable=ogRpcTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcDescription=ogRpcDescription, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdName=ogEmdName, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckType=ogCheckType, ogRpcType=ogRpcType, ogHostUserAddress=ogHostUserAddress, ogHostUserName=ogHostUserName, ogEmdTable=ogEmdTable, ogAlarmInstance=ogAlarmInstance, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioTable=ogEmdDioTable, ogAlarmUser=ogAlarmUser, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemIndex=ogCellModemIndex, ogHostUserTable=ogHostUserTable, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemModel=ogCellModemModel, ogWifiApEntry=ogWifiApEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortParity=ogSerialPortParity, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostEntry=ogHostEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemIMSI=ogCellModemIMSI, ogUpsState=ogUpsState, ogCurrentAlarmType=ogCurrentAlarmType, ogWebUserStartTime=ogWebUserStartTime, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemApn=ogCellModemApn, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserName=ogSerialUserName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsEntry=ogUpsEntry, ogRpcCounter=ogRpcCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioEmd=ogEmdDioEmd, ogSerialUserEntry=ogSerialUserEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemCounter=ogCellModemCounter, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsTemperature=ogUpsTemperature, ogWifiApClientTable=ogWifiApClientTable, ogWebUserNotification=ogWebUserNotification, ogWifiClientTable=ogWifiClientTable, ogAlarmType=ogAlarmType, ogUpsHumidity=ogUpsHumidity, ogHostServiceNotification=ogHostServiceNotification, ogNetInterfaceName=ogNetInterfaceName, ogAlarmEventId=ogAlarmEventId, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioName=ogEmdDioName, ogWifiApTxPower=ogWifiApTxPower, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserTable=ogWebUserTable, ogSerialPortMode=ogSerialPortMode, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsIndex=ogUpsIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogStatus2Compliances=ogStatus2Compliances, ogAlarmLogTable=ogAlarmLogTable, ogCellModemVendor=ogCellModemVendor, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdDioType=ogEmdDioType, ogCheckEntry=ogCheckEntry, ogMibNotifications=ogMibNotifications, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsCounter=ogUpsCounter, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostIpV6Address=ogHostIpV6Address, ogWifiApIndex=ogWifiApIndex, ogUpsTable=ogUpsTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdConnectType=ogEmdConnectType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioDirection=ogEmdDioDirection, ogHostUserStartTime=ogHostUserStartTime, ogHostUserHost=ogHostUserHost, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortEntry=ogSerialPortEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialUserNotification=ogSerialUserNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostName=ogHostName, ogRpcEntry=ogRpcEntry, ogStatus2Compliance=ogStatus2Compliance, ogRpcConnectType=ogRpcConnectType, ogAlarmState=ogAlarmState, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckDeviceName=ogCheckDeviceName, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserEntry=ogWebUserEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdHumidityTable=ogEmdHumidityTable, ogHostServiceHost=ogHostServiceHost, ogWebUserName=ogWebUserName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogStatus2Conformance=ogStatus2Conformance, ogHostServicePort=ogHostServicePort, ogAlarmLogIndex=ogAlarmLogIndex, ogHostServiceEntry=ogHostServiceEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckTable=ogCheckTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputCurrent=ogUpsInputCurrent, ogSystem=ogSystem, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyName=ogPowerSupplyName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientApMac=ogWifiClientApMac, PYSNMP_MODULE_ID=ogStatus2, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApTable=ogWifiApTable, ogEmdDescription=ogEmdDescription, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceTable=ogHostServiceTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceType=ogNetInterfaceType, ogEmdDioEntry=ogEmdDioEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmCheck=ogAlarmCheck, ogCheckName=ogCheckName, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemTower=ogCellModemTower, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceCounter=ogHostServiceCounter, ogUpsName=ogUpsName, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCustomNotification=ogCustomNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostTable=ogHostTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialUserLabel=ogSerialUserLabel, ogCellDataNotification=ogCellDataNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogFirmwareVersion=ogFirmwareVersion, ogEmdDioState=ogEmdDioState, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletName=ogRpcOutletName, ogCellTowerNotification=ogCellTowerNotification, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdEntry=ogEmdEntry, ogStatus2Groups=ogStatus2Groups, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmName=ogAlarmName, ogCellModemTable=ogCellModemTable, ogCheckDeviceTable=ogCheckDeviceTable, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientInterface=ogWifiClientInterface, ogUpsNotification=ogUpsNotification, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientEntry=ogWifiClientEntry, ogUpsInputNotification=ogUpsInputNotification, ogUpsType=ogUpsType, ogSerialPortRTS=ogSerialPortRTS, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApInterface=ogWifiApInterface, ogUpsConnectType=ogUpsConnectType, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutputNotification=ogRpcOutputNotification, ogHostUserNotification=ogHostUserNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApCounter=ogWifiApCounter, ogCellApnNotification=ogCellApnNotification)
