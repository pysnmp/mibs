...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputPower=ogUpsOutputPower, ogCellModemTemperature=ogCellModemTemperature, ogCheckName=ogCheckName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcIndex=ogRpcIndex, ogEmdDioTable=ogEmdDioTable, ogStatus2Groups=ogStatus2Groups, ogSerialPortTable=ogSerialPortTable, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioEmd=ogEmdDioEmd, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsDescription=ogUpsDescription, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcEntry=ogRpcEntry, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmType=ogAlarmType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemIndex=ogCellModemIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApTxPower=ogWifiApTxPower, ogSystem=ogSystem, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmInstance=ogAlarmInstance, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsConnectType=ogUpsConnectType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserStartTime=ogHostUserStartTime, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApIndex=ogWifiApIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostServiceTable=ogHostServiceTable, ogEmdHumidityValue=ogEmdHumidityValue, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmSummary=ogAlarmSummary, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientTable=ogWifiClientTable, ogNetInterfaceName=ogNetInterfaceName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWebUserName=ogWebUserName, ogWifiApClientRssi=ogWifiApClientRssi, ogHostTable=ogHostTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApClientTable=ogWifiApClientTable, ogUpsTable=ogUpsTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmLogTable=ogAlarmLogTable, ogHostUserName=ogHostUserName, ogPowerSupplyName=ogPowerSupplyName, ogUpsCounter=ogUpsCounter, ogEmdDioEntry=ogEmdDioEntry, ogSerialUserPort=ogSerialUserPort, ogNetInterfaceType=ogNetInterfaceType, ogRpcTable=ogRpcTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcConnectType=ogRpcConnectType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmState=ogAlarmState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemRegistered=ogCellModemRegistered, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdConnectType=ogEmdConnectType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioState=ogEmdDioState, ogHostServiceType=ogHostServiceType, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdEntry=ogEmdEntry, ogHostServiceHost=ogHostServiceHost, ogCellDataNotification=ogCellDataNotification, ogUpsEntry=ogUpsEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostIpV4Address=ogHostIpV4Address, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientEnabled=ogWifiClientEnabled, ogCellApnNotification=ogCellApnNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortEntry=ogSerialPortEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostUserNotification=ogHostUserNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsNotification=ogUpsNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApFrequency=ogWifiApFrequency, ogAlarmDevice=ogAlarmDevice, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemApn=ogCellModemApn, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserEntry=ogSerialUserEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemTable=ogCellModemTable, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckIndex=ogCheckIndex, ogSerialUserTable=ogSerialUserTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellSignalNotification=ogCellSignalNotification, ogHostName=ogHostName, ogWifiClientInterface=ogWifiClientInterface, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsState=ogUpsState, ogAlarmUser=ogAlarmUser, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialNumber=ogSerialNumber, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryState=ogUpsBatteryState, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckType=ogCheckType, ogCellModemTower=ogCellModemTower, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApEntry=ogWifiApEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDescription=ogEmdDescription, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientAp=ogWifiApClientAp, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApInterface=ogWifiApInterface, ogUpsType=ogUpsType, ogSerialPortParity=ogSerialPortParity, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmName=ogAlarmName, ogUpsInputCurrent=ogUpsInputCurrent, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioIndex=ogEmdDioIndex, ogEmdName=ogEmdName, ogRpcCounter=ogRpcCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWebUserStartTime=ogWebUserStartTime, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogStatus2Conformance=ogStatus2Conformance, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemModel=ogCellModemModel, ogSerialUserName=ogSerialUserName, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityName=ogEmdHumidityName, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckTable=ogCheckTable, ogHostServicePort=ogHostServicePort, ogWifiClientIndex=ogWifiClientIndex, ogEmdEnabled=ogEmdEnabled, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostIndex=ogHostIndex, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcName=ogRpcName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletState=ogRpcOutletState, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApSsid=ogWifiApSsid, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortDCD=ogSerialPortDCD, ogEmdHumidityEntry=ogEmdHumidityEntry, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortMode=ogSerialPortMode, ogCellMessageNotification=ogCellMessageNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostPingNotification=ogHostPingNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogStatus2=ogStatus2, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmTime=ogAlarmTime, ogAlarm=ogAlarm, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcType=ogRpcType, ogCellModemVendor=ogCellModemVendor, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogHostUserIndex=ogHostUserIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsIndex=ogUpsIndex, ogCellTowerNotification=ogCellTowerNotification, ogCheckEntry=ogCheckEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsHumidity=ogUpsHumidity, ogWifiApClientIndex=ogWifiApClientIndex, ogCustomNotification=ogCustomNotification, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortIndex=ogSerialPortIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserTable=ogWebUserTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientCounter=ogWifiClientCounter, ogWebUserIndex=ogWebUserIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdIndex=ogEmdIndex, PYSNMP_MODULE_ID=ogStatus2, ogHostUserTable=ogHostUserTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWebUserEntry=ogWebUserEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsTemperature=ogUpsTemperature, ogEmdTable=ogEmdTable, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortDSR=ogSerialPortDSR, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApTable=ogWifiApTable, ogUpsName=ogUpsName, ogHostIpV6Address=ogHostIpV6Address, ogHostUserAddress=ogHostUserAddress, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientMode=ogWifiClientMode, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceTable=ogNetInterfaceTable, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialUserIndex=ogSerialUserIndex, ogWebUserNotification=ogWebUserNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletTable=ogRpcOutletTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcDescription=ogRpcDescription, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostEntry=ogHostEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostUserEntry=ogHostUserEntry, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModem4gRssi=ogCellModem4gRssi, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarmCheck=ogAlarmCheck, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioType=ogEmdDioType, ogCurrentAlarmState=ogCurrentAlarmState, ogHostUserHost=ogHostUserHost, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemNetwork=ogCellModemNetwork, ogAlarmEventId=ogAlarmEventId, ogMibNotifications=ogMibNotifications, ogCellModemConnected=ogCellModemConnected, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioName=ogEmdDioName, ogCellModemCounter=ogCellModemCounter, ogWifiApCounter=ogWifiApCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckDeviceRef=ogCheckDeviceRef)
