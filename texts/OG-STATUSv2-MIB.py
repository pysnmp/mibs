...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioCounter=ogEmdDioCounter, ogStatus2Compliances=ogStatus2Compliances, ogWifiApEnabled=ogWifiApEnabled, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostIndex=ogHostIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApTable=ogWifiApTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdConnectType=ogEmdConnectType, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientInterface=ogWifiClientInterface, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmSummary=ogAlarmSummary, ogCellModemVendor=ogCellModemVendor, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServiceCounter=ogHostServiceCounter, ogCellModemApn=ogCellModemApn, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceIndex=ogHostServiceIndex, ogCellModemEnabled=ogCellModemEnabled, ogSerialNumber=ogSerialNumber, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdEntry=ogEmdEntry, ogUpsNotification=ogUpsNotification, ogEmdDioIndex=ogEmdDioIndex, ogUpsConnectType=ogUpsConnectType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcCounter=ogRpcCounter, ogHostUserName=ogHostUserName, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcInputNotification=ogRpcInputNotification, ogCellSignalNotification=ogCellSignalNotification, ogCellDataNotification=ogCellDataNotification, ogEmdName=ogEmdName, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortCTS=ogSerialPortCTS, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmState=ogAlarmState, ogWebUserName=ogWebUserName, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioEmd=ogEmdDioEmd, ogWifiApEntry=ogWifiApEntry, ogEmdDioDescription=ogEmdDioDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostUserStartTime=ogHostUserStartTime, ogUpsCounter=ogUpsCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcTable=ogRpcTable, ogEmdDioNotification=ogEmdDioNotification, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletName=ogRpcOutletName, ogFirmwareVersion=ogFirmwareVersion, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServicePort=ogHostServicePort, ogCellTowerNotification=ogCellTowerNotification, ogCellModemTable=ogCellModemTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcType=ogRpcType, ogUpsInputNotification=ogUpsInputNotification, ogUpsTable=ogUpsTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortDCD=ogSerialPortDCD, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserEntry=ogHostUserEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcIndex=ogRpcIndex, ogCellModemTower=ogCellModemTower, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientTable=ogWifiApClientTable, ogWebUserStartTime=ogWebUserStartTime, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortTable=ogSerialPortTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutletState=ogRpcOutletState, ogHostUserHostName=ogHostUserHostName, ogHostUserNotification=ogHostUserNotification, ogSerialUserEntry=ogSerialUserEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletTable=ogRpcOutletTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserEntry=ogWebUserEntry, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdTable=ogEmdTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostUserAddress=ogHostUserAddress, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcConnectType=ogRpcConnectType, ogRpcOutletNotification=ogRpcOutletNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostName=ogHostName, ogWifiClientEssid=ogWifiClientEssid, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmLogTable=ogAlarmLogTable, ogCellModemEntry=ogCellModemEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckType=ogCheckType, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceNotification=ogHostServiceNotification, ogHostServiceType=ogHostServiceType, ogHostServiceStatus=ogHostServiceStatus, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostPingNotification=ogHostPingNotification, ogUpsIndex=ogUpsIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsHumidity=ogUpsHumidity, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialUserTable=ogSerialUserTable, ogHostUserTable=ogHostUserTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortDTR=ogSerialPortDTR, ogWebUserIndex=ogWebUserIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmCheck=ogAlarmCheck, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWebUserNotification=ogWebUserNotification, ogEmdDioTable=ogEmdDioTable, ogWifiApCounter=ogWifiApCounter, ogCellModemConnected=ogCellModemConnected, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsType=ogUpsType, ogWifiApClientEntry=ogWifiApClientEntry, PYSNMP_MODULE_ID=ogStatus2, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostEntry=ogHostEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientFrequency=ogWifiClientFrequency, ogStatus2=ogStatus2, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioName=ogEmdDioName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcInputFrequency=ogRpcInputFrequency, ogSystem=ogSystem, ogWifiApFrequency=ogWifiApFrequency, ogHostUserIndex=ogHostUserIndex, ogCheckName=ogCheckName, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdIndex=ogEmdIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioDirection=ogEmdDioDirection, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceHost=ogHostServiceHost, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioType=ogEmdDioType, ogWifiApSsid=ogWifiApSsid, ogCheckIndex=ogCheckIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientMode=ogWifiClientMode, ogCheckTable=ogCheckTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientMac=ogWifiApClientMac, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmTime=ogAlarmTime, ogUpsDescription=ogUpsDescription, ogCurrentAlarmTable=ogCurrentAlarmTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserTable=ogWebUserTable, ogRpcDescription=ogRpcDescription, ogUpsEntry=ogUpsEntry, ogStatus2Groups=ogStatus2Groups, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellNetworkNotification=ogCellNetworkNotification, ogStatus2Compliance=ogStatus2Compliance, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDescription=ogEmdDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientTable=ogWifiClientTable, ogWebUserSourcePort=ogWebUserSourcePort, ogNetInterfaceState=ogNetInterfaceState, ogCellModemRegistered=ogCellModemRegistered, ogAlarmEventId=ogAlarmEventId, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserPort=ogSerialUserPort, ogCellModemSessionTime=ogCellModemSessionTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsState=ogUpsState, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortLabel=ogSerialPortLabel, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemModel=ogCellModemModel, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyName=ogPowerSupplyName, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioState=ogEmdDioState, ogSerialPortRTS=ogSerialPortRTS, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceTable=ogHostServiceTable, ogWifiApClientAp=ogWifiApClientAp, ogHostTable=ogHostTable, ogUpsTemperature=ogUpsTemperature, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemTemperature=ogCellModemTemperature, ogRpcName=ogRpcName, ogSerialUserIndex=ogSerialUserIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarm=ogAlarm, ogCellMessageNotification=ogCellMessageNotification, ogHostUserHost=ogHostUserHost, ogNetInterfaceName=ogNetInterfaceName, ogCellModemCounter=ogCellModemCounter, ogWifiApTxPower=ogWifiApTxPower, ogEmdHumidityName=ogEmdHumidityName, ogCellModemNetwork=ogCellModemNetwork, ogAlarmType=ogAlarmType, ogCellModemIndex=ogCellModemIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellApnNotification=ogCellApnNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsName=ogUpsName, ogRpcEntry=ogRpcEntry, ogMibNotifications=ogMibNotifications, ogAlarmInstance=ogAlarmInstance, ogSerialUserName=ogSerialUserName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmUser=ogAlarmUser, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortParity=ogSerialPortParity, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckEntry=ogCheckEntry, ogCustomNotification=ogCustomNotification, ogWifiApIndex=ogWifiApIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmName=ogAlarmName)
