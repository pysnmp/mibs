...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortDSR=ogSerialPortDSR, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialUserPort=ogSerialUserPort, ogCustomNotification=ogCustomNotification, ogRpcEntry=ogRpcEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemConnected=ogCellModemConnected, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortBreaks=ogSerialPortBreaks, ogStatus2Compliance=ogStatus2Compliance, ogCheckDeviceName=ogCheckDeviceName, ogHostServiceTable=ogHostServiceTable, ogAlarmDevice=ogAlarmDevice, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWebUserIndex=ogWebUserIndex, ogHostIpV6Address=ogHostIpV6Address, ogUpsType=ogUpsType, ogEmdIndex=ogEmdIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientFrequency=ogWifiClientFrequency, ogHostUserNotification=ogHostUserNotification, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmType=ogAlarmType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemCounter=ogCellModemCounter, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioTable=ogEmdDioTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsCounter=ogUpsCounter, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsNotification=ogUpsNotification, ogEmdName=ogEmdName, ogWifiApIndex=ogWifiApIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostIndex=ogHostIndex, ogHostIpV4Address=ogHostIpV4Address, ogCheckEntry=ogCheckEntry, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostName=ogHostName, ogRpcDescription=ogRpcDescription, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellModemTable=ogCellModemTable, ogStatus2=ogStatus2, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialNumber=ogSerialNumber, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortLabel=ogSerialPortLabel, ogUpsEntry=ogUpsEntry, ogRpcOutletTable=ogRpcOutletTable, ogEmdDioEmd=ogEmdDioEmd, ogHostUserTable=ogHostUserTable, ogUpsTemperature=ogUpsTemperature, ogHostUserIndex=ogHostUserIndex, ogHostServiceType=ogHostServiceType, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemRegistered=ogCellModemRegistered, ogHostUserHostName=ogHostUserHostName, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellModemTower=ogCellModemTower, ogRpcConnectType=ogRpcConnectType, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioEntry=ogEmdDioEntry, ogUpsIndex=ogUpsIndex, ogWifiApInterface=ogWifiApInterface, ogStatus2Groups=ogStatus2Groups, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckName=ogCheckName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmInstance=ogAlarmInstance, ogCellDataNotification=ogCellDataNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckIndex=ogCheckIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemApn=ogCellModemApn, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApEnabled=ogWifiApEnabled, ogHostUserName=ogHostUserName, ogNetInterfaceTable=ogNetInterfaceTable, ogHostPingNotification=ogHostPingNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, PYSNMP_MODULE_ID=ogStatus2, ogAlarmState=ogAlarmState, ogWebUserName=ogWebUserName, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApSsid=ogWifiApSsid, ogEmdDescription=ogEmdDescription, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdHumidityValue=ogEmdHumidityValue, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryState=ogUpsBatteryState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmUser=ogAlarmUser, ogSerialUserNotification=ogSerialUserNotification, ogRpcIndex=ogRpcIndex, ogCellModemEntry=ogCellModemEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmCheck=ogAlarmCheck, ogEmdDioType=ogEmdDioType, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortParity=ogSerialPortParity, ogSerialUserName=ogSerialUserName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemNetwork=ogCellModemNetwork, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceType=ogNetInterfaceType, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientInterface=ogWifiClientInterface, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemIndex=ogCellModemIndex, ogHostServicePort=ogHostServicePort, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsDescription=ogUpsDescription, ogUpsConnectType=ogUpsConnectType, ogSerialUserLabel=ogSerialUserLabel, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsTable=ogUpsTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTable=ogEmdTable, ogAlarm=ogAlarm, ogWifiClientApMac=ogWifiClientApMac, ogUpsInputCurrent=ogUpsInputCurrent, ogStatus2Compliances=ogStatus2Compliances, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsName=ogUpsName, ogUpsInputVoltage=ogUpsInputVoltage, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioCounter=ogEmdDioCounter, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientTable=ogWifiClientTable, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmSummary=ogAlarmSummary, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdEntry=ogEmdEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckResolveActions=ogCheckResolveActions, ogAlarmLogTable=ogAlarmLogTable, ogWebUserStartTime=ogWebUserStartTime, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckTriggerActions=ogCheckTriggerActions, ogWebUserTable=ogWebUserTable, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientEntry=ogWifiClientEntry, ogWebUserEntry=ogWebUserEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostUserAddress=ogHostUserAddress, ogAlarmTime=ogAlarmTime, ogWifiApCounter=ogWifiApCounter, ogEmdConnectType=ogEmdConnectType, ogRpcName=ogRpcName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcType=ogRpcType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckDeviceTable=ogCheckDeviceTable, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortDTR=ogSerialPortDTR, ogCellModemSessionTime=ogCellModemSessionTime, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdHumidityTable=ogEmdHumidityTable, ogSystem=ogSystem, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemTemperature=ogCellModemTemperature, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientMac=ogWifiApClientMac, ogUpsState=ogUpsState, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostTable=ogHostTable, ogCheckType=ogCheckType, ogSerialPortMode=ogSerialPortMode)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletState=ogRpcOutletState, ogHostEntry=ogHostEntry, ogUpsHumidity=ogUpsHumidity, ogHostUserHost=ogHostUserHost, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceHost=ogHostServiceHost, ogMibNotifications=ogMibNotifications, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientMode=ogWifiClientMode, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityName=ogEmdHumidityName, ogCellModemVendor=ogCellModemVendor, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemModel=ogCellModemModel, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientIndex=ogWifiClientIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletName=ogRpcOutletName, ogEmdEnabled=ogEmdEnabled, ogWifiApTable=ogWifiApTable, ogWifiApClientTable=ogWifiApClientTable, ogNetInterfaceState=ogNetInterfaceState, ogCellApnNotification=ogCellApnNotification, ogSerialPortDCD=ogSerialPortDCD, ogHostUserEntry=ogHostUserEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcTable=ogRpcTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemIMSI=ogCellModemIMSI, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioName=ogEmdDioName, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioState=ogEmdDioState, ogRpcCounter=ogRpcCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientEssid=ogWifiClientEssid, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserIndex=ogSerialUserIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckTable=ogCheckTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostServiceEntry=ogHostServiceEntry, ogAlarmName=ogAlarmName)
