...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortMode=ogSerialPortMode, ogUpsIndex=ogUpsIndex, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioIndex=ogEmdDioIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogWebUserName=ogWebUserName, ogEmdDescription=ogEmdDescription, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemEnabled=ogCellModemEnabled, ogCellModemModel=ogCellModemModel, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortDTR=ogSerialPortDTR, ogWifiApTxPower=ogWifiApTxPower, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWebUserEntry=ogWebUserEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletName=ogRpcOutletName, ogWifiClientEntry=ogWifiClientEntry, ogAlarmDevice=ogAlarmDevice, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletTable=ogRpcOutletTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceCounter=ogHostServiceCounter, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientEssid=ogWifiClientEssid, ogCellDataNotification=ogCellDataNotification, ogAlarm=ogAlarm, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcInputNotification=ogRpcInputNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostUserIndex=ogHostUserIndex, ogEmdEnabled=ogEmdEnabled, ogHostServiceHost=ogHostServiceHost, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsDescription=ogUpsDescription, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsTable=ogUpsTable, ogRpcTable=ogRpcTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckTable=ogCheckTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientAp=ogWifiApClientAp, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientTable=ogWifiApClientTable, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortLabel=ogSerialPortLabel, ogSerialNumber=ogSerialNumber, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialUserEntry=ogSerialUserEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserName=ogHostUserName, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmInstance=ogAlarmInstance, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientApMac=ogWifiClientApMac, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmEventId=ogAlarmEventId, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientBitRate=ogWifiClientBitRate, ogMibNotifications=ogMibNotifications, ogEmdTable=ogEmdTable, ogCellModemIMSI=ogCellModemIMSI, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcType=ogRpcType, ogWebUserNotification=ogWebUserNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogCellApnNotification=ogCellApnNotification, ogRpcEntry=ogRpcEntry, ogCellModemVendor=ogCellModemVendor, ogEmdDioType=ogEmdDioType, ogWifiClientMode=ogWifiClientMode, ogCheckName=ogCheckName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserNotification=ogHostUserNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostServiceTable=ogHostServiceTable, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmState=ogAlarmState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcDescription=ogRpcDescription, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckDeviceTable=ogCheckDeviceTable, ogHostIpV6Address=ogHostIpV6Address, ogUpsTemperature=ogUpsTemperature, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortParity=ogSerialPortParity, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyName=ogPowerSupplyName, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceType=ogHostServiceType, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsState=ogUpsState, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmCheck=ogAlarmCheck, ogAlarmPreviousValue=ogAlarmPreviousValue, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellNetworkNotification=ogCellNetworkNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogNetInterfaceState=ogNetInterfaceState, ogRpcIndex=ogRpcIndex, ogHostUserHost=ogHostUserHost, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarmType=ogAlarmType, ogWifiApFrequency=ogWifiApFrequency, ogEmdEntry=ogEmdEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputVoltage=ogUpsInputVoltage, ogCustomNotification=ogCustomNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientTable=ogWifiClientTable, ogAlarmTime=ogAlarmTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsHumidity=ogUpsHumidity, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServiceIndex=ogHostServiceIndex, ogStatus2Groups=ogStatus2Groups, ogEmdIndex=ogEmdIndex, ogWifiApInterface=ogWifiApInterface, ogHostUserEntry=ogHostUserEntry, ogWifiClientRssi=ogWifiClientRssi, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWebUserSourceAddress=ogWebUserSourceAddress, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortCTS=ogSerialPortCTS, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortEntry=ogSerialPortEntry, ogAlarmLogTable=ogAlarmLogTable, ogAlarmUser=ogAlarmUser, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemConnected=ogCellModemConnected, ogHostPingNotification=ogHostPingNotification, ogHostUserHostName=ogHostUserHostName, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserTable=ogSerialUserTable, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdConnectType=ogEmdConnectType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostServicePort=ogHostServicePort, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialUserLabel=ogSerialUserLabel, PYSNMP_MODULE_ID=ogStatus2, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemTower=ogCellModemTower, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApTable=ogWifiApTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApEnabled=ogWifiApEnabled, ogUpsType=ogUpsType, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemEntry=ogCellModemEntry, ogWifiApEntry=ogWifiApEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWebUserTable=ogWebUserTable, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioState=ogEmdDioState, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostIndex=ogHostIndex, ogSerialUserName=ogSerialUserName, ogUpsBatteryTemperature=ogUpsBatteryTemperature)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioName=ogEmdDioName, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckEntry=ogCheckEntry, ogSerialPortRTS=ogSerialPortRTS, ogUpsLogEnabled=ogUpsLogEnabled, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostTable=ogHostTable, ogCellModemApn=ogCellModemApn, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemIndex=ogCellModemIndex, ogUpsConnectType=ogUpsConnectType, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceName=ogNetInterfaceName, ogStatus2=ogStatus2, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcConnectType=ogRpcConnectType, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckIndex=ogCheckIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsEntry=ogUpsEntry, ogEmdName=ogEmdName, ogCellModemTable=ogCellModemTable, ogUpsNotification=ogUpsNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostEntry=ogHostEntry, ogSerialPortDCD=ogSerialPortDCD, ogCheckType=ogCheckType, ogHostName=ogHostName, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsCounter=ogUpsCounter, ogStatus2Compliances=ogStatus2Compliances, ogUpsName=ogUpsName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceNotification=ogHostServiceNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmName=ogAlarmName, ogCheckResolveActions=ogCheckResolveActions, ogHostServiceEntry=ogHostServiceEntry, ogCheckDeviceName=ogCheckDeviceName, ogHostUserAddress=ogHostUserAddress, ogSystem=ogSystem, ogCellModemCounter=ogCellModemCounter, ogCellMessageNotification=ogCellMessageNotification, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioDescription=ogEmdDioDescription, ogHostUserTable=ogHostUserTable, ogRpcName=ogRpcName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApCounter=ogWifiApCounter, ogRpcCounter=ogRpcCounter, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortTable=ogSerialPortTable, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioNotification=ogEmdDioNotification)
