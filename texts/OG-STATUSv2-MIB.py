...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcName=ogRpcName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostServiceType=ogHostServiceType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioState=ogEmdDioState, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckIndex=ogCheckIndex, ogRpcOutletState=ogRpcOutletState, ogCellModemNetwork=ogCellModemNetwork, ogHostPingNotification=ogHostPingNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsIndex=ogUpsIndex, ogUpsConnectType=ogUpsConnectType, ogSystem=ogSystem, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserName=ogWebUserName, ogHostServiceTable=ogHostServiceTable, ogCellModemModel=ogCellModemModel, ogCellModemRegistered=ogCellModemRegistered, ogHostUserHostName=ogHostUserHostName, ogAlarmName=ogAlarmName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellTowerNotification=ogCellTowerNotification, ogHostUserName=ogHostUserName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsDescription=ogUpsDescription, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioTable=ogEmdDioTable, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortDCD=ogSerialPortDCD, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioEmd=ogEmdDioEmd, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserNotification=ogHostUserNotification, ogCheckType=ogCheckType, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsEntry=ogUpsEntry, ogAlarmUser=ogAlarmUser, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioEntry=ogEmdDioEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServiceIndex=ogHostServiceIndex, ogCellModemCounter=ogCellModemCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmDevice=ogAlarmDevice, ogWifiApSsid=ogWifiApSsid, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemTable=ogCellModemTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsState=ogUpsState, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserName=ogSerialUserName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdHumidityCounter=ogEmdHumidityCounter, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsNotification=ogUpsNotification, ogHostServiceNotification=ogHostServiceNotification, ogCheckResolveActions=ogCheckResolveActions, ogUpsHumidity=ogUpsHumidity, ogMibNotifications=ogMibNotifications, ogHostUserAddress=ogHostUserAddress, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdEntry=ogEmdEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletLoad=ogRpcOutletLoad, ogHostEntry=ogHostEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsName=ogUpsName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApEntry=ogWifiApEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdEnabled=ogEmdEnabled, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdIndex=ogEmdIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortDSR=ogSerialPortDSR, ogRpcTable=ogRpcTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortTable=ogSerialPortTable, ogWifiClientEssid=ogWifiClientEssid, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsCounter=ogUpsCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemTower=ogCellModemTower, ogCheckName=ogCheckName, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserIndex=ogHostUserIndex, ogAlarmSummary=ogAlarmSummary, ogWebUserNotification=ogWebUserNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientMode=ogWifiClientMode, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckTable=ogCheckTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemVendor=ogCellModemVendor, ogEmdName=ogEmdName, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryNotification=ogUpsBatteryNotification, PYSNMP_MODULE_ID=ogStatus2, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceEntry=ogHostServiceEntry, ogHostUserEntry=ogHostUserEntry, ogStatus2Conformance=ogStatus2Conformance, ogEmdConnectType=ogEmdConnectType, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTable=ogEmdTable, ogUpsTable=ogUpsTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientIndex=ogWifiClientIndex, ogWebUserEntry=ogWebUserEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApCounter=ogWifiApCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmState=ogAlarmState, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCustomNotification=ogCustomNotification, ogWebUserTable=ogWebUserTable, ogWifiApInterface=ogWifiApInterface, ogSerialPortParity=ogSerialPortParity, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdDioName=ogEmdDioName, ogWifiApTable=ogWifiApTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostIndex=ogHostIndex, ogSerialPortRTS=ogSerialPortRTS, ogHostUserStartTime=ogHostUserStartTime, ogHostName=ogHostName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortLogLevel=ogSerialPortLogLevel, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioIndex=ogEmdDioIndex, ogAlarmInstance=ogAlarmInstance, ogSerialPortMode=ogSerialPortMode, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDescription=ogEmdDescription, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialUserEntry=ogSerialUserEntry, ogCellModemConnected=ogCellModemConnected, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityName=ogEmdHumidityName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcIndex=ogRpcIndex, ogWifiClientTable=ogWifiClientTable, ogSerialUserPort=ogSerialUserPort, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioType=ogEmdDioType, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserLabel=ogSerialUserLabel, ogUpsTemperature=ogUpsTemperature, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientInterface=ogWifiClientInterface, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientAp=ogWifiApClientAp, ogHostIpV6Address=ogHostIpV6Address, ogCellModemTemperature=ogCellModemTemperature, ogRpcCounter=ogRpcCounter, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemEnabled=ogCellModemEnabled, ogUpsLogEnabled=ogUpsLogEnabled, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortDTR=ogSerialPortDTR, ogAlarmType=ogAlarmType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientCounter=ogWifiClientCounter, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApEnabled=ogWifiApEnabled, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServicePort=ogHostServicePort, ogAlarmCheck=ogAlarmCheck, ogStatus2Compliance=ogStatus2Compliance, ogStatus2Groups=ogStatus2Groups, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialUserTable=ogSerialUserTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialNumber=ogSerialNumber, ogAlarmEventId=ogAlarmEventId, ogEmdLogEnabled=ogEmdLogEnabled, ogStatus2=ogStatus2, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserIndex=ogWebUserIndex, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellDataNotification=ogCellDataNotification, ogHostTable=ogHostTable, ogWifiApFrequency=ogWifiApFrequency, ogAlarm=ogAlarm, ogRpcEntry=ogRpcEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcDescription=ogRpcDescription, ogEmdDioDirection=ogEmdDioDirection, ogCellModemApn=ogCellModemApn, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientApMac=ogWifiClientApMac, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcConnectType=ogRpcConnectType, ogCellApnNotification=ogCellApnNotification, ogSerialPortIndex=ogSerialPortIndex, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckEntry=ogCheckEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogFirmwareVersion=ogFirmwareVersion, ogHostUserTable=ogHostUserTable, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserHost=ogHostUserHost, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmTime=ogAlarmTime, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientMac=ogWifiApClientMac, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcType=ogRpcType, ogUpsType=ogUpsType, ogWifiApIndex=ogWifiApIndex, ogRpcOutletName=ogRpcOutletName)
