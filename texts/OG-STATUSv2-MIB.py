...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTable=ogEmdTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserHost=ogHostUserHost, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortCTS=ogSerialPortCTS, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioName=ogEmdDioName, ogHostServiceIndex=ogHostServiceIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientTable=ogWifiClientTable, ogCheckName=ogCheckName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortSpeed=ogSerialPortSpeed, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsConnectType=ogUpsConnectType, ogHostUserName=ogHostUserName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsName=ogUpsName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioType=ogEmdDioType, ogUpsDescription=ogUpsDescription, ogWifiApClientTable=ogWifiApClientTable, ogCellModemEntry=ogCellModemEntry, ogUpsEntry=ogUpsEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApTable=ogWifiApTable, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioIndex=ogEmdDioIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityName=ogEmdHumidityName, ogHostUserTable=ogHostUserTable, ogWifiClientInterface=ogWifiClientInterface, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsHumidity=ogUpsHumidity, ogHostServiceType=ogHostServiceType, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortDCD=ogSerialPortDCD, ogRpcConnectType=ogRpcConnectType, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApInterface=ogWifiApInterface, ogSerialUserEntry=ogSerialUserEntry, ogSystem=ogSystem, ogCellModem3gRssi=ogCellModem3gRssi, ogStatus2=ogStatus2, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientApMac=ogWifiClientApMac, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmEventId=ogAlarmEventId, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortTable=ogSerialPortTable, ogEmdDioState=ogEmdDioState, ogWifiApSsid=ogWifiApSsid, ogAlarmState=ogAlarmState, ogCellModemRegistered=ogCellModemRegistered, ogHostName=ogHostName, ogUpsTable=ogUpsTable, ogEmdLogEnabled=ogEmdLogEnabled, ogWebUserIndex=ogWebUserIndex, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogNetInterfaceState=ogNetInterfaceState, ogAlarmName=ogAlarmName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserTable=ogSerialUserTable, ogHostUserIndex=ogHostUserIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsState=ogUpsState, ogCellModemTower=ogCellModemTower, ogCellModemIndex=ogCellModemIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogStatus2Conformance=ogStatus2Conformance, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellDataNotification=ogCellDataNotification, ogCustomNotification=ogCustomNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApCounter=ogWifiApCounter, ogEmdDioEntry=ogEmdDioEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWebUserName=ogWebUserName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioTable=ogEmdDioTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortParity=ogSerialPortParity, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdEnabled=ogEmdEnabled, ogHostServicePort=ogHostServicePort, ogHostServiceEntry=ogHostServiceEntry, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckDeviceRef=ogCheckDeviceRef, ogMibNotifications=ogMibNotifications, ogUpsType=ogUpsType, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsIndex=ogUpsIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcType=ogRpcType, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWebUserNotification=ogWebUserNotification, ogRpcOutletTable=ogRpcOutletTable, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemVendor=ogCellModemVendor, ogAlarmInstance=ogAlarmInstance, ogCellModemEnabled=ogCellModemEnabled, ogCellNetworkNotification=ogCellNetworkNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostIndex=ogHostIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckEntry=ogCheckEntry, ogSerialPortMode=ogSerialPortMode, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostIpV4Address=ogHostIpV4Address, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcDescription=ogRpcDescription, ogUpsLogEnabled=ogUpsLogEnabled, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemApn=ogCellModemApn, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmCheck=ogAlarmCheck, ogCheckTable=ogCheckTable, ogEmdName=ogEmdName, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmSummary=ogAlarmSummary, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmType=ogAlarmType, ogRpcCounter=ogRpcCounter, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserName=ogSerialUserName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutletName=ogRpcOutletName, ogRpcInputFrequency=ogRpcInputFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostIpV6Address=ogHostIpV6Address, ogStatus2Groups=ogStatus2Groups, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryState=ogUpsBatteryState, ogAlarmTime=ogAlarmTime, ogHostUserAddress=ogHostUserAddress, ogHostServiceNotification=ogHostServiceNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserHostName=ogHostUserHostName, ogRpcEntry=ogRpcEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogCheckType=ogCheckType, ogEmdDescription=ogEmdDescription, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostEntry=ogHostEntry, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsTemperature=ogUpsTemperature, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostTable=ogHostTable, ogStatus2Compliances=ogStatus2Compliances, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWebUserEntry=ogWebUserEntry, ogHostServiceCounter=ogHostServiceCounter, ogCellModemTable=ogCellModemTable, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsCounter=ogUpsCounter)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsNotification=ogUpsNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApIndex=ogWifiApIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioEmd=ogEmdDioEmd, ogStatus2Compliance=ogStatus2Compliance, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputPower=ogUpsOutputPower, ogEmdConnectType=ogEmdConnectType, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserNotification=ogSerialUserNotification, ogHostUserNotification=ogHostUserNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogWebUserStartTime=ogWebUserStartTime, ogUpsInputNotification=ogUpsInputNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWebUserTable=ogWebUserTable, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyName=ogPowerSupplyName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserEntry=ogHostUserEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarm=ogAlarm, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcName=ogRpcName, ogRpcOutletState=ogRpcOutletState, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceHost=ogHostServiceHost, ogRpcIndex=ogRpcIndex, ogSerialNumber=ogSerialNumber, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmUser=ogAlarmUser, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcTable=ogRpcTable, ogCellModemModel=ogCellModemModel, ogCheckIndex=ogCheckIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellApnNotification=ogCellApnNotification, ogEmdEntry=ogEmdEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApEntry=ogWifiApEntry, ogEmdIndex=ogEmdIndex, ogEmdDioCounter=ogEmdDioCounter, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostPingNotification=ogHostPingNotification)
