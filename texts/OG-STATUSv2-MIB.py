...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsName=ogUpsName, ogSerialUserNotification=ogSerialUserNotification, ogHostIndex=ogHostIndex, ogCellModemTable=ogCellModemTable, ogUpsType=ogUpsType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckType=ogCheckType, ogWifiApIndex=ogWifiApIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckTable=ogCheckTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsTemperature=ogUpsTemperature, ogHostUserEntry=ogHostUserEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserIndex=ogHostUserIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogHostUserHost=ogHostUserHost, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserHostName=ogHostUserHostName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemEntry=ogCellModemEntry, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletTable=ogRpcOutletTable, ogRpcName=ogRpcName, ogSystem=ogSystem, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmTime=ogAlarmTime, ogCheckDeviceName=ogCheckDeviceName, ogSerialNumber=ogSerialNumber, ogAlarmName=ogAlarmName, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogMibNotifications=ogMibNotifications, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmDevice=ogAlarmDevice, ogNetInterfaceState=ogNetInterfaceState, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarm=ogAlarm, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogNetInterfaceType=ogNetInterfaceType, ogWebUserTable=ogWebUserTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdEntry=ogEmdEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApEntry=ogWifiApEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogBasicStatusGroup=ogBasicStatusGroup, ogHostIpV6Address=ogHostIpV6Address, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsHumidity=ogUpsHumidity, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemConnected=ogCellModemConnected, ogRpcConnectType=ogRpcConnectType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientMac=ogWifiApClientMac, ogHostUserNotification=ogHostUserNotification, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientMode=ogWifiClientMode, ogHostServiceStatus=ogHostServiceStatus, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortMode=ogSerialPortMode, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostServicePort=ogHostServicePort, ogWebUserName=ogWebUserName, ogRpcInputNotification=ogRpcInputNotification, ogCustomNotification=ogCustomNotification, ogEmdDescription=ogEmdDescription, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdName=ogEmdName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortLabel=ogSerialPortLabel, ogAlarmCheck=ogAlarmCheck, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletState=ogRpcOutletState, ogEmdConnectType=ogEmdConnectType, ogWifiApEnabled=ogWifiApEnabled, ogCellModemCounter=ogCellModemCounter, ogAlarmLogTable=ogAlarmLogTable, ogRpcEntry=ogRpcEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellApnNotification=ogCellApnNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2=ogStatus2, ogCurrentAlarmName=ogCurrentAlarmName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputLoad=ogUpsOutputLoad, ogHostServiceType=ogHostServiceType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostUserName=ogHostUserName, ogCellModemTower=ogCellModemTower, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcDescription=ogRpcDescription, ogRpcType=ogRpcType, ogCellModemModel=ogCellModemModel, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortCTS=ogSerialPortCTS, ogCellModemIndex=ogCellModemIndex, ogHostServiceTable=ogHostServiceTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostName=ogHostName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioCounter=ogEmdDioCounter, ogUpsCounter=ogUpsCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortDCD=ogSerialPortDCD, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortDSR=ogSerialPortDSR, ogAlarmUser=ogAlarmUser, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortParity=ogSerialPortParity, ogHostUserTable=ogHostUserTable, ogCheckEntry=ogCheckEntry, ogHostServiceEntry=ogHostServiceEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostEntry=ogHostEntry, ogAlarmState=ogAlarmState, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortIndex=ogSerialPortIndex, ogUpsIndex=ogUpsIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortTable=ogSerialPortTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientEnabled=ogWifiClientEnabled, ogCellDataNotification=ogCellDataNotification, ogWifiClientEssid=ogWifiClientEssid, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioDirection=ogEmdDioDirection, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdIndex=ogEmdIndex, ogCellModemTemperature=ogCellModemTemperature, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserAddress=ogHostUserAddress, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostPingNotification=ogHostPingNotification, ogEmdDioType=ogEmdDioType, ogRpcTable=ogRpcTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServiceHost=ogHostServiceHost, ogHostServiceCounter=ogHostServiceCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApCounter=ogWifiApCounter, ogWebUserEntry=ogWebUserEntry, ogWifiApInterface=ogWifiApInterface, ogWifiApClientAp=ogWifiApClientAp, ogUpsState=ogUpsState, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialUserTable=ogSerialUserTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarmEventId=ogAlarmEventId, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortBreaks=ogSerialPortBreaks, ogHostTable=ogHostTable, ogEmdDioName=ogEmdDioName, ogSerialPortEntry=ogSerialPortEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserName=ogSerialUserName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsTable=ogUpsTable, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsConnectType=ogUpsConnectType, ogAlarmSummary=ogAlarmSummary, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsNotification=ogUpsNotification, ogStatus2Conformance=ogStatus2Conformance, ogCheckIndex=ogCheckIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmType=ogAlarmType, ogStatus2Compliances=ogStatus2Compliances, ogCellMessageNotification=ogCellMessageNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientTable=ogWifiClientTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckName=ogCheckName, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsEntry=ogUpsEntry, ogEmdDioTable=ogEmdDioTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialUserPort=ogSerialUserPort, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApSsid=ogWifiApSsid, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemRegistered=ogCellModemRegistered, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemIMSI=ogCellModemIMSI, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcCounter=ogRpcCounter, ogRpcOutletName=ogRpcOutletName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioState=ogEmdDioState, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTable=ogEmdTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientCounter=ogWifiClientCounter, ogCellModemEnabled=ogCellModemEnabled, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioEmd=ogEmdDioEmd, ogCellModemApn=ogCellModemApn, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdEnabled=ogEmdEnabled, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserIndex=ogWebUserIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApTable=ogWifiApTable, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientInterface=ogWifiClientInterface, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceIndex=ogHostServiceIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogStatus2Groups=ogStatus2Groups, ogUpsDescription=ogUpsDescription, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcIndex=ogRpcIndex, ogEmdHumidityEntry=ogEmdHumidityEntry)
