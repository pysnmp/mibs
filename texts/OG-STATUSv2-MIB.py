...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApTxPower=ogWifiApTxPower, ogHostTable=ogHostTable, ogSerialPortDSR=ogSerialPortDSR, ogUpsState=ogUpsState, ogEmdEntry=ogEmdEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmDevice=ogAlarmDevice, ogCheckEntry=ogCheckEntry, ogUpsHumidity=ogUpsHumidity, ogRpcCounter=ogRpcCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcEntry=ogRpcEntry, ogWifiApClientAp=ogWifiApClientAp, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemApn=ogCellModemApn, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletName=ogRpcOutletName, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmTime=ogAlarmTime, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemTable=ogCellModemTable, ogHostUserIndex=ogHostUserIndex, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortDTR=ogSerialPortDTR, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioCounter=ogEmdDioCounter, ogRpcName=ogRpcName, ogHostUserHostName=ogHostUserHostName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogStatus2Groups=ogStatus2Groups, ogRpcDescription=ogRpcDescription, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemTemperature=ogCellModemTemperature, ogWifiApTable=ogWifiApTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortIndex=ogSerialPortIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostServiceType=ogHostServiceType, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientTable=ogWifiApClientTable, ogCellMessageNotification=ogCellMessageNotification, ogCustomNotification=ogCustomNotification, ogRpcOutletTable=ogRpcOutletTable, ogHostUserHost=ogHostUserHost, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityEmd=ogEmdHumidityEmd, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserTable=ogHostUserTable, ogWifiApClientMac=ogWifiApClientMac, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortDCD=ogSerialPortDCD, ogCellModemEnabled=ogCellModemEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServiceIndex=ogHostServiceIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWebUserIndex=ogWebUserIndex, ogWifiApIndex=ogWifiApIndex, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletVoltage=ogRpcOutletVoltage, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientApMac=ogWifiClientApMac, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmType=ogAlarmType, ogWifiClientMode=ogWifiClientMode, ogRpcOutletRpc=ogRpcOutletRpc, ogHostIndex=ogHostIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioIndex=ogEmdDioIndex, ogEmdIndex=ogEmdIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemEntry=ogCellModemEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsNotification=ogUpsNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmName=ogAlarmName, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletIndex=ogRpcOutletIndex, ogStatus2=ogStatus2, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortRTS=ogSerialPortRTS, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialNumber=ogSerialNumber, ogWebUserName=ogWebUserName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsTable=ogUpsTable, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemIMSI=ogCellModemIMSI, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogNetInterfaceType=ogNetInterfaceType, ogCellApnNotification=ogCellApnNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioDirection=ogEmdDioDirection, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceNotification=ogHostServiceNotification, ogAlarmState=ogAlarmState, ogHostUserName=ogHostUserName, ogCellModemVendor=ogCellModemVendor, ogRpcIndex=ogRpcIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogStatus2Compliance=ogStatus2Compliance, ogHostServiceEntry=ogHostServiceEntry, ogUpsBatteryState=ogUpsBatteryState, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDescription=ogEmdDescription, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortLabel=ogSerialPortLabel, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioType=ogEmdDioType, ogCheckType=ogCheckType, ogAlarm=ogAlarm, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmUser=ogAlarmUser, ogSerialSignalNotification=ogSerialSignalNotification, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmSummary=ogAlarmSummary, ogCellNetworkNotification=ogCellNetworkNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogSystem=ogSystem, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostServiceStatus=ogHostServiceStatus, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserName=ogSerialUserName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioNotification=ogEmdDioNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsType=ogUpsType, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientInterface=ogWifiClientInterface, ogCheckName=ogCheckName, ogSerialUserPort=ogSerialUserPort, ogRpcInputNotification=ogRpcInputNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckIndex=ogCheckIndex, ogEmdTable=ogEmdTable, ogMibNotifications=ogMibNotifications, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserEntry=ogSerialUserEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRssi=ogWifiClientRssi, ogWebUserEntry=ogWebUserEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmInstance=ogAlarmInstance, ogWifiApSsid=ogWifiApSsid, ogWifiClientTable=ogWifiClientTable, ogWebUserNotification=ogWebUserNotification, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientEssid=ogWifiClientEssid, ogUpsEntry=ogUpsEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortEntry=ogSerialPortEntry, ogWifiApEntry=ogWifiApEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckTable=ogCheckTable, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioEntry=ogEmdDioEntry, ogHostUserNotification=ogHostUserNotification, ogRpcType=ogRpcType, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApCounter=ogWifiApCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdHumidityName=ogEmdHumidityName, ogRpcInputVoltage=ogRpcInputVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialUserIndex=ogSerialUserIndex, ogEmdName=ogEmdName, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServicePort=ogHostServicePort, ogSerialUserNotification=ogSerialUserNotification, ogUpsDescription=ogUpsDescription, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApEnabled=ogWifiApEnabled, ogAlarmCheck=ogAlarmCheck, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdEnabled=ogEmdEnabled, ogHostServiceTable=ogHostServiceTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmEventId=ogAlarmEventId, ogSerialPortMode=ogSerialPortMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostName=ogHostName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogFirmwareVersion=ogFirmwareVersion, ogCellModemIndex=ogCellModemIndex, ogHostEntry=ogHostEntry, ogWifiClientIndex=ogWifiClientIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceCounter=ogHostServiceCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsName=ogUpsName, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioName=ogEmdDioName, ogSerialPortParity=ogSerialPortParity, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioTable=ogEmdDioTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemTower=ogCellModemTower, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemModel=ogCellModemModel, ogHostPingNotification=ogHostPingNotification, ogSerialPortTable=ogSerialPortTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceHost=ogHostServiceHost, ogAlarmLogTable=ogAlarmLogTable, ogHostUserEntry=ogHostUserEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletState=ogRpcOutletState, ogStatus2Conformance=ogStatus2Conformance, ogUpsInputCurrent=ogUpsInputCurrent, ogCellDataNotification=ogCellDataNotification, ogStatus2Compliances=ogStatus2Compliances, ogUpsConnectType=ogUpsConnectType, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcTable=ogRpcTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioState=ogEmdDioState, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsIndex=ogUpsIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemCounter=ogCellModemCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserAddress=ogHostUserAddress, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserTable=ogWebUserTable, ogCellModemConnected=ogCellModemConnected, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletLoad=ogRpcOutletLoad, ogNetInterfaceName=ogNetInterfaceName, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsCounter=ogUpsCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogDialPoolHealthNotification=ogDialPoolHealthNotification)
