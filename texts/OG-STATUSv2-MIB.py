...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortParity=ogSerialPortParity, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceNotification=ogHostServiceNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcType=ogRpcType, ogRpcName=ogRpcName, ogCheckIndex=ogCheckIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioType=ogEmdDioType, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTable=ogEmdTable, ogRpcCounter=ogRpcCounter, ogEmdDioDescription=ogEmdDioDescription, ogAlarmName=ogAlarmName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdName=ogEmdName, ogAlarmType=ogAlarmType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientMode=ogWifiClientMode, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityName=ogEmdHumidityName, ogUpsType=ogUpsType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsState=ogUpsState, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckTable=ogCheckTable, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApInterface=ogWifiApInterface, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialUserStartTime=ogSerialUserStartTime, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogHostServiceType=ogHostServiceType, ogHostTable=ogHostTable, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemTable=ogCellModemTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApSsid=ogWifiApSsid, ogAlarmTime=ogAlarmTime, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmInstance=ogAlarmInstance, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogStatus2=ogStatus2, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWebUserTable=ogWebUserTable, ogHostUserIndex=ogHostUserIndex, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortLogLevel=ogSerialPortLogLevel, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsName=ogUpsName, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcConnectType=ogRpcConnectType, ogWebUserEntry=ogWebUserEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcEntry=ogRpcEntry, ogHostServiceStatus=ogHostServiceStatus, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApCounter=ogWifiApCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortDTR=ogSerialPortDTR, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemEnabled=ogCellModemEnabled, ogHostPingNotification=ogHostPingNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioNotification=ogEmdDioNotification, ogUpsEntry=ogUpsEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialNumber=ogSerialNumber, ogWifiApEntry=ogWifiApEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWebUserName=ogWebUserName, ogUpsCounter=ogUpsCounter, ogCheckDeviceName=ogCheckDeviceName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmDevice=ogAlarmDevice, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortTable=ogSerialPortTable, ogCustomNotification=ogCustomNotification, ogRpcIndex=ogRpcIndex, ogHostServiceEntry=ogHostServiceEntry, ogEmdConnectType=ogEmdConnectType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletVoltage=ogRpcOutletVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostUserStartTime=ogHostUserStartTime, ogCheckEntry=ogCheckEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientBitRate=ogWifiClientBitRate, ogCellApnNotification=ogCellApnNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcInputCurrent=ogRpcInputCurrent, ogCellMessageNotification=ogCellMessageNotification, ogUpsIndex=ogUpsIndex, ogEmdDescription=ogEmdDescription, ogUpsTable=ogUpsTable, ogSerialUserEntry=ogSerialUserEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostEntry=ogHostEntry, ogRpcOutletState=ogRpcOutletState, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientEntry=ogWifiClientEntry, ogNetInterfaceType=ogNetInterfaceType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioEntry=ogEmdDioEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckType=ogCheckType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserNotification=ogHostUserNotification, ogWebUserIndex=ogWebUserIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceTable=ogHostServiceTable, ogWifiApFrequency=ogWifiApFrequency, ogCellModemModel=ogCellModemModel, ogAlarmState=ogAlarmState, ogCellModemVendor=ogCellModemVendor, ogSerialUserTable=ogSerialUserTable, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialUserIndex=ogSerialUserIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemTower=ogCellModemTower, ogUpsInputNotification=ogUpsInputNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortDSR=ogSerialPortDSR, ogUpsDescription=ogUpsDescription, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserNotification=ogWebUserNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioName=ogEmdDioName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientTable=ogWifiApClientTable, ogMibNotifications=ogMibNotifications, ogNetInterfaceState=ogNetInterfaceState, ogRpcDescription=ogRpcDescription, ogSerialPortEntry=ogSerialPortEntry, ogCellModemEntry=ogCellModemEntry, ogAlarmUser=ogAlarmUser, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApIndex=ogWifiApIndex, ogHostUserTable=ogHostUserTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceCounter=ogHostServiceCounter, ogStatus2Compliance=ogStatus2Compliance, ogAlarmLogTable=ogAlarmLogTable, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserEntry=ogHostUserEntry, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmCheck=ogAlarmCheck, ogWifiApClientMac=ogWifiApClientMac, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortRTS=ogSerialPortRTS, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletEntry=ogRpcOutletEntry, ogHostUserHost=ogHostUserHost, ogAlarm=ogAlarm, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogPowerSupplyName=ogPowerSupplyName, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdEnabled=ogEmdEnabled, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostUserHostName=ogHostUserHostName, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemConnected=ogCellModemConnected, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientInterface=ogWifiClientInterface, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsConnectType=ogUpsConnectType, ogAlarmLogIndex=ogAlarmLogIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2Groups=ogStatus2Groups, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientTable=ogWifiClientTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletName=ogRpcOutletName, ogHostIndex=ogHostIndex, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientAp=ogWifiApClientAp, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientRssi=ogWifiApClientRssi, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApEnabled=ogWifiApEnabled, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdEntry=ogEmdEntry, ogCellModemIMSI=ogCellModemIMSI, ogEmdIndex=ogEmdIndex, ogEmdDioDirection=ogEmdDioDirection, ogSystem=ogSystem, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckResolveActions=ogCheckResolveActions, ogRpcTable=ogRpcTable, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioState=ogEmdDioState, ogSerialUserLabel=ogSerialUserLabel, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostName=ogHostName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCheckName=ogCheckName, ogSerialUserPort=ogSerialUserPort, ogUpsTemperature=ogUpsTemperature, ogSerialUserName=ogSerialUserName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostUserName=ogHostUserName, ogWifiClientCounter=ogWifiClientCounter, ogCheckRepeatTimeout=ogCheckRepeatTimeout, PYSNMP_MODULE_ID=ogStatus2, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemApn=ogCellModemApn, ogEmdDioCounter=ogEmdDioCounter, ogUpsNotification=ogUpsNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApTable=ogWifiApTable, ogHostServicePort=ogHostServicePort, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmIndex=ogCurrentAlarmIndex)
