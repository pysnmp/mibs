...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostIpV6Address=ogHostIpV6Address, ogCellModemTable=ogCellModemTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDioName=ogEmdDioName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogMibNotifications=ogMibNotifications, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserHost=ogHostUserHost, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcInputVoltage=ogRpcInputVoltage, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioEntry=ogEmdDioEntry, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemEntry=ogCellModemEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureTable=ogEmdTemperatureTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemIndex=ogCellModemIndex, ogEmdName=ogEmdName, ogWifiClientMode=ogWifiClientMode, ogSerialPortDataBits=ogSerialPortDataBits, ogCheckDeviceCheck=ogCheckDeviceCheck, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsEntry=ogUpsEntry, ogCellModemTower=ogCellModemTower, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortTable=ogSerialPortTable, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletTable=ogRpcOutletTable, ogHostServiceEntry=ogHostServiceEntry, ogUpsState=ogUpsState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserAddress=ogHostUserAddress, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientMac=ogWifiApClientMac, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcEntry=ogRpcEntry, ogCheckIndex=ogCheckIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogHostServiceType=ogHostServiceType, ogUpsCounter=ogUpsCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckResolveActions=ogCheckResolveActions, ogSerialNumber=ogSerialNumber, ogHostUserStartTime=ogHostUserStartTime, ogHostEntry=ogHostEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemApn=ogCellModemApn, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialUserIndex=ogSerialUserIndex, ogWifiApEntry=ogWifiApEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmDevice=ogAlarmDevice, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdEntry=ogEmdEntry, ogUpsTable=ogUpsTable, ogSerialUserNotification=ogSerialUserNotification, ogEmdIndex=ogEmdIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcName=ogRpcName, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmLogIndex=ogAlarmLogIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2Groups=ogStatus2Groups, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortMode=ogSerialPortMode, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellSignalNotification=ogCellSignalNotification, ogHostName=ogHostName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcType=ogRpcType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckEntry=ogCheckEntry, ogWebUserEntry=ogWebUserEntry, ogRpcOutletName=ogRpcOutletName, ogSerialPortDCD=ogSerialPortDCD, ogPowerSupplyName=ogPowerSupplyName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceType=ogNetInterfaceType, ogWifiApInterface=ogWifiApInterface, ogEmdTable=ogEmdTable, ogUpsIndex=ogUpsIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostUserName=ogHostUserName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogCellDataNotification=ogCellDataNotification, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserEntry=ogHostUserEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortRTS=ogSerialPortRTS, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApFrequency=ogWifiApFrequency, ogHostServiceCounter=ogHostServiceCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcTable=ogRpcTable, ogAlarmTime=ogAlarmTime, ogSerialUserName=ogSerialUserName, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemRegistered=ogCellModemRegistered, ogAlarmUser=ogAlarmUser, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmInstance=ogAlarmInstance, ogAlarmState=ogAlarmState, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellTowerNotification=ogCellTowerNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostPingNotification=ogHostPingNotification, ogSerialUserTable=ogSerialUserTable, ogWebUserTable=ogWebUserTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogStatus2Compliance=ogStatus2Compliance, ogRpcCounter=ogRpcCounter, ogWifiApCounter=ogWifiApCounter, ogSerialUserPort=ogSerialUserPort, ogWifiApClientRssi=ogWifiApClientRssi, ogNetInterfaceState=ogNetInterfaceState, ogUpsDescription=ogUpsDescription, ogCheckName=ogCheckName, ogWifiApSsid=ogWifiApSsid, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortDSR=ogSerialPortDSR, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputNotification=ogUpsOutputNotification, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserEntry=ogSerialUserEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogFirmwareVersion=ogFirmwareVersion, ogStatus2Conformance=ogStatus2Conformance, ogCheckTable=ogCheckTable, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemNetwork=ogCellModemNetwork, ogUpsName=ogUpsName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmSummary=ogAlarmSummary, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientInterface=ogWifiClientInterface, ogEmdEnabled=ogEmdEnabled, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmName=ogAlarmName, PYSNMP_MODULE_ID=ogStatus2, ogEmdDescription=ogEmdDescription, ogWebUserStartTime=ogWebUserStartTime, ogWebUserIndex=ogWebUserIndex, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemEnabled=ogCellModemEnabled, ogUpsHumidity=ogUpsHumidity, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserNotification=ogWebUserNotification, ogEmdDioType=ogEmdDioType, ogEmdConnectType=ogEmdConnectType, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsConnectType=ogUpsConnectType, ogUpsType=ogUpsType, ogEmdDioTable=ogEmdDioTable, ogHostUserIndex=ogHostUserIndex, ogWifiApTable=ogWifiApTable, ogWifiClientTable=ogWifiClientTable, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsNotification=ogUpsNotification, ogEmdDioDescription=ogEmdDioDescription)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientBitRate=ogWifiClientBitRate, ogStatus2Compliances=ogStatus2Compliances, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApIndex=ogWifiApIndex, ogSerialPortParity=ogSerialPortParity, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortIndex=ogSerialPortIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckDeviceName=ogCheckDeviceName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortEntry=ogSerialPortEntry, ogHostUserNotification=ogHostUserNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostTable=ogHostTable, ogEmdDioState=ogEmdDioState, ogHostUserHostName=ogHostUserHostName, ogWebUserName=ogWebUserName, ogSystem=ogSystem, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckType=ogCheckType, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostServicePort=ogHostServicePort, ogRpcOutletIndex=ogRpcOutletIndex, ogCustomNotification=ogCustomNotification, ogAlarm=ogAlarm, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserTable=ogHostUserTable, ogAlarmType=ogAlarmType, ogCellModemTemperature=ogCellModemTemperature, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmCheck=ogAlarmCheck, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcDescription=ogRpcDescription, ogCellModemCounter=ogCellModemCounter, ogCellModemIMSI=ogCellModemIMSI, ogRpcIndex=ogRpcIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostIndex=ogHostIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientTable=ogWifiApClientTable, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApEnabled=ogWifiApEnabled, ogUpsOutputPower=ogUpsOutputPower, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemModel=ogCellModemModel, ogBasicAlarmGroup=ogBasicAlarmGroup, ogStatus2=ogStatus2)
