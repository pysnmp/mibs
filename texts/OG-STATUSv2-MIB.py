...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApTxPower=ogWifiApTxPower, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemEntry=ogCellModemEntry, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemApn=ogCellModemApn, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemConnected=ogCellModemConnected, ogUpsNotification=ogUpsNotification, ogStatus2Compliances=ogStatus2Compliances, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemTable=ogCellModemTable, ogSerialPortDTR=ogSerialPortDTR, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostServiceHost=ogHostServiceHost, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserName=ogHostUserName, ogSerialPortParity=ogSerialPortParity, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogHostUserAddress=ogHostUserAddress, ogHostIpV4Address=ogHostIpV4Address, ogSystem=ogSystem, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientInterface=ogWifiClientInterface, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApEntry=ogWifiApEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceEntry=ogHostServiceEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmUser=ogAlarmUser, ogHostUserEntry=ogHostUserEntry, ogHostEntry=ogHostEntry, PYSNMP_MODULE_ID=ogStatus2, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcIndex=ogRpcIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserSourceAddress=ogWebUserSourceAddress, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWebUserEntry=ogWebUserEntry, ogCheckTable=ogCheckTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdDioIndex=ogEmdDioIndex, ogSerialUserEntry=ogSerialUserEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialUserPort=ogSerialUserPort, ogAlarmLogTable=ogAlarmLogTable, ogUpsState=ogUpsState, ogCellNetworkNotification=ogCellNetworkNotification, ogHostUserIndex=ogHostUserIndex, ogUpsTable=ogUpsTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogStatus2Conformance=ogStatus2Conformance, ogWifiApTable=ogWifiApTable, ogEmdEnabled=ogEmdEnabled, ogUpsOutputPower=ogUpsOutputPower, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmTable=ogCurrentAlarmTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellApnNotification=ogCellApnNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioCounter=ogEmdDioCounter, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientApMac=ogWifiClientApMac, ogRpcDescription=ogRpcDescription, ogUpsIndex=ogUpsIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortDSR=ogSerialPortDSR, ogEmdDescription=ogEmdDescription, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckDeviceName=ogCheckDeviceName, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmTime=ogAlarmTime, ogRpcType=ogRpcType, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryState=ogUpsBatteryState, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApInterface=ogWifiApInterface, ogRpcTable=ogRpcTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialUserStartTime=ogSerialUserStartTime, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortMode=ogSerialPortMode, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortEntry=ogSerialPortEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApEnabled=ogWifiApEnabled, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApSsid=ogWifiApSsid, ogUpsCounter=ogUpsCounter, ogCheckName=ogCheckName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogStatus2Compliance=ogStatus2Compliance, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcConnectType=ogRpcConnectType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellDataNotification=ogCellDataNotification, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceNotification=ogNetInterfaceNotification, ogMibNotifications=ogMibNotifications, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialUserIndex=ogSerialUserIndex, ogHostServicePort=ogHostServicePort, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckEntry=ogCheckEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortIndex=ogSerialPortIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcEntry=ogRpcEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsInputNotification=ogUpsInputNotification, ogCheckIndex=ogCheckIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckType=ogCheckType, ogHostIndex=ogHostIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApFrequency=ogWifiApFrequency, ogUpsConnectType=ogUpsConnectType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserHost=ogHostUserHost, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostServiceType=ogHostServiceType, ogHostName=ogHostName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsName=ogUpsName, ogUpsTemperature=ogUpsTemperature, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletName=ogRpcOutletName, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioType=ogEmdDioType, ogWebUserTable=ogWebUserTable, ogHostUserHostName=ogHostUserHostName, ogWifiApClientMac=ogWifiApClientMac, ogNetInterfaceType=ogNetInterfaceType, ogHostPingNotification=ogHostPingNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceIndex=ogHostServiceIndex, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceStatus=ogHostServiceStatus, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioNotification=ogEmdDioNotification, ogEmdIndex=ogEmdIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletTable=ogRpcOutletTable, ogCellModemModel=ogCellModemModel, ogCellTowerNotification=ogCellTowerNotification, ogHostTable=ogHostTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostUserTable=ogHostUserTable, ogAlarmEventId=ogAlarmEventId, ogAlarmName=ogAlarmName, ogAlarmType=ogAlarmType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceName=ogNetInterfaceName, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletState=ogRpcOutletState, ogHostIpV6Address=ogHostIpV6Address, ogUpsHumidity=ogUpsHumidity, ogAlarmInstance=ogAlarmInstance, ogWebUserIndex=ogWebUserIndex, ogWifiApCounter=ogWifiApCounter, ogDialPoolHealthNotification=ogDialPoolHealthNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioState=ogEmdDioState, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostServiceNotification=ogHostServiceNotification, ogWifiApIndex=ogWifiApIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogCustomNotification=ogCustomNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortRTS=ogSerialPortRTS, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioDirection=ogEmdDioDirection, ogSerialUserName=ogSerialUserName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmCheck=ogAlarmCheck, ogUpsType=ogUpsType, ogEmdDioTable=ogEmdDioTable, ogPowerSupplyName=ogPowerSupplyName, ogSerialNumber=ogSerialNumber, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioName=ogEmdDioName, ogEmdConnectType=ogEmdConnectType, ogUpsEntry=ogUpsEntry, ogEmdEntry=ogEmdEntry, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsDescription=ogUpsDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogStatus2=ogStatus2, ogSerialPortTable=ogSerialPortTable, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcCounter=ogRpcCounter, ogSerialUserNotification=ogSerialUserNotification, ogEmdName=ogEmdName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdTable=ogEmdTable, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarm=ogAlarm, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWebUserName=ogWebUserName, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogStatus2Groups=ogStatus2Groups, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemTower=ogCellModemTower, ogRpcName=ogRpcName, ogWifiClientCounter=ogWifiClientCounter, ogCheckResolveActions=ogCheckResolveActions, ogWebUserNotification=ogWebUserNotification, ogAlarmState=ogAlarmState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientMode=ogWifiClientMode, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortDCD=ogSerialPortDCD, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdHumidityNotification=ogEmdHumidityNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmDevice=ogAlarmDevice, ogHostServiceTable=ogHostServiceTable)
