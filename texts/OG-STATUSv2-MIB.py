...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmInstance=ogAlarmInstance, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserEntry=ogHostUserEntry, ogSerialPortDSR=ogSerialPortDSR, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostIndex=ogHostIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemTable=ogCellModemTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortDTR=ogSerialPortDTR, ogHostServiceEntry=ogHostServiceEntry, ogEmdConnectType=ogEmdConnectType, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcLogEnabled=ogRpcLogEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletName=ogRpcOutletName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdName=ogEmdName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryState=ogUpsBatteryState, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortLabel=ogSerialPortLabel, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDescription=ogEmdDescription, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsState=ogUpsState, ogEmdDioType=ogEmdDioType, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceTable=ogHostServiceTable, ogEmdDioName=ogEmdDioName, ogWebUserNotification=ogWebUserNotification, ogCheckTable=ogCheckTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceStatus=ogHostServiceStatus, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmState=ogAlarmState, ogSerialPatternNotification=ogSerialPatternNotification, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcInputVoltage=ogRpcInputVoltage, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckDeviceIndex=ogCheckDeviceIndex, ogStatus2Groups=ogStatus2Groups, ogSerialUserName=ogSerialUserName, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckType=ogCheckType, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcCounter=ogRpcCounter, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsType=ogUpsType, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialNumber=ogSerialNumber, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureName=ogEmdTemperatureName, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsCounter=ogUpsCounter, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogNetInterfaceState=ogNetInterfaceState, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckName=ogCheckName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcConnectType=ogRpcConnectType, ogWebUserTable=ogWebUserTable, ogHostUserTable=ogHostUserTable, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckEntry=ogCheckEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientMac=ogWifiApClientMac, ogUpsDescription=ogUpsDescription, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApEntry=ogWifiApEntry, ogCellModemRegistered=ogCellModemRegistered, ogHostUserIndex=ogHostUserIndex, ogWifiApFrequency=ogWifiApFrequency, ogStatus2Compliance=ogStatus2Compliance, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApEnabled=ogWifiApEnabled, ogAlarmUser=ogAlarmUser, ogAlarm=ogAlarm, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcEntry=ogRpcEntry, ogEmdDioEntry=ogEmdDioEntry, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletState=ogRpcOutletState, ogSerialPortDCD=ogSerialPortDCD, ogRpcDescription=ogRpcDescription, ogUpsHumidity=ogUpsHumidity, ogCellModemEntry=ogCellModemEntry, ogEmdDioCounter=ogEmdDioCounter, ogUpsTemperature=ogUpsTemperature, ogRpcName=ogRpcName, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckIndex=ogCheckIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcType=ogRpcType, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceType=ogHostServiceType, ogWebUserName=ogWebUserName, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemVendor=ogCellModemVendor, ogHostUserName=ogHostUserName, ogMibNotifications=ogMibNotifications, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioTable=ogEmdDioTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostEntry=ogHostEntry, ogEmdTable=ogEmdTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletTable=ogRpcOutletTable, ogPowerSupplyName=ogPowerSupplyName, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellDataNotification=ogCellDataNotification, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceNotification=ogHostServiceNotification, ogHostUserNotification=ogHostUserNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsNotification=ogUpsNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModemTower=ogCellModemTower, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientTable=ogWifiApClientTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserStartTime=ogHostUserStartTime, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemIMSI=ogCellModemIMSI, ogCellModemModel=ogCellModemModel, ogWifiApIndex=ogWifiApIndex, ogHostTable=ogHostTable, ogUpsOutputFrequency=ogUpsOutputFrequency, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserIndex=ogWebUserIndex, ogHostUserAddress=ogHostUserAddress, ogUpsIndex=ogUpsIndex, ogCellModemApn=ogCellModemApn, ogAlarmType=ogAlarmType, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmLogTable=ogAlarmLogTable, ogUpsEntry=ogUpsEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortTable=ogSerialPortTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdEntry=ogEmdEntry, ogWifiClientMode=ogWifiClientMode, ogCellApnNotification=ogCellApnNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserTable=ogSerialUserTable, ogAlarmName=ogAlarmName, ogCellMessageNotification=ogCellMessageNotification, ogCustomNotification=ogCustomNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserStartTime=ogWebUserStartTime, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmUser=ogCurrentAlarmUser, ogStatus2=ogStatus2, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsConnectType=ogUpsConnectType, ogSystem=ogSystem, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortParity=ogSerialPortParity, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortCTS=ogSerialPortCTS, ogEmdEnabled=ogEmdEnabled, ogAlarmTime=ogAlarmTime, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemIndex=ogCellModemIndex, ogWifiApCounter=ogWifiApCounter, ogUpsTable=ogUpsTable, ogEmdDioState=ogEmdDioState, ogStatus2Compliances=ogStatus2Compliances, ogAlarmEventId=ogAlarmEventId, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortMode=ogSerialPortMode, ogHostServicePort=ogHostServicePort, ogRpcIndex=ogRpcIndex, ogAlarmSummary=ogAlarmSummary, ogEmdIndex=ogEmdIndex, ogEmdDioNotification=ogEmdDioNotification, ogWifiApTxPower=ogWifiApTxPower, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientCounter=ogWifiClientCounter, ogRpcInputCurrent=ogRpcInputCurrent, ogHostUserHost=ogHostUserHost, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientTable=ogWifiClientTable, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsName=ogUpsName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostName=ogHostName, ogCellModemConnected=ogCellModemConnected, ogRpcTable=ogRpcTable, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmName=ogCurrentAlarmName, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApTable=ogWifiApTable, ogAlarmCheck=ogAlarmCheck, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex)
