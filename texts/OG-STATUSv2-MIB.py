...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyIndex=ogPowerSupplyIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostEntry=ogHostEntry, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsLogEnabled=ogUpsLogEnabled, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcName=ogRpcName, ogRpcOutletName=ogRpcOutletName, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemTemperature=ogCellModemTemperature, ogWifiApEntry=ogWifiApEntry, ogUpsType=ogUpsType, ogWifiClientMode=ogWifiClientMode, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientCounter=ogWifiClientCounter, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogStatus2Conformance=ogStatus2Conformance, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserHostName=ogHostUserHostName, ogEmdDioType=ogEmdDioType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarm=ogAlarm, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceType=ogNetInterfaceType, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmUser=ogAlarmUser, ogWifiApIndex=ogWifiApIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWebUserTable=ogWebUserTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientTable=ogWifiClientTable, ogSerialUserTable=ogSerialUserTable, ogSerialPortLabel=ogSerialPortLabel, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdConnectType=ogEmdConnectType, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioIndex=ogEmdDioIndex, ogCellModemTower=ogCellModemTower, ogSerialPortEntry=ogSerialPortEntry, ogCellTowerNotification=ogCellTowerNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputPower=ogUpsOutputPower, ogFirmwareVersion=ogFirmwareVersion, ogRpcDescription=ogRpcDescription, ogUpsTable=ogUpsTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioState=ogEmdDioState, ogHostUserHost=ogHostUserHost, ogSerialPortTable=ogSerialPortTable, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcEntry=ogRpcEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientMac=ogWifiApClientMac, ogHostUserEntry=ogHostUserEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostUserAddress=ogHostUserAddress, ogHostServiceNotification=ogHostServiceNotification, ogHostName=ogHostName, ogRpcConnectType=ogRpcConnectType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserName=ogWebUserName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApTxPower=ogWifiApTxPower, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApSsid=ogWifiApSsid, ogWebUserNotification=ogWebUserNotification, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostServiceStatus=ogHostServiceStatus, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioDirection=ogEmdDioDirection, ogUpsState=ogUpsState, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityName=ogEmdHumidityName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceType=ogHostServiceType, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcLogEnabled=ogRpcLogEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcIndex=ogRpcIndex, PYSNMP_MODULE_ID=ogStatus2, ogSystem=ogSystem, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortDSR=ogSerialPortDSR, ogCellModemTable=ogCellModemTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostTable=ogHostTable, ogAlarmType=ogAlarmType, ogUpsCounter=ogUpsCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRssi=ogWifiClientRssi, ogEmdDescription=ogEmdDescription, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioCounter=ogEmdDioCounter, ogStatus2=ogStatus2, ogCheckEntry=ogCheckEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmDevice=ogAlarmDevice, ogSerialPortMode=ogSerialPortMode, ogCellApnNotification=ogCellApnNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdName=ogEmdName, ogWifiApInterface=ogWifiApInterface, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsEntry=ogUpsEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialUserName=ogSerialUserName, ogRpcOutletLoad=ogRpcOutletLoad, ogWebUserEntry=ogWebUserEntry, ogAlarmTime=ogAlarmTime, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsInputFrequency=ogUpsInputFrequency, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserName=ogHostUserName, ogCheckDeviceName=ogCheckDeviceName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckIndex=ogCheckIndex, ogRpcTable=ogRpcTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmCheck=ogAlarmCheck, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmEventId=ogAlarmEventId, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientApMac=ogWifiClientApMac, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdEnabled=ogEmdEnabled, ogHostIndex=ogHostIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostUserStartTime=ogHostUserStartTime, ogCheckTable=ogCheckTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApTable=ogWifiApTable, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcCounter=ogRpcCounter, ogHostPingNotification=ogHostPingNotification, ogCellDataNotification=ogCellDataNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmSummary=ogAlarmSummary, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWebUserIndex=ogWebUserIndex, ogCellModemModel=ogCellModemModel, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortRTS=ogSerialPortRTS, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserPort=ogSerialUserPort, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmState=ogAlarmState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDioNotification=ogEmdDioNotification, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortParity=ogSerialPortParity, ogCellModem4gRssi=ogCellModem4gRssi, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemIMSI=ogCellModemIMSI, ogUpsDescription=ogUpsDescription, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogMibNotifications=ogMibNotifications, ogHostServiceIndex=ogHostServiceIndex, ogCellModemCounter=ogCellModemCounter, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckName=ogCheckName, ogHostServicePort=ogHostServicePort, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdDioName=ogEmdDioName, ogWifiApClientTable=ogWifiApClientTable, ogHostUserTable=ogHostUserTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioTable=ogEmdDioTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmName=ogAlarmName, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceHost=ogHostServiceHost, ogWifiClientEntry=ogWifiClientEntry, ogAlarmInstance=ogAlarmInstance, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortDCD=ogSerialPortDCD, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcInputCurrent=ogRpcInputCurrent, ogHostIpV4Address=ogHostIpV4Address, ogCellModemApn=ogCellModemApn, ogUpsName=ogUpsName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceEntry=ogHostServiceEntry, ogAlarmLogTable=ogAlarmLogTable, ogCellModemVendor=ogCellModemVendor, ogUpsNotification=ogUpsNotification, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApEnabled=ogWifiApEnabled, ogSerialUserIndex=ogSerialUserIndex, ogUpsConnectType=ogUpsConnectType, ogEmdIndex=ogEmdIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsIndex=ogUpsIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemIndex=ogCellModemIndex, ogHostServiceCounter=ogHostServiceCounter, ogRpcType=ogRpcType, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogStatus2Compliance=ogStatus2Compliance, ogCellModemConnected=ogCellModemConnected, ogWifiApCounter=ogWifiApCounter, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostServiceTable=ogHostServiceTable, ogRpcOutletState=ogRpcOutletState, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdEntry=ogEmdEntry, ogSerialPortCTS=ogSerialPortCTS, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckType=ogCheckType, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTable=ogEmdTable, ogWebUserStartTime=ogWebUserStartTime, ogSerialNumber=ogSerialNumber, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityValue=ogEmdHumidityValue, ogCustomNotification=ogCustomNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureCounter=ogEmdTemperatureCounter)
