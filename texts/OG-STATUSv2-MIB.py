...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmSummary=ogAlarmSummary, ogHostEntry=ogHostEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioCounter=ogEmdDioCounter, ogSystem=ogSystem, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcName=ogRpcName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWebUserName=ogWebUserName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserLabel=ogSerialUserLabel, ogWifiApSsid=ogWifiApSsid, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApTable=ogWifiApTable, ogEmdDioNotification=ogEmdDioNotification, ogEmdDescription=ogEmdDescription, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserNotification=ogHostUserNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserHostName=ogHostUserHostName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceStatus=ogHostServiceStatus, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientTable=ogWifiClientTable, ogSerialPortRTS=ogSerialPortRTS, ogHostIndex=ogHostIndex, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceIndex=ogHostServiceIndex, ogCellDataNotification=ogCellDataNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckName=ogCheckName, ogCellModemConnected=ogCellModemConnected, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellApnNotification=ogCellApnNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioTable=ogEmdDioTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserHost=ogHostUserHost, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientMode=ogWifiClientMode, ogRpcTable=ogRpcTable, ogSerialPortEntry=ogSerialPortEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostUserAddress=ogHostUserAddress, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarmDevice=ogAlarmDevice, ogEmdDioState=ogEmdDioState, ogSerialSignalNotification=ogSerialSignalNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmCheck=ogAlarmCheck, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcOutletTotal=ogRpcOutletTotal, ogStatus2Compliance=ogStatus2Compliance, ogUpsCounter=ogUpsCounter, ogHostServiceType=ogHostServiceType, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletState=ogRpcOutletState, ogSerialUserName=ogSerialUserName, ogAlarmName=ogAlarmName, ogRpcType=ogRpcType, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioName=ogEmdDioName, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmLogTable=ogAlarmLogTable, ogUpsDescription=ogUpsDescription, ogEmdConnectType=ogEmdConnectType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientAp=ogWifiApClientAp, ogHostUserTable=ogHostUserTable, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarm=ogAlarm, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialUserNotification=ogSerialUserNotification, ogRpcCounter=ogRpcCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientEssid=ogWifiClientEssid, ogAlarmInstance=ogAlarmInstance, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsType=ogUpsType, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientFrequency=ogWifiClientFrequency, PYSNMP_MODULE_ID=ogStatus2, ogHostUserEntry=ogHostUserEntry, ogRpcDescription=ogRpcDescription, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletTable=ogRpcOutletTable, ogWifiApTxPower=ogWifiApTxPower, ogCustomNotification=ogCustomNotification, ogSerialNumber=ogSerialNumber, ogWifiApFrequency=ogWifiApFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmState=ogAlarmState, ogWifiApClientIndex=ogWifiApClientIndex, ogNetInterfaceName=ogNetInterfaceName, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortCTS=ogSerialPortCTS, ogCellModemModel=ogCellModemModel, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemTower=ogCellModemTower, ogRpcEntry=ogRpcEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioDirection=ogEmdDioDirection, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsState=ogUpsState, ogHostName=ogHostName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserName=ogHostUserName, ogSerialPortMode=ogSerialPortMode, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmType=ogAlarmType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletName=ogRpcOutletName, ogWebUserStartTime=ogWebUserStartTime, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialUserPort=ogSerialUserPort, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemEntry=ogCellModemEntry, ogCellModemApn=ogCellModemApn, ogUpsNotification=ogUpsNotification, ogCellModemEnabled=ogCellModemEnabled, ogHostServiceTable=ogHostServiceTable, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckType=ogCheckType, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcConnectType=ogRpcConnectType, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientTable=ogWifiApClientTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWebUserEntry=ogWebUserEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogMibNotifications=ogMibNotifications, ogWifiApEntry=ogWifiApEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientEntry=ogWifiClientEntry, ogHostUserStartTime=ogHostUserStartTime, ogEmdEntry=ogEmdEntry, ogEmdDioEntry=ogEmdDioEntry, ogSerialUserTable=ogSerialUserTable, ogStatus2=ogStatus2, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcIndex=ogRpcIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmUser=ogAlarmUser, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckTable=ogCheckTable, ogUpsTable=ogUpsTable, ogSerialPortIndex=ogSerialPortIndex, ogCellModemVendor=ogCellModemVendor, ogWebUserNotification=ogWebUserNotification, ogUpsHumidity=ogUpsHumidity, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmEventId=ogAlarmEventId, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdEnabled=ogEmdEnabled, ogUpsIndex=ogUpsIndex, ogWifiApClientMac=ogWifiApClientMac, ogWebUserIndex=ogWebUserIndex, ogWifiApInterface=ogWifiApInterface, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellMessageNotification=ogCellMessageNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputVoltage=ogUpsInputVoltage, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortParity=ogSerialPortParity, ogWifiClientApMac=ogWifiClientApMac, ogCheckEntry=ogCheckEntry, ogUpsName=ogUpsName, ogAlarmTime=ogAlarmTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsConnectType=ogUpsConnectType, ogStatus2Compliances=ogStatus2Compliances, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdDioDescription=ogEmdDioDescription, ogUpsTemperature=ogUpsTemperature, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostTable=ogHostTable, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemTable=ogCellModemTable, ogCellModemCounter=ogCellModemCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWebUserTable=ogWebUserTable, ogHostServicePort=ogHostServicePort, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckResolveActions=ogCheckResolveActions, ogHostUserIndex=ogHostUserIndex, ogEmdName=ogEmdName, ogWifiApEnabled=ogWifiApEnabled, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellSignalNotification=ogCellSignalNotification, ogEmdTable=ogEmdTable, ogHostServiceHost=ogHostServiceHost, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientIndex=ogWifiClientIndex, ogEmdHumidityName=ogEmdHumidityName, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckDeviceName=ogCheckDeviceName, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemIMSI=ogCellModemIMSI, ogEmdIndex=ogEmdIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApIndex=ogWifiApIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApCounter=ogWifiApCounter, ogEmdDioType=ogEmdDioType, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsEntry=ogUpsEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckIndex=ogCheckIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemNetwork=ogCellModemNetwork, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemRegistered=ogCellModemRegistered)
