...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Unsigned32, iso, Bits, IpAddress, MibIdentifier, ObjectIdentity, NotificationType, ModuleIdentity, Integer32, Counter32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Unsigned32", "iso", "Bits", "IpAddress", "MibIdentifier", "ObjectIdentity", "NotificationType", "ModuleIdentity", "Integer32", "Counter32", "Gauge32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcType=ogRpcType, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialUserName=ogSerialUserName, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientInterface=ogWifiClientInterface, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmSummary=ogAlarmSummary, ogCellModemTower=ogCellModemTower, ogAlarmLogEntry=ogAlarmLogEntry, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserName=ogHostUserName, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioState=ogEmdDioState, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostUserIndex=ogHostUserIndex, ogUpsDescription=ogUpsDescription, ogHostServiceTable=ogHostServiceTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServicePort=ogHostServicePort, ogEmdDioType=ogEmdDioType, ogWebUserName=ogWebUserName, ogUpsCounter=ogUpsCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserNotification=ogHostUserNotification, ogAlarmType=ogAlarmType, ogCellModemTemperature=ogCellModemTemperature, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmType=ogCurrentAlarmType, ogCustomNotification=ogCustomNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogStatus2Groups=ogStatus2Groups, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsNotification=ogUpsNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDescription=ogEmdDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserNotification=ogSerialUserNotification, ogRpcEntry=ogRpcEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsType=ogUpsType, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdConnectType=ogEmdConnectType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsState=ogUpsState, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortEntry=ogSerialPortEntry, ogHostUserHost=ogHostUserHost, ogEmdIndex=ogEmdIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApIndex=ogWifiApIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcIndex=ogRpcIndex, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioNotification=ogEmdDioNotification, ogEmdName=ogEmdName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialNumber=ogSerialNumber, ogCheckDeviceName=ogCheckDeviceName, ogFirmwareVersion=ogFirmwareVersion, ogWebUserTable=ogWebUserTable, ogUpsName=ogUpsName, ogCellModemIndex=ogCellModemIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserPort=ogSerialUserPort, ogCheckTable=ogCheckTable, ogWebUserEntry=ogWebUserEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcInputNotification=ogRpcInputNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostIpV4Address=ogHostIpV4Address, ogWebUserIndex=ogWebUserIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWebUserSourcePort=ogWebUserSourcePort, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcName=ogRpcName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmInstance=ogAlarmInstance, ogHostEntry=ogHostEntry, ogStatus2=ogStatus2, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApFrequency=ogWifiApFrequency, ogCellModemSessionTime=ogCellModemSessionTime, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsTable=ogUpsTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmEventId=ogAlarmEventId, ogAlarmCheck=ogAlarmCheck, ogUpsIndex=ogUpsIndex, ogCellModemModel=ogCellModemModel, ogHostServiceHost=ogHostServiceHost, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApEntry=ogWifiApEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcCounter=ogRpcCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientTable=ogWifiClientTable, ogCellModemConnected=ogCellModemConnected, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostTable=ogHostTable, ogMibNotifications=ogMibNotifications, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioEntry=ogEmdDioEntry, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserTable=ogHostUserTable, ogCellModemEntry=ogCellModemEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostIndex=ogHostIndex, ogHostIpV6Address=ogHostIpV6Address, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortDSR=ogSerialPortDSR, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckEntry=ogCheckEntry, ogStatus2Compliances=ogStatus2Compliances, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmName=ogAlarmName, ogHostServiceNotification=ogHostServiceNotification, ogCellModemTable=ogCellModemTable, ogUpsOutputPower=ogUpsOutputPower, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellMessageNotification=ogCellMessageNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsLogEnabled=ogUpsLogEnabled, ogBasicStatusGroup=ogBasicStatusGroup, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortRTS=ogSerialPortRTS, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmUser=ogAlarmUser, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTable=ogEmdTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioTable=ogEmdDioTable, ogRpcConnectType=ogRpcConnectType, ogWifiApTxPower=ogWifiApTxPower, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioIndex=ogEmdDioIndex, ogWifiApTable=ogWifiApTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialUserLabel=ogSerialUserLabel, ogAlarmDevice=ogAlarmDevice, ogHostServiceCounter=ogHostServiceCounter, ogUpsTemperature=ogUpsTemperature, ogSerialPortCTS=ogSerialPortCTS, ogCellTowerNotification=ogCellTowerNotification, ogCellSignalNotification=ogCellSignalNotification, ogUpsEntry=ogUpsEntry, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckResolveActions=ogCheckResolveActions, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckType=ogCheckType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostUserHostName=ogHostUserHostName, ogRpcTable=ogRpcTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletState=ogRpcOutletState, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserTable=ogSerialUserTable, ogWifiClientApMac=ogWifiClientApMac, ogCellDataNotification=ogCellDataNotification, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortParity=ogSerialPortParity, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientMode=ogWifiClientMode, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServiceType=ogHostServiceType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostName=ogHostName, ogCellModemApn=ogCellModemApn, ogHostUserAddress=ogHostUserAddress, ogWifiApClientTable=ogWifiApClientTable, ogHostServiceIndex=ogHostServiceIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmTime=ogAlarmTime, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioEmd=ogEmdDioEmd, ogRpcOutletTable=ogRpcOutletTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientCounter=ogWifiClientCounter, ogHostPingNotification=ogHostPingNotification, ogCellApnNotification=ogCellApnNotification, ogRpcDescription=ogRpcDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialUserIndex=ogSerialUserIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletName=ogRpcOutletName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioName=ogEmdDioName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemCounter=ogCellModemCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemVendor=ogCellModemVendor, ogSerialPortIndex=ogSerialPortIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2Conformance=ogStatus2Conformance, ogHostUserEntry=ogHostUserEntry, ogCheckName=ogCheckName, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWebUserNotification=ogWebUserNotification, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApInterface=ogWifiApInterface, ogAlarm=ogAlarm, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdEntry=ogEmdEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmState=ogAlarmState, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdEnabled=ogEmdEnabled, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientIndex=ogWifiClientIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortTable=ogSerialPortTable, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckIndex=ogCheckIndex, ogCellModemEnabled=ogCellModemEnabled, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsOutputLoad=ogUpsOutputLoad, ogSystem=ogSystem)
