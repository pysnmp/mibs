...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientEssid=ogWifiClientEssid, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserAddress=ogHostUserAddress, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemApn=ogCellModemApn, ogUpsInputNotification=ogUpsInputNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogCustomNotification=ogCustomNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWebUserTable=ogWebUserTable, ogHostServiceNotification=ogHostServiceNotification, ogCellModemRegistered=ogCellModemRegistered, ogCellModemTable=ogCellModemTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdDioName=ogEmdDioName, ogRpcOutletName=ogRpcOutletName, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogCellApnNotification=ogCellApnNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientApMac=ogWifiClientApMac, ogUpsDescription=ogUpsDescription, ogStatus2Compliances=ogStatus2Compliances, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserHost=ogHostUserHost, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioNotification=ogEmdDioNotification, ogHostServicePort=ogHostServicePort, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsTable=ogUpsTable, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortLabel=ogSerialPortLabel, ogHostUserIndex=ogHostUserIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemCounter=ogCellModemCounter, ogEmdName=ogEmdName, ogSerialPortDCD=ogSerialPortDCD, ogHostPingNotification=ogHostPingNotification, ogUpsEntry=ogUpsEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceName=ogNetInterfaceName, ogEmdDescription=ogEmdDescription, ogHostTable=ogHostTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortDSR=ogSerialPortDSR, ogAlarmSummary=ogAlarmSummary, ogRpcInputNotification=ogRpcInputNotification, ogSystem=ogSystem, ogHostUserHostName=ogHostUserHostName, ogCellModemIndex=ogCellModemIndex, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioEntry=ogEmdDioEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceType=ogHostServiceType, ogEmdTemperatureName=ogEmdTemperatureName, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletEntry=ogRpcOutletEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmTime=ogAlarmTime, ogHostUserNotification=ogHostUserNotification, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyName=ogPowerSupplyName, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsTemperature=ogUpsTemperature, ogAlarmUser=ogAlarmUser, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemConnected=ogCellModemConnected, ogWebUserNotification=ogWebUserNotification, ogWifiApTxPower=ogWifiApTxPower, ogCellDataNotification=ogCellDataNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletLoad=ogRpcOutletLoad, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientTable=ogWifiClientTable, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdEntry=ogEmdEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApSsid=ogWifiApSsid, ogSerialPortRTS=ogSerialPortRTS, ogCellModemEntry=ogCellModemEntry, ogCheckType=ogCheckType, ogWifiApIndex=ogWifiApIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceState=ogNetInterfaceState, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmEventId=ogAlarmEventId, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdIndex=ogEmdIndex, ogRpcOutletState=ogRpcOutletState, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialUserPort=ogSerialUserPort, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceTable=ogHostServiceTable, ogSerialPortMode=ogSerialPortMode, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostUserEntry=ogHostUserEntry, ogWifiApCounter=ogWifiApCounter, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortTable=ogSerialPortTable, ogWifiClientRssi=ogWifiClientRssi, ogCheckIndex=ogCheckIndex, ogStatus2=ogStatus2, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmInstance=ogAlarmInstance, ogHostServiceStatus=ogHostServiceStatus, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcCounter=ogRpcCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioType=ogEmdDioType, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientIndex=ogWifiClientIndex, ogUpsConnectType=ogUpsConnectType, ogAlarmState=ogAlarmState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortParityErrors=ogSerialPortParityErrors, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialNumber=ogSerialNumber, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostName=ogHostName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientMode=ogWifiClientMode, ogCellModemTower=ogCellModemTower, ogUpsName=ogUpsName, ogWifiApInterface=ogWifiApInterface, ogHostEntry=ogHostEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApEntry=ogWifiApEntry, ogSerialUserNotification=ogSerialUserNotification, ogRpcType=ogRpcType, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialUserEntry=ogSerialUserEntry, ogCellModemModel=ogCellModemModel, ogWifiApTable=ogWifiApTable, ogWifiApClientMac=ogWifiApClientMac, ogHostServiceIndex=ogHostServiceIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModem4gRssi=ogCellModem4gRssi, ogCellTowerNotification=ogCellTowerNotification, ogCheckName=ogCheckName, ogEmdDioState=ogEmdDioState, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDioIndex=ogEmdDioIndex, ogHostServiceHost=ogHostServiceHost, ogUpsCounter=ogUpsCounter, ogMibNotifications=ogMibNotifications, ogUpsNotification=ogUpsNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserTable=ogSerialUserTable, ogCellModemIMSI=ogCellModemIMSI, ogUpsState=ogUpsState, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmName=ogAlarmName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortIndex=ogSerialPortIndex, ogEmdConnectType=ogEmdConnectType, ogUpsType=ogUpsType, ogHostIpV4Address=ogHostIpV4Address, ogHostUserTable=ogHostUserTable, ogSerialUserName=ogSerialUserName, ogCurrentAlarmSummary=ogCurrentAlarmSummary)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserLabel=ogSerialUserLabel, ogWebUserName=ogWebUserName, ogRpcTable=ogRpcTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcName=ogRpcName, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutletNotification=ogRpcOutletNotification, ogCellMessageNotification=ogCellMessageNotification, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsIndex=ogUpsIndex, ogUpsOutputPower=ogUpsOutputPower, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortDTR=ogSerialPortDTR, ogCellModemNetwork=ogCellModemNetwork, ogAlarmLogTable=ogAlarmLogTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioTable=ogEmdDioTable, ogRpcEntry=ogRpcEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostIpV6Address=ogHostIpV6Address, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletTable=ogRpcOutletTable, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmType=ogAlarmType, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserName=ogHostUserName, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApEnabled=ogWifiApEnabled, ogCheckTable=ogCheckTable, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmDevice=ogAlarmDevice, ogRpcIndex=ogRpcIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckEntry=ogCheckEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdTable=ogEmdTable, ogUpsHumidity=ogUpsHumidity, ogAlarm=ogAlarm, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryState=ogUpsBatteryState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogHostIndex=ogHostIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogStatus2Conformance=ogStatus2Conformance, ogRpcDescription=ogRpcDescription)
