...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmType=ogAlarmType, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmTriggerValue=ogAlarmTriggerValue, ogAlarmName=ogAlarmName, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsTable=ogUpsTable, ogRpcConnectType=ogRpcConnectType, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceTable=ogHostServiceTable, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryState=ogUpsBatteryState, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostEntry=ogHostEntry, ogWifiApEntry=ogWifiApEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogFirmwareVersion=ogFirmwareVersion, ogCellModemTable=ogCellModemTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserHost=ogHostUserHost, ogUpsEntry=ogUpsEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletState=ogRpcOutletState, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcEntry=ogRpcEntry, ogSerialUserNotification=ogSerialUserNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmDevice=ogAlarmDevice, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApInterface=ogWifiApInterface, ogCheckTable=ogCheckTable, ogCheckEntry=ogCheckEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckIndex=ogCheckIndex, ogWebUserName=ogWebUserName, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortParity=ogSerialPortParity, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcName=ogRpcName, ogHostServicePort=ogHostServicePort, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPatternNotification=ogSerialPatternNotification, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogStatus2Groups=ogStatus2Groups, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdEnabled=ogEmdEnabled, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioState=ogEmdDioState, ogAlarmEventId=ogAlarmEventId, ogSerialUserEntry=ogSerialUserEntry, ogCellModemRegistered=ogCellModemRegistered, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioDescription=ogEmdDioDescription, ogWifiApTable=ogWifiApTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcDescription=ogRpcDescription, ogUpsNotification=ogUpsNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletName=ogRpcOutletName, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityName=ogEmdHumidityName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostServiceCounter=ogHostServiceCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdIndex=ogEmdIndex, ogWifiClientCounter=ogWifiClientCounter, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTable=ogEmdTable, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServiceEntry=ogHostServiceEntry, ogRpcTable=ogRpcTable, ogUpsDescription=ogUpsDescription, ogCellMessageNotification=ogCellMessageNotification, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialUserName=ogSerialUserName, ogWebUserNotification=ogWebUserNotification, ogCheckType=ogCheckType, PYSNMP_MODULE_ID=ogStatus2, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserHostName=ogHostUserHostName, ogCellModemTemperature=ogCellModemTemperature, ogHostUserIndex=ogHostUserIndex, ogHostUserName=ogHostUserName, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckName=ogCheckName, ogAlarmInstance=ogAlarmInstance, ogWebUserEntry=ogWebUserEntry, ogWifiApIndex=ogWifiApIndex, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceType=ogNetInterfaceType, ogUpsHumidity=ogUpsHumidity, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemModel=ogCellModemModel, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsCounter=ogUpsCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdConnectType=ogEmdConnectType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckResetTimeout=ogCheckResetTimeout, ogHostUserNotification=ogHostUserNotification, ogSerialPortMode=ogSerialPortMode, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortRTS=ogSerialPortRTS, ogCellModemEntry=ogCellModemEntry, ogWifiApSsid=ogWifiApSsid, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemApn=ogCellModemApn, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemIMSI=ogCellModemIMSI, ogAlarmUser=ogAlarmUser, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSystem=ogSystem, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserTable=ogWebUserTable, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApCounter=ogWifiApCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemCounter=ogCellModemCounter, ogEmdEntry=ogEmdEntry, ogEmdDioTable=ogEmdDioTable, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemVendor=ogCellModemVendor, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioNotification=ogEmdDioNotification, ogCellTowerNotification=ogCellTowerNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemTower=ogCellModemTower, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceHost=ogHostServiceHost, ogCellModemNetwork=ogCellModemNetwork, ogRpcCounter=ogRpcCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckDeviceCheck=ogCheckDeviceCheck, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdName=ogEmdName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletTotal=ogRpcOutletTotal, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioType=ogEmdDioType, ogHostServiceStatus=ogHostServiceStatus, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemEnabled=ogCellModemEnabled, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsConnectType=ogUpsConnectType, ogCellModemIndex=ogCellModemIndex, ogHostPingNotification=ogHostPingNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortTable=ogSerialPortTable, ogRpcOutputNotification=ogRpcOutputNotification, ogHostUserTable=ogHostUserTable, ogHostServiceType=ogHostServiceType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmTime=ogAlarmTime, ogEmdDescription=ogEmdDescription, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsInputNotification=ogUpsInputNotification, ogSerialUserTable=ogSerialUserTable, ogUpsIndex=ogUpsIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortIndex=ogSerialPortIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcType=ogRpcType, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientMode=ogWifiClientMode, ogStatus2Compliances=ogStatus2Compliances, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletTable=ogRpcOutletTable, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsName=ogUpsName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostName=ogHostName, ogUpsLogEnabled=ogUpsLogEnabled, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcIndex=ogRpcIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogStatus2Compliance=ogStatus2Compliance, ogMibNotifications=ogMibNotifications, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmSummary=ogAlarmSummary, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogStatus2Conformance=ogStatus2Conformance, ogCustomNotification=ogCustomNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckDeviceName=ogCheckDeviceName, ogWebUserStartTime=ogWebUserStartTime, ogStatus2=ogStatus2, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogNetInterfaceName=ogNetInterfaceName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarm=ogAlarm, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialNumber=ogSerialNumber, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioName=ogEmdDioName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApTxPower=ogWifiApTxPower, ogCellModemConnected=ogCellModemConnected, ogSerialUserLabel=ogSerialUserLabel, ogHostIndex=ogHostIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogHostTable=ogHostTable, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserEntry=ogHostUserEntry, ogWifiClientIndex=ogWifiClientIndex, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioEntry=ogEmdDioEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogCellDataNotification=ogCellDataNotification, ogUpsType=ogUpsType, ogEmdDioEmd=ogEmdDioEmd, ogEmdDioDirection=ogEmdDioDirection, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmState=ogAlarmState, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortDCD=ogSerialPortDCD, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsState=ogUpsState, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialUserPort=ogSerialUserPort)
