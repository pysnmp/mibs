...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcName=ogRpcName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostTable=ogHostTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientRssi=ogWifiClientRssi, ogUpsInputVoltage=ogUpsInputVoltage, ogMibNotifications=ogMibNotifications, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortParity=ogSerialPortParity, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogStatus2Groups=ogStatus2Groups, ogCellModemEnabled=ogCellModemEnabled, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortCTS=ogSerialPortCTS, ogHostEntry=ogHostEntry, ogHostIpV4Address=ogHostIpV4Address, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWebUserIndex=ogWebUserIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmTime=ogAlarmTime, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortEntry=ogSerialPortEntry, ogHostUserHostName=ogHostUserHostName, ogAlarmLogIndex=ogAlarmLogIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckType=ogCheckType, ogCellModemIndex=ogCellModemIndex, ogStatus2Compliance=ogStatus2Compliance, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortDCD=ogSerialPortDCD, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletState=ogRpcOutletState, ogEmdEntry=ogEmdEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioState=ogEmdDioState, ogHostName=ogHostName, ogHostUserName=ogHostUserName, ogNetInterfaceName=ogNetInterfaceName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmEventId=ogAlarmEventId, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsTable=ogUpsTable, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmName=ogAlarmName, ogHostUserEntry=ogHostUserEntry, ogRpcOutletName=ogRpcOutletName, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostServiceType=ogHostServiceType, ogWifiClientEntry=ogWifiClientEntry, ogCellDataNotification=ogCellDataNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcConnectType=ogRpcConnectType, ogCellModemModel=ogCellModemModel, ogUpsType=ogUpsType, ogCellModemCounter=ogCellModemCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckTable=ogCheckTable, ogEmdDioName=ogEmdDioName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogNetInterfaceType=ogNetInterfaceType, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostIndex=ogHostIndex, ogRpcType=ogRpcType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserName=ogWebUserName, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceCounter=ogHostServiceCounter, ogWifiApEntry=ogWifiApEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortLabel=ogSerialPortLabel, ogWebUserStartTime=ogWebUserStartTime, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDescription=ogEmdDescription, ogRpcOutletNotification=ogRpcOutletNotification, ogHostServiceEntry=ogHostServiceEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortSpeed=ogSerialPortSpeed, PYSNMP_MODULE_ID=ogStatus2, ogHostUserNotification=ogHostUserNotification, ogWifiApClientAp=ogWifiApClientAp, ogUpsNotification=ogUpsNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryState=ogUpsBatteryState, ogCellSignalNotification=ogCellSignalNotification, ogCheckEntry=ogCheckEntry, ogSerialUserName=ogSerialUserName, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemNetwork=ogCellModemNetwork, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcCounter=ogRpcCounter, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsState=ogUpsState, ogRpcEntry=ogRpcEntry, ogStatus2=ogStatus2, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientTable=ogWifiApClientTable, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioCounter=ogEmdDioCounter, ogHostUserHost=ogHostUserHost, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemTower=ogCellModemTower, ogCheckName=ogCheckName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioDirection=ogEmdDioDirection, ogWifiApInterface=ogWifiApInterface, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellApnNotification=ogCellApnNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellTowerNotification=ogCellTowerNotification, ogCustomNotification=ogCustomNotification, ogWifiClientInterface=ogWifiClientInterface, ogWifiApTxPower=ogWifiApTxPower, ogCheckIndex=ogCheckIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientCounter=ogWifiClientCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortTable=ogSerialPortTable, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientTable=ogWifiClientTable, ogRpcDescription=ogRpcDescription, ogAlarmInstance=ogAlarmInstance, ogEmdEnabled=ogEmdEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserStartTime=ogHostUserStartTime, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdIndex=ogEmdIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientMac=ogWifiApClientMac, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsEntry=ogUpsEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserIndex=ogHostUserIndex, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsInputFrequency=ogUpsInputFrequency, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcInputNotification=ogRpcInputNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmState=ogAlarmState, ogRpcIndex=ogRpcIndex, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckResolveActions=ogCheckResolveActions, ogAlarmUser=ogAlarmUser, ogHostServiceStatus=ogHostServiceStatus, ogWifiApCounter=ogWifiApCounter, ogWifiApFrequency=ogWifiApFrequency, ogHostServiceIndex=ogHostServiceIndex, ogAlarmSummary=ogAlarmSummary, ogSerialNumber=ogSerialNumber, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcTable=ogRpcTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsCounter=ogUpsCounter, ogSerialUserPort=ogSerialUserPort, ogEmdName=ogEmdName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTable=ogEmdTable, ogHostUserAddress=ogHostUserAddress, ogWifiApSsid=ogWifiApSsid, ogCellModemTable=ogCellModemTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserTable=ogHostUserTable, ogWifiApTable=ogWifiApTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceState=ogNetInterfaceState, ogWebUserTable=ogWebUserTable, ogStatus2Conformance=ogStatus2Conformance, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdConnectType=ogEmdConnectType, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityName=ogEmdHumidityName, ogUpsIndex=ogUpsIndex, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioDescription=ogEmdDioDescription, ogCellModemConnected=ogCellModemConnected, ogAlarm=ogAlarm, ogHostServicePort=ogHostServicePort, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsName=ogUpsName, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioTable=ogEmdDioTable, ogWifiClientIndex=ogWifiClientIndex, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortMode=ogSerialPortMode, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsTemperature=ogUpsTemperature, ogHostServiceTable=ogHostServiceTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsConnectType=ogUpsConnectType, ogSerialUserIndex=ogSerialUserIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogSystem=ogSystem, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemApn=ogCellModemApn, ogWifiApIndex=ogWifiApIndex, ogHostPingNotification=ogHostPingNotification, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioType=ogEmdDioType, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientMode=ogWifiClientMode, ogAlarmLogTable=ogAlarmLogTable, ogUpsDescription=ogUpsDescription, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmType=ogAlarmType, ogNetInterfaceIndex=ogNetInterfaceIndex)
