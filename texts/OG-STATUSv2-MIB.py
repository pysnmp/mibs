...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTable=ogEmdTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityCounter=ogEmdHumidityCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsState=ogUpsState, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientApMac=ogWifiClientApMac, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioEmd=ogEmdDioEmd, ogWifiApFrequency=ogWifiApFrequency, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApCounter=ogWifiApCounter, ogWifiApSsid=ogWifiApSsid, ogHostUserEntry=ogHostUserEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsNotification=ogUpsNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdEntry=ogEmdEntry, ogHostUserTable=ogHostUserTable, ogUpsHumidity=ogUpsHumidity, ogWifiClientFrequency=ogWifiClientFrequency, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceIndex=ogHostServiceIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserName=ogWebUserName, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmState=ogAlarmState, ogAlarmType=ogAlarmType, ogSerialPortParity=ogSerialPortParity, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientCounter=ogWifiClientCounter, ogCheckTable=ogCheckTable, ogCheckName=ogCheckName, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortMode=ogSerialPortMode, ogEmdDioTable=ogEmdDioTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientTable=ogWifiApClientTable, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemTemperature=ogCellModemTemperature, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserIndex=ogHostUserIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsBatteryCharge=ogUpsBatteryCharge, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogPowerSupplyName=ogPowerSupplyName, ogCellModemTable=ogCellModemTable, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdIndex=ogEmdIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortEntry=ogSerialPortEntry, ogEmdConnectType=ogEmdConnectType, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogStatus2Groups=ogStatus2Groups, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemRegistered=ogCellModemRegistered, ogUpsType=ogUpsType, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogMibNotifications=ogMibNotifications, ogStatus2Compliances=ogStatus2Compliances, ogCellModemEntry=ogCellModemEntry, ogEmdDioState=ogEmdDioState, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckEntry=ogCheckEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletName=ogRpcOutletName, ogCheckType=ogCheckType, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcEntry=ogRpcEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioType=ogEmdDioType, ogCheckResetTimeout=ogCheckResetTimeout, ogCustomNotification=ogCustomNotification, ogSerialUserTable=ogSerialUserTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApClientMac=ogWifiApClientMac, ogHostUserStartTime=ogHostUserStartTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmCheck=ogAlarmCheck, ogStatus2=ogStatus2, ogSerialPortRTS=ogSerialPortRTS, ogWifiApEnabled=ogWifiApEnabled, ogHostUserAddress=ogHostUserAddress, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDioName=ogEmdDioName, ogEmdDioNotification=ogEmdDioNotification, ogUpsDescription=ogUpsDescription, ogRpcTable=ogRpcTable, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmDevice=ogAlarmDevice, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsName=ogUpsName, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApEntry=ogWifiApEntry, ogHostServiceType=ogHostServiceType, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogAlarmUser=ogAlarmUser, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellDataNotification=ogCellDataNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemConnected=ogCellModemConnected, ogRpcType=ogRpcType, ogSerialPortDTR=ogSerialPortDTR, ogEmdEnabled=ogEmdEnabled, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSystem=ogSystem, ogPowerSupplyIndex=ogPowerSupplyIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmSummary=ogAlarmSummary, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellModemEnabled=ogCellModemEnabled, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostUserNotification=ogHostUserNotification, ogWebUserEntry=ogWebUserEntry, ogHostPingNotification=ogHostPingNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemIndex=ogCellModemIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcConnectType=ogRpcConnectType, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialUserEntry=ogSerialUserEntry, ogCheckResolveActions=ogCheckResolveActions, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostName=ogHostName, ogRpcOutletTable=ogRpcOutletTable, ogHostIndex=ogHostIndex, ogHostServiceTable=ogHostServiceTable, ogRpcIndex=ogRpcIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServiceStatus=ogHostServiceStatus, ogHostServicePort=ogHostServicePort, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioDirection=ogEmdDioDirection, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioCounter=ogEmdDioCounter, ogCheckDeviceName=ogCheckDeviceName, ogAlarmInstance=ogAlarmInstance, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemVendor=ogCellModemVendor, ogHostUserHost=ogHostUserHost, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletState=ogRpcOutletState, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemApn=ogCellModemApn, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialUserPort=ogSerialUserPort, ogRpcDescription=ogRpcDescription, ogHostServiceCounter=ogHostServiceCounter, ogHostServiceEntry=ogHostServiceEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWebUserIndex=ogWebUserIndex, ogWifiClientTable=ogWifiClientTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsConnectType=ogUpsConnectType, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemTower=ogCellModemTower, ogAlarmName=ogAlarmName, ogSerialPortTable=ogSerialPortTable, ogWebUserTable=ogWebUserTable, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserIndex=ogSerialUserIndex, ogSerialUserLabel=ogSerialUserLabel, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmEventId=ogAlarmEventId, ogEmdName=ogEmdName, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsTable=ogUpsTable, ogWifiClientInterface=ogWifiClientInterface, ogWifiApIndex=ogWifiApIndex, ogWebUserStartTime=ogWebUserStartTime, ogHostEntry=ogHostEntry, ogUpsCounter=ogUpsCounter, ogSerialPortLabel=ogSerialPortLabel, ogWifiApTxPower=ogWifiApTxPower)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientAp=ogWifiApClientAp, PYSNMP_MODULE_ID=ogStatus2, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientMode=ogWifiClientMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmTime=ogAlarmTime, ogSerialPortDSR=ogSerialPortDSR, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcCounter=ogRpcCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApClientRssi=ogWifiApClientRssi, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsEntry=ogUpsEntry, ogWifiClientRssi=ogWifiClientRssi, ogUpsIndex=ogUpsIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityValue=ogEmdHumidityValue, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApTable=ogWifiApTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialNumber=ogSerialNumber, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckIndex=ogCheckIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemCounter=ogCellModemCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarm=ogAlarm, ogSerialPortSpeed=ogSerialPortSpeed, ogHostUserName=ogHostUserName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServiceHost=ogHostServiceHost, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostTable=ogHostTable, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserName=ogSerialUserName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioDescription=ogEmdDioDescription, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApInterface=ogWifiApInterface, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemModel=ogCellModemModel, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcName=ogRpcName, ogEmdDescription=ogEmdDescription, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmLogTable=ogAlarmLogTable, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientEntry=ogWifiApClientEntry)
