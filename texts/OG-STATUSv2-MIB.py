...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostIpV6Address=ogHostIpV6Address, ogEmdIndex=ogEmdIndex, ogSerialPortIndex=ogSerialPortIndex, ogCheckType=ogCheckType, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientEssid=ogWifiClientEssid, ogRpcInputNotification=ogRpcInputNotification, ogUpsInputNotification=ogUpsInputNotification, ogCustomNotification=ogCustomNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientApMac=ogWifiClientApMac, ogWifiApTxPower=ogWifiApTxPower, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWebUserTable=ogWebUserTable, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemTable=ogCellModemTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogPowerSupplyName=ogPowerSupplyName, ogAlarmCheck=ogAlarmCheck, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemTemperature=ogCellModemTemperature, ogEmdTable=ogEmdTable, ogCellModemEnabled=ogCellModemEnabled, ogHostUserAddress=ogHostUserAddress, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellSignalNotification=ogCellSignalNotification, ogAlarmEventId=ogAlarmEventId, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmUser=ogAlarmUser, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientTable=ogWifiApClientTable, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserTable=ogHostUserTable, ogUpsTable=ogUpsTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostTable=ogHostTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmState=ogAlarmState, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletState=ogRpcOutletState, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortStopBits=ogSerialPortStopBits, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemCounter=ogCellModemCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsState=ogUpsState, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialUserPort=ogSerialUserPort, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemApn=ogCellModemApn, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcConnectType=ogRpcConnectType, ogCellTowerNotification=ogCellTowerNotification, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApIndex=ogWifiApIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogStatus2=ogStatus2, ogWifiApClientMac=ogWifiApClientMac, ogRpcEntry=ogRpcEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmTime=ogAlarmTime, ogUpsIndex=ogUpsIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityName=ogEmdHumidityName, ogRpcName=ogRpcName, ogCellModemEntry=ogCellModemEntry, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserHost=ogHostUserHost, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApCounter=ogWifiApCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogHostName=ogHostName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialNumber=ogSerialNumber, ogHostUserName=ogHostUserName, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortMode=ogSerialPortMode, ogHostEntry=ogHostEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckTable=ogCheckTable, ogWifiClientTable=ogWifiClientTable, ogHostIpV4Address=ogHostIpV4Address, ogHostUserStartTime=ogHostUserStartTime, ogHostIndex=ogHostIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletTable=ogRpcOutletTable, ogWebUserName=ogWebUserName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioType=ogEmdDioType, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserNotification=ogHostUserNotification, ogCellModemNetwork=ogCellModemNetwork, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryState=ogUpsBatteryState, ogUpsConnectType=ogUpsConnectType, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemIMSI=ogCellModemIMSI, ogCellDataNotification=ogCellDataNotification, ogEmdDioCounter=ogEmdDioCounter, ogCellModemTower=ogCellModemTower, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemModel=ogCellModemModel, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDescription=ogEmdDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcCounter=ogRpcCounter, ogAlarmSummary=ogAlarmSummary, ogEmdDioIndex=ogEmdDioIndex, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemIndex=ogCellModemIndex, ogUpsEntry=ogUpsEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortDTR=ogSerialPortDTR, ogHostServiceType=ogHostServiceType, ogRpcDescription=ogRpcDescription, ogEmdEnabled=ogEmdEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApTable=ogWifiApTable, ogWifiApInterface=ogWifiApInterface, ogSerialPortParity=ogSerialPortParity, ogAlarmType=ogAlarmType, ogSerialUserTable=ogSerialUserTable, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcIndex=ogRpcIndex, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcType=ogRpcType, ogAlarmName=ogAlarmName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserEntry=ogSerialUserEntry, ogSerialUserNotification=ogSerialUserNotification, ogAlarmDevice=ogAlarmDevice, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioDescription=ogEmdDioDescription, ogCheckResetTimeout=ogCheckResetTimeout, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputNotification=ogUpsOutputNotification, ogHostServiceStatus=ogHostServiceStatus, ogNetInterfaceType=ogNetInterfaceType, ogWifiApEntry=ogWifiApEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortDataBits=ogSerialPortDataBits, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioState=ogEmdDioState, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputVoltage=ogUpsOutputVoltage, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogStatus2Groups=ogStatus2Groups, ogHostServiceHost=ogHostServiceHost, ogRpcOutletName=ogRpcOutletName, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemSessionTime=ogCellModemSessionTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServicePort=ogHostServicePort, ogEmdDioName=ogEmdDioName, ogSystem=ogSystem, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostPingNotification=ogHostPingNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceTable=ogHostServiceTable, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioEmd=ogEmdDioEmd, ogWifiApFrequency=ogWifiApFrequency, PYSNMP_MODULE_ID=ogStatus2, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserIndex=ogSerialUserIndex, ogUpsNotification=ogUpsNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioTable=ogEmdDioTable, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientInterface=ogWifiClientInterface, ogCheckEntry=ogCheckEntry, ogWifiClientCounter=ogWifiClientCounter, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceName=ogCheckDeviceName, ogStatus2Compliances=ogStatus2Compliances, ogMibNotifications=ogMibNotifications, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdConnectType=ogEmdConnectType, ogUpsCounter=ogUpsCounter, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostServiceCounter=ogHostServiceCounter, ogCellModemVendor=ogCellModemVendor, ogUpsDescription=ogUpsDescription, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsType=ogUpsType, ogAlarm=ogAlarm, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmInstance=ogAlarmInstance, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemConnected=ogCellModemConnected, ogSerialUserName=ogSerialUserName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogStatus2Compliance=ogStatus2Compliance, ogEmdName=ogEmdName, ogCheckIndex=ogCheckIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsName=ogUpsName, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserEntry=ogHostUserEntry, ogEmdEntry=ogEmdEntry, ogCheckName=ogCheckName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApSsid=ogWifiApSsid, ogRpcTable=ogRpcTable, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsTemperature=ogUpsTemperature, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary)
