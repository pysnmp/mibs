...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioName=ogEmdDioName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioType=ogEmdDioType, ogHostTable=ogHostTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogSystem=ogSystem, ogUpsEntry=ogUpsEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityName=ogEmdHumidityName, ogEmdDioEmd=ogEmdDioEmd, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApInterface=ogWifiApInterface, ogEmdDioDirection=ogEmdDioDirection, ogHostServiceType=ogHostServiceType, ogSerialPortRTS=ogSerialPortRTS, ogHostUserEntry=ogHostUserEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceNotification=ogHostServiceNotification, ogHostUserIndex=ogHostUserIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsTable=ogUpsTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemTable=ogCellModemTable, ogEmdConnectType=ogEmdConnectType, ogRpcName=ogRpcName, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckType=ogCheckType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemCounter=ogCellModemCounter, ogEmdDioIndex=ogEmdDioIndex, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostPingNotification=ogHostPingNotification, ogRpcTable=ogRpcTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsCounter=ogUpsCounter, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostIndex=ogHostIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogHostName=ogHostName, ogUpsIndex=ogUpsIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortDCD=ogSerialPortDCD, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemApn=ogCellModemApn, ogHostUserTable=ogHostUserTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmUser=ogCurrentAlarmUser, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemEnabled=ogCellModemEnabled, ogEmdEntry=ogEmdEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmTable=ogCurrentAlarmTable, ogMibNotifications=ogMibNotifications, ogAlarmType=ogAlarmType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsTemperature=ogUpsTemperature, ogAlarmUser=ogAlarmUser, ogSerialUserIndex=ogSerialUserIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdName=ogEmdName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemRegistered=ogCellModemRegistered, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarm=ogAlarm, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserHost=ogHostUserHost, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmDevice=ogAlarmDevice, ogWifiClientIndex=ogWifiClientIndex, ogAlarmName=ogAlarmName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApCounter=ogWifiApCounter, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogHostUserNotification=ogHostUserNotification, ogCellDataNotification=ogCellDataNotification, ogStatus2=ogStatus2, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortDSR=ogSerialPortDSR, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWebUserName=ogWebUserName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserStartTime=ogHostUserStartTime, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortCTS=ogSerialPortCTS, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdIndex=ogEmdIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcOutletTable=ogRpcOutletTable, ogCellModemModel=ogCellModemModel, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientTable=ogWifiClientTable, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioDescription=ogEmdDioDescription, ogWifiApTable=ogWifiApTable, ogFirmwareVersion=ogFirmwareVersion, ogCheckIndex=ogCheckIndex, ogUpsName=ogUpsName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemVendor=ogCellModemVendor, ogHostUserAddress=ogHostUserAddress, ogUpsDescription=ogUpsDescription, ogCustomNotification=ogCustomNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioState=ogEmdDioState, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsState=ogUpsState, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmLogTable=ogAlarmLogTable, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientApMac=ogWifiClientApMac, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialUserTable=ogSerialUserTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialUserName=ogSerialUserName, ogHostIpV4Address=ogHostIpV4Address, ogUpsHumidity=ogUpsHumidity, ogWifiApIndex=ogWifiApIndex, ogEmdDioCounter=ogEmdDioCounter, ogAlarmState=ogAlarmState, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserLabel=ogSerialUserLabel, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientEntry=ogWifiClientEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletState=ogRpcOutletState, ogCellMessageNotification=ogCellMessageNotification, ogHostServicePort=ogHostServicePort, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcEntry=ogRpcEntry, ogEmdTable=ogEmdTable, ogCellModemIndex=ogCellModemIndex, ogSerialPortMode=ogSerialPortMode, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemIMSI=ogCellModemIMSI, ogUpsNotification=ogUpsNotification, ogEmdDioTable=ogEmdDioTable, ogCheckTable=ogCheckTable, ogWifiClientCounter=ogWifiClientCounter, ogWebUserStartTime=ogWebUserStartTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmTime=ogAlarmTime, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientInterface=ogWifiClientInterface, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserName=ogHostUserName, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserEntry=ogSerialUserEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceCounter=ogHostServiceCounter, ogAlarmInstance=ogAlarmInstance, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserNotification=ogSerialUserNotification, ogRpcIndex=ogRpcIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApTxPower=ogWifiApTxPower, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortIndex=ogSerialPortIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortParity=ogSerialPortParity)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcCounter=ogRpcCounter, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApFrequency=ogWifiApFrequency, ogWebUserIndex=ogWebUserIndex, ogWifiClientRssi=ogWifiClientRssi, ogEmdDescription=ogEmdDescription, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApEnabled=ogWifiApEnabled, ogRpcInputNotification=ogRpcInputNotification, ogHostUserHostName=ogHostUserHostName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortTable=ogSerialPortTable, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcType=ogRpcType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckEntry=ogCheckEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogCellApnNotification=ogCellApnNotification, ogCheckName=ogCheckName, ogWebUserTable=ogWebUserTable, ogAlarmSummary=ogAlarmSummary, ogHostServiceStatus=ogHostServiceStatus, ogHostIpV6Address=ogHostIpV6Address, ogRpcDescription=ogRpcDescription, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostServiceHost=ogHostServiceHost, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmCheck=ogAlarmCheck, ogWifiApEntry=ogWifiApEntry, ogEmdDioEntry=ogEmdDioEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletName=ogRpcOutletName, ogWifiApSsid=ogWifiApSsid, ogHostEntry=ogHostEntry, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemTower=ogCellModemTower, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsType=ogUpsType, ogUpsConnectType=ogUpsConnectType, ogWifiApClientAp=ogWifiApClientAp, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserNotification=ogWebUserNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemEntry=ogCellModemEntry, ogStatus2Compliance=ogStatus2Compliance, ogStatus2Groups=ogStatus2Groups, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemConnected=ogCellModemConnected, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialNumber=ogSerialNumber)
