...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmTime=ogAlarmTime, ogCliUserSessionNotification=ogCliUserSessionNotification, ogStatus2=ogStatus2, ogSerialUserLabel=ogSerialUserLabel, ogWebUserName=ogWebUserName, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogNetInterfaceType=ogNetInterfaceType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientEntry=ogWifiClientEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcDescription=ogRpcDescription, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientTable=ogWifiClientTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcEntry=ogRpcEntry, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioEmd=ogEmdDioEmd, ogHostServicePort=ogHostServicePort, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcCounter=ogRpcCounter, ogCellModemVendor=ogCellModemVendor, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdIndex=ogEmdIndex, ogRpcTable=ogRpcTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemConnected=ogCellModemConnected, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApEnabled=ogWifiApEnabled, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellTowerNotification=ogCellTowerNotification, ogCustomNotification=ogCustomNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserName=ogSerialUserName, ogWifiClientInterface=ogWifiClientInterface, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientMac=ogWifiApClientMac, ogCellModemIndex=ogCellModemIndex, ogEmdDioType=ogEmdDioType, ogEmdDioIndex=ogEmdDioIndex, ogAlarm=ogAlarm, ogHostServiceStatus=ogHostServiceStatus, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsIndex=ogUpsIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmCheck=ogAlarmCheck, ogSerialPortEntry=ogSerialPortEntry, ogUpsCounter=ogUpsCounter, ogWebUserEntry=ogWebUserEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmName=ogAlarmName, ogUpsEntry=ogUpsEntry, ogSerialPortDSR=ogSerialPortDSR, ogWifiApTable=ogWifiApTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserTable=ogHostUserTable, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientIndex=ogWifiClientIndex, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTable=ogEmdTable, ogHostUserIndex=ogHostUserIndex, ogStatus2Compliances=ogStatus2Compliances, ogAlarmState=ogAlarmState, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceIndex=ogCheckDeviceIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckName=ogCheckName, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortDCD=ogSerialPortDCD, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletRpc=ogRpcOutletRpc, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcInputVoltage=ogRpcInputVoltage, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputCurrent=ogUpsInputCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckDeviceName=ogCheckDeviceName, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceEntry=ogHostServiceEntry, ogHostUserHost=ogHostUserHost, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdConnectType=ogEmdConnectType, ogSerialNumber=ogSerialNumber, ogEmdDioNotification=ogEmdDioNotification, ogHostTable=ogHostTable, ogSerialUserTable=ogSerialUserTable, ogCellModemTable=ogCellModemTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsName=ogUpsName, ogWebUserTable=ogWebUserTable, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserEntry=ogSerialUserEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckTable=ogCheckTable, ogHostIpV6Address=ogHostIpV6Address, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcName=ogRpcName, ogEmdDioState=ogEmdDioState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcConnectType=ogRpcConnectType, ogFirmwareVersion=ogFirmwareVersion, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutletName=ogRpcOutletName, ogHostEntry=ogHostEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyName=ogPowerSupplyName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostPingNotification=ogHostPingNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsNotification=ogUpsNotification, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsConnectType=ogUpsConnectType, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletState=ogRpcOutletState, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemTower=ogCellModemTower, ogEmdDioEntry=ogEmdDioEntry, ogCheckType=ogCheckType, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckEntry=ogCheckEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellDataNotification=ogCellDataNotification, ogSerialPortDTR=ogSerialPortDTR, ogUpsType=ogUpsType, ogWebUserStartTime=ogWebUserStartTime, ogCellModemEntry=ogCellModemEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemCounter=ogCellModemCounter, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsHumidity=ogUpsHumidity, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserPort=ogSerialUserPort, PYSNMP_MODULE_ID=ogStatus2, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApCounter=ogWifiApCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserNotification=ogHostUserNotification, ogCellModemNetwork=ogCellModemNetwork, ogAlarmDevice=ogAlarmDevice, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckIndex=ogCheckIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostUserAddress=ogHostUserAddress, ogHostServiceHost=ogHostServiceHost, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModem4gRssi=ogCellModem4gRssi, ogNetInterfaceNotification=ogNetInterfaceNotification, ogNetInterfaceState=ogNetInterfaceState, ogHostUserName=ogHostUserName, ogSerialSignalNotification=ogSerialSignalNotification, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellApnNotification=ogCellApnNotification, ogUpsDescription=ogUpsDescription, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemTemperature=ogCellModemTemperature, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostUserHostName=ogHostUserHostName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortIndex=ogSerialPortIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSystem=ogSystem, ogWifiApSsid=ogWifiApSsid, ogUpsTemperature=ogUpsTemperature, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmType=ogAlarmType, ogSerialPortLabel=ogSerialPortLabel, ogHostServiceTable=ogHostServiceTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientAp=ogWifiApClientAp, ogWifiApInterface=ogWifiApInterface, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientApMac=ogWifiClientApMac, ogAlarmInstance=ogAlarmInstance, ogEmdName=ogEmdName, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemIMSI=ogCellModemIMSI, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDioDirection=ogEmdDioDirection, ogHostServiceType=ogHostServiceType, ogAlarmSummary=ogAlarmSummary, ogCellModemEnabled=ogCellModemEnabled, ogWebUserNotification=ogWebUserNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdEnabled=ogEmdEnabled, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsTable=ogUpsTable, ogSerialUserIndex=ogSerialUserIndex, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortTable=ogSerialPortTable, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortBreaks=ogSerialPortBreaks, ogStatus2Conformance=ogStatus2Conformance, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostUserEntry=ogHostUserEntry, ogCellModemApn=ogCellModemApn, ogEmdDioTable=ogEmdDioTable, ogRpcType=ogRpcType, ogEmdDioName=ogEmdDioName, ogEmdEntry=ogEmdEntry, ogMibNotifications=ogMibNotifications, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostName=ogHostName, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmUser=ogAlarmUser, ogEmdDescription=ogEmdDescription, ogUpsOutputPower=ogUpsOutputPower, ogCellModemModel=ogCellModemModel, ogUpsState=ogUpsState, ogHostIndex=ogHostIndex, ogRpcIndex=ogRpcIndex, ogWifiApEntry=ogWifiApEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortMode=ogSerialPortMode)
