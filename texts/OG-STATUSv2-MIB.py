...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioNotification=ogEmdDioNotification, ogCellMessageNotification=ogCellMessageNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceNotification=ogHostServiceNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemCounter=ogCellModemCounter, ogHostName=ogHostName, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientMode=ogWifiClientMode, ogWebUserStartTime=ogWebUserStartTime, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserName=ogHostUserName, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemRegistered=ogCellModemRegistered, ogCellModemConnected=ogCellModemConnected, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApSsid=ogWifiApSsid, ogHostServicePort=ogHostServicePort, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserTable=ogSerialUserTable, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcConnectType=ogRpcConnectType, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserIndex=ogWebUserIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostIndex=ogHostIndex, ogUpsTemperature=ogUpsTemperature, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioType=ogEmdDioType, ogAlarmType=ogAlarmType, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogNetInterfaceName=ogNetInterfaceName, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostTable=ogHostTable, ogWifiApClientEntry=ogWifiApClientEntry, ogCellDataNotification=ogCellDataNotification, ogNetInterfaceType=ogNetInterfaceType, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientCounter=ogWifiClientCounter, ogCellModemApn=ogCellModemApn, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortMode=ogSerialPortMode, ogCheckName=ogCheckName, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogHostUserNotification=ogHostUserNotification, ogAlarmCheck=ogAlarmCheck, ogHostUserIndex=ogHostUserIndex, ogStatus2=ogStatus2, ogAlarm=ogAlarm, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModem3gRssi=ogCellModem3gRssi, ogWebUserNotification=ogWebUserNotification, ogCellModemTable=ogCellModemTable, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryNotification=ogUpsBatteryNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcDescription=ogRpcDescription, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortCTS=ogSerialPortCTS, ogRpcName=ogRpcName, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceType=ogHostServiceType, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApTable=ogWifiApTable, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletState=ogRpcOutletState, ogWifiApClientAp=ogWifiApClientAp, ogUpsState=ogUpsState, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortLabel=ogSerialPortLabel, ogSerialSignalNotification=ogSerialSignalNotification, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortDCD=ogSerialPortDCD, ogCustomNotification=ogCustomNotification, ogUpsType=ogUpsType, ogWifiApClientMac=ogWifiApClientMac, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputNotification=ogUpsInputNotification, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostPingNotification=ogHostPingNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioEntry=ogEmdDioEntry, ogUpsConnectType=ogUpsConnectType, ogWifiClientTable=ogWifiClientTable, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcIndex=ogRpcIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserName=ogWebUserName, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApEnabled=ogWifiApEnabled, ogEmdIndex=ogEmdIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceEntry=ogHostServiceEntry, ogRpcEntry=ogRpcEntry, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioDirection=ogEmdDioDirection, ogAlarmLogIndex=ogAlarmLogIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioName=ogEmdDioName, ogCheckDeviceName=ogCheckDeviceName, ogUpsDescription=ogUpsDescription, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellSignalNotification=ogCellSignalNotification, ogSerialNumber=ogSerialNumber, ogAlarmUser=ogAlarmUser, ogRpcTable=ogRpcTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmName=ogAlarmName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortParity=ogSerialPortParity, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSystem=ogSystem, ogCellModemModel=ogCellModemModel, ogHostEntry=ogHostEntry, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdName=ogEmdName, ogWifiClientRssi=ogWifiClientRssi, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceTable=ogHostServiceTable, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserLabel=ogSerialUserLabel, ogSerialUserName=ogSerialUserName, PYSNMP_MODULE_ID=ogStatus2, ogCheckIndex=ogCheckIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemTower=ogCellModemTower, ogAlarmTime=ogAlarmTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioState=ogEmdDioState, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogPowerSupplyName=ogPowerSupplyName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsEntry=ogUpsEntry, ogEmdDioIndex=ogEmdDioIndex, ogEmdConnectType=ogEmdConnectType, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostUserAddress=ogHostUserAddress, ogCheckTable=ogCheckTable, ogRpcOutletLoad=ogRpcOutletLoad, ogHostUserTable=ogHostUserTable, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientTable=ogWifiApClientTable, ogAlarmSummary=ogAlarmSummary, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyTable=ogPowerSupplyTable, ogHostUserHostName=ogHostUserHostName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDescription=ogEmdDescription, ogSerialUserNotification=ogSerialUserNotification, ogHostUserStartTime=ogHostUserStartTime, ogCellTowerNotification=ogCellTowerNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckEntry=ogCheckEntry, ogWifiClientInterface=ogWifiClientInterface, ogRpcType=ogRpcType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdEntry=ogEmdEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortTable=ogSerialPortTable, ogStatus2Compliances=ogStatus2Compliances, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogMibNotifications=ogMibNotifications)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApCounter=ogWifiApCounter, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsIndex=ogUpsIndex, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckType=ogCheckType, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioCounter=ogEmdDioCounter, ogAlarmState=ogAlarmState, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostServiceHost=ogHostServiceHost, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogNetInterfaceState=ogNetInterfaceState, ogCellModemEntry=ogCellModemEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogWebUserTable=ogWebUserTable, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsTable=ogUpsTable, ogCheckDeviceRef=ogCheckDeviceRef, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsNotification=ogUpsNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsCounter=ogUpsCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogHostIpV6Address=ogHostIpV6Address, ogRpcCounter=ogRpcCounter, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmLogTable=ogAlarmLogTable, ogEmdTable=ogEmdTable, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWebUserEntry=ogWebUserEntry, ogAlarmInstance=ogAlarmInstance, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsHumidity=ogUpsHumidity, ogStatus2Compliance=ogStatus2Compliance, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellApnNotification=ogCellApnNotification, ogWifiClientIndex=ogWifiClientIndex, ogAlarmEventId=ogAlarmEventId, ogCellModemNetwork=ogCellModemNetwork, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserHost=ogHostUserHost, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserEntry=ogHostUserEntry, ogWifiApInterface=ogWifiApInterface, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsName=ogUpsName, ogRpcInputNotification=ogRpcInputNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmDevice=ogAlarmDevice, ogWifiApEntry=ogWifiApEntry)
