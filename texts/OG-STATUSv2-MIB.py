...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ObjectIdentity, TimeTicks, Counter64, MibIdentifier, Counter32, ModuleIdentity, IpAddress, iso, Unsigned32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ObjectIdentity", "TimeTicks", "Counter64", "MibIdentifier", "Counter32", "ModuleIdentity", "IpAddress", "iso", "Unsigned32", "NotificationType", "Bits")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckType=ogCheckType, ogRpcType=ogRpcType, ogSerialPortMode=ogSerialPortMode, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialUserPort=ogSerialUserPort, ogEmdName=ogEmdName, ogWifiApTable=ogWifiApTable, ogAlarmUser=ogAlarmUser, ogAlarmEventId=ogAlarmEventId, ogAlarmType=ogAlarmType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostUserAddress=ogHostUserAddress, ogWifiApClientEntry=ogWifiApClientEntry, ogCellDataNotification=ogCellDataNotification, ogCellModemIndex=ogCellModemIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortDSR=ogSerialPortDSR, ogHostPingNotification=ogHostPingNotification, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcIndex=ogRpcIndex, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortRTS=ogSerialPortRTS, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmSummary=ogAlarmSummary, ogCellModemModel=ogCellModemModel, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcDescription=ogRpcDescription, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsHumidity=ogUpsHumidity, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioNotification=ogEmdDioNotification, ogHostServiceTable=ogHostServiceTable, ogEmdDioEmd=ogEmdDioEmd, ogSerialNumber=ogSerialNumber, ogEmdEntry=ogEmdEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserStartTime=ogHostUserStartTime, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioDescription=ogEmdDioDescription, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortTable=ogSerialPortTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserName=ogSerialUserName, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckEntry=ogCheckEntry, ogRpcOutletState=ogRpcOutletState, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcInputNotification=ogRpcInputNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientAp=ogWifiApClientAp, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostUserName=ogHostUserName, ogCellModemApn=ogCellModemApn, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApIndex=ogWifiApIndex, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientTable=ogWifiClientTable, ogWebUserIndex=ogWebUserIndex, ogHostTable=ogHostTable, ogStatus2=ogStatus2, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmDevice=ogAlarmDevice, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmName=ogAlarmName, ogWebUserName=ogWebUserName, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmCheck=ogAlarmCheck, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceCounter=ogHostServiceCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceType=ogHostServiceType, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckTable=ogCheckTable, ogCellModemConnected=ogCellModemConnected, ogBasicStatusGroup=ogBasicStatusGroup, ogHostName=ogHostName, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogCellSignalNotification=ogCellSignalNotification, ogWebUserStartTime=ogWebUserStartTime, ogWifiApFrequency=ogWifiApFrequency, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApClientIndex=ogWifiApClientIndex, ogHostEntry=ogHostEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsTemperature=ogUpsTemperature, ogWifiApSsid=ogWifiApSsid, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientApMac=ogWifiClientApMac, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientRssi=ogWifiClientRssi, ogFirmwareVersion=ogFirmwareVersion, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserTable=ogSerialUserTable, ogEmdDioCounter=ogEmdDioCounter, ogUpsName=ogUpsName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientEnabled=ogWifiClientEnabled, ogStatus2Groups=ogStatus2Groups, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemEntry=ogCellModemEntry, ogWifiApInterface=ogWifiApInterface, ogEmdConnectType=ogEmdConnectType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckName=ogCheckName, ogWifiApCounter=ogWifiApCounter, ogSerialUserStartTime=ogSerialUserStartTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdEnabled=ogEmdEnabled, ogHostUserTable=ogHostUserTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogHostUserHostName=ogHostUserHostName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcName=ogRpcName, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmTime=ogAlarmTime, ogUpsNotification=ogUpsNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyName=ogPowerSupplyName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientTable=ogWifiApClientTable, ogHostUserEntry=ogHostUserEntry, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientRssi=ogWifiApClientRssi, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDescription=ogEmdDescription, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientEssid=ogWifiClientEssid, ogUpsIndex=ogUpsIndex, ogCellModemTower=ogCellModemTower, ogSerialPortEntry=ogSerialPortEntry, ogMibNotifications=ogMibNotifications, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApEnabled=ogWifiApEnabled, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsState=ogUpsState, ogHostServicePort=ogHostServicePort, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostUserHost=ogHostUserHost, ogEmdTable=ogEmdTable, ogCellModemTable=ogCellModemTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcCounter=ogRpcCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsTable=ogUpsTable, ogWebUserTable=ogWebUserTable, ogCellApnNotification=ogCellApnNotification, ogSerialUserNotification=ogSerialUserNotification, ogAlarm=ogAlarm, ogCellModemEnabled=ogCellModemEnabled, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureTable=ogEmdTemperatureTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsDescription=ogUpsDescription, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsEntry=ogUpsEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletRpc=ogRpcOutletRpc, ogSystem=ogSystem, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortDCD=ogSerialPortDCD, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcTable=ogRpcTable, ogEmdDioDirection=ogEmdDioDirection, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioTable=ogEmdDioTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckTriggerActions=ogCheckTriggerActions, ogUpsType=ogUpsType, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceName=ogCheckDeviceName, ogCellModemRegistered=ogCellModemRegistered, ogWebUserEntry=ogWebUserEntry, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletTable=ogRpcOutletTable, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioType=ogEmdDioType, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellTowerNotification=ogCellTowerNotification, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcConnectType=ogRpcConnectType, ogEmdDioState=ogEmdDioState, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientMode=ogWifiClientMode, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemVendor=ogCellModemVendor, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApEntry=ogWifiApEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmState=ogAlarmState, ogCellModemCounter=ogCellModemCounter, PYSNMP_MODULE_ID=ogStatus2, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialUserIndex=ogSerialUserIndex, ogCheckIndex=ogCheckIndex, ogWifiApTxPower=ogWifiApTxPower, ogRpcOutletName=ogRpcOutletName, ogCustomNotification=ogCustomNotification, ogRpcEntry=ogRpcEntry, ogHostServiceHost=ogHostServiceHost, ogHostUserIndex=ogHostUserIndex, ogSerialPortParity=ogSerialPortParity, ogAlarmInstance=ogAlarmInstance, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdIndex=ogEmdIndex, ogCellMessageNotification=ogCellMessageNotification, ogUpsCounter=ogUpsCounter, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogHostServiceStatus=ogHostServiceStatus, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioName=ogEmdDioName, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortLabel=ogSerialPortLabel, ogWebUserNotification=ogWebUserNotification, ogHostIndex=ogHostIndex)
