...
ModuleIdentity, IpAddress, Counter32, Counter64, Gauge32, Unsigned32, Integer32, NotificationType, TimeTicks, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "IpAddress", "Counter32", "Counter64", "Gauge32", "Unsigned32", "Integer32", "NotificationType", "TimeTicks", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApAuthNotification=ogWifiApAuthNotification, ogStatus2=ogStatus2, ogAlarmState=ogAlarmState, ogWifiClientTable=ogWifiClientTable, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceNotification=ogHostServiceNotification, ogWebUserName=ogWebUserName, ogUpsName=ogUpsName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostUserStartTime=ogHostUserStartTime, ogHostPingNotification=ogHostPingNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogMibNotifications=ogMibNotifications, ogCellModemEntry=ogCellModemEntry, ogWifiApCounter=ogWifiApCounter, ogRpcName=ogRpcName, ogAlarmEventId=ogAlarmEventId, ogHostServiceTable=ogHostServiceTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmLogIndex=ogAlarmLogIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWebUserNotification=ogWebUserNotification, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceName=ogNetInterfaceName, ogCheckName=ogCheckName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostUserAddress=ogHostUserAddress, ogAlarmCheck=ogAlarmCheck, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWebUserTable=ogWebUserTable, ogRpcDescription=ogRpcDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmUser=ogAlarmUser, ogCellModemEnabled=ogCellModemEnabled, ogHostTable=ogHostTable, ogCellModemApn=ogCellModemApn, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioCounter=ogEmdDioCounter, ogWifiApInterface=ogWifiApInterface, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortParityErrors=ogSerialPortParityErrors, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletEntry=ogRpcOutletEntry, PYSNMP_MODULE_ID=ogStatus2, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsState=ogUpsState, ogSerialUserName=ogSerialUserName, ogHostServiceCounter=ogHostServiceCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellDataNotification=ogCellDataNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcIndex=ogRpcIndex, ogRpcEntry=ogRpcEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogHostServiceHost=ogHostServiceHost, ogEmdDioIndex=ogEmdDioIndex, ogUpsEntry=ogUpsEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmName=ogAlarmName, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortEntry=ogSerialPortEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemCounter=ogCellModemCounter, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdIndex=ogEmdIndex, ogWifiClientInterface=ogWifiClientInterface, ogHostIndex=ogHostIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostEntry=ogHostEntry, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialNumber=ogSerialNumber, ogHostUserIndex=ogHostUserIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmTriggerValue=ogAlarmTriggerValue, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostUserName=ogHostUserName, ogRpcType=ogRpcType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsBatteryState=ogUpsBatteryState, ogAlarmType=ogAlarmType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmSummary=ogAlarmSummary, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletState=ogRpcOutletState, ogUpsInputNotification=ogUpsInputNotification, ogSerialUserTable=ogSerialUserTable, ogCellModemVendor=ogCellModemVendor, ogRpcOutletName=ogRpcOutletName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmDevice=ogAlarmDevice, ogWifiClientEntry=ogWifiClientEntry, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientIndex=ogWifiClientIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogFirmwareVersion=ogFirmwareVersion, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioName=ogEmdDioName, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioState=ogEmdDioState, ogAlarm=ogAlarm, ogSerialUserIndex=ogSerialUserIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsConnectType=ogUpsConnectType, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortParity=ogSerialPortParity, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemIndex=ogCellModemIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserStartTime=ogSerialUserStartTime, ogHostIpV6Address=ogHostIpV6Address, ogCheckIndex=ogCheckIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsLogEnabled=ogUpsLogEnabled, ogSystem=ogSystem, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostName=ogHostName, ogHostUserTable=ogHostUserTable, ogWifiApEntry=ogWifiApEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApClientAp=ogWifiApClientAp, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortTable=ogSerialPortTable, ogCellApnNotification=ogCellApnNotification, ogSerialUserNotification=ogSerialUserNotification, ogWifiApFrequency=ogWifiApFrequency, ogCellModemTable=ogCellModemTable, ogHostServicePort=ogHostServicePort, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCustomNotification=ogCustomNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortDCD=ogSerialPortDCD, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckType=ogCheckType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWebUserStartTime=ogWebUserStartTime, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApSsid=ogWifiApSsid, ogHostUserHost=ogHostUserHost, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioEntry=ogEmdDioEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsHumidity=ogUpsHumidity, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcCounter=ogRpcCounter, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortIndex=ogSerialPortIndex, ogWifiApTable=ogWifiApTable, ogCheckEntry=ogCheckEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioEmd=ogEmdDioEmd, ogCellModemConnected=ogCellModemConnected, ogRpcConnectType=ogRpcConnectType, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioType=ogEmdDioType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortRTS=ogSerialPortRTS, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApEnabled=ogWifiApEnabled, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortLabel=ogSerialPortLabel, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletTable=ogRpcOutletTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsTemperature=ogUpsTemperature, ogHostUserHostName=ogHostUserHostName, ogUpsDescription=ogUpsDescription, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientRssi=ogWifiApClientRssi)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostIpV4Address=ogHostIpV4Address, ogAlarmLogTable=ogAlarmLogTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortCTS=ogSerialPortCTS, ogUpsTable=ogUpsTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityValue=ogEmdHumidityValue, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellTowerNotification=ogCellTowerNotification, ogCellModemTower=ogCellModemTower, ogCellMessageNotification=ogCellMessageNotification, ogStatus2Compliance=ogStatus2Compliance, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmInstance=ogAlarmInstance, ogStatus2Conformance=ogStatus2Conformance, ogCheckDeviceName=ogCheckDeviceName, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemModel=ogCellModemModel, ogSerialPortMode=ogSerialPortMode, ogCheckTable=ogCheckTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioTable=ogEmdDioTable, ogAlarmTime=ogAlarmTime, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientMode=ogWifiClientMode, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdDescription=ogEmdDescription, ogHostServiceStatus=ogHostServiceStatus, ogCheckResolveActions=ogCheckResolveActions, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTable=ogEmdTable, ogEmdEntry=ogEmdEntry, ogHostServiceEntry=ogHostServiceEntry, ogEmdName=ogEmdName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellSignalNotification=ogCellSignalNotification, ogHostServiceType=ogHostServiceType, ogWifiApIndex=ogWifiApIndex, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsCounter=ogUpsCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcInputNotification=ogRpcInputNotification, ogUpsIndex=ogUpsIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsNotification=ogUpsNotification, ogCellModemTemperature=ogCellModemTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcTable=ogRpcTable, ogUpsType=ogUpsType, ogSerialPortDSR=ogSerialPortDSR, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioNotification=ogEmdDioNotification, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogStatus2Groups=ogStatus2Groups, ogWifiClientLinkQuality=ogWifiClientLinkQuality)
