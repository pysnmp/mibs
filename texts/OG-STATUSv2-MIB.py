...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWebUserNotification=ogWebUserNotification, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcDescription=ogRpcDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemModel=ogCellModemModel, ogEmdDescription=ogEmdDescription, ogEmdEntry=ogEmdEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioEmd=ogEmdDioEmd, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortCTS=ogSerialPortCTS, ogWifiApTable=ogWifiApTable, ogStatus2Compliance=ogStatus2Compliance, ogSerialNumber=ogSerialNumber, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsNotification=ogUpsNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcEntry=ogRpcEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortDCD=ogSerialPortDCD, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserEntry=ogHostUserEntry, ogWebUserIndex=ogWebUserIndex, ogStatus2Compliances=ogStatus2Compliances, ogAlarmCheck=ogAlarmCheck, ogWifiApAuthNotification=ogWifiApAuthNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostIpV4Address=ogHostIpV4Address, PYSNMP_MODULE_ID=ogStatus2, ogCellModemTower=ogCellModemTower, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdConnectType=ogEmdConnectType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellTowerNotification=ogCellTowerNotification, ogCellModemEnabled=ogCellModemEnabled, ogEmdIndex=ogEmdIndex, ogWifiClientInterface=ogWifiClientInterface, ogWifiApSsid=ogWifiApSsid, ogWifiClientIndex=ogWifiClientIndex, ogRpcOutletState=ogRpcOutletState, ogStatus2=ogStatus2, ogHostEntry=ogHostEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmName=ogAlarmName, ogEmdDioTable=ogEmdDioTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceStatus=ogHostServiceStatus, ogUpsEntry=ogUpsEntry, ogRpcType=ogRpcType, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostTable=ogHostTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmLogIndex=ogAlarmLogIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletName=ogRpcOutletName, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioState=ogEmdDioState, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsName=ogUpsName, ogCheckTable=ogCheckTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletTable=ogRpcOutletTable, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsState=ogUpsState, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserName=ogWebUserName, ogCustomNotification=ogCustomNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioName=ogEmdDioName, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostUserHostName=ogHostUserHostName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckName=ogCheckName, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientMac=ogWifiApClientMac, ogWifiApIndex=ogWifiApIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientApMac=ogWifiClientApMac, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserName=ogHostUserName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckIndex=ogCheckIndex, ogHostServiceType=ogHostServiceType, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsType=ogUpsType, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostIndex=ogHostIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortMode=ogSerialPortMode, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientFrequency=ogWifiClientFrequency, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsIndex=ogUpsIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyName=ogPowerSupplyName, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsConnectType=ogUpsConnectType, ogWifiApCounter=ogWifiApCounter, ogCellModemTemperature=ogCellModemTemperature, ogCheckDeviceCheck=ogCheckDeviceCheck, ogFirmwareVersion=ogFirmwareVersion, ogAlarmDevice=ogAlarmDevice, ogUpsCounter=ogUpsCounter, ogWifiApFrequency=ogWifiApFrequency, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApInterface=ogWifiApInterface, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserEntry=ogWebUserEntry, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceTable=ogHostServiceTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortTable=ogSerialPortTable, ogWifiApClientTable=ogWifiApClientTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemIndex=ogCellModemIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemRegistered=ogCellModemRegistered, ogSerialUserEntry=ogSerialUserEntry, ogSerialUserNotification=ogSerialUserNotification, ogHostServiceIndex=ogHostServiceIndex, ogCellMessageNotification=ogCellMessageNotification, ogAlarmLogTable=ogAlarmLogTable, ogCheckType=ogCheckType, ogCellModemVendor=ogCellModemVendor, ogHostName=ogHostName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmTime=ogAlarmTime, ogCellModemTable=ogCellModemTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserNotification=ogHostUserNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTable=ogEmdTable, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsOutputPower=ogUpsOutputPower, ogHostUserHost=ogHostUserHost, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortDSR=ogSerialPortDSR, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemIMSI=ogCellModemIMSI, ogWebUserTable=ogWebUserTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWebUserStartTime=ogWebUserStartTime, ogCellModemConnected=ogCellModemConnected, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceNotification=ogHostServiceNotification, ogNetInterfaceName=ogNetInterfaceName, ogRpcConnectType=ogRpcConnectType, ogHostUserIndex=ogHostUserIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogCellDataNotification=ogCellDataNotification, ogHostUserTable=ogHostUserTable, ogCellModemEntry=ogCellModemEntry, ogAlarmState=ogAlarmState, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarm=ogAlarm, ogEmdDioDirection=ogEmdDioDirection, ogSystem=ogSystem, ogRpcTable=ogRpcTable, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServiceHost=ogHostServiceHost, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcName=ogRpcName, ogCellSignalNotification=ogCellSignalNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceState=ogNetInterfaceState, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortRTS=ogSerialPortRTS, ogWifiApEntry=ogWifiApEntry, ogUpsTemperature=ogUpsTemperature, ogCellApnNotification=ogCellApnNotification, ogSerialUserPort=ogSerialUserPort, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientCounter=ogWifiClientCounter, ogUpsDescription=ogUpsDescription, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioCounter=ogEmdDioCounter, ogUpsTable=ogUpsTable, ogEmdName=ogEmdName, ogHostPingNotification=ogHostPingNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcInputNotification=ogRpcInputNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmUser=ogAlarmUser, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServicePort=ogHostServicePort, ogWifiApEnabled=ogWifiApEnabled, ogHostIpV6Address=ogHostIpV6Address, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsLogEnabled=ogUpsLogEnabled, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientAp=ogWifiApClientAp, ogCheckResolveActions=ogCheckResolveActions, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioEntry=ogEmdDioEntry, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcCounter=ogRpcCounter, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmType=ogAlarmType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioType=ogEmdDioType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogStatus2Groups=ogStatus2Groups, ogRpcIndex=ogRpcIndex, ogCheckEntry=ogCheckEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientTable=ogWifiClientTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemApn=ogCellModemApn, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserTable=ogSerialUserTable, ogSerialPortLabel=ogSerialPortLabel, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdEnabled=ogEmdEnabled, ogEmdDioIndex=ogEmdDioIndex, ogSerialUserName=ogSerialUserName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogMibNotifications=ogMibNotifications, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApTxPower=ogWifiApTxPower, ogCheckDeviceName=ogCheckDeviceName, ogHostUserAddress=ogHostUserAddress, ogSerialUserIndex=ogSerialUserIndex, ogRpcInputFrequency=ogRpcInputFrequency)
