...
Gauge32, Counter32, Bits, Unsigned32, TimeTicks, IpAddress, ObjectIdentity, ModuleIdentity, NotificationType, Counter64, Integer32, iso, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "Bits", "Unsigned32", "TimeTicks", "IpAddress", "ObjectIdentity", "ModuleIdentity", "NotificationType", "Counter64", "Integer32", "iso", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletName=ogRpcOutletName, ogSerialPortLabel=ogSerialPortLabel, ogEmdEnabled=ogEmdEnabled, ogEmdDioState=ogEmdDioState, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioEntry=ogEmdDioEntry, ogAlarmType=ogAlarmType, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutputNotification=ogRpcOutputNotification, ogHostName=ogHostName, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioName=ogEmdDioName, ogWifiClientRssi=ogWifiClientRssi, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTable=ogEmdTable, ogWifiApFrequency=ogWifiApFrequency, ogAlarmName=ogAlarmName, ogEmdDioNotification=ogEmdDioNotification, ogCellTowerNotification=ogCellTowerNotification, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioDescription=ogEmdDioDescription, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckTable=ogCheckTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogHostUserEntry=ogHostUserEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsIndex=ogUpsIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmUser=ogAlarmUser, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckIndex=ogCheckIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarm=ogAlarm, ogHostServicePort=ogHostServicePort, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApCounter=ogWifiApCounter, ogCheckName=ogCheckName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientMode=ogWifiClientMode, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientEssid=ogWifiClientEssid, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemTable=ogCellModemTable, ogSerialPortRTS=ogSerialPortRTS, ogHostServiceCounter=ogHostServiceCounter, ogWifiApIndex=ogWifiApIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostIndex=ogHostIndex, ogWebUserTable=ogWebUserTable, ogStatus2=ogStatus2, ogEmdDioDirection=ogEmdDioDirection, ogUpsHumidity=ogUpsHumidity, ogEmdDescription=ogEmdDescription, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientMac=ogWifiApClientMac, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemIndex=ogCellModemIndex, ogCellModemModel=ogCellModemModel, ogCheckEntry=ogCheckEntry, ogStatus2Conformance=ogStatus2Conformance, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServiceStatus=ogHostServiceStatus, ogHostIpV4Address=ogHostIpV4Address, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputPower=ogUpsOutputPower, ogWifiApSsid=ogWifiApSsid, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemTower=ogCellModemTower, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientTable=ogWifiClientTable, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortCTS=ogSerialPortCTS, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsDescription=ogUpsDescription, ogWifiClientApMac=ogWifiClientApMac, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogStatus2Compliances=ogStatus2Compliances, ogWebUserNotification=ogWebUserNotification, ogCellModemConnected=ogCellModemConnected, ogCellModemEntry=ogCellModemEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioTable=ogEmdDioTable, ogHostServiceNotification=ogHostServiceNotification, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWebUserName=ogWebUserName, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsEntry=ogUpsEntry, ogUpsConnectType=ogUpsConnectType, ogSerialNumber=ogSerialNumber, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialUserTable=ogSerialUserTable, ogEmdEntry=ogEmdEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserTable=ogHostUserTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletState=ogRpcOutletState, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogNetInterfaceState=ogNetInterfaceState, ogRpcEntry=ogRpcEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioCounter=ogEmdDioCounter, ogWebUserSourcePort=ogWebUserSourcePort, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemIMSI=ogCellModemIMSI, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogCellMessageNotification=ogCellMessageNotification, ogAlarmInstance=ogAlarmInstance, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsTable=ogUpsTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdConnectType=ogEmdConnectType, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityCounter=ogEmdHumidityCounter, ogMibNotifications=ogMibNotifications, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortParity=ogSerialPortParity, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsTemperature=ogUpsTemperature, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyName=ogPowerSupplyName, ogRpcCounter=ogRpcCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserEntry=ogWebUserEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmCheck=ogAlarmCheck, ogSerialUserName=ogSerialUserName, ogCellSignalNotification=ogCellSignalNotification, ogHostTable=ogHostTable, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmTime=ogAlarmTime, ogEmdDioType=ogEmdDioType, ogStatus2Groups=ogStatus2Groups, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryState=ogUpsBatteryState, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceHost=ogHostServiceHost, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientFrequency=ogWifiClientFrequency, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmState=ogAlarmState, ogCellModemRegistered=ogCellModemRegistered, ogCheckDeviceRef=ogCheckDeviceRef, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcDescription=ogRpcDescription, ogHostServiceType=ogHostServiceType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortTable=ogSerialPortTable, ogRpcName=ogRpcName, ogCheckType=ogCheckType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsCounter=ogUpsCounter, ogUpsNotification=ogUpsNotification, ogAlarmDevice=ogAlarmDevice, ogNetInterfaceName=ogNetInterfaceName, ogWifiApEnabled=ogWifiApEnabled, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, PYSNMP_MODULE_ID=ogStatus2, ogWebUserStartTime=ogWebUserStartTime, ogRpcOutletTotal=ogRpcOutletTotal)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdName=ogEmdName, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserHost=ogHostUserHost, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientAp=ogWifiApClientAp, ogRpcConnectType=ogRpcConnectType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemNetwork=ogCellModemNetwork, ogSystem=ogSystem, ogAlarmEventId=ogAlarmEventId, ogCustomNotification=ogCustomNotification, ogAlarmLogTable=ogAlarmLogTable, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletTable=ogRpcOutletTable, ogRpcIndex=ogRpcIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcTable=ogRpcTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckResolveActions=ogCheckResolveActions, ogCellModemApn=ogCellModemApn, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserIndex=ogHostUserIndex, ogCellApnNotification=ogCellApnNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostIpV6Address=ogHostIpV6Address, ogRpcType=ogRpcType, ogEmdIndex=ogEmdIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellDataNotification=ogCellDataNotification, ogUpsType=ogUpsType, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApInterface=ogWifiApInterface, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserName=ogHostUserName, ogHostServiceTable=ogHostServiceTable, ogUpsState=ogUpsState, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckDeviceName=ogCheckDeviceName, ogAlarmSummary=ogAlarmSummary, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialUserEntry=ogSerialUserEntry, ogWifiApTable=ogWifiApTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsName=ogUpsName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortMode=ogSerialPortMode, ogWifiApEntry=ogWifiApEntry, ogHostEntry=ogHostEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemEnabled=ogCellModemEnabled, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag)
