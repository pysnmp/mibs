...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsIndex=ogUpsIndex, ogCellModemTower=ogCellModemTower, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioEntry=ogEmdDioEntry, ogWebUserName=ogWebUserName, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortTable=ogSerialPortTable, ogUpsType=ogUpsType, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemCounter=ogCellModemCounter, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsConnectType=ogUpsConnectType, ogSerialUserPort=ogSerialUserPort, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceNotification=ogHostServiceNotification, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckIndex=ogCheckIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogFirmwareVersion=ogFirmwareVersion, ogEmdDioType=ogEmdDioType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientCounter=ogWifiClientCounter, ogHostUserAddress=ogHostUserAddress, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialUserLabel=ogSerialUserLabel, ogAlarmName=ogAlarmName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientAp=ogWifiApClientAp, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServicePort=ogHostServicePort, ogCellSignalNotification=ogCellSignalNotification, ogEmdName=ogEmdName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletFrequency=ogRpcOutletFrequency, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserName=ogSerialUserName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientMode=ogWifiClientMode, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmInstance=ogAlarmInstance, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmCheck=ogAlarmCheck, ogHostServiceTable=ogHostServiceTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortDCD=ogSerialPortDCD, ogWebUserSourcePort=ogWebUserSourcePort, ogHostIpV4Address=ogHostIpV4Address, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmTime=ogAlarmTime, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmSummary=ogAlarmSummary, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcIndex=ogRpcIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckEntry=ogCheckEntry, ogEmdDioState=ogEmdDioState, ogSerialUserEntry=ogSerialUserEntry, ogAlarmType=ogAlarmType, ogHostUserName=ogHostUserName, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApSsid=ogWifiApSsid, ogWifiApClientMac=ogWifiApClientMac, ogWebUserEntry=ogWebUserEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcName=ogRpcName, ogCheckDeviceName=ogCheckDeviceName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApFrequency=ogWifiApFrequency, ogAlarmEventId=ogAlarmEventId, ogSerialPortMode=ogSerialPortMode, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortLabel=ogSerialPortLabel, ogRpcInputNotification=ogRpcInputNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemIMSI=ogCellModemIMSI, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdEntry=ogEmdEntry, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortIndex=ogSerialPortIndex, ogUpsTemperature=ogUpsTemperature, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceType=ogNetInterfaceType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogStatus2Conformance=ogStatus2Conformance, ogNetInterfaceState=ogNetInterfaceState, ogHostTable=ogHostTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDescription=ogEmdDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmDevice=ogAlarmDevice, ogWifiClientTable=ogWifiClientTable, ogCheckTable=ogCheckTable, ogEmdDioDirection=ogEmdDioDirection, ogCellModemModel=ogCellModemModel, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioTable=ogEmdDioTable, ogUpsEntry=ogUpsEntry, ogRpcOutletName=ogRpcOutletName, ogAlarm=ogAlarm, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcConnectType=ogRpcConnectType, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioIndex=ogEmdDioIndex, ogEmdIndex=ogEmdIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemEntry=ogCellModemEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserEntry=ogHostUserEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcCounter=ogRpcCounter, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortCTS=ogSerialPortCTS, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientIndex=ogWifiApClientIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientRssi=ogWifiClientRssi, ogWifiApEntry=ogWifiApEntry, ogCellDataNotification=ogCellDataNotification, ogHostServiceCounter=ogHostServiceCounter, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserNotification=ogHostUserNotification, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryState=ogUpsBatteryState, ogCellModemVendor=ogCellModemVendor, ogHostServiceType=ogHostServiceType, ogUpsCounter=ogUpsCounter, ogCellModemConnected=ogCellModemConnected, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostIndex=ogHostIndex, ogHostUserIndex=ogHostUserIndex, ogUpsState=ogUpsState, ogAlarmUser=ogAlarmUser, ogNetInterfaceName=ogNetInterfaceName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdTable=ogEmdTable, ogRpcDescription=ogRpcDescription, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmType=ogCurrentAlarmType, ogHostPingNotification=ogHostPingNotification, ogStatus2Compliance=ogStatus2Compliance, ogUpsTable=ogUpsTable, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApClientTable=ogWifiApClientTable, ogWifiApTable=ogWifiApTable, ogAlarmLogTable=ogAlarmLogTable, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioEmd=ogEmdDioEmd, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsName=ogUpsName, ogUpsHumidity=ogUpsHumidity, ogRpcOutletState=ogRpcOutletState, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcTable=ogRpcTable, ogMibNotifications=ogMibNotifications, ogWebUserTable=ogWebUserTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostServiceHost=ogHostServiceHost)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientIndex=ogWifiClientIndex, ogHostUserHost=ogHostUserHost, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostEntry=ogHostEntry, ogStatus2=ogStatus2, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellModemApn=ogCellModemApn, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityName=ogEmdHumidityName, ogCellModemTable=ogCellModemTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellMessageNotification=ogCellMessageNotification, ogWebUserIndex=ogWebUserIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogStatus2Groups=ogStatus2Groups, ogRpcOutletTable=ogRpcOutletTable, ogHostName=ogHostName, ogCellApnNotification=ogCellApnNotification, ogHostUserStartTime=ogHostUserStartTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckType=ogCheckType, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsNotification=ogUpsNotification, ogCellTowerNotification=ogCellTowerNotification, ogSystem=ogSystem, ogRpcEntry=ogRpcEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApIndex=ogWifiApIndex, ogSerialNumber=ogSerialNumber, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdConnectType=ogEmdConnectType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioName=ogEmdDioName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcType=ogRpcType, ogAlarmState=ogAlarmState, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckName=ogCheckName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCustomNotification=ogCustomNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApCounter=ogWifiApCounter, ogUpsDescription=ogUpsDescription, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserTable=ogHostUserTable, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceIndex=ogHostServiceIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification)
