...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApIeeeMode=ogWifiApIeeeMode, ogFirmwareVersion=ogFirmwareVersion, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcOutletVoltage=ogRpcOutletVoltage, ogStatus2=ogStatus2, ogRpcInputNotification=ogRpcInputNotification, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsState=ogUpsState, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientMode=ogWifiClientMode, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioState=ogEmdDioState, ogCellModemModel=ogCellModemModel, ogAlarmEventId=ogAlarmEventId, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsConnectType=ogUpsConnectType, ogHostIpV6Address=ogHostIpV6Address, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserName=ogSerialUserName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemVendor=ogCellModemVendor, ogHostUserEntry=ogHostUserEntry, ogEmdTable=ogEmdTable, ogRpcDescription=ogRpcDescription, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserLabel=ogSerialUserLabel, ogEmdConnectType=ogEmdConnectType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckIndex=ogCheckIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcType=ogRpcType, ogStatus2Groups=ogStatus2Groups, ogWifiApEntry=ogWifiApEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcCounter=ogRpcCounter, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogStatus2Compliances=ogStatus2Compliances, ogWebUserNotification=ogWebUserNotification, ogHostServiceStatus=ogHostServiceStatus, ogAlarmState=ogAlarmState, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModemNetwork=ogCellModemNetwork, ogAlarmUser=ogAlarmUser, ogUpsIndex=ogUpsIndex, ogSerialUserNotification=ogSerialUserNotification, ogAlarmInstance=ogAlarmInstance, ogWifiApIndex=ogWifiApIndex, ogUpsType=ogUpsType, ogRpcIndex=ogRpcIndex, ogCheckDeviceName=ogCheckDeviceName, ogEmdDioType=ogEmdDioType, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcTable=ogRpcTable, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmType=ogAlarmType, ogWebUserIndex=ogWebUserIndex, ogWebUserStartTime=ogWebUserStartTime, ogHostServiceNotification=ogHostServiceNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostIndex=ogHostIndex, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdEnabled=ogEmdEnabled, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcName=ogRpcName, ogHostUserTable=ogHostUserTable, ogEmdDioName=ogEmdDioName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApSsid=ogWifiApSsid, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmCheck=ogAlarmCheck, ogSerialUserTable=ogSerialUserTable, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckType=ogCheckType, ogUpsCounter=ogUpsCounter, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDescription=ogEmdDescription, ogRpcOutletName=ogRpcOutletName, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemCounter=ogCellModemCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogCustomNotification=ogCustomNotification, ogHostServiceCounter=ogHostServiceCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyTable=ogPowerSupplyTable, ogCellApnNotification=ogCellApnNotification, ogUpsNotification=ogUpsNotification, ogSerialUserPort=ogSerialUserPort, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApInterface=ogWifiApInterface, ogCheckTable=ogCheckTable, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientTable=ogWifiApClientTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogNetInterfaceNotification=ogNetInterfaceNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmSummary=ogAlarmSummary, ogCellModemEntry=ogCellModemEntry, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientTable=ogWifiClientTable, ogUpsTable=ogUpsTable, ogWifiClientCounter=ogWifiClientCounter, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortRTS=ogSerialPortRTS, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortDCD=ogSerialPortDCD, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortParity=ogSerialPortParity, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostPingNotification=ogHostPingNotification, ogWifiClientEssid=ogWifiClientEssid, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputPower=ogUpsOutputPower, ogHostUserName=ogHostUserName, ogWebUserEntry=ogWebUserEntry, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceTable=ogHostServiceTable, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialNumber=ogSerialNumber, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletState=ogRpcOutletState, ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceType=ogHostServiceType, ogHostName=ogHostName, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputCurrent=ogUpsOutputCurrent, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioEntry=ogEmdDioEntry, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsDescription=ogUpsDescription, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostTable=ogHostTable, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApTable=ogWifiApTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServicePort=ogHostServicePort, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsHumidity=ogUpsHumidity, ogCellModemEnabled=ogCellModemEnabled, ogHostUserStartTime=ogHostUserStartTime, ogHostUserAddress=ogHostUserAddress, ogWebUserTable=ogWebUserTable, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellDataNotification=ogCellDataNotification, ogEmdName=ogEmdName, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApCounter=ogWifiApCounter, ogUpsName=ogUpsName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientMac=ogWifiApClientMac, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyName=ogPowerSupplyName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserIndex=ogHostUserIndex, ogCellTowerNotification=ogCellTowerNotification, ogCellMessageNotification=ogCellMessageNotification, ogHostUserHost=ogHostUserHost, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdIndex=ogEmdIndex, ogEmdHumidityEmd=ogEmdHumidityEmd)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemTower=ogCellModemTower, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckName=ogCheckName, ogRpcOutletTable=ogRpcOutletTable, ogEmdEntry=ogEmdEntry, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortIndex=ogSerialPortIndex, ogCellModemApn=ogCellModemApn, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcLogEnabled=ogRpcLogEnabled, ogHostEntry=ogHostEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmDevice=ogAlarmDevice, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsEntry=ogUpsEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckEntry=ogCheckEntry, ogAlarmTime=ogAlarmTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarm=ogAlarm, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemTable=ogCellModemTable, ogMibNotifications=ogMibNotifications, ogSystem=ogSystem, ogSerialPortTable=ogSerialPortTable, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceHost=ogHostServiceHost, ogUpsTemperature=ogUpsTemperature, ogWifiApTxPower=ogWifiApTxPower, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialUserIndex=ogSerialUserIndex, ogWebUserName=ogWebUserName, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmName=ogAlarmName, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortMode=ogSerialPortMode, ogEmdDioTable=ogEmdDioTable, ogWifiApEnabled=ogWifiApEnabled, PYSNMP_MODULE_ID=ogStatus2, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcEntry=ogRpcEntry, ogEmdDioCounter=ogEmdDioCounter)
