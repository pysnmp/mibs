...
NotificationType, Counter64, ModuleIdentity, MibIdentifier, Integer32, Counter32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Bits, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "ModuleIdentity", "MibIdentifier", "Integer32", "Counter32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Bits", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcIndex=ogRpcIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmState=ogAlarmState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortMode=ogSerialPortMode, ogHostIpV6Address=ogHostIpV6Address, ogUpsState=ogUpsState, ogCellModemConnected=ogCellModemConnected, ogUpsOutputPower=ogUpsOutputPower, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserName=ogHostUserName, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortCTS=ogSerialPortCTS, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientMac=ogWifiApClientMac, ogCellModemEnabled=ogCellModemEnabled, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientTable=ogWifiApClientTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcCounter=ogRpcCounter, ogPowerSupplyName=ogPowerSupplyName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWebUserName=ogWebUserName, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientInterface=ogWifiClientInterface, ogRpcConnectType=ogRpcConnectType, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellSignalNotification=ogCellSignalNotification, ogUpsConnectType=ogUpsConnectType, ogHostServiceType=ogHostServiceType, ogCheckIndex=ogCheckIndex, ogWebUserEntry=ogWebUserEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserNotification=ogSerialUserNotification, ogAlarmName=ogAlarmName, ogCellModemSessionTime=ogCellModemSessionTime, ogHostServiceEntry=ogHostServiceEntry, ogCellMessageNotification=ogCellMessageNotification, ogUpsCounter=ogUpsCounter, ogAlarmLogTable=ogAlarmLogTable, ogWifiApCounter=ogWifiApCounter, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsNotification=ogUpsNotification, ogWifiApTable=ogWifiApTable, ogUpsHumidity=ogUpsHumidity, ogWifiClientIndex=ogWifiClientIndex, ogHostUserAddress=ogHostUserAddress, ogHostIpV4Address=ogHostIpV4Address, ogEmdDioEmd=ogEmdDioEmd, ogWifiApInterface=ogWifiApInterface, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceIndex=ogHostServiceIndex, ogCellTowerNotification=ogCellTowerNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceStatus=ogHostServiceStatus, ogWebUserTable=ogWebUserTable, ogCellModemVendor=ogCellModemVendor, ogNetInterfaceState=ogNetInterfaceState, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckTable=ogCheckTable, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientMode=ogWifiClientMode, ogAlarmTime=ogAlarmTime, ogEmdName=ogEmdName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientCounter=ogWifiClientCounter, ogCellApnNotification=ogCellApnNotification, ogSerialPortLabel=ogSerialPortLabel, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemTower=ogCellModemTower, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcType=ogRpcType, ogAlarmInstance=ogAlarmInstance, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogStatus2Groups=ogStatus2Groups, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsEntry=ogUpsEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioDirection=ogEmdDioDirection, ogUpsIndex=ogUpsIndex, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdEnabled=ogEmdEnabled, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostPingNotification=ogHostPingNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioTable=ogEmdDioTable, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDescription=ogEmdDescription, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarm=ogAlarm, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientEnabled=ogWifiClientEnabled, ogHostEntry=ogHostEntry, ogEmdDioState=ogEmdDioState, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApFrequency=ogWifiApFrequency, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcInputNotification=ogRpcInputNotification, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcTable=ogRpcTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcInputFrequency=ogRpcInputFrequency, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletName=ogRpcOutletName, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortRTS=ogSerialPortRTS, ogHostUserHostName=ogHostUserHostName, ogRpcName=ogRpcName, ogHostUserStartTime=ogHostUserStartTime, ogUpsDescription=ogUpsDescription, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletState=ogRpcOutletState, ogHostServicePort=ogHostServicePort, ogWifiApEntry=ogWifiApEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsTable=ogUpsTable, ogAlarmDevice=ogAlarmDevice, ogCellModemTable=ogCellModemTable, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientEssid=ogWifiClientEssid, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckResolveActions=ogCheckResolveActions, ogHostServiceHost=ogHostServiceHost, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserTable=ogSerialUserTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSystem=ogSystem, ogHostTable=ogHostTable, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemApn=ogCellModemApn, ogWifiApTxPower=ogWifiApTxPower, ogCellDataNotification=ogCellDataNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWebUserStartTime=ogWebUserStartTime, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmType=ogAlarmType, ogWifiClientTxPower=ogWifiClientTxPower, ogNetInterfaceName=ogNetInterfaceName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckEntry=ogCheckEntry, ogHostUserHost=ogHostUserHost, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialUserPort=ogSerialUserPort, ogEmdDioIndex=ogEmdDioIndex, ogSerialNumber=ogSerialNumber, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApIndex=ogWifiApIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsInputNotification=ogUpsInputNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioName=ogEmdDioName, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcDescription=ogRpcDescription, ogWifiClientRssi=ogWifiClientRssi, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortParity=ogSerialPortParity, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogStatus2=ogStatus2, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcEntry=ogRpcEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdEntry=ogEmdEntry, ogCellModemIndex=ogCellModemIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemModel=ogCellModemModel, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceCounter=ogHostServiceCounter, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckDeviceName=ogCheckDeviceName, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryNotification=ogUpsBatteryNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogMibNotifications=ogMibNotifications, ogWebUserIndex=ogWebUserIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityName=ogEmdHumidityName, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserIndex=ogSerialUserIndex, ogHostUserIndex=ogHostUserIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckName=ogCheckName, ogNetInterfaceType=ogNetInterfaceType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientEntry=ogWifiClientEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApEnabled=ogWifiApEnabled, ogCellNetworkNotification=ogCellNetworkNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortTable=ogSerialPortTable, ogHostServiceTable=ogHostServiceTable, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserNotification=ogHostUserNotification, ogSerialUserLabel=ogSerialUserLabel, ogAlarmUser=ogAlarmUser, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostUserTable=ogHostUserTable, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmEventId=ogAlarmEventId, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyTable=ogPowerSupplyTable, ogCustomNotification=ogCustomNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogHostIndex=ogHostIndex, ogAlarmCheck=ogAlarmCheck, ogEmdDioCounter=ogEmdDioCounter, ogEmdTable=ogEmdTable, ogEmdDioType=ogEmdDioType, ogCellModemCounter=ogCellModemCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsType=ogUpsType, ogCellModem4gRssi=ogCellModem4gRssi, ogHostName=ogHostName, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialUserName=ogSerialUserName, ogHostUserEntry=ogHostUserEntry, ogCellModemEntry=ogCellModemEntry, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdIndex=ogEmdIndex, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortIndex=ogSerialPortIndex, ogWifiApClientAp=ogWifiApClientAp, ogUpsName=ogUpsName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckType=ogCheckType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdConnectType=ogEmdConnectType)
