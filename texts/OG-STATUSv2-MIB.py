...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Integer32, IpAddress, NotificationType, ModuleIdentity, Unsigned32, Counter32, Counter64, Bits, TimeTicks, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Integer32", "IpAddress", "NotificationType", "ModuleIdentity", "Unsigned32", "Counter32", "Counter64", "Bits", "TimeTicks", "Gauge32", "ObjectIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmState=ogAlarmState, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemTemperature=ogCellModemTemperature, ogCellModemCounter=ogCellModemCounter, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemNetwork=ogCellModemNetwork, ogSerialUserName=ogSerialUserName, ogHostTable=ogHostTable, ogUpsName=ogUpsName, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostPingNotification=ogHostPingNotification, ogSerialPortTable=ogSerialPortTable, ogRpcOutletNotification=ogRpcOutletNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostUserHostName=ogHostUserHostName, ogAlarmInstance=ogAlarmInstance, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceIndex=ogHostServiceIndex, ogUpsConnectType=ogUpsConnectType, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemIMSI=ogCellModemIMSI, ogSystem=ogSystem, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckEntry=ogCheckEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmEventId=ogAlarmEventId, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApTxPower=ogWifiApTxPower, ogWifiApEntry=ogWifiApEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmTime=ogAlarmTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApTable=ogWifiApTable, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellMessageNotification=ogCellMessageNotification, ogHostUserEntry=ogHostUserEntry, ogHostServiceNotification=ogHostServiceNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortParity=ogSerialPortParity, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialUserPort=ogSerialUserPort, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogMibNotifications=ogMibNotifications, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientBitRate=ogWifiClientBitRate, ogHostIndex=ogHostIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialUserStartTime=ogSerialUserStartTime, ogHostUserName=ogHostUserName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWebUserName=ogWebUserName, ogEmdDioName=ogEmdDioName, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogHostName=ogHostName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogStatus2=ogStatus2, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcTable=ogRpcTable, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioState=ogEmdDioState, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioTable=ogEmdDioTable, ogHostUserAddress=ogHostUserAddress, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientCounter=ogWifiClientCounter, ogRpcConnectType=ogRpcConnectType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemConnected=ogCellModemConnected, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemTower=ogCellModemTower, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcDescription=ogRpcDescription, ogHostUserStartTime=ogHostUserStartTime, ogUpsNotification=ogUpsNotification, ogAlarmUser=ogAlarmUser, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarmCheck=ogAlarmCheck, ogAlarmType=ogAlarmType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemModel=ogCellModemModel, ogRpcOutletTable=ogRpcOutletTable, ogNetInterfaceTable=ogNetInterfaceTable, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsHumidity=ogUpsHumidity, ogSerialPortDCD=ogSerialPortDCD, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioType=ogEmdDioType, ogUpsDescription=ogUpsDescription, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdIndex=ogEmdIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdConnectType=ogEmdConnectType, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputNotification=ogUpsInputNotification, ogCustomNotification=ogCustomNotification, ogHostServiceHost=ogHostServiceHost, ogRpcOutletState=ogRpcOutletState, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserTable=ogWebUserTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckTable=ogCheckTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientTable=ogWifiApClientTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmName=ogAlarmName, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellDataNotification=ogCellDataNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserNotification=ogHostUserNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogHostUserHost=ogHostUserHost, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApSsid=ogWifiApSsid, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioEntry=ogEmdDioEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceType=ogHostServiceType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckIndex=ogCheckIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletEntry=ogRpcOutletEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserTable=ogHostUserTable, ogRpcType=ogRpcType, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsTable=ogUpsTable, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioDirection=ogEmdDioDirection, ogWifiApCounter=ogWifiApCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWebUserEntry=ogWebUserEntry, ogNetInterfaceType=ogNetInterfaceType, ogHostIpV6Address=ogHostIpV6Address, ogEmdEntry=ogEmdEntry, ogCellModemVendor=ogCellModemVendor, ogSerialPortMode=ogSerialPortMode, ogAlarm=ogAlarm, ogRpcName=ogRpcName, ogEmdDescription=ogEmdDescription, ogCheckType=ogCheckType, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWebUserStartTime=ogWebUserStartTime, ogUpsState=ogUpsState, ogCellModemIndex=ogCellModemIndex, ogRpcEntry=ogRpcEntry, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmType=ogCurrentAlarmType, PYSNMP_MODULE_ID=ogStatus2, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientEntry=ogWifiClientEntry, ogStatus2Groups=ogStatus2Groups, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputTruePower=ogUpsOutputTruePower, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientTable=ogWifiClientTable, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServicePort=ogHostServicePort, ogSerialUserLabel=ogSerialUserLabel, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmSummary=ogAlarmSummary, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemApn=ogCellModemApn, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemTable=ogCellModemTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmDevice=ogAlarmDevice, ogHostServiceTable=ogHostServiceTable, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioEmd=ogEmdDioEmd, ogHostUserIndex=ogHostUserIndex, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortRTS=ogSerialPortRTS)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsCounter=ogUpsCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogStatus2Compliances=ogStatus2Compliances, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdName=ogEmdName, ogSerialUserNotification=ogSerialUserNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientMode=ogWifiClientMode, ogRpcCounter=ogRpcCounter, ogWebUserIndex=ogWebUserIndex, ogSerialNumber=ogSerialNumber, ogUpsIndex=ogUpsIndex, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortCTS=ogSerialPortCTS, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmLogTable=ogAlarmLogTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceStatus=ogHostServiceStatus, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioDescription=ogEmdDioDescription, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsEntry=ogUpsEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletName=ogRpcOutletName, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyName=ogPowerSupplyName, ogUpsType=ogUpsType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellApnNotification=ogCellApnNotification, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemRegistered=ogCellModemRegistered, ogRpcIndex=ogRpcIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostEntry=ogHostEntry, ogSerialPortIndex=ogSerialPortIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCheckName=ogCheckName, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsTemperature=ogUpsTemperature, ogSerialUserTable=ogSerialUserTable, ogEmdTable=ogEmdTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt)
