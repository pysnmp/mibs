...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcIndex=ogRpcIndex, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsTemperature=ogUpsTemperature, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemApn=ogCellModemApn, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioIndex=ogEmdDioIndex, ogCellApnNotification=ogCellApnNotification, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemCounter=ogCellModemCounter, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWebUserName=ogWebUserName, ogEmdDioState=ogEmdDioState, ogUpsConnectType=ogUpsConnectType, ogRpcDescription=ogRpcDescription, ogWifiApInterface=ogWifiApInterface, ogSerialPortMode=ogSerialPortMode, ogHostName=ogHostName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemModel=ogCellModemModel, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApTxPower=ogWifiApTxPower, ogWifiApFrequency=ogWifiApFrequency, ogNetInterfaceName=ogNetInterfaceName, ogWifiApCounter=ogWifiApCounter, ogUpsType=ogUpsType, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceStatus=ogHostServiceStatus, ogAlarmType=ogAlarmType, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckEntry=ogCheckEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemTower=ogCellModemTower, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckType=ogCheckType, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioType=ogEmdDioType, ogHostUserIndex=ogHostUserIndex, ogHostServiceHost=ogHostServiceHost, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmLogTable=ogAlarmLogTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckIndex=ogCheckIndex, ogRpcOutletName=ogRpcOutletName, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemConnected=ogCellModemConnected, ogCellModemEntry=ogCellModemEntry, ogStatus2Groups=ogStatus2Groups, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogPowerSupplyName=ogPowerSupplyName, ogUpsHumidity=ogUpsHumidity, ogUpsName=ogUpsName, ogAlarmUser=ogAlarmUser, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcEntry=ogRpcEntry, ogUpsOutputPower=ogUpsOutputPower, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApEntry=ogWifiApEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmLogIndex=ogAlarmLogIndex, ogWebUserIndex=ogWebUserIndex, ogSystem=ogSystem, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemEnabled=ogCellModemEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckDeviceEntry=ogCheckDeviceEntry, ogFirmwareVersion=ogFirmwareVersion, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmState=ogAlarmState, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmCheck=ogAlarmCheck, ogStatus2Compliance=ogStatus2Compliance, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmDevice=ogAlarmDevice, ogWebUserEntry=ogWebUserEntry, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityName=ogEmdHumidityName, ogEmdEntry=ogEmdEntry, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientEntry=ogWifiClientEntry, ogUpsEntry=ogUpsEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortDTR=ogSerialPortDTR, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostIpV4Address=ogHostIpV4Address, ogCellModemIndex=ogCellModemIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDescription=ogEmdDescription, ogUpsInputCurrent=ogUpsInputCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientMode=ogWifiClientMode, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmTime=ogAlarmTime, ogHostPingNotification=ogHostPingNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTable=ogEmdTable, ogCheckDeviceName=ogCheckDeviceName, ogEmdIndex=ogEmdIndex, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserTable=ogHostUserTable, ogHostTable=ogHostTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcCounter=ogRpcCounter, ogWifiClientInterface=ogWifiClientInterface, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortIndex=ogSerialPortIndex, ogHostServicePort=ogHostServicePort, ogMibNotifications=ogMibNotifications, ogUpsCounter=ogUpsCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceCounter=ogHostServiceCounter, ogWifiApTable=ogWifiApTable, ogSerialPortLabel=ogSerialPortLabel, ogRpcName=ogRpcName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellMessageNotification=ogCellMessageNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsDescription=ogUpsDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsInputNotification=ogUpsInputNotification, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientCounter=ogWifiClientCounter, ogHostEntry=ogHostEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogWebUserNotification=ogWebUserNotification, ogCheckTable=ogCheckTable, ogRpcInputNotification=ogRpcInputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcType=ogRpcType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputLoad=ogUpsOutputLoad, ogHostServiceEntry=ogHostServiceEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientRssi=ogWifiClientRssi, ogEmdDioName=ogEmdDioName, ogEmdName=ogEmdName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityEntry=ogEmdHumidityEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialNumber=ogSerialNumber, ogCellModemTable=ogCellModemTable, ogCellDataNotification=ogCellDataNotification, ogHostIpV6Address=ogHostIpV6Address, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApIndex=ogWifiApIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortDCD=ogSerialPortDCD, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogStatus2Conformance=ogStatus2Conformance, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcTable=ogRpcTable, ogSerialUserLabel=ogSerialUserLabel, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemVendor=ogCellModemVendor, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmInstance=ogAlarmInstance)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserName=ogHostUserName, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostUserHost=ogHostUserHost, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmEventId=ogAlarmEventId, ogSerialPortCTS=ogSerialPortCTS, ogAlarmLogEntry=ogAlarmLogEntry, ogStatus2=ogStatus2, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioDescription=ogEmdDioDescription, ogHostUserAddress=ogHostUserAddress, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellTowerNotification=ogCellTowerNotification, ogUpsState=ogUpsState, ogHostIndex=ogHostIndex, ogEmdDioCounter=ogEmdDioCounter, ogAlarmName=ogAlarmName, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceNotification=ogHostServiceNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsIndex=ogUpsIndex, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletState=ogRpcOutletState, ogSerialUserPort=ogSerialUserPort, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortRTS=ogSerialPortRTS, ogSerialUserIndex=ogSerialUserIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdConnectType=ogEmdConnectType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmSummary=ogAlarmSummary, ogCheckName=ogCheckName, ogWebUserTable=ogWebUserTable, ogHostUserEntry=ogHostUserEntry, ogUpsTable=ogUpsTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServiceType=ogHostServiceType, ogAlarm=ogAlarm, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsNotification=ogUpsNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioTable=ogEmdDioTable, ogRpcOutletTable=ogRpcOutletTable, ogCellModemRegistered=ogCellModemRegistered, ogEmdEnabled=ogEmdEnabled, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioNotification=ogEmdDioNotification, ogCellModemTemperature=ogCellModemTemperature, ogSerialUserName=ogSerialUserName, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserStartTime=ogHostUserStartTime, ogCustomNotification=ogCustomNotification, ogHostUserHostName=ogHostUserHostName)
