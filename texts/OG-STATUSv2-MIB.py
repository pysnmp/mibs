...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Unsigned32, Counter64, ModuleIdentity, Gauge32, Bits, IpAddress, iso, ObjectIdentity, NotificationType, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Unsigned32", "Counter64", "ModuleIdentity", "Gauge32", "Bits", "IpAddress", "iso", "ObjectIdentity", "NotificationType", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemEnabled=ogCellModemEnabled, ogSerialNumber=ogSerialNumber, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioCounter=ogEmdDioCounter, ogWifiApFrequency=ogWifiApFrequency, ogHostEntry=ogHostEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdIndex=ogEmdIndex, ogCheckTable=ogCheckTable, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioType=ogEmdDioType, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcDescription=ogRpcDescription, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcConnectType=ogRpcConnectType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsEntry=ogUpsEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApEntry=ogWifiApEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortMode=ogSerialPortMode, ogUpsTable=ogUpsTable, ogCustomNotification=ogCustomNotification, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellTowerNotification=ogCellTowerNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientEnabled=ogWifiClientEnabled, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsType=ogUpsType, ogUpsInputVoltage=ogUpsInputVoltage, ogHostPingNotification=ogHostPingNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarm=ogAlarm, ogAlarmType=ogAlarmType, ogMibNotifications=ogMibNotifications, ogWifiApTable=ogWifiApTable, ogSerialUserTable=ogSerialUserTable, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortLabel=ogSerialPortLabel, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServicePort=ogHostServicePort, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcEntry=ogRpcEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortDTR=ogSerialPortDTR, ogEmdDescription=ogEmdDescription, ogHostUserNotification=ogHostUserNotification, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogStatus2=ogStatus2, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemCounter=ogCellModemCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioEntry=ogEmdDioEntry, ogRpcTable=ogRpcTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostTable=ogHostTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApCounter=ogWifiApCounter, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWebUserIndex=ogWebUserIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserHost=ogHostUserHost, ogUpsTemperature=ogUpsTemperature, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApIndex=ogWifiApIndex, ogAlarmCheck=ogAlarmCheck, ogWifiApInterface=ogWifiApInterface, ogUpsOutputVoltage=ogUpsOutputVoltage, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceNotification=ogHostServiceNotification, ogCheckType=ogCheckType, ogUpsCounter=ogUpsCounter, ogAlarmName=ogAlarmName, ogWebUserName=ogWebUserName, ogSerialUserIndex=ogSerialUserIndex, ogCellModemEntry=ogCellModemEntry, ogHostUserTable=ogHostUserTable, ogEmdEnabled=ogEmdEnabled, ogCheckDeviceName=ogCheckDeviceName, ogSerialUserName=ogSerialUserName, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckName=ogCheckName, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcType=ogRpcType, ogCellModemSessionTime=ogCellModemSessionTime, ogFirmwareVersion=ogFirmwareVersion, ogStatus2Conformance=ogStatus2Conformance, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputPower=ogUpsOutputPower, ogEmdName=ogEmdName, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientTable=ogWifiClientTable, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdEntry=ogEmdEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogHostIpV6Address=ogHostIpV6Address, ogNetInterfaceName=ogNetInterfaceName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmState=ogAlarmState, ogSerialUserEntry=ogSerialUserEntry, ogAlarmUser=ogAlarmUser, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientRssi=ogWifiClientRssi, ogEmdTable=ogEmdTable, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdConnectType=ogEmdConnectType, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemTemperature=ogCellModemTemperature, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellSignalNotification=ogCellSignalNotification, ogWebUserStartTime=ogWebUserStartTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServiceTable=ogHostServiceTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserHostName=ogHostUserHostName, ogHostUserStartTime=ogHostUserStartTime, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckIndex=ogCheckIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioIndex=ogEmdDioIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDioTable=ogEmdDioTable, ogEmdDioDirection=ogEmdDioDirection, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmEventId=ogAlarmEventId, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmType=ogCurrentAlarmType, ogHostName=ogHostName, ogCellMessageNotification=ogCellMessageNotification, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientBitRate=ogWifiClientBitRate, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioState=ogEmdDioState, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientEntry=ogWifiClientEntry, ogHostUserAddress=ogHostUserAddress, ogCellModemModel=ogCellModemModel, ogWifiClientInterface=ogWifiClientInterface, ogUpsConnectType=ogUpsConnectType, ogUpsHumidity=ogUpsHumidity, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialUserPort=ogSerialUserPort, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortEntry=ogSerialPortEntry, ogRpcName=ogRpcName, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemIndex=ogCellModemIndex, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityName=ogEmdHumidityName, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsName=ogUpsName, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcCounter=ogRpcCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserEntry=ogHostUserEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientMode=ogWifiClientMode, ogSerialUserLabel=ogSerialUserLabel, ogHostIpV4Address=ogHostIpV4Address, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletState=ogRpcOutletState, ogWifiClientIndex=ogWifiClientIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsNotification=ogUpsNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortTable=ogSerialPortTable, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyName=ogPowerSupplyName, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmTable=ogCurrentAlarmTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortRTS=ogSerialPortRTS, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserTable=ogWebUserTable, ogRpcIndex=ogRpcIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioDescription=ogEmdDioDescription, ogWebUserNotification=ogWebUserNotification, ogWifiApClientTable=ogWifiApClientTable, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsState=ogUpsState, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApEnabled=ogWifiApEnabled, ogSystem=ogSystem, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientApMac=ogWifiClientApMac, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioNotification=ogEmdDioNotification, ogCellModemTable=ogCellModemTable, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsIndex=ogUpsIndex, ogHostServiceHost=ogHostServiceHost, ogAlarmTime=ogAlarmTime, ogHostUserName=ogHostUserName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostIndex=ogHostIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortParity=ogSerialPortParity, ogRpcOutletTable=ogRpcOutletTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioName=ogEmdDioName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogStatus2Compliances=ogStatus2Compliances, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceType=ogHostServiceType, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckEntry=ogCheckEntry, ogWebUserEntry=ogWebUserEntry, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemTower=ogCellModemTower, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemApn=ogCellModemApn, ogUpsDescription=ogUpsDescription, ogSerialPortTxBytes=ogSerialPortTxBytes)
