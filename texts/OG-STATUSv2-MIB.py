...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityName=ogEmdHumidityName, ogCheckTriggerActions=ogCheckTriggerActions, ogHostUserNotification=ogHostUserNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogFirmwareVersion=ogFirmwareVersion, ogWebUserName=ogWebUserName, ogRpcEntry=ogRpcEntry, ogRpcType=ogRpcType, ogEmdDioType=ogEmdDioType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostUserHost=ogHostUserHost, ogSerialSignalNotification=ogSerialSignalNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemVendor=ogCellModemVendor, ogAlarmState=ogAlarmState, ogSerialPortLabel=ogSerialPortLabel, ogCheckName=ogCheckName, ogUpsState=ogUpsState, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialUserName=ogSerialUserName, ogSerialPortEntry=ogSerialPortEntry, ogHostUserEntry=ogHostUserEntry, ogCheckEntry=ogCheckEntry, ogEmdEntry=ogEmdEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApTxPower=ogWifiApTxPower, ogCellModemIMSI=ogCellModemIMSI, ogCheckType=ogCheckType, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsName=ogUpsName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmLogTable=ogAlarmLogTable, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostUserTable=ogHostUserTable, ogAlarmType=ogAlarmType, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmName=ogAlarmName, ogUpsDescription=ogUpsDescription, ogEmdConnectType=ogEmdConnectType, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcName=ogRpcName, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserPort=ogSerialUserPort, ogAlarmCheck=ogAlarmCheck, ogWifiApSsid=ogWifiApSsid, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsIndex=ogUpsIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSystem=ogSystem, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioEmd=ogEmdDioEmd, ogCheckDeviceRef=ogCheckDeviceRef, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckIndex=ogCheckIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletState=ogRpcOutletState, ogEmdHumidityTable=ogEmdHumidityTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceName=ogCheckDeviceName, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsCounter=ogUpsCounter, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckResolveActions=ogCheckResolveActions, ogAlarmSummary=ogAlarmSummary, ogSerialPortMode=ogSerialPortMode, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckTable=ogCheckTable, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdIndex=ogEmdIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientRssi=ogWifiClientRssi, ogWifiApEntry=ogWifiApEntry, ogCellModemEntry=ogCellModemEntry, ogSerialPortTable=ogSerialPortTable, ogHostServiceStatus=ogHostServiceStatus, ogRpcDescription=ogRpcDescription, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserStartTime=ogHostUserStartTime, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryState=ogUpsBatteryState, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioIndex=ogEmdDioIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemNetwork=ogCellModemNetwork, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioTable=ogEmdDioTable, ogEmdDioCounter=ogEmdDioCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcTable=ogRpcTable, ogUpsInputNotification=ogUpsInputNotification, ogUpsType=ogUpsType, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserTable=ogWebUserTable, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcCounter=ogRpcCounter, ogEmdDioState=ogEmdDioState, ogWifiClientInterface=ogWifiClientInterface, ogCellModemEnabled=ogCellModemEnabled, ogHostServiceTable=ogHostServiceTable, ogHostServiceType=ogHostServiceType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostServiceHost=ogHostServiceHost, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmLogEntry=ogAlarmLogEntry, ogCustomNotification=ogCustomNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientAp=ogWifiApClientAp, ogUpsTemperature=ogUpsTemperature, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApCounter=ogWifiApCounter, ogWifiApTable=ogWifiApTable, ogRpcIndex=ogRpcIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWebUserNotification=ogWebUserNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletRpc=ogRpcOutletRpc, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletName=ogRpcOutletName, ogAlarmEventId=ogAlarmEventId, ogCellApnNotification=ogCellApnNotification, ogHostUserAddress=ogHostUserAddress, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientEntry=ogWifiClientEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsConnectType=ogUpsConnectType, ogEmdEnabled=ogEmdEnabled, ogCellModemCounter=ogCellModemCounter, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmTime=ogAlarmTime, ogEmdDioName=ogEmdDioName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmUser=ogAlarmUser, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdName=ogEmdName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcInputCurrent=ogRpcInputCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogNetInterfaceName=ogNetInterfaceName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApFrequency=ogWifiApFrequency, ogHostIndex=ogHostIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWebUserIndex=ogWebUserIndex, ogSerialUserIndex=ogSerialUserIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemTower=ogCellModemTower, ogEmdHumidityValue=ogEmdHumidityValue, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostPingNotification=ogHostPingNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortParity=ogSerialPortParity, ogWifiClientTable=ogWifiClientTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarm=ogAlarm, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientMode=ogWifiClientMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTable=ogEmdTable, ogHostUserName=ogHostUserName, ogWifiApIndex=ogWifiApIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDescription=ogEmdDescription, ogSerialNumber=ogSerialNumber, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellDataNotification=ogCellDataNotification, ogCellModem3gRssi=ogCellModem3gRssi)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientMac=ogWifiApClientMac, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsTable=ogUpsTable, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioDescription=ogEmdDioDescription, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogStatus2Groups=ogStatus2Groups, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortDTR=ogSerialPortDTR, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2=ogStatus2, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApInterface=ogWifiApInterface, ogCellTowerNotification=ogCellTowerNotification, ogHostTable=ogHostTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioEntry=ogEmdDioEntry, ogUpsNotification=ogUpsNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogMibNotifications=ogMibNotifications, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsHumidity=ogUpsHumidity, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemTable=ogCellModemTable, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryNotification=ogUpsBatteryNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostEntry=ogHostEntry, ogSerialUserTable=ogSerialUserTable, ogWifiClientEssid=ogWifiClientEssid, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsEntry=ogUpsEntry, ogHostServicePort=ogHostServicePort, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogAlarmInstance=ogAlarmInstance, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserEntry=ogSerialUserEntry, ogRpcInputNotification=ogRpcInputNotification, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceType=ogNetInterfaceType, ogCellModemModel=ogCellModemModel, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemConnected=ogCellModemConnected, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostName=ogHostName, ogSerialPortCTS=ogSerialPortCTS, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientApMac=ogWifiClientApMac, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserIndex=ogHostUserIndex, ogRpcConnectType=ogRpcConnectType, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemApn=ogCellModemApn, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue)
