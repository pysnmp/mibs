...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioNotification=ogEmdDioNotification, ogAlarmCheck=ogAlarmCheck, ogUpsCounter=ogUpsCounter, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostEntry=ogHostEntry, ogEmdIndex=ogEmdIndex, ogHostServiceType=ogHostServiceType, ogCellModemEnabled=ogCellModemEnabled, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletVoltage=ogRpcOutletVoltage, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientMac=ogWifiApClientMac, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientCounter=ogWifiClientCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortDSR=ogSerialPortDSR, ogRpcType=ogRpcType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdEnabled=ogEmdEnabled, ogHostName=ogHostName, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioState=ogEmdDioState, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientInterface=ogWifiClientInterface, ogAlarmUser=ogAlarmUser, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortTable=ogSerialPortTable, ogRpcInputNotification=ogRpcInputNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWebUserName=ogWebUserName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmTime=ogAlarmTime, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientMode=ogWifiClientMode, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortDTR=ogSerialPortDTR, ogSystem=ogSystem, ogCellApnNotification=ogCellApnNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletName=ogRpcOutletName, ogEmdDioName=ogEmdDioName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientAp=ogWifiApClientAp, ogRpcConnectType=ogRpcConnectType, ogHostUserIndex=ogHostUserIndex, ogAlarmLogTable=ogAlarmLogTable, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsTemperature=ogUpsTemperature, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemConnected=ogCellModemConnected, ogWifiClientRssi=ogWifiClientRssi, ogWebUserEntry=ogWebUserEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdConnectType=ogEmdConnectType, ogSerialUserName=ogSerialUserName, ogRpcDescription=ogRpcDescription, ogWifiApEntry=ogWifiApEntry, ogSerialPortDCD=ogSerialPortDCD, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostIndex=ogHostIndex, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckEntry=ogCheckEntry, ogCellModemTower=ogCellModemTower, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientTxPower=ogWifiClientTxPower, ogWebUserIndex=ogWebUserIndex, ogSerialPortLabel=ogSerialPortLabel, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApTxPower=ogWifiApTxPower, ogEmdDescription=ogEmdDescription, ogCheckTable=ogCheckTable, ogMibNotifications=ogMibNotifications, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyName=ogPowerSupplyName, ogWifiApFrequency=ogWifiApFrequency, ogWifiApCounter=ogWifiApCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsTable=ogUpsTable, ogEmdDioDescription=ogEmdDioDescription, ogAlarmDevice=ogAlarmDevice, ogSerialPortRTS=ogSerialPortRTS, ogAlarmPreviousValue=ogAlarmPreviousValue, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortParity=ogSerialPortParity, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioType=ogEmdDioType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmSummary=ogAlarmSummary, ogNetInterfaceState=ogNetInterfaceState, ogRpcEntry=ogRpcEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsConnectType=ogUpsConnectType, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostIpV6Address=ogHostIpV6Address, ogCellModemTemperature=ogCellModemTemperature, ogCheckName=ogCheckName, ogRpcCounter=ogRpcCounter, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogStatus2Compliance=ogStatus2Compliance, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCheckIndex=ogCheckIndex, ogUpsState=ogUpsState, ogCellModemVendor=ogCellModemVendor, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTable=ogEmdTable, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcIndex=ogRpcIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsName=ogUpsName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemEntry=ogCellModemEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogStatus2Conformance=ogStatus2Conformance, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApSsid=ogWifiApSsid, ogAlarmEventId=ogAlarmEventId, ogUpsDescription=ogUpsDescription, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostUserTable=ogHostUserTable, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserNotification=ogWebUserNotification, ogEmdDioIndex=ogEmdDioIndex, ogSerialUserEntry=ogSerialUserEntry, ogUpsIndex=ogUpsIndex, ogWifiClientEntry=ogWifiClientEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemModel=ogCellModemModel, ogSerialUserPort=ogSerialUserPort, ogCellTowerNotification=ogCellTowerNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsHumidity=ogUpsHumidity, ogWifiApTable=ogWifiApTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemCounter=ogCellModemCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemTable=ogCellModemTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdName=ogEmdName, ogRpcName=ogRpcName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientFrequency=ogWifiClientFrequency, ogNetInterfaceType=ogNetInterfaceType, ogSerialNumber=ogSerialNumber, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogStatus2=ogStatus2, ogEmdDioCounter=ogEmdDioCounter, ogAlarmName=ogAlarmName, ogCellDataNotification=ogCellDataNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemRegistered=ogCellModemRegistered, ogAlarmType=ogAlarmType, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsNotification=ogUpsNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletIndex=ogRpcOutletIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCustomNotification=ogCustomNotification, ogHostUserHostName=ogHostUserHostName, ogCheckType=ogCheckType, ogWifiClientTable=ogWifiClientTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServicePort=ogHostServicePort, ogStatus2Compliances=ogStatus2Compliances, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserIndex=ogSerialUserIndex, ogAlarmInstance=ogAlarmInstance, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcTable=ogRpcTable, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletState=ogRpcOutletState, ogHostServiceHost=ogHostServiceHost, ogHostServiceTable=ogHostServiceTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostUserHost=ogHostUserHost, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdEntry=ogEmdEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserEntry=ogHostUserEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientIndex=ogWifiClientIndex, ogHostUserAddress=ogHostUserAddress, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostIpV4Address=ogHostIpV4Address, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioTable=ogEmdDioTable, ogWebUserTable=ogWebUserTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemApn=ogCellModemApn, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioDirection=ogEmdDioDirection, ogAlarmState=ogAlarmState, ogWifiClientApMac=ogWifiClientApMac, ogHostUserStartTime=ogHostUserStartTime, ogUpsEntry=ogUpsEntry, ogSerialPortMode=ogSerialPortMode, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogHostUserName=ogHostUserName, ogHostTable=ogHostTable, ogSerialUserTable=ogSerialUserTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarm=ogAlarm, ogCellModemNetwork=ogCellModemNetwork, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApIndex=ogWifiApIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioEmd=ogEmdDioEmd, ogUpsType=ogUpsType)
