...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemConnected=ogCellModemConnected, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModemTemperature=ogCellModemTemperature, ogMibNotifications=ogMibNotifications, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserNotification=ogHostUserNotification, ogWifiApCounter=ogWifiApCounter, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmUser=ogAlarmUser, ogEmdHumidityName=ogEmdHumidityName, ogWebUserNotification=ogWebUserNotification, ogSerialPortDSR=ogSerialPortDSR, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsInputNotification=ogUpsInputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortEntry=ogSerialPortEntry, ogRpcIndex=ogRpcIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemTower=ogCellModemTower, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientAp=ogWifiApClientAp, ogCellDataNotification=ogCellDataNotification, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialNumber=ogSerialNumber, ogCellModemVendor=ogCellModemVendor, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmType=ogAlarmType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsName=ogUpsName, ogWifiApEnabled=ogWifiApEnabled, ogSerialUserLabel=ogSerialUserLabel, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsCounter=ogUpsCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioDirection=ogEmdDioDirection, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckEntry=ogCheckEntry, ogSerialPortMode=ogSerialPortMode, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioState=ogEmdDioState, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsEntry=ogUpsEntry, ogSystem=ogSystem, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserIndex=ogHostUserIndex, ogUpsDescription=ogUpsDescription, ogSerialUserName=ogSerialUserName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioCounter=ogEmdDioCounter, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcName=ogRpcName, ogStatus2Groups=ogStatus2Groups, ogRpcOutletState=ogRpcOutletState, ogUpsState=ogUpsState, ogWifiApTable=ogWifiApTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioType=ogEmdDioType, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientTable=ogWifiClientTable, ogCheckType=ogCheckType, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmTime=ogAlarmTime, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmCurrentValue=ogAlarmCurrentValue, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdConnectType=ogEmdConnectType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsType=ogUpsType, ogPowerSupplyName=ogPowerSupplyName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputPower=ogUpsOutputPower, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckResolveActions=ogCheckResolveActions, ogWebUserIndex=ogWebUserIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcConnectType=ogRpcConnectType, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemApn=ogCellModemApn, ogHostUserEntry=ogHostUserEntry, ogWifiClientEntry=ogWifiClientEntry, ogUpsHumidity=ogUpsHumidity, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceCounter=ogHostServiceCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortParity=ogSerialPortParity, ogWifiApIndex=ogWifiApIndex, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsConnectType=ogUpsConnectType, ogWifiApSsid=ogWifiApSsid, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialUserPort=ogSerialUserPort, ogEmdIndex=ogEmdIndex, ogHostUserHost=ogHostUserHost, ogAlarmInstance=ogAlarmInstance, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcType=ogRpcType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckIndex=ogCheckIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogNetInterfaceType=ogNetInterfaceType, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientMac=ogWifiApClientMac, ogCellMessageNotification=ogCellMessageNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserName=ogWebUserName, ogCellApnNotification=ogCellApnNotification, PYSNMP_MODULE_ID=ogStatus2, ogUpsTable=ogUpsTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserTable=ogSerialUserTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientIndex=ogWifiClientIndex, ogRpcCounter=ogRpcCounter, ogRpcTable=ogRpcTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemEnabled=ogCellModemEnabled, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioName=ogEmdDioName, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioIndex=ogEmdDioIndex, ogHostUserHostName=ogHostUserHostName, ogCellModemIndex=ogCellModemIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogHostUserTable=ogHostUserTable, ogAlarmState=ogAlarmState, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserIndex=ogSerialUserIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmName=ogAlarmName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemModel=ogCellModemModel, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortIndex=ogSerialPortIndex, ogEmdDescription=ogEmdDescription, ogAlarmDevice=ogAlarmDevice, ogStatus2=ogStatus2, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApFrequency=ogWifiApFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientEssid=ogWifiClientEssid, ogRpcDescription=ogRpcDescription, ogAlarmCheck=ogAlarmCheck, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWebUserEntry=ogWebUserEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientRssi=ogWifiClientRssi, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServicePort=ogHostServicePort, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortRTS=ogSerialPortRTS, ogCellModem3gRssi=ogCellModem3gRssi, ogHostIndex=ogHostIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityCounter=ogEmdHumidityCounter, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWebUserStartTime=ogWebUserStartTime, ogCheckName=ogCheckName, ogHostName=ogHostName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsTemperature=ogUpsTemperature, ogRpcOutletRpc=ogRpcOutletRpc, ogNetInterfaceName=ogNetInterfaceName, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcEntry=ogRpcEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostUserAddress=ogHostUserAddress, ogEmdLogEnabled=ogEmdLogEnabled, ogStatus2Compliances=ogStatus2Compliances, ogHostUserName=ogHostUserName, ogEmdDioTable=ogEmdDioTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientCounter=ogWifiClientCounter, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemEntry=ogCellModemEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdEnabled=ogEmdEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioEmd=ogEmdDioEmd, ogHostEntry=ogHostEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmTable=ogCurrentAlarmTable, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWebUserTable=ogWebUserTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialUserNotification=ogSerialUserNotification, ogHostServiceType=ogHostServiceType, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdName=ogEmdName, ogAlarmSummary=ogAlarmSummary, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortLabel=ogSerialPortLabel, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostPingNotification=ogHostPingNotification, ogUpsNotification=ogUpsNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemTable=ogCellModemTable, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceNotification=ogHostServiceNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTable=ogEmdTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmEventId=ogAlarmEventId, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortTable=ogSerialPortTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioNotification=ogEmdDioNotification, ogHostTable=ogHostTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsIndex=ogUpsIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogHostIpV6Address=ogHostIpV6Address, ogCellModemCounter=ogCellModemCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdEntry=ogEmdEntry, ogCheckTable=ogCheckTable, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarm=ogAlarm, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialUserEntry=ogSerialUserEntry, ogCustomNotification=ogCustomNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientRxPackets=ogWifiApClientRxPackets)
