...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApInterface=ogWifiApInterface, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemIMSI=ogCellModemIMSI, ogCellModemSessionTime=ogCellModemSessionTime, ogHostName=ogHostName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletName=ogRpcOutletName, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckIndex=ogCheckIndex, ogAlarmType=ogAlarmType, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmSummary=ogAlarmSummary, ogCheckType=ogCheckType, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcName=ogRpcName, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogFirmwareVersion=ogFirmwareVersion, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostServiceStatus=ogHostServiceStatus, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioType=ogEmdDioType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserTable=ogHostUserTable, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostServiceTable=ogHostServiceTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientInterface=ogWifiClientInterface, ogHostUserNotification=ogHostUserNotification, ogCellDataNotification=ogCellDataNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogHostServiceIndex=ogHostServiceIndex, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdConnectType=ogEmdConnectType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientTable=ogWifiApClientTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientTable=ogWifiClientTable, ogStatus2Compliances=ogStatus2Compliances, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellApnNotification=ogCellApnNotification, ogEmdEntry=ogEmdEntry, ogSerialPortMode=ogSerialPortMode, ogWifiClientIndex=ogWifiClientIndex, ogUpsNotification=ogUpsNotification, ogHostUserName=ogHostUserName, ogCellModemNetwork=ogCellModemNetwork, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioIndex=ogEmdDioIndex, ogCellModemIndex=ogCellModemIndex, ogCheckName=ogCheckName, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcEntry=ogRpcEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostIndex=ogHostIndex, ogSerialPortLabel=ogSerialPortLabel, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApTable=ogWifiApTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletIndex=ogRpcOutletIndex, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcTable=ogRpcTable, ogNetInterfaceType=ogNetInterfaceType, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmCheck=ogAlarmCheck, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckEntry=ogCheckEntry, ogAlarmInstance=ogAlarmInstance, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsEntry=ogUpsEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioEntry=ogEmdDioEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostPingNotification=ogHostPingNotification, ogEmdEnabled=ogEmdEnabled, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletFrequency=ogRpcOutletFrequency, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsIndex=ogUpsIndex, ogEmdDioName=ogEmdDioName, ogCellModemTower=ogCellModemTower, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApIndex=ogWifiApIndex, ogUpsName=ogUpsName, ogAlarmDevice=ogAlarmDevice, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortDTR=ogSerialPortDTR, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortTable=ogSerialPortTable, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialNumber=ogSerialNumber, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcInputFrequency=ogRpcInputFrequency, ogHostIpV4Address=ogHostIpV4Address, ogRpcIndex=ogRpcIndex, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioState=ogEmdDioState, ogEmdDescription=ogEmdDescription, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserName=ogSerialUserName, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityNotification=ogEmdHumidityNotification, ogMibNotifications=ogMibNotifications, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryState=ogUpsBatteryState, ogAlarmUser=ogAlarmUser, ogHostTable=ogHostTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsType=ogUpsType, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserEntry=ogWebUserEntry, ogRpcConnectType=ogRpcConnectType, ogSerialUserPort=ogSerialUserPort, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcCounter=ogRpcCounter, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioCounter=ogEmdDioCounter, ogHostServiceHost=ogHostServiceHost, ogSerialPortSpeed=ogSerialPortSpeed, ogHostEntry=ogHostEntry, ogUpsTable=ogUpsTable, ogHostUserHost=ogHostUserHost, ogAlarmState=ogAlarmState, ogWebUserTable=ogWebUserTable, ogCustomNotification=ogCustomNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApTxPower=ogWifiApTxPower, ogCellModemTable=ogCellModemTable, ogHostServiceCounter=ogHostServiceCounter, ogCellModemEntry=ogCellModemEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, PYSNMP_MODULE_ID=ogStatus2, ogHostServicePort=ogHostServicePort, ogEmdTable=ogEmdTable, ogEmdDioNotification=ogEmdDioNotification, ogUpsCounter=ogUpsCounter, ogWebUserStartTime=ogWebUserStartTime, ogStatus2=ogStatus2, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApCounter=ogWifiApCounter, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckTable=ogCheckTable, ogRpcOutletTable=ogRpcOutletTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemModel=ogCellModemModel, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsConnectType=ogUpsConnectType, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserHostName=ogHostUserHostName, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialUserIndex=ogSerialUserIndex, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsDescription=ogUpsDescription, ogAlarm=ogAlarm, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientEnabled=ogWifiClientEnabled, ogSystem=ogSystem, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletState=ogRpcOutletState, ogAlarmTime=ogAlarmTime, ogAlarmTriggerValue=ogAlarmTriggerValue, ogStatus2Groups=ogStatus2Groups, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioDescription=ogEmdDioDescription, ogRpcType=ogRpcType, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcDescription=ogRpcDescription, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortDCD=ogSerialPortDCD, ogEmdName=ogEmdName, ogWebUserName=ogWebUserName, ogEmdTemperatureName=ogEmdTemperatureName, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmTable=ogCurrentAlarmTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserIndex=ogHostUserIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioTable=ogEmdDioTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsOutputPower=ogUpsOutputPower, ogUpsOutputLoad=ogUpsOutputLoad, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserEntry=ogHostUserEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemApn=ogCellModemApn, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialUserTable=ogSerialUserTable, ogEmdIndex=ogEmdIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioEmd=ogEmdDioEmd, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemTemperature=ogCellModemTemperature, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWebUserIndex=ogWebUserIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialUserEntry=ogSerialUserEntry, ogHostServiceType=ogHostServiceType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemCounter=ogCellModemCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortEntry=ogSerialPortEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogStatus2Compliance=ogStatus2Compliance, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsState=ogUpsState, ogEmdHumidityName=ogEmdHumidityName, ogAlarmName=ogAlarmName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortDSR=ogSerialPortDSR, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientMode=ogWifiClientMode, ogUpsHumidity=ogUpsHumidity, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortStopBits=ogSerialPortStopBits)
