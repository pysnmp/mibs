...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServicePort=ogHostServicePort, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsType=ogUpsType, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmCheck=ogAlarmCheck, ogHostServiceEntry=ogHostServiceEntry, ogHostUserIndex=ogHostUserIndex, ogHostUserAddress=ogHostUserAddress, ogStatus2Compliances=ogStatus2Compliances, ogAlarmLogTable=ogAlarmLogTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialNumber=ogSerialNumber, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmSummary=ogAlarmSummary, ogCellModemNetwork=ogCellModemNetwork, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckName=ogCheckName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsName=ogUpsName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckType=ogCheckType, ogUpsOutputPower=ogUpsOutputPower, ogCellModemConnected=ogCellModemConnected, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcIndex=ogRpcIndex, ogWifiApIndex=ogWifiApIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceType=ogHostServiceType, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceState=ogNetInterfaceState, ogAlarmDevice=ogAlarmDevice, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApFrequency=ogWifiApFrequency, ogUpsTable=ogUpsTable, ogRpcInputFrequency=ogRpcInputFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdEnabled=ogEmdEnabled, ogHostIndex=ogHostIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialSignalNotification=ogSerialSignalNotification, ogStatus2Compliance=ogStatus2Compliance, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWebUserNotification=ogWebUserNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcConnectType=ogRpcConnectType, ogEmdTable=ogEmdTable, ogCellModemVendor=ogCellModemVendor, ogUpsDescription=ogUpsDescription, ogHostServiceStatus=ogHostServiceStatus, ogCellModemIMSI=ogCellModemIMSI, ogEmdIndex=ogEmdIndex, ogWifiClientCounter=ogWifiClientCounter, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostEntry=ogHostEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceCounter=ogHostServiceCounter, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogWebUserIndex=ogWebUserIndex, ogSerialUserName=ogSerialUserName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellNetworkNotification=ogCellNetworkNotification, ogHostPingNotification=ogHostPingNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDescription=ogEmdDescription, ogEmdDioState=ogEmdDioState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApTable=ogWifiApTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserHostName=ogHostUserHostName, ogEmdName=ogEmdName, ogCellSignalNotification=ogCellSignalNotification, ogRpcEntry=ogRpcEntry, ogHostServiceIndex=ogHostServiceIndex, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientEntry=ogWifiClientEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmInstance=ogAlarmInstance, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioCounter=ogEmdDioCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApCounter=ogWifiApCounter, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcType=ogRpcType, ogUpsEntry=ogUpsEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmName=ogAlarmName, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientMode=ogWifiClientMode, ogWifiClientInterface=ogWifiClientInterface, ogUpsTemperature=ogUpsTemperature, ogCellModemRegistered=ogCellModemRegistered, ogAlarmType=ogAlarmType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckTable=ogCheckTable, ogCustomNotification=ogCustomNotification, ogUpsNotification=ogUpsNotification, ogWebUserEntry=ogWebUserEntry, ogRpcDescription=ogRpcDescription, ogUpsBatteryState=ogUpsBatteryState, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogStatus2=ogStatus2, ogHostUserName=ogHostUserName, ogHostUserTable=ogHostUserTable, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceHost=ogHostServiceHost, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortEntry=ogSerialPortEntry, ogHostName=ogHostName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserHost=ogHostUserHost, ogWebUserTable=ogWebUserTable, ogMibNotifications=ogMibNotifications, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsHumidity=ogUpsHumidity, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApSsid=ogWifiApSsid, ogStatus2Conformance=ogStatus2Conformance, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, PYSNMP_MODULE_ID=ogStatus2, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientBitRate=ogWifiClientBitRate, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCheckDeviceName=ogCheckDeviceName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemApn=ogCellModemApn, ogSerialPortDTR=ogSerialPortDTR, ogEmdConnectType=ogEmdConnectType, ogRpcOutletName=ogRpcOutletName, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcCounter=ogRpcCounter, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmEventId=ogAlarmEventId, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarm=ogAlarm, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialUserTable=ogSerialUserTable, ogSerialUserPort=ogSerialUserPort, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioType=ogEmdDioType, ogCellModemEntry=ogCellModemEntry, ogRpcTable=ogRpcTable, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortDSR=ogSerialPortDSR, ogCellModemIndex=ogCellModemIndex, ogUpsState=ogUpsState, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserEntry=ogSerialUserEntry, ogCellModemTable=ogCellModemTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientEssid=ogWifiClientEssid, ogSystem=ogSystem, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortFlowControl=ogSerialPortFlowControl, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortTable=ogSerialPortTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckEntry=ogCheckEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientApMac=ogWifiClientApMac, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioIndex=ogEmdDioIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioName=ogEmdDioName, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortMode=ogSerialPortMode)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdEntry=ogEmdEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemCounter=ogCellModemCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortRTS=ogSerialPortRTS, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmState=ogAlarmState, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserEntry=ogHostUserEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsCounter=ogUpsCounter, ogWifiApInterface=ogWifiApInterface, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioNotification=ogEmdDioNotification, ogCheckIndex=ogCheckIndex, ogHostServiceTable=ogHostServiceTable, ogUpsIndex=ogUpsIndex, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientTable=ogWifiClientTable, ogHostTable=ogHostTable, ogAlarmTime=ogAlarmTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryNotification=ogUpsBatteryNotification, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortDCD=ogSerialPortDCD, ogRpcName=ogRpcName, ogUpsConnectType=ogUpsConnectType, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemModel=ogCellModemModel, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientIndex=ogWifiClientIndex, ogCellModemTower=ogCellModemTower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmUser=ogAlarmUser, ogCurrentAlarmState=ogCurrentAlarmState, ogWebUserName=ogWebUserName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdDioEmd=ogEmdDioEmd, ogRpcOutletState=ogRpcOutletState, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortRxBytes=ogSerialPortRxBytes, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDioTable=ogEmdDioTable, ogWifiClientRssi=ogWifiClientRssi, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApClientTxPackets=ogWifiApClientTxPackets)
