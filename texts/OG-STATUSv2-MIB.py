...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserName=ogSerialUserName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsTemperature=ogUpsTemperature, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserNotification=ogWebUserNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogHostName=ogHostName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemTemperature=ogCellModemTemperature, ogRpcTable=ogRpcTable, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserEntry=ogSerialUserEntry, ogHostUserHost=ogHostUserHost, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortRTS=ogSerialPortRTS, ogAlarmType=ogAlarmType, ogUpsEntry=ogUpsEntry, ogCellModemTable=ogCellModemTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortEntry=ogSerialPortEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApEntry=ogWifiApEntry, ogEmdDioEmd=ogEmdDioEmd, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdIndex=ogEmdIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioDirection=ogEmdDioDirection, ogAlarm=ogAlarm, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsOutputNotification=ogUpsOutputNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDescription=ogEmdDescription, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryNotification=ogUpsBatteryNotification, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryState=ogUpsBatteryState, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellTowerNotification=ogCellTowerNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcDescription=ogRpcDescription, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmLogTable=ogAlarmLogTable, ogHostServiceEntry=ogHostServiceEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletNotification=ogRpcOutletNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTable=ogEmdTable, ogCellModemModel=ogCellModemModel, ogNetInterfaceName=ogNetInterfaceName, ogCheckType=ogCheckType, ogRpcConnectType=ogRpcConnectType, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmTime=ogAlarmTime, ogSerialUserPort=ogSerialUserPort, ogUpsName=ogUpsName, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmDevice=ogAlarmDevice, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletState=ogRpcOutletState, ogWifiApClientMac=ogWifiApClientMac, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortStopBits=ogSerialPortStopBits, ogWebUserName=ogWebUserName, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsTable=ogUpsTable, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsState=ogUpsState, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmLogIndex=ogAlarmLogIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserTable=ogHostUserTable, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsHumidity=ogUpsHumidity, ogWifiClientTable=ogWifiClientTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialUserTable=ogSerialUserTable, ogSystem=ogSystem, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckEntry=ogCheckEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWebUserIndex=ogWebUserIndex, ogHostTable=ogHostTable, ogCellDataNotification=ogCellDataNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientIndex=ogWifiClientIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialUserNotification=ogSerialUserNotification, ogAlarmName=ogAlarmName, ogCellModemTower=ogCellModemTower, ogWifiApTable=ogWifiApTable, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientEntry=ogWifiApClientEntry, ogStatus2Compliance=ogStatus2Compliance, ogWifiApTxPower=ogWifiApTxPower, ogRpcOutletName=ogRpcOutletName, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogMibNotifications=ogMibNotifications, ogAlarmState=ogAlarmState, ogEmdName=ogEmdName, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2=ogStatus2, ogHostEntry=ogHostEntry, ogEmdEnabled=ogEmdEnabled, ogCheckIndex=ogCheckIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceTable=ogHostServiceTable, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServiceStatus=ogHostServiceStatus, ogHostUserAddress=ogHostUserAddress, ogEmdDioName=ogEmdDioName, ogUpsOutputPower=ogUpsOutputPower, ogHostUserNotification=ogHostUserNotification, ogUpsType=ogUpsType, ogCellModemCounter=ogCellModemCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityNotification=ogEmdHumidityNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityValue=ogEmdHumidityValue, ogStatus2Conformance=ogStatus2Conformance, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogFirmwareVersion=ogFirmwareVersion, ogStatus2Groups=ogStatus2Groups, ogRpcEntry=ogRpcEntry, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmUser=ogAlarmUser, ogHostUserEntry=ogHostUserEntry, ogCellModemConnected=ogCellModemConnected, ogWifiClientRssi=ogWifiClientRssi, ogHostServicePort=ogHostServicePort, ogUpsCounter=ogUpsCounter, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortMode=ogSerialPortMode, ogWifiApClientAp=ogWifiApClientAp, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdEntry=ogEmdEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmTable=ogCurrentAlarmTable, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserLabel=ogSerialUserLabel, ogHostIndex=ogHostIndex, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemApn=ogCellModemApn, ogRpcIndex=ogRpcIndex, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceHost=ogHostServiceHost, ogUpsNotification=ogUpsNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWebUserEntry=ogWebUserEntry, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostIpV6Address=ogHostIpV6Address, ogRpcCounter=ogRpcCounter, ogWifiApSsid=ogWifiApSsid, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletTable=ogRpcOutletTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApEnabled=ogWifiApEnabled)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApIndex=ogWifiApIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortParity=ogSerialPortParity, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserHostName=ogHostUserHostName, ogCellModemVendor=ogCellModemVendor, ogHostUserIndex=ogHostUserIndex, ogEmdDioTable=ogEmdDioTable, ogCheckTable=ogCheckTable, ogHostServiceType=ogHostServiceType, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortLabel=ogSerialPortLabel, ogSerialNumber=ogSerialNumber, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCustomNotification=ogCustomNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmCheck=ogAlarmCheck, ogUpsDescription=ogUpsDescription, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcName=ogRpcName, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostUserName=ogHostUserName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletRpc=ogRpcOutletRpc, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortTable=ogSerialPortTable, ogCellModemEntry=ogCellModemEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsConnectType=ogUpsConnectType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientInterface=ogWifiClientInterface, ogWifiApFrequency=ogWifiApFrequency, ogNetInterfaceEntry=ogNetInterfaceEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioState=ogEmdDioState, ogSerialPortDCD=ogSerialPortDCD, ogAlarmEventId=ogAlarmEventId, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioType=ogEmdDioType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcType=ogRpcType, ogRpcOutletTotal=ogRpcOutletTotal, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckName=ogCheckName, ogWifiApCounter=ogWifiApCounter, ogWifiApInterface=ogWifiApInterface, ogHostServiceNotification=ogHostServiceNotification, ogUpsIndex=ogUpsIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemIMSI=ogCellModemIMSI, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemIndex=ogCellModemIndex, ogAlarmSummary=ogAlarmSummary)
