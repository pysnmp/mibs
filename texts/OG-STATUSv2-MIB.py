...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Integer32, ModuleIdentity, Counter32, iso, Gauge32, TimeTicks, NotificationType, Counter64, ObjectIdentity, IpAddress, Unsigned32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Integer32", "ModuleIdentity", "Counter32", "iso", "Gauge32", "TimeTicks", "NotificationType", "Counter64", "ObjectIdentity", "IpAddress", "Unsigned32", "Bits")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostIpV4Address=ogHostIpV4Address, ogHostServiceEntry=ogHostServiceEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserTable=ogHostUserTable, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcCounter=ogRpcCounter, ogWifiApEntry=ogWifiApEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsTable=ogUpsTable, ogCheckType=ogCheckType, ogEmdDioEmd=ogEmdDioEmd, ogHostTable=ogHostTable, ogEmdDioState=ogEmdDioState, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioName=ogEmdDioName, ogSerialPortIndex=ogSerialPortIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemCounter=ogCellModemCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmUser=ogAlarmUser, ogRpcOutletState=ogRpcOutletState, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortEntry=ogSerialPortEntry, ogEmdEnabled=ogEmdEnabled, ogEmdDioType=ogEmdDioType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApTxPower=ogWifiApTxPower, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientInterface=ogWifiClientInterface, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortDCD=ogSerialPortDCD, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckTable=ogCheckTable, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSystem=ogSystem, ogSerialUserName=ogSerialUserName, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientAp=ogWifiApClientAp, ogAlarmDevice=ogAlarmDevice, ogCellModemTable=ogCellModemTable, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortRTS=ogSerialPortRTS, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdConnectType=ogEmdConnectType, ogCellDataNotification=ogCellDataNotification, ogCellTowerNotification=ogCellTowerNotification, ogWebUserNotification=ogWebUserNotification, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogCustomNotification=ogCustomNotification, ogSerialUserIndex=ogSerialUserIndex, ogUpsEntry=ogUpsEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogStatus2=ogStatus2, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemTemperature=ogCellModemTemperature, ogHostEntry=ogHostEntry, ogAlarmState=ogAlarmState, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApCounter=ogWifiApCounter, ogCheckTriggerActions=ogCheckTriggerActions, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientEntry=ogWifiClientEntry, ogHostUserEntry=ogHostUserEntry, ogWifiApInterface=ogWifiApInterface, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellApnNotification=ogCellApnNotification, ogWifiClientApMac=ogWifiClientApMac, ogHostUserName=ogHostUserName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostServiceType=ogHostServiceType, ogUpsInputCurrent=ogUpsInputCurrent, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortStopBits=ogSerialPortStopBits, ogHostPingNotification=ogHostPingNotification, ogMibNotifications=ogMibNotifications, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdDioTable=ogEmdDioTable, ogUpsState=ogUpsState, ogCheckEntry=ogCheckEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientIndex=ogWifiClientIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogHostIpV6Address=ogHostIpV6Address, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsName=ogUpsName, ogAlarm=ogAlarm, ogUpsDescription=ogUpsDescription, ogUpsIndex=ogUpsIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsNotification=ogUpsNotification, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostIndex=ogHostIndex, ogUpsHumidity=ogUpsHumidity, ogStatus2Compliances=ogStatus2Compliances, ogEmdEntry=ogEmdEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortMode=ogSerialPortMode, ogWebUserName=ogWebUserName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApEnabled=ogWifiApEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmName=ogAlarmName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDescription=ogEmdDescription, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmLogTable=ogAlarmLogTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsConnectType=ogUpsConnectType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientMode=ogWifiClientMode, ogEmdDioCounter=ogEmdDioCounter, ogUpsCounter=ogUpsCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemConnected=ogCellModemConnected, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckResolveActions=ogCheckResolveActions, ogHostName=ogHostName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserTable=ogSerialUserTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcDescription=ogRpcDescription, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostServiceTable=ogHostServiceTable, ogWifiClientCounter=ogWifiClientCounter, ogHostServicePort=ogHostServicePort, ogWifiClientTable=ogWifiClientTable, ogRpcEntry=ogRpcEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcConnectType=ogRpcConnectType, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckName=ogCheckName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserNotification=ogSerialUserNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmCheck=ogAlarmCheck, ogCellModemModel=ogCellModemModel, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortTable=ogSerialPortTable, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmType=ogAlarmType, ogCellModemVendor=ogCellModemVendor, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServiceHost=ogHostServiceHost, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmTime=ogCurrentAlarmTime, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApIndex=ogWifiApIndex, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioDirection=ogEmdDioDirection, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcInputNotification=ogRpcInputNotification, ogSerialUserPort=ogSerialUserPort, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientBitRate=ogWifiClientBitRate, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortParityErrors=ogSerialPortParityErrors)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletEntry=ogRpcOutletEntry, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletTable=ogRpcOutletTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmTime=ogAlarmTime, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityCounter=ogEmdHumidityCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemApn=ogCellModemApn, ogCheckIndex=ogCheckIndex, ogHostUserNotification=ogHostUserNotification, ogSerialPortParity=ogSerialPortParity, ogRpcName=ogRpcName, PYSNMP_MODULE_ID=ogStatus2, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdName=ogEmdName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceStatus=ogHostServiceStatus, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortDTR=ogSerialPortDTR, ogSerialNumber=ogSerialNumber, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientTable=ogWifiApClientTable, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsTemperature=ogUpsTemperature, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTable=ogEmdTable, ogWifiApTable=ogWifiApTable, ogHostUserStartTime=ogHostUserStartTime, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcType=ogRpcType, ogUpsType=ogUpsType, ogStatus2Groups=ogStatus2Groups, ogCellModemIndex=ogCellModemIndex, ogRpcIndex=ogRpcIndex, ogCellModemEnabled=ogCellModemEnabled, ogWifiApIeeeMode=ogWifiApIeeeMode, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostUserAddress=ogHostUserAddress, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogNetInterfaceEntry=ogNetInterfaceEntry, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletName=ogRpcOutletName, ogHostUserHost=ogHostUserHost, ogEmdDioIndex=ogEmdDioIndex, ogWebUserEntry=ogWebUserEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmInstance=ogAlarmInstance, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemEntry=ogCellModemEntry, ogCellModemTower=ogCellModemTower, ogEmdDioEntry=ogEmdDioEntry, ogWebUserIndex=ogWebUserIndex, ogRpcTable=ogRpcTable, ogWebUserStartTime=ogWebUserStartTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdIndex=ogEmdIndex, ogAlarmSummary=ogAlarmSummary, ogUpsOutputTruePower=ogUpsOutputTruePower)
