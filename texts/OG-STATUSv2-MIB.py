...
NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, Counter64, TimeTicks, iso, IpAddress, ObjectIdentity, Bits, Integer32, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "Counter64", "TimeTicks", "iso", "IpAddress", "ObjectIdentity", "Bits", "Integer32", "Gauge32", "ModuleIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2Compliances=ogStatus2Compliances, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialUserLabel=ogSerialUserLabel, ogEmdTable=ogEmdTable, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortTable=ogSerialPortTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcCounter=ogRpcCounter, ogUpsType=ogUpsType, ogHostUserHost=ogHostUserHost, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellApnNotification=ogCellApnNotification, ogSerialUserTable=ogSerialUserTable, ogCellModemConnected=ogCellModemConnected, ogHostEntry=ogHostEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsDescription=ogUpsDescription, ogHostUserNotification=ogHostUserNotification, ogFirmwareVersion=ogFirmwareVersion, ogUpsName=ogUpsName, ogHostIpV4Address=ogHostIpV4Address, ogCustomNotification=ogCustomNotification, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApClientAp=ogWifiApClientAp, ogStatus2=ogStatus2, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmDevice=ogAlarmDevice, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialUserIndex=ogSerialUserIndex, ogCellModemCounter=ogCellModemCounter, ogUpsCounter=ogUpsCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSystem=ogSystem, ogEmdDioName=ogEmdDioName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemApn=ogCellModemApn, ogRpcName=ogRpcName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarm=ogAlarm, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmCheck=ogAlarmCheck, ogUpsIndex=ogUpsIndex, ogWifiApSsid=ogWifiApSsid, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortParity=ogSerialPortParity, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApTable=ogWifiApTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioTable=ogEmdDioTable, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortRTS=ogSerialPortRTS, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsNotification=ogUpsNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmInstance=ogAlarmInstance, ogCellModemNetwork=ogCellModemNetwork, ogAlarmLogTable=ogAlarmLogTable, ogWebUserTable=ogWebUserTable, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortLabel=ogSerialPortLabel, ogWifiApEnabled=ogWifiApEnabled, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckIndex=ogCheckIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWebUserIndex=ogWebUserIndex, ogUpsConnectType=ogUpsConnectType, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientFrequency=ogWifiClientFrequency, PYSNMP_MODULE_ID=ogStatus2, ogCellDataNotification=ogCellDataNotification, ogHostServiceStatus=ogHostServiceStatus, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioType=ogEmdDioType, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdEntry=ogEmdEntry, ogSerialNumber=ogSerialNumber, ogHostUserTable=ogHostUserTable, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogStatus2Groups=ogStatus2Groups, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioCounter=ogEmdDioCounter, ogHostServicePort=ogHostServicePort, ogSerialPortDCD=ogSerialPortDCD, ogRpcInputVoltage=ogRpcInputVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletName=ogRpcOutletName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdName=ogEmdName, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemVendor=ogCellModemVendor, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientTable=ogWifiClientTable, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputPower=ogUpsOutputPower, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientMode=ogWifiClientMode, ogSerialUserName=ogSerialUserName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcInputNotification=ogRpcInputNotification, ogRpcIndex=ogRpcIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostUserName=ogHostUserName, ogUpsHumidity=ogUpsHumidity, ogHostName=ogHostName, ogUpsEntry=ogUpsEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialUserEntry=ogSerialUserEntry, ogWifiApEntry=ogWifiApEntry, ogAlarmTime=ogAlarmTime, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmState=ogAlarmState, ogCellTowerNotification=ogCellTowerNotification, ogCheckEntry=ogCheckEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApTxPower=ogWifiApTxPower, ogCellModemTable=ogCellModemTable, ogCellModemEntry=ogCellModemEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserPort=ogSerialUserPort, ogMibNotifications=ogMibNotifications, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientInterface=ogWifiClientInterface, ogHostServiceTable=ogHostServiceTable, ogWifiApCounter=ogWifiApCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellMessageNotification=ogCellMessageNotification, ogHostServiceHost=ogHostServiceHost, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryState=ogUpsBatteryState, ogUpsOutputLoad=ogUpsOutputLoad, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdEnabled=ogEmdEnabled, ogUpsState=ogUpsState, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyName=ogPowerSupplyName, ogStatus2Conformance=ogStatus2Conformance, ogRpcDescription=ogRpcDescription, ogSerialUserNotification=ogSerialUserNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmUser=ogAlarmUser, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogStatus2Compliance=ogStatus2Compliance, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceIndex=ogHostServiceIndex, ogHostIndex=ogHostIndex, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostIpV6Address=ogHostIpV6Address, ogHostUserAddress=ogHostUserAddress, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmType=ogAlarmType, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioIndex=ogEmdDioIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcType=ogRpcType, ogWifiApInterface=ogWifiApInterface, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmSummary=ogAlarmSummary, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemModel=ogCellModemModel, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcTable=ogRpcTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioDescription=ogEmdDioDescription, ogUpsBatteryRunTime=ogUpsBatteryRunTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmEventId=ogAlarmEventId, ogWebUserNotification=ogWebUserNotification, ogWebUserName=ogWebUserName, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdHumidityTable=ogEmdHumidityTable, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientApMac=ogWifiClientApMac, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientRssi=ogWifiClientRssi, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserEntry=ogWebUserEntry, ogEmdIndex=ogEmdIndex, ogHostServiceCounter=ogHostServiceCounter, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsTable=ogUpsTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceType=ogHostServiceType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletTable=ogRpcOutletTable, ogWifiApIndex=ogWifiApIndex, ogSerialPortDTR=ogSerialPortDTR, ogEmdConnectType=ogEmdConnectType, ogHostUserIndex=ogHostUserIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcConnectType=ogRpcConnectType, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletIndex=ogRpcOutletIndex, ogWebUserStartTime=ogWebUserStartTime, ogEmdDescription=ogEmdDescription, ogRpcOutletState=ogRpcOutletState, ogCellSignalNotification=ogCellSignalNotification, ogRpcEntry=ogRpcEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCheckName=ogCheckName, ogEmdDioState=ogEmdDioState, ogHostServiceNotification=ogHostServiceNotification, ogCheckTable=ogCheckTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemTower=ogCellModemTower, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortMode=ogSerialPortMode, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckType=ogCheckType, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostTable=ogHostTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmName=ogAlarmName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification)
