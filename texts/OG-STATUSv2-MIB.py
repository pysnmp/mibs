...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputPower=ogUpsOutputPower, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemConnected=ogCellModemConnected, ogWifiClientIndex=ogWifiClientIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletLoad=ogRpcOutletLoad, ogHostUserHostName=ogHostUserHostName, ogUpsType=ogUpsType, ogUpsBatteryState=ogUpsBatteryState, ogCellDataNotification=ogCellDataNotification, ogWifiApClientTable=ogWifiApClientTable, ogHostUserAddress=ogHostUserAddress, ogSerialUserPort=ogSerialUserPort, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmUser=ogAlarmUser, ogWifiApTable=ogWifiApTable, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceNotification=ogHostServiceNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemIndex=ogCellModemIndex, ogUpsIndex=ogUpsIndex, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortEntry=ogSerialPortEntry, ogCheckType=ogCheckType, ogRpcOutletRpc=ogRpcOutletRpc, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdTable=ogEmdTable, ogWifiClientMode=ogWifiClientMode, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialUserEntry=ogSerialUserEntry, ogWifiApIndex=ogWifiApIndex, ogRpcOutletState=ogRpcOutletState, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsConnectType=ogUpsConnectType, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogNetInterfaceType=ogNetInterfaceType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcName=ogRpcName, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityName=ogEmdHumidityName, ogWifiApEntry=ogWifiApEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogStatus2Groups=ogStatus2Groups, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemApn=ogCellModemApn, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModem4gRssi=ogCellModem4gRssi, ogHostName=ogHostName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcDescription=ogRpcDescription, ogCellApnNotification=ogCellApnNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcCounter=ogRpcCounter, ogPowerSupplyName=ogPowerSupplyName, ogWebUserIndex=ogWebUserIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRssi=ogWifiClientRssi, ogMibNotifications=ogMibNotifications, ogEmdDioDescription=ogEmdDioDescription, ogUpsDescription=ogUpsDescription, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsTemperature=ogUpsTemperature, ogWifiApCounter=ogWifiApCounter, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServicePort=ogHostServicePort, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmEventId=ogAlarmEventId, ogRpcIndex=ogRpcIndex, ogCellModemTable=ogCellModemTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemRegistered=ogCellModemRegistered, ogSerialUserLabel=ogSerialUserLabel, ogCellModemTower=ogCellModemTower, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioState=ogEmdDioState, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioTable=ogEmdDioTable, ogWifiClientApMac=ogWifiClientApMac, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmState=ogAlarmState, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDescription=ogEmdDescription, ogCurrentAlarmName=ogCurrentAlarmName, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientCounter=ogWifiClientCounter, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostUserIndex=ogHostUserIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdName=ogEmdName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServiceType=ogHostServiceType, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioEmd=ogEmdDioEmd, ogSystem=ogSystem, ogFirmwareVersion=ogFirmwareVersion, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioName=ogEmdDioName, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceStatus=ogHostServiceStatus, ogUpsState=ogUpsState, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApInterface=ogWifiApInterface, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserEntry=ogHostUserEntry, ogUpsEntry=ogUpsEntry, ogAlarmLogTable=ogAlarmLogTable, ogWifiApEnabled=ogWifiApEnabled, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioDirection=ogEmdDioDirection, PYSNMP_MODULE_ID=ogStatus2, ogEmdConnectType=ogEmdConnectType, ogUpsCounter=ogUpsCounter, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarm=ogAlarm, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserTable=ogWebUserTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApTxPower=ogWifiApTxPower, ogUpsHumidity=ogUpsHumidity, ogSerialUserNotification=ogSerialUserNotification, ogStatus2Compliances=ogStatus2Compliances, ogCellModemCounter=ogCellModemCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortStopBits=ogSerialPortStopBits, ogWebUserEntry=ogWebUserEntry, ogWifiClientTable=ogWifiClientTable, ogWifiApSsid=ogWifiApSsid, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmTime=ogAlarmTime, ogAlarmInstance=ogAlarmInstance, ogEmdDioType=ogEmdDioType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemModel=ogCellModemModel, ogSerialNumber=ogSerialNumber, ogSerialPortTable=ogSerialPortTable, ogWifiClientEssid=ogWifiClientEssid, ogCellModemEnabled=ogCellModemEnabled, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortLabel=ogSerialPortLabel, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemEntry=ogCellModemEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceHost=ogHostServiceHost, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCustomNotification=ogCustomNotification, ogCheckTable=ogCheckTable, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckEntry=ogCheckEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialUserName=ogSerialUserName, ogCellMessageNotification=ogCellMessageNotification, ogHostUserTable=ogHostUserTable, ogEmdEntry=ogEmdEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmDevice=ogAlarmDevice, ogCheckName=ogCheckName, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmName=ogAlarmName, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcEntry=ogRpcEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcConnectType=ogRpcConnectType, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostEntry=ogHostEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdEnabled=ogEmdEnabled, ogAlarmType=ogAlarmType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostTable=ogHostTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogStatus2=ogStatus2, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletName=ogRpcOutletName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWebUserName=ogWebUserName, ogWifiClientInterface=ogWifiClientInterface, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserTable=ogSerialUserTable, ogHostUserName=ogHostUserName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApClientMac=ogWifiApClientMac, ogUpsName=ogUpsName, ogUpsNotification=ogUpsNotification, ogCheckIndex=ogCheckIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortMode=ogSerialPortMode, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortDSR=ogSerialPortDSR, ogHostIndex=ogHostIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioCounter=ogEmdDioCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortDCD=ogSerialPortDCD, ogEmdHumidityTotal=ogEmdHumidityTotal, ogStatus2Conformance=ogStatus2Conformance, ogWifiApFrequency=ogWifiApFrequency, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputNotification=ogUpsInputNotification, ogRpcType=ogRpcType, ogSerialUserIndex=ogSerialUserIndex, ogHostUserHost=ogHostUserHost, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdIndex=ogEmdIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemVendor=ogCellModemVendor, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcTable=ogRpcTable, ogSerialPortParity=ogSerialPortParity, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletTable=ogRpcOutletTable, ogHostUserNotification=ogHostUserNotification, ogAlarmSummary=ogAlarmSummary, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdDioEntry=ogEmdDioEntry, ogUpsTable=ogUpsTable, ogHostServiceTable=ogHostServiceTable)
