...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserHost=ogHostUserHost, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryState=ogUpsBatteryState, ogEmdConnectType=ogEmdConnectType, ogPowerSupplyName=ogPowerSupplyName, ogHostServicePort=ogHostServicePort, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdLogEnabled=ogEmdLogEnabled, ogHostTable=ogHostTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSystem=ogSystem, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckEntry=ogCheckEntry, ogEmdName=ogEmdName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarm=ogAlarm, ogWifiApInterface=ogWifiApInterface, ogCellModemEntry=ogCellModemEntry, ogWebUserTable=ogWebUserTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcCounter=ogRpcCounter, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemTemperature=ogCellModemTemperature, ogHostIpV4Address=ogHostIpV4Address, ogHostPingNotification=ogHostPingNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemTower=ogCellModemTower, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortDCD=ogSerialPortDCD, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdEntry=ogEmdEntry, ogStatus2Groups=ogStatus2Groups, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogStatus2=ogStatus2, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemTable=ogCellModemTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmLogTable=ogAlarmLogTable, ogCheckName=ogCheckName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsCounter=ogUpsCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemApn=ogCellModemApn, ogEmdDioTable=ogEmdDioTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserName=ogSerialUserName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortTxBytes=ogSerialPortTxBytes, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortParity=ogSerialPortParity, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortIndex=ogSerialPortIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioType=ogEmdDioType, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioCounter=ogEmdDioCounter, ogUpsTemperature=ogUpsTemperature, ogStatus2Compliances=ogStatus2Compliances, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsHumidity=ogUpsHumidity, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckIndex=ogCheckIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceTable=ogHostServiceTable, ogWifiClientEntry=ogWifiClientEntry, ogHostUserHostName=ogHostUserHostName, ogAlarmSummary=ogAlarmSummary, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialUserTable=ogSerialUserTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioState=ogEmdDioState, ogHostName=ogHostName, ogEmdDioEntry=ogEmdDioEntry, ogUpsConnectType=ogUpsConnectType, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortRTS=ogSerialPortRTS, PYSNMP_MODULE_ID=ogStatus2, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemModel=ogCellModemModel, ogWifiApTxPower=ogWifiApTxPower, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcTable=ogRpcTable, ogSerialPortLabel=ogSerialPortLabel, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityTable=ogEmdHumidityTable, ogHostServiceNotification=ogHostServiceNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsTable=ogUpsTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsType=ogUpsType, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserName=ogWebUserName, ogSerialPortMode=ogSerialPortMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckType=ogCheckType, ogCellModemNetwork=ogCellModemNetwork, ogRpcEntry=ogRpcEntry, ogHostUserEntry=ogHostUserEntry, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioName=ogEmdDioName, ogWifiApCounter=ogWifiApCounter, ogUpsEntry=ogUpsEntry, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioDescription=ogEmdDioDescription, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmEventId=ogAlarmEventId, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcIndex=ogRpcIndex, ogRpcOutletName=ogRpcOutletName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletTable=ogRpcOutletTable, ogCheckTable=ogCheckTable, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsIndex=ogUpsIndex, ogHostServiceType=ogHostServiceType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogMibNotifications=ogMibNotifications, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmName=ogAlarmName, ogWifiApTable=ogWifiApTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApEnabled=ogWifiApEnabled, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserAddress=ogHostUserAddress, ogRpcType=ogRpcType, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellDataNotification=ogCellDataNotification, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserPort=ogSerialUserPort, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogStatus2Conformance=ogStatus2Conformance, ogCellMessageNotification=ogCellMessageNotification, ogAlarmCheck=ogAlarmCheck, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmType=ogAlarmType, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceHost=ogHostServiceHost, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientRssi=ogWifiApClientRssi, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsState=ogUpsState, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemRegistered=ogCellModemRegistered, ogHostUserTable=ogHostUserTable, ogWebUserIndex=ogWebUserIndex, ogCellModemIndex=ogCellModemIndex, ogRpcOutletState=ogRpcOutletState, ogRpcInputCurrent=ogRpcInputCurrent, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostEntry=ogHostEntry, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApIndex=ogWifiApIndex, ogWebUserStartTime=ogWebUserStartTime, ogUpsNotification=ogUpsNotification, ogHostUserNotification=ogHostUserNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApAuthNotification=ogWifiApAuthNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortEntry=ogSerialPortEntry, ogAlarmTime=ogAlarmTime, ogWifiClientInterface=ogWifiClientInterface, ogRpcConnectType=ogRpcConnectType, ogUpsOutputPower=ogUpsOutputPower, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmState=ogAlarmState, ogWifiApClientTable=ogWifiApClientTable, ogUpsInputVoltage=ogUpsInputVoltage, ogCustomNotification=ogCustomNotification, ogRpcDescription=ogRpcDescription, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellTowerNotification=ogCellTowerNotification, ogHostUserName=ogHostUserName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialNumber=ogSerialNumber, ogEmdTable=ogEmdTable, ogCellModemConnected=ogCellModemConnected, ogWifiClientMode=ogWifiClientMode, ogEmdEnabled=ogEmdEnabled, ogHostUserIndex=ogHostUserIndex, ogUpsInputNotification=ogUpsInputNotification, ogRpcInputNotification=ogRpcInputNotification, ogUpsName=ogUpsName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserEntry=ogWebUserEntry, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmDevice=ogAlarmDevice, ogUpsInputFrequency=ogUpsInputFrequency, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientCounter=ogWifiClientCounter, ogCheckResolveActions=ogCheckResolveActions, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemVendor=ogCellModemVendor, ogWifiApClientMac=ogWifiApClientMac, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityCounter=ogEmdHumidityCounter, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDescription=ogEmdDescription, ogHostIndex=ogHostIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemIMSI=ogCellModemIMSI, ogAlarmInstance=ogAlarmInstance, ogRpcName=ogRpcName, ogAlarmUser=ogAlarmUser, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdIndex=ogEmdIndex, ogUpsDescription=ogUpsDescription, ogWebUserNotification=ogWebUserNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellApnNotification=ogCellApnNotification, ogHostUserStartTime=ogHostUserStartTime, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientBitRate=ogWifiClientBitRate)
