...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemModel=ogCellModemModel, ogWifiClientInterface=ogWifiClientInterface, ogHostUserAddress=ogHostUserAddress, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckType=ogCheckType, ogNetInterfaceType=ogNetInterfaceType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApInterface=ogWifiApInterface, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcEntry=ogRpcEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioIndex=ogEmdDioIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcType=ogRpcType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogStatus2Groups=ogStatus2Groups, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWebUserEntry=ogWebUserEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostUserStartTime=ogHostUserStartTime, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortIndex=ogSerialPortIndex, ogRpcName=ogRpcName, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioType=ogEmdDioType, ogHostServiceType=ogHostServiceType, ogCellModemEnabled=ogCellModemEnabled, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApEntry=ogWifiApEntry, ogUpsIndex=ogUpsIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckIndex=ogCheckIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckTable=ogCheckTable, ogCheckDeviceName=ogCheckDeviceName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientTable=ogWifiClientTable, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserPort=ogSerialUserPort, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemTable=ogCellModemTable, ogSerialPortRTS=ogSerialPortRTS, ogRpcDescription=ogRpcDescription, ogCheckResolveActions=ogCheckResolveActions, ogUpsCounter=ogUpsCounter, ogSerialUserTable=ogSerialUserTable, ogHostServiceTable=ogHostServiceTable, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostServiceEntry=ogHostServiceEntry, ogCellModemEntry=ogCellModemEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserTable=ogWebUserTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSystem=ogSystem, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientEntry=ogWifiClientEntry, ogWifiApTable=ogWifiApTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcCounter=ogRpcCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsHumidity=ogUpsHumidity, ogSerialPortDCD=ogSerialPortDCD, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmName=ogAlarmName, ogSerialPortBreaks=ogSerialPortBreaks, ogStatus2=ogStatus2, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdConnectType=ogEmdConnectType, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryState=ogUpsBatteryState, ogHostEntry=ogHostEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemTower=ogCellModemTower, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmInstance=ogAlarmInstance, ogCellApnNotification=ogCellApnNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdEntry=ogEmdEntry, ogCellModemTemperature=ogCellModemTemperature, ogAlarmUser=ogAlarmUser, ogEmdHumidityName=ogEmdHumidityName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTable=ogEmdTable, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityValue=ogEmdHumidityValue, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletName=ogRpcOutletName, ogWebUserStartTime=ogWebUserStartTime, ogSerialUserName=ogSerialUserName, ogUpsState=ogUpsState, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsNotification=ogUpsNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserNotification=ogWebUserNotification, ogCellModemVendor=ogCellModemVendor, ogHostUserName=ogHostUserName, ogCustomNotification=ogCustomNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletTable=ogRpcOutletTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostServicePort=ogHostServicePort, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostIndex=ogHostIndex, ogAlarmState=ogAlarmState, ogWifiApClientTable=ogWifiApClientTable, ogAlarmEventId=ogAlarmEventId, ogHostServiceHost=ogHostServiceHost, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortParity=ogSerialPortParity, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellDataNotification=ogCellDataNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemIndex=ogCellModemIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortTable=ogSerialPortTable, ogSerialPortDTR=ogSerialPortDTR, ogAlarmCheck=ogAlarmCheck, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsOutputPower=ogUpsOutputPower, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceName=ogNetInterfaceName, ogHostUserHostName=ogHostUserHostName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdEnabled=ogEmdEnabled, ogSerialUserIndex=ogSerialUserIndex, ogCellModemConnected=ogCellModemConnected, ogHostName=ogHostName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsInputFrequency=ogUpsInputFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioEntry=ogEmdDioEntry, ogStatus2Compliances=ogStatus2Compliances, ogHostUserTable=ogHostUserTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemCounter=ogCellModemCounter, ogRpcMaxTemperature=ogRpcMaxTemperature, ogFirmwareVersion=ogFirmwareVersion, PYSNMP_MODULE_ID=ogStatus2, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletState=ogRpcOutletState, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyName=ogPowerSupplyName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsTemperature=ogUpsTemperature, ogEmdIndex=ogEmdIndex, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmSummary=ogAlarmSummary, ogCellTowerNotification=ogCellTowerNotification, ogWifiApSsid=ogWifiApSsid, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmTime=ogAlarmTime, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientMac=ogWifiApClientMac, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsConnectType=ogUpsConnectType, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialSignalNotification=ogSerialSignalNotification, ogWebUserName=ogWebUserName, ogCheckName=ogCheckName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogNetInterfaceState=ogNetInterfaceState, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApEnabled=ogWifiApEnabled, ogUpsDescription=ogUpsDescription, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostTable=ogHostTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdHumidityTable=ogEmdHumidityTable, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceCounter=ogHostServiceCounter, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioEmd=ogEmdDioEmd, ogAlarmType=ogAlarmType, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarm=ogAlarm, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApFrequency=ogWifiApFrequency, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogMibNotifications=ogMibNotifications, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostUserHost=ogHostUserHost, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientMode=ogWifiClientMode, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioName=ogEmdDioName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWebUserIndex=ogWebUserIndex, ogRpcTable=ogRpcTable, ogRpcIndex=ogRpcIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDescription=ogEmdDescription, ogStatus2Compliance=ogStatus2Compliance, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioState=ogEmdDioState, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortEntry=ogSerialPortEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserIndex=ogHostUserIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdName=ogEmdName, ogWifiApIndex=ogWifiApIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserEntry=ogHostUserEntry, ogUpsTable=ogUpsTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsEntry=ogUpsEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckEntry=ogCheckEntry, ogCellModemApn=ogCellModemApn, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmDevice=ogAlarmDevice, ogSerialPortLabel=ogSerialPortLabel, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialNumber=ogSerialNumber, ogUpsType=ogUpsType, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogBasicStatusGroup=ogBasicStatusGroup, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsName=ogUpsName, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputVoltage=ogUpsOutputVoltage)
