...
iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, IpAddress, Integer32, NotificationType, MibIdentifier, Counter32, TimeTicks, ModuleIdentity, Gauge32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "IpAddress", "Integer32", "NotificationType", "MibIdentifier", "Counter32", "TimeTicks", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputCurrent=ogUpsInputCurrent, ogCheckIndex=ogCheckIndex, ogUpsInputNotification=ogUpsInputNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsType=ogUpsType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostName=ogHostName, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdConnectType=ogEmdConnectType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceCounter=ogHostServiceCounter, ogWifiApTable=ogWifiApTable, ogAlarmName=ogAlarmName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceType=ogHostServiceType, ogWifiApInterface=ogWifiApInterface, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserIndex=ogWebUserIndex, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioState=ogEmdDioState, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWebUserName=ogWebUserName, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioEntry=ogEmdDioEntry, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientIndex=ogWifiApClientIndex, ogHostServiceTable=ogHostServiceTable, ogUpsDescription=ogUpsDescription, ogCellModemRegistered=ogCellModemRegistered, ogEmdDescription=ogEmdDescription, ogWifiApAuthNotification=ogWifiApAuthNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostServiceHost=ogHostServiceHost, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmEventId=ogAlarmEventId, ogHostServiceStatus=ogHostServiceStatus, ogWifiApSsid=ogWifiApSsid, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckTable=ogCheckTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdEntry=ogEmdEntry, ogSerialUserLabel=ogSerialUserLabel, ogCellModemTower=ogCellModemTower, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdName=ogEmdName, ogRpcInputCurrent=ogRpcInputCurrent, ogCellMessageNotification=ogCellMessageNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceNotification=ogHostServiceNotification, ogHostEntry=ogHostEntry, ogCheckName=ogCheckName, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioNotification=ogEmdDioNotification, ogAlarmInstance=ogAlarmInstance, ogNetInterfaceState=ogNetInterfaceState, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityName=ogEmdHumidityName, ogRpcEntry=ogRpcEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApEntry=ogWifiApEntry, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogHostTable=ogHostTable, ogSerialPortIndex=ogSerialPortIndex, ogCellModemIndex=ogCellModemIndex, ogRpcDescription=ogRpcDescription, ogHostPingNotification=ogHostPingNotification, ogEmdEnabled=ogEmdEnabled, ogCustomNotification=ogCustomNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsEntry=ogUpsEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserTable=ogSerialUserTable, ogSerialPortDataBits=ogSerialPortDataBits, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemConnected=ogCellModemConnected, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellSignalNotification=ogCellSignalNotification, ogAlarmTime=ogAlarmTime, ogCellModemVendor=ogCellModemVendor, ogWebUserTable=ogWebUserTable, ogAlarmUser=ogAlarmUser, ogHostUserIndex=ogHostUserIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcMaxTemperature=ogRpcMaxTemperature, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsNotification=ogUpsNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmSummary=ogAlarmSummary, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortParity=ogSerialPortParity, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientRssi=ogWifiClientRssi, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellTowerNotification=ogCellTowerNotification, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarm=ogAlarm, ogSerialPortStopBits=ogSerialPortStopBits, ogCellApnNotification=ogCellApnNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemApn=ogCellModemApn, ogRpcConnectType=ogRpcConnectType, ogRpcOutletTable=ogRpcOutletTable, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmType=ogAlarmType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogStatus2Groups=ogStatus2Groups, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortTable=ogSerialPortTable, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutletIndex=ogRpcOutletIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceEntry=ogHostServiceEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcTable=ogRpcTable, ogRpcInputVoltage=ogRpcInputVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioName=ogEmdDioName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletState=ogRpcOutletState, ogCliUserSessionNotification=ogCliUserSessionNotification, ogStatus2Compliance=ogStatus2Compliance, ogRpcName=ogRpcName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientEssid=ogWifiClientEssid, ogAlarmCheck=ogAlarmCheck, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApCounter=ogWifiApCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogStatus2=ogStatus2, ogEmdDioTable=ogEmdDioTable, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortMode=ogSerialPortMode, ogEmdIndex=ogEmdIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSystem=ogSystem, ogWifiClientTable=ogWifiClientTable, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellNetworkNotification=ogCellNetworkNotification, ogHostUserTable=ogHostUserTable, ogRpcType=ogRpcType, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserName=ogHostUserName, ogWifiClientMode=ogWifiClientMode, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserHost=ogHostUserHost, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWebUserNotification=ogWebUserNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdTable=ogEmdTable, ogRpcCounter=ogRpcCounter)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsName=ogUpsName, ogHostUserEntry=ogHostUserEntry, ogCellModemTable=ogCellModemTable, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortCTS=ogSerialPortCTS, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioDirection=ogEmdDioDirection, ogUpsCounter=ogUpsCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostUserStartTime=ogHostUserStartTime, ogUpsIndex=ogUpsIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsTemperature=ogUpsTemperature, ogSerialNumber=ogSerialNumber, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsHumidity=ogUpsHumidity, ogEmdDioIndex=ogEmdDioIndex, ogCellDataNotification=ogCellDataNotification, ogCheckType=ogCheckType, ogWifiClientCounter=ogWifiClientCounter, ogHostServicePort=ogHostServicePort, ogHostIndex=ogHostIndex, ogWebUserEntry=ogWebUserEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsState=ogUpsState, ogMibNotifications=ogMibNotifications, ogHostUserNotification=ogHostUserNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortDCD=ogSerialPortDCD, ogUpsConnectType=ogUpsConnectType, ogRpcIndex=ogRpcIndex, ogAlarmDevice=ogAlarmDevice, ogUpsTable=ogUpsTable, ogCellModemCounter=ogCellModemCounter, ogSerialPortDTR=ogSerialPortDTR, ogAlarmState=ogAlarmState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletName=ogRpcOutletName, ogSerialUserName=ogSerialUserName, ogCellModemModel=ogCellModemModel, ogCheckEntry=ogCheckEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApFrequency=ogWifiApFrequency, ogWifiApTxPower=ogWifiApTxPower, ogHostUserAddress=ogHostUserAddress, ogWebUserStartTime=ogWebUserStartTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioType=ogEmdDioType)
