...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortRTS=ogSerialPortRTS, ogCustomNotification=ogCustomNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialUserName=ogSerialUserName, ogSerialNumber=ogSerialNumber, ogCellModemConnected=ogCellModemConnected, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmTime=ogAlarmTime, ogWebUserNotification=ogWebUserNotification, ogEmdDioTable=ogEmdDioTable, ogCellModemTable=ogCellModemTable, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsDescription=ogUpsDescription, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletName=ogRpcOutletName, ogHostUserNotification=ogHostUserNotification, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsType=ogUpsType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcDescription=ogRpcDescription, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdName=ogEmdName, ogSerialPortCTS=ogSerialPortCTS, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckDeviceTable=ogCheckDeviceTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckType=ogCheckType, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemVendor=ogCellModemVendor, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostUserTable=ogHostUserTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckIndex=ogCheckIndex, ogWifiApFrequency=ogWifiApFrequency, ogRpcTable=ogRpcTable, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientMac=ogWifiApClientMac, ogCellModemIndex=ogCellModemIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarm=ogAlarm, ogHostIpV4Address=ogHostIpV4Address, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortMode=ogSerialPortMode, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsConnectType=ogUpsConnectType, ogUpsOutputPower=ogUpsOutputPower, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmDevice=ogAlarmDevice, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortDSR=ogSerialPortDSR, ogHostUserName=ogHostUserName, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWebUserStartTime=ogWebUserStartTime, ogCellMessageNotification=ogCellMessageNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioNotification=ogEmdDioNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutletTable=ogRpcOutletTable, ogCellModemTower=ogCellModemTower, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioName=ogEmdDioName, ogSerialUserPort=ogSerialUserPort, ogEmdDioDescription=ogEmdDioDescription, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmState=ogAlarmState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioEntry=ogEmdDioEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemTemperature=ogCellModemTemperature, ogHostIndex=ogHostIndex, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientTable=ogWifiClientTable, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserHost=ogHostUserHost, ogEmdHumidityName=ogEmdHumidityName, ogHostPingNotification=ogHostPingNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemEntry=ogCellModemEntry, ogEmdTable=ogEmdTable, ogCellDataNotification=ogCellDataNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortTable=ogSerialPortTable, ogStatus2=ogStatus2, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcType=ogRpcType, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsNotification=ogUpsNotification, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceIndex=ogHostServiceIndex, ogWifiApEntry=ogWifiApEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortDCD=ogSerialPortDCD, ogCellApnNotification=ogCellApnNotification, ogSerialUserTable=ogSerialUserTable, ogUpsEntry=ogUpsEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostUserHostName=ogHostUserHostName, ogWifiApEnabled=ogWifiApEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdDescription=ogEmdDescription, ogWifiApClientTable=ogWifiApClientTable, ogHostTable=ogHostTable, ogCellModemCounter=ogCellModemCounter, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmType=ogAlarmType, ogSerialUserIndex=ogSerialUserIndex, ogAlarmInstance=ogAlarmInstance, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputNotification=ogUpsInputNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdIndex=ogEmdIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceTable=ogHostServiceTable, ogRpcOutletEntry=ogRpcOutletEntry, ogMibNotifications=ogMibNotifications, ogUpsCounter=ogUpsCounter, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioType=ogEmdDioType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientEssid=ogWifiClientEssid, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckResolveActions=ogCheckResolveActions, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortParity=ogSerialPortParity, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceNotification=ogHostServiceNotification, ogHostServiceCounter=ogHostServiceCounter, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioState=ogEmdDioState, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcIndex=ogRpcIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserEntry=ogHostUserEntry, ogHostUserIndex=ogHostUserIndex, ogUpsHumidity=ogUpsHumidity, ogWebUserName=ogWebUserName, ogWifiApInterface=ogWifiApInterface, ogWifiApCounter=ogWifiApCounter, ogHostName=ogHostName, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSystem=ogSystem, ogWebUserEntry=ogWebUserEntry, ogRpcCounter=ogRpcCounter, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellSignalNotification=ogCellSignalNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioDirection=ogEmdDioDirection, ogUpsState=ogUpsState, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcName=ogRpcName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostEntry=ogHostEntry, ogCellModemApn=ogCellModemApn, ogSerialPortEntry=ogSerialPortEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmSummary=ogAlarmSummary, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApTable=ogWifiApTable, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsTemperature=ogUpsTemperature, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioCounter=ogEmdDioCounter, ogCheckName=ogCheckName, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmCheck=ogAlarmCheck, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientAp=ogWifiApClientAp, ogUpsTable=ogUpsTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServiceHost=ogHostServiceHost, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientIndex=ogWifiApClientIndex, ogHostIpV6Address=ogHostIpV6Address, ogRpcEntry=ogRpcEntry, ogCheckEntry=ogCheckEntry, ogHostServicePort=ogHostServicePort, ogNetInterfaceState=ogNetInterfaceState, ogWifiApTxPower=ogWifiApTxPower, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmUser=ogAlarmUser, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcConnectType=ogRpcConnectType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemModel=ogCellModemModel, ogWifiClientMode=ogWifiClientMode, ogHostServiceType=ogHostServiceType, ogUpsIndex=ogUpsIndex, ogWebUserTable=ogWebUserTable, ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckTable=ogCheckTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdEntry=ogEmdEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmName=ogAlarmName, ogAlarmEventId=ogAlarmEventId, ogUpsName=ogUpsName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification)
