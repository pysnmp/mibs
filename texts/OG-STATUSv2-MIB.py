...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdName=ogEmdName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTemperatureName=ogEmdTemperatureName, ogHostUserTable=ogHostUserTable, ogUpsIndex=ogUpsIndex, ogCellSignalNotification=ogCellSignalNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientTable=ogWifiApClientTable, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmDevice=ogAlarmDevice, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDescription=ogEmdDescription, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckEntry=ogCheckEntry, ogAlarmType=ogAlarmType, ogEmdDioName=ogEmdDioName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientInterface=ogWifiClientInterface, ogStatus2Compliance=ogStatus2Compliance, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostName=ogHostName, ogEmdEnabled=ogEmdEnabled, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcDescription=ogRpcDescription, ogWifiApIndex=ogWifiApIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsTemperature=ogUpsTemperature, ogEmdEntry=ogEmdEntry, ogCheckType=ogCheckType, ogWifiApClientAp=ogWifiApClientAp, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioDirection=ogEmdDioDirection, ogCustomNotification=ogCustomNotification, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApSsid=ogWifiApSsid, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientApMac=ogWifiClientApMac, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsTable=ogUpsTable, ogRpcOutletEntry=ogRpcOutletEntry, ogHostUserIndex=ogHostUserIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortEntry=ogSerialPortEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTable=ogEmdTable, ogUpsCounter=ogUpsCounter, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserEntry=ogWebUserEntry, ogCellMessageNotification=ogCellMessageNotification, ogRpcConnectType=ogRpcConnectType, ogNetInterfaceType=ogNetInterfaceType, ogHostTable=ogHostTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmSummary=ogAlarmSummary, ogUpsInputNotification=ogUpsInputNotification, ogHostServiceType=ogHostServiceType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceIndex=ogHostServiceIndex, ogRpcEntry=ogRpcEntry, ogCheckResolveActions=ogCheckResolveActions, PYSNMP_MODULE_ID=ogStatus2, ogFirmwareVersion=ogFirmwareVersion, ogSystem=ogSystem, ogHostUserNotification=ogHostUserNotification, ogCellModemModel=ogCellModemModel, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarm=ogAlarm, ogWifiApTable=ogWifiApTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsOutputPower=ogUpsOutputPower, ogUpsType=ogUpsType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWebUserName=ogWebUserName, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmState=ogAlarmState, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsState=ogUpsState, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellTowerNotification=ogCellTowerNotification, ogHostUserHost=ogHostUserHost, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsHumidity=ogUpsHumidity, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemCounter=ogCellModemCounter, ogAlarmInstance=ogAlarmInstance, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceNotification=ogHostServiceNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserEntry=ogHostUserEntry, ogSerialUserLabel=ogSerialUserLabel, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortCTS=ogSerialPortCTS, ogAlarmUser=ogAlarmUser, ogWifiClientEntry=ogWifiClientEntry, ogUpsNotification=ogUpsNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemIndex=ogCellModemIndex, ogEmdDioNotification=ogEmdDioNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckIndex=ogCheckIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientMode=ogWifiClientMode, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortDSR=ogSerialPortDSR, ogRpcTable=ogRpcTable, ogCellModemVendor=ogCellModemVendor, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletName=ogRpcOutletName, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApCounter=ogWifiApCounter, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortDCD=ogSerialPortDCD, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmLogTable=ogAlarmLogTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellApnNotification=ogCellApnNotification, ogRpcType=ogRpcType, ogSerialUserTable=ogSerialUserTable, ogAlarmEventId=ogAlarmEventId, ogWebUserTable=ogWebUserTable, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialNumber=ogSerialNumber, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmTime=ogAlarmTime, ogUpsLogEnabled=ogUpsLogEnabled, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletState=ogRpcOutletState, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserIndex=ogSerialUserIndex, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioTable=ogEmdDioTable, ogHostServiceTable=ogHostServiceTable, ogStatus2Compliances=ogStatus2Compliances, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsName=ogUpsName, ogRpcIndex=ogRpcIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialUserNotification=ogSerialUserNotification, ogRpcName=ogRpcName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWebUserStartTime=ogWebUserStartTime, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostPingNotification=ogHostPingNotification, ogCellModemConnected=ogCellModemConnected, ogHostEntry=ogHostEntry, ogNetInterfaceState=ogNetInterfaceState, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletTotal=ogRpcOutletTotal, ogHostUserHostName=ogHostUserHostName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioType=ogEmdDioType, ogEmdConnectType=ogEmdConnectType, ogAlarmCheck=ogAlarmCheck, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortTable=ogSerialPortTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWebUserIndex=ogWebUserIndex, ogAlarmName=ogAlarmName, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcInputFrequency=ogRpcInputFrequency)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserStartTime=ogSerialUserStartTime, ogCheckTable=ogCheckTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialUserName=ogSerialUserName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsDescription=ogUpsDescription, ogMibNotifications=ogMibNotifications, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemTower=ogCellModemTower, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortMode=ogSerialPortMode, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientMac=ogWifiApClientMac, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletTable=ogRpcOutletTable, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckName=ogCheckName, ogUpsEntry=ogUpsEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogHostServiceEntry=ogHostServiceEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientCounter=ogWifiClientCounter, ogWebUserNotification=ogWebUserNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApEntry=ogWifiApEntry, ogRpcCounter=ogRpcCounter, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApInterface=ogWifiApInterface, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmTime=ogCurrentAlarmTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApEnabled=ogWifiApEnabled, ogStatus2=ogStatus2, ogHostIndex=ogHostIndex, ogEmdIndex=ogEmdIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientTable=ogWifiClientTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckDeviceTable=ogCheckDeviceTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemTable=ogCellModemTable, ogCellModemApn=ogCellModemApn, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsConnectType=ogUpsConnectType, ogCellModemRegistered=ogCellModemRegistered, ogWifiApIeeeMode=ogWifiApIeeeMode, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostServicePort=ogHostServicePort, ogHostUserName=ogHostUserName, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmState=ogCurrentAlarmState, ogHostUserAddress=ogHostUserAddress, ogEmdDioState=ogEmdDioState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyEntry=ogPowerSupplyEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent)
