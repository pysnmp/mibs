...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsEntry=ogUpsEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckType=ogCheckType, ogAlarmState=ogAlarmState, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcCounter=ogRpcCounter, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioIndex=ogEmdDioIndex, ogEmdConnectType=ogEmdConnectType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientEssid=ogWifiClientEssid, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmCurrentValue=ogAlarmCurrentValue, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApClientMac=ogWifiApClientMac, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemIMSI=ogCellModemIMSI, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioType=ogEmdDioType, ogHostUserHostName=ogHostUserHostName, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserTable=ogSerialUserTable, ogAlarmCheck=ogAlarmCheck, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortParity=ogSerialPortParity, ogStatus2=ogStatus2, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientCounter=ogWifiClientCounter, ogCellModemIndex=ogCellModemIndex, ogWebUserStartTime=ogWebUserStartTime, ogUpsTemperature=ogUpsTemperature, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioEntry=ogEmdDioEntry, ogCheckName=ogCheckName, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserNotification=ogWebUserNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostUserName=ogHostUserName, ogUpsName=ogUpsName, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmSummary=ogAlarmSummary, ogHostUserAddress=ogHostUserAddress, ogSerialPortDCD=ogSerialPortDCD, ogHostName=ogHostName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortEntry=ogSerialPortEntry, ogHostServiceCounter=ogHostServiceCounter, ogSerialUserPort=ogSerialUserPort, ogUpsTable=ogUpsTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserIndex=ogWebUserIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserTable=ogHostUserTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsDescription=ogUpsDescription, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientEntry=ogWifiClientEntry, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortDSR=ogSerialPortDSR, ogSerialNumber=ogSerialNumber, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellTowerNotification=ogCellTowerNotification, ogHostUserNotification=ogHostUserNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApCounter=ogWifiApCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceHost=ogHostServiceHost, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsState=ogUpsState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmName=ogAlarmName, ogEmdDioDirection=ogEmdDioDirection, ogCheckEntry=ogCheckEntry, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletTable=ogRpcOutletTable, ogCellModemTower=ogCellModemTower, ogMibNotifications=ogMibNotifications, ogSerialUserNotification=ogSerialUserNotification, ogHostServiceTable=ogHostServiceTable, ogWifiClientInterface=ogWifiClientInterface, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientTxPackets=ogWifiApClientTxPackets, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialUserName=ogSerialUserName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputPower=ogUpsOutputPower, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemEntry=ogCellModemEntry, ogCellMessageNotification=ogCellMessageNotification, ogRpcTable=ogRpcTable, ogWifiClientRssi=ogWifiClientRssi, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcType=ogRpcType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortLabel=ogSerialPortLabel, ogCellModemVendor=ogCellModemVendor, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmType=ogAlarmType, ogCurrentAlarmName=ogCurrentAlarmName, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellSignalNotification=ogCellSignalNotification, ogRpcEntry=ogRpcEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApFrequency=ogWifiApFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletState=ogRpcOutletState, ogStatus2Conformance=ogStatus2Conformance, ogUpsNotification=ogUpsNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmDevice=ogAlarmDevice, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcInputFrequency=ogRpcInputFrequency, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioName=ogEmdDioName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckIndex=ogCheckIndex, ogHostUserEntry=ogHostUserEntry, ogHostServiceStatus=ogHostServiceStatus, ogRpcName=ogRpcName, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSystem=ogSystem, ogUpsBatteryState=ogUpsBatteryState, ogCellModemTable=ogCellModemTable, ogAlarmUser=ogAlarmUser, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserIndex=ogSerialUserIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApSsid=ogWifiApSsid, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTable=ogEmdTable, ogWifiApClientAp=ogWifiApClientAp, ogUpsIndex=ogUpsIndex, ogEmdIndex=ogEmdIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcInputVoltage=ogRpcInputVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostTable=ogHostTable, ogWifiClientEnabled=ogWifiClientEnabled, ogHostEntry=ogHostEntry, ogUpsType=ogUpsType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemModel=ogCellModemModel, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApIndex=ogWifiApIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortIndex=ogSerialPortIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsCounter=ogUpsCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogWebUserTable=ogWebUserTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdName=ogEmdName, ogEmdDioDescription=ogEmdDioDescription, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCustomNotification=ogCustomNotification, ogAlarmEventId=ogAlarmEventId, ogWifiClientIndex=ogWifiClientIndex, ogFirmwareVersion=ogFirmwareVersion, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdEnabled=ogEmdEnabled, ogUpsConnectType=ogUpsConnectType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcDescription=ogRpcDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserIndex=ogHostUserIndex, ogWebUserName=ogWebUserName, ogAlarmInstance=ogAlarmInstance, ogCellDataNotification=ogCellDataNotification, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientTable=ogWifiApClientTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogNetInterfaceTable=ogNetInterfaceTable, ogHostIpV4Address=ogHostIpV4Address, ogNetInterfaceName=ogNetInterfaceName, ogNetInterfaceState=ogNetInterfaceState, ogEmdDescription=ogEmdDescription, ogWifiApClientEntry=ogWifiApClientEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarm=ogAlarm, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApTxPower=ogWifiApTxPower, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletName=ogRpcOutletName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcOutletTotal=ogRpcOutletTotal, ogHostServiceType=ogHostServiceType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdEntry=ogEmdEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortRTS=ogSerialPortRTS, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApTable=ogWifiApTable, ogPowerSupplyTable=ogPowerSupplyTable, ogStatus2Compliances=ogStatus2Compliances, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostIndex=ogHostIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApEntry=ogWifiApEntry, ogUpsHumidity=ogUpsHumidity, ogCellModemCounter=ogCellModemCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckTable=ogCheckTable, ogSerialPortMode=ogSerialPortMode, ogHostServicePort=ogHostServicePort, ogHostUserHost=ogHostUserHost, ogEmdDioTable=ogEmdDioTable, ogWifiClientTxPower=ogWifiClientTxPower, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckDeviceName=ogCheckDeviceName, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientMode=ogWifiClientMode, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemConnected=ogCellModemConnected, ogRpcIndex=ogRpcIndex, ogWifiClientApMac=ogWifiClientApMac, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortTable=ogSerialPortTable, ogAlarmTime=ogAlarmTime, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemApn=ogCellModemApn, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioState=ogEmdDioState)
