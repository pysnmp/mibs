...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmType=ogAlarmType, ogWifiApCounter=ogWifiApCounter, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckType=ogCheckType, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientMode=ogWifiClientMode, ogUpsOutputLoad=ogUpsOutputLoad, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioType=ogEmdDioType, ogCellModemApn=ogCellModemApn, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletTotal=ogRpcOutletTotal, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDescription=ogEmdDescription, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcCounter=ogRpcCounter, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortTable=ogSerialPortTable, ogCellModemEnabled=ogCellModemEnabled, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsIndex=ogUpsIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSystem=ogSystem, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckTable=ogCheckTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioNotification=ogEmdDioNotification, ogCustomNotification=ogCustomNotification, ogWebUserName=ogWebUserName, ogCellModemEntry=ogCellModemEntry, ogCellModemConnected=ogCellModemConnected, ogSerialPortLabel=ogSerialPortLabel, ogEmdConnectType=ogEmdConnectType, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemTable=ogCellModemTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmTime=ogAlarmTime, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientTable=ogWifiApClientTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemCounter=ogCellModemCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserStartTime=ogHostUserStartTime, ogRpcType=ogRpcType, ogSerialUserLabel=ogSerialUserLabel, ogHostPingNotification=ogHostPingNotification, ogAlarmCheck=ogAlarmCheck, ogEmdDioState=ogEmdDioState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletState=ogRpcOutletState, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceHost=ogHostServiceHost, ogHostName=ogHostName, ogCellModemIndex=ogCellModemIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsBatteryState=ogUpsBatteryState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmInstance=ogAlarmInstance, ogCellModemNetwork=ogCellModemNetwork, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogNetInterfaceState=ogNetInterfaceState, ogSerialUserEntry=ogSerialUserEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserHostName=ogHostUserHostName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmState=ogAlarmState, ogSerialPortParity=ogSerialPortParity, ogWifiClientRssi=ogWifiClientRssi, ogAlarmName=ogAlarmName, ogEmdHumidityTable=ogEmdHumidityTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletEntry=ogRpcOutletEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcDescription=ogRpcDescription, ogEmdEntry=ogEmdEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServicePort=ogHostServicePort, ogWifiApTable=ogWifiApTable, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdDioEmd=ogEmdDioEmd, ogCellModemTemperature=ogCellModemTemperature, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, PYSNMP_MODULE_ID=ogStatus2, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortDSR=ogSerialPortDSR, ogAlarm=ogAlarm, ogHostUserEntry=ogHostUserEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogStatus2=ogStatus2, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserName=ogSerialUserName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckIndex=ogCheckIndex, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioDescription=ogEmdDioDescription, ogUpsHumidity=ogUpsHumidity, ogWifiApInterface=ogWifiApInterface, ogHostUserName=ogHostUserName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostTable=ogHostTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmEventId=ogAlarmEventId, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApIndex=ogWifiApIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogFirmwareVersion=ogFirmwareVersion, ogUpsInputNotification=ogUpsInputNotification, ogUpsTable=ogUpsTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientEntry=ogWifiApClientEntry, ogHostUserHost=ogHostUserHost, ogHostIndex=ogHostIndex, ogRpcConnectType=ogRpcConnectType, ogUpsCounter=ogUpsCounter, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApEnabled=ogWifiApEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientApMac=ogWifiClientApMac, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientIndex=ogWifiClientIndex, ogHostEntry=ogHostEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialNumber=ogSerialNumber, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsState=ogUpsState, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdDioTable=ogEmdDioTable, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyName=ogPowerSupplyName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserPort=ogSerialUserPort, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserNotification=ogSerialUserNotification, ogRpcEntry=ogRpcEntry, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckResolveActions=ogCheckResolveActions, ogCheckName=ogCheckName, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckDeviceName=ogCheckDeviceName, ogCellApnNotification=ogCellApnNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCellTowerNotification=ogCellTowerNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApSsid=ogWifiApSsid, ogCellModemTower=ogCellModemTower, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioName=ogEmdDioName, ogNetInterfaceType=ogNetInterfaceType, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogStatus2Compliances=ogStatus2Compliances, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortDTR=ogSerialPortDTR, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortCTS=ogSerialPortCTS, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostServiceType=ogHostServiceType, ogUpsEntry=ogUpsEntry, ogUpsDescription=ogUpsDescription, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientMac=ogWifiApClientMac, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdEnabled=ogEmdEnabled, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApEntry=ogWifiApEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientInterface=ogWifiClientInterface, ogEmdName=ogEmdName, ogRpcName=ogRpcName, ogUpsTemperature=ogUpsTemperature, ogUpsConnectType=ogUpsConnectType, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientTable=ogWifiClientTable, ogCellModemVendor=ogCellModemVendor, ogHostUserNotification=ogHostUserNotification, ogUpsNotification=ogUpsNotification, ogUpsType=ogUpsType, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellDataNotification=ogCellDataNotification, ogHostUserIndex=ogHostUserIndex, ogUpsName=ogUpsName, ogHostUserAddress=ogHostUserAddress, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialSignalNotification=ogSerialSignalNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientCounter=ogWifiClientCounter, ogSerialUserIndex=ogSerialUserIndex, ogEmdIndex=ogEmdIndex, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostServiceNotification=ogHostServiceNotification, ogEmdTable=ogEmdTable, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientTxPower=ogWifiClientTxPower, ogMibNotifications=ogMibNotifications, ogRpcOutletNotification=ogRpcOutletNotification, ogNetInterfaceName=ogNetInterfaceName, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortMode=ogSerialPortMode, ogRpcIndex=ogRpcIndex, ogCheckEntry=ogCheckEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletName=ogRpcOutletName, ogCellModemModel=ogCellModemModel, ogWebUserEntry=ogWebUserEntry, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemRegistered=ogCellModemRegistered, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcTable=ogRpcTable, ogHostServiceStatus=ogHostServiceStatus, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2Conformance=ogStatus2Conformance, ogHostUserTable=ogHostUserTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogStatus2Groups=ogStatus2Groups, ogAlarmDevice=ogAlarmDevice, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmUser=ogAlarmUser, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityNotification=ogEmdHumidityNotification)
