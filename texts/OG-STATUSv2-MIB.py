...
ObjectIdentity, ModuleIdentity, Gauge32, Counter32, MibIdentifier, IpAddress, iso, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Bits, NotificationType, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "ModuleIdentity", "Gauge32", "Counter32", "MibIdentifier", "IpAddress", "iso", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Bits", "NotificationType", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceTable=ogNetInterfaceTable, ogStatus2Compliance=ogStatus2Compliance, ogWifiApClientAp=ogWifiApClientAp, ogCheckTable=ogCheckTable, ogSerialPortTable=ogSerialPortTable, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletTable=ogRpcOutletTable, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientIndex=ogWifiClientIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdDioState=ogEmdDioState, ogUpsType=ogUpsType, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemRegistered=ogCellModemRegistered, ogWifiApTxPower=ogWifiApTxPower, ogWebUserName=ogWebUserName, ogEmdEnabled=ogEmdEnabled, ogUpsIndex=ogUpsIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemIndex=ogCellModemIndex, ogCellModemTable=ogCellModemTable, ogWifiClientApMac=ogWifiClientApMac, ogSerialUserNotification=ogSerialUserNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApIndex=ogWifiApIndex, ogCustomNotification=ogCustomNotification, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsDescription=ogUpsDescription, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmUser=ogAlarmUser, ogPowerSupplyName=ogPowerSupplyName, ogMibNotifications=ogMibNotifications, ogRpcOutletName=ogRpcOutletName, ogWebUserStartTime=ogWebUserStartTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemVendor=ogCellModemVendor, ogAlarmState=ogAlarmState, ogWebUserIndex=ogWebUserIndex, ogHostUserTable=ogHostUserTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostIndex=ogHostIndex, ogAlarmTime=ogAlarmTime, ogEmdIndex=ogEmdIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientEntry=ogWifiClientEntry, ogUpsState=ogUpsState, ogHostTable=ogHostTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmName=ogAlarmName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogStatus2=ogStatus2, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsNotification=ogUpsNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcTable=ogRpcTable, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialUserTable=ogSerialUserTable, ogSerialNumber=ogSerialNumber, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortParity=ogSerialPortParity, ogWebUserEntry=ogWebUserEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsLogEnabled=ogUpsLogEnabled, ogHostServiceNotification=ogHostServiceNotification, ogWifiApEntry=ogWifiApEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogStatus2Groups=ogStatus2Groups, ogNetInterfaceState=ogNetInterfaceState, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioTable=ogEmdDioTable, ogCellModemEntry=ogCellModemEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientMode=ogWifiClientMode, ogCheckType=ogCheckType, ogUpsHumidity=ogUpsHumidity, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemModel=ogCellModemModel, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialUserPort=ogSerialUserPort, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceCounter=ogHostServiceCounter, ogEmdDescription=ogEmdDescription, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWebUserNotification=ogWebUserNotification, ogUpsConnectType=ogUpsConnectType, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortLabel=ogSerialPortLabel, ogAlarmTriggerValue=ogAlarmTriggerValue, ogAlarmInstance=ogAlarmInstance, ogHostUserHostName=ogHostUserHostName, ogWifiApSsid=ogWifiApSsid, ogSerialPortMode=ogSerialPortMode, ogAlarm=ogAlarm, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsCounter=ogUpsCounter, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserEntry=ogSerialUserEntry, ogSerialUserName=ogSerialUserName, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcDescription=ogRpcDescription, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortDSR=ogSerialPortDSR, ogUpsName=ogUpsName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdDioCounter=ogEmdDioCounter, ogAlarmSummary=ogAlarmSummary, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemIMSI=ogCellModemIMSI, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortIndex=ogSerialPortIndex, ogHostUserNotification=ogHostUserNotification, ogRpcCounter=ogRpcCounter, ogEmdConnectType=ogEmdConnectType, ogCellSignalNotification=ogCellSignalNotification, ogHostUserIndex=ogHostUserIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialUserIndex=ogSerialUserIndex, ogHostUserName=ogHostUserName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioDescription=ogEmdDioDescription, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDCD=ogSerialPortDCD, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemEnabled=ogCellModemEnabled, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostName=ogHostName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostPingNotification=ogHostPingNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostServiceType=ogHostServiceType, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemTower=ogCellModemTower, ogHostUserAddress=ogHostUserAddress, ogHostUserHost=ogHostUserHost, ogRpcOutletState=ogRpcOutletState, ogStatus2Conformance=ogStatus2Conformance, ogCheckEntry=ogCheckEntry, ogWifiApClientTable=ogWifiApClientTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputPower=ogUpsOutputPower, ogRpcEntry=ogRpcEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckDeviceName=ogCheckDeviceName, ogSerialPatternNotification=ogSerialPatternNotification, ogCellApnNotification=ogCellApnNotification, ogWifiApClientMac=ogWifiApClientMac, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientTable=ogWifiClientTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientEnabled=ogWifiClientEnabled, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemApn=ogCellModemApn, ogEmdDioEntry=ogEmdDioEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioType=ogEmdDioType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientInterface=ogWifiClientInterface, ogSystem=ogSystem, ogRpcType=ogRpcType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemCounter=ogCellModemCounter, ogUpsTemperature=ogUpsTemperature, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarmEventId=ogAlarmEventId, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostServiceHost=ogHostServiceHost, ogEmdDioIndex=ogEmdDioIndex, ogWifiApInterface=ogWifiApInterface, ogCheckName=ogCheckName, ogWifiClientRssi=ogWifiClientRssi, ogHostServiceEntry=ogHostServiceEntry, ogHostUserEntry=ogHostUserEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletRpc=ogRpcOutletRpc, ogHostEntry=ogHostEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmLogEntry=ogAlarmLogEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioName=ogEmdDioName, ogEmdTable=ogEmdTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApCounter=ogWifiApCounter, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckIndex=ogCheckIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApEnabled=ogWifiApEnabled, ogHostServiceTable=ogHostServiceTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostServicePort=ogHostServicePort, ogCellModemConnected=ogCellModemConnected, ogWifiClientEssid=ogWifiClientEssid, ogAlarmType=ogAlarmType, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmCheck=ogAlarmCheck, ogEmdName=ogEmdName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostIpV4Address=ogHostIpV4Address, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellTowerNotification=ogCellTowerNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWebUserTable=ogWebUserTable, ogNetInterfaceName=ogNetInterfaceName, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdEntry=ogEmdEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputVoltage=ogUpsOutputVoltage, PYSNMP_MODULE_ID=ogStatus2, ogAlarmDevice=ogAlarmDevice, ogWifiApTable=ogWifiApTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModemTemperature=ogCellModemTemperature, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcIndex=ogRpcIndex, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcName=ogRpcName, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsTable=ogUpsTable, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyTable=ogPowerSupplyTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsEntry=ogUpsEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue)
