...
Integer32, Counter64, iso, Unsigned32, Gauge32, NotificationType, MibIdentifier, ObjectIdentity, Bits, IpAddress, TimeTicks, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter64", "iso", "Unsigned32", "Gauge32", "NotificationType", "MibIdentifier", "ObjectIdentity", "Bits", "IpAddress", "TimeTicks", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCustomNotification=ogCustomNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserHost=ogHostUserHost, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletTable=ogRpcOutletTable, ogUpsConnectType=ogUpsConnectType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdEnabled=ogEmdEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApEntry=ogWifiApEntry, ogAlarmName=ogAlarmName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyName=ogPowerSupplyName, ogCheckEntry=ogCheckEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogCellDataNotification=ogCellDataNotification, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApEnabled=ogWifiApEnabled, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmLogTable=ogAlarmLogTable, ogCellModemTower=ogCellModemTower, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcName=ogRpcName, ogWifiApInterface=ogWifiApInterface, ogHostPingNotification=ogHostPingNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsType=ogUpsType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostUserName=ogHostUserName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServicePort=ogHostServicePort, ogCheckResolveActions=ogCheckResolveActions, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcDescription=ogRpcDescription, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientEntry=ogWifiClientEntry, ogCellModemIndex=ogCellModemIndex, ogRpcTable=ogRpcTable, ogRpcOutletState=ogRpcOutletState, ogNetInterfaceEntry=ogNetInterfaceEntry, ogStatus2Conformance=ogStatus2Conformance, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemModel=ogCellModemModel, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientMac=ogWifiApClientMac, ogCellModemConnected=ogCellModemConnected, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsTemperature=ogUpsTemperature, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmDevice=ogAlarmDevice, ogWifiClientMode=ogWifiClientMode, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserHostName=ogHostUserHostName, ogAlarmTime=ogAlarmTime, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmEventId=ogAlarmEventId, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioIndex=ogEmdDioIndex, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsOutputTruePower=ogUpsOutputTruePower, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceHost=ogHostServiceHost, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWebUserNotification=ogWebUserNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioTable=ogEmdDioTable, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsNotification=ogUpsNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApTxPower=ogWifiApTxPower, ogEmdIndex=ogEmdIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsName=ogUpsName, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcInputCurrent=ogRpcInputCurrent, ogHostServiceTable=ogHostServiceTable, ogUpsEntry=ogUpsEntry, ogWifiApTable=ogWifiApTable, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsInputNotification=ogUpsInputNotification, ogHostServiceCounter=ogHostServiceCounter, ogHostName=ogHostName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDescription=ogEmdDescription, ogUpsCounter=ogUpsCounter, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortParity=ogSerialPortParity, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemEntry=ogCellModemEntry, ogSerialNumber=ogSerialNumber, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmCheck=ogAlarmCheck, ogUpsState=ogUpsState, ogAlarmState=ogAlarmState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsTable=ogUpsTable, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcIndex=ogRpcIndex, ogCellModemIMSI=ogCellModemIMSI, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemRegistered=ogCellModemRegistered, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientTable=ogWifiApClientTable, ogRpcType=ogRpcType, ogEmdDioCounter=ogEmdDioCounter, ogSystem=ogSystem, ogWebUserTable=ogWebUserTable, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioName=ogEmdDioName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApIndex=ogWifiApIndex, ogSerialUserName=ogSerialUserName, ogHostIndex=ogHostIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostIpV4Address=ogHostIpV4Address, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcEntry=ogRpcEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioEntry=ogEmdDioEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserPort=ogSerialUserPort, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortDataBits=ogSerialPortDataBits, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsLogEnabled=ogUpsLogEnabled, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioType=ogEmdDioType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioDirection=ogEmdDioDirection, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortLabel=ogSerialPortLabel, ogHostUserAddress=ogHostUserAddress, ogWifiApFrequency=ogWifiApFrequency, ogHostIpV6Address=ogHostIpV6Address, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostServiceType=ogHostServiceType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputFrequency=ogUpsInputFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientCounter=ogWifiClientCounter, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmType=ogCurrentAlarmType, ogHostTable=ogHostTable, ogCellModemApn=ogCellModemApn, ogWifiClientApMac=ogWifiClientApMac, ogCheckIndex=ogCheckIndex, ogRpcOutletName=ogRpcOutletName, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortDCD=ogSerialPortDCD, ogWifiApCounter=ogWifiApCounter, ogSerialPortDSR=ogSerialPortDSR, ogRpcCounter=ogRpcCounter, ogUpsHumidity=ogUpsHumidity, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckTable=ogCheckTable, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApSsid=ogWifiApSsid, ogHostUserTable=ogHostUserTable, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserIndex=ogWebUserIndex, ogWifiClientIndex=ogWifiClientIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserEntry=ogWebUserEntry, ogUpsDescription=ogUpsDescription)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserTable=ogSerialUserTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioState=ogEmdDioState, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortParityErrors=ogSerialPortParityErrors, ogStatus2=ogStatus2, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcConnectType=ogRpcConnectType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdEntry=ogEmdEntry, ogUpsIndex=ogUpsIndex, ogEmdHumidityName=ogEmdHumidityName, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserNotification=ogSerialUserNotification, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmUser=ogAlarmUser, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckType=ogCheckType, ogEmdTable=ogEmdTable, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellSignalNotification=ogCellSignalNotification, ogAlarmType=ogAlarmType, ogStatus2Groups=ogStatus2Groups, ogWebUserName=ogWebUserName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellApnNotification=ogCellApnNotification, ogSerialUserLabel=ogSerialUserLabel, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmInstance=ogAlarmInstance, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostEntry=ogHostEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortDTR=ogSerialPortDTR, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientInterface=ogWifiClientInterface, ogCellNetworkNotification=ogCellNetworkNotification, ogMibNotifications=ogMibNotifications, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemTable=ogCellModemTable, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdName=ogEmdName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckName=ogCheckName, ogWifiApClientAp=ogWifiApClientAp, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarm=ogAlarm, ogUpsOutputVoltage=ogUpsOutputVoltage)
