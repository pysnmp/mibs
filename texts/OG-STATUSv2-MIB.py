...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceCounter=ogHostServiceCounter, ogWebUserName=ogWebUserName, ogSerialPortStopBits=ogSerialPortStopBits, ogHostServiceNotification=ogHostServiceNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientApMac=ogWifiClientApMac, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryState=ogUpsBatteryState, ogRpcIndex=ogRpcIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioEntry=ogEmdDioEntry, ogCheckName=ogCheckName, ogStatus2=ogStatus2, ogWebUserTable=ogWebUserTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioTable=ogEmdDioTable, ogCellMessageNotification=ogCellMessageNotification, ogAlarmType=ogAlarmType, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortParity=ogSerialPortParity, ogHostName=ogHostName, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcType=ogRpcType, ogEmdDioType=ogEmdDioType, ogHostTable=ogHostTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckIndex=ogCheckIndex, PYSNMP_MODULE_ID=ogStatus2, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostUserTable=ogHostUserTable, ogHostUserNotification=ogHostUserNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogStatus2Compliances=ogStatus2Compliances, ogAlarmEventId=ogAlarmEventId, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialNumber=ogSerialNumber, ogWifiClientMode=ogWifiClientMode, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserName=ogHostUserName, ogWifiApFrequency=ogWifiApFrequency, ogCellModemVendor=ogCellModemVendor, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioCounter=ogEmdDioCounter, ogWifiApInterface=ogWifiApInterface, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialUserEntry=ogSerialUserEntry, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogBasicStatusGroup=ogBasicStatusGroup, ogCustomNotification=ogCustomNotification, ogUpsIndex=ogUpsIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcTable=ogRpcTable, ogHostIndex=ogHostIndex, ogSerialPortDTR=ogSerialPortDTR, ogCellModemApn=ogCellModemApn, ogEmdDioState=ogEmdDioState, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsEntry=ogUpsEntry, ogCellModemTable=ogCellModemTable, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcCounter=ogRpcCounter, ogEmdDioEmd=ogEmdDioEmd, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortIndex=ogSerialPortIndex, ogWifiApSsid=ogWifiApSsid, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdEntry=ogEmdEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientEssid=ogWifiClientEssid, ogUpsType=ogUpsType, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemCounter=ogCellModemCounter, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioDirection=ogEmdDioDirection, ogRpcName=ogRpcName, ogHostServiceHost=ogHostServiceHost, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, ogAlarmInstance=ogAlarmInstance, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApEnabled=ogWifiApEnabled, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcDescription=ogRpcDescription, ogWebUserNotification=ogWebUserNotification, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckType=ogCheckType, ogWebUserIndex=ogWebUserIndex, ogCheckEntry=ogCheckEntry, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApEntry=ogWifiApEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserEntry=ogHostUserEntry, ogSerialPortTable=ogSerialPortTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmState=ogAlarmState, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemTower=ogCellModemTower, ogEmdDioName=ogEmdDioName, ogCellModemIndex=ogCellModemIndex, ogAlarmDevice=ogAlarmDevice, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientAp=ogWifiApClientAp, ogWifiApClientMac=ogWifiApClientMac, ogHostPingNotification=ogHostPingNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdConnectType=ogEmdConnectType, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientTable=ogWifiClientTable, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarm=ogAlarm, ogSerialUserName=ogSerialUserName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortDCD=ogSerialPortDCD, ogEmdTable=ogEmdTable, ogHostServiceType=ogHostServiceType, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortMode=ogSerialPortMode, ogSerialPortDataBits=ogSerialPortDataBits, ogSystem=ogSystem, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApTxPower=ogWifiApTxPower, ogAlarmName=ogAlarmName, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogMibNotifications=ogMibNotifications, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostServiceIndex=ogHostServiceIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogNetInterfaceName=ogNetInterfaceName, ogEmdHumidityName=ogEmdHumidityName, ogHostEntry=ogHostEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialUserLabel=ogSerialUserLabel, ogUpsTable=ogUpsTable, ogHostServiceStatus=ogHostServiceStatus, ogAlarmUser=ogAlarmUser, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemEnabled=ogCellModemEnabled, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApIndex=ogWifiApIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientIndex=ogWifiClientIndex, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceState=ogNetInterfaceState, ogCheckTable=ogCheckTable, ogWifiApCounter=ogWifiApCounter, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdIndex=ogEmdIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemModel=ogCellModemModel, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsTemperature=ogUpsTemperature, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientIndex=ogWifiApClientIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemConnected=ogCellModemConnected, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialUserPort=ogSerialUserPort, ogEmdName=ogEmdName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogStatus2Conformance=ogStatus2Conformance, ogUpsNotification=ogUpsNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsInputNotification=ogUpsInputNotification, ogUpsState=ogUpsState, ogUpsDescription=ogUpsDescription, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemNetwork=ogCellModemNetwork, ogHostUserIndex=ogHostUserIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDescription=ogEmdDescription, ogHostServiceTable=ogHostServiceTable, ogRpcConnectType=ogRpcConnectType, ogUpsHumidity=ogUpsHumidity, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckDeviceName=ogCheckDeviceName, ogEmdDioDescription=ogEmdDioDescription, ogHostServicePort=ogHostServicePort, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellDataNotification=ogCellDataNotification, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPatternNotification=ogSerialPatternNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostUserHost=ogHostUserHost, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcEntry=ogRpcEntry, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2Groups=ogStatus2Groups, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellSignalNotification=ogCellSignalNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserTable=ogSerialUserTable, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientInterface=ogWifiClientInterface, ogCellTowerNotification=ogCellTowerNotification, ogWifiApTable=ogWifiApTable, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmTime=ogAlarmTime, ogRpcOutletName=ogRpcOutletName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellApnNotification=ogCellApnNotification, ogStatus2Compliance=ogStatus2Compliance, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsCounter=ogUpsCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortDSR=ogSerialPortDSR, ogCellModemEntry=ogCellModemEntry, ogUpsName=ogUpsName)
