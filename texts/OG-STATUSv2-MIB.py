...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortEntry=ogSerialPortEntry, ogEmdConnectType=ogEmdConnectType, ogEmdDioTable=ogEmdDioTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostUserAddress=ogHostUserAddress, ogCellModemTable=ogCellModemTable, ogHostServiceHost=ogHostServiceHost, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsTemperature=ogUpsTemperature, ogWebUserNotification=ogWebUserNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletNotification=ogRpcOutletNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApEnabled=ogWifiApEnabled, ogBasicStatusGroup=ogBasicStatusGroup, ogHostEntry=ogHostEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdEnabled=ogEmdEnabled, ogHostUserHostName=ogHostUserHostName, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmEventId=ogAlarmEventId, ogHostServiceNotification=ogHostServiceNotification, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemApn=ogCellModemApn, ogStatus2=ogStatus2, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckIndex=ogCheckIndex, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcIndex=ogRpcIndex, ogUpsType=ogUpsType, ogEmdTable=ogEmdTable, ogHostUserName=ogHostUserName, ogCheckName=ogCheckName, ogHostServiceType=ogHostServiceType, ogAlarmState=ogAlarmState, ogWifiApClientEntry=ogWifiApClientEntry, ogHostServiceCounter=ogHostServiceCounter, ogStatus2Conformance=ogStatus2Conformance, ogStatus2Compliance=ogStatus2Compliance, ogAlarmType=ogAlarmType, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientTable=ogWifiClientTable, ogRpcOutletIndex=ogRpcOutletIndex, ogNetInterfaceState=ogNetInterfaceState, ogStatus2Compliances=ogStatus2Compliances, ogCellModemNetwork=ogCellModemNetwork, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemRegistered=ogCellModemRegistered, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortLabel=ogSerialPortLabel, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioEmd=ogEmdDioEmd, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemTower=ogCellModemTower, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWebUserTable=ogWebUserTable, ogHostIndex=ogHostIndex, ogHostUserIndex=ogHostUserIndex, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortMode=ogSerialPortMode, ogCellModemCounter=ogCellModemCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserEntry=ogHostUserEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServicePort=ogHostServicePort, ogUpsOutputPower=ogUpsOutputPower, ogCheckResolveActions=ogCheckResolveActions, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsConnectType=ogUpsConnectType, ogRpcDescription=ogRpcDescription, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellMessageNotification=ogCellMessageNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientMac=ogWifiApClientMac, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsInputNotification=ogUpsInputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletState=ogRpcOutletState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserStartTime=ogWebUserStartTime, ogWifiApCounter=ogWifiApCounter, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcCounter=ogRpcCounter, ogAlarmUser=ogAlarmUser, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckEntry=ogCheckEntry, ogEmdEntry=ogEmdEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientMode=ogWifiClientMode, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletTable=ogRpcOutletTable, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsState=ogUpsState, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioType=ogEmdDioType, ogSerialUserPort=ogSerialUserPort, ogHostName=ogHostName, ogWifiApTable=ogWifiApTable, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialUserEntry=ogSerialUserEntry, ogEmdDescription=ogEmdDescription, ogRpcConnectType=ogRpcConnectType, ogWifiClientEntry=ogWifiClientEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientRssi=ogWifiClientRssi, ogCellModemVendor=ogCellModemVendor, ogEmdDioName=ogEmdDioName, ogCellModemModel=ogCellModemModel, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialUserTable=ogSerialUserTable, ogHostPingNotification=ogHostPingNotification, ogWebUserName=ogWebUserName, ogRpcEntry=ogRpcEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserHost=ogHostUserHost, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserName=ogSerialUserName, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyEntry=ogPowerSupplyEntry, ogMibNotifications=ogMibNotifications, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityNotification=ogEmdHumidityNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmLogIndex=ogAlarmLogIndex, ogCellTowerNotification=ogCellTowerNotification, ogUpsCounter=ogUpsCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSystem=ogSystem, ogSerialNumber=ogSerialNumber, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsEntry=ogUpsEntry, ogWifiApClientTable=ogWifiApClientTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioState=ogEmdDioState, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortTxBytes=ogSerialPortTxBytes, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdName=ogEmdName, ogCellDataNotification=ogCellDataNotification, ogSerialUserIndex=ogSerialUserIndex, ogCellModemEnabled=ogCellModemEnabled, ogRpcName=ogRpcName, ogWifiClientIndex=ogWifiClientIndex, ogHostIpV6Address=ogHostIpV6Address, ogWifiApTxPower=ogWifiApTxPower, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmTriggerValue=ogAlarmTriggerValue, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceName=ogCheckDeviceName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostTable=ogHostTable, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmTime=ogAlarmTime, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogHostUserTable=ogHostUserTable, ogHostUserNotification=ogHostUserNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortDCD=ogSerialPortDCD, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsDescription=ogUpsDescription, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogWebUserIndex=ogWebUserIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmLogTable=ogAlarmLogTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogFirmwareVersion=ogFirmwareVersion, ogWifiApIndex=ogWifiApIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsName=ogUpsName, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortTable=ogSerialPortTable, ogSerialPortLogLevel=ogSerialPortLogLevel, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmCheck=ogAlarmCheck, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckTable=ogCheckTable, ogCheckType=ogCheckType, ogUpsTable=ogUpsTable, ogWifiApEntry=ogWifiApEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmName=ogAlarmName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdIndex=ogEmdIndex, ogEmdDioNotification=ogEmdDioNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcTable=ogRpcTable, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApFrequency=ogWifiApFrequency, ogAlarmSummary=ogAlarmSummary, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsNotification=ogUpsNotification, ogSerialPortDTR=ogSerialPortDTR, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcOutletName=ogRpcOutletName, ogUpsHumidity=ogUpsHumidity, ogEmdDioDirection=ogEmdDioDirection, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcType=ogRpcType, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceEntry=ogHostServiceEntry, ogAlarm=ogAlarm, ogUpsIndex=ogUpsIndex, ogAlarmInstance=ogAlarmInstance, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServiceTable=ogHostServiceTable, ogCustomNotification=ogCustomNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortIndex=ogSerialPortIndex, ogCellModemIMSI=ogCellModemIMSI, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent)
