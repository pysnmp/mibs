...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioDescription=ogEmdDioDescription, ogUpsName=ogUpsName, ogCheckType=ogCheckType, ogSerialUserNotification=ogSerialUserNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckEntry=ogCheckEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmTime=ogAlarmTime, ogEmdDioType=ogEmdDioType, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletState=ogRpcOutletState, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientMode=ogWifiClientMode, ogUpsConnectType=ogUpsConnectType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemIMSI=ogCellModemIMSI, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsCounter=ogUpsCounter, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialNumber=ogSerialNumber, ogWifiClientEntry=ogWifiClientEntry, ogCellModemEntry=ogCellModemEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserStartTime=ogHostUserStartTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserName=ogWebUserName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsNotification=ogUpsNotification, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioEntry=ogEmdDioEntry, ogRpcName=ogRpcName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortLabel=ogSerialPortLabel, ogCellApnNotification=ogCellApnNotification, ogWebUserIndex=ogWebUserIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmLogIndex=ogAlarmLogIndex, ogCellDataNotification=ogCellDataNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdName=ogEmdName, ogCellModemRegistered=ogCellModemRegistered, ogRpcTable=ogRpcTable, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemVendor=ogCellModemVendor, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioEmd=ogEmdDioEmd, ogRpcCounter=ogRpcCounter, ogRpcIndex=ogRpcIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortDSR=ogSerialPortDSR, ogHostServiceNotification=ogHostServiceNotification, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemModel=ogCellModemModel, ogCellModemTemperature=ogCellModemTemperature, ogNetInterfaceState=ogNetInterfaceState, ogSerialUserTable=ogSerialUserTable, ogStatus2Compliance=ogStatus2Compliance, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServicePort=ogHostServicePort, ogWifiClientFrequency=ogWifiClientFrequency, ogSystem=ogSystem, ogMibNotifications=ogMibNotifications, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserLabel=ogSerialUserLabel, ogAlarmState=ogAlarmState, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortRTS=ogSerialPortRTS, ogEmdEnabled=ogEmdEnabled, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserHost=ogHostUserHost, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmSummary=ogAlarmSummary, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostServiceTable=ogHostServiceTable, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortIndex=ogSerialPortIndex, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostServiceType=ogHostServiceType, ogRpcOutletName=ogRpcOutletName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostName=ogHostName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTable=ogEmdTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmDevice=ogAlarmDevice, ogWebUserTable=ogWebUserTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioNotification=ogEmdDioNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioState=ogEmdDioState, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostUserEntry=ogHostUserEntry, ogUpsOutputPower=ogUpsOutputPower, ogWifiApEntry=ogWifiApEntry, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortTable=ogSerialPortTable, ogEmdIndex=ogEmdIndex, ogSerialPortMode=ogSerialPortMode, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsType=ogUpsType, ogCellModemIndex=ogCellModemIndex, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserEntry=ogWebUserEntry, ogCheckTable=ogCheckTable, ogHostUserName=ogHostUserName, ogUpsTable=ogUpsTable, ogSerialUserName=ogSerialUserName, ogCellModemApn=ogCellModemApn, ogStatus2Compliances=ogStatus2Compliances, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogHostIndex=ogHostIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserNotification=ogHostUserNotification, ogAlarmCheck=ogAlarmCheck, ogRpcDescription=ogRpcDescription, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmName=ogAlarmName, ogUpsEntry=ogUpsEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsIndex=ogUpsIndex, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckIndex=ogCheckIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsHumidity=ogUpsHumidity, ogHostUserIndex=ogHostUserIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsInputNotification=ogUpsInputNotification, ogCellModemTable=ogCellModemTable, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserHostName=ogHostUserHostName, ogCheckDeviceName=ogCheckDeviceName, ogFirmwareVersion=ogFirmwareVersion, ogEmdDioTable=ogEmdDioTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortDTR=ogSerialPortDTR, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdHumidityName=ogEmdHumidityName, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityValue=ogEmdHumidityValue, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWebUserNotification=ogWebUserNotification, ogAlarmUser=ogAlarmUser, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApIndex=ogWifiApIndex, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientTable=ogWifiClientTable, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcConnectType=ogRpcConnectType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckResetTimeout=ogCheckResetTimeout, ogHostIpV6Address=ogHostIpV6Address, ogEmdEntry=ogEmdEntry, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmType=ogAlarmType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientEssid=ogWifiClientEssid, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserPort=ogSerialUserPort, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientRssi=ogWifiClientRssi, ogHostEntry=ogHostEntry, ogStatus2=ogStatus2, ogWifiApTable=ogWifiApTable, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostTable=ogHostTable, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemNetwork=ogCellModemNetwork, ogCheckResolveActions=ogCheckResolveActions, ogRpcEntry=ogRpcEntry, ogCheckName=ogCheckName, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientInterface=ogWifiClientInterface, ogHostIpV4Address=ogHostIpV4Address, ogUpsLogEnabled=ogUpsLogEnabled, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemCounter=ogCellModemCounter, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemTower=ogCellModemTower, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDescription=ogEmdDescription, ogUpsTemperature=ogUpsTemperature, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsDescription=ogUpsDescription, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserTable=ogHostUserTable, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientRssi=ogWifiApClientRssi, ogCustomNotification=ogCustomNotification, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioName=ogEmdDioName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsState=ogUpsState, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmLogEntry=ogAlarmLogEntry, PYSNMP_MODULE_ID=ogStatus2, ogHostPingNotification=ogHostPingNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApInterface=ogWifiApInterface, ogAlarm=ogAlarm, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApCounter=ogWifiApCounter, ogAlarmInstance=ogAlarmInstance, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialUserIndex=ogSerialUserIndex, ogRpcType=ogRpcType)
