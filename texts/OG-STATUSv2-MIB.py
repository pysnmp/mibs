...
Counter64, Integer32, TimeTicks, ObjectIdentity, Gauge32, iso, Counter32, IpAddress, Unsigned32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, MibIdentifier, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "TimeTicks", "ObjectIdentity", "Gauge32", "iso", "Counter32", "IpAddress", "Unsigned32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "MibIdentifier", "Bits")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialSignalNotification=ogSerialSignalNotification, ogEmdConnectType=ogEmdConnectType, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientIndex=ogWifiClientIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostIpV6Address=ogHostIpV6Address, ogCheckName=ogCheckName, ogCheckType=ogCheckType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortMode=ogSerialPortMode, ogSerialPortRTS=ogSerialPortRTS, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientApMac=ogWifiClientApMac, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckEntry=ogCheckEntry, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogMibNotifications=ogMibNotifications, ogNetInterfaceType=ogNetInterfaceType, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApEntry=ogWifiApEntry, ogSerialPortDCD=ogSerialPortDCD, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioName=ogEmdDioName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletName=ogRpcOutletName, ogHostUserTable=ogHostUserTable, ogUpsConnectType=ogUpsConnectType, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemApn=ogCellModemApn, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserIndex=ogWebUserIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWebUserNotification=ogWebUserNotification, ogHostPingNotification=ogHostPingNotification, ogAlarm=ogAlarm, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortSpeed=ogSerialPortSpeed, ogCellMessageNotification=ogCellMessageNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioIndex=ogEmdDioIndex, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceName=ogNetInterfaceName, ogHostServiceStatus=ogHostServiceStatus, ogWifiApCounter=ogWifiApCounter, ogAlarmSummary=ogAlarmSummary, ogWifiClientMode=ogWifiClientMode, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserIndex=ogHostUserIndex, ogEmdEntry=ogEmdEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCustomNotification=ogCustomNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcDescription=ogRpcDescription, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmPreviousValue=ogAlarmPreviousValue, ogStatus2=ogStatus2, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryState=ogUpsBatteryState, ogUpsNotification=ogUpsNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogHostEntry=ogHostEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsEntry=ogUpsEntry, ogHostUserEntry=ogHostUserEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserHost=ogHostUserHost, ogCellModemTower=ogCellModemTower, ogUpsCounter=ogUpsCounter, ogWifiClientCounter=ogWifiClientCounter, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortLabel=ogSerialPortLabel, ogUpsState=ogUpsState, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserTable=ogWebUserTable, ogFirmwareVersion=ogFirmwareVersion, ogWebUserSourcePort=ogWebUserSourcePort, ogWebUserName=ogWebUserName, ogSerialPortCTS=ogSerialPortCTS, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmCheck=ogAlarmCheck, ogHostServicePort=ogHostServicePort, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemEntry=ogCellModemEntry, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCheckTable=ogCheckTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceHost=ogHostServiceHost, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortParity=ogSerialPortParity, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserIndex=ogSerialUserIndex, ogHostIpV4Address=ogHostIpV4Address, ogWifiApInterface=ogWifiApInterface, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsName=ogUpsName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostTable=ogHostTable, ogCellModemIndex=ogCellModemIndex, ogCellModemCounter=ogCellModemCounter, ogAlarmDevice=ogAlarmDevice, ogWifiApAuthNotification=ogWifiApAuthNotification, ogPowerSupplyName=ogPowerSupplyName, ogNetInterfaceState=ogNetInterfaceState, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortEntry=ogSerialPortEntry, ogEmdName=ogEmdName, ogStatus2Compliance=ogStatus2Compliance, ogSystem=ogSystem, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemConnected=ogCellModemConnected, ogNetInterfaceIndex=ogNetInterfaceIndex, ogStatus2Groups=ogStatus2Groups, ogUpsInputCurrent=ogUpsInputCurrent, ogStatus2Conformance=ogStatus2Conformance, ogRpcCounter=ogRpcCounter, ogCellModemTable=ogCellModemTable, ogWifiApFrequency=ogWifiApFrequency, ogUpsTable=ogUpsTable, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcEntry=ogRpcEntry, ogSerialPortDTR=ogSerialPortDTR, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmUser=ogAlarmUser, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioTable=ogEmdDioTable, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRssi=ogWifiClientRssi, ogAlarmTime=ogAlarmTime, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientTable=ogWifiClientTable, ogRpcLogEnabled=ogRpcLogEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostName=ogHostName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostIndex=ogHostIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckIndex=ogCheckIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcIndex=ogRpcIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserEntry=ogSerialUserEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletRpc=ogRpcOutletRpc, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortDSR=ogSerialPortDSR, ogAlarmType=ogAlarmType, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmName=ogAlarmName, ogWifiApIndex=ogWifiApIndex, ogUpsIndex=ogUpsIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioDescription=ogEmdDioDescription, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsHumidity=ogUpsHumidity, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortTable=ogSerialPortTable, ogHostServiceEntry=ogHostServiceEntry, ogRpcConnectType=ogRpcConnectType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientInterface=ogWifiClientInterface, ogUpsType=ogUpsType, ogHostUserNotification=ogHostUserNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellDataNotification=ogCellDataNotification, ogCellModemModel=ogCellModemModel, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientEntry=ogWifiClientEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletState=ogRpcOutletState, ogSerialNumber=ogSerialNumber, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcName=ogRpcName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApEnabled=ogWifiApEnabled, ogRpcType=ogRpcType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckResolveActions=ogCheckResolveActions, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserName=ogHostUserName, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemVendor=ogCellModemVendor, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserAddress=ogHostUserAddress, ogUpsDescription=ogUpsDescription, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioType=ogEmdDioType, ogCheckDeviceName=ogCheckDeviceName, ogEmdTable=ogEmdTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmState=ogAlarmState, ogHostUserHostName=ogHostUserHostName, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcInputNotification=ogRpcInputNotification, ogSerialUserTable=ogSerialUserTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApTxPower=ogWifiApTxPower, PYSNMP_MODULE_ID=ogStatus2, ogWebUserEntry=ogWebUserEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioEntry=ogEmdDioEntry, ogUpsTemperature=ogUpsTemperature, ogEmdIndex=ogEmdIndex, ogAlarmEventId=ogAlarmEventId, ogSerialUserName=ogSerialUserName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioCounter=ogEmdDioCounter, ogHostServiceType=ogHostServiceType, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioState=ogEmdDioState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellApnNotification=ogCellApnNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServiceTable=ogHostServiceTable, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApClientAp=ogWifiApClientAp, ogAlarmLogTable=ogAlarmLogTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcTable=ogRpcTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDescription=ogEmdDescription, ogWifiApTable=ogWifiApTable)
