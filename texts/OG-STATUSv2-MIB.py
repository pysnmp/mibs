...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, ObjectIdentity, Gauge32, Integer32, Counter64, NotificationType, TimeTicks, Unsigned32, iso, MibIdentifier, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "ObjectIdentity", "Gauge32", "Integer32", "Counter64", "NotificationType", "TimeTicks", "Unsigned32", "iso", "MibIdentifier", "Bits", "Counter32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioNotification=ogEmdDioNotification, ogUpsState=ogUpsState, ogEmdEntry=ogEmdEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemTable=ogCellModemTable, ogCheckType=ogCheckType, ogAlarmState=ogAlarmState, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortDSR=ogSerialPortDSR, ogCellModemCounter=ogCellModemCounter, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApIndex=ogWifiApIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientCounter=ogWifiClientCounter, ogUpsType=ogUpsType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientRssi=ogWifiClientRssi, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyName=ogPowerSupplyName, ogSerialUserNotification=ogSerialUserNotification, ogCheckIndex=ogCheckIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogNetInterfaceType=ogNetInterfaceType, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserEntry=ogSerialUserEntry, ogRpcTable=ogRpcTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsHumidity=ogUpsHumidity, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemEntry=ogCellModemEntry, ogStatus2Compliance=ogStatus2Compliance, ogAlarmLogEntry=ogAlarmLogEntry, ogWebUserEntry=ogWebUserEntry, ogSerialUserLabel=ogSerialUserLabel, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioType=ogEmdDioType, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientInterface=ogWifiClientInterface, ogUpsIndex=ogUpsIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckEntry=ogCheckEntry, ogWifiClientEssid=ogWifiClientEssid, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemModel=ogCellModemModel, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortDTR=ogSerialPortDTR, ogHostName=ogHostName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortLabel=ogSerialPortLabel, ogCheckTable=ogCheckTable, ogRpcConnectType=ogRpcConnectType, ogHostServiceStatus=ogHostServiceStatus, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcType=ogRpcType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserName=ogHostUserName, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApClientIndex=ogWifiApClientIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletTable=ogRpcOutletTable, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostUserAddress=ogHostUserAddress, ogEmdDescription=ogEmdDescription, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcDescription=ogRpcDescription, ogEmdDioEmd=ogEmdDioEmd, ogWebUserStartTime=ogWebUserStartTime, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientMode=ogWifiClientMode, ogAlarmEventId=ogAlarmEventId, ogRpcOutletName=ogRpcOutletName, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsInputNotification=ogUpsInputNotification, ogAlarmUser=ogAlarmUser, ogSerialPortEntry=ogSerialPortEntry, ogWifiApCounter=ogWifiApCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmInstance=ogAlarmInstance, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioState=ogEmdDioState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortRTS=ogSerialPortRTS, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemTower=ogCellModemTower, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemIMSI=ogCellModemIMSI, ogCheckResolveActions=ogCheckResolveActions, ogEmdTable=ogEmdTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemIndex=ogCellModemIndex, ogHostIpV6Address=ogHostIpV6Address, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckTriggerActions=ogCheckTriggerActions, ogHostUserHostName=ogHostUserHostName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdName=ogEmdName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsEntry=ogUpsEntry, ogStatus2Compliances=ogStatus2Compliances, ogHostIndex=ogHostIndex, ogMibNotifications=ogMibNotifications, ogSerialPortDCD=ogSerialPortDCD, ogHostTable=ogHostTable, ogStatus2=ogStatus2, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserEntry=ogHostUserEntry, ogRpcEntry=ogRpcEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientMac=ogWifiApClientMac, PYSNMP_MODULE_ID=ogStatus2, ogHostUserNotification=ogHostUserNotification, ogCellModemApn=ogCellModemApn, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortIndex=ogSerialPortIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioDescription=ogEmdDioDescription, ogAlarmType=ogAlarmType, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryState=ogUpsBatteryState, ogSerialUserPort=ogSerialUserPort, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogStatus2Groups=ogStatus2Groups, ogUpsOutputPower=ogUpsOutputPower, ogUpsDescription=ogUpsDescription, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcCounter=ogRpcCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmCheck=ogAlarmCheck, ogCellApnNotification=ogCellApnNotification, ogRpcName=ogRpcName, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServicePort=ogHostServicePort, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserName=ogSerialUserName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWebUserNotification=ogWebUserNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWebUserIndex=ogWebUserIndex, ogCellModemTemperature=ogCellModemTemperature, ogSystem=ogSystem, ogHostUserTable=ogHostUserTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialNumber=ogSerialNumber, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsTemperature=ogUpsTemperature, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemNetwork=ogCellModemNetwork, ogCellDataNotification=ogCellDataNotification, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckName=ogCheckName, ogEmdEnabled=ogEmdEnabled, ogHostEntry=ogHostEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientBitRate=ogWifiClientBitRate, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarm=ogAlarm, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientApMac=ogWifiClientApMac, ogWebUserTable=ogWebUserTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdConnectType=ogEmdConnectType, ogCellModemRegistered=ogCellModemRegistered, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmSummary=ogAlarmSummary, ogAlarmName=ogAlarmName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsNotification=ogUpsNotification, ogWifiClientTable=ogWifiClientTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioTable=ogEmdDioTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserIndex=ogHostUserIndex, ogWifiApEntry=ogWifiApEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostServiceTable=ogHostServiceTable, ogEmdDioDirection=ogEmdDioDirection, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsTable=ogUpsTable, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialUserTable=ogSerialUserTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmTime=ogAlarmTime, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostUserHost=ogHostUserHost, ogCellModemEnabled=ogCellModemEnabled, ogRpcIndex=ogRpcIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsName=ogUpsName, ogHostServiceType=ogHostServiceType, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApTable=ogWifiApTable, ogEmdDioCounter=ogEmdDioCounter, ogEmdIndex=ogEmdIndex, ogSerialPortTable=ogSerialPortTable, ogHostIpV4Address=ogHostIpV4Address, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioName=ogEmdDioName, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortMode=ogSerialPortMode, ogHostPingNotification=ogHostPingNotification, ogCellModemConnected=ogCellModemConnected, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApSsid=ogWifiApSsid, ogRpcOutletState=ogRpcOutletState, ogCellModemVendor=ogCellModemVendor, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCustomNotification=ogCustomNotification, ogUpsConnectType=ogUpsConnectType, ogWifiApInterface=ogWifiApInterface, ogUpsCounter=ogUpsCounter, ogWebUserName=ogWebUserName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServiceEntry=ogHostServiceEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart)
