...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdEntry=ogEmdEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApEnabled=ogWifiApEnabled, ogAlarmLogTable=ogAlarmLogTable, ogSerialNumber=ogSerialNumber, ogAlarmSummary=ogAlarmSummary, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsConnectType=ogUpsConnectType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogStatus2=ogStatus2, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogNetInterfaceState=ogNetInterfaceState, ogNetInterfaceType=ogNetInterfaceType, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientMode=ogWifiClientMode, ogWifiClientCounter=ogWifiClientCounter, ogRpcInputNotification=ogRpcInputNotification, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioNotification=ogEmdDioNotification, ogRpcDescription=ogRpcDescription, ogHostUserNotification=ogHostUserNotification, ogUpsIndex=ogUpsIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientIndex=ogWifiClientIndex, ogSerialUserPort=ogSerialUserPort, ogWebUserStartTime=ogWebUserStartTime, ogUpsCounter=ogUpsCounter, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmType=ogAlarmType, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserTable=ogHostUserTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostUserName=ogHostUserName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsName=ogUpsName, ogUpsState=ogUpsState, ogAlarmName=ogAlarmName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioState=ogEmdDioState, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialUserName=ogSerialUserName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckEntry=ogCheckEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletName=ogRpcOutletName, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemEntry=ogCellModemEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserHost=ogHostUserHost, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellMessageNotification=ogCellMessageNotification, ogAlarmEventId=ogAlarmEventId, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostUserIndex=ogHostUserIndex, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioEmd=ogEmdDioEmd, ogCellModemTower=ogCellModemTower, ogCheckType=ogCheckType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServicePort=ogHostServicePort, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserStartTime=ogSerialUserStartTime, ogSystem=ogSystem, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortCTS=ogSerialPortCTS, ogEmdName=ogEmdName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioName=ogEmdDioName, ogEmdIndex=ogEmdIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmInstance=ogAlarmInstance, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostName=ogHostName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortParity=ogSerialPortParity, ogUpsNotification=ogUpsNotification, ogCustomNotification=ogCustomNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellSignalNotification=ogCellSignalNotification, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserEntry=ogWebUserEntry, ogCheckResolveActions=ogCheckResolveActions, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientApMac=ogWifiClientApMac, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsInputNotification=ogUpsInputNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityName=ogEmdHumidityName, ogWifiApInterface=ogWifiApInterface, ogEmdDescription=ogEmdDescription, ogHostServiceStatus=ogHostServiceStatus, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceType=ogHostServiceType, ogHostServiceNotification=ogHostServiceNotification, ogCellDataNotification=ogCellDataNotification, ogUpsHumidity=ogUpsHumidity, ogCellModemApn=ogCellModemApn, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmName=ogCurrentAlarmName, ogCellNetworkNotification=ogCellNetworkNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemTable=ogCellModemTable, ogRpcOutletTable=ogRpcOutletTable, ogAlarm=ogAlarm, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmCheck=ogAlarmCheck, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdEnabled=ogEmdEnabled, ogAlarmUser=ogAlarmUser, ogHostEntry=ogHostEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialUserNotification=ogSerialUserNotification, ogAlarmDevice=ogAlarmDevice, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsDescription=ogUpsDescription, ogEmdTable=ogEmdTable, ogCellModemIndex=ogCellModemIndex, ogRpcCounter=ogRpcCounter, ogCellTowerNotification=ogCellTowerNotification, ogMibNotifications=ogMibNotifications, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserEntry=ogSerialUserEntry, ogStatus2Groups=ogStatus2Groups, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserAddress=ogHostUserAddress, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemRegistered=ogCellModemRegistered, ogWebUserNotification=ogWebUserNotification, ogStatus2Compliances=ogStatus2Compliances, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellApnNotification=ogCellApnNotification, ogSerialPortMode=ogSerialPortMode, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemModel=ogCellModemModel, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogHostServiceCounter=ogHostServiceCounter, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientAp=ogWifiApClientAp, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsTemperature=ogUpsTemperature, ogRpcTable=ogRpcTable, ogWifiClientTable=ogWifiClientTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApTxPower=ogWifiApTxPower, ogHostPingNotification=ogHostPingNotification, ogRpcType=ogRpcType, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostIpV6Address=ogHostIpV6Address, ogRpcConnectType=ogRpcConnectType, ogSerialPortRTS=ogSerialPortRTS, ogWebUserName=ogWebUserName, ogCheckTable=ogCheckTable, ogHostIndex=ogHostIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsEntry=ogUpsEntry, ogWebUserTable=ogWebUserTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostTable=ogHostTable, ogSerialUserLabel=ogSerialUserLabel, ogUpsTable=ogUpsTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApCounter=ogWifiApCounter, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioDirection=ogEmdDioDirection, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmUser=ogCurrentAlarmUser)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientMac=ogWifiApClientMac, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemConnected=ogCellModemConnected, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientTable=ogWifiApClientTable, ogHostUserStartTime=ogHostUserStartTime, ogEmdConnectType=ogEmdConnectType, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckName=ogCheckName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmTime=ogAlarmTime, ogSerialPortTable=ogSerialPortTable, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyName=ogPowerSupplyName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioType=ogEmdDioType, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortDataBits=ogSerialPortDataBits, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApIndex=ogWifiApIndex, ogUpsType=ogUpsType, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApFrequency=ogWifiApFrequency, ogRpcIndex=ogRpcIndex, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcEntry=ogRpcEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApTable=ogWifiApTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckIndex=ogCheckIndex, ogHostServiceEntry=ogHostServiceEntry, ogWebUserIndex=ogWebUserIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmState=ogAlarmState, ogHostUserEntry=ogHostUserEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcName=ogRpcName, ogEmdDioTable=ogEmdDioTable, ogRpcOutletState=ogRpcOutletState, ogSerialPortEntry=ogSerialPortEntry, ogCellModemIMSI=ogCellModemIMSI, ogHostServiceHost=ogHostServiceHost, ogEmdDioIndex=ogEmdDioIndex)
