...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemNetwork=ogCellModemNetwork, ogCellTowerNotification=ogCellTowerNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsDescription=ogUpsDescription, ogWifiApEntry=ogWifiApEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogFirmwareVersion=ogFirmwareVersion, ogWifiApInterface=ogWifiApInterface, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemCounter=ogCellModemCounter, ogSerialUserTable=ogSerialUserTable, ogHostServiceNotification=ogHostServiceNotification, ogHostIndex=ogHostIndex, ogEmdDioDirection=ogEmdDioDirection, ogAlarmInstance=ogAlarmInstance, ogCheckDeviceRef=ogCheckDeviceRef, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortMode=ogSerialPortMode, ogStatus2=ogStatus2, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemEntry=ogCellModemEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdConnectType=ogEmdConnectType, ogHostEntry=ogHostEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserName=ogSerialUserName, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioEmd=ogEmdDioEmd, ogHostName=ogHostName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemVendor=ogCellModemVendor, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientIndex=ogWifiApClientIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogNetInterfaceName=ogNetInterfaceName, ogHostServiceType=ogHostServiceType, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserName=ogHostUserName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletTable=ogRpcOutletTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientMac=ogWifiApClientMac, ogAlarmEventId=ogAlarmEventId, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckResolveActions=ogCheckResolveActions, ogHostUserNotification=ogHostUserNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientTable=ogWifiClientTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientInterface=ogWifiClientInterface, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSystem=ogSystem, ogCheckIndex=ogCheckIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletState=ogRpcOutletState, ogCellDataNotification=ogCellDataNotification, ogHostServicePort=ogHostServicePort, ogSerialNumber=ogSerialNumber, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortParity=ogSerialPortParity, ogRpcDescription=ogRpcDescription, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserTable=ogHostUserTable, ogEmdDioType=ogEmdDioType, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsConnectType=ogUpsConnectType, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckEntry=ogCheckEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemConnected=ogCellModemConnected, ogStatus2Compliances=ogStatus2Compliances, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientMode=ogWifiClientMode, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdIndex=ogEmdIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialUserEntry=ogSerialUserEntry, ogUpsCounter=ogUpsCounter, ogCheckTable=ogCheckTable, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsEntry=ogUpsEntry, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcOutletName=ogRpcOutletName, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientAp=ogWifiApClientAp, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioName=ogEmdDioName, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioTable=ogEmdDioTable, ogWebUserIndex=ogWebUserIndex, ogHostServiceStatus=ogHostServiceStatus, ogHostUserHost=ogHostUserHost, ogUpsTable=ogUpsTable, ogHostServiceTable=ogHostServiceTable, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckType=ogCheckType, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdTable=ogEmdTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcTable=ogRpcTable, ogWifiApIndex=ogWifiApIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientCounter=ogWifiClientCounter, ogCellModemTable=ogCellModemTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellApnNotification=ogCellApnNotification, ogStatus2Conformance=ogStatus2Conformance, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioNotification=ogEmdDioNotification, ogAlarmUser=ogAlarmUser, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsName=ogUpsName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcInputVoltage=ogRpcInputVoltage, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortDTR=ogSerialPortDTR, ogHostTable=ogHostTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogStatus2Compliance=ogStatus2Compliance, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioState=ogEmdDioState, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcEntry=ogRpcEntry, ogSerialPortTable=ogSerialPortTable, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientRssi=ogWifiClientRssi, ogRpcConnectType=ogRpcConnectType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcIndex=ogRpcIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemApn=ogCellModemApn, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserStartTime=ogWebUserStartTime, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortDSR=ogSerialPortDSR, ogHostUserHostName=ogHostUserHostName, ogSerialUserIndex=ogSerialUserIndex, ogWebUserTable=ogWebUserTable, ogWifiClientEntry=ogWifiClientEntry, ogWifiApTable=ogWifiApTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmLogTable=ogAlarmLogTable, ogAlarmState=ogAlarmState, ogWifiClientEssid=ogWifiClientEssid, ogAlarmType=ogAlarmType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsNotification=ogUpsNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmTime=ogAlarmTime, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcType=ogRpcType, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioIndex=ogEmdDioIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostPingNotification=ogHostPingNotification, ogAlarm=ogAlarm, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemModel=ogCellModemModel, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServiceEntry=ogHostServiceEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApSsid=ogWifiApSsid, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostUserIndex=ogHostUserIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsType=ogUpsType, ogHostServiceIndex=ogHostServiceIndex, ogEmdDescription=ogEmdDescription, ogRpcOutletTotal=ogRpcOutletTotal)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityCounter=ogEmdHumidityCounter, ogMibNotifications=ogMibNotifications, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcName=ogRpcName, ogCellModemTower=ogCellModemTower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientIndex=ogWifiClientIndex, PYSNMP_MODULE_ID=ogStatus2, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogWebUserName=ogWebUserName, ogWifiApClientTable=ogWifiApClientTable, ogHostServiceHost=ogHostServiceHost, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModem4gRssi=ogCellModem4gRssi, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsState=ogUpsState, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApCounter=ogWifiApCounter, ogEmdDioEntry=ogEmdDioEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApTxPower=ogWifiApTxPower, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCustomNotification=ogCustomNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdEntry=ogEmdEntry, ogEmdName=ogEmdName, ogCheckName=ogCheckName, ogRpcCounter=ogRpcCounter, ogSerialUserPort=ogSerialUserPort, ogAlarmSummary=ogAlarmSummary, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmName=ogAlarmName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsIndex=ogUpsIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostUserStartTime=ogHostUserStartTime, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortLabel=ogSerialPortLabel, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortIndex=ogSerialPortIndex, ogCellModemIndex=ogCellModemIndex, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostServiceCounter=ogHostServiceCounter, ogSerialUserLabel=ogSerialUserLabel, ogCellModemIMSI=ogCellModemIMSI, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyTable=ogPowerSupplyTable, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogDialPoolHealthNotification=ogDialPoolHealthNotification)
