...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogMibNotifications=ogMibNotifications, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarm=ogAlarm, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcIndex=ogRpcIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioState=ogEmdDioState, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialUserName=ogSerialUserName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogWebUserName=ogWebUserName, ogCellApnNotification=ogCellApnNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcOutletName=ogRpcOutletName, ogWifiApTable=ogWifiApTable, ogHostUserHost=ogHostUserHost, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWebUserTable=ogWebUserTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsEntry=ogUpsEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortDTR=ogSerialPortDTR, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemIMSI=ogCellModemIMSI, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcName=ogRpcName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmEventId=ogAlarmEventId, ogEmdTable=ogEmdTable, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApIndex=ogWifiApIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortIndex=ogSerialPortIndex, ogEmdConnectType=ogEmdConnectType, ogSerialPortRTS=ogSerialPortRTS, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostIpV4Address=ogHostIpV4Address, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApSsid=ogWifiApSsid, ogWifiClientTable=ogWifiClientTable, ogWifiClientFrequency=ogWifiClientFrequency, ogHostServiceNotification=ogHostServiceNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmState=ogAlarmState, ogCellModemVendor=ogCellModemVendor, ogAlarmUser=ogAlarmUser, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmLogIndex=ogAlarmLogIndex, ogWebUserNotification=ogWebUserNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserAddress=ogHostUserAddress, ogUpsIndex=ogUpsIndex, ogStatus2Groups=ogStatus2Groups, ogUpsState=ogUpsState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputNotification=ogUpsInputNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmDevice=ogAlarmDevice, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdEntry=ogEmdEntry, ogCheckName=ogCheckName, ogHostServiceStatus=ogHostServiceStatus, ogAlarmName=ogAlarmName, ogAlarmCheck=ogAlarmCheck, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientMode=ogWifiClientMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioIndex=ogEmdDioIndex, ogUpsConnectType=ogUpsConnectType, ogUpsOutputPower=ogUpsOutputPower, ogWebUserIndex=ogWebUserIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceType=ogNetInterfaceType, ogCellModemRegistered=ogCellModemRegistered, ogCheckEntry=ogCheckEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmSummary=ogAlarmSummary, ogStatus2=ogStatus2, ogHostTable=ogHostTable, ogUpsHumidity=ogUpsHumidity, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceType=ogHostServiceType, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioDescription=ogEmdDioDescription, ogHostServicePort=ogHostServicePort, ogEmdName=ogEmdName, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApEnabled=ogWifiApEnabled, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemTower=ogCellModemTower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioDirection=ogEmdDioDirection, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSystem=ogSystem, ogWebUserEntry=ogWebUserEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletState=ogRpcOutletState, ogStatus2Conformance=ogStatus2Conformance, ogHostIndex=ogHostIndex, ogWifiApTxPower=ogWifiApTxPower, ogRpcEntry=ogRpcEntry, ogAlarmTime=ogAlarmTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioEntry=ogEmdDioEntry, ogCheckIndex=ogCheckIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemTable=ogCellModemTable, ogSerialPortStopBits=ogSerialPortStopBits, ogHostIpV6Address=ogHostIpV6Address, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsTemperature=ogUpsTemperature, ogEmdDioTable=ogEmdDioTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcInputNotification=ogRpcInputNotification, ogCellModemIndex=ogCellModemIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellDataNotification=ogCellDataNotification, ogCellModemApn=ogCellModemApn, ogUpsOutputFrequency=ogUpsOutputFrequency, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortMode=ogSerialPortMode, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckTable=ogCheckTable, ogHostServiceHost=ogHostServiceHost, ogWifiClientIndex=ogWifiClientIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyName=ogPowerSupplyName, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserStartTime=ogHostUserStartTime, ogAlarmLogEntry=ogAlarmLogEntry, ogHostName=ogHostName, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioCounter=ogEmdDioCounter, ogCheckResetTimeout=ogCheckResetTimeout, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogHostEntry=ogHostEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialUserPort=ogSerialUserPort, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcTable=ogRpcTable, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserIndex=ogHostUserIndex, ogUpsType=ogUpsType, ogUpsNotification=ogUpsNotification, ogSerialPortEntry=ogSerialPortEntry, ogUpsTable=ogUpsTable, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialUserIndex=ogSerialUserIndex, ogRpcDescription=ogRpcDescription, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemModel=ogCellModemModel, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApCounter=ogWifiApCounter, ogAlarmType=ogAlarmType, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserEntry=ogSerialUserEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortTable=ogSerialPortTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialNumber=ogSerialNumber, ogNetInterfaceName=ogNetInterfaceName, ogEmdIndex=ogEmdIndex, ogEmdDioEmd=ogEmdDioEmd, ogEmdDioType=ogEmdDioType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortParity=ogSerialPortParity, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogCellMessageNotification=ogCellMessageNotification, ogEmdEnabled=ogEmdEnabled, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletTable=ogRpcOutletTable, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortLabel=ogSerialPortLabel, ogUpsCounter=ogUpsCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletLoad=ogRpcOutletLoad)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioNotification=ogEmdDioNotification, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientInterface=ogWifiClientInterface, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureName=ogEmdTemperatureName, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApInterface=ogWifiApInterface, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcConnectType=ogRpcConnectType, ogHostUserName=ogHostUserName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogNetInterfaceTable=ogNetInterfaceTable, ogNetInterfaceState=ogNetInterfaceState, ogRpcMaxTemperature=ogRpcMaxTemperature, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostUserTable=ogHostUserTable, ogCellModemEntry=ogCellModemEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmType=ogCurrentAlarmType, ogHostPingNotification=ogHostPingNotification, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostUserEntry=ogHostUserEntry, ogUpsName=ogUpsName, ogCellModemConnected=ogCellModemConnected, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckResolveActions=ogCheckResolveActions, ogAlarmInstance=ogAlarmInstance, ogCustomNotification=ogCustomNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDescription=ogEmdDescription, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServiceTable=ogHostServiceTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcCounter=ogRpcCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioName=ogEmdDioName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogStatus2Compliance=ogStatus2Compliance, ogCheckType=ogCheckType, ogUpsDescription=ogUpsDescription, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogFirmwareVersion=ogFirmwareVersion, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryState=ogUpsBatteryState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcType=ogRpcType, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdHumidityName=ogEmdHumidityName, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellNetworkNotification=ogCellNetworkNotification)
