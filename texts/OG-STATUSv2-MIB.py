...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, ObjectIdentity, ModuleIdentity, Counter32, iso, IpAddress, MibIdentifier, TimeTicks, Bits, NotificationType, Integer32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Counter32", "iso", "IpAddress", "MibIdentifier", "TimeTicks", "Bits", "NotificationType", "Integer32", "Counter64")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientIeeeMode=ogWifiClientIeeeMode, PYSNMP_MODULE_ID=ogStatus2, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserPort=ogSerialUserPort, ogUpsNotification=ogUpsNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiApEntry=ogWifiApEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientBitRate=ogWifiClientBitRate, ogStatus2Groups=ogStatus2Groups, ogCheckName=ogCheckName, ogSerialPortIndex=ogSerialPortIndex, ogAlarmDevice=ogAlarmDevice, ogCellModemApn=ogCellModemApn, ogSerialPortTable=ogSerialPortTable, ogCellTowerNotification=ogCellTowerNotification, ogEmdDescription=ogEmdDescription, ogCellModemEnabled=ogCellModemEnabled, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmUser=ogAlarmUser, ogUpsHumidity=ogUpsHumidity, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputPower=ogUpsOutputPower, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsDescription=ogUpsDescription, ogWebUserEntry=ogWebUserEntry, ogUpsTable=ogUpsTable, ogRpcType=ogRpcType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogNetInterfaceState=ogNetInterfaceState, ogUpsType=ogUpsType, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdName=ogEmdName, ogRpcInputNotification=ogRpcInputNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckResetTimeout=ogCheckResetTimeout, ogCellApnNotification=ogCellApnNotification, ogEmdEntry=ogEmdEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckTriggerActions=ogCheckTriggerActions, ogWebUserIndex=ogWebUserIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcDescription=ogRpcDescription, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarm=ogAlarm, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientRssi=ogWifiClientRssi, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTable=ogEmdTable, ogUpsBatteryState=ogUpsBatteryState, ogHostTable=ogHostTable, ogPowerSupplyName=ogPowerSupplyName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityName=ogEmdHumidityName, ogWebUserTable=ogWebUserTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletTable=ogRpcOutletTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdEnabled=ogEmdEnabled, ogUpsInputNotification=ogUpsInputNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioDirection=ogEmdDioDirection, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialUserName=ogSerialUserName, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortDTR=ogSerialPortDTR, ogCheckResolveActions=ogCheckResolveActions, ogMibNotifications=ogMibNotifications, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsInputCurrent=ogUpsInputCurrent, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialUserTable=ogSerialUserTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmSummary=ogAlarmSummary, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsEntry=ogUpsEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApIndex=ogWifiApIndex, ogCellModemVendor=ogCellModemVendor, ogSerialNumber=ogSerialNumber, ogHostServiceType=ogHostServiceType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostServiceEntry=ogHostServiceEntry, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserAddress=ogHostUserAddress, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserName=ogHostUserName, ogCustomNotification=ogCustomNotification, ogSerialPortEntry=ogSerialPortEntry, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortDCD=ogSerialPortDCD, ogCheckTable=ogCheckTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortDSR=ogSerialPortDSR, ogRpcName=ogRpcName, ogAlarmTime=ogAlarmTime, ogHostServiceHost=ogHostServiceHost, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletState=ogRpcOutletState, ogCheckEntry=ogCheckEntry, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientTable=ogWifiApClientTable, ogCheckDeviceName=ogCheckDeviceName, ogWifiApTable=ogWifiApTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientMac=ogWifiApClientMac, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApSsid=ogWifiApSsid, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmInstance=ogAlarmInstance, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostPingNotification=ogHostPingNotification, ogHostUserIndex=ogHostUserIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialUserEntry=ogSerialUserEntry, ogCheckIndex=ogCheckIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcOutletName=ogRpcOutletName, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientEntry=ogWifiClientEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogHostUserStartTime=ogHostUserStartTime, ogRpcInputVoltage=ogRpcInputVoltage, ogSystem=ogSystem, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserTable=ogHostUserTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserNotification=ogHostUserNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmCheck=ogAlarmCheck, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientCounter=ogWifiClientCounter, ogRpcEntry=ogRpcEntry, ogUpsName=ogUpsName, ogEmdDioState=ogEmdDioState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioDescription=ogEmdDioDescription, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostUserEntry=ogHostUserEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmType=ogCurrentAlarmType, ogHostUserHost=ogHostUserHost, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostEntry=ogHostEntry, ogRpcIndex=ogRpcIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortMode=ogSerialPortMode, ogHostServiceTable=ogHostServiceTable, ogHostIndex=ogHostIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemTable=ogCellModemTable, ogRpcOutletTotal=ogRpcOutletTotal, ogCellMessageNotification=ogCellMessageNotification, ogCellSignalNotification=ogCellSignalNotification, ogStatus2Compliance=ogStatus2Compliance, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortCTS=ogSerialPortCTS, ogUpsTemperature=ogUpsTemperature, ogCellModemCounter=ogCellModemCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientTable=ogWifiClientTable, ogUpsCounter=ogUpsCounter, ogSerialPortParity=ogSerialPortParity, ogCellModemRegistered=ogCellModemRegistered)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemConnected=ogCellModemConnected, ogAlarmState=ogAlarmState, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckType=ogCheckType, ogStatus2=ogStatus2, ogWifiClientMode=ogWifiClientMode, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcConnectType=ogRpcConnectType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserName=ogWebUserName, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientInterface=ogWifiClientInterface, ogHostName=ogHostName, ogHostServiceStatus=ogHostServiceStatus, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmType=ogAlarmType, ogHostServicePort=ogHostServicePort, ogAlarmName=ogAlarmName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsState=ogUpsState, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioName=ogEmdDioName, ogNetInterfaceType=ogNetInterfaceType, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcTable=ogRpcTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApFrequency=ogWifiApFrequency, ogWifiApCounter=ogWifiApCounter, ogCellModemIndex=ogCellModemIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioIndex=ogEmdDioIndex, ogCellModemModel=ogCellModemModel, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsConnectType=ogUpsConnectType, ogHostServiceNotification=ogHostServiceNotification, ogEmdConnectType=ogEmdConnectType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioType=ogEmdDioType, ogRpcCounter=ogRpcCounter, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsIndex=ogUpsIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmLogIndex=ogAlarmLogIndex, ogHostServiceIndex=ogHostServiceIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserIndex=ogSerialUserIndex, ogCellModemTower=ogCellModemTower, ogWifiClientEssid=ogWifiClientEssid, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioTable=ogEmdDioTable, ogEmdDioEntry=ogEmdDioEntry, ogEmdIndex=ogEmdIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApIeeeMode=ogWifiApIeeeMode)
