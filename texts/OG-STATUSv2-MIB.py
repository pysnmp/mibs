...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckEntry=ogCheckEntry, ogAlarmTime=ogAlarmTime, ogWebUserName=ogWebUserName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogStatus2Compliances=ogStatus2Compliances, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdEntry=ogEmdEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTable=ogEmdTable, ogRpcDescription=ogRpcDescription, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceType=ogNetInterfaceType, ogHostUserEntry=ogHostUserEntry, ogRpcName=ogRpcName, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserTable=ogSerialUserTable, ogCellModemEnabled=ogCellModemEnabled, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioState=ogEmdDioState, ogAlarmState=ogAlarmState, ogWifiClientTable=ogWifiClientTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemModel=ogCellModemModel, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioDirection=ogEmdDioDirection, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsTable=ogUpsTable, ogCellModemEntry=ogCellModemEntry, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserPort=ogSerialUserPort, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientMode=ogWifiClientMode, ogAlarmEventId=ogAlarmEventId, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsDescription=ogUpsDescription, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortLogLevel=ogSerialPortLogLevel, ogStatus2=ogStatus2, ogSerialPortDTR=ogSerialPortDTR, ogHostServiceHost=ogHostServiceHost, ogCellApnNotification=ogCellApnNotification, ogUpsCounter=ogUpsCounter, ogSystem=ogSystem, ogSerialUserName=ogSerialUserName, ogCellModemConnected=ogCellModemConnected, ogEmdConnectType=ogEmdConnectType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWebUserNotification=ogWebUserNotification, ogUpsHumidity=ogUpsHumidity, ogCellModemIndex=ogCellModemIndex, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarmUser=ogAlarmUser, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemVendor=ogCellModemVendor, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioType=ogEmdDioType, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceTable=ogHostServiceTable, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemTable=ogCellModemTable, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdName=ogEmdName, ogWifiApEntry=ogWifiApEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcIndex=ogRpcIndex, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmInstance=ogAlarmInstance, ogHostServiceNotification=ogHostServiceNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogCellTowerNotification=ogCellTowerNotification, ogHostUserHostName=ogHostUserHostName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsName=ogUpsName, ogStatus2Compliance=ogStatus2Compliance, ogHostEntry=ogHostEntry, ogSerialPortLabel=ogSerialPortLabel, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientEntry=ogWifiClientEntry, ogWifiApTable=ogWifiApTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModemApn=ogCellModemApn, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmLogIndex=ogAlarmLogIndex, ogHostTable=ogHostTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemCounter=ogCellModemCounter, ogHostIpV4Address=ogHostIpV4Address, ogHostUserHost=ogHostUserHost, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioIndex=ogEmdDioIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcConnectType=ogRpcConnectType, ogRpcOutletTable=ogRpcOutletTable, ogMibNotifications=ogMibNotifications, ogUpsInputCurrent=ogUpsInputCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceState=ogNetInterfaceState, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckResolveActions=ogCheckResolveActions, ogHostName=ogHostName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdEnabled=ogEmdEnabled, ogWifiApFrequency=ogWifiApFrequency, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortParity=ogSerialPortParity, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortEntry=ogSerialPortEntry, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostPingNotification=ogHostPingNotification, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellDataNotification=ogCellDataNotification, ogHostUserName=ogHostUserName, ogHostServiceStatus=ogHostServiceStatus, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmName=ogAlarmName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemTower=ogCellModemTower, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostUserStartTime=ogHostUserStartTime, ogRpcEntry=ogRpcEntry, ogUpsTemperature=ogUpsTemperature, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletNotification=ogRpcOutletNotification, ogWebUserEntry=ogWebUserEntry, PYSNMP_MODULE_ID=ogStatus2, ogAlarmCheck=ogAlarmCheck, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientEssid=ogWifiClientEssid, ogUpsNotification=ogUpsNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckDeviceName=ogCheckDeviceName, ogEmdIndex=ogEmdIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDescription=ogEmdDescription, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWebUserStartTime=ogWebUserStartTime, ogCheckIndex=ogCheckIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApTxPower=ogWifiApTxPower, ogUpsInputVoltage=ogUpsInputVoltage, ogStatus2Groups=ogStatus2Groups, ogEmdDioTable=ogEmdDioTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCustomNotification=ogCustomNotification, ogRpcCounter=ogRpcCounter, ogUpsIndex=ogUpsIndex, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckName=ogCheckName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckType=ogCheckType, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcTable=ogRpcTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioNotification=ogEmdDioNotification, ogUpsEntry=ogUpsEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortCTS=ogSerialPortCTS)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialNumber=ogSerialNumber, ogSerialPortIndex=ogSerialPortIndex, ogCheckTable=ogCheckTable, ogRpcInputFrequency=ogRpcInputFrequency, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserIndex=ogHostUserIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostIndex=ogHostIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletName=ogRpcOutletName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortDSR=ogSerialPortDSR, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletState=ogRpcOutletState, ogUpsState=ogUpsState, ogAlarmLogTable=ogAlarmLogTable, ogHostUserTable=ogHostUserTable, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApIndex=ogWifiApIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWebUserTable=ogWebUserTable, ogHostUserNotification=ogHostUserNotification, ogSerialPortTable=ogSerialPortTable, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmType=ogAlarmType, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioName=ogEmdDioName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceEntry=ogHostServiceEntry, ogHostServiceType=ogHostServiceType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsType=ogUpsType, ogHostServicePort=ogHostServicePort, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientApMac=ogWifiClientApMac, ogAlarmSummary=ogAlarmSummary, ogWifiClientInterface=ogWifiClientInterface, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarm=ogAlarm, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsConnectType=ogUpsConnectType, ogAlarmDevice=ogAlarmDevice, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcType=ogRpcType, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApCounter=ogWifiApCounter, ogWifiApClientTable=ogWifiApClientTable, ogRpcInputNotification=ogRpcInputNotification, ogCellMessageNotification=ogCellMessageNotification)
