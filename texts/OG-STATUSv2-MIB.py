...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientTable=ogWifiApClientTable, ogAlarmName=ogAlarmName, ogCellModemRegistered=ogCellModemRegistered, ogWebUserName=ogWebUserName, ogHostUserEntry=ogHostUserEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientInterface=ogWifiClientInterface, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmTime=ogAlarmTime, ogCellModem4gRssi=ogCellModem4gRssi, ogNetInterfaceType=ogNetInterfaceType, ogWebUserSourcePort=ogWebUserSourcePort, ogHostUserAddress=ogHostUserAddress, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApTable=ogWifiApTable, ogNetInterfaceName=ogNetInterfaceName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCheckTable=ogCheckTable, ogWifiClientApMac=ogWifiClientApMac, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWebUserTable=ogWebUserTable, ogAlarmType=ogAlarmType, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostUserTable=ogHostUserTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApSsid=ogWifiApSsid, ogEmdDioCounter=ogEmdDioCounter, ogCheckEntry=ogCheckEntry, ogRpcOutletState=ogRpcOutletState, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsCounter=ogUpsCounter, ogAlarmEventId=ogAlarmEventId, ogAlarmSummary=ogAlarmSummary, ogUpsHumidity=ogUpsHumidity, ogRpcIndex=ogRpcIndex, ogRpcInputNotification=ogRpcInputNotification, ogRpcTable=ogRpcTable, ogSerialUserPort=ogSerialUserPort, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcConnectType=ogRpcConnectType, ogEmdIndex=ogEmdIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApIndex=ogWifiApIndex, ogStatus2Groups=ogStatus2Groups, ogAlarmUser=ogAlarmUser, ogEmdName=ogEmdName, ogCellModemModel=ogCellModemModel, ogCellModemEntry=ogCellModemEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemEnabled=ogCellModemEnabled, ogRpcType=ogRpcType, ogUpsInputFrequency=ogUpsInputFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmInstance=ogAlarmInstance, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogCellApnNotification=ogCellApnNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTable=ogEmdTable, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserName=ogSerialUserName, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApEntry=ogWifiApEntry, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostServiceCounter=ogHostServiceCounter, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputTruePower=ogUpsOutputTruePower, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserName=ogHostUserName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientEntry=ogWifiClientEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortIndex=ogSerialPortIndex, ogUpsEntry=ogUpsEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcName=ogRpcName, ogCellModemConnected=ogCellModemConnected, ogWifiApCounter=ogWifiApCounter, ogSerialPortParity=ogSerialPortParity, ogHostUserStartTime=ogHostUserStartTime, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsTable=ogUpsTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWebUserStartTime=ogWebUserStartTime, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogStatus2=ogStatus2, ogCellModemTable=ogCellModemTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCustomNotification=ogCustomNotification, ogWifiClientTable=ogWifiClientTable, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServiceStatus=ogHostServiceStatus, ogCellModemTower=ogCellModemTower, ogHostEntry=ogHostEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarm=ogAlarm, ogWifiApInterface=ogWifiApInterface, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostIndex=ogHostIndex, ogWifiClientIndex=ogWifiClientIndex, ogUpsName=ogUpsName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdConnectType=ogEmdConnectType, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioDescription=ogEmdDioDescription, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyName=ogPowerSupplyName, ogCheckName=ogCheckName, ogUpsTemperature=ogUpsTemperature, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserTable=ogSerialUserTable, ogRpcCounter=ogRpcCounter, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserHostName=ogHostUserHostName, ogRpcOutletTable=ogRpcOutletTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsIndex=ogUpsIndex, ogUpsType=ogUpsType, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemIMSI=ogCellModemIMSI, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWebUserEntry=ogWebUserEntry, ogAlarmLogTable=ogAlarmLogTable, ogWebUserNotification=ogWebUserNotification, ogRpcOutletName=ogRpcOutletName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientTxPower=ogWifiClientTxPower, ogMibNotifications=ogMibNotifications, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemVendor=ogCellModemVendor, ogSerialPortEntry=ogSerialPortEntry, ogStatus2Compliances=ogStatus2Compliances, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioTable=ogEmdDioTable, ogEmdDescription=ogEmdDescription, ogSerialPortMode=ogSerialPortMode, ogCheckTriggerActions=ogCheckTriggerActions, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortDSR=ogSerialPortDSR, ogCellDataNotification=ogCellDataNotification, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemCounter=ogCellModemCounter, ogWifiApEnabled=ogWifiApEnabled, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioName=ogEmdDioName, ogHostServiceEntry=ogHostServiceEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityValue=ogEmdHumidityValue, ogHostServicePort=ogHostServicePort, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApClientRssi=ogWifiApClientRssi, PYSNMP_MODULE_ID=ogStatus2, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostIpV4Address=ogHostIpV4Address, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioEntry=ogEmdDioEntry, ogCheckType=ogCheckType, ogRpcDescription=ogRpcDescription, ogUpsNotification=ogUpsNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApTxPower=ogWifiApTxPower, ogHostPingNotification=ogHostPingNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostServiceType=ogHostServiceType, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSystem=ogSystem, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsDescription=ogUpsDescription, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostName=ogHostName, ogHostServiceIndex=ogHostServiceIndex, ogHostUserNotification=ogHostUserNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsConnectType=ogUpsConnectType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmState=ogAlarmState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmDevice=ogAlarmDevice, ogWifiApFrequency=ogWifiApFrequency, ogHostUserHost=ogHostUserHost, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioType=ogEmdDioType, ogAlarmCheck=ogAlarmCheck, ogSerialPortRTS=ogSerialPortRTS, ogCellModemApn=ogCellModemApn, ogHostTable=ogHostTable, ogSerialUserIndex=ogSerialUserIndex, ogRpcEntry=ogRpcEntry, ogEmdEnabled=ogEmdEnabled, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWebUserIndex=ogWebUserIndex, ogEmdDioState=ogEmdDioState, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioDirection=ogEmdDioDirection, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServiceHost=ogHostServiceHost, ogCheckIndex=ogCheckIndex, ogUpsState=ogUpsState, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdEntry=ogEmdEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialNumber=ogSerialNumber, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid)
