...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientTable=ogWifiApClientTable, ogWifiApTable=ogWifiApTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialUserIndex=ogSerialUserIndex, ogCellApnNotification=ogCellApnNotification, ogUpsConnectType=ogUpsConnectType, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserTable=ogWebUserTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortDTR=ogSerialPortDTR, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckIndex=ogCheckIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsName=ogUpsName, ogCheckType=ogCheckType, ogHostServiceTable=ogHostServiceTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsEntry=ogUpsEntry, ogSerialNumber=ogSerialNumber, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserStartTime=ogHostUserStartTime, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModemTower=ogCellModemTower, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientTable=ogWifiClientTable, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialUserName=ogSerialUserName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientEssid=ogWifiClientEssid, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTable=ogEmdTable, ogCellTowerNotification=ogCellTowerNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsNotification=ogUpsNotification, ogCheckTable=ogCheckTable, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmDevice=ogAlarmDevice, ogUpsCounter=ogUpsCounter, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserTable=ogHostUserTable, ogCellModemVendor=ogCellModemVendor, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityName=ogEmdHumidityName, ogRpcEntry=ogRpcEntry, ogHostEntry=ogHostEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApSsid=ogWifiApSsid, ogEmdDioName=ogEmdDioName, ogSerialPortTable=ogSerialPortTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostUserAddress=ogHostUserAddress, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApCounter=ogWifiApCounter, ogAlarmTime=ogAlarmTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmUser=ogAlarmUser, ogEmdName=ogEmdName, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsTable=ogUpsTable, ogRpcTable=ogRpcTable, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortEntry=ogSerialPortEntry, ogUpsType=ogUpsType, ogWifiApClientEntry=ogWifiApClientEntry, ogStatus2Compliance=ogStatus2Compliance, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemCounter=ogCellModemCounter, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletTable=ogRpcOutletTable, ogHostServiceNotification=ogHostServiceNotification, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdConnectType=ogEmdConnectType, ogWebUserStartTime=ogWebUserStartTime, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortMode=ogSerialPortMode, ogAlarmType=ogAlarmType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortDSR=ogSerialPortDSR, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdEnabled=ogEmdEnabled, ogNetInterfaceEntry=ogNetInterfaceEntry, ogStatus2=ogStatus2, ogCheckName=ogCheckName, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogStatus2Groups=ogStatus2Groups, ogUpsTemperature=ogUpsTemperature, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServiceStatus=ogHostServiceStatus, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsBatteryCharge=ogUpsBatteryCharge, ogMibNotifications=ogMibNotifications, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarm=ogAlarm, ogSerialUserTable=ogSerialUserTable, ogWifiApInterface=ogWifiApInterface, ogWebUserNotification=ogWebUserNotification, ogSerialPortDCD=ogSerialPortDCD, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcIndex=ogRpcIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogAlarmName=ogAlarmName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostName=ogHostName, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWebUserEntry=ogWebUserEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortParity=ogSerialPortParity, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostPingNotification=ogHostPingNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostServiceHost=ogHostServiceHost, ogCellModemApn=ogCellModemApn, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortLabel=ogSerialPortLabel, ogHostUserHost=ogHostUserHost, ogRpcType=ogRpcType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserName=ogHostUserName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmInstance=ogAlarmInstance, ogAlarmCheck=ogAlarmCheck, ogAlarmState=ogAlarmState, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemTable=ogCellModemTable, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientInterface=ogWifiClientInterface, ogUpsInputNotification=ogUpsInputNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletNotification=ogRpcOutletNotification, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApTxPower=ogWifiApTxPower, ogRpcName=ogRpcName, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApIndex=ogWifiApIndex, ogSerialPortIndex=ogSerialPortIndex, ogUpsIndex=ogUpsIndex, ogEmdEntry=ogEmdEntry, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemModel=ogCellModemModel, ogHostUserEntry=ogHostUserEntry, ogUpsState=ogUpsState, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputPower=ogUpsOutputPower, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckDeviceName=ogCheckDeviceName, ogHostServiceIndex=ogHostServiceIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdIndex=ogEmdIndex, ogHostTable=ogHostTable, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSystem=ogSystem, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceType=ogNetInterfaceType, ogRpcConnectType=ogRpcConnectType, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceState=ogNetInterfaceState, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialUserNotification=ogSerialUserNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientAp=ogWifiApClientAp, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostServiceType=ogHostServiceType, ogRpcInputCurrent=ogRpcInputCurrent, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemEnabled=ogCellModemEnabled, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmEventId=ogAlarmEventId, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserName=ogWebUserName, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdDescription=ogEmdDescription, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCustomNotification=ogCustomNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApEnabled=ogWifiApEnabled, ogSerialUserPort=ogSerialUserPort, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioEmd=ogEmdDioEmd, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientEntry=ogWifiClientEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserIndex=ogHostUserIndex, ogCellDataNotification=ogCellDataNotification, ogWifiClientMode=ogWifiClientMode, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcCounter=ogRpcCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmState=ogCurrentAlarmState, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWebUserIndex=ogWebUserIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostUserHostName=ogHostUserHostName, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletName=ogRpcOutletName, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemNetwork=ogCellModemNetwork, ogHostServicePort=ogHostServicePort, ogEmdDioType=ogEmdDioType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioState=ogEmdDioState, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserNotification=ogHostUserNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckEntry=ogCheckEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogHostIndex=ogHostIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsDescription=ogUpsDescription, ogRpcDescription=ogRpcDescription, ogAlarmSummary=ogAlarmSummary, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemEntry=ogCellModemEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortCTS=ogSerialPortCTS)
