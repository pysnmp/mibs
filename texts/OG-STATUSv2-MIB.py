...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApClientMac=ogWifiApClientMac, ogSerialSignalNotification=ogSerialSignalNotification, ogHostServiceType=ogHostServiceType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientTable=ogWifiApClientTable, ogWifiApEnabled=ogWifiApEnabled, ogHostUserName=ogHostUserName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWebUserTable=ogWebUserTable, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioState=ogEmdDioState, ogUpsHumidity=ogUpsHumidity, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortLogLevel=ogSerialPortLogLevel, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModem4gRssi=ogCellModem4gRssi, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdIndex=ogEmdIndex, ogSerialPortDTR=ogSerialPortDTR, ogCheckEntry=ogCheckEntry, PYSNMP_MODULE_ID=ogStatus2, ogHostName=ogHostName, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApInterface=ogWifiApInterface, ogCellModemTower=ogCellModemTower, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceTable=ogHostServiceTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSystem=ogSystem, ogNetInterfaceTable=ogNetInterfaceTable, ogStatus2=ogStatus2, ogEmdName=ogEmdName, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientIndex=ogWifiApClientIndex, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutletVoltage=ogRpcOutletVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostIpV4Address=ogHostIpV4Address, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientCounter=ogWifiClientCounter, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApFrequency=ogWifiApFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserIndex=ogWebUserIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarm=ogAlarm, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcType=ogRpcType, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientTable=ogWifiClientTable, ogCellModemConnected=ogCellModemConnected, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellDataNotification=ogCellDataNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdDioTable=ogEmdDioTable, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemModel=ogCellModemModel, ogSerialPortEntry=ogSerialPortEntry, ogAlarmTime=ogAlarmTime, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellApnNotification=ogCellApnNotification, ogEmdEnabled=ogEmdEnabled, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioCounter=ogEmdDioCounter, ogEmdConnectType=ogEmdConnectType, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemVendor=ogCellModemVendor, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcCounter=ogRpcCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserStartTime=ogHostUserStartTime, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsOutputPower=ogUpsOutputPower, ogHostPingNotification=ogHostPingNotification, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmType=ogAlarmType, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsNotification=ogUpsNotification, ogAlarmInstance=ogAlarmInstance, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsDescription=ogUpsDescription, ogCheckName=ogCheckName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmEventId=ogAlarmEventId, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckType=ogCheckType, ogAlarmState=ogAlarmState, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostEntry=ogHostEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcEntry=ogRpcEntry, ogSerialNumber=ogSerialNumber, ogWebUserStartTime=ogWebUserStartTime, ogRpcTable=ogRpcTable, ogHostUserHostName=ogHostUserHostName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTable=ogEmdTable, ogSerialPortRTS=ogSerialPortRTS, ogNetInterfaceName=ogNetInterfaceName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortMode=ogSerialPortMode, ogCheckResolveActions=ogCheckResolveActions, ogUpsCounter=ogUpsCounter, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserName=ogSerialUserName, ogWifiClientEntry=ogWifiClientEntry, ogUpsConnectType=ogUpsConnectType, ogHostIpV6Address=ogHostIpV6Address, ogUpsTemperature=ogUpsTemperature, ogCellModemIndex=ogCellModemIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletTable=ogRpcOutletTable, ogCellModemCounter=ogCellModemCounter, ogUpsName=ogUpsName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdEntry=ogEmdEntry, ogCellModemRegistered=ogCellModemRegistered, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcIndex=ogRpcIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioType=ogEmdDioType, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmLogTable=ogAlarmLogTable, ogAlarmCheck=ogAlarmCheck, ogWifiApTable=ogWifiApTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCustomNotification=ogCustomNotification, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsTable=ogUpsTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioEntry=ogEmdDioEntry, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientRssi=ogWifiClientRssi, ogAlarmTriggerValue=ogAlarmTriggerValue, ogFirmwareVersion=ogFirmwareVersion, ogAlarmUser=ogAlarmUser, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientRssi=ogWifiApClientRssi, ogWebUserName=ogWebUserName, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogHostTable=ogHostTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApCounter=ogWifiApCounter, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmName=ogAlarmName, ogEmdDioIndex=ogEmdDioIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsInputVoltage=ogUpsInputVoltage, ogWebUserEntry=ogWebUserEntry, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortDCD=ogSerialPortDCD, ogHostUserNotification=ogHostUserNotification, ogHostServiceIndex=ogHostServiceIndex, ogHostServicePort=ogHostServicePort, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApTxPower=ogWifiApTxPower, ogHostUserTable=ogHostUserTable, ogHostIndex=ogHostIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemEntry=ogCellModemEntry, ogPowerSupplyName=ogPowerSupplyName, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortTable=ogSerialPortTable, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialUserNotification=ogSerialUserNotification, ogHostServiceCounter=ogHostServiceCounter, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserTable=ogSerialUserTable, ogStatus2Groups=ogStatus2Groups)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemEnabled=ogCellModemEnabled, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletName=ogRpcOutletName, ogRpcOutletState=ogRpcOutletState, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemApn=ogCellModemApn, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortParity=ogSerialPortParity, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDescription=ogEmdDescription, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcInputNotification=ogRpcInputNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserHost=ogHostUserHost, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemTable=ogCellModemTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcName=ogRpcName, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsState=ogUpsState, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputNotification=ogUpsInputNotification, ogUpsType=ogUpsType, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioName=ogEmdDioName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientIndex=ogWifiClientIndex, ogWifiApIndex=ogWifiApIndex, ogUpsEntry=ogUpsEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioDirection=ogEmdDioDirection, ogHostUserIndex=ogHostUserIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckIndex=ogCheckIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsIndex=ogUpsIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcDescription=ogRpcDescription, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellTowerNotification=ogCellTowerNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogHostServiceStatus=ogHostServiceStatus, ogCellModemIMSI=ogCellModemIMSI, ogMibNotifications=ogMibNotifications, ogHostServiceEntry=ogHostServiceEntry, ogNetInterfaceState=ogNetInterfaceState, ogWebUserNotification=ogWebUserNotification, ogWifiClientMode=ogWifiClientMode, ogCheckTable=ogCheckTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc)
