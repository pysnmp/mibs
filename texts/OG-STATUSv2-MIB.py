...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Bits, Counter64, TimeTicks, Unsigned32, Integer32, Gauge32, NotificationType, ModuleIdentity, Counter32, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Bits", "Counter64", "TimeTicks", "Unsigned32", "Integer32", "Gauge32", "NotificationType", "ModuleIdentity", "Counter32", "IpAddress", "ObjectIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsDescription=ogUpsDescription, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmType=ogAlarmType, ogEmdDioTable=ogEmdDioTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckName=ogCheckName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceIndex=ogHostServiceIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserStartTime=ogHostUserStartTime, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserPort=ogSerialUserPort, ogWifiClientApMac=ogWifiClientApMac, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellDataNotification=ogCellDataNotification, ogRpcOutletTable=ogRpcOutletTable, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortMode=ogSerialPortMode, ogCellModemVendor=ogCellModemVendor, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientIndex=ogWifiClientIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmName=ogAlarmName, ogHostUserTable=ogHostUserTable, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApTxPower=ogWifiApTxPower, ogHostName=ogHostName, ogEmdTable=ogEmdTable, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdConnectType=ogEmdConnectType, ogCellModemModel=ogCellModemModel, ogWebUserTable=ogWebUserTable, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientCounter=ogWifiClientCounter, ogFirmwareVersion=ogFirmwareVersion, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioState=ogEmdDioState, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceStatus=ogHostServiceStatus, ogCellTowerNotification=ogCellTowerNotification, ogAlarmState=ogAlarmState, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckIndex=ogCheckIndex, ogSerialPortDTR=ogSerialPortDTR, ogCellSignalNotification=ogCellSignalNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortTable=ogSerialPortTable, ogHostUserAddress=ogHostUserAddress, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortDCD=ogSerialPortDCD, ogCellModemNetwork=ogCellModemNetwork, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputVoltage=ogUpsInputVoltage, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioType=ogEmdDioType, ogHostServiceType=ogHostServiceType, ogUpsConnectType=ogUpsConnectType, ogRpcConnectType=ogRpcConnectType, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmSummary=ogAlarmSummary, ogMibNotifications=ogMibNotifications, ogHostIndex=ogHostIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserEntry=ogHostUserEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCustomNotification=ogCustomNotification, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioCounter=ogEmdDioCounter, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcType=ogRpcType, ogAlarm=ogAlarm, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortIndex=ogSerialPortIndex, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmCheck=ogAlarmCheck, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsState=ogUpsState, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemConnected=ogCellModemConnected, ogUpsOutputTruePower=ogUpsOutputTruePower, ogStatus2Conformance=ogStatus2Conformance, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemTower=ogCellModemTower, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcTable=ogRpcTable, ogCheckResetTimeout=ogCheckResetTimeout, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsType=ogUpsType, ogEmdDioEmd=ogEmdDioEmd, ogRpcOutletState=ogRpcOutletState, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsBatteryState=ogUpsBatteryState, ogWifiApCounter=ogWifiApCounter, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientAp=ogWifiApClientAp, ogWebUserName=ogWebUserName, ogHostUserHost=ogHostUserHost, ogWifiApFrequency=ogWifiApFrequency, ogHostUserIndex=ogHostUserIndex, ogEmdEnabled=ogEmdEnabled, ogCellModemIndex=ogCellModemIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserName=ogHostUserName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortParity=ogSerialPortParity, ogSerialPortRTS=ogSerialPortRTS, ogCellModemCounter=ogCellModemCounter, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientTable=ogWifiClientTable, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApEnabled=ogWifiApEnabled, ogEmdName=ogEmdName, PYSNMP_MODULE_ID=ogStatus2, ogRpcInputFrequency=ogRpcInputFrequency, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckDeviceName=ogCheckDeviceName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmTime=ogAlarmTime, ogUpsIndex=ogUpsIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostEntry=ogHostEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdHumidityValue=ogEmdHumidityValue, ogNetInterfaceType=ogNetInterfaceType, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApTable=ogWifiApTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsTable=ogUpsTable, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckEntry=ogCheckEntry, ogCheckTable=ogCheckTable, ogHostTable=ogHostTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWebUserEntry=ogWebUserEntry, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioEntry=ogEmdDioEntry, ogAlarmUser=ogAlarmUser, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApEntry=ogWifiApEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialNumber=ogSerialNumber, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellApnNotification=ogCellApnNotification, ogSerialPortCTS=ogSerialPortCTS, ogWifiApSsid=ogWifiApSsid, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioIndex=ogEmdDioIndex, ogHostServicePort=ogHostServicePort, ogCellModemEntry=ogCellModemEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmDevice=ogAlarmDevice, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcCounter=ogRpcCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogNetInterfaceState=ogNetInterfaceState, ogUpsName=ogUpsName, ogRpcOutletName=ogRpcOutletName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialUserNotification=ogSerialUserNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcName=ogRpcName, ogRpcEntry=ogRpcEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsHumidity=ogUpsHumidity, ogEmdDioName=ogEmdDioName, ogEmdIndex=ogEmdIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientMac=ogWifiApClientMac, ogRpcDescription=ogRpcDescription, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityCounter=ogEmdHumidityCounter, ogStatus2=ogStatus2, ogCellModemRegistered=ogCellModemRegistered, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogAlarmEventId=ogAlarmEventId, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcIndex=ogRpcIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogHostIpV4Address=ogHostIpV4Address, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyName=ogPowerSupplyName, ogSystem=ogSystem, ogNetInterfaceName=ogNetInterfaceName, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdEntry=ogEmdEntry, ogSerialPortEntry=ogSerialPortEntry, ogHostIpV6Address=ogHostIpV6Address, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserNotification=ogWebUserNotification, ogHostServiceHost=ogHostServiceHost, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsEntry=ogUpsEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientRssi=ogWifiClientRssi, ogUpsCounter=ogUpsCounter, ogSerialUserName=ogSerialUserName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemApn=ogCellModemApn, ogHostServiceCounter=ogHostServiceCounter, ogCellModemTable=ogCellModemTable, ogUpsNotification=ogUpsNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDescription=ogEmdDescription, ogWifiClientMode=ogWifiClientMode, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApIeeeMode=ogWifiApIeeeMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsInputNotification=ogUpsInputNotification, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserLabel=ogSerialUserLabel, ogHostUserNotification=ogHostUserNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostPingNotification=ogHostPingNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceTable=ogHostServiceTable, ogCheckType=ogCheckType, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsTemperature=ogUpsTemperature)
