...
ModuleIdentity, MibIdentifier, IpAddress, Unsigned32, Bits, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Counter32, Gauge32, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "IpAddress", "Unsigned32", "Bits", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Counter32", "Gauge32", "ObjectIdentity", "NotificationType")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, PYSNMP_MODULE_ID=ogStatus2, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogWebUserName=ogWebUserName, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckTable=ogCheckTable, ogCellModemTower=ogCellModemTower, ogHostUserEntry=ogHostUserEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortCTS=ogSerialPortCTS, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioEmd=ogEmdDioEmd, ogStatus2Conformance=ogStatus2Conformance, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserIndex=ogSerialUserIndex, ogRpcCounter=ogRpcCounter, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemIMSI=ogCellModemIMSI, ogAlarmUser=ogAlarmUser, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsType=ogUpsType, ogHostUserNotification=ogHostUserNotification, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioDirection=ogEmdDioDirection, ogWifiApEnabled=ogWifiApEnabled, ogAlarmType=ogAlarmType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioIndex=ogEmdDioIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemNetwork=ogCellModemNetwork, ogHostUserStartTime=ogHostUserStartTime, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogStatus2Groups=ogStatus2Groups, ogWifiApClientAp=ogWifiApClientAp, ogCheckTriggerActions=ogCheckTriggerActions, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdConnectType=ogEmdConnectType, ogWifiApIndex=ogWifiApIndex, ogAlarmState=ogAlarmState, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsIndex=ogUpsIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortDTR=ogSerialPortDTR, ogAlarmDevice=ogAlarmDevice, ogWifiApClientEntry=ogWifiApClientEntry, ogHostUserTable=ogHostUserTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletState=ogRpcOutletState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletTable=ogRpcOutletTable, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientMode=ogWifiClientMode, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemConnected=ogCellModemConnected, ogHostEntry=ogHostEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcName=ogRpcName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTable=ogEmdTable, ogNetInterfaceType=ogNetInterfaceType, ogUpsConnectType=ogUpsConnectType, ogHostPingNotification=ogHostPingNotification, ogSerialPortParity=ogSerialPortParity, ogWifiClientTable=ogWifiClientTable, ogRpcOutletTotal=ogRpcOutletTotal, ogHostServiceTable=ogHostServiceTable, ogSerialUserLabel=ogSerialUserLabel, ogRpcTable=ogRpcTable, ogWebUserIndex=ogWebUserIndex, ogHostServiceHost=ogHostServiceHost, ogAlarmCheck=ogAlarmCheck, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogNetInterfaceState=ogNetInterfaceState, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceType=ogHostServiceType, ogWifiClientCounter=ogWifiClientCounter, ogUpsNotification=ogUpsNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmSummary=ogAlarmSummary, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostUserName=ogHostUserName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserHost=ogHostUserHost, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsEntry=ogUpsEntry, ogSerialPortDCD=ogSerialPortDCD, ogCellModemVendor=ogCellModemVendor, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortIndex=ogSerialPortIndex, ogSerialUserNotification=ogSerialUserNotification, ogHostUserHostName=ogHostUserHostName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostIndex=ogHostIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogFirmwareVersion=ogFirmwareVersion, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletName=ogRpcOutletName, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureValue=ogEmdTemperatureValue, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioDescription=ogEmdDioDescription, ogAlarmInstance=ogAlarmInstance, ogRpcType=ogRpcType, ogAlarm=ogAlarm, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdEnabled=ogEmdEnabled, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortLabel=ogSerialPortLabel, ogPowerSupplyName=ogPowerSupplyName, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdHumidityName=ogEmdHumidityName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellMessageNotification=ogCellMessageNotification, ogCellModemEnabled=ogCellModemEnabled, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCustomNotification=ogCustomNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcIndex=ogRpcIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialUserPort=ogSerialUserPort, ogWifiClientTxPower=ogWifiClientTxPower, ogHostName=ogHostName, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckName=ogCheckName, ogAlarmTime=ogAlarmTime, ogUpsBatteryState=ogUpsBatteryState, ogHostIpV6Address=ogHostIpV6Address, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortTable=ogSerialPortTable, ogUpsOutputPower=ogUpsOutputPower, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemModel=ogCellModemModel, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortLogLevel=ogSerialPortLogLevel, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsState=ogUpsState, ogWifiApSsid=ogWifiApSsid, ogCellModemTable=ogCellModemTable, ogEmdDescription=ogEmdDescription, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdName=ogEmdName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogStatus2Compliance=ogStatus2Compliance, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialUserEntry=ogSerialUserEntry, ogSystem=ogSystem, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserIndex=ogHostUserIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputTruePower=ogUpsOutputTruePower, ogNetInterfaceName=ogNetInterfaceName, ogUpsName=ogUpsName, ogUpsInputFrequency=ogUpsInputFrequency, ogMibNotifications=ogMibNotifications, ogWifiClientIndex=ogWifiClientIndex, ogHostServiceEntry=ogHostServiceEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientInterface=ogWifiClientInterface, ogAlarmEventId=ogAlarmEventId, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServiceCounter=ogHostServiceCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioTable=ogEmdDioTable, ogSerialUserStartTime=ogSerialUserStartTime, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsDescription=ogUpsDescription, ogSerialSignalNotification=ogSerialSignalNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsCounter=ogUpsCounter, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceNotification=ogHostServiceNotification, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientEntry=ogWifiClientEntry, ogWebUserEntry=ogWebUserEntry, ogWebUserTable=ogWebUserTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApCounter=ogWifiApCounter, ogEmdDioType=ogEmdDioType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcEntry=ogRpcEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckType=ogCheckType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmLogTable=ogAlarmLogTable, ogEmdIndex=ogEmdIndex, ogEmdDioState=ogEmdDioState, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserName=ogSerialUserName, ogHostServicePort=ogHostServicePort, ogCellModemTemperature=ogCellModemTemperature, ogAlarmName=ogAlarmName, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcConnectType=ogRpcConnectType, ogWifiApTable=ogWifiApTable, ogCheckIndex=ogCheckIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsTable=ogUpsTable, ogCellModemApn=ogCellModemApn, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletIndex=ogRpcOutletIndex, ogStatus2=ogStatus2, ogEmdEntry=ogEmdEntry, ogCheckEntry=ogCheckEntry, ogWebUserNotification=ogWebUserNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioName=ogEmdDioName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialNumber=ogSerialNumber, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckDeviceName=ogCheckDeviceName, ogCellModemCounter=ogCellModemCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortMode=ogSerialPortMode, ogRpcDescription=ogRpcDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApInterface=ogWifiApInterface, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserTable=ogSerialUserTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmType=ogCurrentAlarmType, ogHostTable=ogHostTable)
