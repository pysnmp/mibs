...
Bits, Counter32, ObjectIdentity, Unsigned32, Integer32, Counter64, MibIdentifier, IpAddress, NotificationType, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "ObjectIdentity", "Unsigned32", "Integer32", "Counter64", "MibIdentifier", "IpAddress", "NotificationType", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckType=ogCheckType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmDevice=ogAlarmDevice, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserName=ogHostUserName, ogSerialUserEntry=ogSerialUserEntry, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogPowerSupplyEntry=ogPowerSupplyEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortParity=ogSerialPortParity, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsInputNotification=ogUpsInputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemIMSI=ogCellModemIMSI, ogUpsTemperature=ogUpsTemperature, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogStatus2Groups=ogStatus2Groups, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientTable=ogWifiApClientTable, ogMibNotifications=ogMibNotifications, ogUpsConnectType=ogUpsConnectType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmState=ogAlarmState, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcTable=ogRpcTable, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientCounter=ogWifiClientCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemEntry=ogCellModemEntry, ogEmdDescription=ogEmdDescription, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdName=ogEmdName, ogAlarmCheck=ogAlarmCheck, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostServiceNotification=ogHostServiceNotification, ogHostServiceIndex=ogHostServiceIndex, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioType=ogEmdDioType, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostUserNotification=ogHostUserNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserHostName=ogHostUserHostName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdEnabled=ogEmdEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceEntry=ogHostServiceEntry, ogHostPingNotification=ogHostPingNotification, ogEmdDioTable=ogEmdDioTable, ogUpsNotification=ogUpsNotification, ogSerialPortEntry=ogSerialPortEntry, ogSystem=ogSystem, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostEntry=ogHostEntry, ogUpsDescription=ogUpsDescription, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogStatus2Compliance=ogStatus2Compliance, ogRpcName=ogRpcName, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioState=ogEmdDioState, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialNumber=ogSerialNumber, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApFrequency=ogWifiApFrequency, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyName=ogPowerSupplyName, ogUpsIndex=ogUpsIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityIndex=ogEmdHumidityIndex, ogNetInterfaceName=ogNetInterfaceName, ogUpsCounter=ogUpsCounter, ogHostTable=ogHostTable, ogWifiApTable=ogWifiApTable, ogCellModemIndex=ogCellModemIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostIpV6Address=ogHostIpV6Address, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientTable=ogWifiClientTable, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2=ogStatus2, ogRpcConnectType=ogRpcConnectType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputPower=ogUpsOutputPower, ogCellModemTable=ogCellModemTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletState=ogRpcOutletState, ogCellModemSessionTime=ogCellModemSessionTime, ogHostServiceHost=ogHostServiceHost, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserLabel=ogSerialUserLabel, PYSNMP_MODULE_ID=ogStatus2, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApClientAp=ogWifiApClientAp, ogCellModemNetwork=ogCellModemNetwork, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientIndex=ogWifiApClientIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWebUserEntry=ogWebUserEntry, ogAlarmUser=ogAlarmUser, ogRpcOutletName=ogRpcOutletName, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortLabel=ogSerialPortLabel, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientMode=ogWifiClientMode, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsName=ogUpsName, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemApn=ogCellModemApn, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcEntry=ogRpcEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdIndex=ogEmdIndex, ogCheckIndex=ogCheckIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellDataNotification=ogCellDataNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApEntry=ogWifiApEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcInputNotification=ogRpcInputNotification, ogRpcIndex=ogRpcIndex, ogCheckEntry=ogCheckEntry, ogWifiClientEssid=ogWifiClientEssid, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortRTS=ogSerialPortRTS, ogCustomNotification=ogCustomNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsTable=ogUpsTable, ogUpsState=ogUpsState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserEntry=ogHostUserEntry, ogHostUserTable=ogHostUserTable, ogWebUserTable=ogWebUserTable, ogSerialUserName=ogSerialUserName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialUserTable=ogSerialUserTable, ogSerialPortDCD=ogSerialPortDCD, ogRpcType=ogRpcType, ogNetInterfaceType=ogNetInterfaceType, ogAlarm=ogAlarm, ogHostUserHost=ogHostUserHost, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientIndex=ogWifiClientIndex, ogRpcDescription=ogRpcDescription, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmName=ogAlarmName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortDTR=ogSerialPortDTR, ogEmdTable=ogEmdTable, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemModel=ogCellModemModel, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWebUserName=ogWebUserName, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceType=ogHostServiceType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryState=ogUpsBatteryState, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdEntry=ogEmdEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostServiceStatus=ogHostServiceStatus, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcCounter=ogRpcCounter, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortCTS=ogSerialPortCTS, ogHostIndex=ogHostIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioDirection=ogEmdDioDirection, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckTable=ogCheckTable, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioCounter=ogEmdDioCounter, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogFirmwareVersion=ogFirmwareVersion, ogHostUserIndex=ogHostUserIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApTxPower=ogWifiApTxPower, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserStartTime=ogWebUserStartTime, ogNetInterfaceState=ogNetInterfaceState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserIndex=ogSerialUserIndex, ogCellModemVendor=ogCellModemVendor, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckName=ogCheckName, ogUpsEntry=ogUpsEntry, ogAlarmLogTable=ogAlarmLogTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostName=ogHostName, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemCounter=ogCellModemCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioName=ogEmdDioName, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsHumidity=ogUpsHumidity, ogHostUserStartTime=ogHostUserStartTime, ogAlarmEventId=ogAlarmEventId, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserPort=ogSerialUserPort, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientApMac=ogWifiClientApMac, ogWebUserIndex=ogWebUserIndex, ogWifiApSsid=ogWifiApSsid, ogSerialPortMode=ogSerialPortMode, ogAlarmTime=ogAlarmTime, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServiceTable=ogHostServiceTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellTowerNotification=ogCellTowerNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioNotification=ogEmdDioNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostUserAddress=ogHostUserAddress, ogHostServicePort=ogHostServicePort, ogEmdConnectType=ogEmdConnectType, ogUpsType=ogUpsType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmInstance=ogAlarmInstance, ogCellModemTower=ogCellModemTower, ogAlarmType=ogAlarmType)
