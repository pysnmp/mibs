...
MibIdentifier, ObjectIdentity, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Integer32, ModuleIdentity, Bits, Counter32, Gauge32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectIdentity", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Integer32", "ModuleIdentity", "Bits", "Counter32", "Gauge32", "iso", "TimeTicks")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioEntry=ogEmdDioEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApFrequency=ogWifiApFrequency, ogHostUserName=ogHostUserName, ogUpsIndex=ogUpsIndex, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioName=ogEmdDioName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostServiceNotification=ogHostServiceNotification, ogSerialUserLabel=ogSerialUserLabel, ogSerialUserIndex=ogSerialUserIndex, ogAlarmEventId=ogAlarmEventId, ogEmdIndex=ogEmdIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioState=ogEmdDioState, ogWifiClientIndex=ogWifiClientIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserIndex=ogHostUserIndex, ogWebUserStartTime=ogWebUserStartTime, ogCheckType=ogCheckType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostName=ogHostName, ogRpcCounter=ogRpcCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcType=ogRpcType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdName=ogEmdName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientTable=ogWifiClientTable, ogMibNotifications=ogMibNotifications, ogCellModemIndex=ogCellModemIndex, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostServiceType=ogHostServiceType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdConnectType=ogEmdConnectType, ogCellModemTower=ogCellModemTower, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortDTR=ogSerialPortDTR, ogRpcInputNotification=ogRpcInputNotification, PYSNMP_MODULE_ID=ogStatus2, ogWifiApSsid=ogWifiApSsid, ogSerialPortEntry=ogSerialPortEntry, ogWifiApIndex=ogWifiApIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogNetInterfaceState=ogNetInterfaceState, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortDCD=ogSerialPortDCD, ogAlarmState=ogAlarmState, ogCheckDeviceName=ogCheckDeviceName, ogHostIndex=ogHostIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogStatus2Groups=ogStatus2Groups, ogWebUserNotification=ogWebUserNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmUser=ogAlarmUser, ogEmdTable=ogEmdTable, ogHostUserHost=ogHostUserHost, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsHumidity=ogUpsHumidity, ogHostIpV6Address=ogHostIpV6Address, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmSummary=ogAlarmSummary, ogSerialPortParity=ogSerialPortParity, ogCheckEntry=ogCheckEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApEntry=ogWifiApEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostTable=ogHostTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcDescription=ogRpcDescription, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcIndex=ogRpcIndex, ogHostServiceHost=ogHostServiceHost, ogWifiApTable=ogWifiApTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortLabel=ogSerialPortLabel, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDescription=ogEmdDescription, ogUpsBatteryState=ogUpsBatteryState, ogUpsConnectType=ogUpsConnectType, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortCTS=ogSerialPortCTS, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioEmd=ogEmdDioEmd, ogUpsNotification=ogUpsNotification, ogRpcEntry=ogRpcEntry, ogStatus2=ogStatus2, ogRpcConnectType=ogRpcConnectType, ogAlarmTime=ogAlarmTime, ogEmdEnabled=ogEmdEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemCounter=ogCellModemCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogWebUserIndex=ogWebUserIndex, ogAlarmLogTable=ogAlarmLogTable, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemVendor=ogCellModemVendor, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureName=ogEmdTemperatureName, ogHostPingNotification=ogHostPingNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserTable=ogHostUserTable, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemEntry=ogCellModemEntry, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortMode=ogSerialPortMode, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletNotification=ogRpcOutletNotification, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientCounter=ogWifiClientCounter, ogHostServiceCounter=ogHostServiceCounter, ogAlarmDevice=ogAlarmDevice, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsLogEnabled=ogUpsLogEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserPort=ogSerialUserPort, ogEmdDioDirection=ogEmdDioDirection, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmCheck=ogAlarmCheck, ogCheckIndex=ogCheckIndex, ogSerialUserTable=ogSerialUserTable, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityName=ogEmdHumidityName, ogCellDataNotification=ogCellDataNotification, ogCheckName=ogCheckName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsTemperature=ogUpsTemperature, ogCheckResolveActions=ogCheckResolveActions, ogUpsCounter=ogUpsCounter, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsState=ogUpsState, ogRpcOutletName=ogRpcOutletName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogPowerSupplyName=ogPowerSupplyName, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemTable=ogCellModemTable, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemApn=ogCellModemApn, ogCustomNotification=ogCustomNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemRegistered=ogCellModemRegistered, ogAlarm=ogAlarm, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientMode=ogWifiClientMode, ogSerialPortStopBits=ogSerialPortStopBits, ogFirmwareVersion=ogFirmwareVersion, ogCellModemNetwork=ogCellModemNetwork, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialUserName=ogSerialUserName, ogHostEntry=ogHostEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientApMac=ogWifiClientApMac, ogStatus2Compliance=ogStatus2Compliance, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletEntry=ogRpcOutletEntry, ogStatus2Compliances=ogStatus2Compliances, ogUpsEntry=ogUpsEntry, ogUpsType=ogUpsType, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmName=ogAlarmName, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsName=ogUpsName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioTable=ogEmdDioTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientEssid=ogWifiClientEssid, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogBasicAlarmGroup=ogBasicAlarmGroup)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmInstance=ogAlarmInstance, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletState=ogRpcOutletState, ogUpsDescription=ogUpsDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioNotification=ogEmdDioNotification, ogHostUserAddress=ogHostUserAddress, ogWebUserName=ogWebUserName, ogUpsTable=ogUpsTable, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserNotification=ogHostUserNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckTable=ogCheckTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostIpV4Address=ogHostIpV4Address, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServicePort=ogHostServicePort, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemModel=ogCellModemModel, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApCounter=ogWifiApCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogWebUserEntry=ogWebUserEntry, ogUpsOutputPower=ogUpsOutputPower, ogSerialNumber=ogSerialNumber, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientMac=ogWifiApClientMac, ogWifiApEnabled=ogWifiApEnabled, ogWifiApTxPower=ogWifiApTxPower, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcName=ogRpcName, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdEntry=ogEmdEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemIMSI=ogCellModemIMSI, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientAp=ogWifiApClientAp, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmType=ogAlarmType, ogHostUserHostName=ogHostUserHostName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsInputFrequency=ogUpsInputFrequency, ogStatus2Conformance=ogStatus2Conformance, ogWebUserTable=ogWebUserTable, ogHostServiceTable=ogHostServiceTable, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioType=ogEmdDioType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcTable=ogRpcTable, ogSystem=ogSystem)
