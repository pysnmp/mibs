...
Integer32, iso, NotificationType, ModuleIdentity, Counter32, Bits, TimeTicks, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "NotificationType", "ModuleIdentity", "Counter32", "Bits", "TimeTicks", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "ObjectIdentity", "Unsigned32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellTowerNotification=ogCellTowerNotification, ogCellModemEnabled=ogCellModemEnabled, ogRpcTable=ogRpcTable, ogCellModemTable=ogCellModemTable, ogSerialPortDataBits=ogSerialPortDataBits, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserPort=ogSerialUserPort, ogWifiApClientRssi=ogWifiApClientRssi, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarm=ogAlarm, ogWifiApClientAp=ogWifiApClientAp, ogHostServicePort=ogHostServicePort, ogSerialPortCTS=ogSerialPortCTS, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityDescription=ogEmdHumidityDescription, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmType=ogAlarmType, ogCellMessageNotification=ogCellMessageNotification, ogAlarmSummary=ogAlarmSummary, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcType=ogRpcType, ogRpcDescription=ogRpcDescription, ogCheckName=ogCheckName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckIndex=ogCheckIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdEnabled=ogEmdEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogHostIpV4Address=ogHostIpV4Address, ogEmdTemperatureTable=ogEmdTemperatureTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemCounter=ogCellModemCounter, ogUpsTemperature=ogUpsTemperature, ogStatus2Conformance=ogStatus2Conformance, ogRpcConnectType=ogRpcConnectType, ogAlarmTime=ogAlarmTime, ogWifiApEntry=ogWifiApEntry, ogEmdDioName=ogEmdDioName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortEntry=ogSerialPortEntry, ogCheckTable=ogCheckTable, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcName=ogRpcName, ogUpsHumidity=ogUpsHumidity, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialUserName=ogSerialUserName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserNotification=ogHostUserNotification, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmTime=ogCurrentAlarmTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserAddress=ogHostUserAddress, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckEntry=ogCheckEntry, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsState=ogUpsState, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientMode=ogWifiClientMode, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemTower=ogCellModemTower, ogRpcCounter=ogRpcCounter, ogRpcOutletTable=ogRpcOutletTable, ogHostServiceNotification=ogHostServiceNotification, ogMibNotifications=ogMibNotifications, ogRpcOutletName=ogRpcOutletName, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserTable=ogWebUserTable, ogSerialPortParity=ogSerialPortParity, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemIndex=ogCellModemIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioNotification=ogEmdDioNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserStartTime=ogHostUserStartTime, ogStatus2Compliances=ogStatus2Compliances, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckDeviceName=ogCheckDeviceName, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemVendor=ogCellModemVendor, ogHostServiceTable=ogHostServiceTable, ogEmdEntry=ogEmdEntry, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmEventId=ogAlarmEventId, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServiceEntry=ogHostServiceEntry, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityName=ogEmdHumidityName, ogEmdDioTable=ogEmdDioTable, ogEmdHumidityValue=ogEmdHumidityValue, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletState=ogRpcOutletState, ogEmdDioType=ogEmdDioType, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioEmd=ogEmdDioEmd, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientEssid=ogWifiClientEssid, ogHostServiceHost=ogHostServiceHost, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcInputCurrent=ogRpcInputCurrent, ogHostPingNotification=ogHostPingNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioState=ogEmdDioState, ogCellApnNotification=ogCellApnNotification, ogEmdDescription=ogEmdDescription, ogWebUserName=ogWebUserName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortIndex=ogSerialPortIndex, ogSerialNumber=ogSerialNumber, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsType=ogUpsType, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialUserNotification=ogSerialUserNotification, ogAlarmCheck=ogAlarmCheck, ogHostUserTable=ogHostUserTable, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostEntry=ogHostEntry, ogAlarmDevice=ogAlarmDevice, ogUpsNotification=ogUpsNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdIndex=ogEmdIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcInputNotification=ogRpcInputNotification, ogCustomNotification=ogCustomNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcIndex=ogRpcIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmLogIndex=ogAlarmLogIndex, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortTable=ogSerialPortTable, ogUpsDescription=ogUpsDescription, ogAlarmUser=ogAlarmUser, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostName=ogHostName, ogUpsName=ogUpsName, ogEmdDioIndex=ogEmdDioIndex, ogStatus2Compliance=ogStatus2Compliance, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcEntry=ogRpcEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogStatus2=ogStatus2, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioEntry=ogEmdDioEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogNetInterfaceType=ogNetInterfaceType, ogWifiApInterface=ogWifiApInterface, ogHostServiceType=ogHostServiceType, ogSerialUserTable=ogSerialUserTable, ogUpsIndex=ogUpsIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmInstance=ogAlarmInstance, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostTable=ogHostTable, ogWifiClientApMac=ogWifiClientApMac)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogFirmwareVersion=ogFirmwareVersion, ogCellModemModel=ogCellModemModel, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmName=ogAlarmName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogSystem=ogSystem, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortMode=ogSerialPortMode, ogEmdTable=ogEmdTable, ogCellModemApn=ogCellModemApn, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsLogEnabled=ogUpsLogEnabled, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApTxPower=ogWifiApTxPower, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsCounter=ogUpsCounter, ogUpsEntry=ogUpsEntry, ogCheckType=ogCheckType, PYSNMP_MODULE_ID=ogStatus2, ogCellModemConnected=ogCellModemConnected, ogHostUserName=ogHostUserName, ogHostIndex=ogHostIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserHostName=ogHostUserHostName, ogSerialPortLabel=ogSerialPortLabel, ogHostUserIndex=ogHostUserIndex, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsTable=ogUpsTable, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserStartTime=ogWebUserStartTime, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWebUserIndex=ogWebUserIndex, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsConnectType=ogUpsConnectType, ogSerialPortDTR=ogSerialPortDTR, ogHostUserHost=ogHostUserHost, ogCellDataNotification=ogCellDataNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialUserLabel=ogSerialUserLabel, ogCellModemEntry=ogCellModemEntry, ogWifiApCounter=ogWifiApCounter, ogWifiApTable=ogWifiApTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogStatus2Groups=ogStatus2Groups, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdName=ogEmdName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWebUserEntry=ogWebUserEntry, ogAlarmState=ogAlarmState, ogCellModem4gRssi=ogCellModem4gRssi)
