...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserHostName=ogHostUserHostName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsCounter=ogUpsCounter, ogHostServiceIndex=ogHostServiceIndex, ogCellModemTable=ogCellModemTable, ogWifiApFrequency=ogWifiApFrequency, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioCounter=ogEmdDioCounter, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogStatus2Compliances=ogStatus2Compliances, ogWifiApIndex=ogWifiApIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckName=ogCheckName, ogRpcOutputNotification=ogRpcOutputNotification, ogFirmwareVersion=ogFirmwareVersion, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemTower=ogCellModemTower, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioEntry=ogEmdDioEntry, ogAlarmInstance=ogAlarmInstance, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApEntry=ogWifiApEntry, ogCellModemIndex=ogCellModemIndex, ogCellModemEntry=ogCellModemEntry, ogAlarmState=ogAlarmState, ogHostIndex=ogHostIndex, ogHostPingNotification=ogHostPingNotification, ogHostServiceStatus=ogHostServiceStatus, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcEntry=ogRpcEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogNetInterfaceState=ogNetInterfaceState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioState=ogEmdDioState, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialUserEntry=ogSerialUserEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortMode=ogSerialPortMode, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmType=ogAlarmType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientRssi=ogWifiClientRssi, ogWebUserIndex=ogWebUserIndex, ogHostServiceType=ogHostServiceType, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientCounter=ogWifiClientCounter, ogHostServiceCounter=ogHostServiceCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApInterface=ogWifiApInterface, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsTemperature=ogUpsTemperature, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSystem=ogSystem, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdIndex=ogEmdIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioType=ogEmdDioType, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWebUserName=ogWebUserName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApSsid=ogWifiApSsid, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortDCD=ogSerialPortDCD, ogStatus2=ogStatus2, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemEnabled=ogCellModemEnabled, ogHostUserHost=ogHostUserHost, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModem3gRssi=ogCellModem3gRssi, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckTable=ogCheckTable, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserTable=ogSerialUserTable, ogWifiClientEnabled=ogWifiClientEnabled, ogHostEntry=ogHostEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdConnectType=ogEmdConnectType, ogWebUserTable=ogWebUserTable, ogHostServiceHost=ogHostServiceHost, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDSR=ogSerialPortDSR, ogAlarmUser=ogAlarmUser, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientAp=ogWifiApClientAp, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsDescription=ogUpsDescription, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialUserPort=ogSerialUserPort, ogRpcIndex=ogRpcIndex, ogWifiApTxPower=ogWifiApTxPower, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDescription=ogEmdDescription, ogWifiClientBitRate=ogWifiClientBitRate, ogMibNotifications=ogMibNotifications, ogRpcCounter=ogRpcCounter, ogWifiClientEntry=ogWifiClientEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmDevice=ogAlarmDevice, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcName=ogRpcName, ogEmdHumidityTable=ogEmdHumidityTable, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortIndex=ogSerialPortIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsTable=ogUpsTable, ogAlarmName=ogAlarmName, ogCheckIndex=ogCheckIndex, ogHostTable=ogHostTable, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortEntry=ogSerialPortEntry, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientApMac=ogWifiClientApMac, ogEmdDioEmd=ogEmdDioEmd, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemNetwork=ogCellModemNetwork, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcType=ogRpcType, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmCheck=ogAlarmCheck, ogHostIpV4Address=ogHostIpV4Address, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsInputNotification=ogUpsInputNotification, ogWifiApCounter=ogWifiApCounter, ogEmdDioName=ogEmdDioName, ogHostServicePort=ogHostServicePort, ogCheckEntry=ogCheckEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogStatus2Compliance=ogStatus2Compliance, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientTable=ogWifiClientTable, ogRpcDescription=ogRpcDescription, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellDataNotification=ogCellDataNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdEntry=ogEmdEntry, ogCellApnNotification=ogCellApnNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarm=ogAlarm, ogStatus2Groups=ogStatus2Groups, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTable=ogEmdTable, ogHostUserEntry=ogHostUserEntry, ogSerialNumber=ogSerialNumber, ogCheckDeviceName=ogCheckDeviceName, ogCellModemModel=ogCellModemModel, ogWebUserEntry=ogWebUserEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsIndex=ogUpsIndex, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsEntry=ogUpsEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortParity=ogSerialPortParity, ogHostUserIndex=ogHostUserIndex, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserLabel=ogSerialUserLabel, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemRegistered=ogCellModemRegistered, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsType=ogUpsType, ogAlarmTime=ogAlarmTime, ogHostUserNotification=ogHostUserNotification, ogHostUserAddress=ogHostUserAddress, ogPowerSupplyIndex=ogPowerSupplyIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApEnabled=ogWifiApEnabled, ogSerialPortDataBits=ogSerialPortDataBits, ogHostUserStartTime=ogHostUserStartTime, PYSNMP_MODULE_ID=ogStatus2, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientMac=ogWifiApClientMac, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioNotification=ogEmdDioNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialUserName=ogSerialUserName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioDescription=ogEmdDioDescription, ogCellModemCounter=ogCellModemCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityName=ogEmdHumidityName, ogEmdEnabled=ogEmdEnabled, ogUpsHumidity=ogUpsHumidity, ogCustomNotification=ogCustomNotification, ogWifiApTable=ogWifiApTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortTable=ogSerialPortTable, ogUpsState=ogUpsState, ogHostUserName=ogHostUserName, ogHostServiceTable=ogHostServiceTable, ogHostName=ogHostName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsNotification=ogUpsNotification, ogRpcTable=ogRpcTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemVendor=ogCellModemVendor, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdName=ogEmdName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostUserTable=ogHostUserTable, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsName=ogUpsName, ogRpcConnectType=ogRpcConnectType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientEssid=ogWifiClientEssid, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServiceNotification=ogHostServiceNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientMode=ogWifiClientMode, ogCellModemApn=ogCellModemApn, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWebUserStartTime=ogWebUserStartTime, ogCheckType=ogCheckType, ogUpsConnectType=ogUpsConnectType, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsInputFrequency=ogUpsInputFrequency)
