...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, TimeTicks, IpAddress, NotificationType, Unsigned32, Integer32, Bits, Counter64, iso, ModuleIdentity, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "TimeTicks", "IpAddress", "NotificationType", "Unsigned32", "Integer32", "Bits", "Counter64", "iso", "ModuleIdentity", "MibIdentifier")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceTable=ogHostServiceTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdLogEnabled=ogEmdLogEnabled, ogHostUserName=ogHostUserName, ogUpsLogEnabled=ogUpsLogEnabled, ogNetInterfaceState=ogNetInterfaceState, ogAlarmEventId=ogAlarmEventId, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarm=ogAlarm, ogEmdTable=ogEmdTable, ogUpsTemperature=ogUpsTemperature, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdIndex=ogEmdIndex, ogAlarmName=ogAlarmName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialUserNotification=ogSerialUserNotification, ogCellModemTable=ogCellModemTable, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogHostName=ogHostName, ogAlarmLogTable=ogAlarmLogTable, ogCellModemIMSI=ogCellModemIMSI, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioNotification=ogEmdDioNotification, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserName=ogSerialUserName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletState=ogRpcOutletState, ogWifiClientInterface=ogWifiClientInterface, ogUpsType=ogUpsType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogStatus2Conformance=ogStatus2Conformance, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientApMac=ogWifiClientApMac, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApCounter=ogWifiApCounter, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserPort=ogSerialUserPort, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioDescription=ogEmdDioDescription, ogRpcIndex=ogRpcIndex, ogCheckIndex=ogCheckIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckTable=ogCheckTable, ogHostUserTable=ogHostUserTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserAddress=ogHostUserAddress, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioState=ogEmdDioState, ogSerialUserLabel=ogSerialUserLabel, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostTable=ogHostTable, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientEntry=ogWifiClientEntry, ogWebUserNotification=ogWebUserNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsConnectType=ogUpsConnectType, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletTable=ogRpcOutletTable, ogRpcDescription=ogRpcDescription, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdConnectType=ogEmdConnectType, ogFirmwareVersion=ogFirmwareVersion, ogStatus2Compliances=ogStatus2Compliances, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioEmd=ogEmdDioEmd, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletFrequency=ogRpcOutletFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApSsid=ogWifiApSsid, ogEmdDescription=ogEmdDescription, ogEmdHumidityIndex=ogEmdHumidityIndex, ogAlarmType=ogAlarmType, ogUpsName=ogUpsName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostIndex=ogHostIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmInstance=ogAlarmInstance, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSystem=ogSystem, ogCurrentAlarmName=ogCurrentAlarmName, ogCellTowerNotification=ogCellTowerNotification, ogCellModemVendor=ogCellModemVendor, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceIndex=ogHostServiceIndex, ogCellModemRegistered=ogCellModemRegistered, ogHostEntry=ogHostEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdDioType=ogEmdDioType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsInputNotification=ogUpsInputNotification, ogStatus2=ogStatus2, ogHostServicePort=ogHostServicePort, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcConnectType=ogRpcConnectType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcTable=ogRpcTable, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryState=ogUpsBatteryState, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientTable=ogWifiApClientTable, ogCellModemModel=ogCellModemModel, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortLabel=ogSerialPortLabel, ogUpsNotification=ogUpsNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWebUserTable=ogWebUserTable, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortMode=ogSerialPortMode, ogAlarmState=ogAlarmState, ogSerialPortDataBits=ogSerialPortDataBits, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemConnected=ogCellModemConnected, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceEntry=ogHostServiceEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemCounter=ogCellModemCounter, ogHostServiceType=ogHostServiceType, ogCheckResolveActions=ogCheckResolveActions, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsHumidity=ogUpsHumidity, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserTable=ogSerialUserTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckType=ogCheckType, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckName=ogCheckName, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogMibNotifications=ogMibNotifications, ogWifiApIndex=ogWifiApIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApEnabled=ogWifiApEnabled, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserIndex=ogWebUserIndex, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogCustomNotification=ogCustomNotification, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientAp=ogWifiApClientAp, ogAlarmTime=ogAlarmTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceHost=ogHostServiceHost, ogUpsDescription=ogUpsDescription, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsTable=ogUpsTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortDTR=ogSerialPortDTR, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmSummary=ogAlarmSummary, ogWebUserName=ogWebUserName, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientMac=ogWifiApClientMac, ogStatus2Groups=ogStatus2Groups, ogWifiApInterface=ogWifiApInterface, ogEmdEntry=ogEmdEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemTemperature=ogCellModemTemperature, ogRpcType=ogRpcType, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortRTS=ogSerialPortRTS, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialNumber=ogSerialNumber, ogUpsEntry=ogUpsEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientTable=ogWifiClientTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemApn=ogCellModemApn, ogWifiApEntry=ogWifiApEntry, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckEntry=ogCheckEntry, ogAlarmCheck=ogAlarmCheck, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdName=ogEmdName, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsCounter=ogUpsCounter, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmUser=ogAlarmUser, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortDCD=ogSerialPortDCD, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceCounter=ogHostServiceCounter, ogCellModemEntry=ogCellModemEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortTable=ogSerialPortTable, ogEmdEnabled=ogEmdEnabled, ogCellModemTower=ogCellModemTower, ogSerialPortParity=ogSerialPortParity, ogEmdDioName=ogEmdDioName, ogHostPingNotification=ogHostPingNotification, ogHostUserStartTime=ogHostUserStartTime, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientEssid=ogWifiClientEssid, ogSerialPatternNotification=ogSerialPatternNotification, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsIndex=ogUpsIndex, ogRpcEntry=ogRpcEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcCounter=ogRpcCounter, ogCellDataNotification=ogCellDataNotification, ogSerialUserIndex=ogSerialUserIndex, ogUpsState=ogUpsState, ogWebUserEntry=ogWebUserEntry, ogRpcName=ogRpcName, ogWifiClientMode=ogWifiClientMode, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserHostName=ogHostUserHostName, ogHostUserHost=ogHostUserHost, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogStatus2Compliance=ogStatus2Compliance, ogWifiApTable=ogWifiApTable, ogRpcOutletName=ogRpcOutletName, ogSerialPortDSR=ogSerialPortDSR, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientIndex=ogWifiApClientIndex)
