...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserName=ogSerialUserName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientMac=ogWifiApClientMac, ogHostUserEntry=ogHostUserEntry, ogUpsName=ogUpsName, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcName=ogRpcName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcCounter=ogRpcCounter, ogWifiApSsid=ogWifiApSsid, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdEntry=ogEmdEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdTable=ogEmdTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputNotification=ogUpsInputNotification, ogHostIpV4Address=ogHostIpV4Address, ogUpsType=ogUpsType, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserSourcePort=ogWebUserSourcePort, ogMibNotifications=ogMibNotifications, ogSerialPortDSR=ogSerialPortDSR, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortTable=ogSerialPortTable, ogRpcOutletName=ogRpcOutletName, ogCellModemTower=ogCellModemTower, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemModel=ogCellModemModel, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryState=ogUpsBatteryState, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckResolveActions=ogCheckResolveActions, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsEntry=ogUpsEntry, ogEmdDioName=ogEmdDioName, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortIndex=ogSerialPortIndex, ogAlarmTime=ogAlarmTime, ogHostPingNotification=ogHostPingNotification, ogCellModemTable=ogCellModemTable, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletTable=ogRpcOutletTable, ogSerialUserPort=ogSerialUserPort, ogAlarmInstance=ogAlarmInstance, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmState=ogAlarmState, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsIndex=ogUpsIndex, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostServiceStatus=ogHostServiceStatus, ogHostServiceHost=ogHostServiceHost, ogCellModemApn=ogCellModemApn, ogWifiClientRssi=ogWifiClientRssi, ogUpsTemperature=ogUpsTemperature, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioNotification=ogEmdDioNotification, ogStatus2Groups=ogStatus2Groups, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmType=ogCurrentAlarmType, ogWebUserNotification=ogWebUserNotification, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortMode=ogSerialPortMode, ogEmdDioType=ogEmdDioType, ogHostEntry=ogHostEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemNetwork=ogCellModemNetwork, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortEntry=ogSerialPortEntry, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServicePort=ogHostServicePort, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientTable=ogWifiClientTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcEntry=ogRpcEntry, PYSNMP_MODULE_ID=ogStatus2, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceType=ogHostServiceType, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostIndex=ogHostIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmUser=ogAlarmUser, ogHostUserName=ogHostUserName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdHumidityName=ogEmdHumidityName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsDescription=ogUpsDescription, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckType=ogCheckType, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortSpeed=ogSerialPortSpeed, ogStatus2Compliances=ogStatus2Compliances, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceIndex=ogHostServiceIndex, ogWebUserIndex=ogWebUserIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsCounter=ogUpsCounter, ogEmdDioEmd=ogEmdDioEmd, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApEnabled=ogWifiApEnabled, ogCellModemEnabled=ogCellModemEnabled, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientApMac=ogWifiClientApMac, ogUpsHumidity=ogUpsHumidity, ogCheckTable=ogCheckTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserHost=ogHostUserHost, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioDescription=ogEmdDioDescription, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmSummary=ogAlarmSummary, ogCheckName=ogCheckName, ogWebUserEntry=ogWebUserEntry, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientTable=ogWifiApClientTable, ogUpsNotification=ogUpsNotification, ogWifiApCounter=ogWifiApCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogStatus2=ogStatus2, ogRpcConnectType=ogRpcConnectType, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemSessionTime=ogCellModemSessionTime, ogSystem=ogSystem, ogRpcTable=ogRpcTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserTable=ogHostUserTable, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellMessageNotification=ogCellMessageNotification, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogNetInterfaceState=ogNetInterfaceState, ogHostServiceTable=ogHostServiceTable, ogEmdDioTable=ogEmdDioTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmLogTable=ogAlarmLogTable, ogAlarmName=ogAlarmName, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioState=ogEmdDioState, ogAlarmDevice=ogAlarmDevice, ogEmdDioIndex=ogEmdDioIndex, ogHostName=ogHostName, ogCellSignalNotification=ogCellSignalNotification, ogWifiApFrequency=ogWifiApFrequency, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApTable=ogWifiApTable, ogAlarmType=ogAlarmType, ogSerialPortDataBits=ogSerialPortDataBits, ogHostUserNotification=ogHostUserNotification, ogWebUserTable=ogWebUserTable, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserAddress=ogHostUserAddress, ogUpsOutputPower=ogUpsOutputPower, ogCellModemConnected=ogCellModemConnected, ogCustomNotification=ogCustomNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcType=ogRpcType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceName=ogCheckDeviceName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioCounter=ogEmdDioCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckIndex=ogCheckIndex, ogCurrentAlarmTime=ogCurrentAlarmTime)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApTxPower=ogWifiApTxPower, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdEnabled=ogEmdEnabled, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdName=ogEmdName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogCellNetworkNotification=ogCellNetworkNotification, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDescription=ogEmdDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialNumber=ogSerialNumber, ogEmdConnectType=ogEmdConnectType, ogCellModemVendor=ogCellModemVendor, ogWifiApIndex=ogWifiApIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemIndex=ogCellModemIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortRTS=ogSerialPortRTS, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcDescription=ogRpcDescription, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsTable=ogUpsTable, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogHostUserIndex=ogHostUserIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientIndex=ogWifiClientIndex, ogCheckEntry=ogCheckEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortCTS=ogSerialPortCTS, ogCellDataNotification=ogCellDataNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortBreaks=ogSerialPortBreaks, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsState=ogUpsState, ogRpcIndex=ogRpcIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortParity=ogSerialPortParity, ogWebUserName=ogWebUserName, ogHostTable=ogHostTable, ogRpcOutletState=ogRpcOutletState, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarm=ogAlarm, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientMode=ogWifiClientMode, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdIndex=ogEmdIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsConnectType=ogUpsConnectType)
