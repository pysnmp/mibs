...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmUser=ogAlarmUser, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientMac=ogWifiApClientMac, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserHost=ogHostUserHost, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckResolveActions=ogCheckResolveActions, ogRpcType=ogRpcType, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApEntry=ogWifiApEntry, ogHostName=ogHostName, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortDSR=ogSerialPortDSR, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsHumidity=ogUpsHumidity, ogUpsName=ogUpsName, ogWebUserEntry=ogWebUserEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityName=ogEmdHumidityName, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialUserNotification=ogSerialUserNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTable=ogEmdTable, ogNetInterfaceType=ogNetInterfaceType, ogEmdDescription=ogEmdDescription, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemRegistered=ogCellModemRegistered, ogWifiApTable=ogWifiApTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserName=ogSerialUserName, ogWifiApCounter=ogWifiApCounter, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioName=ogEmdDioName, ogUpsEntry=ogUpsEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortTable=ogSerialPortTable, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserName=ogWebUserName, ogCheckName=ogCheckName, ogCellModemModel=ogCellModemModel, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemApn=ogCellModemApn, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemNetwork=ogCellModemNetwork, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientInterface=ogWifiClientInterface, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsIndex=ogUpsIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmEventId=ogAlarmEventId, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogPowerSupplyName=ogPowerSupplyName, ogHostTable=ogHostTable, ogSerialPortDCD=ogSerialPortDCD, ogAlarmName=ogAlarmName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcInputNotification=ogRpcInputNotification, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceTable=ogHostServiceTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmDevice=ogAlarmDevice, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcDescription=ogRpcDescription, ogUpsCounter=ogUpsCounter, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApFrequency=ogWifiApFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortEntry=ogSerialPortEntry, PYSNMP_MODULE_ID=ogStatus2, ogAlarm=ogAlarm, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientTable=ogWifiApClientTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceType=ogHostServiceType, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcIndex=ogRpcIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsBatteryState=ogUpsBatteryState, ogSystem=ogSystem, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmTime=ogAlarmTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdIndex=ogEmdIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioState=ogEmdDioState, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckEntry=ogCheckEntry, ogCellModemEntry=ogCellModemEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdName=ogEmdName, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserTable=ogHostUserTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApSsid=ogWifiApSsid, ogHostIndex=ogHostIndex, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemTemperature=ogCellModemTemperature, ogHostEntry=ogHostEntry, ogSerialPortLabel=ogSerialPortLabel, ogAlarmCheck=ogAlarmCheck, ogEmdDioNotification=ogEmdDioNotification, ogCheckIndex=ogCheckIndex, ogAlarmState=ogAlarmState, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApInterface=ogWifiApInterface, ogRpcConnectType=ogRpcConnectType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellMessageNotification=ogCellMessageNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientTxPower=ogWifiClientTxPower, ogMibNotifications=ogMibNotifications, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientMode=ogWifiClientMode, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortCTS=ogSerialPortCTS, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckType=ogCheckType, ogEmdDioDirection=ogEmdDioDirection, ogSerialUserStartTime=ogSerialUserStartTime, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdConnectType=ogEmdConnectType, ogHostServiceHost=ogHostServiceHost, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmInstance=ogAlarmInstance, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletState=ogRpcOutletState, ogCellApnNotification=ogCellApnNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsDescription=ogUpsDescription, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellModemIndex=ogCellModemIndex, ogEmdEnabled=ogEmdEnabled, ogCellModemIMSI=ogCellModemIMSI, ogWebUserNotification=ogWebUserNotification, ogHostServiceEntry=ogHostServiceEntry, ogSerialUserPort=ogSerialUserPort, ogRpcCounter=ogRpcCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmSummary=ogAlarmSummary, ogCellModemTable=ogCellModemTable, ogSerialNumber=ogSerialNumber, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostUserAddress=ogHostUserAddress, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientIndex=ogWifiClientIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemVendor=ogCellModemVendor, ogHostServicePort=ogHostServicePort, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsTemperature=ogUpsTemperature, ogEmdDioType=ogEmdDioType, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsType=ogUpsType, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortParity=ogSerialPortParity, ogSerialUserTable=ogSerialUserTable, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmType=ogAlarmType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientCounter=ogWifiClientCounter, ogHostUserName=ogHostUserName, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsState=ogUpsState)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletName=ogRpcOutletName, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioDescription=ogEmdDioDescription, ogWebUserTable=ogWebUserTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcName=ogRpcName, ogUpsTable=ogUpsTable, ogEmdDioTable=ogEmdDioTable, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemTower=ogCellModemTower, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdEntry=ogEmdEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcTable=ogRpcTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCustomNotification=ogCustomNotification, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdLogEnabled=ogEmdLogEnabled, ogHostPingNotification=ogHostPingNotification, ogSerialPortDTR=ogSerialPortDTR, ogUpsConnectType=ogUpsConnectType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWebUserIndex=ogWebUserIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckDeviceName=ogCheckDeviceName, ogHostUserHostName=ogHostUserHostName, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServiceCounter=ogHostServiceCounter, ogWifiApEnabled=ogWifiApEnabled, ogStatus2Compliances=ogStatus2Compliances, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceState=ogNetInterfaceState, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioCounter=ogEmdDioCounter, ogHostUserIndex=ogHostUserIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostUserEntry=ogHostUserEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsNotification=ogUpsNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcEntry=ogRpcEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortIndex=ogSerialPortIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientTable=ogWifiClientTable, ogHostUserStartTime=ogHostUserStartTime, ogCheckTable=ogCheckTable, ogStatus2=ogStatus2, ogUpsBatteryNotification=ogUpsBatteryNotification)
