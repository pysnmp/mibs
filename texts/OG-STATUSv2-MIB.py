...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostUserHost=ogHostUserHost, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsInputNotification=ogUpsInputNotification, ogWifiApTxPower=ogWifiApTxPower, ogCellModemTower=ogCellModemTower, ogHostServiceTable=ogHostServiceTable, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientEssid=ogWifiClientEssid, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsName=ogUpsName, ogCellModemModel=ogCellModemModel, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemEnabled=ogCellModemEnabled, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientApMac=ogWifiClientApMac, ogNetInterfaceName=ogNetInterfaceName, ogHostServiceIndex=ogHostServiceIndex, PYSNMP_MODULE_ID=ogStatus2, ogWifiApSsid=ogWifiApSsid, ogSerialUserEntry=ogSerialUserEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDescription=ogEmdDescription, ogCheckDeviceTable=ogCheckDeviceTable, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserNotification=ogHostUserNotification, ogHostEntry=ogHostEntry, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioEmd=ogEmdDioEmd, ogRpcInputNotification=ogRpcInputNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsTable=ogUpsTable, ogWifiClientTable=ogWifiClientTable, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioTable=ogEmdDioTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemEntry=ogCellModemEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmName=ogAlarmName, ogAlarmCheck=ogAlarmCheck, ogCustomNotification=ogCustomNotification, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckEntry=ogCheckEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServiceStatus=ogHostServiceStatus, ogHostUserEntry=ogHostUserEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostPingNotification=ogHostPingNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemConnected=ogCellModemConnected, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserHostName=ogHostUserHostName, ogEmdIndex=ogEmdIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialUserStartTime=ogSerialUserStartTime, ogStatus2Compliances=ogStatus2Compliances, ogCellModemTemperature=ogCellModemTemperature, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmEventId=ogAlarmEventId, ogRpcName=ogRpcName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApCounter=ogWifiApCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostName=ogHostName, ogWifiClientTxPower=ogWifiClientTxPower, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsCounter=ogUpsCounter, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientTable=ogWifiApClientTable, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemApn=ogCellModemApn, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcEntry=ogRpcEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRssi=ogWifiClientRssi, ogEmdDioDirection=ogEmdDioDirection, ogSerialUserIndex=ogSerialUserIndex, ogCheckName=ogCheckName, ogRpcOutletRpc=ogRpcOutletRpc, ogHostIpV6Address=ogHostIpV6Address, ogStatus2Conformance=ogStatus2Conformance, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmTime=ogAlarmTime, ogUpsNotification=ogUpsNotification, ogSerialUserLabel=ogSerialUserLabel, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioDescription=ogEmdDioDescription, ogHostTable=ogHostTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdConnectType=ogEmdConnectType, ogWifiApInterface=ogWifiApInterface, ogSerialNumber=ogSerialNumber, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletState=ogRpcOutletState, ogSerialPortDTR=ogSerialPortDTR, ogHostUserIndex=ogHostUserIndex, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdEntry=ogEmdEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcCounter=ogRpcCounter, ogEmdTable=ogEmdTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityValue=ogEmdHumidityValue, ogMibNotifications=ogMibNotifications, ogRpcDescription=ogRpcDescription, ogEmdDioNotification=ogEmdDioNotification, ogCellApnNotification=ogCellApnNotification, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioName=ogEmdDioName, ogAlarm=ogAlarm, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostServicePort=ogHostServicePort, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsConnectType=ogUpsConnectType, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientEntry=ogWifiClientEntry, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialUserName=ogSerialUserName, ogCheckTriggerActions=ogCheckTriggerActions, ogNetInterfaceState=ogNetInterfaceState, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWebUserStartTime=ogWebUserStartTime, ogHostIndex=ogHostIndex, ogWebUserName=ogWebUserName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioState=ogEmdDioState, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsIndex=ogUpsIndex, ogAlarmState=ogAlarmState, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmType=ogAlarmType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostUserAddress=ogHostUserAddress, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmLogIndex=ogAlarmLogIndex, ogHostUserName=ogHostUserName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioEntry=ogEmdDioEntry, ogStatus2=ogStatus2, ogEmdName=ogEmdName, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientCounter=ogWifiClientCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellDataNotification=ogCellDataNotification, ogSerialUserPort=ogSerialUserPort, ogCellModemTable=ogCellModemTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsState=ogUpsState, ogWebUserEntry=ogWebUserEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortMode=ogSerialPortMode, ogHostServiceType=ogHostServiceType, ogHostUserTable=ogHostUserTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsType=ogUpsType, ogRpcConnectType=ogRpcConnectType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortLabel=ogSerialPortLabel, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioType=ogEmdDioType, ogUpsTemperature=ogUpsTemperature, ogWifiApClientAp=ogWifiApClientAp, ogAlarmUser=ogAlarmUser, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWebUserNotification=ogWebUserNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsEntry=ogUpsEntry, ogCellModemVendor=ogCellModemVendor, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmType=ogCurrentAlarmType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceNotification=ogHostServiceNotification, ogSystem=ogSystem, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmDevice=ogAlarmDevice, ogRpcIndex=ogRpcIndex, ogHostServiceHost=ogHostServiceHost, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioCounter=ogEmdDioCounter, ogCellModemNetwork=ogCellModemNetwork, ogWifiApTable=ogWifiApTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletTable=ogRpcOutletTable, ogEmdEnabled=ogEmdEnabled, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortCTS=ogSerialPortCTS, ogCellModemSessionTime=ogCellModemSessionTime, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcType=ogRpcType, ogUpsDescription=ogUpsDescription, ogUpsHumidity=ogUpsHumidity, ogSerialPortIndex=ogSerialPortIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcTable=ogRpcTable, ogCellMessageNotification=ogCellMessageNotification, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApEntry=ogWifiApEntry, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserStartTime=ogHostUserStartTime, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletTotal=ogRpcOutletTotal, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortStopBits=ogSerialPortStopBits, ogPowerSupplyTable=ogPowerSupplyTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostServiceCounter=ogHostServiceCounter, ogWifiApEnabled=ogWifiApEnabled, ogAlarmLogTable=ogAlarmLogTable, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckIndex=ogCheckIndex, ogStatus2Groups=ogStatus2Groups, ogSerialPortRTS=ogSerialPortRTS, ogCheckTable=ogCheckTable, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientMode=ogWifiClientMode, ogCheckType=ogCheckType)
