...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmUser=ogAlarmUser, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialUserName=ogSerialUserName, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemIndex=ogCellModemIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsName=ogUpsName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmTime=ogAlarmTime, ogHostIndex=ogHostIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsConnectType=ogUpsConnectType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortCTS=ogSerialPortCTS, ogWebUserSourcePort=ogWebUserSourcePort, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmName=ogAlarmName, ogHostIpV6Address=ogHostIpV6Address, ogEmdName=ogEmdName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckIndex=ogCheckIndex, ogHostServiceTable=ogHostServiceTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellModemVendor=ogCellModemVendor, ogWifiApFrequency=ogWifiApFrequency, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogStatus2Compliances=ogStatus2Compliances, ogCheckEntry=ogCheckEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApCounter=ogWifiApCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyName=ogPowerSupplyName, ogCellModemModel=ogCellModemModel, ogHostUserAddress=ogHostUserAddress, ogWifiApTxPower=ogWifiApTxPower, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostTable=ogHostTable, ogHostUserEntry=ogHostUserEntry, ogHostEntry=ogHostEntry, ogAlarmSummary=ogAlarmSummary, ogEmdDioName=ogEmdDioName, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletName=ogRpcOutletName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcType=ogRpcType, ogAlarmLogIndex=ogAlarmLogIndex, ogStatus2=ogStatus2, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsIndex=ogUpsIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientTable=ogWifiApClientTable, ogEmdConnectType=ogEmdConnectType, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcEntry=ogRpcEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogNetInterfaceType=ogNetInterfaceType, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCustomNotification=ogCustomNotification, ogMibNotifications=ogMibNotifications, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogWebUserTable=ogWebUserTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostServiceHost=ogHostServiceHost, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceCounter=ogHostServiceCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemEntry=ogCellModemEntry, ogAlarmLogTable=ogAlarmLogTable, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserTable=ogSerialUserTable, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsNotification=ogUpsNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmCheck=ogAlarmCheck, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioIndex=ogEmdDioIndex, ogWifiApEntry=ogWifiApEntry, ogCellSignalNotification=ogCellSignalNotification, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialSignalNotification=ogSerialSignalNotification, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioDirection=ogEmdDioDirection, ogHostServiceType=ogHostServiceType, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcTable=ogRpcTable, ogEmdTable=ogEmdTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialUserLabel=ogSerialUserLabel, ogUpsEntry=ogUpsEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientMac=ogWifiApClientMac, ogStatus2Compliance=ogStatus2Compliance, ogEmdEnabled=ogEmdEnabled, ogHostServicePort=ogHostServicePort, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsState=ogUpsState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserStartTime=ogHostUserStartTime, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserNotification=ogHostUserNotification, ogWebUserNotification=ogWebUserNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogNetInterfaceState=ogNetInterfaceState, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletState=ogRpcOutletState, ogEmdEntry=ogEmdEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, PYSNMP_MODULE_ID=ogStatus2, ogHostUserHost=ogHostUserHost, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortLabel=ogSerialPortLabel, ogRpcCounter=ogRpcCounter, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApTable=ogWifiApTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApSsid=ogWifiApSsid, ogAlarmType=ogAlarmType, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckTable=ogCheckTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostUserTable=ogHostUserTable, ogUpsDescription=ogUpsDescription, ogHostName=ogHostName, ogNetInterfaceName=ogNetInterfaceName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientTable=ogWifiClientTable, ogSerialPortDSR=ogSerialPortDSR, ogHostUserHostName=ogHostUserHostName, ogRpcInputFrequency=ogRpcInputFrequency, ogHostPingNotification=ogHostPingNotification, ogHostServiceStatus=ogHostServiceStatus, ogUpsTable=ogUpsTable, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientAp=ogWifiApClientAp, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioState=ogEmdDioState, ogAlarmEventId=ogAlarmEventId, ogCheckType=ogCheckType, ogCellDataNotification=ogCellDataNotification, ogSerialPortEntry=ogSerialPortEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemIMSI=ogCellModemIMSI, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioType=ogEmdDioType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWebUserIndex=ogWebUserIndex, ogAlarmInstance=ogAlarmInstance, ogCheckName=ogCheckName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWebUserName=ogWebUserName, ogSerialNumber=ogSerialNumber, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityName=ogEmdHumidityName, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServiceIndex=ogHostServiceIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApIndex=ogWifiApIndex, ogEmdDioNotification=ogEmdDioNotification, ogRpcIndex=ogRpcIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioTable=ogEmdDioTable, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemTable=ogCellModemTable, ogWifiClientApMac=ogWifiClientApMac, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcName=ogRpcName, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApInterface=ogWifiApInterface, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemConnected=ogCellModemConnected, ogHostUserName=ogHostUserName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemNetwork=ogCellModemNetwork, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientEntry=ogWifiClientEntry, ogAlarmState=ogAlarmState, ogUpsType=ogUpsType, ogHostServiceNotification=ogHostServiceNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogFirmwareVersion=ogFirmwareVersion, ogUpsTemperature=ogUpsTemperature, ogWifiClientMode=ogWifiClientMode, ogSerialUserEntry=ogSerialUserEntry, ogRpcConnectType=ogRpcConnectType, ogRpcInputVoltage=ogRpcInputVoltage, ogSystem=ogSystem, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientCounter=ogWifiClientCounter, ogWifiApEnabled=ogWifiApEnabled, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortMode=ogSerialPortMode, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDescription=ogEmdDescription, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsCounter=ogUpsCounter, ogCellModemApn=ogCellModemApn, ogCurrentAlarmName=ogCurrentAlarmName, ogStatus2Groups=ogStatus2Groups, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdIndex=ogEmdIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemTower=ogCellModemTower, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsHumidity=ogUpsHumidity, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsOutputLoad=ogUpsOutputLoad, ogCellApnNotification=ogCellApnNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarm=ogAlarm, ogCellModemCounter=ogCellModemCounter, ogSerialPortRTS=ogSerialPortRTS, ogRpcDescription=ogRpcDescription, ogWebUserEntry=ogWebUserEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialUserPort=ogSerialUserPort)
