...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcOutletTable=ogRpcOutletTable, ogMibNotifications=ogMibNotifications, ogWifiApClientEntry=ogWifiApClientEntry, ogHostServiceIndex=ogHostServiceIndex, ogUpsState=ogUpsState, ogSerialUserTable=ogSerialUserTable, ogHostEntry=ogHostEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmTime=ogAlarmTime, ogCellDataNotification=ogCellDataNotification, ogHostIndex=ogHostIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckTable=ogCheckTable, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsOutputPower=ogUpsOutputPower, ogUpsTemperature=ogUpsTemperature, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientCounter=ogWifiClientCounter, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsCounter=ogUpsCounter, ogUpsName=ogUpsName, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsType=ogUpsType, ogUpsEntry=ogUpsEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientEntry=ogWifiClientEntry, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyName=ogPowerSupplyName, ogEmdTable=ogEmdTable, ogEmdDioState=ogEmdDioState, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemEntry=ogCellModemEntry, ogAlarmEventId=ogAlarmEventId, ogHostUserHost=ogHostUserHost, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsIndex=ogUpsIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcDescription=ogRpcDescription, ogSerialPortMode=ogSerialPortMode, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdEntry=ogEmdEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdEnabled=ogEmdEnabled, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcConnectType=ogRpcConnectType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialUserIndex=ogSerialUserIndex, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioTable=ogEmdDioTable, ogWifiApSsid=ogWifiApSsid, ogEmdName=ogEmdName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcName=ogRpcName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckType=ogCheckType, ogAlarmInstance=ogAlarmInstance, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostPingNotification=ogHostPingNotification, ogStatus2Compliances=ogStatus2Compliances, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApIeeeMode=ogWifiApIeeeMode, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostUserTable=ogHostUserTable, ogCellModemIndex=ogCellModemIndex, ogWifiApInterface=ogWifiApInterface, ogCheckName=ogCheckName, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientTable=ogWifiClientTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWebUserIndex=ogWebUserIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogHostServiceCounter=ogHostServiceCounter, ogWebUserNotification=ogWebUserNotification, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDescription=ogEmdDescription, ogEmdDioName=ogEmdDioName, ogHostUserNotification=ogHostUserNotification, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortTable=ogSerialPortTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWebUserTable=ogWebUserTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserHostName=ogHostUserHostName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioDescription=ogEmdDioDescription, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortLabel=ogSerialPortLabel, ogCustomNotification=ogCustomNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogStatus2=ogStatus2, ogWifiClientApMac=ogWifiClientApMac, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmUser=ogAlarmUser, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioType=ogEmdDioType, ogHostServiceEntry=ogHostServiceEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogHostServiceType=ogHostServiceType, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCurrentAlarmSummary=ogCurrentAlarmSummary, PYSNMP_MODULE_ID=ogStatus2, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcType=ogRpcType, ogAlarmCheck=ogAlarmCheck, ogRpcOutletState=ogRpcOutletState, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletName=ogRpcOutletName, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsConnectType=ogUpsConnectType, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostTable=ogHostTable, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellModemApn=ogCellModemApn, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityName=ogEmdHumidityName, ogFirmwareVersion=ogFirmwareVersion, ogAlarmDevice=ogAlarmDevice, ogEmdDioCounter=ogEmdDioCounter, ogRpcInputNotification=ogRpcInputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSystem=ogSystem, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserStartTime=ogSerialUserStartTime, ogNetInterfaceState=ogNetInterfaceState, ogCellModemModel=ogCellModemModel, ogCellModemRegistered=ogCellModemRegistered, ogUpsNotification=ogUpsNotification, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialUserName=ogSerialUserName, ogEmdDioEntry=ogEmdDioEntry, ogRpcTable=ogRpcTable, ogWebUserName=ogWebUserName, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientMode=ogWifiClientMode, ogNetInterfaceName=ogNetInterfaceName, ogWifiApIndex=ogWifiApIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortDTR=ogSerialPortDTR, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialUserPort=ogSerialUserPort, ogCellModemTower=ogCellModemTower, ogHostServiceHost=ogHostServiceHost, ogAlarmSummary=ogAlarmSummary, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserNotification=ogSerialUserNotification, ogHostServicePort=ogHostServicePort, ogStatus2Conformance=ogStatus2Conformance, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWebUserEntry=ogWebUserEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemVendor=ogCellModemVendor, ogAlarmLogEntry=ogAlarmLogEntry, ogStatus2Groups=ogStatus2Groups, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialUserLabel=ogSerialUserLabel, ogWifiApTable=ogWifiApTable, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApFrequency=ogWifiApFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortCTS=ogSerialPortCTS, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostIpV6Address=ogHostIpV6Address, ogCellModemIMSI=ogCellModemIMSI, ogWifiApCounter=ogWifiApCounter, ogSerialPortEntry=ogSerialPortEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostUserAddress=ogHostUserAddress, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcEntry=ogRpcEntry, ogSerialNumber=ogSerialNumber, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceType=ogNetInterfaceType, ogAlarmName=ogAlarmName, ogAlarm=ogAlarm, ogWifiApAuthNotification=ogWifiApAuthNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsDescription=ogUpsDescription, ogCellModemCounter=ogCellModemCounter, ogHostUserIndex=ogHostUserIndex, ogAlarmState=ogAlarmState, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdIndex=ogEmdIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApEnabled=ogWifiApEnabled, ogWifiApTxPower=ogWifiApTxPower, ogHostName=ogHostName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckEntry=ogCheckEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckDeviceName=ogCheckDeviceName, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmLogTable=ogAlarmLogTable, ogSerialSignalNotification=ogSerialSignalNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceTable=ogHostServiceTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserName=ogHostUserName, ogAlarmType=ogAlarmType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApEntry=ogWifiApEntry, ogRpcIndex=ogRpcIndex, ogCellModemTable=ogCellModemTable, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcCounter=ogRpcCounter, ogHostServiceStatus=ogHostServiceStatus, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsHumidity=ogUpsHumidity, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsTable=ogUpsTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortParity=ogSerialPortParity, ogHostServiceNotification=ogHostServiceNotification, ogCheckIndex=ogCheckIndex)
