...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApTxPower=ogWifiApTxPower, ogWifiApSsid=ogWifiApSsid, ogSerialPortStopBits=ogSerialPortStopBits, ogWebUserIndex=ogWebUserIndex, ogUpsIndex=ogUpsIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdHumidityCounter=ogEmdHumidityCounter, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogNetInterfaceType=ogNetInterfaceType, ogCellModemConnected=ogCellModemConnected, ogEmdDioDirection=ogEmdDioDirection, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckName=ogCheckName, ogCheckEntry=ogCheckEntry, ogWebUserStartTime=ogWebUserStartTime, ogAlarmName=ogAlarmName, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialUserPort=ogSerialUserPort, ogRpcOutletState=ogRpcOutletState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdEntry=ogEmdEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemTable=ogCellModemTable, ogHostEntry=ogHostEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletTable=ogRpcOutletTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsNotification=ogUpsNotification, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientInterface=ogWifiClientInterface, ogCellModemModel=ogCellModemModel, ogSerialPortDCD=ogSerialPortDCD, ogAlarmSummary=ogAlarmSummary, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmTime=ogAlarmTime, ogRpcDescription=ogRpcDescription, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellMessageNotification=ogCellMessageNotification, ogCellModemEntry=ogCellModemEntry, ogCellModemIMSI=ogCellModemIMSI, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortCTS=ogSerialPortCTS, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdEnabled=ogEmdEnabled, ogCellModemEnabled=ogCellModemEnabled, ogCellModemIndex=ogCellModemIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortDataBits=ogSerialPortDataBits, ogHostServiceType=ogHostServiceType, ogWifiApEnabled=ogWifiApEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcCounter=ogRpcCounter, ogStatus2Compliances=ogStatus2Compliances, ogUpsTemperature=ogUpsTemperature, ogAlarmEventId=ogAlarmEventId, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientMode=ogWifiClientMode, ogHostServiceHost=ogHostServiceHost, ogHostIndex=ogHostIndex, ogCheckTable=ogCheckTable, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserEntry=ogHostUserEntry, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApFrequency=ogWifiApFrequency, ogEmdLogEnabled=ogEmdLogEnabled, ogMibNotifications=ogMibNotifications, ogUpsType=ogUpsType, ogUpsConnectType=ogUpsConnectType, ogCellDataNotification=ogCellDataNotification, ogHostTable=ogHostTable, ogHostUserHostName=ogHostUserHostName, ogHostUserTable=ogHostUserTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemVendor=ogCellModemVendor, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientIndex=ogWifiClientIndex, ogHostUserHost=ogHostUserHost, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellTowerNotification=ogCellTowerNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserName=ogHostUserName, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostIpV4Address=ogHostIpV4Address, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemApn=ogCellModemApn, ogWifiApClientIndex=ogWifiApClientIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserLabel=ogSerialUserLabel, ogWifiApTable=ogWifiApTable, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTable=ogEmdTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApIndex=ogWifiApIndex, ogUpsState=ogUpsState, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialUserIndex=ogSerialUserIndex, ogHostUserNotification=ogHostUserNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckResetTimeout=ogCheckResetTimeout, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmTriggerValue=ogAlarmTriggerValue, ogNetInterfaceName=ogNetInterfaceName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortParity=ogSerialPortParity, ogSerialPortTable=ogSerialPortTable, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsDescription=ogUpsDescription, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioEntry=ogEmdDioEntry, ogEmdIndex=ogEmdIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdConnectType=ogEmdConnectType, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortMode=ogSerialPortMode, ogCheckResolveActions=ogCheckResolveActions, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletName=ogRpcOutletName, ogCustomNotification=ogCustomNotification, ogRpcIndex=ogRpcIndex, ogCheckType=ogCheckType, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientAp=ogWifiApClientAp, ogWifiApEntry=ogWifiApEntry, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemTower=ogCellModemTower, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialUserTable=ogSerialUserTable, ogSerialPortDTR=ogSerialPortDTR, ogAlarmState=ogAlarmState, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdDioTable=ogEmdDioTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemCounter=ogCellModemCounter, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioCounter=ogEmdDioCounter, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApCounter=ogWifiApCounter, ogSerialUserName=ogSerialUserName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDescription=ogEmdDescription, ogUpsName=ogUpsName, ogSerialNumber=ogSerialNumber, ogPowerSupplyName=ogPowerSupplyName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcInputNotification=ogRpcInputNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcName=ogRpcName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientCounter=ogWifiClientCounter, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioName=ogEmdDioName, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostServiceNotification=ogHostServiceNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcType=ogRpcType, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmType=ogAlarmType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogStatus2Groups=ogStatus2Groups, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostUserIndex=ogHostUserIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserStartTime=ogHostUserStartTime, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserName=ogWebUserName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckDeviceName=ogCheckDeviceName, ogWifiApInterface=ogWifiApInterface, ogAlarmUser=ogAlarmUser, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsTable=ogUpsTable, ogCellApnNotification=ogCellApnNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioState=ogEmdDioState, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcTable=ogRpcTable, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsCounter=ogUpsCounter, ogAlarm=ogAlarm, ogWebUserTable=ogWebUserTable, ogHostName=ogHostName, ogAlarmCheck=ogAlarmCheck, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmDevice=ogAlarmDevice, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioNotification=ogEmdDioNotification, ogRpcConnectType=ogRpcConnectType, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialUserNotification=ogSerialUserNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientApMac=ogWifiClientApMac, ogSerialUserEntry=ogSerialUserEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityTable=ogEmdHumidityTable, ogStatus2=ogStatus2, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostServicePort=ogHostServicePort, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdName=ogEmdName, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckIndex=ogCheckIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientTable=ogWifiClientTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryState=ogUpsBatteryState, ogUpsEntry=ogUpsEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientMac=ogWifiApClientMac, ogSystem=ogSystem, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApClientTable=ogWifiApClientTable, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcEntry=ogRpcEntry, ogAlarmInstance=ogAlarmInstance, ogEmdDioType=ogEmdDioType, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientEntry=ogWifiClientEntry)
