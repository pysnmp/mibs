...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServiceType=ogHostServiceType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostIndex=ogHostIndex, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioType=ogEmdDioType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellTowerNotification=ogCellTowerNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdIndex=ogEmdIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioDirection=ogEmdDioDirection, ogPowerSupplyName=ogPowerSupplyName, ogEmdEntry=ogEmdEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckIndex=ogCheckIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarm=ogAlarm, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientIndex=ogWifiClientIndex, ogCellDataNotification=ogCellDataNotification, ogCellModemConnected=ogCellModemConnected, ogWebUserIndex=ogWebUserIndex, ogSerialPortDSR=ogSerialPortDSR, ogWifiApEntry=ogWifiApEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortDTR=ogSerialPortDTR, ogAlarmTime=ogAlarmTime, ogHostUserIndex=ogHostUserIndex, ogStatus2Compliance=ogStatus2Compliance, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceIndex=ogHostServiceIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceHost=ogHostServiceHost, ogEmdDioCounter=ogEmdDioCounter, ogWifiApIndex=ogWifiApIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcType=ogRpcType, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApInterface=ogWifiApInterface, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmState=ogAlarmState, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogHostServiceCounter=ogHostServiceCounter, ogWifiApClientTable=ogWifiApClientTable, ogWebUserEntry=ogWebUserEntry, ogHostServiceTable=ogHostServiceTable, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserEntry=ogSerialUserEntry, ogHostTable=ogHostTable, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckName=ogCheckName, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcName=ogRpcName, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserTable=ogSerialUserTable, ogNetInterfaceState=ogNetInterfaceState, ogCellModemEntry=ogCellModemEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioNotification=ogEmdDioNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityEmd=ogEmdHumidityEmd, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostServicePort=ogHostServicePort, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputLoad=ogUpsOutputLoad, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckType=ogCheckType, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostUserTable=ogHostUserTable, ogCellNetworkNotification=ogCellNetworkNotification, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserStartTime=ogSerialUserStartTime, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmName=ogAlarmName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostName=ogHostName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemTower=ogCellModemTower, ogUpsHumidity=ogUpsHumidity, ogSerialPortRTS=ogSerialPortRTS, ogCellModemTable=ogCellModemTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialUserIndex=ogSerialUserIndex, ogHostPingNotification=ogHostPingNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortEntry=ogSerialPortEntry, ogAlarmCheck=ogAlarmCheck, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemVendor=ogCellModemVendor, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsType=ogUpsType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellMessageNotification=ogCellMessageNotification, ogCellApnNotification=ogCellApnNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserStartTime=ogHostUserStartTime, ogAlarmInstance=ogAlarmInstance, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortMode=ogSerialPortMode, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsName=ogUpsName, ogEmdDescription=ogEmdDescription, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserName=ogSerialUserName, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletName=ogRpcOutletName, ogCellModemModel=ogCellModemModel, ogUpsIndex=ogUpsIndex, ogCheckTable=ogCheckTable, ogRpcOutletState=ogRpcOutletState, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostEntry=ogHostEntry, ogRpcTable=ogRpcTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsState=ogUpsState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemApn=ogCellModemApn, ogEmdTable=ogEmdTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmType=ogAlarmType, ogAlarmLogTable=ogAlarmLogTable, ogRpcInputNotification=ogRpcInputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioState=ogEmdDioState, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemTemperature=ogCellModemTemperature, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckEntry=ogCheckEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWebUserName=ogWebUserName, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSystem=ogSystem, ogWifiApCounter=ogWifiApCounter, ogHostUserHost=ogHostUserHost, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceEntry=ogHostServiceEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsNotification=ogUpsNotification, ogCheckResolveActions=ogCheckResolveActions, ogCellModemCounter=ogCellModemCounter, ogEmdDioTable=ogEmdDioTable, ogAlarmSummary=ogAlarmSummary, ogUpsEntry=ogUpsEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsTemperature=ogUpsTemperature, ogSerialNumber=ogSerialNumber, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcDescription=ogRpcDescription, ogWifiApTable=ogWifiApTable, ogCustomNotification=ogCustomNotification, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortTable=ogSerialPortTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmEventId=ogAlarmEventId, ogHostUserHostName=ogHostUserHostName, ogEmdName=ogEmdName, ogSerialUserPort=ogSerialUserPort, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellSignalNotification=ogCellSignalNotification, ogUpsCounter=ogUpsCounter, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogStatus2Conformance=ogStatus2Conformance, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogStatus2=ogStatus2, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcConnectType=ogRpcConnectType, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsDescription=ogUpsDescription, ogFirmwareVersion=ogFirmwareVersion, ogWifiApTxPower=ogWifiApTxPower, ogUpsTable=ogUpsTable, ogEmdHumidityName=ogEmdHumidityName, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioIndex=ogEmdDioIndex, ogWebUserNotification=ogWebUserNotification, ogWifiApEnabled=ogWifiApEnabled, ogEmdEnabled=ogEmdEnabled, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemRegistered=ogCellModemRegistered, ogWebUserStartTime=ogWebUserStartTime, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioName=ogEmdDioName, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcEntry=ogRpcEntry, ogMibNotifications=ogMibNotifications, ogHostUserEntry=ogHostUserEntry, ogNetInterfaceName=ogNetInterfaceName, ogHostUserName=ogHostUserName, ogWifiClientFrequency=ogWifiClientFrequency, ogStatus2Groups=ogStatus2Groups, ogRpcCounter=ogRpcCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmDevice=ogAlarmDevice, ogSerialPortParity=ogSerialPortParity, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioEmd=ogEmdDioEmd, ogWebUserTable=ogWebUserTable, ogUpsConnectType=ogUpsConnectType, ogWifiApClientMac=ogWifiApClientMac, ogRpcIndex=ogRpcIndex, ogWifiClientMode=ogWifiClientMode, ogAlarmUser=ogAlarmUser, ogEmdDioDescription=ogEmdDioDescription)
