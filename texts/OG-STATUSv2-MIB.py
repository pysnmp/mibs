...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcTable=ogRpcTable, ogCellTowerNotification=ogCellTowerNotification, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApIndex=ogWifiApIndex, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellDataNotification=ogCellDataNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserEntry=ogHostUserEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostIpV6Address=ogHostIpV6Address, ogStatus2Compliance=ogStatus2Compliance, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioIndex=ogEmdDioIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogAlarmInstance=ogAlarmInstance, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortParity=ogSerialPortParity, ogCellModemApn=ogCellModemApn, ogEmdEnabled=ogEmdEnabled, ogEmdDioCounter=ogEmdDioCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcConnectType=ogRpcConnectType, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserNotification=ogSerialUserNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceEntry=ogHostServiceEntry, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDescription=ogEmdDescription, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemEntry=ogCellModemEntry, ogAlarmType=ogAlarmType, ogWifiClientTable=ogWifiClientTable, ogUpsOutputPower=ogUpsOutputPower, ogWifiApEntry=ogWifiApEntry, ogFirmwareVersion=ogFirmwareVersion, ogAlarmName=ogAlarmName, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserStartTime=ogSerialUserStartTime, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputVoltage=ogUpsOutputVoltage, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckType=ogCheckType, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletTable=ogRpcOutletTable, ogUpsHumidity=ogUpsHumidity, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortRTS=ogSerialPortRTS, ogUpsNotification=ogUpsNotification, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserLabel=ogSerialUserLabel, ogHostIpV4Address=ogHostIpV4Address, ogAlarmSummary=ogAlarmSummary, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioEntry=ogEmdDioEntry, ogWebUserTable=ogWebUserTable, ogWifiApFrequency=ogWifiApFrequency, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientMode=ogWifiClientMode, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApTxPower=ogWifiApTxPower, ogWifiApEnabled=ogWifiApEnabled, ogHostUserHost=ogHostUserHost, ogCellModemIndex=ogCellModemIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDioName=ogEmdDioName, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletState=ogRpcOutletState, ogEmdConnectType=ogEmdConnectType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletName=ogRpcOutletName, ogSerialUserName=ogSerialUserName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsName=ogUpsName, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsConnectType=ogUpsConnectType, ogSerialNumber=ogSerialNumber, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogStatus2=ogStatus2, ogHostName=ogHostName, ogCheckTable=ogCheckTable, ogAlarmState=ogAlarmState, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModemConnected=ogCellModemConnected, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApInterface=ogWifiApInterface, ogUpsIndex=ogUpsIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogStatus2Groups=ogStatus2Groups, ogHostServicePort=ogHostServicePort, ogEmdDioType=ogEmdDioType, ogHostServiceStatus=ogHostServiceStatus, ogUpsDescription=ogUpsDescription, ogWifiApTable=ogWifiApTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServiceType=ogHostServiceType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserAddress=ogHostUserAddress, ogUpsTable=ogUpsTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostUserTable=ogHostUserTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientEntry=ogWifiClientEntry, ogEmdDioDirection=ogEmdDioDirection, ogRpcEntry=ogRpcEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserStartTime=ogHostUserStartTime, ogCellModemNetwork=ogCellModemNetwork, ogCustomNotification=ogCustomNotification, ogUpsType=ogUpsType, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientCounter=ogWifiClientCounter, ogRpcIndex=ogRpcIndex, ogCheckResolveActions=ogCheckResolveActions, ogHostUserIndex=ogHostUserIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostServiceTable=ogHostServiceTable, ogWebUserEntry=ogWebUserEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceHost=ogHostServiceHost, ogHostUserName=ogHostUserName, ogCellMessageNotification=ogCellMessageNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdEntry=ogEmdEntry, ogPowerSupplyName=ogPowerSupplyName, ogCheckEntry=ogCheckEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdHumidityName=ogEmdHumidityName, ogCellModemIMSI=ogCellModemIMSI, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarm=ogAlarm, ogUpsEntry=ogUpsEntry, ogMibNotifications=ogMibNotifications, ogSerialUserTable=ogSerialUserTable, ogHostUserHostName=ogHostUserHostName, ogWebUserIndex=ogWebUserIndex, ogRpcDescription=ogRpcDescription, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserPort=ogSerialUserPort, ogHostPingNotification=ogHostPingNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostIndex=ogHostIndex, ogCellModemModel=ogCellModemModel, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserStartTime=ogWebUserStartTime, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortMode=ogSerialPortMode, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogCellNetworkNotification=ogCellNetworkNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSystem=ogSystem, ogAlarmDevice=ogAlarmDevice, ogStatus2Conformance=ogStatus2Conformance, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmUser=ogAlarmUser, ogCellModemVendor=ogCellModemVendor, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcCounter=ogRpcCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserNotification=ogHostUserNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckIndex=ogCheckIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortEntry=ogSerialPortEntry, ogUpsState=ogUpsState, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckName=ogCheckName, ogAlarmTime=ogAlarmTime, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemTable=ogCellModemTable, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioState=ogEmdDioState, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortDTR=ogSerialPortDTR, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWebUserName=ogWebUserName, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortStopBits=ogSerialPortStopBits, ogHostTable=ogHostTable, ogEmdName=ogEmdName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdIndex=ogEmdIndex, ogUpsTemperature=ogUpsTemperature, ogWifiApSsid=ogWifiApSsid, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientMac=ogWifiApClientMac, ogRpcType=ogRpcType, ogCellModemTower=ogCellModemTower, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortIndex=ogSerialPortIndex, ogAlarmLogTable=ogAlarmLogTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostEntry=ogHostEntry, ogEmdTable=ogEmdTable, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcName=ogRpcName, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWebUserNotification=ogWebUserNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApAuthNotification=ogWifiApAuthNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortTable=ogSerialPortTable, ogUpsCounter=ogUpsCounter, ogCellModemRegistered=ogCellModemRegistered)
