...
Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, Gauge32, IpAddress, MibIdentifier, NotificationType, ObjectIdentity, ModuleIdentity, iso, Integer32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "Gauge32", "IpAddress", "MibIdentifier", "NotificationType", "ObjectIdentity", "ModuleIdentity", "iso", "Integer32", "Bits")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApEnabled=ogWifiApEnabled, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsTemperature=ogUpsTemperature, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostTable=ogHostTable, ogEmdDioDirection=ogEmdDioDirection, ogRpcCounter=ogRpcCounter, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckType=ogCheckType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputPower=ogUpsOutputPower, ogHostUserName=ogHostUserName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioName=ogEmdDioName, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserHostName=ogHostUserHostName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemSessionTime=ogCellModemSessionTime, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialUserName=ogSerialUserName, ogEmdDioCounter=ogEmdDioCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTable=ogEmdTable, ogSerialNumber=ogSerialNumber, ogCellModemVendor=ogCellModemVendor, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWebUserName=ogWebUserName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, PYSNMP_MODULE_ID=ogStatus2, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemTower=ogCellModemTower, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmSummary=ogAlarmSummary, ogCellApnNotification=ogCellApnNotification, ogCellModemTable=ogCellModemTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogNetInterfaceName=ogNetInterfaceName, ogAlarmState=ogAlarmState, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortMode=ogSerialPortMode, ogCellModemTemperature=ogCellModemTemperature, ogRpcIndex=ogRpcIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioIndex=ogEmdDioIndex, ogWebUserStartTime=ogWebUserStartTime, ogHostUserEntry=ogHostUserEntry, ogWifiClientMode=ogWifiClientMode, ogAlarmEventId=ogAlarmEventId, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortDTR=ogSerialPortDTR, ogHostIpV4Address=ogHostIpV4Address, ogCellModemEntry=ogCellModemEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApCounter=ogWifiApCounter, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcName=ogRpcName, ogHostUserHost=ogHostUserHost, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceType=ogHostServiceType, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcConnectType=ogRpcConnectType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogHostServiceIndex=ogHostServiceIndex, ogCellModemEnabled=ogCellModemEnabled, ogHostServiceNotification=ogHostServiceNotification, ogUpsTable=ogUpsTable, ogWifiClientTable=ogWifiClientTable, ogCheckIndex=ogCheckIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogHostEntry=ogHostEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdConnectType=ogEmdConnectType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckEntry=ogCheckEntry, ogSerialUserNotification=ogSerialUserNotification, ogHostIndex=ogHostIndex, ogWebUserEntry=ogWebUserEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioTable=ogEmdDioTable, ogWifiClientApMac=ogWifiClientApMac, ogSystem=ogSystem, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWebUserIndex=ogWebUserIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmInstance=ogAlarmInstance, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputNotification=ogUpsOutputNotification, ogHostName=ogHostName, ogRpcOutletName=ogRpcOutletName, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemModel=ogCellModemModel, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsName=ogUpsName, ogWebUserTable=ogWebUserTable, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortDCD=ogSerialPortDCD, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmType=ogAlarmType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmUser=ogAlarmUser, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcEntry=ogRpcEntry, ogFirmwareVersion=ogFirmwareVersion, ogUpsConnectType=ogUpsConnectType, ogRpcDescription=ogRpcDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogHostPingNotification=ogHostPingNotification, ogEmdDioEmd=ogEmdDioEmd, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApEntry=ogWifiApEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemIndex=ogCellModemIndex, ogEmdName=ogEmdName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdEntry=ogEmdEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellDataNotification=ogCellDataNotification, ogHostServiceCounter=ogHostServiceCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortTable=ogSerialPortTable, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDescription=ogEmdDescription, ogEmdIndex=ogEmdIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsDescription=ogUpsDescription, ogCheckName=ogCheckName, ogHostServiceHost=ogHostServiceHost, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdEnabled=ogEmdEnabled, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortLabel=ogSerialPortLabel, ogUpsEntry=ogUpsEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientInterface=ogWifiClientInterface, ogCheckDeviceRef=ogCheckDeviceRef, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortDSR=ogSerialPortDSR, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckTable=ogCheckTable, ogUpsCounter=ogUpsCounter, ogHostServicePort=ogHostServicePort, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsHumidity=ogUpsHumidity, ogHostServiceTable=ogHostServiceTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostUserAddress=ogHostUserAddress, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcOutletTable=ogRpcOutletTable, ogNetInterfaceType=ogNetInterfaceType, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialUserEntry=ogSerialUserEntry, ogAlarmTime=ogAlarmTime, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortParity=ogSerialPortParity, ogHostUserTable=ogHostUserTable, ogRpcOutletState=ogRpcOutletState, ogUpsIndex=ogUpsIndex, ogNetInterfaceState=ogNetInterfaceState, ogUpsType=ogUpsType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostServiceEntry=ogHostServiceEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientIeeeMode=ogWifiClientIeeeMode)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortEntry=ogSerialPortEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDioType=ogEmdDioType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogStatus2Compliance=ogStatus2Compliance, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioState=ogEmdDioState, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsLogEnabled=ogUpsLogEnabled, ogCellTowerNotification=ogCellTowerNotification, ogAlarmName=ogAlarmName, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApTable=ogWifiApTable, ogWifiApSsid=ogWifiApSsid, ogWifiApInterface=ogWifiApInterface, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserPort=ogSerialUserPort, ogUpsNotification=ogUpsNotification, ogCellModemConnected=ogCellModemConnected, ogSerialUserLabel=ogSerialUserLabel, ogStatus2Groups=ogStatus2Groups, ogUpsState=ogUpsState, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellMessageNotification=ogCellMessageNotification, ogHostUserStartTime=ogHostUserStartTime, ogRpcType=ogRpcType, ogUpsBatteryState=ogUpsBatteryState, ogMibNotifications=ogMibNotifications, ogEmdHumidityName=ogEmdHumidityName, ogCustomNotification=ogCustomNotification, ogWifiClientIndex=ogWifiClientIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientAp=ogWifiApClientAp, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogStatus2=ogStatus2, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmDevice=ogAlarmDevice, ogCellModemApn=ogCellModemApn, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarm=ogAlarm, ogRpcTable=ogRpcTable, ogRpcOutletTotal=ogRpcOutletTotal)
