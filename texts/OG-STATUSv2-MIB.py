...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioType=ogEmdDioType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserNotification=ogWebUserNotification, ogUpsState=ogUpsState, ogHostServiceHost=ogHostServiceHost, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioDescription=ogEmdDioDescription, ogCheckIndex=ogCheckIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckType=ogCheckType, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmEventId=ogAlarmEventId, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputPower=ogUpsOutputPower, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsTable=ogUpsTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemRegistered=ogCellModemRegistered, ogStatus2Compliances=ogStatus2Compliances, ogHostTable=ogHostTable, ogUpsTemperature=ogUpsTemperature, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserStartTime=ogWebUserStartTime, ogHostName=ogHostName, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientCounter=ogWifiClientCounter, ogEmdDioEmd=ogEmdDioEmd, ogRpcTable=ogRpcTable, ogWifiClientIndex=ogWifiClientIndex, ogRpcCounter=ogRpcCounter, ogFirmwareVersion=ogFirmwareVersion, ogWebUserTable=ogWebUserTable, ogWifiClientTable=ogWifiClientTable, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortCTS=ogSerialPortCTS, ogHostUserStartTime=ogHostUserStartTime, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdConnectType=ogEmdConnectType, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellSignalNotification=ogCellSignalNotification, ogUpsCounter=ogUpsCounter, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemTower=ogCellModemTower, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioTable=ogEmdDioTable, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioName=ogEmdDioName, ogAlarmInstance=ogAlarmInstance, ogEmdDioState=ogEmdDioState, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsConnectType=ogUpsConnectType, ogWifiClientEssid=ogWifiClientEssid, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckEntry=ogCheckEntry, ogWebUserName=ogWebUserName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserTable=ogHostUserTable, ogUpsIndex=ogUpsIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsNotification=ogUpsNotification, ogUpsEntry=ogUpsEntry, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmSummary=ogAlarmSummary, ogHostUserName=ogHostUserName, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityDescription=ogEmdHumidityDescription, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApIndex=ogWifiApIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientAp=ogWifiApClientAp, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceStatus=ogHostServiceStatus, ogMibNotifications=ogMibNotifications, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdName=ogEmdName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellApnNotification=ogCellApnNotification, ogHostServiceType=ogHostServiceType, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmDevice=ogAlarmDevice, ogRpcType=ogRpcType, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialUserName=ogSerialUserName, ogEmdDioDirection=ogEmdDioDirection, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogHostIndex=ogHostIndex, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemEntry=ogCellModemEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceState=ogNetInterfaceState, ogCellModemVendor=ogCellModemVendor, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputVoltage=ogUpsInputVoltage, ogHostUserHost=ogHostUserHost, ogSerialPortTable=ogSerialPortTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, PYSNMP_MODULE_ID=ogStatus2, ogHostUserAddress=ogHostUserAddress, ogAlarmName=ogAlarmName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientMode=ogWifiClientMode, ogRpcIndex=ogRpcIndex, ogWifiClientEntry=ogWifiClientEntry, ogAlarm=ogAlarm, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdEntry=ogEmdEntry, ogCellModemNetwork=ogCellModemNetwork, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortParity=ogSerialPortParity, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcDescription=ogRpcDescription, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCustomNotification=ogCustomNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmUser=ogAlarmUser, ogEmdDescription=ogEmdDescription, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortLabel=ogSerialPortLabel, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialSignalNotification=ogSerialSignalNotification, ogNetInterfaceName=ogNetInterfaceName, ogCheckName=ogCheckName, ogWifiApClientMac=ogWifiApClientMac, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialUserTable=ogSerialUserTable, ogSerialPortSpeed=ogSerialPortSpeed, ogHostPingNotification=ogHostPingNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsType=ogUpsType, ogCellModemCounter=ogCellModemCounter, ogHostServiceCounter=ogHostServiceCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckTable=ogCheckTable, ogSerialPortDSR=ogSerialPortDSR, ogStatus2Conformance=ogStatus2Conformance, ogHostUserIndex=ogHostUserIndex, ogWifiApTxPower=ogWifiApTxPower, ogWifiApInterface=ogWifiApInterface, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemApn=ogCellModemApn, ogAlarmTime=ogAlarmTime, ogHostUserNotification=ogHostUserNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApEntry=ogWifiApEntry, ogRpcName=ogRpcName, ogStatus2Groups=ogStatus2Groups, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortIndex=ogSerialPortIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmCheck=ogAlarmCheck, ogSerialPortMode=ogSerialPortMode, ogRpcOutletName=ogRpcOutletName, ogSerialUserPort=ogSerialUserPort)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserNotification=ogSerialUserNotification, ogHostServicePort=ogHostServicePort, ogHostServiceTable=ogHostServiceTable, ogRpcOutletTable=ogRpcOutletTable, ogSerialNumber=ogSerialNumber, ogUpsName=ogUpsName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWebUserEntry=ogWebUserEntry, ogCheckDeviceName=ogCheckDeviceName, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientIndex=ogWifiApClientIndex, ogStatus2=ogStatus2, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellDataNotification=ogCellDataNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialUserIndex=ogSerialUserIndex, ogCellModemModel=ogCellModemModel, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceNotification=ogHostServiceNotification, ogEmdTable=ogEmdTable, ogEmdDioIndex=ogEmdDioIndex, ogRpcEntry=ogRpcEntry, ogHostEntry=ogHostEntry, ogRpcInputNotification=ogRpcInputNotification, ogWifiApTable=ogWifiApTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortRTS=ogSerialPortRTS, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsHumidity=ogUpsHumidity, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityName=ogEmdHumidityName, ogAlarmState=ogAlarmState, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcConnectType=ogRpcConnectType, ogHostIpV6Address=ogHostIpV6Address, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserEntry=ogHostUserEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdIndex=ogEmdIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogSystem=ogSystem, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceIndex=ogHostServiceIndex, ogCellModemTable=ogCellModemTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApFrequency=ogWifiApFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApSsid=ogWifiApSsid, ogUpsDescription=ogUpsDescription, ogAlarmType=ogAlarmType, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent)
