...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserEntry=ogSerialUserEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApCounter=ogWifiApCounter, ogRpcOutletName=ogRpcOutletName, ogEmdDioIndex=ogEmdDioIndex, ogCheckName=ogCheckName, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemTower=ogCellModemTower, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserHost=ogHostUserHost, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortRTS=ogSerialPortRTS, ogAlarmEventId=ogAlarmEventId, ogAlarmState=ogAlarmState, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceName=ogCheckDeviceName, ogCheckTriggerActions=ogCheckTriggerActions, ogStatus2Conformance=ogStatus2Conformance, ogNetInterfaceType=ogNetInterfaceType, ogUpsCounter=ogUpsCounter, ogWifiClientInterface=ogWifiClientInterface, PYSNMP_MODULE_ID=ogStatus2, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApEntry=ogWifiApEntry, ogHostServiceTable=ogHostServiceTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckType=ogCheckType, ogSerialPortCTS=ogSerialPortCTS, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientApMac=ogWifiClientApMac, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostUserHostName=ogHostUserHostName, ogStatus2=ogStatus2, ogCheckIndex=ogCheckIndex, ogSerialUserName=ogSerialUserName, ogCellModemNetwork=ogCellModemNetwork, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserStartTime=ogHostUserStartTime, ogWebUserNotification=ogWebUserNotification, ogEmdDioDirection=ogEmdDioDirection, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApInterface=ogWifiApInterface, ogAlarmSummary=ogAlarmSummary, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckResolveActions=ogCheckResolveActions, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellMessageNotification=ogCellMessageNotification, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortDTR=ogSerialPortDTR, ogCellModemIndex=ogCellModemIndex, ogWifiClientTable=ogWifiClientTable, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioTable=ogEmdDioTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputNotification=ogUpsOutputNotification, ogHostTable=ogHostTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsBatteryState=ogUpsBatteryState, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdConnectType=ogEmdConnectType, ogCustomNotification=ogCustomNotification, ogAlarmTime=ogAlarmTime, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityName=ogEmdHumidityName, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialNumber=ogSerialNumber, ogCellModemConnected=ogCellModemConnected, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemCounter=ogCellModemCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcTable=ogRpcTable, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdIndex=ogEmdIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsEntry=ogUpsEntry, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserStartTime=ogSerialUserStartTime, ogWebUserName=ogWebUserName, ogEmdDioEmd=ogEmdDioEmd, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApClientTable=ogWifiApClientTable, ogCheckEntry=ogCheckEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortDCD=ogSerialPortDCD, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortDataBits=ogSerialPortDataBits, ogHostUserName=ogHostUserName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsTemperature=ogUpsTemperature, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemModel=ogCellModemModel, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostName=ogHostName, ogCellModemRegistered=ogCellModemRegistered, ogHostUserTable=ogHostUserTable, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcIndex=ogRpcIndex, ogSerialPortMode=ogSerialPortMode, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostEntry=ogHostEntry, ogUpsHumidity=ogUpsHumidity, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserAddress=ogHostUserAddress, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcDescription=ogRpcDescription, ogEmdDioNotification=ogEmdDioNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputPower=ogUpsOutputPower, ogHostPingNotification=ogHostPingNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWebUserIndex=ogWebUserIndex, ogUpsNotification=ogUpsNotification, ogUpsTable=ogUpsTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceStatus=ogHostServiceStatus, ogAlarmType=ogAlarmType, ogEmdDioType=ogEmdDioType, ogEmdDioState=ogEmdDioState, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientCounter=ogWifiClientCounter, ogStatus2Compliance=ogStatus2Compliance, ogCellModemIMSI=ogCellModemIMSI, ogEmdName=ogEmdName, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdEnabled=ogEmdEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTable=ogEmdTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioDescription=ogEmdDioDescription, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsIndex=ogUpsIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogHostIndex=ogHostIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckTable=ogCheckTable, ogWifiApFrequency=ogWifiApFrequency, ogUpsState=ogUpsState, ogWebUserTable=ogWebUserTable, ogHostServiceIndex=ogHostServiceIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmLogTable=ogAlarmLogTable, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityValue=ogEmdHumidityValue, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApClientRssi=ogWifiApClientRssi, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApSsid=ogWifiApSsid, ogRpcType=ogRpcType, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioCounter=ogEmdDioCounter, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemTable=ogCellModemTable, ogEmdDioEntry=ogEmdDioEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSystem=ogSystem, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServicePort=ogHostServicePort, ogWifiApTxPower=ogWifiApTxPower, ogAlarmName=ogAlarmName, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogCellDataNotification=ogCellDataNotification, ogNetInterfaceName=ogNetInterfaceName, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogStatus2Groups=ogStatus2Groups, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmUser=ogAlarmUser, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceEntry=ogHostServiceEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsDescription=ogUpsDescription, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserIndex=ogHostUserIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsName=ogUpsName, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyName=ogPowerSupplyName, ogCellModemApn=ogCellModemApn, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortTable=ogSerialPortTable, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsType=ogUpsType, ogWifiApTable=ogWifiApTable, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientRssi=ogWifiClientRssi, ogHostServiceType=ogHostServiceType, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarm=ogAlarm, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdDescription=ogEmdDescription, ogRpcEntry=ogRpcEntry, ogSerialUserTable=ogSerialUserTable, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcName=ogRpcName, ogWifiClientEntry=ogWifiClientEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApIndex=ogWifiApIndex, ogHostUserNotification=ogHostUserNotification, ogEmdDioName=ogEmdDioName, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortIndex=ogSerialPortIndex, ogRpcCounter=ogRpcCounter, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdEntry=ogEmdEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogMibNotifications=ogMibNotifications, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemEntry=ogCellModemEntry, ogAlarmDevice=ogAlarmDevice, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortParity=ogSerialPortParity, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt)
