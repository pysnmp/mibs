...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemTower=ogCellModemTower, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApTable=ogWifiApTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellDataNotification=ogCellDataNotification, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortDCD=ogSerialPortDCD, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioDescription=ogEmdDioDescription, ogSerialUserTable=ogSerialUserTable, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceType=ogNetInterfaceType, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostIndex=ogHostIndex, ogSerialUserName=ogSerialUserName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmName=ogAlarmName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApEntry=ogWifiApEntry, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckIndex=ogCheckIndex, ogWifiClientApMac=ogWifiClientApMac, ogAlarmUser=ogAlarmUser, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdIndex=ogEmdIndex, ogSerialPortDTR=ogSerialPortDTR, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckName=ogCheckName, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsNotification=ogUpsNotification, ogRpcOutletName=ogRpcOutletName, ogWebUserIndex=ogWebUserIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcLogEnabled=ogRpcLogEnabled, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostPingNotification=ogHostPingNotification, ogCheckResolveActions=ogCheckResolveActions, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemModel=ogCellModemModel, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioCounter=ogEmdDioCounter, ogRpcEntry=ogRpcEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsIndex=ogUpsIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortMode=ogSerialPortMode, ogHostUserIndex=ogHostUserIndex, ogUpsType=ogUpsType, ogUpsInputVoltage=ogUpsInputVoltage, ogHostUserAddress=ogHostUserAddress, ogRpcConnectType=ogRpcConnectType, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCustomNotification=ogCustomNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemRegistered=ogCellModemRegistered, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdName=ogEmdName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSystem=ogSystem, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialNumber=ogSerialNumber, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmType=ogAlarmType, ogWifiApClientRssi=ogWifiApClientRssi, ogHostTable=ogHostTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmSummary=ogAlarmSummary, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApIndex=ogWifiApIndex, ogHostEntry=ogHostEntry, ogSerialUserPort=ogSerialUserPort, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemTable=ogCellModemTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdEntry=ogEmdEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemTemperature=ogCellModemTemperature, ogEmdTable=ogEmdTable, ogCheckDeviceName=ogCheckDeviceName, ogHostUserHost=ogHostUserHost, ogUpsName=ogUpsName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsDescription=ogUpsDescription, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemApn=ogCellModemApn, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcTable=ogRpcTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemIndex=ogCellModemIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsEntry=ogUpsEntry, ogAlarm=ogAlarm, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsState=ogUpsState, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletTable=ogRpcOutletTable, ogHostServiceTable=ogHostServiceTable, ogEmdDioState=ogEmdDioState, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemNetwork=ogCellModemNetwork, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostUserTable=ogHostUserTable, ogAlarmEventId=ogAlarmEventId, ogWebUserName=ogWebUserName, ogHostIpV4Address=ogHostIpV4Address, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioEmd=ogEmdDioEmd, ogStatus2Compliances=ogStatus2Compliances, ogUpsTable=ogUpsTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutletState=ogRpcOutletState, ogSerialPortTable=ogSerialPortTable, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApCounter=ogWifiApCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApSsid=ogWifiApSsid, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemConnected=ogCellModemConnected, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostName=ogHostName, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortEntry=ogSerialPortEntry, ogUpsHumidity=ogUpsHumidity, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientCounter=ogWifiClientCounter, ogAlarmTime=ogAlarmTime, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdHumidityName=ogEmdHumidityName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioType=ogEmdDioType, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemEntry=ogCellModemEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientRssi=ogWifiClientRssi, ogEmdDescription=ogEmdDescription, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogStatus2Compliance=ogStatus2Compliance, ogWebUserTable=ogWebUserTable, ogAlarmCheck=ogAlarmCheck, ogRpcCounter=ogRpcCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostServicePort=ogHostServicePort, ogRpcType=ogRpcType, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdEnabled=ogEmdEnabled, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdConnectType=ogEmdConnectType, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckEntry=ogCheckEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioName=ogEmdDioName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckType=ogCheckType, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmState=ogAlarmState, ogSerialPortParity=ogSerialPortParity, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogNetInterfaceState=ogNetInterfaceState, ogUpsCounter=ogUpsCounter, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostServiceHost=ogHostServiceHost, ogStatus2=ogStatus2, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmType=ogCurrentAlarmType, ogWebUserEntry=ogWebUserEntry, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsInputCurrent=ogUpsInputCurrent)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmInstance=ogAlarmInstance, ogCellApnNotification=ogCellApnNotification, ogMibNotifications=ogMibNotifications, ogWifiApInterface=ogWifiApInterface, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientTable=ogWifiApClientTable, ogCellModemIMSI=ogCellModemIMSI, ogUpsInputFrequency=ogUpsInputFrequency, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostServiceType=ogHostServiceType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogStatus2Groups=ogStatus2Groups, ogEmdDioTable=ogEmdDioTable, ogCellModemVendor=ogCellModemVendor, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceEntry=ogHostServiceEntry, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserName=ogHostUserName, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceRef=ogCheckDeviceRef, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientIndex=ogWifiClientIndex, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceIndex=ogHostServiceIndex, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckTable=ogCheckTable, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientTable=ogWifiClientTable, ogCellModemCounter=ogCellModemCounter, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcDescription=ogRpcDescription, ogStatus2Conformance=ogStatus2Conformance, ogUpsInputNotification=ogUpsInputNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcInputNotification=ogRpcInputNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostIpV6Address=ogHostIpV6Address, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioDirection=ogEmdDioDirection, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientMode=ogWifiClientMode, ogRpcIndex=ogRpcIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyName=ogPowerSupplyName, ogRpcName=ogRpcName, PYSNMP_MODULE_ID=ogStatus2, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency)
