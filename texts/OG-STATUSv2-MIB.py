...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioEntry=ogEmdDioEntry, ogUpsTemperature=ogUpsTemperature, ogHostName=ogHostName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServicePort=ogHostServicePort, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmEventId=ogAlarmEventId, ogStatus2Compliance=ogStatus2Compliance, ogEmdDescription=ogEmdDescription, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletState=ogRpcOutletState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientRssi=ogWifiClientRssi, ogWifiApFrequency=ogWifiApFrequency, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogStatus2Groups=ogStatus2Groups, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortTable=ogSerialPortTable, ogEmdDioEmd=ogEmdDioEmd, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialUserEntry=ogSerialUserEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortDSR=ogSerialPortDSR, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcEntry=ogRpcEntry, ogAlarm=ogAlarm, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApEnabled=ogWifiApEnabled, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostIndex=ogHostIndex, ogHostServiceIndex=ogHostServiceIndex, ogCellModemCounter=ogCellModemCounter, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmUser=ogAlarmUser, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcConnectType=ogRpcConnectType, ogSerialUserLabel=ogSerialUserLabel, ogCellModemEnabled=ogCellModemEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcCounter=ogRpcCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceCounter=ogHostServiceCounter, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostServiceHost=ogHostServiceHost, ogWifiApTxPower=ogWifiApTxPower, ogCellModemConnected=ogCellModemConnected, ogSerialUserPort=ogSerialUserPort, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioDescription=ogEmdDioDescription, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmLogTable=ogAlarmLogTable, ogEmdConnectType=ogEmdConnectType, ogCellModemIndex=ogCellModemIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckTable=ogCheckTable, ogAlarmState=ogAlarmState, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApCounter=ogWifiApCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceType=ogNetInterfaceType, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsState=ogUpsState, ogSerialPortIndex=ogSerialPortIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmCheck=ogAlarmCheck, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostServiceEntry=ogHostServiceEntry, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemTable=ogCellModemTable, ogWifiApEntry=ogWifiApEntry, ogEmdDioCounter=ogEmdDioCounter, ogUpsEntry=ogUpsEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmName=ogAlarmName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialNumber=ogSerialNumber, ogHostUserNotification=ogHostUserNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsInputNotification=ogUpsInputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemModel=ogCellModemModel, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsName=ogUpsName, ogWifiApInterface=ogWifiApInterface, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostUserAddress=ogHostUserAddress, ogWebUserTable=ogWebUserTable, ogEmdDioTable=ogEmdDioTable, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientMode=ogWifiClientMode, ogEmdDioInputTotal=ogEmdDioInputTotal, PYSNMP_MODULE_ID=ogStatus2, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserHost=ogHostUserHost, ogNetInterfaceName=ogNetInterfaceName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApIndex=ogWifiApIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdName=ogEmdName, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellMessageNotification=ogCellMessageNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogHostUserEntry=ogHostUserEntry, ogWifiApTable=ogWifiApTable, ogHostServiceNotification=ogHostServiceNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostUserIndex=ogHostUserIndex, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemTower=ogCellModemTower, ogHostIpV4Address=ogHostIpV4Address, ogMibNotifications=ogMibNotifications, ogEmdIndex=ogEmdIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientIndex=ogWifiClientIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogHostServiceType=ogHostServiceType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsIndex=ogUpsIndex, ogHostUserStartTime=ogHostUserStartTime, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsNotification=ogUpsNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioState=ogEmdDioState, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientApMac=ogWifiClientApMac, ogCellModemIMSI=ogCellModemIMSI, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortRTS=ogSerialPortRTS, ogUpsTable=ogUpsTable, ogSystem=ogSystem, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcName=ogRpcName, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemEntry=ogCellModemEntry, ogHostServiceTable=ogHostServiceTable, ogCheckEntry=ogCheckEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletEntry=ogRpcOutletEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostServiceStatus=ogHostServiceStatus, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientInterface=ogWifiClientInterface, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsOutputVoltage=ogUpsOutputVoltage, ogPowerSupplyTable=ogPowerSupplyTable, ogWebUserNotification=ogWebUserNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWebUserIndex=ogWebUserIndex, ogStatus2Compliances=ogStatus2Compliances, ogUpsConnectType=ogUpsConnectType, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientRssi=ogWifiApClientRssi, ogHostTable=ogHostTable, ogRpcType=ogRpcType, ogSerialPortParity=ogSerialPortParity, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdHumidityName=ogEmdHumidityName, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsLogEnabled=ogUpsLogEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckName=ogCheckName, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemTemperature=ogCellModemTemperature, ogCheckType=ogCheckType, ogHostPingNotification=ogHostPingNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsType=ogUpsType, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioName=ogEmdDioName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientIeeeMode=ogWifiClientIeeeMode)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortSpeed=ogSerialPortSpeed, ogWebUserName=ogWebUserName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogAlarmDevice=ogAlarmDevice, ogUpsDescription=ogUpsDescription, ogWifiClientTable=ogWifiClientTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckResolveActions=ogCheckResolveActions, ogWifiApSsid=ogWifiApSsid, ogWebUserEntry=ogWebUserEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcTable=ogRpcTable, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryState=ogUpsBatteryState, ogHostUserHostName=ogHostUserHostName, ogCustomNotification=ogCustomNotification, ogCellModemVendor=ogCellModemVendor, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogStatus2=ogStatus2, ogRpcIndex=ogRpcIndex, ogCellModemApn=ogCellModemApn, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserTable=ogHostUserTable, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellApnNotification=ogCellApnNotification, ogEmdEntry=ogEmdEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortMode=ogSerialPortMode, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsCounter=ogUpsCounter, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmTime=ogAlarmTime, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckIndex=ogCheckIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserTable=ogSerialUserTable, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientCounter=ogWifiClientCounter, ogHostEntry=ogHostEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostUserName=ogHostUserName, ogRpcDescription=ogRpcDescription, ogHostIpV6Address=ogHostIpV6Address, ogAlarmType=ogAlarmType, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTable=ogEmdTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdEnabled=ogEmdEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmInstance=ogAlarmInstance, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialUserName=ogSerialUserName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioType=ogEmdDioType, ogCurrentAlarmState=ogCurrentAlarmState)
