...
MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, ModuleIdentity, ObjectIdentity, NotificationType, Bits, TimeTicks, iso, Counter64, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "ModuleIdentity", "ObjectIdentity", "NotificationType", "Bits", "TimeTicks", "iso", "Counter64", "Unsigned32", "IpAddress")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientApMac=ogWifiClientApMac, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckType=ogCheckType, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdHumidityTotal=ogEmdHumidityTotal, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemApn=ogCellModemApn, ogStatus2Groups=ogStatus2Groups, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarm=ogAlarm, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdEnabled=ogEmdEnabled, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcType=ogRpcType, ogHostEntry=ogHostEntry, ogAlarmDevice=ogAlarmDevice, ogHostName=ogHostName, ogRpcCounter=ogRpcCounter, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckIndex=ogCheckIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmUser=ogAlarmUser, ogMibNotifications=ogMibNotifications, ogHostUserTable=ogHostUserTable, ogUpsType=ogUpsType, ogWebUserName=ogWebUserName, ogAlarmInstance=ogAlarmInstance, ogRpcOutletTable=ogRpcOutletTable, ogAlarmSummary=ogAlarmSummary, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogHostUserEntry=ogHostUserEntry, ogHostUserIndex=ogHostUserIndex, ogUpsTemperature=ogUpsTemperature, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemTemperature=ogCellModemTemperature, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostUserAddress=ogHostUserAddress, ogSerialNumber=ogSerialNumber, ogSerialUserNotification=ogSerialUserNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortMode=ogSerialPortMode, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserStartTime=ogHostUserStartTime, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogHostIndex=ogHostIndex, ogEmdDioEmd=ogEmdDioEmd, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortTable=ogSerialPortTable, ogEmdDioIndex=ogEmdDioIndex, ogWebUserIndex=ogWebUserIndex, ogEmdConnectType=ogEmdConnectType, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputPower=ogUpsOutputPower, ogCheckDeviceName=ogCheckDeviceName, ogRpcIndex=ogRpcIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceTable=ogHostServiceTable, ogUpsState=ogUpsState, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcInputNotification=ogRpcInputNotification, ogHostUserHost=ogHostUserHost, ogRpcEntry=ogRpcEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModem3gRssi=ogCellModem3gRssi, ogBasicStatusGroup=ogBasicStatusGroup, ogStatus2=ogStatus2, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientEntry=ogWifiClientEntry, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsEntry=ogUpsEntry, ogHostServiceStatus=ogHostServiceStatus, ogSystem=ogSystem, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutletEntry=ogRpcOutletEntry, ogCellDataNotification=ogCellDataNotification, ogStatus2Conformance=ogStatus2Conformance, ogCellModem4gRssi=ogCellModem4gRssi, ogHostUserName=ogHostUserName, ogSerialPortDSR=ogSerialPortDSR, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsNotification=ogUpsNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortDCD=ogSerialPortDCD, ogCellModemConnected=ogCellModemConnected, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsName=ogUpsName, ogNetInterfaceTable=ogNetInterfaceTable, ogNetInterfaceState=ogNetInterfaceState, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserNotification=ogHostUserNotification, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceNotification=ogHostServiceNotification, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioTable=ogEmdDioTable, ogUpsHumidity=ogUpsHumidity, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientMode=ogWifiClientMode, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcName=ogRpcName, ogRpcOutletName=ogRpcOutletName, ogSerialUserIndex=ogSerialUserIndex, ogSerialUserName=ogSerialUserName, ogEmdDioCounter=ogEmdDioCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsCounter=ogUpsCounter, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApClientMac=ogWifiApClientMac, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemModel=ogCellModemModel, ogEmdDioState=ogEmdDioState, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdTable=ogEmdTable, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientCounter=ogWifiClientCounter, ogEmdName=ogEmdName, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryState=ogUpsBatteryState, ogUpsIndex=ogUpsIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogNetInterfaceType=ogNetInterfaceType, ogRpcConnectType=ogRpcConnectType, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemVendor=ogCellModemVendor, ogSerialUserTable=ogSerialUserTable, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioName=ogEmdDioName, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceType=ogHostServiceType, ogWebUserStartTime=ogWebUserStartTime, ogHostServiceCounter=ogHostServiceCounter, ogRpcDescription=ogRpcDescription, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserPort=ogSerialUserPort, ogEmdDioType=ogEmdDioType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellTowerNotification=ogCellTowerNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialUserEntry=ogSerialUserEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdEntry=ogEmdEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApSsid=ogWifiApSsid, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientAp=ogWifiApClientAp, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsTable=ogUpsTable, ogHostPingNotification=ogHostPingNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckTable=ogCheckTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPatternNotification=ogSerialPatternNotification, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostIpV4Address=ogHostIpV4Address, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdIndex=ogEmdIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemEntry=ogCellModemEntry, ogCellModemCounter=ogCellModemCounter, ogCellModemEnabled=ogCellModemEnabled, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWebUserTable=ogWebUserTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServicePort=ogHostServicePort, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellApnNotification=ogCellApnNotification, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiApTable=ogWifiApTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemTable=ogCellModemTable, ogPowerSupplyName=ogPowerSupplyName, ogWifiApAssociationNotification=ogWifiApAssociationNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogNetInterfaceName=ogNetInterfaceName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialUserLabel=ogSerialUserLabel, ogWifiApIndex=ogWifiApIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmName=ogAlarmName, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmTime=ogAlarmTime, ogWebUserEntry=ogWebUserEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmType=ogAlarmType, ogRpcOutletState=ogRpcOutletState, ogAlarmState=ogAlarmState, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostServiceHost=ogHostServiceHost, ogAlarmEventId=ogAlarmEventId, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureValue=ogEmdTemperatureValue, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmCheck=ogAlarmCheck, ogCellModemIndex=ogCellModemIndex, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckResolveActions=ogCheckResolveActions, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientEssid=ogWifiClientEssid, ogHostTable=ogHostTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemTower=ogCellModemTower, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmName=ogCurrentAlarmName, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientTable=ogWifiClientTable, ogCustomNotification=ogCustomNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogWebUserNotification=ogWebUserNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsDescription=ogUpsDescription, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceIndex=ogHostServiceIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientInterface=ogWifiClientInterface, ogRpcTable=ogRpcTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckName=ogCheckName, ogCheckEntry=ogCheckEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApFrequency=ogWifiApFrequency, ogEmdDescription=ogEmdDescription, ogEmdDioDirection=ogEmdDioDirection, ogCellSignalNotification=ogCellSignalNotification)
