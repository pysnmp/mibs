...
NotificationType, ModuleIdentity, Integer32, Counter64, TimeTicks, Unsigned32, ObjectIdentity, iso, MibIdentifier, Bits, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ModuleIdentity", "Integer32", "Counter64", "TimeTicks", "Unsigned32", "ObjectIdentity", "iso", "MibIdentifier", "Bits", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientAp=ogWifiApClientAp, ogRpcTable=ogRpcTable, ogRpcInputNotification=ogRpcInputNotification, ogUpsState=ogUpsState, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortParity=ogSerialPortParity, ogEmdDioEmd=ogEmdDioEmd, ogWifiApInterface=ogWifiApInterface, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogStatus2Groups=ogStatus2Groups, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogCellMessageNotification=ogCellMessageNotification, ogAlarmType=ogAlarmType, ogCheckName=ogCheckName, ogStatus2Compliances=ogStatus2Compliances, ogEmdDescription=ogEmdDescription, ogCurrentAlarmState=ogCurrentAlarmState, ogBasicStatusGroup=ogBasicStatusGroup, ogCellTowerNotification=ogCellTowerNotification, ogCheckDeviceName=ogCheckDeviceName, ogUpsHumidity=ogUpsHumidity, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortEntry=ogSerialPortEntry, ogAlarmInstance=ogAlarmInstance, ogUpsTable=ogUpsTable, ogCellModemVendor=ogCellModemVendor, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcCounter=ogRpcCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmUser=ogAlarmUser, ogHostPingNotification=ogHostPingNotification, ogSerialUserLabel=ogSerialUserLabel, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserName=ogHostUserName, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2=ogStatus2, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioIndex=ogEmdDioIndex, ogHostServiceNotification=ogHostServiceNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmEventId=ogAlarmEventId, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialUserTable=ogSerialUserTable, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcConnectType=ogRpcConnectType, ogCheckDeviceTable=ogCheckDeviceTable, ogWebUserName=ogWebUserName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserIndex=ogHostUserIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdDioNotification=ogEmdDioNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceHost=ogHostServiceHost, ogHostIndex=ogHostIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmDevice=ogAlarmDevice, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, PYSNMP_MODULE_ID=ogStatus2, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientInterface=ogWifiClientInterface, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckDeviceCheck=ogCheckDeviceCheck, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioDescription=ogEmdDioDescription, ogRpcIndex=ogRpcIndex, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientTable=ogWifiApClientTable, ogWifiApTxPower=ogWifiApTxPower, ogEmdName=ogEmdName, ogEmdDioTable=ogEmdDioTable, ogEmdDioState=ogEmdDioState, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApCounter=ogWifiApCounter, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWebUserIndex=ogWebUserIndex, ogEmdDioType=ogEmdDioType, ogSerialPortMode=ogSerialPortMode, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckTable=ogCheckTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostName=ogHostName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialUserEntry=ogSerialUserEntry, ogUpsNotification=ogUpsNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialUserNotification=ogSerialUserNotification, ogUpsCounter=ogUpsCounter, ogCellModemEntry=ogCellModemEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellDataNotification=ogCellDataNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialUserName=ogSerialUserName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcOutletName=ogRpcOutletName, ogSerialPortDCD=ogSerialPortDCD, ogCheckResetTimeout=ogCheckResetTimeout, ogMibNotifications=ogMibNotifications, ogCheckEntry=ogCheckEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemTemperature=ogCellModemTemperature, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcName=ogRpcName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmTime=ogAlarmTime, ogCellModemTable=ogCellModemTable, ogCustomNotification=ogCustomNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsEntry=ogUpsEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceIndex=ogHostServiceIndex, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserNotification=ogWebUserNotification, ogAlarmSummary=ogAlarmSummary, ogWifiApFrequency=ogWifiApFrequency, ogUpsDescription=ogUpsDescription, ogSerialNumber=ogSerialNumber, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserStartTime=ogHostUserStartTime, ogCellModemIndex=ogCellModemIndex, ogWifiClientTable=ogWifiClientTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcDescription=ogRpcDescription, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsIndex=ogUpsIndex, ogRpcOutletState=ogRpcOutletState, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostTable=ogHostTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioEntry=ogEmdDioEntry, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientCounter=ogWifiClientCounter, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostUserAddress=ogHostUserAddress, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdIndex=ogEmdIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemIMSI=ogCellModemIMSI, ogHostUserHost=ogHostUserHost, ogSerialPortRTS=ogSerialPortRTS, ogCheckIndex=ogCheckIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdEntry=ogEmdEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortLabel=ogSerialPortLabel, ogAlarmLogTable=ogAlarmLogTable, ogHostUserTable=ogHostUserTable, ogUpsTemperature=ogUpsTemperature, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcType=ogRpcType, ogAlarm=ogAlarm, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsType=ogUpsType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceType=ogHostServiceType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostUserEntry=ogHostUserEntry, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceName=ogNetInterfaceName, ogHostServiceEntry=ogHostServiceEntry, ogAlarmName=ogAlarmName, ogRpcOutletNotification=ogRpcOutletNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientEntry=ogWifiClientEntry, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmCheck=ogAlarmCheck)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTable=ogEmdTable, ogSystem=ogSystem, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdConnectType=ogEmdConnectType, ogRpcEntry=ogRpcEntry, ogHostUserHostName=ogHostUserHostName, ogWifiApIndex=ogWifiApIndex, ogWifiClientApMac=ogWifiClientApMac, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellApnNotification=ogCellApnNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostEntry=ogHostEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWebUserStartTime=ogWebUserStartTime, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemConnected=ogCellModemConnected, ogHostServicePort=ogHostServicePort, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioName=ogEmdDioName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortTable=ogSerialPortTable, ogWifiApTable=ogWifiApTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsConnectType=ogUpsConnectType, ogHostUserNotification=ogHostUserNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemApn=ogCellModemApn, ogEmdLogEnabled=ogEmdLogEnabled, ogWebUserTable=ogWebUserTable, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemTower=ogCellModemTower, ogWebUserEntry=ogWebUserEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsName=ogUpsName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostServiceTable=ogHostServiceTable, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckType=ogCheckType, ogEmdDioCounter=ogEmdDioCounter, ogAlarmState=ogAlarmState, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApEnabled=ogWifiApEnabled, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdEnabled=ogEmdEnabled, ogCellModemModel=ogCellModemModel, ogSerialPortCTS=ogSerialPortCTS)
