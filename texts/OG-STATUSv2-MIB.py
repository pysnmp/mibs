...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApEntry=ogWifiApEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdEntry=ogEmdEntry, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckTable=ogCheckTable, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDescription=ogEmdDescription, ogWebUserNotification=ogWebUserNotification, ogCellTowerNotification=ogCellTowerNotification, ogHostUserName=ogHostUserName, ogHostUserIndex=ogHostUserIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmState=ogAlarmState, ogSerialPortMode=ogSerialPortMode, ogSystem=ogSystem, ogNetInterfaceName=ogNetInterfaceName, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostTable=ogHostTable, ogEmdName=ogEmdName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdTable=ogEmdTable, ogUpsOutputPower=ogUpsOutputPower, ogHostIpV4Address=ogHostIpV4Address, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsConnectType=ogUpsConnectType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortCTS=ogSerialPortCTS, ogRpcName=ogRpcName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcInputCurrent=ogRpcInputCurrent, ogHostUserAddress=ogHostUserAddress, ogSerialPortTable=ogSerialPortTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcTable=ogRpcTable, ogHostServicePort=ogHostServicePort, ogHostServiceType=ogHostServiceType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioEntry=ogEmdDioEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortIndex=ogSerialPortIndex, ogRpcInputNotification=ogRpcInputNotification, ogUpsIndex=ogUpsIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApAuthNotification=ogWifiApAuthNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserHost=ogHostUserHost, ogSerialPortEntry=ogSerialPortEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletName=ogRpcOutletName, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmUser=ogAlarmUser, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemApn=ogCellModemApn, ogWebUserTable=ogWebUserTable, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutletFrequency=ogRpcOutletFrequency, ogFirmwareVersion=ogFirmwareVersion, ogWebUserStartTime=ogWebUserStartTime, ogStatus2Compliance=ogStatus2Compliance, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcIndex=ogRpcIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsNotification=ogUpsNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmName=ogAlarmName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserLabel=ogSerialUserLabel, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmType=ogAlarmType, ogSerialPortStopBits=ogSerialPortStopBits, ogHostServiceTable=ogHostServiceTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemEnabled=ogCellModemEnabled, ogNetInterfaceState=ogNetInterfaceState, ogSerialNumber=ogSerialNumber, ogHostEntry=ogHostEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientMode=ogWifiClientMode, ogWifiApClientMac=ogWifiApClientMac, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostIndex=ogHostIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemCounter=ogCellModemCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserTable=ogHostUserTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioState=ogEmdDioState, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioEmd=ogEmdDioEmd, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckName=ogCheckName, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsName=ogUpsName, ogEmdDioName=ogEmdDioName, ogRpcOutletState=ogRpcOutletState, ogSerialUserEntry=ogSerialUserEntry, ogUpsInputNotification=ogUpsInputNotification, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceHost=ogHostServiceHost, ogAlarmCheck=ogAlarmCheck, ogCellModemTemperature=ogCellModemTemperature, ogHostName=ogHostName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemVendor=ogCellModemVendor, ogRpcOutletEntry=ogRpcOutletEntry, ogCellDataNotification=ogCellDataNotification, ogCheckIndex=ogCheckIndex, ogCellApnNotification=ogCellApnNotification, ogWebUserIndex=ogWebUserIndex, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientEnabled=ogWifiClientEnabled, ogCellSignalNotification=ogCellSignalNotification, ogRpcType=ogRpcType, ogEmdEnabled=ogEmdEnabled, ogEmdDioCounter=ogEmdDioCounter, ogAlarmTime=ogAlarmTime, ogUpsBatteryState=ogUpsBatteryState, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmInstance=ogAlarmInstance, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletTable=ogRpcOutletTable, ogStatus2Conformance=ogStatus2Conformance, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemTower=ogCellModemTower, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsTemperature=ogUpsTemperature, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioType=ogEmdDioType, ogEmdIndex=ogEmdIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsCounter=ogUpsCounter, ogWebUserEntry=ogWebUserEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceNotification=ogHostServiceNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarm=ogAlarm, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserStartTime=ogHostUserStartTime, ogRpcCounter=ogRpcCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogCellMessageNotification=ogCellMessageNotification, ogCheckEntry=ogCheckEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioDirection=ogEmdDioDirection, ogUpsState=ogUpsState, ogWifiApEnabled=ogWifiApEnabled, ogUpsDescription=ogUpsDescription, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcEntry=ogRpcEntry, ogWifiClientRssi=ogWifiClientRssi, ogWifiApFrequency=ogWifiApFrequency, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientTable=ogWifiApClientTable, ogWifiApIndex=ogWifiApIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemEntry=ogCellModemEntry, ogAlarmPreviousValue=ogAlarmPreviousValue)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApTable=ogWifiApTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortLabel=ogSerialPortLabel, ogCustomNotification=ogCustomNotification, ogCellModemModel=ogCellModemModel, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogMibNotifications=ogMibNotifications, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemIndex=ogCellModemIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsType=ogUpsType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientEntry=ogWifiClientEntry, ogWifiApInterface=ogWifiApInterface, ogEmdDioDescription=ogEmdDioDescription, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserIndex=ogSerialUserIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientTxPackets=ogWifiApClientTxPackets, PYSNMP_MODULE_ID=ogStatus2, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckType=ogCheckType, ogCellModemTable=ogCellModemTable, ogWifiClientTxPower=ogWifiClientTxPower, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortDCD=ogSerialPortDCD, ogPowerSupplyName=ogPowerSupplyName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApSsid=ogWifiApSsid, ogCheckTriggerActions=ogCheckTriggerActions, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsEntry=ogUpsEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioTable=ogEmdDioTable, ogSerialUserTable=ogSerialUserTable, ogAlarmEventId=ogAlarmEventId, ogUpsTable=ogUpsTable, ogHostPingNotification=ogHostPingNotification, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogStatus2Groups=ogStatus2Groups, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcConnectType=ogRpcConnectType, ogStatus2=ogStatus2, ogSerialUserPort=ogSerialUserPort, ogSerialPortBreaks=ogSerialPortBreaks, ogWebUserName=ogWebUserName, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemRegistered=ogCellModemRegistered, ogRpcDescription=ogRpcDescription, ogWifiClientTable=ogWifiClientTable, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortParity=ogSerialPortParity, ogWifiApCounter=ogWifiApCounter, ogSerialUserName=ogSerialUserName)
