...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcName=ogRpcName, ogEmdDioEmd=ogEmdDioEmd, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsCounter=ogUpsCounter, ogRpcTable=ogRpcTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsConnectType=ogUpsConnectType, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostUserHost=ogHostUserHost, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialSignalNotification=ogSerialSignalNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioType=ogEmdDioType, ogUpsNotification=ogUpsNotification, ogUpsOutputPower=ogUpsOutputPower, ogCellModemConnected=ogCellModemConnected, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServiceStatus=ogHostServiceStatus, ogRpcIndex=ogRpcIndex, ogCheckDeviceName=ogCheckDeviceName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortLogLevel=ogSerialPortLogLevel, PYSNMP_MODULE_ID=ogStatus2, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialUserName=ogSerialUserName, ogSerialPortTable=ogSerialPortTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemTower=ogCellModemTower, ogCheckName=ogCheckName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortParity=ogSerialPortParity, ogWebUserEntry=ogWebUserEntry, ogHostUserTable=ogHostUserTable, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmUser=ogAlarmUser, ogEmdEnabled=ogEmdEnabled, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarm=ogAlarm, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortDCD=ogSerialPortDCD, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdDioEntry=ogEmdDioEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDescription=ogEmdDescription, ogWifiApIndex=ogWifiApIndex, ogWifiApSsid=ogWifiApSsid, ogHostEntry=ogHostEntry, ogHostServiceTable=ogHostServiceTable, ogAlarmInstance=ogAlarmInstance, ogCellApnNotification=ogCellApnNotification, ogSerialPortIndex=ogSerialPortIndex, ogHostUserEntry=ogHostUserEntry, ogCellModemRegistered=ogCellModemRegistered, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApTable=ogWifiApTable, ogRpcCounter=ogRpcCounter, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialUserLabel=ogSerialUserLabel, ogUpsName=ogUpsName, ogRpcOutletName=ogRpcOutletName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioCounter=ogEmdDioCounter, ogHostServiceEntry=ogHostServiceEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioDescription=ogEmdDioDescription, ogAlarmSummary=ogAlarmSummary, ogWifiClientCounter=ogWifiClientCounter, ogRpcConnectType=ogRpcConnectType, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckTable=ogCheckTable, ogNetInterfaceType=ogNetInterfaceType, ogCellModemIndex=ogCellModemIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserPort=ogSerialUserPort, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsDescription=ogUpsDescription, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApClientTable=ogWifiApClientTable, ogAlarmEventId=ogAlarmEventId, ogHostUserNotification=ogHostUserNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceNotification=ogHostServiceNotification, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmType=ogAlarmType, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdIndex=ogEmdIndex, ogNetInterfaceName=ogNetInterfaceName, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceState=ogNetInterfaceState, ogHostIpV6Address=ogHostIpV6Address, ogUpsTemperature=ogUpsTemperature, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWebUserName=ogWebUserName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdName=ogEmdName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApTxPower=ogWifiApTxPower, ogCheckTriggerActions=ogCheckTriggerActions, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientIndex=ogWifiClientIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioDirection=ogEmdDioDirection, ogRpcEntry=ogRpcEntry, ogCheckType=ogCheckType, ogSerialNumber=ogSerialNumber, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientApMac=ogWifiClientApMac, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostServiceType=ogHostServiceType, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsState=ogUpsState, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostUserName=ogHostUserName, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientMode=ogWifiClientMode, ogSystem=ogSystem, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCustomNotification=ogCustomNotification, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientAp=ogWifiApClientAp, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceHost=ogHostServiceHost, ogCheckEntry=ogCheckEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApCounter=ogWifiApCounter, ogSerialPortDTR=ogSerialPortDTR, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortMode=ogSerialPortMode, ogStatus2Conformance=ogStatus2Conformance, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityName=ogEmdHumidityName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmCheck=ogAlarmCheck, ogCellModemModel=ogCellModemModel, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellDataNotification=ogCellDataNotification, ogUpsTable=ogUpsTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemEntry=ogCellModemEntry, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogStatus2Groups=ogStatus2Groups, ogHostName=ogHostName, ogWifiApEntry=ogWifiApEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsEntry=ogUpsEntry, ogAlarmDevice=ogAlarmDevice, ogCellMessageNotification=ogCellMessageNotification, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTable=ogEmdTable, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmState=ogAlarmState, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletTable=ogRpcOutletTable, ogUpsIndex=ogUpsIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsHumidity=ogUpsHumidity, ogCellModemTemperature=ogCellModemTemperature, ogCheckIndex=ogCheckIndex, ogMibNotifications=ogMibNotifications, ogEmdDioState=ogEmdDioState, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserIndex=ogHostUserIndex, ogRpcType=ogRpcType, ogStatus2Compliance=ogStatus2Compliance, ogRpcDescription=ogRpcDescription, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcOutletState=ogRpcOutletState, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceCounter=ogHostServiceCounter, ogCellModemIMSI=ogCellModemIMSI, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWebUserNotification=ogWebUserNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioName=ogEmdDioName, ogEmdConnectType=ogEmdConnectType, ogWifiApClientMac=ogWifiApClientMac, ogAlarmTime=ogAlarmTime, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsType=ogUpsType, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortCTS=ogSerialPortCTS, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellModemVendor=ogCellModemVendor, ogCellModemCounter=ogCellModemCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserIndex=ogSerialUserIndex, ogHostTable=ogHostTable, ogCellModemApn=ogCellModemApn, ogNetInterfaceEntry=ogNetInterfaceEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckResolveActions=ogCheckResolveActions, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialUserTable=ogSerialUserTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsInputNotification=ogUpsInputNotification, ogHostIndex=ogHostIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioNotification=ogEmdDioNotification, ogCellModemNetwork=ogCellModemNetwork, ogCellModemTable=ogCellModemTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserStartTime=ogWebUserStartTime, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientTable=ogWifiClientTable, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioTable=ogEmdDioTable, ogWebUserTable=ogWebUserTable, ogEmdEntry=ogEmdEntry, ogHostUserAddress=ogHostUserAddress, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServicePort=ogHostServicePort, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmName=ogAlarmName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogStatus2=ogStatus2, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioInputTotal=ogEmdDioInputTotal)
