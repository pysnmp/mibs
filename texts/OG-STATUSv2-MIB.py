...
TimeTicks, ObjectIdentity, Counter64, Counter32, iso, IpAddress, MibIdentifier, Integer32, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "Counter64", "Counter32", "iso", "IpAddress", "MibIdentifier", "Integer32", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "NotificationType")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortDCD=ogSerialPortDCD, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellApnNotification=ogCellApnNotification, ogStatus2Compliances=ogStatus2Compliances, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientRssi=ogWifiClientRssi, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellDataNotification=ogCellDataNotification, ogRpcOutletState=ogRpcOutletState, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientApMac=ogWifiClientApMac, ogEmdDescription=ogEmdDescription, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserNotification=ogWebUserNotification, ogAlarmState=ogAlarmState, ogSerialPortParity=ogSerialPortParity, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarm=ogAlarm, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortMode=ogSerialPortMode, ogUpsTable=ogUpsTable, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSystem=ogSystem, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletFrequency=ogRpcOutletFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioTable=ogEmdDioTable, ogUpsIndex=ogUpsIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApIndex=ogWifiApIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostUserTable=ogHostUserTable, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcDescription=ogRpcDescription, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputNotification=ogUpsOutputNotification, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceTable=ogHostServiceTable, ogCellNetworkNotification=ogCellNetworkNotification, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckDeviceName=ogCheckDeviceName, ogMibNotifications=ogMibNotifications, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientAp=ogWifiApClientAp, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialUserPort=ogSerialUserPort, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdHumidityName=ogEmdHumidityName, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckType=ogCheckType, ogHostServiceEntry=ogHostServiceEntry, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmType=ogAlarmType, ogSerialPortDSR=ogSerialPortDSR, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcIndex=ogRpcIndex, ogStatus2Groups=ogStatus2Groups, ogEmdName=ogEmdName, ogAlarmLogTable=ogAlarmLogTable, ogHostName=ogHostName, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmTime=ogAlarmTime, ogCellModemTable=ogCellModemTable, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsConnectType=ogUpsConnectType, ogStatus2=ogStatus2, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServicePort=ogHostServicePort, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmInstance=ogAlarmInstance, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientMode=ogWifiClientMode, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserName=ogHostUserName, ogStatus2Compliance=ogStatus2Compliance, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemIndex=ogCellModemIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckTable=ogCheckTable, ogUpsNotification=ogUpsNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogHostUserEntry=ogHostUserEntry, ogRpcTable=ogRpcTable, ogWifiApTxPower=ogWifiApTxPower, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogHostIndex=ogHostIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogHostTable=ogHostTable, ogWifiClientBitRate=ogWifiClientBitRate, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientEntry=ogWifiClientEntry, ogCustomNotification=ogCustomNotification, ogUpsType=ogUpsType, ogRpcName=ogRpcName, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletName=ogRpcOutletName, ogCellModemTower=ogCellModemTower, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmName=ogAlarmName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceHost=ogHostServiceHost, ogHostUserIndex=ogHostUserIndex, ogSerialUserEntry=ogSerialUserEntry, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckName=ogCheckName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWebUserStartTime=ogWebUserStartTime, ogWifiApEntry=ogWifiApEntry, ogSerialUserIndex=ogSerialUserIndex, ogEmdIndex=ogEmdIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmCheck=ogAlarmCheck, ogHostServiceNotification=ogHostServiceNotification, ogCellModemConnected=ogCellModemConnected, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioState=ogEmdDioState, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsInputCurrent=ogUpsInputCurrent, ogNetInterfaceType=ogNetInterfaceType, ogCellModemCounter=ogCellModemCounter, ogCellModemVendor=ogCellModemVendor, ogWebUserTable=ogWebUserTable, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckResolveActions=ogCheckResolveActions, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryState=ogUpsBatteryState, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemEntry=ogCellModemEntry, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortSpeed=ogSerialPortSpeed, ogCellTowerNotification=ogCellTowerNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsState=ogUpsState, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsCounter=ogUpsCounter, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserName=ogSerialUserName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserEntry=ogWebUserEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApFrequency=ogWifiApFrequency, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputPower=ogUpsOutputPower, ogHostEntry=ogHostEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcType=ogRpcType, ogUpsName=ogUpsName, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogHostUserAddress=ogHostUserAddress, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialNumber=ogSerialNumber, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserNotification=ogSerialUserNotification, ogEmdTable=ogEmdTable, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientCounter=ogWifiClientCounter, ogRpcCounter=ogRpcCounter, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialUserTable=ogSerialUserTable, ogEmdEntry=ogEmdEntry, ogWifiApInterface=ogWifiApInterface, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserHostName=ogHostUserHostName, ogEmdDioName=ogEmdDioName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientMac=ogWifiApClientMac, ogRpcInputNotification=ogRpcInputNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckEntry=ogCheckEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioEmd=ogEmdDioEmd, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioEntry=ogEmdDioEntry, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientTable=ogWifiClientTable, ogSerialPortCTS=ogSerialPortCTS, ogWifiApTable=ogWifiApTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemModel=ogCellModemModel, ogCellModemApn=ogCellModemApn, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApEnabled=ogWifiApEnabled, ogWebUserName=ogWebUserName, ogRpcConnectType=ogRpcConnectType, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyName=ogPowerSupplyName, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceStatus=ogHostServiceStatus, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmEventId=ogAlarmEventId, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostIpV4Address=ogHostIpV4Address, ogUpsDescription=ogUpsDescription, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckIndex=ogCheckIndex, ogUpsTemperature=ogUpsTemperature, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmUser=ogAlarmUser, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortTable=ogSerialPortTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsInputNotification=ogUpsInputNotification, ogHostServiceType=ogHostServiceType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserHost=ogHostUserHost, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsEntry=ogUpsEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientInterface=ogWifiClientInterface, ogCellSignalNotification=ogCellSignalNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostPingNotification=ogHostPingNotification, ogUpsHumidity=ogUpsHumidity, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcEntry=ogRpcEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioType=ogEmdDioType)
