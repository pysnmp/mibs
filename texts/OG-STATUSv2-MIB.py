...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortMode=ogSerialPortMode, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientAp=ogWifiApClientAp, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostUserHostName=ogHostUserHostName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmDevice=ogAlarmDevice, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientEntry=ogWifiClientEntry, ogStatus2Compliance=ogStatus2Compliance, ogCellModemCounter=ogCellModemCounter, ogEmdEnabled=ogEmdEnabled, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApEntry=ogWifiApEntry, ogEmdEntry=ogEmdEntry, ogCellApnNotification=ogCellApnNotification, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckName=ogCheckName, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdTable=ogEmdTable, ogSerialUserTable=ogSerialUserTable, ogCheckEntry=ogCheckEntry, ogWifiApInterface=ogWifiApInterface, ogUpsEntry=ogUpsEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSystem=ogSystem, ogWifiClientTxPower=ogWifiClientTxPower, ogWebUserTable=ogWebUserTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellTowerNotification=ogCellTowerNotification, ogStatus2Groups=ogStatus2Groups, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdDioState=ogEmdDioState, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDescription=ogEmdDescription, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientTable=ogWifiClientTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserEntry=ogHostUserEntry, ogHostUserAddress=ogHostUserAddress, ogWifiApClientIndex=ogWifiApClientIndex, ogCellMessageNotification=ogCellMessageNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserEntry=ogWebUserEntry, ogCellModemIMSI=ogCellModemIMSI, ogRpcType=ogRpcType, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletRpc=ogRpcOutletRpc, ogAlarmState=ogAlarmState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdName=ogEmdName, ogWebUserIndex=ogWebUserIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientInterface=ogWifiClientInterface, ogCellSignalNotification=ogCellSignalNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmTime=ogAlarmTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmName=ogAlarmName, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemTable=ogCellModemTable, ogWifiApCounter=ogWifiApCounter, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientEssid=ogWifiClientEssid, ogWebUserNotification=ogWebUserNotification, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceType=ogNetInterfaceType, ogUpsTemperature=ogUpsTemperature, ogHostServiceCounter=ogHostServiceCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientEntry=ogWifiApClientEntry, ogStatus2Conformance=ogStatus2Conformance, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemEnabled=ogCellModemEnabled, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemVendor=ogCellModemVendor, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostUserNotification=ogHostUserNotification, ogEmdIndex=ogEmdIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioEntry=ogEmdDioEntry, ogCellModemModel=ogCellModemModel, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioType=ogEmdDioType, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioIndex=ogEmdDioIndex, ogWifiApTxPower=ogWifiApTxPower, ogCheckDeviceName=ogCheckDeviceName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmLogTable=ogAlarmLogTable, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarmSummary=ogAlarmSummary, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortDTR=ogSerialPortDTR, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogHostTable=ogHostTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortDataBits=ogSerialPortDataBits, ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdConnectType=ogEmdConnectType, ogSerialUserName=ogSerialUserName, ogWifiApClientTable=ogWifiApClientTable, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserHost=ogHostUserHost, ogUpsCounter=ogUpsCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApSsid=ogWifiApSsid, ogAlarmLogEntry=ogAlarmLogEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarm=ogAlarm, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortIndex=ogSerialPortIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogMibNotifications=ogMibNotifications, ogStatus2Compliances=ogStatus2Compliances, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsIndex=ogUpsIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialNumber=ogSerialNumber, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmUser=ogAlarmUser, ogRpcOutletTotal=ogRpcOutletTotal, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemApn=ogCellModemApn, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsType=ogUpsType, ogWebUserName=ogWebUserName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckType=ogCheckType, ogCheckIndex=ogCheckIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemEntry=ogCellModemEntry, ogAlarmCheck=ogAlarmCheck, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcIndex=ogRpcIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletName=ogRpcOutletName, ogWifiApClientMac=ogWifiApClientMac, ogRpcCounter=ogRpcCounter, ogRpcName=ogRpcName, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceName=ogNetInterfaceName, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletTable=ogRpcOutletTable, ogHostUserTable=ogHostUserTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckTable=ogCheckTable, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserIndex=ogHostUserIndex, ogHostServiceEntry=ogHostServiceEntry, ogUpsConnectType=ogUpsConnectType, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletState=ogRpcOutletState, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmType=ogAlarmType, ogEmdDioTable=ogEmdDioTable, ogRpcTable=ogRpcTable, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortLabel=ogSerialPortLabel, ogCellModemTemperature=ogCellModemTemperature, ogCheckResolveActions=ogCheckResolveActions, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryState=ogUpsBatteryState, ogWifiApEnabled=ogWifiApEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemTower=ogCellModemTower, ogUpsHumidity=ogUpsHumidity, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostPingNotification=ogHostPingNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcConnectType=ogRpcConnectType, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputFrequency=ogUpsOutputFrequency)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcDescription=ogRpcDescription, ogWebUserStartTime=ogWebUserStartTime, ogAlarmEventId=ogAlarmEventId, ogHostServicePort=ogHostServicePort, ogUpsDescription=ogUpsDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmInstance=ogAlarmInstance, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmName=ogCurrentAlarmName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioDirection=ogEmdDioDirection, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostServiceNotification=ogHostServiceNotification, ogWifiApTable=ogWifiApTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioDescription=ogEmdDioDescription, ogCellModemIndex=ogCellModemIndex, ogUpsTable=ogUpsTable, ogUpsName=ogUpsName, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostIndex=ogHostIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioName=ogEmdDioName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyName=ogPowerSupplyName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortDCD=ogSerialPortDCD, ogHostUserName=ogHostUserName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceTable=ogHostServiceTable, ogHostName=ogHostName, ogRpcEntry=ogRpcEntry, ogStatus2=ogStatus2, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsNotification=ogUpsNotification, ogWifiClientMode=ogWifiClientMode, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortTable=ogSerialPortTable, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServiceType=ogHostServiceType, ogUpsState=ogUpsState, ogCellDataNotification=ogCellDataNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCustomNotification=ogCustomNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientRssi=ogWifiClientRssi, ogCellModemConnected=ogCellModemConnected, ogHostEntry=ogHostEntry, ogHostServiceIndex=ogHostServiceIndex, ogHostServiceHost=ogHostServiceHost)
