...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioCounter=ogEmdDioCounter, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialUserName=ogSerialUserName, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioState=ogEmdDioState, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmState=ogAlarmState, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletEntry=ogRpcOutletEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemTower=ogCellModemTower, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostUserEntry=ogHostUserEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortDCD=ogSerialPortDCD, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletTable=ogRpcOutletTable, ogAlarm=ogAlarm, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogStatus2Groups=ogStatus2Groups, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcEntry=ogRpcEntry, ogWebUserTable=ogWebUserTable, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckEntry=ogCheckEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcTable=ogRpcTable, ogRpcName=ogRpcName, ogEmdEnabled=ogEmdEnabled, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemEntry=ogCellModemEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWebUserNotification=ogWebUserNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckName=ogCheckName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcCounter=ogRpcCounter, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientTable=ogWifiApClientTable, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientCounter=ogWifiClientCounter, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletName=ogRpcOutletName, ogUpsEntry=ogUpsEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioEntry=ogEmdDioEntry, ogUpsTemperature=ogUpsTemperature, ogUpsTable=ogUpsTable, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemVendor=ogCellModemVendor, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceEntry=ogHostServiceEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmSummary=ogAlarmSummary, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsHumidity=ogUpsHumidity, ogHostServiceTable=ogHostServiceTable, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsType=ogUpsType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsInputNotification=ogUpsInputNotification, ogHostTable=ogHostTable, ogUpsName=ogUpsName, ogWifiClientApMac=ogWifiClientApMac, ogCheckIndex=ogCheckIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellSignalNotification=ogCellSignalNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortIndex=ogSerialPortIndex, ogNetInterfaceState=ogNetInterfaceState, ogSerialSignalNotification=ogSerialSignalNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellTowerNotification=ogCellTowerNotification, ogHostUserIndex=ogHostUserIndex, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemIMSI=ogCellModemIMSI, ogCheckTable=ogCheckTable, ogWifiApTable=ogWifiApTable, ogAlarmDevice=ogAlarmDevice, ogWifiClientMode=ogWifiClientMode, ogUpsConnectType=ogUpsConnectType, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcDescription=ogRpcDescription, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientInterface=ogWifiClientInterface, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmCheck=ogAlarmCheck, ogEmdIndex=ogEmdIndex, ogHostUserNotification=ogHostUserNotification, ogSystem=ogSystem, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortCTS=ogSerialPortCTS, ogAlarmType=ogAlarmType, ogHostUserAddress=ogHostUserAddress, ogEmdDescription=ogEmdDescription, ogHostIpV4Address=ogHostIpV4Address, ogStatus2Compliance=ogStatus2Compliance, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceCounter=ogHostServiceCounter, ogCellModemTemperature=ogCellModemTemperature, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioType=ogEmdDioType, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostServiceHost=ogHostServiceHost, ogAlarmEventId=ogAlarmEventId, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdDioName=ogEmdDioName, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcIndex=ogRpcIndex, ogEmdDioTable=ogEmdDioTable, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioEmd=ogEmdDioEmd, ogHostPingNotification=ogHostPingNotification, ogHostServiceType=ogHostServiceType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmName=ogAlarmName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyName=ogPowerSupplyName, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientTable=ogWifiClientTable, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioDescription=ogEmdDioDescription, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellMessageNotification=ogCellMessageNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogHostUserName=ogHostUserName, ogUpsIndex=ogUpsIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmTime=ogAlarmTime, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialNumber=ogSerialNumber, ogCellModemEnabled=ogCellModemEnabled, ogCellModemCounter=ogCellModemCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcInputVoltage=ogRpcInputVoltage, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserHostName=ogHostUserHostName, ogSerialUserIndex=ogSerialUserIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApSsid=ogWifiApSsid, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletState=ogRpcOutletState, ogHostEntry=ogHostEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApEntry=ogWifiApEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmInstance=ogAlarmInstance, ogUpsNotification=ogUpsNotification, ogCheckType=ogCheckType, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostUserHost=ogHostUserHost, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletLoad=ogRpcOutletLoad, ogHostServiceIndex=ogHostServiceIndex, ogEmdName=ogEmdName, ogWifiApInterface=ogWifiApInterface, ogUpsDescription=ogUpsDescription, ogEmdTable=ogEmdTable, ogCellModemModel=ogCellModemModel, ogCellDataNotification=ogCellDataNotification, ogWebUserName=ogWebUserName, ogWifiClientIndex=ogWifiClientIndex, ogMibNotifications=ogMibNotifications, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientIndex=ogWifiApClientIndex, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityTable=ogEmdHumidityTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogNetInterfaceName=ogNetInterfaceName, ogCellModemTable=ogCellModemTable, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCustomNotification=ogCustomNotification, ogWifiApEnabled=ogWifiApEnabled, PYSNMP_MODULE_ID=ogStatus2, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmUser=ogAlarmUser, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserTable=ogHostUserTable, ogHostIndex=ogHostIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserStartTime=ogHostUserStartTime, ogCellApnNotification=ogCellApnNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortParity=ogSerialPortParity, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientEnabled=ogWifiClientEnabled, ogHostName=ogHostName, ogSerialUserEntry=ogSerialUserEntry, ogCellModemConnected=ogCellModemConnected, ogNetInterfaceType=ogNetInterfaceType, ogStatus2=ogStatus2, ogUpsCounter=ogUpsCounter, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialUserPort=ogSerialUserPort, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcConnectType=ogRpcConnectType, ogSerialUserTable=ogSerialUserTable, ogWifiApTxPower=ogWifiApTxPower, ogCellModemApn=ogCellModemApn, ogSerialPortMode=ogSerialPortMode, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientRssi=ogWifiClientRssi, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdEntry=ogEmdEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServicePort=ogHostServicePort, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemIndex=ogCellModemIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioIndex=ogEmdDioIndex, ogRpcType=ogRpcType, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApCounter=ogWifiApCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsState=ogUpsState, ogRpcOutletTotal=ogRpcOutletTotal)
