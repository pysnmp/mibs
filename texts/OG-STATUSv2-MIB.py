...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, MibIdentifier, iso, Gauge32, Counter32, Integer32, Unsigned32, ModuleIdentity, NotificationType, Counter64, ObjectIdentity, TimeTicks, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "MibIdentifier", "iso", "Gauge32", "Counter32", "Integer32", "Unsigned32", "ModuleIdentity", "NotificationType", "Counter64", "ObjectIdentity", "TimeTicks", "IpAddress")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdLogEnabled=ogEmdLogEnabled, ogHostIpV6Address=ogHostIpV6Address, ogRpcIndex=ogRpcIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemTower=ogCellModemTower, ogCustomNotification=ogCustomNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostEntry=ogHostEntry, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialUserIndex=ogSerialUserIndex, ogHostIndex=ogHostIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioCounter=ogEmdDioCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarm=ogAlarm, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserNotification=ogHostUserNotification, ogAlarmEventId=ogAlarmEventId, ogWifiClientEssid=ogWifiClientEssid, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsName=ogUpsName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemTable=ogCellModemTable, ogSerialPortSpeed=ogSerialPortSpeed, ogStatus2Compliances=ogStatus2Compliances, ogUpsEntry=ogUpsEntry, ogRpcOutletTable=ogRpcOutletTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcName=ogRpcName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmUser=ogAlarmUser, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemApn=ogCellModemApn, ogStatus2Groups=ogStatus2Groups, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWebUserEntry=ogWebUserEntry, ogUpsNotification=ogUpsNotification, ogSerialPortMode=ogSerialPortMode, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcType=ogRpcType, ogUpsState=ogUpsState, ogNetInterfaceName=ogNetInterfaceName, ogWifiApCounter=ogWifiApCounter, ogWifiApTable=ogWifiApTable, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialUserLabel=ogSerialUserLabel, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckResolveActions=ogCheckResolveActions, ogUpsConnectType=ogUpsConnectType, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemVendor=ogCellModemVendor, ogCheckEntry=ogCheckEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogHostPingNotification=ogHostPingNotification, ogWebUserStartTime=ogWebUserStartTime, ogHostServiceHost=ogHostServiceHost, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortDTR=ogSerialPortDTR, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortIndex=ogSerialPortIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdName=ogEmdName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServiceEntry=ogHostServiceEntry, ogAlarmState=ogAlarmState, ogUpsTable=ogUpsTable, ogHostUserTable=ogHostUserTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdIndex=ogEmdIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientIndex=ogWifiApClientIndex, ogWebUserName=ogWebUserName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApIndex=ogWifiApIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcTable=ogRpcTable, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcEntry=ogRpcEntry, ogHostUserAddress=ogHostUserAddress, ogCheckIndex=ogCheckIndex, ogEmdHumidityName=ogEmdHumidityName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWebUserNotification=ogWebUserNotification, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdEntry=ogEmdEntry, ogRpcCounter=ogRpcCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWebUserIndex=ogWebUserIndex, ogUpsInputNotification=ogUpsInputNotification, ogCellModemIndex=ogCellModemIndex, ogAlarmTime=ogAlarmTime, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostTable=ogHostTable, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemEnabled=ogCellModemEnabled, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServiceNotification=ogHostServiceNotification, ogSerialUserName=ogSerialUserName, ogCheckType=ogCheckType, ogEmdDioName=ogEmdDioName, ogSystem=ogSystem, ogCellModemModel=ogCellModemModel, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserName=ogHostUserName, ogSerialPortParity=ogSerialPortParity, ogUpsIndex=ogUpsIndex, ogEmdConnectType=ogEmdConnectType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletTotal=ogRpcOutletTotal, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortEntry=ogSerialPortEntry, ogWifiApEntry=ogWifiApEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDescription=ogEmdDescription, ogWebUserTable=ogWebUserTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsType=ogUpsType, ogWifiClientCounter=ogWifiClientCounter, ogAlarmName=ogAlarmName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogStatus2=ogStatus2, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientMode=ogWifiClientMode, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioType=ogEmdDioType, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientInterface=ogWifiClientInterface, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostServicePort=ogHostServicePort, ogCellModem4gRssi=ogCellModem4gRssi, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryNotification=ogUpsBatteryNotification, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientTable=ogWifiApClientTable, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputPower=ogUpsOutputPower, ogCliUserSessionNotification=ogCliUserSessionNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckTable=ogCheckTable, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialUserPort=ogSerialUserPort, ogWifiApClientMac=ogWifiApClientMac, ogCheckName=ogCheckName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostServiceIndex=ogHostServiceIndex, ogSerialUserEntry=ogSerialUserEntry, ogUpsDescription=ogUpsDescription, ogAlarmType=ogAlarmType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmInstance=ogAlarmInstance, ogEmdDioNotification=ogEmdDioNotification, ogCellApnNotification=ogCellApnNotification, ogUpsCounter=ogUpsCounter, ogWifiClientRssi=ogWifiClientRssi, ogAlarmCheck=ogAlarmCheck, ogHostServiceTable=ogHostServiceTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdTable=ogEmdTable, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmDevice=ogAlarmDevice, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserEntry=ogHostUserEntry, ogCellModemCounter=ogCellModemCounter, ogCellModemNetwork=ogCellModemNetwork)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserHostName=ogHostUserHostName, ogCellDataNotification=ogCellDataNotification, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortTable=ogSerialPortTable, ogWifiClientTable=ogWifiClientTable, ogAlarmLogTable=ogAlarmLogTable, ogSerialNumber=ogSerialNumber, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsTemperature=ogUpsTemperature, ogCellModemEntry=ogCellModemEntry, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmSummary=ogAlarmSummary, ogHostName=ogHostName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcDescription=ogRpcDescription, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioState=ogEmdDioState, ogCellModemConnected=ogCellModemConnected, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceStatus=ogHostServiceStatus, ogHostIpV4Address=ogHostIpV4Address, ogHostServiceType=ogHostServiceType, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletState=ogRpcOutletState, ogSerialPatternNotification=ogSerialPatternNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioEmd=ogEmdDioEmd, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioIndex=ogEmdDioIndex, ogSerialUserTable=ogSerialUserTable, ogHostUserHost=ogHostUserHost, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletName=ogRpcOutletName, ogMibNotifications=ogMibNotifications, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientApMac=ogWifiClientApMac, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioTable=ogEmdDioTable, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2Compliance=ogStatus2Compliance, ogRpcConnectType=ogRpcConnectType, ogHostUserIndex=ogHostUserIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientConnectNotification=ogWifiClientConnectNotification)
