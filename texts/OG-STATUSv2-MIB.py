...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApEnabled=ogWifiApEnabled, ogRpcConnectType=ogRpcConnectType, ogUpsType=ogUpsType, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmState=ogAlarmState, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemEnabled=ogCellModemEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModem3gRssi=ogCellModem3gRssi, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckEntry=ogCheckEntry, ogCellTowerNotification=ogCellTowerNotification, ogUpsEntry=ogUpsEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellDataNotification=ogCellDataNotification, ogUpsTable=ogUpsTable, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortMode=ogSerialPortMode, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioIndex=ogEmdDioIndex, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientIndex=ogWifiApClientIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientEssid=ogWifiClientEssid, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityName=ogEmdHumidityName, ogAlarmEventId=ogAlarmEventId, ogEmdEnabled=ogEmdEnabled, ogHostUserTable=ogHostUserTable, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserTable=ogWebUserTable, ogEmdName=ogEmdName, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialUserName=ogSerialUserName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostServiceTable=ogHostServiceTable, ogHostUserAddress=ogHostUserAddress, ogSystem=ogSystem, ogSerialPortDCD=ogSerialPortDCD, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceHost=ogHostServiceHost, ogFirmwareVersion=ogFirmwareVersion, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApTable=ogWifiApTable, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputPower=ogUpsOutputPower, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcDescription=ogRpcDescription, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogNetInterfaceType=ogNetInterfaceType, ogRpcTable=ogRpcTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsNotification=ogUpsNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserName=ogHostUserName, ogCellModemConnected=ogCellModemConnected, PYSNMP_MODULE_ID=ogStatus2, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarm=ogAlarm, ogHostIpV4Address=ogHostIpV4Address, ogEmdIndex=ogEmdIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemVendor=ogCellModemVendor, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientApMac=ogWifiClientApMac, ogRpcName=ogRpcName, ogCellModemCounter=ogCellModemCounter, ogAlarmUser=ogAlarmUser, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmName=ogAlarmName, ogCellNetworkNotification=ogCellNetworkNotification, ogCellSignalNotification=ogCellSignalNotification, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserHostName=ogHostUserHostName, ogAlarmSummary=ogAlarmSummary, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogPowerSupplyName=ogPowerSupplyName, ogCellModemTower=ogCellModemTower, ogUpsCounter=ogUpsCounter, ogWifiApInterface=ogWifiApInterface, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortDataBits=ogSerialPortDataBits, ogCellMessageNotification=ogCellMessageNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserTable=ogSerialUserTable, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmTime=ogAlarmTime, ogMibNotifications=ogMibNotifications, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserNotification=ogHostUserNotification, ogHostTable=ogHostTable, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsTemperature=ogUpsTemperature, ogCheckIndex=ogCheckIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckName=ogCheckName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortParity=ogSerialPortParity, ogRpcIndex=ogRpcIndex, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserPort=ogSerialUserPort, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApIndex=ogWifiApIndex, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryState=ogUpsBatteryState, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserEntry=ogHostUserEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostPingNotification=ogHostPingNotification, ogSerialPortLabel=ogSerialPortLabel, ogAlarmCheck=ogAlarmCheck, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemNetwork=ogCellModemNetwork, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientMode=ogWifiClientMode, ogHostEntry=ogHostEntry, ogHostUserHost=ogHostUserHost, ogHostName=ogHostName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioType=ogEmdDioType, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemTemperature=ogCellModemTemperature, ogRpcCounter=ogRpcCounter, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdDioState=ogEmdDioState, ogEmdDioEmd=ogEmdDioEmd, ogCellModem4gRssi=ogCellModem4gRssi, ogNetInterfaceNotification=ogNetInterfaceNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioDirection=ogEmdDioDirection, ogUpsIndex=ogUpsIndex, ogCheckResolveActions=ogCheckResolveActions, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputNotification=ogUpsOutputNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemApn=ogCellModemApn, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2=ogStatus2, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientIndex=ogWifiClientIndex, ogSerialUserIndex=ogSerialUserIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostServiceNotification=ogHostServiceNotification, ogUpsInputNotification=ogUpsInputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostIndex=ogHostIndex, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletName=ogRpcOutletName, ogStatus2Compliances=ogStatus2Compliances, ogRpcInputFrequency=ogRpcInputFrequency, ogWebUserEntry=ogWebUserEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCustomNotification=ogCustomNotification, ogAlarmInstance=ogAlarmInstance, ogWifiApFrequency=ogWifiApFrequency, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsConnectType=ogUpsConnectType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsState=ogUpsState, ogEmdDioTable=ogEmdDioTable, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcEntry=ogRpcEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcType=ogRpcType, ogWebUserName=ogWebUserName, ogHostServicePort=ogHostServicePort, ogWifiApEntry=ogWifiApEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortTable=ogSerialPortTable, ogWifiApCounter=ogWifiApCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmType=ogAlarmType, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckTable=ogCheckTable, ogEmdDioCounter=ogEmdDioCounter, ogWifiApSsid=ogWifiApSsid, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientInterface=ogWifiClientInterface, ogUpsHumidity=ogUpsHumidity, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientMac=ogWifiApClientMac, ogCellModemTable=ogCellModemTable, ogRpcInputNotification=ogRpcInputNotification, ogEmdDescription=ogEmdDescription, ogWebUserStartTime=ogWebUserStartTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortDSR=ogSerialPortDSR, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdTable=ogEmdTable, ogCellModemModel=ogCellModemModel, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostServiceType=ogHostServiceType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientCounter=ogWifiClientCounter, ogStatus2Groups=ogStatus2Groups, ogUpsName=ogUpsName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostServiceStatus=ogHostServiceStatus, ogUpsDescription=ogUpsDescription, ogSerialNumber=ogSerialNumber, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialUserLabel=ogSerialUserLabel, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortRTS=ogSerialPortRTS, ogCellModemEntry=ogCellModemEntry, ogCheckType=ogCheckType, ogEmdDioName=ogEmdDioName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdEntry=ogEmdEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt)
