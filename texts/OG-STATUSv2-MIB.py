...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApIndex=ogWifiApIndex, ogStatus2Compliance=ogStatus2Compliance, ogEmdIndex=ogEmdIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckType=ogCheckType, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserName=ogWebUserName, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApFrequency=ogWifiApFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletNotification=ogRpcOutletNotification, ogHostIndex=ogHostIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckDeviceRef=ogCheckDeviceRef, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityNotification=ogEmdHumidityNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcName=ogRpcName, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmName=ogAlarmName, ogWebUserIndex=ogWebUserIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceEntry=ogHostServiceEntry, ogHostUserHostName=ogHostUserHostName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApTable=ogWifiApTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmState=ogAlarmState, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortDSR=ogSerialPortDSR, ogUpsName=ogUpsName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsEntry=ogUpsEntry, ogAlarm=ogAlarm, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmDevice=ogAlarmDevice, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientInterface=ogWifiClientInterface, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdName=ogEmdName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletState=ogRpcOutletState, ogAlarmEventId=ogAlarmEventId, ogSerialUserName=ogSerialUserName, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsHumidity=ogUpsHumidity, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostServiceIndex=ogHostServiceIndex, ogCellModemVendor=ogCellModemVendor, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsCounter=ogUpsCounter, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcEntry=ogRpcEntry, ogHostServiceType=ogHostServiceType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletTable=ogRpcOutletTable, ogCellModemEnabled=ogCellModemEnabled, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdHumidityName=ogEmdHumidityName, ogPowerSupplyName=ogPowerSupplyName, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceTable=ogHostServiceTable, ogRpcOutputNotification=ogRpcOutputNotification, ogHostUserEntry=ogHostUserEntry, ogHostUserNotification=ogHostUserNotification, ogHostUserTable=ogHostUserTable, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortMode=ogSerialPortMode, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientEntry=ogWifiClientEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmCheck=ogAlarmCheck, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientMode=ogWifiClientMode, ogHostName=ogHostName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmTime=ogAlarmTime, ogRpcInputNotification=ogRpcInputNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckResetTimeout=ogCheckResetTimeout, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioIndex=ogEmdDioIndex, ogEmdTable=ogEmdTable, ogHostUserStartTime=ogHostUserStartTime, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWebUserStartTime=ogWebUserStartTime, ogWifiApEntry=ogWifiApEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortTable=ogSerialPortTable, ogCheckDeviceTable=ogCheckDeviceTable, ogHostServiceHost=ogHostServiceHost, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemIndex=ogCellModemIndex, ogEmdDioState=ogEmdDioState, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioType=ogEmdDioType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserAddress=ogHostUserAddress, ogCellModemModel=ogCellModemModel, ogRpcConnectType=ogRpcConnectType, ogCellTowerNotification=ogCellTowerNotification, ogHostTable=ogHostTable, ogEmdDioEntry=ogEmdDioEntry, ogRpcDescription=ogRpcDescription, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserEntry=ogSerialUserEntry, ogCheckResolveActions=ogCheckResolveActions, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckEntry=ogCheckEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioDescription=ogEmdDioDescription, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortCTS=ogSerialPortCTS, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogFirmwareVersion=ogFirmwareVersion, ogCellModemEntry=ogCellModemEntry, ogSerialPortIndex=ogSerialPortIndex, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsConnectType=ogUpsConnectType, ogSerialPortDTR=ogSerialPortDTR, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientTable=ogWifiClientTable, ogRpcOutletIndex=ogRpcOutletIndex, ogWebUserTable=ogWebUserTable, ogSerialNumber=ogSerialNumber, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserTable=ogSerialUserTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientEssid=ogWifiClientEssid, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortParity=ogSerialPortParity, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcCounter=ogRpcCounter, ogEmdEntry=ogEmdEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostPingNotification=ogHostPingNotification, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserNotification=ogWebUserNotification, ogAlarmType=ogAlarmType, ogSerialPortDCD=ogSerialPortDCD, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemCounter=ogCellModemCounter, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdConnectType=ogEmdConnectType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogNetInterfaceName=ogNetInterfaceName, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServicePort=ogHostServicePort, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputPower=ogUpsOutputPower, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModemApn=ogCellModemApn, ogWifiApSsid=ogWifiApSsid, ogCheckName=ogCheckName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostServiceNotification=ogHostServiceNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortEntry=ogSerialPortEntry, ogMibNotifications=ogMibNotifications, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientCounter=ogWifiClientCounter, ogCellModemConnected=ogCellModemConnected, ogCheckIndex=ogCheckIndex, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogStatus2Groups=ogStatus2Groups)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsIndex=ogUpsIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientApMac=ogWifiClientApMac, ogUpsDescription=ogUpsDescription, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioName=ogEmdDioName, ogStatus2=ogStatus2, ogEmdDescription=ogEmdDescription, ogAlarmSummary=ogAlarmSummary, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsType=ogUpsType, ogRpcIndex=ogRpcIndex, ogNetInterfaceState=ogNetInterfaceState, ogCellModemTower=ogCellModemTower, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserHost=ogHostUserHost, ogHostEntry=ogHostEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialUserPort=ogSerialUserPort, ogHostIpV4Address=ogHostIpV4Address, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsTable=ogUpsTable, ogWifiApEnabled=ogWifiApEnabled, ogCellApnNotification=ogCellApnNotification, ogRpcTable=ogRpcTable, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioDirection=ogEmdDioDirection, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioTable=ogEmdDioTable, ogHostUserName=ogHostUserName, ogCellModemTable=ogCellModemTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostUserIndex=ogHostUserIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcType=ogRpcType, ogWifiApInterface=ogWifiApInterface, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckTable=ogCheckTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsState=ogUpsState, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcOutletName=ogRpcOutletName, ogUpsNotification=ogUpsNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogSystem=ogSystem, ogAlarmInstance=ogAlarmInstance, ogAlarmUser=ogAlarmUser, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCustomNotification=ogCustomNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortRxBytes=ogSerialPortRxBytes)
