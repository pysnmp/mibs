...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortDCD=ogSerialPortDCD, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemModel=ogCellModemModel, ogEmdDioIndex=ogEmdDioIndex, ogCheckType=ogCheckType, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialUserTable=ogSerialUserTable, ogWifiApCounter=ogWifiApCounter, ogHostUserTable=ogHostUserTable, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortLabel=ogSerialPortLabel, ogAlarmState=ogAlarmState, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcName=ogRpcName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserLabel=ogSerialUserLabel, ogCellModemSessionTime=ogCellModemSessionTime, ogCellSignalNotification=ogCellSignalNotification, ogWifiApSsid=ogWifiApSsid, ogHostServiceHost=ogHostServiceHost, ogSerialUserName=ogSerialUserName, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientTxPower=ogWifiClientTxPower, ogStatus2Compliance=ogStatus2Compliance, ogAlarmInstance=ogAlarmInstance, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortCTS=ogSerialPortCTS, ogCellDataNotification=ogCellDataNotification, ogFirmwareVersion=ogFirmwareVersion, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApInterface=ogWifiApInterface, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdConnectType=ogEmdConnectType, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioNotification=ogEmdDioNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioName=ogEmdDioName, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcConnectType=ogRpcConnectType, ogAlarmLogTable=ogAlarmLogTable, ogUpsHumidity=ogUpsHumidity, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcDescription=ogRpcDescription, ogCellModemVendor=ogCellModemVendor, ogWifiClientEntry=ogWifiClientEntry, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioDirection=ogEmdDioDirection, ogUpsTemperature=ogUpsTemperature, ogHostUserName=ogHostUserName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsIndex=ogUpsIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortEntry=ogSerialPortEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmEventId=ogAlarmEventId, ogHostTable=ogHostTable, ogCellModemApn=ogCellModemApn, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmCheck=ogAlarmCheck, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortParity=ogSerialPortParity, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostPingNotification=ogHostPingNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogNetInterfaceName=ogNetInterfaceName, ogStatus2Groups=ogStatus2Groups, ogEmdIndex=ogEmdIndex, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogMibNotifications=ogMibNotifications, ogAlarmName=ogAlarmName, ogWebUserNotification=ogWebUserNotification, ogHostServiceType=ogHostServiceType, PYSNMP_MODULE_ID=ogStatus2, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcLogEnabled=ogRpcLogEnabled, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDescription=ogEmdDescription, ogUpsType=ogUpsType, ogSerialNumber=ogSerialNumber, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmUser=ogCurrentAlarmUser, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortMode=ogSerialPortMode, ogCellModemIndex=ogCellModemIndex, ogCheckName=ogCheckName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckEntry=ogCheckEntry, ogRpcOutletName=ogRpcOutletName, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortTable=ogSerialPortTable, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemIMSI=ogCellModemIMSI, ogHostServiceNotification=ogHostServiceNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemTemperature=ogCellModemTemperature, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialSignalNotification=ogSerialSignalNotification, ogStatus2=ogStatus2, ogEmdEntry=ogEmdEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserNotification=ogHostUserNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsTable=ogUpsTable, ogUpsCounter=ogUpsCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemTable=ogCellModemTable, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientIndex=ogWifiClientIndex, ogNetInterfaceType=ogNetInterfaceType, ogHostUserEntry=ogHostUserEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientEnabled=ogWifiClientEnabled, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApFrequency=ogWifiApFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemNetwork=ogCellModemNetwork, ogUpsNotification=ogUpsNotification, ogUpsState=ogUpsState, ogSystem=ogSystem, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletNotification=ogRpcOutletNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientAp=ogWifiApClientAp, ogRpcEntry=ogRpcEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWebUserTable=ogWebUserTable, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmType=ogAlarmType, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyName=ogPowerSupplyName, ogUpsOutputPower=ogUpsOutputPower, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmUser=ogAlarmUser, ogCustomNotification=ogCustomNotification, ogHostEntry=ogHostEntry, ogCheckIndex=ogCheckIndex, ogStatus2Compliances=ogStatus2Compliances, ogUpsName=ogUpsName, ogCheckDeviceName=ogCheckDeviceName, ogEmdDioTable=ogEmdDioTable, ogEmdName=ogEmdName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialUserPort=ogSerialUserPort, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogHostUserHostName=ogHostUserHostName, ogHostServiceIndex=ogHostServiceIndex, ogAlarm=ogAlarm, ogUpsDescription=ogUpsDescription, ogHostServicePort=ogHostServicePort, ogUpsConnectType=ogUpsConnectType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientTable=ogWifiApClientTable, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWebUserStartTime=ogWebUserStartTime, ogCellMessageNotification=ogCellMessageNotification, ogHostUserHost=ogHostUserHost, ogWifiClientTable=ogWifiClientTable, ogHostIndex=ogHostIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialUserNotification=ogSerialUserNotification, ogAlarmTime=ogAlarmTime, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostIpV6Address=ogHostIpV6Address, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortDTR=ogSerialPortDTR, ogWifiApTxPower=ogWifiApTxPower, ogEmdTable=ogEmdTable, ogRpcCounter=ogRpcCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApIndex=ogWifiApIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserEntry=ogWebUserEntry, ogAlarmSummary=ogAlarmSummary, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioState=ogEmdDioState, ogHostServiceTable=ogHostServiceTable, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApTable=ogWifiApTable, ogRpcOutletEntry=ogRpcOutletEntry, ogWebUserName=ogWebUserName, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientRssi=ogWifiClientRssi, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserIndex=ogHostUserIndex, ogCellModemCounter=ogCellModemCounter, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcType=ogRpcType, ogCellModemTower=ogCellModemTower, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioType=ogEmdDioType, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApEntry=ogWifiApEntry, ogWifiApEnabled=ogWifiApEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletState=ogRpcOutletState, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceEntry=ogNetInterfaceEntry, ogNetInterfaceState=ogNetInterfaceState, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostName=ogHostName, ogCheckTable=ogCheckTable, ogCellModemConnected=ogCellModemConnected, ogRpcTable=ogRpcTable, ogWifiClientCounter=ogWifiClientCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsEntry=ogUpsEntry, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcIndex=ogRpcIndex, ogSerialPortDSR=ogSerialPortDSR, ogCellModemEnabled=ogCellModemEnabled, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue)
