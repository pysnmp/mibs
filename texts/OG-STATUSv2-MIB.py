...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserName=ogHostUserName, ogCellModemConnected=ogCellModemConnected, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserPort=ogSerialUserPort, ogCellModemTower=ogCellModemTower, ogRpcCounter=ogRpcCounter, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdName=ogEmdName, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsName=ogUpsName, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialNumber=ogSerialNumber, ogHostName=ogHostName, ogRpcEntry=ogRpcEntry, ogHostServiceType=ogHostServiceType, ogRpcIndex=ogRpcIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWebUserNotification=ogWebUserNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemIMSI=ogCellModemIMSI, ogEmdIndex=ogEmdIndex, ogCellApnNotification=ogCellApnNotification, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientAp=ogWifiApClientAp, ogCellModemTable=ogCellModemTable, ogRpcDescription=ogRpcDescription, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletIndex=ogRpcOutletIndex, ogSystem=ogSystem, ogWebUserEntry=ogWebUserEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogHostPingNotification=ogHostPingNotification, ogSerialPortParity=ogSerialPortParity, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsType=ogUpsType, ogSerialPortLabel=ogSerialPortLabel, ogStatus2Groups=ogStatus2Groups, ogCellMessageNotification=ogCellMessageNotification, ogHostServiceStatus=ogHostServiceStatus, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsEntry=ogUpsEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsInputNotification=ogUpsInputNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientRssi=ogWifiApClientRssi, ogStatus2Compliance=ogStatus2Compliance, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApCounter=ogWifiApCounter, ogRpcOutletName=ogRpcOutletName, ogEmdDioName=ogEmdDioName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortTable=ogSerialPortTable, ogUpsInputVoltage=ogUpsInputVoltage, ogAlarmName=ogAlarmName, ogCellModemModel=ogCellModemModel, ogHostServiceNotification=ogHostServiceNotification, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemTemperature=ogCellModemTemperature, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyName=ogPowerSupplyName, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckIndex=ogCheckIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsConnectType=ogUpsConnectType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDescription=ogEmdDescription, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTable=ogEmdTable, ogWifiClientEntry=ogWifiClientEntry, ogWebUserIndex=ogWebUserIndex, ogWifiApInterface=ogWifiApInterface, ogMibNotifications=ogMibNotifications, ogWifiClientMode=ogWifiClientMode, ogWifiClientTable=ogWifiClientTable, ogWifiApSsid=ogWifiApSsid, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcType=ogRpcType, ogWebUserName=ogWebUserName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialUserLabel=ogSerialUserLabel, ogAlarmEventId=ogAlarmEventId, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioState=ogEmdDioState, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortCTS=ogSerialPortCTS, ogRpcTable=ogRpcTable, ogAlarmTime=ogAlarmTime, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApEnabled=ogWifiApEnabled, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostServicePort=ogHostServicePort, ogHostServiceCounter=ogHostServiceCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdEnabled=ogEmdEnabled, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsNotification=ogUpsNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckEntry=ogCheckEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostServiceHost=ogHostServiceHost, ogUpsCounter=ogUpsCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemIndex=ogCellModemIndex, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsDescription=ogUpsDescription, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostUserTable=ogHostUserTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialPortDTR=ogSerialPortDTR, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientTable=ogWifiApClientTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemRegistered=ogCellModemRegistered, ogUpsTable=ogUpsTable, ogRpcName=ogRpcName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellDataNotification=ogCellDataNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApTable=ogWifiApTable, ogAlarm=ogAlarm, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdConnectType=ogEmdConnectType, ogRpcOutletState=ogRpcOutletState, ogWifiApIndex=ogWifiApIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioType=ogEmdDioType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogNetInterfaceIndex=ogNetInterfaceIndex, ogStatus2=ogStatus2, ogEmdTemperatureTable=ogEmdTemperatureTable, ogStatus2Compliances=ogStatus2Compliances, ogAlarmCheck=ogAlarmCheck, ogCellSignalNotification=ogCellSignalNotification, ogAlarmUser=ogAlarmUser, ogSerialPortDSR=ogSerialPortDSR, ogCellModemApn=ogCellModemApn, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserNotification=ogSerialUserNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogWebUserTable=ogWebUserTable, ogWebUserStartTime=ogWebUserStartTime, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientApMac=ogWifiClientApMac, ogCheckType=ogCheckType, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdEntry=ogEmdEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemEntry=ogCellModemEntry, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserHost=ogHostUserHost, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioCounter=ogEmdDioCounter, ogAlarmState=ogAlarmState, ogSerialUserIndex=ogSerialUserIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioDescription=ogEmdDioDescription, ogUpsHumidity=ogUpsHumidity, ogWifiClientCounter=ogWifiClientCounter, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcInputNotification=ogRpcInputNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyTable=ogPowerSupplyTable, ogHostUserEntry=ogHostUserEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioNotification=ogEmdDioNotification, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceName=ogCheckDeviceName, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletTable=ogRpcOutletTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellTowerNotification=ogCellTowerNotification, ogAlarmDevice=ogAlarmDevice, ogHostUserAddress=ogHostUserAddress, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogHostIndex=ogHostIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmType=ogAlarmType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserHostName=ogHostUserHostName, ogCustomNotification=ogCustomNotification, ogHostUserNotification=ogHostUserNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostUserStartTime=ogHostUserStartTime, ogStatus2Conformance=ogStatus2Conformance, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostEntry=ogHostEntry, ogHostServiceTable=ogHostServiceTable, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsState=ogUpsState, ogWifiClientIndex=ogWifiClientIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmSummary=ogAlarmSummary, ogCheckTable=ogCheckTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialUserName=ogSerialUserName, ogSerialPortIndex=ogSerialPortIndex, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortMode=ogSerialPortMode, ogUpsIndex=ogUpsIndex, ogCellModemVendor=ogCellModemVendor, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientInterface=ogWifiClientInterface, ogUpsTemperature=ogUpsTemperature, ogHostTable=ogHostTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortDCD=ogSerialPortDCD, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioTable=ogEmdDioTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioEmd=ogEmdDioEmd, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarmInstance=ogAlarmInstance, ogFirmwareVersion=ogFirmwareVersion, ogWifiApTxPower=ogWifiApTxPower, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckName=ogCheckName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostIpV4Address=ogHostIpV4Address, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityEmd=ogEmdHumidityEmd, ogHostUserIndex=ogHostUserIndex)
