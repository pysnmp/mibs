...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemRegistered=ogCellModemRegistered, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioName=ogEmdDioName, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdLogEnabled=ogEmdLogEnabled, ogHostServiceType=ogHostServiceType, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientMode=ogWifiClientMode, ogCellModemTable=ogCellModemTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemIndex=ogCellModemIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogWebUserTable=ogWebUserTable, ogWebUserNotification=ogWebUserNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserEntry=ogHostUserEntry, ogSerialNumber=ogSerialNumber, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApInterface=ogWifiApInterface, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletName=ogRpcOutletName, ogAlarmSummary=ogAlarmSummary, ogHostUserIndex=ogHostUserIndex, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletTotal=ogRpcOutletTotal, ogCellSignalNotification=ogCellSignalNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialUserLabel=ogSerialUserLabel, ogAlarm=ogAlarm, ogHostTable=ogHostTable, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyName=ogPowerSupplyName, ogUpsIndex=ogUpsIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmType=ogAlarmType, ogEmdHumidityValue=ogEmdHumidityValue, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcConnectType=ogRpcConnectType, ogCellModemEntry=ogCellModemEntry, ogUpsTable=ogUpsTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortEntry=ogSerialPortEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserName=ogHostUserName, ogCellTowerNotification=ogCellTowerNotification, ogUpsName=ogUpsName, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortLabel=ogSerialPortLabel, ogEmdDioState=ogEmdDioState, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsHumidity=ogUpsHumidity, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemApn=ogCellModemApn, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortTable=ogSerialPortTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostServiceStatus=ogHostServiceStatus, ogRpcEntry=ogRpcEntry, ogCellModemTower=ogCellModemTower, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostUserTable=ogHostUserTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApTable=ogWifiApTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostIndex=ogHostIndex, ogEmdTable=ogEmdTable, ogCheckTable=ogCheckTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcName=ogRpcName, ogSerialUserName=ogSerialUserName, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckType=ogCheckType, ogStatus2Compliances=ogStatus2Compliances, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmInstance=ogAlarmInstance, ogEmdDescription=ogEmdDescription, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostEntry=ogHostEntry, ogMibNotifications=ogMibNotifications, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostServiceIndex=ogHostServiceIndex, ogCellModemTemperature=ogCellModemTemperature, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioType=ogEmdDioType, ogSystem=ogSystem, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientMac=ogWifiApClientMac, ogAlarmDevice=ogAlarmDevice, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdIndex=ogEmdIndex, ogSerialUserEntry=ogSerialUserEntry, ogUpsDescription=ogUpsDescription, ogUpsBatteryState=ogUpsBatteryState, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsNotification=ogUpsNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientTable=ogWifiClientTable, ogHostUserHostName=ogHostUserHostName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialUserStartTime=ogSerialUserStartTime, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserStartTime=ogHostUserStartTime, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModem4gRssi=ogCellModem4gRssi, ogHostPingNotification=ogHostPingNotification, ogSerialPortDTR=ogSerialPortDTR, ogEmdEntry=ogEmdEntry, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserPort=ogSerialUserPort, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckResolveActions=ogCheckResolveActions, ogHostName=ogHostName, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortMode=ogSerialPortMode, ogEmdDioDescription=ogEmdDioDescription, ogNetInterfaceName=ogNetInterfaceName, ogEmdConnectType=ogEmdConnectType, ogHostServiceTable=ogHostServiceTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserHost=ogHostUserHost, ogAlarmCurrentValue=ogAlarmCurrentValue, ogStatus2=ogStatus2, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemIMSI=ogCellModemIMSI, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServicePort=ogHostServicePort, ogCheckDeviceName=ogCheckDeviceName, ogCellModemVendor=ogCellModemVendor, ogCheckName=ogCheckName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmState=ogAlarmState, ogUpsCounter=ogUpsCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcTable=ogRpcTable, ogRpcOutletState=ogRpcOutletState, ogHostUserAddress=ogHostUserAddress, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApFrequency=ogWifiApFrequency, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemEnabled=ogCellModemEnabled, ogUpsInputCurrent=ogUpsInputCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientInterface=ogWifiClientInterface, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioIndex=ogEmdDioIndex, ogRpcCounter=ogRpcCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortCTS=ogSerialPortCTS, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletEntry=ogRpcOutletEntry, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckIndex=ogCheckIndex, ogStatus2Groups=ogStatus2Groups, ogPowerSupplyIndex=ogPowerSupplyIndex, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApSsid=ogWifiApSsid, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcType=ogRpcType, ogRpcDescription=ogRpcDescription, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemNetwork=ogCellModemNetwork, ogEmdName=ogEmdName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsType=ogUpsType, ogCellApnNotification=ogCellApnNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmName=ogAlarmName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostServiceHost=ogHostServiceHost, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckEntry=ogCheckEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialUserNotification=ogSerialUserNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortDSR=ogSerialPortDSR, ogUpsState=ogUpsState, ogCustomNotification=ogCustomNotification, ogWifiApIndex=ogWifiApIndex, ogRpcIndex=ogRpcIndex, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientRssi=ogWifiClientRssi, ogEmdDioTable=ogEmdDioTable, ogSerialPortIndex=ogSerialPortIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogStatus2Compliance=ogStatus2Compliance, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemCounter=ogCellModemCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortParity=ogSerialPortParity, ogAlarmCheck=ogAlarmCheck, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientCounter=ogWifiClientCounter, ogWebUserName=ogWebUserName, ogAlarmEventId=ogAlarmEventId, ogHostUserNotification=ogHostUserNotification, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellDataNotification=ogCellDataNotification, ogSerialUserTable=ogSerialUserTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApTxPower=ogWifiApTxPower, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmTime=ogAlarmTime, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortSpeed=ogSerialPortSpeed, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsEntry=ogUpsEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemModel=ogCellModemModel, ogSerialUserIndex=ogSerialUserIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApEntry=ogWifiApEntry, ogUpsTemperature=ogUpsTemperature, ogCellModemConnected=ogCellModemConnected, ogAlarmUser=ogAlarmUser, ogWifiClientBitRate=ogWifiClientBitRate, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortRTS=ogSerialPortRTS, ogUpsOutputNotification=ogUpsOutputNotification)
