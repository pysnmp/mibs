...
ModuleIdentity, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, iso, ObjectIdentity, NotificationType, Counter64, Counter32, Bits, IpAddress, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "iso", "ObjectIdentity", "NotificationType", "Counter64", "Counter32", "Bits", "IpAddress", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostIndex=ogHostIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserName=ogHostUserName, ogWifiClientCounter=ogWifiClientCounter, ogSerialUserStartTime=ogSerialUserStartTime, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApIeeeMode=ogWifiApIeeeMode, ogStatus2Compliances=ogStatus2Compliances, ogEmdTable=ogEmdTable, ogAlarmType=ogAlarmType, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioDescription=ogEmdDioDescription, ogHostUserNotification=ogHostUserNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortTable=ogSerialPortTable, ogHostPingNotification=ogHostPingNotification, ogCheckTable=ogCheckTable, ogWifiClientEntry=ogWifiClientEntry, ogCheckName=ogCheckName, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApInterface=ogWifiApInterface, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletTable=ogRpcOutletTable, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSystem=ogSystem, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceCounter=ogHostServiceCounter, ogSerialUserLabel=ogSerialUserLabel, ogWebUserName=ogWebUserName, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsIndex=ogUpsIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialUserPort=ogSerialUserPort, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemRegistered=ogCellModemRegistered, ogRpcLogEnabled=ogRpcLogEnabled, ogCheckType=ogCheckType, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdIndex=ogEmdIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortLabel=ogSerialPortLabel, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsInputVoltage=ogUpsInputVoltage, ogHostUserTable=ogHostUserTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemTable=ogCellModemTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserNotification=ogWebUserNotification, ogWifiApFrequency=ogWifiApFrequency, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserEntry=ogHostUserEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostEntry=ogHostEntry, ogUpsTable=ogUpsTable, ogRpcType=ogRpcType, ogAlarmName=ogAlarmName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2Groups=ogStatus2Groups, ogCellModemVendor=ogCellModemVendor, ogHostUserHostName=ogHostUserHostName, ogEmdDioTable=ogEmdDioTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckIndex=ogCheckIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortIndex=ogSerialPortIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioState=ogEmdDioState, ogRpcInputVoltage=ogRpcInputVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientMac=ogWifiApClientMac, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletState=ogRpcOutletState, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogStatus2Compliance=ogStatus2Compliance, ogAlarm=ogAlarm, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcDescription=ogRpcDescription, ogUpsNotification=ogUpsNotification, ogFirmwareVersion=ogFirmwareVersion, ogRpcName=ogRpcName, ogHostServiceHost=ogHostServiceHost, ogUpsState=ogUpsState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCustomNotification=ogCustomNotification, ogCellModemEntry=ogCellModemEntry, ogHostTable=ogHostTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApEnabled=ogWifiApEnabled, ogEmdDescription=ogEmdDescription, ogUpsEntry=ogUpsEntry, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceState=ogNetInterfaceState, ogAlarmTime=ogAlarmTime, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletName=ogRpcOutletName, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemTower=ogCellModemTower, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmCheck=ogAlarmCheck, ogAlarmState=ogAlarmState, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientTable=ogWifiApClientTable, ogRpcCounter=ogRpcCounter, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemCounter=ogCellModemCounter, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemIndex=ogCellModemIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioCounter=ogEmdDioCounter, ogAlarmUser=ogAlarmUser, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioType=ogEmdDioType, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcIndex=ogRpcIndex, ogEmdEntry=ogEmdEntry, ogRpcTable=ogRpcTable, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsType=ogUpsType, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientInterface=ogWifiClientInterface, ogHostIpV6Address=ogHostIpV6Address, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputCurrent=ogUpsInputCurrent, ogCliUserSessionNotification=ogCliUserSessionNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogMibNotifications=ogMibNotifications, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceStatus=ogHostServiceStatus, ogCellDataNotification=ogCellDataNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostServicePort=ogHostServicePort, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceName=ogNetInterfaceName, ogUpsTemperature=ogUpsTemperature, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialNumber=ogSerialNumber, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApSsid=ogWifiApSsid, ogHostUserHost=ogHostUserHost, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostName=ogHostName, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemModel=ogCellModemModel, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortMode=ogSerialPortMode, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortCTS=ogSerialPortCTS, ogAlarmSummary=ogAlarmSummary, ogRpcEntry=ogRpcEntry, ogWebUserTable=ogWebUserTable, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientEssid=ogWifiClientEssid, ogWifiApEntry=ogWifiApEntry, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioName=ogEmdDioName, ogCellModemNetwork=ogCellModemNetwork, ogStatus2=ogStatus2, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortDTR=ogSerialPortDTR, ogEmdEnabled=ogEmdEnabled, ogHostUserAddress=ogHostUserAddress, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckResolveActions=ogCheckResolveActions, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, PYSNMP_MODULE_ID=ogStatus2, ogCellApnNotification=ogCellApnNotification, ogCellModemApn=ogCellModemApn, ogCellModemEnabled=ogCellModemEnabled, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyTable=ogPowerSupplyTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityName=ogEmdHumidityName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortDSR=ogSerialPortDSR, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientSignalNotification=ogWifiClientSignalNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsCounter=ogUpsCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogAlarmLogTable=ogAlarmLogTable, ogEmdConnectType=ogEmdConnectType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApClientEntry=ogWifiApClientEntry, ogHostUserStartTime=ogHostUserStartTime, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryState=ogUpsBatteryState, ogCellModemConnected=ogCellModemConnected, ogSerialPortEntry=ogSerialPortEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsDescription=ogUpsDescription, ogWifiClientApMac=ogWifiClientApMac, ogWifiApCounter=ogWifiApCounter, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcConnectType=ogRpcConnectType, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortRTS=ogSerialPortRTS, ogUpsName=ogUpsName, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceTable=ogHostServiceTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApIndex=ogWifiApIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserName=ogSerialUserName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserEntry=ogWebUserEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdName=ogEmdName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortParity=ogSerialPortParity, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmInstance=ogAlarmInstance, ogWifiApClientAp=ogWifiApClientAp, ogCheckEntry=ogCheckEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioDirection=ogEmdDioDirection, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientMode=ogWifiClientMode, ogWifiApTable=ogWifiApTable, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputPower=ogUpsOutputPower, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialUserTable=ogSerialUserTable, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostServiceType=ogHostServiceType)
