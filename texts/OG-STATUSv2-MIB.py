...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdLogEnabled=ogEmdLogEnabled, ogHostName=ogHostName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsType=ogUpsType, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcName=ogRpcName, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemConnected=ogCellModemConnected, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApEnabled=ogWifiApEnabled, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostUserEntry=ogHostUserEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserHostName=ogHostUserHostName, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsCounter=ogUpsCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsHumidity=ogUpsHumidity, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortDataBits=ogSerialPortDataBits, ogFirmwareVersion=ogFirmwareVersion, ogEmdDioState=ogEmdDioState, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientTable=ogWifiApClientTable, ogWebUserEntry=ogWebUserEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceEntry=ogHostServiceEntry, ogStatus2Compliance=ogStatus2Compliance, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckType=ogCheckType, ogCellModemTemperature=ogCellModemTemperature, ogCheckIndex=ogCheckIndex, ogCellModemIndex=ogCellModemIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortDCD=ogSerialPortDCD, ogCellModemModel=ogCellModemModel, ogEmdDioTable=ogEmdDioTable, ogRpcIndex=ogRpcIndex, ogWebUserStartTime=ogWebUserStartTime, ogEmdEntry=ogEmdEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckResolveActions=ogCheckResolveActions, ogAlarm=ogAlarm, ogCellSignalNotification=ogCellSignalNotification, ogEmdDioDirection=ogEmdDioDirection, ogMibNotifications=ogMibNotifications, ogEmdDioNotification=ogEmdDioNotification, ogAlarmState=ogAlarmState, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmEventId=ogAlarmEventId, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemTable=ogCellModemTable, ogSerialUserNotification=ogSerialUserNotification, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientEssid=ogWifiClientEssid, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortCTS=ogSerialPortCTS, ogWifiApIndex=ogWifiApIndex, ogWifiClientMode=ogWifiClientMode, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortMode=ogSerialPortMode, ogSerialNumber=ogSerialNumber, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsIndex=ogUpsIndex, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsName=ogUpsName, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmSummary=ogAlarmSummary, ogSerialUserName=ogSerialUserName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceName=ogCheckDeviceName, ogEmdName=ogEmdName, ogWifiClientTable=ogWifiClientTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcConnectType=ogRpcConnectType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemEntry=ogCellModemEntry, ogUpsNotification=ogUpsNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCustomNotification=ogCustomNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsEntry=ogUpsEntry, ogHostUserTable=ogHostUserTable, ogWifiApClientAp=ogWifiApClientAp, ogAlarmCheck=ogAlarmCheck, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientApMac=ogWifiClientApMac, ogAlarmTime=ogAlarmTime, ogEmdHumidityName=ogEmdHumidityName, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcDescription=ogRpcDescription, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputPower=ogUpsOutputPower, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortEntry=ogSerialPortEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortLabel=ogSerialPortLabel, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmDevice=ogAlarmDevice, ogWebUserNotification=ogWebUserNotification, ogHostIndex=ogHostIndex, ogCellModemCounter=ogCellModemCounter, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserName=ogWebUserName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmUser=ogAlarmUser, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostEntry=ogHostEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserHost=ogHostUserHost, ogHostTable=ogHostTable, ogSerialUserEntry=ogSerialUserEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApEntry=ogWifiApEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApFrequency=ogWifiApFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientCounter=ogWifiClientCounter, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientIndex=ogWifiClientIndex, ogCheckTable=ogCheckTable, ogEmdTable=ogEmdTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletState=ogRpcOutletState, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModemTower=ogCellModemTower, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApCounter=ogWifiApCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckEntry=ogCheckEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryState=ogUpsBatteryState, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceHost=ogHostServiceHost, ogUpsTemperature=ogUpsTemperature, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellApnNotification=ogCellApnNotification, ogRpcEntry=ogRpcEntry, ogHostServicePort=ogHostServicePort, ogWifiApSsid=ogWifiApSsid, ogCellModemNetwork=ogCellModemNetwork, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcType=ogRpcType, ogRpcCounter=ogRpcCounter, ogSerialPortParity=ogSerialPortParity, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdIndex=ogEmdIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserIndex=ogWebUserIndex, ogHostServiceType=ogHostServiceType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserStartTime=ogHostUserStartTime, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletName=ogRpcOutletName, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioName=ogEmdDioName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioType=ogEmdDioType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserPort=ogSerialUserPort, ogRpcOutletTable=ogRpcOutletTable, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDescription=ogEmdDescription, ogRpcOutputNotification=ogRpcOutputNotification, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceTable=ogHostServiceTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellTowerNotification=ogCellTowerNotification, ogAlarmTriggerValue=ogAlarmTriggerValue)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserAddress=ogHostUserAddress, ogHostUserIndex=ogHostUserIndex, ogEmdConnectType=ogEmdConnectType, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemApn=ogCellModemApn, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientEntry=ogWifiClientEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckName=ogCheckName, ogHostIpV4Address=ogHostIpV4Address, ogAlarmName=ogAlarmName, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcTable=ogRpcTable, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortTable=ogSerialPortTable, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSystem=ogSystem, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckDeviceTable=ogCheckDeviceTable, ogStatus2=ogStatus2, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmType=ogAlarmType, ogHostUserNotification=ogHostUserNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsState=ogUpsState, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserName=ogHostUserName, ogAlarmLogTable=ogAlarmLogTable, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortDSR=ogSerialPortDSR, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioDescription=ogEmdDioDescription, ogWifiApInterface=ogWifiApInterface, ogSerialPortStopBits=ogSerialPortStopBits, ogHostPingNotification=ogHostPingNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, PYSNMP_MODULE_ID=ogStatus2, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyName=ogPowerSupplyName, ogWebUserTable=ogWebUserTable, ogNetInterfaceName=ogNetInterfaceName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemVendor=ogCellModemVendor, ogUpsTable=ogUpsTable, ogBasicStatusGroup=ogBasicStatusGroup, ogStatus2Groups=ogStatus2Groups, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialUserTable=ogSerialUserTable, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdDioIndex=ogEmdDioIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsDescription=ogUpsDescription, ogRpcOutletFrequency=ogRpcOutletFrequency, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApTable=ogWifiApTable)
