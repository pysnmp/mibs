...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcConnectType=ogRpcConnectType, ogHostTable=ogHostTable, ogWifiClientTable=ogWifiClientTable, ogMibNotifications=ogMibNotifications, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWebUserStartTime=ogWebUserStartTime, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserIndex=ogHostUserIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdName=ogEmdName, ogSerialPortEntry=ogSerialPortEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCustomNotification=ogCustomNotification, ogAlarmCheck=ogAlarmCheck, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemEnabled=ogCellModemEnabled, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmName=ogCurrentAlarmName, ogStatus2Compliances=ogStatus2Compliances, ogWifiApEntry=ogWifiApEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmType=ogAlarmType, ogRpcCounter=ogRpcCounter, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortCTS=ogSerialPortCTS, ogRpcEntry=ogRpcEntry, ogCellModemModel=ogCellModemModel, ogUpsEntry=ogUpsEntry, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserNotification=ogHostUserNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckTable=ogCheckTable, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortLabel=ogSerialPortLabel, ogEmdEnabled=ogEmdEnabled, ogWebUserIndex=ogWebUserIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioTable=ogEmdDioTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsInputNotification=ogUpsInputNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletNotification=ogRpcOutletNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsNotification=ogUpsNotification, ogHostServiceIndex=ogHostServiceIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemConnected=ogCellModemConnected, ogWifiApInterface=ogWifiApInterface, ogStatus2Compliance=ogStatus2Compliance, ogAlarmInstance=ogAlarmInstance, ogRpcInputNotification=ogRpcInputNotification, ogUpsIndex=ogUpsIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsHumidity=ogUpsHumidity, ogCellModemTower=ogCellModemTower, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientRssi=ogWifiClientRssi, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmState=ogAlarmState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckIndex=ogCheckIndex, ogAlarm=ogAlarm, ogEmdEntry=ogEmdEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModemTable=ogCellModemTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemCounter=ogCellModemCounter, ogSerialPortParity=ogSerialPortParity, ogWifiClientEntry=ogWifiClientEntry, ogCellModemEntry=ogCellModemEntry, ogWifiApTable=ogWifiApTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientTable=ogWifiApClientTable, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletName=ogRpcOutletName, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioNotification=ogEmdDioNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogStatus2Conformance=ogStatus2Conformance, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogCellTowerNotification=ogCellTowerNotification, ogUpsState=ogUpsState, ogWifiApEnabled=ogWifiApEnabled, ogCheckName=ogCheckName, ogPowerSupplyName=ogPowerSupplyName, ogAlarmName=ogAlarmName, ogSerialNumber=ogSerialNumber, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmSummary=ogAlarmSummary, ogRpcDescription=ogRpcDescription, ogRpcOutletState=ogRpcOutletState, ogSerialPortTable=ogSerialPortTable, ogHostUserEntry=ogHostUserEntry, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortMode=ogSerialPortMode, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsDescription=ogUpsDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortRTS=ogSerialPortRTS, ogHostUserName=ogHostUserName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserTable=ogSerialUserTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckType=ogCheckType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogHostUserStartTime=ogHostUserStartTime, ogSerialUserName=ogSerialUserName, ogAlarmLogEntry=ogAlarmLogEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientInterface=ogWifiClientInterface, ogSystem=ogSystem, ogWifiClientApMac=ogWifiClientApMac, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityName=ogEmdHumidityName, ogSerialUserNotification=ogSerialUserNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemApn=ogCellModemApn, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsInputCurrent=ogUpsInputCurrent, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioEmd=ogEmdDioEmd, ogUpsCounter=ogUpsCounter, ogUpsName=ogUpsName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPatternNotification=ogSerialPatternNotification, ogHostIndex=ogHostIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogHostName=ogHostName, ogRpcIndex=ogRpcIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioState=ogEmdDioState, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortIndex=ogSerialPortIndex, ogUpsTemperature=ogUpsTemperature, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmUser=ogAlarmUser, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientAp=ogWifiApClientAp, ogRpcOutletTable=ogRpcOutletTable, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemVendor=ogCellModemVendor, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdIndex=ogEmdIndex, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemIndex=ogCellModemIndex, ogHostPingNotification=ogHostPingNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDioIndex=ogEmdDioIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWebUserName=ogWebUserName, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientMode=ogWifiClientMode, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostUserHostName=ogHostUserHostName, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmDevice=ogAlarmDevice, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsTable=ogUpsTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckDeviceEntry=ogCheckDeviceEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioName=ogEmdDioName, ogEmdConnectType=ogEmdConnectType, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortDTR=ogSerialPortDTR, ogStatus2=ogStatus2, ogWebUserTable=ogWebUserTable, ogHostIpV6Address=ogHostIpV6Address)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostServiceType=ogHostServiceType, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortDSR=ogSerialPortDSR, ogCellModemRegistered=ogCellModemRegistered, ogHostUserHost=ogHostUserHost, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdTable=ogEmdTable, ogSerialUserPort=ogSerialUserPort, ogWifiApTxPower=ogWifiApTxPower, ogHostUserTable=ogHostUserTable, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceStatus=ogHostServiceStatus, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioDirection=ogEmdDioDirection, ogEmdDescription=ogEmdDescription, ogUpsType=ogUpsType, ogHostIpV4Address=ogHostIpV4Address, ogHostServiceTable=ogHostServiceTable, ogWifiClientEssid=ogWifiClientEssid, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemNetwork=ogCellModemNetwork, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostUserAddress=ogHostUserAddress, ogWebUserEntry=ogWebUserEntry, ogEmdDioDescription=ogEmdDioDescription, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcName=ogRpcName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcTable=ogRpcTable, ogRpcType=ogRpcType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogStatus2Groups=ogStatus2Groups, ogWifiClientFrequency=ogWifiClientFrequency, ogHostServiceCounter=ogHostServiceCounter, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckDeviceName=ogCheckDeviceName, ogAlarmTime=ogAlarmTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckEntry=ogCheckEntry, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioEntry=ogEmdDioEntry, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioType=ogEmdDioType, ogUpsInputFrequency=ogUpsInputFrequency, ogHostServicePort=ogHostServicePort, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogHostEntry=ogHostEntry, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellDataNotification=ogCellDataNotification, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientRxPackets=ogWifiApClientRxPackets)
