...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceType=ogHostServiceType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsConnectType=ogUpsConnectType, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckType=ogCheckType, ogEmdHumidityName=ogEmdHumidityName, ogCellApnNotification=ogCellApnNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdEntry=ogEmdEntry, ogAlarmState=ogAlarmState, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogHostIpV4Address=ogHostIpV4Address, ogAlarmName=ogAlarmName, ogWifiApClientEntry=ogWifiApClientEntry, ogStatus2=ogStatus2, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientAp=ogWifiApClientAp, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioType=ogEmdDioType, ogSerialUserName=ogSerialUserName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioEntry=ogEmdDioEntry, ogUpsTemperature=ogUpsTemperature, ogWebUserTable=ogWebUserTable, ogHostName=ogHostName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioDirection=ogEmdDioDirection, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserLabel=ogSerialUserLabel, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApEntry=ogWifiApEntry, ogSerialPortDCD=ogSerialPortDCD, ogStatus2Compliance=ogStatus2Compliance, ogEmdDescription=ogEmdDescription, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceIndex=ogHostServiceIndex, ogAlarmSummary=ogAlarmSummary, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsNotification=ogUpsNotification, ogUpsCounter=ogUpsCounter, ogUpsIndex=ogUpsIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemTable=ogCellModemTable, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioState=ogEmdDioState, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdIndex=ogEmdIndex, ogCheckTable=ogCheckTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogCellDataNotification=ogCellDataNotification, ogWifiApIndex=ogWifiApIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortDSR=ogSerialPortDSR, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmType=ogAlarmType, ogWifiClientEnabled=ogWifiClientEnabled, ogHostServiceHost=ogHostServiceHost, ogCellModemEntry=ogCellModemEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckResolveActions=ogCheckResolveActions, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostPingNotification=ogHostPingNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckIndex=ogCheckIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioTable=ogEmdDioTable, ogSystem=ogSystem, ogRpcOutletState=ogRpcOutletState, ogSerialUserEntry=ogSerialUserEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCustomNotification=ogCustomNotification, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostServicePort=ogHostServicePort, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioName=ogEmdDioName, ogUpsInputFrequency=ogUpsInputFrequency, ogStatus2Compliances=ogStatus2Compliances, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientCounter=ogWifiClientCounter, ogWifiApTxPower=ogWifiApTxPower, ogWifiApEnabled=ogWifiApEnabled, ogRpcDescription=ogRpcDescription, ogCheckEntry=ogCheckEntry, ogAlarmCheck=ogAlarmCheck, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogRpcOutputNotification=ogRpcOutputNotification, ogNetInterfaceState=ogNetInterfaceState, ogHostUserName=ogHostUserName, ogWebUserEntry=ogWebUserEntry, ogUpsDescription=ogUpsDescription, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientInterface=ogWifiClientInterface, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdName=ogEmdName, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortTable=ogSerialPortTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdEnabled=ogEmdEnabled, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApSsid=ogWifiApSsid, ogAlarmInstance=ogAlarmInstance, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostTable=ogHostTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcInputNotification=ogRpcInputNotification, ogHostUserHostName=ogHostUserHostName, ogSerialPortMode=ogSerialPortMode, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmUser=ogAlarmUser, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsType=ogUpsType, ogCellModemApn=ogCellModemApn, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialNumber=ogSerialNumber, ogAlarmEventId=ogAlarmEventId, ogHostUserIndex=ogHostUserIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcEntry=ogRpcEntry, ogHostUserHost=ogHostUserHost, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialUserTable=ogSerialUserTable, ogCellModemRegistered=ogCellModemRegistered, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostServiceNotification=ogHostServiceNotification, ogRpcType=ogRpcType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcCounter=ogRpcCounter, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostUserTable=ogHostUserTable, ogNetInterfaceTable=ogNetInterfaceTable, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioIndex=ogEmdDioIndex, PYSNMP_MODULE_ID=ogStatus2, ogAlarmDevice=ogAlarmDevice, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceCounter=ogHostServiceCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemIndex=ogCellModemIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceType=ogNetInterfaceType, ogEmdConnectType=ogEmdConnectType, ogCellMessageNotification=ogCellMessageNotification, ogRpcConnectType=ogRpcConnectType, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortIndex=ogSerialPortIndex, ogHostIpV6Address=ogHostIpV6Address, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcTable=ogRpcTable, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarm=ogAlarm, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTable=ogEmdTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemVendor=ogCellModemVendor, ogStatus2Groups=ogStatus2Groups, ogUpsEntry=ogUpsEntry, ogHostServiceTable=ogHostServiceTable, ogWifiClientMode=ogWifiClientMode, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmTime=ogAlarmTime, ogUpsName=ogUpsName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApTable=ogWifiApTable, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsOutputPower=ogUpsOutputPower, ogRpcInputCurrent=ogRpcInputCurrent)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsHumidity=ogUpsHumidity, ogWifiApInterface=ogWifiApInterface, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWebUserName=ogWebUserName, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostEntry=ogHostEntry, ogCellModemIMSI=ogCellModemIMSI, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemTower=ogCellModemTower, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsInputNotification=ogUpsInputNotification, ogWifiApFrequency=ogWifiApFrequency, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialUserPort=ogSerialUserPort, ogCellModemModel=ogCellModemModel, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsState=ogUpsState, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemConnected=ogCellModemConnected, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioDescription=ogEmdDioDescription, ogCheckDeviceName=ogCheckDeviceName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceName=ogNetInterfaceName, ogRpcName=ogRpcName, ogUpsTable=ogUpsTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcIndex=ogRpcIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientTable=ogWifiClientTable, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemCounter=ogCellModemCounter, ogWebUserNotification=ogWebUserNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostIndex=ogHostIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogMibNotifications=ogMibNotifications, ogEmdDioNotification=ogEmdDioNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckName=ogCheckName, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortParity=ogSerialPortParity, ogCellTowerNotification=ogCellTowerNotification, ogHostUserEntry=ogHostUserEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortCTS=ogSerialPortCTS)
