...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientAp=ogWifiApClientAp, ogEmdDescription=ogEmdDescription, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserEntry=ogHostUserEntry, ogWifiApTable=ogWifiApTable, ogCellSignalNotification=ogCellSignalNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyName=ogPowerSupplyName, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogWebUserIndex=ogWebUserIndex, ogCheckEntry=ogCheckEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckName=ogCheckName, ogAlarmDevice=ogAlarmDevice, ogSerialUserNotification=ogSerialUserNotification, ogCellApnNotification=ogCellApnNotification, ogRpcOutletState=ogRpcOutletState, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioCounter=ogEmdDioCounter, ogCheckIndex=ogCheckIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortDTR=ogSerialPortDTR, ogEmdTable=ogEmdTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortParity=ogSerialPortParity, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckResetTimeout=ogCheckResetTimeout, ogHostName=ogHostName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsHumidity=ogUpsHumidity, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsIndex=ogUpsIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmState=ogCurrentAlarmState, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserName=ogHostUserName, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServicePort=ogHostServicePort, ogWifiApTxPower=ogWifiApTxPower, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsType=ogUpsType, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsState=ogUpsState, ogAlarmPreviousValue=ogAlarmPreviousValue, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityName=ogEmdHumidityName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsNotification=ogUpsNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostIndex=ogHostIndex, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientIndex=ogWifiClientIndex, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletName=ogRpcOutletName, ogUpsOutputNotification=ogUpsOutputNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemIMSI=ogCellModemIMSI, ogNetInterfaceType=ogNetInterfaceType, ogWifiApIndex=ogWifiApIndex, ogCheckType=ogCheckType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsTable=ogUpsTable, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApClientIndex=ogWifiApClientIndex, ogStatus2Compliance=ogStatus2Compliance, ogCellModemConnected=ogCellModemConnected, ogCheckDeviceRef=ogCheckDeviceRef, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsTemperature=ogUpsTemperature, ogSerialUserTable=ogSerialUserTable, ogUpsEntry=ogUpsEntry, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceCounter=ogHostServiceCounter, ogRpcName=ogRpcName, ogHostServiceHost=ogHostServiceHost, ogRpcDescription=ogRpcDescription, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemEnabled=ogCellModemEnabled, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcIndex=ogRpcIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemTable=ogCellModemTable, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortTable=ogSerialPortTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmInstance=ogAlarmInstance, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputPower=ogUpsOutputPower, ogEmdDioEmd=ogEmdDioEmd, ogAlarmType=ogAlarmType, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemApn=ogCellModemApn, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogNetInterfaceName=ogNetInterfaceName, ogUpsInputVoltage=ogUpsInputVoltage, ogCellTowerNotification=ogCellTowerNotification, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialNumber=ogSerialNumber, ogEmdHumidityTable=ogEmdHumidityTable, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientApMac=ogWifiClientApMac, ogAlarmUser=ogAlarmUser, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdDioNotification=ogEmdDioNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioTable=ogEmdDioTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialUserEntry=ogSerialUserEntry, ogHostServiceStatus=ogHostServiceStatus, ogHostIpV6Address=ogHostIpV6Address, ogUpsDescription=ogUpsDescription, ogEmdEnabled=ogEmdEnabled, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcTable=ogRpcTable, ogEmdDioType=ogEmdDioType, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogStatus2Compliances=ogStatus2Compliances, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioName=ogEmdDioName, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcEntry=ogRpcEntry, ogAlarmEventId=ogAlarmEventId, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogNetInterfaceState=ogNetInterfaceState, ogWebUserTable=ogWebUserTable, ogAlarmSummary=ogAlarmSummary, ogHostUserHost=ogHostUserHost, ogHostServiceType=ogHostServiceType, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemModel=ogCellModemModel, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserName=ogSerialUserName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortRTS=ogSerialPortRTS, ogRpcType=ogRpcType, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortIndex=ogSerialPortIndex, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogAlarmName=ogAlarmName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientEntry=ogWifiApClientEntry, ogSystem=ogSystem, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsCounter=ogUpsCounter, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogStatus2Groups=ogStatus2Groups, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApEntry=ogWifiApEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarm=ogAlarm, ogMibNotifications=ogMibNotifications, ogUpsBatteryState=ogUpsBatteryState, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApFrequency=ogWifiApFrequency, ogHostPingNotification=ogHostPingNotification, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientMode=ogWifiClientMode, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryNotification=ogUpsBatteryNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureName=ogEmdTemperatureName, ogCellDataNotification=ogCellDataNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPatternNotification=ogSerialPatternNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemTower=ogCellModemTower, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmTime=ogAlarmTime, ogWifiClientTable=ogWifiClientTable, ogUpsName=ogUpsName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogHostUserTable=ogHostUserTable, ogCustomNotification=ogCustomNotification, ogHostTable=ogHostTable, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckDeviceName=ogCheckDeviceName, ogHostServiceTable=ogHostServiceTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdName=ogEmdName, ogCellModemNetwork=ogCellModemNetwork, ogHostUserHostName=ogHostUserHostName, ogEmdDioState=ogEmdDioState, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcCounter=ogRpcCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemEntry=ogCellModemEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientTable=ogWifiApClientTable, ogWebUserEntry=ogWebUserEntry, ogSerialPortMode=ogSerialPortMode, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApInterface=ogWifiApInterface, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsConnectType=ogUpsConnectType, ogWifiClientEssid=ogWifiClientEssid, ogHostEntry=ogHostEntry, ogSerialUserLabel=ogSerialUserLabel, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmState=ogAlarmState, ogEmdIndex=ogEmdIndex, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApSsid=ogWifiApSsid, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdConnectType=ogEmdConnectType, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostUserIndex=ogHostUserIndex, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortDSR=ogSerialPortDSR, ogWebUserName=ogWebUserName, ogStatus2=ogStatus2, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemIndex=ogCellModemIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckTable=ogCheckTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostUserAddress=ogHostUserAddress, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdEntry=ogEmdEntry, ogSerialPortDCD=ogSerialPortDCD, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortLabel=ogSerialPortLabel)
