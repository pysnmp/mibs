...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcType=ogRpcType, ogHostUserIndex=ogHostUserIndex, ogSerialPortLabel=ogSerialPortLabel, ogRpcInputFrequency=ogRpcInputFrequency, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityCounter=ogEmdHumidityCounter, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientEssid=ogWifiClientEssid, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmEventId=ogAlarmEventId, ogCheckResetTimeout=ogCheckResetTimeout, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientMode=ogWifiClientMode, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostIpV4Address=ogHostIpV4Address, ogEmdDioNotification=ogEmdDioNotification, ogWifiApSsid=ogWifiApSsid, ogHostUserAddress=ogHostUserAddress, ogSerialPortCTS=ogSerialPortCTS, ogHostName=ogHostName, ogRpcEntry=ogRpcEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckDeviceName=ogCheckDeviceName, ogUpsLogEnabled=ogUpsLogEnabled, ogStatus2Groups=ogStatus2Groups, ogEmdDioName=ogEmdDioName, ogRpcOutputNotification=ogRpcOutputNotification, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputLoad=ogUpsOutputLoad, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserPort=ogSerialUserPort, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemCounter=ogCellModemCounter, ogHostServiceHost=ogHostServiceHost, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcInputVoltage=ogRpcInputVoltage, ogNetInterfaceType=ogNetInterfaceType, ogUpsCounter=ogUpsCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityName=ogEmdHumidityName, ogWebUserIndex=ogWebUserIndex, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsHumidity=ogUpsHumidity, ogUpsName=ogUpsName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortDataBits=ogSerialPortDataBits, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioEntry=ogEmdDioEntry, ogHostServiceStatus=ogHostServiceStatus, ogUpsState=ogUpsState, ogBasicStatusGroup=ogBasicStatusGroup, ogSystem=ogSystem, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdName=ogEmdName, ogHostUserTable=ogHostUserTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcIndex=ogRpcIndex, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmName=ogAlarmName, ogWifiClientIndex=ogWifiClientIndex, ogSerialUserTable=ogSerialUserTable, ogEmdEnabled=ogEmdEnabled, ogCellDataNotification=ogCellDataNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckType=ogCheckType, ogUpsType=ogUpsType, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostServiceTable=ogHostServiceTable, ogSerialPortEntry=ogSerialPortEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogNetInterfaceEntry=ogNetInterfaceEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioIndex=ogEmdDioIndex, ogCheckName=ogCheckName, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostEntry=ogHostEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogStatus2Conformance=ogStatus2Conformance, ogCustomNotification=ogCustomNotification, ogHostUserName=ogHostUserName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletTable=ogRpcOutletTable, ogCellModemApn=ogCellModemApn, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckIndex=ogCheckIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApEntry=ogWifiApEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckResolveActions=ogCheckResolveActions, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmInstance=ogAlarmInstance, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApIndex=ogWifiApIndex, ogUpsIndex=ogUpsIndex, ogWifiApFrequency=ogWifiApFrequency, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletState=ogRpcOutletState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientAp=ogWifiApClientAp, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioDirection=ogEmdDioDirection, ogWifiApTable=ogWifiApTable, ogAlarmSummary=ogAlarmSummary, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemTable=ogCellModemTable, ogSerialSignalNotification=ogSerialSignalNotification, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioType=ogEmdDioType, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortTable=ogSerialPortTable, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceNotification=ogHostServiceNotification, ogRpcName=ogRpcName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceType=ogHostServiceType, ogCellModemNetwork=ogCellModemNetwork, ogRpcTable=ogRpcTable, ogCellModemIMSI=ogCellModemIMSI, ogSerialUserIndex=ogSerialUserIndex, ogCellModemVendor=ogCellModemVendor, ogHostUserStartTime=ogHostUserStartTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientCounter=ogWifiClientCounter, ogEmdTable=ogEmdTable, ogCellModemConnected=ogCellModemConnected, ogUpsTable=ogUpsTable, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdDioTable=ogEmdDioTable, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckDeviceRef=ogCheckDeviceRef, ogNetInterfaceName=ogNetInterfaceName, ogUpsNotification=ogUpsNotification, ogCheckTable=ogCheckTable, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientEntry=ogWifiClientEntry, ogRpcCounter=ogRpcCounter, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogHostIndex=ogHostIndex, ogAlarm=ogAlarm, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogMibNotifications=ogMibNotifications, ogCellModemEntry=ogCellModemEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceIndex=ogHostServiceIndex, ogHostPingNotification=ogHostPingNotification, ogCellModemTower=ogCellModemTower, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostIpV6Address=ogHostIpV6Address, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmTime=ogAlarmTime, ogCheckEntry=ogCheckEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserLabel=ogSerialUserLabel, ogHostUserEntry=ogHostUserEntry, ogRpcDescription=ogRpcDescription, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcOutletName=ogRpcOutletName, ogSerialPortIndex=ogSerialPortIndex, ogWifiApCounter=ogWifiApCounter, ogSerialUserEntry=ogSerialUserEntry, ogPowerSupplyName=ogPowerSupplyName, ogCellMessageNotification=ogCellMessageNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceEntry=ogHostServiceEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRssi=ogWifiClientRssi)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmType=ogAlarmType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmState=ogAlarmState, ogHostUserHost=ogHostUserHost, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsInputNotification=ogUpsInputNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemIndex=ogCellModemIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientIndex=ogWifiApClientIndex, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioCounter=ogEmdDioCounter, ogHostServicePort=ogHostServicePort, ogCellModemTemperature=ogCellModemTemperature, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdIndex=ogEmdIndex, ogSerialNumber=ogSerialNumber, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWebUserTable=ogWebUserTable, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmDevice=ogAlarmDevice, ogUpsConnectType=ogUpsConnectType, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserNotification=ogHostUserNotification, ogWebUserName=ogWebUserName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdEntry=ogEmdEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortSpeed=ogSerialPortSpeed, ogHostTable=ogHostTable, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsDescription=ogUpsDescription, ogEmdDioState=ogEmdDioState, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmUser=ogAlarmUser, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialUserName=ogSerialUserName, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsEntry=ogUpsEntry, ogCellModemModel=ogCellModemModel, ogStatus2=ogStatus2, ogUpsInputFrequency=ogUpsInputFrequency, ogWebUserNotification=ogWebUserNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortParity=ogSerialPortParity, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortDCD=ogSerialPortDCD, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcConnectType=ogRpcConnectType, ogFirmwareVersion=ogFirmwareVersion, ogEmdDescription=ogEmdDescription, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow)
