...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputCurrent=ogRpcInputCurrent, ogHostIpV4Address=ogHostIpV4Address, ogCheckType=ogCheckType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemIndex=ogCellModemIndex, ogCheckTable=ogCheckTable, ogRpcInputVoltage=ogRpcInputVoltage, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortDSR=ogSerialPortDSR, ogRpcIndex=ogRpcIndex, ogEmdDioDirection=ogEmdDioDirection, ogEmdLogEnabled=ogEmdLogEnabled, ogWebUserName=ogWebUserName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemTable=ogCellModemTable, ogSerialUserTable=ogSerialUserTable, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApTxPower=ogWifiApTxPower, ogHostUserName=ogHostUserName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsEntry=ogUpsEntry, ogCellModemIMSI=ogCellModemIMSI, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientEssid=ogWifiClientEssid, ogCellModemTower=ogCellModemTower, ogHostUserTable=ogHostUserTable, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceNotification=ogHostServiceNotification, ogUpsInputNotification=ogUpsInputNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmInstance=ogAlarmInstance, ogUpsTable=ogUpsTable, ogCellTowerNotification=ogCellTowerNotification, ogUpsCounter=ogUpsCounter, ogCheckName=ogCheckName, ogEmdDioIndex=ogEmdDioIndex, ogStatus2=ogStatus2, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostServiceType=ogHostServiceType, ogAlarm=ogAlarm, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialNumber=ogSerialNumber, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcDescription=ogRpcDescription, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioType=ogEmdDioType, ogUpsName=ogUpsName, ogRpcConnectType=ogRpcConnectType, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmType=ogAlarmType, ogCellModemConnected=ogCellModemConnected, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApSsid=ogWifiApSsid, ogEmdName=ogEmdName, ogEmdTable=ogEmdTable, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserEntry=ogWebUserEntry, ogRpcTable=ogRpcTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsNotification=ogUpsNotification, ogCellDataNotification=ogCellDataNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsState=ogUpsState, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceHost=ogHostServiceHost, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWebUserTable=ogWebUserTable, ogSerialPortEntry=ogSerialPortEntry, ogHostIpV6Address=ogHostIpV6Address, ogWifiApIndex=ogWifiApIndex, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsDescription=ogUpsDescription, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserHost=ogHostUserHost, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioCounter=ogEmdDioCounter, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCustomNotification=ogCustomNotification, ogEmdDioTable=ogEmdDioTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmSummary=ogAlarmSummary, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcEntry=ogRpcEntry, ogAlarmLogTable=ogAlarmLogTable, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortFlowControl=ogSerialPortFlowControl, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsType=ogUpsType, ogWifiApClientTable=ogWifiApClientTable, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApEntry=ogWifiApEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletState=ogRpcOutletState, ogSerialUserName=ogSerialUserName, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyName=ogPowerSupplyName, ogRpcName=ogRpcName, ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputPower=ogUpsOutputPower, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioState=ogEmdDioState, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemEntry=ogCellModemEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApEnabled=ogWifiApEnabled, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostEntry=ogHostEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogStatus2Groups=ogStatus2Groups, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserAddress=ogHostUserAddress, ogWifiApClientAp=ogWifiApClientAp, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientInterface=ogWifiClientInterface, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcType=ogRpcType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserIndex=ogHostUserIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmEventId=ogAlarmEventId, ogHostServiceStatus=ogHostServiceStatus, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServiceEntry=ogHostServiceEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialUserNotification=ogSerialUserNotification, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogStatus2Conformance=ogStatus2Conformance, ogHostPingNotification=ogHostPingNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApInterface=ogWifiApInterface, ogCellModemRegistered=ogCellModemRegistered, ogEmdEntry=ogEmdEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsConnectType=ogUpsConnectType, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientApMac=ogWifiClientApMac, ogNetInterfaceTable=ogNetInterfaceTable, ogHostTable=ogHostTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsTemperature=ogUpsTemperature, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemApn=ogCellModemApn, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemVendor=ogCellModemVendor, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientMode=ogWifiClientMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostServicePort=ogHostServicePort, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserStartTime=ogWebUserStartTime, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDescription=ogEmdDescription, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdConnectType=ogEmdConnectType, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientTable=ogWifiClientTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserNotification=ogHostUserNotification, ogCheckEntry=ogCheckEntry, ogEmdEnabled=ogEmdEnabled, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityTotal=ogEmdHumidityTotal, ogFirmwareVersion=ogFirmwareVersion, ogHostIndex=ogHostIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostName=ogHostName, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmTime=ogAlarmTime, ogUpsOutputCurrent=ogUpsOutputCurrent, ogMibNotifications=ogMibNotifications, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortDTR=ogSerialPortDTR, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientCounter=ogWifiClientCounter, ogAlarmName=ogAlarmName, ogAlarmDevice=ogAlarmDevice, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmPreviousValue=ogAlarmPreviousValue)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWebUserIndex=ogWebUserIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmCurrentValue=ogAlarmCurrentValue, ogNetInterfaceState=ogNetInterfaceState, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletTable=ogRpcOutletTable, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputVoltage=ogUpsInputVoltage, ogHostUserEntry=ogHostUserEntry, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmCheck=ogAlarmCheck, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortCTS=ogSerialPortCTS, ogWifiApTable=ogWifiApTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioName=ogEmdDioName, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckDeviceName=ogCheckDeviceName, ogUpsHumidity=ogUpsHumidity, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApCounter=ogWifiApCounter, ogCellModemModel=ogCellModemModel, ogSerialPortLabel=ogSerialPortLabel, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientRssi=ogWifiApClientRssi, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientMac=ogWifiApClientMac, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletName=ogRpcOutletName, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemCounter=ogCellModemCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSystem=ogSystem, ogSerialPortTable=ogSerialPortTable, ogCheckIndex=ogCheckIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortRTS=ogSerialPortRTS, ogRpcCounter=ogRpcCounter, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmUser=ogAlarmUser, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsIndex=ogUpsIndex, ogAlarmState=ogAlarmState, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdIndex=ogEmdIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckTriggerActions=ogCheckTriggerActions)
