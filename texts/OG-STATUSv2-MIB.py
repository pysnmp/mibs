...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellApnNotification=ogCellApnNotification, ogHostUserHost=ogHostUserHost, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioEmd=ogEmdDioEmd, ogHostEntry=ogHostEntry, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientMac=ogWifiApClientMac, ogEmdEntry=ogEmdEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdDescription=ogEmdDescription, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWebUserName=ogWebUserName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioEntry=ogEmdDioEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogStatus2=ogStatus2, ogCellModemCounter=ogCellModemCounter, ogWifiApFrequency=ogWifiApFrequency, ogCellModemNetwork=ogCellModemNetwork, ogUpsEntry=ogUpsEntry, ogHostServicePort=ogHostServicePort, ogWifiApInterface=ogWifiApInterface, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientTxPower=ogWifiClientTxPower, ogHostIndex=ogHostIndex, ogHostServiceTable=ogHostServiceTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortMode=ogSerialPortMode, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortIndex=ogSerialPortIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApEntry=ogWifiApEntry, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckEntry=ogCheckEntry, ogRpcTable=ogRpcTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserIndex=ogHostUserIndex, ogWifiClientInterface=ogWifiClientInterface, ogSerialUserIndex=ogSerialUserIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientRssi=ogWifiClientRssi, ogCellModem3gRssi=ogCellModem3gRssi, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogAlarmName=ogAlarmName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsHumidity=ogUpsHumidity, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWebUserIndex=ogWebUserIndex, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletState=ogRpcOutletState, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortCTS=ogSerialPortCTS, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortTable=ogSerialPortTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcConnectType=ogRpcConnectType, ogUpsIndex=ogUpsIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdIndex=ogEmdIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostServiceStatus=ogHostServiceStatus, ogCellModemModel=ogCellModemModel, ogAlarmTime=ogAlarmTime, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostUserStartTime=ogHostUserStartTime, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdConnectType=ogEmdConnectType, ogUpsName=ogUpsName, ogEmdHumidityName=ogEmdHumidityName, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostName=ogHostName, ogEmdName=ogEmdName, ogCustomNotification=ogCustomNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostServiceType=ogHostServiceType, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdTable=ogEmdTable, ogCellModemRegistered=ogCellModemRegistered, ogCheckName=ogCheckName, ogEmdDioNotification=ogEmdDioNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialUserPort=ogSerialUserPort, ogCellModemIndex=ogCellModemIndex, ogHostPingNotification=ogHostPingNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceHost=ogHostServiceHost, ogHostUserHostName=ogHostUserHostName, ogSerialPortDCD=ogSerialPortDCD, ogRpcIndex=ogRpcIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmInstance=ogAlarmInstance, ogCellDataNotification=ogCellDataNotification, ogSerialPortRTS=ogSerialPortRTS, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsInputNotification=ogUpsInputNotification, ogWifiApEnabled=ogWifiApEnabled, ogUpsType=ogUpsType, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostIpV4Address=ogHostIpV4Address, ogCellModemEntry=ogCellModemEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserNotification=ogHostUserNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApCounter=ogWifiApCounter, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputPower=ogUpsOutputPower, ogStatus2Groups=ogStatus2Groups, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmEventId=ogAlarmEventId, ogCellModemApn=ogCellModemApn, ogUpsTable=ogUpsTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletName=ogRpcOutletName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApTable=ogWifiApTable, ogRpcName=ogRpcName, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientIndex=ogWifiApClientIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceType=ogNetInterfaceType, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemVendor=ogCellModemVendor, ogEmdDioDescription=ogEmdDioDescription, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioTable=ogEmdDioTable, ogAlarmDevice=ogAlarmDevice, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserEntry=ogHostUserEntry, ogUpsCounter=ogUpsCounter, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioType=ogEmdDioType, ogEmdEnabled=ogEmdEnabled, ogSerialUserTable=ogSerialUserTable, ogWifiClientIndex=ogWifiClientIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceEntry=ogHostServiceEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostTable=ogHostTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcEntry=ogRpcEntry, ogAlarmState=ogAlarmState, ogAlarmUser=ogAlarmUser, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureName=ogEmdTemperatureName, ogStatus2Compliance=ogStatus2Compliance, ogWifiApClientAp=ogWifiApClientAp, ogWebUserTable=ogWebUserTable, ogHostIpV6Address=ogHostIpV6Address, ogUpsConnectType=ogUpsConnectType, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletTable=ogRpcOutletTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcInputNotification=ogRpcInputNotification, ogSystem=ogSystem, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialUserLabel=ogSerialUserLabel, ogCheckType=ogCheckType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioCounter=ogEmdDioCounter, ogUpsTemperature=ogUpsTemperature, ogEmdDioDirection=ogEmdDioDirection, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApSsid=ogWifiApSsid, ogUpsState=ogUpsState, ogRpcType=ogRpcType, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioName=ogEmdDioName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortParity=ogSerialPortParity, ogSerialSignalNotification=ogSerialSignalNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortDTR=ogSerialPortDTR, ogNetInterfaceName=ogNetInterfaceName, ogHostUserName=ogHostUserName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortStopBits=ogSerialPortStopBits)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckDeviceName=ogCheckDeviceName, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsNotification=ogUpsNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialUserName=ogSerialUserName, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcDescription=ogRpcDescription, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckDeviceRef=ogCheckDeviceRef, ogCellSignalNotification=ogCellSignalNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcCounter=ogRpcCounter, ogNetInterfaceState=ogNetInterfaceState, ogCheckIndex=ogCheckIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsDescription=ogUpsDescription, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellMessageNotification=ogCellMessageNotification, ogAlarm=ogAlarm, ogAlarmSummary=ogAlarmSummary, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellTowerNotification=ogCellTowerNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientEnabled=ogWifiClientEnabled, ogPowerSupplyName=ogPowerSupplyName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserEntry=ogWebUserEntry, ogStatus2Compliances=ogStatus2Compliances, ogSerialNumber=ogSerialNumber, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemTower=ogCellModemTower, ogCheckTable=ogCheckTable, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWebUserNotification=ogWebUserNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemTable=ogCellModemTable, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmLogTable=ogAlarmLogTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdHumidityValue=ogEmdHumidityValue, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApIndex=ogWifiApIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientTable=ogWifiClientTable, ogHostUserTable=ogHostUserTable, ogEmdDioState=ogEmdDioState, ogAlarmType=ogAlarmType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogMibNotifications=ogMibNotifications, ogAlarmCheck=ogAlarmCheck)
