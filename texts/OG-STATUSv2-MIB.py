...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsTemperature=ogUpsTemperature, ogWifiApClientAp=ogWifiApClientAp, ogWifiApClientEntry=ogWifiApClientEntry, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortLabel=ogSerialPortLabel, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDescription=ogEmdDescription, ogAlarmLogTable=ogAlarmLogTable, ogUpsConnectType=ogUpsConnectType, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmState=ogAlarmState, ogHostServiceHost=ogHostServiceHost, ogUpsType=ogUpsType, ogHostIpV4Address=ogHostIpV4Address, ogCellModemTable=ogCellModemTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortDSR=ogSerialPortDSR, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletState=ogRpcOutletState, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCheckName=ogCheckName, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserAddress=ogHostUserAddress, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmName=ogAlarmName, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortDTR=ogSerialPortDTR, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellSignalNotification=ogCellSignalNotification, ogHostIndex=ogHostIndex, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApSsid=ogWifiApSsid, ogCustomNotification=ogCustomNotification, ogSerialPortCTS=ogSerialPortCTS, ogAlarmCheck=ogAlarmCheck, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioTable=ogEmdDioTable, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserIndex=ogHostUserIndex, ogWifiApEntry=ogWifiApEntry, ogEmdDioIndex=ogEmdDioIndex, ogHostName=ogHostName, ogEmdDioState=ogEmdDioState, ogSerialPortRTS=ogSerialPortRTS, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmTime=ogCurrentAlarmTime, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemApn=ogCellModemApn, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserNotification=ogHostUserNotification, ogCellModemEntry=ogCellModemEntry, ogAlarmUser=ogAlarmUser, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdHumidityName=ogEmdHumidityName, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserHost=ogHostUserHost, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellModemCounter=ogCellModemCounter, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckEntry=ogCheckEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserStartTime=ogWebUserStartTime, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientCounter=ogWifiClientCounter, ogSystem=ogSystem, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyName=ogPowerSupplyName, ogCellModem3gRssi=ogCellModem3gRssi, ogWebUserIndex=ogWebUserIndex, ogSerialUserName=ogSerialUserName, ogAlarmEventId=ogAlarmEventId, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientMode=ogWifiClientMode, ogEmdIndex=ogEmdIndex, ogEmdDioEmd=ogEmdDioEmd, ogStatus2Compliances=ogStatus2Compliances, ogHostIpV6Address=ogHostIpV6Address, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogAlarmType=ogAlarmType, ogHostServiceNotification=ogHostServiceNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortTable=ogSerialPortTable, ogCellModemTemperature=ogCellModemTemperature, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcConnectType=ogRpcConnectType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckIndex=ogCheckIndex, ogSerialPortParity=ogSerialPortParity, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWebUserName=ogWebUserName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemModel=ogCellModemModel, ogHostServiceTable=ogHostServiceTable, ogEmdEnabled=ogEmdEnabled, ogCellModemIMSI=ogCellModemIMSI, ogSerialUserLabel=ogSerialUserLabel, ogWifiApClientTable=ogWifiApClientTable, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortMode=ogSerialPortMode, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemConnected=ogCellModemConnected, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioDirection=ogEmdDioDirection, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortEntry=ogSerialPortEntry, ogHostServicePort=ogHostServicePort, ogHostTable=ogHostTable, ogHostUserHostName=ogHostUserHostName, ogCheckDeviceTable=ogCheckDeviceTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarmDevice=ogAlarmDevice, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostPingNotification=ogHostPingNotification, ogHostUserTable=ogHostUserTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsInputCurrent=ogUpsInputCurrent, ogNetInterfaceName=ogNetInterfaceName, ogCheckDeviceName=ogCheckDeviceName, ogHostUserEntry=ogHostUserEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsEntry=ogUpsEntry, ogUpsHumidity=ogUpsHumidity, ogAlarmTime=ogAlarmTime, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostServiceType=ogHostServiceType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellMessageNotification=ogCellMessageNotification, ogUpsDescription=ogUpsDescription, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioEntry=ogEmdDioEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApTable=ogWifiApTable, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioName=ogEmdDioName, ogWifiClientEnabled=ogWifiClientEnabled, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioType=ogEmdDioType, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcCounter=ogRpcCounter, ogAlarm=ogAlarm, ogWifiClientEssid=ogWifiClientEssid, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioCounter=ogEmdDioCounter, ogMibNotifications=ogMibNotifications, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialNumber=ogSerialNumber, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserPort=ogSerialUserPort, ogCheckType=ogCheckType, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsName=ogUpsName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdTable=ogEmdTable, ogCellModemVendor=ogCellModemVendor, ogWifiClientInterface=ogWifiClientInterface, ogEmdHumidityEmd=ogEmdHumidityEmd, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemRegistered=ogCellModemRegistered, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdConnectType=ogEmdConnectType, ogCheckResolveActions=ogCheckResolveActions, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, PYSNMP_MODULE_ID=ogStatus2, ogRpcDescription=ogRpcDescription, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputPower=ogUpsOutputPower, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckTable=ogCheckTable, ogUpsTable=ogUpsTable, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcInputCurrent=ogRpcInputCurrent, ogCellTowerNotification=ogCellTowerNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsState=ogUpsState, ogRpcTable=ogRpcTable, ogWifiClientTable=ogWifiClientTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApCounter=ogWifiApCounter, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApInterface=ogWifiApInterface, ogCellDataNotification=ogCellDataNotification, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcEntry=ogRpcEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcType=ogRpcType, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsNotification=ogUpsNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsIndex=ogUpsIndex, ogRpcName=ogRpcName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcOutletTable=ogRpcOutletTable, ogSerialUserEntry=ogSerialUserEntry, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApIndex=ogWifiApIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWebUserTable=ogWebUserTable, ogWebUserEntry=ogWebUserEntry, ogCellModemTower=ogCellModemTower, ogUpsInputNotification=ogUpsInputNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletName=ogRpcOutletName, ogRpcIndex=ogRpcIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientApMac=ogWifiClientApMac, ogStatus2=ogStatus2, ogHostUserName=ogHostUserName, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostEntry=ogHostEntry, ogStatus2Groups=ogStatus2Groups, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdEntry=ogEmdEntry, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdName=ogEmdName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogNetInterfaceType=ogNetInterfaceType, ogCellModemIndex=ogCellModemIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsCounter=ogUpsCounter, ogNetInterfaceState=ogNetInterfaceState)
