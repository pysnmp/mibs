...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientInterface=ogWifiClientInterface, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmDevice=ogAlarmDevice, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortMode=ogSerialPortMode, ogRpcOutletNotification=ogRpcOutletNotification, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemTemperature=ogCellModemTemperature, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientTable=ogWifiClientTable, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputLoad=ogUpsOutputLoad, ogCellTowerNotification=ogCellTowerNotification, ogRpcDescription=ogRpcDescription, ogHostUserIndex=ogHostUserIndex, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceIndex=ogHostServiceIndex, ogRpcIndex=ogRpcIndex, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApCounter=ogWifiApCounter, ogSerialPortDCD=ogSerialPortDCD, ogHostTable=ogHostTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarm=ogAlarm, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostEntry=ogHostEntry, ogSerialPortTable=ogSerialPortTable, ogSerialUserEntry=ogSerialUserEntry, ogHostIpV4Address=ogHostIpV4Address, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletState=ogRpcOutletState, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckType=ogCheckType, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsEntry=ogUpsEntry, ogWebUserEntry=ogWebUserEntry, ogUpsState=ogUpsState, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmUser=ogAlarmUser, ogWifiClientIndex=ogWifiClientIndex, ogWifiApIndex=ogWifiApIndex, ogRpcType=ogRpcType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostServicePort=ogHostServicePort, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortParity=ogSerialPortParity, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckIndex=ogCheckIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsNotification=ogUpsNotification, ogCellModemRegistered=ogCellModemRegistered, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceNotification=ogHostServiceNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialUserPort=ogSerialUserPort, ogUpsOutputPower=ogUpsOutputPower, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckResetTimeout=ogCheckResetTimeout, ogHostUserNotification=ogHostUserNotification, ogHostServiceType=ogHostServiceType, ogEmdEntry=ogEmdEntry, ogEmdEnabled=ogEmdEnabled, ogCustomNotification=ogCustomNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioDescription=ogEmdDioDescription, ogHostIndex=ogHostIndex, ogAlarmName=ogAlarmName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellMessageNotification=ogCellMessageNotification, ogRpcInputNotification=ogRpcInputNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserHost=ogHostUserHost, ogUpsInputFrequency=ogUpsInputFrequency, ogHostIpV6Address=ogHostIpV6Address, ogRpcCounter=ogRpcCounter, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioTable=ogEmdDioTable, ogHostUserHostName=ogHostUserHostName, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioNotification=ogEmdDioNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApSsid=ogWifiApSsid, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTable=ogEmdTable, ogCellModemSessionTime=ogCellModemSessionTime, ogStatus2Conformance=ogStatus2Conformance, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogHostPingNotification=ogHostPingNotification, ogEmdIndex=ogEmdIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmType=ogAlarmType, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDescription=ogEmdDescription, ogSerialUserTable=ogSerialUserTable, ogUpsType=ogUpsType, ogWebUserName=ogWebUserName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApEntry=ogWifiApEntry, ogSerialPortIndex=ogSerialPortIndex, ogWebUserIndex=ogWebUserIndex, ogCellModemConnected=ogCellModemConnected, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdHumidityName=ogEmdHumidityName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsConnectType=ogUpsConnectType, ogWifiClientEssid=ogWifiClientEssid, ogCheckEntry=ogCheckEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogFirmwareVersion=ogFirmwareVersion, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsName=ogUpsName, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemNetwork=ogCellModemNetwork, ogRpcTable=ogRpcTable, ogCellModemIndex=ogCellModemIndex, ogUpsDescription=ogUpsDescription, ogWifiClientMode=ogWifiClientMode, ogSerialPortRTS=ogSerialPortRTS, ogHostName=ogHostName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioState=ogEmdDioState, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdLogEnabled=ogEmdLogEnabled, ogCellDataNotification=ogCellDataNotification, ogUpsTable=ogUpsTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckDeviceCheck=ogCheckDeviceCheck, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsCounter=ogUpsCounter, ogRpcName=ogRpcName, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmSummary=ogAlarmSummary, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApInterface=ogWifiApInterface, ogNetInterfaceType=ogNetInterfaceType, ogStatus2Groups=ogStatus2Groups, ogAlarmTime=ogAlarmTime, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdConnectType=ogEmdConnectType, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserAddress=ogHostUserAddress, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletEntry=ogRpcOutletEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserTable=ogHostUserTable, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortEntry=ogSerialPortEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletTable=ogRpcOutletTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceHost=ogHostServiceHost, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemIMSI=ogCellModemIMSI)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostServiceTable=ogHostServiceTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemModel=ogCellModemModel, ogAlarmState=ogAlarmState, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckTable=ogCheckTable, ogStatus2=ogStatus2, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemVendor=ogCellModemVendor, ogPowerSupplyName=ogPowerSupplyName, ogCellModemTower=ogCellModemTower, ogSerialUserName=ogSerialUserName, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioName=ogEmdDioName, ogSerialNumber=ogSerialNumber, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletRpc=ogRpcOutletRpc, PYSNMP_MODULE_ID=ogStatus2, ogRpcConnectType=ogRpcConnectType, ogEmdName=ogEmdName, ogCellModemApn=ogCellModemApn, ogCheckName=ogCheckName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApFrequency=ogWifiApFrequency, ogEmdDioDirection=ogEmdDioDirection, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiApTable=ogWifiApTable, ogHostServiceEntry=ogHostServiceEntry, ogWebUserTable=ogWebUserTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsIndex=ogUpsIndex, ogEmdDioType=ogEmdDioType, ogSerialPortSpeed=ogSerialPortSpeed, ogMibNotifications=ogMibNotifications, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemEntry=ogCellModemEntry, ogCellModemTable=ogCellModemTable, ogEmdDioIndex=ogEmdDioIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientAp=ogWifiApClientAp, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogSystem=ogSystem, ogStatus2Compliances=ogStatus2Compliances, ogAlarmInstance=ogAlarmInstance, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcEntry=ogRpcEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserName=ogHostUserName, ogWifiClientCounter=ogWifiClientCounter, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification)
