...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostName=ogHostName, ogCellModemIndex=ogCellModemIndex, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdIndex=ogEmdIndex, ogEmdDioDescription=ogEmdDioDescription, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarm=ogAlarm, ogUpsTable=ogUpsTable, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmState=ogAlarmState, ogRpcTable=ogRpcTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioNotification=ogEmdDioNotification, ogAlarmSummary=ogAlarmSummary, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckIndex=ogCheckIndex, ogWebUserEntry=ogWebUserEntry, ogEmdTable=ogEmdTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmDevice=ogAlarmDevice, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsEntry=ogUpsEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputVoltage=ogUpsInputVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdName=ogEmdName, ogHostServiceTable=ogHostServiceTable, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioName=ogEmdDioName, ogWifiApEntry=ogWifiApEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsType=ogUpsType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApInterface=ogWifiApInterface, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsDescription=ogUpsDescription, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserTable=ogHostUserTable, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemEnabled=ogCellModemEnabled, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortEntry=ogSerialPortEntry, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortParity=ogSerialPortParity, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserTable=ogWebUserTable, ogAlarmTime=ogAlarmTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserIndex=ogWebUserIndex, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcIndex=ogRpcIndex, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcName=ogRpcName, ogCellModemCounter=ogCellModemCounter, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserStartTime=ogSerialUserStartTime, ogCellMessageNotification=ogCellMessageNotification, ogHostServiceType=ogHostServiceType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApSsid=ogWifiApSsid, ogRpcType=ogRpcType, ogEmdDioDirection=ogEmdDioDirection, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortRTS=ogSerialPortRTS, ogCellModemEntry=ogCellModemEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientInterface=ogWifiClientInterface, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemTower=ogCellModemTower, ogHostUserAddress=ogHostUserAddress, ogWebUserNotification=ogWebUserNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientMode=ogWifiClientMode, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostServicePort=ogHostServicePort, ogCellModemConnected=ogCellModemConnected, ogUpsInputNotification=ogUpsInputNotification, ogEmdEntry=ogEmdEntry, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioType=ogEmdDioType, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemTable=ogCellModemTable, ogSerialPortCTS=ogSerialPortCTS, ogSerialUserPort=ogSerialUserPort, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcDescription=ogRpcDescription, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsTemperature=ogUpsTemperature, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortLogLevel=ogSerialPortLogLevel, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceEntry=ogHostServiceEntry, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserName=ogHostUserName, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemModel=ogCellModemModel, ogHostIndex=ogHostIndex, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsConnectType=ogUpsConnectType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogCellDataNotification=ogCellDataNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmType=ogAlarmType, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortStopBits=ogSerialPortStopBits, ogHostUserStartTime=ogHostUserStartTime, ogRpcEntry=ogRpcEntry, ogSerialUserName=ogSerialUserName, ogCellApnNotification=ogCellApnNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemApn=ogCellModemApn, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckEntry=ogCheckEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServiceHost=ogHostServiceHost, ogWebUserStartTime=ogWebUserStartTime, ogHostEntry=ogHostEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmUser=ogAlarmUser, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientTable=ogWifiApClientTable, ogWifiApTable=ogWifiApTable, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserNotification=ogHostUserNotification, ogRpcOutletName=ogRpcOutletName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostUserIndex=ogHostUserIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckType=ogCheckType, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogNetInterfaceType=ogNetInterfaceType, ogEmdConnectType=ogEmdConnectType, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcOutletState=ogRpcOutletState, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryState=ogUpsBatteryState, ogWebUserName=ogWebUserName, ogHostUserHost=ogHostUserHost, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioState=ogEmdDioState, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDescription=ogEmdDescription, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2Conformance=ogStatus2Conformance, ogCheckName=ogCheckName, ogStatus2=ogStatus2, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServiceCounter=ogHostServiceCounter, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsIndex=ogUpsIndex, ogSerialUserEntry=ogSerialUserEntry, ogCellModemVendor=ogCellModemVendor, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCustomNotification=ogCustomNotification, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryCharge=ogUpsBatteryCharge, ogStatus2Groups=ogStatus2Groups, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApIndex=ogWifiApIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogMibNotifications=ogMibNotifications, ogWifiClientCounter=ogWifiClientCounter, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcConnectType=ogRpcConnectType, ogNetInterfaceName=ogNetInterfaceName, ogAlarmName=ogAlarmName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApEnabled=ogWifiApEnabled, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmLogTable=ogAlarmLogTable, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialNumber=ogSerialNumber, ogSerialPortTable=ogSerialPortTable, ogWifiClientTable=ogWifiClientTable, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortMode=ogSerialPortMode, ogSerialPortIndex=ogSerialPortIndex, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApCounter=ogWifiApCounter, ogCellModemNetwork=ogCellModemNetwork, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialPortLabel=ogSerialPortLabel, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmCheck=ogAlarmCheck, ogWifiClientEntry=ogWifiClientEntry, ogHostTable=ogHostTable, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsNotification=ogUpsNotification, ogSystem=ogSystem, ogWebUserSourceAddress=ogWebUserSourceAddress, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcInputNotification=ogRpcInputNotification, ogHostPingNotification=ogHostPingNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostUserEntry=ogHostUserEntry, ogCellModemIMSI=ogCellModemIMSI, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsName=ogUpsName, ogEmdHumidityName=ogEmdHumidityName, ogCheckTable=ogCheckTable, ogAlarmEventId=ogAlarmEventId, ogCheckDeviceName=ogCheckDeviceName, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsState=ogUpsState, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsCounter=ogUpsCounter, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostUserHostName=ogHostUserHostName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortDSR=ogSerialPortDSR, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcCounter=ogRpcCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification)
