...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioType=ogEmdDioType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsHumidity=ogUpsHumidity, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsName=ogUpsName, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemCounter=ogCellModemCounter, ogHostUserAddress=ogHostUserAddress, ogHostUserEntry=ogHostUserEntry, ogWifiClientMode=ogWifiClientMode, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsEntry=ogUpsEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortMode=ogSerialPortMode, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmUser=ogAlarmUser, ogCellModemIndex=ogCellModemIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcOutletName=ogRpcOutletName, ogCellModemIMSI=ogCellModemIMSI, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserHost=ogHostUserHost, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortDTR=ogSerialPortDTR, ogRpcName=ogRpcName, ogWifiApInterface=ogWifiApInterface, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortDCD=ogSerialPortDCD, ogAlarmName=ogAlarmName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostUserNotification=ogHostUserNotification, ogCellModemModel=ogCellModemModel, ogWifiClientTable=ogWifiClientTable, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApTable=ogWifiApTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserNotification=ogSerialUserNotification, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostServiceStatus=ogHostServiceStatus, ogSerialNumber=ogSerialNumber, ogHostServicePort=ogHostServicePort, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserLabel=ogSerialUserLabel, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortTable=ogSerialPortTable, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioDescription=ogEmdDioDescription, ogAlarmSummary=ogAlarmSummary, ogStatus2=ogStatus2, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputPower=ogUpsOutputPower, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortDSR=ogSerialPortDSR, ogEmdHumidityName=ogEmdHumidityName, ogCellModemEntry=ogCellModemEntry, ogUpsNotification=ogUpsNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmEventId=ogAlarmEventId, ogStatus2Groups=ogStatus2Groups, ogCheckResolveActions=ogCheckResolveActions, ogCellModemTemperature=ogCellModemTemperature, ogRpcOutletState=ogRpcOutletState, ogAlarmType=ogAlarmType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientEssid=ogWifiClientEssid, ogCellModemVendor=ogCellModemVendor, ogWifiApCounter=ogWifiApCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialUserName=ogSerialUserName, ogCheckName=ogCheckName, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDioName=ogEmdDioName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureTable=ogEmdTemperatureTable, ogStatus2Conformance=ogStatus2Conformance, ogCheckTable=ogCheckTable, ogHostServiceType=ogHostServiceType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialPortDataBits=ogSerialPortDataBits, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientTable=ogWifiApClientTable, ogWebUserNotification=ogWebUserNotification, ogWifiApFrequency=ogWifiApFrequency, ogHostName=ogHostName, ogSerialPortRTS=ogSerialPortRTS, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCustomNotification=ogCustomNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemTable=ogCellModemTable, ogEmdEntry=ogEmdEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioEntry=ogEmdDioEntry, ogHostServiceEntry=ogHostServiceEntry, ogRpcType=ogRpcType, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSystem=ogSystem, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmState=ogCurrentAlarmState, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserTable=ogHostUserTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemNetwork=ogCellModemNetwork, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialUserIndex=ogSerialUserIndex, ogWifiApSsid=ogWifiApSsid, ogRpcDescription=ogRpcDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialUserTable=ogSerialUserTable, ogUpsTemperature=ogUpsTemperature, ogAlarmState=ogAlarmState, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyName=ogPowerSupplyName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryState=ogUpsBatteryState, ogHostIpV6Address=ogHostIpV6Address, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientEntry=ogWifiClientEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortStopBits=ogSerialPortStopBits, ogMibNotifications=ogMibNotifications, ogCheckIndex=ogCheckIndex, ogUpsCounter=ogUpsCounter, ogRpcCounter=ogRpcCounter, ogCellModemTower=ogCellModemTower, ogCellModemApn=ogCellModemApn, ogAlarmTime=ogAlarmTime, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserIndex=ogWebUserIndex, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortEntry=ogSerialPortEntry, ogRpcConnectType=ogRpcConnectType, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcTable=ogRpcTable, ogEmdName=ogEmdName, ogWifiApEnabled=ogWifiApEnabled, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsState=ogUpsState, ogSerialUserPort=ogSerialUserPort, ogCheckEntry=ogCheckEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcIndex=ogRpcIndex, ogCellModemRegistered=ogCellModemRegistered, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortParity=ogSerialPortParity, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsIndex=ogUpsIndex, ogHostTable=ogHostTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmDevice=ogAlarmDevice, ogWifiClientCounter=ogWifiClientCounter, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcInputNotification=ogRpcInputNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsTable=ogUpsTable, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostIndex=ogHostIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityValue=ogEmdHumidityValue)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApIndex=ogWifiApIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioNotification=ogEmdDioNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdHumidityNotification=ogEmdHumidityNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckType=ogCheckType, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioTable=ogEmdDioTable, ogFirmwareVersion=ogFirmwareVersion, ogRpcEntry=ogRpcEntry, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmLogTable=ogAlarmLogTable, ogUpsDescription=ogUpsDescription, ogEmdIndex=ogEmdIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostIpV4Address=ogHostIpV4Address, ogCheckDeviceName=ogCheckDeviceName, ogEmdTable=ogEmdTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsType=ogUpsType, ogHostPingNotification=ogHostPingNotification, ogEmdDioState=ogEmdDioState, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientApMac=ogWifiClientApMac, ogHostUserName=ogHostUserName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServiceIndex=ogHostServiceIndex, ogWebUserTable=ogWebUserTable, ogWifiClientIndex=ogWifiClientIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDescription=ogEmdDescription, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellApnNotification=ogCellApnNotification, ogEmdDioIndex=ogEmdDioIndex, ogEmdConnectType=ogEmdConnectType, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostEntry=ogHostEntry, ogNetInterfaceName=ogNetInterfaceName, ogWebUserName=ogWebUserName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiApClientIndex=ogWifiApClientIndex, ogHostServiceNotification=ogHostServiceNotification, ogUpsConnectType=ogUpsConnectType, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCliUserSessionNotification=ogCliUserSessionNotification, ogStatus2Compliances=ogStatus2Compliances, ogAlarm=ogAlarm, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientInterface=ogWifiClientInterface, ogWifiApEntry=ogWifiApEntry, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmInstance=ogAlarmInstance, ogHostServiceHost=ogHostServiceHost)
