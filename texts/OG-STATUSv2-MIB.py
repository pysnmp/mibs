...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletTable=ogRpcOutletTable, ogEmdDescription=ogEmdDescription, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioDescription=ogEmdDioDescription, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemVendor=ogCellModemVendor, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModemIMSI=ogCellModemIMSI, ogWifiApEnabled=ogWifiApEnabled, ogCheckIndex=ogCheckIndex, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortTable=ogSerialPortTable, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortRTS=ogSerialPortRTS, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcTable=ogRpcTable, ogSerialUserLabel=ogSerialUserLabel, ogAlarmInstance=ogAlarmInstance, ogSerialPortEntry=ogSerialPortEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsName=ogUpsName, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmTime=ogAlarmTime, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserEntry=ogHostUserEntry, ogAlarmUser=ogAlarmUser, ogRpcEntry=ogRpcEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogPowerSupplyName=ogPowerSupplyName, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogWebUserIndex=ogWebUserIndex, ogSerialUserNotification=ogSerialUserNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemEnabled=ogCellModemEnabled, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostTable=ogHostTable, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcCounter=ogRpcCounter, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmSummary=ogAlarmSummary, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioDirection=ogEmdDioDirection, ogCheckTriggerActions=ogCheckTriggerActions, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCheckName=ogCheckName, ogUpsState=ogUpsState, ogCheckEntry=ogCheckEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostIndex=ogHostIndex, ogCustomNotification=ogCustomNotification, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserName=ogSerialUserName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioName=ogEmdDioName, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdConnectType=ogEmdConnectType, ogAlarmName=ogAlarmName, ogEmdEnabled=ogEmdEnabled, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmEventId=ogAlarmEventId, ogRpcDescription=ogRpcDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioCounter=ogEmdDioCounter, ogCellMessageNotification=ogCellMessageNotification, ogCellTowerNotification=ogCellTowerNotification, ogUpsDescription=ogUpsDescription, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityName=ogEmdHumidityName, ogHostUserStartTime=ogHostUserStartTime, ogAlarmLogTable=ogAlarmLogTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckDeviceIndex=ogCheckDeviceIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiClientEntry=ogWifiClientEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsTemperature=ogUpsTemperature, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsInputNotification=ogUpsInputNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputPower=ogUpsOutputPower, ogWebUserNotification=ogWebUserNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcInputNotification=ogRpcInputNotification, ogSerialUserEntry=ogSerialUserEntry, ogHostIpV4Address=ogHostIpV4Address, ogAlarm=ogAlarm, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientEssid=ogWifiClientEssid, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcName=ogRpcName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogNetInterfaceState=ogNetInterfaceState, ogEmdTable=ogEmdTable, ogWifiApClientTable=ogWifiApClientTable, ogCellDataNotification=ogCellDataNotification, ogSerialUserIndex=ogSerialUserIndex, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcType=ogRpcType, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceCounter=ogHostServiceCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemCounter=ogCellModemCounter, ogWebUserEntry=ogWebUserEntry, ogCheckTable=ogCheckTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsConnectType=ogUpsConnectType, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceTable=ogHostServiceTable, ogCheckType=ogCheckType, ogHostEntry=ogHostEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApCounter=ogWifiApCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioNotification=ogEmdDioNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialUserTable=ogSerialUserTable, ogWifiApTable=ogWifiApTable, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortMode=ogSerialPortMode, ogWifiClientMode=ogWifiClientMode, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogStatus2Compliances=ogStatus2Compliances, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemApn=ogCellModemApn, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioType=ogEmdDioType, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApInterface=ogWifiApInterface, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsTable=ogUpsTable, ogWifiApClientMac=ogWifiApClientMac, ogMibNotifications=ogMibNotifications, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApTxPower=ogWifiApTxPower, ogWifiApIndex=ogWifiApIndex, ogWifiApEntry=ogWifiApEntry, ogUpsNotification=ogUpsNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWebUserTable=ogWebUserTable, ogUpsEntry=ogUpsEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApSsid=ogWifiApSsid, ogWifiApFrequency=ogWifiApFrequency, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellApnNotification=ogCellApnNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceHost=ogHostServiceHost, ogAlarmType=ogAlarmType, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceType=ogHostServiceType, ogCellModemConnected=ogCellModemConnected, ogRpcOutletName=ogRpcOutletName, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserName=ogWebUserName, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortParity=ogSerialPortParity, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostServicePort=ogHostServicePort, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortDSR=ogSerialPortDSR, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsCounter=ogUpsCounter, ogWifiClientCounter=ogWifiClientCounter, ogCellModemTable=ogCellModemTable, ogCellModemTemperature=ogCellModemTemperature, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsIndex=ogUpsIndex, ogEmdIndex=ogEmdIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcIndex=ogRpcIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioEmd=ogEmdDioEmd, ogUpsType=ogUpsType, ogHostPingNotification=ogHostPingNotification, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletState=ogRpcOutletState, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogStatus2Groups=ogStatus2Groups, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsLogEnabled=ogUpsLogEnabled, ogStatus2=ogStatus2, ogCellModemIndex=ogCellModemIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostName=ogHostName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModemModel=ogCellModemModel, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemEntry=ogCellModemEntry, ogHostUserNotification=ogHostUserNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdName=ogEmdName, ogHostUserName=ogHostUserName, ogAlarmDevice=ogAlarmDevice, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemTower=ogCellModemTower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsHumidity=ogUpsHumidity, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogHostUserHost=ogHostUserHost, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortLabel=ogSerialPortLabel, ogSerialNumber=ogSerialNumber, ogWifiClientTable=ogWifiClientTable, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioState=ogEmdDioState, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogStatus2Conformance=ogStatus2Conformance, ogEmdEntry=ogEmdEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogStatus2Compliance=ogStatus2Compliance, ogHostUserTable=ogHostUserTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmCheck=ogAlarmCheck, ogEmdDioEntry=ogEmdDioEntry, ogSerialUserPort=ogSerialUserPort, ogSerialPortIndex=ogSerialPortIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmState=ogAlarmState, ogWifiApClientEntry=ogWifiApClientEntry, ogSystem=ogSystem, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortFlowControl=ogSerialPortFlowControl, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientRssi=ogWifiClientRssi, ogHostUserHostName=ogHostUserHostName, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserAddress=ogHostUserAddress, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcMaxTemperature=ogRpcMaxTemperature)
