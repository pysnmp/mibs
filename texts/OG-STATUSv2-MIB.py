...
Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, ObjectIdentity, Unsigned32, Bits, MibIdentifier, Counter64, TimeTicks, IpAddress, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "ObjectIdentity", "Unsigned32", "Bits", "MibIdentifier", "Counter64", "TimeTicks", "IpAddress", "Counter32", "iso")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceHost=ogHostServiceHost, ogAlarmInstance=ogAlarmInstance, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcConnectType=ogRpcConnectType, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApTable=ogWifiApTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientApMac=ogWifiClientApMac, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientInterface=ogWifiClientInterface, ogCellSignalNotification=ogCellSignalNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserHost=ogHostUserHost, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioInputTotal=ogEmdDioInputTotal, ogMibNotifications=ogMibNotifications, ogRpcInputNotification=ogRpcInputNotification, ogWifiApIndex=ogWifiApIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmSummary=ogAlarmSummary, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcName=ogRpcName, ogSerialUserEntry=ogSerialUserEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostIpV4Address=ogHostIpV4Address, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWebUserStartTime=ogWebUserStartTime, ogWebUserSourcePort=ogWebUserSourcePort, ogNetInterfaceTable=ogNetInterfaceTable, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCellModemNetwork=ogCellModemNetwork, ogUpsOutputPower=ogUpsOutputPower, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogCustomNotification=ogCustomNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogCheckName=ogCheckName, ogUpsInputCurrent=ogUpsInputCurrent, ogWebUserEntry=ogWebUserEntry, ogStatus2Compliances=ogStatus2Compliances, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemTable=ogCellModemTable, ogUpsIndex=ogUpsIndex, PYSNMP_MODULE_ID=ogStatus2, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserAddress=ogHostUserAddress, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioState=ogEmdDioState, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmUser=ogAlarmUser, ogHostEntry=ogHostEntry, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostUserNotification=ogHostUserNotification, ogAlarmTime=ogAlarmTime, ogSerialUserName=ogSerialUserName, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsTable=ogUpsTable, ogHostServiceType=ogHostServiceType, ogWebUserName=ogWebUserName, ogSerialUserNotification=ogSerialUserNotification, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsName=ogUpsName, ogEmdHumidityIndex=ogEmdHumidityIndex, ogStatus2Groups=ogStatus2Groups, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortIndex=ogSerialPortIndex, ogHostIndex=ogHostIndex, ogHostUserEntry=ogHostUserEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletState=ogRpcOutletState, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortTable=ogSerialPortTable, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortDSR=ogSerialPortDSR, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortMode=ogSerialPortMode, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientIndex=ogWifiClientIndex, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApCounter=ogWifiApCounter, ogEmdDioType=ogEmdDioType, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCheckTriggerActions=ogCheckTriggerActions, ogPowerSupplyName=ogPowerSupplyName, ogWifiApEntry=ogWifiApEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortEntry=ogSerialPortEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApTxPower=ogWifiApTxPower, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApSsid=ogWifiApSsid, ogAlarmName=ogAlarmName, ogWifiClientTable=ogWifiClientTable, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletTable=ogRpcOutletTable, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemSessionTime=ogCellModemSessionTime, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsEntry=ogUpsEntry, ogUpsNotification=ogUpsNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcIndex=ogRpcIndex, ogAlarmDevice=ogAlarmDevice, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientEntry=ogWifiClientEntry, ogRpcEntry=ogRpcEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellTowerNotification=ogCellTowerNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApInterface=ogWifiApInterface, ogRpcTable=ogRpcTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemApn=ogCellModemApn, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiApFrequency=ogWifiApFrequency, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckDeviceName=ogCheckDeviceName, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientEssid=ogWifiClientEssid, ogEmdName=ogEmdName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserPort=ogSerialUserPort, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWebUserTable=ogWebUserTable, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDescription=ogEmdDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogFirmwareVersion=ogFirmwareVersion, ogHostPingNotification=ogHostPingNotification, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCellMessageNotification=ogCellMessageNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioIndex=ogEmdDioIndex, ogUpsConnectType=ogUpsConnectType, ogEmdEnabled=ogEmdEnabled, ogHostTable=ogHostTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletName=ogRpcOutletName, ogCheckIndex=ogCheckIndex, ogCheckTable=ogCheckTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortDTR=ogSerialPortDTR, ogUpsCounter=ogUpsCounter, ogWebUserIndex=ogWebUserIndex, ogCheckType=ogCheckType, ogStatus2=ogStatus2, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcType=ogRpcType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdConnectType=ogEmdConnectType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmEventId=ogAlarmEventId, ogRpcCounter=ogRpcCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcInputFrequency=ogRpcInputFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsState=ogUpsState, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmType=ogAlarmType, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemModel=ogCellModemModel, ogCellDataNotification=ogCellDataNotification, ogRpcDescription=ogRpcDescription, ogAlarmCheck=ogAlarmCheck)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostName=ogHostName, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSerialNumber=ogSerialNumber, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTable=ogEmdTable, ogEmdDioName=ogEmdDioName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioDirection=ogEmdDioDirection, ogCheckEntry=ogCheckEntry, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientTable=ogWifiApClientTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortDataBits=ogSerialPortDataBits, ogHostUserIndex=ogHostUserIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsDescription=ogUpsDescription, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioTable=ogEmdDioTable, ogAlarmState=ogAlarmState, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckResolveActions=ogCheckResolveActions, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModem4gRssi=ogCellModem4gRssi, ogHostServiceNotification=ogHostServiceNotification, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdEntry=ogEmdEntry, ogUpsBatteryState=ogUpsBatteryState, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsInputNotification=ogUpsInputNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemTower=ogCellModemTower, ogSystem=ogSystem, ogHostUserName=ogHostUserName, ogUpsType=ogUpsType, ogWifiApEnabled=ogWifiApEnabled, ogUpsTemperature=ogUpsTemperature, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserTable=ogHostUserTable, ogCurrentAlarmType=ogCurrentAlarmType, ogHostServiceTable=ogHostServiceTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientMode=ogWifiClientMode, ogHostServicePort=ogHostServicePort, ogHostUserHostName=ogHostUserHostName, ogCellModemIMSI=ogCellModemIMSI, ogAlarm=ogAlarm, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemVendor=ogCellModemVendor, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientMac=ogWifiApClientMac, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdIndex=ogEmdIndex, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientIndex=ogWifiApClientIndex)
