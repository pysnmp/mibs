...
NotificationType, Integer32, TimeTicks, ModuleIdentity, Gauge32, Counter64, MibIdentifier, IpAddress, iso, ObjectIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "TimeTicks", "ModuleIdentity", "Gauge32", "Counter64", "MibIdentifier", "IpAddress", "iso", "ObjectIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellTowerNotification=ogCellTowerNotification, ogUpsBatteryState=ogUpsBatteryState, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityNotification=ogEmdHumidityNotification, ogNetInterfaceState=ogNetInterfaceState, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmCheck=ogAlarmCheck, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioTable=ogEmdDioTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApIeeeMode=ogWifiApIeeeMode, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTable=ogEmdTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceType=ogNetInterfaceType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogStatus2=ogStatus2, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCustomNotification=ogCustomNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmTime=ogAlarmTime, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceHost=ogHostServiceHost, ogWifiClientEntry=ogWifiClientEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientRssi=ogWifiClientRssi, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceType=ogHostServiceType, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserTable=ogWebUserTable, ogSerialUserIndex=ogSerialUserIndex, ogSerialUserPort=ogSerialUserPort, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientMode=ogWifiClientMode, ogRpcName=ogRpcName, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcConnectType=ogRpcConnectType, ogRpcInputNotification=ogRpcInputNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialUserLabel=ogSerialUserLabel, ogWebUserEntry=ogWebUserEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserNotification=ogSerialUserNotification, ogHostServiceCounter=ogHostServiceCounter, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsNotification=ogUpsNotification, ogCellModemTemperature=ogCellModemTemperature, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdDioState=ogEmdDioState, ogHostIndex=ogHostIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApClientMac=ogWifiApClientMac, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcOutletTable=ogRpcOutletTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsDescription=ogUpsDescription, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApTxPower=ogWifiApTxPower, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckIndex=ogCheckIndex, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdIndex=ogEmdIndex, ogHostServiceNotification=ogHostServiceNotification, ogRpcDescription=ogRpcDescription, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemModel=ogCellModemModel, ogCellDataNotification=ogCellDataNotification, ogRpcEntry=ogRpcEntry, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApCounter=ogWifiApCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortIndex=ogSerialPortIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientEssid=ogWifiClientEssid, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioName=ogEmdDioName, ogAlarmState=ogAlarmState, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmSummary=ogAlarmSummary, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmInstance=ogAlarmInstance, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserName=ogSerialUserName, ogCurrentAlarmType=ogCurrentAlarmType, ogCellApnNotification=ogCellApnNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcIndex=ogRpcIndex, ogHostUserName=ogHostUserName, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemEnabled=ogCellModemEnabled, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsConnectType=ogUpsConnectType, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcLogEnabled=ogRpcLogEnabled, ogHostName=ogHostName, ogUpsHumidity=ogUpsHumidity, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserHost=ogHostUserHost, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortDCD=ogSerialPortDCD, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsOutputPower=ogUpsOutputPower, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemIndex=ogCellModemIndex, ogAlarmName=ogAlarmName, ogUpsState=ogUpsState, ogAlarmEventId=ogAlarmEventId, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdEntry=ogEmdEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckDeviceName=ogCheckDeviceName, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarm=ogAlarm, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdName=ogEmdName, ogHostUserEntry=ogHostUserEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemApn=ogCellModemApn, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckResolveActions=ogCheckResolveActions, ogUpsTemperature=ogUpsTemperature, ogSerialPortTable=ogSerialPortTable, ogAlarmDevice=ogAlarmDevice, ogCheckType=ogCheckType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogStatus2Groups=ogStatus2Groups, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputNotification=ogUpsInputNotification, ogCellModemRegistered=ogCellModemRegistered, ogFirmwareVersion=ogFirmwareVersion, ogHostUserIndex=ogHostUserIndex, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityCounter=ogEmdHumidityCounter, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsType=ogUpsType, ogCellModemIMSI=ogCellModemIMSI, ogWifiApInterface=ogWifiApInterface, ogWifiClientApMac=ogWifiClientApMac, ogRpcCounter=ogRpcCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostTable=ogHostTable, ogWebUserIndex=ogWebUserIndex, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortDSR=ogSerialPortDSR, ogRpcOutletName=ogRpcOutletName, ogHostUserTable=ogHostUserTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServiceTable=ogHostServiceTable, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemVendor=ogCellModemVendor, ogEmdDioType=ogEmdDioType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcTable=ogRpcTable, ogHostEntry=ogHostEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWebUserNotification=ogWebUserNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckTable=ogCheckTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogAlarmType=ogAlarmType, ogEmdConnectType=ogEmdConnectType, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialNumber=ogSerialNumber, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortParity=ogSerialPortParity, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostIpV4Address=ogHostIpV4Address, ogHostPingNotification=ogHostPingNotification, ogCellModemTable=ogCellModemTable, ogCheckDeviceRef=ogCheckDeviceRef, ogSystem=ogSystem, ogWebUserName=ogWebUserName, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogHostServicePort=ogHostServicePort, ogAlarmPreviousValue=ogAlarmPreviousValue)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemEntry=ogCellModemEntry, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientTable=ogWifiApClientTable, ogCellModemTower=ogCellModemTower, ogHostServiceIndex=ogHostServiceIndex, ogWifiApIndex=ogWifiApIndex, ogUpsName=ogUpsName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientInterface=ogWifiClientInterface, ogUpsTable=ogUpsTable, ogSerialPortMode=ogSerialPortMode, ogEmdEnabled=ogEmdEnabled, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsIndex=ogUpsIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdTemperatureTable=ogEmdTemperatureTable, ogNetInterfaceName=ogNetInterfaceName, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDescription=ogEmdDescription, ogSerialUserTable=ogSerialUserTable, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsCounter=ogUpsCounter, ogWifiApTable=ogWifiApTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserNotification=ogHostUserNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyName=ogPowerSupplyName, ogRpcType=ogRpcType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioCounter=ogEmdDioCounter, ogWifiApEntry=ogWifiApEntry, ogRpcOutletState=ogRpcOutletState, ogCheckName=ogCheckName, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmUser=ogAlarmUser, ogSerialPortDTR=ogSerialPortDTR, ogEmdHumidityName=ogEmdHumidityName, ogMibNotifications=ogMibNotifications, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientCounter=ogWifiClientCounter, ogCheckEntry=ogCheckEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostUserHostName=ogHostUserHostName, ogWifiClientTable=ogWifiClientTable, ogWifiApClientAp=ogWifiApClientAp, ogUpsEntry=ogUpsEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientBitRate=ogWifiClientBitRate)
