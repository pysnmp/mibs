...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletState=ogRpcOutletState, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsCounter=ogUpsCounter, ogRpcName=ogRpcName, ogWifiApEntry=ogWifiApEntry, ogAlarm=ogAlarm, ogCellApnNotification=ogCellApnNotification, ogEmdIndex=ogEmdIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioDirection=ogEmdDioDirection, ogUpsTemperature=ogUpsTemperature, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsEntry=ogUpsEntry, ogFirmwareVersion=ogFirmwareVersion, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostServicePort=ogHostServicePort, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioName=ogEmdDioName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityIndex=ogEmdHumidityIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsConnectType=ogUpsConnectType, ogEmdTable=ogEmdTable, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmTable=ogCurrentAlarmTable, ogNetInterfaceName=ogNetInterfaceName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApSsid=ogWifiApSsid, ogCheckName=ogCheckName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsIndex=ogUpsIndex, ogSerialUserNotification=ogSerialUserNotification, ogHostServiceHost=ogHostServiceHost, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemApn=ogCellModemApn, ogRpcCounter=ogRpcCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsNotification=ogUpsNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostEntry=ogHostEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemIMSI=ogCellModemIMSI, ogWebUserIndex=ogWebUserIndex, ogRpcIndex=ogRpcIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdDioEmd=ogEmdDioEmd, ogStatus2Conformance=ogStatus2Conformance, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletName=ogRpcOutletName, ogStatus2Compliance=ogStatus2Compliance, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcTable=ogRpcTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcConnectType=ogRpcConnectType, ogRpcLogEnabled=ogRpcLogEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmInstance=ogAlarmInstance, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmName=ogAlarmName, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputPower=ogUpsOutputPower, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientInterface=ogWifiClientInterface, ogAlarmState=ogAlarmState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsInputNotification=ogUpsInputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortDCD=ogSerialPortDCD, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserName=ogHostUserName, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialUserLabel=ogSerialUserLabel, ogHostServiceEntry=ogHostServiceEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsHumidity=ogUpsHumidity, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsName=ogUpsName, ogWifiApTable=ogWifiApTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientApMac=ogWifiClientApMac, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletTable=ogRpcOutletTable, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientIndex=ogWifiClientIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogWebUserEntry=ogWebUserEntry, ogWifiClientEssid=ogWifiClientEssid, ogUpsDescription=ogUpsDescription, ogSerialPortRTS=ogSerialPortRTS, ogStatus2=ogStatus2, ogEmdEntry=ogEmdEntry, ogStatus2Groups=ogStatus2Groups, ogCheckEntry=ogCheckEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyTable=ogPowerSupplyTable, ogHostUserAddress=ogHostUserAddress, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemEntry=ogCellModemEntry, ogCellModemTemperature=ogCellModemTemperature, ogWifiApIndex=ogWifiApIndex, ogSerialUserEntry=ogSerialUserEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioDescription=ogEmdDioDescription, ogHostPingNotification=ogHostPingNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioTable=ogEmdDioTable, ogAlarmType=ogAlarmType, ogCheckDeviceName=ogCheckDeviceName, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialUserTable=ogSerialUserTable, ogUpsTable=ogUpsTable, ogSerialPortMode=ogSerialPortMode, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDescription=ogEmdDescription, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostUserTable=ogHostUserTable, ogNetInterfaceType=ogNetInterfaceType, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCellDataNotification=ogCellDataNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemModel=ogCellModemModel, ogEmdHumidityEmd=ogEmdHumidityEmd, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsOutputLoad=ogUpsOutputLoad, ogHostServiceNotification=ogHostServiceNotification, ogCellSignalNotification=ogCellSignalNotification, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserStartTime=ogHostUserStartTime, ogCellModemVendor=ogCellModemVendor, ogCellModemNetwork=ogCellModemNetwork, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServiceType=ogHostServiceType, ogWifiApCounter=ogWifiApCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApEnabled=ogWifiApEnabled, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserHost=ogHostUserHost, ogHostIndex=ogHostIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmSummary=ogAlarmSummary, ogCustomNotification=ogCustomNotification, ogEmdConnectType=ogEmdConnectType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientTable=ogWifiApClientTable, ogPowerSupplyName=ogPowerSupplyName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmTime=ogAlarmTime, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostServiceCounter=ogHostServiceCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckIndex=ogCheckIndex, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsBatteryState=ogUpsBatteryState, ogMibNotifications=ogMibNotifications, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsType=ogUpsType, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioState=ogEmdDioState, ogHostUserIndex=ogHostUserIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortParity=ogSerialPortParity, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmDevice=ogAlarmDevice, ogRpcDescription=ogRpcDescription, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSystem=ogSystem, ogCellMessageNotification=ogCellMessageNotification, ogEmdName=ogEmdName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmTriggerValue=ogAlarmTriggerValue)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortTable=ogSerialPortTable, ogWebUserTable=ogWebUserTable, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemIndex=ogCellModemIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWebUserName=ogWebUserName, ogCheckType=ogCheckType, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioType=ogEmdDioType, ogSerialPortSpeed=ogSerialPortSpeed, ogHostName=ogHostName, ogCheckTable=ogCheckTable, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientEntry=ogWifiClientEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemTable=ogCellModemTable, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceTable=ogHostServiceTable, ogWifiClientMode=ogWifiClientMode, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialUserPort=ogSerialUserPort, ogWifiApFrequency=ogWifiApFrequency, PYSNMP_MODULE_ID=ogStatus2, ogAlarmUser=ogAlarmUser, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialUserIndex=ogSerialUserIndex, ogHostUserHostName=ogHostUserHostName, ogAlarmEventId=ogAlarmEventId, ogSerialPortDSR=ogSerialPortDSR, ogUpsState=ogUpsState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientTable=ogWifiClientTable, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApTxPower=ogWifiApTxPower, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDioEntry=ogEmdDioEntry, ogCellModemTower=ogCellModemTower, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcType=ogRpcType, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceIndex=ogHostServiceIndex, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserEntry=ogHostUserEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogCellNetworkNotification=ogCellNetworkNotification, ogWebUserNotification=ogWebUserNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcEntry=ogRpcEntry, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialNumber=ogSerialNumber, ogSerialPortCTS=ogSerialPortCTS, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemCounter=ogCellModemCounter, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserName=ogSerialUserName, ogWifiClientEnabled=ogWifiClientEnabled, ogHostTable=ogHostTable)
