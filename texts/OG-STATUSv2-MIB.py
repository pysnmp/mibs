...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32, TimeTicks, ObjectIdentity, NotificationType, Unsigned32, Bits, MibIdentifier, IpAddress, ModuleIdentity, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32", "TimeTicks", "ObjectIdentity", "NotificationType", "Unsigned32", "Bits", "MibIdentifier", "IpAddress", "ModuleIdentity", "Integer32", "iso")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogPowerSupplyTable=ogPowerSupplyTable, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientInterface=ogWifiClientInterface, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputNotification=ogUpsInputNotification, ogNetInterfaceName=ogNetInterfaceName, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmName=ogAlarmName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcName=ogRpcName, ogCellApnNotification=ogCellApnNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemTower=ogCellModemTower, ogSystem=ogSystem, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdTable=ogEmdTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsIndex=ogUpsIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientTable=ogWifiClientTable, ogCellModemRegistered=ogCellModemRegistered, ogCellModemCounter=ogCellModemCounter, ogUpsEntry=ogUpsEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApClientTable=ogWifiApClientTable, ogAlarmEventId=ogAlarmEventId, ogCellMessageNotification=ogCellMessageNotification, ogWifiApSsid=ogWifiApSsid, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceTable=ogHostServiceTable, ogAlarmTime=ogAlarmTime, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemEntry=ogCellModemEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsInputVoltage=ogUpsInputVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortTable=ogSerialPortTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortMode=ogSerialPortMode, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApInterface=ogWifiApInterface, ogWifiClientEntry=ogWifiClientEntry, ogEmdEnabled=ogEmdEnabled, ogEmdDioName=ogEmdDioName, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemConnected=ogCellModemConnected, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostUserHost=ogHostUserHost, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcDescription=ogRpcDescription, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemVendor=ogCellModemVendor, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcIndex=ogRpcIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogCellDataNotification=ogCellDataNotification, ogSerialPortLabel=ogSerialPortLabel, ogUpsTable=ogUpsTable, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemTemperature=ogCellModemTemperature, ogCustomNotification=ogCustomNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortEntry=ogSerialPortEntry, ogHostUserHostName=ogHostUserHostName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmState=ogAlarmState, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckDeviceName=ogCheckDeviceName, ogRpcInputCurrent=ogRpcInputCurrent, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsState=ogUpsState, ogEmdName=ogEmdName, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientRssi=ogWifiApClientRssi, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutletVoltage=ogRpcOutletVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcTable=ogRpcTable, ogSerialPortDSR=ogSerialPortDSR, ogRpcInputNotification=ogRpcInputNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientApMac=ogWifiClientApMac, ogPowerSupplyName=ogPowerSupplyName, ogHostServiceCounter=ogHostServiceCounter, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientTxPower=ogWifiClientTxPower, ogHostIndex=ogHostIndex, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemApn=ogCellModemApn, ogHostTable=ogHostTable, ogHostUserAddress=ogHostUserAddress, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserName=ogHostUserName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortRTS=ogSerialPortRTS, ogCheckEntry=ogCheckEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogMibNotifications=ogMibNotifications, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarm=ogAlarm, ogEmdDioDirection=ogEmdDioDirection, ogEmdConnectType=ogEmdConnectType, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortIndex=ogSerialPortIndex, ogRpcType=ogRpcType, ogRpcInputFrequency=ogRpcInputFrequency, ogCellTowerNotification=ogCellTowerNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortDCD=ogSerialPortDCD, ogWebUserStartTime=ogWebUserStartTime, ogRpcOutletName=ogRpcOutletName, ogAlarmType=ogAlarmType, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputLoad=ogUpsOutputLoad, ogCheckType=ogCheckType, ogWifiApFrequency=ogWifiApFrequency, ogCellModemTable=ogCellModemTable, ogSerialNumber=ogSerialNumber, ogCellModemIMSI=ogCellModemIMSI, ogAlarmSummary=ogAlarmSummary, ogEmdIndex=ogEmdIndex, PYSNMP_MODULE_ID=ogStatus2, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckName=ogCheckName, ogWifiApCounter=ogWifiApCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialUserNotification=ogSerialUserNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserName=ogSerialUserName, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogStatus2Conformance=ogStatus2Conformance, ogUpsName=ogUpsName, ogEmdDescription=ogEmdDescription, ogWebUserNotification=ogWebUserNotification, ogWifiApTxPower=ogWifiApTxPower, ogRpcEntry=ogRpcEntry, ogEmdEntry=ogEmdEntry, ogFirmwareVersion=ogFirmwareVersion, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmCheck=ogAlarmCheck, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioState=ogEmdDioState, ogUpsType=ogUpsType, ogWifiClientBitRate=ogWifiClientBitRate, ogHostEntry=ogHostEntry, ogWifiApClientMac=ogWifiApClientMac, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsCounter=ogUpsCounter, ogEmdDioEntry=ogEmdDioEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckTable=ogCheckTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcCounter=ogRpcCounter, ogSerialUserEntry=ogSerialUserEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckIndex=ogCheckIndex, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostServiceIndex=ogHostServiceIndex, ogWebUserIndex=ogWebUserIndex, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWebUserTable=ogWebUserTable, ogWebUserName=ogWebUserName, ogEmdHumidityName=ogEmdHumidityName, ogHostUserNotification=ogHostUserNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdDioDescription=ogEmdDioDescription, ogEmdDioEmd=ogEmdDioEmd, ogEmdDioType=ogEmdDioType, ogEmdDioNotification=ogEmdDioNotification, ogRpcOutletState=ogRpcOutletState, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortParity=ogSerialPortParity, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsBatteryState=ogUpsBatteryState, ogUpsTemperature=ogUpsTemperature, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientEssid=ogWifiClientEssid, ogHostServiceType=ogHostServiceType, ogCellModemModel=ogCellModemModel, ogUpsNotification=ogUpsNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApTable=ogWifiApTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellSignalNotification=ogCellSignalNotification, ogWifiApEntry=ogWifiApEntry, ogNetInterfaceType=ogNetInterfaceType, ogNetInterfaceState=ogNetInterfaceState, ogHostIpV4Address=ogHostIpV4Address, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogStatus2=ogStatus2, ogWifiApIndex=ogWifiApIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletTable=ogRpcOutletTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmUser=ogAlarmUser, ogUpsConnectType=ogUpsConnectType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostPingNotification=ogHostPingNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortCTS=ogSerialPortCTS, ogWifiApEnabled=ogWifiApEnabled, ogHostName=ogHostName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientMode=ogWifiClientMode, ogAlarmInstance=ogAlarmInstance, ogEmdDioIndex=ogEmdDioIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserTable=ogHostUserTable, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostUserEntry=ogHostUserEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientRssi=ogWifiClientRssi, ogUpsHumidity=ogUpsHumidity, ogRpcConnectType=ogRpcConnectType, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostServicePort=ogHostServicePort, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemIndex=ogCellModemIndex, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsDescription=ogUpsDescription, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserEntry=ogWebUserEntry, ogNetInterfaceNotification=ogNetInterfaceNotification)
