...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemCounter=ogCellModemCounter, ogAlarm=ogAlarm, ogEmdDioNotification=ogEmdDioNotification, ogSerialPortDTR=ogSerialPortDTR, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostServiceTable=ogHostServiceTable, ogCheckEntry=ogCheckEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioState=ogEmdDioState, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdTemperatureTable=ogEmdTemperatureTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogStatus2Compliance=ogStatus2Compliance, ogHostEntry=ogHostEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemVendor=ogCellModemVendor, ogHostUserName=ogHostUserName, ogUpsConnectType=ogUpsConnectType, ogHostIpV6Address=ogHostIpV6Address, ogWifiApSsid=ogWifiApSsid, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletName=ogRpcOutletName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWifiApIndex=ogWifiApIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckName=ogCheckName, ogHostServiceHost=ogHostServiceHost, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialUserLabel=ogSerialUserLabel, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellApnNotification=ogCellApnNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckTable=ogCheckTable, ogSerialSignalNotification=ogSerialSignalNotification, PYSNMP_MODULE_ID=ogStatus2, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemTower=ogCellModemTower, ogRpcOutletTable=ogRpcOutletTable, ogWifiApTable=ogWifiApTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsInputFrequency=ogUpsInputFrequency, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApCounter=ogWifiApCounter, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioDescription=ogEmdDioDescription, ogSerialUserNotification=ogSerialUserNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceType=ogHostServiceType, ogStatus2Compliances=ogStatus2Compliances, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceState=ogNetInterfaceState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmLogIndex=ogAlarmLogIndex, ogCellTowerNotification=ogCellTowerNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdName=ogEmdName, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialUserIndex=ogSerialUserIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsInputNotification=ogUpsInputNotification, ogHostUserHostName=ogHostUserHostName, ogRpcOutletState=ogRpcOutletState, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientAp=ogWifiApClientAp, ogWifiApEnabled=ogWifiApEnabled, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmType=ogAlarmType, ogAlarmState=ogAlarmState, ogWebUserStartTime=ogWebUserStartTime, ogCellDataNotification=ogCellDataNotification, ogCellModemTemperature=ogCellModemTemperature, ogSerialUserPort=ogSerialUserPort, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioTable=ogEmdDioTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcConnectType=ogRpcConnectType, ogSystem=ogSystem, ogSerialPortRTS=ogSerialPortRTS, ogCellModemApn=ogCellModemApn, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCheckTriggerActions=ogCheckTriggerActions, ogHostUserEntry=ogHostUserEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientFrequency=ogWifiClientFrequency, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsEntry=ogUpsEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmLogEntry=ogAlarmLogEntry, ogNetInterfaceType=ogNetInterfaceType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsHumidity=ogUpsHumidity, ogCellSignalNotification=ogCellSignalNotification, ogSerialUserEntry=ogSerialUserEntry, ogWebUserName=ogWebUserName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmUser=ogAlarmUser, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortCTS=ogSerialPortCTS, ogWebUserEntry=ogWebUserEntry, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioDirection=ogEmdDioDirection, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortTable=ogSerialPortTable, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserNotification=ogWebUserNotification, ogEmdDioName=ogEmdDioName, ogWifiClientEntry=ogWifiClientEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdConnectType=ogEmdConnectType, ogSerialUserName=ogSerialUserName, ogHostServiceStatus=ogHostServiceStatus, ogUpsNotification=ogUpsNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsTemperature=ogUpsTemperature, ogWifiApClientMac=ogWifiApClientMac, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmTime=ogAlarmTime, ogRpcTable=ogRpcTable, ogSerialUserTable=ogSerialUserTable, ogCellModemConnected=ogCellModemConnected, ogSerialPortStopBits=ogSerialPortStopBits, ogMibNotifications=ogMibNotifications, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostIndex=ogHostIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortDCD=ogSerialPortDCD, ogRpcInputNotification=ogRpcInputNotification, ogStatus2=ogStatus2, ogHostPingNotification=ogHostPingNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceCounter=ogHostServiceCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryNotification=ogUpsBatteryNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemIndex=ogCellModemIndex, ogUpsCounter=ogUpsCounter, ogCellMessageNotification=ogCellMessageNotification, ogRpcEntry=ogRpcEntry, ogSerialPortMode=ogSerialPortMode, ogHostServiceNotification=ogHostServiceNotification, ogCellModemModel=ogCellModemModel, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientMode=ogWifiClientMode, ogUpsType=ogUpsType, ogCheckType=ogCheckType, ogHostName=ogHostName, ogEmdTable=ogEmdTable, ogUpsTable=ogUpsTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientTable=ogWifiApClientTable, ogHostIpV4Address=ogHostIpV4Address, ogEmdDioIndex=ogEmdDioIndex, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWebUserIndex=ogWebUserIndex, ogUpsDescription=ogUpsDescription, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCustomNotification=ogCustomNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckResolveActions=ogCheckResolveActions, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostUserIndex=ogHostUserIndex, ogAlarmName=ogAlarmName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioType=ogEmdDioType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortEntry=ogSerialPortEntry, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientTable=ogWifiClientTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmDevice=ogAlarmDevice, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityTable=ogEmdHumidityTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityName=ogEmdHumidityName, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserTable=ogHostUserTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogHostUserAddress=ogHostUserAddress, ogRpcCounter=ogRpcCounter, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcType=ogRpcType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsIndex=ogUpsIndex, ogRpcIndex=ogRpcIndex, ogCheckIndex=ogCheckIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmInstance=ogAlarmInstance, ogEmdDioEntry=ogEmdDioEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostUserNotification=ogHostUserNotification, ogEmdIndex=ogEmdIndex, ogHostServicePort=ogHostServicePort, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletFrequency=ogRpcOutletFrequency, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWebUserTable=ogWebUserTable, ogSerialNumber=ogSerialNumber, ogWifiApInterface=ogWifiApInterface, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostUserHost=ogHostUserHost, ogRpcName=ogRpcName, ogCellModemEntry=ogCellModemEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutletNotification=ogRpcOutletNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemTable=ogCellModemTable, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsState=ogUpsState, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogFirmwareVersion=ogFirmwareVersion, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDescription=ogEmdDescription, ogRpcDescription=ogRpcDescription, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApFrequency=ogWifiApFrequency, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortParity=ogSerialPortParity, ogEmdEntry=ogEmdEntry, ogStatus2Groups=ogStatus2Groups, ogHostTable=ogHostTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApEntry=ogWifiApEntry, ogUpsName=ogUpsName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortSpeed=ogSerialPortSpeed)
