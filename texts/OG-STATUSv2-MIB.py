...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientMode=ogWifiClientMode, ogSerialPortStopBits=ogSerialPortStopBits, ogRpcInputVoltage=ogRpcInputVoltage, ogCellMessageNotification=ogCellMessageNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellSignalNotification=ogCellSignalNotification, ogUpsEntry=ogUpsEntry, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemEnabled=ogCellModemEnabled, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortTable=ogSerialPortTable, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdHumidityName=ogEmdHumidityName, ogUpsIndex=ogUpsIndex, ogAlarmUser=ogAlarmUser, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioName=ogEmdDioName, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientApMac=ogWifiClientApMac, ogAlarmType=ogAlarmType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioState=ogEmdDioState, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdIndex=ogEmdIndex, ogSerialPortParity=ogSerialPortParity, ogEmdDioDescription=ogEmdDioDescription, ogCellModemCounter=ogCellModemCounter, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientCounter=ogWifiClientCounter, ogHostServiceType=ogHostServiceType, ogMibNotifications=ogMibNotifications, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogStatus2Compliance=ogStatus2Compliance, ogHostUserEntry=ogHostUserEntry, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmState=ogCurrentAlarmState, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityNotification=ogEmdHumidityNotification, ogStatus2Groups=ogStatus2Groups, ogRpcName=ogRpcName, ogSerialUserLabel=ogSerialUserLabel, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellTowerNotification=ogCellTowerNotification, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialUserPort=ogSerialUserPort, ogWifiClientRssi=ogWifiClientRssi, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcTable=ogRpcTable, ogEmdName=ogEmdName, ogEmdTable=ogEmdTable, ogNetInterfaceState=ogNetInterfaceState, ogCellModemTable=ogCellModemTable, ogCustomNotification=ogCustomNotification, ogUpsType=ogUpsType, ogRpcOutletState=ogRpcOutletState, ogHostUserHostName=ogHostUserHostName, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogStatus2Conformance=ogStatus2Conformance, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcCounter=ogRpcCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdConnectType=ogEmdConnectType, ogWifiApCounter=ogWifiApCounter, ogWifiApTable=ogWifiApTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdEntry=ogEmdEntry, ogUpsTemperature=ogUpsTemperature, ogCellModemConnected=ogCellModemConnected, ogWebUserStartTime=ogWebUserStartTime, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmTime=ogAlarmTime, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcType=ogRpcType, ogHostUserTable=ogHostUserTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserEntry=ogWebUserEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemModel=ogCellModemModel, ogRpcOutputNotification=ogRpcOutputNotification, ogHostIpV6Address=ogHostIpV6Address, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmInstance=ogAlarmInstance, ogWifiClientIndex=ogWifiClientIndex, ogUpsInputFrequency=ogUpsInputFrequency, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckEntry=ogCheckEntry, ogUpsBatteryState=ogUpsBatteryState, ogWifiApInterface=ogWifiApInterface, ogSerialPortRTS=ogSerialPortRTS, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostEntry=ogHostEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioTable=ogEmdDioTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApSsid=ogWifiApSsid, ogCheckType=ogCheckType, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientTable=ogWifiClientTable, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioEntry=ogEmdDioEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortSpeed=ogSerialPortSpeed, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostServicePort=ogHostServicePort, ogAlarm=ogAlarm, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemApn=ogCellModemApn, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientMac=ogWifiApClientMac, ogUpsTable=ogUpsTable, ogHostUserNotification=ogHostUserNotification, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputNotification=ogUpsOutputNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyName=ogPowerSupplyName, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApEntry=ogWifiApEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsCounter=ogUpsCounter, ogUpsOutputPower=ogUpsOutputPower, ogHostUserStartTime=ogHostUserStartTime, ogUpsNotification=ogUpsNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortDSR=ogSerialPortDSR, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmState=ogAlarmState, ogRpcOutletName=ogRpcOutletName, ogHostUserName=ogHostUserName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcDescription=ogRpcDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdDescription=ogEmdDescription, ogSerialPortIndex=ogSerialPortIndex, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioType=ogEmdDioType, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortDTR=ogSerialPortDTR, ogEmdHumidityTotal=ogEmdHumidityTotal, ogAlarmName=ogAlarmName, ogUpsInputNotification=ogUpsInputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemIndex=ogCellModemIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckTable=ogCheckTable, ogHostUserIndex=ogHostUserIndex, ogRpcIndex=ogRpcIndex, ogHostServiceIndex=ogHostServiceIndex, ogHostServiceCounter=ogHostServiceCounter, ogSystem=ogSystem, ogNetInterfaceName=ogNetInterfaceName, ogHostIndex=ogHostIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortEntry=ogSerialPortEntry, PYSNMP_MODULE_ID=ogStatus2, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWebUserTable=ogWebUserTable, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServiceStatus=ogHostServiceStatus, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemRegistered=ogCellModemRegistered, ogRpcConnectType=ogRpcConnectType, ogWebUserNotification=ogWebUserNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceHost=ogHostServiceHost, ogEmdEnabled=ogEmdEnabled, ogUpsName=ogUpsName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialPortDCD=ogSerialPortDCD, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogCellApnNotification=ogCellApnNotification, ogAlarmDevice=ogAlarmDevice, ogUpsHumidity=ogUpsHumidity, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogStatus2=ogStatus2, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserHost=ogHostUserHost, ogAlarmLogTable=ogAlarmLogTable, ogHostUserAddress=ogHostUserAddress, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemTower=ogCellModemTower, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogStatus2Compliances=ogStatus2Compliances, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemEntry=ogCellModemEntry, ogWifiApIndex=ogWifiApIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialUserName=ogSerialUserName, ogRpcEntry=ogRpcEntry, ogHostPingNotification=ogHostPingNotification, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialUserIndex=ogSerialUserIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmEventId=ogAlarmEventId, ogHostName=ogHostName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientEnabled=ogWifiClientEnabled, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCheckIndex=ogCheckIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientEssid=ogWifiClientEssid, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostServiceNotification=ogHostServiceNotification, ogAlarmCheck=ogAlarmCheck, ogCheckDeviceName=ogCheckDeviceName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostServiceTable=ogHostServiceTable, ogEmdDioDirection=ogEmdDioDirection, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmSummary=ogAlarmSummary, ogUpsDescription=ogUpsDescription, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApFrequency=ogWifiApFrequency, ogSerialNumber=ogSerialNumber, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialUserTable=ogSerialUserTable, ogCellModemVendor=ogCellModemVendor, ogUpsState=ogUpsState, ogCheckName=ogCheckName, ogWebUserName=ogWebUserName, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletTable=ogRpcOutletTable, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserStartTime=ogSerialUserStartTime, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostTable=ogHostTable)
