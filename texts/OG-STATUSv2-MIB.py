...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApFrequency=ogWifiApFrequency, ogWebUserIndex=ogWebUserIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioTable=ogEmdDioTable, ogAlarmName=ogAlarmName, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemModel=ogCellModemModel, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcType=ogRpcType, ogCellModemCounter=ogCellModemCounter, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletTotal=ogRpcOutletTotal, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioEntry=ogEmdDioEntry, ogAlarmInstance=ogAlarmInstance, ogCellModemEnabled=ogCellModemEnabled, ogWifiApClientAp=ogWifiApClientAp, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioIndex=ogEmdDioIndex, ogWifiApCounter=ogWifiApCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcInputNotification=ogRpcInputNotification, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioNotification=ogEmdDioNotification, ogUpsHumidity=ogUpsHumidity, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsInputFrequency=ogUpsInputFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApTable=ogWifiApTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemConnected=ogCellModemConnected, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostIpV4Address=ogHostIpV4Address, ogHostUserNotification=ogHostUserNotification, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientEssid=ogWifiClientEssid, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemEntry=ogCellModemEntry, ogAlarmLogTable=ogAlarmLogTable, ogUpsNotification=ogUpsNotification, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcName=ogRpcName, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioName=ogEmdDioName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcConnectType=ogRpcConnectType, ogSerialUserNotification=ogSerialUserNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdIndex=ogEmdIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApClientTable=ogWifiApClientTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdName=ogEmdName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcCounter=ogRpcCounter, ogSerialPortEntry=ogSerialPortEntry, ogWifiApIndex=ogWifiApIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsState=ogUpsState, ogCellModemNetwork=ogCellModemNetwork, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceState=ogNetInterfaceState, ogCheckResolveActions=ogCheckResolveActions, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientIndex=ogWifiClientIndex, ogWebUserTable=ogWebUserTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmUser=ogAlarmUser, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserName=ogSerialUserName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyName=ogPowerSupplyName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserNotification=ogWebUserNotification, ogStatus2=ogStatus2, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApEntry=ogWifiApEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApInterface=ogWifiApInterface, ogHostServiceNotification=ogHostServiceNotification, ogCellModemTower=ogCellModemTower, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostServiceTable=ogHostServiceTable, ogCellModem3gRssi=ogCellModem3gRssi, ogHostIndex=ogHostIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsConnectType=ogUpsConnectType, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityName=ogEmdHumidityName, ogEmdDescription=ogEmdDescription, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostEntry=ogHostEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsInputCurrent=ogUpsInputCurrent, ogCellDataNotification=ogCellDataNotification, ogRpcOutletState=ogRpcOutletState, ogCheckDeviceName=ogCheckDeviceName, ogAlarmCheck=ogAlarmCheck, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApEnabled=ogWifiApEnabled, ogHostTable=ogHostTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcTable=ogRpcTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortParity=ogSerialPortParity, ogStatus2Compliance=ogStatus2Compliance, ogEmdTable=ogEmdTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsIndex=ogUpsIndex, ogSerialUserLabel=ogSerialUserLabel, ogHostUserStartTime=ogHostUserStartTime, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioCounter=ogEmdDioCounter, ogHostName=ogHostName, ogHostUserName=ogHostUserName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsCounter=ogUpsCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsDescription=ogUpsDescription, ogUpsEntry=ogUpsEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostUserEntry=ogHostUserEntry, ogHostServiceEntry=ogHostServiceEntry, ogCheckEntry=ogCheckEntry, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioEmd=ogEmdDioEmd, ogEmdLogEnabled=ogEmdLogEnabled, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientBitRate=ogWifiClientBitRate, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceName=ogNetInterfaceName, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioState=ogEmdDioState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCheckDeviceTable=ogCheckDeviceTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortDataBits=ogSerialPortDataBits, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDioDescription=ogEmdDioDescription, ogCellModemTable=ogCellModemTable, ogSerialPortCTS=ogSerialPortCTS, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSystem=ogSystem, ogCheckTable=ogCheckTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdEnabled=ogEmdEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogAlarmEventId=ogAlarmEventId, ogRpcIndex=ogRpcIndex, ogSerialPortDCD=ogSerialPortDCD, ogStatus2Compliances=ogStatus2Compliances, ogRpcOutletEntry=ogRpcOutletEntry, ogWebUserStartTime=ogWebUserStartTime, ogEmdDioType=ogEmdDioType, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortLabel=ogSerialPortLabel, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortMode=ogSerialPortMode, ogAlarm=ogAlarm, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsTemperature=ogUpsTemperature, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserAddress=ogHostUserAddress, ogAlarmState=ogAlarmState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientEntry=ogWifiClientEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceType=ogHostServiceType, ogStatus2Groups=ogStatus2Groups, ogWifiClientApMac=ogWifiClientApMac, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemRegistered=ogCellModemRegistered, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortTable=ogSerialPortTable, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletName=ogRpcOutletName, ogEmdConnectType=ogEmdConnectType, ogCellModemIMSI=ogCellModemIMSI, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemIndex=ogCellModemIndex, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutletRpc=ogRpcOutletRpc, ogCellApnNotification=ogCellApnNotification, ogAlarmType=ogAlarmType, ogUpsInputVoltage=ogUpsInputVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceIndex=ogHostServiceIndex, ogCellModemVendor=ogCellModemVendor, ogHostUserTable=ogHostUserTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortIndex=ogSerialPortIndex, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckType=ogCheckType, ogSerialPortDSR=ogSerialPortDSR, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcEntry=ogRpcEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdEntry=ogEmdEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmTime=ogAlarmTime, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsName=ogUpsName, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostUserIndex=ogHostUserIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioDirection=ogEmdDioDirection, ogNetInterfaceType=ogNetInterfaceType, ogRpcDescription=ogRpcDescription, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientMode=ogWifiClientMode, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostServicePort=ogHostServicePort, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWebUserEntry=ogWebUserEntry, ogSerialUserPort=ogSerialUserPort, ogUpsType=ogUpsType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortRTS=ogSerialPortRTS, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserIndex=ogSerialUserIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdHumidityEntry=ogEmdHumidityEntry, ogMibNotifications=ogMibNotifications, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckName=ogCheckName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsTable=ogUpsTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmDevice=ogAlarmDevice, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckResetTimeout=ogCheckResetTimeout, ogWebUserName=ogWebUserName, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserHost=ogHostUserHost, ogCheckIndex=ogCheckIndex, ogSerialNumber=ogSerialNumber, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemApn=ogCellModemApn, ogAlarmSummary=ogAlarmSummary, ogCustomNotification=ogCustomNotification)
