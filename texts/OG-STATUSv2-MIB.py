...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Counter64, IpAddress, ModuleIdentity, Counter32, Bits, Unsigned32, MibIdentifier, Integer32, NotificationType, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Counter64", "IpAddress", "ModuleIdentity", "Counter32", "Bits", "Unsigned32", "MibIdentifier", "Integer32", "NotificationType", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientCounter=ogWifiClientCounter, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemEnabled=ogCellModemEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientTable=ogWifiApClientTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcCounter=ogRpcCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostPingNotification=ogHostPingNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApIeeeMode=ogWifiApIeeeMode, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckTable=ogCheckTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdConnectType=ogEmdConnectType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialUserLabel=ogSerialUserLabel, ogHostUserTable=ogHostUserTable, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmSummary=ogAlarmSummary, ogRpcType=ogRpcType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogCellDataNotification=ogCellDataNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientRssi=ogWifiClientRssi, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostTable=ogHostTable, ogEmdDioTable=ogEmdDioTable, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApTxPower=ogWifiApTxPower, ogAlarmType=ogAlarmType, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellMessageNotification=ogCellMessageNotification, ogCellModemNetwork=ogCellModemNetwork, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDescription=ogEmdDescription, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogAlarmTime=ogAlarmTime, ogRpcTable=ogRpcTable, ogAlarmUser=ogAlarmUser, ogSystem=ogSystem, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostIpV6Address=ogHostIpV6Address, ogCellModemTable=ogCellModemTable, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsTable=ogUpsTable, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWebUserNotification=ogWebUserNotification, ogSerialPortParity=ogSerialPortParity, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarm=ogAlarm, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortTable=ogSerialPortTable, ogNetInterfaceState=ogNetInterfaceState, ogCellModemTower=ogCellModemTower, ogHostUserNotification=ogHostUserNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCheckResolveActions=ogCheckResolveActions, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckName=ogCheckName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, PYSNMP_MODULE_ID=ogStatus2, ogUpsConnectType=ogUpsConnectType, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2=ogStatus2, ogFirmwareVersion=ogFirmwareVersion, ogCheckEntry=ogCheckEntry, ogUpsHumidity=ogUpsHumidity, ogAlarmLogTable=ogAlarmLogTable, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserIndex=ogHostUserIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientInterface=ogWifiClientInterface, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientApMac=ogWifiClientApMac, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemEntry=ogCellModemEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostServiceEntry=ogHostServiceEntry, ogUpsType=ogUpsType, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientMode=ogWifiClientMode, ogEmdEnabled=ogEmdEnabled, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserHostName=ogHostUserHostName, ogEmdDioType=ogEmdDioType, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostUserAddress=ogHostUserAddress, ogCheckDeviceCheck=ogCheckDeviceCheck, ogHostUserHost=ogHostUserHost, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialUserNotification=ogSerialUserNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellTowerNotification=ogCellTowerNotification, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortDTR=ogSerialPortDTR, ogCellApnNotification=ogCellApnNotification, ogCustomNotification=ogCustomNotification, ogCellModemCounter=ogCellModemCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckType=ogCheckType, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcDescription=ogRpcDescription, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserPort=ogSerialUserPort, ogCheckTriggerActions=ogCheckTriggerActions, ogHostServiceTable=ogHostServiceTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsInputNotification=ogUpsInputNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsIndex=ogUpsIndex, ogWebUserIndex=ogWebUserIndex, ogHostUserName=ogHostUserName, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsCounter=ogUpsCounter, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApIndex=ogWifiApIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApEnabled=ogWifiApEnabled, ogAlarmState=ogAlarmState, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortMode=ogSerialPortMode, ogSerialUserName=ogSerialUserName, ogUpsInputFrequency=ogUpsInputFrequency, ogMibNotifications=ogMibNotifications, ogCellModemRegistered=ogCellModemRegistered, ogCellModemTemperature=ogCellModemTemperature, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortLabel=ogSerialPortLabel, ogHostUserStartTime=ogHostUserStartTime, ogHostUserEntry=ogHostUserEntry, ogRpcOutletTable=ogRpcOutletTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdIndex=ogEmdIndex, ogUpsEntry=ogUpsEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemModel=ogCellModemModel, ogHostName=ogHostName, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdTable=ogEmdTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsNotification=ogUpsNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioState=ogEmdDioState, ogCheckIndex=ogCheckIndex, ogHostServiceCounter=ogHostServiceCounter, ogCellModemApn=ogCellModemApn, ogCellModemIMSI=ogCellModemIMSI, ogHostServicePort=ogHostServicePort, ogSerialPortIndex=ogSerialPortIndex, ogEmdEntry=ogEmdEntry, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcIndex=ogRpcIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWebUserTable=ogWebUserTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortDCD=ogSerialPortDCD, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApTable=ogWifiApTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientEntry=ogWifiClientEntry, ogSerialNumber=ogSerialNumber, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmName=ogAlarmName, ogRpcInputNotification=ogRpcInputNotification, ogCellModemConnected=ogCellModemConnected, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemIndex=ogCellModemIndex, ogWebUserEntry=ogWebUserEntry, ogUpsState=ogUpsState, ogEmdDioName=ogEmdDioName, ogSerialPortDSR=ogSerialPortDSR, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdDioNotification=ogEmdDioNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortBreaks=ogSerialPortBreaks, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserName=ogWebUserName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortDataBits=ogSerialPortDataBits, ogNetInterfaceEntry=ogNetInterfaceEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcEntry=ogRpcEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientTable=ogWifiClientTable, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureValue=ogEmdTemperatureValue, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsInputVoltage=ogUpsInputVoltage, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdHumidityName=ogEmdHumidityName, ogStatus2Compliance=ogStatus2Compliance, ogHostIndex=ogHostIndex, ogUpsDescription=ogUpsDescription, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcName=ogRpcName, ogCellModem3gRssi=ogCellModem3gRssi, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceType=ogHostServiceType, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApCounter=ogWifiApCounter, ogHostEntry=ogHostEntry, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletState=ogRpcOutletState, ogWebUserStartTime=ogWebUserStartTime, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceIndex=ogHostServiceIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogStatus2Groups=ogStatus2Groups, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortStopBits=ogSerialPortStopBits, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemVendor=ogCellModemVendor, ogAlarmInstance=ogAlarmInstance, ogHostServiceHost=ogHostServiceHost, ogWifiApEntry=ogWifiApEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApInterface=ogWifiApInterface, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdName=ogEmdName, ogUpsName=ogUpsName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortRTS=ogSerialPortRTS)
