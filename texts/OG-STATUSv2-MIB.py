...
Integer32, Counter32, Bits, NotificationType, ObjectIdentity, ModuleIdentity, Gauge32, IpAddress, iso, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Counter32", "Bits", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Gauge32", "IpAddress", "iso", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserNotification=ogSerialUserNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientEntry=ogWifiClientEntry, ogSerialUserTable=ogSerialUserTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientEssid=ogWifiClientEssid, ogRpcEntry=ogRpcEntry, ogHostName=ogHostName, ogHostTable=ogHostTable, ogSerialPortIndex=ogSerialPortIndex, ogAlarmState=ogAlarmState, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsTable=ogUpsTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostIpV4Address=ogHostIpV4Address, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostIndex=ogHostIndex, ogCheckDeviceName=ogCheckDeviceName, ogUpsState=ogUpsState, ogBasicStatusGroup=ogBasicStatusGroup, ogSerialUserLabel=ogSerialUserLabel, ogWebUserIndex=ogWebUserIndex, ogHostServiceStatus=ogHostServiceStatus, ogCellModemIMSI=ogCellModemIMSI, ogEmdEntry=ogEmdEntry, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortMode=ogSerialPortMode, ogCellModemTable=ogCellModemTable, ogMibNotifications=ogMibNotifications, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemVendor=ogCellModemVendor, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialUserEntry=ogSerialUserEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemApn=ogCellModemApn, ogHostIpV6Address=ogHostIpV6Address, ogCheckResolveActions=ogCheckResolveActions, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWebUserNotification=ogWebUserNotification, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceIndex=ogHostServiceIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmSummary=ogAlarmSummary, ogUpsIndex=ogUpsIndex, ogEmdDioType=ogEmdDioType, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientApMac=ogWifiClientApMac, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyName=ogPowerSupplyName, ogCellTowerNotification=ogCellTowerNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientRssi=ogWifiClientRssi, ogWebUserTable=ogWebUserTable, ogRpcOutletName=ogRpcOutletName, PYSNMP_MODULE_ID=ogStatus2, ogCellModemTower=ogCellModemTower, ogRpcIndex=ogRpcIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApFrequency=ogWifiApFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityName=ogEmdHumidityName, ogHostUserName=ogHostUserName, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemConnected=ogCellModemConnected, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostServiceEntry=ogHostServiceEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletTable=ogRpcOutletTable, ogUpsInputNotification=ogUpsInputNotification, ogWifiApIndex=ogWifiApIndex, ogAlarmEventId=ogAlarmEventId, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortRTS=ogSerialPortRTS, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsEntry=ogUpsEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcDescription=ogRpcDescription, ogCellModemTemperature=ogCellModemTemperature, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientMode=ogWifiClientMode, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserStartTime=ogWebUserStartTime, ogHostServiceTable=ogHostServiceTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogStatus2Compliances=ogStatus2Compliances, ogSerialUserPort=ogSerialUserPort, ogRpcInputNotification=ogRpcInputNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogStatus2Conformance=ogStatus2Conformance, ogCheckTriggerActions=ogCheckTriggerActions, ogSystem=ogSystem, ogCellModemCounter=ogCellModemCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmName=ogAlarmName, ogHostPingNotification=ogHostPingNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortTable=ogSerialPortTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApEntry=ogWifiApEntry, ogHostUserIndex=ogHostUserIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialNumber=ogSerialNumber, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortEntry=ogSerialPortEntry, ogRpcTable=ogRpcTable, ogWifiApTable=ogWifiApTable, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientTxPower=ogWifiClientTxPower, ogWebUserEntry=ogWebUserEntry, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsName=ogUpsName, ogEmdDescription=ogEmdDescription, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApEnabled=ogWifiApEnabled, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientCounter=ogWifiClientCounter, ogUpsType=ogUpsType, ogRpcOutletState=ogRpcOutletState, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogAlarmType=ogAlarmType, ogHostUserHostName=ogHostUserHostName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckTable=ogCheckTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsHumidity=ogUpsHumidity, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdDioDescription=ogEmdDioDescription, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemModel=ogCellModemModel, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCheckEntry=ogCheckEntry, ogHostUserEntry=ogHostUserEntry, ogStatus2=ogStatus2, ogHostUserNotification=ogHostUserNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarm=ogAlarm, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckName=ogCheckName, ogHostUserHost=ogHostUserHost, ogFirmwareVersion=ogFirmwareVersion, ogHostUserStartTime=ogHostUserStartTime, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryState=ogUpsBatteryState, ogRpcType=ogRpcType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityDescription=ogEmdHumidityDescription, ogNetInterfaceType=ogNetInterfaceType, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmCheck=ogAlarmCheck, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdIndex=ogEmdIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortParity=ogSerialPortParity, ogEmdConnectType=ogEmdConnectType, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApInterface=ogWifiApInterface, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyIndex=ogPowerSupplyIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogStatus2Groups=ogStatus2Groups, ogCheckIndex=ogCheckIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioState=ogEmdDioState, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdTable=ogEmdTable, ogSerialPortLabel=ogSerialPortLabel, ogWebUserName=ogWebUserName, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortDCD=ogSerialPortDCD, ogAlarmUser=ogAlarmUser, ogAlarmLogTable=ogAlarmLogTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioNotification=ogEmdDioNotification, ogAlarmTime=ogAlarmTime, ogCheckType=ogCheckType, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialUserName=ogSerialUserName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsCounter=ogUpsCounter, ogHostServiceCounter=ogHostServiceCounter, ogRpcCounter=ogRpcCounter, ogEmdEnabled=ogEmdEnabled, ogWifiApSsid=ogWifiApSsid, ogCellModemIndex=ogCellModemIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsDescription=ogUpsDescription, ogRpcName=ogRpcName, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortDTR=ogSerialPortDTR, ogRpcConnectType=ogRpcConnectType, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioCounter=ogEmdDioCounter, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdName=ogEmdName, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserTable=ogHostUserTable, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellApnNotification=ogCellApnNotification, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogNetInterfaceName=ogNetInterfaceName, ogHostServiceType=ogHostServiceType, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioTable=ogEmdDioTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsNotification=ogUpsNotification, ogHostEntry=ogHostEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApCounter=ogWifiApCounter, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortDataBits=ogSerialPortDataBits, ogCustomNotification=ogCustomNotification, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientTable=ogWifiClientTable, ogHostUserAddress=ogHostUserAddress, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsTemperature=ogUpsTemperature, ogWifiApClientTable=ogWifiApClientTable, ogEmdDioName=ogEmdDioName, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogAlarmDevice=ogAlarmDevice, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostServicePort=ogHostServicePort)
