...
iso, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, Counter32, Integer32, IpAddress, Unsigned32, NotificationType, Gauge32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "Counter32", "Integer32", "IpAddress", "Unsigned32", "NotificationType", "Gauge32", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletTotal=ogRpcOutletTotal, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostIndex=ogHostIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserAddress=ogHostUserAddress, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceHost=ogHostServiceHost, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcName=ogRpcName, ogWifiClientEntry=ogWifiClientEntry, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserEntry=ogSerialUserEntry, ogCellModemEntry=ogCellModemEntry, ogEmdDioEmd=ogEmdDioEmd, ogCustomNotification=ogCustomNotification, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceEntry=ogCheckDeviceEntry, ogMibNotifications=ogMibNotifications, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemTable=ogCellModemTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialUserPort=ogSerialUserPort, ogUpsDescription=ogUpsDescription, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmInstance=ogAlarmInstance, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientTable=ogWifiApClientTable, ogHostServiceType=ogHostServiceType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdName=ogEmdName, ogWifiClientIndex=ogWifiClientIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostUserTable=ogHostUserTable, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckEntry=ogCheckEntry, ogCheckTable=ogCheckTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogNetInterfaceName=ogNetInterfaceName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogAlarmName=ogAlarmName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostName=ogHostName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWebUserEntry=ogWebUserEntry, ogAlarmType=ogAlarmType, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletTable=ogRpcOutletTable, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureTable=ogEmdTemperatureTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortCTS=ogSerialPortCTS, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcType=ogRpcType, ogEmdDescription=ogEmdDescription, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdDioState=ogEmdDioState, ogHostUserNotification=ogHostUserNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApTable=ogWifiApTable, ogAlarmCheck=ogAlarmCheck, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioCounter=ogEmdDioCounter, ogCellModemIndex=ogCellModemIndex, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientMode=ogWifiClientMode, ogNetInterfaceEntry=ogNetInterfaceEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioType=ogEmdDioType, ogCheckType=ogCheckType, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutputNotification=ogRpcOutputNotification, ogCellApnNotification=ogCellApnNotification, ogSerialPortParity=ogSerialPortParity, ogStatus2Compliances=ogStatus2Compliances, ogRpcEntry=ogRpcEntry, ogPowerSupplyName=ogPowerSupplyName, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemRegistered=ogCellModemRegistered, ogCellMessageNotification=ogCellMessageNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckResetTimeout=ogCheckResetTimeout, ogStatus2Groups=ogStatus2Groups, ogSerialUserIndex=ogSerialUserIndex, ogCellModemApn=ogCellModemApn, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostUserName=ogHostUserName, ogSerialPortDTR=ogSerialPortDTR, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcTable=ogRpcTable, ogSerialUserTable=ogSerialUserTable, ogRpcLogEnabled=ogRpcLogEnabled, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWebUserNotification=ogWebUserNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortIndex=ogSerialPortIndex, ogCheckName=ogCheckName, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcConnectType=ogRpcConnectType, ogHostServiceEntry=ogHostServiceEntry, ogUpsNotification=ogUpsNotification, ogCellModemTower=ogCellModemTower, ogUpsName=ogUpsName, ogEmdDioEntry=ogEmdDioEntry, ogCheckDeviceName=ogCheckDeviceName, ogUpsBatteryState=ogUpsBatteryState, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioNotification=ogEmdDioNotification, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApIndex=ogWifiApIndex, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostPingNotification=ogHostPingNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialPortTable=ogSerialPortTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientCounter=ogWifiClientCounter, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmTime=ogAlarmTime, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogHostUserHostName=ogHostUserHostName, ogCheckIndex=ogCheckIndex, ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortDSR=ogSerialPortDSR, ogWebUserIndex=ogWebUserIndex, ogStatus2=ogStatus2, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogFirmwareVersion=ogFirmwareVersion, ogWifiApInterface=ogWifiApInterface, ogWifiApEnabled=ogWifiApEnabled, ogWifiApCounter=ogWifiApCounter, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdConnectType=ogEmdConnectType, ogRpcDescription=ogRpcDescription, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserStartTime=ogWebUserStartTime, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApEntry=ogWifiApEntry, ogWebUserTable=ogWebUserTable, ogWifiApClientIndex=ogWifiApClientIndex, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogCellDataNotification=ogCellDataNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsType=ogUpsType, ogCellModemModel=ogCellModemModel, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortMode=ogSerialPortMode, ogStatus2Conformance=ogStatus2Conformance, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellTowerNotification=ogCellTowerNotification, ogSerialNumber=ogSerialNumber, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientRssi=ogWifiClientRssi, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellModemTemperature=ogCellModemTemperature, ogCellModemConnected=ogCellModemConnected, ogEmdHumidityName=ogEmdHumidityName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogHostUserIndex=ogHostUserIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsHumidity=ogUpsHumidity, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsCounter=ogUpsCounter, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdTable=ogEmdTable, ogAlarmDevice=ogAlarmDevice)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsLogEnabled=ogUpsLogEnabled, ogAlarm=ogAlarm, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcIndex=ogRpcIndex, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSystem=ogSystem, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsInputNotification=ogUpsInputNotification, ogEmdEntry=ogEmdEntry, ogCellModemCounter=ogCellModemCounter, ogUpsConnectType=ogUpsConnectType, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostServiceTable=ogHostServiceTable, ogHostTable=ogHostTable, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmEventId=ogAlarmEventId, ogHostServiceCounter=ogHostServiceCounter, ogUpsEntry=ogUpsEntry, ogWifiClientTable=ogWifiClientTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdIndex=ogEmdIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortEntry=ogSerialPortEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdEnabled=ogEmdEnabled, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsIndex=ogUpsIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientFrequency=ogWifiClientFrequency, ogHostUserHost=ogHostUserHost, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientApMac=ogWifiClientApMac, ogUpsTable=ogUpsTable, ogWebUserName=ogWebUserName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogHostServicePort=ogHostServicePort, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmLogIndex=ogAlarmLogIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialUserName=ogSerialUserName, ogHostIpV4Address=ogHostIpV4Address, ogEmdDioName=ogEmdDioName, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmState=ogAlarmState, ogSerialPortBreaks=ogSerialPortBreaks, ogHostUserEntry=ogHostUserEntry, ogSerialPortDCD=ogSerialPortDCD, ogUpsTemperature=ogUpsTemperature, ogCellModemNetwork=ogCellModemNetwork, ogUpsState=ogUpsState, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogHostEntry=ogHostEntry, ogEmdDioTable=ogEmdDioTable, ogAlarmUser=ogAlarmUser, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcCounter=ogRpcCounter)
