...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialNumber=ogSerialNumber, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserNotification=ogSerialUserNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioTable=ogEmdDioTable, ogHostIpV4Address=ogHostIpV4Address, ogHostServiceHost=ogHostServiceHost, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemIndex=ogCellModemIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogHostEntry=ogHostEntry, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcIndex=ogRpcIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogMibNotifications=ogMibNotifications, ogUpsOutputPower=ogUpsOutputPower, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostServiceIndex=ogHostServiceIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmSummary=ogAlarmSummary, ogRpcOutletIndex=ogRpcOutletIndex, ogHostUserEntry=ogHostUserEntry, ogWifiApEntry=ogWifiApEntry, ogHostUserHost=ogHostUserHost, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientMode=ogWifiClientMode, ogCellDataNotification=ogCellDataNotification, ogUpsEntry=ogUpsEntry, ogUpsIndex=ogUpsIndex, ogCellModemApn=ogCellModemApn, ogEmdTemperatureTable=ogEmdTemperatureTable, ogHostUserIndex=ogHostUserIndex, ogRpcEntry=ogRpcEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServicePort=ogHostServicePort, ogRpcDescription=ogRpcDescription, ogUpsState=ogUpsState, ogRpcCounter=ogRpcCounter, ogCellModemEnabled=ogCellModemEnabled, ogAlarmDevice=ogAlarmDevice, ogHostIpV6Address=ogHostIpV6Address, ogEmdEntry=ogEmdEntry, ogEmdDioEntry=ogEmdDioEntry, ogRpcName=ogRpcName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostPingNotification=ogHostPingNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientBitRate=ogWifiClientBitRate, ogBasicStatusGroup=ogBasicStatusGroup, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceName=ogNetInterfaceName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientEntry=ogWifiApClientEntry, ogWebUserEntry=ogWebUserEntry, ogFirmwareVersion=ogFirmwareVersion, ogCellMessageNotification=ogCellMessageNotification, ogWifiApSsid=ogWifiApSsid, ogSerialPortStopBits=ogSerialPortStopBits, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdIndex=ogEmdIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcType=ogRpcType, ogEmdConnectType=ogEmdConnectType, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioDescription=ogEmdDioDescription, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcConnectType=ogRpcConnectType, ogCheckDeviceName=ogCheckDeviceName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostUserTable=ogHostUserTable, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioState=ogEmdDioState, ogCustomNotification=ogCustomNotification, ogUpsTable=ogUpsTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientRssi=ogWifiClientRssi, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckTable=ogCheckTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialUserName=ogSerialUserName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApIndex=ogWifiApIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostIndex=ogHostIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceTable=ogHostServiceTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCellModemCounter=ogCellModemCounter, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsConnectType=ogUpsConnectType, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDescription=ogEmdDescription, ogAlarmName=ogAlarmName, ogNetInterfaceState=ogNetInterfaceState, ogAlarmTime=ogAlarmTime, ogAlarmInstance=ogAlarmInstance, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialUserPort=ogSerialUserPort, ogHostServiceEntry=ogHostServiceEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiClientApMac=ogWifiClientApMac, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortTable=ogSerialPortTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostTable=ogHostTable, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsDescription=ogUpsDescription, ogCellModemTower=ogCellModemTower, ogWebUserName=ogWebUserName, ogWifiClientTable=ogWifiClientTable, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortDSR=ogSerialPortDSR, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemEntry=ogCellModemEntry, ogHostServiceStatus=ogHostServiceStatus, ogCellApnNotification=ogCellApnNotification, ogSerialUserTable=ogSerialUserTable, ogUpsHumidity=ogUpsHumidity, ogRpcOutletName=ogRpcOutletName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioNotification=ogEmdDioNotification, ogEmdName=ogEmdName, ogCellModemConnected=ogCellModemConnected, ogWifiClientIndex=ogWifiClientIndex, ogHostName=ogHostName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityName=ogEmdHumidityName, ogEmdTable=ogEmdTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiApTable=ogWifiApTable, ogAlarmLogTable=ogAlarmLogTable, ogStatus2Groups=ogStatus2Groups, ogCheckName=ogCheckName, ogCheckType=ogCheckType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckIndex=ogCheckIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApFrequency=ogWifiApFrequency, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarm=ogAlarm, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletState=ogRpcOutletState, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogPowerSupplyName=ogPowerSupplyName, ogCellModemRegistered=ogCellModemRegistered, ogUpsName=ogUpsName, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostUserHostName=ogHostUserHostName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogNetInterfaceNotification=ogNetInterfaceNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcTable=ogRpcTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmCheck=ogAlarmCheck, ogSerialPortSpeed=ogSerialPortSpeed, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioIndex=ogEmdDioIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsCounter=ogUpsCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellSignalNotification=ogCellSignalNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceNotification=ogHostServiceNotification, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceType=ogHostServiceType, ogEmdDioType=ogEmdDioType, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientEssid=ogWifiClientEssid, ogHostUserName=ogHostUserName, PYSNMP_MODULE_ID=ogStatus2, ogUpsTemperature=ogUpsTemperature, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdDioName=ogEmdDioName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSystem=ogSystem, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApCounter=ogWifiApCounter, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortRTS=ogSerialPortRTS, ogSerialUserEntry=ogSerialUserEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutletTable=ogRpcOutletTable, ogCellModemModel=ogCellModemModel, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogAlarmLogIndex=ogAlarmLogIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemIMSI=ogCellModemIMSI, ogStatus2=ogStatus2, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceType=ogNetInterfaceType, ogSerialPortMode=ogSerialPortMode, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsType=ogUpsType, ogAlarmUser=ogAlarmUser, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortEntry=ogSerialPortEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWebUserStartTime=ogWebUserStartTime, ogAlarmCurrentValue=ogAlarmCurrentValue, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdEnabled=ogEmdEnabled, ogAlarmType=ogAlarmType, ogCellModemTable=ogCellModemTable, ogCurrentAlarmState=ogCurrentAlarmState, ogCellTowerNotification=ogCellTowerNotification, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTable=ogWifiApClientTable, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmState=ogAlarmState, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortLabel=ogSerialPortLabel, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostUserStartTime=ogHostUserStartTime, ogAlarmEventId=ogAlarmEventId, ogSerialUserIndex=ogSerialUserIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortDTR=ogSerialPortDTR, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiApInterface=ogWifiApInterface, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserAddress=ogHostUserAddress, ogCheckEntry=ogCheckEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWebUserIndex=ogWebUserIndex, ogUpsNotification=ogUpsNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserNotification=ogHostUserNotification, ogWifiClientCounter=ogWifiClientCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserTable=ogWebUserTable)
