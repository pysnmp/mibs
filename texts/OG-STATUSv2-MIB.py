...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputCurrent=ogUpsInputCurrent, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostServicePort=ogHostServicePort, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsEntry=ogUpsEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserNotification=ogHostUserNotification, ogWifiApClientMac=ogWifiApClientMac, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellMessageNotification=ogCellMessageNotification, ogEmdDescription=ogEmdDescription, ogSerialPortIndex=ogSerialPortIndex, ogCheckResolveActions=ogCheckResolveActions, ogSerialUserPort=ogSerialUserPort, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiApCounter=ogWifiApCounter, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarm=ogAlarm, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmName=ogAlarmName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsState=ogUpsState, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCheckDeviceName=ogCheckDeviceName, ogUpsTable=ogUpsTable, ogCellModemTemperature=ogCellModemTemperature, ogCheckEntry=ogCheckEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogNetInterfaceState=ogNetInterfaceState, ogAlarmTime=ogAlarmTime, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceTable=ogHostServiceTable, ogSerialPortParity=ogSerialPortParity, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsName=ogUpsName, ogUpsNotification=ogUpsNotification, PYSNMP_MODULE_ID=ogStatus2, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostUserHostName=ogHostUserHostName, ogUpsBatteryState=ogUpsBatteryState, ogNetInterfaceType=ogNetInterfaceType, ogRpcConnectType=ogRpcConnectType, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmState=ogAlarmState, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellApnNotification=ogCellApnNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemConnected=ogCellModemConnected, ogPowerSupplyTable=ogPowerSupplyTable, ogSystem=ogSystem, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellSignalNotification=ogCellSignalNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcType=ogRpcType, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemVendor=ogCellModemVendor, ogEmdDioNotification=ogEmdDioNotification, ogWifiApClientAp=ogWifiApClientAp, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmLogEntry=ogAlarmLogEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPatternNotification=ogSerialPatternNotification, ogStatus2Compliance=ogStatus2Compliance, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostUserEntry=ogHostUserEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcTable=ogRpcTable, ogWifiClientTable=ogWifiClientTable, ogWifiClientMode=ogWifiClientMode, ogEmdDioEmd=ogEmdDioEmd, ogCellModemIndex=ogCellModemIndex, ogSerialUserName=ogSerialUserName, ogEmdDioTable=ogEmdDioTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogCellDataNotification=ogCellDataNotification, ogHostServiceType=ogHostServiceType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWebUserIndex=ogWebUserIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdConnectType=ogEmdConnectType, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApEntry=ogWifiApEntry, ogCellModemCounter=ogCellModemCounter, ogWifiClientFrequency=ogWifiClientFrequency, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWebUserStartTime=ogWebUserStartTime, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApSsid=ogWifiApSsid, ogCellModemModel=ogCellModemModel, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmUser=ogAlarmUser, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemEntry=ogCellModemEntry, ogWifiApTable=ogWifiApTable, ogEmdDioDescription=ogEmdDioDescription, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcEntry=ogRpcEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserEntry=ogWebUserEntry, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcName=ogRpcName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdTable=ogEmdTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogWebUserTable=ogWebUserTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemApn=ogCellModemApn, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogHostIpV4Address=ogHostIpV4Address, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogHostUserHost=ogHostUserHost, ogCellTowerNotification=ogCellTowerNotification, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientEssid=ogWifiClientEssid, ogEmdName=ogEmdName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletState=ogRpcOutletState, ogCheckType=ogCheckType, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemTable=ogCellModemTable, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmLogTable=ogAlarmLogTable, ogHostServiceStatus=ogHostServiceStatus, ogUpsTemperature=ogUpsTemperature, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsInputFrequency=ogUpsInputFrequency, ogHostName=ogHostName, ogCustomNotification=ogCustomNotification, ogSerialPortDTR=ogSerialPortDTR, ogWifiApFrequency=ogWifiApFrequency, ogHostServiceHost=ogHostServiceHost, ogUpsIndex=ogUpsIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioName=ogEmdDioName, ogEmdEnabled=ogEmdEnabled, ogSerialPortTxBytes=ogSerialPortTxBytes, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioDirection=ogEmdDioDirection, ogCheckDeviceRef=ogCheckDeviceRef, ogHostUserTable=ogHostUserTable, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsType=ogUpsType, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsCounter=ogUpsCounter, ogRpcDescription=ogRpcDescription, ogWebUserName=ogWebUserName, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortMode=ogSerialPortMode, ogHostServiceEntry=ogHostServiceEntry, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientApMac=ogWifiClientApMac, ogEmdHumidityNotification=ogEmdHumidityNotification, ogAlarmEventId=ogAlarmEventId, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioState=ogEmdDioState, ogCheckName=ogCheckName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckResetTimeout=ogCheckResetTimeout, ogHostPingNotification=ogHostPingNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckTable=ogCheckTable, ogSerialPortEntry=ogSerialPortEntry, ogAlarmInstance=ogAlarmInstance, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdEntry=ogEmdEntry, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortDSR=ogSerialPortDSR, ogWebUserNotification=ogWebUserNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmType=ogAlarmType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmCheck=ogAlarmCheck, ogAlarmCurrentValue=ogAlarmCurrentValue, ogFirmwareVersion=ogFirmwareVersion, ogCellModemTower=ogCellModemTower, ogUpsDescription=ogUpsDescription, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogMibNotifications=ogMibNotifications, ogRpcCounter=ogRpcCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApInterface=ogWifiApInterface, ogHostUserName=ogHostUserName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcIndex=ogRpcIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortTable=ogSerialPortTable, ogHostIndex=ogHostIndex, ogUpsInputNotification=ogUpsInputNotification, ogCellModemRegistered=ogCellModemRegistered, ogEmdIndex=ogEmdIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletName=ogRpcOutletName, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioType=ogEmdDioType, ogCurrentAlarmName=ogCurrentAlarmName, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApIndex=ogWifiApIndex, ogSerialNumber=ogSerialNumber, ogPowerSupplyName=ogPowerSupplyName, ogHostUserIndex=ogHostUserIndex, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcOutletTable=ogRpcOutletTable, ogHostTable=ogHostTable, ogHostEntry=ogHostEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckIndex=ogCheckIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApEnabled=ogWifiApEnabled, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmSummary=ogAlarmSummary, ogStatus2=ogStatus2)
