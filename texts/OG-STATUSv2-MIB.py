...
ObjectIdentity, IpAddress, Integer32, Gauge32, Counter32, Counter64, iso, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "Integer32", "Gauge32", "Counter32", "Counter64", "iso", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Bits", "NotificationType")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostName=ogHostName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogStatus2Compliance=ogStatus2Compliance, ogUpsCounter=ogUpsCounter, ogEmdEnabled=ogEmdEnabled, ogWebUserTable=ogWebUserTable, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioName=ogEmdDioName, ogRpcInputCurrent=ogRpcInputCurrent, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDSR=ogSerialPortDSR, ogAlarmDevice=ogAlarmDevice, ogWebUserEntry=ogWebUserEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsState=ogUpsState, ogNetInterfaceName=ogNetInterfaceName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientApMac=ogWifiClientApMac, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioEmd=ogEmdDioEmd, ogEmdConnectType=ogEmdConnectType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsEntry=ogUpsEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortTable=ogSerialPortTable, ogHostServiceType=ogHostServiceType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortEntry=ogSerialPortEntry, ogUpsConnectType=ogUpsConnectType, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckType=ogCheckType, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryNotification=ogUpsBatteryNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcCounter=ogRpcCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogAlarmCheck=ogAlarmCheck, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientEssid=ogWifiClientEssid, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostUserStartTime=ogHostUserStartTime, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientCounter=ogWifiClientCounter, ogCellModemModel=ogCellModemModel, ogWifiApSsid=ogWifiApSsid, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcIndex=ogRpcIndex, ogWifiClientMode=ogWifiClientMode, ogEmdDescription=ogEmdDescription, ogHostServiceStatus=ogHostServiceStatus, ogCellModemEnabled=ogCellModemEnabled, ogHostUserTable=ogHostUserTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortSpeed=ogSerialPortSpeed, ogWebUserSourcePort=ogWebUserSourcePort, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientInterface=ogWifiClientInterface, ogAlarm=ogAlarm, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModem4gRssi=ogCellModem4gRssi, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostEntry=ogHostEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientAp=ogWifiApClientAp, ogRpcDescription=ogRpcDescription, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmName=ogAlarmName, ogRpcInputNotification=ogRpcInputNotification, ogCellTowerNotification=ogCellTowerNotification, ogAlarmLogTable=ogAlarmLogTable, ogHostUserAddress=ogHostUserAddress, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiApCounter=ogWifiApCounter, ogEmdDioDescription=ogEmdDioDescription, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioEntry=ogEmdDioEntry, ogWifiApTable=ogWifiApTable, ogHostUserName=ogHostUserName, ogEmdDioDirection=ogEmdDioDirection, ogUpsIndex=ogUpsIndex, ogAlarmType=ogAlarmType, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserIndex=ogHostUserIndex, ogCellMessageNotification=ogCellMessageNotification, ogEmdName=ogEmdName, ogEmdDioState=ogEmdDioState, ogEmdEntry=ogEmdEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApInterface=ogWifiApInterface, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdIndex=ogEmdIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellApnNotification=ogCellApnNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckName=ogCheckName, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWebUserIndex=ogWebUserIndex, ogSerialPortCTS=ogSerialPortCTS, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdHumidityValue=ogEmdHumidityValue, ogSystem=ogSystem, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCellDataNotification=ogCellDataNotification, ogSerialUserTable=ogSerialUserTable, ogSerialPortParity=ogSerialPortParity, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemApn=ogCellModemApn, ogEmdTable=ogEmdTable, ogCellSignalNotification=ogCellSignalNotification, ogHostIpV6Address=ogHostIpV6Address, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApClientMac=ogWifiApClientMac, ogCellModemIndex=ogCellModemIndex, ogAlarmUser=ogAlarmUser, ogCellNetworkNotification=ogCellNetworkNotification, ogStatus2Groups=ogStatus2Groups, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserNotification=ogWebUserNotification, ogWifiApEntry=ogWifiApEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcTable=ogRpcTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcName=ogRpcName, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemCounter=ogCellModemCounter, ogUpsTable=ogUpsTable, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputCurrent=ogUpsInputCurrent, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemTable=ogCellModemTable, ogUpsTemperature=ogUpsTemperature, ogUpsDescription=ogUpsDescription, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdHumidityIndex=ogEmdHumidityIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmState=ogAlarmState, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioTable=ogEmdDioTable, ogCellModemConnected=ogCellModemConnected, ogEmdDioType=ogEmdDioType, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApAuthNotification=ogWifiApAuthNotification, ogStatus2=ogStatus2, ogHostUserHost=ogHostUserHost, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmSummary=ogAlarmSummary, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckTable=ogCheckTable, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcConnectType=ogRpcConnectType, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServiceCounter=ogHostServiceCounter, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostServiceHost=ogHostServiceHost, ogHostServiceIndex=ogHostServiceIndex, ogCellModemTemperature=ogCellModemTemperature, ogCellModemEntry=ogCellModemEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutletName=ogRpcOutletName, ogWifiApFrequency=ogWifiApFrequency, ogRpcType=ogRpcType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientBitRate=ogWifiClientBitRate, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdHumidityName=ogEmdHumidityName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioNotification=ogEmdDioNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialUserPort=ogSerialUserPort, ogUpsType=ogUpsType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialPortDataBits=ogSerialPortDataBits, ogCheckIndex=ogCheckIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserNotification=ogHostUserNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserEntry=ogHostUserEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogMibNotifications=ogMibNotifications, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, PYSNMP_MODULE_ID=ogStatus2, ogCellModemVendor=ogCellModemVendor, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientRssi=ogWifiApClientRssi)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCustomNotification=ogCustomNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientRssi=ogWifiClientRssi, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostUserHostName=ogHostUserHostName, ogSerialPortLabel=ogSerialPortLabel, ogHostPingNotification=ogHostPingNotification, ogUpsHumidity=ogUpsHumidity, ogAlarmEventId=ogAlarmEventId, ogUpsNotification=ogUpsNotification, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckEntry=ogCheckEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialNumber=ogSerialNumber, ogHostIpV4Address=ogHostIpV4Address, ogCellModemRegistered=ogCellModemRegistered, ogWifiApEnabled=ogWifiApEnabled, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialUserName=ogSerialUserName, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogFirmwareVersion=ogFirmwareVersion, ogUpsInputVoltage=ogUpsInputVoltage, ogStatus2Compliances=ogStatus2Compliances, ogStatus2Conformance=ogStatus2Conformance, ogCellModemTower=ogCellModemTower, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortMode=ogSerialPortMode, ogHostServicePort=ogHostServicePort, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserName=ogWebUserName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsName=ogUpsName, ogSerialUserEntry=ogSerialUserEntry, ogAlarmTime=ogAlarmTime, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmLogEntry=ogAlarmLogEntry, ogHostServiceTable=ogHostServiceTable, ogHostTable=ogHostTable, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostIndex=ogHostIndex, ogWifiApIndex=ogWifiApIndex, ogRpcEntry=ogRpcEntry, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityNotification=ogEmdHumidityNotification, ogNetInterfaceState=ogNetInterfaceState, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApTxPower=ogWifiApTxPower, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortDTR=ogSerialPortDTR)
