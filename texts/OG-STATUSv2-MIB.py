...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputVoltage=ogUpsOutputVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostName=ogHostName, ogWifiClientTable=ogWifiClientTable, ogWebUserName=ogWebUserName, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogPowerSupplyName=ogPowerSupplyName, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryState=ogUpsBatteryState, ogCheckTable=ogCheckTable, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioNotification=ogEmdDioNotification, ogRpcInputNotification=ogRpcInputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckResolveActions=ogCheckResolveActions, ogUpsState=ogUpsState, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellMessageNotification=ogCellMessageNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostUserNotification=ogHostUserNotification, ogEmdDioType=ogEmdDioType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioCounter=ogEmdDioCounter, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserStartTime=ogHostUserStartTime, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTable=ogEmdTable, ogHostIpV4Address=ogHostIpV4Address, ogUpsName=ogUpsName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogUpsNotification=ogUpsNotification, ogRpcOutletTable=ogRpcOutletTable, ogWebUserStartTime=ogWebUserStartTime, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostTable=ogHostTable, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServiceStatus=ogHostServiceStatus, ogRpcIndex=ogRpcIndex, ogStatus2Groups=ogStatus2Groups, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioState=ogEmdDioState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckEntry=ogCheckEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogSerialPortRTS=ogSerialPortRTS, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialUserIndex=ogSerialUserIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortDTR=ogSerialPortDTR, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceName=ogNetInterfaceName, ogRpcCounter=ogRpcCounter, ogRpcOutletState=ogRpcOutletState, ogWifiClientApMac=ogWifiClientApMac, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApIndex=ogWifiApIndex, ogHostUserAddress=ogHostUserAddress, ogFirmwareVersion=ogFirmwareVersion, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioIndex=ogEmdDioIndex, ogRpcDescription=ogRpcDescription, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioDirection=ogEmdDioDirection, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientMode=ogWifiClientMode, ogAlarmInstance=ogAlarmInstance, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsIndex=ogUpsIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogNetInterfaceType=ogNetInterfaceType, ogCellApnNotification=ogCellApnNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortFlowControl=ogSerialPortFlowControl, ogStatus2Compliance=ogStatus2Compliance, ogHostUserTable=ogHostUserTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSystem=ogSystem, ogWifiApSsid=ogWifiApSsid, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemRegistered=ogCellModemRegistered, ogCellDataNotification=ogCellDataNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialUserLabel=ogSerialUserLabel, ogSerialUserPort=ogSerialUserPort, ogEmdName=ogEmdName, ogRpcName=ogRpcName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientInterface=ogWifiClientInterface, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemEnabled=ogCellModemEnabled, ogWebUserEntry=ogWebUserEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellModemTable=ogCellModemTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogStatus2Compliances=ogStatus2Compliances, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialSignalNotification=ogSerialSignalNotification, ogHostUserEntry=ogHostUserEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogAlarmSummary=ogAlarmSummary, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApTable=ogWifiApTable, ogAlarmName=ogAlarmName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceHost=ogHostServiceHost, ogRpcInputCurrent=ogRpcInputCurrent, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmUser=ogAlarmUser, ogCheckName=ogCheckName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCellModemVendor=ogCellModemVendor, ogUpsHumidity=ogUpsHumidity, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemConnected=ogCellModemConnected, ogCheckDeviceName=ogCheckDeviceName, ogWifiApFrequency=ogWifiApFrequency, ogUpsInputNotification=ogUpsInputNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApTxPower=ogWifiApTxPower, ogWebUserIndex=ogWebUserIndex, ogWifiApEntry=ogWifiApEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryCharge=ogUpsBatteryCharge, PYSNMP_MODULE_ID=ogStatus2, ogAlarmDevice=ogAlarmDevice, ogCellModemApn=ogCellModemApn, ogCheckIndex=ogCheckIndex, ogUpsType=ogUpsType, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialNumber=ogSerialNumber, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletName=ogRpcOutletName, ogWifiClientFrequency=ogWifiClientFrequency, ogHostIndex=ogHostIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemIMSI=ogCellModemIMSI, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmEventId=ogAlarmEventId, ogSerialPortDCD=ogSerialPortDCD, ogHostUserHostName=ogHostUserHostName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemTower=ogCellModemTower, ogHostUserName=ogHostUserName, ogRpcConnectType=ogRpcConnectType, ogRpcInputFrequency=ogRpcInputFrequency, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdConnectType=ogEmdConnectType, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityName=ogEmdHumidityName, ogAlarmCheck=ogAlarmCheck, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDescription=ogEmdDescription, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserTable=ogSerialUserTable, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortCTS=ogSerialPortCTS, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcEntry=ogRpcEntry, ogSerialPortTable=ogSerialPortTable, ogSerialUserEntry=ogSerialUserEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdEntry=ogEmdEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsCounter=ogUpsCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemIndex=ogCellModemIndex, ogMibNotifications=ogMibNotifications, ogSerialUserName=ogSerialUserName, ogSerialPortLabel=ogSerialPortLabel)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdIndex=ogEmdIndex, ogAlarm=ogAlarm, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsDescription=ogUpsDescription, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserNotification=ogSerialUserNotification, ogHostIpV6Address=ogHostIpV6Address, ogCellModemModel=ogCellModemModel, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApCounter=ogWifiApCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortParity=ogSerialPortParity, ogHostServicePort=ogHostServicePort, ogCellModemNetwork=ogCellModemNetwork, ogCheckType=ogCheckType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceType=ogHostServiceType, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsConnectType=ogUpsConnectType, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioDescription=ogEmdDioDescription, ogHostEntry=ogHostEntry, ogRpcTable=ogRpcTable, ogCustomNotification=ogCustomNotification, ogAlarmType=ogAlarmType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdEnabled=ogEmdEnabled, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdDioName=ogEmdDioName, ogAlarmState=ogAlarmState, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcType=ogRpcType, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserTable=ogWebUserTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioTable=ogEmdDioTable, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserHost=ogHostUserHost, ogUpsTable=ogUpsTable, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemCounter=ogCellModemCounter, ogStatus2=ogStatus2, ogUpsEntry=ogUpsEntry, ogWebUserNotification=ogWebUserNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortMode=ogSerialPortMode, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemEntry=ogCellModemEntry, ogAlarmTime=ogAlarmTime, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserIndex=ogHostUserIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientIndex=ogWifiClientIndex, ogWifiApInterface=ogWifiApInterface, ogWifiClientEntry=ogWifiClientEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientTxPower=ogWifiClientTxPower)
