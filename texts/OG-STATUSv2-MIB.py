...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckTable=ogCheckTable, ogUpsState=ogUpsState, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialUserTable=ogSerialUserTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutletNotification=ogRpcOutletNotification, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsNotification=ogUpsNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogFirmwareVersion=ogFirmwareVersion, ogCellModemTable=ogCellModemTable, ogWifiApInterface=ogWifiApInterface, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsBatteryCharge=ogUpsBatteryCharge, ogStatus2Groups=ogStatus2Groups, ogSerialUserPort=ogSerialUserPort, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostPingNotification=ogHostPingNotification, ogRpcCounter=ogRpcCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmState=ogAlarmState, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemVendor=ogCellModemVendor, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmLogTable=ogAlarmLogTable, ogCellModem3gRssi=ogCellModem3gRssi, ogWebUserStartTime=ogWebUserStartTime, ogWifiApTable=ogWifiApTable, ogNetInterfaceName=ogNetInterfaceName, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmEventId=ogAlarmEventId, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsTable=ogUpsTable, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortSpeed=ogSerialPortSpeed, ogCheckName=ogCheckName, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckResolveActions=ogCheckResolveActions, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientApMac=ogWifiClientApMac, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletTable=ogRpcOutletTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmUser=ogAlarmUser, ogUpsOutputCurrent=ogUpsOutputCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortMode=ogSerialPortMode, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiApIndex=ogWifiApIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApSsid=ogWifiApSsid, ogCellModemRegistered=ogCellModemRegistered, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdDioDescription=ogEmdDioDescription, ogCellModemCounter=ogCellModemCounter, ogAlarmSummary=ogAlarmSummary, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortIndex=ogSerialPortIndex, ogHostUserName=ogHostUserName, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemTower=ogCellModemTower, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientInterface=ogWifiClientInterface, ogHostServicePort=ogHostServicePort, ogCellApnNotification=ogCellApnNotification, ogAlarmName=ogAlarmName, ogUpsInputCurrent=ogUpsInputCurrent, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsConnectType=ogUpsConnectType, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmDevice=ogAlarmDevice, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsType=ogUpsType, ogCustomNotification=ogCustomNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioEntry=ogEmdDioEntry, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcName=ogRpcName, ogAlarmLogEntry=ogAlarmLogEntry, ogSystem=ogSystem, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientEntry=ogWifiClientEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcDescription=ogRpcDescription, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWebUserNotification=ogWebUserNotification, ogWifiClientMode=ogWifiClientMode, ogWifiApFrequency=ogWifiApFrequency, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckType=ogCheckType, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTable=ogEmdTable, ogHostServiceType=ogHostServiceType, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmTime=ogAlarmTime, ogEmdLogEnabled=ogEmdLogEnabled, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortDTR=ogSerialPortDTR, ogRpcInputFrequency=ogRpcInputFrequency, ogCellTowerNotification=ogCellTowerNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortTable=ogSerialPortTable, ogHostUserAddress=ogHostUserAddress, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioState=ogEmdDioState, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioTable=ogEmdDioTable, ogCellModemEntry=ogCellModemEntry, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioName=ogEmdDioName, ogUpsCounter=ogUpsCounter, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostIpV6Address=ogHostIpV6Address, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialUserEntry=ogSerialUserEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioType=ogEmdDioType, ogUpsEntry=ogUpsEntry, ogUpsIndex=ogUpsIndex, ogNetInterfaceType=ogNetInterfaceType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostServiceTable=ogHostServiceTable, ogRpcOutletName=ogRpcOutletName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialUserName=ogSerialUserName, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServiceIndex=ogHostServiceIndex, ogWifiClientIndex=ogWifiClientIndex, ogHostUserTable=ogHostUserTable, ogHostServiceNotification=ogHostServiceNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientCounter=ogWifiClientCounter, ogUpsHumidity=ogUpsHumidity, ogUpsDescription=ogUpsDescription, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdConnectType=ogEmdConnectType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogStatus2Compliances=ogStatus2Compliances, ogAlarmType=ogAlarmType, ogWifiClientTable=ogWifiClientTable, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmInstance=ogAlarmInstance, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsTemperature=ogUpsTemperature, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemModel=ogCellModemModel, ogUpsInputVoltage=ogUpsInputVoltage, ogHostServiceHost=ogHostServiceHost, ogWifiApTxPower=ogWifiApTxPower, ogEmdDescription=ogEmdDescription, ogRpcInputNotification=ogRpcInputNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogStatus2Compliance=ogStatus2Compliance, ogAlarm=ogAlarm, ogCheckDeviceName=ogCheckDeviceName, ogEmdName=ogEmdName, ogWifiClientRssi=ogWifiClientRssi, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletFrequency=ogRpcOutletFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryState=ogUpsBatteryState, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmState=ogCurrentAlarmState, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApEntry=ogWifiApEntry, ogRpcOutletState=ogRpcOutletState, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogHostTable=ogHostTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWebUserName=ogWebUserName, ogCellModemApn=ogCellModemApn, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityName=ogEmdHumidityName, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckTriggerActions=ogCheckTriggerActions, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellSignalNotification=ogCellSignalNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserIndex=ogWebUserIndex, ogHostIndex=ogHostIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserStartTime=ogHostUserStartTime, ogMibNotifications=ogMibNotifications, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortParity=ogSerialPortParity, ogEmdEntry=ogEmdEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserIndex=ogSerialUserIndex, ogHostServiceStatus=ogHostServiceStatus, ogWebUserEntry=ogWebUserEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientEssid=ogWifiClientEssid, ogRpcEntry=ogRpcEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialNumber=ogSerialNumber, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostUserHost=ogHostUserHost, ogRpcType=ogRpcType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckEntry=ogCheckEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckResetTimeout=ogCheckResetTimeout, ogBasicAlarmGroup=ogBasicAlarmGroup, ogStatus2=ogStatus2, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortLabel=ogSerialPortLabel, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostName=ogHostName, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserEntry=ogHostUserEntry, ogRpcConnectType=ogRpcConnectType, ogWebUserTable=ogWebUserTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcIndex=ogRpcIndex, ogEmdDioNotification=ogEmdDioNotification, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemTemperature=ogCellModemTemperature, ogEmdIndex=ogEmdIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsName=ogUpsName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckIndex=ogCheckIndex, ogHostUserNotification=ogHostUserNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortBreaks=ogSerialPortBreaks, PYSNMP_MODULE_ID=ogStatus2, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmCheck=ogAlarmCheck, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortStopBits=ogSerialPortStopBits, ogNetInterfaceTable=ogNetInterfaceTable, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserIndex=ogHostUserIndex, ogCellModemConnected=ogCellModemConnected, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostEntry=ogHostEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientAp=ogWifiApClientAp, ogRpcTable=ogRpcTable)
