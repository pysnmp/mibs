...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemIMSI=ogCellModemIMSI, ogWifiApInterface=ogWifiApInterface, ogSerialPortRTS=ogSerialPortRTS, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdDioState=ogEmdDioState, ogSerialUserEntry=ogSerialUserEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmSummary=ogAlarmSummary, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiApIndex=ogWifiApIndex, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortDSR=ogSerialPortDSR, ogHostServiceTable=ogHostServiceTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarm=ogAlarm, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputNotification=ogUpsOutputNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApTxPower=ogWifiApTxPower, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientEntry=ogWifiClientEntry, PYSNMP_MODULE_ID=ogStatus2, ogUpsState=ogUpsState, ogRpcDescription=ogRpcDescription, ogRpcCounter=ogRpcCounter, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemConnected=ogCellModemConnected, ogWebUserName=ogWebUserName, ogHostServiceType=ogHostServiceType, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApTable=ogWifiApTable, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortDCD=ogSerialPortDCD, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortTable=ogSerialPortTable, ogHostUserNotification=ogHostUserNotification, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemSessionTime=ogCellModemSessionTime, ogWebUserIndex=ogWebUserIndex, ogHostServiceEntry=ogHostServiceEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogRpcOutletLoad=ogRpcOutletLoad, ogWebUserNotification=ogWebUserNotification, ogEmdDioIndex=ogEmdDioIndex, ogCellModemTable=ogCellModemTable, ogCellModemCounter=ogCellModemCounter, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsTemperature=ogUpsTemperature, ogUpsCounter=ogUpsCounter, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckName=ogCheckName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCellModemApn=ogCellModemApn, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsName=ogUpsName, ogHostServiceCounter=ogHostServiceCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmInstance=ogAlarmInstance, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcInputNotification=ogRpcInputNotification, ogCellSignalNotification=ogCellSignalNotification, ogHostServiceNotification=ogHostServiceNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortMode=ogSerialPortMode, ogWifiApEntry=ogWifiApEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmTriggerValue=ogAlarmTriggerValue, ogHostServiceHost=ogHostServiceHost, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCustomNotification=ogCustomNotification, ogAlarmUser=ogAlarmUser, ogCellModemModel=ogCellModemModel, ogEmdTable=ogEmdTable, ogUpsLogEnabled=ogUpsLogEnabled, ogSystem=ogSystem, ogUpsHumidity=ogUpsHumidity, ogWebUserTable=ogWebUserTable, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsIndex=ogUpsIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcConnectType=ogRpcConnectType, ogRpcOutletIndex=ogRpcOutletIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientEssid=ogWifiClientEssid, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmDevice=ogAlarmDevice, ogRpcOutletState=ogRpcOutletState, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellApnNotification=ogCellApnNotification, ogHostServicePort=ogHostServicePort, ogWifiClientInterface=ogWifiClientInterface, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmState=ogAlarmState, ogEmdEnabled=ogEmdEnabled, ogSerialUserTable=ogSerialUserTable, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserNotification=ogSerialUserNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApCounter=ogWifiApCounter, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletTotal=ogRpcOutletTotal, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostName=ogHostName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostUserHostName=ogHostUserHostName, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellModemEntry=ogCellModemEntry, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyName=ogPowerSupplyName, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdName=ogEmdName, ogHostServiceIndex=ogHostServiceIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioName=ogEmdDioName, ogAlarmName=ogAlarmName, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialNumber=ogSerialNumber, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckType=ogCheckType, ogStatus2Compliance=ogStatus2Compliance, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckTable=ogCheckTable, ogStatus2Compliances=ogStatus2Compliances, ogCellMessageNotification=ogCellMessageNotification, ogRpcTable=ogRpcTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputFrequency=ogUpsInputFrequency, ogHostIndex=ogHostIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsTable=ogUpsTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdEntry=ogEmdEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmEventId=ogAlarmEventId, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortSpeed=ogSerialPortSpeed, ogCellModemTemperature=ogCellModemTemperature, ogHostUserTable=ogHostUserTable, ogCellNetworkNotification=ogCellNetworkNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostUserName=ogHostUserName, ogUpsDescription=ogUpsDescription, ogWifiApSsid=ogWifiApSsid, ogHostUserEntry=ogHostUserEntry, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientTable=ogWifiClientTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcOutletTable=ogRpcOutletTable, ogCellTowerNotification=ogCellTowerNotification, ogUpsEntry=ogUpsEntry, ogUpsConnectType=ogUpsConnectType, ogEmdDescription=ogEmdDescription, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWebUserEntry=ogWebUserEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcType=ogRpcType, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcOutletName=ogRpcOutletName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemVendor=ogCellModemVendor, ogEmdDioDescription=ogEmdDioDescription, ogHostUserIndex=ogHostUserIndex, ogCheckIndex=ogCheckIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckResolveActions=ogCheckResolveActions, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogStatus2Groups=ogStatus2Groups, ogHostPingNotification=ogHostPingNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemTower=ogCellModemTower, ogCheckEntry=ogCheckEntry, ogRpcIndex=ogRpcIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialUserName=ogSerialUserName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostTable=ogHostTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserAddress=ogHostUserAddress, ogSerialPortIndex=ogSerialPortIndex, ogUpsType=ogUpsType, ogHostUserHost=ogHostUserHost, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsInputVoltage=ogUpsInputVoltage, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcEntry=ogRpcEntry, ogCellModemIndex=ogCellModemIndex, ogWifiApFrequency=ogWifiApFrequency, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputPower=ogUpsOutputPower, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostUserStartTime=ogHostUserStartTime, ogHostIpV6Address=ogHostIpV6Address, ogAlarmCheck=ogAlarmCheck, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmType=ogAlarmType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortCTS=ogSerialPortCTS, ogAlarmTime=ogAlarmTime, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostEntry=ogHostEntry, ogAlarmLogTable=ogAlarmLogTable, ogStatus2=ogStatus2, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserSourcePort=ogWebUserSourcePort, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostIpV4Address=ogHostIpV4Address, ogUpsNotification=ogUpsNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortParity=ogSerialPortParity, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortDTR=ogSerialPortDTR, ogRpcOutletCurrent=ogRpcOutletCurrent, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmLogEntry=ogAlarmLogEntry, ogMibNotifications=ogMibNotifications, ogWifiApClientTable=ogWifiApClientTable, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioType=ogEmdDioType, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientMode=ogWifiClientMode, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdHumidityName=ogEmdHumidityName, ogHostServiceStatus=ogHostServiceStatus, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdIndex=ogEmdIndex, ogRpcName=ogRpcName, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortEntry=ogSerialPortEntry, ogCellModemNetwork=ogCellModemNetwork, ogRpcInputFrequency=ogRpcInputFrequency)
