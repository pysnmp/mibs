...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioIndex=ogEmdDioIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogStatus2Groups=ogStatus2Groups, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApFrequency=ogWifiApFrequency, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmState=ogAlarmState, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputPower=ogUpsOutputPower, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsIndex=ogUpsIndex, ogAlarmEventId=ogAlarmEventId, ogCellSignalNotification=ogCellSignalNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmDevice=ogAlarmDevice, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserSourcePort=ogWebUserSourcePort, ogHostUserName=ogHostUserName, ogWifiClientMode=ogWifiClientMode, ogEmdName=ogEmdName, ogEmdEnabled=ogEmdEnabled, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientCounter=ogWifiClientCounter, ogCellModemEntry=ogCellModemEntry, ogSerialUserName=ogSerialUserName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServicePort=ogHostServicePort, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityCounter=ogEmdHumidityCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostPingNotification=ogHostPingNotification, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientInterface=ogWifiClientInterface, ogWifiApEntry=ogWifiApEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortMode=ogSerialPortMode, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityValue=ogEmdHumidityValue, PYSNMP_MODULE_ID=ogStatus2, ogEmdIndex=ogEmdIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcName=ogRpcName, ogAlarmInstance=ogAlarmInstance, ogSerialPortFlowControl=ogSerialPortFlowControl, ogFirmwareVersion=ogFirmwareVersion, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientMac=ogWifiApClientMac, ogStatus2Compliance=ogStatus2Compliance, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModemRegistered=ogCellModemRegistered, ogCellModemModel=ogCellModemModel, ogAlarm=ogAlarm, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsType=ogUpsType, ogHostIndex=ogHostIndex, ogRpcDescription=ogRpcDescription, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdTable=ogEmdTable, ogSerialNumber=ogSerialNumber, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityName=ogEmdHumidityName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApIndex=ogWifiApIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogWebUserNotification=ogWebUserNotification, ogWifiApTable=ogWifiApTable, ogUpsOutputLoad=ogUpsOutputLoad, ogHostServiceStatus=ogHostServiceStatus, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceEntry=ogHostServiceEntry, ogCellModemTemperature=ogCellModemTemperature, ogEmdDioTable=ogEmdDioTable, ogStatus2Compliances=ogStatus2Compliances, ogHostServiceType=ogHostServiceType, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryState=ogUpsBatteryState, ogHostUserNotification=ogHostUserNotification, ogHostUserHostName=ogHostUserHostName, ogRpcIndex=ogRpcIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortDCD=ogSerialPortDCD, ogAlarmCheck=ogAlarmCheck, ogRpcTable=ogRpcTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceIndex=ogHostServiceIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortCTS=ogSerialPortCTS, ogCellModemTable=ogCellModemTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdHumidityTable=ogEmdHumidityTable, ogCellApnNotification=ogCellApnNotification, ogWebUserName=ogWebUserName, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemEnabled=ogCellModemEnabled, ogSerialPortParity=ogSerialPortParity, ogUpsTable=ogUpsTable, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioName=ogEmdDioName, ogNetInterfaceState=ogNetInterfaceState, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellTowerNotification=ogCellTowerNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialUserLabel=ogSerialUserLabel, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellDataNotification=ogCellDataNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioDirection=ogEmdDioDirection, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServiceHost=ogHostServiceHost, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmSummary=ogAlarmSummary, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsDescription=ogUpsDescription, ogRpcOutletName=ogRpcOutletName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogHostUserStartTime=ogHostUserStartTime, ogRpcType=ogRpcType, ogMibNotifications=ogMibNotifications, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsName=ogUpsName, ogAlarmLogTable=ogAlarmLogTable, ogCellModemSessionTime=ogCellModemSessionTime, ogCellModemCounter=ogCellModemCounter, ogEmdDioDescription=ogEmdDioDescription, ogRpcCounter=ogRpcCounter, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogStatus2=ogStatus2, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceTable=ogHostServiceTable, ogWifiApTxPower=ogWifiApTxPower, ogWifiApCounter=ogWifiApCounter, ogSystem=ogSystem, ogWifiClientIndex=ogWifiClientIndex, ogWebUserIndex=ogWebUserIndex, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientEssid=ogWifiClientEssid, ogUpsState=ogUpsState, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortDSR=ogSerialPortDSR, ogUpsEntry=ogUpsEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogHostUserEntry=ogHostUserEntry, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckTable=ogCheckTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserTable=ogSerialUserTable, ogRpcInputFrequency=ogRpcInputFrequency, ogHostUserHost=ogHostUserHost, ogCellMessageNotification=ogCellMessageNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmUser=ogAlarmUser, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsNotification=ogUpsNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmName=ogAlarmName, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortLabel=ogSerialPortLabel, ogWifiApSsid=ogWifiApSsid, ogHostUserTable=ogHostUserTable, ogCellModemNetwork=ogCellModemNetwork, ogAlarmType=ogAlarmType, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortTable=ogSerialPortTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcConnectType=ogRpcConnectType, ogRpcOutletState=ogRpcOutletState, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemVendor=ogCellModemVendor, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialUserPort=ogSerialUserPort, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDescription=ogEmdDescription, ogHostName=ogHostName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcInputCurrent=ogRpcInputCurrent, ogHostIpV4Address=ogHostIpV4Address, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCheckIndex=ogCheckIndex, ogWifiClientTxPower=ogWifiClientTxPower, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortEntry=ogSerialPortEntry, ogUpsTemperature=ogUpsTemperature, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientTable=ogWifiClientTable, ogCheckName=ogCheckName, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortStopBits=ogSerialPortStopBits)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCheckType=ogCheckType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckEntry=ogCheckEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsCounter=ogUpsCounter, ogWifiApEnabled=ogWifiApEnabled, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostUserAddress=ogHostUserAddress, ogWebUserTable=ogWebUserTable, ogCellModemIMSI=ogCellModemIMSI, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemIndex=ogCellModemIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApInterface=ogWifiApInterface, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientTable=ogWifiApClientTable, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemApn=ogCellModemApn, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortIndex=ogSerialPortIndex, ogHostTable=ogHostTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostEntry=ogHostEntry, ogNetInterfaceType=ogNetInterfaceType, ogRpcEntry=ogRpcEntry, ogSerialPortRTS=ogSerialPortRTS, ogStatus2Conformance=ogStatus2Conformance, ogWebUserStartTime=ogWebUserStartTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWebUserEntry=ogWebUserEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemTower=ogCellModemTower, ogCustomNotification=ogCustomNotification, ogSerialUserIndex=ogSerialUserIndex, ogUpsHumidity=ogUpsHumidity, ogEmdEntry=ogEmdEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemConnected=ogCellModemConnected, ogEmdDioState=ogEmdDioState, ogEmdDioEntry=ogEmdDioEntry, ogEmdConnectType=ogEmdConnectType, ogAlarmTime=ogAlarmTime, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureValue=ogEmdTemperatureValue, ogPowerSupplyName=ogPowerSupplyName, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioType=ogEmdDioType, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue)
