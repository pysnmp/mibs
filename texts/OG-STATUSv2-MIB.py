...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmState=ogAlarmState, ogCheckIndex=ogCheckIndex, ogHostUserIndex=ogHostUserIndex, ogSystem=ogSystem, ogCheckType=ogCheckType, ogNetInterfaceState=ogNetInterfaceState, ogWifiApTxPower=ogWifiApTxPower, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWebUserName=ogWebUserName, ogSerialUserPort=ogSerialUserPort, ogSerialPortParity=ogSerialPortParity, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserTable=ogWebUserTable, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioType=ogEmdDioType, ogSerialPortDCD=ogSerialPortDCD, ogHostUserEntry=ogHostUserEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApFrequency=ogWifiApFrequency, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmEventId=ogAlarmEventId, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortLabel=ogSerialPortLabel, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsNotification=ogUpsNotification, ogWebUserEntry=ogWebUserEntry, ogSerialPortEntry=ogSerialPortEntry, ogMibNotifications=ogMibNotifications, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortDSR=ogSerialPortDSR, ogAlarmSummary=ogAlarmSummary, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioState=ogEmdDioState, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsDescription=ogUpsDescription, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserName=ogSerialUserName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcType=ogRpcType, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsTemperature=ogUpsTemperature, ogWifiApIndex=ogWifiApIndex, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioEntry=ogEmdDioEntry, ogHostServiceIndex=ogHostServiceIndex, ogHostServiceHost=ogHostServiceHost, ogWifiClientTxPower=ogWifiClientTxPower, ogHostServicePort=ogHostServicePort, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostUserTable=ogHostUserTable, ogAlarmCheck=ogAlarmCheck, ogAlarmInstance=ogAlarmInstance, ogHostName=ogHostName, ogWifiClientEntry=ogWifiClientEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioName=ogEmdDioName, ogUpsType=ogUpsType, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApEnabled=ogWifiApEnabled, ogHostIpV6Address=ogHostIpV6Address, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletTable=ogRpcOutletTable, ogRpcCounter=ogRpcCounter, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModem3gRssi=ogCellModem3gRssi, ogCellSignalNotification=ogCellSignalNotification, ogWifiApEntry=ogWifiApEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsTable=ogUpsTable, ogHostServiceTable=ogHostServiceTable, ogWifiClientRssi=ogWifiClientRssi, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserEntry=ogSerialUserEntry, ogRpcConnectType=ogRpcConnectType, ogAlarmLogIndex=ogAlarmLogIndex, ogNetInterfaceName=ogNetInterfaceName, ogCellApnNotification=ogCellApnNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogPowerSupplyName=ogPowerSupplyName, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckEntry=ogCheckEntry, ogHostUserHostName=ogHostUserHostName, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCellModemIndex=ogCellModemIndex, ogEmdDioCounter=ogEmdDioCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogStatus2Groups=ogStatus2Groups, ogStatus2Compliance=ogStatus2Compliance, ogAlarmType=ogAlarmType, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApTable=ogWifiApTable, ogEmdDioTable=ogEmdDioTable, ogRpcDescription=ogRpcDescription, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceType=ogHostServiceType, ogRpcTable=ogRpcTable, ogHostUserStartTime=ogHostUserStartTime, ogUpsBatteryState=ogUpsBatteryState, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellModemEnabled=ogCellModemEnabled, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsState=ogUpsState, ogCellModemTemperature=ogCellModemTemperature, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientAp=ogWifiApClientAp, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioEmd=ogEmdDioEmd, ogCellModemModel=ogCellModemModel, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdName=ogEmdName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdDioNotification=ogEmdDioNotification, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostTable=ogHostTable, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyIndex=ogPowerSupplyIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogHostServiceCounter=ogHostServiceCounter, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmDevice=ogAlarmDevice, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApInterface=ogWifiApInterface, ogHostUserNotification=ogHostUserNotification, ogSerialPortCTS=ogSerialPortCTS, ogCellModemTower=ogCellModemTower, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogRpcEntry=ogRpcEntry, ogUpsIndex=ogUpsIndex, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTable=ogEmdTable, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientRxBytes=ogWifiApClientRxBytes, PYSNMP_MODULE_ID=ogStatus2, ogEmdDioDescription=ogEmdDioDescription, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostEntry=ogHostEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemCounter=ogCellModemCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsCounter=ogUpsCounter, ogCheckName=ogCheckName, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmName=ogAlarmName, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsEntry=ogUpsEntry, ogSerialUserNotification=ogSerialUserNotification, ogCustomNotification=ogCustomNotification, ogCellTowerNotification=ogCellTowerNotification, ogHostUserName=ogHostUserName, ogCurrentAlarmType=ogCurrentAlarmType, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputPower=ogUpsOutputPower, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcInputNotification=ogRpcInputNotification, ogHostUserHost=ogHostUserHost, ogUpsInputCurrent=ogUpsInputCurrent, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApClientEntry=ogWifiApClientEntry, ogCellMessageNotification=ogCellMessageNotification, ogRpcName=ogRpcName, ogCellModemApn=ogCellModemApn, ogStatus2Compliances=ogStatus2Compliances, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostPingNotification=ogHostPingNotification, ogSerialPortTable=ogSerialPortTable, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientEssid=ogWifiClientEssid, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemEntry=ogCellModemEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckResolveActions=ogCheckResolveActions)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialUserLabel=ogSerialUserLabel, ogHostIpV4Address=ogHostIpV4Address, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcOutletName=ogRpcOutletName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostServiceStatus=ogHostServiceStatus, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdEnabled=ogEmdEnabled, ogEmdDioDirection=ogEmdDioDirection, ogStatus2Conformance=ogStatus2Conformance, ogRpcMaxTemperature=ogRpcMaxTemperature, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDescription=ogEmdDescription, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckTable=ogCheckTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApSsid=ogWifiApSsid, ogAlarmUser=ogAlarmUser, ogWifiApClientMac=ogWifiApClientMac, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdEntry=ogEmdEntry, ogSerialNumber=ogSerialNumber, ogWifiClientApMac=ogWifiClientApMac, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmLogTable=ogAlarmLogTable, ogEmdConnectType=ogEmdConnectType, ogAlarm=ogAlarm, ogUpsName=ogUpsName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortMode=ogSerialPortMode, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogRpcIndex=ogRpcIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletEntry=ogRpcOutletEntry, ogHostUserAddress=ogHostUserAddress, ogHostIndex=ogHostIndex, ogCellModemTable=ogCellModemTable, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogNetInterfaceType=ogNetInterfaceType, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientMode=ogWifiClientMode, ogAlarmTime=ogAlarmTime, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientInterface=ogWifiClientInterface, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsConnectType=ogUpsConnectType, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdIndex=ogEmdIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogStatus2=ogStatus2, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemRegistered=ogCellModemRegistered, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcInputCurrent=ogRpcInputCurrent)
