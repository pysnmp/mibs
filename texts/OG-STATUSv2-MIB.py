...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientAp=ogWifiApClientAp, ogCellDataNotification=ogCellDataNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApTable=ogWifiApTable, ogAlarmName=ogAlarmName, ogSerialUserEntry=ogSerialUserEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogStatus2Groups=ogStatus2Groups, ogCellModemApn=ogCellModemApn, ogCheckType=ogCheckType, ogRpcOutputNotification=ogRpcOutputNotification, ogSystem=ogSystem, ogWifiClientTable=ogWifiClientTable, ogUpsTable=ogUpsTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsType=ogUpsType, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsIndex=ogUpsIndex, ogRpcTable=ogRpcTable, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsState=ogUpsState, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmState=ogAlarmState, ogAlarmLogTable=ogAlarmLogTable, ogAlarmEventId=ogAlarmEventId, ogRpcType=ogRpcType, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckTable=ogCheckTable, ogUpsBatteryState=ogUpsBatteryState, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTable=ogEmdTable, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckEntry=ogCheckEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApFrequency=ogWifiApFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsEntry=ogUpsEntry, ogWebUserTable=ogWebUserTable, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioTable=ogEmdDioTable, ogHostIpV6Address=ogHostIpV6Address, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdEntry=ogEmdEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellApnNotification=ogCellApnNotification, ogSerialPortTable=ogSerialPortTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServiceIndex=ogHostServiceIndex, ogRpcCounter=ogRpcCounter, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortRTS=ogSerialPortRTS, ogUpsName=ogUpsName, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletName=ogRpcOutletName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientIndex=ogWifiApClientIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWebUserIndex=ogWebUserIndex, ogCellModemEntry=ogCellModemEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortLabel=ogSerialPortLabel, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyName=ogPowerSupplyName, ogWifiApSsid=ogWifiApSsid, ogCellModemTemperature=ogCellModemTemperature, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogHostServiceCounter=ogHostServiceCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPatternNotification=ogSerialPatternNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientMode=ogWifiClientMode, ogAlarmUser=ogAlarmUser, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmInstance=ogAlarmInstance, ogRpcDescription=ogRpcDescription, ogCellModemVendor=ogCellModemVendor, ogSerialPortBreaks=ogSerialPortBreaks, ogHostIndex=ogHostIndex, PYSNMP_MODULE_ID=ogStatus2, ogEmdDescription=ogEmdDescription, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmSummary=ogAlarmSummary, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserTable=ogHostUserTable, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortParity=ogSerialPortParity, ogSerialUserIndex=ogSerialUserIndex, ogWebUserEntry=ogWebUserEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostUserNotification=ogHostUserNotification, ogFirmwareVersion=ogFirmwareVersion, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWebUserName=ogWebUserName, ogCellModemTower=ogCellModemTower, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogUpsConnectType=ogUpsConnectType, ogHostUserAddress=ogHostUserAddress, ogCheckIndex=ogCheckIndex, ogCheckName=ogCheckName, ogUpsNotification=ogUpsNotification, ogEmdDioType=ogEmdDioType, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdName=ogEmdName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApInterface=ogWifiApInterface, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemModel=ogCellModemModel, ogMibNotifications=ogMibNotifications, ogSerialUserNotification=ogSerialUserNotification, ogAlarmType=ogAlarmType, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostServiceTable=ogHostServiceTable, ogSerialPortMode=ogSerialPortMode, ogRpcOutletTable=ogRpcOutletTable, ogRpcIndex=ogRpcIndex, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdDioEmd=ogEmdDioEmd, ogEmdConnectType=ogEmdConnectType, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostTable=ogHostTable, ogAlarm=ogAlarm, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsCounter=ogUpsCounter, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientIndex=ogWifiClientIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApClientTable=ogWifiApClientTable, ogHostName=ogHostName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdIndex=ogEmdIndex, ogEmdDioNotification=ogEmdDioNotification, ogWifiApEntry=ogWifiApEntry, ogAlarmTime=ogAlarmTime, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsHumidity=ogUpsHumidity, ogUpsInputNotification=ogUpsInputNotification, ogHostServicePort=ogHostServicePort, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostPingNotification=ogHostPingNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserName=ogSerialUserName, ogCliUserSessionNotification=ogCliUserSessionNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostEntry=ogHostEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemConnected=ogCellModemConnected, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceType=ogHostServiceType, ogRpcLogEnabled=ogRpcLogEnabled, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioIndex=ogEmdDioIndex, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdDioName=ogEmdDioName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsTemperature=ogUpsTemperature, ogSerialPortEntry=ogSerialPortEntry, ogRpcEntry=ogRpcEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemTable=ogCellModemTable, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortDTR=ogSerialPortDTR, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortTxBytes=ogSerialPortTxBytes, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientEntry=ogWifiClientEntry, ogHostUserHostName=ogHostUserHostName, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCheckResolveActions=ogCheckResolveActions, ogHostUserStartTime=ogHostUserStartTime, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCellModemCounter=ogCellModemCounter, ogCellSignalNotification=ogCellSignalNotification, ogCellModemIMSI=ogCellModemIMSI, ogHostUserEntry=ogHostUserEntry, ogWifiApIndex=ogWifiApIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioEntry=ogEmdDioEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientEssid=ogWifiClientEssid, ogCurrentAlarmName=ogCurrentAlarmName, ogCellMessageNotification=ogCellMessageNotification, ogAlarmDevice=ogAlarmDevice, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioCounter=ogEmdDioCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdDioState=ogEmdDioState, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCustomNotification=ogCustomNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostUserName=ogHostUserName, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmCheck=ogAlarmCheck, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortDataBits=ogSerialPortDataBits, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientRssi=ogWifiClientRssi, ogWifiApEnabled=ogWifiApEnabled, ogStatus2=ogStatus2, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWebUserStartTime=ogWebUserStartTime, ogStatus2Compliance=ogStatus2Compliance, ogSerialNumber=ogSerialNumber, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcName=ogRpcName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientApMac=ogWifiClientApMac, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioDescription=ogEmdDioDescription, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortDCD=ogSerialPortDCD, ogCellTowerNotification=ogCellTowerNotification, ogWifiApTxPower=ogWifiApTxPower, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsDescription=ogUpsDescription, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserNotification=ogWebUserNotification, ogHostUserHost=ogHostUserHost, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmLogEntry=ogAlarmLogEntry)
