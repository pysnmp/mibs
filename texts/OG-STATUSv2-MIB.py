...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsConnectType=ogUpsConnectType, ogCellModemEnabled=ogCellModemEnabled, ogCellModemIndex=ogCellModemIndex, ogHostUserIndex=ogHostUserIndex, ogEmdDioDescription=ogEmdDioDescription, ogCellModemNetwork=ogCellModemNetwork, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioEmd=ogEmdDioEmd, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsState=ogUpsState, ogHostServiceHost=ogHostServiceHost, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientRssi=ogWifiClientRssi, ogMibNotifications=ogMibNotifications, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApClientIndex=ogWifiApClientIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModemRegistered=ogCellModemRegistered, ogFirmwareVersion=ogFirmwareVersion, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApClientMac=ogWifiApClientMac, ogCellModemApn=ogCellModemApn, ogUpsIndex=ogUpsIndex, ogWebUserEntry=ogWebUserEntry, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdEntry=ogEmdEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialUserPort=ogSerialUserPort, ogHostName=ogHostName, ogRpcOutletRpc=ogRpcOutletRpc, ogHostUserHost=ogHostUserHost, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsNotification=ogUpsNotification, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientEssid=ogWifiClientEssid, ogRpcType=ogRpcType, ogAlarmCheck=ogAlarmCheck, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortCTS=ogSerialPortCTS, ogUpsEntry=ogUpsEntry, ogEmdDioName=ogEmdDioName, ogCellModemTower=ogCellModemTower, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogPowerSupplyEntry=ogPowerSupplyEntry, ogStatus2=ogStatus2, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogSystem=ogSystem, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryState=ogUpsBatteryState, ogUpsTable=ogUpsTable, ogCellModemSessionTime=ogCellModemSessionTime, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortIndex=ogSerialPortIndex, ogWifiClientMode=ogWifiClientMode, ogHostUserName=ogHostUserName, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialNumber=ogSerialNumber, ogHostIndex=ogHostIndex, ogHostServiceTable=ogHostServiceTable, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostPingNotification=ogHostPingNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcOutletName=ogRpcOutletName, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserStartTime=ogSerialUserStartTime, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsHumidity=ogUpsHumidity, ogEmdName=ogEmdName, ogRpcConnectType=ogRpcConnectType, ogCellTowerNotification=ogCellTowerNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellMessageNotification=ogCellMessageNotification, ogCheckDeviceName=ogCheckDeviceName, ogHostUserTable=ogHostUserTable, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdEnabled=ogEmdEnabled, ogAlarmInstance=ogAlarmInstance, ogCheckType=ogCheckType, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletTable=ogRpcOutletTable, ogWifiApEntry=ogWifiApEntry, ogCheckTable=ogCheckTable, ogEmdDescription=ogEmdDescription, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcDescription=ogRpcDescription, ogUpsCounter=ogUpsCounter, ogRpcOutletTotal=ogRpcOutletTotal, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCurrentAlarmUser=ogCurrentAlarmUser, ogRpcOutletState=ogRpcOutletState, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletEntry=ogRpcOutletEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostServiceStatus=ogHostServiceStatus, ogSerialPortLogLevel=ogSerialPortLogLevel, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioCounter=ogEmdDioCounter, ogCellModemEntry=ogCellModemEntry, ogSerialPortMode=ogSerialPortMode, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmSummary=ogAlarmSummary, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWebUserNotification=ogWebUserNotification, ogWebUserIndex=ogWebUserIndex, ogRpcTable=ogRpcTable, ogAlarmTime=ogAlarmTime, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceCounter=ogHostServiceCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdDioTable=ogEmdDioTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientRssi=ogWifiApClientRssi, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientAp=ogWifiApClientAp, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostIpV6Address=ogHostIpV6Address, ogWifiClientTable=ogWifiClientTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioType=ogEmdDioType, ogHostServiceNotification=ogHostServiceNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogCellModemTable=ogCellModemTable, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2Groups=ogStatus2Groups, ogEmdDioDirection=ogEmdDioDirection, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcIndex=ogRpcIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortEntry=ogSerialPortEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientCounter=ogWifiClientCounter, ogSerialUserEntry=ogSerialUserEntry, ogSerialUserIndex=ogSerialUserIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputCurrent=ogUpsOutputCurrent, ogAlarmEventId=ogAlarmEventId, ogSerialUserName=ogSerialUserName, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsType=ogUpsType, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortDTR=ogSerialPortDTR, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWebUserName=ogWebUserName, ogCellModemCounter=ogCellModemCounter, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortLabel=ogSerialPortLabel, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialUserTable=ogSerialUserTable, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientFrequency=ogWifiClientFrequency, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApCounter=ogWifiApCounter, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckIndex=ogCheckIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortParity=ogSerialPortParity, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellDataNotification=ogCellDataNotification, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemModel=ogCellModemModel, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApFrequency=ogWifiApFrequency, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientEntry=ogWifiClientEntry, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceState=ogNetInterfaceState, ogAlarm=ogAlarm, ogCustomNotification=ogCustomNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostEntry=ogHostEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialUserNotification=ogSerialUserNotification, ogUpsName=ogUpsName, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApIndex=ogWifiApIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmState=ogAlarmState, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogEmdDioState=ogEmdDioState, ogEmdDioEntry=ogEmdDioEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, PYSNMP_MODULE_ID=ogStatus2, ogWifiApSsid=ogWifiApSsid, ogAlarmUser=ogAlarmUser, ogCellModemVendor=ogCellModemVendor, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortTable=ogSerialPortTable, ogHostUserEntry=ogHostUserEntry, ogAlarmType=ogAlarmType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmState=ogCurrentAlarmState, ogEmdDioIndex=ogEmdDioIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCheckName=ogCheckName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogPowerSupplyTable=ogPowerSupplyTable, ogHostUserAddress=ogHostUserAddress, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckDeviceIndex=ogCheckDeviceIndex, ogAlarmName=ogAlarmName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcName=ogRpcName, ogRpcCounter=ogRpcCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceType=ogNetInterfaceType, ogWifiApTable=ogWifiApTable, ogSerialPortDCD=ogSerialPortDCD, ogCheckEntry=ogCheckEntry, ogHostServiceType=ogHostServiceType, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcEntry=ogRpcEntry, ogWifiClientApMac=ogWifiClientApMac, ogCellApnNotification=ogCellApnNotification, ogHostServicePort=ogHostServicePort, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioNotification=ogEmdDioNotification, ogCellModemTemperature=ogCellModemTemperature, ogEmdConnectType=ogEmdConnectType, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemConnected=ogCellModemConnected, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApInterface=ogWifiApInterface, ogEmdTable=ogEmdTable, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarmLogEntry=ogAlarmLogEntry, ogHostTable=ogHostTable, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsOutputPower=ogUpsOutputPower, ogStatus2Conformance=ogStatus2Conformance, ogUpsDescription=ogUpsDescription, ogCellSignalNotification=ogCellSignalNotification, ogWebUserTable=ogWebUserTable, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdIndex=ogEmdIndex)
