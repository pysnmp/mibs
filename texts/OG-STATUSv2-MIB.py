...
Integer32, iso, Gauge32, Unsigned32, Counter32, NotificationType, TimeTicks, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Bits, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "Gauge32", "Unsigned32", "Counter32", "NotificationType", "TimeTicks", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Bits", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmLogTable=ogAlarmLogTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioState=ogEmdDioState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApEntry=ogWifiApEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellTowerNotification=ogCellTowerNotification, ogUpsTemperature=ogUpsTemperature, ogCheckDeviceName=ogCheckDeviceName, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialUserName=ogSerialUserName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioEmd=ogEmdDioEmd, ogEmdIndex=ogEmdIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortRTS=ogSerialPortRTS, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServiceStatus=ogHostServiceStatus, ogEmdDioTable=ogEmdDioTable, ogSerialUserStartTime=ogSerialUserStartTime, ogHostUserHostName=ogHostUserHostName, ogHostUserIndex=ogHostUserIndex, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityName=ogEmdHumidityName, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortDTR=ogSerialPortDTR, ogStatus2=ogStatus2, ogCellNetworkNotification=ogCellNetworkNotification, ogHostUserEntry=ogHostUserEntry, ogCustomNotification=ogCustomNotification, ogUpsHumidity=ogUpsHumidity, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCheckTable=ogCheckTable, ogUpsBatteryState=ogUpsBatteryState, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogHostPingNotification=ogHostPingNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogStatus2Conformance=ogStatus2Conformance, ogSerialUserPort=ogSerialUserPort, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogStatus2Groups=ogStatus2Groups, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmState=ogAlarmState, ogUpsOutputNotification=ogUpsOutputNotification, ogCellDataNotification=ogCellDataNotification, ogSerialPortTable=ogSerialPortTable, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcIndex=ogRpcIndex, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApCounter=ogWifiApCounter, ogSerialPortBreaks=ogSerialPortBreaks, ogHostServiceNotification=ogHostServiceNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostUserHost=ogHostUserHost, ogWifiApClientMac=ogWifiApClientMac, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortIndex=ogSerialPortIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckIndex=ogCheckIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogAlarmSummary=ogAlarmSummary, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialUserNotification=ogSerialUserNotification, ogHostServiceType=ogHostServiceType, ogRpcEntry=ogRpcEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModemEntry=ogCellModemEntry, ogSerialUserLabel=ogSerialUserLabel, ogCheckEntry=ogCheckEntry, ogAlarmUser=ogAlarmUser, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserIndex=ogSerialUserIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogAlarmDevice=ogAlarmDevice, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientInterface=ogWifiClientInterface, ogEmdTable=ogEmdTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostIpV6Address=ogHostIpV6Address, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemIndex=ogCellModemIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsNotification=ogUpsNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWebUserIndex=ogWebUserIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostName=ogHostName, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserStartTime=ogWebUserStartTime, ogRpcInputNotification=ogRpcInputNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientRssi=ogWifiClientRssi, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserTable=ogHostUserTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialNumber=ogSerialNumber, ogCellModemTemperature=ogCellModemTemperature, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostServiceIndex=ogHostServiceIndex, ogCheckResolveActions=ogCheckResolveActions, ogRpcConnectType=ogRpcConnectType, ogAlarmName=ogAlarmName, ogCellModemIMSI=ogCellModemIMSI, ogHostIpV4Address=ogHostIpV4Address, ogEmdConnectType=ogEmdConnectType, PYSNMP_MODULE_ID=ogStatus2, ogAlarm=ogAlarm, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemNetwork=ogCellModemNetwork, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogStatus2Compliances=ogStatus2Compliances, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmEventId=ogAlarmEventId, ogSerialPortParity=ogSerialPortParity, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostUserName=ogHostUserName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckType=ogCheckType, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModemTable=ogCellModemTable, ogEmdName=ogEmdName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWebUserNotification=ogWebUserNotification, ogHostServiceTable=ogHostServiceTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletState=ogRpcOutletState, ogSerialPortEntry=ogSerialPortEntry, ogHostUserStartTime=ogHostUserStartTime, ogHostUserNotification=ogHostUserNotification, ogHostServicePort=ogHostServicePort, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSystem=ogSystem, ogWifiClientTable=ogWifiClientTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortFlowControl=ogSerialPortFlowControl, ogRpcOutputNotification=ogRpcOutputNotification, ogCellModemTower=ogCellModemTower, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApFrequency=ogWifiApFrequency, ogHostIndex=ogHostIndex, ogSerialPortMode=ogSerialPortMode, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioDescription=ogEmdDioDescription, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemModel=ogCellModemModel, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApIndex=ogWifiApIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsConnectType=ogUpsConnectType, ogEmdEntry=ogEmdEntry, ogCellModemRegistered=ogCellModemRegistered, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortDSR=ogSerialPortDSR, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiClientIndex=ogWifiClientIndex, ogWifiApTxPower=ogWifiApTxPower, ogHostTable=ogHostTable, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogPowerSupplyName=ogPowerSupplyName, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserTable=ogSerialUserTable, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsTable=ogUpsTable, ogEmdDioCounter=ogEmdDioCounter, ogWifiApInterface=ogWifiApInterface, ogCellModemApn=ogCellModemApn, ogStatus2Compliance=ogStatus2Compliance, ogRpcType=ogRpcType, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogMibNotifications=ogMibNotifications, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioDirection=ogEmdDioDirection, ogEmdDescription=ogEmdDescription, ogUpsDescription=ogUpsDescription, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcDescription=ogRpcDescription, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsState=ogUpsState, ogHostEntry=ogHostEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApEnabled=ogWifiApEnabled, ogWebUserEntry=ogWebUserEntry, ogSerialPortLabel=ogSerialPortLabel, ogUpsOutputPower=ogUpsOutputPower, ogRpcTable=ogRpcTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientAp=ogWifiApClientAp)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogAlarmTime=ogAlarmTime, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWebUserTable=ogWebUserTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckName=ogCheckName, ogWifiApClientTable=ogWifiApClientTable, ogAlarmCheck=ogAlarmCheck, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsCounter=ogUpsCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceHost=ogHostServiceHost, ogWifiApTable=ogWifiApTable, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsInputNotification=ogUpsInputNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWebUserName=ogWebUserName, ogRpcName=ogRpcName, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmType=ogAlarmType, ogNetInterfaceName=ogNetInterfaceName, ogUpsName=ogUpsName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellMessageNotification=ogCellMessageNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientCounter=ogWifiClientCounter, ogCellApnNotification=ogCellApnNotification, ogUpsEntry=ogUpsEntry, ogUpsType=ogUpsType, ogWifiApSsid=ogWifiApSsid, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostUserAddress=ogHostUserAddress, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientMode=ogWifiClientMode, ogRpcCounter=ogRpcCounter, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemVendor=ogCellModemVendor, ogEmdDioType=ogEmdDioType, ogEmdTemperatureTable=ogEmdTemperatureTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortCTS=ogSerialPortCTS, ogEmdDioName=ogEmdDioName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemConnected=ogCellModemConnected, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientApMac=ogWifiClientApMac, ogUpsIndex=ogUpsIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmInstance=ogAlarmInstance, ogCellModemCounter=ogCellModemCounter)
