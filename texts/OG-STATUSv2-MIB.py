...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletName=ogRpcOutletName, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortLabel=ogSerialPortLabel, ogUpsInputFrequency=ogUpsInputFrequency, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCustomNotification=ogCustomNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCellModemIMSI=ogCellModemIMSI, ogSerialUserLabel=ogSerialUserLabel, ogUpsIndex=ogUpsIndex, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmUser=ogCurrentAlarmUser, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioState=ogEmdDioState, ogWebUserEntry=ogWebUserEntry, ogCellModemNetwork=ogCellModemNetwork, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputPower=ogUpsOutputPower, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogNetInterfaceIndex=ogNetInterfaceIndex, ogFirmwareVersion=ogFirmwareVersion, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdConnectType=ogEmdConnectType, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogNetInterfaceState=ogNetInterfaceState, ogSerialUserIndex=ogSerialUserIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmCheck=ogAlarmCheck, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialPortDCD=ogSerialPortDCD, ogSerialPortCTS=ogSerialPortCTS, ogNetInterfaceNotification=ogNetInterfaceNotification, ogStatus2Compliance=ogStatus2Compliance, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioName=ogEmdDioName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWebUserIndex=ogWebUserIndex, ogCellModemTower=ogCellModemTower, ogUpsNotification=ogUpsNotification, ogCellModemModel=ogCellModemModel, ogEmdName=ogEmdName, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarm=ogAlarm, ogHostPingNotification=ogHostPingNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogHostIpV6Address=ogHostIpV6Address, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientCounter=ogWifiClientCounter, ogAlarmName=ogAlarmName, ogCellSignalNotification=ogCellSignalNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogCellModemApn=ogCellModemApn, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialPortStopBits=ogSerialPortStopBits, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostUserName=ogHostUserName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellNetworkNotification=ogCellNetworkNotification, ogHostServiceType=ogHostServiceType, ogRpcDescription=ogRpcDescription, ogAlarmState=ogAlarmState, ogWifiApEnabled=ogWifiApEnabled, ogCellApnNotification=ogCellApnNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogSerialUserStartTime=ogSerialUserStartTime, ogNetInterfaceTable=ogNetInterfaceTable, ogHostServicePort=ogHostServicePort, ogRpcType=ogRpcType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserName=ogWebUserName, ogHostServiceHost=ogHostServiceHost, ogSerialPortBreaks=ogSerialPortBreaks, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserPort=ogSerialUserPort, ogNetInterfaceType=ogNetInterfaceType, ogUpsName=ogUpsName, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserHost=ogHostUserHost, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityName=ogEmdHumidityName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogMibNotifications=ogMibNotifications, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostIndex=ogHostIndex, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientEssid=ogWifiClientEssid, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortParity=ogSerialPortParity, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogHostEntry=ogHostEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogHostUserHostName=ogHostUserHostName, ogHostServiceTable=ogHostServiceTable, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdDescription=ogEmdDescription, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiApCounter=ogWifiApCounter, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdEntry=ogEmdEntry, ogWifiApInterface=ogWifiApInterface, ogHostUserTable=ogHostUserTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsConnectType=ogUpsConnectType, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmType=ogAlarmType, ogRpcEntry=ogRpcEntry, ogHostTable=ogHostTable, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmUser=ogAlarmUser, ogAlarmDevice=ogAlarmDevice, ogHostName=ogHostName, ogCheckIndex=ogCheckIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogHostServiceStatus=ogHostServiceStatus, ogHostServiceIndex=ogHostServiceIndex, ogHostUserIndex=ogHostUserIndex, ogUpsState=ogUpsState, ogUpsCounter=ogUpsCounter, ogEmdDioDirection=ogEmdDioDirection, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioTable=ogEmdDioTable, ogCellModemTemperature=ogCellModemTemperature, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsDescription=ogUpsDescription, ogEmdTemperatureValue=ogEmdTemperatureValue, ogHostUserStartTime=ogHostUserStartTime, ogCellModemIndex=ogCellModemIndex, ogEmdDioIndex=ogEmdDioIndex, ogUpsTable=ogUpsTable, ogUpsEntry=ogUpsEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsHumidity=ogUpsHumidity, ogWifiClientApMac=ogWifiClientApMac, ogWebUserTable=ogWebUserTable, ogCellModemEnabled=ogCellModemEnabled, ogCellModemConnected=ogCellModemConnected, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogStatus2Compliances=ogStatus2Compliances, ogSystem=ogSystem, ogCellModemEntry=ogCellModemEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserEntry=ogHostUserEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApTable=ogWifiApTable, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioEmd=ogEmdDioEmd, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletLoad=ogRpcOutletLoad, ogHostIpV4Address=ogHostIpV4Address, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckType=ogCheckType, ogStatus2Groups=ogStatus2Groups, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWebUserNotification=ogWebUserNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostUserNotification=ogHostUserNotification, ogEmdDioNotification=ogEmdDioNotification, ogCheckName=ogCheckName, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogSerialPortMode=ogSerialPortMode, ogRpcOutletRpc=ogRpcOutletRpc, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApSsid=ogWifiApSsid, ogSerialUserNotification=ogSerialUserNotification, ogEmdEnabled=ogEmdEnabled, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioCounter=ogEmdDioCounter, ogRpcCounter=ogRpcCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCheckTable=ogCheckTable, ogEmdHumidityTable=ogEmdHumidityTable, ogWebUserStartTime=ogWebUserStartTime, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcConnectType=ogRpcConnectType, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientMode=ogWifiClientMode, ogWifiApIndex=ogWifiApIndex, ogSerialNumber=ogSerialNumber, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsType=ogUpsType, ogSerialPortDSR=ogSerialPortDSR)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogAlarmTime=ogAlarmTime, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialUserEntry=ogSerialUserEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialUserName=ogSerialUserName, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputLoad=ogUpsOutputLoad, ogHostUserAddress=ogHostUserAddress, ogSerialPortTable=ogSerialPortTable, ogCurrentAlarmName=ogCurrentAlarmName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortIndex=ogSerialPortIndex, ogRpcIndex=ogRpcIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcTable=ogRpcTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsTemperature=ogUpsTemperature, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckEntry=ogCheckEntry, ogWifiApClientAp=ogWifiApClientAp, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdIndex=ogEmdIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialPortDTR=ogSerialPortDTR, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientTable=ogWifiClientTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemVendor=ogCellModemVendor, ogRpcName=ogRpcName, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiClientIndex=ogWifiClientIndex, ogStatus2Conformance=ogStatus2Conformance, ogAlarmInstance=ogAlarmInstance, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogAlarmSummary=ogAlarmSummary, ogCellTowerNotification=ogCellTowerNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTable=ogEmdTable, ogHostServiceNotification=ogHostServiceNotification, ogSerialUserTable=ogSerialUserTable, ogEmdDioEntry=ogEmdDioEntry, ogRpcInputNotification=ogRpcInputNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckDeviceName=ogCheckDeviceName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioType=ogEmdDioType, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemTable=ogCellModemTable, ogHostServiceCounter=ogHostServiceCounter, ogStatus2=ogStatus2, ogNetInterfaceName=ogNetInterfaceName, ogCellModemCounter=ogCellModemCounter, ogSerialPortEntry=ogSerialPortEntry)
