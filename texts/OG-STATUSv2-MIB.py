...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletEntry=ogRpcOutletEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemEntry=ogCellModemEntry, ogCellModemCounter=ogCellModemCounter, ogCheckResolveActions=ogCheckResolveActions, ogCellModemTable=ogCellModemTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogSerialPortMode=ogSerialPortMode, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletName=ogRpcOutletName, ogCellMessageNotification=ogCellMessageNotification, ogUpsConnectType=ogUpsConnectType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsType=ogUpsType, ogAlarmState=ogAlarmState, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsOutputPower=ogUpsOutputPower, ogUpsInputNotification=ogUpsInputNotification, ogWebUserEntry=ogWebUserEntry, ogWebUserTable=ogWebUserTable, ogUpsEntry=ogUpsEntry, ogUpsDescription=ogUpsDescription, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortTable=ogSerialPortTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckTriggerActions=ogCheckTriggerActions, ogWebUserNotification=ogWebUserNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcType=ogRpcType, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserIndex=ogHostUserIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortDSR=ogSerialPortDSR, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioNotification=ogEmdDioNotification, ogHostUserNotification=ogHostUserNotification, ogUpsIndex=ogUpsIndex, ogEmdDioEmd=ogEmdDioEmd, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsState=ogUpsState, ogSerialUserNotification=ogSerialUserNotification, ogAlarmEventId=ogAlarmEventId, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmState=ogCurrentAlarmState, ogHostIpV6Address=ogHostIpV6Address, ogAlarmDevice=ogAlarmDevice, ogUpsCounter=ogUpsCounter, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModemIMSI=ogCellModemIMSI, ogCellApnNotification=ogCellApnNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioTable=ogEmdDioTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsNotification=ogUpsNotification, ogHostServiceIndex=ogHostServiceIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdEntry=ogEmdEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcEntry=ogRpcEntry, ogStatus2=ogStatus2, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdIndex=ogEmdIndex, ogSerialPortCTS=ogSerialPortCTS, ogCheckEntry=ogCheckEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcName=ogRpcName, ogStatus2Compliances=ogStatus2Compliances, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsTemperature=ogUpsTemperature, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostIpV4Address=ogHostIpV4Address, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarmType=ogAlarmType, ogHostServiceNotification=ogHostServiceNotification, ogSerialUserPort=ogSerialUserPort, ogCellModemConnected=ogCellModemConnected, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdConnectType=ogEmdConnectType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsName=ogUpsName, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdDioType=ogEmdDioType, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWebUserStartTime=ogWebUserStartTime, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortParity=ogSerialPortParity, ogEmdName=ogEmdName, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioIndex=ogEmdDioIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckName=ogCheckName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyName=ogPowerSupplyName, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientTable=ogWifiClientTable, ogCellModemTemperature=ogCellModemTemperature, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogHostServiceStatus=ogHostServiceStatus, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcCounter=ogRpcCounter, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemEnabled=ogCellModemEnabled, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogFirmwareVersion=ogFirmwareVersion, ogRpcConnectType=ogRpcConnectType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmSummary=ogAlarmSummary, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsHumidity=ogUpsHumidity, ogCellModemApn=ogCellModemApn, ogCheckIndex=ogCheckIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogHostIndex=ogHostIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserHostName=ogHostUserHostName, ogPowerSupplyIndex=ogPowerSupplyIndex, PYSNMP_MODULE_ID=ogStatus2, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCellTowerNotification=ogCellTowerNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogAlarmInstance=ogAlarmInstance, ogRpcOutletState=ogRpcOutletState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmTime=ogCurrentAlarmTime, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortEntry=ogSerialPortEntry, ogWifiApCounter=ogWifiApCounter, ogWifiApEntry=ogWifiApEntry, ogSerialUserIndex=ogSerialUserIndex, ogWifiClientIndex=ogWifiClientIndex, ogHostUserName=ogHostUserName, ogWifiApInterface=ogWifiApInterface, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortRTS=ogSerialPortRTS, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputVoltage=ogUpsOutputVoltage, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdDioName=ogEmdDioName, ogSerialPortLabel=ogSerialPortLabel, ogHostUserAddress=ogHostUserAddress, ogCellSignalNotification=ogCellSignalNotification, ogUpsBatteryState=ogUpsBatteryState, ogHostName=ogHostName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioInputTotal=ogEmdDioInputTotal, ogAlarmLogTable=ogAlarmLogTable, ogSerialUserTable=ogSerialUserTable, ogCellDataNotification=ogCellDataNotification, ogHostServiceEntry=ogHostServiceEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSystem=ogSystem, ogHostPingNotification=ogHostPingNotification, ogWifiApSsid=ogWifiApSsid, ogWifiApFrequency=ogWifiApFrequency, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcOutletTable=ogRpcOutletTable, ogUpsTable=ogUpsTable, ogSerialUserName=ogSerialUserName, ogHostServiceType=ogHostServiceType, ogUpsInputVoltage=ogUpsInputVoltage, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserHost=ogHostUserHost, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserLabel=ogSerialUserLabel, ogWebUserSourceAddress=ogWebUserSourceAddress, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserSourcePort=ogWebUserSourcePort, ogCustomNotification=ogCustomNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientMode=ogWifiClientMode, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostServiceCounter=ogHostServiceCounter, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialNumber=ogSerialNumber, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientCounter=ogWifiClientCounter, ogWebUserIndex=ogWebUserIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiApIndex=ogWifiApIndex, ogWifiApEnabled=ogWifiApEnabled, ogNetInterfaceState=ogNetInterfaceState, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientTable=ogWifiApClientTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserEntry=ogHostUserEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmTime=ogAlarmTime, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckType=ogCheckType, ogWifiApTable=ogWifiApTable, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortDTR=ogSerialPortDTR, ogHostTable=ogHostTable, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceHost=ogHostServiceHost, ogRpcDescription=ogRpcDescription, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemRegistered=ogCellModemRegistered, ogNetInterfaceName=ogNetInterfaceName, ogRpcInputNotification=ogRpcInputNotification, ogHostEntry=ogHostEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogNetInterfaceTable=ogNetInterfaceTable, ogNetInterfaceType=ogNetInterfaceType, ogStatus2Groups=ogStatus2Groups, ogCellModemNetwork=ogCellModemNetwork, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemModel=ogCellModemModel, ogAlarmUser=ogAlarmUser, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientInterface=ogWifiClientInterface, ogEmdTable=ogEmdTable, ogEmdDescription=ogEmdDescription, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDioDirection=ogEmdDioDirection, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcIndex=ogRpcIndex, ogHostServicePort=ogHostServicePort, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcTable=ogRpcTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientEnabled=ogWifiClientEnabled, ogCheckTable=ogCheckTable, ogUpsInputFrequency=ogUpsInputFrequency, ogHostUserTable=ogHostUserTable, ogWebUserName=ogWebUserName, ogWifiClientRssi=ogWifiClientRssi, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemVendor=ogCellModemVendor, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemTower=ogCellModemTower, ogHostServiceTable=ogHostServiceTable, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmName=ogAlarmName, ogEmdDioState=ogEmdDioState, ogUpsOutputFrequency=ogUpsOutputFrequency, ogMibNotifications=ogMibNotifications, ogWifiClientEntry=ogWifiClientEntry, ogAlarm=ogAlarm)
