...
ObjectIdentity, IpAddress, ModuleIdentity, Counter32, NotificationType, iso, Unsigned32, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "IpAddress", "ModuleIdentity", "Counter32", "NotificationType", "iso", "Unsigned32", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "Bits", "Gauge32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortTable=ogSerialPortTable, ogWifiApInterface=ogWifiApInterface, ogCellModemConnected=ogCellModemConnected, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckType=ogCheckType, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApFrequency=ogWifiApFrequency, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortEntry=ogSerialPortEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialUserIndex=ogSerialUserIndex, ogUpsHumidity=ogUpsHumidity, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostUserEntry=ogHostUserEntry, ogEmdDioNotification=ogEmdDioNotification, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogMibNotifications=ogMibNotifications, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientMode=ogWifiClientMode, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogStatus2=ogStatus2, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostUserHost=ogHostUserHost, ogUpsNotification=ogUpsNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioType=ogEmdDioType, ogSerialPortStopBits=ogSerialPortStopBits, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsTemperature=ogUpsTemperature, ogUpsName=ogUpsName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcLogEnabled=ogRpcLogEnabled, ogCellModemSessionTime=ogCellModemSessionTime, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortTxBytes=ogSerialPortTxBytes, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdHumidityEmd=ogEmdHumidityEmd, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogFirmwareVersion=ogFirmwareVersion, ogHostName=ogHostName, ogEmdIndex=ogEmdIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogCellApnNotification=ogCellApnNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiApClientAp=ogWifiApClientAp, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyName=ogPowerSupplyName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWebUserName=ogWebUserName, ogEmdDioCounter=ogEmdDioCounter, ogRpcEntry=ogRpcEntry, ogRpcConnectType=ogRpcConnectType, ogNetInterfaceName=ogNetInterfaceName, ogCheckEntry=ogCheckEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDescription=ogEmdDescription, ogAlarmLogEntry=ogAlarmLogEntry, ogCellModemModel=ogCellModemModel, ogCellModemEntry=ogCellModemEntry, ogSerialUserEntry=ogSerialUserEntry, ogWebUserTable=ogWebUserTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostEntry=ogHostEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckTriggerActions=ogCheckTriggerActions, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWebUserNotification=ogWebUserNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortDTR=ogSerialPortDTR, ogNetInterfaceType=ogNetInterfaceType, ogWifiApTxPower=ogWifiApTxPower, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApTable=ogWifiApTable, ogStatus2Conformance=ogStatus2Conformance, ogUpsInputCurrent=ogUpsInputCurrent, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortRTS=ogSerialPortRTS, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApCounter=ogWifiApCounter, ogUpsIndex=ogUpsIndex, ogHostServiceTable=ogHostServiceTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcInputNotification=ogRpcInputNotification, ogCellModemEnabled=ogCellModemEnabled, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsInputFrequency=ogUpsInputFrequency, ogHostUserStartTime=ogHostUserStartTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdDioEmd=ogEmdDioEmd, ogCellModemApn=ogCellModemApn, ogEmdConnectType=ogEmdConnectType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCheckName=ogCheckName, ogHostUserHostName=ogHostUserHostName, ogCellDataNotification=ogCellDataNotification, ogUpsType=ogUpsType, ogCellModemVendor=ogCellModemVendor, ogHostServiceType=ogHostServiceType, ogAlarmUser=ogAlarmUser, ogRpcOutletState=ogRpcOutletState, ogSerialPortParity=ogSerialPortParity, ogSerialPortIndex=ogSerialPortIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdName=ogEmdName, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckDeviceName=ogCheckDeviceName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostUserAddress=ogHostUserAddress, ogRpcCounter=ogRpcCounter, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmDevice=ogAlarmDevice, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceHost=ogHostServiceHost, ogRpcType=ogRpcType, ogCellModemNetwork=ogCellModemNetwork, ogAlarmCheck=ogAlarmCheck, ogHostUserNotification=ogHostUserNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialNumber=ogSerialNumber, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientIndex=ogWifiClientIndex, ogNetInterfaceState=ogNetInterfaceState, ogUpsDescription=ogUpsDescription, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdDioState=ogEmdDioState, ogWebUserEntry=ogWebUserEntry, ogWifiApClientMac=ogWifiApClientMac, ogEmdDioName=ogEmdDioName, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCheckIndex=ogCheckIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioDirection=ogEmdDioDirection, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostServiceEntry=ogHostServiceEntry, ogSerialPortMode=ogSerialPortMode, ogUpsCounter=ogUpsCounter, ogWifiApIndex=ogWifiApIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogUpsBatteryState=ogUpsBatteryState, ogAlarmTime=ogAlarmTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioTable=ogEmdDioTable, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdEntry=ogEmdEntry, ogUpsEntry=ogUpsEntry, ogUpsInputNotification=ogUpsInputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortDSR=ogSerialPortDSR, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialUserPort=ogSerialUserPort, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmName=ogCurrentAlarmName, ogHostServiceNotification=ogHostServiceNotification, ogUpsState=ogUpsState, ogRpcOutletLoad=ogRpcOutletLoad, ogStatus2Compliances=ogStatus2Compliances, ogRpcName=ogRpcName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletName=ogRpcOutletName, ogCellModemCounter=ogCellModemCounter, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemTower=ogCellModemTower, ogSerialPortLabel=ogSerialPortLabel, ogHostUserName=ogHostUserName, ogUpsOutputPower=ogUpsOutputPower, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcDescription=ogRpcDescription, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCustomNotification=ogCustomNotification, ogPowerSupplyTable=ogPowerSupplyTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostTable=ogHostTable, ogCheckTable=ogCheckTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcOutletVoltage=ogRpcOutletVoltage, ogSerialUserNotification=ogSerialUserNotification, ogAlarmInstance=ogAlarmInstance, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmName=ogAlarmName, ogUpsTable=ogUpsTable, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialUserLabel=ogSerialUserLabel, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApSsid=ogWifiApSsid, ogEmdTemperatureName=ogEmdTemperatureName, ogWebUserStartTime=ogWebUserStartTime, PYSNMP_MODULE_ID=ogStatus2, ogCellModemIndex=ogCellModemIndex, ogCellMessageNotification=ogCellMessageNotification, ogCheckResolveActions=ogCheckResolveActions, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialUserTable=ogSerialUserTable, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityName=ogEmdHumidityName, ogSystem=ogSystem, ogRpcTable=ogRpcTable, ogRpcIndex=ogRpcIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmType=ogAlarmType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortDataBits=ogSerialPortDataBits, ogCellTowerNotification=ogCellTowerNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarm=ogAlarm, ogUpsConnectType=ogUpsConnectType, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostServicePort=ogHostServicePort, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserTable=ogHostUserTable, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemTable=ogCellModemTable, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmState=ogAlarmState, ogWifiClientTable=ogWifiClientTable, ogSerialUserName=ogSerialUserName, ogEmdTable=ogEmdTable, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientTable=ogWifiApClientTable, ogHostIndex=ogHostIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogAlarmEventId=ogAlarmEventId, ogCurrentAlarmType=ogCurrentAlarmType)
