...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostIpV4Address=ogHostIpV4Address, ogCellModemSessionTime=ogCellModemSessionTime, ogHostServiceTable=ogHostServiceTable, ogSerialUserPort=ogSerialUserPort, ogCellSignalNotification=ogCellSignalNotification, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogFirmwareVersion=ogFirmwareVersion, ogEmdDioType=ogEmdDioType, ogNetInterfaceState=ogNetInterfaceState, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletState=ogRpcOutletState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSystem=ogSystem, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcInputNotification=ogRpcInputNotification, ogUpsDescription=ogUpsDescription, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialUserNotification=ogSerialUserNotification, ogWebUserStartTime=ogWebUserStartTime, ogAlarmTime=ogAlarmTime, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientIndex=ogWifiClientIndex, ogEmdDioIndex=ogEmdDioIndex, ogEmdEnabled=ogEmdEnabled, ogSerialPortIndex=ogSerialPortIndex, ogRpcIndex=ogRpcIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmType=ogAlarmType, ogWifiApEntry=ogWifiApEntry, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServiceType=ogHostServiceType, ogCellModemTable=ogCellModemTable, ogEmdDioNotification=ogEmdDioNotification, ogEmdTemperatureValue=ogEmdTemperatureValue, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdIndex=ogEmdIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientCounter=ogWifiClientCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortTable=ogSerialPortTable, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsOutputNotification=ogUpsOutputNotification, ogHostUserHostName=ogHostUserHostName, ogCellModemApn=ogCellModemApn, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsNotification=ogUpsNotification, ogHostServicePort=ogHostServicePort, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientMac=ogWifiApClientMac, PYSNMP_MODULE_ID=ogStatus2, ogEmdLogEnabled=ogEmdLogEnabled, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialUserLabel=ogSerialUserLabel, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarm=ogAlarm, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmDevice=ogAlarmDevice, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdConnectType=ogEmdConnectType, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialUserName=ogSerialUserName, ogAlarmCheck=ogAlarmCheck, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostServiceIndex=ogHostServiceIndex, ogAlarmInstance=ogAlarmInstance, ogCellModemEnabled=ogCellModemEnabled, ogRpcInputFrequency=ogRpcInputFrequency, ogAlarmUser=ogAlarmUser, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsInputNotification=ogUpsInputNotification, ogRpcName=ogRpcName, ogCellModemIndex=ogCellModemIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdDioName=ogEmdDioName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortCTS=ogSerialPortCTS, ogStatus2Compliances=ogStatus2Compliances, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDescription=ogEmdDescription, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientTable=ogWifiClientTable, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmEventId=ogAlarmEventId, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsType=ogUpsType, ogWifiApTable=ogWifiApTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsName=ogUpsName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModemVendor=ogCellModemVendor, ogRpcOutputNotification=ogRpcOutputNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcOutletTable=ogRpcOutletTable, ogWifiApSsid=ogWifiApSsid, ogWebUserNotification=ogWebUserNotification, ogHostIpV6Address=ogHostIpV6Address, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcDescription=ogRpcDescription, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortDSR=ogSerialPortDSR, ogUpsEntry=ogUpsEntry, ogEmdDioTable=ogEmdDioTable, ogHostEntry=ogHostEntry, ogHostUserHost=ogHostUserHost, ogEmdTemperatureTable=ogEmdTemperatureTable, ogPowerSupplyName=ogPowerSupplyName, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsOutputPower=ogUpsOutputPower, ogUpsConnectType=ogUpsConnectType, ogSerialPortLabel=ogSerialPortLabel, ogSerialUserIndex=ogSerialUserIndex, ogRpcTable=ogRpcTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModemEntry=ogCellModemEntry, ogSerialPortParity=ogSerialPortParity, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcEntry=ogRpcEntry, ogCheckEntry=ogCheckEntry, ogCheckIndex=ogCheckIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckTable=ogCheckTable, ogRpcConnectType=ogRpcConnectType, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostServiceHost=ogHostServiceHost, ogWebUserEntry=ogWebUserEntry, ogHostServiceEntry=ogHostServiceEntry, ogRpcOutletEntry=ogRpcOutletEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyIndex=ogPowerSupplyIndex, ogHostServiceCounter=ogHostServiceCounter, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientTable=ogWifiApClientTable, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApIndex=ogWifiApIndex, ogWifiClientRssi=ogWifiClientRssi, ogSerialNumber=ogSerialNumber, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogStatus2Conformance=ogStatus2Conformance, ogHostUserAddress=ogHostUserAddress, ogWifiApEnabled=ogWifiApEnabled, ogHostIndex=ogHostIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostName=ogHostName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostServiceStatus=ogHostServiceStatus, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogUpsIndex=ogUpsIndex, ogWebUserName=ogWebUserName, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemTower=ogCellModemTower, ogCellModemConnected=ogCellModemConnected, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserName=ogHostUserName, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogNetInterfaceType=ogNetInterfaceType, ogRpcType=ogRpcType, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdName=ogEmdName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTable=ogEmdTable, ogCurrentAlarmState=ogCurrentAlarmState, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdDioDirection=ogEmdDioDirection, ogWifiApInterface=ogWifiApInterface, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdHumidityIndex=ogEmdHumidityIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmSummary=ogAlarmSummary, ogUpsTemperature=ogUpsTemperature, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdEntry=ogEmdEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputVoltage=ogUpsOutputVoltage, ogMibNotifications=ogMibNotifications, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletNotification=ogRpcOutletNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioState=ogEmdDioState, ogCheckName=ogCheckName, ogHostUserEntry=ogHostUserEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemCounter=ogCellModemCounter, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceIndex=ogCheckDeviceIndex, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmType=ogCurrentAlarmType, ogRpcInputCurrent=ogRpcInputCurrent, ogCellApnNotification=ogCellApnNotification, ogWifiClientMode=ogWifiClientMode, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcCounter=ogRpcCounter, ogSerialPortMode=ogSerialPortMode, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutletName=ogRpcOutletName, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostServiceNotification=ogHostServiceNotification, ogSerialPortDTR=ogSerialPortDTR, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCustomNotification=ogCustomNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogStatus2Groups=ogStatus2Groups, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientEssid=ogWifiClientEssid, ogHostTable=ogHostTable, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiClientInterface=ogWifiClientInterface, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryState=ogUpsBatteryState, ogUpsHumidity=ogUpsHumidity, ogWifiApTxPower=ogWifiApTxPower, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckType=ogCheckType, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserIndex=ogHostUserIndex, ogWebUserIndex=ogWebUserIndex, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmName=ogAlarmName, ogCellTowerNotification=ogCellTowerNotification, ogWebUserTable=ogWebUserTable, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostUserTable=ogHostUserTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsTable=ogUpsTable, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialSignalNotification=ogSerialSignalNotification, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsCounter=ogUpsCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientEntry=ogWifiClientEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogStatus2=ogStatus2, ogCellModemModel=ogCellModemModel, ogWifiApClientIndex=ogWifiApClientIndex, ogAlarmState=ogAlarmState, ogCellModemNetwork=ogCellModemNetwork, ogWifiApCounter=ogWifiApCounter, ogSerialPortEntry=ogSerialPortEntry, ogEmdDioEmd=ogEmdDioEmd, ogUpsState=ogUpsState, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortRTS=ogSerialPortRTS, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdDioCounter=ogEmdDioCounter, ogNetInterfaceTable=ogNetInterfaceTable)
