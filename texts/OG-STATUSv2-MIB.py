...
NotificationType, Bits, IpAddress, MibIdentifier, Counter64, ModuleIdentity, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, iso, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "IpAddress", "MibIdentifier", "Counter64", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "iso", "Gauge32", "Integer32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogStatus2Conformance=ogStatus2Conformance, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCheckIndex=ogCheckIndex, ogRpcName=ogRpcName, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortDTR=ogSerialPortDTR, ogAlarmLogTable=ogAlarmLogTable, ogHostName=ogHostName, ogRpcEntry=ogRpcEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellApnNotification=ogCellApnNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientRssi=ogWifiClientRssi, ogUpsTable=ogUpsTable, ogCellDataNotification=ogCellDataNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortLabel=ogSerialPortLabel, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdDescription=ogEmdDescription, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogRpcOutletTable=ogRpcOutletTable, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientTable=ogWifiApClientTable, ogUpsDescription=ogUpsDescription, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmName=ogAlarmName, ogCheckDeviceName=ogCheckDeviceName, ogWifiApSsid=ogWifiApSsid, ogHostTable=ogHostTable, ogUpsConnectType=ogUpsConnectType, ogStatus2Groups=ogStatus2Groups, ogCellModemIndex=ogCellModemIndex, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogUpsCounter=ogUpsCounter, ogCheckName=ogCheckName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsOutputPower=ogUpsOutputPower, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApEnabled=ogWifiApEnabled, ogHostServicePort=ogHostServicePort, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientCounter=ogWifiClientCounter, ogHostServiceStatus=ogHostServiceStatus, ogEmdTable=ogEmdTable, ogCellModemIMSI=ogCellModemIMSI, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmUser=ogAlarmUser, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmSummary=ogAlarmSummary, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsEntry=ogUpsEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostServiceEntry=ogHostServiceEntry, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialNumber=ogSerialNumber, ogUpsIndex=ogUpsIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdDioDescription=ogEmdDioDescription, ogNetInterfaceIndex=ogNetInterfaceIndex, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModem4gRssi=ogCellModem4gRssi, ogHostUserName=ogHostUserName, ogCellTowerNotification=ogCellTowerNotification, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceTable=ogHostServiceTable, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientIndex=ogWifiClientIndex, ogCellModemTower=ogCellModemTower, ogUpsOutputLoad=ogUpsOutputLoad, PYSNMP_MODULE_ID=ogStatus2, ogNetInterfaceType=ogNetInterfaceType, ogAlarmType=ogAlarmType, ogStatus2=ogStatus2, ogCellModemRegistered=ogCellModemRegistered, ogHostServiceNotification=ogHostServiceNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcDescription=ogRpcDescription, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogWifiApTable=ogWifiApTable, ogHostUserAddress=ogHostUserAddress, ogRpcIndex=ogRpcIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarm=ogAlarm, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialUserIndex=ogSerialUserIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletState=ogRpcOutletState, ogCellModemTable=ogCellModemTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostUserEntry=ogHostUserEntry, ogSerialPortDSR=ogSerialPortDSR, ogWebUserSourcePort=ogWebUserSourcePort, ogHostServiceHost=ogHostServiceHost, ogWebUserName=ogWebUserName, ogRpcTable=ogRpcTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortDCD=ogSerialPortDCD, ogEmdName=ogEmdName, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogBasicStatusGroup=ogBasicStatusGroup, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostIpV6Address=ogHostIpV6Address, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmTriggerValue=ogAlarmTriggerValue, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialPortTable=ogSerialPortTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientEssid=ogWifiClientEssid, ogCellModemCounter=ogCellModemCounter, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogMibNotifications=ogMibNotifications, ogCheckResolveActions=ogCheckResolveActions, ogEmdIndex=ogEmdIndex, ogUpsState=ogUpsState, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioType=ogEmdDioType, ogEmdDioState=ogEmdDioState, ogHostUserHostName=ogHostUserHostName, ogEmdConnectType=ogEmdConnectType, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientEntry=ogWifiClientEntry, ogEmdEntry=ogEmdEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostEntry=ogHostEntry, ogHostServiceType=ogHostServiceType, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellSignalNotification=ogCellSignalNotification, ogCellModemTemperature=ogCellModemTemperature, ogAlarmTime=ogAlarmTime, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckEntry=ogCheckEntry, ogWifiApClientMac=ogWifiApClientMac, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserHost=ogHostUserHost, ogEmdEnabled=ogEmdEnabled, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialUserPort=ogSerialUserPort, ogCellModemConnected=ogCellModemConnected, ogStatus2Compliances=ogStatus2Compliances, ogAlarmCurrentValue=ogAlarmCurrentValue, ogSerialPortMode=ogSerialPortMode, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWebUserTable=ogWebUserTable, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogNetInterfaceName=ogNetInterfaceName, ogWifiApInterface=ogWifiApInterface, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialUserName=ogSerialUserName, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcType=ogRpcType, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortEntry=ogSerialPortEntry, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemNetwork=ogCellModemNetwork, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsTemperature=ogUpsTemperature, ogUpsHumidity=ogUpsHumidity, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserTable=ogHostUserTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityName=ogEmdHumidityName, ogAlarmState=ogAlarmState, ogRpcInputVoltage=ogRpcInputVoltage, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsName=ogUpsName, ogAlarmInstance=ogAlarmInstance, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApFrequency=ogWifiApFrequency)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortRxBytes=ogSerialPortRxBytes, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioIndex=ogEmdDioIndex, ogCellModemModel=ogCellModemModel, ogUpsType=ogUpsType, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckTable=ogCheckTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortParity=ogSerialPortParity, ogAlarmCheck=ogAlarmCheck, ogEmdDioNotification=ogEmdDioNotification, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletName=ogRpcOutletName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioName=ogEmdDioName, ogEmdTemperatureName=ogEmdTemperatureName, ogWebUserIndex=ogWebUserIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogCustomNotification=ogCustomNotification, ogPowerSupplyName=ogPowerSupplyName, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortIndex=ogSerialPortIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsNotification=ogUpsNotification, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApIndex=ogWifiApIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApCounter=ogWifiApCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDioTable=ogEmdDioTable, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientMode=ogWifiClientMode, ogHostPingNotification=ogHostPingNotification, ogRpcCounter=ogRpcCounter, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogStatus2Compliance=ogStatus2Compliance, ogSystem=ogSystem, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApEntry=ogWifiApEntry, ogCellModemApn=ogCellModemApn, ogHostUserIndex=ogHostUserIndex, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWebUserStartTime=ogWebUserStartTime, ogNetInterfaceNotification=ogNetInterfaceNotification, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyTable=ogPowerSupplyTable, ogCheckType=ogCheckType, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortCTS=ogSerialPortCTS, ogUpsInputNotification=ogUpsInputNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWebUserEntry=ogWebUserEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostIndex=ogHostIndex, ogCellModemVendor=ogCellModemVendor, ogAlarmEventId=ogAlarmEventId, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemEntry=ogCellModemEntry, ogSerialUserTable=ogSerialUserTable)
