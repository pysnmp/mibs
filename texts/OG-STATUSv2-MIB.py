...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserSourcePort=ogWebUserSourcePort, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioDescription=ogEmdDioDescription, ogCellModemTemperature=ogCellModemTemperature, ogUpsTemperature=ogUpsTemperature, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostUserEntry=ogHostUserEntry, ogCellModemApn=ogCellModemApn, ogSerialPortDTR=ogSerialPortDTR, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletNotification=ogRpcOutletNotification, ogCellDataNotification=ogCellDataNotification, ogAlarmEventId=ogAlarmEventId, ogHostPingNotification=ogHostPingNotification, ogSerialNumber=ogSerialNumber, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemIMSI=ogCellModemIMSI, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityName=ogEmdHumidityName, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserNotification=ogWebUserNotification, ogEmdDescription=ogEmdDescription, ogAlarmInstance=ogAlarmInstance, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceState=ogNetInterfaceState, ogUpsOutputVoltage=ogUpsOutputVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientAp=ogWifiApClientAp, ogSerialUserPort=ogSerialUserPort, ogCellModemVendor=ogCellModemVendor, ogStatus2Groups=ogStatus2Groups, ogCellTowerNotification=ogCellTowerNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortParity=ogSerialPortParity, ogWifiClientApMac=ogWifiClientApMac, ogMibNotifications=ogMibNotifications, ogAlarmSummary=ogAlarmSummary, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdTemperatureValue=ogEmdTemperatureValue, ogRpcInputCurrent=ogRpcInputCurrent, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogHostServicePort=ogHostServicePort, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostUserAddress=ogHostUserAddress, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsDescription=ogUpsDescription, ogCellApnNotification=ogCellApnNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApCounter=ogWifiApCounter, ogHostServiceNotification=ogHostServiceNotification, ogStatus2Compliance=ogStatus2Compliance, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcDescription=ogRpcDescription, ogHostUserIndex=ogHostUserIndex, ogWebUserEntry=ogWebUserEntry, ogRpcEntry=ogRpcEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogUpsOutputPower=ogUpsOutputPower, ogWifiApSsid=ogWifiApSsid, ogCellModemIndex=ogCellModemIndex, ogCheckTable=ogCheckTable, ogSerialPortDCD=ogSerialPortDCD, ogCheckName=ogCheckName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostUserName=ogHostUserName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientBitRate=ogWifiClientBitRate, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogStatus2=ogStatus2, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckType=ogCheckType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostUserHostName=ogHostUserHostName, ogHostIndex=ogHostIndex, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApIndex=ogWifiApIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmUser=ogAlarmUser, ogRpcOutletIndex=ogRpcOutletIndex, ogCellModemConnected=ogCellModemConnected, ogCellModemEntry=ogCellModemEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcConnectType=ogRpcConnectType, ogEmdTable=ogEmdTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortEntry=ogSerialPortEntry, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceTable=ogHostServiceTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogHostServiceStatus=ogHostServiceStatus, ogHostEntry=ogHostEntry, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcIndex=ogRpcIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsName=ogUpsName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceCounter=ogHostServiceCounter, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApEnabled=ogWifiApEnabled, ogStatus2Compliances=ogStatus2Compliances, ogWifiApClientTable=ogWifiApClientTable, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostServiceEntry=ogHostServiceEntry, ogAlarmTime=ogAlarmTime, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckEntry=ogCheckEntry, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientMode=ogWifiClientMode, ogAlarm=ogAlarm, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogRpcOutletRpc=ogRpcOutletRpc, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPatternNotification=ogSerialPatternNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcCounter=ogRpcCounter, ogHostServiceType=ogHostServiceType, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdEntry=ogEmdEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcMaxTemperature=ogRpcMaxTemperature, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsEntry=ogUpsEntry, ogWifiApClientMac=ogWifiApClientMac, ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCellModemTable=ogCellModemTable, ogEmdName=ogEmdName, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostName=ogHostName, ogWifiApTable=ogWifiApTable, ogSystem=ogSystem, ogAlarmName=ogAlarmName, ogCellModemTower=ogCellModemTower, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortDSR=ogSerialPortDSR, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsInputNotification=ogUpsInputNotification, ogCellModemCounter=ogCellModemCounter, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogRpcOutletLoad=ogRpcOutletLoad, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialUserName=ogSerialUserName, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcOutletState=ogRpcOutletState, ogHostUserNotification=ogHostUserNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmDevice=ogAlarmDevice, ogNetInterfaceType=ogNetInterfaceType, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsIndex=ogUpsIndex, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCustomNotification=ogCustomNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcTable=ogRpcTable, ogCheckIndex=ogCheckIndex, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiApInterface=ogWifiApInterface, ogUpsTable=ogUpsTable, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortRTS=ogSerialPortRTS, ogRpcOutletTotal=ogRpcOutletTotal, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApEntry=ogWifiApEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortMode=ogSerialPortMode, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckDeviceName=ogCheckDeviceName, ogHostServiceHost=ogHostServiceHost, ogSerialUserIndex=ogSerialUserIndex, ogStatus2Conformance=ogStatus2Conformance, ogUpsCounter=ogUpsCounter, ogUpsNotification=ogUpsNotification, ogEmdDioEmd=ogEmdDioEmd, ogHostUserHost=ogHostUserHost, ogHostTable=ogHostTable)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmLogTable=ogAlarmLogTable, ogSerialUserTable=ogSerialUserTable, ogRpcOutletName=ogRpcOutletName, ogAlarmType=ogAlarmType, ogSerialUserLabel=ogSerialUserLabel, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioIndex=ogEmdDioIndex, ogHostIpV6Address=ogHostIpV6Address, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioName=ogEmdDioName, ogAlarmCheck=ogAlarmCheck, ogEmdIndex=ogEmdIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioType=ogEmdDioType, ogCellSignalNotification=ogCellSignalNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellModemRegistered=ogCellModemRegistered, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellMessageNotification=ogCellMessageNotification, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutputNotification=ogRpcOutputNotification, ogAlarmState=ogAlarmState, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioState=ogEmdDioState, ogCellModemSessionTime=ogCellModemSessionTime, ogWifiClientRssi=ogWifiClientRssi, ogEmdDioTable=ogEmdDioTable, ogRpcOutletTable=ogRpcOutletTable, ogWebUserTable=ogWebUserTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiApIeeeMode=ogWifiApIeeeMode, ogNetInterfaceTable=ogNetInterfaceTable, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcName=ogRpcName, ogCheckTriggerActions=ogCheckTriggerActions, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientInterface=ogWifiClientInterface, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellModemModel=ogCellModemModel, ogUpsType=ogUpsType, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcType=ogRpcType, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserNotification=ogSerialUserNotification, ogWifiApFrequency=ogWifiApFrequency, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientEssid=ogWifiClientEssid, ogSerialPortTable=ogSerialPortTable, ogEmdEnabled=ogEmdEnabled, ogEmdDioEntry=ogEmdDioEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientTable=ogWifiClientTable, ogEmdConnectType=ogEmdConnectType, ogHostUserTable=ogHostUserTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWebUserStartTime=ogWebUserStartTime, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioCounter=ogEmdDioCounter, ogUpsState=ogUpsState, ogWebUserName=ogWebUserName, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmLogEntry=ogAlarmLogEntry)
