...
TimeTicks, NotificationType, Unsigned32, Gauge32, MibIdentifier, ModuleIdentity, Counter64, Integer32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Unsigned32", "Gauge32", "MibIdentifier", "ModuleIdentity", "Counter64", "Integer32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "iso", "Counter32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsTemperature=ogUpsTemperature, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceStatus=ogHostServiceStatus, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellNetworkNotification=ogCellNetworkNotification, ogHostUserHostName=ogHostUserHostName, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortSpeed=ogSerialPortSpeed, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioState=ogEmdDioState, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdTemperatureName=ogEmdTemperatureName, ogWebUserEntry=ogWebUserEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogNetInterfaceEntry=ogNetInterfaceEntry, ogAlarmName=ogAlarmName, ogAlarmState=ogAlarmState, ogAlarmSummary=ogAlarmSummary, ogHostEntry=ogHostEntry, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsState=ogUpsState, ogWifiApSsid=ogWifiApSsid, ogWifiClientEssid=ogWifiClientEssid, ogHostUserName=ogHostUserName, ogWifiApIndex=ogWifiApIndex, ogCellModemTable=ogCellModemTable, ogEmdDioDirection=ogEmdDioDirection, ogUpsCounter=ogUpsCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientMode=ogWifiClientMode, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogHostServiceCounter=ogHostServiceCounter, ogStatus2=ogStatus2, ogEmdHumidityName=ogEmdHumidityName, ogWifiApEntry=ogWifiApEntry, ogSerialPortDSR=ogSerialPortDSR, ogHostServiceHost=ogHostServiceHost, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemApn=ogCellModemApn, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemIMSI=ogCellModemIMSI, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModem3gRssi=ogCellModem3gRssi, ogRpcOutletRpc=ogRpcOutletRpc, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcLogEnabled=ogRpcLogEnabled, ogStatus2Groups=ogStatus2Groups, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioType=ogEmdDioType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckType=ogCheckType, ogRpcOutletState=ogRpcOutletState, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDescription=ogEmdDescription, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialUserName=ogSerialUserName, ogNetInterfaceName=ogNetInterfaceName, ogUpsNotification=ogUpsNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogPowerSupplyTable=ogPowerSupplyTable, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogAlarmTime=ogAlarmTime, ogAlarmInstance=ogAlarmInstance, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserTable=ogSerialUserTable, ogWebUserSourcePort=ogWebUserSourcePort, ogWebUserName=ogWebUserName, ogPowerSupplyName=ogPowerSupplyName, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDioEntry=ogEmdDioEntry, ogEmdDioName=ogEmdDioName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsName=ogUpsName, ogUpsInputVoltage=ogUpsInputVoltage, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialPortTable=ogSerialPortTable, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdIndex=ogEmdIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemNetwork=ogCellModemNetwork, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialPortIndex=ogSerialPortIndex, ogUpsEntry=ogUpsEntry, ogHostIpV6Address=ogHostIpV6Address, ogCheckTriggerActions=ogCheckTriggerActions, ogHostPingNotification=ogHostPingNotification, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmLogIndex=ogAlarmLogIndex, ogCheckIndex=ogCheckIndex, ogHostUserStartTime=ogHostUserStartTime, ogSerialUserLabel=ogSerialUserLabel, ogHostTable=ogHostTable, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemTower=ogCellModemTower, ogBasicStatusGroup=ogBasicStatusGroup, ogRpcIndex=ogRpcIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientCounter=ogWifiClientCounter, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcName=ogRpcName, ogCellModemIndex=ogCellModemIndex, ogSystem=ogSystem, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckDeviceRef=ogCheckDeviceRef, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientRssi=ogWifiClientRssi, ogSerialPortDTR=ogSerialPortDTR, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWebUserNotification=ogWebUserNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortParity=ogSerialPortParity, ogAlarmDevice=ogAlarmDevice, ogCellTowerNotification=ogCellTowerNotification, ogAlarmUser=ogAlarmUser, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPortCTS=ogSerialPortCTS, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemVendor=ogCellModemVendor, ogCellModem4gRssi=ogCellModem4gRssi, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostServiceIndex=ogHostServiceIndex, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcInputNotification=ogRpcInputNotification, ogAlarm=ogAlarm, ogWifiClientEnabled=ogWifiClientEnabled, ogHostName=ogHostName, ogHostUserIndex=ogHostUserIndex, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialNumber=ogSerialNumber, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcConnectType=ogRpcConnectType, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputPower=ogUpsOutputPower, ogUpsInputCurrent=ogUpsInputCurrent, ogCustomNotification=ogCustomNotification, ogRpcOutletTable=ogRpcOutletTable, ogRpcOutputNotification=ogRpcOutputNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiApEnabled=ogWifiApEnabled, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcOutletName=ogRpcOutletName, ogWifiClientApMac=ogWifiClientApMac, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserEntry=ogSerialUserEntry, ogHostUserTable=ogHostUserTable, ogRpcDescription=ogRpcDescription, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckResolveActions=ogCheckResolveActions, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckTable=ogCheckTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCheckEntry=ogCheckEntry, ogWifiApClientMac=ogWifiApClientMac, ogRpcType=ogRpcType, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioIndex=ogEmdDioIndex, ogSerialUserIndex=ogSerialUserIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostUserEntry=ogHostUserEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserStartTime=ogSerialUserStartTime, ogAlarmCheck=ogAlarmCheck, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioEmd=ogEmdDioEmd, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostServiceType=ogHostServiceType, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsType=ogUpsType, ogCellModemModel=ogCellModemModel, ogUpsDescription=ogUpsDescription, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemTemperature=ogCellModemTemperature, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortLabel=ogSerialPortLabel, ogUpsInputNotification=ogUpsInputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogAlarmLogTable=ogAlarmLogTable, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApTable=ogWifiApTable, ogWifiApInterface=ogWifiApInterface, ogEmdDioCounter=ogEmdDioCounter, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogFirmwareVersion=ogFirmwareVersion, ogEmdTable=ogEmdTable, ogUpsHumidity=ogUpsHumidity, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientEntry=ogWifiClientEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletNotification=ogRpcOutletNotification, ogWebUserTable=ogWebUserTable, ogEmdName=ogEmdName, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostUserHost=ogHostUserHost, ogUpsIndex=ogUpsIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostServiceEntry=ogHostServiceEntry, ogHostServiceTable=ogHostServiceTable, ogCellModemEntry=ogCellModemEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioDescription=ogEmdDioDescription, ogEmdEntry=ogEmdEntry, ogRpcEntry=ogRpcEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiClientIndex=ogWifiClientIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialUserPort=ogSerialUserPort, ogCellApnNotification=ogCellApnNotification, ogHostIndex=ogHostIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellSignalNotification=ogCellSignalNotification, ogCellModemConnected=ogCellModemConnected, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdEnabled=ogEmdEnabled, ogWifiApCounter=ogWifiApCounter, PYSNMP_MODULE_ID=ogStatus2, ogHostUserNotification=ogHostUserNotification, ogCellModemCounter=ogCellModemCounter, ogRpcTable=ogRpcTable, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsConnectType=ogUpsConnectType, ogHostServicePort=ogHostServicePort, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialPortMode=ogSerialPortMode, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityNotification=ogEmdHumidityNotification, ogMibNotifications=ogMibNotifications, ogUpsTable=ogUpsTable, ogAlarmEventId=ogAlarmEventId, ogEmdConnectType=ogEmdConnectType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioTable=ogEmdDioTable, ogCheckName=ogCheckName, ogWebUserIndex=ogWebUserIndex, ogRpcCounter=ogRpcCounter, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmType=ogAlarmType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientTable=ogWifiClientTable, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdTemperatureValue=ogEmdTemperatureValue, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostUserAddress=ogHostUserAddress, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemEnabled=ogCellModemEnabled)
