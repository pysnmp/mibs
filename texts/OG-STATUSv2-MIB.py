...
ModuleIdentity, MibIdentifier, TimeTicks, ObjectIdentity, Counter64, Counter32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, Unsigned32, iso, Integer32, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibIdentifier", "TimeTicks", "ObjectIdentity", "Counter64", "Counter32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "Unsigned32", "iso", "Integer32", "Gauge32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientEntry=ogWifiClientEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioTable=ogEmdDioTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientTxPower=ogWifiClientTxPower, ogCellModemTable=ogCellModemTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserPort=ogSerialUserPort, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckResolveActions=ogCheckResolveActions, ogUpsTemperature=ogUpsTemperature, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCheckEntry=ogCheckEntry, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientCounter=ogWifiClientCounter, ogStatus2Conformance=ogStatus2Conformance, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogStatus2=ogStatus2, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdIndex=ogEmdIndex, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletCurrent=ogRpcOutletCurrent, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioDirection=ogEmdDioDirection, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityName=ogEmdHumidityName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserName=ogHostUserName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellApnNotification=ogCellApnNotification, ogSerialUserEntry=ogSerialUserEntry, ogAlarmType=ogAlarmType, ogAlarmUser=ogAlarmUser, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioDescription=ogEmdDioDescription, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsIndex=ogUpsIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostIndex=ogHostIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogSerialPortLabel=ogSerialPortLabel, ogSerialNumber=ogSerialNumber, ogSerialUserTable=ogSerialUserTable, ogCellTowerNotification=ogCellTowerNotification, ogCustomNotification=ogCustomNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogAlarmSummary=ogAlarmSummary, ogHostServicePort=ogHostServicePort, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPortEntry=ogSerialPortEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApIndex=ogWifiApIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellSignalNotification=ogCellSignalNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogRpcInputNotification=ogRpcInputNotification, ogAlarmCheck=ogAlarmCheck, ogRpcType=ogRpcType, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsHumidity=ogUpsHumidity, ogHostUserEntry=ogHostUserEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcDescription=ogRpcDescription, ogWifiApTable=ogWifiApTable, ogHostUserHost=ogHostUserHost, ogCheckResetTimeout=ogCheckResetTimeout, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogMibNotifications=ogMibNotifications, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostServiceTable=ogHostServiceTable, ogRpcOutletName=ogRpcOutletName, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsOutputLoad=ogUpsOutputLoad, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioType=ogEmdDioType, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemCounter=ogCellModemCounter, ogCheckDeviceRef=ogCheckDeviceRef, ogAlarmDevice=ogAlarmDevice, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortMode=ogSerialPortMode, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdHumidityValue=ogEmdHumidityValue, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiClientEssid=ogWifiClientEssid, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortFlowControl=ogSerialPortFlowControl, ogPowerSupplyIndex=ogPowerSupplyIndex, ogPowerSupplyName=ogPowerSupplyName, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsState=ogUpsState, ogHostUserHostName=ogHostUserHostName, ogCheckType=ogCheckType, ogHostServiceCounter=ogHostServiceCounter, ogCellModemEnabled=ogCellModemEnabled, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckName=ogCheckName, ogEmdName=ogEmdName, ogEmdDescription=ogEmdDescription, ogHostServiceEntry=ogHostServiceEntry, ogHostUserAddress=ogHostUserAddress, ogRpcOutletTable=ogRpcOutletTable, ogWebUserStartTime=ogWebUserStartTime, ogWifiClientInterface=ogWifiClientInterface, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsConnectType=ogUpsConnectType, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckDeviceName=ogCheckDeviceName, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmEventId=ogAlarmEventId, ogCheckTable=ogCheckTable, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdTable=ogEmdTable, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellModem3gRssi=ogCellModem3gRssi, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcConnectType=ogRpcConnectType, ogUpsInputNotification=ogUpsInputNotification, ogWebUserNotification=ogWebUserNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, PYSNMP_MODULE_ID=ogStatus2, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcInputVoltage=ogRpcInputVoltage, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemConnected=ogCellModemConnected, ogAlarmInstance=ogAlarmInstance, ogSerialPortIndex=ogSerialPortIndex, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientMac=ogWifiApClientMac, ogWifiApEntry=ogWifiApEntry, ogWifiClientMode=ogWifiClientMode, ogSerialPortStopBits=ogSerialPortStopBits, ogHostServiceIndex=ogHostServiceIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialUserNotification=ogSerialUserNotification, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarm=ogAlarm, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserTable=ogWebUserTable, ogUpsTable=ogUpsTable, ogWifiApInterface=ogWifiApInterface, ogWifiApEnabled=ogWifiApEnabled, ogAlarmLogTable=ogAlarmLogTable, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdEntry=ogEmdEntry, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsNotification=ogUpsNotification, ogSystem=ogSystem, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemIndex=ogCellModemIndex, ogWifiApCounter=ogWifiApCounter, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcTable=ogRpcTable, ogHostServiceType=ogHostServiceType, ogSerialPortDTR=ogSerialPortDTR, ogUpsOutputPower=ogUpsOutputPower, ogUpsBatteryCharge=ogUpsBatteryCharge, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostPingNotification=ogHostPingNotification, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialUserIndex=ogSerialUserIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmState=ogAlarmState, ogNetInterfaceType=ogNetInterfaceType, ogRpcLogEnabled=ogRpcLogEnabled, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApSsid=ogWifiApSsid, ogUpsBatteryState=ogUpsBatteryState, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsOutputFrequency=ogUpsOutputFrequency, ogNetInterfaceState=ogNetInterfaceState, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWebUserName=ogWebUserName, ogAlarmTime=ogAlarmTime, ogCellModemModel=ogCellModemModel, ogEmdDioCounter=ogEmdDioCounter, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemTemperature=ogCellModemTemperature, ogCellModemEntry=ogCellModemEntry, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortTable=ogSerialPortTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostUserTable=ogHostUserTable, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioEntry=ogEmdDioEntry, ogUpsEntry=ogUpsEntry, ogWifiApTxPower=ogWifiApTxPower, ogWifiApFrequency=ogWifiApFrequency, ogHostTable=ogHostTable, ogRpcEntry=ogRpcEntry, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellMessageNotification=ogCellMessageNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsCounter=ogUpsCounter, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcCounter=ogRpcCounter, ogHostEntry=ogHostEntry, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogHostName=ogHostName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPortDSR=ogSerialPortDSR, ogRpcName=ogRpcName, ogEmdDioIndex=ogEmdDioIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdDioName=ogEmdDioName, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdEnabled=ogEmdEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmType=ogCurrentAlarmType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsDescription=ogUpsDescription, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdDioNotification=ogEmdDioNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmName=ogAlarmName, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemTower=ogCellModemTower, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioEmd=ogEmdDioEmd, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemVendor=ogCellModemVendor, ogWifiApClientAp=ogWifiApClientAp, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcIndex=ogRpcIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellDataNotification=ogCellDataNotification, ogUpsName=ogUpsName, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserIndex=ogHostUserIndex, ogHostUserNotification=ogHostUserNotification, ogHostServiceStatus=ogHostServiceStatus, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServiceHost=ogHostServiceHost, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortParity=ogSerialPortParity, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialUserName=ogSerialUserName, ogCheckIndex=ogCheckIndex, ogEmdConnectType=ogEmdConnectType, ogUpsType=ogUpsType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientTable=ogWifiClientTable, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioState=ogEmdDioState, ogStatus2Groups=ogStatus2Groups, ogCellModemApn=ogCellModemApn, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientIndex=ogWifiClientIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceNotification=ogHostServiceNotification, ogSerialUserLabel=ogSerialUserLabel)
