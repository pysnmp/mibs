...
ModuleIdentity, Integer32, Counter32, iso, Gauge32, Unsigned32, IpAddress, MibIdentifier, TimeTicks, ObjectIdentity, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "Counter32", "iso", "Gauge32", "Unsigned32", "IpAddress", "MibIdentifier", "TimeTicks", "ObjectIdentity", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientCounter=ogWifiClientCounter, ogBasicStatusGroup=ogBasicStatusGroup, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialUserTable=ogSerialUserTable, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogRpcEntry=ogRpcEntry, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmInstance=ogAlarmInstance, ogCheckDeviceEntry=ogCheckDeviceEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemTable=ogCellModemTable, ogWifiClientEssid=ogWifiClientEssid, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApClientAp=ogWifiApClientAp, ogWifiApTable=ogWifiApTable, ogAlarmTime=ogAlarmTime, ogEmdDioName=ogEmdDioName, ogEmdDioState=ogEmdDioState, ogUpsDescription=ogUpsDescription, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortEntry=ogSerialPortEntry, ogUpsNotification=ogUpsNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarm=ogAlarm, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientIndex=ogWifiClientIndex, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceEntry=ogHostServiceEntry, ogWebUserNotification=ogWebUserNotification, ogCellTowerNotification=ogCellTowerNotification, ogWifiApEntry=ogWifiApEntry, ogHostUserIndex=ogHostUserIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemTemperature=ogCellModemTemperature, ogAlarmSummary=ogAlarmSummary, ogWifiApIndex=ogWifiApIndex, ogEmdDioTable=ogEmdDioTable, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemIMSI=ogCellModemIMSI, ogUpsCounter=ogUpsCounter, ogSerialUserNotification=ogSerialUserNotification, ogCellModemNetwork=ogCellModemNetwork, ogAlarmTriggerValue=ogAlarmTriggerValue, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostName=ogHostName, ogCheckType=ogCheckType, ogCellSignalNotification=ogCellSignalNotification, ogHostUserHost=ogHostUserHost, ogAlarmEventId=ogAlarmEventId, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmName=ogAlarmName, ogCellModemVendor=ogCellModemVendor, ogHostUserName=ogHostUserName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsState=ogUpsState, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientApMac=ogWifiClientApMac, ogAlarmType=ogAlarmType, ogSerialPortDSR=ogSerialPortDSR, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApFrequency=ogWifiApFrequency, ogWebUserIndex=ogWebUserIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientMac=ogWifiApClientMac, ogEmdEntry=ogEmdEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogCheckDeviceName=ogCheckDeviceName, ogHostIndex=ogHostIndex, ogHostServiceCounter=ogHostServiceCounter, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortMode=ogSerialPortMode, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdDescription=ogEmdDescription, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemIndex=ogCellModemIndex, ogRpcOutletState=ogRpcOutletState, ogEmdDioIndex=ogEmdDioIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTable=ogEmdTable, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialUserLabel=ogSerialUserLabel, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogMibNotifications=ogMibNotifications, ogRpcName=ogRpcName, ogHostUserHostName=ogHostUserHostName, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortCTS=ogSerialPortCTS, ogUpsHumidity=ogUpsHumidity, ogUpsType=ogUpsType, ogStatus2Compliance=ogStatus2Compliance, ogEmdDioType=ogEmdDioType, ogRpcDescription=ogRpcDescription, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortTxBytes=ogSerialPortTxBytes, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogCellModemTower=ogCellModemTower, ogRpcType=ogRpcType, ogEmdConnectType=ogEmdConnectType, ogWifiClientMode=ogWifiClientMode, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialUserIndex=ogSerialUserIndex, ogRpcConnectType=ogRpcConnectType, ogWebUserStartTime=ogWebUserStartTime, ogWifiApInterface=ogWifiApInterface, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogCellMessageNotification=ogCellMessageNotification, ogRpcIndex=ogRpcIndex, ogStatus2Groups=ogStatus2Groups, ogCellModemRegistered=ogCellModemRegistered, ogCellModemCounter=ogCellModemCounter, ogUpsIndex=ogUpsIndex, ogHostTable=ogHostTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogAlarmLogEntry=ogAlarmLogEntry, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCheckIndex=ogCheckIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsTable=ogUpsTable, ogWifiApTxPower=ogWifiApTxPower, ogHostServicePort=ogHostServicePort, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortDCD=ogSerialPortDCD, ogWifiApSsid=ogWifiApSsid, ogEmdDioCounter=ogEmdDioCounter, ogEmdName=ogEmdName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletFrequency=ogRpcOutletFrequency, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellModemEntry=ogCellModemEntry, ogCustomNotification=ogCustomNotification, ogAlarmDevice=ogAlarmDevice, ogEmdIndex=ogEmdIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletTable=ogRpcOutletTable, ogCellModemConnected=ogCellModemConnected, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostServiceTable=ogHostServiceTable, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioDirection=ogEmdDioDirection, ogCellModemApn=ogCellModemApn, ogSerialPortLabel=ogSerialPortLabel, ogEmdLogEnabled=ogEmdLogEnabled, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogNetInterfaceType=ogNetInterfaceType, ogNetInterfaceState=ogNetInterfaceState, ogUpsLogEnabled=ogUpsLogEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogCellApnNotification=ogCellApnNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogSystem=ogSystem, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiApEnabled=ogWifiApEnabled, ogHostServiceStatus=ogHostServiceStatus, ogHostUserEntry=ogHostUserEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialNumber=ogSerialNumber, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletName=ogRpcOutletName, ogUpsTemperature=ogUpsTemperature, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApClientIndex=ogWifiApClientIndex, ogHostIpV4Address=ogHostIpV4Address, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdDioEmd=ogEmdDioEmd, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialUserPort=ogSerialUserPort, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcTable=ogRpcTable, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientRssi=ogWifiClientRssi, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserTable=ogWebUserTable, ogUpsName=ogUpsName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostUserAddress=ogHostUserAddress, ogEmdHumidityNotification=ogEmdHumidityNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmLogIndex=ogAlarmLogIndex, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserTable=ogHostUserTable, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckTable=ogCheckTable, ogRpcOutletVoltage=ogRpcOutletVoltage)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApCounter=ogWifiApCounter, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApAuthNotification=ogWifiApAuthNotification, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserName=ogSerialUserName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckEntry=ogCheckEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsInputNotification=ogUpsInputNotification, ogCellNetworkNotification=ogCellNetworkNotification, ogStatus2=ogStatus2, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellModemModel=ogCellModemModel, ogAlarmUser=ogAlarmUser, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortDTR=ogSerialPortDTR, ogWebUserEntry=ogWebUserEntry, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientTable=ogWifiClientTable, ogWebUserName=ogWebUserName, ogUpsConnectType=ogUpsConnectType, ogHostPingNotification=ogHostPingNotification, ogSerialPortDataBits=ogSerialPortDataBits, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmCheck=ogAlarmCheck, ogHostUserNotification=ogHostUserNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcCounter=ogRpcCounter, ogCellDataNotification=ogCellDataNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioDescription=ogEmdDioDescription, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientInterface=ogWifiClientInterface, ogRpcMaxTemperature=ogRpcMaxTemperature, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdEnabled=ogEmdEnabled, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyName=ogPowerSupplyName, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmPreviousValue=ogAlarmPreviousValue, ogHostEntry=ogHostEntry, ogUpsEntry=ogUpsEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostServiceType=ogHostServiceType, ogEmdTemperatureValue=ogEmdTemperatureValue, ogAlarmState=ogAlarmState, ogSerialPortTable=ogSerialPortTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientTable=ogWifiApClientTable, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdHumidityDescription=ogEmdHumidityDescription, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckName=ogCheckName, ogWifiApAssociationNotification=ogWifiApAssociationNotification)
