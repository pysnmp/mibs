...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckDeviceName=ogCheckDeviceName, ogStatus2Compliances=ogStatus2Compliances, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostServiceTable=ogHostServiceTable, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogNetInterfaceName=ogNetInterfaceName, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmUser=ogAlarmUser, ogEmdDescription=ogEmdDescription, ogSerialPortLabel=ogSerialPortLabel, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostIpV4Address=ogHostIpV4Address, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostUserStartTime=ogHostUserStartTime, ogWifiApInterface=ogWifiApInterface, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiClientEntry=ogWifiClientEntry, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsTemperature=ogUpsTemperature, ogRpcOutletRpc=ogRpcOutletRpc, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortBreaks=ogSerialPortBreaks, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogCheckType=ogCheckType, ogCheckEntry=ogCheckEntry, ogUpsName=ogUpsName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialSignalNotification=ogSerialSignalNotification, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdDioNotification=ogEmdDioNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserName=ogWebUserName, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemVendor=ogCellModemVendor, ogCellModemModel=ogCellModemModel, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortLogLevel=ogSerialPortLogLevel, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemCounter=ogCellModemCounter, ogWebUserTable=ogWebUserTable, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsEntry=ogUpsEntry, ogEmdDioDescription=ogEmdDioDescription, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsState=ogUpsState, ogUpsInputNotification=ogUpsInputNotification, ogAlarmSummary=ogAlarmSummary, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDioState=ogEmdDioState, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCustomNotification=ogCustomNotification, ogUpsOutputPower=ogUpsOutputPower, ogEmdDioDirection=ogEmdDioDirection, ogCellApnNotification=ogCellApnNotification, ogHostName=ogHostName, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarmType=ogAlarmType, ogSerialUserIndex=ogSerialUserIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsCounter=ogUpsCounter, ogCellModemTable=ogCellModemTable, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceType=ogNetInterfaceType, ogWifiClientEssid=ogWifiClientEssid, ogRpcTable=ogRpcTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortMode=ogSerialPortMode, ogHostUserAddress=ogHostUserAddress, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApIndex=ogWifiApIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApTable=ogWifiApTable, ogHostServiceHost=ogHostServiceHost, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioName=ogEmdDioName, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiClientInterface=ogWifiClientInterface, ogStatus2Compliance=ogStatus2Compliance, ogUpsConnectType=ogUpsConnectType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialPortEntry=ogSerialPortEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserTable=ogSerialUserTable, ogRpcConnectType=ogRpcConnectType, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiApTxPower=ogWifiApTxPower, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcOutletState=ogRpcOutletState, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogStatus2=ogStatus2, ogCheckIndex=ogCheckIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmDevice=ogAlarmDevice, ogAlarmInstance=ogAlarmInstance, ogSerialNumber=ogSerialNumber, ogRpcIndex=ogRpcIndex, ogSerialPortTable=ogSerialPortTable, ogWifiClientTxPower=ogWifiClientTxPower, ogCellTowerNotification=ogCellTowerNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserPort=ogSerialUserPort, ogHostServiceStatus=ogHostServiceStatus, ogHostTable=ogHostTable, ogWifiClientIndex=ogWifiClientIndex, ogAlarmName=ogAlarmName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApEntry=ogWifiApEntry, ogHostServicePort=ogHostServicePort, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcDescription=ogRpcDescription, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogRpcOutletTotal=ogRpcOutletTotal, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceCounter=ogHostServiceCounter, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellDataNotification=ogCellDataNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostIndex=ogHostIndex, ogCheckDeviceRef=ogCheckDeviceRef, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiApSsid=ogWifiApSsid, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortDCD=ogSerialPortDCD, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortRTS=ogSerialPortRTS, ogCellModemTower=ogCellModemTower, ogCellModemEntry=ogCellModemEntry, ogWebUserStartTime=ogWebUserStartTime, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogPowerSupplyName=ogPowerSupplyName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserIndex=ogWebUserIndex, ogRpcCounter=ogRpcCounter, ogRpcInputCurrent=ogRpcInputCurrent, ogAlarmCheck=ogAlarmCheck, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceState=ogNetInterfaceState, ogBasicStatusGroup=ogBasicStatusGroup, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApEnabled=ogWifiApEnabled, ogHostEntry=ogHostEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApFrequency=ogWifiApFrequency, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarm=ogAlarm, ogPowerSupplyTemperature=ogPowerSupplyTemperature, PYSNMP_MODULE_ID=ogStatus2, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostUserTable=ogHostUserTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientApMac=ogWifiClientApMac, ogUpsDescription=ogUpsDescription, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiApClientMac=ogWifiApClientMac, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialPortDSR=ogSerialPortDSR, ogUpsIndex=ogUpsIndex, ogEmdEntry=ogEmdEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogCellModemIndex=ogCellModemIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogCellModemConnected=ogCellModemConnected, ogHostUserNotification=ogHostUserNotification, ogCheckTriggerActions=ogCheckTriggerActions, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioCounter=ogEmdDioCounter, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcEntry=ogRpcEntry, ogWebUserNotification=ogWebUserNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarmState=ogAlarmState, ogEmdDioEmd=ogEmdDioEmd, ogUpsTable=ogUpsTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostServiceEntry=ogHostServiceEntry, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialUserNotification=ogSerialUserNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostPingNotification=ogHostPingNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceIndex=ogHostServiceIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogStatus2Conformance=ogStatus2Conformance, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcName=ogRpcName, ogEmdDioType=ogEmdDioType, ogRpcOutletName=ogRpcOutletName, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmEventId=ogAlarmEventId, ogSystem=ogSystem, ogRpcInputFrequency=ogRpcInputFrequency, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityName=ogEmdHumidityName, ogHostUserHost=ogHostUserHost, ogCellModemEnabled=ogCellModemEnabled, ogCheckName=ogCheckName, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostUserHostName=ogHostUserHostName, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemSessionTime=ogCellModemSessionTime, ogCheckResolveActions=ogCheckResolveActions, ogEmdDioTable=ogEmdDioTable, ogRpcOutletTable=ogRpcOutletTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdDioIndex=ogEmdDioIndex, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientMode=ogWifiClientMode, ogWifiApClientAp=ogWifiApClientAp, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTable=ogEmdTable, ogMibNotifications=ogMibNotifications, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmTime=ogAlarmTime, ogCheckDeviceTable=ogCheckDeviceTable, ogCheckTable=ogCheckTable, ogWifiClientRssi=ogWifiClientRssi, ogWebUserEntry=ogWebUserEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortDTR=ogSerialPortDTR, ogEmdIndex=ogEmdIndex, ogEmdConnectType=ogEmdConnectType, ogCellModemApn=ogCellModemApn, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialUserName=ogSerialUserName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostServiceType=ogHostServiceType, ogUpsHumidity=ogUpsHumidity, ogUpsNotification=ogUpsNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemTemperature=ogCellModemTemperature, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsType=ogUpsType, ogRpcType=ogRpcType, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortIndex=ogSerialPortIndex, ogSerialPortParity=ogSerialPortParity, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApCounter=ogWifiApCounter, ogHostUserIndex=ogHostUserIndex, ogEmdName=ogEmdName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserName=ogHostUserName, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmSummary=ogCurrentAlarmSummary)
