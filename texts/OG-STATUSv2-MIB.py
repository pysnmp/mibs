...
NotificationType, Counter64, TimeTicks, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, iso, ObjectIdentity, Bits, IpAddress, Unsigned32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "TimeTicks", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "iso", "ObjectIdentity", "Bits", "IpAddress", "Unsigned32", "Integer32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsTemperature=ogUpsTemperature, ogWifiApCounter=ogWifiApCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCheckIndex=ogCheckIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientTxPower=ogWifiClientTxPower, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCheckName=ogCheckName, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialUserTable=ogSerialUserTable, ogHostIndex=ogHostIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyName=ogPowerSupplyName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellModemConnected=ogCellModemConnected, ogRpcInputNotification=ogRpcInputNotification, ogRpcOutletName=ogRpcOutletName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmInstance=ogAlarmInstance, ogAlarmUser=ogAlarmUser, ogWifiClientMode=ogWifiClientMode, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemModel=ogCellModemModel, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellDataNotification=ogCellDataNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogRpcConnectType=ogRpcConnectType, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdDioState=ogEmdDioState, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdName=ogEmdName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostUserTable=ogHostUserTable, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceType=ogHostServiceType, ogCellSignalNotification=ogCellSignalNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogStatus2Compliance=ogStatus2Compliance, ogWebUserName=ogWebUserName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckEntry=ogCheckEntry, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortTable=ogSerialPortTable, ogEmdHumidityName=ogEmdHumidityName, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceEntry=ogHostServiceEntry, ogUpsDescription=ogUpsDescription, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogUpsConnectType=ogUpsConnectType, ogCellModemVendor=ogCellModemVendor, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioTable=ogEmdDioTable, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmType=ogCurrentAlarmType, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsEntry=ogUpsEntry, ogWebUserTable=ogWebUserTable, ogEmdDioDescription=ogEmdDioDescription, ogRpcCounter=ogRpcCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogHostUserName=ogHostUserName, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioName=ogEmdDioName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortFlowControl=ogSerialPortFlowControl, ogStatus2=ogStatus2, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmEventId=ogAlarmEventId, ogCellModemTower=ogCellModemTower, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioIndex=ogEmdDioIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCellModemApn=ogCellModemApn, ogEmdDioType=ogEmdDioType, ogRpcLogEnabled=ogRpcLogEnabled, ogCellTowerNotification=ogCellTowerNotification, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdEnabled=ogEmdEnabled, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialUserNotification=ogSerialUserNotification, ogWifiApTable=ogWifiApTable, ogRpcType=ogRpcType, ogSerialUserStartTime=ogSerialUserStartTime, ogNetInterfaceType=ogNetInterfaceType, ogHostUserEntry=ogHostUserEntry, ogSerialPortDTR=ogSerialPortDTR, ogWifiApClientMac=ogWifiApClientMac, PYSNMP_MODULE_ID=ogStatus2, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialUserName=ogSerialUserName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogHostUserIndex=ogHostUserIndex, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcOutletIndex=ogRpcOutletIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcDescription=ogRpcDescription, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApEntry=ogWifiApEntry, ogCellModemTemperature=ogCellModemTemperature, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserAddress=ogHostUserAddress, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogStatus2Compliances=ogStatus2Compliances, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSystem=ogSystem, ogSerialUserPort=ogSerialUserPort, ogSerialPortDCD=ogSerialPortDCD, ogWifiApClientTable=ogWifiApClientTable, ogHostEntry=ogHostEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostServiceNotification=ogHostServiceNotification, ogCheckTable=ogCheckTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostServicePort=ogHostServicePort, ogWebUserEntry=ogWebUserEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsIndex=ogUpsIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmDevice=ogAlarmDevice, ogSerialPortLabel=ogSerialPortLabel, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialUserEntry=ogSerialUserEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdConnectType=ogEmdConnectType, ogSerialUserIndex=ogSerialUserIndex, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceName=ogNetInterfaceName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCustomNotification=ogCustomNotification, ogEmdTable=ogEmdTable, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioEntry=ogEmdDioEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogHostUserHost=ogHostUserHost, ogStatus2Conformance=ogStatus2Conformance, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWifiApFrequency=ogWifiApFrequency, ogRpcEntry=ogRpcEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdHumidityIndex=ogEmdHumidityIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWifiApAuthNotification=ogWifiApAuthNotification, ogCellModemTable=ogCellModemTable, ogHostUserNotification=ogHostUserNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApTxPower=ogWifiApTxPower, ogRpcName=ogRpcName, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdEntry=ogEmdEntry, ogSerialPortRTS=ogSerialPortRTS, ogHostName=ogHostName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortIndex=ogSerialPortIndex, ogWifiApIndex=ogWifiApIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceHost=ogHostServiceHost, ogEmdIndex=ogEmdIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogUpsCounter=ogUpsCounter, ogCellNetworkNotification=ogCellNetworkNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsNotification=ogUpsNotification, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostUserStartTime=ogHostUserStartTime, ogRpcInputCurrent=ogRpcInputCurrent, ogHostTable=ogHostTable, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletTable=ogRpcOutletTable, ogCellApnNotification=ogCellApnNotification, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogHostServiceStatus=ogHostServiceStatus, ogHostServiceTable=ogHostServiceTable, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApSsid=ogWifiApSsid, ogRpcIndex=ogRpcIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogCheckDeviceName=ogCheckDeviceName, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialNumber=ogSerialNumber, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdDioEmd=ogEmdDioEmd, ogAlarmTime=ogAlarmTime, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWifiClientEssid=ogWifiClientEssid, ogCellModemIndex=ogCellModemIndex, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarm=ogAlarm, ogCheckDeviceCheck=ogCheckDeviceCheck, ogFirmwareVersion=ogFirmwareVersion, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmState=ogAlarmState, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialPortStopBits=ogSerialPortStopBits)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdHumidityNotification=ogEmdHumidityNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientTable=ogWifiClientTable, ogUpsType=ogUpsType, ogHostIpV6Address=ogHostIpV6Address, ogSerialPortEntry=ogSerialPortEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemEntry=ogCellModemEntry, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemCounter=ogCellModemCounter, ogCheckResolveActions=ogCheckResolveActions, ogCheckType=ogCheckType, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureName=ogEmdTemperatureName, ogWebUserStartTime=ogWebUserStartTime, ogMibNotifications=ogMibNotifications, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientApMac=ogWifiClientApMac, ogHostIpV4Address=ogHostIpV4Address, ogEmdDescription=ogEmdDescription, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsHumidity=ogUpsHumidity, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWebUserNotification=ogWebUserNotification, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioNotification=ogEmdDioNotification, ogAlarmSummary=ogAlarmSummary, ogUpsOutputCurrent=ogUpsOutputCurrent, ogStatus2Groups=ogStatus2Groups, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioDirection=ogEmdDioDirection, ogRpcInputVoltage=ogRpcInputVoltage, ogWebUserIndex=ogWebUserIndex, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostPingNotification=ogHostPingNotification, ogWifiApInterface=ogWifiApInterface, ogWifiClientCounter=ogWifiClientCounter, ogAlarmType=ogAlarmType, ogRpcOutletState=ogRpcOutletState, ogUpsName=ogUpsName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortParity=ogSerialPortParity, ogUpsBatteryState=ogUpsBatteryState, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortMode=ogSerialPortMode, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsState=ogUpsState, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientAp=ogWifiApClientAp, ogCellModemIMSI=ogCellModemIMSI, ogAlarmCheck=ogAlarmCheck, ogWifiClientEntry=ogWifiClientEntry, ogAlarmName=ogAlarmName, ogSerialPortDSR=ogSerialPortDSR, ogUpsTable=ogUpsTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcTable=ogRpcTable)
