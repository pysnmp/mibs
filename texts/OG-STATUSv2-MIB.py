...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmPreviousValue=ogAlarmPreviousValue, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdEnabled=ogEmdEnabled, ogHostServiceType=ogHostServiceType, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogAlarmType=ogAlarmType, ogWebUserNotification=ogWebUserNotification, ogNetInterfaceName=ogNetInterfaceName, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioDescription=ogEmdDioDescription, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostName=ogHostName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiClientRssi=ogWifiClientRssi, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdName=ogEmdName, ogCheckName=ogCheckName, ogSystem=ogSystem, ogRpcTable=ogRpcTable, ogRpcOutletNotification=ogRpcOutletNotification, ogCellModemCounter=ogCellModemCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientMode=ogWifiClientMode, ogWifiClientApMac=ogWifiClientApMac, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientCounter=ogWifiClientCounter, ogStatus2Compliance=ogStatus2Compliance, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortParity=ogSerialPortParity, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletTable=ogRpcOutletTable, ogHostServiceEntry=ogHostServiceEntry, ogAlarmCheck=ogAlarmCheck, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckDeviceCheck=ogCheckDeviceCheck, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputNotification=ogUpsOutputNotification, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyName=ogPowerSupplyName, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityTable=ogEmdHumidityTable, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsDescription=ogUpsDescription, ogWebUserEntry=ogWebUserEntry, ogEmdDescription=ogEmdDescription, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialUserName=ogSerialUserName, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdConnectType=ogEmdConnectType, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmState=ogAlarmState, ogAlarmInstance=ogAlarmInstance, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckType=ogCheckType, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsIndex=ogUpsIndex, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiApCounter=ogWifiApCounter, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApTable=ogWifiApTable, ogSerialNumber=ogSerialNumber, ogEmdEntry=ogEmdEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmName=ogAlarmName, ogWifiApClientTable=ogWifiApClientTable, ogHostIndex=ogHostIndex, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmDevice=ogAlarmDevice, ogRpcOutletFrequency=ogRpcOutletFrequency, ogHostEntry=ogHostEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogSerialUserEntry=ogSerialUserEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdDioIndex=ogEmdDioIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostServiceNotification=ogHostServiceNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdHumidityEmd=ogEmdHumidityEmd, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcCounter=ogRpcCounter, ogCellTowerNotification=ogCellTowerNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemTable=ogCellModemTable, ogUpsHumidity=ogUpsHumidity, PYSNMP_MODULE_ID=ogStatus2, ogSerialPortLabel=ogSerialPortLabel, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogStatus2Groups=ogStatus2Groups, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserAddress=ogHostUserAddress, ogHostTable=ogHostTable, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogEmdDioState=ogEmdDioState, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemEnabled=ogCellModemEnabled, ogFirmwareVersion=ogFirmwareVersion, ogBasicAlarmGroup=ogBasicAlarmGroup, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialUserTable=ogSerialUserTable, ogCheckIndex=ogCheckIndex, ogRpcType=ogRpcType, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientTable=ogWifiClientTable, ogEmdDioTable=ogEmdDioTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWebUserName=ogWebUserName, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientTxPower=ogWifiClientTxPower, ogHostPingNotification=ogHostPingNotification, ogCellModemEntry=ogCellModemEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemTower=ogCellModemTower, ogRpcIndex=ogRpcIndex, ogSerialPortDCD=ogSerialPortDCD, ogWifiApSsid=ogWifiApSsid, ogWifiClientIndex=ogWifiClientIndex, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceType=ogNetInterfaceType, ogAlarmCurrentValue=ogAlarmCurrentValue, ogMibNotifications=ogMibNotifications, ogUpsName=ogUpsName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsTable=ogUpsTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdHumidityValue=ogEmdHumidityValue, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsTemperature=ogUpsTemperature, ogSerialPortBreaks=ogSerialPortBreaks, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostUserName=ogHostUserName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcOutletState=ogRpcOutletState, ogWifiClientEssid=ogWifiClientEssid, ogCellModemApn=ogCellModemApn, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserPort=ogSerialUserPort, ogHostUserIndex=ogHostUserIndex, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWebUserTable=ogWebUserTable, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWebUserStartTime=ogWebUserStartTime, ogRpcEntry=ogRpcEntry, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortCTS=ogSerialPortCTS, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmLogTable=ogAlarmLogTable, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsState=ogUpsState, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemTemperature=ogCellModemTemperature, ogAlarmSummary=ogAlarmSummary, ogCellDataNotification=ogCellDataNotification, ogHostUserEntry=ogHostUserEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiApInterface=ogWifiApInterface, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialUserIndex=ogSerialUserIndex, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialUserNotification=ogSerialUserNotification, ogHostServiceTable=ogHostServiceTable, ogAlarmTime=ogAlarmTime, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortDSR=ogSerialPortDSR, ogWifiClientEntry=ogWifiClientEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApEntry=ogWifiApEntry, ogHostServiceHost=ogHostServiceHost, ogWifiApTxPower=ogWifiApTxPower, ogUpsInputNotification=ogUpsInputNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcDescription=ogRpcDescription, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckTable=ogCheckTable, ogHostIpV6Address=ogHostIpV6Address, ogUpsCounter=ogUpsCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApClientAp=ogWifiApClientAp, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcInputNotification=ogRpcInputNotification, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdIndex=ogEmdIndex, ogEmdDioType=ogEmdDioType, ogSerialPortDTR=ogSerialPortDTR, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogStatus2=ogStatus2, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortMode=ogSerialPortMode, ogCheckEntry=ogCheckEntry, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCellApnNotification=ogCellApnNotification, ogCellMessageNotification=ogCellMessageNotification, ogUpsConnectType=ogUpsConnectType, ogRpcOutletLoad=ogRpcOutletLoad, ogWifiApClientIndex=ogWifiApClientIndex, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioName=ogEmdDioName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogAlarmUser=ogAlarmUser, ogStatus2Compliances=ogStatus2Compliances, ogCellModemNetwork=ogCellModemNetwork)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDioEntry=ogEmdDioEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogAlarm=ogAlarm, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioCounter=ogEmdDioCounter, ogWifiApIndex=ogWifiApIndex, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdTable=ogEmdTable, ogUpsEntry=ogUpsEntry, ogWifiClientInterface=ogWifiClientInterface, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogNetInterfaceState=ogNetInterfaceState, ogWifiApEnabled=ogWifiApEnabled, ogSerialSignalNotification=ogSerialSignalNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputPower=ogUpsOutputPower, ogCellModemConnected=ogCellModemConnected, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortIndex=ogSerialPortIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDioDirection=ogEmdDioDirection, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserSourceAddress=ogWebUserSourceAddress, ogHostUserHost=ogHostUserHost, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckResetTimeout=ogCheckResetTimeout, ogAlarmEventId=ogAlarmEventId, ogPowerSupplyEntry=ogPowerSupplyEntry, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletTotal=ogRpcOutletTotal, ogWebUserIndex=ogWebUserIndex, ogUpsType=ogUpsType, ogStatus2Conformance=ogStatus2Conformance, ogHostServicePort=ogHostServicePort, ogSerialPortEntry=ogSerialPortEntry, ogCellModemModel=ogCellModemModel, ogWifiApClientRssi=ogWifiApClientRssi, ogCustomNotification=ogCustomNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortTable=ogSerialPortTable, ogHostServiceIndex=ogHostServiceIndex, ogRpcOutletName=ogRpcOutletName, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemIndex=ogCellModemIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserTable=ogHostUserTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsNotification=ogUpsNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogAlarmLogIndex=ogAlarmLogIndex, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortRTS=ogSerialPortRTS, ogRpcName=ogRpcName, ogRpcOutputNotification=ogRpcOutputNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcInputCurrent=ogRpcInputCurrent, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcConnectType=ogRpcConnectType, ogCellModemVendor=ogCellModemVendor)
