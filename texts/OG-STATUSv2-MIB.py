...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletName=ogRpcOutletName, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogCheckType=ogCheckType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdDioTable=ogEmdDioTable, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortTable=ogSerialPortTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWebUserName=ogWebUserName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCurrentAlarmTable=ogCurrentAlarmTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogCheckDeviceTable=ogCheckDeviceTable, ogWebUserNotification=ogWebUserNotification, ogRpcName=ogRpcName, ogAlarmState=ogAlarmState, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemTable=ogCellModemTable, ogUpsBatteryState=ogUpsBatteryState, ogCellModemTower=ogCellModemTower, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsIndex=ogUpsIndex, ogUpsOutputNotification=ogUpsOutputNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModemModel=ogCellModemModel, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCurrentAlarmName=ogCurrentAlarmName, ogWifiClientMode=ogWifiClientMode, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdEntry=ogEmdEntry, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityTable=ogEmdHumidityTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortDTR=ogSerialPortDTR, ogCustomNotification=ogCustomNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellDataNotification=ogCellDataNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortEntry=ogSerialPortEntry, ogWifiApFrequency=ogWifiApFrequency, ogSerialPortIndex=ogSerialPortIndex, ogRpcIndex=ogRpcIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogHostServiceTable=ogHostServiceTable, ogCellApnNotification=ogCellApnNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcInputNotification=ogRpcInputNotification, ogEmdDioEmd=ogEmdDioEmd, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortLabel=ogSerialPortLabel, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortMode=ogSerialPortMode, ogNetInterfaceType=ogNetInterfaceType, ogRpcCounter=ogRpcCounter, ogHostUserEntry=ogHostUserEntry, ogWifiClientTable=ogWifiClientTable, ogSerialPortCTS=ogSerialPortCTS, ogCellModemConnected=ogCellModemConnected, ogAlarmUser=ogAlarmUser, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcConnectType=ogRpcConnectType, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortRTS=ogSerialPortRTS, ogCellModemApn=ogCellModemApn, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsHumidity=ogUpsHumidity, ogEmdDioState=ogEmdDioState, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogEmdEnabled=ogEmdEnabled, ogNetInterfaceState=ogNetInterfaceState, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsName=ogUpsName, ogRpcOutletState=ogRpcOutletState, ogSerialUserEntry=ogSerialUserEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogAlarmTime=ogAlarmTime, ogWifiApClientMac=ogWifiApClientMac, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityDescription=ogEmdHumidityDescription, ogAlarm=ogAlarm, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientInterface=ogWifiClientInterface, ogWifiClientEntry=ogWifiClientEntry, ogCheckName=ogCheckName, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmLogIndex=ogAlarmLogIndex, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialUserPort=ogSerialUserPort, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogSystem=ogSystem, ogEmdDioDescription=ogEmdDioDescription, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsState=ogUpsState, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsLogEnabled=ogUpsLogEnabled, ogCellModemRegistered=ogCellModemRegistered, ogEmdTable=ogEmdTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialUserStartTime=ogSerialUserStartTime, ogCellTowerNotification=ogCellTowerNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCheckDeviceName=ogCheckDeviceName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcType=ogRpcType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortDSR=ogSerialPortDSR, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiApInterface=ogWifiApInterface, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogHostUserHostName=ogHostUserHostName, ogEmdHumidityValue=ogEmdHumidityValue, ogHostIpV4Address=ogHostIpV4Address, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsNotification=ogUpsNotification, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientRssi=ogWifiApClientRssi, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientCounter=ogWifiClientCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceStatus=ogHostServiceStatus, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserEntry=ogWebUserEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogAlarmName=ogAlarmName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostUserTable=ogHostUserTable, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsEntry=ogUpsEntry, ogWebUserTable=ogWebUserTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityTotal=ogEmdHumidityTotal, ogHostServiceHost=ogHostServiceHost, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmState=ogCurrentAlarmState, ogRpcDescription=ogRpcDescription, ogAlarmCurrentValue=ogAlarmCurrentValue, ogStatus2Compliance=ogStatus2Compliance, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogHostServiceIndex=ogHostServiceIndex, ogEmdDioEntry=ogEmdDioEntry, ogEmdDioName=ogEmdDioName, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientTable=ogWifiApClientTable, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmSummary=ogAlarmSummary, ogSerialPortDCD=ogSerialPortDCD, ogWifiApTable=ogWifiApTable, ogAlarmType=ogAlarmType, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemSessionTime=ogCellModemSessionTime, ogPowerSupplyName=ogPowerSupplyName, ogStatus2Compliances=ogStatus2Compliances, ogEmdName=ogEmdName, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioNotification=ogEmdDioNotification, PYSNMP_MODULE_ID=ogStatus2, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortParity=ogSerialPortParity, ogHostUserAddress=ogHostUserAddress, ogCheckTriggerActions=ogCheckTriggerActions, ogHostIndex=ogHostIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmDevice=ogAlarmDevice, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceEntry=ogHostServiceEntry, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWebUserIndex=ogWebUserIndex, ogCheckTable=ogCheckTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogSerialUserTable=ogSerialUserTable, ogAlarmCheck=ogAlarmCheck, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogStatus2=ogStatus2, ogStatus2Conformance=ogStatus2Conformance, ogBasicNotificationGroup=ogBasicNotificationGroup, ogSerialUserName=ogSerialUserName, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientEssid=ogWifiClientEssid, ogFirmwareVersion=ogFirmwareVersion, ogEmdDioType=ogEmdDioType, ogUpsDescription=ogUpsDescription, ogWifiApClientAp=ogWifiApClientAp, ogHostName=ogHostName, ogStatus2Groups=ogStatus2Groups, ogWifiApSsid=ogWifiApSsid, ogHostServiceCounter=ogHostServiceCounter, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsType=ogUpsType, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemEnabled=ogCellModemEnabled, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckResolveActions=ogCheckResolveActions, ogUpsInputNotification=ogUpsInputNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialNumber=ogSerialNumber, ogSerialPortBreaks=ogSerialPortBreaks)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostTable=ogHostTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckIndex=ogCheckIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletTotal=ogRpcOutletTotal, ogCheckEntry=ogCheckEntry, ogWifiClientApMac=ogWifiClientApMac, ogHostEntry=ogHostEntry, ogHostUserHost=ogHostUserHost, ogRpcEntry=ogRpcEntry, ogWebUserStartTime=ogWebUserStartTime, ogUpsTable=ogUpsTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogAlarmLogEntry=ogAlarmLogEntry, ogAlarmInstance=ogAlarmInstance, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdConnectType=ogEmdConnectType, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcTable=ogRpcTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDescription=ogEmdDescription, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserName=ogHostUserName, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServicePort=ogHostServicePort, ogHostServiceType=ogHostServiceType, ogWebUserSourcePort=ogWebUserSourcePort, ogHostUserNotification=ogHostUserNotification, ogEmdDioDirection=ogEmdDioDirection, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityName=ogEmdHumidityName, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellMessageNotification=ogCellMessageNotification, ogHostServiceNotification=ogHostServiceNotification, ogCellModemNetwork=ogCellModemNetwork, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdTemperatureName=ogEmdTemperatureName, ogUpsCounter=ogUpsCounter, ogCellNetworkNotification=ogCellNetworkNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsOutputPower=ogUpsOutputPower, ogCellModemVendor=ogCellModemVendor, ogWifiApCounter=ogWifiApCounter, ogCellModemCounter=ogCellModemCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogNetInterfaceTable=ogNetInterfaceTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientRssi=ogWifiClientRssi, ogEmdIndex=ogEmdIndex, ogMibNotifications=ogMibNotifications, ogHostIpV6Address=ogHostIpV6Address, ogWifiApEntry=ogWifiApEntry, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcInputFrequency=ogRpcInputFrequency, ogCheckResetTimeout=ogCheckResetTimeout)
