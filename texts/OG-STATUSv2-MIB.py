...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdEnabled=ogEmdEnabled, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellApnNotification=ogCellApnNotification, ogWifiApCounter=ogWifiApCounter, ogWebUserIndex=ogWebUserIndex, ogSerialPortRTS=ogSerialPortRTS, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApTable=ogWifiApTable, ogWifiApSsid=ogWifiApSsid, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemIndex=ogCellModemIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientCounter=ogWifiClientCounter, ogSerialPatternNotification=ogSerialPatternNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemVendor=ogCellModemVendor, ogHostTable=ogHostTable, ogCheckDeviceName=ogCheckDeviceName, ogUpsInputNotification=ogUpsInputNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApClientAp=ogWifiApClientAp, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellMessageNotification=ogCellMessageNotification, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcIndex=ogRpcIndex, ogAlarmEventId=ogAlarmEventId, ogWifiClientRssi=ogWifiClientRssi, ogWifiClientApMac=ogWifiClientApMac, ogCheckDeviceCheck=ogCheckDeviceCheck, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdDioEmd=ogEmdDioEmd, ogWifiApIndex=ogWifiApIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogMibNotifications=ogMibNotifications, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCellDataNotification=ogCellDataNotification, ogWebUserEntry=ogWebUserEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsState=ogUpsState, ogCellSignalNotification=ogCellSignalNotification, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsCounter=ogUpsCounter, ogWifiApEnabled=ogWifiApEnabled, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdDioName=ogEmdDioName, ogRpcInputCurrent=ogRpcInputCurrent, ogCellModemApn=ogCellModemApn, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogUpsIndex=ogUpsIndex, ogUpsTable=ogUpsTable, ogHostServiceType=ogHostServiceType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortIndex=ogSerialPortIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsType=ogUpsType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemCounter=ogCellModemCounter, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApClientIndex=ogWifiApClientIndex, ogCheckType=ogCheckType, ogAlarmName=ogAlarmName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemTable=ogCellModemTable, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserHost=ogHostUserHost, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioType=ogEmdDioType, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdHumidityName=ogEmdHumidityName, ogSerialPortDataBits=ogSerialPortDataBits, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsNotification=ogUpsNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialUserIndex=ogSerialUserIndex, ogWebUserName=ogWebUserName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdTable=ogEmdTable, ogNetInterfaceType=ogNetInterfaceType, ogCheckResetTimeout=ogCheckResetTimeout, ogNetInterfaceState=ogNetInterfaceState, ogCellModemModel=ogCellModemModel, ogSerialPortDTR=ogSerialPortDTR, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCellTowerNotification=ogCellTowerNotification, ogCellModemRegistered=ogCellModemRegistered, ogAlarmState=ogAlarmState, ogEmdDioTable=ogEmdDioTable, ogWifiClientEssid=ogWifiClientEssid, ogHostServiceCounter=ogHostServiceCounter, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogPowerSupplyTable=ogPowerSupplyTable, ogHostUserStartTime=ogHostUserStartTime, ogSerialPortParityErrors=ogSerialPortParityErrors, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApInterface=ogWifiApInterface, ogRpcOutletName=ogRpcOutletName, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCellModemTower=ogCellModemTower, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputPower=ogUpsOutputPower, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialPortLogLevel=ogSerialPortLogLevel, ogAlarmInstance=ogAlarmInstance, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcOutletState=ogRpcOutletState, ogCellModemConnected=ogCellModemConnected, ogSerialUserName=ogSerialUserName, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserStartTime=ogWebUserStartTime, ogStatus2Groups=ogStatus2Groups, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostServiceTable=ogHostServiceTable, ogEmdConnectType=ogEmdConnectType, ogWebUserTable=ogWebUserTable, ogWifiClientMode=ogWifiClientMode, ogEmdDioIndex=ogEmdDioIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsDescription=ogUpsDescription, ogWifiApClientRssi=ogWifiApClientRssi, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserNotification=ogHostUserNotification, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiApEntry=ogWifiApEntry, ogRpcCounter=ogRpcCounter, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWebUserNotification=ogWebUserNotification, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortTable=ogSerialPortTable, ogHostEntry=ogHostEntry, ogAlarm=ogAlarm, ogCurrentAlarmTime=ogCurrentAlarmTime, ogUpsBatteryState=ogUpsBatteryState, ogRpcType=ogRpcType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutletTable=ogRpcOutletTable, ogHostUserHostName=ogHostUserHostName, ogHostIpV4Address=ogHostIpV4Address, ogHostServicePort=ogHostServicePort, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserIndex=ogHostUserIndex, ogSerialNumber=ogSerialNumber, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogStatus2Conformance=ogStatus2Conformance, ogRpcName=ogRpcName, ogEmdDescription=ogEmdDescription, ogPowerSupplyName=ogPowerSupplyName, ogFirmwareVersion=ogFirmwareVersion, ogCurrentAlarmName=ogCurrentAlarmName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsEntry=ogUpsEntry, ogEmdDioState=ogEmdDioState, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckEntry=ogCheckEntry, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckIndex=ogCheckIndex, ogAlarmCheck=ogAlarmCheck, ogWifiApClientMac=ogWifiApClientMac, ogNetInterfaceName=ogNetInterfaceName, ogSerialUserLabel=ogSerialUserLabel, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdName=ogEmdName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogCellModemEntry=ogCellModemEntry, ogHostName=ogHostName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostIndex=ogHostIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSystem=ogSystem, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdHumidityCounter=ogEmdHumidityCounter, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogStatus2Compliance=ogStatus2Compliance, ogSerialPortParity=ogSerialPortParity, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialPortCTS=ogSerialPortCTS, ogRpcDescription=ogRpcDescription, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcInputNotification=ogRpcInputNotification, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdEntry=ogEmdEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsTemperature=ogUpsTemperature, ogStatus2=ogStatus2, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialPortMode=ogSerialPortMode, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceHost=ogHostServiceHost, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdIndex=ogEmdIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsOutputLoad=ogUpsOutputLoad)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmDevice=ogAlarmDevice, ogUpsConnectType=ogUpsConnectType, ogCellModemNetwork=ogCellModemNetwork, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiApTxPower=ogWifiApTxPower, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcConnectType=ogRpcConnectType, ogHostUserEntry=ogHostUserEntry, ogCustomNotification=ogCustomNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogRpcInputVoltage=ogRpcInputVoltage, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserTable=ogSerialUserTable, ogRpcOutletTotal=ogRpcOutletTotal, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsName=ogUpsName, ogHostServiceStatus=ogHostServiceStatus, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioDescription=ogEmdDioDescription, ogRpcEntry=ogRpcEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogAlarmLogTable=ogAlarmLogTable, ogRpcTable=ogRpcTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogHostUserName=ogHostUserName, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogHostUserTable=ogHostUserTable, ogSerialPortDCD=ogSerialPortDCD, ogCheckTable=ogCheckTable, ogAlarmType=ogAlarmType, ogSerialPortEntry=ogSerialPortEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioDirection=ogEmdDioDirection, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceTable=ogCheckDeviceTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientIndex=ogWifiClientIndex, ogSerialUserPort=ogSerialUserPort, ogSerialUserEntry=ogSerialUserEntry, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmTime=ogAlarmTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientBitRate=ogWifiClientBitRate, ogAlarmUser=ogAlarmUser, ogSerialPortDSR=ogSerialPortDSR, ogHostPingNotification=ogHostPingNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortLabel=ogSerialPortLabel, ogCheckName=ogCheckName, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmSummary=ogAlarmSummary, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiApFrequency=ogWifiApFrequency, ogCellModemEnabled=ogCellModemEnabled)
