...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletState=ogRpcOutletState, ogRpcOutletTable=ogRpcOutletTable, ogHostIpV6Address=ogHostIpV6Address, ogHostServiceType=ogHostServiceType, ogAlarmLogTable=ogAlarmLogTable, ogHostIndex=ogHostIndex, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientIndex=ogWifiClientIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogRpcEntry=ogRpcEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdEnabled=ogEmdEnabled, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogSerialPortTable=ogSerialPortTable, ogCheckDeviceTable=ogCheckDeviceTable, ogHostName=ogHostName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortDTR=ogSerialPortDTR, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsEntry=ogUpsEntry, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsState=ogUpsState, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiApTxPower=ogWifiApTxPower, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortMode=ogSerialPortMode, ogEmdTable=ogEmdTable, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckTable=ogCheckTable, ogAlarmUser=ogAlarmUser, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcIndex=ogRpcIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemSessionTime=ogCellModemSessionTime, ogHostTable=ogHostTable, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogAlarmSummary=ogAlarmSummary, ogStatus2Groups=ogStatus2Groups, ogRpcType=ogRpcType, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiApEntry=ogWifiApEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogHostServiceCounter=ogHostServiceCounter, ogCheckTriggerActions=ogCheckTriggerActions, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogRpcOutputNotification=ogRpcOutputNotification, ogHostServiceStatus=ogHostServiceStatus, ogWifiApFrequency=ogWifiApFrequency, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserStartTime=ogWebUserStartTime, ogEmdDescription=ogEmdDescription, ogEmdHumidityCounter=ogEmdHumidityCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryState=ogUpsBatteryState, ogEmdName=ogEmdName, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientIndex=ogWifiApClientIndex, ogSerialNumber=ogSerialNumber, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCheckDeviceName=ogCheckDeviceName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserIndex=ogWebUserIndex, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientEntry=ogWifiClientEntry, ogSerialUserIndex=ogSerialUserIndex, ogAlarmTime=ogAlarmTime, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdHumidityName=ogEmdHumidityName, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdDioType=ogEmdDioType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogMibNotifications=ogMibNotifications, ogSerialPortDCD=ogSerialPortDCD, ogUpsDescription=ogUpsDescription, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemEntry=ogCellModemEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmInstance=ogAlarmInstance, ogUpsInputFrequency=ogUpsInputFrequency, ogUpsIndex=ogUpsIndex, ogHostServiceIndex=ogHostServiceIndex, ogUpsOutputPower=ogUpsOutputPower, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletEntry=ogRpcOutletEntry, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortEntry=ogSerialPortEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceName=ogNetInterfaceName, ogAlarmState=ogAlarmState, ogStatus2Compliance=ogStatus2Compliance, ogEmdEntry=ogEmdEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogHostUserEntry=ogHostUserEntry, ogWifiApTable=ogWifiApTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCurrentAlarmName=ogCurrentAlarmName, ogSystem=ogSystem, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialUserPort=ogSerialUserPort, ogCheckName=ogCheckName, ogCellModemVendor=ogCellModemVendor, ogWebUserTable=ogWebUserTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCustomNotification=ogCustomNotification, ogSerialUserName=ogSerialUserName, ogAlarmName=ogAlarmName, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioCounter=ogEmdDioCounter, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemNetwork=ogCellModemNetwork, ogWebUserEntry=ogWebUserEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogNetInterfaceType=ogNetInterfaceType, ogAlarmDevice=ogAlarmDevice, ogHostUserHost=ogHostUserHost, ogCheckType=ogCheckType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserName=ogWebUserName, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsHumidity=ogUpsHumidity, ogSerialPortParity=ogSerialPortParity, ogWifiApClientMac=ogWifiApClientMac, ogHostUserAddress=ogHostUserAddress, ogRpcCounter=ogRpcCounter, ogWifiApClientAp=ogWifiApClientAp, ogCellModemModel=ogCellModemModel, ogCurrentAlarmState=ogCurrentAlarmState, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsType=ogUpsType, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmType=ogAlarmType, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdConnectType=ogEmdConnectType, ogRpcTable=ogRpcTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientInterface=ogWifiClientInterface, ogWifiApInterface=ogWifiApInterface, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmEventId=ogAlarmEventId, ogRpcOutletIndex=ogRpcOutletIndex, ogRpcConnectType=ogRpcConnectType, ogSerialPortRTS=ogSerialPortRTS, ogStatus2Compliances=ogStatus2Compliances, ogWifiApEnabled=ogWifiApEnabled, ogHostPingNotification=ogHostPingNotification, ogCellDataNotification=ogCellDataNotification, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogHostUserTable=ogHostUserTable, ogWifiApSsid=ogWifiApSsid, ogSerialPortFlowControl=ogSerialPortFlowControl, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostServiceHost=ogHostServiceHost, ogAlarmTriggerValue=ogAlarmTriggerValue, ogSerialUserLabel=ogSerialUserLabel, ogHostUserHostName=ogHostUserHostName, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdDioNotification=ogEmdDioNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsOutputLoad=ogUpsOutputLoad, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiClientApMac=ogWifiClientApMac, ogUpsName=ogUpsName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsCounter=ogUpsCounter, ogHostServiceEntry=ogHostServiceEntry, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcName=ogRpcName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemApn=ogCellModemApn, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdHumidityEntry=ogEmdHumidityEntry, ogWebUserNotification=ogWebUserNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemEnabled=ogCellModemEnabled, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortDSR=ogSerialPortDSR, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApCounter=ogWifiApCounter, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostIpV4Address=ogHostIpV4Address, ogCellModemIndex=ogCellModemIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCheckResetTimeout=ogCheckResetTimeout, ogPowerSupplyName=ogPowerSupplyName, ogEmdHumidityValue=ogEmdHumidityValue, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortCTS=ogSerialPortCTS, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsConnectType=ogUpsConnectType, ogCellModemTower=ogCellModemTower, ogNetInterfaceNotification=ogNetInterfaceNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputNotification=ogUpsOutputNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApIndex=ogWifiApIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogFirmwareVersion=ogFirmwareVersion, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemRegistered=ogCellModemRegistered, ogAlarm=ogAlarm, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortIndex=ogSerialPortIndex, ogCheckIndex=ogCheckIndex, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserIndex=ogHostUserIndex, ogSerialPortParityErrors=ogSerialPortParityErrors, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientMode=ogWifiClientMode, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostServiceTable=ogHostServiceTable, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogStatus2=ogStatus2, ogEmdIndex=ogEmdIndex, ogEmdDioState=ogEmdDioState, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiClientEssid=ogWifiClientEssid, ogCellModemIMSI=ogCellModemIMSI, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiClientCounter=ogWifiClientCounter, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsInputNotification=ogUpsInputNotification, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsNotification=ogUpsNotification, ogEmdDioDirection=ogEmdDioDirection, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortRxBytes=ogSerialPortRxBytes, ogRpcInputCurrent=ogRpcInputCurrent, ogHostUserName=ogHostUserName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortLabel=ogSerialPortLabel, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientRssi=ogWifiClientRssi, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellTowerNotification=ogCellTowerNotification, ogRpcDescription=ogRpcDescription, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellApnNotification=ogCellApnNotification, ogUpsTable=ogUpsTable, ogCellModemTable=ogCellModemTable, ogCellModemCounter=ogCellModemCounter, ogCheckEntry=ogCheckEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellModemConnected=ogCellModemConnected, ogRpcOutletName=ogRpcOutletName, ogEmdDioIndex=ogEmdDioIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogRpcOutletFrequency=ogRpcOutletFrequency, ogNetInterfaceState=ogNetInterfaceState, ogHostEntry=ogHostEntry, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServicePort=ogHostServicePort, ogHostServiceNotification=ogHostServiceNotification, ogEmdDioName=ogEmdDioName, ogAlarmCheck=ogAlarmCheck, ogWifiClientTable=ogWifiClientTable)
