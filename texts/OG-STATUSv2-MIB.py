...
ModuleIdentity, ObjectIdentity, iso, Unsigned32, Counter64, Gauge32, IpAddress, MibIdentifier, Bits, NotificationType, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "iso", "Unsigned32", "Counter64", "Gauge32", "IpAddress", "MibIdentifier", "Bits", "NotificationType", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogEmdDioTable=ogEmdDioTable, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortFlowControl=ogSerialPortFlowControl, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellSignalNotification=ogCellSignalNotification, ogStatus2Groups=ogStatus2Groups, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortDCD=ogSerialPortDCD, ogCellModemIMSI=ogCellModemIMSI, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsTable=ogUpsTable, ogUpsLogEnabled=ogUpsLogEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcDescription=ogRpcDescription, ogCheckResolveActions=ogCheckResolveActions, ogAlarmLogIndex=ogAlarmLogIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogUpsOutputLoad=ogUpsOutputLoad, ogAlarmCurrentValue=ogAlarmCurrentValue, ogStatus2=ogStatus2, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellDataNotification=ogCellDataNotification, ogAlarmTime=ogAlarmTime, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmInstance=ogAlarmInstance, ogAlarmCheck=ogAlarmCheck, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogEmdHumidityName=ogEmdHumidityName, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSerialUserIndex=ogSerialUserIndex, ogHostUserHostName=ogHostUserHostName, ogWifiClientInterface=ogWifiClientInterface, ogCheckName=ogCheckName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioDirection=ogEmdDioDirection, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsDescription=ogUpsDescription, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiApClientTable=ogWifiApClientTable, ogEmdLogEnabled=ogEmdLogEnabled, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortParity=ogSerialPortParity, ogRpcInputNotification=ogRpcInputNotification, ogCheckTable=ogCheckTable, ogNetInterfaceName=ogNetInterfaceName, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientIndex=ogWifiClientIndex, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemModel=ogCellModemModel, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortIndex=ogSerialPortIndex, ogCheckEntry=ogCheckEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogHostServiceIndex=ogHostServiceIndex, ogUpsName=ogUpsName, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialSignalNotification=ogSerialSignalNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServicePort=ogHostServicePort, ogUpsIndex=ogUpsIndex, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialUserPort=ogSerialUserPort, ogCellModemVendor=ogCellModemVendor, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiClientEnabled=ogWifiClientEnabled, ogHostUserStartTime=ogHostUserStartTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialNumber=ogSerialNumber, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiApInterface=ogWifiApInterface, ogUpsInputCurrent=ogUpsInputCurrent, ogHostServiceTable=ogHostServiceTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdEnabled=ogEmdEnabled, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialUserEntry=ogSerialUserEntry, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioEntry=ogEmdDioEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsEntry=ogUpsEntry, ogHostServiceEntry=ogHostServiceEntry, ogHostServiceStatus=ogHostServiceStatus, ogEmdHumidityTable=ogEmdHumidityTable, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogWifiClientRssi=ogWifiClientRssi, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdName=ogEmdName, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiApClientMac=ogWifiApClientMac, ogAlarmDevice=ogAlarmDevice, ogWebUserTable=ogWebUserTable, ogAlarm=ogAlarm, ogHostPingNotification=ogHostPingNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWebUserNotification=ogWebUserNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsTemperature=ogUpsTemperature, ogRpcCounter=ogRpcCounter, ogSerialUserLabel=ogSerialUserLabel, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDioNotification=ogEmdDioNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellApnNotification=ogCellApnNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientMode=ogWifiClientMode, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemEntry=ogCellModemEntry, ogCellModemCounter=ogCellModemCounter, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostName=ogHostName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogAlarmEventId=ogAlarmEventId, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdDioType=ogEmdDioType, ogHostUserNotification=ogHostUserNotification, ogEmdDioIndex=ogEmdDioIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcOutletName=ogRpcOutletName, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortRTS=ogSerialPortRTS, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckIndex=ogCheckIndex, ogWifiClientTable=ogWifiClientTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellMessageNotification=ogCellMessageNotification, ogAlarmState=ogAlarmState, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdIndex=ogEmdIndex, ogCustomNotification=ogCustomNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceName=ogCheckDeviceName, ogHostServiceCounter=ogHostServiceCounter, ogEmdDioCounter=ogEmdDioCounter, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcInputVoltage=ogRpcInputVoltage, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserName=ogWebUserName, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsCounter=ogUpsCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcName=ogRpcName, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostUserAddress=ogHostUserAddress, ogAlarmSummary=ogAlarmSummary, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApTxPower=ogWifiApTxPower, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserStartTime=ogSerialUserStartTime, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcOutletState=ogRpcOutletState, ogEmdEntry=ogEmdEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdDioEmd=ogEmdDioEmd, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostServiceHost=ogHostServiceHost, ogUpsOutputTruePower=ogUpsOutputTruePower, ogNetInterfaceType=ogNetInterfaceType, ogAlarmLogTable=ogAlarmLogTable, ogHostEntry=ogHostEntry, ogWifiApCounter=ogWifiApCounter, ogSerialPortLabel=ogSerialPortLabel, ogRpcTable=ogRpcTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserEntry=ogHostUserEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmLogEntry=ogAlarmLogEntry, ogHostIndex=ogHostIndex, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientCounter=ogWifiClientCounter, PYSNMP_MODULE_ID=ogStatus2, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCellModemNetwork=ogCellModemNetwork, ogUpsConnectType=ogUpsConnectType, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWifiApTable=ogWifiApTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogWifiApFrequency=ogWifiApFrequency, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientRssi=ogWifiApClientRssi, ogFirmwareVersion=ogFirmwareVersion, ogHostTable=ogHostTable, ogCellModemTable=ogCellModemTable, ogWifiApEnabled=ogWifiApEnabled, ogUpsState=ogUpsState, ogRpcIndex=ogRpcIndex, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientBitRate=ogWifiClientBitRate, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsInputNotification=ogUpsInputNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogCellModemConnected=ogCellModemConnected, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdConnectType=ogEmdConnectType, ogWebUserIndex=ogWebUserIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialUserName=ogSerialUserName, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemApn=ogCellModemApn, ogUpsHumidity=ogUpsHumidity, ogUpsType=ogUpsType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApSsid=ogWifiApSsid, ogEmdDioState=ogEmdDioState, ogSerialPortStopBits=ogSerialPortStopBits, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcOutletTable=ogRpcOutletTable, ogSerialUserNotification=ogSerialUserNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogStatus2Compliance=ogStatus2Compliance, ogPowerSupplyIndex=ogPowerSupplyIndex, ogAlarmUser=ogAlarmUser, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostUserHost=ogHostUserHost, ogSystem=ogSystem, ogRpcEntry=ogRpcEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioName=ogEmdDioName, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSerialUserTable=ogSerialUserTable, ogHostIpV6Address=ogHostIpV6Address, ogNetInterfaceIndex=ogNetInterfaceIndex, ogPowerSupplyName=ogPowerSupplyName, ogRpcType=ogRpcType, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApIndex=ogWifiApIndex, ogWifiClientEntry=ogWifiClientEntry, ogAlarmType=ogAlarmType, ogCheckType=ogCheckType, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdTable=ogEmdTable, ogHostUserTable=ogHostUserTable, ogSerialPortTable=ogSerialPortTable, ogAlarmName=ogAlarmName, ogCellModemTemperature=ogCellModemTemperature, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellModemRegistered=ogCellModemRegistered, ogRpcConnectType=ogRpcConnectType, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDescription=ogEmdDescription, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApEntry=ogWifiApEntry, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemTower=ogCellModemTower, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsNotification=ogUpsNotification, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientApMac=ogWifiClientApMac, ogWifiApClientAp=ogWifiApClientAp, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWebUserStartTime=ogWebUserStartTime, ogStatus2Conformance=ogStatus2Conformance, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogHostUserName=ogHostUserName, ogHostServiceType=ogHostServiceType, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortMode=ogSerialPortMode, ogSerialPortTxBytes=ogSerialPortTxBytes, ogMibNotifications=ogMibNotifications, ogStatus2Compliances=ogStatus2Compliances, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWebUserEntry=ogWebUserEntry)
