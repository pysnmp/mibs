...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDescription=ogEmdDescription, ogUpsBatteryCharge=ogUpsBatteryCharge, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiClientTable=ogWifiClientTable, ogWifiApClientMac=ogWifiApClientMac, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureName=ogEmdTemperatureName, ogRpcOutletVoltage=ogRpcOutletVoltage, ogNetInterfaceType=ogNetInterfaceType, ogCellModemModel=ogCellModemModel, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsEntry=ogUpsEntry, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcDescription=ogRpcDescription, ogAlarmState=ogAlarmState, ogCellModemCounter=ogCellModemCounter, ogAlarmUser=ogAlarmUser, ogRpcOutletRpc=ogRpcOutletRpc, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogSerialPortTable=ogSerialPortTable, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceNotification=ogHostServiceNotification, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostName=ogHostName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemEnabled=ogCellModemEnabled, ogHostUserIndex=ogHostUserIndex, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogNetInterfaceState=ogNetInterfaceState, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCheckTriggerActions=ogCheckTriggerActions, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientApMac=ogWifiClientApMac, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientCounter=ogWifiClientCounter, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdDioDirection=ogEmdDioDirection, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsConnectType=ogUpsConnectType, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityTable=ogEmdHumidityTable, ogRpcOutputNotification=ogRpcOutputNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogEmdEntry=ogEmdEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemTower=ogCellModemTower, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcLogEnabled=ogRpcLogEnabled, ogHostUserName=ogHostUserName, ogHostUserAddress=ogHostUserAddress, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortDCD=ogSerialPortDCD, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmName=ogAlarmName, ogHostServiceHost=ogHostServiceHost, ogHostEntry=ogHostEntry, ogHostIpV4Address=ogHostIpV4Address, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioInputTotal=ogEmdDioInputTotal, ogUpsHumidity=ogUpsHumidity, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWebUserEntry=ogWebUserEntry, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortSpeed=ogSerialPortSpeed, ogHostUserTable=ogHostUserTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmCurrentValue=ogAlarmCurrentValue, ogAlarmTime=ogAlarmTime, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCellMessageNotification=ogCellMessageNotification, ogCellDataNotification=ogCellDataNotification, ogHostUserHostName=ogHostUserHostName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceCounter=ogHostServiceCounter, ogRpcConnectType=ogRpcConnectType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTable=ogEmdTable, ogSerialPortMode=ogSerialPortMode, ogWifiClientIndex=ogWifiClientIndex, ogCheckResetTimeout=ogCheckResetTimeout, ogCellApnNotification=ogCellApnNotification, ogSerialNumber=ogSerialNumber, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApEnabled=ogWifiApEnabled, ogAlarmLogTable=ogAlarmLogTable, ogSerialPortParity=ogSerialPortParity, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWebUserName=ogWebUserName, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemApn=ogCellModemApn, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarm=ogAlarm, ogAlarmSummary=ogAlarmSummary, ogCellModemEntry=ogCellModemEntry, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserLabel=ogSerialUserLabel, ogHostIpV6Address=ogHostIpV6Address, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsTable=ogUpsTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdEnabled=ogEmdEnabled, ogSerialUserIndex=ogSerialUserIndex, ogWifiApIndex=ogWifiApIndex, ogCellModemNetwork=ogCellModemNetwork, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientInterface=ogWifiClientInterface, ogCheckDeviceName=ogCheckDeviceName, ogUpsName=ogUpsName, ogEmdIndex=ogEmdIndex, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostTable=ogHostTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogAlarmLogEntry=ogAlarmLogEntry, ogCheckTable=ogCheckTable, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogHostServiceEntry=ogHostServiceEntry, ogHostPingNotification=ogHostPingNotification, ogSystem=ogSystem, ogStatus2Groups=ogStatus2Groups, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcCounter=ogRpcCounter, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsState=ogUpsState, ogUpsOutputLoad=ogUpsOutputLoad, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsOutputCurrent=ogUpsOutputCurrent, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientRssi=ogWifiClientRssi, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogRpcOutletName=ogRpcOutletName, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortLogLevel=ogSerialPortLogLevel, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDioType=ogEmdDioType, ogSerialPortLabel=ogSerialPortLabel, ogWifiApClientAp=ogWifiApClientAp, ogSerialPatternNotification=ogSerialPatternNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogSerialPortDataBits=ogSerialPortDataBits, ogCheckName=ogCheckName, ogRpcName=ogRpcName, ogNetInterfaceTable=ogNetInterfaceTable, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserTable=ogWebUserTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsIndex=ogUpsIndex, ogFirmwareVersion=ogFirmwareVersion, ogWifiApCounter=ogWifiApCounter, ogUpsNotification=ogUpsNotification, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWebUserSourceAddress=ogWebUserSourceAddress, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogNetInterfaceIndex=ogNetInterfaceIndex, ogSerialPortRTS=ogSerialPortRTS, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceStatus=ogHostServiceStatus, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceIndex=ogHostServiceIndex, ogCellModemConnected=ogCellModemConnected, ogEmdTemperatureDescription=ogEmdTemperatureDescription, PYSNMP_MODULE_ID=ogStatus2, ogSerialSignalNotification=ogSerialSignalNotification, ogEmdDioName=ogEmdDioName, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortStopBits=ogSerialPortStopBits, ogWifiApSsid=ogWifiApSsid, ogPowerSupplyName=ogPowerSupplyName, ogHostServiceTable=ogHostServiceTable, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsDescription=ogUpsDescription, ogEmdDioCounter=ogEmdDioCounter, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmType=ogAlarmType, ogEmdConnectType=ogEmdConnectType, ogWifiClientEntry=ogWifiClientEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogAlarmDevice=ogAlarmDevice, ogRpcOutletNotification=ogRpcOutletNotification, ogStatus2Compliances=ogStatus2Compliances, ogUpsType=ogUpsType, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApTable=ogWifiApTable, ogHostUserEntry=ogHostUserEntry, ogRpcType=ogRpcType, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemVendor=ogCellModemVendor, ogAlarmCheck=ogAlarmCheck, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortDSR=ogSerialPortDSR, ogCellSignalNotification=ogCellSignalNotification, ogWifiApEntry=ogWifiApEntry, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioTable=ogEmdDioTable, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcIndex=ogRpcIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcEntry=ogRpcEntry, ogStatus2=ogStatus2, ogMibNotifications=ogMibNotifications, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWifiClientFrequency=ogWifiClientFrequency, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogStatus2Compliance=ogStatus2Compliance)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsOutputNotification=ogUpsOutputNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityName=ogEmdHumidityName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckType=ogCheckType, ogWebUserNotification=ogWebUserNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsTemperature=ogUpsTemperature, ogWifiApFrequency=ogWifiApFrequency, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialUserPort=ogSerialUserPort, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApInterface=ogWifiApInterface, ogEmdName=ogEmdName, ogSerialUserStartTime=ogSerialUserStartTime, ogHostServicePort=ogHostServicePort, ogCellModemTable=ogCellModemTable, ogUpsInputNotification=ogUpsInputNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemIMSI=ogCellModemIMSI, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcTable=ogRpcTable, ogEmdDioEmd=ogEmdDioEmd, ogWifiApClientTable=ogWifiApClientTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemIndex=ogCellModemIndex, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogRpcOutletTable=ogRpcOutletTable, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostUserHost=ogHostUserHost, ogCheckEntry=ogCheckEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserNotification=ogSerialUserNotification, ogCustomNotification=ogCustomNotification, ogNetInterfaceName=ogNetInterfaceName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmName=ogCurrentAlarmName, ogPowerSupplyTable=ogPowerSupplyTable, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialUserName=ogSerialUserName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdDioState=ogEmdDioState, ogEmdHumidityNotification=ogEmdHumidityNotification, ogHostServiceType=ogHostServiceType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientEssid=ogWifiClientEssid, ogEmdDioDescription=ogEmdDioDescription, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsCounter=ogUpsCounter, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletState=ogRpcOutletState, ogAlarmInstance=ogAlarmInstance, ogHostIndex=ogHostIndex, ogCheckIndex=ogCheckIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogAlarmEventId=ogAlarmEventId, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientSignalNotification=ogWifiClientSignalNotification)
