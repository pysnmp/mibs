...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsConnectType=ogUpsConnectType, ogNetInterfaceType=ogNetInterfaceType, ogMibNotifications=ogMibNotifications, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcIndex=ogRpcIndex, ogHostServicePort=ogHostServicePort, ogHostIpV4Address=ogHostIpV4Address, ogWebUserStartTime=ogWebUserStartTime, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCheckName=ogCheckName, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogWifiApClientTable=ogWifiApClientTable, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortDataBits=ogSerialPortDataBits, ogHostServiceCounter=ogHostServiceCounter, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputNotification=ogUpsInputNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmCheck=ogAlarmCheck, ogUpsInputFrequency=ogUpsInputFrequency, ogHostPingNotification=ogHostPingNotification, ogWifiClientCounter=ogWifiClientCounter, ogAlarmInstance=ogAlarmInstance, ogEmdName=ogEmdName, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputVoltage=ogUpsOutputVoltage, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCellModemEntry=ogCellModemEntry, ogSerialUserLabel=ogSerialUserLabel, ogUpsDescription=ogUpsDescription, ogSerialUserName=ogSerialUserName, ogCellModemTemperature=ogCellModemTemperature, ogWebUserSourcePort=ogWebUserSourcePort, ogWifiApIndex=ogWifiApIndex, ogUpsInputVoltage=ogUpsInputVoltage, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostEntry=ogHostEntry, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsTemperature=ogUpsTemperature, ogWifiClientEntry=ogWifiClientEntry, ogSerialPortLabel=ogSerialPortLabel, ogWifiApCounter=ogWifiApCounter, ogSerialPortIndex=ogSerialPortIndex, ogUpsState=ogUpsState, ogCellModemCounter=ogCellModemCounter, ogSerialPortParity=ogSerialPortParity, ogWifiApClientMac=ogWifiApClientMac, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemTower=ogCellModemTower, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogRpcCounter=ogRpcCounter, ogHostUserNotification=ogHostUserNotification, ogEmdDioState=ogEmdDioState, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiApSsid=ogWifiApSsid, ogHostIndex=ogHostIndex, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserIndex=ogWebUserIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogCellModemVendor=ogCellModemVendor, ogEmdEnabled=ogEmdEnabled, ogAlarmType=ogAlarmType, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdTable=ogEmdTable, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialUserNotification=ogSerialUserNotification, ogHostUserIndex=ogHostUserIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCheckIndex=ogCheckIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostServiceEntry=ogHostServiceEntry, ogEmdDioEmd=ogEmdDioEmd, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellApnNotification=ogCellApnNotification, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserPort=ogSerialUserPort, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmLogTable=ogAlarmLogTable, ogHostName=ogHostName, ogHostUserAddress=ogHostUserAddress, ogCustomNotification=ogCustomNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogBasicAlarmGroup=ogBasicAlarmGroup, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcTable=ogRpcTable, ogAlarmDevice=ogAlarmDevice, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsName=ogUpsName, ogStatus2Groups=ogStatus2Groups, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyName=ogPowerSupplyName, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCellModemModel=ogCellModemModel, ogStatus2=ogStatus2, ogEmdDioCounter=ogEmdDioCounter, ogCheckTable=ogCheckTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogUpsHumidity=ogUpsHumidity, ogHostUserName=ogHostUserName, ogEmdDioName=ogEmdDioName, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialUserStartTime=ogSerialUserStartTime, ogStatus2Compliance=ogStatus2Compliance, ogCurrentAlarmUser=ogCurrentAlarmUser, ogSerialPortDSR=ogSerialPortDSR, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsNotification=ogUpsNotification, ogSerialUserIndex=ogSerialUserIndex, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcConnectType=ogRpcConnectType, ogRpcOutletEntry=ogRpcOutletEntry, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCellModemEnabled=ogCellModemEnabled, ogEmdHumidityName=ogEmdHumidityName, ogCellSignalNotification=ogCellSignalNotification, ogSerialPortStopBits=ogSerialPortStopBits, ogCheckType=ogCheckType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemIMSI=ogCellModemIMSI, ogRpcOutletTable=ogRpcOutletTable, ogEmdHumidityIndex=ogEmdHumidityIndex, ogSerialPortDCD=ogSerialPortDCD, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApClientIndex=ogWifiApClientIndex, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCheckEntry=ogCheckEntry, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogNetInterfaceIndex=ogNetInterfaceIndex, ogNetInterfaceName=ogNetInterfaceName, ogUpsOutputNotification=ogUpsOutputNotification, ogHostServiceIndex=ogHostServiceIndex, ogHostIpV6Address=ogHostIpV6Address, ogUpsIndex=ogUpsIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogStatus2Compliances=ogStatus2Compliances, ogRpcType=ogRpcType, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogAlarmUser=ogAlarmUser, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortDTR=ogSerialPortDTR, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcName=ogRpcName, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsOutputPower=ogUpsOutputPower, ogHostTable=ogHostTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWebUserName=ogWebUserName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyTable=ogPowerSupplyTable, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletState=ogRpcOutletState, ogWifiApInterface=ogWifiApInterface, ogAlarmTime=ogAlarmTime, ogCheckResolveActions=ogCheckResolveActions, ogAlarmEventId=ogAlarmEventId, ogUpsTable=ogUpsTable, ogEmdDioDescription=ogEmdDioDescription, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWebUserNotification=ogWebUserNotification, ogCellModemApn=ogCellModemApn, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserHostName=ogHostUserHostName, ogCellDataNotification=ogCellDataNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogEmdDioNotification=ogEmdDioNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceNotification=ogHostServiceNotification, ogHostUserEntry=ogHostUserEntry, ogEmdDioType=ogEmdDioType, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientApMac=ogWifiClientApMac, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdDescription=ogEmdDescription, ogEmdEntry=ogEmdEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdDioIndex=ogEmdDioIndex, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCellModemIndex=ogCellModemIndex, ogEmdTemperatureName=ogEmdTemperatureName, ogHostServiceHost=ogHostServiceHost, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsEntry=ogUpsEntry, ogSerialPortSpeed=ogSerialPortSpeed, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioEntry=ogEmdDioEntry, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialUserTable=ogSerialUserTable, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcInputNotification=ogRpcInputNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogRpcDescription=ogRpcDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcOutletFrequency=ogRpcOutletFrequency, ogSerialSignalNotification=ogSerialSignalNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogAlarmState=ogAlarmState)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletName=ogRpcOutletName, ogWifiApClientAp=ogWifiApClientAp, ogEmdIndex=ogEmdIndex, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellModemTable=ogCellModemTable, ogEmdHumidityCounter=ogEmdHumidityCounter, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryVoltage=ogUpsBatteryVoltage, PYSNMP_MODULE_ID=ogStatus2, ogHostServiceTable=ogHostServiceTable, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserTable=ogHostUserTable, ogEmdDioDirection=ogEmdDioDirection, ogAlarmName=ogAlarmName, ogUpsType=ogUpsType, ogCheckDeviceTable=ogCheckDeviceTable, ogSerialPortEntry=ogSerialPortEntry, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogHostUserHost=ogHostUserHost, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdDioTable=ogEmdDioTable, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckDeviceName=ogCheckDeviceName, ogCheckDeviceRef=ogCheckDeviceRef, ogCellTowerNotification=ogCellTowerNotification, ogCellMessageNotification=ogCellMessageNotification, ogHostServiceType=ogHostServiceType, ogEmdConnectType=ogEmdConnectType, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialNumber=ogSerialNumber, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientMode=ogWifiClientMode, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogCellModemConnected=ogCellModemConnected, ogUpsBatteryState=ogUpsBatteryState, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmSummary=ogAlarmSummary, ogWifiApEntry=ogWifiApEntry, ogSystem=ogSystem, ogWebUserTable=ogWebUserTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiApTable=ogWifiApTable, ogUpsCounter=ogUpsCounter, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarm=ogAlarm, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiClientTable=ogWifiClientTable, ogSerialPortMode=ogSerialPortMode, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApFrequency=ogWifiApFrequency, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortTable=ogSerialPortTable, ogCellModemRegistered=ogCellModemRegistered, ogRpcEntry=ogRpcEntry)
