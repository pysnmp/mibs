...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogMibNotifications=ogMibNotifications, ogEmdName=ogEmdName, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyName=ogPowerSupplyName, ogUpsTemperature=ogUpsTemperature, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModemIMSI=ogCellModemIMSI, ogAlarm=ogAlarm, ogUpsEntry=ogUpsEntry, ogCellApnNotification=ogCellApnNotification, ogHostPingNotification=ogHostPingNotification, ogUpsCounter=ogUpsCounter, ogWebUserStartTime=ogWebUserStartTime, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostIndex=ogHostIndex, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialNumber=ogSerialNumber, ogRpcOutletName=ogRpcOutletName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortRTS=ogSerialPortRTS, ogHostUserIndex=ogHostUserIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemTower=ogCellModemTower, ogHostServicePort=ogHostServicePort, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsType=ogUpsType, ogCheckName=ogCheckName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientRssi=ogWifiClientRssi, ogUpsDescription=ogUpsDescription, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortIndex=ogSerialPortIndex, ogHostServiceType=ogHostServiceType, ogHostUserHostName=ogHostUserHostName, ogWifiClientIndex=ogWifiClientIndex, ogCellModemCounter=ogCellModemCounter, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogEmdHumidityName=ogEmdHumidityName, ogWifiApTable=ogWifiApTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceCounter=ogHostServiceCounter, ogUpsInputVoltage=ogUpsInputVoltage, ogRpcOutletCurrent=ogRpcOutletCurrent, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApEntry=ogWifiApEntry, ogRpcType=ogRpcType, ogRpcOutletState=ogRpcOutletState, ogHostName=ogHostName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsOutputNotification=ogUpsOutputNotification, ogStatus2=ogStatus2, ogUpsOutputPower=ogUpsOutputPower, ogCellModemRegistered=ogCellModemRegistered, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemTemperature=ogCellModemTemperature, ogHostUserStartTime=ogHostUserStartTime, ogSerialUserIndex=ogSerialUserIndex, ogHostServiceEntry=ogHostServiceEntry, ogRpcCounter=ogRpcCounter, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsInputFrequency=ogUpsInputFrequency, ogSerialPortDTR=ogSerialPortDTR, ogAlarmSummary=ogAlarmSummary, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogAlarmState=ogAlarmState, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogAlarmTime=ogAlarmTime, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostServiceHost=ogHostServiceHost, ogWifiApCounter=ogWifiApCounter, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdDioTable=ogEmdDioTable, ogCustomNotification=ogCustomNotification, ogCheckEntry=ogCheckEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogCellMessageNotification=ogCellMessageNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdEnabled=ogEmdEnabled, ogCellNetworkNotification=ogCellNetworkNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsNotification=ogUpsNotification, ogHostTable=ogHostTable, ogWifiApSsid=ogWifiApSsid, ogRpcOutputNotification=ogRpcOutputNotification, ogHostUserEntry=ogHostUserEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialUserName=ogSerialUserName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApEnabled=ogWifiApEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCheckDeviceEntry=ogCheckDeviceEntry, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmType=ogAlarmType, ogRpcTable=ogRpcTable, ogSerialUserNotification=ogSerialUserNotification, ogHostUserTable=ogHostUserTable, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWifiClientBitRate=ogWifiClientBitRate, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogEmdDioEntry=ogEmdDioEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogWifiClientApMac=ogWifiClientApMac, ogCheckDeviceName=ogCheckDeviceName, ogAlarmUser=ogAlarmUser, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcConnectType=ogRpcConnectType, ogUpsInputNotification=ogUpsInputNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogCellModemIndex=ogCellModemIndex, ogCellTowerNotification=ogCellTowerNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogAlarmInstance=ogAlarmInstance, ogSerialUserPort=ogSerialUserPort, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortEntry=ogSerialPortEntry, ogSerialUserEntry=ogSerialUserEntry, ogEmdTemperatureName=ogEmdTemperatureName, ogCellModemVendor=ogCellModemVendor, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialUserTable=ogSerialUserTable, ogPowerSupplyEntry=ogPowerSupplyEntry, ogHostUserNotification=ogHostUserNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApFrequency=ogWifiApFrequency, ogNetInterfaceNotification=ogNetInterfaceNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogCheckTriggerActions=ogCheckTriggerActions, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostIpV4Address=ogHostIpV4Address, ogCellModemEntry=ogCellModemEntry, ogStatus2Groups=ogStatus2Groups, ogCellModemTable=ogCellModemTable, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortParity=ogSerialPortParity, ogCurrentAlarmTable=ogCurrentAlarmTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortMode=ogSerialPortMode, ogWebUserSourceAddress=ogWebUserSourceAddress, ogCellModemEnabled=ogCellModemEnabled, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialPortTxBytes=ogSerialPortTxBytes, ogHostEntry=ogHostEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogHostServiceNotification=ogHostServiceNotification, ogWifiClientCounter=ogWifiClientCounter, PYSNMP_MODULE_ID=ogStatus2, ogRpcLogEnabled=ogRpcLogEnabled, ogHostServiceStatus=ogHostServiceStatus, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogWifiApTxPower=ogWifiApTxPower, ogSystem=ogSystem, ogCellModem4gRssi=ogCellModem4gRssi, ogAlarmCheck=ogAlarmCheck, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsTable=ogUpsTable, ogNetInterfaceState=ogNetInterfaceState, ogCellModemConnected=ogCellModemConnected, ogWifiClientInterface=ogWifiClientInterface, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCheckTable=ogCheckTable, ogUpsHumidity=ogUpsHumidity, ogStatus2Compliance=ogStatus2Compliance, ogWifiApInterface=ogWifiApInterface, ogSerialPortDataBits=ogSerialPortDataBits, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioDescription=ogEmdDioDescription, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiApIndex=ogWifiApIndex, ogWifiApClientAp=ogWifiApClientAp, ogEmdDioType=ogEmdDioType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogSerialUserLabel=ogSerialUserLabel, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostIpV6Address=ogHostIpV6Address, ogUpsName=ogUpsName, ogAlarmEventId=ogAlarmEventId, ogRpcOutletFrequency=ogRpcOutletFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogUpsConnectType=ogUpsConnectType, ogEmdDioNotification=ogEmdDioNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWebUserIndex=ogWebUserIndex, ogAlarmDevice=ogAlarmDevice, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcInputFrequency=ogRpcInputFrequency, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostUserHost=ogHostUserHost, ogWifiClientTxPower=ogWifiClientTxPower, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTable=ogEmdTable, ogSerialPortTable=ogSerialPortTable, ogCheckIndex=ogCheckIndex, ogWebUserTable=ogWebUserTable, ogHostUserAddress=ogHostUserAddress, ogSerialPortDCD=ogSerialPortDCD, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsState=ogUpsState, ogUpsIndex=ogUpsIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcInputVoltage=ogRpcInputVoltage, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellModemModel=ogCellModemModel, ogWifiApClientRssi=ogWifiApClientRssi, ogHostServiceIndex=ogHostServiceIndex)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutletLoad=ogRpcOutletLoad, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogStatus2Compliances=ogStatus2Compliances, ogRpcName=ogRpcName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApClientIndex=ogWifiApClientIndex, ogEmdDioEmd=ogEmdDioEmd, ogHostUserName=ogHostUserName, ogRpcEntry=ogRpcEntry, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdEntry=ogEmdEntry, ogCellModemApn=ogCellModemApn, ogEmdHumidityEmd=ogEmdHumidityEmd, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdConnectType=ogEmdConnectType, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdDescription=ogEmdDescription, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyTable=ogPowerSupplyTable, ogCellSignalNotification=ogCellSignalNotification, ogStatus2Conformance=ogStatus2Conformance, ogEmdDioState=ogEmdDioState, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryState=ogUpsBatteryState, ogWifiApClientEntry=ogWifiApClientEntry, ogSerialSignalNotification=ogSerialSignalNotification, ogFirmwareVersion=ogFirmwareVersion, ogWebUserName=ogWebUserName, ogWifiClientEssid=ogWifiClientEssid, ogCheckResolveActions=ogCheckResolveActions, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsOutputTruePower=ogUpsOutputTruePower, ogNetInterfaceType=ogNetInterfaceType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckType=ogCheckType, ogSerialPortDSR=ogSerialPortDSR, ogEmdDioName=ogEmdDioName, ogWebUserEntry=ogWebUserEntry, ogRpcOutletTable=ogRpcOutletTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdIndex=ogEmdIndex, ogWebUserNotification=ogWebUserNotification, ogWifiClientEntry=ogWifiClientEntry, ogCellModem3gRssi=ogCellModem3gRssi, ogBasicNotificationGroup=ogBasicNotificationGroup, ogRpcDescription=ogRpcDescription, ogWifiApClientTable=ogWifiApClientTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcIndex=ogRpcIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmState=ogCurrentAlarmState, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortCTS=ogSerialPortCTS, ogWifiClientTable=ogWifiClientTable, ogAlarmName=ogAlarmName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletRpc=ogRpcOutletRpc, ogRpcInputNotification=ogRpcInputNotification, ogCellModemNetwork=ogCellModemNetwork, ogEmdHumidityValue=ogEmdHumidityValue)
