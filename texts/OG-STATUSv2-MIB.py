...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcEntry=ogRpcEntry, ogAlarmName=ogAlarmName, ogUpsDescription=ogUpsDescription, ogUpsLogEnabled=ogUpsLogEnabled, ogHostServiceCounter=ogHostServiceCounter, ogRpcIndex=ogRpcIndex, ogAlarmTriggerValue=ogAlarmTriggerValue, ogAlarmEventId=ogAlarmEventId, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioState=ogEmdDioState, ogRpcOutletVoltage=ogRpcOutletVoltage, ogEmdConnectType=ogEmdConnectType, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortBreaks=ogSerialPortBreaks, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogRpcOutletNotification=ogRpcOutletNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdDioName=ogEmdDioName, ogSystem=ogSystem, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdDioIndex=ogEmdDioIndex, ogCheckDeviceName=ogCheckDeviceName, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogNetInterfaceTable=ogNetInterfaceTable, ogAlarmLogTable=ogAlarmLogTable, ogCellSignalNotification=ogCellSignalNotification, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsHumidity=ogUpsHumidity, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserSourceAddress=ogWebUserSourceAddress, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWebUserTable=ogWebUserTable, ogHostIndex=ogHostIndex, ogWifiClientInterface=ogWifiClientInterface, ogUpsState=ogUpsState, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiClientMode=ogWifiClientMode, ogSerialPortLogLevel=ogSerialPortLogLevel, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdDioDirection=ogEmdDioDirection, ogCellModemModel=ogCellModemModel, ogPowerSupplyTable=ogPowerSupplyTable, ogNetInterfaceName=ogNetInterfaceName, ogHostServicePort=ogHostServicePort, ogWifiApInterface=ogWifiApInterface, ogWifiApIndex=ogWifiApIndex, ogHostPingNotification=ogHostPingNotification, ogAlarmType=ogAlarmType, ogStatus2Compliances=ogStatus2Compliances, ogWifiApAuthNotification=ogWifiApAuthNotification, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialNumber=ogSerialNumber, ogRpcInputNotification=ogRpcInputNotification, ogAlarmUser=ogAlarmUser, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemVendor=ogCellModemVendor, ogFirmwareVersion=ogFirmwareVersion, ogWifiApEntry=ogWifiApEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioType=ogEmdDioType, ogUpsIndex=ogUpsIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiApClientTable=ogWifiApClientTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellDataNotification=ogCellDataNotification, ogCellModemNetwork=ogCellModemNetwork, ogWifiClientFrequency=ogWifiClientFrequency, ogCheckDeviceIndex=ogCheckDeviceIndex, ogRpcOutletIndex=ogRpcOutletIndex, ogAlarm=ogAlarm, ogWifiApCounter=ogWifiApCounter, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcName=ogRpcName, ogHostUserTable=ogHostUserTable, ogCellNetworkNotification=ogCellNetworkNotification, ogHostUserEntry=ogHostUserEntry, ogUpsNotification=ogUpsNotification, ogHostServiceNotification=ogHostServiceNotification, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcCounter=ogRpcCounter, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCheckTable=ogCheckTable, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogSerialPortIndex=ogSerialPortIndex, ogEmdHumidityValue=ogEmdHumidityValue, ogSerialPortRTS=ogSerialPortRTS, ogAlarmSummary=ogAlarmSummary, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmLogIndex=ogAlarmLogIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserNotification=ogHostUserNotification, ogHostUserAddress=ogHostUserAddress, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogSerialPortEntry=ogSerialPortEntry, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientEnabled=ogWifiClientEnabled, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiClientApMac=ogWifiClientApMac, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostUserIndex=ogHostUserIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialUserTable=ogSerialUserTable, ogEmdName=ogEmdName, ogSerialPortCTS=ogSerialPortCTS, ogWifiApClientEntry=ogWifiApClientEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogStatus2Conformance=ogStatus2Conformance, ogSerialPatternNotification=ogSerialPatternNotification, ogCellApnNotification=ogCellApnNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserIndex=ogWebUserIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostUserName=ogHostUserName, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortDSR=ogSerialPortDSR, ogWifiApEnabled=ogWifiApEnabled, ogRpcInputCurrent=ogRpcInputCurrent, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogHostServiceType=ogHostServiceType, ogCellModemRegistered=ogCellModemRegistered, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdEnabled=ogEmdEnabled, ogRpcTable=ogRpcTable, ogWebUserName=ogWebUserName, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsEntry=ogUpsEntry, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioCounter=ogEmdDioCounter, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsInputCurrent=ogUpsInputCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmLogEntry=ogAlarmLogEntry, ogHostUserHost=ogHostUserHost, ogWifiApFrequency=ogWifiApFrequency, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCheckEntry=ogCheckEntry, ogRpcOutletName=ogRpcOutletName, ogSerialUserName=ogSerialUserName, ogUpsBatteryState=ogUpsBatteryState, ogSerialPortMode=ogSerialPortMode, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdIndex=ogEmdIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogCellModemEnabled=ogCellModemEnabled, ogUpsType=ogUpsType, ogHostServiceEntry=ogHostServiceEntry, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogRpcOutletCurrent=ogRpcOutletCurrent, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortLabel=ogSerialPortLabel, ogUpsCounter=ogUpsCounter, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogPowerSupplyName=ogPowerSupplyName, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserEntry=ogSerialUserEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApClientMac=ogWifiApClientMac, ogMibNotifications=ogMibNotifications, ogUpsInputFrequency=ogUpsInputFrequency, ogRpcType=ogRpcType, ogRpcDescription=ogRpcDescription, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogHostEntry=ogHostEntry, ogSerialUserIndex=ogSerialUserIndex, ogAlarmCheck=ogAlarmCheck, ogCellModemTable=ogCellModemTable, ogSerialPortParity=ogSerialPortParity, ogCellModemConnected=ogCellModemConnected, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmState=ogAlarmState, ogHostServiceHost=ogHostServiceHost, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiClientIndex=ogWifiClientIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostTable=ogHostTable, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCustomNotification=ogCustomNotification, ogWebUserStartTime=ogWebUserStartTime, ogCellModemTower=ogCellModemTower, ogSerialPortTable=ogSerialPortTable, ogHostIpV4Address=ogHostIpV4Address, ogWebUserNotification=ogWebUserNotification, ogWifiClientEssid=ogWifiClientEssid, ogStatus2Groups=ogStatus2Groups, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemIndex=ogCellModemIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogAlarmTime=ogAlarmTime, ogCheckIndex=ogCheckIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsInputVoltage=ogUpsInputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogStatus2Compliance=ogStatus2Compliance, ogRpcOutletState=ogRpcOutletState, ogWifiApSsid=ogWifiApSsid, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityEntry=ogEmdHumidityEntry, ogAlarmPreviousValue=ogAlarmPreviousValue, ogEmdDioTable=ogEmdDioTable, ogCheckType=ogCheckType, ogEmdDioInputTotal=ogEmdDioInputTotal, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdTable=ogEmdTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemIMSI=ogCellModemIMSI, ogCellModemEntry=ogCellModemEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogWifiClientCounter=ogWifiClientCounter, ogWifiApClientAp=ogWifiApClientAp, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialUserLabel=ogSerialUserLabel, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogHostServiceTable=ogHostServiceTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcOutputNotification=ogRpcOutputNotification, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortDTR=ogSerialPortDTR, PYSNMP_MODULE_ID=ogStatus2, ogWebUserEntry=ogWebUserEntry, ogUpsConnectType=ogUpsConnectType, ogSerialUserPort=ogSerialUserPort, ogUpsTemperature=ogUpsTemperature, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogUpsOutputLoad=ogUpsOutputLoad, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostServiceIndex=ogHostServiceIndex, ogCellModemCounter=ogCellModemCounter, ogEmdDescription=ogEmdDescription, ogNetInterfaceType=ogNetInterfaceType, ogHostUserStartTime=ogHostUserStartTime, ogCellModemApn=ogCellModemApn, ogSerialPortDCD=ogSerialPortDCD, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcConnectType=ogRpcConnectType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemTemperature=ogCellModemTemperature, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostName=ogHostName, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiApTxPower=ogWifiApTxPower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogUpsName=ogUpsName, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsOutputNotification=ogUpsOutputNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientRssi=ogWifiClientRssi, ogStatus2=ogStatus2, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdEntry=ogEmdEntry, ogWifiClientEntry=ogWifiClientEntry, ogWifiApTable=ogWifiApTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckName=ogCheckName, ogCellModem3gRssi=ogCellModem3gRssi, ogHostUserHostName=ogHostUserHostName, ogHostIpV6Address=ogHostIpV6Address, ogSerialUserNotification=ogSerialUserNotification, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdLogEnabled=ogEmdLogEnabled, ogUpsTable=ogUpsTable, ogRpcOutletEntry=ogRpcOutletEntry, ogCellModemSessionTime=ogCellModemSessionTime)
