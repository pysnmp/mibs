...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiApCounter=ogWifiApCounter, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogHostServicePort=ogHostServicePort, ogUpsTable=ogUpsTable, ogRpcInputVoltage=ogRpcInputVoltage, ogHostServiceTable=ogHostServiceTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserIndex=ogWebUserIndex, ogWebUserNotification=ogWebUserNotification, ogEmdDescription=ogEmdDescription, ogHostUserHost=ogHostUserHost, ogHostUserNotification=ogHostUserNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogStatus2=ogStatus2, ogRpcOutletState=ogRpcOutletState, ogHostTable=ogHostTable, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostUserHostName=ogHostUserHostName, ogSerialUserNotification=ogSerialUserNotification, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogRpcTable=ogRpcTable, ogCellModemSessionTime=ogCellModemSessionTime, ogEmdDioEntry=ogEmdDioEntry, ogHostIpV6Address=ogHostIpV6Address, ogEmdTemperatureValue=ogEmdTemperatureValue, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceEntry=ogCheckDeviceEntry, ogNetInterfaceType=ogNetInterfaceType, ogSerialUserLabel=ogSerialUserLabel, ogRpcOutletEntry=ogRpcOutletEntry, ogWifiClientInterface=ogWifiClientInterface, ogEmdDioType=ogEmdDioType, ogHostUserIndex=ogHostUserIndex, ogSerialPortDSR=ogSerialPortDSR, ogHostName=ogHostName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsState=ogUpsState, ogSerialPortIndex=ogSerialPortIndex, ogWebUserTable=ogWebUserTable, ogHostServiceStatus=ogHostServiceStatus, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostServiceHost=ogHostServiceHost, ogHostServiceType=ogHostServiceType, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialUserIndex=ogSerialUserIndex, ogWifiApTable=ogWifiApTable, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdDioDescription=ogEmdDioDescription, ogSerialPortMode=ogSerialPortMode, ogSerialPortParity=ogSerialPortParity, ogHostPingNotification=ogHostPingNotification, ogWifiApIeeeMode=ogWifiApIeeeMode, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcConnectType=ogRpcConnectType, ogBasicStatusGroup=ogBasicStatusGroup, ogBasicAlarmGroup=ogBasicAlarmGroup, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellTowerNotification=ogCellTowerNotification, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmEventId=ogAlarmEventId, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogNetInterfaceName=ogNetInterfaceName, ogCellModemEntry=ogCellModemEntry, ogUpsConnectType=ogUpsConnectType, ogRpcInputFrequency=ogRpcInputFrequency, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioCounter=ogEmdDioCounter, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogRpcOutletNotification=ogRpcOutletNotification, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceEntry=ogHostServiceEntry, ogWifiApInterface=ogWifiApInterface, ogCheckIndex=ogCheckIndex, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellApnNotification=ogCellApnNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogWifiApClientAp=ogWifiApClientAp, ogSerialPortFlowControl=ogSerialPortFlowControl, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCellModemVendor=ogCellModemVendor, ogCellMessageNotification=ogCellMessageNotification, ogEmdDioDirection=ogEmdDioDirection, ogWifiApEnabled=ogWifiApEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogHostServiceIndex=ogHostServiceIndex, ogAlarmDevice=ogAlarmDevice, ogWifiClientRssi=ogWifiClientRssi, ogUpsTemperature=ogUpsTemperature, ogWifiApAuthNotification=ogWifiApAuthNotification, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserName=ogSerialUserName, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientIndex=ogWifiClientIndex, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialNumber=ogSerialNumber, ogHostUserAddress=ogHostUserAddress, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogSerialPortLabel=ogSerialPortLabel, ogUpsInputVoltage=ogUpsInputVoltage, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryState=ogUpsBatteryState, ogAlarmLogTable=ogAlarmLogTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogUpsEntry=ogUpsEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckDeviceCheck=ogCheckDeviceCheck, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientMode=ogWifiClientMode, ogCellModemTower=ogCellModemTower, ogAlarmType=ogAlarmType, ogCurrentAlarmName=ogCurrentAlarmName, ogUpsInputCurrent=ogUpsInputCurrent, ogWifiApSsid=ogWifiApSsid, ogWifiApClientIndex=ogWifiApClientIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCheckType=ogCheckType, ogEmdHumidityDescription=ogEmdHumidityDescription, ogCellModemConnected=ogCellModemConnected, ogAlarmCurrentValue=ogAlarmCurrentValue, ogMibNotifications=ogMibNotifications, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioEmd=ogEmdDioEmd, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcType=ogRpcType, ogEmdLogEnabled=ogEmdLogEnabled, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryCharge=ogUpsBatteryCharge, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmInstance=ogAlarmInstance, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortDCD=ogSerialPortDCD, ogRpcOutletTable=ogRpcOutletTable, ogUpsType=ogUpsType, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogNetInterfaceNotification=ogNetInterfaceNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogStatus2Conformance=ogStatus2Conformance, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogCellModemCounter=ogCellModemCounter, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogAlarmName=ogAlarmName, ogUpsInputFrequency=ogUpsInputFrequency, ogWebUserSourceAddress=ogWebUserSourceAddress, ogWifiClientEssid=ogWifiClientEssid, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellModemEnabled=ogCellModemEnabled, ogCheckTable=ogCheckTable, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsDescription=ogUpsDescription, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdIndex=ogEmdIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogWebUserName=ogWebUserName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogEmdHumidityName=ogEmdHumidityName, ogCellModem4gRssi=ogCellModem4gRssi, ogSystem=ogSystem, ogStatus2Compliance=ogStatus2Compliance, ogWebUserStartTime=ogWebUserStartTime, ogSerialPortEntry=ogSerialPortEntry, ogUpsNotification=ogUpsNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogRpcOutletLoad=ogRpcOutletLoad, ogEmdConnectType=ogEmdConnectType, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserName=ogHostUserName, ogHostServiceCounter=ogHostServiceCounter, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogAlarmTime=ogAlarmTime, ogRpcDescription=ogRpcDescription, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogRpcEntry=ogRpcEntry, ogAlarmSummary=ogAlarmSummary, ogWifiClientTable=ogWifiClientTable, ogEmdTemperatureName=ogEmdTemperatureName, ogNetInterfaceState=ogNetInterfaceState, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialPortCTS=ogSerialPortCTS, ogSerialPortRTS=ogSerialPortRTS, ogUpsOutputFrequency=ogUpsOutputFrequency, ogRpcOutletFrequency=ogRpcOutletFrequency, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogRpcIndex=ogRpcIndex, ogWifiApEntry=ogWifiApEntry, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityTable=ogEmdHumidityTable, ogEmdTable=ogEmdTable, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdDioState=ogEmdDioState, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogEmdEntry=ogEmdEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogEmdDioNotification=ogEmdDioNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioIndex=ogEmdDioIndex, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCheckDeviceName=ogCheckDeviceName, ogStatus2Compliances=ogStatus2Compliances, ogRpcName=ogRpcName, ogRpcMaxTemperature=ogRpcMaxTemperature, ogHostUserEntry=ogHostUserEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioName=ogEmdDioName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialUserPort=ogSerialUserPort, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsInputNotification=ogUpsInputNotification, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogAlarmUser=ogAlarmUser, ogCurrentAlarmUser=ogCurrentAlarmUser, ogHostIpV4Address=ogHostIpV4Address, ogWebUserEntry=ogWebUserEntry, ogCheckResetTimeout=ogCheckResetTimeout, ogCellModemTemperature=ogCellModemTemperature)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogAlarm=ogAlarm, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiApClientMac=ogWifiApClientMac, ogSerialUserEntry=ogSerialUserEntry, ogCellModemIMSI=ogCellModemIMSI, ogUpsName=ogUpsName, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCheckName=ogCheckName, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostServiceNotification=ogHostServiceNotification, ogSerialUserTable=ogSerialUserTable, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemModel=ogCellModemModel, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmCheck=ogAlarmCheck, ogAlarmState=ogAlarmState, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioTable=ogEmdDioTable, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogStatus2Groups=ogStatus2Groups, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogRpcCounter=ogRpcCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogRpcOutputNotification=ogRpcOutputNotification, ogPowerSupplyName=ogPowerSupplyName, ogEmdName=ogEmdName, ogBasicNotificationGroup=ogBasicNotificationGroup, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCustomNotification=ogCustomNotification, ogRpcOutletName=ogRpcOutletName, ogHostIndex=ogHostIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogHostEntry=ogHostEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApIndex=ogWifiApIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostUserTable=ogHostUserTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckEntry=ogCheckEntry, PYSNMP_MODULE_ID=ogStatus2, ogWifiApTxPower=ogWifiApTxPower, ogSerialPortStopBits=ogSerialPortStopBits, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellModemNetwork=ogCellModemNetwork, ogEmdEnabled=ogEmdEnabled, ogCellModemApn=ogCellModemApn, ogUpsIndex=ogUpsIndex, ogCellDataNotification=ogCellDataNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemRegistered=ogCellModemRegistered, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogUpsCounter=ogUpsCounter, ogCellModemTable=ogCellModemTable, ogWifiClientCounter=ogWifiClientCounter, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletCurrent=ogRpcOutletCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortDTR=ogSerialPortDTR, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcOutletIndex=ogRpcOutletIndex, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemIndex=ogCellModemIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogWifiApFrequency=ogWifiApFrequency, ogCellSignalNotification=ogCellSignalNotification)
