...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogNetInterfaceName=ogNetInterfaceName, ogWifiApTable=ogWifiApTable, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioType=ogEmdDioType, ogCheckIndex=ogCheckIndex, ogWebUserTable=ogWebUserTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellMessageNotification=ogCellMessageNotification, ogRpcOutletState=ogRpcOutletState, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogHostServiceTable=ogHostServiceTable, ogCheckDeviceName=ogCheckDeviceName, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogHostEntry=ogHostEntry, ogRpcInputNotification=ogRpcInputNotification, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemTemperature=ogCellModemTemperature, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientBitRate=ogWifiClientBitRate, ogSerialPortIndex=ogSerialPortIndex, ogEmdEnabled=ogEmdEnabled, ogWifiClientIndex=ogWifiClientIndex, ogCellModemApn=ogCellModemApn, ogEmdTemperatureName=ogEmdTemperatureName, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCurrentAlarmState=ogCurrentAlarmState, ogHostName=ogHostName, ogWifiClientEssid=ogWifiClientEssid, ogAlarmCheck=ogAlarmCheck, ogSerialPatternNotification=ogSerialPatternNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsBatteryState=ogUpsBatteryState, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostServiceCounter=ogHostServiceCounter, ogSerialPortLabel=ogSerialPortLabel, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialUserIndex=ogSerialUserIndex, ogRpcEntry=ogRpcEntry, ogWifiApIndex=ogWifiApIndex, ogWifiClientEnabled=ogWifiClientEnabled, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostUserName=ogHostUserName, ogAlarmType=ogAlarmType, ogRpcOutletName=ogRpcOutletName, ogAlarmCurrentValue=ogAlarmCurrentValue, ogRpcConnectType=ogRpcConnectType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWifiClientFrequency=ogWifiClientFrequency, ogRpcOutletTable=ogRpcOutletTable, ogWifiApClientMac=ogWifiApClientMac, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogCellTowerNotification=ogCellTowerNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogPowerSupplyName=ogPowerSupplyName, ogCellModem3gRssi=ogCellModem3gRssi, ogCheckTable=ogCheckTable, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogHostServiceType=ogHostServiceType, ogStatus2Conformance=ogStatus2Conformance, ogUpsDescription=ogUpsDescription, ogCellModem4gRssi=ogCellModem4gRssi, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsTable=ogUpsTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApSsid=ogWifiApSsid, ogCellModemVendor=ogCellModemVendor, ogSerialPortDCD=ogSerialPortDCD, ogCellModemRegistered=ogCellModemRegistered, ogUpsIndex=ogUpsIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletCurrent=ogRpcOutletCurrent, ogAlarmDevice=ogAlarmDevice, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogEmdName=ogEmdName, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogBasicAlarmGroup=ogBasicAlarmGroup, ogRpcCounter=ogRpcCounter, ogHostUserEntry=ogHostUserEntry, ogEmdDioNotification=ogEmdDioNotification, ogUpsConnectType=ogUpsConnectType, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsCounter=ogUpsCounter, ogHostServiceIndex=ogHostServiceIndex, ogAlarmState=ogAlarmState, ogWifiApAuthNotification=ogWifiApAuthNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortEntry=ogSerialPortEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogHostUserHostName=ogHostUserHostName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiApCounter=ogWifiApCounter, ogWifiApFrequency=ogWifiApFrequency, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWebUserNotification=ogWebUserNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemIndex=ogCellModemIndex, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellDataNotification=ogCellDataNotification, ogRpcType=ogRpcType, ogWifiClientTable=ogWifiClientTable, ogFirmwareVersion=ogFirmwareVersion, ogUpsHumidity=ogUpsHumidity, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdDioDescription=ogEmdDioDescription, ogBasicNotificationGroup=ogBasicNotificationGroup, ogHostUserAddress=ogHostUserAddress, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputFrequency=ogUpsInputFrequency, ogHostIndex=ogHostIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiClientCounter=ogWifiClientCounter, ogHostUserNotification=ogHostUserNotification, ogRpcDescription=ogRpcDescription, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletFrequency=ogRpcOutletFrequency, ogAlarmName=ogAlarmName, ogWifiApTxPower=ogWifiApTxPower, ogEmdEntry=ogEmdEntry, ogEmdDioEmd=ogEmdDioEmd, ogSerialUserNotification=ogSerialUserNotification, ogEmdDioTable=ogEmdDioTable, ogSerialUserStartTime=ogSerialUserStartTime, ogEmdIndex=ogEmdIndex, ogCheckName=ogCheckName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsInputNotification=ogUpsInputNotification, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortBreaks=ogSerialPortBreaks, ogStatus2Compliance=ogStatus2Compliance, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCellApnNotification=ogCellApnNotification, ogUpsName=ogUpsName, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCellSignalNotification=ogCellSignalNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsOutputCurrent=ogUpsOutputCurrent, ogEmdTemperatureTable=ogEmdTemperatureTable, ogSerialPortMode=ogSerialPortMode, ogHostServiceNotification=ogHostServiceNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiClientInterface=ogWifiClientInterface, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWebUserSourcePort=ogWebUserSourcePort, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientApMac=ogWifiClientApMac, ogAlarmInstance=ogAlarmInstance, ogEmdConnectType=ogEmdConnectType, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiApClientEntry=ogWifiApClientEntry, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemCounter=ogCellModemCounter, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogAlarmEventId=ogAlarmEventId, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApClientAp=ogWifiApClientAp, ogCheckType=ogCheckType, ogSerialPortDTR=ogSerialPortDTR, ogCellModemConnected=ogCellModemConnected, ogEmdLogEnabled=ogEmdLogEnabled, ogRpcInputCurrent=ogRpcInputCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogWifiApInterface=ogWifiApInterface, ogCheckEntry=ogCheckEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmLogTable=ogAlarmLogTable, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialUserTable=ogSerialUserTable, ogRpcIndex=ogRpcIndex, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogHostUserHost=ogHostUserHost, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityTotal=ogEmdHumidityTotal, ogSerialNumber=ogSerialNumber, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogWifiApClientTable=ogWifiApClientTable, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioState=ogEmdDioState, ogRpcTable=ogRpcTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsOutputLoad=ogUpsOutputLoad, ogHostIpV4Address=ogHostIpV4Address, ogPowerSupplyEntry=ogPowerSupplyEntry, ogSerialUserName=ogSerialUserName, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialPortDataBits=ogSerialPortDataBits, ogMibNotifications=ogMibNotifications, ogStatus2=ogStatus2, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdTable=ogEmdTable, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWebUserIndex=ogWebUserIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogCellModemTable=ogCellModemTable, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCheckDeviceCheck=ogCheckDeviceCheck, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogCheckDeviceEntry=ogCheckDeviceEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioDirection=ogEmdDioDirection, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdHumidityDescription=ogEmdHumidityDescription, ogEmdDescription=ogEmdDescription, ogAlarmUser=ogAlarmUser, ogUpsType=ogUpsType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWifiClientEntry=ogWifiClientEntry)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsState=ogUpsState, ogEmdHumidityName=ogEmdHumidityName, ogCustomNotification=ogCustomNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogHostServiceHost=ogHostServiceHost, ogAlarmTime=ogAlarmTime, ogUpsEntry=ogUpsEntry, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogStatus2Groups=ogStatus2Groups, ogEmdDioCounter=ogEmdDioCounter, ogWebUserName=ogWebUserName, ogWifiApEntry=ogWifiApEntry, ogHostUserTable=ogHostUserTable, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellModemTower=ogCellModemTower, ogUpsTemperature=ogUpsTemperature, ogSerialPortTable=ogSerialPortTable, ogHostServiceEntry=ogHostServiceEntry, ogHostServicePort=ogHostServicePort, ogCliUserSessionNotification=ogCliUserSessionNotification, PYSNMP_MODULE_ID=ogStatus2, ogSerialUserPort=ogSerialUserPort, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogUpsNotification=ogUpsNotification, ogHostTable=ogHostTable, ogUpsOutputFrequency=ogUpsOutputFrequency, ogAlarm=ogAlarm, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialUserEntry=ogSerialUserEntry, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogEmdDioName=ogEmdDioName, ogWifiApClientIndex=ogWifiApClientIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogHostUserIndex=ogHostUserIndex, ogUpsInputCurrent=ogUpsInputCurrent, ogHostUserStartTime=ogHostUserStartTime, ogStatus2Compliances=ogStatus2Compliances, ogSerialPortRTS=ogSerialPortRTS, ogRpcName=ogRpcName, ogEmdDioIndex=ogEmdDioIndex, ogCellModemEntry=ogCellModemEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiClientMode=ogWifiClientMode, ogWifiClientRssi=ogWifiClientRssi, ogEmdDioEntry=ogEmdDioEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemNetwork=ogCellModemNetwork, ogCellModemIMSI=ogCellModemIMSI, ogUpsOutputPower=ogUpsOutputPower, ogHostServiceStatus=ogHostServiceStatus, ogHostPingNotification=ogHostPingNotification, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortCTS=ogSerialPortCTS, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceEntry=ogNetInterfaceEntry, ogHostIpV6Address=ogHostIpV6Address, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApEnabled=ogWifiApEnabled, ogNetInterfaceState=ogNetInterfaceState, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogSystem=ogSystem, ogAlarmSummary=ogAlarmSummary, ogCellModemModel=ogCellModemModel)
