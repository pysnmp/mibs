...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsHumidity=ogUpsHumidity, ogAlarmCheck=ogAlarmCheck, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogHostTable=ogHostTable, ogRpcOutletRpc=ogRpcOutletRpc, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyName=ogPowerSupplyName, ogUpsOutputNotification=ogUpsOutputNotification, ogSerialPortParityErrors=ogSerialPortParityErrors, ogSerialUserIndex=ogSerialUserIndex, ogNetInterfaceNotification=ogNetInterfaceNotification, ogRpcInputVoltage=ogRpcInputVoltage, ogCheckDeviceRef=ogCheckDeviceRef, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsInputCurrent=ogUpsInputCurrent, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckDeviceName=ogCheckDeviceName, ogWifiClientApMac=ogWifiClientApMac, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcOutletState=ogRpcOutletState, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdDioCounter=ogEmdDioCounter, ogAlarmLogTable=ogAlarmLogTable, ogEmdDioDirection=ogEmdDioDirection, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmLogEntry=ogAlarmLogEntry, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsLogEnabled=ogUpsLogEnabled, ogSystem=ogSystem, ogSerialPortBreaks=ogSerialPortBreaks, ogCellNetworkNotification=ogCellNetworkNotification, ogSerialPortRTS=ogSerialPortRTS, ogWifiClientIndex=ogWifiClientIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCellModemNetwork=ogCellModemNetwork, ogWifiApIeeeMode=ogWifiApIeeeMode, ogWifiApClientAp=ogWifiApClientAp, ogUpsDescription=ogUpsDescription, ogStatus2Conformance=ogStatus2Conformance, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialPortStopBits=ogSerialPortStopBits, ogCellApnNotification=ogCellApnNotification, ogCellModemRegistered=ogCellModemRegistered, ogAlarmTime=ogAlarmTime, ogHostServiceHost=ogHostServiceHost, ogHostIndex=ogHostIndex, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostServiceTable=ogHostServiceTable, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogStatus2Compliance=ogStatus2Compliance, ogWifiApClientEntry=ogWifiApClientEntry, ogCellModemIMSI=ogCellModemIMSI, ogWifiApTable=ogWifiApTable, ogAlarmUser=ogAlarmUser, ogWifiApClientTable=ogWifiApClientTable, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogAlarmEventId=ogAlarmEventId, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiApClientMac=ogWifiApClientMac, ogSerialPortDSR=ogSerialPortDSR, ogHostUserNotification=ogHostUserNotification, ogSerialNumber=ogSerialNumber, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmTriggerValue=ogAlarmTriggerValue, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsName=ogUpsName, ogEmdDioName=ogEmdDioName, ogCellModemTable=ogCellModemTable, ogCellModemCounter=ogCellModemCounter, ogCellModemEntry=ogCellModemEntry, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialPortFlowControl=ogSerialPortFlowControl, ogBasicStatusGroup=ogBasicStatusGroup, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPatternNotification=ogSerialPatternNotification, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogWebUserSourcePort=ogWebUserSourcePort, ogRpcOutletIndex=ogRpcOutletIndex, ogStatus2Compliances=ogStatus2Compliances, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogEmdName=ogEmdName, ogCheckType=ogCheckType, ogUpsConnectType=ogUpsConnectType, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogFirmwareVersion=ogFirmwareVersion, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCellModemConnected=ogCellModemConnected, ogEmdEntry=ogEmdEntry, ogRpcDescription=ogRpcDescription, ogRpcConnectType=ogRpcConnectType, ogHostEntry=ogHostEntry, ogSerialPortTable=ogSerialPortTable, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemTower=ogCellModemTower, ogWifiClientInterface=ogWifiClientInterface, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortMode=ogSerialPortMode, ogCustomNotification=ogCustomNotification, ogCheckResolveActions=ogCheckResolveActions, ogRpcTable=ogRpcTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputFrequency=ogUpsOutputFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogNetInterfaceType=ogNetInterfaceType, PYSNMP_MODULE_ID=ogStatus2, ogWifiClientEntry=ogWifiClientEntry, ogRpcName=ogRpcName, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletTable=ogRpcOutletTable, ogCheckIndex=ogCheckIndex, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogPowerSupplyTable=ogPowerSupplyTable, ogCellModemVendor=ogCellModemVendor, ogUpsTable=ogUpsTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogCellModem3gRssi=ogCellModem3gRssi, ogUpsType=ogUpsType, ogStatus2Groups=ogStatus2Groups, ogRpcIndex=ogRpcIndex, ogStatus2=ogStatus2, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientTable=ogWifiClientTable, ogHostUserTable=ogHostUserTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogEmdHumidityName=ogEmdHumidityName, ogRpcInputFrequency=ogRpcInputFrequency, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioType=ogEmdDioType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogWebUserTable=ogWebUserTable, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostUserName=ogHostUserName, ogRpcEntry=ogRpcEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogUpsOutputTruePower=ogUpsOutputTruePower, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogHostServiceNotification=ogHostServiceNotification, ogCellModemApn=ogCellModemApn, ogSerialPortRxBytes=ogSerialPortRxBytes, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCheckDeviceIndex=ogCheckDeviceIndex, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellTowerNotification=ogCellTowerNotification, ogHostServiceType=ogHostServiceType, ogMibNotifications=ogMibNotifications, ogHostUserHostName=ogHostUserHostName, ogUpsOutputPower=ogUpsOutputPower, ogEmdTemperatureName=ogEmdTemperatureName, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsInputFrequency=ogUpsInputFrequency, ogCellModemEnabled=ogCellModemEnabled, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogWifiClientMode=ogWifiClientMode, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCheckName=ogCheckName, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarm=ogAlarm, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialPortDCD=ogSerialPortDCD, ogEmdTable=ogEmdTable, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCheckTriggerActions=ogCheckTriggerActions, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientEssid=ogWifiClientEssid, ogSerialUserTable=ogSerialUserTable, ogEmdHumidityValue=ogEmdHumidityValue, ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsState=ogUpsState, ogHostServiceCounter=ogHostServiceCounter, ogHostUserEntry=ogHostUserEntry, ogEmdDescription=ogEmdDescription, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletName=ogRpcOutletName, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemIndex=ogCellModemIndex, ogWifiApClientRssi=ogWifiApClientRssi, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWebUserName=ogWebUserName, ogWifiApTxPower=ogWifiApTxPower, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmUser=ogCurrentAlarmUser, ogAlarmDevice=ogAlarmDevice, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcInputNotification=ogRpcInputNotification, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogUpsNotification=ogUpsNotification, ogSerialPortTxBytes=ogSerialPortTxBytes, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCurrentAlarmTime=ogCurrentAlarmTime, ogAlarmState=ogAlarmState, ogCheckResetTimeout=ogCheckResetTimeout, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogCellDataNotification=ogCellDataNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogCellMessageNotification=ogCellMessageNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogAlarmType=ogAlarmType, ogWifiApInterface=ogWifiApInterface, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogCellModemTemperature=ogCellModemTemperature, ogRpcCounter=ogRpcCounter, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletNotification=ogRpcOutletNotification, ogHostPingNotification=ogHostPingNotification, ogWifiApFrequency=ogWifiApFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogHostUserAddress=ogHostUserAddress, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogBasicAlarmGroup=ogBasicAlarmGroup, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogHostServicePort=ogHostServicePort, ogHostIpV6Address=ogHostIpV6Address, ogCheckTable=ogCheckTable, ogUpsTemperature=ogUpsTemperature)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogUpsInputNotification=ogUpsInputNotification, ogEmdDioIndex=ogEmdDioIndex, ogWifiApCounter=ogWifiApCounter, ogNetInterfaceState=ogNetInterfaceState, ogSerialPortLabel=ogSerialPortLabel, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcType=ogRpcType, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogEmdDioEntry=ogEmdDioEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogHostUserIndex=ogHostUserIndex, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioTable=ogEmdDioTable, ogNetInterfaceName=ogNetInterfaceName, ogSerialPortEntry=ogSerialPortEntry, ogWifiApIndex=ogWifiApIndex, ogSerialPortParity=ogSerialPortParity, ogEmdDioState=ogEmdDioState, ogHostServiceEntry=ogHostServiceEntry, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialPortDTR=ogSerialPortDTR, ogSerialUserPort=ogSerialUserPort, ogAlarmPreviousValue=ogAlarmPreviousValue, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsCounter=ogUpsCounter, ogEmdHumidityNotification=ogEmdHumidityNotification, ogSerialUserEntry=ogSerialUserEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdDioNotification=ogEmdDioNotification, ogCheckEntry=ogCheckEntry, ogHostUserStartTime=ogHostUserStartTime, ogRpcLogEnabled=ogRpcLogEnabled, ogAlarmCurrentValue=ogAlarmCurrentValue, ogEmdEnabled=ogEmdEnabled, ogEmdConnectType=ogEmdConnectType, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogCliUserSessionNotification=ogCliUserSessionNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsIndex=ogUpsIndex, ogCellModemModel=ogCellModemModel, ogWebUserStartTime=ogWebUserStartTime, ogEmdIndex=ogEmdIndex, ogHostName=ogHostName, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsEntry=ogUpsEntry, ogEmdDioDescription=ogEmdDioDescription, ogWifiApEntry=ogWifiApEntry, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmSummary=ogAlarmSummary, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogHostServiceStatus=ogHostServiceStatus, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortDataBits=ogSerialPortDataBits, ogHostIpV4Address=ogHostIpV4Address, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialUserName=ogSerialUserName, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApSsid=ogWifiApSsid, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiClientRssi=ogWifiClientRssi, ogHostUserHost=ogHostUserHost, ogSerialUserLabel=ogSerialUserLabel, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogAlarmName=ogAlarmName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent)
