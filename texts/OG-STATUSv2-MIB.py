...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogUpsOutputFrequency=ogUpsOutputFrequency, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcOutletTotal=ogRpcOutletTotal, ogSerialPortParity=ogSerialPortParity, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientMode=ogWifiClientMode, ogSerialNumber=ogSerialNumber, ogAlarmState=ogAlarmState, ogCurrentAlarmTime=ogCurrentAlarmTime, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogNetInterfaceName=ogNetInterfaceName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutputNotification=ogRpcOutputNotification, ogNetInterfaceType=ogNetInterfaceType, ogWifiApClientMac=ogWifiApClientMac, ogHostServiceStatus=ogHostServiceStatus, ogStatus2=ogStatus2, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsDescription=ogUpsDescription, ogSerialPortTable=ogSerialPortTable, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogEmdDioIndex=ogEmdDioIndex, ogEmdDioName=ogEmdDioName, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogUpsInputNotification=ogUpsInputNotification, ogHostUserName=ogHostUserName, ogCellModemConnected=ogCellModemConnected, ogUpsCounter=ogUpsCounter, ogCellModemNetwork=ogCellModemNetwork, ogAlarmTriggerValue=ogAlarmTriggerValue, ogEmdDioState=ogEmdDioState, ogCellModemTable=ogCellModemTable, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserTable=ogHostUserTable, ogSerialUserLabel=ogSerialUserLabel, ogUpsBatteryState=ogUpsBatteryState, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialUserEntry=ogSerialUserEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogAlarmTime=ogAlarmTime, ogWifiApTable=ogWifiApTable, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogAlarmLogTable=ogAlarmLogTable, ogSerialUserIndex=ogSerialUserIndex, ogRpcInputNotification=ogRpcInputNotification, ogHostUserEntry=ogHostUserEntry, ogHostServiceTable=ogHostServiceTable, ogEmdTemperatureName=ogEmdTemperatureName, ogEmdDioNotification=ogEmdDioNotification, ogEmdEntry=ogEmdEntry, ogWifiClientApMac=ogWifiClientApMac, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCellModemTemperature=ogCellModemTemperature, ogRpcName=ogRpcName, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsName=ogUpsName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWebUserSourcePort=ogWebUserSourcePort, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiApClientAp=ogWifiApClientAp, ogUpsState=ogUpsState, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCellMessageNotification=ogCellMessageNotification, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostUserHost=ogHostUserHost, ogWifiApCounter=ogWifiApCounter, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortEntry=ogSerialPortEntry, ogNetInterfaceState=ogNetInterfaceState, ogAlarmType=ogAlarmType, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsIndex=ogUpsIndex, ogEmdConnectType=ogEmdConnectType, ogEmdHumidityTotal=ogEmdHumidityTotal, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogUpsInputFrequency=ogUpsInputFrequency, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiClientEntry=ogWifiClientEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogSerialPortDCD=ogSerialPortDCD, ogCellModemIndex=ogCellModemIndex, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogSerialPortDSR=ogSerialPortDSR, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientEnabled=ogWifiClientEnabled, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcEntry=ogRpcEntry, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogRpcOutletName=ogRpcOutletName, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserStartTime=ogWebUserStartTime, ogUpsLogEnabled=ogUpsLogEnabled, ogSerialSignalNotification=ogSerialSignalNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogPowerSupplyIndex=ogPowerSupplyIndex, ogUpsHumidity=ogUpsHumidity, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApClientIndex=ogWifiApClientIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsOutputNotification=ogUpsOutputNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialUserName=ogSerialUserName, ogSerialUserPort=ogSerialUserPort, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioTable=ogEmdDioTable, ogWifiApTxPower=ogWifiApTxPower, ogSerialPatternNotification=ogSerialPatternNotification, ogAlarmSummary=ogAlarmSummary, ogUpsType=ogUpsType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortMode=ogSerialPortMode, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWebUserName=ogWebUserName, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcCounter=ogRpcCounter, ogHostServiceCounter=ogHostServiceCounter, PYSNMP_MODULE_ID=ogStatus2, ogHostIpV6Address=ogHostIpV6Address, ogCheckType=ogCheckType, ogRpcDescription=ogRpcDescription, ogWifiApInterface=ogWifiApInterface, ogWifiApSsid=ogWifiApSsid, ogCheckEntry=ogCheckEntry, ogPowerSupplyName=ogPowerSupplyName, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCheckDeviceName=ogCheckDeviceName, ogAlarmUser=ogAlarmUser, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogCheckDeviceRef=ogCheckDeviceRef, ogCellModemModel=ogCellModemModel, ogRpcInputFrequency=ogRpcInputFrequency, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogWifiApEntry=ogWifiApEntry, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogAlarmCurrentValue=ogAlarmCurrentValue, ogStatus2Conformance=ogStatus2Conformance, ogSerialPortLabel=ogSerialPortLabel, ogNetInterfaceNotification=ogNetInterfaceNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCellModemRegistered=ogCellModemRegistered, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogSystem=ogSystem, ogEmdTable=ogEmdTable, ogEmdName=ogEmdName, ogSerialPortCTS=ogSerialPortCTS, ogAlarmLogEntry=ogAlarmLogEntry, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogAlarmName=ogAlarmName, ogHostUserHostName=ogHostUserHostName, ogUpsTable=ogUpsTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostIndex=ogHostIndex, ogSerialPortStopBits=ogSerialPortStopBits, ogStatus2Compliance=ogStatus2Compliance, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogUpsOutputCurrent=ogUpsOutputCurrent, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogHostPingNotification=ogHostPingNotification, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletTable=ogRpcOutletTable, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioCounter=ogEmdDioCounter, ogCellModemIMSI=ogCellModemIMSI, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientTable=ogWifiApClientTable, ogCheckName=ogCheckName, ogRpcInputCurrent=ogRpcInputCurrent, ogStatus2Groups=ogStatus2Groups, ogAlarmDevice=ogAlarmDevice, ogUpsConnectType=ogUpsConnectType, ogPowerSupplyEntry=ogPowerSupplyEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsNotification=ogUpsNotification, ogSerialUserNotification=ogSerialUserNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogRpcOutletVoltage=ogRpcOutletVoltage, ogWifiClientRssi=ogWifiClientRssi, ogHostUserStartTime=ogHostUserStartTime, ogEmdHumidityTable=ogEmdHumidityTable, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcOutletNotification=ogRpcOutletNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogHostTable=ogHostTable, ogSerialPortSpeed=ogSerialPortSpeed, ogWebUserNotification=ogWebUserNotification, ogCurrentAlarmType=ogCurrentAlarmType, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortParityErrors=ogSerialPortParityErrors, ogHostServiceIndex=ogHostServiceIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsOutputPower=ogUpsOutputPower, ogUpsInputVoltage=ogUpsInputVoltage, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogUpsOutputVoltage=ogUpsOutputVoltage, ogHostUserIndex=ogHostUserIndex, ogHostServiceEntry=ogHostServiceEntry, ogWebUserIndex=ogWebUserIndex, ogWifiClientIndex=ogWifiClientIndex, ogWifiClientEssid=ogWifiClientEssid, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletState=ogRpcOutletState, ogCellDataNotification=ogCellDataNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemEntry=ogCellModemEntry, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogCheckTable=ogCheckTable, ogCellModem3gRssi=ogCellModem3gRssi, ogCellModem4gRssi=ogCellModem4gRssi, ogCheckTriggerActions=ogCheckTriggerActions, ogCurrentAlarmName=ogCurrentAlarmName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogStatus2Compliances=ogStatus2Compliances, ogHostUserAddress=ogHostUserAddress, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCellModemVendor=ogCellModemVendor, ogEmdEnabled=ogEmdEnabled, ogWifiApIndex=ogWifiApIndex, ogRpcConnectType=ogRpcConnectType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCurrentAlarmState=ogCurrentAlarmState, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDescription=ogEmdDescription, ogMibNotifications=ogMibNotifications, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdDioEntry=ogEmdDioEntry, ogHostServicePort=ogHostServicePort, ogWifiClientTable=ogWifiClientTable, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutletEntry=ogRpcOutletEntry, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarmInstance=ogAlarmInstance, ogAlarmEventId=ogAlarmEventId, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialUserStartTime=ogSerialUserStartTime, ogCellModemApn=ogCellModemApn, ogCellModemTower=ogCellModemTower, ogRpcTable=ogRpcTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogCellSignalNotification=ogCellSignalNotification, ogRpcIndex=ogRpcIndex, ogFirmwareVersion=ogFirmwareVersion, ogHostServiceType=ogHostServiceType, ogCustomNotification=ogCustomNotification, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogHostUserNotification=ogHostUserNotification, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdIndex=ogEmdIndex, ogEmdDioEmd=ogEmdDioEmd, ogWifiClientCounter=ogWifiClientCounter, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogSerialUserTable=ogSerialUserTable, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApFrequency=ogWifiApFrequency, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogWifiClientInterface=ogWifiClientInterface, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortDTR=ogSerialPortDTR, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcType=ogRpcType, ogSerialPortRxBytes=ogSerialPortRxBytes, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogCellApnNotification=ogCellApnNotification, ogWebUserTable=ogWebUserTable, ogEmdDioDescription=ogEmdDioDescription, ogHostServiceHost=ogHostServiceHost, ogUpsTemperature=ogUpsTemperature, ogCheckIndex=ogCheckIndex, ogCellModemCounter=ogCellModemCounter, ogWifiClientFrequency=ogWifiClientFrequency, ogAlarmCheck=ogAlarmCheck, ogSerialPortRTS=ogSerialPortRTS, ogUpsOutputTruePower=ogUpsOutputTruePower, ogEmdDioType=ogEmdDioType, ogRpcOutletIndex=ogRpcOutletIndex, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogHostServiceNotification=ogHostServiceNotification, ogUpsEntry=ogUpsEntry, ogSerialPortIndex=ogSerialPortIndex, ogHostName=ogHostName, ogHostEntry=ogHostEntry, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogBasicStatusGroup=ogBasicStatusGroup, ogBasicNotificationGroup=ogBasicNotificationGroup, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarm=ogAlarm)
