...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcOutputNotification=ogRpcOutputNotification, ogEmdDioInputTotal=ogEmdDioInputTotal, ogHostPingNotification=ogHostPingNotification, ogSerialUserLabel=ogSerialUserLabel, ogEmdDioType=ogEmdDioType, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCheckDeviceEntry=ogCheckDeviceEntry, ogHostUserHost=ogHostUserHost, ogHostServiceNotification=ogHostServiceNotification, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogSerialPortMode=ogSerialPortMode, ogAlarmState=ogAlarmState, ogEmdHumidityEmd=ogEmdHumidityEmd, ogUpsIndex=ogUpsIndex, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcOutletVoltage=ogRpcOutletVoltage, ogStatus2Groups=ogStatus2Groups, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogHostUserStartTime=ogHostUserStartTime, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogEmdIndex=ogEmdIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogEmdLogEnabled=ogEmdLogEnabled, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiClientTxPower=ogWifiClientTxPower, ogHostServiceHost=ogHostServiceHost, ogEmdHumidityValue=ogEmdHumidityValue, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsInputCurrent=ogUpsInputCurrent, ogUpsDescription=ogUpsDescription, ogAlarmName=ogAlarmName, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogCheckResolveActions=ogCheckResolveActions, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortIndex=ogSerialPortIndex, ogRpcName=ogRpcName, ogSerialPortRxBytes=ogSerialPortRxBytes, ogHostName=ogHostName, ogUpsType=ogUpsType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWifiClientApMac=ogWifiClientApMac, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogNetInterfaceEntry=ogNetInterfaceEntry, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialUserPort=ogSerialUserPort, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortFlowControl=ogSerialPortFlowControl, ogUpsOutputLoad=ogUpsOutputLoad, ogSerialUserName=ogSerialUserName, ogCheckEntry=ogCheckEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogEmdDioName=ogEmdDioName, ogEmdTable=ogEmdTable, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserTable=ogWebUserTable, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcIndex=ogRpcIndex, ogEmdDioState=ogEmdDioState, ogHostServiceIndex=ogHostServiceIndex, ogWifiApCounter=ogWifiApCounter, ogUpsCounter=ogUpsCounter, ogAlarmCurrentValue=ogAlarmCurrentValue, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientFrequency=ogWifiClientFrequency, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogHostUserTable=ogHostUserTable, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdConnectType=ogEmdConnectType, ogUpsOutputFrequency=ogUpsOutputFrequency, ogSerialPortParity=ogSerialPortParity, ogCellModem4gRssi=ogCellModem4gRssi, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCellModemTower=ogCellModemTower, ogWifiApTxPower=ogWifiApTxPower, ogAlarmType=ogAlarmType, ogWifiApClientMac=ogWifiApClientMac, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiApClientAp=ogWifiApClientAp, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogSerialPortDataBits=ogSerialPortDataBits, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogWebUserNotification=ogWebUserNotification, ogWifiClientEntry=ogWifiClientEntry, ogUpsConnectType=ogUpsConnectType, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogUpsOutputPower=ogUpsOutputPower, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogWifiApFrequency=ogWifiApFrequency, ogCheckIndex=ogCheckIndex, ogCellSignalNotification=ogCellSignalNotification, ogUpsName=ogUpsName, ogBasicStatusGroup=ogBasicStatusGroup, ogHostIpV6Address=ogHostIpV6Address, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogSerialPortTable=ogSerialPortTable, ogWifiApIeeeMode=ogWifiApIeeeMode, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPatternNotification=ogSerialPatternNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogUpsInputNotification=ogUpsInputNotification, ogCellModemVendor=ogCellModemVendor, ogHostUserEntry=ogHostUserEntry, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientEssid=ogWifiClientEssid, ogCheckType=ogCheckType, ogAlarmUser=ogAlarmUser, ogBasicAlarmGroup=ogBasicAlarmGroup, ogAlarmEventId=ogAlarmEventId, ogRpcOutletTotal=ogRpcOutletTotal, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCheckDeviceRef=ogCheckDeviceRef, ogCellTowerNotification=ogCellTowerNotification, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCurrentAlarmType=ogCurrentAlarmType, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemEnabled=ogCellModemEnabled, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientMode=ogWifiClientMode, ogCellModemEntry=ogCellModemEntry, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellApnNotification=ogCellApnNotification, ogAlarmLogTable=ogAlarmLogTable, ogSerialUserNotification=ogSerialUserNotification, ogCellMessageNotification=ogCellMessageNotification, ogStatus2Compliances=ogStatus2Compliances, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientTable=ogWifiClientTable, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDioCounter=ogEmdDioCounter, ogRpcOutletTable=ogRpcOutletTable, ogCellModemApn=ogCellModemApn, ogCustomNotification=ogCustomNotification, ogRpcTable=ogRpcTable, ogWifiApInterface=ogWifiApInterface, ogSerialPortLabel=ogSerialPortLabel, ogEmdName=ogEmdName, ogEmdEnabled=ogEmdEnabled, ogWebUserName=ogWebUserName, ogHostUserNotification=ogHostUserNotification, ogEmdDescription=ogEmdDescription, ogWifiApEntry=ogWifiApEntry, ogSerialUserEntry=ogSerialUserEntry, ogEmdDioEmd=ogEmdDioEmd, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdDioEntry=ogEmdDioEntry, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdHumidityName=ogEmdHumidityName, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogAlarmLogEntry=ogAlarmLogEntry, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogRpcCounter=ogRpcCounter, ogRpcMaxTemperature=ogRpcMaxTemperature, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemRegistered=ogCellModemRegistered, ogSerialPortDCD=ogSerialPortDCD, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortDSR=ogSerialPortDSR, ogPowerSupplyTable=ogPowerSupplyTable, ogRpcDescription=ogRpcDescription, ogSerialPortEntry=ogSerialPortEntry, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiApTable=ogWifiApTable, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostServiceTable=ogHostServiceTable, ogUpsOutputVoltage=ogUpsOutputVoltage, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiApIndex=ogWifiApIndex, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcInputCurrent=ogRpcInputCurrent, ogStatus2Conformance=ogStatus2Conformance, ogRpcEntry=ogRpcEntry, ogRpcOutletName=ogRpcOutletName, ogUpsState=ogUpsState, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsOutputNotification=ogUpsOutputNotification, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioNotification=ogEmdDioNotification, ogWebUserStartTime=ogWebUserStartTime, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiApClientRssi=ogWifiApClientRssi, ogWifiApClientTable=ogWifiApClientTable, ogRpcOutletEntry=ogRpcOutletEntry, ogSystem=ogSystem, ogHostServicePort=ogHostServicePort, ogMibNotifications=ogMibNotifications, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogAlarmInstance=ogAlarmInstance, ogHostUserAddress=ogHostUserAddress, ogCurrentAlarmState=ogCurrentAlarmState, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogHostUserHostName=ogHostUserHostName, ogCurrentAlarmName=ogCurrentAlarmName, ogCellModemTemperature=ogCellModemTemperature, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogHostUserIndex=ogHostUserIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogUpsNotification=ogUpsNotification, ogAlarmSummary=ogAlarmSummary, ogCheckDeviceName=ogCheckDeviceName, ogSerialUserStartTime=ogSerialUserStartTime, ogCheckName=ogCheckName, ogWifiClientIndex=ogWifiClientIndex, ogAlarm=ogAlarm, ogCheckResetTimeout=ogCheckResetTimeout, ogSerialPortDTR=ogSerialPortDTR, ogHostUserName=ogHostUserName, ogEmdEntry=ogEmdEntry, ogHostServiceEntry=ogHostServiceEntry, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcInputNotification=ogRpcInputNotification, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogHostEntry=ogHostEntry, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmPreviousValue=ogAlarmPreviousValue, ogNetInterfaceTable=ogNetInterfaceTable, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortRTS=ogSerialPortRTS, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsHumidity=ogUpsHumidity, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcOutletRpc=ogRpcOutletRpc, ogWebUserIndex=ogWebUserIndex, ogCellModemIndex=ogCellModemIndex, ogEmdHumidityIndex=ogEmdHumidityIndex, PYSNMP_MODULE_ID=ogStatus2, ogCheckTriggerActions=ogCheckTriggerActions, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyName=ogPowerSupplyName, ogUpsInputFrequency=ogUpsInputFrequency, ogAlarmTriggerValue=ogAlarmTriggerValue, ogUpsTemperature=ogUpsTemperature, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogEmdHumidityTable=ogEmdHumidityTable, ogCheckRepeatTimeout=ogCheckRepeatTimeout)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogUpsBatteryState=ogUpsBatteryState, ogEmdDioDirection=ogEmdDioDirection, ogWifiApAuthNotification=ogWifiApAuthNotification, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCellModemNetwork=ogCellModemNetwork, ogEmdDioTable=ogEmdDioTable, ogWifiClientRssi=ogWifiClientRssi, ogSerialUserTable=ogSerialUserTable, ogStatus2Compliance=ogStatus2Compliance, ogEmdHumidityTotal=ogEmdHumidityTotal, ogWifiApSsid=ogWifiApSsid, ogHostIndex=ogHostIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogRpcOutletState=ogRpcOutletState, ogWifiApClientEntry=ogWifiApClientEntry, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcInputVoltage=ogRpcInputVoltage, ogSerialUserIndex=ogSerialUserIndex, ogStatus2=ogStatus2, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcOutletLoad=ogRpcOutletLoad, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdTemperatureName=ogEmdTemperatureName, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemSessionTime=ogCellModemSessionTime, ogUpsEntry=ogUpsEntry, ogHostTable=ogHostTable, ogHostIpV4Address=ogHostIpV4Address, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogSerialPortLogLevel=ogSerialPortLogLevel, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiClientCounter=ogWifiClientCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogCellModemModel=ogCellModemModel, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemCounter=ogCellModemCounter, ogRpcType=ogRpcType, ogFirmwareVersion=ogFirmwareVersion, ogHostServiceCounter=ogHostServiceCounter, ogWifiApEnabled=ogWifiApEnabled, ogNetInterfaceType=ogNetInterfaceType, ogAlarmCheck=ogAlarmCheck, ogUpsTable=ogUpsTable, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioIndex=ogEmdDioIndex, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellDataNotification=ogCellDataNotification, ogCellModemTable=ogCellModemTable, ogAlarmTime=ogAlarmTime, ogAlarmDevice=ogAlarmDevice, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckTable=ogCheckTable, ogSerialNumber=ogSerialNumber, ogHostServiceType=ogHostServiceType, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsInputVoltage=ogUpsInputVoltage, ogCellModemConnected=ogCellModemConnected, ogRpcConnectType=ogRpcConnectType, ogWebUserEntry=ogWebUserEntry, ogCellModemIMSI=ogCellModemIMSI, ogSerialPortCTS=ogSerialPortCTS, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientBitRate=ogWifiClientBitRate, ogRpcOutletIndex=ogRpcOutletIndex)
