...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogRpcCounter=ogRpcCounter, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiApTable=ogWifiApTable, ogAlarmTriggerValue=ogAlarmTriggerValue, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdDioEmd=ogEmdDioEmd, ogUpsState=ogUpsState, ogUpsDescription=ogUpsDescription, ogHostPingNotification=ogHostPingNotification, ogEmdDioIndex=ogEmdDioIndex, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientApMac=ogWifiClientApMac, ogHostServiceIndex=ogHostServiceIndex, ogWifiApClientAp=ogWifiApClientAp, ogRpcTable=ogRpcTable, ogHostServiceTable=ogHostServiceTable, ogRpcOutletEntry=ogRpcOutletEntry, ogSerialPortDTR=ogSerialPortDTR, ogRpcDescription=ogRpcDescription, ogWifiApClientMac=ogWifiApClientMac, ogCellModem4gRssi=ogCellModem4gRssi, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogAlarmSummary=ogAlarmSummary, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogWifiClientEssid=ogWifiClientEssid, ogCellTowerNotification=ogCellTowerNotification, ogStatus2Compliance=ogStatus2Compliance, ogWebUserNotification=ogWebUserNotification, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogSerialPortIndex=ogSerialPortIndex, ogHostServicePort=ogHostServicePort, ogCellModemApn=ogCellModemApn, ogAlarm=ogAlarm, ogEmdDioDirection=ogEmdDioDirection, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogCellModemVendor=ogCellModemVendor, ogHostTable=ogHostTable, ogSerialUserTable=ogSerialUserTable, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogAlarmState=ogAlarmState, ogStatus2=ogStatus2, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCheckDeviceName=ogCheckDeviceName, ogSerialPatternNotification=ogSerialPatternNotification, ogHostUserIndex=ogHostUserIndex, ogHostUserName=ogHostUserName, ogUpsTemperature=ogUpsTemperature, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcLogEnabled=ogRpcLogEnabled, ogSerialPortSpeed=ogSerialPortSpeed, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogCellMessageNotification=ogCellMessageNotification, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogHostUserStartTime=ogHostUserStartTime, ogEmdDioCounter=ogEmdDioCounter, ogAlarmLogTable=ogAlarmLogTable, ogUpsOutputCurrent=ogUpsOutputCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogCellModemCounter=ogCellModemCounter, ogBasicNotificationGroup=ogBasicNotificationGroup, ogCellModemRegistered=ogCellModemRegistered, ogHostServiceEntry=ogHostServiceEntry, ogEmdLogEnabled=ogEmdLogEnabled, ogAlarmInstance=ogAlarmInstance, ogNetInterfaceState=ogNetInterfaceState, ogEmdTemperatureValue=ogEmdTemperatureValue, ogNetInterfaceIndex=ogNetInterfaceIndex, ogCellModemEnabled=ogCellModemEnabled, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogHostServiceHost=ogHostServiceHost, ogCheckDeviceIndex=ogCheckDeviceIndex, ogSerialPortDCD=ogSerialPortDCD, ogAlarmLogEntry=ogAlarmLogEntry, ogHostEntry=ogHostEntry, ogCellApnNotification=ogCellApnNotification, ogCheckIndex=ogCheckIndex, ogWifiApClientTable=ogWifiApClientTable, ogSerialPortEntry=ogSerialPortEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientCounter=ogWifiClientCounter, ogHostIpV4Address=ogHostIpV4Address, ogHostIpV6Address=ogHostIpV6Address, ogRpcOutletName=ogRpcOutletName, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostServiceStatus=ogHostServiceStatus, ogRpcType=ogRpcType, ogAlarmName=ogAlarmName, ogPowerSupplyEntry=ogPowerSupplyEntry, ogCheckType=ogCheckType, ogHostName=ogHostName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWebUserSourceAddress=ogWebUserSourceAddress, ogEmdEnabled=ogEmdEnabled, ogCurrentAlarmTime=ogCurrentAlarmTime, ogEmdName=ogEmdName, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogCheckName=ogCheckName, ogCheckDeviceCheck=ogCheckDeviceCheck, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCliUserSessionNotification=ogCliUserSessionNotification, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsCounter=ogUpsCounter, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogEmdTable=ogEmdTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogAlarmTime=ogAlarmTime, ogCurrentAlarmType=ogCurrentAlarmType, ogUpsOutputTruePower=ogUpsOutputTruePower, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcConnectType=ogRpcConnectType, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdHumidityTable=ogEmdHumidityTable, ogWifiClientRssi=ogWifiClientRssi, ogEmdHumidityEntry=ogEmdHumidityEntry, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserName=ogWebUserName, ogSerialPortTable=ogSerialPortTable, ogWifiApIndex=ogWifiApIndex, ogEmdHumidityCounter=ogEmdHumidityCounter, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWebUserStartTime=ogWebUserStartTime, ogWifiApClientRssi=ogWifiApClientRssi, ogEmdTemperatureTable=ogEmdTemperatureTable, ogEmdTemperatureName=ogEmdTemperatureName, ogCheckDeviceEntry=ogCheckDeviceEntry, ogRpcMaxTemperature=ogRpcMaxTemperature, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsIndex=ogUpsIndex, ogEmdIndex=ogEmdIndex, ogUpsType=ogUpsType, ogHostIndex=ogHostIndex, ogUpsOutputPower=ogUpsOutputPower, ogNetInterfaceName=ogNetInterfaceName, ogWifiClientTxPower=ogWifiClientTxPower, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCellModemEntry=ogCellModemEntry, ogUpsTable=ogUpsTable, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogAlarmUser=ogAlarmUser, ogCheckResolveActions=ogCheckResolveActions, ogMibNotifications=ogMibNotifications, ogStatus2Groups=ogStatus2Groups, ogRpcEntry=ogRpcEntry, ogUpsHumidity=ogUpsHumidity, ogCellModem3gRssi=ogCellModem3gRssi, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCheckTable=ogCheckTable, ogRpcInputNotification=ogRpcInputNotification, ogRpcIndex=ogRpcIndex, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortBreaks=ogSerialPortBreaks, ogWifiClientEnabled=ogWifiClientEnabled, ogCurrentAlarmName=ogCurrentAlarmName, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogSerialUserIndex=ogSerialUserIndex, ogCellModemTemperature=ogCellModemTemperature, ogAlarmCheck=ogAlarmCheck, ogWifiApClientEntry=ogWifiApClientEntry, ogHostUserNotification=ogHostUserNotification, ogCellModemTower=ogCellModemTower, ogCellNetworkNotification=ogCellNetworkNotification, ogEmdHumidityDescription=ogEmdHumidityDescription, ogWifiClientEntry=ogWifiClientEntry, ogWifiClientTable=ogWifiClientTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogCustomNotification=ogCustomNotification, ogUpsInputCurrent=ogUpsInputCurrent, ogRpcName=ogRpcName, ogWifiApEntry=ogWifiApEntry, ogSerialUserLabel=ogSerialUserLabel, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserTable=ogHostUserTable, ogSerialSignalNotification=ogSerialSignalNotification, ogAlarmType=ogAlarmType, ogEmdDioTable=ogEmdDioTable, ogUpsConnectType=ogUpsConnectType, ogSerialUserStartTime=ogSerialUserStartTime, ogUpsNotification=ogUpsNotification, ogUpsName=ogUpsName, ogHostServiceNotification=ogHostServiceNotification, ogUpsBatteryNotification=ogUpsBatteryNotification, ogHostUserHost=ogHostUserHost, ogWifiApInterface=ogWifiApInterface, ogSystem=ogSystem, ogWebUserIndex=ogWebUserIndex, ogEmdEntry=ogEmdEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogCellModemIndex=ogCellModemIndex, ogHostUserHostName=ogHostUserHostName, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApSsid=ogWifiApSsid, ogWifiApCounter=ogWifiApCounter, ogUpsEntry=ogUpsEntry, PYSNMP_MODULE_ID=ogStatus2, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckDeviceTable=ogCheckDeviceTable, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemConnected=ogCellModemConnected, ogSerialPortRTS=ogSerialPortRTS, ogCheckEntry=ogCheckEntry, ogEmdHumidityTotal=ogEmdHumidityTotal, ogNetInterfaceNotification=ogNetInterfaceNotification, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogRpcOutletTotal=ogRpcOutletTotal, ogHostServiceType=ogHostServiceType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogHostUserAddress=ogHostUserAddress, ogUpsInputNotification=ogUpsInputNotification, ogEmdDioState=ogEmdDioState, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogWifiClientIndex=ogWifiClientIndex, ogWebUserEntry=ogWebUserEntry, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogEmdDioNotification=ogEmdDioNotification, ogEmdDioType=ogEmdDioType, ogSerialNumber=ogSerialNumber, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogSerialPortLabel=ogSerialPortLabel, ogWifiClientConnectNotification=ogWifiClientConnectNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdDescription=ogEmdDescription, ogEmdHumidityValue=ogEmdHumidityValue, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogSerialPortParity=ogSerialPortParity, ogNetInterfaceTable=ogNetInterfaceTable, ogEmdDioDescription=ogEmdDioDescription, ogFirmwareVersion=ogFirmwareVersion, ogCheckResetTimeout=ogCheckResetTimeout, ogEmdHumidityName=ogEmdHumidityName, ogWebUserTable=ogWebUserTable, ogEmdConnectType=ogEmdConnectType, ogSerialUserName=ogSerialUserName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialPortMode=ogSerialPortMode, ogSerialUserNotification=ogSerialUserNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogCheckDeviceRef=ogCheckDeviceRef, ogSerialUserPort=ogSerialUserPort, ogNetInterfaceType=ogNetInterfaceType, ogUpsBatteryState=ogUpsBatteryState, ogRpcOutletState=ogRpcOutletState, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioName=ogEmdDioName, ogCellModemModel=ogCellModemModel, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogUpsOutputVoltage=ogUpsOutputVoltage, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogCellDataNotification=ogCellDataNotification, ogPowerSupplyName=ogPowerSupplyName, ogStatus2Conformance=ogStatus2Conformance, ogHostServiceCounter=ogHostServiceCounter, ogStatus2Compliances=ogStatus2Compliances, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiClientInterface=ogWifiClientInterface, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarmDevice=ogAlarmDevice, ogSerialPortRxBytes=ogSerialPortRxBytes, ogWifiApIeeeMode=ogWifiApIeeeMode, ogAlarmPreviousValue=ogAlarmPreviousValue, ogAlarmEventId=ogAlarmEventId, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogCellModemNetwork=ogCellModemNetwork, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialUserEntry=ogSerialUserEntry, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcOutletRpc=ogRpcOutletRpc, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogUpsOutputNotification=ogUpsOutputNotification, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogRpcOutletIndex=ogRpcOutletIndex, ogSerialPortCTS=ogSerialPortCTS, ogRpcOutletNotification=ogRpcOutletNotification, ogSerialPortDSR=ogSerialPortDSR, ogCellModemTable=ogCellModemTable, ogWifiApFrequency=ogWifiApFrequency, ogWifiApEnabled=ogWifiApEnabled, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientMode=ogWifiClientMode, ogWifiApTxPower=ogWifiApTxPower, ogAlarmLogIndex=ogAlarmLogIndex, ogCurrentAlarmUser=ogCurrentAlarmUser)
