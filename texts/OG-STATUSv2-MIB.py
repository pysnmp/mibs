...
Bits, NotificationType, Counter32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Counter64, Unsigned32, Gauge32, ObjectIdentity, Integer32, IpAddress, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "Counter32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Counter64", "Unsigned32", "Gauge32", "ObjectIdentity", "Integer32", "IpAddress", "ModuleIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogRpcMaxTemperature=ogRpcMaxTemperature, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemIMSI=ogCellModemIMSI, ogWifiApEnabled=ogWifiApEnabled, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsHumidity=ogUpsHumidity, ogEmdHumidityTotal=ogEmdHumidityTotal, ogUpsInputCurrent=ogUpsInputCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogCheckResetTimeout=ogCheckResetTimeout, PYSNMP_MODULE_ID=ogStatus2, ogWifiApTable=ogWifiApTable, ogSerialPortTxBytes=ogSerialPortTxBytes, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientInterface=ogWifiClientInterface, ogHostUserHostName=ogHostUserHostName, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsTemperature=ogUpsTemperature, ogCurrentAlarmTime=ogCurrentAlarmTime, ogWifiApIndex=ogWifiApIndex, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortDTR=ogSerialPortDTR, ogAlarmState=ogAlarmState, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcCounter=ogRpcCounter, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiClientEnabled=ogWifiClientEnabled, ogAlarmTriggerValue=ogAlarmTriggerValue, ogRpcConnectType=ogRpcConnectType, ogWebUserTable=ogWebUserTable, ogRpcOutletTotal=ogRpcOutletTotal, ogRpcTable=ogRpcTable, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogBasicStatusGroup=ogBasicStatusGroup, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdName=ogEmdName, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogUpsType=ogUpsType, ogHostName=ogHostName, ogHostIpV4Address=ogHostIpV4Address, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogPowerSupplyEntry=ogPowerSupplyEntry, ogRpcInputCurrent=ogRpcInputCurrent, ogCheckName=ogCheckName, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogHostTable=ogHostTable, ogRpcOutletVoltage=ogRpcOutletVoltage, ogUpsInputFrequency=ogUpsInputFrequency, ogHostServiceNotification=ogHostServiceNotification, ogRpcIndex=ogRpcIndex, ogCellModemTable=ogCellModemTable, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientTable=ogWifiClientTable, ogWifiApClientRssi=ogWifiApClientRssi, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostServiceHost=ogHostServiceHost, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemApn=ogCellModemApn, ogUpsIndex=ogUpsIndex, ogWifiApIeeeMode=ogWifiApIeeeMode, ogSerialPortRTS=ogSerialPortRTS, ogCellModem4gRssi=ogCellModem4gRssi, ogSerialUserTable=ogSerialUserTable, ogHostServiceType=ogHostServiceType, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCellModemEnabled=ogCellModemEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogRpcOutletTable=ogRpcOutletTable, ogSerialPortSpeed=ogSerialPortSpeed, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckResolveActions=ogCheckResolveActions, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortDSR=ogSerialPortDSR, ogSerialUserIndex=ogSerialUserIndex, ogPowerSupplyIndex=ogPowerSupplyIndex, ogRpcOutletCurrent=ogRpcOutletCurrent, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdDioEmd=ogEmdDioEmd, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogWebUserNotification=ogWebUserNotification, ogWifiApClientAp=ogWifiApClientAp, ogWifiApCounter=ogWifiApCounter, ogWifiClientTxPower=ogWifiClientTxPower, ogCheckType=ogCheckType, ogRpcOutputNotification=ogRpcOutputNotification, ogUpsBatteryState=ogUpsBatteryState, ogCheckIndex=ogCheckIndex, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialUserEntry=ogSerialUserEntry, ogWebUserIndex=ogWebUserIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogStatus2Conformance=ogStatus2Conformance, ogCheckDeviceRef=ogCheckDeviceRef, ogCellMessageNotification=ogCellMessageNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogCellModemEntry=ogCellModemEntry, ogSerialPortLabel=ogSerialPortLabel, ogRpcOutletNotification=ogRpcOutletNotification, ogEmdIndex=ogEmdIndex, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortParity=ogSerialPortParity, ogCellNetworkNotification=ogCellNetworkNotification, ogCheckDeviceName=ogCheckDeviceName, ogSerialNumber=ogSerialNumber, ogCellModemNetwork=ogCellModemNetwork, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdTemperatureValue=ogEmdTemperatureValue, ogCellModemCounter=ogCellModemCounter, ogUpsCounter=ogUpsCounter, ogWifiClientApMac=ogWifiClientApMac, ogUpsOutputPower=ogUpsOutputPower, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmLogIndex=ogAlarmLogIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCellModemConnected=ogCellModemConnected, ogCurrentAlarmState=ogCurrentAlarmState, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogCheckDeviceIndex=ogCheckDeviceIndex, ogEmdHumidityTable=ogEmdHumidityTable, ogCellModemSessionTime=ogCellModemSessionTime, ogHostUserIndex=ogHostUserIndex, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogAlarmUser=ogAlarmUser, ogSerialUserNotification=ogSerialUserNotification, ogSerialPortDCD=ogSerialPortDCD, ogCellTowerNotification=ogCellTowerNotification, ogWifiApEntry=ogWifiApEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogStatus2=ogStatus2, ogHostUserAddress=ogHostUserAddress, ogEmdDescription=ogEmdDescription, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWifiApInterface=ogWifiApInterface, ogCellApnNotification=ogCellApnNotification, ogHostIpV6Address=ogHostIpV6Address, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogCellModemTemperature=ogCellModemTemperature, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogSerialPortEntry=ogSerialPortEntry, ogHostServiceCounter=ogHostServiceCounter, ogHostUserEntry=ogHostUserEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogEmdDioDirection=ogEmdDioDirection, ogRpcInputFrequency=ogRpcInputFrequency, ogEmdTable=ogEmdTable, ogRpcType=ogRpcType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogUpsDescription=ogUpsDescription, ogCellDataNotification=ogCellDataNotification, ogUpsOutputFrequency=ogUpsOutputFrequency, ogCheckDeviceTable=ogCheckDeviceTable, ogCellModemModel=ogCellModemModel, ogNetInterfaceIndex=ogNetInterfaceIndex, ogRpcOutletState=ogRpcOutletState, ogEmdTemperatureName=ogEmdTemperatureName, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialUserPort=ogSerialUserPort, ogUpsState=ogUpsState, ogUpsOutputVoltage=ogUpsOutputVoltage, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCurrentAlarmName=ogCurrentAlarmName, ogNetInterfaceName=ogNetInterfaceName, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityEmd=ogEmdHumidityEmd, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogAlarmPreviousValue=ogAlarmPreviousValue, ogSerialUserLabel=ogSerialUserLabel, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogWifiApClientMac=ogWifiApClientMac, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogFirmwareVersion=ogFirmwareVersion, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiClientEssid=ogWifiClientEssid, ogUpsConnectType=ogUpsConnectType, ogEmdHumidityEntry=ogEmdHumidityEntry, ogSerialPortParityErrors=ogSerialPortParityErrors, ogEmdHumidityDescription=ogEmdHumidityDescription, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmEventId=ogAlarmEventId, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogRpcOutletLoad=ogRpcOutletLoad, ogCustomNotification=ogCustomNotification, ogEmdDioNotification=ogEmdDioNotification, ogWebUserStartTime=ogWebUserStartTime, ogNetInterfaceState=ogNetInterfaceState, ogCellSignalNotification=ogCellSignalNotification, ogHostUserNotification=ogHostUserNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogHostServiceStatus=ogHostServiceStatus, ogWifiApAuthNotification=ogWifiApAuthNotification, ogAlarmSummary=ogAlarmSummary, ogCheckTable=ogCheckTable, ogBasicAlarmGroup=ogBasicAlarmGroup, ogHostUserName=ogHostUserName, ogWifiApFrequency=ogWifiApFrequency, ogRpcDescription=ogRpcDescription, ogUpsInputNotification=ogUpsInputNotification, ogSerialPatternNotification=ogSerialPatternNotification, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCurrentAlarmUser=ogCurrentAlarmUser, ogCellModemVendor=ogCellModemVendor, ogWifiClientRssi=ogWifiClientRssi, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckDeviceEntry=ogCheckDeviceEntry, ogEmdDioTable=ogEmdDioTable, ogEmdDioCounter=ogEmdDioCounter, ogAlarm=ogAlarm, ogUpsName=ogUpsName, ogHostUserTable=ogHostUserTable, ogEmdDioName=ogEmdDioName, ogEmdHumidityName=ogEmdHumidityName, ogStatus2Groups=ogStatus2Groups, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogWebUserSourcePort=ogWebUserSourcePort, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogWebUserName=ogWebUserName, ogAlarmType=ogAlarmType, ogAlarmTime=ogAlarmTime, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogEmdDioType=ogEmdDioType, ogUpsOutputCurrent=ogUpsOutputCurrent, ogSerialPortIndex=ogSerialPortIndex, ogEmdDioEntry=ogEmdDioEntry, ogRpcName=ogRpcName, ogSerialPortLogLevel=ogSerialPortLogLevel, ogCellModemTower=ogCellModemTower, ogCheckEntry=ogCheckEntry, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogStatus2Compliances=ogStatus2Compliances, ogCheckDeviceCheck=ogCheckDeviceCheck, ogSerialPortTable=ogSerialPortTable, ogEmdDioState=ogEmdDioState, ogEmdDioIndex=ogEmdDioIndex, ogAlarmName=ogAlarmName, ogPowerSupplyName=ogPowerSupplyName, ogEmdDioDescription=ogEmdDioDescription, ogWifiClientMode=ogWifiClientMode, ogWifiApClientEntry=ogWifiApClientEntry, ogEmdHumidityNotification=ogEmdHumidityNotification, ogEmdHumidityValue=ogEmdHumidityValue, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogHostServiceTable=ogHostServiceTable, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogRpcEntry=ogRpcEntry, ogMibNotifications=ogMibNotifications, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdEntry=ogEmdEntry, ogNetInterfaceType=ogNetInterfaceType, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmCheck=ogAlarmCheck, ogHostUserStartTime=ogHostUserStartTime, ogSystem=ogSystem, ogHostIndex=ogHostIndex, ogWifiApSsid=ogWifiApSsid, ogHostEntry=ogHostEntry, ogUpsBatteryNotification=ogUpsBatteryNotification, ogSerialPortMode=ogSerialPortMode, ogHostPingNotification=ogHostPingNotification, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWebUserEntry=ogWebUserEntry, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogUpsEntry=ogUpsEntry, ogWifiClientCounter=ogWifiClientCounter, ogCellModemRegistered=ogCellModemRegistered, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogSerialSignalNotification=ogSerialSignalNotification, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogRpcInputNotification=ogRpcInputNotification, ogHostServiceIndex=ogHostServiceIndex, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmLogEntry=ogAlarmLogEntry, ogNetInterfaceEntry=ogNetInterfaceEntry, ogSerialPortCTS=ogSerialPortCTS, ogAlarmLogTable=ogAlarmLogTable, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogRpcOutletName=ogRpcOutletName, ogCellModemIndex=ogCellModemIndex, ogUpsNotification=ogUpsNotification, ogCellModem3gRssi=ogCellModem3gRssi, ogEmdConnectType=ogEmdConnectType, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserHost=ogHostUserHost, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogUpsTable=ogUpsTable, ogAlarmDevice=ogAlarmDevice, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogHostServiceEntry=ogHostServiceEntry, ogEmdEnabled=ogEmdEnabled, ogRpcOutletFrequency=ogRpcOutletFrequency, ogWifiClientIndex=ogWifiClientIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogSerialUserName=ogSerialUserName, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogStatus2Compliance=ogStatus2Compliance, ogHostServicePort=ogHostServicePort)
