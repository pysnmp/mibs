...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogAlarmPreviousValue=ogAlarmPreviousValue, ogRpcOutletVoltage=ogRpcOutletVoltage, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWebUserNotification=ogWebUserNotification, ogWifiClientApMac=ogWifiClientApMac, ogAlarmType=ogAlarmType, ogSerialPortParity=ogSerialPortParity, ogWebUserSourceAddress=ogWebUserSourceAddress, ogUpsInputNotification=ogUpsInputNotification, ogWifiClientTable=ogWifiClientTable, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientCounter=ogWifiClientCounter, ogSerialPortLabel=ogSerialPortLabel, ogUpsEntry=ogUpsEntry, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiClientFrequency=ogWifiClientFrequency, ogSerialPortFlowControl=ogSerialPortFlowControl, ogHostUserHost=ogHostUserHost, ogCheckDeviceEntry=ogCheckDeviceEntry, ogCellModem4gRssi=ogCellModem4gRssi, ogWifiClientIndex=ogWifiClientIndex, ogEmdConnectType=ogEmdConnectType, ogUpsOutputVoltage=ogUpsOutputVoltage, ogUpsIndex=ogUpsIndex, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogFirmwareVersion=ogFirmwareVersion, ogEmdHumidityDescription=ogEmdHumidityDescription, ogSerialPortDCD=ogSerialPortDCD, ogHostUserHostName=ogHostUserHostName, ogSerialPortDTR=ogSerialPortDTR, ogStatus2Compliance=ogStatus2Compliance, ogUpsCounter=ogUpsCounter, ogHostUserStartTime=ogHostUserStartTime, ogBasicNotificationGroup=ogBasicNotificationGroup, ogAlarmTime=ogAlarmTime, ogSerialUserStartTime=ogSerialUserStartTime, ogWifiApEntry=ogWifiApEntry, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellModemEntry=ogCellModemEntry, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogRpcOutletTotal=ogRpcOutletTotal, ogUpsName=ogUpsName, ogAlarmCheck=ogAlarmCheck, ogHostUserIndex=ogHostUserIndex, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogRpcType=ogRpcType, ogAlarmLogIndex=ogAlarmLogIndex, ogCellModemNetwork=ogCellModemNetwork, ogCheckType=ogCheckType, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogEmdDioCounter=ogEmdDioCounter, ogEmdDioState=ogEmdDioState, ogHostServicePort=ogHostServicePort, ogAlarmLogTable=ogAlarmLogTable, ogCellModemVendor=ogCellModemVendor, ogEmdHumidityEmd=ogEmdHumidityEmd, ogAlarmInstance=ogAlarmInstance, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryNotification=ogUpsBatteryNotification, ogNetInterfaceState=ogNetInterfaceState, ogRpcOutletState=ogRpcOutletState, ogRpcOutletFrequency=ogRpcOutletFrequency, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApTxPower=ogWifiApTxPower, ogCurrentAlarmTable=ogCurrentAlarmTable, ogSerialPortDataBits=ogSerialPortDataBits, ogSerialPortTxBytes=ogSerialPortTxBytes, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWebUserEntry=ogWebUserEntry, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsTemperature=ogUpsTemperature, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialPortCTS=ogSerialPortCTS, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogHostServiceEntry=ogHostServiceEntry, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyName=ogPowerSupplyName, ogEmdTable=ogEmdTable, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogUpsInputFrequency=ogUpsInputFrequency, ogEmdDioDirection=ogEmdDioDirection, ogUpsState=ogUpsState, ogUpsHumidity=ogUpsHumidity, ogCellModemCounter=ogCellModemCounter, ogWebUserTable=ogWebUserTable, ogAlarmDevice=ogAlarmDevice, ogNetInterfaceName=ogNetInterfaceName, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogNetInterfaceType=ogNetInterfaceType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogWifiApIeeeMode=ogWifiApIeeeMode, ogRpcOutletNotification=ogRpcOutletNotification, ogHostServiceTable=ogHostServiceTable, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortStopBits=ogSerialPortStopBits, ogHostEntry=ogHostEntry, ogRpcOutletTable=ogRpcOutletTable, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogNetInterfaceNotification=ogNetInterfaceNotification, ogEmdHumidityCounter=ogEmdHumidityCounter, ogCheckEntry=ogCheckEntry, ogWifiApClientRssi=ogWifiApClientRssi, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogRpcName=ogRpcName, ogEmdDioTable=ogEmdDioTable, ogSerialUserNotification=ogSerialUserNotification, ogRpcInputCurrent=ogRpcInputCurrent, ogRpcInputFrequency=ogRpcInputFrequency, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialUserLabel=ogSerialUserLabel, ogCheckResetTimeout=ogCheckResetTimeout, ogPowerSupplyTable=ogPowerSupplyTable, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogRpcEntry=ogRpcEntry, ogUpsOutputLoad=ogUpsOutputLoad, ogCellApnNotification=ogCellApnNotification, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserStartTime=ogWebUserStartTime, ogEmdTemperatureValue=ogEmdTemperatureValue, ogUpsLogEnabled=ogUpsLogEnabled, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsOutputTruePower=ogUpsOutputTruePower, ogHostServiceNotification=ogHostServiceNotification, ogEmdEntry=ogEmdEntry, ogCheckResolveActions=ogCheckResolveActions, ogHostTable=ogHostTable, ogCellDataNotification=ogCellDataNotification, ogEmdDioDescription=ogEmdDioDescription, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogRpcIndex=ogRpcIndex, ogHostIpV4Address=ogHostIpV4Address, ogCheckDeviceIndex=ogCheckDeviceIndex, ogHostUserName=ogHostUserName, ogHostIpV6Address=ogHostIpV6Address, ogEmdHumidityEntry=ogEmdHumidityEntry, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogWifiApSsid=ogWifiApSsid, ogWifiApAuthNotification=ogWifiApAuthNotification, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCurrentAlarmTime=ogCurrentAlarmTime, ogCellModemEnabled=ogCellModemEnabled, ogRpcOutletRpc=ogRpcOutletRpc, ogCellModemTemperature=ogCellModemTemperature, ogSerialPortBreaks=ogSerialPortBreaks, ogAlarmLogEntry=ogAlarmLogEntry, ogRpcInputNotification=ogRpcInputNotification, ogSerialUserEntry=ogSerialUserEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogUpsInputVoltage=ogUpsInputVoltage, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogCustomNotification=ogCustomNotification, ogMibNotifications=ogMibNotifications, ogStatus2=ogStatus2, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogSerialPortSpeed=ogSerialPortSpeed, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsNotification=ogUpsNotification, ogHostServiceHost=ogHostServiceHost, ogWifiApClientMac=ogWifiApClientMac, ogStatus2Compliances=ogStatus2Compliances, ogCellModemRegistered=ogCellModemRegistered, ogUpsBatteryState=ogUpsBatteryState, ogHostIndex=ogHostIndex, ogSerialPortIndex=ogSerialPortIndex, ogSerialUserName=ogSerialUserName, ogCheckTriggerActions=ogCheckTriggerActions, ogSerialPortEntry=ogSerialPortEntry, ogRpcOutletIndex=ogRpcOutletIndex, ogEmdDescription=ogEmdDescription, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogWifiClientRssi=ogWifiClientRssi, ogSystem=ogSystem, ogUpsDescription=ogUpsDescription, ogEmdDioEmd=ogEmdDioEmd, ogAlarmState=ogAlarmState, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogHostName=ogHostName, ogSerialSignalNotification=ogSerialSignalNotification, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogSerialPortRTS=ogSerialPortRTS, ogEmdDioName=ogEmdDioName, ogPowerSupplyIndex=ogPowerSupplyIndex, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogUpsTable=ogUpsTable, ogWifiApFrequency=ogWifiApFrequency, ogHostUserAddress=ogHostUserAddress, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWifiApClientIndex=ogWifiApClientIndex, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogSerialPortTable=ogSerialPortTable, ogCellModemIMSI=ogCellModemIMSI, ogCheckIndex=ogCheckIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogHostPingNotification=ogHostPingNotification, ogCellTowerNotification=ogCellTowerNotification, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogUpsOutputPower=ogUpsOutputPower, ogSerialUserTable=ogSerialUserTable, ogSerialNumber=ogSerialNumber, ogCheckName=ogCheckName, ogEmdName=ogEmdName, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmName=ogCurrentAlarmName, ogNetInterfaceIndex=ogNetInterfaceIndex, ogHostUserEntry=ogHostUserEntry, ogHostServiceType=ogHostServiceType, ogSerialPortLogLevel=ogSerialPortLogLevel, PYSNMP_MODULE_ID=ogStatus2, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogNetInterfaceTable=ogNetInterfaceTable, ogHostUserNotification=ogHostUserNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCurrentAlarmType=ogCurrentAlarmType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogHostServiceCounter=ogHostServiceCounter, ogWebUserIndex=ogWebUserIndex, ogUpsType=ogUpsType, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCliUserSessionNotification=ogCliUserSessionNotification, ogHostServiceStatus=ogHostServiceStatus, ogWifiClientMode=ogWifiClientMode, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientEssid=ogWifiClientEssid, ogWifiClientBitRate=ogWifiClientBitRate, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogRpcMaxTemperature=ogRpcMaxTemperature, ogSerialPatternNotification=ogSerialPatternNotification, ogStatus2Groups=ogStatus2Groups, ogWebUserSourcePort=ogWebUserSourcePort, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogAlarmEventId=ogAlarmEventId, ogHostServiceIndex=ogHostServiceIndex, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogRpcTable=ogRpcTable, ogAlarmUser=ogAlarmUser, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputNotification=ogUpsOutputNotification)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostUserTable=ogHostUserTable, ogWifiApClientTable=ogWifiApClientTable, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogAlarm=ogAlarm, ogUpsConnectType=ogUpsConnectType, ogRpcCounter=ogRpcCounter, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogCheckDeviceName=ogCheckDeviceName, ogAlarmTriggerValue=ogAlarmTriggerValue, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdHumidityTotal=ogEmdHumidityTotal, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogRpcInputVoltage=ogRpcInputVoltage, ogCellModemIndex=ogCellModemIndex, ogWifiApEnabled=ogWifiApEnabled, ogEmdDioNotification=ogEmdDioNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogRpcOutputNotification=ogRpcOutputNotification, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogWifiApClientAp=ogWifiApClientAp, ogCellModemModel=ogCellModemModel, ogEmdDioInputTotal=ogEmdDioInputTotal, ogCellModemApn=ogCellModemApn, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdEnabled=ogEmdEnabled, ogAlarmSummary=ogAlarmSummary, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiApClientEntry=ogWifiApClientEntry, ogRpcConnectType=ogRpcConnectType, ogCellModemTower=ogCellModemTower, ogEmdDioEntry=ogEmdDioEntry, ogRpcOutletName=ogRpcOutletName, ogWifiApIndex=ogWifiApIndex, ogCellSignalNotification=ogCellSignalNotification, ogEmdIndex=ogEmdIndex, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryCharge=ogUpsBatteryCharge, ogCellModemTable=ogCellModemTable, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogWifiClientEntry=ogWifiClientEntry, ogWifiApTable=ogWifiApTable, ogEmdDioIndex=ogEmdDioIndex, ogRpcOutletLoad=ogRpcOutletLoad, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogEmdHumidityIndex=ogEmdHumidityIndex, ogCheckTable=ogCheckTable, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemConnected=ogCellModemConnected, ogCellModem3gRssi=ogCellModem3gRssi, ogSerialPortMode=ogSerialPortMode, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogNetInterfaceEntry=ogNetInterfaceEntry, ogWifiApInterface=ogWifiApInterface, ogAlarmName=ogAlarmName, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogWifiClientTxPower=ogWifiClientTxPower, ogWifiApCounter=ogWifiApCounter, ogWifiClientInterface=ogWifiClientInterface, ogRpcDescription=ogRpcDescription, ogWebUserName=ogWebUserName, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCellModemSessionTime=ogCellModemSessionTime, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceTable=ogCheckDeviceTable, ogEmdDioType=ogEmdDioType, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialUserPort=ogSerialUserPort, ogUpsInputCurrent=ogUpsInputCurrent)
