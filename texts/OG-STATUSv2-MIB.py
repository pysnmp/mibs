...
Gauge32, Counter64, NotificationType, iso, Unsigned32, Integer32, TimeTicks, ObjectIdentity, IpAddress, Bits, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "NotificationType", "iso", "Unsigned32", "Integer32", "TimeTicks", "ObjectIdentity", "IpAddress", "Bits", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogSerialUserNotification=ogSerialUserNotification, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortDSR=ogSerialPortDSR, ogWebUserName=ogWebUserName, ogWifiApClientAp=ogWifiApClientAp, ogWifiClientMode=ogWifiClientMode, ogWebUserSourcePort=ogWebUserSourcePort, ogEmdEnabled=ogEmdEnabled, ogAlarmInstance=ogAlarmInstance, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogEmdDioType=ogEmdDioType, ogSerialPortRTS=ogSerialPortRTS, ogRpcEntry=ogRpcEntry, ogUpsOutputPower=ogUpsOutputPower, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioState=ogEmdDioState, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckDeviceRef=ogCheckDeviceRef, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogCheckResetTimeout=ogCheckResetTimeout, ogHostServiceHost=ogHostServiceHost, ogRpcOutputNotification=ogRpcOutputNotification, ogSerialPortLabel=ogSerialPortLabel, ogWifiApIeeeMode=ogWifiApIeeeMode, ogEmdDescription=ogEmdDescription, ogWifiApClientTable=ogWifiApClientTable, ogHostUserHostName=ogHostUserHostName, ogCheckTable=ogCheckTable, ogSerialUserIndex=ogSerialUserIndex, ogEmdDioDescription=ogEmdDioDescription, ogCellModemConnected=ogCellModemConnected, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogWifiClientTable=ogWifiClientTable, ogUpsIndex=ogUpsIndex, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogCellModem4gRssi=ogCellModem4gRssi, ogRpcOutletName=ogRpcOutletName, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortFlowControl=ogSerialPortFlowControl, ogEmdTemperatureName=ogEmdTemperatureName, ogSerialUserEntry=ogSerialUserEntry, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogWifiApCounter=ogWifiApCounter, ogSerialPortTxBytes=ogSerialPortTxBytes, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogCellMessageNotification=ogCellMessageNotification, ogPowerSupplyEntry=ogPowerSupplyEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogRpcName=ogRpcName, ogRpcDescription=ogRpcDescription, ogEmdDioInputTotal=ogEmdDioInputTotal, ogSerialPortDCD=ogSerialPortDCD, ogRpcInputNotification=ogRpcInputNotification, ogCheckType=ogCheckType, ogAlarmSummary=ogAlarmSummary, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogEmdDioDirection=ogEmdDioDirection, ogSerialPortParityErrors=ogSerialPortParityErrors, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPortBreaks=ogSerialPortBreaks, ogCheckTriggerActions=ogCheckTriggerActions, ogEmdHumidityEmd=ogEmdHumidityEmd, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApIndex=ogWifiApIndex, ogUpsTable=ogUpsTable, ogWebUserTable=ogWebUserTable, ogUpsOutputNotification=ogUpsOutputNotification, ogCellModemEntry=ogCellModemEntry, ogHostServicePort=ogHostServicePort, ogWebUserSourceAddress=ogWebUserSourceAddress, ogAlarmName=ogAlarmName, ogHostEntry=ogHostEntry, ogCellModemRegistered=ogCellModemRegistered, ogHostUserEntry=ogHostUserEntry, ogEmdDioName=ogEmdDioName, ogUpsInputCurrent=ogUpsInputCurrent, ogSerialPortParity=ogSerialPortParity, ogCheckEntry=ogCheckEntry, ogAlarmEventId=ogAlarmEventId, ogCheckName=ogCheckName, ogNetInterfaceName=ogNetInterfaceName, ogHostUserIndex=ogHostUserIndex, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcMaxTemperature=ogRpcMaxTemperature, ogEmdDioEmd=ogEmdDioEmd, ogPowerSupplyTable=ogPowerSupplyTable, ogAlarmLogEntry=ogAlarmLogEntry, ogEmdDioCounter=ogEmdDioCounter, ogWifiApTable=ogWifiApTable, ogRpcCounter=ogRpcCounter, ogRpcOutletNotification=ogRpcOutletNotification, ogUpsLogEnabled=ogUpsLogEnabled, ogWifiApClientIndex=ogWifiApClientIndex, ogCellModemEnabled=ogCellModemEnabled, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogBasicStatusGroup=ogBasicStatusGroup, ogWebUserIndex=ogWebUserIndex, ogRpcType=ogRpcType, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcOutletLoad=ogRpcOutletLoad, ogRpcOutletTotal=ogRpcOutletTotal, ogCellApnNotification=ogCellApnNotification, ogStatus2Compliances=ogStatus2Compliances, ogEmdDioIndex=ogEmdDioIndex, ogHostUserHost=ogHostUserHost, ogHostServiceType=ogHostServiceType, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogRpcOutletCurrent=ogRpcOutletCurrent, ogSerialPortStopBits=ogSerialPortStopBits, ogEmdIndex=ogEmdIndex, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogCheckIndex=ogCheckIndex, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogEmdHumidityTable=ogEmdHumidityTable, ogUpsNotification=ogUpsNotification, ogUpsHumidity=ogUpsHumidity, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogNetInterfaceNotification=ogNetInterfaceNotification, ogCustomNotification=ogCustomNotification, ogUpsState=ogUpsState, ogFirmwareVersion=ogFirmwareVersion, ogSerialUserLabel=ogSerialUserLabel, ogUpsCounter=ogUpsCounter, ogHostUserNotification=ogHostUserNotification, ogWifiApAuthNotification=ogWifiApAuthNotification, ogHostIpV6Address=ogHostIpV6Address, ogNetInterfaceType=ogNetInterfaceType, ogBasicNotificationGroup=ogBasicNotificationGroup, ogNetInterfaceEntry=ogNetInterfaceEntry, ogEmdDioNotification=ogEmdDioNotification, ogAlarmCheck=ogAlarmCheck, ogCurrentAlarmName=ogCurrentAlarmName, ogRpcLogEnabled=ogRpcLogEnabled, ogEmdHumidityTotal=ogEmdHumidityTotal, ogPowerSupplyName=ogPowerSupplyName, ogUpsOutputTruePower=ogUpsOutputTruePower, ogCellModemTower=ogCellModemTower, ogSerialPortDataBits=ogSerialPortDataBits, ogUpsType=ogUpsType, ogSerialPortIndex=ogSerialPortIndex, ogUpsTemperature=ogUpsTemperature, ogEmdLogEnabled=ogEmdLogEnabled, ogCellModemModel=ogCellModemModel, ogRpcConnectType=ogRpcConnectType, ogWifiApEntry=ogWifiApEntry, ogSerialNumber=ogSerialNumber, PYSNMP_MODULE_ID=ogStatus2, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogUpsBatteryNotification=ogUpsBatteryNotification, ogStatus2Groups=ogStatus2Groups, ogWifiClientApMac=ogWifiClientApMac, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogUpsOutputCurrent=ogUpsOutputCurrent, ogUpsInputVoltage=ogUpsInputVoltage, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogEmdHumidityName=ogEmdHumidityName, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogSerialUserStartTime=ogSerialUserStartTime, ogRpcInputCurrent=ogRpcInputCurrent, ogNetInterfaceTable=ogNetInterfaceTable, ogUpsBatteryState=ogUpsBatteryState, ogWifiClientEssid=ogWifiClientEssid, ogRpcOutletVoltage=ogRpcOutletVoltage, ogAlarm=ogAlarm, ogEmdTemperatureTable=ogEmdTemperatureTable, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogUpsOutputFrequency=ogUpsOutputFrequency, ogHostIpV4Address=ogHostIpV4Address, ogEmdName=ogEmdName, ogWifiApClientMac=ogWifiApClientMac, ogWifiApTxPower=ogWifiApTxPower, ogWifiApEnabled=ogWifiApEnabled, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellDataNotification=ogCellDataNotification, ogHostServiceCounter=ogHostServiceCounter, ogHostServiceTable=ogHostServiceTable, ogWifiClientRssi=ogWifiClientRssi, ogAlarmDevice=ogAlarmDevice, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogCheckResolveActions=ogCheckResolveActions, ogWifiClientIndex=ogWifiClientIndex, ogStatus2Conformance=ogStatus2Conformance, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostServiceNotification=ogHostServiceNotification, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogAlarmType=ogAlarmType, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogSerialPortSpeed=ogSerialPortSpeed, ogHostIndex=ogHostIndex, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogUpsInputFrequency=ogUpsInputFrequency, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogHostServiceEntry=ogHostServiceEntry, ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogEmdConnectType=ogEmdConnectType, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogPowerSupplyIndex=ogPowerSupplyIndex, ogSerialSignalNotification=ogSerialSignalNotification, ogRpcIndex=ogRpcIndex, ogCliUserSessionNotification=ogCliUserSessionNotification, ogSerialPortCTS=ogSerialPortCTS, ogCellModemSessionTime=ogCellModemSessionTime, ogAlarmCurrentValue=ogAlarmCurrentValue, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogWifiClientBitRate=ogWifiClientBitRate, ogHostUserTable=ogHostUserTable, ogRpcInputVoltage=ogRpcInputVoltage, ogEmdHumidityNotification=ogEmdHumidityNotification, ogWebUserNotification=ogWebUserNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogCellModemNetwork=ogCellModemNetwork, ogEmdTable=ogEmdTable, ogUpsDescription=ogUpsDescription, ogSerialPortDTR=ogSerialPortDTR, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogEmdHumidityDescription=ogEmdHumidityDescription, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiApClientRssi=ogWifiApClientRssi, ogAlarmUser=ogAlarmUser, ogAlarmState=ogAlarmState, ogEmdEntry=ogEmdEntry, ogEmdHumidityIndex=ogEmdHumidityIndex, ogWifiApSsid=ogWifiApSsid, ogSystem=ogSystem, ogSerialPortMode=ogSerialPortMode, ogHostUserName=ogHostUserName, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogWebUserStartTime=ogWebUserStartTime, ogNetInterfaceState=ogNetInterfaceState, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogWebUserEntry=ogWebUserEntry, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogCurrentAlarmTime=ogCurrentAlarmTime, ogHostPingNotification=ogHostPingNotification, ogSerialPortEntry=ogSerialPortEntry, ogAlarmTime=ogAlarmTime, ogCheckDeviceTable=ogCheckDeviceTable, ogRpcOutletTable=ogRpcOutletTable, ogCurrentAlarmType=ogCurrentAlarmType)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogCellModemCounter=ogCellModemCounter, ogWifiClientEnabled=ogWifiClientEnabled, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellSignalNotification=ogCellSignalNotification, ogWifiClientInterface=ogWifiClientInterface, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogEmdHumidityEntry=ogEmdHumidityEntry, ogEmdDioTable=ogEmdDioTable, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogAlarmLogIndex=ogAlarmLogIndex, ogRpcOutletEntry=ogRpcOutletEntry, ogUpsInputNotification=ogUpsInputNotification, ogHostUserStartTime=ogHostUserStartTime, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogSerialPatternNotification=ogSerialPatternNotification, ogBasicAlarmGroup=ogBasicAlarmGroup, ogSerialPortRxBytes=ogSerialPortRxBytes, ogCellModemTable=ogCellModemTable, ogWifiApInterface=ogWifiApInterface, ogHostServiceIndex=ogHostServiceIndex, ogCurrentAlarmState=ogCurrentAlarmState, ogSerialUserPort=ogSerialUserPort, ogCellModem3gRssi=ogCellModem3gRssi, ogNetInterfaceIndex=ogNetInterfaceIndex, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdTemperatureValue=ogEmdTemperatureValue, ogSerialUserName=ogSerialUserName, ogMibNotifications=ogMibNotifications, ogAlarmLogTable=ogAlarmLogTable, ogUpsName=ogUpsName, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmTable=ogCurrentAlarmTable, ogHostUserAddress=ogHostUserAddress, ogCheckDeviceName=ogCheckDeviceName, ogCheckDeviceIndex=ogCheckDeviceIndex, ogCellModemApn=ogCellModemApn, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogEmdHumidityCounter=ogEmdHumidityCounter, ogHostName=ogHostName, ogWifiClientCounter=ogWifiClientCounter, ogRpcOutletIndex=ogRpcOutletIndex, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogWifiApFrequency=ogWifiApFrequency, ogStatus2Compliance=ogStatus2Compliance, ogCellModemIMSI=ogCellModemIMSI, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogCheckDeviceCheck=ogCheckDeviceCheck, ogCellTowerNotification=ogCellTowerNotification, ogSerialPortLogLevel=ogSerialPortLogLevel, ogWifiClientEntry=ogWifiClientEntry, ogCellModemVendor=ogCellModemVendor, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogEmdHumidityValue=ogEmdHumidityValue, ogCellModemIndex=ogCellModemIndex, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogCellModemTemperature=ogCellModemTemperature, ogHostTable=ogHostTable, ogUpsEntry=ogUpsEntry, ogStatus2=ogStatus2, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogCheckDeviceEntry=ogCheckDeviceEntry, ogWifiClientTxPower=ogWifiClientTxPower, ogRpcTable=ogRpcTable, ogCellNetworkNotification=ogCellNetworkNotification, ogCurrentAlarmUser=ogCurrentAlarmUser, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogWifiApClientEntry=ogWifiApClientEntry, ogUpsConnectType=ogUpsConnectType, ogRpcOutletState=ogRpcOutletState, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogSerialPortTable=ogSerialPortTable)
