...
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogDialPoolHealthNotification=ogDialPoolHealthNotification, ogWifiClientCounter=ogWifiClientCounter, ogEmdHumidityEmd=ogEmdHumidityEmd, ogEmdTemperatureValue=ogEmdTemperatureValue, ogEmdHumidityValue=ogEmdHumidityValue, ogUpsInputVoltage=ogUpsInputVoltage, ogHostServiceIndex=ogHostServiceIndex, ogEmdEntry=ogEmdEntry, ogSerialPortTxBytes=ogSerialPortTxBytes, ogRpcLogEnabled=ogRpcLogEnabled, ogFirmwareVersion=ogFirmwareVersion, ogWifiClientEntry=ogWifiClientEntry, ogCurrentAlarmUser=ogCurrentAlarmUser, ogWebUserName=ogWebUserName, ogEmdDioTable=ogEmdDioTable, ogSerialUserName=ogSerialUserName, ogHostServiceType=ogHostServiceType, ogCheckEntry=ogCheckEntry, ogCellModemIndex=ogCellModemIndex, ogCurrentAlarmType=ogCurrentAlarmType, ogWifiClientTxPower=ogWifiClientTxPower, ogSerialPortTable=ogSerialPortTable, ogEmdDioDescription=ogEmdDioDescription, ogAlarmEventId=ogAlarmEventId, ogSerialPortOverrunErrors=ogSerialPortOverrunErrors, ogWifiApIeeeMode=ogWifiApIeeeMode, ogMibNotifications=ogMibNotifications, ogWifiClientIeeeMode=ogWifiClientIeeeMode, ogHostName=ogHostName, ogUpsCounter=ogUpsCounter, ogUpsBatteryNominalCurrent=ogUpsBatteryNominalCurrent, ogAlarmCurrentValue=ogAlarmCurrentValue, ogWifiApClientTable=ogWifiApClientTable, ogWifiApClientRssi=ogWifiApClientRssi, ogHostUserTable=ogHostUserTable, ogWifiClientLinkQuality=ogWifiClientLinkQuality, ogPowerSupplyIndex=ogPowerSupplyIndex, ogCheckResolveActions=ogCheckResolveActions, ogCurrentAlarmInstance=ogCurrentAlarmInstance, ogEmdConnectType=ogEmdConnectType, ogPowerSupplyTemperature=ogPowerSupplyTemperature, ogSerialPortFramingErrors=ogSerialPortFramingErrors, ogStatus2Conformance=ogStatus2Conformance, ogEmdHumidityName=ogEmdHumidityName, ogWifiClientApMac=ogWifiClientApMac, ogRpcType=ogRpcType, ogCheckDeviceName=ogCheckDeviceName, ogAlarmPreviousValue=ogAlarmPreviousValue, ogWifiClientInterface=ogWifiClientInterface, ogHostServicePort=ogHostServicePort, ogWifiApClientMac=ogWifiApClientMac, ogUpsState=ogUpsState, ogSerialPortDSR=ogSerialPortDSR, ogCheckDeviceRef=ogCheckDeviceRef, ogRpcDescription=ogRpcDescription, ogCellModemModel=ogCellModemModel, ogUpsConnectType=ogUpsConnectType, ogPowerSupplyOutputCurrent=ogPowerSupplyOutputCurrent, ogWifiApAssociationNotification=ogWifiApAssociationNotification, ogCheckResetTimeout=ogCheckResetTimeout, ogCurrentAlarmState=ogCurrentAlarmState, ogUpsInputFrequency=ogUpsInputFrequency, ogWifiApClientTxBitRate=ogWifiApClientTxBitRate, ogHostServiceTable=ogHostServiceTable, ogEmdLogEnabled=ogEmdLogEnabled, ogWifiApFrequency=ogWifiApFrequency, ogCheckRepeatTimeout=ogCheckRepeatTimeout, ogEmdHumidityCounter=ogEmdHumidityCounter, ogRpcTable=ogRpcTable, ogHostPingNotification=ogHostPingNotification, ogEmdTemperatureTotal=ogEmdTemperatureTotal, ogSerialUserTable=ogSerialUserTable, ogCurrentAlarmSummary=ogCurrentAlarmSummary, ogWifiApClientTxPackets=ogWifiApClientTxPackets, ogEmdDioDirection=ogEmdDioDirection, ogWifiClientEssid=ogWifiClientEssid, ogCellModemTower=ogCellModemTower, ogAlarmSummary=ogAlarmSummary, ogSerialPortDTR=ogSerialPortDTR, ogSerialSignalNotification=ogSerialSignalNotification, ogCellModemConnected=ogCellModemConnected, ogUpsIndex=ogUpsIndex, ogWifiClientMissedBeacon=ogWifiClientMissedBeacon, ogRpcOutletCurrent=ogRpcOutletCurrent, ogUpsBatteryRunTimeRestart=ogUpsBatteryRunTimeRestart, ogEmdDioInputTotal=ogEmdDioInputTotal, ogWifiApIndex=ogWifiApIndex, ogNetInterfaceEntry=ogNetInterfaceEntry, ogCurrentAlarmTable=ogCurrentAlarmTable, ogUpsInputNotification=ogUpsInputNotification, ogCellModemSelectedSimCard=ogCellModemSelectedSimCard, ogCurrentAlarmCheck=ogCurrentAlarmCheck, ogUpsOutputPower=ogUpsOutputPower, ogCheckName=ogCheckName, ogRpcOutletTotal=ogRpcOutletTotal, ogEmdIndex=ogEmdIndex, ogCheckDeviceTable=ogCheckDeviceTable, ogWifiClientFrequency=ogWifiClientFrequency, ogWifiClientTable=ogWifiClientTable, ogWifiApInterface=ogWifiApInterface, ogEmdTemperatureEntry=ogEmdTemperatureEntry, ogPowerSupplyTable=ogPowerSupplyTable, ogUpsName=ogUpsName, ogCurrentAlarmTime=ogCurrentAlarmTime, ogSerialPortRTS=ogSerialPortRTS, ogEmdTemperatureDescription=ogEmdTemperatureDescription, ogSerialPortIndex=ogSerialPortIndex, ogAlarmType=ogAlarmType, ogAlarmLogEntry=ogAlarmLogEntry, ogStatus2NotificationPrefix=ogStatus2NotificationPrefix, ogWifiClientConnectNotification=ogWifiClientConnectNotification, ogNetInterfaceState=ogNetInterfaceState, ogUpsBatteryVoltage=ogUpsBatteryVoltage, ogCellModemTable=ogCellModemTable, ogRpcOutputNotification=ogRpcOutputNotification, ogCheckDeviceEntry=ogCheckDeviceEntry, ogAlarm=ogAlarm, ogWifiApClientEntry=ogWifiApClientEntry, ogAlarmTime=ogAlarmTime, ogStatus2Compliance=ogStatus2Compliance, ogHostServiceEntry=ogHostServiceEntry, ogWifiApEnabled=ogWifiApEnabled, ogSystem=ogSystem, ogWifiClientRssi=ogWifiClientRssi, ogWifiApClientRxBytes=ogWifiApClientRxBytes, ogEmdName=ogEmdName, ogWifiApSsid=ogWifiApSsid, ogUpsOutputNominalFrequency=ogUpsOutputNominalFrequency, ogSerialPortStopBits=ogSerialPortStopBits, ogUpsEntry=ogUpsEntry, ogStatus2=ogStatus2, ogCliUserSessionNotification=ogCliUserSessionNotification, ogCurrentAlarmIndex=ogCurrentAlarmIndex, ogCellModemRegistered=ogCellModemRegistered, ogSerialUserIndex=ogSerialUserIndex, ogUpsOutputCurrent=ogUpsOutputCurrent, ogWebUserSourceAddress=ogWebUserSourceAddress, ogSerialUserEntry=ogSerialUserEntry, ogRpcOutletRpc=ogRpcOutletRpc, ogSerialPatternNotification=ogSerialPatternNotification, ogWebUserSourcePort=ogWebUserSourcePort, ogAlarmLogTable=ogAlarmLogTable, ogWifiClientSignalNotification=ogWifiClientSignalNotification, ogUpsOutputVoltage=ogUpsOutputVoltage, ogEmdDioTriggerMode=ogEmdDioTriggerMode, ogCellModem4gRssi=ogCellModem4gRssi, ogEmdDioState=ogEmdDioState, ogSerialPortCTS=ogSerialPortCTS, ogCellModemEnabled=ogCellModemEnabled, ogHostIpV4Address=ogHostIpV4Address, ogBasicNotificationGroup=ogBasicNotificationGroup, ogEmdHumidityIndex=ogEmdHumidityIndex, ogRpcOutletName=ogRpcOutletName, ogPowerSupplyOutputNotification=ogPowerSupplyOutputNotification, ogSerialPortDCD=ogSerialPortDCD, ogWifiApEntry=ogWifiApEntry, ogCellSignalNotification=ogCellSignalNotification, ogStatus2Compliances=ogStatus2Compliances, ogHostEntry=ogHostEntry, ogCurrentAlarmEventId=ogCurrentAlarmEventId, ogCellNetworkNotification=ogCellNetworkNotification, ogWifiClientEnabled=ogWifiClientEnabled, ogSerialPortEntry=ogSerialPortEntry, ogCurrentAlarmEntry=ogCurrentAlarmEntry, ogWebUserNotification=ogWebUserNotification, ogEmdHumidityTable=ogEmdHumidityTable, ogSerialPortRxBytes=ogSerialPortRxBytes, ogEmdTemperatureNotification=ogEmdTemperatureNotification, ogRpcName=ogRpcName, ogUpsOutputNominalVoltage=ogUpsOutputNominalVoltage, ogUpsInputNominalCurrent=ogUpsInputNominalCurrent, ogEmdEnabled=ogEmdEnabled, ogRpcOutletState=ogRpcOutletState, ogCellModemVendor=ogCellModemVendor, ogSerialPortBreaks=ogSerialPortBreaks, ogCellModemNetwork=ogCellModemNetwork, ogSerialPortSpeed=ogSerialPortSpeed, ogUpsInputCurrent=ogUpsInputCurrent, ogEmdHumidityEntry=ogEmdHumidityEntry, ogHostUserNotification=ogHostUserNotification, ogBasicStatusGroup=ogBasicStatusGroup, ogCellModemEntry=ogCellModemEntry, ogRpcOutletTable=ogRpcOutletTable, ogSerialUserStartTime=ogSerialUserStartTime, ogSerialUserPort=ogSerialUserPort, ogAlarmDevice=ogAlarmDevice, ogCheckDeviceIndex=ogCheckDeviceIndex, ogUpsOutputFrequency=ogUpsOutputFrequency, ogPowerSupplyTempNotification=ogPowerSupplyTempNotification, ogEmdTemperatureCounter=ogEmdTemperatureCounter, ogAlarmTriggerValue=ogAlarmTriggerValue, ogCheckType=ogCheckType, ogWifiApCounter=ogWifiApCounter, ogCellApnNotification=ogCellApnNotification, ogNetInterfaceName=ogNetInterfaceName, ogUpsTemperature=ogUpsTemperature, ogUpsTable=ogUpsTable, ogWebUserStartTime=ogWebUserStartTime, ogCellMessageNotification=ogCellMessageNotification, ogWifiClientMode=ogWifiClientMode, ogUpsBatteryNotification=ogUpsBatteryNotification, ogUpsBatteryState=ogUpsBatteryState, ogRpcInputVoltage=ogRpcInputVoltage, ogRpcOutletLoad=ogRpcOutletLoad, ogUpsOutputTruePower=ogUpsOutputTruePower, ogSerialPortDataBits=ogSerialPortDataBits, ogWifiApClientTxBytes=ogWifiApClientTxBytes, ogCellTowerNotification=ogCellTowerNotification, ogCellModemRadioTechnology=ogCellModemRadioTechnology, ogHostIndex=ogHostIndex, ogCellModemIMSI=ogCellModemIMSI, ogWifiClientRxInvalidRetries=ogWifiClientRxInvalidRetries, ogRpcInputFrequency=ogRpcInputFrequency, ogWifiClientRxInvalidCrypt=ogWifiClientRxInvalidCrypt, ogSerialUserNotification=ogSerialUserNotification, ogHostServiceNotification=ogHostServiceNotification, ogUpsOutputNominalCurrent=ogUpsOutputNominalCurrent, ogCellModem3gRssi=ogCellModem3gRssi, ogPowerSupplyEntry=ogPowerSupplyEntry, ogBasicAlarmGroup=ogBasicAlarmGroup, ogUpsInputNominalFrequency=ogUpsInputNominalFrequency, ogHostUserAddress=ogHostUserAddress, ogEmdDioCounter=ogEmdDioCounter, ogCurrentAlarmTriggerValue=ogCurrentAlarmTriggerValue, ogCurrentAlarmName=ogCurrentAlarmName, ogEmdDioEntry=ogEmdDioEntry, ogSerialPortMode=ogSerialPortMode, ogRpcInputCurrent=ogRpcInputCurrent, ogWifiClientRxInvalidMisc=ogWifiClientRxInvalidMisc, ogEmdTemperatureEmd=ogEmdTemperatureEmd, ogEmdHumidityTotal=ogEmdHumidityTotal, ogEmdDioName=ogEmdDioName, ogCurrentAlarmCurrentValue=ogCurrentAlarmCurrentValue, ogSerialPortLabel=ogSerialPortLabel, ogRpcEntry=ogRpcEntry, ogUpsInputNominalVoltage=ogUpsInputNominalVoltage, ogEmdDioType=ogEmdDioType, ogCurrentAlarmDevice=ogCurrentAlarmDevice, ogCellModemApn=ogCellModemApn, ogNetInterfaceType=ogNetInterfaceType, ogUpsOutputLoad=ogUpsOutputLoad, ogRpcOutletEntry=ogRpcOutletEntry, ogWebUserIndex=ogWebUserIndex, ogAlarmLogIndex=ogAlarmLogIndex, ogEmdHumidityDescription=ogEmdHumidityDescription, ogHostUserHostName=ogHostUserHostName, ogHostTable=ogHostTable, ogWifiApTxPower=ogWifiApTxPower, ogCheckTable=ogCheckTable, ogRpcConnectType=ogRpcConnectType, ogWifiClientBitRate=ogWifiClientBitRate, ogUpsBatteryRunTime=ogUpsBatteryRunTime, ogHostServiceCounter=ogHostServiceCounter, ogEmdTemperatureName=ogEmdTemperatureName)
mibBuilder.exportSymbols("OG-STATUSv2-MIB", ogCellModemTemperature=ogCellModemTemperature, ogWifiApClientInactiveTime=ogWifiApClientInactiveTime, ogCurrentAlarmPreviousValue=ogCurrentAlarmPreviousValue, ogUpsOutputNotification=ogUpsOutputNotification, ogAlarmCheck=ogAlarmCheck, ogWifiApTable=ogWifiApTable, ogEmdDioNotification=ogEmdDioNotification, ogEmdTemperatureTable=ogEmdTemperatureTable, ogRpcOutletFrequency=ogRpcOutletFrequency, ogCellModemCounter=ogCellModemCounter, ogUpsDescription=ogUpsDescription, ogStatus2Groups=ogStatus2Groups, ogWebUserTable=ogWebUserTable, ogPowerSupplyInputNotification=ogPowerSupplyInputNotification, ogNetInterfaceIndex=ogNetInterfaceIndex, ogWifiClientRxInvalidNwid=ogWifiClientRxInvalidNwid, ogCheckTriggerActions=ogCheckTriggerActions, ogCheckIndex=ogCheckIndex, ogSerialPortFlowControl=ogSerialPortFlowControl, ogWifiApClientAp=ogWifiApClientAp, ogHostServiceStatus=ogHostServiceStatus, ogPowerSupplyInputVoltage=ogPowerSupplyInputVoltage, ogUpsNotification=ogUpsNotification, PYSNMP_MODULE_ID=ogStatus2, ogCustomNotification=ogCustomNotification, ogHostUserEntry=ogHostUserEntry, ogHostIpV6Address=ogHostIpV6Address, ogEmdDioEmd=ogEmdDioEmd, ogUpsBatteryRunTimeLow=ogUpsBatteryRunTimeLow, ogSerialPortParityErrors=ogSerialPortParityErrors, ogUpsBatteryNominalVoltage=ogUpsBatteryNominalVoltage, ogAlarmInstance=ogAlarmInstance, ogWifiApClientRxPackets=ogWifiApClientRxPackets, ogNetInterfaceTable=ogNetInterfaceTable, ogPowerSupplyName=ogPowerSupplyName, ogSerialNumber=ogSerialNumber, ogCellModemSessionTime=ogCellModemSessionTime, ogRpcOutletIndex=ogRpcOutletIndex, ogCheckDeviceCheck=ogCheckDeviceCheck, ogEmdDioIndex=ogEmdDioIndex, ogUpsBatteryCharge=ogUpsBatteryCharge, ogHostUserHost=ogHostUserHost, ogSerialPortLogLevel=ogSerialPortLogLevel, ogSerialUserLabel=ogSerialUserLabel, ogHostUserIndex=ogHostUserIndex, ogUpsBatteryCurrent=ogUpsBatteryCurrent, ogHostServiceHost=ogHostServiceHost, ogNetInterfaceNotification=ogNetInterfaceNotification, ogWebUserEntry=ogWebUserEntry, ogUpsLogEnabled=ogUpsLogEnabled, ogAlarmName=ogAlarmName, ogWifiApAuthNotification=ogWifiApAuthNotification, ogRpcCounter=ogRpcCounter, ogRpcOutletVoltage=ogRpcOutletVoltage, ogHostUserStartTime=ogHostUserStartTime, ogRpcIndex=ogRpcIndex, ogEmdTemperatureIndex=ogEmdTemperatureIndex, ogUpsType=ogUpsType, ogHostUserName=ogHostUserName, ogEmdTable=ogEmdTable, ogAlarmState=ogAlarmState, ogWifiApClientIndex=ogWifiApClientIndex, ogWifiClientRxInvalidFrag=ogWifiClientRxInvalidFrag, ogCellDataNotification=ogCellDataNotification, ogRpcInputNotification=ogRpcInputNotification, ogUpsBatteryTemperature=ogUpsBatteryTemperature, ogEmdDescription=ogEmdDescription, ogRpcMaxTemperature=ogRpcMaxTemperature, ogAlarmUser=ogAlarmUser, ogUpsHumidity=ogUpsHumidity, ogSerialPortParity=ogSerialPortParity, ogRpcOutletNotification=ogRpcOutletNotification, ogWifiClientIndex=ogWifiClientIndex, ogEmdHumidityNotification=ogEmdHumidityNotification)
